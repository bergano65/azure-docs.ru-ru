...
> [!IMPORTANT] 
> Azure NetApp Files поведение подготовки пула томов и емкости изменится на *ручной* и *управляемый* механизм. **Начиная с 15 марта 2021, размеры томов (квоты) будут управлять производительностью пропускной способности, а также подготовленной емкостью, а базовые пулы емкости больше не будут автоматически расти.** 
