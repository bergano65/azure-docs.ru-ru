...
description: Сведения об Azure NetApp Files, высокопроизводительной тарифицируемой службе хранилища файлов корпоративного класса, которая поддерживает рабочие нагрузки любого типа и обеспечивает высокий уровень доступности.
