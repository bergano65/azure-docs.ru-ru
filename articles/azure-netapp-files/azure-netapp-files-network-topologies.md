...
* Группы безопасности сети (Nsg), примененный к подсети, делегированные
...
Рассмотрим виртуальную сеть 2 и 3 виртуальной сети на схеме выше. Если необходимо подключиться к виртуальной Машине 3 или том 2 VM 2 или 3 виртуальной Машины необходимо подключиться к виртуальной Машине 2 или том 1, необходимо включить пиринговой связи между виртуальной сетью 2 и 3 виртуальной сети. 
...
В зависимости от конфигурации можно подключаться для локальных ресурсов к ресурсам в концентраторе и периферийных зонах.
...
* Для локальных ресурсов виртуальной Машины 1 и 2 на виртуальной Машине можно подключиться к том 1 в концентраторе через сеть сеть VPN или ExpressRoute канал. 
...
* 3 виртуальной Машины в концентраторе виртуальной сети можно подключиться том 2 в периферийной виртуальной сети и 3 тома в периферийной зоне 2 виртуальной сети.
