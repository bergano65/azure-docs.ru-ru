...
* Число IP-адресов, используемых в виртуальной сети с Azure NetApp Files (включая одноранговые виртуальных сетей), не может превышать 1000. Мы работаем над тем, чтобы увеличить это ограничение для удовлетворения требований масштабирования клиентов. Если вам нужны дополнительные IP-адреса, обратитесь в нашу службу поддержки, используя свой вариант использования и необходимый предел.
