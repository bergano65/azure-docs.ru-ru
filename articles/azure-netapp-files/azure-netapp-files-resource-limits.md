...
|  Количество используемых IP-адресов в виртуальной сети (включая немедленное одноранговое виртуальных сетей) с Azure NetApp Files   |    1000   |    Да   |
