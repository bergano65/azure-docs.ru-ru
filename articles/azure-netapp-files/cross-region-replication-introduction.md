...
Azure NetApp Files репликация тома поддерживается между разными [региональными парами Azure](/azure/best-practices-availability-paired-regions#azure-regional-pairs) и непарными. Azure NetApp Filesная репликация тома сейчас доступна в следующих регионах:  
