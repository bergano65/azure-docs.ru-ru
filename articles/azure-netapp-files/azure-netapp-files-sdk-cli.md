---
title: Пакеты SDK файлах Azure NetApp | Документация Майкрософт
description: Список пакетов SDK, поддерживаемые службой файлов Azure NetApp.
...
ms.locfileid: "65957885"
---
# <a name="azure-netapp-files-sdks"></a>Пакеты SDK для Azure NetApp Files

В этой статье перечислены пакеты SDK, поддерживаемые службой файлов Azure NetApp.

## <a name="supported-sdks"></a>Поддерживаемые пакеты SDK 

В следующей таблице перечислены поддерживаемые пакеты SDK.  Вы найдете сведения о поддерживаемых пакетов SDK в расположениях, опубликованных в GitHub.  

|    Язык    |    Место публикации пакета SDK    |
|------------------|--------------------------------------------------------------------------------------------|
...
## <a name="next-steps"></a>Дальнейшие действия   
 [Загрузите пакеты Azure SDK](https://azure.microsoft.com/downloads/)
