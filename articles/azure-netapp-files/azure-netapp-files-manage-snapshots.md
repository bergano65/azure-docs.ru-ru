...
ms.locfileid: "78267898"
---
# <a name="manage-snapshots-by-using-azure-netapp-files"></a>Управление моментальными снимками с помощью Azure NetApp Files

Azure NetApp Files можно использовать для ручного создания моментального снимка по запросу для тома или восстановления из моментального снимка в новый том. Служба Azure NetApp Files не создает моментальные снимки томов автоматически.  
...
4. В окне "Новый том" укажите сведения о новом томе:  
    ...
    *   **Виртуальная сеть**  
        ...
        В указанной виртуальной сети должна быть подсеть, делегированная службе Azure NetApp Files. Благодаря пиринговой связи вы можете получить доступ к службе Azure NetApp Files только из той же виртуальной сети, либо из виртуальной сети, которая находится в том же регионе, что и том. Вы можете получить доступ к тому из локальной сети через Express Route. 
