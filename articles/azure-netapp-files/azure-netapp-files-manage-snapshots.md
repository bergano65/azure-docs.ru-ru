...
Вы можете использовать файлы Azure NetApp для ручного создания снимка по требованию для объема или восстановления от снимка к новому объему. Служба Файлов NetApp Azure не создает автоматически моментальных снимков громкости.  
...
4. В окне "Новый том" укажите сведения о новом томе:  
    ...
    *   **Виртуальная сеть**  
        ...
        В указанной виртуальной сети должна быть подсеть, делегированная службе Azure NetApp Files. Благодаря пиринговой связи вы можете получить доступ к службе Azure NetApp Files только из той же виртуальной сети, либо из виртуальной сети, которая находится в том же регионе, что и том. Вы можете получить доступ к объему из вашей сети через Express Route. 
