...
> [!IMPORTANT] 
> Для использования функциональных возможностей политики моментальных снимков требуется список разрешений. Для запроса этой функции отправьте ИД своей подписки на адрес anffeedback@microsoft.com.
