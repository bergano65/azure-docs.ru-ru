...
* Убедитесь, что соблюдены [требования к Active Directoryным подключениям](create-active-directory-connections.md#requirements-for-active-directory-connections). 
