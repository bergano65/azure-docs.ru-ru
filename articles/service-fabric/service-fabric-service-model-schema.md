---
title: Описания XML-схемы модели службы Service Fabric Azure
description: Описание схемы XML модели службы Service Fabric, включая расположение и сводку по компонентам.
ms.topic: reference
ms.date: 12/10/2018
...
|Код|Универсальный код ресурса (URI) пространства имен|
|---|---|
|xs|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Сводка по компоненту 
Ниже приведены компоненты, определенные в файле ServiceFabricServiceModel.xsd:
- [257 элементов](service-fabric-service-model-schema-elements.md)
- [112 элементов ComplexTypes](service-fabric-service-model-schema-complex-types.md)
