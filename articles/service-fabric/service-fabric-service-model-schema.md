---
title: Описание схемы схемы службы Azure Service Fabric
description: Описание схемы XML модели обслуживания Service Fabric, включая местоположение и резюме компонентов.
ms.topic: reference
ms.date: 12/10/2018
