...
--- | --- | --- | --- |---
Ubuntu | 2.0.0 | AzulJDK 1.8 | Неявно с использованием npm | последних |
RHEL | - | OpenJDK 1.8 | Неявно с использованием npm | последних |
...
1. Откройте Eclipse и проверьте, установлена ли у вас версия Eclipse Neon или выше и последняя версия Buildship (2.2.1 или выше). Проверьте версии установленных компонентов, щелкнув **Help** > **About Eclipse** > **Installation Details** (Справка > О программе Eclipse > Сведения об установке). Вы можете обновить построение, следуя инструкциям в разделе [Сборка Eclipse: подключаемые модули Eclipse для Gradle][buildship-update].
...
Если подключаемый модуль Eclipse Service Fabric уже установлен, убедитесь, что вы используете последнюю версию. Для проверки выберите **Help** > **About Eclipse** > **Installation Details** (Справка > О программе Eclipse > Сведения об установке). Затем выполните поиск Service Fabric в списке установленных подключаемых модулей. Выберите **Обновить** , если доступна более новая версия.
