...
Затем удалите сертификат кластера из локального хранилища. Выведите список установленных сертификатов, чтобы найти отпечаток для своего кластера:

```powershell
Get-ChildItem Cert:\CurrentUser\My\
```

Затем удалите сертификат:
