...
| Параметр | Описание |
| --- | --- |
default-service-health-policy | Спецификация политики работоспособности в формате [JSON](https://docs.microsoft.com/rest/api/servicefabric/sfclient-model-servicetypehealthpolicy) , используемой по умолчанию для вычисления работоспособности типа службы. Сопоставление является пустым по умолчанию. |
