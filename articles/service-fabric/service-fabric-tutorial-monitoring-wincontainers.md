...
Если щелкнуть **Решение мониторинга контейнеров**, можно перейти к более подробной панели мониторинга. В ней можно прокручивать несколько панелей, а также выполнять запросы в журналах Azure Monitor.
