...
| Операция \ Роль | Основной | Дополнительный |
| --- |:--- |:--- |
...
| Запрос \ Предоставлено | Без блокировки | Общая | Обновить | Монопольная блокировка |
| --- |:--- |:--- |:--- |:--- |
| Общая |Нет конфликтов |Нет конфликтов |Конфликт |Конфликт |
| Обновить |Нет конфликтов |Нет конфликтов |Конфликт |Конфликт |
