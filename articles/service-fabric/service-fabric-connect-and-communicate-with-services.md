---
title: Подключение и общение с службами в Azure Service Fabric
...
В распределенной системе службы могут со временем быть перемещены с одного компьютера на другой. Это может произойти по различным причинам, включая балансировку ресурсов, обновление, сбой или масштабирование. Это означает изменение конечных адресов службы по мере перемещения службы в узлы с различными IP-адресами и может открываться в разных портах, если служба использует динамически выбранный порт.
