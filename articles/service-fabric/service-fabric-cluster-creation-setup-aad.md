...
#### <a name="solution"></a>Решение
На странице Azure AD выберите **Регистрация приложений**, выберите приложение кластера и щелкните **URL-адреса ответа**. В области **URL-адреса ответа** добавьте URL-адрес Service Fabric Explorer в список или замените один из элементов в списке. Сохраните изменения.
