...
Service Fabric реализует концепцию начальных узлов. Это узлы, которые поддерживают доступность базового кластера. Эти узлы гарантируют работу кластера, арендуя другие узлы и выступая в роли прерывателя связи во время определенных сбоев сети. Если случайные сбои выводят большинство начальных узлов в кластере и они не возвращаются, кольцо федерации вашего кластера сворачивается, как вы потеряли кворума узла начального значения и кластера происходит сбой. В Azure поставщик ресурсов Service Fabric управляет конфигурации кластера Service Fabric и по умолчанию распределяет начальных узлов в доменах сбоя и обновления типа первичного узла; Если первичного узла помечается как уровни устойчивости Silver или Gold, при удалении узла начальное значение, либо масштабирование в вашей первичного узла, либо вручную удалив начальный узел, кластер будет пытаться распространять другой узел без начального значения из доступных первичного узла емкость и завершится ошибкой, если у вас есть менее доступной емкости, чем уровень надежности кластера требуется для типа первичного узла.
