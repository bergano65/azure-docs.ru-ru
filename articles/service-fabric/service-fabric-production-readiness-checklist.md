...
## <a name="prerequisites-for-production"></a>Предпосылки для производства
1. Лучшие практики Azure Service Fabric: [Дизайн приложений,](./service-fabric-best-practices-applications.md) [безопасность,](./service-fabric-best-practices-security.md) [планирование](./service-fabric-best-practices-networking.md) [и масштабирование,](./service-fabric-best-practices-capacity-scaling.md) [инфраструктура как код,](./service-fabric-best-practices-infrastructure-as-code.md) [мониторинг и диагностика.](./service-fabric-best-practices-monitoring.md) 
...
1. Службы и приложения отслеживаются, также создаются и сохраняются журналы приложений. При этом могут создаваться оповещения. Например, [см. Добавить журналирование в приложение Service Fabric](service-fabric-how-to-diagnostics-log.md) и [контейнеры Monitor с журналами Azure Monitor.](service-fabric-diagnostics-oms-containers.md)
1. Кластер контролируется с помощью оповещения (например, с [журналами Azure Monitor).](service-fabric-diagnostics-event-analysis-oms.md) 
1. Базовая инфраструктура набора виртуальной шкалы машин контролируется с помощью оповещения (например, с [помощью журналов Azure Monitor.](service-fabric-diagnostics-oms-agent.md)
