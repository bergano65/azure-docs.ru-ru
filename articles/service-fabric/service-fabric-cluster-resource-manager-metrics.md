---
title: Управление загрузкой приложения Azure Service Fabric с помощью метрик
...
![Пример метрического веса и его влияние на балансирующие решения][Image3]
</center>
...
- Определение метрик дефрагментации является одним из способов консолидации нагрузки на узлы, а не ее распространения. Чтобы узнать, как настроить дефрагментацию, обратитесь к [этой статье](service-fabric-cluster-resource-manager-defragmentation-metrics.md)
