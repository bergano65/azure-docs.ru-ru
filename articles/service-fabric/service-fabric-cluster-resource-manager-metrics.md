...
Метрики по умолчанию прекрасно подходят для начала работы. Однако на этом их возможности исчерпываются. Например:  Какова вероятность того, что выбранная схема секционирования приведет равномерному идеально все секции? Какова вероятность того, что заданная служба испытывает одинаковую нагрузку все время или даже во всех секциях прямо сейчас?
