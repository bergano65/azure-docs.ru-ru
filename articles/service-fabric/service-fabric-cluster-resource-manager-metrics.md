...
![структура кластера с метриками по умолчанию][Image1]
</center>
...
![, сбалансированный кластер с метриками по умолчанию и пользовательскими показателями][Image2]
</center>
...
![пример веса метрики и его влияние на][Image3]
решений балансировки </center>
