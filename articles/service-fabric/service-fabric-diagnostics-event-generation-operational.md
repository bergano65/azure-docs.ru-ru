...
## <a name="application-events"></a>События приложений
...
| 23083 | ApplicationProcessExited | LifeCycle | Прекращен процесс в приложении | Размещение | Информация | 
...
| 16834 | PrimaryReplicationQueueFull | Здоровье | Первичная реплика очередь репликации заполнена | Репликация | Предупреждение |
| 16835 | PrimaryReplicationQueueWarning | Здоровье | Очередь репликации первичной реплики, приближается к полной | Репликация | Предупреждение |
| 16836 | PrimaryReplicationQueueWarningMitigated | Здоровье | Допустимо первичная реплика очереди репликации | Репликация | Информация |
| 16837 | SecondaryReplicationQueueFull | Здоровье | Вторичная реплика очередь репликации заполнена | Репликация | Предупреждение |
| 16838 | SecondaryReplicationQueueWarning | Здоровье | Очередь репликации вторичная реплика, приближается к полной | Репликация | Предупреждение |
| 16839 | SecondaryReplicationQueueWarningMitigated | Здоровье | Допустимо очереди репликации вторичной реплики | Репликация | Информация |
| 16840 | PrimaryFaultedSlowSecondary | Здоровье | Первичную реплику сбойного медленно вторичной реплики | Репликация | Предупреждение |
| 16841 | ReplicatorFaulted | Здоровье | Произошел сбой реплики | Репликация | Предупреждение |
...
| --- | --- | ---| --- | --- | --- |
| 23074 | ContainerActivated | Контейнер запущен | Размещение | Информация | 1 |
| 23075 | ContainerDeactivated | Контейнер остановлен | Размещение | Информация | 1 |
| 23082 | ContainerExited | Работа контейнера завершена. Проверьте на наличие параметра UnexpectedTermination | Размещение | Информация | 1 |
...
| 23075 | ContainerDeactivated | Размещение | Информация |
