...
| EventId | Имя | Категория | Description |Источник (задача) | Level | 
| --- | --- | --- | --- | --- | --- | 
...
| 16836 | примарирепликатионкуеуеварнингмитигатед | Health | Очередь репликации первичной реплики является допустимой | Репликация | Informational |
...
| 16839 | секондарирепликатионкуеуеварнингмитигатед | Health | Очередь репликации вторичной реплики является допустимой | Репликация | Informational |
...
| EventId | Имя | Description |Источник (задача) | Level | Версия |
| --- | --- | ---| --- | --- | --- |
