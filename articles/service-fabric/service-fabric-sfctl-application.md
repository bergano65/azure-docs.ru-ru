...
|Команда|Описание|
| --- | --- |
| Создать | Создает приложение Service Fabric с помощью указанного описания. |
...
| информация | Возвращает сведения о приложении Service Fabric. |
| список | Возвращает список приложений, созданных в кластере Service Fabric, которые соответствуют заданным фильтрам. |
| нагрузка | Возвращает сведения о нагрузке приложения Service Fabric. |
