---
title: Пакет приложения Azure Service Fabric
description: Узнайте об упаковке приложения Azure Service Fabric и о том, как подготовиться к развертыванию в кластере.
ms.topic: conceptual
ms.date: 2/23/2018
...
Для получения дополнительной информации о том, как настроить **SetupEntryPoint,** [см.](service-fabric-application-runas-security.md)
...
Если вы использовали Visual Studio для создания приложения, вы можете использовать команду *пакета* для автоматического создания пакета, который соответствует макету, описанной выше.

Чтобы создать пакет, нажмите правой кнопкой мыши на проект приложения в *Solution Explorer* и выберите команду **пакета:**
...
[Развертывание и удаление приложений][10] описывает, как использовать PowerShell для управления экземплярами приложений
