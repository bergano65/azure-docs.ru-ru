...
[Управление параметрами приложения для нескольких сред][11] описывает настройку параметров и переменных среды для различных экземпляров приложения.

[Настройка политик безопасности для приложения][12] описывает, как запускать службы в политиках безопасности для ограничения доступа.
