...
---
# <a name="deploy-service-fabric-application-with-system-assigned-managed-identity"></a>Развертывание приложения Service Fabric с системно-назначенной управляемой итог
