...
| `resource` | Ресурс, для которого был выдан маркер доступа, заданный с помощью `resource` параметра строки запроса запроса. соответствует утверждению "AUD" токена. |
...
| сообщение | Подробное описание ошибки. **Описания ошибок могут изменяться в любое время. Не зависят от самого сообщения об ошибке.**|
