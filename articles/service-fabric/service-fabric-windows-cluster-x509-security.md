...
Дополнительные сведения см. в разделе [Устранение неполадок и часто задаваемые вопросы](https://docs.microsoft.com/azure/service-fabric/cluster-security-certificate-management#troubleshooting-and-frequently-asked-questions).
