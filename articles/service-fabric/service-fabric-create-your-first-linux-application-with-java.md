---
title: Создание надежного приложения Службы обслуживания Azure Fabric, надежного приложения Java на Linux
...
> * [СЗ - Linux](service-fabric-create-your-first-linux-application-with-csharp.md)
>
>
...
* **Служба актера**. Субъекты Reliable Actors упаковываются в службы Reliable Services, которые могут быть развернуты в инфраструктуре Service Fabric. Экземпляры субъектов активируются в именованном экземпляре службы.
