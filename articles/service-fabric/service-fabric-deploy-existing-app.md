...
Можно запустить, создайте структуру каталогов, как описано в разделе [упаковать приложение Azure Service Fabric](https://docs.microsoft.com/azure/service-fabric/service-fabric-package-apps).
