---
title: Развертывание существующей функции, исполняемой в функции службы Azure Fabric
...
1. Выберите **Файл** > **Новый проект**, и создать приложение Service Fabric.
2. Выберите **гостевой исполняемый файл** в качестве шаблона службы.
3. Нажмите **«Прогон»,** чтобы выбрать папку с исполняемой и заполнить остальные параметры для создания службы.
...
### <a name="packaging-multiple-executables-with-visual-studio"></a>Упаковка нескольких исполнителей с Visual Studio

Вы можете использовать Visual Studio для создания пакета приложений, который содержит несколько исполнителей гостей. После добавления первого гостя, нажмите на проект приложения и выберите **службу Add->New Service Fabric,** чтобы добавить второй проект, исполняемый гостем, к решению.

> [!NOTE]
> Если связать источник с проектом Visual Studio, при построении решения Visual Studio следует убедиться, что в пакете приложения отображаются последние изменения в источнике.
...
### <a name="packaging-multiple-executables-using-yeoman-on-linux"></a>Упаковка нескольких исполнителей с помощью Yeoman на Linux
...
Вы можете начать с создания структуры каталога, как описано в [пакете Приложения Azure Service Fabric](https://docs.microsoft.com/azure/service-fabric/service-fabric-package-apps)App.
