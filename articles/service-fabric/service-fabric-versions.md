...
Перерывы в работе служб могут включать следующее:

- Версии, которые *не* используют режим **открытия** : кластер будет оставаться в рабочем режиме, но **открытый** режим перестанет работать, что может вызвать перерывы в обслуживании для рабочих нагрузок.

- Версии, *использующие* режим **открытия** : кластер может стать недоступным и перестанет работать, что может вызвать перерывы в обслуживании для рабочих нагрузок.
