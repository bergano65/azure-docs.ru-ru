...
Развертывание сертификата, используемого для приложений в кластере, показано в [этом примере сценария PowerShell](scripts/service-fabric-powershell-add-application-certificate.md).
