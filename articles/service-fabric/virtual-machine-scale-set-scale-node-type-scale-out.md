---
title: Добавление типа узлов в кластер Azure Service Fabric
...
Добавление нового типа узла (который поддерживается виртуальным набором масштабов машины) к существующему кластеру аналогично [обновлению типа основного узла,](service-fabric-scale-up-node-type.md)за исключением того же NodeTypeRef; очевидно, что не будет отключать любые активно используемые наборы виртуальных машин, и вы не потеряете доступность кластера, если не обновите тип основного узла. 
