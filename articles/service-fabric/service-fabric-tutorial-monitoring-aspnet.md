...
Запустите Visual Studio 2019 с более высоким уровнем привилегий, щелкнув правой кнопкой мыши значок Visual Studio в меню "Пуск" и выбрав **Запуск от имени администратора**. Выберите **Файл** > **Открыть** > **Решение или проект** и перейдите к приложению Voting (созданному в первой части руководства или клонированному из Git). Откройте *Voting.sln*. Если появится запрос на восстановление пакетов NuGet приложения, щелкните **Да**.
