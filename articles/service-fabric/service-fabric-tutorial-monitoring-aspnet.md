...
1. Щелкните правой кнопкой мыши имя службы и выберите **Добавить > Телеметрия Application Insights...**    
