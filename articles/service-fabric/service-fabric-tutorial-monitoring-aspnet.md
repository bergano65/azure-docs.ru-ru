...
Чтобы создать ресурс Application Insights, перейдите на [портал Azure](https://portal.azure.com). Щелкните **Создать ресурс** в меню навигации слева, чтобы открыть Azure Marketplace. Щелкните **Мониторинг и управление** и выберите **Application Insights**.
...
Запустите Visual Studio 2017 с более высоким уровнем привилегий, щелкнув значок Visual Studio в меню "Пуск" правой кнопкой мыши и выбрав **Запуск от имени администратора**. Выберите **Файл** > **Открыть** > **Решение или проект** и перейдите к приложению Voting (созданному в первой части руководства или клонированному из Git). Откройте *Voting.sln*. Если появится запрос на восстановление пакетов NuGet приложения, щелкните **Да**.

Выполните следующие действия, чтобы настроить Application Insights для служб VotingWeb и VotingData:

1. Щелкните правой кнопкой мыши имя службы и выберите **Добавить > Подключенные службы > Мониторинг с помощью Application Insights**.
...
1. В самом верху обозревателя решений щелкните правой кнопкой мыши **Решение "Voting"** и выберите **Управление пакетами NuGet для решения...**
