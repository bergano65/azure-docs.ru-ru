---
title: Обновление версии группы Azure Service Fabric
...
Вы можете указать пользовательские политики работоспособности для обновления Service Fabric. Если вы установили кластер для автоматического обновления ткани, то эти политики применяются к [фазе-1 автоматической модернизации ткани.](service-fabric-cluster-upgrade.md#fabric-upgrade-behavior-during-automatic-upgrades)
...
* Узнайте, как настроить некоторые [настройки кластерной ткани ткани сервисной ткани](service-fabric-cluster-fabric-settings.md)
* Узнайте, как [масштабировать кластер в и из](service-fabric-cluster-scale-up-down.md)
