---
title: 'Создайте свое первое приложение Azure Service Fabric на Linux с помощью C #'
...
1. Запустите этот скрипт с помощью служебной программы для отслеживания, чтобы просмотреть выходные данные службы субъекта.
   ...
   В случае MAC OS X, вам нужно скопировать папку myactorsvcTestClient в том же месте внутри контейнера, запустив следующие дополнительные команды.
