...
Поставщик ресурсов Azure Service Fabric доступен во всех регионах Azure и соответствует требованиям всех сертификатов соответствия, присутствующих в Azure, включая такие: SOC, ISO, PCI DSS, HIPPA и GDRP. Полный список сертификатов соответствия см. на [этой странице](https://www.microsoft.com/trustcenter/compliance/complianceofferings).
