---
title: Лазурная служба Ткань CLI- sfctl сочинять
description: Узнайте о sfctl, интерфейсе командной строки Azure Service Fabric. Включает список команд для приложений Docker Compose.
author: jeffj6123
ms.topic: reference
ms.date: 1/16/2020
ms.author: jejarry
