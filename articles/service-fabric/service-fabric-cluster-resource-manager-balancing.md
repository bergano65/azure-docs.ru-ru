---
title: Сбалансируйте кластер Azure Service Fabric
...
* устанавливает балансирующий флаг каждые пять секунд
...
Пороговые значения балансировки задаются в определении кластера на основе метрик. Для получения дополнительной информации о метриках, проверить [эту статью](service-fabric-cluster-resource-manager-metrics.md).
...
![Балансировка пороговых действий примера][Image2]
</center>
