...
|Подгруппа|Описание|
| --- | --- |
| [schedule](service-fabric-sfctl-chaos-schedule.md) | Получение и настройка хаотического расписания. |
## <a name="commands"></a>Команды

|Команда|Описание|
| --- | --- |
| events | Получает следующий сегмент событий службы Chaos на основе маркера продолжения или диапазона времени. |
