...
> [!NOTE]
> Поддержка Windows 7:
> - Windows 7 по умолчанию поставляется с Windows PowerShell версии 2.0. Для выполнения командлетов PowerShell для Service Fabric требуется PowerShell начиная с версии 3.0. [Windows PowerShell 5,0 можно загрузить][powershell5-download] из центра загрузки Майкрософт.
...
Текущие версии:
* Service Fabric SDK и средства 3.4.658
* 6\.5.658 среды выполнения Service Fabric
