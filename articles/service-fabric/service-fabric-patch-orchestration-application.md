...
> [!IMPORTANT]
> Версия v1.3.0 (последняя) приложения оркестрации исправлениями имеет известную проблему, выполняемую на Windows Server 2012. Если вы запускаете Windows Server 2012, скачайте версию v1.2.2 приложения [здесь](http://download.microsoft.com/download/C/9/1/C91780A5-F4B8-46AE-ADD9-E76B9B0104F6/PatchOrchestrationApplication_v1.2.2.zip). Ссылка на SFPkg [здесь](http://download.microsoft.com/download/C/9/1/C91780A5-F4B8-46AE-ADD9-E76B9B0104F6/PatchOrchestrationApplication_v1.2.2.sfpkg).
...
| InstallWindowsOSOnlyUpdates | Логическое <br> (Значение по умолчанию: true)                 | Используйте этот флаг, чтобы контролировать, какие обновления следует скачать и установить. Допустимы следующие значения: <br>true — устанавливает только обновления операционной системы Windows;<br>false — устанавливает все доступные обновления на компьютере.          |
