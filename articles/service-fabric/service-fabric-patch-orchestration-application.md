...
> 
> [!IMPORTANT]
> Приложение для управления исправлениями в linux является устаревшим. Посетите [Azure масштабируемого набора виртуальных машин автоматическое обновление образа ОС](https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-automatic-upgrade) для оркестрации обновлений в linux.
...
- Параметризованное ограничение размещения для микрослужб POA для расширенных примеров использования.
