---
title: 'Диспетчер ресурсов кластера Service Fabric: Стоимость перемещения | Документация Майкрософт'
