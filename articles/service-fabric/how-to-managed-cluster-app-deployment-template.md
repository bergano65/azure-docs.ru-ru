---
title: Развертывание Service Fabricного приложения управляемого кластера (Предварительная версия) с помощью шаблона ARM
description: Развертывание приложения в управляемом кластере Azure Service Fabric (Предварительная версия) с помощью шаблона Azure Resource Manager.
ms.topic: how-to
ms.date: 02/15/2021
...
Затем создайте шаблон диспетчер ресурсов, обновите файл параметров, указав сведения о приложении, и разверните шаблон в кластере Service Fabric. [Ознакомьтесь с примерами](https://github.com/Azure-Samples/service-fabric-dotnet-quickstart/tree/voting-sample-no-reverse-proxy/ARM-Managed-Cluster).
...
| version    | Идентификатор ресурса, тип приложения и версия приложения.       | /providers/Microsoft.ServiceFabric/managedClusters/sf-cluster-123/applicationTypes/VotingType/versions/1.0.0                                               | Должно соответствовать ApplicationManifest.xml                 |              |
| serviceName            | Имя службы         | VotingWeb                                             | Должен быть в формате ServiceType            |
| serviceTypeName        | Имя типа службы                | вотингвебтипе                                                    | Должно соответствовать ServiceManifest.xml                 |
