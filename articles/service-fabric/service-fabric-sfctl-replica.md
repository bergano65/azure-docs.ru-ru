---
title: Лазурная служба Ткань CLI- sfctl реплики
description: Узнайте о sfctl, интерфейсе командной строки Azure Service Fabric. Включает список команд для управления репликами.
author: jeffj6123
ms.topic: reference
ms.date: 1/16/2020
ms.author: jejarry
