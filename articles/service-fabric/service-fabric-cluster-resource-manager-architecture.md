...
![На схеме, показывающей сов, служба кластера диспетчер ресурсов выполняет статистическую обработку всех данных от локальных агентов и реагирует на них в соответствии с текущей конфигурацией.][Image1]
</center>
