---
title: Масштабирование типа узлов azure Service Fabric
...
6. Удалите старый масштабируемый набор из типа первичного узла. (После того, как узлы отключены, как в шаге 5, в виртуальном маштабе набора лезвия в Azure портала, распределить узлы из старого типа узлов один за другим.)
