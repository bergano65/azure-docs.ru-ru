---
title: Увеличение масштаба типа узла Service Fabric Azure
...
6. Удалите старый масштабируемый набор из типа первичного узла. (После отключения узлов, как показано на шаге 5, в колонке масштабируемого набора виртуальных машин в портал Azure освободить узлы от старого типа узла по одному.)
