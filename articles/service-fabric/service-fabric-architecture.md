---
title: Архитектура сервисной ткани Azure
description: В этой статье объясняется архитектура Сервисной ткани, платформы распределенных систем, используемой для создания масштабируемых, надежных и легко управляемых приложений для облака.
...
* Диспетчер ресурсов размещает реплики службы в доменах сбоев в кластере и гарантирует, что все блоки сбоя работают. Диспетчер ресурсов также распределяет ресурсы службы в рамках совместного пула узлов кластера, обеспечивая равномерное распределение нагрузки.
