---
title: Элементы XML-схемы модели службы Service Fabric Azure
...
|определение|локально в [группе ScalingPolicyMechanismGroup](service-fabric-service-model-schema-element-groups.md#scalingpolicymechanismgroup-group)|
...
|определение|локально в [сложном типе FabricEndpointsType](service-fabric-service-model-schema-complex-types.md#fabricendpointstype-complextype)|
...
|тип|анонимный complexType|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ApplicationInstanceType](service-fabric-service-model-schema-complex-types.md#applicationinstancetype-complextype)|
...
|тип|xs:string|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ExeHostEntryPointType](service-fabric-service-model-schema-complex-types.md#exehostentrypointtype-complextype)|
|name|Аргументы|
|minOccurs|0|
...
|определение|локально в [группе ScalingPolicyTriggerGroup](service-fabric-service-model-schema-element-groups.md#scalingpolicytriggergroup-group)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе Destinations|
|name|AzureBlob|
|minOccurs|0|
|maxOccurs|unbounded|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в двух элементах Destinations|
|name|AzureBlob|
|minOccurs|0|
|maxOccurs|unbounded|
...
|определение|локально в элементе Infrastructure|
|name|Blackbird|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в элементе NodeType|
|name|Capacities|
|minOccurs|0|
...
|тип|[KeyValuePairType](service-fabric-service-model-schema-complex-types.md#keyvaluepairtype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе Capacities|
|name|Capacity|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="centralsecretservicereplicatorendpoint-element"></a>Элемент CentralSecretServiceReplicatorEndpoint
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ContainerHostPoliciesType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype)|
|name|CertificateRef|
|minOccurs|0|
|maxOccurs|unbounded|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе NodeType и [сложном типе InfrastructureNodeType](service-fabric-service-model-schema-complex-types.md#infrastructurenodetype-complextype)|
|name|Сертификаты|
|minOccurs|0|
...
|определение|локально в [сложном типе ApplicationManifestType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype)|
|name|Сертификаты|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе ClusterManifestType](service-fabric-service-model-schema-complex-types.md#clustermanifesttype-complextype)|
|name|Сертификаты|
|minOccurs|0|
...
|тип|[FabricCertificateType](service-fabric-service-model-schema-complex-types.md#fabriccertificatetype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе CertificatesType](service-fabric-service-model-schema-complex-types.md#certificatestype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype) и элементе DigestedCodePackage|
|name|CodePackage|
|maxOccurs|unbounded|
...
|тип|xs:string|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ContainerHostEntryPointType](service-fabric-service-model-schema-complex-types.md#containerhostentrypointtype-complextype)|
|name|Команды|
|minOccurs|0|
|maxOccurs|1|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе ConfigOverrides и элементе DigestedConfigPackage|
|name|ConfigOverride|
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в элементе ServiceManifestImport|
...
## <a name="configpackage-element-type-configpackagedescriptiontype"></a>Элемент ConfigPackage (тип ConfigPackageDescriptionType) 
...
|Атрибут|Значение|
|---|---|
|тип|[ConfigPackageDescriptionType](service-fabric-service-model-schema-complex-types.md#configpackagedescriptiontype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [ConfigPackagePoliciesType complexType](service-fabric-service-model-schema-complex-types.md#configpackagepoliciestype-complextype)|
|name|ConfigPackage|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="configpackage-element-type-configpackagetype"></a>Элемент ConfigPackage (тип ConfigPackageType) 
Объявляет папку с именем, указанным в атрибуте Name, и PackageRoot, которая содержит файл Settings. XML. Этот файл содержит разделы заданных пользователем параметров пар "ключ-значение", которые могут считываться процессом во время выполнения. Во время обновления при изменении одного только атрибута version для ConfigPackage перезапуск процесса не выполняется. Вместо этого при помощи обратного вызова в процесс передается уведомление о том, что параметры конфигурации изменились, поэтому они были перезагружены в динамическом режиме.

|Атрибут|Значение|
|---|---|
|тип|[ConfigPackageType](service-fabric-service-model-schema-complex-types.md#configpackagetype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype) и элементе DigestedConfigPackage|
|name|ConfigPackage|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="configpackagepolicies-element"></a>Элемент ConfigPackagePolicies
Пакеты конфигурации, которые необходимо установить в контейнере.

|Атрибут|Значение|
|---|---|
|тип|[ConfigPackagePoliciesType](service-fabric-service-model-schema-complex-types.md#configpackagepoliciestype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype) и элементе DigestedCodePackage|
...
|тип|xs:string|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе DebugParametersType](service-fabric-service-model-schema-complex-types.md#debugparameterstype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе EntryPointDescriptionType](service-fabric-service-model-schema-complex-types.md#entrypointdescriptiontype-complextype)|
|name|ContainerHost|
...
## <a name="containerlabel-element"></a>Элемент ContainerLabel
...
## <a name="containernetworkpolicy-element"></a>Элемент ContainerNetworkPolicy
Описывает политики сети контейнера для пакета службы.

|Атрибут|Значение|
|---|---|
|тип|[ContainerNetworkPolicyType](service-fabric-service-model-schema-complex-types.md#containernetworkpolicytype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [NetworkPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#networkpoliciestype-complextype)|
...
|определение|локально в [сложном типе DiagnosticsType](service-fabric-service-model-schema-complex-types.md#diagnosticstype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе TargetInformationType](service-fabric-service-model-schema-complex-types.md#targetinformationtype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype)и элементе DigestedDataPackage|
|name|DataPackage|
|minOccurs|0|
|maxOccurs|unbounded|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементах DigestedCodePackage, DigestedConfigPackage и DigestedDataPackage|
...
|определение|локально в [сложном типе ApplicationPoliciesType](service-fabric-service-model-schema-complex-types.md#applicationpoliciestype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ApplicationHealthPolicyType](service-fabric-service-model-schema-complex-types.md#applicationhealthpolicytype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ApplicationManifestType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype) и [сложном типе ApplicationInstanceType](service-fabric-service-model-schema-complex-types.md#applicationinstancetype-complextype)|
...
|тип|xs:string|
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ApplicationManifestType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype), [ServiceManifestType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype) и [ServicePackageType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|name|Описание|
|minOccurs|0|
...
|определение|локально в элементе CrashDumpSource|
|name|Назначения|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|3 элемента, 0 атрибутов|
|определение|локально в элементе ETWSource|
|name|Назначения|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|3 элемента, 0 атрибутов|
|определение|локально в элементе FolderSource|
|name|Назначения|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ApplicationManifestType](service-fabric-service-model-schema-complex-types.md#applicationmanifesttype-complextype) и [EnvironmentType](service-fabric-service-model-schema-complex-types.md#environmenttype-complextype)|
|name|Диагностика|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ServiceManifestType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype) и [ServicePackageType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
|name|Диагностика|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|2 элемента, 0 атрибутов|
|определение|локально в [сложном типе ApplicationPackageType](service-fabric-service-model-schema-complex-types.md#applicationpackagetype-complextype)|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в элементе DigestedResources|
|name|DigestedCertificates|
|minOccurs|0|
|maxOccurs|1|
...
|определение|локально в [сложном типе ServicePackageType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
|определение|локально в элементе DigestedEndpoints|
...
|тип|анонимный complexType|
|content|0 элементов, 1 атрибут|
|определение|локально в элементе Membership|
|name|DomainGroup|
|minOccurs|0|
|maxOccurs|unbounded|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ContainerLoggingDriverType](service-fabric-service-model-schema-complex-types.md#containerloggingdrivertype-complextype) и [ContainerVolumeType](service-fabric-service-model-schema-complex-types.md#containervolumetype-complextype)|
|name|DriverOption|
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|2 элемента, 0 атрибутов|
|определение|локально в [сложном типе ServiceDiagnosticsType](service-fabric-service-model-schema-complex-types.md#servicediagnosticstype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе Endpoints|
|name|Конечная точка|
|maxOccurs|unbounded|
...
|тип|[EndpointType](service-fabric-service-model-schema-complex-types.md#endpointtype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементах Endpoints и DigestedEndpoint|
|name|Конечная точка|
|maxOccurs|unbounded|
...
## <a name="endpointbinding-element"></a>Элемент EndpointBinding
Указывает конечную точку, которую необходимо предоставить в сети контейнера.

|Атрибут|Значение|
|---|---|
|тип|[ContainerNetworkPolicyEndpointBindingType](service-fabric-service-model-schema-complex-types.md#containernetworkpolicyendpointbindingtype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [ContainerNetworkPolicyType complexType](service-fabric-service-model-schema-complex-types.md#containernetworkpolicytype-complextype)|
...
|тип|[EndpointBindingPolicyType](service-fabric-service-model-schema-complex-types.md#endpointbindingpolicytype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype) и элементе DigestedEndpoint|
|name|EndpointBindingPolicy|
|minOccurs|0|
...
|тип|[EndpointCertificateType](service-fabric-service-model-schema-complex-types.md#endpointcertificatetype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе Certificates и двух элементах DigestedCertificates|
|name|EndpointCertificate|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе ResourceOverridesType](service-fabric-service-model-schema-complex-types.md#resourceoverridestype-complextype)|
|name|Конечные точки|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе ResourcesType](service-fabric-service-model-schema-complex-types.md#resourcestype-complextype)|
|name|Конечные точки|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе CodePackageType](service-fabric-service-model-schema-complex-types.md#codepackagetype-complextype)|
|name|EntryPoint|
|minOccurs|1|
...
## <a name="environmentvariable-element-type-environmentvariableoverridetype"></a>Элемент EnvironmentVariable (тип EnvironmentVariableOverrideType) 
Переменная среды.

|Атрибут|Значение|
|---|---|
|тип|[EnvironmentVariableOverrideType](service-fabric-service-model-schema-complex-types.md#environmentvariableoverridetype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально [EnvironmentOverridesType complexType](service-fabric-service-model-schema-complex-types.md#environmentoverridestype-complextype)|
...
## <a name="environmentvariable-element-type-environmentvariabletype"></a>Элемент EnvironmentVariable (тип EnvironmentVariableType) 
Переменная среды.
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [EnvironmentVariablesType complexType](service-fabric-service-model-schema-complex-types.md#environmentvariablestype-complextype)|
|name|EnvironmentVariable|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="eventstoreservicereplicatorendpoint-element"></a>Элемент EventStoreServiceReplicatorEndpoint
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе SetupEntryPoint|
|name|ExeHost|
...
## <a name="extension-element"></a>Extension, элемент

|Атрибут|Значение|
|---|---|
|тип|анонимный complexType|
|content|0 элементов, 2 атрибута|
|определение|локально в [сложном типе ExtensionsType](service-fabric-service-model-schema-complex-types.md#extensionstype-complextype)|
|name|Расширение|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="gatewayresourcemanagerreplicatorendpoint-element"></a>Элемент GatewayResourceManagerReplicatorEndpoint
...
|тип|анонимный complexType|
|content|2 элемента, 1 атрибут|
|определение|локально в элементе Groups|
|name|Группа|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|0 элементов, 1 атрибут|
|определение|локально в элементе MemberOf|
|name|Группа|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="groups-element"></a>Groups, элемент
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе SecurityPrincipalsType](service-fabric-service-model-schema-complex-types.md#securityprincipalstype-complextype)|
|name|Группы|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ImageOverridesType](service-fabric-service-model-schema-complex-types.md#imageoverridestype-complextype)|
|name|Изображение|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="label-element"></a>Элемент Label
Задает метки для контейнера.

|Атрибут|Значение|
|---|---|
|тип|[ContainerLabelType](service-fabric-service-model-schema-complex-types.md#containerlabeltype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ContainerHostPoliciesType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype)|
|name|Метка|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в пяти элементах LoadMetrics|
|name|LoadMetric|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе ServiceGroupMemberType](service-fabric-service-model-schema-complex-types.md#servicegroupmembertype-complextype)|
|name|LoadMetrics|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в элементе ServiceGroupTypeMember|
|name|LoadMetrics|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе ServiceGroupTypeType](service-fabric-service-model-schema-complex-types.md#servicegrouptypetype-complextype)|
|name|LoadMetrics|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе ServiceTypeType](service-fabric-service-model-schema-complex-types.md#servicetypetype-complextype)|
|name|LoadMetrics|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе ServiceType](service-fabric-service-model-schema-complex-types.md#servicetype-complextype)|
|name|LoadMetrics|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|0 элементов, 1 атрибут|
|определение|локально в элементе LogCollectionPolicies|
|name|LogCollectionPolicy|
...
|тип|[LogicalDirectoryType](service-fabric-service-model-schema-complex-types.md#logicaldirectorytype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе LogicalDirectories|
|name|LogicalDirectory|
|maxOccurs|unbounded|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе DllHostEntryPointType](service-fabric-service-model-schema-complex-types.md#dllhostentrypointtype-complextype)|
...
|тип|[DataPackageType](service-fabric-service-model-schema-complex-types.md#datapackagetype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе ManifestDataPackages|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в элементе ETW|
|name|ManifestDataPackages|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементах Members|
|name|Член|
|minOccurs|1|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|2 элемента, 0 атрибутов|
|определение|локально в элементе User|
|name|MemberOf|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе StatefulServiceGroupType](service-fabric-service-model-schema-complex-types.md#statefulservicegrouptype-complextype)|
|name|Члены|
|minOccurs|1|
|maxOccurs|1|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе StatelessServiceGroupType](service-fabric-service-model-schema-complex-types.md#statelessservicegrouptype-complextype)|
|name|Члены|
|minOccurs|1|
|maxOccurs|1|
...
|тип|анонимный complexType|
|content|3 элемента, 0 атрибутов|
|определение|локально в элементе Group|
|name|Членство|
|minOccurs|0|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [группе PartitionDescriptionGroup](service-fabric-service-model-schema-element-groups.md#partitiondescriptiongroup-group)|
|name|NamedPartition|
...
## <a name="networkpolicies-element"></a>Элемент NetworkPolicies
Указывает политики сети, включая политики сети контейнера.

|Атрибут|Значение|
|---|---|
|тип|[NetworkPoliciesType](service-fabric-service-model-schema-complex-types.md#networkpoliciestype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype) и [ServicePackageType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементах NodeList|
|name|Узел|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе InfrastructureInformationType](service-fabric-service-model-schema-complex-types.md#infrastructureinformationtype-complextype)|
|name|NodeList|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе LinuxInfrastructureType](service-fabric-service-model-schema-complex-types.md#linuxinfrastructuretype-complextype)|
|name|NodeList|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе WindowsInfrastructureType](service-fabric-service-model-schema-complex-types.md#windowsinfrastructuretype-complextype)|
|name|NodeList|
...
|определение|локально в элементе NodeTypes|
|name|NodeType|
|maxOccurs|unbounded|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ParametersType](service-fabric-service-model-schema-complex-types.md#parameterstype-complextype)|
|name|Параметр|
|minOccurs|1|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|0 элементов, 2 атрибута|
|определение|локально в элементе Parameters|
|name|Параметр|
|block||
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|0 элементов, 2 атрибута|
|определение|локально в элементе Section|
|name|Параметр|
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в [сложном типе AppInstanceDefinitionType](service-fabric-service-model-schema-complex-types.md#appinstancedefinitiontype-complextype)|
|name|Параметры|
...
|тип|анонимный complexType|
|content|0 элементов, 1 атрибут|
|определение|локально в элементе NamedPartition|
|name|Секция|
...
|тип|xs:string|
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ServiceType](service-fabric-service-model-schema-complex-types.md#servicetype-complextype), [ServiceTypeType](service-fabric-service-model-schema-complex-types.md#servicetypetype-complextype) и [ServiceGroupTypeType](service-fabric-service-model-schema-complex-types.md#servicegrouptypetype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [ServicePackageContainerPolicyType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagecontainerpolicytype-complextype), [ContainerHostPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype)|
|name|PortBinding|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="properties-element"></a>Properties, элемент
...
|тип|[ServiceTypeExtensionPolicyPropertiesType](service-fabric-service-model-schema-complex-types.md#servicetypeextensionpolicypropertiestype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементах PersistencePolicy и EvictionPolicy|
|name|Свойства|
|minOccurs|0|
...
|тип|[KeyValuePairType](service-fabric-service-model-schema-complex-types.md#keyvaluepairtype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе PlacementProperties|
|name|Свойство|
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|0 элементов, 2 атрибута|
|определение|локально в [сложном типе ServiceTypeExtensionPolicyPropertiesType](service-fabric-service-model-schema-complex-types.md#servicetypeextensionpolicypropertiestype-complextype)|
|name|Свойство|
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|0 элементов, 1 атрибут|
|определение|локально в элементе ProviderGuids|
|name|ProviderGuid|
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|[ResourceGovernancePolicyType](service-fabric-service-model-schema-complex-types.md#resourcegovernancepolicytype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), элементе DigestedCodePackage и элементе DigestedEndpoint|
|name|ResourceGovernancePolicy|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestType](service-fabric-service-model-schema-complex-types.md#servicemanifesttype-complextype)|
|name|Ресурсы|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе Roles|
|name|Role|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в элементе Blackbird|
|name|Роли|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в элементе PaaS|
|name|Роли|
...
|тип|анонимный complexType|
|content|1 элемент, 0 атрибутов|
|определение|локально в элементе WindowsAzure|
|name|Роли|
...
|тип|анонимный complexType|
|content|0 элементов, 1 атрибут|
|определение|локально в элементе ExeHost|
|name|RunFrequency|
|minOccurs|0|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе ServiceScalingPolicies|
|name|ScalingPolicy|
|maxOccurs|unbounded|
...
|тип|[FabricCertificateType](service-fabric-service-model-schema-complex-types.md#fabriccertificatetype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в двух элементах Certificates и элементе DigestedCertificates|
|name|SecretsCertificate|
|minOccurs|0|
...
|определение|локально в [сложном типе SettingsOverridesType](service-fabric-service-model-schema-complex-types.md#settingsoverridestype-complextype)|
|name|Section|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|1 элемент, 1 атрибут|
|определение|локально в [сложном типе SettingsType](service-fabric-service-model-schema-complex-types.md#settingstype-complextype)|
|name|Section|
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|[SecurityAccessPolicyType](service-fabric-service-model-schema-complex-types.md#securityaccesspolicytype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype), элементе SecurityAccessPolicies и элементе DigestedEndpoint|
|name|SecurityAccessPolicy|
|minOccurs|0|
...
|определение|локально в [сложном типе DefaultServicesType](service-fabric-service-model-schema-complex-types.md#defaultservicestype-complextype)|
|name|Service|
...
|тип|анонимный complexType|
|content|0 элементов, 2 атрибута|
|определение|локально в элементе ServiceCorrelations|
...
## <a name="servicefabricruntimeaccesspolicy-element"></a>Элемент ServiceFabricRuntimeAccessPolicy
Указывает политики, которые определяют способ предоставления среды выполнения Service Fabric репликам.

|Атрибут|Значение|
|---|---|
|тип|[ServiceFabricRuntimeAccessPolicyType](service-fabric-service-model-schema-complex-types.md#servicefabricruntimeaccesspolicytype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype) и [ServicePackageType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
## <a name="servicepackagecontainerpolicy-element"></a>Элемент ServicePackageContainerPolicy

|Атрибут|Значение|
|---|---|
|тип|[ServicePackageContainerPolicyType](service-fabric-service-model-schema-complex-types.md#servicepackagecontainerpolicytype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ServiceManifestImportPoliciesType](service-fabric-service-model-schema-complex-types.md#servicemanifestimportpoliciestype-complextype) и [ServicePackageType](service-fabric-service-model-schema-complex-types.md#servicepackagetype-complextype)|
...
|тип|анонимный complexType|
|content|0 элементов, 2 атрибута|
|определение|локально в элементе ServicePlacementPolicies|
|name|ServicePlacementPolicy|
|maxOccurs|unbounded|
...
|тип|[ServiceTypesType](service-fabric-service-model-schema-complex-types.md#servicetypestype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе DigestedServiceTypes|
|name|ServiceTypes|
...
|тип|[SettingsOverridesType](service-fabric-service-model-schema-complex-types.md#settingsoverridestype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ConfigOverrideType](service-fabric-service-model-schema-complex-types.md#configoverridetype-complextype)|
|name|Настройки|
|minOccurs|0|
...
|тип|[KeyValuePairType](service-fabric-service-model-schema-complex-types.md#keyvaluepairtype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе SfssRgPolicies|
|name|SfssRgPolicy|
|minOccurs|0|
|maxOccurs|unbounded|
...
|тип|анонимный complexType|
|content|0 элементов, 1 атрибут|
|определение|локально в [сложном типе FabricKtlLoggerSettingsType](service-fabric-service-model-schema-complex-types.md#fabricktlloggersettingstype-complextype)|
...
|тип|[StatefulServiceType](service-fabric-service-model-schema-complex-types.md#statefulservicetype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceTemplatesType](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype) и элементе Service|
|name|StatefulService|
...
|тип|[StatefulServiceGroupType](service-fabric-service-model-schema-complex-types.md#statefulservicegrouptype-complextype)|
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceTemplatesType](service-fabric-service-model-schema-complex-types.md#servicetemplatestype-complextype) и элементе ServiceGroup|
|name|StatefulServiceGroup|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в [сложном типе ServiceAndServiceGroupTypesType](service-fabric-service-model-schema-complex-types.md#serviceandservicegrouptypestype-complextype)|
...
|content|0 элементов, 0 атрибутов|
|определение|локально в сложных типах [ServiceAndServiceGroupTypesType](service-fabric-service-model-schema-complex-types.md#serviceandservicegrouptypestype-complextype) и [ServiceTypesType](service-fabric-service-model-schema-complex-types.md#servicetypestype-complextype)|
...
|определение|локально в элементе Users|
|name|Пользователь|
|maxOccurs|unbounded|
...
Указывает тип учетной записи: LocalUser, DomainUser, NetworkService, LocalService, ManagedServiceAccount или LocalSystem.  По умолчанию используется LocalUser. Локальные учетные записи пользователя создаются на компьютерах, на которых развернуто приложение. По умолчанию эти учетные записи имеют одинаковые имена, заданные здесь. Вместо этого они создаются динамически и имеют случайные пароли. Поддерживаются следующие типы учетных записей локальной системы: LocalUser, NetworkService, LocalService и LocalSystem. Учетные записи домена поддерживаются в развертываниях Windows Server, в которых находится Azure Active Directory.
...
|content|0 элементов, 0 атрибутов|
|определение|локально в элементе Votes|
|name|Vote|
|maxOccurs|unbounded|
