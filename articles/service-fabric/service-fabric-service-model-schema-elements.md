...
|type|xs:string|
|use|дополнительный|
|значение по умолчанию|SharedProcess|
...
|name|AccountType|
|use|дополнительный|
|значение по умолчанию|LocalUser|
