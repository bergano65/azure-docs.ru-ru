...
|содержимое|0 элементов, 0 атрибутов|
|defined|локально в [ConfigPackagePoliciesType complexType](service-fabric-service-model-schema-complex-types.md#configpackagepoliciestype-complextype)|
|name|ConfigPackage|
|minOccurs|0|
|maxOccurs|unbounded|
...
|содержимое|0 элементов, 0 атрибутов|
|defined|локально в [NetworkPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#networkpoliciestype-complextype)|
...
|---|---|
|тип|анонимный complexType|
|содержимое|6 элементов, 2 атрибута|
...
|содержимое|0 элементов, 0 атрибутов|
|defined|локально в [ContainerNetworkPolicyType complexType](service-fabric-service-model-schema-complex-types.md#containernetworkpolicytype-complextype)|
...
|содержимое|0 элементов, 0 атрибутов|
|defined|локально [EnvironmentOverridesType complexType](service-fabric-service-model-schema-complex-types.md#environmentoverridestype-complextype)|
...
|содержимое|0 элементов, 0 атрибутов|
|defined|локально в [EnvironmentVariablesType complexType](service-fabric-service-model-schema-complex-types.md#environmentvariablestype-complextype)|
|name|EnvironmentVariable|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="parameter-element-defined-in-parameters"></a>Элемент Parameter, определенный в параметрах
...
## <a name="parameter-element-defined-in-section"></a>Элемент Parameter, определенный в разделе
...
Если значение равно True, то значение этого параметра шифруется. За создание сертификата и использование командлета Invoke-ServiceFabricEncryptSecret для шифрования конфиденциальной информации отвечает разработчик приложения. Сведения о сертификате, который будет использоваться для шифрования значения, указываются в разделе сертификатов. Этот атрибут нерекомендуемый. Используйте атрибут Type.
...
Это значение определяет тип значения, указанного в атрибуте "value". Это может быть Секретссторереф/encrypted/PlainText.
Если задано значение Секретссторереф, извлекается ссылка из Секретсторе.
Если задано значение Encrypted, разработчик приложения несет ответственность за создание сертификата и использование командлета Invoke-ServiceFabricEncryptSecret для шифрования конфиденциальных данных.
...
|содержимое|0 элементов, 0 атрибутов|
|defined|локально в [ServicePackageContainerPolicyType complexType](service-fabric-service-model-schema-complex-types.md#servicepackagecontainerpolicytype-complextype), [ContainerHostPoliciesType complexType](service-fabric-service-model-schema-complex-types.md#containerhostpoliciestype-complextype)|
|name|PortBinding|
|minOccurs|0|
|maxOccurs|unbounded|
...
## <a name="serviceplacementpolicy-element-defined-in-serviceplacementpolicies"></a>Элемент Сервицеплацементполици, определенный в СервицеплацементполиЦиес
Определяет политику размещения службы, которая указывает, должна ли служба выполняться в определенных доменах сбоя кластера.  Это полезно, если кластер охватывает значительные географические расстояния или геополитические регионы.
