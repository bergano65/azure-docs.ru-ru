...
***Проще всего подход к проектированию микрослужб — это отделенная Федерация служб с независимыми изменениями в каждом и согласованном стандарте взаимодействия.** _
...
_ Инкапсулировать клиентский или бизнес-сценарий. Какую проблему вы решаете?
...
***Приложения микрослужб состоят из небольших, независимо версий служб, ориентированных на клиентов, которые взаимодействуют друг с другом по стандартным протоколам с четко определенными интерфейсами.** _
...
_*_Монолитный подход, слева, содержит одну базу данных и уровни конкретных технологий._*_

_*_Подход на основе микрослужб справа имеет граф взаимосвязанных микрослужб, где состояние обычно ограничено микрослужбой и используются различные технологии._*_
...
_*_Целью Service Fabric является решение проблем, связанных с созданием и запуском службы, а также эффективное использование ресурсов инфраструктуры, благодаря чему команды могут решать бизнес-задачи с помощью подхода к микрослужбам._*_
...
_ Платформа, предоставляющая системные службы для развертывания, обновления, обнаружения и перезапуска служб со сбоями, обнаружения служб, маршрутизации сообщений, управления состоянием и мониторинга работоспособности.
...
***Service Fabric не зависит от того, как вы создаете службу, и можете использовать любую технологию. Но он предоставляет встроенные API-интерфейсы программирования, упрощающие создание микрослужб.** _
...
Помните, что вы можете _start и останавливаться на любом из этих этапов *. На следующий этап нет необходимости. 
