---
title: Подготовка автономного кластерного развертывания
...
* Установлена ОС Windows Server (действительные версии: 2012 R2, 2016, 1709, или 1803). Версия Service Fabric 6.4.654.9590 и позже также поддерживает Server 2019 и 1809.
* [.NET Framework 4.5.1 или выше,](https://www.microsoft.com/download/details.aspx?id=40773)полная установка
* [Windows PowerShell 3.0](https://msdn.microsoft.com/powershell/scripting/install/installing-windows-powershell)
* [Служба RemoteRegistry](https://technet.microsoft.com/library/cc754820) должна работать на всех машинах
* СервисНая установка привода должна быть файловой системой NTFS
...
5. Если компьютеры в составе кластера не имеют доступ к Интернету, задайте в конфигурации кластера следующие параметры:
   * Отключить телеметрию: Под *свойствами* набор *"включитьТелеметрия": ложные*
   * Отзвуки автоматической версии Fabric загрузки & уведомлений о том, что текущая версия кластера близится к концу поддержки: Под *свойствами* набор *"fabricClusterAutoupgrade": ложные*
