...
[Azure Key Vault][key-vault-get-started] используется в качестве безопасного места хранения сертификатов, а также как способ получения сертификатов, установленных в кластерах Service Fabric в Azure. Если вы не выполняете развертывание в Azure, то использование хранилища ключей для управления секретами в приложениях Service Fabric не требуется.
