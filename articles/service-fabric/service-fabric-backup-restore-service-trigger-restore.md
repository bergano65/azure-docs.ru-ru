...
Можно отслеживать ход восстановления с помощью [TrackRestoreProgress](service-fabric-backup-restore-service-trigger-restore.md#tracking-restore-progress).
