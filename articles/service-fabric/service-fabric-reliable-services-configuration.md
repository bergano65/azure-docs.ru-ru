...
| енаблестаблереадс |Логическое |False |Включение стабильных операций чтения позволяет вторичным репликам возвращать значения, которые были подтверждено) кворума. |
