...
| Имя | Единицы | Значение по умолчанию | Комментарии |
| --- | --- | --- | --- |
...
| енаблестаблереадс |Логическое значение |Неверно |Включение стабильных операций чтения позволяет вторичным репликам возвращать значения, которые были подтверждено) кворума. |
