---
title: Настройка надежных служб Службы Azure
description: Узнайте о настройке надежных служб состояния в приложении Azure Service Fabric по всему миру и для одной службы.
author: sumukhs
ms.topic: conceptual
ms.date: 10/02/2017
ms.author: sumukhs
...
* **Код** - Конфигурация с помощью кода осуществляется путем создания ReliableStateManager с помощью объекта ReliableStateManagerConfiguration с соответствующим набором опций.
...
| EnableStableReads |Логическое |False |Включение стабильных считывателей ограничивает вторичные реплики возвращающимися значениями, которые были убраны кворумом. |
