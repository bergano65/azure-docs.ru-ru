...
В Azure ARM или локальный шаблона JSON в приведенном ниже примере показано, как изменить общий журнал транзакций, создается для хранения резервных копий надежных коллекций для служб с отслеживанием состояния.
