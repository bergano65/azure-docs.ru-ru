---
title: Отладка приложений Service Fabric Azure в Windows
...
[трассировки событий Windows](/windows/win32/etw/event-tracing-portal) (ETW). Преимущества использования трассировки событий Windows:
...
Service Fabric генерирует события ETW, чтобы разработчики понимали, что происходит в платформе. Если это еще не сделано, следуйте указаниям статьи [Создание первого приложения в Visual Studio](service-fabric-tutorial-create-dotnet-app.md). Эта информация поможет вам получить запущенное и работающее приложение со средством просмотра событий диагностики, показывающим сообщения трассировки.
...
* [Сбор журналов с помощью системы диагностики Azure](./service-fabric-diagnostics-event-aggregation-wad.md)
