---
title: Мониторинг производительности лазурной ткани сервиса
...
| Физический диск (а диск) | Avg. Диск Читать Длина очереди |
| Физический диск (а диск) | Avg. Диск Написать Длина очереди |
| Физический диск (а диск) | Avg. Диск сек/ Читать |
| Физический диск (а диск) | Avg. Диск сек/ Запись |
