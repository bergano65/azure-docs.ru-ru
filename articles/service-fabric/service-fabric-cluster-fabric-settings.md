...
|CleanupApplicationPackageOnProvisionSuccess|Логическое значение, по умолчанию — false |Динамический|Эта конфигурация включает или отключает автоматическую очистку пакета приложения при успешном выполнении. |
