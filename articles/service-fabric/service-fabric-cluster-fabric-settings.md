...
|CleanupApplicationPackageOnProvisionSuccess|Логическое значение, по умолчанию — false |Динамический|Включает или отключает автоматическую очистку пакета приложения при успешном выполнении.<br/> *Рекомендуется использовать `true` .*
