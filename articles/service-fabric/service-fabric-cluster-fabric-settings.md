...
|блоккнодеинупградеконстраинтприорити | Целое число, по умолчанию — 1 |Динамический|Определяет приоритет ограничения емкости: 0 — жесткое; 1: Soft; отрицательный: пропуск  |
