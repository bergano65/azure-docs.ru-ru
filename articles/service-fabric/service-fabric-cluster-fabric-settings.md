...
|ретритрансиентфабрицеррорс|Логическое значение, по умолчанию — true|Статические|Параметр управляет возможностями повтора при вызове Service Fabric API из DnsService. Если эта возможность включена, она повторяет попытку до 3 раз при возникновении временной ошибки.|
...
|блоккнодеинупградеконстраинтприорити | Целое число, по умолчанию — 0 |Динамический|Определяет приоритет ограничения емкости: 0 — жесткое; 1: Soft; отрицательный: пропуск  |
