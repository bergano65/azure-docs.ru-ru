...
description: Узнайте о конфигурациях для реплик служб ы состояния и процессе перенастройки Service Fabric для поддержания согласованности и доступности во время изменения.
author: appi101
ms.topic: conceptual
ms.date: 01/10/2018
ms.author: aprameyr
...
- Перенастройка, при которой изменяется первичная реплика:
    - **Failover**: Failovers являются перенастройками в ответ на сбой запущенного основного.
...
- **Фаза2**: На этом этапе ткань обслуживания гарантирует, что все данные доступны в большинстве копий текущей конфигурации.
...
- **Вниз реплики**: Некоторые фазы реконфигурации требуют большинства реплик в конфигурации, чтобы быть вверх.
...
- [Отчеты о состоянии системы](service-fabric-understand-and-troubleshoot-with-system-health-reports.md)
