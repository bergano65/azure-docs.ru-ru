...
Мы рекомендуем использовать EventStore для быстрого анализа, а также чтобы получить представление о том, как работает кластер, и выполняются ли операции нужным образом.
