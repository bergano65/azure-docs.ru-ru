...
| ИМЯ | Единица | Значение по умолчанию | Примечания |
| --- | --- | --- | --- |
...
| MaxReplicationMessageSize |Байт |50 MB |Максимальный размер данных репликации, которые могут быть переданы в одном сообщении. |
