...
В разделе **Монитор узла** колонки панели мониторинга кластера отображается количество работоспособных и неработоспособных виртуальных машин. Дополнительные сведения о работоспособности кластера см. в статье о [Service Fabric модели][service-fabric-health-introduction]исправности.
