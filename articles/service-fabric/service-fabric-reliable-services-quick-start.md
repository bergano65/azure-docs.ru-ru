...
Надежные коллекции имеют многие операции, выполняемые их `System.Collections.Generic` и `System.Collections.Concurrent` аналоги, за исключением запросов, интегрированных в язык LINQ. Операции в надежных коллекциях являются асинхронными. Это вызвано тем, что операции записи с Reliable Collections выполняют операции ввода-вывода для репликации и сохранения данных на диске.
