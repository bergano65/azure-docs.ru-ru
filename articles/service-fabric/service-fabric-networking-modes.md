---
title: Настройка сетевых режимов для контейнерных услуг
...
>[!WARNING]
>Azure позволяет в общей сложности 65 356 I-х i-х просмотров в виртуальной сети. Сумма количества узлов и количество экземпляров контейнерных услуг (использующих режим Open) не могут превышать 65 356 ИС в виртуальной сети. Для сценариев высокой плотности мы рекомендуем применять сетевой режим NAT. Кроме того, другие зависимости, такие как балансосмлер [нагрузки,](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits) будут иметь другие ограничения для рассмотрения. В настоящее время проверено и доказано, что на узла хитро 50 ИС на узла. 
>
