...
Управление доступом на основе ролей (RBAC) позволяет назначать точное управление доступом к ресурсам Azure.  Подпискам, группам ресурсов и ресурсам можно назначить разные правила доступа.  Правила RBAC наследуются по иерархии ресурсов, если они не переопределены на более низком уровне.  С помощью правил RBAC можно предоставить любому пользователю или группе пользователей в AAD возможность изменять кластер.  Дополнительные сведения в статье [Что такое управление доступом на основе ролей (RBAC)?](../role-based-access-control/overview.md)
...
Дополнительные сведения о группах безопасности см. в [этой статье](../virtual-network/security-overview.md).
