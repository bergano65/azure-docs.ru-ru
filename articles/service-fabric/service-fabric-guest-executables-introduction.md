...
* Возможность обнаружения С помощью функции RESTFUL можно вызвать службу именования Service Fabric, чтобы найти другие службы в кластере. 
