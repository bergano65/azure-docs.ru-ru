...
* **SourceId**: System.FM
* **Свойство**: Состояние.
* **Дальнейшие действия**: Если узел не работает для обновления, он запустится после обновления. В этом случае для состояния работоспособности снова будет установлено значение "ОК". Если узел не возобновляет работу или вышел из строя, необходимо дополнительно проанализировать проблему.
