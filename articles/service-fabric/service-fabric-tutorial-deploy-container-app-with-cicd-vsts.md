...
![Снимок экрана: окно "Team Explorer — синхронизация" в Visual Studio. В разделе "Отправить в Azure DevOps" выделена кнопка "Опубликовать репозиторий Git".][push-git-repo]
...
![Снимок экрана: окно "Отправить в Azure DevOps". Выделены параметры для адреса электронной почты, учетной записи, имени репозитория и кнопка "Опубликовать репозиторий".][publish-code]
...
![Снимок экрана: приложение для голосования в Service Fabric Explorer. На вкладке "Основные компоненты" выделена версия приложения 1.0.0.20170815.3.][sfx1]
...
![Снимок экрана: приложение для голосования в Service Fabric Explorer. Выделено сообщение "Выполняется обновление", и в разделе состояния приложения указано "Обновление".][sfx2]
...
![Снимок экрана: приложение для голосования в Service Fabric Explorer. На вкладке "Основные компоненты" выделена версия обновленного приложения 1.0.0.20170815.4.][sfx3]
