...
* Узнайте больше об [оповещениях](../log-analytics/log-analytics-alerts.md) Azure Monitor, которые помогут в обнаружении и диагностике.
...
* Более подробные сведения о журналах Azure Monitor и их возможностях см. в статье [Что такое журналы Azure Monitor?](../operations-management-suite/operations-management-suite-overview.md)
