...
* Узнайте больше об [оповещениях](../azure-monitor/platform/alerts-overview.md) Azure Monitor, которые помогут в обнаружении и диагностике.
