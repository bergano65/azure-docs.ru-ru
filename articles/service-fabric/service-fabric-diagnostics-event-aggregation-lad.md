---
title: Агрегация событий с linux Azure Диагностика
...
Один из способов отправки и сбора журналов заключается в использовании расширения системы диагностики Azure для Linux (LAD), которое отправляет журналы в службу хранилища Azure, а также может отправлять журналы в Azure Application Insights или Центры событий. Можно также использовать внешний процесс для чтения событий из хранилища и их размещения в продукте аналитической платформы, например в [журналах Azure Monitor](../log-analytics/log-analytics-service-fabric.md) или другом решении для анализа журналов.
...
[Мониторинг и диагностика услуг в локальной установке разработки машины.](service-fabric-diagnostics-how-to-monitor-and-diagnose-services-locally-linux.md)
