...
1. Моделирование и создание сбои, которые могут возникнуть в реальных сценариях: Одним из важных аспектов Service Fabric — их применение позволяет распределенным приложениям восстановиться после различных сбоев. Однако чтобы убедиться, что приложение может восстанавливаться после этих сбоев, нам нужен механизм моделирования и создания таких реальных сбоев в управляемой тестовой среде.
1. Возможность создания коррелированных ошибок: Основные сбои в системе, таких как сбои сети и аппаратные сбои, можно легко создавать по отдельности. Создание значительного количества сценариев, возможных в реальном мире в результате взаимодействия этих отдельных ошибок, — нетривиальная задача.
1. Унифицированное взаимодействие для разных уровней разработки и развертывания: Существует множество систем внесения ошибок, которые могут выполнять различных типов сбоев. Однако эти возможности уменьшаются, когда мы переходим от универсальных сценариев разработки к выполнению аналогичных проверок в больших тестовых средах и в рабочей среде.
