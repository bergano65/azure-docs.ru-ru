...
[Кластер Service Fabric](service-fabric-deploy-anywhere.md) — это подключенный к сети набор виртуальных или физических машин, в котором развертываются и управляются микрослужбы. Кластеры можно масштабировать до нескольких тысяч машин.
