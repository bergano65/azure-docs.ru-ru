...
1. Получите правила NAT для входящих подключений для протокола удаленного рабочего стола (RDP).
    ...
    Обычно у каждого типа узла, определенного в кластере, есть собственные виртуальные IP-адреса и выделенная подсистема балансировки нагрузки. По умолчанию именем подсистемы балансировки нагрузки для типа узла в следующем формате: *LB-{имя кластера}-{тип узла}* , например *LB-mycluster-FrontEnd*. 
