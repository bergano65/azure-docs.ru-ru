---
title: Жизненный цикл Reliable Services Service Fabric Azure
description: Сведения о событиях жизненного цикла в приложении Azure Service Fabric Reliable Services, использующем Java для служб с отслеживанием состояния и без отслеживания состояния.
...
Исключения, создаваемые Service Fabric, являются либо постоянными [( `FabricException` )](/java/api/system.fabric.exception) , либо временными [( `FabricTransientException` )](/java/api/system.fabric.exception.fabrictransientexception). Постоянные исключения должны быть зарегистрированы в журнале и отброшены. Для временных исключений возможен повтор в соответствии с логикой повтора.
