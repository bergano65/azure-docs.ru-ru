---
title: Лазурная служба Ткань CLI- sfctl sa-кластер
description: Узнайте о sfctl, интерфейсе командной строки Azure Service Fabric. Включает список команд для управления автономными кластерами.
author: jeffj6123
ms.topic: reference
ms.date: 1/16/2020
ms.author: jejarry
