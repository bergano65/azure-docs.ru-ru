...
| **Name** | **Допустимые значения** | ** --- ** | **Рекомендация или краткое описание** |
| --- | --- | --- | --- |
...
| durabilityLevel | Бронзовая, серебристая, золотость, Platinum | --- | время, отведенное на приостановку работы неизменяемой инфраструктуры Azure |
| енаблепараллелжобс | Значение true или false | --- | Включите COMPUTE Параллелжобс, например Remove VM и перезагрузите виртуальную машину в том же масштабируемом наборе параллельно |
