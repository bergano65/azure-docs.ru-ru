...
Давайте рассмотрим простой пример. Если для создания службы на уровне района выборах, можно создать секции для каждого города в округе. Затем в секции вы сохраняете голоса каждого человека в городе, который относится к соответствующей секции. На рис. 3 приведен набор людей и городов, в которых они находятся.
