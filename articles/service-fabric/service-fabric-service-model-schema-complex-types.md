...
|Атрибут|Value|
|---|---|
|контент|9 элементов, 0 атрибутов|
|defined|globally|
...
|Атрибут|Value|
|---|---|
|контент|0 элементов, 8 атрибутов|
|defined|globally|
...
|Атрибут|Value|
|---|---|
|контент|10 элементов, 8 атрибутов|
|defined|globally|
...
|Атрибут|Value|
|---|---|
|контент|4 элемента, 10 атрибутов|
|defined|globally|
...
|Атрибут|Value|
|---|---|
|контент|21 элемент, 0 атрибутов|
|defined|globally|
...
|Атрибут|Value|
|---|---|
|контент|2 элемента, 7 атрибутов|
|defined|globally|
...
|Атрибут|Value|
|---|---|
|контент|0 элементов, 12 атрибутов|
|defined|globally|
...
Ограничения памяти (в МБ). Это должно быть положительное целое число. Пакеты кода (контейнеры или процессы) не могут выделить больше памяти, чем задано ограничением, а при попытке сделать это возникнет проблема нехватки памяти.
...
Общий объем используемой памяти подкачки, в МБ. Это должно быть положительное целое число.
...
Мягкое ограничение (в МБ) для управления памятью, которое применяется, только когда на узле обнаруживается состязание за память. Это должно быть положительное целое число.
...
Относительный вес ЦП. Это должно быть положительное целое число.
...
Процент доступных используемых ЦП (только для Windows). Это должно быть положительное целое число. Если ограничения ресурсов ЦП указаны для пакета службы, этот параметр игнорируется.
...
Максимальная скорость ввода-вывода (чтение и запись) с точки зрения операций ввода-вывода, которые могут использоваться. Это должно быть положительное целое число.
...
Максимальная скорость ввода-вывода (в байтах в секунду), которую можно использовать (чтение и запись). Это должно быть положительное целое число.
...
Дисковая квота для контейнеров.  Это должно быть положительное целое число.
...
Ограничения памяти ядра в байтах.  Это должно быть положительное целое число.  Обратите внимание, что это применимо только для Linux. При использовании данного атрибута в Docker на платформе Windows возникнет ошибка.
...
Размер /dev/shm в байтах. Если размер не указан, система использует 64 МБ.  Это должно быть положительное целое число.  Обратите внимание, что это применимо только для Linux. Однако при использовании данного атрибута в Docker ошибка не возникнет.  Атрибут просто будет проигнорирован.
...
Права, которые необходимо предоставить: на чтение, изменение или полные права. Значение по умолчанию — на чтение.
...
|Атрибут|Value|
|---|---|
|контент|11 элементов, 0 атрибутов|
|defined|globally|
...
Предел ЦП в количестве логических ядер. Это должно быть положительное целое число.
...
#### <a name="memoryinmb"></a>MemoryInMB
Ограничения памяти (в МБ). Это должно быть положительное целое число.
...
|Атрибут|Value|
|---|---|
|контент|11 элементов, 4 атрибута|
|defined|globally|
...
|Атрибут|Value|
|---|---|
|контент|5 элементов, 2 атрибута|
|defined|globally|
|name|ServiceType|
...
|Атрибут|Value|
|---|---|
|контент|0 элементов, 11 атрибутов|
|defined|globally|
