...
|name|EntryPointType|
|use|дополнительный|
|значение по умолчанию|Главная ветвь|
...
|use|дополнительный|
|значение по умолчанию|DedicatedProcess|
...
|name|Type|
|use|дополнительный|
|значение по умолчанию|Внутренние|
...
|---|---|
|name|X509FindType|
|значение по умолчанию|FindByThumbprint|
...
|name|Контекст|
|use|дополнительный|
|значение по умолчанию|приложение|
...
|name|ResourceType|
|use|дополнительный|
|значение по умолчанию|Конечная точка|
