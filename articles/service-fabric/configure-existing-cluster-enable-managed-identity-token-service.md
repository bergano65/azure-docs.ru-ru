...
ms.locfileid: "68964032"
---
# <a name="configure-an-existing-azure-service-fabric-cluster-to-enable-managed-identity-support"></a>Настройка существующего кластера Azure Service Fabric для включения поддержки управляемого удостоверения
