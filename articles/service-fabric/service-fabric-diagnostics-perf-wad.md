---
title: Мониторинг производительности с помощью диагностики Windows Azure
...
* Посетите [конструктор WadCfg,](https://azure.github.io/azure-diagnostics-tools/config-builder/) чтобы создать шаблон с нуля и убедиться, что ваш синтаксис правильный. (чтобыhttps://azure.github.io/azure-diagnostics-tools/config-builder/) построить шаблон с нуля и убедитесь, что ваш синтаксис является правильным.
