---
title: Отчеты и проверка работоспособности с помощью Azure Service Fabric
...
---
# <a name="report-and-check-service-health"></a>Отчеты и проверка работоспособности служб
