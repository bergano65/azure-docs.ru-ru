---
title: Разработка модульных тестов для служб состояния
description: Узнайте о модульном тестировании в Azure Service Fabric для служб состояния и особых соображениях, которые следует учитывать при разработке.
ms.topic: conceptual
ms.date: 09/04/2018
...
*ServiceFabric.Mocks не принадлежит и не обслуживается корпорацией Майкрософт. Тем не менее, это в настоящее время Microsoft рекомендуется библиотека для модульного тестирования государственных служб.*
