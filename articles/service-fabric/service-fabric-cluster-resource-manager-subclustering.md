...
* Служба A — имеет ограничение на размещение "NodeType = = тип1", сообщает о загрузке 10
* Служба B — имеет ограничение на размещение "NodeType = = тип1", сообщает о загрузке 10
* Служба C — имеет ограничение на размещение "NodeType = = тип2", сообщает о загрузке 100
* Служба D — имеет ограничение на размещение "NodeType = = тип2", сообщает о загрузке 100
* И у нас есть четыре узла. Два из них имеют тип данных NodeType, а другие два — "тип2".
