...
-   Чтобы обновить Buildship, ознакомьтесь со статьей [Eclipse Buildship: Eclipse Plug-ins for Gradle][buildship-update] (Eclipse Buildship. Подключаемые модули Eclipse для Gradle).
...
1. В **работать с** введите https:\//dl.microsoft.com/eclipse.
2. Щелкните **Добавить**.
...
Сведения о том, как быстро развернуть написанное на Java приложение Reliable Services в Service Fabric в защищенный кластер Linux, см. в статье [Краткое руководство. Развертывание приложения надежных служб Java в Service Fabric](./service-fabric-quickstart-java-reliable-services.md).
...
- Инструкции по быстрому созданию, локальному развертыванию и развертыванию в Azure приложения надежной службы Java см. в статье [Краткое руководство. Развертывание приложения надежных служб Java в Service Fabric](./service-fabric-quickstart-java-reliable-services.md).
