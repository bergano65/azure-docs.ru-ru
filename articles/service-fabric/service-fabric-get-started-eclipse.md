---
title: Плагин Azure Service Fabric для Eclipse
description: Узнайте о том, как начать работу с Azure Service Fabric на Java с помощью eclipse and Service Fabric предоставил плагин.
author: rapatchi
ms.topic: conceptual
ms.date: 04/06/2018
ms.author: rapatchi
...
> [!IMPORTANT]
> Убедитесь, что JDK 8 установлен на системе и выбран в Eclipse.
...
-   Чтобы проверить версии установленных компонентов, в Eclipse, перейдите, чтобы **помочь** > **о Eclipse** > **Установка Подробная информация**.
...
-   Чтобы проверить и установить обновления для Eclipse, перейдите на **справку** > **Проверить обновления.**

Установите плагин Service Fabric в Eclipse, перейдите на **помощь** > **в установке нового программного обеспечения.**
1. В **работе с** коробкой введите https:\//dl.microsoft.com/eclipse.
...
1. Чтобы проверить наличие доступных обновлений, перейдите на **помощь** > **о Eclipse** > **Установка Подробная информация**. 
...
1.  В Eclipse, перейдите на **файл** > **Новый** > **Другой**. Выберите **Service Fabric Project** (Проект Service Fabric) и нажмите кнопку **Next** (Далее).
...
5.  Чтобы убедиться, что ваше приложение работает, откройте Service [http://localhost:19080/Explorer](http://localhost:19080/Explorer)Fabric Explorer на локальном кластере в окне браузера. Разверните узел **приложений** и проверьте, работает ли приложение. 
...
Для быстрого рассмотрения работы по развертыванию приложения Service Fabric Reliable Services, написанного на Java, в безопасный кластер Linux, [см.](./service-fabric-quickstart-java-reliable-services.md)
...
1. В Eclipse перейдите на конфигурации **Run** > **Run.**
...
1.  Перейти к **запуску** > **Конфигурации**. Щелкните небольшую стрелку слева от **Gradle Project** (Проект Gradle) в области слева.
...
- Для быстрых шагов по созданию приложения Java Reliable service и [Quickstart: Deploy a Java Reliable Services application](./service-fabric-quickstart-java-reliable-services.md)развертыванию его локально и в Azure см.
