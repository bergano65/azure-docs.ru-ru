---
title: 'Подсистема тестирования: Взаимодействие между службами | Документация Майкрософт'
...
### <a name="test-it-move-service-instances"></a>Проверьте его: Перемещение экземпляров службы
...
### <a name="test-it-write-operation-unavailability"></a>Проверьте его: Недоступность операции записи
