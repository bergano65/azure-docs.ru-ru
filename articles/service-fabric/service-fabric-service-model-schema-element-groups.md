---
title: Группы элементов схемы XML модели службы Service Fabric Azure
...
ms.locfileid: "84700874"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>Элементы XML-схемы Service Fabric модели службы
