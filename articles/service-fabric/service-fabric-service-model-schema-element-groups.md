---
title: Модель службы Службы Службы Azure Fabric XML группы элементов схемы
...
# <a name="service-fabric-service-model-xml-schema-elements"></a>Сервисная модель XML-схема модели XML
