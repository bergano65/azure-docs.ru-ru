---
title: Непрерывная сборка для приложений Linux с помощью Jenkins
...
1. Войдите на портал Jenkins, сделав следующее.
   ...
   1. (Необязательно.) После первого входа можно создать собственную учетную запись пользователя и использовать ее для выполнения следующих действий. также можно продолжить использовать учетную запись администратора. Если вы создадите пользователя, вам потребуется использовать его для последующих действий.
