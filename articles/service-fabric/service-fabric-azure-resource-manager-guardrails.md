...
* Если уровень надежности — бронзовый, выполните следующие [действия](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-scale-in-out#manually-remove-vms-from-a-node-typevirtual-machine-scale-set) для корректного масштабирования кластера.
