...
Ниже приведен пример приложения, использующего службы с отслеживанием состояния: ![Application, использующий службы с отслеживанием состояния @ no__t-1
