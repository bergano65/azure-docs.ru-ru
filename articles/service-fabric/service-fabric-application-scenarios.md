...
Ниже приведен пример приложения, использующего службы с отслеживанием состояния: ![Приложение, использующее службы без отслеживания состояния][Image2]
