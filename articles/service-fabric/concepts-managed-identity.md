---
title: Общие сведения об управляемом удостоверении Service Fabric
description: Эта статья содержит общие сведения об управляемом удостоверении и его приложениях в Azure Service Fabric.
ms.topic: conceptual
ms.date: 12/09/2019
