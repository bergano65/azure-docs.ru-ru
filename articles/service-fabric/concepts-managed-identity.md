...
---
# <a name="using-managed-identities-for-azure-with-service-fabric-preview"></a>Использование управляемых идентификационных данных для Azure с помощью сервисной ткани (Предварительный просмотр)
...
В настоящее время для этой функции предварительного просмотра поддерживаются следующие сценарии:
...
- Служба Поддержки ткани для управляемых идентификационных данных в настоящее время не интегрирована в [AzureServiceTokenProvider;](../key-vault/service-to-service-authentication.md) интеграция будет достигнута к концу периода предварительного просмотра функции управляемой идентификации.

>
> [!NOTE]
>
> Эта функция предоставляется в предварительной версии. Он может подвергаться частым изменениям и не подходит для развертывания продукции.
