...
| Silver           | 5                              | Виртуальные машины с одним ядром или более, по крайней мере 50 ГБ локального SSD                      | Можно отложить до утверждения кластером Service Fabric | Задержка на любой значительный период времени невозможна                                                    |
| Bronze           | 1                              | Виртуальные машины с размером не менее 50 ГБ локального SSD                                              | Не будет задержано кластером Service Fabric           | Задержка на любой значительный период времени невозможна                                                    |
