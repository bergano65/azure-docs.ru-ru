...
> Независимо от уровня устойчивости операция [Перераспределение](https://docs.microsoft.com/en-us/rest/api/compute/virtualmachinescalesets/deallocate) в масштабируемом наборе виртуальных машин уничтожит кластер.
