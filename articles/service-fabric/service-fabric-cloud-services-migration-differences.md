...
[Облачные службы похожи на Service Fabric в степени контроля и простоты использования, но теперь для новой разработки рекомендуется использовать устаревшую службу и Service Fabric](https://docs.microsoft.com/azure/app-service/overview-compare). Ниже приведено сравнение API:
