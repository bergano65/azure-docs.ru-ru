---
title: Регулятор ingress на внутренней сети
...
Теперь получите доступ к адресу вашего `curl`контроллера *http://10.240.0.42*входа Kubernetes с помощью, например. Укажите свой внутренний IP-адрес, указанный при развертывании контроллера входящего трафика на первом шаге, описанном в этой статье.
