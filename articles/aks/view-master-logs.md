...
Журналы аудита записываются в две категории: *KUBE-Audit-Admin* и *KUBE-Audit*. Категория *KUBE-Audit* содержит все данные журнала аудита для каждого события аудита, включая *Получение*, *перечисление*, *Создание*, *Обновление*, *Удаление*, *исправление*и *запись*.
...
Включение и отображение журналов диагностики может занять несколько минут.
