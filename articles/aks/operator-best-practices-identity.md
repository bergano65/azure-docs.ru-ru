...
Чтобы создать кластер AKS, которое использует Azure AD, см. в разделе [интегрировать Azure Active Directory с AKS][aks-aad].
...
Чтобы использовать удостоверения pod, см. в разделе [удостоверения Azure Active Directory для приложений Kubernetes][aad-pod-identity].
