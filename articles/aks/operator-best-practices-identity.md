...
> * Управление доступом к ресурсам с помощью Kubernetes управления доступом на основе ролей (RBAC)
...
## <a name="use-kubernetes-role-based-access-controls-rbac"></a>Использование элементов управления доступом на основе ролей Kubernetes (RBAC)
...
2. Доступ к API Kubernetes. Этот уровень доступа управляется либо с помощью [KUBERNETES RBAC](#use-kubernetes-role-based-access-controls-rbac) (традиционного), либо путем интеграции Azure RBAC с AKS для авторизации Kubernetes.
