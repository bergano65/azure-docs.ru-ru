...
> [!NOTE]
> Диск Azure можно подключить только к одному pod за один раз. Если вам нужно использовать постоянный том между несколькими модулями POD, используйте [файлов Azure][azure-files-volume].
...
Дополнительные сведения о AKS кластеров, взаимодействуют с дисками Azure, см. в разделе [подключаемый модуль Kubernetes для дисков Azure][kubernetes-disks].
