...
Теперь назначьте субъекту-службе для вашего кластера AKS разрешения *участника* в виртуальной сети с помощью команды [AZ Role назначение Create][az-role-assignment-create] . Укажите собственный *\<appId >* , как показано в выходных данных предыдущей команды, чтобы создать субъект-службу.
