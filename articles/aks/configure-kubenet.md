...
Теперь назначьте субъекту-службе кластера AKS разрешение *Участник* для виртуальной сети с помощью команды [az role assignment create][az-role-assignment-create]. Укажите собственные * \< AppID>* , как показано в выходных данных предыдущей команды для создания субъекта-службы.
