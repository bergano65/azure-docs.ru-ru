...
2. Второе значение — регрессивная скорость резервирования памяти для правильного функционирования кубелетского даймона (кубе-зарезервировано).
