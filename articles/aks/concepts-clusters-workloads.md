...
Дополнительные сведения см. в разделе жизненный цикл [Kubernetes][kubernetes-pods] Pods и [Kubernetes Lifecycle][kubernetes-pod-lifecycle].
