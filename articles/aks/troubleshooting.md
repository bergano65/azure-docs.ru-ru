...
## <a name="im-getting-a-quota-exceeded-error-during-creation-or-upgrade-what-should-i-do"></a>Я получаю ошибку превышения квоты во время создания или обновления. Что делать? 
 ...
 [Запросить еще ядер](https://docs.microsoft.com/azure/azure-portal/supportability/resource-manager-core-quotas-request).
...
При использовании подключаемого модуля CNI для сети Azure AKS выделяет IP-адреса на основе параметра "--max-pods" для узла. Размер подсети должен быть больше, чем количество узлов, помноженное на максимальное значение параметра числа pod на узел. Следующее выражение описывает это:
...
## <a name="i-created-a-cluster-with-rbac-enabled-and-now-i-see-many-warnings-on-the-kubernetes-dashboard-the-dashboard-used-to-work-without-any-warnings-what-should-i-do"></a>Я создал кластер с включенным RBAC, и теперь я вижу много предупреждений на панели мониторинга Kubernetes. Ранее на панели мониторинга не возникало никаких предупреждений. Что делать?
