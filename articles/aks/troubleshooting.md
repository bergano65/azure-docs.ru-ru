...
Эти ошибки также отображаются в [AKS Diagnostics](https://docs.microsoft.com/azure/aks/concepts-diagnostics) , которые заблаговременно выводят проблемы, например недостаточный размер подсети.
