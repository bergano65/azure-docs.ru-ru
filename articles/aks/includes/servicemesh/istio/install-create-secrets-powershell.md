...
---
### <a name="add-grafana-secret"></a>Добавить Графана Секрет

Замените `REPLACE_WITH_YOUR_SECURE_PASSWORD` маркер паролем и запустите следующие команды:
...
### <a name="add-kiali-secret"></a>Добавить Киали Секрет
