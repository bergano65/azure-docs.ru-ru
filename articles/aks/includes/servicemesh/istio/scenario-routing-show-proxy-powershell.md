...
Контейнер `istio-proxy` был автоматически введен Istio для управления сетевым трафиком к компонентам и из него, как показано в следующем выводе примера:
