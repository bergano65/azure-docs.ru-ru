...
---
В оболочке на основе PowerShell в Windows используйте `Invoke-WebRequest` для загрузки выпуска Consul Helm Chart, а затем извлеките с помощью `Expand-Archive` следующим образом:
