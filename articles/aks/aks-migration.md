...
В кластерах AKS, поддерживающих [группы доступности виртуальных машин](../virtual-machine-scale-sets/availability.md#availability-sets) , отсутствует поддержка многих из этих функций.
