...
Можно также прочитать рекомендации по [безопасность кластера][best-practices-cluster-security] and for [pod security][best-practices-pod-security].
...
Дополнительные сведения об обновлениях базовый образ, см. в разделе [автоматизация образ основан на обновление базового образа с реестром контейнеров Azure][acr-base-image-update].
...
* [Автоматизация создания образов при обновлении базового образа с реестром контейнеров Azure][acr-base-image-update]
