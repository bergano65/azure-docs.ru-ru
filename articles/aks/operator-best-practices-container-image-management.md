...
Вы также можете использовать [безопасность контейнеров в Центре безопасности,][security-center-containers] чтобы помочь сканировать контейнеры на наличие уязвимостей.  Существует также [интеграция реестра контейнеров Azure][security-center-acr] с Центром безопасности, чтобы помочь защитить ваши изображения и реестр от уязвимостей.
