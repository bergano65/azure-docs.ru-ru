...
- [Kubernetes управления доступом на основе ролей (Kubernetes RBAC)](#kubernetes-role-based-access-control-kubernetes-rbac)
  ...
  - [Учетные записи службы Kubernetes](#kubernetes-service-accounts)
