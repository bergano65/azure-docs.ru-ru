---
title: Рекомендации по изоляции кластера в Службе Azure Kubernetes (AKS)
...
* **Контейнеры** включают в себя надстройку политики Azure для AKS, обеспечивающую безопасность Pod, использование контекстов безопасности Pod и сканирование как образов, так и среды выполнения для уязвимостей. Также они включают использование App Armor или Seccomp (Secure Computing) для ограничения доступа контейнера к базовому узлу.
