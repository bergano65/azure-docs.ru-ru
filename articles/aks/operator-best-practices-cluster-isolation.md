...
Kubernetes предоставляет возможности логической изоляции команд и рабочих нагрузок в одном кластере. Задача — предоставить минимально необходимый набор привилегий для использования ресурсов, которые нужны каждой команде. [Пространство имен][k8s-namespaces] в Kubernetes создает границу логической изоляции. Дополнительные функции Kubernetes и рекомендации по изоляции и мультитенантность включают в себя следующие области:
