...
> [!NOTE]
Средство автомасштабирования кластера принимает решение по масштабированию на основе минимального и максимального количества, заданного для каждого пула узлов, но не применяет эти значения принудительно. Например, если минимальное число узлов равно 5, а текущее их количество — 3, размер пула не будет незамедлительно масштабирован до 5. При изменении минимального числа в пуле узлов на значение, превышающее текущее число узлов, это новое предельное значение будет учитываться при наличии достаточного количества внеплановых pod. Для этого требуются 2 новых дополнительных узла и активация события автомасштабирования. После этого в средстве автомасштабирования кластера будет применяться новое минимально допустимое количество узлов.
