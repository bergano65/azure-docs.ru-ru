...
Кластеры Kubernetes, созданные с помощью подсистемы AKS, поддерживают оба подключаемых модуля [кубенет][kubenet] and [Azure CNI][cni-networking] . Таким образом, обработчик AKS поддерживает оба сценария сети.
