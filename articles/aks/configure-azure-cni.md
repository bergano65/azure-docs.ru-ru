...
Параметр Макспод на узел можно определить при создании нового пула узлов. Если необходимо увеличить параметр Макспод для каждого узла в существующем кластере, добавьте новый пул узлов с новым требуемым числом Макспод. После переноса модулей Pod в новый пул удалите старый пул. Чтобы удалить все старые пулы в кластере, убедитесь, что вы настраиваете режимы пула узлов, как определено в [пуле узлов системы Document[-node-]Pools.
...
[пулы системных узлов]: use-system-pools.md
