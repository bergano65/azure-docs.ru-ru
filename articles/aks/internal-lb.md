...
При просмотре сведений о службе в столбце IP-адрес внутренней подсистемы балансировки нагрузки отображается в столбце *EXTERNAL-IP*. В этом контексте *внешне* относится к внешнему интерфейсу балансировщика нагрузки, а не к получению общедоступного внешнего IP-адреса. Изменение IP-адреса с * \<ожидания\> * на фактический внутренний IP-адрес может занять одну или две минуты, как показано в следующем примере:
