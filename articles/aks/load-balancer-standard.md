...
* Его нельзя использовать с компонентом [общедоступного IP-адреса узла](use-multiple-node-pools.md#assign-a-public-ip-per-node-in-a-node-pool).
