...
Кластер AKS должен быть развернут в существующей виртуальной сети с настроенной подсетью. При использовании архитектуры "Стандартный балансировщик нагрузки" (SLB) необходимо установить явный выход. Для этого необходимо отправить исходящие запросы на устройство, например брандмауэр, шлюз, локально или разрешить исходящий трафик общедоступным IP-адресом, назначенным стандартному подсистеме балансировки нагрузки или данному узлу.
