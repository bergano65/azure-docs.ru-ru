...
| Вариант использования  | Подключаемый модуль тома | Для чтения и записи, индивидуально | Только для чтения, совместно | Для чтения и записи, совместно |
|----------|---------------|-----------------|----------------|-----------------|
| Конфигурация совместного использования       | Файлы Azure   | Yes | Да | Yes |
| Структурированные данные приложения        | Диски Azure   | Yes | Нет   | Нет   |
| Данные приложения, общие ресурсы только для чтения | [Dysk (предварительная версия)][dysk] | Yes | Да | Нет   |
| Неструктурированные данные, операции файловой системы | [BlobFuse (предварительная версия)][blobfuse] | Yes | Да | Yes |
