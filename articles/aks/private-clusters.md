...
* Виртуальные узлы в частном кластере не поддерживаются для прокрутки частных экземпляров инфраструктуры Cisco Application-Infrastructure (ACI) в частной виртуальной сети Azure.
