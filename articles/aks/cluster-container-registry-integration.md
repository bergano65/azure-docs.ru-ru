...
/Subscriptions/\<subscription-ID @ no__t-1/resourceGroups/\<resource-Group-Name @ no__t-3/providers/Microsoft. ContainerRegistry/registrys/\<name @ no__t-5 
...
Используйте следующую команду для входа в запись контроля доступа.  Замените параметр <acrname> именем записи контроля доступа.  Например, значение по умолчанию — **aks < > записи контроля доступа для группы ресурсов**.
