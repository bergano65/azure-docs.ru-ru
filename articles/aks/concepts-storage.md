...
- *default* — использует службу хранилища Azure ценовой категории "Стандартный" для создания управляемого диска. Политика reclaimа указывает, что базовый диск Azure удаляется при удалении постоянного тома, который использовался для удаления.
