...
См. дополнительные сведения о [делегировании прав доступа другим ресурсам Azure в AKS][sp-delegation]. Вместо субъекта-службы можно также использовать управляемое удостоверение, назначенное системой, для разрешений. Дополнительные сведения см. в статье о том, [как использовать управляемые удостоверения](use-managed-identity.md).
