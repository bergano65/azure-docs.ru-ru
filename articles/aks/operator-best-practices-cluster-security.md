...
> [!div class="checklist"]
> * Использование Azure Active Directory и управления доступом на основе ролей (RBAC) для безопасного доступа к серверу API
