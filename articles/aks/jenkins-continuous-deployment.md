---
title: Непрерывное развертывание Jenkins c помощью Службы Azure Kubernetes
description: Сведения о том, как автоматизировать процесс непрерывного развертывания с помощью Jenkins для развертывания и обновления контейнерного приложения в Службе Azure Kubernetes
...
Для быстрого развертывания обновлений в Службе Azure Kubernetes (AKS) часто используется платформа непрерывной интеграции и непрерывной поставки (CI/CD). На платформе CI/CD фиксация кода может активировать новую сборку контейнера, которая затем используется, чтобы развернуть обновленный экземпляр приложения. В рамках этой статьи в качестве платформы CI/CD используется инструмент Jenkins, с помощью которого выполняется сборка и отправка образов контейнеров в Реестр контейнеров Azure (ACR), а затем и запуск этих приложений в AKS. Вы узнаете, как выполнять следующие задачи:

> [!div class="checklist"]
> * развертывание примера приложения для голосования Azure в кластере AKS;
> * создание базового экземпляра Jenkins;
...
> * тестирование конвейера CI/CD для обновления приложения в AKS на основе фиксаций кода GitHub.
