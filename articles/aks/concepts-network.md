...
Хотя такие возможности, как конечные точки службы или определяемые пользователем маршруты, поддерживаются как в кубенет, так и в Azure CNI, [политики поддержки для AKS][support-policies] определяют, какие изменения можно выполнить. Например:
