...
* **Azure CNI**
    * Модули Pod получают полное подключение к виртуальной сети и могут быть непосредственно достигнуты извне кластера.
