...
Кроме того, для получения разрешений можно использовать управляемую идентификацию вместо принципа службы. Управляемые идентификаторы легче управлять, чем принципы обслуживания, и не требуют обновлений или вращений. Для получения дополнительной информации [см.](use-managed-identity.md)
