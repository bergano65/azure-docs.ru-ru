...
Обратите внимание, что вместо того, чтобы использовать принцип службы, можно использовать управляемую идентификацию для получения разрешений. Для получения дополнительной информации [см.](use-managed-identity.md)
