...
| Функция                               | Azure                      | Кошка черепахового                      |
|------------------------------------------|----------------------------|-----------------------------|
...
| Ведение журнала                                  | Правила добавления / удаления в IPTables регистрируются на каждом узле в разделе */var/log/azure-npm.log* | Дополнительные сведения см. в разделе [Кошка черепахового компонент журналы][calico-logs] |
...
Чтобы использовать политики сети с кластером AKS, необходимо использовать [Azure подключаемом модуле CNI][azure-cni] and define your own virtual network and subnets. For more detailed information on how to plan out the required subnet ranges, see [configure advanced networking][use-advanced-networking].
...
Применение политики сети с помощью [kubectl применить][kubectl-apply] команду и укажите имя yaml-ФАЙЛ манифеста:
...
Применение политики обновленные сети с помощью [kubectl применить][kubectl-apply] команду и укажите имя yaml-ФАЙЛ манифеста:
...
В этой статье мы создали два пространства имен и применения политики сети. Для очистки этих ресурсов, используйте [kubectl удалить][kubectl-delete] команду и укажите имена ресурсов:
