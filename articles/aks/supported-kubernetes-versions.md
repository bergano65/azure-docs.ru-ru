...
И AKS выпуски 1,16. *это означает, что 1,13.* версии (все версии 1,13) будут удалены и не будут поддерживаться.
...
* Для новых **вспомогательных** версий Kubernetes
  ...
  * Служба поддержки Azure предоставляет клиентам в **течение 30 дней** с общедоступной даты обновления до поддерживаемого дополнительного выпуска версии. По прошествии 30 дней необходимо обновить дополнительную версию, чтобы продолжить получение поддержки.
* Для новых версий **исправлений** Kubernetes
  ...
  * Служба поддержки Azure предоставляет клиентам **30 дней** обновление до поддерживаемого выпуска исправлений после удаления старой версии исправления. По прошествии 30 дней вам потребуется обновить версию исправления, чтобы продолжить получение поддержки.
...
Если в кластере не поддерживается более 3 дополнительных версий и обнаружены угрозы безопасности, Azure обращается к вам для упреждающего обновления кластера. Если вы не предпримете дальнейшие действия, Azure оставляет за собой право принудительно обновить кластер от вашего имени.
