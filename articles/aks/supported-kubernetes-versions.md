...
Новый список поддерживаются версии дополнительный номер версии
-----------------        ----------------------
...
* Для новых **незначительные** версий Kubernetes
  * Все пользователи получают уведомление о новой версии и какие версии будут удалены.
  * Клиенты, использующие версии **удаляемый** получит уведомление, что они имеют **60 дней** обновить до поддерживаемой версии (например, дополнительный номер версии).
