...
Нет, операции масштабирования с использованием API-интерфейсов масштабируемого набора виртуальных машин не поддерживаются. Используйте API AKS (`az aks scale`).
