...
2.  В **мастере развертывания базы данных U-SQL**выберите **учетную запись ADLA** , в которой требуется развернуть базу данных. Поддерживаются оба типа учетных записей — локальные и ADLA.
