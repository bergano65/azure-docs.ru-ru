...
После выполнения этого обновления до .NET Framework 4.7.2 управляемый код системы будет выполняться как версия 4.7.2. пользовательские библиотеки, такие как настраиваемые сборки U-SQL, будут работать в режиме обратной совместимости, подходящем для версии, которая была установлена в сборке. создано для.
