...
### <a name="step-2-configure-the-objects-that-you-want-to-export"></a>Шаг 2. Настройка объектов, которые требуется экспортировать
...
|Импортировать локальную базу данных автоматически|Если выбран этот параметр, то после экспорта экспортированная база данных автоматически импортируется в локальную базу данных.|
