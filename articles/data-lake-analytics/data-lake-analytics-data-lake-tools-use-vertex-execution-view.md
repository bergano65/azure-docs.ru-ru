...
* Общий объем данных чтения/записи: Данные были, прочитанные или записанные этой вершиной.
* Состояние выхода состояния: Конечное состояние, когда завершается вершины.
* Выйти из код/тип сбоя: Ошибка при сбое вершины.
* Причина создания: Почему причина создания вершины.
...
* Идентификатор GUID процесса/создателя: Идентификатор GUID для текущей выполняемой вершины или ее создателя.
