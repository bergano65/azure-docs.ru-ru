...
* обработка изображений: [распознавание лиц](https://github.com/Azure-Samples/usql-cognitive-imaging-ocr-hello-world);
* обработка изображений: [распознавание эмоций](https://github.com/Azure-Samples/usql-cognitive-imaging-emotion-detection-hello-world);
* обработка изображений: [распознавание объектов (добавление тегов)](https://github.com/Azure-Samples/usql-cognitive-imaging-object-tagging-hello-world);
* обработка изображений: [распознавание текста (OCR)](https://github.com/Azure-Samples/usql-cognitive-imaging-ocr-hello-world);
