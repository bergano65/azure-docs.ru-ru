---
title: Разработка операторов, определяемых пользователями U-S'SL - Аналитика Azure Data Lake
...
11. Щелкните элемент **Отправить**. Итоги отправки и ссылка на задание появятся в окне результатов, когда операция отправки будет завершена.
