...
**Максимальное число учетных записей ADLA на подписку в регионе:**  5
...
**Максимальное количество единиц аналитики (кластера AUs) на одну учетную запись:** 32
...
**Максимальное количество единиц аналитики (кластера AUs) на задание:** 32
...
**Максимальное количество одновременно выполняемых заданий U-SQL на учетную запись:** 20
