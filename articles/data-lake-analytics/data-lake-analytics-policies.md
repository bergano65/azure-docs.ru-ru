...
description: Узнайте, как использовать политики для управления использованием учетной записи Data Lake Analytics, например максимума Au и максимум заданий.
...
* **Предел Au на задание**: Пользователи могут отправлять только задания, имеющие до этого числа. По умолчанию это ограничение аналогично максимальному значению единиц использования аналитики для учетной записи.
* **Приоритет**. Пользователи могут отправлять только задания с приоритетом меньше или равным этому значению. Более высокое число указывает на более низкий приоритет. По умолчанию устанавливается значение 1, которое означает максимально возможный приоритет.
...
3. В разделе **Пределы отправки заданий** нажмите кнопку **Добавить политику**. Затем выберите или введите следующие параметры.
    ...
    2. **Выберите пользователя или группу**: Выберите пользователя или группу, к которым применяется эта политика.
    3. **Задайте предел Au для задания**: Задайте предел AU, который будет применяться к выбранному пользователю или группе.
    4. **Задайте ограничение по приоритету**: Задайте ограничение приоритета, которое будет применяться к выбранному пользователю или группе.
