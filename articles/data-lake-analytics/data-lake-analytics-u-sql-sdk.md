...
|-UseDatabase|мастер|База данных, в которой нужно регистрировать временную сборку кода программной части.|
...
### <a name="step-1-create-c-unit-test-project-and-configuration"></a>Шаг 1. Создание C# проекта модульного теста и конфигурации
...
### <a name="step-2-create-u-sql-script-test-case"></a>Шаг 2. Создание тестового случая скрипта U-SQL
...
|Корневой путь к данным|строка|Путь к корневой папке данных.|
...
- Убедитесь, что используется среда x64. Целевая платформа сборки и тестовая среда должны иметь версию x64, см **. шаг 1. Создайте C# проект модульного теста и** конфигурацию, приведенную выше.
