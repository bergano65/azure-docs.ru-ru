...
|--------|-------------|-----------|
|-CodeBehind|Нет|Сценарий содержит код программной части .cs.|
...
|-UdoRedirect|Нет|Создание конфигурации перенаправления сборки Udo.|
|-UseDatabase|master|База данных, в которой нужно регистрировать временную сборку кода программной части.|
|-Verbose|Нет|Отображение подробных выходных данных среды выполнения.|
