...
* **Участник**: может отправлять и отслеживать задания, отменять задания от любого пользователя, а также настраивать учетные записи.
...
1. На портале Azure выберите свою учетную запись Data Lake Analytics.
2. Выберите **Управление доступом (IAM)** > **Добавить назначение роли**.
3. Выберите роль.
...
2. Нажмите кнопку **Создать задание**. Настройте для каждого задания:
    ...
    3. **Параллелизм**. Максимальное количество вычислительных процессов, которые можно зарезервировать для этого задания.
