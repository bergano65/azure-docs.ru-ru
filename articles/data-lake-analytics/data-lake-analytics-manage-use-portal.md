...
2. Нажмите **Создать ресурс** > **Разведка и аналитика** > **данных озера Analytics**.
...
6. Выберите списки управления доступом для файлов. Чтобы использовать хранилище по умолчанию, не изменяйте списки управления доступом для корневой папки "/" и для папки /system. Нажмите **Выберите**.
...
1. На портале Azure выберите свою учетную запись Data Lake Analytics.
2. Нажмите **элемент управления доступом (IAM)** > **Добавить назначение ролей**.
3. Выберите роль.
...
3. Нажмите на вкладку **«Вакансии трубопровода».** Список заданий конвейера будет отображаться вместе с агрегированной статистикой по каждому конвейеру.
...
1. На портале Azure перейдите к своим учетным записям Data Lake Analytics.
2. Выберите **Подробные сведения о заданиях**. По умолчанию на вкладке "Все задания" можно просмотреть список выполняющихся и завершенных заданий, а также заданий, поставленных в очередь.
3. Нажмите на вкладку **Повторяющиеся вакансии.** Список повторяющихся заданий будет отображаться вместе с агрегированными статистическими данными по каждому повторяющемуся заданию.
