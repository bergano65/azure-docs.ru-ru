...
С **помощью инструментов** > **данных озера** > Работа**Просмотр**, вы можете вставить работу URL, чтобы открыть вид на работу в визуальной студии. Выберите **Просмотреть связанные задания**, чтобы открыть представление связанных заданий.
