---
title: Разрешение перекоса данных - Инструменты Azure Data Lake для визуальной студии
...
- SqlUserDefinedCombiner (Mode-CombinerMode.Full): Каждый строка вывода потенциально зависит от всех входных строк слева и справа с одинаковым значением ключа.
