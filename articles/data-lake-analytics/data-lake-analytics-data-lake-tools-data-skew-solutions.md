...
### <a name="option-1-filter-the-skewed-key-value-in-advance"></a>Вариант 1. Отфильтровать отклоненное значение ключа заранее
...
### <a name="option-2-pick-a-different-partition-or-distribution-key"></a>Вариант 2. Выберите другую секцию или ключ распределения
...
### <a name="option-3-add-more-partition-or-distribution-keys"></a>Вариант 3. Добавление дополнительных ключей разделов или распределения
...
### <a name="option-2-use-skewfactor"></a>Вариант 2. Использование SKEWFACTOR
...
### <a name="option-3-use-rowcount"></a>Вариант 3. Использовать ROWCOUNT  
...
## <a name="solution-3-improve-the-user-defined-reducer-and-combiner"></a>Решение 3. Улучшение определяемого пользователем средства сокращения и средства объединения
...
### <a name="option-1-use-a-recursive-reducer-if-possible"></a>Вариант 1. По возможности использовать рекурсивный reduce
...
### <a name="option-2-use-row-level-combiner-mode-if-possible"></a>Вариант 2. Использовать режим средства объединения на уровне строк, если это возможно
...
- qlUserDefinedCombiner(Mode=CombinerMode.Right): Каждая строка выходных данных зависит от одной входной строки справа (и, возможно, всех строк из левой части с тем же значением ключа).

- SqlUserDefinedCombiner (Mode = CombinerMode. Inner): Каждая строка выходных данных зависит от одной входной строки слева и справа с тем же значением.
