---
title: Управление сборками U-S'L в конвейере CI/CD - Azure Data Lake
...
1. Создайте проект Библиотеки классов (для приложения U-S'L), выбрав **файл** > **New** > **Project.** Проект находится в узле **Azure Data Lake > U-SQL**.
...
1. Создайте проект U-S'L, выбрав **файл** > **New** > **Project.** Проект находится в рамках узла **Azure Data Lake** > **U-S'L.**
...
_DeployTempDirectory в окне редактора внизу является заданной переменной, которая указывает инструмент на папку вывода сборки. ** \@** В выходной папке сборки каждая сборка имеет вложенную папку с именем сборки. Все библиотеки DLL, а также дополнительные файлы, находятся в этой вложенной папке.
