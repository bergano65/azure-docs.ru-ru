...
- [Подключение к учетной записи хранения Azure или службе](https://docs.microsoft.com//azure/vs-azure-tools-storage-manage-with-storage-explorer#connect-to-a-storage-account-or-service)
...
1.  Следуйте приведенным ниже инструкциям в зависимости от задачи, которую необходимо выполнить.
    ...
    - **Отправка файлов в общую папку**
        ...
        а.  На панели инструментов основной панели выберите **Отправить**, а затем **отправьте файлы** из раскрывающегося меню.
    ...
    - **Отправка папки в общую папку**
        ...
        а. На панели инструментов основной панели выберите **Отправить**, а затем **отправьте папку** из раскрывающегося меню.
