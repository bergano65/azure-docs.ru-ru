...
- [Подключения к учетной записи хранения Azure или службы](https://docs.microsoft.com//azure/vs-azure-tools-storage-manage-with-storage-explorer#connect-to-a-storage-account-or-service)
...
1. Щелкните правой кнопкой мыши общую папку, которую необходимо удалить, и выберите в контекстном меню команду **Удалить**. Также можно нажать кнопку **Удалить**, чтобы удалить выбранную общую папку.
    ...
    ![Delete (Удалить)](media/vs-azure-tools-storage-explorer-files/image6.png)
