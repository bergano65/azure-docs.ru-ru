...
## <a name="create-an-empty-virtual-hub"></a><a name="hub"></a>Создание пустого виртуального концентратора
...
## <a name="edit-hub-assignment"></a><a name="edit"></a>Изменение назначения концентратора
...
В таблице ниже приведены сведения о доступных **единицах масштабирования**.

| **Единица масштабирования** | **Пропускная способность** | **Подключения типа "точка — сеть"** |
| --- | --- | --- |
| 1| 500 Мбит/с | 500 |
| 2| 1 Гбит/с | 500 |
| 3| 1,5 Гбит/с | 500 |
...
5. Заполните раздел секретного ключа закрытым ключом сертификата клиента P2S в base64. Инструкции см. в статье о том, [как извлечь закрытый ключ](howto-openvpn-clients.md#windows).
