...
Создайте подключение к виртуальной сети из каждой непрямой периферийной виртуальной сети (VNet1 и VNet2) в концентратор. Эти подключения к виртуальной сети показаны синими стрелками на приведенном выше рисунке. Затем создайте подключение к виртуальной сети из виртуальной сети NVA к концентратору (черная стрелка на рисунке). 
