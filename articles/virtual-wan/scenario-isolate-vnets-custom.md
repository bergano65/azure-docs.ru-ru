...
## <a name="scenario-design"></a><a name="design"></a>Проектирование сценария
...
| Исходный тип | В:| *Синий виртуальных сетей* | *Красный виртуальных сетей* | *Ветви*|
|---|---|---|---|---|
