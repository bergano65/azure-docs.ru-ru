...
description: В этом руководстве описано, как развернуть сетевой виртуальный модуль в виртуальном концентраторе глобальной сети.
...
1. На этой странице будет предложено принять условия соглашения о доступе соадминистратора. Это стандарт с управляемыми приложениями, в которых издатель будет иметь доступ к некоторым ресурсам в этом развертывании. Установите флажок **я принимаю условия выше** и нажмите кнопку **создать**.
