...
---
# <a name="automation-guidelines-for-virtual-wan-partners"></a>Рекомендации по автоматизации для партнеров виртуальных глобальных сетей
...
### <a name="custom"></a>Пользовательские политики для подключения IPsec
