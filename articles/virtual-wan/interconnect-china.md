...
## <a name="secure-internet-breakout-for-office-365"></a><a name="secure"></a>Безопасный выход из Интернета для Office 365
...
Все эти параметры используют защищенный концентратор Виртуальной глобальной сети Azure для прямого подключения M365 в Гонконге. Эти архитектуры также поддерживают требования к соответствию для [Office 365 в различных регионах](https://docs.microsoft.com/office365/enterprise/office-365-multi-geo) и хранят этот трафик около ближайшего расположения Front Door Office 365. В результате это также позволяет улучшить использование Microsoft 365 за пределами Китая.
