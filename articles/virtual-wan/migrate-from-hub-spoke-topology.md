...
![существующей топологии сети Contoso](./media/migrate-from-hub-spoke-topology/contoso-pre-migration.png)
**рисунке: существующая топология сети Contoso**
...
## <a name="architecture"></a>Архитектура виртуальной глобальной сети Azure
...
![архитектура виртуальных глобальных сетей Contoso](./media/migrate-from-hub-spoke-topology/vwan-architecture.png)
**рисунке: Архитектура виртуальной глобальной сети Azure**
...
**рис. 1. концентратор постоянного тока в одном регионе**
...
- [Руководство. Создание подключения типа "сеть — сеть" с помощью виртуальной глобальной сети Azure](virtual-wan-site-to-site-portal.md)
...
![развертывании виртуальных концентраторов глобальной сети](./media/migrate-from-hub-spoke-topology/figure2.png)
**рис. 2. Перенос концентратора/резерва в виртуальный WAN**
...
**рис. 3. Перенос концентратора/резерва в виртуальную сеть в постоянного тока**
...
![протестируйте гибридные подключения с помощью виртуальной глобальной сети](./media/migrate-from-hub-spoke-topology/figure4.png)
**рис. 4. Перенос концентратора/резерва в виртуальный WAN**
...
![переход к виртуальному концентратору глобальной сети](./media/migrate-from-hub-spoke-topology/figure5.png)
**рис. 5. Перенос концентратора/резерва в виртуальный WAN**

**a**. Удалите существующие подключения пиринга из периферийных виртуальных сетей к старому концентратору постоянного тока. Доступ к приложениям в сегментах виртуальных сетей невозможен, пока не будут выполнены шаги а–в.
...
![оптимизировать локальное подключение для полного использования виртуальной глобальной сети](./media/migrate-from-hub-spoke-topology/figure7.png)
**рис. 7. Перенос концентратора и виртуальной глобальной сети в постоянного тока**
...
**рисунке: Виртуальная глобальная сеть с двумя регионами**
...
**рисунке: брандмауэр Azure в виртуальной глобальной сети (защищенный виртуальный концентратор)**
