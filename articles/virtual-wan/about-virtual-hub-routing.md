...
:::image type="content" source="./media/about-virtual-hub-routing/concepts-propagation.png" alt-text="Взаимосвязь":::
...
* Все сведения, относящиеся к маршруту 0.0.0.0/0, ограничены таблицей маршрутов в локальном концентраторе. Этот маршрут не распространяется между концентраторами.
