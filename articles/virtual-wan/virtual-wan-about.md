...
Чтобы создать подключение типа "сайт — сайт" используя Виртуальную глобальную сеть, можно либо перейти по ссылке [Виртуальная глобальная сеть (предварительная версия)](virtual-wan-locations-partners.md), либо создать соединение вручную.
...
Сведения о том, создать подключение вручную, см. в руководстве по [созданию подключения "сеть — сеть" с помощью Виртуальной глобальной сети Azure (предварительная версия)](virtual-wan-point-to-site-portal.md).

## <a name="er"></a>Подключения ExpressRoute (предварительная версия)

Сведения о том, как создать подключение вручную, см. в руководстве по [созданию подключения ExpressRoute с помощью Виртуальной глобальной сети](virtual-wan-expressroute-portal.md).
...
Дополнительные сведения см. в статье [Расположения партнеров и виртуального концентратора Виртуальной глобальной сети](virtual-wan-locations-partners.md).
