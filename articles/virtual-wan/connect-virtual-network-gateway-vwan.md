...
На странице **Конфигурация** шлюза виртуальной сети можно настроить **BGP ASN**. Измените BGP ASN. BGP ASN не может иметь значение 65515. 66515 будет использоваться виртуальной глобальной сетью Azure.
