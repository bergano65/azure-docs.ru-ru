...
Чтобы подключиться к виртуальной сети, необходимо создать и настроить профиль VPN клиента. Смотрите [настройку аутентификации Azure AD для подключения к сайту от точки к сайту с Azure.](virtual-wan-point-to-site-azure-ad.md)
