...
Для подключения необходимо скачать VPN-клиент Azure и импортировать профиль VPN-клиента, скачанный на предыдущих шагах, на каждом компьютере, который хочет подключиться к виртуальной сети.
...
## <a name="viewwan"></a>10. Просмотр виртуальной глобальной сети
...
## <a name="viewhealth"></a>11. Просмотр работоспособности ресурсов
