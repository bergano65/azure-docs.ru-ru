...
|_None_ |Вы уже определили набор запросов и временное окно, которые вам нужно изучить, и не хотите отвлекаться на другие запросы. _None_ подходит для тестирования и маркировки сред. При выборе режима _None_ будьте осторожны, поскольку вы можете упустить возможность отследить и оптимизировать новые важные запросы. Восстановить данные за прошедшие периоды времени невозможно. |
