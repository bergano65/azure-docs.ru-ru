---
title: Обзор конечной точки служб виртуальной сети (VNet) в базе данных Azure для PostgreSQL — один сервер
description: Узнайте, как работают конечные точки службы виртуальной сети (VNet) для базы данных Azure для PostgreSQL-Single Server.
author: bolzmj
ms.author: mbolz
...
- Включение конечных точек служб для виртуальной сети для Базы данных Azure для PostgreSQL с помощью тега службы **Microsoft.Sql** также включает конечные точки для всех служб баз данных Azure: "База данных Azure для MySQL", "База данных Azure для PostgreSQL", "База данных SQL Azure" и "Хранилище данных SQL Azure".
