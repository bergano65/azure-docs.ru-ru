---
title: Правила виртуальной сети - База данных Azure для PostgreS'L - Единый сервер
description: Узнайте, как использовать конечные точки виртуальной сети (vnet) для подключения к базе данных Azure для PostgreS-L - Single Server.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="use-virtual-network-service-endpoints-and-rules-for-azure-database-for-postgresql---single-server"></a>Используйте конечные точки службы виртуальной сети и правила для базы данных Azure для PostgreS-L - Единый сервер
