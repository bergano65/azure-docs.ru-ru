...
> [!NOTE]
> Эта функция доступна во всех регионах Azure, где база данных Azure для PostgreSQL поддерживает ценовые категории "общего назначения" и "оптимизировано для памяти".
...
1. **Добавление разнородности реализации криптографии** . Запланированное перемещение на аппаратное шифрование будет дополнительно изменить реализации, предоставляя аппаратную реализацию в дополнение к реализации на основе программного обеспечения.
...
> [!Important]
> - Сценарий 2 и 4 существенно влияют на производительность сервера базы данных Azure для PostgreSQL из-за дополнительного уровня шифрования инфраструктуры.
