---
title: Резервное копирование и восстановление - Портал Azure - База данных Azure для PostgreS'L - Единый сервер
description: В этой статье описывается, как восстановить сервер в базе данных Azure для PostgreS-L - Единый сервер с помощью портала Azure.
author: rachel-msft
ms.author: raagyema
...
ms.locfileid: "74765636"
---
# <a name="how-to-backup-and-restore-a-server-in-azure-database-for-postgresql---single-server-using-the-azure-portal"></a>Как создать резервную связь и восстановить сервер в базе данных Azure для PostgreS'L - Единый сервер с помощью портала Azure
...
1. Выберите **кнопку «Создание ресурса»** в верхнем левом углу портала. Выберите **базы данных** > **Лазурные базы данных для PostgreS'L**.
