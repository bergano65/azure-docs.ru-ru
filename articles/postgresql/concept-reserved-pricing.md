...
* Для подписок с Соглашением Enterprise на **портале EA** следует включить параметр [Добавить зарезервированные экземпляры](https://ea.azure.com/). В противном случае, если этот параметр отключен, необходимо быть администратором подписки EA.
