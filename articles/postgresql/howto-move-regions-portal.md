...
>[!NOTE]
> При создании реплики они не наследуют правила брандмауэра и конечные точки службы виртуальной сети главного сервера. Эти правила следует настроить для каждой реплики отдельно.
