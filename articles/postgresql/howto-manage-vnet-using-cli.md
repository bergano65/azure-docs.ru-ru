---
title: Создание конечных точек и правил службы виртуальной сети для базы данных Azure для PostgreSQL-Single Server и управление ими с помощью Azure CLI
