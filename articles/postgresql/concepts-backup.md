---
title: 'Резервное копирование и восстановление базы данных Azure для PostgreSQL: один сервер'
description: Дополнительные сведения об автоматическом резервном копировании и восстановлении базы данных Azure для сервера PostgreSQL - одного сервера.
author: rachel-msft
ms.author: raagyema
...
ms.locfileid: "65068851"
---
# <a name="backup-and-restore-in-azure-database-for-postgresql---single-server"></a>Резервное копирование и восстановление базы данных Azure для PostgreSQL: один сервер
