---
title: Ценовые категории для службы "База данных Azure для PostgreSQL"
description: В этой статье описаны ценовые категории для службы "База данных Azure для PostgreSQL".
author: jan-eng
ms.author: janeng
