...
| Универсальные | Для решения большинства бизнес-задач требуются сбалансированные вычислительные ресурсы и память с масштабируемой пропускной способностью операций ввода-вывода. К примерам относятся серверы для размещения мобильных и веб-приложений, а также других корпоративных приложений.|
...
### <a name="large-storage-preview"></a>Большие хранилища (Предварительная версия)

Мы увеличиваем ограничений хранения на уровнях наших общего назначения и оптимизированных для памяти. Вновь созданные серверов, согласиться на предварительную версию можно подготовить до 16 ТБ хранилища. Операций ввода-ВЫВОДА масштабирования в отношении 3:1 до 20 000 операций ввода-ВЫВОДА. Как и в случае с текущей общедоступной хранилища, можно добавить дополнительную емкость хранилища после создания сервера и для увеличения хранилища, автоматически с учетом объема хранилища для рабочей нагрузки системы.
...
| Размер хранилища | 32 ГБ до 16 ТБ| 32 до 16 ТБ |
| Шаг приращения хранилища | 1 GB | 1 GB |
| IOPS | 3 операции ввода-вывода в секунду на ГБ<br/>Минимум 100 операций ввода-вывода в секунду<br/>Макс. 20 000 операций ввода-ВЫВОДА | 3 операции ввода-вывода в секунду на ГБ<br/>Минимум 100 операций ввода-вывода в секунду<br/>Макс. 20 000 операций ввода-ВЫВОДА |

> [!IMPORTANT]
> Большие хранилища в настоящее время находится в общедоступной предварительной версии в следующих регионах: Восточная часть США, восточная часть США 2, Центральная часть США, Западная часть США, Северная Европа, Западная Европа, Южная часть соединенного Королевства, Западная часть соединенного Королевства, Юго-Восточная Азия, Восточная Азия, Япония Восток; Япония, Западная, Южная Корея Central, Корея, Восточная Австралия, юго-восток Австралии.
>
> Просмотр с большим объемом памяти в настоящее время не поддерживает:
>
> * Входящие подключения через конечные точки службы виртуальной сети
> * Геоизбыточного резервного копирования
> * Реплики чтения
