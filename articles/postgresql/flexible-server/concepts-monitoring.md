...
ms.locfileid: "90937247"
---
# <a name="monitor-metrics-azure-database-for-postgresql---flexible-server"></a>Мониторинг метрик базы данных Azure для PostgreSQL — гибкого сервера
