...
Чтобы избежать такой ситуации, когда объем хранилища достигнет 95% или если доступная емкость меньше 5 гиб, сервер автоматически переключается в **режим только для чтения**.
