...
Если вы хотите изменить значения по умолчанию, воспользуйтесь справочной документацией по Azure CLI, <!--FIXME --> где описаны все настраиваемые параметры интерфейса командной строки. 
