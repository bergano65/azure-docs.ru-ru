...
---
# <a name="handling-transient-connectivity-errors-for-azure-database-for-postgresql---single-server"></a>Обработка временных ошибок подключения для базы данных Azure для PostgreSQL — один сервер
