---
title: Создание конечных точек и правил службы виртуальной сети в базе данных Azure для PostgreSQL-Single Server и управление ими с помощью портал Azure
