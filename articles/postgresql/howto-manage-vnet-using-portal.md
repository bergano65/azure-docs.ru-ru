---
title: Создание и управление ими конечных точек службы виртуальной сети и правил в базе данных Azure для PostgreSQL - отдельного сервера с помощью портала Azure
description: Создание и управление ими конечных точек службы виртуальной сети и правил базы данных Azure для PostgreSQL - отдельного сервера с помощью портала Azure
author: bolzmj
ms.author: mbolz
...
ms.locfileid: "65073171"
---
# <a name="create-and-manage-vnet-service-endpoints-and-vnet-rules-in-azure-database-for-postgresql---single-server-by-using-the-azure-portal"></a>Создание и управление ими конечных точек службы виртуальной сети и правила виртуальной сети в базе данных Azure для PostgreSQL: один сервер с помощью портала Azure
