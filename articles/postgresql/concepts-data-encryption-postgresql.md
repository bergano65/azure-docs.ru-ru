---
title: Шифрование данных на одном сервере в базе данных Azure для PostgreSQL с помощью управляемого клиентом ключа
