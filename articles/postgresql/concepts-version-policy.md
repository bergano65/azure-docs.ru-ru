...
## <a name="retired-postgresql-engine-versions-not-supported-in-azure-postgresql"></a>Устаревшие версии подсистемы PostgreSQL не поддерживаются в Azure PostgreSQL
...
- Если вы можете столкнуться с любой проблемой, связанной с базой данных PostgreSQL, мы не сможем предоставить вам поддержку. В таких случаях потребуется обновить базу данных, чтобы мы смогли предоставить вам поддержку.
...
- В случае серьезной уязвимости системы безопасности базы данных, указанной в отмененной версии базы данных, Azure может выбрать автоматическое обновление базы данных до более поздней версии.
