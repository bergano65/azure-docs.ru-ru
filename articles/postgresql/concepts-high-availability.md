...
:::image type="content" source="./media/concepts-high-availability/azure-postgresql-built-in-high-availability.png" alt-text="представление эластичного масштабирования в Azure PostgreSQL":::
