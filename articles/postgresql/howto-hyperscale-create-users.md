...
Поскольку масштабирование является управляемой службой PaaS, только корпорация Майкрософт может войти с помощью `postgres` роли суперпользователя. Для ограниченного административного доступа эта роль предоставляется в масштабе `citus` .
