...
Если вы хотите узнать о том, как создавать и администрировать пользователей подписки Azure и их привилегии, вы можете посетить [статью Управление доступом на основе ролей (Azure RBAC) в Azure](../role-based-access-control/built-in-roles.md) или ознакомиться с разрешениями по [настройке ролей](../role-based-access-control/custom-roles.md).
