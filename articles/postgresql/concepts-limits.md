...
description: В этой статье описываются ограничения в базе данных Azure для PostgreSQL - одного сервера, например количество подключений и параметры подсистемы хранилища.
author: rachel-msft
ms.author: raagyema
