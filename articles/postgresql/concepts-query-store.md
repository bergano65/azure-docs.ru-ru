---
title: Хранилище запросов в базе данных Azure для PostgreSQL — один сервер
...
| pg_qs.track_utility | Задает, будут ли отслеживаться команды служебных программ. | на | on, off |
...
|**Name**   |**Тип** | **Справочные материалы**  | **Описание**|
|---|---|---|---|
...
|вызовы  |bigint  || Число выполнений запроса|
...
|строки   |bigint ||  Общее число строк, полученных или затронутых инструкцией|
...
|вызовы  |Integer        ||Число одинаковых записанных событий|
