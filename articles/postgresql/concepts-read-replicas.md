...
Метрика " **Максимальная задержка между репликами** " показывает задержку в байтах между первичной и задержкой репликой. Эта метрика доступна только на сервере-источнике.
