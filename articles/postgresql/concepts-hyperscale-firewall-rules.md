...
> Java. util. параллельно. Ексекутионексцептион: Java. lang. RuntimeException: org. PostgreSQL. util. Псклексцептион: Неустранимая: отсутствует запись PG\_HBA. conf для узла "123.45.67.890", пользователь "Цитус", база данных "Цитус", SSL
