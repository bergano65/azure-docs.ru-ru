...
1. Настройте [правила брандмауэра](howto-hyperscale-manage-firewall-using-portal.md) , чтобы разрешить IP-адрес клиента. Для временных целей тестирования настройте правило брандмауэра, используя 0.0.0.0 как начало диапазона IP-адресов и 255.255.255.255 как завершение. Это правило открывает сервер для всех IP-адресов. Если правило устраняет проблему с подключением, удалите его и создайте правило брандмауэра для соответствующего ограниченного IP-адреса или диапазона адресов.
