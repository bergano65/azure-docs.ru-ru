---
title: 'Устранение неполадок подключения к базе данных Azure для PostgreSQL: один сервер'
description: 'Узнайте, как устранение неполадок подключения к базе данных Azure для PostgreSQL: один сервер.'
...
ms.locfileid: "65952107"
---
# <a name="troubleshoot-connection-issues-to-azure-database-for-postgresql---single-server"></a>Устранение неполадок подключения к базе данных Azure для PostgreSQL: один сервер
...
2. На всех брандмауэрах между клиентом и Интернетом убедитесь, что порт 5432 открыт для исходящих подключений.
