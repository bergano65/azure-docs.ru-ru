...
* Ошибка пользователя: возможны недопустимые параметры подключения, такие как имя сервера в строке подключения или отсутствующий суффикс *\@ServerName* в имени пользователя.
