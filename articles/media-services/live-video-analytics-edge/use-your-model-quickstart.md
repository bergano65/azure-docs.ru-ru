...
* Попробуйте [защищенную версию модели YOLOv3](https://github.com/Azure/live-video-analytics/blob/master/utilities/video-analysis/tls-yolov3-onnx/readme.md) и разверните ее на пограничном устройстве IoT. 
