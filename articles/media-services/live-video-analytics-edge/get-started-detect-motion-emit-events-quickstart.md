...
1. В раскрывающемся меню в левой части окна Cloud Shell выберите в качестве среды **bash** .
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/quickstarts/env-selector.png" alt-text="Аналитика видеотрансляции на основе обнаружения движения&quot;:::

Просмотрите следующее видео с подробными инструкциями о том, как приступить к работе со службой &quot;Аналитика видеотрансляций"
    ```
...
1. Щелкните правой кнопкой мыши и выберите **Параметры расширения** .
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/run-program/extensions-tab.png" alt-text="Аналитика видеотрансляции на основе обнаружения движения&quot;:::

Просмотрите следующее видео с подробными инструкциями о том, как приступить к работе со службой &quot;Аналитика видеотрансляций" (Показывать подробное сообщение).

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/run-program/show-verbose-message.png" alt-text="Аналитика видеотрансляции на основе обнаружения движения&quot;:::
