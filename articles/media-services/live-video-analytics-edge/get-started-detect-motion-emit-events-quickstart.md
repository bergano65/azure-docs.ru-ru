...
> [!NOTE]
> Скрипт также создает несколько файлов конфигурации в каталоге **_~/clouddrive/lva-sample/_* _. Эти файлы понадобятся вам позднее в этом кратком руководстве.
