...
1. Щелкните правой кнопкой мыши и выберите **Параметры расширения**.
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/run-program/extensions-tab.png" alt-text="Аналитика видеотрансляции на основе обнаружения движения" (Показывать подробное сообщение).

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/run-program/show-verbose-message.png" alt-text="Аналитика видеотрансляции на основе обнаружения движения"::: (Показывать подробное сообщение)
1. <!--In Visual Studio Code-->Выберите **Вид** > **Проводник** или нажмите клавиши CTRL+SHIFT+E.
