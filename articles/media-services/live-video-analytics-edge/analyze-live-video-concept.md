...
> [!div class="mx-imgBorder"]
> :::image type="content" source="./media/analyze-live-video/custom-model.png" alt-text="Интерактивная аналитика видео на основе обнаруженных в ходе движения кадров с помощью внешнего модуля":::
