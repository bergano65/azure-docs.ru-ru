...
|Общие ошибки пользователей    |400 диапазон  ||
|Сущность не найдена   |404        ||
|Общие ошибки сервера| 500 диапазон       ||
...
Создана новая сущность  |201|   Н/Д|
Общие ошибки пользователей |400 диапазон  ||
