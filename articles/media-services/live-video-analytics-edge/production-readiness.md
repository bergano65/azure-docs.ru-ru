...
ms.locfileid: "84260377"
---
# <a name="production-readiness-and-best-practices"></a>Подготовка рабочей среды и рекомендации

В этой статье содержатся инструкции по настройке и развертыванию функции Live Video Analytics в модуле IoT Edge в рабочих средах. Кроме того, ознакомьтесь [со статьей подготовка к развертыванию решения IOT EDGE в рабочей](https://docs.microsoft.com/azure/iot-edge/production-checklist) статье по подготовке IOT Edgeного решения. 
...
* С помощью свойства двойника модуля [[аппликатиондатадиректори](module-twin-configuration-schema.md#module-twin-properties)], где следует указать каталог в локальной файловой системе для хранения данных конфигурации.
