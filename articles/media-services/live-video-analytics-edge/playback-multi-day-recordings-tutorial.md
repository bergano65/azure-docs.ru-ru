...
Затем в Visual Studio Code откройте src/ams-asset-player. Эта папка содержит файлы, необходимые для работы с этим учебником. Откройте файл appsettings.json и скопируйте его содержимое в новый файл под названием appsettings.Developer.json. Внесите во второй файл следующие изменения:
