...
1. Найдите и включите параметр &quot;Show Verbose Message" слева или нажмите клавиши CTRL+SHIFT+D, чтобы открыть приложения, которые можно запустить.
