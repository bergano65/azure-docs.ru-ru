...
* Ресурс [пограничной Azure Stack](https://docs.microsoft.com/azure/databox-online/azure-stack-edge-gpu-deploy-prep)
   
* [Центр Интернета вещей](https://docs.microsoft.com/azure/iot-hub/iot-hub-create-through-portal)
* [Субъект-служба](https://docs.microsoft.com/azure/media-services/live-video-analytics-edge/create-custom-azure-resource-manager-role-how-to#create-service-principal) для модуля Live Video Analytics.
...
* Учетная запись хранения
    ...
    Дополнительные сведения о [учетной записи хранения общего назначения версии 2](https://docs.microsoft.com/azure/storage/common/storage-account-upgrade?tabs=azure-portal).
...
Azure Stack ребро — это решение "оборудование как услуга" и "пограничные вычислительные устройства с поддержкой искусственного интеллекта" с возможностями перемещения данных сети. Дополнительные сведения о [Azure Stack и подробных инструкциях по настройке см](https://docs.microsoft.com/azure/databox-online/azure-stack-edge-deploy-prep). в этой статье. Чтобы приступить к работе, следуйте инструкциям по ссылкам ниже:

* [Azure Stack создания ресурсов ребра или Шлюз Data Box](https://docs.microsoft.com/azure/databox-online/azure-stack-edge-deploy-prep)
* [Установка и настройка](https://docs.microsoft.com/azure/databox-online/azure-stack-edge-deploy-install)
* [Подключение и активация](https://docs.microsoft.com/azure/databox-online/azure-stack-edge-deploy-connect-setup-activate)
...
1. В колонке Настройка вычислений Edge введите следующие значения:
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/deploy-azure-stack-edge-how-to/azure-stack-edge-get-started.png" alt-text="Начало работы с Azure Stack краями":::
1. Нажмите кнопку **создания**. Для создания ресурса Центра Интернета вещей нужно несколько минут. После этого на плитке **Настройка вычислений** появляется конфигурация вычислений. Чтобы подтвердить настройку роли вычислений Edge, на плитке **Настройка вычислений** щелкните **Просмотреть вычисления**.
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/deploy-azure-stack-edge-how-to/edge-compute-config.png" alt-text="Создание ресурсов центра Интернета вещей":::
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/deploy-azure-stack-edge-how-to/configure-edge-compute.png" alt-text="Настройка высокореберной расчетной карты ":::
...
* Чтобы развернуть кластер Kubernetes, необходимо настроить ресурс Azure Stack ребра с помощью [локального веб-интерфейса](https://docs.microsoft.com/azure/databox-online/azure-stack-edge-deploy-connect-setup-activate#connect-to-the-local-web-ui-setup). 
...
1. Создайте удаленный общий ресурс для хранилища синхронизации файлов.
    ...
    > [!TIP]
    > Используя клиент Windows, подключенный к Azure Stack границе, подключитесь к общим ресурсам SMB, выполнив действия, [описанные в этом документе](https://docs.microsoft.com/azure/databox-online/azure-stack-edge-deploy-add-shares#connect-to-an-smb-share).
