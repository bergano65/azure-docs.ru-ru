...
> [!div class="mx-imgBorder"]
> :::image type="content" source="./media/custom-vision-tutorial/docker-file.png" alt-text="Схема: обзор Пользовательского визуального распознавания"   13 hours ago        Up 25 seconds       127.0.0.1:80->80/tcp   practical_cohen
        ```
...
1. Щелкните правой кнопкой мыши файл src/edge/deployment.customvision.template.json и выберите **Создать манифест развертывания IoT Edge** .
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/custom-vision-tutorial/deployment-template-json.png" alt-text="Схема: обзор Пользовательского визуального распознавания":::
...
1. Задайте строку подключения к Центру Интернета вещей, щелкнув значок **Дополнительные действия** рядом с областью **ЦЕНТР ИНТЕРНЕТА ВЕЩЕЙ AZURE** в левом нижнем углу. Строку можно скопировать из файла appsettings.json. (Есть еще один рекомендуемый подход, позволяющий обеспечивать правильность настройки Центра Интернета вещей в Visual Studio Code. Он предполагает использование команды [Задать строку подключения Центра Интернета вещей](https://github.com/Microsoft/vscode-azure-iot-toolkit/wiki/Select-IoT-Hub).)
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/custom-vision-tutorial/connection-string.png" alt-text="Схема: обзор Пользовательского визуального распознавания":::
1. Затем щелкните правой кнопкой мыши файл src/edge/config/deployment.customvision.amd64.json и выберите **Создать развертывание для одного устройства** .
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/custom-vision-tutorial/deployment-amd64-json.png" alt-text="Схема: обзор Пользовательского визуального распознавания":::
...
> [!div class="mx-imgBorder"]
> :::image type="content" source="./media/custom-vision-tutorial/start-monitoring.png" alt-text="Схема: обзор Пользовательского визуального распознавания":::
...
1. Щелкните правой кнопкой мыши и выберите **Параметры расширения** .
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/run-program/extensions-tab.png" alt-text="Схема: обзор Пользовательского визуального распознавания":::
1. Найдите и включите параметр **Показывать подробное сообщение** .

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/run-program/show-verbose-message.png" alt-text="Схема: обзор Пользовательского визуального распознавания"
              }
            ]
          }
        }
