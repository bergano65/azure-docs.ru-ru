...
|                                         | НАЙДЕТЕ | ЧАСТИЧНО ПРОТЕСТИРОВАНО | НЕ ТЕСТИРОВАЛСЯ | НЕПОДДЕРЖИВАЕМЫЙ | ПРИМЕЧАНИЯ                                                                                                                |
|:----------------------------------------|--------|------------------|----------|-------------|:---------------------------------------------------------------------------------------------------------------------|
| Воспроизведение                                |        |                  |          |             |                                                                                                                      |
...
| Специальные возможности — субтитры и субтитры  |        | X                |          |             |  WebVTT поддерживается по запросу, Live CEA 708 частично протестировано                                                       |
...
| Аналитика                               |        | X                |          |             | AMP предоставляет возможность прослушивания аналитических и диагностических событий для отправки на серверную часть аналитики по своему усмотрению.  Все события и свойства недоступны для всех специалистов из-за ограничений платформы.                                                                            |
| Пользовательские обложки                            |        |                  | X        |             | Установите для элементов управления значение false в AMP и используйте собственный HTML и CSS.           |
| Очистка строки поиска                      |        |                  |          | X           |                                                                                                                      |
| Хитрость — воспроизведение                              |        |                  |          | X           |                                                                                                                      |
| Только звук                              |        |                  |          | X           | Может работать в некоторых технических целях для адаптивной потоковой передачи, но в настоящее время не поддерживается и не работает в AzureHtml5JS. Прогрессивное воспроизведение MP3 может работать с технической поддержкой HTML5, если платформа поддерживает ее.                                                                                                        |
| Только видео                              |        |                  |          | X           | Может работать в некоторых технических целях для адаптивной потоковой передачи, но в настоящее время не поддерживается и не работает в AzureHtml5JS.      |
