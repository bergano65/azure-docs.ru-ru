...
[RTMP] позволяет отправлять сигналы времени метаданных как [AMF0] сообщения о подсказках, внедренные в поток [RTMP]. Сообщения о подсказке могут быть отправлены в любое время до наступления фактического события или сигнала объединения AD [SCTE35]. Для поддержки этого сценария фактическое время события отправляется в сообщении подсказки. Чтобы получить дополнительные сведения, ознакомьтесь с [AMF0].
...
## <a name="211-rtmp-signal-syntax"></a>, синтаксис сигнала RTMP
...
## <a name="212--simple-mode-ad-signaling-with-rtmp"></a>Сигнал 2.1.2 в простом режиме с помощью RTMP
...
## <a name="213-scte-35-mode-ad-signaling-with-rtmp"></a>2.1.3 SCTE-35. сигнал в режиме рекламы с помощью RTMP
...
---
## <a name="214-elemental-live-oncuepoint-ad-markers-with-rtmp"></a>2.1.4ные Интерактивные маркеры AD "Онкуепоинт" с помощью RTMP
...
### <a name="215-cancellation-and-updates"></a>Отмена и обновление 2.1.5
...
| ВРЕМЯ               | десятичное число с плавающей запятой | Обязательное значение                                  | Время презентации события. Единицы измерения — доли секунды.                                                                                                                                                                                                                    |
