...
ms.locfileid: "71950176"
---
# <a name="quickstart-invite-users-to-video-indexer"></a>Краткое руководство. Пригласить пользователей в индексатор видео
...
![Удалить пользователей](./media/invite-users/remove-users.png)
