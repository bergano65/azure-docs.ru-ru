...
Индексатор видео может выполнять следующие операции с файлами мультимедиа:

* определение и извлечение речи и определение говорящих;
* определение и извлечение экранного текста в видео;
* определение и пометка объектов в видеофайле;
* определение торговых марок, таких как Майкрософт, в звуковых дорожках и на экранном тексте в видео;
* определение и распознавание лиц из базы данных знаменитостей и пользовательской базы данных лиц;
* извлечение ключевых слов из видео- и аудиосодержимого на основе речи и текстовых изображений;
* извлечение тем, обсуждаемых, но не обязательно явно упоминаемых, в аудио- и видеосодержимом из речи и визуального текста;
* создание субтитров или скрытых субтитров из звуковой дорожки.

Дополнительные сведения см. в этом [обзоре](video-indexer-overview.md).
...
В соответствии с [условиями использования веб-служб Azure](http://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=31), вы сохраняете полные права на ваше содержимое, а корпорация Майкрософт осуществляет доступ к этому содержимому, метаданным и извлеченным сведениям только в строгом соответствии с условиями использования веб-служб и заявлением Майкрософт о конфиденциальности.
