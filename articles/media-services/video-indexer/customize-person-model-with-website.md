...
1. Нажмите кнопку Настройка модели содержимого в левой части страницы.

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/content-model-customization/content-model-customization.png" alt-text="Настройка модели содержимого":::
1. Перейдите на вкладку люди.
    ...
    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/customize-face-model/content-model-customization-people-tab.png" alt-text="Настройка пользователей":::

## <a name="create-a-new-person-model"></a>Создание новой модели пользователя

1. Нажмите кнопку **+ Добавить модель** справа.
1. Введите имя модели. Теперь вы можете добавлять новых людей и лиц в новую модель Person.
1. Нажмите кнопку меню список и выберите **+ Добавить пользователя**.

    > [!div class="mx-imgBorder"]
    > :::image type="content" source="./media/customize-face-model/add-new-person.png" alt-text="Добавление Перон":::
...
1. Выберите в меню пункт **Переименовать**.
1. Выберите текущее имя модели и введите новое имя.
1. Нажмите кнопку проверки для переименования модели.
...
1. Удалите видеофайл или перейдите к файлу.
