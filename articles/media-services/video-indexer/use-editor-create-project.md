...
1. Щелкните **создать новый проект** .  
    ...
    ![Снимок экрана, на котором показана страница "индексатор видео" с выбранной вкладкой "проекты".](./media/video-indexer-view-edit/new-project.png)
...
1. Добавьте видео, с которыми вы хотите работать в этом проекте, выбрав **Добавить видео** .
    ...
    ![На снимке экрана показан поиск видеороликов, которые упоминают GitHub с двумя результатами.](./media/video-indexer-view-edit/github.png)
...
1. Теперь вы увидите все выбранные видеоролики. Это видеоролики, из которых вы собираетесь выбрать клипы для проекта.
    ...
    ![Снимок экрана: индексатор видео с контекстным меню одного из видео для удаления, очистки выделения или перемещения вниз.](./media/video-indexer-view-edit/rearrange.png)
...
1. Добавьте фильтры для дальнейшего указания сведений о том, для чего нужны сцены, выбрав **Параметры фильтра** .
    ...
    ![Снимок экрана: индексатор видео с выбранными пользователями для фильтра включения.](./media/video-indexer-view-edit/include.png)
...
![Снимок экрана: индексатор видео с предварительной версией видео в правой части окна.](./media/video-indexer-view-edit/preview.png)
...
1. По завершении убедитесь, что проект сохранен. Теперь этот проект можно визуализировать. Выберите **рендеринг и скачать** . 
    ...
    ![Снимок экрана показывает индексатор видео с параметром для подготовки к просмотру и скачиванию проекта.](./media/video-indexer-view-edit/save.png)
