...
ms.locfileid: "96433468"
---
# <a name="add-video-clips-to-your-projects"></a>Добавление видеороликов в проекты

Веб-сайт индексатора видео позволяет использовать подробные сведения из видео для поиска нужного мультимедийного содержимого, поиска интересующих элементов и использования результатов для создания совершенно нового проекта. 
