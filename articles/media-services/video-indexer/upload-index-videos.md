...
- Изменение состояния индексирования: 
    ...
    - Пример: https: \//Test. com/нотифиме? имя_проекта = MyProject & ID = 1234abcd & State = обработано
- Человек, идентифицированный на видео:
  - properties
    ...
    - Пример: https: \//Test. com/нотифиме? имя_проекта = MyProject & ID = 1234abcd & FaceId = 12 & Кновнперсонид = CCA84350-89B7-4262-861C-3CAC796542A5 & Персоннаме = Inigo_Montoya 
