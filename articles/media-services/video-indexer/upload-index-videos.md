...
* Использовать существующий ресурс служб мультимедиа Azure, предоставляя [идентификатор актива](https://docs.microsoft.com/azure/media-services/latest/assets-concept) (поддерживается в платных только для учетных записей).
...
- Индексирование ресурсы служб мультимедиа имеет те же ограничения, как индексирование с URL-адреса
- Индексатор видео имеет ограничение максимального времени на 4 часа для одного файла
...
- `Default` — Индекс и получить аналитические данные, используя аудио и видео
- `AudioOnly` — Индекс и получить аналитические данные, используя только аудио (игнорирование видео)
- `DefaultWithNoiseReduction` — Индекс и получайте результаты аудио и видео, во время применения алгоритмов снижение шума в потоке звука
...
[Изучите выходные данные индексатора видео Azure API](video-indexer-output-json-v2.md)
