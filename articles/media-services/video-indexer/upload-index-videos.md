...
ms.locfileid: "53253210"
---
# <a name="upload-and-index-your-videos"></a>Отправка и индексирование видео  

API "Индексатор видео" позволяет загружать видео двумя способами: 
...
- Размер видео, передаваемого с использованием его URL-адреса, ограничено до 10 ГБ.
