...
ms.locfileid: "89050868"
---
# <a name="examine-the-video-indexer-output"></a>Изучите выходные данные индексатора видео

Когда видео индексируется, индексатор видео подуцес содержимое JSON, содержащее сведения об указанном видео Insights. Аналитические сведения включают в себя: записи, Окрс, лица, темы, блоки и т. д. Каждый тип Insights содержит экземпляры диапазонов времени, которые показывают, когда аналитика отображается в видео. 
...
|описание|Описание списка воспроизведения.|
...
|описание|Описание торговой марки.|
