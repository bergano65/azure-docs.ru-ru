...
|создано|Время создания списка воспроизведения.|
...
|Атрибут | Описание|
|---|---|
|имя|Имя видео. Например, Azure Monitor.|
...
|ключевые слова|Может содержать или не содержать ключевые слова. Дополнительные сведения см. в разделе [keywords](#keywords).|
|тональности|Может содержать или не содержать сведения о тональности. Дополнительные сведения см. в разделе [sentiments](#sentiments).|
...
|ключевые слова|Измерение [keywords](#keywords).|
...
|тональности|Измерение [sentiments](#sentiments).|
...
|имя|Имя лица. Это может быть "Неизвестный № 0", идентифицированная знаменитость или заданный клиентом человек.|
...
|заголовок|Если это знаменитость, значением будет ее должность (например, генеральный директор Майкрософт).|
...
|Экземпляры|Список диапазонов времени этой сценой (сцены может иметь только один экземпляр).|
...
|Экземпляры|Список диапазонов времени этот снимок (снимок может иметь только один экземпляр).|
...
|имя|Название темы (например, "Лекарственные препараты").|
...
[Портал разработчиков индексатор видео](https://api-portal.videoindexer.ai)
