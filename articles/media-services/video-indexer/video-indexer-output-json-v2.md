...
В этой статье рассматриваются выходные данные индексатора видео (содержимое JSON). Сведения о доступных функциях и аналитических данных см. в статье [индексаторы видео](video-indexer-overview.md#video-insights).
