...
|duration|Содержит данные об отрезке времени, в котором обнаружены аналитические сведения. Отрезок времени указан в секундах.|
