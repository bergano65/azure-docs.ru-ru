...
![Аналитические сведения](./media/video-indexer-output-json/video-indexer-summarized-insights.png)
...
|Description (Описание)|Описание списка воспроизведения.|
...
|Description (Описание)|Текстовое описание знаменитости. |
...
|Description (Описание)|Описание торговой марки.|
