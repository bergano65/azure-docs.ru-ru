...
2. Оформите подписку.
    ...
    После подписки вы сможете найти свою подписку в разделе **Products**  ->  **авторизация** продуктов. На странице Подписка вы найдете первичный и вторичный ключи. Ключи должны быть защищены. Их нужно использовать только в серверном коде. Они не должны быть доступны на стороне клиента (в файлах с расширением JS, HTML и т. д.).
