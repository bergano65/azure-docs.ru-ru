...
3. Выберите кнопку**</>** встраиваемого (), которая появляется под видео.
...
5. Копирование встраиваемого кода (появляется в **Copy встроенного кода** в **диалоге Share & Embed).**
...
Если вы хотите вставить другой язык, `&captions=<Language Code>` вы можете добавить в встраиваемый URL-адрес игрока. Если вы хотите, чтобы подписи отображались по умолчанию, вы можете пройти &showCaptions'true.
