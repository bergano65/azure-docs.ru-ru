...
|локаль|Код короткий языка|Определяет язык insights. Значение по умолчанию — `en`. Например, `language=de`.|
|TAB|Выбранная вкладка по умолчанию|Управляет insights вкладку, которая отображается по умолчанию. `tab=timeline` Выполняет визуализацию аналитики на вкладке «временная шкала».|
...
> [!NOTE]
> При наличии проблем с доступом через URL-адреса видео, попробуйте добавить параметр «location» по ссылке. Для параметра должно быть установлено [регионов Azure, в которых существует индексатор видео](regions.md). Например, `https://www.videoindexer.ai/accounts/00000000-0000-0000-0000-000000000000/videos/b2b2c74b8e/?location=trial`.
