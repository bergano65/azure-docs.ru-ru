...
Чтобы создать платную учетную запись в Azure для государственных организаций, следуйте инструкциям в статье [Создание платного](https://api-portal.videoindexer.ai.azure.us/docs/services/Operations/operations/Create-Paid-Account)счета. Эта конечная точка API включает только регионы облака для государственных организаций.
...
*   В облаке для государственных организаций нет доступных ручных операций по содержимому. 
