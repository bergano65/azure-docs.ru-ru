...
Укажите [расположение и идентификатор учетной записи](https://docs.microsoft.com/azure/cognitive-services/video-indexer/video-indexer-use-apis#location) , чтобы получить маркер учетной записи Индексатора видео.
