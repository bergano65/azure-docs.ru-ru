...
- **Идентификация знаменитостей**. Индексатор видео автоматически определяет знаменитостей 1 миллиона — например мировых лидеров в области, субъекты, актрисы, athletes, исследователей, бизнеса и техническими специалистами по всему миру. Данные об этих знаменитостях можно найти также на различных известных веб-сайтах (например, IMDB и Википедия).
...
- **Сегментация сцены**: Определяет, при изменении сцены в видео, в зависимости от визуальные подсказки. Сцена изображена одно событие и его размещении ряд последовательных снимков, которые семантически связаны. 
- **Снимок обнаружения**: Определяет, когда снимок изменяется в зависимости от визуальных подсказок видео. Снимок представляет собой ряд кадров из же кинофильмов камеры. Дополнительные сведения см. в разделе [сцены, снимки и опорные кадры](scenes-shots-keyframes.md).
...
- **Последовательное кредиты**: идентифицировать начало и конец последовательного деньги на счете в конце передачи и фильмы.
...
- Создание содержимого — insights извлекались из видео и помогают эффективно создавать содержимое, например фильмов, социальных сетей мультимедийного содержимого, новости клипы и т.д. из существующего содержимого в архиве организации 
...
- [Начало работы с веб-сайта индексатор видео](video-indexer-get-started.md)
- [Обработка содержимого с помощью REST API индексатора видео](video-indexer-use-apis.md)
- [Внедрение visual мини-приложений в приложении](video-indexer-embed-widgets.md)
