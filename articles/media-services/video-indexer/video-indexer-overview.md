...
* **Распознавание речи и транскрипции на нескольких языках** (предварительная версия). Автоматически определяет язык речи в разных сегментах аудио. Отправляет каждый сегмент файла мультимедиа для транскрибирования, а затем объединяет транскрипцию в единый элемент. Дополнительные сведения см. в разделе [Автоматическое выявление и транскрибирование содержимого на нескольких языках](multi-language-identification-transcription.md).
