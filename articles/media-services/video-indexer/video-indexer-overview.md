...
- **Оптическое распознавание текста**. Извлечение текста, демонстрируемого на видео.
...
- **Определение тем**. Формирование выводов о главных темах в расшифровке речи. Включен 1-й уровень классификации [IPTC](https://iptc.org/standards/media-topics/).
