...
|функциональное назначение;|Пробная версия|Платный|
|---|---|---|
...
1. Нажмите кнопку Настройка модели содержимого в правом верхнем углу страницы.
    ...
    ![Снимок экрана, на котором показана страница "индексатор видео" с кнопкой "Настройка модели содержимого", выбранной в правом верхнем углу.](./media/animated-characters-recognition/content-model-customization.png)
