...
1. Пометьте и обучить модель.
    ...
    1. После завершения редактирования всех нужных имен необходимо обучить модель.
        ...
        * Пробные учетные записи. Откройте страницу настройки и перейдите на вкладку "анимированные символы" и щелкните имеющуюся модель " **обучение** ".
        * Платные учетные записи: Откройте страницу Настройка и перейдите на вкладку анимированные символы. Для соответствующей модели щелкните ссылку **изменить в пользовательское визуальное распознавание** . Затем вы будете перенаправлены на страницу модели в Пользовательское визуальное распознавание. Нажмите кнопку "обучение", чтобы обучить модель. 
