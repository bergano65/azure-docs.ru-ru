...
| Price |Откройте [страницу цен](https://azure.microsoft.com/pricing/details/media-services/) и выберите вкладку Live Video |См. [страницу с ценами](https://azure.microsoft.com/pricing/details/media-services/) |
...
| Выполнение |Готово (нет запущенных программ)<br/>or<br/>Потоковая передача (запущена по крайней мере одна программа) |YES |
