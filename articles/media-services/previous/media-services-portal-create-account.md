...
2. Нажмите **кнопку «Создайте ресурс** > **Медиа** > **Медиа Сервисы».**
3. В окне **создания учетной записи служб мультимедиа** введите необходимые значения.
   ...
   3. Выберите новую или существующую **группу ресурсов**.  Группа ресурсов — это коллекция ресурсов с одинаковым жизненным циклом, разрешениями и политиками. Узнайте больше [здесь](../../azure-resource-manager/management/overview.md#resource-groups).
   4. В **местоположении**выберите географический регион, который будет использоваться для хранения записей носителей и метаданных для вашей учетной записи Media Services. Этот регион будет использоваться для обработки и потоковой передачи мультимедиа. В раскрывающемся списке отображаются только доступные регионы служб мультимедиа. 
