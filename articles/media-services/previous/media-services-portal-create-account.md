...
> [!NOTE]
> Сведения о доступности функций служб мультимедиа Azure в разных регионах см. в разделе [AMS Features in regions](availability-regions-v-2.md).
...
2. Щелкните **+ создать ресурс**  >  **Media**  >  **службы** мультимедиа мультимедиа.
