...
Если вы откроете один из файлов сегментов в текстовом редакторе (например, http:\//test001.origin.mediaservices.windows.net/8bfe7d6f-34e3-4d1a-b289-3e48a8762490/BigBuckBunny.ism/QualityLevels (514369)/MANIFEST (видео, Format = m3u8-AAPL), он содержит #EXT-X-KEY, что означает, что файл зашифрован.
