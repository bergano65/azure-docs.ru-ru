...
* [Клиентский пакет SDK для бесперебойной потоковой передачи Microsoft для Windows 8](https://visualstudiogallery.msdn.microsoft.com/04423d13-3b3e-4741-a01c-1ae29e84fea6?SRC=Home)
...
### <a name="to-create-a-windows-store-project"></a>Создание проекта магазина Windows
...
1. В диалоговом окне "Новый проект" введите или выберите следующие значения:
    ...
    | Название |SSPlayer |
    | Местоположение |C:\SSTutorials |
    | Имя решения |SSPlayer |
    | Создать каталог для решения |(выбрано) |

1. Нажмите кнопку **ОК**.

### <a name="to-add-a-reference-to-the-smooth-streaming-client-sdk"></a>Добавление ссылки на пакет SDK для клиента Smooth Streaming
...
1. Введите или выберите следующие значения:
    ...
    | Ссылка |Выберите клиентский пакет SDK бесперебойной потоковой передачи Microsoft для Windows 8 и пакет среды выполнения Microsoft Visual C++ |
...
### <a name="to-design-the-player-user-interface"></a>Разработка пользовательского интерфейса проигрывателя
...
### <a name="to-register-the-smooth-streaming-byte-stream-handler-and-pass-the-propertyset"></a>Регистрация обработчика байтового потока Smooth Streaming и передача этого свойства
...
### <a name="to-add-the-adaptive-source-manager-level-event-handler"></a>Добавление обработчика событий уровня диспетчера адаптивного источника
...
### <a name="to-add-adaptive-source-level-event-handlers"></a>Добавление обработчиков событий адаптивного уровня источника
...
### <a name="to-add-media-element-event-handlers"></a>Добавление обработчиков событий элемента мультимедиа
...
## <a name="lesson-4-select-smooth-streaming-tracks"></a>Урок 4. Выбор Smooth Streaming дорожек
