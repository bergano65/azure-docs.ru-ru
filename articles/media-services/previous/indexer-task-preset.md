...
description: В этой теме приводится обзор предустановленной задачи для медиаиндекса Медиа-услуг Azure.
