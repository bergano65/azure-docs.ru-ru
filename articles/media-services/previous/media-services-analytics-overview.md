...
> [!IMPORTANT]
> Некоторые обработчики мультимедиа выводятся из эксплуатации. Даты выбытия и дополнительные сведения см. в разделе [устаревшие компоненты](legacy-components.md) . 
