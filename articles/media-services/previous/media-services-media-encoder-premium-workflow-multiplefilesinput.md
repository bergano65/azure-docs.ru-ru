...
Есть сценарии, в которых при отправке задачи с помощью обработчика мультимедиа **Расширенный рабочий процесс кодировщика мультимедиа** может потребоваться настроить свойства компонентов, указать содержимое XML-файла со списком клипов или отправить несколько входных файлов. Некоторые примеры.
