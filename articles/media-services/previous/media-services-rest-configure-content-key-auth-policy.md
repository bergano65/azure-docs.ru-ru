...
ms.locfileid: "56003637"
---
# <a name="dynamic-encryption-configure-a-content-key-authorization-policy-legacy"></a>Динамическое шифрование: настройка политики авторизации ключей содержимого (для прежних версий)
