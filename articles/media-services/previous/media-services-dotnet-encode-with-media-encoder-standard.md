...
Если выходящий ресурс зашифрован в хранилище, необходимо настроить политику доставки ресурсов. Для получения дополнительной [Configuring asset delivery policy](media-services-dotnet-configure-asset-delivery-policy.md)информации см.
...
* Укажите, чтобы использовать предустановленную [адаптивную потоковую передачу.](media-services-autogen-bitrate-ladder-with-mes.md) 
...
[Как создать эскиз с помощью Media Encoder Standard с обзором кодирования](media-services-dotnet-generate-thumbnail-with-mes.md)
[медиа-услуг](media-services-encode-asset.md) .NET
