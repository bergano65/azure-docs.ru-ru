...
description: В этой статье показано, как использовать .NET для кодирования ресурса с помощью Media Encoder Standard.
...
Если выходящий ресурс зашифрован в хранилище, необходимо настроить политику доставки ресурсов. Дополнительные сведения см. в разделе [Настройка политики доставки ресурсов](media-services-dotnet-configure-asset-delivery-policy.md).
...
* Укажите, чтобы использовать предустановку [адаптивной потоковой передачи](media-services-autogen-bitrate-ladder-with-mes.md) . 
...
[Создание эскиза с помощью Media Encoder Standard с использованием](media-services-dotnet-generate-thumbnail-with-mes.md)
[службы мультимедиа .NET общие сведения о кодировке](media-services-encode-asset.md)
