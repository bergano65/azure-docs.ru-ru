...
## <a name="assetfiles-element-root-element"></a><a name="AssetFiles"></a> Элемент AssetFiles (корневой элемент)
...
| name | Type | Описание: |
| --- | --- | --- |
| **Name**<br /><br /> Обязательное значение |**xs:string** |Имя файла ресурса-контейнера. |
| **Размер**<br /><br /> Обязательное значение |**xs:long** |Размер файла ресурса-контейнера в байтах. |
| **Длительность**<br /><br /> Обязательное значение |**xs:duration** |Длительность воспроизведения содержимого. Пример: Duration="PT25M37.757S". |
| **NumberOfStreams**<br /><br /> Обязательное значение |**xs:int** |Количество потоков в файле ресурса-контейнера. |
| **FormatNames**<br /><br /> Обязательное значение |**xs: string** |Имена форматов. |
| **FormatVerboseNames**<br /><br /> Обязательное значение |**xs: string** |Подробные имена форматов. |
...
| **Метаданные**<br /><br /> minOccurs="0" maxOccurs="unbounded" |[MetadataType](media-services-input-metadata-schema.md#MetadataType) |Метаданные файла ресурса-контейнера, представленные в виде строки "ключ —значение". Пример:<br /><br /> **&lt;Ключ метаданных = "язык" значение = "ENG"/&gt;** |
...
| name | Type | Описание: |
| --- | --- | --- |
| **Id**<br /><br /> Обязательное значение |**xs:int** |Отсчитываемый от нуля индекс аудио- или видеодорожки.<br /><br /> MP4-файл не обязательно должен содержать идентификатор дорожки. |
| **Равн** |**xs:string** |Строка кодека видеодорожки. |
| **CodecLongName** |**xs: string** |Полное имя кодека звуковой или видеодорожки. |
| **TimeBase**<br /><br /> Обязательное значение |**xs:string** |Базовый счетчик времени. Пример: TimeBase="1/48000" |
...
| **Длительность** |**xs:duration** |Продолжительность дорожки. Пример: Duration="PTSampleFormat M37.757S". |
...
| **Метаданные**<br /><br /> minOccurs="0" maxOccurs="unbounded" |[MetadataType](media-services-input-metadata-schema.md#MetadataType) |Общие строки "ключ —значение", которые можно использовать для хранения различных сведений. Например, key="language" и value="eng". |

## <a name="audiotracktype-inherits-from-tracktype"></a><a name="AudioTrackType"></a>AudioTrackType (наследует от TrackType)
...
| **Channels**<br /><br /> Обязательное значение |**xs:int** |Количество (0 или более) аудиоканалов. |
| **SamplingRate**<br /><br /> Обязательное значение |**xs:int** |Частота аудиовыборки: выборок/с или Гц. |
...
## <a name="videotracktype-inherits-from-tracktype"></a><a name="VideoTrackType"></a>VideoTrackType (наследует от TrackType)
...
| **Width**<br /><br /> Обязательное значение |**xs:int** |Ширина закодированного видео в пикселях. |
| **Height**<br /><br /> Обязательное значение |**xs:int** |Высота закодированного видео в пикселях. |
| **DisplayAspectRatioNumerator**<br /><br /> Обязательное значение |**xs: double** |Числитель пропорции отображения видео. |
| **DisplayAspectRatioDenominator**<br /><br /> Обязательное значение |**xs:double** |Знаменатель пропорции отображения видео. |
| **DisplayAspectRatioDenominator**<br /><br /> Обязательное значение |**xs: double** |Числитель пропорции выборки видео. |
...
| **Частота**<br /><br /> Обязательное значение |**xs:decimal** |Измеренная частота видеокадров в формате 3F. |
...
## <a name="metadatatype"></a><a name="MetadataType"></a>метадататипе
...
| Имя | Type | Описание: |
| --- | --- | --- |
| **key**<br /><br /> Обязательное значение |**xs:string** |Ключ в паре "ключ — значение". |
| **value**<br /><br /> Обязательное значение |**xs:string** |Значение в паре "ключ — значение". |
...
| Имя | Type | Описание: |
| --- | --- | --- |
| **ProgramId**<br /><br /> Обязательное значение |**xs:int** |Идентификатор программы |
| **NumberOfPrograms**<br /><br /> Обязательное значение |**xs:int** |Количество программ. |
| **PmtPid**<br /><br /> Обязательное значение |**xs:int** |Таблицы сопоставления программ (PMT) содержат сведения о программах.  Дополнительные сведения см. в разделе [PMT](https://en.wikipedia.org/wiki/MPEG_transport_stream#PMT). |
| **PcrPid**<br /><br /> Обязательное значение |**xs: int** |Используется декодером. Дополнительные сведения см. в разделе [PCR](https://en.wikipedia.org/wiki/MPEG_transport_stream#PCR). |
| **StartPTS** |**xs: long** |Метка времени начала презентации. |
| **EndPTS** |**xs: long** |Метка времени окончания презентации. |

## <a name="streamdispositiontype"></a><a name="StreamDispositionType"></a>стреамдиспоситионтипе
...
| Имя | Type | Описание |
| --- | --- | --- |
| **Default**<br /><br /> Обязательное значение |**xs: int** |Установите значение 1, чтобы указать, что это презентация по умолчанию. |
| **Dub**<br /><br /> Обязательное значение |**xs:int** |Установите значение 1, чтобы указать, что это дубликат презентации. |
| **До преобразования**<br /><br /> Обязательное значение |**xs: int** |Установите значение 1, чтобы указать, что это оригинал презентации. |
| **Комментарий**<br /><br /> Обязательное значение |**xs:int** |Установите значение 1, чтобы указать, что эта дорожка содержит дикторский текст. |
| **Lyrics**<br /><br /> Обязательное значение |**xs:int** |Установите значение 1, чтобы указать, что эта дорожка содержит слова композиции. |
| **Karaoke**<br /><br /> Обязательное значение |**xs:int** |Установите значение 1, чтобы указать, что это караоке-дорожка (фонограмма без вокала). |
| **Обязательна**<br /><br /> Обязательное значение |**xs:int** |Установите значение 1, чтобы указать, что это принудительная презентация. |
| **HearingImpaired**<br /><br /> Обязательное значение |**xs:int** |Присвойте этому атрибуту значение 1, чтобы указать, что эта запись предназначена для людей с нарушениями слуха. |
| **VisualImpaired**<br /><br /> Обязательное значение |**xs:int** |Установите значение 1, чтобы указать, что эта дорожка предназначена для пользователей с нарушениями зрения. |
| **CleanEffects**<br /><br /> Обязательное значение |**xs: int** |Установите значение 1, чтобы указать, что эта дорожка содержит чистые эффекты. |
| **AttachedPic**<br /><br /> Обязательное значение |**xs: int** |Установите значение 1, чтобы указать, что эта дорожка содержит изображения. |

## <a name="programs-element"></a><a name="Programs"></a> Элемент Programs
...
## <a name="schema-code"></a><a name="code"></a>Код схемы
```xml
