...
### <a name="create-asset-delivery-policy"></a><a id="create_asset_delivery_policy"></a>Создание политики доставки активов
...
### <a name="get-delivery-url"></a><a id="get_delivery_url"></a>Получить URL-адрес доставки
