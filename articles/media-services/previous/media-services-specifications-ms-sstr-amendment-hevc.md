...
>  **Время композиции**. Время, когда выборка поставляется на клиент, как определено в спецификации [[ISO/IEC-14496-12].](https://go.microsoft.com/fwlink/?LinkId=183695)

>   **CENC**. Общее шифрование, как определено во втором выпуске спецификации [ISO/IEC 23001-7].

>   **Время декодирования**. Время, когда выборка должна быть декодирована в клиенте, как определено в спецификации [[ISO/IEC http://go.microsoft.com/fwlink/?LinkId=18369514496-12].](https://go.microsoft.com/fwlink/?LinkId=183695)
