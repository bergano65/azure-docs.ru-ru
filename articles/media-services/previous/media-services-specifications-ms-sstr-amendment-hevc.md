...
> 
>   **Время декодирования**. Время, когда выборка должна быть декодирована в клиенте, как определено в спецификации [[ISO/IEC https://go.microsoft.com/fwlink/?LinkId=18369514496-12].](https://go.microsoft.com/fwlink/?LinkId=183695)
...
> 
>   [RFC2119] Bradner, S., «ключевые слова для использования в RFC для обозначения уровня требований», BCP 14, RFC 2119, март 1997 г.,   [https://www.rfc-editor.org/rfc/rfc2119.txt](https://go.microsoft.com/fwlink/?LinkId=90317)
...
> 
>   [RFC3548] Конференции Josefsson, S., «Base16, Base32 и Base64 кодировки данных», RFC 3548, июль 2003 г., [https://www.ietf.org/rfc/rfc3548.txt](https://go.microsoft.com/fwlink/?LinkId=90432)
> 
>   [RFC5234]. Д. Крокер (Crocker, D.) и П. Оверел (Overell, P.) "Augmented BNF for Syntax Specifications: ABNF», STD 68, RFC 5234, января 2008 г.   [https://www.rfc-editor.org/rfc/rfc5234.txt](https://go.microsoft.com/fwlink/?LinkId=123096)
...
>   Разработчики могут гарантировать, что расширения не конфликтуют, регистрируя их коды в MPEG4-RA, как указано в [[ISO/IEC-14496-12]](https://go.microsoft.com/fwlink/?LinkId=183695)
...
> 1. (Без изменения)
> 
>    Рекомендуемое значение — 90000 для представления точной продолжительности видеокадров и фрагментов, содержащих дробное видео (например, 30/1,001 Гц).
...
> 
>   **CodecPrivateData** поле должно содержать шестнадцатеричное строковое представление следующей последовательности байтов, указанный в ABNF [[RFC5234]:](https://go.microsoft.com/fwlink/?LinkId=123096) (без изменений в MS-SSTR)
> 
