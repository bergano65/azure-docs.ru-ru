...
description: В этой статье показано, как вставить рекламу в свои носители на стороне клиента.
...
## <a name="inserting-ads-into-your-media"></a><a id="insert_ads_into_media"></a>Вставка рекламы в мультимедиа
...
Платформа проигрывателя Microsoft Media Platform для iOS содержит набор образцов приложений, в которых демонстрируется реализация приложения видеопроигрывателя с использованием данной платформы. Платформу проигрывателя и образцы можно скачать на странице [Платформа Проигрывателя мультимедиа Azure](https://github.com/Azure/azure-media-player-framework). На странице GitHub есть ссылка на Вики, которая содержит дополнительную информацию о структуре игрока и введение в образец игрока: [Azure Media Player Wiki](https://github.com/Azure/azure-media-player-framework/wiki/How-to-use-Azure-media-player-framework).
