...
Платформа проигрывателя Microsoft Media Platform для iOS содержит набор образцов приложений, в которых демонстрируется реализация приложения видеопроигрывателя с использованием данной платформы. Платформу проигрывателя и образцы можно скачать на странице [Платформа Проигрывателя мультимедиа Azure](https://github.com/Azure/azure-media-player-framework). На странице GitHub есть ссылка на вики-сайт, содержащий дополнительные сведения о платформе проигрывателя, а также введение в пример для проигрывателя: [проигрыватель мультимедиа Azure вики-сайта](https://github.com/Azure/azure-media-player-framework/wiki/How-to-use-Azure-media-player-framework).
