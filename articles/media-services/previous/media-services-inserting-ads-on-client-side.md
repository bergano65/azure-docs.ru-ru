...
В этом примере указывается встроенный отклик на рекламу с элементом `<VASTAdData>`, содержащим отклик на рекламу VAST. Дополнительные сведения о других элементах см. в разделе [VMAP](https://www.iab.net/guidelines/508676/digitalvideo/vsuite/vmap).
...
Исполняемую рекламу можно инициализировать с помощью элемента `<AdParameters>` внутри элементов `<Linear>` или `<NonLinear>` в отклике VAST. Дополнительные сведения об элементе `<AdParameters>` см. в разделе [VAST 3.0](https://www.iab.net/media/file/VASTv3.0.pdf). Дополнительные сведения об интерфейсе VPAID API см. в разделе [VPAID 2.0](https://www.iab.net/media/file/VPAID_2.0_Final_04-10-2012.pdf).
...
Платформа проигрывателя Microsoft Media Platform для Windows 8 и Windows Phone 8 содержит набор примеров приложений, в которых демонстрируется реализация приложения видеопроигрывателя с использованием данной платформы. Платформу проигрывателя и образцы можно скачать на странице [Платформа проигрывателя для Windows 8 и Windows Phone 8](https://playerframework.codeplex.com).
...
Дополнительные сведения об AdSchedulerPlugin см. в разделе [Реклама на платформе проигрывателя в Windows 8 и Windows Phone 8](https://playerframework.codeplex.com/wikipage?title=Advertising&referringTitle=Windows%208%20Player%20Documentation).
...
Платформа проигрывателя Microsoft Media Platform для iOS содержит набор примеров приложений, в которых демонстрируется реализация приложения видеопроигрывателя с использованием данной платформы. Платформу проигрывателя и образцы можно скачать на странице [Платформа Проигрывателя мультимедиа Azure](https://github.com/Azure/azure-media-player-framework). На странице GitHub содержится ссылка на вики-сайт с дополнительными сведениями о платформе проигрывателя и общими сведениями о примере проигрывателя: [вики-сайт Проигрывателя мультимедиа Azure](https://github.com/Azure/azure-media-player-framework/wiki/How-to-use-Azure-media-player-framework).
