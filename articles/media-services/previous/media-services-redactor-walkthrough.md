...
Для получения дополнительной информации, смотрите [этот](https://azure.microsoft.com/blog/redaction-preview-available-globally) блог.
...
1. Скачать AMSE для AMS v2 инструмент [отсюда](https://aka.ms/amseforv2).
