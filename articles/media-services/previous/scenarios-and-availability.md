...
|---|---|---|
|Стандартный|Общая доступность|Все|
...
|---|---|---|
|Стандартный кодировщик служб мультимедиа|Общая доступность|Все|
...
|Azure Media Redactor|Общая доступность|Все|
