...
> [!NOTE] 
> Многие расширенные функции служб мультимедиа версии 2 Media Encoder Standard в настоящее время недоступны в версии 3. Дополнительные сведения см. в разделе [зазоры компонентов](https://docs.microsoft.com/azure/media-services/latest/migrate-from-v2-to-v3#feature-gaps-with-respect-to-v2-apis).
