...
1. Создайте интерактивное событие или программу. 
...
![Снимок экрана, на котором показана страница "Потоковая трансляция" с выбранным каналом и панелью каналов.](./media/media-services-portal-passthrough-get-started/media-services-channel-created.png)
