...
В этой статье показано, как управлять сущностями Служб мультимедиа Azure с помощью .NET (прежняя версия).
...
В следующем примере кода показан метод удаления задания, проверяющий состояния заданий и удаляющий их при завершенном или отмененном состоянии. Этот код зависит от ссылки на задание, которую вы получили, следуя инструкциям в предыдущем разделе "Получение ссылки на задание".
