...
3.  Проигрыватель мультимедиа Azure поддерживает спрайты только в браузерах Edge, Chrome и Firefox. Разбор VTT в IE11 не поддерживается.
