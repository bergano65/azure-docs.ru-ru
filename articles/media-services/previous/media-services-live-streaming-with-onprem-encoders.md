...
| **Выполнение** |**Готово** (нет запущенных программ)<p><p>или диспетчер конфигурации служб<p>**Потоковая передача** (запущена по крайней мере одна программа) |Да |
