...
ms.locfileid: "80476550"
---
# <a name="working-with-channels-that-receive-multi-bitrate-live-stream-from-on-premises-encoders"></a>Работа с каналами, которые получают многобитный живой эфир от кондиаторов на территории
...
>
>Для получения информации о рекомендуемых на помещениях кодеров, [см.](media-services-recommended-encoders.md)
...
У вас есть возможность глотать фрагментированный MP4 (Гладкая потоковая передача) живой эфир через подключение TLS. Чтобы глотать по TLS, не забудьте обновить URL-адрес для глотания до HTTPS. В настоящее время вы не можете глотать RTMP по TLS.
...
| --- | --- | --- |
| **Начиная** |**Начиная** |Нет (переходное состояние) |
...
| **Остановился** |**Остановился** |Нет |

## <a name="closed-captioning-and-ad-insertion"></a><a id="cc_and_ads"></a>Закрытые субтитры и вставки рекламы
...
[Рекомендуется на кодерах помещений](media-services-recommended-encoders.md)
