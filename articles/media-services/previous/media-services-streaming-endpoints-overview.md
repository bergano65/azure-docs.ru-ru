...
|Стандартная конечная точка потоковой передачи (Предварительная версия)|2,0|0|Yes|Платно|
|Единицы потоковой передачи типа "Премиум"|1.0|>0|Yes|Платно|
|Единицы потоковой передачи типа "Премиум"|2,0|>0|Yes|Платно|

### <a name="features"></a>Функции

Функция|Стандартная|Премиум
---|---|---
Бесплатно первые 15 дней <sup>1</sup>| Yes |Нет 
...
Фильтрация G20 или настраиваемый узел IP <sup>2</sup>|Yes|Yes
