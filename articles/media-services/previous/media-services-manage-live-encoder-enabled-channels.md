...
Обратите внимание, что если вам нужны пользовательские предустановки, amshelp@microsoft.comобратитесь к.
...
| Состояние Канала | Индикаторы пользовательского интерфейса портала | Выставление счетов |
| --- | --- | --- |
| Запуск |Идет запуск |Нет (переходное состояние) |
| Выполняется |Готово (нет запущенных программ)<br/>или диспетчер конфигурации служб<br/>Потоковая передача (как минимум одна программа запущена) |ДА |
| Идет остановка |Идет остановка |Нет (переходное состояние) |
| Остановлено |Остановлено |Нет |
