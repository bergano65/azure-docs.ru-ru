...
* **Остановлен**. Это первоначальное состояние Канала после его создания. В этом состоянии свойства Канала можно обновить, но потоковая передача невозможна.
* **Запуск**. Канал запускается. В этом состоянии не разрешаются обновления и потоковая передача. При возникновении ошибки Канал возвращается в состояние "Остановлено".
* **Выполняется**. Канал способен обрабатывать потоки в реальном времени.
* **Остановка**. Канал прекращает свою работу. В этом состоянии не разрешаются обновления и потоковая передача.
