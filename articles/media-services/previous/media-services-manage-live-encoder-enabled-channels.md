...
| Запущен |Готово (нет запущенных программ)<br/>or<br/>Потоковая передача (запущена по крайней мере одна программа) |YES |
...
| --- | --- | --- |
| Запуск |Запуск |Нет (переходное состояние) |
| Запущен |Готово (нет запущенных программ)<br/>or<br/>Потоковая передача (запущена по крайней мере одна программа) |Да |
| Остановка |Остановка |Нет (переходное состояние) |
| Остановлена |Остановлена |нет |
