...
3. Используйте **NuGet** для добавления ссылок на библиотеки DLL, связанные со службами мультимедиа. В **главном меню Visual Studio**выберите **инструменты** > **Диспетчер пакетов NuGet** > **консоль диспетчера пакетов**. В окне консоли введите **Install-Package windowsazure.mediaservices** и нажмите клавишу ВВОД.
