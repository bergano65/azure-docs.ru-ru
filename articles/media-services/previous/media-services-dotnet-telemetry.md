...
ms.locfileid: "55989880"
---
# <a name="configuring-azure-media-services-telemetry-with-net-legacy"></a>Настройка телеметрии Служб мультимедиа Azure с использованием .NET (для предыдущих версий)
