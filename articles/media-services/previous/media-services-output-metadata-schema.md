...
| Name | Тип | Описание |
| --- | --- | --- |
| **Id**<br/><br/> minInclusive ="0"<br/><br/> Обязательно для заполнения |**xs:int** |Отсчитываемый от нуля индекс этой видеодорожки. **Примечание.**  Этот **идентификатор** необязательно является TrackID, используемым в MP4-файле. |
...
| Name | Тип | Описание |
| --- | --- | --- |
| **Id**<br/><br/> minInclusive ="0"<br/><br/> Обязательно для заполнения |**xs:int** |Отсчитываемый от нуля индекс этой звуковой дорожки. **Примечание.**  Это не обязательно TrackID, используемое в MP4-файле. |
