...
description: В этой статье приводится обзор схемы метаданных выходных метаданных медиаслужбы Azure Media Services.
author: Juliako
manager: femila
editor: ''
...
Задание кодирования связано с входным ресурсом-контейнером (или ресурсами-контейнерами), в котором нужно выполнить эти задачи. Например, преобразуйте MP4-файл в набор мультискоростных MP4-файлов в формате H.264. Создайте эскиз и наложения. После выполнения задачи создается выходной ресурс-контейнер.  Выходный актив содержит видео, аудио, эскизы и т.д. Выходный актив также содержит файл с метаданными об активе вывода. Имя XML-файла метаданных имеет следующий формат: &lt;имя_исходного_файла&gt;_manifest.xml (например, BigBuckBunny_manifest.xml).  
...
## <a name="assetfiles-root-element"></a><a name="AssetFiles"></a> Корневой элемент AssetFiles
...
## <a name="assetfile-element"></a><a name="AssetFile"></a> Элемент AssetFile
Пример XML-файла см. в [соответствующем разделе](#xml).  

### <a name="attributes"></a>Атрибуты
| name | Тип | Описание |
| --- | --- | --- |
| **Название**<br/><br/> Обязательно |**xs:string** |Имя файла ресурса мультимедиа. |
| **Размер**<br/><br/> minInclusive ="0"<br/><br/> Обязательно |**xs:long** |Размер файла ресурса-контейнера в байтах. |
| **Длительность**<br/><br/> Обязательно |**xs:duration** |Длительность воспроизведения содержимого. |
...
## <a name="sources-element"></a><a name="Sources"></a>Элемент источников
...
## <a name="source-element"></a><a name="Source"></a>Исходный элемент
...
| name | Тип | Описание |
| --- | --- | --- |
| **Название**<br/><br/> Обязательно |**xs:string** |Имя входного исходного файла. |
...
## <a name="videotrack-element"></a><a name="VideoTrack"></a> Элемент VideoTrack
...
| name | Тип | Описание |
| --- | --- | --- |
| **Id**<br/><br/> minInclusive ="0"<br/><br/> Обязательно |**xs:int** |Нулевой индекс этого видеотрека. **Примечание:**  Этот **идентификатор** не обязательно является TrackID, используемым в файле MP4. |
...
| **Ширина**<br/><br/> minInclusive ="0"<br/><br/> Обязательно |**xs:int** |Ширина закодированного видео в пикселях. |
| **Высота**<br/><br/> minInclusive ="0"<br/><br/> Обязательно |**xs:int** |Высота закодированного видео в пикселях. |
...
| **Кадров**<br/><br/> minInclusive ="0"<br/><br/> Обязательно |**xs:decimal** |Измеренная частота видеокадров в формате 3F. |
...
## <a name="audiotrack-element"></a><a name="AudioTrack"></a> Элемент AudioTrack
...
| name | Тип | Описание |
| --- | --- | --- |
| **Id**<br/><br/> minInclusive ="0"<br/><br/> Обязательно |**xs:int** |Нулевой индекс этой звуковой дорожки. **Примечание:**  Это не обязательно TrackID, используемый в файле MP4. |
| **Кодек** |**xs:string** |Строка кодека звуковой дорожки. |
| **EncoderVersion** |**xs:string** |Дополнительная строка версии кодировщика, требуемая для EAC3. |
| **Каналы**<br/><br/> minInclusive ="0"<br/><br/> Обязательно |**xs:int** |Число аудиоканалов. |
...
## <a name="loudnessmeteringresultparameters-element"></a><a name="LoudnessMeteringResultParameters"></a> Элемент LoudnessMeteringResultParameters
...
## <a name="xml-example"></a><a name="xml"></a>Пример XML
