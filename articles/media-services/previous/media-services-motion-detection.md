...
| Название | Параметры | Описание | Значение по умолчанию |
| --- | --- | --- | --- |
| sensitivityLevel |String: low, medium, high |Задает уровень чувствительности, используемый при предоставлении сведений о движениях. Измените его, чтобы настроить число ложных срабатываний. |medium |
...
| detectLightChange |Boolean: true или false |Определяет, будут ли сведения об изменениях освещения отображены в результатах |False |
