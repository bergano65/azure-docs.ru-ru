...
description: В этой статье приводится обзор защиты контента с помощью Azure Media Services v2.
...
Службы мультимедиа Azure доставляют содержимое, динамически зашифрованное с помощью незащищенного ключа AES или шифрования DRM путем использования PlayReady, Widevine или FairPlay. Если содержимое зашифровано с помощью четкого ключа AES и передается через HTTPS, это не ясно, пока не достигнет клиента. 
...
## <a name="aes-128-clear-key-vs-drm"></a>Ясный ключ AES-128 против DRM
...
* [Защитите с помощью PlayReady и/или Widevine](media-services-protect-with-playready-widevine.md)
