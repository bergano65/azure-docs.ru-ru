...
Следующий метод **следующий configureclearassetdeliverypolicy** указывает, что не следует применять динамическое шифрование и передавать поток в любой из следующих протоколов: MPEG ТИРЕ, HLS и Smooth Streaming protocols. Эту политику можно применить к зашифрованным в хранилище ресурсам-контейнерам.
