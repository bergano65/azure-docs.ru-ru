...
| --- | --- |
|AdvancedOutput| Если для атрибута AdvancedOutput задано значение true, выходные данные JSON будут содержать данные о положении для каждого отдельного слова (помимо фраз и регионов). Если вы не хотите видеть эти сведения, установите значение false. Значение по умолчанию — false. Дополнительную информацию см. в [этом блоге](https://azure.microsoft.com/blog/azure-media-ocr-simplified-output/).|
...
| начало |Время начала фрагмента в тактах |
...
| ориентация |Ориентация текста, обнаруженного в пределах области |
| линии |Массив строк текста, обнаруженного в пределах области |
