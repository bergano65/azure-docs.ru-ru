---
title: Общие сведения о зарезервированных единицах мультимедиа | Документация Майкрософт
description: В этой статье представлен обзор масштабирования обработки мультимедиа с помощью служб мультимедиа Azure.
...
[Платформа .NET](media-services-dotnet-encoding-units.md) 
 [Портал](media-services-portal-scale-media-processing.md) 
 [Оставшаяся](/rest/api/media/operations/encodingreservedunittype) 
