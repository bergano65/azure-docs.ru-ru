...
| Семиминутное видео, где представлен тест производительности |Кодирование в односкоростной MP4-файл с тем же разрешением занимает приблизительно 5 минут. |Кодирование с предустановкой H264 Single Bitrate 720p длится около 8 минут.<br/><br/>Кодирование с предустановкой H264 Multiple Bitrate 720p длится 16,8 минуты. |Кодирование с предустановкой H264 Single Bitrate 1080p длится 4 минуты.<br/><br/>Кодирование с предустановкой H264 Multiple Bitrate 1080p длится 8 минут. |
