...
ms.locfileid: "58077791"
---
# <a name="how-to-perform-live-streaming-using-media-services-to-create-multi-bitrate-streams-with-the-azure-portal"></a>Как вести потоковую трансляцию с использованием служб мультимедиа для создания потоков с несколькими скоростями на портале Azure  
