...
При успешной отправке длительной операции вы получаете сообщение "201 Created" и должны запросить завершение операции с помощью возвращенного идентификатора операции.
