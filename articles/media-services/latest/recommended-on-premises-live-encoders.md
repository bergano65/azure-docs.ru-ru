...
13. С помощью проигрывателя, например [Проигрывателя мультимедиа Azure](http://aka.ms/azuremediaplayer), просмотрите архивный ресурс и проверьте видео на отсутствие артефактов при любом уровне качества. Либо воспользуйтесь URL-адресом для предварительного просмотра, чтобы убедиться в отсутствии ошибок во время сеанса трансляции.
...
Выполните те же инструкции, что и для [проверки сквозной трансляции](#pass-through-live-event-verification), за исключением шага 11. <br/>Запустите динамический кодировщик не на 10 минут, а на неделю или на более длительный период. Используйте проигрыватель, например [Проигрыватель мультимедиа Azure](http://aka.ms/azuremediaplayer), чтобы время от времени просматривать потоковую трансляцию (или архивный ресурс) и проверять видео на отсутствие артефактов.
