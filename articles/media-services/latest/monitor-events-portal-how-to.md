---
title: Мониторинг событий Мультимедиа Мониторинг с помощью Event Grid с помощью портала
...
1. Выберите «Веб Крюк» для **типа endpoint.**
