...
ms.locfileid: "58012650"
---
# <a name="how-to-encode-with-a-custom-transform-by-using-rest"></a>Как кодировать с помощью пользовательского преобразования с помощью REST
