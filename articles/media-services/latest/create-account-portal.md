...
1. Нажмите кнопку **Создать** в нижней части формы.
    ...
    После успешного создания учетной записи просмотрите загрузку страниц. В таблице конечная точка потоковой передачи учетная запись будет иметь конечную точку потоковой передачи по умолчанию в **остановленном** состоянии. 
