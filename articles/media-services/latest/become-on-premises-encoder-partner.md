---
title: Станьте партнером по кодере в помещениях - Azure Media Services
description: В этой статье обсуждается, как проверить ваши на месте жить потокового кодеров.
...
---
# <a name="how-to-verify-your-on-premises-live-streaming-encoder"></a>Как проверить ваш на месте жить потокового кодера
...
6. Создайте **Live Output** и используйте созданное вами имя актива.
7. Создайте **потоковое локатор** со встроенными типами **потоковой политики.**
...
[Проверенные на месте кодеры](recommended-on-premises-live-encoders.md)
