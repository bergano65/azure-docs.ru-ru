...
description: Станьте локальным партнером по кодировщику с помощью служб мультимедиа Azure.
...
ms.locfileid: "78252978"
---
# <a name="become-an-on-premises-encoder-partner"></a>Станьте локальным партнером по кодировщику
...
[Рекомендуемые локальные динамические кодировщики](recommended-on-premises-live-encoders.md)
