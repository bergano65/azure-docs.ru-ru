...
> [!NOTE]
> Если вам нужно использовать пользовательскую предустановку для кодирования в реальном времени, обратитесь по адресу amshelp@microsoft.com. Следует указать нужную таблицу с разрешениями и скоростями. Убедитесь, что имеется только один слой 720p и не более 6 слоев.
