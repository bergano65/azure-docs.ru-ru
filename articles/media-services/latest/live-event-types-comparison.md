...
В службах мультимедиа Azure для [события Live](https://docs.microsoft.com/rest/api/media/liveevents) можно задать *транзитный* (локальный динамический кодировщик отправляет поток с несколькими скоростями) или *кодирование в реальном времени* (локальный динамический кодировщик отправляет один поток с скоростью). 
...
| Возможность включения динамической транскрипции|Да|Да|
