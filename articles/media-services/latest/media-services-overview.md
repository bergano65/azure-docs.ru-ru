...
> [!TIP]
> Перед началом разработки ознакомьтесь со следующими материалами:<br/>* [Основные понятия](concepts-overview.md) (описание таких важных понятий, как упаковка, кодирование и защита)<br/>* [Разработка с использованием интерфейсов API служб мультимедиа версии 3](media-services-apis-overview.md) (включает в себя сведения о доступе к интерфейсам API, соглашения об именовании и т. д.)
