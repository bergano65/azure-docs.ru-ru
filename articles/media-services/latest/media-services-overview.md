...
* **Уведомления**, отслеживающие ход выполнения задания или состояния, а также события включения, выключения и возникновения ошибок динамических событий. Уведомления интегрированы с системой уведомлений службы "Сетка событий Azure". Вы можете легко подписаться на события в нескольких ресурсах на платформе "Службы мультимедиа Azure". 
* Шаблоны **Управление ресурсами Azure** можно использовать для создания и развертывания преобразований, конечных точек потоковой передачи, событий потоковой трансляции и т. д.
* **Управление доступом на основе ролей** можно задать на уровне ресурсов, что позволит заблокировать доступ к определенным ресурсам (например, к преобразователям, динамическим событиям и т. д.).
...
Сведения о том, как начать разработку в API Служб мультимедиа версии 3 с использованием различных инструментов и пакетов SDK, см. в статье [Начало разработки с использованием API Служб мультимедиа версии 3 с помощью пакетов SDK и служб](developers-guide.md).
...
| Основные понятия | Подробные пояснения [основных понятий и функций Служб мультимедиа версии 3](concepts-overview.md). Прежде чем приступать к разработке, необходимо ознакомиться со следующими основными понятиями.<br/><br/>* Передача в облако и хранение<br/>* Кодирование<br/>* Аналитика мультимедиа<br/>* Упаковка, доставка и защита<br/>* Потоковая трансляция<br/>* Мониторинг<br/>* Клиенты Проигрывателя<br/><br/>другое. |
