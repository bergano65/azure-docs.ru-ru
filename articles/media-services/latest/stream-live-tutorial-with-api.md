...
ms.locfileid: "51613398"
---
# <a name="tutorial-stream-live-with-media-services-v3-using-apis"></a>Руководство. Потоковая трансляция в реальном времени с помощью Служб мультимедиа Azure версии 3 и API-интерфейсов
