---
title: Потоковая трансляция в режиме реального времени с помощью Служб мультимедиа версии 3
titleSuffix: Azure Media Services
description: Сведения о потоковой трансляции в режиме реального времени с помощью Служб мультимедиа Azure версии 3.
...
> * Просмотр событий с помощью [Проигрывателя мультимедиа Azure](https://amp.azure.net/libs/amp/latest/docs/index.html) в https://ampdemo.azureedge.net.
> * Очистка ресурсов.
...
> [!IMPORTANT]
> Этот пример использует уникальный суффикс для каждого ресурса. Если вы отмените отладку или завершите приложение раньше, чем оно закончит свою работу, в вашей учетной записи сохранятся несколько трансляций. <br/>
