...
| состояние | string | Новое состояние задания в этом событии. Например, "Scheduled: The job is ready to start" (Запланировано: задание готово к запуску) или "Finished: The job is finished" (Завершено: задание завершено).|
...
| состояние | string | Состояние события прямой трансляции. |
