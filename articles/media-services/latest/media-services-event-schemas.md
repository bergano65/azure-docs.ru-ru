...
| state | string | Новое состояние задания в этом событии. Например, "запланировано: Задание готово к запуску" или "завершено: задание завершено".|
...
Коды результатов ошибок можно найти в [кодах ошибок динамических событий](live-event-error-codes.md).
...
| Свойство | Тип | Описание |
| -------- | ---- | ----------- |
| Раздел | string | Раздел "Сетка событий". Это свойство имеет идентификатор ресурса для учетной записи Служб мультимедиа. |
...
- [Коды динамических ошибок событий](live-event-error-codes.md)
