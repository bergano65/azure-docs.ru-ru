...
Вы можете найти коды результатов ошибки в [кодах ошибок события в реальном времени.](live-event-error-codes.md)
...
- [Коды ошибок, связанных с трансляцией](live-event-error-codes.md)
