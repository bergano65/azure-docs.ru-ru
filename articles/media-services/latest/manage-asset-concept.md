...
* [Разработка с помощью API-интерфейсов служб мультимедиа v3](media-services-apis-overview.md) (содержит сведения о доступе к API, соглашения об именовании и т. д.) 
...
* [Создание входных данных задания на основе URL-адреса HTTPS](job-input-from-http-how-to.md)
