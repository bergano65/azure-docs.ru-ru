...
Активные события теперь имеют состояние StandBy.  См. раздел [динамические события и динамические выходные данные в службах мультимедиа](https://docs.microsoft.com/azure/media-services/latest/live-events-outputs-concept).
