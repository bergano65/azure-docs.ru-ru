...
В службах мультимедиа v3 API-интерфейсы хранилища используются для передачи файлов в активы. Дополнительные сведения см. в разделе [Основные понятия активов](assets-concept.md).
