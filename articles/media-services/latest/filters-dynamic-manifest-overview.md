...
ms.locfileid: "66225522"
---
# <a name="pre-filtering-manifests-with-dynamic-packager"></a>Предварительная фильтрация манифестов для работы динамического упаковщика
...
Фильтры можно применять к протоколам потоковой передачи с переменной скоростью: HLS, MPEG-DASH и Smooth Streaming. В представленной ниже таблице приводятся некоторые примеры URL-адресов с фильтрами.
