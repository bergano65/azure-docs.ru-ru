...
Трудно выполнить точный расчет максимального числа параллельных потоков, поддерживаемых конечной точкой потоковой передачи, так как при этом учитывается ряд факторов. Сюда входит следующее.
