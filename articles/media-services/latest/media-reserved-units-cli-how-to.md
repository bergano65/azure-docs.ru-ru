...
Службы мультимедиа Azure позволяют масштабировать обработку мультимедиа в учетной записи, управляя зарезервированными единицами мультимедиа (MRU). MRUs определить скорость, с которой ваши задачи обработки мультимедиа обрабатываются. Вы можете выбрать один из следующих типов зарезервированных единиц: **S1**, **S2** или **S3**. Например, если использовать тип зарезервированной единицы **S2**, задание по кодированию выполняется быстрее по сравнению заданием, для которого выбран тип **S1**. 
...
Остальная часть статьи показывает, как использовать [медиа-услуги v3 CLI](https://aka.ms/ams-v3-cli-ref) для масштабирования MRUs.
