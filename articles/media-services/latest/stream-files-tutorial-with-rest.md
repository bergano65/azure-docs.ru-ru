---
title: Кодирование и потоковая передача файла из удаленного расположения с помощью Служб мультимедиа Azure версии 3
...
ms.locfileid: "78359523"
---
# <a name="tutorial-encode-a-remote-file-based-on-url-and-stream-the-video---rest"></a>Учебник. кодирование удаленного файла на основе URL-адреса и поток видео — остальное
