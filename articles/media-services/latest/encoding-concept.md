...
description: Узнайте, как кодировать видео и аудио с помощью служб мультимедиа Azure.
...
* [Кодирование локального файла с помощью встроенных предустановок](job-input-from-local-file-how-to.md).
* [Создайте пользовательскую предустановку, предназначенную для конкретного сценария или требований к устройству](customize-encoder-presets-how-to.md).