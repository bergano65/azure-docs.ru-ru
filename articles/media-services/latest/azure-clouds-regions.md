---
title: Доступность облаков и регионов служб мультимедиа Azure v3
...
ms.locfileid: "93242718"
---
# <a name="azure-media-services-v3-clouds-and-regions-availability"></a>Доступность облаков и регионов служб мультимедиа Azure v3

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

Службы мультимедиа Azure версии 3 доступны через Azure Resource Manager. Однако не все функции Служб мультимедиа доступны во всех облаках Azure. В этом документе описывается наличие основных компонентов Служб мультимедиа версии 3. В следующих таблицах показано, какие функции служб мультимедиа доступны в каждом регионе.  

[!INCLUDE [reference-feature-availability-us](./includes/regions-availability-table-key.md)]

Используйте навигацию справа, чтобы найти интересующий вас регион.
