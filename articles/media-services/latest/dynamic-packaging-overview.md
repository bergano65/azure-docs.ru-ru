...
1. Получение URL-адреса приема и настройка вашего локального кодировщика использовать URL-адрес для отправки, участия в веб-канала.
