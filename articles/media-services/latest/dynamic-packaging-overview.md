...
## <a name="to-prepare-your-source-files-for-delivery"></a><a id="delivery-protocols"/>Подготовка исходных файлов к доставке
...
## <a name="audio-codecs-supported-by-dynamic-packaging"></a><a id="audio-codecs"/>Аудиокодеки, поддерживаемые для динамической упаковки
