---
title: Использование службы мультимедиа Azure для сдвига и динамической передачи в VOD (видео по запросу) | Документация Майкрософт
...
ms.locfileid: "71338846"
---
# <a name="using-time-shifting-and-live-to-vod-video-on-demand"></a>Использование смены времени и динамической передачи в VOD (видео по запросу)
