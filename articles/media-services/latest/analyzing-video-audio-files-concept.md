...
description: При использовании служб мультимедиа Azure можно анализировать аудио и видео содержимое с помощью Аудиоанализерпресет и Видеоанализерпресет.
...
|[фацедетекторпресет](https://docs.microsoft.com/rest/api/media/transforms/createorupdate#facedetectorpreset)|Обнаружение всех лиц, имеющихся в видео|Описывает параметры, используемые при анализе видео с целью обнаружения всех имеющихся лиц.|
