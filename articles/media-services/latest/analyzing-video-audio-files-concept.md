...
|[фацедетекторпресет](/rest/api/media/transforms/createorupdate#facedetectorpreset)|Обнаружение лиц, имеющихся в видео|Описывает параметры, используемые при анализе видео для обнаружения всех имеющихся лиц.|
