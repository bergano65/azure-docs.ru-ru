...
|**Имя предустановки**|**Сценарий**|**Сведения**|
|---|---|---|
...
|Экземпляры|Экземпляры, в которых лицо появлялось в заданном диапазоне времени. У каждого экземпляра также есть thumbnailsId. |
...
|Экземпляры|Список временных интервалов этого снимка (снимки имеют только один экземпляр).|
