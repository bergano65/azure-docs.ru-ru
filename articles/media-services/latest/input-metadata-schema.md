...
| name | Описание |
| --- | --- |
| **имя**;<br />Обязательно |Имя файла ресурса-контейнера. <br /><br />Пример: `"Name": "Ignite-short.mp4"` |
...
| **Размер**<br />Обязательно |Размер файла ресурса-контейнера в байтах.  <br /><br />Пример: `"Size": 75739259`|
| **Длительность**<br />Обязательно |Длительность воспроизведения содержимого. <br /><br />Например, `"Duration": "PT1M10.304S"`. |
| **NumberOfStreams**<br />Обязательно |Количество потоков в файле ресурса-контейнера.  <br /><br />Пример: `"NumberOfStreams": 2`|
| **FormatNames**<br />Обязательно |Имена форматов.  <br /><br />Пример: `"FormatNames": "mov,mp4,m4a,3gp,3g2,mj2"`|
| **форматвербосенаме**<br /> Обязательно |Подробные имена форматов. <br /><br />Пример: `"FormatVerboseName": "QuickTime / MOV"` |
...
| **Level** |Уровень видеодорожки. <br /><br />Пример: `"Level": "3.2"`|
...
| **Id**<br />Обязательно |Отсчитываемый от нуля индекс аудио- или видеодорожки.<br /><br /> Этот **идентификатор** не обязательно представляет собой TrackID, используемый в файле MP4. <br /><br />Пример: `"Id": 2`|
...
| **Равн** |Строка кодека видеодорожки. <br /><br />Пример: `"Codec": "h264"`|
| **TimeBase**<br />Обязательно |Базовый счетчик времени.<br /><br />Пример: `"TimeBase": "1/30000"`|
...
| **Каналы**<br />Обязательно |Количество (0 или более) аудиоканалов. <br /><br />Пример: `"Channels": 2`|
...
| **Метаданные** |Общие строки "ключ —значение", которые можно использовать для хранения различных сведений.  <br />Полный пример см. в конце статьи. |
| **Id**<br />Обязательно |Отсчитываемый от нуля индекс аудио- или видеодорожки.<br /><br /> MP4-файл не обязательно должен содержать идентификатор дорожки. <br /><br />Пример: `"Id": 1`|
...
| **TimeBase**<br />Обязательно |Базовый счетчик времени.<br /><br />Пример: `"TimeBase": "1/48000"` |
...
| Имя | Описание |
| --- | --- |
| **key**<br />Обязательно |Ключ в паре "ключ — значение". |
| **value**<br /> Обязательно |Значение в паре "ключ — значение". |
