...
>![Регистрация для создания записных книжек Azure](./media/notebooks/sentinel-azure-sign-up-azure-notebooks.png)
...
1. В портал Azure перейдите к**записным книжкам** **Azure Sentinel** > **Threat Management** > , где можно просмотреть записные книжки, предоставляемые Azure Sentinel. 
...
1. В портал Azure перейдите к**записным книжкам** **Azure Sentinel** > **Threat Management** > и выберите **клонировать записные книжки** на панели команд:
  
    > [!div class="mx-imgBorder"]
    >![Параметр клонирования записных книжек](./media/notebooks/sentinel-azure-clone-notebooks.png)
...
3. Выберите записную книжку, чтобы открыть ее.
    ...
    При первом открытии записной книжки может быть предложено выбрать версию ядра. Если запрос не выводится, можно выбрать версию ядра из**ядра изменения** **ядра** >  , а затем выбрать версию, которая не ниже 3,6. Выбранная версия ядра отображается в правом верхнем углу окна записной книжки:
