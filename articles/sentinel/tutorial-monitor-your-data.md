...
1. Кроме того, можно клонировать книгу. Выберите **изменить** , а затем **Сохранить как**, сохранив его под другим именем в той же подписке и группе ресурсов. Эти книги отображаются на вкладке **Мои книги** .
...
1. Чтобы переключаться между книгами в рабочей области, в верхней области любой книги](./media/tutorial-monitor-data/switch.png)можно выбрать **Открыть** ![книги переключения. В окне, открывающемся справа, переключитесь между книгами.
...
Чтобы удалить настроенную книгу, сделайте следующее:
1.  Выберите **Просмотр книги**.
2.  Выберите **Открыть** в верхней части страницы.
3.  В таблице, в которой перечислены книги, в строке удаляемой книги выберите три точки в конце строки... чтобы открыть меню, а затем выберите **Удалить**. Сохраненная книга будет удалена.
