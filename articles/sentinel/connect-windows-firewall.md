...
>
> - Если Azure Sentinel и Azure Defender (ранее — центр безопасности Azure) собираются в одну и ту же рабочую область, не нужно включать решение брандмауэра Windows через этот соединитель. Если вы включили его, это не приведет к дублированию данных. 
...
На вкладке **инструкции** выполните следующие действия.

- **Если ваши компьютеры Windows находятся в Azure, выполните следующие действия.**
...
После выполнения действий на вкладке **инструкции** нажмите кнопку **установить решение**.

### <a name="next-steps-tab"></a>Вкладка "дальнейшие действия"

- Чтобы получить представление о данных журнала брандмауэра Windows, ознакомьтесь с доступными рекомендуемыми книгами и примерами запросов, объединенными с соединителем данных **брандмауэра Windows** .
