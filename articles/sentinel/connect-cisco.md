---
title: Сбор данных Cisco в предварительной версии Sentinel Azure | Документация Майкрософт
description: Дополнительные сведения о сборе данных Cisco в Azure Sentinel.
services: sentinel
...
Настройка Cisco ASA для пересылки сообщения системного журнала в рабочей области Azure с помощью системного журнала агента:
...
В этом документе вы узнали, как для подключения устройства Cisco ASA к Azure Sentinel. Дополнительные сведения о Azure Sentinel, см. в разделе со следующими статьями:
