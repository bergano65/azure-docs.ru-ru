...
Вы можете настроить книги путем редактирования основного запроса ![кнопка редактирования запроса](./media/qs-get-visibility/edit-query-button.png). Нажмите на кнопку ![кнопка Log Analytics](./media/qs-get-visibility/go-to-la-button.png), чтобы перейти в [Log Analytics для изменения запроса](../azure-monitor/log-query/log-analytics-tutorial.md). Вы можете выбрать кнопку с многоточием (...) и щелкнуть **Настройка данных плитки**, что позволяет изменить основной фильтр времени или удалить определенные плитки в книге.
