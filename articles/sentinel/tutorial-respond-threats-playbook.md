...
description: В этом учебнике показано, как использовать сборники схем по обеспечению безопасности в Azure Sentinel для настройки автоматического реагирования на связанные с безопасностью угрозы.
services: sentinel
