...
1. В диалоговом окне Сохранить заполните поля следующим образом:
    ...
    1. **Категория**. можно выбрать существующую категорию или создать новую категорию (например, *нормализеднетворксессионспарсерс*).
        ...
        :::image type="content" source="./media/normalization/save-new-parser.png" alt-text="Установка нового средства синтаксического анализа":::
...
:::image type="content" source="./media/normalization/query-parser.png" alt-text="Установка нового средства синтаксического анализа":::
...
:::image type="content" source="./media/normalization/query-explorer.png" alt-text="Установка нового средства синтаксического анализа" (или имя категории, выбранное при создании анализаторов):

:::image type="content" source="./media/normalization/find-parser.png" alt-text="Установка нового средства синтаксического анализа":::
...
:::image type="content" source="./media/normalization/customize-parser.png" alt-text="Установка нового средства синтаксического анализа" и используйте то же имя, псевдоним и категорию. Откроется диалоговое окно переопределения — нажмите кнопку "ОК":

:::image type="content" source="./media/normalization/are-you-sure.png" alt-text="Установка нового средства синтаксического анализа":::
