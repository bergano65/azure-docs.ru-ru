...
1. На портале Sentinel Azure щелкните **аналитика**и перейдите на вкладку **шаблоны правил** . Выберите правило **обнаружения аномальных входов RDP** и переместите ползунок **состояние** в положение **включено**.
