...
- **Распространенные** -стандартный набор событий для аудита. Полный журнал аудита пользователя включается в этот набор. Например, этот набор содержит данные о входе и выходе пользователя (идентификатор события 4634). Мы добавили действия аудита, такие как изменение группы безопасности, операции основного контроллера домена Kerberos и другие события, рекомендованные отраслевыми организациями.
