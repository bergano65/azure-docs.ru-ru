...
> [!NOTE]
> Сбор событий безопасности в контексте одной рабочей области можно настроить из защитника Azure (прежнее название — "Центр безопасности Azure") или с помощью Azure Sentinel, но не одновременно. Если вы подключите метку Azure в рабочей области, в которой уже работает защитник Azure, и для нее настроено получение событий безопасности, у вас есть два варианта:
> - Оставьте коллекцию событий безопасности в защитнике Azure как есть. Вы сможете запрашивать и анализировать эти события в Azure Sentinel, а также в защитнике Azure. Однако вы не сможете отслеживать состояние подключения соединителя или изменять его конфигурацию в Azure Sentinel. Если это важно, рассмотрим второй вариант.
>
> - [Отключите сбор событий безопасности](../security-center/security-center-enable-data-collection.md) в защитнике Azure и добавьте только соединитель событий безопасности в Azure Sentinel. Как и в случае с первым параметром, вы сможете запрашивать и анализировать события как в Azure Sentinel, так и в защитнике Azure, но теперь вы сможете отслеживать состояние подключения соединителя или изменять его конфигурацию в и только в Azure Sentinel.
