...
- Вы должны быть предварительным клиентом защитника Майкрософт для идентификации и включения интеграции между защитником Майкрософт для идентификации и Microsoft Cloud App Security. Дополнительные сведения см. в [статье защитник Майкрософт для интеграции удостоверений](https://docs.microsoft.com/cloud-app-security/aatp-integration).
