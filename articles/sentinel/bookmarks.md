...
1. В портал Azure **перейдите к**пункту "  >  Управление обработаными**угрозами**",  >  **Hunting** чтобы выполнить запросы для подозрительных и аномальных поведений.
...
1. В портал Azure перейдите к пункту Управление закладками **для**  >  **управления**  >  **Hunting**  >  **Bookmarks** обученными угрозами и выберите закладку или закладки, которые необходимо исследовать.
...
1. В портал Azure **перейдите к**пункту Управление закладками для  >  **управления**  >  **Hunting**  >  **Bookmarks** инцидентами, а затем выберите закладку или закладки, которые нужно добавить в происшествие.
...
Чтобы просмотреть закладку в инциденте, перейдите к пункту инциденты управления событиями **Sentinel**  >  **Threat management**  >  **Incidents** и выберите инцидент с закладкой. Выберите **Просмотреть все сведения**, а затем перейдите на вкладку **закладки** .
...
Для просмотра запросов с закладками, результатов или их журнала выберите закладку на **Hunting**  >  вкладке Поиск**закладок** и используйте ссылки, приведенные в области сведений. 
...
Можно также просмотреть необработанные данные закладки для всех закладок, выбрав **журналы закладок** на панели команд на вкладке Поиск **Hunting**  >  **закладок** .
...
1.  В портал Azure **перейдите к**пункту Управление закладками на странице "Поиск меток  >  **Threat management**  >  **Hunting**  >  **Bookmarks** " и выберите закладку или закладки, которые нужно удалить. 
