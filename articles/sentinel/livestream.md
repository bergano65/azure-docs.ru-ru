...
> [!IMPORTANT]
> Поиск облаку в Azure Sentinel в настоящее время находится в общедоступной предварительной версии.
...
Выберите уведомление, чтобы открыть колонку **облаку** .
