...
1. Выберите рабочую область, которую вы хотите использовать, или создайте новую. Вы можете запускать метку Azure в нескольких рабочих областях, но данные изолированы по одной рабочей области.
   ...
   > - Sentinel Azure можно запускать в рабочих областях, развернутых в любом из следующих регионов:  Юго-Восточная Австралия, Центральная Канада, Центральная Индия, Восточная часть США, Восточная часть США 2 (EUAP) (ранний), Восточная Япония, Юго-Восточная Азия, южная часть Соединенного Королевства, Западная Европа, Западная часть США 2.
