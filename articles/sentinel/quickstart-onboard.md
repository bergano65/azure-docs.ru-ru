---
title: Подключение в предварительной версии Azure Sentinel | Документация Майкрософт
...
ms.locfileid: "70019024"
---
# <a name="on-board-azure-sentinel-preview"></a>Встроенная Предварительная версия Azure Sentinel
...
После подключения источников данных выберите из коллекции информационных панелей, созданных экспертами, на основе данных. Эти панели мониторинга можно легко настроить в своих нуждах.
...
- Для использования Sentinel Azure требуются разрешения участника или читателя для группы ресурсов, к которой принадлежит Рабочая область.
...
1. Выберите рабочую область, которую вы хотите использовать, или создайте новую. Вы можете запускать метку Azure в нескольких рабочих областях, но данные изолированы по одной рабочей области.
   ...
   > - Sentinel Azure можно запускать в рабочих областях, развернутых в любом из следующих регионов: Восточная Австралия, Юго-Восточная Австралия, Центральная Канада, Центральная Индия, Восточная часть США 2 (EUAP) (ранний), Восточная Япония, Юго-Восточная Азия, южная часть Соединенного Королевства, Западная Европа, Западная часть США 2, Западная Центральная часть США, Центральная Канада, Центральная Корея, Северная Европа, восток США 2, Восточная Азия, Западная часть США, Центральная часть США, Юго-Центральный регион США.
...
В нижней части Azure Sentinel приводятся рекомендации по выбору панелей мониторинга, которые следует установить для каждого соединителя, чтобы вы могли немедленно получить интересующие вас данные. <br> Следуйте инструкциям по установке или см. Дополнительные сведения в [соответствующем руководстве по подключению](connect-data-sources.md) . Дополнительные сведения о соединителях данных см. в разделе [Подключение служб Майкрософт](connect-data-sources.md).
