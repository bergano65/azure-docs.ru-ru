...
Хотя мы рекомендуем использовать шаблоны [Azure Resource Manager (ARM)](/azure/azure-resource-manager/templates/) для конвейера CI/CD, модуль **AZ. секуритинсигхтс** полезен для задач, выполняемых после развертывания, и специально предназначен для автоматизации SoC.  Например, Автоматизация SOC может включать в себя действия по настройке соединителей данных, созданию правил аналитики или добавлению действий автоматизации в правила аналитики.
...
Azure Sentinel теперь поддерживает управляемые удостоверения для соединителя Azure Sentinel Logic Apps, что позволяет предоставлять разрешения непосредственно определенному сборник тренировочных заданий для работы в Azure Sentinel вместо создания дополнительных удостоверений.
