...
1. На портале Sentinel Azure щелкните Поиск **.**
  ![Azure Sentinel начинает поиск @ no__t-1
...
Поиск в Azure Sentinel основан на языке запросов Kusto. Дополнительные сведения о языке запросов и поддерживаемых операторах см. в разделе [Справочник по языку запросов](https://docs.loganalytics.io/docs/Language-Reference/).
...
Типичный запрос начинается с имени таблицы, за которым следует последовательность операторов, разделенных \|.
