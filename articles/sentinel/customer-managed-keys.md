...
1.  [Включите параметры восстановления.](../key-vault/general/best-practices.md#turn-on-recovery-options)
    ...
    -   Убедитесь, что [обратимое удаление](../key-vault/general/overview-soft-delete.md) включено.

    -   Включите [защиту от очистки](../key-vault/general/overview-soft-delete.md#purge-protection) , чтобы защититься от принудительного удаления секрета или хранилища даже после обратимого удаления.
