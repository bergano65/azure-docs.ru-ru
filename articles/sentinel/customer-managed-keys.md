...
1.  [Включите параметры восстановления:](../key-vault/key-vault-best-practices.md#turn-on-recovery-options)
    ...
    -   Убедитесь, что [Soft Delete](../key-vault/key-vault-ovw-soft-delete.md) включен.

    -   Включите [защиту очистки,](../key-vault/key-vault-ovw-soft-delete.md#purge-protection) чтобы защититься от принудительного удаления секрета/хранилища даже после мягкого удаления.
