...
Соединитель базы данных SQL Azure позволяет выполнять потоковую передачу журналов аудита и диагностики баз данных в метку, что позволяет постоянно отслеживать действия во всех экземплярах.

- Подключение журналов диагностики позволяет отправить журналы диагностики баз данных различных типов в рабочую область Sentinel.
