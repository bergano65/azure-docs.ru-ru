...
1. Включите **журналы диагностики** для всех брандмауэров, журналы которых вы хотите подключить:
    ...
    1. Щелкните ссылку [Открыть ресурс брандмауэра Azure >](https://ms.portal.azure.com/#blade/HubsExtension/BrowseResource/resourceType/Microsoft.Network%2FazureFirewalls) .
