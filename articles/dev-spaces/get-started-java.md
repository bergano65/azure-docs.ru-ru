---
title: Создание пространства разработки Kubernetes в облаке с помощью Java и VS Code | Документация Майкрософт
...
> [См. дополнительные сведения о коллективной разработке](team-development-java.md)
