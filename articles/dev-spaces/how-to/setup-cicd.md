...
1. Нажмите кнопку **Обзор** и выберите `samples/release.json` в проекте.
...
1. Убедитесь, что в поле **тип соединения** выбрано **Azure Resource Manager** . Вы увидите три элемента управления "раскрывающийся список", выделенные красным цветом: ![Release Definition Setup @ no__t-1
...
1. Наведите указатель мыши на поле " **произв** ." в разделе " **этапы** " и нажмите кнопку **развернуть**.
    @no__t 0Promote в рабочую среду @ no__t-1
