...
* По этой причине выполнение любого типа интеграционного тестирования становится затруднительным. Фактически интеграционное тестирование можно выполнить только после фиксации, что означает, что вы обнаружите проблемы позже в цикле разработки.
    ...
    ![Изображение, показывающее сложность тестирования интеграции, отображая связь между службой приложений и ее зависимостями.](media/common/microservices-challenges.png)
...
1. В раскрывающемся списке пространства выберите **\<Create New Space…\>** .
...
5. В раскрывающемся списке пространства выберите **\<Create New Space…\>** .

    ![Снимок экрана, отображающий выбор параметра "Добавление рабочей среды" в раскрывающемся списке "Пространство" на странице свойств проекта отладки обозревателя решений Visual Studio.](media/get-started-netcore-visualstudio/Settings.png)
...
6. В диалоговом окне **Добавление рабочей среды** в качестве родительского пространства укажите **dev** и введите имя нового пространства. Вы можете использовать свое имя (например, "scott") для нового пространства, чтобы люди, которые работают в одной среде с вами, могли идентифицировать ваше пространство. Нажмите кнопку **ОК**.
    ...
    ![Снимок экрана, отображающий диалоговое окно добавления нового пространства для коллективной разработки.](media/get-started-netcore-visualstudio/AddSpace.png)

7. Теперь вы должны увидеть свой кластер AKS и новое пространство, выбранное на странице свойств проекта.

    ![Снимок экрана, отображающий кластер AKS MyAKS и пространство scott на странице свойств проекта отладки в обозревателе решений Visual Studio.](media/get-started-netcore-visualstudio/Settings2.png)
...
![Схема, показывающая различия в именах путей и маршрутизации запросов через вновь созданное пространство dev/scott и используемое по умолчанию пространство разработки.](media/common/Space-Routing.png)
