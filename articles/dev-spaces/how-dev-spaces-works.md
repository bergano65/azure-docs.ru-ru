...
Чтобы приступить к подключению локального компьютера разработки к кластеру AKS, см. статью [Подключение компьютера разработки к кластеру AKS][connect].
