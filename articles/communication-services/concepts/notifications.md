...
Платформу APNs нужно настроить в режиме аутентификации по токену. Режим аутентификации по сертификату в настоящее время не поддерживается. 
