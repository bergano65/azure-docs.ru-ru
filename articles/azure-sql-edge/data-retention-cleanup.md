---
title: Управление историческими данными с помощью политики хранения. Azure SQL Server (Предварительная версия)
description: Узнайте, как управлять историческими данными с помощью политики хранения в Azure SQL ребро (Предварительная версия)
...
Операции очистки политики хранения данных можно отслеживать с помощью расширенных событий (XEvents) в Azure SQL (Предварительная версия). Дополнительные сведения о расширенных событиях см. в [обзоре XEvents](https://docs.microsoft.com/sql/relational-databases/extended-events/extended-events).
