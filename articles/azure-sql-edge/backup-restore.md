---
title: Резервное копирование и восстановление баз данных — Azure SQL Server (Предварительная версия)
description: Узнайте о возможностях резервного копирования и восстановления в Azure SQL (Предварительная версия).
keywords: ''
services: sql-edge
ms.service: sql-edge
ms.topic: conceptual
...
ms.locfileid: "84667868"
---
# <a name="back-up-and-restore-databases-in-azure-sql-edge-preview"></a>Резервное копирование и восстановление баз данных в Azure SQL (Предварительная версия) 

Azure SQL Server построен на основе последних версий Microsoft SQL Server ядро СУБД в Linux. Она предоставляет аналогичные возможности резервного копирования и восстановления базы данных, доступные в SQL Server на Linux и SQL Server, выполняемых в контейнерах. Компонент резервного копирования и восстановления обеспечивает необходимую защиту данных, хранящихся в пограничных базах данных SQL Azure. 
