...
11. На странице **Установка модулей на устройстве** нажмите кнопку **создать**.
...
Вы можете подключать и выполнять запросы SQL к экземпляру SQL Azure с помощью любого внешнего средства Linux, Windows или macOS, поддерживающего подключения SQL. Дополнительные сведения о подключении к контейнеру SQL для пограничных вычислений из внешней среды см. в [этой статье](./connect.md).
