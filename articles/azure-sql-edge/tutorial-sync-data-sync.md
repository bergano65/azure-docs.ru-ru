...
* Создайте базу данных SQL Azure. Сведения о создании Базы данных SQL Azure с помощью портала Azure см. в [этой статье](../azure-sql/database/single-database-create-quickstart.md?tabs=azure-portal).
