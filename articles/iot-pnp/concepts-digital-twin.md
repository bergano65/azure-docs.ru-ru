---
title: Знакомство с IoT Plug and Play Digital двойников
description: Сведения о том, как в предварительной версии IoT Plug and Play используется Digital двойников
author: prashmo
ms.author: prashmo
ms.date: 07/17/2020
ms.topic: conceptual
...
ms.locfileid: "87352416"
---
# <a name="understand-iot-plug-and-play-digital-twins"></a>Знакомство с IoT Plug and Play Digital двойников
...
В этой статье описывается, как компоненты и свойства представлены в *требуемых* и *сообщаемых* разделах двойникаа устройства. Здесь также описывается, как эти понятия сопоставляются с соответствующими цифровыми двойника.
...
В цифровом двойника есть унифицированное представление текущего и требуемого состояния свойства. Состояние синхронизации для данного свойства хранится в соответствующем разделе корневого уровня или компонента `$metadata` .
...
| `{componentName}` | Объект JSON, содержащий значения свойств и метаданные компонента, аналогичные корневому объекту. |
...
Предположим, что у устройства также есть следующее доступное для записи свойство на корневом уровне:
