...
## <a name="azure-iot-device-workbench-extension"></a>Расширение Workbench для устройства Azure IoT

Azure IoT Device Workbench — это расширение [Visual Studio Code](#visual-studio-code) , которое предоставляет интегрированную среду для:
...
Visual Studio Code — это современный редактор кода, доступный для нескольких платформ. Расширения, такие как [расширение Azure IOT Device Workbench](#azure-iot-device-workbench-extension) , позволяют настроить его для поддержки широкого спектра сценариев разработки.
