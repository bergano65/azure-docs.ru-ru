---
title: Взаимодействие с подключенным к решению устройством IoT Plug and Play (предварительная версия) с помощью Node.js | Документация Майкрософт
...
1. Это окно терминала теперь будет использоваться в качестве терминала _устройства_. Перейдите в папку клонированного репозитория, а затем в папку **/azure-iot-samples-node/digital-twins/Quickstarts/Device**. Установите все зависимости, выполнив следующую команду:
