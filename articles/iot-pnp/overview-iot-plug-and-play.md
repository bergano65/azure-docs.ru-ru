...
Во время действия общедоступной предварительной версии решение IoT Plug and Play IoT доступно во всех регионах.
...
- [Создание устройства IoT Plug and Play с помощью модели возможностей устройства](./quickstart-create-pnp-device-windows.md)
- [Подключение устройства к Центру Интернета вещей](./quickstart-connect-pnp-device-c-windows.md)
- [Подключение к устройству в решении](./quickstart-connect-pnp-device-solution-node.md)
