...
При вызове `t-123`устройства термостата Вы получаете все свойства всех интерфейсов, реализованных устройством, с помощью вызова REST API Get:

```REST
GET /digitalTwins/t-123/interfaces
```

Как правило, доступ ко всем свойствам всех интерфейсов осуществляется с помощью этого `{device-id}` REST API шаблона, где — это идентификатор устройства:
