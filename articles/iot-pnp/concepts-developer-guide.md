...
Если устройство термостата называется `t-123`, вы получаете все свойства, реализованные устройством, с помощью вызова REST API GET:

```REST
GET /digitalTwins/t-123/interfaces
```

Как правило, доступ ко всем свойствам осуществляется с помощью этого шаблона REST API, где `{device-id}` является идентификатором для устройства:
