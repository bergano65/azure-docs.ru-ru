---
title: Руководством для разработчиков устройств (Java) — Plug and Play IoT | Документация Майкрософт
description: Описание Plug and Play IoT для разработчиков устройств Java
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91580056"
---
# <a name="iot-plug-and-play-device-developer-guide-java"></a>Центр Интернета вещей Plug and Play для разработчиков устройств (Java)
