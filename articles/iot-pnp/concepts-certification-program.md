...
На портале сертификации приведены инструкции по подключению к экземпляру центра Интернета вещей, используемому для тестирования. Можно установить подключение DPS с помощью любого из [поддерживаемых методов аттестации](https://aka.ms/acdAttestation).
