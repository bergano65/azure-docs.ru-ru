...
description: Установите средство Azure IoT Explorer и используйте его для взаимодействия с устройствами Интернета вещей Plug and Play предварительной версии, подключенными к центру Интернета вещей.
author: rido-min
ms.author: rmpablos
ms.date: 05/06/2020
ms.topic: how-to
...
>[!Important]
>В версии 0.11.0 IoT Explorer поддерживает только предварительную версию Plug and Play Интернета вещей 2020. Чтобы использовать функции, доступные в предыдущем предварительном выпуске, начиная с августа 2019, необходимо установить версию 0,10. x.
...
:::image type="content" source="media/howto-use-iot-explorer/components-iot-explorer.png" alt-text="Просмотр компонентов в Azure IoT Explorer":::
