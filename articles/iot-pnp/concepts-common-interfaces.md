...
- Должен быть объявлен в модели возможностей. Если значение равно "Yes", этот интерфейс должен быть объявлен в `"implements":` разделе модели возможностей устройства для этого устройства IoT Plug and Play.
...
1. Введите **Plug and Play** , а затем выберите команду **IOT Plug and Play: открыть репозиторий модели** . Выберите **общедоступный репозиторий**. Общедоступный репозиторий моделей откроется в VS Code.
