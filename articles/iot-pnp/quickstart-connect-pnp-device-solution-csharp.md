---
title: Взаимодействие с подключенным к решению устройством IoT Plug and Play (предварительная версия) с помощью C# | Документация Майкрософт
