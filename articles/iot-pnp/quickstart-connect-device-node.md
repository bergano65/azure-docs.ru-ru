---
title: Краткое руководство. Подключение примера кода устройства Node.js IoT Plug and Play к Центру Интернета вещей | Документация Майкрософт
description: Краткое руководство. Создание и запуск примера кода устройства IoT Plug and Play, который подключается к центру Интернета вещей, с помощью Node.js. С помощью обозревателя Интернета вещей Azure просматривайте сведения, отправленные устройством в центр.
author: ericmitt
ms.author: ericmitt
ms.date: 07/10/2020
ms.topic: quickstart
