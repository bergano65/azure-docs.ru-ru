...
1. Проверяйте модели устройств локально с помощью [сценариев для проверки изменений](#validate-files) .
...
Запрос на вытягивание активирует ряд действий GitHub, которые будут проверять новые отправленные интерфейсы, и убедитесь, что запрос на вытягивание удовлетворяет всем проверкам.
...
Вы можете запустить [образец проверки дтдл](https://github.com/Azure-Samples/DTDL-Validator) для локальной проверки моделей устройств.
