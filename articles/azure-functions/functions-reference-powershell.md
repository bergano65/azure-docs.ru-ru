...
> [!NOTE]
> Управляемые зависимости полагаются на доступ к www.powershellgallery.com для скачивания модулей. Необходимо убедиться, что у среды выполнения функции есть доступ к этому URL-адресу, добавив необходимые правила брандмауэра.
