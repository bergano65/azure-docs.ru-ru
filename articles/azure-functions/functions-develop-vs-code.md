...
| **Выберите параметр из "Local. Settings. JSON"** | `MyStorageConnection` | Имя параметра приложения, содержащего строку подключения для учетной записи хранения. Параметр `AzureWebJobsStorage` содержит строку подключения для учетной записи хранения, созданной с помощью приложения функции. |
...
|Команда "функции Azure"  | Description  |
|---------|---------|
