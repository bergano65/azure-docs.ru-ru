...
Дополнительные сведения см. в документации по [выходной привязке хранилища очередей](functions-bindings-storage-queue.md#output) .
...
Дополнительные сведения см. в справочнике по [выходной привязке хранилища очередей](functions-bindings-storage-queue.md#output) .
