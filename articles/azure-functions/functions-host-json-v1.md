...
> [!NOTE]
> Эта статья предназначена для службы "Функции Azure" версии 1.x.  Для справки о host.json в функциях 2.x и более поздних см. [ссылку host.json для Azure Functions 2.x](functions-host-json.md).
...
Настройки конфигурации для [триггера и привязок Azure Cosmos DB.](functions-bindings-cosmosdb.md)
...
Параметры конфигурации для [триггеров и привязок концентратора событий](functions-bindings-event-hubs-trigger.md#functions-1x).
...
Указывает время ожидания для всех функций. В бессерверных планах потребления допускается диапазон от 1 секунды до 10 минут, а значение по умолчанию — 5 минут. В плане службы приложений нет общего лимита, а значение по умолчанию _является нулевым,_ что указывает на отсутствие тайм-аута.
...
Настройка конфигурации для [связывания вывода SendGrind](functions-bindings-sendgrid.md)
