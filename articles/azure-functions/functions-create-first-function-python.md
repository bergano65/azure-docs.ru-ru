...
ms.locfileid: "73622032"
---
# <a name="create-an-http-triggered-python-function-in-azure"></a>Создание функции Python, активируемой HTTP, в Azure
...
+ Установите [Python 3.6.8](https://www.python.org/downloads/). Эта версия Python проверяется с помощью функций. Версия 3.7 и более поздние пока не поддерживаются.
