---
title: Azure выражения функции привязки и шаблоны
description: Узнайте, как создать различные выражения привязки функций Azure, исходя из распространенных шаблонов.
services: functions
...
ms.locfileid: "56887188"
---
# <a name="azure-functions-binding-expression-patterns"></a>Шаблоны выражений привязки в функциях Azure

Одной из наиболее мощных функций [триггеров и привязок](./functions-triggers-bindings.md) — *выражения привязки*. В файле *function.json* и в параметрах функции и коде можно использовать выражения, которые разрешаются в значения из различных источников.
