...
Интеграция виртуальной сети позволяет приложению-функции получить доступ к ресурсам в виртуальной сети. Функции Azure поддерживают две разновидности интеграции виртуальной сети:
