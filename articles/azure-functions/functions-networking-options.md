...
При создании приложения-функции необходимо создать или связать с учетной записью хранения Azure общего назначения, которая поддерживает хранилище BLOB-объектов, очередей и таблиц. Сейчас вы не можете использовать ограничения виртуальной сети для этой учетной записи. Если вы настроили конечную точку службы виртуальной сети в учетной записи хранения, которую вы используете для приложения-функции, это приведет к нарушению работы приложения. В настоящее время эта функция доступна с помощью плана Premium и интеграции виртуальной сети.
