...
![Переключатель виртуальной сети](media/functions-networking-options/virtual-network-trigger-toggle.png)
...
При интеграции приложения-функции в план Premium или план службы приложений с виртуальной сетью приложение по умолчанию может выполнять исходящие вызовы через Интернет. Добавив параметр `WEBSITE_VNET_ROUTE_ALL=1`приложения, вы принудительно передаете весь исходящий трафик в виртуальную сеть, где можно использовать правила группы безопасности сети для ограничения трафика.
