...
* Доступ к частному сайту доступен в [плане службы приложений](functions-scale.md#app-service-plan) уровня " [премиум](./functions-premium-plan.md) " и "при настройке **конечных точек службы** ". Дополнительные сведения см. в разделе [конечные точки службы виртуальной сети](../virtual-network/virtual-network-service-endpoints-overview.md) .
