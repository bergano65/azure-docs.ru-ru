...
* Отправьте запрос HTTP POST в `https://{functionappname}.azurewebsites.net/admin/host/synctriggers?code=<API_KEY>` с помощью [главного ключа](functions-bindings-http-webhook.md#authorization-keys).
