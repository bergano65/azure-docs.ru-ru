...
| Технология развертывания | Использование Windows | Windows Premium (Предварительная версия) | Выделенные Windows  | Использование Linux | Выделенные Linux |
|-----------------------|:-------------------:|:-------------------------:|:-----------------:|:---------------------------:|:---------------:|
...
| | Использование Windows | Windows Premium (Предварительная версия) | Выделенные Windows | Использование Linux | Linux Premium (Предварительная версия)| Выделенные Linux |
|-|:-----------------: |:-------------------------:|:-----------------:|:---------------------------:|:---------------:|:---------------:|
| C# | | | | | |
