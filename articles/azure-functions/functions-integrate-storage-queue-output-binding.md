...
1. В разделе **Параметры приложения** выберите **AzureWebJobsStorage**.
    ...
    :::image type="content" source="./media/functions-integrate-storage-queue-output-binding/function-find-storage-account.png" alt-text="Найдите учетную запись хранения, подключенную к AzureWebJobsStorage." border="true":::
