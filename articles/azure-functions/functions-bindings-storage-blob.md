...
Чтобы выполнить принудительную повторную обработку большого двоичного объекта, удалите уведомление о получении этого большого двоичного объекта из контейнера *azure-webjobs-hosts* вручную. Повторная обработка может происходить не сразу, но это гарантированной выполнить последующий момент времени.
