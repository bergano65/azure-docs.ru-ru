...
1. Затем используйте настройки, указанные в таблице под изображением.
    ...
    |---|---|---|
    | **Название** | Уникальное для вашего приложения-функции | Имя функции, активируемой большим двоичным объектом. |
...
1. Разверните подключенные учетную запись хранения, щелкните правой кнопкой мыши **Контейнеры BLOB-объектов**, а затем щелкните **Создать контейнер BLOB-объектов**, введите `samples-workitems` и нажмите клавишу ВВОД.
...
1. В обозревателе службы хранилища разверните свою учетную запись хранения, **Контейнеры BLOB-объектов** и **samples-workitems**. Щелкните **Отправка**, а затем **Отправка файлов**.
