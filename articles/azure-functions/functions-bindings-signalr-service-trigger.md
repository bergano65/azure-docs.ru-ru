...
|Error| Доступно для события *disconnected* . Оно может быть пустым, если соединение закрыто без ошибок или содержит сообщения об ошибках.|
