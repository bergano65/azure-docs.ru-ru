...
> [!NOTE]  
> Функция тестирования, интегрированная с порталом, `Disabled` игнорирует параметр. Это означает, что отключенная функция по-прежнему запускается при запуске из окна **тестов** на портале. 
