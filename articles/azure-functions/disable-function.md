...
> [!NOTE]  
> Функциональность интегрированного в портале `Disabled` тестирования игнорирует настройки. Это означает, что функция отключения по-прежнему выполняется при запуске из окна **теста** на портале. 
