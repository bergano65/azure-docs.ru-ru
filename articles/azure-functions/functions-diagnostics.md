...
Вы можете задать вопросы или отправить отзыв о диагностике функций Azure в [UserVoice](https://feedback.azure.com/forums/355860-azure-functions). Добавьте `[Diag]` в заголовок своего отзыва.
