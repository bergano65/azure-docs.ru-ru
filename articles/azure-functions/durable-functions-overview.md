...
> [Bindings for Durable Functions (Azure Functions)](durable-functions-types-features-overview.md) (Привязки устойчивых функций (Функции Azure))
