...
В коде * _ \_ init_ \_ . Корректировка* объявляется параметр `func.ServiceBusMessage` , который позволяет считывать сообщение очереди в функции.
