...
Функции Azure, запущенные в планах службы приложений, выполняются в той же службе, что и веб-приложения, а значит все рекомендации по веб-приложениям будет применимы и к выделенной функции.
