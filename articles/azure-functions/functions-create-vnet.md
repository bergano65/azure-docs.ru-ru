...
1. В окне **Создание виртуальной сети**используйте параметры, приведенные в таблице под изображением.
    ...
    | Параметр      | Рекомендуемое значение  | Description      |
    | ------------ | ---------------- | ---------------- |
    | **Название** | myResourceGroup — виртуальная сеть | Вы можете использовать имя по умолчанию, созданное для виртуальной сети. |
...
1. В приложении-функции выберите **прокси-серверы** >  **+** , а затем используйте параметры прокси-сервера в таблице под изображением.
    ...
    | Параметр  | Рекомендуемое значение  | Description      |
    | -------- | ---------------- | ---------------- |
    | **Название** | РасТениЕ | Имя может иметь любое значение. Он используется для обнаружения учетной записи-посредника. |
