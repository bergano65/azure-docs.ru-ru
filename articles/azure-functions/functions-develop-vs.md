...
Visual Studio позволяет разрабатывать, тестировать и развертывать функции библиотеки классов C# в Azure. Если вы впервые сталкиваетесь с функциями Azure, дополнительные сведения см. в статье [Общие сведения о Функциях Azure](functions-overview.md).
...
1. В меню **Сервис** выберите пункт **Расширения и обновления**. Разверните узел **установленные** > **инструменты** и выберите средства службы " **функции и веб-задания Azure**".
...
Эти значения параметров приложения-функции также могут считываться в коде как переменные среды. Дополнительную информацию см. в разделе [Переменные среды](functions-dotnet-class-library.md#environment-variables).
...
1. В Visual Studio откройте **Cloud Explorer**, разверните **учетную запись** > хранения**ваша учетная запись хранения**, а затем на вкладке **Свойства** скопируйте **основное значение строки подключения** .
...
* [Использование портал Azure](functions-how-to-use-azure-function-app-settings.md#settings).
