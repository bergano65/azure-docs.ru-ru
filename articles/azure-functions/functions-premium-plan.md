...
Функции Azure, развернутых в план уровня "премиум" использует преимущества [Новая интеграция виртуальной сети для веб-приложений](../app-service/web-sites-integrate-with-vnet.md).  При настройке приложения можно взаимодействовать с ресурсами в виртуальной сети или защищено с помощью конечных точек службы.  Ограничения IP-адресов, также доступны в приложение, чтобы ограничить входящий трафик.
