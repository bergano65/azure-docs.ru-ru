...
ms.locfileid: "76715035"
---
# <a name="microsoft-graph-bindings-for-azure-functions"></a>Привязки Microsoft Graph для службы "Функции Azure"

В этой статье объясняется, как настраивать и использовать триггеры и привязки Microsoft Graph в решении "Функции Azure". Они помогут вам использовать решение "Функции Azure" для работы с данными, аналитической информацией и событиями в [Microsoft Graph](https://developer.microsoft.com/graph).
...
> [!Note]
> Привязки Microsoft Graph в настоящее время находятся в предварительном просмотре для версии 2.x Azure И.И. Они не поддерживаются в Функциях версии 1.x.
...
> [!Note] 
> Процесс установки в портале может занять до 10 минут по плану потребления.
...
* [Использования](#auth-token---usage)
...
В следующей таблице объясняется свойства связывающей конфигурации, `Token` установленные в файле *function.json* и атрибуте.

|свойство function.json | Свойство атрибута |Описание|
|---------|---------|----------------------|
|**name**| Недоступно |Обязательное. Имя переменной, используемое в коде функции для токена аутентификации. Дополнительные сведения см. в разделе [Использование входной привязки токена аутентификации в коде](#token-input-code).|
|**тип**| Недоступно |Обязательное. Необходимо задать значение `token`.|
|**direction**| Недоступно |Обязательное. Необходимо задать значение `in`.|
|**Идентичности**|**идентификации**|Обязательное. Удостоверение, которое будет использоваться для выполнения действия. Может использоваться одно из следующих значений:<ul><li><code>userFromRequest</code> — применяется только с [триггером HTTP]. Позволяет использовать удостоверение вызывающего пользователя.</li><li><code>userFromId</code> — позволяет использовать удостоверение пользователя, ранее вошедшего в систему, с указанным идентификатором. См. описание свойства <code>userId</code>.</li><li><code>userFromToken</code> — позволяет использовать удостоверение, представленное указанным токеном. См. описание свойства <code>userToken</code>.</li><li><code>clientCredentials</code> — позволяет использовать удостоверение приложения-функции.</li></ul>|
...
|**Ресурсов**|**Ресурсов**|Обязательное. URL-адрес ресурса Azure AD, для которого запрашивается маркер.|
...
* [Использования](#excel-input---usage)
...
В следующей таблице объясняется свойства связывающей конфигурации, `Excel` установленные в файле *function.json* и атрибуте.

|свойство function.json | Свойство атрибута |Описание|
|---------|---------|----------------------|
|**name**| Недоступно |Обязательное. Имя переменной, используемое в коде функции для таблицы Excel. Дополнительные сведения см. в разделе [Использование входной привязки таблицы Excel в коде](#excel-input-code).|
|**тип**| Недоступно |Обязательное. Необходимо задать значение `excel`.|
|**direction**| Недоступно |Обязательное. Необходимо задать значение `in`.|
|**Идентичности**|**идентификации**|Обязательное. Удостоверение, которое будет использоваться для выполнения действия. Может использоваться одно из следующих значений:<ul><li><code>userFromRequest</code> — применяется только с [триггером HTTP]. Позволяет использовать удостоверение вызывающего пользователя.</li><li><code>userFromId</code> — позволяет использовать удостоверение пользователя, ранее вошедшего в систему, с указанным идентификатором. См. описание свойства <code>userId</code>.</li><li><code>userFromToken</code> — позволяет использовать удостоверение, представленное указанным токеном. См. описание свойства <code>userToken</code>.</li><li><code>clientCredentials</code> — позволяет использовать удостоверение приложения-функции.</li></ul>|
|**Userid**|**Userid**  |Требуется, только если для свойства _identity_ задано значение `userFromId`. Идентификатор субъекта-пользователя, связанный с пользователем, ранее вошедшим в систему.|
|**userToken**|**UserToken**|Требуется, только если для свойства _identity_ задано значение `userFromToken`. Токен, предназначенный для приложения-функции. |
|**Путь**|**Путь**|Обязательное. Путь к книге Excel в OneDrive.|
|**worksheetName**|**ЛистЛистИмя**|Лист, на котором находится таблица.|
|**Tablename**|**Tablename**|Имя таблицы. Если это свойство не указано, будет использоваться содержимое листа.|
...
* [Использования](#excel-output---usage)
...
|свойство function.json | Свойство атрибута |Описание|
|---------|---------|----------------------|
|**name**| Недоступно |Обязательное. Имя переменной, используемое в коде функции для токена аутентификации. Дополнительные сведения см. в разделе [Использование выходной привязки таблицы Excel в коде](#excel-output-code).|
|**тип**| Недоступно |Обязательное. Необходимо задать значение `excel`.|
|**direction**| Недоступно |Обязательное. Необходимо задать значение `out`.|
|**Идентичности**|**идентификации**|Обязательное. Удостоверение, которое будет использоваться для выполнения действия. Может использоваться одно из следующих значений:<ul><li><code>userFromRequest</code> — применяется только с [триггером HTTP]. Позволяет использовать удостоверение вызывающего пользователя.</li><li><code>userFromId</code> — позволяет использовать удостоверение пользователя, ранее вошедшего в систему, с указанным идентификатором. См. описание свойства <code>userId</code>.</li><li><code>userFromToken</code> — позволяет использовать удостоверение, представленное указанным токеном. См. описание свойства <code>userToken</code>.</li><li><code>clientCredentials</code> — позволяет использовать удостоверение приложения-функции.</li></ul>|
|**Userid** |**Userid** |Требуется, только если для свойства _identity_ задано значение `userFromId`. Идентификатор субъекта-пользователя, связанный с пользователем, ранее вошедшим в систему.|
|**userToken**|**UserToken**|Требуется, только если для свойства _identity_ задано значение `userFromToken`. Токен, предназначенный для приложения-функции. |
|**Путь**|**Путь**|Обязательное. Путь к книге Excel в OneDrive.|
|**worksheetName**|**ЛистЛистИмя**|Лист, на котором находится таблица.|
|**Tablename**|**Tablename**|Имя таблицы. Если это свойство не указано, будет использоваться содержимое листа.|
|**updateType**|**ОбновлениеТип**|Обязательное. Тип изменения, которое требуется внести в таблицу. Может использоваться одно из следующих значений:<ul><li><code>update</code> — замена содержимого таблицы в OneDrive.</li><li><code>append</code> — добавление полезных данных в конец таблицы в OneDrive путем создания новых строк.</li></ul>|
...
* [Использования](#file-input---usage)
...
В следующей таблице объясняется свойства связывающей конфигурации, `OneDrive` установленные в файле *function.json* и атрибуте.

|свойство function.json | Свойство атрибута |Описание|
|---------|---------|----------------------|
|**name**| Недоступно |Обязательное. Имя переменной, используемое в коде функции для файла. Дополнительные сведения см. в разделе [Использование входной привязки файлов OneDrive в коде](#onedrive-input-code).|
|**тип**| Недоступно |Обязательное. Необходимо задать значение `onedrive`.|
|**direction**| Недоступно |Обязательное. Необходимо задать значение `in`.|
|**Идентичности**|**идентификации**|Обязательное. Удостоверение, которое будет использоваться для выполнения действия. Может использоваться одно из следующих значений:<ul><li><code>userFromRequest</code> — применяется только с [триггером HTTP]. Позволяет использовать удостоверение вызывающего пользователя.</li><li><code>userFromId</code> — позволяет использовать удостоверение пользователя, ранее вошедшего в систему, с указанным идентификатором. См. описание свойства <code>userId</code>.</li><li><code>userFromToken</code> — позволяет использовать удостоверение, представленное указанным токеном. См. описание свойства <code>userToken</code>.</li><li><code>clientCredentials</code> — позволяет использовать удостоверение приложения-функции.</li></ul>|
|**Userid**|**Userid**  |Требуется, только если для свойства _identity_ задано значение `userFromId`. Идентификатор субъекта-пользователя, связанный с пользователем, ранее вошедшим в систему.|
|**userToken**|**UserToken**|Требуется, только если для свойства _identity_ задано значение `userFromToken`. Токен, предназначенный для приложения-функции. |
|**Путь**|**Путь**|Обязательное. Путь к файлу в OneDrive.|
...
* [Использования](#file-output---usage)
...
|свойство function.json | Свойство атрибута |Описание|
|---------|---------|----------------------|
|**name**| Недоступно |Обязательное. Имя переменной, используемое в коде функции для файла. Дополнительные сведения см. в разделе [Использование выходной привязки файла OneDrive в коде](#onedrive-output-code).|
|**тип**| Недоступно |Обязательное. Необходимо задать значение `onedrive`.|
|**direction**| Недоступно |Обязательное. Необходимо задать значение `out`.|
|**Идентичности**|**идентификации**|Обязательное. Удостоверение, которое будет использоваться для выполнения действия. Может использоваться одно из следующих значений:<ul><li><code>userFromRequest</code> — применяется только с [триггером HTTP]. Позволяет использовать удостоверение вызывающего пользователя.</li><li><code>userFromId</code> — позволяет использовать удостоверение пользователя, ранее вошедшего в систему, с указанным идентификатором. См. описание свойства <code>userId</code>.</li><li><code>userFromToken</code> — позволяет использовать удостоверение, представленное указанным токеном. См. описание свойства <code>userToken</code>.</li><li><code>clientCredentials</code> — позволяет использовать удостоверение приложения-функции.</li></ul>|
|**Userid** |**Userid** |Требуется, только если для свойства _identity_ задано значение `userFromId`. Идентификатор субъекта-пользователя, связанный с пользователем, ранее вошедшим в систему.|
...
* [Использования](#outlook-output---usage)
...
В следующей таблице объясняется свойства связывающей конфигурации, `Outlook` установленные в файле *function.json* и атрибуте.

|свойство function.json | Свойство атрибута |Описание|
|---------|---------|----------------------|
|**name**| Недоступно |Обязательное. Имя переменной, используемое в коде функции для сообщения электронной почты. Дополнительные сведения см. в разделе [Использование выходной привязки сообщений Outlook в коде](#outlook-output-code).|
|**тип**| Недоступно |Обязательное. Необходимо задать значение `outlook`.|
|**direction**| Недоступно |Обязательное. Необходимо задать значение `out`.|
|**Идентичности**|**идентификации**|Обязательное. Удостоверение, которое будет использоваться для выполнения действия. Может использоваться одно из следующих значений:<ul><li><code>userFromRequest</code> — применяется только с [триггером HTTP]. Позволяет использовать удостоверение вызывающего пользователя.</li><li><code>userFromId</code> — позволяет использовать удостоверение пользователя, ранее вошедшего в систему, с указанным идентификатором. См. описание свойства <code>userId</code>.</li><li><code>userFromToken</code> — позволяет использовать удостоверение, представленное указанным токеном. См. описание свойства <code>userToken</code>.</li><li><code>clientCredentials</code> — позволяет использовать удостоверение приложения-функции.</li></ul>|
|**Userid**|**Userid**  |Требуется, только если для свойства _identity_ задано значение `userFromId`. Идентификатор субъекта-пользователя, связанный с пользователем, ранее вошедшим в систему.|
|**userToken**|**UserToken**|Требуется, только если для свойства _identity_ задано значение `userFromToken`. Токен, предназначенный для приложения-функции. |
...
* [Использования](#webhook-trigger---usage)
...
В [библиотеках класса C'](functions-dotnet-class-library.md)используйте атрибут [GraphWebhookTrigger.](https://github.com/Azure/azure-functions-microsoftgraph-extension/blob/master/src/MicrosoftGraphBinding/Bindings/GraphWebhookTriggerAttribute.cs)

### <a name="webhook-trigger---configuration"></a>Конфигурация триггера веб-перехватчика

В следующей таблице объясняется свойства связывающей конфигурации, `GraphWebhookTrigger` установленные в файле *function.json* и атрибуте.

|свойство function.json | Свойство атрибута |Описание|
|---------|---------|----------------------|
|**name**| Недоступно |Обязательное. Имя переменной, используемое в коде функции для сообщения электронной почты. Дополнительные сведения см. в разделе [Использование выходной привязки сообщений Outlook в коде](#outlook-output-code).|
|**тип**| Недоступно |Обязательное. Необходимо задать значение `graphWebhook`.|
|**direction**| Недоступно |Обязательное. Необходимо задать значение `trigger`.|
|**ресурсType**|**ResourceType**|Обязательное. Ресурс Graph, для которого эта функция должна отвечать на вызовы веб-перехватчиков. Может использоваться одно из следующих значений:<ul><li><code>#Microsoft.Graph.Message</code> — изменения, которые вносятся в сообщения Outlook.</li><li><code>#Microsoft.Graph.DriveItem</code> — изменения, которые вносятся в корневые элементы OneDrive.</li><li><code>#Microsoft.Graph.Contact</code> —изменения, которые вносятся в личные контакты в Outlook.</li><li><code>#Microsoft.Graph.Event</code> — изменения, которые вносятся в элементы календаря Outlook.</li></ul>|
...
* [Использования](#webhook-input---usage)
...
В [библиотеках класса C'](functions-dotnet-class-library.md)используйте атрибут [GraphWebhookSubscription.](https://github.com/Azure/azure-functions-microsoftgraph-extension/blob/master/src/MicrosoftGraphBinding/Bindings/GraphWebhookSubscriptionAttribute.cs)

### <a name="webhook-input---configuration"></a>Конфигурация входной привязки веб-перехватчика

В следующей таблице объясняется свойства связывающей конфигурации, `GraphWebhookSubscription` установленные в файле *function.json* и атрибуте.

|свойство function.json | Свойство атрибута |Описание|
|---------|---------|----------------------|
|**name**| Недоступно |Обязательное. Имя переменной, используемое в коде функции для сообщения электронной почты. Дополнительные сведения см. в разделе [Использование выходной привязки сообщений Outlook в коде](#outlook-output-code).|
|**тип**| Недоступно |Обязательное. Необходимо задать значение `graphWebhookSubscription`.|
|**direction**| Недоступно |Обязательное. Необходимо задать значение `in`.|
|**Фильтр**|**Фильтр**| Если задано значение `userFromRequest`, привязка будет получать только подписки, принадлежащие вызывающему пользователю (применяется только с [триггером HTTP]).| 
...
* [Использования](#webhook-output---usage)
...
|**Userid**|**Userid**  |Требуется, только если для свойства _identity_ задано значение `userFromId`. Идентификатор субъекта-пользователя, связанный с пользователем, ранее вошедшим в систему.|
|**userToken**|**UserToken**|Требуется, только если для свойства _identity_ задано значение `userFromToken`. Токен, предназначенный для приложения-функции. |
|**Действий**|**Действие**|Обязательное. Указывает действие, которое необходимо выполнить с помощью привязки. Может использоваться одно из следующих значений:<ul><li><code>create</code> — регистрация новой подписки.</li><li><code>delete</code> — удаление указанной подписки.</li><li><code>refresh</code> — обновление указанной подписки. Позволяет предотвратить истечение срока действия.</li></ul>|
|**subscriptionResource**|**ПодпискаРесурс**|Требуется, только если для свойства _action_ задано значение `create`. Указывает ресурс Microsoft Graph, изменения которого будут отслеживаться. Дополнительные сведения см. в статье [Работа с веб-перехватчиками в Microsoft Graph]. |
...
- Использование удостоверения приложения для всех подписок. Для этого потребуется согласие от админ-аминazрейте Active Directory. Это может быть использовано всеми языками, поддерживаемыми функциями Azure.
