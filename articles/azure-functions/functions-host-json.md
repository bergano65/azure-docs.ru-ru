...
В следующем примере файла *Host. JSON* указаны все возможные параметры (за исключением всех, которые предназначены только для внутреннего использования).
