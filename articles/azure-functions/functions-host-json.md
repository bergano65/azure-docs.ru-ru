...
|Свойство | По умолчанию | Описание |
| --------- | --------- | --------- |
| дефаултексекутаблепас | Недоступно | Исполняемый файл, запускаемый в качестве процесса настраиваемого обработчика. Это обязательный параметр при использовании пользовательских обработчиков и его значение относительно корня приложения-функции. |
...
| аргументы | Недоступно | Массив аргументов командной строки для передачи в процесс пользовательского обработчика. |
