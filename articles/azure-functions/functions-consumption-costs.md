...
```
В этом конкретном ответе показано, что от `2019-09-11T21:46` до `2019-09-11T23:18`приложение заняло 1110000000 МБ-миллисекунд (1083,98 ГБ/с).
...
| timestamp \[\] времени в формате UTC          | name          | value       |
|----------------------------|---------------|-------------|
