...
| ---- | ----------- |
| [**Потребление**](functions-scale.md#consumption-plan) | Плата насчитывается только за время запуска приложения функции. Этот план включает [бесплатную страницу предоставления][цен] на каждую подписку.|
