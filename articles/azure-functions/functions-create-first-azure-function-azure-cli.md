...
+ Для Python 3.6 и 3.7 требуется [Azure Functions Core Tools](./functions-run-local.md#v2) 2.7.1846 или версии, более поздней, чем 2.x. Для Python 3.8 требуется Core Tools [версии 3.x](./functions-run-local.md#v2).
::: zone-end
