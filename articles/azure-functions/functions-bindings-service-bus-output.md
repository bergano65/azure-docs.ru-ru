...
* Чтобы получить доступ к ИДЕНТИФИКАТОРу сеанса, выполните привязку к [`Message`](https://docs.microsoft.com/dotnet/api/microsoft.azure.servicebus.message) типу и используйте `sessionId` свойство.
...
| Привязка | Справка |
|---|---|
| Cлужебная шина | [Коды ошибок службы "Служебная шина"](https://docs.microsoft.com/azure/service-bus-messaging/service-bus-messaging-exceptions) |
| Cлужебная шина | [Ограничения службы "Служебная шина"](https://docs.microsoft.com/azure/service-bus-messaging/service-bus-quotas) |
