...
В среде выполнения Функции Azure версии 2.x используются расширения привязки. Они предназначены для реализации кода триггеров и привязок. Расширения привязки входят в состав пакетов NuGet. Чтобы зарегистрировать расширение, необходимо установить пакет. Способ установки расширений привязки при разработке функций зависит от среды разработки. Дополнительные сведения см. в разделе [Регистрация расширений привязки](functions-triggers-bindings.md#register-binding-extensions) статьи о триггерах и привязках.
