...
1. Используйте настройки триггера HTTP, как указано в таблице.
    ...
    | Уровень авторизации | Anonymous | Дополнительно Предоставляет доступ к функции без ключа API |
...
1. Используйте настройки прокси-сервера, как указано в таблице. 
    ...
    | Поле | Образец значения | Описание |
    |---|---|---|
    | Название | HelloProxy | Понятное имя, используемое только для управления |
