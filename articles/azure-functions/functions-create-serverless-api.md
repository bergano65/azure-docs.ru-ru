...
Повторите шаги для [создания приложения-функции](./functions-get-started.md), чтобы создать приложение-функцию, в котором вы создадите свой прокси-сервер. Этот URL-адрес нового приложения выступает в качестве внешнего интерфейса для нашего API, а приложение-функция, которое вы ранее редактировали, выступает в качестве серверной части.
