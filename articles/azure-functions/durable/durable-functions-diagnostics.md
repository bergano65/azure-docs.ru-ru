...
Уровень детализации данных отслеживания, порожденных в Application Insights, можно настроить в `logger` разделе (функции 1. x) `logging` или (функции 2,0) `host.json` файла.
