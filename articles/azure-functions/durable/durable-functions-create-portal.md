...
> [!NOTE]
> 
> * Если вы разрабатываете прочные функции в СЗ, вы должны вместо этого рассмотреть [Visual Studio 2019 развития](durable-functions-create-first-csharp.md).
...
Для выполнения любых функций вам понадобится приложение-функция, Функциональное приложение позволяет группировать функции как логическую единицу для облегчения управления, развертывания, масштабирования и совместного использования ресурсов. Вы можете создать приложение .NET или JavaScript.
...
Если вы создаете долговременные функции JavaScript, необходимо установить [ `durable-functions` пакет npm.](https://www.npmjs.com/package/durable-functions)
...
1. Расширьте приложение функции **+** и нажмите кнопку рядом с **функциями.** Если это первая функция в приложении-функции, последовательно выберите **На портале** и **Продолжить**. Если нет, перейдите к шагу 3.
...
1. При запросе выберите **установку** для установки расширения Azure DurableTask и любых зависимостей в приложении функции. Установить расширение для приложения-функции необходимо всего один раз. По завершении установки щелкните **Продолжить**.
