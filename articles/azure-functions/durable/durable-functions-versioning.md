...
* Разверните новую копию приложения-функции с той же учетной записью хранения, но с `taskHub` обновленным именем. Рекомендуется использовать параллельные развертывания.
