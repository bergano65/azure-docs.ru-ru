...
* **Python.** Требуется расширение Устойчивых функций 1.8.5 или более поздней версии. Поддержка расширения "Устойчивые функции" в настоящее время предоставляется в общедоступной предварительной версии.
