...
Чтобы проверить квоту в [портал Azure](https://portal.azure.com), выберите **функции платформы** > **Параметры приложение-функция** в приложении функции. Если вы используете заданную **квоту ежедневного использования** , отображается следующее сообщение:
