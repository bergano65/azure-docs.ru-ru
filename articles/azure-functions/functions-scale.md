...
|-|:----------------:|:------------:|:----------------:|
| Windows | Общая доступность | предварительная версия | Общая доступность |
| Linux | Общая доступность | предварительная версия | Общая доступность |
