...
Выполнение в [Среда службы приложений](../app-service/environment/intro.md) (ASE) позволяет полностью изолировать функции и воспользоваться преимуществами высокого масштаба.
