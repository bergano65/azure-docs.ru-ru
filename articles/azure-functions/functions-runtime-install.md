...
1. Перейдите к **портал среды выполнения функций Azure** как `https://<machinename>.<domain>` например `https://mycomputer.mydomain.com`.
...
1. Для создания приложений-функций необходимо создать подписку.  В левом верхнем углу портала, щелкните **+** параметр напротив подписок.
