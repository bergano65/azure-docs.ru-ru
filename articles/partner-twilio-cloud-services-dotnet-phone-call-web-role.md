...
1. Получите учетную запись Twilio и маркер проверки подлинности из [консоли Twilio][twilio_console]. Чтобы приступить к работе с Twilio, зарегистрируйтесь на странице [https://www.twilio.com/try-twilio][try_twilio]. Вы можете ознакомиться с расценками на сайте [https://www.twilio.com/pricing][twilio_pricing]. Дополнительные сведения о предоставляемых службой Twilio интерфейсах API см. на странице [https://www.twilio.com/voice/api][twilio_api].
...
Подробные сведения о TwiML см. на странице [https://www.twilio.com/docs/api/twiml][twiml]. Дополнительные сведения о команде &lt;Say&gt; и других командах Twilio см. на странице [https://www.twilio.com/docs/api/twiml/say][twilio_say].
