...
|Шифрование HTTPS, SSL и TLS|Все подключения к Azure Cosmos DB поддерживают протокол HTTPS. Azure Cosmos DB также поддерживает TLS 1,2.<br>Можно применить минимальную версию протокола TLS на стороне сервера. Для этого обратитесь в [azurecosmosdbtls@service.microsoft.com](mailto:azurecosmosdbtls@service.microsoft.com).|
