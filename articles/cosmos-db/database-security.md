...
|Шифрование HTTPS, SSL и TLS|Все взаимодействия между клиентом и службой в Azure Cosmos DB осуществляются по протоколу SSL/TLS 1.2. Кроме того, все репликации в центре обработки данных и между центрами обработки данных являются SSL/TLS 1,2.|
...
|Сертификаты безопасности и защиты данных| Самый актуальный список сертификатов см. на общем [сайте соответствия требованиям Azure](https://www.microsoft.com/en-us/trustcenter/compliance/complianceofferings) , а также в последнем [документе соответствия требованиям Azure](https://gallery.technet.microsoft.com/Overview-of-Azure-c1be3942) со всеми сертификатами (выполните поиск по запросу Cosmos). Для получения более подробного внимания ознакомьтесь с 25 апреля 2018 Post [Azure #CosmosDB: Безопасность, частный, соответствующий требованиям, включающий SoC 1/2 типа 2, HITRUST, PCI DSS уровень 1, ISO 27001, HIPAA, FedRAMP High и многие другие.
...
Дополнительные сведения о главных ключах и маркерах ресурсов см. [в статье Защита доступа к Azure Cosmos DBным данным](secure-access-to-data.md).
