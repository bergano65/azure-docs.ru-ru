...
:::image type="content" source="./media/secure-access-to-data/nosql-database-security-master-key-portal.png" alt-text="Ответственность клиента и поставщика базы данных":::
