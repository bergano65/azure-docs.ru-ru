...
|Мониторинг атак|С помощью [ведения журнала аудита и журналов действий](logging.md)можно отслеживать нормальные и аномальные действия в учетной записи. Вы можете просматривать, какие операции выполнялись с ресурсами, кто инициировал эти операции, время их выполнения, состояние операций и многое другое, как показано на снимке экрана после этой таблицы.|
...
На следующем снимке экрана показано, как можно выполнять мониторинг учетной записи с помощью журналов аудита и действий: :::image type="content" source="./media/database-security/nosql-database-security-application-logging.png" alt-text="Ответственность клиента и поставщика базы данных":::
...
Дополнительные сведения о ведении журнала аудита см. в разделе [Azure Cosmos DB ведение журнала диагностики](logging.md).
