...
* **Сведения для подключения учетной записи Azure Cosmos DB**: имя, конечная точка и ключ учетной записи API Cassandra для Azure.
