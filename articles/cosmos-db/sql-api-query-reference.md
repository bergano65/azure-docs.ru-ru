...
Посетите сайт [Query Playground](https://www.documentdb.com/sql/demo), на котором вы можете испытать Cosmos DB в действии и выполнить SQL-запросы к нашему набору данных.  
...
- `expr`  
   ...
   — Любое допустимое выражение массива JSON. Обратите внимание на то, что строковые значения должны записываться в двойные кавычки, чтобы быть допустимыми. Дополнительные сведения о формате JSON, см. в разделе [json.org](https://json.org/)
...
- `expr`  
   ...
   — Любое допустимое выражение числу JSON. Числа в формате JSON должно быть целое число или число с плавающей запятой. Дополнительные сведения о формате JSON, см. в разделе [json.org](https://json.org/)  
...
- `expr`  
   ...
   — Любое допустимое выражение объекта JSON. Обратите внимание на то, что строковые значения должны записываться в двойные кавычки, чтобы быть допустимыми. Дополнительные сведения о формате JSON, см. в разделе [json.org](https://json.org/)  
