---
title: 'Эмулятор Azure Cosmos DB: скачивание и заметки о выпуске'
description: Ознакомьтесь с заметками о выпуске эмулятора Azure Cosmos DB для разных версий и сведениями о скачивании.
...
В этой статье приведены заметки о выпуске эмулятора Azure Cosmos DB со списком обновлений функций, сделанных в каждом выпуске. В нем также перечислены последние версии эмулятора для скачивания и использования.
...
### <a name="21110-5-january-2021"></a>2.11.10 (5 января 2021 г.)

 - В этом выпуске локальное содержимое обозревателя данных обновляется до последней версии портала Azure с добавлением нового общедоступного параметра /ExportPemCert, который позволяет пользователю эмулятора напрямую экспортировать сертификат общедоступного эмулятора в качестве PEM-файла.
