...
:::image type="content" source="./media/account-databases-containers-items/cosmos-entities.png" alt-text="Иерархия учетной записи Azure Cosmos" border="false":::
