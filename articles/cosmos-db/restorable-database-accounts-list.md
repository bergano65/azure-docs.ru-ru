---
title: Вывод списка учетных записей базы данных restorable с помощью Azure Cosmos DB REST API
description: Список всех учетных записей базы данных restorable Azure Cosmos DB, доступных в подписке.
author: kanshiG
...
* [Учетные записи базы данных restorable — список по расположению.](restorable-database-accounts-list-by-location.md)
