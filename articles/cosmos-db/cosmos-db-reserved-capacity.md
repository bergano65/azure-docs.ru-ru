...
4. Заполните обязательные поля, как описано в следующей таблице.
   ...
   |Поле  |ОПИСАНИЕ  |
   |---------|---------|
   |Name   |    Название резервирования. Это поле автоматически заполняется значением `CosmosDB_Reservation_<timeStamp>`. Вы можете указать другое название во время создания резервирования. Или вы можете переименовать его после создания резервирования.      |
