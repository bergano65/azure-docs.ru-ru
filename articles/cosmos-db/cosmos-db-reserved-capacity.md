...
Помогает в выявлении прямо зарезервированный объем ресурсов, см. в разделе [понять, как скидка на резервирование применяется к Azure Cosmos DB](../billing/billing-understand-cosmosdb-reservation-charges.md). В событии, необходимо отменить или exchange на резервирование Azure Cosmos DB, обратитесь в службу Azure Cosmos DB в `AskCosmosDB@microsoft.com`.
