...
4. Заполните обязательные поля, как описано в следующей таблице.
   ...
   |Тип зарезервированной емкости   |  Пропускная способность предоставляется как единицы запроса. Вы можете приобрести резервирование для подготовленной пропускной способности для настройки обоих параметров — один регион записывает записи также несколькими регионами.|
