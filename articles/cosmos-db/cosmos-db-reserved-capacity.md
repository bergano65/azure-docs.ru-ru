...
4. Заполните обязательные поля, как описано в следующей таблице.
   ...
   | Единицы зарезервированной емкости| Объем пропускной способности, который необходимо зарезервировать. Вы можете вычислить это значение путем определения пропускной способности, необходимой для всех ресурсов Cosmos DB (например, баз данных или контейнеров) в регионе. Затем вы умножаете его на число регионов, которые будут связаны с базой данных Cosmos. Пример: Если у вас есть пять регионов с 1 млн ЕЗ/с в каждом, выберите 5 миллионов ЕЗ/с, чтобы приобрести емкость резервирования. |
