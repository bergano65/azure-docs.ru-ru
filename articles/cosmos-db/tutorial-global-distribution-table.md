...
* **Запросы на запись:** пакет SDK автоматически отправляет все запросы на запись в текущий регион записи. В учетной записи с несколькими источниками текущий регион также будет обслуживать запросы на запись. В зависимости от сходства пакет SDK автоматически выбирает резервный геореплицированный регион для обеспечения высокого уровня доступности.
