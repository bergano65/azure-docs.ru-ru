...
2. **Cosmos DB:** Созданные данные хранятся в коллекции Azure Cosmos DB.  
...
## <a name="optional-visualize-with-an-e-commerce-site"></a>Необязательно: визуализация с использованием сайта электронной коммерции
