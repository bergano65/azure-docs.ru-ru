...
1. Вернитесь к [портал Azure](https://portal.azure.com/), затем к **учетной записи Cosmos DB**, а затем к **Обозреватель данных**.  
   ...
   Добавьте две коллекции в **changefeedlabdatabase**разделе  -  **продукты** и **категории** чанжефидлабдатабасе с фиксированной емкостью хранилища.
