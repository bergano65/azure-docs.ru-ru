...
*   После включения аналитического хранилища с аналитическим значением TTL его можно обновить до другого допустимого значения позже. 
*   Хотя параметр TTL может быть задан на уровне контейнера или элемента, аналитический срок жизни можно задать только на уровне контейнера.
*   Вы можете достигнуть длительного хранения рабочих данных в аналитическом хранилище, установив аналитический срок жизни >= транзакционный срок жизни на уровне контейнера.
...
При включении хранилища анайтикал в контейнере:
 * с помощью портала Azure для аналитического TTL задается значение по умолчанию-1. Это значение можно изменить на "n" секунд, перейдя к параметрам контейнера в разделе обозреватель данных. 
 
 * с помощью пакета SDK для Azure или PowerShell или интерфейса командной строки можно включить аналитический срок жизни, задав для него значение-1 или "n". 
