---
title: Создание мобильных приложений с помощью Xamarin и Azure Cosmos DB
...
Полный образец кода из этого примера можно найти в материалах по [брокеру маркера ресурса на сайте GitHub](https://aka.ms/documentdb-xamarin-todouser). Решение показано на схеме ниже.
