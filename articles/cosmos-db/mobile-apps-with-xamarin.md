...
:::image type="content" source="media/mobile-apps-with-xamarin/documentdb-for-mobile.png" alt-text="Возможности Azure Cosmos DB для мобильных приложений":::

* Широкие возможности запросов к данным без схемы. Azure Cosmos DB хранит данные в виде бессхемных документов JSON в разнородных коллекциях. Она предлагает [запросы с широкими возможностями и обеспечивает их быстрое выполнение](how-to-sql-query.md), так что вам не нужно беспокоиться о схемах или индексах.
...
* Безграничные возможности масштабирования. Контейнеры Azure Cosmos [увеличиваются по мере расширения приложения](partition-data.md). Вы можете начать с данных небольшого объема и пропускной способности в сотни запросов в секунду. Коллекции или базы данных могут достигать какой угодно пропускной способности (например, 100 миллионов запросов в секунду) и объема данных в несколько петабайт.
...
* Встроенные средства для расширенной проверки подлинности. С помощью Azure Cosmos DB можно легко реализовать популярные возможности, например [данные пользователей](https://github.com/kirillg/azure-documentdb-dotnet/tree/master/samples/xamarin/UserItems) или многопользовательские общие данные, без настраиваемого сложного кода проверки подлинности.
...
:::image type="content" source="media/mobile-apps-with-xamarin/cosmos-db-quickstart.png" alt-text="Возможности Azure Cosmos DB для мобильных приложений":::
...
Полный образец кода из этого примера можно найти в материалах по [брокеру маркера ресурса на сайте GitHub](https://github.com/kirillg/azure-documentdb-dotnet/tree/master/samples/xamarin/UserItems). Решение показано на схеме ниже.

:::image type="content" source="media/mobile-apps-with-xamarin/documentdb-resource-token-broker.png" alt-text="Возможности Azure Cosmos DB для мобильных приложений" border="false":::
...
:::image type="content" source="media/mobile-apps-with-xamarin/cosmos-db-xamarin-scale.png" alt-text="Возможности Azure Cosmos DB для мобильных приложений":::
...
:::image type="content" source="media/mobile-apps-with-xamarin/cosmos-db-xamarin-replicate.png" alt-text="Возможности Azure Cosmos DB для мобильных приложений" border="false":::
...
* Узнайте о [расширенных возможностях запросов в Azure Cosmos DB](how-to-sql-query.md).
