...
3. После открытия страницы "Метрики" выберите коллекцию для проверки в раскрывающемся списке **Коллекции**.
   ...
   ![Снимок экрана, показывающий набор метрик линзы мониторинга](./media/monitor-accounts/metrics-suite.png)
...
2. В группе связанных элементов **Мониторинг** по умолчанию отображаются следующие элементы:
   ...
   * Используемое хранилище.
   ...
   ![Снимок экрана, показывающий запросы и использование хранилища линзы мониторинга](./media/monitor-accounts/documentdb-total-requests-and-usage.png)
...
2. В меню ресурсов щелкните **Правила оповещения**, чтобы открыть соответствующую страницу.  
   ![Снимок экрана: часть правила генерации оповещений выбранные](./media/monitor-accounts/madocdb10.5.png)
...
4. На странице **Добавление правила оповещения** укажите следующее:
   ...
   * дополнительные адреса для оповещений электронной почты.  
     ![Снимок экрана: добавить страницу правила генерации оповещений](./media/monitor-accounts/madocdb12.png)
