...
В Azure Cosmos DB можно настроить как стандартную (ручную), так и автомасштабированную пропускную способность для баз данных и контейнеров. Автомасштабирование подготовленной пропускной способности в Azure Cosmos DB позволяет **автоматически и мгновенно масштабировать пропускную способность (единиц запросов в секунду) для базы данных или контейнера**. Пропускная способность масштабируется на основе использования, не влияя на доступность, задержку, пропускную способность или производительность рабочей нагрузки.
...
* Дополнительные сведения о [секционировании](partitioning-overview.md) в Azure Cosmos DB.
