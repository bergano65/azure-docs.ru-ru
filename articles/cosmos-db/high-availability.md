...
> [!NOTE] 
> Чтобы включить добавлена поддержка зон доступности, учетная запись Azure Cosmos DB необходимо иметь многопроцессорного-master в нескольких регионах записи включено. 
