...
|Цена (**_1_* _) | Н/Д | Скорость подготовки единиц запросов в секунду (x 1,25) | Число подготовленных единиц запросов в секунду x 1,25 (_*_2_*_) | Скорость записи в нескольких регионах |

_*_1_*_ для единиц запросов к бессерверным учетным ЗАПИСЯМ (ru) умножается на 1,25.

_*_2_*_ 1,25 Rate применяется только к тем регионам, в которых включено AZ.

Зоны доступности можно включить через:

_ [Портал Azure](how-to-manage-database-account.md#addremove-regions-from-your-database-account)
