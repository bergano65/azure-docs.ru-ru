...
При настройке операций записи в несколько регионов для учетной записи Azure Cosmos вы можете использовать избыточность зоны без дополнительных затрат. В противном случае ознакомьтесь с заметкой о ценах на поддержку избыточности зоны. Вы можете включить избыточность зоны в существующем регионе учетной записи Azure Cosmos, удалив регион и добавив ее обратно с включенной избыточностью зоны. Список регионов, в которых поддерживаются зоны доступности, см. в документации по [зонам доступности](../availability-zones/az-region.md) .
