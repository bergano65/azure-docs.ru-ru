...
|Ключевой показатель эффективности  |Один регион без зон доступности (не AZ)  |Одном регионе с зонами доступности (AZ)  |Нескольких регионов с зонами доступности (AZ 2 регионов) — наиболее рекомендуется использовать параметр |
|---------|---------|---------|---------|
