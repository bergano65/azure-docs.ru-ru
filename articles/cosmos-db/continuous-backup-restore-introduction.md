...
ms.locfileid: "99527869"
---
# <a name="continuous-backup-with-point-in-time-restore-feature-in-azure-cosmos-db"></a>Непрерывное резервное копирование с функцией восстановления до точки во времени в Azure Cosmos DB
[!INCLUDE[appliesto-sql-mongodb-api](includes/appliesto-sql-mongodb-api.md)]

Функция восстановления до точки во времени Azure Cosmos DB помогает в нескольких сценариях, таких как следующие:
