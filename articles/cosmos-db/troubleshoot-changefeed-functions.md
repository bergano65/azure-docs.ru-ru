...
Если вы обнаружите, что некоторые изменения, произошедшие в контейнере Azure Cosmos, не выбираются функцией Azure, или при копировании в целевом объекте отсутствуют некоторые изменения, выполните следующие действия.
...
Если назначением является другой контейнер Cosmos и вы выполняете операции Upsert для копирования элементов, **Убедитесь, что определение ключа секции в отслеживаемом и целевом контейнере одинаково**. Операции Upsert могут сохранять несколько исходных элементов в качестве одного в месте назначения из-за разницы в конфигурации.
