...
## <a name="step-2-clone-the-github-project"></a><a id="GitClone"></a>Шаг 2. Клонирование проекта GitHub
...
## <a name="step-5-create-a-collection"></a><a id="CreateColl"></a>Шаг 5. Создание коллекции
> [!WARNING]
...
## <a name="step-11-run-your-java-console-application-all-together"></a><a id="Run"></a>Шаг 11. Запуск консольного приложения Java
