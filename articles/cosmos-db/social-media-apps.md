...
Дело в том, что универсального решения для таких сценариев не существует. Это взаимосвязь, созданная сочетанием замечательных служб, которые позволяют создавать отличные впечатления от работы: скорость и свобода Azure Cosmos DB для предоставления отличного социальных приложений, аналитических средств для поиска в первом классе, например Azure Когнитивный поиск, гибкость служб приложений Azure для размещения даже независимых от языка приложений, но мощных фоновых процессов и расширяемой службы хранилища Azure и базы данных SQL Azure для хранения больших объемов данных и аналитической мощности Машинное обучение Azure Создавайте знания и аналитические данные, которые могут предоставить отзыв вашим процессам и помочь нам обеспечить правильное содержимое нужным пользователям.
