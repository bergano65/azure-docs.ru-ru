...
1. Добавьте строку подключения и имя Cosmos DB в файл ```.env```. Замените заполнителей «космос-имя-аккаунт» и «dbname» с вашим собственным именем учетной записи Cosmos и именем базы данных, без символов скобки.
