...
Это ограничение JavaScript. В JavaScript используется формат с плавающей запятой двойной точности согласно стандарту IEEE 754. Он может содержать только числа от –(253–1) до 253–1 (например, 9007199254740991).
