...
Создавать пользователей и разрешения можно с помощью [интерфейсов REST API](sql-api-sdk-dotnet.md) или одного из [пакетов SDK для API Cosmos DB](/rest/api/cosmos-db/).
