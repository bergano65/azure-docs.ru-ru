...
Для проектирования масштабируемых и производительных таблиц необходимо учитывать ряд факторов, включая затраты. Если вы ранее разработали схемы для реляционных баз данных, вам будет удобнее ознакомиться с этими вопросами. Но хотя между хранилищем таблиц Azure и реляционными моделями есть некоторые сходства, также существует много важных различий. Эти различия обычно приводят к различным проектам, которые могут выглядеть интуитивно понятными или неправильными для пользователей, знакомых с реляционными базами данных, но это имеет смысл при проектировании для NoSQL хранилища ключей и значений, например табличного хранилища.
