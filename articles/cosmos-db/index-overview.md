...
Пространственные индексы можно использовать для правильно отформатированных объектов [GeoJSON](./sql-query-geospatial-intro.md). В настоящее время поддерживаются Points, LineStrings, Polygons и MultiPolygons.
