...
Клонированный репозиторий содержит два примера: "Булкимпортсампле" и "Булкупдатесампле". Вы можете открыть любой из примеров приложений, обновить строки подключения в файле App. config, используя строки подключения учетной записи Azure Cosmos DB, собрать решение и запустить его.
