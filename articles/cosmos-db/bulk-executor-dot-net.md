...
description: Использование библиотеки .NET массового исполнителя в Azure Cosmos DB для массового импорта и обновления документов в контейнерах Azure Cosmos DB.
