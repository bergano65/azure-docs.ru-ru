...
| **Клиентские драйверы**; | **Azure CLI** | **API SQL**; | **API Azure Cosmos DB для Cassandra** | **API Azure Cosmos DB для MongoDB** | **API Gremlin**;|**API таблицы**; |
| --- | --- | --- | --- | --- | --- | --- |
| .NET | Нет данных | ДА | ДА | ДА | ДА | Нет |
|Java:|Нет данных|ДА|ДА|ДА|ДА|Нет|
|Python|Нет данных|ДА|ДА|ДА|ДА|Нет|
|Node/JS|Нет данных|ДА|ДА|ДА|ДА|Нет|
