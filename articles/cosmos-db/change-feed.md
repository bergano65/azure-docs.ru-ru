...
* В [бессерверных](http://azure.com/serverless) веб-приложениях и мобильных приложениях вы можете отслеживать события, такие как изменения профиля, параметров или расположения, а также активировать определенные действия, например отправлять push-уведомления на соответствующие устройства с помощью [Функций Azure](#azure-functions). 
