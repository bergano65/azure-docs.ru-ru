...
ms.locfileid: "71219892"
---
# <a name="change-feed-in-azure-cosmos-db---overview"></a>Канал изменений в Azure Cosmos DB. Обзор

Поддержка веб-канала изменений в Azure Cosmos DB работает путем прослушивания контейнера Azure Cosmos для внесения каких-либо изменений. Затем он выводит отсортированный список документов в порядке, в котором они были изменены. Изменения сохраняются и обрабатываются асинхронно и пошагово, а выходные данные могут распределяться в один или несколько объектов-получателей для параллельной обработки. 
