...
| **Клиентские драйверы**; | **Лазурный CLI** | **API СЗЛ** | **API API Azure Cosmos DB для Кассандры** | **API Azure Cosmos DB для MongoDB** | **Гремлин API**|**Таблица API** |
| --- | --- | --- | --- | --- | --- | --- |
