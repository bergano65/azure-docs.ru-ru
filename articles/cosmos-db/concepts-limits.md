...
description: Azure Cosmos DB служба квоты и ограничения по умолчанию на разных типов ресурсов.
author: arramac
ms.author: arramac
...
В этой статье содержатся общие сведения о квотах по умолчанию, предоставляемые для разных ресурсов в Azure Cosmos DB.
...
| Максимальный размер хранилища для всех элементов на ключ секции (логический)| 10 ГБ |
| Максимальное количество ключей отдельную секцию (логический) | Без ограничений |
| Максимальный объем хранилища на контейнер | Без ограничений |
| Максимальный размер хранилища на базу данных | Без ограничений |
...
| Максимальный общий объем хранилища на одну учетную запись | 10 ГБ |
