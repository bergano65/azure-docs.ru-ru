...
| Максимально включены пути на контейнер| 500 |
| Максимально исключенные пути в контейнере| 500 |
| Максимальные свойства в составном индексе| 8 |
...
| Ресурс | Ограничение по умолчанию |
| --- | --- |
| Максимальный размер памяти запроса MongoDB (это ограничение только для 3.2 версии сервера) | 40 МБ |
