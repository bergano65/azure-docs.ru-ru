...
Создав учетную запись Azure Cosmos DB в подписке Azure, вы сможете управлять данными в своей учетной записи [, создавая базы данных, контейнеры и элементы](databases-containers-items.md).
...
| Ресурс | Ограничение по умолчанию |
| --- | --- |
|Максимальная скорость создания коллекции, повторн минута| 5|
