...
* Если вы случайно удалили или повредили данные, обратитесь в [службу поддержки Azure](https://azure.microsoft.com/support/options/) в течение 8 часов, чтобы группа Azure Cosmos DB могла помочь вам восстановить данные из резервных копий.
  ...
  * Если вы случайно удалили базу данных или контейнер, откройте обращение в службу поддержки Azure уровень серьезности B или уровень серьезности C. 
  * Если вы случайно удалили или повредили некоторые документы в контейнере, откройте уровень серьезности в службу поддержки. 

При повреждении данных, а также при изменении либо удалении документов в контейнере нужно **удалить контейнер как можно скорее**. Удалив контейнер, вы можете избежать перезаписи Azure Cosmos DB резервными копиями. Если по какой-либо причине удаление невозможно, следует как можно скорее отправить запрос в службу. В дополнение к имени учетной записи Azure Cosmos, именам баз данных, именам контейнеров следует указать момент времени, в который можно восстановить данные. Важно действовать с максимальной точностью, чтобы помочь нам определить самые лучшие резервные копии, доступные на этот момент. Важно также указать время в формате UTC. 
