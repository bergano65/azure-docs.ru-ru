...
| **Операцион** | **Не определено** | **Null** | **Boolean** | **Число** | **String** | **Объект** | **массив**. |
|---|---|---|---|---|---|---|---|
...
| --- | --- | --- | --- |
| **True** |True |True |True |
| **False** |Верно |Неверно |Не определено |
| **Не определено** |Верно |Не определено |Не определено |
...
|  | **True** | **False** | **Не определено** |
| --- | --- | --- | --- |
| **True** |Верно |Неверно |Не определено |
| **False** |Неверно |Неверно |Неверно |
| **Не определено** |Не определено |Неверно |Не определено |
