...
| **Операцион** | **Не определено** | **Null** | **Boolean** | **Число** | **String** | **Объект** | **InArray** |
|---|---|---|---|---|---|---|---|
...
| **InArray** | Не определено | Не определено | Не определено | Не определено | Не определено | Не определено | **Хорошо** |
