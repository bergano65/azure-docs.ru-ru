...
**Масштабирование пропускной записи чтения и записи во всем мире.** Вы можете позволить каждому региону быть writable и упругой масштаба читает и пишет по всему миру. Пропускная часть, которую приложение настраивает на базу данных Azure Cosmos или контейнер, гарантированно будет доставлена во все регионы, связанные с вашей учетной записью Azure Cosmos. Предудержанный пропускная информация гарантируется за счет [финансово обеспеченных SLAs.](https://azure.microsoft.com/support/legal/sla/cosmos-db/v1_3/)
