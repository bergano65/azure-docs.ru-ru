...
С помощью Azure Cosmos DB можно в любое время добавлять или удалять регионы, связанные с учетной записью. Вам не нужно приостанавливать или повторно развертывать приложение, чтобы добавить или удалить регион. Он по-своему постоянно доступен в течение всего времени из-за возможностей поддержки нескольких сетевых услуг, предоставляемых службой изначально.
...
## <a id="Next Steps"></a>Следующие шаги
