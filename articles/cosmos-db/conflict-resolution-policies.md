...
Если ваша учетная запись Cosmos настроена на несколько регионов записи, при одновременном обновлении одного и того же элемента несколькими средствами записи в разных регионах могут возникнуть конфликты. Конфликты обновления делятся на следующие три типа:
