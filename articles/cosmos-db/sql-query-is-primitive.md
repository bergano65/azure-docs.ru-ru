...
## <a name="examples"></a>Примеры
  ...
  В следующем примере выполняется проверка объектов Boolean, число, строка, null, объект, массив и неопределенные типы с помощью `IS_PRIMITIVE` функции.  
