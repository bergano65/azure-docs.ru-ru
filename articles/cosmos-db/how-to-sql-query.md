...
- [Azure Cosmos DB SQL спецификации](https://go.microsoft.com/fwlink/p/?LinkID=510612)
- [ANSI SQL 2011 Г.](https://www.iso.org/iso/iso_catalogue/catalogue_tc/catalogue_detail.htm?csnumber=53681)
- [JSON](https://json.org/)
...
- Graefe ж. «Каскадные платформы для оптимизации запросов.» *IEEE Data Eng. Bull.* 18, нет. 3 (1995).
...
- [Примеры для Azure Cosmos DB .NET](https://github.com/Azure/azure-cosmosdb-dotnet)
