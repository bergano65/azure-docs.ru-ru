...
Следующий запрос возвращает все заданные имена детей в семье, `id` соответствует `WakefieldFamily`, упорядоченные по корпоративного класса.
...
| Или | Истина | False | Undefined |
| --- | --- | --- | --- |
| Истина |Истина |Истина |Истина |
| False |Истина |False |Undefined |
| Undefined |Истина |Undefined |Undefined |

**Оператор AND**

| AND | Истина | False | Undefined |
| --- | --- | --- | --- |
| Истина |Истина |False |Undefined |
...
| Функция | Описание |
|-------|-------------|
| Число | Возвращает число элементов в выражении. |
| SUM   | Возвращает сумму всех элементов в выражении. |
| МИНИМАЛЬНЫЕ   | Возвращает минимальное значение в выражении. |
