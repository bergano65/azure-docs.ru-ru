...
Например, контейнер содержит элементы. Каждый элемент имеет уникальное значение для свойства `UserID`. Если `UserID` выступает в качестве ключа секции для элементов в контейнере и 1 000 уникальных значений `UserID`, для контейнера создаются логические секции 1 000.
...
* У одной логической секции есть верхний предел в 20 ГБ хранилища.  
