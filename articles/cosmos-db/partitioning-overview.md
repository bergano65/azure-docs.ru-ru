...
Число физических секций в контейнере зависит от следующей конфигурации:
...
> [!NOTE]
> При выборе ключа секции, который равномерно распределяет потребление пропускной способности по логическим секциям, вы обеспечите балансировку потребления пропускной способности в физических секциях.
...
:::image type="content" source="./media/partitioning-overview/logical-partitions.png" alt-text="Просмотр числа физических разделов" border="false":::
