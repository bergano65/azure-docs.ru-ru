---
title: Скрипт Azure PowerShell. Репликация в нескольких регионах для базы данных Azure Cosmos DB
...
| [Set-AzResource](https://docs.microsoft.com/powershell/module/az.resources/set-azresource) | Изменяет учетную запись базы данных. |
