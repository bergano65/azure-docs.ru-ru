---
title: Скрипт Azure PowerShell для создания учетной записи API Cassandra для Azure Cosmos DB
description: Пример скрипта Azure PowerShell для создания учетной записи API Cassandra для Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
