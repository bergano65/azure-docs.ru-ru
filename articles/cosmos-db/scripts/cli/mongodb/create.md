---
title: Создание базы данных и коллекции для API MongoDB в Azure Cosmos DB
description: Создание базы данных и коллекции для API MongoDB в Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "87432160"
---
# <a name="create-a-database-and-collection-for-mongodb-api-for-azure-cosmos-db-using-azure-cli"></a>Создание базы данных и коллекции для API MongoDB в Azure Cosmos DB с помощью Azure CLI
