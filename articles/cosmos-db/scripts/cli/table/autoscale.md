---
title: Создание таблицы для API таблиц с автомасштабированием в Azure Cosmos DB
description: Создание таблицы для API таблиц с автомасштабированием в Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "87433464"
---
# <a name="create-an-azure-cosmos-table-api-account-and-table-with-autoscale-using-azure-cli"></a>Создание учетной записи и таблицы API таблиц с автомасштабированием в Azure Cosmos с помощью Azure CLI
