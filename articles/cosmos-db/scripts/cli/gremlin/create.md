---
title: Создание базы данных и графа Gremlin в Azure Cosmos DB
description: Создание базы данных и графа Gremlin в Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "87432229"
---
# <a name="create-an-azure-cosmos-gremlin-api-account-database-and-graph-using-azure-cli"></a>Создание учетной записи, базы данных и графа API Gremlin в Azure Cosmos с помощью Azure CLI
