...
| [Set-AzCosmosDBMongoDBDatabase](https://docs.microsoft.com/powershell/module/az.cosmosdb/set-azcosmosdbmongodbdatabase) | Создает новую или обновляет существующую базу данных API MongoDB службы Cosmos DB. |
...
| [Set-AzCosmosDBMongoDBCollection](https://docs.microsoft.com/powershell/module/az.cosmosdb/set-azcosmosdbmongodbcollection) | Создает новую или обновляет существующую коллекцию SQL службы Cosmos DB. |
