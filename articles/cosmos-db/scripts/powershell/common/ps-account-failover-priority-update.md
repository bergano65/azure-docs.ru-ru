---
title: Скрипт Azure PowerShell — изменение приоритета при отработке отказа для учетной записи Azure Cosmos
description: Пример скрипта Azure PowerShell — изменение приоритета при отработке отказа для учетной записи Azure Cosmos
author: markjbrown
