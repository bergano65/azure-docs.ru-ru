...
| [Get-AzCosmosDBTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbtable) | Выводит список таблиц или указанную таблицу API таблиц в службе Cosmos DB учетной записи. |
