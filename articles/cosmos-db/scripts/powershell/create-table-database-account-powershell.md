---
title: Сценарий Azure PowerShell для создания учетной записи API таблиц для Azure Cosmos DB
description: Пример сценария Azure PowerShell для создания учетной записи API таблиц для Azure Cosmos DB.
author: SnehaGunda
ms.author: sngun
