---
title: Скрипт Azure PowerShell для создания учетной записи API Gremlin для Azure Cosmos DB
description: Пример скрипта Azure PowerShell для создания учетной записи API Gremlin для Azure Cosmos DB
