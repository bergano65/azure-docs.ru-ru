...
|**Item**|**Использование (ежемесячно)**|**Тариф**|**Ежемесячные расходы**|
|----|----|----|----|
...
|Счет за хранение контейнера в западной части США |1 ТБ (или 1024 ГБ) |0,25 долл. США за ГБ |$256 |
|Счет за хранение в трех дополнительных регионах ("Восточная часть США", "Северная Европа" и "Восточная Азия") |3 - 1 ТБ (или 3072 ГБ) |0,25 долл. США за ГБ |$768 |
|**Общая**|||**$6,976** |
