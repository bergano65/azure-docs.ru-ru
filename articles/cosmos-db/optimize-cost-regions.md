...
1. `T x N RU/s` Если ваша учетная запись Azure Cosmos настроена с областью одной операции записи. 

1. `T x (N+1) RU/s` Если для учетной записи Azure Cosmos настроены все регионы, способная обрабатывать операции записи. 
