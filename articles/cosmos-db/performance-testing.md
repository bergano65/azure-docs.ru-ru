...
**Шаг 2.** Измените параметры для EndpointUrl, Authorizationkey согласно инструкциям, CollectionThroughput и DocumentTemplate (необязательно) в файле App. config.
