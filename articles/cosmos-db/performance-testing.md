...
**Шаг 1.** Скачайте проект со страницы [примера для тестирования производительности в Azure Cosmos DB](https://github.com/Azure/azure-documentdb-dotnet/tree/master/samples/documentdb-benchmark) или создайте вилку репозитория GitHub.
