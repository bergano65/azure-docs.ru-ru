...
![Секции ресурсов](./media/global-dist-under-the-hood/distribution-of-resource-partitions.png)
**Распределение секций ресурсов**

Физически секция ресурсов реализуется группой реплик, называемой набором реплик. Каждая машина содержит сотни реплик, соответствующих различным секциям ресурсов в рамках фиксированного набора процессов, как показано на предыдущем рисунке. Реплики, соответствующие секциям ресурсов, динамически размещаются и распределяют нагрузки между машинами в кластере и центрах обработки данных в пределах региона.  
