...
Все операции CRUD, выполняемые с помощью пакета SDK, совместимого с CQLV4, возвращают дополнительные сведения об ошибке, использованных единицах запроса. Команды удаления и обновления необходимо выполнять с учетом принципов управления ресурсами, чтобы избежать правильного использования выделенной пропускной способности. 
