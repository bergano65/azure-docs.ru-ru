...
ms.locfileid: "85392052"
---
# <a name="azure-cosmos-db-net-core-sdk-v2-for-sql-api-release-notes-and-resources"></a>Azure Cosmos DB пакет SDK для .NET Core v2 для API SQL: заметки о выпуске и ресурсы
...
> [!NOTE]
> Если вы используете .NET Core, см. последнюю версию 3. x [пакета SDK для .NET](sql-api-sdk-dotnet-standard.md), которая предназначена для .NET Standard. 
