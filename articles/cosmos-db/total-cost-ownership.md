...
:::image type="content" source="./media/total-cost-ownership/tco.png" alt-text="Стоимость владения Azure Cosmos DB" border="false":::
...
* **Вы получаете множество функций бесплатно:** В Azure Cosmos DB рабочие нагрузки записи значительно дешевле по сравнению с альтернативными службами баз данных. Кроме того, Azure Cosmos DB предлагает такие функции, как [автоматическое индексирование](index-policy.md), значение [срока жизни (TTL)](time-to-live.md), [веб-канал изменений](change-feed.md) и другие возможности без дополнительной платы, которую обычно взимают другие службы баз данных.
