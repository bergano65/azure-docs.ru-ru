...
Ответ. Да, эта функция доступна для новых учетных записей Cosmos и должна выполняться во время создания учетной записи. Дополнительные сведения см. в документе " [управляемые ключи клиента](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk) ".
...
Общие сведения о Cosmos DB безопасности и последних улучшениях см. в статье [безопасность базы данных Azure Cosmos](database-security.md).
