...
- **Края содержат ссылки на вершины, на которые они указывают**. Все грани хранятся с ключами секций и идентификаторами вершин, на которые они указывают. Это вычисление делает `out()` все запросы направления всегда выделяться секционированным запросом с областью, а не с помощью скрытого межсекционного запроса. 
