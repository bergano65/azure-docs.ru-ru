...
| Сущность Azure Cosmos | API SQL | API Cassandra | API Azure Cosmos DB для MongoDB | API Gremlin | API таблицы |
| --- | --- | --- | --- | --- | --- |
...
| Свойство, определяемое системой | Формируемый системой или настраиваемый пользователем | Цель | API SQL | API Cassandra | API Azure Cosmos DB для MongoDB | API Gremlin | API таблицы |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| Сущность Cosmos | API SQL | API Cassandra | API Azure Cosmos DB для MongoDB | API Gremlin | API таблицы |
| --- | --- | --- | --- | --- | --- |
...
| Свойство, определяемое системой | Формируемый системой или настраиваемый пользователем| Цель | API SQL | API Cassandra | API Azure Cosmos DB для MongoDB | API Gremlin | API таблицы |
| --- | --- | --- | --- | --- | --- | --- | --- |
|\_RID | Создано системой | Уникальный идентификатор элемента | Да | Нет | Нет | Нет | Нет |
|\_ETag | Создано системой | Тег сущности, используемый для управления оптимистической блокировкой. | Да | Нет | Нет | Нет | Нет |
