...
Вы можете зарегистрировать [хранимые процедуры, триггеры, определяемые пользователем функции (UDF)](stored-procedures-triggers-udfs.md) и [слияния процедуры](how-to-manage-conflicts.md#create-a-custom-conflict-resolution-policy-with-a-stored-procedure) в контейнер Azure Cosmos. 
