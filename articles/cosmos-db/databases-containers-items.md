...
| Azure Cosmos, объект | API-интерфейс SQL | API Cassandra | API Azure Cosmos DB для MongoDB | API Gremlin | API таблиц |
| --- | --- | --- | --- | --- | --- |
...
| Операция | Инфраструктура CLI Azure | API-интерфейс SQL | API Cassandra | API Azure Cosmos DB для MongoDB | API Gremlin | API таблиц |
| --- | --- | --- | --- | --- | --- | --- |
...
| Системные свойства | Создаваемые системой или пользователем | Назначение | API-интерфейс SQL | API Cassandra | API Azure Cosmos DB для MongoDB | API Gremlin | API таблиц |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
| Создать контейнер | Да | Да | Да | Да | Нет данных | Нет данных |
...
| Сущности Cosmos | API-интерфейс SQL | API Cassandra | API Azure Cosmos DB для MongoDB | API Gremlin | API таблиц |
| --- | --- | --- | --- | --- | --- |
...
|идентификатор | Можно использовать | Определяемое пользователем уникальное имя в логической секции. Если пользователь не укажет идентификатор, система автоматически создает один. | Да | Да | Да | Да | Да |
