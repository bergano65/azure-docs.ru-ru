---
title: Использование геопространственных данных в учетной записи Azure Cosmos DB API SQL
...
Эта статья содержит вводную информацию о геопространственной функциональности Azure Cosmos DB. В настоящее время хранение геопространственных данных и доступ к ним поддерживаются только в учетных записях API SQL Azure Cosmos DB. После прочтения этой статьи вы сможете ответить на следующие вопросы:
...
Azure Cosmos DB поддерживает следующие встроенные функции Открытого геопространственного консорциума (OGC) для выполнения запросов к геопространственным данным. Дополнительные сведения о всех встроенных функциях SQL см. в статье [Запрос данных Azure Cosmos DB с помощью SQL-запросов](how-to-sql-query.md).
...
* Освойте геопространственные запросы на [Игровой площадке запросов Azure Cosmos DB](https://www.documentdb.com/sql/demo#geospatial).
* Дополнительные сведения о запросах Azure Cosmos DB см. [здесь](how-to-sql-query.md).
