...
* **Azure China 21Vianet** доступен благодаря уникальному партнерству между Microsoft и 21Vianet, одним из крупнейших интернет-провайдеров страны.
...
| --- | --- | --- | --- |
| Сертификация CSA STAR | Руководство по требованиям DoD уровень 2 | HIPAA BAA | Австралия IRAP |
...
| ISO 20000-1:2011 | Уровень 4-го уровня ДоР SRG | PCI DSS | 
...
* Для обзора безопасности DB Azure Cosmos и последних улучшений смотрите статью [безопасности базы данных Azure Cosmos.](database-security.md)
