...
Уровни согласованности не зависят от региона. Уровень согласованности учетной записи Cosmos DB гарантируется для всех операций чтения, независимо от следующих параметров:
