...
- **Уровень согласованности = "сеансовая"**. Операции чтения всегда учитывают гарантии постоянного префикса (при условии единого сеанса записи), монотонного чтения, монотонной записи, чтения собственных записей, записей после чтения. Согласованность сеанса ограничена сеансом клиента.
