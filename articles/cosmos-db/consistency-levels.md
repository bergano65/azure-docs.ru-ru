...
- **Уровень согласованности Session (сеанс)** :  В рамках сеанса отдельного клиента операции чтения гарантированно учитывает префиксный (при условии, что сеанс единый «писатель»), монотонное чтение, монотонную запись, гарантии по уровням чтения записи и записи следующим операций чтения. Клиенты вне сеанса, выполнения операций записи, будут видеть итоговую согласованность.
