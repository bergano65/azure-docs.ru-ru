...
В этом сценарии контейнер Cosmos глобально реплицируется в нескольких регионах на нескольких континентах. Использование строгой согласованности для всех регионов в этом сценарии повлияет на производительность. Чтобы обеспечить более высокий уровень устойчивости без повышения задержки записи, в приложении можно использовать два клиента с одним токеном сеанса.
