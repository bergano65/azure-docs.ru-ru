...
1. В окне **Azure Cosmos DB ODBC Driver SDN Setup** (Настройка имени источника данных драйвера ODBC для Azure Cosmos DB) укажите следующие сведения: 
    ...
    :::image type="content" source="./media/odbc-driver/odbc-driver-dsn-setup.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::
    ...
    :::image type="content" source="./media/odbc-driver/odbc-cosmos-account-keys.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB" введите "regedit", чтобы найти и открыть приложение **редактора реестра** .
        ...
        - Щелкните правой кнопкой мыши, чтобы добавить новое **строковое** значение:
            ...
            - Данные значения: **1** 
             :::image type="content" source="./media/odbc-driver/cosmos-odbc-edit-registry.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::
...
1. Когда вы завершите настройку и закроете окно **настройки имени источника данных драйвера ODBC для Azure Cosmos DB** , новое пользовательское имя источника данных будет добавлено на соответствующую вкладку.
    ...
    :::image type="content" source="./media/odbc-driver/odbc-driver-user-dsn.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::
...
1. После выполнения шагов 1-4 в разделе [Подключение к базе данных Azure Cosmos](#connect)щелкните **редактор схем** в окне **установки Azure Cosmos DB драйвера ODBC** .
    ...
    :::image type="content" source="./media/odbc-driver/odbc-driver-schema-editor.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB" которых задано значение true, не возвращаются для выбора и проекции, несмотря на то, что они по-прежнему являются частью схемы. Например, можно скрыть все обязательные системные свойства Azure Cosmos DB, начинающиеся со знака "_".
...
:::image type="content" source="./media/odbc-driver/odbc-driver-linked-server-ssms.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::
...
:::image type="content" source="./media/odbc-driver/odbc-driver-create-view.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::
...
1. Щелкните **Получить данные** .
    ...
    :::image type="content" source="./media/odbc-driver/odbc-driver-power-bi-get-data.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::

1. В окне **Получить данные** щелкните **Другие** | **ODBC** | **Подключиться** .

    :::image type="content" source="./media/odbc-driver/odbc-driver-power-bi-get-data-2.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::
...
1. В окне **Из ODBC** выберите созданное имя источника данных и нажмите кнопку **ОК** . Поля на вкладке **Дополнительные параметры** можно не заполнять.
   ...
   :::image type="content" source="./media/odbc-driver/odbc-driver-power-bi-get-data-3.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::
...
1. В окне **Навигатор** на панели слева разверните базу данных, схему и выберите таблицу. В область результатов данные добавляются по созданной схеме.
    ...
    :::image type="content" source="./media/odbc-driver/odbc-driver-power-bi-get-data-4.png" alt-text="Администратор источников данных ODBC для Azure Cosmos DB":::
