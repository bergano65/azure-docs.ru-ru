...
description: В этой статье описывается, как создавать и использовать учетные записи Azure Cosmos. Он также показывает иерархию элементов в учетной записи Azure Cosmos
author: markjbrown
ms.author: mjbrown
