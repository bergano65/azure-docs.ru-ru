...
> [!NOTE]
> Поддержка частной конечной точки в настоящее время доступна в поддерживаемых регионах только для режима подключения к шлюзу. В режиме прямого доступа он доступен в виде предварительной версии функции.
