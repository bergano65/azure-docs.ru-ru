...
При создании частной конечной точки ее можно интегрировать с частной зоной DNS в Azure. Если вы решили не интегрировать закрытую конечную точку с частной зоной DNS в Azure, а вместо этого использовать настраиваемую службу DNS, необходимо настроить DNS для добавления новой записи DNS для частного IP-адреса, соответствующего новому региону.
