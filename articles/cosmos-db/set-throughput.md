...
# <a name="setting-throughput-on-a-azure-cosmos-container"></a>Настройка пропускной способности в контейнере Azure Cosmos  
...
# <a name="setting-throughput-on-a-azure-cosmos-database"></a>Настройка пропускной способности в базе данных Azure Cosmos
...
## <a name="setting-throughput-on-a-azure-cosmos-database-and-a-container"></a>Настройка пропускной способности для базы данных Azure Cosmos и контейнера
