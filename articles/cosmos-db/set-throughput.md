...
Контейнеры в базе данных с общей пропускной способностью совместно используют пропускную способность (единиц запросов в секунду), выделенную этой базе данных. В базе данных с общей пропускной способностью:
...
* В базе данных может быть не более 25 контейнеров. Если в базе данных с общей пропускной способностью уже имеется более 25 контейнеров, вы не сможете создавать дополнительные контейнеры до тех пор, пока количество контейнеров не будет меньше 25.
