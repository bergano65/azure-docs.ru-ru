...
Несколько логических секций, принадлежащих разным контейнерам, которые совместно используют пропускную способность, подготовленную к базе данных, могут размещаться в одной физической секции. Хотя одна логическая Секция контейнера всегда находится в пределах физической секции, *"L"* логические секции в контейнерах *"C"* , которые совместно используют подготовленную пропускную способность базы данных, можно сопоставить и разместить на *"R"* физической Partition. 
