...
> [!NOTE]
> В базе данных с общей пропускной способностью в базе данных может быть не более 25 контейнеров. Если в базе данных с общей пропускной способностью уже имеется более 25 контейнеров, вы не сможете создавать дополнительные контейнеры до тех пор, пока количество контейнеров не будет меньше 25.
