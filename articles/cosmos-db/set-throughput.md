...
При условии хорошего ключа секции, который равномерно распределяет логические секции между физическими секциями, пропускная способность также распределяется равномерно по всем логическим секциям контейнера. Нельзя выборочно указывать пропускную способность для логических секций. Так как один логический раздел контейнера или несколько размещаются в физическом разделе, физические разделы относятся исключительно к данному контейнеру и поддерживают пропускную способность, подготовленную для контейнера. 
