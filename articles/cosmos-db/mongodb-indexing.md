...
Составные индексы содержат ссылки на множество полей документа. Если требуется создать составной индекс, [выполните обновление до версии 3,6](mongodb-version-upgrade.md).
