...
![Настройка геопространственной конфигурации](./media/sql-query-geospatial-index/geospatial-configuration.png)

Можно также изменить `geospatialConfig` в пакете SDK для .NET, чтобы настроить **Геопространственное конфигурирование**:

Если значение не указано, `geospatialConfig` по умолчанию будет выбран тип данных geography. При изменении `geospatialConfig`все существующие геопространственные данные в контейнере будут переиндексированы.
