...
> [!NOTE]
> Azure Cosmos DB поддерживает индексирование точек, LineString, многоугольников и многомногоугольниковых элементов. При индексировании любого из этих типов будет автоматически индексироваться все остальные типы. Иными словами, при индексировании многоугольников также будут индексироваться баллы, LineString и многомногоугольники. Индексирование нового пространственного типа не влияет на ЕДИНИЦу оплаты при записи или размер индекса, если только отсутствуют допустимые данные геоjson этого типа.

## <a name="modifying-geospatial-configuration"></a>Изменение геопространственной конфигурации
