...
#### <a name="add-a-list-item-view"></a><a name="AddItemIndexView"></a>Добавление представления "Элемент списка"
...
#### <a name="add-a-new-item-view"></a><a name="AddNewIndexView"></a>Добавление представления "Создание элементов"
...
1. Откройте в решении файл *Startup.cs* и замените в нем метод `ConfigureServices` следующим кодом:
