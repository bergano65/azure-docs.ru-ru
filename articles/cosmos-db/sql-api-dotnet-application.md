...
### <a name="initialize-services"></a>Объявление и инициализация служб
...
## <a name="run-the-application"></a>Шаг 5. Локальный запуск приложения
...
## <a name="deploy-the-application-to-azure"></a>Шаг 6. Развертывание приложения
