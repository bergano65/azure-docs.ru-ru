...
- Если взглянуть на `storeOps` объект, можно увидеть, что имеет значение, а это `fanoutFactor` `5` означает, что эта операция осуществляла доступ к [5 секциям](https://docs.microsoft.com/azure/cosmos-db/partition-data) .
