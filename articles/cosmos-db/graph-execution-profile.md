...
- Судя от `time` метрики, задержка этого запроса кажется высокой, так как она [больше 10 мс для одной операции чтения точки](./introduction.md#guaranteed-low-latency-at-99th-percentile-worldwide).
