...
Хранимые процедуры написаны с использованием JavaScript. Они могут создавать, обновлять, читать, запрашивать и удалять элементы в контейнере Azure Cosmos. Дополнительные сведения о том, как написать хранимую процедуру в Azure Cosmos DB см. в [этой статье](how-to-write-stored-procedures-triggers-udfs.md#stored-procedures).
