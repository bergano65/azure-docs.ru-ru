...
|Тип ключа|Ресурсы|
|---|---|
|[Главные ключи](#primary-keys) |Используются для административных ресурсов: учетных записей базы данных, баз данных, пользователей и разрешений.|
