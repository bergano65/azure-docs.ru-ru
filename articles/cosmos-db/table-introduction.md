...
* [Выделенная пропускная способность](partitioning-overview.md) по всему миру (при использовании подготовленной пропускной способности).
...
| Цены | На основе потребления. | Доступно в режимах [на основе потребления](serverless.md) и [подготовленной емкости](set-throughput.md). |
