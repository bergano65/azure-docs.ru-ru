---
title: Создание контейнеров и баз данных Azure Cosmos с пропускной способностью в режиме автопилота.
...
ms.locfileid: "73512279"
---
# <a name="create-azure-cosmos-containers-and-databases-with-provisioned-throughput-in-autopilot-mode-preview"></a>Создание контейнеров и баз данных Azure Cosmos с подготовленной пропускной способностью в режиме автопилотного режима (Предварительная версия)
...
|---------|---------|---------|
| **Подготовленная пропускная способность** | Подготовка вручную | Заблаговременное и реактивно масштабирование на основе шаблонов использования рабочих нагрузок. |
| **Ограничение скорости запросов и операций (429)**  | Может произойти, если потребление превышает подготовленную емкость. | Не будет выполняться.  |
...
1. Выберите **создать базу данных**, введите имя базы данных. Для параметра **автопилотность** выберите **включено** и укажите максимальную пропускную способность, которую база данных не может превысить при использовании параметра автопилот.

   ![Создание базы данных в режиме автопилота](./media/provision-throughput-autopilot/create-database-autopilot-mode.png)

1. Нажмите кнопку **ОК**.

Аналогичным образом можно создать контейнер с подготовленной пропускной способностью в режиме автопилота.
