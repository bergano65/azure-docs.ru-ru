---
title: Библиотека обработчика веб-канала изменений в Azure Cosmos DB
description: Узнайте, как использовать библиотеку обработчика канала изменений Azure Cosmos DB для чтения веб-канала изменений, компонентов обработчика веб-канала изменений.
author: markjbrown
ms.author: mjbrown
