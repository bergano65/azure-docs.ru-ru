...
* На портале Azure Functions можно создать триггер. Для инструкций по быстрому запуску на [портале Azure смотрите триггер Azure Functions для Cosmos DB.](https://aka.ms/cosmosdbtriggerportalfunc)
...
* [Создание триггера Azure Functions для Cosmos DB на портале Azure](https://aka.ms/cosmosdbtriggerportalfunc)
