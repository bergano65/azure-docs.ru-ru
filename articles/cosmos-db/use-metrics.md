...
:::image type="content" source="media/use-metrics/metrics-12.png" alt-text="Cosmos DB метрики производительности в портал Azure":::
...
:::image type="content" source="media/use-metrics/metrics-17.png" alt-text="Cosmos DB метрики производительности в портал Azure":::
...
:::image type="content" source="media/use-metrics/metrics-07.png" alt-text="Cosmos DB метрики производительности в портал Azure":::

Чтобы определить, какой ключ секции искажает распределение, щелкните секцию на диаграмме.

:::image type="content" source="media/use-metrics/metrics-05.png" alt-text="Cosmos DB метрики производительности в портал Azure":::
