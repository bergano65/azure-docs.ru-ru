...
## <a name="examples"></a>Примеры
  ...
  В следующем примере показано, как `StringToObject` ведет себя по разным типам. 
...
Несмотря на то, что они являются допустимыми в запросе, они не будут анализироваться в допустимые объекты. Строки в строке объекта должны либо экранированы "{\\" a @ no__t-1 ": \\" str @ no__t-3 "}", либо окружающая кавычка должна быть единственной "{" a ":" str "}".
