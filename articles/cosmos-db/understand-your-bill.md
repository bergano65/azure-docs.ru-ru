...
ms.locfileid: "58877645"
---
# <a name="understand-your-azure-cosmos-db-bill"></a>Расшифровка счета за использование Azure Cosmos DB

Azure Cosmos DB — это полностью управляемая оптимизированная для облака служба баз данных с упрощенной моделью выставления счетов. Плата взимается только за подготовленную пропускную способность и использованный объем хранилища. Отсутствуют дополнительные лицензионные платежи, оборудования, программа затраты или расходов по сравнению с локальной или размещенной в IaaS альтернативные варианты. При рассмотрении множественных регион возможности Azure Cosmos DB, службу базы данных предоставляет значительно сократить затраты по сравнению с существующей локальной или решений IaaS.
...
|**Элемент** |**Использование (месяц)** |**Тариф** |**Ежемесячные расходы** |
|---------|---------|---------|-------|
...
*Предположим также, что вы отправляете 100 ГБ данных каждый месяц из контейнера в западной части США для репликации данных в восточной части США, Северная Европа и Восточная Азия. Взимается плата за исходящий трафик в соответствии с внешней скорости передачи данных.*
...
|**Часы**  |**ЕЗ/с** |**Элемент** |**Использование (каждый час)** |**Стоимость** |
|---------|---------|---------|-------|-------|
...
|| |**Общая ежемесячная стоимость**  | |**$38,688**   |
...
*Цены могут отличаться от указанных по регионам. Актуальные цены, см. в разделе [странице цен](https://azure.microsoft.com/pricing/details/cosmos-db/).*
...
|**Регион**| **Почасовая цена за 100 ЕЗ/с**|**Единицы (ЕЗ/с)**|**Сумма начисления (ежечасно)**| **Сумма начисления (ежемесячно)**|
|----|----|----|----|----|
