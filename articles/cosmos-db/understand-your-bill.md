...
|**Hours**  |**Единиц запросов в секунду** |**Элемент** |**Использование (ежечасно)** |**Стоимость** |
|---------|---------|---------|-------|-------|
...
### <a name="billing-example---container-or-database-with-autoscale-throughput"></a>Пример выставления счетов — контейнер или база данных с пропускной способностью автомасштабирования
- Предположим, что на бесплатной учетной записи уровня создается база данных или контейнер с включенным автомасштабированием с максимальным числом единиц запросов в секунду (4000 единиц запросов в секунду). Этот ресурс будет автоматически масштабироваться между 400 единиц запросов в секунду и 4000 единиц запросов в секунду. 
...
- Примечание. Если цена за единицу для единиц запросов в секунду или хранилища различается в регионах, уровень Free 400 единиц запросов в секунду и 5 ГБ будут отражать тарифы региона, в котором была создана учетная запись.
