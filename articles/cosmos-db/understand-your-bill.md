...
:::image type="content" source="./media/understand-your-bill/bill-example3.png" alt-text="Пример счета за выделенную пропускную способность" (запись во всех регионах)  | `D1: 10K RU/sec/100 * $0.016 * 100 hours = $160` <br/>`D2: 30 K RU/sec/100 * $0.016 * 100 hours = $480` <br/>`C1: 20 K RU/sec/100 *$0.016 * 100 hours = $320` |960 долл. США  |
