...
> [!TIP]
> Хранимые процедуры, лучше всего подходят для операций, которые требуют транзакции между значением ключа секции и интенсивными операциями записи. При принятии решения использовать хранимые процедуры, оптимизируйте вокруг инкапсуляции максимальный объем возможных операций записи. Вообще говоря хранимые процедуры не самое эффективное средство для выполнения большого количества операций чтения или запроса, поэтому использование хранимых процедур для пакета большого количества операций чтения и возвратить клиенту не окажет требуемой преимущество. Для наилучшей производительности эти операции интенсивными операциями чтения должно выполняться на стороне клиента, с помощью пакета SDK для Cosmos. 
