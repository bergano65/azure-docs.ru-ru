...
Помимо стандартного (ручного) или программного способа подготовки пропускной способности, можно также настроить контейнеры Cosmos для Azure в подготовленной пропускной способности автомасштабирования. Автоматическое масштабирование автоматически и мгновенно масштабируется в соответствии с потребностями в рамках указанных диапазонов единиц запросов, не нарушая соглашения об уровне обслуживания. Дополнительные сведения см. в статье [Создание контейнеров и баз данных Azure Cosmos в автомасштабировании](provision-throughput-autoscale.md) .
