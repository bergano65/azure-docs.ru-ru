...
- Формат **простого** маркера сеанса используется пакетом SDK для .NET v1 (Microsoft. Azure. DocumentDB-Version 1. x).
- Формат токена **векторного** сеанса используется пакетом SDK для .NET версии 2 (Microsoft. Azure. DocumentDB-Version 2. x).
