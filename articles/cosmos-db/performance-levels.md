...
|Максимальный объем хранилища|Без ограничений|20 ГБ|20 ГБ|20 ГБ|20 ГБ|
...
Независимо от наличия коллекции с уровнем производительности S1, S2 или S3 или с одной коллекцией секций, для которой доступно 20 ГБ хранилища, можно использовать средство переноса данных Azure Cosmos DB для переноса данных в секционированную коллекцию практически неограниченное хранилище. Сведения о преимуществах секционированной коллекции см. в статье [Секционирование, ключи секции и масштабирование в Azure Cosmos DB](sql-api-partition-data.md). 
