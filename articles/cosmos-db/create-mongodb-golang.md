...
ms.locfileid: "53791614"
---
# <a name="build-a-console-app-using-azure-cosmos-dbs-api-for-mongodb-and-golang-sdk"></a>Создание консольного приложения с помощью API для MongoDB (Azure Cosmos DB) и пакета SDK Golang
