---
title: Вопросы и ответы об API таблиц в Azure Cosmos DB
description: Получите ответы на часто задаваемые вопросы об API таблиц в Azure Cosmos DB
author: SnehaGunda
...
ms.locfileid: "93341245"
---
# <a name="frequently-asked-questions-about-the-table-api-in-azure-cosmos-db"></a>Вопросы и ответы об API таблиц в Azure Cosmos DB
[!INCLUDE[appliesto-table-api](includes/appliesto-table-api.md)]

API-интерфейс таблиц службы Azure Cosmos DB доступен на [портале Azure](https://portal.azure.com). Во-первых, вам нужно зарегистрироваться для получения подписки Azure. После этого вы сможете добавить учетную запись API таблиц Azure Cosmos DB в подписку Azure, а затем добавить таблицы в свою учетную запись. Поддерживаемые языки и связанные способы быстрого начала работы можно найти в статье [Знакомство со службой Azure Cosmos DB. API таблицы](table-introduction.md).

## <a name="table-api-in-azure-cosmos-db-vs-azure-table-storage"></a><a id="table-api-vs-table-storage"></a>Сравнение API таблиц Azure Cosmos DB и хранилища таблиц Azure
...
* Идентификатор имени свойства сущности в настоящее время не поддерживается.
...
* С точки зрения API REST существует ряд конечных точек и параметров запросов, которые не поддерживаются API таблиц базы данных Azure Cosmos DB.
  ...
  | OPTIONS | `/<table-resource-name>` | [Preflight Table Request](/rest/api/storageservices/preflight-table-request) (Предварительные запросы таблиц) | Этот метод является частью CORS и сейчас не поддерживается в Azure Cosmos DB. |
...
Вы можете использовать [обозреватель хранилищ Azure](../vs-azure-tools-storage-manage-with-storage-explorer.md).
...
[AzCopy](../storage/common/storage-use-azcopy-v10.md) и [средство миграции данных DB Cosmos Azure](import-data.md) поддерживаются.
...
* [Страница "Часто задаваемые вопросы" на сайте Майкрософт](/answers/topics/azure-cosmos-db.html)
...
* [Создание приложения, использующего API таблиц, с помощью пакета SDK .NET и Azure Cosmos DB](create-table-dotnet.md)
