...
* Если вы хотите узнать больше о клиентах, использующих Azure Cosmos DB, смотрите страницу [тематических исследований клиента.](https://azure.microsoft.com/case-studies/?service=cosmos-db)
