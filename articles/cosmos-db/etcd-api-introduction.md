...
:::image type="content" source="./media/etcd-api-introduction/etcd-api-wire-protocol.png" alt-text="Реализация протокола проводной сети etcd в Azure Cosmos DB" border="false":::
