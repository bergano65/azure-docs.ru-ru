...
В приведенных ниже примерах показано, как создать все вспомогательные ресурсы, необходимые для подготовки ресурса уровня контейнера в Azure Cosmos DB.
