...
1. На странице **создания учетной записи Azure Cosmos DB** введите основные параметры для новой учетной записи Azure Cosmos. 
    ...
    |Режим емкости|"Подготовленная пропускная способность" или "Бессерверный"|Выберите **Подготовленная пропускная способность**, чтобы создать учетную запись в режиме [подготовленной пропускной способности](set-throughput.md). Выберите **Бессерверный**, чтобы создать учетную запись в режиме [Бессерверный](serverless.md).|
