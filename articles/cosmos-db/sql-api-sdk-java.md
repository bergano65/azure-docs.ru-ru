...
> [!WARNING]
> Поддержка всех версий **1. x** пакета SDK SQL для Java будет прекращена **30 мая 2020 г.** . Поддержка всех версий пакета SDK SQL для Java версии ниже **1.0.0** была прекращена **29 февраля 2016 года**.
> 
> 
