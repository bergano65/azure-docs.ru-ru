...
|**Руководство по веб-приложениям**|[Разработка веб-приложений с помощью Azure Cosmos DB](sql-api-java-application.md)|
...
* Исправляет ошибку времени ожидания пула соединений.
* Исправляет обновление токена проверки подлинности при внутренних повторных попытках.
...
* Исправлена ошибка, чтобы гарантировать, что Куеритератор не возвращает значения NULL.
...
* Исправлена ошибка, при которой запрос в режиме DirectHttps может перестать отвечать на запросы при возникновении сбоев регулирования.
...
* Проверяет свойство идентификатора для всех ресурсов. Идентификаторы ресурсов не могут содержать знаки ?, /, #, \, или заканчиваться пробелом.
...
> [!WARNING]
> Все версии **1. x** пакета SDK SQL для Java будут сняты с **30 мая 2020 г**.
> 
>
