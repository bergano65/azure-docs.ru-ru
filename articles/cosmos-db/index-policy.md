...
> [!NOTE]
> Метод обновления политики индексации, описанные в этой статье относится только к SQL Azure Cosmos DB (Core) API.
...
- Системное свойство «etag» исключен из индексирования по умолчанию, если etag добавляется включенного пути для индексирования.
