...
## <a id="include-exclude-paths"></a>Включение и исключение путей к свойствам
...
- Системное свойство "_etag" исключено из индексирования по умолчанию, если ETag не добавляется в включаемый путь для индексирования.
