...
Кроме того, необходимо задать **значение true**для свойства **Автоматическое** в политике индексирования. Присвоение этому свойству значения true позволяет Azure Cosmos DB автоматически индексировать документы по мере их написания.
