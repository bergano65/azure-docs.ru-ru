...
- При создании составного индекса для оптимизации запросов с несколькими фильтрами `ORDER` составной индекс не будет оказывать влияния на результаты. Это свойство необязательно.
