...
:::image type="content" source="./media/table-import/cosmos-connection-string.png" alt-text="Снимок экрана: выбраны элементы &quot;Учетные записи хранения&quot; > &quot;Учетная запись&quot; > &quot;Ключи доступа&quot; и выделена кнопка &quot;Копировать&quot;.":::
