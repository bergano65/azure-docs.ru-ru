...
:::image type="content" source="./media/online-backup-and-restore/backup-support-request-portal.png" alt-text="Создание запроса на резервное копирование в службу поддержки с помощью портала Azure":::
...
2 резервные копии предоставляются бесплатно. Дополнительные резервные копии начисляются в соответствии с ценами на основе региона для хранилища резервных копий, описанных в разделе [цены на хранилище резервных копий](https://azure.microsoft.com/en-us/pricing/details/cosmos-db/). Например, если срок хранения резервных копий настроен на 240 часов, т. е. 10 дней, а интервал резервного копирования — 24 часа. Это подразумевает 10 копий данных резервных копий. Предполагая, что 1 ТБ данных в Западная часть США 2, для хранилища резервных копий в определенном месяце будет 1000 * 0,12 ~ $120. 
