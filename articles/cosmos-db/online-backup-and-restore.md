...
Основная цель восстановления данных — восстановить случайно удаленные или измененные данные. Поэтому мы рекомендуем сначала проверить содержимое восстановленных данных. Затем перенесите данные обратно в основную учетную запись. Хотя вы можете использовать восстановленную учетную запись в качестве учетной записи Live, это не рекомендуется делать при наличии производственных рабочих нагрузок.  
