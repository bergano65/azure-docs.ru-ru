...
Ниже показано, как контейнер Azure Cosmos со всеми тремя основными разделами ресурсов в регионе "Западная часть США" копируется в удаленную учетную запись хранилища BLOB-объектов Azure в регионе "Западная часть США", а затем реплицируется в регион "Восточная часть США".
