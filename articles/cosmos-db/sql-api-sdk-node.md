---
title: 'Azure Cosmos DB: API SQL Node. js, & ресурсы пакета SDK'
...
* Переключить _ts тип с строки на число (#252) (#295)
...
* Переключить _ts тип из строки в число
...
* Добавлен параметр для отключения проверки TLS при работе с эмулятором Azure Cosmos DB.
...
* Отключение проверки TLS при использовании пакета SDK для ориентации на эмулятор (hostname = localhost).
...
* Проверка свойств идентификатора для всех ресурсов. Идентификаторы ресурсов не могут содержать знаки?,/, #,  &#47;&#47;, символы или заканчиваться пробелом.
