...
|Документация по API  |  [Справочная документация по пакету SDK для JavaScript](/javascript/api/%40azure/cosmos/?preserve-view=true&view=azure-node-latest)
