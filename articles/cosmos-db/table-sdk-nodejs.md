---
title: API таблиц Azure Cosmos DB на Node.js | Документация Майкрософт
...
|**Документация по API**|[Справочная документация по API Node.js](http://azure.github.io/azure-storage-node/)|
