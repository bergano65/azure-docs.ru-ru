---
title: API таблиц Azure Cosmos DB для Node.js
...
|   |   |
|---|---|
|**Загрузка SDK**|[NPM](https://www.npmjs.com/package/azure-storage)|
|**Документация API**|[Справочная документация по API Node.js](https://azure.github.io/azure-storage-node/)|
