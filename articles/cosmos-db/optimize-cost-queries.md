---
title: Оптимизируйте затраты и единицы запросов в секунду, чтобы выполнять запросы в Azure Cosmos DB
...
Операции чтения в Azure Cosmos DB, как правило, упорядочиваются от самых быстрых и более эффективных к медленным и менее эффективным с точки зрения пропускной способности следующим образом:  
...
Так как уточняющие запросы "ключ — значение" для идентификатора элемента являются наиболее эффективным видом чтения, следует убедиться, что идентификатор элемента имеет осмысленное значение.
