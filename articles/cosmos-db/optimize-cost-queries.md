...
Количество единиц запроса, расходуемых на запрос, зависит от нескольких факторов. Например количество элементов Azure Cosmos загружен или возвращаемых, количество операций поиска с индексом, компиляции запроса время сведения и т. д. Azure Cosmos DB гарантирует, что один и тот же запрос к одним и тем же данным всегда будет иметь одинаковую стоимость в единицах запроса. Профиль запроса, полученный по метрикам выполнения запроса, дает хорошее представление о затратах единиц запроса.  
