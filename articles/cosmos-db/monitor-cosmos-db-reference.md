...
Azure Cosmos DB использует таблицы Kusto из журналов Azure Monitor. Эти таблицы можно запрашивать с помощью log Analytics. Список используемых Kusto зажимы см. в статье Справочник по [таблицам журналов Azure Monitor](/azure-monitor/reference/tables/tables-resourcetype#azure-cosmos-db) .
