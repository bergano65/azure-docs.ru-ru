...
|**Заканчивающ**|Доступное значение: **Null**|  
...
|**Объектами**|Неупорядоченный набор из нуля или более пар "имя — значение". Имя является строкой Юникода. Значение может иметь любой скалярный тип данных (за исключением типа **Неопределенное**).|  
...
##  <a name="arguments"></a><a name="bk_arguments"></a>Даваемых
