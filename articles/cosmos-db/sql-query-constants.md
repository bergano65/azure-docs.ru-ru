---
title: Константы в Azure Cosmos DB
description: Узнайте о том, как константы запросов S'L в Azure Cosmos DB используются для представления определенного значения данных
author: timsander1
...
---
# <a name="azure-cosmos-db-sql-query-constants"></a>Константы запроса Azure Cosmos DB S'L  
...
|**Логических**|Доступные значения: **false**, **true**|  
...
|**Массив**|Последовательность из нуля или более элементов. Каждый элемент может быть значением любого типа данных scalar, за исключением **Undefined**.|  
|**Объекта**|Неупорядоченный набор из нуля или более пар "имя — значение". Имя является строкой Юникода. Значение может иметь любой скалярный тип данных (за исключением типа **Неопределенное**).|  
...
|**escape-последовательность**|**Описание**|**Персонаж Unicode**|  
|-|-|-|  
|\\'|Апостроф (')|U+0027|  
|\\"|Кавычки (")|U+0022|  
