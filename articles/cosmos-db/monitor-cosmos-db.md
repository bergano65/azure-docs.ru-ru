...
Ниже приведен еще один пример для просмотра метрик задержки на стороне сервера для определенной базы данных, контейнера или операции.

![Метрики задержки на стороне сервера](./media/monitor-cosmos-db/serverside-latency-metric.png)
