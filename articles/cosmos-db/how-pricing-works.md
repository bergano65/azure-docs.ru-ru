...
* [Understanding your Azure Cosmos DB bill](understand-your-bill.md) (Расшифровка счета за использование Azure Cosmos DB)
...
* [Optimize storage cost in Azure Cosmos DB](optimize-cost-storage.md) (Оптимизация затрат на хранение в Azure Cosmos DB)
* [Optimize the cost required to read and write data from Azure Cosmos DB](optimize-cost-reads-writes.md) (Оптимизация затрат на чтение и запись данных в Azure Cosmos DB)
* [Optimize the cost required to run queries in Azure Cosmos DB](optimize-cost-queries.md) (Оптимизация затрат, необходимых на выполнение запросов в Azure Cosmos DB)
...
* [Предоплата ресурсов Azure Cosmos DB с резервной мощностью](cosmos-db-reserved-capacity.md)
