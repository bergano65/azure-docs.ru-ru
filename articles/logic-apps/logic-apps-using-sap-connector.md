...
* Убедитесь, что установлена последняя версия, [соединитель SAP (NCo 3,0) для Microsoft .NET 3.0.22.0, скомпилированный с .NET Framework 4,0-Windows 64-bit (x64)](https://support.sap.com/en/product/connectors/msnet.html). Более ранние версии могут привести к проблемам совместимости. Дополнительные сведения см. в разделе [версии клиентской библиотеки SAP](#sap-library-versions).
