...
> [!IMPORTANT]
> Более ранние соединители сервера приложений SAP и сервера сообщений SAP устарели 29 февраля 2020. Текущий соединитель SAP объединяет эти предыдущие соединители SAP, чтобы не менять тип подключения, полностью совместимый с предыдущими соединителями, предоставляет множество дополнительных возможностей и по-прежнему использует библиотеку соединителей SAP .NET ( SAP NCo).
>
