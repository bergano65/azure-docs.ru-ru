...
1. Теперь сохраните приложение логики, чтобы можно было создать URL-адрес конечной точки для приложения логики. На панели инструментов конструктора нажмите кнопку **сохранить**.
...
* Только один вызов или сообщение Send to SAP работает с Трфк. Шаблон фиксации BAPI, такой как выполнение нескольких вызовов Трфк в одном сеансе, не поддерживается.
...
Технические сведения о триггерах, действиях и ограничениях, которые описаны в описании OpenAPI (ранее — Swagger) соединителя, см. на [странице справочника](/connectors/sap/)по соединителю.
