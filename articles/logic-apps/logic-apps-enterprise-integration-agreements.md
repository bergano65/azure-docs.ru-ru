...
1. В разделе **Соглашения** щелкните **Добавить**. В **добавить** области, указав сведения о соответствии с соглашением, например:
   ...
   |----------|----------|-------|-------------|
   | **Имя** | Yes | <*Название соглашения*> | Имя соглашения в соответствующем поле |
   | **Тип соглашения** | Yes | **AS2**, **X12**, или **EDIFACT** | Тип протокола, соглашения в соответствующем поле. При создании файла соглашения, содержимое этого файла должно соответствовать типу соглашения. | |  
   | **Главный партнер** | Yes | <*Имя узла партнера*> | Главный партнер представляет организацию, которая указывает соглашение |
   | **Главный идентификатор** | Yes | <*Идентификатор узла партнера*> | Идентификатор главного партнера |
   | **Гостевой партнер** | Yes | <*Имя партнера гостя*> | Гостевой партнер представляет организацию, у которой есть деловые отношения с главным партнером. |
   | **Гостевой идентификатор** | Yes | <*гостевой партнер идентификаторов*> | Идентификатор гостевого партнера |
