---
title: Создание веб-API & интерфейсов API RESTFUL для Azure Logic Apps
...
Хотя Azure Logic Apps предлагает [сотни соединителей](../connectors/apis-list.md) , которые можно использовать в рабочих процессах приложения логики, можно вызывать интерфейсы API, системы и службы, которые недоступны в качестве соединителей. Вы можете создавать собственные API с действиями и триггерами для использования в приложениях логики. Ниже приведены другие причины создания собственных интерфейсов API, которые можно вызывать из рабочих процессов приложения логики.
...
Вы также можете предложить зарегистрированные соединители для сертификации Майкрософт. Этот процесс подтверждает, что зарегистрированные соединители соответствуют критериям общедоступного использования и делают эти соединители доступными для пользователей в Power автоматизиру и Microsoft Power Apps.
...
Чтобы сделать пользовательские API доступными для всех пользователей в Logic Apps, автоматизации Powering и Microsoft Power Apps, необходимо добавить безопасность, зарегистрировать API в качестве соединителей приложения логики и назначить соединители для [программы, Microsoft Azure сертификации](https://azure.microsoft.com/marketplace/programs/certified/logic-apps/). 

## <a name="get-support"></a>Получение поддержки

* Для получения справки по пользовательским интерфейсам [customapishelp@microsoft.com](mailto:customapishelp@microsoft.com)API обратитесь к.
