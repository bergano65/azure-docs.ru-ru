...
|---------|------|-------------|
| верхние колонтитулы | Объект JSON | Заголовки из ответа |
...
<table><thead><tr><th>ИДЕНТИФИКАТОР</th><th>Product_Name</th></tr></thead><tbody><tr><td>0</td><td>Яблоки</td></tr><tr><td>1</td><td>Апельсины</td></tr></tbody></table>
...
| Значение | Тип | Описание | 
|-------|------|-------------| 
| <*expression-object-or-token*> | Возможны разные варианты | Выражение, объект JSON или маркер безопасности для оценки | 
...
| <*matching-value*> | Возможны разные варианты | Значение для сравнения с результатом вычисления | 
|||| 
