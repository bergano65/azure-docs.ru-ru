...
|--------------|-------------| 
| [**НТТР**](#http-trigger) | Проверяет или *опрашивает* любую конечную точку. Эта конечная точка должна соответствовать определенному контракту триггера либо с помощью `202` асинхронной модели, либо путем возвращения массива. | 
...
| [**НТТР**](#http-action) | Вызывает конечную точку HTTP. | 
