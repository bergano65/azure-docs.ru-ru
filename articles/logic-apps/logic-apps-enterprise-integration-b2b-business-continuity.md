---
title: Восстановление после стихийных бедствий для интеграционных счетов
description: Настройка учетных записей интеграции и B2B-артефактов с помощью перекрестного восстановления последствий в регионах в приложениях логики Azure
services: logic-apps
...
---
# <a name="set-up-cross-region-disaster-recovery-for-integration-accounts-in-azure-logic-apps"></a>Настройка межрегионального восстановления аварийных данных для учетных записей интеграции в приложениях логики Azure
...
5. Выберите **новый шаг** > **Добавить действие**.
...
7. Чтобы подключить действие к учетной записи интеграции вторичной области, выберите **подключение** > Change**Добавлено новое соединение** для списка доступных учетных записей интеграции. Введите имя для подключения, выберите из списка свою *учетную запись интеграции для дополнительного региона*, а затем выберите **Создать**. 
...
6. Выберите **новый шаг** > **Добавить действие**.    
...
8. Чтобы подключить действие к учетной записи интеграции вторичной области, выберите **подключение** > Change**Добавлено новое соединение** для списка доступных учетных записей интеграции. Введите имя для подключения, выберите из списка свою *учетную запись интеграции для дополнительного региона*, а затем выберите **Создать**.
...
7. Чтобы подключить действие к учетной записи вторичной интеграции, выберите **подключение** > Change**Добавлено новое соединение** для списка доступных учетных записей интеграции. Введите имя для подключения, выберите из списка свою *учетную запись интеграции для дополнительного региона*, а затем выберите **Создать**.
