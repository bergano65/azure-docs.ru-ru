...
Чтобы выполнить действие для каждого действия в области с **неудачным** результатом, а также для фильтрации массива результатов по невыполненным действиям, можно связать выражение `@result()` с действием [**Фильтровать массив**](../connectors/connectors-native-query.md) и цикл [**по каждому**](../logic-apps/logic-apps-control-flow-loops.md) элементу. Можно настроить выполнение действия для каждой ошибки в отфильтрованном массиве результатов, используя цикл **Foreach**.
