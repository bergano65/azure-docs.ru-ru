---
title: Пакетная обработка сообщений EDI как группы Azure Logic Apps
description: Отправка и получение сообщений EDI как пакетов, групп или коллекций в Azure Logic Apps
services: logic-apps
