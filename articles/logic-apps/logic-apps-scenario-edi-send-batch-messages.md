...
5. Теперь добавьте действие, которое кодирует каждый пакет: 
   ...
   2. В поле поиска введите "X12 Batch" в качестве фильтра и выберите это действие (любая версия): **Пакетная кодировка <*версия*>-X12** 
...
2. В поле поиска введите "HTTP" в качестве фильтра. Выбор действия **HTTP — HTTPS**
