...
5. Теперь добавьте действие, которое кодирует каждый пакет: 
   ...
   2. В поле поиска введите «X 12 пакет» для фильтрации и выберите действие (любая версия): **Пакетная кодировка <*версии*>-X12** 
