...
Цикл for each повторяет одно или несколько действий для каждого элемента массива и работает только с массивами. Вот некоторые рекомендации при использовании цикла for each.
