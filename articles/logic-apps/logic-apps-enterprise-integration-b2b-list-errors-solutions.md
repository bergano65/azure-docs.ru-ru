...
**Действие пользователя**: Недопустимая конфигурация As2-from или As2-to настроена для соглашения. Введите правильные идентификаторы AS2-From (AS2 — от) и AS2-To (AS2 — кому) для сопоставления идентификаторов AS2 в заголовках сообщения AS2 с параметрами соглашения.
...
**Действие пользователя**: получено сообщение AS2, которое не содержит заголовков As2-from или As2-to или оба. Проверьте эти заголовки и исправьте их в соответствии с конфигурацией соглашения.
