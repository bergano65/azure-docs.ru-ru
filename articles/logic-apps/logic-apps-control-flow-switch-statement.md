---
title: Добавление коммутаторов в рабочие процессы
...
1. В этом примере добавьте оператор switch в конце вашего рабочего процесса. После выполнения последнего шага выберите **Новый шаг**.
   ...
   Если вы хотите добавить оператор switch между шагами, наведите указатель мыши на стрелку, где его нужно добавить. Выберите **знак** **+** плюс (), который появляется, а затем выберите **Добавить действие.**
