...
## <a name="manage-logic-app-versions"></a>Управление версиями логических приложений

Вы можете использовать портал Azure для управления версиями ваших логических приложений. Вы можете найти историю версий приложения логики и продвигать предыдущие версии.

<a name="find-version-history"></a>

### <a name="find-and-view-previous-versions"></a>Поиск и просмотр предыдущих версий

1. На портале Azure [найдите логическое приложение,](#find-logic-app)которым вы хотите управлять.

1. В меню приложения логики, под **инструментами разработки,** выберите **версии.**

   ![В меню приложения логики выберите "Версии" в рамках "Инструменты развития"](./media/manage-logic-apps-with-azure-portal/logic-apps-menu-versions.png)

1. Выберите **версию** приложения логики для управления из списка. Для фильтрации списка можно ввести идентификатор **версии** в панели поиска.

1. На странице **версии History** вы увидите детали предыдущей версии в режиме только для чтения. Вы можете выбрать между **режимами «Дизайнер** приложений логики» и режимами **просмотра кода.**

   ![Страница версии истории для приложения логики с представлением кода и представлением дизайнера приложений Logic](./media/manage-logic-apps-with-azure-portal/history-version.png)

<a name="promote-previous-versions"></a>

### <a name="promote-previous-versions"></a>Продвижение предыдущих версий

1. В истории версии приложения логики [найдите и выберите версию, которую вы хотите продвигать.](#find-version-history)

1. На странице **версии Истории** выберите **Promote**.

   ![Продвигайте кнопку в истории версий приложения логики](./media/manage-logic-apps-with-azure-portal/promote-button.png)

1. На странице **Дизайнер приложений логики,** которая открывается, отодвинете версию, которую вы продвигаете по мере необходимости. Вы можете переключаться между режимами **просмотра кода** и **кода.** Вы также можете обновить **параметры,** **шаблоны**и **соединительные соединения.**

   ![Страница дизайнера логических приложений для продвижения предыдущей версии](./media/manage-logic-apps-with-azure-portal/promote-page.png)

1. Чтобы сохранить все обновления и отделочные работы над предыдущей версией, выберите **Сохранить**. (Или, чтобы отменить изменения, выберите **Отбросить**.) 

   При [повторном просмотре истории версии приложения логики](#find-version-history) продвигаемый вариант появляется в верхней части списка и имеет новый идентификатор.
