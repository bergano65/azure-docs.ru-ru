...
* **Бесплатный**: Если вы хотите испытать произвольные сценарии, а не рабочие сценарии. Этот уровень доступен только для общедоступных регионов в Azure, например Западная часть США или Юго-Восточная Азия, но не для [Azure Китая (21vianet](https://docs.microsoft.com/azure/china/overview-operations) ) или [Azure для государственных организаций](../azure-government/documentation-government-welcome.md).
