...
* [Стандартные](../connectors/apis-list.md#managed-connectors) соединители и соединители [предприятия](../connectors/apis-list.md#enterprise-connectors) (столько корпоративных подключений, сколько требуется)

   Стандартные и корпоративные соединители, отображающие метку **ISE** , выполняются в той же интегрированной среде сценариев, что и приложения логики. Соединители, не отображающие метку ISE, выполняются в глобальной службе Logic Apps. Фиксированные месячные цены также применяются к соединителям, которые выполняются в глобальной службе при их использовании с приложениями логики, выполняемыми в интегрированной среде сценариев.
