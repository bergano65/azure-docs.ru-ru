...
Узнайте больше о том, как работает выставление счетов на уровнях [триггеров](#triggers) и [действий](#actions) . Дополнительные сведения об ограничениях см. в разделе [ограничения и настройка для Azure Logic Apps](logic-apps-limits-and-config.md).
...
* **Разработчик** ISE: этот SKU не поддерживает масштабирование, без соглашения об уровне обслуживания (SLA) и без опубликованных ограничений. Используйте этот номер SKU только для экспериментов, разработки и тестирования, а не для тестирования в рабочей среде и производительности.

Для приложений логики, создаваемых и выполняемых в интегрированной среде сценариев, вы платите за эти возможности с [фиксированной ежемесячной ценой](https://azure.microsoft.com/pricing/details/logic-apps) :
