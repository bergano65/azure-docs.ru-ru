...
ms.locfileid: "70051708"
---
# <a name="manage-mailing-list-requests-with-azure-logic-apps"></a>Управление запросами для списка рассылки с помощью Azure Logic Apps
...
1. В конструкторе в поле поиска введите "когда приходит электронное письмо". Выберите триггер для своего поставщика услуг электронной почты: **<*ваш поставщик услуг электронной почты*> — Когда приходит новое электронное письмо**.
   ...
   ![Выберите триггер для поставщика электронной почты: "Когда приходит новое электронное письмо"](./media/tutorial-process-mailing-list-subscriptions-workflow/add-trigger-new-email.png)
...
Выполните поиск по слову mailchimp и выберите следующее действие: **MailChimp — добавление участника в список**
...
4. Укажите сведения для этого действия, как показано и описано здесь:
   ...
   | **Состояние** | subscribed | Состояние подписки нового участника. Дополнительные сведения см. в руководстве разработчика об [управлении подписчиками с помощью API MailChimp](https://developer.mailchimp.com/documentation/mailchimp/guides/manage-subscribers-with-the-mailchimp-api/). | 
...
4. Укажите сведения для этого действия, как показано и описано ниже.
   ...
   | **Тема** | <*тема сообщения об успешном выполнении операции*> | Тема сообщения об успешном выполнении операции. В рамках примеров в этом руководстве введите текст ниже и в списке параметров или динамического содержимого выберите указанное поле в действии **Добавить участника в список**: <p>"Поздравляем! Участник добавлен в список test-members-ML: **Адрес электронной почты** | 
   | **Текст** | <*текст сообщения почты об успешном выполнении операции*> | Содержимое сообщения электронной почты об успешном выполнении операции. В рамках примеров в этом руководстве введите текст ниже и в списке параметров или списке с динамическим содержимым выберите указанное поле в действии **Добавить участника в список**:  <p>Новый участник добавлен в список test-members-ML: **Адрес электронной почты**</br>Состояние участия пользователя: **Состояние** | 
   | | | | 
