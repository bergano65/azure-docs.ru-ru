...
Чтобы получать оповещения на основе конкретных метрик или превышения пороговых значений для приложения логики, настройте [оповещения в Azure Monitor](../azure-monitor/alerts/alerts-overview.md). Узнайте подробнее о [метриках в Azure](../azure-monitor/data-platform.md). Чтобы настроить оповещения без использования [Azure Monitor](../azure-monitor/logs/log-query-overview.md), выполните следующие действия.
