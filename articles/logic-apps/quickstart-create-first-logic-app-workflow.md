...
1. После развертывания приложения в Azure открывается конструктор Logic Apps и отображается страница с вводным видео и часто используемыми триггерами. В разделе **Шаблоны** выберите **Пустое приложение логики**.
...
1. В действии **Send an email** (Отправить сообщение электронной почты) укажите данные, которые нужно добавить в электронное письмо.
   ...
   1. В поле **Тело** введите текст и выберите необходимые маркеры для тела сообщения электронной почты. 
