...
1. Выберите в меню ресурса **управление доступом (IAM)** . На панели инструментов выберите **добавить** > **добавить назначение роли**.

   ![Добавление назначения роли](./media/create-managed-service-identity/add-permissions-logic-app.png)
