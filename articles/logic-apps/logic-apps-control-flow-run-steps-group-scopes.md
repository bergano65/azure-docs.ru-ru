...
1. Войдите на <a href="https://portal.azure.com" target="_blank">портал Azure</a>, если вы еще этого не сделали. Создайте пустое приложение логики.
...
1. В ветке **Если истинно** добавьте действие "Отправить сообщение" для поставщика электронной почты. 
   ...
   1. После разрешения выражения добавьте следующий текст в начальный пробел: ``` minutes```
