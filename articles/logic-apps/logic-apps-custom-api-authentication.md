...
| -------- | -------- | ----------- | 
| клиенте | Yes | GUID для арендатора Azure AD. | 
...
| Свойство | обязательные | ОПИСАНИЕ |
| -------- | -------- | ----------- |
| `type` | Yes | Тип проверки подлинности. Для SSL-сертификатов клиента используйте значение `ClientCertificate`. |
...
| Свойство | обязательные | ОПИСАНИЕ | 
| -------- | -------- | ----------- | 
| type | Yes | Тип аутентификации, который будет использоваться. Для обычной проверки подлинности используйте значение `Basic`. | 
