...
2. В главном меню Azure выберите **Все службы**. 
   Введите в поле поиска "интеграция" и выберите **Учетные записи интеграции**.  
...
Настройте эти свойства в соответствии с вашим соглашением с партнером, с которым вы будете обмениваться сообщениями. Ниже приведены таблицы с описанием свойств раздела настроек отправки.
    ...
    **Параметры получения** включает следующие разделы: Идентификаторы, подтверждение, схемы, конверты, контрольные номера, проверки и внутренние параметры.
...
Настройте эти свойства в соответствии с вашим соглашением с партнером, с которым вы будете обмениваться сообщениями. Ниже приведены таблицы с описанием свойств раздела настроек отправки.
    ...
    **Параметры отправки** включает следующие разделы: Идентификаторы, подтверждение, схемы, конверты, кодировки и разделители, контрольных номеров и проверки.
