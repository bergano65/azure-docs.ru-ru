---
title: Учебник по автоматизации обработки электронных писем и вложений с помощью Azure Logic Apps | Документация Майкрософт
...
1. Прежде чем создать контейнер хранилища, [создайте учетную запись хранения](../storage/common/storage-quickstart-create-account.md), указав приведенные параметры на вкладке **Основы** на портале Azure.
   ...
   | **Имя учетной записи хранения** | attachmentstorageacct | Имя вашей учетной записи |
