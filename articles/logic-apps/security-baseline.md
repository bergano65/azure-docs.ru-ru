...
* [Список определений политик Azure для Logic Apps](./policy-samples.md)
...
* [Включение обратимого удаления и очистки защиты в Key Vault](../storage/blobs/soft-delete-overview.md?tabs=azure-portal)
