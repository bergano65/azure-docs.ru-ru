...
- [Список определений политик Azure для Logic Apps](/azure/logic-apps/policy-samples)
...
- [Как собираются и анализируйте журналы действий Azure в Log Analytics в Azure Monitor](/azure/azure-monitor/platform/activity-log-collect)
...
- [Как защитить доступ к Logic Apps через RBAC](logic-apps-securing-a-logic-app.md#access-to-logic-app-operations)
