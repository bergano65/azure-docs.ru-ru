...
description: Базовый план безопасности Azure для Logic Apps
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 06/22/2020
...
* [Общие сведения о соединителях для Logic Apps](https://docs.microsoft.com/azure/connectors/apis-list)

* [Общие сведения о тегах служб в Azure](https://docs.microsoft.com/azure/virtual-network/service-tags-overview)

* [Общие сведения о доступе к ресурсам виртуальной сети Azure из Azure Logic Apps с помощью сред службы интеграции (Исес)](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview)
...
* [Общие сведения о доступе к конечной точке ISE](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview#ise-endpoint-access)
...
* [Как включить доступ для интегрированной среды сценариев](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment#enable-access-for-ise)
...
* [Как защитить входящие вызовы на Logic Apps](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-request-based-triggers)

* [Ограничение входящих IP-адресов](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#restrict-inbound-ip-addresses)
...
* [Как понять журналы WAF Access](https://docs.microsoft.com/azure/web-application-firewall/ag/web-application-firewall-logs#access-log)
...
* [Список определений политик Azure для Logic Apps](https://docs.microsoft.com/azure/logic-apps/policy-samples)
...
* [Настройка журналов Azure Monitor и получение диагностических данных для Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/monitor-logic-apps-log-analytics)
...
* [Мониторинг состояния выполнения, Просмотр журнала триггеров и Настройка оповещений для Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/monitor-logic-apps)
...
* [Как собираются и анализируйте журналы действий Azure в Log Analytics в Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/platform/activity-log-collect)
...
* [Проверка подлинности и получение доступа к ресурсам Azure с помощью управляемых удостоверений в Azure Logic Apps.](https://docs.microsoft.com/azure/logic-apps/create-managed-service-identity)
...
* [Защита доступа и данных в Azure Logic Apps с помощью SAS](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-request-based-triggers)
...
* [Защита данных и доступ к ним в Logic Apps](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app)

* [Как задать и получить секрет из Azure Key Vault](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal)
...
* [Сведения об API триггеров рабочих процессов](https://docs.microsoft.com/rest/api/logic/workflowtriggers)

* [Общие сведения о конфигурации соединителя](https://docs.microsoft.com/azure/connectors/apis-list])
...
* [Узнайте, как ограничить входящие IP-адреса в Logic Apps](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#restrict-inbound-ip-addresses)
...
* [Доступ к ресурсам виртуальных сетей Azure из Azure Logic Apps с использованием сред службы интеграции (ISE)](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview)
...
* [Безопасный доступ и данные в Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app)

* [Получение входящих HTTP-запросов и ответ на них в Azure Logic Apps](https://docs.microsoft.com/azure/connectors/connectors-native-reqres#tls-support)

* [Вызов конечных точек службы по HTTP или HTTPS из Azure Logic Apps](https://docs.microsoft.com/azure/connectors/connectors-native-http#tls-support)
...
* [Общие сведения о шифровании данных — неактивных с помощью Azure](https://docs.microsoft.com/azure/security/fundamentals/encryption-atrest)

* [Настройка ключей, управляемых клиентом, для шифрования неактивных данных в средах службы интеграции (Исес) в Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/customer-managed-keys-integration-service-environment)
...
* [Безопасный доступ для выполнения данных журнала](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-run-history-data)
...
**Руководство**. Вы можете разрешив отдельным пользователям или группам выполнять определенные задачи, такие как управление, редактирование и просмотр приложений логики. Чтобы управлять их разрешениями, используйте управление доступом на основе ролей Azure (RBAC), чтобы можно было назначить настраиваемые или встроенные роли членам подписки Azure.
...
* [Безопасный доступ к операциям Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-logic-app-operations)
...
* [Шифрование неактивных данных для сред службы интеграции в Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/customer-managed-keys-integration-service-environment)
...
* [Список всех соединителей Logic Apps](https://docs.microsoft.com/connectors/connector-reference/connector-reference-logicapps-connectors)

* [Общие сведения о проблемах и ограничениях для соединителей Gmail](https://docs.microsoft.com/connectors/gmail/#known-issues-and-limitations)

* [Дополнительные сведения о политике конфиденциальности Google](https://docs.microsoft.com/azure/connectors/connectors-google-data-security-privacy-policy)
...
Logic Apps, необходимые для бизнес-операций, но которые могут повлечь за собой более высокий риск для Организации, должны быть изолированы по мере возможности через отдельные группы ресурсов с конкретными разрешениями и границами RBAC.
...
* [Как защитить доступ к Logic Apps через RBAC](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-logic-app-operations)
...
* [Блокировать подключения, созданные соединителями, в Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/block-connections-connectors)
...
* [Развертывание шаблонов Azure Resource Manager для Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/logic-apps-deploy-azure-resource-manager-templates)

* [Общие сведения о параметрах безопасного действия](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#secure-action-parameters)

* [Рекомендации по безопасности параметров](https://docs.microsoft.com/azure/azure-resource-manager/templates/template-best-practices#security-recommendations-for-parameters)
...
* [Безопасный доступ к входным и выходным данным журнала выполнения](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#obfuscate)

* [Безопасный доступ к входным параметрам](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#secure-action-parameters)
...
* [Защита входных и выходных данных в журнале выполнения в Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#obfuscate)

* [Рекомендации по безопасности параметров](https://docs.microsoft.com/azure/azure-resource-manager/templates/template-best-practices#security-recommendations-for-parameters)

* [Безопасный доступ к входным параметрам в Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-parameter-inputs)

* [Передача безопасных значений параметров во время развертывания с помощью Azure Key Vault](https://docs.microsoft.com/azure/azure-resource-manager/templates/key-vault-parameter)
...
* [Проверка подлинности доступа к ресурсам Azure с помощью управляемых удостоверений в Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/create-managed-service-identity)
...
* [Сведения об антивредоносном по Майкрософт для облачных служб и виртуальных машин Azure](https://docs.microsoft.com/azure/security/fundamentals/antimalware)
...
* [Дополнительные сведения о непрерывности бизнес-процессов и аварийном восстановлении для Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/business-continuity-disaster-recovery-guidance)

* [Автоматизация развертывания для Azure Logic Apps с помощью шаблонов Azure Resource Manager](https://docs.microsoft.com/azure/logic-apps/logic-apps-azure-resource-manager-templates-overview)
