...
Для управления трафиком между подсетями виртуальной сети, где развертывается вашей интегрированной среды Сценариев, можно при необходимости настроить [группы безопасности сети (Nsg)](../virtual-network/security-overview.md) в виртуальной сети путем [фильтрации сетевого трафика между подсетями](../virtual-network/tutorial-filter-network-traffic.md). Если выбран этот маршрут, убедитесь, что вашей интегрированной среды Сценариев открывается определенные порты, как описано в следующей таблице, в виртуальной сети, которая использует группы безопасности сети. При наличии существующих групп безопасности сети и брандмауэры в вашей виртуальной сети, убедитесь, что они откройте эти порты. Таким образом, в интегрированной среде Сценариев остается доступным и могли правильно работать таким образом, чтобы не потерять доступ к вашей интегрированной среды Сценариев. В противном случае если какие-либо необходимые порты недоступны, в интегрированной среде Сценариев перестает работать.
