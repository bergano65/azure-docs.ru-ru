...
1. Укажите эти сведения о переменной, как описано ниже.
   ...
   |----------|----------|-------|--------------|
   | **Name** | Да | <*имя переменной*> | Имя переменной |
...
| Свойство | Обязательно | Значение |  Описание |
|----------|----------|-------|--------------|
| **Name** | Да | <*имя переменной*> | Имя уменьшаемой переменной | 
...
| Свойство | Обязательно | Значение |  Описание |
|----------|----------|-------|--------------|
| **Name** | Да | <*имя переменной*> | Имя изменяемой переменной |
