...
4. Укажите следующие сведения о переменной:
   ...
   |----------|----------|-------|--------------|
   | Name | Yes | <*variable-name*> | Имя переменной | 
...
| Свойство | Обязательно | Значение |  ОПИСАНИЕ |
|----------|----------|-------|--------------|
| Name | Yes | <*variable-name*> | Имя уменьшаемой переменной | 
...
| Свойство | Обязательно | Значение |  ОПИСАНИЕ | 
|----------|----------|-------|--------------| 
| Name | Yes | <*variable-name*> | Имя изменяемой переменной | 
| Value | Yes | <*new-value*> | Значение, которое требуется назначить переменной. Их типы данных должны совпадать. | 
||||| 
...
|----------|----------|-------|--------------| 
| Name | Yes | <*variable-name*> | Имя изменяемой переменной | 
| Value | Yes | <*append-value*> | Значение, которое требуется добавить. Оно может относиться к любому типу. | 
|||||  
