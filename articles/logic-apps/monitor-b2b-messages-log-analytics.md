...
1. В меню рабочей области выберите пункт **Сводка по рабочей области** > **Logic Apps B2B**.
...
| **икн** | Контрольный номер обмена для сообщения X12 |
| **тскн** | Контрольный номер набора транзакций для сообщения X12 |
...
| **икн** | Контрольный номер обмена сообщениями EDIFACT |
| **тскн** | Контрольный номер набора транзакций для сообщения EDIFACT |
