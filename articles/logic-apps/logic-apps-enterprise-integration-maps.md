...
Чтобы передавать XML-данные между форматами сценариев интеграции Enterprise в Azure Logic Apps, приложение логики может использовать карты, а точнее — карты XSLT. Карта — это XML-документ, описывающий преобразование данных из XML-документа в другой формат. 
