...
* Если карта ссылается на внешнюю сборку, необходимо передать *сборку и карту* в учетную запись интеграции. Убедитесь, что [ *сначала передайте сборку*](#add-assembly), а затем отправить карту, которая ссылается на сборку.
...
> [!NOTE]
> Если изменить сборку, необходимо также обновить карту ли карта содержит изменения.
