---
title: Создавайте рабочие процессы приложений логики быстрее, используя заранее построенные шаблоны
description: Быстро создавайте рабочие процессы приложений логики, используя заранее построенные шаблоны, предоставляемые приложениями Azure Logic Apps
services: logic-apps
...
1. Если вы еще не сделали этого, вопийте на [порталAz.](https://portal.azure.com "Портал Azure")

2. Из основного меню Azure выберите создать приложение > **«Логика корпоративной** > **интеграции».** **Create a resource**
...
3. Создайте приложение логики с параметрами в таблице под этим рисунком.
   ...
   | ------- | ----- | ----------- | 
   | **Название** | *имя_вашего_приложения_логики* | Укажите уникальное имя приложения логики. | 
   ...
   | **Аналитика журнала** | **Выкл.** (по умолчанию) или **Вкл.** | Настройка [диагностической регистрации](../logic-apps/monitor-logic-apps-log-analytics.md) для приложения логики с помощью [журналов Azure Monitor.](../log-analytics/log-analytics-overview.md) Требуется наличие рабочей области Log Analytics. | 
   |||| 
...
1. На [портале Azure](https://portal.azure.com "Портал Azure")найдите и откройте логическое приложение в th Logic App Designer.
