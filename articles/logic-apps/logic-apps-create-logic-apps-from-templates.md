---
title: Создание рабочих процессов на основе шаблонов
...
1. Войдите в [портал Azure](https://portal.azure.com "портала Azure"), если вы еще этого не сделали.
...
1. В [портал Azure](https://portal.azure.com "портала Azure")найдите и откройте приложение логики в конструкторе приложений логики.
