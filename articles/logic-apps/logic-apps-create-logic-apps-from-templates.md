...
3. Создайте приложение логики с параметрами в таблице под этим рисунком.
   ...
   | **Служба Log Analytics** | **Выкл.** (по умолчанию) или **Вкл.** | Включите [ведение журнала диагностики](../logic-apps/logic-apps-monitor-your-logic-apps.md#turn-on-diagnostics-logging-for-your-logic-app) для приложения логики с помощью [журналов Azure Monitor](../log-analytics/log-analytics-overview.md). Требуется наличие рабочей области Log Analytics. | 
   |||| 
