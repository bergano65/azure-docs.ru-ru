...
| Возвращаемое значение | Тип | Описание |
| ------------ | -----| ----------- |
| <*выходные_данные_body_действия*> | Тип String | Выходные данные `body` указанного действия |
||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*actionName*> | Да | Тип String | Имя действия для требуемого результата. |
|||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*actionName*> | Да | Тип String | Имя объекта действия, выходные данные которого требуется получить.  |
| <*property*> | нет | Тип String | Имя свойства объекта действия, значение которого требуется: **name**, **startTime**, **endTime**, **inputs**, **outputs**, **status**, **code**, **trackingId** и **clientTrackingId**. На портале Azure вы можете найти эти свойства, просмотрев подробности в конкретном журнале выполнения. Дополнительные сведения см. в статье с [действиями запуска рабочего процесса в REST API](/rest/api/logic/workflowrunactions/get). |
|||||

| Возвращаемое значение | Тип | Описание: |
| ------------ | -----| ----------- |
| <*выходные_данные_действия*> | Тип String | Выходные данные указанного действия или свойства. |
||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*timestamp*> | Да | Тип String | Строка, содержащая метку времени |
...
| <*format*> | нет | Тип String | Либо [один описатель формата](/dotnet/standard/base-types/standard-date-and-time-format-strings), либо [пользовательский шаблон формата](/dotnet/standard/base-types/custom-date-and-time-format-strings). Формат по умолчанию для метки времени — ["o"](/dotnet/standard/base-types/standard-date-and-time-format-strings) (ГГГГ-ММ-ДДTЧЧ:ММ:fffffffK), который соответствует [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) и сохраняет информацию о часовом поясе. |
|||||
...
| --------- | -------- | ---- | ----------- |
| <*object*> | Да | Объект | Объект JSON, в который вы хотите добавить свойство |
| <*parent-property*> | Да | Тип String | Имя родительского свойства, в которое необходимо добавить дочернее свойство |
| <*child-property*> | Да | Тип String | Имя добавляемого дочернего свойства |
...
| <*timeUnit*> | Да | Тип String | Единица измерения времени, используемая с *interval*: Second, Minute, Hour, Day, Week, Month, Year. |
| <*format*> | нет | Тип String | Либо [один описатель формата](/dotnet/standard/base-types/standard-date-and-time-format-strings), либо [пользовательский шаблон формата](/dotnet/standard/base-types/custom-date-and-time-format-strings). Формат по умолчанию для метки времени — ["o"](/dotnet/standard/base-types/standard-date-and-time-format-strings) (ГГГГ-ММ-ДДTЧЧ:ММ:fffffffK), который соответствует [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) и сохраняет информацию о часовом поясе. |
|||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*value*> | Да | Тип String | Строка для создания массива |
|||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*строка_base64*> | Тип String | Версия строки входных данных с кодировкой base64 |
||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*декодированная строка base64*> | Тип String | Строковая версия строки с кодировкой base64 |
||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*текст1текст2...* > | Тип String | Строка, созданная из объединенных входных строк |
||||
...
| --------- | -------- | ---- | ----------- |
| <*timestamp*> | Да | Тип String | Строка, содержащая метку времени |
| <*destinationTimeZone*> | Да | Тип String | Имя целевого часового пояса. Имена часовых поясов см. в разделе [Значения индекса часовых поясов Майкрософт](https://support.microsoft.com/en-us/help/973627/microsoft-time-zone-index-values), но может потребоваться удалить все знаки препинания из имени часового пояса. |
| <*format*> | нет | Тип String | Либо [один описатель формата](/dotnet/standard/base-types/standard-date-and-time-format-strings), либо [пользовательский шаблон формата](/dotnet/standard/base-types/custom-date-and-time-format-strings). Формат по умолчанию для метки времени — ["o"](/dotnet/standard/base-types/standard-date-and-time-format-strings) (ГГГГ-ММ-ДДTЧЧ:ММ:fffffffK), который соответствует [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) и сохраняет информацию о часовом поясе. |
|||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*преобразованная метка времени*> | Тип String | Метка времени, преобразованная в целевой часовой пояс |
||||
...
| --------- | -------- | ---- | ----------- |
| <*timestamp*> | Да | Тип String | Строка, содержащая метку времени |
| <*sourceTimeZone*> | Да | Тип String | Имя исходного часового пояса. Имена часовых поясов см. в разделе [Значения индекса часовых поясов Майкрософт](https://support.microsoft.com/en-us/help/973627/microsoft-time-zone-index-values), но может потребоваться удалить все знаки препинания из имени часового пояса. |
| <*format*> | нет | Тип String | Либо [один описатель формата](/dotnet/standard/base-types/standard-date-and-time-format-strings), либо [пользовательский шаблон формата](/dotnet/standard/base-types/custom-date-and-time-format-strings). Формат по умолчанию для метки времени — ["o"](/dotnet/standard/base-types/standard-date-and-time-format-strings) (ГГГГ-ММ-ДДTЧЧ:ММ:fffffffK), который соответствует [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) и сохраняет информацию о часовом поясе. |
|||||

| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*преобразованная метка времени*> | Тип String | Метка времени, которая преобразуются в формат UTC |
||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*URI данных*> | Тип String | URI данных для входной строки |
||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*день месяца*> | Тип Integer | День месяца из указанной метки времени |
||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*день недели*> | Тип Integer | День недели из указанной метки времени, где воскресенье имеет значение 0, понедельник — 1 и т. д. |
||||
...
| Возвращаемое значение | Тип | Описание |
| ------------ | ---- | ----------- |
| <*декодированный URI*> | Тип String | Обновленная строка с декодированными escape-символами |
||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*value*> | Да | Тип String | Строка для преобразования в формат закодированного URI |
|||||
...
| Возвращаемое значение | Тип | Описание |
| ------------ | ---- | ----------- |
| <*метка времени в другом формате*> | Тип String | Обновленная метка времени в указанном формате |
||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*actionName*> | Да | Тип String | Действие, выходные данные которого содержат требуемое значение ключа |
| <*key*> | Да | Тип String | Имя ключа, значение которого нужно получить |
|||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*значение ключа*> | Тип String | Значение в указанном ключе  |
||||
...
| <*format*> | Да | Тип String | Строка составного формата, указывающая формат, который необходимо использовать. Сведения о поддерживаемых строках числового формата см. в разделе [Стандартные строки числового формата](/dotnet/standard/base-types/standard-numeric-format-strings), которые поддерживаются `number.ToString(<format>, <locale>)`. |
| <*языковой стандарт*> | нет | Тип String | Языковой стандарт, который следует использовать, поддерживаемый `number.ToString(<format>, <locale>)`. Если не задано, по умолчанию используется значение `en-us`. |
|||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*format*> | нет | Тип String | Один [указатель формата](/dotnet/api/system.guid.tostring?view=netcore-3.1#system_guid_tostring_system_string_) для возвращенного идентификатора GUID. По умолчанию имеет формат "D", но можно использовать "N", "D", "B", "P" или "X". |
|||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Строки, которая содержит подстроку для поиска |
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*целочисленный результат*> | Тип Integer | Целочисленная версия указанной строки |
||||
...
| <*delimiter*> | Да | Тип String | Разделитель, содержащийся между каждым символом в результирующей строке |
|||||
...
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Строки, которая содержит подстроку для поиска |
| <*searchText*> | Да | Тип String | Подстрока для поиска |
|||||

| Возвращаемое значение | Тип | Описание |
| ------------ | ---- | ----------- |
| <*конечное значение индекса*> | Тип Integer | Начальная позиция или значение индекса последнего вхождения указанной подстроки. <p>Если строка не найдена, возвращается -1. |
||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*actionName*> | Да | Тип String | Имя действия, которое содержит выходные данные, состоящие из нескольких частей |
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*minValue*> | Да | Тип Integer | Наименьшее целое число в диапазоне |
| <*maxValue*> | Да | Тип Integer | Целое число, следующее за наибольшим целым числом в диапазоне, которое функция может вернуть |
|||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Строка, которая содержит заменяемую подстроку |
| <*oldText*> | Да | Тип String | Заменяемая подстрока |
| <*newText*> | Да | Тип String | Строка для замены |
|||||
...
| <*property*> | Да | Тип String | Имя удаляемого свойства |
|||||
...
| <*parent-property*> | Да | Тип String | Имя родительского свойства, из которого необходимо удалить дочернее свойство |
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Строка для разделения на подстроки в зависимости от указанного разделителя в исходной строке |
| <*delimiter*> | Да | Тип String | Символ в исходной строке для использования в качестве разделителя |
|||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Проверяемая строка |
| <*searchText*> | Да | Тип String | Начальная строка для поиска |
|||||
...
| Возвращаемое значение | Тип | Описание |
| ------------ | ---- | ----------- |
| <*строковое значение*> | Тип String | Версия строки для указанного значения. Если параметр *value* имеет значение null или имеет значение null, это значение возвращается в виде пустого значения String ( `""` ). |
||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Строка, символы которой требуется получить |
...
| --------- | -------- | ---- | ----------- |
| <*timestamp*> | Да | Тип String | Строка, содержащая метку времени |
| <*interval*> | Да | Тип Integer | Число единиц времени для вычитания |
| <*timeUnit*> | Да | Тип String | Единица измерения времени, используемая с *interval*: Second, Minute, Hour, Day, Week, Month, Year. |
| <*format*> | нет | Тип String | Либо [один описатель формата](/dotnet/standard/base-types/standard-date-and-time-format-strings), либо [пользовательский шаблон формата](/dotnet/standard/base-types/custom-date-and-time-format-strings). Формат по умолчанию для метки времени — ["o"](/dotnet/standard/base-types/standard-date-and-time-format-strings) (ГГГГ-ММ-ДДTЧЧ:ММ:fffffffK), который соответствует [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) и сохраняет информацию о часовом поясе. |
|||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*обновленная_метка_времени*> | Тип String | Метка времени, от которой отнято указанное число единиц времени |
||||
...
| <*count*> | Да | Тип Integer | Положительное целое число для количества элементов в начале коллекции, которые требуется получить |
|||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*timestamp*> | Да | Тип String | Строка для метки времени |
|||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Строка, возвращаемая в нижнем регистре |
|||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Строка, возвращаемая в верхнем регистре |
|||||

| Возвращаемое значение | Тип | Описание |
| ------------ | ---- | ----------- |
| <*текст в верхнем регистре*> | Тип String | Исходная строка в верхнем регистре |
||||
...
| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*выходные данные триггера*> | Тип String | Выходные данные из триггера во время выполнения |
||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*text*> | Да | Тип String | Строка, которая содержит начальные и конечные пробелы для удаления |
|||||

| Возвращаемое значение | Тип | Описание: |
| ------------ | ---- | ----------- |
| <*обновленный текст*> | Тип String | Обновленная версия исходной строки без начальных и конечных пробелов |
||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*value*> | Да | Тип String | Преобразуемая строка с закодированным URI |
|||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*uri*> | Да | Тип String | URI, значение `host` которого требуется |
|||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*uri*> | Да | Тип String | URI, значение `path` которого требуется |
|||||

| Возвращаемое значение | Тип | Описание |
| ------------ | ---- | ----------- |
| <*значение пути*> | Тип String | Значение `path` для указанного URI. Если `path` не имеет значения, вернется символ "/". |
||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*uri*> | Да | Тип String | URI, значения `path` и `query` которого требуется извлечь |
|||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*uri*> | Да | Тип String | URI, значение `port` которого требуется |
|||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*uri*> | Да | Тип String | URI, значение `query` которого требуется |
|||||
...
| Параметр | Обязательно | Тип | Описание |
| --------- | -------- | ---- | ----------- |
| <*uri*> | Да | Тип String | URI, значение `scheme` которого требуется |
|||||

| Возвращаемое значение | Тип | Описание |
| ------------ | ---- | ----------- |
| <*значение схемы*> | Тип String | Значение `scheme` для указанного URI. |
||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*variableName*> | Да | Тип String | Имя переменной, значение которой нужно получить |
|||||
...
| Параметр | Обязательно | Тип | Описание: |
| --------- | -------- | ---- | ----------- |
| <*property*> | нет | Тип String | Имя свойства рабочего процесса, значение которого требуется <p>Объект рабочего процесса имеет такие свойства: **name**, **type**, **id**, **location** и **run**. Значение свойства **run** также является объектом, имеющим следующие свойства: **name**, **type** и **id**. |
|||||
