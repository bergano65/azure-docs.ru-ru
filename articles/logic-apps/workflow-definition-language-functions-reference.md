...
| Возвращаемое значение | type | Описание | 
| ------------ | ---- | ----------- | 
| <*index*> | Целое число | Значение индекса для текущей итерации внутри указанного цикл Until | 
|||| 
...
| Параметр | Обязательно для заполнения | type | Описание |
| --------- | -------- | ---- | ----------- |
| <*startIndex*> | Да | Целое число | Целочисленное значение, которое запускается как первый элемент массива |
...
| <*startIndex*> | Да | Целое число | Положительное число, равное или больше 0, который вы хотите использовать в качестве начального значения позицию или индекс |
