...
Чтобы перенести приложение логики или связанные ресурсы в другую подписку Azure, группу ресурсов или регион, можно выполнить различные способы выполнения таких задач, как портал Azure, Azure PowerShell, Azure CLI и REST API. Прежде чем перемещать ресурсы, ознакомьтесь со следующими соображениями. 
...
* При каждом перемещении ресурсов Azure создает новые идентификаторы ресурсов. Убедитесь, что вместо этого вы используете новые идентификаторы, и обновите все сценарии или средства, связанные с перемещенными ресурсами.
