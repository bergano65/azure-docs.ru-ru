  ...
  * [Обозреватель службы хранилища Azure](../vs-azure-tools-storage-manage-with-storage-explorer.md), который можно использовать для управления учетными записями хранения и контейнерами больших двоичных объектов. 
  Чтобы использовать Обозреватель службы хранилища, выберите один из следующих вариантов:
    ...
    * [Скачайте и установите версию Azure Storage Explorer](https://www.storageexplorer.com/) для рабочего стола. 
    ...
    Чтобы узнать больше, [см.](../storage/blobs/storage-quickstart-blobs-storage-explorer.md)
...
Чтобы добавить объемные схемы, отправьте свою схему в контейнер больших двоичных объектов в учетной записи хранения Azure. Ваши шаги для добавления схем отличаются на основе того, имеет ли ваш контейнер с каплями общедоступный доступ к чтению. Итак, во-первых, проверьте, имеет ли ваш контейнер с каплями доступ к общедоступным, следуя следующим шагам: [Установите уровень публичного доступа для контейнера с каплями](../vs-azure-tools-storage-explorer-blobs.md#set-the-public-access-level-for-a-blob-container)
...
1. В контекстном меню контейнера больших двоичных объектов выберите **Set Public Access Level** (Настроить уровень общего доступа).
   ...
   * Если ваш контейнер с blob имеет по крайней мере открытый доступ, выберите **Cancel**и выполните следующие действия позже на этой странице: [Загрузить в контейнеры с открытым доступом](#public-access)

     ![Открытый доступ](media/logic-apps-enterprise-integration-schemas/azure-blob-container-public-access.png)

   * Если контейнер с blob не имеет общедоступного доступа, выберите **Cancel**и выполните следующие действия позже на этой странице: [Загрузить в контейнеры без публичного доступа](#public-access)
