---
title: Отслеживание сообщений B2B с помощью Azure Monitor журналов — Azure Logic Apps | Документация Майкрософт
...
| Direction | Направление сообщения AS2 |
...
| Метка времени | Время обработки сообщения действием AS2 |
|          |             |
...
| Direction | Направление сообщения X12 |
| Идентификатор корреляции | Идентификатор для корреляции всех триггеров и действий в приложении логики |
...
| Метка времени | Время обработки сообщения действием X12 |
|          |             |
...
| Direction | Направление сообщения EDIFACT |
| Идентификатор корреляции | Идентификатор для корреляции всех триггеров и действий в приложении логики |
...
| Метка времени | Время обработки сообщения действием EDIFACT |
|          |               |
