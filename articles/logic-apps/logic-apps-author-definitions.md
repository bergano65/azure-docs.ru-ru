---
title: Создание, изменение и расширение определений приложений логики
...
Жизненный цикл развертывания обычно имеет различные среды для разработки, тестирования, промежуточного хранения и производства. При наличии значений, которые вы хотите повторно использовать в приложении логики без прописано или в зависимости от потребностей развертывания, можно создать [шаблон Azure Resource Manager](../azure-resource-manager/resource-group-overview.md) для определения рабочего процесса, чтобы можно было автоматизировать развертывание приложений логики. 
