...
* Каждая среда ISE, как для [разработчиков, так и для Premium](../logic-apps/connect-virtual-network-vnet-isolated-environment-overview.md#ise-level), ограничена общим количеством учетных записей интеграции, но [это ограничение можно увеличить за дополнительную стоимость](logic-apps-pricing.md#fixed-pricing):

  | SKU ISE | Ограничения учетной записи интеграции |
  |---------|----------------------------|
  | **Премиальный** | 20 всего — только [стандартные](../logic-apps/logic-apps-pricing.md#integration-accounts) учетные записи, включая одну стандартную учетную запись бесплатно. [Для получения дополнительных затрат можно использовать более учетные записи интеграции](logic-apps-pricing.md#fixed-pricing). Учетные записи уровней "Бесплатный" и "Базовый" не разрешены. |
  | **Разработчик** | 20 [всего (не](../logic-apps/logic-apps-pricing.md#integration-accounts) более 1 учетной записи) и [Standard](../logic-apps/logic-apps-pricing.md#integration-accounts) , или все стандартные учетные записи. [Для получения дополнительных затрат можно использовать более учетные записи интеграции](logic-apps-pricing.md#fixed-pricing). Учетные записи уровней "Базовый" не разрешены. Используйте [SKU Developer](../logic-apps/connect-virtual-network-vnet-isolated-environment-overview.md#ise-level) для экспериментов, разработки и тестирования, но не для использования в рабочей среде или тестирования производительности. |
  |||
