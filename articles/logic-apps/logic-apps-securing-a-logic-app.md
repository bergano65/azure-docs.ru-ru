...
| Параметр запроса | Description (Описание) |
|-----------------|-------------|
...
| Свойство (конструктор) | Свойство (JSON) | Обязательно | Значение | Description (Описание) |
|---------------------|-----------------|----------|-------|-------------|
| **Проверка подлинности** | `type` | Да | базовая; | Используемый тип проверки подлинности |
...
| Свойство (конструктор) | Свойство (JSON) | Обязательно | Значение | Description (Описание) |
|---------------------|-----------------|----------|-------|-------------|
| **Проверка подлинности** | `type` | Да | **Сертификат клиента** <br>или <br>`ClientCertificate` | Тип аутентификации, используемый для сертификатов клиента Secure Sockets Layer (SSL). Хотя самозаверяющие сертификаты поддерживаются, они не допускаются для SSL. |
...
| Свойство (конструктор) | Свойство (JSON) | Обязательно | Значение | Description (Описание) |
|---------------------|-----------------|----------|-------|-------------|
| **Проверка подлинности** | `type` | Да | **Active Directory OAuth** <br>или <br>`ActiveDirectoryOAuth` | Тип проверки подлинности. Logic Apps в настоящее время соответствует [протоколу OAuth 2,0](../active-directory/develop/v2-overview.md). |
...
| Свойство (конструктор) | Свойство (JSON) | Обязательно | Значение | Description (Описание) |
|---------------------|-----------------|----------|-------|-------------|
| **Проверка подлинности** | `type` | Да | Чтен | Используемый тип проверки подлинности |
...
3. В триггере или действии, где вы хотите использовать управляемое удостоверение, укажите следующие значения свойств.
   ...
   | Свойство (конструктор) | Свойство (JSON) | Обязательно | Значение | Description (Описание) |
   |---------------------|-----------------|----------|-------|-------------|
   | **Проверка подлинности** | `type` | Да | **Управляемое удостоверение** <br>или <br>`ManagedServiceIdentity` | Используемый тип проверки подлинности |
