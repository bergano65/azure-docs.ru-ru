...
1. В разделе **Определение политики**укажите сведения для определения политики на основе свойств, описанных в примере.
   ...
   | **Name** | Да | <*Политика-определение-имя*> | Имя, используемое для определения политики |
   ...
   | **Принудительное применение политик** | Да | **Enabled** | Этот параметр указывает, следует ли включать или отключать определение политики при сохранении работы. |
   ||||
