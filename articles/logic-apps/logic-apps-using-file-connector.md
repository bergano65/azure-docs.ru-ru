...
Для выполнения этого примера необходимы следующие элементы.
...
* [Учетная запись Drobox](https://www.dropbox.com/) и данные для входа в учетную запись. Ваши учетные данные DropBox необходимы для создания соединения между вашим логическим приложением и вашей учетной записью Drobox. 

* Данные для входа в учетную запись на компьютер с файловой системой, к которой вы хотите получить доступ. Например, если вы устанавливаете шлюз данных на одном компьютере в качестве файловой системы, вам необходимы учетные данные для этого компьютера. 
...
1. Если у вас еще нет подключения к файловой системе, то вам будет предложено создать такое подключение.
   ...
   | **Имя пользователя** | Yes | <*домен*>\\<*имя пользователя*> | Имя пользователя для компьютера, на котором есть файловая система. | 
   | **Пароль** | Yes | <*ваш пароль*> | Пароль для компьютера, на котором есть файловая система. | 
...
* Чтобы улучшить Azure Logic Apps и соединители, голосуйте за идеи или предлагайте собственные на [сайте пользовательских мнений Azure Logic Apps](https://aka.ms/logicapps-wish).
