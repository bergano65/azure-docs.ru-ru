---
title: Мониторинг приложений логики с помощью Azure Monitor
...
1. В [портал Azure](https://portal.azure.com)Создайте приложение логики. В главном меню на портале Azure последовательно выберите **Создать ресурс** > **Интеграция** > **Приложение логики**.
   ...
   ![Создание приложения логики](media/logic-apps-monitor-your-logic-apps-oms/create-new-logic-app.png)
...
1. Перейдите в рабочую область Log Analytics и выберите **Сводная информация о рабочей области** > **Logic Apps управления**.
...
1. Чтобы просмотреть все сведения о выполнении конкретного приложения логики или о конкретном состоянии, выберите строку с соответствующим приложением логики или состоянием.
   ...
   * Столбец " **Отслеживание свойств** ": для приложения логики, в котором настроены отслеживании свойств, сгруппированных по действиям, можно просмотреть эти свойства из этого столбца. Для просмотра этих отслеживаний свойств выберите **вид**. Для поиска отслеживаемых свойств можно использовать фильтр столбцов.
   ...
   * Повторная **Отправка**: вы можете повторно отправить одно или несколько приложений логики, которые завершились сбоем, успешно или все еще выполняются. Установите флажки для тех запусков, которые необходимо отправить повторно, а затем щелкните **Отправить повторно**.
