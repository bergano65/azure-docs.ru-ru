...
|-----------|----------|------|-------------|
| <*имя параметра*> | Да | String | Имя параметра, который требуется определить |
...
| <*массив-с-допустимыми параметрами-values*> | нет | Array | Массив со значениями, которые может принимать параметр. |
