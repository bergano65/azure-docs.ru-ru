...
| <*возвращен код состояния*> | Да | Строка | Код состояния, возвращаемый действием |
| <*Состояние действия*> | Да | Строка | Состояние действия, например, `Succeeded` или `Failed` |
|||||
