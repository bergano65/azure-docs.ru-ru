---
title: Корпоративная интеграция с Azure Logic Apps
description: Общие сведения о том, как создавать корпоративные решения интеграции путем автоматизации и оркестрации задач, рабочих процессов и бизнес-процессов, выполняющих интеграцию приложений, данных, служб и систем на предприятиях и в организациях. а также решения, поддерживающие интеграцию этих компонентов и выполнение сценариев оркестрации.
services: logic-apps
