---
title: Автоматические задачи для корпоративной интеграции B2B — Azure Logic Apps
...
![Конструктор Logic Apps — пример приложения логики](./media/logic-apps-overview/azure-logic-apps-overview.png)
