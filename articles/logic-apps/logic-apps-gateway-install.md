...
* **Важные сведения**
  ...
  * Установите шлюз на компьютер, подключенный к Интернету, который всегда включен и *не переходит* в спящий режим. В противном случае шлюз не сможет работать. 
  Кроме того, может наблюдаться снижение производительности при использовании беспроводной сети.

  * Во время установки войти можно только с помощью [рабочей или учебной учетной записи](../active-directory/sign-up-organization.md), управляемой Azure Active Directory (Azure AD), например @contoso.onmicrosoft.com, а не с помощью гостевой учетной записи Azure B2B или личной учетной записи Майкрософт, таких как @hotmail.com или @outlook.com. 
  Используйте ту же учетную запись для входа при регистрации установки шлюза на портале Azure. Это достигается путем создания ресурса шлюза. 
