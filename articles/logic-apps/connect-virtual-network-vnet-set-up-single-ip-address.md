...
1. В коллекции добавьте правило, разрешающее трафик в целевую систему.
   ...
   **Свойства коллекции сетевых правил**
   ...
   | Свойство. | Значение | Описание |
   |----------|-------|-------------|
   | **Name** | <*сеть-Rule-Collection-Name*> | Имя коллекции правил сети |
   ...
   **Свойства правила сети**
   ...
   | Свойство. | Значение | Описание |
   |----------|-------|-------------|
   | **Name** | <*сеть-имя правила*> | Имя правила сети |
   ...
   | **Порты назначения** | <*Назначение — порты*> | Все порты, используемые конечной системой для входящего трафика |
   |||
