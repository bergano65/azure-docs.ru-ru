...
В определении JSON действия в `columns` массиве присвойте `header` свойству пустую строку. Для каждого `value` свойства отменяйте ссылку на каждое нужное свойство массива.
