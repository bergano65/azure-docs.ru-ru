---
title: Добавление условных инструкций в рабочие процессы
...
1. Добавьте условие в нужное место. 
   ...
   Чтобы добавить условие между шагами, наведите указатель мыши на стрелку, где его нужно добавить. Выберите **знак** **+** плюс (), который появляется, а затем выберите **Добавить действие.** Пример:
...
1. В поле **Условие** создайте ваше условие. 
   ...
   Чтобы добавить еще один ряд к вашему состоянию, выберите **добавить** > **добавить строку.** 
   Чтобы добавить группу с подусловиями, выберите **группу Добавить.** > **Add group** 
