---
title: Добавление условных операторов в рабочие процессы
...
1. Добавьте условие в нужное место. 
   ...
   Чтобы добавить условие между шагами, наведите указатель мыши на стрелку, где его нужно добавить. Выберите отображаемый **знак плюса** (**+**), а затем щелкните **Добавить действие**. Пример:
...
1. В поле **Условие** создайте ваше условие. 
   ...
   Чтобы добавить в условие другую строку, выберите **Добавить** > **Добавить строку**. 
   Чтобы добавить группу с подсостояниями, выберите **Добавить** > **Добавить группу**. 
