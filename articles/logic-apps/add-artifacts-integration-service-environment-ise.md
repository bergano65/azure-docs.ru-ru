...
* Для создания, добавления или обновления ресурсов, развернутых в интегрированной среде сценариев, необходимо назначить роль владельца или участника в интегрированной среде сценариев или разрешения, наследуемые через подписку Azure или группу ресурсов Azure, связанную с ИНТЕГРИРОВАНной средой разработки. Для пользователей, у которых нет владельца, участника или унаследованных разрешений, им можно назначить роль участника среда службы интеграции или среда службы интеграции роль разработчика. Дополнительные сведения об управлении доступом на основе ролей (RBAC) см. в статье [что такое управление доступом на основе ролей (RBAC) для ресурсов Azure](../role-based-access-control/overview.md).
...
Соединители, управляемые корпорацией Майкрософт, которые становятся доступными после создания ИНТЕГРИРОВАНной среды разработки, не отображаются автоматически в средстве выбора соединителя в конструкторе приложений логики. Прежде чем использовать эти соединители ISE, необходимо вручную добавить и развернуть эти соединители в интегрированной среде сценариев, чтобы они отображались в конструкторе приложений логики.
...
1. В области **Добавить новый управляемый соединитель** откройте список **Найти соединитель** . Выберите соединитель ISE, который вы хотите использовать, но еще не развернут в интегрированной среде сценариев. Щелкните **Создать**.
