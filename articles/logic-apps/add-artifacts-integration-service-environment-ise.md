...
1. Укажите сведения о приложении логики, которое необходимо создать, например:
   ...
   | **Местоположение** | Да | В разделе **среды службы Integration**Services выберите интегрированную среду сценариев, если она еще не выбрана. <p><p> **Важно**. для использования приложений логики с учетной записью интеграции необходимо использовать одну интегрированную среду сценариев. |
   ||||
...
1. Укажите сведения о приложении логики, которое необходимо создать, например:
   ...
   | **Местоположение** | Да | В разделе **среды службы интеграции**выберите ту же интегрированную среду сценариев, которую используют приложения логики, если они еще не выбраны. <p><p> **Важно**. чтобы использовать учетную запись интеграции с приложениями логики, необходимо использовать одну интегрированную среду сценариев. |
   ||||
