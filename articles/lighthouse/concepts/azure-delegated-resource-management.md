...
> [!NOTE]
> Делегированное управление ресурсами Azure также можно использовать на предприятии, имеющем несколько собственных арендаторов Azure AD, чтобы упростить управление ими.
