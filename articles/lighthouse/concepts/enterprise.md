...
Например, предположим, что в вашей организации есть один арендатор, который мы назовем *Арендатором A.* Затем ваша организация приобретает двух дополнительных арендаторов, *Арендатора B* и *Tenant C,* и у вас есть бизнес-причины, которые требуют, чтобы вы поддерживали их в качестве отдельных арендаторов.
