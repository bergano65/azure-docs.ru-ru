...
Azure CLI команды, например [AZ Account List](/cli/azure/account?view=azure-cli-latest#az-account-list) , отображают атрибуты **хометенантид** и **манажедбитенантс** для каждой подписки, позволяя определить, принадлежит ли возвращенная Подписка к клиенту поставщика услуг или к клиенту управляемого клиента.
