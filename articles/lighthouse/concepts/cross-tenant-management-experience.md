...
- Развертывание и управление [Azure Virtual Network (VNet)](../../virtual-network/index.yml) и виртуальных сетевых интерфейсных карт (vNICs) в клиентах-клиентах
- Развертывание и настройка [Azure Firewall](../../firewall/overview.md) для защиты ресурсов виртуальной сети клиентов
- Управление службами подключения, такими как [Azure Virtual WAN,](../../virtual-wan/virtual-wan-about.md) [ExpressRoute](../../expressroute/expressroute-introduction.md)и [VPN шлюзы](../../vpn-gateway/vpn-gateway-about-vpngateways.md) для клиентов
- Используйте маяк Azure для поддержки ключевых сценариев [программы MSP сети Azure](../../networking/networking-partners-msp.md)
