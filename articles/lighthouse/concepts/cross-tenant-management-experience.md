...
- Log Analytics: запрос данных из удаленных рабочих областей в нескольких клиентах (Обратите внимание, что учетные записи службы автоматизации, используемые для доступа к данным из рабочих областей в клиентских клиентах, должны создаваться в одном клиенте).
