...
Используя управление ресурсами, делегированное Azure, авторизованные пользователи могут войти в систему к арендатору поставщика услуг для доступа к этим ресурсам, как показано здесь:
