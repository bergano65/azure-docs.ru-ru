...
|---------|---------|---------|---------|---------|
|Архитекторы     |Группа пользователей         |\<principalId\>         |Contributor         |b24988ac-6180-42a0-ab88-20f7382dd24c  |
|OMS.     |Группа пользователей         |\<principalId\>         |Читатель         |acdd72a7-3385-48ef-bd42-f606fba81ae7  |
|Специалисты по VM     |Группа пользователей         |\<principalId\>         |Участник VM         |9980e02c-c2be-4d73-94e8-173b1dc7cf3c  |
|Автоматизация     |Имя субъекта-службы (SPN)         |\<principalId\>         |Contributor         |b24988ac-6180-42a0-ab88-20f7382dd24c  |
