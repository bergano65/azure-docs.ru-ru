...
> [!NOTE]
> Если вы не хотите публиковать предложение в Azure Marketplace, вы можете вручную подключать клиентов с помощью шаблонов Azure Resource Manager. Дополнительные сведения см. в статье подключение [клиента к Azure лигхсаусе](onboard-customer.md).
