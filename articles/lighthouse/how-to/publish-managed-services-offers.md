...
3. You'll see an **Editor** section for your offer with four parts to fill in: **Offer Settings**, **Plans**, **Marketplace**, and **Support**. Прочтите инструкции по заполнению этих разделов.
...
- **Azure AD Object Display Name**: A friendly name to help the customer understand the purpose of this authorization. Клиент увидит это имя при делегировании ресурсов.
- **Role Definition**: Select one of the available Azure AD built-in roles from the list. Эта роль определит разрешения, которые пользователь в поле **Идентификатор объекта Azure AD** будет иметь на ресурсы ваших клиентов. Описание этих ролей см. в разделах [Встроенные роли](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles) и [Поддержка ролей для делегированного управления ресурсами Azure](../concepts/tenants-users-roles.md#role-support-for-azure-delegated-resource-management).
...
|**Marketing Identifier** (Маркетинговый идентификатор)     | Уникальный идентификатор, доступный для использования в URL-адресе. This identifier can only contain lowercase alphanumeric characters and dashes. It will be used in Marketplace URLs for this offer. Если идентификатор издателя имеет значение *contoso*, и вы назначили маркетинговый идентификатор *sampleApp*, для вашего предложения в Azure Marketplace будет создан URL-адрес *https://azuremarketplace.microsoft.com/marketplace/apps/contoso-sampleApp* .        |
...
Four logo sizes are required: **Small (40x40)** , **Medium (90x90)** , **Large (115x115)** , and **Wide (255x115)** . Следуйте приведенным ниже рекомендациям для ваших логотипов:
