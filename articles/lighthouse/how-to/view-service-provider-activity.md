...
Записанные в журнал действия доступны в портал Azure за последние 90 дней. Сведения о том, как хранить эти данные дольше 90 дней, см. [в статье получение и анализ журналов действий Azure в log Analytics рабочей области](../../azure-monitor/platform/activity-log-collect.md).
