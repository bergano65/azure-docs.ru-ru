...
Не забывайте, что в верхней части страницы **Мои клиенты** отображается только информация о клиентах, которым были делегированы подписки или группы ресурсов. Если вы работаете с другими клиентами (например, с помощью [программы "Поставщик облачных решений"](https://docs.microsoft.com/partner-center/csp-overview)), то не увидите здесь информацию об этих клиентах, если только не подключите их ресурсы к делегированному управлению ресурсами. Ниже на странице, в разделе **Cloud Solution Provider (Preview)** (Поставщик облачных решений (предварительная версия)), отображаются сведения о выставлении счетов и ресурсы для клиентов CSP, которые [подписали клиентский договор с Майкрософт (MCA)](https://docs.microsoft.com/partner-center/confirm-customer-agreement) и используют план Azure, независимо от того, были ли они подключены для делегированного управления ресурсами Azure. Чтобы узнать больше, ознакомьтесь с разделом [Начало работы с учетной записью выставления счетов Соглашения с партнером Майкрософт](https://docs.microsoft.com/azure/billing/mpa-overview).
...
> [!IMPORTANT]
> Чтобы пользователи могли увидеть делегированные ресурсы, в процессе подключения им должна быть предоставлена роль [Читатель](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#reader) (или другая встроенная роль, которая предоставляет доступ для чтения).
