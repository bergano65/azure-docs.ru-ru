...
- Чтобы просмотреть более подробные сведения о назначениях для делегированных подписок или групп ресурсов, выберите запись в столбце **Делегирования**.
