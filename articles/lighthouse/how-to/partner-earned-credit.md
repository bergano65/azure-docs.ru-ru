...
1. При подключении [клиента с помощью шаблонов ARM](onboard-customer.md)обязательно включите авторизацию, включающую учетную запись службы автоматизации PEC, в качестве пользователя с [встроенной ролью Azure, доступной для PEC](/partner-center/azure-roles-perms-pec).
