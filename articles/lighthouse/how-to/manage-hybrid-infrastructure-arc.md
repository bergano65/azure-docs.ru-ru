...
В этом разделе приводятся общие сведения о том, как поставщики услуг могут использовать серверы с поддержкой ARC (Предварительная версия) и Kubernetes (Предварительная версия) в службе "Дуга" в Azure для управления гибридной средой клиентов с видимостью всех клиентов управляемых клиентов.
...
## <a name="manage-hybrid-servers-at-scale-with-azure-arc-enabled-servers-preview"></a>Управление гибридными серверами в масштабе с помощью серверов с поддержкой ARC (Предварительная версия)

> [!NOTE]
> Серверы с поддержкой ARC в Azure в настоящее время доступны в предварительной версии. Мы не рекомендуем использовать его для рабочих нагрузок в данный момент.
