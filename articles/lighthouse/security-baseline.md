...
- [Azure Security Benchmark — управление ресурсами](../security/benchmarks/security-controls-v2-incident-response.md)
...
- [Azure Security Benchmark — безопасность сети](../security/benchmarks/security-controls-v2-logging-threat-detection.md)
