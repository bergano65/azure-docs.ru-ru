...
В Application Insights есть два тарифных плана: "Базовый" и "Корпоративный". По умолчанию используется тарифный план "Базовый". Он включает в себя все возможности плана "Корпоративный", не требуя дополнительных затрат. В плане "Базовый" плата в основном взимается за объем принимаемых данных. 
