...
> [!NOTE]
> Если вы используете [Поиск](app-insights-diagnostic-search.md), обратите внимание, что слова необходимо сопоставлять целиком: "Пр" и "о" не соответствуют "Про".
> 
> 
