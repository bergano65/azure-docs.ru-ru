...
> [!NOTE] 
> * Мы настоятельно рекомендуем тестирование из нескольких расположений, чтобы избежать ложных предупреждений, получаемых в результате временных проблем с определенным местоположением.
...
В колонке "Обзор" выберите **Параметры** и **Тесты производительности**. При создании теста вам будет предложено подключиться к учетной записи Azure DevOps или создать ее.
