...
[Отладочные моментальные снимки](app-insights-snapshot-debugger.md) хранятся в течение 7 дней. Такая политика хранения установлена для каждого приложения. Если нужно изменить этот параметр, вы можете запросить изменения, открыв окно Службы Поддержки на портале Microsoft Azure.
