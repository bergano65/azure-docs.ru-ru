...
![Снимок экрана с обзором графиков КПЭ производительности](./media/app-insights-detect-triage-diagnose/overview-graphs.png)
...
![Различные метрики](./media/app-insights-detect-triage-diagnose/002-servers.png)
...
![Диаграмма и сетка значений времени отклика сервера.](./media/app-insights-detect-triage-diagnose/response-time.png)
...
![Число просмотров страниц](./media/app-insights-detect-triage-diagnose/funnel.png)
