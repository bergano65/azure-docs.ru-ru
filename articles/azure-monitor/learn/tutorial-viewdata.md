...
![Простой запрос](media/tutorial-viewdata/log-analytics-portal-eventlist-01.png)
...
![Фильтр](media/tutorial-viewdata/log-analytics-portal-eventlist-02.png)

Добавьте свойства на панель фильтров, выбрав **Добавить в фильтры** в меню свойств одной из записей.

![Меню добавления в фильтры](media/tutorial-viewdata/log-analytics-portal-eventlist-03.png)
...
![Группировка по компьютеру](media/tutorial-viewdata/log-analytics-portal-eventlist-04.png)
...
![Табличное представление](media/tutorial-viewdata/log-search-portal-table-01.png)

Щелкните стрелку рядом с записью, чтобы просмотреть сведения для этой записи.

![Сортировка результатов](media/tutorial-viewdata/log-search-portal-table-02.png)

Выполните сортировку по любому полю, щелкнув заголовок соответствующего столбца.

![Сортировка результатов](media/tutorial-viewdata/log-search-portal-table-03.png)

Отфильтруйте результаты по определенному значению в столбце с помощью кнопки "Фильтр", а затем укажите условия фильтра.

![Фильтрация результатов](media/tutorial-viewdata/log-search-portal-table-04.png)
...
![Группирование результатов](media/tutorial-viewdata/log-search-portal-table-05.png)
...
![Данные о производительности](media/tutorial-viewdata/log-analytics-portal-perfsearch-01.png)
...
![Использование процессора](media/tutorial-viewdata/log-analytics-portal-perfsearch-02.png)
...
![Диаграмма данных о производительности](media/tutorial-viewdata/log-analytics-portal-perfsearch-03.png)
...
![График](media/tutorial-viewdata/log-analytics-portal-linechart-01.png)
...
> [Создание панелей мониторинга данных Log Analytics и предоставление общего доступа к ним](tutorial-logs-dashboards.md)
