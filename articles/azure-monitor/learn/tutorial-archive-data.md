...
- Данные метрик платформы Azure Monitor хранятся 93 дня. 
...
Теперь можно приступить к настройке среды Azure для маршрутизации данных мониторинга в учетную запись хранения. Сначала настраиваются данные на уровне подписки (содержатся в журнале действий Azure) для маршрутизации к учетной записи хранения. [**Журнал действий Azure**](../../azure-monitor/platform/activity-logs-overview.md) содержит события на уровне подписки в Azure. Его можно просмотреть на портале Azure, чтобы определить, *кто* создал, обновил или удалил *ресурсы*, а также *когда* это было сделано.
...
3. В открывшемся разделе **Экспорт журнала действий** установите флажок **Экспорт в учетную запись хранения" и щелкните **Выбрать учетную запись хранения**.
...
2. Щелкните ресурс в списке, а затем выберите **Включить диагностику**.
  ...
  Если параметр уже настроен, будут показаны имеющиеся параметры и кнопка **Добавить параметр диагностики**. Нажмите эту кнопку.
...
3. В открывшемся разделе назначьте параметру **Имя** и установите флажок **Архивировать в учетную запись хранения**.

   ![Раздел параметров диагностики](media/tutorial-archive-data/diagnostic-settings-home.png)

4. В разделе **Архивировать в учетную запись хранения** нажмите кнопку **Конфигурация** и выберите учетную запись хранения, созданную в предыдущем разделе. Последовательно выберите **ОК**.
...
5. В появившемся разделе щелкните **Включить мониторинг на гостевом уровне**.
...
3. Перейдите в раздел **Параметры диагностики** на виртуальной машине, настроенной на предыдущем шаге **Маршрутизация данных виртуальной машины (гостевая ОС) в учетную запись хранения**, и на вкладке **Агент** щелкните **Удалить** (под разделом **Удалеие агента диагностики Azure**).
