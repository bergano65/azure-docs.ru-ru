...
2. Щелкните ресурс в списке, а затем выберите **Включить диагностику**.
   ...
   Если какие-то параметры уже настроены, будут показаны имеющиеся параметры и кнопка **Добавить параметр диагностики**. Нажмите эту кнопку.
...
3. В открывшемся разделе назначьте параметру **Имя** и установите флажок **Архивировать в учетной записи хранения**.

   ![Раздел параметров диагностики](media/tutorial-archive-data/diagnostic-settings-home.png)

4. Ниже под **Архивировать в учетной записи хранения** нажмите кнопку **Настроить** и выберите учетную запись хранения, созданную в предыдущем разделе. Нажмите кнопку **ОК**.
...
3. Перейдите в раздел **Параметры диагностики** на виртуальной машине, настроенной на предыдущем шаге **Маршрутизация данных виртуальной машины (гостевая ОС) в учетную запись хранения**, и на вкладке **Агент** щелкните **Удалить** (под разделом **Удаление агента Диагностики Azure**).
