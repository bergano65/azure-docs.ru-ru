...
4. Ниже под **Архивировать в учетной записи хранения** нажмите кнопку **Настроить** и выберите учетную запись хранения, созданную в предыдущем разделе. Затем нажмите кнопку **ОК**.
