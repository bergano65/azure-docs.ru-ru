...
3. Выберите имя приложения, такое как *MyTestScaleWebApp*. Создайте для приложения группу ресурсов \*myResourceGroup" или поместите его в группу ресурсов по своему выбору.
