...
В своем новом ресурсе Application Insights перейдите на страницу **Обзор**. Скопируйте в ресурсе ключ инструментирования.
   ...
   ![Кнопка "Аналитика" в Application Insights](./media/mobile-center-quickstart/overview-01.png)
...
1. **Запрос данных телеметрии пользовательских событий.** На странице **Обзор** Application Insights выберите **Аналитика**. 
   ...
   ![Кнопка "Аналитика" в Application Insights](./media/mobile-center-quickstart/analytics-001.png)
   ...
   ![Портал аналитики](./media/mobile-center-quickstart/analytics-portal-001.png)
