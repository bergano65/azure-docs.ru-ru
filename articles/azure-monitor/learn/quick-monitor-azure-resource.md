...
В этом кратком руководстве вы просмотрели для ресурса Azure журнал действий и метрики, которые автоматически собираются службой Azure Monitor. Журналы ресурсов предоставляют подробные сведения об операциях с ресурсом, но их сбор нужно настраивать отдельно. Перейдите к учебнику по сбору журналов ресурсов в рабочую область Log Analytics, где для их анализа можно применить запросы к журналам.
