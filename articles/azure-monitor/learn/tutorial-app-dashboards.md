...
2.  На панели мониторинга выберите **Новая панель мониторинга**.
...
6. Щелкните **Настройка выполнена** в верхней части экрана, чтобы выйти из режима настройки плитки.
