...
1. Добавьте текст в свойства плитки и измените его размер на поле панели мониторинга.
