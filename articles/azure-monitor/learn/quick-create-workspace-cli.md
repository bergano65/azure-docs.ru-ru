...
- Для работы с этой статьей требуется версия 2.0.30 или более поздняя Azure CLI. Если вы используете Azure Cloud Shell, последняя версия уже установлена.
