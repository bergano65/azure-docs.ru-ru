...
> [Create custom KPI dashboards using Azure Application Insights](../../azure-monitor/learn/tutorial-app-dashboards.md) (Создание настраиваемых панелей мониторинга с помощью Azure Application Insights)
