...
- Включите [отправку из приложения телеметрии](../../azure-monitor/app/usage-overview.md#send-telemetry-from-your-app) для пользовательских событий и просмотров страниц.
...
3. На панели **Образец этих сеансов** справа перечислены сеансы с большим количеством событий.  Эти сеансы наиболее интересны для анализа.
    ...
    ![Образец этих сеансов](media/tutorial-users/SessionsSample.png)

4. Щелкните любой сеанс, чтобы просмотреть **Временную шкалу сеанса**, где отображается каждое действие в этом сеансе. Так вы сможете найти важную информацию, например сеансы с большим числом исключений.
...
4. Нажмите кнопку **Сохранить**, чтобы сохранить эту воронку и просмотреть ее результаты. В окне справа от воронки отображаются самые распространенные события, происходящие до первого действия и после последнего действия. Так вы сможете оценить тенденции в поведении пользователей до и после этой последовательности.
...
> [Создание настраиваемых панелей мониторинга КПЭ с помощью Azure Application Insights](../../azure-monitor/learn/tutorial-app-dashboards.md)
