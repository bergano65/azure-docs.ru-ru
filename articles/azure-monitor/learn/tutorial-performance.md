...
5.  Вы можете увидеть, что больше всего общую длительность транзакции влияет обращение к таблице  Azure Fabrikamaccount. Вы также можете увидеть исключение, которое привело к сбою. Щелкните любой элемент в списке, чтобы просмотреть соответствующие сведения в области справа. См. дополнительные сведения об [интерфейсе диагностики транзакций](../../azure-monitor/app/transaction-diagnostics.md).
