...
Как только вы создадите подписку Azure и начнете добавлять такие ресурсы, как виртуальные машины и веб-приложения, Azure Monitor начнет собирать данные.  [Журналы действий](platform/activity-logs-overview.md) записываются при создании или изменении ресурсов. [Метрики](platform/data-platform.md) указывают производительность ресурса и используемые им ресурсы. 
...
Включите наблюдение за [приложением служб приложений](app/azure-web-apps.md) , [виртуальной машиной и приложением масштабируемого набора виртуальных машин](app/azure-vm-vmss-apps.md), чтобы Application Insights собираются подробные сведения о приложении, включая Просмотры страниц, запросы приложений и отличи. Проверьте доступность приложения, настроив [тест доступности](app/monitor-web-app-availability.md) для имитации пользовательского трафика.
...
![Предупреждения](media/overview/alerts.png)
...
![Информационная панель](media/overview/dashboard.png)
...
[Центры событий Azure](https://docs.microsoft.com/azure/event-hubs) — это платформа потоковой передачи и служба приема событий, которая может трансформировать и хранить данные с помощью любого поставщика аналитических данных в реальном времени либо адаптеров хранения или пакетной обработки. Используйте концентраторы событий для потоковой передачи [данных Azure Monitor](platform/stream-monitoring-data-event-hubs.md) в средства Partner SIEM and Monitoring Tools.
