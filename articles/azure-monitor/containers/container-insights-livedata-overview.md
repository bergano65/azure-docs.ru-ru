...
Следующая процедура используется для просмотра журналов в реальном времени для развертываний, входящих в состав кластеров AKS, которые не отслеживаются Azure Monitor для контейнеров. Если кластер использует Azure Monitor для контейнеров, используйте приведенный ниже процесс для просмотра динамических данных для узлов, контроллеров, контейнеров и развертываний.
