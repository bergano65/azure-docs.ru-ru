...
ms.locfileid: "100621840"
---
# <a name="how-to-create-log-alerts-from-azure-monitor-for-containers"></a>Создание оповещений журнала из Azure Monitor для контейнеров
...
Если вы не знакомы с Azure Monitor оповещениями, ознакомьтесь со статьей [Обзор оповещений в Microsoft Azure](../platform/alerts-overview.md) перед началом работы. Дополнительные сведения об оповещениях, использующих запросы журналов, см. [в разделе оповещения журнала в Azure Monitor](../alerts/alerts-unified-log.md). Дополнительные сведения об оповещениях метрик см. [в разделе оповещения метрик в Azure Monitor](../alerts/alerts-metric-overview.md).
