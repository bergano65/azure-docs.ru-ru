...
В следующей таблице представлены сведения о записях, собранных Azure Monitor для контейнеров. Список описаний столбцов см. в справочнике по таблицам [контаинеринвентори](/azure/azure-monitor/reference/tables/containerinventory) и [контаинерлог](/azure/azure-monitor/reference/tables/containerlog) .
