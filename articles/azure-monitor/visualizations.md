...
> [!IMPORTANT]
> Представления в данный процесс являются устаревшими. Инструкции по преобразованию представлений в книги см. в разделе [Конструктор представлений Azure Monitor. Руководство по переходу к книгам](platform/view-designer-conversion-overview.md) .
