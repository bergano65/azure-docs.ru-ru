...
### <a name="advantages"></a>Преимущества
- Глубокая интеграция в Azure. Визуализации можно прикрепить к панелям мониторинга с нескольких страниц Azure, включая Explorer Метрики, Аналитика журналов и Исследования приложений.
- Поддержка метрик и журналов.
...
- Автоматическое обновление. Обновление метрик зависит от диапазона времени (минимум пять минут). Логи обновляют каждый час, с ручной опцией обновления по требованию, нажав на значок "обновить" на заданную визуализацию, или освежая полную панель мониторинга.
...
> [!IMPORTANT]
> Мнения находятся в процессе амортизации. См. [руководство по переходу к разделу Azure Monitor](platform/view-designer-conversion-overview.md) для перехода к трудовым книгам для руководства по преобразованию представлений в трудовые книжки.
...
- Узнайте больше о [трудовых книжках](../azure-monitor/app/usage-workbooks.md).
