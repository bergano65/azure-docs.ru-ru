...
* Просмотр правил генерации оповещений, определенных в интерфейсе [оповещений Azure](alerts/alerts-overview.md).
* Запрос метрик с помощью [REST API Azure Monitor](/rest/api/monitor/metrics), [командлетов PowerShell](powershell-samples.md) или [кроссплатформенного интерфейса командной строки](cli-samples.md).
...
* Просмотр [параметров диагностики](essentials/diagnostic-settings.md) для ресурса.
* Просмотр [профиля журнала](essentials/activity-log.md#legacy-collection-methods) для подписки.
...
* Настройка [параметров диагностики](essentials/diagnostic-settings.md) для ресурса.\*
* Настройка [профиля журнала](essentials/activity-log.md#legacy-collection-methods) для подписки.\*
* Настройка действий и параметров для правил генерации оповещений при помощи интерфейса [оповещений Azure](alerts/alerts-overview.md).
