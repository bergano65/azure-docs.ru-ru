...
- Тип агрегирования (статистика, которая выполняется по необработанным значениям метрики. [Поддерживаются следующие типы агрегирования](../platform/metrics-aggregation-explained.md#aggregation-types) : минимальное, максимальное, среднее, общее, число). среднее значение
...
- [Узнайте, как создавать оповещения в Azure Монтиор обозреватель метрик](../platform/metrics-charts.md#alert-rules)
