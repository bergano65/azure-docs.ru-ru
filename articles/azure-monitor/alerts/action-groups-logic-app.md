...
Когда активируется оповещение Azure Monitor, оно вызывает [группу действий](../platform/action-groups.md). Группы действий позволяют активировать одно или несколько действий для уведомления других лиц об оповещении и устранения его причины.
...
15. Откройте существующую группу действий и добавьте в нее действие, которое ссылается на приложение логики. Если у вас нет группы действий, см. раздел [Создание групп действий и управление ими в портал Azure](../platform/action-groups.md) для ее создания. Обязательно сохраните изменения.
...
* Изучите [обзор оповещений журнала действий Azure](../platform/alerts-overview.md) и узнайте, как получать оповещения.  
