...
![Снимок экрана с окнами и параметрами для добавления подключения ServiceNow.](media/itsmc-connections-servicenow/itsm-connection-servicenow-connection-latest.png)
