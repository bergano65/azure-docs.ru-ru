...
В приведенном ниже примере создается [правило генерации оповещений "Количество результатов"](../alerts/alerts-unified-log.md#count-of-the-results-table-rows).

### <a name="notes"></a>Примечания

- В этот пример входят [полезные данные веб-перехватчика](../alerts/alerts-log-webhook.md). Если правило генерации оповещений не должно запускать веб-перехватчик, удалите элемент **customWebhookPayload**.
...
В приведенном ниже примере создается [правило генерации оповещений "Измерение метрик"](../alerts/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
