...
2. В области **Источники данных рабочей области** щелкните **Подключения ITSM**.
    ...
    ![Новое подключение](media/itsmc-connections-scsm/add-new-itsm-connection.png)
...
![Подключение к Service Manager](media/itsmc-connections-scsm/service-manager-connection.png)
...
3. В разделе **гибридных подключений** щелкните **Настройте конечные точки гибридного подключения**.
    ...
    ![Сети гибридного подключения](media/itsmc-connections-scsm/itsmc-hybrid-connection-networking-and-end-points.png)
4. В колонке **Гибридные подключения** щелкните **Добавить гибридное подключение**.

    ![Добавление гибридного подключения](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-add.png)

5. В колонке **добавления гибридных подключений** щелкните вкладку **Создать гибридное подключение**.

    ![Новое гибридное подключение](media/itsmc-connections-scsm/itsmc-create-new-hybrid-connection.png)
...
6. Введите следующие значения:
   ...
   - **Name** (Имя). если вы создаете служебную шину, укажите для нее имя.
     ...
     ![Значения для гибридного подключения](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-values.png)
...
7. После этого выберите подключение и щелкните **Добавление выбранного гибридного подключения**.
    ...
    ![Новое гибридное подключение](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-added.png)
...
![Успешное гибридное подключение](media/itsmc-connections-scsm/itsmc-hybrid-connection-listener-set-up-successful.png)
> [!NOTE]
> 
...
![Проверка гибридного подключения](media/itsmc-connections-scsm/itsmc-hybrid-connection-test.png)
