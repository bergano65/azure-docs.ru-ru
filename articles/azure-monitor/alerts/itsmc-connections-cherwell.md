...
![Подключение Cherwell](media/itsmc-connections-cherwell/itsm-connections-cherwell-latest.png)
...
3. Выберите **Create new client** (Создание нового клиента) > **client secret** (Секрет клиента).
    ...
    ![Идентификатор пользователя Cherwell](media/itsmc-connections-cherwell/itsmc-cherwell-client-id.png)
