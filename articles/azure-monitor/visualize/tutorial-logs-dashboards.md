...
> [Respond to events with Log Analytics Alerts](../alerts/tutorial-response.md) (Реакция на события с помощью оповещений Log Analytics)