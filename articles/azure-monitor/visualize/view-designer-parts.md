...
| Пороговое значение |Пороговое значение. Для цвета работоспособности каждого элемента списка задается цвет наибольшего порогового значения, превышенного значением элемента. Если пороговые значения не превышены, используется стандартный цвет. |
