...
> [!IMPORTANT]
> Представления в Azure Monitor были переведены в [книги](workbooks-overview.md) , предоставляющие дополнительные функциональные возможности. Дополнительные сведения о преобразовании существующих представлений в книги см. в разделе [Конструктор представлений Azure Monitor. книга переходов](view-designer-conversion-overview.md) .
...
Для создания или изменения представлений необходимо иметь по крайней мере [разрешения уровня участника](../platform/manage-access.md#manage-access-using-azure-permissions) в рабочей области log Analytics. Если у вас нет этого разрешения, параметр конструктор представлений не будет отображаться в меню.
...
| Журналы      | Открывает [log Analytics](../log-query/log-query-overview.md) для анализа данных с помощью запросов журналов. |
...
| Отменить      | Отменяет изменения и закрывает представление. |
...
* Добавьте [элементы визуализации](view-designer-parts.md) в пользовательское представление.
