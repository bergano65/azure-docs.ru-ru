...
- [Как просматривать и извлекать события журнала действий Azure](./platform/activity-log.md#view-the-activity-log)
...
- [Приступая к работе с Log Analytics запросами](./log-query/log-analytics-tutorial.md)
...
**Руководство**. Использование управления доступом на основе ролей Azure (Azure RBAC) для управления доступом к Azure Monitor.
...
- [Управление рабочей областью Log Analytics с помощью шаблонов Azure Resource Manager](./samples/resource-manager-workspace.md)
