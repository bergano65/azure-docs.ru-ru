...
Политика Azure включает несколько предварительно созданных определений, связанных с Azure Monitor. Вы можете назначить эти определения политик существующей подписке или использовать их в качестве базиса для создания собственных пользовательских определений. Полный список встроенных политики в категории **мониторинга** см. в статье [определения встроенных политик политики Azure для Azure Monitor](./samples/policy-reference.md).
