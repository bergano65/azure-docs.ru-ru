...
![Обзор приложения логики](media/logs-export-logic-app/logic-app-overview.png)
...
![Создание приложения логики](media/logs-export-logic-app/create-logic-app.png)
...
![Действие повторения](media/logs-export-logic-app/recurrence-action.png)
...
![Действие Azure Monitor журналов](media/logs-export-logic-app/select-azure-monitor-connector.png)

Щелкните **Azure log Analytics — запуск запроса и вывод списка результатов**.

![Снимок экрана нового действия, добавляемого к шагу в конструкторе приложений логики. Azure Monitor журналы выделяются в разделе Выберите действие.](media/logs-export-logic-app/select-query-action-list.png)
...
![Снимок экрана параметров для нового действия "регистрация" Azure Monitor "выполнить запрос" и визуализировать результаты.](media/logs-export-logic-app/run-query-list-action.png)
...
![Выбор действия "анализ JSON"](media/logs-export-logic-app/select-parse-json.png)
...
[![Выбрать текст](media/logs-export-logic-app/select-body.png)](media/logs-export-logic-app/select-body.png#lightbox)
...
![Анализ полезных данных JSON](media/logs-export-logic-app/parse-json-payload.png)
...
![Выбор действия создания](media/logs-export-logic-app/select-compose.png)
...
[![Выбрать текст для действия создания](media/logs-export-logic-app/select-body-compose.png)](media/logs-export-logic-app/select-body-compose.png#lightbox)
...
![Выберите создать BLOB-объект.](media/logs-export-logic-app/select-create-blob.png)
...
[![Выражение BLOB-объекта](media/logs-export-logic-app/blob-expression.png)](media/logs-export-logic-app/blob-expression.png#lightbox)
...
![Создать выражение BLOB-объекта](media/logs-export-logic-app/create-blob.png)
...
[![Журнал запусков](media/logs-export-logic-app/runs-history.png)](media/logs-export-logic-app/runs-history.png#lightbox)
