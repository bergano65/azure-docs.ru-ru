...
|:---|:---|:---|
| Запись, созданная в источнике данных | [TimeGenerated](../platform/log-standard-columns.md#timegenerated-and-timestamp) <br>Если источник данных не задает это значение, он будет установлен в то же время, что и _TimeReceived. |
| Запись, полученная конечной точкой приема Azure Monitor | [_TimeReceived](../platform/log-standard-columns.md#_timereceived) | |
