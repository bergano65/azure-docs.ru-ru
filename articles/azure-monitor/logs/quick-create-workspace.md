...
* Сведения о мониторинге работоспособности рабочей области см. [в статье мониторинг работоспособности log Analytics рабочей области в Azure Monitor](../logs/monitor-workspace.md) создание правил генерации оповещений. 
* См. статью [Сбор журналов и метрик службы Azure для использования в log Analytics](../essentials/resource-logs.md#send-to-log-analytics-workspace) , чтобы включить сбор данных из ресурсов Azure с помощью система диагностики Azure или службы хранилища Azure.
