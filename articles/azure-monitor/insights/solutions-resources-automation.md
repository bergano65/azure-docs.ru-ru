...
|:--|:--|:--|:--|
| string   | Заключает значение в две пары кавычек.  | "\"Hello world\"" | "Здравствуй, мир" |
...
- Учетные данные.
- Переменная.
- Module.  Это [модуль OMSIngestionAPI](https://www.powershellgallery.com/packages/OMSIngestionAPI/1.5) для записи данных в Log Analytics. 
