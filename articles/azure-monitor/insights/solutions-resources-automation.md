...
| параметры |Сущность для каждого значения параметра, необходимого для модуля Runbook. |
...
| Тип данных | Description | Пример | Результат разрешения |
|:--|:--|:--|:--|
