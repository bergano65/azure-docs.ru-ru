...
ms.locfileid: "56983391"
---
#  <a name="agent-health-solution-in-azure"></a>Решение для мониторинга работоспособности агентов в Azure
Агент работоспособности решения в Azure поможет вам понять, для всех агентов, предоставляющих отчеты непосредственно в рабочей области Log Analytics или группу управления System Center Operations Manager подключен к Azure Monitor, который не отвечает и отправки операционных данные.  Вы также можете отслеживать число развернутых агентов и их географическое распределение, а также выполнять другие запросы, чтобы знать о распределении агентов, развернутых в Azure, других облачных средах или в локальной среде.    
...
* Дополнительные сведения о [оповещения в Azure Monitor](../platform/alerts-overview.md) для генерации оповещений из Log Analytics. 
