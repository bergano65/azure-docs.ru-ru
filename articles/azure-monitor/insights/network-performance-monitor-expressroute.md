...
| 5103 | Шлюз ExpressRoute неисправен. | 
| 5201 | Канал поставщика служб сообщает о высокой задержке. |
| 5202 | Пакеты не передаются из назначенной цепи ExpressRoute. |
| 5301 | Пограничный маршрутизатор клиента сообщает о высокой задержке. | 
| 5302 | Задержка вызвана устройством или каналом в среде клиента. Проблема, кажется, не связана с каналом ExpressRoute. | 
...
| 5506 | Использование приближается к допустимому максимуму. | 
| 5507 | Использование находится на низком уровне. |
...
| 5512 | Не удается определить, передается ли трафик через предполагаемую цепь. |
...
![Использование пропускной способности ExpressRoute](media/network-performance-monitor-expressroute/expressroute-peak-utilization.png)
