...
* Используйте [поиск по журналам в Log Analytics](../../log-analytics/log-analytics-queries.md) для просмотра подробных данных диагностики Azure.
