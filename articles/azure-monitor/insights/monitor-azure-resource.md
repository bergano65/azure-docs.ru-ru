...
Многие службы отображают данные мониторинга на странице **Обзор**, что позволяет быстро оценить их работу. Как правило, этот механизм основан на подмножестве метрик платформы, хранящихся в службе метрик Azure Monitor. Другие параметры мониторинга, как правило, доступны в разделе **Мониторинг** в меню служб.
...
- Дополнительные сведения о просмотре журнала действий и получении записей с помощью различных методов см. в разделе [Просмотр и получение событий журнала действий Azure](../platform/activity-log-view.md).
