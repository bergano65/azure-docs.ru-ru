...
Многие службы будут включать данные мониторинга на странице **обзора** как краткий обзор их работы. Как правило, это основано на подмножестве метрик платформы, хранящихся в Azure Monitor метриках. Другие параметры мониторинга, как правило, доступны в разделе " **мониторинг** " служб. меню.

![Страница "Обзор"](media/monitor-azure-resource/overview-page.png)

## <a name="analyzing-metrics"></a>Анализ метрик
Анализируйте отдельные метрики и сопоставьте несколько метрик для выявления корреляций и тенденций с помощью [обозревателя метрик](../platform/metrics-getting-started.md). Некоторые службы предоставляют пользовательский интерфейс для работы со своими метриками при открытии **метрик** из меню ресурсов.
...
- Пошаговое руководство по использованию Log Analytics для написания запроса и работе с результатами см. [в статье Приступая к работе с log Analytics в Azure Monitor](../log-query/get-started-portal.md) .
...
Некоторые службы предоставляют средства, выходящие за рамки стандартных функций Azure Monitor. [Решения](../insights/solutions.md) предоставляют стандартную логику мониторинга, основанную на стандартных функциях Azure Monitor. [Insights](../insights/insights-overview.md) предоставляет настраиваемый опыт мониторинга, основанный на Azure Monitor платформе данных и стандартных функциях.

Если ресурс имеет доступ к аналитике, вы можете открыть его из **аналитической информации** в меню ресурсов. Доступ ко всем аналитикам и решениям из меню Azure Monitor.

- Ознакомьтесь с документацией по мониторингу для каждой службы, чтобы определить, есть ли доступные сведения или решения.

![Аналитические сведения](media/monitor-azure-resource/insights.png)

## <a name="next-steps"></a>Дальнейшие действия

* Подробные сведения о журналах ресурсов для различных служб Azure см. в статье [Поддерживаемые службы, схемы и категории для журналов диагностики Azure](../platform/diagnostic-logs-schema.md) .  
