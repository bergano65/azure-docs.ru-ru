---
title: Включить работоспособность гостевых Azure Monitor для виртуальных машин (Предварительная версия)
...
Следующие поставщики ресурсов Azure необходимо зарегистрировать для подписки, чтобы включить Azure Monitor для виртуальных машин работоспособности гостевой виртуальной машины. 
