...
>
>Новые клиенты должны установить [сопоставление служб решение](../vm/service-map.md) или [Azure Monitor для виртуальных машин](../vm/vminsights-overview.md).  Сопоставление служб набор данных сравним с данными передачи.  Azure Monitor для виртуальных машин включает набор данных Сопоставление служб с дополнительными данными о производительности и функциями для анализа. 
