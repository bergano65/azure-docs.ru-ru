...
2. Скачайте агент зависимостей Windows, используя ссылку в предыдущем разделе и затем запустите его с помощью следующей команды: `InstallDependencyAgent-Windows.exe`
