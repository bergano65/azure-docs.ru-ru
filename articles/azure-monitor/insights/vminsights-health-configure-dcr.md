...
| Property (Свойство) | Мониторы | Описание |
|:---|:---|:---|
...
| Монитор | Включен | Оповещение | Предупреждение | Критически важно | Периодичность оценки | лукбакк | Тип оценки | Пример min | Максимальное число выборок |
|:---|:---|:---|:---|:---|:---|:---|:---|:---|:---|
| загрузка ЦП;  | Да | Неверно | Нет | \> 90%    | 60 с | 240 с | Min | 2 | 3 |
| Объем доступной памяти | Да | Неверно | Нет | \< 100 МБ | 60 с | 240 с | Max | 2 | 3 |
| Файловая система      | Да | Неверно | Нет | \< 100 МБ | 60 с | 120 с | Max | 1 | 1 |
...
Переопределения определяются в [правиле сбора данных (ДКР)](../platform/data-collection-rule-overview.md). Вы можете создать несколько DCR с разными наборами переопределений и применить их к нескольким виртуальным машинам. Вы применяете ДКР к виртуальной машине, создав Ассоциацию, как описано в разделе [Настройка сбора данных для агента Azure Monitor (Предварительная версия)](../platform/data-collection-rule-azure-monitor-agent.md#data-collection-rule-associations).
...
| Property (Свойство) | Обязательный | Описание | 
|:---|:---|:---|
