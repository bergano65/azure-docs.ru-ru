...
Как правило, [решения по управлению](solutions.md) включают в себя одно или несколько представлений для визуализации данных.  В этой статье описывается, как экспортировать представление, созданное [конструктором представлений](../../azure-monitor/platform/view-designer.md) , и включить его в решение для управления.  
...
Чтобы экспортировать представление в файл, следуйте инструкциям [конструктора представлений Log Analytics](../../azure-monitor/platform/view-designer.md).  Экспортированный файл будет в формате JSON с теми же [элементами, что и в файле решения](solutions-solution-file.md).  
...
| Версия рабочей области | Версия API | query |
|:---|:---|:---|
