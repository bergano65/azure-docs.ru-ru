...
Как правило, [решения по управлению](solutions.md) включают одно или несколько представлений для визуализации данных.  В этой статье описывается, как экспортировать представление, созданное в [конструкторе представлений](../../azure-monitor/platform/view-designer.md), и добавить его в решение для управления.  
