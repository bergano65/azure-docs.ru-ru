...
[Решения для управления,](solutions.md) как правило, включают одно или несколько представлений для визуализации данных.  В этой статье описывается, как экспортировать представление, созданное [конструктором View,](../../azure-monitor/platform/view-designer.md) и включать его в решение управления.  
