...
| Контроллеры | Pod | событие | При выборе типа POD события фильтруются по его пространству имен. В заголовке области отображается пространство имен Pod. |
| Контроллеры | Контроллер | событие | Если контроллер выбран, события фильтруются по его пространству имен. В заголовке панели показано пространство имен контроллера. |
