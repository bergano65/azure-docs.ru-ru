...
>[!IMPORTANT]
>Если вы повторно настроить Azure AD для проверки подлинности пользователя, используя обновленные URI, очистите кэш обозревателя, чтобы маркер проверки подлинности обновленные будет загружена и применена.   
