...
- **Operations Manager** — это точно такой же агент, как Microsoft Monitoring Agent. Но в этой конфигурации он [подключается к группе управления Operations Manager](../../azure-monitor/platform/om-agents.md), которая в свою очередь подключена к Log Analytics. 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| [Анализ журнала действий](../../azure-monitor/platform/collect-activity-logs.md) | Таблицы Azure | | | | | | при уведомлении |
