...
| **Решение для мониторинга** | **Платформа** | **Microsoft Monitoring Agent** | **Агент Operations Manager** | **Хранилище Azure** | **Нужен ли Operations Manager?** | **Отправка данных агента Operations Manager через группу управления** | **Частота сбора** |
| --- | --- | --- | --- | --- | --- | --- | --- |
