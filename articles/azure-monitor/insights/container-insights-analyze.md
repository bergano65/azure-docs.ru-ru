...
> [!IMPORTANT]
> Azure Monitor для поддержки контейнеров для мониторинга кластера AKS под управлением Windows Server 2019 в настоящее время находится в общедоступной предварительной версии.
