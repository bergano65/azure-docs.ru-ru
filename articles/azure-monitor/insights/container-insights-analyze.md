...
| |Сообщение о состоянии |Доступность |  
|-------|-------|-----------------|  
...
|--------|-------------|
| Имя | Имя узла. |
| Сообщение о состоянии | Представление Kubernetes о состоянии узла. |
...
|--------|-------------|
| Название | Имя контроллера.|
| Сообщение о состоянии | Состояния контейнеров (при наличии). В таблице ниже приведены дополнительные сведения о значке состояния.|
...
- **Емкость диска**: Представляет диаграммы использования интерактивного диска для каждого диска, представленного на узле в контейнере, по следующим ракурсам:
    ...
    - Сетка, показанная для каждого диска узлов, процент используемой области, тренд процентного пространства, свободное место на диске (гиб) и тенденция свободного места на диске (гиб). Если в таблице выбрана строка, то ниже показан процент использованного места и свободного места на диске (гиб) 
...
- **Ввод-вывод диска**: Представляет диаграммы использования интерактивного диска для каждого диска, представленного на узле в контейнере, следующими перспективами.
    ...
    - Дисковые операции ввода-вывода, собранные по всем дискам, считываются в байтах/с, записываются байт/с и прочтенные и записываемые тренды (байт/с) 
    - Восемь диаграмм производительности с ключевыми показателями эффективности, которые помогают измерять и определять узкие места дискового ввода-вывода.
...
- **Сеть**. Представляет интерактивные диаграммы использования сети для каждого узла сетевой адаптер и сетку, представляющую ключевые показатели эффективности, которые помогают измерять производительность сетевых адаптеров.  
