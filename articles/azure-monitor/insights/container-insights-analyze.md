...
При переключении на вкладку **Узлы**, **Контроллеры** и **Контейнеры** в правой области страницы автоматически отображается панель свойств.  Он отображает свойства элемент выделен, включая метки, которые вы задали для организации объектов Kubernetes. Щелкните на панели ссылку **>>**, чтобы просмотреть или скрыть панель.  
