...
Страница по умолчанию открывается при выборе **аналитических сведений**  > **кластере**. В диаграммах с четырьмя линиями производительности отображаются ключевые метрики производительности кластера. 
...
![\<Name представление производительности контроллеров >](./media/container-insights-analyze/containers-controllers-view.png)
...
![представление производительности \<Name > контейнеров](./media/container-insights-analyze/containers-containers-view.png)
