...
> 
> ### <a name="q-is-it-possible-to-on-board-the-office-365-azure-monitor-solution-between-now-and-april-30th"></a>Вопрос. можно ли подключить решение Office 365 Azure Monitor между сейчас и 30 апреля?
> Нет, сценарии адаптации решения Azure Monitor Office 365 больше не доступны. Решение будет удалено 30 апреля.
> 
...
> - [Настройка автоматических ответов на угрозы в Azure Sentinel](../../sentinel/tutorial-respond-threats-playbook.md)
...
> 
> ###   <a name="q-what-will-happen-on-april-30-do-i-need-to-offboard-beforehand"></a>Вопрос. что произойдет 30 апреля? Нужно ли отключение заранее?
> 
...
> - Если вы не отключение решение вручную, ваши данные будут автоматически отключены 30 апреля.
> 
...
| UserType | Тип пользователя, выполнившего операцию.<br><br>Административный<br>Приложение<br>DcAdmin<br>Обычный<br>Reserved<br>ServicePrincipal<br>System |
...
| Actor | Пользователь или субъект-служба, которые выполнили действие. |
