...
| UserType | Тип пользователя, выполнившего операцию.<br><br>Администратор<br>Приложение<br>DcAdmin<br>Обычный<br>Зарезервированное<br>ServicePrincipal<br>Система |
