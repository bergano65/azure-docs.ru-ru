...
- Имя группы ресурсов: группа ресурсов, в которой содержится рабочая область.
- Идентификатор подписки Azure: подписка, в которой содержится рабочая область.
...
- Идентификатор клиента: 16-значная строка, представляющая клиента Office 365.
...
Вы можете удалить решение по управлению Office 365 с помощью процесса, описанного в этом [разделе](solutions.md#remove-a-management-solution). Однако это не остановит сбор данных в Office 365 и последующую их отправку в Log Analytics. Выполните процедуру ниже, чтобы отменить подписку на Office 365 и прекратить сбор данных.
