...
| Аналитика SQL Azure, параметр | Описание: | Поддержка базы данных SQL | Поддержка Управляемый экземпляр SQL |
| --- | ------- | ----- | ----- |
...
После загрузки на плитке отображается количество баз данных и эластичных пулов в базе данных SQL, а также управляемых экземпляров и баз данных экземпляров в SQL Управляемый экземпляр, из которых Аналитика SQL Azure получает данные телеметрии диагностики.
...
При выборе представления SQL Управляемый экземпляр отображаются сведения об использовании управляемого экземпляра, содержащихся в ней базах данных, а также данные телеметрии о запросах, выполняемых в экземпляре.
