...
| --- | --- | --- |
| [Система диагностики Azure](../platform/collect-azure-metrics-logs.md) | **Да** | Данные метрик и журналов Azure отправляются в журналы Azure Monitor непосредственно в Azure. |
...
| Истечение выделенного времени | Предоставляет подробные данные о времени ожидания SQL в базах данных в иерархическом виде. | Да | Нет |
| Блокировки | Предоставляет подробные данные о блокировках SQL в базах данных в иерархическом виде. | Да | Нет |
| Ожидания баз данных | Предоставляет подробную статистику времени ожидания SQL на уровне базы данных в иерархическом виде. Включает сводку по общему времени ожидания и времени ожидания для каждого типа ожидания. |Да | Да |
| Длительность запроса | Предоставляет подробную статистику о выполнении запросов, такую как продолжительность запроса, загрузку ЦП, число операций ввода-вывода данных, число операций ввода-вывода журнала, в иерархическом виде. | Да | Да |
| Ожидания запросов | Предоставляет подробную статистику времени ожидании запросов по категории ожидания в иерархическом виде. | Да | Да |
