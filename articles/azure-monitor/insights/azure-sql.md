...
| Аналитика SQL Azure, параметр | Описание | Поддержка одной базы данных и эластичных пулов в составе пула | Поддержка баз данных управляемых экземпляров и экземпляров |
| --- | ------- | ----- | ----- |
| Resource by type (Ресурсы по типу) | Перспектива, в которой представлено число всех отслеживаемых ресурсов. | Да | Да |
| Подробные сведения | Предоставляет подробные сведения о производительности Intelligent Insights в иерархическом виде. | Да | Да |
