...
|:--- |:--- |:--- |
| accountName |string |Учетная запись службы автоматизации Azure. |
| pricingTier |string |Ценовая категория рабочей области Log Analytics и учетной записи службы автоматизации Azure. |
| regionId |string |Регион службы автоматизации Azure. |
| solutionName |string |Имя решения.  При развертывании решения с использованием шаблонов быстрого запуска следует указать solutionName как параметр, чтобы можно было определить строку и не требовалось, чтобы ее указывал пользователь. |
| workspaceName |string |Имя рабочей области Log Analytics. |
| workspaceRegionId |string |Регион рабочей области Log Analytics. |
...
|:--- |:--- |
| workspaceResourceId |ИДЕНТИФИКАТОР рабочей области Log Analytics в форме *\<идентификатор группы ресурсов >/провидерс/микрософт.оператионалинсигхтс/воркспацес/\<имя рабочей области\>* . |
