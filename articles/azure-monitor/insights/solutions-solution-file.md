...
| Description (Описание) |Необязательное описание параметра.  Отображается в информационном всплывающем предупреждении возле параметра. |
...
| Свойство | Описание |
|:--- |:--- |
| workspaceResourceId |ИДЕНТИФИКАТОР рабочей области Log Analytics в формате *\<Resource идентификатор группы >/провидерс/микрософт.оператионалинсигхтс/воркспацес/\<Workspace Name \>* . |
