...
| Свойство | ОПИСАНИЕ |
|:--- |:--- |
| workspaceResourceId |Идентификатор рабочей области Log Analytics в виде  *\<идентификатор группы ресурсов > /providers/Microsoft.OperationalInsights/workspaces/\<имя рабочей области\>* . |
