...
5. Проверьте журналы агента. При развертывании контейнерного агента он выполняет быструю проверку, используя команды OMI, и отображает версию агента и поставщика.

6. Чтобы убедиться, что агент успешно развернут, выполните команду:`kubectl logs omsagent-484hw --namespace=kube-system`
