...
Чтобы настроить сценарий масштабирования, использующий политику Azure, Azure PowerShell или шаблоны Azure Resource Manager, необходимо установить решение *вминсигхтс* . Это можно сделать одним из следующих способов:
...
### <a name="azure-arc-machines"></a>Компьютеры ARC в Azure
Azure Monitor для виртуальных машин доступен для серверов с поддержкой ARC в Azure в регионах, где доступна служба расширения ARC. Чтобы включить Azure Monitor для виртуальных машин на серверах с поддержкой Arc, пользователям необходимо запустить агент Arc версии 0,9 или более поздней.
...
|------------------|--------|-------------|
| Одна виртуальная машина Azure, Azure VMSS или машина Arc Azure | [Включение на портале](vminsights-enable-single-vm.md) | Выберите **Insights** непосредственно в меню в портал Azure. |
| Несколько виртуальных машин Azure, Azure VMSS или Azure Arc | [Включить с помощью политики Azure](vminsights-enable-at-scale-policy.md) | Используйте политику Azure для автоматического включения при создании виртуальной машины или VMSS. |
| | [Включение с помощью Azure PowerShell или шаблонов Azure Resource Manager](vminsights-enable-at-scale-powershell.md) | Используйте шаблоны Azure PowerShell или Azure Resource Manager, чтобы включить несколько виртуальных машин Azure, виртуальной машины Azure Arc или Azure VMSS в указанной подписке или группе ресурсов. |
| Гибридное облачное решение | [Включить для гибридной среды](vminsights-enable-hybrid-cloud.md) | Развертывание на виртуальных машинах или физических компьютерах, размещенных в вашем центре обработки данных или в других облачных средах. |
