...
| Гибридное облако | [Включить для гибридной среды](vminsights-enable-hybrid-cloud.md) | Развертывание на виртуальных машинах или физических компьютерах, размещенных в вашем центре обработки данных или в других облачных средах. |
