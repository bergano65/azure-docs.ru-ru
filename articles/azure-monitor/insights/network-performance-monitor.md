...
Используйте основные процессы для установки агентов при [подключении компьютеров Windows к Azure Monitor](../platform/agent-windows.md), [Подключите компьютеры Linux к Azure Monitor (Предварительная версия)](../../virtual-machines/extensions/oms-linux.md) и [Подключите Operations Manager к Azure Monitor](../platform/om-agents.md).
...
2. Если вы решили ввести адрес электронной почты напрямую, будет создана группа действий с именем **NPM email ActionGroup** , а в эту группу действий будет добавлен идентификатор электронной почты.
