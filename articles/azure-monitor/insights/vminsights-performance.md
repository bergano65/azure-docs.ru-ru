...
Ознакомьтесь с общими сведениями о [сборе метрик и журналов с помощью Azure Monitor](../platform/data-collection.md), чтобы лучше разобраться в фундаментальных различиях и других вопросах, прежде чем настраивать сбор дополнительных метрик и правила генерации оповещений.  
