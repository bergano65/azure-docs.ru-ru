...
Здесь можно изменить поисковый запрос в соответствии с определенной задачей. Дополнительные сведения о поиске по журналам см. в разделе [Поиск данных по журналам в Log Analytics](../log-query/log-query-overview.md).
