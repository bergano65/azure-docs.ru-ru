...
* Добавьте решение для мониторинга VMware в подписку, используя процесс, описанный в разделе [Установка решения по управлению](../../azure-monitor/insights/solutions.md#install-a-management-solution).
