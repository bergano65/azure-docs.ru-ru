...
|----------|-------------| 
| **Область действия** | Группа управления и подписки, к которым вы имеете доступ или которые наследуются с возможностью детализации по иерархии группы управления.|
...
| Состояние соответствия | Description | 
|------------------|-------------|
...
| **Блокировка** | У вас недостаточно прав доступа к группе управления. <sup>1</sup> | 
...
| Состояние назначения | Description | 
|------------------|-------------|
| **Успешно** | На всех виртуальных машинах в области разворачиваются Log Analytics и агенты зависимостей.|
