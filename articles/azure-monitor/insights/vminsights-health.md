...
| Имя монитора | Частота (мин.) | Длительность лукбакк (мин.) | Оператор | Порог | Оповещение о состоянии | Серьезность | Категория рабочей нагрузки | 
|--------------|-----------|----------|----------|-----------|----------------|----------|-------------------|
| Логический диск в сети | 5 | 15 | <> | 1 (true) | Критический | Sev1 | Linux | 
| свободное пространство на логическом диске; | 5 | 15 | < | 200 МБ (предупреждение)<br> 100 МБ (критическое) | Предупреждение | Sev1<br> Уровень 2 | Linux | 
...
| Состояние сетевого адаптера | 5 | 15 | <> | 1 (true) | Предупреждение | Уровень 2 | Linux | 
| Объем доступной памяти операционной системы (МБ) | 5 | 10 | < | 2,5 МБ | Критический | Sev1 | Linux | 
| Среднее время чтения с диска (с) | 5 | 25 | > | 0,05 с | Критический | Sev1 | Linux | 
| Среднее время обращения к диску (сек.) | 5 | 25 | > | 0,05 с | Критический | Sev1 | Linux | 
| СР. время записи на диск (сек.) " | 5 | 25 | > | 0,05 с | Критический | Sev1 | Linux | 
| Состояние диска | 5 | 25 | <> | 1 (true) | Критический | Sev1 | Linux | 
| Общий процент загрузки процессора операционной системы | 5 | 10 | >= | 95% | Критический | Sev1 | Linux | 
...
| среднее время на операцию чтения, секунд (логический диск); | 1 | 15 | > | 0,04 с | Предупреждение | Уровень 2 | Windows | 
| среднее время на операцию перемещения, секунд (логический диск); | 1 | 15 | > | 0,04 с | Предупреждение | Уровень 2 | Windows | 
| Среднее время обращения к логическому диску (с) на операцию записи (логический диск) | 1 | 15 | > | 0,04 с | Предупреждение | Уровень 2 | Windows | 
| текущая длина очереди диска (логический диск); | 5 | 60 | >= | 32 | Предупреждение | Уровень 2 | Windows | 
| Свободное место на логическом диске (МБ) | 15 | 60 | > | 500 МБ предупреждений<br> 300 МБ критическое | Критический | Sev1<br> Уровень 2 | Windows | 
| Свободное место на логическом диске (%) | 15 | 60 | > | предупреждение 10%<br> 5% критическое | Критический | Sev1<br> Уровень 2 | Windows |
| процент времени простоя логического диска; | 15 | 360 | <= | 20 % | Предупреждение | Уровень 2 | Windows | 
| процент используемой пропускной способности чтения; | 5 | 60 | >= | 60 % | Предупреждение | Уровень 2 | Windows | 
| процент используемой общей пропускной способности; | 5 | 60 | >= | 75 % | Предупреждение | Уровень 2 | Windows | 
| процент используемой пропускной способности записи; | 5 | 60 | >= | 60 % | Предупреждение | Уровень 2 | Windows | 
...
| среднее время на операцию перемещения, секунд (диск); | 1 | 15 | > | 0,04 с | Предупреждение | Уровень 2 | Windows | 
| Среднее время записи на диск (сек.) | 1 | 15 | > | 0,04 с | Предупреждение | Уровень 2 | Windows | 
| Текущая длина очереди диска | 5 | 60 | >= | 32 | Предупреждение | Уровень 2 | Windows | 
| процент времени простоя диска; | 5 | 60 | >= | 20 % | Предупреждение | Уровень 2 | Windows | 
