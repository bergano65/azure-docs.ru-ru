...
|--------------|-----------|----------|----------|-----------|----------------|----------|-------------------|
| Логический диск в сети | 5 | 15 | <> | 1 (true) | Critical | Sev1 | Linux | 
...
| свободные дескрипторы на логическом диске (в процентах); | 5 | 15 | < | 5 % | Critical | Sev1 | Linux | 
| свободное пространство на логическом диске (в процентах); | 5 | 15 | < | 5 % | Critical | Sev1 | Linux | 
| Состояние сетевого адаптера | 5 | 15 | <> | 1 (true) | Предупреждение | Sev2 | Linux | 
| Объем доступной памяти операционной системы (МБ) | 5 | 10 | < | 2,5 МБ | Critical | Sev1 | Linux | 
| Среднее время чтения с диска (с) | 5 | 25 | > | 0,05 с | Critical | Sev1 | Linux | 
| Среднее время обращения к диску (сек.) | 5 | 25 | > | 0,05 с | Critical | Sev1 | Linux | 
| СР. время записи на диск (сек.) " | 5 | 25 | > | 0,05 с | Critical | Sev1 | Linux | 
| Состояние диска | 5 | 25 | <> | 1 (true) | Critical | Sev1 | Linux | 
| Общий процент загрузки процессора операционной системы | 5 | 10 | >= | 95% | Critical | Sev1 | Linux | 
| общий процент использования ЦП; | 5 | 10 | >= | 95% | Critical | Sev1 | Windows | 
| ошибка или повреждение файловой системы; | 60 | 60 | <> | 4 | Critical | Sev1 | Windows | 
| среднее время на операцию чтения, секунд (логический диск); | 1 | 15 | > | 0,04 с | Предупреждение | Sev2 | Windows | 
| среднее время на операцию перемещения, секунд (логический диск); | 1 | 15 | > | 0,04 с | Предупреждение | Sev2 | Windows | 
...
| Свободное место на логическом диске (МБ) | 15 | 60 | > | 500 МБ предупреждений<br> 300 МБ критическое | Critical | Sev1<br> Sev2 | Windows | 
| Свободное место на логическом диске (%) | 15 | 60 | > | предупреждение 10%<br> 5% критическое | Critical | Sev1<br> Sev2 | Windows |
...
| работоспособность службы DHCP-клиента; | 5 | 12 | <> | 4 (работает) | Critical | Sev1 | Windows | 
| работоспособность службы DNS-клиента; | 5 | 12 | <> | 4 (работает) | Critical | Sev1 | Windows | 
| работоспособность службы журнала событий Windows; | 5 | 12 | <> | 4 (работает) | Critical | Sev1 | Windows | 
| работоспособность службы брандмауэра Windows; | 5 | 12 | <> | 4 (работает) | Critical | Sev1 | Windows | 
| работоспособность службы RPC; | 5 | 12 | <> | 4 (работает) | Critical | Sev1 | Windows | 
| работоспособность службы сервера; | 5 | 12 | <> | 4 (работает) | Critical | Sev1 | Windows | 
| работоспособность службы удаленного управления Windows. | 5 | 12 | <> | 4 (работает) | Critical | Sev1 | Windows | 
| доступный объем памяти, мегабайт; | 5 | 10 | < | 100 МБ | Critical | Sev1 | Windows | 
| Свободные записи системной таблицы страниц | 5 | 10 | <= | 5000 | Critical | Sev1 | Windows | 
| страниц памяти в секунду; | 5 | 10 | >= | 5000/с | Предупреждение | Sev1 | Windows | 
| процент используемой выделенной памяти; | 5 | 10 | > | 80 % | Critical | Sev1 | Windows | 
| среднее время на операцию перемещения, секунд (диск); | 1 | 15 | > | 0,04 с | Предупреждение | Sev2 | Windows | 
