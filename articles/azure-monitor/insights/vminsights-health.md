...
| Имя монитора | Частота (мин.) | Длительность лукбакк (мин.) | Оператор | Порог | Оповещение о состоянии | Severity | Категория рабочей нагрузки | 
|--------------|-----------|----------|----------|-----------|----------------|----------|-------------------|
| Логический диск в сети | 5 | 15 | <> | 1 (true) | Критические важное | Sev1 | Linux | 
| Свободное место на логическом диске | 5 | 15 | < | 200 МБ (предупреждение)<br> 100 МБ (критическое) | Предупреждение | Sev1<br> Sev2 | Linux | 
| Процент свободных индексных дескрипторов на логическом диске | 5 | 15 | < | 5 % | Критические важное | Sev1 | Linux | 
| Процент свободного места на логическом диске | 5 | 15 | < | 5 % | Критические важное | Sev1 | Linux | 
| Состояние сетевого адаптера | 5 | 15 | <> | 1 (true) | Предупреждение | Sev2 | Linux | 
| Объем доступной памяти операционной системы (МБ) | 5 | 10 | < | 2,5 МБ | Критические важное | Sev1 | Linux | 
| Среднее время чтения с диска (с) | 5 | 25 | > | 0,05 с | Критические важное | Sev1 | Linux | 
| Среднее время обращения к диску (сек.) | 5 | 25 | > | 0,05 с | Критические важное | Sev1 | Linux | 
| СР. время записи на диск (сек.) " | 5 | 25 | > | 0,05 с | Критические важное | Sev1 | Linux | 
| Состояние диска | 5 | 25 | <> | 1 (true) | Критические важное | Sev1 | Linux | 
| Общий процент загрузки процессора операционной системы | 5 | 10 | >= | 95% | Критические важное | Sev1 | Linux | 
| Общий процент использования ЦП | 5 | 10 | >= | 95% | Критические важное | Sev1 | Windows | 
| Ошибка файловой системы или повреждение данных | 60 | 60 | <> | 4 | Критические важное | Sev1 | Windows | 
| Ср. время чтения с логического диска (сек.) | 1 | 15 | > | 0,04 с | Предупреждение | Sev2 | Windows | 
| Ср. время обращения к логическому диску (сек.) | 1 | 15 | > | 0,04 с | Предупреждение | Sev2 | Windows | 
| Среднее время обращения к логическому диску (с) на операцию записи (логический диск) | 1 | 15 | > | 0,04 с | Предупреждение | Sev2 | Windows | 
| Текущая длина очереди диска (логический диск) | 5 | 60 | >= | 32 | Предупреждение | Sev2 | Windows | 
| Свободное место на логическом диске (МБ) | 15 | 60 | > | 500 МБ предупреждений<br> 300 МБ критическое | Критические важное | Sev1<br> Sev2 | Windows | 
| Свободное место на логическом диске (%) | 15 | 60 | > | предупреждение 10%<br> 5% критическое | Критические важное | Sev1<br> Sev2 | Windows |
| Процент времени бездействия логического диска | 15 | 360 | <= | 20% | Предупреждение | Sev2 | Windows | 
| Процентное значение используемой пропускной способности при чтении | 5 | 60 | >= | 60% | Предупреждение | Sev2 | Windows | 
| Суммарное значение используемой пропускной способности в процентах | 5 | 60 | >= | 75% | Предупреждение | Sev2 | Windows | 
| Процент используемой пропускной способности при записи | 5 | 60 | >= | 60% | Предупреждение | Sev2 | Windows | 
| Работоспособность службы DHCP-клиента | 5 | 12 | <> | 4 (работает) | Критические важное | Sev1 | Windows | 
| Работоспособность службы DNS-клиента | 5 | 12 | <> | 4 (работает) | Критические важное | Sev1 | Windows | 
| Работоспособность службы журнала событий Windows | 5 | 12 | <> | 4 (работает) | Критические важное | Sev1 | Windows | 
| работоспособность службы брандмауэра Windows; | 5 | 12 | <> | 4 (работает) | Критические важное | Sev1 | Windows | 
| Работоспособность службы RPC | 5 | 12 | <> | 4 (работает) | Критические важное | Sev1 | Windows | 
| Работоспособность службы сервера | 5 | 12 | <> | 4 (работает) | Критические важное | Sev1 | Windows | 
| работоспособность службы удаленного управления Windows. | 5 | 12 | <> | 4 (работает) | Критические важное | Sev1 | Windows | 
| Объем доступной памяти в мегабайтах | 5 | 10 | < | 100 МБ | Критические важное | Sev1 | Windows | 
| Свободные записи системной таблицы страниц | 5 | 10 | <= | 5000 | Критические важное | Sev1 | Windows | 
| Память\Страниц в секунду | 5 | 10 | >= | 5000/с | Предупреждение | Sev1 | Windows | 
| Процент используемой выделенной памяти | 5 | 10 | > | 80 % | Критические важное | Sev1 | Windows | 
| Среднее время обращения к диску (сек.) | 1 | 15 | > | 0,04 с | Предупреждение | Sev2 | Windows | 
| Среднее время записи на диск (сек.) | 1 | 15 | > | 0,04 с | Предупреждение | Sev2 | Windows | 
...
>[!NOTE]
>Частота указывает, как часто оповещение метрики проверяет, выполняются ли условия, например каждую минуту.  Это скорость, с которой выполняется критерий работоспособности, а лукбакк — это время, в течение которого оценивается критерий работоспособности. Например, критерий работоспособности оценивает, превышает ли состояние **загрузки ЦП** более 95% с частотой 5 минут и остается больше 95% в течение 15 минут (3 последовательных цикла оценки), после чего состояние обновляется до критической серьезности, если оно еще не было.
...
| |Неизвестно |Невозможно вычислить состояние по нескольким причинам. В следующем разделе приведены дополнительные сведения и возможные решения. |
...
* **Type**. Существует три типа критериев работоспособности для оценки условий и свертки общего состояния работоспособности отслеживаемой виртуальной машины.
...
|Severity |Чтобы включить оповещения всех уровней, выберите уровни оповещения или **Все**. |
