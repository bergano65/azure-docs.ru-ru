...
* [Монитор ЭкспрессРут](https://docs.microsoft.com/azure/networking/network-monitoring-overview#expressroute-monitor)
...
**У меня есть две подсети (A и B), и у меня есть несколько агентов на каждой подсети. Монитор производительности отслеживает подключение от всех агентов в подсети А ко всем агентам в подсети B. Будет ли взиматься плата в зависимости от количества межподсетевых соединений?**
...
Плата за проглатывание (загрузка данных в рабочее пространство Log Analytics в Azure Monitor, обработка и индексирование) доступна на [странице ценообразования](https://azure.microsoft.com/pricing/details/log-analytics/) для Log Analytics в разделе Заглатывает данные. Плата за хранение данных (то есть, данные, сохраняемые по желанию клиента по истечении первого месяца использования) также доступна на [странице цен](https://azure.microsoft.com/pricing/details/log-analytics/) в разделе о приеме данных.
...
**Я использую ExpressRoute монитор для мониторинга нескольких схем ExpressRoute. Взимается ли я в зависимости от количества отслеживаемых схем?**
...
Обратитесь в раздел [мониторинга подключения](https://azure.microsoft.com/pricing/details/network-watcher/) для расходов на мониторинг конечной точки в течение всего месяца. Для Log Analytics плата за данные доступна на [странице цен](https://azure.microsoft.com/pricing/details/log-analytics/) в разделе о приеме данных.
