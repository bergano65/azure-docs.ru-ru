...
| Книга | Описание | Область видимости |
|----------|-------------|-------|
...
| Подключения | Подключения предоставляют подробные сведения о входящих и исходящих подключениях с отслеживаемых виртуальных машин. | В большом масштабе |
...
| Безопасность и порты | Анализ трафика TCP/IP, который сообщает об общих подключениях, вредоносных подключениях, где конечные точки IP находятся глобально.  Чтобы включить все компоненты, необходимо включить обнаружение безопасности. | В большом масштабе |
...
| Подключения | Подключения предоставляют подробные сведения о входящих и исходящих подключениях к виртуальной машине. | Одиночная виртуальная машина |
