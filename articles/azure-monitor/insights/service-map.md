...
Чтобы просмотреть данные о производительности, может потребоваться [включить соответствующие счетчики производительности Log Analytics](../platform/data-sources-performance-counters.md).  Счетчики, которые потребуется включить:
