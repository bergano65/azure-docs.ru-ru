...
ms.locfileid: "84204656"
---
# <a name="understand-monitoring-costs-for-azure-monitor-for-containers"></a>Общие сведения о затратах на мониторинг Azure Monitor для контейнеров
...
Рассмотрим ситуацию, в которой различные организационные ресурсы подразделения Организации Kubernetes инфраструктуру и рабочую область Log Analytics. Для каждого подразделения, разделенного пространством имен Kubernetes. Вы можете визуализировать объем данных, принимаемых в каждой рабочей области, с помощью недавно выпущенной книги. Книга "сведения **об использовании контейнеров** ", которая находится в [коллекции книг](../platform/workbooks-overview.md#getting-started), помогает визуализировать источник данных без необходимости создавать собственную библиотеку запросов, предоставляемых в нашей документации. В этой книге есть диаграммы, с помощью которых можно просматривать оплачиваемые данные с таких перспектив, как:
