---
title: Мониторинг поверхностных концентраторов с помощью azure Monitor Документы Майкрософт
...
1. Войдите в Intune.
2. Перейдите к **настройкам подключенных** > **источников.**
...
6. Нажмите **OK,** чтобы завершить конфигурацию.
