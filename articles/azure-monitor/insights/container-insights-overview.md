...
- В Windows нет метрики RSS в памяти, поэтому она недоступна для узлов и контейнеров Windows. Доступна метрика [рабочего набора](https://docs.microsoft.com/windows/win32/memory/working-set) .
