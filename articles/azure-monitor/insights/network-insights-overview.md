---
title: Аналитические сведения о сети
description: Обзор Network Insights, который предоставляет исчерпывающее представление о работоспособности и метриках для всех развернутых сетевых ресурсов без какой-либо настройки.
ms.subservice: ''
ms.topic: conceptual
author: KumudD
ms.author: kumud
...
ms.locfileid: "96751773"
---
# <a name="network-insights"></a>Аналитические сведения о сети

> [!NOTE]
> *Network Insights* ранее назывался *Azure Monitor для сетей*. 

Network Insights предоставляет исчерпывающее представление о [работоспособности](../../service-health/resource-health-checks-resource-types.md) и [метриках](../platform/metrics-supported.md) для всех развернутых сетевых ресурсов, не требуя настройки. Он также предоставляет доступ к возможностям мониторинга сети, таким как [монитор подключения](../../network-watcher/connection-monitor-preview.md), [ведение журнала потоков для групп безопасности сети (группы безопасности сети)](../../network-watcher/network-watcher-nsg-flow-logging-overview.md)и [аналитика трафика](../../network-watcher/traffic-analytics.md). И предоставляет другие функции [диагностики](../../network-watcher/network-watcher-monitoring-overview.md#diagnostics) сети.

Network Insights структурирован вокруг следующих ключевых компонентов мониторинга:
...
На странице Обзор Network Insights можно легко визуализировать данные инвентаризации сетевых ресурсов, а также **сведения** о работоспособности и предупреждениях ресурсов. Он делится на четыре ключевых функциональных области: Поиск и фильтрация, работоспособность ресурсов и метрики, оповещения и представление зависимостей.
...
[![Снимок экрана, показывающий результаты поиска Network Insights.](media/network-insights-overview/search.png)](media/network-insights-overview/search.png#lightbox)
...
![Снимок экрана, на котором показана работоспособность ресурсов и метрики в Network Insights.](media/network-insights-overview/resource-health.png)

Если вы выберете недоступные подключения ER и VPN, отобразится представление метрики: 

![Снимок экрана, показывающий представление метрики в Network Insights.](media/network-insights-overview/metric-view.png)
...
![Сриншот, отображающий представление шлюза приложений в Network Insights.](media/network-insights-overview/application-gateway.png)
...
[![Снимок экрана, показывающий представление зависимостей в Network Insights.](media/network-insights-overview/dependency-view.png)](media/network-insights-overview/dependency-view.png#lightbox)
...
![Снимок экрана, показывающий меню "представление зависимостей" в Network Insights.](media/network-insights-overview/dependency-view-menu.png)
...
![Снимок экрана, на котором показан пример поиска в Network Insights.](media/network-insights-overview/search-example.png)
...
![Снимок экрана, на котором показана вкладка "подключение" в службе Network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-tab.png)
...
[![Снимок экрана, на котором показаны проверки подключения в Network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-tests.png)](media/network-insights-overview/azure-monitor-for-networks-connectivity-tests.png#lightbox)

Чтобы открыть представление метрики, можно выбрать любую плитку источника или назначения.

[![Снимок экрана, показывающий метрики подключения в Network Insights.](media/network-insights-overview/azure-monitor-for-networks-connectivity-metrics.png)](media/network-insights-overview/azure-monitor-for-networks-connectivity-metrics.png#lightbox)
...
[![Снимок экрана, на котором показана вкладка "трафик" в Network Insights.](media/network-insights-overview/azure-monitor-for-networks-traffic-view.png)](media/network-insights-overview/azure-monitor-for-networks-traffic-view.png#lightbox)
...
[![Снимок экрана, показывающий представление области трафика в Network Insights.](media/network-insights-overview/azure-monitor-for-networks-traffic-region-view.png)](media/network-insights-overview/azure-monitor-for-networks-traffic-region-view.png#lightbox)
...
Этот раздел поможет в диагностике и устранении некоторых распространенных проблем, которые могут возникнуть при использовании Network Insights. 
...
Дополнительные сведения об устранении неполадок, связанных с сетью, которые можно определить с помощью Network Insights, см. в документации по устранению неполадок для неисправного ресурса. 
