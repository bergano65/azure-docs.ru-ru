---
title: Предварительная версия Azure Monitor для сетей
...
![Снимок экрана, на котором показана страница обзора.](media/network-insights-overview/overview.png)
...
![Снимок экрана, на котором показано Azure Monitor для результатов поиска в сетях.](media/network-insights-overview/search.png)
...
![Снимок экрана, на котором показано представление зависимостей в Azure Monitor для сетей.](media/network-insights-overview/dependency-view.png)
...
Вкладка **Подключение** позволяет легко визуализировать все тесты, настроенные с помощью монитора подключения и [монитора подключений (Предварительная версия)](../../network-watcher/connection-monitor-preview.md) , для выбранного набора подписок.
...
![Снимок экрана, на котором показаны проверки подключения в Azure Monitor для сетей.](media/network-insights-overview/azure-monitor-for-networks-connectivity-tests.png)

Чтобы открыть представление метрики, можно выбрать любую плитку источника или назначения.

![Снимок экрана, показывающий метрики подключения в Azure Monitor для сетей.](media/network-insights-overview/azure-monitor-for-networks-connectivity-metrics.png)
...
![Снимок экрана, на котором показана вкладка "трафик" в Azure Monitor для сетей.](media/network-insights-overview/azure-monitor-for-networks-traffic-view.png)
...
![Снимок экрана, показывающий представление области трафика в Azure Monitor для сетей.](media/network-insights-overview/azure-monitor-for-networks-traffic-region-view.png)
