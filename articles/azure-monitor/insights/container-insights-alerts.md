...
Выполните следующие действия, чтобы создать оповещение журнала в Azure Monitor с помощью одного из указанных выше правил поиска журналов. Сведения о создании с помощью шаблона ARM см. в статье [примеры создания оповещений журнала с помощью шаблона ресурсов Azure](../platform/alerts-log-create-templates.md).
