...
```
Следующий запрос возвращает счетчики этапов Pod на основе всех фаз: *Сбой*,ожидание, неизвестное, *запущено*или *успешно*.  
...
2. На панели слева выберите **монитор** . Вразделе "аналитика"выберите контейнеры.
