...
- При включении мониторинга с помощью метода PowerShell необходимо использовать [PowerShell Core](https://docs.microsoft.com/powershell/scripting/install/installing-powershell?view=powershell-6) .
