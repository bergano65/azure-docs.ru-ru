---
title: Решение для управления в передовых методах Azure
description: В этой статье узнайте советы по созданию файла управленческих решений. Узнайте, как работать с источниками данных, рунами, представлениями и оповещениями.
ms.subservice: ''
ms.topic: conceptual
author: bwren
ms.author: bwren
