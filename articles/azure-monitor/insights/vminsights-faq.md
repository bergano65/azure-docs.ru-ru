...
description: Ответы на часто задаваемые вопросы по Azure Monitor для виртуальных машин, которые отслеживают работоспособность и производительность виртуальных машин Azure в дополнение к автоматическому обнаружению и сопоставлению компонентов приложения и их зависимостей.
...
Дополнительные сведения о включенных счетчиках производительности см. в нашей [обзорной статье о включении](vminsights-enable-overview.md#performance-counters-enabled) .
...
Если вы решили использовать метод на основе сценария, эти действия описаны в статье [включение Azure Monitor для виртуальных машин (Предварительная версия) с использованием Azure PowerShell или диспетчер ресурсов шаблона](vminsights-enable-at-scale-powershell.md) . 
