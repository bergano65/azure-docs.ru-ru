...
- Вы являетесь членом **[владельца](https://docs.microsoft.com/en-us/azure/role-based-access-control/built-in-role.md#owner)** роли на ресурс кластера AKS. 
