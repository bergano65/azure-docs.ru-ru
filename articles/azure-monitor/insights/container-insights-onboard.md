...
- Подсистема AKS в [Azure Stack](https://docs.microsoft.com/azure-stack/user/azure-stack-kubernetes-aks-engine-overview?view=azs-1908) или Kubernetes, развернутая локально.
...
|------------------|--------|-------------|
| Новый кластер Kubernetes | [Создание кластера AKS с помощью Azure CLI](../../aks/kubernetes-walkthrough.md#create-aks-cluster)| Вы можете включить мониторинг нового кластера AKS, созданного с помощью Azure CLI. |
...
| Существующий кластер Kubernetes | [Включение для кластера AKS с помощью Azure CLI](container-insights-enable-existing-clusters.md#enable-using-azure-cli) | Вы можете включить мониторинг кластера AKS, уже развернутого с помощью Azure CLI. |
