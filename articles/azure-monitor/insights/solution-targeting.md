...
### <a name="1-create-a-computer-group"></a>1. Создание компьютерной группы
 ...
 **Конфигурация области** включает в себя одну или несколько групп компьютеров и может применяться к одному или нескольким решениям. 
 ...
 6. Выберите созданную вами группу компьютеров и, при необходимости, другие группы, которые необходимо добавить в конфигурацию.  Нажмите **Выберите**.  
