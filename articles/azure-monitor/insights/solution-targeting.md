...
- Дополнительные сведения о решениях по управлению, включая решения, которые доступны для установки в вашей среде, см. в статье [Добавление решений для управления Azure Log Analytics в рабочую область](solutions.md).
- Дополнительные сведения о создании групп компьютеров см. в статье [Использование групп компьютеров при поиске по журналам Log Analytics](../../azure-monitor/platform/computer-groups.md).
