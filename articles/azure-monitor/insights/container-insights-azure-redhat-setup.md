...
>
> Следуйте указаниям этого руководством, чтобы [создать кластер Azure Red Hat OpenShift 4](https://docs.microsoft.com/azure/openshift/tutorial-create-cluster).
