...
> [!NOTE]
> Начиная с 14 мая 2018 г., все оповещения в экземпляре публичного облака Azure рабочей области Log Analytics начали автоматически распространяться на Azure. Дополнительные сведения см. в статье об [отображении оповещений в Azure](../../monitoring-and-diagnostics/monitoring-alerts-extend.md). Теперь действия пользователей, которые отображают оповещения в Azure, контролируются в группах действий Azure. Если рабочая область и ее оповещения перенесены в Azure, можно извлечь или добавить действия с помощью [группы действий (шаблон Azure Resource Manager)](../../monitoring-and-diagnostics/monitoring-create-action-group-with-resource-manager-template.md).
