...
System Center Operations Manager (SCOM) обеспечивает детальный мониторинг рабочих нагрузок на виртуальных машинах. Сравнение платформ мониторинга и стратегий реализации см. в статье [Руководство по облачному мониторингу](/azure/cloud-adoption-framework/manage/monitor/).
