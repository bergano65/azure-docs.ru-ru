...
Перед началом работы убедитесь, что вы являетесь членом **[владельца](../../role-based-access-control/built-in-roles.md#owner)** роли ресурс кластера AKS, чтобы включить сбор данных узла и pod метрики производительности. 
