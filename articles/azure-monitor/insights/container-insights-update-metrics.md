...
* Вы являетесь членом роли **[владельца](../../role-based-access-control/built-in-roles.md#owner)** в ресурсе кластера AKS, чтобы включить сбор настраиваемых метрик производительности node и Pod.
