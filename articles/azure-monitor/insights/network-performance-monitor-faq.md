...
Возможность наблюдения за сетями с помощью узлов на основе Linux теперь является общедоступной. Соответствующий [агент.](../../virtual-machines/extensions/oms-linux.md) Агенты Linux поддерживают при работе с решением "Монитор производительности сети" только функцию мониторинга производительности. Мониторинг подключений службы и (или) ExpressRoute не поддерживается.
