...
Возможность наблюдения за сетями с помощью узлов на основе Linux теперь является общедоступной. Соответствующий [агент.](../../virtual-machines/extensions/oms-linux.md) 
