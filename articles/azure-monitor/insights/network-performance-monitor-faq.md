...
Создание предупреждений из пользовательского интерфейса NPM в данный момент не выполняется из-за проблемы. Создайте оповещения вручную.
