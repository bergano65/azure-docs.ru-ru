...
Возможность наблюдать за сетями с помощью узлы под управлением Linux в настоящее время доступна Предварительная версия. Дополнительные сведения вы можете получить у своего менеджера. Если вы предоставите нам используемый идентификатор рабочей области, мы включим для вас эту возможность. Агенты Linux поддерживают при работе с решением "Монитор производительности сети" только функцию мониторинга производительности. Мониторинг подключений службы и (или) ExpressRoute не поддерживается.
