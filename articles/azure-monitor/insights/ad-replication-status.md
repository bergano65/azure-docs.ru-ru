...
**Вопрос. Такое, как часто обновляются данные о состоянии репликации AD?**
Ответ. Данные обновляются каждые пять дней.

**Вопрос. Есть ли способ настроить частоту обновления данных?**
Ответ. На данный момент нет.

**Вопрос. Нужно ли добавить все контроллеры домена в мою рабочую область Log Analytics, чтобы просмотреть состояние репликации?**
...
**Вопрос. Я не хочу добавлять какие-либо контроллеры домена в свою рабочую область Log Analytics. По-прежнему использовать решение для контроля состояния репликации AD?**
...
**Вопрос. Что такое имя процесса, который собирает данные?**
...
**Вопрос. Есть ли способ настроить время сбора данных?**
Ответ. На данный момент нет.

**Вопрос. Какие разрешения необходимы для сбора данных?**
