...
| платформа | Direct Agent | Агент SCOM | Служба хранилища Azure | Нужен ли SCOM? | Отправка данных агента SCOM через группу управления | Частота сбора |
| --- | --- | --- | --- | --- | --- | --- |
