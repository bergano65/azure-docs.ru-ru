...
4. Дополнительные сведения о том, как включить журналы диагностики для службы Key Vault, см. в [полном руководстве](https://docs.microsoft.com/azure/key-vault/key-vault-logging).
...
Чтобы лучше понять, что представляет каждый код состояния, рекомендуем ознакомиться с документацией по [кодам состояния и ответов в Azure Key Vault](https://docs.microsoft.com/azure/key-vault/authentication-requests-and-responses).
...
>[!NOTE]
> Обратите внимание на то, что для просмотра этой книги необходимо включить параметры диагностики. Дополнительные сведения о включении параметра диагностики см. в статье [Ведения журналов в Azure Key Vault](https://docs.microsoft.com/azure/key-vault/general/logging).
...
Узнайте, в каких ситуациях применяются книги, как создавать и настраивать отчеты и многое другое, изучив статью [Создание интерактивных отчетов с использованием книг Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/platform/workbooks-overview).
