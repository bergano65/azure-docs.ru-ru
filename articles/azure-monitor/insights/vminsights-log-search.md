...
| Свойство. | Описание: |
|:--|:--|
|Direction (направление) |Направление подключения. Возможные значения: *inbound* (Входящее) или *outbound* (Исходящее). |
...
| Пространство имен | name | Описание: | Единицы | Tags |
|:---|:---|:---|:---|:---|
