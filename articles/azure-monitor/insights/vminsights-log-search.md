...
| Network (Сеть)     | WriteBytesPerSecond   | Число байт, записываемых в сеть, в секунду            | Байт/с | Нетворкдевицеид — идентификатор устройства;<br>байт — всего отправленных байтов |
| Network (Сеть)     | ReadBytesPerSecond    | Число байт, прочитанных из сети в секунду             | Байт/с | Нетворкдевицеид — идентификатор устройства;<br>байт — всего получено байт |
