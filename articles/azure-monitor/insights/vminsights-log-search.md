...
>- Западная Европа
>
> Сбор таких данных включена в другом [поддерживаемые регионы](vminsights-onboard.md#log-analytics) для Azure Monitor для виртуальных машин. 
