...
5. Нажмите кнопку **развернуть в Azure** .
...
* Для связывания Рабочая область Log Analytics и учетная запись службы автоматизации должны находиться в одной подписке, но могут находиться в разных группах ресурсов, развернутых в одном регионе. Допустимое исключение: рабочая область Log Analytics в восточной части США и учетная запись службы автоматизации в восточной части США 2.
...
1. Перейдите к разделу **связанные ресурсы** меню и выберите пункт **связанная Рабочая область**.
1. Если **Рабочая область** связана с учетной записью службы автоматизации, то на этой странице отображается рабочая область, с которой она связана. Если вы выбрали имя рабочей области в списке, вы будете перенаправлены на страницу обзора для этой рабочей области.
