...
В Azure Monitor вы можете добавить решения мониторинга для всех используемых приложений и служб. Они, как правило, доступны на безвозмездной основе, но собирать данные, которые могут вызвать расходы на использование. Помимо решений, предоставляемых корпорацией Майкрософт, партнеры и клиенты могут [создавать решения по управлению](solutions-creating.md) а затем применять их в своей среде или предоставлять клиентам через средства сообщества.
...
1. Перейдите на [портал Azure](https://ms.portal.azure.com). Поиск и выберите **монитор**.
...
1. Нажмите на плитку для решения, чтобы открыть свое представление, которое включает в себя более подробный анализ собранных данных.
...
1. Перейдите на [портал Azure](https://ms.portal.azure.com). Поиск и выбор **решений**.
...
1. Просмотр или поиск решения. Вы также можете просматривать решения из [этой поисковой ссылки.](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/category/management-tools?page=1&subcategories=management-solutions)
...
1. При запуске процесса установки предлагается указать рабочее пространство Log Analytics и предоставить любую необходимую конфигурацию для решения.
...
5. Нажмите кнопку **«Развертывание» в Azure.**
...
При установке решения через Azure Marketplace вам предлагается найти рабочую область и учетную запись автоматизации. При необходимости связь между ними создается автоматически.
