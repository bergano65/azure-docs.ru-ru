...
Затраты на экспорт: выплачивается в разделе "журналы платформы" на [странице цен на Azure Monitor.](https://azure.microsoft.com/pricing/details/monitor/) 
