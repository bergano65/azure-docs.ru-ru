...
> [!WARNING]
> Если вы отправляете [журналы ресурсов Azure или метрики в учетную запись хранения с помощью параметров диагностики](resource-logs-collect-storage.md) или [журналов действий в учетную запись хранения с помощью профилей журналов](resource-logs-collect-storage.md), формат данных в учетной записи хранения изменился на строки JSON в ноя. 1, 2018. Ниже описывается влияние этого изменения, а также приводятся инструкции по обновлению инструментария для включения поддержки нового формата.
>
