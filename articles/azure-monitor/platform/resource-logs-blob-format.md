...
Чтобы узнать, имеются ли параметры диагностики, отправляющие данные в учетную запись хранения Azure, перейдите к разделу **мониторинг** на портале, щелкните **параметры диагностики**и укажите все ресурсы с **состоянием диагностики** . значение **включено**:
