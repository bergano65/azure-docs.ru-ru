...
Счетчики производительности настраиваются в [меню "Данные" раздела "Параметры" службы Log Analytics](agent-data-sources.md#configuring-data-sources).
...
* Экспортируйте собранные данные в [Power BI](../../log-analytics/log-analytics-powerbi.md) для дополнительной визуализации и анализа.
