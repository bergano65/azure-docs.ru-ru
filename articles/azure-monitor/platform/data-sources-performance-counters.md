...
![Настройка счетчиков производительности Linux](media/data-sources-performance-counters/configure-linux-1.png)
...
1. Щелкните **+** или нажмите клавишу **Ввод** , чтобы добавить счетчик в список других счетчиков для объекта.
...
1. Закончив добавление счетчиков, нажмите кнопку **Сохранить** в верхней части экрана, чтобы сохранить конфигурацию.
