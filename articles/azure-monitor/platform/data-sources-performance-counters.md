...
| Логический диск | Обращений чтения с диска/с |
| Логический диск | Обращений к диску в секунду |
| Логический диск | Скорость записи на диск (байт/с) |
| Логический диск | Обращений записи на диск/с |
| Логический диск | Свободно мегабайт |
| Логический диск | Скорость обмена с логическим диском, байт/с |
| Память | Объем доступной памяти |
| Память | Объем доступной области подкачки, % |
| Память | Объем используемой памяти, % |
| Память | Объем используемой области подкачки, % |
| Память | Объем доступной памяти, МБ |
| Память | Объем доступной области подкачки, МБ |
| Память | Чтение страниц/с |
| Память | Запись страниц/с |
| Память | Страниц/с |
| Память | Используемая область подкачки, МБ |
| Память | Объем используемой памяти, МБ |
| Сеть | Всего передано байт |
| Сеть | Всего получено байт |
| Сеть | Общее количество байт |
...
| Физический диск | Скорость обмена с логическим диском, байт/с |
...
| Процесс | Объем виртуальной общей памяти |
| Процессор | Процент времени на отложенные вызовы процедур |
| Процессор | Процент времени бездействия |
| Процессор | Процент времени прерываний |
| Процессор | Процент времени ожидания ввода-вывода |
| Процессор | Процент времени с низким приоритетом |
| Процессор | % работы в привилегированном режиме; |
| Процессор | % загруженности процессора |
| Процессор | Процент времени пользователя |
| System | Объем свободной физической памяти |
| System | Свободное пространство в файлах подкачки |
| System | Объем свободной виртуальной памяти |
| System | Процессы |
| System | Размер хранения в файлах подкачки |
| System | Время работы |
| System | Users |
...
| Время создания |Дата и время выборки данных. |
