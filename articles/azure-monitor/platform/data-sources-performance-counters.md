...
2. Нажмите **+** или нажмите **Введите,** чтобы добавить счетчик в список.
...
3. Нажмите **+** или нажмите **Введите,** чтобы добавить счетчик в список других счетчиков для объекта.
...
| Физический диск | Avg. Диск сек/ Читать |
| Физический диск | Avg. Диск сек/Передача |
| Физический диск | Avg. Диск сек/ Запись |
...
| Perf &#124; где ObjectName »- «Процессор» и CounterName »» «% Время процессора» и InstanceName »» _Total &#124; суммировать AVGCPU » avg (CounterValue) компьютером |Средний объем использования ЦП на всех компьютерах |
| Perf &#124;, где CounterName ,% Время процессора "&#124; суммировать AggregatedValue и макс (CounterValue) по компьютерам |Максимальный объем использования ЦП на всех компьютерах |
| Perf &#124; где ObjectName - "LogicalDisk" и CounterName - "Текущая длина очереди диска" и компьютер "MyComputerName" &#124; суммировать AggregatedValue |Средняя длина текущей дисковой очереди по всем экземплярам заданного компьютера |
| Perf &#124; где CounterName - "Диск переводы / сек" &#124; суммировать AggregatedValue и процентиль (CounterValue, 95) по компьютеру |95-й процентиль для обращений к диску/с на всех компьютерах |
