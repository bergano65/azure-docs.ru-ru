---
title: Используйте API-коллектор аиМа для создания конвейера данных
...
В оставшейся части этой статьи будут рассмотрены данные просмотра страниц в Application Insights. В нашем гипотетическом сценарии, мы хотим соотнести географическую информацию, собранную по умолчанию Application Insights SDK, с пользовательскими данными, содержащими население каждой страны/региона в мире, с целью определения того, где мы должны тратить больше всего маркетинговых долларов. 
...
Чтобы отследить конвейер, ми используем средство Application Insights для отслеживания Функции Azure (дополнительные сведения см. [здесь](../../azure-functions/functions-monitoring.md)) и службу Azure Monitor для отслеживания приложения логики (дополнительные сведения см. [здесь](../../logic-apps/logic-apps-monitor-your-logic-apps-oms.md)). 
