...
При использовании нескольких условий в одном правиле, правило «and» условия друг с другом.  То есть оповещение срабатывает, если все условия в диалоговом окне оповещения оценивать как true и решать, когда одно из условий больше не true. Пример оповещения этого типа будет предупреждения, если «Выше, чем 90% ресурсов ЦП» и «длина очереди — более 300 элементов». 
