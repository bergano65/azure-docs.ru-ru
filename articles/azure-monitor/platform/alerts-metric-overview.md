...
На данный момент вы узнали, как одно предупреждение метрики можно использовать для отслеживания одного или нескольких метрических временных рядов, связанных с одним ресурсом Azure. Во многих случаях вы можете захотеть, чтобы одно и то же правило генерации оповещений применялось ко многим ресурсам. Azure Monitor также поддерживает мониторинг нескольких ресурсов с одним правилом генерации оповещений о метриках. В настоящее время эта функция поддерживается только на виртуальных машинах, базах данных SQL Server, пулах эластичных БД SQL Server и пограничных устройствах данных. Кроме того, для одного оповещения о метрике ресурсы отслеживаются в одном регионе Azure.
