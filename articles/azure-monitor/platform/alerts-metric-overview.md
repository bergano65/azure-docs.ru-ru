...
- Тип агрегирования (статистика, которая выполняется по необработанным значениям метрики. [Поддерживаются следующие типы агрегирования](./metrics-aggregation-explained.md#aggregation-types) : минимальное, максимальное, среднее, общее, число). среднее значение
...
- [Узнайте, как создавать оповещения в Azure Монтиор обозреватель метрик](./metrics-charts.md#alert-rules)
