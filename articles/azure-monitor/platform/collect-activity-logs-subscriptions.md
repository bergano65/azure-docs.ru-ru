---
title: Получение журналов действий Azure в рабочую область Log Analytics в разных подписках | Документация Майкрософт
...
ms.locfileid: "58540760"
---
# <a name="collect-azure-activity-logs-into-a-log-analytics-workspace-across-subscriptions-in-different-azure-active-directory-tenants"></a>Получение журналов действий Azure в рабочую область Log Analytics в разных подписок в разных клиентах Azure Active Directory
...
- Рабочее пространство Log Analytics может находиться в другой подписке и клиенте Azure Active Directory, нежели приложение логики, но для простоты мы рекомендуем, чтобы они принадлежали к одной подписке. Приложение логики отправляет в рабочую область, используя идентификатор рабочей области Log Analytics и ключ.
...
>[!NOTE]
> Журналы действий записываются в пользовательскую таблицу и не отображаются в [решении журнала действий](./collect-activity-logs.md).
