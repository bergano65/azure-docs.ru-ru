...
Если рабочая область Log Analytics находится в той же подписке Azure или в другой подписке, но в том же клиенте Azure Active Directory, следуйте инструкциям в статье [Просмотр журналов действий Azure](collect-activity-logs.md), чтобы собрать журналы действий Azure.
