...
> [!IMPORTANT]
> Чтобы отправить данные в неизменяемое хранилище, установите неизменяемую политику для учетной записи хранилища, описанную в [Set, и управляйте политиками неизменности для хранения Blob.](../../storage/blobs/storage-blob-immutability-policies-manage.md) Вы должны следовать всем шагам в этой статье, включая включение защищенных капли приложения пишет.
