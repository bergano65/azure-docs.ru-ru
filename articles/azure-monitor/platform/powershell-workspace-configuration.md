...
```
В указанном примере regexDelimiter был определен как \\n для новой строки. Разделителем журнала также может быть метка времени.  Далее приведены поддерживаемые форматы.
...
| --- | --- |
| ГГГГ-ММ-ДД ЧЧ:ММ:СС;  | ((\\\\д{2})\|(\\\\д{4}))-([0-1]\\\\д)-(([0-3]\\\\д)\|(\\\\д))\\\\с((\\\\д)\|([0-1]\\\\д)\|(2[0-4])):[0-5][0-9]:[0-5][0-9] |
| М/Д/ГГГГ ЧЧ:ММ:СС AM/PM (12-часовой формат); | (([0-1]\\\\д)\|[0-9])/(([0-3]\\\\д)\|(\\\\д))/((\\\\д{2})\|(\\\\д{4}))\\\\с((\\\\д)\|([0-1]\\\\д)\|(2[0-4])):[0-5][0-9]:[0-5][0-9]\\\\с(AM\|PM\|am\|pm) |
| дд/МММ/ггг ЧЧ:ММ:СС; | ((([0-3]\\\\д)\|(\\\\д))/(Янв\|Фев\|Мар\|Май\|Апр\|Июл\|Июн\|Авг\|Окт\|Сен\|Ноя\|Дек\|янв\|фев\|мар\|май\|апр\|июл\|июн\|авг\|окт\|сен\|ноя\|дек)/((\\\\д{2})\|(\\\\д{4}))\\\\с((\\\\д)\|([0-1]\\\\д)\|(2[0-4])):[0-5][0-9]:[0-5][0-9]) |
| МММ дд гггг ЧЧ:ММ:СС | (((?:Янв(?:арь)?\|Фев(?:раль)?\|Мар(?:т)?\|Апр(?:ель)?\|Май\|Ию(?нь)?\|Ию(?ль)?\|Авг(?:уст)?\|Сен(?:тябрь)?\|Сен\|Окт(?:тябрь)?\|Ноя(?:брь)?\|Дек(?:абрь)?)).*?((?:(?:[0-2]?\\\\д{1})\|(?:[3][01]{1})))(?![\\\\д]).*?((?:(?:[1]{1}\\\\д{1}\\\\д{1}\\\\д{1})\|(?:[2]{1}\\\\д{3})))(?![\\\\д]).*?((?:(?:[0-1][0-9])\|(?:[2][0-3])\|(?:[0-9])):(?:[0-5][0-9])(?::[0-5][0-9])?(?:\\\\с?(?:am\|AM\|pm\|PM))?)) |
| ггммдд чч:мм:сс; | ([0-9]{2}([0][1-9]\|[1][0-2])([0-2][0-9]\|[3][0-1])\\\\с\\\\с?([0-1]?[0-9]\|[2][0-3]):[0-5][0-9]:[0-5][0-9]) |
| ддммгг чч:мм:сс; | (([0-2][0-9]\|[3][0-1])([0][1-9]\|[1][0-2])[0-9]{2}\\\\с\\\\с?([0-1]?[0-9]\|[2][0-3]):[0-5][0-9]:[0-5][0-9]) |
| МММ д ЧЧ:мм:сс; | (Янв\|Фев\|Мар\|Апр\|Май\|Июн\|Июл\|Авг\|Сен\|Окт\|Ноя\|Дек)\\\\с\\\\с?([0]?[1-9]\|[1-2][0-9]\|[3][0-1])\\\\c([0-1]?[0-9]\|[2][0-3]):([0-5][0-9]):([0-5][0-9]) |
| МММ д ЧЧ:мм:сс;<br> два пробела после МММ | (Явн\|Фев\|Мар\|Апр\|Май\|Июн\|Июл\|Авг\|Сен\|Окт\|Ноя\|Дек)\\\\с\\\\с([0]?[1-9]\|[1-2][0-9]\|[3][0-1])\\\\с([0][0-9]\|[1][0-2]):([0-5][0-9]):([0-5][0-9]) |
| МММ д ЧЧ:мм:сс; | (Явн\|Фев\|Мар\|Апр\|Май\|Июн\|Июл\|Авг\|Сен\|Окт\|Ноя\|Дек)\\\\([0]?[1-9]\|[1-2][0-9]\|[3][0-1])\\\\s([0][0-9]\|[1][0-2]):([0-5][0-9]):([0-5][0-9]) |
| дд/МММ/гггг:ЧЧ:мм:сс +часовой пояс;<br> где "+" обозначает "+" или "-"<br> смещение времени часового пояса | (([0-2][1-9]\|[3][0-1])\\\\/(Янв\|Фев\|Мар\|Апр\|Май\|Июн\|Июл\|Авг\|Сент\|Окт\|Ноя\|Дек)\\\\/((19\|20)[0-9][0-9]):([0][0-9]\|[1][0-2]):([0-5][0-9]):([0-5][0-9])\\\\с[\\\\+\|\\\\-][0-9]{4}) |
| гггг-ММТЧЧ:мм:сс<br> T является литералом буквы T | ((\\\\д{2})\|(\\\\д{4}))-([0-1]\\\\д)-(([0-3]\\\\д)\|(\\\\д))T((\\\\д)\|([0-1]\\\\д)\|(2[0-4])):[0-5][0-9]:[0-5][0-9] |
...
Дополнительные сведения о доступных журналах см. в разделе [Поддерживаемые службы и схемы для журналов диагностики](../../azure-monitor/platform/tutorial-dashboards.md).
