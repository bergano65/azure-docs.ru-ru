...
**Сигнал**: Порождено целевым ресурсом. Сигналы могут иметь следующие типы: метрика, журнал действий, Application Insights и журнал.

**Критерии**: Сочетание сигнала и логики, применяемой к целевому ресурсу. Примеры: 
   - Загрузка ЦП > 70 %
...
**Уровень серьезности**. Уровень серьезности предупреждения после соблюдения критериев, указанных в правиле генерации оповещений. Уровень серьезности может иметь значение от 0 до 4.
...
| Область | Описание |
|:---|:---|
| Оператор new | Эта ошибка была только что обнаружена и еще не проверена. |
