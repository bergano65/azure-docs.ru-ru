...
Состояние оповещения изменяется только пользователем. Узнайте, [как изменить состояние оповещений и смарт-групп](./alerts-managing-alert-states.md?toc=%252fazure%252fazure-monitor%252ftoc.json).
...
Интеллектуальные группы — это статистические выражения, основанные на алгоритмах машинного обучения, которые могут помочь в уменьшении шума и помощи в устранении неполадок. [Дополнительные сведения о смарт-группах](./alerts-smartgroups-overview.md?toc=%252fazure%252fazure-monitor%252ftoc.json) и [управление смарт-группами](./alerts-managing-smart-groups.md?toc=%252fazure%252fazure-monitor%252ftoc.json).

## <a name="next-steps"></a>Дальнейшие действия

- [Дополнительные сведения о смарт-группах](./alerts-smartgroups-overview.md?toc=%252fazure%252fazure-monitor%252ftoc.json)
- [Дополнительные сведения о группах действий](./action-groups.md)
- [Управление экземплярами оповещений в Azure](./alerts-managing-alert-instances.md?toc=%252fazure%252fazure-monitor%252ftoc.json)
- [Управление интеллектуальными группами](./alerts-managing-smart-groups.md?toc=%252fazure%252fazure-monitor%252ftoc.json)
