...
Вы можете оповещать о метриках и журналах, как описано в разделе [мониторинг источников данных](../../azure-monitor/platform/data-sources.md). Помимо прочего, к ним относятся:
