---
title: Создавайте и управляйте классическими метрическими оповещениями с помощью Azure Monitor
...
7. Чтобы отправлять уведомления на дополнительные электронные адреса при срабатывании оповещения, добавьте их в поле **Дополнительные адреса электронной почты администратора**. Отдельные несколько писем с запятой, в следующем формате: *электронная почта\@contoso.com;email2\@contoso.com*
...
8. Классические правила генерации оповещений больше не могут создаваться с помощью PowerShell. Для создания правила оповещения необходимо использовать новую команду ['Add-AzMetricAlertRule'.](/powershell/module/az.monitor/add-azmetricalertrule)
