...
С помощью конструктора представлений в [Azure Log Analytics](../../azure-monitor/log-query/log-query-overview.md) на портале Azure можно создавать различные пользовательские представления, содержащие визуальные представления данных из рабочей области Log Analytics. Эта статья содержит обзор конструктора представлений и процедур по созданию и изменению пользовательских представлений.
...
| Analytics | Открывает [портал расширенной аналитики](../../azure-monitor/log-query/portals.md) для анализа данных с помощью запросов по журналам. |
