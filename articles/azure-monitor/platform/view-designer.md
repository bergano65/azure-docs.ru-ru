...
| Экспортировать      | Экспортирует представление в [шаблон Azure Resource Manager](../../azure-resource-manager/templates/template-syntax.md), который можно импортировать в другую рабочую область. Для файла используется имя представления и формат *OMSVIEW*. |
