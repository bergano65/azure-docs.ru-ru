...
С помощью конструктора представлений в [Azure Log Analytics](../../log-analytics/log-analytics-queries.md) на портале Azure можно создавать различные пользовательские представления, содержащие визуальные представления данных из рабочей области Log Analytics. Эта статья содержит обзор конструктора представлений и процедур по созданию и изменению пользовательских представлений.
...
| Analytics | Открывает [портал расширенной аналитики](../../log-analytics/log-analytics-log-search-portals.md) для анализа данных с помощью запросов по журналам. |
