...
> [!IMPORTANT]
> Представления в Azure Monitor выводятся и заменяются [книгами](workbooks-overview.md) , которые предоставляют дополнительные функциональные возможности. Дополнительные сведения о преобразовании существующих представлений в книги см. в разделе [Конструктор представлений Azure Monitor. книга переходов](view-designer-conversion-overview.md) . В следующей таблице приведены шаги, которые будут предприняты в течение следующих нескольких месяцев.
> 
> | Изменить | Что это означает | Ожидаемая Дата |
> |:---|:---|:---|
> | Отключение создания новых представлений, созданных с помощью конструктора представлений. | Вы больше не сможете создавать и сохранять новые пользовательские представления в портал Azure.| Ноябрь 2020 |
> | Отключите функцию Edit для существующих представлений с помощью конструктора представлений. | Вы больше не сможете изменять и сохранять изменения в существующих пользовательских представлениях. | Ноябрь 2020 |
> | Отключение развертывания представлений в Log Analytics рабочих областях | Вы больше не сможете развертывать пользовательские представления с помощью ARM для Log Analytics рабочих областей. | Март 2021 |
> | Конструктор представлений больше не доступен в портал Azure | Работа с порталом больше не будет поддерживать конструктор представлений. | Июнь 2021 |
> | Пользовательские представления, удаленные из сводки по рабочей области | Вы больше не сможете получить доступ к данным пользовательского представления. | Декабрь 2021 г. |
...
| Часть | Описание |
|:--- |:--- |
| Tiles | Отображаются на странице **обзора** Azure Monitor. Каждая плитка отображает визуальную сводку пользовательского представления, которое она представляет. Каждый тип плитки предоставляет отличное представление записей. Вы выбираете плитку для отображения пользовательского представления. |
...
| Параметр | Описание: |
|:--|:--|
| Кнопка "Сохранить"        | Сохраняет изменения и закрывает представление. |
