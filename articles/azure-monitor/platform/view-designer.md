...
| Часть | Описание |
|:--- |:--- |
| Плитка | Отображаются на странице **обзора** Azure Monitor. Каждая плитка отображает визуальную сводку пользовательского представления, которое она представляет. Каждый тип плитки предоставляет отличное представление записей. Вы выбираете плитку для отображения пользовательского представления. |
