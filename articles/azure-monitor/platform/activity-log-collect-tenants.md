...
2. Введите параметры в таблице, приведенной ниже.
   ...
   | подписку   | Выберите подписку Azure, в которой будет размещаться приложение логики. |
   | resource group | Выберите для приложения логики существующую группу ресурсов или создайте новую. |
   | Место проведения       | Выберите регион центра обработки данных для развертывания приложения логики. |
