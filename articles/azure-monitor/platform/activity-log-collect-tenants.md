...
3. Щелкните **Создать**. При отображении уведомления **Развертывание прошло успешно** щелкните **Перейти к ресурсу**, чтобы открыть приложение логики.
...
2. Когда появится запрос учетных данных, подключитесь к пространству имен Центров событий. Введите имя для своего подключения, а затем скопированную строку подключения.  Щелкните **Создать**.
