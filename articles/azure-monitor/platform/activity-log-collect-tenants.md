...
Если Рабочая область Log Analytics находится в той же подписке Azure или в другой подписке, но в той же Azure Active Directory, выполните действия, описанные в статье [Получение и анализ журналов действий Azure в log Analytics рабочей области в Azure Monitor](activity-log-collect.md) для получения сведений об Azure. Журналы действий.
