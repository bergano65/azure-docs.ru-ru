...
Более старые классические, мониторинга и оповещений будет прекращена 31 августа 2019 г.; включая замыкание связанные интерфейсы API, Azure интерфейс портала и служб в нем. В частности, будет прекращена поддержка таких функций:
...
Все сведений классической мониторинга и оповещений системы, включая соответствующий [API](https://msdn.microsoft.com/library/azure/dn931945.aspx), [PowerShell](../../azure-monitor/platform/alerts-classic-portal.md), [CLI](../../azure-monitor/platform/alerts-classic-portal.md), [странице портала Azure](../../azure-monitor/platform/alerts-classic-portal.md)и [ Шаблон ресурсов](../../azure-monitor/platform/alerts-enable-template.md) останутся может использоваться до конца августа 2019. 

В конце августа 2019, в Azure Monitor:
...
- Все правила генерации оповещений, которые продолжают существовать в службе оповещений (Классическая модель) за август 2019 будет продолжать выполнение и срабатывание уведомления, но недоступен для изменения.
- Начиная с сентября 2019 г., правила генерации оповещений в классическом мониторинг и оповещения, который можно перенести, будет автоматически перемещен корпорацией Майкрософт в их эквивалент в новой платформе Azure monitor на этапах, охватывающих несколько недель. Процесс будет выполнен незаметно, без каких-либо простоев. Возможности мониторинга для пользователей не пострадают.
...
- Некоторые [классические правила генерации оповещений, которые не могут быть перенесены автоматически](alerts-understand-migration.md#classic-alert-rules-that-will-not-be-migrated) и потребовать действий пользователей будут выполняться до июня 2020.
