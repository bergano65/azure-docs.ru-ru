...
С новой платформой мониторинга и оповещений Azure классические оповещения в Azure Monitor удаляются, но по-прежнему используются только для ресурсов, которые еще не поддерживают новые оповещения. Дата прекращения использования этих оповещений была дополнительно расширена. Вскоре будет выводится новая дата для миграции оставшихся предупреждений, [облака Azure для государственных организаций](../../azure-government/documentation-government-welcome.md)и [Azure Китая (21vianet](https://docs.azure.cn/)).
