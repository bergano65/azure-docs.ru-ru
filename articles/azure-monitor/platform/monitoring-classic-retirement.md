...
> [!IMPORTANT]
> Microsoft Azure Monitor в ближайшее время предоставит клиентам инструменты для автоматического перемещения классических правил генерации оповещений на новую платформу, а в июле 2019 года запустит его принудительно для всех классических правил генерации оповещений, которые все еще существуют. После перемещения классических правил генерации оповещений клиентам нужно будет убедиться, что автоматизация, использующая полезные данные таких правил, адаптирована для обработки новых полезных данных из [унифицированных метрик и оповещений в Application Insights](#unified-metrics-and-alerts-in-application-insights) или [унифицированных метрик и оповещений для других ресурсов Azure](#unified-metrics-and-alerts-for-other-azure-resources). 
