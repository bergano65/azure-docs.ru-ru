...
- Начиная с сентября 2019 г., правила генерации оповещений в классическом мониторинг и оповещения, который можно перенести, будет автоматически перемещен корпорацией Майкрософт в их эквивалент в новой платформе Azure monitor. Процесс будет выполнен незаметно, без каких-либо простоев. Возможности мониторинга для пользователей не пострадают.
