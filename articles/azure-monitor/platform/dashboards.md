...
![Пример панели мониторинга](./media/dashboards/oms-dashboards-example-dash.png)
...
* [Мобильное приложение OMS в Microsoft Store](https://www.windowsphone.com/store/app/operational-insights/4823b935-83ce-466c-82bb-bd0a3f58d865)
* [Мобильное приложение OMS в Apple iTunes](https://itunes.apple.com/app/microsoft-operations-management/id1042424859?mt=8)

![панель мониторинга на мобильном устройстве](./media/dashboards/oms-search-mobile.png)
...
![Обзор](./media/dashboards/oms-dashboards-overview.png)
...
![Инструкция в виде рисунков](./media/dashboards/oms-dashboards-pictorial01.png)
...
![Добавление плиток 1](./media/dashboards/oms-dashboards-pictorial02.png)

Если щелкнуть знак **плюс**, в представлении My Dashboard (Моя панель мониторинга) появится новая плитка.

![Добавление плиток 2](./media/dashboards/oms-dashboards-pictorial03.png)
...
![Изменение плитки](./media/dashboards/oms-dashboards-pictorial04.png)

![Изменение плитки](./media/dashboards/oms-dashboards-pictorial05.png)
...
| --- | --- |
| ![Линейчатая диаграмма](./media/dashboards/oms-dashboards-bar-chart.png) |Отображает временную шкалу результатов сохраненного поиска по журналу в виде линейчатой диаграммы или списка результатов по полям (зависит от того, сортирует ли поиск по журналу найденные результаты по полям). |
| ![метрика](./media/dashboards/oms-dashboards-metric.png) |На ней показывается число, которое означает, сколько раз был найден элемент по запросу поиска журнала. Плитки с метрикой позволяют задать пороговое значение, по достижении которого плитка будет выделяться. |
| ![line](./media/dashboards/oms-dashboards-line.png) |Отображает временную шкалу совпадения результатов сохраненного поиска по журналу со значениями в виде графика. |
...
![Упорядочение панели мониторинга](./media/dashboards/oms-dashboards-organize.png)
...
![Удаление плитки](./media/dashboards/oms-dashboards-remove-tile.png)

## <a name="next-steps"></a>Дополнительная информация
* Создайте [оповещения](../../azure-monitor/platform/alerts-overview.md) в службе Log Analytics для создания уведомлений и устранения проблем.
