...
* Запрос метрик с помощью [REST API Azure Monitor](https://msdn.microsoft.com/library/azure/dn931930.aspx), [командлетов PowerShell](powershell-quickstart-samples.md) или [кроссплатформенного интерфейса командной строки](../samples/cli-samples.md).
...
* Настройка [профиля журнала](activity-log-export.md) для подписки.\*
