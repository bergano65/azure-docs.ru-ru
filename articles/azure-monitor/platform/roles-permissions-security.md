...
Если приведенные выше роли не соответствуют точным потребностям команды, вы можете [создать настраиваемую роль Azure](../../role-based-access-control/custom-roles.md) с более детализированными разрешениями. Ниже приведены распространенные операции RBAC для Azure Monitor с описаниями.
