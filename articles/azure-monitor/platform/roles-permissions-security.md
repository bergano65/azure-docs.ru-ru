...
\*пользователю также необходимо отдельно предоставить разрешение ListKeys на целевом ресурсе (учетную запись хранения или пространство имен концентратора событий), чтобы задать профиль журнала или параметр диагностики.
