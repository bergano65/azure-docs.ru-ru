...
[Создайте концентратор событий](../../event-hubs/event-hubs-create.md) , если он еще не создан. Пространство имен концентраторов событий не обязательно должно находиться в той же подписке, что и подписка, создающая журналы, при условии, что пользователь, который настраивает этот параметр, имеет соответствующий доступ RBAC к обеим подпискам, и обе подписки находятся в одном клиенте.
