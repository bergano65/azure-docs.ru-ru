...
| Собираемые данные | Журналы событий<br>События ETW<br>Производительность<br>Журналы на основе файлов<br>Журналы служб IIS<br>Журналы приложений .NET<br>Аварийные дампы<br>Журналы диагностики агента | Журналы событий<br><IIS logs> производительности<br>Журналы на основе файлов<br>Аналитические сведения и решения<br>Другие службы | Сведения о процессе и зависимости<br>Метрики сетевого подключения |
