...
![Снимок экрана: элемент визуализации списка запросов в конструкторе представлений Azure Monitor.](media/view-designer-parts/view-list-queries.png)
...
![Снимок экрана с элементами визуализации чисел и списков в конструкторе представлений Azure Monitor.](media/view-designer-parts/view-number-list.png)
...
| Content |Текст, отображаемый для каждого элемента. |
...
Навигация по щелчку позволяет определить, какое действие будет выполнено, если щелкнуть заголовок или элемент списка в представлении.  Это приведет к открытию запроса в [log Analytics](../log-query/log-query-overview.md) или запуску другого представления.
