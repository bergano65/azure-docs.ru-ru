...
|:--- |:--- |
| **Общие сведения** | |
| Title |Текст, отображаемый в верхней части представления. |
...
| Значок использования |Щелкните эту ссылку, чтобы отобразить значок. |
| **Header** | |
| Title |Текст, отображаемый в верхней части заголовка. |
...
| **Элементы информации** | |
| Title |Текст, отображаемый в качестве имени для каждого элемента. |
...
| Title |Текст, отображаемый в верхней строке диаграммы. |
