...
| Value |Текст, отображаемый в верхней части второго столбца. |
...
| Контент |Текст, отображаемый для каждого элемента. |
...
| Показать              | Представление, которое открывается при выборе элемента заголовка или элемента в списке.  В поле **Имя представления** укажите имя представления в рабочей области. |
