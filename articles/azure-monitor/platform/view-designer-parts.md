...
Навигация по щелчку позволяет определить, какое действие будет выполнено, если щелкнуть заголовок или элемент списка в представлении.  При щелчке может открыться запрос на [портале поиска по журналам](../../azure-monitor/log-query/portals.md) или запуститься другое представление.
...
* Узнайте больше о [поиске по журналу](../../azure-monitor/log-query/log-query-overview.md) для поддержки запросов в элементах визуализации.
