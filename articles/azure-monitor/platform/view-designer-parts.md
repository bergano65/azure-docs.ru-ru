...
| **Title** | |
| Legend |Текст, отображаемый в верхней части заголовка. |
...
| Subtitle |Текст, отображаемый под названием в верхней части заголовка. |
| **Кольцо** | |
...
| Legend |Текст, отображаемый под выноской для первого ряда. |
...
| Subtitle |Текст, отображаемый под заголовком в верхней части диаграммы. |
