...
Навигация по щелчку позволяет определить, какое действие будет выполнено, если щелкнуть заголовок или элемент списка в представлении.  Может открыться запрос в [Analyticsl журнала](../../azure-monitor/log-query/portals.md) или запуститься другое представление.
