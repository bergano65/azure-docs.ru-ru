...
Навигация по щелчку позволяет определить, какое действие будет выполнено, если щелкнуть заголовок или элемент списка в представлении.  При щелчке может открыться запрос на [портале поиска по журналам](../../log-analytics/log-analytics-log-search-portals.md) или запуститься другое представление.
...
* Узнайте больше о [поиске по журналу](../../log-analytics/log-analytics-queries.md) для поддержки запросов в элементах визуализации.
