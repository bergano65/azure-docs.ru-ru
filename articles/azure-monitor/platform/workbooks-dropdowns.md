...
![Изображение, демонстрирующее пример сгруппированного раскрывающегося списка](./media/workbook-dropdowns/grouped-dropDown.png)
...
![Изображение с раскрывающимся списком, в котором используются параметры значения, метки, выбора и группы](./media/workbook-dropdowns/dropdown-more-options.png)
