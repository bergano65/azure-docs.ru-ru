...
|Атрибут  |type   |Обязательно для заполнения| значение по умолчанию | Описание|  
|-----------|-------|--------|---------|------------|  
...
|**scheduledTransferLogLevelFilter**|string|Необязательный элемент. Указывает минимальный уровень серьезности для передаваемых записей журнала. По умолчанию используется значение **Undefined**. Другие возможные значения: **Verbose**, **Information**, **Warning**, **Error** и **Critical**.|  
...
|Атрибут|type|Описание|  
|---------------|----------|-----------------|  
|**container**|string|Имя контейнера, в который будет передаваться содержимое каталога.|  
...
|Атрибут|type|Описание|  
|---------------|----------|-----------------|  
|**path**|string|Обязательный элемент. Абсолютный путь к отслеживаемому каталогу.|  
...
|Атрибут|type|Описание|  
|---------------|----------|-----------------|  
|**name**|string|Обязательный элемент. Имя локального ресурса, который содержит каталог для отслеживания.|  
|**relativePath**|string|Обязательный элемент. Путь относительно отслеживаемого локального ресурса.|  
...
|Атрибут|type|Описание|  
|---------------|----------|-----------------|  
|**counterSpecifier**|string|Обязательный элемент. Путь к счетчику производительности, данные которого будут собираться.|  
...
|Атрибут|type|Описание|  
|---------------|----------|-----------------|  
|**name**|string|Обязательный элемент. Выражение XPath, задающее журнал для сбора.|  
