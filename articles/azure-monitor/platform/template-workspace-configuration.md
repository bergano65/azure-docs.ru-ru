...
3. Создание сохраненной функции. ETag следует добавлять, чтобы переопределить функцию и поддерживать идемпотенцию.
...
11. Сбор пользовательских журналов с компьютера Windows
