...
При настройке расширения "Диагностика Microsoft Azure" необходимо указать учетную запись хранения, в которую будут отправляться все указанные данные. При необходимости можно добавить *приемники данных* для отправки данных в разные расположения.
