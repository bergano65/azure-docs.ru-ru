...
- Чтобы получить данные из репозитория Log Analytics, используйте [API поиска по журналам](../../azure-monitor/log-query/log-query-overview.md).

- Дополнительные сведения о [создании конвейера данных с помощью API сборщика данных](../../azure-monitor/platform/create-pipeline-datacollector-api.md), используя рабочий процесс Logic Apps в Log Analytics.
