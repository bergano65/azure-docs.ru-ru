...
| Resource |Имя ресурса API: /api/logs. |
...
| 404 |Не удалось найти | | Указан неправильный URL-адрес либо запрос слишком большой. |
