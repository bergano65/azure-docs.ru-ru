...
> [!WARNING]
> [Большинство метрик в Azure хранятся 93 дня](data-platform-metrics.md#retention-of-metrics). Тем не менее, данные на одной диаграмме можно запрашивать не более чем за 30 дней. Это ограничение не применяется к [метрикам на основе журналов](../app/pre-aggregated-metrics-log-metrics.md#log-based-metrics).
