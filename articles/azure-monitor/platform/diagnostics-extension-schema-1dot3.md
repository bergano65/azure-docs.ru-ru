...
Эта страница предназначена для версий 1.3 и более поздних (пакет Azure SDK 2.4 и более поздней версии). Новые разделы конфигурации снабжены комментариями, указывающими, в какой версии они были добавлены. Версия 1,0 и 1,2 схемы были заархивированы и больше не доступны. 
...
|Дочерние элементы|Description (Описание)|  
|--------------------|-----------------|  
...
|Дочерний элемент|Description (Описание)|  
|-------------------|-----------------|  
...
|Элемент|Тип|Description (Описание)|  
|-------------|----------|-----------------|  
...
|Атрибуты|Тип|Description (Описание)|  
|----------------|----------|-----------------|  
