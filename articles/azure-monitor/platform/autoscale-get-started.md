---
title: Приступая к работе с автомасштабированием в Azure
...
ms.locfileid: "75396355"
---
# <a name="get-started-with-autoscale-in-azure"></a>Приступая к работе с автомасштабированием в Azure
...
1. Итак, вы создали первое правило масштабирования. В этом же интерфейсе вы увидите некоторые рекомендация по настройке, например: "Рекомендуется настроить не меньше одного правила горизонтального уменьшения масштаба". Для этого:
