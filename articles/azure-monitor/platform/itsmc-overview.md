...
8. Если необходимо заполнить готовые поля с фиксированными значениями, выберите **использовать настраиваемый шаблон**. В противном случае выберите существующий [шаблон](https://docs.microsoft.com/azure/azure-monitor/platform/itsmc-overview#template-definitions) в списке **шаблонов** и введите фиксированные значения в поля шаблона.
