...
9. При выборе пункта **создать отдельные рабочие элементы для каждого элемента** конфигурации каждый элемент конфигурации будет иметь свой собственный рабочий элемент. Для каждого элемента конфигурации будет один рабочий элемент. Он будет обновлен в соответствии с создаваемыми оповещениями.
   ...
   Если снять флажок **создать отдельные рабочие элементы для каждого элемента конфигурации** , то каждое оповещение создаст новый рабочий элемент. На один элемент конфигурации может быть несколько оповещений.
