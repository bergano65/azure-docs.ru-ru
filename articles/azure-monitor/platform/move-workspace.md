...
- Ключи рабочей области повторно создаются с перемещением в рабочую область (основной и дополнительный). Если ключ в качестве ключа рабочей области является хранилищем, обновите его с помощью новых созданных ключей. 
