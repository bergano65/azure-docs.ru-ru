...
> 
> **Оповещения**
> - Все оповещения должны повторно создаваться после перемещения, так как разрешения основываются на ИДЕНТИФИКАТОРе ресурса Azure рабочей области, а также на их изменение при перемещении рабочей области. 
