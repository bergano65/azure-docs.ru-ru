---
title: Справочный справочник по плиткам View Designer в Azure Monitor (ru) Документы Майкрософт
...
ms.locfileid: "77658512"
---
# <a name="reference-guide-to-view-designer-tiles-in-azure-monitor"></a>Справочный справочник для просмотра плитки конструктора в Azure Monitor
Используя View Designer в Azure Monitor, можно создать различные пользовательские представления на портале Azure, которые помогут вам визуализировать данные в рабочем пространстве Log Analytics. В этой статье содержится справочное руководство по параметрам плиток, доступных в пользовательских представлениях.
...
| Плитка | Описание |
|:--- |:--- |
| [Номер](#number-tile) |Количество записей из запроса. |
| [Два числа](#two-numbers-tile) |Числа записей из двух разных запросов. |
| [Пончик](#donut-tile) | Диаграмма, составленная на основе запроса, с суммарным значением в центре. |
...
> [!NOTE]
> Плитки в представлениях основаны на [запросах журналов](../log-query/log-query-overview.md) в рабочей области Log Analytics. В настоящее время они не поддерживают [перекрестные запросы ресурсов](../log-query/cross-workspace-query.md) для получения данных из Application Insights.
...
![Плитка "Число"](media/view-designer-tiles/tile-number.png)

| Параметр | Описание |
|:--- |:--- |
| name |Текст, отображаемый в верхней части плитки. |
...
![Плитка "Два числа"](media/view-designer-tiles/tile-two-numbers.png)
...
![Плитка "Кольцо"](media/view-designer-tiles/tile-donut.png)
...
| **Пончик** |**> Дополнительные параметры** |
...
![Плитка "График с выноской"](media/view-designer-tiles/tile-line-chart.png)
...
| Units |Укажите единицы измерения для значений, возвращенных запросом. Эти сведения используются для отображения на графике подписей, в которых указаны типы значений, и при необходимости для преобразования значений. **Тип единицы** определяет категорию единицы и определяет имеющиеся значения **текущего типа единицы.** Если вы выберете значение в **Преобразовании,** то числовые значения преобразуются из текущего типа **единицы** в тип **«Преобразование».** |
...
![Плитка "График с выноской"](media/view-designer-tiles/tile-line-chart-callout.png)
...
![Плитка "Две временные шкалы"](media/view-designer-tiles/tile-two-timelines.png)
...
| Color |Цвет, используемый для столбцов в первом ряду. |
...
| Color |Цвет, используемый для столбцов во втором ряду. |
...
* Узнайте о [запросах журнала](../log-query/log-query-overview.md) для поддержки запросов в плитках.
