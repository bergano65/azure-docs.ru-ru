...
Чтобы заменить учетную запись хранения, используемую для приема, сначала создайте ссылку для новой учетной записи хранения. Агенты ведения журнала получат обновленную конфигурацию и также начнут отправлять данные в новое хранилище.
...
- Для получения дополнительных сведений о Приватном канале см. информацию об [использовании Приватного канала Azure для безопасного подключения сетей к Azure Monitor}(private-link-security.md)
