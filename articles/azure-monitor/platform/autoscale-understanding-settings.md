...
| profile | rules | Механизм автомасштабирования автоматически уменьшает и увеличивает емкость путем использования правил в профиле. В профиле может быть несколько правил. Обычно имеется два правила: одно применяется, когда необходимо горизонтальное масштабирование, а другое — когда нужно уменьшить масштаб. |
