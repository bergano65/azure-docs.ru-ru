...
| scaleAction | значение | Емкость, до которой нужно увеличить или уменьшить ресурс. |
...
* [Общие сведения об автомасштабировании](../../azure-monitor/platform/autoscale-overview.md)
