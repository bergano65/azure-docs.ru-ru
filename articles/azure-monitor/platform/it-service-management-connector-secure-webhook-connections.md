...
1. Выберите [Add action group](./action-groups.md#create-an-action-group-by-using-the-azure-portal) (Добавить группу действий) и заполните поля.
