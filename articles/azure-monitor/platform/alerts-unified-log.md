...
Правила поиска по журналам могут быть двух типов (как для [Azure Log Analytics](../../azure-monitor/learn/tutorial-viewdata.md), так и для [Application Insights](../../azure-monitor/app/cloudservices.md#view-azure-diagnostics-events)). Каждый из этих типов подробно описан в последующих разделах.
