...
8.  Скопируйте и вставьте приведенный ниже пример полезных данных в диалоговое окно.
...
- Для шага 8 используйте следующий пример полезных данных для триггера HTTP-запроса:
