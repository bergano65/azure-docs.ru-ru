...
-   Импорт примера полезных данных для соответствующего типа оповещения в приложение логики.
...
8.  Скопируйте и вставьте следующий пример полезных данных в диалоговом окне:
...
- Для шага 8 используйте следующий пример полезных данных для триггера HTTP-запросов:
