...
Для любого другого объекта найди в Azure Monitor [источник пользовательских журналов.](data-sources-custom-logs.md)
...
Вы можете добавить новый объект, сначала выбрав опцию **Применить ниже конфигурации для моих машин,** а затем набрав его имя и нажав **+**. Для каждого устройства будут собираться сообщения только с выбранным уровнем серьезности.  Укажите уровни серьезности сообщений, которые хотите получать от соответствующего устройства. Дополнительные критерии для фильтрации сообщений задавать нельзя.

![Настройка системного журнала](media/data-sources-syslog/configure.png)

По умолчанию все изменения конфигурации автоматически отправляются во все агенты. Если вы хотите настроить Syslog вручную на каждом агенте Linux, то отрежь поле *Применить ниже конфигурации для моих машин.*
