...
description: Системный журнал (Syslog) — это протокол ведения журнала событий, который обычно используется в Linux. В этой статье описано, как настроить коллекцию сообщений Syslog в Azure Monitor, а также сведения о записях, создаваемых ими.
