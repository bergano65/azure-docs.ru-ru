...
Настройте syslog [в меню данные в дополнительных параметрах](agent-data-sources.md#configuring-data-sources) для рабочей области log Analytics. Эта конфигурация передается в файл конфигурации на каждом агенте Linux.
