...
Сборщик данных системного журнала поддерживаются следующие средства:
...
Другие устройства [настроить источник данных настраиваемые журналы](data-sources-custom-logs.md) в Azure Monitor.
