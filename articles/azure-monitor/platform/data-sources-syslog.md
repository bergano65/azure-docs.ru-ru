...
Настройте системный журнал в [меню "Данные" раздела "Дополнительные параметры" Log Analytics](agent-data-sources.md#configuring-data-sources).  Эта конфигурация передается в файл конфигурации на каждом агенте Linux.
...
* [Настройте агенты Linux](../../log-analytics/log-analytics-quick-collect-linux-computer.md) для сбора других типов данных.
