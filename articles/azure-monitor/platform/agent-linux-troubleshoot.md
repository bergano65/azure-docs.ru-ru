...
* Посетите страницу Log Analytics отзывы, чтобы просмотреть отправленные идеи и [https://aka.ms/opinsightsfeedback](https://aka.ms/opinsightsfeedback) ошибки или создать новый файл.  
