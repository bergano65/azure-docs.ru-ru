...
ms.locfileid: "92460807"
---
# <a name="log-analytics-agent-data-sources-in-azure-monitor"></a>Источники данных агента Log Analytics в Azure Monitor
Данные, Azure Monitor собираемые из виртуальных машин с помощью агента [log Analytics](log-analytics-agent.md) , определяются источниками данных, настроенными в [рабочей области log Analytics](data-platform-logs.md).   Каждый источник данных создает записи определенного типа, а каждый тип обладает собственным набором свойств.

> [!IMPORTANT]
> В этой статье рассматриваются источники данных для [агента log Analytics](log-analytics-agent.md) , который является одним из агентов, используемых Azure Monitor. Другие агенты собираются разные данные и настраиваются по-разному. Список доступных агентов и данных, которые они могут собираются, см. в разделе [Обзор агентов Azure Monitor](agents-overview.md) .
