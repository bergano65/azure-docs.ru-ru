...
* Узнайте больше о [решениях](../../azure-monitor/insights/solutions.md), которые расширяют функции службы Log Analytics и собирают данные в рабочей области.
