...
* **Использовать разрешения ресурса или рабочей области**. Этот режим управления разрешает детализированный RBAC. Пользователям можно предоставить доступ только к данным, связанным с ресурсами, которые они могут просматривать `read` , назначая разрешение Azure. 
