...
Чтобы узнать, как изменить режим управления доступом на портале с помощью PowerShell или шаблона диспетчер ресурсов, см. раздел [Определение режима управления доступом](manage-access.md#define-access-control-mode).
