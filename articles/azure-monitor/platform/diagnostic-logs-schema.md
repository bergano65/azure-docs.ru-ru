...
* [Дополнительные сведения о журналах диагностики](../../azure-monitor/platform/resource-logs-overview.md)
* [Потоковая передача журналов диагностики Azure в **Центры событий**](../../azure-monitor/platform/resource-logs-stream-event-hubs.md)
