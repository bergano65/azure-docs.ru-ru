...
ms.locfileid: "74893524"
---
# <a name="prepare-for-format-change-to-azure-monitor-resource-logs-archived-to-a-storage-account"></a>Подготовка к изменению формата для Azure Monitor журналов ресурсов, архивированных в учетную запись хранения

> [!WARNING]
> Если вы отправляете [журналы ресурсов Azure или метрики в учетную запись хранения с помощью параметров диагностики ресурсов](./../../azure-monitor/platform/archive-diagnostic-logs.md) или [журналов действий в учетную запись хранения с помощью профилей журналов](./../../azure-monitor/platform/archive-activity-log.md), формат данных в учетной записи хранения изменится на строки JSON в ноя. 1, 2018. Ниже описывается влияние этого изменения, а также приводятся инструкции по обновлению инструментария для включения поддержки нового формата. 
>
> 
