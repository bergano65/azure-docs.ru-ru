...
description: Описание влияния и способов обновления инструментов для обработки новых журналов диагностики Azure, которые были изменены для использования добавочных больших двоичных объектов в 1 ноября 2018 г.
author: johnkemnetz
services: monitoring
...
* Это изменение затрагивает следующие типы данных:
  * [журналы диагностики ресурсов Azure](archive-diagnostic-logs.md) ([см. список ресурсов здесь](diagnostic-logs-schema.md));
