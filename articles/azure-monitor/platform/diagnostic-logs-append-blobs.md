...
description: Описывает влияние и способы обновления инструментария для обработки новых журналов ресурсов Azure, которые были изменены для использования капли приложений 1 ноября 2018 года.
author: johnkemnetz
services: monitoring
ms.topic: conceptual
ms.date: 07/06/2018
...
ms.locfileid: "77670446"
---
# <a name="prepare-for-format-change-to-azure-monitor-resource-logs-archived-to-a-storage-account"></a>Подготовка к изменению формата в журналы ресурсов Azure Monitor, архивированные в учетную запись хранения

> [!WARNING]
> Если вы отправляете [журналы ресурсов ресурсов или метрик ресурса Azure в учетную запись хранения с использованием параметров диагностики ресурсов](./../../azure-monitor/platform/archive-diagnostic-logs.md) или [журналов активности в учетную запись хранения с помощью профилей журналов,](./../../azure-monitor/platform/archive-activity-log.md)формат данных в учетной записи хранилища изменится на JSON Lines 1 ноября 2018 года. Ниже описывается влияние этого изменения, а также приводятся инструкции по обновлению инструментария для включения поддержки нового формата. 
>
> 

## <a name="what-is-changing"></a>Изменения

Azure Monitor предлагает возможность, позволяющую отправлять данные о диагностике ресурсов и данные журнала активности в учетную запись хранения данных Azure, пространство имен событий концентраторов или в рабочее пространство аналитики журналов в Azure Monitor. В целях устранения проблем с производительностью системы **1 ноября 2018 г. в полночь по времени в формате UTC** изменится формат данных журналов, отправляемых в хранилище BLOB-объектов. Если у вас есть инструменты для считывания данных из хранилища BLOB-объектов, их необходимо обновить для распознавания нового формата данных.
...
* Это изменение произойдет один раз во всех регионах общедоступного облака. Изменения не произойдут в Microsoft Azure, работающих в 21Vianet, Azure Germany или Azure Government clouds.
* Это изменение затрагивает следующие типы данных:
  * [Журналы ресурсов ресурсов Azure](archive-diagnostic-logs.md) [(см. список ресурсов здесь)](diagnostic-logs-schema.md)
