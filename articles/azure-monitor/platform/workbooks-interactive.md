...
| `Cell Details` | Показывает значение ячейки на вкладке контекста сетки свойств. полезно, когда ячейка содержит динамический тип со сведениями (например, JSON с такими свойствами запроса, как расположение, экземпляр роли и т. д.). |
| `Cell Details` | Показывает значение ячейки на вкладке контекста сетки свойств. полезно, когда ячейка содержит динамический тип со сведениями (например, JSON с такими свойствами запроса, как расположение, экземпляр роли и т. д.). |
