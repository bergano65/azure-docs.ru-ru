...
|:--- |:--- |:--- |:--- |
| состояние |Да |Activated, Resolved |Состояние оповещения на основе заданных условий. |
...
| description |Да | |Описание данного предупреждения. |
