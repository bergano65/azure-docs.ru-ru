...
* Для журнала действий Azure выберите пространство имен концентраторов событий и Azure Monitor создает концентратор событий в этом пространстве имен, называется «insights журналы operational-logs.» Для других типов журналов, можно выбрать существующий концентратор событий (что позволяет повторно использовать тот же концентратор событий insights журналы operational-logs) или создать концентратор событий каждой категории журналов в Azure Monitor.
* Как правило необходимо открыть исходящий порт 5671 и 5672 на компьютере или виртуальной сети Использование данных из концентратора событий.
...
* [Архивация журнала действий для учетной записи хранения](../../azure-monitor/platform/archive-activity-log.md)
* [Прочитайте обзор журнала действий Azure](../../azure-monitor/platform/activity-logs-overview.md)
* [Настройка предупреждения о событиях журнала действий](../../azure-monitor/platform/alerts-log-webhook.md)
