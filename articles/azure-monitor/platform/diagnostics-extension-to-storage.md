...
| --- | --- |
| Журналы Azure |Таблицы |
| Журналы IIS 7.0 |BLOB-объекты |
| Журналы инфраструктуры системы диагностики Azure |Таблицы |
| Журналы трассировки невыполненных запросов |BLOB-объекты |
| Журналы событий Windows |Таблицы |
| Счетчики производительности |Таблицы |
| Аварийные дампы |BLOB-объекты |
| Пользовательские журналы ошибок |BLOB-объекты |
