...
- [Потоковая передача журналов ресурсов в службу сторонних разработчиков](../../azure-monitor/platform/resource-logs-stream-event-hubs.md)
