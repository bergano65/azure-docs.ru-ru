...
![Логотип эластичных БД](./media/partners/elastic.png)
...
![Логотип монитор логики](./media/partners/logicmonitor.png)
...
Serverless360 — это средство в одну платформу, для удостоверения, управление и мониторинг бессерверных компонентов Azure. Управляемость является одним из основных проблем с бессерверной реализациями. Сотни небольших отдельных служб бессерверной разбросаны в различных местах – управление и эксплуатации таких решений является сложным. Serverless360 решает эти проблемы с богатый набор сложных средств. Она позволяет отслеживать бессерверной служб, таких как "функции Azure", Logic Apps, сетки событий, очереди служебной шины, разделы, ретрансляторы, концентраторов событий, хранилища очередей, файлов, больших двоичных объектов и таблиц. Serverless360 доступна в Azure Marketplace. Эти возможности доступны как для SaaS, так и для частного размещения (размещенный в собственной среде).  

[Подробнее][serverless360-doc]

## <a name="signalfx"></a>SignalFx

![Логотип SignalFX](./media/partners/signalfx.png)

SignalFx является ведущей службой операционной аналитики в режиме реального времени для сред DevOps, управляемых данными. Служба обнаруживает и собирает метрики для каждого компонента в облаке. Она заменяет традиционные инструменты и обеспечивает видимость в режиме реального времени в современных динамических средах. Использующая высокомасштабируемую платформу SignalFx, платформа SaaS оптимизирована для архитектур на основе контейнеров и микрослужб и обеспечивает мощную визуализацию, проактивное оповещение и возможности сортировки с поддержкой совместной работы в организациях всех размеров. SignalFx интегрируется непосредственно с помощью Azure Monitor, а также через соединители с открытым исходным кодом например *Telegraf*, *statsD*, и *collectd* для обеспечения лучшей в классе панели мониторинга, аналитики и оповещения для Azure.
...
![Логотип sumo Logic](./media/partners/SumoLogic.png)
...
[influxdata-doc]: ./../../azure-monitor/platform/collect-custom-metrics-linux-telegraf.md "Данных Azure Monitor Наплыв Telegraf интеграции."
...
[serverless360-doc]: https://docs.serverless360.com/docs/associating-service-principals "Документация по Serverless360."
