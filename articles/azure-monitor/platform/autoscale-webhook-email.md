...
При использовании шаблона REST API или диспетчер ресурсов включите элемент Notifications в [autoscalesettings](https://docs.microsoft.com/azure/templates/microsoft.insights/2015-04-01/autoscalesettings) со следующими параметрами.
...
| операции |да |Для увеличения экземпляров это будет "Горизонтально увеличить масштаб", а для уменьшения экземпляров — "Горизонтально уменьшить масштаб" |
