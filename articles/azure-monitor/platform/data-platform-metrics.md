...
| Оповещение | Настройка [правила оповещения метрики](alerts-metric.md) , отправляет уведомление или принимает [автоматизированное действие](action-groups.md) когда значение метрики достигает порогового значения. |
