...
* Поддерживаемые регионы - только с перечисленных ниже регионов Azure поддерживаются System Center Operations Manager для подключения к рабочей области Log Analytics.
