...
1. Отображаемые значения измерения основаны на данных метрик, собранных за последний день.
1. Если значение измерения еще не выдается или не отображается, можно использовать параметр "добавить пользовательское значение" для добавления значения настраиваемого измерения
