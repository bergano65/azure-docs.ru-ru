...
| \Процессор(_общий объем ресурсов)\частота процессора |Счетчик |
| \Система\процессы |Счетчик |
| \Процессор (_общий объем ресурсов)\число потоков |Счетчик |
| \Процессор (_общий объем ресурсов)\число обработанных элементов |Счетчик |
...
| \PhysicalDisk(_Total)\Средняя длина очереди диска |Счетчик |
| \ Физический диск (_Total) \Logicaldisk длина очереди чтения диска |Счетчик |
| \ Физический диск (_Total) \Logicaldisk длина очереди записи на диск |Счетчик |
| \Физический диск(_общий объем ресурсов)\% свободного места |Процент |
| \Логический диск(_общий объем ресурсов)\свободная память (в мегабайтах) |Счетчик |
...
| \Физический диск\Средняя длина очереди диска |Счетчик |
| \Сетевой интерфейс\Передано байт |Байты |
| \Сетевой интерфейс\Получено байт |Байты |
| \Сетевой интерфейс\Передано пакетов |Счетчик |
| \Сетевой интерфейс\ Получено пакетов |Счетчик |
| \Сетевой интерфейс\Всего байт |Байты |
| \Сетевой интерфейс\Всего ошибок RX |Счетчик |
| \Сетевой интерфейс\Всего ошибок TX |Счетчик |
| \Сетевой интерфейс\Всего конфликтов |Счетчик |
...
| DiskQueueLength |Счетчик |
| HttpQueueLength |Счетчик |
| BytesReceived |Байты |
| BytesSent |Байты |
