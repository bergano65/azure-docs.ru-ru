...
[Создайте параметр диагностики](diagnostic-settings.md) для отправки журналов ресурсов в рабочую область log Analytics. Эти данные хранятся в таблицах, как описано в разделе [Структура журналов Azure Monitor](./data-platform-logs.md). Таблицы, используемые журналами ресурсов, зависят от типа коллекции, используемой ресурсом.
