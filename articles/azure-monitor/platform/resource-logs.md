...
| ResourceProvider    | Категория     | А  | B  | C  | D  | E  | F  | G.  | H  | I  |
| -- | -- | -- | -- | -- | -- | -- | -- | -- | -- | -- |
...
В PT1H.jsфайла каждое событие хранится в следующем формате. При этом будет использоваться общая схема верхнего уровня, но она будет уникальной для каждой службы Azure, как описано в статье о [схемах журналов ресурсов](diagnostic-logs-schema.md).
