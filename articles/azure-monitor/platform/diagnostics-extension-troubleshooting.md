...
Если идентификатор ресурса неверный, проверьте правильность задания идентификатора ресурса в разделе **конфигурации** **диагностики** > **метрики** > **ResourceId** .
