...
Если вы используете только одну часть сочетания, автоматического масштабирования будут присутствовать только действия в одном направлении (scale out или in) пока не будет достигнуто максимальное или минимальное количество экземпляров подсчет определены в профиле. Это не является оптимальным. В идеале нужный ресурс для масштабирования в периоды высокой нагрузки должен обеспечивать доступность. Аналогичным образом в некоторых случаях с низким уровнем использования для экономии средств необходимо, чтобы ресурс уменьшался.
