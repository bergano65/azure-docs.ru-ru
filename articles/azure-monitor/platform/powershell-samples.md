...
| [Создание рабочей области Log Analytics с помощью PowerShell](../scripts/powershell-sample-create-workspace.md) | Создает рабочую область Log Analytics в Azure Monitor.|
| | |
