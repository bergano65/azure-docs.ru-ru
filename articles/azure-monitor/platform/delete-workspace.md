...
Для удаления рабочего пространства Log Analytics необходимо иметь разрешение на удаление рабочего пространства Log Analytics.<br>
Если вы получаете сообщение об ошибке '*Это имя рабочего пространства уже используется*' при создании рабочего пространства, это может быть с:
* Имя рабочего пространства недоступно и используется кем-то в вашей организации или другим клиентом.
* Рабочее пространство было удалено за последние 14 дней, а его название сохранено зарезервированным для периода мягкого удаления. Чтобы переопределить мягкое удаление и немедленно удалить рабочее пространство и создать новое рабочее пространство с тем же именем, выполните следующие шаги, чтобы восстановить рабочее пространство сначала и выполнить постоянное удаление:<br>
   1. [Восстановить](https://docs.microsoft.com/azure/azure-monitor/platform/delete-workspace#recover-workspace) рабочее пространство.
   2. [Постоянно удаляйте](https://docs.microsoft.com/azure/azure-monitor/platform/delete-workspace#permanent-workspace-delete) рабочее пространство.
   3. Создание нового рабочего пространства с использованием того же имени рабочего пространства.
