...
|---|---|---|---|---|---|
|Процентный|Среднее|Расположение запуска, имя теста|
...
|Единица измерения|Поддерживаемые агрегаты|Поддерживаемые измерения|
|---|---|---|---|---|---|
|Миллисекунд|Average, min, Max|Расположение запуска, имя теста, результат теста
...
|Единица измерения|Поддерживаемые агрегаты|Поддерживаемые измерения|
|---|---|---|---|---|---|
|Число|Число|Расположение запуска, имя теста, результат теста|
...
|---|---|---|
|Миллисекунд|Average, min, Max|Нет|
...
Эта метрика отражает число вызванных исключений из кода приложения, выполняемого в браузере. В метрику включаются только исключения, которые отправляются с помощью вызова API ```trackException()``` Application Insights.

|Единица измерения|Поддерживаемые агрегаты|Предварительно агрегированные измерения|Примечания|
|---|---|---|---|
|Число|Число|Нет|В версии на основе журнала используется агрегирование **сумм**|
...
|Единица измерения|Поддерживаемые агрегаты|Предварительно агрегированные измерения|Примечания|
|---|---|---|---|
|Число|Число|Имя роли облака, экземпляр облачной роли, тип устройства|В версии на основе журнала используется агрегирование **сумм**|
...
|Единица измерения|Поддерживаемые агрегаты|Предварительно агрегированные измерения|Примечания|
|---|---|---|---|
|Число|Число|Экземпляр роли облака, имя облачной роли, реальный или искусственный трафик, производительность запросов, код ответа|В версии на основе журнала используется агрегирование **сумм**|
...
|Единица измерения|Поддерживаемые агрегаты|Предварительно агрегированные измерения|Примечания|
|---|---|---|---|
|Число|Число|Имя роли облака, экземпляр облачной роли|В версии на основе журнала используется агрегирование **сумм**|
...
|Единица измерения|Поддерживаемые агрегаты|Поддерживаемые измерения|
|---|---|---|
|Процентный|Average, min, Max|Экземпляр облачной роли
...
|Единица измерения|Поддерживаемые агрегаты|Поддерживаемые измерения|
|---|---|---|
|Байт|Average, min, Max|Экземпляр облачной роли
