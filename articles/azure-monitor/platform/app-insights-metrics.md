...
> [!NOTE]
> Для сбора метрик браузера приложение должно быть инструментировано с помощью [фрагмента SDK для Application Insights JavaScript](../../azure-monitor/app/javascript.md#add-the-sdk-script-to-your-app-or-web-pages).
