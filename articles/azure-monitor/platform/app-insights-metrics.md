...
|---|---|---|---|---|---|
|Процент|Среднее|Расположение запуска, имя теста|
...
|Единица измерения|Поддерживаемые агрегаты|Поддерживаемые измерения|
|---|---|---|---|---|---|
|Счетчик|Счетчик|Расположение запуска, имя теста, результат теста|
...
|---|---|---|---|
|Счетчик|Счетчик|Нет|В версии на основе журнала используется агрегирование **сумм**|
...
|Единица измерения|Поддерживаемые агрегаты|Предварительно агрегированные измерения|Примечания|
|---|---|---|---|
|Счетчик|Счетчик|Имя роли облака, экземпляр облачной роли, тип устройства|В версии на основе журнала используется агрегирование **сумм**|
...
|Единица измерения|Поддерживаемые агрегаты|Предварительно агрегированные измерения|Примечания|
|---|---|---|---|
|Счетчик|Счетчик|Экземпляр роли облака, имя облачной роли, реальный или искусственный трафик, производительность запросов, код ответа|В версии на основе журнала используется агрегирование **сумм**|
...
|Единица измерения|Поддерживаемые агрегаты|Предварительно агрегированные измерения|Примечания|
|---|---|---|---|
|Счетчик|Счетчик|Имя роли облака, экземпляр облачной роли|В версии на основе журнала используется агрегирование **сумм**|
