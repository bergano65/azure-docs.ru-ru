...
>[!NOTE]
>В рамках текущего перехода от Microsoft Operations Management Suite (OMS) к Azure Monitor шлюз OMS теперь называется шлюзом Log Analytics. 
>
...
* System Center Operations Manager 2012 с пакетом обновления 1 (SP1) и накопительным пакетом обновления 7 (UR7), Operations Manager 2012 R2 с накопительным пакетом обновления 3 (UR3), группа управления Operations Manager 2016 или более поздней версии, интегрируемая с Log Analytics.  
...
1. Откройте командную строку с повышенными привилегиями.
    ...
    б) Щелкните **командную строку** правой кнопкой мыши, а затем выберите **Запустить от имени администратора**.  
