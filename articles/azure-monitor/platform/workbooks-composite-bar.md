...
Параметры составных панелей для заголовков:

![Снимок экрана параметров заголовка составной полосы с параметрами, описанными выше.](./media/workbooks-composite-bar/tiles-settings.png)
