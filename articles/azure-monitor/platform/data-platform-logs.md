...
| Данные | Описание |
|:---|:---|
| Диагностика ресурсов | Настройте параметры диагностики для записи в диагностические данные, включая метрики в Log Analytics рабочей области. См. статью [потоковая передача журналов ресурсов Azure в log Analytics](resource-logs-collect-workspace.md). |
...
| Хранилище таблиц Azure | Собирайте данные из службы хранилища Azure, где некоторые ресурсы Azure записывают данные мониторинга. [Дополнительные сведения о событиях с log Analytics см. в статье Использование хранилища BLOB-объектов Azure для IIS и хранилища таблиц Azure](diagnostics-extension-logs.md). |
