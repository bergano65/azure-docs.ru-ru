...
ms.locfileid: "68814328"
---
# <a name="logs-in-azure-monitor"></a>Журналы в Azure Monitor

> [!NOTE]
> Все данные, собранные Azure Monitor, помещаются в один из двух фундаментальных типов, метрик и журналов. В этой статье описываются журналы. В [Azure Monitor](data-platform-metrics.md) подробное описание метрик и [мониторинг данных, собираемых Azure Monitor,](data-platform.md) см. в разделе метрики.
...
| Data | Описание |
|:---|:---|
| Диагностика ресурсов | Настройте параметры диагностики для записи в диагностические данные, включая метрики в Log Analytics рабочей области. См. статью [Streaming журналов диагностики Azure для log Analytics](diagnostic-logs-stream-log-store.md). |
