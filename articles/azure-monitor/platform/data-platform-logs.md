...
| Табличное хранилище Azure | Сбор данных из службы хранилища Azure, где некоторые ресурсы Azure записывать данные мониторинга. См. в разделе [используйте хранилище BLOB-объектов для IIS и хранилища таблиц Azure для событий с помощью Log Analytics](azure-storage-iis-table.md). |
