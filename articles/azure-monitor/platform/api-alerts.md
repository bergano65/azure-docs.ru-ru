...
> [!NOTE]
> Начиная с 14 мая 2018 года все оповещения в общедоступном облаке Azure экземпляра рабочей области Log Analytics будут автоматически отображаться в Azure. Пользователь может по собственному желанию инициировать отображение оповещений в Azure до 14 мая 2018 года. Дополнительные сведения см. в статье [Интеграция оповещений из Log Analytics в Azure](../../azure-monitor/platform/alerts-extend.md). Теперь действия пользователей, которые отображают оповещения в Azure, контролируются в группах действий Azure. Если рабочая область и ее оповещения перенесены в Azure, можно извлечь или добавить действия с помощью [API группы действий](https://docs.microsoft.com/rest/api/monitor/actiongroups).
...
| Attachment |Вложения пока не поддерживаются, поэтому это свойство всегда будет иметь значение None. |
