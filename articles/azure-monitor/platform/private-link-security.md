...
* Объект АМПЛС может одновременно подключаться к 20 Azure Monitor ресурсам.
...
* АМПЛС A подключается к 2 рабочим областям и 1 компонент Application Insight: с помощью 3/20 из возможных ресурсов Azure Monitor.
...
4. На экране ресурса
   ...
   Б. Для **типа ресурсов** выберите **Microsoft.insights/privateLinkScopes**. 
