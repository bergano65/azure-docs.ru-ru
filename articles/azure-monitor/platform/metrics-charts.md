...
## <a name="multiple-metrics-and-charts"></a>Несколько метрики и диаграммы

Кроме того, можно создавать диаграммы, отобразить несколько метрик или отображение нескольких диаграмм метрик за один раз. Эта функция позволяет:
...
### <a name="multiple-metrics-on-a-chart"></a>Нескольких метрик на диаграмме

Во-первых, [создать диаграмму](#create-a-new-chart). Нажмите кнопку **добавить метрику** и повторите шаги, чтобы добавить другую метрику на одной диаграмме.
