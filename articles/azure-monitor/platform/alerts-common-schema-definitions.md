...
* **Основные**сведения: Набор стандартизованных полей, общих для всех типов оповещений, описывающих ресурс, на котором включено оповещение, а также дополнительные общие метаданные предупреждений (например, серьезность или описание). 
