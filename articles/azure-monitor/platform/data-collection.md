...
- [Журналы действий](collect-activity-logs.md) из ресурсов Azure, которые включают информацию о конфигурации и работоспособности ресурсов, и [журналы диагностики](../../monitoring-and-diagnostics/monitor-stream-diagnostic-logs-log-analytics.md), предоставляющие аналитические данные о работе ресурсов.
...
> [!IMPORTANT]
> Данные из Application Insights хранятся в отдельном разделе, а не вместе с другими данными журнала в Azure Monitor. Это позволяет использовать такие же функции, что и для других данных журнала, но для доступа к этим данным необходимо использовать [консоль Application Insights](/application-insights/app-insights-analytics.md) или [API Application Insights](https://dev.applicationinsights.io/). Для анализа данных приложений вместе с другими данными журналов можно использовать [межресурсный запрос](../log-query/cross-workspace-query.md).
