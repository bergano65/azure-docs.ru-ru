...
* [POST purge](https://docs.microsoft.com/rest/api/loganalytics/workspacepurge/purge) — принимает объект с параметрами удаляемых данных и возвращает идентификатор GUID. 
