...
| Уровень | Description | Метод сбора |
|:---|:---|:---|
...
| Место назначения | Description | Справочные материалы |
|:---|:---|:---|
...
| Хранилище | Отправка журналов ресурсов в службу хранилища Azure для архивирования. | [Архивация журналов ресурсов Azure](resource-logs-collect-workspace.md) |
...
| Место назначения | Description | Справочные материалы |
|:---|:---|:---|
| Хранилище | При включении расширения диагностики оно по умолчанию будет записывать данные в учетную запись хранения. | [Хранение и просмотр диагностических данных в службе хранилища Azure](diagnostics-extension-to-storage.md) |
...
| Хранилище виртуальных машин | Azure Monitor для виртуальных машин использует агент Log Analytics для хранения сведений о состоянии работоспособности в пользовательском расположении. Эта возможность доступна только для Azure Monitor для виртуальных машин портал Azure в дополнение к [REST API работоспособности ресурсов Azure](/rest/api/resourcehealth/). | [Сведения о работоспособности виртуальных машин Azure](../insights/vminsights-health.md)<br>[REST API работоспособности ресурсов Azure](https://docs.microsoft.com/rest/api/resourcehealth/) |
...
| Место назначения | Метод | Description | Справочные материалы |
|:---|:---|:---|:---|
...
| Служба | Место назначения | Description | Справочные материалы |
|:---|:---|:---|:---|
...
| [Azure Sentinel](/azure/sentinel/) | Журналы Azure Monitor | Azure Sentinel сохраняет собранные данные из разных источников данных в Log Analytics рабочей области, что позволяет анализировать данные журналов, собираемых Azure Monitor.  | [Подключение источников данных](/azure/sentinel/quickstart-onboard) |
