...
Комплексный мониторинг и управление виртуальными машинами Windows или Linux или физическими компьютерами обеспечивается с помощью агента Log Analytics. Виртуальная машина может работать в Azure, другом облаке или локальной среде. Агент подключается к Log Analytics либо напрямую, либо через System Center Operations Manager и позволяет собирать данные из настроенных [источников данных](../../azure-monitor/platform/agent-data-sources.md) или [решений мониторинга](../../azure-monitor/insights/solutions.md), которые предоставляют дополнительные сведения о приложениях, выполняемых на виртуальной машине.
