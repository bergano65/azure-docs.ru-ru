...
Этот запрос не является точной репликацией того, как вычисляется использование, но будет работать для предоставления рекомендаций уровня ценообразования в большинстве случаев.  
