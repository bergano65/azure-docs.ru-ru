...
Два типа данных-- `Usage` и `AzureActivity` --по умолчанию хранятся в течение не менее 90 дней, а плата за этот срок хранения 90 дней не взимается. Если срок хранения данных рабочей области увеличен до более 90 дней, то срок хранения этих типов данных также увеличится.  Плата за прием данных для этих типов данных не взимается. 
