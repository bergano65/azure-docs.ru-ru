...
Ежедневное ограничение можно настроить с помощью ARM, задав `dailyQuotaGb` параметр в разделе `WorkspaceCapping` , как описано [здесь](/rest/api/loganalytics/workspaces/createorupdate#workspacecapping). 
