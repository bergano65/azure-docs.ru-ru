...
Чтобы узнать, сколько узлов отправляло данные за последний месяц, выполните следующий запрос.
...
Это довольно дорогостоящий запрос, поэтому применяйте его осторожно. Чтобы узнать, какие типы данных отправляются на конкретный компьютер, выполните следующий запрос.
