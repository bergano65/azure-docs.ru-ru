...
|:--|:--|
| База данных MySQL | Пространство на диске в байтах |
| База данных MySQL | Таблицы |
| MySQL Server | Процент прерванных подключений |
| MySQL Server | Процент использования подключений |
| MySQL Server | Использование пространства на диске в байтах |
| MySQL Server | Процент полной проверки таблицы |
| MySQL Server | Процент попаданий в буферный пул InnoDB |
| MySQL Server | Процент использования буферного пула InnoDB |
| MySQL Server | Процент использования буферного пула InnoDB |
| MySQL Server | Процент попаданий в кэш ключа |
| MySQL Server | Процент использования кэша ключа |
| MySQL Server | Процент записи в кэш ключа |
| MySQL Server | Процент попаданий в кэш запроса |
| MySQL Server | Процент очисток кэша запроса |
| MySQL Server | Процент использования кэша запроса |
| MySQL Server | Процент попаданий в кэш таблицы |
| MySQL Server | Процент использования кэша таблицы |
| MySQL Server | Процент конфликтов блокировки таблицы |
...
| Имени объекта | Имя счетчика |
|:--|:--|
| HTTP-сервер Apache | Занятые рабочие процессы |
| HTTP-сервер Apache | Бездействующие рабочие процессы |
| HTTP-сервер Apache | Процент занятых рабочих процессов |
| HTTP-сервер Apache | Общий процент загрузки ЦП |
...
| Виртуальный узел Apache | КБ запросов в секунду |
