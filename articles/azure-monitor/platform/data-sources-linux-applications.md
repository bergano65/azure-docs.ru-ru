...
| Сервер MySQL | Счетчик производительности "Прерванные подключения" |
| Сервер MySQL | Счетчик производительности "Использование подключения" |
| Сервер MySQL | Используемое дисковое пространство в байтах |
| Сервер MySQL | Счетчик производительности "Сканирование всей таблицы" |
| Сервер MySQL | Счетчик производительности "Попадания в буферный пул InnoDB" |
| Сервер MySQL | Счетчик производительности "Использование буферного пула InnoDB" |
| Сервер MySQL | Счетчик производительности "Использование буферного пула InnoDB" |
| Сервер MySQL | Счетчик производительности "Попадания в кэш ключей" |
| Сервер MySQL | Счетчик производительности "Использование кэша ключей" |
| MySQL Server | Счетчик производительности "Запись в кэш ключей" |
| Сервер MySQL | Счетчик производительности "Попадания в кэш запросов" |
| Сервер MySQL | Счетчик производительности "Очистка кэша запросов" |
| Сервер MySQL | Счетчик производительности "Использование кэша запросов" |
| Сервер MySQL | Счетчик производительности "Попадания в кэш таблиц" |
| Сервер MySQL | Счетчик производительности "Использование кэша таблиц" |
| Сервер MySQL | Счетчик производительности "Блокировка подключения к таблице" |
