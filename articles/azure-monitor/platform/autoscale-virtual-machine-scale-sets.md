...
4. Ниже приведен гипотетический сценарий масштабирования, который используется в данном пошаговом руководстве.
   ...
   * **На основе нагрузки** — мне хотелось бы масштабировать или в зависимости от нагрузки на мое приложение, размещенное в моем масштабируемом наборе. *
...
[Общие метрики для автомасштабирования](autoscale-common-metrics.md)
