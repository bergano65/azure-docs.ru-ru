...
4. Ниже приведен гипотетический сценарий масштабирования, который используется в данном пошаговом руководстве.
   ...
   * **Нагрузка основана** - я хотел бы масштабировать или в зависимости от нагрузки на мое приложение, размещенное на моем наборе масштаба.
   ...
   * *Последние два профиля могут также иметь другие правила, основанные на метрике производительности. В этом случае я решил не иметь один и вместо этого полагаться на показатели производительности по умолчанию на основе правил. Правила не являются обязательными для повторяющихся и дата на основе профилей.*
...
[Общие метрики для автоскалирования](autoscale-common-metrics.md)
