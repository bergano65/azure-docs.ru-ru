...
| Журналы Azure Monitor    | Log Analytics рабочей области, основанной на обозреватель данных Azure, которая предоставляет мощный модуль анализа и расширенный язык запросов. | [Служба Log Analytics](../log-query/portals.md)<br>[Log Analytics API](https://dev.loganalytics.io/)<br>[API Application Insights](https://dev.applicationinsights.io/reference/get-query) |
