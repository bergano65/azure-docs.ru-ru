...
Схема для журналов диагностики ресурсов зависит от типа ресурса, который определяется `resourceId` свойством, `category` и свойств. В следующем списке перечислены все службы Azure, которые поддерживают журналы ресурсов со ссылками на схему службы и конкретной категории, где это возможно.
