...
Если пользовательский интерфейс группы действий портал Azure не позволяет выбрать код страны, то SMS не поддерживается в вашей стране. Цены на поддерживаемые страны перечислены на [странице цен на Azure Monitor](https://azure.microsoft.com/pricing/details/monitor/). Если код страны недоступен, можно проголосовать за добавление вашей страны в [Пользовательский Голос](https://feedback.azure.com/forums/913690-azure-monitor/suggestions/36663181-add-more-country-codes-for-sms-alerting-and-voice).  
...
Если пользовательский интерфейс группы действий портал Azure не позволяет выбрать код страны, то голосовой звонок не будет поддерживаться в вашей стране. Цены на поддерживаемые страны перечислены на [странице цен на Azure Monitor](https://azure.microsoft.com/pricing/details/monitor/). Если код страны недоступен, можно проголосовать за добавление вашей страны в [Пользовательский Голос](https://feedback.azure.com/forums/913690-azure-monitor/suggestions/36663181-add-more-country-codes-for-sms-alerting-and-voice).  
