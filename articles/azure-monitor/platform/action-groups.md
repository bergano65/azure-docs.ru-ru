...
1. Определяет список уведомлений для отправки при срабатывании оповещения. Для каждого уведомления укажите следующие сведения:
    ...
    a. **Тип уведомления**: выберите тип уведомления, которое вы хотите отправить. Доступные параметры:
    ...
    d. **Общая схема оповещений** Можно включить [общую схему оповещений](https://aka.ms/commonAlertSchemaDocs), которая дает преимущества единых расширяемых и унифицированных полезных данных оповещений во всех службах оповещений в Azure Monitor.
