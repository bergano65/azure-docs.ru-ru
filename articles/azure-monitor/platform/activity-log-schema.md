...
```
Дополнительные сведения о значениях в свойствах см. в статье об [уведомлениях о работоспособности службы](./../../monitoring-and-diagnostics/monitoring-service-notifications.md).
...
При потоковой передаче журнала действий Azure в учетную запись хранения или пространство имен Центров событий данные соответствуют [схеме журналов системы диагностики Azure](./tutorial-dashboards.md). Ниже приведено сопоставление свойств приведенной выше схемы и схемы журналов диагностики:
...
* [Дополнительные сведения о журнале действий (прежнее название — журналы аудита)](../../monitoring-and-diagnostics/monitoring-overview-activity-logs.md)
* [Потоковая передача журнала действий Azure в Центры событий](../../monitoring-and-diagnostics/monitoring-stream-activity-logs-event-hubs.md)
