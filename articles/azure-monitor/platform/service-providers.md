...
2. Power BI как центральное расположение. Power BI может выступать в качестве центрального расположения, если различные рабочие области экспортируют данные в это расположение с помощью интеграции между Log Analytics и [Power BI](../../azure-monitor/platform/powerbi.md). 
