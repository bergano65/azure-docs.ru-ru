...
[Журналы платформы](platform-logs-overview.md) в Azure, в том числе журнал действий Azure и журналы ресурсов, предоставляют подробные сведения о диагностике и аудите для ресурсов Azure и платформы Azure, от которых они зависят. В этой статье описывается сбор журналов ресурсов в Log Analytics рабочей области, что позволяет анализировать их с другими данными мониторинга, собранными в журналах Azure Monitor, используя мощные запросы журналов, а также использовать другие функции Azure Monitor, такие как оповещения и визуализации. 
...
| ResourceProvider    | Категория     | Объект  | B  | В  | D  | E  | F  | G.  | H  | I  |
| -- | -- | -- | -- | -- | -- | -- | -- | -- | -- | -- |
...
- Таблица *Service1AuditLogs* выглядит следующим образом:
    ...
    | Поставщик ресурсов | Категория | Объект | B | В |
    | -- | -- | -- | -- | -- |
