...
- PowerShell- [Get-азсчедуледкуерируле](https://docs.microsoft.com/powershell/module/az.monitor/get-azscheduledqueryrule?view=azps-3.7.0)
- REST API: [выведите список по подписке](https://docs.microsoft.com/rest/api/monitor/scheduledqueryrules/listbysubscription).
