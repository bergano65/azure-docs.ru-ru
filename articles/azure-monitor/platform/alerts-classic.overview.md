...
> [!NOTE]
> В этой статье объясняется, как создавать классические оповещения метрик прежней версии. Azure Monitor теперь поддерживает [новые метереик и новые оповещения в режиме реального времени и новый опыт оповещения.](../../azure-monitor/platform/alerts-overview.md) Классические оповещения [отменяются,](https://docs.microsoft.com/azure/azure-monitor/platform/monitoring-classic-retirement)хотя все еще в ограниченном использовании для ресурсов, которые еще не поддерживают новые оповещения. 
>
...
## <a name="old-and-new-alerting-capabilities"></a>Старые и новые возможности оповещения
...
- **Единый авторский опыт** - Все создание оповещения для метрик, журналов и журналов активности в Azure Monitor, Log Analytics и Application Insights находится в одном месте.
...
Для данных журнала ресурсов, доступных через Azure Monitor, маршрут данных в журнал Analytics и используйте оповещение о запросе журнала. В журнале Analytics теперь используется [новый метод оповещения](../../azure-monitor/platform/alerts-overview.md) 
...
* **Действие** - конкретный вызов, отправленный получателю уведомления (например, отправка адреса по электронной почте или размещение на URL-адрес веб-крючка). Обычно уведомления могут активировать несколько действий.
...
* Подробнее о [метриках](data-platform.md)
...
* Подробнее о [журнале активности](platform-logs-overview.md)
