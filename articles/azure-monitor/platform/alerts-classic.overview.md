...
- **Усовершенствованная система уведомлений.** Во всех новых оповещениях используются [группы действий](./action-groups.md). Это именованные группы уведомлений и действий, которые можно использовать в нескольких оповещениях.  В классических оповещениях метрик и оповещениях прежней версии Log Analytics группы действий не используются. 
...
Для данных журнала ресурсов, доступных через Azure Monitor, отправьте их в Log Analytics и используйте предупреждение о запросе журнала. Log Analytics теперь использует [новый метод создания предупреждений](./alerts-overview.md) 
