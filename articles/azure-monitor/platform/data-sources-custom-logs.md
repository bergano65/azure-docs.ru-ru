---
title: Собирайте пользовательские журналы с помощью агента Log Analytics в Azure Monitor
...
ms.locfileid: "95911742"
---
# <a name="collect-custom-logs-with-log-analytics-agent-in-azure-monitor"></a>Собирайте пользовательские журналы с помощью агента Log Analytics в Azure Monitor
...
- Для Linux часовой пояс конвересион не поддерживается для меток времени в журналах.
...
2. Щелкните **Data**  >  **пользовательские журналы** данных.
