...
- Дополнительные сведения об изменениях в [Управлении обновлениями](../../automation/migrate-oms-update-deployments.md) см. в статье [Перенос развертываний обновлений OMS в Azure](../../automation/automation-update-management.md).
...
| Contributor | участник Log Analytics. |
