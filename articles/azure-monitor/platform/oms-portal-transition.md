...
- [Решение NSG заменяется](#azure-network-security-group-analytics) улучшенной функциональностью, доступной с помощью решения Traffic Analytics.
...
Управление доступом на портале Azure предусматривает больше возможностей и функций, чем управление доступом на портале OMS. Подробнее об управлении доступом в журнале Log Analytics читайте в [материале «Проектирование рабочего пространства журналов Azure Monitor Logs».](design-logs-deployment.md)
