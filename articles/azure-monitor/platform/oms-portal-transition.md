...
Управление доступом на портале Azure предусматривает больше возможностей и функций, чем управление доступом на портале OMS. Дополнительные сведения об управлении доступом в Log Analytics см. в разделе [проектирование Azure Monitor журналов рабочей области] Design-Logs-deployment.md).
