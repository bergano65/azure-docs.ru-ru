...
1. В поле **Имя последовательности** добавьте имя последовательности и нажмите кнопку **Создать последовательность**.<br><br>![Сохранение последовательности](media/flow-tutorial/flow06.png)
2. Теперь последовательность создана и будет выполняться через день, как задано в расписании. 
3. Чтобы проверить последовательность, щелкните **Запустить сейчас**, а затем — **Запустить последовательность**.<br><br>![Запуск последовательности](media/flow-tutorial/flow07.png)
3. По завершении последовательности проверьте почту получателя, которую вы указали.  Вы должны получить сообщение с текстом, подобным этому:<br><br>![Пример электронного сообщения](media/flow-tutorial/flow08.png)


## <a name="next-steps"></a>Дополнительная информация

- Дополнительные сведения о [поиске по журналам Log Analytics](../../azure-monitor/log-query/log-query-overview.md).
