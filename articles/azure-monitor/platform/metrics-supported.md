...
|sqlserver_process_core_percent|Основные проценты основных процессов сервера Сервера|Процент|Максимальная|Процент использования процессора для процесса S'L Server, измеряемый операционной системой.|Отсутствуют|
|sqlserver_process_memory_percent|Процент памяти процесса обработки серверов S'L|Процент|Максимальная|Процент использования памяти для процесса S'L Server, измеряемый операционной системой.|Отсутствуют|
|tempdb_data_size|Темпб данных файл размер килобайт|Count|Максимальная|Темп файла данных Размер килобайт. Не применяется к хранилищам данных.|Отсутствуют|
|tempdb_log_size|Tempdb журнал файл размер килобайт|Count|Максимальная|Tempdb журнал файл размер килобайт. Не применяется к хранилищам данных.|Отсутствуют|
|tempdb_log_used_percent|Tempdb Процент Журнала Используется|Процент|Максимальная|Tempdb Процент Журнала Используется. Не применяется к хранилищам данных.|Отсутствуют|
...
|sqlserver_process_core_percent|Основные проценты основных процессов сервера Сервера|Процент|Максимальная|Процент использования процессора для процесса S'L Server, измеряемый операционной системой. Применяется к эластичным бассейнам.|Отсутствуют|
|sqlserver_process_memory_percent|Процент памяти процесса обработки серверов S'L|Процент|Максимальная|Процент использования памяти для процесса S'L Server, измеряемый операционной системой. Применяется к эластичным бассейнам.|Отсутствуют|
|tempdb_data_size|Темпб данных файл размер килобайт|Count|Максимальная|Темпб данных файл размер килобайт|Отсутствуют|
|tempdb_log_size|Tempdb журнал файл размер килобайт|Count|Максимальная|Tempdb журнал файл размер килобайт|Отсутствуют|
|tempdb_log_used_percent|Tempdb Процент Журнала Используется|Процент|Максимальная|Tempdb Процент Журнала Используется|Отсутствуют|
