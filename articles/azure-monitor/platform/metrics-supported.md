...
|private_bytes_metric|Байты исключительного пользования|Байты|Средняя|Байтов исключительного назначения.|ServerResourceType|
|virtual_bytes_metric|Байт виртуальной памяти|Байты|Средняя|Число виртуальных байтов.|ServerResourceType|
...
|mashup_engine_private_bytes_metric|Байты исключительного пользования подсистемы M|Байты|Средняя|Использование байтов исключительного пользования процессом гибридного механизма.|ServerResourceType|
|mashup_engine_virtual_bytes_metric|Байты виртуальной памяти подсистемы M|Байты|Средняя|Использование виртуальной памяти процессами гибридного механизма.|ServerResourceType|
...
|хттпинкомингрекуестдуратион|хттпинкомингрекуестдуратион|Count|Средняя|Задержка HTTP-запроса.|StatusCode|
...
|AppMemoryCommitted|Назначенная память для приложения|Байты|Средняя|Память, назначенная ВИРТУАЛЬНОЙ машины Java в байтах|AppName, Pod|
|AppMemoryUsed|Используемая память для приложения|Байты|Средняя|Используемая память приложения в байтах|AppName, Pod|
...
|MaxOldGenMemoryPoolBytes|Максимальный доступный размер данных старого поколения|Байты|Средняя|Максимальный размер пула памяти старого поколения|AppName, Pod|
|OldGenMemoryPoolBytes|Размер данных старого поколения|Байты|Средняя|Размер пула памяти старого поколения после полного GC|AppName, Pod|
...
|Недоступные для использования ядра|Недоступные для использования ядра|Count|Средняя|Число неиспользуемых ядер|Сценарий, имя_кластера|
|Замещенные ядра|Замещенные ядра|Count|Средняя|Число ядер с вытеснением|Сценарий, имя_кластера|
|Освобождаемые ядра|Освобождаемые ядра|Count|Средняя|Число покидает ядер|Сценарий, имя_кластера|
|Процент использования квоты|Процент использования квоты|Count|Средняя|Процент использования квоты|Сценарий, имя_кластера, Вмфамилинаме, Вмприорити|
...
|MemoryUsage|Использование памяти|Байты|Средняя|Использование памяти|Узел|
|MemoryLimit|Предельный объем памяти|Байты|Средняя|Предельный объем памяти|Узел|
|MemoryUsagePercentageInDouble|Процент использования памяти|Процент|Среднее|Процент использования памяти|Узел|
|StorageUsage|Использование хранилища|Байты|Средняя|Использование хранилища|Узел|
...
|ConnectionActive|Активные подключения|Count|Средняя|Активные подключения|Узел|
...
|totalcommandsprocessed0|Total Operations (Shard 0)|Count|Итог||Нет|
|cachehits0|Cache Hits (Shard 0)|Count|Итог||Нет|
|cachemisses0|Cache Misses (Shard 0)|Count|Итог||Нет|
|getcommands0|Gets (Shard 0)|Count|Итог||Нет|
|setcommands0|Sets (Shard 0)|Count|Итог||Нет|
|operationsPerSecond0|Количество операций в секунду (сегмент 0).|Count|Максимальная||Нет|
|evictedkeys0|Evicted Keys (Shard 0)|Count|Итог||Нет|
|totalkeys0|Total Keys (Shard 0)|Count|Максимальная||Нет|
|expiredkeys0|Expired Keys (Shard 0)|Count|Итог||Нет|
...
|totalcommandsprocessed1|Total Operations (Shard 1)|Count|Итог||Нет|
|cachehits1|Cache Hits (Shard 1)|Count|Итог||Нет|
|cachemisses1|Cache Misses (Shard 1)|Count|Итог||Нет|
|getcommands1|Gets (Shard 1)|Count|Итог||Нет|
|getcommands1|Sets (Shard 1)|Count|Итог||Нет|
|operationsPerSecond1|Количество операций в секунду (сегмент 1).|Count|Максимальная||Нет|
|evictedkeys1|Evicted Keys (Shard 1)|Count|Итог||Нет|
|totalkeys1|Total Keys (Shard 1)|Count|Максимальная||Нет|
|expiredkeys1|Expired Keys (Shard 1)|Count|Итог||Нет|
...
|totalcommandsprocessed2|Total Operations (Shard 2)|Count|Итог||Нет|
|cachehits2|Cache Hits (Shard 2)|Count|Итог||Нет|
|cachemisses2|Cache Misses (Shard 2)|Count|Итог||Нет|
|getcommands2|Gets (Shard 2)|Count|Итог||Нет|
|getcommands2|Sets (Shard 2)|Count|Итог||Нет|
|operationsPerSecond2|Количество операций в секунду (сегмент 2).|Count|Максимальная||Нет|
|evictedkeys2|Evicted Keys (Shard 2)|Count|Итог||Нет|
|totalkeys2|Total Keys (Shard 2)|Count|Максимальная||Нет|
|expiredkeys2|Expired Keys (Shard 2)|Count|Итог||Нет|
...
|totalcommandsprocessed3|Total Operations (Shard 3)|Count|Итог||Нет|
|cachehits3|Cache Hits (Shard 3)|Count|Итог||Нет|
|cachemisses3|Cache Misses (Shard 3)|Count|Итог||Нет|
|getcommands3|Gets (Shard 3)|Count|Итог||Нет|
|setcommands3|Sets (Shard 3)|Count|Итог||Нет|
|operationsPerSecond3|Количество операций в секунду (сегмент 3).|Count|Максимальная||Нет|
|evictedkeys3|Evicted Keys (Shard 3)|Count|Итог||Нет|
|totalkeys3|Total Keys (Shard 3)|Count|Максимальная||Нет|
|expiredkeys3|Expired Keys (Shard 3)|Count|Итог||Нет|
...
|totalcommandsprocessed4|Total Operations (Shard 4)|Count|Итог||Нет|
|cachehits4|Cache Hits (Shard 4)|Count|Итог||Нет|
|cachemisses4|Cache Misses (Shard 4)|Count|Итог||Нет|
|getcommands4|Gets (Shard 4)|Count|Итог||Нет|
|setcommands4|Sets (Shard 4)|Count|Итог||Нет|
|operationsPerSecond4|Количество операций в секунду (сегмент 4).|Count|Максимальная||Нет|
|evictedkeys4|Evicted Keys (Shard 4)|Count|Итог||Нет|
|totalkeys4|Total Keys (Shard 4)|Count|Максимальная||Нет|
|expiredkeys4|Expired Keys (Shard 4)|Count|Итог||Нет|
...
|totalcommandsprocessed5|Total Operations (Shard 5)|Count|Итог||Нет|
|cachehits5|Cache Hits (Shard 5)|Count|Итог||Нет|
|cachemisses5|Cache Misses (Shard 5)|Count|Итог||Нет|
|getcommands5|Gets (Shard 5)|Count|Итог||Нет|
|getcommands5|Sets (Shard 5)|Count|Итог||Нет|
|operationsPerSecond5|Количество операций в секунду (сегмент 5).|Count|Максимальная||Нет|
|evictedkeys5|Evicted Keys (Shard 5)|Count|Итог||Нет|
|totalkeys5|Total Keys (Shard 5)|Count|Максимальная||Нет|
|expiredkeys5|Expired Keys (Shard 5)|Count|Итог||Нет|
...
|totalcommandsprocessed6|Total Operations (Shard 6)|Count|Итог||Нет|
|cachehits6|Cache Hits (Shard 6)|Count|Итог||Нет|
|cachemisses6|Cache Misses (Shard 6)|Count|Итог||Нет|
|getcommands6|Gets (Shard 6)|Count|Итог||Нет|
|setcommands6|Sets (Shard 6)|Count|Итог||Нет|
|operationsPerSecond6|Количество операций в секунду (сегмент 6).|Count|Максимальная||Нет|
|evictedkeys6|Evicted Keys (Shard 6)|Count|Итог||Нет|
|totalkeys6|Total Keys (Shard 6)|Count|Максимальная||Нет|
|expiredkeys6|Expired Keys (Shard 6)|Count|Итог||Нет|
...
|totalcommandsprocessed7|Total Operations (Shard 7)|Count|Итог||Нет|
|cachehits7|Cache Hits (Shard 7)|Count|Итог||Нет|
|cachemisses7|Cache Misses (Shard 7)|Count|Итог||Нет|
|getcommands7|Gets (Shard 7)|Count|Итог||Нет|
|setcommands7|Sets (Shard 7)|Count|Итог||Нет|
|operationsPerSecond7|Количество операций в секунду (сегмент 7).|Count|Максимальная||Нет|
|evictedkeys7|Evicted Keys (Shard 7)|Count|Итог||Нет|
|totalkeys7|Total Keys (Shard 7)|Count|Максимальная||Нет|
|expiredkeys7|Expired Keys (Shard 7)|Count|Итог||Нет|
...
|totalcommandsprocessed8|Total Operations (Shard 8)|Count|Итог||Нет|
|cachehits8|Cache Hits (Shard 8)|Count|Итог||Нет|
|cachemisses8|Cache Misses (Shard 8)|Count|Итог||Нет|
|getcommands8|Gets (Shard 8)|Count|Итог||Нет|
|setcommands8|Sets (Shard 8)|Count|Итог||Нет|
|operationsPerSecond8|Количество операций в секунду (сегмент 8).|Count|Максимальная||Нет|
|evictedkeys8|Evicted Keys (Shard 8)|Count|Итог||Нет|
|totalkeys8|Total Keys (Shard 8)|Count|Максимальная||Нет|
|expiredkeys8|Expired Keys (Shard 8)|Count|Итог||Нет|
...
|totalcommandsprocessed9|Total Operations (Shard 9)|Count|Итог||Нет|
|cachehits9|Cache Hits (Shard 9)|Count|Итог||Нет|
|cachemisses9|Cache Misses (Shard 9)|Count|Итог||Нет|
|getcommands9|Gets (Shard 9)|Count|Итог||Нет|
|setcommands9|Sets (Shard 9)|Count|Итог||Нет|
|operationsPerSecond9|Количество операций в секунду (сегмент 9).|Count|Максимальная||Нет|
|evictedkeys9|Evicted Keys (Shard 9)|Count|Итог||Нет|
|totalkeys9|Total Keys (Shard 9)|Count|Максимальная||Нет|
|expiredkeys9|Expired Keys (Shard 9)|Count|Итог||Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|Загрузка ЦП|Percentage CPU|Процент|Средняя|Процент выделенных вычислительных единиц, используемых в настоящее время виртуальными машинами.|Нет|
...
|Disk Read Operations/Sec|Disk Read Operations/Sec|Число/с|Средняя|Количество операций вода-вывода в секунду при чтении с диска.|Нет|
|Disk Write Operations/Sec|Disk Write Operations/Sec|Число/с|Средняя|Количество операций вода-вывода в секунду при записи на диск.|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|Загрузка ЦП|Percentage CPU|Процент|Средняя|Процент выделенных вычислительных единиц, используемых в настоящее время виртуальными машинами.|RoleInstanceId|
...
|Disk Read Operations/Sec|Disk Read Operations/Sec|Число/с|Средняя|Количество операций вода-вывода в секунду при чтении с диска.|RoleInstanceId|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|UsedCapacity|Используемая емкость|Байты|Средняя|Используемая емкость учетной записи|Нет|
...
|SuccessServerLatency|Успешно выполненная задержка сервера|Миллисекунды|Средняя|Задержка, используемая службой хранилища Azure для обработки успешного запроса в миллисекундах. Это значение не включает в себя сетевую задержку, указанную в метрике SuccessE2ELatency.|Геотипизированный, ApiName, проверка подлинности|
|SuccessE2ELatency|Успешно выполненная задержка E2E|Миллисекунды|Средняя|Сквозная задержка успешных запросов к службе хранилища или заданной операции API в миллисекундах. Это значение включает необходимое время обработки в пределах службы хранилища Azure для считывания запроса, отправки ответа и получения подтверждения ответа.|Геотипизированный, ApiName, проверка подлинности|
|Доступность|Доступность|Процент|Средняя|Процент доступности службы хранения или указанной операции API. Доступность рассчитывается следующим образом: общее значение запросов для тарификации делится на количество применимых запросов, включая те, которые вызвали непредвиденные ошибки. Все непредвиденные ошибки приводят к снижению уровня доступности службы хранения или указанной операции API.|Геотипизированный, ApiName, проверка подлинности|
...
|BlobCount|Количество больших двоичных объектов|Count|Средняя|Количество больших двоичных объектов в службе BLOB-объектов учетной записи хранения.|BlobType, уровень|
|ContainerCount|Количество контейнеров больших двоичных объектов|Count|Средняя|Количество контейнеров в службе BLOB-объектов учетной записи хранения.|Нет|
|IndexCapacity|Емкость индекса|Байты|Средняя|Объем хранилища, используемый ADLS 2-го поколения (иерархический) индекс в байтах.|Нет|
|Transactions|Transactions|Count|Итог|Количество запросов к службе хранения или указанной операции API. Это число включает успешные и неудачные запросы, а также запросы, вызвавшие ошибку. Используйте измерение ResponseType для различных типов ответа.|ResponseType, геотип, ApiName, проверка подлинности|
|Входящий трафик|Входящий трафик|Байты|Итог|Объем входящих данных в байтах. Это количество включает входящий трафик из внешнего клиента в службу хранилища Azure, а также входящий трафик в пределах Azure.|Геотипизированный, ApiName, проверка подлинности|
|Исходящие|Исходящие|Байты|Итог|Объем входящих данных в байтах. Это количество включает исходящий трафик из внешнего клиента в службу хранилища Azure, а также исходящий трафик в пределах Azure. В результате это количество не отражает исходящий трафик для тарификации.|Геотипизированный, ApiName, проверка подлинности|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|TableCapacity|Емкость таблицы|Байты|Средняя|Объем хранилища, используемый Хранилищем таблиц учетной записи хранения, в байтах.|Нет|
|TableCount|Количество таблиц|Count|Средняя|Количество таблиц в Хранилище таблиц учетной записи хранения.|Нет|
|TableEntityCount|Количество сущностей таблиц|Count|Средняя|Количество сущностей таблиц в Хранилище таблиц учетной записи хранения.|Нет|
|Transactions|Transactions|Count|Итог|Количество запросов к службе хранения или указанной операции API. Это число включает успешные и неудачные запросы, а также запросы, вызвавшие ошибку. Используйте измерение ResponseType для различных типов ответа.|ResponseType, геотип, ApiName, проверка подлинности|
|Входящий трафик|Входящий трафик|Байты|Итог|Объем входящих данных в байтах. Это количество включает входящий трафик из внешнего клиента в службу хранилища Azure, а также входящий трафик в пределах Azure.|Геотипизированный, ApiName, проверка подлинности|
|Исходящие|Исходящие|Байты|Итог|Объем входящих данных в байтах. Это количество включает исходящий трафик из внешнего клиента в службу хранилища Azure, а также исходящий трафик в пределах Azure. В результате это количество не отражает исходящий трафик для тарификации.|Геотипизированный, ApiName, проверка подлинности|
|SuccessServerLatency|Успешно выполненная задержка сервера|Миллисекунды|Среднее|Задержка, используемая службой хранилища Azure для обработки успешного запроса в миллисекундах. Это значение не включает в себя сетевую задержку, указанную в метрике SuccessE2ELatency.|Геотипизированный, ApiName, проверка подлинности|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|FileCapacity|Емкость файла|Байты|Средняя|Объем хранилища, используемый службой файлов учетной записи хранения в байтах.|FileShare|
|FileCount|Количество файлов|Count|Средняя|Число файлов в файловой службе учетной записи хранения.|FileShare|
|FileShareCount|Количество общих файловых ресурсов|Count|Средняя|Число общих файловых ресурсов в файловой службе учетной записи хранения.|Нет|
|FileShareSnapshotCount|Число моментальных снимков файлового ресурса|Count|Средняя|Количество моментальных снимков, имеющихся в службе файлов учетной записи хранения в общей папке.|FileShare|
|FileShareSnapshotSize|Размер моментального снимка файлового ресурса|Байты|Средняя|Объем хранилища, используемый моментальными снимками в файловой службе учетной записи хранения в байтах.|FileShare|
|FileShareQuota|Размер квоты файлового ресурса|Байты|Средняя|Верхний предел объема хранилища, который может использоваться службой файлов Azure в байтах.|FileShare|
...
|Доступность|Доступность|Процент|Средняя|Процент доступности службы хранения или указанной операции API. Доступность рассчитывается следующим образом: общее значение запросов для тарификации делится на количество применимых запросов, включая те, которые вызвали непредвиденные ошибки. Все непредвиденные ошибки приводят к снижению уровня доступности службы хранения или указанной операции API.|Геотипизированный, ApiName, проверка подлинности, Общая папка|

## <a name="microsoftclassicstoragestorageaccountsqueueservices"></a>Microsoft.ClassicStorage/storageAccounts/queueServices

|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|QueueCapacity|Емкость очереди|Байты|Средняя|Объем хранилища, используемый службой очередей учетной записи хранения, в байтах.|Нет|
|QueueCount|Количество очередей|Count|Средняя|Количество очередей в службе очередей учетной записи хранения.|Нет|
|QueueMessageCount|Количество сообщений очереди|Count|Средняя|Приблизительное количество сообщений очередей в службе очередей учетной записи хранения.|Нет|
|Transactions|Transactions|Count|Итог|Количество запросов к службе хранения или указанной операции API. Это число включает успешные и неудачные запросы, а также запросы, вызвавшие ошибку. Используйте измерение ResponseType для различных типов ответа.|ResponseType, геотип, ApiName, проверка подлинности|
|Входящий трафик|Входящий трафик|Байты|Итог|Объем входящих данных в байтах. Это количество включает входящий трафик из внешнего клиента в службу хранилища Azure, а также входящий трафик в пределах Azure.|Геотипизированный, ApiName, проверка подлинности|
|Исходящие|Исходящие|Байты|Итог|Объем входящих данных в байтах. Это количество включает исходящий трафик из внешнего клиента в службу хранилища Azure, а также исходящий трафик в пределах Azure. В результате это количество не отражает исходящий трафик для тарификации.|Геотипизированный, ApiName, проверка подлинности|
|SuccessServerLatency|Успешно выполненная задержка сервера|Миллисекунды|Среднее|Задержка, используемая службой хранилища Azure для обработки успешного запроса в миллисекундах. Это значение не включает в себя сетевую задержку, указанную в метрике SuccessE2ELatency.|Геотипизированный, ApiName, проверка подлинности|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|Загрузка ЦП|Percentage CPU|Процент|Средняя|Процент выделенных вычислительных единиц, которые в настоящее время используются виртуальными машинами.|Нет|
...
|Оставшиеся кредиты ЦП|Оставшиеся кредиты ЦП|Count|Средняя|Общее число доступных для увеличения кредитов|Нет|
|Использованные кредиты ЦП|Использованные кредиты ЦП|Count|Средняя|Общее количество кредитов, использованных виртуальной машиной|Нет|
...
|Длина очереди в расчете на диск|Диск данных длина очереди [(не рекомендуется)](portal-disk-metrics-deprecation.md)] (Portal-Disk-Metrics-Deprecation.md)|Count|Средняя|Длина очереди дисков данных|ИД слота|
...
|Длина очереди на диск ОС|Диск ОС длина очереди [(не рекомендуется)](portal-disk-metrics-deprecation.md)|Count|Средняя|Длина очереди дисков ОС|Нет|
...
|Длина очереди диска данных|Длина очереди диска данных (предварительная версия)|Count|Средняя|Длина очереди дисков данных|LUN|
...
|Длина очереди диска ОС|Длина очереди диска ОС (предварительная версия)|Count|Средняя|Длина очереди дисков ОС|Нет|
|Входящие потоки|Входящие потоки|Count|Средняя|Входящие потоки — это число текущих потоков во входящем направлении (трафик, поступающий на виртуальную машину).|Нет|
|Исходящие потоки|Исходящие потоки|Count|Средняя|Исходящие потоки — это число текущих потоков в исходящем направлении (трафик, выходящий за пределы виртуальной машины)|Нет|
...
|Попадание при чтении в кэше для диска данных категории "Премиум"|Попадание при чтении в кэше для диска данных категории "Премиум" (предварительная версия)|Процент|Средняя|Попадание при чтении в кэше для диска данных категории "Премиум"|LUN|
|Промах чтения в кэше для диска данных категории "Премиум"|Промах чтения в кэше для диска данных категории "Премиум" (предварительная версия)|Процент|Средняя|Промах чтения в кэше для диска данных категории "Премиум"|LUN|
|Попадание при чтении в кэше для диска ОС категории "Премиум"|Попадание при чтении в кэше для диска ОС категории "Премиум" (предварительная версия)|Процент|Средняя|Попадание при чтении в кэше для диска ОС категории "Премиум"|Нет|
|Промах чтения в кэше для диска ОС категории "Премиум"|Промах чтения в кэше для диска ОС категории "Премиум" (предварительная версия)|Процент|Средняя|Промах чтения в кэше для диска ОС категории "Премиум"|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|Загрузка ЦП|Percentage CPU|Процент|Средняя|Процент выделенных вычислительных единиц, которые в настоящее время используются виртуальными машинами.|VMName|
...
|Скорость чтения в расчете на диск (операций/с)|Операций чтения с диска данных/с [(устарело)](portal-disk-metrics-deprecation.md)|Число/с|Среднее|Чтение операций ввода-вывода с одного диска в течение периода мониторинга|ИД слота|
|Скорость записи в расчете на диск (операций/с)|Операций записи на диск данных в секунду [(не рекомендуется)](portal-disk-metrics-deprecation.md)|Число/с|Среднее|Запись операций ввода-вывода с одного диска в течение периода мониторинга|ИД слота|
|Длина очереди в расчете на диск|Диск данных длина очереди [(не рекомендуется)](portal-disk-metrics-deprecation.md)|Count|Средняя|Длина очереди дисков данных|ИД слота|
|Скорость чтения с диска ОС (байт/с)|Скорость чтения с диска ОС (байт/с [) (устарело)](portal-disk-metrics-deprecation.md)|Число/с|Среднее|Скорость чтения (байт/с) с одного диска в течение периода мониторинга для диска ОС|Нет|
|Скорость записи на диск ОС (байт/с)|Скорость записи на диск ОС (байт/с [) (устарело)](portal-disk-metrics-deprecation.md)|Число/с|Среднее|Байтов в секунду, записанных на один диск в течение периода мониторинга для диска ОС|Нет|
|Скорость чтения с диска ОС (операций/с)|Операций чтения с диска ОС в секунду [(не рекомендуется)](portal-disk-metrics-deprecation.md)|Число/с|Среднее|Чтение операций ввода-вывода с одного диска в течение периода мониторинга для диска ОС|Нет|
|Скорость записи на диск ОС (операций/с)|Операций записи на диск ОС в секунду [(не рекомендуется)](portal-disk-metrics-deprecation.md)|Число/с|Среднее|Запись операций ввода-вывода с одного диска в течение периода мониторинга для диска ОС|Нет|
...
|Длина очереди диска данных|Длина очереди диска данных (предварительная версия)|Count|Средняя|Длина очереди дисков данных|LUN, VMName|
...
|Длина очереди диска ОС|Длина очереди диска ОС (предварительная версия)|Count|Средняя|Длина очереди дисков ОС|VMName|
|Входящие потоки|Входящие потоки|Count|Средняя|Входящие потоки — это число текущих потоков во входящем направлении (трафик, поступающий на виртуальную машину).|VMName|
|Исходящие потоки|Исходящие потоки|Count|Средняя|Исходящие потоки — это число текущих потоков в исходящем направлении (трафик, выходящий за пределы виртуальной машины)|VMName|
...
|Попадание при чтении в кэше для диска данных категории "Премиум"|Попадание при чтении в кэше для диска данных категории "Премиум" (предварительная версия)|Процент|Средняя|Попадание при чтении в кэше для диска данных категории "Премиум"|LUN, VMName|
|Промах чтения в кэше для диска данных категории "Премиум"|Промах чтения в кэше для диска данных категории "Премиум" (предварительная версия)|Процент|Средняя|Промах чтения в кэше для диска данных категории "Премиум"|LUN, VMName|
|Попадание при чтении в кэше для диска ОС категории "Премиум"|Попадание при чтении в кэше для диска ОС категории "Премиум" (предварительная версия)|Процент|Средняя|Попадание при чтении в кэше для диска ОС категории "Премиум"|VMName|
|Промах чтения в кэше для диска ОС категории "Премиум"|Промах чтения в кэше для диска ОС категории "Премиум" (предварительная версия)|Процент|Средняя|Промах чтения в кэше для диска ОС категории "Премиум"|VMName|
...
|NetworkBytesReceivedPerSecond|Получено байтов по сети в секунду|Байты|Средняя|Количество байт, полученных по сети в секунду.|Нет|
|NetworkBytesTransmittedPerSecond|Передано байт по сети в секунду|Байты|Средняя|Количество байт, переданных по сети в секунду.|Нет|

## <a name="microsoftcontainerregistryregistries"></a>Microsoft.ContainerRegistry/registries

|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|TotalPullCount|Всего операций извлечения|Count|Средняя|Общее число опросов изображений|Нет|
|SuccessfulPullCount|Число успешных операций извлечения|Count|Средняя|Число успешных операций извлечения изображений|Нет|
|TotalPushCount|Всего операций отправки|Count|Средняя|Общее число push-уведомлений для образа|Нет|
|SuccessfulPushCount|Число успешных операций отправки|Count|Средняя|Число успешных push-уведомлений образа|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|kube_node_status_allocatable_cpu_cores|Общее количество доступных ядер ЦП в управляемом кластере|Count|Средняя|Общее количество доступных ядер ЦП в управляемом кластере|Нет|
|kube_node_status_allocatable_memory_bytes|Общий объем доступной памяти в управляемом кластере|Байты|Средняя|Общий объем доступной памяти в управляемом кластере|Нет|
|kube_pod_status_ready|Число модулей pod в состоянии готовности|Count|Средняя|Число модулей pod в состоянии готовности|пространство имен, Pod|
|kube_node_status_condition|Состояния для различных условий узла|Count|Средняя|Состояния для различных условий узла|условие, состояние, status2, узел|
|kube_pod_status_phase|Число модулей pod по фазам|Count|Средняя|Число модулей pod по фазам|этап, пространство имен, Pod|
...
|CloudReadThroughputPerShare|Пропускная способность скачивания из облака (общий ресурс)|Байт/с|Среднее|Пропускная способность загрузки в Azure из общей папки в течение отчетного периода.|Общий доступ|
|CloudUploadThroughputPerShare|Пропускная способность отправки в облако (общий ресурс)|Байт/с|Среднее|Пропускная способность передачи в Azure из общей папки в течение отчетного периода.|Общий доступ|
|BytesUploadedToCloudPerShare|Отправлено байт в облако (общий ресурс)|Байты|Средняя|Общее число байтов, отправленных в Azure из общей папки в течение отчетного периода.|Общий доступ|
|TotalCapacity|Общая емкость|Байты|Средняя|Общая емкость|Нет|
|AvailableCapacity|Доступная емкость|Байты|Средняя|Доступная емкость в байтах за отчетный период.|Нет|
...
|BytesUploadedToCloud|Отправлено байт в облако (устройство)|Байты|Средняя|Общее число байтов, отправленных в Azure с устройства за отчетный период.|Нет|
|HyperVVirtualProcessorUtilization|Пограничные вычисления — процент загрузки ЦП|Процент|Средняя|Процент использования ЦП|InstanceName|
|HyperVMemoryUtilization|Пограничные вычисления — использование памяти|Процент|Средняя|Объем используемой оперативной памяти|InstanceName|
...
|нумберофассетсвисклассификатионс|Количество активов по крайней мере с одной классификацией|Count|Средняя|Указывает количество ресурсов по крайней мере с одной классификацией тегов.|Нет|
|сканканцеллед|Сканирование отменено|Count|Итог|Указывает число отмененных просмотров.|Нет|
|сканкомплетед|Сканирование завершено|Count|Итог|Указывает количество успешно выполненных проверок.|Нет|
|сканфаилед|Сбой сканирования|Count|Итог|Указывает количество ошибок сканирования.|Нет|
|скантиметакен|Затраченное время сканирования|Секунды|Итог|Указывает общее время сканирования в секундах.|Нет|
|каталогактивеусерс|Активные Ежедневные Пользователи|Count|Итог|Ежедневное число активных пользователей|Нет|
...
|IntegrationRuntimeCpuPercentage|Использование ЦП средой выполнения интеграции|Процент|Средняя||Интегратионрунтименаме, NodeName|
|IntegrationRuntimeAvailableMemory|Доступная память для среды выполнения интеграции|Байты|Средняя||Интегратионрунтименаме, NodeName|
...
|IntegrationRuntimeQueueLength|Длина очереди среды выполнения интеграции|Count|Средняя||интегратионрунтименаме|
|интегратионрунтимеаваилабленоденумбер|Число доступных узлов в среде выполнения интеграции|Count|Средняя||интегратионрунтименаме|
...
|JobEndedFailure|Failed Jobs|Count|Итог|Количество невыполненных заданий.|Нет|
|JobEndedCancelled|Cancelled Jobs|Count|Итог|Количество отмененных заданий.|Нет|
...
|жобстаже|Задания на этапе|Count|Итог|Количество заданий на каждом этапе.|Нет|
...
|WriteRequests|Запросы на запись|Count|Итог|Количество запросов на запись данных в учетную запись.|Нет|
|ReadRequests|Запросы на чтение|Count|Итог|Количество запросов на чтение данных для учетной записи.|Нет|
...
|storage_used|Storage used|Байты|Средняя|Storage used|Нет|
...
|serverlog_storage_usage|Используемый объем хранилища для журнала сервера|Байты|Средняя|Используемый объем хранилища для журнала сервера|Нет|
|serverlog_storage_limit|Максимальный объем хранилища для журнала сервера|Байты|Средняя|Максимальный объем хранилища для журнала сервера|Нет|
|active_connections|Активные подключения|Count|Средняя|Активные подключения|Нет|
...
|backup_storage_used|Используемое хранилище резервных копий|Байты|Средняя|Используемое хранилище резервных копий|Нет|
...
|cpu_percent|Нагрузка ЦП|Процент|Среднее|Нагрузка ЦП|Нет|
|memory_percent|Процент памяти|Процент|Среднее|Процент памяти|Нет|
|iops|ОПЕРАЦИЙ ВВОДА-ВЫВОДА|Count|Средняя|Операций ввода-вывода в секунду|Нет|
|storage_percent|Процент хранилища|Процент|Среднее|Процент хранилища|Нет|
|storage_used|Storage used|Байты|Средняя|Storage used|Нет|
|active_connections|Активные подключения|Count|Средняя|Активные подключения|Нет|
|network_bytes_egress|Сеть (исходящий трафик)|Байты|Итог|Исходящий сетевой трафик по активным подключениям|Нет|
...
|maximum_used_transactionIDs|Максимальное число используемых идентификаторов транзакций|Count|Средняя|Максимальное число используемых идентификаторов транзакций|Нет|
...
|d2c.twin.read.size|Размер ответа операций чтения с двойников, инициированных устройством.|Байты|Средняя|Среднее, минимальное и максимальное значение всех успешных операций чтения, инициированных устройством.|Нет|
...
|d2c.twin.update.size|Размер обновлений двойников, инициированных устройством.|Байты|Средняя|Средний, минимальный и максимальный размеры всех успешных обновлений двойников, инициированных устройством.|Нет|
...
|c2d.methods.requestSize|Размер запроса вызовов прямых методов.|Байты|Средняя|Среднее, минимальное и максимальное значение всех успешных запросов прямых методов.|Нет|
...
|dailyMessageQuotaUsed|Общее количество используемых сообщений|Count|Среднее|Количество сообщений, использованных сегодня|Нет|
...
|конфигурации|Configuration Metrics (Метрики конфигурации)|Count|Итог|Метрики для операций конфигурации|Нет|
...
|креатеаккаунт|Учетная запись создана|Count|Count|Учетная запись создана|Нет|
...
|делетеаккаунт|Учетная запись удалена|Count|Count|Учетная запись удалена|Нет|
...
|MongoRequestsCount|Частота запросов Mongo|Число/с|Средняя|Число запросов Mongo в секунду|DatabaseName, CollectionName, регион, CommandName, ErrorCode|
|MongoRequestsDelete|Частота запросов Mongo на удаление|Число/с|Средняя|Mongoных запросов на удаление в секунду|DatabaseName, CollectionName, регион, CommandName, ErrorCode|
|MongoRequestsInsert|Частота запросов Mongo на вставку|Число/с|Средняя|Число вставок Mongo в секунду|DatabaseName, CollectionName, регион, CommandName, ErrorCode|
|MongoRequestsQuery|Частота запросов Mongo на чтение|Число/с|Средняя|Mongo запросов в секунду|DatabaseName, CollectionName, регион, CommandName, ErrorCode|
|MongoRequestsUpdate|Частота запросов Mongo на обновление|Число/с|Средняя|Mongo запросов на обновление в секунду|DatabaseName, CollectionName, регион, CommandName, ErrorCode|
...
|регионфаиловер|Отработка отказа региона|Count|Count|Отработка отказа региона|Нет|
...
|ServiceAvailability|Доступность службы|Процент|Средняя|Доступность запросов учетной записи за один час, с детализацией дня или месяца|Нет|
...
|упдатеаккаунтнетворксеттингс|Параметры сети учетной записи обновлены|Count|Count|Параметры сети учетной записи обновлены|Нет|
|упдатеаккаунтрепликатионсеттингс|Параметры репликации учетной записи обновлены|Count|Count|Параметры репликации учетной записи обновлены|Нет|
...
|ActiveConnections|ActiveConnections|Count|Средняя|Число активных подключений для Microsoft.EventHub.|Нет|
...
|ActiveConnections|ActiveConnections|Count|Среднее|Число активных подключений для Microsoft.EventHub.|Нет|
|ConnectionsOpened|Открытые подключения.|Count|Среднее|Открытые подключения для Microsoft.EventHub.|Нет|
|ConnectionsOpened|Закрытые подключения.|Count|Среднее|Закрытые подключения для Microsoft.EventHub.|Нет|
|CaptureBacklog|Невыполненная работа записи.|Count|Итог|Невыполненная работа записи для Microsoft.EventHub.|Нет|
|CapturedMessages|Записанные сообщения.|Count|Итог|Записанные сообщения для Microsoft.EventHub.|Нет|
...
|Размер|Размер EventHub в байтах.|Байты|Средняя|Размер EventHub в байтах.|Роль|
...
|ObservedCapacity|Наблюдаемая емкость|Count|Средняя|Емкость, передаваемая для автомасштабирования при выполнении.|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|availabilityResults/availabilityPercentage|Доступность|Процент|Средняя|Процент успешно завершенных тестов доступности|Аваилабилитиресулт/Name, Аваилабилитиресулт/Location|
...
|requests/rate|Частота запросов к серверу|Число/с|Средняя|Частота запросов сервера в секунду|запрос/Перформанцебуккет, запрос/resultCode, операция, искусственный, облако, roleInstance, запрос/успешно, Облако/roleName|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|connectedDeviceCount|Всего подключенных устройств|Count|Средняя|Число устройств, подключенных к IoT Central|Нет|
|C2D. свойство. Read. Success|Успешное чтение свойства устройства из IoT Central|Count|Итог|Число всех успешных операций чтения свойств, инициированных из IoT Central|Нет|
|C2D. свойство. Read. Failure|Сбой чтения свойства устройства из IoT Central|Count|Итог|Число всех неудачных операций чтения свойств, инициированных из IoT Central|Нет|
|D2C. свойство. Read. Success|Успешное чтение свойств устройства с устройств|Count|Итог|Число всех успешных операций чтения свойств, инициированных с устройств|Нет|
|D2C. свойство. Read. Failure|Сбой чтения свойств устройства с устройств|Count|Итог|Число всех неудачных операций чтения свойств, инициированных с устройств|Нет|
|C2D. свойство. Update. Success|Успешное обновление свойств устройства с IoT Central|Count|Итог|Число всех успешных обновлений свойств, инициированных из IoT Central|Нет|
|C2D. свойство. обновление. сбой|Не удалось обновить свойства устройства с IoT Central|Count|Итог|Число всех неудачных обновлений свойств, инициированных из IoT Central|Нет|
|D2C. свойство. Update. Success|Успешное обновление свойств устройства с устройств|Count|Итог|Число всех успешных обновлений свойств, инициированных с устройств|Нет|
|D2C. свойство. обновление. сбой|Не удалось обновить свойства устройства с устройств|Count|Итог|Число всех неудачных обновлений свойств, инициированных с устройств|Нет|
...
|ServiceApiLatency|Общая задержка API службы|Миллисекунды|Средняя|Общая задержка запросов к API службы|ActivityType, ActivityName, StatusCode, Статускодекласс|
...
|сатуратионшоебокс|Общая насыщенность хранилища|Процент|Средняя|Используемая емкость хранилища|ActivityType, ActivityName, Трансактионтипе|
|Доступность|Общая доступность хранилища|Процент|Средняя|Доступность запросов хранилища|ActivityType, ActivityName, StatusCode, Статускодекласс|

## <a name="microsoftkustoclusters"></a>Microsoft.Kusto/Clusters

|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|CacheUtilization|Использование кэша|Процент|Средняя|Уровень загрузки в области кластера|Нет|
|QueryDuration|Query duration (Длительность запросов)|Миллисекунды|Средняя|Длительность запросов в секундах|QueryStatus|
|IngestionUtilization|Использование приема|Процент|Средняя|Доля использованных слотов приема данных в кластере|Нет|
|KeepAlive|Проверка активности|Count|Средняя|Проверка работоспособности показывает, что кластер отвечает на запросы|Нет|
...
|ContinuousExportPendingCount|Число ожидающих непрерывного экспорта|Count|Максимальная|Число ожидающих заданий непрерывного экспорта, готовых к выполнению|Нет|
|ContinuousExportMaxLatenessMinutes|Максимальная длина непрерывного экспорта|Count|Максимальная|Задержку (в минутах), сообщаемую заданиями непрерывного экспорта в кластере|Нет|
...
|StreamingIngestDataRate|Скорость данных потокового приема|Count|Средняя|Скорость приема данных потоковой передачи (МБ в секунду)|Нет|
...
|StreamingIngestResults|Результат потокового приема|Count|Средняя|Поток приема результатов|Результат|
...
|InstanceCount|Число экземпляров|Count|Средняя|Общее число экземпляров|Нет|
...
|TriggerSuccessLatency|Trigger Success Latency |Секунды|Среднее|Задержка успешно выполненных триггеров рабочего процесса.|Нет|
|TriggerThrottledEvents|Trigger Throttled Events|Count|Итог|Число событий регулирования триггера рабочего процесса.|Нет|
|IntegrationServiceEnvironmentWorkflowProcessorUsage|Загрузка процессора рабочего процесса для среды службы интеграции|Процент|Средняя|Использование процессора рабочих процессов для среды службы интеграции.|Нет|
|IntegrationServiceEnvironmentWorkflowMemoryUsage|Использование памяти рабочего процесса для среды службы интеграции|Процент|Средняя|Использование памяти рабочего процесса для среды службы интеграции.|Нет|
|IntegrationServiceEnvironmentConnectorProcessorUsage|Загрузка процессора соединителя для среды службы интеграции|Процент|Средняя|Использование процессора соединителя для среды службы интеграции.|Нет|
...
|Освобождаемые ядра|Освобождаемые ядра|Count|Средняя|Число покидает ядер|Сценарий, имя_кластера|
|Процент использования квоты|Процент использования квоты|Count|Средняя|Процент использования квоты|Сценарий, имя_кластера, Вмфамилинаме, Вмприорити|
|CpuUtilization|CpuUtilization|Count|Средняя|CPU (Preview) (ЦП (предварительная версия))|Сценарий, runId, NodeId, время создания|
|гпуутилизатион|гпуутилизатион|Count|Средняя|GPU (Предварительная версия)|Сценарий, runId, NodeId, время создания, DeviceId|
...
|Доступность|Доступность|Процент|Средняя|Доступность API-интерфейсов|Апикатегори, ApiName|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|AssetQuota|Квота ресурсов|Count|Средняя|Сколько ресурсов разрешено для текущей учетной записи службы мультимедиа|Нет|
|AssetCount|Число ресурсов|Count|Средняя|Сколько ресурсов уже создано в текущей учетной записи службы мультимедиа|Нет|
|AssetQuotaUsedPercentage|Процент используемой квоты ресурсов|Процент|Средняя|Процент использования ресурса в текущей учетной записи службы мультимедиа|Нет|
|ContentKeyPolicyQuota|Квота политик ключей содержимого|Count|Средняя|Сколько политик ключей содержимого разрешено для текущей учетной записи службы мультимедиа|Нет|
|ContentKeyPolicyCount|Число политик ключей содержимого|Count|Средняя|Сколько политик ключей содержимого уже создано в текущей учетной записи службы мультимедиа|Нет|
|ContentKeyPolicyQuotaUsedPercentage|Процент использования квоты политик ключей содержимого|Процент|Средняя|Процент использования политики ключа содержимого в текущей учетной записи службы мультимедиа|Нет|
|StreamingPolicyQuota|Квота политик потоковой передачи|Count|Средняя|Сколько политик потоковой передачи разрешено для текущей учетной записи службы мультимедиа|Нет|
|StreamingPolicyCount|Число политик потоковой передачи|Count|Средняя|Сколько политик потоковой передачи уже созданы в текущей учетной записи службы мультимедиа|Нет|
|StreamingPolicyQuotaUsedPercentage|Процент использования квоты политик потоковой передачи|Процент|Средняя|Процент использования политики потоковой передачи в текущей учетной записи службы мультимедиа|Нет|
...
|VolumeLogicalSize|Объем использованного объема тома|Байты|Средняя|Логический размер тома (используемые байты)|Нет|
|VolumeSnapshotSize|Volume snapshot size (Размер моментальных снимков в томе)|Байты|Средняя|Размер всех моментальных снимков в томе|Нет|
|ReadIops|Read iops (Число операций ввода-вывода в секунду при чтении)|Число/с|Средняя|Число операций ввода-вывода в секунду при чтении|Нет|
|WriteIops|Write iops (Количество операций ввода-вывода в секунду при записи)|Число/с|Средняя|Число операций ввода-вывода в секунду при записи|Нет|

## <a name="microsoftnetappnetappaccountscapacitypools"></a>Microsoft.NetApp/netAppAccounts/capacityPools

|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|VolumePoolAllocatedUsed|Пул, выделенный для размера тома|Байты|Средняя|Используемый выделенный размер пула|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|VipAvailability|Data Path Availability (Доступность пути к данным)|Count|Средняя|Средняя доступность пути к данным подсистемы балансировки нагрузки за период времени|Фронтендипаддресс, FrontendPort|
|DipAvailability|Health Probe Status (Состояние пробы работоспособности)|Count|Средняя|Среднее состояние пробы работоспособности подсистемы балансировки нагрузки за период времени|ProtocolType, Баккендпорт, Фронтендипаддресс, FrontendPort, Баккендипаддресс|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|QueryVolume|Объем запросов|Count|Итог|Количество запросов, выполненных для зоны DNS|Нет|
...
|PingMeshProbesFailedPercent|Неудачные проверки связи с виртуальной машиной|Процент|Средняя|Процент числа неудачных проверок связи для общего числа отправленных сообщений ping для целевой виртуальной машины|Саурцекустомераддресс, Дестинатионкустомераддресс|
...
|FirewallHealth|Состояние работоспособности брандмауэра|Процент|Средняя|Состояние работоспособности брандмауэра|Состояние, причина|
|DataProcessed|Обработанные данные|Байты|Итог|Общий объем данных, обработанных брандмауэром|Нет|
|SNATPortUtilization|Использование портов SNAT|Процент|Средняя|Использование портов SNAT|Нет|
...
|AvgRequestCountPerHealthyHost|Количество запросов в минуту на исправный узел|Count|Средняя|Среднее число запросов в минуту за каждый работоспособный хост-сервер в пуле|BackendSettingsPool|
...
|невконнектионсперсеконд|Новых подключений в секунду|Число/с|Средняя|Новых подключений в секунду, установленных с помощью шлюза приложений|Нет|
|CpuUtilization|Загрузка ЦП|Процент|Средняя|Текущая загрузка ЦП шлюзом приложений|Нет|
|CapacityUnits|Текущее число единиц емкости|Count|Средняя|Потребленные единицы мощности|Нет|
|фикседбиллаблекапаЦитюнитс|Фиксированные оплачиваемые единицы емкости|Count|Средняя|Единицы с минимальной емкостью, которые будут заряжены|Нет|
|естиматедбилледкапаЦитюнитс|Расчетные единицы пропускной способности|Count|Средняя|Предполагаемые единицы мощности, которые будут заряжены|Нет|
|ComputeUnits|Текущее число единиц вычислений|Count|Средняя|Потребленные единицы вычислений|Нет|
...
|BlockedReqCount|Число заблокированных запросов для брандмауэра веб-приложения v1|Count|Итог|Число заблокированных запросов для брандмауэра веб-приложения v1|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|RxLightLevel|RxLightLevel|Count|Средняя|Уровень источника RX в dBm|Связь, дорожка|
|TxLightLevel|TxLightLevel|Count|Средняя|Уровень источника TX в dBm|Связь, дорожка|
|AdminState|AdminState|Count|Средняя|Состояние администратора порта|Ссылка|
|LineProtocol|LineProtocol|Count|Средняя|Состояние протокола строки для порта|Ссылка|
...
|BgpAvailability|Доступность BGP|Процент|Средняя|Доступность BGP от MSEE к всем одноранговым узлам.|Пирингтипе, одноранговая|
|ArpAvailability|Доступность ARP|Процент|Средняя|Доступность ARP из MSEE для всех узлов.|Пирингтипе, одноранговая|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|BitsInPerSecond|BitsInPerSecond|Число/с|Средняя|Входящий трафик Azure в секунду (в битах)|Нет|
|BitsOutPerSecond|BitsOutPerSecond|Число/с|Средняя|Исходящий трафик Azure в секунду (в битах)|Нет|

## <a name="microsoftnetworkexpressroutegateways"></a>Microsoft.Network/expressRouteGateways

|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|ErGatewayConnectionBitsInPerSecond|BitsInPerSecond|Число/с|Средняя|Входящий трафик Azure в секунду (в битах)|ConnectionName|
|ErGatewayConnectionBitsOutPerSecond|BitsOutPerSecond|Число/с|Средняя|Исходящий трафик Azure в секунду (в битах)|ConnectionName|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|ProbesFailedPercent|Доля проб с ошибками, в процентах|Процент|Средняя|Доля проб мониторинга подключения с ошибками, в процентах|Нет|
...
|BackendHealthPercentage|Работоспособность серверного компонента (в процентах)|Процент|Средняя|Процент успешных проб работоспособности от прокси-сервера HTTP/S к серверным частям|Серверная часть, неработоспособных|
|WebApplicationFirewallRequestCount|Web Application Firewall Request Count (Число запросов к брандмауэру веб-приложения)|Count|Итог|Количество клиентских запросов, обрабатываемых брандмауэром веб-приложения|PolicyName, RuleName, действие|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|QueryVolume|Объем запросов|Count|Итог|Число запросов, выполненных для зоны Частная зона DNS|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|registration.all|Операции регистрации|Count|Итог|Число всех успешных операций регистрации (создание, запрос, обновление и удаление). |Нет|
|registration.create|Операции создания регистрации|Count|Итог|Число всех успешных операций создания регистраций.|Нет|
|registration.update|Операции обновления регистрации|Count|Итог|Число всех успешных операций обновления регистраций.|Нет|
|registration.get|Операции чтения регистрации|Count|Итог|Число всех успешных запросов регистрации.|Нет|
|registration.delete|Операции удаления регистрации|Count|Итог|Число всех успешных операций удаления регистраций.|Нет|
|incoming|Входящие сообщения|Count|Итог|Число всех успешно отправленных вызовов API. |Нет|
|incoming.scheduled|Отправлено запланированных push-уведомлений|Count|Итог|Отменено запланированных push-уведомлений|Нет|
|incoming.scheduled.cancel|Отменено запланированных push-уведомлений|Count|Итог|Отменено запланированных push-уведомлений|Нет|
...
|installation.all|Операции управления установкой|Count|Итог|Операции управления установкой|Нет|
|installation.get|Операции получения установки|Count|Итог|Операции получения установки|Нет|
...
|Average_Current Disk Queue Length|Текущая длина очереди диска|Count|Средняя|Average_Current Disk Queue Length|Computer, ObjectName, имя_экземпляра, Каунтерпас, Sourcesystem имеет значение|
|Average_Available MBytes|Доступный объем в МБ|Count|Средняя|Average_Available MBytes|Computer, ObjectName, имя_экземпляра, Каунтерпас, Sourcesystem имеет значение|
|Average_% Committed Bytes In Use|Использование выделенной памяти (в байтах), %|Count|Средняя|Average_% Committed Bytes In Use|Computer, ObjectName, имя_экземпляра, Каунтерпас, Sourcesystem имеет значение|
|Average_Bytes Received/sec|Полученных байтов/с|Count|Средняя|Average_Bytes Received/sec|Computer, ObjectName, имя_экземпляра, Каунтерпас, Sourcesystem имеет значение|
|Average_Bytes Sent/sec|Отправленных байтов/с|Count|Средняя|Average_Bytes Sent/sec|Computer, ObjectName, имя_экземпляра, Каунтерпас, Sourcesystem имеет значение|
|Average_Bytes Total/sec|Всего байтов/с|Count|Средняя|Average_Bytes Total/sec|Computer, ObjectName, имя_экземпляра, Каунтерпас, Sourcesystem имеет значение|
|Average_Processor Queue Length|Длина очереди процессора|Count|Средняя|Average_Processor Queue Length|Computer, ObjectName, имя_экземпляра, Каунтерпас, Sourcesystem имеет значение|
|Пульс|Пульс|Count|Итог|Пульс|Computer, OSType, Version, Саурцекомпутерид|
|Обновление|Update|Count|Средняя|Обновление|Компьютер, продукт, классификация, Упдатестате, необязательный, утвержденный|
|Событие|Событие|Count|Средняя|Событие|Source, EventLog, Computer, Евенткатегори, Евентлевел, него eventlevelname, EventID|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|SessionAvailabilityV4|Доступность сеанса v4|Процент|Средняя|Доступность сеанса v4|ConnectionId|
|SessionAvailabilityV6|Доступность сеанса V6|Процент|Средняя|Доступность сеанса V6|ConnectionId|
|ингресстраффикрате|Скорость входящего трафика|битсперсеконд|Средняя|Скорость входящего трафика в битах в секунду|ConnectionId|
|егресстраффикрате|Скорость исходящего трафика|битсперсеконд|Средняя|Скорость исходящего трафика в битах в секунду|ConnectionId|
...
|нумберофассетсвисклассификатионс|Количество активов по крайней мере с одной классификацией|Count|Средняя|Указывает количество ресурсов по крайней мере с одной классификацией тегов.|ResourceId|
...
|SearchQueriesPerSecond|Search queries per second|Число/с|Средняя|Число поисковых запросов в секунду для службы поиска.|Нет|
|ThrottledSearchQueriesPercentage|Throttled search queries percentage|Процент|Средняя|Процент отрегулированных поисковых запросов для службы поиска.|Нет|
...
|ConnectionsOpened|Открытые подключения.|Count|Средняя|Открытые подключения для Microsoft.ServiceBus.|EntityName|
|ConnectionsOpened|Закрытые подключения.|Count|Средняя|Закрытые подключения для Microsoft.ServiceBus.|EntityName|
|Размер|Размер|Байты|Средняя|Размер очереди или раздела в байтах.|EntityName|
|Сообщения|Число сообщений в очереди или разделе.|Count|Средняя|Число сообщений в очереди или разделе.|EntityName|
|ActiveMessages|Число активных сообщений в очереди или разделе.|Count|Средняя|Число активных сообщений в очереди или разделе.|EntityName|
|DeadletteredMessages|Число недоставленных сообщений в очереди или разделе.|Count|Средняя|Число недоставленных сообщений в очереди или разделе.|EntityName|
|ScheduledMessages|Число запланированных сообщений в очереди или разделе.|Count|Средняя|Число запланированных сообщений в очереди или разделе.|EntityName|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|AllocatedCpu|AllocatedCpu|Count|Средняя|ЦП, выделенный этому контейнеру в миллисекундах|ApplicationName, ServiceName, Кодепаккаженаме, Сервицерепликанаме|
|AllocatedMemory|AllocatedMemory|Байты|Средняя|Память, выделенная для этого контейнера, в МБ|ApplicationName, ServiceName, Кодепаккаженаме, Сервицерепликанаме|
|ActualCpu|ActualCpu|Count|Средняя|Фактическое использование ЦП в миллисекундах|ApplicationName, ServiceName, Кодепаккаженаме, Сервицерепликанаме|
|ActualMemory|ActualMemory|Байты|Средняя|Фактическое использование памяти в МБ|ApplicationName, ServiceName, Кодепаккаженаме, Сервицерепликанаме|
...
|ApplicationStatus|ApplicationStatus|Count|Средняя|Состояние Service Fabric приложения сетки|ApplicationName, состояние|
|ServiceStatus|ServiceStatus|Count|Средняя|Состояние работоспособности службы в Service Fabric приложении для сетки|ApplicationName, состояние, ServiceName|
|ServiceReplicaStatus|ServiceReplicaStatus|Count|Средняя|Состояние работоспособности реплики службы в Service Fabric приложении сети|ApplicationName, состояние, ServiceName, Сервицерепликанаме|
|ContainerStatus|ContainerStatus|Count|Средняя|Состояние контейнера в Service Fabric приложении сетки|ApplicationName, ServiceName, Кодепаккаженаме, Сервицерепликанаме, состояние|
|RestartCount|RestartCount|Count|Средняя|Число перезапусков контейнера в Service Fabric приложении сетки|ApplicationName, Status, ServiceName, Сервицерепликанаме, Кодепаккаженаме|
...
|storage_percent|Процент использования пространства данных|Процент|Максимум|Процент использования пространства данных. Неприменимо к хранилищам данных или базам данных с масштабированием.|Нет|
...
|dtu_limit|Лимит DTU|Count|Средняя|Предел DTU. Применяется к базам данных на основе DTU.|Нет|
|dtu_used|DTU used|Count|Средняя|Использованные DTU. Применяется к базам данных на основе DTU.|Нет|
|cpu_limit|Ограничение загрузки ЦП|Count|Средняя|Ограничение ЦП. Применяется к базам данных на основе виртуальное ядро.|Нет|
|cpu_used|Загрузка ЦП|Count|Средняя|ЦП используется. Применяется к базам данных на основе виртуальное ядро.|Нет|
...
|app_cpu_billed|Выставлен счет за ЦП для приложения|Count|Итог|Выплата за ЦП приложения. Применяется к бессерверным базам данных.|Нет|
...
|allocated_data_storage|Выделенное пространство данных|Байты|Средняя|Выделенное хранилище данных. Неприменимо к хранилищам данных.|Нет|
|memory_usage_percent|Процент использования памяти|Процент|Максимум|Процент памяти. Применяется только к хранилищам данных.|Нет|
...
|base_blob_size_bytes|Базовый размер хранилища BLOB-объектов|Байты|Максимальная|Базовый размер хранилища BLOB-объектов. Применяется к базам данных с масштабированием.|Нет|
...
|eDTU_limit|eDTU limit|Count|Средняя|предел eDTU. Применяется к эластичным пулам на основе DTU.|Нет|
|storage_limit|Максимальный размер данных|Байты|Средняя|Максимальный размер данных|Нет|
|eDTU_used|eDTU used|Count|Средняя|используемые eDTU. Применяется к эластичным пулам на основе DTU.|Нет|
|database_eDTU_used|eDTU used|Count|Средняя|eDTU used|DatabaseResourceId|
|storage_used|Используемое пространство данных|Байты|Средняя|Используемое пространство данных|Нет|
|database_storage_used|Используемое пространство данных|Байты|Средняя|Используемое пространство данных|DatabaseResourceId|
...
|cpu_limit|Ограничение загрузки ЦП|Count|Средняя|Ограничение ЦП. Применяется к эластичным пулам на основе виртуальное ядро.|Нет|
|database_cpu_limit|Ограничение загрузки ЦП|Count|Средняя|Ограничение загрузки ЦП|DatabaseResourceId|
|cpu_used|Загрузка ЦП|Count|Средняя|ЦП используется. Применяется к эластичным пулам на основе виртуальное ядро.|Нет|
|database_cpu_used|Загрузка ЦП|Count|Средняя|Загрузка ЦП|DatabaseResourceId|
...
|tempdb_log_size<sup>1</sup>|Размер файла журнала tempdb в КБ|Count|Максимальная|Размер файла журнала tempdb в килобайтах. |Нет|
|tempdb_log_used_percent<sup>1</sup>|Процент использования журнала tempdb|Процент|Максимум|Используемый журнал в процентах tempdb.|Нет|
|allocated_data_storage|Выделенное пространство данных|Байты|Средняя|Выделенное пространство данных|Нет|
|database_allocated_data_storage|Выделенное пространство данных|Байты|Средняя|Выделенное пространство данных|DatabaseResourceId|
|allocated_data_storage_percent|Выделенное пространство данных в процентах|Процент|Максимальная|Выделенное пространство данных в процентах|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|virtual_core_count|Virtual core count (Число виртуальных ядер)|Count|Средняя|Virtual core count (Число виртуальных ядер)|Нет|
...
|reserved_storage_mb|Зарезервированное дисковое пространство|Count|Средняя|Зарезервированное дисковое пространство|Нет|
|storage_space_used_mb|Использованное дисковое пространство|Count|Средняя|Использованное дисковое пространство|Нет|
|io_requests|IO requests count (Количество запросов ввода-вывода)|Count|Средняя|IO requests count (Количество запросов ввода-вывода)|Нет|
|io_bytes_read|Количество считанных байт ввода-вывода|Байты|Средняя|Количество считанных байт ввода-вывода|Нет|
|io_bytes_written|Количество записанных байт ввода-вывода|Байты|Средняя|Количество записанных байт ввода-вывода|Нет|
...
|Входящий трафик|Входящий трафик|Байты|Итог|Объем входящих данных в байтах. Это количество включает входящий трафик из внешнего клиента в службу хранилища Azure, а также входящий трафик в пределах Azure.|Геотипизированный, ApiName, проверка подлинности|
|Исходящие|Исходящие|Байты|Итог|Объем входящих данных в байтах. Это количество включает исходящий трафик из внешнего клиента в службу хранилища Azure, а также исходящий трафик в пределах Azure. В результате это количество не отражает исходящий трафик для тарификации.|Геотипизированный, ApiName, проверка подлинности|
|SuccessServerLatency|Успешно выполненная задержка сервера|Миллисекунды|Средняя|Средняя задержка, используемая службой хранилища Azure для обработки успешного запроса, в миллисекундах. Это значение не включает сетевую задержку, указанную в метрике AverageE2ELatency.|Геотипизированный, ApiName, проверка подлинности|
|SuccessE2ELatency|Успешно выполненная задержка E2E|Миллисекунды|Средняя|Средняя совокупная задержка успешных запросов к службе хранения или указанной операции API в миллисекундах. Это значение включает необходимое время обработки в пределах службы хранилища Azure для считывания запроса, отправки ответа и получения подтверждения ответа.|Геотипизированный, ApiName, проверка подлинности|
|Доступность|Доступность|Процент|Средняя|Процент доступности службы хранения или указанной операции API. Доступность рассчитывается следующим образом: общее значение запросов для тарификации делится на количество применимых запросов, включая те, которые вызвали непредвиденные ошибки. Все непредвиденные ошибки приводят к снижению уровня доступности службы хранения или указанной операции API.|Геотипизированный, ApiName, проверка подлинности|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|ClientIOPS|Всего операций ввода-вывода в секунду для клиента|Count|Средняя|Частота операций с клиентскими файлами, обрабатываемых кэшем.|Нет|
|ClientLatency|Средняя задержка клиента|Миллисекунды|Средняя|Средняя задержка операций файлового файла клиента в кэш хранилища.|Нет|
|ClientReadIOPS|Операций ввода-вывода в секунду при чтении для клиента|Число/с|Средняя|Количество операций чтения клиента в секунду.|Нет|
...
|ClientWriteIOPS|Операций ввода-вывода в секунду при записи для клиента|Число/с|Средняя|Количество операций записи клиента в секунду.|Нет|
|ClientWriteThroughput|Средняя пропускная способность записи кэша|Байт/с|Среднее|Скорость передачи данных для клиента.|Нет|
|ClientMetadataReadIOPS|Операций ввода-вывода в секунду для чтения метаданных клиента|Число/с|Средняя|Частота операций с клиентскими файлами, отправленных в кэш, за исключением операций чтения данных, которые не изменяют постоянное состояние.|Нет|
|ClientMetadataWriteIOPS|Операций ввода-вывода в секунду для записи метаданных клиента|Число/с|Средняя|Частота операций с клиентскими файлами, отправляемых в кэш, за исключением операций записи данных, которые изменяют постоянное состояние.|Нет|
|ClientLockIOPS|Операций ввода-вывода в секунду для блокировок клиента|Число/с|Средняя|Количество операций блокировки файлов клиента в секунду.|Нет|
|StorageTargetHealth|Работоспособность целевого расположения хранилища|Count|Средняя|Логические результаты проверки подключения между целевыми объектами хранилища и кэша.|Нет|
|Время доступности|Время доступности|Count|Средняя|Логические результаты проверки подключения между системой кэша и мониторинга.|Нет|
|StorageTargetIOPS|Всего операций ввода-вывода в секунду для StorageTarget|Count|Средняя|Частота операций с файлами, которые кэш отправляет определенному Сторажетаржету.|сторажетаржет|
|StorageTargetWriteIOPS|Операций ввода-вывода в секунду при записи StorageTarget|Count|Средняя|Частота операций записи в файл, отправляемых кэшем в определенный Сторажетаржет.|сторажетаржет|
...
|StorageTargetLatency|Задержка StorageTarget|Миллисекунды|Средняя|Средняя задержка кругового пути для всех операций с файлами, которые кэш отправляет в партрикулар Сторажетаржет.|сторажетаржет|
|StorageTargetMetadataReadIOPS|Операций ввода-вывода в секунду при чтении метаданных StorageTarget|Число/с|Средняя|Частота операций с файлами, которые не изменяют постоянное состояние и не выполняют операцию чтения, которые кэш отправляет определенному Сторажетаржет.|сторажетаржет|
|StorageTargetMetadataWriteIOPS|Операций ввода-вывода в секунду при записи метаданных StorageTarget|Число/с|Средняя|Частота операций с файлами, которые выполняют изменение постоянного состояния и исключают операцию записи, которые кэшируются в определенный Сторажетаржет.|сторажетаржет|
|StorageTargetReadIOPS|Операций ввода-вывода в секунду при чтении StorageTarget|Число/с|Средняя|Частота операций чтения файлов, которые кэш отправляет определенному Сторажетаржету.|сторажетаржет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|ServerSyncSessionResult|Результат сеанса синхронизации|Count|Средняя|Метрика, которая регистрирует значение 1 каждый раз, когда конечная точка сервера успешно завершает сеанс синхронизации с конечной точкой облака.|Синкграупнаме, Серверендпоинтнаме, Синкдиректион|
...
|коннектионсблоккедбифиревалл|Подключения, заблокированные брандмауэром|Count|Итог|Число подключений, заблокированных правилами брандмауэра. Повторное посещение политик управления доступом для пула SQL и отслеживание этих подключений при высоком числе|Нет|
...
|локалтемпдбуседперцент|Процент использования локальной базы данных tempdb|Процент|Максимальная|Использование локальной базы данных tempdb для всех вычислений-узлов — значения создаются каждые пять минут.|Нет|
|меморюседперцент|Процент используемой памяти|Процент|Максимальная|Использование памяти на всех узлах в пуле SQL|Нет|
...
|wlg_effective_min_resource_percent|Действующий минимальный процент ресурсов|Процент|Минимум|Допустимый параметр в процентах для минимального ресурса min, учитывая уровень обслуживания и параметры группы рабочей нагрузки. Эффективный min_percentage_resource можно изменить выше на более низких уровнях обслуживания.|Исусердефинед, WorkloadGroup|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|IngressReceivedMessages|Получено сообщений входящих данных|Count|Итог|Количество сообщений, полученных от всех источников событий (концентраторов событий Azure и Центров Интернета вещей Azure)|Нет|
|IngressReceivedInvalidMessages|Получено недопустимых сообщений во входящих данных|Count|Итог|Количество недопустимых сообщений, полученных от всех источников событий (концентраторов событий Azure и Центров Интернета вещей Azure)|Нет|
...
|IngressStoredEvents|Хранится событий входящих данных|Count|Итог|Количество сведенных событий, успешно обработанных и доступных для запросов|Нет|
...
|IngressReceivedMessagesCountLag|Интервал между номерами полученных сообщений во входящих данных|Count|Среднее|Разница между порядковым номером последней поставленной в очередь сообщения в секции источника событий и порядковым номером сообщений, обрабатываемых в входящих данных|Нет|
...
|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|IngressReceivedMessages|Получено сообщений входящих данных|Count|Итог|Количество сообщений, считанных из источника событий|Нет|
|IngressReceivedInvalidMessages|Получено недопустимых сообщений во входящих данных|Count|Итог|Количество недопустимых сообщений, считанных из источника событий|Нет|
...
|IngressReceivedMessagesCountLag|Интервал между номерами полученных сообщений во входящих данных|Count|Среднее|Разница между порядковым номером последней поставленной в очередь сообщения в секции источника событий и порядковым номером сообщений, обрабатываемых в входящих данных|Нет|
|вармсторажемакспропертиес|Максимальное число свойств для горячего хранения|Count|Максимум|Максимальное число свойств, разрешенное средой для SKU S1/S2, и максимальное количество свойств, разрешенных в "горячий" магазин для SKU PAYG|Нет|
|вармсторажеуседпропертиес|Свойства использования теплого хранилища |Count|Максимальная|Число свойств, используемых средой для SKU S1/S2, и количество свойств, используемых в "горячем" магазине для SKU PAYG|Нет|
...
|DiskReadOperations|Операции чтения с диска|Count|Итог|Число операций чтения ввода-вывода в предыдущем периоде выборки. Обратите внимание, что эти операции могут иметь переменный размер.|Нет|
...
|Disk Read Operations/Sec|Disk Read Operations/Sec|Число/с|Средняя|Среднее число операций чтения ввода-вывода в предыдущем периоде выборки. Обратите внимание, что эти операции могут иметь переменный размер.|Нет|
|Disk Write Operations/Sec|Disk Write Operations/Sec|Число/с|Средняя|Среднее число операций записи ввода-вывода в предыдущем периоде выборки. Обратите внимание, что эти операции могут иметь переменный размер.|Нет|
|DiskReadLatency|Задержка чтения с диска|Миллисекунды|Средняя|Общая задержка чтения. Сумма задержек чтения устройства и ядра.|Нет|
|DiskWriteLatency|Задержка записи на диск|Миллисекунды|Средняя|Общая задержка записи. Сумма задержек при записи в устройство и ядро.|Нет|
...
|MemoryUsed|Используемая память|Байты|Средняя|Объем памяти компьютера, используемой виртуальной машиной.|Нет|
|MemoryGranted|Предоставленная память|Байты|Средняя|Объем памяти, предоставленной виртуальной машине узлом. Память не предоставляется узлу до тех пор, пока она не будет затронута один раз и выделенная память может быть переключена или выведена из появления, если Вмкернел нуждается в памяти.|Нет|
|MemoryActive|Активная память|Байты|Средняя|Объем памяти, используемой виртуальной машиной в прошлом маленьком окне времени. Это "истинное" количество памяти, которое в настоящее время требуется виртуальной машине. Дополнительная неиспользуемая память может быть переключена или повышена, что не влияет на производительность гостевой системы.|Нет|
...
|TcpSynSent|Состояние TCP SYN-SENT|Count|Средняя|Состояние TCP SYN-SENT|Экземпляр|
|TcpSynReceived|Состояние TCP SYN-RECEIVED|Count|Средняя|Состояние TCP SYN-RECEIVED|Экземпляр|
|TcpEstablished|Состояние TCP ESTABLISHED|Count|Средняя|Состояние TCP ESTABLISHED|Экземпляр|
...
|AppConnections|Соединения|Count|Средняя|Соединения|Экземпляр|
|Маркеры|Счетчик дескрипторов|Count|Средняя|Счетчик дескрипторов|Экземпляр|
...
|HealthCheckStatus|Состояние проверки работоспособности|Count|Средняя|Состояние проверки работоспособности|Экземпляр|
...
|TotalFrontEnds|Общее число внешних интерфейсов|Count|Средняя|Общее число внешних интерфейсов|Нет|
|SmallAppServicePlanInstances|Рабочие роли плана службы приложений уровня "Малый"|Count|Средняя|Рабочие роли плана службы приложений уровня "Малый"|Нет|
|MediumAppServicePlanInstances|Рабочие процессы плана службы приложений уровня "Средний"|Count|Средняя|Рабочие процессы плана службы приложений уровня "Средний"|Нет|
|LargeAppServicePlanInstances|Рабочие процессы плана службы приложений уровня "Крупный"|Count|Средняя|Рабочие процессы плана службы приложений уровня "Крупный"|Нет|

## <a name="microsoftwebhostingenvironmentsworkerpools"></a>Microsoft.Web/hostingEnvironments/workerPools

|Метрика|Отображаемое имя метрики|Единицы|Тип статистической обработки|Описание|Измерения|
|---|---|---|---|---|---|
|WorkersTotal|Общее количество рабочих процессов|Count|Средняя|Общее количество рабочих процессов|Нет|
|WorkersAvailable|Доступные рабочие процессы|Count|Средняя|Доступные рабочие процессы|Нет|
|WorkersUsed|Использованные рабочие процессы|Count|Средняя|Использованные рабочие процессы|Нет|
|CpuPercentage|Процент использования ЦП|Процент|Среднее|Процент использования ЦП|Экземпляр|
|MemoryPercentage|Процент использования памяти|Процент|Среднее|Процент использования памяти|Экземпляр|
