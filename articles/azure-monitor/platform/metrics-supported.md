...
|Capacity|Capacity|Процент|Средняя|Метрика использования для службы ApiManagement|Location|
|EventHubTotalEvents|События всего концентратора событий|Количество|Итого|Количество событий, отправленных к концентратору событий|Location|
|EventHubSuccessfulEvents|События успешной концентратора событий|Количество|Итого|Число успешных событий концентратора событий.|Location|
|EventHubTotalFailedEvents|События сбоя концентратора событий|Количество|Итого|Количество неудачных событий концентратора событий.|Location|
|EventHubRejectedEvents|События отклоненных концентратора событий|Количество|Итого|Количество отклоненных событий концентратора событий (неправильные конфигурации, или доступ запрещен)|Location|
|EventHubThrottledEvents|События регулируемых концентратора событий|Количество|Итого|Число регулируемых событий концентратора событий.|Location|
|EventHubTimedoutEvents|Истекло время ожидания события концентратора событий.|Количество|Итого|Число истекло время ожидания события концентратора событий.|Location|
|EventHubDroppedEvents|События удаленные концентратора событий|Количество|Итого|Число событий, пропущенный из-за достигнут предел размера очереди|Location|
|EventHubTotalBytesSent|Размер событий концентратора событий.|Байты|Итого|Общий размер событий концентратора событий в байтах|Location|
...
|Latency|Latency|MilliSeconds|Средняя|Время задержки в миллисекундах.|ApiName Имя_операции, регион|
...
|Сеть (входящий трафик)|Оплачиваемый входящий трафик|Байты|Итого|Число оплачиваемых байтов, получаемых виртуальными машинами через все сетевые интерфейсы (входящий трафик)|Нет измерений|
|Сеть (исходящий трафик)|Оплачиваемый исходящий трафик|Байты|Итого|Число оплачиваемых байтов, отправляемых виртуальными машинами через все сетевые интерфейсы (исходящий трафик)|Нет измерений|
|Скорость чтения с диска|Скорость чтения с диска|Байты|Итого|Число байтов, считанных с диска во время мониторинга|Нет измерений|
|Disk Write Bytes|Скорость записи на диск|Байты|Итого|Число байтов, записанных на диск во время мониторинга|Нет измерений|
|Disk Read Operations/Sec|Чтение с дисков (операций/с)|Число/с|Средняя|Количество операций вода-вывода в секунду при чтении с диска.|Нет измерений|
|Disk Write Operations/Sec|Запись на диски (операций/с)|Число/с|Средняя|Количество операций вода-вывода в секунду при записи на диск.|Нет измерений|
...
|Скорость чтения в расчете на диск (байт/с)|Скорость чтения с диска данных (байт/с) (нерекомендуется)|Число/с|Средняя|Скорость чтения (байт/с) с одного диска во время мониторинга|ИД слота|
|Скорость записи в расчете на диск (байт/с)|Скорость записи на диск данных (байт/с) (нерекомендуется)|Число/с|Средняя|Скорость записи (байт/с) на один диск во время мониторинга|ИД слота|
|Скорость чтения в расчете на диск (операций/с)|Скорость чтения с диска данных (операций/с) (нерекомендуется)|Число/с|Средняя|Операции ввода-вывода в секунду при чтении с одного диска во время мониторинга|ИД слота|
|Скорость записи в расчете на диск (операций/с)|Скорость записи на диск данных (операций/с) (нерекомендуется)|Число/с|Средняя|Операции ввода-вывода в секунду при записи на один диск во время мониторинга|ИД слота|
|Длина очереди в расчете на диск|Длина очереди диска данных (нерекомендуется)|Количество|Средняя|Длина очереди дисков данных|ИД слота|
|Скорость чтения с диска ОС (байт/с)|Скорость чтения с диска ОС (байт/с) (нерекомендуется)|Число/с|Средняя|Скорость чтения (байт/с) с одного диска во время мониторинга для диска ОС|Нет измерений|
|Скорость записи на диск ОС (байт/с)|Скорость записи на диск ОС (байт/с) (нерекомендуется)|Число/с|Средняя|Скорость записи (байт/с) на один диск во время мониторинга для диска ОС|Нет измерений|
|Скорость чтения с диска ОС (операций/с)|Скорость чтения с диска ОС (операций/с) (нерекомендуется)|Число/с|Средняя|Операции ввода-вывода в секунду при чтении с одного диска во время мониторинга для диска ОС|Нет измерений|
|Скорость записи на диск ОС (операций/с)|Скорость записи на диск ОС (операций/с) (нерекомендуется)|Число/с|Средняя|Операции ввода-вывода в секунду при записи на один диск во время мониторинга для диска ОС|Нет измерений|
|Длина очереди на диск ОС|Длина очереди диска ОС (нерекомендуется)|Количество|Средняя|Длина очереди дисков ОС|Нет измерений|
|Скорость чтения с диска данных (байт/с)|Скорость чтения с диска данных (байт/с) (предварительная версия)|Число/с|Средняя|Скорость чтения (байт/с) с одного диска во время мониторинга|LUN|
|Скорость записи на диск данных (байт/с)|Скорость записи на диск данных (байт/с) (предварительная версия)|Число/с|Средняя|Скорость записи (байт/с) на один диск во время мониторинга|LUN|
|Скорость чтения с диска данных (операций/с)|Скорость чтения с диска данных (операций/с) (предварительная версия)|Число/с|Средняя|Операции ввода-вывода в секунду при чтении с одного диска во время мониторинга|LUN|
|Скорость записи на диск данных (операций/с)|Скорость записи на диск данных (операций/с) (предварительная версия)|Число/с|Средняя|Операции ввода-вывода в секунду при записи на один диск во время мониторинга|LUN|
|Длина очереди диска данных|Длина очереди диска данных (предварительная версия)|Количество|Средняя|Длина очереди дисков данных|LUN|
|Скорость чтения с диска ОС (байт/с)|Скорость чтения с диска ОС (байт/с) (предварительная версия)|Число/с|Средняя|Скорость чтения (байт/с) с одного диска во время мониторинга для диска ОС|Нет измерений|
|Скорость записи на диск ОС (байт/с)|Скорость записи на диск ОС (байт/с) (предварительная версия)|Число/с|Средняя|Скорость записи (байт/с) на один диск во время мониторинга для диска ОС|Нет измерений|
|Скорость чтения с диска ОС (операций/с)|Скорость чтения с диска ОС (операций/с) (предварительная версия)|Число/с|Средняя|Операции ввода-вывода в секунду при чтении с одного диска во время мониторинга для диска ОС|Нет измерений|
|Скорость записи на диск ОС (операций/с)|Скорость записи на диск ОС (операций/с) (предварительная версия)|Число/с|Средняя|Операции ввода-вывода в секунду при записи на один диск во время мониторинга для диска ОС|Нет измерений|
|Длина очереди диска ОС|Длина очереди диска ОС (предварительная версия)|Количество|Средняя|Длина очереди дисков ОС|Нет измерений|
|Входящие потоки|Входящие потоки (предварительная версия)|Количество|Средняя|Входящие потоки — это число текущих входящих потоков (с трафиком по направлению к виртуальной машине)|Нет измерений|
|Исходящие потоки|Исходящие потоки (предварительная версия)|Количество|Средняя|Исходящие потоки — это число текущих исходящих потоков (с трафиком по направлению от виртуальной машины)|Нет измерений|
|Максимальная скорость создания входящих потоков|Максимальная скорость создания входящих потоков (предварительная версия)|Число/с|Средняя|Максимальная скорость создания входящих потоков (входящий трафик виртуальной машины)|Нет измерений|
|Максимальная скорость создания исходящих потоков|Максимальная скорость создания исходящих потоков (предварительная версия)|Число/с|Средняя|Максимальная скорость создания исходящих потоков (исходящий трафик виртуальной машины)|Нет измерений|
...
|Попадание при чтении в кэше для диска ОС категории "Премиум"|Попадание при чтении в кэше для диска ОС категории "Премиум" (предварительная версия)|Процент|Средняя|Попадание при чтении в кэше для диска ОС категории "Премиум"|Нет измерений|
|Промах чтения в кэше для диска ОС категории "Премиум"|Промах чтения в кэше для диска ОС категории "Премиум" (предварительная версия)|Процент|Средняя|Промах чтения в кэше для диска ОС категории "Премиум"|Нет измерений|
|Суммарный входящий трафик|Суммарный входящий трафик|Байты|Итого|Число байтов, полученных через все сетевые интерфейсы виртуальных машин (входящий трафик).|Нет измерений|
|Суммарный исходящий трафик|Суммарный исходящий трафик|Байты|Итого|Число байтов, переданных из всех сетевых интерфейсов виртуальных машин (исходящий трафик).|Нет измерений|

## <a name="microsoftcomputevirtualmachinescalesets"></a>Microsoft.Compute/virtualMachineScaleSets;

|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|Percentage CPU|Загрузка ЦП|Процент|Средняя|Процент выделенных вычислительных единиц, которые в настоящее время используются виртуальными машинами.|VMName|
|Сеть (входящий трафик)|Оплачиваемый входящий трафик|Байты|Итого|Число оплачиваемых байтов, получаемых виртуальными машинами через все сетевые интерфейсы (входящий трафик)|VMName|
|Сеть (исходящий трафик)|Оплачиваемый исходящий трафик|Байты|Итого|Число оплачиваемых байтов, отправляемых виртуальными машинами через все сетевые интерфейсы (исходящий трафик)|VMName|
|Скорость чтения с диска|Скорость чтения с диска|Байты|Итого|Число байтов, считанных с диска во время мониторинга|VMName|
|Disk Write Bytes|Скорость записи на диск|Байты|Итого|Число байтов, записанных на диск во время мониторинга|VMName|
|Disk Read Operations/Sec|Чтение с дисков (операций/с)|Число/с|Средняя|Количество операций вода-вывода в секунду при чтении с диска.|VMName|
|Disk Write Operations/Sec|Запись на диски (операций/с)|Число/с|Средняя|Количество операций вода-вывода в секунду при записи на диск.|VMName|
|Оставшиеся кредиты ЦП|Оставшиеся кредиты ЦП|Количество|Средняя|Общее число доступных для увеличения кредитов|Нет измерений|
|Использованные кредиты ЦП|Использованные кредиты ЦП|Количество|Средняя|Общее количество кредитов, использованных виртуальной машиной|Нет измерений|
|Скорость чтения в расчете на диск (байт/с)|Скорость чтения с диска данных (байт/с) (нерекомендуется)|Число/с|Средняя|Скорость чтения (байт/с) с одного диска во время мониторинга|ИД слота|
|Скорость записи в расчете на диск (байт/с)|Скорость записи на диск данных (байт/с) (нерекомендуется)|Число/с|Средняя|Скорость записи (байт/с) на один диск во время мониторинга|ИД слота|
...
|Скорость записи на диск ОС (операций/с)|Скорость записи на диск ОС (операций/с) (нерекомендуется)|Число/с|Средняя|Операции ввода-вывода в секунду при записи на один диск во время мониторинга для диска ОС|Нет измерений|
|Длина очереди на диск ОС|Длина очереди диска ОС (нерекомендуется)|Количество|Средняя|Длина очереди дисков ОС|Нет измерений|
|Скорость чтения с диска данных (байт/с)|Скорость чтения с диска данных (байт/с) (предварительная версия)|Число/с|Средняя|Скорость чтения (байт/с) с одного диска во время мониторинга|LUN, VMName|
|Скорость записи на диск данных (байт/с)|Скорость записи на диск данных (байт/с) (предварительная версия)|Число/с|Средняя|Скорость записи (байт/с) на один диск во время мониторинга|LUN, VMName|
|Скорость чтения с диска данных (операций/с)|Скорость чтения с диска данных (операций/с) (предварительная версия)|Число/с|Средняя|Операции ввода-вывода в секунду при чтении с одного диска во время мониторинга|LUN, VMName|
|Скорость записи на диск данных (операций/с)|Скорость записи на диск данных (операций/с) (предварительная версия)|Число/с|Средняя|Операции ввода-вывода в секунду при записи на один диск во время мониторинга|LUN, VMName|
|Длина очереди диска данных|Длина очереди диска данных (предварительная версия)|Количество|Средняя|Длина очереди дисков данных|LUN, VMName|
|Скорость чтения с диска ОС (байт/с)|Скорость чтения с диска ОС (байт/с) (предварительная версия)|Число/с|Средняя|Скорость чтения (байт/с) с одного диска во время мониторинга для диска ОС|VMName|
|Скорость записи на диск ОС (байт/с)|Скорость записи на диск ОС (байт/с) (предварительная версия)|Число/с|Средняя|Скорость записи (байт/с) на один диск во время мониторинга для диска ОС|VMName|
|Скорость чтения с диска ОС (операций/с)|Скорость чтения с диска ОС (операций/с) (предварительная версия)|Число/с|Средняя|Операции ввода-вывода в секунду при чтении с одного диска во время мониторинга для диска ОС|VMName|
|Скорость записи на диск ОС (операций/с)|Скорость записи на диск ОС (операций/с) (предварительная версия)|Число/с|Средняя|Операции ввода-вывода в секунду при записи на один диск во время мониторинга для диска ОС|VMName|
|Длина очереди диска ОС|Длина очереди диска ОС (предварительная версия)|Количество|Средняя|Длина очереди дисков ОС|VMName|
|Входящие потоки|Входящие потоки (предварительная версия)|Количество|Средняя|Входящие потоки — это число текущих входящих потоков (с трафиком по направлению к виртуальной машине)|VMName|
|Исходящие потоки|Исходящие потоки (предварительная версия)|Количество|Средняя|Исходящие потоки — это число текущих исходящих потоков (с трафиком по направлению от виртуальной машины)|VMName|
|Максимальная скорость создания входящих потоков|Максимальная скорость создания входящих потоков (предварительная версия)|Число/с|Средняя|Максимальная скорость создания входящих потоков (входящий трафик виртуальной машины)|VMName|
|Максимальная скорость создания исходящих потоков|Максимальная скорость создания исходящих потоков (предварительная версия)|Число/с|Средняя|Максимальная скорость создания исходящих потоков (исходящий трафик виртуальной машины)|VMName|
...
|Суммарный входящий трафик|Суммарный входящий трафик|Байты|Итого|Число байтов, полученных через все сетевые интерфейсы виртуальных машин (входящий трафик).|VMName|
|Суммарный исходящий трафик|Суммарный исходящий трафик|Байты|Итого|Число байтов, переданных из всех сетевых интерфейсов виртуальных машин (исходящий трафик).|VMName|
...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|TotalPullCount|Число всего на включение внесенных изменений|Количество|Средняя|Извлекает число изображений в целом|Нет измерений|
|SuccessfulPullCount|Число успешных по запросу|Количество|Средняя|Число успешно образа переносит|Нет измерений|
|TotalPushCount|Число общее Push-уведомлений|Количество|Средняя|Количество изображений, Push-уведомлений в целом|Нет измерений|
|SuccessfulPushCount|Число успешно отправлены|Количество|Средняя|Количество успешных образа Push-уведомлений|Нет измерений|
...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|NICReadThroughput|Скорость чтения (сеть)|Байт/с|Средняя|Пропускная способность чтения сетевого интерфейса на устройстве в отчетный период для всех томов в шлюзе. |InstanceName|
|NICWriteThroughput|Пропускная способность записи (сеть)|Байт/с|Средняя|Пропускная способность записи сетевого интерфейса на устройстве в отчетный период для всех томов в шлюзе. |InstanceName|
|CloudReadThroughputPerShare|Пропускная способность скачивания для облака (общий ресурс)|Байт/с|Средняя|Пропускная способность скачивания в Azure из общего ресурса в отчетный период.|Share (Предоставить общий доступ)|
|CloudUploadThroughputPerShare|Пропускная способность отправки для облака (общий ресурс)|Байт/с|Средняя|Пропускная способность отправки в Azure из общего ресурса в отчетный период.|Share (Предоставить общий доступ)|
|BytesUploadedToCloudPerShare|Отправлено байт для облака (общий ресурс)|Байты|Средняя|Общее число байтов, отправляемых в Azure из общего ресурса в отчетный период.|Share (Предоставить общий доступ)|
|Общая емкость|Общая емкость|Байты|Средняя|Общая емкость|Нет измерений|
|AvailableCapacity|Доступная емкость|Байты|Средняя|Доступная емкость в байтах в отчетный период.|Нет измерений|
|CloudUploadThroughput|Пропускная способность отправки для облака|Байт/с|Средняя|Облако пропускной способности передачи в Azure в течение отчетного периода.|Нет измерений|
|CloudReadThroughput|Пропускная способность облака загрузки|Байт/с|Средняя|Облако загрузки пропускной способности в Azure в течение отчетного периода.|Нет измерений|
|BytesUploadedToCloud|Отправлено байт для облака (устройство)|Байты|Средняя|Общее число байтов, отправляемых в Azure с устройства в отчетный период.|Нет измерений|
|HyperVVirtualProcessorUtilization|Пограничные вычисления — процент загрузки ЦП|Процент|Средняя|Процент загрузки ЦП|InstanceName|
|HyperVMemoryUtilization|Пограничные вычисления — использование памяти|Процент|Средняя|Используемый объем ОЗУ|InstanceName|
...
|backup_storage_used|Объем хранилища резервных копий|Байты|Средняя|Объем хранилища резервных копий|Нет измерений|
...
|cpu_percent|Нагрузка ЦП|Процент|Средняя|Нагрузка ЦП|Нет измерений|
|memory_percent|Процент памяти|Процент|Средняя|Процент памяти|Нет измерений|
|операций ввода-вывода|ОПЕРАЦИЙ ВВОДА-ВЫВОДА|Количество|Средняя|Операций ввода-ВЫВОДА в секунду|Нет измерений|
|storage_percent|Процент хранилища|Процент|Средняя|Процент хранилища|Нет измерений|
|storage_used|Storage used|Байты|Средняя|Storage used|Нет измерений|
|active_connections|Активные подключения|Количество|Средняя|Активные подключения|Нет измерений|
|network_bytes_egress|Сеть (исходящий трафик)|Байты|Итого|Исходящий сетевой трафик по активным подключениям|Нет измерений|
...
|ReplicationLatency|P99 Задержка репликации|MilliSeconds|Средняя|Задержка репликации P99 между исходными и целевыми регионами для геореплицируемой учетной записи|SourceRegion, TargetRegion|
|ServiceAvailability|Доступность службы|Процент|Средняя|Учетная запись доступности запросов на уровне детализации один час, день или месяц|Нет измерений|
...
|ActiveConnections|ActiveConnections|Количество|Средняя|Число активных подключений для Microsoft.EventHub.|Нет измерений|
|ConnectionsOpened|Открытые подключения.|Количество|Средняя|Открытые подключения для Microsoft.EventHub.|EntityName|
|ConnectionsOpened|Закрытые подключения.|Количество|Средняя|Закрытые подключения для Microsoft.EventHub.|EntityName|
...
|Autoscale|Метрики автомасштабирования|Количество|Максимальная|Метрики автомасштабирования|ClusterDnsName MetricName|
|AllocatedMB|Выделено, МБ|Количество|Максимальная|Выделено, МБ|ClusterDnsName MetricName|
|AvailableMB|Доступно, МБ|Количество|Максимальная|Доступно, МБ|ClusterDnsName MetricName|
|AppsPending|Ожидающие приложения|Количество|Максимальная|Ожидающие приложения|ClusterDnsName MetricName|
|AppsRunning|Приложения, работающие|Количество|Максимальная|Приложения, работающие|ClusterDnsName MetricName|
|AppsSubmitted|Приложения, отправляемые|Количество|Максимальная|Приложения, отправляемые|ClusterDnsName MetricName|
...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|availabilityResults/availabilityPercentage|Доступность|Процент|Средняя|Процент пройденных тестов доступности.|availabilityResult availabilityResult/имя, и расположение|
...
|dependencies/failed|Сбои при вызове зависимости|Количество|Количество|Число завершившихся сбоем вызовов зависимостей, отправленных приложением к внешним ресурсам.|dependency/type, dependency/performanceBucket, operation/synthetic, cloud/roleInstance, cloud/roleName|
...
|запросы и скорость|Частота запросов к серверу|Число/с|Средняя|Интенсивность запросов к серверу в секунду|request/performanceBucket, request/resultCode, operation/synthetic, cloud/roleInstance, request/success, cloud/roleName|
...
|IngestedEventAgeSeconds|Ingestion Latency (In seconds) (Задержка приема данных (в секундах))|Секунды|Средняя|Время приема данных из источника, например из концентратора событий, в кластер (в секундах)|Нет измерений|
...
|TriggerSuccessLatency|Trigger Success Latency |Секунды|Средняя|Задержка успешно выполненных триггеров рабочего процесса.|Нет измерений|
|TriggerThrottledEvents|Trigger Throttled Events|Количество|Итого|Число событий регулирования триггера рабочего процесса.|Нет измерений|
|IntegrationServiceEnvironmentWorkflowProcessorUsage|Загрузка процессора рабочего процесса для среды службы интеграции|Процент|Средняя|Загрузка процессора рабочего процесса для среды службы интеграции.|Нет измерений|
|IntegrationServiceEnvironmentWorkflowMemoryUsage|Использование памяти рабочего процесса для среды службы интеграции|Процент|Средняя|Использование памяти рабочего процесса для среды службы интеграции.|Нет измерений|
|IntegrationServiceEnvironmentConnectorProcessorUsage|Загрузка процессора соединителя для среды службы интеграции|Процент|Средняя|Загрузка процессора соединителя для среды службы интеграции.|Нет измерений|
|IntegrationServiceEnvironmentConnectorMemoryUsage|Использование памяти соединителя для среды службы интеграции|Процент|Средняя|Использование памяти соединителя для среды службы интеграции.|Нет измерений|
...
|Доступность|Доступность|Процент|Средняя|Доступность API-интерфейсы|ApiCategory, ApiName|
...
|CapacityUnits|Текущих единицах мощности|Количество|Средняя|Единиц емкости|Нет измерений|
...
|P2SConnectionCount|P2S Connection Count (Количество подключений P2S)|Количество|Максимальная|Число подключений "точка — сеть" для шлюза|Protocol|
...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|BitsInPerSecond|BitsInPerSecond|Число/с|Средняя|Входящий трафик Azure в секунду (в битах)|Тип PeeringType|
|BitsOutPerSecond|BitsOutPerSecond|Число/с|Средняя|Исходящий трафик Azure в секунду (в битах)|Тип PeeringType|
...
|DeadletteredMessages|Число недоставленных сообщений в очереди или разделе.  (предварительная версия)|Количество|Средняя|Число недоставленных сообщений в очереди или разделе.  (предварительная версия)|EntityName|
|ScheduledMessages|Число запланированных сообщений в очереди или разделе.  (предварительная версия)|Количество|Средняя|Число запланированных сообщений в очереди или разделе.  (предварительная версия)|EntityName|
...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|AllocatedCpu|AllocatedCpu|Количество|Средняя|ЦП, выделенных для этого контейнера (в миллиядрах)|ApplicationName, ServiceName, Имя_пакета_кода, ServiceReplicaName|
|AllocatedMemory|AllocatedMemory|Байты|Средняя|Память, выделенная для этого контейнера в МБ|ApplicationName, ServiceName, Имя_пакета_кода, ServiceReplicaName|
|ActualCpu|ActualCpu|Количество|Средняя|Фактическое использование ЦП (в миллиядрах)|ApplicationName, ServiceName, Имя_пакета_кода, ServiceReplicaName|
|ActualMemory|ActualMemory|Байты|Средняя|Фактическое использование памяти в МБ|ApplicationName, ServiceName, Имя_пакета_кода, ServiceReplicaName|
|CpuUtilization|CpuUtilization|Процент|Средняя|Использование ЦП для этого контейнера как процент AllocatedCpu|ApplicationName, ServiceName, Имя_пакета_кода, ServiceReplicaName|
|MemoryUtilization|MemoryUtilization|Процент|Средняя|Использование ЦП для этого контейнера как процент AllocatedCpu|ApplicationName, ServiceName, Имя_пакета_кода, ServiceReplicaName|
|ApplicationStatus|ApplicationStatus|Количество|Средняя|Состояние приложения Service Fabric Mesh|ApplicationName, состояние|
|ServiceStatus|ServiceStatus|Количество|Средняя|Состояние работоспособности службы в приложении Service Fabric Mesh|ServiceName ApplicationName, состояние,|
|ServiceReplicaStatus|ServiceReplicaStatus|Количество|Средняя|Состояние работоспособности реплики службы в приложении Service Fabric Mesh|ApplicationName, статус, ServiceName, ServiceReplicaName|
|Состояние_контейнера|Состояние_контейнера|Количество|Средняя|Состояние контейнера в Service Fabric Mesh приложения|ApplicationName, ServiceName, Имя_пакета_кода, ServiceReplicaName, состояние|
|RestartCount|RestartCount|Количество|Средняя|Число контейнера перезапусков приложения Service Fabric Mesh|ApplicationName, статус, ServiceName, ServiceReplicaName, Имя_пакета_кода|
...
|storage|Используемое место для данных|Байты|Максимальная|Total database size|Нет измерений|
...
|cpu_limit|Ограничения на ЦП|Количество|Средняя|Ограничения на ЦП|Нет измерений|
|cpu_used|ЦП|Количество|Средняя|ЦП|Нет измерений|
...
|local_tempdb_usage_percent|Local tempdb percentage (Процент использования локальной базы данных tempdb)|Процент|Средняя|Local tempdb percentage (Процент использования локальной базы данных tempdb)|Нет измерений|
|app_cpu_billed|Выставление счетов за использование ЦП приложениями|Количество|Итого|Выставление счетов за использование ЦП приложениями|Нет измерений|
|app_cpu_percent|Процент ЦП приложения|Процент|Средняя|Процент ЦП приложения|Нет измерений|
|app_memory_percent|Процент используемой памяти приложения|Процент|Средняя|Процент используемой памяти приложения|Нет измерений|
|allocated_data_storage|Выделено места для данных|Байты|Средняя|Выделено места для данных|Нет измерений|
...
|log_write_percent|Log IO percentage|Процент|Средняя|Log IO percentage|Нет измерений|
|dtu_consumption_percent|Процент использования DTU|Процент|Средняя|Процент использования DTU|Нет измерений|
|storage_percent|Процент пространства, используемого данных||Процент|Средняя|Storage percentage|Нет измерений|
|workers_percent|Workers percentage|Процент|Средняя|Workers percentage|Нет измерений|
|sessions_percent|Процент использования сеансов|Процент|Средняя|Процент использования сеансов|Нет измерений|
...
|storage_used|Используемое место для данных|Байты|Средняя|Storage used|Нет измерений|
|xtp_storage_percent|Процент хранилища выполняющейся в памяти OLTP|Процент|Средняя|Процент хранилища выполняющейся в памяти OLTP|Нет измерений|
|cpu_limit|Ограничения на ЦП|Количество|Средняя|Ограничения на ЦП|Нет измерений|
|cpu_used|ЦП|Количество|Средняя|ЦП|Нет измерений|
|allocated_data_storage|Выделено места для данных|Байты|Средняя|Выделено места для данных|Нет измерений|
...
|IndexCapacity|Индекс емкости|Байты|Средняя|Объем хранилища, используемый для индекса ADLS 2-го поколения (иерархического), в байтах.|Нет измерений|
|Транзакции|Транзакции|Количество|Итого|Количество запросов к службе хранения или указанной операции API. Это число включает успешные и неудачные запросы, а также запросы, вызвавшие ошибку. Используйте измерение ResponseType для различных типов ответа.|ResponseType, GeoType, ApiName, Authentication|
|Входящие|Входящие|Байты|Итого|Объем входящих данных в байтах. Это количество включает входящий трафик из внешнего клиента в службу хранилища Azure, а также входящий трафик в пределах Azure.|GeoType, ApiName, Authentication|
|Исходящие|Исходящие|Байты|Итого|Объем входящих данных в байтах. Это количество включает исходящий трафик из внешнего клиента в службу хранилища Azure, а также исходящий трафик в пределах Azure. В результате это количество не отражает исходящий трафик для тарификации.|GeoType, ApiName, Authentication|
|SuccessServerLatency|Успешно выполненная задержка сервера|Миллисекунды|Средняя|Средняя задержка, используемая службой хранилища Azure для обработки успешного запроса, в миллисекундах. Это значение не включает сетевую задержку, указанную в метрике AverageE2ELatency.|GeoType, ApiName, Authentication|
...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|ServerSyncSessionResult|Результат сеанса синхронизации|Количество|Средняя|Метрики, журналы значение 1 каждой времени конечную точку сервера успешно завершает сеанс синхронизации с облачной конечной точки|SyncDirection SyncGroupName ServerEndpointName,|
|StorageSyncSyncSessionAppliedFilesCount|Синхронизировано файлов|Количество|Итого|Число файлов синхронизированы|SyncDirection SyncGroupName ServerEndpointName,|
...
|StorageSyncServerHeartbeat|Сетевой статус сервера|Количество|Максимальная|Метрики, журналы значение 1 каждой времени зарегистрированный сервер успешно записывает периодический сигнал с облачной конечной точки|имя_сервера;|
...
|Метрика|Отображаемое имя метрики|Единица измерения|Тип статистической обработки|ОПИСАНИЕ|Измерения|
|---|---|---|---|---|---|
|DiskReadBytesPerSecond|Disk Read Bytes/Sec|Байт/с|Средняя|Время обращения к диску пропускной способности из-за операций чтения в период выборки.|Нет измерений|
|DiskWriteBytesPerSecond|Disk Write Bytes/Sec|Байт/с|Средняя|Время обращения к диску пропускной способности из-за операции записи в период выборки.|Нет измерений|
...
|Disk Read Operations/Sec|Чтение с дисков (операций/с)|Число/с|Средняя|Среднее число операций ввода-ВЫВОДА операций чтения в предыдущем примере периоде. Обратите внимание на то, что эти операции могут быть размер переменной.|Нет измерений|
|Disk Write Operations/Sec|Запись на диски (операций/с)|Число/с|Средняя|Среднее число операций ввода-ВЫВОДА операций записи в предыдущий период выборки. Обратите внимание на то, что эти операции могут быть размер переменной.|Нет измерений|
|DiskReadLatency|Задержка чтения с диска|Миллисекунды|Средняя|Задержка чтения всего. Сумма устройства и ядра задержкой операций чтения.|Нет измерений|
|DiskWriteLatency|Задержка записи на диск|Миллисекунды|Средняя|Задержка всего записи. Задержки записи на сумме устройства и ядра.|Нет измерений|
|NetworkInBytesPerSecond|Сеть в байт/с|Байт/с|Средняя|Пропускная способность сети среднее для принятого трафика.|Нет измерений|
|NetworkOutBytesPerSecond|Исходящий сетевой трафик байт/с|Байт/с|Средняя|Пропускная способность сети среднее для передаваемого трафика.|Нет измерений|
...
|MemoryUsed|Память, используемая|Байты|Средняя|Объем памяти компьютера, который используется виртуальной Машиной.|Нет измерений|
|MemoryGranted|Памяти, предоставленный|Байты|Средняя|Объем памяти, предоставленное узлом виртуальной Машины. Память не была предоставлена на узле, пока он обрабатывается один раз и предоставил памяти может быть переключена или ballooned немедленно, если VMkernel требуется память.|Нет измерений|
|MemoryActive|Активный памяти|Байты|Средняя|Объем памяти, используемой виртуальной Машины в прошлом небольшой промежуток времени. Это «true» число объем памяти на виртуальной Машине в настоящее время есть необходимость. Дополнительную, неиспользуемые память может быть переключена или ballooned без влияния на производительность виртуальной машины.|Нет измерений|
|Percentage CPU|Загрузка ЦП|Процент|Средняя|Использование ЦП. Это значение передается вместе с 100%, представляющий все ядра процессора в системе. Например виртуальная машина двунаправленного, с использованием 50% Четырехъядерная система полностью использует два ядра.|Нет измерений|
