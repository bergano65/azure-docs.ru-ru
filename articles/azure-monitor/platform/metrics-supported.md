...
|JobEndedCanceled|Отмененные задания|Количество|Итого|Количество отмененных заданий.|Нет измерений|
...
|JobAUEndedCanceled|Отмененные время AU|Секунды|Итого|Общее время AU отмененных заданий.|Нет измерений|
...
|RunsCanceled|Отмененные запуски|Количество|Итого|Число выполнений рабочего процесса отменен.|Нет измерений|
...
|UserErrors|Ошибки пользователей|Процент|Средняя|Процент ошибок пользователей|Нет измерений|
|SystemErrors|Системные ошибки|Процент|Средняя|Процент системных ошибок|Нет измерений|
