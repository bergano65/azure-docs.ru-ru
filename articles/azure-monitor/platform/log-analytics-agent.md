...
В приведенной ниже информации перечисляются сведения о конфигурации прокси и брандмауэра, необходимые агенту Linux и Windows для связи с журналами Azure Monitor.  
