...
|-------|-------------|-------------|
|Azure| [Вручную из портал Azure](../../azure-monitor/learn/quick-collect-azurevm.md?toc=/azure/azure-monitor/toc.json) | Укажите виртуальные машины для развертывания из рабочей области Log Analytics. |
