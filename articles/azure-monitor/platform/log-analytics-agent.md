...
| [Syslog](data-sources-syslog.md)                     | Сведения, отправляемые в систему ведения журнала событий Linux. |
...
| | [Шаблон диспетчер ресурсов с Azure Stack](https://github.com/Azure/AzureStack-QuickStart-Templates/tree/master/MicrosoftMonitoringAgent-ext-win) | Используйте шаблон Azure Resource Manager, если в центре обработки данных развернуты Microsoft Azure Stack.| 
