...
Функция [Моя панель мониторинга](dashboards.md) в Log Analytics не рекомендована к использованию. Эта функция позволяла использовать частную коллекцию элементов конструктора представлений и была заменена встроенными функциями панели мониторинга Azure. Вы можете продолжать визуализировать данные в Log Analytics с помощью [конструктора представлений](view-designer.md) для общих представлений. Также можно закреплять визуализации из этих представлений или [отдельных запросов](../learn/tutorial-logs-dashboards.md) на панелях мониторинга Azure.
