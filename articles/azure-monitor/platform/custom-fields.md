...
![Основной пример](media/custom-fields/main-example.png)
...
![Изменение выделенной записи](media/custom-fields/modify-highlight.png)
...
![Исходное количество](media/custom-fields/initial-count.png)
...
![Группирование по запросу](media/custom-fields/query-group.png)
