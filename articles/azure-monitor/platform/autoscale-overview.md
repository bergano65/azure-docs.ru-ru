...
---
# <a name="overview-of-autoscale-in-microsoft-azure-virtual-machines-cloud-services-and-web-apps"></a>Общие сведения об автомасштабировании в виртуальных машинах, облачных службах и веб-приложениях Microsoft Azure
...
* [Расширенная настройка автомасштабирования с помощью шаблонов Resource Manager для набора масштабирования виртуальных машин](../../azure-monitor/platform/autoscale-virtual-machine-scale-sets.md)  
...
| Виртуальные машины: пример с Windows |[Расширенная настройка автомасштабирования с помощью шаблонов Resource Manager для набора масштабирования виртуальных машин](../../azure-monitor/platform/autoscale-virtual-machine-scale-sets.md) |
