---
title: Автомасштабирование в визгода, облачных сервисах и веб-приложениях
...
* [Расширенная конфигурация автомасштаба с использованием шаблонов управления ресурсами для наборов шкалы VM](../../azure-monitor/platform/autoscale-virtual-machine-scale-sets.md)  
...
| Виртуальные машины: пример с Windows |[Расширенная конфигурация автомасштаба с использованием шаблонов управления ресурсами для наборов шкалы VM](../../azure-monitor/platform/autoscale-virtual-machine-scale-sets.md) |
