...
Расширение система диагностики Azure используется с другими продуктами диагностики Майкрософт, такими как Azure Monitor, в том числе Application Insights и Log Analytics. Дополнительные сведения см. в статье [Обзор мониторинга в Microsoft Azure](../../azure-monitor/overview.md).
