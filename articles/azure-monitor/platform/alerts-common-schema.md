...
| Электронная почта | Шаблон согласованное и подробное сообщение электронной почты, что позволяет легко диагностировать проблемы с первого взгляда. Внедренные глубокого ссылки на экземпляр предупреждения об изменении на портале и затронутого ресурса убедитесь, что можно быстро перейти в процесс исправления. |
