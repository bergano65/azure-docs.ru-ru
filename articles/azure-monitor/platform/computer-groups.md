...
Вы можете настроить в Azure Monitor импорт групп безопасности из Active Directory, используя раздел **Дополнительные параметры** в рабочем пространстве Log Analytics на портале Azure.  Последовательно выберите **Группы компьютеров**, **Active Directory** и **Импорт членств в группах Active Directory с компьютеров**.  Дополнительная настройка не требуется.
...
Вы можете настроить в Azure Monitor импорт групп безопасности из WSUS, используя раздел **Дополнительные параметры** в рабочем пространстве Log Analytics на портале Azure.  Последовательно выберите **Группы компьютеров**, **WSUS** и **Импорт членств в группах WSUS**.  Дополнительная настройка не требуется.
...
Группы компьютеров, созданные с помощью операции или API запроса к журналам, можно просматривать в меню **Дополнительные параметры** для рабочего пространства Log Analytics на портале Azure.  Выберите **Группы компьютеров**, а затем **Сохраненные группы**.  
