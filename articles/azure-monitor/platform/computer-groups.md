...
| Диспетчер конфигурации | Импортируйте коллекции из Configuration Manager конечных точек Майкрософт и создайте группу в Azure Monitor для каждой из них. |
