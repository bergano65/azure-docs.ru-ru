...
9. В последнем разделе определения группы действий ITSM можно определить, сколько рабочих элементов будет создано для каждого предупреждения.
    ...
    > * Оповещения метрик и оповещения журнала действий всегда будут создавать один рабочий элемент для каждого предупреждения.

    * В случае выбора в раскрывающемся списке рабочих элементов "инцидент" или "предупреждение":
        * Если установить флажок **"создать отдельные рабочие элементы для каждого элемента конфигурации"** , каждый элемент конфигурации в каждом предупреждении создаст новый рабочий элемент. В системе ITSM может быть несколько рабочих элементов для одного элемента конфигурации.
