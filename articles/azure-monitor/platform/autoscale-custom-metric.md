...
> Примечание. В приведенных ниже действиях используется план службы приложений, связанный с веб-приложением, для которого настроен экземпляр Application Insights.
