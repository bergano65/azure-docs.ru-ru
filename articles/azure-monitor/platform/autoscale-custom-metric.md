...
АвтомасштабAzуре монитора применяется только к [наборам виртуальных машинных шкал,](https://azure.microsoft.com/services/virtual-machine-scale-sets/) [облачным службам,](https://azure.microsoft.com/services/cloud-services/) [службе приложений - Web Apps,](https://azure.microsoft.com/services/app-service/web/) [кластеру Azure Data Explorer,](https://azure.microsoft.com/services/data-explorer/)   
Интеграционная служба окружающей среды и [услуги по управлению API](https://docs.microsoft.com/azure/api-management/api-management-key-concepts).
...
- Установите пределы экземпляра. Например, если необходимо выполнить масштабирование в пределах 2–5 экземпляров в зависимости от колебаний пользовательской метрики, следует задать для параметров "Минимум" и "По умолчанию" значение 2, а для параметра "Максимум" — значение 5.
