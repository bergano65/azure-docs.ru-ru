...
При создании нового типа пользовательских данных из [пользовательского журнала](data-sources-custom-logs.md) или [API сборщика данных](data-collector-api.md)система создает выделенный контейнер хранилища. Это однократное увеличение нагрузки, которое возникает только при первом входе этого типа данных.
