...
Журналы событий Windows настраиваются в меню ["Данные" в параметрах Log Analytics](agent-data-sources.md#configuring-data-sources).
...
* Используйте [настраиваемые поля](../../log-analytics/log-analytics-custom-fields.md) для анализа записей событий в отдельных полях.
