---
title: Сбор и анализ Журналов событий Windows в Log Analytics | Документация Майкрософт
description: Описывается, как с помощью Log Analytics настроить сбор Журналов событий Windows и сведений о создаваемых ими записях.
