...
Пороговые значения, отображаемых на диаграмме, перед созданием правила генерации оповещений на основе метрики, вычисляются на основе достаточно исторических данных, для которого требуется вычислить час или день сезонным (10 дн.). При нажатии на «Еженедельно шаблон отображения» получит достаточно исторических данных, для вычисления еженедельно сезонным (28 дней). После создания правила генерации оповещений, динамическими порогами будут выполнять все необходимые исторических данных, которая доступна и узнаете, постоянно и опыт, на основе новых данных обеспечивают более высокую точность пороговые значения.
