...
Если у вас есть новый ресурс или отсутствуют данные метрики, то динамические пороговые значения не будут вызывать предупреждения до трех дней или 30 выборок данных метрик, чтобы обеспечить точные пороговые значения.
