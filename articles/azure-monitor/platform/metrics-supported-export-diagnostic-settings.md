...
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  евенсубдроппедевентс  |  Удалены события EventHub  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  евенсубрежектедевентс  |  Отклоненные события EventHub  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  евенсубсукцессфулевентс  |  Успешные события EventHub  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  евенсубсроттледевентс  |  Регулируемые события EventHub  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  евенсубтимедаутевентс  |  Истекло время ожидания событий EventHub  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  евенсубтоталбитессент  |  Размер событий EventHub  |  Байты  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  евенсубтоталевентс  |  Всего событий EventHub  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  евенсубтоталфаиледевентс  |  События EventHub, завершившиеся сбоем  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  FailedRequests  |  Неудачные запросы к шлюзу (не рекомендуется)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  OtherRequests  |  Другие запросы к шлюзу (не рекомендуется)  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  TotalRequests  |  Всего запросов к шлюзу (устарело)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.ApiManagement/service  |  UnauthorizedRequests  |  Неавторизованные запросы к шлюзу (устарели)  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Аппплатформ/пружина  |  гкпаусетоталкаунт  |  Счетчик приостановки GC  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Аппплатформ/пружина  |  томкатерроркаунт  |  Глобальная ошибка Tomcat  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Аппплатформ/пружина  |  томкатрекуесттоталкаунт  |  Общее число запросов Tomcat  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Аппплатформ/пружина  |  томкатсессионактивекурренткаунт  |  Счетчик активности сеансов Tomcat  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Аппплатформ/пружина  |  томкатсессионактивемакскаунт  |  Максимальное число активных сеансов Tomcat  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Аппплатформ/пружина  |  томкатсессионкреатедкаунт  |  Число созданных сеансов Tomcat  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Аппплатформ/пружина  |  томкатсессионекспиредкаунт  |  Счетчик с истекшим сроком действия сеанса Tomcat  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Аппплатформ/пружина  |  томкатсессионрежектедкаунт  |  Число отклоненных сеансов Tomcat  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.Automation/automationAccounts  |  тоталупдатедеплойментмачинерунс  |  Всего запусков компьютера для развертывания обновлений  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.Automation/automationAccounts  |  тоталупдатедеплойментрунс  |  Всего запусков развертывания обновлений  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Бездействующие ядра  |  Бездействующие ядра  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Бездействующие узлы  |  Бездействующие узлы  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Задание выполнено  |  Задание выполнено  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Задание Отправлено  |  Задание Отправлено  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Освобождение ядер  |  Освобождение ядер  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Покинуть узлы  |  Покинуть узлы  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Вытесненные ядра  |  Вытесненные ядра  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Прерванные узлы  |  Прерванные узлы  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Процент использования квоты  |  Процент использования квоты  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Непригодные для использования ядра  |  Непригодные для использования ядра  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. BatchAI/рабочие области  |  Неиспользуемые узлы  |  Неиспользуемые узлы  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Блокчейн/Блоккчаинмемберс  |  коннектионакцептед  |  Принятые подключения  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Блокчейн/Блоккчаинмемберс  |  коннектионактиве  |  Активные подключения  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Блокчейн/Блоккчаинмемберс  |  коннектионхандлед  |  Обработанные соединения  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Блокчейн/Блоккчаинмемберс  |  пендингтрансактионс  |  Ожидающие транзакции  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Блокчейн/Блоккчаинмемберс  |  процесседблоккс  |  Обработанные блоки  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Блокчейн/Блоккчаинмемберс  |  процесседтрансактионс  |  Обработанные транзакции  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Блокчейн/Блоккчаинмемберс  |  куеуедтрансактионс  |  Транзакции в очереди  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Блокчейн/Блоккчаинмемберс  |  рекуессандлед  |  Обработанные запросы  |  Count  |  Итог | 
...
| нет  | нет |  Microsoft. Классикстораже/storageAccounts/Блобсервицес  |  BlobCount  |  Количество больших двоичных объектов  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Блобсервицес  |  ContainerCount  |  Количество контейнеров больших двоичных объектов  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Блобсервицес  |  Transactions  |  Transactions  |  Count  |  Итог | 
...
| нет  | нет |  Microsoft. Классикстораже/storageAccounts/Филесервицес  |  FileCount  |  Количество файлов  |  Count  |  Среднее | 
| нет  | нет |  Microsoft. Классикстораже/storageAccounts/Филесервицес  |  FileShareCount  |  Количество общих файловых ресурсов  |  Count  |  Среднее | 
| нет  | нет |  Microsoft. Классикстораже/storageAccounts/Филесервицес  |  филешарекуота  |  Размер квоты общей папки  |  Байты  |  Среднее | 
| нет  | нет |  Microsoft. Классикстораже/storageAccounts/Филесервицес  |  филешареснапшоткаунт  |  Число моментальных снимков общей папки  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Филесервицес  |  Transactions  |  Transactions  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Куеуесервицес  |  QueueCount  |  Количество очередей  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Куеуесервицес  |  QueueMessageCount  |  Количество сообщений очереди  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Куеуесервицес  |  Transactions  |  Transactions  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Таблесервицес  |  TableCount  |  Количество таблиц  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Таблесервицес  |  TableEntityCount  |  Количество сущностей таблиц  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Классикстораже/storageAccounts/Таблесервицес  |  Transactions  |  Transactions  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.CognitiveServices/accounts  |  BlockedCalls  |  Blocked Calls  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.CognitiveServices/accounts  |  чарактерстраинед  |  Обученные символы  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachines  |  Глубина очереди диска данных  |  Глубина очереди диска данных (Предварительная версия)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachines  |  Глубина очереди диска ОС  |  Глубина очереди диска ОС (Предварительная версия)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachines  |  Длина очереди на диск ОС  |  Диск ОС длина очереди (не рекомендуется)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachines  |  Длина очереди в расчете на диск  |  Диск данных длина очереди (не рекомендуется)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachineScaleSets;  |  Глубина очереди диска данных  |  Глубина очереди диска данных (Предварительная версия)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachineScaleSets;  |  Глубина очереди диска ОС  |  Глубина очереди диска ОС (Предварительная версия)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachineScaleSets;  |  Длина очереди на диск ОС  |  Диск ОС длина очереди (не рекомендуется)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachineScaleSets;  |  Длина очереди в расчете на диск  |  Диск данных длина очереди (не рекомендуется)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  Глубина очереди диска данных  |  Глубина очереди диска данных (Предварительная версия)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  Глубина очереди диска ОС  |  Глубина очереди диска ОС (Предварительная версия)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  Длина очереди на диск ОС  |  Диск ОС длина очереди (не рекомендуется)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  Длина очереди в расчете на диск  |  Диск данных длина очереди (не рекомендуется)  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.ContainerRegistry/registries  |  сукцессфулпуллкаунт  |  Число успешных операций извлечения  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.ContainerRegistry/registries  |  сукцессфулпушкаунт  |  Число успешных push-уведомлений  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.ContainerRegistry/registries  |  тоталпуллкаунт  |  Общее число броских  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.ContainerRegistry/registries  |  тоталпушкаунт  |  Общее число push-уведомлений  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.DataFactory/factories;  |  активитиканцелледрунс  |  Отмененные метрики выполнения действий  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.DataFactory/factories;  |  факторисизеингбунитс  |  Общий размер фабрики (ГБ единиц)  |  Count  |  Максимальная | 
...
| **Да**  | нет |  Microsoft.DataFactory/factories;  |  интегратионрунтимекуеуеленгс  |  Длина очереди среды выполнения интеграции  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.DataFactory/factories;  |  максалловедфакторисизеингбунитс  |  Максимально допустимый размер фабрики (единица GB)  |  Count  |  Максимальная | 
| **Да**  | нет |  Microsoft.DataFactory/factories;  |  максалловедресаурцекаунт  |  Максимальное число допустимых сущностей  |  Count  |  Максимальная | 
| **Да**  | нет |  Microsoft.DataFactory/factories;  |  пипелинеканцелледрунс  |  Отмененные метрики запуска конвейера  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.DataFactory/factories;  |  ресаурцекаунт  |  Общее число сущностей  |  Count  |  Максимальная | 
| **Да**  | нет |  Microsoft.DataFactory/factories;  |  тригжерканцелледрунс  |  Отмененные метрики запуска триггера  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Дбфорпостгрескл/serversv2  |  active_connections  |  Активные подключения  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Дбфорпостгрескл/serversv2  |  cpu_percent  |  Нагрузка ЦП  |  Процент  |  Среднее | 
| **Да**  | нет |  Microsoft. Дбфорпостгрескл/serversv2  |  /  |  ОПЕРАЦИЙ ВВОДА-ВЫВОДА  |  Count  |  Среднее | 
...
| **Да**  | **Да** |  Microsoft. Devices/Account  |  дигиталтвинс. телеметрии. nodes  |  Заполнитель данных телеметрии для узла Digital двойников  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.abandon.success  |  Отброшенных сообщений C2D  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.complete.success  |  Доставка сообщений C2D завершена  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.reject.success  |  Отклоненные сообщения C2D  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.Devices/IotHubs  |  C2DMessagesExpired  |  Срок действия сообщений C2D истек (Предварительная версия)  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.Devices/IotHubs  |  евентгридделивериес  |  Сетка событий: доставок (Предварительная версия)  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.DocumentDB/databaseAccounts  |  делетевиртуалнетворк  |  делетевиртуалнетворк  |  Count  |  Count | 
...
| нет  | нет |  Microsoft. Ентерприсекновледжеграф/Services  |  FailureCount  |  Число сбоев  |  Count  |  Count | 
| нет  | нет |  Microsoft. Ентерприсекновледжеграф/Services  |  SuccessCount  |  Подсчет успешных событий  |  Count  |  Count | 
| нет  | нет |  Microsoft. Ентерприсекновледжеграф/Services  |  сукцесслатенци  |  Задержка успешного выполнения  |  MilliSeconds  |  Среднее | 
| нет  | нет |  Microsoft. Ентерприсекновледжеграф/Services  |  трансактионкаунт  |  Число транзакций  |  Count  |  Count | 
...
| **Да**  | **Да** |  Microsoft. EventGrid/Domains  |  PublishFailCount  |  Опубликовать события с ошибками  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. EventGrid/Domains  |  PublishSuccessCount  |  Published Events (Опубликованные события)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. EventGrid/Domains  |  публишсукцесслатенциинмс  |  Задержка успешной публикации  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.EventGrid/extensionTopics  |  PublishFailCount  |  Опубликовать события с ошибками  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventGrid/extensionTopics  |  PublishSuccessCount  |  Published Events (Опубликованные события)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventGrid/extensionTopics  |  публишсукцесслатенциинмс  |  Задержка успешной публикации  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventGrid/extensionTopics  |  UnmatchedEventCount  |  Unmatched Events (Несоответствующие события)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventGrid/topics  |  PublishFailCount  |  Опубликовать события с ошибками  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventGrid/topics  |  PublishSuccessCount  |  Published Events (Опубликованные события)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventGrid/topics  |  публишсукцесслатенциинмс  |  Задержка успешной публикации  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.EventHub/namespaces  |  EHABL  |  Архивировать сообщения невыполненной работы (не рекомендуется)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventHub/namespaces  |  EHAMBS  |  Пропускная способность сообщений архивации (не рекомендуется)  |  Байты  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventHub/namespaces  |  EHAMSGS  |  Архивирование сообщений (не рекомендуется)  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.EventHub/namespaces  |  FAILREQ  |  Неудачные запросы (устарело)  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.EventHub/namespaces  |  MISCERR  |  Другие ошибки (не рекомендуется)  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.EventHub/namespaces  |  SUCCREQ  |  Успешные запросы (устарело)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.EventHub/namespaces  |  SVRBSY  |  Ошибки занятости сервера (устарели)  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.HDInsight/clusters  |  нумактивеворкерс  |  Число активных рабочих ролей  |  Count  |  Максимальная | 
| **Да**  | нет |  Microsoft.HDInsight/clusters  |  скалингрекуестс  |  Запросы на масштабирование  |  Count  |  Максимальная | 
...
| нет  | нет |  Microsoft.Insights/Components  |  availabilityResults/Count  |  Тесты доступности  |  Count  |  Count | 
...
| нет  | нет |  Microsoft.Insights/Components  |  dependencies/failed  |  Сбои при вызове зависимостей  |  Count  |  Count | 
...
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  континуаусекспортмакслатенессминутес  |  Максимальное время непрерывного экспорта (мин.)  |  Count  |  Максимальная | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  континуаусекспортнумофрекордсекспортед  |  Непрерывный экспорт-число экспортированных записей  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  континуаусекспортпендингкаунт  |  Число ожидающих непрерывного экспорта  |  Count  |  Максимальная | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  континуаусекспортресулт  |  Результат непрерывного экспорта  |  Count  |  Count | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  ЦП  |  ЦП  |  Процент  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  евентспроцесседфоревенсубс  |  Обработано событий (для концентраторов событий и IoT)  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  инжестионволумеинмб  |  Объем приема (в МБ)  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  Проверки  |  Срок поддержания активности  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  QueryDuration  |  Query duration (Длительность запросов)  |  Миллисекунды  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  стеамингинжестрекуестрате  |  Частота запросов приема потоковой передачи  |  Count  |  ратерекуестсперсеконд | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  стреамингинжестдатарате  |  Скорость приема данных потоковой передачи  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  стреамингинжестдуратион  |  Длительность приема потоковой передачи  |  Миллисекунды  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Kusto/Clusters  |  стреамингинжестресултс  |  Поток приема результатов  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  ActionLatency  |  Action Latency   |  Секунды  |  Среднее | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  ActionsCompleted  |  Actions Completed   |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  ActionsFailed  |  Actions Failed   |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  ActionsSkipped  |  Actions Skipped   |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  ActionsStarted  |  Actions Started   |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  ActionsSucceeded  |  Actions Succeeded   |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  ActionSuccessLatency  |  Action Success Latency   |  Секунды  |  Среднее | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  ActionThrottledEvents  |  Action Throttled Events  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  RunsCancelled  |  Выполнение отменено  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  RunsCompleted  |  Runs Completed  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  RunsFailed  |  Runs Failed  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  RunsStarted  |  Runs Started  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  RunsSucceeded  |  Runs Succeeded  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  рунстартсроттледевентс  |  Запустить регулируемые события запуска  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  RunSuccessLatency  |  Run Success Latency  |  Секунды  |  Среднее | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  RunThrottledEvents  |  Run Throttled Events  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  TriggersCompleted  |  Triggers Completed   |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  TriggersFailed  |  Triggers Failed   |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  TriggersFired  |  Triggers Fired   |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  TriggersSkipped  |  Triggers Skipped  |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  TriggersStarted  |  Triggers Started   |  Count  |  Итог | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  TriggersSucceeded  |  Triggers Succeeded   |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  TriggerSuccessLatency  |  Trigger Success Latency   |  Секунды  |  Среднее | 
| **Да**  | **Да** |  Microsoft. Logic/Интегратионсервицеенвиронментс  |  TriggerThrottledEvents  |  Trigger Throttled Events  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.Logic/workflows  |  RunsCancelled  |  Выполнение отменено  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.Logic/workflows  |  рунстартсроттледевентс  |  Запустить регулируемые события запуска  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Освобождение ядер  |  Освобождение ядер  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Покинуть узлы  |  Покинуть узлы  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Сбой развертывание модели  |  Сбой развертывание модели  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  развертывание модели запущено  |  развертывание модели запущено  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  развертывание модели успех  |  развертывание модели успех  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Не удалось зарегистрировать модель  |  Не удалось зарегистрировать модель  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Регистрация модели прошла  |  Регистрация модели прошла  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Вытесненные ядра  |  Вытесненные ядра  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Прерванные узлы  |  Прерванные узлы  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Непригодные для использования ядра  |  Непригодные для использования ядра  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.MachineLearningServices/workspaces  |  Неиспользуемые узлы  |  Неиспользуемые узлы  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Media/mediaservices  |  ассеткаунт  |  Число ресурсов  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Media/mediaservices  |  ассеткуота  |  Квота ресурса  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Media/mediaservices  |  ассеткуотауседперцентаже  |  Процент используемой квоты актива  |  Процент  |  Среднее | 
| **Да**  | нет |  Microsoft. Media/mediaservices  |  контенткэйполицикаунт  |  Число политик ключей содержимого  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Media/mediaservices  |  контенткэйполицикуота  |  Квота политики для ключа содержимого  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Media/mediaservices  |  стреамингполицикаунт  |  Число политик потоковой передачи  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Media/mediaservices  |  стреамингполицикуота  |  Квота политики потоковой передачи  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Media/mediaservices/Streamingendpoint  |  Requests  |  Requests  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Microservices4Spring/Аппклустерс  |  гкпаусетоталкаунт  |  Счетчик приостановки GC  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Microservices4Spring/Аппклустерс  |  томкатерроркаунт  |  Глобальная ошибка Tomcat  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Microservices4Spring/Аппклустерс  |  томкатрекуесттоталкаунт  |  Общее число запросов Tomcat  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Microservices4Spring/Аппклустерс  |  томкатсессионактивекурренткаунт  |  Счетчик активности сеансов Tomcat  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Microservices4Spring/Аппклустерс  |  томкатсессионактивемакскаунт  |  Максимальное число активных сеансов Tomcat  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Microservices4Spring/Аппклустерс  |  томкатсессионкреатедкаунт  |  Число созданных сеансов Tomcat  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Microservices4Spring/Аппклустерс  |  томкатсессионекспиредкаунт  |  Счетчик с истекшим сроком действия сеанса Tomcat  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. Microservices4Spring/Аппклустерс  |  томкатсессионрежектедкаунт  |  Число отклоненных сеансов Tomcat  |  Count  |  Итог | 
...
| нет  | нет |  Microsoft.Network/applicationGateways  |  авгрекуесткаунтперхеалсихост  |  Количество запросов в минуту на исправный узел  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Network/applicationGateways  |  баккендреспонсестатус  |  Состояние ответа серверной части  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.Network/applicationGateways  |  блоккедкаунт  |  Распределение правил блокированных запросов брандмауэра веб-приложения  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft.Network/applicationGateways  |  блоккедреккаунт  |  Число заблокированных запросов брандмауэра веб-приложения  |  Count  |  Итог | 
...
| нет  | нет |  Microsoft.Network/applicationGateways  |  капаЦитюнитс  |  Текущие единицы мощности  |  Count  |  Среднее | 
| нет  | нет |  Microsoft.Network/applicationGateways  |  клиентртт  |  RTT клиента  |  MilliSeconds  |  Среднее | 
| нет  | нет |  Microsoft.Network/applicationGateways  |  компутеунитс  |  Текущие единицы вычислений  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Network/applicationGateways  |  матчедкаунт  |  Общее распространение правила брандмауэра веб-приложения  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.Network/applicationGateways  |  тлспротокол  |  Клиентский протокол TLS  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.Network/azurefirewalls  |  аппликатионрулехит  |  Число попаданий правил приложения  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.Network/azurefirewalls  |  нетворкрулехит  |  Число попаданий сетевых правил  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Network/Експрессраутепортс  |  админстате  |  админстате  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Network/Експрессраутепортс  |  линепротокол  |  линепротокол  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Network/Експрессраутепортс  |  ркслигхтлевел  |  ркслигхтлевел  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Network/Експрессраутепортс  |  ткслигхтлевел  |  ткслигхтлевел  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. время чтения с диска (с)  |  Среднее время чтения с диска (с)  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. время обращения к диску (с)  |  Среднее время обращения к диску (сек.)  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. время записи на диск (с)  |  Среднее время записи на диск (сек.)  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. время записи на диск (с)  |  Среднее время записи на диск (сек.)  |  Count  |  Среднее | 
...
| нет  | нет |  Microsoft.ServiceBus/namespaces  |  деадлеттередмессажес  |  Количество недоставленных сообщений в очереди или разделе.  |  Count  |  Среднее | 
...
| нет  | нет |  Microsoft.ServiceBus/namespaces  |  счедуледмессажес  |  Число запланированных сообщений в очереди или разделе.  |  Count  |  Среднее | 
...
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  актуалкпу  |  актуалкпу  |  Count  |  Среднее | 
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  актуалмемори  |  актуалмемори  |  Байты  |  Среднее | 
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  аллокатедкпу  |  аллокатедкпу  |  Count  |  Среднее | 
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  аллокатедмемори  |  аллокатедмемори  |  Байты  |  Среднее | 
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  аппликатионстатус  |  аппликатионстатус  |  Count  |  Среднее | 
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  контаинерстатус  |  контаинерстатус  |  Count  |  Среднее | 
...
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  рестарткаунт  |  рестарткаунт  |  Count  |  Среднее | 
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  сервицерепликастатус  |  сервицерепликастатус  |  Count  |  Среднее | 
| нет  | нет |  Microsoft. Сервицефабрикмеш/приложения  |  сервицестатус  |  сервицестатус  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Sql/servers/databases  |  app_cpu_billed  |  Выплата за ЦП приложения  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.Sql/servers/databases  |  cpu_limit  |  Ограничение ЦП  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Sql/servers/databases  |  cpu_percent  |  Процент использования ЦП  |  Процент  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Sql/servers/databases  |  cpu_used  |  Используемый ЦП  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Sql/servers/databases  |  tempdb_data_size  |  Размер файла данных tempdb, КБ  |  Count  |  Максимальная | 
| **Да**  | нет |  Microsoft.Sql/servers/databases  |  tempdb_log_size  |  Размер файла журнала tempdb, КБ  |  Count  |  Максимальная | 
...
| **Да**  | нет |  Microsoft.Sql/servers/elasticPools  |  cpu_limit  |  Ограничение ЦП  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Sql/servers/elasticPools  |  cpu_percent  |  Процент использования ЦП  |  Процент  |  Среднее | 
| **Да**  | нет |  Microsoft.Sql/servers/elasticPools  |  cpu_used  |  Используемый ЦП  |  Count  |  Среднее | 
| нет  | нет |  Microsoft.Sql/servers/elasticPools  |  database_allocated_data_storage  |  Выделенное пространство данных  |  Байты  |  Среднее | 
| нет  | нет |  Microsoft.Sql/servers/elasticPools  |  database_cpu_limit  |  Ограничение ЦП  |  Count  |  Среднее | 
| нет  | нет |  Microsoft.Sql/servers/elasticPools  |  database_cpu_percent  |  Процент использования ЦП  |  Процент  |  Среднее | 
| нет  | нет |  Microsoft.Sql/servers/elasticPools  |  database_cpu_used  |  Используемый ЦП  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft.Sql/servers/elasticPools  |  tempdb_data_size  |  Размер файла данных tempdb, КБ  |  Count  |  Максимальная | 
| **Да**  | нет |  Microsoft.Sql/servers/elasticPools  |  tempdb_log_size  |  Размер файла журнала tempdb, КБ  |  Count  |  Максимальная | 
...
| нет  | нет |  Microsoft.Storage/storageAccounts/fileServices  |  филешареснапшоткаунт  |  Число моментальных снимков общей папки  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Сторажекаче/кэши  |  клиентиопс  |  Всего операций ввода-вывода клиента  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Сторажекаче/кэши  |  сторажетаржесеалс  |  Работоспособность целевого объекта хранилища  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Сторажекаче/кэши  |  сторажетаржетиопс  |  Всего Сторажетаржет операций ввода-вывода  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. Сторажекаче/кэши  |  сторажетаржетвритеиопс  |  Сторажетаржет запись в секунду  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. Сторажекаче/кэши  |  Время доступности  |  Время доступности  |  Count  |  Среднее | 
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес  |  серверсинксессионресулт  |  Результат сеанса синхронизации  |  Count  |  Среднее | 
...
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес  |  сторажесинксерверхеартбеат  |  Состояние сервера в сети  |  Count  |  Максимальная | 
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес  |  сторажесинксинксессионапплиедфилескаунт  |  Синхронизировано файлов  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес  |  сторажесинксинксессионперитемеррорскаунт  |  Несинхронизирующиеся файлы  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес/Регистередсерверс  |  серверхеартбеат  |  Состояние сервера в сети  |  Count  |  Максимальная | 
...
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес/Синкграупс  |  синкграупсинксессионапплиедфилескаунт  |  Синхронизировано файлов  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес/Синкграупс  |  синкграупсинксессионперитемеррорскаунт  |  Несинхронизирующиеся файлы  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес/Синкграупс/Серверендпоинтс  |  серверендпоинтсинксессионапплиедфилескаунт  |  Синхронизировано файлов  |  Count  |  Итог | 
| **Да**  | нет |  Microsoft. storagesync/Сторажесинксервицес/Синкграупс/Серверендпоинтс  |  серверендпоинтсинксессионперитемеррорскаунт  |  Несинхронизирующиеся файлы  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft.StreamAnalytics/streamingjobs  |  инпутевентссаурцесбакклогжед  |  Необработанные входные события  |  Count  |  Максимальная | 
| **Да**  | нет |  Microsoft.StreamAnalytics/streamingjobs  |  инпутевентссаурцесперсеконд  |  Полученные входные источники  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Вмвареклаудсимпле/virtualMachines  |  дискреадоператионс  |  Операции чтения с диска  |  Count  |  Итог | 
...
| **Да**  | нет |  Microsoft. Вмвареклаудсимпле/virtualMachines  |  дисквритеоператионс  |  Операции записи на диск  |  Count  |  Итог | 
...
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  ткпклосеваит  |  Ожидание TCP-закрытия  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  ткпклосинг  |  TCP-закрытие  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  ткпестаблишед  |  Установлен TCP  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  TcpFinWait1  |  Ожидание TCP FIN 1  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  TcpFinWait2  |  Ожидание TCP FIN 2  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  ткпластакк  |  Последнее подтверждение TCP  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  ткпсинрецеивед  |  Получен TCP SYN  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  ткпсинсент  |  TCP SYN отправлен  |  Count  |  Среднее | 
| **Да**  | **Да** |  Microsoft.Web/serverfarms  |  ткптимеваит  |  Время ожидания TCP  |  Count  |  Среднее | 
...
| **Да**  | **Да** |  Microsoft.Web/sites  |  хеалсчеккстатус  |  Состояние проверки работоспособности  |  Count  |  Среднее | 
...
| **Да**  | **Да** |  Microsoft.Web/sites/slots  |  хеалсчеккстатус  |  Состояние проверки работоспособности  |  Count  |  Среднее | 
