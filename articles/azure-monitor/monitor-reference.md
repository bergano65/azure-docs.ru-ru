...
| [Azure Monitor для виртуальных машин](insights/container-insights-overview.md) | Отслеживает виртуальные машины Azure и масштабируемые наборы виртуальных машин в масштабе. Это решение анализирует производительность и работоспособность виртуальных машин Windows и Linux, отслеживает их процессы и зависимости на других ресурсах, а также внешние процессы. |
...
| [Сопоставление служб](insights/service-map.md) | Автоматически обнаруживает компоненты приложения в системах Windows и Linux и сопоставляет взаимодействие между службами. |
...
| [Анализ журнала действий](platform/activity-log-view.md#azure-portal) | Просмотр записей журнала действий. |
