...
| [Azure Monitor для виртуальных машин](insights/container-insights-overview.md) | Отслеживает виртуальные машины Azure и масштабируемые наборы виртуальных машин в большом масштабе. Это решение анализирует производительность и работоспособность виртуальных машин Windows и Linux, отслеживает их процессы и зависимости на других ресурсах, а также внешние процессы. |
...
|Key Vault | Да | Да | [Да](insights/key-vaults-insights-overview.md) |  |
...
|:---|:---|
| [Служба автоматизации Azure](/azure/automation/) | Управление обновлениями операционной системы и отслеживание изменений на компьютерах Windows и Linux. См. статьи [Отслеживание изменений](../automation/change-tracking.md) и [Управление обновлениями](../automation/automation-update-management.md). |
| [Azure Information Protection](https://docs.microsoft.com/azure/information-protection/) | Классификация и дополнительная защита документов и сообщений электронной почты. См. [Центр отчетов для Azure Information Protection](https://docs.microsoft.com/azure/information-protection/reports-aip#configure-a-log-analytics-workspace-for-the-reports). |
| [Центр безопасности Azure](/azure/security-center/) | Сбор и анализ событий безопасности и анализ угроз. См. [Сбор данных в Центре безопасности Azure](/azure/security-center/security-center-enable-data-collection). |
| [Azure Sentinel](/azure/sentinel/) | Подключается к различным источникам, включая Office 365 и Amazon Web Services CloudTrail. См. статью [Подключение источников данных](/azure/sentinel/connect-data-sources). |
| [Аналитика Key Vault](insights/azure-key-vault.md) | Анализ журналов AuditEvent в Azure Key Vault. |
...
| [Центр приложений Visual Studio](https://docs.microsoft.com/appcenter/) | Сборка, тестирование и распространение приложений с последующим отслеживанием их состояния и использования. См. статью [Анализ мобильного приложения с помощью Центра приложений и Application Insights](learn/mobile-center-quickstart.md). |
| Windows | [Поддержка обновлений Windows](https://docs.microsoft.com/windows/deployment/update/update-compliance-get-started) — оценка обновлений классических приложений Windows.<br>[Аналитика компьютеров](https://docs.microsoft.com/configmgr/desktop-analytics/overview) интегрируется с Configuration Manager и предоставляет ценные сведения и аналитику для принятия более обоснованных решений о готовности к обновлению клиентов Windows. |
...
| [Анализ журналов действий](platform/activity-log-view.md#azure-portal) | Просмотр записей журналов действий. |
...
| [Оценка по требованию](https://docs.microsoft.com/services-hub/health/getting_started_with_on_demand_assessments) | Оценка и оптимизация доступности, безопасности и производительности локальных, гибридных и облачных технологических сред Майкрософт. |
...
| Ресурс | Метод |
|:---|:---|
| Приложения | Отслеживание веб-приложений за пределами Azure с помощью Application Insights. См. статью [Что такое Azure Application Insights?](https://docs.microsoft.com/azure/azure-monitor/app/app-insights-overview) |
| Виртуальные машины | Использование агента Log Analytics для получения данных из операционных систем на виртуальных машинах в других облачных средах или в локальной среде. См. статью [Сбор данных журнала с помощью агента Log Analytics](platform/log-analytics-agent.md). |
