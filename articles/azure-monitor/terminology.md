...
## <a name="october-2019---diagnostic-log-to-resource-log"></a>Октябрь 2019 - Диагностический журнал в журнале ресурсов
"Диагностические журналы" были изменены на "журналы ресурсов", чтобы лучше соответствовать тому, что на самом деле собирается. Термин "диагностические настройки" остается прежним.  
...
Данные журнала Azure Monitor по-прежнему хранятся в рабочей области Log Analytics, собираются и анализируются той же службой, но мы меняем термин _Log Analytics_ во многих местах на _журналы Azure Monitor_. Этот термин лучше отражает его роль в Azure Monitor и обеспечивает лучшую согласованность с [метриками в Azure Monitor.](platform/data-platform-metrics.md)
