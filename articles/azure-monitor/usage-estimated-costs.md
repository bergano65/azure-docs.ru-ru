...
> - [Управление использованием и затратами с помощью журналов Azure Monitor](logs/manage-cost-storage.md) описывает управление затратами путем изменения срока хранения данных, а также анализ и оповещение об использовании данных.
...
У некоторых клиентов будет доступ к [устаревшим](logs/manage-cost-storage.md#legacy-pricing-tiers) ценовым категориям log Analytics и [устаревшей ценовой категории Enterprise Application Insights](app/pricing.md#legacy-enterprise-per-node-pricing-tier). 
...
> [!NOTE]
> Использование службы **управления затратами** в центре **управления затратами Azure и центром выставления счетов** является предпочтительным подходом к широкому пониманию затрат на мониторинг.  **Использование и оценка затрат** на [log Analytics](logs/manage-cost-storage.md#understand-your-usage-and-estimate-costs) и [Application Insights](app/pricing.md#understand-your-usage-and-estimate-costs) предоставляют более подробные сведения о каждой из этих частей Azure Monitor.
