...
Для удобства IP-адрес удаленной стороны подключения включается в свойство RemoteIp. Для входящих подключений свойство RemoteIp имеет то же значение, что и свойство SourceIp, а для исходящих подключений у него будет такое же значение, что и у свойства DestinationIp. Свойство RemoteDnsCanonicalNames представляет канонические имена DNS, переданные компьютером для свойства RemoteIp. Свойство Ремотеднскуестионс представляет вопросы DNS, о которых сообщает компьютер для RemoteIp. Свойство Ремовеклассификатион зарезервировано для будущего использования. 
...
|Статус |Значения: *0–5*, где *5* является самым серьезным, а *0* не является серьезным вообще. Значение по умолчанию — *3*.  |
...
| Пространство имен | Имя | Описание | Unit | Теги |
|:---|:---|:---|:---|:---|
...
| LogicalDisk | WritesPerSecond       | Число операций записи логического диска в секунду            | Число/с | Маунтид — идентификатор подключения устройства |
| LogicalDisk | врителатенцимс        | Задержка записи на логический диск (МС)    | MilliSeconds   | Маунтид — идентификатор подключения устройства |
| LogicalDisk | WriteBytesPerSecond   | Байт записи на логический диск в секунду       | Байт/с | Маунтид — идентификатор подключения устройства |
| LogicalDisk | TransfersPerSecond    | Число перемещений логических дисков в секунду         | Число/с | Маунтид — идентификатор подключения устройства |
| LogicalDisk | трансферлатенцимс     | Задержка передачи логического диска (МС) | MilliSeconds   | Маунтид — идентификатор подключения устройства |
| LogicalDisk | ReadsPerSecond        | Число операций чтения логического диска в секунду             | Число/с | Маунтид — идентификатор подключения устройства |
| LogicalDisk | реадлатенцимс         | Задержка чтения логического диска (МС)     | MilliSeconds   | Маунтид — идентификатор подключения устройства |
| LogicalDisk | ReadBytesPerSecond    | Байт чтения логического диска в секунду        | Байт/с | Маунтид — идентификатор подключения устройства |
| LogicalDisk | фриспацеперцентаже   | Свободное место на логическом диске в процентах        | Процент        | Маунтид — идентификатор подключения устройства |
| LogicalDisk | фриспацемб           | Объем свободного места на логическом диске (байт)             | Мегабайты      | Маунтид — идентификатор подключения устройства<br>Дисксиземб — общий размер диска |
| LogicalDisk | Байт/с        | Байт логического диска в секунду             | Байт/с | Маунтид — идентификатор подключения устройства |
