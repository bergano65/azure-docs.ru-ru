---
title: Оповещения работоспособности гостевых виртуальных машин в Azure Monitor (предварительная версия)
...
ms.locfileid: "100625632"
---
# <a name="azure-monitor-for-vms-guest-health-alerts-preview"></a>Оповещения работоспособности гостевых виртуальных машин в Azure Monitor (предварительная версия)
