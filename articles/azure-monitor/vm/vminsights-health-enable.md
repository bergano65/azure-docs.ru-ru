...
В представлении **Начало работы** в Azure Monitor для виртуальных машин щелкните ссылку рядом с сообщением об обновлении для виртуальной машины, а затем нажмите кнопку **Обновить** . Вы можете выбрать несколько виртуальных машин, чтобы обновить их одновременно.
...
Конфигурация мониторов в Azure Monitor для виртуальных машин гостевой работоспособности хранится в [правилах сбора данных (ДКР)](../agents/data-collection-rule-overview.md). Каждая виртуальная машина с расширением работоспособности гостевой системы потребует связи с этим правилом.
