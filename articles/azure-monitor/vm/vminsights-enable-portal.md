...
- [Создание и Настройка рабочей области log Analytics](../insights/vminsights-configure-workspace.md). Кроме того, во время этого процесса можно создать новую рабочую область.
...
![Включение Azure Monitor для виртуальной машины](media/vminsights-enable-portal/enable-vminsights-vm-portal.png)
...
![Включение Azure Monitor для обработки развертывания мониторинга виртуальных машин](media/vminsights-enable-portal/onboard-vminsights-vm-portal-status.png)
