...
- [Рабочие области Microsoft.OperationalInsights](/azure/templates/microsoft.operationalinsights/2020-08-01/workspaces) 
- [Рабочие области и источники данных Microsoft.OperationalInsights](/azure/templates/microsoft.operationalinsights/2020-08-01/workspaces/datasources)
...
Следующий пример добавляет коллекцию [событий Windows](../platform/data-sources-windows-events.md) в существующую рабочую область.
...
Следующий пример добавляет коллекцию [событий системного журнала](../platform/data-sources-syslog.md) в существующую рабочую область.
...
Следующий пример добавляет коллекцию [счетчиков производительности Windows](../platform/data-sources-performance-counters.md) в существующую рабочую область.
...
Следующий пример добавляет коллекцию [счетчиков производительности Linux](../platform/data-sources-performance-counters.md) в существующую рабочую область.
...
Следующий пример добавляет коллекцию [пользовательских журналов](../platform/data-sources-custom-logs.md) в существующую рабочую область.
...
Следующий пример добавляет коллекцию [журналов IIS](../platform/data-sources-iis-logs.md) в существующую рабочую область.
...
* [Узнайте об источниках данных агентов.](../platform/agent-data-sources.md)
