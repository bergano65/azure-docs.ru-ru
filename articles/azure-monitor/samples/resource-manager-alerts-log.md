...
## <a name="number-of-results-template-up-to-version-2018-04-16"></a>Шаблон "Количество результатов" (до версии 2018-04-16)
В приведенном ниже примере создается [правило генерации оповещений "Количество результатов"](../platform/alerts-unified-log.md#count-of-the-results-table-rows).
...
## <a name="metric-measurement-template-up-to-version-2018-04-16"></a>Шаблон "Измерение метрик" (до версии 2018-04-16)
В приведенном ниже примере создается [правило генерации оповещений "Измерение метрик"](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value).
...
## <a name="template-for-all-resource-types-from-version-2020-05-01-preview"></a>Шаблон для всех типов ресурсов (начиная с версии 2020-05-01-preview)
В следующем примере создается правило, предназначенное для любого ресурса.
