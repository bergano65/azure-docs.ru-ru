...
> [!IMPORTANT]
> В этой статье рассматривается сбор данных о производительности с помощью [агента log Analytics](../platform/log-analytics-agent.md) , который является одним из агентов, используемых Azure Monitor. Другие агенты собираются разные данные и настраиваются по-разному. Список доступных агентов и данных, которые они могут собираются, см. в разделе [Обзор агентов Azure Monitor](../agents/agents-overview.md) .
...
Настройте счетчики производительности в [меню данные в дополнительных параметрах](../agents/agent-data-sources.md#configuring-data-sources) для рабочей области log Analytics.
...
* Экспортируйте собранные данные в [Power BI](../platform/powerbi.md) для дополнительной визуализации и анализа.
