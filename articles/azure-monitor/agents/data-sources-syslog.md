...
> [!IMPORTANT]
> В этой статье рассматривается сбор событий системного журнала с помощью [агента log Analytics](../platform/log-analytics-agent.md) , который является одним из агентов, используемых Azure Monitor. Другие агенты собираются разные данные и настраиваются по-разному. Список доступных агентов и данных, которые они могут собираются, см. в разделе [Обзор агентов Azure Monitor](../agents/agents-overview.md) .
...
* [Настройте агенты Linux](../learn/quick-collect-linux-computer.md) для сбора других типов данных.
