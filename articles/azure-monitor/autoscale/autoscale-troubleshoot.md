...
Автомасштабирование предоставляет [четыре метрики](../platform/metrics-supported.md#microsoftinsightsautoscalesettings) для понимания работы. 
...
Вы можете использовать [Обозреватель метрик](../platform/metrics-getting-started.md) , чтобы выработать приведенные выше метрики в одном месте. На диаграмме должна отобразиться:
...
Как и любой другой ресурс Azure, служба автомасштабирования предоставляет [журналы ресурсов](../platform/platform-logs-overview.md). Существует две категории журналов.
...
Как и в случае с любой Azure Monitor поддерживаемой службой, можно использовать [параметры диагностики](../platform/diagnostic-settings.md) для маршрутизации следующих журналов:
