...
Для получения дополнительных сведений о параметрах автомасштабирования перейдите к [Обзору автомасштабирования](../autoscale/autoscale-overview.md).

> [!div class="nextstepaction"]
> [Архивирование данных мониторинга](../essentials/platform-logs-overview.md)
