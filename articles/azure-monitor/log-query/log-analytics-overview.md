...
> [!TIP]
> В этой статье содержится описание Log Analytics и всех ее функций. Если вы хотите перейти непосредственно к учебнику, см. [log Analytics руководстве](get-started-portal.md).
