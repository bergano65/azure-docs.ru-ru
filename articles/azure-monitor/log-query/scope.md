...
| Subscription | Записи, созданные всеми ресурсами в подписке. Может включать данные из нескольких рабочих областей Log Analytics. | Выберите **журналы** в меню подписка.   | Не удается изменить область. |
