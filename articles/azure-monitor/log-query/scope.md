...
> [!IMPORTANT]
> Если вы используете APM 2,1, то Application Insights приложения хранятся в Log Analytics рабочей области со всеми остальными данными журнала, а область Application Insights недоступна. Если выбрать пункт **журналы** в меню Application Insights, то он действует так же, как и **другие области ресурсов Azure** , и только данные, из в этом приложении, доступны только в таблицах Application Insights.
