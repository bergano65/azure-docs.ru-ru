...
| sort by table asc
```
Дополнительные сведения о создаваемых таблицах см. в документации по каждому источнику данных. Примеры включают статьи для [источников данных агентов](../platform/agent-data-sources.md), [журналов ресурсов](../platform/resource-logs-schema.md)и [решений для мониторинга](../monitor-reference.md).
