...
ms.locfileid: "56242113"
---
# <a name="get-started-with-azure-monitor-log-analytics"></a>Начало работы со службой Log Analytics в Azure Monitor

[!INCLUDE [log-analytics-demo-environment](../../../includes/log-analytics-demo-environment.md)]

В этом руководстве рассматривается использование Log Analytics для записывания запросов журнала Azure Monitor. Вы научитесь:
...
Log Analytics — это веб-инструмент, используемый для записывания и выполнения запросов журнала Azure Monitor. Откройте их, выбрав **Журналы** в меню Azure Monitor. Она начинается с нового пустого запроса.
...
Запросы Log Analytics всегда сохраняются в выбранную рабочую область и совместно используются другими пользователями этой рабочей области.
