...
Каждый символ в строке имеет номер индекса в соответствии с его расположением. Первый символ находится в индексе 0, следующий символ — 1 и т. д. Различные строковые функции используют номера индексов по-разному, как показано в следующих разделах. Во многих приведенных примерах используется команда **print** для демонстрации работы со строками без использования определенного источника данных.
