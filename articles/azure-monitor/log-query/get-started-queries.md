...
ms.locfileid: "67296086"
---
# <a name="get-started-with-log-queries-in-azure-monitor"></a>Начало работы с запросов к журналу в Azure Monitor
...
В этом руководстве вы узнаете для записи журнала запросов в Azure Monitor. Вы научитесь:

- Понять структуру запроса
...
Учебник по использованию Log Analytics на портале Azure, см. в разделе [приступить к работе с Azure Monitor Log Analytics](get-started-portal.md).<br>
Дополнительные сведения о журнале запросов в Azure Monitor, см. в разделе [Общие сведения о журнале запросов в Azure Monitor](log-query-overview.md).
...
> [!WARNING]
> Поисковые запросы обычно медленнее, чем запросы на основе таблицы, из-за наличия для обработки дополнительных данных. 
