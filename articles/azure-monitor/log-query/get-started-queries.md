...
ms.locfileid: "52885502"
---
# <a name="get-started-with-queries-in-log-analytics"></a>Начало работы с запросами в Log Analytics


> [!NOTE]
> Прежде чем приступать к этому руководству, необходимо ознакомиться со статьей [Начало работы с порталом аналитики](get-started-portal.md).
