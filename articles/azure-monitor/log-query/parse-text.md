---
title: Анализ текстовых данных в службе Azure Log Analytics | Документация Майкрософт
description: Описывает различные варианты анализа данных в записях Log Analytics во время сбора данных и их извлечения в запросе, сравнивая относительные преимущества каждого.
documentationcenter: ''
author: bwren
manager: carmonm
editor: tysonn
...
В этой статье описываются различные варианты анализа текстовых данных в записях Log Analytics во время сбора данных и их извлечения в запросе, сравнивая относительные преимущества каждого.
...
Дополнительные сведения об анализе данных после их сбора см. в разделе [Create custom fields in Log Analytics](../../log-analytics/log-analytics-custom-fields.md) (Создание настраиваемых полей в Log Analytics). Это создает в таблице настраиваемые свойства, которые могут использоваться запросами, как и любое другое свойство.
...
Чтобы включить эффективный анализ в больших масштабах, Log Analytics использует регулярные выражения версии re2, которые похожие, но не идентичны с некоторыми другими вариантами регулярных выражений. Детали см. на странице о [синтаксисе re2](https://aka.ms/kql_re2syntax).
