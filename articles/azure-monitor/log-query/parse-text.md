...
Когда вы анализируете данные во время их сбора, вы настраиваете [настраиваемые поля](../platform/custom-fields.md), которые создают в таблице новые свойства. Запросы не должны включать какую-либо логику анализа, а просто использовать эти свойства как любое другое поле в таблице.
