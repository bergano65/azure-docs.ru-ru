...
- [Мониторинг приложений Java из любого расположения](./app/java-standalone-config.md) — добавлена новая статья.
- [Мониторинг приложений Java в любой среде](./app/java-in-process-agent.md) — добавлена новая статья.
- [Мониторинг приложений Java, выполняющихся в любой среде](./app/java-standalone-arguments.md) — добавлена новая статья.
- [Мониторинг приложений Java, выполняющихся в локальной среде](./app/java-on-premises.md) — добавлена новая статья.
- [Удаление Application Insights в Visual Studio](./app/remove-application-insights.md) — добавлена новая статья.
...
- [Настройка Azure Monitor для контейнеров в Azure Red Hat OpenShift 4.х](./insights/container-insights-azure-redhat4-setup.md) — добавлена новая статья.
- [Как вручную исправить проблемы с синхронизацией ServiceNow](./platform/itsmc-resync-servicenow.md) — добавлена новая статья.
- [Как отключить мониторинг кластера Azure и Red Hat OpenShift v4](./insights/container-insights-optout-openshift-v4.md) — добавлена новая статья.
- [Как отключить мониторинг кластера Red Hat OpenShift версии 3 в Azure](./insights/container-insights-optout-openshift-v3.md) — добавлена новая статья.
- [Как отключить мониторинг гибридного кластера Kubernetes](./insights/container-insights-optout-hybrid.md) — добавлена новая статья.

### <a name="insights"></a>Аналитика

- [Мониторинг Azure Key Vault с помощью Azure Monitor для Key Vault (предварительная версия)](./insights/key-vault-insights-overview.md) — добавлена новая статья.
