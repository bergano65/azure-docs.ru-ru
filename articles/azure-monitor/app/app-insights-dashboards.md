...
3. Чтобы **переключаться между панелями мониторинга**, воспользуйтесь раскрывающимся меню возле заголовка панели мониторинга.
...
5. Чтобы **настроить панель мониторинга**, Перемещайте, настраивайте и удаляйте плитки путем наведения на них указателя мыши и использования верхней панели.
...
* Диапазон времени до 1 часа — обновление раз в 5 минут;
* диапазон времени от 1 до 24 часов — обновление раз в 15 минут;
* диапазон времени свыше 24 часов — диапазон времени / 60.

### <a name="pin-any-query-in-analytics"></a>Закрепление любого запроса в аналитике
Вы также можете [закрепить диаграммы аналитики](../../azure-monitor/log-query/get-started-portal.md) на [общей](#share-dashboards-with-your-team) панели мониторинга. Это позволяет добавлять диаграммы из любого произвольного запроса вместе со стандартными метриками. 
...
* [**Обозреватель метрик**](../../azure-monitor/app/metrics-explorer.md) необходим, чтобы создавать собственные метрики производительности и использования.
...
* [**Сценарий автоматизации**](../../azure-monitor/app/powershell.md) — это экспорт определения ресурса Azure, позволяющий использовать его как шаблон для создания новых ресурсов.
...
|  |  |
| --- | --- |
| [Обозреватель метрик](../../azure-monitor/app/metrics-explorer.md)<br/>Фильтрация и сегментирование метрик |![Пример поиска](./media/app-insights-dashboards/64.png) |
| [Поиск по журналу диагностики](../../azure-monitor/app/diagnostic-search.md)<br/>Поиск и проверка событий, связанные события и создание ошибок |![Пример поиска](./media/app-insights-dashboards/61.png) |
| [Аналитика в Application Insights](../../azure-monitor/app/analytics.md)<br/>Эффективный язык запросов |![Пример поиска](./media/app-insights-dashboards/63.png) |
