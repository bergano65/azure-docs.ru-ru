...
Для пакетов SDK, которые не поддерживают адаптивную выборку, можно использовать [выборку](https://docs.microsoft.com/azure/azure-monitor/app/sampling#ingestion-sampling) данных, которая выбирается, когда данные Application Insights рецевед в зависимости от процента данных для удержания или с помощью [фиксированной частоты выборки для ASP.NET, ASP.NET Core и Java. ](https://docs.microsoft.com/azure/azure-monitor/app/sampling#fixed-rate-sampling-for-aspnet-aspnet-core-and-java-websites)веб-сайты для уменьшения трафика, отправляемого с веб-сервера и веб-браузеров
