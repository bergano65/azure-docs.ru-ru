...
Приложение Insights Daily Cap создает событие в kog активности Azure, когда проглатынные объемы данных выдают уровень предупреждения или дневной уровень крышки.  Можно [создать оповещение на основе этих событий журнала активности.](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-activity-log#create-with-the-azure-portal) Имена сигналов для этих событий:
