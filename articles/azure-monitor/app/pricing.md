...
Существует два подхода к исследованию томов данных для Application Insights. В первой используется агрегированная информация в `systemEvents` таблице, а во второй — `_BilledSize` свойство, доступное для каждого полученного события.
