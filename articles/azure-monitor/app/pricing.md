...
Чтобы узнать фактическую частоту выборки (где бы она ни применялась), выполните [запрос Analytics](../logs/log-query-overview.md). Этот запрос выглядит следующим образом.
