...
Анализ изменений в настоящее время интегрирован в веб-приложение службы приложений для **диагностики и устранения проблем** , а также доступен в виде автономной колонки в портал Azure.
...
Параметры, такие как правило IP-конфигурации, параметры SSL и версии расширений, пока недоступны в аргументе ARG, поэтому запросы на анализ изменений и их повторные значения для предоставления дополнительных сведений в приложении. Эти сведения пока недоступны в графе ресурсов Azure, но скоро будут доступны.
...
Поставщик ресурсов Microsoft. Чанжеаналисис должен быть зарегистрирован в подписке для Azure Resource Manager отслеживанию свойств и изменение параметров прокси-сервера для доступа к данным. При вводе веб-приложения и устранении проблем, а также при включении автономной колонки анализа изменений этот поставщик ресурсов регистрируется автоматически. Она не имеет никаких реализаций производительности и затрат для вашей подписки.
Для изменений в гостевом веб-приложении требуется отдельное включение для сканирования файлов кода в веб-приложении. Дополнительные сведения см. в разделе *Включение анализа изменений в средстве "Диагностика и устранение проблем"* далее в этой статье.
