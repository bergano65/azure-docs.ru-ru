...
1. Включите **анализ изменений** и нажмите кнопку **сохранить**. Средство отображает все веб-приложения в плане служб приложений. Чтобы включить анализ изменений для всех веб-приложений в рамках плана, можно использовать параметр уровень плана.
