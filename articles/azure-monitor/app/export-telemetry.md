...
## <a name="continuous-export-advanced-storage-configuration"></a>Непрерывный Экспорт конфигурации Дополнительные хранилища

Непрерывный Экспорт **не поддерживает** следующие функции службы хранилища Azure и конфигурации:

* Использование [брандмауэры хранилища виртуальной сети или Azure](https://docs.microsoft.com/azure/storage/common/storage-network-security) в сочетании с хранилищем BLOB-объектов Azure.

* [Неизменяемый хранилища](https://docs.microsoft.com/azure/storage/blobs/storage-blob-immutable-storage) BLOB-объектов Azure.

* [Хранилище Озера данных Azure 2-го поколения](https://docs.microsoft.com/azure/storage/blobs/data-lake-storage-introduction).
...
3. Создайте или выберите [учетную запись хранения Azure](../../storage/common/storage-introduction.md), в которой необходимо сохранить данные. Дополнительные сведения о вариантах оплаты см. на [официальной странице цен](https://azure.microsoft.com/pricing/details/storage/).
    ...
    ![Последовательно щелкните "Добавить", "Назначение экспорта", "Учетная запись хранения" и затем создайте новое хранилище или выберите существующее.](./media/export-telemetry/02-add.png)

4. Создайте или выберите контейнер в хранилище:

    ![Щелкните "Выбор типов событий".](./media/export-telemetry/create-container.png)
...
![Щелкните "Выбор типов событий".](./media/export-telemetry/05-edit.png)
...
Вы несете ответственность за управление емкостью хранилища и удалить старые данные, при необходимости.
...
![Измените параметры непрерывного экспорта, откройте и закройте место назначения экспорта.](./media/export-telemetry/07-resetstore.png)
...
* *Существует ли предел для объема данных, помещаемых в мое хранилище?*
    ...
    № Мы будем хранить переданные данные в хранилище, пока вы не удалите данные экспорта. Мы остановим передачу данных, если столкнемся с внешними ограничениями для хранилища больших двоичных объектов, но хранилище очень большое. Вы можете настроить объем используемого хранилища.  
