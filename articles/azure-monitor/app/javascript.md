...
Полный список параметров конфигурации см. на [странице GitHub](https://github.com/microsoft/applicationinsights-js#configuration). Ниже перечислены некоторые доступные параметры.
