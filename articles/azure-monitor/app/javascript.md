...
> [!NOTE]
> Если вы используете [Поиск](../../azure-monitor/app/diagnostic-search.md), обратите внимание, что слова необходимо сопоставлять целиком: "Пр" и "о" не соответствуют "Про".
> 
> 
