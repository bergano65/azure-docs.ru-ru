...
1. Выберите Application Insights ресурс > **Automation**  >  **шаблон экспорта** службы автоматизации 
...
Если проверка выполняется с localhost, а значение параметра `customDimensions_client-ip` — `::1` , то это ожидаемое поведение. `::1` представляет петлевой адрес в IPv6. Он эквивалентен `127.0.01` в IPv4.
