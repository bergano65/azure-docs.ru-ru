...
Это правило генерации оповещений создается с помощью связанной [группы действий](../platform/action-groups.md) с именем "Application Insights Smart Detection", которая содержит действия электронной почты и веб-перехватчика и может быть расширена для активации дополнительных действий при срабатывании оповещения.
...
> Уведомления, отправленные из этого правила генерации оповещения, соответствуют [общей схеме оповещений](../platform/alerts-common-schema.md).
>
...
* Можно использовать функцию подавления для [правила действий оповещения](../platform/alerts-action-rules.md).
