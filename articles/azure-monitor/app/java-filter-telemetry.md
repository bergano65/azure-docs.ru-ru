...
Для передачи этих параметров в пользовательский фильтр необходимо создать собственные `application.properties` параметры фильтра в и использовать внешнюю инфраструктуру конфигурации с пружинной загрузкой. 
