---
title: Фильтр Azure Приложение Исследования телеметрии в вашем веб-приложении Java
...
### <a name="1-code-your-filter"></a>1. Кодируйте свой фильтр
...
### <a name="2-invoke-your-filter-in-the-configuration-file"></a>2. Вызвать фильтр в файле конфигурации
...
### <a name="3-invoke-your-filter-java-spring"></a>3. Вызвать фильтр (Java Spring)

Для приложений, основанных на рамочной системе Spring, пользовательские телеметрические процессоры должны быть зарегистрированы в вашем основном классе приложений в качестве беас. Затем они будут автоматически подключены, когда приложение начинается.
...
Вам нужно будет создать свои собственные `application.properties` параметры фильтра и использовать экстернализированную структуру конфигурации Spring Boot, чтобы передать эти параметры в пользовательский фильтр. 
