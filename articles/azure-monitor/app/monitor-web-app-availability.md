...
| Отображаемое имя | Имя заполнения |
|--------------|-----------------|
| Уссек Запад   | уссек-Запад-AZR  |
| Уссек Восток   | уссек-Восток-AZR  |

#### <a name="us-nat"></a>NAT (США)

| Отображаемое имя | Имя заполнения |
|--------------|-----------------|
| Уснат Восток   | уснат-Восток-AZR  |
| Уснат Запад   | уснат-Запад-AZR  |
