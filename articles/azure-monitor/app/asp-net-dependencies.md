...
![Схема приложений](./media/asp-net-dependencies/cloud-rolename.png)
...
> [!NOTE]
> **100% сбоев?** — вероятно, означает, что вы получаете только неполные данные зависимостей. Необходимо [настроить мониторинг зависимостей в соответствии со своей платформой](#set-up-dependency-monitoring).
>
>
...
*SQL-запрос, не отображается в полном объеме.*
