...
Не имеете представления, куда девается время? [Профилировщик Application Insights](../../azure-monitor/app/profiler.md) отслеживает вызовы HTTP к активному веб-сайту и показывает, какие функции в коде выполнялись дольше всего.
