...
Для веб-страниц Application Insights пакет SDK для JavaScript автоматически собирает вызовы AJAX как зависимости, как описано [здесь](javascript.md#ajax-performance). В этом документе рассматриваются зависимости от серверных компонентов.
...
* На [вкладке браузеры](javascript.md#ajax-performance) ОТОБРАЖАЮТСЯ вызовы AJAX из браузеров пользователей.
...
## <a name="logs-analytics"></a>Журналы (аналитика)
