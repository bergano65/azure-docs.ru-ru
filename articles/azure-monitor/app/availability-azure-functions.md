...
С помощью журналов (Analytics) можно просматривать результаты доступности, зависимости и многое другое. Дополнительные сведения о журналах см. в статье [Обзор запросов журналов](../log-query/log-query-overview.md).
