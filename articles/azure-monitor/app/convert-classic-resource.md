...
Данные классических ресурсов будут сохранены и будут подвергаться параметрам хранения во время их приема. Все новые данные, полученные после миграции, будут подвергаться параметрам сохранения связанной рабочей области Log Analytics. 
...
> [!NOTE]
> Прием и хранение данных ресурсов рабочей области Application Insights оплачиваются по тарифам рабочей области Log Analytics, в которой находятся данные. [Узнайте больше]( ./pricing.md#workspace-based-application-insights) о выставлении счетов за ресурсы рабочей области Application Insights. (Классические Application Insights данные ресурсов, принимаемые до миграции, будут по-прежнему попадать в Application Insights хранения и цены на время, в течение которого данные хранятся.) 
