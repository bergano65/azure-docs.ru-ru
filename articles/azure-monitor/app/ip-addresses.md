...
Вы можете запросить список IP-адресов, используемых группами действий, с помощью [команды PowerShell Get-азнетворксервицетаг](https://docs.microsoft.com/powershell/module/az.network/Get-AzNetworkServiceTag).

### <a name="action-groups-service-tag"></a>Тег службы групп действий
