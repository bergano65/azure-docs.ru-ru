---
title: Мониторинг производительности веб-приложений Java в Azure Application Insights (2.5.0-BETA) | Документация Майкрософт
description: Расширенное наблюдение за производительностью и использованием веб-сайта Java с помощью Application Insights (2.5.0-BETA).
...
Ключ `JAVA_OPTS`Значений`-javaagent:D:/home/site/wwwroot/applicationinsights-agent-2.5.0-BETA.jar`
