...
*Мои клиента и данных телеметрии на стороне сервера не отображают скоординированные образцы, как описано выше.*
...
*Можно ли процент выборки меняться со временем?*

* Да, адаптивная выборка постепенно меняет процент выборки в зависимости от текущего объема данных телеметрии.

*Если я использую выборки с фиксированной частотой, как узнать, какие-либо выборки в процентах будет оптимальным для моего приложения?*
...
*Есть определенные редкие события, которые я всегда хочу просматривать. Как я могу их за модуль выборки?*
