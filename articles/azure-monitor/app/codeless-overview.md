...
|Служба приложений Azure в Linux             | Недоступно             | Не поддерживается   | Закрытая предварительная версия | Общедоступная предварительная версия  |
...
|Окна функций Azure — зависимости | Не поддерживается   | Не поддерживается   | Общедоступная предварительная версия  | Не поддерживается   |
...
|Изолированный агент — любой env.            | Не поддерживается   | Не поддерживается   | GA              | Не поддерживается   |
