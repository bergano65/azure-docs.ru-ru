...
|Служба приложений Azure в Linux    | Недоступно             | Не поддерживается   | Общедоступная предварительная версия  | Общедоступная предварительная версия  |
|Служба приложений Azure на AKS      | Недоступно             | В разработке       | В разработке       | В разработке       |
...
|Служба Azure Kubernetes      | Недоступно             | В разработке       | Через агент   | В разработке       |
