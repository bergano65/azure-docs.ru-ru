---
title: Диагностика с помощью потока live Metrics Stream - Azure Application Insights
...
Держите руку на пульсе работы веб-приложения с помощью Live Metrics Stream в [Application Insights](../../azure-monitor/app/app-insights-overview.md). Выбирайте и фильтруйте метрики и счетчики производительности для отслеживания в режиме реального времени, не нарушая работу служб. Проверяйте трассировки стека на основе образцов неудавшихся запросов и исключений. Вместе с [Профилером](../../azure-monitor/app/profiler.md), [Моментальный отладчик](../../azure-monitor/app/snapshot-debugger.md). Live Metrics Stream предоставляет мощный и неинвазивный диагностический инструмент для вашего живого веб-сайта.
...
В настоящее время live Metrics поддерживается для приложений ASP.NET, ASP.NET Core, Azure Functions, Java и Node.js.
...
|Канал управления|В пакет SDK отправляются управляющие сигналы фильтрации. Мы советуем защитить этот канал.|Связь является одним из способов, на портал|
...
Для приложений функции Azure (v2) обеспечение безопасности канала ключом API может быть выполнено с помощью переменной среды.
...
### <a name="aspnet-core-requires-application-insights-aspnet-core-sdk-230-or-greater"></a>ASP.NET Core (Требует сярприза ASP.NET Core SDK 2.3.0 или более)
...
## <a name="supported-features-table"></a>Таблица поддерживаемых функций

| Язык                         | Основные метрики       | Метрики производительности | Пользовательская фильтрация    | Образец телеметрии    | Процессор, разделенный по процессу |
|----------------------------------|:--------------------|:--------------------|:--------------------|:--------------------|:---------------------|
| .NET                             | Поддерживается (V2.7.2) | Поддерживается (V2.7.2) | Поддерживается (V2.7.2) | Поддерживается (V2.7.2) | Поддерживается (V2.7.2)  |
| Ядро .NET (целевая рамочная программа.NET)| Поддерживается (V2.4.1) | Поддерживается (V2.4.1) | Поддерживается (V2.4.1) | Поддерживается (V2.4.1) | Поддерживается (V2.4.1)  |
| Ядро .NET (целевой показатель.NET Core)     | Поддерживается (V2.4.1) | Поддерживается*          | Поддерживается (V2.4.1) | Поддерживается (V2.4.1) | **Не поддерживается**    |
| Функции Azure версии 2               | Поддерживается           | Поддерживается           | Поддерживается           | Поддерживается           | **Не поддерживается**    |
| Java                             | Поддерживается (V2.0.0) | Поддерживается (V2.0.0) | **Не поддерживается**   | **Не поддерживается**   | **Не поддерживается**    |
| Node.js                          | Поддерживается (V1.3.0) | Поддерживается (V1.3.0) | **Не поддерживается**   | Поддерживается (V1.3.0) | **Не поддерживается**    |

Основные показатели включают скорость запроса, зависимости и исключения. Показатели производительности (счетчики производительности) включают память и процессор. Образец телеметрии показывает поток подробной информации для неудавшихся запросов и зависимостей, исключений, событий и следов.

 \*Поддержка PerfCounters немного варьируется в зависимости от версий .NET Core, которые не нацелены на рамочную систему .NET:

- Метрики PerfCounters поддерживаются при запуске в службе приложений Azure для Windows. (AspNetCore SDK Версия 2.4.1 или выше)
- PerfCounters поддерживается при запуске приложения в любых компьютерах Windows (VM или Cloud Service или On-prem и т.д.) (AspNetCore SDK Версия 2.7.1 или выше), но для приложений, ориентированных на .NET Core 2.0 или выше.
- PerfCounters поддерживается, когда приложение работает ANYWHERE (Linux, Windows, служба приложений для Linux, контейнеры и т.д.) в последней бета-версии (т.е. AspNetCore SDK Версия 2.8.0-beta1 или выше), но для приложений, ориентированных на .NET Core 2.0 или выше.

По умолчанию Live Metrics отключен в Node.js SDK. Чтобы включить Live Metrics, добавьте `setSendLiveMetrics(true)` в [методы конфигурации](https://github.com/Microsoft/ApplicationInsights-node.js#configuration) при инициализации SDK.

## <a name="troubleshooting"></a>Устранение неполадок

Данные отсутствуют? Если ваше приложение находится в защищенной сети: Live Metrics Stream использует различные IP-адреса, чем другие телеметрии Application Insights. Убедитесь, что [эти IP-адреса](../../azure-monitor/app/ip-addresses.md) открыты в брандмауэре.
