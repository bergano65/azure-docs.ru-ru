...
Если вы уже используете службу приложений в Azure, то наверняка получили определенные сведения мониторинга, касающиеся частоты запросов и ошибок. Добавьте Application Insights, чтобы получить дополнительные сведения и возможности, такие как время отклика, мониторинг вызовов зависимостей, интеллектуальное обнаружение и мощный язык запросов Data Explorer. 
