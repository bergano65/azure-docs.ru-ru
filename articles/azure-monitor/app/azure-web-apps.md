...
Поддерживаются следующие версии ASP.NET Core: ASP.NET Core 2,1, ASP.NET Core 2,2, ASP.NET Core 3,0, ASP.NET Core 3,1
...
2. Указав, какой ресурс следует использовать, можно выбрать способ, с помощью которого Application Insights собирает данные для каждой платформы приложения. ASP.NET Core предлагает **рекомендуемый сбор** или **отключение** для ASP.NET Core 2,1, 2,2, 3,0 и 3,1.
