...
Если вы уже используете службу приложений в Azure, то наверняка получили определенные сведения мониторинга, касающиеся частоты запросов и ошибок. Application Insights расширяет возможности мониторинга, обеспечивая лучшее время отклика, возможности мониторинга вызовов зависимостей, интеллектуального обнаружения и использования языка запросов Kusto. 
...
2. Указав ресурс для использования, вы можете выбрать способ сбора данных в Application Insights для каждой платформы для приложения (мониторинг приложения ASP.NET по умолчанию включен с двумя разными уровнями коллекции).
    ...
    * Уровень **рекомендуемой коллекции** .NET:
    ...
    .NET Core предлагает уровень **рекомендуемой** или отключенной коллекции для .NET Core 2.0 и 2.1.
