...
> [!IMPORTANT]
> Поддерживаются следующие версии ASP.NET Core: ASP.NET Core 2,1, 3,1 и 5,0. Версии 2,0, 2,2 и 3,0 были прекращены и больше не поддерживаются. Выполните обновление до [поддерживаемой версии](https://dotnet.microsoft.com/platform/support/policy/dotnet-core) .NET Core, чтобы автоматическое инструментирование работало.
