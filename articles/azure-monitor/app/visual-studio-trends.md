...
Затем нажмите **«Анализ телеметрии»** для выполнения запроса.
...
Элементы управления фильтрами, расположенные в нижней части окна, позволяют выявлять конкретные тренды. Чтобы применить фильтр, щелкните его название. Можно быстро переключаться между разными фильтрами, чтобы выявить тренды, которые могут быть скрыты в определенном измерении телеметрии. При применении фильтра в одном измерении, например типа исключения, фильтры в других измерениях остаются интерактивными, даже если они кажутся серыми. Чтобы отменить фильтр, нажмите на него еще раз. Удерживая нажатой клавишу CTRL, можно выбрать несколько фильтров в одном измерении.
