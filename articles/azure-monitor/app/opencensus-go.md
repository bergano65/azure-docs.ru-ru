...
1. Выберите **Создать ресурс** > **Средства разработчика** > **Application Insights**.
 ...
 > [!NOTE]
   >Если вы впервые создаете Application Insights ресурс, вы можете узнать больше, перейдя в статью [создание Application Insights ресурсов](https://docs.microsoft.com/azure/azure-monitor/app/create-new-resource) .
