...
Для Python можно использовать [обработчики телеметрии Опенценсус Python](api-filtering-sampling.md#opencensus-python-telemetry-processors) .
