...
* [**Упреждающая диагностика**](../../application-insights/app-insights-proactive-diagnostics.md) автоматически настроена для отправки уведомлений о необычных показателях производительности.
...
![В колонке правил оповещений нажмите кнопку «Добавить оповещение». Установите приложение в качестве ресурса для измерения, введите имя оповещения и выберите метрику.](./media/alerts/01-set-metric.png)
...
> [!NOTE]
> В колонке "Оповещения" вы увидите, что оповещение уже настроено: [Упреждающая диагностика](../../application-insights/app-insights-proactive-failure-diagnostics.md). Это автоматическое оповещение, которое отслеживает одну определенную метрику — процент сбоев запросов. Если вы не хотите отключать упреждающее оповещение, не нужно задавать собственное оповещение о проценте сбоев запросов. 
> 
> 
...
![В колонке "Обзор" щелкните "Параметры" > "Журналы аудита".](./media/alerts/09-alerts.png)
...
Не забывайте, что [упреждающая диагностика частоты сбоев](../../application-insights/app-insights-proactive-failure-diagnostics.md) автоматически отслеживает скорость, с которой приложение отвечает на запросы с кодом ошибки. 
...
* [Упреждающая диагностика](../../application-insights/app-insights-proactive-diagnostics.md) 
