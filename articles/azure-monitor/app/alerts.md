...
## <a name="how-to-set-an-exception-alert-using-custom-log-search"></a>Настройка оповещения об исключении с помощью настраиваемого поиска по журналам
...
Этот раздел относится к **классическим оповещениям о доступности**, **классическим оповещениям о метриках Application Insights** и **классическим оповещениям об аномалиях и сбоях**.
