...
Этот раздел относится к **доступности классического оповещения**, **классические оповещения метрик Application Insights**, а в **классической предупреждениях аномалии**.
