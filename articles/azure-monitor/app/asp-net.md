...
Настройка выполняется несколькими щелчками в Visual Studio. Вы можете избежать расходов, ограничив объем телеметрии. Эта функциональность позволяет экспериментировать и отладить, или контролировать сайт с не так много пользователей. Если вы хотите отслеживать рабочий сайт, вы можете легко увеличить лимит позже.

## <a name="prerequisites"></a>Предварительные требования
Чтобы добавить Application Insights для веб-сайта ASP.NET, сделайте следующее:

- Установка [Visual Studio 2019 для Windows](https://www.visualstudio.com/downloads/) со следующими рабочими нагрузками:
...
> [!IMPORTANT]
> Скриншоты в этом примере основаны на visual Studio 2017 версии 15.9.9 и позже. Опыт добавления Application Insights варьируется в разных версиях Visual Studio, а также в зависимости от типа шаблона ASP.NET. Старые версии могут иметь альтернативный текст, такой как "Наверстывание приложений Insights".

Нажмите правой кнопкой мыши имя веб-приложения в Solution Explorer и выберите **Добавить** > **приложение Исследования Телеметрия**
...
![Снимок экрана с окном страницы "Зарегистрировать приложение в Application Insights"](./media/asp-net/00005-register-ed.png)
 ...
 Выберите источник**пакетов пакетов** >  **Управления** > nuGet**Project: nuget.org** > подтвердить, что у вас есть последний стабильный выпуск Приложения Исследования SDK.
...
Чтобы просмотреть данные Application Insights в Visual Studio, сделайте следующее.  Выберите **решения Explorer** > **Подключенные службы** > правой кнопкой **нажмите Приложение Исследования**, а затем нажмите Поиск Live **Телеметрия**.
...
## <a name="youre-all-set"></a><a name="land"></a>Вы все в порядке
...
* **[Код пользовательских событий](../../azure-monitor/app/api-custom-events-metrics.md)** для подсчета, времени или измерения действий пользователя.
