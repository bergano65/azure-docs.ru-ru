...
Чтобы просмотреть данные Application Insights в Visual Studio, сделайте следующее.  Выберите **Обозреватель решений** > **подключенные службы** > щелкните правой кнопкой мыши **Application Insights**, а затем выберите **Поиск в Live телеметрии**.
...
* **[Код пользовательские события](../../azure-monitor/app/api-custom-events-metrics.md)** для подсчета количества, времени или измерения действий пользователя.
