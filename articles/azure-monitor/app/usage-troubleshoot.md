...
Все события телеметрии в Application Insights имеют уникальные [идентификатор анонимного пользователя](./data-model-context.md) и [идентификатор сеанса](./data-model-context.md) в качестве двух стандартных свойств. По умолчанию все инструменты аналитики потребления подсчитывают пользователей и сеансы на основе этих идентификаторов. Если стандартные свойства не были заполнены уникальными идентификаторами для каждого пользователя и сеанса приложения, в инструментах аналитики потребления отобразится неправильное количество пользователей и сеансов.
