...
- **OnlyProviders**. Задайте этот параметр только сбор журналов из пакета SDK. Вы можете настроить этот список, в зависимости от вашей определенные исследования. 
