...
* Убедитесь, что на компьютере разработки установлен средства Application Insights. В Visual Studio **средства** > **расширения и обновления**, искать **средства Application Insights**. Если это не так в **установленные** открытой вкладкой ", **Online** вкладку и установите его.
* Это может быть тип проекта, который не поддерживает средства Application Insights. Используйте [установку вручную](#manual-installation).
