...
Уровень серьезности можно также добавить к сообщению. Как и для других данных телеметрии, вы можно добавлять значения свойств для фильтрации или поиска различных наборов трассировки. Пример:
