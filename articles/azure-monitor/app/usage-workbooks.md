...
* Изучение использования приложения, когда вы не узнаете интересующие вас метрики: число пользователей, тарифные курсы, тарифные курсы и т. д. В отличие от других средств аналитики использования, книги позволяют объединять несколько видов визуализаций и анализа, делая их отличными для такого рода просмотра свободной формы.
...
Более подходящий пример — использование раскрывающегося списка для выбора из набора стран или регионов по имени:
