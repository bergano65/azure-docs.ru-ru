...
* Будет ли BYOS работать с шифрованием неактивных и управляемого клиентом ключа?
    _Да, чтобы быть точным, BYOS является необходимым условием включения профилировщика или отладчика с помощью ключей клиента._
...
* Будет ли BYOS работать, когда одновременно были включены управляемые клиентом ключи и частная связь? 
    _Да, это возможно._
