...
(Для более сложных запросов к данным используйте [Analytics](../log-query/get-started-portal.md).)
...
> [!NOTE]
> Чтобы написать более сложные запросы, откройте [**журналы (Analytics)**](../log-query/get-started-portal.md) в верхней части колонки поиска.
>
...
* [Создание сложных запросов в Analytics](../log-query/get-started-portal.md)
