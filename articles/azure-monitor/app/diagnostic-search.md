...
* **Трассировка событий**  -  [Журналы диагностики](../../azure-monitor/app/asp-net-trace-logs.md) , в том числе вызовы TrackTrace, log4net, NLog и System. Диагностика. Trace.
...
* **Просмотр страницы**  -  [Данные телеметрии, отправленные веб-клиентом](../../azure-monitor/app/javascript.md)и используемые для создания отчетов по просмотру страниц.
...
* **Зависимость от**  -  [Вызовы из серверного приложения](../../azure-monitor/app/asp-net-dependencies.md) в другие службы, такие как API-интерфейсы или базы данных, и вызовы AJAX из [клиентского кода](../../azure-monitor/app/javascript.md).
