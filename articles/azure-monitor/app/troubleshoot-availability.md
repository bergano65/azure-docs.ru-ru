...
Эта ошибка означает, что необходимо добавить исключения брандмауэра, чтобы разрешить агентам доступности тестировать целевой URL-адрес. Полный список разрешенных IP-адресов агента см. в статье об [исключении IP](https://docs.microsoft.com/azure/azure-monitor/app/ip-addresses#availability-tests).
