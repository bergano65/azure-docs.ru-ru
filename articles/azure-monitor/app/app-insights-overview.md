...
Вы устанавливаете небольшой пакет инструментирования (SDK) в приложении или включаете Application Insights без использования кода, [когда это возможно](../../azure-monitor/app/platforms.md). Функция инструментирования отслеживает ваше приложение и направляет данные телеметрии в ресурс Azure Application Insights, используя уникальный идентификатор GUID, который мы будем называть ключом инструментирования.
