...
Влияние на производительность вашего приложения очень мало. Вызовы отслеживания не приводят к блокировке, собираются в пакеты и отправляются в отдельном потоке.
