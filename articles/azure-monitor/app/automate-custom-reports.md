...
* [Автоматизация отчетов с помощью Microsoft Flow](automate-with-flow.md)
...
1. Создайте приложение-функция Azure. (Application Insights _в_ требуется только в том случае, если вы хотите отслеживать новые приложение-функция с Application Insights)
   ...
   Дополнительные сведения о [создании приложения-функции](https://docs.microsoft.com/azure/azure-functions/functions-create-first-azure-function#create-a-function-app) см. в документации по функциям Azure.
