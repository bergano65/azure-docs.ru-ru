...
1. В поле **этап 1** выберите гиперссылку, чтобы **просмотреть задачи этапа.**
   ...
   ![Просмотреть задачи этапа](media/continuous-monitoring/002.png)
