...
*Предупреждение*. в некоторых случаях необработанное исключение может [препятствовать](https://docs.microsoft.com/dotnet/csharp/language-reference/keywords/try-finally) вызову `finally`, чтобы операции не были отслеживаниться.
