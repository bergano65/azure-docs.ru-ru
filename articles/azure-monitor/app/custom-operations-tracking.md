...
Application Insights использует тип зависимости для настройки интерфейсов пользовательского интерфейса. Для очередей он распознает следующие типы `DependencyTelemetry` , улучшающие [возможности диагностики транзакций](/azure/azure-monitor/app/transaction-diagnostics):
