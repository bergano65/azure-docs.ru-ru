...
* **Группа ресурсов** — это удобный способ управления такими свойствами, как [Управление доступом](../../azure-monitor/app/resources-roles-access-control.md). Для разработки, тестирования и эксплуатации можно использовать отдельные группы ресурсов.
...
(Для автоматического создания ресурса можно написать [сценарий PowerShell](https://docs.microsoft.com/azure/azure-monitor/app/create-new-resource#creating-a-resource-automatically) .)
