...
3. Снова выберите **Выполнение запроса**. Если вы не видите идентификаторы пользователей, которые отображаются в таблице, изменение страны или региона, где приложение имеет пользователей.

4. Сохраните и назовите когорту.

## <a name="frequently-asked-questions"></a>Часто задаваемые вопросы

_Я определил когорту пользователей из определенных страны или региона. Когда я сравниваю эта когорта в инструментах пользователя только Настройка фильтра входа этой страны или региона, я вижу разные результаты. Почему?_
...
* [Анализ шаблонов навигации пользователя с помощью инструмента "Маршруты пользователя" в Azure Application Insights](usage-flows.md)
