...
2. Выберите вкладку **Template Gallery.** Вы видите коллекцию шаблонов для различных когорт.
...
3. Выберите **Engaged Users – by Days Used** (Активные пользователи — по дням пользования службой).
    ...
    * **UsedAtLeastCustom**, количество раз пользователи должны использовать что-то в течение периода, чтобы считаться вовлеченным.

4. Изменение **UsedAtLeastCustom** до **5 дней**и оставить **период** по умолчанию 28 дней.
...
Эти фильтры поддерживают более сложные вопросы, которые невозможно выразить через конструктор запросов. Примером могут быть _люди, которые занимались в течение последних 28 дней. Как вели себя те же самые люди за последние 60 дней?_
...
2. Выберите вкладку **Template Gallery.** Вы увидите коллекцию шаблонов для различных когорт.
...
3. Снова выберите **Выполнение запроса**. Если в таблице отображаются иудиктора пользователя, измените в страну/регион, где в приложении есть пользователи.

4. Сохраните и назовите когорту.

## <a name="frequently-asked-questions"></a>Часто задаваемые вопросы

_Я определил когорту пользователей из определенной страны / региона. Когда я сравниваю эту когорту в инструменте пользователей, чтобы просто установить фильтр на этой стране / регионе, я вижу разные результаты. Почему?_
