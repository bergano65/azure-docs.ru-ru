...
### <a name="enabling-profiler-for-other-clouds-manually"></a>Включение Profiler для других облаках вручную

Если вы хотите включить профилировщик для других облаков, можно использовать ниже параметры приложения.
