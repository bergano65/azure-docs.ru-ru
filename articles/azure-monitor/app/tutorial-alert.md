...
> [Use Azure Application Insights to understand how customers are using your application](./tutorial-users.md) (Анализ взаимодействия клиентов с приложением с помощью Azure Application Insights)
