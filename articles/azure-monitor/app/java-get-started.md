...
> [!CAUTION]
> По состоянию на ноябрь 2020 для мониторинга приложений Java рекомендуется автоматическое инструментирование с помощью агента Azure Monitor Application Insights 3,0. Дополнительные сведения о том, как приступить к работе, см. в разделе [Application Insights агент Java 3,0](./java-in-process-agent.md).
