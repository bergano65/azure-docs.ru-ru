...
[Application Insights Profiler](./profiler.md) и [Snapshot Debugger](snapshot-debugger.md) упрощают диагностику проблем производительности и ошибок на уровне кода. Эти средства позволяют легко просматривать трассировки профилировщика и моментальные снимки из любого компонента.
...
* Если эти компоненты являются отдельными Application Insightsными ресурсами, у вас есть необходимые [права доступа](resources-roles-access-control.md) , если у вас есть доступ и компоненты оснащены последними пакетами SDK Application Insights, сообщите нам через правый канал обратной связи.
