...
* *Можно ли создавать собственные правила обнаружения аномалий или настраивать имеющиеся правила?*
  ...
  * Пока еще нет, но вы можете:
    * [настроить оповещения](../alerts/alerts-log.md), которые предупреждают вас, когда метрика достигает порогового значения;
...
* *То есть эта функция заменяет [оповещения о метриках](../alerts/alerts-log.md)?*
...
* [Интеллектуальная диагностика и анализ](../logs/log-query-overview.md)
