...
* *Можно ли создавать собственные правила обнаружения аномалий или настраивать имеющиеся правила?*
  ...
  * Пока еще нет, но вы можете:
    * [настроить оповещения](/azure/azure-monitor/platform/alerts-log), которые предупреждают вас, когда метрика достигает порогового значения;
...
* *То есть эта функция заменяет [оповещения о метриках](/azure/azure-monitor/platform/alerts-log)?*
...
* [Настройка оповещений в Application Insights](/azure/azure-monitor/platform/alerts-log)
