...
3. Подозрительные действия пользователя: приложения осуществляется из разных стран и регионов тем же пользователем в примерно то же время. Например, один и тот же пользователь обратился к приложению из Испании и США в течение одного часа. Такое обнаружение указывает на потенциально злоумышленную попытку доступа к приложению.
...
2. **Область.** Из каких странах и регионах исходили подозрительные запросы? Кто из пользователей был наиболее подозрительным? Эти сведения можно получить из уведомления.
3. **Диагностика.** Обнаружение предоставляет список подозрительных пользователей и список стран и регионов, для каждого пользователя, чтобы помочь вам в дальнейшем диагностировать проблему.
