...
[Отладочные моментальные снимки](../../azure-monitor/app/snapshot-debugger.md) хранятся в течение пятнадцати дней. Такая политика хранения задается для каждого приложения отдельно. Если нужно увеличить этот параметр, можно запросить увеличение, отправив обращение в службу поддержки на портале Azure.
