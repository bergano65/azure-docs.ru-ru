...
Если [пользовательские метрики][track] были закодированы в приложении и они содержат значения свойств, вы сможете выбрать свойство в списке.
