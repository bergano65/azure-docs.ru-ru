...
* **%**- процентные версии каждой агрегации используются только с сегментированными диаграммами. Общее значение всегда равно 100 %, а на диаграмме отображается относительный вклад каждого компонента.
...
[Подробнее о предупреждениях.][alerts]
...
* Данные о производительности (CPU, скорость обработки и того раз и т.д.) доступны для веб-сервисов Java, настольных приложений Windows, [веб-приложений и служб IIS при установке монитора состояния](../../azure-monitor/app/monitor-performance-live-website-now.md)и [облачных служб Azure.](../../azure-monitor/app/app-insights-overview.md) Такие данные для веб-сайтов Azure недоступны.
