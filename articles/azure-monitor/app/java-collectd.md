...
В ресурсе Application Insights откройте [метрики и добавьте диаграммы,][metrics]выбрав метрики, которые вы хотите видеть из категории Пользовательские.
...
Симптомы: Сбор журнала показывает ошибки, которые включают "ИИ: ... SyntaxError: Неожиданный токен N."
