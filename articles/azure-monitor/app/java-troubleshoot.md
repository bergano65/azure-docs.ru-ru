...
* [Включите ведение журнала](#debug-data-from-the-sdk) , добавив `<SDKLogger />` элемент в корневой узел в файле ApplicationInsights. XML (в папке ресурсов проекта) и проверяйте наличие записей, начинающихся с AI: info/warn/Error для любых подозрительных журналов. 
