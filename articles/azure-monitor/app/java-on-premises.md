...
Следуйте [подробным инструкциям](./java-in-process-agent.md) для всех сред, включая локальную.

 ## <a name="next-steps"></a>Дальнейшие действия

* [Получение инструкций по загрузке агента Java](./java-in-process-agent.md)
