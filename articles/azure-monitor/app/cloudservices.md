...
Дальнейшие действия — [Просмотр метрик из приложения](../platform/metrics-charts.md), [запрос данных с помощью аналитики](../log-query/log-query-overview.md). 
...
Узнайте, как [динамически задать ключ инструментирования](https://docs.microsoft.com/azure/azure-monitor/app/separate-resources#dynamic-ikey) для различных этапов. 
...
1. Откройте созданные ранее ресурсы Application Insights.
   ...
   В разделе [Поиск][diagnostic] отображаются отдельные точки данных, а в [обозревателе метрик](../platform/metrics-charts.md) — агрегированные данные.
...
Источники данных [диагностики Azure](../platform/diagnostics-extension-overview.md) в Application Insights можно найти в следующих расположениях:
...
* [Настройка системы диагностики Azure для отправки данных в Application Insights](../platform/diagnostics-extension-to-application-insights.md)
