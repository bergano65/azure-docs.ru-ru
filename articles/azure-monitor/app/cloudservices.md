...
Дальнейшие действия — [Просмотр метрик из приложения](../../azure-monitor/platform/metrics-charts.md), [запрос данных с помощью аналитики](../../azure-monitor/app/analytics.md). 
...
1. В Обозреватель решений Visual Studio в  > разделе ** \<роли>йоурклаудсервице **откройте свойства каждой роли. **Roles**
