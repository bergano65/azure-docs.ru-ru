...
Дальнейшие действия — [Просмотр метрик из приложения](../../azure-monitor/platform/metrics-charts.md), [запрос данных с помощью аналитики](../log-query/log-query-overview.md). 
...
Если у вас есть клиентское мобильное приложение, воспользуйтесь [Центром приложений](../../azure-monitor/learn/mobile-center-quickstart.md). Создайте запросы в [Аналитике](../log-query/log-query-overview.md) для отображения числа событий и закрепите эти показатели на панели мониторинга.
