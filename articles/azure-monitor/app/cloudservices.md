...
Следующими шагами являются [просмотр метрик из приложения,](../../azure-monitor/app/metrics-explorer.md) [запрос данных с помощью Analytics.](../../azure-monitor/app/analytics.md) 
...
1. Откройте созданные ранее ресурсы Application Insights.
   ...
   В разделе [Поиск][diagnostic] отображаются отдельные точки данных, а в [обозревателе метрик](../../azure-monitor/app/metrics-explorer.md) — агрегированные данные.
...
* [Проверка](https://github.com/christopheranderson/azure-functions-app-insights-sample)
