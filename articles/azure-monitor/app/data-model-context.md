...
Идентификатор пользователя, прошедшего проверку подлинности. Противоположность идентификатору анонимного пользователя, это поле представляет пользователя с понятным именем. Этот параметр собираются по умолчанию с помощью пакета SDK для ASP.NET Framework [`AuthenticatedUserIdTelemetryInitializer`](https://github.com/microsoft/ApplicationInsights-dotnet/blob/develop/WEB/Src/Web/Web/AuthenticatedUserIdTelemetryInitializer.cs) .  
