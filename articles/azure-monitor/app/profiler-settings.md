...
Триггеры поддерживаются только в версии 2,6 или более поздней версии агента профилировщика. Если вы используете службу приложений Azure, агент будет обновлен автоматически. Вы можете увидеть, какую версию агента вы используете, если вы перейдете по URL-адресу KUDU для веб-сайта и добавите \Диагностиксервицес к концу, `https://yourwebsite.scm.azurewebsites.net/diagnosticservices`вот так:. Веб-задание Application Insights Profiler должно иметь версию 2,6 или более позднюю. Вы можете принудительно выполнить обновление, перезапустив веб-приложение. 
