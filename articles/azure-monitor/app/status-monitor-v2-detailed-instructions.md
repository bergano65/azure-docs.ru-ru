...
Подробнее о том, как использовать этот cmdlet, можно ознакомиться в [справочнике API.](https://docs.microsoft.com/azure/azure-monitor/app/status-monitor-v2-api-reference#enable-applicationinsightsmonitoring)
