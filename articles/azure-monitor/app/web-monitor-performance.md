...
* [Веб-приложений Java EE](https://docs.microsoft.com/azure/azure-monitor/app/java-in-process-agent)
...
## <a name="diagnosing-issues"></a><a name="diagnosis"></a>Диагностические проблемы
