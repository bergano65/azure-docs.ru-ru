...
![На снимке экрана показана производительность (Предварительная версия) с тремя пиковыми нагрузками в течение 7 дней с помощью временного интервала](./media/web-monitor-performance/PerformanceTriageView7DaysZoomedTrend.png)
...
![Снимок экрана: получение сведений о клиентах и сведения о трех пиковых значениях длительности в течение 7 дней с помощью временного интервала.](./media/web-monitor-performance/PerformanceTriageView7DaysZoomedTrendZoomed95th99th.png)
...
![На снимке экрана показана производительность (Предварительная версия) с выбранным общим открытым окном и аналитическими сведениями.](./media/web-monitor-performance/Performance30DayOveralllnsights.png)
