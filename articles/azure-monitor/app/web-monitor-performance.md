...
ms.locfileid: "72899299"
---
# <a name="monitor-performance-in-web-applications"></a>Отслеживание производительности в веб-приложениях


Она позволяет удостовериться, что приложение работает с хорошей производительностью, и быстро выяснить, были ли сбои. [Application Insights][start] сообщит о любых проблемах производительности и исключениях, а также поможет найти и диагностировать основные причины.
...
* Настройте [веб-тесты][availability] , которые должны получать оповещения, если веб-узел переходит в неправильное или медленное реагирование. 
* сравните число запросов с другими метриками, чтобы узнать, не связаны ли сбои или медленный ответ с нагрузкой;
* [Вставка и поиск в коде операторов трассировки][diagnostic] , помогающих выявить проблемы.
* Отслеживайте работу веб-приложения с [Live Metrics Stream][livestream].
...
[Веб-тесты][availability] — веб-запросы, отправляемые в приложение через регулярные интервалы по всему миру.

[Запись и поиск диагностических трассировок][diagnostic] — Вставка вызовов трассировки и необходимости просеивания с помощью результатов для выявления проблем.

[Отслеживание использования][usage] . Узнайте, как пользователи используют ваше приложение.

[Устранение неполадок][qna] — и Q & A
