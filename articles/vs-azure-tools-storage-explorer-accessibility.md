...
Платформа | Читатель экрана
---------|--------------
Windows  | Nvda
Mac      | Голосовая связь
Linux    | (читатели экрана не поддерживаются на Linux)
...
## <a name="high-contrast-themes"></a>Высокие контрастные темы

В обозревателе службы хранилища доступны две темы высокой контрастности, **Высокая контрастность — светлый** и **Высокая контрастность — темный**. Вы можете изменить свою тему, выбрав из меню Справка > темы.
...
### <a name="editor-commands"></a>Команды редакторов
