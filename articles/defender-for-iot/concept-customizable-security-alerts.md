...
ms.locfileid: "90939529"
---
# <a name="defender-for-iot-customizable-security-alerts"></a>Защитник для настраиваемых оповещений системы безопасности IoT
...
Следующий список защитника для оповещений IoT определяется вами в зависимости от ожидаемого центра Интернета вещей и (или) поведения устройства. Дополнительные сведения о настройке каждого оповещения см. в разделе [Создание настраиваемых оповещений](quickstart-create-custom-alerts.md).
