...
Чтобы создавать мгновенные моментальные снимки подробных сведений об активах, защитник для центра Интернета вещей дополняет пассивный мониторинг необязательным активным компонентом. Этот компонент использует надежные, утвержденные поставщиком команды для запроса сведений о ресурсах как для Windows, так и для устройств контроллеров, как часто, так и редко.
...
- **Обнаружение нарушений политики**: определяет нарушения политики, такие как незаконное использование кодов функций, доступ к конкретным объектам или изменение конфигурации ресурса.
