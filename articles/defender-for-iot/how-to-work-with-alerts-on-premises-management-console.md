---
title: Работа с оповещениями в локальной консоли управления
...
ms.locfileid: "97842854"
---
# <a name="work-with-alerts-on-the-on-premises-management-console"></a>Работа с оповещениями в локальной консоли управления 
...
Вы можете управлять событиями предупреждений, обнаруженными датчиками Организации, следующим образом.
