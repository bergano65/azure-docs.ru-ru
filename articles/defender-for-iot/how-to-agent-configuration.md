...
|----------|-|---------|----|----|
|Диагностическое событие|евентприоритидиагностик| Выключено| False| Диагностические события, связанные с агентом. Используйте это событие для подробного ведения журнала.|
...
|Сведения о системе |евентприоритисистеминформатион |Низкий |True |Моментальный снимок системных сведений (например, ОС или ЦП).|
