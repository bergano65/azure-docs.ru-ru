...
| аггрегатионенабледпроцесстерминате | Логическое | Включить или отключить агрегирование событий для событий завершения процесса | Только в Windows|
...
- Проверка наличия [необходимых компонентов для службы](service-prerequisites.md) IOT
