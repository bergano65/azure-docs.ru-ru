...
4. Учетные данные устройства:
   ...
   - Имя пользователя: **циберкс**

   - Пароль: **ксхксвхттжу, @4338**
...
1. Получите доступ к BIOS устройства напрямую с помощью клавиатуры и экрана или используйте Идрак.
   ...
   - Если устройство является защитником для устройства IoT, выполните вход с помощью **циберкс** для имени пользователя и **@4338 ксхксвхттжу** для пароля.
