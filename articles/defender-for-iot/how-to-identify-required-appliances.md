...
| Питание | 2 x HPE 500 с беспроблемным гнездом "горячая установка" с горячим подключением для горячей установки низкого Halogen |
...
| Питание | Источники питания с двумя горячими подключениями 500 W |
...
| Управление | HPE iLO Advanced |
| Доступ к устройству | Front: 1 x USB 3,0, порт службы USB iLO 1 x <br>Задняя: 2 x USB 3,0 <br>Внутренний: 1 x USB 3,0 |
| Питание | Источник питания с поддержкой горячего подключения 290 W |
| Поддержка стойки | Набор салазок для коротких трений HPE 1U |
...
| Максимальная пропускная способность [1](#anchortext2)| 1G МБ/с |
...
| Питание | Источники питания с двумя горячими подключениями 350 W |
