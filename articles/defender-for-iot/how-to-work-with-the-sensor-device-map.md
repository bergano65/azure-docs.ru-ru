...
5. Нажмите кнопку **ОК**. На карте появятся элементы подсети.
...
| Имя группы | Описание |
|--|--|
| **Известные приложения или нестандартные порты (по умолчанию)** | Устройства, использующие зарезервированные порты, такие как TCP. Устройства, использующие нестандартные порты или порты, которым не назначен псевдоним. |
