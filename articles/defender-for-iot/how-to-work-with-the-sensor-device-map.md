...
| Область | Безопасность и состояние авторизации устройства: <br /> — Состояние `Secured` при отсутствии предупреждений. <br /> — При наличии предупреждений об устройстве отображается число оповещений. <br /> — Состояние `Unauthorized` отображается для устройств, добавленных в сеть по истечении обучающего периода. Можно вручную определить устройство, как `Authorized Device` в параметрах <br /> Если адрес этого устройства определен как динамический адрес, `DHCP` добавляется к состоянию. |
