...
2. В окне **Пользователи** выберите **создать пользователя**.
3. На панели **создать пользователя** определите следующие параметры.
...
2. Введите `sudo nano /var/cyberx/properties/authentication`.
...
6. Чтобы добавить доверенный сервер, выберите **Добавить сервер** и настройте другой сервер.
