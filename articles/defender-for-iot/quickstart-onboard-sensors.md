...
| **Обновление сетевых параметров датчика перед активацией** | Измените параметры, определенные во время установки датчика. Дополнительные сведения см. в инструкциях по **загрузке файлов активации датчика**.|
...
4. Выберите вариант приобретения датчика.
   ...
   ![Представление датчика сети в Azure Defender для Интернета вещей](media/updates/image6.png)
