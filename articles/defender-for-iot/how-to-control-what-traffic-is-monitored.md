...
Имя узла отображается в перечне активов и в карте активов, а также в отчетах.
...
8. Щелкните **Сохранить**. Диалоговое окно **изменение конфигурации диапазонов сканирования** закрывается, а количество диапазонов отображается на панели **Просмотр диапазонов** .
