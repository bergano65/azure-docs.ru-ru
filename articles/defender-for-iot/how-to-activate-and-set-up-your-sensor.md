...
После первого входа в систему датчика защитника Azure для IoT начнет отслеживать свою сеть автоматически. Сетевые ресурсы будут отображаться в разделах "схема активов" и "Инвентаризация активов". Защитник Azure для IoT начнет обнаруживать и оповещать вас о всех событиях безопасности и эксплуатации, происходящих в сети. Затем можно создавать отчеты и запросы на основе обнаруженных данных.

Изначально это действие выполняется в режиме обучения, который указывает датчику на необходимость изучения обычной активности сети. Например, датчик узнает о ресурсах, обнаруженных в сети, об обнаруженных в сети протоколах и передачах файлов между конкретными ресурсами. Это действие станет базовым действием вашей сети.
