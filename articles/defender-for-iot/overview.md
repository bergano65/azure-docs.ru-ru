...
Защитник Azure для Интернета вещей — это единое решение для обеспечения безопасности, которое определяет активы, уязвимости и угрозы IoT. Она позволяет защитить всю среду IoT/a, нужно ли защищать существующие устройства IoT/в или создать безопасность в новых нововведениях IoT.  
...
Используйте пассивный, безагентный мониторинг сети для получения полного перечня всех ресурсов IoT/Asset, их сведений и способа связи, с нулевым влиянием на сеть IoT/.  
...
## <a name="agent-based-solution-for-device-builders"></a>Решение на основе агента для построителей устройств 
