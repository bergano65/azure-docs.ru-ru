...
- Защитник Azure для датчиков IoT
- Консоли управления:
    - Консоль датчика
    - Локальная консоль управления
    - Портал Azure
- Встроенный агент безопасности (модуль безопасности и пакет SDK для IoT)
