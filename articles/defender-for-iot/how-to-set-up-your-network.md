...
| Протокол | Транспорт | В/Из | Port | Используется | Цель | Источник | Назначение |
|--|--|--|--|--|--|--|--|
...
| 17 | Настройка обучения (самостоятельный обучающий курс). | ☐ |  |
| 18 | Go или No — Go. | ☐ |  |
...
|  Компонент               | Устройство 1 | Устройство 2 | Устройство 3 |
| --------------- | ------------- | ------------- | ------------- |
| IP-адрес устройства    |               |               |               |
| Подсеть          |               |               |               |
| Шлюз по умолчанию |               |               |               |
...
|       Компонент          | Активен | Пассивный (при использовании HA) |
| --------------- | ------ | ----------------------- |
| IP-адрес             |        |                         |
| Подсеть          |        |                         |
| Шлюз по умолчанию |        |                         |
