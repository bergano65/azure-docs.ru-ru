...
| **Подключение между защитником и платформой управления для платформы IoT и почтовым сервером (если это уместно)** | SMTP | TCP | Вне управления датчиками | 25 | Email |
...
| **Порт DNS-сервера (если применимо)** | DNS | Н/Д | Входящий или исходящий| 53 | DNS |
...
| **Удаленные собирающие SNMP (если применимо)** | SNMP | UDP | Вне управления датчиками| 161 | Наблюдение |
| **Мониторинг конечных точек Windows (если применимо)** | WMI | UDP | Вне управления датчиками| 135 | Наблюдение |
| **Мониторинг конечных точек Windows (если применимо)** | WMI | TCP | Вне управления датчиками| 1024 и выше | Наблюдение |
| **Туннелирование (если применимо)** | Туннелирование | TCP | В CM | 9000<br />в дополнение к порту 443<br />От конечного пользователя до локальной консоли управления <br />Порт 22 от датчика к локальной консоли управления | Наблюдение |
