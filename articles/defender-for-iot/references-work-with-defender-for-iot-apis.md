---
title: Работа с защитником для API IoT
...
5. Нажмите кнопку **Готово**. Создаваемые токены отображаются в диалоговом окне **маркеры доступа** .
   ...
   :::image type="content" source="media/references-work-with-defender-for-iot-apis/access-token-window.png" alt-text="Снимок экрана: диалоговое окно &quot;маркеры активов&quot; с заполненными маркерами":::
