...
Защитник Azure для датчика IoT работает с конкретными характеристиками оборудования, как описано в статье [спецификации оборудования](https://aka.ms/AzureDefenderforIoTBareMetalAppliance). клиенты могут приобрести сертифицированное оборудование от партнеров Майкрософт или использовать предоставленный комплект (BOM) и приобрести его самостоятельно. 
