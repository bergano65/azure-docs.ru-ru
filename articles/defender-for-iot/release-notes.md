...
### <a name="sensor---enhanced-custom-alert-rules"></a>Правила настраиваемых оповещений с улучшенными датчиками
...
### <a name="on-premises-management-console---export-alerts"></a>Локальная консоль управления — Экспорт оповещений
...
Документация по нерекомендуемому модулю безопасности будет перемещена в *решение на основе агента для построителей устройств>классической* папке.
