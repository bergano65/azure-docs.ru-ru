...
Зоны — это логические сущности, позволяющие разделять ресурсы внутри сайта группами в соответствии с различными характеристиками. Например, можно создать группы для производственных линий, подстанций, областей сайта или типов ресурсов. Вы можете определить зоны на основе любых характеристик, подходящих для вашей организации.
...
| Активы | Количество активов, которые наблюдает за датчиком. |
