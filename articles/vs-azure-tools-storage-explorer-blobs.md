...
4. Под папкой **Контейнеры больших двоичных объектов** отобразится текстовое поле. Введите имя контейнера больших двоичных объектов. См. в разделе [создать контейнер](storage/blobs/storage-quickstart-blobs-dotnet.md#create-a-container) сведения о правилах и ограничениях для именования контейнеров больших двоичных объектов.
...
7. Следуйте приведенным ниже инструкциям в зависимости от задачи, которую необходимо выполнить.
   ...
   * **Отправка файлов в контейнер больших двоичных объектов**
     ...
     3. Укажите тип в поле **Тип BLOB-объекта**. См. в разделе [создать контейнер](storage/blobs/storage-quickstart-blobs-dotnet.md#create-a-container) Дополнительные сведения.
