---
title: Сведения о шифровании в Azure ExpressRoute | Документация Майкрософт
...
Нет. Если Максек настроен и несовпадение в ключе, связь с корпорацией Майкрософт теряется. Другими словами, мы не будем возвращаться к незашифрованному соединению, предоставляя данные. 
