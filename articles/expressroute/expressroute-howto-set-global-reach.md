...
Если вы просто запускаете *$CKT _1* в PowerShell, вы увидите *Циркуитконнектионстатус* в выходных данных. Таким образом вы узнаете, установлено ли подключение (состояние "Подключено" или "Нет подключения"). 
