...
> [!IMPORTANT]
> Общедоступный пиринг Azure является устаревшим и недоступно для новых каналов ExpressRoute. Новые каналы поддержки Microsoft и частного пиринга.  
>
...
> [!Note]
> Общедоступный пиринг Azure имеет 1 NAT IP-адрес для каждого сеанса BGP. Более чем на 2 IP-адреса NAT переместите пиринг Майкрософт. Пиринг Майкрософт позволяет настроить собственные выделения NAT, а также использовать фильтры маршрутов для объявления префиксов Выборочный. Дополнительные сведения см. в разделе [переместить пиринг Майкрософт](https://docs.microsoft.com/azure/expressroute/how-to-move-peering).
>
