---
title: 'Настройка пиринга для канала ExpressRoute: Azure: классический | Документация Майкрософт'
...
> [!NOTE]
> Общедоступный пиринг Azure является устаревшим для новых каналов.
>
