...
Создайте список [значений сообщества BGP](expressroute-routing.md#bgp) вы хотите использовать в фильтре маршрута. 
...
Можно выбрать службы, которые вы хотите подключиться к из раскрывающегося списка и сохранить правило после завершения.
...
Можно подключить фильтр маршрутов к каналу, нажав кнопку «Добавить схемы» и выбрав канал ExpressRoute из раскрывающегося списка.
...
Чтобы отсоединить канал от фильтра маршрутов, щелкните правой кнопкой мыши по каналу и нажмите кнопку «Отменить связь».
...
* Сведения о примеры конфигурации маршрутизатора, см. в разделе [примеры конфигурации маршрутизатора для настройки и управления маршрутизацией](expressroute-config-samples-routing.md). 
