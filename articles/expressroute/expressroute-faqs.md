...
Канал SKU для ExpressRoute используется значение ExpressRoute Local. Ключевой особенностью локальных —, что локального circit на канал ExpressRoute, расположение пиринга дает доступ только для одного или двух регионов Azure в или рядом в одном регионе. Напротив стандартный канал предоставляет доступ к всех регионах геополитической области и канала уровня "премиум" во всех регионах Azure глобально. 
