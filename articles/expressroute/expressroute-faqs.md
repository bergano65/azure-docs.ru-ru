...
Дополнительные сведения о выборе пути BGP и общих конфигурациях маршрутизаторов см. [здесь](https://docs.microsoft.com/azure/expressroute/expressroute-optimize-routing#path-selection-of-microsoft-and-public-peerings) . 
