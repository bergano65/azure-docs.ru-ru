...
Шлюз ExpressRoute объявляет *адресное пространство* виртуальной сети Azure, вы не можете включить или исключить его на уровне подсети. Оно всегда является адресным пространством виртуальной сети, которое объявлено. Кроме того, если используется пиринг виртуальной сети, а в одноранговой виртуальной сети включен параметр "использовать удаленный шлюз", адресное пространство одноранговой виртуальной сети также будет объявлено.
