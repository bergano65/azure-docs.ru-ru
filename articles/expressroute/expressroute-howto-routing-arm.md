...
description: Узнайте, как создать и настроить конфигурацию маршрутизации для канала ExpressRoute в модели развертывания диспетчер ресурсов с помощью PowerShell.
