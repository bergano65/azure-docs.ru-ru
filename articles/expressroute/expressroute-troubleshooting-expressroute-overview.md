...
>[!TIP]
>Имя группы ресурсов можно получить с помощью Azure. Перейдите к предыдущему подразделу этого документа и обратите внимание на то, что имя группы ресурсов указано в примере снимка экрана.
>
>
