...
description: Узнайте, как отключить и включить пирингы канала Azure ExpressRoute с помощью Azure PowerShell. При настройке пиринга они включаются по умолчанию.
