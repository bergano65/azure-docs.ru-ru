...
|Число виртуальных машин в виртуальной сети |Доступность| Недоступно |Шлюз виртуальной сети ExpressRoute|
...
|Максимальная|real|Максимальное из двух значений метрик, помещаемых двумя MSEE|
