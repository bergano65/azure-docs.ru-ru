...
* **Управление доступом на основе ролей Azure (Azure RBAC)** — RBAC основывается на Azure Active Directory.  Дополнительные сведения об управлении доступом на основе ролей в Azure см. [здесь](../role-based-access-control/role-assignments-portal.md).
