...
Вы можете определить фильтры пользовательских маршрутов и разрешить использовать только определенные или необходимые маршруты. См. дополнительные сведения о [создании и изменении маршрутизации для канала ExpressRoute с помощью PowerShell и классической модели развертывания](expressroute-howto-routing-classic.md).
