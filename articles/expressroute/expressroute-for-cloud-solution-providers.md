...
* **Управление доступом на основе ролей Azure (Azure RBAC)** . Azure RBAC основан на Azure Active Directory.  Дополнительные сведения об Azure RBAC см. [здесь](../role-based-access-control/role-assignments-portal.md).
