---
title: 'Azure ExpressRoute: Перенос классических VNets на менеджера ресурсов'
...
* Убедитесь, что у вас есть последние версии модулей Azure PowerShell. Подробнее: [Установка и настройка Azure PowerShell](/powershell/azure/overview). Для установки модуля управления службой PowerShell (который необходим для классической модели развертывания) [см.](/powershell/azure/servicemanagement/install-azure-ps)
...
* Ознакомьтесь со следующими статьями о переносе ресурсов:
    ...
    * [Поддерживаемая платформой миграция ресурсов IaaS с классического в менеджер ресурсов Azure](../virtual-machines/virtual-machines-windows-migration-classic-resource-manager.md)
...
* Перенос канала ExpressRoute в другие подписки не поддерживается. Для получения дополнительной [Microsoft.Network move support](../azure-resource-manager/management/move-support-resources.md#microsoftnetwork)информации см.
