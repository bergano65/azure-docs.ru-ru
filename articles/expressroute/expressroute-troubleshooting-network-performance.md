...
| | | | | | |
|-|-|-|-|-|-|
|ExpressRoute<br/>Расположение|Таблицы Azure<br/>Регион|Приблизительно<br/>Расстояние (км)|Задержка|Сеанс 1<br/>Пропускная способность|Максимальная<br/>Пропускная способность|
