...
Настройка тестирования:
 ...
 - Во всех тестах использовалась команда AzureCT Get-LinkPerformance с 5-минутным нагрузочным тестом для каждого из шести тестовых запусков. Вот несколько примеров:
...
| Сиэтл | South Central US |  2,877 км |  51 мс |  30,6 Мбит/с |  2,49 Гбит/с |
...
| Сиэтл | East US          |  3,699 км |  74 мс |  21,1 Мбит/с |  1,78 Гбит/с |
