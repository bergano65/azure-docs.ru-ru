...
2. Отключите базу данных-получатель в том же регионе, используя режим планового завершения (11). При этом создается независимая, но полностью синхронизированная копия рабочей базы данных-источника. Эта база данных будет обновлена.
