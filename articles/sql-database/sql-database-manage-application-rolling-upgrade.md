...
2. Создайте профиль отработки отказа в ATM с `contoso-1.azurewebsites.net` в качестве подключенной конечной точки и с `contoso-2.azurewebsites.net` в качестве автономной.
...
1. Переключите рабочую конечную точку в профиле ATM на `contoso-2.azurewebsites.net`, которая указывает на версию V2 веб-сайта (6). Теперь она становится рабочим слотом с приложением V2, куда направляется трафик пользователей.  
...
> [!NOTE]
> Откат не требует изменения профиля ATM, так как он уже указывает на `contoso-1.azurewebsites.net` как на активную конечную точку.
...
4. Добавьте дополнительные конечные точки `contoso-2.azurewebsites.net` и `contoso-3.azurewebsites.net` в профиль отработки отказа в ATM как автономные конечные точки (5).
...
1. Переключите активную конечную точку в профиле ATM на `contoso-2.azurewebsites.net`, которая теперь указывает на версию V2 веб-сайта (9). Теперь она становится рабочим слотом с приложением V2, куда направляется трафик конечных пользователей.
...
> [!NOTE]
> Откат не требует изменения профиля ATM, так как уже указывает на `contoso-1.azurewebsites.net` как на активную конечную точку.
