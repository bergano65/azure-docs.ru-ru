...
ms.locfileid: "64866953"
---
# <a name="time-zones-in-azure-sql-database-managed-instance-preview"></a>Часовые пояса в базе данных управляемого экземпляра SQL Azure (Предварительная версия)
