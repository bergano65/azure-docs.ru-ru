...
Для крупномасштабных системах, где вы работаете с много ресурсов, [журналы Azure Monitor](saas-dbpertenant-log-analytics.md) может использоваться. Это отдельная служба Azure, которая предоставляет аналитические сведения на основе журналов диагностики и данных телеметрии, собранных в рабочей области Log Analytics. Журналы Azure Monitor может собирать данные телеметрии из многих служб и использоваться для запросов и настройки оповещений.
...
| 4. | Создание нагрузки с более высоким DTU при пиках на базу данных (около 80 DTU).|
| 5 | Создание нормальной нагрузки, а также с высокой нагрузкой на отдельный клиент (около 95 DTU)|
...
1. Задайте **$DemoScenario = 5, создания нормальной нагрузки, а также с высокой нагрузкой на отдельный клиент (около 95 DTU).**
...
* [Журналы Azure Monitor](saas-dbpertenant-log-analytics.md) — параметр настройке и использовании учебника журналы Azure Monitor
