---
title: 'Приложение SaaS: Мониторинг производительности многих баз данных SQL Azure '
...
В сценариях с большими объемами, где вы работаете с большим количеством ресурсов, можно использовать [журналы Azure Monitor](saas-dbpertenant-log-analytics.md) . Это отдельная служба Azure, которая обеспечивает аналитику по выпущенным журналам диагностики и телеметрии, собранным в Log Analytics рабочей области. Журналы Azure Monitor могут выполнять сбор данных телеметрии из многих служб и использовать их для запроса и настройки оповещений.
