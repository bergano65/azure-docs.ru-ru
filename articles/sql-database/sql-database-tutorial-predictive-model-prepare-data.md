...
Из [второй части](sql-database-tutorial-predictive-model-build-compare.md) вы узнаете, как создать и обучить несколько моделей машинного обучения на языке R, а затем выбрать наиболее точную из них.
