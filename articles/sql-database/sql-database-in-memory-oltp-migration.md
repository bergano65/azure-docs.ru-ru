...
> [!NOTE] 
> Узнайте [, как кворум удваивает рабочую нагрузку ключевой базы данных при снижении количества DTU на 70% с базой данных SQL](https://customers.microsoft.com/story/quorum-doubles-key-databases-workload-while-lowering-dtu-with-sql-database)
...
3. В окне мастера щелкните **Проверка переноса** (или нажмите кнопку **Далее**). Так вы узнаете, содержит ли таблица функции, которые не поддерживаются в оптимизированных для памяти таблицах. Дополнительные сведения можно найти в разделе
   ...
   * [Конструкции Transact-SQL, не поддерживаемые выполняющейся в памяти OLTP](https://msdn.microsoft.com/library/dn246937.aspx).
   * [Миграция в выполняющуюся в памяти OLTP](https://msdn.microsoft.com/library/dn247639.aspx).
