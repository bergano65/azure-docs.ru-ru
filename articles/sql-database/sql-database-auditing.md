...
> [!IMPORTANT]
> Включение аудита для приостановленного хранилища данных SQL Azure невозможна. Чтобы включить ее, отменить приостановки хранилища данных.

> [!WARNING]
> Включение аудита на сервере, где в хранилище данных SQL Azure на нем **приведет к хранилищу данных, возобновления и повторно приостановлена снова** которого может повлечь в расходов.
