...
> [!NOTE] 
> Аудит для реплики, доступной только для чтения, включен автоматически. Дополнительные сведения об иерархии папки хранилища, соглашениях об именовании и формате журнала см. в разделе [Формат журнала аудита базы данных SQL](sql-database-audit-log-format.md). 
