...
> [!NOTE] 
> Аудит для [реплик только для чтения](https://docs.microsoft.com/en-us/azure/sql-database/sql-database-read-scale-out) включен автоматически. Дополнительные сведения об иерархии папок хранилища, соглашениях об именовании и формате журнала см. в разделе [Формат журнала аудита базы данных SQL](sql-database-audit-log-format.md). 
