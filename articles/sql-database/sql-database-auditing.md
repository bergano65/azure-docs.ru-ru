...
Чтобы настроить запись журналов аудита в учетную запись хранения, выберите **Хранилище** и щелкните **Сведения о хранилище**. Выберите учетную запись хранения Azure, в которой будут храниться журналы, и укажите срок хранения. Затем нажмите кнопку **ОК**. Журналы старше, чем срок хранения, удаляются.
   ...
   ![Учетная запись хранилища](./media/sql-database-auditing-get-started/auditing_select_storage.png)
