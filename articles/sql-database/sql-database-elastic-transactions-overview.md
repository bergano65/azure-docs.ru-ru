...
* **New-азсклсерверкоммуникатионлинк**: Используйте этот командлет для создания нового отношения взаимодействия между двумя серверами базы данных SQL в базе данных SQL Azure. Отношение симметрично, то есть оба сервера могут инициировать транзакции с другим сервером.
