...
* **New-AzureRmSqlServerCommunicationLink**. Служит для создания отношения взаимодействия между двумя логическими серверами в базе данных SQL Azure. Отношение симметрично, то есть оба сервера могут инициировать транзакции с другим сервером.
