---
title: Начало работы с временными столами
...
ms.locfileid: "73820724"
---
# <a name="getting-started-with-temporal-tables-in-azure-sql-database"></a>Приступая к работе с темпоральными таблицами в базе данных Azure SQL
...
Для того, чтобы использовать автоматическое отслеживание изменений для данного конкретного сценария, давайте просто обновим столбец **PagesVisited** каждый раз, когда пользователь заканчивает свою сессию на веб-сайте:
