...
description: Общие сведения о прозрачном шифровании данных для базы данных SQL и SQL Analytics в Azure синапсе. В этом документе описаны преимущества и параметры конфигурации прозрачного шифрования, включая управляемое службой прозрачное шифрование данных и создание собственных ключей.
...
Дополнительные сведения о прозрачном шифровании данных с Azure Key Vaultной интеграцией (создание собственных ключей support) для базы данных SQL Azure, Управляемый экземпляр SQL и Azure синапсе см. в статье [прозрачное шифрование данных с помощью интеграции с Azure Key Vault](transparent-data-encryption-byok-azure-sql.md).
...
Управление прозрачным шифрованием данных с помощью Transact-SQL.

Подключитесь к базе данных, указав имя входа администратора или члена роли **dbmanager** в базе данных master.

| Команда | Описание |
| --- | --- |
| [ALTER DATABASE (база данных Azure SQL)](https://docs.microsoft.com/sql/t-sql/statements/alter-database-azure-sql-database) | SET ENCRYPTION ON/OFF — шифрование или расшифровка базы данных |
...
- Дополнительные сведения о прозрачном шифровании данных с поддержкой создание собственных ключей для базы данных SQL Azure, Управляемый экземпляр SQL Azure и Azure синапсе см. в статье [прозрачное шифрование данных с поддержкой создание собственных ключей](transparent-data-encryption-byok-azure-sql.md).
