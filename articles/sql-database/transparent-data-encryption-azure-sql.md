...
Дополнительные сведения о TDE с поддержкой создания собственных ключей для Базы данных SQL Azure, Управляемого экземпляра Базы данных SQL и хранилища данных можно найти в [этой статье](transparent-data-encryption-byok-azure-sql.md).
