...
TDE необходимо вручную включили для старых баз данных базы данных Azure S'L, Управляемых экземпляров Azure S'L или Azure Synapse.
