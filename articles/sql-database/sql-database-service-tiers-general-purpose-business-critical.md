---
title: Общее назначение и критически важный для бизнеса
...
- На уровне службы "критически важный для `tempdb` бизнеса" использует подключенный SSD с файлами MDF и LDF, а `tempdb` стоимость хранилища включается в цену Виртуальное ядро.
