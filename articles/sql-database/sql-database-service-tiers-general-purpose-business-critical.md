...
- На уровне "критически важный для бизнеса" `tempdb` совместно используют подключенный SSD с файлами MDF и LDF, а стоимость хранилища `tempdb` включается в цену Виртуальное ядро.
