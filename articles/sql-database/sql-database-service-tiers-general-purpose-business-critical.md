...
- Выбрать можно любой размер отдельной базы данных: от 10 ГБ до максимально допустимого значения.
  ...
  - Для хранения в хранилище уровня службы "Премиум" или "Критически важный для бизнеса" можно увеличить или уменьшить размер с шагом приращения в 250 ГБ.
