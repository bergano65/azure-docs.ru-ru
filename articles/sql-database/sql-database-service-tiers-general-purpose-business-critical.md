...
> [!NOTE]
> Дополнительные сведения об уровне служб "Гипермасштабирование" см. в статье [Уровень служб "Гипермасштабирование" размером до 100 ТБ (предварительная версия)](sql-database-service-tier-hyperscale.md). Сравнение моделей приобретения на основе виртуальных ядер и единиц DTU см. в статье [Ресурсы и модели приобретения для базы данных SQL Azure](sql-database-purchase-models.md).
