...
description: Сведения о настройке приложений и баз данных для повышения производительности в базе данных SQL Azure.
...
---
# <a name="tune-applications-and-databases-for-performance-in-azure-sql-database"></a>Настройка приложений и баз данных для повышения производительности в базе данных SQL Azure
...
Перед выпуском уровня службы " [Горизонтальный](sql-database-service-tier-hyperscale.md) " в базе данных SQL Azure клиенты использовали для ограничения емкости отдельных баз данных. Эти ограничения емкости по-прежнему существуют для баз данных в составе пула в эластичных пулах и экземпляре базы данных в управляемых экземплярах. В следующих двух разделах обсуждаются два варианта решения проблем с очень большими базами данных в службе SQL Azure, если не удается использовать уровень службы "масштабирование".
