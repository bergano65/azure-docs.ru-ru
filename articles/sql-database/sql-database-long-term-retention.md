...
> [!IMPORTANT]
> База данных SQL Azure управляет временем отдельных резервных копий LTR. Нельзя вручную создать резервную копию LTR или управлять временем создания резервной копии. После настройки политики LTR, может занять до 7 дней перед первой резервной копии LTR будут отображаться в списке доступных резервных копий.  
> 
