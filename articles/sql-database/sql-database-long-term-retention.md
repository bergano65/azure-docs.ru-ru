...
Если изменить приведенную выше политику и W = 0 (Отмена еженедельных резервных копий), периодичность набор резервных копий изменятся, как показано в приведенной выше таблице на указанные сроки. Размеры хранилища, необходимые для хранения этих резервных копий, сократятся соответственно. 
