---
title: Менеджер восстановления для устранения проблем с осколками карты
...
Класс [RecoveryManager](https://docs.microsoft.com/dotnet/api/microsoft.azure.sqldatabase.elasticscale.shardmanagement.recovery.recoverymanager) предоставляет ADO.NET приложениям возможность легко обнаруживать и исправлять любые несоответствия между глобальной картой осколков (GSM) и локальной картой осколков (LSM) в осколке базы данных.
...
* [Обзор: Непрерывность облачного бизнеса и аварийное восстановление базы данных с помощью базы данных S'L](sql-database-business-continuity.md)
* [Начало работы с эластичными инструментами базы данных](sql-database-elastic-scale-get-started.md)  
...
* Параметр *shardMapName* — это имя карты осколка. Он необходим, только если один и тот же диспетчер сопоставления сегментов управляет несколькими сопоставлениями сегментов. Необязательный параметр.
