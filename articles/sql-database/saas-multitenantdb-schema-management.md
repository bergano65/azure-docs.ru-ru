...
1. В **интегрированной среде сценариев PowerShell**откройте *... Learning modules\\Schema\\Management Demo-SchemaManagement. ps1. \\*
...
- **При\_добавлении\_задания SP** создается задание, именуемое *развертыванием эталонных данных*.
...
* **При\_создании\_задания SP Add** создается новое задание с именем *Online reindex\_\_PK VenueTyp\_\_265E44FD7FD4C885*.
...
Затем ознакомьтесь с [руководством по автоматизированной системе отчетности](saas-multitenantdb-adhoc-reporting.md) , чтобы исследовать выполнение распределенных запросов между базами данных клиентов.
