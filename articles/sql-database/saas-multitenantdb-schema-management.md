...
1. Чтобы убедиться, что в настоящее время **не** включены *Motorcycle* и *Swimming клуб* , перейдите к базе данных *contosoconcerthall* на сервере *tenants1-DPT-&lt;пользователя&gt;* и запросите таблицу *VenueTypes* .
