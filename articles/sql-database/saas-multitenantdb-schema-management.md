...
> [!NOTE]
> В этом руководстве используются функции службы Базы данных SQL Azure в ограниченной предварительной версии ([Задания обработки эластичных баз данных](sql-database-elastic-database-client-library.md)). Если вы хотите сделать этот учебник, предоставьте свой идентификатор подписки *\@saaSFeedback microsoft.com* с предметом-эластичной пробы Предварительный просмотр. Получив подтверждение о включении подписки, [скачайте и установите предварительную версию командлетов заданий](https://github.com/jaredmoo/azure-powershell/releases). Этот предварительный просмотр ограничен, поэтому свяжитесь с *\@SaaSFeedback microsoft.com* для связанных вопросов или поддержки.
...
1. В **PowerShell ISE**, открыть *... Учебные\\модули\\Schema Management Demo-SchemaManagement.ps1 . \\*
...
6. В SSMS, откройте файл *... Учебные\\модули\\Схема управления РазвертываниеReferenceData.sql . \\*
...
- **sp\_\_добавить задание** создает задание под названием *Ссылка развертывания данных*.
...
2. В SSMS, открыть *... Учебные\\модули\\Schema Management OnlineReindex.sql . \\*
...
* **sp\_\_добавить работу** создает новую работу под названием *Онлайн Reindex PK\_\_VenueTyp\_\_265E44FD7FD4C885*.

* **sp\_\_добавить jobstep** создает шаг работы, содержащий текст команды T-S'L для обновления индекса.
...
Затем попробуйте [специальный учебник по отчетности](saas-multitenantdb-adhoc-reporting.md) для изучения запущенных распределенных запросов в базах данных арендаторов.
