...
3. Нажмите кнопку **создать правило генерации оповещений** , чтобы открыть страницу **Создание правила** .
  ](media/sql-database-insights-alerts-portal/create-rule.png) ![создания правила

4. В разделе **условие** нажмите кнопку **Добавить**.
  ![определить условие](media/sql-database-insights-alerts-portal/create-rule.png)
5. На странице **Настройка логики сигнала** выберите сигнал.
  ![выберите](media/sql-database-insights-alerts-portal/select-signal.png)сигнала.
6. После выбора сигнала, такого как **процент загрузки ЦП**, появляется страница **Настройка логики сигнала** .
  ![настроить логику сигнала](media/sql-database-insights-alerts-portal/configure-signal-logic.png)
