...
||Стандартная|Стандартный|"Премиум"|
| :-- | --: |--:| --:|
...
|Хранение архивных копий|7 дней|35 дней|35 дней|
...
| Оператор delete |УДАЛЕНИЕ; сочетание в памяти и не в памяти; чтение и запись |
