...
> [!IMPORTANT]
> Базы данных с избыточностью зоны и эластичные пулы в настоящий момент поддерживается только на уровнях служб "премиум" и критически важный для бизнеса в избранных регионах. При использовании уровня "критически важный для бизнеса", избыточных конфигурации зоны доступна только при выборе оборудования вычислений 5-го поколения. Актуальные сведения об областях, которые поддерживают зоны избыточных баз данных см. в разделе [службы поддержки по регионам](../availability-zones/az-overview.md#services-support-by-region).  
