...
[Уровень вычислений "бессерверный](sql-database-serverless.md) " находится на этапе предварительной версии.
...
|Максимальное число операций ввода-вывода в секунду (64 КБ)|5000|10 000|15000|20 000|25000|30 000|
...
## <a name="hyperscale-service-tier-for-provisioned-compute"></a>Масштабируемый уровень службы для подготовленных вычислений
...
**Примечание 1**. Масштабирование — многоуровневая архитектура с отдельными компонентами вычислений и хранения: [Архитектура уровня службы "масштабирование"](sql-database-service-tier-hyperscale.md#distributed-functions-architecture)

**Примечание 2**. Многоязычная многоуровневая архитектура имеет кэширование на нескольких уровнях. Действующие операции ввода-вывода будут зависеть от рабочей нагрузки.

**Примечание 3**. Задержка составляет 1-2 мс для данных в кэше на основе SSD RBPEX на репликах вычислений, которые кэшируют большинство используемых страниц данных. Большая задержка для данных, полученных с серверов страниц.
