...
\*Как правило, каждые 100 DTU на уровне Standard требуется по крайней мере 1 Виртуальное ядро, а для каждых 125 DTU на уровне Premium требуется по крайней мере 1 Виртуальное ядро. Дополнительные сведения см. в разделе [Модель покупки на основе числа виртуальных ядер](https://docs.microsoft.com/azure/sql-database/sql-database-purchase-models#vcore-based-purchasing-model).
