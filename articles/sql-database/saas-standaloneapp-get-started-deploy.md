...
Исходный код приложения и скрипты управления доступны в репозитории GitHub [WingtipTicketsSaaS-StandaloneApp](https://github.com/Microsoft/WingtipTicketsSaaS-StandaloneApp). Приложение было создано с помощью Visual Studio 2015 и не успешно открыть и компиляции в Visual Studio 2019 без обновления.
...
Постепенно будут выпускаться дополнительные руководства. Они будут позволяют исследовать ряд сценариев управления, основанных на этой модели приложения.   
...
Далее ознакомьтесь [Provision and Catalog](saas-standaloneapp-provision-and-catalog.md) учебник, в котором рассматривается использование каталогов клиентов, который включает широкий набор сценариев между клиентами, таких как схемы управления и аналитику клиентов.
