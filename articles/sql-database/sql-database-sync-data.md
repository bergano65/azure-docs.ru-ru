...
- **Глобально распределенные приложения.** Многие организации охватывают несколько регионов и даже несколько стран и регионов. Чтобы свести к минимуму задержки в сети, рекомендуется хранить свои данные в регионе, ближайшем к вам. Используя синхронизацию данных, можно легко обеспечить синхронизацию баз данных в регионах по всему миру.
...
- Столбцы с помощью определяемых пользователем типов данных не поддерживаются
