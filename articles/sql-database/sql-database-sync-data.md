...
- **Гибридная синхронизация данных:** С помощью синхронизации данных можно синхронизировать данные между локальными базами данных и базами данных SQL Azure, чтобы обеспечить гибридные приложения. Эта возможность может привлечь клиентов, которые рассматривают переход в облако и собираются поместить некоторые из своих приложений в Azure.
...
| Недостатки | — Задержка 5 мин или дольше<br/>— Отсутствует согласованность транзакций<br/>— Большее влияние на производительность | -Не удается опубликовать из отдельной базы данных SQL Azure или базы данных в составе пула<br/>— Дорогое обслуживание |
