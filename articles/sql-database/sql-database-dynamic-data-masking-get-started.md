...
description: Динамическое маскирование данных ограничивает раскрытие конфиденциальных данных путем маскирования пользователей, не имеющих прав привилегированных, для базы данных SQL и Azure синапсе
...
Настройка политики динамического маскирования данных на портале Azure осуществляется посредством выбора операции "Динамическое маскирование данных" в колонке конфигурации или параметров базы данных SQL. Этот компонент нельзя задать с помощью портала для Azure синапсе (используйте PowerShell или REST API).
