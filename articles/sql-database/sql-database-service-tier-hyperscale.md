...
- **Служба хранилища**:
  ...
  Указывать максимальный объем данных при настройке базы данных ценовой категории "Гипермасштабирование" не нужно. На уровне "Гипермасштабирование" счета за использование хранилища для базы данных выставляются в зависимости от фактического распределения. Размер хранилища автоматически выделяется между 40 ГБ и 100 ТБ, с приращениями, которые динамически корректируются между 10 ГБ и 40 ГБ. База данных с масштабированием создается с начальным размером 10 ГБ и начинает расти на 10 ГБ каждые 10 минут, пока не достигнет размера 40 ГБ.
