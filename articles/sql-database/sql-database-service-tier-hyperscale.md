...
6. Щелкните **Далее: Solutions @ no__t-0
...
| Отслеживание изменений | Вы не сможете использовать Отслеживание изменений с базами данных с масштабированием. |
