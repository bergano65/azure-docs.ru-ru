---
title: Запрос к облачным базам данных с различной схемой
...
* **Ссылка на удаленную базу данных**: язык DDL внешней таблицы ссылается на внешний источник данных. Внешний источник данных указывает имя сервера База данных SQL и имя удаленной базы данных, в которой фактически хранятся данные из таблицы. 
