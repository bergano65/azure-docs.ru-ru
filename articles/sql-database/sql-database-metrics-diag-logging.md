...
- **[Центры событий Azure](#stream-into-event-hubs)** :
...
> [!NOTE]
> Чтобы включить потоковую передачу журнала аудита для телеметрии безопасности, см. статью [Настройка аудита для базы данных](sql-database-auditing.md#subheading-2) и [журналы аудита в Azure Monitor журналов и концентраторах событий Azure](https://techcommunity.microsoft.com/t5/Azure-SQL-Database/SQL-Audit-logs-in-Azure-Log-Analytics-and-Azure-Event-Hubs/ba-p/386242).
