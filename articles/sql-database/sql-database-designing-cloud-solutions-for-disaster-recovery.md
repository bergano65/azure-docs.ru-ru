---
title: Проектирование глобально доступных услуг
...
В конце дня, например, в 23:00 по местному времени активные базы данных должны быть переключены на следующий регион (Северная Европа). Эта задача может быть полностью автоматизирована с помощью [приложений Azure Logic Apps.](../logic-apps/logic-apps-overview.md) Эта задача предусматривает указанные ниже действия.
...
* Чтобы узнать о группах автоматического отказа, [см.](sql-database-auto-failover-group.md)
* Для получения информации об активной георепликации с эластичными пулами [см.](sql-database-disaster-recovery-strategies-for-applications-with-elastic-pool.md)
