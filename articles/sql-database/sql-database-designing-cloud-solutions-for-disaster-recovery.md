...
* Дополнительные сведения о группах автоматической отработки отказа см. в статье [группы автоматической отработки](sql-database-auto-failover-group.md)отказа.
* Сведения об активной георепликации с пулами эластичных баз данных см. в статье [стратегии аварийного восстановления эластичного пула](sql-database-disaster-recovery-strategies-for-applications-with-elastic-pool.md).
