...
1. ADO.NET 4.5 (или более поздней версии) инициирует краткое взаимодействие с облаком Azure и получает динамически указанный номер порта.
   ...
   * Динамически идентифицированный номер порта находится в диапазоне 11000-11999.
...
Убедитесь, что диапазоны портов 11000-11999 на вашем клиентском компьютере Azure остаются доступными для ADO.NET 4,5 взаимодействия с клиентами с базой данных S'L.
