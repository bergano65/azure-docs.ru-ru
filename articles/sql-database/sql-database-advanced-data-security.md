...
- [& Классификация обнаружения данных](sql-database-data-discovery-and-classification.md) предоставляет возможности, встроенные в базу данных SQL Azure для обнаружения, классификации и маркировки & защиты конфиденциальных данных в базах данных. Она может использоваться для просмотра состояния классификации базы данных, а также отслеживания доступа к конфиденциальным данным в базе данных и за ее пределами.
