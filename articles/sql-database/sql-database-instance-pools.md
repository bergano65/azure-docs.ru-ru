---
title: Пулы экземпляров базы данных SQL Azure (Предварительная версия) | Документация Майкрософт
...
Существует несколько ограничений ресурсов, касающихся пулов экземпляров и экземпляров в пулах:
...
Для цены на вычисления (измеряется в виртуальных ядер) доступны два варианта ценообразования:
  ...
  1. *Лицензия включена*: Примените существующие лицензии SQL Server с помощью программы Software Assurance.
  2. *Преимущество гибридного использования Azure*. Сниженная цена, включающая Преимущество гибридного использования Azure для SQL Server. Клиенты могут принять участие в этой цене, используя существующие лицензии на SQL Server с Software Assurance. Сведения о допустимости и других деталях см. в разделе [преимущество гибридного использования Azure](https://azure.microsoft.com/pricing/hybrid-benefit/).
