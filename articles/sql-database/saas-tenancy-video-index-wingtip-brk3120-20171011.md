---
title: Видео приложения SaaS S'L
...
- [1. **(Начало)** Добро пожаловать слайд, 0:00:03](#anchor-image-wtip-min00001)
- [2. Цели сессии, 0:03:11](#anchor-image-wtip-min00311)
- [3. Повестка дня, 0:04:17](#anchor-image-wtip-min00417)
- [4. Мультитенант веб-приложение, 0:05:05](#anchor-image-wtip-min00505)
- [5. Веб-форма приложения в действии, 0:05:55](#anchor-image-wtip-min00555)
- [6. Стоимость одного арендатора (масштаб, изоляция, восстановление), 0:09:31](#anchor-image-wtip-min00931)
- [7. Модели баз данных для мультитенантов: плюсы и минусы, 0:11:59](#anchor-image-wtip-min01159)
- [8. Гибридная модель сочетает в себе преимущества MT/ST, 0:13:01](#anchor-image-wtip-min01301)
- [9. Один-арендатор против мультитенанта: плюсы и минусы, 0:16:44](#anchor-image-wtip-min01644)
- [10. Бассейны рентабельны для непредсказуемых нагрузок, 0:19:36](#anchor-image-wtip-min01936)
- [11. Демо базы данных за арендатора и гибридных ST / MT, 0:20:08](#anchor-image-wtip-min02008)
- [12. Live приложение форме с указанием Додзе, 0:20:29](#anchor-image-wtip-min02029)
- [13. MYOB и не DBA в поле зрения, 0:28:54](#anchor-image-wtip-min02854)
- [14. пример использования упругого бассейна MYOB, 0:29:40](#anchor-image-wtip-min02940)
- [15. Обучение у MYOB и других ISVs, 0:31:36](#anchor-image-wtip-min03136)
- [16. Шаблоны, сопоставляются в сценарии E2E SaaS, 0:43:15](#anchor-image-wtip-min04315)
- [17. Канонические гибридные мультитенантные SaaS приложение, 0:47:33](#anchor-image-wtip-min04733)
- [18. Wingtip SaaS образец приложения, 0:48:10](#anchor-image-wtip-min04810)
- [19. Сценарии и закономерности, исследованные в учебниках, 0:49:10](#anchor-image-wtip-min04910)
- [20. Демо учебников и gitHub репозиторий, 0:50:18](#anchor-image-wtip-min05018)
- [21. GitHub репо Microsoft / WingtipSaaS, 0:50:38](#anchor-image-wtip-min05038)
- [22. Изучение моделей, 0:56:20](#anchor-image-wtip-min05620)
- [23. Обеспечение арендаторов и посадка, 0:57:44](#anchor-image-wtip-min05744)
- [24. Предоставление арендаторам и подключение к заявке, 0:58:58](#anchor-image-wtip-min05858)
- [25. Демо-скрипты управления подготовки одного арендатора, 0:59:43](#anchor-image-wtip-min05943)
- [26. PowerShell к обеспечению и каталогу, 1:00:02](#anchor-image-wtip-min10002)
- [27. T-S'L SELECT - от арендаторовРасширенный, 1:03:30](#anchor-image-wtip-min10330)
- [28. Управление непредсказуемыми рабочими нагрузками арендатора, 1:04:36](#anchor-image-wtip-min10436)
- [29. Упругий мониторинг бассейна, 1:06:39](#anchor-image-wtip-min10639)
- [30. Мониторинг генерации и производительности, 1:09:42](#anchor-image-wtip-min10942)
- [31. Схема управления в масштабе, 1:10:33](#anchor-image-wtip-min11033)
- [32. Распределенный запрос по базам данных арендаторов, 1:12:21](#anchor-image-wtip-min11221)
- [33. Демо поколения билетов, 1:12:32](#anchor-image-wtip-min11232)
- [34. SSMS adhoc analytics, 1:12:46](#anchor-image-wtip-min11246)
- [35. Извлеките данные о арендаторах в S'L DW, 1:16:32](#anchor-image-wtip-min11632)
- [36. График ежедневного распределения продаж, 1:16:48](#anchor-image-wtip-min11648)
- [37. Оберните и призыв к действию, 1:19:52](#anchor-image-wtip-min11952)
- [38. Ресурсы для получения дополнительной информации, 1:20:42](#anchor-image-wtip-min12042)
...
#### <a name="1-start-welcome-slide-00001"></a>1. *(Начало)* Добро пожаловать слайд, 0:00:01

*Обучение от MYOB. Конструктивные шаблоны для приложений SaaS в Базе данных SQL Azure — BRK3120*

[![Приветственный слайд][image-wtip-min00003-brk3120-whole-welcome]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1)
...
#### <a name="2-session-objectives-00153"></a>2. Цели сессии, 0:01:53
...
#### <a name="3-agenda-00409"></a>3. Повестка дня, 0:04:09
[![Программа][image-wtip-min00417-agenda]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=249)


&nbsp; <a name="anchor-image-wtip-min00505"/>
#### <a name="4-multi-tenant-web-app-00500"></a>4. Мультитенант веб-приложение, 0:05:00
...
#### <a name="6-per-tenant-cost-scale-isolation-recovery-00658"></a>6. Стоимость одного арендатора (масштаб, изоляция, восстановление), 0:06:58
...
#### <a name="7-database-models-for-multi-tenant-pros-and-cons-00952"></a>7. Модели баз данных для мультиарендаторов: плюсы и минусы, 0:09:52
[![Модели баз данных для мультитенантов: плюсы и минусы][image-wtip-min01159-db-models-pros-cons]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=592)
...
[![Гибридная модель сочетает в себе преимущества MT/ST][image-wtip-min01301-hybrid]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=749)


&nbsp; <a name="anchor-image-wtip-min01644"/>
#### <a name="9-single-tenant-vs-multi-tenant-pros-and-cons-01311"></a>9. Один-арендатор против мультитенанта: плюсы и минусы, 0:13:11
...
#### <a name="10-pools-are-cost-effective-for-unpredictable-workloads-01749"></a>10. Бассейны рентабельны для непредсказуемых нагрузок, 0:17:49
...
#### <a name="11-demo-of-database-per-tenant-and-hybrid-stmt-01959"></a>11. Демо базы данных за арендатора и гибридных ST / MT, 0:19:59
[![Демонстрация базы данных за арендатора и гибридная ST/MT][image-wtip-min02008-demo-st-hybrid]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1199)


&nbsp; <a name="anchor-image-wtip-min02029"/>
#### <a name="12-live-app-form-showing-dojo-02010"></a>12. Live приложение форме с указанием Додзе, 0:20:10
[![Форма приложения Live, показывающая Додзе][image-wtip-min02029-live-app-form-dojo]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1210)

&nbsp; <a name="anchor-image-wtip-min02854"/>
#### <a name="13-myob-and-not-a-dba-in-sight-02506"></a>13. MYOB и не DBA в поле зрения, 0:25:06
[![MYOB, а не DBA в поле зрения][image-wtip-min02854-myob-no-dba]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1506)


&nbsp; <a name="anchor-image-wtip-min02940"/>
#### <a name="14-myob-elastic-pool-usage-example-02930"></a>14. пример использования упругого бассейна MYOB, 0:29:30
[![Пример использования упругого бассейна MYOB][image-wtip-min02940-myob-elastic]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=1770)


&nbsp; <a name="anchor-image-wtip-min03136"/>
#### <a name="15-learning-from-myob-and-other-isvs-03125"></a>15. Обучение у MYOB и других ISVs, 0:31:25
...
#### <a name="16-patterns-compose-into-e2e-saas-scenario-03142"></a>16. Шаблоны, сопоставляются в сценарии E2E SaaS, 0:31:42
...
#### <a name="17-canonical-hybrid-multi-tenant-saas-app-04604"></a>17. Канонические гибридные мультитенантные SaaS приложение, 0:46:04
...
#### <a name="18-wingtip-saas-sample-app-04801"></a>18. Wingtip SaaS образец приложения, 0:48:01
...
#### <a name="19-scenarios-and-patterns-explored-in-the-tutorials-04900"></a>19. Сценарии и закономерности, исследованные в учебниках, 0:49:00
[![Сценарии и шаблоны, исследованные в учебниках][image-wtip-min04910-scenarios-tutorials]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=2940)


&nbsp; <a name="anchor-image-wtip-min05018"/>
#### <a name="20-demo-of-tutorials-and-github-repository-05012"></a>20. Демо учебников и gitHub репозиторий, 0:50:12
...
#### <a name="21-github-repo-microsoftwingtipsaas-05032"></a>21. GitHub репо Microsoft / WingtipSaaS, 0:50:32
...
#### <a name="22-exploring-the-patterns-05615"></a>22. Изучение моделей, 0:56:15
[![Изучение закономерностей][image-wtip-min05620-exploring-patterns]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3375)


&nbsp; <a name="anchor-image-wtip-min05744"/>
#### <a name="23-provisioning-tenants-and-onboarding-05619"></a>23. Обеспечение арендаторов и посадка, 0:56:19
[![Обеспечение арендаторов и посадка на борт][image-wtip-min05744-provisioning-tenants-onboarding-1]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3379)


&nbsp; <a name="anchor-image-wtip-min05858"/>
#### <a name="24-provisioning-tenants-and-application-connection-05752"></a>24. Предоставление арендаторам и подключение к заявке, 0:57:52
[![Предоставление арендаторам и подключение к приложениям][image-wtip-min05858-provisioning-tenants-app-connection-2]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3472)


&nbsp; <a name="anchor-image-wtip-min05943"/>
#### <a name="25-demo-of-management-scripts-provisioning-a-single-tenant-05936"></a>25. Демо-скрипты управления подготовки одного арендатора, 0:59:36
[![Демонстрация сценариев управления, подготовка одного арендатора][image-wtip-min05943-demo-management-scripts-st]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3576)


&nbsp; <a name="anchor-image-wtip-min10002"/>
#### <a name="26-powershell-to-provision-and-catalog-05956"></a>26. PowerShell к обеспечению и каталогу, 0:59:56
[![PowerShell для обеспечения и каталога][image-wtip-min10002-powershell-provision-catalog]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=3596)


&nbsp; <a name="anchor-image-wtip-min10330"/>
#### <a name="27-t-sql-select--from-tenantsextended-10325"></a>27. T-S'L SELECT - от арендаторовРасширенный, 1:03:25
...
#### <a name="28-managing-unpredictable-tenant-workloads-10334"></a>28. Управление непредсказуемыми рабочими нагрузками арендатора, 1:03:34
...
#### <a name="29-elastic-pool-monitoring-10632"></a>29. Контроль упругого бассейна, 1:06:32
...
#### <a name="30-load-generation-and-performance-monitoring-10937"></a>30. Мониторинг генерации и производительности, 1:09:37
[![Генерация нагрузки и мониторинг производительности][image-wtip-min10942-load-generation]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4117)


&nbsp; <a name="anchor-image-wtip-min11033"/>
#### <a name="31-schema-management-at-scale-10940"></a>31. Схема управления в масштабе, 1:09:40
...
#### <a name="32-distributed-query-across-tenant-databases-11118"></a>32. Распределенный запрос по базам данных арендаторов, 1:11:18
[![Распределенный запрос по базам данных арендаторов][image-wtip-min11221-distributed-query]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4278)


&nbsp; <a name="anchor-image-wtip-min11232"/>
#### <a name="33-demo-of-ticket-generation-11228"></a>33. Демо поколения билетов, 1:12:28
[![Демо поколения билетов][image-wtip-min11232-demo-ticket-generation]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4348)


&nbsp; <a name="anchor-image-wtip-min11246"/>
#### <a name="34-ssms-adhoc-analytics-11235"></a>34. SSMS adhoc analytics, 1:12:35
[![SSMS адхок аналитики][image-wtip-min11246-ssms-adhoc-analytics]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4355)


&nbsp; <a name="anchor-image-wtip-min11632"/>
#### <a name="35-extract-tenant-data-into-sql-dw-11546"></a>35. Извлеките данные о арендаторах в S'L DW, 1:15:46
[![Извлекайте данные о клиентах в S'L DW][image-wtip-min11632-extract-tenant-data-sql-dw]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4546)


&nbsp; <a name="anchor-image-wtip-min11648"/>
#### <a name="36-graph-of-daily-sale-distribution-11638"></a>36. График ежедневного распределения продаж, 1:16:38
[![График ежедневного распределения продаж][image-wtip-min11648-graph-daily-sale-distribution]](https://www.youtube.com/watch?v=jjNmcKBVjrc&t=4598)


&nbsp; <a name="anchor-image-wtip-min11952"/>
#### <a name="37-wrap-up-and-call-to-action-11743"></a>37. Оберните и призыв к действию, 1:17:43
...
#### <a name="38-resources-for-more-information-12035"></a>38. Ресурсы для получения дополнительной информации, 1:20:35
...
[image-wtip-min00417-agenda]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min00417-agenda-app-management-models-patterns.png "Повестки дня."
...
[image-wtip-min05018-demo-tutorials-github]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min05018-demo-saas-tutorials-github-repo.png "Демонстрация учебников и репо GitHub"
...
[image-wtip-min10639-elastic-pool-monitoring]: media/saas-tenancy-video-index-wingtip-brk3120-20171011/wingtip-20171011-min10639-elastic-pool-monitoring.png "Упругий мониторинг пула"
