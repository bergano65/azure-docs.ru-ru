...
> - Существующие серверы без параметров автоматической настройки будут автоматически настроены с новыми настройками Azure по умолчанию. Это относится ко всем клиентам, которые в настоящее время имеют автоматическую настройку в неопределенном состоянии.
> - Новые созданные серверы будут автоматически настроены с новыми настройками Azure по умолчанию (в отличие от предыдущих, если конфигурация автоматической настройки находилась в неопределенном состоянии после создания нового сервера).
>
