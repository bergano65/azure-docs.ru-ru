...
| 4\. | Создание нагрузки с более поздней версии единиц DTU при пиках на клиента (около 70 DTU)|
| 5 | Создание нагрузки высокой интенсивности (около 90 DTU) на одного клиента, а также нагрузки с обычной интенсивностью на все клиенты |
...
1. Задайте **$DemoScenario = 5**, _создания нормальной нагрузки, а также с высокой нагрузкой на отдельный клиент (около 90 DTU)._
