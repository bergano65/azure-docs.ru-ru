...
> [!IMPORTANT]
> Хранилище ценовой категории "Премиум" объемом свыше 1 ТБ сейчас доступно во всех регионах, кроме следующих: восточный Китай, северный Китай, центральная Германия, северо-восточная Германия, северная часть Соединенного Королевства, южная часть Соединенного Королевства, центральный регион US DoD, восточный регион US DoD, центральный регион US Government и центрально-западная часть США.  В этих регионах максимальный объем хранилища категории "Премиум" ограничен 1 ТБ. См. [текущие ограничения для баз данных P11–P15](#single-database-limitations-of-p11-and-p15-when-the-maximum-size-greater-than-1-tb).  
