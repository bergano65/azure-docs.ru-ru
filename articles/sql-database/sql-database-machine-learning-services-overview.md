...
>
> Общедоступная Предварительная версия доступна для отдельных баз данных и эластичных пулов, используя модель приобретения на основе виртуальных ядер в **общего назначения** и **критически важный для бизнеса** уровни служб. В этой начальной общедоступной предварительной версии не поддерживается уровень служб **гипермасштабирование** и параметр развертывания **управляемого экземпляра**. В настоящее время R — единственный поддерживаемый язык. В настоящее время Python не поддерживается.
>
