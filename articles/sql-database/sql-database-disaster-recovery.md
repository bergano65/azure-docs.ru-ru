...
> [!NOTE]
> База данных-источник и база данных-получатель должны иметь один и тот же уровень обслуживания. Также настоятельно рекомендуется, базы данных-получателя было создано с вычисления (Dtu или виртуальных ядер) от размеров первичной. Дополнительные сведения см. в разделе [низкого как базы данных-источника или обновление](sql-database-active-geo-replication.md#upgrading-or-downgrading-a-primary-database).
