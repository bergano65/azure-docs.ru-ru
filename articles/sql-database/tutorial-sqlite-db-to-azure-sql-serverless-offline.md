...
2. Убедитесь, что файл базы данных SQLite доступен в среде Windows. Установите драйвер SQLite ODBC, если у вас его еще нет (например, http://www.ch-werner.de/sqliteodbc/).
