...
2. Перейдите к разделу Создание**Databases** > **базы данных** **ресурсов** > SQL.
...
1. Перейдите к разделу **базы данных** > **Clinic** > SQL**Просмотр строк подключения к базе данных**.
...
1. Откройте SSMS. (Перейдите в раздел **Подключение** > **ядро СУБД** , чтобы открыть окно **Подключение к серверу** , если оно не открыто.)
