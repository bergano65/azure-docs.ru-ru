...
Можно быстро создать хранилище ключей, выполнив следующий сценарий. Подробное объяснение этих команд и более подробная информация о создании [What is Azure Key Vault?](../key-vault/general/overview.md)и настройке хранилища ключей см.
