...
В первой части этого руководства из трех частей вы узнаете, как подготовить данные из базы данных SQL Azure для выполнения кластеризации на языке R с помощью Служб машинного обучения в Базе данных SQL Azure (предварительная версия).
...
> * Разделение клиентов по разным измерениям.
> * Загрузка данных из базы данных SQL Azure в кадр данных с помощью языка R.

Из [второй части](sql-database-tutorial-clustering-model-build.md) вы узнаете, как создать и обучить модель кластеризации по методу K-средних.
