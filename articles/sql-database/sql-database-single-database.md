...
Можно построить свое первое приложение на небольшой одной базы данных по низкой стоимости в уровня вычислений без сервера (Предварительная версия) или размер мелкие вычислительные операции на уровне подготовленных вычислительных ресурсов. Изменить [уровень вычислений или службы](sql-database-single-database-scale.md) вручную или программным способом в любое время в соответствии с потребностями вашего решения. Вы можете настроить производительность без простоя для приложения и работы клиентов. Динамическая масштабируемость позволяет базе данных прозрачно реагировать на быстро меняющиеся требования к ресурсам. Кроме того, таким образом вы можете платить только за необходимые ресурсы, и только когда они вам нужны.
