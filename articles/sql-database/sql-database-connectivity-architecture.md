...
description: В этом документе описывается архитектура onnectivity Azcure SQL для подключения к базе данных из Azure или из за пределами Azure.
