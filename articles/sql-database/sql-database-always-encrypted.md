---
title: Всегда зашифровано - магазин сертификатов Windows
...
В этой статье показано, как обеспечить безопасность конфиденциальных данных в базе данных СЗЛ с шифрованием базы данных с помощью [всегда зашифрованного мастера](https://msdn.microsoft.com/library/mt459280.aspx) в [студии управления серверами S'L (SSMS).](https://msdn.microsoft.com/library/hh213248.aspx) В ней также показано, как сохранить ключи в хранилище сертификатов Windows.
...
* Используйте всегда зашифрованный мастер в SSMS для создания [всегда зашифрованных ключей.](https://msdn.microsoft.com/library/mt163865.aspx#Anchor_3)
  * Создайте [мастер-ключ колонки (CMK).](https://msdn.microsoft.com/library/mt146393.aspx)
  * Создайте [ключ шифрования колонки (CEK).](https://msdn.microsoft.com/library/mt146372.aspx)
...
2. Нажмите **На кнопку «Создание данных о ресурсах** > **и база данных хранения данных** > **S'L».**
...
1. Нажмите на **базы данных** > **S'L Клиника** > **Показать строки соединения базы данных**.
...
1. Откройте SSMS. (Нажмите**на движок базы данных** **Connect,** > чтобы открыть окно **Connect to Server,** если оно не открыто).
...
Вы можете проверить создание ключей в SSMS, перейдя в **клинику** > **безопасности** > **всегда зашифрованные ключи**. Таким образом можно увидеть новые ключи, созданные с помощью мастера.
...
2. Нажмите **Connect** > **Database Engine,** чтобы открыть окно **Connect to Server,** а затем нажмите **Параметры**.
...
* [Всегда зашифрованный блог](https://blogs.msdn.com/b/sqlsecurity/archive/tags/always-encrypted/)