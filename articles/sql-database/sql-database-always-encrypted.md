---
title: Always Encrypted. База данных SQL Azure в хранилище сертификатов Windows | Документация Майкрософт
...
Мастер настройки Always Encrypted содержит следующие разделы: **Выбор столбца**, **Настройка главного ключа** (CMK), **Проверка** и **Итоги**.
...
* [Блог по функции постоянного шифрования](https://blogs.msdn.com/b/sqlsecurity/archive/tags/always-encrypted/)
