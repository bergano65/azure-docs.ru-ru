...
Доступные уровни служб и ограничения для каждой модели ресурсов см. в разделе [модель приобретения на основе DTU](sql-database-service-tiers-dtu.md) или [модель приобретения на основе виртуальное ядро](sql-database-service-tiers-vcore.md).
...
> [!IMPORTANT]
> Если количество баз данных в пуле приближается к максимально поддерживаемому, обязательно рассмотрите возможность [управления ресурсами в сжатых пулах эластичных БД](sql-database-elastic-pool-resource-management.md).
> 
...
Чтобы начать отслеживать эластичный пул, найдите и откройте его на портале. Сначала вы увидите экран с обзором состояния эластичного пула. Сюда входит выполнение следующих задач.
