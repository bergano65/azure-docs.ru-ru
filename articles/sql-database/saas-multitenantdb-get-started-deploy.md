...
1. Открыть... \\Обучающие модули\\подготавливают и\\Catalog*Demo-ProvisionTenants. ps1* в *интегрированной среде сценариев PowerShell*.
...
1. В... \\Обучающие модули\\подготавливают и Catalog\\*Demo-ProvisionTenants. ps1*, измените *$TenantName* на **Salix Salsa**, *$VenueType* в **Dance** и *$Scenario* на **2**.
...
Теперь попробуйте [руководство по подготовке и каталогизации](sql-database-saas-tutorial-provision-and-catalog.md).
