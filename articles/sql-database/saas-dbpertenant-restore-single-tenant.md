...
* Разверните приложение SaaS Wingtip. Чтобы развернуть менее чем за пять минут, см [Развертывайте и исследуйте приложение Wingtip SaaS.](saas-dbpertenant-get-started-deploy.md)
...
1. Откройте концентратор&gt;событий (;пользовательhttp://events.wtp.&lt.trafficmanager.net), и выберите **концертный зал Contoso**.
...
1. В интегрированной среде сценариев PowerShell последовательно откройте …\\Learning Modules\\Business Continuity and Disaster Recovery\\RestoreTenant\\*Demo-RestoreTenant.ps1* и задайте следующее значение:
   ...
   * **$DemoScenario** = **1**, *Удалить последнее событие (без продажи билетов)*.
...
3. Установить **$DemoScenario** = **2**, *Восстановить арендатора параллельно*.
...
1. Установить **$DemoScenario** = **4**, *Удалить восстановленный арендатор*.
...
2. Установить **$DemoScenario** = **5**, *Восстановить арендатора на месте*.
