...
1. Укажите цель обслуживания. Цель службы предписывает уровень служб, поколение оборудования и максимальное виртуальных ядер. В таблице ниже приведены возможные варианты.
...
|Объект|Метрика|Описание|Единицы измерения|
|---|---|---|---|
