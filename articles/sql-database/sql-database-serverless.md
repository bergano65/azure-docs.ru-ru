...
#### <a name="cache-reclaiming"></a>Кэшировать освобождение
...
- Размер кэша никогда не уменьшается ниже минимального объема памяти, согласно минимальное виртуальных ядер, которые можно настроить.
