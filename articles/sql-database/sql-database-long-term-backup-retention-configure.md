---
title: 'Отдельная база данных: управление долгосрочным хранением резервных копий'
description: Сведения о хранении и восстановлении автоматически создаваемых резервных копий для одной базы данных SQL Azure или в составе пула в службе хранилища Azure (до 10 лет) с помощью портала Azure и PowerShell.
...
> [!IMPORTANT]
> Сведения об управляемом экземпляре базы данных SQL Azure см. в разделе [Поддержка LTR для управляемого экземпляра](sql-database-long-term-retention.md#managed-instance-support).
