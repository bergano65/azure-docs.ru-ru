...
---
# <a name="tutorial-configure-transactional-replication-between-two-managed-instances-and-sql-server"></a>Руководство по Настройка репликации транзакций между двумя управляемыми экземплярами и SQL Server
