---
title: Мониторинг синхронизация данных SQL Azure с помощью журналов Azure Monitor | Документация Майкрософт
description: Узнайте, как отслеживать синхронизация данных SQL Azure с помощью журналов Azure Monitor
...
10. Внесите необходимые изменения в учетной записи и конфигурации синхронизации данных SQL. (Дополнительные сведения см. в примере сценария.)
    ...
    3.  Azure Monitor сведения о журналах. Эти сведения можно найти на портале Azure, выбрав "Параметры | Подключенные источники". Дополнительные сведения об отправке данных в журналы Azure Monitor см. [в статье отправка данных в журналы Azure Monitor с помощью API сборщика данных HTTP (Предварительная версия)](../azure-monitor/platform/data-collector-api.md).
...
6.  В нижней части страницы нажмите кнопку **Save**. Теперь при возникновении ошибок заданные получатели будут получать уведомления по электронной почте.
