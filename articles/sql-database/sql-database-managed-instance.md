...
description: Здесь описывается расширенная защита данных в Базе данных SQL Azure и объясняется, как она работает и чем отличается от отдельной базы данных или базы данных в пуле в Базе данных SQL Azure.
...
- Для сложного мониторинга производительности управляемого экземпляра базы данных благодаря встроенным средствам аналитики по устранению неполадок, см. в разделе [мониторинг базы данных SQL Azure с помощью Azure SQL Analytics](../azure-monitor/insights/azure-sql.md).
