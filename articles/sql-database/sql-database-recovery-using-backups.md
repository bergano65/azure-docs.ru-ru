...
- Создание новой базы данных на любом логическом сервере в любом регионе, восстановленной до точки во времени последней резервной копии.
...
### <a name="recover-to-a-point-in-time-using-azure-portal"></a>Восстановление до точки во времени на портале Azure
...
### <a name="recover-a-deleted-database-using-the-azure-portal"></a>Восстановление удаленной базы данных на портале Azure
