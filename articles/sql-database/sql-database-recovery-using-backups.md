...
По умолчанию резервные копии базы данных SQL Azure хранятся в геореплицированном хранилище BLOB-объектов (тип хранилища RA-GRS). Для восстановления базы данных доступны следующие параметры с помощью автоматически создаваемых [резервных копий базы данных](sql-database-automated-backups.md). Вы сможете:
