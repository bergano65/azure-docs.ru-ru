...
Чтобы восстановить автономную базу данных, базу данных в составе пула или базу данных экземпляра до точки во времени с помощью портала Azure, откройте страницу для базы данных и щелкните **Восстановление** на панели инструментов.
...
- Для восстановления автономной базы данных или базы данных в составе пула см. описание командлета [Restore-AzureRmSqlDatabase](https://docs.microsoft.com/powershell/module/azurerm.sql/restore-azurermsqldatabase).
...
Восстановление автономной базы данных или базы данных в составе пула с помощью REST API.
...
Для восстановления автономной базы данных или базы данных в составе пула с помощью Azure CLI см. описание команды [az sql db restore](https://docs.microsoft.com/cli/azure/sql/db#az-sql-db-restore).
