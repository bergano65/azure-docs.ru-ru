...
---
# <a name="choose-a-cloud-sql-server-option-azure-sql-paas-database-or-sql-server-on-azure-vms-iaas"></a>Выбор компонента SQL Server в облаке: База данных SQL Azure (PaaS) или SQL Server на виртуальных машинах Azure (IaaS)
...
- [База данных SQL Azure](https://azure.microsoft.com/services/sql-database/). Ядро СУБД SQL на основе SQL Server Enterprise Edition, оптимизированное для разработки современных приложений. База данных SQL Azure предлагает несколько вариантов развертывания:
