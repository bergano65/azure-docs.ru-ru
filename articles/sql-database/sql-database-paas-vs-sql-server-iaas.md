...
- [Администрирование](#administration) — с PaaS вы тратите меньше времени на администрирование базы данных. Но при этом вы не можете выполнять некоторые пользовательские задачи администрирования, которые могут повысить производительность рабочей нагрузки.
