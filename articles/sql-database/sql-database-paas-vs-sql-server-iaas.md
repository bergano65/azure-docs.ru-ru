...
ms.locfileid: "59360821"
---
# <a name="choose-the-right-sql-server-option-in-azure"></a>Выбор правильного параметра SQL Server в Azure

В Azure вы можете запускать рабочие нагрузки SQL Server в размещенной инфраструктуре (IaaS) или в качестве размещенных служб ([PaaS](https://azure.microsoft.com/overview/what-is-paas/)). В PaaS у вас есть несколько параметров развертывания и уровней службы в каждом параметре развертывания. Главный вопрос, который следует задать при выборе между PaaS и IaaS, — вы хотите управлять базой данных, применять исправления и создавать резервные копии или вы хотите делегировать эти операции Azure?
...
| **Совокупной стоимости владения:** | Устраняет расходы на оборудование и уменьшает затраты на администрирование. | Аналогично Базе данных SQL для отдельных баз данных и баз данных в составе пула. | Сводит затраты на оборудование к нулю. |
...
**При использовании базы данных SQL Azure:**
...
- [Цена базы данных SQL](https://azure.microsoft.com/pricing/details/sql-database/)
