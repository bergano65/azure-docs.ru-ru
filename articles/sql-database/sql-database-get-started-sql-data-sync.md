...
---
# <a name="tutorial-set-up-sql-data-sync-between-azure-sql-database-and-sql-server-on-premises"></a>Руководство. Настройка синхронизация данных SQL между базой данных SQL Azure и SQL Server локальной средой
...
1. Перейдите в [портал Azure](https://portal.azure.com) , чтобы найти базу данных SQL. Выполните поиск по запросу **базы данных SQL** и выберите этот пункт.

    ![Поиск баз данных SQL, портал Microsoft Azure](media/sql-database-get-started-sql-data-sync/search-for-sql-databases.png)

1. Выберите базу данных, которую нужно использовать в качестве центральной базы данных для синхронизации данных.

    ![Выберите из списка баз данных SQL портал Microsoft Azure](media/sql-database-get-started-sql-data-sync/select-sql-database.png)
...
1. В меню **базы данных SQL** для выбранной базы данных выберите **синхронизировать с другими базами данных**.
    ...
    ![Синхронизация с другими базами данных, база данных SQL портал Microsoft Azure](media/sql-database-get-started-sql-data-sync/sync-to-other-databases.png)
...
- [Общие сведения о базе данных SQL](sql-database-technical-overview.md)
