...
2. [Настройка безопасности для разделения и объединения](sql-database-elastic-scale-split-merge-security-configuration.md)
...
7. [Глоссарий по инструментам эластичных баз данных](sql-database-elastic-scale-glossary.md)
