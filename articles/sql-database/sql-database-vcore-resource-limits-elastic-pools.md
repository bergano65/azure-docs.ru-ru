...
Эта статья содержит подробные сведения об ограничениях для эластичных пулов и баз данных в пулах в службе "База данных SQL Azure" в модели приобретения на основе виртуальных ядер.
...
|Максимальное число одновременных входов на пул (запросов) *|1680|1890|2100|2520|33 600|4200|8400|
...
|Целевое число операций ввода-вывода в секунду (64 КБ)|5000|10 000|15000|20 000|25000|30 000|35 000|
...
|Тип хранилища|Локальная память SSD|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|Локальная память SSD|
|Задержка ввода-вывода (приблизительно)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|
|Целевое число операций ввода-вывода в секунду (64 КБ)|40 000|45000|50 000|60000|80 000|100 000|200 000|
