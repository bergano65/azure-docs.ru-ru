...
* Эластичный запрос работает только с базой данных SQL Azure. Его нельзя использовать для выполнения запросов на локальном сервере SQL Server или SQL Server на виртуальной Машине.
