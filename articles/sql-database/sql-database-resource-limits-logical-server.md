...
description: Статья содержит обзор ограничений ресурсов для логического сервера Базы данных SQL Azure, касающихся отдельных баз данных и баз данных, объединенных с помощью эластичных пулов. Здесь также содержится информация о том, что происходит, когда эти ограничения ресурсов соответствуют или превышают допустимые нормы.
...
ms.locfileid: "51620904"
---
# <a name="sql-database-resource-limits-for-single-and-pooled-databases"></a>Ограничения ресурсов Базы данных SQL для отдельных баз данных и баз данных, объединенных в пулы
