...
- **Проблемы ввода-вывода**
  ...
  Запросы могут ожидать записи страниц в файлы данных или журналов. В этом случае проверьте статистику ожидания `INSTANCE_LOG_RATE_GOVERNOR`в `WRITE_LOG`динамическом `PAGEIOLATCH_*` административном элементе, или. См. раздел Использование динамических административных представлений для [обнаружения проблем производительности операций ввода-вывода](sql-database-monitoring-with-dmvs.md#identify-io-performance-issues).
- **Проблемы TempDB**
