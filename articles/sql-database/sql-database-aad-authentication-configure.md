---
title: Настройка проверки подлинности Azure Active Directory — SQL
...
| Отсутствует в представлении sys. server_principals | Содержится в представлении sys. server_principals |
...
| Имя командлета | Description (Описание) |
| --- | --- |
