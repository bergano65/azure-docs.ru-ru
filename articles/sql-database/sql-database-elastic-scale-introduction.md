...
Горизонтальное масштабирование означает добавление или удаление баз данных для регулировки емкости или общей производительности, также называемой «масштабированием». Сегментирование, в которым данные разделяются по набору идентично структурированных баз данных, является наиболее распространенным методом горизонтального масштабирования.  

Вертикальное масштабирование означает увеличение или уменьшение размера вычислений отдельной базы данных, также известной как «масштабирование».

В большей части баз данных облачных приложений для масштабирования используется сочетание этих двух стратегий. Например, приложение Software как приложение Службы может использовать горизонтальное масштабирование для предоставления новых конечных клиентов и вертикального масштабирования, чтобы позволить базе данных каждого конечного клиента увеличивать или сокращать ресурсы по мере необходимости в результате рабочей нагрузки.
...
*Сегментирование* — это методика распределения больших объемов данных с одинаковой структурой по множеству независимых баз данных. Она пользуется особенной популярностью среди разработчиков облачных технологий, создающих решения SaaS для пользователей или предприятий. Этих конечных клиентов часто называют «арендаторами». Сегментирование может потребоваться по ряду причин:  
