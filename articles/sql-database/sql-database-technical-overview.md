...
- [Гипермасштабный](sql-database-service-tier-hyperscale.md) уровень обслуживания, предназначенный для очень большой базы данных OLTP и возможности автоматического масштабирования хранения и плавного масштабирования.    
