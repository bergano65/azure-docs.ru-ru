...
- **[Группы отработки отказа](sql-database-geo-replication-overview.md)**
...
- [Отзывы:](https://aka.ms/sqlfeedback) информирование об ошибках и подача запросов
