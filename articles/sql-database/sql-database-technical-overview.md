...
- как отдельную базу данных с собственным набором ресурсов, управляемую с помощью сервера Базы данных SQL;
- как базу данных, которая находится в [эластичном пуле](sql-database-elastic-pool.md) с общим набором ресурсов, управляемых с помощью сервера Базы данных SQL;
