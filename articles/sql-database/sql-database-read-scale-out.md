...
Чтобы создать базу данных с отключенным горизонтальным масштабированием чтения или изменить параметр для существующей базы данных, используйте следующий метод со свойством `readScale`, имеющим значение `Enabled` или `Disabled`, как показано в примере запроса ниже.
