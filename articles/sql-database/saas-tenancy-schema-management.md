...
> * Обновление эталонных данных во всех клиентских базах данных.
...
1. Перейдите к базе данных *contosoconcerthall* на сервере *tenants1-dpt-* пользователь и запросите таблицу _VenueTypes_, чтобы убедиться, что места проведения *Motorcycle Racing&lt; (Мотоциклетные гонки) и &gt;Swimming Club* (Плавательный клуб) *отсутствуют*.
...
1. В среде SSMS откройте файл …\\Learning Modules\\Schema Management\\DeployReferenceData.sql.
