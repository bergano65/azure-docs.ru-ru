...
Стоит отметить пару различий между агентом SQL (доступным как локально, так и как часть Управляемого экземпляра Базы данных SQL) и агентом задания эластичной базы данных (доступным для отдельной Базы данных SQL и Хранилища данных SQL).
