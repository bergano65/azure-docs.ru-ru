---
title: Премиум RS сервисный уровень выхода на пенсию
...
|**Если вы в данный момент...**|**Перенос на основе виртуальных ядер для сравнимых...**|**Перенос на основе единиц передачи данных для сравнимых...**|
|---|---|---|
|Уровень "Премиум RS 1"| Гипермасштаб 1 vCore (Gen4) или Бизнес Критический 1 vCore (Gen4)|Уровень "Премиум 1"|
|Уровень "Премиум RS 2"| Гипермасштаб 2 vCores (Gen4) или Бизнес Критические 2 vCores (Gen4|Уровень "Премиум 2"|
|Уровень "Премиум RS 4"| Гипермасштаб 4 vCores (Gen4) или Бизнес Критические 4 vCores (Gen4)|Уровень "Премиум 4"
|Уровень "Премиум RS 6"| Гипермасштаб 6 vCores (Gen4) или Бизнес Критические 6 vCores (Gen4)|Уровень "Премиум 6"|
