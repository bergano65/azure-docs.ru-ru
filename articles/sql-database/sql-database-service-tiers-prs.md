...
|**Если вы в данный момент...**|**Перенос на основе виртуальных ядер для сравнимых...**|**Перенос на основе единиц передачи данных для сравнимых...**|
|---|---|---|
|Уровень "Премиум RS 1"|(Предварительная версия) уровень "Гипермасштабирование на основе 1 виртуального ядра (поколение 4)" или уровень "Критически важный для бизнеса на основе 1 виртуального ядра (поколение 4)"|Уровень "Премиум 1"|
|Уровень "Премиум RS 2"|(Предварительная версия) уровень "Гипермасштабирование на основе 2 виртуальных ядер (поколение 4)" или уровень "Критически важный для бизнеса на основе 2 виртуальных ядер (поколение 4)"|Уровень "Премиум 2"|
|Уровень "Премиум RS 4"|(Предварительная версия) уровень "Гипермасштабирование на основе 4 виртуальных ядер (поколение 4)" или уровень "Критически важный для бизнеса на основе 4 виртуальных ядер (поколение 4)"|Уровень "Премиум 4"
|Уровень "Премиум RS 6"|(Предварительная версия) уровень "Гипермасштабирование на основе 6 виртуальных ядер (поколение 4)" или уровень "Критически важный для бизнеса на основе 6 виртуальных ядер (поколение 4)"|Уровень "Премиум 6"|
