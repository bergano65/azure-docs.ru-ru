---
title: Прекращение использования уровня служб Azure База данных SQL Premium RS
...
- Уровни служб виртуальных ядер
  ...
  Уровни служб **Общее назначение** и **Критически важный для бизнеса** в [модели приобретения на основе виртуальных ядер](sql-database-service-tiers-vcore.md). Эти два уровня служб являются общедоступными. Модель приобретения на основе виртуальное ядро также предлагает уровень службы " **горизонтальное масштабирование** ", который адаптируется по запросу к потребностям вашей рабочей нагрузки с автоматическим масштабированием до 100 ТБ на базу данных. Уровень служб "Гипермасштабирование" обеспечивает производительность ввода-вывода, сопоставимую с уровнем обслуживания "Премиум" в [модели приобретения на основе единиц DTU](sql-database-service-tiers-dtu.md), по цене, более близкой к уровню обслуживания уровня "Премиум RS".
