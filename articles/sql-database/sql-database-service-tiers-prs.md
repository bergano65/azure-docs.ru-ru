...
|**Если вы сейчас включены...**|**Перенос на основе виртуальных ядер для сравнимых...**|**Перенос в сопоставимых, на основе единиц DTU...**|
|---|---|---|
...
|**Если вы сейчас включены...**|**Перенос на основе виртуальных ядер для сравнимых...**|**Перенос в сопоставимых, на основе единиц DTU...**|
|---|---|---|
|Уровень "Премиум RS 1"|(Предварительная версия) уровень "Гипермасштабируемый на основе 1 виртуального ядра (поколение 4)" или уровень "Критически важный для бизнеса на основе 1 виртуального ядра (поколение 4)"|Уровень "Премиум 1"|
|Уровень "Премиум RS 2"|(Предварительная версия) уровень "Гипермасштабируемый на основе 2 виртуальных ядер (поколение 4)" или уровень "Критически важный для бизнеса на основе 2 виртуальных ядер (поколение 4)"|Уровень "Премиум 2"|
|Уровень "Премиум RS 4"|(Предварительная версия) уровень "Гипермасштабируемый на основе 4 виртуальных ядер (поколение 4)" или уровень "Критически важный для бизнеса на основе 4 виртуальных ядер (поколение 4)"|Уровень "Премиум 4"
|Уровень "Премиум RS 6"|(Предварительная версия) уровень "Гипермасштабируемый на основе 6 виртуальных ядер (поколение 4)" или уровень "Критически важный для бизнеса на основе 6 виртуальных ядер (поколение 4)"|Уровень "Премиум 6"|
