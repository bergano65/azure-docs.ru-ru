...
### <a name="i-see-this-message-cannot-insert-the-value-null-into-the-column-column-column-does-not-allow-nulls-what-does-this-mean-and-how-can-i-fix-it"></a><a name="sync-nulls"></a>Я вижу следующее сообщение: "не удается вставить значение NULL в столбец столбца \<>. В столбце запрещены значения NULL". Что это означает, и как это можно исправить? 
...
- [Я не могу отменить регистрацию локальной базы данных SQL Server](#setup-unreg)
...
- **Решение**. Убедитесь, что базы данных SQL и базы данных SQL Server подключены к сети.
...
- **Решение**. Чтобы отменить регистрацию локальной базы данных SQL Server, выберите эту базу данных и щелкните **Принудительно удалить**.
