...
| [Токсичную химические данные — данные прогноза анализатора&trade;EPA ТоксиЦити (ToxCast)](https://www.epa.gov/chemical-research/toxicity-forecaster-toxcasttm-data) | "Самые актуальные общедоступные данные EPA с высокой пропускной способностью о токсичности тысяч химических веществ. Эти данные создаются в рамках научно-исследовательской работы EPA ToxCast". | Наборы данных доступны в различных форматах, включая электронные таблицы, пакеты R и файлы базы данных MySQL. |
