...
| [Общедоступные данные о геномах](https://www.completegenomics.com/public-data/) | "Разнообразный набор данных целых человеческих геномов свободно доступны для общественного пользования для повышения любого геномного исследования ..." Поставщик, Complete Genomics, является частной некоммерческой корпорацией. | После извлечения наборы данных будут доступны в текстовом формате UNIX. Доступны также средства анализа. |
