...
| [Общедоступные данные о геномах](https://www.completegenomics.com/public-data/) | "Широкий набор данных целого человека геномов свободно доступен для использования в целях улучшения любого геномныхного исследования..." Поставщик (Complete Genomics) является частным предприятием для получения прибыли. | После извлечения наборы данных будут доступны в текстовом формате UNIX. Доступны также средства анализа. |
