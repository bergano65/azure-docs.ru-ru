---
title: Общедоступные наборы данных для аналитики Azure
...
## <a name="us-government-and-agency-data"></a>Данные правительства и агентства США

| Источник данных | О данных | О файлах |
|---|---|---|
| [Данные US Gov ](https://catalog.data.gov/dataset) | Более 250 000 наборов данных, охватывающих сельское хозяйство, климат, потребителей, экосистемы, образование, энергетику, финансы, здравоохранение, местное самоуправление, производство, море, океан, общественную безопасность, а также науку и научные исследования в США. | Файлы различных размеров и форматов, включая HTML, XML, CSV, JSON, Excel и многие другие. Вы можете фильтровать доступные наборы данных по формату файла. |
...
| [Задержки рейсов авиакомпаний и другие данные о транспортировках](https://www.transtats.bts.gov/OT_Delay/OT_DelayCause1.asp) | "Бюро статистики транспорта Министерства транспорта США (DOT) отслеживает своевременное выполнение внутренних рейсов, выполняемых крупными авиаперевозчиками. Сводные данные о числе рейсов по графику, задержанных, отмененных и измененных рейсов отображаются в сводных таблицах, размещенных на этом веб-сайте". | Файлы доступны в формате CSV. |
...
| [Токсичные химические данные - EPA Токсичность ForeCaster (ToxCast&trade;) данные](https://www.epa.gov/chemical-research/toxicity-forecaster-toxcasttm-data) | "Самые актуальные общедоступные данные EPA с высокой пропускной способностью о токсичности тысяч химических веществ. Эти данные создаются в рамках научно-исследовательской работы EPA ToxCast". | Наборы данных доступны в различных форматах, включая электронные таблицы, пакеты R и файлы базы данных MySQL. |
