...
## <a name="gen-4-vs-gen-5"></a>Gen 4 и Gen 5 

**Разделы справки выбрать между созданием оборудования GEN 4 и Gen 5 для управляемого экземпляра?**
...
Для рабочих нагрузок с интенсивным вводом-выводом можно использовать оборудование поколения 5, а для ресурсоемких рабочих нагрузок — GEN 4. Дополнительные сведения см. в разделе [разделы справки выбор между GEN 4 и Gen 5](#gen-4-vs-gen-5).
...
Используйте параметр **накопленные затраты** , а затем отфильтруйте по **типу ресурса** `microsoft.sql/managedinstances`. 
  
## <a name="inbound-nsg-rules"></a>Правила входящих NSG

**Как настроить входящие правила NSG на портах управления?**

Встроенная функция брандмауэра настраивает брандмауэр Windows на всех виртуальных машинах в кластере, чтобы разрешить входящие подключения из диапазонов IP-адресов, связанных только с компьютерами управления или развертывания Майкрософт, и защищенные рабочие станции администратора, препятствующие атакам через сетевой уровень.
...
## <a name="mitigate-network-risks"></a>Устранение рисков сети  

**Как устранить риски с сетью?**
...
## <a name="moving-mi"></a>Перемещение MI

**Можно ли переместить управляемый экземпляр или его виртуальную сеть в другую группу ресурсов?**
