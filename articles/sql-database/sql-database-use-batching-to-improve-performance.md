---
title: Как использовать пакетирование для повышения производительности приложения
...
В следующей таблице показаны специальные результаты тестирования на использование параметров, ценных на стол, в миллисекундах.
...
Следующие результаты специальных тестов показывают производительность пакетирования с **помощью SqlBulkCopy** за миллисекунды.
...
В случае с пакетами меньшего размера использование параметров, которые возвращают табличное значение, приводит к повышению производительности в сравнении с использованием класса **SqlBulkCopy** . Тем не менее, **SqlBulkCopy** выполнила 12-31% быстрее, чем столовая стоимость параметров для испытаний 1000 и 10000 строк. Аналогично параметрам, которые возвращают табличное значение, класс **SqlBulkCopy** — это хорошее решение для пакетных вставок, особенно в сравнении с операциями, в которых не используются пакеты.

Дополнительные сведения о массовом копировании в ADO.NET см. в разделе [Массовое копирование в SQL Server](https://msdn.microsoft.com/library/7ek5da1a.aspx).
...
Следующие результаты специальных тестов показывают производительность этого типа вставки оператора в миллисекундах.
