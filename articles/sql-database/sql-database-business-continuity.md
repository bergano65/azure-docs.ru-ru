...
| Функция | базовая; | Стандартная | "Премиум" | Универсальные | Критически важный для бизнеса
| --- | --- | --- | --- |--- |--- |
