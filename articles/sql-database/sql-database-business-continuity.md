...
- [Активная Георепликация](sql-database-active-geo-replication.md) позволяет создавать реплики, доступные для чтения, и вручную отработку отказа для любой реплики в случае сбоя центра обработки данных или обновления приложения.
...
Обсуждение вопросов разработки приложений для автономных баз данных и эластичных пулов см. в статье [проектирование приложения для аварийного восстановления облака](sql-database-designing-cloud-solutions-for-disaster-recovery.md) и [стратегий аварийного восстановления эластичного пула](sql-database-disaster-recovery-strategies-for-applications-with-elastic-pool.md).
