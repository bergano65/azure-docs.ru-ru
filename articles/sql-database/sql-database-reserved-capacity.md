---
title: Экономия затрат на виртуальных ядер базы данных SQL Azure | Документация Майкрософт
...
Вы можете приобрести резервную мощность Базы данных SQL Azure на [портале Azure](https://portal.azure.com). Платите за резервирование на [передний план или с ежемесячными платежами](../billing/billing-monthly-payments-reservations.md). Чтобы купить резервную мощность Базы данных SQL:
