...
Если в резервной мощности Базы данных SQL нужно изменить регион, тип развертывания, уровень производительности или срок, можете обменять это резервирование на другое с такими же или большими значениями. При обмене дата начала использования для нового резервирования не переносится из текущего резервирования. Срок использования (1 или 3 года) начинается с момента создания резервирования. Чтобы выполнить обмен, перейдите к зарезервированию в портал Azure и выберите **Exchange**.
