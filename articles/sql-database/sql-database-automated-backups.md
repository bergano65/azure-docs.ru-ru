...
Если вы используете [модель приобретения на основе виртуальных ядер](sql-database-service-tiers-vcore.md), срок хранения резервных копий по умолчанию составляет 7 дней (для изолированных баз данных, баз данных в составе пула и баз данных экземпляра). Для всех баз данных SQL Azure (изолированных баз данных, баз данных в составе пула и баз данных экземпляров) можете [изменить период хранения резервных копий](#how-to-change-the-pitr-backup-retention-period), установив срок до 35 дней.
