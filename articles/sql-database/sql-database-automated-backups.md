...
На логическом сервере вы можете [изменить срок хранения резервных копий до 35 дней](#how-to-change-backup-retention-period). Изменение срока хранения резервных копий недоступно в Управляемом экземпляре. 
