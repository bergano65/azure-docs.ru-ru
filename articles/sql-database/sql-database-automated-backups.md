...
Управляемый экземпляр выполняет автоматическую первоначальную архивацию `CHECKSUM` баз данных, `RESTORE` восстановленных с помощью собственной команды или службы Azure Data Migration Service после завершения миграции.
