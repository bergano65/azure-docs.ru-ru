...
В каждой Базе данных SQL установлен период хранения резервных копий по умолчанию (от 7 до 35 дней). Его длительность зависит от модели приобретения и уровня служб. Вы можете изменить период хранения резервных копий для базы данных на логическом сервере Azure. Дополнительные сведения см. в разделе [Как изменить период хранения резервной копии](#how-to-change-the-pitr-backup-retention-period).
