...
Чтобы использовать Intelligent Insights со службой хранилища, настройте потоковую передачу данных журнала Intelligent Insights в службу хранилища, как описано в разделе [Потоковая передача в хранилище](sql-database-metrics-diag-logging.md#stream-diagnostic-telemetry-into-azure-storage).
