...
| :----------------------------- | ----- | ----- |
| **Настройка Intelligent Insights** . настройка анализа Intelligent Insights для баз данных. | Yes | Yes | 
| **Stream Insights для аналитика SQL Azure** --Stream Insights для аналитика SQL Azure решения для мониторинга базы данных SQL Azure. | Yes | Yes | 
| **Stream Insights to концентратора событий** — потоковая аналитика в концентраторы событий для дальнейшей пользовательской интеграции. | Yes | Yes | 
| **Stream Insights для службы хранилища Azure** — Stream Insights в службе хранилища Azure для дальнейшего анализа и долгосрочного архивирования. | Yes | Yes |
...
- Узнайте, как [собирать и использовать данные журнала из ресурсов Azure](../azure-monitor/platform/resource-logs-overview.md).
