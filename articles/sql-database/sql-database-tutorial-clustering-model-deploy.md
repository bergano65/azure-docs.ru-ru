...
Из [второй части](sql-database-tutorial-clustering-model-build.md) вы узнали, как создать и обучить модель кластеризации по методу K-средних с помощью сценария R.
