...
1. В форме **Создание Базы данных SQL** введите или выберите следующие значения: 
...
1. В разделе **Сервер** выберите **Создать**. 
...
1. Введите *myResourceGroup* в поле и щелкните **Удалить**.
