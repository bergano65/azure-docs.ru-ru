...
> - предоставление разрешений именам для входа Azure AD в управляемом экземпляре;
...
> [!NOTE]
> Имена для входа управляемых экземпляров Базы данных SQL находятся на этапе **общедоступной предварительной версии**.
...
1. Подключитесь к управляемому экземпляру с помощью имени для входа Azure AD в SQL Server Management Studio. Введите имя узла управляемого экземпляра. При входе в систему с учетной записью Azure AD есть три варианта проверки подлинности в SSMS:
