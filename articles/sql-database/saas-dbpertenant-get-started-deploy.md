---
title: Руководство по SaaS для базы данных и клиента — база данных SQL Azure
...
- http://events.wingtip-dpt.&lt;user&gt;.trafficmanager.net/fabrikamjazzclub
    ...
    | Часть URL-адреса        | Description (Описание)       |
    | :-------------- | :---------------- |
...
3. Нажмите клавишу F5, чтобы запустить скрипт. Не изменяйте значения по умолчанию.
   ...
   > [!NOTE]
   > Во многих сценариях SaaS Wingtip переменная *$PSScriptRoot* используется для перехода по папкам и вызова функций из других сценариев. Эта переменная вычисляется только при выполнении полного сценария путем нажатия клавиши F5. Выделение и запуск выделенного фрагмента с помощью F8 может привести к ошибкам. Используйте клавишу F5 для запуска сценариев.
