...
1. В шаблоне введите значения обязательных параметров.
    ...
    - **Группа ресурсов.** Выберите **Создать** и укажите уникальное имя группы ресурсов, которое вы выбрали ранее.
    - **Расположение.** Выберите расположение из раскрывающегося списка.
    - **User**: Используйте значение имени пользователя, выбранное ранее.

1. Разверните приложения.

    1\. Установите флажок, чтобы принять условия.

    2\. Щелкните **Приобрести**.
