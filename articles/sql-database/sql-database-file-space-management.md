---
title: Управление пространством файлов для одноместных/объединенных баз данных
...
Служба Базы данных SQL не сможет автоматически сжать файлы данных для освобождения неиспользуемого выделенного пространства из-за возможного влияния на производительность базы данных.  Тем не менее, клиенты могут сокращать файлы данных с помощью самообслуживания в выбранное ими время, следуя шагам, описанным в [восстановлении неиспользованного выделенного пространства.](#reclaim-unused-allocated-space)
...
Измените следующие примеры, чтобы вернуть таблицу, в которых перечислено выделенное пространство и неиспользованное выделенное пространство для каждой базы данных в эластичной пуле. Таблица сортирует базы данных по объему неиспользованного выделенного пространства от наибольших к наименьшим.  Единицы результатов запроса указываются в МБ.  
