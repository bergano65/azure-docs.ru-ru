...
- [Определение нужного SKU Базы данных SQL Azure и Управляемого экземпляра для локальной базы данных](/sql/dma/dma-sku-recommend-sql-db/).
