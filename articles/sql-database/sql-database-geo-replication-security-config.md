...
#### <a name="1-determine-logins-with-access-to-the-primary-database"></a>1. Определить логины с доступом к основной базе данных
...
#### <a name="2-find-the-sid-for-the-logins-identified-in-step-1"></a>2. Найти SID для логинов, определенных в шаге 1
...
#### <a name="3-create-the-logins-on-the-target-server"></a>3. Создание логинов на целевом сервере
