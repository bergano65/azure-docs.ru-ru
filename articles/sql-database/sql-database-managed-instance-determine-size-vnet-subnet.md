...
> [!IMPORTANT]
> Размер подсети с 16 IP-адресами составляет от нуля до минимума с ограниченным потенциалом для дальнейшего Управляемый экземпляр масштабирования. Настоятельно рекомендуется выбирать подсети с префиксом /27 или ниже.
