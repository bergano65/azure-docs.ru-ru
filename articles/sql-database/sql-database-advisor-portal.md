...
2. Перейдите на **все службы** > **баз данных S'L**и выберите базу данных.
...
Здесь же можно увидеть состояние последних операций. Выберите рекомендацию или статус, чтобы увидеть больше информации.
...
### <a name="manually-apply-recommendations-through-t-sql"></a>Вручную применять рекомендации через T-S'L
...
* [Элемент управления доступом на основе ролей](../role-based-access-control/overview.md)
