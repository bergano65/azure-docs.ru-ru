---
title: 'Создание заданий эластичной базы данных SQL Azure и управление ими с помощью Transact-SQL (T-SQL) '
...
|Хранимая процедура  |Description (Описание)  |
|---------|---------|
