...
-   **Для текущей синхронизации**. Выберите/ Вставьте/ Обновление/ Удаление на таблицах, которые выбраны для синхронизации, и на таблицах синхронизации метаданных и отслеживания; Выполнение разрешения на сохраненные процедуры, созданные службой; Выполнение разрешения на типах таблиц, определенных пользователем.
...
-   Если у вас есть десятичные или числовые столбцы с точностью более 28, синхронизация данных s'L может столкнуться с проблемой переполнения преобразования во время синхронизации. Мы рекомендуем ограничить точность десятичных или числовых столбцов до 28 или менее.
...
### <a name="avoid-schema-refresh-timeout"></a>Избегайте тайм-аута обновления схемы

Если у вас есть сложная схема для синхронизации, вы можете столкнуться с "операцией тайм-аута" во время обновления схемы, если база данных метаданных синхронизации имеет более низкий SKU (например: базовый). 
