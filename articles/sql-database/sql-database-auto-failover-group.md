...
- **Подтверждение известных ограничений групп отработки отказа**
  ...
  Переименование базы данных и изменение размера экземпляра не поддерживаются для экземпляров в группе отработки отказа. Чтобы дается эти действия, необходимо временно удалить группу отработки отказа.
