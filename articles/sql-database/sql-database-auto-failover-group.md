...
- **Использование одной или нескольких групп отработки отказа для управления отработкой отказа нескольких баз данных**
  ...
  > [!IMPORTANT]
  > Создание групп отработки отказа между двумя серверами в разных подписках в настоящее время не поддерживается для отдельных баз данных и эластичных пулов.
