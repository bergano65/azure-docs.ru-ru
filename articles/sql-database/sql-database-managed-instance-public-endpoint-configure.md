---
title: Настройка общедоступной конечной точки для управляемого экземпляра базы данных SQL Azure | Документация Майкрософт
...
1. Перейдите на вкладку **правила безопасности для входящего трафика** и **добавьте** правило с более высоким приоритетом, чем правило **deny_all_inbound** со следующими параметрами. </br> </br>
    ...
    |**Местоназначение**     |Any         |Запрет места назначения в качестве любого, чтобы разрешить трафик в подсеть управляемого экземпляра |
