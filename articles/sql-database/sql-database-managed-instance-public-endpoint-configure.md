...
1. Выберите **правила безопасности для входящего трафика** вкладке и **добавить** правило, которое имеет более высокий приоритет, чем **deny_all_inbound** правило со следующими параметрами: </br> </br>
    ...
    |---------|---------|---------|
    |**Источник**     |Любой IP-адреса или тег службы         |<ul><li>Для служб Azure, таких как Power BI выберите тег Azure облачной службы</li> <li>Для компьютера или виртуальной Машины Azure используйте IP-адрес NAT</li></ul> |
    ...
    |**Назначение**     |Любой         |Создание назначения как какой-либо чтобы разрешить трафик в подсети управляемого экземпляра |
    ...
    |**Действие**     |РАЗРЕШИТЬ         |Разрешить входящий трафик в управляемый экземпляр через общедоступную конечную точку |
