...
9. Щелкните значок **Уведомления**, чтобы просмотреть состояние развертывания.
...
10. Щелкните **Развертывание выполняется**, чтобы открыть окно Управляемого экземпляра для дальнейшего мониторинга состояния развертывания. 
