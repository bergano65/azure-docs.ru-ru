...
5. Нажмите кнопку **Сохранить**. Правило IP-пространства IP-класса создается для открытого порта IP-адреса вашей виртуальной машины, открывающего порт 1433 на сервере базы данных S'L.
