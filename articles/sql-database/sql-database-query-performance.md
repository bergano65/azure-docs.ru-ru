...
* Заметки, отображающие рекомендации по производительности от [помощников по базам данных](sql-database-advisor.md)
...
5. Откройте **Intelligent Performance** > **рекомендации** по интеллектуальной производительности и проверьте, доступны ли какие либо рекомендации по производительности. Дополнительные сведения о встроенных рекомендациях по производительности см. в статье [Помощник по базам данных SQL Azure](sql-database-advisor.md).
