---
title: Анализ производительности запросов для Базы данных SQL Azure
...
* **Авто**: хранилище запросов игнорирует редко используемые запросы и запросы с незначительной длительностью компиляции и выполнения. Пороговые значения числа выполнений, а также времени компиляции и выполнения определяются внутренним образом. Это вариант по умолчанию.
