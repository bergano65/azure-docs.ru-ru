...
На следующем рисунке показан пример активной георепликации, настроенной с помощью базы данных-источника в северо-центральном регионе США и базы данных-получателя в центрально-южной части США.
...
## <a name="keeping-credentials-and-firewall-rules-in-sync"></a>Хранение учетных данных и правил брандмауэра в синхронизации
