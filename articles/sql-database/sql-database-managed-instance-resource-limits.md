...
| Максимальный размер базы данных | 8 ТБ | 4 TБ |
...
- **ограничение Виртуальное ядро**: Максимальное число виртуальных ядер, которые могут быть развернуты во всех экземплярах в одном регионе. Общее число экземпляров не ограничено, если оно находится в пределах ограничения Виртуальное ядро.
