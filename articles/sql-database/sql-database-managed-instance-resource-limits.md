...
| Операции ввода-вывода в секунду для данных или журнала (приблизительно) | 500–7500 на каждый файл<br/>\*[Зависит от размера файла] (https://docs.microsoft.com/azure/virtual-machines ce пропускной способности журнала | 22 МБ/с на экземпляр | 3 МБ/с на виртуальное ядро;<br/>максимум 48 МБ/с |
