...
| --- | --- | --- |
| Количество виртуальных ядер\* | 4-е поколение: 8, 16, 24<br/>Го поколения: 4, 8, 16, 24, 32, 40, 64, 80 | 4-е поколение: 8, 16, 24 <br/> Го поколения: 4, 8, 16, 24, 32, 40, 64, 80 <br/>@no__t — 0Same число виртуальных ядер, выделенное для запросов только для чтения. |
...
|Разработка и тестирование Enterprise|3|320|
...
\* @ no__t-1 большие ограничения подсети и виртуальное ядро доступны в следующих регионах: Восточная Австралия, Восточная часть США, Восточная часть США 2, Северная Европа, Юго-Центральный регион США, Юго-Восточная Азия, южная часть Соединенного Королевства, Западная Европа, Западная часть США 2.
