...
| Память | 4-е поколение: 56–156 ГБ<br/>5-е поколение: 44–440 ГБ<br/>\*Пропорционально количеству виртуальных ядер | 4-е поколение: 56–156 ГБ <br/> 5-е поколение: 41–408 ГБ<br/>\*Пропорционально количеству виртуальных ядер |
| Максимальный размер хранилища | 8 ТБ | 4-е поколение: 1 TБ <br/> 5 поколение: <br/>— 1 ТБ для 8, 16 виртуальных ядер<br/>— 2 ТБ для 24 виртуальных ядер<br/>— 4 ТБ для 32, 40, 64, 80 виртуальных ядер |
...
| Операции ввода-вывода в секунду для данных или журнала (приблизительно) | 500–7500 на каждый файл<br/>\*[Зависит от размера файла](https://docs.microsoft.com/azure/virtual-machines/windows/premium-storage-performance#premium-storage-disk-sizes) | 11–110 тыс. (1375 на виртуальное ядро) |
| Экземпляр пропускной способности журнала | 22 МБ/с на экземпляр | 3 МБ/с на виртуальное ядро;<br/>максимум 48 МБ/с |
...
| Максимальный размер tempdb | 192–1920 ГБ (24 ГБ на виртуальное ядро) | Без ограничений — ограничены максимальным размером хранилища экземпляра |
