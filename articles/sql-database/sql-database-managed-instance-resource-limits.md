...
| Операции ввода-вывода в секунду для данных или журнала (приблизительно) | 500–7,500 МБ/с на каждый файл<br/>\*[Зависит от размера файла](https://docs.microsoft.com/azure/virtual-machines)| 11–110 тис. (1375 на виртуальное ядро) |
|Журнал пропускной способности | 22 МБ/с на экземпляр | 3 МБ/с на виртуальное ядро<br/>Макс. 48 МБ/с |
