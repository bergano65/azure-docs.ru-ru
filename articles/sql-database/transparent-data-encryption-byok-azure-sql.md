...
Если ключ, необходимый для восстановления резервной копии, больше не доступен на целевом сервере, то при восстановлении будет возвращено следующее сообщение об ошибке: "целевой `<Servername>` сервер не имеет доступа ко всем URI AKV, созданным между \<метками \<времени #1> и #2 меток времени>. Повторите операцию после восстановления всех URI AKV. "
