...
- Создайте хранилище ключей с включенной [обратимым удалением](https://docs.microsoft.com/azure/key-vault/key-vault-ovw-soft-delete) и защитой от потери данных в случае случайного удаления ключа — или хранилища ключей.  Для [включения свойства обратимого удаления в хранилище ключей необходимо использовать PowerShell](https://docs.microsoft.com/azure/key-vault/key-vault-soft-delete-powershell), так как это свойство пока не поддерживается на портале AKV, но является обязательным для SQL Azure.  
