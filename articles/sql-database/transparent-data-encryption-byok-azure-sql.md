...
ms.locfileid: "49114674"
---
# <a name="azure-sql-transparent-data-encryption-bring-your-own-key-support"></a>Прозрачное шифрование данных Azure SQL с поддержкой создания собственных ключей
...
- При использовании брандмауэров и виртуальных сетей с помощью Azure Key Vault необходимо настроить следующее: 
  - Разрешите доступ из раздела "Выбранные сети". 
  - Добавьте имеющиеся виртуальные сети и выберите сеть Базы данных SQL, если это применимо (это необязательно для отдельных баз данных и необходимо для управляемых экземпляров). 
