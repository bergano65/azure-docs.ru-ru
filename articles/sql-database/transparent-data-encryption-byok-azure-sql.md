...
description: Поддержка создание собственных ключей (BYOK) для прозрачное шифрование данных (TDE) с Azure Key Vault для базы данных SQL и Azure синапсе. Обзор TDE с поддержкой BYOK, преимущества, принцип работы, замечания и рекомендации.
...
Дополнительные сведения о восстановлении резервной копии для Базы данных SQL см. в [этой статье](sql-database-recovery-using-backups.md). Дополнительные сведения о восстановлении резервных копий для пула SQL см. в статье [Восстановление пула SQL](../sql-data-warehouse/backup-and-restore.md). Инструкции для собственного резервного копирования или восстановления SQL Server с управляемым экземпляром см. в разделе [Краткое руководство. Восстановление базы данных в управляемый экземпляр](https://docs.microsoft.com/azure/sql-database/sql-database-managed-instance-get-started-restore)
