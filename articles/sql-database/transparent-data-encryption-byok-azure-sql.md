...
 > [!NOTE]
 > Если базы данных SQL, зашифрованные с помощью TDE, теряют доступ к хранилищу ключей по причине того, что не могут обойти брандмауэр, они будут удалены в течение 24 часов.
