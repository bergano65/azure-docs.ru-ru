...
||**Универсальные**|**Критически важный для бизнеса**|**Уровень "Гипермасштабирование"**|
|---|---|---|---|
...
Серия M поддерживается только на уровне критически важный для бизнеса и не поддерживает избыточность зоны.
