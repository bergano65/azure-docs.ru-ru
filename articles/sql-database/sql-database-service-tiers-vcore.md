---
title: Служба базы данных SQL Azure — общие сведения о модели Виртуальное ядро | Документация Майкрософт
...
ms.locfileid: "73496089"
---
# <a name="vcore-model-overview"></a>Общие сведения о модели Виртуальное ядро
