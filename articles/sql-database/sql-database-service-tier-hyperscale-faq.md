...
№ Рабочей нагрузки чтения только перенаправляется в случайные реплики чтения и масштабирования.
...
№ Вторичный вычислительных узлов также используются для обеспечения высокой ДОСТУПНОСТИ, поэтому они должны иметь ту же конфигурацию, как источник, в случае отработки отказа.
