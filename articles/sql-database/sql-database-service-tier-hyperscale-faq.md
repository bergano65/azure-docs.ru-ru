...
№ Для увеличения объема ОЗУ необходимо использовать более высокий уровень вычислительных ресурсов. Аппаратное обеспечение 4-го поколения обеспечивает больше оперативной памяти по сравнению с оборудованием 5-го поколения. Дополнительные сведения см. в разделе [Уровень служб "Гипермасштабирование" (предварительная версия)](sql-database-vcore-resource-limits-single-databases.md).
