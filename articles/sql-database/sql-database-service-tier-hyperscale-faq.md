...
Да.  Географическое восстановление поддерживается полностью. В отличие от восстановления до точки во времени, для геовосстановления может потребоваться длительная операция с размером данных.
