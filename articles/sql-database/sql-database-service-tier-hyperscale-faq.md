...
Если вы используете аналитику данных в крупном масштабе с помощью сложных запросов и высокие тарифы на прием данных, превышающие 100 МБ/с, или с помощью хранилища данных Parallel Data Warehouse (PDW), Teradata или других хранилищ (MPP), хранилище данных SQL может быть наилучший вариант.
...
Ваша база данных `tempdb` находится в локальном хранилище SSD и настроена на основе подготавливаемого объема вычислительных ресурсов. @No__t_0 оптимизирована для обеспечения максимальной производительности. Размер `tempdb` нельзя настроить и управлять им.
