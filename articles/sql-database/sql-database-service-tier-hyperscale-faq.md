---
title: Часто задаваемые вопросы о гипермасштабировании
...
| | Управляемый экземпляр | Зависит от размера файла | Недоступно | 1375 операций ввода-вывода в секунду/Виртуальное ядро |
