---
title: Архитектура подключения для управляемого экземпляра в базе данных SQL Azure | Документация Майкрософт
...
\*Подсеть MI ссылается на диапазон IP-адресов для подсети в формате 10. x. x. x/y. Эти сведения можно найти в портал Azure в свойствах подсети.
