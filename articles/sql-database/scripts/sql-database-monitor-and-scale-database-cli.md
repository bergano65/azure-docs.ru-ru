...
| [az sql db show-usage](https://docs.microsoft.com/cli/azure/sql/db#az-sql-db-show-usage) | Отображает сведения об используемом размере отдельной базы данных или базы данных в пуле. |
