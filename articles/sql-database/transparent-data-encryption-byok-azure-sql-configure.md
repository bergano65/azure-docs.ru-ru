...
- Узнайте, как сменить средство защиты TDE сервера в соответствии с требованиями безопасности: [поворачивайте средство защиты прозрачное шифрование данных с помощью PowerShell](transparent-data-encryption-byok-azure-sql-key-rotation.md).
