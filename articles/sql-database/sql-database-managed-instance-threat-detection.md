...
ms.locfileid: "52997143"
---
# <a name="azure-sql-database-managed-instance-threat-detection-preview"></a>Обнаружение угроз в управляемом экземпляре Базы данных SQL Azure (предварительная версия)
