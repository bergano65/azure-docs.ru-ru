...
В этой статье рассматриваются некоторые из основных характеристик базы данных SQL Azure как готовой к использованию платформы. К ним относятся следующие.
...
Правила брандмауэра можно создавать на уровне сервера и базы данных. Правила брандмауэра на уровне сервера можно создавать с помощью портала Azure или с помощью SSMS. Дополнительные сведения о настройке правила брандмауэра уровня сервера и базы данных см. в [этом разделе](sql-database-security-tutorial.md#create-firewall-rules).
