---
title: Управление одними и базами данных в составе пула после миграции
...
- Идентификация & проверка подлинности (проверка подлинности[SQL и Azure Active Directory [AAD]](sql-database-manage-logins.md)).
...
|**Premium**|Приложения с большим количеством одновременно работающих пользователей, высоким уровнем потребления ресурсов ЦП и памяти, а также с высокими требованиями к операциям ввода-вывода. Чувствительные к задержкам приложения с высокими требованиями к параллелизму и пропускной способности, которые могут работать на уровне "Премиум". |
|||
