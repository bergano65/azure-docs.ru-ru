...
Эта страница содержит сведения о проблемах производительности Базы данных SQL Azure и Управляемого экземпляра Базы данных SQL, которые можно обнаружить с помощью журнала диагностики производительности базы данных [Intelligent Insights](sql-database-intelligent-insights.md). Данные телеметрии диагностики журнала могли быть переданы [журналы Azure Monitor](../azure-monitor/insights/azure-sql.md), [концентраторов событий](../azure-monitor/platform/diagnostic-logs-stream-event-hubs.md), [хранилища Azure](sql-database-metrics-diag-logging.md#stream-into-storage), или стороннее решение для настраиваемых оповещений DevOps и возможности работы с отчетами.
