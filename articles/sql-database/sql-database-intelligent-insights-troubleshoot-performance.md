...
| [Снижение эффективности плана](sql-database-intelligent-insights-troubleshoot-performance.md#plan-regression) | Обнаружен новый план или изменение рабочей нагрузки существующего плана. Это негативно влияет на производительность Базы данных SQL. | Обнаружен новый план или изменение рабочей нагрузки существующего плана. Это негативно влияет на производительность базы данных. |
...
## <a name="new-query"></a>Создать новый запрос
