...
SSL-сертификат требуется для шифрования при обмене данными и проверки подлинности сервера. Выберите наиболее подходящий из этих трех сценариев и выполните все шаги.
...
Группа правила управления доступом, которые применяются к и конечной точки настраиваются в  **\<EndpointAcls >** статьи **файл конфигурации службы**.
...
Правила в группе управления доступом настраиваются в \<AccessControl name = "" > раздел файла конфигурации службы. 
