...
Ограничения функций помогают предотвратить утечку информации о базе данных в некоторых формах SQL, даже если внедрение кода SQL успешно выполнено. Дополнительные сведения см. в статье [ограничения функций базы данных SQL Azure](sql-database-feature-restrictions.md).
