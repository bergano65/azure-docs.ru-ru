...
|------------------------|--------|-------|------|--------|------|-------|--------|
| **Происхождение чести**       | Да    | Да   | нет   | Да    | нет   | Да   | Да    |
| **Длительность кэша CDN** | 2 дня |7 дней | Отсутствуют | 7 дней | Отсутствуют | 1 день | Год |
