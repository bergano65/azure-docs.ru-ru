...
> [!NOTE] 
> Правила кэширования доступны только для профилей **Azure CDN уровня "Стандартный" от Verizon** и **Azure CDN уровня "Стандартный" от Akamai**. Для **Azure CDN из профилей Майкрософт** необходимо использовать [обработчик стандартных правил](cdn-standard-rules-engine-reference.md) для **Azure CDN "Премиум" из профилей Verizon** . для подобной функциональности необходимо использовать [обработчик правил Verizon Premium](cdn-rules-engine.md) на портале **управления** .
