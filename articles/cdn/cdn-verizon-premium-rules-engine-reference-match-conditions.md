---
title: Azure CDN от Verizon Premium правила двигателя совпадают условия Документы Майкрософт
description: Справочная документация для Сети доставки контента Azure от Verizon Premium соответствует условиям двигателя.
services: cdn
author: asudbring
...
---
# <a name="azure-cdn-from-verizon-premium-rules-engine-match-conditions"></a>Azure CDN от Verizon Premium правила двигателя матч условия

В этой статье перечислены подробные описания доступных условий соответствия для сети доставки содержимого Azure (CDN) из [движка правил](cdn-verizon-premium-rules-engine.md)Verizon Premium.
...
- Запросы фильтра, генерируемые с определенного IP-адреса или страны/региона.
...
[Страна](#country) | Определяет запросы, поступающие из указанных стран/регионов.
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия AS Number:
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия IP-адреса клиента:
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия параметру Cookie.
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия параметру Cookie Regex.
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия «Страна»:
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия устройств:
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия домену передачи:
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия буквального соответствия заголовку запроса.
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия заголовка запроса Regex.
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия подбору подбора подзаголовком запроса.
...
Опция **«Совпадения**/**не соответствует»** определяет условия, при которых выполняется условие соответствия каталога URL-адреса.
...
- Используйте параметр **Относительно**, чтобы указать, где начинается точка сравнения URL-адресов: перед точкой доступа к содержимому или после нее. Точка доступа к содержимому представляет собой часть пути и отображается между именем узла Verizon CDN и относительным путем к запрошенному ресурсу (например, /800001/CustomerOrigin). Она определяет расположение по типу сервера (например, источник CDN или клиента) и номеру счета заказчика.
  ...
  Этот URL указывает на следующее Verizon CDN хостимя: http:\//wpc.0001. &lt;домен&gt;/800001/myorigin/**myfolder**/index.htm
...
Опция **«Совпадение**/**не соответствует»** определяет условия, при которых выполняется условие соответствия расширения URL-адреса.
...
Значение спецификации: asp aspx php html
...
Опция **«Совпадение**/**не соответствует»** определяет условия, при которых выполняется условие соответствия файла URL-адреса.
...
Опция **«Совпадение**/**не соответствует»** определяет условия, при которых выполняется условие буква «Буква» пути URL.
...
- Используйте параметр **Относительно**, чтобы указать, где начинается точка сравнения URL-адресов: перед точкой доступа к содержимому или после нее. 
  ...
  - **Корневой домен**. Указывает, что точка сравнения URL-адресов начинается непосредственно после имени узла CDN.
    ...
    Например: http:\//wpc.0001. &lt;&gt;/**домена 800001/myorigin/myfolder/index.htm**

  - **Исходный домен**. Указывает, что точка сравнения URL-адресов начинается после точки доступа к содержимому (например, /000001 или /800001/myorigin). Так как запись CNAME \*.azureedge.net создана относительно исходного каталога в имени узла Verizon CDN по умолчанию, пользователи Azure CDN должны использовать значение **Исходный домен**. 

    Например: https:\//&lt;&gt;endpoint .azureedge.net/**myfolder/index.htm**

  Этот URL указывает на следующее Verizon CDN хостимя: http:\//wpc.0001. &lt;домен&gt;/800001/миориг/**myfolder/index.htm**
...
Опция **«Совпадение**/**не соответствует»** определяет условия, при которых выполняется условие соответствия URL Path Regex.
...
Опция **«Матчи**/**не соответствует»** определяет условия, при которых выполняется условие соответствия URL Path Wildcard.
...
Опция **«Совпадение**/**не соответствует»** определяет условия, при которых выполняется условие соответствия URL-адреса literal.
...
- Для некоторых знаков требуется кодирование в формат URL-адреса. Используйте знак процента для кодирования таких знаков в формат URL-адреса:
   ...
   Знак | Кодирование в формат URL-адреса
   ----------|---------
   Пробел     | %20
   &         | %25
...
Опция **«Совпадение**/**не соответствует»** определяет условия, при которых выполняется условие соответствия параметру URL-параметра.
...
Опция **«Совпадение**/**не соответствует»** определяет условия, при которых выполняется условие соответствия URL-адреса Regex.
...
- Для некоторых знаков требуется кодирование в формат URL-адреса. Используйте знак процента для кодирования таких знаков в формат URL-адреса:
   ...
   Знак | Кодирование в формат URL-адреса | Значение
   ----------|--------------|------
   Пробел     | %20          | \%20
   &         | %25          | \%25
...
Опция **«Совпадение**/**не соответствует»** определяет условия, при которых выполняется условие соответствия URL-адреса Wildcard.
...
- В целях этого параметра строка запроса начинается с первого знака после разделителя вопросительного знака (?) строки запроса.
- Значения параметров могут включать [значения подстановочных знаков:](cdn-verizon-premium-rules-engine-reference.md#wildcard-values)
   - Каждый шаблон значения параметра может содержать одну или несколько звездочек (*), где каждая звездочка может соответствовать последовательности одного или нескольких знаков.
   - Для некоторых знаков требуется кодирование в формат URL-адреса. Используйте знак процента для кодирования таких знаков в формат URL-адреса:
...
\*пользовательского\* \*отказа\* | Для соответствия этому шаблону запрос URL-адреса CDN должен содержать параметр пользователя или OptOut.
