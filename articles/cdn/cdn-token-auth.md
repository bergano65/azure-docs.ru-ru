...
- Страна: Разрешение или отклонение запросов, поступающих из стран, указанных по их [код страны](/previous-versions/azure/mt761717(v=azure.100)).
