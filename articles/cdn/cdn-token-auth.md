...
- Страна: Разрешение или отклонение запросов, поступающих из стран, указанных по их [код страны](https://msdn.microsoft.com/library/mt761717.aspx).
