...
Сейчас мы поддерживаем подстановочный знак в **условии соответствия урлпас** в обработчике стандартных правил. \*Символ — это звездочка, представляющая один или несколько символов. 
