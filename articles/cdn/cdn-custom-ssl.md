...
>[!NOTE]
>Проверка электронной почты владельца личного домена сейчас недоступна для профилей **Azure CDN от Akamai**. Эта функция сейчас доступна в режиме невыполненной работы. 
