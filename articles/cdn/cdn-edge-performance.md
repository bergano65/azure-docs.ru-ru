...
* Метрика: щелкните значок диаграммы рядом с нужным показателем. Диаграмма и временная шкала будут обновлены на основании данных для выбранной метрики.
