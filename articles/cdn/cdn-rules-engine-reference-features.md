...
Значение|Результат
-|-
Включено|Запросы для заголовков ответа debug cache возвратят ответ, включающий заголовок X-EC-Debug.
...
Значение|Результат
-|-
Включено|Предотвращает ответ на запрос байтового диапазона с кодом состояния 416 запрошенный диапазон невыполним точек подключения. Вместо этого серверы предоставят запрошенный ресурс и возвратят ответ 200 ОК клиенту.
