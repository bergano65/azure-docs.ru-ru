---
title: Функции обработчика правил Azure CDN от Verizon Premium | Документация Майкрософт
...
## <a name="azure-cdn-from-verizon-premium-rules-engine-features-reference"></a>Справочник по функциям обработчика правил Azure CDN от Verizon Premium
...
**Назначение.** Регулирует пропускную способность для ответа, предоставляемого точками подключения.
...
**Поведение по умолчанию:** Перезапись.
...
-|-|-
Заголовок запроса|`%{[RequestHeader]()}[i]()` | %{Accept-Encoding}i <br/> {Referrer}i <br/> %{Authorization}i
...
**Поведение по умолчанию:** Overwrite
...
**Поведение по умолчанию:** Поведение по умолчанию состоит в соблюдении приведенных выше директив.
...
**Назначение.** Добавляет в запрос пользовательский заголовок, который идентифицирует запрашивающий клиент по IP-адресу.
