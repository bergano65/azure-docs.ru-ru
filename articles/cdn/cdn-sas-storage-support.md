...
### <a name="option-2-hidden-cdn-sas-token-using-a-rewrite-rule"></a>Вариант 2. Скрытый маркер CDN SAS, с использованием правила переопределения
...
### <a name="option-3-using-cdn-security-token-authentication-with-a-rewrite-rule"></a>Вариант 3. С помощью проверки подлинности маркера безопасности CDN с правилом подстановки
