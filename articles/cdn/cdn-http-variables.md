...
| Универсальный код ресурса (URI) запроса | %{request} | Описывает запрос. <br />Синтаксис: &lt;&gt; &lt;HTTP-протокол относительный путь&gt; &lt;HTTP&gt; | GET /marketing/foo.js?loggedin=true HTTP/1.1 |
