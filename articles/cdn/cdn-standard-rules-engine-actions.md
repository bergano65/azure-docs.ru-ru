...
Fragment | Определите фрагмент, который будет использоваться в перенаправлении. Оставьте пустым, чтобы сохранить входящий фрагмент. 
...
Destination | Определите целевой путь, который будет использоваться в перезаписи. Целевой путь перезаписывает исходный шаблон.
