...
Действия | Имя заголовка HTTP | Value
-------|------------------|------
...
Удаление | Если выбран этот параметр, правило соответствует, а заголовок, указанный в правиле, имеется, заголовок удаляется из запроса. | Строка
...
Удаление | Если выбран этот параметр, правило соответствует, а заголовок, указанный в правиле, имеется, заголовок удаляется из ответа. | Строка
