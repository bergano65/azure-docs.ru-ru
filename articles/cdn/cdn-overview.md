...
Дополнительные сведения см. в разделе об [ограничениях подписки CDN](https://docs.microsoft.com/azure/azure-subscription-service-limits).
