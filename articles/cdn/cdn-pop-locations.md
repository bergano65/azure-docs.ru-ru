...
В этой статье перечислены доступные сейчас приложения Metro, содержащие расположения точек подключения (POP), отсортированные по регионам, для продуктов сети доставки содержимого (CDN) Azure. Каждое приложение Metro может содержать несколько POP. Например, Azure CDN от Майкрософт содержит 129 POP в 61 приложении Metro. 
...
| Ближний Восток | | Мускат, Оман<br />Фуджира, Объединенные Арабские Эмираты | Катар<br />Объединенные Арабские Эмираты |
