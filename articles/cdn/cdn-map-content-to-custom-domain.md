...
3. Создайте запись CNAME для своего личного домена и заполните поля, как показано в таблице ниже (имена полей могут отличаться):
    ...
    - Источник. Введите имя личного домена, включая поддомен cdnverify, в следующем формате: cdnverify.&lt;&gt;доменного имени. Например, cdnverify. www.contoso.com.
