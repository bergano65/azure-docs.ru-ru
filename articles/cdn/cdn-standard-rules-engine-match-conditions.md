...
- При указании имени файла cookie нельзя использовать подстановочные знаки (включая звездочки (\*)). Вы обращаются использовать точное имя файла cookie.
...
- Чтобы указать несколько IP-адресов и блоков IP-адресов, используйте один пробел между значениями:
  ...
  - **Пример для IPv6**: *1:2:3:4:5:6:7:8 10:20:30:40:50:60:70:8*0 соответствует всем запросам, поступающим из адреса 1:2:3:4:5:6:7:8 или 10:20:30:40:50:60:70:80.
...
operator | Текст запроса | Преобразование регистра
---------|--------------|---------------
[Список стандартных операторов](#standard-operator-list) | String, int | Без преобразования, до верхнего регистра
...
operator | Добавочный номер | Преобразование регистра
---------|-----------|---------------
[Список стандартных операторов](#standard-operator-list) | String, int | Без преобразования, до верхнего регистра
...
operator | Значение | Преобразование регистра
---------|-------|---------------
[Список стандартных операторов](#standard-operator-list) | String, int | Без преобразования, до верхнего регистра
