...
* [C# Ремотеманажер. Скирефлектионсеттингс, свойство](/dotnet/api/microsoft.azure.remoterendering.remotemanager.skyreflectionsettings)
* [C++ Ремотеманажер:: Скирефлектионсеттингс ()](/cpp/api/remote-rendering/remotemanager#skyreflectionsettings)
