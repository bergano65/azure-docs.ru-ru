...
* Введите уникальное имя в поле **Имя учетной записи хранения**. **Это имя должно быть глобально уникальным**, в противном случае появится предупреждение о том, что указанное имя уже существует. В этом кратком руководстве мы используем имя **arrtutorialstorage**. Вам нужно будет заменить его собственным именем во всех соответствующих местах.
