...
В этой главе рассматриваются способы выявления потенциальных узких мест на стороне клиента с помощью *трассировок производительности*.

## <a name="getting-started"></a>Начало работы

Если вы не знакомы с функцией трассировки производительности Windows, в этом разделе будут упомянуты наиболее фундаментальные термины и приложения, которые помогут вам приступить к работе.
...
1. Запустите [средство записи производительности Windows](https://docs.microsoft.com/windows-hardware/test/wpt/windows-performance-recorder) из меню " *Пуск*".
...
* [Запросы данных о производительности на стороне сервера](../overview/features/performance-queries.md)
