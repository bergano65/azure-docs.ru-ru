...
| **frequency** | Да, при использовании элемента **recurrence**. | Единица времени между вхождениями. Поддерживаются такие значения: Minute (минута), Hour (час), Day (день), Week (неделя), Month (месяц) и Year (год) | 
