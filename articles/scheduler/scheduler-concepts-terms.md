...
| [**state**](#state) | Да | Сведения о текущем состоянии задания. |
| [**status**](#status) | Да | Сведения о текущем состоянии задания, которым управляет служба. |
||||
...
| **schedule** | Нет | Возможны разные варианты | Сведения о более сложных и расширенных расписаниях. См. параметры **hours**, **minutes**, **weekDays**, **months** и **monthDays**. | 
...
| **monthDays** | Нет | Возможны разные варианты | Массив, содержащий дни месяца, который задает время запуска задания. | 
