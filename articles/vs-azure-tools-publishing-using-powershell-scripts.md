...
1. Замените `New-WebDeployPackage` следующим кодом и замените заполнители в строке `$msbuildCmd`. Этот код предназначен для Visual Studio 2017. Если вы используете Visual Studio 2015, замените значение свойства **VisualStudioVersion** на `14.0` (`12.0` для Visual Studio 2013).
