---
title: Руководство по разработке модулей для устройств Windows (Azure IoT Edge)
...
1. Найдите свойство **registryCredentials** в требуемых свойствах $edgeAgent и убедитесь, что оно содержит правильные сведения.
