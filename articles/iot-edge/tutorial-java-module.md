...
* Вы можете настроить устройство IoT Edge, выполнив шаги, описанные в кратких руководствах для [Linux](quickstart-linux.md) или [Windows](quickstart.md).
* Для IoT Edge версии 1.0.5 на устройствах Windows не поддерживаются модули Java. Дополнительные сведения см. в [заметках о выпуске 1.0.5](https://github.com/Azure/azure-iotedge/releases/tag/1.0.5). Инструкции по установке конкретной версии см. в статье [Обновление управляющей программы безопасности и среды выполнения IoT Edge](how-to-update-iot-edge.md).
