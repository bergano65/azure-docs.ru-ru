...
Если вы устанавливаете IoT Edge, а не обновляете установленную версию, выполните действия, описанные в статье [Установка в автономном режиме или с определенной версией](how-to-install-iot-edge.md#offline-or-specific-version-installation).
