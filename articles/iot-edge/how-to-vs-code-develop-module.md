...
## <a name="debug-a-module-with-iot-edge-runtime-python-c"></a>Отладка модуля с использованием среды выполнения IoT Edge (Python, C)
...
В настоящее время поддержка отладки для модулей Python и C доступна только в контейнерах amd64 Linux.

### <a name="build-and-deploy-your-module"></a>Создание и развертывание модуля
...
Чтобы проверить состояние контейнера, откройте представление Docker в Visual Studio Code или выполните команду `docker ps` в окне терминала.
