...
## <a name="create-the-azure-machine-learning-service-container"></a>Создание контейнера Службы машинного обучения Azure
В этом разделе описывается, как скачать файлы обученной модели и преобразовать их в контейнер Службы машинного обучения Azure.
