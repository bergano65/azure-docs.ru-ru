...
* Упростите обмен данными между нижестоящими конечными устройствами и IoT Edge устройствами.
* Упростите обмен данными между модулями на IoT Edge устройстве.
* Упростите обмен данными между устройством IoT Edge и облаком.
