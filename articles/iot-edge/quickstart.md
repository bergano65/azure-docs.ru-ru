...
>
> Если вам нужно настроить собственное устройство Windows для IoT Edge, выполните инструкции из статьи [Установка или удаление среды выполнения Azure IoT Edge](how-to-install-iot-edge.md).
