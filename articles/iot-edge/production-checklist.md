...
**Функцию Установка глобальных ограничений, относящихся ко всем модулям контейнеров**
...
**Функцию Настройка параметров журнала для каждого модуля контейнера**
