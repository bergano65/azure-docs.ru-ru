...
Получите образы с помощью команды DOCKER Pull для размещения в реестре. Имейте в виду, что вам потребуется обновить образы с каждым новым выпуском IoT Edge среды выполнения.
