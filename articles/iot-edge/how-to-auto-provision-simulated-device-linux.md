---
title: Автоматическая подготовка устройств Linux с помощью Службы подготовки устройств к добавлению в Центр Интернета вещей для Azure IoT Edge | Документация Майкрософт
...
В этой статье показано, как протестировать функцию автоматической подготовки на имитированном устройстве IoT Edge, выполнив следующие действия: 
...
В этом разделе описано, как создать виртуальную машину Linux в Hyper-V с имитированным доверенным платформенным модулем. С ее помощью можно проверить, как работает функция автоматической подготовки с IoT Edge. 
...
3. В ходе работы **Мастера создания виртуальной машины** укажите следующие настройки.
   ...
   1. **Укажите поколение**. Выберите **Поколение 2**.
