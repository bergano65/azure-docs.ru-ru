...
Вы можете использовать предпочтительный язык программирования с пакетами [SDK для устройств центра Интернета вещей Azure](https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-sdks#azure-iot-hub-device-sdks) , чтобы обновить значения сообщаемых свойств в модуле двойника на основе кода приложения вашего модуля. Следующая процедура использует пакет Azure SDK для .NET для этого, используя код из модуля [симулатедтемпературесенсор](https://github.com/Azure/iotedge/blob/dd5be125df165783e4e1800f393be18e6a8275a3/edge-modules/SimulatedTemperatureSensor/src/Program.cs) :

1. Создайте экземпляр [модулеклиент](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.client.moduleclient) с помощью метода [креатефроменвиронментайснк](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.client.moduleclient.createfromenvironmentasync) .

1. Получите коллекцию свойств двойникаа модуля с помощью метода [жеттвинасинк](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.client.moduleclient.gettwinasync?view=azure-dotnet) .

1. Создание прослушивателя (передача обратного вызова) для перехвата изменений требуемых свойств с помощью метода [сетдесиредпропертюпдатекаллбаккасинк](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.client.deviceclient.setdesiredpropertyupdatecallbackasync?view=azure-dotnet) .

1. В методе обратного вызова обновите сообщаемые свойства в модуле двойника с помощью метода [упдатерепортедпропертиесасинк](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.client.moduleclient) , передав [твинколлектион](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.shared.twincollection) значений свойств, которые необходимо задать.
...
Следующие команды представлены в структуре [AZ центра Интернета вещей двойника](https://docs.microsoft.com/cli/azure/ext/azure-cli-iot-ext/iot/hub/module-twin) .
