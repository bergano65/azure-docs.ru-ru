...
1.  Создайте сертификат ЦС владельца и один промежуточный сертификат. Эти сертификаты помещаются в `$WRKDIR`.
...
2.  Создайте сертификат ЦС пограничного устройства и закрытый ключ с помощью указанной ниже команды.
...
Подробные сведения о маршрутизации сообщений см. в статье о [составлении модулей](./module-composition.md).
