...
1. При появлении запроса укажите значения, начиная с **идентификатора развертывания**.
  ...
  | Priority |  Положительное целое число. Если на одном устройстве нацелено два или более развертывания, будет применяться развертывание с наибольшим числовым значением приоритета. |
