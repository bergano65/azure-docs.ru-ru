...
Состояние целевого устройства постоянно оценивается на протяжении всего времени существования развертывания. Включаются новые устройства, отвечающие требованиям, а любые существующие устройства, которые больше не отвечают этим требованиям, удаляются. Развертывание повторно активируется, если служба обнаруживает любое изменение состояния целевого устройства. 
