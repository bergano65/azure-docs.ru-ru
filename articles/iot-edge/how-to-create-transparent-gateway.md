...
Устройство Azure IoT Edge, настроенное с помощью [рабочих сертификатов](how-to-install-production-certificates.md).
...
Вы можете проверить, какие модули выполняются на устройстве, проверив сведения об устройстве в портал Azure, просмотрев состояние устройства в Visual Studio или Visual Studio Code или выполнив команду `iotedge list` на самом устройстве.
