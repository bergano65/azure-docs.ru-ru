...
1. В обозревателе Visual Studio Code разверните раздел **Центр Интернета вещей Azure/Устройства**, чтобы отобразился список устройств Интернета вещей.
...
Сведения о состоянии устройства IoT Edge можно просмотреть в разделе **Центр Интернета вещей Azure/Устройства** в обозревателе Visual Studio Code. Разверните раздел со сведениями об устройстве, чтобы просмотреть список развернутых и запущенных модулей.
