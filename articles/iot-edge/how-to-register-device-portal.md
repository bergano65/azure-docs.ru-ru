...
4. Укажите описательный идентификатор устройства. Для автоматического создания ключей аутентификации и подключения нового устройства к концентратору используйте параметры по умолчанию.
