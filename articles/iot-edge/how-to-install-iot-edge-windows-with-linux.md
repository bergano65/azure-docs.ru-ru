...
5. **Initialize IoTEdge** команда настраивает среду выполнения IoT Edge на вашем компьютере. По умолчанию используется ручной подготовки с помощью строки подключения устройства. Объявите Linux нужного контейнера операционной системы. 
