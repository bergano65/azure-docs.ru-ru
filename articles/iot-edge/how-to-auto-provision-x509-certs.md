...
[Служба подготовки устройств для центра Интернета вещей Azure (DPS)](../iot-dps/index.yml)позволяет автоматически подготавливать IOT Edge устройства с помощью сертификатов X. 509. Если вы не знакомы с процессом автоматической подготовки, прежде чем продолжить, ознакомьтесь с обзором [подготовки](../iot-dps/about-iot-dps.md#provisioning-process) .
