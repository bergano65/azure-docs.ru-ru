...
1. Выберите **Добавить отдельную регистрацию** и выполните следующие действия для настройки регистрации.  
   ...
   * **Начальное состояние двойникаа устройства**: добавьте значение тега, добавляемое в двойника устройства, если хотите. Теги можно использовать для целевых групп устройств для автоматического развертывания. Например:
...
При добавлении сертификата X. 509 и сведений о ключе в файл config. YAML эти пути должны быть указаны в виде URI файлов. Например:
