...
* **IoT Edge 1,2 (Предварительная версия)** содержит дополнительное содержимое для функций и возможностей, которые находятся в последнем предварительном выпуске: [1,2-RC1](https://github.com/Azure/azure-iotedge/releases/tag/1.2-rc1)
...
| Заметки о выпуске и активы | Тип | Date | Особенности |
| ------------------------ | ---- | ---- | ---------- |
| [1,2 — RC1](https://github.com/Azure/azure-iotedge/releases/tag/1.2-rc1) | Предварительный просмотр | Ноябрь 2020 г. | [IoT Edge устройств за шлюзами](how-to-connect-downstream-iot-edge-device.md?view=iotedge-2020-11&preserve-view=true)<br>[Брокер IoT Edge MQTT](how-to-publish-subscribe.md?view=iotedge-2020-11&preserve-view=true) |
