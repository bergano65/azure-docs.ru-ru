...
5. **Параметры создания контейнера.** Укажите в приведенном ниже коде JSON собственные значения и замените JSON на странице портала:
...
2. В палитре команд введите и выполните команду **Azure IoT Edge: New IoT Edge Solution** (Azure IoT Edge: создать решение IoT Edge). 
