...
| Поле | Возможные значения | Пояснение |
| ----- | ----- | ---- |
...
Можно также попытаться [обозреватель службы хранилища Azure](https://azure.microsoft.com/features/storage-explorer/) для подключения к учетной записи локального хранилища. Мы постарались с [предыдущей версии 1.5.0](https://github.com/Microsoft/AzureStorageExplorer/releases/tag/v1.5.0) обозревателя Azure.
> [!NOTE]
> Могут возникнуть ошибки, выполняя следующие действия, игнорировать и обновить. 
