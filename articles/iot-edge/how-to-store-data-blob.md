...
| делетеафтеруплоад | true, false | По умолчанию имеет значение `false`. Если задано значение `true`, то при завершении отправки в облачное хранилище данные будут автоматически удалены. <br><br> Переменная среды: `deviceToCloudUploadProperties__deleteAfterUpload={false,true}` |
