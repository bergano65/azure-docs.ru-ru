...
3. Обратите внимание, что этот файл использует [переменные сборки Azure DevOps](/azure/devops/pipelines/build/variables?view=vsts#build-variables) в параметре **версия**. Эта конфигурация гарантирует, что новая версия модуля будет создаваться каждый раз при выполнении новой сборки.
