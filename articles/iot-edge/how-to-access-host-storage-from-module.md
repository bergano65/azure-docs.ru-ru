...
Чтобы настроить хранилище в основной системе, создайте переменную среды для модуля, указывающего на папку хранилища в контейнере. Затем используйте параметры создания для привязки этой папки хранения к папке на хост-компьютере.
