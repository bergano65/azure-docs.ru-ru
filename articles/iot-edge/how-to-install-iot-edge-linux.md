...
С помощью фигурных команд можно ориентироваться на файлы компонентов непосредственно из репозитория IoT Edge GitHub. Чтобы установить либиоссм и управляющую программу безопасности IoT Edge, выполните следующие действия. Установите подсистему значок Кита Engine и CLI, выполнив действия, описанные в разделе [Установка среды выполнения контейнера](#install-a-container-runtime) .
