...
Выполните действия, описанные в разделе [Настройка устройства IOT Edge для](how-to-create-transparent-gateway.md)работы в качестве прозрачного шлюза.
