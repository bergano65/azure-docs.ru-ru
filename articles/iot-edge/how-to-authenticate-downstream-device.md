...
* Выберите **задать родительское устройство** и выберите устройство шлюза IOT EDGE, с помощью которого будет подключаться это подчиненное устройство. Этот шаг включает [возможности автономного](offline-capabilities.md) подключения для подчиненного устройства. Вы всегда можете изменить родительский элемент позже.
