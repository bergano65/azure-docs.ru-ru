...
* [Docker для Linux](https://docs.docker.com/config/daemon/systemd/#httphttps-proxy)
* [Docker для Windows](https://docs.microsoft.com/virtualization/windowscontainers/manage-docker/configure-docker-daemon#proxy-configuration)
