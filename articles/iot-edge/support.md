...
| Raspberry Pi OS бустер <sup>1</sup> |  | ![Raspberry Pi OS бустер + ARM32v7](./media/tutorial-c-module/green-check.png) | ![Raspberry Pi OS бустер + ARM64](./media/tutorial-c-module/green-check.png) |
