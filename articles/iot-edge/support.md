...
![подсистему значок Кита в качестве](./media/support/only-moby-for-production.png)
среды выполнения контейнеров </center>
...
![Azure IoT Edge в](./media/support/edge-on-vm.png)
виртуальной машины </center>
