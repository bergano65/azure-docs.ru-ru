...
* Если необходимо запустить среду выполнения Azure IoT Edge в локальной системе, следуйте инструкциям в статье [Установка среды выполнения Azure IoT Edge в Linux (x64)](how-to-install-iot-edge-linux.md).

* Если необходимо использовать устройство на базе ARM32, например Raspberry Pi, следуйте инструкциям в разделе [Выполнение установки Azure IoT Edge в Linux (ARM32v7/armhf)](how-to-install-iot-edge-linux-arm.md).
