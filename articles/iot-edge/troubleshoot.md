...
Типы проверок, проводимых инструментом, можно классифицировать как:
...
Полный список диагностических проверок можно найти [ввстроенную функцию устранения неполадок.](https://github.com/Azure/iotedge/blob/master/doc/troubleshoot-checks.md)
