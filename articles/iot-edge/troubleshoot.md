...
Вы можете проверить установку IoT Edge на устройствах, выполнив [мониторинг модуля edgeAgent двойника](https://docs.microsoft.com/azure/iot-edge/how-to-monitor-module-twins).
...
Эта команда выводит все [сообщаемые свойства](https://docs.microsoft.com/azure/iot-edge/module-edgeagent-edgehub)edgeAgent. Ниже приведены некоторые полезные рекомендации по мониторингу состояния устройства.
