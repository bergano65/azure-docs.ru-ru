...
### <a name="resolution"></a>Способы устранения:
Укажите DNS-сервера для вашей среды в параметры ядра контейнера. Создайте файл с именем `daemon.json` указание DNS-сервер для использования. Например: 
