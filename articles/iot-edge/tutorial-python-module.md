...
>* Правильный ли ваш репозиторий контейнеров? Откройте **modules** > **cmodule** > **module.json** и найдите поле **репозитория**. Репозиторий образов должен выглядеть так: **\<имя_реестра\>.azurecr.io/pythonmodule**. 
