...
3. Задайте для свойств **сертификата** в файле config. YAML URI файла сертификата и файлов ключей на устройстве IOT Edge. Удалите символ `#` перед свойствами сертификата, чтобы раскомментировать четыре строки. Помните, что отступы в YAML — это два пробела. Пример.
