...
Устройства Azure IoT Edge можно подготовить автоматически с помощью [Службы подготовки устройств к добавлению в Центр Интернета вещей](../iot-dps/index.yml) точно так же, как и другие устройства. Если вы не знакомы с процессом автоматической подготовки, прежде чем продолжить, ознакомьтесь с обзором [подготовки](../iot-dps/about-iot-dps.md#provisioning-process) .
