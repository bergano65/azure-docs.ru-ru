---
title: Автоматически подготавливать устройства с помощью политики диагностики симметричных ключей — Azure IoT Edge | Документация Майкрософт
...
1. Команда **Initialize-IoTEdge** настраивает среду выполнения IoT Edge на вашем компьютере. По умолчанию команда выполняется вручную с контейнерами Windows, если для использования автоматической подготовки не используется флаг `-Dps`.
