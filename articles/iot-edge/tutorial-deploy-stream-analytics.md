...
1. Если вы уже развертывали модуль SimulatedTemperatureSensor на этом устройстве, его параметры могут заполниться автоматически. Если же он не установлен, добавьте модуль следующим образом.
   ...
   1. Оставьте другие параметры без изменений и выберите **Добавить**.
...
1. Выберите **Обновить** или **Отмена**.

1. Запишите имя модуля Stream Analytics, так как оно понадобится вам на следующем шаге. Затем щелкните **Далее. Маршруты**.
