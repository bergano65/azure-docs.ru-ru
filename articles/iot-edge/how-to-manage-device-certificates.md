...
По истечении указанного числа дней необходимо перезапустить управляющую программу IoT Edge безопасности, чтобы повторно создать сертификат ЦС устройства, он не будет обновлен автоматически.
...
После указания значения в файле config. YAML выполните следующие действия.
