...
1. Щелкните устройство IoT Edge правой кнопкой мыши, чтобы создать его развертывание. Перейдите к манифесту развертывания, настроенному для вашей платформы, расположенной в папке **config** в решении Visual Studio, `deployment.arm32v7.json`например.
