...
1. На [портале Azure](https://portal.azure.com) выберите **Создать ресурс** > **Контейнеры** > **Реестр контейнеров**.
    ...
    ![Создание реестра контейнеров на портале Azure](./media/tutorial-deploy-function/create-container-registry.png)
...
3. В палитре команд введите и выполните команду **Azure IoT Edge: Создать решение IoT Edge**. Следуйте инструкциям на экране в палитре команд для создания решения.
...
2. Найдите и выполните команду **Azure: Войти**. Следуйте инструкциям, чтобы войти в свою учетную запись Azure. 

3. В палитре команд найдите и выполните команду **Центр Интернета вещей: выбрать Центр Интернета вещей**. 
