---
title: Учебник по разработке модулей C# для Windows с помощью Azure IoT Edge
...
3. Присвойте проекту и решению описательное имя, например **CSharpTutorialApp**. Щелкните **Создать**, чтобы создать проект.
