...
Многоуровневые развертывания можно создавать и управлять с помощью Azure CLI, как и при любом автоматическом развертывании, с помощью всего нескольких различий. После создания многоуровневого развертывания тот же Azure CLI работает для многоуровневых развертываний так же, как и любое развертывание. Чтобы создать многослойное развертывание, добавьте флаг `--layered` в команду Create. 
...
Используйте ту же команду с флагом `--layered`, чтобы создать многоуровневый деплоймет.
