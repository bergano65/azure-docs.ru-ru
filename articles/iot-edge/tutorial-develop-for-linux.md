...
9. В нижней части Explorer разверните свернутый раздел **Устройства Центра Интернета вещей Azure**. Вы увидите устройства и устройства IoT Edge, связанные с Центром Интернета вещей, который вы выбрали в палитре команд.
