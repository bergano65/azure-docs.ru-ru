...
Чтобы установить с автономными компонентами, используйте параметр `-OfflineInstallationPath` в составе команды deploy-IoTEdge и укажите абсолютный путь к каталогу файлов. Пример:
...
| Параметр | Допустимые значения | Comments |
| --------- | --------------- | -------- |
