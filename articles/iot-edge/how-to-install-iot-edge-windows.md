...
Если устройство IoT Edge является компьютером под управлением Windows, убедитесь, что оно соответствует [системным требованиям](https://docs.microsoft.com/virtualization/hyper-v-on-windows/reference/hyper-v-requirements) для использования Hyper-V. При использовании виртуальной машины включите [вложенную виртуализацию](https://docs.microsoft.com/virtualization/hyper-v-on-windows/user-guide/nested-virtualization) и выделите не менее 2 ГБ памяти.
