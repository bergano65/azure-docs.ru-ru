...
Эта статья предназначена для разработчиков, которым требуется более глубокое понимание работы полнотекстового поиска Lucene в Azure Когнитивный поиск. Для текстовых запросов Когнитивный поиск Azure будет легко доставлять ожидаемые результаты в большинстве сценариев, но иногда вы можете получить результат, который кажется «отключенным». В таких ситуациях понимание четырех этапов выполнения запросов Lucene (синтаксический анализ запроса, лексический анализ, поиск соответствующего документа и оценка) помогут определить характерные изменения параметров запроса или конфигурации индекса, которые приведут к желаемому результату. 
...
| Срок действия | Список документов |
|------|---------------|
| atman | 1 |
| beach | 2 |
| hotel | 1, 3 |
