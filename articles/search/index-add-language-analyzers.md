...
Используйте параметр запроса **searchFields**, чтобы указать поля для других языков, в которых будет выполнен запрос. В [документах поиска](https://docs.microsoft.com/rest/api/searchservice/search-documents)можно просмотреть примеры запросов, включающие свойство анализатора. 
...
+ [Создание индекса &#40;Azure Когнитивный поиск REST API&#41;](https://docs.microsoft.com/rest/api/searchservice/create-index)  
