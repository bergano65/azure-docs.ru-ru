...
После добавления службы поиска Azure в учетную запись хранения можно выполнить стандартный процесс, чтобы расширить данные в любом источнике данных Azure. Если у вас уже есть содержимое большого двоичного объекта, вы можете использовать мастер импорта данных в службе поиска Azure, чтобы ознакомиться с простым введением в обогащение искусственного интеллекта. В этом кратком руководстве описаны действия по [созданию конвейера обогащения искусственного интеллекта на портале](cognitive-search-quickstart-blob.md). 

В следующих разделах мы рассмотрим больше компонентов и концепций.

## <a name="begin-with-blob-indexers"></a>Начало с индексаторами BLOB-объектов
...
## <a name="how-to-use-ai-enriched-content"></a>Как использовать содержимое из искусственного интеллекта

Выходным результатом искусственного интеллекта является индекс поиска в службе поиска Azure или хранилище знаний в службе хранилища Azure.
