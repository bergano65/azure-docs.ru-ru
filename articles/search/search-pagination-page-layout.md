...
Структура ответа определяется параметрами в документе запрос: [Поиск](/rest/api/searchservice/Search-Documents) в REST API или [классе SearchResults](/dotnet/api/azure.search.documents.models.searchresults-1) в пакете SDK для .NET.
