...
Форматирование применяется к запросам целых терминов. Тип форматирования определяется тегами, `highlightPreTag` `highlightPostTag`и код обрабатывает ответ (например, применение полужирного шрифта или желтого фона).
