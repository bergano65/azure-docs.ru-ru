...
Услуги, созданные после 15 июля 2020 года, предоставят другой опыт выделения. Службы, созданные до этой даты, не изменятся в поведении выделений. 

С новым поведением:

* Будут возвращены только фразы, которые соответствуют полному запросу фразы. Запрос "супер чаша" вернет основные моменты следующим образом:

    ```html
    '<em>super bowl</em> is super awesome with a bowl of chips'
    ```
  Обратите внимание, что термин *чаша фишек* не имеет никакого выделения, поскольку он не соответствует полной фразе.
  
* Можно будет указать размер фрагмента, возвращенный для изюминки. Размер фрагмента указан как количество символов (максимум 1000 символов).
