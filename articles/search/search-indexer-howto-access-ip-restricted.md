...
IP-адрес службы поиска можно получить, выполнив `nslookup` (или `ping` ) полное доменное имя. В приведенном ниже примере вы добавите "10.50.10.50" в правило входящего трафика в брандмауэре службы хранилища Azure.
...
- [Настройка брандмауэра IP для Cosmos DB](../cosmos-db/firewall-support.md)
