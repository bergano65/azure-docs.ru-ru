...
description: Сканирование больших двоичных объектов Azure для текстового содержимого с помощью индексатора BLOB-объектов поиска Azure Конгитиве. Каждый большой двоичный объект может подавать один или несколько документов поискового индекса.
manager: nitinme
author: arv100kri
ms.author: arjagann
ms.devlang: rest-api
...
Если вы еще не знакомы с базовой структурой и рабочим процессом индексирования BLOB-объектов, сначала ознакомьтесь [с индексацией хранилища BLOB-объектов Azure с помощью Azure Конгитиве Search](search-howto-index-json-blobs.md) . Дополнительные сведения о режимах синтаксического анализа для различных типов содержимого больших двоичных объектов см. в следующих статьях.
