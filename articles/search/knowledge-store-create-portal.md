...
> [!Note]
> Хранилище знаний предоставляется в предварительной версии и не предназначено для использования в рабочей среде. Портал Azure и [REST API службы "Поиск" версии 2019-05-06-Preview](search-api-preview.md) предоставляют этот компонент. Поддержка пакета SDK для .NET пока не реализована.
>
