...
Конвейер принимает изображения и неструктурированный текст в виде необработанного содержимого, применяет ИИ с помощью служб Cognitive Services (например, распознавание текста, анализ изображений и обработку естественного языка), а также извлекает информацию и выводит новые структуры и сведения. Одним из физических артефактов, созданных конвейером, является [хранилище знаний](knowledge-store-concept-intro.md), доступ к которому можно получить с помощью средств для анализа и просмотра содержимого.
