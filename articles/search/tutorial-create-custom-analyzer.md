...
Исходный код примера для этого руководства расположен в папке [custom-analyzers](https://github.com/Azure-Samples/azure-search-postman-samples/custom-analyzers) репозитория [Azure-Samples/azure-search-postman-samples](https://github.com/Azure-Samples/azure-search-postman-samples) на сайте GitHub.
