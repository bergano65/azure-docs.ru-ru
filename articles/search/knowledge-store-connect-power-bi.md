...
ms.locfileid: "73485156"
---
# <a name="connect-a-knowledge-store-with-power-bi"></a>Подключение хранилища знаний с помощью Power BI

> [!Note]
> Хранилище знаний предоставляется в предварительной версии и не предназначено для использования в рабочей среде. Портал и [REST API службы "Поиск" версии 2019-05-06-Preview](search-api-preview.md) предоставляют этот компонент. Поддержка пакета SDK для .NET пока не реализована.
>
...
+ Вам потребуется хранилище знаний с проекцией в хранилище таблиц Azure. Кроме того, вам потребуется имя учетной записи хранения Azure, которая использовалась для создания хранилища знаний, а также его ключ доступа из портала Azure.

Если вы хотите работать с примером хранилища знаний, следуйте инструкциям по [созданию хранилища знаний](knowledge-store-create-portal.md).
