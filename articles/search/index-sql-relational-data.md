...
1. Выполните команду `SELECT * FROM dbo.HotelRooms` , чтобы получить набор строк. Этот запрос возвращает 50 строк, по одному на гостиницу, со связанной информацией о комнате в виде коллекции JSON. 
