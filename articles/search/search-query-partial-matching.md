...
> [!TIP]
> Знакомы с API-интерфейсами почтовых и других функций? [Скачайте коллекцию примеров запросов](https://github.com/Azure-Samples/azure-search-postman-samples/) , чтобы запросить частичные термины и специальные символы, описанные в этой статье.
