---
title: Примеры запросов с использованием синтаксиса "Simple" для поиска Azure
...
ms.locfileid: "69647615"
---
# <a name="query-examples-using-the-simple-search-syntax-in-azure-search"></a>Примеры запросов с использованием синтаксиса поиска "Simple" в службе поиска Azure
