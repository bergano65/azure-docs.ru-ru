...
+ При секционировании данных на небольшие отдельные источники данных можно применять параллельную обработку. Можно разбить большой набор данных на небольшие наборы данных, а затем создать несколько определений источников данных индексатора, которые могут индексироваться параллельно.
