...
+ Сопоставьте каждый небольшой набор данных с его [источником данных](https://docs.microsoft.com/rest/api/searchservice/create-data-source) и создайте для каждого свой [индексатор](https://docs.microsoft.com/rest/api/searchservice/create-indexer).
