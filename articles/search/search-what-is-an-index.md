...
Так как физические структуры созданы в службе, для внесения значительных изменений в существующее определение поля требуется [удаление и повторное создание индексов](search-howto-reindex.md). Это означает, что на время разработки необходимо запланировать частые операции перестроения. Можно рассмотреть возможность использования подмножества данных, чтобы ускорить перестроение. 
