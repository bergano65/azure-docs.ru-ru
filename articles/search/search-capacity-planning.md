...
При перестроении индекса будет существовать период времени, когда данные добавляются в новый индекс. Если вы хотите продолжить доступ к старому индексу в течение этого времени, необходимо иметь копию старого индекса с другим именем в той же службе или копию индекса с тем же именем в другой службе. , а затем укажите в коде логику перенаправления или отработки отказа.
