...
Конфигурация ресурсов доступна при настройке службы на уровне [Базовый](https://aka.ms/azuresearchbasic) или на одном из уровней [Стандартный](search-limits-quotas-capacity.md). Для всех служб на этих уровнях емкость приобретается в *единицах поиска*, где каждая секция и реплика принимается за одну единицу поиска. 
...
Все стандартные службы можно предположить, перечисленных ниже комбинациями реплик и секций, ограничение 36 единиц поиска. 
