...
Для массива JSON запрос индексатора использует анализатор `jsonArray`. Это единственные два требования к массиву для индексирования больших двоичных объектов JSON.
...
+ [Руководство. Поиск частично структурированных данных в облачном хранилище Azure](search-semi-structured-data.md)
