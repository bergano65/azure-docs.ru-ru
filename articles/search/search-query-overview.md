...
| [Postman или другой инструмент тестирования HTTP](search-fiddler.md) | Описывается настройка заголовка и текста HTTP-запроса для отправки запросов к Поиску Azure.  |
