...
[Анализатор](https://docs.microsoft.com/dotnet/api/microsoft.azure.search.models.analyzer?view=azure-dotnet)вызовов с указанием типа [анализернаме](https://docs.microsoft.com/dotnet/api/microsoft.azure.search.models.analyzername?view=azure-dotnet) , предоставляющего анализатор текста, поддерживаемый службой поиска Azure.
