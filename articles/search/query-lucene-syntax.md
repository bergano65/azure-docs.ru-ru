...
##  <a name="bkmk_fuzzy"></a> Поиск нечетких соответствий  
 ...
 Поиск нечетких соответствий можно применять только к терминам, а не к фразам. Поиск нечетких соответствий может расширить термин до максимум 50 терминов, соответствующих критерию расстояния.
...
##  <a name="bkmk_boolean"></a> Логические операторы  
