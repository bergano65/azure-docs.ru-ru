---
title: Советы по устранению неполадок при обогащении искусственного интеллекта
...
ms.locfileid: "72787703"
---
# <a name="troubleshooting-tips-for-ai-enrichment-in-azure-cognitive-search"></a>Советы по устранению неполадок при обогащении искусственного интеллекта в Azure Когнитивный поиск
...
Если проблема связана с размером файла, может появиться следующее сообщение об ошибке: "имя файла \<BLOB-объекта >" имеет размер \<размер файла > байт, что превышает максимальный размер для извлечения документа для текущего уровня служб ". Дополнительные сведения об ограничениях индексатора см. в разделе [Ограничения служб](search-limits-quotas-capacity.md).
