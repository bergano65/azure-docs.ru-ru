...
Навык **формирователя** создает элемент *analyzedText* с объединенными элементами *text* и *sentiment*. Эти выходные данные соответствует схеме индекса. Он будет импортирован и проиндексирован в индексе Azure Когнитивный поиск.
