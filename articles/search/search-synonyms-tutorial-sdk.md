---
title: Руководство по C# — служба "Поиск Azure"
description: Из этого руководства по C# вы узнаете, как добавить функцию синонимов в индекс в службе "Поиск Azure". Карта синонимов — это список эквивалентных терминов. Поля с поддержкой синонимов расширяют запросы, позволяя включать в них указанный пользователем термин и все его синонимы.
manager: cgronlun
author: HeidiSteen
services: search
ms.service: search
