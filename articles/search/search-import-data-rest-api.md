---
title: Отправка данных в коде с помощью REST API службы поиска — Поиск Azure
description: Узнайте, как отправлять данные в полнотекстовый индекс с поддержкой поиска в службе "Поиск Azure" с помощью HTTP-запросов и REST API.
author: brjohnstmsft
manager: jlembicz
ms.author: brjohnst
services: search
