---
title: Мониторинг состояния индексатора и результатов — Поиск Azure
description: Отслеживайте состояние, ход выполнения и результаты индексаторов службы "Поиск Azure" в портал Azure с помощью REST API или пакета SDK для .NET.
ms.date: 06/28/2019
author: RobDixon22
manager: HeidiSteen
ms.author: heidist
...
ms.locfileid: "68840733"
---
# <a name="how-to-monitor-azure-search-indexer-status-and-results"></a>Мониторинг состояния индексатора поиска Azure и результатов

Служба поиска Azure предоставляет сведения о состоянии и мониторинге текущих и исторических запусков каждого индексатора.
...
## <a name="find-indexer-status-and-history-details"></a>Поиск состояния индексатора и сведений о журнале
...
## <a name="monitor-indexers-in-the-portal"></a>Мониторинг индексаторов на портале
...
Дополнительные сведения об анализе ошибок и предупреждений индексатора см. [в разделе Устранение распространенных проблем с индексатором в службе поиска Azure](search-indexer-troubleshooting.md).

<a name="restapi"></a>

## <a name="monitor-indexers-using-the-rest-api"></a>Мониторинг индексаторов с помощью REST API
...
## <a name="monitor-indexers-using-the-net-sdk"></a>Мониторинг индексаторов с помощью пакета SDK для .NET
