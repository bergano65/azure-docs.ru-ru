...
description: Используйте мастер импорта данных для создания, загрузки и запроса первого индекса службы "Когнитивный поиск Azure".
author: lobrien
manager: nitinme
ms.author: laobri
...
С помощью портала можно быстро освоить основные понятия и создавать интересные запросы к индексу за считаные минуты.

> [!div class="checklist"]
> * Начните работу с тестовым набором данных, размещенным в Azure для бесплатного и открытого доступа.
> * Запустите мастер **импорта данных** в Когнитивном поиске Azure, чтобы загрузить данные и создать индекс
...
Вы можете детальнее изучить службу "Когнитивный поиск Azure" с помощью программных средств, следуя инструкциям в таких статьях:
...
* [Краткое руководство. Создание индекса службы "Поиск Azure" в Postman с помощью REST API](search-get-started-postman.md)
