---
title: Руководство по индексированию, отправке запросов и фильтрации в службе поиска Azure на портале Azure | Документация Майкрософт
...
ms.locfileid: "53314029"
---
# <a name="tutorial-use-built-in-portal-tools-for-azure-search-indexing-and-queries"></a>Руководство. Использование встроенных инструментов на портале для отправки запросов и индексирования в службе поиска Azure
...
### <a name="step-2-define-the-index"></a>Шаг 2. Определение индекса
...
### <a name="step-3-define-the-indexer"></a>Шаг 3. Определение индексатора
...
### <a name="step-4-view-the-index"></a>Шаг 4. Просмотр индекса
