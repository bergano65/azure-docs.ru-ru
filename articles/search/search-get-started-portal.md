---
title: Краткое руководство. Создание индекса службы "Поиск Azure" с помощью портала Azure
...
Чтобы быстро освоить основные концепции Поиска Azure, попробуйте воспользоваться встроенными средствами на портале Azure. Эти мастеры и редакторы не полностью соответствуют возможностям интерфейсов API .NET и REST, но зато позволяют быстро начать работу без написания кода и всего за несколько минут создать интересные запросы к индексу.
