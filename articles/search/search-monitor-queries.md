...
В этой статье объясняется, как измерять производительность запросов и томов с помощью метрик и ведения журнала диагностики. Здесь также объясняется, как собираются входные термины, используемые в запросах. необходимые сведения необходимо для оценки служебной программы и эффективности поиска совокупности.
...
| Число | Число метрик, переданных в журнал в течение интервала в один минуту. |
