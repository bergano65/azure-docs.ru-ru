...
| Тип статистической обработки | Description |
|------------------|-------------|
| Среднее | Среднее число секунд в течение минуты, в течение которых произошло выполнение запроса.|
| Количество | Число метрик, переданных в журнал в течение интервала в один минуту. |
| Максимум | Максимальное число поисковых запросов в секунду, зарегистрированных в течение минуты. |
| Минимальное | Наименьшее количество поисковых запросов в секунду, зарегистрированных в течение минуты.  |
...
| Минимальное | Кратчайший запуск запроса в примере.  | 
...
| Минимальное | Процент запросов, отбрасываемых в пределах интервала. |
