...
| Минимальные требования | Наименьшее количество поисковых запросов в секунду, зарегистрированных в течение минуты.  |
...
| Минимальные требования | Кратчайший запуск запроса в примере.  | 
...
| Минимальные требования | Процент запросов, отбрасываемых в пределах интервала. |
