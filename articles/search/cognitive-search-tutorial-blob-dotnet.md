---
title: Учебник по C#. Вызовы API-интерфейсов Cognitive Services в конвейере обогащения данных с помощью средств ИИ
titleSuffix: Azure Cognitive Search
description: Ознакомьтесь с примером извлечения данных, обработки естественного языка и изображений с применением искусственного интеллекта в конвейере индексирования и обогащения Когнитивного поиска Azure.
manager: nitinme
author: MarkHeff
ms.author: maheff
...
ms.locfileid: "72790226"
---
# <a name="c-tutorial-call-cognitive-services-apis-in-an-azure-cognitive-search-indexing-pipeline"></a>Руководство по C#. Вызов API-интерфейсов Cognitive Services в конвейере индексирования службы "Когнитивный поиск Azure"
