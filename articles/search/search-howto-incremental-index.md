---
title: Настройка добавочной индексации расширенного отслеживания изменений на основе содержимого
titleSuffix: Azure Cognitive Search
description: Включение отслеживания изменений и сохранение состояния расширенного содержимого для контролируемой обработки в наборе автонавыков.
author: vkurpad
manager: eladz
ms.author: vikurpad
...
Добавочное индексирование настраивается с помощью [API поиска по оставшимся версии = 2019-05 -06-Preview](https://docs.microsoft.com/rest/api/searchservice/Indexer-operations).

> [!NOTE]
> Эта функция пока недоступна на портале и должна использоваться программно.
>
