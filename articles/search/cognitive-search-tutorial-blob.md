---
title: Руководство по использованию REST. Создание конвейера обогащения ИИ для извлечения текста и структуры из больших двоичных объектов JSON
