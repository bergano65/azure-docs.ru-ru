...
1. Для расположения выберите **центрально-южную часть США** или **Западную Европу**. В настоящее время предварительная версия доступна только в этих регионах.
...
> [!TIP]
> Теперь, прежде чем проделать большой объем работы, самое время убедиться, что служба поиска работает в одном из поддерживаемых расположений, в которых предоставляется функция предварительной версии: центрально-южная часть США или Западная Европа.
