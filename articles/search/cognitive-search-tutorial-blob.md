---
title: Руководство по Вызов API-интерфейсов Cognitive Services в конвейере индексирования Поиска Azure
description: Ознакомьтесь с примером извлечения данных, обработки естественного языка и изображений с применением искусственного интеллекта в индексировании службы "Поиск Azure" для извлечения и преобразования данных с применением больших двоичных объектов JSON.
manager: pablocas
author: luiscabrer
services: search
ms.service: search
...
ms.locfileid: "59261927"
---
# <a name="tutorial-call-cognitive-services-apis-in-an-azure-search-indexing-pipeline-preview"></a>Руководство по Вызов API-интерфейсов Cognitive Services в конвейере индексирования Поиска Azure (предварительная версия)
...
### <a name="get-an-azure-search-api-key-and-endpoint"></a>Получение ключа API и конечной точки службы "Поиск Azure"
