...
+ [Azure Key Vault](../key-vault/secrets/quick-create-portal.md#create-a-vault) в той же подписке, что и когнитивный Поиск Azure. Для хранилища ключей должна быть включена **Защита от** **обратимого удаления** и очистки.
