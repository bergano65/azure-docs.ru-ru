...
После создания ресурса Azure Key Vault включите **обратимое удаление** и **очистку** в выбранном хранилище ключей, выполнив следующие команды PowerShell или Azure CLI:   
