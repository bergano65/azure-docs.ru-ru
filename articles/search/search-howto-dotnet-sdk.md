...
Пакет SDK для .NET поддерживает версию `2017-11-11` [интерфейса REST API службы поиска Azure](https://docs.microsoft.com/rest/api/searchservice/). Эта версия теперь поддерживает синонимы, а также дополнительные улучшения для индексаторов. Те функции предварительной версии, которые *не* вошли в эту версию, включая поддержку индексирования массивов JSON и файлов CSV, доступны в [предварительной версии](search-api-2016-09-01-preview.md). Их можно найти в версии [4.0-preview пакета SDK для .NET](https://aka.ms/search-sdk-preview).
