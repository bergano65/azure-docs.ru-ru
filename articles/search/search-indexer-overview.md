...
* Если документ является PDF-файлом в [источнике данных хранилища больших двоичных объектов Azure](search-howto-indexing-azure-blob-storage.md), то индексатор извлечет текст, изображения и метаданные для файла.
