...
Индексаторы доступны только для Azure, с индивидуальными индексаторами для Azure SQL, Azure Cosmos DB, хранилищем таблиц Azure и хранилищем BLOB-объектов. При настройке индексатора необходимо указать источник данных (исходный), а также индекс (назначение). Несколько источников данных, таких как индексаторы хранилища BLOB-объектов, имеют дополнительные свойства, относящиеся к этому типу содержимого.
