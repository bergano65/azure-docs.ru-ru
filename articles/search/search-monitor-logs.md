...
Ведение журнала диагностики включено с помощью интеграции с [Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/). 
...
| operationVersion |string |"2020-06-30" |Используемая версия API |
| категория |string |"OperationLogs" |constant |
...
| Query_s |string |"? Поиск = AzureSearch&$count = true&API-Version = 2020-06-30" |Параметры запроса |
