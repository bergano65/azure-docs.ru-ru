---
title: Мониторинг использования и статистика в службе поиска — Поиск Azure
...
* Число запросов в секунду (QPS) — число запросов поиска, получаемых в секунду (данные агрегируются поминутно).
* Процент регулируемых запросов поиска — процент отрегулированных поисковых запросов для службы поиска (данные агрегируются поминутно).
