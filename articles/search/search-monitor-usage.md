...
Оповещения, связанные с хранилищем, в настоящее время недоступны; потребление хранилища не будет агрегировано или входить в таблицу **азуреметрикс** в Azure Monitor. Вам потребуется [создать пользовательское решение](https://docs.microsoft.com/azure/azure-monitor/insights/solutions-creating) , которое выдает уведомления, связанные с ресурсами, где код проверяет размер хранилища и обрабатывает ответ. Дополнительные сведения о метриках хранилища см. в статье [Получение статистики службы](https://docs.microsoft.com/rest/api/searchservice/get-service-statistics#response).
...
К зарегистрированным событиям относятся связанные с индексированием и запросами. Таблица **AzureDiagnostics** в log Analytics собирает операционные данные, связанные с запросами и индексацией.
