...
**Free** создает ограниченный поисковый сервис для небольших проектов, включая quickstarts и учебники. Внутренне реплики и разделы распределяются между несколькими подписчиками. Вы не можете масштабировать бесплатную службу или запускать значительные рабочие нагрузки.

**Basic** и **Standard** являются наиболее часто используемыми оплачиваемыми уровнями, при этом **Стандартный** является по умолчанию. С помощью выделенных ресурсов под вашим контролем можно развертывать более крупные проекты, оптимизировать производительность и устанавливать емкость.
...
+ Фиксированная стоимость самой службы, работая 24x7, при минимальной конфигурации (одна перегородка и реплика)
...
+ Когнитивный поиск (присоединение когнитивных служб для обогащения ИИ или использование хранилища Azure для хранения знаний)
