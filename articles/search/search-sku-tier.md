...
|Уровень | Capacity |
|-----|-------------|
|Бесплатный | Совместно с другими подписчиками. Немасштабируемая, ограниченная трех индексов и 50 МБ памяти. |
...
В службе поиска Azure существует три способа хранение будет сопровождаться затратами в службе поиска Azure, и компоненты фиксированных и переменных. В этом разделе рассматривается каждый компонент выставления счетов в свою очередь.
...
Для [индексирования искусственного Интеллекта с помощью Cognitive Services](cognitive-search-concept-intro.md), необходимо запланировать присоединение оплачиваемых ресурса Cognitive Services, в том же регионе поиска Azure на ценовую категорию S0 для оплаты по мере использования обработки. Плата не взимается «основных» связан присоединение Cognitive Services. Вы платите только за обработку.
