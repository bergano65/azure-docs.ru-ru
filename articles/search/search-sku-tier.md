...
+ Количество индексов и других объектов (максимальные пределы)
+ скорость секционирования и размер секций (физического хранилища).
+ Оплачиваемая ставка, фиксированная стоимость, которая также расходится с учетом количества используемых секций и реплик
...
+ [Стоимость самой службы](#service-costs) , выполнение круглосуточная с минимальной конфигурацией (один раздел и реплика) с базовым курсом.
