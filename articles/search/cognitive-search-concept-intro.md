---
title: Когнитивный поиск для извлечения данных и обработки естественной речи c помощью искусственного интеллекта в службе "Поиск Azure" | Документация Майкрософт
...
ms.locfileid: "45729058"
---
# <a name="what-is-cognitive-search"></a>Что такое когнитивный поиск?

Когнитивный поиск создает информацию, доступную для поиска, из содержимого, не подлежащего поиску, путем присоединения алгоритмов искусственного интеллекта к конвейеру индексирования. Интеграция искусственного интеллекта осуществляется через *когнитивные навыки* и обогащает исходные документы при создании индекса для поиска. 

Навыки **обработки естественного языка** включают в себя [распознавание сущностей](cognitive-search-skill-named-entity-recognition.md), определение языка, [извлечение ключевых фраз](cognitive-search-skill-keyphrases.md), обработку текста и определение тональности. С помощью этих навыков неструктурированный текст становится структурированным, сопоставляемым с полями поиска и фильтрации в индексе.

Навыки **обработки изображений** охватывают [распознавание текста](cognitive-search-skill-ocr.md) и идентификацию [визуальных функций](cognitive-search-skill-image-analysis.md), таких как обнаружение лица, интерпретация изображений, распознавание изображений (известные люди и ориентиры) или атрибутов, таких как цвета или ориентация изображений. Вы можете создавать текстовые представления содержимого изображения, по которым можно выполнять поиск, используя все возможности запросов службы "Поиск Azure".
...
Когнитивные навыки службы "Поиск Azure" основываются на тех же алгоритмах искусственного интеллекта, которые применяются в API-интерфейсах Cognitive Services. В их число входят [API распознавания именованных сущностей](cognitive-search-skill-named-entity-recognition.md), [API извлечения ключевых фраз](cognitive-search-skill-keyphrases.md) и [API распознавания текста](cognitive-search-skill-ocr.md). 
...
Функция когнитивного поиска доступна в режиме предварительной версии для всех уровней службы [Поиск Azure](search-what-is-azure-search.md) в регионах "Центрально-южная часть США" и "Западная Европа". 
