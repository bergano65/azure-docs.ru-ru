...
| Обработка естественного языка | Обработка текста для получения аналитических сведений о текстовых входных данных. Определение языка, анализ тональности и извлечения ключевых фраз — вот основные примеры навыков, относящихся к обработке естественной речи.  | Ознакомьтесь со статьями о навыках [извлечения ключевых фраз](cognitive-search-skill-keyphrases.md), [распознавания языка](cognitive-search-skill-language-detection.md), [перевода текста (предварительная версия)](cognitive-search-skill-text-translation.md) и [анализа тональности](cognitive-search-skill-sentiment.md) |
...
| Кэш индексатора | Выходные данные навыков учетной записи хранения кэшируются индексатором. Кэш позволяет индексатору минимизировать затраты на обработку большого количества документов при редактировании набора навыков. | См. [Добавочное индексирование](cognitive-search-incremental-indexing-conceptual.md) | 
