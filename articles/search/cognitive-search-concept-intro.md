...
---
# <a name="getting-started-with-ai-enrichment"></a>Приступая к работе с ИСКУССТВЕНным совершенствованием

Обогащение искусственного интеллекта — это возможность индексирования Когнитивный поиск Azure, используемая для извлечения текста из изображений, больших двоичных объектов и других неструктурированных источников данных. Обогащение и извлечение упрощают поиск содержимого в [индексе](search-what-is-an-index.md) или в [хранилище знаний](knowledge-store-concept-intro.md). Извлечение и дополнение реализуются с помощью качественных *навыков* , присоединенных к конвейеру индексирования. В службу встроены когнитивные навыки приведенных ниже категорий. 
