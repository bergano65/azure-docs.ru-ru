...
Когнитивный поиск с готовыми навыками хорошо подходит для следующих сценариев использования.
...
+ Файлы PDF с изображением и текстом. Текст в файлах PDF может быть извлечен во время индексирования службы "Поиск Azure" без использования Когнитивного поиска, но добавление обработки изображений и естественного языка часто может предоставить лучший результат, чем стандартное индексирование.
...
+ Неструктурированные или частично структурированные документы с содержимым, которое имеет присущее значение или контекст, скрытые в большом документе. 
  ...
  Кроме того, готовые навыки также могут использоваться для реструктуризации содержимого с помощью операций разделения текста, слияния и формирования фигур.
...
## <a name="component-pipeline-of-cognitive-search"></a>Конвейер компонентов когнитивного поиска
...
Мы рекомендуем пользоваться бесплатной версией службы в учебных целях. Но учтите, что число бесплатных транзакций ограничено 20 документами в день. Чтобы выполнить краткое руководство и учебник за один день, используйте небольшой набор файлов (из 10 документов), что позволит выполнить оба упражнения, или удалите индексатор, который использовался в кратком руководстве или учебнике.
...
| [Создание набора навыков (api-version=2019-05-06)](https://docs.microsoft.com/rest/api/searchservice/create-skillset)  | Этот API предназначен для Когнитивного поиска. Это ресурс, описывающий использование [стандартных навыков](cognitive-search-predefined-skills.md) и [пользовательских когнитивных навыков](cognitive-search-custom-skill-interface.md) в конвейере обогащения данных во время индексирования. |
