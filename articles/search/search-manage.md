...
* Использование [PowerShell](search-manage-powershell.md) или [REST API управления](https://docs.microsoft.com/rest/api/searchmanagement/) для [получения свойств службы](https://docs.microsoft.com/rest/api/searchmanagement/services). На программном уровне не предоставлены новые сведения или операции. Существуют интерфейсы, которые позволяют создавать сценарии.
...
* [Получение статистических данных индекса](https://docs.microsoft.com/rest/api/searchservice/Get-Index-Statistics)
...
Секции добавляются кратными 12 (в частности, 1, 2, 3, 4, 6 или 12). Это артефакт сегментирования. Индекс создается в 12 сегментах, которые все вместе могут храниться в одной секции или равномерно распределяться по 2, 3, 4, 6 или 12 секциям (один сегмент на секцию).
