...
+ Создайте совокупность искомых данных, содержащую только ваши данные, полученные из нескольких типов содержимого и платформ. 
+ Используйте индексирование на основе ИИ, чтобы извлекать текст и компоненты из файлов изображений или сущности и ключевые фразы из необработанного текста.
+ Создайте интуитивно понятную поисковую систему с навигацией по аспектам и фильтрами, синонимами, автозавершением и анализом текста для автоматически исправленных условий поиска типа "имелось в виду".
+ Добавьте геопространственный поиск соседних объектов, анализаторы языка, отличного от английского, для полнотекстового поиска и логику оценки для ранжирования результатов поиска.
...
| Интеграция данных | Индексы Поиска Azure принимают данные из любого источника, если он передается как структура данных JSON. <br/><br/> При необходимости для поддерживаемых источников данных в Azure можно использовать [**индексаторы**](search-indexer-overview.md), чтобы автоматически сканировать[ базу данных SQL Azure](search-howto-connecting-azure-sql-database-to-azure-search-using-indexers.md), [Azure Cosmos DB](search-howto-index-cosmosdb.md) или [хранилище BLOB-объектов Azure](search-howto-indexing-azure-blob-storage.md) на предмет доступного для поиска содержимого в основных хранилищах данных. Индексаторы больших двоичных объектов Azure могут выполнять *открытие документов* для [извлечения текста из основных форматов файлов](search-howto-indexing-azure-blob-storage.md), включая Microsoft Office, PDF и HTML-документы. |
