...
+ Создайте индекс искомых данных, содержащий только ваши данные, полученные из нескольких типов содержимого и платформ. 

+ Используйте обогащение данных на основе ИИ, чтобы извлекать текст и компоненты из файлов изображений или сущности и ключевые фразы из необработанного текста.

+ Создайте интуитивно понятную поисковую систему с навигацией по аспектам и фильтрами аспектов, синонимами, автозавершением и анализом текста для автоматически исправленных условий поиска типа "имелось в виду". Регулируйте релевантность с помощью функций и более эффективной логики.

+ Создавайте приложения поиска для конкретных вариантов применения. Функция геопространственного поиска поддерживает возможность поиска мест неподалеку. С помощью анализаторов языка можно использовать функцию многоязычного поиска. Таким образом можно найти текст на языках, отличных от английского.
...
### <a name="step-4-search"></a>Шаг 4. поиска
