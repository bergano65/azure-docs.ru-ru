...
+ [обогащения на основе ИИ](cognitive-search-concept-intro.md), в результате которых создается пригодное для поиска содержимое на основе изображений, необработанного текста и файлов приложений;
+ интеграция с другими службами Azure для данных, машинного обучения и ИИ, а также безопасности.
