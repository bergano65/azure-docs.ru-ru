...
+ ориентирование на искусственный интеллект при анализе, преобразовании изображений и недифференцированного текста во время индексирования;
+ постоянное сохранение создаваемых и администрируемых индексов поиска;
...
> [!TIP]
> Выполните консолидацию шагов, начав с [**мастера импорта данных**](search-get-started-portal.md), а также источника данных Azure для создания, загрузки и запроса индекса за считаные минуты.
