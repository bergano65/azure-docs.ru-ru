...
+ Необработанное содержимое — это большой неструктурированный текст, файлы изображений или приложений, например типы содержимого Office в источнике данных Azure (хранилище BLOB-объектов Azure или Cosmos DB). Вы можете применять когнитивные навыки во время индексации, чтобы добавить структуру или извлечь значение из файлов изображений и приложений.
...
В этом 9-минутном видео руководитель программы Лиам Кавана (Liam Cavanagh) объясняет преимущества интеграции поисковой системы для приложения. В этом демонстрационном ролике также рассматриваются ключевые возможности Когнитивного поиска Azure и стандартный рабочий процесс. 
