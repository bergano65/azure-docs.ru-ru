...
```
### <a name="sample-index-for-only-the-categories-description-faces-and-tags-fields"></a>Индекс образцов (для только категории "," Описание "," лица "и" теги полей)
```json
{
    "fields": [
        {
...
```
### <a name="sample-output-field-mapping-for-the-above-index"></a>Сопоставление полей пример выходных данных (для индекса выше)
```json
    "outputFieldMappings": [
        {
