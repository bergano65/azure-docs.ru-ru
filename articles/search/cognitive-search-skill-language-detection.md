...
description: Оценивает неструктурированный текст, и для каждой записи возвращаети идентификатор языка со счетом, указывающим на прочность анализа в конвейере обогащения ИИ в Azure Cognitive Search.
manager: nitinme
author: luiscabrer
ms.author: luisca
...
Обнаружение языков использует библиотеки обработки естественного языка Bing, что превышает количество [поддерживаемых языков и регионов, перечисленных](https://docs.microsoft.com/azure/cognitive-services/text-analytics/language-support) для Text Analytics. Точный список языков не публикуется, но включает в себя все широко распространенные языки, а также варианты, диалекты, а также некоторые региональные и культурные языки. Если у вас есть содержимое, выраженное на менее часто используемом языке, вы можете [попробовать API обнаружения языков,](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/56f30ceeeda5650db055a3c7) чтобы увидеть, возвращает ли он код. Для языков, которые не удалась распознать, возвращается ответ `unknown`.
...
Максимальный размер записи должен соразмеровать 50 000 [`String.Length`](https://docs.microsoft.com/dotnet/api/system.string.length)символов. Если вам нужно разбить данные перед отправкой на навык обнаружения языка, вы можете использовать [навык сплита текста.](cognitive-search-skill-textsplit.md)
