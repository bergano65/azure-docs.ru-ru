...
[Обновление индекса &#40;API REST службы поиска Azure&#41;](https://docs.microsoft.com/rest/api/searchservice/update-index)  
[Предложения &#40;API REST службы поиска Azure&#41;](https://docs.microsoft.com/rest/api/searchservice/suggestions)  
[Операции с индексами &#40;API REST службы поиска Azure&#41;](https://docs.microsoft.com/rest/api/searchservice/index-operations)  
[REST для службы поиска Azure](https://docs.microsoft.com/rest/api/searchservice/)  
