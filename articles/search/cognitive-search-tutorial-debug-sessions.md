...
> [!Important]
> Поддержка сеансов отладки для Когнитивного поиска Azure доступна [по запросу](https://aka.ms/DebugSessions) в виде предварительной версии с ограниченным доступом. Предварительная версия функций предоставляется без соглашения об уровне обслуживания, поэтому использовать ее в рабочей среде не рекомендуется. Дополнительные сведения см. в статье [Дополнительные условия использования предварительных выпусков Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).
>
> После предоставления вам доступа к предварительной версии вы сможете получить доступ к сеансам отладки и использовать их для своей службы с помощью портала Azure.
>   
...
> ![Изменение переменных в Postman](media/cognitive-search-debug/postman-enter-variables.png)
...
> [!div class="mx-imgBorder"]
> ![Использование Postman для создания источника данных](media/cognitive-search-debug/postman-create-data-source.png)
...
> [!div class="mx-imgBorder"]
> ![Запуск нового сеанса отладки](media/cognitive-search-debug/new-debug-session-screen-required.png)
...
> [!div class="mx-imgBorder"]
> ![Запущен новый сеанс отладки](media/cognitive-search-debug/debug-execution-complete1.png)
...
> [!div class="mx-imgBorder"]
> ![Вычислитель выражений](media/cognitive-search-debug/expression-evaluator-language.png)
...
> [!div class="mx-imgBorder"]
> ![Вкладка "Обогащенная структура данных"](media/cognitive-search-debug/enriched-data-structure-language.png)
