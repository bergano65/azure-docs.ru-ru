...
Azure Когнитивный поиск поддерживает несколько источников данных, [лингвистический анализ для множества языков](https://docs.microsoft.com/rest/api/searchservice/language-support), [Пользовательский анализ для интересных и нестандартных входных данных](https://docs.microsoft.com/rest/api/searchservice/custom-analyzers-in-azure-search), Поиск ранжированных элементов управления с помощью [профилей оценки](https://docs.microsoft.com/rest/api/searchservice/add-scoring-profiles-to-a-search-index)и взаимодействие с пользователем. такие функции, как typeahead, выделение совпадений и навигация с аспектами. Она также включает в себя другие функции, такие как поиск синонимов и синтаксис расширенных запросов, но они обычно не являются отличительными.
