...
### <a name="can-i-index-from-sql-database-replicas-applies-to-azure-sql-database-indexers"></a>Можно ли индексировать из реплик базы данных SQL (применяется к [индексаторам базы данных SQL Azure](https://docs.microsoft.com/azure/search/search-howto-connecting-azure-sql-database-to-azure-search-using-indexers))
