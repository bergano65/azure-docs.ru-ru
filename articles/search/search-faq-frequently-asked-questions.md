...
### <a name="what-is-the-difference-between-azure-cognitive-search-and-elasticsearch"></a>В чем разница между Azure Cognitive Search и Elasticsearch?

При сравнении технологий поиска клиенты часто запрашивают информацию о том, как Azure Cognitive Search сравнивается с Elasticsearch. Клиенты, выбирающие Azure Cognitive Search вместо Elasticsearch для своих проектов поисковых приложений, обычно делают это, потому что мы упростили ключевую задачу или им нужна встроенная интеграция с другими технологиями Майкрософт:

+ Azure Cognitive Search — это полностью управляемый облачный сервис с 99,9% соглашений об уровне обслуживания (SLA), когда они подготовлены с достаточной избыточностью (2 реплики для доступа к чтению, три реплики для чтения записи).
...
+ [Индексы когнитивного поиска Azure](search-indexer-overview.md) могут сканировать различные источники данных Azure для первоначальной и поэтапной индексации.
