...
* Для индексирования в режиме принудительного режима вызовите [Добавление, обновление или удаление документов](https://docs.microsoft.com/rest/api/searchservice/addupdate-or-delete-documents) , чтобы отправить изменения в индекс.
