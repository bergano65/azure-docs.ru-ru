...
Когнитивный поиск Azure — это автономный ресурс, используемый для добавления поиска в пользовательские приложения. Когнитивный поиск Azure легко интегрируется с другими службами Azure, приложениями на сетевых серверах или с программным обеспечением, работающим на других облачных платформах.
