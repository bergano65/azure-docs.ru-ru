...
Со временем вы сможете получать представление о текущих и прогнозируемых совокупных затратах (как показано на снимке экрана) или более детализировано изучить расходы на отдельные ресурсы. На следующем снимке экрана показан тип сведений о затратах, которые можно увидеть при объединении нескольких ресурсов в одну группу.
...
> [!TIP]
> Группы ресурсов упрощают очистку, поскольку при удалении группы также удаляются службы внутри нее. Если проект прототипа использует нескольких служб, то, поместив их все в одну группу ресурсов, можно упростить очистку после завершения этого проекта.
...
Кроме того, если вы используете обогащение с помощью ИИ, создайте службу в том же регионе, что и Cognitive Services. *Совместное размещение Когнитивного поиска Azure и Cognitive Services в одном регионе является обязательным условием для обогащения ИИ*.
