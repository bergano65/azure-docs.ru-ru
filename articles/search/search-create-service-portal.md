...
Из этой статьи вы узнаете, как создать службу поиска на [портале Azure](https://portal.azure.com/).
...
**_Секции_* _ позволяют службе хранить данные и осуществлять поиск в большем количестве документов.

_*_Реплики_*_ дают службе возможность справляться с повышенной нагрузкой запросов поиска.
...
2. В области навигации слева щелкните _ *Параметры** > **Масштаб**.
