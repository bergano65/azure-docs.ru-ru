...
Так как рабочая нагрузка мала, Cognitive Services работает в фоновом режиме, чтобы обеспечить бесплатную обработку до 20 транзакций ежедневно на каждый индексатор при вызове из Когнитивного поиска Azure. Если вы используете демонстрационные данные, которые мы предоставляем, можно пропустить создание или присоединение ресурса Cognitive Services.
