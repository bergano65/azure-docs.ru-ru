...
В рамках этого краткого руководства используется бесплатная служба, но количество бесплатных транзакций ограничено 20 документами в день. Если вы хотите использовать это краткое руководство чаще одного раза в день, применяйте набор файлов меньшего размера, чтобы его было запускать соответствующее количество раз.
