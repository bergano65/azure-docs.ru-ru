---
title: Краткое руководство. Конвейер когнитивного поиска на портале Azure — Поиск Azure
...
1. В качестве расположения выберите один из [поддерживаемых регионов](#supported-regions) для функции "Когнитивный поиск".
...
В разделе **Connect to your data** (Подключение к данным)  > **Хранилище BLOB-объектов** выберите учетную запись и созданный контейнер. Присвойте источнику данных имя, а для остальных параметров используйте значения по умолчанию. 
   ...
   ![Конфигурация больших двоичных объектов Azure](./media/cognitive-search-quickstart-blob/blob-datasource2.png)
