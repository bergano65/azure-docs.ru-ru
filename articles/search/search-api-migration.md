...
Версия 2020-06-30 — это новая общедоступная версия REST API. Существует одно критическое изменение и несколько различий в поведении. 
...
Существующий код, написанный для более ранних версий API, приведет к нарушению работы API-Version = 2020-06-30 и более поздних версий, если код содержит следующие функциональные возможности:
