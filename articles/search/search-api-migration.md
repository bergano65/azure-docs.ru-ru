...
При обновлении до новых версий вам, возможно, не придется вносить какие бы то ни было изменения в код, кроме изменения номера версии. Изменение кода может потребоваться только в следующих случаях:
...
Если любая из этих ситуаций применима к вам, вам может потребоваться соответствующим образом изменить код. В противном случае никакие изменения не требуются, если вы не хотите использовать функции, добавленные в новой версии.
...
Существующий код, написанный для более ранних версий API, будет прерываться на API-Version = 2019-05-06, если код содержит следующие функциональные возможности:
