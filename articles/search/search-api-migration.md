...
Если вы используете предыдущую версию [REST API поиска](/rest/api/searchservice/), эта статья поможет вам обновить приложение для использования новейшей общедоступной версии API, 2020-06-30.
