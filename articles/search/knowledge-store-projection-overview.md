...
description: Сохраняйте и обменяйте обогащенные данные из конвейера индексирования искусственного интеллекта AI для использования в сценариях, отличных от полнотекстового поиска.
manager: nitinme
author: vkurpad
ms.author: vikurpad
