---
title: Работа с проекциями в хранилище базы знаний — поиска Azure
...
Проекции, в состав [знаний хранилища (Предварительная версия)](knowledge-store-concept-intro.md), представляют собой виды богатый набор документов, которые могут быть сохранены в физическое хранилище для целей интеллектуального анализа данных базы знаний. Проекция позволяет «проецировать» свои данные фигуры, которая соответствует вашим потребностям, сохраняя связи, таким образом, чтобы такие средства, как Power BI может считывать данные с без дополнительных усилий. 
