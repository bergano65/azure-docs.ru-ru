...
1. По возможности повторно используйте подключения HTTP. При использовании пакета SDK Azure Когнитивный поиск .NET это означает, что следует повторно использовать экземпляр или экземпляр [сеарчклиент](/dotnet/api/azure.search.documents.searchclient) , а если используется REST API, следует повторно использовать один HttpClient.
...
[Зоны доступности](https://docs.microsoft.com/azure/availability-zones/az-overview) разделение центров обработки данных региона на отдельные группы физического расположения для обеспечения высокой доступности в пределах одного региона. Для Когнитивный поиск отдельные реплики являются единицами для назначения зоны. Служба поиска выполняется в одном регионе; его реплики выполняются в разных зонах.

Вы можете использовать Зоны доступности с Когнитивный поиск Azure, добавив в службу поиска две или более реплики. Каждая реплика будет помещена в другую зону доступности в пределах региона. Если у вас больше реплик, чем Зоны доступности, реплики будут распределяться по Зоны доступности как можно более равномерно.

В настоящее время Когнитивный поиск Azure поддерживает Зоны доступности для служб поиска уровня "Стандартный" или "более высокий", которые были созданы в одном из следующих регионов:

+ Восточная Австралия (создано 30 января 2021 или более поздней версии)
+ Центральная Канада (создано 30 января 2021 или более поздней версии)
+ Центральная американская (создана 4 декабря 2020 или более поздней версии)
+ Восточная часть США 2 (создано 30 января 2021 или более поздней версии)
+ Центральная Франция (с 23 октября 2020 или более поздней версии)
+ Восточная Япония (создан 30 января 2021 или более поздней версии)
+ Северная Европа (создано 28 января 2021 или более поздней версии)
+ Южный Восточная Азия (создано 31 января 2021 или более поздней версии)
+ Южная часть Соединенного Королевства (создано 30 января 2021 или более поздней версии)
+ Западная Европа (создан 29 января 2021 или более поздней версии)
+ Западная часть США 2 (создано 30 января 2021 или более поздней версии)

Зоны доступности не влияют на [соглашение об уровне обслуживания Azure когнитивный Поиск](https://azure.microsoft.com/support/legal/sla/search/v1_0/). Для обеспечения высокой доступности запросов по-прежнему требуется 3 или более реплик.
