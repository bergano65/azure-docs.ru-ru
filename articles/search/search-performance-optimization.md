...
Существует два варианта поддержания синхронизации распределенных служб поиска, которые состоят из использования [индексатора когнитивный Поиск Azure](search-indexer-overview.md) или API push-уведомлений (также называемого [Когнитивный поиском Azure REST API](https://docs.microsoft.com/rest/api/searchservice/)).  
