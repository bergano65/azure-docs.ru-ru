...
[Зоны доступности](https://docs.microsoft.com/azure/availability-zones/az-overview) разделите центры обработки данных региона на отдельные группы физических расположений, чтобы обеспечить высокую доступность, внутри региона. Служба поиска выполняется в одном регионе; реплики выполняются в разных зонах.
...
Зоны доступности не влияют на [соглашение об уровне обслуживания Azure когнитивный Поиск](https://azure.microsoft.com/support/legal/sla/search/v1_0/).
