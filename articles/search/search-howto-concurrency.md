...
В этом фрагменте кода показано добавление synonymMap в индекс, который уже существует. Этот код взят из [синонимов (Предварительная версия) C# пример для поиска Azure](search-synonyms-tutorial-sdk.md).
