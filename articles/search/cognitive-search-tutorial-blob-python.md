...
В рамках этого учебника используется бесплатная служба, но количество бесплатных транзакций ограничено 20 документами в день. Если вы хотите выполнять описанные здесь операции несколько раз в день, удалите индексатор, чтобы сбросить счетчик.
...
Теперь, когда службы и исходные файлы подготовлены, начните сборку компонентов конвейера индексирования. Начните с объекта источника данных, который указывает службе "Когнитивный поиск Azure", как извлекать данные из внешнего источника.
