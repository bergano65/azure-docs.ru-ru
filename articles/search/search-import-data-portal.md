...
| [Index](https://docs.microsoft.com/rest/api/searchservice/create-index) | Физическая структура данных, используемая для полнотекстового поиска и других запросов. | 
