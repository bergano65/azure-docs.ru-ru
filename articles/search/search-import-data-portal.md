...
| **Примеры**| Поиск Azure содержит бесплатную общедоступную базу данных SQL Azure, которую можно использовать для изучения импорта и запросов в Поиске Azure. См. [краткое руководство по импорту, индексированию и отправке запросов с помощью средств портала](search-get-started-portal.md). |
