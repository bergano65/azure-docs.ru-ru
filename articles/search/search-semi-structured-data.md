---
title: Руководство по использованию REST. Индексирование частично структурированных данных в больших двоичных объектах JSON
...
ms.locfileid: "72794292"
---
# <a name="rest-tutorial-index-and-search-semi-structured-data-json-blobs-in-azure-cognitive-search"></a>Руководство по использованию REST. Индексирование и поиск частично структурированных данных (больших двоичных объектов JSON) в службе "Когнитивный поиск Azure"
