...
+ На уровне хранилища для уровня платформы задается шифрование неактивных данных, но Когнитивный поиск также предлагает параметр "двойное шифрование" для клиентов, которым требуется двойная защита как пользователей, так и управляемых корпорацией Майкрософт ключей.
