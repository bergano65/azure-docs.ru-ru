...
|----------------|-------------|
| Шифрование при передаче <br>(HTTPS, SSL, TLS) | Azure Cognitive Search слушается на порте HTTPS 443. Подключения к службам Azure по всей платформе зашифрованы. <br/><br/>Все взаимодействия azure Cognitive Search от клиента к сервису способны sSL/TLS 1.2.  Обязательно используйте TLS версии 1.2 для SSL-подключений к службе.|
