...
Для внутренних данных, обрабатываемых службой поиска, в следующей таблице описаны [модели шифрования данных](../security/fundamentals/encryption-atrest.md#data-encryption-models). Некоторые функции, такие как хранилище знаний, добавочное дополнение и индексирование на основе индексаторов, читают или пишут структуры данных в других службах Azure. Эти службы имеют собственные уровни поддержки шифрования, отделенные от Когнитивный поиск Azure.
