...
Создание пользовательского навыка позволяет вставлять преобразования, уникальные для содержимого. Пользовательский навык выполняется независимо, применяя любой нужный вам шаг обогащения. Например, вы можете определить пользовательские сущности конкретных полей, создать настраиваемые модели классификации для разделения деловых и финансовых контрактов и документов, а также добавить навык распознавания речи, чтобы углубиться в содержимое звуковых файлов. Пошаговый пример см. в разделе [Пример: создание пользовательского навыка для поиска с помощью автоподбора](cognitive-search-create-custom-skill-example.md).
