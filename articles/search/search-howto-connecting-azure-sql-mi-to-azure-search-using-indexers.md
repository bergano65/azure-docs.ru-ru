...
Вытакже можете включить общедоступную конечную точку на существующем управляемый экземпляр SQL в разделе**открытая конечная точка** >  **безопасности** > **виртуальной сети** > .
