...
Более постоянное решение — сбор входных данных запроса и предоставление ответа в виде результатов поиска в клиентском приложении. В следующем руководстве по C# объясняется, как создать приложение поиска: [Создание первого приложения в когнитивный Поиск Azure](tutorial-csharp-create-first-app.md).
...
+ [Настройка индексатора BLOB-объектов (Azure Когнитивный поиск)](search-howto-indexing-azure-blob-storage.md) 
