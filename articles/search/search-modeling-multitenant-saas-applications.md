---
title: Моделирование мультитенантности для изоляции содержимого в одной службе. Поиск Azure
...
|  | Стандартная | Standard1 | Standard2 | Standard3 | Standard3 HD |
| --- | --- | --- | --- | --- | --- |
