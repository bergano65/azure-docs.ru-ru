...
2. Скопируйте этот URL-адрес: `https://<placeholder-for-your-service-name>.search.windows.net/indexes/hotel?api-version=2019-05-06`.
...
2. Скопируйте этот URL-адрес: `https://<placeholder-for-your-service-name>.search.windows.net/indexes/hotels/docs/index?api-version=2019-05-06`.
...
+ Скопируйте этот URL-адрес: `https://<placeholder-for-your-service-name>.search.windows.net/indexes/hotels/docs?search=motel&$count=true&api-version=2019-05-06`.
...
Вы также можете запрашивать системную информацию для получения количества документов и занятого объема хранилища: `https://mydemo.search.windows.net/indexes/hotels/stats?api-version=2019-05-06`.
...
В качестве целевого объекта укажите измененную версию этого URL-адреса: `https://<placeholder-for-your-service-name>.search.windows.net/indexes?api-version=2019-05-06`.
...
Измените команду на **PUT**. Скопируйте измененную версию этого URL-адреса: `https://<placeholder-for-your-service-name>.search.windows.net/indexes/hotel?api-version=2019-05-06`. Скопируйте указанное выше определение индекса в текст запроса. Теперь страница должна выглядеть, как на снимке экрана ниже. Нажмите **Execute** (Выполнить) вверху справа, чтобы отправить созданный запрос.
