...
2. Скопируйте значение URL-адреса. `https://<placeholder-for-your-service-name>.search.windows.net/indexes/hotel?api-version=2017-11-11`
...
2. Скопируйте значение URL-адреса. `https://<placeholder-for-your-service-name>.search.windows.net/indexes/hotels/docs/index?api-version=2017-11-11`
...
+ Скопируйте значение URL-адреса. `https://<placeholder-for-your-service-name>.search.windows.net/indexes/hotels/docs?search=motel&$count=true&api-version=2017-11-11`
...
**Перед заменой пробелов (lastRenovationDate desc):**

        GET /indexes/hotels/docs?search=*&$orderby=lastRenovationDate desc&api-version=2017-11-11

**После замены пробелов на символ плюса (lastRenovationDate+desc):**
...
+ [Краткое руководство. Создание индекса с помощью пакета SDK для .NET](search-create-index-dotnet.md)
