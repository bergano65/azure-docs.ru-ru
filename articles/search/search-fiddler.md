...
Измените команду на **PUT**. Скопируйте измененную версию этого URL-адреса: `https://<YOUR-SEARCH-SERVICE-NAME>.search.windows.net/indexes/hotels?api-version=2019-05-06`. Скопируйте указанное выше определение индекса в текст запроса. Теперь страница должна выглядеть, как на снимке экрана ниже. Нажмите **Execute** (Выполнить) вверху справа, чтобы отправить созданный запрос.
