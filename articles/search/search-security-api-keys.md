...
> [!Note]
> Пример кода, в котором показано использование ключа запроса, можно найти в разделе [запрос индекса Azure когнитивный Поиск в C#](search-query-dotnet.md).
