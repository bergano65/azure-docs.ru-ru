...
+ [Управление доступом на основе ролей в службе поиска Azure](search-security-rbac.md)
+ [Управление с помощью PowerShell](search-manage-powershell.md) 
+ [Оптимизация производительности и статьи](search-performance-optimization.md)