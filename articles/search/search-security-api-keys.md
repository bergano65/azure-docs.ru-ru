...
+ В [решениях для RESTful](search-get-started-postman.md)ключ API обычно указывается в заголовке запроса.
...
3. Выберите службу и на странице Обзор щелкните **Параметры**  > **ключи** , чтобы просмотреть ключи администратора и запроса.
   ...
   :::image type="content" source="media/search-security-overview/settings-keys.png" alt-text="Страница портала, раздел Получение параметров, ключи" border="false":::
...
5. Используйте ключ запроса, уже созданный для вашей службы, или создайте до 50 новых ключей запроса. Ключ запроса по умолчанию не именован, но для управляемости можно назвать дополнительные ключи запроса.
   ...
   :::image type="content" source="media/search-security-overview/create-query-key.png" alt-text="Страница портала, раздел Получение параметров, ключи" border="false":::
