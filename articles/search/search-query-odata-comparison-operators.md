...
При использовании операторов сравнения важно помнить, что все поля, не связанные с коллекцией, в Azure Когнитивный поиск потенциально могут `null`быть. В следующей таблице показаны все возможные результаты для выражения сравнения, где может быть `null`одна из сторон:
...
В сводке не `NaN` равно какому-либо значению, включая само себя.
