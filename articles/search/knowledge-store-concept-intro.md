...
Хранилище знаний — это дополнительный компонент службы "Поиск Azure", который предназначен для хранения обогащенных документов и метаданных, созданных с помощью конвейера индексирования на базе ИИ [(когнитивный поиск)](cognitive-search-concept-intro.md). Хранилище знаний поддерживает учетная запись хранения Azure, которая настраивается как элемент конвейера. При активации служба поиска кэширует представление каждого обогащенного документа с помощью этой учетной записи хранения. 
