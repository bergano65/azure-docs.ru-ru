...
Наконец, добавьте методы обнаружения, удаления и создания индекса службы "Когнитивный поиск Azure". Все эти методы имеют одинаковую структуру:
...
> [Вызов службы "Когнитивный поиск Azure" с веб-страницы с помощью JavaScript](https://github.com/liamca/azure-search-javascript-samples)
