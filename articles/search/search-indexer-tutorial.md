...
description: В этом руководстве описано, как подключить базу данных SQL Azure, извлечь доступные для поиска данные и отправить их в индекс в службе "Поиск Azure".
author: HeidiSteen
manager: cgronlun
services: search
ms.service: search
...
* [База данных Azure SQL](https://azure.microsoft.com/services/sql-database/), которая предоставляет источник внешних данных, используемый индексатором. В примере решения предоставляется файл данных SQL для создания таблицы.
