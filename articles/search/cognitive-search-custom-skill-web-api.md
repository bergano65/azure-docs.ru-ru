...
"Output" соответствует ответу, возвращенному веб-API. Веб-API должен возвращать полезные данные _JSON_ (проверенные путем просмотра `Content-Type` заголовка ответа) и должны соответствовать следующим ограничениям:
