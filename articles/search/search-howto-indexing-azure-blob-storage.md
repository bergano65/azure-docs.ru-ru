...
В этом методе будет использоваться [собственная функция обратимого удаления больших двоичных объектов](https://docs.microsoft.com/azure/storage/blobs/storage-blob-soft-delete) , предоставляемая хранилищем BLOB-объектов Azure. Если источник данных имеет собственный набор политик обратимого удаления и индексатор находит большой двоичный объект, перенесенный в обратимо Удаленное состояние, индексатор удалит этот документ из индекса.
