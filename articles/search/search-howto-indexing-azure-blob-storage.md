...
description: Узнайте, как индексировать документы в хранилище BLOB-объектов Azure и извлекать текст из документов с помощью Azure Когнитивный поиск.
manager: nitinme
author: mgottein
ms.author: magottei
ms.devlang: rest-api
