...
|lineEnding | Значение, используемое между каждым обнаружены строки. Возможные значения: «Место», «CarriageReturn», «Перевод строки».  Значение по умолчанию — «Пространство» |
