...
В следующих примерах предполагается, что это встроенный пример индекса недвижимости. Этот индекс можно создать с помощью мастера импорта данных на портале, выбрав **примеры** в качестве источника данных.
