...
|[truncate](https://lucene.apache.org/core/4_10_3/analyzers-common/org/apache/lucene/analysis/miscellaneous/TruncateTokenFilter.html)|TruncateTokenFilter|Усекает термины до определенной длины.<br /><br /> **Варианты**<br /><br /> length (тип: целое число). Значение по умолчанию: 300. Максимальное значение: 300. Обязательный.|  
