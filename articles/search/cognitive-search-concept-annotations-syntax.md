---
title: Ссылочные входные и выходные данные в конвейерах когнитивного поиска — Поиск Azure
...
Обратите внимание, что количество элементов `"/document/people/*/lastname"` больше, чем для документа. Узлов фамилий может быть 10, в то время как для этого документа существует только один узел. В этом случае система автоматически создаст массив `"/document/people/*/lastname"`, содержащий все элементы в документе.
