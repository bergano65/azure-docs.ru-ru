---
title: Справочные материалы и результаты в профессиональных навыках
titleSuffix: Azure Cognitive Search
description: Объясняет синтаксис аннотации и ссылку на аннотацию в входных данных и выводах набора навыков в конвейере обогащения ИИ в Azure Cognitive Search.
manager: nitinme
author: LuisCabrer
ms.author: luisca
...
---
# <a name="how-to-reference-annotations-in-an-azure-cognitive-search-skillset"></a>Как отослать аннотации в наборе навыков Azure Cognitive Search
...
В хранилище Azure Blob предположим, что у вас есть множество файлов, содержащих ссылки на имена людей, которые вы хотите извлечь с помощью распознавания сущности. В приведенном ниже определении навыка `"/document/content"` — это текстовое представление всего документа, а people — извлеченные данные с полными именами сущностей, которые определяются как пользователи.
...
Обратите внимание, что `"/document/people/*/lastname"` кардинальность документа больше, чем у документа. Узлов фамилий может быть 10, в то время как для этого документа существует только один узел. В этом случае система автоматически создаст массив `"/document/people/*/lastname"`, содержащий все элементы в документе.
