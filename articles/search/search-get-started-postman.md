...
Если вам больше не нужна служба поиска, самый быстрый способ освободить службы — удалить группу ресурсов, содержащую службу "Поиск Azure". При удалении группы ресурсов все ее содержимое, включая службы и все хранящиеся данные, удаляется без возможности восстановления. На портале имя группы ресурсов находится на странице "Обзор" каждой службы.
