...
1. Включите ведение журнала диагностики для службы поиска:
...
1. Выберите **ключ** в качестве метода проверки подлинности и укажите ключ учетной записи хранения. Выберите **частный** в качестве уровня конфиденциальности. Щелкните Вход и начать процесс загрузки.
...
[Основные понятия для конструкторов в служба Power BI](https://docs.microsoft.com/power-bi/service-basic-concepts)