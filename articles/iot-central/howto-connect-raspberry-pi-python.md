...
| Имя поля     | Единицы измерения  | Минимальное | Максимум | Число десятичных знаков |
| -------------- | ------ | ------- | ------- | -------------- |
| Влажность       | %      | 0       | 100     | 0              |
| temp           | °C     | –40     | 120     | 0              |
...
| Отображаемое имя | Имя поля | Единицы измерения | Число десятичных знаков | Минимальное | Максимум | Начальный |
| ------------ | ---------- | ----- | -------------- | ------- | ------- | ------- |
...
| Отображаемое имя | Имя поля | Включение текста | Отключение текста | Начальный |
| ------------ | ---------- | ------- | -------- | ------- |
...
| --------------- | ------------ | ---------- | --------- |
| Свойство устройства | Серийный номер   | dieNumber  | число    |
| Текст            | Размещение     | расположение   | Н/Д       |
