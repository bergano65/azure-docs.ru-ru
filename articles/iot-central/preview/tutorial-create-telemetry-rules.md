...
ms.locfileid: "76262689"
---
# <a name="tutorial-create-a-rule-and-set-up-notifications-in-your-azure-iot-central-application-preview-features"></a>Руководство. Создание правила и настройка уведомлений в приложении Azure IoT Central (функции предварительной версии)
...
В этом учебнике вы создадите правило, которое отправляет сообщение электронной почты, когда температура на датчике окружающей среды превышает 70 &deg;F.
