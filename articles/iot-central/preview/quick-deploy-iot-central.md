...
1. Выберите, хотите ли вы создать это приложение с помощью 7-дневной бесплатной пробной версии или воспользоваться подпиской с оплатой по мере использования.
    ...
    - При использовании приложений **с оплатой по мере использования** плата взимается за каждое устройство, при этом первые два устройства предоставляются бесплатно. Дополнительные сведения о [ценообразовании в IoT Central](https://aka.ms/iotcentral-pricing). При создании приложения с оплатой по мере использования необходимо выбрать *каталог*, *подписку Azure* и *регион*.
        ...
        - *Регион* — физическое расположение, в котором будут храниться данные устройств. Как правило, для получения оптимальной производительности, а также обеспечения соответствия стандарту независимости данных необходимо выбирать регион, расположенный как можно ближе к вашим устройствам. Выбрав регион, вы не сможете переместить приложение в другой регион.

        > [!NOTE]
        > В общедоступной предварительной версии для **предварительной версии приложения** доступны только регионы **Северная Европа** и **Центральная часть США**.
