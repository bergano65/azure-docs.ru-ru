...
manager: philmea
ms.openlocfilehash: 9873069c8e342e3278732c12f0913b4f54b0470d
ms.sourcegitcommit: 4f6a7a2572723b0405a21fea0894d34f9d5b8e12
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 02/04/2020
ms.locfileid: "76990918"
---
...
Можно создать копию любого приложения без экземпляров устройства, журнала данных устройства и данных пользователя. Копия — это стандартное приложение, за которое взимается плата. Вы не можете создать пробное приложение, скопировав приложение.

Выберите **Копировать**. В диалоговом окне введите сведения о новом стандартном приложении. Затем выберите **Копировать** , чтобы подтвердить продолжение работы. Дополнительные сведения о полях в форме см. в кратком руководстве по [созданию приложения](quick-deploy-iot-central.md) .
