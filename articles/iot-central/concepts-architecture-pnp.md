...
- **Модели возможностей устройств** определяют возможности устройства, такие как отправляемые данные телеметрии, свойства, определяющие состояние устройства, и команды, на которые реагирует устройство. Возможности устройства организованы в один или несколько интерфейсов. Дополнительные сведения о моделях возможностей устройств см. в документации по [Plug and Play IOT](https://aka.ms/iot-pnp-docs) .
