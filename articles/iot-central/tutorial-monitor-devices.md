...
1. Выберите **Параметры**. Измените значение в поле **Set Temperature** (Установить температуру) на 75. Выберите **Обновить**, чтобы отправить новую целевую температуру на устройство. Когда устройство подтверждает изменение параметра, состояние значения параметра изменяется на **синхронизированное**:
