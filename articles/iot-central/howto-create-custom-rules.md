...
1. Используйте сведения в следующей таблице, чтобы настроить входные данные, используя созданный ранее концентратор событий, а затем выберите **Сохранить**:
    ...
    | Параметр | Value |
    | ------- | ----- |
    | Псевдоним входных данных | centraltelemetry |
    | Подписка | Ваша подписка |
...
Теперь, когда вы знаете, как создать настраиваемые правила и уведомления, мы предлагаем — Узнайте, как [расширение Azure IoT Central с пользовательским аналитическим](howto-create-custom-analytics.md).
