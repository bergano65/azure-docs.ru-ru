...
| Название | Имя поля  | Единицы | Минимум | Максимальное количество | Знаки после запятой |
| ------------ | ----------- | ----- | --- | --- | -------------- |
...
| ------------ | ----------- | --------| ------------ | ------- | ------------ | 
| Режим вентилятора     | fanmode     | 1       | Работает      | 0       | Остановлена      |
...
| Название | Имя поля  | Уровень серьезности |
| ------------ | ----------- | -------- |
...
| Название    | Имя поля     | Единицы | Десятичные знаки | Минимум | Максимальное количество  | Исходный |
| --------------- | -------------- | ----- | -------- | --- | ---- | ------- |
...
| Название    | Имя поля     | Тип данных | Value |
| --------------- | -------------- | --------- | ----- |
