...
| Отображаемое имя | Имя поля  | Единицы измерения | Минимум | Максимум | Знаки после запятой |
| ------------ | ----------- | ----- | --- | --- | -------------- |
| Температура  | Температура | Пт     | 60  | 110 | 0              |
...
| ------------ | ----------- | --------| ------------ | ------- | ------------ | 
| Режим вентилятора     | fanmode     | 1       | Запущено      | 0       | Остановлено      |
...
| Отображаемое имя | Имя поля  | Серьезность |
| ------------ | ----------- | -------- |
...
| Отображаемое имя    | Имя поля     | Единицы измерения | Десятичные знаки | Минимум | Максимум  | Начальный |
| --------------- | -------------- | ----- | -------- | --- | ---- | ------- |
| Скорость вращения вентилятора       | fanSpeed       | Об/мин   | 0        | 0   | 3000 | 0       |
| Установить температуру | setTemperature | Пт     | 0        | 20  | 200  | 80      |
...
| Отображаемое имя    | Имя поля     | Время ожидания по умолчанию | Тип данных |
| --------------- | -------------- | --------------- | --------- |
| Обратный отсчет       | Обратный отсчет      | 30              | число    |

Добавьте следующее поле ввода обратного отсчета команды:

| Отображаемое имя    | Имя поля     | Тип данных | Значение |
| --------------- | -------------- | --------- | ----- |
| Отсчет от      | countFrom      | число    | 10    |
