...
7. Закончив вносить изменения, нажмите кнопку **Done** (Готово).
...
1. Чтобы просмотреть подключенный кондиционер в роли оператора, нажмите кнопку **Done** (Готово), чтобы завершить редактирование шаблона. Таким образом вы вернетесь к представлению оператора на устройстве.

2. Чтобы обновить расположение устройства, измените значение на плитке расположения и выберите **Сохранить**:
