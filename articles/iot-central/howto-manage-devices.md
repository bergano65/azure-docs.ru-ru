...
1. Выберите шаблон из списка доступных шаблонов и щелкните **связать**.
...
1. Выберите **сообщение об успешном выполнении** , чтобы загрузить файл в локальную папку на диске.
...
Дополнительные сведения о строках подключения и подключении реальных устройств к приложению IoT Central см. [в статье подключение устройств в Azure IOT Central](concepts-connectivity.md).
