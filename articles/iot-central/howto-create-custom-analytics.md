...
В этом пошаговом руководство показано, как расширить IoT Central, за исключением того, что он может сделать с помощью [встроенных средств анализа](howto-create-analytics.md).
...
| URL | Примите значение по умолчанию или выберите собственный уникальный префикс URL-адреса. |
| Каталог | Клиент Azure Active Directory |
| Подписка Azure | Ваша подписка Azure. |
| Район | East US |

В примерах и снимках экрана в этой статье используется регион **восточной части США** . Выберите расположение, близкое к вам, и убедитесь, что вы создали все ресурсы в том же регионе.
...
| Параметр | Значение |
| ------- | ----- |
| Название    | Выберите имя пространства имен |
...
1. Выберите **+ добавить**. Создайте политику с именем **Listen** с утверждением **прослушивания** .
...
![Конфигурация непрерывного экспорта данных](media/howto-create-custom-analytics/cde-configuration.png)
...
| Режим кластера | Стандарт |
| Версия Databricks Runtime | 5,3 (Scala 2,11, Spark 2.4.0) |
| Версия Python | 3 |
