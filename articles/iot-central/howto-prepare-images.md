...
Выберите плитку образ приложения, чтобы отправить образ, подготовленный (268 x 160 пикселей) с локального компьютера.
...
Настройка образа установите элемент изображения, чтобы отправить образ, подготовленный с локального компьютера. Наименьшая по размеру плитка — 200 x 200 пикселей. Плитки большего размера имеют квадратную или прямоугольную форму размера, кратного размеру небольших плиток. Например, 200 x 400, 400 x 200 или 400 x 400 пикселей.
...
Выберите плитку изображение, чтобы отправить образ, подготовленный (64 x 64 px) с локального компьютера.
...
Под изображением, настроить выберите плитку для изображения и выберите файл для загрузки с локального компьютера. Наименьшая по размеру плитка — 200 x 200 пикселей. Плитки большего размера имеют квадратную или прямоугольную форму размера, кратного размеру небольших плиток. Например, 200 x 400, 400 x 200 или 400 x 400 пикселей.
