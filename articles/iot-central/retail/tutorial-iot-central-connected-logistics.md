...
3. Щелчок **Создание приложений** откроет форму **Новое приложение**. Введите следующие сведения:
    ...
    * **Создание**. Выберите &quot;Create" (Создать) в нижней части страницы, чтобы развернуть приложение.
    ...
    :::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-app-create.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
...
3. Щелчок **Создание приложений** откроет форму **Новое приложение**. Введите следующие сведения:
    ...
    * **URL** (URL-адрес): можно использовать предложенный URL-адрес по умолчанию или ввести понятный уникальный URL-адрес. Если у вас уже есть подписка Azure, то рекомендуется использовать параметр по умолчанию. Вы можете начать с 7-дневной бесплатной пробной версии тарифного плана и выбрать преобразование в стандартный тарифный план в любое время до истечения срока действия бесплатной версии.
    * **Billing Info** (Данные для выставления счетов): сведения о каталоге, подписке Azure и регионе необходимы для подготовки ресурсов.
    * **Создание**. Выберите &quot;Create":::

    :::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-app-create-billinginfo.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
...
:::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-dashboard1.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
...
:::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-dashboard2.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
...
:::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-devicetemplate1.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
...
:::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-devicetemplate2.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
...
:::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-rules.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
...
:::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-jobs.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
...
:::image type="content" source="media/tutorial-iot-central-connected-logistics/connected-logistics-cleanup.png" alt-text="Шаблон интеллектуальной логистики&quot;:::
