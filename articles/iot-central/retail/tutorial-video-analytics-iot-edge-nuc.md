...
* Прежде чем начать работу, необходимо пройти статью [Руководство. Создание приложения видеоаналитики для распознавания объектов и движения в Azure IoT Central](./tutorial-video-analytics-create-app.md).
...
* Среда выполнения IoT Edge, которая [установлена](../../iot-edge/how-to-install-iot-edge-linux.md) и запущена на этом устройстве.
...
Если на вашем компьютере Intel NUC не установлена среда выполнения IoT Edge, см. статью [Установка среды выполнения Azure IoT Edge в системах Linux на основе Debian](../../iot-edge/how-to-install-iot-edge-linux.md).
