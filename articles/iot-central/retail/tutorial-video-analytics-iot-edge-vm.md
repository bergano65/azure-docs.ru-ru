...
Прежде чем начать работу, необходимо ознакомиться со статьей [Руководство. Создание приложения видеоаналитики для распознавания объектов и движения в Azure IoT Central](./tutorial-video-analytics-create-app.md).
...
| Идентификатор устройства | *lva-gateway-001* — устройство шлюза, которое вы создали при работе с предыдущим руководством. |
...
См. статью [Устранение неполадок с устройством IoT Edge](https://docs.microsoft.com/azure/iot-edge/troubleshoot).
