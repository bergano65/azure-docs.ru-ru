...
Дополнительные сведения см. в руководстве [по развертыванию и использованию шаблона приложения для микроцентра исполнения заказов](./tutorial-micro-fulfillment-center-pnp.md).
...
* [Развертывание и использование шаблона приложения микроцентра исполнения заказов](./tutorial-micro-fulfillment-center-pnp.md).
