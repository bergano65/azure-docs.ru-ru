...
* **Setup** (Настройка) — предоставляет сведения о проектировании приложения и позволяет добавлять и удалять камеры.
* **Manage** (Управление) — позволяет управлять камерами. Например, можно настроить и запустить камеры, а также просмотреть сведения о состоянии.
* **Real Cameras** (Реальные камеры) — позволяет просматривать информацию из реальных камер, например число обнаружений и события камер.
* **Monitor** (Монитор) — позволяет просматривать подробные сведения со всех камер.
...
Дополнительные сведения о развертывании решения см. в учебнике по [созданию приложения видеоаналитики в Azure IoT Central](tutorial-video-analytics-create-app.md).

### <a name="live-video-analytics"></a>Аналитика видеотрансляции

Аналитика видеотрансляций предоставляет платформу для создания интеллектуальных видеоприложений, использующих как пограничные, так и облачные вычисления. Платформа предоставляет возможность сканирования, записи, анализа видеотрансляций, а также публикации результатов (видео или видеоаналитики) в службах Azure. Службы Azure могут работать в облаке или на пограничных устройствах. Вы можете использовать платформу, чтобы повысить эффективность ваших решений для Интернета вещей за счет анализа видео.
