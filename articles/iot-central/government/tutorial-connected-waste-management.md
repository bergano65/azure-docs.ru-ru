---
title: Руководство. созданию приложения для интерактивного управления отходами с использованием Azure IoT Central
description: Руководство. созданию приложения для интерактивного управления отходами с помощью шаблонов приложений Azure IoT Central.
author: miriambrus
ms.author: miriamb
ms.date: 11/12/2019
ms.topic: tutorial
...
ms.locfileid: "77016499"
---
# <a name="tutorial-create-a-connected-waste-management-application-in-iot-central"></a>Руководство. созданию приложения для интерактивного управления отходами с использованием IoT Central
