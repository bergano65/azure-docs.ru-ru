...
Если щелкнуть **Готово**, в списке измерений отобразятся данные измерения **температуры**. Оператор может просматривать визуализации данных температуры, которые собирает устройство.
...
Например, можно добавить новый параметр скорости, выбрав **Изменить шаблон** и введя новый параметр:
...
После создания плитки можно опробовать новый параметр. Сначала щелкните **Готово** в верхней правой части экрана.
...
Например, можно добавить расположение устройства в качестве нового свойства, выбрав **Изменить шаблон** и введя новое свойство:
...
После создания плитки можно изменить значение свойства. Сначала щелкните **Готово** в верхней правой части экрана.
...
Если выбрать **Сохранить** и **Готово**, команда **Echo** (Вывод на экран) будет отображаться в виде плитки и ее можно использовать для вывода устройства на экран.
