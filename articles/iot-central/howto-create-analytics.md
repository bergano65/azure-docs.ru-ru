...
* **Показать сетку**. Ваши результаты будут доступны в формате таблицы, что позволяет просматривать конкретное значение для каждой точки данных. Это представление также соответствует стандартам доступа. 
