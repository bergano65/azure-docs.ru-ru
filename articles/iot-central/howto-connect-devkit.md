...
1. Получение сведений о подключении, такие как **идентификатор области, идентификатор устройства и первичный ключ** для добавленное устройство, выбрав **Connect** на странице "устройства".
