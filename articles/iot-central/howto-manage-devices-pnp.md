...
1. В меню навигации слева выберите **устройства** . Здесь отображается список всех устройств и шаблонов устройств.
...
1. На правой панели страницы **устройства** отображается список устройств, созданных в этом шаблоне устройства. Выберите одно устройство, чтобы просмотреть страницу сведений о нем:
    ...
    ![Страница сведений об устройстве](./media/howto-manage-devices-pnp/devicelist.png)
...
1. В меню навигации слева выберите **устройства** .
...
1. Выберите **Импортировать**.
    ...
    ![Действие импорта](./media/howto-manage-devices-pnp/bulkimport1a.png)
...
1. После завершения импорта на панели операций устройства появится сообщение об успешном выполнении.
    ...
    ![Успешное завершение импорта](./media/howto-manage-devices-pnp/bulkimport3a.png)
...
1. На панели слева выберите **все устройства**:
    ...
    ![Несвязанные устройства](./media/howto-manage-devices-pnp/unassociateddevices1a.png)
...
1. Выберите **Миграция**:
    ...
    ![Связывание устройств](./media/howto-manage-devices-pnp/unassociateddevices2a.png)
...
1. Выберите устройства, которые требуется экспортировать, а затем выберите действие **Экспорт** .
    ...
    ![Экспорт](./media/howto-manage-devices-pnp/export1a.png)
...
1. Щелкните ссылку **скачать файл** , чтобы скачать файл в локальную папку на диске.
    ...
    ![Успешное завершение экспорта](./media/howto-manage-devices-pnp/export2a.png)
...
Дополнительные сведения о строках подключения и подключении реальных устройств к IoT Centralному приложению см. [в статье подключение устройств в Azure IOT Central](concepts-connectivity-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
1. В меню навигации выберите пункт **устройства** .
...
> [Использование наборов устройств](howto-use-device-groups-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
