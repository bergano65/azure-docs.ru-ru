...
В приложении IoT Central Azure можно [непрерывно экспортировать данные](howto-export-data-event-hubs-service-bus.md) в собственные концентраторы событий Azure и экземпляры служебной шины Azure. Вы также можете периодически экспортировать данные в учетную запись хранилища BLOB-объектов Azure. IoT Central может экспортировать измерения, устройства и шаблоны устройств.
