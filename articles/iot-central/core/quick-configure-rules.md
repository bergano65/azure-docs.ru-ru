...
1. В разделе **Целевые устройства** выберите **MXChip IoT DevKit** в качестве шаблона устройства. Эта опция фильтрует устройства, к которым применяется правило, по типу шаблона устройства. Дополнительные условия фильтра можно добавить с помощью элемента **+ Filter** (+ Фильтр).
