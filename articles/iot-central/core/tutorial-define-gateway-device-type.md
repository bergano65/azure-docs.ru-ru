...
Вот как можно создать шаблон устройства для **_датчика присутствия RS40_*:

1. На панели слева выберите элемент **Шаблоны устройств**. Затем щелкните **+** , чтобы начать добавление шаблона.

1. Прокрутите вниз, чтобы увидеть плитку устройства **_Датчик присутствия RS40_*. Выберите плитку и щелкните **Далее: Настройка**.
