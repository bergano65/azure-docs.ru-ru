...
description: В этой статье описывается идентификация, удаляние и экспорт данных клиентов в приложении Azure IoT Central.
author: dominicbetts
ms.author: dobett
ms.date: 08/23/2019
ms.topic: conceptual
...
Удалять данные пользователя можно только на странице администрирования IoT Central. Администраторы приложений могут выбрать пользователя для удаления и **удалить** в правом верхнем углу приложения, чтобы удалить запись. Они также могут удалять отдельные учетные записи, которые больше не связаны с конкретным приложением.
