...
1. Выберите **Device Explorer** на левой панели. Отобразится список [шаблонов устройств](howto-set-up-template.md).
...
1. Выберите **Device Explorer** на левой панели.
...
1. Перейдите на вкладку **Параметры** . Здесь отображаются все параметры, которые имеет устройство, и их текущие значения. Вы можете проверить, для каких параметров в данный момент выполняется синхронизация.
