...
В приложении IoT Central Azure перейдите на вкладку **Администрирование** и выберите **Подключение устройства**. Запишите **область идентификатора** и **первичный ключ**.
...
1. Откройте веб-браузер и перейдите по адресу [http://192.168.0.1/](http://192.168.0.1/). Откроется следующая веб-страница:
    ...
    - Имя сети Wi-Fi (SSID).
    - Пароль сети Wi-Fi.
    - Сведения о подключении: **идентификатор устройства** , который вы можете выбрать самостоятельно, а также **область идентификаторов** и **первичный ключ SAS группы** , которые были сделаны ранее.
