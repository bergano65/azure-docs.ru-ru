...
- Приложение IoT Central, созданное из шаблона **предварительной версии приложения** . Вы можете выполнить действия, описанные в разделе [Создание приложения Plug and Play IOT](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
