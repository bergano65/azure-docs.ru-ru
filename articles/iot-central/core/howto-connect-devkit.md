...
1. Во всплывающем окне введите **идентификатор устройства** как `SampleDevKit` и **имя устройства** как `MXChip IoT DevKit - Sample`. Убедитесь, что параметр **смоделированный** отключен. Щелкните **Создать**.
