...
В [репозитории примеров использования пакета средств разработки для Azure IoT Central ARM](https://docs.microsoft.com/samples/azure-samples/azure-iot-central-arm-sdk-samples/azure-iot-central-arm-sdk-samples/) собраны примеры кода для нескольких языков программирования, которые демонстрируют, как создавать, обновлять, перечислять и удалять приложения Azure IoT Central.
