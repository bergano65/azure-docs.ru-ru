...
description: Сведения о том, как добавить реальное устройство в приложение Azure IoT Central и настроить его. Также вы узнаете, как создавать код в реальном устройстве.
author: sandeeppujar
ms.author: sandeepu
ms.date: 08/23/2019
ms.topic: tutorial
