...
**Панель мониторинга** — это страница, которая загружается при первом переходе в приложение. **Строитель** в приложении определяет панель мониторинга приложения по умолчанию для всех пользователей. Вы можете дополнительно создать свою собственную персонализированную панель мониторинга приложений. Вы можете иметь несколько панелей мониторинга, которые отображают различные данные и переключаются между ними.
