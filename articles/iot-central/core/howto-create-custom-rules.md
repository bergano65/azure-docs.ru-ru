...
### <a name="resource-group"></a>групп ресурсов;
...
| Контактные данные | Заполнение требуемой информации |
...
Чтобы реализовать функцию, добавьте код C# для синтаксического анализа входящего HTTP-запроса и отправьте сообщения электронной почты следующим образом:

1. Выберите функцию **HttpTrigger1** в приложении функции и замените код C# следующим кодом:
