...
:::image type="content" source="media/howto-faq/auto-approve.png" alt-text="Снимок экрана с выключенным приложением с отключенным параметром автоматического утверждения.":::

Оператор должен явно утвердить устройство перед отправкой данных. Устройства, не зарегистрированные вручную на странице " **устройства** ", но подключенные с действительными учетными данными, будут иметь состояние устройства **ожидание утверждения**. Операторы могут утверждать эти устройства на странице **устройства** с помощью кнопки **утвердить** :

:::image type="content" source="media/howto-faq/approve-device.png" alt-text="Снимок экрана, показывающий, как утвердить устройство":::
