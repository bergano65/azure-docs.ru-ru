...
| Название            | Имя свойства. IoT Central Azure создает значение для этого поля из отображаемого имени, но при необходимости можно выбрать собственное значение. Это поле должно быть буквенно-цифровым.                                                 |
...
Дополнительные сведения о двойниковах устройств см. в статье [Настройка устройств из серверной службы](https://docs.microsoft.com/azure/iot-hub/tutorial-device-twins).
