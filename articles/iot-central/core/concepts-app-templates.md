...
В настоящее время шаблон приложения, который использует _общедоступные_ функции:

- Пользовательское приложение > устаревшие приложения
...
- Центр розничной > Micro-выполнения
...
> [!NOTE]
> Шаблоны **устаревших приложений** в настоящее время доступны в **США**, **Австралии**, **Азиатско-Тихоокеанский регион**или в **Европе** , а другие шаблоны в настоящее время доступны только в **странах Европы** и **США** .
