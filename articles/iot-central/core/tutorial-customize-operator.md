---
title: Руководство по настройке представлений оператора в Azure IoT Central
description: Руководство по Как конструктор вы можете настраивать представления оператора в приложении Azure IoT Central.
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
...
1. Чтобы изменить шаблон устройства **Подключенный кондиционер**, выберите **Шаблоны устройств** на панели слева:
