...
| Добавление примечаний | Любые комментарии о возможности "Телеметрия". |
...
| Единица отображения | Отображаемая единица для использования на панелях мониторинга и в формах. |
| Добавление примечаний | Любые комментарии о возможности "Свойство". |
...
| Добавление примечаний | Любые комментарии о возможности "Команда". |
