...
[Plug and Play IOT (Предварительная версия)](../../iot-pnp/overview-iot-plug-and-play.md) позволяет IOT Central интегрировать устройства без написания кода встраиваемого устройства. В основе IoT Plug and Play (предварительная версия) лежит схема модели возможностей устройства, которая описывает возможности устройства. В приложении IoT Central шаблоны устройств используют эти модели возможностей устройств IoT Plug and Play (предварительная версия).
...
С помощью настроек можно изменить импортированный интерфейс или добавить функции IoT Central для возможности. Настраивать можно только те поля, которые не нарушают совместимость интерфейса. Например, с их помощью можно выполнять следующее.
