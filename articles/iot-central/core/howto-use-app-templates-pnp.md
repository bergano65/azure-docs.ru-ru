...
Выберите **Копировать**. В диалоговом окне введите сведения для нового приложения с оплатой по мере использования. Затем выберите **Копировать** , чтобы подтвердить продолжение работы. Дополнительные сведения о полях в форме см. в кратком руководстве по [созданию приложения](quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) .

![Страница "Параметры приложения"](media/howto-use-app-templates-pnp/appcopy2.png)

После завершения операции копирования приложения можно переходить к новому приложению, используя ссылку.

![Страница "Параметры приложения"](media/howto-use-app-templates-pnp/appcopy3a.png)
...
![Создание шаблона приложения](media/howto-use-app-templates-pnp/create-template.png)
...
![Создание приложения на основе шаблона](media/howto-use-app-templates-pnp/create-app.png)
...
Теперь, когда вы узнали, как использовать шаблоны приложений, предлагаем следующий шаг — Узнайте, как [управлять IOT Central из портал Azure](howto-manage-iot-central-from-portal.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
