...
| Серьезность | Доступно только для семантического типа события. **Ошибка**, **информация**или **предупреждение**. |
...
| Единица | Единица измерения для значения телеметрии, например **миль/ч**, **%** или **&deg;C**. |
...
| Серьезность | Доступно только для семантического типа события. **Ошибка**, **информация**или **предупреждение**. |
| Значения состояния | Доступно только для семантического типа состояния. Определите возможные значения состояния, каждое из которых имеет отображаемое имя, имя, тип перечисления и значение. |
| Единица | Единица измерения для значения свойства, например **миль/ч**, **%** или **&deg;C**. |
| Единица дисплея | Отображаемая единица для использования на панелях мониторинга и формах. |
...
Настройки следует использовать, когда необходимо изменить импортированный интерфейс или добавить к возможности функции, относящиеся к IoT Central. Настраивать можно только те поля, которые не нарушают совместимость интерфейса. Например, вы можете:
...
> [Создание новой версии шаблона устройства](howto-version-device-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
> [Подключение устройства MXChip IOT DevKit к приложению Azure IOT Central](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
