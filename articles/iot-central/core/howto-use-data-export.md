...
Для концентраторов событий и назначений служебной шины данные экспортируются практически в реальном времени. Данные находятся в теле сообщения и имеют формат JSON, закодированный как UTF-8. Примеры см. ниже.
