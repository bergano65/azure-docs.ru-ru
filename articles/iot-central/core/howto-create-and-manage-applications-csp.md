---
title: Создавайте и управляйте приложениями Azure IoT Central с портала CSP Документы Майкрософт
...
---
# <a name="create-and-manage-an-azure-iot-central-application-from-the-csp-portal"></a>Создание и управление приложением Azure IoT Central с портала CSP
...
Чтобы приступить к работе, войдите в учетную запись на портале партнеров Майкрософт и выберите клиента, для которого вы хотите создать приложение Azure IoT Central. Перейдите к управлению обслуживанием для клиента с левого навигатора.

![Клиентское представление в Центре партнеров Майкрософт](media/howto-create-and-manage-applications-csp/image1.png)

Azure IoT Central отображается как служба, доступная для администрирования. Выберите центральную ссылку Azure IoT на странице для создания новых приложений или управления существующими приложениями для этого клиента.
...
Чтобы создать центральное приложение Azure IoT, выберите **сборку** в левом меню. Выберите один из отраслевых шаблонов или **пользовательский приложение** для создания приложения с нуля. Будет загружена страница создания приложения. Необходимо заполнить все поля на этой странице и нажать кнопку **Создать**. Ниже приводятся сведения о каждом поле.
...
![Создание страницы приложения для информации о выставлении счетов для провайдеров](media/howto-create-and-manage-applications-csp/image4-2.png)

## <a name="pricing-plan"></a>Ценовой план

Можно создавать только приложения, которые используют стандартный план ценообразования в качестве CSP. Чтобы продемонстрировать клиенту Azure IoT Central, можно создать приложение, которое использует план бесплатного ценообразования отдельно. Дополнительные сведения о бесплатном и стандартном тарифных планах см. на [странице с ценами на Azure IoT Central](https://azure.microsoft.com/pricing/details/iot-central/).
...
Если у вас нет подписки Azure, вы можете создать ее в партнерской сети Майкрософт. После создания подписки Azure перейдите на страницу **Создание приложения**. В раскрывающемся списке **Подписка Azure** отобразится новая подписка.
...
**Местоположение** — это [география,](https://azure.microsoft.com/global-infrastructure/geographies/) где вы хотите создать приложение. Как правило, следует выбирать расположение как можно ближе к устройствам, чтобы обеспечить оптимальную производительность. В настоящее время вы можете создать ioT Центральное приложение в **Австралии,** **Азиатско-Тихоокеанском регионе,** **Европе,** **США,** **Великобритании**и **Японии.** Выбрав расположение, вы не сможете переместить приложение в другое расположение.

## <a name="application-template"></a>Шаблон приложения

Выберите шаблон приложения, который вы хотите использовать для вашего приложения.
