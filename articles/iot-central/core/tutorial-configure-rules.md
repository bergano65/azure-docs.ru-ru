---
title: Руководство. настройке правил и действий в Azure IoT Central
...
В этом руководстве показано, как создать правило, которое отправляет сообщение электронной почты, когда температура на кондиционере превышает 70 &deg;F.
...
1. Чтобы добавить новое правило на основе телеметрии в приложение, на панели слева выберите **Шаблоны устройства**:
...
4. Чтобы определить правило, используйте информацию из следующей таблицы.
...
2. Чтобы определить действие, используйте информацию из следующей таблицы.
    ...
    | Параметр      | Значение                                               |
    | ------------ | --------------------------------------------------- |
    | Отображаемое имя | Оповещение о температуре по электронной почте                             |
