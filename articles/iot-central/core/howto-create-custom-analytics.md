...
Теперь, когда вы узнали, как создать пользовательскую аналитику, предлагаем следующий шаг — Узнайте, как [управлять приложением](howto-administer.md).
