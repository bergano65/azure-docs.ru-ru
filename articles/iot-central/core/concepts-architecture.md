...
В шаблоне устройства приложения IoT Central содержатся следующие сведения:

- **Модели возможностей устройств** определяют возможности устройства, такие как отправляемые данные телеметрии, свойства, определяющие состояние устройства, и команды, на которые реагирует устройство. Возможности устройства организованы в один или несколько интерфейсов. Дополнительные сведения о моделях возможностей устройств см. в документации по [Plug and Play IOT (Предварительная версия)](../../iot-pnp/overview-iot-plug-and-play.md) .
