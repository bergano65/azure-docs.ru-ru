...
- **Модели возможностей устройств** определяют возможности устройства, такие как отправляемые данные телеметрии, свойства, определяющие состояние устройства, и команды, на которые реагирует устройство. Возможности устройства организованы в один или несколько интерфейсов.
