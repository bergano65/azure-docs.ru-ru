...
6. Выбрав устройства, нажмите кнопку **выполнить** или **сохранить**. Теперь задание отображается на главной странице **заданий** . В этом представлении можно увидеть текущее выполняемое задание и историю всех ранее выполненных заданий. Выполняемое задание всегда отображается в верхней части списка. Сохраненное задание можно снова открыть в любое время, чтобы продолжить редактирование или запуск.
