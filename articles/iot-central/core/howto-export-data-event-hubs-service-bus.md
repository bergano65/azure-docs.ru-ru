...
2. Выберите подписку. 
    ...
    > [!Note] 
    > Теперь вы можете экспортировать данные в другие подписки, не являющиеся теми, которые относятся к стандартному приложению IoT Central. В этом случае вы подключаетесь с использованием строки подключения.
...
2. В левой области выберите **Непрерывная экспорт данных**.

    > [!Note]
    > Если вы не видите параметр непрерывный экспорт данных в левой области, вы не являетесь администратором в приложении. Обратитесь к администратору, чтобы настроить экспорт данных.
