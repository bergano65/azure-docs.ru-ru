...
- Он доступен только в таких расположениях как США, Европа, Азиатско-Тихоокеанский регион и Австралия.
...
[IoT Plug and Play (предварительная версия)](../../iot-pnp/overview-iot-plug-and-play.md) позволяет IoT Central интегрировать устройства без необходимости писать код для встраиваемого устройства. В основе IoT Plug and Play (предварительная версия) лежит схема модели возможностей устройства, которая описывает соответствующие функции. В приложении IoT Central шаблоны устройств используют эти модели возможностей устройств IoT Plug and Play (предварительная версия).
...
- Подключать устройства с использованием подписанных URL-адресов.
...
## <a name="stay-connected"></a>Сохранение доступа
...
[Роли и разрешения](howto-manage-users-roles.md) позволяют администратору настраивать взаимодействие для каждого пользователя. С помощью веб-интерфейса администратор создает роли и назначает разрешения.

## <a name="transform-your-iot-data"></a>Преобразование данных Интернета вещей
...
Когда ваши устройства подключены и отправляют данные, правила могут идентифицировать устройства, испытывающие проблемы или отправляющие сообщения об ошибках, чтобы вы могли исправить их с минимальным временем простоя. Создайте правила в своем приложении IoT Central, чтобы отслеживать телеметрию с ваших устройств и предупреждать оператора, когда метрика превышает пороговое значение или устройство отправляет определенное сообщение. Действия электронной почты и веб-перехватчики для правил уведомляют требуемых специалистов и правильные подчиненные системы.
...
- Дополнительные сведения см. в статье [Что представляет собой предварительная версия IoT Plug and Play?](../../iot-pnp/overview-iot-plug-and-play.md).
