...
> [!NOTE]
> IoT Central принимает любой допустимый JSON, но его можно использовать только для визуализаций, если он соответствует определению в DCM. Вы можете экспортировать данные, не соответствующие определению, [в разделе Экспорт данных IOT в назначения в Azure](howto-export-data.md).
