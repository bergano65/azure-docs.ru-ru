...
> [!NOTE]
> [Выпуск общедоступной предварительной версии IoT Plug and Play](../../iot-pnp/overview-iot-plug-and-play.md) предназначен для разработчиков и изготовителей оборудования, чтобы начать создавать устройства, которые они могут сертифицировать для интернета вещей Plug and Play перед общедоступным.
