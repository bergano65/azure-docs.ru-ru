...
>
> - Сведения о последних функциях экспорта данных см. в статье [Экспорт данных Интернета вещей в облачные назначения с помощью экспорта данных](./howto-export-data.md).
