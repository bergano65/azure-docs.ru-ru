...
>
> - Сведения о новых функциях предварительной версии для экспорта данных см. в статье [Экспорт данных IOT в облачные назначения с помощью экспорта данных (Предварительная версия)](./howto-export-data.md).
> - Дополнительные сведения о различиях между функциями предварительной версии экспорта данных и экспортом устаревших данных см. в [таблице сравнения](./howto-export-data.md#comparison-of-legacy-data-export-and-preview-data-export).
...
8. Чтобы включить экспорт данных, **Убедитесь, что** **включен переключатель Включить** . Выберите **Сохранить**.
