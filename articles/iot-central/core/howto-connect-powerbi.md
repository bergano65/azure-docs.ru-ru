...
> [!NOTE]
> Если вы используете приложение IoT Central версии 2, см. статью [визуализация и анализ данных IOT Central Azure на панели мониторинга Power BI](https://docs.microsoft.com/previous-versions/azure/iot-central/core/howto-connect-powerbi) на веб-сайте документации по предыдущим версиям.
