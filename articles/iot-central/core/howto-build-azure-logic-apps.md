...
Вы всегда можете начать создание рабочего процесса в соединителе IoT Central в Logic Apps на портале Azure. Затем можно выбрать, к какому IoT Central приложению и к какому правилу подключаться, и все равно работать аналогично. Нет необходимости каждый раз начинать процедуру на странице правил IoT Central.
