...
| Отображаемое имя | Имя поля  | Единицы | Min | Максимальное количество | Число десятичных знаков |
| ------------ | ----------- | ----- | --- | --- | -------------- |
...
| ------------ | ----------- | --------| ------------ | ------- | ------------ | 
| Режим вентилятора     | fanmode     | 1       | Выполнение      | 0       | Остановлена      |
...
| Отображаемое имя    | Имя поля     | Единицы | Десятичные знаки | Min | Максимальное количество  | Initial |
| --------------- | -------------- | ----- | -------- | --- | ---- | ------- |
...
| Отображаемое имя    | Имя поля     | Тип данных | Value |
| --------------- | -------------- | --------- | ----- |
