...
- **Группа устройств:** [Группа устройств](howto-use-device-groups-pnp.md) — это определяемая пользователем группа устройств. Например, все Рефрижераторс в Оакланд или турбины обмотка версии 2,0.
