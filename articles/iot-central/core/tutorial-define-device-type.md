...
Для работы с этим учебником вам потребуется приложение Azure IoT Central, созданное с помощью шаблона **Пользовательское приложение**. Если у вас нет приложения, выполните инструкции из краткого руководства [Create an Azure IoT Central application](quick-deploy-iot-central.md) (Создание приложения Azure IoT Central), убедившись, что выбран шаблон **Пользовательское приложение**.
...
Чтобы добавить новый шаблон устройства в приложение, вам нужно перейти на страницу **шаблонов устройств**. Для этого выберите **Шаблоны устройств** на панели навигации слева.
