...
Новое приложение можно создать из списка шаблонов IoT Central, соответствующих отраслям, чтобы быстро приступить к работе, или начать с нуля с помощью шаблона **пользовательского приложения**. В этом кратком руководстве используется шаблон **пользовательского приложения**.

Для создания нового приложения IoT Central Azure из шаблона **пользовательского приложения**:
...
1. Выберите **пользовательское приложение** и убедитесь, что выбран шаблон **пользовательского приложения**.
...
1. Azure IoT Central также создает уникальный префикс **URL-адреса приложения** на основе имени приложения. Этот URL-адрес используется для доступа к приложению. Измените этот префикс на что-то более запоминающееся, если захотите.
    ...
    ![Сведения о выставлении счетов Azure IoT Central](media/quick-deploy-iot-central/iotcentralcreate-billinginfo-pnp.png)
