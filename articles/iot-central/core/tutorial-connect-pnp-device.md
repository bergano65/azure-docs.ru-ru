...
1. Войдите в созданное приложение IoT Central с помощью шаблона **Пользовательское приложение > Предварительная версия приложения** в кратком руководстве [Создание приложения Azure IoT Central](./quick-deploy-iot-central.md).
