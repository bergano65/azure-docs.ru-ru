...
Чтобы узнать больше, смотрите [создать и подключить клиентское приложение Node.js к учебнику приложения Azure IoT Central.](./tutorial-connect-device-nodejs.md)
