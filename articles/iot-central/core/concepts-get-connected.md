...
Azure IoT Central использует [службу подготовки устройств для центра Интернета вещей Azure (DPS)](../../iot-dps/about-iot-dps.md) для управления регистрацией и подключением устройств.
