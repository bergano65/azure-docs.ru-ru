...
Это формат для устройств, использующих общедоступный пакет SDK для устройств:

```javascript
    iotcModelId: '< this is the URN for the capability model>';
```

Это формат для устройств, использующих общедоступный предварительный пакет SDK для устройств:
