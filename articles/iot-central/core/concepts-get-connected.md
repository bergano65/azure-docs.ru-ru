...
1. [Добавьте и проверьте корневой или промежуточный сертификат X. 509](#connect-devices-using-x509-certificates) для приложения IOT Central. (#connect-Devices-using-x509-Certificates)
...
1. Изготовитель оборудования выдает устройство с ИДЕНТИФИКАТОРом устройства, созданным левым сертификатом X. 509 и значением **области идентификатора** приложения.
