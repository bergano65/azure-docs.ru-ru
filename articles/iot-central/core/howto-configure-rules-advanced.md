...
Соединитель IoT Central для Power Automate и Azure Logic Apps позволяет создавать более сложные правила для автоматизации операций в IoT Central.
...
Чтобы добавить соединитель **Azure IoT Central (предварительная версия)** в качестве триггера в Power Automate, сделайте следующее:

1. В Power Automate щелкните **+ Создать**, а затем выберите вкладку **Пользовательские**.
1. Найдите *IoT Central* и выберите соединитель **Azure IoT Central (предварительная версия)** .
...
Чтобы добавить соединитель **Azure IoT Central (предварительная версия)** в качестве триггера в Azure Logic Apps, сделайте следующее:
...
Чтобы добавить соединитель **Azure IoT Central (предварительная версия)** в качестве действия в Azure Logic Apps, сделайте следующее.
