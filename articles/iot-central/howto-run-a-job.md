...
1. Выберите **+ создать** , чтобы создать новое задание.
    ...
    ![Создать задание](./media/howto-run-a-job/createnewjob.png)
...
| Неудача               | Это задание завершилось сбоем и выполнено не полностью на устройствах.  |
| Ожидается              | Это задание еще не начала выполняться на устройствах.         |
| Работает              | Это задание в данный момент выполняется на устройствах.             |
...
| Неудача               | Число устройств, на которых не удалось выполнить задание.       |
...
| Неудача               | Это задание завершилось сбоем на этом устройстве. В сообщении об ошибке содержатся дополнительные сведения.  |
| Ожидается              | Задание еще не выполнялось на этом устройстве.                                   |
