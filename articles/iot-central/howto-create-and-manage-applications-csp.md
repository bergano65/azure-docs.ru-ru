...
Чтобы создать приложение IoT Central Azure, выберите плитку **создать приложение** . Будет загружена страница создания приложения. Необходимо заполнить все поля на этой странице и нажать кнопку **Создать**. Ниже приводятся сведения о каждом поле.
