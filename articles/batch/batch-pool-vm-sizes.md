...
| Серия виртуальной машины  | Поддерживаемые размеры | Режим распределения пула учетных записей пакетной службы<sup>1</sup> |
|------------|---------|-----------------|
...
| [Оптимизированные для памяти размеры](../virtual-machines/linux/sizes-memory.md) | Нет | Недоступно |
