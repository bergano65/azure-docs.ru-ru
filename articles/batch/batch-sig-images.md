---
title: Использование общей коллекции образов для создания настраиваемого пула
description: Пользовательские образы представляют собой эффективный способ настройки вычислительных узлов для выполнения рабочих нагрузок пакетной службы.
ms.topic: conceptual
ms.date: 05/22/2020
...
ms.locfileid: "83844494"
---
# <a name="use-the-shared-image-gallery-to-create-a-custom-pool"></a>Использование общей коллекции образов для создания настраиваемого пула

При создании пула в пакетной службе Azure с помощью конфигурации виртуальной машины необходимо указать образ виртуальной машины, предоставляющий операционную систему, для каждого вычислительного узла в пуле. Пул виртуальных машин можно создать на основе поддерживаемого образа из Azure Marketplace или настраиваемого образа из [Общей коллекции образов](../virtual-machines/windows/shared-image-galleries.md).
...
- **Повышенная производительность по сравнению с настраиваемым образом.** Используя общие образы, можно сократить время, необходимое пулу для достижения стабильного состояния, на 25 %, а задержку простоя виртуальной машины на 30 %.
...
В Azure подготовить настраиваемый образ можно с помощью:
