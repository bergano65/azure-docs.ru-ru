...
- **Более высокая производительность, чем использование только управляемого образа в качестве пользовательского образа.** Для пользовательского пула образов с общим изображением время достижения стабильного состояния составляет 25% фастерм, а задержка простоя виртуальной машины составляет 30%.
