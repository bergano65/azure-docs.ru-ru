...
Если вы предпочитаете предоставить доступ к хранилищу ключей вручную, перейдите в раздел " **политики доступа** " хранилища ключей и выберите **Пакетная служба Microsoft Azure**. Настройте **разрешения секрета** с помощью раскрывающегося меню. Для пакетной службы Azure необходимо предоставить минимум разрешений **Get**, **List**, **Set**и **Delete** .
