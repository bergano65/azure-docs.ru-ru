...
Принудительное применение выделенных базовых квот повышается за счет того, что изменения становятся доступными на этапах и выполняются для всех учетных записей пакетной службы в конце января 2021.
...
Эти дополнительные ограничения устанавливаются пакетной службой. В отличие от [квот ресурсов](#resource-quotas) эти значения нельзя изменить.
...
:::image type="content" source="./media/batch-quota-limit/account-quota-portal.png" alt-text="Снимок экрана, показывающий квоты учетной записи пакетной службы в портал Azure.":::
...
1. В разделе **Подробные сведения** содержится следующая информация:
    ...
    1. На вкладке **Укажите сведения** укажите расположение, тип квоты и учетную запись пакетной службы.
       ...
       :::image type="content" source="media/batch-quota-limit/quota-increase.png" alt-text="Снимок экрана с экраном сведений о квотах при запросе увеличения квоты.":::
