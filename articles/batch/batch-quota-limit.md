...
Квоты ядра существуют для каждой серии виртуальных машин, поддерживаемой пакетной службой, и отображаются на странице **квот** на портале. Квоты на ряд виртуальных машин можно обновить с помощью запроса на поддержку, как описано ниже. Для выделенных узлов Пакетная операция обеспечивает ограничение квоты ядра для каждой серии виртуальных машин, а также общий предел квоты ядра для всей учетной записи пакетной службы. Для узлов с низким приоритетом Пакетная обработка обеспечивает только общую квоту ядра для учетной записи пакетной службы без различия между разными сериями виртуальных машин.
