...
Также Обратите внимание, что квоты не гарантируется, что значения. Квоты могут отличаться в зависимости от изменения из пакетной службы или запрос пользователя, чтобы изменить значение квоты.
...
Ограничения на размер пула задаются пакетной службой. В отличие от [квоты ресурсов](#resource-quotas), эти значения нельзя изменить. Только пулы с обмен данными между узлами и пользовательские образы имеют ограничения, отличается от Стандартная Квота.
...
Дополнительные ограничения, задайте пакетной службой. В отличие от [квоты ресурсов](#resource-quotas), эти значения нельзя изменить.
