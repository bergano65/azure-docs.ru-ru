...
1. В разделе **Подробные сведения** содержится следующая информация:
    ...
    а. В поле **Укажите сведения**укажите расположение, тип квоты и учетную запись пакетной службы.
    ...
    * **На регион**  
    ...
    b. Выберите **серьезность** в соответствии с [влиянием на бизнес][support_sev].
