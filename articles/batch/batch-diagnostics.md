...
* Отправка журналов диагностики в [Azure Monitor регистрирует](../log-analytics/log-analytics-overview.md), где вы можете анализировать их или экспортировать для анализа в Power BI или Excel.
...
3. В **параметров диагностики**, введите имя параметра и выберите расположение для журналов (существующую учетную запись хранения, концентратор событий или журналов Azure Monitor). Выберите **ServiceLog**, **AllMetrics** или оба параметра сразу.
