---
title: Хранение и перемещение данных для рендеринга в пакетной службе Azure
description: Узнайте о различных вариантах хранения данных и перемещения данных для визуализации рабочих нагрузок файлов активов и выходных данных.
services: batch
ms.service: batch
author: mscurrell
ms.author: markscu
...
* [Хранение azure blob:](https://docs.microsoft.com/azure/storage/blobs/storage-blobs-introduction)
...
* [Хранение капли azure](https://docs.microsoft.com/azure/storage/blobs/storage-blobs-introduction)
