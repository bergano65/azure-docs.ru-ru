...
Вы можете изучить [эту запись блога](https://blogs.msdn.microsoft.com/windowsazurestorage/2014/05/26/persisting-connections-to-microsoft-azure-files/) и [документацию](../storage/files/storage-how-to-use-files-windows.md), посвященные подключению общего файлового ресурса службы файлов Azure.
