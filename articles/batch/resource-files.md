...
Если каждая задача имеет много уникальных для нее файлов, лучше всего использовать файлы ресурсов, так как подобные задачи требуется часто обновлять или заменять, что не так просто делать с помощью содержимого пакетов приложений. Файлы ресурсов обеспечивают дополнительную гибкость при обновлении, добавлении или изменении отдельных файлов.
