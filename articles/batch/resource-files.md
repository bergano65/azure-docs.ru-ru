...
Если не удается сократить количество необходимых задаче файлов, можно оптимизировать задачу, создав отдельный файл ресурсов, который ссылается на контейнер хранилища с файлами ресурсов. Для этого вставьте файлы ресурсов в контейнер службы хранилища Azure и используйте различные [методы](/dotnet/api/microsoft.azure.batch.resourcefileazure-dotnet#methods) контейнера для файлов ресурсов. Используйте параметры префикса BLOB-объектов, чтобы указать коллекции файлов, которые будут скачаны для задач.
