...
Ниже приведены примеры двух формул автомасштабирования, которые можно настроить для работы в большинстве сценариев. Переменные, `startingNumberOfVMs` и `maxNumberofVMs` в примерах формул, могут быть скорректированы в соответствии с вашими потребностями.
