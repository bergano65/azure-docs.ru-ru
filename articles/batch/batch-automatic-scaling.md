...
| Определяемые службой переменные для чтения и записи | Description |
| --- | --- |
...
| Определяемые службой переменные только для чтения | Description |
| --- | --- |
...
| Компонент | Возвращаемый тип | Description |
| --- | --- | --- |
