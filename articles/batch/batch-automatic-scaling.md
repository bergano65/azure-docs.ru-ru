...
В этом фрагменте кода [.NET][net_api] для этой пакетной программы вычисляется формула автомасштабирования. Если в пуле не включено автомасштабирование, сначала необходимо его включить.
