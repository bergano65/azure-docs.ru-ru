...
* **Перезагрузка узла** ([остальные][rest_reboot] | [.NET][net_reboot])
...
* **Переобразировать узел** ([остальные][rest_reimage] | [.NET][net_reimage])
...
* **Удаление узла из пула** ([остальные][rest_remove] | [.NET][net_remove])
