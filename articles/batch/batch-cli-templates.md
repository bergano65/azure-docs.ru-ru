...
Шаблоны пакетов основывается на существующей поддержке пакета в [Azure CLI](batch-cli-get-started.md#json-files-for-resource-creation) для файлов JSON для определения значений свойств при создании пулов, заданий, задач и других элементов. Шаблоны пакетной службы добавляют следующие возможности.
