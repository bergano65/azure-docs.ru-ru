...
> [!IMPORTANT]
> Поддержка пулов без общедоступных IP-адресов в пакетной службе Azure в настоящее время доступна в общедоступной предварительной версии для следующих регионов: Франция Central, Восточная Азия, Западная Центральная часть США, Юго-Центральный регион США, Западная часть США 2, восток США, Северная Европа, Восточная часть США 2, Центральная часть США, Западная Европа.
