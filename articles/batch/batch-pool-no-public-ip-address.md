...
> [!IMPORTANT]
> Поддержка пулов без общедоступных IP-адресов в пакетной службе Azure в настоящее время доступна в общедоступной предварительной версии для Западной Центральной части США, восточной части US, юго-центральной части США, Западная часть США 2, US Gov (Вирджиния) и US Gov (Аризона) регионов.
...
![Экран добавления пула с выбранным НопублиЦипаддрессес](./media/batch-pool-no-public-ip-address/create-pool-without-public-ip-address.png)
