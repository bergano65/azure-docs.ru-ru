...
description: Возможности Standard Azure Batch используются для выполнения визуализации рабочих нагрузок и приложений. Пакет включает в себя определенные функции для поддержки визуализации рабочих нагрузок.
services: batch
ms.service: batch
author: mscurrell
ms.author: markscu
