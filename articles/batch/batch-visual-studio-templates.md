...
2. В Обозреватель решений щелкните решение правой кнопкой мыши и выберите команду **Добавить** > **Новый проект**.
...
По умолчанию при сбое не будет выполняться повторный запуск диспетчера заданий. В зависимости от логики диспетчера заданий клиент может захотеть включить повторные попытки через *ограничения*/*maxTaskRetryCount*.
