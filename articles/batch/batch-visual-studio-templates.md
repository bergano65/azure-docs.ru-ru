...
* Шаблоны пакетной службы, доступные из [коллекции Visual Studio][vs_gallery] в виде расширений Visual Studio. Получить шаблоны можно двумя способами:
  ...
  * Загрузите шаблоны из онлайн-коллекции для Visual Studio: [Шаблоны проектов пакетная служба Microsoft Azure][vs_gallery_templates]
...
Пакетная служба имеет простой механизм передачи параметров среды задаче диспетчера заданий с помощью `EnvironmentSettings` свойства в [Microsoft. Azure. Batch. JobManagerTask][net_jobmanagertask].
