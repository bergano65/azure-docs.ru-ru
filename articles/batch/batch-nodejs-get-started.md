---
title: Использование клиентской библиотеки пакетной службы Azure для Node.js
...
![Схема, демонстрирующая архитектуру сценария.](./media/batch-nodejs-get-started/BatchScenario.png)
