...
5. *Необязательно*. Используйте [портал Azure][portal] или [Batch Explorer][batch_labs] , чтобы просмотреть пример пула, задания и задачи ("MultiInstanceSamplePool", "MultiInstanceSampleJob", "MultiInstanceSampleTask") перед удалением ресурсов.
