---
title: Создавайте задачи для подготовки & выполнения заданий на вычислительных узлах - Azure Batch
...
Перед выполнением задач задания Пакет выполняет задачу подготовки заданий на каждом вычислительном узлах, запланированных для выполнения задачи. По умолчанию Batch ждет выполнения задачи подготовки к заданию перед выполнением задач, запланированных для выполнения на узлах. Это ожидание можно отключить в настройках службы. При перезагрузке узла задача подготовки к задания выполняется снова. Вы также можете отключить это поведение. Если у вас есть задание с заданием по подготовке заданий и настраиваемый менеджер омработки, задача подготовки заданий выполняется до задачи менеджера задач, как и для всех других задач. Задание по подготовке задания всегда выполняется первым.
...
Задачи по выпуску заданий могут выполняться не более 15 минут, прежде чем быть прекращены службой пакетов. Для получения дополнительной информации смотрите [справочную документацию REST API](https://docs.microsoft.com/rest/api/batchservice/job/add#jobreleasetask).
> 
> 
