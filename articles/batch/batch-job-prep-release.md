...
Задачи выпуска заданий могут выполняться максимум в течение 15 минут до того, как они будут завершены пакетной службой. Дополнительные сведения см. в [справочной документации REST API](https://docs.microsoft.com/rest/api/batchservice/job/add#jobreleasetask).
> 
> 
