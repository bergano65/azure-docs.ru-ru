---
title: Событие завершения выполнения задачи пакетной службы Azure
...
|[`multiInstanceSettings`](#multiInstanceSettings)|Сложный тип|Указывает, что задача включает в себя несколько экземпляров и требует несколько вычислительных узлов.  Подробные сведения см. в разделе [`multiInstanceSettings`](https://docs.microsoft.com/rest/api/batchservice/get-information-about-a-task).|
