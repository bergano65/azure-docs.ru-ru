...
* Чтобы просмотреть другие триггеры Функций Azure, которые можно использовать для запуска рабочих нагрузок пакетной службы, ознакомьтесь с [документацией по Функциям Azure](../azure-functions/functions-triggers-bindings.md).
