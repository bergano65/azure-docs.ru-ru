---
title: Руководство. Активация пакетного задания с использованием Функций Azure
...
Из этого руководства вы узнаете, как активировать пакетное задание с помощью [Функций Azure](../azure-functions/functions-overview.md). Мы рассмотрим пример, в котором к документам, добавленным в контейнер хранилища BLOB-объектов Azure, применяется оптическое распознавание символов (OCR) с помощью пакетной службы Azure. Чтобы упростить обработку распознавания, мы настроим функцию Azure, которая запускает пакетное задание распознавания текста при каждом добавлении файла в контейнер больших двоичных объектов. Вы узнаете, как выполнять следующие задачи:
...
1. Для создания функции выполните действия, описанные в статье [Создание функции, активируемой хранилищем BLOB-объектов Azure](../azure-functions/functions-create-storage-blob-triggered-function.md).
