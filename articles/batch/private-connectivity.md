...
> [!IMPORTANT]
> Поддержка частного подключения в пакетной службе Azure в настоящее время доступна в следующих регионах Azure: Central US, Северо-центральный регион США, Юго-Центральный регион США, Западная часть США, восток США, восток США 2, Запад, Западная часть США 2, Восточная Азия, Центральный Франция, южная часть Соединенного Королевства, Северная Европа, Западная Европа, Восточная Япония, Западная Япония, Восточная Австралия, а также все US Gov и US DoD регионы.
