...
> [!IMPORTANT]
> Поддержка частного подключения в пакетной службе Azure в настоящее время доступна для всех общедоступных регионов, кроме Германии Central и Северо-Восточная Германия.
...
6. В области **ресурсов** задайте **тип ресурса** **Microsoft.BatCH/батчаккаунтс**. Выберите учетную запись частного пакета, к которой требуется получить доступ, а затем нажмите кнопку **Далее: Конфигурация**.
   :::image type="content" source="media/private-connectivity/create-private-endpoint.png" alt-text="Подключения к частным конечным точкам&quot;:::
5. На панели &quot; **основы** ":::
...
:::image type="content" source="media/private-connectivity/access-private.png" alt-text="Подключения к частным конечным точкам&quot;:::
5. На панели &quot; **основы** ":::
