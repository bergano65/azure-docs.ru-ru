...
Поддержка частного подключения в пакетной службе Azure в настоящее время доступна в следующих регионах Azure: Западная Центральная часть США, Запад США 2, восток США, Юго-Центральный регион США, US Gov (Вирджиния), US Gov (Аризона), Восточная Азия, Франция и южная часть Соединенного Королевства.
