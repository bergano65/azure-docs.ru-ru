...
| API | Справочник по интерфейсам API | Скачать | Учебник | Примеры кода | Подробнее |
| --- | --- | --- | --- | --- | --- |
...
| **Пакетная служба Python** |[docs.microsoft.com][api_python] |[PyPI][api_python_pypi] |[Руководство](tutorial-parallel-python.md)|[GitHub][api_sample_python] | [Readme](https://github.com/Azure/azure-sdk-for-python/blob/master/sdk/batch/azure-batch/README.md) |
...
| API | Справочник по интерфейсам API | Скачать | Учебник | Примеры кода |
| --- | --- | --- | --- | --- |
