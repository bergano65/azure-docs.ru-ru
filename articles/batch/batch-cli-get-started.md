...
- **Проверка подлинности через Azure Active Directory (Azure AD)** . 
    ...
    Преимущество Azure AD заключается в том, что эта служба предоставляет управление доступом на основе ролей (RBAC). При использовании RBAC доступ пользователя зависит от назначенной роли, а не наличия ключей учетной записи. Вместо управления ключами учетной записи вы можете управлять ролями Azure и разрешать доступ и проверку подлинности в Azure AD.  
