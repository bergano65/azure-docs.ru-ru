---
title: Использование коллекции общих образов для создания пула с помощью пакетной службы Azure | Документация Майкрософт
...
ms.locfileid: "70141829"
---
# <a name="use-the-shared-image-gallery-to-create-a-pool"></a>Создание пула с помощью коллекции общих образов
...
![Создайте пул из общего образа с помощью портала.](media/batch-custom-images/create-custom-pool.png)
