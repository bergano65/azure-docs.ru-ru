...
> [!WARNING]
> IP-адреса пакетной службы могут меняться со временем. Чтобы предотвратить сбой из-за изменения IP-адреса, мы рекомендуем установить периодический процесс обновления IP-адресов пакетной службы и регулярно обновлять их в таблице маршрутов.
