---
title: Установка пакетов приложений на COMPUTE nodes
...
![Предупреждение "нет настроенной учетной записи хранения" в портал Azure][9]
...
Рекомендуется создать учетную запись хранения *специально* для использования с учетной записью пакетной службы и выбрать ее здесь. Созданную учетную запись хранения затем можно связать с учетной записью пакетной службы в окне **Учетная запись хранения**.
...
[5]: ./media/batch-application-packages/app_pkg_05.png "Колонка "новое приложение" в портал Azure"
...
[10]: ./media/batch-application-packages/app_pkg_10.png "Выберите колонку учетной записи хранения в портал Azure"
[11]: ./media/batch-application-packages/app_pkg_11.png "Колонка "Обновление пакета" в портал Azure"
