...
|resultMessage|Строковое|Ошибка изменения размера содержит сведения о результате.<br /><br /> Если размер успешно изменен, сообщается, что операция выполнена.|