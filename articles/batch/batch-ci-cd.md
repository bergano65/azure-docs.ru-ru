...
* [Создание проекта в Azure DevOps](/azure/devops/organizations/projects/create-projects)
...
1. Создать конвейер сборки можно двумя способами:
    ...
    b. [С помощью сборок YAML](/azure/devops/pipelines/get-started-yamls). Вы можете создать конвейер YAML, выбрав элемент Azure Repos или GitHub на странице "Новый конвейер". Кроме того, можно сохранить приведенный ниже пример в системе управления версиями и сослаться на существующий файл YAML, щелкнув в визуальном конструкторе и использовав шаблон YAML.
