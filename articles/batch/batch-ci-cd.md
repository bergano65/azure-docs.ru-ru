...
* [Создание организации Azure DevOps](/azure/devops/organizations/accounts/create-organization)
* [Создание проекта в Azure DevOps](/azure/devops/organizations/projects/create-project)
...
* Папка **HPC-Application** , которая является Windows 64-разрядной версией [FFmpeg 4.3.1](https://www.gyan.dev/ffmpeg/builds/packages/ffmpeg-4.3.1-2020-10-01-essentials_build.7z).
...
* [Что такое система управления версиями?](/azure/devops/user-guide/source-control)
...
1. Создать конвейер сборки можно двумя способами:
    ...
    а. [С помощью визуального конструктора](/azure/devops/pipelines/get-started-designer). Для этого на странице **Новый конвейер** щелкните "Использовать визуальный конструктор".

    b. [С помощью сборок YAML](/azure/devops/pipelines/get-started-yaml). Вы можете создать конвейер YAML, выбрав элемент Azure Repos или GitHub на странице "Новый конвейер". Кроме того, можно сохранить приведенный ниже пример в системе управления версиями и сослаться на существующий файл YAML, щелкнув в визуальном конструкторе и использовав шаблон YAML.
...
> [!NOTE]
> Если вы используете клиентское приложение для выполнения пакетного приложения HPC, необходимо создать отдельное определение сборки для него. Ряд руководств можно найти в документации по [Azure Pipelines](/azure/devops/pipelines/get-started/index).
