...
- **"cloudServiceConfiguration" или "virtualMachineConfiguration".**
    следует использовать "virtualMachineConfiguration". Пулы "virtualMachineConfiguration" поддерживают все функции пакетной службы. Не все функции поддерживаются для пулов "cloudServiceConfiguration", и новые возможности не планируются.
