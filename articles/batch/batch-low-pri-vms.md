...
>
> Пулы пакетной службы Azure начнут поддерживать виртуальные машины в первом квартале 2020 с новыми версиями [API-интерфейсов и средств пакетной](https://docs.microsoft.com/azure/batch/batch-apis-tools)службы. Виртуальные машины с низким приоритетом продолжат поддерживаться, используя текущие версии API и средства по крайней мере за 12 месяцев, чтобы обеспечить достаточное время для миграции на виртуальные машины. 
>
