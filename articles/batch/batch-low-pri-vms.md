...
* Начните планировать переход с низкоприоритетных виртуальных машин на точечные виртуальные машины. Если вы используете виртуальные машины с низким приоритетом с **пулами конфигурации облачной службы**, продумайте переход на пулы **конфигурации виртуальной машины**.
