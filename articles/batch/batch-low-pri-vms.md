...
![Снимок экрана, показывающий выбор метрики для узлов с низким приоритетом.](media/batch-low-pri-vms/low-pri-metrics.png)
