...
> [!IMPORTANT]
> Для больших кластеров и в зависимости от размера виртуальных машин, выбранных для узлов, может потребоваться увеличить квоту на число ядер в подписке. Чтобы запросить увеличение квоты, отправьте [запрос в службу поддержки клиентов](../../azure-portal/supportability/how-to-create-azure-support-request.md) бесплатно. Если вы используете [бесплатную учетную запись Azure](https://azure.microsoft.com/free/), вам доступно ограниченное количество вычислительных ядер Azure.
> 
