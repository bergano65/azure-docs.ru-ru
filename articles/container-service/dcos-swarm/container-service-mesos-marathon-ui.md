...
Чтобы увидеть пользовательский интерфейс Marathon, перейдите по http: \/ /ЛОКАЛХОСТ/марасон.. На этом экране можно запустить новый контейнер или другие приложения в кластере DC/OS службы контейнеров Azure. Здесь вы также можете просмотреть информацию о работе контейнеров и приложений.  
