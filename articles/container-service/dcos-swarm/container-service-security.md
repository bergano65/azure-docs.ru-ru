...
* **DC/OS**: [Securing Your Cluster](https://docs.mesosphere.com/1.12/administering-clusters/securing-your-cluster) (Защита кластера)
...
* Дополнительные сведения о безопасности платформы Azure см. на странице [центра безопасности Azure](https://www.microsoft.com/trustcenter/cloudservices/azure).
