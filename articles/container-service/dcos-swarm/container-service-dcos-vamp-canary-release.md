...
* Ознакомьтесь со сведениями об управлении действиями Vamp через интерфейс [REST API Vamp](https://docs.vamp.io/how-vamp-works/events-and-metrics#events).

* Создайте сценарии автоматизации Vamp, используя Node.js, и выполните их как [рабочие процессы Vamp](https://docs.vamp.io/how-vamp-works/concepts-and-components#workflows).

* Также ознакомьтесь с дополнительными [руководствами по VAMP](https://docs.vamp.io/tutorials/).
