...
[DaemonSets](https://kubernetes.io/docs/concepts/workloads/controllers/daemonset/) используются Kubernetes для выполнения одного экземпляра контейнера на каждом узлах в кластере.
