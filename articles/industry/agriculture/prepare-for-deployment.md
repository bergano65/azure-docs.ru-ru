...
| Подключение. номер  | Имя ресурса  | Компонент Фармбеатс  |
|---------|---------|---------|
...
2. Выполните вход с использованием учетных данных портал Azure.
3. Вы можете увидеть Swagger и выполнить все операции RESTFUL в API-интерфейсах Azure Фармбеатс. Это означает успешное развертывание Azure Фармбеатс.
