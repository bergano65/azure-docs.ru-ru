...
**Датахуб** можно найти по адресу\<HTTPS://фармбеатс-website-Name>-API.azurewebsites.NET/Swagger. Здесь вы увидите различные объекты API Фармбеатс и выполняют операции RESTFUL с API.
