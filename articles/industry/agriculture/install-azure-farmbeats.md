...
4. Сценарий AAD занимает около 2 минут для запуска и вывода значений на экране, а также для JSON-файла в том же каталоге. Если вы еще не работали с этим сценарием, попросите его поделиться этим выходом.
