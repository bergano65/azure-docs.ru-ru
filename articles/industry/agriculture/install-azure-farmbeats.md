...
Вы можете проверить разрешения на доступ в портал Azure, следуя инструкциям в статье [Управление доступом на основе ролей в Azure](../../role-based-access-control/check-access.md).
