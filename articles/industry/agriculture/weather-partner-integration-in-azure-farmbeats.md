---
title: Интеграция с партнером по погоде
...
ms.locfileid: "86232650"
---
# <a name="weather-partner-integration"></a>Интеграция с партнером по погоде
...
Если вы установили Фармбеатс, вы можете получить доступ к Фармбеатс Swagger по адресу[https://yourfarmbeatswebsitename-api.azurewebsites.net](https://yourfarmbeatswebsitename-api.azurewebsites.net/swagger)

Обратите внимание, что "-API" добавляется в имя веб-сайта Фармбеатс.
Конечная точка API будет:[https://yourfarmbeatswebsitename-api.azurewebsites.net](https://yourfarmbeatswebsitename-api.azurewebsites.net)
...
Дополнительные сведения о работе конвейеров и действий ADF см. в разделе [https://docs.microsoft.com/azure/data-factory/copy-activity-schema-and-type-mapping](https://docs.microsoft.com/azure/data-factory/copy-activity-schema-and-type-mapping) .
