...
Чтобы получить данные о погоде, убедитесь, что [установлен фармбеатс](./install-azure-farmbeats.md). Интеграция с погодой поддерживается в версиях 1.2.11 и выше. 
