...
ms.locfileid: "73797859"
---
# <a name="ingest-historical-telemetry-data"></a>Прием исторических данных телеметрии
...
5. Перейдите в каталог, в который были отправлены файлы (по умолчанию они передаются в корневой каталог/Хоме/усернаме/.
...
7. Следуйте инструкциям на экране, чтобы выполнить процедуру.
    ...
    Обратитесь к администратору Фармбеатс, если у вас нет доступа к Фармбеатс или вашей подписке Azure.
