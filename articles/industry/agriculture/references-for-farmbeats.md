...
Задание  | Задание соответствует любому рабочему процессу действий, которые выполняются в системе Фармбеатс для получения нужных выходных данных. Каждое задание связано с ИДЕНТИФИКАТОРом задания и типом задания.
