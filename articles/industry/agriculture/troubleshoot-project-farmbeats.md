...
2. Выберите **концентратор событий** (датафидевенсубнамеспаце...) и проверьте число входящих сообщений.   
...
### <a name="sentinel-hub-wrong-url-or-not-accessible"></a>Неверный URL-адрес концентратора маркеров или недоступен 
