...
API-интерфейсы содержат техническую документацию по Swagger. Дополнительные сведения об API и соответствующих запросах или ответах см. в разделе [Swagger](https://aka.ms/FarmBeatsSwagger).
...
- /**Сенсормодел**: сенсормодел соответствует метаданным датчика, например изготовителю, типу датчика, который является либо аналоговым, либо цифровым, и мерой датчика, например окружающей температуры и нажимом.
...
Фармбеатс поддерживает добавление новых типов мер датчика и единиц. Дополнительные сведения об API/Екстендедтипе см. в разделе [Swagger](https://aka.ms/FarmBeatsSwagger).
