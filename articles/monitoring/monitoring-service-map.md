...
Эта статья описывает подключение и использование Сопоставления служб. Сведения о настройке решения "Сопоставление служб" и соответствующих агентов подключения см. в статье [Настройка схемы услуги в Operations Management Suite]( monitoring-service-map-configure.md).

>[!NOTE]
>Если Сопоставление служб уже развернуто, вы можете также просматривать свои карты в Azure Monitor для виртуальных машин, которая включает дополнительные возможности для мониторинга работоспособности и производительности виртуальной машины. Дополнительные сведения см. в разделе [Общие сведения об Azure Monitor для виртуальных машин](monitoring-vminsights-overview.md).
...
3. На странице результатов поиска по Marketplace выберите в списке значение **Сопоставление служб**.<br><br> ![Выбор решения "Сопоставление служб" в результатах поиска по Azure Marketplace](./media/monitoring-service-map/marketplace-search-results.png)<br>
4. В области обзора **Сопоставление служб** просмотрите сведения о решении и нажмите кнопку **Создать**, чтобы начать процесс подключения к рабочей области Log Analytics.<br><br> ![Подключение решения "Сопоставление служб"](./media/monitoring-service-map/service-map-onboard.png)
5. В области **Настройка решения** выберите существующую или создайте рабочую область Log Analytics.  Сведения о создании рабочей области см. в разделе [Создание рабочей области Log Analytics на портале Azure](../log-analytics/log-analytics-quick-create-workspace.md). Указав необходимые сведения, нажмите кнопку **Создать**.  

Пока проверяются данные, ход развертывания решения можно проверить в разделе **Уведомления** в меню. 

Обратитесь к Сопоставлению служб на портале Azure из рабочей области Log Analytics и выберите параметр **Решения** на левой панели.<br><br> ![Выбор параметра "Решения" в рабочей области](./media/monitoring-service-map/select-solution-from-workspace.png)<br> В списке решений выберите **ServiceMap(имя_рабочей_области)** и щелкните плитку сводки для Сопоставления служб на странице обзора решения Сопоставления служб.<br><br> ![Плитка сводки для Сопоставления служб](./media/monitoring-service-map/service-map-summary-tile.png)
...
![Событие ConfigurationChange](media/monitoring-service-map/configuration-change-event-01.png)
