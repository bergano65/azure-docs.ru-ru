...
![Логотип Office 365](media/monitoring-solution-office-365/icon.png)
...
Начните с добавления [решения Office 365 в подписку](monitoring-solutions.md#install-a-management-solution). Когда оно будет добавлено, вам нужно выполнить шаги по настройке, описанные в этом разделе, чтобы предоставить решению доступ к подписке Office 365.
...
1. Щелкните **Регистрация нового приложения**.
    ...
    ![Добавление регистрации приложений](media/monitoring-solution-office-365/add-app-registration.png)
1. Введите **имя** приложения и **URL-адрес входа**.  Имя должно быть описательным.  Используйте _http://localhost_ для URL-адреса и оставьте в поле **Тип приложения** значение _Веб-приложение или API_.
    ...
    ![Создание приложения](media/monitoring-solution-office-365/create-application.png)
1. Щелкните **Создать** и проверьте сведения о приложении.

    ![Зарегистрированное приложение](media/monitoring-solution-office-365/registered-app.png)
...
1. Выберите **Свойства**. Задайте для параметра **Мультитенантный** значение _Да_.
    ...
    ![Настройка мультитенантного приложения](media/monitoring-solution-office-365/settings-multitenant.png)
...
1. Щелкните **Select an API** (Выбор API), а затем — **Office 365 Management APIs** (Интерфейсы API управления Office 365). Выберите **Office 365 Management APIs** (Интерфейсы API управления Office 365). Нажмите кнопку **Выбрать**.
    ...
    ![Выбор API](media/monitoring-solution-office-365/select-api.png)
...
1. В разделе **Выберите разрешения** выберите следующие параметры в разделах **Разрешения приложений** и **Делегированные разрешения**:
    ...
    ![Выбор API](media/monitoring-solution-office-365/select-permissions.png)

1. Нажмите кнопку **Выбрать**, а затем — **Готово**.
1. Щелкните **Предоставить разрешения**, а затем — **Да** при появлении запроса на проверку.

    ![Предоставление разрешений](media/monitoring-solution-office-365/grant-permissions.png)
...
1. Нажмите кнопку **Сохранить**, а затем скопируйте созданное **значение**.
    ...
    ![ключей](media/monitoring-solution-office-365/keys.png)
...
1. Появится окно, аналогичное приведенному ниже. Нажмите кнопку **Принимаю**.
    ...
    ![Согласие администратора](media/monitoring-solution-office-365/admin-consent.png)
...
![Плитка сводки Office 365](media/monitoring-solution-office-365/tile.png)  

Щелкните элемент **Office 365**, чтобы открыть панель мониторинга **Office 365**.

![Панель мониторинга Office 365](media/monitoring-solution-office-365/dashboard.png)  
