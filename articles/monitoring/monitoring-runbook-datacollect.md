...
![Модуль OMSIngestionAPI](media/monitoring-runbook-datacollect/OMSIngestionAPI.png)
...
![Изменение модуля runbook](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Тестирование модуля runbook](media/monitoring-runbook-datacollect/test-runbook.png)
...
![Публикация модуля runbook](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Ведение журнала и трассировка](media/monitoring-runbook-datacollect/logging.png)
...
![Создание расписания для модуля runbook](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
5. Прокрутите вниз, чтобы найти запись, как на изображении ниже.<br>![Подробная информация](media/monitoring-runbook-datacollect/verbose.png)
...
- Поместите модуль runbook в пакет [решения по управлению](monitoring-solutions-creating.md), чтобы можно было распространять его среди заказчиков.
