...
Вы также можете получить подробные сведения о *instanceView* для всех экземпляров в одном вызове API, что поможет избежать регулирования API для больших установок.
