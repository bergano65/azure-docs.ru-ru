---
title: Работа с большими наборами виртуальной шкалы машин Azure
description: Что нужно знать о больших наборах виртуальных машин Azure, чтобы использовать их в приложении.
author: cynthn
ms.author: cynthn
...
Для полного примера шаблона набора [https://github.com/gbowerman/azure-myriad/blob/master/bigtest/bigbottle.json](https://github.com/gbowerman/azure-myriad/blob/master/bigtest/bigbottle.json)крупного масштаба, обратитесь к .
