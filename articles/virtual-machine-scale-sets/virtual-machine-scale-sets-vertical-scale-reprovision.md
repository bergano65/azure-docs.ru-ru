---
title: Вертикальные масштабы наборов виртуальных машин Azure
...
* [Примеры для быстрого запуска Azure Monitor с помощью PowerShell](../azure-monitor/platform/powershell-quickstart-samples.md)
