...
## <a name="azure-virtual-machine-scale-sets-with-azure-load-balancer"></a>Наборы виртуальных машин Azure с azure Load Balancer
...
* **Порт-форвардинг и входящие правила NAT:**
  ...
  * При использовании виртуальной шкалы машины, установленной в пуле бэкэнда балансоилира нагрузки, входящие правила NAT по умолчанию создаются автоматически.
* **Правила балансировки нагрузки**.
  * При использовании виртуальной шкалы машины, установленной в пуле бэкэнда балансирующего нагрузочника, правило балансировки нагрузки по умолчанию создается автоматически.
* **Правила выезда**:
  *  Чтобы создать исходящие правила для пула бэкэнда, на который уже ссылается правило балансировки нагрузки, необходимо сначала отметить **"Создать неявные правила исходящего"** как **Нет** в портале при создании правила балансировки входящих нагрузок.
  ...
  :::image type="content" source="./media/vmsslb.png" alt-text="Создание правил балансировки нагрузки" border="true":::
...
* [Настроили виртуальный набор масштабов машины с существующим балансом загрузки Azure с помощью портала Azure.](https://docs.microsoft.com/azure/load-balancer/configure-vm-scale-set-portal)
* [Настроили виртуальный набор масштабов машины с существующим балансом загрузки Azure с помощью Azure PowerShell.](https://docs.microsoft.com/azure/load-balancer/configure-vm-scale-set-powershell)
* [Настроили виртуальный набор масштабов машины с существующим балансом загрузки Azure с помощью Azure CLI.](https://docs.microsoft.com/azure/load-balancer/configure-vm-scale-set-cli)
