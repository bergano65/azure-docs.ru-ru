---
title: Дизайн соображения для Azure Виртуальные наборы шкалы машин
description: Узнайте о соображениях проектирования для наборов виртуальной шкалы масштабов azure. Сравните функции наборов масштабов с функциями VM.
...
- После указания конфигурации набора масштаба можно обновить свойство *емкости* для параллельного развертывания большего числа вс-аналогов. Этот процесс гораздо проще, чем написание сценария для оркестрации развертывания множества отдельных виртуальных машин в параллельном режиме.
...
- Вы можете [пересоздать образ виртуальных машин масштабируемого набора](https://docs.microsoft.com/rest/api/compute/virtualmachinescalesets/reimage), но [не отдельных виртуальных машин](https://docs.microsoft.com/rest/api/compute/virtualmachines).
