...
- **Простота создания множества виртуальных машин и управления ими**
    ...
    - Масштабируемые наборы поддерживают использование [Azure Load Balancer](../load-balancer/load-balancer-overview.md) для базового распределения трафика уровня 4 и [Шлюза приложений Azure](../application-gateway/overview.md) для более продвинутого распределения трафика уровня 7 и терминирования TLS.
...
- **Поддержка работы в большом масштабе**
    ...
    - Для улучшения производительности при выполнении рабочих нагрузок рабочей среды используйте [управляемые диски Azure](../virtual-machines/managed-disks-overview.md).
