...
При создании нового масштабируемого набора можно включить уведомления об увольнении в масштабируемом наборе с помощью командлета [New-азвмсс](/powershell/module/az.compute/new-azvmss) .
