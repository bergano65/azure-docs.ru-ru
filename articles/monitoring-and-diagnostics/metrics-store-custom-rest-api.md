...
Создайте субъект-службу в клиенте Azure Active Directory, используя инструкции, приведенные в [этой статье](../active-directory/develop/howto-create-service-principal-portal.md). 
