...
Добавьте это расширение управляемых удостоверений для ресурсов Azure в шаблон в верхней части раздела resources.  Расширение гарантирует, что Azure Monitor принимает исходящие метрики.  
