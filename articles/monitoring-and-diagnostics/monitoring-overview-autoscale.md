...
* [портал Azure](monitoring-autoscale-get-started.md)
...
| --- | --- |
| Веб-приложения |[Scaling Web Apps (Масштабирование веб-приложения)](monitoring-autoscale-get-started.md) |
