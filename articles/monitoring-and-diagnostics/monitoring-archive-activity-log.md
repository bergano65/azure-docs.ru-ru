...
1. На портале щелкните ссылку **Журнал действий** на панели навигации слева. Если вы не видите эту ссылку, сначала щелкните ссылку **Все службы**.
    ...
    ![Переход к колонке журнала действий](media/monitoring-archive-activity-log/activity-logs-portal-navigate-v2.png)
2. В верхней части колонки щелкните **Экспорт в концентратор событий**.
   
    ![Нажатие кнопки "Экспорт"](media/monitoring-archive-activity-log/activity-logs-portal-export-v2.png)
