...
- [Записи пульсов для решения "Работоспособность агентов"](../monitoring/monitoring-solution-agenthealth.md).
...
3. **Установленные поддерживаемые решения Log Analytics**. Настроенное решение Log Analytics должно отправлять данные в рабочую область Log Analytics. Поддерживаемые решения: [счетчики производительности для Windows и Linux](../log-analytics/log-analytics-data-sources-performance-counters.md), [записи пульса для решения "Работоспособность агентов"](../monitoring/monitoring-solution-agenthealth.md), "Управление обновлениями" и [данные событий](../log-analytics/log-analytics-data-sources-windows-events.md).
