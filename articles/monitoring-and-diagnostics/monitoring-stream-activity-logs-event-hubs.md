...
* **Потоковая передача в сторонние системы ведения журнала и сбора телеметрии.** Со временем Центры событий Azure будут использоваться для передачи журнала действий в сторонние решения SIEM и Log Analytics.
...
1. Перейдите в раздел **Журнал действий**, используя раздел поиска **Все службы** в левой части портала.
   ...
   ![Выбор пункта "Журнал действий" из списка служб на портале](./media/monitoring-stream-activity-logs-event-hubs/activity-logs-portal-navigate-v2.png)
2. Нажмите кнопку **Экспорт в концентратор событий** в верхней части журнала.
   
   ![Кнопка "Экспорт" на портале](./media/monitoring-stream-activity-logs-event-hubs/activity-logs-portal-export-v2.png)
