...
ms.locfileid: "67544141"
---
# <a name="microsoft-azure-storage-explorer-release-notes"></a>Заметки о выпуске Обозревателя службы хранилища Microsoft Azure

Эта статья содержит заметки о выпуске обозревателя службы хранилища Azure 1.9.0, а также заметки о выпуске для предыдущих версий.
...
## <a name="version-190"></a>Версии 1.9.0
7/1/2019

### <a name="download-azure-storage-explorer-190"></a>Скачивание обозревателя службы хранилища Azure 1.9.0
...
* Теперь можно присоединить контейнеры больших двоичных объектов с помощью Azure AD (разрешения RBAC или ACL). Эта функция предназначена для пользователей, имеющих доступ к контейнеры, но не учетные записи хранения, контейнеры — в. См. в разделе наших руководство по началу работы Дополнительные сведения об этой функции.
* Приобрести и прервать аренду теперь поддерживают RBAC. [#1354](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1354)
* Управление политиками доступа и задании уровня общего доступа теперь работают с RBAC. [#1355](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1355)
* Удаление папки BLOB-объектов теперь работать с RBAC. [#1450](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1450)
* Изменение уровня доступа BLOB-объектов, которые теперь работают с RBAC. [#1446](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1446)
* Теперь можно быстро сбросить быстрый доступ через «Help» → «Сброс». [#1327](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1327)
...
* Исправлена, когда не удается загрузить больше 50 подписок для одной учетной записи. [#1416](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1416)
* Исправлена кнопка «Войти», не работает на информационной панели, отображаемого при невозможности прямую ссылку. [#1358](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1358)
* Исправлена не выполняется отправка файлов .app в macOS. [#1119](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1119)
* Исправлена «Повторить все» не работает для переименования неудачных BLOB-объектов. [#992](https://www.github.com/Microsoft/AzureStorageExplorer/issues/992)
* Исправлена «Отмена», не работает при открытии большого двоичного объекта. [#1464](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1464)
* Исправлено несколько проблем проверки орфографии и подсказки на уровне продукта. Выражаем благодарность всем, кто устранения этих проблем! [#1303](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1303), [#1328](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1328), [#1329](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1329), [#1331](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1331), [#1336](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1336), [#1352](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1352), [#1368](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1368), [#1395](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1395)
...
* [Версии 1.8.1](#version-181)
* [Версии 1.8.0](#version-180)
...
## <a name="version-181"></a>Версии 1.8.1
5/13/2019

### <a name="hotfixes"></a>Исправления
* В некоторых случаях нажав кнопку «Загрузка дополнительные» на уровне ресурсов не вернет следующую страницу ресурсов. Эта ошибка исправлена. [#1359](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1359)
* На Windows AzCopy загрузки приведет к сбою при загрузке одного файла или папки и имя файла или папки имели символ, недопустимый для пути Windows. Эта ошибка исправлена. [#1350](https://www.github.com/Microsoft/AzureStorageExplorer/issues/1350)
* В очень редких случаях при выполнении общей папки для переименования или переименования в общей папке, если не удалось копии для переименования или изучите хранилища не удалось проверить успешность копий с помощью Azure произошла потенциально обозревателя службы хранилища для удаления o исходные файлы, прежде чем был завершен копирования. Эта ошибка исправлена.
...
* Устранение неполадок обозревателя службы хранилища [руководство][2]
