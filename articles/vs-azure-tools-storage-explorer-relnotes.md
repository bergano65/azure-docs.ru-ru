...
### <a name="download-azure-storage-explorer-150"></a>Скачивание Обозревателя службы хранилища Azure 1.5.0
- [Обозреватель службы хранилища Azure 1.5.0 для Windows](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Обозреватель службы хранилища Azure 1.5.0 для Mac](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Обозреватель службы хранилища Azure 1.5.0 для Linux](https://go.microsoft.com/fwlink/?LinkId=722418)
...
* Прерывание аренды теперь возможно только по одному большому двоичному объекту за раз. Кроме того, необходимо ввести имя большого двоичного объекта, аренда которого прерывается. Это изменение было внесено, чтобы уменьшить вероятность случайного прерывания аренды, особенно в случае использования VHD-файлов для виртуальных машин. № 394
