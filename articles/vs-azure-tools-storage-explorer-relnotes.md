...
* Обозреватель службы хранилища теперь поддерживает управляемые диски. Можно сделать следующее:
...
* Обозреватель службы хранилища теперь поддерживает обратимое удаление. Можно сделать следующее:
