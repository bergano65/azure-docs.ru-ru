...
* Если вы используете RBAC, обозреватель службы хранилища требуется некоторые разрешения уровня управления, чтобы получить доступ к ресурсам хранилища. См. в разделе [руководство по устранению неполадок](https://docs.microsoft.com/en-us/azure/storage/common/storage-explorer-troubleshooting) Дополнительные сведения.
