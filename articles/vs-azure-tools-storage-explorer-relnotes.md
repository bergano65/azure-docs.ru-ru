...
ms.locfileid: "65620495"
---
# <a name="microsoft-azure-storage-explorer-release-notes"></a>Заметки о выпуске Обозревателя службы хранилища Microsoft Azure

Эта статья содержит заметки о выпуске обозревателя службы хранилища Azure 1.8.1, а также заметки о выпуске для предыдущих версий.
...
### <a name="download-azure-storage-explorer-181"></a>Скачивание обозревателя службы хранилища Azure 1.8.1
- [Обозреватель службы хранилища Azure 1.8.1 для Windows](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Обозреватель службы хранилища Azure 1.8.1 для Mac](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Обозреватель службы хранилища Azure 1.8.1 для Linux](https://go.microsoft.com/fwlink/?LinkId=722418)
