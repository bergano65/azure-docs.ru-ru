...
См. также [рекомендации по созданию тегов и управлению версиями для образов контейнеров](container-registry-image-tag-version.md), чтобы ознакомиться со стратегиями создания тегов и управления версиями образов в реестре. 
...
Реестр контейнеров Azure доступен на нескольких уровнях (называемых номерами SKU), каждый из которых обеспечивает разные возможности. Дополнительные сведения об уровнях служб см. в статье [Уровни служб реестра контейнеров Azure](container-registry-skus.md).
