...
| `stepTimeout` | int (секунды) | Yes | Максимальное число секунд выполнения шага. Это свойство можно переопределить на том или ином шаге, задав для него свойство времени ожидания. | Yes | 600 (10 минут) |
