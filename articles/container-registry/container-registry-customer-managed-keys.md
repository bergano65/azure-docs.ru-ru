...
> [!NOTE]
> В настоящее время можно использовать только Azure CLI, чтобы настроить реестр для автоматического обновления версии ключа, управляемого клиентом. При использовании портала для включения шифрования необходимо вручную обновить версию ключа.
...
1. Выберите **создать** , чтобы создать экземпляр реестра.
