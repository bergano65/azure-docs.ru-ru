...
Для использования шагов Azure CLI в этой статье требуется версия Azure CLI 2.2.0 или позже. Если вам нужно установить или обновить, [см.](/cli/azure/install-azure-cli)
...
Для шагов по созданию [Quickstart: Set and retrieve a secret from Azure Key Vault using the Azure portal](../key-vault/quick-create-portal.md)хранилища ключей см.
...
* Узнайте больше о политиках доступа и о том, как [обеспечить доступ к хранилищу ключей.](../key-vault/key-vault-secure-your-key-vault.md)
