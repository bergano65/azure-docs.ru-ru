...
Для доступа к хранилищу ключей, настроенному с помощью брандмауэра Key Vault, реестр должен обходить брандмауэр. Настройте хранилище ключей, чтобы разрешить доступ любыми [доверенными службами](../key-vault/general/overview-vnet-service-endpoints.md#trusted-services). Реестр контейнеров Azure — это одна из доверенных служб.
