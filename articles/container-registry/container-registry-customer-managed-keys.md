...
Если эта проблема возникает при назначении пользователем удостоверения, сначала необходимо переназначить удостоверение с помощью идентификатора GUID, отображаемого в сообщении об ошибке. Например:
