...
* [`build`](container-registry-tasks-reference-yaml.md#build). Создайте один или несколько образов контейнеров, используя `docker build` привычный синтаксис, последовательно или параллельно.
...
См. [примеры задач][task-examples] для выполнения многошаговой задачи YAML файлов и файлы dockerfile в нескольких сценариях.
...
* [Примеры задач][task-examples] . `task.yaml` файлы примеров для нескольких сценариев, простые и сложные.
