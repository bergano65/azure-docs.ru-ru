...
Например, можно запустить многошаговую задачу, позволяющую автоматически выполнять следующие действия:
...
Предлагаем вам оставить отзывы о функции многошаговых задач службы "Задачи ACR", пока она находится в предварительной версии. Доступны несколько механизмов обратной связи:

* [Проблемы](https://aka.ms/acr/issues). Просматривайте имеющиеся ошибки и проблемы, а также уведомляйте о новых.
* [UserVoice](https://aka.ms/acr/uservoice). Голосуйте за имеющиеся запросы функций или оставляйте новые запросы.
* [Обсуждение](https://aka.ms/acr/feedback). Принимайте участие в обсуждении Реестра контейнеров Azure в сообществе Stack Overflow.
