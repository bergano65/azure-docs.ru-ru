...
* [`build`](container-registry-tasks-reference-yaml.md#build): Создайте один или несколько образов контейнеров с помощью `docker build` привычного синтаксиса в ряде или параллельно.
