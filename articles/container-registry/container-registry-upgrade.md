...
После миграции учетная запись хранения в подписке, с помощью которой было выполнено первоначальное резервное копирование реестра уровня "Классический", не будет применяться для записи контроля доступа. После проверки успешности миграции рассмотрите возможность удаления учетной записи хранения, чтобы свести затраты к минимуму.
