---
title: Руководство. Развертывание приложения из геореплицированного реестра Docker в Azure
...
Реестр контейнеров Azure предоставляет поддержку для развертывания контейнерных приложений напрямую в [веб-приложения для контейнеров](../app-service/containers/index.yml). В рамках этого руководства с помощью портала Azure развертывается образ контейнера, созданного в предыдущих руководствах, в два плана веб-приложений, расположенных в разных регионах.
