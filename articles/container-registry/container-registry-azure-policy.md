...
1. Используйте фильтры для ограничения состояния соответствия или для поиска политик ![на соответствие политике на портале](./media/container-registry-azure-policy/azure-policy-compliance.png).
