...
| Value | Описание |
|---|---|
| ИМЯ | Имя, назначаемое веб-перехватчику. Он может содержать только буквы и цифры и должно быть 5 до 50 символов. |
...
| Статус | Состояние веб-перехватчика после его создания. По умолчанию он включен. |
| Область | Область действия веб-перехватчика. Если не указан, это все события в реестре. Его можно указать определенный репозиторий или тег, используя формат «репозиторий: тег» или «репозиторий: *» для всех тегов в репозитории. |
...
## <a name="test-webhook"></a>Проверить веб-перехватчик
