...
| Роль или разрешение       | [Доступ к Resource Manager](#access-resource-manage)| [Создание и удаление реестра](#create/delete-registry) | [Отправка образа](#push-image) | [Получение образа](#pull-image) | [Изменение политик](#change-polices) |   [Подписывание образов](#sign-images)  |
| ---------| --------- | --------- | --------- | --------- | --------- | --------- |
| Владелец. | X | X | X | X | X |  |  
| участник; | X | X | X | X | X |  |  
| читатель. | X |  |  | X |  |  | 
