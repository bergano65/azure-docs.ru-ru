...
* Вы пытаетесь интегрировать центр безопасности Azure с реестром, в котором есть частная конечная точка или конечная точка службы. [решение](#configure-image-scanning-solution)
...
Чтобы получить доступ к реестру, защищенному брандмауэром клиента или прокси-сервером, настройте правила брандмауэра для доступа к конечным точкам и ОСТАВШИМся данным реестра. Если [выделенные конечные точки данных](container-registry-firewall-access-rules.md#enable-dedicated-data-endpoints) включены, необходимы правила для доступа:
...
### <a name="configure-image-scanning-solution"></a>Настройка решения для сканирования изображений

Если в реестре настроена частная конечная точка или конечная точка службы, сейчас вы не сможете интегрироваться с центром безопасности Azure для сканирования изображений. При необходимости настройте другие решения для сканирования изображений, доступные в Azure Marketplace, в том числе:

* [Голубая облачная платформа безопасности](https://azuremarketplace.microsoft.com/marketplace/apps/aqua-security.aqua-security)
* [Twistlock Enterprise Edition](https://azuremarketplace.microsoft.com/marketplace/apps/twistlock.twistlock)

Связанные ссылки

* [Сканирование образа реестра контейнеров Azure по центру безопасности](../security-center/azure-container-registry-integration.md)
