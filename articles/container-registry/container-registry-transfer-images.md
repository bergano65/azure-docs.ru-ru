...
|artifacts | Массив исходных артефактов для перемещения в виде тегов или дайджестов манифеста<br/>Пример: `[samples/hello-world:v1", "samples/nginx:v1" , "myrepository@sha256:0a2e01852872..."]` |
