...
В выходных данных команды запишите идентификатор ресурса ( `id` ) конвейера. Это значение можно сохранить в переменной среды для последующего использования, выполнив команду [AZ Deployment Group][az-deployment-group-show]. Например:
...
Если вы планируете выполнить импорт вручную, запишите идентификатор ресурса ( `id` ) конвейера. Это значение можно сохранить в переменной среды для последующего использования, выполнив команду [AZ Deployment Group][az-deployment-group-show]. Например:
