...
В следующей таблице приведены примеры поддерживаемых контекстных расположений для задач контроля доступа.
...
| Главная ветвь GitHub | Файлы в основной ветви (или другой по умолчанию) в общедоступном или частном репозитории GitHub.  | `https://github.com/gituser/myapp-repo.git` |
...
| Артефакт в реестре контейнеров | [OCI файлы артефактов](container-registry-oci-artifacts.md) в репозитории реестра контейнеров. | `oci://myregistry.azurecr.io/myartifact:mytag` |
