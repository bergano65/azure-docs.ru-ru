---
title: Краткое руководство. Сборка и запуск образа контейнера в Реестре контейнеров Azure
...
В этом кратком руководстве показано, как с помощью команд Задач Реестра контейнеров Azure можно быстро создавать, отправлять и запускать образ контейнера Docker в Azure, а также продемонстрирована выгрузка "внутреннего цикла" разработки в облако. [Задачи Реестра контейнеров][container-registry-tasks-overview] — это набор функций в Реестре контейнеров Azure, которые призваны помогать управлять образами контейнеров и изменять их в течение всего жизненного цикла контейнеров. 
