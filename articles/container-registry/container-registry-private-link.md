...
Ограничьте доступ к реестру, назначив частные IP-адреса виртуальной сети конечным точкам реестра и используя [частную связь Azure](../private-link/private-link-overview.md). Сетевой трафик между клиентами в виртуальной сети и частными конечными точками реестра проходит по виртуальной сети и частной связи в магистральной сети Майкрософт, что устраняет уязвимость в общедоступном Интернете. Частная ссылка также позволяет включить доступ к частному реестру из локальной среды через частный пиринг [Azure ExpressRoute](../expressroute/expressroute-introduction.MD) или [VPN-шлюз](../vpn-gateway/vpn-gateway-about-vpngateways.md).
...
* В настоящее время для реестра может быть настроено не более 10 частных конечных точек.
