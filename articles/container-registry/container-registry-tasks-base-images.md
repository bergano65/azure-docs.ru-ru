...
Если базовый образ, указанный в инструкции `FROM`, находится в одном из этих расположений, задача записи контроля доступа добавляет обработчик, чтобы гарантировать, что образ будет перестроен во время обновления базы.
