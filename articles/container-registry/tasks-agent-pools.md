...
| Direction | Протокол | Источник         | Исходный порт | Назначение          | Порт приемника | Используется    |
|-----------|----------|----------------|-------------|----------------------|-----------|---------|
| Исходящие  | TCP      | Виртуальная сеть | Любой         | AzureKeyVault        | 443       | Значение по умолчанию |
| Исходящие  | TCP      | Виртуальная сеть | Любой         | Хранилище              | 443       | Значение по умолчанию |
| Исходящие  | TCP      | Виртуальная сеть | Любой         | концентратор событий.             | 443       | Значение по умолчанию |
| Исходящие  | TCP      | Виртуальная сеть | Любой         | AzureActiveDirectory | 443       | Значение по умолчанию |
| Исходящие  | TCP      | Виртуальная сеть | Любой         | AzureMonitor         | 443       | Значение по умолчанию |
