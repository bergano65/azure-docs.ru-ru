...
|   [субъекта-службы AD](#service-principal)                 | `docker login`<br/><br/>`az acr login` в Azure CLI<br/><br/> Параметры входа в реестр в API или Инструментарий<br/><br/>      секретный запрос на вытягивание Kubernetes                                       | Автоматическая отправка из конвейера CI/CD<br/><br/> Автоматическое извлечение в Azure или внешние службы  | Да                              | Срок действия пароля SP по умолчанию — 1 год       |                                                           
