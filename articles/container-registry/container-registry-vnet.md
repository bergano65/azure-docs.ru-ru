...
1. Выберите **Добавить существующую виртуальную сеть**и выберите виртуальную сеть и подсеть, настроенные с помощью конечной точки службы. Нажмите **Добавить**.
1. Щелкните **Сохранить**.
