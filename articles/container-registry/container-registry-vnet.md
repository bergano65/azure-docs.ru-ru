...
* Для выполнения [задач контроля](container-registry-tasks-overview.md) доступа в реестре контейнеров, доступ к которому в виртуальной сети требуется [выделенный пул агентов](container-registry-tasks-agent-pools.md).
...
1. Чтобы запретить доступ по умолчанию, выберите Разрешить доступ из **выбранных сетей**. 
...
* [Конечные точки служб](https://docs.microsoft.com/azure/virtual-network/virtual-network-service-endpoints-overview)
