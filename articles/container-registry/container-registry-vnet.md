...
Для каждого правила, настроенного, запустите [удалить запись контроля доступа Azure network-rule] [ az-acr-network-rule-remove] команду, чтобы удалить его. Например: 
...
Если вы создали все группы ресурсов Azure в тот же ресурс и они больше не нужны, при необходимости можно удалить ресурсы с помощью одной [удаление группы az](/cli/azure/group#az_group_delete) команды:
