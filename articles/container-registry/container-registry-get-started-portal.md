...
Перед отправкой и извлечением образов контейнеров необходимо войти в экземпляр ACR. Откройте командную оболочку в операционной системе и используйте команду [az acr login][az-acr-login] в Azure CLI. (Укажите только имя контейнера. Не включайте "azurecr.io")
