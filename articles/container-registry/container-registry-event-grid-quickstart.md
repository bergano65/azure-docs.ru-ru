---
title: Быстрый запуск - Отправить события в сетку событий
...
---
# <a name="quickstart-send-events-from-private-container-registry-to-event-grid"></a>Быстрый запуск: Отправить события из реестра частных контейнеров в Event Grid
