...
* **Конечная точка хранилища (Data)** . разрешает доступ ко всем учетным записям хранилища BLOB-объектов Azure с помощью подстановочного знака`*.blob.core.windows.net`
