...
ACR supports Docker Registry HTTP API V2. The APIs can be accessed at `https://<your registry login server>/v2/`. Пример: `https://mycontainerregistry.azurecr.io/v2/`
