...
Да. Ниже приведен [шаблон](https://github.com/Azure/azure-cli/blob/master/src/command_modules/azure-cli-acr/azure/cli/command_modules/acr/template.json) , который можно использовать для создания реестра.
