...
В настоящее время команда `acr purge` распространяется в общедоступном образе контейнера (`mcr.microsoft.com/acr/acr-cli:0.2`), созданном на основе исходного кода в репозитории [acr-cli](https://github.com/Azure/acr-cli) на GitHub.
