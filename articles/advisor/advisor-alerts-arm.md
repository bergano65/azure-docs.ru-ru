...
description: Узнайте, как в Помощнике по Azure настроить оповещение для новых рекомендаций с помощью шаблона Azure Resource Manager (шаблона ARM).
ms.topic: quickstart
