...
[Временный диск ОС](https://docs.microsoft.com/azure/virtual-machines/windows/ephemeral-os-disks) позволяет выполнять следующие задачи: 
