...
3. Группа действий. можно либо выбрать существующую группу действий, либо создать новую. Дополнительные сведения о группах действий см. в статье [Создание групп действий и управление ими](https://docs.microsoft.com/azure/azure-monitor/platform/action-groups).
...
* **Шаг 5.** В разделе **Группа действий** выберите **группу действий** для дайджеста. Дополнительные сведения см. в статье [Создание групп действий и управление ими](https://docs.microsoft.com/azure/azure-monitor/platform/action-groups) .
