...
В любой из схем можно задать события рекомендации помощника, выполнив **eventSource** Поиск eventSource `Recommendation` , **operationName** а operationName `Microsoft.Advisor/recommendations/available/action`—.
