...
Если вы хотите интенсивнее определять виртуальные машины с низким уровнем использования, то можете настроить правило среднего показателя использования ЦП для каждой подписки.  Правило использования ЦП может быть присвоено 5%, 10%, 15% или 20%.
