...
Advisor отслеживает использование виртуальной машины в течение 7 дней, а затем определяет виртуальные машины с низким уровнем использования. Виртуальные машины считаются низкоиспользованными, если их использование процессора составляет 5% или меньше, а их использование сети составляет менее 2% или если текущая рабочая нагрузка может быть приспособлена меньшим виртуальным размером машины.

Если вы хотите интенсивнее определять виртуальные машины с низким уровнем использования, то можете настроить правило среднего показателя использования ЦП для каждой подписки.  Правило использования процессора может быть установлено на 5%, 10%, 15% или 20%.
