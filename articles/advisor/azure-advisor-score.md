...
Advisor применяет эту модель на уровне категории Advisor (безопасность использует модель с [безопасной оценками](../security-center/secure-score-security-controls.md#introduction-to-secure-score) ), предоставляя оценку Advisor для каждой категории, а затем в виде простого среднего вычисляется итоговая оценка помощника.
