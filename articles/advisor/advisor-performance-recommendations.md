...
В рекомендации по контексту могут быть предоставлены дополнительные эвристики. Дополнительные сведения о том, как эта рекомендация определяется, см. в статье [рекомендации по хранилищу данных SQL](../synapse-analytics/sql-data-warehouse/sql-data-warehouse-concept-recommendations.md#replicate-tables). 
