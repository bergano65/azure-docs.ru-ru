...
> [!NOTE]
> Поддержка классических оповещения в Azure Monitor будет прекращена в июне 2019 г. Рекомендуется обновить классические учетные записи хранения до ARM для сохранения функциональности оповещений на новой платформе. Дополнительные сведения см. в сообщении об обновлении [Прекращение поддержки классических оповещений в Azure Monitor в июне 2019 г.](https://azure.microsoft.com/updates/classic-alerting-monitoring-retirement/)
