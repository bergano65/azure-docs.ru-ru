...
Управление данными, такими как база данных Azure S'L или службы хранения azure, такие как служба таблицы, которая предоставляет услуги по хранению больших объемов неструктурированных данных и служба Blob, предоставляющая услуги по хранению больших объемов неструктурированного текста или двоичные данные, такие как видео, аудио и изображения.
...
* Azure Service Bus предоставляет возможность безопасного обмена сообщениями и передачи данных для распределенных и гибридных приложений, например связи между размещенными в Azure приложениями и локальными приложениями и службами без необходимости в использовании комплексных инфраструктур брандмауэра и безопасности. Использование Service Bus Relay для ресурсов приложений для доступа к услугам, которые подвергаются в качестве конечных точек, может принадлежать арендатору (например, размещенным за пределами системы, например, на местах), или они могут быть услугами, предоставляемыми специально для арендатора (потому что конфиденциальные данные, относяеся для конкретных арендаторов, перемещаются по ним).
