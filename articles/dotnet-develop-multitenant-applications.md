...
Дополнительные сведения о дополнительных аспектах разработки приложения для нескольких клиентов см. в статье [Размещение приложения с несколькими клиентами в Azure][Hosting a Multi-Tenant Application on Azure]. Сведения о распространенных шаблонах архитектуры данных для мультитенантных приложений базы данных SaaS см. в статье [Шаблоны разработки для мультитенантных приложений SaaS с использованием Базы данных Azure SQL](sql-database/sql-database-design-patterns-multi-tenancy-saas-applications.md). 
...
Управление данными, например база данных SQL Azure или службы хранилища Azure, например служба таблиц, которая предоставляет службы для хранения больших объемов неструктурированных данных и службы BLOB-объектов, которая предоставляет службы для хранения больших объемов неструктурированного текста или двоичные данные, такие как видео, аудио и изображения.
