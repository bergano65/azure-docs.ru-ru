...
ms.locfileid: "76722737"
---
# <a name="recover-a-deleted-dashboard-in-the-azure-portal"></a>Восстановление удаленной панели мониторинга в портал Azure

При удалении _опубликованной_ панели мониторинга в портал Azure можно восстановить эту панель мониторинга в течение 90 дней после удаления. Если панель мониторинга не опубликована, ее нельзя восстановить, и ее необходимо перестроить. Дополнительные сведения о публикации панели мониторинга см. в статье [Публикация панели мониторинга](azure-portal-dashboard-share-access.md#publish-dashboard). Чтобы восстановить опубликованную панель мониторинга, выполните следующие действия.
