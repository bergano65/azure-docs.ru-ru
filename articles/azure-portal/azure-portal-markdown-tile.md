...
3. Измените поля **Заголовок**, **Подзаголовок** и **Содержимое**, чтобы настроить плитку. В приведенном здесь примере плитка с поддержкой Мarkdown была отредактирована так, чтобы отображать пользовательские сведения о службе технической поддержки.
