---
title: Управление параметрами и настройками портал Azure | Документация Майкрософт
...
![Снимок экрана, показывающий параметры портал Azure с выделенными темами](./media/set-preferences/menu-mode.png)
