...
* [Подписка по умолчанию](#choose-your-default-subscription)
...
1. Выберите значок фильтра каталогов и подписок в верхней области навигации.
...
### <a name="choose-a-theme"></a>Выбор темы
