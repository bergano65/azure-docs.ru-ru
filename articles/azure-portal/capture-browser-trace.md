...
1. Нажмите клавишу F12 ![или выберите снимок экрана "](media/capture-browser-trace/chromium-icon-settings.png) > параметры браузера **" значок** > "средства**разработчика**".
...
1. Нажмите клавишу F12 ![или выберите снимок экрана "](media/capture-browser-trace/edge-icon-settings.png) > параметры браузера **" значок** > "средства**разработчика**".
