...
Дополнительные сведения об этих двух моделях развертывания и преимуществах использования диспетчер ресурсов см. на странице [Диспетчер ресурсов и классическое развертывание](../../azure-resource-manager/management/deployment-models.md) .
