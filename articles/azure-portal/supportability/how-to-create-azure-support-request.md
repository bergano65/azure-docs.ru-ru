...
**Справку и поддержку** можно получить в портал Azure. Он доступен в глобальном заголовке или в меню ресурсов для службы. Прежде чем можно будет отправить запрос в службу поддержки, необходимо иметь соответствующие разрешения.
