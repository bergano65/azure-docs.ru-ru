...
Вариант | Модель службы | Типичный сценарий использования
-------|---------------|-----------------
...
`<anchorPeersList>` Разделенный пробелами список одноранговых узлов, которые должны быть установлены в качестве однорангового узла. Например:
