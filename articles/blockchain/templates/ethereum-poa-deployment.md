...
Дополнительные параметры | Расширенные параметры Ethereum | Включите параметр
...
Параметр | Описание: | Пример значения
----------|-------------|--------------
Наблюдение | Параметр для включения мониторинга | Включите параметр
...
1. Нажмите кнопку **Сохранить**. Для применения изменений может потребоваться несколько минут.
