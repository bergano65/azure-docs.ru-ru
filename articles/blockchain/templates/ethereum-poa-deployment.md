...
Местоположение|Регион Azure для группы ресурсов.||Н/Д
...
Дополнительные параметры|Расширенные параметры Ethereum|"Включить" или "Отключить"|Отключение
...
Transaction Permission Contract (Контракт разрешения транзакций) ("Расширенные параметры" = "Включить")|Байт-код контракта разрешения транзакций. Ограничение развертывания и выполнения интеллектуального контракта до списка разрешенных учетных записей Ethereum.|Contract bytecode (Байт-код контракта)|Н/Д
...
[!INCLUDE [azure-monitor-log-analytics-rebrand](../../../includes/azure-monitor-log-analytics-rebrand.md)]
  ...
  Имя параметра|Описание|Допустимые значения|Значения по умолчанию
  ---|---|---|---
Отслеживание|Параметр включения мониторинга|"Включить" или "Отключить"|Включить
Подключение к существующим журналам Azure Monitor|Создание нового экземпляра журнала Azure Monitor или присоединение к существующему экземпляру|"Создать" или Join existing (Присоединить имеющийся)|Создать
Расположение монитора (подключение к существующим журналам Azure Monitor = создание нового)|Регион, в котором будет развернут новый экземпляр журналов Azure Monitor|Все регионы журналов Azure Monitor|Н/Д
...
Повторите эти шаги для каждого региона в развернутой сети. Когда конечные точки будут \"включены в состояние Enabled\" , они будут автоматически загружаться и распределяться по регионам по имени DNS диспетчера трафика. Теперь вы можете использовать это DNS-имя и параметр \[CONSORTIUM\_DATA\_URL\] на других шагах документации.
