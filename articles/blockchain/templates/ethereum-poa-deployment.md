...
Виртуальная машина и уровень хранилища повлияет на производительность сети.  Мы рекомендуем следующие номера SKU в зависимости от требуемой эффективности затрат:
  ...
  Номер SKU виртуальной машины|Уровень хранилища|Цена|Пропускная способность|Latency
  ---|---|---|---|---
...
Ограничение газа блока ("Расширенные параметры" = "Включить")|Исходный предел газа блока сети.|Любое числовое|5 000 000
...
Подключаться к существующим журналам Azure Monitor|Создать новый экземпляр журналы Azure Monitor или присоединиться к существующему экземпляру|"Создать" или Join existing (Присоединить имеющийся)|Создание
