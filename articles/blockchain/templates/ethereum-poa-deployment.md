...
Отслеживать расположение (подключение к существующим журналам Azure Monitor — создайте новый)|Регион, где новый монитор Azure регистрирует экземпляр будет развертываться.|Все Azure Monitor регистрирует регионов|Нет данных
Идентификатор рабочей области существующая log analytics (подключение к существующим журналам Azure Monitor = присоединиться к существующей)|Идентификатор рабочей области из существующей Azure Monitor регистрирует экземпляр||Нет данных
