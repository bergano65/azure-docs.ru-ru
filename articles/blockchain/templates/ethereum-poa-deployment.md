...
Расположение | Регион, в котором развернут новый экземпляр | East US
...
Вы можете удаленно подключаться к виртуальным машинам для проверяющих узлов через SSH с указанными именем администратора и паролем или ключом SSH. Команда SSH для доступа к первому узлу проверяющего элемента управления указана в выходных данных развертывания шаблона. Например.
