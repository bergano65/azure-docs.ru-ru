...
Тип проверки подлинности | Метод аутентификации на виртуальной машине. | Пароль
...
Параметр | Описание | Пример значения
----------|-------------|--------------
Наблюдение | Параметр для включения мониторинга | Включить
...
1. Выберите правило **allow-SSH** .
    ...
    ![Снимок экрана отображает окно обзора, выбранное SSH-Allow.](./media/ethereum-poa-deployment/ssh-allow.png)
