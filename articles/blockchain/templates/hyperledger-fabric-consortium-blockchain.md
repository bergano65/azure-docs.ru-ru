...
> [!IMPORTANT]
> [Структура "Главная книга" в](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/microsoft-azure-blockchain.azure-blockchain-hyperledger-fabric) шаблоне Azure будет нерекомендуемой. Вместо этого используйте [структуру Kubernetes в службе Azure](hyperledger-fabric-consortium-azure-kubernetes-service.md) .  
...
| Имя параметра | Description | Допустимые значения |
|---|---|---|
...
**Настройка организации** |Вы можете указать имя организации и сертификат или использовать значения по умолчанию.|По умолчанию <br/> Расширенная |
