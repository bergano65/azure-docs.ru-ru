...
Убедитесь, что вы установили последнюю [Azure CLI](/cli/azure/install-azure-cli) и выполнили вход в учетную запись Azure в с помощью `az login` .
