---
title: Используйте разъем блокчейна Ethereum с приложениями Azure Logic - Azure Blockchain Service
...
Заполните дополнительное обязательное условие [Квикстарт: Используйте visual Studio Code для подключения к сети консорциума Azure Blockchain Service.](connect-vscode.md) В этом кратком руководстве описывается, как установить [Пакет средств разработки Блокчейна Azure для Ethereum](https://marketplace.visualstudio.com/items?itemName=AzBlockchain.azure-blockchain) и настроить среду разработки блокчейна.
...
* Триггеры, когда событие происходит на блокчейне, [Используйте триггер события.](#use-the-event-trigger)
* Запросы или развертывание смарт-контракта, [Используйте действия](#use-actions).
...
1. Введите сведения о смарт-контракте, в котором вы будете проверять наличие событий.
    ...
    | **Название мероприятия** | Выберите событие смарт-контракта, которое вы будете проверять. Событие активирует приложение логики. |
...
1. В зависимости от выбранного действия укажите следующие сведения о функции смарт-контракта.
    ...
    | **Контрактный байтекод** | Скомпилированный байт-код смарт-контракта. См. сведения о [получении байт-кода контракта](#get-the-contract-bytecode). |
    | **Адрес смарт-контракта** | Адрес контракта — это адрес назначения смарт-контракта в блокчейне Ethereum. См. сведения о [получении адреса контракта](#get-the-contract-address). |
...
1. Создайте запрос HTTP POST с помощью cURL. Replace the placeholder text * \<HTTP POST URL\> * with the URL from the previous step.
...
1. Выберите**клавиши доступа**к **строкам** > подключения.
...
1. Выберите **Azure Blockchain: Извлечения частного ключа.**
...
1. Копируйте адрес **учетной записи Участника.**
