...
Служба "Блокчейн Azure" — это полностью управляемая финансовая служба, с помощью которой пользователи могут расширять сети блокчейна и использовать их в большом масштабе в Azure. Обеспечивая унифицированный контроль для управления как инфраструктурой, так и сетями блокчейна, служба "Блокчейн Azure" предоставляет:
