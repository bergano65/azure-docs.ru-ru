...
Даже самый маленький проект взаимодействует с как минимум двумя узлами блокчейн: Один на компьютере разработчика, а другой — сеть, в которой разработчик развертывает свое приложение. Например, основная общедоступная сеть Ethereum или служба Блокчейн Azure. Труффле предоставляет систему для управления артефактами компиляции и развертывания для каждой сети и делает это таким образом, что упрощает окончательное развертывание приложений. Дополнительные сведения см. в [кратком руководстве Используйте Труффле для подключения к сети](connect-truffle.md)службы блокчейн Azure.
...
Пошаговые инструкции см. в [руководстве Отправка транзакции с помощью службы](send-transaction.md) блокчейн Azure для примера закрытой транзакции.
...
* [Azure Блокчейн Service Explorer](https://web3labs.com/azure-offer) от Web3 Labs
...
[Краткое руководство Подключение к сети службы Блокчейн Azure с помощью Труффле](connect-truffle.md)
