...
Пошаговые инструкции см. в [руководстве Отправьте транзакцию с помощью службы Azure Блокчейн @ no__t-0 в качестве примера закрытой транзакции.
...
[Краткое руководство Использование Труффле для подключения к сети службы Блокчейн Azure @ no__t-0
