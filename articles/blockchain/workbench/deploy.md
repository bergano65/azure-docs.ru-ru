...
1. Затем обновите раздел **appRoles** манифеста. Замените `"appRoles": []` на предоставленный JSON. Обязательно замените значение поля **Идентификатор** значением, созданным GUID. 
...
1. В области навигации слева выберите службу **Azure Active Directory**. Выберите **Регистрация приложений**.
