...
6. Выполните основные настройки.
    ...
    | Местоположение | Укажите регион, в котором необходимо развернуть платформу. |
...
2. Для последующего использования во время развертывания на панели **Свойства** скопируйте и сохраните следующие значения.
    ...
    |------------------|-------------------|
    | ИД приложения | Установка Azure Active Directory > идентификатор приложения |
...
![Имя домена](media/deploy/domain-name.png)
