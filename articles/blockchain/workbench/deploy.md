...
1. Существует два ресурса с типом **Служба приложений**. Выберите ресурс типа **служба приложений** *без* суффикса "-API".
...
1. Скопируйте и сохраните значение **идентификатора приложения** для последующего использования во время развертывания.
    ...
    |------------------|-------------------|
    | Идентификатор приложения (клиент) | Установка Azure Active Directory > идентификатор приложения |
