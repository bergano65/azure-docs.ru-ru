...
1. Выберите **блокчейн**  >  **Azure блокчейн Workbench (Предварительная версия)**.
    ...
    | Регион развертывания | Укажите место для развертывания ресурсов Blockchain Workbench. Для обеспечения лучшей доступности это значение должно соответствовать параметру расположение **региона** . Во время предварительной версии доступны не все регионы. Компоненты могут быть недоступны в некоторых регионах. Диспетчер данных блокчейна Azure доступен в таких регионах Azure: восточная часть США и Западная Европа.|
