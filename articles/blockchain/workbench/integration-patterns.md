---
title: Шаблоны интеграции смарт-контрактов - Azure Blockchain Workbench
description: Обзор шаблонов интеграции смарт-контрактов в Azure Blockchain Workbench Preview.
ms.date: 11/20/2019
ms.topic: conceptual
...
Например, если температура в грузовике, доставляющего грузы медицинского назначения, поднялась до 43 градусов, это может повлиять на сохранность медпрепаратов и создать общественную угрозу, если этот факт не будет вовремя обнаружен и эти медикаменты не будут изъяты из цепочки поставок. Если водитель ускорил свой автомобиль до 100 миль в час, полученная информация датчика может спровоцировать отмену страховки их страховым поставщиком. Если речь идет о прокатном автомобиле, данные GPS покажут, если водитель выезжал за пределы зоны, оговоренной в его соглашении о прокате, и ему придется заплатить штраф.
