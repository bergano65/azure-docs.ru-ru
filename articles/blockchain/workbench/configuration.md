...
| Поле | ОПИСАНИЕ | Обязательно для заполнения | Максимальная длина |
|-------|-------------|:--------:|-----------:|
...
| Поле | ОПИСАНИЕ | Обязательно для заполнения |
|-------|-------------|:--------:|
| Параметры | Коллекция [идентификаторов](#identifiers), необходимых для инициирования смарт-контракта. | Yes |
