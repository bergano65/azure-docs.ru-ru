...
description: Общие сведения о настройке приложения Azure Блокчейн Workbench Preview.
...
| Поле | Description | Обязательное значение |
|-------|-------------|:--------:|
...
| Поле | Description | Обязательное значение | Максимальная длина |
|-------|-------------|:--------:|-----------:|
| Название | Уникальное имя рабочего процесса. Для соответствующего смарт-контракта должно использоваться то же самое имя **Name**, что и для применимого класса контракта. | Да | 50 |
...
| Тип | Description |
|-------|-------------|
| адрес  | Тип адреса блокчейна, такой как *контракты* или *пользователи* |
...
| ssNoversion      | Целочисленный тип данных. |
...
| Поле | Description | Обязательное значение | Максимальная длина |
|-------|-------------|:--------:|-----------:|
| Название | Уникальное имя функции. Для соответствующего смарт-контракта должно использоваться то же самое имя **Name**, что и для применимой функции. | Да | 50 |
...
| Поле | Description | Обязательное значение | Максимальная длина |
|-------|-------------|:--------:|-----------:|
| Название | Уникальное имя состояния. Для соответствующего смарт-контракта должно использоваться то же самое имя **Name**, что и для применимого состояния. | Да | 50 |
...
| Поле | Description | Обязательное значение | Максимальная длина |
|-------|-------------|:--------:|-----------:|
| Название | Уникальное имя роли приложения. Для соответствующего смарт-контракта должно использоваться то же самое имя **Name**, что и для применимой роли. Имена базового типа зарезервированы. Роли приложения нельзя присвоить имя, которое уже используется для типа [Type](#type)| Да | 50 |
...
| Поле | Description | Обязательное значение | Максимальная длина |
|-------|-------------|:--------:|-----------:|
| Название | Уникальное имя свойства или параметра. Для соответствующего смарт-контракта должно использоваться то же самое имя **Name**, что и для применимого свойства или параметра. | Да | 50 |
