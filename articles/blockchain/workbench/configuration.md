---
title: Ссылка на метаданные конфигурации конфигурации Blockchain Workbench
description: Обзор метаданных конфигурации конфигурации приложений Azure Blockchain Workbench Preview.
ms.date: 12/09/2019
ms.topic: article
ms.reviewer: brendal
...
| массиве    | Одномерный массив типа integer, bool, money или time. Массивы могут быть статическими или динамическими. Используйте **ElementType**, чтобы указать тип данных элементов в массиве. Ознакомьтесь с [примером конфигурации](#example-configuration-of-type-array). |
...
| Поле | Описание | Обязательно | Максимальная длина |
|-------|-------------|:--------:|-----------:|
| name | Уникальное имя функции. Для соответствующего смарт-контракта должно использоваться то же самое имя **Name**, что и для применимой функции. | Да | 50 |
...
| Тип | [Тип данных](#type)свойств . | Да |
