...
| Поле | Описание | Обязательное значение | Максимальная длина |
|-------|-------------|:--------:|-----------:|
...
| Элемент Property | Коллекция [идентификаторов](#identifiers). Представляет данные, которые могут считываться вне сети или визуализируются в средстве пользователя. | Да | |
