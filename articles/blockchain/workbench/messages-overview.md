---
title: Использование сообщений для интеграции с Azure Блокчейн Workbench
description: Общие сведения об использовании сообщений для интеграции предварительной версии Azure Блокчейн Workbench с другими системами.
ms.date: 09/05/2019
ms.topic: article
ms.reviewer: brendal
...
1. Создайте **приложение-функция Azure** в портал Azure.
2. Создайте функцию.
...
| provisioningStatus | Определяет текущее состояние процесса подготовки для транзакции. Доступны следующие значения: </br>0 — действие транзакции было создано в базе данных с помощью API</br>1 — транзакция была отправлена распределенному реестру</br>2 — транзакция успешно зафиксирована в распределенном реестре;</br>3 или 4 — транзакцию не удалось зафиксировать в реестре;</br>5 — транзакция успешно зафиксирована в распределенном реестре. |
...
| Стиль | Стиль состояния (успех или сбой) |
