...
| Состояние                | Состояние запроса на создание пользователя.  При успешном выполнении значение будет **Success**. При сбое значение будет **Failure**.     |
...
| Состояние                   | Состояние запроса на создание контракта.  Возможные значения: **Submitted**, **Committed**, **Failure**.  |
| additionalInformation    | Предоставляемые дополнительные сведения на основе состояния                              |
...
| Состояние                | Состояние запроса на создание действия контракта. Возможные значения: **Submitted**, **Committed**, **Failure**.                         |
| additionalInformation | Предоставляемые дополнительные сведения на основе состояния |
...
| Название | Описание |
|------|-------------|
| блок | Содержит [информацию о блоке](#block-information) |
...
| to                 | Уникальный идентификатор в реестре для целевого объекта транзакции |
...
| расположение | URL-адрес, по которому расположен файл кода контракта |
...
| функц. | Коллекция [функций для рабочего процесса приложения](#workflow-function-information)|
| штаты | Коллекция [состояний для рабочего процесса приложения](#workflow-state-information) |
| свойства | [Сведения о свойствах рабочего процесса](#workflow-property-information) приложения |
