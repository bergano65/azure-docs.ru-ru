...
| Идентификатор пользователя                     | int           | Нет          | Идентификатор пользователя, связанного с ролью |
...
| Идентификатор пользователя                   | int           | Нет          | Идентификатор пользователя, связанного с подключением |
