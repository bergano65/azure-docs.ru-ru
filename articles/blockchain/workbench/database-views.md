...
| имя                             | введите          | Могут принимать значение Null | ОПИСАНИЕ                                                                                                                                                                                                                                                   |
|----------------------------------|---------------|-------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| ContractActionExecutedByUserExternalId   | nvarchar(255) | Yes         | Внешний идентификатор пользователя, который выполняет действия контракта. По умолчанию это идентификатор GUID, представляющий удостоверение в Azure Active Directory консорциума. |
...
| TransactionIsWorkbenchTransaction        | bit           | Yes         | Бит, определяющий, является ли транзакция транзакцией Azure Блокчейн Workbench |
...
| StateName                          | nvarchar(50)  | Yes         | Если это свойство содержит состояние контракта, это отображаемое имя состояния. Если оно не связанно с состояние, значение будет null. |
...
| StateValue                         | nvarchar(255) | Yes         | Если это свойство содержит состояние, то оно является значением состояния. Если оно не связанно с состояние, значение будет null. |
...
| StateName                          | nvarchar(50)  | Yes         | Если это свойство содержит состояние, то оно отображает отображаемое имя для состояния. Если оно не связанно с состояние, значение будет null. |
| StateDisplayName                   | nvarchar(255) | Нет          | Если это свойство содержит состояние, это отображаемое имя состояния. Если оно не связанно с состояние, значение будет null. |
| StateValue                         | nvarchar(255) | Yes         | Если это свойство содержит состояние, то оно является значением состояния. Если оно не связанно с состояние, значение будет null. |
