...
ms.locfileid: "87003327"
---
# <a name="azure-blockchain-workbench-database-views"></a>Представления базы данных Azure Блокчейн Workbench

Предварительная версия Azure Блокчейн Workbench предоставляет данные из распределенных книг в *автономную* базу данных SQL. Автономная база данных позволяет использовать SQL и существующие средства, например [SQL Server Management Studio](/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017), для взаимодействия с данными блокчейн.
