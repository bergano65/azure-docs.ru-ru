---
title: Представления базы данных Azure Блокчейн Workbench
description: Обзор доступных представлений базы данных SQL Azure Блокчейн Workbench Preview.
ms.date: 09/05/2019
ms.topic: article
...
---
# <a name="azure-blockchain-workbench-database-views"></a>Представления базы данных Azure Блокчейн Workbench
...
| UploadedByUserProvisioningStatus | int           | Нет          | Определяет текущее состояние процесса подготовки для пользователя. Доступны следующие значения: <br />0 — пользователь был создан API<br />1 — ключ был связан с пользователем в базе данных<br />2 — пользователь полностью подготовлен                         |
...
| UserProvisioningStatus     | int           | Нет          | Определяет текущее состояние процесса подготовки для пользователя. Доступны следующие значения: <br />0 — пользователь был создан API<br />1 — ключ был связан с пользователем в базе данных<br />2 — пользователь полностью подготовлен |
...
| ContractDeployedByUserProvisioningStatus | int            | Нет          | Определяет текущее состояние процесса подготовки для пользователя. Доступны следующие значения: <br />0 — пользователь был создан API<br />1 — ключ был связан с пользователем в базе данных <br />2 — пользователь полностью подготовлен                     |
...
| TransactionProvisioningStatus            | INT           | Да         | Определяет текущее состояние процесса подготовки для транзакции. Доступны следующие значения: <br />0 — действие транзакции было создано в базе данных с помощью API<br />1 — транзакция была отправлена распределенному реестру<br />2 — транзакция была успешно развернута в распределенном реестре                 |
...
| ProvisioningStatus | int           | Нет          |Определяет текущее состояние процесса подготовки для пользователя. Доступны следующие значения: <br />0 — пользователь был создан API<br />1 — ключ был связан с пользователем в базе данных<br />2 — пользователь полностью подготовлен |
