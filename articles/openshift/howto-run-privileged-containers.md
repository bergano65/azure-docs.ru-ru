...
Затем убедитесь, что `oc` двоичная версия имеет `3.11.154`значение.
```
oc version
oc v3.11.154
...
Во `oc create -f twistlock_console.yaml` время выполнения шага 2 вы получите сообщение об ошибке при создании пространства имен.
...
Во `oc create -f defender.yaml` время выполнения шага 2 вы получите сообщения об ошибках при создании роли кластера и привязки роли кластера.
