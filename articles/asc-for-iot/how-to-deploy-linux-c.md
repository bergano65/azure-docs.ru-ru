---
title: Руководство по установке и развертывании агента Linux C ASC для Интернета вещей агент предварительной версии | Документация Майкрософт
...
ms.locfileid: "58619855"
---
# <a name="deploy-asc-for-iot-c-based-security-agent-for-linux"></a>Развертывание ASC для безопасности на основе Интернета вещей C агента для Linux
...
В этом руководстве объясняется, как установить и развернуть ASC для агента безопасности на основе C Интернета вещей в Linux.
