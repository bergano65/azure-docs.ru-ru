...
description: В этом кратком руководстве приведены сведения о создании и назначении настраиваемых оповещений устройств в Центре безопасности Azure для Интернета вещей.
