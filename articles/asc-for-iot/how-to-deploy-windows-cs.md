---
title: Установка агента C's на устройстве Windows
...
1. Добавление запущенных разрешений в скрипт InstallSecurityAgent, запустив:
...
Пример помощи:```Get-Help .\InstallSecurityAgent.ps1```
...
1. Дополнительные сведения о сбое можно просмотреть в файле журнала. Файл журнала будет присутствовать в рабочем каталоге, где мы запускаем сценарий. 
