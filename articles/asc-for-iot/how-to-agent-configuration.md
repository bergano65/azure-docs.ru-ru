...
|Имя события| PropertyName | Default Value| События моментального снимка| Сведения о состоянии  |
|----------|------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|---------------|
...
|Удаленные события статистики |eventPriorityDroppedEventsStatistics |Низкий |True|Статистика событий с агентом. |
|Статистика сообщений|eventPriorityMessageStatistics |Низкий |True |Статистика сообщений с агентом. |
|Подключенных устройств|eventPriorityConnectedHardware |Низкий |True |Моментальных снимков оборудования, подключенных к устройству.|
|Ожидание передачи данных через порты|eventPriorityListeningPorts |Высокий |True |Моментальный снимок все открытые порты прослушивания на устройстве.|
...
|Настройка брандмауэра| eventPriorityFirewallConfiguration|Низкий|True|Снимок конфигурации устройства брандмауэра (правила брандмауэра). |
|Базовых показателей операционной системы| eventPriorityOSBaseline| Низкий|True|Проверьте моментальный снимок базовых показателей операционной системы устройства.|
