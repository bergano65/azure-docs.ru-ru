---
title: Понимание Центра безопасности Azure для агрегации событий IoT Документы Майкрософт
...
|:-----------|:---------------|
| агрегацияEnabledProcessСоздать | Да |
| агрегацияIntervalProcessСоздать | "PT1H"|
| агрегацияEnabledConnectionСоздать | Да |
| агрегатацияIntervalConnectionСоздать | "PT1H"|
| агрегацияEnabledProcessTerminate | Да |
