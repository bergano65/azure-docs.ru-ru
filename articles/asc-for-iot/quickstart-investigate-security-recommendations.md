...
description: Изучите рекомендации по безопасности с помощью службы безопасности Центра безопасности Azure для Интернета вещей.
...
Своевременный анализ и устранение рисков в соответствии с рекомендациями Центра безопасности Azure для Интернета вещей — это лучший способ повысить уровень безопасности и сократить направления атак для решения Интернета вещей.
