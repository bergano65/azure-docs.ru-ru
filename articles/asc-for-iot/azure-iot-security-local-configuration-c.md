...
| HostName | string | Имя узла центра Интернета вещей Azure. обычно <My-Hub>. azure-devices.net |
| deviceId | string | ИДЕНТИФИКАТОР устройства (зарегистрированный в центре Интернета вещей Azure) |
| DPS | JsonObject | Конфигурации, связанные с DP |
| IDScope | string | Область ИДЕНТИФИКАТОРов DPS |
| ИД регистрации | string  | ИДЕНТИФИКАТОР регистрации устройства DPS |
