---
title: Понимание Центра безопасности Azure для локальных конфигураций агентов для C Документы Майкрософт
...
| Проверка подлинности | JsonObject | Конфигурация аутентификации. Этот объект содержит всю информацию, необходимую для проверки подлинности против IoTHub |
| идентификации | "ДПС", "БезопасностьМодуль", "Устройство" | Идентификация подлинности - DPS, если аутентификация производится через DPS, SecurityModule, если аутентификация производится с помощью учетных данных модуля безопасности или устройства, если аутентификация сделана с учетными данными устройства |
...
| Ведение журнала | JsonObject | Конфигурации, связанные с регистратором агента |
