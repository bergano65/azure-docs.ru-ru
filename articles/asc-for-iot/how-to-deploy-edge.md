...
description: Дополнительные сведения о том, как развертывать центр безопасности Azure для Интернета вещей агент безопасности в IoT Edge.
services: ascforiot
...
Azure центр безопасности (ASC) для Интернета вещей **azureiotsecurity** модуль представляет собой решение полнофункциональных средств безопасности для устройства IoT Edge.
