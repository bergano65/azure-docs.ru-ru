...
Прием данных Log Analytics в Центре Интернета вещей отключен по умолчанию решением Центра безопасности Azure для Интернета вещей. Чтобы включить его для работы с модулем безопасности для ОСРВ Azure, выполните следующие действия: 
