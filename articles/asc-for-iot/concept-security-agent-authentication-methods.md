...
Когда [развертывание агента безопасности](select-deploy-agent.md), необходимо предоставить сведения о проверке подлинности в виде аргументов.
...
- [Развернуть агент безопасности](select-deploy-agent.md)
