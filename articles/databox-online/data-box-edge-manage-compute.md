...
- **Файл**: Эти триггеры в ответ на события файла, такие как создание файла, изменение файла.
- **Запланировано**: Эти триггеры в ответ на график, который можно определить с датой начала, время начала и интервал повторения.
...
- Узнайте, как [управлять вычислительной сетью Edge через портал Azure.](data-box-edge-extend-compute-access-modules.md)
