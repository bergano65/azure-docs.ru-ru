...
* Если используется средство проверки готовности Azure Stack, пароли для всех PFX-файлов сертификатов должны быть одинаковыми во время развертывания. Дополнительные сведения см. в статье [Создание сертификатов для Azure Stack ребра Pro с помощью средства проверки готовности центра Azure Stack](azure-stack-edge-j-series-create-certificates-tool.md).
...
[Создание сертификатов для Azure Stack ребра Pro с помощью средства проверки готовности центра Azure Stack](azure-stack-edge-j-series-create-certificates-tool.md)
