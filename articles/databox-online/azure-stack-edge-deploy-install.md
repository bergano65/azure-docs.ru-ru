---
title: Руководство по установке физического устройства Azure Stack Edge — распаковка, установка в стойку и подключение | Документация Майкрософт
description: Во втором руководстве по установке Azure Stack Edge описано, как распаковать, установить в стойку и подключить физическое устройство.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "82564992"
---
# <a name="tutorial-install-azure-stack-edge"></a>Руководство по установке Azure Stack Edge

Этот учебник содержит инструкции по установке Azure Stack Edge на физическое устройство. Процедура установки включает распаковку устройства, установку в стойку и подключение к нему кабелей. 
...
* Выполнены все инструкции из руководства по [подготовке к развертыванию Azure Stack Edge](azure-stack-edge-deploy-prep.md).
...
Если вы не получили все элементы из перечисленных в этом руководстве, обратитесь в службу технической поддержки Azure Stack Edge. Следующим шагом является установка устройства в стойку.
...
> [Подключение, настройка и активация Azure Stack Edge](./azure-stack-edge-deploy-connect-setup-activate.md)
