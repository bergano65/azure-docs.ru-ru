...
9. Вы снова увидите уведомление о доступных обновлениях. Это обновления Kubernetes. Выберите уведомление или щелкните **обновить устройство** на верхней панели команд.
    ...
    ![Версия программного обеспечения после обновления 15](./media/azure-stack-edge-gpu-install-update/portal-update-16.png)
...
10. Скачайте обновления Kubernetes. Можно увидеть, что размер пакета отличается по сравнению с предыдущим пакетом обновления.
    ...
    ![Версия программного обеспечения после обновления 16](./media/azure-stack-edge-gpu-install-update/portal-update-17.png)

    Процесс установки аналогичен процессу обновления устройства. Сначала загружаются обновления.

    ![Версия программного обеспечения после обновления 17](./media/azure-stack-edge-gpu-install-update/portal-update-18.png)    
    
11. После загрузки обновлений можно установить обновления. 

    ![Версия программного обеспечения после обновления 18](./media/azure-stack-edge-gpu-install-update/portal-update-19.png)
    ...
    ![Версия программного обеспечения после обновления 19](./media/azure-stack-edge-gpu-install-update/portal-update-20.png)
...
2. В поле поиска каталога Центр обновления Майкрософт введите номер исправления или условия для обновления, которое вы хотите скачать, в базе знаний Майкрософт (KB). Например, введите **Azure Stack ребра Pro**и нажмите кнопку **Поиск**.
    ...
    ![Каталог поиска 2](./media/azure-stack-edge-gpu-install-update/download-update-2b.png)
...
6. После перезапуска открывается страница **входа** . Чтобы убедиться, что программное обеспечение устройства Обновлено, в локальном веб-интерфейсе перейдите в раздел **обслуживание**  >  **Обновление программного обеспечения**. Отображаемая версия программного обеспечения в этом примере — **2.0.1257.1591**.
   ...
   ![Обновление устройства 6](./media/azure-stack-edge-gpu-install-update/local-ui-update-6.png) 
