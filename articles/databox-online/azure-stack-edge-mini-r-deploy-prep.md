...
Это руководство — первое в серии руководств по развертыванию, необходимых для полного развертывания устройства Azure Stack Edge Mini R. В этом учебнике содержатся сведения о подготовке портала Azure для развертывания ресурса Azure Stack Edge.
...
2. В области слева выберите **+ Создать ресурс**. Найдите и выберите **Azure Stack Edge или Шлюз Azure Data Box**. Нажмите кнопку **создания**. 
...
5. На вкладке **Основы** введите или выберите следующие **сведения о проекте**.
...
6. Введите или выберите следующие **сведения об экземпляре**.
...
8. По завершении выберите **Next: Теги**. При желании укажите здесь теги для распределения ресурсов по категориям и консолидированного выставления счетов. По завершении выберите **Next: Отзыв и создание**.

9. На вкладке **Просмотр и создание** просмотрите **сведения о ценах**, **условия использования** и подробные сведения о ресурсе. Установите флажок, чтобы подтвердить ознакомление с **условиями конфиденциальности**.

    ![Создание ресурса 7](media/azure-stack-edge-mini-r-deploy-prep/create-resource-7.png)

    Кроме того, вы получите уведомление о том, что во время создания ресурса включается Управляемое удостоверение службы (MSI), которое позволяет выполнять проверку подлинности в облачных службах. Это удостоверение существует, пока существует ресурс.
...
2. На плитке **Активация** введите имя хранилища Azure Key Vault или примите имя по умолчанию. Длина имени хранилища ключей должна составлять от 3 до 24 знаков. 

    Хранилище ключей создается для каждого ресурса Azure Stack Edge, который активируется на устройстве. В хранилище ключей можно хранить секреты и получать к ним доступ. Например, в хранилище ключей хранится ключ целостности канала (CIK) для службы.
