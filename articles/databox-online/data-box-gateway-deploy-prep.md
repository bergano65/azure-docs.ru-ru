...
ms.locfileid: "75438660"
---
# <a name="tutorial-prepare-to-deploy-azure-data-box-gateway"></a>Руководство. Подготовка Шлюза Azure Data Box к развертыванию
...
4. На вкладке **Основы** введите или выберите следующие **сведения о проекте**.
    ...
    |Параметр  |Значение  |
    |---------|---------|
    |Subscription    |Это поле заполняется автоматически на основе ранее выбранного значения. Подписка привязана к учетной записи выставления счетов. |
