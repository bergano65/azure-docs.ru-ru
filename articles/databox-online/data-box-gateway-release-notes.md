...
| **10.** |Общие папки |Обновление существующего контейнера с помощью страничных BLOB-объектов в общую папку блочных BLOB-объектов (или наоборот) приводит к сбоям отправки при изменении файла.  |Такая ситуация возникает, когда вы выполняете следующие действия: <li> создаете общую папку блочных BLOB-объектов на устройстве; </li><li> связываете общую папку с существующим контейнером облака, который имеет страничные BLOB-объекты;</li><li>обновляете эту общую папку; </li><li>изменяете некоторые обновленные файлы, которые уже хранятся в виде страничных BLOB-объектов в облаке.</li> Вы увидите сбои отправки. |
