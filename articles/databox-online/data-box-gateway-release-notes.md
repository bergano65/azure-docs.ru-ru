...
| **8.** |Справка в Интернете |Ссылки на справку на портале Azure не могут ссылаться на документацию.|Ссылки на справку будут работать в выпуске общедоступной версии. |
