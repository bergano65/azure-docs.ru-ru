...
3. Распакуйте коробку. После распаковки коробки, убедитесь, что у вас имеется:
    - одно устройство Data Box Edge в отдельном корпусе;
    - два кабеля питания;
...
Ниже описано, как подсоединить кабель питания и сетевой кабель к устройству Data Box Edge.

Перед подключением кабелей к устройству убедитесь, что у вас есть следующее:

- распакованное и установленное в стойку физическое устройство Data Box Edge;
- два кабеля питания;
...
> - Устройство Data Box Edge необходимо подключить к сети центра обработки данных таким образом, чтобы оно могло принимать данные с исходных серверов данных.

Устройство Data Box Edge оснащено следующим:
...
2. Изучите расположение отсеков для накопителей и кнопки питания на передней панели устройства.
    ...
    ![Передняя панель устройства](./media/data-box-edge-deploy-install/device-front-plane-labeled-1.png)
