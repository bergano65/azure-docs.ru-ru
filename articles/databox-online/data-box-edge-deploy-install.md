...
ms.locfileid: "76263954"
---
# <a name="tutorial-install-azure-data-box-edge"></a>Руководство. установке Azure Data Box Edge
...
Проложите кабели, а затем подключите устройство. Ниже описано, как подсоединить кабель питания и сетевой кабель к устройству Data Box Edge.
