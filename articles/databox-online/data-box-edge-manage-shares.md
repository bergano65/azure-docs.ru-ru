...
Для передачи данных в Azure необходимо создать общие папки в Azure Data Box Edge. Общие папки, добавляемые на устройство Data Box Edge, могут быть локальными или общими папками, которые отправляют данные в облако.
 ...
 - **Локальные акции**: Используйте эти акции, когда вы хотите, чтобы данные обрабатывались локально на устройстве.
 - **Акции:** Используйте эти акции, когда вы хотите, чтобы данные устройства автоматически перемещались на учетную запись хранилища в облаке. К этим общим папкам применяются все облачные функции, такие как **Обновление** и **Синхронизация ключей хранилища**.
