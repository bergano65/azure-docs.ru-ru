...
- После возврата устройства в корпорацию Майкрософт оно проходит физическую проверку в центре обработки данных Azure и Azure Stack вызовы командного отдела пограничных операций для подтверждения того, что устройство было возвращено.
