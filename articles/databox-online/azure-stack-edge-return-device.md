...
description: Узнайте, как очистить данные и вернуть устройство Azure Stack пограничной, а затем удалите ресурс, связанный с устройством.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
- Если устройство становится неизменным и имеет хорошую форму, счетчик выставления счетов для этого ресурса останавливается. Azure Stack пограничных операций свяжется с вами, чтобы убедиться, что устройство было возвращено. Затем можно удалить ресурс, связанный с устройством, на портале Azure.
...
- После возврата устройства в корпорацию Майкрософт оно проходит физическую проверку в центре обработки данных Azure, а Azure Stack пограничные вызовы команды для подтверждения того, что устройство было возвращено.
