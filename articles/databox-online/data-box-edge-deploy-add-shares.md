---
title: Руководство по передаче данных в общие папки с помощью Azure Data Box Edge | Документация Майкрософт
...
ms.locfileid: "64924616"
---
# <a name="tutorial-transfer-data-with-azure-data-box-edge"></a>Руководство по Передача данных с помощью Azure Data Box Edge
...
1. На [портале Azure](https://portal.azure.com/) выберите ресурс Data Box Edge и перейдите в раздел **Обзор**. Устройство должно быть подключено к сети.

   ![Устройство, подключенное к сети](./media/data-box-edge-deploy-add-shares/device-online-1.png)

2. На панели команд для устройства выберите **+ Добавление общего файлового ресурса**.

   ![Добавление общей папки](./media/data-box-edge-deploy-add-shares/select-add-share-1.png)
