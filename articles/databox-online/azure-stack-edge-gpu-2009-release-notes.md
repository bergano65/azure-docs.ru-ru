...
Эта статья относится к выпуску **Azure Stack ребра Pro 2009** , который соответствует номеру версии программного обеспечения **2.1.1358.2075**.
