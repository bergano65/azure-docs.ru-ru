...
ms.locfileid: "82569086"
---
# <a name="azure-stack-edge-system-requirements"></a>Azure Stack пограничных требований к системе
...
| Порт № | Входящий или исходящий | Область порта | Обязательный | Руководство |
|----------|-----------|------------|----------|----------|
...
- [Развертывание Azure Stack пограничных устройств](azure-stack-edge-deploy-prep.md)
