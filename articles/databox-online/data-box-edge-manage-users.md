...
Сначала разрешения пользователя определяются при его создании во время создания общей папки. Изменение разрешений на уровне акций в настоящее время не поддерживается.
