...
![Как работает модуль Azure IoT Edge на Azure Stack границе](./media/azure-stack-edge-j-series-create-iot-edge-module/how-module-works-1.png)
...
- Azure Stack пограничной устройства, на котором работает.
    ...
    Дополнительные сведения см. в подразделе [Настройка вычислений](azure-stack-edge-j-series-deploy-configure-compute.md#configure-compute) для Azure Stackной стороны.
...
Чтобы развернуть и запустить этот модуль на Azure Stack пограничных устройств, см. действия в разделе [Добавление модуля](azure-stack-edge-j-series-deploy-configure-compute.md#add-a-module).
