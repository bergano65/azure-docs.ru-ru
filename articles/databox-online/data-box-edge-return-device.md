...
Кроме того, подключитесь к интерфейсу PowerShell устройства и используйте командлет `Reset-HcsAppliance`, чтобы стереть данные с дисков данных. Дополнительные сведения см. в разделе [reseting a Device](data-box-edge-connect-powershell-interface.md#reset-your-device).
