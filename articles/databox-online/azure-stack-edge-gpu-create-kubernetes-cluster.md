---
title: Создание кластера Kubernetes и управление им на Azure Stack пограничном устройстве GPU | Документация Майкрософт
description: Описание создания кластера Kubernetes и управления им на Azure Stack пограничном устройстве GPU с помощью интерфейса Windows PowerShell.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "89267964"
---
# <a name="connect-to-and-manage-a-kubernetes-cluster-via-kubectl-on-your-azure-stack-edge-gpu-device"></a>Подключение к кластеру Kubernetes и управление им с помощью kubectl на устройстве с Azure Stack пограничном GPU
