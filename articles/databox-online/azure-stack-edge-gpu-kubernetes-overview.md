...
Кластер Kubernetes на устройстве Azure Stack ребра Pro позволяет управлять доступом на основе ролей (RBAC). Дополнительные сведения см. [в статье Управление доступом на основе ролей для кластера Kubernetes на устройстве с Azure Stack пограничном Pro](azure-stack-edge-gpu-kubernetes-rbac.md).
