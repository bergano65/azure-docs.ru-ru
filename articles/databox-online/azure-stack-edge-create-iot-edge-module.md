---
title: Модуль IoT Edge C# для Azure Stack ребра Pro | Документация Майкрософт
description: Узнайте, как разработать модуль IoT Edge C#, который может быть развернут на Azure Stack пограничных Pro.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
![Как работает модуль Azure IoT Edge на Azure Stack пограничных Pro](./media/azure-stack-edge-create-iot-edge-module/how-module-works-1.png)
...
- Устройство Azure Stack пограничной Pro, на котором работает.
    ...
    Дополнительные сведения см. в подразделе [Настройка вычислений](azure-stack-edge-deploy-configure-compute.md#configure-compute) для Azure Stack пограничных Pro.
