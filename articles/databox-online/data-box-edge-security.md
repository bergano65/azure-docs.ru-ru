...
ms.locfileid: "58119791"
---
# <a name="data-box-edge-security-and-data-protection-preview"></a>Данные пограничного поле безопасности и защиты данных (Предварительная версия)
...
- Защищен на все время пароль администратора устройства.
...
- Удаленно подключаться к интерфейсе PowerShell устройства по протоколу HTTP. Удаленное управление включено по умолчанию. Затем можно предоставить пароль администратора устройства для входа в устройство. Дополнительные сведения см. в статье [удаленное подключение к устройству Edge поле данных](data-box-edge-connect-powershell-interface.md#connect-to-the-powershell-interface).
...
- Обеспечить надежность и хорошую защиту паролей администратора устройства. Выполните [рекомендации по паролям](https://docs.microsoft.com/azure/security/azure-security-identity-management-best-practices#enable-password-management).
