---
title: 'Случаи использования коробок данных Microsoft Azure (фото: 2: 200) Документы Майкрософт'
description: Описывает случаи использования для Azure Data Box Gateway, виртуального решения для хранения приборов, которое позволяет передавать данные в Azure
services: databox
author: alkohli
ms.service: databox
...
Перед началом работы убедитесь, что у вас есть работающее устройство "Шлюз Data Box". Выполните следующие шаги, описанные в [учебнике: Подготовьтесь к развертыванию Azure Data Box Gateway](data-box-gateway-deploy-prep.md) и продолжайте продвигаться к следующему учебнику, пока у вас не будет эксплуатационного устройства.
...
- После отправки данных переведите хранилище на архивный уровень. Вы можете установить уровень капли двумя способами: скриптом Azure PowerShell или политикой управления жизненным циклом хранения данных Azure.  
