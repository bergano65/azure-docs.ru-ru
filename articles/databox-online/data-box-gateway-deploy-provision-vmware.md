...
ms.locfileid: "55099164"
---
# <a name="tutorial-provision-azure-data-box-gateway-in-vmware-preview"></a>Руководство. Подготовка Шлюза Azure Data Box в VMware (предварительная версия)
...
2. Войдите на сервер ESXi, используя веб-клиент vSphere. Чтобы создать виртуальную машину, требуются права администратора.
