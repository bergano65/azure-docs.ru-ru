...
ms.locfileid: "89265700"
---
# <a name="use-the-azure-portal-to-manage-bandwidth-schedules-on-your-azure-stack-edge-gpu"></a>Использование портал Azure для управления расписаниями пропускной способности на Azure Stackном GPU 
