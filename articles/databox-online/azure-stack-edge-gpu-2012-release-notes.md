---
title: Заметки о выпуске Azure Stack ребра Pro 2012
description: Описание критических открытых проблем и способов их устранения для Azure Stack пограничной версии 2012.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "97364616"
---
# <a name="azure-stack-edge-2012-release-notes"></a>Заметки о выпуске Azure Stack пограничных 2012

В следующих заметках о выпуске указываются критические открытые проблемы и разрешенные проблемы для выпуска 2012 для устройств Azure Stack. Эти заметки о выпуске применимы для Azure Stack GPU Pro, Azure Stack пограничных Pro R и Azure Stack пограничных устройств R. Функции и проблемы, соответствующие определенной модели, называются там, где это применимо.
...
Эта статья относится к выпуску **Azure Stack пограничной 2012** , который соответствует номеру версии программного обеспечения **2.2.1438.2470**.

## <a name="whats-new"></a>Новое

В выпуске Azure Stack ребра 2012 доступны следующие новые функции. 
...
## <a name="known-issues-in-2012-release"></a>Известные проблемы в выпуске 2012

В следующей таблице приведены сводные сведения об известных проблемах в выпуске 2012.
