---
title: Контрольный список предварительного развертывания для развертывания Azure Stack пограничной Pro R Device | Документация Майкрософт
description: В этой статье описываются сведения, которые можно собрать перед развертыванием устройства R Azure Stack ребра.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
В этой статье описываются сведения, которые можно собрать перед фактическим развертыванием устройства R для Azure Stack пограничной Pro. 

Используйте следующий контрольный список, чтобы убедиться, что эти сведения имеются после того, как вы разместили заказ на устройство с Azure Stack ребра Pro R и до получения устройства. 
...
Подготовка к развертыванию [устройства Azure Stack пограничной Pro](azure-stack-edge-pro-r-deploy-prep.md).
