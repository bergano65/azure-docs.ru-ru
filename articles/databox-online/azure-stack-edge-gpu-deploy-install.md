---
title: Учебник по установке физического устройства GPU Azure Stack Edge — распаковка, установка в стойку и подключение | Документация Майкрософт
description: Во втором учебнике по установке GPU Azure Stack Edge описано, как распаковать, установить в стойку и подключить физическое устройство.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "89421379"
---
# <a name="tutorial-install-azure-stack-edge-with-gpu"></a>Руководство по установке Azure Stack Edge с GPU

Этот учебник содержит инструкции по установке Azure Stack Edge на физическое устройство с GPU. Процедура установки включает распаковку устройства, установку в стойку и подключение к нему кабелей. 
...
* Выполнены все инструкции из учебника по [подготовке к развертыванию Azure Stack Edge с GPU](azure-stack-edge-gpu-deploy-prep.md).
...
### <a name="for-the-azure-stack-edge-physical-device"></a>Для физического устройства Azure Stack Edge
...
- Изучите сетевые требования к развертыванию Azure Stack Edge и настройте сеть центра обработки данных в соответствии с требованиями. Дополнительные сведения см. в разделе [Требования к сети Azure Stack Edge](azure-stack-edge-system-requirements.md#networking-port-requirements).
...
3. Распакуйте коробку. После распаковки коробки, убедитесь, что у вас имеется:
    - одно устройство Azure Stack Edge в отдельном корпусе;
    - два кабеля питания;
...
> [!IMPORTANT]
> Для правильной работы устройства Azure Stack Edge должны быть установлены в стойку.
...
Проложите кабели, а затем подключите устройство. Ниже описано, как подсоединить кабель питания и сетевой кабель к устройству Azure Stack Edge.

Перед подключением кабелей к устройству убедитесь, что у вас есть следующее:

- распакованное и установленное в стойку физическое устройство Azure Stack Edge;
- два кабеля питания;
...
> - Устройство Azure Stack Edge необходимо подключить к сети центра обработки данных таким образом, чтобы оно могло принимать данные с исходных серверов данных.
...
> [Учебник. Подключение к Azure Stack Edge с GPU](./azure-stack-edge-gpu-deploy-connect.md)
