---
title: Устранение неполадок с сертификатами с помощью Azure Stack пограничных устройств | Документация Майкрософт
description: Описание устранения неполадок с сертификатами с Azure Stack пограничным устройством.
