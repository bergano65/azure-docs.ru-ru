...
[Политика Azure](../governance/policy/index.yml) может принудительно применять правила для ресурсов Azure, чтобы ваша инфраструктура соответствовала определенным бизнес-стандартам.
