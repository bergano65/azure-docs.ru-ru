...
| --- | --- | --- | --- |
| Администратор учетной записи | Один на учетную запись Azure | <ul><li>Управление выставлением счетов на [портале Azure](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade)</li><li>Управление всеми подписками в учетной записи</li><li>Создание новых подписок</li><li>Отмена подписок</li><li>Изменение тарифного плана для подписки</li><li>Изменение администратора служб</li></ul> | По существу, это владелец подписки, которому выставляются счета. |
