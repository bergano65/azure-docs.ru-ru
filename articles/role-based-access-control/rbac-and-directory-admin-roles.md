...
| --- | --- | --- | --- |
| Администратор учетной записи | Один на учетную запись Azure | <ul><li>Доступ к [центру управления учетной записью Azure](https://account.azure.com/Subscriptions)</li><li>Управление всеми подписками в учетной записи</li><li>Создание новых подписок</li><li>Отмена подписок</li><li>Изменение тарифного плана для подписки</li><li>Изменение администратора служб</li></ul> | По существу, это владелец подписки, которому выставляются счета.<br>Администратор учетной записи не имеет доступа к порталу Azure. |
