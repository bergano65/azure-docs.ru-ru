...
Чтобы наиболее эффективно использовать страницу управления доступом (IAM), можно ответить на следующие три вопроса при попытке назначения роли:
...
1. В раскрывающемся списке **Роли** выберите роль, например **Участник виртуальных машин**.
   ...
   ![Область "Добавить назначение ролей"](./media/role-assignments-portal/add-role-assignment-with-scope.png)
...
1. В меню слева щелкните **назначения ролей Azure**.
    ...
    ![Назначение ролей для управляемого удостоверения, назначенного системой](./media/shared/role-assignments-user-assigned.png)
