...
Если назначить роль участнику безопасности (пользователь, группа, субъект-служба или управляемое удостоверение), а затем удалить этот субъект безопасности без удаления назначения роли, то тип субъекта безопасности для назначения роли будет отображаться как **неизвестный**. На следующем снимке экрана показан пример в портал Azure. Имя субъекта безопасности указано в списке **удалено удостоверение** и **удостоверение больше не существует**. 
