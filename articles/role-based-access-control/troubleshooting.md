...
Не существует проблем с назначениями ролей, но их можно удалить с помощью действий, аналогичных другим назначениям ролей. Сведения об удалении назначений ролей см. в разделе [портал Azure](role-assignments-portal.md#remove-role-assignments), [Azure PowerShell](role-assignments-powershell.md#remove-access)или [Azure CLI](role-assignments-cli.md#remove-access)
