...
| Свойство | Описание |
| --- | --- |
| `Name` | Название отображения роли. |
...
| `AssignableScopes` | Массив строк, который определяет области, доступные для назначения. |
