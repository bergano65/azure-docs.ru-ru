...
1. Щелкните **Управление доступом (IAM)** .
    ...
    На следующем снимке экрана представлен пример колонки Управление доступом (IAM) для группы ресурсов. Если вы вносите здесь изменения в контроль доступа, они будут применены только к группе ресурсов.
