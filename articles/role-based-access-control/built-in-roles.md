...
> | **Web** |  |  |
> | [Читатель данных Azure Maps (предварительная версия)](#azure-maps-data-reader-preview) | Предоставляет доступ для чтения данных, связанных с картой, из учетной записи Azure Maps. | 423170ca-a8f6-4b0f-8487-9e4eb8f49bfa |
...
> | [Читатель безопасности](#security-reader) | Может просматривать рекомендации и оповещения, просматривать политики безопасности, просматривать состояния безопасности, но не может вносить изменения. | 39bc4728-0917-49c7-9d2c-d95423bc2eb4 |
> | **DevOps** |  |  |
