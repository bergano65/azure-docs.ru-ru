...
На этом шаге вы переносите подписку из исходного каталога в целевой каталог. Действия будут отличаться в зависимости от того, требуется ли передавать владение выставлением счетов.
...
1. Определите, нужно ли также передавать владение выставлением счетов.
