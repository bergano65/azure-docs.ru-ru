...
> | Действие | Microsoft. аадиам/metricDefinitions/Read | Чтение определений метрик на уровне клиента |
> | Действие | Microsoft. аадиам/метрики/чтение | Чтение метрик уровня клиента |
...
> | Действие | Microsoft.Advisor/recommendations/available/action | Новая рекомендация доступна в Microsoft Advisor |
...
> | Действие | Microsoft. ApiManagement/Service/Аусоризатионсерверс/Листсекретс/Action | Получает секреты для сервера авторизации. |
> | Действие | Microsoft.ApiManagement/service/authorizationServers/read | Содержит коллекцию серверов авторизации, определенных в экземпляре службы. или возвращает сведения о сервере авторизации без секретов. |
...
> | Действие | Microsoft. ApiManagement/служба/шлюзы/API/удаление | Удаляет указанный API из указанного шлюза. |
...
> | Действие | Microsoft. ApiManagement/служба/шлюзы/Хостнамеконфигуратионс/чтение | Перечисляет коллекцию конфигураций имен узлов для указанного шлюза. |
...
> | Действие | Microsoft. ApiManagement/Service/Идентитипровидерс/Листсекретс/Action | Возвращает секреты поставщика удостоверений. |
> | Действие | Microsoft.ApiManagement/service/identityProviders/read | Содержит коллекцию поставщиков удостоверений, настроенных в указанном экземпляре службы. или возвращает сведения о конфигурации поставщика удостоверений без секретов. |
...
> | Действие | Microsoft. ApiManagement/Service/Опенидконнектпровидерс/Листсекретс/Action | Получает конкретные секреты поставщика OpenID Connect Connect. |
> | Действие | Microsoft.ApiManagement/service/openidConnectProviders/read | Список всех поставщиков OpenID Connect Connect. или возвращает конкретного поставщика OpenID Connect Connect без секретов. |
...
> | Действие | Microsoft. ApiManagement/Service/порталсеттингс/Листсекретс/Action | Возвращает ключ проверки параметров делегирования портала. |
> | Действие | Microsoft.ApiManagement/service/portalsettings/read | Содержит коллекцию параметров портала. или получите параметры входа для портала или получите параметры регистрации для портала или получите параметры делегирования для портала. |
...
> | Действие | Microsoft. ApiManagement/Service/Properties/Листсекретс/действие | Возвращает секреты свойства, заданного его идентификатором. |
...
> | Действие | Microsoft. ApiManagement/Service/Subscriptions/Листсекретс/Action | Возвращает указанные ключи подписки. |
> | Действие | Microsoft.ApiManagement/service/subscriptions/read | Список всех подписок экземпляра службы управления API. или возвращает указанную сущность подписки (без ключей). |
...
> | Действие | Microsoft. ApiManagement/Service/клиент/Листсекретс/действие | Возвращает сведения о доступе клиента. |
...
> | Действие | Microsoft.ApiManagement/service/write | Создание или обновление экземпляра службы управления API |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft. Аппконфигуратион/Чеккнамеаваилабилити/Read | Проверьте, доступно ли имя ресурса для использования. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Delete | Удаляет хранилище конфигурации. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Евентгридфилтерс/Delete | Удаляет фильтр сетки событий хранилища конфигурации. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Евентгридфилтерс/Read | Возвращает свойства указанного фильтра сетки событий хранилища конфигураций или список всех фильтров сетки событий хранилища конфигурации в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Евентгридфилтерс/запись | Создание или обновление фильтра сетки событий хранилища конфигураций с указанными параметрами. |
> | DataAction | Microsoft. Аппконфигуратион/Конфигуратионсторес/Кэйвалуес/Delete | Удаляет существующее значение ключа из хранилища конфигураций. |
...
> | DataAction | Microsoft. Аппконфигуратион/Конфигуратионсторес/Кэйвалуес/запись | Создает или обновляет значение ключа в хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/ListKeys/Action | Выводит список ключей API для указанного хранилища конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Листкэйвалуе/Action | Перечисляет значение ключа для указанного хранилища конфигурации. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Приватиндпоинтконнектионпроксиес/Delete | Удаление прокси-сервера подключения частной конечной точки в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Приватиндпоинтконнектионпроксиес/Read | Получение прокси-сервера подключения к частной конечной точке в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверьте прокси-сервер подключения частной конечной точки в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Приватиндпоинтконнектионпроксиес/запись | Создание или обновление прокси-сервера подключения к частной конечной точке в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Приватиндпоинтконнектионс/Delete | Удаление подключения к частной конечной точке в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Приватиндпоинтконнектионс/Read | Получение подключения к частной конечной точке или вывод списка подключений к частным конечным точкам в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Приватиндпоинтконнектионс/запись | Утверждение или отклонение подключения к частной конечной точке в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Приватиндпоинтконнектионсаппровал/Action | Автоматическое утверждение подключения к частной конечной точке в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Привателинкресаурцес/Read | Список всех ресурсов закрытой ссылки в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/providers/Microsoft. Insights/diagnosticSettings/Read | Чтение всех значений параметров диагностики для хранилища конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/providers/Microsoft. Insights/diagnosticSettings/запись | Запись и перезапись параметров диагностики для конфигурации приложения Майкрософт. |
...
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Read | Возвращает свойства указанного хранилища конфигураций или список всех хранилищ конфигураций в указанной группе ресурсов или подписке. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Реженератекэй/Action | Повторное создание ключа API для указанного хранилища конфигурации. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Синктаскс/Delete | Удаляет задачу синхронизации хранилища конфигурации. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Синктаскс/Read | Возвращает свойства указанной задачи синхронизации хранилища конфигурации или список всех задач синхронизации хранилища конфигурации в указанном хранилище конфигураций. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/Синктаскс/запись | Создание или обновление задачи синхронизации хранилища конфигурации с указанными параметрами. |
> | Действие | Microsoft. Аппконфигуратион/Конфигуратионсторес/запись | Создание или обновление хранилища конфигурации с указанными параметрами. |
...
> | Действие | Microsoft.BingMaps/mapApis/Delete | Удаляет ресурс для Microsoft. BingMaps/Мапапис |
> | Действие | Microsoft.BingMaps/mapApis/listSecrets/action | Список секретов для Microsoft. BingMaps/Мапапис |
> | Действие | Microsoft. BingMaps/Мапапис/Листусажеметрикс/Action | Перечисление метрик для Microsoft. BingMaps/Мапапис |
> | Действие | Microsoft.BingMaps/mapApis/Read | Возвращает ресурс для Microsoft. BingMaps/Мапапис |
> | Действие | Microsoft.BingMaps/mapApis/regenerateKey/action | Повторно создать ключи для Microsoft. BingMaps/Мапапис |
> | Действие | Microsoft.BingMaps/mapApis/Write | Обновляет ресурс для Microsoft. BingMaps/Мапапис |
> | Действие | Microsoft.BingMaps/Operations/read | Перечисление операций для Microsoft. BingMaps |
...
> | Действие | Microsoft. Блокчейн/Кордамемберс/Delete | Удаляет существующий элемент Блокчейн. |
> | Действие | Microsoft. Блокчейн/Кордамемберс/Read | Возвращает или перечисляет существующие элементы Блокчейн-шнура. |
> | Действие | Microsoft. Блокчейн/Кордамемберс/запись | Создает или обновляет элемент Блокчейн-шнура. |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft.BotService/botServices/channels/delete | Удаление канала службы Bot |
> | Действие | Microsoft. Ботсервице/Ботсервицес/channels/листчаннелвискэйс/Action | Список каналов Ботсервице с секретами |
> | Действие | Microsoft.BotService/botServices/channels/read | Чтение канала службы Bot |
> | Действие | Microsoft.BotService/botServices/channels/write | Создание канала службы Bot |
> | Действие | Microsoft.BotService/botServices/connections/delete | Удаление подключения к службе Bot |
> | Действие | Microsoft. Ботсервице/Ботсервицес/Connections/листвиссекретс/Write | Создание списка подключений к службе Bot  |
> | Действие | Microsoft.BotService/botServices/connections/read | Чтение подключения к службе Bot |
> | Действие | Microsoft.BotService/botServices/connections/write | Создание подключения к службе Bot |
...
> | Действие | Microsoft. Capacity/ресерватионордерс/мержеоператионресултс/чтение | Опрос любой операции слияния |
...
> | Действие | Microsoft. Capacity/ресерватионордерс/сплитоператионресултс/чтение | Опросить любую операцию разделения |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | DataAction | Microsoft. CognitiveServices/Accounts/Аномалидетектор/TimeSeries/ALL/обнаружение/действие | Эта операция создает модель, используя целый ряд, каждая из которых определяется одной и той же моделью.<br>В этом методе точки до и после определенной точки используются для определения того, является ли она аномалией.<br>Полное обнаружение может дать пользователю общее состояние временных рядов. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Аномалидетектор/TimeSeries/Last/обнаружение/действие | Эта операция создает модель с использованием точек до последней. При использовании этого метода для определения того, является ли Целевая точка аномалией, используются только исторические точки. Последняя точка обнаружения соответствует сценарию мониторинга бизнес-метрик в режиме реального времени. |
...
> | DataAction | Microsoft. CognitiveServices/Accounts/Компутервисион, чтение, анализ и действие | Используйте этот интерфейс для выполнения операций чтения, используя современные алгоритмы оптического распознавания символов (OCR), оптимизированные для документов с большим объемом текста.<br>Он может обрабатывать рукописные, печатные или смешанные документы.<br>При использовании интерфейса чтения ответ содержит заголовок с именем Operation-Location.<br>Заголовок "Operation-Location" содержит URL-адрес, который необходимо использовать для операции получения результата чтения при получении доступа к результатам OCR. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Компутервисион/Read/анализересултс/Read | Используйте этот интерфейс для получения состояния и результата OCR операции чтения.  URL-адрес, содержащий "идентификатор", возвращается в заголовке ответа операции чтения "Operation-Location". |
> | DataAction | Microsoft. CognitiveServices/Accounts/Компутервисион, чтение, ядро, асинкбатчанализе/действие | Используйте этот интерфейс для получения результата операции пакетного чтения файла, применяя штатный оптический символ |
> | DataAction | Microsoft. CognitiveServices/Accounts/Компутервисион/Read/Operations/Read | Этот интерфейс используется для получения результатов OCR операции чтения. URL-адрес этого интерфейса должен быть получен из поля <b>"Operation-Location"</b> , возвращенного из интерфейса пакетного чтения файлов. |
...
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/ImageList/действие | Создание списка изображений. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/ImageList/Delete | Списки изображений — Удаление |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/ImageList/Images/Delete | Удаление образа из списка изображений. Список изображений можно использовать для нечеткого соответствия с другими образами при использовании API Image/Match. Удалите все изображения из списка. Список изображений можно использовать для нечеткого соответствия с другими образами при использовании API Image/Match. * |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/ImageList/Images/Read | Изображение — получить все идентификаторы изображений |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/ImageList/Images/Write | Добавьте изображение в список изображений. Список изображений можно использовать для нечеткого соответствия с другими образами при использовании API Image/Match. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/ImageList/чтение | Списки изображений — получение сведений — списки изображений — получение всех |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/imagelists/рефрешиндекс/действие | Списки изображений — обновление индекса поиска |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/ImageList/запись | Списки изображений — сведения об обновлении |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/процессимаже/Оценка/действие | Возвращает вероятности изображения, содержащего носящих непристойный характер или содержимое для взрослых. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/процессимаже/финдфацес/Action | Поиск лиц в изображениях. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/процессимаже/Match/Action | Фуззили соответствует образу в одном из пользовательских списков изображений.<br>С помощью этого API можно создавать настраиваемые списки изображений и управлять ими.<br> |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/процессимаже/OCR/Action | Возвращает любой текст, найденный в изображении для указанного языка. Если в входных данных не указан язык, по умолчанию используется значение Английский. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/процесстекст/детектлангуаже/Action | Эта операция определит язык заданного входного содержимого.<br>Возвращает код ISO 639-3 для основного языка, состоящего из отправленного текста.<br>Поддерживаются более 110 языков. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/процесстекст/экран/действие | Эта операция обнаруживает ненормативную лексику более чем на 100 языках и соответствует настраиваемым и общим спискам черного. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/команды/задания/действие | Для содержимого образа, размещенного в этой конечной точке, будет возвращен идентификатор задания.  |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/команды/задания/чтение | Получение сведений о задании для идентификатора задания. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/рецензии/AccessKey/чтение | Получите ключ доступа к содержимому проверки для вашей команды. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/views/Action | Созданные рецензии будут отображаться для рецензентов в вашей команде. По мере того как рецензенты просматривают проверку, результаты проверки будут ОПУБЛИКОВАНы (т. е. HTTP POST) на указанном Каллбаккендпоинт. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/views/frames/Read | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/рецензии/кадры/запись | Используйте этот метод, чтобы добавить кадры для проверки видео. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/рецензии/публикация/действие | Проверки видео изначально создаются в неопубликованном состоянии. Это означает, что они еще не доступны рецензентам в команде. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/рецензии/чтение | Возвращает сведения о проверке для переданного идентификатора проверки. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/рецензии/действие | Этот API добавляет в проверку видео файл транскрипции (текстовая версия всех слов, проносимых в видео). Файл должен быть допустимым форматом WebVTT. |
...
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/Settings/Templates/Delete | Удаление шаблона в команде |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/Settings/Templates/Read | Возвращает массив шаблонов проверки, подготовленных для этой команды. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/Teams/Settings/Templates/Write | Создает или обновляет указанный шаблон. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/группы/рабочие процессы/чтение | Получение сведений о конкретном рабочем процессе в команде. Получите все рабочие процессы, доступные для команды * |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/команды/рабочие процессы/запись | Создайте новый рабочий процесс или обновите существующий. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/Action | Создать список терминов. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/булкупдате/Action | Списки терминов — групповое обновление |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/Delete | Списки терминов — удаление |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/Read | Списки терминов — получение списка всех терминов — получение сведений |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/рефрешиндекс/Action | Списки терминов — обновление индекса поиска |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/термы/удаление | Term-Delete-Term — удаление всех терминов |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/термы/чтение | Термин — получение всех терминов |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/термы/запись | Термин — Добавление термина |
> | DataAction | Microsoft. CognitiveServices/Accounts/Контентмодератор/термлистс/Write | Списки терминов — сведения об обновлении |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/классификация/итерации/изображение/действие | Классификация образа и сохранение результата. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/классификация/итерации/изображение/хранимое действие | Классификация образа без сохранения результата. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/классификация/итерации/URL/действие | Классификация URL-адреса образа и сохранение результата. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/классификация/итерации/URL/хранимая операция | Классификация URL-адреса изображения без сохранения результата. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/обнаружение/итерации/изображение/действие | Обнаружение объектов в образе и сохранение результата. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/обнаружение/итерации/изображение/хранимое действие | Обнаружение объектов в образе без сохранения результата. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/обнаружение/итерации/URL/действие | Обнаружение объектов в URL-адресе изображения и сохранение результата. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/обнаружение/итерации/URL/хранимая операция | Обнаружение объектов в URL-адресе изображения без сохранения результата. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Domains/Read | Получение сведений о конкретном домене. Получение списка доступных доменов. * |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/лабелпропосалс/параметр/действие | Задайте размер пула для предложения метки. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/лабелпропосалс/задание/чтение | Возвращает размер пула для предложения метки для этого проекта. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/проект/миграция/действие | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Action | Создайте проект. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Delete | Удаление конкретного проекта. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/Action | Этот API принимает содержимое текста как multipart/form-data и Application/октет-Stream. При использовании составного |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/Delete | Удаление изображений из набора обучающих изображений. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/Files/Action | Этот API принимает пакет файлов и, при необходимости, теги для создания изображений. Существует ограничение в 64 изображений и 20 тегов. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/ID/Read | Этот API вернет набор изображений для указанных тегов и, при необходимости, итерацию. Если не указано ни одной итерации, |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/прогнозы/действие | Этот API создает пакет образов из заданных прогнозируемых образов. Существует ограничение в 64 изображений и 20 тегов. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/регионпропосалс/Action | Этот API будет получать предложения по регионам для изображения вместе с достоверностью для региона. Если предложения не найдены, возвращается пустой массив. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/regions/Action | Этот API принимает пакет областей изображения и, при необходимости, теги, чтобы обновить существующие изображения с информацией о регионе. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/regions/Delete | Удаление набора областей образа. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/предложенное/действие | Этот API будет выбирал изображения без тегов, отфильтрованные по предлагаемым идентификаторам тегов. Если изображения не найдены, возвращается пустой массив. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/предложенное/количество/действие | Этот API принимает идентификаторы тегов, чтобы получить количество изображений без тегов для каждого из предложенных тегов для заданного порогового значения. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/пометка/количество/чтение | Фильтрация осуществляется по связи и (или). Например, если предоставлены идентификаторы тегов для "Dog" и |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/Tagged/Read | Этот API поддерживает пакетную обработку и выбор диапазона. По умолчанию он будет возвращать только первые 50 изображений, соответствующих образам. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/Tags/Action | Свяжите набор изображений с набором тегов. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/Tags/Delete | Удаляет набор тегов из набора изображений. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/без тегов/Count/Read | Этот API возвращает изображения, не имеющие тегов для данного проекта и, при необходимости, итерации. Если не указано ни одной итерации, |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/без тегов или чтение | Этот API поддерживает пакетную обработку и выбор диапазона. По умолчанию он будет возвращать только первые 50 изображений, соответствующих образам. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Images/URL/Action | Этот API принимает пакет URL-адресов и, при необходимости, теги для создания изображений. Существует ограничение в 64 изображений и 20 тегов. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/удаление | Удаляет определенную итерацию проекта. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/экспорт/действие | Экспорт обученной итерации. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/экспорт/чтение | Возвращает список экспортов для определенной итерации. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/производительность/изображения/подсчет/чтение | Фильтрация осуществляется по связи и (или). Например, если предоставлены идентификаторы тегов для "Dog" и |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/производительность/изображения/чтение | Этот API поддерживает пакетную обработку и выбор диапазона. По умолчанию он будет возвращать только первые 50 изображений, соответствующих образам. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/производительность/чтение | Получение подробных сведений о производительности итерации. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/публикация/действие | Опубликуйте определенную итерацию. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/публикация/удаление | Отмена публикации определенной итерации. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/чтение | Получить конкретную итерацию. Получение итераций для проекта. * |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/итерации/запись | Обновление определенной итерации. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/прогнозы/удаление | Удаление набора прогнозируемых образов и связанных с ними результатов прогноза. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/прогнозы, запрос/действие | Получение образов, отправленных в конечную точку прогнозирования. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/QuickTest/Image/Action | Быстрое тестирование образа. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/QuickTest/URL/Action | Быстрое тестирование URL-адреса образа. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Read | Получение конкретного проекта. Получение проектов. * |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Tags/действие | Создайте тег для проекта. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Tags/Delete | Удалите тег из проекта. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Tags/Read | Получение сведений о конкретном теге. Получение тегов для данного проекта и итерации. * |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Tags/Write | Обновление тега. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/тагсандрегионс/предложение/действие | Этот API будет получать предлагаемые теги и регионы для массива или пакета изображений без тегов вместе с достоверностью тегов. Если теги не найдены, возвращается пустой массив. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/проекты/обучение/действие | Проект очередей для обучения. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Projects/Write | Обновление конкретного проекта. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/квота/действие | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/квота/удаление | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/квота/обновление/запись | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/использование/прогноз/пользователь/чтение | Получение сведений об использовании для ресурса прогнозирования для пользователя Oxford |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/использование/обучение, ресурс/уровень/чтение | Получение сведений об использовании учебных материалов для пользователей Azure |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/использование/обучение/пользователь/чтение | Получение сведений об использовании учебного ресурса для пользователя Oxford |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/пользователь/действие | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/пользователь/Delete | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. Прогноз/пользователь/состояние/запись | Обновление пользовательской среды |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/пользователь/уровень/запись | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/Users/Read | *нотдефинед* |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/список разрешений/Delete | Удаление пользователя список разрешений с определенной возможностью |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/список разрешений/Read | Возвращает список пользователей список разрешений с определенной возможностью. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Кустомвисион. PREDICTION/список разрешений/Write | Обновляет или создает пользователя в список разрешений с определенной возможностью. |
...
> | DataAction | Microsoft. CognitiveServices/Accounts/Face, снимок, применение и действие | Применение моментального снимка с указанием идентификатора объекта, указанного пользователем. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Face, снимок или удаление | Удаление моментального снимка. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Face, снимок/чтение | Возвращает состояние операции моментального снимка. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Face, снимок, Take/действие | Создание моментального снимка для объекта. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Face, снимок/запись | Обновление свойств моментального снимка. |
> | DataAction | Microsoft. CognitiveServices/учетные записи, лица, снимки и чтение | Вывод списка всех доступных для пользователя моментальных снимков со сведениями. * |
...
> | DataAction | Microsoft. CognitiveServices/Accounts/Формрекогнизер/Custom/Models/Analyze/Action | Извлечение пар "ключ-значение" из заданного документа. Входной документ должен принадлежать к одному из поддерживаемых типов содержимого: "Application/PDF", "Image/JPEG" или "Image/PNG". Успешный ответ будет возвращен в формате JSON. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Формрекогнизер/Custom/Models/Delete | Удаление артефактов модели. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Формрекогнизер/Custom/Models/ключи/чтение | Получите ключи для модели. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Формрекогнизер/Custom/Models/Read | Получение сведений о модели. Получение сведений обо всех обученных пользовательских моделях * |
> | DataAction | Microsoft. CognitiveServices/Accounts/Формрекогнизер/пользовательское/обучение/действие | Создание и обучение пользовательской модели.<br>Запрос на обучение должен включать параметр источника, который является либо доступным извне URI контейнера BLOB-объектов службы хранилища Azure (предпочтительно URI подписанного URL-адресом), либо допустимым путем к папке данных на локальном подключенном диске.<br>Если указаны локальные пути, они должны соответствовать формату пути Linux/UNIX и быть абсолютным путем к конфигурации подключения для входа. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Формрекогнизер/Предварительная сборка/приемка/асинкбатчанализе/действие | Извлечение текста поля и семантических значений из данного документа приемки. Входной документ изображения должен иметь один из поддерживаемых типов содержимого: JPEG, PNG, BMP, PDF или TIFF. Ответ об успешном выполнении — это JSON, содержащий поле "Operation-Location", которое содержит URL-адрес для операции получения результатов прихода для асинхронного получения результатов. |
> | DataAction | Microsoft. CognitiveServices/Accounts/Формрекогнизер/Предварительная сборка, получение, операции или действие | Запросите состояние и получите результат операции анализа получения. URL-адрес этого интерфейса можно получить из заголовка "Operation-Location" в ответе на анализ получения. |
...
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/alters/Read | Скачивание изменений из среды выполнения. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/alters/Write | Замена данных изменений. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/ендпоинткэйс/Read | Возвращает ключи конечной точки для конечной точки. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/ендпоинткэйс/рефрешкэйс/Action | Повторно создает ключ конечной точки. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/ендпоинтсеттингс/Read | Возвращает параметры конечной точки для конечной точки. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/ендпоинтсеттингс/Write | Обновите конечную точку ситтингс для конечной точки. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/базы знаний, создание и запись | Асинхронная операция создания новой базы знаний. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/базы знаний/Delete | Удаляет базу знаний и все ее данные. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/базы знаний/скачивание/чтение | Скачайте базу знаний. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/базы знаний/женератеансвер/Action | Вызов Женератеансвер для запроса базы знаний. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/базы знаний/Publish/Action | Публикует все изменения в индексе тестирования базы знаний в ее индексе произв. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/базы знаний/Read | Возвращает список базы знаний или сведения о конкретном кновледжебасер. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/базы знаний/поезд/действие | Обучить вызов, чтобы добавить предложения в базу знаний. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/базы знаний/Write | Асинхронная операция изменения базы знаний или замены содержимого базы знаний. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/Operations/Read | Получает сведения об определенной длительной операции. |
> | DataAction | Microsoft. CognitiveServices/Accounts/QnAMaker/root/действие | QnA Maker |
...
> | Действие | Microsoft. CognitiveServices/Locations/оператионресултс/Read | Чтение состояния асинхронной операции. |
...
> | Действие | Microsoft. COMPUTE/галереи/приложения/Удаление | Удаляет приложение из коллекции. |
> | Действие | Microsoft. COMPUTE/галереи/приложения/чтение | Возвращает свойства приложения коллекции. |
> | Действие | Microsoft. COMPUTE/галереи/приложения/версии/удаление | Удаляет версию приложения коллекции. |
> | Действие | Microsoft. COMPUTE/галереи/приложения/версии/чтение | Возвращает свойства версии приложения коллекции. |
> | Действие | Microsoft. COMPUTE/галереи/приложения/версии/запись | Создает новую версию приложения коллекции или обновляет существующую. |
> | Действие | Microsoft. COMPUTE/галереи/приложения/запись | Создает новое приложение из коллекции или обновляет существующее. |
...
> | Действие | Microsoft. COMPUTE/virtualMachines/Ассесспатчес/действие | Оценивает виртуальную машину и находит список доступных для него исправлений обновления ОС. |
> | Действие | Microsoft. COMPUTE/virtualMachines/Канцелпатчинсталлатион/действие | Отменяет текущую операцию установки исправления обновления ОС на виртуальной машине. |
...
> | Действие | Microsoft. COMPUTE/virtualMachines/Инсталлпатчес/действие | Устанавливает доступные исправления обновления ОС на виртуальной машине на основе параметров, предоставленных пользователем. Результаты оценки, содержащие список доступных исправлений, также будут обновлены в рамках этого. |
...
> | Действие | Microsoft. COMPUTE/virtualMachineScaleSets/Extensions/Roles/Read | Возвращает свойства роли в масштабируемом наборе виртуальных машин с помощью расширения службы среды выполнения виртуальной машины. |
> | Действие | Microsoft. COMPUTE/virtualMachineScaleSets/Extensions/Roles/Write | Обновляет свойства существующей роли в масштабируемом наборе виртуальных машин с помощью расширения службы среды выполнения виртуальной машины. |
...
> | Действие | Microsoft. COMPUTE/virtualMachineScaleSets/Роллингупградес/действие | Отмена последовательного обновления масштабируемого набора виртуальных машин. |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft. потребление/аггрегатедкост/чтение | Список Аггрегатедкост для группы управления. |
...
> | Действие | Microsoft. потребление/Екстерналбиллингаккаунтс/Теги/чтение | Вывод списка тегов для EA и подписок. |
> | Действие | Microsoft. потребление/Екстерналсубскриптионс/Теги/чтение | Вывод списка тегов для EA и подписок. |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft. Контаинеринстанце/Контаинерграупс/Containers/буилдлогс/Read | Получение журналов сборки для определенного контейнера. |
...
> | Действие | Microsoft. ContainerRegistry/реестров/Женератекредентиалс/действие | Создание ключей для токена указанного реестра контейнеров. |
...
> | Действие | Microsoft. ContainerRegistry/реестров/Приватиндпоинтконнектионпроксиес/Delete | Удаление прокси-сервера подключения частной конечной точки (только NRP) |
> | Действие | Microsoft. ContainerRegistry/Registry/Приватиндпоинтконнектионпроксиес/Оператионстатусес/Read | Получение состояния асинхронной операции прокси-сервера подключения к частной конечной точке |
> | Действие | Microsoft. ContainerRegistry/реестр/Приватиндпоинтконнектионпроксиес/чтение | Получить прокси-сервер подключения частной конечной точки (только NRP) |
> | Действие | Microsoft. ContainerRegistry/реестров/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверка прокси-сервера подключения к частной конечной точке (только NRP) |
> | Действие | Microsoft. ContainerRegistry/реестров/Приватиндпоинтконнектионпроксиес/запись | Создание прокси подключения к частной конечной точке (только NRP) |
...
> | Действие | Microsoft. ContainerRegistry/реестров/карантин/чтение | Извлечение или получение помещенных в карантин образов из реестра контейнеров. |
> | Действие | Microsoft. ContainerRegistry/реестров/карантин/запись | Запись и изменение состояния карантина образов, помещенных в карантин. |
...
> | Действие | Microsoft. ContainerRegistry/реестров/Скопемапс/Delete | Удаляет карту области из реестра контейнеров. |
...
> | Действие | Microsoft. ContainerRegistry/реестр/Скопемапс/чтение | Возвращает свойства указанной карты области или список всех сопоставлений областей для указанного реестра контейнеров. |
> | Действие | Microsoft. ContainerRegistry/реестров/Скопемапс/запись | Создает или обновляет карту области для реестра контейнеров с указанными параметрами. |
...
> | Действие | Microsoft. ContainerRegistry/registrys/tokens/Delete | Удаляет токен из реестра контейнеров. |
> | Действие | Microsoft. ContainerRegistry/registrys/tokens/Оператионстатусес/Read | Возвращает состояние асинхронной операции маркера. |
> | Действие | Microsoft. ContainerRegistry/реестры/маркеры/чтение | Возвращает свойства указанного маркера или список всех токенов для указанного реестра контейнеров. |
> | Действие | Microsoft. ContainerRegistry/реестры/маркеры/запись | Создает или обновляет маркер для реестра контейнеров с указанными параметрами. |
...
> | Действие | Microsoft. ContainerService/Манажедклустерс/Аваилаблеажентпулверсионс/Read | Возвращает доступные версии пула агентов кластера. |
...
> | Действие | Microsoft. ContainerService/Манажедклустерс/Листклустермониторингусеркредентиал/Action | Перечисление учетных данных Клустермониторингусер управляемого кластера |
...
> | Действие | Microsoft. ContainerService/Манажедклустерс/Ротатеклустерцертификатес/Action | Смена сертификатов для управляемого кластера |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft. Костманажемент/Alerts/Write | Обновление оповещений. |
...
> | Действие | Microsoft. Костманажемент/Екстерналбиллингаккаунтс/Dimensions/Read | Перечислите все поддерживаемые измерения для External Биллингаккаунтс. |
...
> | Действие | Microsoft. Костманажемент/Екстерналбиллингаккаунтс/прогноз/действие | Прогнозирование данных об использовании для внешних Биллингаккаунтс. |
> | Действие | Microsoft. Костманажемент/Екстерналбиллингаккаунтс/прогноз/чтение | Прогнозирование данных об использовании для внешних Биллингаккаунтс. |
> | Действие | Microsoft. Костманажемент/Екстерналбиллингаккаунтс/запрос/действие | Запрос данных об использовании для внешних Биллингаккаунтс. |
> | Действие | Microsoft. Костманажемент/Екстерналбиллингаккаунтс/запрос/чтение | Запрос данных об использовании для внешних Биллингаккаунтс. |
...
> | Действие | Microsoft. Костманажемент/Екстерналсубскриптионс/Dimensions/Read | Перечисление всех поддерживаемых измерений для внешней подписки. |
> | Действие | Microsoft. Костманажемент/Екстерналсубскриптионс/прогноз/действие | Прогнозирование данных об использовании для внешних Биллингаккаунтс. |
> | Действие | Microsoft. Костманажемент/Екстерналсубскриптионс/прогноз/чтение | Прогнозирование данных об использовании для внешних Биллингаккаунтс. |
> | Действие | Microsoft. Костманажемент/Екстерналсубскриптионс/запрос/действие | Запрос данных об использовании для внешней подписки. |
...
> | Действие | Microsoft. Костманажемент/прогноз/действие | Прогнозирование данных об использовании по области. |
...
> | Действие | Microsoft. Костманажемент/views/Action | Создать представление. |
> | Действие | Microsoft. Костманажемент/views/Delete | Удаление сохраненных представлений. |
> | Действие | Microsoft. Костманажемент/views/Read | Вывод списка всех сохраненных представлений. |
> | Действие | Microsoft. Костманажемент/views/Write | Обновить представление. |
...
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/Containers/Delete | Удаляет контейнеры. |
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/Containers/Оператионресултс/Read | Выводит или возвращает результат операции. |
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/Containers/Read | Выводит список контейнеров или возвращает их. |
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/Containers/обновление/действие | Обновление метаданных контейнера с помощью данных из облака |
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/Containers/Write | Создает или обновляет контейнеры. |
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/Delete | Удаление учетных записей хранения |
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/Оператионресултс/Read | Выводит или возвращает результат операции. |
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/Read | Перечисление или получение учетных записей хранения |
> | Действие | Microsoft. Датабокседже/Датабокседжедевицес/storageAccounts/запись | Создает или обновляет учетные записи хранения. |
...
> | Действие | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | Создает устройства Data Box Edge или обновляет их |
> | Действие | Microsoft. Датабокседже/SKU/чтение | Выводит список номеров SKU или возвращает их. |
...
> | Действие | Microsoft. кирпичы/рабочие области/storageEncryption/удалить | Отключает шифрование ключа, управляемого клиентом, в управляемой учетной записи хранения в рабочей области "кирпичи данных" |
> | Действие | Microsoft. кирпичы/рабочие области/storageEncryption/запись | Включает управляемое клиентом шифрование ключа в управляемой учетной записи хранения в рабочей области "кирпичи данных" |
...
> | Действие | Microsoft. кирпичы/рабочие области/Виртуалнетворкпирингс/удалить | Удаляет пиринг виртуальной сети. |
> | Действие | Microsoft. кирпичы/рабочие области/Виртуалнетворкпирингс/чтение | Получает пиринг виртуальной сети. |
> | Действие | Microsoft. кирпичы/рабочие области/Виртуалнетворкпирингс/запись | Добавление или изменение пиринга виртуальной сети |
...
> | Действие | Microsoft. адддатафловтодебугсессион/фабрики//действие | Добавьте поток данных в сеанс отладки для предварительного просмотра. |
...
> | Действие | Microsoft. ексекутедатафловдебугкомманд/фабрики//действие | Выполнение команды отладки потока данных. |
...
> | Действие | Microsoft. оператионресултс/фабрики//чтение | Возвращает результаты операции. |
...
> | Действие | Microsoft. куеридатафловдебугсессионс/фабрики//действие | Запрашивает сеанс отладки потока данных. |
...
> | Действие | Microsoft. куеритригжерс/фабрики//действие | Запрашивает триггеры. |
> | Действие | Microsoft.DataFactory/factories/read | Считывает фабрику данных. |
> | Действие | Microsoft. сандбокспипелинерунс/фабрики//действие | Запрашивает данные о выполнении конвейера отладки. |
> | Действие | Microsoft. сандбокспипелинерунс/фабрики//чтение | Возвращает сведения о выполнении отладки для конвейера. |
...
> | Действие | Microsoft. жетевентсубскриптионстатус/фабрики/триггеры//действие | Состояние подписки на событие. |
...
> | Действие | Microsoft. субскрибетоевентс/фабрики/триггеры//действие | Подпишитесь на события. |
> | Действие | Microsoft.DataFactory/factories/triggers/triggerruns/read | Считывает выполнения триггеров. |
> | Действие | Microsoft. унсубскрибефромевентс/фабрики/триггеры//действие | Отмена подписки на события. |
...
> | Действие | Microsoft. Migration/Services/Жесибриддовнлоадлинк/действие | Получает ссылку скачивания рабочего пакета DMS из хранилища BLOB-объектов RP. |
...
> | Действие | Microsoft. Дбформариадб/Locations/Приватиндпоинтконнектионазуреасинкоператион/Read | Возвращает результат операции подключения к частной конечной точке |
> | Действие | Microsoft. Дбформариадб/Locations/Приватиндпоинтконнектионоператионресултс/Read | Возвращает результат операции подключения к частной конечной точке |
> | Действие | Microsoft. Дбформариадб/Locations/Приватиндпоинтконнектионпроксязуреасинкоператион/Read | Возвращает результат для операции прокси-сервера подключения частной конечной точки |
> | Действие | Microsoft. Дбформариадб/Locations/Приватиндпоинтконнектионпроксйоператионресултс/Read | Возвращает результат для операции прокси-сервера подключения частной конечной точки |
...
> | Действие | Microsoft. Дбформариадб/серверы/ключи/удалить | Удаление существующего ключа сервера. |
> | Действие | Microsoft. Дбформариадб/серверы/ключи/чтение | Возвращение списка ключей сервера или возвращение свойств указанного ключа сервера. |
> | Действие | Microsoft. Дбформариадб/серверы/ключи/запись | Создание ключа с указанными параметрами либо обновление свойств или тегов указанного ключа сервера. |
> | Действие | Microsoft. Дбформариадб/серверы/файлы журнала/чтение | Возврат списка файлов журнала MariaDB. |
> | Действие | Microsoft. Дбформариадб/Servers/Приватиндпоинтконнектионпроксиес/Delete | Удаляет существующий прокси-сервер подключения частной конечной точки. |
> | Действие | Microsoft. Дбформариадб/Servers/Приватиндпоинтконнектионпроксиес/Read | Возвращает список прокси-серверов подключения частной конечной точки или получает свойства для указанного прокси подключения к частной конечной точке. |
> | Действие | Microsoft. Дбформариадб/Servers/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверяет подключение к частной конечной точке создать вызов с NRP стороны |
> | Действие | Microsoft. Дбформариадб/Servers/Приватиндпоинтконнектионпроксиес/Write | Создает прокси-сервер подключения частной конечной точки с указанными параметрами или обновляет свойства или теги для указанного прокси-сервера подключения частной конечной точки. |
> | Действие | Microsoft. Дбформариадб/Servers/Приватиндпоинтконнектионс/Delete | Удаляет существующее подключение к частной конечной точке |
> | Действие | Microsoft. Дбформариадб/Servers/Приватиндпоинтконнектионс/Read | Возвращает список подключений к частным конечным точкам или возвращает свойства для указанного подключения к частной конечной точке. |
> | Действие | Microsoft. Дбформариадб/Servers/Приватиндпоинтконнектионс/Write | Утверждает или отклоняет существующее подключение к частной конечной точке |
> | Действие | Microsoft. Дбформариадб/Servers/Привателинкресаурцес/Read | Получение ресурсов частной ссылки для соответствующего сервера MariaDB |
...
> | Действие | Microsoft. Дбформискл/Locations/Приватиндпоинтконнектионазуреасинкоператион/Read | Возвращает результат операции подключения к частной конечной точке |
> | Действие | Microsoft. Дбформискл/Locations/Приватиндпоинтконнектионоператионресултс/Read | Возвращает результат операции подключения к частной конечной точке |
> | Действие | Microsoft. Дбформискл/Locations/Приватиндпоинтконнектионпроксязуреасинкоператион/Read | Возвращает результат для операции прокси-сервера подключения частной конечной точки |
> | Действие | Microsoft. Дбформискл/Locations/Приватиндпоинтконнектионпроксйоператионресултс/Read | Возвращает результат для операции прокси-сервера подключения частной конечной точки |
...
> | Действие | Microsoft. Дбформискл/серверы/ключи/удалить | Удаление существующего ключа сервера. |
> | Действие | Microsoft. Дбформискл/серверы/ключи/чтение | Возвращение списка ключей сервера или возвращение свойств указанного ключа сервера. |
> | Действие | Microsoft. Дбформискл/серверы/ключи/запись | Создание ключа с указанными параметрами либо обновление свойств или тегов указанного ключа сервера. |
> | Действие | Microsoft. Дбформискл/серверы/файлы журнала/чтение | Возврат списка файлов журнала MySQL. |
> | Действие | Microsoft. Дбформискл/Servers/Приватиндпоинтконнектионпроксиес/Delete | Удаляет существующий прокси-сервер подключения частной конечной точки. |
> | Действие | Microsoft. Дбформискл/Servers/Приватиндпоинтконнектионпроксиес/Read | Возвращает список прокси-серверов подключения частной конечной точки или получает свойства для указанного прокси подключения к частной конечной точке. |
> | Действие | Microsoft. Дбформискл/Servers/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверяет подключение к частной конечной точке создать вызов с NRP стороны |
> | Действие | Microsoft. Дбформискл/Servers/Приватиндпоинтконнектионпроксиес/Write | Создает прокси-сервер подключения частной конечной точки с указанными параметрами или обновляет свойства или теги для указанного прокси-сервера подключения частной конечной точки. |
> | Действие | Microsoft. Дбформискл/Servers/Приватиндпоинтконнектионс/Delete | Удаляет существующее подключение к частной конечной точке |
> | Действие | Microsoft. Дбформискл/Servers/Приватиндпоинтконнектионс/Read | Возвращает список подключений к частным конечным точкам или возвращает свойства для указанного подключения к частной конечной точке. |
> | Действие | Microsoft. Дбформискл/Servers/Приватиндпоинтконнектионс/Write | Утверждает или отклоняет существующее подключение к частной конечной точке |
> | Действие | Microsoft. Дбформискл/Servers/Привателинкресаурцес/Read | Получение ресурсов частной ссылки для соответствующего сервера MySQL |
...
> | Действие | Microsoft. Дбфорпостгрескл/серверы/ключи/удалить | Удаление существующего ключа сервера. |
> | Действие | Microsoft. Дбфорпостгрескл/серверы/ключи/чтение | Возвращение списка ключей сервера или возвращение свойств указанного ключа сервера. |
> | Действие | Microsoft. Дбфорпостгрескл/серверы/ключи/запись | Создание ключа с указанными параметрами либо обновление свойств или тегов указанного ключа сервера. |
...
> | Действие | Microsoft. Devices/Еластикпулс/Евентгридфилтерс/Delete | Удаляет Эластичный пул фильтр сетки событий |
> | Действие | Microsoft. Devices/Еластикпулс/Евентгридфилтерс/Read | Возвращает Эластичный пул фильтр сетки событий. |
> | Действие | Microsoft. Devices/Еластикпулс/Евентгридфилтерс/Write | Создание нового или обновление существующего Эластичный пул фильтра сетки событий |
...
> | Действие | Microsoft. Devices/Еластикпулс/Иосубтенантс/securitySettings/Оператионресултс/Read | Получение результата операции асинхронного размещения для центра клиента IOT SecuritySettings |
> | Действие | Microsoft. Devices/Еластикпулс/Иосубтенантс/securitySettings/Read | Получение параметров центра безопасности Azure в центре клиента IOT |
> | Действие | Microsoft. Devices/Еластикпулс/Иосубтенантс/securitySettings/Write | Обновление параметров центра безопасности Azure в центре клиента IOT |
...
> | Действие | Microsoft. Devices/iotHubs/securitySettings/Оператионресултс/Read | Получение результата операции асинхронного размещения для центра Интернета вещей SecuritySettings |
> | Действие | Microsoft. Devices/iotHubs/securitySettings/Read | Получение параметров центра безопасности Azure в центре Интернета вещей |
> | Действие | Microsoft. Devices/iotHubs/securitySettings/Write | Обновление параметров центра безопасности Azure в центре Интернета вещей |
...
> | Действие | Microsoft. Девспацес/Locations/Чеккконтаинерхостмаппинг/Read | Проверка существующего сопоставления контроллера для узла контейнера |
...
> | Действие | Microsoft.DevTestLab/labs/artifactSources/artifacts/GenerateArmTemplate/action | Создает шаблон Azure Resource Manager для данного артефакта, передает необходимые файлы в учетную запись хранения и проверяет созданный артефакт. |
...
> | Действие | Microsoft. DevTestLab/Labs/virtualMachines/Клеарартифактресултс/действие | Очищает результаты артефакта виртуальной машины. |
...
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Delete | Удалите пространства ключей Cassandra. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Read | Прочтите Cassandra пространства ключей или перечислите все Cassandra пространств ключей. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Tables/Delete | Удаление таблицы Cassandra. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Tables/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Tables/Read | Считывает таблицу Cassandra или список всех таблиц Cassandra. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Tables/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Tables/Сраугхпутсеттингс/Read | Считывает пропускную способность таблицы Cassandra. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Tables/Сраугхпутсеттингс/Write | Обновите пропускную способность таблицы Cassandra. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/таблицы/запись | Создание или обновление таблицы Cassandra. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Сраугхпутсеттингс/Read | Считывает пропускную способность Cassandra пространства ключей. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/Сраугхпутсеттингс/запись | Обновление пропускной способности Cassandra пространства ключей. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Кассандракэйспацес/запись | Создайте пространства ключей Cassandra. |
...
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Delete | Удаление базы данных Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Graphs/Delete | Удаление графа Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Graphs/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/графы/чтение | Прочтите граф Gremlin или перечислите все диаграммы Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Graphs/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Graphs/Сраугхпутсеттингс/Read | Считывает пропускную способность графа Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Graphs/Сраугхпутсеттингс/Write | Обновите пропускную способность графа Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/графики/запись | Создание или обновление графа Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Read | Прочтите базу данных Gremlin или перечислите все базы данных Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Сраугхпутсеттингс/Read | Считывает пропускную способность базы данных Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/Сраугхпутсеттингс/запись | Обновите пропускную способность базы данных Gremlin. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Гремлиндатабасес/запись | Создайте базу данных Gremlin. |
...
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Collections/Delete | Удаление коллекции MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Collections/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Collections/Read | Прочтите коллекцию MongoDB или перечислите все коллекции MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Collections/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Collections/Сраугхпутсеттингс/Read | Считывает пропускную способность коллекции MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Collections/Сраугхпутсеттингс/Write | Обновите пропускную способность коллекции MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Collections/Write | Создание или обновление коллекции MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Delete | Удаление базы данных MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Read | Прочтите базу данных MongoDB или перечислите все базы данных MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Сраугхпутсеттингс/Read | Считывает пропускную способность базы данных MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/Сраугхпутсеттингс/запись | Обновите пропускную способность базы данных MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Монгодбдатабасес/запись | Создайте базу данных MongoDB. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Нотебукворкспацес/Delete | Удаление рабочей области записной книжки |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Нотебукворкспацес/Листконнектионинфо/Action | Вывод сведений о подключении для рабочей области записной книжки |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Нотебукворкспацес/Оператионресултс/Read | Чтение состояния асинхронной операции в рабочих областях записной книжки |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Нотебукворкспацес/Read | Чтение рабочей области записной книжки |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Нотебукворкспацес/запись | Создание или обновление рабочей области записной книжки |
...
> | Действие | Microsoft. DocumentDB/databaseAccounts/Приватиндпоинтконнектионпроксиес/Оператионресултс/Read | Чтение состояния асинхронной операции прокси-сервера подключения к частной конечной точке |
...
> | Действие | Microsoft. DocumentDB/databaseAccounts/Приватиндпоинтконнектионс/Delete | Удаление подключения к частной конечной точке учетной записи базы данных |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Приватиндпоинтконнектионс/Оператионресултс/Read | Чтение состояния асинхронной операции Приватиндпоинтконненктионс |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Приватиндпоинтконнектионс/Read | Чтение частного подключения к частной конечной точке или вывод списка всех подключений к частным конечным точкам учетной записи базы данных |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Приватиндпоинтконнектионс/запись | Создание или обновление подключения к частной конечной точке учетной записи базы данных |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Привателинкресаурцес/Read | Чтение ресурса частной ссылки или перечисление всех ресурсов частной ссылки учетной записи базы данных |
...
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Delete | Удаление контейнера SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Read | Считывает контейнер SQL или список всех контейнеров SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Сторедпроцедурес/Delete | Удаление хранимой процедуры SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Сторедпроцедурес/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Сторедпроцедурес/Read | Прочтите хранимую процедуру SQL или перечислите все хранимые процедуры SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Сторедпроцедурес/Write | Создание или обновление хранимой процедуры SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Сраугхпутсеттингс/Read | Считывает пропускную способность контейнера SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Сраугхпутсеттингс/Write | Обновление пропускной способности контейнера SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Triggers/Delete | Удаление триггера SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Triggers/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/контейнеры/триггеры/чтение | Прочтите триггер SQL или перечислите все триггеры SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/контейнеры/триггеры/запись | Создание или обновление триггера SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Усердефинедфунктионс/Delete | Удаляет определяемую пользователем функцию SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Усердефинедфунктионс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Усердефинедфунктионс/Read | Прочтите определяемую пользователем функцию SQL или перечислите все определяемые пользователем функции SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Усердефинедфунктионс/Write | Создает или обновляет определяемую пользователем функцию SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Containers/Write | Создание или обновление контейнера SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Delete | Удаление базы данных SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Read | Прочтите базу данных SQL или перечислите все базы данных SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Сраугхпутсеттингс/Read | Прочтите пропускную способность базы данных SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/Сраугхпутсеттингс/запись | Обновите пропускную способность базы данных SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Склдатабасес/запись | Создайте базу данных SQL. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Tables/Delete | Удаление таблицы. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Tables/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Tables/Read | Считывает таблицу или список всех таблиц. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Tables/Сраугхпутсеттингс/Оператионресултс/Read | Чтение состояния асинхронной операции. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Tables/Сраугхпутсеттингс/Read | Чтение пропускной способности таблицы. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/Tables/Сраугхпутсеттингс/Write | Обновите пропускную способность таблицы. |
> | Действие | Microsoft. DocumentDB/databaseAccounts/таблицы/запись | Создание или обновление таблицы. |
...
> | Действие | Microsoft.EventHub/clusters/namespaces/read | Вывод списка пространств имен Azure Resource Manager Идентификаторы пространств имен в кластере. |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft. Хибридкомпуте/Locations/оператионресултс/Read | Считывает состояние операции с поставщиком ресурсов Microsoft. Хибридкомпуте. |
> | Действие | Microsoft. Хибридкомпуте/Machines/Delete | Удаление компьютеров ARC в Azure |
...
> | Действие | Microsoft. Хибридкомпуте/Machines/Read | Чтение всех машин ARC в Azure |
> | Действие | Microsoft. Хибридкомпуте/Machines/Reconnect/действие | Повторное подключение компьютеров ARC в Azure |
> | Действие | Microsoft. Хибридкомпуте/Machines/Write | Запись машин ARC в Azure |
...
> | Действие | Microsoft. Insights/Components/providers/Microsoft. Insights/diagnosticSettings/Read | Чтение параметра диагностики для ресурсов. |
> | Действие | Microsoft. Insights/Components/providers/Microsoft. Insights/diagnosticSettings/запись | Создание или изменение параметра для диагностики ресурсов. |
> | Действие | Microsoft. Insights/Components/providers/Microsoft. Insights/Логдефинитионс/Read | Считывает определения журналов. |
...
> | Действие | Microsoft. Insights/ДатаколлектионрулеассоЦиатионс/удаление | Удаление связи ресурса с правилом сбора данных |
> | Действие | Microsoft. Insights/ДатаколлектионрулеассоЦиатионс/чтение | Чтение связи ресурса с правилом сбора данных |
> | Действие | Microsoft. Insights/ДатаколлектионрулеассоЦиатионс/запись | Создание или обновление связи ресурса с помощью правила сбора данных |
> | DataAction | Microsoft. Insights/Датаколлектионрулес/данные/запись | Отправка данных в правило сбора данных |
> | Действие | Microsoft. Insights/Датаколлектионрулес/удаление | Удаление правила сбора данных |
> | Действие | Microsoft. Insights/Датаколлектионрулес/чтение | Чтение правила сбора данных |
> | Действие | Microsoft. Insights/Датаколлектионрулес/запись | Создание или обновление правила сбора данных |
...
> | Действие | Microsoft. Insights/Миворкбукс/запись | Создание или обновление частной книги |
> | Действие | Microsoft.Insights/Operations/Read | Считывает операции. |
> | Действие | Microsoft. Insights/Привателинкскопес/удаление | Удаление области закрытых ссылок |
> | Действие | Microsoft. Insights/Привателинкскопес/Приватиндпоинтконнектионпроксиес/удаление | Удаление прокси-сервера подключения частной конечной точки |
> | Действие | Microsoft. Insights/Привателинкскопес/Приватиндпоинтконнектионпроксиес/чтение | Чтение прокси-сервера подключения частной конечной точки |
> | Действие | Microsoft. Insights/Привателинкскопес/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверка прокси-сервера подключения частной конечной точки |
> | Действие | Microsoft. Insights/Привателинкскопес/Приватиндпоинтконнектионпроксиес/запись | Создание или обновление прокси-сервера подключения к частной конечной точке |
> | Действие | Microsoft. Insights/Привателинкскопес/Приватиндпоинтконнектионс/удаление | Удаление подключения к частной конечной точке |
> | Действие | Microsoft. Insights/Привателинкскопес/Приватиндпоинтконнектионс/чтение | Чтение подключения к частной конечной точке |
> | Действие | Microsoft. Insights/Привателинкскопес/Приватиндпоинтконнектионс/запись | Создание или обновление подключения к частной конечной точке |
> | Действие | Microsoft. Insights/Привателинкскопес/Привателинкресаурцес/чтение | Чтение ресурса частной ссылки |
> | Действие | Microsoft. Insights/Привателинкскопес/чтение | Чтение области частной ссылки |
> | Действие | Microsoft. Insights/Привателинкскопес/Скопедресаурцес/удаление | Удаление ресурса с областью действия закрытой ссылки |
> | Действие | Microsoft. Insights/Привателинкскопес/Скопедресаурцес/чтение | Чтение ресурса с областью действия закрытой ссылки |
> | Действие | Microsoft. Insights/Привателинкскопес/Скопедресаурцес/запись | Создание или обновление ресурса с областью действия закрытой ссылки |
...
> | DataAction | Microsoft. KeyVault/хранилища/цертификатекас/удаление | Удаление сертификата "сертификат" |
> | DataAction | Microsoft. KeyVault/хранилища/цертификатекас/чтение | Чтение сертификата "сертификат" |
> | DataAction | Microsoft. KeyVault/Vault/цертификатекас/запись | Запись сертификата для SuSE |
> | DataAction | Microsoft. KeyVault/Vault/цертификатеконтактс/запись | Управление контактными данными сертификата |
> | DataAction | Microsoft. KeyVault/хранилища, сертификаты, резервное копирование и действие | Создайте файл резервной копии сертификата. Файл может использоваться для восстановления сертификата в Key Vault той же подписки. Могут применяться ограничения. |
> | DataAction | Microsoft. KeyVault/хранилища/сертификаты/создание/действие | Создает новый сертификат. |
> | DataAction | Microsoft. KeyVault/хранилища/сертификаты/удаление | Удаление сертификата. |
> | DataAction | Microsoft. KeyVault/хранилища/сертификаты/импорт/действие | Импортирует существующий действительный сертификат, содержащий закрытый ключ, в Azure Key Vault. Импортируемый сертификат может иметь формат PFX или PEM. |
> | DataAction | Microsoft. KeyVault/хранилища/сертификаты/Очистка/действие | Удаляет сертификат, делая его невосстанавливаемым. |
> | DataAction | Microsoft. KeyVault/хранилища/сертификаты/чтение | Вывод списка сертификатов в указанном хранилище ключей или получение сведений о сертификате. |
> | DataAction | Microsoft. KeyVault/хранилища/сертификаты/восстановление/действие | Восстанавливает удаленный сертификат. Операция выполняет реверсирование операции удаления. Эта операция применима в хранилищах, разрешенных для обратимого удаления, и должна выдаваться в течение интервала хранения. |
> | DataAction | Microsoft. KeyVault/хранилища/сертификаты/восстановление/действие | Восстанавливает резервную копию сертификата и все его версии в хранилище. |
> | DataAction | Microsoft. KeyVault/хранилища/сертификаты/обновление/действие | Обновляет указанные атрибуты, связанные с данным сертификатом. |
...
> | DataAction | Microsoft. KeyVault/хранилища/ключи/резервное копирование/действие | Создайте файл резервной копии ключа. Файл может использоваться для восстановления ключа в Key Vault одной подписки. Могут применяться ограничения. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/создание/действие | Создает новый ключ. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/расшифровка и действие | Расшифровка зашифрованного текста с помощью ключа. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/удалить | Удаление ключа. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/шифрование/действие | Шифрование открытого текста с помощью ключа. Обратите внимание, что если ключ является асимметричным, эта операция может быть выполнена участниками с доступом на чтение. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/импорт/действие | Импортирует созданный внешне ключ, сохраняет его, а также возвращает параметры и атрибуты ключа клиенту. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/Очистка/действие | Удаляет ключ, делая его невосстанавливаемым. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/чтение | Вывод списка ключей в указанном хранилище или чтение свойств и общего материала ключа.<br>Для асимметричных ключей эта операция предоставляет открытый ключ и включает возможность выполнения алгоритмов открытого ключа, таких как шифрование и проверка подписи.<br>Закрытые ключи и симметричные ключи никогда не предоставляются. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/восстановление/действие | Восстанавливает удаленный ключ. Операция выполняет реверсирование операции удаления. Эта операция применима в хранилищах, разрешенных для обратимого удаления, и должна выдаваться в течение интервала хранения. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/восстановление/действие | Восстанавливает резервную копию ключа и все его версии в хранилище. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи, подписывание и действие | Подпишите хэш с помощью ключа. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/распаковка/действие | Разворачивает симметричный ключ с ключом Key Vault. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи, обновление/действие | Обновляет указанные атрибуты, связанные с заданным ключом. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/проверка/действие | Проверьте хэш. Обратите внимание, что если ключ является асимметричным, эта операция может быть выполнена участниками с доступом на чтение. |
> | DataAction | Microsoft. KeyVault/хранилища/ключи/действие по переносу и действию | Заключите симметричный ключ в ключ Key Vault. Обратите внимание, что если ключ Key Vault является асимметричным, эту операцию можно выполнить с доступом на чтение. |
> | Действие | Microsoft.KeyVault/vaults/read | Отображает свойства Key Vault. |
> | DataAction | Microsoft. KeyVault/хранилища, секреты, резервное копирование и действие | Создайте файл резервной копии секрета. Файл может использоваться для восстановления секрета в Key Vault одной подписки. Могут применяться ограничения. |
> | DataAction | Microsoft. KeyVault/хранилища/секреты/удаление | Удаление секрета. |
> | DataAction | Microsoft. KeyVault/Vault/секреты/действие | Возвращает значение секрета. |
> | DataAction | Microsoft. KeyVault/хранилища/секреты, очистка или действие | Удаляет секрет, делая его невосстанавливаемым. |
> | Действие | Microsoft.KeyVault/vaults/secrets/read | Просмотр свойств секрета, но не его значения. |
> | DataAction | Microsoft. KeyVault/хранилища/секреты, Реадметадата/действие | Перечисление или Просмотр свойств секрета, но не его значения. |
> | DataAction | Microsoft. KeyVault/хранилища/секреты, восстановление/действие | Восстанавливает удаленный секрет. Операция выполняет реверсирование операции удаления. Эта операция применима в хранилищах, разрешенных для обратимого удаления, и должна выдаваться в течение интервала хранения. |
> | DataAction | Microsoft. KeyVault/хранилища/секреты, восстановление/действие | Восстанавливает резервную копию секрета и все его версии в хранилище. |
> | DataAction | Microsoft. KeyVault/хранилища/секреты, Сетсекрет/действие | Создайте новый секрет. |
> | DataAction | Microsoft. KeyVault/хранилища/секреты, обновление/действие | Обновляет указанные атрибуты, связанные с заданным секретом. |
...
> | Действие | Microsoft. Kusto/Clusters/Аттачеддатабасеконфигуратионс/Delete | Удаляет ресурс конфигурации присоединенной базы данных. |
> | Действие | Microsoft. Kusto/Clusters/Аттачеддатабасеконфигуратионс/Read | Считывает ресурс конфигурации присоединенной базы данных. |
> | Действие | Microsoft. Kusto/Clusters/Аттачеддатабасеконфигуратионс/Write | Записывает ресурс конфигурации присоединенной базы данных. |
...
> | Действие | Microsoft.Kusto/Clusters/Databases/DataConnections/write | Записывает ресурс подключений к данным. |
...
> | Действие | Microsoft.Kusto/Clusters/Databases/EventHubConnections/delete | Удаляет ресурс соединений концентратора событий. |
> | Действие | Microsoft.Kusto/Clusters/Databases/EventHubConnections/read | Считывает ресурс подключений концентратора событий. |
> | Действие | Microsoft.Kusto/Clusters/Databases/EventHubConnections/write | Записывает ресурс соединений концентратора событий. |
...
> | Действие | Microsoft. Kusto/Clusters/databases/ПринЦипалассигнментс/Delete | Удаляет ресурс назначений участников базы данных. |
> | Действие | Microsoft. Kusto/Clusters/databases/ПринЦипалассигнментс/Read | Считывает ресурс назначений участников базы данных. |
> | Действие | Microsoft. Kusto/Clusters/databases/ПринЦипалассигнментс/Write | Записывает ресурс назначений участников базы данных. |
...
> | Действие | Microsoft. Kusto/Clusters/соединений/удаления | Удаляет ресурс подключений к данным кластера. |
> | Действие | Microsoft. Kusto/Clusters/подключения/чтение | Считывает ресурс подключений к данным кластера. |
> | Действие | Microsoft. Kusto/Clusters/соединений/запись | Записывает ресурс подключений к данным кластера. |
...
> | Действие | Microsoft. Kusto/Clusters/Детачфолловердатабасес/действие | Отсоединяет базы данных следа. |
> | Действие | Microsoft. Kusto/Clusters/Диагносевиртуалнетворк/действие | Диагностика состояния сетевого подключения для внешних ресурсов, от которых зависит служба. |
> | Действие | Microsoft. Kusto/Clusters/Листфолловердатабасес/действие | Выводит список баз данных следов. |
> | Действие | Microsoft. Kusto/Clusters/ПринЦипалассигнментс/Delete | Удаляет ресурс назначений субъекта кластера. |
> | Действие | Microsoft. Kusto/Clusters/ПринЦипалассигнментс/Read | Считывает ресурс назначений субъекта кластера. |
> | Действие | Microsoft. Kusto/Clusters/ПринЦипалассигнментс/Write | Записывает ресурс назначений субъекта кластера. |
> | Действие | Microsoft.Kusto/Clusters/read | Читает кластерный ресурс. |
> | Действие | Microsoft. Kusto/Clusters/SKU/чтение | Считывает ресурс SKU кластера. |
...
> | Действие | Microsoft. Kusto/Locations/Чеккнамеаваилабилити/Action | Проверяет доступность имени ресурса. |
> | Действие | Microsoft. Kusto/Locations/ЖетнетворкполиЦиес/Action | Получение политик намерения сети |
...
> | Действие | Microsoft. Kusto/SKU/чтение | Считывает ресурс номера SKU. |
...
> | Действие | Microsoft. Лабсервицес/Лабаккаунтс/ЖетприЦингандаваилабилити/Action | Получите сведения о ценах и доступности комбинаций размеров, географических регионов и операционных систем для учетной записи лаборатории. |
...
> | Действие | Microsoft. Лабсервицес/Лабаккаунтс/Жетрестриктионсандусаже/Action | Получить базовые ограничения и использование для этой подписки |
...
> | Действие | Microsoft. Лабсервицес/Лабаккаунтс/Labs/ЖетлабприЦингандаваилабилити/действие | Получите цену за единицу лаборатории для этой лабораторной работы и доступность, которая указывает, можно ли масштабировать эту лабораторию. |
...
> | Действие | Microsoft. Лабсервицес/Users/UserSettings/Action | Обновляет и возвращает персональные параметры пользователя. |
...
> | Действие | Microsoft. Logic/Интегратионаккаунтс/группы/удалить | Удаляет группу в учетной записи интеграции. |
> | Действие | Microsoft. Logic/Интегратионаккаунтс/группы/чтение | Считывает группу в учетной записи интеграции. |
> | Действие | Microsoft. Logic/Интегратионаккаунтс/группы/запись | Создает или обновляет группу в учетной записи интеграции. |
...
> | Действие | Microsoft. Logic/Интегратионаккаунтс/Росеттанетпроцессконфигуратионс/Delete | Удаляет конфигурацию процесса RosettaNet в учетной записи интеграции. |
> | Действие | Microsoft. Logic/Интегратионаккаунтс/Росеттанетпроцессконфигуратионс/Read | Считывает конфигурацию процесса RosettaNet в учетной записи интеграции. |
> | Действие | Microsoft. Logic/Интегратионаккаунтс/Росеттанетпроцессконфигуратионс/запись | Создает или обновляет конфигурацию процесса RosettaNet в учетной записи интеграции. |
> | Действие | Microsoft. Logic/Интегратионаккаунтс/Schedules/Delete | Удаляет расписание в учетной записи интеграции. |
> | Действие | Microsoft. Logic/Интегратионаккаунтс/расписания/чтение | Считывает расписание в учетной записи интеграции. |
> | Действие | Microsoft. Logic/Интегратионаккаунтс/Schedules/Write | Создает или обновляет расписание в учетной записи интеграции. |
...
> | Действие | Microsoft.Logic/integrationAccounts/sessions/read | Считывает сеанс в учетной записи интеграции. |
...
> | Действие | Microsoft. Logic/Интегратионсервицеенвиронментс/Аваилаблеманажедапис/Read | Считывает доступные управляемые API среды службы интеграции. |
...
> | Действие | Microsoft. Logic/Интегратионсервицеенвиронментс/Манажедапис/соединение/действие | Присоединяет среда службы интеграции управляемый API. |
> | Действие | Microsoft. Logic/Интегратионсервицеенвиронментс/Манажедапис/Оператионстатусес/Read | Считывает состояния операций управляемого API среды службы интеграции. |
...
> | Действие | Microsoft. Logic/Интегратионсервицеенвиронментс/Манажедапис/запись | Создает или обновляет управляемый API среды службы интеграции. |
...
> | Действие | Microsoft. Logic/рабочие процессы/обнаружение/чтение | Считывает средство обнаружения рабочих процессов. |
...
> | Действие | Microsoft. Мачинелеарнингсервицес/Locations/квоты/чтение | Возвращает назначенные в настоящее время квоты рабочей области на основе Вмфамили. |
> | Действие | Microsoft. Мачинелеарнингсервицес/Locations/Упдатекуотас/Action | Обновите квоту для каждого семейства виртуальных машин в рабочей области. |
...
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/вычислений/перезагрузка/действие | Перезапуск ресурсов вычислений в рабочей области Службы машинного обучения |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/вычислений/запуск/действие | Запуск вычислений ресурсов в рабочей области Службы машинного обучения |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/вычислений/действие | Прерывать ресурсы вычислений в рабочей области Службы машинного обучения |
...
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/датадрифтдетекторс/чтение | Получает данные обнаружения расхождения данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/датадрифтдетекторс/запись | Создает или обновляет средство обнаружения смещения данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/регистрация/удаление | Удаляет зарегистрированные наборы данных в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/зарегистрированный/предварительный просмотр/чтение | Получение предварительной версии набора данных для зарегистрированных наборов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/регистрация/профиль/чтение | Получает профили наборов данных для зарегистрированных наборов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/регистрация/профиль/запись | Создает или обновляет профили наборов данных для зарегистрированных наборов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/наборы данных/зарегистрированные/прочитанные | Получает зарегистрированные наборы данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/зарегистрировано/схема/чтение | Получает схему DataSet для зарегистрированных наборов данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/регистрация/запись | Создает или обновляет зарегистрированные наборы данных в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/отменена регистрация или удаление | Удаляет незарегистрированные наборы данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/отменена регистрация, предварительная версия или чтение | Получение предварительной версии набора данных для незарегистрированных наборов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/незарегистрированный/профиль/чтение | Получает профили наборов данных для незарегистрированных наборов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/Отмена регистрации, профиль/запись | Создает или обновляет профили наборов данных для незарегистрированных наборов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/незарегистрированные или прочитанные | Возвращает незарегистрированные наборы данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/незарегистрированный/схема/чтение | Возвращает схему набора данных для незарегистрированных наборов DataSet в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/наборы данных/незарегистрированный/запись | Создает или обновляет незарегистрированные наборы данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/хранилища данных/удаление | Удаляет хранилища данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/хранилища данных/чтение | Возвращает хранилища данных в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/хранилища данных и запись | Создает или обновляет хранилища данных в Службы машинного обучения рабочих областях |
> | Действие | Microsoft.MachineLearningServices/workspaces/delete | Удаляет рабочие области служб машинного обучения. |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/конечные точки/конвейеры/чтение | Получает опубликованные конвейеры и конечные точки конвейера в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/конечные точки/конвейеры/запись | Создает или обновляет опубликованные конвейеры и конечные точки конвейера в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/среды/сборка/действие | Создает окружения в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/среды/чтение | Получение сред в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/среды/Реадсекретс/действие | Получение сред с секретами в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/среды/запись | Создает или обновляет окружения в Службы машинного обучения рабочих областях |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/Евентгридфилтерс/чтение | Получение фильтра сетки событий для определенной рабочей области |
...
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/эксперименты/запуски/чтение | Получение выполняется в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/эксперименты/запуски/Скриптрун/отправка/действие | Создает или обновляет запуски скриптов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/эксперименты/запуски/запись | Создает или обновляет запуски в Службы машинного обучения рабочих областях |
...
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/компоненты/чтение | Получение всех включенных компонентов для Службы машинного обучения рабочей области |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/метки, экспорт/действие | Экспорт меток проектов с метками в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метки/Метки/чтение | Получает метки проектов с метками в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метки/Метки/отклонить/действие | Отклонять метки проектов с метками в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метки/Метки/запись | Создает метки проектов с метками в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/метки/проекты/Удаление | Удаляет проект меток в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/метки/проекты/чтение | Получает проект меток в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/метки/проекты/сводка/чтение | Получает пометку сводки проекта в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/метки/проекты/запись | Создает или обновляет проект меток в Службы машинного обучения рабочих областях |
...
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метаданные/артефакты/удаление | Удаление артефактов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/метаданные/артефакты/чтение | Получение артефактов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метаданные/артефакты/запись | Создает или обновляет артефакты в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метаданные/секреты/удаление | Удаление секретов в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метаданные/секреты/чтение | Получение секретов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метаданные/секреты/запись | Создает или обновляет секреты в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/Метаданные/моментальные снимки/удаление | Удаление моментальных снимков в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/метаданные/моментальные снимки/чтение | Получение моментальных снимков в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/метаданные/моментальные снимки/записи | Создает или обновляет моментальные снимки в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/модели/удаление | Удаление моделей в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/модели/пакет/действие | Модели пакетов в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/модели/чтение | Получение моделей в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/модели/запись | Создает или обновляет модели в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/модули/чтение | Получение модулей в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/модули/запись | Создает или обновляет модуль в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/пипелинедрафтс/удаление | Удаление черновиков конвейера в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/пипелинедрафтс/чтение | Возвращает черновики конвейера в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/пипелинедрафтс/запись | Создает или обновляет черновики конвейера в Службы машинного обучения рабочих областях |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/Приватиндпоинтконнектионпроксиес/удаление | Удаление прокси-сервера подключения к ресурсу частной конечной точки поставщика Microsoft. Network |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/Приватиндпоинтконнектионпроксиес/чтение | Просмотр состояния прокси-сервера подключения для ресурса частной конечной точки поставщика Microsoft. Network |
> | Действие | Microsoft. Мачинелеарнингсервицес/workspaces/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверка прокси-сервера подключения для ресурса частной конечной точки поставщика Microsoft. Network |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/Приватиндпоинтконнектионпроксиес/запись | Измените состояние прокси-сервера подключения на ресурс частной конечной точки поставщика Microsoft. Network. |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/Приватиндпоинтконнектионс/удаление | Удаление подключения к ресурсу частной конечной точки поставщика Microsoft. Network |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/Приватиндпоинтконнектионс/чтение | Просмотр состояния подключения к закрытому ресурсу конечной точки поставщика Microsoft. Network |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/Приватиндпоинтконнектионс/запись | Изменение состояния подключения на ресурс частной конечной точки поставщика Microsoft. Network |
> | Действие | Microsoft. Мачинелеарнингсервицес/workspaces/Приватиндпоинтконнектионсаппровал/действие | Утверждение или отклонение подключения к закрытой конечной точке ресурса поставщика Microsoft. Network |
> | Действие | Microsoft. Мачинелеарнингсервицес/рабочие области/Привателинкресаурцес/чтение | Возвращает доступные ресурсы частной ссылки для указанного экземпляра Службы машинного обучения рабочих областей. |
> | Действие | Microsoft.MachineLearningServices/workspaces/read | Получает рабочие области служб машинного обучения. |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/службы/ACI/Delete | Удаление ACI Services в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/службы/ACI/listkeys/действие | Перечисление ключей для ACI Services в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/службы/ACI/запись | Создает или обновляет ACI Services в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/службы/AKS/devtest/удалить | Удаление devtest AKS Services в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/Services/AKS/devtest/listkeys/действие | Список ключей для devtest AKS Services в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/Services/AKS/devtest/Оценка/действие | Оценки devtest AKS Services в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/службы/AKS/devtest/запись | Создает или обновляет devtest AKS Services в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/Services/AKS/произв/Delete | Удаляет службы AKS Services в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/Services/AKS/производство/listkeys/действие | Перечисление ключей для служб AKS Services в рабочих областях Службы машинного обучения |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/Services/AKS/производство/Оценка/действие | Оценка производственных AKS Services в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/workspaces/Services/AKS/произв./запись | Создание или обновление производственных AKS Services в Службы машинного обучения рабочих областях |
> | DataAction | Microsoft. Мачинелеарнингсервицес/рабочие области/службы/чтение | Получение служб в Службы машинного обучения рабочих областях |
...
> | Действие | Microsoft. Management/Манажементграупс/потомки/чтение | Возвращает всех потомков (Группы управления, подписок) группы управления. |
...
> | Действие | Microsoft. Management/Манажементграупс/Settings/Delete | Удаляет параметры иерархии группы управления. |
> | Действие | Microsoft. Management/Манажементграупс/параметры/чтение | Выводит список существующих параметров иерархии групп управления. |
> | Действие | Microsoft. Management/Манажементграупс/параметры/запись | Создает или обновляет параметры иерархии групп управления. |
...
> | Действие | Microsoft. Migrate/ассессментпрожектс/импортколлекторс/удаление | Удаляет сборщик импорта |
> | Действие | Microsoft. Migrate/ассессментпрожектс/импортколлекторс/чтение | Возвращает свойства сборщика импорта. |
> | Действие | Microsoft. Migrate/ассессментпрожектс/импортколлекторс/запись | Создает новый сборщик импорта или обновляет существующий. |
...
> | Действие | Microsoft. Migrate/ассессментпрожектс/серверколлекторс/чтение | Возвращает свойства сборщика данных сервера. |
> | Действие | Microsoft. Migrate/ассессментпрожектс/серверколлекторс/запись | Создает новый сборщик серверов или обновляет существующий сборщик серверов. |
...
> | DataAction | Microsoft. Микседреалити/Ремотерендерингаккаунтс/преобразование/действие | Начать преобразование ресурса |
> | DataAction | Microsoft. Микседреалити/Ремотерендерингаккаунтс/преобразовать/удалить | Прерывать преобразование ресурса |
> | DataAction | Microsoft. Микседреалити/Ремотерендерингаккаунтс/преобразование/чтение | Получение свойств преобразования ресурса |
> | DataAction | Microsoft. Микседреалити/Ремотерендерингаккаунтс/диагностика/чтение | Подключение к инспектору удаленной подготовки к просмотру |
> | DataAction | Microsoft. Микседреалити/Ремотерендерингаккаунтс/манажесессионс/Action | Начать сеансы |
> | DataAction | Microsoft. Микседреалити/Ремотерендерингаккаунтс/манажесессионс/Delete | Завершение сеансов |
> | DataAction | Microsoft. Микседреалити/Ремотерендерингаккаунтс/манажесессионс/Read | Получение свойств сеанса |
> | Действие | Microsoft. Микседреалити/Ремотерендерингаккаунтс/providers/Microsoft. Insights/metricDefinitions/Read | Получение доступных метрик для Microsoft. Микседреалити/Ремотерендерингаккаунтс |
> | DataAction | Microsoft. Микседреалити/Ремотерендерингаккаунтс/Render/Read | Подключение к сеансу |
...
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/Аккаунтбаккупс/Delete | Удаляет ресурс резервной копии учетной записи. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/Аккаунтбаккупс/Read | Считывает ресурс резервной копии учетной записи. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/Аккаунтбаккупс/запись | Записывает ресурс резервной копии учетной записи. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/БаккупполиЦиес/Delete | Удаляет ресурс политики архивации. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/БаккупполиЦиес/Read | Чтение ресурса политики архивации. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/БаккупполиЦиес/запись | Записывает ресурс политики архивации. |
...
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/Volumes/Аусоризерепликатион/Action | Авторизация исходного тома репликации |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/тома/резервные копии/удаление | Удаляет ресурс резервного копирования. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/тома/резервное копирование/чтение | Считывает ресурс резервного копирования. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/тома/резервные копии/запись | Записывает ресурс резервного копирования. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/Volumes/Break/Action | Прерывание связей репликации томов |
> | Действие | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/delete | Удаление ресурса тома. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/Volumes/Делетерепликатион/Action | Удаление репликации на целевом томе |
> | Действие | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/read | Чтение ресурса тома. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/Volumes/Репликатионстатус/Action | Считывает состояние репликации тома. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/Volumes/Ресинкрепликатион/Action | Повторная синхронизация репликации на целевом томе |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/КапаЦитипулс/Volumes/revert/Action | Восстановить том до указанного моментального снимка |
...
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/СнапшотполиЦиес/Delete | Удаляет ресурс политики моментальных снимков. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/СнапшотполиЦиес/ListVolumes/действие | Список томов, подключенных к политике моментальных снимков |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/СнапшотполиЦиес/Read | Считывает ресурс политики моментальных снимков. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/СнапшотполиЦиес/запись | Записывает ресурс политики моментальных снимков. |
> | Действие | Microsoft. NetApp/Нетаппаккаунтс/хранилища/чтение | Чтение ресурса хранилища. |
...
> | Действие | Microsoft. Network/Бастионхостс/Креатешареаблелинкс/действие | Создает общие URL-адреса для виртуальных машин в бастиона и возвращает URL-адреса. |
> | Действие | Microsoft.Network/bastionHosts/delete | Удаление узла-бастиона |
> | Действие | Microsoft. Network/Бастионхостс/Делетешареаблелинкс/действие | Удаление общих URL-адресов для указанных виртуальных машин в бастиона |
> | Действие | Microsoft. Network/Бастионхостс/дисконнектактивесессионс/действие | Отключение от заданных активных сеансов на узле бастиона |
> | Действие | Microsoft. Network/Бастионхостс/жетактивесессионс/действие | Получение активных сеансов на узле бастиона |
> | Действие | Microsoft. Network/Бастионхостс/Жетшареаблелинкс/действие | Возвращает общие URL-адреса для указанных виртуальных машин в подсети бастиона, в которой созданы их URL-адреса |
...
> | Действие | Microsoft. Network/Connections/стартпаккеткаптуре/Action | Запускает запись пакетов подключения для шлюза виртуальной сети. |
> | Действие | Microsoft. Network/Connections/стоппаккеткаптуре/Action | Останавливает запись пакетов подключения для шлюза виртуальной сети. |
...
> | Действие | Microsoft. Network/ФронтдурвебаппликатионфиреваллполиЦиес/соединение/действие | Присоединяет политику брандмауэра веб-приложения. Не оповещать. |
...
> | Действие | Microsoft. Network/Ипаллокатионс/удаление | Удаляет Ипаллокатион |
> | Действие | Microsoft. Network/Ипаллокатионс/чтение | Получение Ипаллокатион |
> | Действие | Microsoft. Network/Ипаллокатионс/запись | Создает Ипаллокатион или обновляет существующий Ипаллокатион |
> | Действие | Microsoft. Network/Ипграупс/удаление | Удаляет Ипграуп |
> | Действие | Microsoft. Network/Ипграупс/соединение/действие | Присоединяется к Ипграуп. Не оповещать. |
> | Действие | Microsoft. Network/Ипграупс/чтение | Возвращает Ипграуп |
> | Действие | Microsoft. Network/Ипграупс/Упдатереференцес/действие | Обновление ссылок в Ипграуп |
> | Действие | Microsoft. Network/Ипграупс/проверка/действие | Проверяет Ипграуп |
> | Действие | Microsoft. Network/Ипграупс/запись | Создает Ипграуп или обновляет существующий Ипграупс |
...
> | Действие | Microsoft. Network/Locations/Батчнотифиприватиндпоинтсфорресаурцемове/Action | Отправляет в частную конечную точку пакеты для перемещения ресурсов. |
...
> | Действие | Microsoft. Network/networkInterfaces/Упдатепарентникаттачментонеластикник/действие | Обновляет родительский сетевой адаптер, связанный с эластичной сетевой картой. |
...
> | Действие | Microsoft. Network/Нетворкватчерс/панель/удаление | Удаляет журнал потоков |
> | Действие | Microsoft. Network/Нетворкватчерс/панель/чтение | Получение сведений о журнале потоков |
> | Действие | Microsoft. Network/Нетворкватчерс/панель/запись | Создает журнал потоков |
...
> | Действие | Microsoft. Network/p2sVpnGateways/disconnectp2svpnconnections/действие | Отключить P2S VPN-подключения |
...
> | Действие | Microsoft. Network/Приватеднсзонес/соединение/действие | Присоединяется к зоне Частная зона DNS |
...
> | Действие | Microsoft. Network/Приватиндпоинтс/Приватеднсзонеконфигс/запись | Помещает конфигурацию Частная зона DNSной зоны |
...
> | Действие | Microsoft. Network/Виртуалхубс/Еффективераутес/действие | Получение действующего маршрута, настроенного в виртуальном концентраторе |
...
> | Действие | Microsoft. Network/virtualnetworkgateways/дисконнектвиртуалнетворкгатевайвпнконнектионс/действие | Отключение VPN-подключений шлюза виртуальной сети |
...
> | Действие | Microsoft. Network/virtualnetworkgateways/стартпаккеткаптуре/действие | Запускает запись пакетов шлюза виртуальной сети. |
> | Действие | Microsoft. Network/virtualnetworkgateways/стоппаккеткаптуре/действие | Останавливает запись пакетов шлюза виртуальной сети. |
...
> | Действие | Microsoft.Network/virtualNetworks/subnets/joinViaServiceEndpoint/action | Присоединение к подсети ресурса, например учетной записи хранения или базы данных SQL. Не оповещать. |
...
> | Действие | Microsoft. Network/Виртуалраутерс/пиринг/удалить | Удаляет Виртуалраутерпиринг |
> | Действие | Microsoft. Network/Виртуалраутерс/пиринг/чтение | Получает Виртуалраутерпиринг |
> | Действие | Microsoft. Network/Виртуалраутерс/пиринг/запись | Создает Виртуалраутерпиринг или обновляет существующий Виртуалраутерпиринг |
...
> | Действие | Microsoft. Оффазуре/Хипервситес/сводка/чтение | Возвращает сводку по сайту Hyper-V. |
...
> | Действие | Microsoft. Оффазуре/Импортситес/Delete | Удаляет сайт импорта |
> | Действие | Microsoft. Оффазуре/Импортситес/експортури/Action | Возвращает универсальный код ресурса (URI) SAS для экспорта CSV-файла компьютеров. |
> | Действие | Microsoft. Оффазуре/Импортситес/импортури/Action | Возвращает универсальный код ресурса (URI) SAS для импорта CSV-файла компьютеров. |
> | Действие | Microsoft. Оффазуре/Импортситес/задания/чтение | Возвращает свойства заданий импорта. |
> | Действие | Microsoft. Оффазуре/Импортситес/Machines/Delete | Удаляет компьютер импорта |
> | Действие | Microsoft. Оффазуре/Импортситес/Machines/Read | Возвращает свойства компьютеров импорта. |
> | Действие | Microsoft. Оффазуре/Импортситес/Read | Возвращает свойства сайта импорта. |
> | Действие | Microsoft. Оффазуре/Импортситес/запись | Создает или обновляет сайт импорта |
...
> | Действие | Microsoft. Оффазуре/Серверситес/Delete | Удаляет сайт сервера. |
...
> | Действие | Microsoft. Оффазуре/Серверситес/сводка/чтение | Возвращает сводку сайта сервера. |
...
> | Действие | Microsoft. Оффазуре/Вмвареситес/Клиентграупмемберс/Action | Выводит список членов группы клиентов для выбранной клиентской группы. |
> | Действие | Microsoft.OffAzure/VMwareSites/delete | Удаляет сайт VMware. |
> | Действие | Microsoft. Оффазуре/Вмвареситес/експортаппликатионс/Action | Экспорт данных приложений и ролей VMware в XLS |
> | Действие | Microsoft. Оффазуре/Вмвареситес/Женератекоарсемап/Action | Создает грубую карту для списка компьютеров |
> | Действие | Microsoft. Оффазуре/Вмвареситес/Женератедетаиледмап/Action | Создание подробной грубой схемы VMware |
> | Действие | Microsoft. Оффазуре/Вмвареситес/приложения/действие | Возвращает сведения о приложении списка для выбранных компьютеров. |
...
> | Действие | Microsoft. Оффазуре/Вмвареситес/Machines/Applications/Read | Возвращает свойства приложений машин VMware. |
...
> | Действие | Microsoft. Оффазуре/Вмвареситес/Серверграупмемберс/Action | Выводит список членов группы серверов для выбранной группы серверов. |
> | Действие | Microsoft. Оффазуре/Вмвареситес/сводка/чтение | Возвращает сводку сайта VMware. |
> | Действие | Microsoft. Оффазуре/Вмвареситес/Упдатепропертиес/Action | Обновляет свойства компьютеров сайта |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft. operationalinsights/аваилаблесервицетиерс/Read | Получите доступные уровни служб. |
...
> | Действие | Microsoft. operationalinsights/workspaces/экспорт/удаление | Удаление конкретного экспорта данных. |
> | Действие | Microsoft. operationalinsights/рабочие области/экспорт/чтение | Получение конкретного экспорта данных. |
> | Действие | Microsoft. operationalinsights/workspaces/экспорт/запись | Создание или обновление экспорта данных. |
...
> | Действие | Microsoft. operationalinsights/рабочие области/Приватиндпоинтконнектионпроксиес/удаление | Удаление прокси-сервера подключения к частной конечной точке. |
> | Действие | Microsoft. operationalinsights/рабочие области/Приватиндпоинтконнектионпроксиес/чтение | Получение прокси-сервера подключения к частной конечной точке. |
> | Действие | Microsoft. operationalinsights/workspaces/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверка прокси-сервера подключения к частной конечной точке. |
> | Действие | Microsoft. operationalinsights/рабочие области/Приватиндпоинтконнектионпроксиес/запись | Размещение прокси-сервера подключения к частной конечной точке. |
> | Действие | Microsoft. operationalinsights/рабочие области/Приватиндпоинтконнектионс/удаление | Удаление прокси-сервера подключения к частной конечной точке. |
> | Действие | Microsoft. operationalinsights/рабочие области/Приватиндпоинтконнектионс/чтение | Получение прокси-сервера подключения к частной конечной точке. |
> | Действие | Microsoft. operationalinsights/рабочие области/Приватиндпоинтконнектионс/запись | Размещение прокси-сервера подключения к частной конечной точке. |
> | Действие | Microsoft. operationalinsights/рабочие области/Привателинкресаурцес/чтение | Получите Log Analytics ресурсы для закрытой ссылки. |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Аегделиверифаилурелогс/чтение | Чтение данных из таблицы Аегделиверифаилурелогс |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Аегпублишфаилурелогс/чтение | Чтение данных из таблицы Аегпублишфаилурелогс |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Аппсервицеаудитлогс/чтение | Чтение данных из таблицы Аппсервицеаудитлогс |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Аппсервицеконсолелогс/чтение | Чтение данных из таблицы Аппсервицеконсолелогс |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/availabilityResults/чтение | Чтение данных из таблицы availabilityResults |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Бровсертимингс/чтение | Чтение данных из таблицы Бровсертимингс |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/customEvents/чтение | Чтение данных из таблицы customEvents |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/customMetrics/чтение | Чтение данных из таблицы customMetrics |
...
> | Действие | Microsoft. OperationalInsights/рабочие области, запрос/зависимости/чтение | Чтение данных из таблицы зависимостей |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Дхкпактивити/чтение | Чтение данных из таблицы Дхкпактивити |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Функтионапплогс/чтение | Чтение данных из таблицы Функтионапплогс |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Интунедевицекомплианцеорг/чтение | Чтение данных из таблицы Интунедевицекомплианцеорг |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/ИосубдистрибутедтраЦинг/чтение | Чтение данных из таблицы ИосубдистрибутедтраЦинг |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Кубемонажентевентс/чтение | Чтение данных из таблицы Кубемонажентевентс |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Микрософтазуребастионаудитлогс/чтение | Чтение данных из таблицы Микрософтазуребастионаудитлогс |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Микрософтдаташаререцеиведснапшотлог/чтение | Чтение данных из таблицы Микрософтдаташаререцеиведснапшотлог |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Микрософтдаташаресентснапшотлог/чтение | Чтение данных из таблицы Микрософтдаташаресентснапшотлог |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Микрософтдинамикстелеметриперформанцелогс/чтение | Чтение данных из таблицы Микрософтдинамикстелеметриперформанцелогс |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Микрософтдинамикстелеметрисистемметрикслогс/чтение | Чтение данных из таблицы Микрософтдинамикстелеметрисистемметрикслогс |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/pageViews/чтение | Чтение данных из таблицы pageViews |
> | Действие | Microsoft.OperationalInsights/workspaces/query/Perf/read | Чтение данных из таблицы Perf. |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/счетчик производительности/чтение | Чтение данных из таблицы performanceCounter |
...
> | Действие | Microsoft. OperationalInsights/рабочие области, запрос/запросы на чтение | Чтение данных из таблицы запросов |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Сигналрсервицедиагностиклогс/чтение | Чтение данных из таблицы Сигналрсервицедиагностиклогс |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Сторажеблоблогс/чтение | Чтение данных из таблицы Сторажеблоблогс |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Сторажефилелогс/чтение | Чтение данных из таблицы Сторажефилелогс |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Сторажекуеуелогс/чтение | Чтение данных из таблицы Сторажекуеуелогс |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Сторажетаблелогс/чтение | Чтение данных из таблицы Сторажетаблелогс |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/systemEvents/чтение | Чтение данных из таблицы systemEvents |
...
> | Действие | Microsoft. OperationalInsights/рабочие области, запрос/трассировка/чтение | Чтение данных из таблицы трассировок |
...
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Вмкомпутер/чтение | Чтение данных из таблицы Вмкомпутер |
> | Действие | Microsoft.OperationalInsights/workspaces/query/VMConnection/read | Считывает данные из таблицы VMConnection. |
> | Действие | Microsoft. OperationalInsights/рабочие области/запрос/Вмпроцесс/чтение | Чтение данных из таблицы Вмпроцесс |
...
> | Действие | Microsoft. operationalinsights/рабочие области/Скопедпривателинкпроксиес/удаление | Удаление прокси-сервера закрытой ссылки с заданной областью. |
> | Действие | Microsoft. operationalinsights/рабочие области/Скопедпривателинкпроксиес/чтение | Получить прокси-сервер закрытой ссылки с областью действия. |
> | Действие | Microsoft. operationalinsights/рабочие области/Скопедпривателинкпроксиес/запись | Установите прокси-сервер закрытой ссылки с заданной областью. |
> | Действие | Microsoft.OperationalInsights/workspaces/search/action | Выполняет поисковый запрос. |
> | Действие | microsoft.operationalinsights/workspaces/search/read | Получение результатов поиска. Устаревшее. |
...
> | Действие | Microsoft. Полициинсигхтс/Полициметадата/Read | Получение ресурсов метаданных политики. |
...
> | Действие | Microsoft. recoveryservices/Locations/Баккуппревалидатепротектион/Action |  |
...
> | Действие | Microsoft. recoveryservices/Locations/Баккупстатус/Action | Проверка состояния архивации хранилищ служб восстановления. |
> | Действие | Microsoft. recoveryservices/Locations/Баккупвалидатефеатурес/Action | Проверка компонентов. |
...
> | Действие | Microsoft. recoveryservices/хранилища/баккупконфиг/чтение | Возвращает конфигурацию хранилища служб восстановления. |
> | Действие | Microsoft. recoveryservices/Vault/баккупконфиг/запись | Обновляет конфигурацию хранилища служб восстановления. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупенкриптионконфигс/чтение | Возвращает конфигурацию шифрования ресурсов резервной копии. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупенкриптионконфигс/запись | Обновляет конфигурацию шифрования ресурсов резервных копий |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупенгинес/чтение | Возвращение всех серверов управления архивацией, зарегистрированных в хранилище. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Баккуппротектионинтент/удалить | Удаление цели защиты для резервного копирования. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупфабрикс/Баккуппротектионинтент/чтение | Получение цели защиты для резервного копирования. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Баккуппротектионинтент/запись | Создание цели защиты для резервной копии. |
...
> | Действие | Microsoft. recoveryservices/хранилища/Баккупфабрикс/Протектаблеконтаинерс/чтение | Получение всех защищаемых контейнеров. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/удалить | Удаление зарегистрированного контейнера. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/запрос/действие | Запрос рабочих нагрузок в контейнере. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/элементы/чтение | Получение всех элементов в контейнере. |
...
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/резервное копирование/действие | Архивирует защищенный элемент. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/Delete | Удаляет защищенный элемент. |
...
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/Оператионсстатус/чтение | Возвращает состояние операции, выполненной с защищенными элементами. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/чтение | Возвращает сведения об объекте для защищенного элемента. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/Рековерипоинтс/Провисионинстантитемрековери/действие | Подготавливает мгновенное восстановление для защищенного элемента. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/Рековерипоинтс/чтение | Возвращает точки восстановления для защищенных элементов. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/Рековерипоинтс/Restore/Action | Восстанавливает точки восстановления для защищенных элементов. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/Рековерипоинтс/Ревокеинстантитемрековери/действие | Отменяет мгновенное восстановление для защищенного элемента. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/Протектедитемс/запись | Создает элемент, защищенный службой архивации. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупфабрикс/Протектионконтаинерс/чтение | Возвращает все зарегистрированные контейнеры. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Протектионконтаинерс/запись | Создание зарегистрированного контейнера. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупфабрикс/Рефрешконтаинерс/действие | Обновляет список контейнеров. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупжобс/отмена/действие | Отменяет задание. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупжобс/Оператионресултс/чтение | Возвращает результат операции задания. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупжобс/Оператионсстатус/чтение | Возвращает состояние операции задания. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупжобс/чтение | Возвращает все объекты заданий. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупжобсекспорт/действие | Экспортирует задания. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупоператионресултс/чтение | Возвращает результат операции архивации для хранилища служб восстановления. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупоператионс/чтение | Возвращает состояние операции архивации для хранилища служб восстановления. |
> | Действие | Microsoft. recoveryservices/хранилища/БаккупполиЦиес/удаление | Удаляет политику защиты. |
> | Действие | Microsoft. recoveryservices/хранилища/БаккупполиЦиес/Оператионресултс/чтение | Возвращает результаты операции политики. |
> | Действие | Microsoft. recoveryservices/Vault/БаккупполиЦиес/операции/чтение | Возвращает состояние операции политики. |
> | Действие | Microsoft. recoveryservices/хранилища/БаккупполиЦиес/чтение | Возвращает все политики защиты. |
> | Действие | Microsoft. recoveryservices/Vault/БаккупполиЦиес/запись | Создает политику защиты. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккуппротектаблеитемс/чтение | Возвращает список всех защищаемых элементов. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккуппротектедитемс/чтение | Возвращает список всех защищенных элементов. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккуппротектионконтаинерс/чтение | Возвращает все контейнеры, принадлежащие подписке. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккуппротектионинтентс/чтение | Вывод списка всех целей защиты для резервного копирования. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупсекуритипин/действие | Возвращает данные ПИН-кода безопасности для хранилища служб восстановления. |
> | Действие | Microsoft. recoveryservices/хранилища/баккупсторажеконфиг/чтение | Возвращает конфигурацию службы хранилища для хранилища служб восстановления. |
> | Действие | Microsoft. recoveryservices/Vault/баккупсторажеконфиг/запись | Обновляет конфигурацию службы хранилища для хранилища служб восстановления. |
> | Действие | Microsoft. recoveryservices/хранилища/Баккупусажесуммариес/чтение | Возвращает сводки по защищенным элементам и защищенным серверам для служб восстановления. |
> | Действие | Microsoft. recoveryservices/Vault/Баккупвалидатеоператион/действие | Проверка операций для защищенного элемента |
...
> | Действие | Microsoft. RecoveryServices/Vault/Репликатионфабрикс/Репликатионпротектионконтаинерс/Репликатионмигратионитемс/повторная синхронизация/действие | Повторно синхронизировать |
...
> | Действие | Microsoft. RecoveryServices/хранилища/Репликатионоператионстатус/чтение | Чтение состояния операции репликации хранилища |
...
> | Действие | Microsoft. recoveryservices/хранилища/использование/чтение | Возвращает данные об использовании хранилища служб восстановления. |
...
> | Действие | Microsoft. Relay/пространства имен/нетворкрулесетс/чтение | Получает ресурс Нетворкрулесет |
> | Действие | Microsoft. Relay/пространства имен/нетворкрулесетс/запись | Создание ресурса правила виртуальной сети |
...
> | Действие | Microsoft. Ресаурцехеалс/уведомления/чтение | Получение уведомлений Azure Resource Manager |
...
> | Действие | Microsoft. Resources/Чеккполицикомплианце/Read | Проверка состояния соответствия политикам для указанного ресурса. |
...
> | Действие | Microsoft. Resources/deploymentScripts/Delete | Удаляет скрипт развертывания. |
> | Действие | Microsoft. Resources/deploymentScripts/журналы/чтение | Возвращает или приводит список журналов скрипта развертывания. |
> | Действие | Microsoft. Resources/deploymentScripts/Read | Получает или перечисляет скрипты развертывания. |
> | Действие | Microsoft. Resources/deploymentScripts/Write | Создает или обновляет скрипт развертывания. |
...
> | Действие | Microsoft. Search, Сеарчсервицес/Приватиндпоинтконнектионпроксиес/Delete | Удаляет существующий прокси-сервер подключения частной конечной точки. |
> | Действие | Microsoft. Search/Сеарчсервицес/Приватиндпоинтконнектионпроксиес/чтение | Возвращает список прокси-серверов подключения частной конечной точки или получает свойства для указанного прокси подключения частной конечной точки. |
> | Действие | Microsoft. Search/Сеарчсервицес/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверяет подключение к частной конечной точке создать вызов с NRP стороны |
> | Действие | Microsoft. Search/Сеарчсервицес/Приватиндпоинтконнектионпроксиес/запись | Создает прокси-сервер подключения частной конечной точки с указанными параметрами или обновляет свойства или теги для указанного прокси-сервера подключения частной конечной точки. |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft. Секуритинсигхтс/агрегаты/чтение | Возвращает агрегированные сведения |
> | Действие | Microsoft. Секуритинсигхтс/alertRules/Actions/Delete | Удаляет действия ответа для правила генерации оповещений. |
> | Действие | Microsoft. Секуритинсигхтс/alertRules/Actions/Read | Возвращает действия ответа для правила генерации оповещений. |
> | Действие | Microsoft. Секуритинсигхтс/alertRules/Actions/Write | Обновляет действия ответа правила генерации оповещений. |
> | Действие | Microsoft. Секуритинсигхтс/alertRules/Delete | Удаление правил генерации оповещений |
> | Действие | Microsoft. Секуритинсигхтс/alertRules/Read | Возвращает правила оповещений. |
> | Действие | Microsoft. Секуритинсигхтс/alertRules/запись | Обновляет правила генерации оповещений |
> | Действие | Microsoft. Секуритинсигхтс/закладки/удалить | Удаляет закладки |
> | Действие | Microsoft. Секуритинсигхтс/закладки/развертывание/действие | Получение связанных сущностей сущности с помощью определенного расширения |
> | Действие | Microsoft. Секуритинсигхтс/закладки/чтение | Получение закладок |
> | Действие | Microsoft. Секуритинсигхтс/закладки/запись | Обновления закладок |
> | Действие | Microsoft. Секуритинсигхтс/cases/Comments/Read | Получает комментарии к вариантам. |
> | Действие | Microsoft. Секуритинсигхтс/cases/Comments/Write | Создает комментарии к вариантам |
> | Действие | Microsoft. Секуритинсигхтс/cases/Delete | Удаление варианта |
> | Действие | Microsoft. Секуритинсигхтс/cases/расследования/чтение | Получение исследований вариантов |
> | Действие | Microsoft. Секуритинсигхтс/cases/расследования/запись | Обновляет метаданные варианта |
> | Действие | Microsoft. Секуритинсигхтс/cases/Read | Возвращает вариант |
> | Действие | Microsoft. Секуритинсигхтс/cases/Write | Обновляет вариант |
> | Действие | Microsoft. Секуритинсигхтс/Connects/Delete | Удаляет соединитель данных. |
> | Действие | Microsoft. Секуритинсигхтс/Connects/Read | Возвращает соединители данных. |
> | Действие | Microsoft. Секуритинсигхтс/Connects/Write | Обновляет соединитель данных |
> | Действие | Microsoft. Секуритинсигхтс/инциденты/комментарии/чтение | Возвращает комментарии инцидента. |
> | Действие | Microsoft. Секуритинсигхтс/инциденты/комментарии/запись | Создает комментарий к инциденту |
> | Действие | Microsoft. Секуритинсигхтс/инциденты/удаление | Удаляет инцидент. |
> | Действие | Microsoft. Секуритинсигхтс/инциденты/чтение | Получение инцидента |
> | Действие | Microsoft. Секуритинсигхтс/инциденты/связи/удаление | Удаление отношения между инцидентом и связанными ресурсами |
> | Действие | Microsoft. Секуритинсигхтс/инциденты/отношения/чтение | Возвращает отношение между инцидентом и связанными ресурсами. |
> | Действие | Microsoft. Секуритинсигхтс/инциденты/связи/запись | Обновляет отношение между инцидентом и связанными ресурсами |
> | Действие | Microsoft. Секуритинсигхтс/инциденты/запись | Обновляет инцидент |
> | Действие | Microsoft. Секуритинсигхтс/Register/действие | Регистрация подписки в Azure Sentinel |
> | Действие | Microsoft. Секуритинсигхтс/параметры/чтение | Получение параметров |
> | Действие | Microsoft. Секуритинсигхтс/параметры/запись | Параметры обновлений |
...
> | Действие | Microsoft.SignalRService/locations/operationresults/signalr/read | Запрос результата асинхронной операции на основе расположения |
> | Действие | Microsoft. Сигналрсервице/Locations/Оператионстатусес/идентификатор операции чтения | Запрос состояния асинхронной операции на основе расположения |
...
> | Действие | Microsoft. Сигналрсервице/SignalR/Приватиндпоинтконнектионпроксиес/Delete | Удаление прокси-сервера подключения частной конечной точки |
> | Действие | Microsoft. Сигналрсервице/SignalR/Приватиндпоинтконнектионпроксиес/Read | Чтение прокси-сервера частной конечной точки Коннетион |
> | Действие | Microsoft. Сигналрсервице/SignalR/Приватиндпоинтконнектионпроксиес/проверка/действие | Проверка прокси-сервера подключения частной конечной точки |
> | Действие | Microsoft. Сигналрсервице/SignalR/Приватиндпоинтконнектионпроксиес/запись | Создание прокси-сервера подключения частной конечной точки |
> | Действие | Microsoft. Сигналрсервице/SignalR/Приватиндпоинтконнектионс/Read | Чтение подключения к частной конечной точке |
> | Действие | Microsoft. Сигналрсервице/SignalR/Приватиндпоинтконнектионс/запись | Утверждение или отклонение подключения к частной конечной точке |
> | Действие | Microsoft. Сигналрсервице/SignalR/Привателинкресаурцес/Read | Список всех ресурсов закрытой ссылки SignalR |
...
> | Действие | Microsoft. SQL/Locations/Лонгтермретентионманажединстанцебаккупс/Read | Возвращает список резервных копий управляемого экземпляра LTR для определенного расположения  |
> | Действие | Microsoft. SQL/Locations/Лонгтермретентионманажединстанцес/Лонгтермретентиондатабасес/Лонгтермретентионманажединстанцебаккупс/Delete | Удаляет резервную копию LTR для базы данных управляемого экземпляра |
> | Действие | Microsoft. SQL/Locations/Лонгтермретентионманажединстанцес/Лонгтермретентиондатабасес/Лонгтермретентионманажединстанцебаккупс/Read | Возвращает список резервных копий LTR для базы данных управляемого экземпляра. |
> | Действие | Microsoft. SQL/Locations/Лонгтермретентионманажединстанцес/Лонгтермретентионманажединстанцебаккупс/Read | Возвращает список резервных копий управляемого экземпляра LTR для конкретного управляемого экземпляра |
...
> | Действие | Microsoft. SQL/Locations/Манажединстанцелонгтермретентионполициазуреасинкоператион/Read | Возвращает состояние операции политики долгосрочного хранения для управляемой базы данных. |
> | Действие | Microsoft. SQL/Locations/Манажединстанцелонгтермретентионполициоператионресултс/Read | Возвращает состояние операции политики долгосрочного хранения для управляемой базы данных. |
> | Действие | Microsoft. SQL/Locations/Манажедшорттермретентионполициоператионресултс/Read | Возвращает состояние операции политики краткосрочного хранения. |
...
> | Действие | Microsoft. SQL/Locations/Серверадминистраторазуреасинкоператион/Read | Результаты асинхронной операции администратора сервера Azure Active Directory |
> | Действие | Microsoft. SQL/Locations/Серверадминистратороператионресултс/Read | Результаты операции администратора сервера Azure Active Directory |
...
> | Действие | Microsoft. SQL/Locations/Шорттермретентионполициоператионресултс/Read | Возвращает состояние операции политики краткосрочного хранения. |
...
> | Действие | Microsoft. SQL/Locations/Транспарентдатаенкриптионазуреасинкоператион/Read | Получает выполняющиеся операции с прозрачным шифрованием данных в логической базе данных |
> | Действие | Microsoft. SQL/Locations/Транспарентдатаенкриптионоператионресултс/Read | Получает выполняющиеся операции с прозрачным шифрованием данных в логической базе данных |
...
> | Действие | Microsoft. SQL/Манажединстанцес/databases/БаккуплонгтермретентионполиЦиес/Read | Получение политики долгосрочного хранения для управляемой базы данных. |
> | Действие | Microsoft. SQL/Манажединстанцес/databases/БаккуплонгтермретентионполиЦиес/Write | Обновляет политику долгосрочного хранения для управляемой базы данных. |
...
> | Действие | Microsoft. SQL/Манажединстанцес/databases/Комплетересторе/Action | Завершение операции восстановления управляемой базы данных. |
...
> | Действие | Microsoft. SQL/Манажединстанцес/базы данных/схемы/чтение | Получение схемы управляемой базы данных. (только схема) |
> | Действие | Microsoft. SQL/Манажединстанцес/базы данных, схемы, таблицы, столбцы и чтение | Получить столбец управляемой базы данных (только схема) |
...
> | Действие | Microsoft. SQL/Манажединстанцес/базы данных/схемы/таблицы/чтение | Получение таблицы управляемой базы данных (только схема) |
...
> | Действие | Microsoft. SQL/Манажединстанцес/Инакцессиблеманажеддатабасес/Read | Возвращает список недоступных управляемых баз данных в управляемом экземпляре. |
...
> | Действие | Microsoft. SQL/Манажединстанцес/операции/отмена/действие | Отмена незавершенной асинхронной операции Azure SQL Управляемый экземпляр, которая еще не завершена. |
> | Действие | Microsoft. SQL/Манажединстанцес/операции/чтение | Получение операций с управляемым экземпляром |
...
> | Действие | Microsoft. SQL/Servers/databases/Extensions/Импортекстенсионоператионресултс/Read | Получает выполняющиеся операции импорта |
...
> | Действие | Microsoft.Sql/servers/databases/schemas/read | Получение схемы базы данных (только схема). |
> | Действие | Microsoft.Sql/servers/databases/schemas/tables/columns/read | Получение столбца базы данных (только схема). |
...
> | Действие | Microsoft.Sql/servers/databases/schemas/tables/read | Получение таблицы базы данных (только схема). |
...
> | Действие | Microsoft.Sql/servers/databases/transparentDataEncryption/read | Получение сведений о прозрачное шифрование данных логических баз данных в заданной управляемой базе данных |
> | Действие | Microsoft.Sql/servers/databases/transparentDataEncryption/write | Изменение прозрачное шифрование данных базы данных для заданной логической базы данных |
...
> | Действие | Microsoft. SQL/Servers/databases/Ворклоадграупс/Delete | Удаляет определенную группу рабочей нагрузки. |
> | Действие | Microsoft. SQL/Servers/databases/Ворклоадграупс/Read | Выводит список групп рабочей нагрузки для выбранной базы данных. |
> | Действие | Microsoft. SQL/Servers/databases/Ворклоадграупс/Ворклоадклассифиерс/Delete | Удаляет конкретный классификатор рабочей нагрузки. |
> | Действие | Microsoft. SQL/Servers/databases/Ворклоадграупс/Ворклоадклассифиерс/Read | Выводит список классификаторов рабочей нагрузки для выбранной базы данных. |
> | Действие | Microsoft. SQL/Servers/databases/Ворклоадграупс/Ворклоадклассифиерс/Write | Задает свойства для конкретного классификатора рабочей нагрузки. |
> | Действие | Microsoft. SQL/Servers/databases/Ворклоадграупс/Write | Задает свойства для определенной группы рабочей нагрузки. |
...
> | Действие | Microsoft. SQL/Servers/Дисаблеазуреадонляусентикатион/действие | Отключить проверку подлинности Azure Active Directory только на логическом сервере |
...
> | Действие | Microsoft. SQL/Servers/Инакцессибледатабасес/Read | Возврат списка недоступных баз данных на логическом сервере. |
...
> | Действие | Microsoft. SQL/Servers/Operations/Read | Возврат списка операций, выполненных на сервере |
...
> | Тип действия | Операция | Описание |
> | --- | --- | --- |
> | Действие | Microsoft. Склвиртуалмачине/Locations/Аваилабилитиграуплистенероператионресултс/Read | Получение результата операции прослушивателя группы доступности |
...
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинеграупс/Аваилабилитиграуплистенерс/Delete | Удалить существующий прослушиватель группы доступности |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинеграупс/Аваилабилитиграуплистенерс/Read | Получение сведений о прослушивателе группы доступности SQL в заданной группе виртуальных машин SQL |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинеграупс/Аваилабилитиграуплистенерс/запись | Создание нового или изменение свойств существующего прослушивателя группы доступности SQL |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинеграупс/Delete | Удалить существующую группу виртуальных машин SQL |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинеграупс/Read | Дополнительные сведения о группе виртуальных машин SQL |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинеграупс/Склвиртуалмачинес/Read | Вывод списка виртуальных машин SQL по определенной группе виртуальных машин SQL |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинеграупс/запись | Создание нового или изменение свойств существующей группы виртуальных машин SQL |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинес/Delete | Удалить существующую виртуальную машину SQL |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинес/Read | Получение сведений о виртуальной машине SQL |
> | Действие | Microsoft. Склвиртуалмачине/Склвиртуалмачинес/запись | Создание нового или изменение свойств существующей виртуальной машины SQL |
...
> | DataAction | Microsoft. Storage/storageAccounts/Блобсервицес/Containers/blobs/Делетеблобверсион/Action | Возвращает результат удаления версии BLOB-объекта |
...
> | DataAction | Microsoft. Storage/storageAccounts/Блобсервицес/Containers/blobs/Манажеовнершип/Action | Изменение владельца большого двоичного объекта |
> | DataAction | Microsoft. Storage/storageAccounts/Блобсервицес/Containers/blobs/Модифипермиссионс/Action | Изменяет разрешения большого двоичного объекта |
> | DataAction | Microsoft. Storage/storageAccounts/Блобсервицес/контейнеры/BLOB-объекты/перемещение/действие | Перемещает большой двоичный объект из одного пути в другой |
...
> | Действие | Microsoft. Storage, storageAccounts/ДаташареполиЦиес/Delete |  |
> | Действие | Microsoft. Storage, storageAccounts/ДаташареполиЦиес/Read |  |
> | Действие | Microsoft. Storage, storageAccounts/ДаташареполиЦиес/Read |  |
> | Действие | Microsoft. Storage/storageAccounts/ДаташареполиЦиес/запись |  |
...
> | Действие | Microsoft. Storage/storageAccounts/Филесервицес/shares/Action |  |
...
> | Действие | Microsoft. storagesync/Сторажесинксервицес/Синкграупс/Клаудендпоинтс/Тригжерчанжедетектион/Action | Вызовите это действие, чтобы активировать обнаружение изменений в общей папке облачной конечной точки. |
...
> | Действие | Microsoft.StorSimple/managers/devices/download/action | Скачивание обновлений для устройства. |
...
> | Действие | Microsoft. StreamAnalytics/стреамингжобс/Публишеджепаккаже/Action | Опубликовать пакет пограничных пакетов для задания Stream Analytics |
> | Действие | Microsoft.StreamAnalytics/streamingjobs/Read | Считывает задание Stream Analytics. |
> | Действие | Microsoft. StreamAnalytics/стреамингжобс/Scale/действие | Задание масштабирования Stream Analytics |
...
> | Действие | Microsoft. support/оператионресултс/чтение | Получение результата операции. |
> | Действие | Microsoft. support/Operations/Read | Содержит список операций, доступных в поставщике ресурсов Microsoft. support. |
> | Действие | Microsoft. support/оператионсстатус/чтение | Получение состояния операции |
> | Действие | Microsoft.Support/register/action | Регистрирует поставщик ресурсов поддержки |
> | Действие | Microsoft. Support/Services/Проблемклассификатионс/чтение | Возвращает список классификаций проблем, доступных для службы Azure. |
> | Действие | Microsoft. Support/Services/чтение | Получение списка служб Azure, доступных для поддержки |
> | Действие | Microsoft. support/Суппорттиккетс/связь/чтение | Возвращает список обмена сообщениями в службу поддержки. |
> | Действие | Microsoft. support/Суппорттиккетс/связь/запись | Создание связи с запросом в службу поддержки |
> | Действие | Microsoft.Support/supportTickets/read | Возвращает список билетов в службу поддержки. |
> | Действие | Microsoft.Support/supportTickets/write | Создает запрос в службу поддержки асинхронно или обновляет его. Можно создавать запросы в службу поддержки по техническим проблемам, а также проблемам, связанным с выставлением счетов, квотами или управлением подписками. Вы можете обновить уровень серьезности и контактные данные для существующих билетов на службу поддержки. |
...
> | Действие | Microsoft.VisualStudio/Project/Delete | Удалить проект |
...
> | Действие | Microsoft. Web/hostingEnvironments/Евентгридфилтерс/Delete | Удаление фильтра сетки событий в среде размещения. |
> | Действие | Microsoft. Web/hostingEnvironments/Евентгридфилтерс/Read | Получение фильтра сетки событий в среде размещения. |
> | Действие | Microsoft. Web/hostingEnvironments/Евентгридфилтерс/Write | Добавьте фильтр сетки событий в среде размещения. |
...
> | Действие | Microsoft. Web/Sites/слоты/расширения/чтение | Возвращает расширения слотов веб-приложений. |
> | Действие | Microsoft. Web/Sites/слоты/расширения/запись | Обновите расширения слотов веб-приложений. |
