...
2. Последовательно выберите **Управление затратами + выставление счетов** > **Управление затратами**.
3. В разделе **Параметры**выберите **облачные соединители (Предварительная версия)** .  
    ![Example, отображающая параметр Cloud Connectors (Предварительная версия)) ](./media/aws-integration-setup-configure/cloud-connectors-preview01.png).
...
5. На странице **Создание СОЕДИНИТЕЛЯ AWS** в поле **Отображаемое имя**введите имя соединителя.  
    ![Example страницы для создания AWS Connector @ no__t-1
