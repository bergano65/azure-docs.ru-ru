...
![Example отображение затрат для всех клиентов ](./media/get-started-partners/customer-costs1.png)

Ниже приведен пример, демонстрирующий затраты для одного клиента.
![Example отображение затрат для одного клиента ](./media/get-started-partners/customer-costs2.png)
...
![Policy, чтобы разрешить клиентам просматривать оплату с оплатой по мере использования ](./media/get-started-partners/cost-management-billing-policies.png)
