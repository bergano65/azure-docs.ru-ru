...
|**Область**|**Определена по адресу**|**Необходимый уровень доступа для анализа затрат на область**|**Предварительные требования по параметрам EA**|**Объединяет данные выставления счетов в**|
|---                |---                  |---                   |---            |---           |
...
|Учетная запись регистрации<sup>2</sup2>|[https://ea.azure.com ](https://ea.azure.com )|Владелец учетной записи|Возможность просмотра затрат для владельца учетной записи включена|Все подписки из учетной записи регистрации|
...
<sup>1</sup>Учетную запись выставления счетов часто называют Соглашением Enterprise или Соглашением о регистрации.

<sup>2</sup>Учетную запись регистрации часто называют владельцем учетной записи.
