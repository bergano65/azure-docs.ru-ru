...
Функция анализа затрат доступна для всех клиентов с [соглашением Enterprise (EA)](https://azure.microsoft.com/pricing/enterprise-agreement/). Для просмотра данных о расходах вы должны по крайней мере иметь доступ на чтение к одной или нескольким следующим областям.

- Область *учетной записи выставления счетов* определена по ссылке https://ea.azure.com и ей необходим доступ администратора организации. Нет никаких предварительных требований по параметрам EA. Сведения о выставлении счетов в анализе затрат разделены для всех подписок в Соглашении Enterprise. Учетную запись выставления счетов часто называют *Соглашением Enterprise* или *Соглашением о регистрации*.

- Область *отдела* определена по ссылке https://ea.azure.com и ей необходим доступ администратора отдела. Необходимо также включить параметр **DA view charges** (Возможность просмотра затрат для администратора отдела) на портале EA. Сведения о выставлении счетов в анализе затрат разделены для всех подписок, принадлежащих учетной записи регистрации, которые связаны с отделом.

- Область *учетной записи регистрации* определена по ссылке https://ea.azure.com и ей необходим доступ владельца учетной записи. Необходимо также включение параметра**Возможность просмотра затрат для владельца учетной записи** на портале EA. Сведения о выставлении счетов в анализе затрат разделены для всех подписок, принадлежащих учетной записи регистрации. Учетную запись регистрации часто называют *владельцем учетной записи*.

- Область *группы управления* определена по ссылке https://portal.azure.com и ей требуется доступ читателя службы "Управление затратами" (или читателя). Необходимо также включение параметра**Возможность просмотра затрат для владельца учетной записи** на портале EA. Сведения о выставлении счетов в анализе затрат разделены для всех подписок, принадлежащих группе управления.

- Область *подписки* определена по ссылке https://portal.azure.com и ей требуется доступ читателя службы "Управление затратами" (или читателя). Необходимо также включение параметра**Возможность просмотра затрат для владельца учетной записи** на портале EA. Сведения о выставлении счетов в анализе затрат разделены для всех групп ресурсов и ресурсов в подписке.

- Область *группы ресурсов* определена по ссылке https://portal.azure.com и ей требуется доступ читателя службы "Управление затратами" (или читателя). Необходимо также включение параметра**Возможность просмотра затрат для владельца учетной записи** на портале EA. Сведения о выставлении счетов в анализе затрат разделены для всех ресурсов в группе ресурсов.



Дополнительные сведения о настройке параметров **DA view charges** (Возможность просмотра затрат для владельца учетной записи) и **AO view charges** (Возможность просмотра затрат для администратора отдела) см. в разделе [Включение доступа к затратам](../billing/billing-enterprise-mgmt-grp-troubleshoot-cost-view.md#enabling-access-to-costs).
...
При группировании затрат по определенным атрибутам первые десять основных факторов затрат будут отображаться в порядке убывания. При наличии более десяти групп отображаются первые девять основных факторов затрат, а также группа **Другие**, которая охватывают не уместившиеся группы.

*Классические* (Управление службами Azure или ASM) виртуальные машины, сетевые ресурсы и ресурсы хранения не предоставляют детальную информацию о данных выставления счетов. При группировании затрат они объединяются в группу **Classic services** (Классические службы).
