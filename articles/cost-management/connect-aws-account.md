...
6. На странице отзывов проверьте выбранные параметры и укажите **имя роли**. For example, *Azure-Cost-Mgt*. Enter a **Role description**. Например, _Назначение ролей для Cloudyn_, затем щелкните **Create role** (Создать роль).
