...
Например, вам может потребоваться отслеживать процент используемой памяти и загрузки ЦП виртуальных машин Azure. Метрики виртуальной Машины Azure соответствуют _загрузка ЦП_ и _\Memory\% % использования_.
...
Стандартные метрики являются метриками главного компьютера. _Загрузка ЦП_ метрика — это один из примеров. Существуют также базовые метрики для гостевых виртуальных машин, которые также называются расширенными метриками. Примеры расширенных метрик _\Memory\% % использования_ и _\Memory\Available байт_.
