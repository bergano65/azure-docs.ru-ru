...
В отличие от областей выставления счетов EA, счета для клиентских соглашений привязаны к одному каталогу и не могут иметь подписки на несколько каталогов Azure AD.
