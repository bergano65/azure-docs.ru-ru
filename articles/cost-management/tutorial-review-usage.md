...
Управление затратами Azure также предоставляет рекомендации по снижению затрат на службы Azure. См. [рекомендации по оптимизации затрат](tutorial-acm-opt-recommendations.md).
