...
5. Приведенная ниже политика позволяет сохранить отчет в контейнер S3. Copy and paste the following policy example to the **JSON** tab. Replace &lt;bucketname&gt; with your bucket name.
