...
When completed, your budget is shown in most Cost reports under **Costs** &gt; **Cost Analysis** and in the Cost vs. Budget Over Time report. С помощью действий в разделе **Действия** можно также запланировать отчеты на основе достижения пороговых значений.
