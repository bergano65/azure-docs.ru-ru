...
| **Планы поддержки** | Планы поддержки для Германии | MS-AZR-DE-0043P |
| **Планы поддержки** | Поддержка Standard Azure для государственных организаций | MS-AZR-USGOV-0041P |
| **Планы поддержки** | Профессиональная прямая поддержка в Azure для государственных организаций | MS-AZR-USGOV-0042P |
| **Планы поддержки** | Поддержка Developer для Azure для государственных организаций | MS-AZR-USGOV-0043P |

Для клиентов с оплатой по мере использования, с категорией предложения MSDN и Visual Studio данные будут доступны в службе "Управление затратами", начиная с 10 февраля 2018 г.
...
Данные о затратах и потреблении доступны в службе "Управление затратами", а счета выставляются на портале Azure и в [поддерживаемых API](https://aka.ms/costmgmt/docs). Помните о следующих моментах при проверке затрат:
