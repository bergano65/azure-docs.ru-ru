...
![Новая задача экспорта: тип экспорта](./media/tutorial-export-acm-data/basics_exports.png)
...
![Новая задача экспорта: хранилище](./media/tutorial-export-acm-data/storage_exports.png)
