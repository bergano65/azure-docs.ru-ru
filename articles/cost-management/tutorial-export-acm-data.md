...
ms.locfileid: "59496800"
---
# <a name="tutorial-create-and-manage-exported-data"></a>Руководство по Создание задачи для экспорта данных и управление экспортированными данными
...
Чтобы создать или запланировать операцию экспорта либо же просмотреть сведения о ней, откройте требуемую область на портале Azure и выберите в меню **Анализ затрат**. Например, перейдите к разделу **Подписки**, выберите подписку из списка и щелкните в меню **Анализ затрат**. В верхней части страницы анализа затрат щелкните **Экспорт** и выберите параметр экспорта. Например, щелкните **Запланировать экспорт**. См. [основные сведения об областях и работе с ними](understand-work-scopes.md).

Щелкните **Добавить**, введите имя для задачи экспорта и выберите параметр **Daily export of month-to-date cost** (Ежедневный экспорт затрат за текущий месяц). Щелкните **Далее**.
...
Запланированный экспорт зависит от времени и дня недели, когда изначально был создан экспорт. При создании запланированного экспорта он выполняется в одно и то же время дня для каждого последующего выхода экспорта. Например, вы создаете ежедневный экспорт в 13:00. Следующий экспорт выполняется в 13:00 следующего дня. Текущее время влияет на все остальные типы экспорта таким же образом. Они всегда выполняются в одно и то же время суток, что и при первоначальном создании экспорта. В другом примере вы создаете еженедельный экспорт в понедельник в 16:00. Следующий отчет выполняется в 16:00 следующего понедельника. *Экспортированные данные будут доступны в течение четырех часов после запуска.*

Каждый экспорт создает новый файл, поэтому старые экспорты не перезаписываются.

Существует три типа параметров экспорта.
...
**Еженедельный экспорт расходов за последние семь дней**. Первоначальный экспорт выполняется немедленно. Последующий экспорт выполняется в то же время, что и первоначальный. Затраты за последние семь дней.
