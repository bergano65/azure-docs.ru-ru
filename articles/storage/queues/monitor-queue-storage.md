...
Начните с [мониторинга ресурсов Azure с Azure Monitor](../../azure-monitor/insights/monitor-azure-resource.md) , которые описывают следующее:
...
Описание каждого параметра см. [в разделе архивирование журналов ресурсов с помощью Azure CLI](../../azure-monitor/platform/resource-logs.md#send-to-azure-storage).
...
Описание каждого параметра см. [в статье потоковая передача данных в концентраторы событий с помощью Azure CLI](../../azure-monitor/platform/resource-logs.md#send-to-azure-event-hubs).
...
Ниже приведены некоторые запросы, которые можно ввести на панели **поиска журналов** , чтобы упростить мониторинг очередей. Эти запросы поддерживают [новый язык](../../azure-monitor/log-query/log-query-overview.md).
