...
В этой таблице показаны [метрики хранилища очередей](/azure/azure-monitor/platform/metrics-supported#microsoftstoragestorageaccountsqueueservices).
