...
1. Создайте файл с именем **composer.js** в корневом каталоге проекта и добавьте в него следующий код:
