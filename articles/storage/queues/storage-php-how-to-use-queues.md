---
title: Как использовать хранилище очередей от PHP - Azure Storage
...
В этом руководстве используются функции службы хранения очереди, которые можно вызывать в локальном приложении PHP или в коде, работаемом в веб-приложении Azure.
...
1. Создайте файл под названием **composer.json** в корне проекта и добавьте в него следующий код:
