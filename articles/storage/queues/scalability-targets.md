...
description: Сведения о целевых показателях масштабируемости и производительности для хранилища очередей.
services: storage
author: tamram
ms.service: storage
ms.topic: conceptual
...
## <a name="scale-targets-for-queue-storage"></a>Целевые объекты масштабирования для хранилища очередей
