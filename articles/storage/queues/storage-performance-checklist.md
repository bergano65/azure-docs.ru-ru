...
См. сведения о [целевых показателях масштабируемости службы хранилища Azure для Службы очередей](./scalability-targets.md#scale-targets-for-queue-storage).
