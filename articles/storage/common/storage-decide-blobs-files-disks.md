...
|Специальные возможности|Интерфейсы API REST|Интерфейсы API REST<br /><br /> SMB 2.1 и SMB 3.0 (стандартные API файловой системы)|  
...
|Библиотеки клиента|Несколько языков|Несколько языков|  
...
|`Scope`|Только отдельная виртуальная машина|Совместное использование несколькими виртуальными машинами|  
...
|Authentication|Встроенное|Настройка с помощью команды net use|  
|Доступ с помощью REST|Файлы внутри VHD недоступны|Возможен доступ к файлам в общедоступном ресурсе|  
|Максимальный размер|32 диска (тиб)|Общедоступный ресурс размером в 5 ТиБ и файл размером в 1 ТиБ в общедоступном ресурсе|  
|Maкс. количество операций ввода-вывода в секунду|20 000 операций ввода-вывода|1000 операций ввода-вывода в секунду|  
|Пропускная способность|До 900 Миб/с на диск|Целевой показатель — до 60 Миб/с на общую папку (показатель может быть выше для большего количества операций ввода-вывода)|  
