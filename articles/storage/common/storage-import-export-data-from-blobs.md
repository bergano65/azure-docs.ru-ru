...
## <a name="step-1-create-an-export-job"></a>Шаг 1. Создать задание экспорта
...
4. В разделе **Сведения о возврате** сделайте следующее:
    ...
    - Введите допустимый номер учетной записи, созданный в системе этого перевозчика. Корпорация Майкрософт использует эту учетную запись для отправки дисков вам обратно после завершения задания экспорта. 
...
1. [Скачайте WAImportExport версии 1](https://aka.ms/waiev1) в систему Windows. 
