...
6. В разделе **Сведения о возврате** сделайте следующее:
    ...
    - Введите допустимый номер учетной записи, созданный в системе этого перевозчика. Корпорация Майкрософт использует эту учетную запись для отправки дисков обратно к вам, как только ваша работа экспорта завершена.
...
2. Выберите из списка задание экспорта и щелкните его. Перейдите к **шифрованию** и скопируйте ключи.

   ![Просмотр ключей BitLocker для задания экспорта](./media/storage-import-export-service/export-job-bitlocker-keys-02.png)

3. Используйте ключи BitLocker для разблокировки дисков.

Экспорт завершен.

## <a name="step-5-unlock-the-disks"></a>Шаг 5: Разблокировать диски

При использовании версии 1.4.0.300 инструмента WAImportExport используйте следующую команду для разблокировки диска:

    `WAImportExport Unlock /externalKey:<BitLocker key (base 64 string) copied from journal (*.jrn*) file>`  

При использовании более ранних версий инструмента используйте диалог BitLocker для разблокировки диска.

В это время вы можете удалить задание или оставить его. Вакансии автоматически удаляются через 90 дней.
