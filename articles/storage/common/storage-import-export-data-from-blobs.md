...
Если используется средство WAImportExport версии 1.4.0.300, используйте следующую команду, чтобы разблокировать диск:
...
При использовании более ранних версий средства используйте диалоговое окно BitLocker для разблокировки диска.
