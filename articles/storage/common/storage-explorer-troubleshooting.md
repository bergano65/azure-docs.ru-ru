...
Для других типов ресурсов в настоящее время нет решения, связанного с Azure RBAC. В качестве обходного решения можно запросить URI SAS для [подключения к ресурсу](../../vs-azure-tools-storage-manage-with-storage-explorer.md?tabs=linux#use-a-shared-access-signature-uri).
...
- [Владелец](../../role-based-access-control/built-in-roles.md#owner): управление всеми ресурсами, включая доступ к ресурсам. **Примечание** . Эта роль предоставит вам доступ к ключам.
- [Участник](../../role-based-access-control/built-in-roles.md#contributor): управление всеми ресурсами без доступа к ресурсам. **Примечание** . Эта роль предоставит вам доступ к ключам.
- [Читатель](../../role-based-access-control/built-in-roles.md#reader): чтение и вывод списка ресурсов.
- [Участник учетной записи хранения](../../role-based-access-control/built-in-roles.md#storage-account-contributor). полное управление учетными записями хранения. **Примечание** . Эта роль предоставит вам доступ к ключам.
