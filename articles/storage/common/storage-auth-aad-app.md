...
:::image type="content" source="media/storage-auth-aad-app/app-registration-client-id.png" alt-text="Снимок экрана, показывающий идентификатор клиента":::
...
1. В разделе **разрешения** установите флажок рядом с **user_impersonation**, а затем нажмите кнопку **Добавить разрешения** .
    ...
    :::image type="content" source="media/storage-auth-aad-app/registered-app-permissions-1.png" alt-text="Снимок экрана, на котором показаны разрешения для API хранилища":::
...
:::image type="content" source="media/storage-auth-aad-app/registered-app-permissions-2.png" alt-text="Снимок экрана, на котором показаны разрешения API для зарегистрированного приложения":::
...
1. В разделе **неявное предоставление** установите флажок, чтобы включить маркеры идентификации, как показано на следующем рисунке:
    ...
    :::image type="content" source="media/storage-auth-aad-app/enable-implicit-grant-flow.png" alt-text="Снимок экрана, показывающий, как включить параметры для неявного потока предоставления разрешений":::
