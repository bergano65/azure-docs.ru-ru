...
Помните, что стоимость хранилища Azure — это лишь часть ежемесячных затрат в счете Azure. Хотя в этой статье объясняется, как оценить и контролировать затраты на службу хранилища Azure, вам будет выставлен счет за все службы и ресурсы Azure, используемые для подписки Azure, включая сторонние службы. После ознакомления с управлением затратами для службы хранилища Azure можно применить аналогичные методы для управления затратами для всех служб Azure, используемых в вашей подписке.
