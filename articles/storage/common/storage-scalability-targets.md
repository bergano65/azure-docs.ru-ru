...
## <a name="standard-performance-storage-account-scale-limits"></a>Пределы масштабирования учетной записи хранения Standard производительности
