...
> Список ограничений, региональных сведений и инструкций по включению этих больших размеров файловых ресурсов см. в разделе подключение [к более крупным файловым ресурсам (уровень Standard)](../files/storage-files-planning.md#onboard-to-larger-file-shares-standard-tier) раздела Обзор планирования службы файлов Azure.
...
Например, одна общая папка может достигать 100 000 операций ввода-вывода в секунду, а один файл может масштабироваться до 5 000 операций ввода-вывода в секунду. Например, если в одной общей папке имеется три файла, максимальное число операций ввода-вывода в секунду, которое можно получить из этой общей папки, — 15 000.
