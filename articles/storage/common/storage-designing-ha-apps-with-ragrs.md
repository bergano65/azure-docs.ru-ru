...
| **Таймаут** | **Транзакция**                                            | **Репликация**                       | **Время последней синхронизации** | **Результат** |
|----------|------------------------------------------------------------|---------------------------------------|--------------------|------------| 
...
| T3       | Транзакция В:<br> Обновление: <br>administrator<br>сущности роли в<br>primary |                    | T1                 | Транзакция В записана в основной регион,<br> но еще не реплицирована.  |
