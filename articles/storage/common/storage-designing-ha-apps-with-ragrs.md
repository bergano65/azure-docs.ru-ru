...
Чтобы получить время последней синхронизации для учетной записи хранения с помощью PowerShell, проверьте свойство **жеорепликатионстатс. ластсинктиме** учетной записи хранения. Не забудьте заменить значения заполнителей собственными значениями:
...
Чтобы получить время последней синхронизации для учетной записи хранения с помощью Azure CLI, проверьте свойство **жеорепликатионстатс. ластсинктиме** учетной записи хранения. Используйте параметр, чтобы получить значения для свойств, вложенных в **жеорепликатионстатс.** `--expand` Не забудьте заменить значения заполнителей собственными значениями:
