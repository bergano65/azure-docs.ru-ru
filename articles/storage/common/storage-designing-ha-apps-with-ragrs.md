...
| T2       | Транзакция Б:<br>Обновить<br> обновление сущности сотрудника<br> в основном регионе.  |                                | T1                 | Транзакция Б записана в основной регион,<br> но еще не реплицирована.  |
| T3       | Транзакция В:<br> Обновить <br>administrator<br>сущности роли в<br>primary |                    | T1                 | Транзакция В записана в основной регион,<br> но еще не реплицирована.  |
