...
* [Microsoft Network Monitor (Netmon)](https://www.microsoft.com/download/details.aspx?id=4865) и [Wireshark](https://www.wireshark.org/) — бесплатные средства для анализа сетевых протоколов, с помощью которых можно просматривать подробную информацию о пакетах для широкого спектра сетевых протоколов. Дополнительные сведения о Wireshark см. в [приложении 2 "Отслеживание сетевого трафика с помощью Wireshark"](#appendix-2).
...
> [!NOTE]
> Вы можете найти комплексный контрольный список обеспечения производительности здесь: [Производительность хранилища Microsoft Azure и контрольный список масштабируемости](storage-performance-checklist.md).
>
>
...
| e2d06d78-... |При ожидании ответа возникло исключение: The remote server returned an error: (404) Not Found (Удаленный сервер вернул ошибку: 404 — не найдено). |
...
| e2d06d78-... |При ожидании ответа возникло исключение: The remote server returned an error: (409) Conflict (Удаленный сервер вернул ошибку: 409 — конфликт). |
...
| de8b1c3c-... |При ожидании ответа возникло исключение: The remote server returned an error: (404) Not Found (Удаленный сервер вернул ошибку: 404 — не найдено). |
...
| de8b1c3c-... |Во время операции возникло исключение: The remote server returned an error: (404) Not Found (Удаленный сервер вернул ошибку: 404 — не найдено). |
