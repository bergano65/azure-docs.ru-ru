...
Примечание. Ранее эта информация, наряду с данными журналов, была доступна на [панели мониторинга служб Azure](http://status.azure.com).
...
* [Microsoft Network Monitor (Netmon)](https://www.microsoft.com/download/details.aspx?id=4865) и [Wireshark](http://www.wireshark.org/) — бесплатные средства для анализа сетевых протоколов, с помощью которых можно просматривать подробную информацию о пакетах для широкого спектра сетевых протоколов. Дополнительные сведения о Wireshark см. в [приложении 2 "Отслеживание сетевого трафика с помощью Wireshark"](#appendix-2).
