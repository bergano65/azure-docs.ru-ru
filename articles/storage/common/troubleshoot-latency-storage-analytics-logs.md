...
1. Скачайте [журналы Аналитика службы хранилища](/azure/storage/common/storage-analytics-logging#download-storage-logging-log-data).
...
5. Во время возникновения проблемы важны следующие значения:
   ...
   * Задержка клиента = сквозная задержка — Server-Latency
   ...
   | Тип большого двоичного объекта |Состоянии RequestStatus =<br>Успех|Состоянии RequestStatus =<br>ЖЕСТКИХ NetworkError|Рекомендация|
   |---|---|---|---|
