...
- [Проверки подлинности доступа к BLOB-объекты Azure и очереди, с помощью Azure Active Directory (Предварительная версия)](storage-auth-aad.md)
- [Предоставление доступа к контейнерам Azure и очереди с RBAC на портале Azure (Предварительная версия)](storage-auth-aad-rbac.md)