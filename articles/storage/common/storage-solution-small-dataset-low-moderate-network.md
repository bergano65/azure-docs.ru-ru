...
| Функция | Обозреватель службы хранилища Azure | Портал Azure | AzCopy<br>Azure PowerShell<br>Azure CLI | Интерфейсы REST API и пакеты SDK службы хранилища Azure |
|---------|------------------------|--------------|-----------------------------------------|---------------------------------|
...
| Разрешенные операции в хранилище BLOB-объектов<br>для больших двоичных объектов и папок | Передать<br>Скачивание<br>Управление | Передать<br>Скачивание<br>Управление |Передать<br>Скачивание<br>Управление | Да, поддерживается настройка |
| Разрешенное хранилище Azure Data Lake 1-го поколения<br>операции для файлов и папок | Передать<br>Скачивание<br>Управление | Нет |Передать<br>Скачивание<br>Управление                   | Нет |
| Разрешенные операции в хранилище файлов<br>для файлов и каталогов | Передать<br>Скачивание<br>Управление | Передать<br>Скачивание<br>Управление   |Передать<br>Скачивание<br>Управление | Да, поддерживается настройка |
...
- Узнайте, как [переносить данные с помощью Обозревателя службы хранилища Azure](/azure/machine-learning/team-data-science-process/move-data-to-azure-blob-using-azure-storage-explorer).
- [Передача данных с помощью AzCopy версии 10 (предварительная версия)](/azure/storage/common/storage-use-azcopy-v10)
