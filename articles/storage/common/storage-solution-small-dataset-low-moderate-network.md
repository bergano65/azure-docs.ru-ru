...
|---------|------------------------|--------------|-----------------------------------------|---------------------------------|
| Доступность | Загрузите и установите <br>Автономное средство | Веб-средства просмотра на портале Azure | Программа командной строки |Программируемые интерфейсы в .NET, Java, Python, JavaScript, C++, Go, Ruby и PHP |
