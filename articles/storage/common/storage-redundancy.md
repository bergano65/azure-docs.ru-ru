...
Все данные для всех типов учетных записей хранилища копируются в соответствии с опцией избыточности для учетной записи хранилища. Скопируются объекты, включая блок-капли, капли приложений, капли страниц, очереди, таблицы и файлы.
