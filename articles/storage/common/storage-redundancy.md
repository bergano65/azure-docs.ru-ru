...
| Предназначен для обеспечения \_\_ устойчивости объектов за определенный год<sup>1</sup>                                          | не менее 99,999999999 % (11 девяток) | не менее 99,9999999999 % (12 девяток) | не менее 99,99999999999999 % (16 девяток) | не менее 99,99999999999999 % (16 девяток) |
...
Реплицируются все данные для всех типов учетных записей хранения, включая блочные, добавочные, страничные BLOB-объекты, очереди, таблицы и файлы.
...
> [!NOTE]
> Сейчас Azure Premium Хранилище дисков поддерживает только локально избыточное хранилище (LRS). Хранилище блочных BLOB-объектов Azure Premium поддерживает локально избыточное хранилище (LRS) и хранилище, избыточное в виде зоны (ZRS) в определенных регионах.
