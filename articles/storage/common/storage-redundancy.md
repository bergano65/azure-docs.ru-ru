...
|    BlockBlobStorage<sup>1</sup>    | Юго-восточная Азия<br /> Западная Европа<br /> Восточная часть США    |    Только блочные BLOB-объекты    |
|    FileStorage    | Юго-восточная Азия<br /> Западная Европа<br /> Восточная часть США    |    Только Файлы Azure    |
