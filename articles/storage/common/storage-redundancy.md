...
<sup>2</sup> диски Azure для виртуальных машин, включая управляемые и неуправляемые диски, поддерживают только LRS. Они не поддерживают ZRS или ГЗРС. Дополнительные сведения об управляемых дисках см. в статье [цены для управляемых дисков Azure](/pricing/details/managed-disks/).
