...
Все данные для всех типов учетных записей хранения и [всех уровней (включая архив)](../blobs/storage-blob-storage-tiers.md) копируются в соответствии с параметром избыточность учетной записи хранения. Копируются объекты, включая блочные, добавочные, страничные BLOB-объекты, очереди, таблицы и файлы.
...
- [Проектирование высокодоступных приложений с помощью хранилища RA-GRS](../storage-designing-ha-apps-with-ragrs.md)
