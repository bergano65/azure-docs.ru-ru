...
Служба хранилища Azure регулярно проверяет целостность данных, сохраненных с помощью циклической проверки избыточности (CRC). Если обнаружено повреждение данных, он будет устранено, с помощью избыточных данных. Служба хранилища Azure также вычисляет контрольные суммы на весь сетевой трафик, чтобы обнаружить повреждение пакетов данных при сохранении или извлечении данных.
