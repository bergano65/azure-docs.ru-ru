...
| Поддерживаемые типы учетных записей хранения                                                                   | GPv2, GPv1, BLOB-объект                | GPv2, GPv1 (через PowerShell, Azure CLI или поставщика ресурсов API)                             | GPv2, GPv1, BLOB-объект                     | GPv2, GPv1, BLOB-объект                     |
