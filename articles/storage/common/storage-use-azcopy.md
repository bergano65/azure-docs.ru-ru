...
`/SyncCopy` может создавать дополнительных исходящих затрат по сравнению с асинхронным копированием, рекомендуется использовать этот параметр на виртуальной Машине Azure, который находится в одном регионе с вашей учетной записи хранения источника во избежание таких затрат.
...
Предположим, контейнер BLOB-объектов содержит следующее: JSON-файл, представляющий таблицу Azure, и сопутствующий файл манифеста.
...
* Подробная справка командной строки для AzCopy: `AzCopy /?`
...
AzCopy версии 8 всегда задает свойство Content-MD5 для BLOB-объекта или файла Azure после отправки его в службу.  
...
**Применимо к:** большим двоичным объектам, таблицам
...
* [Способы использования хранилища файлов из .NET](../storage-dotnet-how-to-use-files.md)
* [Практическое использование табличного хранилища из .NET](../../cosmos-db/table-storage-how-to-use-dotnet.md)
* [Описывается создание, управление и удаление учетной записи хранения](../storage-create-storage-account.md)
