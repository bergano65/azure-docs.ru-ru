...
Чтобы обеспечить устойчивую работу с данными, служба хранилища Azure хранит несколько копий данных. При настройке учетной записи хранения вы выбираете опцию репликации. Дополнительные сведения см. в статье [Репликация службы хранилища Azure](/azure/storage/common/storage-redundancy?toc=/azure/storage/blobs/toc.json).
