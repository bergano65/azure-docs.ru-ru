...
- **Интеграция Azure Active Directory (Azure AD) для данных больших двоичных объектов и очередей.** Хранилище Azure поддерживает проверку подлинности и авторизации с помощью Azure AD для служб больших двоичных объектов и очереди с помощью управления доступом на основе ролей (RBAC). Авторизация запросов с помощью Azure AD рекомендуется превосходной безопасности и простоты использования. Дополнительные сведения см. в разделе [авторизовать доступ к Azure, большие двоичные объекты и очереди, используя Azure Active Directory](storage-auth-aad.md).
...
Шифрование хранилища Azure обеспечивает защиту и защищает данные в соответствии с вашей организации требования безопасности и соответствия. Служба хранилища Azure автоматически шифрует все данные перед их сохранением в учетной записи хранения и расшифровывает их перед извлечением. Шифрование, расшифровка и процессов управления ключами полностью прозрачны для пользователей. Клиенты также могут выбрать для управления своими собственными ключами, с помощью хранилища ключей Azure. Дополнительные сведения см. в разделе [шифрованием службы хранилища Azure для неактивных данных](storage-service-encryption.md).

### <a name="client-side-encryption"></a>шифрования на стороне клиента

Клиентские библиотеки службы хранилища Azure предоставляют методы для шифрования данных из клиентской библиотеки перед их отправкой по сети и расшифровки ответа. Данные, зашифрованные с помощью шифрования на стороне клиента также шифруются при хранении службой хранилища Azure. Дополнительные сведения о шифровании на стороне клиента, см. в разделе [шифрование на стороне клиента с помощью .NET для службы хранилища Azure](storage-client-side-encryption.md).
...
- [Клиентская библиотека хранилища Azure для Java/Android](https://docs.microsoft.com/java/api/overview/azure/storage)
- [Клиентская библиотека хранилища Azure для Node.js](https://docs.microsoft.com/javascript/api/azure-storage)
- [Клиентская библиотека хранилища Azure для Python](https://github.com/Azure/azure-storage-python)
- [Клиентская библиотека хранилища Azure для PHP](https://github.com/Azure/azure-storage-php)
- [Клиентская библиотека хранилища Azure для Ruby](https://github.com/Azure/azure-storage-ruby)
- [Клиентская библиотека хранилища Azure дляC++](https://github.com/Azure/azure-storage-cpp)
