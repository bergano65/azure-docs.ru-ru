...
В этом практическом руководстве описаны стандартные операции с использованием командлетов уровня управления для учетных записей хранения. Вы узнаете, как выполнять такие задачи.
