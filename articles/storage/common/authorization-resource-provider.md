...
Для запроса, считывающего или записывающего данные большого двоичного объекта, требуются разрешения, отличные от разрешений на запрос, выполняющий операцию управления. RBAC обеспечивает детальный контроль над разрешениями для обоих типов ресурсов. При назначении роли Azure субъекту безопасности убедитесь, что вы понимаете разрешения, которые будет предоставлять участник. Подробные справочные сведения о действиях, связанных с каждой встроенной ролью Azure, см. [в статье встроенные роли Azure](../../role-based-access-control/built-in-roles.md).
