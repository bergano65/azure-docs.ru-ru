...
| Исходящие | Объем исходящих данных. Это число включает исходящий трафик для внешнего клиента из службы хранилища Azure, а также исходящего трафика в Azure. В результате это количество не отражает исходящий трафик для тарификации. <br/><br/> Единица измерения: байт <br/> Тип агрегирования: итог <br/> Применимые измерения: GeoType, ApiName и Authentication ([определение](#metrics-dimensions)) <br/> Пример значения: 1024 |
