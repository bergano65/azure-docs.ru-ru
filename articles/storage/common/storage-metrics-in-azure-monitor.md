...
| Имя метрики | ОПИСАНИЕ |
| ------------------- | ----------------- |
| BlobCapacity | Объем хранилища BLOB-объектов, используемый в учетной записи хранения. <br/><br/> Единица измерения. Байты <br/> Тип агрегирования. Средняя <br/> Пример значения. 1024 <br/> Размеры: **BlobType**, и **BlobTier** ([определение](#metrics-dimensions)) |
| BlobCount    | Количество больших двоичных объектов, хранящихся в учетной записи хранения. <br/><br/> Единица измерения. Количество <br/> Тип агрегирования. Средняя <br/> Пример значения. 1024 <br/> Размеры: **BlobType**, и **BlobTier** ([определение](#metrics-dimensions)) |
