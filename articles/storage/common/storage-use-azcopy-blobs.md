...
> * Отправка файла с тегами индекса
...
### <a name="upload-a-file-with-index-tags"></a>Отправка файла с тегами индекса
...
> * Копирование BLOB-объектов в другую учетную запись хранения с помощью тегов индекса
...
> [!NOTE]
> Если у исходных больших двоичных объектов есть теги index и вы хотите сохранить эти теги, необходимо повторно применить их к целевым BLOB-объектам. Дополнительные сведения о задании тегов индекса см. в разделе **Copy blobs to другой учетная запись хранения с тегами индекса** ниже. 

<a id="copy-between-accounts-and-add-index-tags"></a>

### <a name="copy-blobs-to-another-storage-account-with-index-tags"></a>Копирование BLOB-объектов в другую учетную запись хранения с помощью тегов индекса

Вы можете скопировать большие двоичные объекты в другую учетную запись хранения и добавить [теги индекса BLOB-объектов (Предварительная версия)](../blobs/storage-manage-find-blobs.md) в целевой большой двоичный объект.
