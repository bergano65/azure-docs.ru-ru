...
* **Инструмент WAImportExport**: это программа командной строки, которая выполняет следующие действия:
  ...
  * Шифрует данные на диске с помощью AES 128-bit BitLocker. Для защиты ключа BitLocker можно использовать предохранитель внешнего ключа.
...
Данные на диске шифруются с помощью AES 128-Bit шифрование диска BitLocker. Это шифрование защитит данные во время пересылки.
