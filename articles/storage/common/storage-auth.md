...
|  |Общий ключ (ключ учетной записи хранения)  |Подписанный URL-адрес (SAS)  |Azure Active Directory (Azure AD)  |Active Directory |Анонимный открытый доступ на чтение  |
|---------|---------|---------|---------|---------|---------|
