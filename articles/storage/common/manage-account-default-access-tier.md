...
Каждая учетная запись хранения Azure имеет уровень доступа по умолчанию: "горячий", "крутой" или "Архив". Уровень доступа назначается при создании учетной записи хранения. Уровень доступа по умолчанию — горячий.
