...
> [!TIP]
> Данные о строках подключения учетной записи хранения можно найти на [портале Azure](https://portal.azure.com). В **SETTINGS**  >  колонке меню учетной записи хранения перейдите к**разделу Параметры ключи доступа** , чтобы просмотреть строки подключения для первичных и вторичных ключей доступа.
>
