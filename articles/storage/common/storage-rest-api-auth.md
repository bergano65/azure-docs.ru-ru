...
**URI запроса**: `https://myaccount.blob.core.windows.net/?comp=list`.  URI запроса создается из конечной точки учетной записи хранения BLOB-объектов @no__t – 0, а строка ресурса — `/?comp=list`.
...
## <a name="example-list-blobs"></a>Пример: Список BLOB-объектов
