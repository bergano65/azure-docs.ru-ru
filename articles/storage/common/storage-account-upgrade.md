...
Затем вызовите следующую команду, чтобы обновить учетную запись, подставив имя группы ресурсов, имя учетной записи хранения и требуемый уровень доступа учетной записи.
