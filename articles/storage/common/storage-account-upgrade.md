...
> [!NOTE]
> Обновление учетной записи хранения до учетной записи общего назначения версии 2 предоставляется бесплатно.
> За изменение уровня доступа к хранилищу может взиматься плата. Дополнительные сведения см. в разделе [Цены и выставление счетов](#pricing-and-billing).
...
* Вы решили использовать или уже используете учетную запись хранения общего назначения версии 2. Теперь вы хотите выяснить, какой уровень доступа к хранилищу использовать — "горячий" или "холодный" для данных больших двоичных объектов.
