...
* **Затраты на исходящий трафик**. Передача исходящих данных (данные, передаваемые из региона Azure) требуют выставления счетов за использование пропускной способности для каждого гигабайта в соответствии с учетными записями хранения общего назначения.
