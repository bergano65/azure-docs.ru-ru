...
ms.locfileid: "61478680"
---
# <a name="retrieving-state-information-for-an-importexport-job"></a>Получение сведений о состоянии задания импорта и экспорта
Чтобы получить сведения о заданиях импорта и экспорта, можно вызвать операцию [Get Job](/rest/api/storageimportexport/jobs). Возвращаемые сведения включают:
...
Задание можно отменить только в определенных состояниях. Отмененное задание пропускает шаг копирования данных, но в противном случае соответствует же переходов между состояниями, как задание, который не был отменен.
