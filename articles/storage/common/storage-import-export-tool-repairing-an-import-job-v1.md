...
|**/bk:**<ключ_BitLocker\>|**Необязательный параметр.** Укажите ключ BitLocker, чтобы разблокировать зашифрованный диск, на котором расположены исходные файлы.|  
