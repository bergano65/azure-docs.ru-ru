...
Действия по подготовке дисков для задания импорта одинаковы независимо от способа создания задания на портале или с помощью REST API.
