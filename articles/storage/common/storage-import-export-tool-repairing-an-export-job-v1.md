...
|**/BK: <ключ BitLocker\>**|Необязательный параметр. Укажите ключ BitLocker, чтобы разблокировать зашифрованное размещение, в котором хранятся экспортированные файлы.|  
