...
7. В файле **template. JSON** назовите целевую учетную запись хранения, указав значение по умолчанию для имени учетной записи хранения. В этом примере для имени учетной записи хранения по умолчанию задается значение `mytargetaccount`.
...
1. В файле **template. JSON** назовите целевую учетную запись хранения, указав значение по умолчанию для имени учетной записи хранения. В этом примере для имени учетной записи хранения по умолчанию задается значение `mytargetaccount`.
