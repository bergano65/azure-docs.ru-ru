...
- Существует несколько сайтов, для которых требуется записывать номер входящего удостоверения центра обработки данных Майкрософт в целях безопасности. Перед отправкой дисков или дисков в центр обработки данных обратитесь к Azure датабокс Operationsadbops@microsoft.com(), чтобы получить это число. Без этого номера пакет будет отклонен.
