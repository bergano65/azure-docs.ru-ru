...
### <a name="the-uploaded-blob-shows-status-as-lease-expired-what-should-i-do"></a>В отправленном большом двоичном объекте отображается состояние "Lease expired" (Срок аренды истек). Что делать?
