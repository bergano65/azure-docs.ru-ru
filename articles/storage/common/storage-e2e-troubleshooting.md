---
title: Устранение неполадок с операциями с данными с помощью диагностики и анализатора сообщений
...
Во-первых, необходимо настроить ведение журнала службы хранилища Azure и метрик таким образом, чтобы у нас имелись данные из службы для анализа. Ведение журнала и метрики можно настроить различными способами: через [портал Azure](https://portal.azure.com), с помощью PowerShell или программно. Дополнительные сведения о настройке ведения журнала и метрик см. в разделе [Включение метрик](storage-analytics-metrics.md#enable-metrics-by-using-the-azure-portal) и [Включение ведения журнала](storage-analytics-logging.md#enable-storage-logging).
...
1. Загрузите [анализатор сообщений](https://docs.microsoft.com/message-analyzer/installing-and-upgrading-message-analyzer).
