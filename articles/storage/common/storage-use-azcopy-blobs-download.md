...
#### <a name="download-blobs-that-were-modified-after-a-date-and-time"></a>Загрузка больших двоичных объектов, которые были изменены после даты и времени 
...
[Моментальный снимок BLOB-объекта](/azure/storage/blobs/snapshots-overview.md) можно скачать, ссылаясь на значение **DateTime** моментального снимка большого двоичного объекта. 
