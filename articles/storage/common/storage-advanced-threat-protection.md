...
1. Выберите подписку Azure или группу ресурсов.
    ...
    ![Выбор подписки или группы](./media/storage-advanced-threat-protection/storage-atp-policy2.png)

1. Назначьте политику.

    ![Страница определений политик](./media/storage-advanced-threat-protection/storage-atp-policy1.png)
