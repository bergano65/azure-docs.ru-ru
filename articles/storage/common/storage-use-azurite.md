...
Для этого метода установки требуется наличие [node. js версии 8,0 или более поздней](https://nodejs.org) . Диспетчер пакетов node (NPM) — это средство управления пакетами, включенное в каждую установку Node. js. После установки Node. js выполните следующую команду, `npm` чтобы установить азурите.
