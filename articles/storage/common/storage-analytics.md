...
## <a name="about-storage-analytics-logging"></a>Информация о ведении журнала аналитики службы хранилища
...
| YYYY |Четырехзначное обозначение года создания журнала. Например:  2011 г. |
...
* [Ведение журнала аналитики службы хранилища](https://msdn.microsoft.com/library/hh343262.aspx)
* [Метрики Аналитики Службы хранилища](https://msdn.microsoft.com/library/hh343258.aspx)
