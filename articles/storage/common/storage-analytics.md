...
ms.locfileid: "75750527"
---
# <a name="storage-analytics"></a>аналитики хранилища

Azure Storage Analytics осуществляет ведение журнала и предоставляет метрические данные для учетной записи хранения. Эта информация может использоваться для трассировки запросов, анализа тенденций пользования и диагностики проблем в учетной записи хранения.
