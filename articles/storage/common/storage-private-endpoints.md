...
| Data Lake файловая система | privatelink.dfe.core.windows.net   |
...
### <a name="network-security-group-rules-on-subnets-with-private-endpoints"></a>Правила группы безопасности сети для подсетей с частными конечными точками
