...
|`DriveId`|String|Серийный номер диска.|  
|`Status`|String|Состояние обработки диска. Дополнительные сведения см. в таблице `Drive Status Codes` ниже.|  
...
|`Metadata/GlobalPath`|String|Относительный путь к глобальному файлу метаданных.|  
|`Metadata/GlobalPath/@Hash`|Атрибут, строка|MD5-хэш глобального файла метаданных в кодировке Base16.|  
|`Metadata/Path`|String|Относительный путь к файлу метаданных.|  
...
|`Properties/GlobalPath`|String|Относительный путь к глобальному файлу свойств.|  
|`Properties/GlobalPath/@Hash`|Атрибут, строка|MD5-хэш глобального файла свойств в кодировке Base16.|  
|`Properties/Path`|String|Относительный путь к файлу свойств.|  
|`Properties/Path/@Hash`|Атрибут, строка|MD5-хэш файла свойств в кодировке Base16.|  
|`Blob/Status`|String|Состояние обработки большого двоичного объекта.|  
