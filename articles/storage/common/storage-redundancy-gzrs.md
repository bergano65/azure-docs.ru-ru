...
Корпорация Майкрософт продолжит включать ГЗРС и RA-ГЗРС в дополнительных регионах Azure. Для получения сведений о поддерживаемых регионах регулярно проверяйте [обновления службы Azure](https://azure.microsoft.com/updates/) Page.
...
Только учетные записи общего назначения v2 поддерживают ГЗРС/RA-ГЗРС, поэтому перед отправкой запроса на динамическую миграцию в ГЗРС/RA-ГЗРС необходимо обновить учетную запись до общего назначения версии 2. Дополнительные сведения см. в статье [Общие сведения об учетной записи хранения Azure](https://docs.microsoft.com/azure/storage/common/storage-account-overview) and [обновление до учетной записи хранения общего назначения версии 2](https://docs.microsoft.com/azure/storage/common/storage-account-upgrade).
