...
4. Укажите следующие значения в разделе **проблема** :
    ...
    - **Подробности:** Введите дополнительные сведения в **подробные сведения** box, например "я хочу перейти на гзрс из [LRS, GRS] в \_ @ no__t-3 регионе". или "я хочу перейти на RA-ГЗРС из [LRS, RA-GRS] в \_ @ no__t-1 регионе".
