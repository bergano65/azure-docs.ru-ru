...
4. Укажите следующие значения в разделе **Проблема**:
    ...
    - **Сведения**: введите дополнительные сведения в поле **сведения** , например "я хочу перейти на гзрс из [LRS, GRS] в \_ @ no__t-3 регионе". или "я хочу перейти на RA-ГЗРС из [LRS, RA-GRS] в \_ @ no__t-1 регионе".
5. Щелкните **Далее**.
