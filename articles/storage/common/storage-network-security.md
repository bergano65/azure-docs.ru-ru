...
Каждая учетная запись хранения поддерживает до 100 сетевых правил для IP-адресов.
...
- Ресурсам некоторых служб может быть предоставлен явный доступ к вашей учетной записи хранения путем **назначения роли RBAC** их управляемому удостоверению, назначенному системой.
