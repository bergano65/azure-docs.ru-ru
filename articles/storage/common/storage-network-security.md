...
Сетевые правила помогают создать безопасную среду для доступа к приложениям и данным в большинстве сценариев. Однако некоторые приложения используют службы, которые не могут быть однозначно изолированы с помощью правил виртуальной сети или IP-адреса. Но такие службы должны быть предоставлены учетной записи хранения для обеспечения полной функциональности приложения. Чтобы включить некоторые сценарии доступа к данным, журналам или аналитике, можно использовать исключение « ***Разрешить доверенные службы Майкрософт...*** ».

### <a name="trusted-microsoft-services"></a>Доверенные службы Майкрософт

Некоторым службам Майкрософт, работающим с сетями, нельзя предоставить доступ через существующие правила сети. Вы можете разрешить доступ к учетной записи хранения подмножеству таких доверенных служб Майкрософт, сохраняя сетевые правила для других приложений. Затем эти службы могут использовать надежную проверку подлинности для подключения к учетной записи хранения. Мы включили два типа доверенного доступа для служб Майкрософт.
...
Исключение " **Разрешить доверенные службы Майкрософт...** " позволяет конкретным экземплярам этих служб получить доступ к учетной записи хранения, если [управляемому системному удостоверению, назначенному](../../active-directory/managed-identities-azure-resources/overview.md) для экземпляра, назначается роль RBAC.
