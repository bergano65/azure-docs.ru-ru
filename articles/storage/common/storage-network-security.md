...
При этом приложению, получающему доступ к учетной записи хранения с активными правилами сети, необходима надлежащая авторизация. Авторизацию обеспечивают учетные данные Azure Active Directory (для больших двоичных объектов и очередей; предварительная версия), действительный ключ доступа к учетной записи или токен SAS.
...
1. Установите [Azure PowerShell](/powershell/azure/install-azurerm-ps) и [выполните вход](/powershell/azure/authenticate-azureps).
