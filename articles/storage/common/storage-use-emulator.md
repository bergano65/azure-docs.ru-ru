...
> [!NOTE]
> Если установлен эмулятор Microsoft Azure COMPUTE, то при запуске эмулятора хранения появится значок панели задач. Щелкните этот значок правой кнопкой мыши, чтобы вызвать меню, которое позволяет запустить и остановить работу эмулятора хранения графическим путем.
>
>
...
| --- | --- | --- | --- |
| **Запуск** |Запускает эмулятор хранения. |`AzureStorageEmulator.exe start [-inprocess]` |*-Reprocess*: Запуск эмулятора в текущем процессе вместо создания нового процесса. |
