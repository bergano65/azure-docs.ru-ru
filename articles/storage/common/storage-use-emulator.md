...
* Эмулятор хранения не будет отклонять версию 2019-07-07 служб хранилища для конечных точек службы BLOB-объектов, очередей и таблиц.

### <a name="version-59"></a>Версия 5,9

* Эмулятор хранения не будет отклонять версию 2019-02-02 служб хранилища для конечных точек службы BLOB-объектов, очередей и таблиц.

### <a name="version-58"></a>Версия 5,8

* Эмулятор хранения не будет отклонять версию 2018-11-09 служб хранилища для конечных точек службы BLOB-объектов, очередей и таблиц.
