...
|--------------------|----------------------------------------------------|---------------------------------------------------------------------|----------------------------------------------------|---------------------------------------------------------------------|
| <b>... из LRS</b> | Недоступно | Используйте портал Azure, PowerShell или CLI, чтобы изменить параметр репликации<sup>1, 2</sup> | Выполнение миграции вручную <br /><br /> ИЛИ <br /><br /> Запрос динамической миграции | Выполнение миграции вручную <br /><br /> ИЛИ <br /><br /> Сначала перейдите в GRS/RA-GRS, а затем запросите динамическую миграцию<sup>1</sup> . |
...
| <b>... из ZRS</b> | Выполнение миграции вручную | Выполнение миграции вручную | Недоступно | Используйте портал Azure, PowerShell или CLI, чтобы изменить параметр репликации<sup>1, 3</sup> |
