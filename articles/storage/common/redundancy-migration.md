...
- Хранилище, избыточное в геопоясе (ГЗРС) или геоизбыточное хранилище с доступом на чтение (RA-ГЗРС) (Предварительная версия)
...
|--------------------|----------------------------------------------------|---------------------------------------------------------------------|----------------------------------------------------|---------------------------------------------------------------------|
| <b>... из LRS</b> | Недоступно | Изменение параметра репликации с помощью портал Azure, PowerShell или интерфейса командной строки | Выполнение миграции вручную <br /><br />Запрос динамической миграции | Выполнение миграции вручную <br /><br />Запрос динамической миграции |
| <b>... из GRS/RA-GRS</b> | Изменение параметра репликации с помощью портал Azure, PowerShell или интерфейса командной строки | Недоступно | Выполнение миграции вручную <br /><br />Запрос динамической миграции | Выполнение миграции вручную <br /><br />Запрос динамической миграции |
| <b>... из ZRS</b> | Выполнение миграции вручную <br /><br />Запрос динамической миграции | Выполнение миграции вручную <br /><br />Запрос динамической миграции | Недоступно | Изменение параметра репликации с помощью портал Azure, PowerShell или интерфейса командной строки |
| <b>... из ГЗРС/RA-ГЗРС</b> | Выполнение миграции вручную <br /><br />Запрос динамической миграции | Выполнение миграции вручную <br /><br />Запрос динамической миграции | Изменение параметра репликации с помощью портал Azure, PowerShell или интерфейса командной строки | Недоступно |

<sup>1</sup> — одноразовая оплата.
...
Чтобы изменить параметр избыточности для учетной записи хранения с помощью PowerShell, вызовите команду [Set-азсторажеаккаунт](/powershell/module/az.storage/set-azstorageaccount) и укажите параметр `-SkuName`:
...
Чтобы изменить параметр избыточности для учетной записи хранения с Azure CLI, вызовите команду [AZ Storage Account Update](/cli/azure/storage/account#az-storage-account-update) и укажите параметр `--sku`:
