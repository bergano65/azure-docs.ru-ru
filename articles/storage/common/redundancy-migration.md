...
| <b>... из ZRS</b> | Выполнение миграции вручную | Выполнение миграции вручную | Н/Д | Изменение параметра репликации<sup>1</sup> с помощью портал Azure, PowerShell или интерфейса командной строки |
