...
|    Поддерживаемые службы хранилища Azure    |    Все                                                |    Хранилище BLOB-объектов, службы файлов Azure                                                                                                               |    Хранилище больших двоичных объектов                                                                  |
|    Хранилище ключей                         |    Хранилище ключей (Майкрософт)    |    Хранилище Azure Key Vault                                                                                                                              |    Azure Key Vault или любое другое хранилище ключей                                                                 |
