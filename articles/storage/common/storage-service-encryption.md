...
> [!NOTE]
> Области шифрования не поддерживаются для учетных записей геоизбыточного хранилища с доступом на чтение (RA-GRS) во время действия предварительной версии.
