...
- Вы можете указать *ключ, управляемый клиентом* , с помощью Azure Key Vault, который будет использоваться для шифрования и расшифровки всех данных в учетной записи хранения. Ключ, управляемый клиентом, используется для шифрования всех данных во всех службах в учетной записи хранения.
