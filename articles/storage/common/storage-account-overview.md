...
> [!NOTE]
> [Доступ уровня "премиум" (Предварительная версия)](../blobs/storage-blob-storage-tiers.md#premium-access-tier), которая оптимизирована для уязвимых приложений производительности, обеспечивает низкий и согласованное задержку, с высокими показателями пропускной способности и транзакций. Уровень доступа "премиум" доступен только с учетными записями хранения блочных BLOB-объектов (Предварительная версия). Дополнительные сведения см. в разделе [общедоступной предварительной версии хранилища BLOB-объектов Azure класса Premium](https://azure.microsoft.com/blog/azure-premium-blob-storage-public-preview/).
