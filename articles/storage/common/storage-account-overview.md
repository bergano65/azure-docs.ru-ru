...
* **[учетные записи общего назначения версии 2](#general-purpose-v2-accounts)** (рекомендуется использовать в большинстве сценариев);
* **[учетные записи общего назначения версии 1](#general-purpose-v1-accounts)**;
* **[учетные записи хранилища BLOB-объектов](#blob-storage-accounts)**. 
...
> [!NOTE]
> [Уровень доступа "Премиум"](../blobs/storage-blob-storage-tiers.md#premium-access-tier) доступен в ограниченной предварительной версии как учетная запись локально избыточного хранилища (LRS) в регионах "Северная Европа", "Восточная часть США 2", "Центральная часть США" и "Западная часть США". Дополнительные сведения о регистрации для использования предварительной версии см. в разделе [Introducing Azure Premium Blob Storage](https://aka.ms/premiumblob) (Знакомство с хранилищем BLOB-объектов ценовой категории "Премиум").
...
* **Холодный** уровень доступа оптимизирован для хранения больших объемов данных, которые используются редко и хранятся не менее 30 дней. Хранение данных на холодном уровне является более экономичным, но доступ к этим данным может быть несколько более затратен, чем доступ к данным на горячем уровне.
...
Если нужно изменить шаблон использования данных, вы в любое время можете изменить уровень доступа. Дополнительные сведения об уровнях доступности см. в статье [Хранилище BLOB-объектов Azure: горячий, холодный и архивный уровни](../blobs/storage-blob-storage-tiers.md).
