...
Учетную запись хранения BLOB-объектов блок — это учетная запись специализированных хранения для хранения неструктурированных данных объектов в виде блочных BLOB-объектов или добавочных BLOB-объектов. Учетные записи хранилища BLOB-объектов блок обеспечивают несколько уровней доступа для хранения данных на основе шаблонов использования. Дополнительные сведения см. в разделе [Уровни доступа для данных блочных BLOB-объектов](#access-tiers-for-block-blob-data).
...
## <a name="general-purpose-performance-tiers"></a>Уровни производительности общего назначения
