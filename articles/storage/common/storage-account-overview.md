...
Учетная запись Блоккблобстораже — это специализированная учетная запись хранения, используемая для хранения неструктурированных данных объекта в виде блочных BLOB-объектов и создания блочных BLOB-объектов Premium. Этот тип учетной записи хранения поддерживает блочные и добавочные большие двоичные объекты, но не страничные BLOB-объекты, таблицы или очереди.
