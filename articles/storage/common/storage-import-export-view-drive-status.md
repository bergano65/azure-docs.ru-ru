...
Состояние задания импорта или экспорта можно отслеживать на портале Azure. Нажмите на вкладку **«Импорт/экспорт».** Список заданий отображается на странице.
