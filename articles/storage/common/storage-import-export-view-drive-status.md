...
| Completed | После отправки всех дисков клиенту заданию присваивается состояние **Completed**, если оно выполнено без ошибок. Задание в состоянии **Completed** автоматически удаляется через 90 дней. |
...
| Completed | Диск перейдет в состояние **Completed**, если служба успешно передаст все данные без ошибок.
