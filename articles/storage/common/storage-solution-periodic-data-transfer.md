...
| Однократная настройка     | Небольшие                                | Средние изменяемые трудозатраты в процессе разработки    |
...
| Функция                                       | Шлюз Data Box (предварительная версия) | Data Box Edge (предварительная версия)  | Фабрика данных Azure        |
|----------------------------------|-----------------------------------------|--------------------------|---------------------------|
...
- Руководства
    ...
    - [Руководство по преобразованию данных с помощью Data Box Edge перед отправкой в Azure](https://docs.microsoft.com/azure/databox-online/data-box-edge-deploy-configure-compute)
