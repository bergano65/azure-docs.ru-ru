...
В этой статье описывается, как использовать Azure CLI для перечисления встроенных ролей RBAC и их назначения пользователям. Дополнительные сведения об использовании Azure CLI см. в разделе [интерфейс командной строки Azure (CLI)](/cli/azure).
