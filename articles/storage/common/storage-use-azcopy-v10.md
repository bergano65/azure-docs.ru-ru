...
- [участник данных BLOB-объектов хранилища](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#storage-blob-data-contributor);
...
Начните с установки переменной `AZCOPY_SPA_CLIENT_SECRET` среды в секрет клиента регистрации приложения субъекта-службы.
...
- [AzCopy в Linux (версии 7)](https://docs.microsoft.com/previous-versions/azure/storage/storage-use-azcopy-linux)
