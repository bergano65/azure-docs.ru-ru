...
1. Перед созданием контейнера, назначить [участник для данных больших двоичных объектов хранилища](../../role-based-access-control/built-in-roles.md#storage-blob-data-contributor-preview) роли себе. Несмотря на то, что вы являетесь владельцем учетной записи, вы должны явные разрешения для выполнения операций с данными в учетной записи хранения. Дополнительные сведения о назначении роли RBAC см. в разделе [предоставить доступ к контейнерам Azure и очереди с RBAC на портале Azure](storage-auth-aad-rbac.md).
