...
Учетные записи хранения, содержащие архивные BLOB-объекты, поддерживают отработку отказа После завершения отработки отказа для преобразования учетной записи обратно в GRS или RA-GRS все большие двоичные объекты арчиевед необходимо сначала восстановить на уровне сети.
