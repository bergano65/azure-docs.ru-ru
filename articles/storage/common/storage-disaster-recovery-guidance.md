...
* [Проектирование устойчивых приложений для Azure](https://docs.microsoft.com/azure/architecture/resiliency/). Обзор основных концепций проектирования высокодоступных приложений в Azure.
* [Контрольный список доступности](https://docs.microsoft.com/azure/architecture/checklist/availability). Контрольный список для проверки того, что приложение реализует лучшие методики проектирования для обеспечения высокого уровня доступности.
