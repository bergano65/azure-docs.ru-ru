...
- **Файлы:** Используйте [AzCopy](./storage-use-azcopy-v10.md) или [Azure PowerShell](/powershell/module/az.storage/) , чтобы скопировать файлы в другую учетную запись хранения в другом регионе.
