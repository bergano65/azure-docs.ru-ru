...
|    |     |
|--------|-----------|
| **Синтаксис** | `azcopy copy 'https://<storage-account-name>.file.core.windows.net/<file-share-name>/<file-path>?<SAS-token>?<SAS-token>' '<local-file-path>'` |
...
|    |     |
|--------|-----------|
| **Синтаксис** | "azcopy Copy" https://< хранилище-учетная запись-name >. File. Core. Windows. NET/< файл-Share-name >/< Directory-путь >? < SAS-Token > " 
"< локальный каталог — путь >"--recursive " |
