...
Дополнительные сведения о скачивании конкретных файлов см. в [этом разделе](./storage-use-azcopy-blobs.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#download-specific-files).
