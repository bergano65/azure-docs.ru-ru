...
По умолчанию файлы журналов находятся в `%USERPROFILE\\.azcopy` каталог на Windows или в `$HOME\\.azcopy` каталог в Mac и Linux. Это расположение можно изменить, если необходимо выполнить с помощью следующих команд.
...
По умолчанию файлы журнала и план, находятся в `%USERPROFILE\\.azcopy` каталоге Windows или `$HOME\\.azcopy` каталог в Mac и Linux.
