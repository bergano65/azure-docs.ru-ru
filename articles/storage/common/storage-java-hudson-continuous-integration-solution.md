...
3. В разделе **Microsoft Azure Storage Account Configuration** (Настройка учетной записи хранения Azure):
    ...
    1\. Введите имя учетной записи хранения, которую можно получить из [портал Azure](https://portal.azure.com).
   
    2\. Введите ключ учетной записи хранения, который также можно получить из [портал Azure](https://portal.azure.com).
