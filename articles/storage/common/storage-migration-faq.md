...
№ Этот процесс является бесплатным.
...
-   При использовании геоизбыточного хранилища с доступом на чтение данные доступны из дополнительного региона в любое время. Используйте один из следующих методов.  
    ...
    - **Маркер SAS**: используйте маркер SAS для доступа к данным из конечной точки. Дополнительные сведения см. в статье [Использование подписанных URL-адресов (SAS)](storage-dotnet-shared-access-signature-part-1.md).

**Как использовать пользовательский домен HTTPS с моей учетной записью хранения? Например, как сделать «https:\//mystorageaccountname.blob.core.windows.net/images/image.gif» отображаются в виде «https:\//www.contoso.com/images/image.gif»?**
