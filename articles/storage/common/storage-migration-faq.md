...
-   Если вы используете хранилище, избыточное между зонами или геоизбыточное хранилище, вы не можете получить доступ к данным из дополнительного региона, если не инициируете отработку отказа в этом регионе. Дополнительные сведения об отработке отказа см. в статье [Аварийное восстановление и отработка отказа учетной записи хранения](storage-disaster-recovery-guidance.md).
