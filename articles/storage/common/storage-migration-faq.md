...
-   При использовании геоизбыточного хранилища с доступом на чтение данные доступны из дополнительного региона в любое время. Используйте один из следующих методов.  
    ...
    - **Токен SAS**: используйте токен SAS для доступа к данным из конечной точки. Дополнительные сведения см. в статье [Использование подписанных URL-адресов](storage-sas-overview.md).
...
Если вы хотите только скачивать данные без использования Обозревателя службы хранилища или аналогичного приложения, можно использовать токен SAS. Дополнительные сведения см. в статье [Использование подписанных URL-адресов](storage-sas-overview.md).
