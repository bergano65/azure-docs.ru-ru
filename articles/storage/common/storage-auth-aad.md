...
Узнайте, как назначение встроенной роли на портале Azure, см. в разделе [предоставить доступ к контейнерам Azure и очереди с RBAC на портале Azure](storage-auth-aad-rbac.md).
...
- [Предоставление доступа к контейнерам Azure и очереди с RBAC на портале Azure](storage-auth-aad-rbac.md)
...
- [Использование удостоверения Azure AD для доступа к хранилищу Azure с помощью интерфейса командной строки или PowerShell](storage-auth-aad-script.md)