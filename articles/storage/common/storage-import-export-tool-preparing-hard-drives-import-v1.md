...
|**/logdir:** <LogDirectory\>|`Optional.` Каталог журнала определяет каталог, используемый для хранения файлов подробных журналов и некоторых временных файлов манифеста. Если каталог не указан, вместо него будет использоваться текущий каталог.|
