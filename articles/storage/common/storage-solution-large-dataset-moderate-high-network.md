...
|                                     |    Средства AzCopy, <br>Azure PowerShell, <br>Инфраструктура CLI Azure             |    Интерфейсы REST API и пакеты SDK для службы хранилища Azure                   |    Шлюз поля данных или граничной поле данных          |    Фабрика данных Azure                                            |
|-------------------------------------|------------------------------------|----------------------------------------------|----------------------------------|-----------------------------------------------------------------------|
