...
Функции создания или перемещения общей папки на конкретный уровень доступны в последнем Azure CLI обновления. Обновление Azure CLI зависит от используемого дистрибутива операционной системы или Linux. Инструкции по обновлению Azure CLI в системе см. в разделе [установка Azure CLI](/cli/azure/install-azure-cli?preserve-view=true&view=azure-cli-latest).
