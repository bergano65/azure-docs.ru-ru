...
Вы можете перенести существующие общие файловые ресурсы, например хранящиеся локально, в новую общую папку Azure. В этом разделе будет показан способ перемещения данных в файл Azure с помощью нескольких популярных методов, описанных в [руководстве по планированию](storage-files-planning.md#migration)
