...
6. Используйте [средство WAImportExport](https://www.microsoft.com/en-us/download/details.aspx?id=55280) для копирования данных на один или несколько жестких дисков.
...
1. Скачайте [последнюю версию AzCopy для Windows](https://aka.ms/downloadazcopy) или [Linux](../common/storage-use-azcopy-linux.md?toc=%2fazure%2fstorage%2ffiles%2ftoc.json#download-and-install-azcopy).
