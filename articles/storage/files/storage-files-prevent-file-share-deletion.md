...
ms.locfileid: "93126946"
---
# <a name="prevent-accidental-deletion-of-azure-file-shares"></a>Предотвращение случайного удаления общих папок Azure

Служба хранилища Azure теперь предлагает обратимое удаление общих папок. Обратимое удаление позволяет восстановить общую папку, если она была по ошибке удалена приложением или другим пользователем учетной записи хранения.
