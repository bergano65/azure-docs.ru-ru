...
ms.locfileid: "78209484"
---
# <a name="storsimple-1200-migration-to-azure-file-sync"></a>Миграция StorSimple 1200 в Синхронизация файлов Azure

Серия StorSimple 1200 — это виртуальное устройство, которое выполняется в локальном центре обработки данных.
С объявленным окончанием срока службы в линии продуктов StorSimple на 31 2022 декабря облачная служба, к которой подключено это виртуальное устройство, перестанет работать.
...
Эта статья содержит необходимые фундаментальные знания и миграции для успешной миграции на Синхронизация файлов Azure.
