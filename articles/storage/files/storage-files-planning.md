...
Чтобы зарегистрировать подписку для предварительной версии общих ресурсов большего размера файлов, выполните следующие команды PowerShell:
