...
|Район  |Поддерживаемая избыточность  |Поддержка существующих учетных записей хранения  |
|---------|---------|---------|
|Юго-Восточная Азия     |LRS|Нет         |
|Западная Европа     |LRS, ZRS|Нет         |
|Западная часть США 2     |LRS, ZRS|Нет         |
