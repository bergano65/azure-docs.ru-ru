...
Файлы Azure Standard shares поддерживают три варианта обеспечения избыточности данных: локально избыточное хранилище (LRS), хранилище, избыточное в виде зоны (ZRS), геоизбыточное хранилище (GRS) и хранилище, избыточное в геопоясе (ГЗРС) (Предварительная версия).
