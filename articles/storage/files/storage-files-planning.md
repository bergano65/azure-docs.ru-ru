...
Основной и дополнительный регионы управляют репликами в отдельных доменах сбоя и доменах обновления в рамках единицы масштабирования хранилища. Единица масштабирования хранилища — это основная единица репликации в центре обработки данных. Репликация на этом уровне предоставляется LRS; Дополнительные сведения см. в разделе [Locally избыточное хранилище (LRS): недорогое средство, чтобы обеспечить избыточность данных для службы хранилища Azure](../common/storage-redundancy-lrs.md).
...
|Регион |Поддерживаемая избыточность |Поддержка существующих учетных записей хранения |Поддержка портала * |
|-------|---------|---------|---------|
|Восточная часть Австралии |LRS     |Нет    |Да|
|Юго-Восточная часть Австралии|LRS |Нет    |Да|
|Центральная Индия  |LRS     |Нет    |Да|
|Восточная Азия      |LRS     |Нет    |Да|
|East US        |LRS     |Нет    |Да|
|Центральная Франция |LRS, ZRS|Нет    |Да|
|Южная Франция   |LRS     |Нет    |Да|
|Северная Европа   |LRS     |Нет    |Пока нет|
|Южная Индия    |LRS     |Нет    |Да|
|Юго-Восточная Азия |LRS, ZRS|Нет    |Да|
|Западно-центральная часть США|LRS     |Нет    |Да|
|Западная Европа    |LRS, ZRS|Нет    |Да|
|Запад США        |LRS     |Нет    |Да|
|Западный регион США 2      |LRS, ZRS|Нет    |Да|
