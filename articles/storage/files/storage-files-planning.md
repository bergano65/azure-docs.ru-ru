...
Стандартные общие файловые ресурсы доступны во всех регионах до 5 тиб. В некоторых регионах они доступны с ограничением в 100 Тиб, эти регионы перечислены в следующей таблице.

|Регион |Поддерживаемая избыточность |
|-------|---------|
|Восточная часть Австралии |LRS     |
|Юго-Восточная часть Австралии|LRS |
|Центральная Канада  |LRS     |
|Восточная Канада     |LRS     |
|Центральная Индия  |LRS     |
|Центральная американская *   |LRS     |
|Восточная Азия      |LRS     |
...
|Западно-центральная часть США|LRS     |
|Западная Европа *    |LRS, ZRS|
|Западная часть США *        |LRS     |
|Западный регион США 2      |LRS, ZRS|

\* поддерживаются для новых учетных записей, не все существующие учетные записи завершили процесс обновления. Вы можете проверить, завершили ли существующие учетные записи хранения процесс обновления, попытайтесь [включить большие файловые ресурсы](storage-files-how-to-create-large-file-share.md).
