...
\* поддерживаются для новых учетных записей, не все существующие учетные записи завершили процесс обновления.
...
Чтобы приступить к использованию общих файловых ресурсов, см. статью [Включение больших файловых](storage-files-how-to-create-large-file-share.md)ресурсов.
