...
- Поддерживает проверку подлинности Kerberos в AD с шифрованием RC4-HMAC. Шифрование AES Kerberos пока не поддерживается.
