...
После создания файловых ресурсов можно периодически создавать их моментальные снимки для архивации данных. Создаваемый периодически моментальный снимок файловых ресурсов позволяет поддерживать предыдущие версии данных, которые могут использоваться для аудита или аварийного восстановления. Для создания моментальных снимков и управления ими рекомендуется использовать [резервное копирование файловых ресурсов Azure](../../backup/azure-file-share-backup-overview.md) в качестве решения для резервного копирования. Вы также можете самостоятельно создавать моментальные снимки и управлять ими с помощью CLI или PowerShell.
...
Мы рекомендуем использовать [резервное копирование файлового ресурса Azure](../../backup/azure-file-share-backup-overview.md) в качестве решения для резервного копирования, чтобы автоматизировать создание моментальных снимков, а также Управление моментальными снимками. При запуске инфраструктуры на Azure автоматизируйте архивацию для восстановления данных, когда это возможно. Автоматические действия более надежны, чем ручные процессы и помогают улучшить защиту данных и возможности восстановления. Вы можете использовать резервную копию файлового ресурса Azure, REST API, пакет SDK клиента или скрипты для автоматизации.
...
Моментальные снимки файлового ресурса обеспечивают защиту только на уровне файлов. Они не защищают от неосторожных удалений файлов в файловом ресурсе или учетных записях хранения. Чтобы защитить учетную запись хранения от случайных удалений, можно либо [включить обратимое удаление](storage-files-prevent-file-share-deletion.md), либо заблокировать учетную запись хранения и (или) группу ресурсов.

## <a name="next-steps"></a>Дальнейшие действия
- Работа с моментальными снимками общих ресурсов с помощью:
    - [Резервное копирование файлового ресурса Azure](../../backup/azure-file-share-backup-overview.md)
