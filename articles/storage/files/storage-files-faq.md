...
**поддерживает ли Azure службы проверки подлинности azure AD DS доступ к SMB с использованием учетных данных Azure AD с устройств, присоединенных к Azure AD или зарегистрированных в них?**
...
**можно ли включить проверку подлинности Azure для файлов azure AD DS с клиентом Azure AD, который отличается от основного клиента, с которым связана общая папка?**
...
* <a id="ad-linux-vms"></a>
**поддерживает ли azure AD DS аутентификацию Azure для виртуальных машин Linux?**

    Нет, проверка подлинности с виртуальных машин Linux не поддерживается.

* <a id="ad-aad-smb-afs"></a>
**можно ли использовать службу "файлы Azure Azure" AD DS проверку подлинности на общих файловых ресурсах, управляемых синхронизация файлов Azure?**

    Нет, службы файлов Azure не поддерживают сохранение списков управления доступом NTFS на общих файловых ресурсах, управляемых Синхронизация файлов Azure. Таблицы управления доступом к файлам, перенесенные из локальных файловых серверов, сохраняются Синхронизация файлов Azure. Все списки ACL NTFS, настроенные изначально для файлов Azure, будут перезаписаны службой Синхронизация файлов Azure. Кроме того, службы файлов Azure не поддерживают проверку подлинности с учетными данными Azure AD для доступа к общим файловым ресурсам, которыми управляет служба синхронизации файлов Azure.
