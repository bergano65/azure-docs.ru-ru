...
**Поддерживает ли служба "Файлы Azure" проверку подлинности и управление доступом на основе удостоверений?**  
    ...
    Для получения исчерпывающего представления всех протоколов, поддерживаемых в службах хранилища Azure, можно обратиться к разделу [Авторизация доступа к службе хранилища Azure](../common/storage-auth.md?toc=%252fazure%252fstorage%252fblobs%252ftoc.json). 
