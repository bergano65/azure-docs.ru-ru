...
Дедупликация данных поддерживается в томах с включенным распределением по уровням в облаке в Windows Server 2016 и Windows Server 2019. Включив дедупликацию в томе с включенным распределением по уровням в облаке, вы можете кэшировать больше файлов локально без выделения дополнительного объема памяти. Обратите внимание, что эти тома экономия применяются только в локальном не будет иметь дедуплицированных данных в службе файлов Azure. 
...
> [!Note]  
> Антивирусного программного обеспечения можно проверить совместимость своих продуктов и синхронизации файлов Azure с помощью [Azure файл синхронизации антивирусная программа совместимости набора тестов] (https://www.microsoft.com/download/details.aspx?id=58322), которая доступна для загрузки в центре загрузки Майкрософт.
...
| Центральная Корея       | Корея, юг        |
| Корея, юг         | Центральная Корея      |
