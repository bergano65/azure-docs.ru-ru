...
| Открытый | Canada | Центральная Канада | `canadacentral` |
| Открытый | Canada | Восточная Канада | `canadaeast` |
| Открытый | Европа | Северная Европа | `northeurope` |
| Открытый | Европа | Западная Европа | `westeurope` |
| Открытый | Франция | Центральная Франция | `francecentral` |
| Открытый | Франция | Южная Франция * | `francesouth` |
...
| Открытый | Корея | Республика Корея, центральный регион | `koreacentral` |
| Открытый | Корея | Республика Корея, южный регион | `koreasouth` |
| Открытый | ЮАР | Северная часть ЮАР; | `southafricanorth` |
| Открытый | ЮАР | Западная Южная Африка * | `southafricawest` |
| Открытый | ОАЭ | Центральная часть ОАЭ * | `uaecentral` |
| Открытый | ОАЭ | Северная часть ОАЭ; | `uaenorth` |
| Открытый | Соединенное Королевство | южная часть Соединенного Королевства | `uksouth` |
| Открытый | Соединенное Королевство | западная часть Соединенного Королевства | `ukwest` |
| Открытый | США | Центральная часть США | `centralus` |
| Открытый | США | Восточная часть США | `eastus` |
| Открытый | США | восточная часть США 2 | `eastus2` |
| Открытый | США | Центрально-северная часть США | `northcentralus` |
| Открытый | США | Центрально-южная часть США | `southcentralus` |
| Открытый | США | центрально-западная часть США | `westcentralus` |
| Открытый | США | западная часть США | `westus` |
| Открытый | США | западная часть США 2 | `westus2` |
