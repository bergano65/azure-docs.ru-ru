...
Дополнительные сведения о настройке сетевых функций для Синхронизации файлов Azure см. в следующих статьях:
