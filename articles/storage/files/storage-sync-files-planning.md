...
|-------------|-------------------|--------------|-------------|
| Общие | Азия | Восточная Азия | `eastasia` |
| Общие | Азия | Юго-Восточная Азия | `southeastasia` |
| Общие | Австралия | Восточная Австралия | `australiaeast` |
| Общие | Австралия | Юго-Восточная часть Австралии | `australiasoutheast` |
| Общие | Бразилия | Южная Бразилия | `brazilsouth` |
| Общие | Canada | Центральная Канада | `canadacentral` |
| Общие | Canada | Восточная Канада | `canadaeast` |
| Общие | Европа | Северная Европа | `northeurope` |
| Общие | Европа | Западная Европа | `westeurope` |
| Общие | Франция | Центральная Франция | `francecentral` |
| Общие | Франция | Южная Франция* | `francesouth` |
| Общие | Индия | Центральная Индия | `centralindia` |
| Общие | Индия | Южная Индия | `southindia` |
| Общие | Япония | Восточная Япония | `japaneast` |
| Общие | Япония | Западная Япония | `japanwest` |
| Общие | Корея | Республика Корея, центральный регион | `koreacentral` |
| Общие | Корея | Республика Корея, южный регион | `koreasouth` |
| Общие | ЮАР | Северная часть ЮАР; | `southafricanorth` |
| Общие | ЮАР | Западная часть ЮАР* | `southafricawest` |
| Общедоступные | ОАЭ | Центральная часть ОАЭ* | `uaecentral` |
| Общие | ОАЭ | Северная часть ОАЭ; | `uaenorth` |
| Общие | Соединенное Королевство | южная часть Соединенного Королевства | `uksouth` |
| Общие | Соединенное Королевство | западная часть Соединенного Королевства | `ukwest` |
