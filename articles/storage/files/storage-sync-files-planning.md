...
В этой статье в первую очередь рассматриваются соображения развертывания для развертывания синхронизации файлов Azure. Для планирования развертывания файлов Azure, которые будут непосредственно установлены на месте или в облаке клиента, [см. Планирование развертывания Azure Files.](storage-files-planning.md)
...
Azure File Sync не взаимодействует с NTFS Encrypted File System (NTFS EFS) или решениями шифрования сторонних сторон, которые находятся над файловой системой, но ниже потока данных файла. 
