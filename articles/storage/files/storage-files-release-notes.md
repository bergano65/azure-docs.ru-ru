...
|----|----------------------|--------------|------------------|
| V10 Релиз - [KB4522359](https://support.microsoft.com/en-us/help/4522409/azure-file-sync-agent-v10-release-march-2020)| 10.0.0.0 | 9 апреля 2020 г. | Поддерживается |
...
- Различные улучшения производительности и надежности
    ...
    - Больше не будет ограничен обезборателем безопасности 2KB для синхронизации дискреционных списков управления доступом (DACLs).  
