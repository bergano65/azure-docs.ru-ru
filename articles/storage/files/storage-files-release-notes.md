...
| Выпуск версии 4 | 4.0.1.0 — 4.3.0.0 | Недоступно | Не поддерживается — версии агента истек 6 ноября 2019 |
| V3 выпуск | 3.1.0.0 — 3.4.0.0 | Недоступно | Не поддерживается. срок действия версий агента истек 19 августа, 2019 |
| Агенты с префиксом pre-GA | 1.1.0.0 — 3.0.13.0 | Недоступно | Не поддерживается. Версии агента истекли 1 октября 2018 г. |
