...
- Поддержка самостоятельного восстановления
    - Теперь пользователи могут восстанавливать свои файлы с помощью функции предыдущей версии. До выпуска V9 функция предыдущей версии не поддерживалась на томах с включенным распределением по уровням облака. Эта функция должна быть включена для каждого тома отдельно, на котором существует конечная точка с включенным распределением по уровням облака. Дополнительные сведения см. в разделе  
