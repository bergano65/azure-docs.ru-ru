...
| V5 Релиз | 5.0.2.0 - 5.2.0.0 | Н/Д | Не поддерживается - Агент версии истек 18 марта 2020 |
| Выпуск версии 4 | 4.0.1.0 - 4.3.0.0 | Н/Д | Не поддерживается - Версия агента истек лавка 6 ноября 2019 г. |
| V3 Релиз | 3.1.0.0 - 3.4.0.0 | Н/Д | Не поддерживается - Версия агента истек 19 августа 2019 |
| Агенты pre-GA | 1.1.0.0 — 3.0.13.0 | Н/Д | Не поддерживается. Версии агента истекли 1 октября 2018 г. |
...
- Инструмент оценки теперь определяет файлы или каталоги, которые заканчиваются периодом
    - [Инструмент оценки](https://docs.microsoft.com/azure/storage/files/storage-sync-files-planning#evaluation-cmdlet) был обновлен для идентификации файлов или каталогов, которые заканчиваются периодом. Файлы или каталоги, которые заканчиваются периодом, в настоящее время не поддерживаются синхронизацией файлов Azure. Чтобы использовать обновленную версию [инструмента оценки,](https://docs.microsoft.com/azure/storage/files/storage-sync-files-planning#evaluation-cmdlet)установите последнюю версию [модуля Azure PowerShell.](https://docs.microsoft.com/powershell/azure/install-az-ps)
