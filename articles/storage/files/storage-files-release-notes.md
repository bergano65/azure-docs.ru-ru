...
|----|----------------------|--------------|------------------|
| V10 Release — [KB4522359](https://support.microsoft.com/en-us/help/4522409/azure-file-sync-agent-v10-release-march-2020)| 10.0.0.0 | 9 апреля 2020 г. | В полете |
...
| Версия V5 | 5.0.2.0 — 5.2.0.0 | Недоступно | Не поддерживается. срок действия версий агента истек 18 марта 2020 г. |
