...
|----|----------------------|--------------|------------------|
| V9 Release — [KB4522359](https://support.microsoft.com/help/4522359)| 9.0.0.0 | 2 декабря 2019 г. | Поддерживается — перелет |
| V8 Release — [KB4511224](https://support.microsoft.com/help/4511224)| 8.0.0.0 | 8 октября 8, 2019 г. | Поддерживается |
