...
|----|----------------------|--------------|------------------|
| Выпуск версии 5 — [KB4459989](https://support.microsoft.com/help/4459989)| 5.0.2.0 | 12 февраля 2019 г. | Поддерживается (рекомендуемая версия) |
...
| Агенты с истекшим сроком действия | 1.1.0.0 — 3.0.13.0 | Недоступно | Не поддерживается. Версии агента истекли 1 октября 2018 г. |
