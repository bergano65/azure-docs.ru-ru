...
| Веха | Номер версии агента | Дата выпуска | Сообщение о состоянии |
|----|----------------------|--------------|------------------|
| Накопительный пакет обновления за Июль 2019 — [KB4490497](https://support.microsoft.com/help/4490497)| 7.2.0.0 | 24 июля 2019 г. | Поддерживается — [перелет](https://docs.microsoft.com/azure/storage/files/storage-files-release-notes#automatic-agent-lifecycle-management) |
| Накопительный пакет обновления за Июль 2019 — [KB4490496](https://support.microsoft.com/help/4490496)| 7.1.0.0 | 12 июля 2019 г. | Поддерживается — [перелет](https://docs.microsoft.com/azure/storage/files/storage-files-release-notes#automatic-agent-lifecycle-management) |
...
| Накопительный пакет обновлений за январь 2019 г. — [KB4481059](https://support.microsoft.com/help/4481059)| 4.3.0.0 | 14 января 2019 г. | Поддерживается |
| Накопительный пакет обновлений за декабрь 2018 г. — [KB4459990](https://support.microsoft.com/help/4459990)| 4.2.0.0 | 10 декабря, 2018 г. | Поддерживается |
| Накопительный пакет обновлений за декабрь 2018 г. | 4.1.0.0 | 4 декабря 2018 г. | Поддерживается |
| Выпуск версии 4 | 4.0.1.0 | 13 ноября 2018 г. | Поддерживается |
...
- Поддержка больших размеров файловых ресурсов
    - При предварительном просмотре больших файловых ресурсов Azure мы также повышаем ограничения поддержки для синхронизации файлов. В этом первом шаге Синхронизация файлов Azure теперь поддерживает до 25TB и 50million файлов в одном синхронизированном пространстве имен. Чтобы применить для просмотра большой общей папки, заполните эту форму https://aka.ms/azurefilesatscalesurvey. 
