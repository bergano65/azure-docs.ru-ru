...
Синхронизация файлов Azure работает на экземплярах Windows Server с прямым подключением к хранилищу (DAS). Она не поддерживает синхронизацию с Linux или с удаленным общим ресурсом SMB.
