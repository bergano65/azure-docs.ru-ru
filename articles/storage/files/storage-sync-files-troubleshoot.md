...
1. Откройте диспетчер задач на сервере и убедитесь, что процесс отслеживания синхронизации хранилища (AzureStorageSyncMonitor.exe) запущен. Если процесс не запущен, попробуйте сначала перезапустить сервер. Если перезапуск сервера не решил эту проблему, обновите агент службы "Синхронизация файлов Azure" до версии [3.3.0.0]( https://support.microsoft.com/help/4457484/update-rollup-for-azure-file-sync-agent-september-2018).
