...
| 0x80070005 | -2147024891 | E_ACCESSDENIED | Файл имеет состояние "Ожидание удаления" | Файл будет удален после закрытия всех открытых дескрипторов файлов. |
| 0x80070020 | — 2147024864 | ERROR_SHARING_VIOLATION | Невозможно синхронизировать файл, так как он используется. По завершении использования файла он будет синхронизирован. | Никаких действий не требуется. |
