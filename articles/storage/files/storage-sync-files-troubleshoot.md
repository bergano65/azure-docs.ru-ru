...
| 0x80070001 | — 2147942401 | ERROR_INVALID_FUNCTION | Не удалось прослойировать файл, так как не работает драйвер фильтра уровня облака (storagesync. sys). | Чтобы устранить эту проблему, откройте командную строку с повышенными привилегиями и выполните следующую команду: флтмк Load storagesync <br>Если не удается загрузить драйвер фильтра storagesync при выполнении команды флтмк, удалите агент Синхронизация файлов Azure, перезапустите сервер и переустановите агент Синхронизация файлов Azure. |
