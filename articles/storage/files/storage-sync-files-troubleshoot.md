...
- На сервере достигнуто максимальное количество параллельных сеансов синхронизации. 
    - Версия агента 4. x и более новая: ограничение зависит от доступных системных ресурсов.
    - Версия агента 3. x: 2 активные сеансы синхронизации на один процессор или максимум 8 активных сеансов синхронизации на один сервер.
