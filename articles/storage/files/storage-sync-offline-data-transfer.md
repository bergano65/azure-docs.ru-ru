...
Процесс, описанный в этой статье, работает не только для Data Box но и для других средств автономной миграции. Она также работает с Интернет-инструментами, такими как AzCopy, Robocopy или партнерские средства и службы. Тем не менее, вы можете устранить проблему начальной отправки, выполнив действия, описанные в этой статье, чтобы использовать эти средства так, как они совместимы с Синхронизация файлов Azure.
