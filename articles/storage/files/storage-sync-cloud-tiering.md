...
В версиях 4,0 и выше агента Синхронизация файлов Azure после того, как файлы были загружены в файловый ресурс Azure, они будут распределены по уровням согласно политикам, как только будет запущен следующий сеанс распределения, что происходит один раз в час. В предыдущих версиях агентов сеанс распределения по уровням мог произойти по истечении 24 часов.
...
Это поведение не относится к Синхронизация файлов Azure, в проводнике Windows отображается «серый крестик» для всех файлов с установленным атрибутом «вне сети». При доступе к файлам по протоколу SMB вы увидите значок X. Подробное описание этого поведения см. в разделе [https://blogs.msdn.microsoft.com/oldnewthing/20170503-00/?p=96105](https://blogs.msdn.microsoft.com/oldnewthing/20170503-00/?p=96105)
