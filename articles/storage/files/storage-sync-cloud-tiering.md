...
При открытии файла, распределенного по уровням, служба Синхронизации файлов Azure отзывает данные файлов из службы файлов Azure, не уведомляя пользователей о том, что файл хранится в Azure. 
 ...
 > [!Important]  
    > Важно! Распределение по уровням в облаке не поддерживается для конечных точек сервера на системных томах Windows. Распределять по уровням в службе файлов Azure можно только файлы размером более 64 КиБ.
