...
В Windows Server 2019 и Синхронизация файлов Azure Agent версии 12 и более поздних также поддерживаются размеры кластеров размером до 2 МБ, а распределение по таким большим размерам кластера работает одинаково. Более старые версии ОС или агента поддерживают кластеры размером до 64 КБ.
