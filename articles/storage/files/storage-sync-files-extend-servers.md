...
После установки **агента службы синхронизации файлов Azure** пользовательский интерфейс регистрации сервера запустится автоматически. Если нет, его можно открыть вручную из расположения файла: C:\Program Files\Azure\StorageSyncAgent\ServerRegistration.exe.
