...
Настроив VPN для конкретной учетной записи хранения, трафик будет проходить через защищенный туннель, а не через Интернет. Следуйте [инструкциям, чтобы настроить VPN](https://github.com/Azure-Samples/azure-files-samples/tree/master/point-to-site-vpn-azure-files
...
Ошибка Ааддстенантнотфаунд возникает при попытке [включить проверку подлинности службы домена Azure Active Directory (AAD DS) для файлов Azure](https://docs.microsoft.com/azure/storage/files/storage-files-active-directory-enable) в учетной записи хранения, где [Служба домена AAD (AAD DS)](https://docs.microsoft.com/azure/active-directory-domain-services/active-directory-ds-overview) не создана в клиенте AAD связанной подписки.  
