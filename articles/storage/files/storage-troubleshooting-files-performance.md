...
8. Определите **Параметры оповещений** (порог, оператор, степень гранулярности и частота агрегирование), которые используются для вычисления правила генерации оповещений метрики, и нажмите кнопку **Готово**.
