...
2. Предварительное заполнение файловых ресурсов Azure данными сервера с помощью любого средства передачи данных по протоколу SMB. Например, Robocopy. Вы также можете использовать AzCopy поверх остальных. Не забудьте использовать AzCopy с соответствующими параметрами для сохранения меток времени и атрибутов ACL.
