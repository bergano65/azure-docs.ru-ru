...
Файлы "премиум" используют учетная запись хранения уникальный **хранилища (Предварительная версия)**, эта учетная запись имеет целевые показатели масштабируемости немного отличается, чем учетная запись хранения, используемая стандартные файлы. Целевые показатели масштабируемости учетной записи хранилища, см. в таблице в [целевые показатели масштабируемости учетной записи службы хранилища Azure](#azure-storage-account-scale-targets) раздел.
...
- [Целевые показатели масштабируемости и производительности для других служб хранилища](../common/storage-scalability-targets.md)
