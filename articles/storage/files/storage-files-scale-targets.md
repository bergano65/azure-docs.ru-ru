...
> Список ограничений, региональных сведений и инструкций по включению этих больших размеров файловых ресурсов см. в разделе подключение [к большим файловым ресурсам](storage-files-planning.md#enable-standard-file-shares-to-span-up-to-100-tib) в статье Планирование.
...
| Память | 128 ГБ |
| Дисковое пространство | Диски SAS с RAID 10 и кэшем, работающем от аккумулятора |
| Сеть | Сеть 1 Гбит/с |
