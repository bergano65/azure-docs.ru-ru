...
> [!WARNING]
> После перемещения всех данных с сервера NAS на сервер Windows Server и завершения миграции: Вернитесь ко ***всем*** группам синхронизации в портал Azure и измените значение процента свободного места на уровне облака на более подходящее для использования кэша, скажем, 20%. 
