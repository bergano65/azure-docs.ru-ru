...
На сервере Windows с установленным агентом Синхронизация файлов Azure можно просматривать распределение по уровням облака, зарегистрированному серверу и работоспособности синхронизации.
