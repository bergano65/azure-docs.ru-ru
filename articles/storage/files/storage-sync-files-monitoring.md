...
**Просмотр метрик Синхронизация файлов Azure в Azure Monitor**
- Перейдите к **службе синхронизации хранилища** в **портал Azure** и щелкните **метрики**.
- Щелкните раскрывающийся список **Метрика** и выберите метрику, которую необходимо просмотреть.
...
С помощью оповещений можно заранее получать уведомления о важных условиях, обнаруженных в ваших данных мониторинга. Дополнительные сведения о настройке оповещений в Azure Monitor см. в разделе [Обзор оповещений в Microsoft Azure](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-overview).

**Создание оповещений для Синхронизация файлов Azure**

- Перейдите к **службе синхронизации хранилища** в **портал Azure**. 
- Щелкните **оповещения** в разделе Мониторинг, а затем щелкните **+ новое правило генерации оповещений**.
- Щелкните **Выбрать условие** и укажите следующие сведения для оповещения. 
    - **Метрика**
    - **Имя измерения**
    - **Логика оповещений**
- Щелкните **выбрать группу действий** и добавьте группу действий (электронная почта, SMS и т. д.) в предупреждение либо выбрав существующую группу действий, либо создав новую группу действий.
- Заполните **сведения о предупреждении** , такие как **имя правила оповещения**, **Описание** и **серьезность**.
...
10. Выберите **Создать правило генерации оповещений**. 
