...
| Синхронизировано файлов | Число отправленных и скачанных файлов.<br><br>Единица измерения: Count<br>Тип агрегирования: Sum<br>Применимые измерения. Имя конечной точки сервера, направление синхронизации, имя группы синхронизации |
| Пульс сервера | Число пульсов, полученных от сервера.<br><br>Единица измерения: Count<br>Тип агрегирования: Максимальная<br>Применяемые измерения: Имя сервера |
