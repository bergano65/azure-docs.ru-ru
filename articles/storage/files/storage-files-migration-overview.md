...
Для приложения, которое в данный момент выполняется на локальном сервере, может быть хорошим выбором хранение файлов в общей папке Azure. Вы можете переместить приложение в Azure и использовать общие файловые ресурсы Azure в качестве общего хранилища. Для этого сценария можно также использовать [диски Azure](../../virtual-machines/windows/managed-disks-overview.md) .
...
- **Метаданные файла**: метаданные файла имеют следующие компоненты:
   ...
   * Метки времени, особенно в том, что метки времени создания и последнего изменения
...
| Windows Server 2012 R2 и более поздние версии | <ul><li>[Синхронизация файлов Azure](storage-sync-files-deployment-guide.md)</li><li>[Синхронизация файлов Azure и Azure Data Box](storage-sync-offline-data-transfer.md)</li><li>Служба Синхронизация файлов Azure и миграция хранилища</li></ul> | <ul><li>Служба синхронизации файлов Azure</li><li>Синхронизация файлов Azure и Data Box</li><li>Служба Синхронизация файлов Azure и миграция хранилища</li><li>RoboCopy</li></ul> |
...
|![Да, рекомендуется](media/storage-files-migration-overview/circle-green-checkmark.png)| Служба синхронизации файлов Azure | Встроенная интегрирована в файловые ресурсы Azure. | Полная точность. * |
...
|![Не полностью рекомендуется](media/storage-files-migration-overview/triangle-yellow-exclamation.png)| Data Box | Поддерживается. | Не копирует метаданные. [Data Box можно использовать с Синхронизация файлов Azure](storage-sync-offline-data-transfer.md). |
