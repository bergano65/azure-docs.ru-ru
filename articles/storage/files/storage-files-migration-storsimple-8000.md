...
В серии StorSimple 8000 есть два физических устройства. Единственное различие между ними — объем локального кэша (место на диске). Это устройство выполняется в локальном центре обработки данных и действует как кэш данных, хранящихся в Azure.
С объявленным окончанием срока службы в линии продуктов StorSimple на 31 2022 декабря облачная служба, к которой подключено это устройство, перестанет работать.

Очень важно переносить все устройства StorSimple с достаточным временем на запас.
Синхронизация файлов Azure — это естественная технология, которая предоставляет больше возможностей и гибкости, чем предложения StorSimple.

В этой статье содержатся необходимые сведения о фоновом наборе знаний и миграции, которые позволят выполнить миграцию, чтобы Синхронизация файлов Azure успешно.
