...
Серия StorSimple 8000 представлена физическим, локальным устройством и компонентами облачной службы 8100 или 8600. Данные любого из этих устройств можно перенести в среду Синхронизация файлов Azure. Эта статья содержит необходимые фундаментальные знания и миграции для успешной миграции на Синхронизация файлов Azure.
