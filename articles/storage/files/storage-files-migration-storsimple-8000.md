...
* Выберите хранилище уровня "Премиум", если требуется [производительность файлового ресурса Azure](understanding-billing.md#provisioned-billing)уровня "Премиум".
