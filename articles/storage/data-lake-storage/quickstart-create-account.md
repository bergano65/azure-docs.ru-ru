...
ms.locfileid: "51281563"
---
# <a name="quickstart-create-a-storage-account-for-analytics"></a>Краткое руководство. Создание учетной записи хранения для аналитики

Учетные записи хранения с поддержкой Data Lake 2-го поколения (предварительная версия) [поддерживают службу иерархического пространства имен](introduction.md), которая предоставляет нативную файловую систему на основе каталогов, предназначенную для работы с распределенной файловой системой Hadoop (HDFS). Доступ к данным Data Lake Storage Gen2 из распределенной файловой системы Hadoop доступен с помощью [драйвера ABFS](abfs-driver.md).

Чтобы активировать поддержку Data Lake Storage 2-го поколения в своей учетной записи хранения, [заполните анкету и запросите доступ](https://aka.ms/adlsgen2signup). После утверждения вашего запроса вы сможете создать учетную запись хранения с поддержкой Data Lake Storage 2-го поколения. В этом кратком руководстве показано, как создать учетную запись с помощью [портала Azure](https://portal.azure.com/), [Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview) или [Azure CLI](https://docs.microsoft.com/cli/azure?view=azure-cli-latest).
...
> [!NOTE]
> Иерархическое пространство имен доступно во всех публичных областях, но не в частных областях. В настоящее время оно недоступно в национальных облаках.
...
В этом кратком руководстве вы создали учетную запись хранения с поддержкой Data Lake Storage 2-го поколения. Сведения об отправке и скачивании больших двоичных объектов в учетную запись хранения и обратно см. в кратком руководстве по хранилищу BLOB-объектов.

* [Перемещение данных в хранилище BLOB-объектов Azure и из него с помощью AzCopy](https://docs.microsoft.com/azure/machine-learning/team-data-science-process/move-data-to-azure-blob-using-azcopy)