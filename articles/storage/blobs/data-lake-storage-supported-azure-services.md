...
|Запись концентраторов событий Azure| Общедоступная версия|[Сбор событий с помощью концентраторов событий Azure в хранилище BLOB-объектов Azure или Azure Data Lake Storage](https://docs.microsoft.com/azure/event-hubs/event-hubs-capture-overview)|
|Azure Logic Apps|Общедоступная версия|[Обзор. что такое Azure Logic Apps?](https://docs.microsoft.com/azure/logic-apps/logic-apps-overview)|
