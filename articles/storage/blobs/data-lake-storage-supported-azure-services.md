...
|Захват концентраторов Azure Event| Общедоступная версия|[Сбор событий из Центров событий Azure в хранилище BLOB-объектов Azure или Azure Data Lake Storage](https://docs.microsoft.com/azure/event-hubs/event-hubs-capture-overview)|
...
|Когнитивный поиск Azure|Preview (Предварительный просмотр)|[Документы индекса и поиска Azure Data Lake Storage Gen2 (предварительный просмотр)](https://docs.microsoft.com/azure/search/search-howto-index-azure-data-lake-storage)|
|Azure Data Explorer|Preview (Предварительный просмотр)|[Данные о запросах в Azure Data Lake с помощью Azure Data Explorer](https://docs.microsoft.com/azure/data-explorer/data-lake-query-data)|
