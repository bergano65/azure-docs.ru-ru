...
|Azure Data Explorer|Предварительный просмотр|[Запрос данных в Azure Data Lake с помощью обозреватель данных Azure](https://docs.microsoft.com/azure/data-explorer/data-lake-query-data)|
