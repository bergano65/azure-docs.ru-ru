...
description: Имитация ошибки при чтении данных из основного региона, если для учетной записи хранения включено избыточное между зонами хранилище с доступом на чтение (RA-GZRS).
services: storage
author: tamram
ms.service: storage
ms.subservice: blobs
