...
На следующей схеме показано, как можно восстановить удаленный большой двоичный объект при включенном обратимом удалении BLOB-объектов:

:::image type="content" source="media/soft-delete-blob-overview/blob-soft-delete-diagram.png" alt-text="Диаграмма, показывающая, как можно восстановить Обратимо удаленный большой двоичный объект":::
