---
title: 'Настройка производительности: MapReduce, HDInsight & Azure хранения данных озера Gen2 (ru) Документы Майкрософт'
...
---
# <a name="tune-performance-mapreduce-hdinsight--azure-data-lake-storage-gen2"></a>Настройка производительности: MapReduce, HDInsight & Azure Хранения данных озера Gen2
...
**Шаг 1: Определить количество рабочих мест**
...
**Шаг 2: Установите mapreduce.map.memory/mapreduce.reduce.memory**
...
Для настройки mapreduce.job.maps/mapreduce.job.reduces следует учитывать общий объем памяти YARN, доступный для использования.  Эта информация доступна в Ambari.  Перейдите к YARN и просмотрите вкладку Configs.  Память YARN отображается в этом окне.  Чтобы определить общий объем памяти YARN, умножьте объем памяти YARN для одного узла на число узлов в кластере.
...
**Шаг 4: Рассчитать количество контейнеров YARN**
