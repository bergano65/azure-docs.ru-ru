...
2. Откройте Visual Studio и создайте пустое приложение (Native Portable): **Файл > Создать > проект > кросс платформенных > пустое приложение (Native Portable)**.
