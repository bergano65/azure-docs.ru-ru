...
2. Откройте Visual Studio и создайте пустое приложение (собственное переносимое): **Файл > новый проект > > кросс-платформенное > пустое приложение (собственное переносимое)** .
