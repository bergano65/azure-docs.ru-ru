...
Data Lake Storage 2-го поколения позволяет включить брандмауэр и ограничить доступ только службами Azure, что очень полезно для сужения вектора внешних атак. Брандмауэр может быть включен на учетной записи хранения на портале Azure через **Брандмауэр** > **Включить Firewall (ON)** > Разрешить доступ к вариантам**служб Azure.**

Чтобы получить доступ к учетной записи хранения данных из Azure Databricks, разместите в виртуальной сети данные Azure Databricks, а затем добавьте эту виртуальную сеть в брандмауэр. Смотрите [Переусмотрите брандмауэры ИС Лазурного хранилища и виртуальные сети.](https://docs.microsoft.com/azure/storage/common/storage-network-security)
...
Высокий уровень доступности (HA) и аварийное восстановление (DR) иногда можно сочетать, хотя связанные стратегии немного отличаются, особенно при работе с данными. Data Lake Storage 2-го поколения уже выполняет трехкратную репликацию в фоновом режиме для защиты от локальных сбоев оборудования. Кроме того, другие варианты репликации, такие как ЗРС или ГЗРС (предварительный просмотр), улучшают HA, в то время как GRS & RA-GRS улучшают DR. Составляя план для обеспечения высокого уровня доступности, в случае прерывания работы службы нужно как можно быстрее предоставить для рабочей нагрузки доступ к последним данным, выполнив переключение на отдельно реплицированный экземпляр в локальной среде или новом регионе.
