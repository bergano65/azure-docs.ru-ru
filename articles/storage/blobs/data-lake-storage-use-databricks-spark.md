...
Для начала создайте [учетную запись хранения с поддержкой возможностей аналитики](data-lake-storage-quickstart-create-account.md) и присвойте этой учетной записи уникальное имя. Перейдите к учетной записи хранения, чтобы получить параметры конфигурации.
...
14. Скопируйте приведенный ниже код и вставьте его в ячейку **Cmd 1**. Не забудьте заменить значения заполнителей, показанные в примере в скобках, собственными значениями.
    ...
    ```
15. Чтобы выполнить ячейку кода, нажмите клавиши **SHIFT+ВВОД**.
