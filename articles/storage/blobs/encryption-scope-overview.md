...
Если область шифрования защищена с помощью ключей, управляемых клиентом, то можно также удалить связанный ключ в хранилище ключей или управляемый модуль HSM, чтобы отключить область шифрования. Помните, что ключи, управляемые клиентом, защищаются с помощью обратимого удаления и очистки защиты в хранилище ключей или управляемого модуля HSM, а удаленный ключ зависит от поведения, определенного для этих свойств. Дополнительные сведения см. в одном из следующих разделов документации по Azure Key Vault:
