...
| `enabled`      | Логическое значение | Необязательное логическое значение, которое позволяет временно отключить правило. Значение по умолчанию — true, если оно не задано. | Нет | 
...
| Действие                      | Базовый BLOB-объект                                  | Снимок      | Версия
|-----------------------------|--------------------------------------------|---------------|---------------|
