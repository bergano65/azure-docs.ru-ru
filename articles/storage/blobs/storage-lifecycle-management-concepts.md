...
Функция управления жизненным циклом не взимается. Клиентам выставляются счета за обычные операции для вызовов API [уровня большого двоичного объекта](/rest/api/storageservices/set-blob-tier) . Операция удаления бесплатна. Дополнительные сведения см. на странице [цен на блочные BLOB-объекты](https://azure.microsoft.com/pricing/details/storage/blobs/).
