...
Функция управления жизненным циклом доступна во всех глобальных регионах Azure и Azure для государственных организаций.
...
| `enabled`      | Логическое | Необязательное логическое значение, которое позволяет временно отключить правило. Значение по умолчанию — true, если оно не задано. | False | 
