...
- Чтобы получить сведения о производительности уровня "Премиум" для блочных BLOB-объектов, необходимо использовать тип учетной записи Блоккблобстораже.
