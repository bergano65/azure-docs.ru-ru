...
description: Руководство по Поиск неструктурированных данных в хранилище BLOB-объектов Azure с помощью службы поиска Azure.
author: roygara
services: storage
ms.service: storage
ms.topic: tutorial
...
ms.locfileid: "65150793"
---
# <a name="tutorial-search-unstructured-data-in-cloud-storage"></a>Руководство по Поиск неструктурированных данных в облачном хранилище
