...
3. Откройте файл проекта (*. csproj*) в текстовом редакторе и добавьте эти ссылки на пакеты внутри элемента \<Project.\>
...
- Ссылки на столбцы указываются `_N` в том виде, в `_1`котором находится первый столбец. Если исходный файл содержит строку заголовка, то можно ссылаться на столбцы по имени, указанному в строке заголовка. 
