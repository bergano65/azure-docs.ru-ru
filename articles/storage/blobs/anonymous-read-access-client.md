...
Служба хранилища Azure поддерживает анонимный общий доступ на чтение для контейнеров и больших двоичных объектов. Клиенты могут анонимно обращаться к открытым контейнерам и BLOB-объектам с помощью клиентских библиотек службы хранилища Azure, а также с помощью других средств и служебных программ, поддерживающих доступ к данным в службе хранилища Azure.

В этой статье показано, как получить доступ к открытому контейнеру или BLOB-объекту из .NET. Дополнительные сведения о настройке анонимного доступа на чтение в контейнере см. в разделе. Сведения о предотвращении анонимного доступа к учетной записи хранения см. в разделе.
