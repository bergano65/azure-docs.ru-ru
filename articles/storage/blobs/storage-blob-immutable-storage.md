...
> [!TIP]
> **Пример:** Пользователь создает политику хранения на основе времени с интервалом хранения в пять лет.
>
