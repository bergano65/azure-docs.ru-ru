...
ms.locfileid: "65787860"
---
# <a name="set-and-retrieve-properties-and-metadata"></a>Задание и получение свойств и метаданных

Кроме данных, которые они содержат, объекты в службе хранилища Azure поддерживают свойства системы и пользовательские метаданные. В этой статье описывается управление свойствами системы и определяемыми пользователем метаданными с помощью [клиентской библиотеки хранилища Azure для .NET](/dotnet/api/overview/azure/storage/client).
...
* [Клиентская библиотека хранилища Azure для .NET](/dotnet/api/?term=Microsoft.Azure.Storage)
* [BLOB-объектов клиентской библиотеки хранилища Azure для пакета .NET](https://www.nuget.org/packages/Microsoft.Azure.Storage.Blob/)
* [Очередь клиентская библиотека хранилища Azure для пакета .NET](https://www.nuget.org/packages/Microsoft.Azure.Storage.Queue/)
* [Файл клиентская библиотека хранилища Azure для пакета .NET](https://www.nuget.org/packages/Microsoft.Azure.Storage.File/)
