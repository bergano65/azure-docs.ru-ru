...
7. При необходимости измените значения в каждом из этих полей: **производительность**, **репликация**, **уровень доступа**. Дополнительные сведения об этих параметрах см. в статье Общие сведения о [службе хранилища Azure](https://docs.microsoft.com/azure/storage/common/storage-introduction#introducing-the-azure-storage-services).
