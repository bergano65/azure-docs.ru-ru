...
Время последнего изменения уровня большого двоичного объекта определяет атрибут **Access Tier Change Time** свойства большого двоичного объекта. Если большой двоичный объект находится на уровне архива, он не может быть перезаписан, поэтому отправка такого же большого двоичного объекта не разрешена в этом сценарии. При перезаписи большого двоичного объекта на горячий или холодном уровне новый большой двоичный объект наследует уровень перезаписанного большого двоичного объекта.
...
- **Затраты на транзакции**. Для каждого уровня, который увеличивается по мере того, как уровень становится еще больше, взимается плата за каждую транзакцию.
