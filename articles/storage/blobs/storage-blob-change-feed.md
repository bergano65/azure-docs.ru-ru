...
4. Нажмите кнопку **сохранить** , чтобы подтвердить параметры **защиты данных** .
    ...
    ![Снимок экрана, на котором показаны параметры защиты данных.](media/soft-delete-enable/storage-blob-soft-delete-portal-configuration.png)
