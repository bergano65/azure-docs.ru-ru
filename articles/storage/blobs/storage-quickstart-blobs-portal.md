...
3. Нажмите кнопку **Отправить**, чтобы открыть колонку отправки.
4. В локальной файловой системе найдите файл, который нужно отправить в виде блочного BLOB-объекта.
...
5. При необходимости разверните раздел "Дополнительно", чтобы задать другие параметры, такие как тип проверки подлинности, уровень доступа или путь к виртуальной папке.
6. Нажмите кнопку **Отправить**, чтобы выполнить отправку.
7. Таким способом можно отправить необходимое количество больших двоичных объектов. Вы увидите, что новые большие двоичные объекты содержатся в контейнере.
