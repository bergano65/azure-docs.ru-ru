...
События хранилища BLOB-объектов надежно отправляются в службу сетки событий, которая предоставляет службы надежной доставки для приложений с помощью политики повтора с широкими возможностями и доставки недоставленных сообщений. Дополнительные сведения см. в разделе [доставки сообщений сетки событий и повторите попытку](https://docs.microsoft.com/azure/event-grid/delivery-and-retry).
...
> |-------------------|------------------------|-----------------------------------------------------------------------|
> |topic|string|Полный идентификатор Azure Resource Manager учетной записи хранения, которая создает событие.|
...
|data.blobType|string|Тип большого двоичного объекта. Допустимые значения: BlockBlob или PageBlob.| 
