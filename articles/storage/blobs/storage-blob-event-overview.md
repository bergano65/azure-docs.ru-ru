...
> * События хранения гарантируют доставку абонентам по крайней мере один раз, что гарантирует вывод всех сообщений. Однако из-за повторного использования или доступности подписок иногда могут возникать дублирующиеся сообщения. Чтобы узнать больше о доставке [Event Grid message delivery and retry](../../event-grid/delivery-and-retry.md)сообщений и повторной попытке, см.
