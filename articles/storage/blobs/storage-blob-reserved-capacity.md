...
1. Заполните обязательные поля, как описано в следующей таблице.
   ...
   | **Избыточность** | Параметр избыточности для резервирования. К параметрам относятся *LRS*, *ZRS*, *GRS*и *RA-гзрс*. Дополнительные сведения о параметрах избыточности см. в статье [избыточность службы хранилища Azure](../common/storage-redundancy.md). |
