...
Вы можете приобрести зарезервированную емкость хранилища Azure в единицах 100 Тиб и 1 ПИБ в месяц в течение одного или трех лет.
...
Резервирования доступны сегодня для 100 Тиб или 1 блоков ПИБ с более высокими скидками для 1 ПИБ блоков. При покупке резервирования в портал Azure Корпорация Майкрософт может предоставить рекомендации на основе предыдущего использования, чтобы определить, какое резервирование следует приобрести.
