...
Вы можете приобрести зарезервированную емкость хранилища Azure с помощью [портал Azure](https://portal.azure.com). Платите за резервирование наперед или ежемесячными платежами. Дополнительные сведения о приобретении с ежемесячными платежами см. в статье [приобретение резервирований Azure с использованием предварительных или ежемесячных выплат](/azure/billing/billing-monthly-payments-reservations).
...
1. Заполните обязательные поля, как описано в следующей таблице.
   ...
   | **Избыточность** | Параметр избыточности для резервирования. Возможные варианты: *LRS*, *ZRS*, *GRS*, *гзрс*, *RA-GRS*и *RA-гзрс*. Дополнительные сведения о параметрах избыточности см. в статье [избыточность службы хранилища Azure](../common/storage-redundancy.md). |
