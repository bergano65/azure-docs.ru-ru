...
1. Для имени узла источника введите конечную точку статического веб-сайта. Чтобы найти конечную точку статического веб-сайта, перейдите к разделу **Статический веб-сайт** для своей учетной записи хранения и скопируйте конечную точку (удалите предыдущий https://)
1. Проверьте конечную точку CDN, перейдя по адресу *mywebsitecdn.azureedge.net* в браузере.
1. Дополнительно проверьте ее, перейдя к параметру **Создать конечную точку** в разделе "Параметры", чтобы проверить, задано ли для типа источника значение *Настраиваемый источник* и отображается ли в параметре *Имя узла источника* имя конечной точки статического веб-сайта.
