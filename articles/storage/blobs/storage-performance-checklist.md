...
- Для Java/Android позвоните по методу [BlobRequestOptions.setConcurrentRequestCount (окончательный integer concurrentRequestCount).](/java/api/com.microsoft.azure.storage.blob.blobrequestoptions.setconcurrentrequestcount)
