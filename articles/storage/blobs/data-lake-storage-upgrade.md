...
| Журналы диагностики                                                                                        | [Ссылка](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Доступно сейчас* (Предварительная версия). См. [Известные проблемы](data-lake-storage-known-issues.md). <br>Интеграция мониторинга Azure — *пока недоступна* |
