...
Схема универсального кода ресурса (URI) для доступа к Data Lake Storage 2-го поколения файлам подробно описана, но [, в общем](../../hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2.md) , это `abfss://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.windows.net/<PATH>`.
