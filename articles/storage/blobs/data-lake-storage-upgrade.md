...
Описывается схема URI для доступа к файлам Gen2 хранилища Озера данных [здесь](https://docs.microsoft.com/azure/storage/data-lake-storage/use-hdi-cluster) в подробности, но вообще говоря, это `abfss://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.widows.net/<PATH>`.
