...
: heavy_check_mark: оперативная информация
...
| Операции с данными — журналы  | ДА | ДА | *Доступно сейчас* (Предварительная версия). См. раздел [Известные проблемы](data-lake-storage-known-issues.md).<br><br> Интеграция со службой мониторинга Azure. *Пока недоступно*. |
...
| Пакеты SDK для разработчиков | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| Пакет SDK для BLOB-объектов *доступен сейчас*. [Пакет SDK для Azure Data Lake Storage 2-го поколения](https://azure.microsoft.com/blog/extended-filesystem-programming-capabilities-in-azure-data-lake-storage/)- *доступен — .NET, Java, Python (общедоступная Предварительная версия)*  |
...
| Управление данными                             | Срок действия файлов                                                                                                                                        | Политики жизненного цикла                                                                                                                                                                                                                                                                                                                                                                                                          | Политики жизненного цикла *доступны сейчас* (Предварительная версия). См. раздел [Известные проблемы](data-lake-storage-known-issues.md).                                                                                                                     |
...
|                     | Qubole       |                      | [Ссылка](https://www.qubole.com/blog/big-data-analytics-microsoft-azure-data-lake-store-qubole/)                                                                                            | [Ссылка](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4c-configure-azure-data-lake-gen-2-storage-with-keys)                                                                                                  | [Ссылка](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4d-configure-azure-data-lake-gen-2-storage-with-tokens)                                                                                                 |
...
| Журналы диагностики                                                                                        | [Ссылка](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *Доступно сейчас* (Предварительная версия). См. раздел [Известные проблемы](data-lake-storage-known-issues.md). <br>Интеграция мониторинга Azure — *пока недоступна* |
