...
Чтобы восстановить большой двоичный объект до определенного обратимо удаленного моментального снимка, можно вызвать `Undelete Blob` для базового большого двоичного объекта. Затем вы можете скопировать моментальный снимок в активный большой двоичный объект. Его также можно скопировать в новый большой двоичный объект.
...
# <a name="clitabazure-cli"></a>[ИНТЕРФЕЙС КОМАНДНОЙ СТРОКИ](#tab/azure-CLI)
...
Да, обратимое удаление доступно для всех уровней хранилища, включая горячий, холодное и архивный. Однако обратимое удаление не предоставляет защиту от перезаписи для больших двоичных объектов на архивном уровне.
