...
| Ограничьте анонимный общий доступ на чтение к контейнерам и BLOB-объектам | Анонимный, Открытый доступ на чтение к контейнеру и его BLOB-объектам предоставляет доступ только для чтения к этим ресурсам любому клиенту. Не разрешайте общий доступ на чтение, если это не требуется для вашего сценария. | - |

## <a name="networking"></a>Сеть

| Рекомендация | Комментарии | Центр безопасности |
|-|----|--|
| Включение правил брандмауэра | Настройте правила брандмауэра, чтобы ограничить доступ к учетной записи хранения для запросов, исходящих из указанных IP-адресов или диапазонов, или из списка подсетей в виртуальной сети Azure. Дополнительные сведения о настройке правил брандмауэра см. в разделе [Синхронизация файлов Azure параметры прокси-сервера и брандмауэра](../files/storage-sync-files-firewall-and-proxy.md). | - |
...
- [Документация по системе безопасности Azure](https://docs.microsoft.com//azure/security/)
