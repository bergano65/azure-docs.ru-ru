...
Нельзя использовать списки управления доступом для обеспечения уровня доступа, который меньше, чем уровень, предоставленные назначение ролей. Например, если вы назначаете [участник для данных больших двоичных объектов хранилища](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles#storage-blob-data-contributor) перечислены роли для субъекта безопасности, то нельзя использовать управление доступом для предотвращения этого участника безопасности производить запись в каталог.
