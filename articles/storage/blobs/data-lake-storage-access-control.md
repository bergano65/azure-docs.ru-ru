...
> [!NOTE]
> Если разрешения предоставляются только с помощью списков управления доступом (без RBAC), то чтобы предоставить субъекту-службе доступ на чтение или запись к файлу, необходимо предоставить субъекту-службе разрешения на **выполнение** для контейнера и в каждую папку в иерархии папок, которые привести к файлу.
