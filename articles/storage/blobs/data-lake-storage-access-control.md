...
> [! ИМПОРАНТ] в этой таблице предполагается, что используются **только** списки ACL без назначений ролей Azure. Для просмотра подобной таблицы, объединяющей Azure RBAC вместе с списками ACL, см. раздел [Таблица разрешений: объединение Azure RBAC и ACL](data-lake-storage-access-control-model.md#permissions-table-combining-azure-rbac-and-acl).
