...
|||
|--------|-----------|
|Обозреватель хранилища Azure |[Использование Обозреватель службы хранилища Azure для управления каталогами, файлами и списками ACL в Azure Data Lake Storage 2-го поколения](data-lake-storage-explorer.md#managing-access)|
...
|Интерфейс командной строки Azure|[Использование Azure CLI для управления каталогами, файлами и списками ACL в Azure Data Lake Storage 2-го поколения](data-lake-storage-directory-file-acl-cli.md)|
