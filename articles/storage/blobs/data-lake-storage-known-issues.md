...
В настоящее время следующие возможности не поддерживаются в клиентской библиотеке Data Lake для PowerShell, Azure CLI, Java, Python и пакета SDK для .NET: `RecursiveACL`, `setExpiry`, `Concat` и `ConcurrentAppend`.
