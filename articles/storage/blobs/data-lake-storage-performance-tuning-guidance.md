---
title: Оптимизация хранения данных Azure Data Lake Gen2 для производительности (ru) Документы Майкрософт
...
ms.locfileid: "74327944"
---
# <a name="optimize-azure-data-lake-storage-gen2-for-performance"></a>Оптимизация хранения данных Azure Data Lake Gen2 для производительности
...
|--------------------|------------------------------------------------------|------------------------------|
| DistCp            | -m (mapper)   | [Ссылку](data-lake-storage-use-distcp.md#performance-considerations-while-using-distcp)                             |
