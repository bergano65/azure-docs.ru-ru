...
| [Storm в HDInsight](data-lake-storage-performance-tuning-storm.md)| <ul><li>Количество рабочих процессов</li><li>количество экземпляров исполнителей элемента spout;</li><li>Количество экземпляров исполнителей сита </li><li>Количество задач воронки</li><li>количество задач элемента bolt.</li></ul>|
