...
Промежуточный метод рассматривается в разделе [Регистрация личного домена с помощью поддомена *asverify*](#register-a-custom-domain-using-the-asverify-subdomain).
...
Если личный домен поддерживает приложение, не допускающее простоя, то следует использовать процедуру, описанную в разделе [Регистрация личного домена с помощью поддомена *asverify*](#register-a-custom-domain-using-the-asverify-subdomain).
