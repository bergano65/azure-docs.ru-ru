...
> [!WARNING]
> Удаление учетной записи хранения невозможно отменить. Обратимое удаление не защищает от удаления учетной записи хранения, но только для удаления объектов данных в этой учетной записи. Чтобы защитить учетную запись хранения от удаления, Настройте блокировку **CannotDelete** для ресурса учетной записи хранения. Дополнительные сведения о блокировке ресурсов Azure Resource Manager см. [в разделе Блокировка ресурсов для предотвращения непредвиденных изменений](../../azure-resource-manager/management/lock-resources.md).
