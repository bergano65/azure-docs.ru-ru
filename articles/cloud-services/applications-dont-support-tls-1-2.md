...
> [!NOTE]
> В выпуске семейства 6 гостевой ОС протокол TLS 1.2 принудительно применяется путем явного отключения протоколов TLS 1.0 и 1.1 и определения конкретного набора шифров. Дополнительные сведения о семействах гостевых ОС см. в статье о [выпуске гостевой ОС](https://docs.microsoft.com/azure/cloud-services/cloud-services-guestos-update-matrix#family-6-releases).
