---
title: Что такое облачные службы Azure (классическая модель) | Документация Майкрософт
description: Узнайте о том, что такое облачные службы Azure, в частности, что оно предназначено для поддержки масштабируемых, надежных и недорогих приложений.
ms.topic: article
...
ms.locfileid: "98742817"
---
# <a name="overview-of-azure-cloud-services-classic"></a>Обзор облачных служб Azure (классическая модель)
