...
>[!NOTE]
>Мартовская Гостевая ОС в настоящее время внедряется на чаты для облачных сервисов, которые настроены для автоматических обновлений. После завершения выпуска эта версия будет доступна для обновления вручную через портал Azure и файлы конфигурации. Следующие патчи включены в мартовский гостевой Os. Этот список подлежит изменению.
