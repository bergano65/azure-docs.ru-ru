...
>[!NOTE]
>Гостевая ОС может сейчас разворачивается для виртуальных машин облачной службы, которые настроены для автоматического обновления. После завершения выпуска эта версия будет доступна для обновления вручную через портал Azure и файлы конфигурации. В гостевой ОС может включаются следующие обновления. Этот список подлежит изменению.
