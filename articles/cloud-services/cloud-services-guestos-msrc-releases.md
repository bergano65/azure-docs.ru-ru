...
>[!NOTE]
>Апрельская гостевая ОС сейчас развертывается для виртуальных машин облачной службы, которые настроены для автоматического обновления. После завершения выпуска эта версия будет доступна для обновления вручную через портал Azure и файлы конфигурации. Следующие исправления включены в гостевой ОС за апрель. Этот список подлежит изменению.
