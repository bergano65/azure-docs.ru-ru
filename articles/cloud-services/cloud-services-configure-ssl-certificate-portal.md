...
ms.locfileid: "61434105"
---
# <a name="configuring-ssl-for-an-application-in-azure"></a>Настройка SSL для приложения в Azure

Шифрование SSL — это наиболее часто используемый метод защиты данных, отправляемых по Интернету. В данной стандартной задаче описывается указание конечной точки по протоколу HTTPS для веб-роли и передача SSL-сертификата для обеспечения безопасности приложения.
...
## <a name="step-2-modify-the-service-definition-and-configuration-files"></a>Шаг 2. Изменять файлы определения и конфигурации службы
...
## <a name="step-3-upload-a-certificate"></a>Шаг 3. Отправить сертификат
...
## <a name="step-4-connect-to-the-role-instance-by-using-https"></a>Шаг 4. Подключитесь к экземпляру роли по протоколу HTTPS
