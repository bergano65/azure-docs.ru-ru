...
Вы можете удалить облачную службу, передав ей имя службы в метод **удаления\_размещенной\_службы** .
...
Чтобы добавить образ операционной системы в репозиторий образов, используйте метод **\_Add OS\_Image** .
...
Чтобы записать образ виртуальной машины, сначала необходимо вызвать метод **Capture\_VM\_Image** .
...
## <a name="next-steps"></a><a name="What's Next"> </a>Дальнейшие шаги
