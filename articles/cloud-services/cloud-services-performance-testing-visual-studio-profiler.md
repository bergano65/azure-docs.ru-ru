...
При публикации облачной службы в Azure вы можете выполнять сбор данных профилирования в Visual Studio, а затем анализировать их локально, как описано в разделе [Профилирование приложения Azure][1].
Кроме того, можно использовать диагностику для трассировки различных счетчиков производительности, как описано в разделе [Использование счетчиков производительности в Azure][2].
