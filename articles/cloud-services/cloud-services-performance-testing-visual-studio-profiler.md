---
title: Профилирование облачной службы (классической) локально в эмуляторе вычислений | Документация Майкрософт
...
ms.locfileid: "98743565"
---
# <a name="testing-the-performance-of-a-cloud-service-classic-locally-in-the-azure-compute-emulator-using-the-visual-studio-profiler"></a>Локальное тестирование производительности облачной службы (классическая модель) в эмуляторе вычислений Azure с помощью профилировщика Visual Studio
...
![Предупреждения, связанные с производительностью][14]
