...
| --------- | ---- | ----------- |
|name|string|Обязательный. Имя рабочей роли. Это имя должно быть уникальным.|
...
|протокол|string|Обязательный. Транспортный протокол для внешней конечной точки. Для рабочей роли возможными значениями могут быть `HTTP`, `HTTPS`, `UDP` или `TCP`.|
