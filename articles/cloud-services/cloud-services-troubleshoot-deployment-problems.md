...
## <a name="problem-i-cannot-access-my-website-but-my-deployment-is-started-and-all-role-instances-are-ready"></a>Проблема. Я не могу получить доступ к веб-сайту, но мое развертывание запущено и все экземпляры роли готовы
...
## <a name="problem-my-role-instances-recycled-without-me-doing-anything"></a>Проблема. Мои экземпляры роли перезапущены без выполнения каких-либо действий
...
## <a name="problem-i-cannot-do-a-vip-swap-and-receive-an-error"></a>Проблема. Не удается выполнить переключение виртуального IP-адреса и получить сообщение об ошибке
...
## <a name="problem-a-role-instance-is-looping-between-started-initializing-busy-and-stopped"></a>Проблема. Экземпляр роли выполняет цикл между запущенным, инициализированным, занятым и остановленным.
...
## <a name="problem-my-application-stopped-working"></a>Проблема. Мое приложение прекратило работать
