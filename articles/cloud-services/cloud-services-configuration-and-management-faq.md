---
title: Вопросы конфигурации и управления часто задаваемые вопросы
...
- [Почему цепочка сертификатов сертификата сертификата Cloud Service TLS/SSL не завершена?](#why-is-the-certificate-chain-of-my-cloud-service-tlsssl-certificate-incomplete)
...
- [Срок действия сертификата управления облачными сервисами истекает. Как его продлить?](#my-cloud-service-management-certificate-is-expiring-how-to-renew-it)
...
- [Каковы предстоящие возможности облачных служб на портале Azure, которые могут помочь управлять приложениями и контролировать их?](#what-are-the-upcoming-cloud-service-capabilities-in-the-azure-portal-which-can-help-manage-and-monitor-applications)
...
- [Как связать статический IP-адрес с моим облачным сервисом?](#how-do-i-associate-a-static-ip-address-to-my-cloud-service)
...
- [Я не могу удаленного рабочего стола для Облачного сервиса VM с помощью файла RDP. Я получаю следующую ошибку: ошибка аутентификации произошла (Код: 0x80004005)](#i-cannot-remote-desktop-to-cloud-service-vm--by-using-the-rdp-file-i-get-following-error-an-authentication-error-has-occurred-code-0x80004005)
...
- [Каков лимит квот для службы облачных услуг?](#what-is-the-quota-limit-for-my-cloud-service)
- [Почему диск на моем Облачном сервисе VM показывает очень мало свободного дискового пространства?](#why-does-the-drive-on-my-cloud-service-vm-show-very-little-free-disk-space)
...
- [Портал Azure не отображает версию SDK моего облачного сервиса. Как я могу получить это?](#the-azure-portal-doesnt-display-the-sdk-version-of-my-cloud-service-how-can-i-get-that)
- [Я хочу закрыть облачную службу на несколько месяцев. Как снизить стоимость выставления счетов облачного сервиса без потери IP-адреса?](#i-want-to-shut-down-the-cloud-service-for-several-months-how-to-reduce-the-billing-cost-of-cloud-service-without-losing-the-ip-address)


## <a name="certificates"></a>Сертификаты

### <a name="why-is-the-certificate-chain-of-my-cloud-service-tlsssl-certificate-incomplete"></a>Почему цепочка сертификатов сертификата сертификата Cloud Service TLS/SSL не завершена?
...
Этот сертификат используется для шифрования ключей компьютера на веб-ролях Azure. Чтобы узнать больше, проверить [этот совет](https://docs.microsoft.com/security-updates/securityadvisories/2018/4092731).

Дополнительные сведения см. в следующих статьях:
- [Как настроить и запустить задачи запуска для облачной службы](https://docs.microsoft.com/azure/cloud-services/cloud-services-startup-tasks)
...
2. [Включить код .NET](https://docs.microsoft.com/azure/cloud-services/cloud-services-dotnet-diagnostics)
...
* [Зарезервируйте IP-адрес существующей облачной службы](/previous-versions/azure/virtual-network/virtual-networks-reserved-public-ip#reserve-the-ip-address-of-an-existing-cloud-service)
* [Связать зарезервированный IP с новой облачной службой](/previous-versions/azure/virtual-network/virtual-networks-reserved-public-ip#associate-a-reserved-ip-to-a-new-cloud-service)
...
* [Связать зарезервированный IP с облачным сервисом с помощью файла конфигурации службы](/previous-versions/azure/virtual-network/virtual-networks-reserved-public-ip#associate-a-reserved-ip-to-a-cloud-service-by-using-a-service-configuration-file)
...
- Включите инструмент разработчика F12 в Internet Explorer или Microsoft Edge и переключитесь на вкладку Сети для проверки протокола. 
...
Размер диска %approot% \<рассчитывается как размер .cspkg и max журнальный размер - запас свободного пространства>, или 1,5 ГБ, в зависимости от того, что больше. Размер вашей ВМ никак не влияет на этот расчет. (Размер виртуальной машины влияет на размер временного диска C.) 
...
Привязка SNI может быть настроена с помощью Смдлета PowerShell **New-WebBinding** в задаче запуска для примера роли облачной службы, как показано ниже:
