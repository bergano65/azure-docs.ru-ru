...
Сведения об устранении таких сбоев выделения см. в [разделе сбой выделения облачной службы: Решения](cloud-services-allocation-failures.md#solutions).
...
Чтобы проверить размеры, доступные в вашем регионе, см [. раздел Microsoft Azure: Продукты, доступные по](https://azure.microsoft.com/regions/services)регионам.
...
Вы также можете отслеживание текущего использования или квоты подписки на портале: Портал Azure = > Subscriptions = \<> соответствующую подписку > = > "использование + квота".
