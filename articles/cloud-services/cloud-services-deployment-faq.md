...
Поможет устранить такие ошибки выделения, см. в разделе [ошибок выделения ресурсов облачной службы: Решения](cloud-services-allocation-failures.md#solutions).
...
Чтобы проверить размеры, доступные в вашем регионе, см. в разделе [Microsoft Azure: Доступность продуктов по регионам](https://azure.microsoft.com/regions/services).
...
Вы также может отслеживать текущую квоту и использование для вашей подписки на портале: Портал Azure = > подписки = > \<соответствующая подписка > = > «Использование + Квота».
