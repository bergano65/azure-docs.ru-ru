---
title: Облачные службы Azure Def. LoadBalancerProbe Schema (англ.) Документы Майкрософт
description: Определенный клиентом LoadBalancerProbe представляет собой зонд работоспособности конечных точек в ролевых экземплярах. Он сочетает в себе веб-роли или роли работника в файле определения службы.
ms.custom: ''
ms.date: 04/14/2015
...
##  <a name="loadbalancerprobes-element"></a><a name="LoadBalancerProbes"></a>Элемент LoadBalancerProbes
...
##  <a name="loadbalancerprobe-element"></a><a name="LoadBalancerProbe"></a>Элемент LoadBalancerProbe
...
| ------------------- | -------- | -----------------|
| `name`              | `string` | Обязательный элемент. Имя проверки подсистемы балансировки нагрузки. Имя должно быть уникальным.|
