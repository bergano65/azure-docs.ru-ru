...
1. Чтобы открыть файл index.jade, введите следующую команду:
   ...
   Jade — это обработчик представлений по умолчанию, используемый приложениями Express. Дополнительные сведения о подсистеме просмотра Jade см. в разделе [http://jade-lang.com][http://jade-lang.com].
...
Дополнительную информацию см. в [центре разработчиков Node.js](https://docs.microsoft.com/azure/javascript/).
