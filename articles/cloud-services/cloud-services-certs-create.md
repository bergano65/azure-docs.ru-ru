...
>[!Note]
>[Облачных служб часто задаваемые вопросы — настройки и управления](cloud-services-configuration-and-management-faq.md) статьи содержит полезную информацию о сертификатах.
