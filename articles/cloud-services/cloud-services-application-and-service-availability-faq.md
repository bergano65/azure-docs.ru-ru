...
Примерно раз в месяц корпорация Майкрософт выпускает новую версию гостевой ОС для виртуальных машин PaaS Windows Azure. Гостевая ОС — это только одно такое обновление в конвейере. На выпуск может влиять множество факторов. Кроме того, Azure работает на сотнях тысяч компьютеров. Это означает, что невозможно предсказать точную дату и время перезапуска ваших ролей. Корпорация Майкрософт будет размещать на RSS-канале обновлений гостевой ОС последние сведения, которыми мы располагаем, но указанные временные рамки следует воспринимать только в качестве приблизительных. Мы осознаем, что это вызывает неудобства для клиентов, и работаем над планом по ограничению перезапусков или уточнению их времени.
