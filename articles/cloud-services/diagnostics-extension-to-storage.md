...
| --- | --- |
| Журналы Azure |Table |
| Журналы IIS 7.0 |Большой двоичный объект |
| Журналы инфраструктуры системы диагностики Azure |Table |
| Журналы трассировки невыполненных запросов |Большой двоичный объект |
| Журналы событий Windows |Table |
| Счетчики производительности |Table |
| Аварийные дампы |Большой двоичный объект |
| Пользовательские журналы ошибок |Большой двоичный объект |
