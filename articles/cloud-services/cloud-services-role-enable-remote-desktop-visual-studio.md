...
1. После шага развертывания добавьте шаг **Azure PowerShell** , присвойте свойству " **Отображаемое имя** " значение "развертывание Azure: Включите расширение RDP (или другое подходящее имя) и выберите подходящую подписку Azure.
