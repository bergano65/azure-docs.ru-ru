...
1. После шага развертывания добавьте **Azure Powershell** шаг, установите его **отображаемое имя** значение «развертывание Azure: Включить расширение удаленного рабочего СТОЛА» (или другим подходящим именем) и выберите нужную подписку Azure.
