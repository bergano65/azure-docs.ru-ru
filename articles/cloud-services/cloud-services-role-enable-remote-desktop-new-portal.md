...
ms.locfileid: "98743259"
---
# <a name="enable-remote-desktop-connection-for-a-role-in-azure-cloud-services-classic"></a>Включение подключение к удаленному рабочему столу для роли в облачных службах Azure (классическая модель)
...
1. Щелкните **Облачные службы**, выберите имя облачной службы, а затем — **Удаленный рабочий стол**.
    ...
    ![на рисунке показан удаленный рабочий стол облачных служб](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop.png)
...
3. Щелкните **Подключиться**, чтобы скачать RDP-файл для экземпляра роли.
    ...
    ![Образ удаленного рабочего стола облачных служб](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop_Connect.png)
