...
1. Щелкните **Облачные службы** , выберите имя облачной службы, а затем — **Удаленный рабочий стол** .
    ...
    ![Снимок экрана, посвященный параметру удаленный рабочий стол.](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop.png)
...
3. Щелкните **Подключиться** , чтобы скачать RDP-файл для экземпляра роли.
    ...
    ![Снимок экрана, на котором выделена кнопка "Подключиться".](./media/cloud-services-role-enable-remote-desktop-new-portal/CloudServices_Remote_Desktop_Connect.png)
