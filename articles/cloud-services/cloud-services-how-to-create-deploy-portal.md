...
> [!NOTE]
> Если вы планируете опубликовать облачную службу из Azure DevOps, воспользуйтесь функцией "Быстрое создание", а затем настройте публикацию Azure DevOps на странице быстрого начала работы в Azure или на панели мониторинга. Дополнительные сведения см. в статье [Непрерывная доставка в Azure с помощью Azure DevOps][TFSTutorialForCloudService]или в справке по **быстрое начало** странице.
>
>
