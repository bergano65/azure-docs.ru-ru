...
- **Установите и настройте Terraform**. Чтобы подготовить виртуальные машины и другую инфраструктуру в Azure, [установите и настройте Terraform](terraform-install-configure.md).
