...
- Начните работу с [установки и настройки Terraform для подготовки виртуальных машин и другой инфраструктуры в Azure](terraform-install-configure.md).
