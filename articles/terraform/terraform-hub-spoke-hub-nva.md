---
title: Создание устройства центральной виртуальной сети с помощью Terraform в Azure
description: В этом учебнике описано, как создать центральную виртуальную сеть, которая выступает общей точкой подключения между всеми другими сетями.
services: terraform
ms.service: azure
...
ms.locfileid: "71173420"
---
# <a name="tutorial-create-a-hub-virtual-network-appliance-with-terraform-in-azure"></a>Руководство по Создание устройства центральной виртуальной сети с помощью Terraform в Azure
...
Azure поддерживает большое количество виртуальных сетевых устройств. В этом учебнике используется образ Ubuntu. Дополнительные сведения о поддерживаемых в Azure сетевых устройствах см. на [этой домашней странице](https://azure.microsoft.com/solutions/network-appliances/).
