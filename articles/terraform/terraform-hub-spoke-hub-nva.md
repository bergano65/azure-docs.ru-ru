...
ms.locfileid: "57993506"
---
# <a name="tutorial-create-a-hub-virtual-network-appliance-with-terraform-in-azure"></a>Руководство. Создание устройства центральной виртуальной сети с помощью Terraform в Azure
