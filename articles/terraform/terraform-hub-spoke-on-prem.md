---
title: Создание локальной виртуальной сети с помощью Terraform в Azure
...
ms.locfileid: "71169782"
---
# <a name="tutorial-create-on-premises-virtual-network-with-terraform-in-azure"></a>Руководство по Создание локальной виртуальной сети с помощью Terraform в Azure

В этом учебнике описано, как реализовать локальную сеть с помощью виртуальной сети Azure. Вместо виртуальной сети Azure можно использовать любую частную виртуальную сеть. Чтобы сделать это, сопоставьте соответствующие IP-адреса в подсети.
...
Чтобы смоделировать локальную сеть, создайте виртуальную сеть Azure. Демонстрационная виртуальная сеть используется вместо фактической локальной частной сети. Чтобы сделать то же самое с имеющейся локальной сетью, сопоставьте соответствующие IP-адреса в подсети.
