---
title: Руководство. Маршрутизация электрических транспортных средств с помощью Записных книжек Azure (Python)
description: Руководство. Маршрутизация электрических транспортных средств с помощью API маршрутизации Azure Maps и Записных книжек Azure.
author: walsehgal
ms.author: v-musehg
ms.date: 11/12/2019
ms.topic: tutorial
...
Чтобы создать подписку на учетную запись Azure Maps с ценовой категорией S1, следуйте инструкциям в разделе о [создании учетной записи](quick-demo-map-app.md#create-an-account-with-azure-maps). 
