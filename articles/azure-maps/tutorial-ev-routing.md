...
> [!div class="checklist"]
> * Создавать и запускать файлы Jupyter Notebook в [Записных книжках Azure](../notebooks/index.yml) в облаке.
...
1. Перейдите в службу [Записные книжки Azure](https://notebooks.azure.com) и выполните вход. Дополнительные сведения см. в [кратком руководстве о входе и настройке идентификатора пользователя](../notebooks/quickstart-sign-in-azure-notebooks.md).
