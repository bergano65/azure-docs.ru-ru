...
Постарайтесь понять функции, реализованные в файле записной книжки. Выполняйте код, приведенный в файле записной книжки, по одной ячейке за раз. Вы можете выполнять код в каждой ячейке, нажимая кнопку **Запустить** в верхней части приложения записной книжки.
