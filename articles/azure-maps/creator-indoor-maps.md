...
[Веб-пакет SDK Azure Maps](./index.yml) включает в себя модуль схем помещений. Этот модуль предлагает расширенные функциональные возможности для библиотеки *Map Control* в Azure Maps. Модуль схем помещений отрисовывает схемы помещений, созданные в Creator. Он интегрирует мини-приложения, например *средство выбора этажа* , которое помогает пользователям визуализировать различные этажи.
