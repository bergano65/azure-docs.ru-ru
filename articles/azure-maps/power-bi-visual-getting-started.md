...
Azure Maps визуальный элемент для Power BI предоставляет широкий набор визуализаций данных для пространственных данных на основе схемы. Оценка того, что свыше 80% бизнес-данных имеет контекст расположения. Визуальный элемент Azure Maps можно использовать для получения подробных сведений о том, как этот контекст расположения связан с бизнес-данными и влияет на них.

![Power BI Desktop с Azure Maps визуальным отображением бизнес-данных](media/power-bi-visual/azure-maps-visual-hero.png)
...
| Стиль схемы           | Стиль схемы. Дополнительные сведения о [поддерживаемых стилях карт](supported-map-styles.md)см. в этом документе. |
...
| Параметр          | Описание   |
|------------------|---------------|
| Zoom             | Уровень масштабирования по умолчанию для схемы. Может быть числом от 0 до 22. |
