...
| Icon Number |Значок| День | Night | Текст |
|-------------|:----:|-----|-------|------|
| 1           |![](./media/weather-services-concepts/sunny-i.png)                      | ДА |  Нет    | Солнечно|
| 2           |![](./media/weather-services-concepts/mostly-sunny.png)                | ДА |  Нет    | Mostly Sunny|
| 3           |![](./media/weather-services-concepts/partly-sunny.png)                | ДА |  Нет    | Partly Sunny|
| 4           |![](./media/weather-services-concepts/intermittent-clouds.png)         | ДА |  Нет    | Intermittent Clouds|
| 5           |![](./media/weather-services-concepts/hazy-sunshine.png)               | ДА |  Нет    | Hazy Sunshine |
| 6           |![](./media/weather-services-concepts/mostly-cloudy.png)               | ДА |  Нет    | Mostly Cloudy|
| 7           |![](./media/weather-services-concepts/cloudy-i.png)                     | ДА |  ДА   | Cloudy |
| 8           |![](./media/weather-services-concepts/dreary-overcast.png)             | ДА |  ДА   | Dreary (Overcast)|
| 11           |![](./media/weather-services-concepts/fog-i.png)                       | ДА |  ДА   | Fog|
| 12           |![](./media/weather-services-concepts/showers-i.png)                   | ДА |  ДА   | Showers|
| 13           |![](./media/weather-services-concepts/mostly-cloudy-showers.png)       | ДА |  Нет    | Mostly Cloudy with Showers|
| 14           |![](./media/weather-services-concepts/partly-sunny-showers.png)        | ДА |  Нет    | Partly Sunny with Showers|
| 15           |![](./media/weather-services-concepts/tstorms-i.png)                   | ДА |  ДА   | Thunderstorms|
| 16           |![](./media/weather-services-concepts/mostly-cloudy-tstorms.png)       | ДА |  Нет    | Mostly Cloudy with Thunderstorms|
| 17           |![](./media/weather-services-concepts/partly-sunny-tstorms.png)        | ДА |  Нет    | Partly Sunny with Thunderstorms|
| 18           |![](./media/weather-services-concepts/rain-i.png)                      | ДА |  ДА   | дождь.|
| 19           |![](./media/weather-services-concepts/flurries-i.png)                  | ДА |  ДА   | Flurries|
| 20           |![](./media/weather-services-concepts/mostly-cloudy-flurries.png)      | ДА |  Нет    | Mostly Cloudy with Flurries|
| 21           |![](./media/weather-services-concepts/partly-sunny-flurries.png)       | ДА |  Нет    | Partly Sunny with Flurries|
| 22           |![](./media/weather-services-concepts/snow-i.png)                      | ДА |  ДА   | Snow|
| 23           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | ДА |  Нет    | Mostly Cloudy with Snow|
| 24           |![](./media/weather-services-concepts/ice-i.png)                       | ДА |  ДА   | Ice |
| 25           |![](./media/weather-services-concepts/sleet-i.png)                     | ДА |  ДА   | Sleet|
| 26           |![](./media/weather-services-concepts/freezing-rain.png)              | ДА |  ДА   | Freezing Rain|
| 29           |![](./media/weather-services-concepts/rain-snow.png)                  | ДА |  ДА   | Rain and Snow|
| 30           |![](./media/weather-services-concepts/hot-i.png)                       | ДА |  ДА   | Горячий|
| 31           |![](./media/weather-services-concepts/cold-i.png)                      | ДА |  ДА   | Холодный|
| 32           |![](./media/weather-services-concepts/windy-i.png)                     | ДА |  ДА   | Windy|
| 33           |![](./media/weather-services-concepts/clear-night.png)                | Нет  |  ДА   | Очистить|
| 34           |![](./media/weather-services-concepts/mostly-clear-night.png)          | Нет  |  ДА   | Mostly Clear|
| 35           |![](./media/weather-services-concepts/partly-cloudy-night.png)         | Нет  |  ДА   | Partly Cloudy|
| 36           |![](./media/weather-services-concepts/intermittent-clouds-Night.png)   | Нет  |  ДА   | Intermittent Clouds|
| 37           |![](./media/weather-services-concepts/hazymoon-light.png)             | Нет  |  ДА   | Hazy Moonlight|
| 38           |![](./media/weather-services-concepts/mostly-cloudy-night.png)         | Нет  |  ДА   | Mostly Cloudy|
| 11,9           |![](./media/weather-services-concepts/partly-cloudy-showers-night.png)  | Нет  |  ДА   | Partly Cloudy with Showers|
| 40           |![](./media/weather-services-concepts/mostly-cloudy-showers-night.png)  | Нет  |  ДА   | Mostly Cloudy with Showers|
| 41           |![](./media/weather-services-concepts/partly-cloudy-tstorms-night.png)  | Нет  |  ДА   | Partly Cloudy with Thunderstorms|
| 42           |![](./media/weather-services-concepts/mostly-cloudy-tstorms-night.png)  | Нет  |  ДА   | Mostly Cloudy with Thunderstorms|
| 43           |![](./media/weather-services-concepts/mostly-cloudy-flurries-night.png) | Нет  |  ДА   | Mostly Cloudy with Flurries|
| 44           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | Нет  |  ДА   | Mostly Cloudy with Snow|
