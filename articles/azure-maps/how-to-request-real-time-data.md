...
В этой статье показано, как использовать [службу Azure Maps Mobility Service](/rest/api/maps/mobility) для запроса общедоступных транзитных данных в режиме реального времени.
