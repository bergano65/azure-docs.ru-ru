...
* `intensity`. Применяет множитель к весу каждой точки данных, чтобы увеличить общую интенсивность тепловой карты и помогает сделать небольшие различия в весе точек данных более удобными для визуализации.
