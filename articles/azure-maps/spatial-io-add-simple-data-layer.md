...
<iframe height="500" style="width: 100%;" scrolling="no" title="Используйте простой слой данных" src="//codepen.io/azuremaps/embed/zYGzpQV/?height=500&theme-id=0&default-tab=js,result&editable=true" frameborder="no" allowtransparency="true" allowfullscreen="true"> См. Ручку <a href='https://codepen.io/azuremaps/pen/zYGzpQV/'>Используйте простой слой данных</a> по Картам Azure ()<a href='https://codepen.io/azuremaps'>@azuremaps</a>на <a href='https://codepen.io'>CodePen</a>.
</iframe>
