---
title: Охват геокодирования Карты Microsoft Azure
description: Процесс преобразования адреса местоположения в координаты широты и долготы известен как геокодирование. В этой статье вы узнаете о регионах с покрытием геокодирования в Microsoft Azure Maps.
author: philmea
ms.author: philmea
ms.date: 12/31/2019
ms.topic: conceptual
...
При поиске местоположения с помощью Azure Maps служба поиска, например [Get Search Address,](https://docs.microsoft.com/rest/api/maps/search/getsearchaddress)использует условия поиска и возвращает координаты широты и долготы. Этот процесс называется геокодированием. Однако Azure Maps не имеет одинакового уровня информации и точности для всех регионов и стран. Из этой статьи вы узнаете, для каких расположения можно выполнять надежный поиск в каждом регионе. 

Способность к геокодированию в стране/регионе зависит от охвата дорожных данных и точности геокодирования службы геокодирования. При использовании следующих категорий указывается уровень поддержки геокодирования в каждой стране/регионе.
