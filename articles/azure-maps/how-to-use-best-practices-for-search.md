...
ms.locfileid: "83742769"
---
# <a name="best-practices-for-azure-maps-search-service"></a>Рекомендации по использованию службы поиска Azure Maps

[Служба поиска](https://docs.microsoft.com/rest/api/maps/search) Azure Maps имеет API-интерфейсы, которые предлагают различные возможности. Например, с помощью API Search Address можно находить точки интереса или информацию об окрестностях конкретных мест. 
...
* Создавать запросы так, чтобы получать наиболее релевантные результаты.
* Сужать результаты поиска.
* Понимать различия между различными типами результатов.
* Читать структуру "поиск-ответ" для адреса.
...
> [!TIP]
> При обращении с запросами к службе поиска вы можете использовать [приложение Postman](https://www.getpostman.com/apps) для создания вызовов REST. Вы также можете использовать любую среду разработки API.
