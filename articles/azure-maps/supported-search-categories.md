---
title: Категории поиска | Microsoft Azure Maps
description: Узнайте, какие категории поиска поддерживаются в Azure Maps. Просмотр всех поддерживаемых кодов категорий и типов представляющих интерес точек, которые представляются каждым из них.
author: sataneja
ms.author: sataneja
ms.date: 05/14/2018
ms.topic: conceptual
...
ms.locfileid: "91310128"
---
# <a name="azure-maps-supported-categories"></a>Поддерживаемые категории в Azure Maps

При выполнении [поиска категорий](https://docs.microsoft.com/rest/api/maps/search/getsearchpoicategory) для точек интереса поддерживается более сотни категорий. Ниже приведен список кодов категорий для имен поддерживаемых категорий. Коды категорий создаются для категорий верхнего уровня. Для всех подкатегорий используется один и тот же код категории. Этот список категорий может быть изменен при выпуске новых данных.
