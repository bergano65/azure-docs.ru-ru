...
| `transit_mode`                | Ознакомьтесь с документацией о [службах мобильности](/rest/api/maps/mobility). |
| `transit_routing_preference` | Ознакомьтесь с документацией о [службах мобильности](/rest/api/maps/mobility). |
