...
* Создатель Azure Maps (Предварительная версия) включен для учетной записи Azure Maps, которую вы использовали для отправки пакета Drawing.
