...
![Пример многострочного текстового объекта на слое меток](./media/drawing-conversion-error-codes/multiline.png)
...
![Пример вертикального ввода 2](./media/drawing-conversion-error-codes/vrt.png)
