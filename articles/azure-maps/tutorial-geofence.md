...
Теперь мы применим [API определения пространственной геозоны](https://docs.microsoft.com/rest/api/maps/spatial/getgeofence) для отправки уведомлений по электронной почте руководителю строительного объекта о том, что элемент оборудования входит в границы геозоны или покидает ее.
