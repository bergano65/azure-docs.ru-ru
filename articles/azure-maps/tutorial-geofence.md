...
Azure Maps поддерживает три типа событий. Сведения о типах событий, поддерживаемых Azure Maps, см. [здесь](https://docs.microsoft.com/azure/event-grid/event-schema-azure-maps. Нам нужны две разные подписки на события: одна для события входа и другая для событий выхода.
