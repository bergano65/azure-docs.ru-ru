...
| Название | Type | Обязательное значение  | Описание |
| :------------ |:------------: |:---------------:| :-----|
...
| businessDayOnly | логический | false |  Указывает, что данные считаются допустимыми только в рабочие дни. По умолчанию имеет значение `false`.|
