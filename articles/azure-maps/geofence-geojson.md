...
* Если используются точки, определяющие круги, геометрию этих кругов можно представить с помощью геометрического объекта `Point`, свойства которого описаны в статье [о расширении геометрических объектов GeoJSON](./extend-geojson.md).      
