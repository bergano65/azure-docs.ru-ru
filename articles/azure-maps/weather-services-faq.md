---
title: Microsoft Azure карты, часто задаваемые вопросы о службах погоды
description: Ответы на часто задаваемые вопросы о Azure Maps данных и функциях служб погоды.
author: anastasia-ms
ms.author: v-stharr
ms.date: 12/04/2020
ms.topic: conceptual
...
ms.locfileid: "96747333"
---
# <a name="azure-maps-weather-services-frequently-asked-questions-faq"></a>Часто задаваемые вопросы о службах погоды Azure Maps
...
## <a name="weather-services-coverage-and-availability"></a>Покрытие и доступность служб погоды
...
**Поддерживает ли Azure Maps веб-пакет SDK встроенную поддержку интеграции со службами погоды?**
...
**Поддерживает ли Azure Maps пакет SDK для Android встроенную поддержку интеграции со службами погоды?**
...
Узнайте, как запрашивать данные о погоде в реальном времени и прогнозировать с помощью Azure Mapsных служб погоды:
> [!div class="nextstepaction"]
> [Запрос данных о погоде в реальном времени ](how-to-request-weather-data.md)

Azure Maps основные понятия о службах погоды:
> [!div class="nextstepaction"]
> [Основные понятия служб погоды](weather-coverage.md)

Изучите документацию по API служб погоды Azure Maps.
