...
| `['get', string]` | value | Получает значение свойства из свойств текущей функции. Возвращает нулевую, если запрашиваемое свойство отсутствует. |
| `['get', string, object]` | value | Получает стоимость свойства от свойств предоставленного объекта. Возвращает нулевую, если запрашиваемое свойство отсутствует. |
...
| `['id']` | value | Получает идентификатор функции, если он имеет один. |
