...
| `['slice', array | string, number]`<br/><br/>`['slice', array | string, number, number]` | `string`\|массив | Возвращает элемент из массива или подстроки из строки с указанным начальным индексом или между начальным и конечным индексами, если задано значение. Возвращаемое значение является инклюзивным по отношению к начальному индексу, но не к конечному индексу. |
