...
ms.locfileid: "77048914"
---
# <a name="azure-maps-mobility-coverage"></a>Покрытие Azure Maps мобильности

Azure Maps предлагает [службу Mobility Service](https://aka.ms/AzureMapsMobilityService). Служба Mobility Service улучшает время разработки для приложений с общедоступными транзитными, велосипедными и мотороллере общими функциями. Он предлагает вариант для маршрутизации с вариантами планирования мультимодальныйной поездки. К функциям общедоступного транзитного пути относятся Поиск ближайших станций, Поиск остановок, Поиск транзитных строк, получение сведений о расписании, получение общедоступных транзитных прибытия и перечисление руководств по маршрутам. Служба возвращает сведения о доступности в режиме реального времени и статическую доступность для общих транспортных средств, таких как, автомобили, велосипеды и скутерс. API возвращает подробные и мультимодальный пошаговые расписания и оповещения службы.

Azure Maps не имеет одинакового уровня информации и точности для всех городов и стран и регионов. Возможность вызова транзитных данных зависит от города. Данные могут не включать все общие транзитные варианты и агентства, обслуживающие город.
