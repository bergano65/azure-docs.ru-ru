---
title: Руководство по Использование Creator для создания схем помещений
description: Руководство по созданию схем помещений с помощью Создателя в Azure Maps
author: anastasia-ms
ms.author: v-stharr
ms.date: 09/22/2020
ms.topic: tutorial
...
ms.locfileid: "91371428"
---
# <a name="tutorial-use-creator-to-create-indoor-maps"></a>Руководство по Использование Creator для создания схем помещений
...
Дополнительные сведения о различных службах Создателя Azure Maps, обсуждаемых в этой статье, см. в статье [Создатель для схем помещений](creator-indoor-maps.md).
