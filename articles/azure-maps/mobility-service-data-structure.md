...
description: Сведения о том, как данные организованы в области Metro в Azure Maps служб Mobility Services. Узнайте, какие поля хранят сведения о прекращении общей транзитной передачи и строках.
author: anastasia-ms
ms.author: v-stharr
ms.date: 06/05/2019
ms.topic: conceptual
