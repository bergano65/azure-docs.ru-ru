...
Служба Mobility Service использует параллельную модель данных для линий и групп строк. Эта модель используется для повышения эффективности изменений, наследуемых от [гтфс](https://gtfs.org/) маршрутов и данных о поездках.
