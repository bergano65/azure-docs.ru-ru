...
description: Узнайте, как использовать портал Azure для управления учетной записью Azure Maps. См. раздел Создание новой учетной записи и удаление существующей учетной записи.
author: anastasia-ms
ms.author: v-stharr
ms.date: 01/27/2020
ms.topic: how-to
