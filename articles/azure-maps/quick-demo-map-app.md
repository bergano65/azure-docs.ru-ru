...
5. После успешного создания учетной записи откройте ее и найдите раздел "Параметры" в меню учетной записи. Щелкните **Проверка подлинности**, чтобы просмотреть первичный и вторичный ключи для своей учетной записи службы Azure Maps. Скопируйте значение **Первичный ключ** в локальный буфер обмена, чтобы использовать его в следующем разделе.
