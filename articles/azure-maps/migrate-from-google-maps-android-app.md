...
Если ваша аудитория распределена по нескольким странам или говорит на разных языках, то необходима локализация.
...
Третий вариант — запрограммировать язык и региональное представление карты с помощью метода `setStyle` карт. Такой подход позволяет обновить язык и региональное представление в любой момент при выполнении кода.
