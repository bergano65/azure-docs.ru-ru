...
ms.locfileid: "87126828"
---
# <a name="manage-the-pricing-tier-of-your-azure-maps-account"></a>Управление ценовой категорией для учетной записи Azure Maps

Вы можете управлять ценовой категорией своей учетной записи Azure Maps на портале Azure. Вы также можете просмотреть или изменить ценовую категорию вашей учетной записи после создания [учетной записи](https://azure.microsoft.com/free/?WT.mc_id=A261C142F).
