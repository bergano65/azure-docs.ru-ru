...
| Функция | Объект, объединяющий геометрию с дополнительными сведениями о метаданных. |
...
* Итоговая функция уровня не должна быть больше 400 квадратных метров.
