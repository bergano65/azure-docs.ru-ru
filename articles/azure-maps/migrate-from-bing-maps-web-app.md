...
description: Как перенести веб-приложения из Карт Bing в Microsoft Azure Maps.
author: rbrundritt
ms.author: richbrun
ms.date: 9/10/2020
ms.topic: tutorial
...
ms.locfileid: "91319747"
---
# <a name="migrate-a-web-app-from-bing-maps"></a>Перенос веб-приложения из Карт Bing
...
> [!TIP]
> Класс Position содержит статическую вспомогательную функцию для импорта координат в формате `latitude, longitude`. В коде Карт Bing функцию [atlas.data.Position.fromLatLng](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.data.position) зачастую можно заменить функцией `new Microsoft.Maps.Location`.
...
Подробную документацию по настройке и использованию элементов управления картой Azure Maps в веб-приложении см. [здесь](https://docs.microsoft.com/azure/azure-maps/how-to-use-map-control).
...
-   Azure Maps также предоставляет элементы управления навигацией для поворота и наклона представления карты, как описано [здесь](https://docs.microsoft.com/azure/azure-maps/map-add-controls).
...
> [!NOTE]
> В Azure Maps можно загрузить несколько экземпляров карт на одной странице с разными настройками языка и региональными параметрами. Кроме того, можно обновить эти параметры на карте после их загрузки. Подробный список поддерживаемых языков в Azure Maps можно найти [здесь](https://docs.microsoft.com/azure/azure-maps/supported-languages).
...
-   [Поддерживаемые стили карт](https://docs.microsoft.com/azure/azure-maps/supported-map-styles)
...
-   [Создание источника данных](https://docs.microsoft.com/azure/azure-maps/create-data-source-web-sdk)
-   [Добавление слоя символов](https://docs.microsoft.com/azure/azure-maps/map-add-pin)
-   [Добавление слоя пузырьков](https://docs.microsoft.com/azure/azure-maps/map-add-bubble-layer)
-   [Данные точек кластера](https://docs.microsoft.com/azure/azure-maps/clustering-point-data-web-sdk)
-   [Добавление меток HTML](https://docs.microsoft.com/azure/azure-maps/map-add-custom-html)
-   [Использование стилистических выражений на основе данных](https://docs.microsoft.com/azure/azure-maps/data-driven-style-expressions-web-sdk)
...
-   [Добавление линий на карту](https://docs.microsoft.com/azure/azure-maps/map-add-shape#add-lines-to-the-map)
...
-   [Добавление многоугольника на карту](https://docs.microsoft.com/azure/azure-maps/map-add-shape#add-a-polygon-to-the-map)
-   [Добавление окружности на карту](https://docs.microsoft.com/azure/azure-maps/map-add-shape#add-a-circle-to-the-map)
...
-   [Добавление всплывающего окна](https://docs.microsoft.com/azure/azure-maps/map-add-popup)
...
-   [Добавление слоя тепловой карты](https://docs.microsoft.com/azure/azure-maps/map-add-heat-map-layer)
...
-   [Добавление слоев фрагмента карты](https://docs.microsoft.com/azure/azure-maps/map-add-tile-layer)
...
-   [Отображение данных дорожного движения на карте](https://docs.microsoft.com/azure/azure-maps/map-show-traffic)
...
-   [Наложение изображения](https://docs.microsoft.com/azure/azure-maps/map-add-image-layer)
...
-   [Документация](https://docs.microsoft.com/azure/azure-maps/set-drawing-options)
...
> [!div class="nextstepaction"]
> [Использование модуля служб Azure Maps](https://docs.microsoft.com/azure/azure-maps/how-to-use-services-module)

> [!div class="nextstepaction"]
> [Поиск достопримечательностей](https://docs.microsoft.com/azure/azure-maps/map-search-location)

> [!div class="nextstepaction"]
> [Получение информации из координаты (обратный геокод)](https://docs.microsoft.com/azure/azure-maps/map-get-information-from-coordinate)

> [!div class="nextstepaction"]
> [Отображение направлений от точки А до точки Б](https://docs.microsoft.com/azure/azure-maps/map-route)
...
> [!div class="nextstepaction"]
> [Справочная документация по API службы веб-пакета SDK Azure Maps](https://docs.microsoft.com/javascript/api/azure-maps-control/)
