...
В этой статье показано, как использовать [службу Azure Maps Mobility Service](/rest/api/maps/mobility) для запроса общедоступных транзитных данных. Транзитные данные включают остановку передачи, сведения о маршруте и оценки времени поездки.
...
> [!div class="nextstepaction"]
> [Документация по службе Mobility Service](/rest/api/maps/mobility)