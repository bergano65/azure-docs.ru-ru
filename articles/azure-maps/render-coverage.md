...
description: В этой статье вы узнаете о регионах с покрытием карт Microsoft Azure, а также об их уровне подготовки к просмотру.
author: jingjing-z
ms.author: jinzh
ms.date: 03/22/2019
ms.topic: conceptual
...
Объем и точность сведений в службе "Карты" зависит от области. В следующих таблицах приведены сведения о том, с каким уровнем детализации может отображаться каждый регион.
