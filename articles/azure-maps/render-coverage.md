...
ms.locfileid: "77025458"
---
# <a name="azure-maps-render-coverage"></a>Покрытие для отображения в службе "Карты Azure"

Для создания карт в службе "Карты Azure" используются растровые и векторные плитки. При самом низком разрешении весь мир помещается в одну плитку. При максимальном разрешении одна плитка представляет 38 квадратных метров. По мере масштабирования вы увидите дополнительные сведения о континентах, регионах, городах и индивидуальном улиц. Дополнительные сведения о плитках см. в статье [уровни масштабирования и сетка плиток](zoom-levels-and-tile-grid.md).

Объем и точность сведений в службе "Карты" зависит от области. В следующих таблицах подробно описан уровень сведений, которые можно визуализировать для каждого региона.
