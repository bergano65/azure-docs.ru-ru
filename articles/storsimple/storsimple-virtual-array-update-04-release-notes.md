...
| 3 |Azure Backup |В предыдущих выпусках длительные процессы резервного копирования могли привести к нехватке места на устройстве и, соответственно, к сбоям резервного копирования. Для устранения этой ошибки в этом выпуске установлено ограничение на длину очереди резервного копирования — не более 5 заданий.|
