...
| 2 |Ведение журнала| Этот выпуск содержит изменения функции ведения журналов, когда устройство находится в сеансе поддержки в режиме подробного протоколирования.|
