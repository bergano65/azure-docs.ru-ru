...
| № | Компонент | Проблема |
| --- | --- | --- |
| 1 |Резервные| Этот выпуск содержит изменения, обеспечивающие повышенную устойчивость к сбоям ошибок резервного копирования путем повышения устойчивости к сбоям облака и высокой загрузки ЦП.|
