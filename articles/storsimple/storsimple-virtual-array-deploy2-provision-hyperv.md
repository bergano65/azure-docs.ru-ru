...
2. Открытый **менеджер сервера**. В верхнем правом углу выберите **Сервис**, а затем — **Диспетчер Hyper-V**.
...
12. В области слева на странице **Параметры** щелкните **Процессор**. В области справа установите для параметра **Количество виртуальных процессоров** значение 4 (или больше). Щелкните **Применить**.
