...
| Сценарий | Рабочая нагрузка | Поддерживается | Ограничения | Version |
| --- | --- | --- | --- | --- |
| Совместная работа |Общий доступ к файлам |Да | |Все версии |
| Взаимодействие |Распределенный общий доступ к файлам |Да | |Все версии |
| Взаимодействие |SharePoint |Да* |Поддерживается только для локально закрепленных томов. |Обновление 2 и более поздняя версия |
| Архивирование |Простое архивирование файлов |Да | |Все версии |
| Виртуализация |ВМ |Да* |Поддерживается только для локально закрепленных томов. |Обновление 2 и более поздняя версия |
...
| Общий доступ к файлам <br></br> Взаимодействие |Talon  |[StorSimple с Talon](https://www.talonstorage.com/products/archive/fast-deployment-azure-storsimple) | |
...
| учетная запись хранения |Набор учетных данных для доступа, связанный с вашей учетной записью хранения для данного поставщика облачных служб. |
