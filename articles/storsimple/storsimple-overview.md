...
| Резервное копирование |Архивация основной цели |Да* |Поддерживается, если устройство StorSimple выделено только для этой рабочей нагрузки. |Обновление 3 и более поздние версии |
| Резервное копирование |Архивация дополнительной цели |Да* |Поддерживается, если устройство StorSimple выделено только для этой рабочей нагрузки. |Обновление 3 и более поздние версии |
