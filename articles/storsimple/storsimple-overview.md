...
| Непрерывная работа |Позволяет пользователям приложения StorSimple серий 5000–7000 переносить их данные на устройства StorSimple серии 8000. |
...
| Сценарий | Рабочая нагрузка | Поддерживаются | Ограничения | Version |
| --- | --- | --- | --- | --- |
...
| Общие сведения |Индексирование |Да* |Для многоуровневых томов поддерживается только индексирование метаданных (не данных).<br>Для локально закрепленных томов поддерживается полное индексирование. |Все версии |
