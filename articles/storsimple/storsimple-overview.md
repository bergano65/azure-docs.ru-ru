...
| Сценарий | Рабочая нагрузка | Поддерживается | Ограничения | Версия |
| --- | --- | --- | --- | --- |
| Общее |ExpressRoute |Да | |Все версии |
| Общее |DataCore FC |Да* |Поддерживается DataCore SANsymphony. |Все версии |
| Общее |DFSR |Да* |Поддерживается только для локально закрепленных томов. |Все версии |
| Общее |Индексация |Да* |Для многоуровневых томов поддерживается только индексирование метаданных (не данных).<br>Для локально закрепленных томов поддерживается полное индексирование. |Все версии |
| Общее |Антивирусные программы |Да* |Для многоуровневых томов поддерживается только проверка при открытии и закрытии.<br>  Для локально закрепленных томов поддерживается полная проверка. |Все версии |
