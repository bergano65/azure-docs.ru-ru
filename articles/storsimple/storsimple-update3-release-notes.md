...
| 5 |Резервное копирование |В некоторых редких случаях в предыдущих версиях программного обеспечения, когда пользователь брал резервную копию удаленного клона, они натыкались на ошибки облака и операция была бы ошибка. В этом выпуске проблема исправлена и операция успешно завершена. |Да |Да |
