...
| 5 |Backup |В некоторых редких случаях в предыдущих версиях программного обеспечения, когда пользователь получит резервную копию удаленного клона, он мог бы выполнить ошибки в облаке, и операция завершилась с ошибкой. В этом выпуске проблема исправлена, и операция завершается успешно. |Да |Да |
