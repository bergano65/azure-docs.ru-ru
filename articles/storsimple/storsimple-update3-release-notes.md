---
title: Заметки о выпуске, посвященные обновлению 3 для устройств серии StorSimple 8000
...
| 3 |Наблюдение |Было обнаружено несколько проблем, связанных с блоками отчета и мониторингом, а также с диаграммами панели мониторинга устройств, где для локально закрепленных томов отображались неправильные сведения. В этом обновлении эти проблемы исправлены. |Да |нет |
...
| 5 |Резервное копирование |В некоторых редких случаях в предыдущих версиях программного обеспечения, когда пользователь получит резервную копию удаленного клона, он мог бы выполнить ошибки в облаке, и операция завершилась с ошибкой. В этом выпуске проблема исправлена, и операция завершается успешно. |Да |Да |
...
Этот выпуск содержит обновления драйвера LSI и встроенного ПО. Дополнительные сведения о том, как установить обновления драйвера LSI и встроенного ПО, см. в статье [Установка обновления 3 на устройство StorSimple](./index.yml).
...
Узнайте, как [установить обновление 3](./index.yml) на устройство StorSimple.