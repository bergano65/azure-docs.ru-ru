...
|                                                                                                                           | Если устройство серии 7000/5000 имеет большой объем данных, во время миграции эти данные необходимо скачать из Azure, что приведет к повышению затрат и задержек, связанных с загрузкой данных из Azure. |
