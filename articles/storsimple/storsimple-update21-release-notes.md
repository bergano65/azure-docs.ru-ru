...
| Нет | Функция | Проблемы | Для физического устройства | Для виртуального устройства |
| --- | --- | --- | --- | --- |
...
| 8 |Обновление |В редких случаях в предыдущих версиях ПО пользователь получал сообщение "CisPowershellHcsscripterror" при попытке проверки или установки обновлений. В этом обновлении эта проблема исправлена. |Да |Да |
...
| Нет. | Функция | Проблемы | Комментарии и возможные решения | Для физического устройства | Для виртуального устройства |
| --- | --- | --- | --- | --- | --- |
