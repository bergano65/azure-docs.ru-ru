...
| 7 |Инструментарий управления Windows (WMI) |В предыдущих версиях программного обеспечения произошло несколько экземпляров сбоя веб-прокси с исключением «\<исключение ManagementException> сбой загрузки поставщика». Эта ошибка была связана с проблемой доступа к памяти WMI. В этом выпуске она исправлена. |Да |Нет |
