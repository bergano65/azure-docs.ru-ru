...
| 7 |Инструментарий управления Windows (WMI) |В предыдущих версиях по наблюдались несколько случаев сбоя веб-прокси с исключением "\<исключение ManagementException > Ошибка загрузки поставщика». Эта ошибка была связана с проблемой доступа к памяти WMI. В этом выпуске она исправлена. |Да |Нет |
| 8 |Блокировка изменений |В редких случаях в предыдущих версиях ПО пользователь получал сообщение "CisPowershellHcsscripterror" при попытке проверки или установки обновлений. В этом обновлении эта проблема исправлена. |Да |Да |
...
| № | Компонент | Проблема | Комментарии и возможные решения | Для физического устройства | Для виртуального устройства |
| --- | --- | --- | --- | --- | --- |
