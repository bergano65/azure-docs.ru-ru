...
| 7 |Инструментарий управления Windows (WMI) |В предыдущих версиях программного обеспечения было несколько случаев сбоя веб-прокси, за исключением "ManagementException\<> Сбой загрузки поставщика". Эта ошибка была связана с проблемой доступа к памяти WMI. В этом выпуске она исправлена. |Да |нет |
...
| Нет. | Компонент | Проблема | Комментарии и возможные решения | Для физического устройства | Для виртуального устройства |
| --- | --- | --- | --- | --- | --- |
