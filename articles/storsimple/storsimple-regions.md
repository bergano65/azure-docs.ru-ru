...
- Странах и регионах, где доступна физическое устройство StorSimple, облака и виртуальное устройство.
...
В зависимости от модели устройства StorSimple могут быть доступны в разных географических регионах или странах и регионах.

### <a name="storsimple-physical-device-models-81008600"></a>Физическое устройство StorSimple (модели 8100 и 8600)

Если используется StorSimple 8100 или 8600 физическое устройство, устройство доступно в следующих странах и регионах.
...
Содержимое этого списка изменяется по мере добавления дополнительных странах и регионах. Последнюю версию списка географических регионов можно получить в приложении к условиям для массива хранения в разделе [Условия для продуктов](https://www.microsoft.com/en-us/licensing/product-licensing/products).
...
> [!IMPORTANT]
> Не размещайте физические устройства StorSimple в тех регионах, где для них не предоставляется поддержка. Майкрософт не будет вам запасные части в странах/регионах которого не поддерживается StorSimple.
