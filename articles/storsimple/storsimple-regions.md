...
|----|----------------|----|-------------|----|--------------|----|----------------------|
| 1  | Австралия      | 16 | Гонконг (ОАР)| 31 | Новая Зеландия  | 46 | Южная Африка         |
...
Содержимое этого списка изменяется по мере добавления новых стран. Последнюю версию списка географических регионов можно получить в приложении к условиям для массива хранения в разделе [Условия для продуктов](https://www.microsoft.com/en-us/licensing/product-licensing/products).
