...
- Страны/регионы, где доступно физическое, облачное или виртуальное устройство StorSimple.
...
В зависимости от модели устройства StorSimple могут быть доступны в разных географических регионах или странах/регионах.

### <a name="storsimple-physical-device-models-81008600"></a>Физическое устройство StorSimple (модели 8100 и 8600)

При использовании физического устройства StorSimple 8100 или 8600 устройство доступно в следующих странах/регионах.
...
Этот список изменяется по мере добавления большего числа стран/регионов. Последнюю версию списка географических регионов можно получить в приложении к условиям для массива хранения в разделе [Условия для продуктов](https://www.microsoft.com/en-us/licensing/product-licensing/products).
...
> [!IMPORTANT]
> Не размещайте физические устройства StorSimple в тех регионах, где для них не предоставляется поддержка. Корпорация Майкрософт не сможет поставлять запасные части в страны/регионы, где StorSimple не поддерживается.
