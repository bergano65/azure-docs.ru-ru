---
title: Доступность региона StorSimple
...
- Страны и регионы, в которых доступно физическое, облачное или виртуальное устройство StorSimple.
...
В зависимости от модели устройства StorSimple могут быть доступны в разных географических регионах или странах или регионах.

### <a name="storsimple-physical-device-models-81008600"></a>Физическое устройство StorSimple (модели 8100 и 8600)

При использовании физического устройства StorSimple 8100 или 8600 устройство доступно в следующих странах и регионах.

| #  | Страна или регион        | #  | Страна или регион     | #  | Страна или регион      | #  | Страна или регион             |
|----|-----------------------|----|--------------------|----|---------------------|----|----------------------------|
| 1  | Австралия             | 16 | Гонконг (САР)      | 31 | Новая Зеландия         | 46 | Южно-Африканская Республика               |
...
| 9  | Чешская Республика        | 24 | Япония              | 39 | Катар               | 54 | Турция                     |
| 10 | Дания               | 25 | Кения              | 40 | Румыния             | 55 | Украина                    |
| 11 | Египет                 | 26 | Кувейт             | 41 | Россия              | 56 | ОАЭ       |
| 12 | Финляндия               | 27 | Макао (САР)          | 42 | Саудовская Аравия        | 57 | Соединенное Королевство             |
...
Этот список изменяется по мере добавления нескольких стран или регионов. Последнюю версию списка географических регионов можно получить в приложении к условиям для массива хранения в разделе [Условия для продуктов](https://www.microsoft.com/en-us/licensing/product-licensing/products).
...
> [!IMPORTANT]
> Не размещайте физические устройства StorSimple в тех регионах, где для них не предоставляется поддержка. Корпорация Майкрософт не сможет поставлять замену в страны и регионы, в которых StorSimple не поддерживается.
