...
5. Убедитесь, что замена выполнена успешно, и диск работоспособен. Откройте портал Azure и выберите **Параметры устройства**  >  **работоспособность оборудования**. В разделах **Общие компоненты** или **Общие компоненты EBOD** состояние диска должно быть обозначено зеленым. Это указывает на работоспособность диска.
