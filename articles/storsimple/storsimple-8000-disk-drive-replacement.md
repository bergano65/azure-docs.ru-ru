...
5. Убедитесь, что замена выполнена успешно, и диск работоспособен. Получите доступ к порталу Azure и перейдите к **настройкам** > устройства**аппаратного обеспечения.** В разделах **Общие компоненты** или **Общие компоненты EBOD** состояние диска должно быть обозначено зеленым. Это указывает на работоспособность диска.
