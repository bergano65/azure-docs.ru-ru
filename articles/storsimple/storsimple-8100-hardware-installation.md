---
title: Установка устройства Microsoft Azure StorSimple 8100
...
значок предупреждения ![](./media/storsimple-safety/IC740879.png)![значок с высокой плотностью](./media/storsimple-8100-hardware-installation/HCS_HeavyWeight_Icon.png) **предупреждение!**
...
5. Установите заглушки на фланцы, вставив их в нужные позиции и закрепив путем нажатия.<br/>
     ...
     ![Установка колпачков](./media/storsimple-8100-hardware-installation/HCSInstallingFlangeCaps.png)
...
2. См. следующую схему сетевого подключения. (Минимальная конфигурация отображается сплошными линиями синего цвета. Дополнительные настройки для обеспечения высокого уровня доступности и производительности отображаются в виде пунктирных линий.)
    ...
    ![Подключите к сети устройство 2U](./media/storsimple-8100-hardware-installation/HCSCableYour2UDeviceforNetwork.png)
...
6. Проверьте работоспособность подключения, нажав на консоли клавишу Ввод. Появится меню последовательной консоли.
