...
5. Настройте подключение через последовательный порт следующим образом: 115200 бод, 8 бит данных, 1 стоповый бит, без контроля четности и поток управления присвоено значение None.
