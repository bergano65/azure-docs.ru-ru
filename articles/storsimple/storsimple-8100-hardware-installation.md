...
2. См. следующую схему сетевого подключения. (Минимальная конфигурация отображается сплошными линиями синего цвета. Дополнительные настройки для обеспечения высокого уровня доступности и производительности отображаются в виде пунктирных линий.)
   ...
   |Метка | Описание |
   |----- | ----------- |
   | А    | Локальная сеть с доступом к Интернету |
   | B    | Контроллер 0 |
   | В    | PCM 0 |
   | D    | Контроллер 1 |
   | E    | PCM 1 |
...
5. Настройте подключение через последовательный порт следующим образом: 115 200 бод, 8 бит данных, 1 бит окончания, без четности и управление потоком задано как None.
6. Проверьте работоспособность соединения, нажав клавишу Enter на консоли. Появится меню последовательной консоли.

> [!NOTE]
> **Управление с выходом на свет**: Если устройство установлено в удаленном центре обработки данных или в компьютерной комнате с ограниченным доступом, убедитесь, что последовательные подключения к обоим контроллерам всегда подключены к коммутатору последовательной консоли или к аналогичному оборудованию. Это позволяет установить удаленное управление и поддерживать работу в случае сбоя сети или непредвиденных сбоев.
> 
> 
