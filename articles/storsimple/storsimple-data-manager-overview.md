...
Примите во внимание следующие рекомендации.
 ...
 - Подключите определение задания и диспетчер данных к региону, содержащему учетную запись хранения StorSimple. Если это невозможно, подключите диспетчер данных к ближайшему региону Azure, а затем создайте определение задания в том же регионе, что и учетная запись хранения StorSimple. 
    ...
    Если вашей учетной записи хранения StorSimple не находится в этих 26 регионов, поддерживаемых Создание определения задания, мы рекомендуем не запускать диспетчер данных StorSimple, как видно, что к продолжительным задержкам и потенциальных плата за исходящий трафик.
    
Корпорация Майкрософт стремится убедитесь, что всегда службы Azure доступны во всех регионах. Тем не менее происходят незапланированные простои служб может возникнуть в течение коротких периодов в определенном регионе. В таком случае можно открыть определение задания и диспетчер данных в регионе, который не затронуты сбоем и запустить задание преобразования. Могут возникнуть некоторые дополнительная задержка, в такой ситуации, но это может быть стратегии восстановления, в редких случаях регионального сбоя.
