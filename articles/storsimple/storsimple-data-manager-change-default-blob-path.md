...
description: Узнайте, как настроить функцию Azure для переименования пути к файлу большого двоичного объекта по умолчанию и перемещения больших двоичных объектов в другое расположение.
author: alkohli
