...
2. Последовательно выберите элементы **Мониторинг > Работоспособность оборудования**. Состояние контроллера 0 или контроллера 1 должно быть выделено красным. Это указывает на отказ.
