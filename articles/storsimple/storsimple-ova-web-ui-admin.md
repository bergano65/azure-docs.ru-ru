...
1. Подключитесь к локальному пользовательскому веб-интерфейсу. Перейдите в раздел **Configuration**  >  **Cloud Settings (параметры облака**).
...
1. В локальном веб-интерфейсе перейдите к разделу **Устранение неполадок**  >  **диагностических тестов**.
...
1. В локальном веб-интерфейсе перейдите к разделу **Устранение неполадок**  >  **системных журналов**.
...
1. В локальном веб-интерфейсе перейдите к разделу **обслуживание**  >  **Параметры управления питанием**.
2. В нижней части страницы нажмите кнопку **Завершение работы**.
