...
1. Подключитесь к локальному пользовательскому веб-интерфейсу. Перейдите к**настройкам облака конфигурации.** **Configuration** > 
...
1. В локальном веб-ui перейдите на > **диагностические тесты**для **устранения проблем.**
...
1. В локальном веб-ui перейдите в журналы **Troubleshooting** > **System.**
...
1. В локальном веб-ui перейдите к**настройкам питания** **обслуживания.** > 
2. В нижней части страницы нажмите **Shutdown**.
