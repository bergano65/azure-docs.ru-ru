...
description: Сведения о конфигурации целевого объекта архивации StorSimple с помощью Veritas NetBackup и рекомендации по интеграции обоих решений.
services: storsimple
documentationcenter: ''
author: harshakirank
manager: matd
...
Распределение по **уровням StorSimple** 
 ![ Схема многоуровневых схем StorSimple](./media/storsimple-configure-backup-target-using-netbackup/image1.jpg)
...
Пошаговое руководство по развертыванию StorSimple см. в статье [Развертывание локального устройства StorSimple (с обновлением 2)](./storsimple-8000-deployment-walkthrough-u2.md).
...
- Отключите [обслуживание Windows Server](/windows/win32/w8cookbook/automatic-maintenance), включенное по умолчанию, в диспетчере задач. Выполните это действие одним из следующих способов.
  - Отключите средство настройки обслуживания в планировщике заданий Windows.
  - Скачайте программу [PsExec](/sysinternals/downloads/psexec) из Windows Sysinternals. После этого запустите Windows PowerShell от имени администратора и введите следующее:
    ```powershell
...
-   Убедитесь, что для устройства StorSimple установлено [обновление 3 или более поздней версии](./index.yml).
...
1.  В консоли администрирования NetBackup выберите **носители и устройства управления устройства**  >  **Devices**  >  **Пулы дисков**. В мастере настройки пула дисков в качестве типа сервера хранилища выберите **AdvancedDisk** и нажмите кнопку **Далее**.
...
4.  Введите имя целевого объекта резервного копирования, а затем нажмите кнопку **Далее**  >  **,** чтобы завершить работу мастера.
...
5. Выберите свой узел, установите флажок **Detect client operating system** (Определять клиентскую операционную систему) и нажмите кнопку **Добавить**. Выберите **Далее**.
...
8. Нажмите кнопку **Далее**  >  **Далее**  >  **Готово**.  Расписание можно изменить после создания политики.
...
1. В консоли администрирования **NetBackup выберите хранилище**  >  **политики жизненного цикла** хранилища  >  **Создание политики жизненного цикла хранилища**.
...
- [Настройка функции Multipath I/O для устройства StorSimple](./storsimple-8000-configure-mpio-windows-server.md)
- [Storage scenarios: Thin provisioning](/windows-hardware/drivers/storage/thin-provisioning) (Сценарии хранилища: тонкая подготовка)
