...
![диаграмма многоуровневого уровня StorSimple](./media/storsimple-configure-backup-target-using-netbackup/image1.jpg)
...
1.  В консоли Администрации NetBackup выберите**Devices** > **дисковые пулы** **для управления средствами мультимедиа и устройств** > управления устройствами. В мастере настройки пула дисков в качестве типа сервера хранилища выберите **AdvancedDisk** и нажмите кнопку **Далее**.
...
4.  Введите имя для целевой резервной копирования, а затем выберите **Next** > **Next,** чтобы закончить мастер.
...
5. Выберите свой узел, установите флажок **Detect client operating system** (Определять клиентскую операционную систему) и нажмите кнопку **Добавить**. Нажмите кнопку **Далее**.
...
8. Выберите **Следующую** > **Следующую** > **Отделку**.  Расписание можно изменить после создания политики.
...
1. В консоли NetBackup Administration Console выберите > **политику жизненного цикла хранения** >  **данных****new Storage Lifecycle Policy.**
