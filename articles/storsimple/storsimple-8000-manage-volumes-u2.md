---
title: Управление объемами StorSimple (Обновление 3)
...
4. После перевода тома в автономный режим (как показано в состоянии тома) выберите том и щелкните его правой кнопкой мыши для вызова контекстного меню. Выберите **изменение громкости**.
...
7. Если выполняется расширение тома, выполните на главном компьютере Windows следующие действия:
   ...
   1. Перейти к ->**управлению диском** **управления компьютером**.
...
7. Чтобы сохранить изменения, нажмите кнопку **Сохранить**. При появлении запроса на подтверждение щелкните **Да** для запуска процесса преобразования. 
