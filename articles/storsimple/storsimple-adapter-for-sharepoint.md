...
* Чтобы скачать адаптер StorSimple для SharePoint, перейдите на страницу [адаптер StorSimple для SharePoint][1] в центре загрузки Майкрософт.
* Сведения о планировании ограничений RBS и RBS см. в статье [Выбор использования RBS в SharePoint 2013][2] или [планирование RBS (SharePoint Server 2010)][3].
