...
2. Щелкните на панели **Область** узел **Тома**. На панели **Результаты** появится список локальных и подключенных томов, включая все тома Azure StorSimple. Столбцы на панели **Результаты** можно настраивать. (Право нажмите узла **объемов,** выберите **Вид,** а затем выберите **Добавить / Удалить столбцы**.)
   ...
   |:--- |:--- |
   |  name |Столбец **Имя** содержит букву диска, назначенную каждому найденному тому. |
...
> [!NOTE]
> Том, который входит в какую-либо группу томов, удалить невозможно. (Опция удаления недоступна для томов, входят в группу томов.) Для удаления громкости необходимо удалить всю группу громкости.
...
* Установите и настройте диспетчер моментальных снимков StorSimple. Для получения дополнительной информации перейдите на [развертывание StorSimple Snapshot Manager](storsimple-snapshot-manager-deployment.md).
...
7. Разверните на панели **Область** узел **Группы томов**. Новая группа томов должна отображаться под узлами **групп объемов.** 
8. Щелкните правой кнопкой мыши имя группы томов.
   ...
   * Чтобы запланировать автоматическое резервное копирование, щелкните пункт **Создать политику резервного копирования**. На странице **Общие** выберите группу томов из списка. На панели **Расписание** введите сведения о расписании. После завершения нажмите кнопку **ОК**. 
