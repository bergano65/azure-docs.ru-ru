...
8. Щелкните правой кнопкой мыши имя группы томов.
   ...
   * Чтобы запланировать автоматическое резервное копирование, щелкните **Создать политику архивации**. На странице **Общие** выберите в списке группу томов. На странице **Расписание** введите данные расписания. По завершении нажмите кнопку **ОК**. 
