...
* Шаг 1. Используйте Управление дисками для создания динамического зеркального тома. 
* Шаг 2. Использование диспетчера моментальных снимков StorSimple для настройки резервного копирования.
...
### <a name="step-1-use-disk-management-to-create-a-dynamic-mirrored-volume"></a>Шаг 1. Используйте Управление дисками для создания динамического зеркального тома
...
### <a name="step-2-use-storsimple-snapshot-manager-to-configure-backup"></a>Шаг 2. Использование диспетчера моментальных снимков StorSimple для настройки резервного копирования
