...
4. В колонке **Свойства** для учетных данных учетной записи хранения выполните следующие действия.
   ...
   2. Ключи доступа для учетных данных учетной записи хранения можно создать повторно. Дополнительные сведения см. в статье [Управление ключами доступа учетной записи хранения](../storage/common/storage-account-keys-manage.md). Укажите новый ключ для учетных данных учетной записи хранения. Для учетной записи хранения Azure это первичный ключ доступа.
