...
2. Перейдите на устройство и перейдите к **настройкам** > **оборудования здоровья**, и убедитесь, что состояние светодиода для активного модуля контроллера EBOD является зеленым и светодиод для неисправного модуля контроллера EBOD красный.
...
2. С защелками в открытом положении установите модуль в корпус и продвигайте его до срабатывания защелок.
    ...
    **Рисунок 2**  Установка модуля контроллера EBOD
3. Закройте защелку. При срабатывании защелки вы должны услышать щелчок.
    ...
    **Рисунок 3**  Закрытие защелки модуля EBOD
4. Подключите кабели. Конфигурация должна остаться той же, которая была до замены модуля. Подробные сведения о подключении кабелей приведены на следующей схеме и в таблице.
    ...
    **Рисунок 4**. Повторное подключение кабелей
