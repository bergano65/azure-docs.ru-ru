...
| **Низкоуровневая оболочка** | **Version (версия)** |
| --- | --- |
...
| **Компонент** | **Version (версия)** | **Дополнительные требования и примечания** |
| --- | --- | --- |
...
| **Номер порта<sup>1</sup>** | **Входящий или исходящий** | **Область порта** | **Обязательно для заполнения** | **Примечания** |
| --- | --- | --- | --- | --- |
