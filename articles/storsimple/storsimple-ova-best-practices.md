...
Общее пространство, требуемое на локальном уровне в данный момент является: 240 GB + 120 GB + 330 GB = 690 GB.

Во-вторых, на локальном уровне понадобится дополнительное пространство, соответствующее наибольшему зарезервированному пространству или превышающее его. Этот дополнительный объем резервируется на случай, если потребуется выполнить восстановление из облачного моментального снимка. В этом примере наибольшее локально зарезервированное пространство составляет 330 ГБ (включая пространство для файловой системы), который нужно добавить к 690 ГБ: 690 GB + 330 GB = 1020 GB.
...
— Общее пространство, требуемое на локальном уровне: 240 ГБ + 330 ГБ = 570 ГБ
