...
Общий объем пространства, необходимый на локальном уровне, составляет: 240 ГБ + 120 ГБ + 330 ГБ = 690 ГБ.

Во-вторых, на локальном уровне понадобится дополнительное пространство, соответствующее наибольшему зарезервированному пространству или превышающее его. Этот дополнительный объем резервируется на случай, если потребуется выполнить восстановление из облачного моментального снимка. В этом примере максимальное локальное резервирование — 330 ГБ (включая резервирование файловой системы), поэтому его можно добавить в 690 ГБ: 690 ГБ + 330 ГБ = 1020 ГБ.
...
Общий объем необходимого пространства на локальном уровне: 240 ГБ + 330 ГБ = 570 ГБ
