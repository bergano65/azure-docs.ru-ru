...
* Размер файлов относительно размера подготовленной многоуровневой общей папки может влиять на производительность распределения по уровням. Работа с большими файлами может привести к медленному выходу. При работе с большими файлами мы рекомендуем, чтобы самый большой файл был меньше 3% от размера доли.
...
* При создании тома следует учитывать уровень ожидаемого использования данных, а также будущий рост. Объем или доля не могут быть расширены позже.
* После создания объема/доли нельзя уменьшить размер объема/доли на StorSimple.
