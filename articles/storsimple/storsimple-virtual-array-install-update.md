...
1. В локальном веб-интерфейсе перейдите в раздел **обслуживание**  >  **Обновление программного обеспечения**.
    ...
    ![На снимке экрана показано обновление программного обеспечения, выбранное в меню "обслуживание".](./media/storsimple-virtual-array-install-update/update1m.png)
...
2. В поле **Путь к файлу обновления** введите имя файла обновления или исправления. Также вы можете найти файл установки обновления или исправления, если он расположен в сетевой папке. Щелкните **Применить**.
    ...
    ![На снимке экрана отображается текстовое поле путь к файлу обновления на странице Обновление программного обеспечения.](./media/storsimple-virtual-array-install-update/update2m.png)
...
3. Отобразится предупреждение. Если это устройство с одним узлом, то после применения обновления оно перезагружается, а также возникает время простоя. Щелкните значок галочки.
   ...
   ![На снимке экрана показано диалоговое окно с предупреждением о простоях.](./media/storsimple-virtual-array-install-update/update3m.png)
...
4. Начинается обновление. После успешного обновления устройство перезапускается. В течение этого времени локальный пользовательский интерфейс недоступен.
    ...
    ![На снимке экрана показано сообщение об успешном выполнении обновления.](./media/storsimple-virtual-array-install-update/update5m.png)

5. После перезапуска открывается страница **входа** . Чтобы убедиться, что программное обеспечение устройства Обновлено, в локальном веб-интерфейсе перейдите в раздел **обслуживание**  >  **Обновление программного обеспечения**. Для обновления 0.3 должна отображаться версия программного обеспечения **10.0.0.0.0.10288.0** .
   ...
   > Версии программного обеспечения в локальном веб-интерфейсе и на портале Azure отображаются немного по-разному. Например, для одной и той же версии в локальном пользовательском веб-интерфейсе отображается номер **10.0.0.0.0.10288** , а на портале Azure — **10.0.10288.0**.
    ...
    ![На снимке экрана показана страница обновления программного обеспечения с текущей версией программного обеспечения.](./media/storsimple-virtual-array-install-update/update6m.png)
