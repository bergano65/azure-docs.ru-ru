...
Этот тест проверяет состояние сетевых интерфейсов, портов, DNS и NTP-серверов, сертификата TLS/SSL, учетных данных учетной записи хранилища, подключения к серверам обновления и подключения веб-прокси на устройстве StorSimple.
