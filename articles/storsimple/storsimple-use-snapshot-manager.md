...
| Клонировать |Разверните узел **Каталог резервных копий**, затем разверните узел **Облачные моментальные снимки**, щелкните датированную резервную копию и выберите том в панели **Результаты**, |Нажмите **Клонировать**, чтобы создать копию облачного моментального снимка и сохранить ее в назначенном месте. |
...
| Создать политику архивации |Выполните одно из следующих действий.<ul><li>Щелкните правой кнопкой мыши пункт **Политики резервного копирования**.</li><li>Щелкните узел **Группы томов** или разверните его, а затем щелкните правой кнопкой мыши группу томов.</li><li>Щелкните узел **Каталог резервных копий** или разверните его, а затем щелкните правой кнопкой мыши группу томов.</li></ul> |Выберите пункт **Создать политику резервного копирования**, чтобы настроить резервное копирование по расписанию для группы томов. |
| Создать группу томов |Выполните одно из следующих действий.<ul><li>Щелкните узел **Тома**, а затем щелкните правой кнопкой мыши том в панели **Результаты**.</li><li>Щелкните правой кнопкой мыши узел **Группы томов**.</li></ul> |Выберите пункт **Создать группу томов**, чтобы назначить тома в группу томов. |
...
| Подробнее |Выберите узел **Устройства**, а затем щелкните правой кнопкой мыши устройство на панели **Результаты**. |Щелкните **Сведения** , чтобы просмотреть данные о конфигурации устройства. |
