...
| Удалить |Щелкните узел или результат (этот элемент появляется во многих меню **Действие** и на панелях **Действия**). |Выберите пункт **Удалить**, чтобы удалить выбранный узел или результат. Когда появится диалоговое окно подтверждения, подтвердите или отмените удаление. |
...
| Правка |Щелкните узел **Политики резервного копирования**, а затем щелкните правой кнопкой мыши политику в панели **Результаты**. |Выберите пункт **Правка**, чтобы изменить расписание резервного копирования для группы томов. |
...
| Обновление |Щелкните любой узел или результат (этот элемент появляется во всех вариантах меню **Действие** и панелей **Действия**). |Щелкните **Обновить** , чтобы обновить отображаемое окно диспетчера моментальных снимков StorSimple. |
...
| Сочетание клавиш | Результат | Клавиша для работы с меню | Результат |
|:--- |:--- |:--- |:--- |
