...
| Элемент меню | Description |
|:--- |:--- |
| Новинка |Щелкните **Создать** , чтобы создать консоль в диспетчере моментальных снимков StorSimple. |
| Открытость |Щелкните **Открыть** , чтобы открыть существующую консоль. |
...
| Действия | Навигация | Description |
|:--- |:--- |:--- |
...
| Изменить |Выберите **Политики архивации**, а затем щелкните правой кнопкой мыши политику на панели **Результаты**. |Щелкните **Изменить** , чтобы изменить расписание архивации для группы томов. |
...
| Cascade |Щелкните **Каскадом** , чтобы отобразить открытые окна консоли каскадом. |
...
|:--- |:--- |:--- |:--- |
| ALT+F |Открытие меню **Файл** . |N |Открытие нового экземпляра консоли. |
...
|  |млн |Открытие страницы **Добавить или удалить оснастку** . | |
|  |P |Открытие страницы **Параметры** . | |
|  |Серия H |Открытие справки в Интернете. | |
...
| ALT+W |Открытие меню **Окно** . |N |Открытие другого окна диспетчера моментальных снимков StorSimple. |
...
| ALT+H |Открытие меню **Справка** . |Серия H |Открытие справки в Интернете. |
