---
title: Включите или выключите или выключите устройство серии StorSimple 8000
...
> 
> Прежде чем завершить работу устройства, убедитесь, что все его компоненты работоспособны. На портале Azure перейдите на > **систему работоспособности**оборудования для**мониторинга** **устройств** > и убедитесь, что состояние всех компонентов является зеленым. Это относится только к работоспособной системе. Если система отключается для замены неисправного компонента, то соответствующий компонент будет иметь состояние сбоя (красный цвет) или ухудшения характеристик (желтый цвет) в разделе **Состояние оборудования**.
> 
> 
...
> [!IMPORTANT]
> Прежде чем завершить работу основного корпуса и корпуса EBOD, убедитесь, что все компоненты устройства работоспособны. На портале Azure перейдите на > **систему работоспособности**оборудования для**мониторинга** **устройств** > и убедитесь, что все компоненты являются работоспособными.
