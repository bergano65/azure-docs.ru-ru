...
**Рис. 1. Подключенные устройства диспетчера моментальных снимков StorSimple** 
...
|:--- |:--- |
| Name |Имя устройства, заданное на классическом портале Azure |
| Модель |Номер модели устройства |
| Version |Версия программного обеспечения, установленного на устройстве |
| Статус |Сведения о доступности устройства |
...
1. Перенастройте подключение iSCSI на новое устройство. Инструкции см. в статье «шаг 7: Подключение, инициализация и форматирование тома» в [развертывание локального устройства StorSimple](storsimple-8000-deployment-walkthrough-u2.md).
...
5. Чтобы настроить новое устройство StorSimple, выполните действия, описанные в шаге 2. Подключение устройства StorSimple в [развертывание диспетчера моментальных снимков StorSimple](storsimple-snapshot-manager-deployment.md).
