...
3. Откроется диалоговое окно Создание группы томов. Можно изменить записи **Имя**, **Приложения** и **Тома**.
