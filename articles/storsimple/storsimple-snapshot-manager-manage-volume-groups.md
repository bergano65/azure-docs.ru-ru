...
| Selected |В столбце **Выбранные** отображается количество томов в каждой группе томов. Ноль (0) значит, что с томами в группе томов не связано ни одно приложение. |
