...
* **Конфиденциальность** — только авторизованные сущности могут видеть ваши данные.
* **Целостность** — только авторизованные сущности могут изменять или удалять ваши данные.
...
* **Облачное хранилище** — место хранения данных в облаке Azure.
...
* Используйте надежные пароли. Дополнительные сведения см. в публикации блога [Create stronger passwords and protect them](https://cloudblogs.microsoft.com/microsoftsecure/2014/08/25/create-stronger-passwords-and-protect-them/) (Создание более надежных паролей и их защита).
...
Для каждой подписки Microsoft Azure можно создать одну или несколько учетных записей хранения. (Учетная запись хранения предоставляет уникальное пространство имен для работы с данными, хранящимися в облаке Azure.) Доступ к учетной записи хранения контролируется подпиской и ключами доступа, связанными с этой учетной записью хранения.
...
**Вопрос.** Устройство было авторизовано для изменения ключа шифрования данных службы, но этот процесс так и не начался.   Что следует делать?
...
**Вопрос.** Наш администратор StorSimple уволился из компании.   Что следует делать?
...
* [Командлет Import-Certificate](/powershell/module/pkiclient/import-certificate)
