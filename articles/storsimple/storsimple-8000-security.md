...
Для каждой подписки Microsoft Azure можно создать одну или несколько учетных записей хранения. (Учетная запись хранилища предоставляет уникальное пространство имен для работы с данными, хранящимися в облаке Azure.) Доступ к учетной записи хранилища контролируется подпиской и ключами доступа, связанными с этой учетной записью хранения.
...
* [Используйте службу StorSimple Device Manager для изменения паролей](storsimple-8000-change-passwords.md)
* [Изменение ключа шифрования данных службы](storsimple-8000-manage-service.md#change-the-service-data-encryption-key)
