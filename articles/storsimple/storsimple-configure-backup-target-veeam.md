...
description: Узнайте о конфигурации целевого объекта архивации StorSimple с Veeam и рекомендациями по интеграции обоих решений.
services: storsimple
documentationcenter: ''
author: harshakirank
manager: matd
...
Распределение по **уровням StorSimple** 
 ![ Схема многоуровневых схем StorSimple](./media/storsimple-configure-backup-target-using-veeam/image1.jpg)
...
3.  Выберите тип **Microsoft Windows server**. Выберите сервер Veeam. Выберите **Далее**.
