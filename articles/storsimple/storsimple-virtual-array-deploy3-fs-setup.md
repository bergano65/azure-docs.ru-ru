...
5. После успешного создания учетных данных учетной записи хранения колонка **Настройка** обновится, и в ней появятся указанные данные. Нажмите кнопку **Настройка**.
