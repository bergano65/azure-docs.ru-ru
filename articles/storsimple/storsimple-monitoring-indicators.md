...
| Питание системы | Сбой модуля | Логический сбой | Оповещение | Статус |
| --- | --- | --- | --- | --- |
| Красно-желтый |ВЫКЛ. |ВЫКЛ. |Н/Д |Питание от электросети отсутствует, используется резервный источник питания; или питание от электросети включено, но модули контроллера извлечены. |
| Зеленый |ВКЛ. |ВКЛ. |Н/Д |Состояние тестирования с включенным питанием ПУ (5 с) |
| Зеленый |ВЫКЛ. |ВЫКЛ. |Н/Д |Питание включено, все функционирует нормально |
| Зеленый |ВКЛ. |Н/Д |Светодиодные индикаторы сбоя блока питания с охлаждением (БПО), светодиодные индикаторы сбоя вентилятора |Любой сбой БПО, сбой вентилятора, слишком высокая или слишком низкая температура |
| Зеленый |ВКЛ. |Н/Д |Светодиодные индикаторы модуля ввода-вывода |Любой сбой модуля контроллера |
| Зеленый |ВКЛ. |Н/Д |Н/Д |Логический сбой корпуса |
| Зеленый |Мигание |Н/Д |Светодиодный индикатор состояния модуля на модуле контроллера. Светодиодные индикаторы сбоя блока питания с охлаждением (БПО), светодиодные индикаторы сбоя вентилятора |Установлен модуль контроллера неизвестного типа, сбой шины I2C, ошибка конфигурации VPD модуля контроллера |
...
| Статус | БПО исправен (зеленый) | Сбой питания от электросети (желтый) | Сбой вентилятора (желтый) | Сбой питания от аккумулятора (желтый) |
| --- | --- | --- | --- | --- |
...
| Сбой БПО (сбой вентилятора) |ВЫКЛ. |ВЫКЛ. |ВКЛ. |Н/Д |
...
| Статус | Аккумулятор исправен (зеленый) | Сбой аккумулятора (желтый) |
| --- | --- | --- |
...
| Статус | Модуль ввода-вывода исправен (зеленый) | Сбой модуля ввода-вывода (желтый) | Активность порта узла (зеленый) |
| --- | --- | --- | --- |
...
| Статус | Светодиодный индикатор нормальной активности (зеленый) | Светодиодный индикатор сбоя (красно-желтый) | Светодиодный индикатор связанной ПУ |
| --- | --- | --- | --- |
...
| S1 |Режим сбоя: 1 секунда Прерывистый |Переход в S2 или S3 (см. примечания) |
| S2 |Режим напоминания: кратковременный сигнал |Нет |
| S3 |Режим с отключенным звуком: без звука |Нет |
...
| Статус | Уровень серьезности | Сигнал | Светодиодный индикатор ПУ |
| --- | --- | --- | --- |
