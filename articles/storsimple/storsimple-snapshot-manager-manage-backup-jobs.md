...
В этом учебнике объясняется, как с помощью узла **Задания** отобразить сведения о запланированных, последних и выполняющихся заданиях архивации. (Список заданий и соответствующая информация отосвазаны в панели **результатов.)** Кроме того, можно нажать правой кнопкой мыши на указанное задание и увидеть контекстное меню, в которое перечислены доступные действия.
