...
| Изменить ключ шифрования данных службы</br>Просмотреть журналы операций |[Использование панели мониторинга службы диспетчера устройств StorSimple](storsimple-8000-service-dashboard.md) |
...
| Об учетных записях хранения</br>Добавить учетную запись хранения</br>изменение учетной записи хранения;</br>Удаление учетной записи хранения</br>смена ключей учетных записей хранения. |[Управление учетными записями хранения](storsimple-8000-manage-storage-accounts.md) |
...
| Добавить контейнер томов</br>Изменение контейнера томов</br>Удаление контейнера томов |[Управление контейнерами томов](storsimple-8000-manage-volume-containers.md) |
| Добавить том</br>Изменение тома</br>Отключение тома</br>Удаление тома</br>Мониторинг тома |[Управление томами](storsimple-8000-manage-volumes-u2.md) |
