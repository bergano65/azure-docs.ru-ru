---
title: Безопасная установка & управлять устройством серии StorSimple 8000
...
| ![Предупреждение](./media/storsimple-safety/IC740879.png) значок **ВНИМАНИЕ!** |Указывает на опасную ситуацию, которая может привести к смерти или серьезной травме. |
...
* Не используйте двуногие шнуры питания ("Y" приводит).
...
![Предупреждение](./media/storsimple-safety/IC740879.png) значок **ВНИМАНИЕ!**
...
При транспортировке или иной транспортировке батарей по воздуху следуйте документу IATA Lithium Battery Guidance[https://www.iata.org/whatwedo/cargo/dgr/Pages/lithium-batteries.aspx](https://www.iata.org/whatwedo/cargo/dgr/Pages/lithium-batteries.aspx)
