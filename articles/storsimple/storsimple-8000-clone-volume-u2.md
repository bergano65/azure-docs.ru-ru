...
3. В колонке **Клонировать** сделайте следующее:
   ...
   2. Укажите уникальное имя тома для клона. Имя должно содержать от 3 до 127 символов.
...
Клон, созданный таким способом, называется промежуточным. Дополнительные сведения о типах клонов см. в разделе [Сравнение временных и постоянных клонов](#transient-vs-permanent-clones).
