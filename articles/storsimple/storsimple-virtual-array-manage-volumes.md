...
| Максимальный размер локально закрепленного тома                    | 200 Мб        |
...
1. В колонке сводных данных о службе StorSimple щелкните **+ Добавить том** на панели команд. Откроется колонка **Добавить том** .
    ...
    ![На снимке экрана показана кнопка Добавить том и область добавить том.](./media/storsimple-virtual-array-manage-volumes/add-volume.png)
...
3. Чтобы добавить новый подключенный узел, щелкните **Добавить** , введите обычное имя и полное имя iSCSI узла, а затем нажмите кнопку **Добавить** .
    ...
    ![На снимке экрана показана область подключенных узлов, в которой можно добавить новый.](./media/storsimple-virtual-array-manage-volumes/volume-add-acr.png)
