...
> [!NOTE]
> **Управление освещением:** Когда устройство устанавливается в удаленном центре обработки данных или в компьютерном зале с ограниченным доступом, убедитесь, что серийные соединения с обоими контроллерами всегда подключены к серийному коммутатору консоли или аналогичному оборудованию. Это позволяет установить удаленное управление и поддерживать работу в случае сбоя сети или непредвиденных сбоев.
> 
> 
