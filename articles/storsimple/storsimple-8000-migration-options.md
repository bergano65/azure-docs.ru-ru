---
title: Варианты миграции данных с устройств серии StorSimple 5000-7000
...
Узнайте больше о [переходе на платформу данных о сплоченности.](https://info.cohesity.com/migrate-from-storsimple-to-cohesity.html)

#### <a name="migrate-to-nasuni"></a>Мигрировать в Насуни

Nasuni упрощает для клиентов StorSimple 5000-7000 мигрировать и хранить свои данные в Azure.  Nasuni является ведущим решением для хранения NAS на основе Azure, предоставляя клиентам производительность и безопасность, которые они ожидают от решений on-prem, с облачной экономикой и масштабом.  Помимо высокопроизводительного хранения файлов, Nasuni и Azure обрабатывают резервное копирование и DR, позволяя вам обмениваться и совместно работать над данными по всему миру с централизованным управлением хранением файлов. 

Nasuni имеет опыт, чтобы сделать вашу миграцию легко - начать сегодня:https://info.nasuni.com/nasuni-storsimple-migration

#### <a name="migrate-to-talon-fast"></a>Мигрировать в Talon FAST

Talon позволяет клиентам StorSimple 5000-7000 продолжать использовать преимущества, которые они так ценили на платформе StorSimple (небольшой след на месте, поддерживаемый неограниченными облачными ресурсами) с еще большей функцией.  С помощью решения Talon FAST клиенты могут мигрировать и хранить свои данные в Azure, в то время как теперь они имеют еще меньший доступ только к программному обеспечению на месте и добавляя такие преимущества, как глобальная блокировка файлов, глобальное пространство имен и многоузловое сотрудничество.  Talon является ведущим экосистемным решением Azure, работающим с глобальными клиентами, чтобы перенести свои рабочие нагрузки файлового сервера в консолидированный, основанный на Azure, без ущерба для рабочего процесса или опыта пользователей.  

Узнайте больше о том, как эволюционировать к облачному предприятию в. https://www.talonstorage.com/alliances/microsoft-storsimple
...
A. В зависимости от сценария для пользователей устройств StorSimple серий 5000–7000 доступны следующие варианты переноса. 
