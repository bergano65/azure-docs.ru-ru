...
### <a name="q-when-do-the-storsimple-5000-and-7000-series-devices-reach-end-of-service"></a>Вопрос. Когда наступает дата окончания поддержки для устройств StorSimple серий 5000 и 7000? 
...
### <a name="q-what-happens-to-the-data-i-have-stored-in-azure"></a>Вопрос. Что происходит с данными, которые хранятся в Azure?  

А. Вы можете продолжать использовать данные в Azure после их перемещения в новую службу. 


### <a name="q-what-happens-to-the-data-i-have-stored-locally-on-my-storsimple-device"></a>Вопрос. Что происходит с данными, которые хранятся локально на устройстве StorSimple? 

А. Данные, которые хранятся локально на устройстве, можно скопировать в новую службу, как описано в документах о переносе.

### <a name="q-what-happens-if-i-want-to-keep-my-storsimple-50007000-series-appliance"></a>Вопрос. Что произойдет, если я хочу сохранить устройство StorSimple серии 5000 или 7000? 
...
### <a name="q-what-options-are-available-to-migrate-data-from-storsimple-5000-7000-series-devices"></a>Вопрос. Какие варианты доступны для переноса данных с устройств StorSimple серий 5000–7000? 

А. В зависимости от сценария для пользователей устройств StorSimple серий 5000–7000 доступны следующие варианты переноса. 
...
### <a name="q-is-migration-to-other-storage-solutions-supported"></a>Вопрос. Поддерживается ли перенос данных в другие решения для хранения?

А. Да. Поддерживается перенос на другие решения для хранения с использованием копии узла данных.

### <a name="q-is-migration-supported-by-microsoft"></a>Вопрос. Поддерживается ли перенос корпорацией Майкрософт? 
...
### <a name="q-what-is-the-pricing-model-for-both-the-migration-options"></a>Вопрос. Какова модель ценообразования для обоих вариантов миграции?
...
### <a name="q--how-long-does-it-take-to-complete-a-migration"></a>Вопрос.  Сколько времени занимает процесс переноса данных?

А. Время переноса данных зависит от объема данных и выбранного варианта обновления. 

### <a name="q-what-is-the-end-of-support-date-for-storsimple-8000-series"></a>Вопрос. Какова дата окончания поддержки StorSimple серии 8000?
