---
title: Просмотр и управление оповещениями для устройства серии StorSimple 8000
...
* **Сбои оборудования** – эти оповещения дают информацию о работоспособности оборудования. Они позволяют узнать, требуется ли обновление встроенного ПО, есть ли проблемы сетевого интерфейса и присутствуют ли сложности с одним из дисков с данными.
...
2. Перейти к **настройкам** > **Общего** для устройства.
...
* [Предупреждения о безопасности](#security-alerts)
...
| Для Data0 обнаружен повторяющийся IP-адрес. | |Система обнаружила конфликт для IP-адреса 10.0.0.1. Сетевой ресурс "Data0" на * \<устройстве1>* находится в автономном режиме. Убедитесь, что этот IP-адрес не использует другая сущность в этой сети. Дополнительные сведения об устранении неполадок сети см. в статье [Устранение неполадок в развертывании устройства StorSimple](storsimple-8000-troubleshoot-deployment.md#troubleshoot-with-the-get-netadapter-cmdlet). Обратитесь к администратору сети за помощью в решении этой проблемы. Если проблема будет повторяться, обратитесь в службу поддержки Майкрософт. |
| Адрес IPv4 (или IPv6) для Data0 находится вне сети. | |Сетевой ресурс Data0 с IP-адресом 10.0.0.1. и приставка длина '22' на * \<устройстве1>* находится в автономном режиме. Убедитесь, что порты коммутатора, к которым подключен этот интерфейс, исправны. Дополнительные сведения об устранении неполадок сети см. в статье [Устранение неполадок в развертывании устройства StorSimple](storsimple-8000-troubleshoot-deployment.md#troubleshoot-with-the-get-netadapter-cmdlet). |
| Не удалось подключиться к службе проверки подлинности. |Ошибка пути к данным |URL-адрес, используемый для проверки подлинности, недоступен. Убедитесь, что правила брандмауэра содержат шаблоны URL-адресов, заданные для устройства StorSimple. Для получения дополнительной информации о шаблонах URL на\/портале Azure перейдите на https: /aka.ms/ss-8000-network-reqs. При использовании облака правительства Azure перейдите к\/шаблонам URL в https: /aka.ms/ss8000-gov-network-reqs.|
