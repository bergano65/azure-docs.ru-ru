---
title: Просмотр оповещений для устройства StorSimple 8000 и управление ими
...
После включения уведомлений по электронной почте для устройства члены списка уведомлений будут получать сообщение электронной почты каждый раз при возникновении критического оповещения. Сообщения будут отправлены из *storsimple-Alerts-reply\@mail.WindowsAzure.com* и будут описывать условия предупреждения. Получатели могут нажать **Отменить подписку**, чтобы удалить себя из списка уведомлений по электронной почте.
...
3. Чтобы отправить тестовое уведомление по электронной почте, щелкните **Отправить тестовое электронное сообщение**. Служба диспетчера устройств StorSimple будет отображать сообщения о состоянии по мере отправки тестового уведомления.
    ...
    ![Параметры предупреждения](./media/storsimple-8000-manage-alerts/configure-alerts-email3.png)
...
5. Когда настройка будет завершена, нажмите кнопку **Сохранить**. При запросе подтверждения нажмите кнопку **Да**.
...
![Панель оповещений](./media/storsimple-8000-manage-alerts/device-summary4.png)
...
При нажатии на кнопку **Сброс** можно оставить свои комментарии об оповещении, а также указать действия, которые были предприняты для разрешения проблемы. Некоторые события будут удалены системой, если другое событие активируется новыми данными. В этом случае вы увидите следующее сообщение.

![Очистить сообщение об оповещении](./media/storsimple-manage-alerts/admin_alerts_system_clear.png)
...
| Устройство переключено на <*имя устройства*>. |Завершение работы или перезапуск контроллера. |Устройство выполнило отработку отказа, так как администратор завершил работу контроллера или перезапустил его. Никакие действия не требуются. После подтверждения этого оповещения удалите его со страницы оповещений. |
...
| Виртуальный IP-адрес сетевого интерфейса <*Данные №*> сообщает о сбое. |Неизвестные или другие причины. |Иногда временные условия могут вызывать эти оповещения. В таком случае это оповещение будет автоматически удалено через некоторое время. Если проблема сохраняется, обратитесь в службу поддержки Майкрософт. |
...
| Текст оповещения | Событие | Дополнительные сведения и рекомендуемые действия |
|:--- |:--- |:--- |
| Аппаратный компонент <*идентификатор_компонента*> сообщает о состоянии <*состояние*>. | |Иногда временные условия могут вызывать эти оповещения. В таком случае это оповещение будет автоматически удалено через некоторое время. Если проблема сохраняется, обратитесь в службу поддержки Майкрософт. |
...
| Текст оповещения | Событие | Дополнительные сведения и рекомендуемые действия |
|:--- |:--- |:--- |
| Не удалось запустить службу или службы StorSimple. |Ошибка пути к данным |Если проблема сохраняется, обратитесь в службу поддержки корпорации Майкрософт. |
| Для Data0 обнаружен повторяющийся IP-адрес. | |Система обнаружила конфликт для IP-адреса 10.0.0.1. Сетевой ресурс "Data0" на устройстве *\<device1 >* находится в режиме "вне сети". Убедитесь, что этот IP-адрес не использует другая сущность в этой сети. Дополнительные сведения об устранении неполадок сети см. в статье [Устранение неполадок в развертывании устройства StorSimple](storsimple-8000-troubleshoot-deployment.md#troubleshoot-with-the-get-netadapter-cmdlet). Обратитесь к администратору сети за помощью в решении этой проблемы. Если проблема сохраняется, обратитесь в службу поддержки корпорации Майкрософт. |
| Адрес IPv4 (или IPv6) для Data0 находится вне сети. | |Сетевой ресурс Data0 с IP-адресом 10.0.0.1. и длина префикса "22" на устройстве *\<device1 >* находится в режиме "вне сети". Убедитесь, что порты коммутатора, к которым подключен этот интерфейс, исправны. Дополнительные сведения об устранении неполадок сети см. в статье [Устранение неполадок в развертывании устройства StorSimple](storsimple-8000-troubleshoot-deployment.md#troubleshoot-with-the-get-netadapter-cmdlet). |
| Не удалось подключиться к службе проверки подлинности. |Ошибка пути к данным |URL-адрес, используемый для проверки подлинности, недоступен. Убедитесь, что правила брандмауэра содержат шаблоны URL-адресов, заданные для устройства StorSimple. Дополнительные сведения о шаблонах URL-адресов в портал Azure см. на странице https:\//aka.ms/ss-8000-network-reqs. При использовании облака Azure для государственных организаций перейдите к шаблонам URL-адресов в формате HTTPS:\//aka.ms/ss8000-gov-network-reqs.|
...
| Текст оповещения | Событие | Дополнительные сведения и рекомендуемые действия |
|:--- |:--- |:--- |
| Не удалось создать пакет поддержки. |StorSimple не удалось создать пакет. |Повторите операцию. Если проблема сохраняется, обратитесь в службу поддержки Майкрософт. После решения проблемы удалите это оповещение со страницы оповещений. |
