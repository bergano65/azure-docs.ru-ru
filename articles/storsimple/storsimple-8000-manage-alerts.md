...
2. Перейдите в раздел **Параметры**  >  **Общие** для устройства.
...
5. Когда настройка будет завершена, нажмите кнопку **Сохранить**. При запросе подтверждения нажмите кнопку **Да**.
     ...
     ![Оповещение о тесте отправлено по электронной почте 2](./media/storsimple-8000-manage-alerts/configure-alerts-email5.png)
...
| Для Data0 обнаружен повторяющийся IP-адрес. | |Система обнаружила конфликт для IP-адреса 10.0.0.1. Сетевой ресурс "Data0" на устройстве находится в *\<device1>* автономном режиме. Убедитесь, что этот IP-адрес не использует другая сущность в этой сети. Дополнительные сведения об устранении неполадок сети см. в статье [Устранение неполадок в развертывании устройства StorSimple](storsimple-8000-troubleshoot-deployment.md#troubleshoot-with-the-get-netadapter-cmdlet). Обратитесь к администратору сети за помощью в решении этой проблемы. Если проблема будет повторяться, обратитесь в службу поддержки Майкрософт. |
| Адрес IPv4 (или IPv6) для Data0 находится вне сети. | |Сетевой ресурс Data0 с IP-адресом 10.0.0.1. и длина префикса "22" на устройстве *\<device1>* отключена. Убедитесь, что порты коммутатора, к которым подключен этот интерфейс, исправны. Дополнительные сведения об устранении неполадок сети см. в статье [Устранение неполадок в развертывании устройства StorSimple](storsimple-8000-troubleshoot-deployment.md#troubleshoot-with-the-get-netadapter-cmdlet). |
| Не удалось подключиться к службе проверки подлинности. |Ошибка пути к данным |URL-адрес, используемый для проверки подлинности, недоступен. Убедитесь, что правила брандмауэра содержат шаблоны URL-адресов, заданные для устройства StorSimple. Дополнительные сведения о шаблонах URL-адресов в портал Azure см. на странице https: \/ /AKA.MS/SS-8000-Network-reqs. Если вы используете облако Azure для государственных организаций, перейдите по шаблонам URL-адресов в формате HTTPS: \/ /AKA.MS/ss8000-gov-Network-reqs.|
...
### <a name="enclosure-environment-alerts"></a>Предупреждения окружения корпуса
