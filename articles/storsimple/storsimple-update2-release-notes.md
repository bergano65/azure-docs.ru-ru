...
* **Улучшения обновления** — в обновлении 1.2 и более ранних версиях устройство StorSimple серии 8000 была обновлена по двум каналам: Обновление Windows для кластеризации, iSCSI и т. д. и Центр обновления Майкрософт для двоичных файлов и встроенного по.
...
| № | Компонент | Проблема | Для физического устройства | Для виртуального устройства |
| --- | --- | --- | --- | --- |
| 1 |Сетевые интерфейсы |После обновления до обновления 1 служба StorSimple Manager сообщила о сбое портов Data2 и Data3 на одном контроллере. Теперь эта проблема устранена. |Да |Нет |
