...
> [!NOTE]
> Сведения о развертывании StorSimple, опубликованные на веб-сайте Microsoft Azure, применяются только к устройствам серии StorSimple 8000. Для получения полной информации о устройствах [http://onlinehelp.storsimple.com/](http://onlinehelp.storsimple.com)серии 7000, перейдите по: . Сведения о развертывании устройств серии 7000 см. в [кратком руководстве по системе StorSimple](http://onlinehelp.storsimple.com/111_Appliance/).
...
| Шаг | Описание |
| --- | --- |
| **Необходимые условия** |При подготовке к предстоящему развертыванию необходимо выполнить следующее. |
...
|  | |
| **ПОЭТАПНОЕ РАЗВЕРТЫВАНИЕ** |Эти шаги обязательны для развертывания устройства StorSimple в производственной среде. |
...
| [Шаг 2: Получить ключ регистрации службы](#step-2-get-the-service-registration-key) |С помощью этого ключа зарегистрируйте и подключите устройство StorSimple к службе управления. |
...
| [Настройка нового учетной записи хранилища для службы](#configure-a-new-storage-account-for-the-service) | |
| [Используйте PuTTY для подключения к серийной консоли устройства](#use-putty-to-connect-to-the-device-serial-console) | |
| [Сканирование и применение обновлений](#scan-for-and-apply-updates) | |
| [Получите I'N хоста Windows Server](#get-the-iqn-of-a-windows-server-host) | |
| [Создание ручного резервного копирования](#create-a-manual-backup) | |
...
Резервные копии обеспечивают защиту состояния томов до определенной точки во времени и улучают возможности восстановления, одновременно снижая время восстановления. Устройство StorSimple позволяет создавать резервные копии двух типов: локальные и облачные моментальные снимки. Резервные копии каждого из этих типов могут быть **запланированы** или запускаться **вручную**.
