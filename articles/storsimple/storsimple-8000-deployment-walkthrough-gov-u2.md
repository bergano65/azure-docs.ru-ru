...
| [Использование выводимых для подключения к последовательной консоли устройства](#use-putty-to-connect-to-the-device-serial-console) | |
| [Проверка на наличие обновлений и их применение](#scan-for-and-apply-updates) | |
