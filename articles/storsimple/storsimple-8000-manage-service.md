...
* **Имя** — имя, назначенное вашей службе диспетчера устройств StorSimple при ее создании. **Имя службы не может быть изменено после создания службы. Это также относится к другим объектам, таким как устройства, объемы, контейнеры объемов и политики резервного копирования, которые не могут быть переименованы в портал Azure.**
* **Состояние** — состояние службы (может быть **Активна**, **Идет создание** или **В сети**).
* **Местоположение** — географическое местоположение, в котором будет развернуто устройство StorSimple.
* **Подписка** — подписка для выставления счетов, связанная со службой.
...
2. Откроется колонка службы диспетчера устройств StorSimple. Выберите команду **Удалить**.
...
| Выполнение запланированного резервного копирования                                                                                                         | Неприменимо |
