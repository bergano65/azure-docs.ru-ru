...
4. В диалоговом окне **Сведения о предпочитаемом конечном объекте** запомните содержимое поля **Аутентификация**. Если настройка выполнена успешно, в этом поле должно быть значение **CHAP**.
