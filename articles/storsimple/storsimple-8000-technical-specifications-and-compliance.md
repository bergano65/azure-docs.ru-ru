...
<sup>* </sup>- *Общая доступная емкость включает в себя емкость, доступную для данных, метаданных и буферов. Вы можете предоставить локально закрепленные объемы до 8,5 ТБ на устройстве 8100 или до 22,5 ТБ на более крупном устройстве 8600. Для получения дополнительной информации перейдите на [локально закрепленные тома StorSimple.](storsimple-8000-local-volume-faq.md)*
...
Вилка и полная сборка шнура питания должны соответствовать стандартам, подходящим для страны/региона, в котором используется устройство, и они должны иметь разрешения на безопасность, которые являются приемлемыми в этой стране/регионе. В следующих таблицах перечислены стандарты США и Европы.
