...
| Периодичность и тип архивации | Полная | Добавочная (день 1–5)  |   
|---|---|---|
...
| Неделя | Полная | Добавочная, день 1 | Добавочная, день 2 | Добавочная, день 3 | Добавочная, день 4 | Добавочная, день 5 |
|---|---|---|---|---|---|---|
...
| Ежемесячные | StorSimple, ежемесячная |   |   |   |   |   |
