...
-   [Backup Exec 16 и более поздних версий](https://www.veritas.com/content/support/en_US/article.100040087)
...
Распределение по **уровням StorSimple** 
 ![ Схема многоуровневых схем StorSimple](./media/storsimple-configure-backup-target-using-backup-exec/image1.jpg)
...
- Отключите [обслуживание Windows Server](/windows/win32/w8cookbook/automatic-maintenance), включенное по умолчанию, в диспетчере задач. Выполните это действие одним из следующих способов.
  ...
  - Скачайте программу [PsExec](/sysinternals/downloads/psexec) из Windows Sysinternals. После этого запустите Azure PowerShell от имени администратора и введите следующее:
    ```powershell
...
1.  В консоли управления Backup Exec выберите **хранилище**  >  **Настройка** хранилища  >  **на основе диска** хранилище  >  **Далее**.
...
3.  Введите соответствующее имя, например **Полное копирование, суббота**, и описание. Выберите **Далее**.
...
1.  В консоли управления Backup Exec щелкните правой кнопкой мыши задание, которое необходимо архивировать на том StorSimple, а затем выберите **Свойства определения резервного копирования**  >  **изменить**.
...
2.  Выберите **добавить стадию**  >  **дублировать на диск**  >  **изменить**.
...
4.  В раскрывающемся списке **Storage** (Хранилище) выберите том StorSimple, на который нужно сохранить данные задания архивации.
    ...
    ![Снимок экрана, на котором показан список, в котором необходимо выбрать хранилище.](./media/storsimple-configure-backup-target-using-backup-exec/image22.png)
