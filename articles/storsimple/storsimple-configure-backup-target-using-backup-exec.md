...
**StorSimple многоуровневая**
![диаграмма многоуровневого уровня StorSimple](./media/storsimple-configure-backup-target-using-backup-exec/image1.jpg)
...
-   Выберите **Хранение** > **Ваш диск** > **Детали** > **Свойства**. Отключите параметр **Pre-allocate disk space** (Выделить дисковое пространство).
...
1.  На консоли управления Backup Exec выберите **Storage** > **Configure** > **Storage-Disk-based Storage** > **Next.**
...
3.  Введите соответствующее имя, например **Полное копирование, суббота**, и описание. Нажмите кнопку **Далее**.
...
1.  На консоли управления Backup Exec выберите**Backup** > **резервное копирование** **для** > диска.
...
1.  На консоли управления Backup Exec нажмите правой кнопкой мыши задание, которое вы хотите архивировать в томе StorSimple, а затем выберите резервное **копирование Определение свойства** > **отсеивание**.
...
2.  Выберите **Добавить этап** > **Дубликат для диска** > **Edit**.
...
1. [Установка Azure PowerShell](/powershell/azure/overview).
