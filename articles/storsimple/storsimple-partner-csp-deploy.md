...
- У вас есть допустимые учетные данные для входа в [Центр партнеров](https://partnercenter.microsoft.com/). Учетные данные позволяют выполнять вход на портал партнеров, чтобы добавлять новых клиентов, искать клиентов или переходить в учетную запись клиента с панели мониторинга партнеров. CSP может работать как администратор StorSimple от имени клиента на портале Azure.
