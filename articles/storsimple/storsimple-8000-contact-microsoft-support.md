---
title: Создание билета поддержки или чехла для серии StorSimple 8000
...
4. В колонке **Новый запрос на поддержку** щелкните шаг 3 **Контактные данные**. В колонке **Контактные данные** выполните следующие действия.
   ...
   2. В Контактной информации укажите свое имя, электронную почту, дополнительный контакт, страну/регион. Установите флажок **Save contact changes for future support requests** (Сохранить изменения контактных данных для будущих обращений в службу поддержки).
