...
4. В колонке **Параметры безопасности** выполните следующие действия.
   ...
   1. Прокрутите вниз в раздел **Пароль администратора устройств.** Укажите пароль администратора длиной от 8 до 15 символов.
   2. Подтвердите пароль.
   3. Нажмите **Сохранить** в верхней части лезвия.
...
1. В локальном веб-файле нажмите**изменение пароля** **обслуживания** > для вашего устройства.
