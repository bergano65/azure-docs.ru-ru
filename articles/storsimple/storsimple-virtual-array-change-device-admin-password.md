...
4. В колонке **Параметры безопасности** выполните следующие действия.
   ...
   1. Прокрутите вниз до раздела **пароль администратора устройства** . Укажите пароль администратора длиной от 8 до 15 символов.
...
1. В локальном веб-интерфейсе щелкните **обслуживание** > **Смена пароля** для устройства.
