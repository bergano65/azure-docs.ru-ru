...
1. На портале Azure перейдите на колонку службы диспетчера устройств StorSimple. Откройте раздел **Устройства** и выберите свое устройство из списка. Откройте элементы **Отслеживание** > **Работоспособность оборудования**. В разделе **Общие компоненты** определите состояние аккумулятора.
2. Определите БПО, в котором произошел сбой батареи. На рис. 1 показана задняя поверхность устройства StorSimple.
   
    ![Задняя панель основных модулей корпуса устройства](./media/storsimple-battery-replacement/IC740994.png)
   ...
   | 4 |Контроллер 1 |
    ...
    ![Светодиоды отслеживающего индикатора на задней панели устройства PCM](./media/storsimple-battery-replacement/IC740992.png)
...
4. Сняв БПО, поднимите и поверните рукоятку модуля аккумулятора вверх, как показано на следующем рисунке, и потяните за нее для снятия модуля аккумулятора.
    ...
    ![Удаление батареи из PCM](./media/storsimple-battery-replacement/IC741019.png)
