...
<sup>1</sup> *ранее назывался 1100*.

<sup>2</sup> *8010 и 8020 используют хранилище Azure уровня "Стандартный" для облака. Разница существует только на локальном уровне внутри устройства*.
