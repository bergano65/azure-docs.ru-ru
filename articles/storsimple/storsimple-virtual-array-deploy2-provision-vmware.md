---
title: Положение StorSimple Виртуальный массив в VMware
...
10. Нажмите значок ![](./media/storsimple-virtual-array-deploy2-provision-vmware/image10.png) загрузки и выберите **файл загрузки.**
...
29. Откроется окно **Add Hardware** (Установка оборудования). На странице **типа устройства,** под **Выберите тип устройства, которое вы хотите добавить,** выберите **жесткий диск**, и нажмите **далее**.
...
35. С помощью выбранной виртуальной машины в правом стене, перейдите на вкладку **Резюме.**
...
2. Настройка может занять несколько минут. После запуска устройства перейдите на вкладку **Консоль.** Отправьте Ctrl-Alt-Delete, чтобы войти в устройство. Также можно установить курсор в окно консоли и нажать CTRL+ALT+INS. По умолчанию используются имя пользователя *StorSimpleAdmin* и пароль *Password1*.
