...
| TCP 9354 |Исходящий |WAN |Да |Исходящий порт используется устройством StorSimple для взаимодействия со службой диспетчера устройств StorSimple. |
