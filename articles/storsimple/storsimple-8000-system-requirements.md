...
* Во время замены модуля контроллера EBOD, непрерывно контролировать состояние компонента в службе StorSimple Device Manager, доступ к работе **монитора** > **оборудования.**
