---
title: Заметки о выпуске обновления 0,2 & 0,1 для виртуального массива StorSimple
...
В следующей таблице представлен список известных проблем для виртуального массива StorSimple, а также содержатся проблемы для предыдущих выпусков, добавленные в заметки о выпуске. **Выпуски проблем, отмеченные в этом выпуске, отмечены звездочкой. Почти все проблемы в этом списке перенесены из общедоступного выпуска виртуального массива StorSimple.**
...
| **Двенадцать.** |CHAP |После создания учетных данных CHAP удалить их нельзя. Кроме того, при изменении учетных данных CHAP необходимо перевести тома в автономный режим, а затем снова перевести их в сетевой режим, чтобы изменения вступили в силу. |Эта проблема будет решена в более поздней версии. |
...
[Установите обновления](./storsimple-virtual-array-install-update-06.md) для виртуального массива StorSimple.