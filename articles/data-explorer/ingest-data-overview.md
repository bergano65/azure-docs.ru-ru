...
* Фабрика данных Azure (ADF) является полностью управляемой службой интеграции данных для рабочих нагрузок аналитики в Azure, чтобы копировать данные в Azure Data Explorer и из нее. Дополнительные сведения см. в статье [Копирование данных из Azure Data Explorer или обратно с помощью Фабрики данных Azure](/azure/data-factory/connector-azure-data-explorer).
