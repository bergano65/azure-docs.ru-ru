...
1. Щелкните **Создать**, чтобы подготовить кластер. Обычно подготовка занимает около 10 минут. На панели инструментов щелкните **Уведомления**, чтобы отслеживать процесс подготовки.

    ![Уведомления](media/create-cluster-database-portal/notifications.png)
