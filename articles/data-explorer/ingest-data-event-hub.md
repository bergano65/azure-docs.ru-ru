...
1. Нажмите следующую кнопку, чтобы начать развертывание и создание концентратора событий. Чтобы следовать инструкциям в этой статье, щелкнув правой кнопкой мыши, откройте другую вкладку или окно и выберите ссылку **Открыть в новом окне**.
