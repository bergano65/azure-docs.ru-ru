---
title: Работа с повторяющимися данными в обозреватель данных Azure
description: В этом разделе будут показаны различные подходы к работе с повторяющимися данными при использовании обозреватель данных Azure.
author: orspod
ms.author: orspodek
ms.reviewer: mblythe
...
ms.locfileid: "68608230"
---
# <a name="handle-duplicate-data-in-azure-data-explorer"></a>Работа с повторяющимися данными в обозреватель данных Azure
