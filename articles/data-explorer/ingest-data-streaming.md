...
* Производительность приема потоковой передачи и масштабирование емкости с увеличением размера виртуальной машины и кластера. Для одного D14 узла Рекомендуемая нагрузка составляет до 150 запросов в секунду.
