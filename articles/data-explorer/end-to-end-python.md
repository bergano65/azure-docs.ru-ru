---
title: Сквозное проглатывание капли в Azure Data Explorer через Python
description: В этой статье вы узнаете, как глотать капли в Azure Data Explorer с сквозным примером, который использует Python.
...
---
# <a name="end-to-end-blob-ingestion-into-azure-data-explorer-through-python"></a>Сквозное проглатывание капли в Azure Data Explorer через Python
...
|---|---|---|
| tenant_id | Идентификатор клиента. Он также известен как идентификатор каталога.|
| subscription_id | Идентификатор подписки, который используется для создания ресурсов.|
| client_id | Идентификатор клиента приложения, который может получить доступ к ресурсам в вашем арендаторе.|
| client_secret | Секрет клиента приложения, которое может получить доступ к ресурсам в вашем арендаторе. |
...
1. Загрузите файл в учетную запись хранилища.
    ...
    |**Параметр** | **Описание поля**|
    |---|---|---|
    | account_key | Ключ доступа программно созданной учетной записи хранилища.|
...
*  Чтобы узнать о других способах создания кластера и базы данных, смотрите [Создать кластер и базу данных Azure Data Explorer.](create-cluster-database-python.md)
