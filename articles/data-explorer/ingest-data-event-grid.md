...
1. В окне **Создание подписки на событие** на вкладке **Основные** введите следующие значения:
    ...
    **Параметр** | **Рекомендуемое значение** | **Описание поля**
    |---|---|---|
    | Название | *test-grid-connection* | Имя создаваемой сетки событий.|
...
1. Заполните форму, указав следующую информацию, и нажмите на кнопку **Создать**.
    ...
    **Параметр** | **Рекомендуемое значение** | **Описание поля**
    ...
    | Сетка событий | *test-grid-connection* | Имя созданной сетки событий. |
    ...
    | Формат данных | *JSON* | К поддерживаемым форматам относятся: Avro, CSV, JSON, многострочный JSON, PSV, SOH, SCSV, TSV и TXT. Поддерживаемые параметры сжатия: ZIP и GZip |
