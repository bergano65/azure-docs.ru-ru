...
1. Заполните форму, указав следующую информацию, и нажмите на кнопку **Создать**.
    ...
    **Параметр** | **Рекомендуемое значение** | **Описание поля**
    ...
    | Формат данных | *JSON* | К поддерживаемым форматам относятся: Avro, CSV, JSON, многострочный JSON, PSV, SOH, SCSV, TSV и TXT. Поддерживаемые варианты сжатия: ZIP и GZip |
