...
В этом документе описаны собственных функций обозревателя данных Azure для обнаружения аномалий ряда времени и прогнозирования. Каждый исходный временной ряд разлагаются на сезонных, тенденции и residual компоненты для обнаружение аномалий и/или прогнозирования. Эти возможности можно использовать для практически в реальном времени сценариев мониторинга, например обнаружения сбоев, прогнозируемого обслуживания и спроса и загрузить прогнозирования.
