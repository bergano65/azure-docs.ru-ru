...
У пользователей должна быть роль владельца. Кроме того, пользователи могут иметь роль участника вместе с ролью администратора доступа пользователей, чтобы применить управление пользователями.
