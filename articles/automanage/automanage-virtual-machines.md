...
Необходимо иметь роль **участника** , чтобы включить функцию автоуправления с помощью существующей учетной записи управления. Если вы включаете Автоуправление с помощью новой учетной записи управления, вам потребуются следующие разрешения: роль **владельца** или **участник** , а также роли **администратора доступа пользователей** .
