...
:::image type="content" source="media\automanage-virtual-machines\disable-step-1.png" alt-text="Отключение автоуправления на виртуальной машине.":::

Внимательно прочтите сообщения в появившемся всплывающем окне, прежде чем согласиться на **Отключение**.
