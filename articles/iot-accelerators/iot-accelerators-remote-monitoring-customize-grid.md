...
Вы определили сетку. Теперь необходимо ознакомится со статьей [Add a custom flyout to the Remote Monitoring solution accelerator web UI](iot-accelerators-remote-monitoring-customize-flyout.md) (Добавление пользовательского всплывающего элемента в веб-интерфейс акселератора решений для удаленного мониторинга).
