...
description: Обзор акселератора прогонирует решения Azure IoT Predictive Maintenance, который предсказывает точку, в которой может произойти сбой для бизнес-сценария.
author: dominicbetts
manager: timlt
...
**Работа: Телеметрия** работает на входящий поток телеметрии устройства с помощью двух инструкций:
...
Компонент машинного обучения использует модель на основе данных, собранных с настоящих двигателей самолета. Вы можете перемещаться по рабочему пространству машинного обучения со плитки решения на [странице azureiotsolutions.com.][lnk-azureiotsolutions] Плитка доступна, когда решение находится в состоянии **Готово**.
...
*\[1\] А. Саксена и К. Гебель (2008). "Turbofan Engine Degradation Data Set", НАСА Эймс Прогноз данных репозиторий (,https://c3.nasa.gov/dashlink/resources/139/)НАСА Эймс исследовательский центр, Моффетт Филд, Калифорния*
