...
* добавить устройство IoT Edge на страницу **Устройства** в веб-интерфейсе решения для удаленного мониторинга;
...
После регистрации устройства в центре Интернета вещей в акселераторе решений для удаленного мониторинга оно отобразится на странице **Устройства** в веб-интерфейсе:
...
1. Выберите устройство **oil-pump** в списке на странице **Устройства** и щелкните **Задания**.
...
1. Перейдите на страницу **Устройства** и выберите устройство oil-pump.
