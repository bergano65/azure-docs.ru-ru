...
При первом развертывании решения для удаленного мониторинга существует две роли: **Администратор** и **Только чтение**.
...
| Разрешение            | Администратор | Только для чтения |
|----------------       |-------|-----------|
