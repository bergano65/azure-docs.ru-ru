...
| Разрешение            | Администратор | Только чтение |
|----------------       |-------|-----------|
| Просмотр решения         | Yes   | Yes       |
| обновление оповещений;         | Yes   | Нет         |
| удаление оповещений;         | Yes   | Нет         |
| создание устройств;        | Yes   | Нет         |
| обновление устройств;        | Yes   | Нет         |
| удаление устройств;        | Yes   | Нет         |
| создание групп устройств;  | Yes   | Нет         |
| обновление групп устройств;  | Yes   | Нет         |
| удаление групп устройств;  | Yes   | Нет         |
| Создание правил          | Yes   | Нет         |
| обновление правил;          | Yes   | Нет         |
| удаление правил;          | Yes   | Нет         |
| Создание заданий           | Yes   | Нет         |
| управление обновлениями SIM. | Yes   | Нет         |
...
Как владелец приложения Azure Active Directory вы можете добавить пользователя в решение удаленного мониторинга или же удалить его оттуда на портале Azure. В следующих шагах используется [корпоративное приложение Azure Active Directory](../active-directory/manage-apps/add-application-portal.md#find-your-azure-ad-tenant-application), созданное при развертывании решения удаленного мониторинга.
