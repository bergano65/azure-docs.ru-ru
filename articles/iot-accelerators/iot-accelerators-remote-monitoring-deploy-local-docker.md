---
title: Развертывание решения для удаленного мониторинга локально - Docker - Azure Документы Майкрософт
...
1. Перейдите к **группе ресурсов**, созданной для решения. Название группы ресурсов — это имя, выбранное для решения при запуске сценария **start.cmd.**
