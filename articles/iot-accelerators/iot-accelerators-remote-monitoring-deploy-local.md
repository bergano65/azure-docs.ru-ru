---
title: Развертывание решения для удаленного мониторинга локально - VS IDE - Azure Документы Майкрософт
...
Следующие шаги показывают, как запустить микросервисы удаленного мониторинга в Visual Studio:
