...
Хранилище OPC — микрослужбу, можно настроить, регистрации и управления жизненным циклом сертификата для сервера OPC UA и клиентских приложений в облаке. В этой статье показано, как защитить клиента OPC UA и OPC UA серверному приложению, в новую пару ключей и сертификатов, используя хранилище OPC.
