---
title: Испытание решения в Azure для управления промышленными устройствами Интернета вещей | Документация Майкрософт
...
Щелкните плитку **Подключенная фабрика**. На плитке **Подключенная фабрика** щелкните **Попробовать**:
