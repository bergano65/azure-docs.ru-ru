---
title: Подключите IoT DevKit к решению удаленного мониторинга - Azure Документы Майкрософт
...
1. Переключите IoT DevKit в **режим конфигурации:**
...
1. Нажмите **F1,** чтобы открыть командную палитру, введите и выберите **Azure IoT Устройство Workbench: Настройка Настройки устройства > ...**
...
1. Нажмите, `F1` чтобы открыть командную палитру, введите и выберите **Azure IoT Устройство Workbench: Загрузите код устройства:**
...
1. Перейдите на панель мониторинга решений и нажмите **Device Explorer.**
...
Акселератор решения для удаленного мониторинга позволяет дистанционно управлять устройством. Пример кода реализует три метода, которые можно увидеть в разделе **Метод** при выборе устройства на странице **Device Explorer:**
