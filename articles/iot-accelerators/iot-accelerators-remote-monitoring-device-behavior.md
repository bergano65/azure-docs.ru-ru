---
title: Имитированное устройство в решении для удаленного мониторинга - Azure Документы Майкрософт
...
- **Состояние** Файлы JavaScript, которые работают с фиксированными интервалами для обновления внутреннего состояния устройства.
- **Методика** JavaScript файлы, которые работают, когда решение вызывает метод на устройстве.
