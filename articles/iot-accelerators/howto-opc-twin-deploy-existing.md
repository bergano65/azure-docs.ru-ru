...
Сценарий развертывания пытается зарегистрировать два приложения AAD в Azure Active Directory.  В зависимости от ваших прав доступа к выбранному клиенту AAD развертывание может завершиться ошибкой. Имеются две возможности:
