...
description: В этом руководстве объясняется, как использовать оповещения для выявления и устранения проблем на устройствах, подключенных к акселератору решения для удаленного мониторинга.
author: dominicbetts
manager: timlt
ms.author: dobett
...
ms.locfileid: "54451729"
---
# <a name="tutorial-troubleshoot-and-fix-device-issues"></a>Руководство. Устранение неполадок и проблем с устройствами
...
После того как вы ознакомились с принципами устранения проблем, далее рекомендуется ознакомиться с руководством [Подключение устройства к акселератору решения для удаленного мониторинга](iot-accelerators-connecting-devices.md).
