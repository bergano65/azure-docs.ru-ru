...
В решении "Подключенная фабрика" агрегируются и отображаются данные с серверов OPC UA, подключенных к решению. В решении можно просматривать и отправлять команды на серверы OPC UA. Дополнительные сведения о OPC UA см. в статье [часто задаваемые вопросы о подключенной фабрике](iot-accelerators-faq-cf.md).
...
В решении "Подключенная фабрика" отображаются данные с серверов OPC UA, подключенных к решению. Установка по умолчанию содержит несколько серверов OPC UA, на которых запущено моделирование фабрики. Вы можете добавить собственные серверы OPC UA, которые [подключаются через шлюз] [LNK-Connect-CF] к вашему решению.
...
1. Если вы являетесь *администратором* решения, то можете опубликовать элемент данных, чтобы сделать его доступным в решении подключенной фабрики. Имея права администратора, можно также изменять значение элементов данных и вызывать методы на сервере OPC UA.
