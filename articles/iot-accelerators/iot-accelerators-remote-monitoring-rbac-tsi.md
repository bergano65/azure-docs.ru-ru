...
description: Эта статья содержит сведения о настройке управления доступом для обозревателя телеметрии Аналитики временных рядов в акселераторе решений для удаленного мониторинга
author: dominicbetts
manager: timlt
ms.author: dobett
...
Эта статья содержит сведения о настройке управления доступом для обозревателя Аналитики временных рядов в акселераторе решений для удаленного мониторинга. Если требуется предоставить пользователям акселератора решений доступ к службе "Аналитика временных рядов", необходимо предоставить каждому пользователю доступ к данным.
...
В этой статье вы узнали, как обеспечивается управление доступом для обозревателя Аналитики временных рядов в акселераторе решений для удаленного мониторинга.
