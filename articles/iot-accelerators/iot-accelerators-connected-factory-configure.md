...
description: В этой статье описывается, как настроить ускоритель решений Connected Factory, включая его топологию.
author: dominicbetts
manager: timlt
...
Connected Factory использует формулы OEE, [http://www.oeefoundation.org](http://www.oeefoundation.org)опубликованные .
...
[Подробнее](overview-opc-publisher.md) о том, как данные телеметрии посягает на Connected Factory, можно узнать больше о том, как данные телеметрии посягает на Connected Factory.
...
Следующий шаг предлагается узнать, как [настроить решение Connected Factory.](iot-accelerators-connected-factory-customize.md)
