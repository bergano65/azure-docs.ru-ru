...
1. Установите последнюю версию [интерфейса командной строки Azure (AZ)](/cli/azure/?view=azure-cli-latest) [отсюда](/cli/azure/install-azure-cli?view=azure-cli-latest).
