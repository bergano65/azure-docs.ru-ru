...
>[!IMPORTANT]
>Оптимизация мультимедиа для команд поддерживается для сред Microsoft 365 государственных организаций (GCC). Оптимизация мультимедиа для команд не поддерживается для GCC-High или DoD.
