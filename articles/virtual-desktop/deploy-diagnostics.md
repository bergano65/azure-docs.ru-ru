...
4. После этого перейдите в раздел **Data** > **счетчики производительности Windows** и добавьте следующие счетчики:
    ...
    -   Логический диск (\*) \%Free
    -   Логический диск (C:) \\Avg. Длина очереди диска
    -   Память (\*) \\Available МБ
...
4. Убедитесь, что следующие счетчики предварительно настроены:
   ...
   - LogicalDisk (\*) \%Free Space: отображает объем свободного пространства общего свободного места на диске в процентах.
   - Логический диск (C:) \\Avg. Длина очереди диска: длина запроса на перемещение диска C. Значение не должно превышать 2 в течение короткого периода времени.
