...
Программное обеспечение для объединения и доставки приложений ликуит позволяет предприятиям и поставщикам услуг подключаться и объединять все серверные компоненты рабочей области (Citrix, VMWare, виртуальные рабочие столы Windows, RDP и старые версии) и предоставлять настроенный и совместимый клиент. взаимодействие, независимо от того, где находятся приложения клиента. Когда клиент публикует смарт-значок, Ликуит определяет, откуда следует запускать приложение, исходя из прав на расположение, устройство и профиль клиента.
