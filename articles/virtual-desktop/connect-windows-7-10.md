...
Если вы являетесь администратором, который заинтересован в изучении более подробных сведений об использовании рабочего стола Windows, ознакомьтесь с [настольным клиентом Windows для администраторов](/windows-server/remote/remote-desktop-services/clients/windowsdesktop-admin).
