...
### <a name="error-windows-virtual-desktop-agent-and-windows-virtual-desktop-agent-boot-loader-are-missing-cwindowstempscriptlogslog-is-also-missing"></a>Ошибка: отсутствуют агент виртуальных рабочих столов Windows и загрузчик агента виртуальных рабочих столов Windows. К:\виндовс\темп\скриптлогс.лог также отсутствует
...
Проверьте параметр групповой политики, открыв редактор групповая политика на виртуальной машине и перейдя в **административные шаблоны** > **компонентов Windows** > **службы удаленных рабочих столов** > **Удаленный рабочий стол узла сеансов**@no __t-7**licensing** > .**установите режим лицензирования удаленный рабочий стол**. Если параметр групповой политики **включен**, измените его на " **отключено**". Если он уже отключен, оставьте его как есть.
