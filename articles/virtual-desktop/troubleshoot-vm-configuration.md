...
1. Убедитесь, что два компонента установлены с помощью функции " **Панель управления**"  >  "**программы** > "**программы и компоненты**". Если **Агент виртуальных рабочих столов Windows** и **загрузчик агента виртуальных рабочих столов Windows** не отображаются, они не будут установлены на виртуальной машине.
...
2. Скачайте PsExec с https://docs.microsoft.com/sysinternals/downloads/psexec.
...
Если вы видите одно из этих сообщений, это означает, что на образе не установлены последние обновления Windows или если для режима лицензирования удаленный рабочий стол задано значение " **на пользователя**". Удалите все настройки, задавая эту политику, а затем выполните действия, чтобы узнать версию многосеансовой версии Windows 10 Enterprise и установить соответствующее обновление.  
...
Если номер версии — "1903", установите [Обновление KB4517211](https://support.microsoft.com/help/4517211).
...
- Сведения об устранении неполадок см. в статье [Tutorial: Устранение неполадок диспетчер ресурсов развертываний шаблонов @ no__t-0.
