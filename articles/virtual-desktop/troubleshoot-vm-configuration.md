...
Проверьте параметр групповой политики, открыв редактор групповая политика на виртуальной машине и перейдя в **административные шаблоны** > **компоненты Windows** > **службы удаленных рабочих столов** > , **Узел сеансов** > **лицензирования** > **установите режим лицензирования удаленный рабочий стол**. Если параметр групповой политики **включен**, измените его на " **отключено**". Если он уже отключен, оставьте его как есть.
