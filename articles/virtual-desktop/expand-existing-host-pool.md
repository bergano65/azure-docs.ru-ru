...
6.    Для *пользователей рабочего стола по умолчанию*введите разделенный запятыми список дополнительных пользователей, которые будут входить в клиенты виртуальных рабочих столов Windows, и получите доступ к рабочему столу после завершения предложения Azure Marketplace. Например, если требуется назначить user3@contoso.com и user4@contoso.com доступа, введите user3@contoso.comuser4@contoso.com.
...
- [Подключение к клиенту macOS](./connect-macos.md)
- [Подключение к клиенту iOS](./connect-ios.md)
