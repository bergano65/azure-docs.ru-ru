...
- Разрешения для файлов Azure должны соответствовать разрешениям, описанным в разделе [требования — контейнеры профилей](/fslogix/overview#requirements/).
