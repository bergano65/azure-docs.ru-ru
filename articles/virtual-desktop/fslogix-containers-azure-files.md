...
- Разрешения для файлов Azure должны соответствовать разрешениям, описанным в разделе [требования — контейнеры профилей](https://docs.fslogix.com/display/20170529/Requirements+-+Profile+Containers).
