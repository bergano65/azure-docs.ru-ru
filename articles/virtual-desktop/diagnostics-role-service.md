---
title: Выявление проблем с функцией диагностики виртуальных рабочих столов Windows — Azure
description: Описание функции диагностики виртуальных рабочих столов Windows и способов ее использования.
...
>[!NOTE]
>Эта предварительная версия не включает полную классификацию ошибок и будет регулярно обновляться. Чтобы получить актуальные сведения, обязательно ознакомьтесь с этой статьей по крайней мере раз в месяц.
...
Дополнительные сведения о ролях в виртуальном рабочем столе Windows см. в разделе [среда предварительного просмотра виртуальных рабочих столов Windows](environment-setup.md).
