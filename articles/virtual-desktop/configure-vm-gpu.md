...
* Для виртуальных машин Azure с графическим процессором NVIDIA используйте служебную программу `nvidia-smi`, как описано в разделе [Проверка установки драйвера](/azure/virtual-machines/windows/n-series-driver-setup#verify-driver-installation) для проверки использования GPU при запуске приложений.
