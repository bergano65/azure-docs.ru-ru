...
ms.locfileid: "83742936"
---
# <a name="set-up-msix-app-attach"></a>Настройка присоединения приложения MSIX

> [!IMPORTANT]
> Подключение приложения MSIX пока доступно только в закрытой предварительной версии.
> без соглашений об уровне обслуживания. Мы не рекомендуем использовать ее для выполнения производственных рабочих нагрузок. Некоторые функции могут не поддерживаться или их возможности могут быть ограничены. Дополнительные сведения см. в статье [Дополнительные условия использования предварительных выпусков Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).
...
- Работающее развертывание виртуального рабочего стола Windows. Дополнительные сведения см. в статье [Создание клиента в виртуальном рабочем столе Windows](./virtual-desktop-fall-2019/tenant-setup-azure-active-directory.md).
- Средство упаковки MSIX
- Сетевая папка в развертывании виртуального рабочего стола Windows, где будет храниться пакет MSIX

## <a name="get-the-os-image"></a>Получение образа ОС

Сначала вам нужно получить образ ОС, который вы будете использовать для приложения MSIX. Чтобы получить образ ОС, сделайте следующее.
...
Прежде чем начать, вам нужно создать главный образ виртуального жесткого диска. Если вы еще не создали главный образ виртуального жесткого диска, откройте раздел [Подготовка и настройка главного образа виртуального жесткого диска](set-up-customize-master-image.md) и выполните указанные в нем инструкции. 
...
После отключения автоматического обновления вам нужно будет включить Hyper-V, так как для промежуточного размещения вы будете использовать команду Mount-VHD, а для отключения — команду Dismount-VHD. 
...
3. Когда откроется окно сведений о цифровой подписи, выберите вкладку **Общие**, а затем **Установить сертификат**.
