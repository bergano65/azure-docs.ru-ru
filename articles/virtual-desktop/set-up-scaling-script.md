...
5. Выполните командлет **New-сторедкредентиал-ключевой \$ключевого пути** . При появлении запроса введите учетные данные виртуального рабочего стола Windows с разрешениями на запрос пула узлов (пул узлов указан в **файле config. XML**).
