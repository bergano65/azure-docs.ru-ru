---
title: Автоматическое масштабирование узлов сеанса — Azure
description: В этой статье описывается настройка автоматического масштабирования скрипт для сеанса узлов виртуального рабочего стола Windows (Предварительная версия).
