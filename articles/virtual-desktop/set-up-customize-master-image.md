...
1. Откройте **редактор локальных групповых политик @ no__t-1Administrative Templates @ no__t-2Windows Components @ no__t-3Windows Update**.
...
1. Перейдите в **раздел административные шаблоны** > **компонентов Windows** > **службы удаленных рабочих столов** > **Удаленный рабочий стол узел сеансов** > **пределы времени сеанса**.
...
4. В **редактор "Управление групповыми политиками"** перейдите к **конфигурации компьютера** > **политики** > **Административные шаблоны** > **компонентов Windows** > **службы удаленных рабочих столов**@no__ t-10**Удаленный рабочий стол узлов сеансов**2**и перенаправление ресурсов**.
