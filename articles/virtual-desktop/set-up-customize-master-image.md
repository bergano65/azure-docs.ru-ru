...
4. В **редактор "Управление групповыми политиками"** перейдите к разделу **политики конфигурации компьютера**  >  **Policies**  >  **Административные шаблоны**  >  **компоненты Windows**  >  **службы удаленных рабочих столов**  >  **Удаленный рабочий стол устройство узла сеансов**  >  **и перенаправление ресурсов**.
