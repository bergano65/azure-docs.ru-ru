...
1. Введите **имя группы клиента Виртуального рабочего стола Windows** для группы клиента, которая содержит ваш клиент. Если вы не хотите использовать свое имя группы клиента, оставьте значение по умолчанию.
2. Введите **имя клиента Виртуального рабочего стола Windows** для клиента, в котором будет создан этот пул узлов.
3. Укажите тип учетных данных, которые вы хотите использовать для проверки подлинности в качестве владельца служб удаленных рабочих столов клиента Виртуального рабочего стола Windows. Если вы выберете **субъект-службу**, вам также нужно указать **идентификатор клиента Azure AD**, связанный с этим субъектом-службой.
...
Задайте контекст группе клиента Виртуального рабочего стола Windows, указанный в предложении Azure Marketplace, выполнив следующий командлет. Если вы оставили значение группы агента Виртуального рабочего стола Windows как значение по умолчанию в предложении Azure Marketplace, этот шаг можно пропустить.
