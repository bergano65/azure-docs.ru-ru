...
3. Перейдите в \\\\Win32\\Release или \\\\x64\\в ZIP-файл и запустите **фслогиксаппссетуп** , чтобы установить агент фслогикс.  Дополнительные сведения об установке Фслогикс см. в статье [Загрузка и установка фслогикс](/fslogix/install-ht/).
