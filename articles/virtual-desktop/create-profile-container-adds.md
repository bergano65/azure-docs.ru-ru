...
---
# <a name="create-an-fslogix-profile-container-with-azure-files"></a>Создание контейнера профиля Фслогикс с помощью службы файлов Azure
...
7. Выполните следующую команду:
    ...
    - Замените `<desired-drive-letter>` на нужное имя диска (например, `y:`).
...
2. Распакуйте скачанный файл агента фслогикс и перейдите к **x64** > **выпускам**x64, а затем откройте **фслогиксаппссетуп. exe**.
...
10. Щелкните правой кнопкой мыши элемент **Профили**, выберите **создать**, а затем выберите **многострочное значение**. Назовите значение **вхдлокатионс** и задайте введите URI для общего ресурса `\\fsprofile.file.core.windows.net\share` службы файлов Azure в качестве значения данных.
...
1. Откройте браузер и перейдите к [веб-клиенту виртуальных рабочих столов Windows](https://rdweb.wvd.microsoft.com/webclient/index.html).
