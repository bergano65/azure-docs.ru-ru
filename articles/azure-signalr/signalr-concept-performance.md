...
| Broadcast  | Размер сообщения | Входящих сообщений в секунду | Соединения | Интервалы отправки |
|---|---------------------|--------------------------|-------------|-------------------------|
...
Разные варианты использования имеют разные требования к серверам приложений. Для **вещания** требуется небольшое количество серверов приложений. **Echo** **Для передачи сообщений или отправки в подключение** требуется много серверов приложений.
