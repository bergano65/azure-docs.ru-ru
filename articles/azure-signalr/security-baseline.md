...
**Руководство**. служба Azure signalr использует Azure Active Directory (Azure AD) для предоставления управления удостоверениями и доступом для ресурсов SignalR. Сюда входят корпоративные удостоверения, например для сотрудников, а также внешние удостоверения, например для партнеров и поставщиков. Это обеспечивает единый вход для управления доступом к данным и ресурсам вашей организации и их защиты в локальной среде и в облаке. Подключите пользователей, приложения и устройства к Azure AD, чтобы обеспечить простой, безопасный доступ и более широкие возможности управления.
