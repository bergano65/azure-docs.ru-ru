...
1. Чтобы изменить действие по умолчанию, переключите кнопку **Разрешить или запретить** .
    ...
    > [!TIP]
    > Действие по умолчанию — это действие, выполняемое при отсутствии соответствия правилу ACL. Например, если действие по умолчанию — **Deny**, то запросы типов, которые не список разрешений ниже, будут запрещены.
