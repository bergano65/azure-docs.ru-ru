...
### <a name="q-does-azure-dedicated-hsm-support-payment-pinetf-features"></a>Вопрос. Поддерживает ли выделенный HSM-модуль Azure функции оплаты (ПИН-код/ЕТФ)?
