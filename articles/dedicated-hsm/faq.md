...
Нет guarentee нет определенного времени работы, предоставляемого для службы выделенного аппаратного модуля безопасности. Корпорация Майкрософт обеспечивает доступ к устройству на уровне сети, поэтому действуют стандартные соглашения об уровне обслуживания для сетей Azure.
...
Поддержка предоставляется корпорацией Майкрософт и компания Gemalto.  Если возникла проблема с оборудованием или сетевой доступ, создавать запрос в службу поддержки корпорации Майкрософт и rasie Пожалуйста, если у вас есть проблема с аппаратным модулем безопасности конфигурации, программного обеспечения и разработке приложений с Gemalto запросов на техническую поддержку. Если у вас проблема не определено, вызывать withg запроса поддержки Microsoft и затем Gemalto может привлечь как требуется. 
