...
* ***Страна:*** для каждой страны или региона, в которых есть конечные пользователи, создается система показателей. Глобальный фильтр содержит всех конечных пользователей.
