...
1. Зарегистрируйтесь в [центре разработчиков](https://dev.windows.com/registration?accountprogram=azure). Майкрософт проверит, является ли организация действующим юридическим лицом с действительным кодом плательщика налогов в стране или регионе, где она зарегистрирована. Процесс утверждения может занять от 5 до 10 дней. Чтобы не платить сбор за регистрацию, используйте рекламный код, полученный в сообщении электронной почты при подаче заявки на утверждение. Дополнительные сведения см. в [руководстве для издателя Azure Marketplace](https://aka.ms/sellerguide).
...
1. Добавьте новый пакет. Заполните раздел **Сведения о пакете** в приведенной ниже форме.
   ...
   * **Определение роли**. Это свойство является списком всех встроенных ролей RBAC (управление доступом на основе ролей), предоставляемых Azure AD. Можно выбрать наиболее подходящую роль, чтобы управлять ресурсами от имени клиента.
...
Можно добавить несколько авторизаций. Рекомендуется создать группу пользователей AD и указать ее идентификатор в свойстве **PrincipalId**. Таким образом можно будет добавлять пользователей в эту группу без необходимости обновлять номер SKU.
