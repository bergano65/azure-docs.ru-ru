...
1. На вкладке **Установка расширения** укажите приведенные ниже значения, после чего щелкните **ОК**.
    ...
    - **Chef Client version** (Версия клиента Chef). Введите версию клиента Chef, которую необходимо установить. Это поле можно оставить пустым. При отсутствии значения будет установлена последняя версия. 
