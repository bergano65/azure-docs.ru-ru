...
1. На странице **Подсети** выберите **+Подсеть** .
   ...
   :::image type="content" source="./media/quickstart-host-portal/subnet.png" alt-text="Параметры виртуальной машины":::
...
1. На странице **Добавление подсети** в поле **Имя** введите **AzureBastionSubnet** .
   ...
   * Не изменяйте другие параметры. Щелкните **ОК** , чтобы принять и сохранить новые параметры подсети.
   ...
   :::image type="content" source="./media/quickstart-host-portal/add-subnet.png" alt-text="Параметры виртуальной машины":::
