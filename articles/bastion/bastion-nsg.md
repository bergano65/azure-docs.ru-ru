...
_ **Входящий трафик:**
   ...
   * **Входящий трафик из плоскости данных бастиона Azure:** Для обмена данными с плоскостью данных между базовыми компонентами Azure бастиона включите порты 8080, 5701, входящие из тега службы **VirtualNetwork** , в тег службы **VirtualNetwork** . Это позволяет компонентам Azure бастиона взаимодействовать друг с другом.
...
* **Исходящий трафик:**
   ...
   * **Исходящий трафик в плоскость данных бастиона Azure:** Для обмена данными с плоскостью данных между базовыми компонентами Azure бастиона включите порты 8080, 5701 исходящий трафик из тега службы **VirtualNetwork** в тег службы **VirtualNetwork** . Это позволяет компонентам Azure бастиона взаимодействовать друг с другом.
   ...
   * **Исходящий трафик в Интернет:** Служба Azure бастиона должна иметь возможность обмениваться данными с Интернетом для проверки сеанса и сертификата. По этой причине мы рекомендуем включить исходящий порт 80 в **Интернете.**
