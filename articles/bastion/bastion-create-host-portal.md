...
1. На домашней странице [портал Azure](https://portal.azure.com)щелкните **+ создать ресурс**.
...
1. В результатах щелкните **бастиона**. Убедитесь, что издатель — это *Microsoft* , а категория — *сеть*.
