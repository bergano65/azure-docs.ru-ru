...
1. На **создать бастиона** настройте новый ресурс Бастиона. Укажите параметры конфигурации для ресурса Бастиона.
    ...
    * **Общедоступный IP-адрес SKU**: Предварительно по умолчанию для **стандартный**. Azure Бастиона использует/поддерживает только SKU "стандартный общедоступный IP-адрес".
