...
1. Выберите **включить диагностику** для сбора данных (если ранее не был включен).
...
1. Если у вас нет **рабочей области Log Analytics** экземпляр, можно создать рабочую область, выбрав **добавить** кнопки:
...
Журналы Azure Monitor также предоставляют мощный ошибки и уведомления о предупреждении служб, которые можно просмотреть, выбрав **Диагностика и решение проблем**:
