---
title: Добавление больших двоичных объектов к объектам в Azure Digital Twins | Документация Майкрософт
...
В следующих разделах представлены сведения об основных конечных точках и их функциональных возможностях.
