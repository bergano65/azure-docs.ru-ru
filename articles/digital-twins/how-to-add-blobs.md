...
| Атрибут | Тип | Описание |
| --- | --- | --- |
| **id** | Строковое | Уникальный идентификатор BLOB-объекта. |
| **name** |Строковое | Понятное имя большого двоичного объекта |
| **parentId** | Строковое | Родительская сущность, с которой связывается большой двоичный объект (пространства, устройства или пользователи) |
| **type** | Строковое | Нельзя использовать типы большого двоичного объекта *type* и *typeId*.  |
| **typeId** | Целое число | Нельзя использовать идентификатор типов большого двоичного объекта *type* и *typeId*. |
| **subtype** | Строковое | Нельзя использовать подтипы большого двоичного объекта *subtype* и *subtypeId*. |
| **subtypeId** | Целое число | Нельзя использовать идентификатор подтипа большого двоичного объекта *subtype* и *subtypeId*. |
| **sharing** | Строковое | Можно ли предоставить большой двоичный объект для общего доступа — перечисление [`None`, `Tree`, `Global`] |
| **description** | Строковое | Настраиваемое описание большого двоичного объекта |
| **contentInfos** | Array | Указывает неструктурированную информацию о метаданных, включая версию |
| **fullName** | Строковое | Полное имя большого двоичного объекта |
| **spacePaths** | Строковое | Путь к пространству |
