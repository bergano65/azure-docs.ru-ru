---
title: Как добавить капли на объекты - Azure Digital Twins Документы Майкрософт
description: Узнайте, как добавлять капли для пользователей, устройств и пробелов в Azure Digital Twins.
ms.author: alinast
...
[![Схемы JSON](media/how-to-add-blobs/blob-models-swagger-img.png)](media/how-to-add-blobs/blob-models-swagger-img.png#lightbox)
...
| **тип** | Строка | Нельзя использовать типы большого двоичного объекта *type* и *typeId*.  |
...
| **Описание** | Строка | Настраиваемое описание большого двоичного объекта |
...
[![пример cURL](media/how-to-add-blobs/http-blob-post-through-curl-img.png)](media/how-to-add-blobs/http-blob-post-through-curl-img.png#lightbox)

Успешный POST возвращает идентификатор нового капли.
...
[![Большие двоичные объекты устройств](media/how-to-add-blobs/blobs-device-api-swagger-img.png)](media/how-to-add-blobs/blobs-device-api-swagger-img.png#lightbox)
...
[![Большие двоичные объекты пространства](media/how-to-add-blobs/blobs-space-api-swagger-img.png)](media/how-to-add-blobs/blobs-space-api-swagger-img.png#lightbox)
...
[![Большие двоичные объекты пользователей](media/how-to-add-blobs/blobs-users-api-swagger-img.png)](media/how-to-add-blobs/blobs-users-api-swagger-img.png#lightbox)
...
* Распространенной ошибкой является предоставление неправильной информации заголовка:
  ...
  Кроме того, убедитесь, что каждый *многокомпонентный кусок* имеет соответствующий **соответствующий тип содержимого.**

* Вторая распространенная ошибка возникает, когда несколько капли назначаются на тот же ресурс в вашем [пространственном графике интеллекта:](concepts-objectmodel-spatialgraph.md)
  ...
  > [!NOTE]
  > Атрибут **сообщения** будет меняться в зависимости от ресурса. 

  Только одна капля (каждого вида) может быть прикреплена к каждому ресурсу в пространственном графике. 

  Чтобы устранить эту ошибку, обновите существующую каплю, используя соответствующую операцию API HTTP PATCH. Это заменит существующие данные капли на нужные данные.
