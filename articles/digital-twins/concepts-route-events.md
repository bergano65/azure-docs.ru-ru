...
Маршруты событий создаются в клиентском приложении. Один из способов сделать это — `CreateEventRoute` вызов [пакета SDK .NET (C#)](how-to-use-apis-sdks.md) : 
