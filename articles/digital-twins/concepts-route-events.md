...
Сведения о настройке недоставленных сообщений см. в статье [*Управление конечными точками и маршрутами в Azure Digital двойников (API и CLI)*](./how-to-manage-routes-apis-cli.md#create-an-endpoint-with-dead-lettering).
