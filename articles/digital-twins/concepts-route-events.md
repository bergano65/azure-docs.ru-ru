...
Ниже приведен пример создания маршрута события в клиентском приложении с помощью `CreateOrReplaceEventRouteAsync` вызова [.NET (C#) SDK](/dotnet/api/overview/azure/digitaltwins/client?view=azure-dotnet-preview&preserve-view=true) : 
