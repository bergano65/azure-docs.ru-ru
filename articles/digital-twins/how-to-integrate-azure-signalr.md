...
Затем завершите публикацию приложения, выполнив следующие действия.
...
Настройте **Пример веб-приложения интеграции SignalR** , выполнив следующие действия.
