...
* **Servicebus** — это конечная точка строки подключения служебной шины.
* **EventGrid** — это конечная точка строки подключения сетки событий.
...
* **Девицемессажес** — это сообщения телеметрии, отправляемые с устройств пользователей и пересылаемые системой.
