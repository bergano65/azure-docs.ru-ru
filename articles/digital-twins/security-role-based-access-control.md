---
title: Понимание управления доступом на основе ролей - Azure Digital Twins Документы Майкрософт
description: Узнайте о элементаре управления доступом на основе ролей и управлении разрешениями в Azure Digital Twins.
ms.author: alinast
...
- Узнайте больше о [RBAC для Azure](https://docs.microsoft.com/azure/role-based-access-control/).
