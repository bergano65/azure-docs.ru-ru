...
Дополнительные сведения о ДТДЛ в целом см. в документации по спецификациям в GitHub: [Digital двойников Definition Language (дтдл) — версия 2](https://github.com/Azure/opendigitaltwins-dtdl/blob/master/DTDL/v2/dtdlv2.md).
...
Ниже приведен пример типичной модели, написанной как интерфейс ДТДЛ. Модель описывает планеты, каждый из которых имеет имя, масса и температуру. Планета может иметь Луны в качестве спутников и может содержать кратерс.
...
Существует пример, который можно использовать для проверки документов модели, чтобы убедиться, что ДТДЛ является допустимым. Он основан на библиотеке анализатора ДТДЛ и не зависит от языка. Его можно найти здесь: [Пример средства проверки дтдл](https://docs.microsoft.com/samples/azure-samples/dtdl-validator/dtdl-validator).

Дополнительные сведения о библиотеке синтаксического анализатора, включая пример непосредственного использования, см. в разделе [практические руководства. анализ и проверка моделей](how-to-use-parser.md).
