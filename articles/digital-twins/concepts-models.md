...
Для использования с Azure Digital двойников модель должна быть представлена на [**языке определения цифровых двойников**](concepts-models.md)на основе JSON-LD (дтдл). Таким образом, чтобы использовать модель, стандартную для отрасли, необходимо сначала преобразовать ее в ДТДЛ, чтобы Azure Digital двойников мог его использовать. Затем модель ДТДЛ выступает в качестве источника истинности модели в Azure Digital двойников.
