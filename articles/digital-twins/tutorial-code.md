...
Чтобы можно было создавать связи, нужно пространство имен `Azure.DigitalTwins.Core.Serialization`. Вы добавили его в проект ранее с помощью инструкции `using`:
