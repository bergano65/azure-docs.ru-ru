...
:::image type="content" source="media/how-to-integrate-logic-apps/create-logic-app.png" alt-text="Страница "Logic Apps" в портал Azure. Нажмите кнопку "Добавить"":::

На следующей странице *приложения логики* введите подписку и группу ресурсов. Кроме того, выберите имя приложения логики и расположение развертывания.

Нажмите кнопку " _Проверка + создать_ ".
