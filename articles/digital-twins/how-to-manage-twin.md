...
Ниже приведен пример кода для удаления двойников и их связей. `DeleteDigitalTwin`Вызов пакета SDK выделено, чтобы уточнить, где он попадает в контекст примера выше.
