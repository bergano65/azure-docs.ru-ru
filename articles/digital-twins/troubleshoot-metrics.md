...
>[!NOTE]
>Хотя эти метрики по-прежнему отображаются в списке выбора, они остаются в нулевом виде до тех пор, пока новые цены на службу не станут доступны. Дополнительные сведения см. в статье [*цены на цифровые двойников Azure*](https://azure.microsoft.com/pricing/details/digital-twins/).
