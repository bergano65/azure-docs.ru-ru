...
* **Экземпляр Digital двойников** , который получит данные телеметрии устройства. См [ *. раздел как настроить экземпляр Digital двойников и аутентификацию Azure.*](./how-to-set-up-instance-portal.md) 
