---
title: Подключение устройств и проникновение телеметрии - Azure Digital Twins Документы Майкрософт
description: Узнайте, как подключиться, сесть на борт и отправить телеметрию с устройства IoT в Azure Digital Twins.
ms.author: alinast
...
Для поэтапного руководства о том, как принести устройства на борту, прочитайте [учебник для развертывания и настройки Digital Twins](tutorial-facilities-setup.md). Вкратце можно выделить следующие шаги:
...
- Создайте [функцию, определяемую пользователем,](concepts-user-defined-functions.md)и присвоите ее пространству на графике для пользовательской обработки телеметрических сообщений.
...
- Чтобы узнать об обработке данных Azure Digital Twins и возможностях функций, определяемых пользователями, прочитайте [обработку данных Azure Digital Twins и функции, определяемые пользователем.](concepts-user-defined-functions.md)
