...
1. Найдите и выберите **Центры событий**. Нажмите кнопку **создания**.
...
1. Введите **имя** для пространства имен концентраторов событий. Выберите **ценовую категорию** **Стандартный**, укажите **подписку**, **группу ресурсов**, используемую для экземпляра Digital Twins, и **расположение**. Нажмите кнопку **создания**.
...
1. Нажмите кнопку **Группа потребителей** вверху и введите имя для группы потребителей, например **tsievents**. Нажмите кнопку **создания**.
...
1. Найдите и выберите ресурс **Аналитика временных рядов** (общедоступная версия). Нажмите кнопку **создания**.
