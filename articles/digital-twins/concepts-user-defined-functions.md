---
title: Обработка данных и функции, определяемые пользователем - Azure Digital Twins Документы Майкрософт
...
После того, как устройства отправляют данные телеметрии в Azure Digital Twins, разработчики могут обрабатывать данные в четыре этапа: *проверка,* *соответствие,* *вычисление*и *отправка.*

[![Поток обработки данных Azure Digital Twins](media/concepts/digital-twins-data-processing-flow.png)](media/concepts/digital-twins-data-processing-flow.png#lightbox)
...
Обработка данных в Azure Digital Twins состоит из определения трех объектов: *совпадений,* *функций, определенных пользователем,* и *назначений ролей.*

[![Объекты обработки данных Digital Twins](media/concepts/digital-twins-user-defined-functions.png)](media/concepts/digital-twins-user-defined-functions.png#lightbox)
...
Для получения дополнительной информации прочитайте [Как использовать функции, определяемые пользователем.](./how-to-user-defined-functions.md)
