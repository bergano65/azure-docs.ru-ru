...
После того как устройства отправляют данные телеметрии в Azure Digital двойников, разработчики могут обрабатывать данные четырьмя этапами: *Проверка*, *сопоставление*, *Вычисление*и *Отправка*.
...
Обработка данных в Microsoft Azure Digital двойников состоит из определения трех объектов: *совпадений*, *определяемых пользователем функций*и *назначений ролей*.
...
Дополнительные сведения см. [в статье Использование определяемых пользователем функций](./how-to-user-defined-functions.md).
