...
Прежде чем назначить роль Azure субъекту безопасности, определите область доступа, которую должен иметь субъект безопасности. Рекомендации определяют, что лучше всего предоставить только минимально возможную область.
...
* Сведения об этих концепциях см. в разделе [*как настроить экземпляр и проверку подлинности*](how-to-set-up-instance-scripted.md).
