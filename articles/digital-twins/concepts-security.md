...
Azure Digital двойников обеспечивает шифрование неактивных и транзитных данных, так как оно написано в наших центрах обработки данных, и расшифровывает его по мере доступа к нему.
