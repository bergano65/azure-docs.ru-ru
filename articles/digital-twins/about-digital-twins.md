...
ms.locfileid: "79370905"
---
# <a name="overview-of-azure-digital-twins-preview"></a>Обзор Azure Digital Twins (предварительная версия)
...
[Цифровые модели объектов двойников](./concepts-objectmodel-spatialgraph.md#digital-twins-object-models) — это предопределенные протоколы устройств и схема данных. Они помогают обеспечить соответствие требованиям определенной предметной области решения, чтобы ускорить и упростить разработку.
