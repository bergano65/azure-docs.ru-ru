...
Эта подписка на события создается подобно тому, как создавалась подписка первой функции на события Центра Интернета вещей ранее в этом учебнике. Разница заключается в том, что на этот раз вам не нужно указывать *телеметрию устройства* в качестве типа события для прослушивания, и вы будете подключать подписку к другой функции Azure.

Еще раз повторим действия по подписке.
