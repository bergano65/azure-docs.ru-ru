...
Вместо этого, если вы хотите внести изменения в модель в Microsoft Azure Digital двойников, например, изменив `DisplayName` или `Description` , можно отправить **более новую версию** той же модели. Исходная модель будет переопределена.

Для этого начните с ДТДЛ исходной модели. Обновите все поля, которые вы хотите изменить.
