...
Он учитывает семантику [наследования](concepts-models.md#model-inheritance) и [Порядок версий](how-to-manage-model.md#update-models) и вычисляет **значение true** для заданного двойника, если двойника соответствует одному из следующих условий:
...
Этот метод имеет несколько параметров перегрузки.
...
Этот вызов возвращает результаты запроса в виде строкового объекта.
...
Существуют дополнительные ограничения на использование `JOIN` .
