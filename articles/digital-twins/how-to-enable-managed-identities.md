---
title: Включение управляемого удостоверения для событий маршрутизации (Предварительная версия)
titleSuffix: Azure Digital Twins
description: Узнайте, как включить назначенное системой удостоверение для Azure Digital двойников и использовать его для пересылки событий.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
...
ms.locfileid: "98948880"
---
# <a name="enable-a-managed-identity-for-routing-azure-digital-twins-events-preview"></a>Включение управляемого удостоверения для маршрутизации событий цифровых двойников Azure (Предварительная версия)
...
В этом разделе вы будете использовать [портал Azure](https://portal.azure.com) , чтобы добавить управляемое системой удостоверение в уже существующий экземпляр цифрового двойников Azure.
