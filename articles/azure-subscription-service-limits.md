...
#### <a name="subscription-limits---azure-service-management-classic-resources"></a>Ограничения подписки — управление службами Azure (классические ресурсы)
...
Сведения об ограничениях базы данных SQL см. в разделе [Ограничения ресурсов базы данных SQL для отдельных баз данных](sql-database/sql-database-vcore-resource-limits-single-databases.md) и [Ограничения ресурсов базы данных SQL для эластичных пулов и баз данных в пулах](sql-database/sql-database-vcore-resource-limits-elastic-pools.md).
