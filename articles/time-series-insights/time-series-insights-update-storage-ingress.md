...
Предварительная версия аналитики временных рядов Azure и индексы данных для оптимальной производительности запросов. Данные становятся доступными для запроса после индексирования. Объем принимаемых данных может повлиять на эту доступность.
