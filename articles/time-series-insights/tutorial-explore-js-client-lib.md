...
> [!NOTE]
> Исходные файлы примера приложения для Аналитики временных рядов можно найти в предоставленном [примере репозитория GitHub](https://github.com/Microsoft/tsiclient/tree/tutorial/pages/tutorial).
...
Сначала давайте рассмотрим [исходный код HTML и JavaScript](https://github.com/Microsoft/tsiclient/blob/tutorial/pages/tutorial/index.html) страницы, отображаемой в браузере. Мы рассмотрим не все элементы, а только основные разделы, чтобы вы получили представление о том, как функционирует страница:
...
2. Создайте объекты статистических выражений с 1 по n и добавьте их в массив:
   ...
   **Параметры aggregateExpression**
   ...
   | `contextMenuActions` | Массив действий, которые следует связать с объектами временных рядов в визуализации (необязательно). | См. дополнительные сведения о всплывающих контекстных меню в разделе о дополнительных функциях. |
