...
## <a name="time-series-insights-javascript-client-library-concepts"></a>Понятия клиентской библиотеки JavaScript для Аналитики временных рядов

Клиентская библиотека Аналитики временных рядов (*tsclient.js*) предоставляет абстракции для двух важных функций JavaScript:
