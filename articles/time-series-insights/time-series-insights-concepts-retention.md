---
title: Хранение данных в службе "Аналитика временных рядов Azure". Общие сведения о хранении данных в среде службы | Документация Майкрософт
