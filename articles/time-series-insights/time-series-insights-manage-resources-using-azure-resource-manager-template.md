...
1. Создайте группу ресурсов, если ее еще нет.
   ...
   * Если у вас нет группы ресурсов, создайте новую группу ресурсов с помощью команды **New-азресаурцеграуп** . Введите имя группы ресурсов и нужное расположение. Например,
