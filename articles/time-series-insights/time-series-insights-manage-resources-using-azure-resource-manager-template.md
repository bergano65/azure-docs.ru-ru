...
В этой статье описывается, как создать и развернуть ресурсы службы "Аналитика временных рядов" с помощью [шаблонов Azure Resource Manager](https://docs.microsoft.com/azure/azure-resource-manager/), PowerShell и поставщика ресурсов Аналитики временных рядов.
...
> [!IMPORTANT]
> Операции командной строки, показанные ниже, описывают [модуль PowerShell Az](https://docs.microsoft.com/powershell/azure/overview).
...
- Сведения о программном управлении ресурсами службы "Аналитика временных рядов" с помощью REST API см. в статье [Управление Аналитикой временных рядов](https://docs.microsoft.com/rest/api/time-series-insights-management/).
