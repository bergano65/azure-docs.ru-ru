---
title: Управление средой с помощью шаблонов Azure Resource Manager-Azure Time Series Insights | Документация Майкрософт
description: Узнайте, как программно управлять средой службы "аналитика временных рядов Azure" с помощью Azure Resource Manager.
...
В этой статье описывается создание и развертывание ресурсов службы "аналитика временных рядов" с помощью [шаблонов Azure Resource Manager](https://docs.microsoft.com/azure/azure-resource-manager/), PowerShell и поставщика ресурсов службы "аналитика временных рядов".
...
1. Клонируйте или скопируйте шаблон [201-timeseriesinsights-environment-with-eventhub](https://github.com/Azure/azure-quickstart-templates/blob/master/201-timeseriesinsights-environment-with-eventhub/azuredeploy.json) из GitHub.
   ...
   * Необязательные параметры
     ...
     | environmentDataRetentionTime | Минимальный период, в течение которого события среды будут доступны для запроса. Значение должно быть указано в формате ISO 8601, например `P30D` для политики хранения в течение 30 дней. |
...
- Сведения о программном управлении ресурсами "аналитика временных рядов" с помощью API-интерфейсов RESTFUL см. в статье [Управление аналитикой временных рядов](https://docs.microsoft.com/rest/api/time-series-insights-management/).
