...
> [!TIP]
> API экземпляра службы "аналитика временных рядов" и поддержка CRUD см. в статье о [запросах данных](concepts-query-overview.md#time-series-model-query-tsm-q-apis) и [документации по API-интерфейсам иерархии](https://docs.microsoft.com/rest/api/time-series-insights/preview-model#hierarchies-api).
...
> [!TIP]
> Для API экземпляра службы "аналитика временных рядов" и поддержки CRUD ознакомьтесь со статьей о [запросах данных](concepts-query-overview.md#time-series-model-query-tsm-q-apis) и [документацией по API типа](https://docs.microsoft.com/rest/api/time-series-insights/preview-model#types-api).
...
Переменные хранятся в определении типа модели временных рядов и могут быть предоставлены встроенными средствами [API запросов](concepts-query-overview.md) для переопределения хранимого определения.

## <a name="next-steps"></a>Дальнейшие шаги

* Дополнительные сведения о [запросах данных](concepts-query-overview.md)

* Ознакомьтесь с справочной документацией по [модели временных рядов](https://docs.microsoft.com/rest/api/time-series-insights/preview-model) .
