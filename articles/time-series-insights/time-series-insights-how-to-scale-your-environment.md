---
title: Масштабирование службы "Аналитика временных рядов Azure". Как масштабировать среду службы "Аналитика временных рядов Azure" | Документация Майкрософт
