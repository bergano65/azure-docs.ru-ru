---
title: Добавление концентратора событий в службу "Аналитика временных рядов Azure" — добавление источника событий Центров событий в Аналитику временных рядов Azure | Документация Майкрософт
