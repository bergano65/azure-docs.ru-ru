...
### <a name="in-this-video-we-provide-an-overview-of-time-series-insights-a-cloud-based-iot-analytics-platformbr"></a>В этом видео мы представляем обзор службы "Аналитика временных рядов" — облачной платформы аналитики Интернета вещей.</br>
