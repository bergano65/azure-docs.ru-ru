...
Обозреватель Аналитики временных рядов (предварительная версия) отображает анализ исторических данных и первопричин. Чтобы начать работу:
...
1. Недавно Contoso обнаружила пожар на ветроэлектрической установке **W7**. Мнения о причине пожара расходятся. В службе "Аналитика временных рядов" отображаются данные датчика оповещения о пожаре, сработавшем во время пожара.
