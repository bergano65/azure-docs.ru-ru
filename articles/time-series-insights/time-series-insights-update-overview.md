---
title: Общие сведения. Что собой представляет предварительная версия службы "Аналитика временных рядов Azure"? — Аналитика временных рядов Azure | Документация Майкрософт
description: Сведения об основных изменениях, улучшениях и функциях в предварительной версии службы "Аналитика временных рядов Azure".
