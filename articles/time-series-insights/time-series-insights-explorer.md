...
1. Используйте **тепловой карты** для быстрого выявления уникальных или аномальных рядов данных в определенном запросе. Только один поисковой запрос можно визуализировать в виде тепловой карты.
    ...
    [![Диаграмма Gen1 Explorer тепловой карты](media/time-series-insights-explorer/tsi-ga-example-heatmap-charting.png)](media/time-series-insights-explorer/tsi-ga-example-heatmap-charting.png#lightbox)
