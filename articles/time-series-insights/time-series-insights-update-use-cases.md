...
* Служба быстро работает и за несколько минут подключается к миллиарду событий в центре Интернета вещей или в центрах событий Azure. 
* Подсоединившись, изучайте и анализируйте миллиарды событий, мгновенно выявляя аномалии и скрытые тенденции в данных.

Служба "Аналитика временных рядов Azure" удобная и простая в использовании. Для взаимодействия с данными вам не потребуется писать свой код. Также не нужно изучать новый язык, хотя для опытных пользователей, знакомых с SQL, необходим детализированный текстовый язык запросов. Она также предоставляет изучение для новичков с помощью команд "выберите" и "щелкните".
