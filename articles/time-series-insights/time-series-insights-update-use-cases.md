...
Аналитика временных рядов Azure — это комплексное предложение модели "платформа как услуга". Оно используется, чтобы принимать, обрабатывать, хранить и запрашивать масштабируемые данные Интернета вещей с высокой степенью контекстуализации, оптимизированные для временных рядов. Аналитика временных рядов идеально подходит для нерегламентированного анализа данных и оперативной аналитики. Аналитика временных рядов — это уникальная служба с возможностью расширения и настройки, которая соответствует требованиям промышленных развертываний Интернета вещей.
