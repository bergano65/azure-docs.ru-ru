...
* Полный список поддерживаемых типов данных см. в разделе [Поддерживаемые типы данных](concepts-supported-data-types.md) .
