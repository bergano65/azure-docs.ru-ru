---
title: Правила обработки и экранирования JSON в Azure Time Series Insights | Документация Майкрософт
description: Сведения об обучении JSON, экранировании и обработке массивов в службе "аналитика временных рядов Azure".
author: lyrana
ms.author: lyhughes
...
|---|---|---|
| Тип данных TSI добавляется в конец имени столбца как "_ \<dataType\> " | ```"type": "Accumulated Heat"``` | type_string |
| [Свойство timestamp](concepts-streaming-ingestion-event-sources.md#event-source-timestamp) источника события будет СОХРАНЕНО в TSI как "timestamp" в хранилище и значение, хранящееся в формате UTC. Вы можете настроить свойство отметок времени источника событий в соответствии с потребностями вашего решения, но имя столбца в «теплый» и «холодном» хранилище — «timestamp». Другие свойства DateTime JSON, не являющиеся отметкой времени источника события, будут сохранены с "_datetime" в имени столбца, как упоминалось в приведенном выше правиле.  | ```"ts": "2020-03-19 14:40:38.318"``` | TIMESTAMP |
