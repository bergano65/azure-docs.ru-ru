...
- Дополнительные сведения о синтаксисе запросов для доступа REST API к данным службы "аналитика временных рядов Azure" см. в статье [синтаксис запросов аналитики временных рядов Azure](https://docs.microsoft.com/rest/api/time-series-insights/gen1-query-syntax) .
