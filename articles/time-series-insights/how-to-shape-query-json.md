...
### <a name="in-this-video-we-cover-best-practices-around-shaping-json-to-meet-your-storage-needsbr"></a>В этом видео мы рассмотрим рекомендации по формированию JSON для выбора необходимого объема хранения.</br>
