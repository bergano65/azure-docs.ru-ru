...
Рассмотрим следующие полезные данные JSON, отправляемые в среду Azure "аналитика временных рядов", с помощью [объекта сообщения устройства IOT](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.message?view=azure-dotnet) , который сериализуется в JSON при отправке в Cloud.
