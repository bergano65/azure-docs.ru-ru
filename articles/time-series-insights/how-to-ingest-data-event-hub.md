...
- Создайте среду службы "аналитика временных рядов Azure", как описано в статье [Создание среды службы "аналитика временных рядов Azure](./tutorials-set-up-tsi-environment.md)".
