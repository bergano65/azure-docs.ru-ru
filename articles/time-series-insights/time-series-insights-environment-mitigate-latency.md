...
### <a name="in-this-video-we-cover-time-series-insights-data-ingress-behavior-and-how-to-plan-for-itbr"></a>В этом видео мы рассмотрим поведение входящих данных аналитики временных рядов, а также их планирование.</br>
