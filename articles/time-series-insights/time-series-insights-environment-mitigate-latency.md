...
1. Нажмите **+ New alert rule** (+ Создать правило генерации оповещений). После этого отобразится панель **Создание правила** . Выберите **Добавить** в поле **условие**.
