---
title: Планирование службы "Аналитика временных рядов Azure". Планирование масштаба среды службы "Аналитика временных рядов Azure" | Документация Майкрософт
