...
1. В поле **время хранения данных (в днях)** введите значение от 1 до 400.
   ...
   [@no__t 1Configure-хранение](media/environment-mitigate-latency/configure-retention.png)](media/environment-mitigate-latency/configure-retention.png#lightbox)
...
Во второй области, на которую следует обратить внимание при планировании среды "аналитика временных рядов", входит *пропускная способность*. Объем входящих данных является производным от поминутного выделения.
