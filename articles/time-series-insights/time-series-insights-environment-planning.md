...
Чтобы приступить к работе со службой "аналитика временных рядов", лучше всего знать, сколько данных вы планируете отправить в минуту и сколько времени необходимо для хранения данных.  
...
- <a href="#ingress-capacity">Емкость входящих данных</a>
- <a href="#shape-your-events">Формирование событий</a>
- <a href="#ensure-that-you-have-reference-data">Обеспечение ссылочных данных на месте</a>
...
Вы можете изменить параметр **время хранения данных** в среде "аналитика временных рядов". Вы можете включить период удержания до 400 дней. 

Аналитика временных рядов имеет два режима. Один режим оптимизирует, чтобы гарантировать, что ваша среда имеет самые последние данные. Этот режим включен, по умолчанию. 

Другой режим оптимизирует, чтобы обеспечить соблюдение ограничений хранения. Во втором режиме входящий трафик приостанавливается при достижении общей емкости среды хранения. 
...
В следующей таблице приводится сводка емкости входящих данных за единицу для каждого SKU "аналитика временных рядов":

|номер SKU  |Число событий в месяц  |Размер события в месяц  |Число событий в минуту  |Размер события в минуту  |
|---------|---------|---------|---------|---------|
...
> [!TIP]
> Ознакомьтесь с документацией по формированию JSON в статье [Отправка событий](https://docs.microsoft.com/azure/time-series-insights/time-series-insights-send-events).
...
Дополнительные сведения о создании, передаче эталонных данных и управлении ими в службе "аналитика временных рядов" см. в [документации по эталонному набору данных](https://docs.microsoft.com/azure/time-series-insights/time-series-insights-add-reference-data-set).
