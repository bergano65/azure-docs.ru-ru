...
### <a name="in-this-video-we-cover-common-time-series-insights-customer-challenges-and-mitigationsbr"></a>В этом видео рассматриваются распространенные проблемы клиентов службы "Аналитика временных рядов" и способы их устранения.</br>

> [!VIDEO https://www.youtube.com/embed/7U0SwxAVSKw]

## <a name="problem-one-no-data-is-shown"></a>Проблема одно: данные не отображаются
...
## <a name="problem-two-some-data-is-shown-but-data-is-missing"></a>Проблема 2: некоторые данные отображаются, но данные отсутствуют
...
## <a name="problem-three-my-event-sources-timestamp-property-name-setting-doesnt-work"></a>Проблема 3: параметр имени свойства метки времени источника события не работает
