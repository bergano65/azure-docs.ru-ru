...
description: В этой статье содержится обзор проверки подлинности общей подписи доступа (SAS) с помощью службы azure Relay.
...
Ключи для SAS можно настроить в пространстве имен ретранслятора. В отличие от обмена сообщениями в служебной шине, при [гибридных подключениях в ретрансляторе](relay-hybrid-connections-protocol.md) поддерживаются неавторизованные и анонимные отправители. При его создании можно включить анонимный доступ к объекту, как показано на следующем скриншоте с портала:
