...
`hyco-https` Модуль изменяет и частично переопределяет основные модули `http` Node. js и `https`предоставляет реализацию прослушивателя HTTPS, совместимую с множеством существующих модулей Node. js и приложений, которые используют эти основные модули.
