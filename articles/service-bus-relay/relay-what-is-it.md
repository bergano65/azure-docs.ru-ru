...
- [Гибридные соединения](#hybrid-connections) - Использует открытые стандартные веб-разъемы, позволяющие многоплатформенные сценарии.
...
## <a name="hybrid-connections-vs-wcf-relay"></a>Гибридные соединения vs. Эстафета WCF
...
8. Шлюз перенаправляет любые сообщения от подслушивающего клиента к клиенту-отверля. 
9. Шлюз перенаправляет все сообщения от отправляющего клиента к прослушивающему клиенту.  

## <a name="next-steps"></a>Дальнейшие действия
* [Начало работы с .NET WebSockets](relay-hybrid-connections-dotnet-get-started.md)
* [Начало работы с HTTP-запросами .NET](relay-hybrid-connections-http-requests-dotnet-get-started.md)
* [Начало работы с узловой WebSockets](relay-hybrid-connections-node-get-started.md)
