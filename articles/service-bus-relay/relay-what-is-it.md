...
ms.locfileid: "48888138"
---
# <a name="what-is-azure-relay"></a>Что такое ретранслятор Azure?
Служба Azure Relay позволяет безопасно предоставлять службы, выполняющиеся в корпоративной сети в общедоступном облаке. Для этого вам не нужно создавать подключение брандмауэра или вносить значительные изменения в инфраструктуру корпоративной сети. 
...
7. После этого прослушивающий клиент создает временный канал и отправляет ответное сообщение в шлюз, наиболее близкий к отправляющему клиенту.
8. Шлюз перенаправляет это сообщение с ответом отправляющему клиенту. 
