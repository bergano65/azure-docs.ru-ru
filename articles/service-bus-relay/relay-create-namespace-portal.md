...
description: В этой статье приводится пошаговое решение, которое показывает, как создать пространство имен ретранслятора с помощью портала Azure.
...
2. Шаблоны [управления ресурсами Azure.](../azure-resource-manager/management/overview.md)
