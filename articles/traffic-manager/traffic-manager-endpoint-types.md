...
* **Внешние конечные точки** используются для IPv4 и IPv6-адресов, полных доменных имен, или для служб, размещенных за пределами Azure, которая может быть либо локальным, или у другого поставщика услуг размещения.
