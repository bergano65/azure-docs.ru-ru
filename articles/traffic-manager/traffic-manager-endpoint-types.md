...
* **внешние конечные точки**, используемые для IPv4- или IPv6-адресов или для служб, размещенных за пределами Azure: локально или с помощью другого поставщика услуг размещения;
