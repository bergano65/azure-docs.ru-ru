...
* **Вложенные конечные точки** используются для объединения профилей диспетчеров трафика для создания более гибких схем реуктора для поддержки потребностей более крупных и сложных развертываний.
...
* [Могу ли я использовать диспетчера трафика с слотами «Постановка» облачного сервиса?](https://docs.microsoft.com/azure/traffic-manager/traffic-manager-faqs#can-i-use-traffic-manager-with-cloud-service-staging-slots)
