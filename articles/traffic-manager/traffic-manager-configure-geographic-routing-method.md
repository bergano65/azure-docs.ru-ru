---
title: Настройка географической маршрутизации трафика с диспетчером трафика Azure
...
4. В разделе **Создание профиля диспетчера трафика** выполните следующее.
    1. Укажите имя профиля. Оно должно быть уникальным в пределах зоны trafficmanager.net. Чтобы получить доступ к профилю диспетчера трафика, используйте DNS-имя `<profilename>.trafficmanager.net`.
