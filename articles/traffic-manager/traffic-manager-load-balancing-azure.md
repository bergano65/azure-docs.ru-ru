...
1. На портале Azure нажмите **«Создайте** > **профиль** > **менеджера сетей сети»** > **Создание**.
...
3. Нажмите **Создать** для создания профиля менеджера трафика.
...
1. На портале Azure в левом стеле нажмите **«Создайте шлюз сетевого** > **Networking** > **приложения».**
...
1. На портале Azure в левом стеле нажмите **«Создайте** > **балансилер****сетевой** > нагрузки».
2. Выберите имя подсистемы балансировки нагрузки.
3. Установите **тип** **для внутреннего**и выберите соответствующую виртуальную сеть и подсеть для балансиватора нагрузки, чтобы проживать дюйма
4. При **назначении IP-адреса**выберите **динамический** или **статический**.
5. В разделе **Группа ресурсов** выберите группу ресурсов для балансировщика нагрузки.
6. В соответствии с **местоположением**выберите подходящий регион для балансоилира нагрузки.
...
6. Под **неработоспособным порогом**укажите количество непрерывных сбоев зонда, которые должны произойти для того, чтобы vM бэк-энда считался неработоспособным.
7. Нажмите **OK,** чтобы создать зонд.
...
3. Выберите **IP-адрес Frontend** балансоилира нагрузки, **протокола**и **порта.**
4. Под **портом Backend**укажите порт, который будет использоваться в пуле бэк-энда.
5. Выберите **серверный пул** и **пробу**, которые вы создали ранее и к которым будет применяться правило.
6. При **сохранении сеанса**выберите, как вы хотите, чтобы сеансы сохранятся.
7. Под **тайм-аутами простоя**укажите количество минут до простоя тайм-аута.
8. В разделе **Плавающий IP-адрес** выберите **Отключен** или **Включен**.
9. Нажмите **OK,** чтобы создать правило.
