...
ms.locfileid: "50158828"
---
# <a name="tutorial-control-traffic-routing-with-weighted-endpoints-by-using-traffic-manager"></a>Руководство по управлению маршрутизацией трафика к конечным точкам на основе весовых коэффициентов с помощью диспетчера трафика 
