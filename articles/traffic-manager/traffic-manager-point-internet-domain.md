---
title: Направьте интернет-домен менеджеру трафика - менеджер управленца трафика Azure
...
Все запросы трафика на *www\.contoso.com* получить направлены *на contoso.trafficmanager.net*.
