...
| &lt;любой&gt; |Отключен |Выключено |Конечная точка отключена. Отключенные конечные точки не отслеживаются. Эта конечная точка не включается в ответы DNS и поэтому не получает трафик. |
| Активировано |Включено |Справка в Интернете |Конечная точка отслеживается и работоспособна. Она включается в ответы DNS и может получать трафик. |
...
| Включено |По крайней мере одна конечная точка находится в сети. Отсутствуют конечные точки в состоянии пониженной функциональности. |Справка в Интернете |Служба принимает трафик. В дальнейших действиях нет необходимости. |
