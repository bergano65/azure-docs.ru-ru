...
| **Проверка работоспособности** | Пользовательская проба, используемая для мониторинга работоспособности участников серверного пула.|
...
Научитесь настраивать разгрузку TLS, посетив: [Настройка TLS Разгрузки](application-gateway-ssl-arm.md)
