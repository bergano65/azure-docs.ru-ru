...
Обратите внимание, что шлюзы приложений для Интернета и внутренней маршрутизации запросов к серверной части серверы с помощью частных IP-адресов, если ресурс пула серверной части содержит частный IP-адрес, конфигурации сетевого Адаптера виртуальной Машины или внутренним образом разрешить адрес и вашей внутренний пул — общедоступную конечную точку, шлюз приложений использует его внешнего интерфейса общедоступного IP-адреса, чтобы подключиться к серверу. Если вы еще не подготовили общедоступный IP-адрес внешнего интерфейса, один назначается для исходящих внешних подключений.
