...
3. Шлюз приложений принимает трафик, поступающий на один или несколько прослушивателей. Прослушиватель — это логическая сущность, которое проверяет наличие запросов на подключение. Он настраивается с помощью плана IP-адрес, протокол и номер порта для подключения от клиентов в шлюзе приложений.
