---
title: Создание и использование настраиваемых правил брандмауэра веб-приложения Azure (WAF) версии 2
description: В этой статье сведения о том, как создать настраиваемые правила брандмауэра веб-приложения (WAF) версии 2 в шлюзе приложений Azure.
