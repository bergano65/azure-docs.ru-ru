...
3. Создайте и подключите [группу безопасности сети](https://docs.microsoft.com/azure/virtual-network/security-overview) для подсети шлюза приложений со следующей конфигурацией в порядке приоритета:
    ...
    в. Запретите весь входящий трафик от источника **в виде тега**службы **Интернета** , а также назначения и порта назначения. Присвоить этому правилу *наименьший приоритет* в правилах для входящих подключений
