...
ms.locfileid: "58170060"
---
# <a name="application-gateway-redirect-overview"></a>Общие сведения о перенаправлении для шлюза приложений

Шлюз приложений можно использовать для перенаправления трафика.  Он имеет универсальный механизм перенаправления что позволяет перенаправлять трафик, поступающий на один прослушиватель на другой прослушиватель или на внешний сайт. Это упрощает настройку приложения, оптимизирует использование ресурсов и обеспечивает поддержку новых сценариев перенаправления, включая перенаправление на основе пути и глобальное перенаправление.
