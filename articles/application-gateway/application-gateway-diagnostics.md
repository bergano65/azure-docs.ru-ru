...
1. На портале Azure найдите нужный ресурс и выберите **параметров диагностики**.
...
3. На странице **Параметры диагностики** представлены параметры журналов диагностики. В этом примере для хранения журналов используется Log Analytics. Для хранения журналов диагностики можно также использовать концентраторы событий и учетную запись хранения.

   ![Начало процесса настройки][2]

5. Введите имя для параметров, проверьте параметры и выберите **Сохранить**.
...
- **Unhealthy Host count**
   ...
   Можно выполнить фильтрацию по серверному пулу для отображения работоспособных и неработоспособных узлов в определенном серверном пуле.
...
1. Выберите **добавить оповещение метрики** открыть **добавить правило** страницы. Можно также открыть эту страницу, на странице метрик.

   ![Кнопка "Добавить оповещение метрики"][6]

2. На **добавить правило** странице, заполните имени, условия и уведомление разделов и выберите **ОК**.
