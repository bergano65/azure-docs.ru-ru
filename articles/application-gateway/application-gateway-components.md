...
Шлюз приложений обрабатывает прослушиватели в указанном [порядке](https://docs.microsoft.com/en-us/azure/application-gateway/configuration-overview#order-of-processing-listeners).
