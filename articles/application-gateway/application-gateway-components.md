...
Номер SKU шлюза для версии 2 приложения Azure можно настроить для поддержки как статический внутренний IP-адрес и статический общедоступный IP-адрес или только статический общедоступный IP-адрес. Его нельзя настроить для поддержки только статический внутренний IP-адрес.

Номер SKU V1 можно настроить для поддержки статический внутренний IP-адрес и динамический общедоступный IP-адрес только статический внутренний IP-адрес, или только динамический общедоступный IP-адрес. Динамический IP-адрес шлюза приложений не приводит к изменению на выполнение шлюза. Его можно изменить только в том случае, если остановить или запустить шлюз. Он остается неизменным на системных сбоев, обновлений, узел Azure обновлений и т.д. 
