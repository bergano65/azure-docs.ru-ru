...
Дополнительные сведения об избыточности между зонами и автомасштабировании шлюза приложений см. в разделе [Автоматическое масштабирование и шлюз приложений, избыточный между зонами (общедоступная предварительная версия)](application-gateway-autoscaling-zone-redundant.md).
