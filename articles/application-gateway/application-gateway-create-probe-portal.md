...
4. На странице **Добавление проверки работоспособности** заполните необходимые сведения для пробы и после завершения нажмите кнопку **ОК**.
   ...
   |**Выбор имени узла из серверных параметров HTTP**|"Да" или "Нет"|Устанавливает заголовок *узла* в зонде на имя узла серверного ресурса во внутреннем пуле, связанном с ПАРАМЕТРом HTTP, с которым связана эта проверка. Требуется специально в случае с многоклиентским интерфейсом, например службой приложений Azure. [Подробнее](https://docs.microsoft.com/azure/application-gateway/configuration-overview#pick-host-name-from-back-end-address)|
