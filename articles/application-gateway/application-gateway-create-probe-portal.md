...
1. В колонке **Добавление зонда работоспособности** введите необходимые сведения о пробе, затем нажмите кнопку **ОК**.
   ...
   |---|---|---|
   |**Name**|customProbe|Понятное имя пробы, которое отображается на портале.|
   ...
   |**Пороговое значение сбоя**|3|Число неудачных попыток, после которых состояние считается неработоспособным. Пороговое значение можно задать равным 1 или более.|
