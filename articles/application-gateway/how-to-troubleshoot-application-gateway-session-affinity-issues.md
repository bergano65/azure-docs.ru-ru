...
- Запустите [Get-AzureRmApplicationGatewayBackendHttpSettings](https://docs.microsoft.com/powershell/module/azurerm.network/get-azurermapplicationgatewaybackendhttpsettings?view=azurermps-4.1.0) в PowerShell
...
Чтобы устранить эту проблему, следует получить доступ к шлюзу приложений с помощью полного доменного ИМЕНИ. Например, использовать [ http://website.com ](http://website.com/) или [ http://appgw.website.com ](http://appgw.website.com/) .
