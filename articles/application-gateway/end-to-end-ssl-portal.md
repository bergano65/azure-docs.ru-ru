...
Чтобы создать шлюз приложений с начала до конца SSL-шифрования, необходимо сначала включить завершение SSL-запросов при создании нового шлюза приложений. Это позволит SSL-шифрования для обмена данными между клиентом и приложением шлюза. Затем необходимо будет добавить в список разрешений сертификаты для внутренних серверов, в параметрах HTTP Включение шифрования SSL для связи между шлюзом и серверной части серверов приложений, таким образом выполнение end-to-end SSL-шифрования.
