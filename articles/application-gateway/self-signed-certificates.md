...
Инструкции по привязке TLS см. в статье [Как настроить SSL для IIS 7](https://docs.microsoft.com/iis/manage/configuring-security/how-to-set-up-ssl-on-iis#create-an-ssl-binding-1).
