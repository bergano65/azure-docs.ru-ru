...
- **Неудачные запросы**
  ...
  Количество невыполненных запросов, которые обслуживаются Gateway приложения. Количество запросов может быть дополнительно отфильтровано, чтобы показать количество на каждую/конкретную комбинацию настройки пула-http.
