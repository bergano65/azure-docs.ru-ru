...
Аналогичным образом, если *Общее время для шлюза приложений* имеет пиковое *время ответа последнего байта сервера* , это может быть признаком узких мест производительности в шлюзе приложений или узким местом в сети между клиентом и шлюзом приложений. Кроме того, если для *RTT клиента* также имеется соответствующий пик, это означает, что снижение производительности обусловлено сетью между клиентом и шлюзом приложений.
...
- **Расчетные единицы пропускной способности**
  ...
  Количество единиц мощности, по которым оценивается счет. Это калкутаед в качестве большего значения между *текущими единицами мощности* и *фиксированными оплачиваемыми единицами мощности*.  
...
- **Фиксированные единицы оплачиваемой емкости** Минимальное число единиц емкости, подготовленных в соответствии с параметром *минимальной единицы масштабирования* в конфигурации шлюза приложений.
...
- Количество **запросов в минуту на** исправный узел Среднее число запросов, полученных каждым работоспособным участником в серверном пуле за минуту. Необходимо указать серверный пул с помощью измерения *неработоспособных неработоспособных* .  
