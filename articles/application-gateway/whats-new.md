...
|---------|---------|---------|
| Имена узлов с подстановочными знаками в прослушивателях (предварительная версия) | Теперь вы можете определять имена узлов с подстановочными знаками в многосайтовом прослушивателе и до 5 имен узлов на прослушиватель. Чтобы узнать больше, ознакомьтесь с [использованием имен узлов с подстановочными знаками в прослушивателях (предварительная версия)](multiple-site-overview.md#wildcard-host-names-in-listener-preview). | Июль 2020 г. |
