...
ms.locfileid: "67613315"
---
# <a name="web-application-firewall-crs-rule-groups-and-rules"></a>Web application CRS правила групп и правил брандмауэра

Брандмауэр веб-приложения шлюза приложений (WAF) позволяет устранить уязвимости веб-приложений и защитить их от эксплойтов. Это делается через правила, которые определены в зависимости от основных наборов правил OWASP 3.0 или 2.2.9. Эти правила можно отключать по отдельности. В этой статье приведены текущие правила и наборы правил.

Следующие правила и группы правил доступны при использовании шлюза приложений с брандмауэром веб-приложения.
...
|920140|Текст в составной запрос не прошел строгую проверку|
...
|920460|Аномальное escape-символы|
...
|941190|XSS, с помощью таблицы стилей|
|941200|С помощью VML кадров XSS|
|941210|С помощью Javascript скрытый XSS|
|941220|С помощью XSS, затрудняющую VB|
|941230|С помощью XSS «внедрение» тег|
|941240|С помощью атрибута «Импорт» или «реализация» XSS|
|941260|XSS, с помощью тега «meta»|
|941270|С помощью «link» href XSS|
|941280|XSS, используя тег «base»|
|941290|XSS, используя тег «приложение»|
|941300|XSS, используя тег «object»|
...
# <a name="owasp-229tabowasp2"></a>[OWASP ВЕРСИИ 2.2.9](#tab/owasp2)
...
|960914|Текст в составной запрос не прошел строгую проверку|
...
Дополнительные сведения об отключении правил WAF: [Настройка правил брандмауэра веб-приложения с помощью портала Azure](application-gateway-customize-waf-rules-portal.md)
