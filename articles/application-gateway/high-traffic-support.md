...
ms.locfileid: "80257433"
---
# <a name="application-gateway-high-traffic-support"></a>Приложение Шлюз высокой поддержки трафика 

В этой статье описаны несколько предлагаемых рекомендаций, которые помогут настроить шлюз приложения для обработки дополнительного трафика из-за больших сценариев объема трафика, таких как ситуация COVID-19. Вы можете использовать шлюз приложений с веб-приложением Firewall (WAF) для масштабируемого и безопасного способа управления трафиком в веб-приложениях. 
