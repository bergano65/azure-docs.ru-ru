---
title: Руководство. Создание шлюза приложений, на котором размещается несколько веб-сайтов, с помощью портала Azure
...
В этом примере создаются два новых правила и удаляется существующее правило по умолчанию, созданное вместе со шлюзом приложений.
