---
title: Создание шлюза приложений для размещения нескольких веб-сайтов — портал Azure
description: Узнайте, как создать шлюз приложений, на котором размещается несколько веб-сайтов, используя портал Azure.
...
2. Щелкните **Подсети**, а затем — **Подсеть**.
    ...
    ![Создание подсети](./media/create-multiple-sites-portal/application-gateway-subnet.png)
...
3. Введите имя *contosoPool* и добавьте цель *contosoVM* с помощью команды **Добавить цель**.
    ...
    ![Добавление внутренних серверов](./media/create-multiple-sites-portal/application-gateway-multisite-backendpool.png)
...
## <a name="create-backend-listeners"></a>Создание серверных прослушивателей
...
![многосайтовые прослушиватели](media/create-multiple-sites-portal/be-listeners.png)

## <a name="create-routing-rules"></a>Создание правил маршрутизации
...
4. Выберите *contosoPool* для внутреннего пула.
    ...
    ![Создание правила на основе пути](./media/create-multiple-sites-portal/application-gateway-multisite-rule.png)
...
1. Выберите **Все ресурсы** и щелкните **myAGPublicIPAddress**.
    ...
    ![Запись DNS-адреса шлюза приложений](./media/create-multiple-sites-portal/application-gateway-multisite-dns.png)
