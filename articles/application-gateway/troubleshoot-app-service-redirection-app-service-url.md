...
- Шлюз приложений теперь должен перенаправлять одно и то же имя узла в `www.contoso.com` службу приложений. Перенаправление происходит в том же имени узла. Проверьте следующие примеры заголовков запросов и ответов.
