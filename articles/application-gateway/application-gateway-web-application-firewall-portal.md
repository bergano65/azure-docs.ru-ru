...
1. Найдите общедоступный IP-адрес для шлюза приложений на странице **Обзор**.![Запишите общедоступный IP-адрес шлюза приложения](./media/application-gateway-create-gateway-portal/application-gateway-record-ag-address.png) 
...
> [Web application firewall for Azure Application Gateway](waf-overview.md) (Брандмауэр веб-приложений для шлюза приложений Azure)
