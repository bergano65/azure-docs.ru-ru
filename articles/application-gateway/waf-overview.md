...
* Скоро WAF будет интегрирован с центром безопасности Azure. Благодаря центру безопасности Azure вы получаете полное представление о состоянии безопасности всех своих ресурсов в Azure.
...
В текущем SKU общедоступном предварительном просмотре WAF реализованы следующие функции.
...
Дополнительные сведения о списке правил и соответствующих возможностях защиты см. [здесь](#core-rule-sets).
