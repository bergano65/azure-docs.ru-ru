...
* Защита нескольких веб-приложений, в то же время. Экземпляр шлюза приложений можно разместить до 20 веб-сайтов, которые защищены брандмауэром веб-приложения.
