...
| 10221-10231 |Входящий трафик |TCP |Взаимодействие клиента с кластерами Redis, внутренняя связь для Redis | (Подсеть Redis) |(Подсеть Redis), Azure Load Balancer, (подсеть клиента) |
