...
description: Узнайте, как создать и настроить поддержку виртуальной сети для кэша Azure уровня "Премиум" для экземпляра Redis.
author: yegu-ms
ms.author: yegu
ms.service: cache
ms.topic: conceptual
