...
> [!NOTE]
> Доступ по протоколу SSL к кэшу Azure для Redis поддерживает TLS 1,0, 1,1 и 1,2 в настоящее время, но сейчас в скором времени отменяются версии 1,0 и 1,1.  Дополнительные сведения см. на [странице Удаление TLS 1,0 и 1,1](cache-remove-tls-10-11.md) .
