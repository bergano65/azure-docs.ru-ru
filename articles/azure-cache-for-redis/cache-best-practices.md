 ...
 * **Включите VRSS** на клиентском компьютере, если вы используете Windows.  [Щелкните здесь, чтобы узнать больше](https://technet.microsoft.com/library/dn383582(v=ws.11).aspx).  Пример сценария PowerShell:
