...
- Наблюдение за `Page Faults/Sec` счетчиком производительности клиента. Во время нормальной работы в большинстве систем возникают ошибки страниц. Пиковые ошибки страниц, соответствующие времени ожидания запросов, могут указывать на нехватку памяти.
