...
1. На странице **Дополнительно** выберите **число реплик** .
    ...
    :::image type="content" source="media/cache-how-to-multi-replicas/create-multi-replicas.png" alt-text="Выбор элемента &quot;Кэш Azure для Redis&quot;.":::

1. Выберите **зоны доступности** . 
   
    :::image type="content" source="media/cache-how-to-zone-redundancy/create-zones.png" alt-text="Выбор элемента &quot;Кэш Azure для Redis&quot;.":::
