...
Лезвие **обновления расписания** позволяет назначить окно обслуживания для экземпляра кэша. Если задан период обслуживания, то любые обновления сервера Redis выполняются в этот период. 
