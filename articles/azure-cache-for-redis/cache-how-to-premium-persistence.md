...
> [!NOTE]
> 
> Служба хранилища Azure автоматически шифрует данные при их сохранении. Для шифрования можно использовать собственные ключи. Дополнительные сведения см. [в разделе ключи, управляемые клиентом, с помощью Azure Key Vault](/azure/storage/common/storage-service-encryption?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#customer-managed-keys-with-azure-key-vault).
> 
> 
...
Сохраняемость Redis включается в колонке " **сохраняемость данных** " с помощью сохранения **RDB** или **AOF** . Для новых кэшей доступ к этой колонке осуществляется при создании кэша, как описано в предыдущем разделе. Для существующих кэшей доступ к колонке **сохраняемости данных** осуществляется из **меню ресурсов** для кэша.
...
| Уровень Premium | Большие двоичные объекты |
|--------------|-------|
| P1           | 4 на сегмент    |
| P2           | 8 на сегмент    |
| P3           | 16 на сегмент   |
