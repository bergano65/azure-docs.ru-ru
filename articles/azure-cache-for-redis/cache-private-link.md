...
10. На вкладке **теги** введите имя и значение, если вы хотите классифицировать ресурс. Это необязательный шаг.
...
Дополнительные сведения о закрытой ссылке см. в [документации по частной ссылке Azure](https://docs.microsoft.com/azure/private-link/private-link-overview). 
