...
description: Сведения об использовании Сетки событий Azure для создания подписки на события Кэша Azure для Redis, активации такого события и просмотра полученных результатов.
author: curib
ms.author: cauribeg
ms.date: 1/5/2021
ms.topic: quickstart
