---
title: Краткое руководство. Использование кэша Azure для Redis в приложениях .NET Core | Документация Майкрософт
...
![Delete (Удалить)](./media/cache-dotnet-core-quickstart/cache-delete-resource-group.png)
