...
* Главный узел кэша.
* Вторичный узла кэша
* Как первичные, так и вторичные узлы кэша
* При использовании кэша премиум-класса с кластеризанием можно перезагрузить первичные, вторичные или оба узла для отдельных осколков в кэше
