...
* Главный узел кэша.
* Вторичный узел кэша
* Первичный и вторичный узлы кэша
* При использовании кэша уровня "Премиум" с кластеризацией можно перезагрузить первичный, вторичный или оба узла для отдельных сегментов в кэше.
