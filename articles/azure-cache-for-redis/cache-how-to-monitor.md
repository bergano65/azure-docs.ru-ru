...
| Занято памяти |Объем памяти кэша, используемой для хранения пар «ключ — значение» (в МБ), за указанный интервал отчетности. Это значение соответствует значению `used_memory` команды INFO Redis. Не содержит метаданных или фрагментации. |
...
![Отслеживание](./media/cache-how-to-monitor/redis-cache-monitoring.png)
