...
2. На странице **Создание** выберите **Базы данных**, а затем **Кэш Azure для Redis**.
    ...
    :::image type="content" source="media/cache-private-link/2-select-cache.png" alt-text="Создать ресурс." настройте параметры для неtls-порта, кластеризации и сохраняемости данных. Чтобы включить кластеризацию, нажмите кнопку **включить**.

    :::image type="content" source="media/cache-how-to-premium-clustering/redis-cache-clustering.png" alt-text="Создать ресурс.":::
    ...
    :::image type="content" source="media/cache-how-to-premium-clustering/redis-cache-clustering-selected.png" alt-text="Создать ресурс." зеленого цвета, выберите **Создать**.
