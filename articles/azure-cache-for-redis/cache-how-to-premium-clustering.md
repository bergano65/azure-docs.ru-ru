---
title: Настройка кластеризации Redis для кэша Azure категории "Премиум" для Redis
...
Да. Сначала убедитесь, что кэш имеет значение Premium, масштабирование, если нет. Далее вы увидите параметры конфигурации кластера, включая параметр включения клсутер. Размер кластера можно изменить после создания кэша или после первого включения кластеризации в первый раз.
