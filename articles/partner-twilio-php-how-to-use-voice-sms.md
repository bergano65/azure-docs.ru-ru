...
Дополнительные сведения см. в [https://github.com/twilio/twilio-php/blob/master/README.md][twilio_github_readme]разделе.
...
* **Примечание**. сведения об устранении ошибок проверки сертификата TLS/SSL см. в разделе[http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation] 
...
Дополнительные сведения о TwiML см. в [https://www.twilio.com/docs/api/twiml][twiml_reference]разделе. 
