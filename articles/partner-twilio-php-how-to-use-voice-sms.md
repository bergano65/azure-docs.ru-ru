...
* **Примечание**: Для устранения неполадок TLS/ SSL ошибки проверки сертификата, см.[http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation] 
