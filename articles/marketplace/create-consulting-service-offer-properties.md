...
> [!IMPORTANT]
> Наличие хотя бы одной компетенции может быть требованием к публикации предложения в зависимости от его основного продукта. Дополнительные сведения см. в разделе [политики сертификации](https://docs.microsoft.com/legal/marketplace/certification-policies#800-consulting-services) .
