---
title: Службы по выходу на рынок — преимущества коммерческой платформы | Azure Marketplace
...
Ваши преимущества зависят от того, к какой категории относится предложение: [список, пробная версия или транзакция](https://docs.microsoft.com/azure/marketplace/determine-your-listing-type#choose-a-publishing-option).
...
Издатели предложений типа [список или пробная версия](https://docs.microsoft.com/azure/marketplace/determine-your-listing-type) могут согласиться на действия в связи с публикацией конкретного предложения или отказаться от них. Партнеры могут в любой момент отказаться от любого сотрудничества с менеджером. 
...
* способствуют незаконным действиям, используя свое предложение на marketplace;
* исключены из списка на коммерческой платформе; 
* используют свое предложение для отображения маркетингового или иного содержимого, которое нарушает законы об авторском праве или товарных знаках;
* нарушают политики [спонсорской программы Azure](https://azure.microsoft.com/offers/ms-azr-0036p/), в том числе, помимо прочего, используя спонсорское финансирование Azure для собственных внутренних операций или майнинга биткойнов.
