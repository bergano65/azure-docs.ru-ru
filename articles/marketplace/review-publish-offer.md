...
3. На вкладке **Обзор** в разделе **предложения**в столбце **состояние** для каждого предложения отображается один из следующих индикаторов состояния.
    ...
    | Реальные данные | Предложение находится в Marketplace и может быть просмотрено и приобретено клиентами. |
...
| Утверждение издателем | Мы отправим вам сообщение электронной почты с запросом на предварительный просмотр и утверждение предложения. |
...
### <a name="to-preview-your-offer-and-sign-off"></a>Предварительный просмотр предложения и выход
...
### <a name="reporting-usage-of-preview-and-other-internal-usage"></a>Создание отчетов об использовании предварительной версии и другого внутреннего использования
