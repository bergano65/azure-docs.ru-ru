...
2.    В меню навигации слева выберите Обзор **коммерческого рынка**  >  **Overview**.
...
|Событие    |Описание    |
|---------|---------------|
|Созданное предложение    |Предложение было создано в центре партнеров. Пользователь выбрал тип предложения, идентификатор предложения и псевдоним предложения в **Commercial Marketplace**  >  **обзоре**коммерческого рынка.    |
