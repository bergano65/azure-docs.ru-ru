...
В таблице **сведения об использовании** отображается нумерованный список первых 1 000 записей об использовании, отсортированных по использованию. Следует отметить следующее.
...
| SKU | SKU | План, связанный с предложением. |
...
| Тип начисления платы за SKU | Тип начисления платы за SKU | Тип выставления счетов, связанный с каждым SKU в предложении. Допустимые значения:<ul><li>Free</li><li>Платный</li></ul> |
...
| DeploymentMethod | Не рекомендуется | Не рекомендуется (то же определение, что и тип предложения)
 |
| Название компании клиента | Название компании клиента | Название компании, которое указал клиент. Имя может отличаться от имени в подписке Azure клиента. |
