...
| Тип лицензии Marketplace | Тип лицензии Marketplace | Метод выставления счетов коммерческого предложения. Допустимые значения:<ul><li>Счета за использование Azure</li><li>Использование собственной лицензии</li><li>Free</li><li>Корпорация Майкрософт в качестве торгового посредника</li></ul> |
