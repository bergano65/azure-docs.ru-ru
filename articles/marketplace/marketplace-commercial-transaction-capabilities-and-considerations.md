...
Издатель или корпорация Майкрософт несут ответственность за управление транзакциями лицензий на программное обеспечение для предложений на коммерческой платформе. Параметр листинга, выбранный для предложения, определяет, кто управляет транзакцией. Сведения о доступности и объяснении каждого варианта публикации см. [в разделе Общие сведения](determine-your-listing-type.md) о параметрах вывода.
...
Это позволяет использовать более высокие или более низкие цены, чем общедоступное предложение. Вы можете использовать частные предложения для скидки или добавления уровня "Премиум" в предложение. Вы можете предоставить доступ к частным предложениям одному или нескольким клиентам, используя белый список подписок Azure на уровне предложения.

### <a name="commercial-marketplace-service-fees"></a>Плата за услуги коммерческого рынка

Плата взимается за 20% стандартной службы магазина, когда клиенты приобретают предложение Transact из коммерческого рынка. Дополнительные сведения об этой плате см. в разделе 5C [соглашения Microsoft Publisher](https://go.microsoft.com/fwlink/?LinkID=699560).

Для определенных инструкций, которые вы публикуете в коммерческом магазине, вы можете полагаться на снижение стоимости обслуживания магазина на 10%. Чтобы получить квалифицированное предложение, оно должно быть назначено корпорацией Майкрософт в качестве выгодно для совместной продажи в Azure IP. Право на выполнение должно выполняться не менее чем за пять рабочих дней до конца каждого календарного месяца, чтобы получить сокращенную плату за обслуживание Marketplace. После соблюдения приемлемости сниженная плата за обслуживание выдается всем транзакциям, начиная с первого дня следующего месяца, пока не будет потеряно состояние выгодно Azure IP-продаж. Дополнительные сведения о правах на совместное использование IP-продаж см. в разделе [требования для статуса совместной продажи](/legal/marketplace/certification-policies#3000-requirements-for-co-sell-status).

Сниженная плата за обслуживание в Marketplace относится к Azure IP Co выгодно SaaS, виртуальным машинам, управляемым приложениям и любым другим квалифицированным решениям IaaS, которые доступны в коммерческом магазине. Платные предложения SaaS, связанные с одним приложением Microsoft Teams, или по крайней мере две надстройки Microsoft 365 (Excel, PowerPoint, Word, Outlook и SharePoint) и опубликованы в Microsoft AppSource также получают эту скидку.
...
**Бесплатные кредиты и предоплата Azure** . Некоторые клиенты заставляют Azure с предоплатой Azure (ранее назывались денежными обязательствами) в Соглашение Enterprise или были предоставлены бесплатные кредиты для использования с Azure. Эти кредиты можно использовать для оплаты использования Azure, но они не подходят для оплаты лицензий на программное обеспечение издателя.
