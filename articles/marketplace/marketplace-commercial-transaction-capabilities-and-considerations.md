...
Это позволяет использовать более высокие или более низкие цены, чем общедоступное предложение. Вы можете использовать частные предложения для скидки или добавления уровня "Премиум" в предложение. Вы можете сделать частные предложения доступными для одного или нескольких клиентов, алловлистинг их подписку Azure на уровне предложения.
