...
- **Длительность тестового диска** (обязательно) — введите число часов, в течение которых тестовый диск будет оставаться активным (по крайней мере один час). Тестовый выпуск автоматически завершит работу по истечении этого периода.
