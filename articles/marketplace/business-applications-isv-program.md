...
1. Щелкните **Параметры** (значок шестеренки) и выберите **Параметры разработчика** .
...
1. Войдите в [Центр партнеров](https://partner.microsoft.com/dashboard).
1. Щелкните **Параметры** (значок шестеренки) и выберите **Параметры разработчика** .
1. В разделе **учетная запись** выберите **профиль выставления счетов** .
1. Ознакомьтесь с основными контактными данными и сведениями о выставлении счетов, которые заполнены юридическим лицом, и внесите необходимые обновления.
