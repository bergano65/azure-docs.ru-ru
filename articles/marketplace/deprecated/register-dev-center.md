...
9.  В разделе `Registration - Review` проверьте данные учетной записи и убедитесь, что все правильно.  
    ...
    Ознакомьте условия соглашения с [издателем](https://cloudpartner.azure.com/Content/Unversioned/PublisherAgreement2.pdf)Microsoft Azure Marketplace.  
...
* **Почему я получаю сообщение об ошибке "Город требуется", хотя я вошел в город правильно?**
  > Убедитесь, что почтовый индекс также введен правильно. Существует проверка почтового индекса города.

* **Как получить промо-код?**
  > Заполните форму [регистрации ​​Marketplace](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv), чтобы получить специальный код центра разработки. Узнайте, как [создать учетную запись Центра партнеров](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account) для получения дополнительной информации.
 
* **Что следует ожидать после завершения регистрации?**
  > Ищите электронное письмо с verify@microsoft.com темой "Необходимо ею: Проверить учетную запись электронной почты в корпорации Майкрософт". Чтобы завершить регистрацию, щелкните ссылку для конфиденциальной проверки времени. *Если вы не получили электронное письмо в течение 24 часов, проверьте папку со спамом.*

* **Каковы дальнейшие действия после проверки центра разработки?**
  > Перейти к "Вашиhttps://developer.microsoft.com/dashboard/Account/Programs) программы" (и войти в учетную запись Dev Center. Если вы не видите Azure в качестве зарегистрированной программы, посмотрите под "Рекомендуемые программы для вас", а затем ищите Azure, чтобы выбрать "Начало работы".
