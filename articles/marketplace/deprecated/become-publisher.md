---
title: Станьте издателем в витринах в Marketplace | Azure Marketplace
...
ms.locfileid: "80281567"
---
# <a name="become-a-cloud-marketplace-publisher"></a>Регистрация в качестве издателя в облаке Marketplace

В этой статье рассматривается регистрация в качестве издателя в облаке Marketplace. В зависимости от выбранного вами варианта публикации и текущего членства в партнерской сети Microsoft Partner Network некоторые шаги выполнять не нужно. После регистрации вы сможете создавать предложения Marketplace для Azure Marketplace или AppSource.


|  | Шаг регистрации | Duration | Сведения |  
|:--- |:--- |:--- |:--- |  
| 1 | Регистрация в партнерской сети Microsoft Partner Network | 15 мин. | [Регистрация в партнерской сети Microsoft Partner Network](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account) |  
...
| 3 | Создание учетной записи Центра партнеров | 15 мин. | [Создание учетной записи Центра партнеров](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) |  
| 4 |  Вход на Портал Cloud Partner | От 1 до 3 дней | [Вход в Портал Cloud Partner](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account#sign-in-with-a-work-account) |  
...
## <a name="1-register-in-microsoft-partner-network"></a>1. Зарегистрируйтесь в Microsoft Partner Network  
| 15 мин |  
Для участия в облаке Microsoft Cloud Marketplace требуется членство в Microsoft Partner Network (MPN), которое также предоставляет ключевые преимущества, программы и отслеживание производительности партнеров. Если ваша организация еще не входит в эту сеть, присоединитесь к сети Microsoft Partner Network (MPN), чтобы стать официальным партнером Майкрософт и получить дополнительные преимущества и поддержку в обмен на публикацию в Marketplace. 
...
Откройте билет со [службой поддержки партнеров](https://partner.microsoft.com/support) Майкрософт для устранения проблем с регистрацией MPN.
...
[! Обратите внимание, что учетная запись Майкрософт, связанная с вашей рабочей электронной почтой, не позволяет получить доступ к порталу.
...
## <a name="3-create-a-partner-center-account"></a>3. Создание учетной записи центра партнеров  
| 15 мин |  
...
---
## <a name="4-sign-into-cloud-partner-portal"></a>4. вход в Портал Cloud Partner
| От 1 до 3 дней | <br>
...
Процесс регистрации в [Центре разработки](https://developer.microsoft.com/store/register) можно начать перед созданием вашего предложения на Портале Cloud Partner. Его нужно завершить до публикации предложения в Marketplace. Учитывая 5-10 день, типичный для этого шага, рекомендуется как можно быстрее запустить этот процесс, если предполагается использовать параметр публикации Transact. 
...
После завершения регистрации в [центре разработки](https://developer.microsoft.com/store/register) свяжите свой профиль облачного партнера с учетной записью [центра разработки](https://developer.microsoft.com/store/register) ([см. подробные инструкции здесь](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal-orig/cloud-partner-portal-manage-publisher-profile)). Этот шаг необходимо выполнить перед публикацией предложения типа "Транзакция". 

>[!Note]
>Чтобы отказаться от регистрации в центре разработчиков $99, заполните [форму регистрации Marketplace](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) , и вы получите сообщение электронной почты с кодом рекламной акции. Дополнительные сведения см. в статье [Создание учетной записи центра партнеров](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account) .
...
* Сведения о витринах Marketplace: [Сравнение AppSource и Azure Marketplace](https://docs.microsoft.com/azure/marketplace/comparing-appsource-azure-marketplace).
*    [Определите тип перечисления для решения](https://docs.microsoft.com/azure/marketplace/determine-your-listing-type).
