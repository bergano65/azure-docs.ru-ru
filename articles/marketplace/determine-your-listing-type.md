...
ms.locfileid: "94741915"
---
# <a name="introduction-to-listing-options"></a>Общие сведения о параметрах перечисления

Вы можете использовать доступные _варианты перечня_ в коммерческом магазине для привлечения потенциальных клиентов различными способами. После публикации предложения параметры перечня, выбранные для вашего предложения, отображаются в левом верхнем углу страницы со списком вашего предложения в Интернет-магазинах. Например, на следующем снимке экрана показана страница со списком предложений в Microsoft AppSource Online Store с кнопками " **связаться со мной** " и " **тестовый диск** ".

:::image type="content" source="./media/listing-options.png" alt-text="Иллюстрирует страницу листинга для предложения. Кнопки контакты и тестового диска отображаются.":::

## <a name="available-listing-options-by-offer-type"></a>Доступные параметры перечисления по типу предложения
...
| Тип предложения | Пробная версия | Тестовый выпуск | Связь со мной | Получить сейчас (Transactd) |
| ------------ | ------------- | ------------- | ------------- | ------------- |
...
Используйте коммерческий магазин, чтобы улучшить обнаружение, автоматизировать подготовку решения и выполнить финансовую транзакцию отдельно от Marketplace. Вариант "использование собственной лицензии (BYOL)" идеально подходит для миграции из локальной среды в облако. Клиенты используют кнопку _получить сейчас_ , чтобы приобрести предложение, используя лицензию, предварительно приобретенную вами.
...
&#42;&#42; надстройки Microsoft 365 доступны для установки и могут быть доступ с помощью предложения SaaS. Дополнительные сведения см. в статье [Монетизация надстройки Office 365 через коммерческую платформу Майкрософт](/office/dev/store/monetize-addins-through-microsoft-commercial-marketplace.md).
