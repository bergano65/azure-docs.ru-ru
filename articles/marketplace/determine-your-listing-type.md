...
`*` Параметр получить сейчас список включает в себя (бесплатный), использовать собственную лицензию (BYOL), подписку и цены на основе использования. Дополнительные сведения см. в разделе [Получение ИТ](#get-it-now).
