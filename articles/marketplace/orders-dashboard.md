...
| ------------ | ------------- | ------------- |
| Идентификатор подписки Marketplace | Идентификатор подписки на платформу | Уникальный идентификатор, связанный с подпиской Azure, которую клиент использовал для приобретения предложения коммерческого рынка. Для предложений инфраструктуры это GUID подписки Azure клиента. Для предложений SaaS это отображается как нули, так как для покупок SaaS не требуется подписка Azure. |
...
| Тип лицензии Azure | Тип лицензии Azure | Тип лицензионного соглашения, используемого клиентами для покупок в Azure. Другое название — канал. Допустимые значения:<ul><li>Поставщик облачных решений</li><li>Enterprise</li><li>Enterprise через торгового посредника</li><li>Оплата по мере использования</li></ul> |
