...
- **Это частный номер SKU?** Выберите "Да", если номер SKU будет доступен для выбора только ограниченной группе клиентов.
...
- **Включить JIT-доступ?** Выберите **Да**, чтобы включить JIT-доступ к управлению для клиентских развертываний, которые используют это предложение.
...
**Чтобы создать новый авторизации:**
