---
title: Тестовый выпуск предложения приложения Azure | Документация Майкрософт
...
В следующей таблице описаны поля, необходимые для настройки тестового выпуска управляемого приложения.
...
|        Шаблон ARM для тестового выпуска            |        Отправьте сжатый файл (ZIP) с шаблонами Azure Resource Manager для вашего приложения. Дополнительные сведения см. в статье [Тестовый выпуск Azure Resource Manager](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal/test-drive/azure-resource-manager-test-drive).            |
...
|       Идентификатор доступа к подписке             |       Предоставляет доступ к службам Azure и порталу Azure. Именно в подписке производится учет использования ресурсов и выставляются счета за услуги. Если у вас еще нет отдельной подписки Azure только для тестовых выпусков, создайте ее.             |
