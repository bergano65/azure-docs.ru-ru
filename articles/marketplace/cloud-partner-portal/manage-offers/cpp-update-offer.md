...
2. Выберите вкладку **Номера SKU**.  Выберите номер SKU для изменения.
3. Нажмите кнопку **Select Countries** (Выбрать страны) под полем **Country/Region availability** (Доступность по странам и регионам).
4. В диалоговом окне доступности по регионам добавьте или удалите регионы для этого номера SKU.

Для предложений AppSource.

2. Выберите вкладку **Storefront Details** (Сведения об онлайн-магазине).
3. Рядом с меткой **Supported countries/regions** (Поддерживаемые страны и регионы) щелкните **Supported countries/regions** (Поддерживаемые страны и регионы). 
4. В диалоговом окне поддерживаемых стран и регионов добавьте или удалите регионы для этого предложения.
