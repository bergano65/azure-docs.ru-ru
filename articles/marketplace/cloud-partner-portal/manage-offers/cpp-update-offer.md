...
2. Перейдите на вкладку **Контакты** . Обновите контакты.
...
1. Перейдите на вкладку **номера SKU** .  Выберите номер SKU для изменения.
...
Вы можете использовать сценарии, в которых необходимо обновить текстовые ресурсы и изображения в Marketplace, такие как логотипы компании, описание предложения и т. д. Чтобы обновить эти ресурсы, выполните следующие действия.
