---
title: Динамика 365 для привлечения клиентов Техническая информация вкладка (ru) Лазурный рынок
description: Устаревая статья CPP, связанная со статьей PC; "Как указать техническую информацию для приложения Dynamics 365 для участия клиентов на AppSource Marketplace".
author: dsindona
