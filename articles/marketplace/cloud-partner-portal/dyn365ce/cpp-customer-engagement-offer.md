---
title: Динамика 365 для привлечения клиентов предложение для рынка Azure
description: Deprecated эта статья CPP, связанная со статьей PC; "Объясняет, как создать Dynamics 365 для привлечения клиентов предложение для AppSource Marketplace с помощью облачного портала партнеров".
author: dsindona
