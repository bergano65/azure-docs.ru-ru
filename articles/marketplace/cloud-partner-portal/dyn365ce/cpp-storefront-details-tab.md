...
| Видео                | Отправьте рекламные или демонстрационные видео для приложения (не более четырех).  Для каждого видео введите название, URL-адрес (поддерживаются только YouTube и Vimeo) и эскиз в формате PNG с размером 1280 x 720 пикселей.  | 
