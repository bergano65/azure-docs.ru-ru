...
|  Демонстрационное видео о тестовом выпуске (необязательно) |  Вы можете предоставить видеоруководство для своего тестового выпуска. Клиент может посмотреть этот видеоролик до начала работы с тестовым выпуском. Укажите URL-адрес видео на YouTube или Vimeo. При выборе параметра **+ Add Video** (+ Добавить видео) вам будет предложено предоставить следующие требования.<ul><li>Name</li><li>URL-адрес</li><li>Эскиз (в формате PNG, 533 x 324 пикселей)</li></ul>  |
|   |   |
