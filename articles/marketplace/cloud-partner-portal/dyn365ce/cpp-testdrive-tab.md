---
title: Динамика 365 для приложения для участия клиентов предлагают тест-драйв вкладку Лазурный рынок
description: Устаревая статья CPP, связанная со статьей PC; было "Как настроить тест-драйв для Динамика 365 для участия клиентов приложение предложение на AppSource Marketplace".
author: dsindona
