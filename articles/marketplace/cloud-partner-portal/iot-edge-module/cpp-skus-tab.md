...
|  **Поле**       |     **Описание**                                                          |
|  ---------       |     ---------------                                                          |
| **Титуль\***        | Заголовок для этого номера SKU. Максимальная длина составляет 50 символов. <br/> Он будет отображаться в портал Azure и будет использоваться как имя модуля по умолчанию (без пробелов и специальных символов) при развертывании. Применение этого поля демонстрируется на изображениях ниже.|
