...
Настройте **сведения о номере SKU** , чтобы определить, как будет отображаться номер SKU в Azure Marketplace и портал Azure веб-сайтах.
...
|  **Поле**       |     **Описание**                                                          |
|  ---------       |     ---------------                                                          |
| **Название\***        | Заголовок для этого номера SKU. Максимальная длина составляет 50 символов. <br/> Он будет отображаться в портал Azure и будет использоваться как имя модуля по умолчанию (без пробелов и специальных символов) при развертывании. Применение этого поля демонстрируется на изображениях ниже.|
...
| **Описание:\***  | Краткое описание номера SKU. Максимальная длина — 3000 символов. Здесь НЕ НУЖНО описывать само предложение, это описание только для номера SKU. Он будет отображаться в Azure Marketplace и в портал Azure. В портал Azure он будет добавлен в описание Marketplace, описывающее предложение, определенное на вкладке Marketplace.  Он может быть таким же, как и сводка SKU. Применение этого поля демонстрируется на изображениях ниже.|
...
В разделе **образы краевых модулей**укажите сведения, необходимые для отправки модуля IOT Edge.
...
| **Имен\*** | Имя пользователя (администратора), связанное с реестром контейнеров. |
