...
|  **Поле**                |     **Описание**                                                          |
|  ---------                |     ---------------                                                          |
| **Название\***                 | Заголовок предложения. Он будет отображаться на видном месте в Marketplace.  Максимальная длина составляет 50 символов. <!--ADD PICTURE IN ACTION-->|
...
| **Идентификатор маркетинга\***  | Уникальный URL-адрес, который будет связан с этим предложением. Обычно включает имя организации и имя решения. Максимальная длина составляет 50 символов.  Пример: <br/> `https://azuremarketplace.microsoft.com/marketplace/apps/contoso.sampleIoTEdgeModule`  |
...
| **Масштаба\***                  | Формат PNG, размер 255x115 пикселей.                                                   |
...
| **Использовать стандартный Констракт\***  | Следует ли использовать стандартный шаблон Microsoft Contract.  Дополнительные сведения см. в разделе [стандартный контракт](https://docs.microsoft.com/azure/marketplace/standard-contract).   |
