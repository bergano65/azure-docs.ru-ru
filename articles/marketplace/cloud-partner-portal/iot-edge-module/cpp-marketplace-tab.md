---
title: Описание маркетплейса для модуля Azure IoT Edge Лазурный рынок
...
| **Длинная сводка\***          | Более подробное описание предложения (но вы можете сохранить то же описание, что и в поле **Summary** (Сводка)).  Максимальная длина составляет 256 символов. <!--ADD PICTURE IN ACTION-->|
...
| **Маркетинговый идентификатор\***  | Уникальный URL-адрес, который будет связан с этим предложением. Обычно включает имя организации и имя решения. Максимальная длина составляет 50 символов.  Пример: <br/> `https://azuremarketplace.microsoft.com/marketplace/apps/contoso.sampleIoTEdgeModule`  |
...
| **Рекомендуемые категории\*** | Выберите до пяти категорий. Они будут отображаться на странице сведений о продукте. На страницах браузера все модули IoT Edge отображаются в категории *Internet of Things \> IoT Edge module* (Интернет вещей > Модуль IoT Edge).|
|  |  |
...
| *Скриншоты*  | Снимки экрана отображаются на странице сведений о продукте. Это хороший способом обеспечить наглядное представление задач и принципов работы модуля IoT Edge. Например, здесь можно опубликовать схемы архитектуры или примеры использования. Не являются обязательными. Не более пяти снимков экрана на один номер SKU. |
| **Название**                  | Имя или заголовок. Максимальная длина составляет 100 символов.                             |
| **ОС контейнера**                 | Изображение снимка экрана, формат PNG, размер 533×324 пикселей.                               |
| *Видео*  | Видео отображаются на странице сведений о продукте. Это хороший способом обеспечить наглядное представление задач и принципов работы модуля IoT Edge. |
| **Название**                  | Имя или заголовок. Максимальная длина составляет 100 символов.                             |
| **Ссылку**                  | URL-адрес видео, размещенного на сайте YouTube или Vimeo.                                        |
...
| **Используйте стандартный констракт\***  | Использовать ли стандартный шаблон контракта Майкрософт.  Для получения дополнительной информации [см.](https://docs.microsoft.com/azure/marketplace/standard-contract)   |
| **Условия использования\***            | *Условия использования* в качестве встраиваемого простого HTML или ссылки на размещенную страницу с использованием     |
|  |  |
