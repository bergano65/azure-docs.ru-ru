...
| **Description\***           | Описание предложения.  Максимальная длина составляет 3000 символов. Поддерживается простое HTML-форматирование.<br/> В нижней части обязательно должен присутствовать абзац с *минимальными требованиями к оборудованию*. Например: <br/> <p><u>Минимальные требования к оборудованию:</u> операционные системы Linux x64 и arm32, 1 ГБ ОЗУ, 500 МБ хранилища</p>
| **Идентификатор маркетингового\***  | Уникальный URL-адрес, который будет связан с этим предложением. Обычно включает имя организации и имя решения. Максимальная длина составляет 50 символов.  Пример: <br/> `https://azuremarketplace.microsoft.com/marketplace/apps/contoso.sampleIoTEdgeModule`  |
