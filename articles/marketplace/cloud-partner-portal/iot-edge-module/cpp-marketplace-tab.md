...
| **Развернутая Сводка\***          | Более подробное описание предложения (но вы можете сохранить то же описание, что и в поле **Summary** (Сводка)).  Максимальная длина составляет 256 символов. <!--ADD PICTURE IN ACTION-->|
...
| **Идентификатор маркетинг\***  | Уникальный URL-адрес, который будет связан с этим предложением. Обычно включает имя организации и имя решения. Максимальная длина составляет 50 символов.  Например:  <br/> `https://azuremarketplace.microsoft.com/marketplace/apps/contoso.sampleIoTEdgeModule`  |
...
| **Расширенный\***                  | Формат PNG, размер 255x115 пикселей.                                                   |
...
| **Используйте стандартные Constract\***  | Следует ли использовать стандартный шаблон Microsoft контракта.  Дополнительные сведения см. в разделе [стандартный контракт](https://docs.microsoft.com/azure/marketplace/standard-contract).   |
| **Условия использования\***            | *Условия использования* как встроенное простой HTML или ссылку на ваши отправленные условия использования страницы     |
|  |  |
