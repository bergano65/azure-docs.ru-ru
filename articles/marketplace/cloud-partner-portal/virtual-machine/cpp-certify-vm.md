---
title: Сертификация образа виртуальной машины для Azure Marketplace | Документация Майкрософт
...
Затем необходимо [создать универсальные коды ресурсов (URI) для каждого виртуального жесткого диска](./cpp-get-sas-uri.md), который отправляется в marketplace. 
