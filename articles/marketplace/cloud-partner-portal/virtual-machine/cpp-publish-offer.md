...
| Создание пакета и регистрация для создания интересов | \< 1 час  | Технические ресурсы предложения упаковываются для использования клиентами, а также настраиваются и устанавливаются системы интересов. |
