---
title: Распространенные проблемы при создании виртуального жесткого диска для Azure Marketplace. Вопросы и ответы | Документация Майкрософт
