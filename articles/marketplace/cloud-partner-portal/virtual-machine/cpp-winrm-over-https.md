---
title: Служба удаленного управления Windows по протоколу HTTPS для Azure | Документация Майкрософт
description: .
