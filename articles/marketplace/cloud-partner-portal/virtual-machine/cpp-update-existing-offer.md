---
title: Обновление существующего предложения виртуальной машины в Azure Marketplace | Документация Майкрософт
...
После публикации предложения с оплатой по мере использования вы не можете напрямую увеличить цену на его номер SKU.  (Но вы можете создать новый SKU для того же предложения и удалить старый номер SKU, а затем повторно опубликовать предложение для новых клиентов.)  Но вы всегда можете уменьшить стоимость опубликованного предложения, выполнив следующие действия.
