---
title: Обновление существующего предложения VM на рынке Azure
...
4.  В **версии Disk**нажмите на **новую версию диска,** чтобы добавить новое изображение VM.
...
2.  Под **всеми предложениями** найти предложение вы хотели бы обновить.
...
После публикации предложения с оплатой по мере использования вы не можете напрямую увеличить цену на его номер SKU.  (Однако, вы можете создать новый SKU под тем же предложением, удалить старый SKU, а затем переиздать свое предложение для новых клиентов.)  В отличие от этого, вы можете снизить цену опубликованного предложения, используя следующие шаги:

1.  Войдите на [Портал Cloud Partner](https://cloudpartner.azure.com/).

2.  В разделе **Все предложения** найдите предложение, которое нужно обновить.

3.  Щелкните номер SKU, цену на который нужно снизить.
...
- для существующих клиентов сниженная цена будет применяться задним числом с начала периода выставления счетов, в течение которого произошло снижение.
...
С 1 сентября 2018 г. на портале стал доступен новый раздел **Simplified Currency Pricing** (Упрощенные цены в разных валютах). Корпорация Майкрософт упрощает работу с Azure Marketplace, внедряя более предсказуемую модель ценообразования и сбора оплаты от клиентов в разных регионах. Это упрощение включает уменьшение количества валют, в которых клиентам выставляются счета.

В этом новом разделе будут указаны цены в валютах, входящих в новый перечень.После перехода всех клиентов на новые валюты расчетов исходный раздел цен будет удален, и на сайте останется только раздел Simplified Currency Pricing (Упрощенные цены в разных валютах).

Вы должны до 1 ноября 2018 г. установить новую цену для регионов, в которых меняется валюта расчетов. Вы не сможете увеличить цену для регионов, в которых валюта расчетов не меняется.
