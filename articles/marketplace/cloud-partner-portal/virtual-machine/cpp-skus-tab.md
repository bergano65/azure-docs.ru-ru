...
| **ИД SKU\***       | Идентификатор создаваемого номера SKU.  Длина имени не должна превышать 50 знаков, оно может содержать строчные буквы, цифры и дефисы (-), но не может заканчиваться дефисом.  Его нельзя будет изменить после публикации предложения.  |
...
| **Суммар\***      | Краткое описание предложения, которое будет отображаться в Marketplace. Максимальная длина составляет 100 символов. |
