...
|  **Поле**                |     **Описание**                                                          |
|  ---------                |     ---------------                                                          |
| **Название\***                 | Название предложения (часто длинное официальное имя). Этот заголовок будет отображаться на видном месте в marketplace.  Максимальная длина составляет 50 символов. |
