---
title: Вкладка виртуальной машины Marketplace в облачном партнерской портале для Azure Marketplace
...
![Раздел обзора вкладки Marketplace для виртуальных машин](./media/publishvm_008.png)
...
| **Канал реселлера Microsoft CSP\*** | Поставщики облачных решений (CSP) партнеров канала отказ в 100 000.  Пожалуйста, ознакомьтесь с информацией о компании [Cloud Solution Providers,](../../cloud-solution-providers.md) чтобы получить дополнительную информацию о маркетинге вашего предложения по каналам партнеров Microsoft CSP. |
| **Маркетинговый идентификатор\***  | Уникальный URL-адрес, который будет связан с этим предложением. Обычно включает имя организации и имя решения. Максимальная длина составляет 50 символов.  Пример: <br/> `https://azuremarketplace.microsoft.com/marketplace/apps/contoso.sampleApp`  |
...
| **Рекомендуемые категории\*** | Выберите до двух (2) категорий, включая начальную и вторичную категории (необязательно). Выберите до двух (2) подкатегорий для каждой основной и/или средней категории. Если подкатегории не выбраны, вы предлагаете все равно будет обнаружено только в выбранной категории. |
|  |  |
...
| *Скриншоты*  | Не являются обязательными. Не более пяти снимков экрана на один номер SKU. |
...
Этот последний раздел позволяет предоставить необходимые юридические документы, необходимые для каждого предложения.  
