...
Также важно отметить, что **все параметры являются необязательными**, поэтому, если вы\'не хотите использовать Any, вам\'не нужно.
...
| **имен**    | строка          | Новое случайное имя пользователя.| admin68876      |
...
**Длительность тестового диска (в часах) —** *требуемый* срок, в течение которого тестовый диск будет \# оставаться активным, в течение нескольких часов. Тестовый выпуск автоматически завершит работу по истечении этого периода.
...
1. Перейдите на вкладку **назначения ролей** .  ![Добавление нового участника контроля доступа](./media/azure-resource-manager-test-drive/SetupSub7_1.jpg)
