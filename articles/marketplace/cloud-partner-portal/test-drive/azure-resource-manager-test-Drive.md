...
Процесс преобразования архитектуры ресурсов в шаблон тестового выпуска Resource Manager может показаться сложной задачей. Чтобы упростить этот процесс, мы создали примеры рекомендуемых способов \'преобразования текущих шаблонов развертывания[.
...
![портале Azure](./media/azure-resource-manager-test-drive/subdetails9.png)
