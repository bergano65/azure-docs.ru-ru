...
| x-ms-activityid    | Да          | Уникальное строковое значение для отслеживания запроса от службы. Этот идентификатор используется для любого выверки. |
