---
title: Регистрация приложения SaaS - Azure Marketplace | Документация Майкрософт
...
|  **Имя параметра**  | **Обязательно для заполнения**  | **ОПИСАНИЕ**                               |
|  ------------------  | ------------- | --------------------------------------------- |
...
|  **Имя заголовка**  | **Обязательно для заполнения** |  **ОПИСАНИЕ**                                   |
|  --------------   | ------------ |  ------------------------------------------------- |
...
| **Имя свойства**   | **Обязательно для заполнения** |  **ОПИСАНИЕ**                                                          |
| -----------------   | -----------  | ------------------------------------------------------------------------- |
...
Теперь можно использовать приложение Azure AD защищены [SaaS реализации API версии 2](./cpp-saas-fulfillment-api-v2.md).
