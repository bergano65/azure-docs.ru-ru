...
description: Объясняется, как создать предложение SaaS на AppSource и с помощью связанных исполнение V2 API-интерфейсы Azure Marketplace.
...
Код: 403<br>
Не разрешено. Не указан. маркер проверки подлинности является недопустимым, или запрос пытается получить доступ к приобретения, не принадлежащие к текущего издателя.
...
| авторизация      |  [Получите маркер JSON web token (JWT) носителя.](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal/saas-app/cpp-saas-registration#get-a-token-based-on-the-azure-ad-app)  |
...
Код: 403<br>
Не разрешено. Не указан. маркер проверки подлинности является недопустимым, или запрос пытается получить доступ к приобретения, не принадлежащие к текущего издателя. <br> 
