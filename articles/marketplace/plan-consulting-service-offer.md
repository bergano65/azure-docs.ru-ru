...
Каждое предложение консультационной службы должно сосредоточиться на продукте Майкрософт, именуемом **основным продуктом** . Основной продукт, выбранный в центре партнеров, определяет, будет ли ваше предложение Опубликовано в Microsoft AppSource или Azure Marketplace.
