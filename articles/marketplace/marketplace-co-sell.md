...
1. Убедившись, что вы удовлетворены [критериями для состояния сопутствующих продаж, вы](#co-sell-publishing-steps-and-requirements)можете следовать приведенному ниже руководству, чтобы назначить предложение для совместной продажи.
