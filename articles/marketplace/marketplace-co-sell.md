...
||Предложения IP *без* [совместной продажи в центре партнеров](./partner-center-portal/commercial-marketplace-co-sell.md)|<ul><li>Попросите обратиться к [специалисту облака](https://partner.microsoft.com/campaigns/ced-nomination-form/) , чтобы предоставить необходимую документацию по сопутствующим продажам.</li></ul>|Готовность к совместной продаже|
