...
- [Создание предложения модуля IoT Edge](https://cloudpartner.azure.com/#documentation/create-iot-edge-module-offer) — шаги для публикации нового модуля IoT Edge с помощью Портала Cloud Partner.
