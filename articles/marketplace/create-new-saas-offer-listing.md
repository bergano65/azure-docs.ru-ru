...
На странице **список предложений** в разделе **сведения о Marketplace**выполните следующие действия. Дополнительные сведения об этих обязательных сведениях см. в разделе [сведения о предложении](plan-saas-offer.md#offer-listing-details).
...
## <a name="add-links-to-supplemental-online-documentation-optional"></a>Добавить ссылки на дополнительную онлайн-документацию (необязательно)
...
- В противном случае перейдите к разделу [как получить предложение SaaS](create-new-saas-offer-marketing.md).
