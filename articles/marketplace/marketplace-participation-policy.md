...
1. **Страны, в которых доступны управляемые службы независимых поставщиков программного обеспечения.**
