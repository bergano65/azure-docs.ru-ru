...
Предоставьте PNG-файлы логотипа вашего предложения следующих размеров:

- **малый (48 x 48)** ;
- **крупный (216 x 216)** ;

Все логотипы являются обязательными и используются в разных местах описания на Marketplace.
