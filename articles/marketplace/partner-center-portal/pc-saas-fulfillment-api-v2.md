...
#### <a name="provisioned"></a>Инициализировано
...
Код: 403<br>
Unauthorized (Недостаточно прав). Маркер проверки подлинности не указан или недопустим, либо запрос пытается получить доступ к приобретению, который не принадлежит текущему издателю.
...
Код: 403<br>
Unauthorized (Недостаточно прав). Маркер проверки подлинности не указан или недопустим, либо запрос пытается получить доступ к приобретению, который не принадлежит текущему издателю. <br> 
...
##### <a name="deletebr-httpsmarketplaceapimicrosoftcomapisaassubscriptionssubscriptionidapi-versionapiversion"></a>Удаление<br> `https://marketplaceapi.microsoft.com/api/saas/subscriptions/<subscriptionId>?api-version=<ApiVersion>`
...
Код: 500<br> Ошибка внутреннего сервера
...
Код: 409<br>
Конфликт. Например, уже выполнено более новая транзакция.
