...
- @no__t 0Channels: Сделать предложение доступным в программе CSP @ no__t-0 (флажок)
...
**Контакт диспетчера каналов** (обязательно): Вопросы по торговым посредникам, связанным с программой CSP.
...
- @no__t — 0Defineная аудитория предварительной версии: Добавьте одну электронную учетную запись AAD/MSA в строку вместе с дополнительным описанием. **
