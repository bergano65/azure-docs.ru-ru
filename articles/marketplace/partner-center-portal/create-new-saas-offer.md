...
1. Чтобы выделить **полужирным** шрифтом содержимое, добавьте `<b>` в начале текста, который необходимо выделить полужирным шрифтом, и добавьте `</b>` в конце текста, который нужно выделить жирным шрифтом. 
    ...
    **Пример**: БЕСПЛАТНАЯ ПРОБНАЯ ВЕРСИЯ `<b>` `</b>`
...
1. Если вы хотите **увеличить размер текста**, сначала выберите размер текста. Используйте приведенные ниже примеры. После выбора размера текста добавьте соответствующие теги `<H*></H*>` в начало и конец текста. 
    ...
    **Пример**:
    ...
    `<h1>`This — заголовок 1 @ no__t-1 <br>
    `<h2>`This — заголовок 2 @ no__t-1 <br>
    `<h3>`This имеет заголовок 3 @ no__t-1 <br>
    `<h4>`This имеет заголовок 4 @ no__t-1 <br>
    `<h5>`This имеет заголовок 5 @ no__t-1 <br>
    `<h6>`This — заголовок 6 @ no__t-1 
