...
- **Изображения** (необязательно). Существует несколько мест, где изображения логотипа вашего предложения могут отображаться в Marketplace (-ов), что требует следующих размеров: 48 x 48 пикселей _(обязательно),_ Medium: 90 x 90 пикселей, крупный: 216 x 216 пикселей _(обязательно),_ широкие: 255 x 115 и Hero: 815 x 290 пикселей. Все образы должны быть в. Формат PNG.
