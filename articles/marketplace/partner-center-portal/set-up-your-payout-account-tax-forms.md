---
title: Настройка учетной записи выплата & налоговыми формами — Microsoft для коммерческого рынка
Description: Чтобы получить деньги от продаж предложений в коммерческом магазине, Узнайте, как настроить счет на выручку и заполнить необходимые налоговые формы.
ms.date: 12/10/2019
ms.topic: conceptual
author: dsindona
ms.author: dsindona
...
### <a name="fill-out-your-tax-forms"></a>Заполнить налоговые формы
