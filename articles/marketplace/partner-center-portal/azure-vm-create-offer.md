...
Прежде чем начать, изучите статью [Управление учетной записью коммерческого магазина в центре партнеров](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account). Убедитесь, что ваша учетная запись зарегистрирована в программе коммерческой платформы.
...
Ознакомьтесь с [руководством по публикации предложений виртуальных машин](https://docs.microsoft.com/azure/marketplace/marketplace-virtual-machines) и следующими материалами по виртуальным машинам Azure.
...
3. На странице **Обзор** выберите **Новое предложение** > **Виртуальная машина Azure**.
    ...
    ![Снимок экрана, показывающий параметры меню в левой части экрана и кнопку "Новое предложение".](./media/new-offer-azure-vm.png)
...
1. Выберите назначение интереса, в которое будут отправляться данные о потенциальных клиентах. Центр партнеров поддерживает следующие системы CRM.
    ...
    > [!NOTE]
    > Если ваша система CRM здесь не указана, используйте для хранения данных о потенциальных клиентах [табличное хранилище Azure](https://docs.microsoft.com/azure/marketplace/partner-center-portal/commercial-marketplace-lead-management-instructions-azure-table) или [конечную точку HTTPS](https://docs.microsoft.com/azure/marketplace/partner-center-portal/commercial-marketplace-lead-management-instructions-https). Затем экспортируйте данные в систему CRM.
...
На странице **Свойства** укажите категории и отрасли для классификации вашего предложения на Azure Marketplace, версию вашего приложения и юридическую информацию.

### <a name="categories"></a>Категории

Выберите не меньше одной и не больше пяти категорий. Категории будут использоваться для размещения вашего предложения в соответствующих областях поиска на Azure Marketplace. В описании предложения расскажите, как ваше предложение поддерживает эти категории. Предложения виртуальных машин отображаются на Azure Marketplace в категории **Вычисления**.
...
- **Стандартный контракт для коммерческой платформы Майкрософт**
  ...
  Дополнительные сведения см. в статье [Стандартный контракт для коммерческой платформы Майкрософт](https://docs.microsoft.com/azure/marketplace/standard-contract). PDF-файл с текстом [стандартного контракта](https://go.microsoft.com/fwlink/?linkid=2041178) (убедитесь, что блокировка всплывающих окон отключена).
...
Дополнительные сведения о ресурсах для листинга на платформе см. в статье [Рекомендации по размещению предложений на Marketplace](https://docs.microsoft.com/azure/marketplace/gtm-offer-listing-best-practices).
...
- **URI SAS**. Расположение в учетной записи хранения Azure, где сохранен виртуальный жесткий диск операционной системы.
...
Настройте демонстрацию или *тестовый выпуск*, позволяющий клиентам попробовать ваше предложение в течение установленного периода времени, прежде чем его приобрести. Информацию о создании демонстрационной среды для клиентов см. в статье [Тестовые выпуски предложений на коммерческой платформе](https://docs.microsoft.com/azure/marketplace/partner-center-portal/test-drive).
...
- Если предложение находится в статусе черновика: [Удалить черновик предложения](https://docs.microsoft.com/azure/marketplace/partner-center-portal/update-existing-offer#delete-a-draft-offer)
- Если предложение запущено: [Остановить продажу предложения](https://docs.microsoft.com/azure/marketplace/partner-center-portal/update-existing-offer#stop-selling-an-offer-or-plan)
- Если предложение доступно в предварительной версии: [Запустить](https://docs.microsoft.com/azure/marketplace/partner-center-portal/publishing-status#publisher-approval)
- Если вы еще не завершили выход из издателя: [Отменить публикацию](https://docs.microsoft.com/azure/marketplace/partner-center-portal/update-existing-offer#cancel-publishing)

## <a name="marketplace-examples"></a>Примеры из Marketplace

Следующие примеры показывают, как предложения отображаются в Azure Marketplace.

### <a name="azure-marketplace-offer-details"></a>Сведения о предложении в Azure Marketplace

![Пример страницы сведений о предложении в Azure Marketplace](media/avm-create1.png)

### <a name="azure-marketplace-search-results"></a>Результаты поиска в Azure Marketplace

![Пример страницы с результатами поиска в Azure Marketplace](media/avm-create2.png)

### <a name="azure-marketplace-plan-details"></a>Сведения о плане в Azure Marketplace

![Пример страницы сведений о плане в Azure Marketplace](media/avm-create3.png)

### <a name="azure-portal-offer-details"></a>Сведения о предложении на портале Azure

![Пример страницы сведений о предложении на портале Azure](media/avm-create4.png)

### <a name="azure-portal-search-results"></a>Результаты поиска на портале Azure

![Пример страницы с результатами поиска на портале Azure](media/avm-create5.png)

### <a name="azure-portal-plan-details"></a>Сведения о плане на портале Azure

![Пример страницы сведений о плане на портале Azure](media/avm-create6.png)
