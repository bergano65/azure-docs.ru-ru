...
|[Заказы](#orders-dashboard)|Сведения о заказах в графическом и загружаемом формате|
...
- **Корпорация Майкрософт в качестве торгового посредника**— представляет предложения, продаваемые торговыми посредниками Майкрософт в составе **[программы поставщика облачных решений (CSP)](./create-new-saas-offer.md)** .
...
| Имя облачного экземпляра: Azure для государственных организаций | Порядок| Облако Майкрософт для государственных организаций одной из следующих стран: Китай, Германия или США.| |
...
| Sku| Порядок| Имя SKU, определенное во время публикации. Предложение может иметь много номеров SKU, но номер SKU может быть связан только с одним предложением.||
