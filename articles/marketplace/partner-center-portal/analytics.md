...
| Тип лицензии Marketplace: Free| Порядок| В этом предложении все пользователи настроены бесплатно. Корпорация Майкрософт не оплачивает счета клиентам за использование этого предложения.||
...
| Состояние заказа: Активна  | Порядок| Клиент приобрел заказ и не отменил свой заказ.|         |
