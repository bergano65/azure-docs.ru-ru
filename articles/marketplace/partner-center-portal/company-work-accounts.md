...
Дополнительные сведения о добавлении пользовательских доменов в Azure Active Directory см. в статье [Добавление домена в Azure AD или связывание с ним](../../active-directory/fundamentals/add-custom-domain.md).
