---
title: Управление интересами из коммерческого рынка Майкрософт
description: Узнайте о создании и получении интересов клиентов из ваших Microsoft AppSource и предложений Azure Marketplace.
author: qianw211
...
ms.locfileid: "82837334"
---
# <a name="customer-leads-from-your-commercial-marketplace-offer"></a>Интересы клиентов из коммерческого предложения

Интересы — это клиенты, заинтересованные в развертывании ваших предложений [Microsoft AppSource](https://appsource.microsoft.com) и [Azure Marketplace](https://azuremarketplace.microsoft.com). Вы можете получить интересы клиентов после публикации предложения на коммерческом рынке. В этой статье описаны следующие основные понятия управления интересами.

* Как предложение коммерческого рынка создает клиентов, чтобы не пропустить бизнес-возможности. 
...
- **"INS"**: означает *установку*. Это действие находится в Azure Marketplace или AppSource, когда клиент приобретает ваш продукт.
...
## <a name="common-questions-about-lead-management"></a>Распространенные вопросы об управлении интересами
...
Вполне возможно, что домен электронной почты пользователя — из .edu. В целях обеспечения конфиденциальности мы не будем передавать персональные данные из домена. edu. Отправьте запрос в службу поддержки с помощью [справки и поддержки центра партнеров](https://partner.microsoft.com/support/v2/?stage=1).
...
Из-за политик персональных данных мы не можем обмениваться информацией о интересах через незащищенную почту.
