...
Полезной отправной точкой для создания схем эталонной архитектуры является использование [моделей архитектуры Azure](https://docs.microsoft.com/azure/architecture/browse/).
