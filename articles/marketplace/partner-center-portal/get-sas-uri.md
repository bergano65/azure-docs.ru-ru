...
Если у вас возникли трудности с созданием SAS URI, [см.](https://aka.ms/AzureSAS_URI_FAQ) В противном случае сохраните URI SAS в надежном расположении для последующего использования. Он вам понадобится для публикации предложения VM в Partner Center.

* [Создайте предложение виртуальной машины Azure](https://aka.ms/Create_AzureVMoffer)
