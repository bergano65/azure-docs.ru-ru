...
3. Щелкните правой кнопкой мыши виртуальный жесткий диск и выберите **получить подпись общего доступа**.
4. Откроется диалоговое окно **Подписанный URL-адрес**. Заполните следующие поля.
...
5. Нажмите **Создать**, чтобы создать URI SAS для этого виртуального жесткого диска. Диалоговое окно обновится, и в нем отобразятся сведения об этой операции.
6. Скопируйте **URI** и сохраните его в текстовом файле в надежном расположении.
...
7. Повторите эти шаги для каждого виртуального жесткого диска в публикуемом плане.
