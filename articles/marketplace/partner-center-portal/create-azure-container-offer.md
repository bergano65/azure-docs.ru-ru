...
На этой вкладке можно указать различные параметры плана в рамках одного предложения. Эти планы ранее назывались номерами SKU или единицами хранения. Планы могут иметь различие с точки зрения доступности в облаках (например, глобальных или для государственных организаций) и образа, на который ссылается план. Чтобы опубликовать предложение на коммерческой платформе, настройте по крайней мере один план.
...
Выберите вариант [**Azure для государственных организаций**](../../azure-government/documentation-government-welcome.md) , чтобы сделать ваше решение отображаемым здесь. Это облачное облако сообщества с управляемым доступом для клиентов от федерального правительства США, S] (.. /маркетплаце-ЖЕО-аваилабилити-курренЦиес.МД) EM. Вы, как издатель, должны предоставить элементы управления соответствием, меры безопасности и рекомендации для этого облачного сообщества. Azure для государственных организаций использует физически изолированные центры обработки данных и сети (расположенные строго в США).

Перед [публикацией](../../azure-government/documentation-government-manage-marketplace-partners.md) в Azure для государственных организаций протестируйте решение в этой области и убедитесь, что оно работает правильно, так как результаты в ней могут отличаться. Чтобы создать и протестировать решение, запросите пробную учетную запись на странице [Пробная версия Microsoft Azure для государственных организаций](https://azure.microsoft.com/global-infrastructure/government/request/).
...
Этот параметр доступен, только если выбрана служба " **Azure для государственных организаций** " в разделе **доступность в облаке**.
