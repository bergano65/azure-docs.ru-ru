---
title: Создание нового Dynamics 365 для участия клиентов & PowerApps в коммерческом магазине
description: Сведения о создании нового Dynamics 365 для участия клиентов & PowerApps для перечисления или продажи в Azure Marketplace, AppSource или с помощью программы поставщика облачных решений (CSP) на портале коммерческого рынка в центре партнеров Майкрософт.
author: JnHs
manager: evansma
ms.author: jenhayes
...
Чтобы начать создание Dynamics 365 для участия клиентов & PowerApps, убедитесь, что вы сначала [создаете учетную запись центра партнеров](./create-account.md) и открываете [панель мониторинга коммерческого рынка](https://partner.microsoft.com/dashboard/commercial-marketplace/offers)с выбранной вкладкой " **Обзор** ".
...
Нажмите кнопку **+ создать предложение** , а затем выберите пункт меню **Dynamics 365 для служб взаимодействия с клиентами & PowerApps** . Появится диалоговое окно **новое предложение** .
...
Логотип вашего предложения можно предоставить в трех размерах: **Малый (48 x 48)** , **крупный (216 x 216)** и **широкий (255 x 115)** . Небольшие и крупные размеры являются обязательными.
...
Установите этот флажок, чтобы включить настройку исходящего доступа к CRM Secure Store или серверу (S2S). Обратите внимание, что эта функция требует особого внимания от команды Dynamics 365 на этапе сертификации. Корпорация Майкрософт свяжется с вами для выполнения дополнительных действий, необходимых для включения поддержки этой возможности.
