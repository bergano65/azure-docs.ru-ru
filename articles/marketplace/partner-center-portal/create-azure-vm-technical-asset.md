...
Чтобы подключить виртуальную машину под управлением Linux, вам нужен клиент протокола Secure Shell (SSH). В следующих шагах [используется бесплатный терминал](https://www.ssh.com/ssh/putty/) SSH для выводимых инструкций.
