---
title: Управление интересами для взаимодействия с клиентами Dynamics 365 — коммерческий рынок Майкрософт
description: Узнайте, как настроить участие клиентов Dynamics 365 для управления интересами из Microsoft AppSource и Azure Marketplace.
author: qianw211
...
* Права администратора в экземпляре взаимодействия с клиентом Dynamics 365, чтобы иметь возможность установить решение.
* Права администратора клиента на создание новой учетной записи службы для службы интересов, используемой для отправки интересов из коммерческих предложений Marketplace.
