...
Выбранные вами ценовые категории устанавливают цену продажи во всех странах и регионах, которые вы выбрали для распространения своего предложения. Вы также можете использовать дополнительные функции ценообразования, такие как выбор разных цен для разных рынков.

Вы можете предложить свое приложение бесплатно или выбрать цену, которую клиенты должны заплатить, чтобы получить ваше предложение. Ценовые категории начинаются с 0,99 долларов США, а далее используются шаги приращения (1,09 долларов США, 1,19 долларов США и т. д.). Шаги приращения между ценовыми категориями увеличиваются по мере увеличения цены.

> [!NOTE] 
> Эти ценовые категории также применяются ко всем дополнениям, которые предлагаются в рамках вашего предложения.

Каждая ценовая категория имеет соответствующее значение в каждой из валют, предлагаемых Магазином. Мы используем эти значения, чтобы помочь вам продавать предложение по сопоставимым стандартным ценам по всему миру. Однако из-за изменений в курсах иностранных валют точная сумма продаж в разных валютах может немного отличаться.

Вы также можете ввести произвольную цену по своему выбору в местной валюте конкретного рынка. Если вы это сделаете, цена не будет корректироваться (даже при изменении курсов валют), пока вы не отправите обновление с новой ценой. 

Следует помнить, что выбранная вами цена может включать в себя налог с продаж или НДС, который должен оплачиваться вашими клиентами. Подробные сведения см. в разделе [Сведения о налогах для платного предложения](tax-details-paid-transactions.md).
