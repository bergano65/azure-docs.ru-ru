...
![Показано использование флажка "Использовать Стандартный контракт для коммерческой платформы корпорации Майкрософт".](./media/iot-edge-module-creation/iot-edge-module-standard-contract-checkbox.png)
