...
- [Призыв к действию по отношению к уникальным посетителям, пришедшим по призыву](#call-to-action-versus-unique-visitors-with-ctas)
...
Это число представляет количество нажатий кнопки **призыва к действию** на странице предложения (странице сведений о продукте). **Призывы к действию** считаются при нажатии кнопок **Получить сейчас**, **Попробовать бесплатно**, **Обратный звонок** и **Тест-драйв**.
