...
Если вы выбрали **Добавить** выше, то в этом месте будет отправлен файл пакета вашего предложения вместе с файлами пакета для любого расширения, в котором у него есть зависимости.
...
Требуется, если ваше предложение должно быть установлено вместе с другим расширением, которое уже Опубликовано в Marketplace. Если это так, отправьте свое приложение или ZIP-файл здесь.
...
Необходимо передать PDF-файл со списком сценариев использования ключа предложения в документе (формат PDF). Все сценарии, перечисленные здесь, могут быть проверены нашей группой проверки перед утверждением вашего предложения для Marketplace.

### <a name="app-tests-automation"></a>Автоматизация тестов приложений

Кроме того, необходимо отправить файл **автоматизации тестов приложения** (. app).
