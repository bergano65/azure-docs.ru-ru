...
- **Сведения о доступе** (требуются для Azure Resource Manager и логических тестовых накопителей): Объясните, что нужно узнать клиенту для доступа к тестовому диску и его использования. Рассмотрим сценарий использования вашего предложения и точно то, что должен знать клиент для доступа к функциям на протяжении всего тестового диска. В этом поле можно указать до 10 000 символов текста.
