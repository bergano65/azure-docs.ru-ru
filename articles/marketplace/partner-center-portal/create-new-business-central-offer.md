...
* **Надстройка** — приложение-надстройка расширяет возможности и существующие функции Dynamics 365 Business Central. Подробные сведения см. в разделе [Приложения-надстройки](/dynamics365/business-central/dev-itpro/developer/readiness/readiness-add-on-apps).
