...
- [Создание единых идентификаторов ресурсов (URI) для каждого VHD](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal/virtual-machine/cpp-get-sas-uri)
