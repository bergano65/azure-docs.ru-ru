...
* Выполните все требования предложения по [продаже через предложение Майкрософт](./create-new-saas-offer.md#sell-through-microsoft) , как описано в подокне [Создание предложения SaaS](./create-new-saas-offer.md).
...
Затем предложение SaaS можно интегрировать с API- [интерфейсами службы измерения Marketplace](./marketplace-metering-service-apis.md) , чтобы сообщить корпорации Майкрософт о оплачиваемых мероприятиях.
...
Например, contoso — это издатель с службой SaaS, именуемый Contoso Notification Services (CNS). CNS позволяет своим клиентам отправлять уведомления с помощью электронной почты или текста. Contoso регистрируется как издатель в центре партнеров, чтобы программа коммерческого рынка опубликовала предложения SaaS для клиентов Azure.  С параметром CNS связаны два плана, описанные ниже.
...
Как и в случае с фиксированной ставкой, цены на измерения выставления счетов можно задать для каждой поддерживаемой страны или региона. Издатель должен использовать функцию импорта и экспорта данных о ценах в центре партнеров.

1. Сначала определите нужные измерения и отметьте, какие рынки поддерживаются. 
1. Затем экспортируйте эти данные в файл.
...
[![Измерения службы измерений Marketplace](./media/metering-service-dimentions.png "Щелкните для увеличения представления")](./media/metering-service-dimentions.png)
