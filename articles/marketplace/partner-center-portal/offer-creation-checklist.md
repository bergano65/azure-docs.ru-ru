---
title: Контрольный список для создания предложений SaaS — коммерческая платформа для Azure
description: Сведения, которые можно указать в процессе создания предложения SaaS. — Коммерческая платформа для Azure
author: dsindona
ms.author: dsindona
...
| Логотипы Store (малый, средний, крупный, широкий, главный имиджевый баннер)  | Малый (48 × 48) и крупный (216 × 216) являются обязательными; другие размеры необязательны, но рекомендуются: средний (90 × 90), широкий (255 × 115), главный имиджевый баннер (815 × 290). Должен иметь формат PNG. |
