...
ms.locfileid: "88815357"
---
# <a name="saas-offer-creation-checklist-in-partner-center"></a>Контрольный список создания предложения SaaS в центре партнеров

Процесс создания предложения SaaS занимает несколько страниц.  В этой статье описываются сведения, которые можно указать на каждой странице, а также ссылки на дополнительные сведения о каждом элементе.
...
Элементы, которые требуется указать или указать, указаны ниже.  Некоторые области являются необязательными или имеют значения по умолчанию, которые можно изменить на свое усмотрение.  Вам не требуется работать с этими разделами в том порядке, который указан здесь.
...
| [Страница списка предложений](#offer-listing-page) | Укажите сведения для отображения в Marketplace, включая описания вашего предложения и маркетинговые ресурсы.|
| [Страница предварительного просмотра](#preview-page) | Определите ограниченную аудиторию предварительного просмотра для выпуска предложения перед публикацией предложения для более широкой аудитории Marketplace.|
| [Страница технической конфигурации](#technical-configuration-page)  |  Доступно только при продаже предложения через корпорацию Майкрософт.  Укажите технические сведения (URL-адрес целевой страницы, URL-адрес веб-перехватчика подключения, идентификатор клиента Azure AD и идентификатор приложения Azure AD), используемого Marketplace для подключения к вашему предложению.  Эти параметры необходимы для правильной интеграции с выполнением SaaS и интерфейсами API тарифного счета Marketplace.|
| [**Модальный новый план**](#plan-identity-modal) | Собирает сведения об удостоверении плана.  |
| [Страница «плановый список»](#plan-listing-page)  | Доступно только при продаже предложения через корпорацию Майкрософт. Укажите сведения, используемые для описания плана в Marketplace.  |
| [Страница "цены и доступность плана"](#plan-pricing-and-availability-page)  | Доступно только при продаже предложения через корпорацию Майкрософт.  Собирает сведения о бизнес-характеристиках (модель ценообразования), аудитории и доступности рынка для каждого плана (версии) вашего предложения.  |
| [Страница списка тестовых дисков](#test-drive-listing-page)  | Доступно, только если вы решили предоставлять тестовый выпуск своего предложения. Укажите сведения, используемые для описания тестового выпуска в Marketplace.  |
...
| [Страница "Проверка и публикация"](#review-and-publish-page)  | Выберите изменения, которые хотите опубликовать, просмотрите состояние каждой страницы и предоставьте заметки для службы сертификации.  |
|
...
| Псевдоним предложения  | Обязательно |
|
...
| Интересы клиентов — подключение к системе CRM | Требуется при продаже через корпорацию Майкрософт или при описании предложения вида "Свяжитесь со мной". По умолчанию: система CRM не подключена. Параметры CRM: Таблица Azure, большой двоичный объект Azure, Dynamics CRM Online, HTTPs "Endpoint, Marketo, Salesforce.  |
|
...
| URL-адрес политики конфиденциальности  | Обязательно |
| URL-адрес маркетинговых материалов программы CSP  | Необязательно |
| Полезные ссылки (заголовок + URL-адрес)  | Необязательно |
...
| Логотипы в магазине (мелкий, средний, крупный)  | Требуется большой логотип (от 216 x 216 до 350 x 350 ПКС). Центр партнеров будет использовать его для создания небольшой эмблемы (48 x 48 пикселей) и средней (90 x 90 ПКС) логотипа. При необходимости можно заменить их другими изображениями позже. Логотипы должны быть в формате PNG. |
...
| URL-адрес службы поддержки  | Обязательно |
|
...
## <a name="plan-pricing-and-availability-page"></a>Страница "цены и доступность плана"
...
| Имя поля | Примечания |
| ---------------- | -----------|
| Заметки по сертификации  | Необязательно |
|
