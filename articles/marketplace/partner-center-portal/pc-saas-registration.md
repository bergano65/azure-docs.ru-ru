...
|  --------------   | ------------ |  ------------------------------------------------- |
|  Content-Type     | True         | Связанный с этим запросом тип содержимого. По умолчанию используется значение `application/x-www-form-urlencoded`.  |
|  |  |  |
...
| -----------------   | -----------  | ------------------------------------------------------------------------- |
|  Grant_type         | True         | Тип предоставления разрешения. По умолчанию используется значение `client_credentials`.                    |
...
|  Ресурс           | True         |  Целевой ресурс, для которого запрашивается токен. По умолчанию используется значение `62d94f6c-d599-489b-a797-3e10e42fbe22`. |
|  |  |  |
