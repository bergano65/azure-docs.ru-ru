...
|  Имя свойства     |  Требуется         |  Описание |
|  ---------------   |  ---------------  | ------------ |
|  `grant-type`      |  True      |  Тип предоставления разрешения. Используйте `"client_credentials"`. |
