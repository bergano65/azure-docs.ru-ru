...
|  Имя параметра    |  Обязательное значение         |  Описание |
|  ---------------   |  ---------------  | ------------ |
|  `tenantId`        |  Да      |  Идентификатор клиента зарегистрированного приложения AAD. |

##### <a name="request-header"></a>*Заголовок запроса*

|  Имя заголовка       |  Обязательное значение         |  Описание |
|  ---------------   |  ---------------  | ------------ |
|  `content-type`    |  Да      |  Связанный с этим запросом тип содержимого. Значение по умолчанию — `application/x-www-form-urlencoded`. |

##### <a name="request-body"></a>*Текст запроса*

|  Имя свойства     |  Обязательное значение         |  Описание |
|  ---------------   |  ---------------  | ------------ |
|  `grant-type`      |  Да      |  Тип предоставления разрешения. Используйте `"client_credentials"`. |
