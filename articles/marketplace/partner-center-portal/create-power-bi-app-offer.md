...
3. На странице «Обзор» выберите **+ Новое предложение** > **Приложение службы Power BI**.
   ...
   ![Отображается меню навигации слева.](./media/new-offer-pbi-app.png)
...
Выберите не меньше одной и не больше трех категорий. Категории будут использоваться для размещения вашего предложения в соответствующих областях поиска на Marketplace, а также будут отображаться на странице сведений о вашем предложении. В описании предложения расскажите, как ваше предложение поддерживает эти категории.

### <a name="industry"></a>Отрасль

При необходимости выберите до двух отраслей и двух вертикалей в каждой отрасли. Несмотря на то, что для отображения предложения используются категории, в фильтрах поиска и в онлайн-магазине применяются отрасли и вертикали. Если ваше предложение ориентировано на определенную отрасль и/или вертикаль, в описании предложения укажите, как ваше предложение поддерживает выбранные отрасли или вертикали. Если ваше предложение не зависит от отрасли, не заполняйте этот раздел.

> [!NOTE]
> Поскольку мы постоянно добавляем новые отрасли и вертикали для улучшения процесса поиска предложений, некоторые отрасли или вертикали области могут еще не отображаться в онлайн-магазине. Отрасли и вертикали, помеченные звездочкой (*), будут доступны в будущем. Для поиска по всем опубликованным предложениям можно использовать ключевые слова.
<p>&nbsp;
...
| Государственные организации | *Оборона и разведка<br>* Общественная безопасность и правосудие<br>* Гражданское управление |
| Здравоохранение | *Медицинское страхование<br>* Поставщики медицинских услуг<br>* Фармацевтическая продукция |
| Производство и ресурсы | *Химия и агрохимия<br>* Дискретное производство<br>* Энергетика |
| Потребительские товары и розничная торговля | *Потребительские товары<br>* Розничные продавцы |
| * Медиаресурсы и коммуникация | *СМИ и индустрия развлечений<br>Телекоммуникации* |
...
| * Гостиничный бизнес и туризм | *Гостиницы и отдых<br>* Транспорт и путешествия<br>* Рестораны и общепит |
| * Другие отрасли государственного сектора | *Лесное хозяйство и рыболовство<br>* Некоммерческие организации |
...
Предоставьте PNG-файлы логотипа вашего предложения в следующих двух размерах:
- **малый** (48 x 48);
- **крупный** (216 x 216).
