...
Чтобы предоставить собственные условия использования, введите текст объемом до 10 000 символов в поле **Условия**. Клиенты должны будут принять эти условия, прежде чем использовать ваше предложение.
