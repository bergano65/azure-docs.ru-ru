...
## <a name="listing-options"></a>Параметры списка
...
- Требуется Azure AD с функцией управления удостоверениями и аутентификацией единого входа. Подробные инструкции см. [в статье Azure AD и предложения SaaS, предоставляемые в коммерческом магазине](azure-ad-saas.md).
...
## <a name="test-drives"></a>Тестовые диски
...
Вы можете добавить или изменить подключение к CRM в любое время во время или после создания предложения. Подробные инструкции см. [в статье управление интересами для коммерческого рынка](lead-management-for-cloud-marketplace.md).
...
- **Ключевые слова поиска** (необязательно): Укажите до трех ключевых слов поиска, которые клиенты могут использовать для поиска вашего предложения в Marketplace. Вам не нужно включать **имя** и **Описание**предложения: этот текст автоматически включается в поиск.
...
- **Контактные данные**. необходимо назначить следующие контакты из вашей организации:
  ...
  - **Контактное лицо по проектированию**: укажите имя, Телефон и адрес электронной почты, которые будут использоваться корпорацией Майкрософт непосредственно при возникновении проблем с вашим предложением. Эти контактные данные отсутствуют в Marketplace.
...
> [!Note]
> Ваше предложение должно соответствовать общим [политикам сертификации коммерческого рынка](https://docs.microsoft.com/legal/marketplace/certification-policies#100-general) и [программному обеспечению как политики службы](https://docs.microsoft.com/legal/marketplace/certification-policies#1000-software-as-a-service-saas) для публикации в коммерческом магазине.
