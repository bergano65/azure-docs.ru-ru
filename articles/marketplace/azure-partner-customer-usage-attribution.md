...
1. Зарегистрируйтесь как [коммерческий издатель Azure Marketplace](https://aka.ms/JoinMarketplace).
   ...
   * У каждого партнера должен быть [свой профиль в Центре партнеров](https://docs.microsoft.com/azure/marketplace/become-publisher). Мы рекомендуем вам опубликовать свое предложение в Azure Marketplace или AppSource.
...
1. В поле **GUID** введите созданный GUID отслеживания. Здесь идентификатор GUID вводится без префикса **pid-** . В поле **Description** (Описание) введите произвольное название или описание предложения.
...
Многие решения партнеров развертываются с помощью шаблонов Azure Resource Manager. Если ваш шаблон Resource Manager уже размещен в Azure Marketplace, GitHub или репозитории шаблонов быстрого запуска, вам будет легко изменить этот шаблон, чтобы реализовать отслеживание потребления услуг клиентом.
...
```
Дополнительные сведения см. в описании пакета [Azure SDK для Go](https://docs.microsoft.com/azure/go/).
...
Существует два канала поддержки для проблем разных типов.

Если у вас возникли проблемы в Центре партнеров (например, при просмотре отчета об отслеживании потребления услуг клиентами или при входе), создайте запрос на поддержку в группу поддержки Центра партнеров: [https://partner.microsoft.com/support](https://partner.microsoft.com/support)

![](./media/marketplace-publishers-guide/partner-center-log-in-support.png)

Если вам необходима помощь с подключением к Marketplace или с отслеживанием потребления услуг клиентами в целом (например, вы хотите понять, как настроить этот механизм), воспользуйтесь описанной ниже процедурой.
...
1. Выберите **категорию**, которая соответствует вашей проблеме.
   ...
   - Если у вас возникла проблема с доступом к Azure Marketplace, выберите **Проблема доступа**.
...
Вы также можете обратиться за помощью к техническому консультанту для партнеров Майкрософт по предпродажной работе, развертыванию и разработке приложений, чтобы понять, как реализовать отслеживание потребления услуг клиентами, и внедрить у себя этот механизм.
...
Нет, нельзя. Источником образа виртуальной машины должен быть каталог Azure Marketplace. Подробнее: [https://docs.microsoft.com/azure/marketplace/marketplace-virtual-machines](https://docs.microsoft.com/azure/marketplace/marketplace-virtual-machines).
