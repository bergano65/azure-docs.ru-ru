---
title: Атрибуция партнера Azure и клиентского использования Лазурный рынок
...
- Terraform: Партнеры могут использовать облачный оркестратор, такой как Terraform, для развертывания шаблона управления ресурсами или непосредственного развертывания служб Azure.

Атрибуция использования клиентов предназначена для нового развертывания и не поддерживает пометку существующих ресурсов, которые уже развернуты.

Атрибуция использования клиентов необходима в [Azure Application:](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal/azure-applications/cpp-azure-app-offer)предложение шаблона решений, опубликованное на Azure Marketplace.


[!INCLUDE [updated-for-az](../../includes/updated-for-az.md)]

## <a name="use-resource-manager-templates"></a>Использование шаблонов Resource Manager
Многие партнерские решения развертываются по подписке клиента с помощью шаблонов Resource Manager. Если у вас есть шаблон resource Manager, который доступен в Azure Marketplace, на GitHub или в качестве квикстарта, процесс изменения шаблона для включения атрибуции использования клиентов должен быть прямолинейным.
...
GUIDs должны быть зарегистрированы для того, чтобы атрибуция использования клиентов.

Все регистрации шаблонов GUID проводятся в Partner Center.

После добавления GUID в шаблон или в агент пользователя и регистрации GUID в Partner Center все развертывания отслеживаются.
