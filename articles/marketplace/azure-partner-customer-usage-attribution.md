...
При возникновении проблем в центре партнеров, например при просмотре отчета о сопоставлении использования клиентов или входе в систему, создайте запрос в службу поддержки с помощью группы поддержки центра партнеров: [https://partner.microsoft.com/support](https://partner.microsoft.com/support)
