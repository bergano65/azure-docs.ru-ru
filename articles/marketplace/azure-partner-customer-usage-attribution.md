...
> [!NOTE]
> Если вы публикуете предложение [приложения Azure](./partner-center-portal/create-new-azure-apps-offer.md) в Azure Marketplace через центр партнеров, все новые идентификаторы GUID, используемые в шаблоне, будут автоматически зарегистрированы в вашем профиле центра партнеров при передаче шаблона.  
...
![Снимок экрана со страницей получения поддержки](./media/marketplace-publishers-guide/partner-center-log-in-support.png)
