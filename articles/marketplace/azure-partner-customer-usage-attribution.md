...
1. Вход с использованием учетной записи Майкрософт (MPN учетная запись) или AAD (учетная запись мониторинга партнеров); исходя из журналов в учетных данных, открывает веб-форму запроса: 
