...
[!Note] Требуется учетная запись Azure. Если у вас ее нет, вы будете перенаправлены на страницу **Добро пожаловать в Azure** , чтобы создать ее.  
...
Дополнительные сведения см. в статье [Центр партнеров-получение документации клиентов](./partner-center-portal/commercial-marketplace-get-customer-leads.md) или отправка запроса в службу [https://aka.ms/marketplacepublishersupport](https://aka.ms/marketplacepublishersupport) поддержки посредством выбора типа предложения и управления интересами.
