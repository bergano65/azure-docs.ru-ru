...
Клиенты могут приобрести предложения из Azure Marketplace и Microsoft AppSource с помощью кредитных карт. Если у вас есть подписка Azure, покупки из Azure Marketplace будут использовать метод оплаты, настроенный для учетной записи и отображаемый в том же счете, что и отдельный элемент строки. Некоторые предложения используют денежные обязательства Azure, но большинство покупок оммерЦиал Marketplace не выводят Соглашение Enterprise обязательства, хотя использование инфраструктуры Azure будет.
