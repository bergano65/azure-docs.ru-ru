...
* [Руководство разработчика активного каталога Azure](https://docs.microsoft.com/azure/active-directory/develop/active-directory-developers-guide)
...
Сертификация интеграции Azure AD несколькими способами, в зависимости от того, является ли приложение однотенантным или мультитенантным, и являетесь ли вы новичок в federated AD Azure AD (SSO) или уже поддерживаете его.  
...
- Цена и счет услуги на квартиру (ежемесячно или ежегодно), или по ставке на пользователя.
- Предоставьте способ обновления или отмены услуги в любой момент.
Коммерческие транзакции хранятся в корпорации Майкрософт. Корпорация Майкрософт выставляет счета вашим клиентам от вашего имени. Чтобы предложить Приложение SaaS в качестве подписки, необходимо интегрироваться с AAS-AAP.  Ваш сервис должен поддерживать предоставление, обновление и отмену.

| Требование | Сведения |  
|:--- |:--- |  
|Выставление счетов и ценообразование | Ваше предложение оценивается в зависимости от выбранной модели ценообразования перед публикацией (плоская ставка или на пользователя).  При использовании модели фиксированной ставки можно дополнительно включить дополнительные размеры, используемые для взимания платы с клиентов за использование, не включенное в фиксированную ставку. |  
