...
Сертификация интеграции с Azure AD в несколько разных способов, в зависимости от того, является ли ваше приложение одним клиентом или мультитенантной базы данных и ли вы новичок в Azure AD федеративного единого входа (SSO), или уже поддерживают.  
