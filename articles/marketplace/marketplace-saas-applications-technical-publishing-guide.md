---
title: Рекомендации по публикации приложений SaaS в Azure Marketplace
...
Приложения SaaS доступны в Microsoft AppSource и Azure Marketplace.  Оба магазина поддерживают списки, пробные версии и предложения Transact.
...
* [Azure Active Directoryное руководством разработчика](https://docs.microsoft.com/azure/active-directory/develop/active-directory-developers-guide)
...
**Для приложений с несколькими клиентами:**  
...
- Отчисление и выставление счетов за обслуживание (по месяцам или ежегодно) или по тарифу на пользователя.
- Предоставьте способ обновления или отмены услуги в любой момент.
Коммерческие транзакции хранятся в корпорации Майкрософт. Корпорация Майкрософт выставляет счета вашим клиентам от вашего имени. Чтобы предложить приложение SaaS в качестве подписки, необходимо интегрироваться с API-интерфейсами выполнения SaaS.  Ваша служба должна поддерживать подготовку, обновление и отмену.

| Требование | Сведения |  
|:--- |:--- |  
|Выставление счетов и ценообразование | Цена на Ваше предложение зависит от модели ценообразования, которую вы выбрали перед публикацией (фиксированная ставка или для каждого пользователя).  При использовании модели с фиксированным тарифом можно дополнительно включить дополнительные измерения, используемые для оплаты использования клиентами, не включенными в фиксированную ставку. |  
...
* Дополнительные сведения см. [в разделе Создание предложения приложения SaaS](./partner-center-portal/create-new-saas-offer.md) .
