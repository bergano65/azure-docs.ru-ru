...
## [Политики и условия Azure Marketplace](./policies-terms.md)
...
### Тестовый выпуск
#### [Что такое тестовый выпуск](./cloud-partner-portal/test-drive/what-is-test-drive.md)
#### [Тестовый выпуск Azure Resource Manager](./cloud-partner-portal/test-drive/azure-resource-manager-test-drive.md)
#### [Размещенный тестовый выпуск](./cloud-partner-portal/test-drive/hosted-test-drive.md)
#### [Тестовый выпуск приложения логики](./cloud-partner-portal/test-drive/logic-app-test-drive.md)
#### [Примеры преобразования для тестового выпуска](./cloud-partner-portal/test-drive/transforming-examples-for-test-drive.md)
#### [Рекомендации по маркетингу](./cloud-partner-portal/test-drive/marketing-and-best-practices.md)
