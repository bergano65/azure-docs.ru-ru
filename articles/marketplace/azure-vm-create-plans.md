...
1. При создании нового предложения выберите **тип поколения** и введите сведения о запрошенном образе:

    :::image type="content" source="./media/create-vm/azure-vm-generations-image-details.png" alt-text="Представление раскрывающегося списка создание.":::

2. Чтобы добавить еще одно поколение в план, выберите **Добавить поколение** :

    :::image type="content" source="./media/create-vm/azure-vm-generations-add.png" alt-text="Представление раскрывающегося списка создание.":::

    Затем введите сведения о поколении:

    :::image type="content" source="./media/create-vm/azure-vm-generations-details.png" alt-text="Представление раскрывающегося списка создание.":::

    Выбранный **идентификатор поколения** будет отображаться для клиентов в таких местах, как URL-адреса продуктов и шаблоны ARM (если применимо). Используйте только строчные буквы, алфавитно-цифровые символы, тире или символы подчеркивания; После публикации его нельзя изменить.

3. Чтобы обновить существующую виртуальную машину с уже опубликованным поколением 1, просто измените сведения на странице **Техническая конфигурация** :

    :::image type="content" source="./media/create-vm/azure-vm-generations-updating.png" alt-text="Представление раскрывающегося списка создание.":::
