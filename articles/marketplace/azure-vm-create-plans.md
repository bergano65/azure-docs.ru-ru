...
1. При создании нового предложения выберите **тип поколения** и введите требуемые сведения:
    ...
    :::image type="content" source="./media/create-vm/azure-vm-generations-image-details-1.png" alt-text="Представление раскрывающегося списка создание.":::
...
-->
3. Чтобы обновить существующую виртуальную машину с уже опубликованным поколением 1, измените сведения на этой странице **технической конфигурации** :
