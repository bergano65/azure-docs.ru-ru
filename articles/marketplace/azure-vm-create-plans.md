...
2. Чтобы добавить еще одно поколение в план, выберите **Добавить поколение** :
    ...
    :::image type="content" source="./media/create-vm/azure-vm-generations-details.png" alt-text="Представление окна сведений о поколении.":::
...
3. Чтобы обновить существующую виртуальную машину с уже опубликованным поколением 1, просто измените сведения на странице **Техническая конфигурация** :
    ...
    :::image type="content" source="./media/create-vm/azure-vm-generations-updating.png" alt-text="Представление страницы &quot;Техническая конфигурация плана&quot;.":::
