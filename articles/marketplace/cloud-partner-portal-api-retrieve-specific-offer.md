...
|-------------|------------------------------------------------------------------------------------------|---------------|
| publisherid | publisherId Например, Contoso                                                        | Тип String        |
| offerId     | Глобальный уникальный идентификатор уникально идентифицирующий предложение.                                                 | Тип String        |
| version     | Версия извлекаемого предложения. По умолчанию извлекается последняя версия предложения. | Тип Integer       |
