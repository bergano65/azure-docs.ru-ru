...
description: Инструкции по настройке приложения на Портале Cloud Partner.
...
Это краткая сводка по ценности вашего предложения. Она будет отображаться на странице поиска вашего предложения. Длина не должна превышать 100 символов.
