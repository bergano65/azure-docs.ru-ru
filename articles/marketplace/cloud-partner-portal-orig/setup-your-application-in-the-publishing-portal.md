...
### <a name="app-type"></a>Тип приложения
...
Выберите языки, которые поддерживает приложение. Если приложение поддерживает дополнительные языки, которых нет в этом списке, опубликуйте предложение и отправьте нам сообщение по адресу: [appsource@microsoft.com](mailto:appsource@microsoft.com) , чтобы сообщить нам о них.
...
* [таблице Azure](./cloud-partner-portal-lead-management-instructions-azure-table.md)
