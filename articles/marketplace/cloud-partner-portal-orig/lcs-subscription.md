---
title: Подписка LCS | Документация Майкрософт
...
**Microsoft Azure Active Directory** входит в облачную среду и помогает управлять пользователями, группами, ролями безопасности и лицензиями для интерактивных приложений способом, похожим на управление ими для локальных сред.
