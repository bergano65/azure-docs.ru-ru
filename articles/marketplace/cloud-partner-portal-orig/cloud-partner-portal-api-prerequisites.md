---
title: Предпосылки API Лазурный рынок
...
-   **Идентификатор приложения**. Чтобы найти этот идентификатор, перейдите на [портал Azure,](https://portal.azure.com)нажмите **Azure Active Directory,** выберите **регистрацию приложений**и нажмите на приложение.
