...
|  Определение     | Содержит итоговое представление о фактическом определении рабочей нагрузки. Чтобы получить подробное определение, используйте API [получить специальное предложение] (./cloud-partner-portal-api-retrieve-specific-offer.md). |
...
|  NotStarted                  | Предложения — новое, но не запущеное.                 |
