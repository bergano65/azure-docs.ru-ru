...
|  notificationEmails   | Успокоились для предложений, перенесенных в Партнерский центр. Уведомления по электронной почте для мгновенных предложений будут отправлены на электронную почту, указанную в контактной информации Продавца в настройках учетной записи.<br><br>Для немиграционных предложений список адресов электронной почты, разделенных запятой, должен быть уведомлен о ходе операции        |
|  |  |
