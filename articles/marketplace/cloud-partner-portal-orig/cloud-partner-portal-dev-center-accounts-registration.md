---
title: Создание учетной записи разработчика Майкрософт (ru) Лазурный рынок
...
| Идентификатор налогового профиля        | Необязательный          | Необязательный      | Необязательный                              | Необходимо             |
| Банковский счет          | Необязательный          | Необязательный      | Необязательный                              | Необходимо             |
...
4. В разделе "Информация о регистрации учетной записи" в раскрывающемся меню выберите **страну или регион учетной записи**, а затем щелкните **Далее**.
   ...
   ![Выбор страны или региона](./media/cloud-partner-portal-create-dev-center-registration/imgRegisterCo_04.png)
    ...
    >[!WARNING]
    >"Продажа из" Стран/Регионов: Для того, чтобы продать свои услуги на Azure Marketplace, зарегистрированная организация должна быть в одной из утвержденных стран/регионов продажи/регионов, указанных в списке отсевов. Это ограничение связано с выплатами и налогообложением. Дополнительные сведения см. в описании политик участия в Marketplace.
...
1.  Перейдите к [ссылке поддержки](https://developer.microsoft.com/windows/support).
