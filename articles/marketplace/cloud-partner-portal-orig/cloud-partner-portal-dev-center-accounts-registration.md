...
| Профиль разработчика     | Запуск черновой версии    | Поэтапное создание       | Бесплатная публикация и шаблон решения   | Коммерческая публикация   |
|---------------------- |----------------   |-----------    |-------------------------------------  |---------------------  |
...
1.  Перейдите по [ссылке Поддержка](https://developer.microsoft.com/windows/support).
