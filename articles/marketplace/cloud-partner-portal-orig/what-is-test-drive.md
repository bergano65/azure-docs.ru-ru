...
- **[Приложение логики](./logic-app-test-drive.md)**. Тестовый выпуск приложения логики — это шаблон развертывания, который должен охватывать все сложные архитектуры решений. Для всех приложений Dynamics или пользовательских продуктов следует использовать этот тип тестового выпуска.
- **Power BI**. Тестовый выпуск Power BI — это просто внедренная ссылка на настраиваемую панель мониторинга. Для любого продукта, в котором нужна просто демонстрация интерактивной визуализации Power BI, следует использовать этот тип тестового выпуска.
