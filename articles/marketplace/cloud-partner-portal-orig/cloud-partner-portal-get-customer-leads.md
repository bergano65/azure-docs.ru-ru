...
Формат для ведущего источника —**Предложение** **действий** |   **источника**-
...
На следующих примерах приводятся уникальные идентификаторы, которые присваиваются издателю, и конкретное предложение: checkpoint.check-point-r77-10sg-byol, bitnami.openedxcypress и docusign.3701c77e-1cfa-4c56-91e6-3ed0b622145a.
