---
title: Получение API конкретное предложение | Azure Marketplace
...
|-------------|------------------------------------------------------------------------------------------|---------------|
| publisherid | publisherId Например, Contoso                                                        | String        |
| offerId     | Глобальный уникальный идентификатор уникально идентифицирующий предложение.                                                 | String        |
| версия     | Версия извлекаемого предложения. По умолчанию извлекается последняя версия предложения. | Integer       |
