---
title: Определение параметра публикации в Azure Marketplace | Azure Marketplace
...
| [**Службы консультации**](https://docs.microsoft.com/azure/marketplace/consulting-services) | Консультационные услуги помогают подключать клиентов со службами для поддержки и расширения возможностей использования служб Azure, Dynamics 365 или Power Suite.|
