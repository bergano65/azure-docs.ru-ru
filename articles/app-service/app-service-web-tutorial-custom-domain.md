...
Чтобы добавить личный домен в приложение, необходимо проверить его принадлежность к домену, добавив идентификатор проверки в качестве записи в формате TXT в поставщике домена. В левой области навигации колонки страницы приложения щелкните **Личные домены** в разделе **Параметры**. Скопируйте отсюда значение идентификатора проверки личного домена. Этот идентификатор проверки подлинности необходим для следующего шага.
