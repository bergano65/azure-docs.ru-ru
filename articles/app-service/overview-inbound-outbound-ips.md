...
- Удаление существующей привязки SSL, например во время обновления сертификата (см. статью об [обновлении сертификата](configure-ssl-certificate.md#renew-certificate)).
...
Набор всех возможных исходящих IP-адресов, которые может использовать приложение, независимо от ценовых категорий, путем поиска свойства `possibleOutboundIpAddresses` или в поле **Дополнительные исходящие IP-адреса** в колонке **свойства** в портал Azure. См. также раздел [Поиск исходящих IP-адресов](#find-outbound-ips).
