...
> [!NOTE]
> В настоящее время ASP.NET Core не поддерживает заполнение текущего пользователя с помощью функции проверки подлинности и авторизации.
>
...
> [!NOTE]
> Проверка подлинности или авторизация ранее называлась простой проверкой подлинности.
>
