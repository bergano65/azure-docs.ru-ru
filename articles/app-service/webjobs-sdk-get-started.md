...
1. В диалоговом окне **Добавить сообщение** введите *Здравствуй, мир!* в поле **Текст сообщения**, а затем нажмите кнопку **OK**.
...
1. Откройте сценарий *Program.cs* и добавьте инструкцию `using` для диспетчера конфигурации:

   ```csharp
   using System.Configuration;
   ```

1. Замените код в методе `Main` следующим кодом:
