---
title: Общие сведения о безопасности Службы приложений Azure | Документация Майкрософт
...
Дополнительные сведения см. [в статье Добавление SSL-сертификата в службу приложений Azure](configure-ssl-certificate.md).
