...
Для службы приложений в Windows можно также динамически ограничить IP-адреса, настроив _web.config_. Дополнительные сведения см. в разделе [Dynamic IP \<dynamicIpSecurity> Security ](https://docs.microsoft.com/iis/configuration/system.webServer/security/dynamicIpSecurity/).
