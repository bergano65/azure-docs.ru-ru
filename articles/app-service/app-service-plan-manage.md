---
title: Управление планом службы приложений
description: Узнайте, как выполнять различные задачи по управлению планом службы приложений, например создание, перемещение, масштабирование и удаление.
...
1. В [портал Azure](https://portal.azure.com)найдите и выберите **службы приложений** и выберите приложение, которое требуется переместить.
...
Сведения о развертывании числа экземпляров приложения вы найдете в статье [Масштабирование числа экземпляров вручную или автоматически](../azure-monitor/autoscale/autoscale-get-started.md).
