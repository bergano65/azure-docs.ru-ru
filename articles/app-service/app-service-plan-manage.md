...
2. Выберите или создайте план службы приложений для нового приложения.
   ...
   В. В поле **Расположение** выберите соответствующее расположение.

   Г. Из списка **Ценовая категория** выберите соответствующую категорию для службы. Щелкните **Просмотреть все**, чтобы просмотреть другие варианты тарификации, например **Бесплатный** и **Общий**. После выбора ценовой категории нажмите кнопку **Выбрать** .
...
1. В меню найдите раздел **План службы приложений**.

1. Щелкните **Изменить план служб приложений**, чтобы открыть селектор **План службы приложений**.

   ![Селектор планов службы приложений.][change] 

1. В селекторе **План служб приложений** выберите существующий план, в который вы хотите переместить это приложение.   

На странице **Select App Service plan** (Выбор плана службы приложений) показаны только планы, которые находятся в той же группе ресурсов и географическом регионе, что и текущий план службы приложений приложения.
