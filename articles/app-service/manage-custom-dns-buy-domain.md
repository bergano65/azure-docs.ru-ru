...
|-|-|-|
|Защита личных сведений | Включение | Дайте согласие на защиту личных сведений, которая входит в стоимость покупки _бесплатно_. Некоторыми доменами верхнего уровня управляют регистраторы, которые не поддерживают защиту личных сведений. Они перечислены на странице **Защита личных сведений**. |
...
Если вы решили не назначать имена узлов по умолчанию для приложения в процессе покупки или хотите назначить имя узла, которое отсутствует в списке, это можно сделать в любое время.
...
[FAQ: App Service Domain and Custom Domains (Домен Службы приложений (предварительная версия) и личные домены)](https://blogs.msdn.microsoft.com/appserviceteam/2017/08/08/faq-app-service-domain-preview-and-custom-domains/)
