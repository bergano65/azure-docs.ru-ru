...
Пути исключения можно настроить, выбрав **Configuration**  >  **Общие параметры** конфигурации и определив путь исключения. В этом примере все, что находится в разделе `/public` path для вашего приложения, не запрашивает сертификат клиента.
