...
|Тип|Платформа|Location|Description|
|-|-|-|-|
...
| Тип журнала | Каталог | Description |
|-|-|-|
...
| Тип журнала | Поддержка Windows | Поддержка Linux (DOCKER) | Description |
|-|-|-|
| аппсервицеконсолелогс | тба | Да | Стандартный вывод и стандартная ошибка |
...
| аппсервицефилеаудитлогс | тба | Да | Изменения файлов с помощью FTP и KUDU |
