...
|-|-|-|-|-|-|
| аппсервицеконсолелогс | Java SE & Tomcat | Да | Да | Да | Стандартный вывод и стандартная ошибка |
| аппсервицехттплогс | Да | Да | Да | Да | Журналы веб-сервера |
