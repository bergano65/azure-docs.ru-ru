...
> [!NOTE]
> В дополнение к инструкциям по ведению журнала в этой статье есть новая интегрированная возможность ведения журнала с помощью мониторинга Azure. Эта возможность находится на странице [журналы и параметры диагностики (Предварительная версия)](https://aka.ms/appsvcblog-azmon). 
>
>

|Тип|Платформа|Расположение|Description (Описание)|
|-|-|-|-|
...
| Тип журнала | Каталог | Description (Описание) |
|-|-|-|
