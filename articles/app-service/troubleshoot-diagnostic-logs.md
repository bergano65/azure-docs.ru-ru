...
|**Подробная информация** | "Трассировка", "Отладка", "Информация", "Предупреждение", "Ошибка", "Критические" (все категории) |
|-|-|
...
* [Мониторинг службы приложений Azure](web-sites-monitor.md)
* [Устранение неполадок службы приложений Azure в Visual Studio](troubleshoot-dotnet-visual-studio.md)
* [Анализ журналов приложений в HDInsight](https://gallery.technet.microsoft.com/scriptcenter/Analyses-Windows-Azure-web-0b27d413)
