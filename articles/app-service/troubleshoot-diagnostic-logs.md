...
|-|-|-|-|-|-|
| аппсервицеконсолелогс | TBA | TBA | Да | Да | Стандартный вывод и стандартная ошибка |
| аппсервицехттплогс | Да | TBA | Да | Да | Журналы веб-сервера |
...
| аппсервицеаудитлогс | Да | TBA | Да | Да | Действия входа через FTP и KUDU |
| аппсервицефилеаудитлогс | Да | TBA | TBA | TBA | Изменения файлов, внесенные в содержимое сайта; доступно только для уровня "Премиум" и более поздних версий |
| аппсервицеапплогс | ASP.NET | TBA | Java SE & Tomcat | Java SE & Tomcat | Журналы приложений |
| аппсервицеипсекаудитлогс  | Да | TBA | Да | Да | Запросы из правил IP-адресов |
| аппсервицеплатформлогс  | TBA | TBA | Да | Да | Журналы операций контейнера |
