...
| аппсервицефилеаудитлогс | Да | TBD | Изменения файлов, внесенные в содержимое сайта; доступно только для уровня "Премиум" и более поздних версий |
