...
Если [Операция переключения](#AboutConfiguration) занимает много времени, можно получить сведения об операции переключения в [журнале действий](../azure-monitor/platform/platform-logs-overview.md).
