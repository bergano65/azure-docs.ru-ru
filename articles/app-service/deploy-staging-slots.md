...
Найдите и выберите свое приложение. Выберите слот **слоты** > *\<развертывания, чтобы удалить>*  >  **Обзор**. Тип приложения отображается как **служба приложений (слот)** , чтобы напомнить вам, что вы просматриваете слот развертывания. На панели команд выберите **Удалить** .  
