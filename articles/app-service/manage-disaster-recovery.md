...
1. На странице **Восстановление резервной копии** настройте операцию восстановления в соответствии со следующей таблицей. По окончании нажмите кнопку **ОК**.
