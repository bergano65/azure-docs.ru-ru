...
description: Узнайте, как восстановить приложение из моментального снимка. Восстановление после неожиданной потери данных в уровне Premium с автоматическими теневыми копиями.
...
1. На странице **«Настройки»** приложения на [портале Azure](https://portal.azure.com)нажмите **кнопку «Резервное копирование»** для отображения **страницы резервного копирования.** Щелкните здесь **Восстановить** в разделе **Моментальный снимок (предварительная версия)**.
