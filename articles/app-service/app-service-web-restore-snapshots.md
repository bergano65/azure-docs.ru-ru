...
1. На **портале Azure** на странице [Параметры](https://portal.azure.com) для приложения щелкните **Резервные копии**. Откроется страница **Резервные копии**. Щелкните здесь **Восстановить** в разделе **Моментальный снимок (предварительная версия)** .
