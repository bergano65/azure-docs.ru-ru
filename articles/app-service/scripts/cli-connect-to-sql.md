...
| [`az sql db create`](/cli/azure/sql/db#az-sql-db-create) | Создает новую базу данных. |
| [`az sql db show-connection-string`](/cli/azure/sql/db#az-sql-db-show-connection-string) | Создание строки подключения к базе данных. |
