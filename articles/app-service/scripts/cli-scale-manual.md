---
title: Пример сценария Azure CLI. Масштабирование приложения вручную с помощью Azure CLI | Документация Майкрософт
description: Пример сценария Azure CLI. Масштабирование Службы приложений вручную с помощью Azure CLI
services: appservice
