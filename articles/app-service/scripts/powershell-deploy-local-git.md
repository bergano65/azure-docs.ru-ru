---
title: Пример сценария Azure PowerShell. Создание и развертывание веб-приложения из локального репозитория GitHub | Документация Майкрософт
