...
>
> Точно так же можно добавить любые действия развертывания в службе приложений на основе Git. См. подробнее о [запуске средства создания](configure-language-php.md#run-composer).
>
