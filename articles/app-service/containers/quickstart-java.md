...
> [!NOTE]
>
> То же самое можно выполнить с помощью популярных интегрированных сред разработки, например IntelliJ, Eclipse и VS Code. См. руководства по [Azure Toolkit for IntelliJ](/azure/developer/java/toolkit-for-intellij/create-hello-world-web-app), [Azure Toolkit for Eclipse](/azure/developer/java/toolkit-for-eclipse/create-hello-world-web-app) и [VS Code](https://code.visualstudio.com/docs/java/java-webapp).
>
