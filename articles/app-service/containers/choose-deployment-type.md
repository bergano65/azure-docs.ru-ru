...
description: Решите между пользовательским развертыванием контейнеров Docker, мультиконтейнером и встроенной платформой приложений для Службы приложений на Linux.
...
- **Развертывание нескольких контейнеров:**"Докеризировать" приложение в нескольких контейнерах с помощью файла конфигурации Docker Compose.
...
Следующие статьи вы начинаете с App Service на Linux со встроенным изображением платформы:
