...
Отправьте скрипт запуска в каталог `/home/site/deployments/tools` своего экземпляра Службы приложений. См. инструкции по [получению учетных данных FTP](/azure/app-service/app-service-deployment-credentials#userscope). 
