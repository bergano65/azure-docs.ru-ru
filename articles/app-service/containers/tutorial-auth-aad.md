---
title: Руководство по проверке подлинности пользователей E2E (Linux)
description: Узнайте, как использовать проверку подлинности и авторизацию в Службе приложений для комплексной защиты приложений Службы приложений в Linux, включая доступ к удаленным API.
