...
## <a name="view-logs-to-troubleshoot-the-app"></a>Просмотр журналов для устранения неполадок приложения

Включите ведение журналов для развернутого веб-приложения Java в службе приложений на платформе Linux:
...
Затем передайте журналы веб-приложения в терминал:
...
Вы увидите последние строки выходных данных, и по мере поступления новых запросов в приложение со списком задач они будут передаваться на консоль. Чтобы выйти из консоли, используйте сочетание клавиш CTRL+C.
