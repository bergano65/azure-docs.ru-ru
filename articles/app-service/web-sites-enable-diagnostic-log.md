...
> [!NOTE]
> Если компонент Azure PowerShell не установлен или не настроен для использования подписки Azure, ознакомьтесь с разделом [Использование Azure PowerShell](https://azure.microsoft.com/develop/nodejs/how-to-guides/powershell-cmdlets/).
>
>
