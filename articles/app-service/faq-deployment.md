...
Учебник [Создать свой первый ASP.NET веб-приложение в Azure в течение пяти минут](app-service-web-get-started-dotnet.md) показывает вам, как развернуть ASP.NET веб-приложения для веб-приложения в App Service с помощью Visual Studio.
...
Если вы видите это сообщение, вполне вероятно, что вы столкнулись с дисковой квотой в плане обслуживания для вашего веб-приложения. Возможно, вам потребуется выбрать более высокий уровень служб в зависимости от необходимого дискового пространства. Дополнительные сведения о ценах на планы и ограничениях ресурсов см. на [этой странице](https://azure.microsoft.com/pricing/details/app-service/).
...
1. Убедитесь, что вы вводите правильное имя и учетные данные. Подробные сведения о различных типах учетных данных и способе их использования см. в статье [Deployment credentials](https://github.com/projectkudu/kudu/wiki/Deployment-credentials) (Учетные данные развертывания).
