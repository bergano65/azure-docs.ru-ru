...
description: Узнайте, как управляемые удостоверения работают в службе приложений Azure и функциях Azure, как настроить управляемое удостоверение и создать маркер для ресурса серверной части.
