...
Чтобы отключить незашифрованный протокол FTP, выберите **Только FTPS**. Чтобы полностью отключить FTP и FTPS, выберите **Отключить**. По завершении щелкните **Сохранить**. При использовании параметра **Только FTPS** необходимо принудительно использовать протокол TLS 1.2 или более поздней версии, перейдя к колонке **Параметры SSL** своего веб-приложения. Протоколы TLS 1.0 и 1.1 не поддерживаются для параметра **Только FTPS**.
