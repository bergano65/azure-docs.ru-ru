---
title: Добавление SSL-сертификатов и управление ими в Службе приложений Azure | Документация Майкрософт
...
После передачи сертификата скопируйте отпечаток сертификата и ознакомьтесь с разделом [Использование SSL-сертификата в коде приложения службы приложений Azure](configure-ssl-certificate-in-code.md#load-the-certificate).
