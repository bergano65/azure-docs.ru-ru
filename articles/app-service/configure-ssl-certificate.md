...
| Политики доступа| Определяет приложения и разрешает доступ к ресурсам хранилища. Ее можно настроить позднее, воспользовавшись сведениями из статьи [Предоставление разрешения на доступ к хранилищу ключей нескольким приложениям](../key-vault/general/group-permissions-for-apps.md). |
