...
| Предоставить мое приложение на частных IP-адресах в моей виртуальной сети | Среда ASE с ILB </br> Использование Шлюза приложений с конечными точками служб |
...
| Балансировка нагрузки трафика в одном регионе | [Шлюз приложений с конечными точками службы][appgwserviceendpoints] | 
