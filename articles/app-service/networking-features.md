...
| Ограничить доступ к моему приложению из ресурсов в виртуальной сети | Конечные точки службы </br> Среда ASE с ILB </br> Частная конечная точка (Предварительная версия) |
| Предоставить мое приложение на частном IP-адресе в виртуальной сети | Среда ASE с ILB </br> частный IP-адрес для входящего трафика в шлюзе приложений с конечными точками службы </br> Конечная точка службы (Предварительная версия) |
| Защита приложения с помощью WAF | Шлюз приложений + ILB ASE </br> Использование Шлюза приложений с конечными точками служб </br> Передняя дверца Azure с ограничениями доступа |
...
### <a name="private-endpoint-preview"></a>Частная конечная точка (Предварительная версия)
...
[Использование частных конечных точек для веб-приложения Azure (предварительная версия)][privateendpoints]
