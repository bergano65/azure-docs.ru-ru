...
1. Укажите данные для входа учетной записи Docker Hub и нажмите кнопку **Сохранить**.
   ...
   ![Снимок экрана: выделено имя репозитория.](./media/quickstart-custom-container/published-docker-repository-vs2019.png)
