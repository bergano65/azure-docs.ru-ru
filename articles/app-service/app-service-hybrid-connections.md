...
- Она поддерживается в общедоступной версии для приложений для Windows и доступна в предварительном режиме для приложений Linux.
...
| Изолированные | 200 на приложение |
