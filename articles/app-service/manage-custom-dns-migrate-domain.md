...
Введите полное доменное имя, которое требуется перенести, соответствующее создаваемой записи TXT, например `contoso.com` , `www.contoso.com` или `*.contoso.com` .
