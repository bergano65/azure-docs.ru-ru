...
![На схеме показано, что Интернет переводится в шлюз приложений в виртуальной сети Azure и перебирается через значок брандмауэра для экземпляров приложений в службе приложений.](./media/app-gateway-with-service-endpoints/service-endpoints-appgw.png)
...
![На снимке экрана показан текст ошибки 403 — это веб-приложение остановлено.](./media/app-gateway-with-service-endpoints/web-site-stopped.png)
