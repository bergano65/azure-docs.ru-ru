...
В этом руководстве речь идет о среде разработки, веб-проекте и Службе приложений, которые вы настроили, следуя инструкциям статьи [Создание веб-приложения ASP.NET Framework в Azure](quickstart-dotnet-framework.md). Для разделов, посвященных веб-заданиям, вам понадобится приложение, созданное при изучении руководства [Начало работы с пакетом SDK для Azure для веб-заданий][GetStartedWJ].
...
## <a name="app-configuration-and-management"></a><a name="sitemanagement"></a>Настройка приложения и управление им
Visual Studio обеспечивает доступ к сокращенному набору функций управления приложением и параметров конфигурации, полный набор которых доступен на [портале Azure](https://go.microsoft.com/fwlink/?LinkId=529715). В этом разделе вы узнаете, какие функции доступны с помощью **обозревателя сервера**. Для просмотра новых функций интеграции Azure также воспользуйтесь **Обозревателем облака** . Оба окна можно открыть в меню **Вид** .
...
## <a name="remote-debugging-apps"></a><a name="remotedebug"></a>Удаленная отладка приложений
...
В этом разделе показано, как удаленно выполнить отладку с помощью проекта, созданного при изучении раздела [Создание веб-приложения ASP.NET Framework в Azure](quickstart-dotnet-framework.md).

1. Откройте веб-проект, созданный после выполнения инструкций статьи [Создание веб-приложения ASP.NET Framework в Azure](quickstart-dotnet-framework.md).
...
## <a name="diagnostic-logs-overview"></a><a name="logsoverview"></a>Обзор журналов диагностики
...
## <a name="create-and-view-application-trace-logs"></a><a name="apptracelogs"></a>Создание и просмотр журналов трассировки приложения
В этом разделе вам нужно выполнить следующие задачи.

* Добавление инструкций трассировки в веб-проект, созданный с помощью руководства по [использованию Azure и ASP.NET](quickstart-dotnet-framework.md).
...
## <a name="view-web-server-logs"></a><a name="webserverlogs"></a>Просмотр журналов веб-сервера
...
## <a name="view-detailed-error-message-logs"></a><a name="detailederrorlogs"></a>Просмотр подробных журналов сообщений об ошибках
...
## <a name="download-file-system-logs"></a><a name="downloadlogs"></a>Загрузка журналов файловой системы
...
14. To look at the details for a single row, double-click one of the rows.
 ...
 -->
## <a name="view-failed-request-tracing-logs"></a><a name="failedrequestlogs"></a>Просмотр журналов неудачно завершенных запросов
