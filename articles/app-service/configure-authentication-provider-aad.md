...
2. На панели навигации слева выберите **Проверка подлинности или авторизация** > **в**.
...
1. В окне **URI перенаправления**выберите **веб** и введите `<app-url>/.auth/login/aad/callback`. Например, `https://contoso.azurewebsites.net/.auth/login/aad/callback`. 
1. Выберите **Создать**.
...
### <a name="secrets"> </a>Включение Azure Active Directory в приложении службы приложений

1. В [портал Azure]найдите и выберите **службы приложений**, а затем выберите свое приложение. 
1. В левой области в разделе **Параметры**выберите **Проверка подлинности или авторизация** > **в**.
...
## <a name="configure-a-native-client-application"></a>Настройка приложения Native Client
