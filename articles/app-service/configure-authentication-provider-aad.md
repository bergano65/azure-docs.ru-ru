...
1. В левой области в разделе **Параметры** выберите **Проверка подлинности/авторизация** и **Убедитесь, что** **Проверка подлинности службы приложений** включена.
1. Выберите **Azure Active Directory**, а затем в разделе **режим управления** выберите **Экспресс**.
...
## <a name="advanced"> </a>Настройка с дополнительными параметрами
...
1. Выберите раздел **Фирменная символика**. В поле **URL-адрес домашней страницы**введите URL-адрес приложения службы приложений и нажмите кнопку **сохранить**.
...
### <a name="secrets"> </a>Добавление Azure Active Directory сведений в приложение службы приложений
