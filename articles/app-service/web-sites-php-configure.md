...
1. Перейдите к своему приложению в [портала Azure](https://portal.azure.com) и прокрутите страницу до **конфигурации** страницы.

2. Из **конфигурации**выберите **Общие параметры** и выберите новую версию PHP.

3. Нажмите кнопку **Сохранить** кнопку в верхней части **Общие параметры** колонке.
...
4. Перейдите к своему приложению на портале Azure и щелкнуть **конфигурации** расположенные **параметры** раздел.
5. Из **конфигурации** колонке **параметры приложения**.
6. В **параметры приложения** щелкните **+ новый параметр приложения** и создайте **PHP_EXTENSIONS** ключ. Значением для этого ключа будет путь относительно корневого веб-сайта: **bin\ваш-внешний-файл**.
7. Нажмите кнопку **обновление** внизу, а затем нажмите кнопку **Сохранить** выше **параметры приложения** вкладки.
...
6. Перейдите к своему приложению на портале Azure и щелкнуть **конфигурации** колонке.
8. Из **конфигурации** колонке **сопоставления путей к**. 
9. Нажмите кнопку **+ новый обработчик** и добавьте `*.php` к расширению поле и добавьте путь к `php-cgi.exe` исполняемого файла в **обработчика скриптов**. Если поместить среду выполнения PHP в каталог `bin` в корне приложения, путь будет выглядеть так: `D:\home\site\wwwroot\bin\php\php-cgi.exe`.
10. В нижней части щелкните **обновление** чтобы завершить Добавление сопоставления обработчика.
