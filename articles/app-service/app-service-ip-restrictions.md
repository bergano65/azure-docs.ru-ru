...
## <a name="adding-ip-address-rules"></a>Добавление правила IP-адресов
...
Конечные точки служб можно настроить приложения с помощью шлюзов приложений или другие устройства WAF. Также можно настроить многоуровневые приложения с безопасной серверных систем. Дополнительные сведения о некоторых возможностей. в статье [сетевые функции и службы приложений](networking-features.md).
