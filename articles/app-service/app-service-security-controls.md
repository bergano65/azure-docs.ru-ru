...
| Шифрование при передаче (например, шифрование ExpressRoute, Шифрование виртуальной сети и шифрование виртуальной сети)| Да | Клиенты могут настраивать веб-сайты так, чтобы требовать и использовать HTTPS для входящего трафика.  | [Как создать только HTTPS для службы приложений Azure](/archive/blogs/benjaminperkins/how-to-make-an-azure-app-service-https-only) (запись блога)
