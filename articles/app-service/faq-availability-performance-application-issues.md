---
title: Часто задаваемые вопросы производительности приложений
description: Получите ответы на часто задаваемые вопросы о доступности, производительности и проблемах приложений в Службе приложений Azure.
author: genlin
...
> [!NOTE]
> Некоторые из приведенных ниже рекомендаций могут работать только на службах Windows или Linux App Services. Например, службы linux App Services работают в 64-битном режиме по умолчанию.
>
...
2. В меню выберите **Debug Console** > **CMD.**
...
4. Выберите **Скачать памяти Дамп** > **Полный Dump**.
...
1. Откройте портал Azure и перейдите к своему веб-приложению.
3. Выберите **все журналы диагностики настроек.** > **Diagnostics Logs**
...
18. В меню выберите **Debug Console** > **CMD.**
...
Чтобы определить, используете ли вы локальный кэш, проверьте **вкладку настроек приложения службы** приложения. При использовании локального кэша `WEBSITE_LOCAL_CACHE_OPTION` настройка `Always`настройки приложения установлена для .
