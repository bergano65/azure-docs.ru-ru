...
Вы можете изменить этот файл напрямую, и Visual Studio предоставит IntelliSense. Схема файла хранится [https://schemastore.org](http://schemastore.org/schemas/json/webjob-publish-settings.json) в и может быть просмотрена там.  
...
Вы можете изменить этот файл напрямую, и Visual Studio предоставит IntelliSense. Схема файла хранится [https://schemastore.org](http://schemastore.org/schemas/json/webjobs-list.json) в и может быть просмотрена там.
