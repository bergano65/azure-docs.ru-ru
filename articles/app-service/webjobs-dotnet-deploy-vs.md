...
Версии 3.x [Azure WebJobs SDK](webjobs-sdk-how-to.md) позволяет разрабатывать веб-заданий, запуск от имени приложений .NET Core или .NET Framework приложениям, тогда как версия 2.x поддерживает только .NET Framework. Для проектов .NET Core и .NET Framework из них отличается способ развертывания проекта веб-заданий.
...
Если вы используете Visual Studio 2019 г., установите [рабочую нагрузку разработки Azure](https://docs.microsoft.com/visualstudio/install/install-visual-studio#step-4---choose-workloads).
