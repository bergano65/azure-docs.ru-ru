---
title: Исправить ошибки HTTP 502 и HTTP 503
...
### <a name="1-observe-and-monitor-application-behavior"></a>1. Наблюдайте и следите за поведением приложений
#### <a name="track-service-health"></a>Мониторинг работоспособности службы
Microsoft Azure информирует о каждом случае прерывания работы или снижения производительности службы. Отслеживание работоспособности службы можно на [портале Azure.](https://portal.azure.com/) Дополнительные сведения см. в статье [Получение информации о работоспособности службы](../monitoring-and-diagnostics/insights-service-health.md).
...
### <a name="3-mitigate-the-issue"></a>3. Смягчить проблему
...
Обычно это самый простой способ восстановления после проблемы, которая возникла один раз. На [портале Azure](https://portal.azure.com/)на лезвии приложения есть варианты остановки или перезапуска приложения.
...
Вы также можете управлять приложением с помощью Azure PowerShell. Для получения дополнительной информации [см.](../powershell-azure-resource-manager.md)
