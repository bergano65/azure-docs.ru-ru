...
description: Узнайте, как настроить аутентификацию Twitter в качестве поставщика идентификационных данных для приложения App Service.
...
---
# <a name="configure-your-app-service-app-to-use-twitter-login"></a>Настройте приложение App Service для использования входа в Twitter

[!INCLUDE [app-service-mobile-selector-authentication](../../includes/app-service-mobile-selector-authentication.md)]

В этой статье показано, как настроить службу приложений Azure для использования Twitter в качестве поставщика аутентификации.
