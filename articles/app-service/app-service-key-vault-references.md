...
> [!NOTE] 
> В настоящее время Key Vault ссылки доступны в предварительной версии, и в настоящее время они не поддерживаются планами потребления Linux.
...
Если синтаксис правильный, можно просмотреть другие причины ошибки, проверив текущее состояние разрешения с помощью встроенного средства обнаружения.
