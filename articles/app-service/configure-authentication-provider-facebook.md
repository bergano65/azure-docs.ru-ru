...
6. В разделе **Вход в Facebook** щелкните **Настройка** и выберите **Параметры** на панели навигации слева.
7. Добавьте **универсальный код ресурса (URI) перенаправления** приложения в поле **Valid OAuth redirect URIs** (Допустимые URI перенаправления OAuth) и щелкните **Сохранить изменения**.
   ...
   > 
   > 
8. На панели навигации слева щелкните **Параметры** > **Базовые**. В поле **Секрет приложения** щелкните **Показать**, при запросе укажите пароль, а затем запишите значения полей **Идентификатор приложения** и **Секрет приложения**. Вы используете их позже, чтобы настроить свое приложение в Azure.
