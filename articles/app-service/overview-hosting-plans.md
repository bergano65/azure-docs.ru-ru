...
- В выделенных уровнях вычислений (**Basic**, **Standard**, **Premium**, **категории премиум v2**) план службы приложений определяет количество экземпляров виртуальных машин, на которые масштабируется приложение, поэтому _каждый экземпляр виртуальной машины_ в плане службы приложений будет оплачен. Плата за экземпляры виртуальной машины является фиксированной, независимо от количества запущенных в них приложений. Чтобы избежать непредвиденных расходов, ознакомьтесь с разделом об [удалении плана службы приложений](app-service-plan-manage.md#delete).
