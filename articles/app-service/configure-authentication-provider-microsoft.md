...
2. Перейдите к [**Регистрация приложений**](https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationsListBlade)и выполните вход с помощью учетная запись Майкрософт по запросу.
...
3. Щелкните **учетную запись Майкрософт**. Вставьте значения идентификатора приложения и пароля, полученные ранее, и при необходимости включите любые области, которые требуются приложению. Затем нажмите кнопку **ОК**.
