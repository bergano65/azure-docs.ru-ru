...
description: Узнайте, как настроить аутентификацию учетной записи Майкрософт в качестве поставщика идентификационных данных для приложения App Service.
...
---
# <a name="configure-your-app-service-app-to-use-microsoft-account-login"></a>Настройте приложение Службы приложения для использования входа в учетную запись Майкрософт

[!INCLUDE [app-service-mobile-selector-authentication](../../includes/app-service-mobile-selector-authentication.md)]

Эта тема показывает, как настроить службу приложений Azure для использования AAD для поддержки личных логинов учетной записи Майкрософт.
