...
Выполните те же действия для серверного приложения, но пропустите последний шаг. Для интерфейсного приложения идентификатор клиента не требуется.
