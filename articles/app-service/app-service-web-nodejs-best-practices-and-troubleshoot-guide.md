...
В [файле исходного кода](https://github.com/Azure/iisnode/blob/master/src/iisnode/cnodeconstants.h) `cnodeconstants` перечислены все возможные сочетания состояния и подсостояния, iisnode могут возвращаться из-за ошибки.
