---
title: Снижение производительности неполадки
description: Узнайте, как устранить проблемы с замедлением производительности приложения в Службе приложений Azure, включая мониторинг поведения приложений, сбор данных и устранение проблемы.
...
* **Неудавшийся отслеживание запросов** - Подробная информация о невыполненных запросах, включая след компонентов IIS, используемых для обработки запроса, и время, затрачиваемые на каждый компонент. Это может быть полезно, если вы пытаетесь повысить производительность приложения или определить причину конкретной ошибки HTTP.
