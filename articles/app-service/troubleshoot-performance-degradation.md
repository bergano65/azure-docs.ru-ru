...
* **Трассировка невыполненных запросов** — подробные сведения о неудачных запросах, включая трассировку компонентов IIS, используемых для обработки запроса, и время, затраченное на каждый компонент. Это может быть полезно, если вы пытаетесь повысить производительность приложения или определить причину конкретной ошибки HTTP.
