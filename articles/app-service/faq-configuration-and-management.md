...
## <a name="why-is-my-certificate-issued-for-11-months-and-not-for-a-full-year"></a>Почему мой сертификат выдается на 11 месяцев, а не на весь год?

Для всех сертификатов, выпущенных после 01.09.2020, максимальная длительность теперь составляет 397 дней. Сертификаты, выпущенные до 01.09.2020, имеют максимальный срок действия 825 дней, по истечении которого для них необходимо выполнить продление, переназначение ключа и т. п. Это изменение затрагивает все сертификаты, продленные после 01.09.2020, так что срок действия продленных сертификатов пользователей может быть короче.
Служба GoDaddy реализовала службу подписки, которая соответствует новым требованиям и учитывает имеющиеся сертификаты клиентов. За 30 дней до истечения срока действия нового выпущенного сертификата служба автоматически выдает второй сертификат, который увеличивает срок действия до первоначальной даты окончания срока действия. Служба приложений совместно с GoDaddy работает над тем, чтобы учесть это изменение и сохранить для наших клиентов полную продолжительность действия их сертификатов.
