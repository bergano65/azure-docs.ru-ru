...
Если приложение выполняется в развертывании службы приложений, где **PremiumV3** недоступно, или если ваше приложение работает в регионе, который сейчас не поддерживает **PremiumV3** , необходимо повторно развернуть приложение, чтобы воспользоваться преимуществами **PremiumV3** .  У вас есть два варианта:
...
Следующая команда создает план службы приложений с ценовой категорией _P1V2_ . Ее можно запустить в Cloud Shell. Параметры для `--sku` : P1V3, _P2V3_ и _P3V3_ .
