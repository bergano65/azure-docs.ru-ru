...
ms.locfileid: "53321585"
---
# <a name="how-to-monitor-apps-in-azure-app-service"></a>Практическое руководство: Мониторинг приложений в службе приложений Azure
[Служба приложений](https://go.microsoft.com/fwlink/?LinkId=529714) предоставляет встроенные средства мониторинга на [портале Azure](https://portal.azure.com).
...
* **Время ЦП**
  * количество времени ЦП (в секундах), используемого приложением. Дополнительные сведения об этой метрике см. в разделе [Время и процент использования ЦП](#cpu-time-vs-cpu-percentage).
* **Входящие данные**
...
**квотах**, выберите "Параметры" > **Квоты**. В интерфейсе пользователя отображаются следующие сведения о квотах: (1) имя, (2) интервал повторного назначения, (3) текущее ограничение и (4) текущее значение.

Доступ к сведениям о ![][metrics]
**метриках** можно получить прямо на странице ресурсов. Вы также можете настроить диаграмму, (1) **щелкнув** ее и выбрав (2) **Изменить диаграмму**.
Этот параметр позволяет задать **диапазон времени**, **тип диаграммы** и отображаемые **метрики**.  

Дополнительные сведения о Центре Интернета вещей см. здесь: [Данные мониторинга, собираемые службой Azure Monitor](../monitoring-and-diagnostics/insights-how-to-customize-monitoring.md).
