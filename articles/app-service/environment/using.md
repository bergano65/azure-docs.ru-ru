...
ASE использует частные конечные точки для входящего трафика и автоматически настраивается с помощью Azure DNS частных зон. Если вы хотите использовать собственный DNS-сервер, необходимо добавить следующие записи:
