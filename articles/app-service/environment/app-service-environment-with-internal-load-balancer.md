---
title: Создание и использование внутренней подсистемы балансировки нагрузки в Среде службы приложений Azure | Документация Майкрософт
...
Среда службы приложений (ASE) — это функция службы приложений Azure уровня служб "Премиум", которая предоставляет возможность расширенной настройки, недоступную в мультитенантных метках. Функция ASE фактически развертывает службу приложений Azure в виртуальной сети Azure. Чтобы получить более полное представление о возможностях, предлагаемых средами службы приложений, ознакомьтесь с документацией по [Среда службы приложений][WhatisASE] . Если вы не знакомы с преимуществами работы в виртуальной сети, ознакомьтесь с вопросами и ответами на [виртуальную сеть Azure][virtualnetwork]. 
...
Создание ASE с внутренним балансировщиком нагрузки не сильно отличается от создания ASE обычным образом. Более подробное обсуждение создания ASE см. в разделе [создание среда службы приложений][HowtoCreateASE]. В процессе создания ASE с внутренним балансировщиком нагрузки точно так же создается новая или выбирается существующая виртуальная сеть. Чтобы создать ASE с внутренним балансировщиком нагрузки, выполните следующее. 
...
## <a name="using-an-ilb-ase"></a>Использование ILB ASE
...
Чтобы приступить к работе со средами службы приложений, см. статью [Общие сведения о средах службы приложений][WhatisASE] .
