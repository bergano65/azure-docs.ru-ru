---
title: Настройка Azure ExpressRoute v1
description: Конфигурация сети для Среда службы приложений PowerApps с Azure ExpressRoute. Этот документ предоставляется только для клиентов, использующих устаревшую версию V1 ASE.
author: stefsch
...
* Исходящие сетевые подключения к доменам ocsp.msocsp.com, mscrl.microsoft.com и crl.microsoft.com. Для поддержки функций TLS требуется подключение к этим доменам.
...
* Скачайте Azure PowerShell со страницы Azure [Загрузки][AzureDownloads]. Выберите загрузку с датой июнь 2015 г. или позже. В разделе >  **средства командной строки****Windows PowerShell**нажмите кнопку **установить** , чтобы установить последние командлеты PowerShell.
...
### <a name="step-2-create-routes-in-the-table"></a>Шаг 2. Создание маршрутов в таблице
...
### <a name="step-3-associate-the-table-to-the-subnet"></a>Шаг 3. связывание таблицы с подсетью
...
### <a name="step-4-test-and-confirm-the-route"></a>Шаг 4. Тестирование и подтверждение маршрута
