...
description: Узнайте, как создавать веб-приложения на Среда службы приложений v1. Этот документ предоставляется только для клиентов, использующих устаревшую версию V1 ASE.
author: ccompy
...
3. Выберите или создайте группу ресурсов.
    ...
    *Группы ресурсов* позволяют управлять связанными ресурсами Azure как единым целым и полезны при установке правил *управления доступом на основе ролей* (RBAC) для приложений. Дополнительные сведения см. в разделе [Azure Resource Manager обзор][ResourceGroups]. 
