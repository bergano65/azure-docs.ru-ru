...
3. Выберите или создайте группу ресурсов.
    ...
    *Группы ресурсов* позволяют управлять связанными ресурсами Azure как единым целым и полезны при установке правил *управления доступом на основе ролей* (RBAC) для приложений. Дополнительные сведения см. в [обзоре Azure Resource Manager][ResourceGroups]. 
