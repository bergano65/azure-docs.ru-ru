...
* 454: **Обязательный порт,** используемый инфраструктурой Azure для управления и обслуживания сред службы приложений через SSL.  Не блокируйте трафик на этом порту.  Этот порт всегда привязан к общедоступному виртуальному IP-адресу ASE.
* 455: **Обязательный порт,** используемый инфраструктурой Azure для управления и обслуживания сред службы приложений через SSL.  Не блокируйте трафик на этом порту.  Этот порт всегда привязан к общедоступному виртуальному IP-адресу ASE.
