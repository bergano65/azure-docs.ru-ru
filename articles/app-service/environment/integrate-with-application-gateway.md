...
description: Узнайте о том, как интегрировать приложение в среду службы приложений ILB с шлюзом приложений в этом сквозном прохождении.
author: ccompy
...
* Адрес подсистемы балансировки нагрузки, используемый средой службы приложений с внутренней подсистемой балансировки нагрузки. Эта информация находится на портале App Service Environment под > **ip-адресами** **настройки:**
...
1. На портале Azure перейдите на **новый** > **сетевой** > **шлюз приложений**.
