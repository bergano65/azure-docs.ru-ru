...
В ASEv1 можно управлять всеми ресурсами вручную, включая внешние интерфейсы, рабочие процессы и IP-адреса, использованные для SSL на основе IP. Перед горизонтальным увеличением масштаба плана службы приложений необходимо выполнить горизонтальное увеличение масштаба пула рабочих процессов, в котором необходимо разместить план.
