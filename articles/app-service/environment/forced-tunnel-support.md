...
* на портале Azure откройте пользовательский интерфейс для таблицы маршрутов, назначенных подсети ASE.  Выберите конфигурацию.  Задайте параметру распространения маршрутов BGP значение "Выкл.".  Нажмите кнопку «Сохранить». Сведения об отключении см. в документе по [созданию таблицы маршрутов][routetable].
