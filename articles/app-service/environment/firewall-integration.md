...
5. Добавьте маршрут в таблицу маршрутов для 0.0.0.0/0, при этом следующий прыжок должен быть Брандмауэром Azure.
6. Создайте в Azure SQL и службе хранилища Azure конечные точки службы для подсети Среды службы приложений.
7. Назначьте таблицу маршрутов, созданную в вашей подсети Среды службы приложений.
