---
title: Введение в Среду службы приложений Azure версии 1
...
Среда службы приложений — это план обслуживания [Премиум][PremiumTier] в [службе приложений Azure](../overview.md). Она обеспечивает полностью изолированную и выделенную среду для безопасной работы приложений службы приложений Azure в большом масштабе, в том числе веб-, мобильных приложений и приложений API.  
