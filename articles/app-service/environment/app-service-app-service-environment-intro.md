...
Интерфейсный пул содержит ресурсы вычислений, отвечающие за завершение TLS, а также автоматическую балансировку нагрузки запросов приложений в пределах Среда службы приложений.
