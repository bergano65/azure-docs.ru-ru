...
В этой статье показано, как создать внешнюю среду ASE. Общие сведения о ASE см. в статье [Введение в среда службы приложений][Intro]. Сведения о создании ASE ILB см. в статье [Создание и использование ilB ASE][MakeILBASE].
...
- **Из шаблона Azure Resource Manager.** Этот метод предназначен для опытных пользователей. Дополнительные сведения см. в статье [Создание ASE на основе шаблона][MakeASEfromTemplate].
...
1. Выберите виртуальную сеть и расположение. Вы можете создать виртуальную сеть или выбрать имеющуюся: 
    ...
    * Если выбрать имеющуюся виртуальную сеть, при создании ASE создается подсеть. *Вы не можете использовать предварительно созданную подсеть на портале. Вы можете создать ASE с существующей подсетью, если вы используете шаблон диспетчер ресурсов.* Сведения о создании ASE на основе шаблона см. в разделе [создание среда службы приложений из шаблона][MakeASEfromTemplate].
...
Дополнительные сведения о ASEv1 см. в статье [Введение в среда службы приложений v1][ASEv1Intro]. Дополнительные сведения о масштабировании, управлении и мониторинге ASEv1 см. [в статье настройка среда службы приложений][ConfigureASEv1].
