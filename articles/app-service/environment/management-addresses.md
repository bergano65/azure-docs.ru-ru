...
description: Поиск адресов управления, используемых для управления Среда службы приложений. Настроили их в таблице маршрутов, чтобы избежать возникновения проблем с маршрутизацией.
author: ccompy
