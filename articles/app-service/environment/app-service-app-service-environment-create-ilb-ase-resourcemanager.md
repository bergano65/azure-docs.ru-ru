---
title: Создание Среды службы приложений с внутренним балансировщиком нагрузки с помощью шаблонов Azure Resource Manager (служба приложений) | Документация Майкрософт
...
* *Субъект*:  для этого атрибута необходимо задать значение **.имя_корневого_домена.com*
