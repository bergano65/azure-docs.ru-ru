...
3. Перейдите в параметры SSL в приложении. Щелкните "Отправить сертификат". Выберите "Общедоступный". Выберите "Локальный компьютер". Укажите имя. Найдите и выберите ваш файл *CER*. Выберите "Передать". 
