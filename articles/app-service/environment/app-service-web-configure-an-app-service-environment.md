...
**Параметры** > **Front End Pool** / **Пулы рабочих процессов**пула. Каждая из этих колонок пула ресурсов позволяет просматривать сведения только в этом пуле ресурсов, а также предоставлять элементы управления для полного масштабирования пула ресурсов.  
