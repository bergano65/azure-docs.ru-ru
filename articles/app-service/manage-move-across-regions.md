...
Ресурсы службы приложений зависят от региона и не могут быть перемещены между регионами. Необходимо создать копию существующих ресурсов службы приложений в целевом регионе, переместить содержимое в новое приложение. Если исходное приложение использует личный домен, его можно перенести в [новое приложение в целевом регионе](manage-custom-dns-migrate-domain.md) по завершении работы.
...
Найдите все ресурсы службы приложений, которые вы используете в данный момент. Например:
...
[Клонирование приложения службы приложений Azure с помощью PowerShell](app-service-web-app-cloning.md)