...
1. Выберите веб-приложение, которое требуется развернуть.
...
1. В [портал Azure](https://portal.azure.com)найдите и выберите **службы приложений**, а затем выберите веб-приложение, которое требуется развернуть. 
