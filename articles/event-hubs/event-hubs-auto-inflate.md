...
Вы можете включить или отключить автоматическое раздувание в пространстве имен центров событий стандартного уровня, используя любой из следующих методов:
...
> [!NOTE]
> Основные области пространства имен событий не поддерживают автоматическое раздувание.
