...
Вы можете включить или отключить автоматическое расширение для пространства имен концентраторов событий уровня "Стандартный" с помощью любого из следующих методов.
...
> [!NOTE]
> Пространства имен концентраторов событий уровня Basic не поддерживают автоматическое расширение.
