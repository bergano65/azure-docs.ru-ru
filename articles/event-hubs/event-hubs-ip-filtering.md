...
1. Чтобы ограничить доступ к определенным IP-адресам, убедитесь, что выбран параметр **Выбранные сети** . В разделе **Брандмауэр** выполните следующие шаги:
    ...
    >[!WARNING]
    > Если вы выбрали вариант **Выбранные сети** и не добавили хотя бы одно правило брандмауэра IP или виртуальную сеть на этой странице, доступ к пространству имен можно получить через общедоступный Интернет (с помощью ключа доступа).
1. Укажите, следует ли **разрешить доверенным службам Майкрософт обходить этот брандмауэр**. Дополнительные сведения см. в разделе [Доверенные службы Майкрософт](#trusted-microsoft-services) . 
