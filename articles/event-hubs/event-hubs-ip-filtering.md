...
>
> Доверенные службы Майкрософт не поддерживаются при реализации IP-фильтрации.
>
> Распространенные сценарии Azure, которые не работают с IP-фильтрацией (Обратите внимание, что список **не** является исчерпывающим) —
...
4. Выберите **сеть** в разделе **Параметры** в меню слева. 
    ...
    По умолчанию выбран параметр **Выбранные сети** . Если не указать правило брандмауэра IP-адресов или добавить виртуальную сеть на этой странице, доступ к пространству имен можно получить через общедоступный Интернет (с помощью ключа доступа). 
