...
ms.locfileid: "83655880"
---
# <a name="configure-ip-firewall-rules-for-an-azure-event-hubs-namespace"></a>Настройка правил брандмауэра для IP-адресов для пространства имен Центров событий Azure
...
>[!WARNING]
> Включение фильтрации IP-адресов может предотвратить взаимодействие с Центрами событий других служб Azure.
>
...
3. Нажмите **Сохранить** на панели инструментов, чтобы сохранить параметры. Подождите несколько минут, чтобы подтверждение появилось в уведомлениях портала.
