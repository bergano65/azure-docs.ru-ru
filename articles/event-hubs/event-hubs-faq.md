...
Начальная загрузка. серверы = думминамеспаце. servicebus. Windows. NET: 9093 Request. timeout. MS = 60000 Security. Протокол = SASL_SSL SASL. механизм = обычный sasl.jaas.config= org. Apache. Kafka. Common. Security. plain. Плаинлогинмодуле обязательный пользователь = "$ConnectionString" пароль = "Endpoint = SB://думминамеспаце.сервицебус.Виндовс.нет/; SharedAccessKeyName = Думмякцесскэйнаме; SharedAccessKey = КСКСКСКСКСКСКСКСКСКСКСКСКСКСКСКСКСКСКСКСКС ";
