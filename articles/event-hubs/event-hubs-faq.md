...
### <a name="what-ip-addresses-do-i-need-to-whitelist"></a>Какие IP-адреса нужно внести в список разрешений?
...
### <a name="where-can-i-find-client-ip-sending-or-receiving-msgs-to-my-namespace"></a>Где можно найти IP-адрес клиента, отправляющий или получающий сообщения, в пространство имен?
...
Техническая поддержка для концентраторов событий доступна на [Странице Майкрософт с вопросами и ответами для Служебной шины Azure](https://docs.microsoft.com/answers/topics/azure-service-bus.html). Поддержка по выставлению счетов и управлению подпиской предоставляется бесплатно.
