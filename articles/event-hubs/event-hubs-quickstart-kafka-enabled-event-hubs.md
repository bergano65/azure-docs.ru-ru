...
Если вы создаете пространство имен в Центрах событий уровня "Стандартный", конечная точка Kafka для пространства имен включается автоматически. Вы можете выполнять потоковую передачу событий из приложений, использующих протокол Kafka, в Центры событий уровня "Стандартный". Такая конечная точка не включается для пространств имен Центров событий уровня "Базовый". 
