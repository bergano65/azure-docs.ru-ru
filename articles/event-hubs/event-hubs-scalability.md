...
Пропускная способность Центров событий выражается в *единицах пропускной способности*. Единицы пропускной способности — это предварительно приобретенные единицы емкости. Одна пропускная способность позволяет:
