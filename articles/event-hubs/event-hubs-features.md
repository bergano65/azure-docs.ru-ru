...
Благодаря этой интеграции не нужно запускать или управлять кластерами Kafka с помощью Zookeeper. Это также позволяет работать с некоторыми из самых требовательных функций концентраторов событий, такими как Сбор, Автоматическое расширение и Геоизбыточное аварийное восстановление.
...
Мы рекомендуем сбалансировать количество единиц пропускной способности и секций, чтобы добиться оптимального масштабирования. Одна секция имеет минимальный масштаб в размере одной единицы пропускной способности. Количество единиц пропускной способности должно быть меньше или равно количеству секций в концентраторе событий.
