...
description: Краткое руководство. в этой статье описывается создание .NET Framework приложения, которое отправляет события в концентраторы событий Azure.
services: event-hubs
documentationcenter: ''
...
ms.locfileid: "78365409"
---
# <a name="quickstart-send-events-to-or-receive-events-from-azure-event-hubs-using-net-framework"></a>Краткое руководство. Отправка событий или получение событий из концентраторов событий Azure с помощью .NET Framework
