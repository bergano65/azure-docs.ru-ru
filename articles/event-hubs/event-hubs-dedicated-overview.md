...
Кластеры подготавливаются и счет за **единиц мощности (Cu)** , предварительно выделенный объем ресурсов ЦП и памяти. Вы можете приобрести 1, 2, 4, 8, 12, 16 или 20 единиц мощности для каждого кластера. Сколько приема и потоковой передачи на единицу CU зависит от многих факторов, таких как количество отправителей и получателей, фигура полезных данных, исходящий трафик скорости (см. в разделе результатов тестирования производительности ниже для получения дополнительных сведений). 
...
| Центры событий; |  10 для каждого пространства имен | 1000 на пространство имен |
...
| Подключения через брокера | включен 1 000, 5000 max | Включено 100 тыс. и max |
...
Возможности самообслуживания для [создать кластер концентраторов событий](event-hubs-dedicated-cluster-create-portal.md) через [портал Azure](https://aka.ms/eventhubsclusterquickstart) теперь доступна в предварительной версии. Если у вас возникли вопросы или нужна помощь адаптации для концентраторов событий уровня Dedicated, обратитесь в службу [группе разработчиков концентраторов событий](mailto:askeventhubs@microsoft.com).
...
| ------------- | --------- | ---------------- | ------------------ | ----------------- | ------------------- | --------- | ---------- |
| Пакеты 100×1 KB | 2 | 400 МБ в секунду | 400 тысяч сообщений в секунду | 800 МБ в секунду | 800 КБ сообщений в секунду | 400 единиц пропускной способности | 100 единиц пропускной способности | 
| Пакеты 10×10 KB | 2 | 666 МБ в секунду | 66.6 k сообщений в секунду | 1,33 ГБ в секунду | 133 k сообщений в секунду | 666 единиц пропускной способности | 166 единиц пропускной способности |
| Пакеты 6×32 KB | 1 | 1,05 ГБ в секунду | 34 тысяч сообщений / сек | 1,05 ГБ в секунду | 34 k сообщений в секунду | 1000 единиц пропускной способности | 250 единиц пропускной способности |
...
Мы не поддерживают в настоящее время автоматический процесс перемещения по переносу данных концентраторов событий из стандартное пространство имен на выделенный, один. 

## <a name="next-steps"></a>Дальнейшие действия

Обратитесь к торговому представителю корпорации Майкрософт или технической поддержки Майкрософт, чтобы получить дополнительные сведения о концентраторов событий уровня Dedicated. Также можно создать кластер или узнать больше о концентраторах событий, ценовые категории по следующим ссылкам:

- [Создайте кластер концентраторов событий с помощью портала Azure](https://aka.ms/eventhubsclusterquickstart) 
