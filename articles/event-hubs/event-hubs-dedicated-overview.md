...
Самостоятельное [Создание кластера концентраторов событий](event-hubs-dedicated-cluster-create-portal.md) с помощью [портал Azure](https://aka.ms/eventhubsclusterquickstart) теперь находится на этапе предварительной версии. Если у вас возникнут вопросы или вам нужна помощь в адаптации к Центры событий (цен. категория "Выделенный"), обратитесь к [группе концентраторов событий](mailto:askeventhubs@microsoft.com).
