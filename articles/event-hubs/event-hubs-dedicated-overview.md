...
description: В этой статье приводятся общие сведения о службе "Центры событий Azure" ценовой категории "Выделенный", которая позволяет развертывать концентраторы событий с одним клиентом.
services: event-hubs
