...
6. Нажмите кнопку **сохранить** на панели инструментов, чтобы сохранить параметры. Подождите несколько минут, пока не отобразится подтверждение уведомления на портале.
