...
description: В этой статье содержатся сведения о добавлении конечной точки службы Microsoft.EventHub в виртуальную сеть.
services: event-hubs
documentationcenter: ''
