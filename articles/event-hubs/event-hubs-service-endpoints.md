...
Привязка пространства имен Центров событий к виртуальной сети состоит из двух этапов. Сначала необходимо создать **конечную точку службы для виртуальной сети** в подсети виртуальной сети и подключить ее к Microsoft.EventHub, как описано в статье [Конечные точки служб для виртуальной сети][vnet-sep]. После добавления конечной точки службы вы привязываете пространство имен Центров событий к ней с помощью *правила виртуальной сети*.
