...
Чтобы авторизовать запрос к службе концентраторов событий из управляемого удостоверения в приложении, сначала настройте параметры управления доступом на основе ролей (RBAC) для этого управляемого удостоверения. Концентраторы событий Azure определяют роли Azure, которые охватывают разрешения для отправки и чтения из концентраторов событий. Когда роль Azure назначается управляемому удостоверению, управляемому удостоверению предоставляется доступ к данным концентраторов событий в соответствующей области.
