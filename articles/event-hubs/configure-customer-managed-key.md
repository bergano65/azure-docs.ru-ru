...
> [!NOTE]
> Для BYOK зашифрованных пространств имен концентраторов событий, конечные точки службы виртуальной сети не поддерживаются в предварительной версии. 
