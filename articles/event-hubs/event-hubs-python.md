...
Вы можете просмотреть больше примеров Python в репозитории Git [azure-event-hubs-python](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/eventhub/azure-eventhubs).
