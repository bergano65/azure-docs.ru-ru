...
[Владельца данных концентраторов событий (Предварительная версия)](../role-based-access-control/built-in-roles.md#service-bus-data-owner) роль обеспечивает доступ к данным в пространство имен концентраторов событий и его сущностей (очереди, разделы, подписки и фильтры)
