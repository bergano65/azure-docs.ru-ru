...
7. На странице **Основные сведения** выполните следующие действия. 
    ...
    5. Выберите **регион** для закрытой конечной точки. Частная конечная точка должна находиться в том же регионе, что и виртуальная сеть, но может находиться в другом регионе от ресурса частной ссылки, к которому вы подключаетесь. 
...
8. На странице **ресурсов** выполните следующие действия.
    ...
    2. Если вы выбрали **подключиться к ресурсу Azure по идентификатору или псевдониму ресурса**, выполните следующие действия.
        1. Введите идентификатор или **псевдоним** **ресурса** . Это может быть идентификатор ресурса или псевдоним, к которому вам предоставили доступ кто-то. Самый простой способ получить идентификатор ресурса — перейти к пространству имен концентраторов событий в портал Azure и скопировать часть URI, начиная с `/subscriptions/`. Пример см. на следующем рисунке. 
