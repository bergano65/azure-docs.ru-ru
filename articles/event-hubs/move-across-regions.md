...
- Если пространство имен концентраторов событий находится в **кластере концентраторов событий**, [Создайте выделенный кластер](event-hubs-dedicated-cluster-create-portal.md) в **целевом регионе** , прежде чем выполнять действия, описанные в этой статье. 
