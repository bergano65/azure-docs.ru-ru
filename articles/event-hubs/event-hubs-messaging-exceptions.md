---
title: Исключения обмена сообщениями для .NET — концентраторы событий Azure | Документация Майкрософт
...
ms.locfileid: "71309841"
---
# <a name="event-hubs-messaging-exceptions---net"></a>Исключения обмена сообщениями концентраторов событий .NET

В этой статье перечислены некоторые исключения .NET, созданные библиотекой API .NET для обмена сообщениями служебной шины Azure, которая включает .NET Framework API концентраторов событий. Этот справочник может измениться, поэтому следите за обновлениями.
