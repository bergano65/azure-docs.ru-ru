...
1. Создайте дополнительное пространство имен. Это необязательный шаг. Вы можете создать вторичное пространство имен при создании связывания на следующем шаге. 
...
1. На странице **Инициация связывания** выберите существующее дополнительное пространство имен или создайте его, а затем щелкните **создать**. В следующем примере выбрано существующее вторичное пространство имен. 
