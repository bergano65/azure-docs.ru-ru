...
Эта функция полезна в сценариях, в которых концентраторы azure Event должны быть доступны только на некоторых известных сайтах. Правила брандмауэра позволяют настроить правила для приема трафика, исходиющего из определенных адресов IPv4. Например, если вы используете концентраторы событий с экспресс-маршрутом Azure Express Route, можно создать **правило брандмауэра,** позволяющее осуществлять трафик только с IP-адресов инфраструктуры. 
...
Интеграция концентраторов событий с «Виртуальной сетью (VNet) Service EndPoints» обеспечивает безопасный доступ к возможностям обмена сообщениями из рабочих нагрузок, таких как виртуальные машины, которые привязаны к виртуальным сетям, с безопасностью сетевого трафика на обоих концов.
