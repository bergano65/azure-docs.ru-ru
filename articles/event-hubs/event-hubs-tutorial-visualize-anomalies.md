---
title: Визуализация аномальных данных в событиях реального времени в Центрах событий Azure | Документация Майкрософт
description: Руководство. Визуализация аномалий данных в событиях реального времени, отправляемых в Центры событий Microsoft Azure
services: event-hubs
