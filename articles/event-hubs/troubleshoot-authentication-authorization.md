...
Если вы используете Azure Active Directory (Azure AD) для проверки подлинности и авторизации в концентраторах событий Azure, убедитесь, что удостоверение, обращающееся к концентратору событий, является членом правильной **роли управления доступом на основе ролей (RBAC)** в правой **области ресурсов** (группа потребителей, концентратор событий, пространство имен, Группа ресурсов или подписка).

### <a name="rbac-roles"></a>Роли RBAC
...
* [Устранение проблем подключения](troubleshooting-guide.md)
