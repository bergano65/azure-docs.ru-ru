        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Дополнительные сведения о Power BI Embedded</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Ознакомьтесь с внедрением отчетов с помощью примера приложения.</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://www.nuget.org/packages/Microsoft.PowerBI.JavaScript/">Скачивание пакета SDK для JavaScript</a></p>
                   </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://docs.microsoft.com/rest/api/power-bi-embedded/">Справочник по REST API Azure Resource Manager</a></p>
                        <p><a href="https://msdn.microsoft.com/library/mt147898.aspx">Справочник по REST API</a></p>
                    </div>
                </div>
            </div>
        </div>
