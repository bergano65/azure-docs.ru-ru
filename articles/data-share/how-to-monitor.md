...
description: Узнайте, как отслеживать состояние приглашений, предоставлять общий доступ к подпискам и журнал моментальных снимков в предварительной версии Azure Data Share.
author: joannapea
ms.author: joanpo
