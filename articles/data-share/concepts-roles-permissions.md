...
description: Сведения о ролях контроля доступа и требованиях к поставщикам данных и потребителям данных для предоставления общего доступа к данным в предварительной версии Azure Data Share.
author: joannapea
ms.author: joanpo
