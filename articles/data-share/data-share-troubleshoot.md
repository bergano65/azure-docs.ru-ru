...
* Исходный или целевой скрипт SQL для предоставления разрешения на доступ к данным не выполняется или выполняется с использованием проверки подлинности SQL, а не Azure Active Directory проверки подлинности.  
