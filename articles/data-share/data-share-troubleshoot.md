...
Для учетной записи хранения ниже приведены дополнительные причины сбоев моментальных снимков.

* Файл обновляется в источнике во время создания моментального снимка. Это может привести к тому, что в целевом объекте будет 0 байтового файла. Следующий моментальный снимок после обновления завершится успешно в источнике.
...
## <a name="snapshot-issue-after-updating-snapshot-schedule"></a>Проблемы с моментальным снимком после обновления расписания моментальных снимков
После обновления поставщиком данных расписания моментальных снимков для отправленного общего ресурса потребитель данных должен отключить предыдущее расписание моментальных снимков и повторно включить Обновленное расписание моментальных снимков для полученного общего ресурса. 
