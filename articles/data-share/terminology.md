...
description: Сведения об общих терминах, используемых для описания ресурсов, используемых в предварительной версии Azure Data Share (поставщик данных, потребитель данных, Общая папка данных, Общая подписка, моментальный снимок, приглашение, получатель).
author: joannapea
ms.author: joanpo
