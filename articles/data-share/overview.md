...
Azure Data Share (предварительная версия) выставляет счета за два компонента. Первый компонент предназначен для управления общим ресурсом. В предварительной версии управление данными будет бесплатным.

Второй компонент предназначен для перемещения данных. Azure Data Share взимает плату за перемещение данных от клиента Azure поставщика данных к клиенту Azure потребителя данных. При перемещении набора данных вы платите за операцию перемещения набора данных и за вычисления, необходимые для этого перемещения. Плата за вычисление при перемещении набора данных начисляется за виртуальное ядро в час. Плата за вычисление при перемещении набора данных округляется до целого числа минут. В предварительной версии операции перемещения набора данных бесплатны. 

Дополнительные сведения о ценах на Azure Data Share см. на [этой странице](https://azure.microsoft.com/pricing/).
