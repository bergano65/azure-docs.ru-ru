...
description: Узнайте, как просто и безопасно обмениваться данными с множеством клиентов и партнеров с помощью Azure Data Share (предварительная версия).
author: joannapea
ms.author: joanpo
