...
Совместное использование на месте в настоящее время ограничено предварительной версией обозревателя данных Azure. Поставщики данных могут совместно использовать данные там, где они находятся, без перемещения данных через символическую ссылку. Подпишитесь на лимитированную предварительную версию функции совместного использования на месте для Azure Data Explorer [здесь](https://aka.ms/azuredatasharepreviewsignup). 
