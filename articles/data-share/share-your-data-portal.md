...
Из этого краткого руководства вы узнаете, как с помощью портала Azure настроить новый общий ресурс Azure Data Share для совместного использования данных из учетной записи хранения.
