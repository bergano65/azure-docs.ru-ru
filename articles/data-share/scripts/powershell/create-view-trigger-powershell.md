...
| Command | Примечания |
|---|---|
| [New-Аздаташаретригжер](/powershell/module/az.resources/new-azdatasharetrigger) | Создайте триггер моментального снимка общего ресурса. |
| [Get-Аздаташаретригжер](/powershell/module/az.resources/get-azdatasharetrigger) | Возвращает параметры синхронизации общей папки. |
|||
