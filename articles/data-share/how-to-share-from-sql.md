...
* Выделенный пул SQL Azure синапсе Analytics (Рабочая область) с таблицами, к которым вы хотите предоставить общий доступ. Совместное использование представления в настоящее время не поддерживается. Совместное использование из несерверного пула SQL в настоящее время не поддерживается.
...
* Выделенный пул SQL Azure синапсе Analytics (Рабочая область). Получение данных в несерверный пул SQL в настоящее время не поддерживается.
* Разрешение на запись в пул SQL в рабочей области синапсе, которая имеется в *Microsoft. синапсе/workspaces/склпулс/Write*. Это разрешение назначено роли **участника**.
