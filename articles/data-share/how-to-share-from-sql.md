...
> 1.  При совместном использовании данных из базы данных SQL Azure в Azure синапсе Analytics поддерживаются не все типы данных. Дополнительные сведения см. в разделе [табличные типы данных в пуле СИНАПСЕ SQL](../synapse-analytics/sql-data-warehouse/sql-data-warehouse-tables-data-types.md) . 
