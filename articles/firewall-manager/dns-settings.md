---
title: Параметры DNS политики брандмауэра Azure (Предварительная версия)
...
ms.locfileid: "85611804"
---
# <a name="azure-firewall-policy-dns-settings-preview"></a>Параметры DNS политики брандмауэра Azure (Предварительная версия)
