...
|Базовые политики должны находиться в том же регионе, что и локальная политика.|Создавайте все локальные политики в том же регионе, в котором находится базовая политика. Тем не менее политику, созданную в одном регионе, можно применить к защищенному концентратору из другого региона.|Изучаем|
|Обмен данными между концентраторами не работает с защищенным виртуальным концентратором|Связь между защищенными виртуальными концентраторами пока не поддерживается.|Изучаем|
...
|Политика брандмауэра не поддерживает группы IP-адресов.|Группы IP-адресов предоставляются в общедоступной предварительной версии и сейчас поддерживаются только традиционными правилами брандмауэра.|Исправление выполняется.
|Подписки по программе "Поставщик облачных решений" (CSP) не поддерживаются.|[Подписки CSP](https://azure.microsoft.com/offers/ms-azr-0145p/) сейчас не поддерживаются.|Изучаем
