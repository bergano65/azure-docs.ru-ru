...
|Сбой правил приложения в защищенном концентраторе с настроенной пользовательской службой DNS (предварительная версия).|DNS-прокси или пользовательский DNS (предварительная версия) не работает в сценариях, где настроен сетевой адаптер управления брандмауэром. К ним относятся развертывания защищенного концентратора и случаи с включенным принудительным туннелированием.|Мы работаем над исправлением.|
