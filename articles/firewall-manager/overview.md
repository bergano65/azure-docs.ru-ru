...
|Сбой правил приложения в защищенном концентраторе с настроенной пользовательской службой DNS (предварительная версия).|Пользовательская служба DNS (предварительная версия) не работает в безопасных развертываниях концентраторов и развертываниях концентраторов виртуальных сетей, где включено принудительное туннелирование.|Мы работаем над исправлением.|
