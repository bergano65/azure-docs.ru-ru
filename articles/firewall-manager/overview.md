...
|---------|---------|---------|
|Центральные виртуальные сети, созданные вручную, не поддерживаются|В настоящее время Диспетчер брандмауэра Azure поддерживает сети, созданные с использованием виртуальных концентраторов. Использование собственной центральной виртуальной сети, созданной вручную, пока не поддерживается.|Используйте Диспетчер брандмауэра Azure со звездообразными сетями, созданными с помощью виртуальных концентраторов.<br>Эта проблема изучается.
