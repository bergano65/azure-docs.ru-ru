...
|Обмен данными между концентраторами не происходит через защищенный виртуальный концентратор|Связь между защищенными виртуальными концентраторами пока не поддерживается, однако взаимодействие обычных концентраторов возможно.|Изучаем|
