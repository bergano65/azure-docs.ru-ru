...
Политика брандмауэра — это высокодоступный и автоматически реплицируемый ресурс. В случае редких аварий в регионе операции политики брандмауэра выполняют отработку отказа на пары регионов Azure. Операции после восстановления выполняют отработку отказа на основной регион Azure как для синхронных, так и для асинхронных операций. 

Пары регионов предоставляют несколько преимуществ, в том числе следующие:
- физическая изоляция с расстоянием не менее 500 км;
- быстрое восстановление после аварии;
- соблюдение требований к месту расположения данных для конкретного географического региона.

Подробные сведения о парах регионов см. в статье [Непрерывность бизнес-процессов и аварийное восстановление (BCDR) в парах регионов Azure](../best-practices-availability-paired-regions.md).
