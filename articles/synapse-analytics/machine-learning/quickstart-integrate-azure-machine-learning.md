...
В этом кратком руководстве вы свяжете рабочую область Synapse Analytics с рабочей областью машинного обучения Azure. Связывание этих рабочих областей позволяет использовать машинное обучение Azure из различных функций Synapse.
