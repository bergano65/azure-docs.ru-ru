...
## <a name="register-azure-synapse-resource-provider"></a>Регистрация поставщика ресурсов Azure Synapse
Зарегистрируйте поставщик ресурсов Azure Synapse, если вы еще этого не сделали. Регистрация поставщика ресурсов настраивает подписку для работы с поставщиком ресурсов. Сведения о регистрации поставщика ресурсов Azure Synapse см. в статье [Поставщики и типы ресурсов Azure](https://docs.microsoft.com/azure/azure-resource-manager/management/resource-providers-and-types). В процессе регистрации выберите в списке поставщиков ресурсов значение *Microsoft.Synapse*.
