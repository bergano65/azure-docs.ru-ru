---
title: Краткое руководство. Создание записной книжки Apache Spark
...
- [Пул Apache Spark](quickstart-create-apache-spark-pool.md)
...
Azure Synapse сохраняет данные в Azure Data Lake Storage. Вы можете без опасений завершить работу экземпляра Spark, когда он не используется. Плата взимается за все время работы пула Apache Spark для Azure Synapse, независимо от реального использования. Плата за пул в несколько раз выше, чем плата за хранилище. Поэтому в целях экономии отключайте экземпляры Spark, если они не используются.
