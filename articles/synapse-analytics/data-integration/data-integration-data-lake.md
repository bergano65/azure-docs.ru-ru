...
Дополнительные сведения об интеграции данных для синапсе Analytics см. в статье прием [данных в выделенном пуле SQL](data-integration-sql-pool.md) .
