...
Поскольку вы будете использовать демонстрационную среду, вам следует создать собственную базу данных для демонстрационных целей. База данных нужна, чтобы в ней можно было создавать представления. В этой документации вы будете использовать эту базу данных в примерах запросов.

> [!NOTE]
> Обратите внимание, что базы данных используются только для просмотра метаданных, а не для реальных данных.
>
...
## <a name="creating-power-bi-desktop-report"></a>Создание отчета Power BI Desktop

Откройте приложения Power BI Desktop и выберите параметр "Получить данные".
