...
description: В этом руководстве описаны действия по подключению Power BI Desktop к бессерверному пулу SQL (предварительная версия).
...
В этом руководстве описаны действия по подключению Power BI Desktop к бессерверному пулу SQL (предварительная версия).
