...
Как и следовало ожидать, пул SQL поддерживает транзакции как часть рабочей нагрузки хранилища данных. Однако для поддержания производительности пула SQL на соответствующем уровне некоторые возможности ограничиваются по сравнению с SQL Server. Эта статья посвящена отличиям этого продукта от аналогичных систем.
