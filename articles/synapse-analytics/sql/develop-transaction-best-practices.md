...
description: В этой статье приведены сведения о том, как оптимизировать производительность кода обработки транзакций в пуле SQL (хранилище данных), чтобы свести к минимуму риск длительных откатов.
