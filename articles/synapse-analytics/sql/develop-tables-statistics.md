...
Поскольку существует корреляция между *категорией продукта\_* и *\_\_подкатегорией продукта*, объект статистики с несколькими столбцами может быть полезен, если доступ к этим столбцам осуществляется одновременно.
