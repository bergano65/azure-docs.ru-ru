---
title: Краткое руководство по преобразованию данных с помощью потока данных сопоставления
...
### <a name="navigate-to-the-synapse-studio"></a>Переход к синапсе Studio
...
* Откройте [Azure синапсе Analytics](https://web.azuresynapse.net/) и войдите в рабочую область.

В этом кратком руководстве мы используем рабочую область с именем «adftest2020» в качестве примера. Автоматически откроется домашняя страница синапсе Studio.

![Домашняя страница синапсе Studio](media/doc-common-process/synapse-studio-home.png)
