...
Дополнительные сведения о подключении Azure Repos к Active Directory вашей организации см. в статье [подключение Организации к Azure Active Directory](/azure/devops/organizations/accounts/connect-organization-to-azure-ad).
