...
Чтобы выполнять запросы с помощью бессерверного пула SQL, создайте источник данных, который бессервереный пул SQL сможет использовать для доступа к файлам в хранилище.
