...
С помощью Azure синапсе Analytics можно создавать сложные конвейеры, которые могут автоматизировать и интегрировать операции перемещения данных, преобразования данных и вычислений в рамках решения. Вы можете создавать и отслеживать эти конвейеры с помощью синапсе Studio.
