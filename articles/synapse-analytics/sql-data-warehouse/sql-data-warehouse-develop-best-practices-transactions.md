...
Дополнительные сведения об уровнях изоляции и ограничениях транзакций см. [в разделе транзакции в СИНАПСЕ SQL](sql-data-warehouse-develop-transactions.md) .  Общие сведения о других рекомендациях см. в статье рекомендации по [Azure синапсе Analytics](sql-data-warehouse-best-practices.md).
