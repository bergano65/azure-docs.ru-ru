...
Обратите внимание, что хранилище данных S'L в настоящее время не поддерживает [сяо.@NESTLEVEL](/sql/t-sql/functions/nestlevel-transact-sql) Необходимо отслеживать уровень вложенности. Маловероятно, что вы превысите восемь уровней вложенности, но если вы это сделаете, вам нужно переписать свой код, чтобы он соответствовал уровням вложенности в этих пределах.
