...
- Есть ли у меня таблицы фактов и измерений в пуле SQL?
...
На схеме ниже показана реплицированная таблица, которая доступна на каждом вычислительном узле. В пуле SQL реплицированная таблица полностью копируется в базу данных распространителя на каждом кластерном узле.
...
- Пул SQL масштабируется часто. Масштабирование пула SQL изменяет число узлов вычислений, что влечет за собой перестроение реплицированной таблицы.
