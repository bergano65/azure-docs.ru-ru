...
description: Рекомендации по проектированию реплицированных таблиц в аналитике S'L
...
- Экземпляр «Аналитика» масштабируется на другой уровень
...
- [CREATE TABLE (Аналитика СЗЛ)](/sql/t-sql/statements/create-table-azure-sql-data-warehouse)
- [CREATE TABLE AS SELECT (Аналитика СЗЛ)](/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse)
