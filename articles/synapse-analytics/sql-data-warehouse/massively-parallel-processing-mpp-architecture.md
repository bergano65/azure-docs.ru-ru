...
description: Узнайте, как Azure синапсе Analytics (ранее SQL DW) сочетает в себе возможности обработки распределенных запросов с хранилищем Azure для достижения высокой производительности и масштабируемости.
...
- SQL Synapse: Выполнение аналитики на основе T-SQL
  ...
  - Выделенный пул SQL (оплата по DWU подготовлен) — общедоступная версия
  - Бессерверный пул SQL (с оплатой за ТБ) — (Предварительная версия)
