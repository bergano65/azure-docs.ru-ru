...
description: Методы анализа приоритетов запросов для рабочей нагрузки в Azure Synapse Analytics.
...
`sys.dm_pdw_resource_waits` DMV показывает информацию о ожидании данного запроса. Время ожидания ресурсов измеряет время ожидания ресурсов. Время ожидания сигнала — это время, необходимое для того, чтобы базовые серверы S'L запланировали запрос на процессор.
