...
| [tempdb](sql-data-warehouse-tables-temporary.md) |Максимальный объем в ГБ |399 ГБ на DW100c. Поэтому в DWU1000c база данных tempdb имеет размер до 3,99 ТБ. |
||||
