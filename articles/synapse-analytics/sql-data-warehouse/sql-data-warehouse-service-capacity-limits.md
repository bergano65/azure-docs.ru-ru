...
|:--- |:--- |:--- |
| [Единицы использования хранилища данных (DWU)](what-is-a-data-warehouse-unit-dwu-cdwu.md) |Максимальный DWU для одного выделенного блока пула SQL (хранилища данных) | Поколение 1: DW6000<br></br>Поколение 2: DW30000c |
| [Единицы использования хранилища данных (DWU)](what-is-a-data-warehouse-unit-dwu-cdwu.md) |Стандартное количество единиц передачи данных (DTU) для одного сервера |54 000<br></br>По умолчанию каждый SQL Server (например, myserver.database.windows.net) имеет квоту DTU 54 000, что позволяет до DW5000c. Эта квота является просто ограничением для безопасности. Вы можете увеличить квоту, [создав запрос в службу поддержки](sql-data-warehouse-get-started-create-support-ticket.md) и выбрав *квоту* в качестве типа запроса.  Чтобы вычислить потребности в DTU, умножьте 7,5 на общее количество DWU или умножьте 9,5 на общее cDWU. Пример:<br></br>6000 DWU x 7,5 = 45 000 DTU<br></br>DW5000c x 9,5 = 47 500 DTU.<br></br>Текущее потребление DTU можно просмотреть в настройке SQL Server на портале. В рамках квоты DTU учитываются как приостановленные, так и активные базы данных. |
