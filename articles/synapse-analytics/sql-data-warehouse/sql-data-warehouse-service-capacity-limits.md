...
description: Максимальное число допустимых значений для различных компонентов пула синапсе SQL в Azure синапсе.
...
| Пакетная служба Azure |Максимальный объем |65 536*4096 |
