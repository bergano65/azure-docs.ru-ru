...
| Размер хранилища данных (ГБ) | Общий размер базы данных. Сюда входят использованное, зарезервированное и нераспределенное пространства. Нераспределенное пространство предоставляется базе данных для оптимизации производительности запросов и нагрузки. | SUM |
| Размер данных аварийного восстановления (ГБ) | Общий размер географической резервной копии, создаваемой каждые 24 часа. | SUM |
| Размер хранилища моментальных снимков (ГБ) | Общий размер моментальных снимков, созданных для обеспечения точек восстановления базы данных. Сюда входят создаваемые автоматически и определяемые пользователем моментальные снимки. | SUM |
