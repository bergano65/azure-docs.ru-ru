...
Приостановка вычислительных ресурсов приводит к отключению уровня хранилища от вычислительных узлов. Ресурсы вычислений освобождаются из вашей учетной записи. Пока вычислительные ресурсы приостановлены, плата за их использование не взимается. При возобновлении работы вычислительных ресурсов хранилище подключается к вычислительным узлам и начинает взиматься плата за вычисления. При приостановке вбассейна S'L:
...
Масштабирование пула S'L требует разрешений, описанных в [ALTER DATABASE.](/sql/t-sql/statements/alter-database-azure-sql-data-warehouse)  Чтобы приостановить и возобновить работу, нужны разрешения [Участник баз данных SQL](../../role-based-access-control/built-in-roles.md#sql-db-contributor), в частности Microsoft.Sql/servers/databases/action.
