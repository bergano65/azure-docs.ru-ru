...
description: Рекомендации по разработке распределенных хэш-распределенных и круговых распределенных таблиц в S'L Analytics.
...
ms.locfileid: "80351341"
---
# <a name="guidance-for-designing-distributed-tables-in-sql-analytics"></a>Руководство по разработке распределенных таблиц в аналитике S'L
Рекомендации по разработке распределенных хэш-распределенных и круговых распределенных таблиц в S'L Analytics.

В этой статье предполагается, что вы знакомы с концепциями распределения данных и перемещения данных в S'L Analytics.Для получения более подробной информации [см.](massively-parallel-processing-mpp-architecture.md) 
...
Поскольку идентичные значения всегда хэшируют в одном и том же дистрибутиве, аналитика S'L имеет встроенные знания о местоположениях строк. Для минимизации перемещения данных во время запросов аналитика S'L Analytics использует эти знания, что повышает производительность запросов. 
...
Учебные [данные Load New York taxicab](load-data-from-azure-blob-storage-using-polybase.md#load-the-data-into-your-data-warehouse) приводят пример загрузки данных в круглогодичный плацдарм в S'L Analytics.
...
- [CREATE TABLE (Аналитика СЗЛ)](https://docs.microsoft.com/sql/t-sql/statements/create-table-azure-sql-data-warehouse)
- [CREATE TABLE AS SELECT (Аналитика СЗЛ)](https://docs.microsoft.com/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse)
