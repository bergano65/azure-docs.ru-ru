...
В этой статье предполагается, что вы знакомы с концепциями распределения данных и перемещения данных в синапсе SQL.  Дополнительные сведения см. в статье [архитектура Azure синапсе Analytics](massively-parallel-processing-mpp-architecture.md).
