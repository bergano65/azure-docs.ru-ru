...
Поскольку одинаковые значения всегда хэшируются в одно и то же распределение, SQL Analytics имеет встроенные знания о расположении строк. В выделенном пуле SQL эти знания используются для уменьшения перемещения данных во время запросов, что повышает производительность запросов.
