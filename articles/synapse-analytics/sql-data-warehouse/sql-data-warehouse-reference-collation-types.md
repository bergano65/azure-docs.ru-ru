...
description: Типы параметров сортировки, поддерживаемые для выделенного пула SQL в Azure синапсе Analytics.
...
ms.locfileid: "93305252"
---
# <a name="database-collation-support-for-dedicated-sql-pool-in-azure-synapse-analytics"></a>Поддержка параметров сортировки базы данных для выделенного пула SQL в Azure синапсе Analytics 
