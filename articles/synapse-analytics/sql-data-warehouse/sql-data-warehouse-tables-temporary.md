...
Временные таблицы полезны при обработке данных, особенно во время преобразования, когда промежуточные результаты являются временными. С помощью аналитики S'L существуют временные таблицы на уровне сессии.  Они видны только на сеансе, в котором они были созданы. Таким образом, они автоматически отключается при отключении сеанса. 
...
Чтобы узнать больше о разработке таблиц, см. [таблицы проектирования с помощью статьи ресурсов S'L Analytics.](sql-data-warehouse-tables-overview.md)
