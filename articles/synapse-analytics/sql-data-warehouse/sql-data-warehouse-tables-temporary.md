...
description: Основные рекомендации по использованию временных таблиц в Хранилище данных Azure S'L, подчеркивающие принципы временных таблиц уровня сеанса.
