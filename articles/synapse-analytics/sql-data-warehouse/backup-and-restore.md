...
> [!IMPORTANT]
> При удалении сервера, на котором размещен пул SQL, все базы данных, принадлежащие серверу, также удаляются и не могут быть восстановлены. Удаленный сервер восстановить невозможно.
