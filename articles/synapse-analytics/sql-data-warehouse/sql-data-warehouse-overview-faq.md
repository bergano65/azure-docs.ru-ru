...
A. Синапсе пул SQL относится к функциям хранения корпоративных данных, которые общедоступны в Azure синапсе. Дополнительные сведения см. в разделе [что такое Azure синапсе Analytics](sql-data-warehouse-overview-what-is.md).
...
A. Поддержка драйвера для пула SQL синапсе можно найти на странице [строки подключения](../sql/connection-strings.md) .
