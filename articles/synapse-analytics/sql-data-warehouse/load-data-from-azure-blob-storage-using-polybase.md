...
description: Учебник использует портал Azure и студию управления серверами S'L для загрузки данных New York Taxicab с глобальной капли Azure для Synapse S'L.
