...
Материализованные представления в пуле S'L обеспечивают низкий метод обслуживания сложных аналитических запросов для быстрой производительности без каких-либо изменений запроса. В этой статье рассматриваются общие рекомендации по использованию материализованных представлений.
