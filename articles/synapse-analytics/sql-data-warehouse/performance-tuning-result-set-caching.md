...
description: Общие сведения о функции кэширования результирующего набора для пула Synapse SQL в Azure Synapse Analytics.
...
> [!IMPORTANT]
> Операции по созданию кэша результирующего набора и извлечению данных из кэша выполняются на управляющем узле экземпляра пула Synapse SQL.
...
Исключением из кэша автоматически управляет Synapse SQL по следующему расписанию:
