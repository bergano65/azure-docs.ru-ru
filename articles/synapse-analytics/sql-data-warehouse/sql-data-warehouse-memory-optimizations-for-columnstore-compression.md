...
Подробные сведения о требованиях к памяти columnstore см. в [статье масштабирование пула SQL видео синапсе: Конфигурация и рекомендации](https://channel9.msdn.com/Events/Ignite/2016/BRK3291).
...
Индексы columnstore создают одну или несколько групп строк в каждой секции. Для пула SQL в Azure синапсе Analytics количество секций быстро растет, так как данные распределяются и каждое распределение секционировано.
...
Дополнительные способы повышения производительности пула SQL см. в [обзоре производительности](cheat-sheet.md).
