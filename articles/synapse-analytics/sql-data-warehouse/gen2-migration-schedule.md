...
- Ответ. Нет. Геоархивация — это корпоративная функция для сохранения доступности пула SQL в случае, когда регион становится недоступным. Если у вас возникнут дополнительные вопросы, откройте [запрос в службу поддержки](sql-data-warehouse-get-started-create-support-ticket.md).
