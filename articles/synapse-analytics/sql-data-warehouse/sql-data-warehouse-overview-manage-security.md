...
Azure Synapse Analytics использует правила IP-брандмауэра уровня сервера. Он не поддерживает правила IP-брандмауэра уровня базы данных. Для получения дополнительной [Azure SQL Database firewall rules](../../sql-database/sql-database-firewall-configure.md?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json) информации см.
...
Подробнее и примерах при подключении к складу с различными протоколами можно найти в [пуле Connect to s-L.](../sql/connect-overview.md)
