...
* [СОЗДАНИЕ ВНЕШНЕЙ ТАБЛИЦЫ](https://msdn.microsoft.com/library/dn935021.aspx)
* [СОЗДАНИЕ ФУНКЦИИ](https://msdn.microsoft.com/library/mt203952.aspx)
...
* [DBCC SHOWRESULTCACHESPACEUSED](/sql/t-sql/database-console-commands/dbcc-showresultcachespaceused-transact-sql) (Предварительный просмотр)
...
* [Состояние поиска](https://msdn.microsoft.com/library/ms173545.aspx)
...
* [СОЗДАНИЕ ВХОДА](https://msdn.microsoft.com/library/ms189751.aspx)
* [СОЗДАНИЕ КЛЮЧА MASTER](https://msdn.microsoft.com/library/ms174382.aspx)
* [CREATE ROLE](https://msdn.microsoft.com/library/ms187936.aspx)
* [СОЗДАНИЕ ПОЛЬЗОВАТЕЛЯ](https://msdn.microsoft.com/library/ms173463.aspx)
