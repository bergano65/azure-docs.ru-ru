...
Руководство по использованию классов ресурсов для управления памятью и параллелизмом для запросов пула Synapse S'L в Azure Synapse.  

## <a name="what-are-resource-classes"></a>Что такое классы ресурсов

Производительность запроса определяется классом ресурсов пользователя.  Классы ресурсов представляют заранее определенные ограничения ресурсов в пуле Synapse S'L, которые регулируют вычислительные ресурсы и парируют для выполнения запросов. Классы ресурсов могут помочь настроить ресурсы для запросов, установив ограничения на количество запросов, которые работают одновременно, и на вычислительные ресурсы, назначенные каждому запросу.  Есть компромисс между памятью и параллелизмом.
