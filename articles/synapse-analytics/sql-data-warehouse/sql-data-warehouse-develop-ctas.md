...
Инструкции MERGE, по крайней мере, в части, можно заменить с помощью CTAS. Можно объединить и в `INSERT` `UPDATE` одну инструкцию. Все удаленные записи должны быть ограничены `SELECT` инструкцией, чтобы исключить их из результатов.
