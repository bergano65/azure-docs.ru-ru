---
title: Подключение к пулу SQL в Azure синапсе
...
ms.locfileid: "98685265"
---
# <a name="connect-to-a-sql-pool-in-azure-synapse"></a>Подключение к пулу SQL в Azure синапсе 

Подключитесь к пулу SQL в Azure синапсе.
