...
- Предварительно сортировать данные по сортированному ключу (ы) перед загрузкой их в таблицы.
