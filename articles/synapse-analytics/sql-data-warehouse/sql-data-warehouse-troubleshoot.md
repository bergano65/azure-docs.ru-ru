...
| Реализация рекомендаций                              | Лучшее место, чтобы начать, чтобы узнать способы повышения производительности запроса является [Synapse S'L бассейн лучших практик](sql-data-warehouse-best-practices.md) статьи. |
