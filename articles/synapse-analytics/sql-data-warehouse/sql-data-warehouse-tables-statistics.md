...
Часто рекомендуется расширить процесс загрузки данных, чтобы обеспечить обновление статистики в конце нагрузки, чтобы избежать/минимизировать блокировку или спор ресурсов между параллельными запросами.  
