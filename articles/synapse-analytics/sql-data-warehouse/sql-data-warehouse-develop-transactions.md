...
Хранилище данных SQL реализует транзакции ACID. Уровень изоляции транзакционной поддержки является дефолтом READ UNCOMMITTED.  Вы можете изменить его на READ COMMITTED SNAPSHOT ISOLATION, превратив на READ_COMMITTED_SNAPSHOT вариант базы данных для базы данных пользователей при подключении к основной базе данных.  После включения все транзакции в этой базе данных выполняются в соответствии с READ COMMITTED SNAPSHOT ISOLATION и установка READ UNCOMMITTED на уровне сессии не будет выполнена. Проверьте [варианты ALTER DATABASE SET (Трансакт-СЗЛ)](https://docs.microsoft.com/sql/t-sql/statements/alter-database-transact-sql-set-options?view=azure-sqldw-latest) для получения подробной информации.
...
Узнайте больше об оптимизации транзакций, ознакомившись с разделом [Оптимизация транзакций для хранилища данных SQL](sql-data-warehouse-develop-best-practices-transactions.md). Ознакомьтесь с дополнительными [рекомендациями по использованию хранилища данных SQL Azure](sql-data-warehouse-best-practices.md).
