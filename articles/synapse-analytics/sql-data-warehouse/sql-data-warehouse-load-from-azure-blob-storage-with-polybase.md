...
Используйте эту команду [CREATE EXTERNAL DATA SOURCE](/sql/t-sql/statements/create-external-data-source-transact-sql?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest) для хранения местоположения данных и типа данных.
...
Теперь, когда вы указали источник данных и формат файла, вы готовы создать схему для внешних таблиц.
