---
title: Управляемое удостоверение в рабочей области Azure Synapse
...
Azure Synapse использует управляемое удостоверение для оркестрации конвейеров. Жизненный цикл управляемого удостоверения напрямую связан с рабочей областью Azure Synapse. Если удалить рабочую область Azure Synapse, то управляемое удостоверение также будет очищено.
...
[Предоставление разрешений для управляемого удостоверения рабочей области Azure Synapse (предварительная версия)](./how-to-grant-workspace-managed-identity-permissions.md)
