...
description: Узнайте, как управлять доступом к рабочим областям, данным и конвейерам в Azure Synapse Analytics.
...
ms.locfileid: "96461345"
---
# <a name="manage-access-to-workspaces-data-and-pipelines"></a>Управление доступом к рабочим областям, данным и конвейерам

Узнайте, как управлять доступом к рабочим областям, данным и конвейерам в Azure Synapse Analytics.
