...
- Убедитесь, что MSI (Управляемое удостоверение службы) для WS1 назначен роли **участника данных BLOB-объекта хранилища** в CNT1
...
| Использование концентратора мониторинга | YES | YES | YES |
| Выполнение мониторинга концентратора, оркестрации или конвейера  | YES | NO | NO |
| Выполнение мониторинга концентратора/оркестрации/триггера  | YES | NO | NO |
| Мониторинг концентратора, оркестрации и сред выполнения интеграции  | YES | YES | YES |
| Мониторинг концентраторов, действий и приложений Spark | YES | YES | NO  |
| Мониторинг концентратора/действий/запросов SQL | YES | NO | YES |
| Мониторинг концентратора, действий и пулов Spark | YES | YES | NO  |
| Мониторинг концентратора/триггеров | YES | NO | NO |
| Управление центрами и связанными службами | YES | YES | YES |
| Управление концентратором и доступом (назначение пользователей для ролей рабочей области синапсе) | YES | NO | NO |
| Управление центрами и средами выполнения интеграции | YES | YES | YES |
