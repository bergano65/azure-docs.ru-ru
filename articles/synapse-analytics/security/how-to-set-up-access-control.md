---
title: Защита рабочей области Synapse
...
ms.locfileid: "96458718"
---
# <a name="secure-your-synapse-workspace"></a>Защита рабочей области Synapse 
...
- Выберите группу ресурсов — необходим доступ к группе ресурсов, для которой назначена роль **владельца** .
- Присвойте рабочей области имя WS1.
- Выберите STG1 для учетной записи хранения —. Выберите CNT1 для контейнера, который используется в качестве файловой системы.
...
## <a name="step-5-configure-admin-access-for-synapse-sql"></a>Шаг 5. Настройка административного доступа для синапсе SQL
...
| Число | Шаг | Администраторы рабочей области | Администраторы Spark | Администраторы SQL |
| --- | --- | --- | --- | --- |
| 1 | Отправка файла Parquet в CNT1 | YES | YES | YES |
| 2 | Чтение файла Parquet с помощью бессерверного пула SQL | YES | NO | YES |
| 3 | Создание бессерверного пула Apache Spark | YES [1] | YES [1] | NO  |
...
| 6 | Создание выделенного пула SQL и выполнение сценария SQL, например &quot; SELECT 1&quot; | YES [1] | NO | YES[1] |
...
| Доступ к данным в базах данных SQL синапсе и Data Hub | YES   | NO   | YES   |
| Данные концентратора данных и доступ к ним в базах данных несерверного пула SQL | YES [2]  | NO  | YES [2]  |
...
| Управление центром и синапсе SQL | YES | NO | YES |
