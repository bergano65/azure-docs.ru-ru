---
title: Краткий справочник. Azure Synapse Analytics (предварительная версия рабочих областей)
...
| **SQL по запросу**   | Созданная для крупномасштабных данных система распределенной обработки данных позволяет выполнять запросы T-SQL к данным в озере. Ее бессерверная инфраструктура сокращает необходимость в управлении.       |
