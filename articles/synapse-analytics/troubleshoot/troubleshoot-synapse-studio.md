...
![На снимке экрана показано, что не удалось установить соединение с сообщением сервера.](media/troubleshooting-synapse-studio/symptom2.png)
...
![На снимке экрана показано окно DevTools с сетью и отключить кэш Online.](media/troubleshooting-synapse-studio/network-panel.png)
...
- состояние начинается с "(не выполнено)", либо расширьте столбец "состояние", либо наведите указатель мыши на текст состояния, чтобы увидеть полный текст. Включите текст и (или) снимок экрана при открытии запроса в службу поддержки.
    ...
    ![На снимке экрана отображаются результаты, включая значение Failed в столбце Status (состояние).](media/troubleshooting-synapse-studio/status-text.png)
...
![На снимке экрана показано окно DevTools с выделенной буквой U R L в заголовках ответа.](media/troubleshooting-synapse-studio/item-details.png)
...
![На снимке экрана показано окно DevTools, размер которого позволяет отобразить сообщение целиком для возможного снимка экрана.](media/troubleshooting-synapse-studio/developer-tool-console.png)
...
![На снимке экрана показано окно DevTools с параметрами, выбранными в контекстном меню.](media/troubleshooting-synapse-studio/developer-tool-console-settings.png)

![На снимке экрана показаны настройки окна DevTools с выбранным параметром Показать метки времени.](media/troubleshooting-synapse-studio/show-time-stamp.png)
