---
title: Краткое руководство по загрузке данных в пул SQL с помощью действия Копирования
description: Использование Azure Synapse Analytics для загрузки данных в пул SQL
...
ms.locfileid: "93280851"
---
# <a name="quickstart-load-data-into-sql-pool-using-copy-activity"></a>Краткое руководство. Загрузка данных в пул SQL с помощью действия Копирования
...
Из этого краткого руководства вы узнаете, как *загрузить данные из Базы данных SQL Azure в Azure Synapse Analytics*. Чтобы копировать данные из других типов хранилищ, необходимо выполнить аналогичные шаги. К копированию данных между другим источником и приемником применяется подобная последовательность действий.
...
* Azure Synapse Analytics. Пул SQL используется в качестве хранилища данных приемника. Если у вас нет экземпляра Azure Synapse Analytics, выполните действия, приведенные в статье [Создание пула SQL](quickstart-create-sql-pool-portal.md), чтобы создать его.
...
* Откройте рабочую область Synapse на [портале Azure](https://ms.portal.azure.com/#home). В верхней области раздела Обзор выберите **Запуск Synapse Studio**.
...
В Azure Synapse Analytics связанная служба используется для определения сведений о подключении к другим службам. В этом разделе вы создадите следующие два типа связанных служб: База данных SQL Azure и связанные службы Azure Data Lake Storage 2-го поколения.
...
Конвейер содержит логический поток для выполнения набора действий. Проходя этот раздел, вы создадите конвейер, содержащий действие копирования, которое принимает данные из Базы данных SQL Azure в пул SQL.
...
1. Выберите **Пул SQL Analytics** в качестве хранилища данных, затем — **Продолжить**.
