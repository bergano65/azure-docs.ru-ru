...
- Запуск автоматизированных экспериментов ML с помощью Машинное обучение Azure и Azure синапсе Analytics: [руководство по аутомл](./spark/../apache-spark-autoscale.md) 
