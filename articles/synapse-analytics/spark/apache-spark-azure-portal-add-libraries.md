...
При запуске экземпляра Spark эти библиотеки будут автоматически добавлены. Дополнительные Python и пользовательские пакеты, созданные на языке, можно добавить на уровне пула Spark.
