...
- [Краткое руководство. Создание пула Apache Spark (предварительной версии) в Synapse Analytics с помощью веб-средств](./apache-spark-notebook-create-spark-use-sql.md)
...
- [Создание пула Apache Spark (предварительной версии) в Synapse Analytics с помощью веб-средств](./apache-spark-notebook-create-spark-use-sql.md)
