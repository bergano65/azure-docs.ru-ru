...
Примечание. столбец индекса — это столбец, который отображается в фильтрах или условиях объединения. Включенный столбец — это столбец, который отображается в выбранном проекте.
...
&nbsp;&nbsp;показаны только первые пять строк &nbsp;&nbsp;
