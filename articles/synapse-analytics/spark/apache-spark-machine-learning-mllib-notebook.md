...
4. В зависимости от созданного размера набора данных и необходимости поэкспериментировать или запустить записную книжку может быть целесообразно кэшировать набор данных локально в рабочую область. Существует три способа выполнения явного кэширования:
