...
- У вас должны быть разрешения на доступ к рабочей области по меньшей мере с ролью RBAC участника данных BLOB-объектов хранилища в учетной записи ADLS 2-го поколения.
