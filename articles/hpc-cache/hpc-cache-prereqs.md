...
* **Доступ в порт:** Кэшу необходим доступ к определенным портам TCP/UDP в вашей системе хранения данных. Различные типы хранения имеют различные портовые требования.
  ...
  * В дополнение к портам, возвращенным `rpcinfo` командой, убедитесь, что эти широко используемые порты позволяют входящих и исходящих трафика:
...
* **Доступ к корням:** Кэш подключается к системе бэк-энда в качестве идентификатора пользователя 0. Проверьте эти настройки в вашей системе хранения данных:
