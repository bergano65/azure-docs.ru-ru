---
title: Получение данных для предварительной версии кэша Azure HPC — копирование вручную
...
ms.locfileid: "71299988"
---
# <a name="azure-hpc-cache-preview-data-ingest---manual-copy-method"></a>Прием данных кэша Azure HPC (Предварительная версия) — метод копирования вручную
...
При наличии достаточного количества параллельных потоков для одной конечной точки монтирования файловой системы будет существовать точка, где Добавление дополнительных потоков не даст больше пропускной способности. (Пропускная способность будет измеряться в файлах в секунду или в байтах в секунду, в зависимости от типа данных.) Что еще хуже, многопоточность иногда может привести к ухудшению пропускной способности.  
...
После понимания описанных выше подходов (несколько копий-потоков на место назначения, несколько назначений на клиент, несколько клиентов на исходную сетевую файловую систему) следует рассмотреть следующую рекомендацию: создайте манифесты файлов, а затем используйте их с командами копирования для нескольких клиентов.
