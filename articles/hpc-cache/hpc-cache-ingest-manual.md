...
Например, если каталог содержит 1000 файлов, последовательно пронумерованных от до `0001` `1000`, можно использовать следующие выражения для создания 10 параллельных потоков, каждый из которых копирует файлы 100:
