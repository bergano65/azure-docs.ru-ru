...
После того как вы понимаете подходы, описанные выше (несколько копий-потоков на каждый клиент, несколько клиентов на исходную файловую систему с доступом к сети), рассмотрите следующие рекомендации: сборка манифестов файлов и их использование с копированием команды для нескольких клиентов.
