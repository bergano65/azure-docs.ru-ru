...
Если кэш находится в регионе, поддерживающем управляемые клиентом ключи шифрования, на вкладках **кэш** и **теги** отображается страница **ключи шифрования диска** . По времени публикации этот вариант поддерживается в восточной части США, юго-центральном регионе США и западной части США 2.
