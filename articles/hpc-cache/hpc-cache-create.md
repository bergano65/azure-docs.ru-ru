...
![снимок экрана: страница со сведениями о проекте на портале Azure](media/create-1.png)
...
![снимок экрана: страница определения размера кэша](media/create-cache-iops.png)
...
![снимок экрана: страница целевых объектов хранилища](media/create-targets.png)
...
Пошаговые инструкции по добавлению целевого объекта хранилища см. в статье [Add storage](hpc-cache-add-storage.md) (Добавление хранилища). Процедура отличается для экспорта хранилища BLOB-объектов или NFS.
...
Создание кэша занимает около 10 минут. Вы можете отслеживать ход создания на панели уведомлений на портале Azure. По завершении появится уведомление со ссылкой на новый экземпляр Azure HPC Cache. 

Кэш также отображается в списке **Ресурсы** вашей подписки. 

![снимок экрана: экземпляр Azure HPC Cache на портале Azure](media/finished-hpc-cache.png)
