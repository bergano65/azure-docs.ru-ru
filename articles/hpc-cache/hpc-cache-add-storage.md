...
Если необходимо изменить целевой объект хранилища, прочитайте статью [Изменение целевых объектов хранилища](hpc-cache-edit-storage.md) , чтобы узнать, как это сделать.
