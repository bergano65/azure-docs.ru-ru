...
Список расширений виртуальной машины на сервере с поддержкой Arc можно получить на портал Azure. Чтобы увидеть их, выполните следующие действия.

1. В браузере перейдите на [портал Azure](https://portal.azure.com).

2. На портале перейдите к пункту **серверы — дугу Azure** и выберите Гибридный компьютер из списка.

3. Выберите **расширения**, и будет возвращен список установленных расширений.

    ![Список расширений виртуальных машин, развернутых на выбранном компьютере](./media/manage-vm-extensions/list-vm-extensions.png)
