...
В этом учебнике описывается, как создать назначение политики для идентификации компьютеров с серверами с поддержкой Azure Arc и идентификации ими компьютеров с поддержкой Arc Azure, на которых не установлен агент Log Analytics.
