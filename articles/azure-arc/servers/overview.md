...
- Добавьте серверы, не относящиеся к Azure, в механизм обнаружения угроз и заблаговременно отслеживайте потенциальные угрозы безопасности через [Центр безопасности Azure](../../security-center/security-center-intro.md).
