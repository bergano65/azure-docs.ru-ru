...
description: Сведения о том, как использовать сервера с поддержкой Azure Arc (предварительная версия), чтобы управлять компьютерами, размещенными вне Azure, как ресурсами Azure.
