...
Используйте одну из следующих процедур для удаления агента Windows или Linux с помощью командной строки или мастера настройки, описанного в этом разделе. Перед установкой агента сначала отключите машину от Azure Arc для серверов (предварительного просмотра), выполнив следующие действия: 
