...
1. На странице **серверы — Azure Arc** выберите **Добавить** в левом верхнем углу.

1. На странице **Выбор метода** выберите элемент **Добавить серверы с помощью интерактивного скрипта** , а затем выберите **создать скрипт**.
...
1. На странице **Создать скрипт** выберите подписку и группу ресурсов, которые следует использовать для управления компьютером в Azure. Выберите расположение Azure, в котором будут храниться метаданные компьютера.
    ...
    >[!NOTE]
    >Серверы с поддержкой Arc Azure поддерживают только следующие регионы:
    >- EastUS
    >- WestUS2
    >- WestEurope
    >- SoutheastAsia
...
1. На странице **необходимые компоненты** просмотрите сведения и нажмите кнопку **Далее: сведения о ресурсах**.
...
1. На странице **сведения о ресурсе** укажите следующее.
    ...
    1. В раскрывающемся списке **Операционная система** выберите операционную систему, в которой будет выполняться сценарий.
...
1. На странице **теги** проверьте предлагаемые по умолчанию **теги физического расположения** и введите значение или укажите один или несколько **настраиваемых тегов** для поддержки своих стандартов.

1. Нажмите кнопку **Далее: Скачайте и запустите сценарий**.

1. На странице **Загрузка и запуск скрипта** просмотрите сводные данные и нажмите кнопку **скачать**. Если вам все еще нужно внести изменения, щелкните **Назад**.
