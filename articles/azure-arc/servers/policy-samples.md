...
ms.locfileid: "82836582"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-arc-for-servers"></a>Встроенные определения политик в Политике Azure для Azure Arc для серверов
