...
9. В предварительной версии поддерживается только косвенно подключенный режим.
10. Выберите профиль конфигурации развертывания.
11. Нажмите кнопку **Открыть в Azure Studio** .
12. На следующем экране вы увидите сводку по выбранным параметрам и созданную записную книжку.  Чтобы скачать записную книжку, нажмите кнопку **скачать подготовку к учетной записной книжке** .
13. Откройте записную книжку в Azure Data Studio и нажмите кнопку **запустить все** в верхней части страницы.
14. Следуйте указаниям и инструкциям в записной книжке, чтобы завершить создание контроллера данных.
