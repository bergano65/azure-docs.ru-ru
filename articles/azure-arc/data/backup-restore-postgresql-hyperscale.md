---
title: Резервное копирование и восстановление для групп серверов PostgreSQL в базе данных Azure для масштабирования
description: Резервное копирование и восстановление для групп серверов PostgreSQL в базе данных Azure для масштабирования
services: azure-arc
...
## <a name="list-backups"></a>Список резервных копий
