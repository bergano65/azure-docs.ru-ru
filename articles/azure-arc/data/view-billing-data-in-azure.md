...
Дополнительные сведения о различиях между [режимами подключения](https://docs.microsoft.com/azure/azure-arc/data/connectivity)см. в этой статье.
