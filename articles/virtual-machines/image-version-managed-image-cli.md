---
title: Клонирование управляемого образа в версию образа с помощью Azure CLI
description: Узнайте, как клонировать управляемый образ в версию образа в общей коллекции образов с помощью Azure CLI.
author: cynthn
