...
В Azure Resource Manager (ARM) существует [функция Base64](https://docs.microsoft.com/azure/azure-resource-manager/templates/template-functions-string#base64).
...
Мы советуем **не** хранить конфиденциальные данные в пользовательских. Дополнительные сведения см. в статье [Рекомендации по защите и шифрованию данных в Azure](https://docs.microsoft.com/azure/security/fundamentals/data-encryption-best-practices).
