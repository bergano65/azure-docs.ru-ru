...
Дополнительные сведения об изменении размера виртуальной машины Windows см. в статье [изменение размера](linux/change-vm-size.md)виртуальной машины Linux.  
...
| Размер: размер и имя | vCPU | Память|Сетевые адаптеры (макс.)| Максимальный размер временного диска | Максимальное значение: количество дисков данных (по 1023 ГБ)| Максимальное значение: количество операций ввода-вывода в секунду (300 на диск) |
|---|---|---|---|---|---|---|
