...
В этом разделе содержатся сведения о старых поколениях размеров виртуальных машин. Эти размеры по-прежнему поддерживаются, но не могут получить дополнительную емкость. Существуют более новые или альтернативные размеры, доступные в целом. Ознакомьтесь с [размером виртуальных машин в Azure](./sizes.md) , чтобы выбрать размеры виртуальных машин, которые лучше подходят для ваших нужд.  
...
**Новый рекомендуемый размер**: серии [Dasv4](dav4-dasv4-series.md), серии [Dsv4](dv4-dsv4-series.md) и [Ddsv4](ddv4-ddsv4-series.md)
...
**Рекомендуемый новый размер**: [серия Lsv2](lsv2-series.md)
...
Максимально возможная пропускная способность дисков виртуальных машин серии Ls может быть ограничена из-за числа, размера и чередования любых подключенных дисков. Дополнительные сведения см. в разделе [проектирование для обеспечения высокой производительности](premium-storage-performance.md).

<sup>1</sup> Экземпляр изолирован на оборудовании, выделенном единственному заказчику.

### <a name="gs-series"></a>Серия GS

**Новый рекомендуемый размер**: серии [Easv4](eav4-easv4-series.md), [Esv4](ev4-esv4-series.md), [Edsv4-](edv4-edsv4-series.md) Series и [M](m-series.md) .
...
**Новый рекомендуемый размер**: серия [Eav4](eav4-easv4-series.md), серии [Ev4](ev4-esv4-series.md) , серии [Edv4](edv4-edsv4-series.md) и серии [M](m-series.md) .
...
**Рекомендуемый новый размер**: [NC T4 v3-Series](nct4-v3-series.md)
...
**Новые рекомендации по размеру**: [NC T4 серии v3](nct4-v3-series.md) и [NC V100 v3-Series](ncv3-series.md)
...
**Рекомендуемый новый размер**: серии [NDv2](ndv2-series.md) и [NC V100 v3-Series](ncv3-series.md)
