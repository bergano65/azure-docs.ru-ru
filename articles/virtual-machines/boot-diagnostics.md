...
> [!IMPORTANT]
> Клиенты Azure не будут платить за ресурсы хранилища, ассоЦитед с помощью диагностики загрузки, используя управляемую учетную запись хранения с 2020 октября.
