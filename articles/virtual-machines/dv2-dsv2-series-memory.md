...
ms.locfileid: "99088910"
---
# <a name="memory-optimized-dv2-and-dsv2-series"></a>Оптимизированные для памяти Dv2 и серии Dsv2

Серия Dv2 и Dsv2 — это последить за исходными сериями D, которые имеют более мощный процессор. Размеры серии DSv2 работают на процессорах Intel® Xeon® Platinum 8272CL (Cascade Lake), Intel® Xeon® 8171M 2,1 ГГц (Skylake) или Intel® Xeon® 2673-Broadwell v4 2,3 ГГц (2673) или Intel® Xeon® Haswell-v3 2,4 ГГц. Серия Dv2 имеет такие же конфигурации памяти и диска, как и серия D.

## <a name="dv2-series-11-15"></a>Серия Dv2 11–15

Размеры серии Dv2 работают на процессорах Intel® Xeon® Platinum 8272CL (Cascade Lake), Intel® Xeon® 8171M 2,1 ГГц (Skylake) или Intel® Xeon® 2673-Broadwell v4 2,3 ГГц (2673) или Intel® Xeon® Haswell-v3 2,4 ГГц.
...
Размеры серии DSv2 работают на процессорах Intel® Xeon® Platinum 8272CL (Cascade Lake), Intel® Xeon® 8171M 2,1 ГГц (Skylake) или Intel® Xeon® 2673-Broadwell v4 2,3 ГГц (2673) или Intel® Xeon® Haswell-v3 2,4 ГГц.
...
<sup>1</sup> Максимальная возможная пропускная способность дисков (в операциях ввода-вывода в секунду или Мбит/с) виртуальных машин серии DSv2 может быть ограничена из-за количества, размера и чередования подключенных дисков.  Дополнительные сведения см. в статье [Хранилище Azure класса Premium. Проектирование для обеспечения высокой производительности](./premium-storage-performance.md).
