---
title: Средство миграции, поддерживаемое платформой.
...
* Оцените политики управления доступом на основе ролей Azure (Azure RBAC), которые настроены в ресурсах IaaS в классической модели развертывания, и запланируйте их после завершения миграции.
