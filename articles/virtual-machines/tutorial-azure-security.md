---
title: Руководство. Использование Центра безопасности Azure для виртуальных машин в Azure
description: В этом руководстве описаны функции Центра безопасности Azure для защиты виртуальных машин в Azure.
author: cynthn
manager: gwallace
...
ms.locfileid: "94594828"
---
# <a name="tutorial-use-azure-security-center-to-monitor-virtual-machines"></a>Руководство по Использование Центра безопасности Azure для мониторинга виртуальных машин
...
> [Создание конвейера для непрерывной интеграции и доставки с использованием Jenkins, GitHub и Docker](/azure/developer/jenkins/pipeline-with-github-and-docker)