...
|--------------|-------------------------------|
| Операций ввода-вывода в сек.         | Запросов данных в секунду             |
...
| Выполняющиеся задачи                     | Да                        | Да                                | Да                      | Да                  | Да                  |
...
- Правило HighCpuUsage: Обнаруживает высокие периоды использования ЦП и показывает топ потребителей загрузки ЦП в течение этих периодов.
- Правило HighDiskUsage: Выявляет высокие периоды использования дискового пространства на физических дисках и показывает основные потребители использования диска в течение этих периодов.
- Правило HighResolutionDiskMetric: Отображает метрики задержки операций ввода-вывода в секунду, пропускной способности и ввода/выводе в 50 миллисекунд для каждого физического диска. Это позволяет быстро найти периоды регулирования диска.
- Правило Хигхмеморюсаже: Обнаруживает высокие периоды использования памяти и показывает топ потребителей по использованию памяти в течение этих периодов.
