...
| Сведения из журналов событий       | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Сведения о системе                | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Сопоставление томов                        | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Сопоставление дисков                          | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Выполняемые задачи                     | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| счетчики надежности хранилища;      | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Сведения о хранилище               | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Выходные данные fsutil                     | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Сведения о драйвере фильтра                | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Выходные данные netstat                    | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Конфигурация сети             | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Настройка брандмауэра            | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Конфигурация SQL Server          | Yes                        | Да                                | Да                      | Да                  | Yes                  |
| Трассировки диагностики производительности*  | Yes                        | Да                                | Да                      | Да                  | Yes                  |
...
- Правило highcpuusage. определяет: Определяет периоды высокой загрузки ЦП и показывает основных потребителей ресурсов ЦП в эти периоды.
- Правило HighDiskUsage. Определяет периоды высокой на физических дисках и показывает потребителей top диска в эти периоды.
- Правило HighResolutionDiskMetric. Показывает метрики задержки операций ввода-ВЫВОДА, пропускной способности и операций ввода-вывода за 50 мс для каждого физического диска. Это позволяет быстро найти периоды регулирования диска.
- Правило HighMemoryUsage. Периоды большого объема памяти и показывает самые ресурсоемкие потребителей эти периоды.
...
-  Поддерживаются перечисленные ниже операционные системы. Windows Server 2008 R2, Windows Server 2012, Windows Server 2012 R2 и Windows Server 2016; Windows 8.1 и Windows 10.
...
4.  Откройте командную строку Windows с правами администратора, а затем запустите PerfInsights.exe, чтобы просмотреть доступные параметры командной строки.
    ...
    PerfInsights
    ```
    ![Снимок экрана выходных данных PerfInsights в командной строке](media/how-to-use-perfInsights/PerfInsightsCommandline.png)
