...
> [!NOTE]
> Для платформы Azure установлено ограничение на адресное пространство памяти на виртуальных машинах под управлением 32-разрядных операционных систем, где виртуальной машине предоставляется только 1 ГБ памяти, а оставшаяся часть памяти виртуальной машины будет отображаться как зарезервированная в гостевой виртуальной машине. Это известная проблема, и в настоящее время у нас нет проблем с исправлением. Мы рекомендуем перейти к версии 64 OS.
> 
