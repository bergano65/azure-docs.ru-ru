...
* Выходной сжатый файл (ZIP) (с именем **PerformanceDiagnostics_yyyy-mm-dd_hh-мм-СС-ФФФ. zip** ) в Windows и файл tar-файла (с именем **PerformanceDiagnostics_yyyy – mm-dd_hh-мм-СС-ФФФ. tar. gz** ) в Linux, который содержит файлы журналов
* отчет HTML.
