...
1.  В правом столбце команд выберите **Диагностика производительности**.
    ...
    > [!NOTE]
    > На этом снимке экрана в колонке имена виртуальных Машин будет скрыт.
...
**Вариант 1.** Автоматически делиться последнего отчета  
...
**Вариант 2.** Создать подпись общего доступа для сжатого файла отчета диагностики  
