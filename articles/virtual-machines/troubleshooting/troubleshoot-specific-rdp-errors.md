...
* [Удаленный сеанс отключен из-за отсутствия удаленный рабочий стол доступных серверов лицензирования для предоставления лицензии](#rdplicense).
...
* [Ошибка безопасности Windows: ваши учетные данные не работают](#wincred).
