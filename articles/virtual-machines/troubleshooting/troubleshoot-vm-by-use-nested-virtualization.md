...
## <a name="step-1-create-a-rescue-vm-and-install-hyper-v-role"></a>Шаг 1. Создание виртуальной машины для обслуживания и установка роли Hyper-V

1.  Создайте новую виртуальную машину спасения:

    -  Операционная система: Windows Server 2016 Datacenter

    -  Размер: Любой ряд v3 с минимум двумя ядрами, поддерживающими вложенную виртуализацию. Дополнительные сведения см. в записи блога, посвященной [обзору новых размеров виртуальных машин Dv3 и Ev3](https://azure.microsoft.com/blog/introducing-the-new-dv3-and-ev3-vm-sizes/).
...
## <a name="step-2-create-the-problem-vm-on-the-rescue-vms-hyper-v-server"></a>Шаг 2. Создание проблемной виртуальной машины на сервере Hyper-V виртуальной машины
...
5.  Откройте диспетчер Hyper-V: В **Диспетчер сервера**выберите **роль Hyper-V**. Щелкните сервер правой кнопкой мыши, а затем выберите **Диспетчер Hyper-V**.
