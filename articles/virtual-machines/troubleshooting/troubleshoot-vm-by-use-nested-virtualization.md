...
1.  Создайте новую виртуальную машину спасения:
    ...
    -  Размер: Все ряды V3 с по крайней мере два ядра, поддерживающими вложенную виртуализацию. Дополнительные сведения см. в записи блога, посвященной [обзору новых размеров виртуальных машин Dv3 и Ev3](https://azure.microsoft.com/blog/introducing-the-new-dv3-and-ev3-vm-sizes/).
...
## <a name="step-2-create-the-problem-vm-on-the-rescue-vms-hyper-v-server"></a>Шаг 2. Создание виртуальной Машины с неполадками на сервере Hyper-V виртуальной Машины спасения
...
5.  Откройте диспетчер Hyper-V: В **диспетчера серверов**выберите **роль Hyper-V**. Щелкните сервер правой кнопкой мыши, а затем выберите **Диспетчер Hyper-V**.
