...
SysRq — это последовательность клавиш, понятная ядру операционной системы Linux, которая может инициировать набор предопределенных действий. Эти команды часто используются, когда устранение или восстановление виртуальной машины не может быть выполнено с помощью традиционного администрирования (например, если VM не отвечает). Использование функции SysRq в последовательной консоли Azure будет имитировать нажатие клавиши SysRq и ввод символов на физической клавиатуре.
...
#### <a name="ubuntu"></a>Ubuntu ####
 - [Свалка ядра аварии](https://help.ubuntu.com/lts/serverguide/kernel-crash-dump.html)
