...
> **Не удалось удалить учетную запись хранения 'StorageAccountName'. Ошибка: учетная запись хранилища не может быть удалена из-за использования артефактов.**
> 
...
1. Войдите на [портал Azure](https://portal.azure.com).
2. В главном меню выберите **Все ресурсы**. Перейти к учетной записи хранения, под **Blob Службы** выбрать **контейнеры**, и найти контейнер для удаления.
