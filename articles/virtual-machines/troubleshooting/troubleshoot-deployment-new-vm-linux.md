...
Чтобы устранить обе эти ошибки, загрузите исходный VHD, доступный в помещениях, с той же настройкой, что и для ОС (обобщенные/специализированные). Чтобы передать диск как универсальный, сначала обязательно выполните команду -deprovision.
