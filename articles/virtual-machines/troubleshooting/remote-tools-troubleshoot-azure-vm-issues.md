...
* За пределами виртуальной сети или развертывания
  ...
  * Для виртуальной машины Azure Resource Manager сначала добавьте DNS-имя в общедоступный IP-адрес. Подробные инструкции приведены в статье [Создание полного доменного имени на портале Azure для виртуальной машины Windows](../create-fqdn.md). Затем выполните следующую команду:
...
- Дополнительные сведения о командлете Enter-PSSession см. в разделе [Ввод-PSSession](/powershell/module/microsoft.powershell.core/enter-pssession).
