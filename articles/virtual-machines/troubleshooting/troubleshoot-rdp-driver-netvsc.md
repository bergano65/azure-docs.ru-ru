...
Прежде чем выполнить эти шаги, [возьмите снимок системного диска](../windows/snapshot-copy-managed-disk.md) пострадавшего VM в качестве резервного копирования. Чтобы устранить эту проблему, воспользуйтесь последовательной консолью или [восстановите виртуальную машину в автономном режиме](#repair-the-vm-offline), присоединив ее системный диск к виртуальной машине для восстановления.
...
2. Скачайте соответствующее обновление на любой новый или существующий диск, который подключен к любой работающей виртуальной машине в том же регионе:
   ...
   - для **10.0.14393.594**: обновление [KB4073562](https://support.microsoft.com/help/4073562)  или более позднее;
   - для **10.0.15063.0**: обновление [KB4016240](https://support.microsoft.com/help/4016240) или более позднее.
...
3. Убедитесь, что диск помечен как **онлайн** в консоли управления диском. Запишите или запомните букву диска, которая назначена подключенному системному диску.
