...
* *\** _ Указывает загрузочный раздел, оба раздела должны быть подключены.

Выполните команду _ *лсблк**, чтобы просмотреть лвмс затронутой виртуальной машины.
