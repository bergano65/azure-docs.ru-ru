...
* **Конфигурация конечной точки для SSH-трафика на целевой виртуальной машине.** Частный TCP-порт на конечной точке должен совпадать с TCP-портом, который прослушивает SSH-служба на виртуальной машине. (Порт по умолчанию — 22.) Проверьте номер TCP-порта SSH в портал Azure, выбрав **виртуальные машины** > **Параметры** >  > *имя виртуальной машины***конечные точки**.
