...
## <a name="source-3-cloud-service-endpoint-and-acl"></a>Источник 3: Конечная точка облачной службы и ACL
...
> [!NOTE]
> Для виртуальных машин, созданных в Resource Manager, перейдите к [источник 4: Группы безопасности сети](#source-4-network-security-groups).
...
* Конфигурация конечной точки для трафика удаленного рабочего стола на целевой виртуальной Машине: Частный TCP-порт конечной точки должно соответствовать TCP-порт, который прослушивает служба удаленных рабочих столов для виртуальной Машины (значение по умолчанию — 3389).
* ACL для конечной точки удаленного рабочего стола трафик на целевой виртуальной Машине: Списки ACL позволяют пользователю указать разрешен или запрещен трафик из Интернета в зависимости от его исходный IP-адрес. Если он неправильно настроен, входящие данные с удаленного рабочего стола на эту конечную точку могут блокироваться. Проверьте свои списки управления доступом и убедитесь в том, что входящий трафик с общедоступных IP-адресов вашего прокси-сервера или другого пограничного сервера разрешен. Дополнительные сведения см. в статье [Список управления доступом (ACL) конечной точки](../../virtual-network/virtual-networks-acl.md).
