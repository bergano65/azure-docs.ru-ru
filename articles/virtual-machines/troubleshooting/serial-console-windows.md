...
1.  Введите `ch -si 1` или нажмите клавишу `<esc>+<tab>` сочетания клавиш, чтобы перейти к каналу, на котором работает экземпляр CMD.
