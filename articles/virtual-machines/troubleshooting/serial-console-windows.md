...
Некоторые данные при вводе с клавиатуры создают странные выходные данные SAC (например, **[A**, **[3~** ). | Еscape-последовательность [VT100](/windows/console/console-virtual-terminal-sequences) не поддерживается в командной строке SAC.
