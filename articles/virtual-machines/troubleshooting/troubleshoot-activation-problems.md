...
5. Проверьте использование [наблюдателя за сетями следующий прыжок](https://docs.microsoft.com/azure/network-watcher/network-watcher-next-hop-overview) , чтобы тип следующего прыжка из виртуальной машины на целевой IP-адрес 23.102.135.246 (для KMS.Core.Windows.NET) или IP-адрес соответствующей КОНЕЧНОЙ точки KMS, применяемой к вашему региону, — **Интернет**.  Если результат — VirtualAppliance или шлюза виртуальной сети, скорее всего, существует маршрут по умолчанию.  Обратитесь к сетевому администратору и поработайте с ними, чтобы определить правильный курс действий.  Это может быть [Настраиваемый маршрут](https://docs.microsoft.com/azure/virtual-machines/troubleshooting/custom-routes-enable-kms-activation) , если решение соответствует политикам вашей организации.
