...
* Если нельзя изменить размер запрошенной виртуальной машины,
  * остановите все виртуальные машины в группе доступности.
    Нажмите **Группы** > ресурсов*вашей группы* > ресурсов**Ресурсы** > *вашей доступности установить* > **виртуальные машины** > *вашей виртуальной машины* > **Стоп.**
  * После остановки всех виртуальных машин создайте новую виртуальную машину необходимого размера.
  * Запустите новый VM, а затем выберите каждый из остановленных VMs и нажмите **Start.**
