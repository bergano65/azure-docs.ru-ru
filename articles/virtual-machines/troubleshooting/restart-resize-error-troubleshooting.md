...
[Просмотр операций развертывания](../../azure-resource-manager/resource-manager-deployment-operations.md)

[Просмотр журналов действий для управления ресурсами Azure](../../resource-group-audit.md)

## <a name="issue-error-when-starting-a-stopped-vm"></a>Проблема Ошибка при запуске остановленной виртуальной машины
