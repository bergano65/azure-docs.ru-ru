...
При использовании [диагностики загрузки](./boot-diagnostics.md) для просмотра снимка экрана виртуальной машины может отобразиться, что на снимке экрана отображается сообщение "перезагрузка", "завершение работы" или "остановка служб".
...
Используйте [последовательную консоль](./serial-console-windows.md) для выполнения следующих действий.
...
5. [Отключите диск операционной системы, а затем повторно подключите диск операционной системы к затронутой виртуальной машине](./troubleshoot-recovery-disks-portal-windows.md).
