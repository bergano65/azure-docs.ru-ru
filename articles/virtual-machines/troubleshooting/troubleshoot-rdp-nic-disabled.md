---
title: Сбой подключения удаленного рабочего стола к Виртуальным машинам Azure из-за отключенного сетевого интерфейса | Документация Майкрософт
...
В этой статье описывается, как устранить проблему, когда невозможно установить подключение удаленного рабочего стола к Виртуальным машинам Azure под управлением Windows из-за отключенного сетевого интерфейса.
...
Чтобы сбросить сетевой интерфейс, измените IP-адрес на другой IP-адрес, доступный в подсети, с помощью портала Azure или Azure PowerShell. Дополнительные сведения см. в статье [Как сбросить сетевой интерфейс для виртуальной машины Azure под управлением Windows](reset-network-interface.md). 