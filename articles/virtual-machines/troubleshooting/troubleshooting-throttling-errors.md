...
-   [AzLogAnalyticRequestRateByInterval экспорта](https://docs.microsoft.com/powershell/module/az.compute/export-azloganalyticrequestratebyinterval)
-   [AzLogAnalyticThrottledRequests экспорта](https://docs.microsoft.com/powershell/module/az.compute/export-azloganalyticthrottledrequests)
