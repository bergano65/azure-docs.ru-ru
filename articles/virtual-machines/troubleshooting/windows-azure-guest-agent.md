...
1. Установите Гостевой агент с помощью следующей команды:
    ...
    В редких случаях, когда Гостевой агент устанавливается неправильно, можно [установить агент виртуальной машины в автономном режиме](https://docs.microsoft.com/azure/virtual-machines/troubleshooting/install-vm-agent-offline).
...
1. Проверьте, блокирует ли брандмауэр Windows или брандмауэр стороннего производителя доступ к портам 80, 443 и 32526. Дополнительные сведения о том, почему этот адрес не должен блокироваться, см. в разделе [что такое IP Address 168.63.129.16](https://docs.microsoft.com/azure/virtual-network/what-is-ip-address-168-63-129-16).
