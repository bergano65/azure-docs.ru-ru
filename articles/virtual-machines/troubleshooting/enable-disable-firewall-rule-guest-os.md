...
description: Узнайте, как использовать онлайн или автономные удаленные инструменты или настройки реестра, чтобы включить или отключить правила брандмауэра гостевой ОС на удаленном Azure VM.
