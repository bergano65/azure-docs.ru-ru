...
- Ошибки выделения ресурсов
    - [ Ошибки распределения ресурсов   ](allocation-failure.md)
...
- [Непредвиденные перезагрузки виртуальных машин с подключенными VHD-дисками  ](unexpected-reboots-attached-vhds.md)
