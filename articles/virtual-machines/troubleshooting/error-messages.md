...
|  InvalidParameter  |  Недопустимое имя контейнера {0}. Имена контейнеров должны быть длиной от 3 до 63 символов и могут содержать только буквы нижнего регистра, цифры и дефисы. Дефис и должны идти следуют буквы или цифры.  |
|  InvalidParameter  |  Недопустимое имя контейнера {0} в URL-адресе {1}. Имена контейнеров должны быть длиной от 3 до 63 символов и могут содержать только буквы нижнего регистра, цифры и дефисы. Дефис и должны идти следуют буквы или цифры.  |
