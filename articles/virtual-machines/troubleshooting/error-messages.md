...
|  InvalidParameter  |  Недопустимое имя контейнера {0}. Имена контейнеров должны быть длиной от 3 до 63 символов и могут содержать только буквы нижнего регистра, цифры и дефисы. Дефис должен предшествовать и сопровождаться алфавитным характером.  |
|  InvalidParameter  |  Недопустимое имя контейнера {0} в URL-адресе {1}. Имена контейнеров должны быть длиной от 3 до 63 символов и могут содержать только буквы нижнего регистра, цифры и дефисы. Дефис должен предшествовать и сопровождаться алфавитным характером.  |
...
|  VMExtensionProvisioningTimeout  |  Подготовка расширения VM{0}' приурочена. Установка расширения может занять слишком много времени, или статус расширения не может быть получен.  |
