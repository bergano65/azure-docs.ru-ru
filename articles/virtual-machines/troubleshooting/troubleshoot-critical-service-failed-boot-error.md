...
2. [Отсоедините диск ОС и снова подключите его к необходимой виртуальной машине](troubleshoot-recovery-disks-portal-windows.md). Виртуальная машина загрузится в безопасном режиме. Если ошибка по-прежнему возникает, перейдите к [дополнительному шагу](#optional-analysis-the-dump-logs-in-boot-debug-mode).
