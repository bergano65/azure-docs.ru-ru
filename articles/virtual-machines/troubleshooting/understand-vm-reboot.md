...
- [Плановое обслуживание виртуальных машин Windows](../maintenance-and-updates.md?bc=/azure/virtual-machines/windows/breadcrumb/toc.json&toc=/azure/virtual-machines/windows/toc.json)
- [Как запланировать плановое обслуживание на виртуальных машинах Azure](../maintenance-and-updates.md?bc=/azure/virtual-machines/windows/breadcrumb/toc.json&toc=/azure/virtual-machines/windows/toc.json)
...
Если выполнить перезагрузку из портал Azure, Azure PowerShell, интерфейса командной строки или REST API, это событие можно найти в [журнале действий Azure](../../azure-monitor/essentials/platform-logs-overview.md).
