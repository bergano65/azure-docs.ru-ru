...
**Сообщение об ошибке**: "Сбой выделения. В этом регионе недостаточно емкости для запрошенного размера виртуальной машины. Дополнительные сведения о повышении вероятности успеха выделения по протоколу HTTPS:\//aka.ms/allocation-guidance "
