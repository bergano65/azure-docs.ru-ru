---
title: Устранение неполадок Windows не удалось завершить настройку системы
...
---
# <a name="troubleshoot-windows-could-not-finish-configuring-the-system"></a>Устранение неполадок Windows не удалось завершить настройку системы
