...
1. Проверьте расположение, в котором настроено создание файла подкачки.
   1. В HKEY_LOCAL_MACHINE\BROKENSYSTEM разверните каталог, соответствующий номеру элемента управления, который вы определили на шаге 4, например **ControlSet001**.
