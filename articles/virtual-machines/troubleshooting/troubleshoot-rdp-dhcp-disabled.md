...
3.  Откройте командную строку с повышенными привилегиями (**Запуск от имени администратора**). Затем выполните следующий сценарий. В этом сценарии предполагается, что буква диска, назначенная подключенному диску ОС, — **F**. Замените букву, соответствующую значению в виртуальной машине.
