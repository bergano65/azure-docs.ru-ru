...
5. Откройте сеанс повышенной команды **(Запуск в качестве администратора).** Выполните следующие сценарии. В этом сценарии мы предполагаем, что подключенному диску ОС присвоена буква F. Замените ее соответствующим значением для своей виртуальной машины.
