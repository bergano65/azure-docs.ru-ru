---
title: Виртуальные машины Azure серии Ev3 и Esv3
...
ms.locfileid: "77493752"
---
# <a name="ev3-and-esv3-series"></a>Серии Ev3 и Esv3

Ev3 и Esv3-Series — процессор Intel® Xeon® с частотой 2,1 ГГц (Skylake) или Intel® Xeon® 8171M с частотой до v4 2,3 ГГц (2673) в конфигурации с поддержкой технологии Hyper-Threading, предоставляя лучшее ценное предложение для большинства рабочих нагрузок общего назначения и добавляя Broadwell для выравнивания с виртуальными машинами общего назначения большинства других облаков.  Объем памяти увеличен с 7 ГиБ до 8 ГиБ на виртуальный ЦП, а дисковые и сетевые ограничения в связи с переходом на технологию Hyper Threading подстроены под каждое ядро. Ev3 — это следующий уровень виртуальных машин с большим объемом памяти, к которым также относятся виртуальные машины семейств D и Dv2.

## <a name="ev3-series"></a>Серия Ev3

Экземпляры серии Ev3 основаны на характеристиках процессоров Intel® Xeon® с частотой 2,1 ГГц (Skylake) или Intel® Xeon®, 2673 v4 2,3 ГГц (Broadwell) и Intel Turbo Boost Technology 2,0. Экземпляры серии Ev3 отлично подходят для корпоративных приложений с высоким объемом требуемой памяти.
...
Экземпляры серии Esv3 основаны на характеристиках процессоров Intel® Xeon® с частотой 2,1 ГГц (Skylake) или Intel® Xeon® с тактовой частотой 4 – 2673 2,3 v4 ГГц (Broadwell), технологии Intel Turbo Boost 2,0 и используют хранилище класса Premium. Экземпляры серии Esv3 идеально подходят для корпоративных приложений с большим объемом памяти.
