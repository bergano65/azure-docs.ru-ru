...
Чтобы получить состояние электропитания всех виртуальных машин в подписке, используйте [виртуальные машины — список всех API](https://docs.microsoft.com/rest/api/compute/virtualmachines/listall) с параметром **statusOnly** , установленным в *значение true*.
