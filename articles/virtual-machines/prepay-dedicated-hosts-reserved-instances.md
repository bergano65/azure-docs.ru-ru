...
Начните с перехода на поддерживаемый размер для [виртуальной машины Windows](./sizes.md) или [Linux](./sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) , чтобы найти серию виртуальных машин.
