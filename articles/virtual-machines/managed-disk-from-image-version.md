...
Задайте `source` для переменной идентификатор версии образа, а затем выполните команду [AZ Disk Create](/cli/azure/disk?view=azure-cli-latest#az_disk_create) , чтобы создать управляемый диск. 
