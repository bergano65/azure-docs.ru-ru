...
**Обходное решение**. Убедитесь, что идентификатор источника совпадает с уже существующим идентификатором источника, измените номер версии образа или удалите текущую версию образа и повторите попытку.
