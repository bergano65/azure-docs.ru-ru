---
title: Создание нескольких идентичных управляемых дисков (Linux) на основе моментального снимка VHD с помощью PowerShell
...
ms.locfileid: "87079933"
---
# <a name="create-a-snapshot-from-a-vhd-to-create-multiple-identical-managed-disks-in-small-amount-of-time-with-powershell-linux"></a>Создание моментального снимка из VHD для быстрого создания нескольких идентичных управляемых дисков с помощью PowerShell (Linux)
