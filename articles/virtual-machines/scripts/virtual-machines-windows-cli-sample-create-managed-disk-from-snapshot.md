---
title: Пример сценария интерфейса командной строки. Создание управляемого диска на основе моментального снимка (Windows)
...
ms.locfileid: "87028504"
---
# <a name="create-a-managed-disk-from-a-snapshot-with-cli-windows"></a>Создание управляемого диска на основе моментального снимка с помощью интерфейса командной строки (Windows)
