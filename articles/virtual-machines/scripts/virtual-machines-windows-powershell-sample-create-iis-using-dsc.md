---
title: Пример сценария Azure PowerShell для IIS с использованием DSC
...
ms.locfileid: "87010025"
---
# <a name="use-an-azure-powershell-sample-script-to-create-an-iis-vm"></a>Создание виртуальной машины IIS с помощью примера сценария Azure PowerShell
...
| [Set-AzVMExtension](/powershell/module/az.compute/set-azvmextension) | Добавляет в виртуальную машину расширение виртуальной машины. В этом примере для установки IIS используется расширение DSC. |
