...
Этот сценарий копирует управляемый диск в ту же или другую подписку в одном регионе. Для выполнения этого скрипта требуются права глобального администратора клиента AAD для обеих подписок.
