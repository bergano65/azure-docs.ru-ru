---
title: Производительность виртуальной машины серии ХБ — виртуальные машины Azure | Документация Майкрософт
...
| Задержка & RDMA, пропускная способность                        | 2.35 Усек, 96,5 ГБ/с   |
| FIO на локальном SSD NVMe                           | ~ 1,7 ГБ/с, ~ 1,0 ГБ/с      |  
| ИОР на 4 * SSD (цен. категория "Премиум") Azure (управляемые диски P30, конфигурацию RAID0) * *  | ~ 725 МБ/с, ~ 780 МБ/операций записи   |



## <a name="infiniband-send-latency"></a>Задержка отправки InfiniBand
Mellanox Perftest.
...
## <a name="osu-mpi-latency-test"></a>Тест задержки осу MPI

ОСУ MPI 5.4.3 Test v.
...
| #bytes  | Задержка [микросекунда] (МПИЧ 3,3 + CH4) | Задержка [микросекунда] (Опенмпи 4.0.0) | Задержка [микросекунда] (MVAPICH2 2,3) | Задержка [микросекунда] (Intel MPI 2019) |
|------|----------|----------|----------|----------|
...
ОСУ MPI Test пропускной способности v 5.4.3.
