...
|-----------------------------|-----------------------|
| Максимальный размер задания MPI            | 13200 ядер (300 виртуальных машин в одном VMSS с singlePlacementGroup = true) |
