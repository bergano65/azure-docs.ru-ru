...
> [!IMPORTANT]
> Подключение между Microsoft Azure и OCI находится на этапе предварительной версии. Чтобы обеспечить подключение с низкой задержкой между Azure и OCI, необходимо сначала список разрешений подписку Azure для этой возможности.
...
* Ваша подписка Azure должна быть список разрешений для этой предварительной версии функции. Свяжитесь с представителями корпорации Майкрософт, чтобы включить эту функцию в подписке.
