---
title: Сервер платформы Oracle в решениях Azure
...
ms.locfileid: "90069733"
---
# <a name="solutions-for-running-oracle-weblogic-server-on-azure"></a>Решения для запуска сервера платформы Oracle в Azure
