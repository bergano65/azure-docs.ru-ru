...
В то время как системно-управляемый осколки является самым простым для настройки и управления, определяемый пользователем осколки или составной осколки хорошо подходит для сценариев, где ваши данные и приложение геораспределены или в сценариях, где вам нужно иметь контроль над репликацией каждого осколок. 
