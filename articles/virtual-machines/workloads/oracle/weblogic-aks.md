...
:::image type="content" source="media/oracle-weblogic/weblogic-architecture-aks.png" alt-text="Вы можете использовать примеры сценариев для развертывания сервера AKS на сервере.":::
