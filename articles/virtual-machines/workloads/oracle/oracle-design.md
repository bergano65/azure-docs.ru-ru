...
- Для некоторых дистрибутивов Linux рассмотрите возможность включения [поддержки TRIM/](https://docs.microsoft.com/azure/virtual-machines/linux/configure-lvm#trimunmap-support)unотмена.
