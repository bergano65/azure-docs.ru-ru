...
- При использовании виртуальных машин серии M в хранилище класса Premium включите [ускоритель записи](https://docs.microsoft.com/azure/virtual-machines/linux/how-to-enable-write-accelerator) на диске журналы повтора.
...
- *Политика NSG*. NSG можно определить с помощью подсети или сетевого адаптера. Проще управлять доступом на уровне подсети, как для безопасности, так и для принудительной маршрутизации таких вещей, как брандмауэры приложений.
