...
Ниже показан пример создания виртуальной машины RHEL 7,6.
...
В этом случае `RedHat:RHEL:7.6:7.6.2019102813` по умолчанию подключен к репозиториям ЕУС. Значение SKU — 7,4. И `RedHat:RHEL:7-LVM:7.6.2019062414` по умолчанию подключены к репозиториям, отличным от ЕУС. Значение SKU — 7 — LVM.
