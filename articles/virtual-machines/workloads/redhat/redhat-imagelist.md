...
:----|:----|:-------------|:-------------|:-----
RHEL          | 6.7      | RAW    | Агент Linux | Поддержка расширенного жизненного цикла доступна 1 декабря. [Дополнительные сведения см. здесь.](redhat-extended-lifecycle-support.md)
|             | 6,8      | RAW    | Агент Linux | Поддержка расширенного жизненного цикла доступна 1 декабря. [Дополнительные сведения см. здесь.](redhat-extended-lifecycle-support.md)
|             | 6.9      | RAW    | Агент Linux | Поддержка расширенного жизненного цикла доступна 1 декабря. [Дополнительные сведения см. здесь.](redhat-extended-lifecycle-support.md)
|             | 6.10     | RAW    | Агент Linux | Поддержка расширенного жизненного цикла доступна 1 декабря. [Дополнительные сведения см. здесь.](redhat-extended-lifecycle-support.md)
...
|             | 7.9      | Диспетчер логических томов    | Агент Linux | Подключен к обычным репозиториям (ЕУС недоступен для RHEL 7,9)
|             | 79-Gen2  | Диспетчер логических томов    | Агент Linux | Подключен к обычным репозиториям (ЕУС недоступен для RHEL 7,9)
...
|             | 8.1      | Диспетчер логических томов    | Агент Linux | По умолчанию подключен к репозиториям ЕУС.
|             | 81gen2   | Диспетчер логических томов    | Агент Linux | Поколение Hyper-V (2) — подключено к репозиториям ЕУС на 2020 ноября.
|             | 8.1-ci   | Диспетчер логических томов    | Агент Linux | Прикрепляется к репозиториям ЕУС на 2020 ноября.
|             | 81-ci-gen2| Диспетчер логических томов    | Агент Linux | Поколение Hyper-V (2) — подключено к репозиториям ЕУС на 2020 ноября.
|             | 8.2      | Диспетчер логических томов    | Агент Linux | Прикрепляется к репозиториям ЕУС на 2020 ноября.
|             | 82gen2   | Диспетчер логических томов    | Агент Linux | Поколение Hyper-V (2) — подключено к репозиториям ЕУС на 2020 ноября.
|             | 8.3   | Диспетчер логических томов    | Агент Linux |  Подключен к обычным репозиториям (ЕУС недоступен для RHEL 8,3)
|             | 83-Gen2   | Диспетчер логических томов    | Агент Linux |Создание Hyper-V (2) — подключено к обычным репозиториям (ЕУС недоступно для RHEL 8,3)
...
RHEL-SAP-HANA (для удаления в ноябре 2020) | 6.7       | RAW    | Агент Linux | RHEL 6,7 для SAP HANA. Устарело в пользу образов RHEL-SAP. Этот образ будет удален в ноябре 2020. Дополнительные сведения о облачных предложениях SAP для Red Hat доступны [здесь](https://access.redhat.com/articles/3751271).
|             | 7.2       | Диспетчер логических томов    | Агент Linux | RHEL 7,2 для SAP HANA. Устарело в пользу образов RHEL-SAP. Этот образ будет удален в ноябре 2020. Дополнительные сведения о облачных предложениях SAP для Red Hat доступны [здесь](https://access.redhat.com/articles/3751271).
|             | 7.3       | Диспетчер логических томов    | Агент Linux | RHEL 7,3 для SAP HANA. Устарело в пользу образов RHEL-SAP. Этот образ будет удален в ноябре 2020. Дополнительные сведения о облачных предложениях SAP для Red Hat доступны [здесь](https://access.redhat.com/articles/3751271).
...
|             | 7.4       | Диспетчер логических томов    | Агент Linux | RHEL 7,4 для SAP Business Applications.
|             | 7.6       | Диспетчер логических томов    | Агент Linux | RHEL 7,6 для SAP Business Applications.
|             | 7.7       | Диспетчер логических томов    | Агент Linux | RHEL 7,7 для SAP Business Applications.
|             | 77-gen2       | Диспетчер логических томов    | Агент Linux | RHEL 7,7 для SAP Business Applications. Образ поколения 2
|             | 8.1       | Диспетчер логических томов    | Агент Linux | RHEL 8,1 для SAP Business Applications.
|             | 81-Gen2      | Диспетчер логических томов    | Агент Linux | RHEL 8,1 для SAP Business Applications. Образ поколения 2.
|             | 8.2       | Диспетчер логических томов    | Агент Linux | RHEL 8,2 для SAP Business Applications.
|             | 82-Gen2      | Диспетчер логических томов    | Агент Linux | RHEL 8,2 для SAP Business Applications. Образ поколения 2.
RHEL-HA       | 7.4       | Диспетчер логических томов    | Агент Linux | RHEL 7,4 с дополнением высокой доступности. Будет взиматься премия за высокий уровень доступности и RHEL поверх базовых вычислений. Устарело в пользу образов RHEL-SAP-HA.
|             | 7,5 %       | Диспетчер логических томов    | Агент Linux | RHEL 7,5 с дополнением высокой доступности. Будет взиматься премия за высокий уровень доступности и RHEL поверх базовых вычислений. Устарело в пользу образов RHEL-SAP-HA.
|             | 7.6       | Диспетчер логических томов    | Агент Linux | RHEL 7,6 с дополнением высокой доступности. Будет взиматься премия за высокий уровень доступности и RHEL поверх базовых вычислений. Устарело в пользу образов RHEL-SAP-HA.
...
|             | 8.1          | Диспетчер логических томов    | Агент Linux | RHEL 8,1 для SAP с высоким уровнем доступности и службами обновления. Подключено к репозиториям E4S. Будет взиматься премия за репозитории SAP и высокой доступности, а также RHEL, поверх базовых расчетных выплат.
|             | 81sapha — Gen2          | Диспетчер логических томов    | Агент Linux | RHEL 8,1 для SAP с высоким уровнем доступности и службами обновления. Образы поколения 2, подключенные к репозиториям E4S. Будет взиматься премия за репозитории SAP и высокой доступности, а также RHEL, поверх базовых расчетных выплат.
|             | 8.2          | Диспетчер логических томов    | Агент Linux | RHEL 8,2 для SAP с высоким уровнем доступности и службами обновления. Будет взиматься премия за репозитории SAP и высокой доступности, а также RHEL, поверх базовых расчетных выплат.
|             | 82sapha — Gen2          | Диспетчер логических томов    | Агент Linux | RHEL 8,2 для SAP с высоким уровнем доступности и службами обновления. Образы поколения 2, подключенные к репозиториям E4S. Будет взиматься премия за репозитории SAP и высокой доступности, а также RHEL, поверх базовых расчетных выплат.
