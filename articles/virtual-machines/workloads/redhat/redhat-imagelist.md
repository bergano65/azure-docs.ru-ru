...
RHEL-SAP-HANA (для удаления из Marketplace в октябре 2020) | 6.7       | RAW    | Агент Linux | RHEL 6,7 для SAP HANA. Устарело в пользу образов RHEL-SAP. Этот образ будет удален из Azure Марткетплаце в октябре 2020. Дополнительные сведения о облачных предложениях SAP для Red Hat доступны [здесь](https://access.redhat.com/articles/3751271).
|             | 7.2       | Диспетчер логических томов    | Агент Linux | RHEL 7,2 для SAP HANA. Устарело в пользу образов RHEL-SAP. Этот образ будет удален из Azure Марткетплаце в октябре 2020. Дополнительные сведения о облачных предложениях SAP для Red Hat доступны [здесь](https://access.redhat.com/articles/3751271).
|             | 7.3       | Диспетчер логических томов    | Агент Linux | RHEL 7,3 для SAP HANA. Устарело в пользу образов RHEL-SAP. Этот образ будет удален из Azure Марткетплаце в октябре 2020. Дополнительные сведения о облачных предложениях SAP для Red Hat доступны [здесь](https://access.redhat.com/articles/3751271).
