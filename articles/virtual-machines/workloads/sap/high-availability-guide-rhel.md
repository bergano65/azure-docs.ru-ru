...
1. Задайте следующие параметры.
   ...
   1. Имя пользователя и пароль администратора или ключ SSH  
      Пользователь будет создан, можно использовать для входа на компьютер.
...
<pre><code>sudo pcs property set maintenance-mode=true
   ...
   Если вы обновляете более старой версии и переключение на сервер постановки в очередь 2, см. в разделе SAP Примечание [2641322](https://launchpad.support.sap.com/#/notes/2641322). 
