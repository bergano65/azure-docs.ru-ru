...
Сначала необходимо создать виртуальные машины для этого кластера. После этого вы создадите подсистему балансировки нагрузки и используете виртуальные машины во внутреннем пуле.
