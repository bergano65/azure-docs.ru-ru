...
* **Компонент SAP**: отдельное приложение SAP, такое как ERP Central (ECC), Бизнес-хранилище (BW), диспетчер решений или Enterprise Portal (EP). Компоненты SAP могут основываться на традиционных технологиях ABAP или Java или в приложении, не основанном на NetWeaver, например в бизнес-объектах.
* **Среда SAP**: один или несколько компонентов SAP, которые логически группируются для выполнения бизнес-функций, таких как разработка, контроль качества, обучение, аварийное восстановление или производство.
* **Ландшафт SAP**. Этот термин относится ко всем ресурсам SAP в ИТ-альбоме клиента. Альбом SAP включает все производственные и непроизводственные среды.
...
Существуют и другие статьи, доступные в рабочей нагрузке SAP в Azure. Начните [работу с рабочей нагрузкой SAP в Azure:](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/get-started) приступайте к работе, а затем выберите интересующую вас область.
