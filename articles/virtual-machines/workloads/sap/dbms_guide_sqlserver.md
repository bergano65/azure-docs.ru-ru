...
Сведения об этих функциональных возможностях можно найти в статье [Файлы данных SQL Server в Microsoft Azure](https://docs.microsoft.com/sql/relational-databases/databases/sql-server-data-files-in-microsoft-azure)
...
- [Расширенное управление ключами с помощью службы Azure Key Vault (SQL Server)](https://docs.microsoft.com/sql/relational-databases/security/encryption/extensible-key-management-using-azure-key-vault-sql-server).
- [Расширенное управление ключами для прозрачного шифрования данных в SQL Server с помощью службы Azure Key Vault — настройка](https://docs.microsoft.com/sql/relational-databases/security/encryption/setup-steps-for-extensible-key-management-using-the-azure-key-vault).
- [Обслуживание и устранение неполадок соединителя SQL Server](https://docs.microsoft.com/sql/relational-databases/security/encryption/sql-server-connector-maintenance-troubleshooting?).
