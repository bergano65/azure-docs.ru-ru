...
* При использовании прослушивателя группы доступности виртуальные машины баз данных необходимо подключить к выделенному Load Balancer. Чтобы избежать назначения новых IP-адресов в Azure в случаях, когда обе виртуальные машины завершаются, необходимо назначить статические IP-адреса сетевым интерфейсам этих виртуальных машин в конфигурации Always On (определение статического IP-адреса описывается в [разделе Эта][virtual-networks-reserved-private-ip] статья)
