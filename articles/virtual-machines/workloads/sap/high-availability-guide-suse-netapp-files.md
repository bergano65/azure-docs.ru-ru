...
Предполагается, что вы уже развернули [виртуальной сети Azure](https://docs.microsoft.com/azure/virtual-network/virtual-networks-overview). Имейте в виду, что ресурсы службы файлов Azure NetApp и виртуальные машины, куда будет подключен ресурсы службы файлов Azure NetApp, должны быть развернуты в той же виртуальной сети Azure.  

1. Если вы еще не сделали, запросить [подавать заявки на этапе предварительной версии Azure NetApp](https://docs.microsoft.com/azure/azure-netapp-files/azure-netapp-files-register).  
