...
| Сценарий использования | HDD (цен. категория "Стандартный") | Диск SSD (цен. категория "Стандартный") | Хранилище класса Premium | Диск (цен. категория "Ультра") | Azure NetApp Files |
| --- | --- | --- | --- | --- | --- |
