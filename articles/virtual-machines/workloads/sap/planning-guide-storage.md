...
| Сценарий использования | HDD ценовой категории "Стандартный" | SSD ценовой категории "Стандартный" | Хранилище класса Premium | Диск (цен. категория "Ультра") | Azure NetApp Files |
| --- | --- | --- | --- | --- | --- |
...
<sup>1</sup> с использованием [ускоритель записи Azure](../../windows/how-to-enable-write-accelerator.md) для семейств виртуальных машин M/Mv2 для журналов журнала/повторяемости <sup>2</sup> с помощью использовании требуется/Hana/Data, а/Hana/log — в использовании 
...
| Максимальное число операций ввода-вывода в секунду на диск | 20 000 [зависит от размера диска](https://azure.microsoft.com/pricing/details/managed-disks/) | Также учитывайте [ограничения виртуальной машины](../../linux/sizes.md) |
...
| --- | --- | --- | --- |
| HDD ценовой категории "Стандартный" | [Размеры виртуальных машин Linux в Azure](../../linux/sizes.md) | [Размеры виртуальных машин Windows в Azure](../../windows/sizes.md) | Вероятно, трудно коснуться ограничений хранилища для средних или крупных виртуальных машин. |
| SSD ценовой категории "Стандартный" | [Размеры виртуальных машин Linux в Azure](../../linux/sizes.md) | [Размеры виртуальных машин Windows в Azure](../../windows/sizes.md) | Вероятно, трудно коснуться ограничений хранилища для средних или крупных виртуальных машин. |
| Хранилище класса Premium | [Размеры виртуальных машин Linux в Azure](../../linux/sizes.md) | [Размеры виртуальных машин Windows в Azure](../../windows/sizes.md) | Простота попадания в операции ввода-вывода или ограничение пропускной способности хранилища в конфигурации хранилища |
| Хранилище Ultra Disk | [Размеры виртуальных машин Linux в Azure](../../linux/sizes.md) | [Размеры виртуальных машин Windows в Azure](../../windows/sizes.md) | Простота попадания в операции ввода-вывода или ограничение пропускной способности хранилища в конфигурации хранилища |
| Azure NetApp Files | [Размеры виртуальных машин Linux в Azure](../../linux/sizes.md) | [Размеры виртуальных машин Windows в Azure](../../windows/sizes.md) | Трафик хранилища использует пропускную способность сети, а не пропускную способность хранилища. |
