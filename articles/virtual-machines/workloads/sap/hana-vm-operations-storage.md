...
| Том | Размер<br /> Уровень хранилища Premium | Размер<br /> Уровень Ultra Storage |
| --- | --- | --- |
| /Hana/log | 4 ТиБ | 2 тиб |
| hana/data; | 6,3 тиб | 3,2 тиб |
| /hana/shared | Максимум (512 ГБ, 1xRAM) на 4 рабочих узла | Максимум (512 ГБ, 1xRAM) на 4 рабочих узла |
...
| Том | Размер<br /> Уровень Ultra Storage |
| --- | --- |
| /hana/log/mnt00001 | 2 тиб |
| /hana/log/mnt00002 | 2 тиб |
| /hana/data/mnt00001 | 3,2 тиб |
| /hana/data/mnt00002 | 3,2 тиб |
| /hana/shared | 2 тиб |
