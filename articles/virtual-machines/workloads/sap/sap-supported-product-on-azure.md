...
Службы IaaS Azure, которые можно использовать для рабочей нагрузки SAP, ограничены оборудованием x86-64 или x64. Для рабочей нагрузки SAP не предусмотрены предложения на основе архитектуры SPARC или питания. Клиенты, работающие в своих приложениях в операционных системах, применяют к аппаратным архитектурам, таким как мэйнфреймы IBM или AS400 или где используются операционные системы HP-UX, Solaris или AIX, необходимо изменить приложения SAP, включая СУБД, на один из следующие операционные системы:
...
- **Для виртуальных машин Azure серии M и виртуальных машин Azure серии Mv2 применяются разные минимальные выпуски ОС, чем для других типов виртуальных машин Azure**. Требование к более поздним выпускам ОС основано на изменениях, которые поставщики операционных систем приходило предоставлять в выпусках операционных систем, чтобы либо активировать операционные системы, работающие на конкретных типах виртуальных машин Azure, либо оптимизировать производительность и пропускная способность рабочей нагрузки SAP на этих типах виртуальных машин
...
Для платформы бизнес-объектов BI — [Примечание о поддержке SAP. #2145537](https://launchpad.support.sap.com/#/notes/2145537) содержит список продуктов SAP Business Objects, поддерживаемых в Azure. Если есть вопросы по поводу компонентов или сочетаний версий программного обеспечения и выпусков ОС, которые не перечислены или не поддерживаются и которые более актуальны по сравнению с указанными минимальными выпусками, необходимо открыть запрос на поддержку SAP для запрашиваемого компонента. поддержка.
...
Поддержка SAP Датахуб/вора в Azure Kubernetes Services (AKS) подробно описана в [заметке о поддержке sap #2464722](https://launchpad.support.sap.com/#/notes/2464722)
...
Поддержка SAP Hybris Commerce Platform 5. x и 6. x в Azure подробно описана на [вики-сайте Hybris](https://wiki.hybris.com/display/SUP/Using+the+hybris+Platform+with+the+Cloud)
