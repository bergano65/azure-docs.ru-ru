...
>![](./media/high-availability-guide-rhel-ibm-db2-luw/hadr-swpm-db2-port.png) определения порта SAP SWPM
...
>![параметров доступности SAP SWPM-DB2](./media/high-availability-guide-rhel-ibm-db2-luw/swpm-db2ha-opt.png)
...
1. Измените среду оболочки для DB2\<SID > пользователя на */бин/КШ*:
...
1. Создайте интерфейсный пул IP-адресов:
   ...
   c. Установите статическое **назначение** ивведите IP-адрес **Virtual-IP** , определенный в начале.
...
- **Очистка ресурсов пк \<res_name >** : Очистка ограничений расположения
- **Очистка ресурсов пк \<res_name >** : очищает все ошибки ресурса.
