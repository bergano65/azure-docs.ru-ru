...
- **> <host>RES_NAME перемещения \<ресурсов ПК:** Создает ограничения расположения и может вызвать проблемы с перенаправление
- **ресурс ПК очистка \<RES_NAME>**: Очистка ограничений расположения
