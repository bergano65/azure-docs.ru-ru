...
[dbms-guide-2.1]:dbms-guide.md#c7abf1f0-c927-4a7c-9c1d-c7b5b3b7212f (Кэширование для VMs и VHDs)
[dbms-guide-2.2]:dbms-guide.md#c8e566f9-21b7-4457-9f7f-126036971a91 (Программное обеспечение RAID)
[dbms-guide-2.3]:dbms-guide.md#10b041ef-c177-498a-93ed-44b3441ab152 (Хранилище Microsoft Azure)
[dbms-guide-2]:dbms-guide.md#65fa79d6-a85f-47ee-890b-22e794f51a64 (Структура развертывания RDBMS)
[dbms-guide-3]:dbms-guide.md#871dfc27-e509-4222-9370-ab1de77021c3 (Высокая доступность и аварийное восстановление с помощью VMs Azure)
[dbms-guide-5.5.1]:dbms-guide.md#0fef0e79-d3fe-4ae2-85af-73666a6f7268 (Сервер S'L 2012 SP1 CU4 и позже)
[dbms-guide-5.5.2]:dbms-guide.md#f9071eff-9d72-4f47-9da4-1852d782087b (Сервер S'L 2012 SP1 CU3 и более ранние релизы)
...
[dbms-guide-8.4.3]:dbms-guide.md#77cd2fbb-307e-4cbf-a65f-745553f72d2c (Соображения производительности для резервного копирования и восстановления)
[dbms-guide-8.4.4]:dbms-guide.md#f77c1436-9ad8-44fb-a331-8671342de818 (Других)
...
[deployment-guide]:deployment-guide.md (Развертывание виртуальных машин Azure для SAP)
...
[deployment-guide-3.3]:deployment-guide.md#54a1fc6d-24fd-4feb-9c57-ac588a55dff2 (Сценарий 2: Развертывание VM с пользовательским изображением для SAP)
[deployment-guide-3.4]:deployment-guide.md#a9a60133-a763-4de8-8986-ac0fa33aa8c1 (Сценарий 3: Перемещение VM из-на-контора с использованием необобщенного Azure VHD с SAP)
[deployment-guide-3]:deployment-guide.md#b3253ee3-d63b-4d74-a49b-185e76c4088e (Сценарии развертывания MMs для SAP в Microsoft Azure)
...
[deployment-guide-4.5.1]:deployment-guide.md#987cf279-d713-4b4c-8143-6b11589bb9d4 (Лазурная силаШелл)
[deployment-guide-4.5.2]:deployment-guide.md#408f3779-f422-4413-82f8-c57a23b4fc2f (Лазурный CLI)
[deployment-guide-4.5]:deployment-guide.md#d98edcd3-f2a1-49f7-b26a-07448ceb60ca (Настройте расширение Azure для SAP)
...
[deployment-guide-5.2]:deployment-guide.md#e2d592ff-b4ea-4a53-a91a-e5521edb6cd1 (Проверка работоспособности для расширения Azure для конфигурации SAP)
[deployment-guide-5.3]:deployment-guide.md#fe25a7da-4e4e-4388-8907-8abc2d33cfd8 (Устранение проблем azure Extension для SAP)

[deployment-guide-configure-monitoring-scenario-1]:deployment-guide.md#ec323ac3-1de9-4c3a-b770-4ff701def65b (Настройка расширения VM)
...
[deployment-guide-troubleshooting-chapter]:deployment-guide.md#564adb4f-5c95-4041-9616-6635e83a810b (Проверки и устранение неполадок для сквозного сбора данных для агента SAP Host)
...
[planning-guide-11.5]:planning-guide.md#4e165b58-74ca-474f-a7f4-5e695a93204f (Использование Autostart для экземпляров SAP)
...
[planning-guide-3.1]:planning-guide.md#be80d1b9-a463-4845-bd35-f4cebdb5424a (Лазурные регионы)
[planning-guide-3.2.1]:planning-guide.md#df49dc09-141b-4f34-a4a2-990913b30358 (Разлом доменов)
[planning-guide-3.2.2]:planning-guide.md#fc1ac8b2-e54a-487c-8581-d3cc6625e560 (Домены обновления)
[planning-guide-3.2.3]:planning-guide.md#18810088-f9be-4c97-958a-27996255c665 (Наборы доступности Azure)
[planning-guide-3.2]:planning-guide.md#8d8ad4b8-6093-4b91-ac36-ea56d80dbf77 (Концепция виртуальных машин Microsoft Azure)
[planning-guide-3.3.2]:planning-guide.md#ff5ad0f9-f7f4-4022-9102-af07aef3bc92 (Премиум-хранилище Azure)
...
[planning-guide-5.2.2]:planning-guide.md#57f32b1c-0cba-4e57-ab6e-c39fe22b6ec3 (Подготовка к развертыванию VM с конкретным изображением клиента для SAP)
...
[planning-guide-5.3.2]:planning-guide.md#a43e40e6-1acc-4633-9816-8f095d5a7b6a (Загрузка VHD из находной в Azure)
...
[planning-guide-7]:planning-guide.md#96a77628-a05e-475d-9df3-fb82217e8f14 (Концепции развертывания только для облаков экземпляров SAP)
[planning-guide-9.1]:planning-guide.md#6f0a47f3-a289-4090-a053-2521618a28c3 (Решение для мониторинга в Azure для SAP)
[planning-guide-azure-premium-storage]:planning-guide.md#ff5ad0f9-f7f4-4022-9102-af07aef3bc92 (Премиум-хранилище Azure)
...
[virtual-machines-linux-cli-deploy-templates]:../../linux/cli-deploy-templates.md (Развертывание и управление виртуальными машинами с помощью шаблонов управления ресурсами Azure и CLI Azure)
...
Группы ресурсов в Azure Resource Manager можно использовать для управления всеми ресурсами приложения в подписке Azure. Для получения дополнительной информации смотрите [обзор менеджера ресурсов Azure][resource-group-overview].
...
1. **Основы**:
   ...
   * **Подписка**: Выберите подписку, которую вы хотите использовать для предоставления новой виртуальной машины.
...
1. **Настройки**:
   ...
   * **Расширения.** Можно установить расширения виртуальных машин, добавив их в развертывание. На этом шаге не нужно добавлять расширение. Расширения, необходимые для поддержки SAP, устанавливаются позже. В этом руководстве смотрите главу [Настройте расширение Azure для SAP.][deployment-guide-4.5]
...
1. **Настройки**:
   ...
   * **Тип хранилища.** Тип используемого хранилища (только для двухуровневого шаблона).
      ...
      * [Структура хранения VM для развертывания RDBMS](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/dbms_guide_general#65fa79d6-a85f-47ee-890b-22e794f51a64)
      ...
      * [Введение в хранилище Microsoft Azure][storage-introduction]
   ...
   * **Новая или существующая подсеть**: Определяет, создается ли новая виртуальная сеть и подсеть или используется существующая подсеть. Если у вас уже есть виртуальная сеть, подключенная к вашей предварительной сети, выберите **Существующий**.
   * **Идентификатор Subnet:** Если вы хотите развернуть VM в существующую VNet, где у вас есть подсеть, определенная VM должны быть назначены, имя идентификатор этой конкретной подсети. Идентификатор обычно выглядит следующим образом: /subscriptions/&lt;идентификатор_подписки>/resourceGroups/&lt;имя_группы_ресурсов>/providers/Microsoft.Network/virtualNetworks/&lt;имя_виртуальной_сети>/subnets/&lt;имя_подсети>.
...
В зависимости от конфигурации локальной сети на виртуальной машине может потребоваться настроить прокси. Если ваш VM подключен к вашей сети через VPN или ExpressRoute, VM может не иметь доступа к Интернету, и не сможет загрузить необходимые расширения VM или собирать информацию об инфраструктуре Azure для агента SAP Host через расширение SAP для Azure. Дополнительные сведения см. в разделе [Настройка прокси-сервера][deployment-guide-configure-proxy].
...
#### <a name="configure-vm-extension"></a><a name="ec323ac3-1de9-4c3a-b770-4ff701def65b"></a>Настройка расширения VM

Чтобы убедиться, что SAP поддерживает вашу среду, настройте расширение Azure для SAP, как описано в [настройке расширения Azure для SAP.][deployment-guide-4.5] Проверьте предпосылки для SAP и требуемые минимальные версии SAP Kernel и SAP Host Agent в ресурсах, перечисленных в [ресурсах SAP.][deployment-guide-2.2]

#### <a name="vm-extension-for-sap-check"></a>Расширение VM для проверки SAP

Проверьте, работает ли расширение VM для SAP, как описано в [Проверках и устранении неполадок для сквозного сбора данных для агента SAP Host.][deployment-guide-troubleshooting-chapter]
...
### <a name="scenario-2-deploying-a-vm-with-a-custom-image-for-sap"></a><a name="54a1fc6d-24fd-4feb-9c57-ac588a55dff2"></a>Сценарий 2: Развертывание VM с пользовательским изображением для SAP
...
1. **Настройки**:
   ...
   * **Тип хранилища.** Тип используемого хранилища (только для двухуровневого шаблона).
      ...
      * [Использование хранилища SSD класса Premium Azure для экземпляра СУБД SAP][2367194]
      * [Структура хранения VM для развертывания RDBMS](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/dbms_guide_general#65fa79d6-a85f-47ee-890b-22e794f51a64)
      * [Премиум-хранилище: Высокопроизводительное хранилище для рабочих нагрузок виртуальной машины Azure][storage-premium-storage-preview-portal]
      * [Введение в хранилище Microsoft Azure][storage-introduction]
   ...
   * **Имя администратора** и **Пароль администратора.** Имя пользователя и пароль.
     ...
     Создается учетная запись пользователя, используемая для входа в виртуальную машину.
   * **New or existing subnet** (Новая или имеющаяся подсеть). Определяет, следует ли создать виртуальную сеть и подсеть или использовать имеющуюся подсеть. Если у вас уже есть виртуальная сеть, подключенная к вашей предварительной сети, выберите **Существующий**.
   * **Идентификатор Subnet:** Если вы хотите развернуть VM в существующую VNet, где у вас есть подсеть, определенная VM должны быть назначены, имя идентификатор этой конкретной подсети. Идентификатор обычно выглядит следующим образом: /subscriptions/&lt;идентификатор_подписки>/resourceGroups/&lt;имя_группы_ресурсов>/providers/Microsoft.Network/virtualNetworks/&lt;имя_виртуальной_сети>/subnets/&lt;имя_подсети>.
...
В зависимости от конфигурации локальной сети на виртуальной машине может потребоваться настроить прокси. Если ваш VM подключен к вашей сети через VPN или ExpressRoute, VM может не иметь доступа к Интернету, и не сможет загрузить необходимые расширения VM или собирать информацию об инфраструктуре Azure для агента SAP Host через расширение SAP для Azure, [см.][deployment-guide-configure-proxy]

#### <a name="configure-azure-vm-extension-for-sap"></a>Настройте расширение Azure VM для SAP

Чтобы убедиться, что SAP поддерживает вашу среду, настройте расширение Azure для SAP, как описано в [настройке расширения Azure для SAP.][deployment-guide-4.5] Проверьте предпосылки для SAP и требуемые минимальные версии SAP Kernel и SAP Host Agent в ресурсах, перечисленных в [ресурсах SAP.][deployment-guide-2.2]

#### <a name="sap-vm-extension-check"></a>Проверка расширения SAP VM
...
В этом случае агент виртуальной машины **не** устанавливается автоматически во время развертывания. Поскольку VM-агент и расширение Azure для SAP необходимы для запуска SAP NetWeaver в Azure, необходимо загрузить, установить и включить оба компонента вручную после создания виртуальной машины.
...
#### <a name="sap-vm-check"></a>Проверка SAP VM

Проверьте, работает ли расширение VM для SAP, как описано в [Проверках и устранении неполадок для сквозного сбора данных для sAP Host Agent.][deployment-guide-troubleshooting-chapter]

## <a name="update-the-configuration-of-azure-extension-for-sap"></a>Обновление конфигурации расширения Azure для SAP

Обновление конфигурации расширения Azure для SAP в любом из следующих сценариев:
* Совместная команда Microsoft/SAP расширяет возможности расширения VM и запрашивает больше или меньше счетчиков.
* Корпорация Майкрософт представляет новую версию базовой инфраструктуры Azure, которая предоставляет данные, и расширение Azure для SAP необходимо адаптировать к этим изменениям.
* Дополнительные диски данных подключаются или удаляются из виртуальной машины Azure. В этом случае необходимо обновить коллекцию данных, связанных с хранилищем. Изменение конфигурации путем добавления или удаляния конечных точек или присвоения IP-адреса vM не влияет на конфигурацию расширения.
...
Чтобы обновить настройки, обновите конфигурацию расширения Azure для SAP, выпустив следующие действия в [настройке расширения Azure для SAP.][deployment-guide-4.5]
...
### <a name="configure-the-proxy"></a><a name="baccae00-6f79-4307-ade4-40292ce4e02d"></a>Настройка прокси-сервера
...
1. Выберите **Компьютерная** > **конфигурация Административные шаблоны** > Windows**Компоненты** > Internet**Explorer**. Убедитесь, что параметр **Задать параметры прокси для компьютера (а не для пользователя)** отключен или не настроен.
...
### <a name="configure-the-azure-extension-for-sap"></a><a name="d98edcd3-f2a1-49f7-b26a-07448ceb60ca"></a>Настройте расширение Azure для SAP

После подготовки виртуальной машины, как описано в разделе [Сценарии развертывания ПО SAP на виртуальных машинах Azure][deployment-guide-3], агент виртуальной машины устанавливается на виртуальной машине. Следующим шагом является развертывание расширения Azure для SAP, которое доступно в репозитории расширения Azure в глобальных центрах обработки данных Azure. Дополнительные сведения см. в [руководстве по планированию и внедрению SAP NetWeaver на виртуальных машинах][planning-guide-9.1].
...
Чтобы установить расширение Azure для SAP с помощью PowerShell:
...
Для получения `Set-AzVMAEMExtension`дополнительной информации о , см. [Set-AzVMAEMExtension][msdn-set-Azvmaemextension].

![Успешное выполнение SAP-специфического Azure cmdlet Set-AzVMAEMExtension][deployment-guide-figure-900]

Конфигурация `Set-AzVMAEMExtension` выполняет все шаги для настройки сбора данных для SAP.

Результат выполнения сценария содержит следующие сведения:

* Подтверждение того, что сбор данных для диска ОС и всех дополнительных дисков данных был настроен.
* В следующих двух сообщениях подтверждается настройка метрик хранилища для определенной учетной записи хранения.
* Одна строка вывода дает статус фактического обновления расширения VM для конфигурации SAP.
* а в другой подтверждается развертывание или обновление конфигурации.
* Последняя строка вывода — информационная. Он показывает ваши варианты для тестирования расширения VM для конфигурации SAP.
* Чтобы проверить, что все этапы Azure VM Extension для конфигурации SAP выполнены успешно, и что инфраструктура Azure предоставляет необходимые данные, приступайте к проверке готовности расширения Azure для SAP, как описано в [проверке готовности для расширения Azure для SAP.][deployment-guide-5.1]
...
Чтобы установить расширение Azure для SAP с помощью Azure CLI:
   ...
   1. Включить расширение Azure для SAP:
...
1. Убедитесь, что расширение Azure для SAP активно работает на Azure Linux VM. Проверьте, создан ли файл \\var\\lib\\AzureEnhancedMonitor\\PerfCounters. Если она существует, в запросе команды запустите эту команду для отображения информации, собранной расширением Azure для SAP:
...
## <a name="checks-and-troubleshooting-for-end-to-end-data-collection-for-sap-host-agent"></a><a name="564adb4f-5c95-4041-9616-6635e83a810b"></a>Проверки и устранение неполадок для сквозного сбора данных для агента SAP Host

После развертывания VM Azure и настройки соответствующего расширения Azure для SAP проверьте, работают ли все компоненты расширения как ожидалось.

Запустите проверку готовности расширения Azure для SAP, описанную в [проверке готовности расширения Azure для SAP.][deployment-guide-5.1] Если результаты проверки готовности являются положительными и все соответствующие счетчики производительности отображаются в порядке, Azure Extension для SAP была успешно настроена. В этом случае продолжайте установку агента SAP Host Agent, как описано в примечаниях к SAP, указанных в разделе [Ресурсы SAP][deployment-guide-2.2]. Если проверка готовности указывает на отсутствие счетчиков, запустите проверку работоспособности расширения Azure для SAP, как описано в [проверке работоспособности для расширения Azure для конфигурации SAP.][deployment-guide-5.2] Дополнительные варианты устранения неполадок [см.][deployment-guide-5.3]
...
Эта проверка гарантирует, что все показатели производительности, отображаемые в приложении SAP, предоставляются базовым расширением Azure для SAP.
...
1. В запросе команды измените каталог в папку установки расширения Azure\\для\\SAP:\\C: Пакеты Плагины Microsoft.AzureCAT.AzureEnhancedMonitoring.AzureCATExtensionверсия\\&lt;версии>\\падение

   *Версия* на пути к расширению может отличаться. Если в папке установки вы видите папки для нескольких версий расширения, проверьте конфигурацию службы AzureEnhancedMonitoring Windows, а затем переключитесь на папку, указанную как *Путь к исполняемой.*

   ![Свойства сервиса под управлением расширения Azure для SAP][deployment-guide-figure-1000]
...
Если расширение Azure для SAP не установлено или служба AzureEnhancedMonitoring не работает, расширение не настроено правильно. Подробную информацию о том, как развернуть расширение, можно найти в [ScAP по scinshooting Extension.][deployment-guide-5.3]

> [!NOTE]
> Компонент Azperflib.exe нельзя использовать в собственных целях. Это компонент, который предоставляет данные инфраструктуры Azure, связанные с VM исключительно для агента SAP Host.
> 

##### <a name="check-the-output-of-azperflibexe"></a>Проверка результата выполнения azperflib.exe

Результат выполнения файла azperflib.exe содержит все заполненные счетчики производительности Azure для SAP. В нижней части списка собранных счетчиков резюме и индикатор аработоспособности показывают состояние расширения Azure для SAP.
...
| Итоговые значения azperflib.exe | Расширение Azure для состояния здоровья SAP |
| --- | --- |
...
| **Состояние здоровья** |Только OK, если статус возврата показывает **OK**. |
| **Диагностики** |Подробные сведения о состоянии работоспособности. |

Если значение **состояния работы** не **является ОК,** следуйте инструкциям проверки [работоспособности для расширения Azure для конфигурации SAP.][deployment-guide-5.2]
...
1. Проверьте выход расширения Azure для SAP.
...
1. Убедитесь, что расширение Azure для SAP установлено и работает.
   ...
   **Ожидаемый результат:** Перечисляет содержимое расширения Azure для каталога SAP.
...
Если какая-либо из этих проверок не удается, а [Troubleshooting the Azure Extension for SAP][deployment-guide-5.3]также подробная информация о том, как передислоцировать расширение, см.

### <a name="health-check-for-the-azure-extension-for-sap-configuration"></a><a name="e2d592ff-b4ea-4a53-a91a-e5521edb6cd1"></a>Проверка работоспособности для расширения Azure для конфигурации SAP

Если некоторые данные инфраструктуры не будут доставлены правильно, как указано в тесте, `Test-AzVMAEMExtension` описанном в [проверке готовности для расширения Azure для SAP,][deployment-guide-5.1]запустите cmdlet, чтобы проверить, правильно ли настроены инфраструктура Azure и расширение Azure для SAP.
...
1. После этого сценарий тестирует конфигурацию выбранной виртуальной машины.
   ...
   ![Выход успешного тестирования расширения Azure для SAP][deployment-guide-figure-1300]

Убедитесь, что для каждой проверки установлено состояние **ОК**. Если некоторые проверки не отображаются **OK,** запустите обновление cmdlet, как описано в [Настройке расширения Azure для SAP.][deployment-guide-4.5] Подождите 15 минут и повторите проверки, описанные в [проверке готовности для Azure Extension для SAP][deployment-guide-5.1] и [проверки работоспособности для Azure Extension для конфигурации SAP.][deployment-guide-5.2] Если проверки по-прежнему указывают на проблему [Troubleshooting the Azure Extension for SAP][deployment-guide-5.3]с некоторыми или всеми счетчиками, см.

> [!Note]
> Вы можете получить некоторые предупреждения в случаях, когда вы используете Управляемые диски Azure (цен. категория "Стандартный"). Предупреждения будут отображаться вместо тестов, возвращающих "ОК". Это нормально в случае с этим типом диска. Смотрите также [см. Проблемы расширения Azure для SAP][deployment-guide-5.3]
> 

### <a name="troubleshooting-azure-extension-for-sap"></a><a name="fe25a7da-4e4e-4388-8907-8abc2d33cfd8"></a>Устранение проблем azure Extension для SAP
...
![Выполнение azperflib.exe указывает на то, что служба расширения Azure для SAP не работает][deployment-guide-figure-1400]
<a name="figure-14"></a>

###### <a name="solution"></a>Решение

Если служба не существует, расширение Azure для SAP не было установлено правильно. Разверните расширение повторно, выполнив действия для сценария развертывания, описанные в разделе [Сценарии развертывания ПО SAP на виртуальных машинах Azure][deployment-guide-3].
...
##### <a name="service-for-azure-extension-for-sap-exists-but-fails-to-start"></a>Служба расширения Azure для SAP существует, но не может начаться
...
Недопустимая конфигурация. Перезапустите расширение Azure для SAP в VM, как описано в [настройке расширения Azure для SAP.][deployment-guide-4.5]
...
Каталог \\var\\lib\\waagent\\ не имеет субдиректоров для расширения Azure для SAP.
...
##### <a name="the-execution-of-set-azvmaemextension-and-test-azvmaemextension-show-warning-messages-stating-that-standard-managed-disks-are-not-supported"></a>Выполнение Set-AzVMAEMExtension и Test-AzVMAEMExtension показывают предупреждающие сообщения о том, что стандартные управляемые диски не поддерживаются

###### <a name="issue"></a>Проблема

При выполнения сообщений Set-AzVMAEMExtension или Test-AzVMAEMExtension, подобных этим, отображаются:
...
Сообщения вызваны тем фактом, что стандартные управляемые диски не обеспечивают AIS, используемые SAP Extension для SAP для проверки статистики учетных записей хранилища Standard Azure. Это не повод для беспокойства. Причиной введения данных о сборе данных для учетных записей standard Disk Storage было регулирование ввода-отсу, которое часто происходило. Управляемые диски позволяют избежать такого регулирования за счет ограничения количества дисков в учетной записи хранилища. Таким образом, отсутствие такого типа этих данных не является критическим.
...
Полный и актуальный список известных проблем можно найти в SAP Note [1999351,]который имеет дополнительную информацию об устранении неполадок для Azure Extension для SAP.

Если устранение неполадок с помощью SAP Note [1999351] не решает проблему, перезапустите сценарий `Set-AzVMAEMExtension` конфигурации, описанный в [настройке расширения Azure для SAP.][deployment-guide-4.5] Необходимо подождать час, так как счетчики аналитики или диагностики хранилищ создаются не сразу после включения. Если проблема не исчезла, откройте сообщение о поддержке клиентов SAP в компоненте BC-OP-NT-AZR для виртуальной машины Windows или BC-OP-LNX-AZR для виртуальной машины Linux.
