...
1. Задайте следующие параметры:
    ...
    * **Имя пользователя, пароль администратора или ключ SSH**. Создается новый пользователь, учетные данные которого можно использовать для входа на этот компьютер.
...
1. Создайте виртуальную машину 1.  
   Используйте версию не ниже Red Hat Enterprise Linux 7.4 для SAP HANA. В этом примере используется образ Red Hat Enterprise Linux 7.4 для SAP HANA <https://ms.portal.azure.com/#create/RedHat.RedHatEnterpriseLinux74forSAPHANA-ARM> выберите группу доступности, созданную в шаге 3.
...
Описание симуляции сетевого сбоя см. в [статье базы знаний Red Hat 79523](https://access.redhat.com/solutions/79523). В этом примере мы используем сценарий net_breaker для полной блокировки доступа к сети.
