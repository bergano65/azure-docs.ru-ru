...
Во время подготовки модуля HLI операционная команда Майкрософт устанавливает операционную систему. Со временем вам потребуется обслуживать операционную систему (например: установка исправлений, настройка, обновление и т. д.) на единице HLI.
...
Укажите следующие данные на ваш запрос в службу.
