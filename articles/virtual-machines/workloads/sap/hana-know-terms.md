...
- **Среда SAP**: один или несколько компонентов SAP, логически сгруппированных для выполнения бизнес-функций, таких как разработка, контроль качества, обучение, аварийное восстановление или производство.
...
- **Категория номеров SKU**: для больших экземпляров HANA предлагаются следующие две категории номеров SKU.
    - **Тип I класс**: S72, S72m, S96, S144, S144m, S192, S192m, S192xm, S224 и S224m
...
- **Редакция**. для меток крупных экземпляров Hana существуют две различные версии штампа. Они отличаются по архитектуре и сходству с узлами виртуальных машин Azure.
    ...
    - "Редакция 4,2" (версия 4,2): на существующих контроллерах домена версии 4 ресурсы переносятся в BareMetal инфраструктуру.  Клиенты могут получать доступ к своим ресурсам как к экземплярам BareMetal из портал Azure. 
