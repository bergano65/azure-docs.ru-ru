...
![Рис. 5. Второй Volume2 в диспетчер отказоустойчивости кластеров][sap-ha-guide-figure-8016]
...
![Рисунок 7. "Выбор общего ресурса SMB — быстрая"][sap-ha-guide-figure-8018]

_**Рисунок 7.** Выбор "Общий ресурс SMB — быстрый профиль"_

<br>

![Рисунок 8. Выберите "sapglobalhost2" и укажите путь в Volume2][sap-ha-guide-figure-8019]

_**Рисунок 8.** Выбор "sapglobalhost2" и указание пути к Volume2_

<br>

![Рисунок 9. Задайте для файлового ресурса имя "sapmnt".][sap-ha-guide-figure-8020]

_**Рисунок 9.** Указание имени "sapmnt" для файлового ресурса_

<br>

![Рисунок 10. Отключить все параметры][sap-ha-guide-figure-8021]
...
![Рисунок 13. Создается вторая sapmnt, привязанная к узлу узлу sapglobal2 и Volume2][sap-ha-guide-figure-8024]
...
* [Установите экземпляр ASCS/SCS в отказоустойчивом кластере без общих дисков][sap-official-ha-file-share-document]: официальные рекомендации SAP для файлового ресурса высокой доступности.
