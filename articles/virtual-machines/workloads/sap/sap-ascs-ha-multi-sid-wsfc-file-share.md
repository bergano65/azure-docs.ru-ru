...
_**Рисунок 1:** Экземпляр SAP ASCS/SCS и SOFS развернуты в двух кластерах_
...
_**Рисунок 2:** Конфигурация SAP с несколькими SID в двух кластерах_
...
Создать группу ** \<доменов\<домен> SAP_ SID2>_GlobalAdmin,** например, с \<SID2> и PR2. Имя группы домена — \<Домен>\SAP_PR2_GlobalAdmin.
...
Вы можете повторно \<использовать существующие> SAPGlobalHost и \<Том1 первой> системы SAP SID1.
...
>
>Путь файла \<для> глобального хоста SID2 — C: «ClusterStorage\\**Volume1**»usr»sap\<SID2>\.
>
...
Вы можете настроить второй SOFS (например, вторую роль кластера SOFS с ** \<>SAPGlobalHost2** и другой **Том2** для второго ** \<>SID2). **
...
Чтобы создать раздел файла SAPMNT на Volume2 с * \<sapGlobalHost2* \<>хост-именем для второго sAP SID2>, запустите мастер-разбойник **Add File Share** в Failover Cluster Manager.
...
![Рисунок 7: "Выберите долю малого и среднего бизнеса - Быстро"][sap-ha-guide-figure-8018]
...
_**Рисунок 8:** Выберите "sapglobalhost2" и укажите путь на Volume2_

<br>

![Рисунок 9: Установите имя общего файла для "sapmnt"][sap-ha-guide-figure-8020]

_**Рисунок 9:** Установите имя общего файла на "sapmnt"_
...
_**Рисунок 12:** Выберите "Создать"_
