...
Несколько виртуальных IP-адресов можно управлять с помощью [внутреннего балансировщика нагрузки Azure][load-balancer-multivip-overview]. 
...
Эти действия описаны в [Подготовка инфраструктуры для сценария с несколькими ИД безопасности SAP][sap-ascs-ha-multi-sid-wsfc-shared-disk-infrast-prepare].
...
![Рис. 4. SOFS с несколькими ИД безопасности размещается на глобальном узле 2 SAP][sap-ha-guide-figure-8015]

_**Рис. 4.** SOFS с несколькими ИД безопасности размещается на глобальном узле 2 SAP_
...
![Рисунок 6. Запуск мастера добавления файлового ресурса][sap-ha-guide-figure-8017]

_**Рисунок 6.** Запуск мастера добавления файлового ресурса_

<br>

![Рисунок 7. «Выберите общий ресурс SMB — быстрый»][sap-ha-guide-figure-8018]

_**Рисунок 7.** Выбор "Общий ресурс SMB — быстрый профиль"_

<br>

![Рисунок 8. Выбор «sapglobalhost2» и указание пути на Volume2][sap-ha-guide-figure-8019]

_**Рисунок 8.** Выбор "sapglobalhost2" и указание пути к Volume2_

<br>

![Рисунок 9. Указание имени файлового ресурса «sapmnt»][sap-ha-guide-figure-8020]

_**Рисунок 9.** Указание имени "sapmnt" для файлового ресурса_

<br>

![Рисунок 10. Отключение всех параметров][sap-ha-guide-figure-8021]

_**Рисунок 10.** Отключение всех параметров_
...
_**Рисунок 11.** Предоставление полного доступа для учетных записей группы пользователей и компьютера_

<br>

![Рисунок 12. Выбор команды "Создать"][sap-ha-guide-figure-8023]

_**Рисунок 12.** Нажатие кнопки "Создать"_

<br>

![Рисунок 13. Привязать второго sapmnt к узлу sapglobal2 и создается Volume2][sap-ha-guide-figure-8024]

_**Рисунок 13.** Привязка второго ресурса sapmnt к узлу sapglobal2 и создание Volume2_
...
* [Установка экземпляра ASCS/SCS в отказоустойчивом кластере без общих дисков][sap-official-ha-file-share-document]: официальные рекомендации SAP для файлового ресурса высокой доступности.

* [Дисковые пространства в Windows Server 2016][s2d-in-win-2016]

* [Масштабируемый файловый сервер для обзора данных приложения][sofs-overview]
