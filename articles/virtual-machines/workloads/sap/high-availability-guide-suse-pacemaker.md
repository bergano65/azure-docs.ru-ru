...
1. **[A]** настройте Cloud-netconfig-Azure для высокодоступного кластера.
   ...
   >[!NOTE]
   > Проверьте установленную версию пакета **Cloud-netconfig-Azure** , запустив **zypper info Cloud-netconfig-Azure**. Если версия в вашей среде — 1,3 или более поздняя, больше не нужно подавлять Управление сетевыми интерфейсами подключаемым модулем облачной сети. Если версия ниже 1,3, мы рекомендуем обновить пакет **Cloud-netconfig-Azure** до последней доступной версии.  
...
1. **[A]** настройте параметры corosync.  
