...
11. Добавьте дополнительную область подкачки.
...
На виртуальной машине сервера приложений общий доступ к каталогу/sapmnt осуществляется через NFS с помощью параметров **RW** и **no_root_squash** . По умолчанию используются параметры **ro** и **root_squash**, но при установке экземпляра базы данных из-за них могут возникать проблемы.
