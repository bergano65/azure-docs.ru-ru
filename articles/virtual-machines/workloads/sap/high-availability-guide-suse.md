...
SAP NetWeaver требует общее хранилище для каталога профиля и транспорта. Чтение [высокого уровня доступности NFS на виртуальных машинах Azure в SUSE Linux Enterprise Server][nfs-ha] о том, как настроить сервер NFS для SAP NetWeaver.
...
1. Откройте [шаблон нескольких ИД безопасности ASCS/SCS][template-multisid-xscs] or the [converged template][template-converged] on the Azure portal. 
