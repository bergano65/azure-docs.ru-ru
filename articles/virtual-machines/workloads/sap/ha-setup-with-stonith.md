...
crm_mon
```
![crm-Мон. png ](media/HowToHLI/HASetupWithStonith/crm-mon.png) можно также войти в Hawk, чтобы проверить состояние кластера *https://\<node IP >: 7630*. Пользователь по умолчанию — hacluster, а пароль — linux. При необходимости можно изменить пароль с помощью команды *passwd*.
...
Кроме того, состояние можно просмотреть на странице *https://\<node IP-адрес >: 7630/ЦИБ/Live/State.*
...
![Before-фаиловер. png ](media/HowToHLI/HASetupWithStonith/Before-failover.png)  

**После выполнения отработки отказа**  
![after-фаиловер. png ](media/HowToHLI/HASetupWithStonith/after-failover.png)  
![crm-Мон-Афтер-фаиловер. png ](media/HowToHLI/HASetupWithStonith/crm-mon-after-failover.png)  
