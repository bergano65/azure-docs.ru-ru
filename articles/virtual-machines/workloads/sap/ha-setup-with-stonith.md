...
Если работа службы pacemaker *завершается сбоем*, дополнительные сведения см. в разделе *Сценарий 5. Сбой службы Pacemaker*.
