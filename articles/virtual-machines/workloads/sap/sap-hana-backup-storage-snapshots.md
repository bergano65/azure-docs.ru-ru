...
_&quot;настоятельно рекомендуется подтверждать или отменять моментальный снимок хранилища как можно скорее после его создания. Во время подготовки или создания моментального снимка хранилища данные, относящиеся к моментальному снимку, фиксируются. Хотя данные, относящиеся к моментальному снимку, остаются замороженными, в базе данных все еще можно вносить изменения. Такие изменения не приведут к изменению замороженных данных, релевантных для моментальных снимков. Вместо этого изменения записываются в позиции в области данных, которые отделены от моментального снимка хранилища. Изменения также записываются в журнал. Однако чем дольше данные, относящиеся к моментальному снимку, зазаморожены, тем больше объем данных может увеличиться.&quot;_
