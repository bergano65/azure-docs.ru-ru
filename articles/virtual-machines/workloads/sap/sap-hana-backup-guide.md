...
В Azure следует учитывать тот факт, что функция моментального снимка больших двоичных объектов Azure не&#39;t обеспечивает согласованность файловой системы на нескольких дисках (см. статью [Использование моментальных снимков BLOB-объектов с помощью PowerShell](https://blogs.msdn.microsoft.com/cie/2016/05/17/using-blob-snapshots-with-powershell/)). 
