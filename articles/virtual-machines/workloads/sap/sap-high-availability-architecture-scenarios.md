...
* **Кластеризация экземпляра SAP ASCS/SCS с использованием кластерных общих дисков**. Дополнительные сведения об этой архитектуре см. [в статье кластеризация экземпляра SAP ASCS/SCS в отказоустойчивом кластере Windows с помощью общего диска кластера][sap-high-availability-guide-wsfc-shared-disk].   

* **Кластеризация экземпляра SAP ASCS/SCS с использованием общей папки**. Дополнительные сведения об этой архитектуре см. [в статье кластеризация экземпляра SAP ASCS/SCS в отказоустойчивом кластере Windows с помощью файлового ресурса][sap-high-availability-guide-wsfc-file-share].
