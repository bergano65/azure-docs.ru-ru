...
* **Кластеризация экземпляра SAP ASCS/SCS с использованием общей папки**. Дополнительные сведения об этой архитектуре см. в статье [Кластеризация экземпляра SAP ASCS/SCS в отказоустойчивом кластере Windows с помощью файлового ресурса в Azure][sap-high-availability-guide-wsfc-file-share].
