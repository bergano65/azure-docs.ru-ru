...
| В | Тип I | eth1.tenant | eno2.tenant | Узел-хранилище |
| D | Тип I | eth4.tenant | eno4.tenant | STONITH |
| Объект | Тип II | >\<виртуальной ЛС тенантно | team0.tenant | Клиент-ХЛИ |
| B | Тип II | тенантно\<виртуальной ЛС + 2> | team0.tenant+2 | Между узлами|
| В | Тип II | Виртуальная ЛС\<тенантно + 1> | team0.tenant+1 | Узел-хранилище |
...
| Объект | Тип II | >\<виртуальной ЛС тенантно | team0.tenant | Клиент-ХЛИ |
| B | Тип II | тенантно\<виртуальной ЛС + 2> | team0.tenant+2 | Настроен, но не используется |
| В | Тип II | Виртуальная ЛС\<тенантно + 1> | team0.tenant+1 | Узел-хранилище |
...
| D | Тип I | eth4.tenant | eno4.tenant | Настроен, но не используется |
| Объект | Тип II | >\<виртуальной ЛС тенантно | team0.tenant | Клиент-ХЛИ |
| B | Тип II | тенантно\<виртуальной ЛС + 2> | team0.tenant+2 | Обмен данными между узлами |
| В | Тип II | Виртуальная ЛС\<тенантно + 1> | team0.tenant+1 | Узел-хранилище |
| D | Тип II | тенантно\<виртуальной ЛС + 3> | team0.tenant+3 | Настроен, но не используется |
...
| В | Тип I | eth1.tenant | eno2.tenant | Узел-хранилище |
| D | Тип I | eth4.tenant | eno4.tenant | Настроен, но не используется |
| Объект | Тип II | >\<виртуальной ЛС тенантно | team0.tenant | Клиент-ХЛИ/HSR |
| B | Тип II | тенантно\<виртуальной ЛС + 2> | team0.tenant+2 | Настроен, но не используется |
| В | Тип II | Виртуальная ЛС\<тенантно + 1> | team0.tenant+1 | Узел-хранилище |
| D | Тип II | тенантно\<виртуальной ЛС + 3> | team0.tenant+3 | Настроен, но не используется |
