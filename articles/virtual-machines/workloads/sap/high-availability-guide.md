...
* [Настройка Always On группы доступности на виртуальных машинах Azure вручную с помощью диспетчер ресурсов][virtual-machines-windows-portal-sql-alwayson-availability-groups-manual]
* [Настройка внутреннего балансировщика нагрузки Azure для группы доступности Always On в Azure][virtual-machines-windows-portal-sql-alwayson-int-listener]
...
Чтобы настроить шаблон ASCS/SCS с несколькими идентификаторами безопасности, в шаблоне с [несколькими ИД безопасности ASCS/SCS][sap-templates-3-tier-multisid-xscs-marketplace-image]введите значения для следующих параметров:
...
Чтобы настроить шаблон базы данных с несколькими идентификаторами безопасности, в [шаблоне с несколькими ИД безопасности базы данных][sap-templates-3-tier-multisid-db-marketplace-image]введите значения для следующих параметров:
...
Чтобы настроить шаблон серверов приложений с несколькими идентификаторами безопасности, в [шаблоне серверы приложений с несколькими идентификаторами безопасности][sap-templates-3-tier-multisid-apps-marketplace-image]введите значения для следующих параметров:
...
2. Выберите параметры в зависимости от типа сети. Для получения дополнительных сведений см. следующие ресурсы:
   ...
   * Для развертываний, которые изолируются в Azure, сделайте следующее. Разверните в том же экземпляре виртуальной сети дополнительную виртуальную машину, которая будет выполнять функции DNS-сервера. Добавьте IP-адреса этих виртуальных машин Azure, настроенных для запуска службы DNS.
