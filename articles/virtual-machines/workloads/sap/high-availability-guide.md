...
2. Выберите параметры в зависимости от типа сети. Дополнительные сведения см. в следующих ресурсах:
   ...
   * Для развертывания, изолированного в Azure: Развертывание дополнительной виртуальной машины в том же экземпляре виртуальной сети, который служит DNS-сервером. Добавьте IP-адреса этих виртуальных машин Azure, настроенных для запуска службы DNS.
