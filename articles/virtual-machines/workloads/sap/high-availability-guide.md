...
2. Выберите параметры в зависимости от типа сети. Для получения дополнительных сведений см. следующие ресурсы:
   ...
   * Для развертываний, изолированных в Azure: разверните дополнительную виртуальную машину в том же экземпляре виртуальной сети, который служит DNS-сервером. Добавьте IP-адреса этих виртуальных машин Azure, настроенных для запуска службы DNS.
