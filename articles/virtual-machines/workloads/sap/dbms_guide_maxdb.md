...
#### <a name="performance-considerations-for-backup-and-restore"></a><a name="77cd2fbb-307e-4cbf-a65f-745553f72d2c"></a>Рекомендации по ускорению архивации и восстановления
...
#### <a name="other-considerations"></a><a name="f77c1436-9ad8-44fb-a331-8671342de818"></a>Другие соображения
...
#### <a name="storage-configuration-for-content-server-in-azure"></a>Конфигурация хранения для сервера содержимого в Azure
