...
- [Общие диски Azure](https://docs.microsoft.com/azure/virtual-machines/windows/disks-shared) — компонент, позволяющий одновременно подключать управляемый диск Azure к нескольким виртуальным машинам. 
...
Корпорация Майкрософт предлагает [Общие диски Azure](https://docs.microsoft.com/azure/virtual-machines/windows/disks-shared), которые можно использовать для реализации высокой доступности SAP ASCS/SCS с помощью параметра общий диск.
...
Дополнительные сведения об ограничениях для общего диска Azure см. в разделе " [ограничения](https://docs.microsoft.com/azure/virtual-machines/linux/disks-shared#limitations) " в документации по общим дискам Azure.
...
> [!TIP]
> При планировании развертывания SAP ознакомьтесь с [руководством по планированию SAP NetWeaver в Azure](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/planning-guide) и [руководством по службе хранилища Azure для рабочих нагрузок SAP](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/planning-guide-storage) .
