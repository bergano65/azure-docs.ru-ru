...
- [Общие диски Azure](../../windows/disks-shared.md) — компонент, позволяющий одновременно подключать управляемый диск Azure к нескольким виртуальным машинам. 
...
Корпорация Майкрософт предлагает [Общие диски Azure](../../windows/disks-shared.md), которые можно использовать для реализации высокой доступности SAP ASCS/SCS с помощью параметра общий диск.
...
Дополнительные сведения об ограничениях для общего диска Azure см. в разделе " [ограничения](../../linux/disks-shared.md#limitations) " в документации по общим дискам Azure.
