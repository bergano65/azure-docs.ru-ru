...
![Рис. 1. Windows конфигурация отказоустойчивого кластера в Azure без общего диска][sap-ha-guide-figure-1001]
...
![Рис. 2. Процессы, структура файлов и файловый ресурс sapmnt глобального узла экземпляра SAP ASCS/SCS][sap-ha-guide-figure-8001]

_**Рис. 2.** Процессы, структура файлов и файловый ресурс sapmnt глобального узла экземпляра SAP ASCS/SCS_
...
![Рис. 3. SAP ASCS/SCS высокого уровня ДОСТУПНОСТИ архитектуры с общим диском][sap-ha-guide-figure-8002]

_**Рис. 3.** SAP ASCS/SCS высокого уровня ДОСТУПНОСТИ архитектуры с общим диском_
...
![Рис. 4. SAP ASCS/SCS высокого уровня ДОСТУПНОСТИ архитектуры с общим диском][sap-ha-guide-figure-8003]

_**Рис. 4.** SAP ASCS/SCS высокого уровня ДОСТУПНОСТИ архитектуры с общим диском_
...
![Рис. 5. Windows Server конфигурация отказоустойчивого кластера в Azure с использованием SIOS DataKeeper][sap-ha-guide-figure-1002]

_**Рис. 5.** Windows конфигурация отказоустойчивого кластера в Azure с использованием SIOS DataKeeper_
