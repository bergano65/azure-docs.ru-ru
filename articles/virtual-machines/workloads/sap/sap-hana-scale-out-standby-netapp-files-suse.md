...
description: Узнайте, как развернуть SAP HANA масштабируемые системы с резервным узлом на виртуальных машинах Azure с помощью Azure NetApp Files на SUSE Linux Enterprise Server.
