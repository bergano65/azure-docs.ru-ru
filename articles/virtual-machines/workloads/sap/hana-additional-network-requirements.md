...
Обратитесь в службу поддержки решения "SAP HANA для управления службами Майкрософт". Если вам порекомендовали увеличить пропускную способность канала ExpressRoute SAP HANA в Azure (крупные экземпляры), создайте запрос на поддержку Azure. (Можно запросить увеличение пропускной способности одного канала до 10 Гбит/с.) После завершения операции вы получите уведомление. Вам не нужно ничего делать, чтобы включить эту более высокую скорость в Azure.
