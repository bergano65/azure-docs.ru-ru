...
11. Убедитесь, что виртуальные машины развернуты в соответствующей [группе размещения Azure](../../linux/co-location.md), как описано в разделе [группы размещения службы "близость" Azure для оптимальной сетевой задержки с приложениями SAP](sap-proximity-placement-scenarios.md).
...
1.  После развертывания инфраструктуры и приложений проверьте следующее:
    ...
    - Виртуальные машины развертываются в правильной [группе размещения Azure](../../linux/co-location.md), как описано в разделе [группы размещения службы "близость" Azure для оптимальной сетевой задержки с приложениями SAP](sap-proximity-placement-scenarios.md).
