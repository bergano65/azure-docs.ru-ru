...
* Рекомендуется отформатировать тома с помощью новой системы Resilient File System (ReFS).
    * Дополнительные сведения см. в разделе [SAP Note 1869038-поддержка SAP для файловой системы ReFs][1869038] и в разделе " [Файловая система][planning-volumes-s2d-choosing-filesystem] " статьи Планирование томов в Локальные дисковые пространства.
...
* Чтобы обеспечить оптимальную производительность внутри сети виртуальных машин, необходимую для синхронизации дисков Локальных дисковых пространств, используйте тип виртуальной машины с высокой пропускной способностью сети.
    Дополнительные сведения см. в спецификации серии [DSv2][dv2-series] и [DS-Series][ds-series] .
...
* [Глубокое углубление: тома в Локальные дисковые пространства][deep-dive-volumes-in-s2d]
