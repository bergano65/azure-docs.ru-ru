...
Ниже приведена базовая конфигурация для различных размеров и использования развертываний SAP в DB2 с небольшим и очень большим объемом.
...
| Имя или размер виртуальной машины |Точка подключения DB2 |Диски Azure класса Premium |NR дисков |Количество операций ввода-вывода в секунду |Пропускная способность [МБ/с] |Размер [ГБ] |Ускоренные операции ввода-вывода |Фи нагрузки [ГБ] | Размер полосы | Кэширование |
| --- | --- | --- | :---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
|E4ds_v4 |/db2 |P6 |1 |240  |50  |64  |3,500  |170  ||  |
|Виртуальных ЦП: 4 |/DB2/ <SID> /sapdata |P6 |4 |960  |200  |256  |14,000  |680  |256 КБ |ReadOnly |
|ОЗУ: 32 гиб |/DB2/ <SID> /саптмп |P6 |2 |480  |100  |128  |7,000  |340  |128 КБ ||
| |/DB2/ <SID> /log_dir |P6 |2 |480  |100  |128  |7,000  |340  |64 КБ ||
...
|Виртуальных ЦП: 16 |/DB2/ <SID> /sapdata |P15 |4 |4,400  |500  |1,024  |14,000  |680  |256 КБ |ReadOnly |
|ОЗУ: 128 гиб |/DB2/ <SID> /саптмп |P6 |2 |480  |100  |128  |7,000  |340  |128 КБ ||
| |/DB2/ <SID> /log_dir |P15 |2 |2,200  |250  |512  |7,000  |340  |64 КБ ||
| |/DB2/ <SID> /offline_log_dir |P10 |1 |500  |100  |128  |3,500  |170  ||| 
...
|Виртуальных ЦП: 32 |/DB2/ <SID> /sapdata |P30 |2 |10,000  |400  |2,048  |10,000  |400  |256 КБ |ReadOnly |
|ОЗУ: 256 гиб |/DB2/ <SID> /саптмп |P10 |2 |1,000  |200  |256  |7,000  |340  |128 КБ ||
| |/DB2/ <SID> /log_dir |P20 |2 |4,600  |300  |1,024  |7,000  |340  |64 КБ ||
...
|Виртуальных ЦП: 64 |/DB2/ <SID> /sapdata |P30 |4 |20,000  |800  |4096  |20,000  |800  |256 КБ |ReadOnly |
|ОЗУ: 504 гиб |/DB2/ <SID> /саптмп |P15 |2 |2,200  |250  |512  |7,000  |340  |128 КБ ||
| |/DB2/ <SID> /log_dir |P20 |4 |9,200  |600  |2,048  |14,000  |680  |64 КБ ||
| |/DB2/ <SID> /offline_log_dir |P20 |1 |2,300  |150  |512  |3,500  |170  || |

#### <a name="large-multi-terabyte-sap-system-database-size-2tb-global-business-suite-system"></a>Большая многотерабайтовая система SAP: размер базы данных 2 ТБ +: Глобальная система бизнес-набора
| Имя или размер виртуальной машины |Точка подключения DB2 |Диски Azure класса Premium |NR дисков |Количество операций ввода-вывода в секунду |Пропускная способность [МБ/с] |Размер [ГБ] |Ускоренные операции ввода-вывода |Фи нагрузки [ГБ] | Размер полосы | Кэширование |
| --- | --- | --- | :---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
|M128s |/db2 |P10 |1 |500  |100  |128  |3,500  |170  || |
|Виртуальных ЦП: 128 |/DB2/ <SID> /sapdata |P40 |4 |30,000  |1,000  |8,192  |30,000  |1,000  |256 КБ |ReadOnly |
|ОЗУ: 2048 гиб |/DB2/ <SID> /саптмп |P20 |2 |4,600  |300  |1,024  |7,000  |340  |128 КБ ||
