...
- [единицы крупного экземпляра HANA](#validate-the-hana-large-instance-units);
...
- См. статью об [установке HANA в HLI](hana-example-installation.md).
