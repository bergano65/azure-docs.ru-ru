...
Для получения дополнительных сведений об ограничениях для общего диска Azure внимательно ознакомьтесь с разделом [ограничения](../../disks-shared.md#limitations) в документации по общим дискам Azure.  
