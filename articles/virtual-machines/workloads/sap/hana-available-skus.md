...
| Решение SAP | ЦП | Память | Storage | Доступность |
| --- | --- | --- | --- | --- |
| Оптимизировано для OLAP: SAP BW, BW/4HANA<br /> или SAP HANA для общих рабочих нагрузок OLAP | SAP HANA на виртуальных машинах Azure S72<br /> — 2 процессора Intel® Xeon® E7-8890 v3<br /> 36 ядер ЦП и 72 потока ЦП |  768 ГБ |  3 ТБ | Больше не предоставляются |
...
| SKU|ЦП | Память | Storage | Доступность |
| ---| --- | --- | --- | --- |
| S96 | SAP HANA на виртуальных машинах Azure S96<br /> — 2 процессора Intel® Xeon® E7-8890 v4<br /> 48 ядер ЦП и 96 потоков ЦП |  768 ГБ |  3 ТБ | Доступно в метках Revision3 и Revision4|


| Оригинальные номера SKU, для которых можно <br /> увеличить объем памяти | ЦП | Память | Storage | Доступность |
| --- | --- | --- | --- | --- |
...
- S72, S72m, S96, S144, S144m, S192, S192m, S192xm и S224, которые называются номерами SKU типа I.
