...
| --- | --- | --- | --- | --- |
| Оптимизировано для OLAP: SAP BW/4 HANA<br /> или SAP HANA для общих рабочих нагрузок OLAP | SAP HANA на виртуальных машинах Azure S72<br /> — 2 процессора Intel® Xeon® E7-8890 v3<br /> 36 ядер ЦП и 72 потока ЦП |  768 ГБ |  3 TБ | Доступна |
