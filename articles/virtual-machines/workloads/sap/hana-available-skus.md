...
| Решение SAP | ЦП | Память | Память | Доступность |
| --- | --- | --- | --- | --- |
...
| --- | SAP HANA в Azure S224<br /> — 4 процессора Intel® Xeon® Platinum 8276 (также известный как Cascade Lake)<br /> 112 ядер ЦП и 224 ЦП |  3 ТБ |  6,3 ТБ | Доступно в метках Revision3 и Revision4  |
| --- | SAP HANA на виртуальных машинах Azure S384<br /> — 8 процессоров Intel® Xeon® E7-8890 v4<br /> 192 ядра ЦП и 384 потока ЦП |  4 TБ |  16 ТБ | Доступно в метках Revision4 |
...
| --- | SAP HANA в Azure S224m<br /> — 4 процессора Intel® Xeon® Platinum 8276 (также известный как Cascade Lake)<br /> 112 ядер ЦП и 224 ЦП |  6 ТБ |  10,5 ТБ | Доступно в метках Revision3 и Revision4  |
|---| SAP HANA на виртуальных машинах Azure S384m<br /> — 8 процессоров Intel® Xeon® E7-8890 v4<br /> 192 ядра ЦП и 384 потока ЦП |  6 ТБ |  18 ТБ | Доступно в метках Revision4|
|---| SAP HANA на виртуальных машинах Azure S384xm<br /> — 8 процессоров Intel® Xeon® E7-8890 v4<br /> 192 ядра ЦП и 384 потока ЦП |  8 TБ |  22 ТБ |  Доступно в метках Revision4 |
|---| SAP HANA на виртуальных машинах Azure S576m<br /> — 12 процессоров Intel® Xeon® E7-8890 v4<br /> 288 ядер ЦП и 576 потоков ЦП |  12 ТБ |  28 ТБ | Доступно в метках Revision4|
|---| SAP HANA на виртуальных машинах Azure S768m<br /> — 16 процессоров Intel® Xeon® E7-8890 v4<br /> 384 ядра ЦП и 768 потоков ЦП |  16 TБ |  36 ТБ | Доступно в метках Revision4|
|---| SAP HANA на виртуальных машинах Azure S960m<br /> — 20 процессоров Intel® Xeon® E7-8890 v4<br /> 480 ядер ЦП и 960 потоков ЦП |  20 ТБ |  46 ТБ | Доступно в метках Revision4|
...
| номер SKU|ЦП | Память | Память | Доступность |
| ---| --- | --- | --- | --- |
| S96 | SAP HANA на виртуальных машинах Azure S96<br /> — 2 процессора Intel® Xeon® E7-8890 v4<br /> 48 ядер ЦП и 96 потоков ЦП |  768 ГБ |  3 TБ | Доступно в метках Revision3 и Revision4|


| Оригинальные номера SKU, для которых можно <br /> увеличить объем памяти | ЦП | Память | Память | Доступность |
| --- | --- | --- | --- | --- |
...
| S384xm можно увеличить до | SAP HANA на виртуальных машинах Azure S384xxm<br /> — 8 процессоров Intel® Xeon® E7-8890 v4<br /> 192 ядра ЦП и 384 потока ЦП |  12 ТБ |  28 ТБ | Доступно в метках Revision4 |
| S576m можно увеличить до | SAP HANA на виртуальных машинах Azure S576xm<br /> — 12 процессоров Intel® Xeon® E7-8890 v4<br /> 288 ядер ЦП и 576 потоков ЦП |  18,0 TБ |  41 TБ | Доступно в метках Revision4|
| S768m можно увеличить до | SAP HANA на виртуальных машинах Azure S768xm<br /> — 16 процессоров Intel® Xeon® E7-8890 v4<br /> 384 ядра ЦП и 768 потоков ЦП |  24,0 TБ |  56 ТБ | Доступно в метках Revision4 |
...
- S72, S72m, S96, S144, S144m, S192, S192m, S192xm, S224 и S224m, называемые номерами SKU типа I.
- S384, S384m, S384xm, S384xxm, S576m, S576xm S768m, S768xm и S960m, которые называются номерами SKU типа II.
- Если вы заинтересованы в других S224 SKU с версии 4.5 ТБ и 9TB с Оптане, обратитесь к группе учетная запись Майкрософт, чтобы получить дополнительные сведения. 
