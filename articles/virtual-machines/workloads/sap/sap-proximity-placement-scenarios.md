...
- При списании Azure оборудование может принудительно выполнять определенные виртуальные машины группы размещения с близкой назначением в другой центр обработки данных Azure. Дополнительные сведения об этом случае см. в документе [совместное размещение ресурсов для повышения задержки](../../co-location.md#planned-maintenance-and-proximity-placement-groups) .  
