...
1. Войдите на основной сервер приложений экземпляра J2EE и выполните команду: `sudo /usr/sap/*SID*/*Instance*/j2ee/configtool/configtool.sh`.
...
Можно использовать существующие общие ресурсы NFS высокой доступности для транспорта или каталога профиля. Дополнительные сведения см. здесь:
