...
| Подсистема балансировки нагрузки Azure | Использование уровня "базовый" или "Стандартный" (рекомендуется), порт пробы для базы данных DB2 (наш Совет 62500) **пробный порт**. |
...
1. Создайте пул серверной части:
   ...
   . Выберите группу доступности или виртуальные машины, на которых размещена база данных IBM DB2, созданная на предыдущем шаге.
...
1. Создайте правила балансировки нагрузки.
   ...
   . Установите для параметра **протокол** значение **TCP**и введите порт *связи с базой данных*порта.
