...
В этом руководстве описывается настройка высокодоступного NFS-сервера, который используется двумя системами SAP, NW1 и NW2. Имена ресурсов (например, виртуальные машины, виртуальные сети), в примере предполагают, что вы использовали [шаблон файлового сервера SAP][template-file-server] с префиксом ресурсов **prod**.
...
* [SUSE Linux Enterprise высокого уровня доступности расширения 12 SP3 лучшие рекомендации, руководства по][sles-hae-guides]
