...
* [Развертывание виртуальных машин и управление ими с помощью шаблонов диспетчера ресурсов Azure и интерфейса командной строки Azure](../../linux/create-ssh-secured-vm-from-template.md)
...
Приведенный выше сценарий описывает сценарий, в котором локальная среда
...
| gateway |sapgw`<nn`> см. * |3301 |свободный |Шлюз SAP, используемый для взаимодействия CPIC и RFC |
