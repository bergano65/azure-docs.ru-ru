...
Приведенный выше сценарий описывает сценарий, в котором локальная
...
| Маршрутизатор SAP |sapdp99 |3299 |Бесплатный |Только имена службы CI (центрального экземпляра) можно заменить в файле /etc/services произвольными значениями после установки. |
