...
Также прочитайте главу [Azure CLI для виртуальных машин Linux][deployment-guide-4.5.2] в разделе [руководство по развертыванию][planning-guide] , где описано, как использовать Azure CLI для развертывания расширения мониторинга Azure для SAP.
