...
Более подробные инструкции по установке, обновлению и настройке командлетов Azure PowerShell также можно найти в [этой главе руководства][deployment-guide-4.1]по развертыванию.
...
Развертывание расширения мониторинга Azure для SAP (см. раздел [решение мониторинга Azure для SAP][planning-guide-9.1] в этом документе) возможно только с помощью POWERSHELL или CLI. Поэтому при развертывании или администрировании системы SAP NetWeaver в Azure нужно обязательно установить и настроить PowerShell или интерфейс командной строки.  
...
Также прочитайте главу [Azure CLI для виртуальных машин Linux][deployment-guide-4.5.2] в разделе [руководство][planning-guide] по развертыванию, где описано, как использовать Azure CLI для развертывания расширения мониторинга Azure для SAP.
...
Для окончательного развертывания и выполнения точных действий, особенно в отношении развертывания расширенного мониторинга SAP, ознакомьтесь с руководством по [развертыванию][deployment-guide].
