...
Дополнительные сведения см. [в статье доступность виртуальных машин Windows в Azure](../../manage-availability.md) и [доступность виртуальных машин Linux в Azure](../../manage-availability.md).
