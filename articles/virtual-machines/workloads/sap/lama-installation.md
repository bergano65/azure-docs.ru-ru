...
1. Щелкните "Добавить".
1. Введите имя, выберите тип приложения «Веб-приложение или API», введите URL-адрес входа (например, http:\//localhost) и выберите команду Создать
