...
![На снимке экрана показано окно командной строки с восстановлением.](media/HowToHLI/OSBackupTypeIISKUs/HowtoRestoreaBackup.PNG)
...
На следующем снимке экрана показано восстановление полной резервной копии. на ![ снимке экрана показано окно командной строки с восстановлением с помощью инструмента "задний запрос".](media/HowToHLI/OSBackupTypeIISKUs/RearToolConfiguration.PNG)
