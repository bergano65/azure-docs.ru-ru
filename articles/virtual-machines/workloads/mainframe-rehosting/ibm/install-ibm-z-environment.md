...
4. Войдите в [оболочку Bash](/azure/cloud-shell/quickstart) с локального компьютера и вставьте команду. Он будет иметь форму **SSH \<user id\> \@ \<IP Address\> **. При появлении запроса на ввод учетных данных введите их, чтобы установить подключение к домашнему каталогу.
