...
4. Войдите в [оболочку Bash](/azure/cloud-shell/quickstart) с локального компьютера и вставьте команду. Он будет иметь форму **ssh\<идентификатор пользователя\>\@\<IP-адрес\>** . При появлении запроса на ввод учетных данных введите их, чтобы установить подключение к домашнему каталогу.
...
1. Перейдите в каталог ЗДТ и распакуйте файл ЗДТ\_Install\_EE\_12.0.0.1. tgz с помощью следующих команд:
