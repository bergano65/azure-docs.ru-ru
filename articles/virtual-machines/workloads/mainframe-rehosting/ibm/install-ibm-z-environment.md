...
4. Войдите в [оболочку Bash](/azure/cloud-shell/quickstart) с локального компьютера и вставьте команду. Он будет иметь форму **SSH @ no__t-1user ID @ no__t-2 @ no__t-3 @ no__t-4IP Address @ no__t-5**. При появлении запроса на ввод учетных данных введите их, чтобы установить подключение к домашнему каталогу.

## <a name="copy-the-installation-file-to-the-server"></a>Копирование файла установки на сервер

Файл установки для веб-сервера — **ЗДТ @ no__t-1Install @ no__t-2EE\_V12.0.0.1.tgz**. Он входит в состав носителей, поставляемых IBM. Этот файл необходимо передать на виртуальную машину Ubuntu.
...
1. Перейдите в каталог ЗДТ и распакуйте файл ЗДТ @ no__t-0Install @ no__t-1EE\_V12.0.0.1.tgz с помощью следующих команд:
