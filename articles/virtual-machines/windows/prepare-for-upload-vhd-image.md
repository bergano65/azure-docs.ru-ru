...
1. Удалите все постоянные статические маршруты из таблицы маршрутизации.
   ...
   * Проверьте `Persistence Routes` разделы. Если имеется постоянный маршрут, удалите его с помощью команды `route delete`.
...
>[!NOTE]
> После выполнения `sysprep.exe` на следующих шагах выключите виртуальную машину. Не включайте его снова, пока вы не создадите образ в Azure.
