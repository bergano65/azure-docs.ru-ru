...
1. Нажмите правой кнопкой мыши меню **"Пуск"** и выберите **систему**
...
* Вы можете увеличить объем памяти, доступной для вашей виртуальной машины, [прикрепив дополнительный диск данных.](attach-managed-disk-portal.md)
