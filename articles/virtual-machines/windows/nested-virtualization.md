...
Не забудьте выбрать достаточно большой размер виртуальной машины для поддержки требований гостевой виртуальной машины. В этом примере мы используем виртуальную машину Azure размера D4_v3 size. 
