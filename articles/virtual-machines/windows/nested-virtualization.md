...
Создайте новую виртуальную машину Azure Windows Server 2016.  Для краткого справочника все виртуальные машины v3 поддерживают вложенную виртуализацию. Полный список размеров виртуальных машин, поддерживающих вложенность, можно найти в статье [Единицы вычислений Azure (ACU)](acu.md).
