...
1. На вкладке "Основные сведения" в разделе "Сведения о проекте" убедитесь, что выбрана правильная подписка, и при необходимости щелкните **Создать группу ресурсов**. В поле "Имя" введите *myResourceGroup*.
...
1. В разделе **Учетная запись администратора** выберите **Пароль**. Введите имя пользователя и пароль.
    ...
    :::image type="content" source="../media/disk-encryption/portal-qs-windows-vm-creation.png" alt-text="Экран создания группы ресурсов":::
