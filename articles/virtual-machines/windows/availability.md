---
title: Варианты доступности Azure для Вымотов Windows
description: Узнайте о функциях доступности для запуска виртуальных машин Windows в Azure
author: cynthn
ms.author: cynthn
