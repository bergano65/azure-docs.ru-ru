...
```
## <a name="enable-automatic-vm-guest-patching"></a>Включить автоматическую установку исправлений гостевых виртуальных машин
...
> [!NOTE]
>Оценка исправлений по запросу не приводит к автоматическому запуску установленного исправления. Оценка и применимые исправления для виртуальной машины устанавливаются только в часы низкой нагрузки на виртуальную машину, следуя процедуре установки исправлений, описанной выше в этом документе.
