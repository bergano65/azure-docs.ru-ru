...
Если вы используете PowerShell и у вас установлен модуль AzureRM, вы также можете установить подключение с помощью командлета `Get-AzRemoteDesktopFile`, как показано ниже.
