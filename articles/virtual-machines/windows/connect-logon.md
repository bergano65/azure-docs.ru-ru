---
title: Подключение к VM сервера Windows
...
Если вы используете PowerShell и установили модуль Azure PowerShell, вы также можете подключиться с помощью `Get-AzRemoteDesktopFile` cmdlet, как показано ниже.
