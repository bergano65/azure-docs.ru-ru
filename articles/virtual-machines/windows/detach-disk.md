---
title: Отсоедините диск данных от Windows VM - Azure
...
Вы можете *погорячим следом* удалить диск данных, но убедитесь, что ничто не активно использует диск, прежде чем отсоединить его от VM.

1. В меню слева выберите **Виртуальные машины**.
1. Выберите виртуальную машину, которая имеет диск данных, который вы хотите отсоединить.
1. В разделе **Параметры** выберите **Диски**.
1. В верхней части области **Диски** щелкните **Изменить**.
1. В панели **дисков,** в крайнем правом правом от диска данных, который вы хотели бы отсоединить, выберите **Detach**.
