...
В дополнение к рекомендациям, описанным в этом разделе, рекомендуется ознакомиться с рекомендациями по обеспечению безопасности как традиционными локальными методами безопасности, так и рекомендациями по обеспечению безопасности виртуальных машин. 

Дополнительные сведения о локальных методиках безопасности см. в статье [вопросы безопасности при установке SQL Server](/sql/sql-server/install/security-considerations-for-a-sql-server-installation) и [центре безопасности](/sql/relational-databases/security/security-center-for-sql-server-database-engine-and-azure-sql-database). 

Дополнительные сведения о безопасности виртуальных машин см. в статье [Общие сведения о безопасности виртуальных машин](/azure/security/fundamentals/virtual-machines-overview).
