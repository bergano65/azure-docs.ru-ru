...
- Проверьте разрешения учетной записи. Если вы создали бесплатную учетную запись Azure, вы являетесь администратором этой подписки. Если вы не администратор подписки, свяжитесь с администратором, чтобы получить необходимые разрешения. Чтобы включить репликацию для виртуальной машины и скопировать данные с помощью Azure Site Recovery, необходимо иметь следующее: 
...
- Сведения о создании наиболее часто используемых сетевых ресурсов на основе конфигурации исходной виртуальной машины см. в следующих документах. 
    ...
    - [Балансировщик нагрузки](../../../load-balancer/tutorial-load-balancer-basic-internal-portal.md)
...
1. Выберите **все службы** в левом верхнем углу панели навигации и в поле поиска введите `recovery services`. 
...
1. Вернитесь к хранилищу, выберите **реплицированные элементы**, выберите виртуальную машину SQL Server и нажмите кнопку **Commit (применить** ), чтобы завершить процесс перемещения в целевой регион. Дождитесь завершения выполнения задания. 
