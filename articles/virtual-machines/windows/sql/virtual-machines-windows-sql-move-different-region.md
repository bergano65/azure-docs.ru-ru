...
- Найдите исходный макет сетевой сети и все ресурсы, которые йоур'е в настоящий момент. Сюда могут входить, среди прочего, подсистемы балансировки нагрузки, группы безопасности сети и общедоступные IP-адреса. 
