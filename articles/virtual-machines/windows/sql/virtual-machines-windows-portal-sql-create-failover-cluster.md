...
1. После того как Azure создаст виртуальные машины, подключитесь к каждому из них с помощью протокола удаленного рабочего стола.
   ...
   При первом подключении к виртуальной машине с помощью протокола удаленного рабочего стола выводится запрос на разрешение обнаружения компьютера в сети. Нажмите кнопку **Да**.
