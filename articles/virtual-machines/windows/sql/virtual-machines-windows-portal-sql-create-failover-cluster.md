...
Следующий пример PowerShell создает отказоустойчивый кластер для **Windows Server 2008-2016**. Обновите скрипт, введя имена узлов (имена виртуальных машин) и доступный IP-адрес из виртуальной сети Azure:
...
Следующий пример PowerShell создает отказоустойчивый кластер для Windows Server 2019.  Дополнительные сведения см. в посвященном отказоустойчивом кластере блога [. Объект](https://blogs.windows.com/windowsexperience/2018/08/14/announcing-windows-server-2019-insider-preview-build-17733/#W0YAxO8BfwBRbkzG.97)сети кластера.  Обновите скрипт, введя имена узлов (имена виртуальных машин) и доступный IP-адрес из виртуальной сети Azure:
...
### <a name="test-connectivity"></a>Тестирование подключения
