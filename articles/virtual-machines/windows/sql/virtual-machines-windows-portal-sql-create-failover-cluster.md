...
- [технологии кластера под управлением Windows](https://technet.microsoft.com/library/hh831579.aspx);
- [экземпляры отказоустойчивого кластера SQL Server](https://msdn.microsoft.com/library/ms189134.aspx).
