...
* **Затраты** — Платите только за используемые услуги. Может быть экономичным вариантом внешнего архива и архива резервных копий. Дополнительные сведения см. на странице [Калькулятор цен](https://go.microsoft.com/fwlink/?LinkId=277060 "Калькулятор цен") и в статье [Цены Azure](https://go.microsoft.com/fwlink/?LinkId=277059 "Цены Azure").
...
| **Большой двоичный объект** |файл любого типа и размера. Для адресации больших двоичных объектов используется следующий формат URL-адресов: **https://[учетная_запись_хранения].blob.core.windows.net/[контейнер]/[большой_двоичный_объект]**. Дополнительные сведения о страничных BLOB-объектах см. в статье [Understanding Block and Page Blobs](https://msdn.microsoft.com/library/azure/ee691964.aspx) (Основные сведения о блочных, добавочных и страничных BLOB-объектах). |
...
> [!NOTE]
> SQL Server 2016 был обновлен для поддержки блочных BLOB-объектов. Дополнительные сведения см. в статье [Учебник. Использование службы хранилища больших двоичных объектов Microsoft Azure с базами данных SQL Server 2016](https://msdn.microsoft.com/library/dn466438.aspx).
> 
> 
...
2. Затем следуйте одному из следующих учебников, в которых описывается создание учетной записи и выполнение восстановления.
   ...
   * **SQL Server 2014:** [Руководство. Резервное копирование и восстановление SQL Server с помощью службы хранилища BLOB-объектов Microsoft Azure](https://msdn.microsoft.com/library/jj720558\(v=sql.120\).aspx).
   * **SQL Server 2016**: [Руководство. Использование службы хранилища больших двоичных объектов Microsoft Azure с базами данных SQL Server 2016](https://msdn.microsoft.com/library/dn466438.aspx)
