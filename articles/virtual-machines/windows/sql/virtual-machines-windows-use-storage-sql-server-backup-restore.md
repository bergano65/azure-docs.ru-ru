...
* **Цена**. Платите только за используемые услуги. Может применяться в качестве экономически эффективного решения по удаленному резервному копированию и архивированию. Для получения дополнительной информации смотрите [калькулятор ценообразования Azure](https://go.microsoft.com/fwlink/?LinkId=277060 "Калькулятор цен")и [статью Оцены Azure.](https://go.microsoft.com/fwlink/?LinkId=277059 "Цена статьи")
* **Моментальные снимки хранилищ**. Если файлы базы данных хранятся в большом двоичном объекте Azure и используется SQL Server 2016, то можно использовать [архивацию файлов моментальных снимков](https://msdn.microsoft.com/library/mt169363.aspx), чтобы выполнять архивацию и восстановление практически мгновенно.

Дополнительные сведения см. в статье [Резервное копирование и восстановление SQL Server с помощью службы хранилища BLOB-объектов Microsoft Azure](https://go.microsoft.com/fwlink/?LinkId=271617).
...
| Компонент | Описание |
| --- | --- |
| **Учетная запись хранилища** |Учетная запись хранения является отправной точкой для всех служб хранилища. Для доступа к службе хранилища BLOB-объектов Azure необходимо сначала создать учетную запись хранения Azure. Дополнительные сведения о службе хранилища BLOB-объектов Azure см. в статье [Приступая к работе с хранилищем BLOB-объектов Azure с помощью .NET](https://azure.microsoft.com/develop/net/how-to-guides/blob-storage/). |
...
| **BLOB-объект** |Файл любого типа и размера. Blobs можно адресовать с использованием следующего формата URL: **https://'s.storage account.blob.core.windows.net/.'контейнерный" / «blob».** Дополнительные сведения о страничных BLOB-объектах см. в статье [Understanding Block and Page Blobs](https://msdn.microsoft.com/library/azure/ee691964.aspx) (Основные сведения о блочных, добавочных и страничных BLOB-объектах). |
...
> [!NOTE]
> SQL Server 2016 был обновлен для поддержки блочных BLOB-объектов. Для получения более подробной информации [см.](https://msdn.microsoft.com/library/dn466438.aspx)
> 
> 
