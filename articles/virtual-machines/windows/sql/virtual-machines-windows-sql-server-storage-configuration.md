...
| Number of columns |Число дисков с данными до 8<sup>1</sup> |
...
| --- | --- | --- |
| **Общие** |Значение по умолчанию, поддерживающее большинство рабочих нагрузок |Нет |
