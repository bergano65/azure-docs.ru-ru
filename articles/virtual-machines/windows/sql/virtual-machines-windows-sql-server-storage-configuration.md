...
Чтобы изменить параметры хранения, выберите **Настройка** под **параметры**. 
...
Этот раздел содержит ссылки для изменения конфигурации хранилища, которые Azure выполняет автоматически во время подготовки виртуальной Машины SQL или конфигурации на портале Azure.
