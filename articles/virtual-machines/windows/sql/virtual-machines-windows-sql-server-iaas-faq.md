...
1. **Разделы справки перейти на другую версию или выпуск SQL Server на виртуальной машине Azure?**
   ...
   Клиенты могут изменить версию или выпуск SQL Server с помощью установочного носителя, который содержит требуемую версию или выпуск SQL Server. После изменения выпуска используйте портал Azure, чтобы изменить свойство Edition виртуальной машины, чтобы точно отобразить выставление счетов для виртуальной машины. Дополнительные сведения см. в разделе [изменение выпуска SQL Server виртуальной машины](virtual-machines-windows-sql-change-edition.md). 
