...
При добавлении виртуальной машины SQL Server в выделенный узел Azure можно выбрать один из двух различных вариантов лицензирования. 
  ...
  - **Лицензирование виртуальных машин SQL**. это существующий вариант лицензирования, где вы платите за каждую SQL Server лицензию на виртуальную машину по отдельности. 
