---
title: Автоматическая архивация для виртуальных машин Azure SQL Server 2014
...
На вкладке **параметры SQL Server** прокрутите вниз до пункта **Автоматическое резервное копирование** и выберите **включить**. На представленном ниже снимке экрана портала Azure показаны параметры **автоматического резервного копирования SQL**.
...
Для существующих SQL Server виртуальных машин можно включить и отключить автоматическое резервное копирование, изменить срок хранения, указать учетную запись хранения и включить шифрование из портал Azure. 

Перейдите к [ресурсу виртуальных машин SQL](virtual-machines-windows-sql-manage-portal.md#access-the-sql-virtual-machines-resource) для виртуальной машины SQL Server 2014, а затем выберите **резервные копии**. 
...
По завершении нажмите кнопку **Применить** в нижней части страницы **резервные копии** , чтобы сохранить изменения.
