...
|**Модель лицензирования на основе коммутатора** |Теперь вы можете переключаться между моделью оплаты за использование и моделью с использованием собственной лицензии для виртуальной машины SQL с помощью Azure CLI или PowerShell. Дополнительные сведения см. в статье об [изменение модели лицензирования для виртуальной машины SQL](virtual-machines-windows-sql-ahb.md). | 
| &nbsp; | &nbsp; |
...
* [Подготовка SQL Server Windows виртуальной Машины](virtual-machines-windows-portal-sql-server-provision.md)
* [Миграция базы данных SQL Server на виртуальной Машине Azure](virtual-machines-windows-migrate-sql.md)
...
* [Обзор SQL Server на виртуальной Машине Linux](../../linux/sql/sql-server-linux-virtual-machines-overview.md)
* [Подготовка виртуальной машины SQL Server Linux](../../linux/sql/provision-sql-server-linux-virtual-machine.md)
* [Часто задаваемые вопросы (Linux)](../../linux/sql/sql-server-linux-faq.md)
* [SQL Server в документации Linux](https://docs.microsoft.com/sql/linux/sql-server-linux-overview)
