---
title: Заметки о выпуске для SQL Server на виртуальных машинах Azure | Документация Майкрософт
...
| Документация | Подробнее |
| --- | --- |
| **Новый SQL Server портал управления ВМ** | Около десятка статей были обновлены до новой SQL Server интерфейс портала управления ВМ. | 
| &nbsp; | &nbsp; |
...
| **Улучшение портала** | Портал Azure возможности развертывания виртуальной машины SQL Server были пересмотрены для повышения удобства использования. Дополнительные сведения см. в [кратком руководстве](quickstart-sql-vm-create-portal.md) и подробное [руководство](virtual-machines-windows-portal-sql-server-provision.md) по развертыванию SQL Server виртуальной машины.|
| &nbsp; | &nbsp; |
