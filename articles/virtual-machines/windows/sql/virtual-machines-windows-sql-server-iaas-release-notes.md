...
| --- | --- |
| **Новых режимов установки SQL IaaS** | Теперь возможна установка расширения SQL IaaS в [упрощенном режиме](virtual-machines-windows-sql-server-agent-extension.md) во избежание перезапуска службы SQL Server.  |
| **Изменения выпуска SQL Server** | Теперь можно изменить [свойства edition](virtual-machines-windows-sql-change-edition.md) для виртуальной Машины SQL Server. |
| **Изменения виртуальной Машины SQL RP** | Вы можете [зарегистрировать виртуальную Машину SQL Server с поставщиком ресурсов виртуальной Машины SQL](virtual-machines-windows-sql-register-with-resource-provider.md#register-with-sql-vm-resource-provider) — даже [образы Windows 2008](virtual-machines-windows-sql-register-with-resource-provider.md#register-sql-server-2008r2-on-windows-server-2008-vms) -с помощью новых режимов SQL IaaS. |
| **Образы BYOL, с помощью AHUB** | Развернуть из marketplace образы BYOL возможность переключения их [тип для «PAYG» лицензии](virtual-machines-windows-sql-ahb.md#remarks).| 
| &nbsp; | &nbsp; |
...
| Улучшения службы | Сведения |
| --- | --- |
| **Улучшения портала** | Теперь имеется возможность изменить модель лицензирования для SQL Server виртуальной Машины с оплатой по мере использования использовать владельцем лицензии с помощью [портала Azure](virtual-machines-windows-sql-ahb.md#change-license-for-vms-already-registered-with-resource-provider)|
