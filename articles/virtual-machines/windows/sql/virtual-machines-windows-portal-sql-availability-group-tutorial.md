...
ms.locfileid: "60593379"
---
# <a name="tutorial-configure-always-on-availability-group-in-azure-vm-manually"></a>Руководство по Настройка группы доступности AlwaysOn на виртуальной машине Azure вручную
...
Прежде чем приступить к этому руководству, необходимо [настроить необходимые компонентов для создания групп доступности AlwaysOn на виртуальных машинах Azure](virtual-machines-windows-portal-sql-availability-group-prereq.md). Если эти предварительные условия уже выполнены, то можно перейти к [созданию кластера](#CreateCluster).
  ...
  >[!NOTE]
  > Многие действия, описанные в этом руководстве можно автоматизировать с помощью [виртуальной Машины SQL Azure CLI](virtual-machines-windows-sql-availability-group-cli.md) и [шаблонов быстрого запуска Azure](virtual-machines-windows-sql-availability-group-quickstart-template.md).
