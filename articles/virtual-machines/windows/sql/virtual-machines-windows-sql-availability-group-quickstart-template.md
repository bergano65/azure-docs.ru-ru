...
1. Заполните обязательные поля, чтобы настроить метаданные для отказоустойчивого кластера Windows. Необязательные поля можно оставить пустыми.
   ...
   | **\_Расположение артефактов** | Это поле имеет значение по умолчанию, и его можно изменить. |
   | **\_Маркер SAS расположения артефактов** | Это поле намеренно оставлено пустым. |
   | &nbsp; | &nbsp; |
...
1. Заполните обязательные поля, чтобы настроить внутренний балансировщик нагрузки, и создайте прослушиватель группы доступности. Необязательные поля можно оставить пустыми. 
   ...
   | **Прослушивающий порт** | Порт, который должен использоваться прослушивателем. Как правило, этот порт должен быть значением по умолчанию 1433. Номер порта, который указывает шаблон. Но если порт по умолчанию был изменен, то порт прослушивателя должен использовать это значение. | 
