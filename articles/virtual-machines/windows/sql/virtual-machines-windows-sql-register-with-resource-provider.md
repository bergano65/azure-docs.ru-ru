...
- **Агент** не предназначен для SQL Server 2008 и SQL Server 2008 R2, установленных на Windows Server 2008. 
...
Чтобы изменить режим управляемости с полной управляемостью, удалите расширение SQL Server IaaS. Затем удалите ресурс Microsoft. Склвиртуалмачине и повторно зарегистрируйте виртуальную машину SQL Server с помощью поставщика ресурсов виртуальной машины SQL.
