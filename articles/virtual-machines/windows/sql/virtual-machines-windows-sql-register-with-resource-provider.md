...
Укажите SQL Server тип лицензии: оплата по`PAYG`мере использования () для оплаты за использование, преимущество гибридного использования Azure (`AHUB`) для использования собственной лицензии или аварийное восстановление (`DR`) для активации [бесплатной лицензии на реплику аварийного](virtual-machines-windows-sql-high-availability-dr.md#free-dr-replica-in-azure)восстановления.
...
Укажите значение `AHUB`, `PAYG`или `DR` в качестве **скллиценсетипе**, а `SQL2008-WS2008` также или `SQL2008R2-WS2008`в качестве **склимажеоффер**. 

Чтобы зарегистрировать SQL Server 2008 или 2008 R2 на экземпляре Windows Server 2008, используйте следующий код AZ CLI или PowerShell: 
...
Отсутствует. Не взимается плата, связанная с регистрацией в поставщике ресурсов виртуальной машины SQL, или с использованием любого из трех режимов управления. Управление виртуальной машиной SQL Server с помощью поставщика ресурсов полностью бесплатное. 
