...
* **Размер единицы размещения NTFS**. при форматировании диска данных рекомендуется использовать единицу распределения 64 КБ для файлов данных и журналов, а также tempdb. Если база данных TempDB размещена на временном диске (D:\ ) производительность, достигаемая за счет использования этого диска, перевешивает необходимость в размере единицы распределения 64 КБ. 
