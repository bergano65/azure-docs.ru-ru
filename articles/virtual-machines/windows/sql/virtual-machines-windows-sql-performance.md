...
### <a name="failover-cluster-instance-and-storage-spaces"></a>Экземпляр отказоустойчивого кластера и дисковых пространств

Если вы используете дисковые пространства, при добавлении узлов в кластер на **Подтверждение** снимите флажок **Добавление всех допустимых хранилищ в кластер**. 

![Снимите флажок допустимого хранилища](media/virtual-machines-windows-sql-performance/uncheck-eligible-cluster-storage.png)
