...
1. [Настройте подключение между](../../../vpn-gateway/vpn-gateway-howto-vnet-vnet-resource-manager-portal.md)виртуальными сетями с помощью портал Azure.
...
1. [Задайте параметры кластера в PowerShell](virtual-machines-windows-portal-sql-availability-group-tutorial.md#setparam).
