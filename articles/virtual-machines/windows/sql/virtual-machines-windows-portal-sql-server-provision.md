...
| [Интеграция Azure Key Vault](#azure-key-vault-integration) |
...
| [Служба машинного обучения](#machine-learning-services) |
...
| **Имя участника** |Имя субъекта-службы Azure Active Directory. Этот имя также называется идентификатором клиента. |fde2b411-33d5-4e11-af04eb07b669ccf2 |
