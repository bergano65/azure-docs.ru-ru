...
> [!IMPORTANT]
> Установлены только обновления Windows и SQL Server, помеченные как **важные** . Другие обновления SQL Server (например, накопительные обновления) нужно устанавливать вручную. 
...
| **Категория исправления** |Важная | Категория обновлений ОС Windows, которые будут скачаны и установлены.|
