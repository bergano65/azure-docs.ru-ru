...
Эта таблица обновляется при наличии новых поддерживаемых версий или обновлений службы.

> [!NOTE]
> Сейчас развертывается версия 2018-10-01. Скоро она появится в других регионах. 
