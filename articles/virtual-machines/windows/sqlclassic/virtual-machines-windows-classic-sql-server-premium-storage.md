...
1. Обратите внимание на DiskName и LUN.
    ...
    ![DisknameAndLUN][2]
1. Подключитесь к виртуальной машине с помощью удаленного рабочего стола. Затем перейдите к **управлению компьютером** | **управления** | **устройствадисков.** Просмотрите свойства каждого диска в «Виртуальных дисках Microsoft»
...
1. **Добавьте больше вторичных реплик в существующий всегда на кластере**
2. **Миграция в новый кластер AlwaysOn**

#### <a name="1-add-more-secondary-replicas-to-an-existing-always-on-cluster"></a>1. Добавьте больше вторичных реплик в существующий всегда на кластере
...
#### <a name="2-migrate-to-a-new-always-on-cluster"></a>2. Мигрировать в новый всегда на кластере
...
1. **Используйте существующий вторичный: одноместный**
2. **Используйте существующую вторичную реплику(ы): Multi-Site**

#### <a name="1-utilize-an-existing-secondary-single-site"></a>1. Используйте существующую вторичную: Одноместный
...
#### <a name="2-utilize-existing-secondary-replicas-multi-site"></a>2. Используйте существующую вторичную реплику (ы): Multi-Site
...
#### <a name="step-2-increase-the-permitted-failures-on-resources-optional"></a>Шаг 2: Увеличьте \<допустимые сбои на ресурсах Факультативное>
...
#### <a name="step-3-addition-ip-address-resource-for-cluster-group-optional"></a>Шаг 3: Добавление ресурса \<IP-адреса для кластерной группы Факультативный>
...
Дождитесь, пока перенесенный узел синхронизируется с локальным узлом Always On. Переведите его в режим синхронной репликации и подождите, пока он синхронизируется. Затем неудача из помещения в первый участок мигрировали, который AFP. После успешного выполнения этого действия измените последний перенесенный узел на AFP.
...
* [Премиум-хранилище Azure](../disks-types.md)
