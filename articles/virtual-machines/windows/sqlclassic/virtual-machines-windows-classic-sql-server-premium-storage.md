...
1. Обратите внимание на DiskName и LUN.
    ...
    ![DisknameAndLUN][2]
1. Подключитесь к виртуальной машине с помощью удаленного рабочего стола. Затем последовательно выберите **Управление** | компьютером**Device Manager** | **диски**. Просмотрите свойства каждого диска в «Виртуальных дисках Microsoft»
...
1. **Добавление вторичных реплик в существующий кластер Always On**
2. **Миграция в новый кластер AlwaysOn**

#### <a name="1-add-more-secondary-replicas-to-an-existing-always-on-cluster"></a>1. Добавление вторичных реплик в существующий кластер Always On
...
#### <a name="2-migrate-to-a-new-always-on-cluster"></a>2. Миграция в новый кластер Always On
...
1. **Использование существующего вторичного сайта: один сайт**
2. **Использовать существующие вторичные реплики: несколько сайтов**

#### <a name="1-utilize-an-existing-secondary-single-site"></a>1. Использование существующего вторичного сайта: один сайт
...
#### <a name="2-utilize-existing-secondary-replicas-multi-site"></a>2. использование существующих вторичных реплик: несколько сайтов
...
* [Хранилище Azure класса Premium](../disks-types.md)
