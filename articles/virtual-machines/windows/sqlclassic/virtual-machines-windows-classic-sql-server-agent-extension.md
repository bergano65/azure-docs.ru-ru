...
> * [Менеджер ресурсов](../sql/virtual-machines-windows-sql-server-agent-extension.md)
...
Вы также можете использовать **Get-AzureVMSqlServerExtension** Azure Powershell cmdlet.
