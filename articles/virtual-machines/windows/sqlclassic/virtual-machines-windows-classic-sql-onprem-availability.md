...
5. На **Выбор реплик** странице несколько вкладок в верхней части: **Реплики**, **конечные точки**, **резервное копирование предпочтения**, и **прослушивателя**. На вкладке **Реплики** щелкните **Добавить реплику Azure…**. , чтобы запустить мастер добавления реплики Azure.
