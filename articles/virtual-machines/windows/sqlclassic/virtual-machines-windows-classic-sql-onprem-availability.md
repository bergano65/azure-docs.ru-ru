...
5. На странице **Выбор реплик** в верхней части перечислены несколько вкладок: **Реплики**, **конечные точки**, **Параметры резервного копирования**и **прослушиватель**. На вкладке **Реплики** щелкните **Добавить реплику Azure…** . , чтобы запустить мастер добавления реплики Azure.
