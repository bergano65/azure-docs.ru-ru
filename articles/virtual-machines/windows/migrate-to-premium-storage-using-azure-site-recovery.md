...
1. **Настройка и добавление реплицированных виртуальных машин в группу доступности (если применимо)** . Site Recovery не поддерживает перенос виртуальных машин вместе с группой доступности. В зависимости от типа развертывания реплицированной виртуальной машины выполните одно из следующих действий.
   * При использовании классической модели развертывания для создания виртуальной машины: добавьте виртуальную машину в набор доступности на портале Azure. Подробные инструкции см. в разделе [Добавление существующей виртуальной машины к группе доступности](../linux/classic/configure-availability-classic.md).
...
* [Страница вопросов и ответов Майкрософт для Microsoft Azure Site Recovery](https://docs.microsoft.com/answers/topics/azure-site-recovery.html)
