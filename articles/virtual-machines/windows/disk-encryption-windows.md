...
ms.locfileid: "82085649"
---
# <a name="azure-disk-encryption-scenarios-on-windows-vms"></a>Сценарии шифрования дисков Azure для виртуальных машин Windows

Шифрование дисков Azure для виртуальных машин Windows (VM) использует функцию BitLocker Windows для обеспечения полного шифрования диска операционной системы и диска данных. Кроме того, он обеспечивает шифрование временного диска ресурсов, если параметр параметра volumetype значение имеет значение ALL.
