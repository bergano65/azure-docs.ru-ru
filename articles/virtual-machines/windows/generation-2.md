...
* [Ls-серии](https://docs.microsoft.com/azure/virtual-machines/windows/sizes-previous-gen#ls-series) и [Lsv2-серии](../lsv2-series.md)
...
Если вы создаете VM с Windows Server 2012 в качестве ОС, то вы выберете либо поколение 1 (BIOS) или поколение 2 (UEFI) VM SKU, которое выглядит следующим образом:
...
* Узнайте, как [подготовить VHD](prepare-for-upload-vhd-image.md) для загрузки из штатных систем в Azure.
