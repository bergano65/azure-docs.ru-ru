...
<img src="media/using-visual-studio-vm/capture-vm.png" alt="Capture an image through the Azure portal UI" style="border:3px solid Silver; display: block; margin: auto;"><center>*(Рис. 1) Запись образа через пользовательский Интерфейс портала Azure.*</center>
...
* [Создание виртуальной Машины на портале Azure](quick-create-portal.md)
