...
В Azure Marketplace можно найти образы самых последних основных версий: Visual Studio 2017 и Visual Studio 2015.  Недавно мы добавили поддержку предварительных версий новой основной версии — Visual Studio 2019.  Для каждого выпущенного основного номера версии доступны изначально выпущенная версия (RTW) и последние обновленные версии.  Для каждой из этих версий доступны выпуски Visual Studio Enterprise и Visual Studio Community.  Эти образы обновляются по крайней мере раз в месяц для включения последних обновлений Visual Studio и Windows.  Хотя имена образов не меняются, описание каждого образа содержит версию установленного продукта и дату выпуска образа.

| Версия выпуска                                              | Выпуски                     |     Версия продукта      |
|:------------------------------------------------------------:|:----------------------------:|:------------------------:|
|    Visual Studio 2019: предварительная версия 1                   |           Enterprise         | Версия 16.0.0 — предварительная версия 1 |
