...
- [Обслуживание](https://docs.microsoft.com/azure/virtual-machines/windows/maintenance-and-updates) , инициированное платформой (например, перезагрузка виртуальной машины, динамическая миграция или сохранение обновлений памяти для узла)
