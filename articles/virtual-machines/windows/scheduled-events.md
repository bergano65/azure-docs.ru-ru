...
> [!NOTE]
> Запланированные события для всех виртуальных машин в клиенте Fabric Controller (FC) доставляются всем виртуальным машинам в клиенте FC. Клиент FC соответствует автономной виртуальной машине, всей облачной службе, всей группе доступности и группы размещения для масштабируемого набора виртуальных машин (VMSS) независимо от использования зоны доступности. 
...
### <a name="version-and-region-availability"></a>Доступность версий и регионов
...
### <a name="enabling-and-disabling-scheduled-events"></a>Включение и отключение Запланированные события
