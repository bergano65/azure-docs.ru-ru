---
title: Запланированные мероприятия для Вымизи Windows в Azure
...
- [Платформа инициировала техническое обслуживание](https://docs.microsoft.com/azure/virtual-machines/windows/maintenance-and-updates) (например, перезагрузка VM, живая миграция или сохранение обновлений памяти для хоста)
...
- [Spot VM](spot-vms.md) и [Spot шкалы выселяемых](../../virtual-machine-scale-sets/use-spot.md) экземпляров
...
- Подробнее об AA, доступных в [службе Metadata instance.](instance-metadata-service.md)
- Узнайте о [планируемом обслуживании виртуальных машин Windows в Azure.](planned-maintenance.md)
