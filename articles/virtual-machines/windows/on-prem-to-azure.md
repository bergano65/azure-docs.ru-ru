...
> [!IMPORTANT]
> Перед загрузкой VHD в Azure следует следить за [тем, чтобы загрузить Windows VHD или VHDX в Azure](prepare-for-upload-vhd-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
>
>
