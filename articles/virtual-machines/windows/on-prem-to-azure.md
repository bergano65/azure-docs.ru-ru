...
> [!IMPORTANT]
> Перед отправкой любого виртуального жесткого диска в Azure необходимо выполнить [подготовку VHD или VHDX для Windows к отправке в Azure](prepare-for-upload-vhd-image.md) .
>
>
