...
Кроме того, необходимо [создать рабочую область Log Analytics](/azure/azure-monitor/learn/quick-create-workspace), которая будет использоваться для агрегирования информации из виртуальных машин в группе доступности.
...
Эта операция устанавливает [Microsoft Monitoring Agent](/azure/virtual-machines/extensions/oms-windows) на виртуальной машине. Подключение виртуальной машины к рабочей области и установка расширения займет несколько минут. 
...
После отправки событий в Log Analytics можно выполнить следующий [запрос](/azure/azure-monitor/log-query/get-started-portal), чтобы найти запланированные события.
