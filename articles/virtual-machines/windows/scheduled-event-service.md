---
title: Настройка уведомлений об обслуживании для виртуальных машин Windows в Azure | Документация Майкрософт
description: Узнайте, как настроить уведомления о запланированном обслуживании для виртуальных машин Azure.
...
ms.locfileid: "69657415"
---
# <a name="set-up-notifications-about-maintenance-affecting-your-vm"></a>Настройка уведомлений об обслуживании, влияющих на виртуальную машину
...
1. На странице **Создание правила** оставьте `collectorworkspace` **ресурс**.
1. В разделе **условие**выберите запись *при каждом <login undefined>поиске по журналу клиента* . Откроется страница **Настройка логики сигнала** .
