---
title: Создание Windows VM из специализированного VHD в Azure
...
В этой статье показано, как использовать управляемые диски. Если у вас есть устаревшное развертывание, требующее использования учетной записи хранилища, [см.](sa-create-vm-specialized.md)

Мы рекомендуем ограничить количество одновременных развертываний 20 вммийм из одного VHD или снимка. 
...
Если вы хотите скопировать существующий VM в другой регион, может потребоваться использовать azcopy для [создания копии диска в другом регионе.](disks-upload-vhd-to-managed-disk-powershell.md#copy-a-managed-disk) 
...
Вы должны увидеть вновь созданный VM либо на [портале Azure](https://portal.azure.com) под **Browse** > **Virtual machines,** либо с помощью следующих команд PowerShell.
