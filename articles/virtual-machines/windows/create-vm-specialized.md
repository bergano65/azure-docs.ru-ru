---
title: Создание виртуальной машины Windows из специализированного виртуального жесткого диска в Azure
...
В этой статье показано, как использовать управляемые диски. Если у вас есть устаревшее развертывание, требующее использования учетной записи хранения, см. статью [Создание виртуальной машины на основе специализированного виртуального жесткого диска в учетной записи хранения](sa-create-vm-specialized.md).
...
Вновь созданная виртуальная машина должна отобразиться в [портал Azure](https://portal.azure.com) в разделе **Обзор** > **виртуальных машин**или с помощью следующих команд PowerShell.
