...
Чтобы найти ресурсы по имени и значению тега, воспользуйтесь командой [Get-AzureRmResource](/powershell/module/azurerm.resources/get-azurermresource):
