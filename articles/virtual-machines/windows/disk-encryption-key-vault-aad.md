...
description: В этой статье вы узнаете, как создать и настроить хранилище ключей для шифрования дисков Azure с помощью Azure AD.
author: msmbaldwin
...
### <a name="create-a-key-vault-with-powershell"></a> Создание хранилища ключей с помощью PowerShell
...
### <a name="create-a-key-vault-with-azure-cli"></a> Создание хранилища ключей с помощью Azure CLI
...
### <a name="create-a-key-vault-with-a-resource-manager-template"></a> Создание хранилища ключей с помощью шаблона Resource Manager
...
## <a name="set-up-an-azure-ad-app-and-service-principal"></a> Настройка приложения Azure AD и субъекта-службы 
...
### <a name="set-up-an-azure-ad-app-and-service-principal-with-azure-powershell"></a> Настройка приложения Azure AD и субъекта-службы с помощью Azure PowerShell 
...
### <a name="set-up-an-azure-ad-app-and-service-principal-with-azure-cli"></a> Настройка приложения Azure AD и субъекта-службы с помощью Azure CLI
...
### <a name="set-up-an-azure-ad-app-and-service-principal-though-the-azure-portal"></a> Настройка приложения Azure AD и субъекта-службы на портале Azure
...
## <a name="set-the-key-vault-access-policy-for-the-azure-ad-app"></a>настроить политику доступа к хранилищу ключей для приложения Azure AD;
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-powershell"></a> Настройка политики доступа к хранилищу ключей для приложения Azure AD с помощью Azure PowerShell
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-cli"></a> Настройка политики доступа к хранилищу ключей для приложения Azure AD с помощью Azure CLI
...
### <a name="set-key-vault-advanced-access-policies-with-azure-powershell"></a> Установка политик расширенного доступа для хранилища ключей с помощью Azure PowerShell
...
### <a name="set-key-vault-advanced-access-policies-using-the-azure-cli"></a> Установка политик расширенного доступа для хранилища ключей с помощью Azure CLI
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a> Установка политики расширенного доступа для хранилища ключей с помощью портала Azure
...
### <a name="set-up-a-key-encryption-key-with-azure-powershell"></a> Настройка ключа шифрования ключей с помощью Azure PowerShell 
...
## <a name="certificate-based-authentication-optional"></a> Аутентификация на основе сертификата (необязательно)
...
## <a name="certificate-based-authentication-and-a-kek-optional"></a> Аутентификация на основе сертификата и KEK (необязательно)
