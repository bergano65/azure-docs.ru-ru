...
### <a name="create-a-key-vault-with-azure-cli"></a>Создание хранилища ключей с Azure CLI
...
### <a name="create-a-key-vault-with-a-resource-manager-template"></a>Создание хранилища ключей с помощью шаблона диспетчер ресурсов
...
### <a name="set-up-an-azure-ad-app-and-service-principal-though-the-azure-portal"></a>Настройка приложения и субъекта-службы Azure AD, хотя портал Azure
...
## <a name="set-the-key-vault-access-policy-for-the-azure-ad-app"></a>Настройка политики доступа к хранилищу ключей для приложения Azure AD
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-powershell"></a>Задайте политику доступа к хранилищу ключей для приложения Azure AD с помощью Azure PowerShell
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-cli"></a>Задайте политику доступа к хранилищу ключей для приложения Azure AD с помощью Azure CLI
...
### <a name="set-key-vault-advanced-access-policies-with-azure-powershell"></a>Настройка расширенных политик доступа к хранилищу ключей с помощью Azure PowerShell
...
### <a name="set-key-vault-advanced-access-policies-using-the-azure-cli"></a>Настройка политик расширенного доступа к хранилищу ключей с помощью Azure CLI
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a>Настройка политик расширенного доступа к хранилищу ключей с помощью портал Azure
...
### <a name="set-up-a-key-encryption-key-with-azure-powershell"></a>Настройка ключа шифрования ключа с помощью Azure PowerShell 
...
## <a name="certificate-based-authentication-optional"></a>Проверка подлинности на основе сертификата (необязательно)
...
## <a name="certificate-based-authentication-and-a-kek-optional"></a>Проверка подлинности на основе сертификатов и KEK (необязательно)
