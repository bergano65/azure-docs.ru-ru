...
Чтобы добавить диск данных в виртуальную машину, добавьте этот код в основной метод. Этот пример добавляет диск данных размером 2 ГБ, han lun 0 и тип кэширования ReadWrite:
