...
Чтобы добавить диск данных в виртуальную машину, добавьте указанный ниже код в метод Main. В этом примере добавляется диск данных объемом 2 ГБ, с номером LUN 0 и типом кэширования ReadWrite.
