...
- Управляемые диски, зашифрованные с помощью шифрования на стороне сервера, с ключами, управляемыми клиентом, не могут также быть зашифрованы с помощью шифрования дисков Azure и наоборот.
