---
title: Бенчмаркинг приложения на хранилище дисков Azure
...
Приступай к нашей статье о [проектировании для высокой производительности](premium-storage-performance.md).

В этой статье вы создаете контрольный список, аналогичный существующему приложению для прототипа. С помощью инструментов тестирования производительности можно смоделировать рабочую нагрузку и измерить производительность прототипа приложения. В результате вы сможете определить, какой из классов диска будет соответствовать требованиям к производительности приложения, а какой превосходить их. Затем те же указания можно применить и для рабочего приложения.