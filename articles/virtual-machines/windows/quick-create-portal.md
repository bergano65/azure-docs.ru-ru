...
На портале выберите виртуальную машину и в обзоре виртуальной машины **нажмите кнопку "Копировать** " справа от IP-адреса, чтобы скопировать его и вставить на вкладку браузера. Откроется страница приветствия служб IIS по умолчанию, которая должна выглядеть следующим образом:
