...
ms.locfileid: "78373084"
---
# <a name="tutorial-monitor-changes-and-update-a-windows-virtual-machine-in-azure"></a>Руководство. Мониторинг изменений и обновление виртуальной машины Windows в Azure
...
| Параметр | Описание |
| --- | --- |
| **Название** |Введите уникальное имя для идентификации развертывания обновлений. |
...
* **Не попыток**: обновление не установлено. Недостаточно времени на основе определенной длительности окна обслуживания.
