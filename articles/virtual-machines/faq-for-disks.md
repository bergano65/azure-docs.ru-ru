...
Для диска операционной системы Azure поддерживает раздел MBR (основная загрузочная запись). Форматирование MBR поддерживает диски размером до 2 ТиБ. Самый крупный размер, поддерживаемый Azure для диска операционной системы, — 4 тиб. Azure поддерживает управляемые диски данных размером до 32 ТиБ.
