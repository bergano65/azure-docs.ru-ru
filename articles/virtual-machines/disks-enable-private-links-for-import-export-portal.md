...
description: Включите приватные каналы для управляемых дисков с помощью портала Azure. Так вы сможете безопасно экспортировать и импортировать диски в пределах вашей виртуальной сети.
author: roygara
...
- [Экспорт или копирование управляемых моментальных снимков в виде VHD в учетную запись хранения в другом регионе с помощью PowerShell](/previous-versions/azure/virtual-machines/scripts/virtual-machines-powershell-sample-copy-snapshot-to-storage-account)