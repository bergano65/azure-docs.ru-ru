...
Если в настоящее время вы используете виртуальные машины с неуправляемыми дисками, мы настоятельно рекомендуем вам преобразовать из неуправляемых дисков в управляемые диски для [Linux](./linux/convert-unmanaged-to-managed-disks.md) и [Windows](./windows/convert-unmanaged-to-managed-disks.md).
