...
description: Обзор концепции вычислительных единиц Azure. Единица вычислений Azure (ACU) предоставляет собой способ сравнения производительности ЦП для различных номеров SKU Azure.
...
| [Хк](hc-series.md) |297 - 315* | 1:1 |
| [L4s - L32s](sizes-previous-gen.md) |180–240* | 1:1 |
| [L8s_v2 - L80s_v2](lsv2-series.md) |150 - 175** | 2:1 |
| [М](m-series.md) | 160 - 180 | 2:1\*\*\* |
