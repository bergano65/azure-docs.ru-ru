...
| азуреспотиснотсуппортедфорсисвмсизе  |  Для этого размера виртуальной машины не поддерживается место Azure {0} . | Выберите другой размер виртуальной машины. Дополнительные сведения см. в статье о [плашечных виртуальных машинах](./spot-vms.md). |
| максприцеиссуппортедонлифоразуреспотвиртуалмачинес  |  Максимальная цена поддерживается только для виртуальных машин Azure на месте. | Дополнительные сведения см. в статье о [плашечных виртуальных машинах](./spot-vms.md). |
