---
title: Вызовы постановки для операций создания или обновления
...
Дополнительные сведения о создании или обновлении вызовов для [виртуальных машин](https://docs.microsoft.com/rest/api/compute/virtualmachines/createorupdate) и [масштабируемых наборов виртуальных машин](https://docs.microsoft.com/rest/api/compute/virtualmachinescalesets/createorupdate)
