---
title: M-серия - Виртуальные машины Azure
description: Спецификации для M-серии VMs.
...
<sup>1</sup> Более 64 vCPU требуют один из этих поддерживаемых гостей ОС: Windows Server 2016, Ubuntu 16.04 LTS, SLES 12 SP2, и Red Hat Enterprise Linux, CentOS 7.3 или Oracle Linux 7.3 с LIS 4.2.1.

<sup>2</sup> Доступные ограниченные размеры ядра.
