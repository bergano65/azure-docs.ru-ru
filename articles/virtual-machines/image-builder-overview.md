...
![Концептуальный рисунок процесса Конструктора образов Azure](./media/image-builder-overview/image-builder-process.png)
...
Сначала необходимо выполнить действия, описанные в документации по [созданию назначаемого пользователем управляемого удостоверения Azure](../active-directory/managed-identities-azure-resources/how-to-manage-ua-identity-cli.md).
