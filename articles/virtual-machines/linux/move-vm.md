---
title: Перемещение VM в использовании Azure CLI
description: Переместите VM в другую группу подписки или ресурсов Azure с помощью Azure CLI.
author: cynthn
...
---
# <a name="move-a-vm-to-another-subscription-or-resource-group"></a>Перемещение VM в другую группу подписчиков или ресурсов
В этой статье вы можете провести перемещение виртуальной машины (VM) между группами ресурсов или подписками. Перемещение ВМ между подписками может понадобиться, если вы создали виртуальную машину в личной подписке и вам нужно переместить ее в корпоративную подписку.
