...
Обязательно. Чтобы построитель образов имел разрешения на чтение и запись образов, чтение в скриптах из службы хранилища Azure, необходимо создать пользовательское удостоверение Azure с разрешениями для отдельных ресурсов. Дополнительные сведения о работе с разрешениями для работы с Image Builder и соответствующих действиях см. в [документации](image-builder-user-assigned-identity.md).
