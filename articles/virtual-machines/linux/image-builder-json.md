...
>> Обратите внимание! Файл настройщика подходит только для загрузки небольших файлов, < 20 МБ. Для загрузки больших файлов используйте скрипт или встроенные команды, использовать код для загрузки файлов, таких как Linux `wget` или `curl`, Windows, `Invoke-WebRequest`.
