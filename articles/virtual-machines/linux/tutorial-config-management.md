...
ms.locfileid: "78372845"
---
# <a name="tutorial-monitor-changes-and-update-a-linux-virtual-machine-in-azure"></a>Руководство. Мониторинг изменений и обновление виртуальной машины Linux в Azure
...
|Классификаций обновлений|Выберите все необходимые категории обновления.|
