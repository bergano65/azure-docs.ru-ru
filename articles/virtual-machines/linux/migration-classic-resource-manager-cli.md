---
title: Имитируйте ввоз в управление ресурсами с помощью Azure CLI
...
Зарегистрируйтесь в поставщике ресурсов миграции с помощью такой команды: Обратите внимание, что в некоторых случаях эта команда выходит из нее. Тем не менее, регистрация будет успешной.
