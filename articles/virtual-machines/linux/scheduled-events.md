...
- [Обслуживание](https://docs.microsoft.com/azure/virtual-machines/linux/maintenance-and-updates) , инициированное платформой (например, перезагрузка виртуальной машины, динамическая миграция или сохранение обновлений памяти для узла)
