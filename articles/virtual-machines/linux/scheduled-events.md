...
| - | - | - | - | 
| 2019-01-01 | Общедоступная версия | All | <li> Добавлена поддержка для масштабируемых наборов виртуальных машин тип данных EventType "Terminate" |
| 2017-11-01 | Общедоступная версия | All | <li> Добавлена поддержка для выборочного вытеснения виртуальной машины с вытеснением "вытеснение"<br> | 
