...
- [Обслуживание, инициированное платформой](https://docs.microsoft.com/en-us/azure/virtual-machines/linux/maintenance-and-updates) (например, виртуальной Машины перезагрузка, динамической миграции или обновлений для узла с сохранением содержимого памяти)
