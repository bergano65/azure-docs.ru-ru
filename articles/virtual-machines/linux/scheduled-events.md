...
| - | - | - | - | 
| 01.08.2019 | Общедоступная версия | Все | <li> Добавлена поддержка EventSource |
| 2019-04-01 | Общедоступная версия | Все | <li> Добавлена поддержка описания события. |
| 01.01.2019 | Общедоступная версия | Все | <li> Добавлена поддержка типа события "Завершение" для масштабируемых наборов виртуальных машин |
| 2017-11-01 | Общедоступная версия | Все | <li> Добавлена поддержка типа события "Выгрузка" для исключения точечных виртуальных машин<br> | 
