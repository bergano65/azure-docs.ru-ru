...
| - | - | - | - | 
| 2017-11-01 | Общая доступность | Все | <li> Добавлена поддержка для виртуальной Машины с низким приоритетом вытеснения EventType «Preempt»<br> | 
