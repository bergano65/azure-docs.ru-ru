---
title: Отсоедините диск данных от Linux VM - Azure
...
2. Выберите виртуальную машину, которая имеет диск данных, который вы хотите отсоединить и нажмите **Стоп,** чтобы разложить VM.
...
Если вы хотите повторно использовать диск данных, вы можете просто [прикрепить его к другому VM](add-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
