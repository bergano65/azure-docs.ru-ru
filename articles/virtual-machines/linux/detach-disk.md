---
title: Отключение диска данных от виртуальной машины Linux — Azure
...
2. Выберите виртуальную машину с диском данных, который необходимо отсоединить, и нажмите кнопку " **Закрыть** " для освобождения виртуальной машины.
...
Если вы хотите повторно использовать диск данных, можно просто [подключить его к другой виртуальной машине](add-disk.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
