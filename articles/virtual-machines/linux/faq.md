---
title: Часто задаваемые вопросы для Linux VMs в Azure
...
Каждый диск данных может быть до 32 767 GiB. Количество дисков данных, которое можно использовать, зависит от размера виртуальной машины. Для получения [подробной](sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)информации см.
...
Пароли должны также соответствовать 3 из следующих 4 требований сложности:
