...
- Если для обслуживания требуется перезагрузка, вы получите уведомление во время планирования обслуживания. В таких случаях вам предоставляется период времени, который обычно составляет 30 дней, когда вы можете самостоятельно начать обслуживание, когда оно будет работать.
...
- С момента создания уведомления начинается *период самообслуживания*. В этом окне, обычно это 30 дней, вы можете определить, какие из ваших виртуальных машин включены в эту волна, и заблаговременно начать обслуживание в соответствии с собственными потребностями планирования.
...
Сведения об плановом обслуживании можно посмотреть, используя [azure vm get-instance-view](/cli/azure/vm?view=azure-cli-latest).
...
**Вопрос. Зачем вам нужно сейчас перезагружать мою виртуальную машину?**
...
**Вопрос. Почему информация о плановом обслуживании не отображается на портале, в PowerShell или интерфейсе командной строки? В чем проблема?**
...
**Вопрос. Можно ли точно узнать, когда моя виртуальная машина будет перезагружена?**
...
**Ответ.** Так как эти платформы будут затронуты плановым обслуживанием, клиенты смогут безопасно использовать их, если в указанный момент времени будут затронуты только виртуальные машины в одном домене обновления. Самообслуживание в настоящее время недоступно для облачных служб (веб-ролей и рабочих ролей) и Service Fabric.
