...
- Код выхода 3: Неверное имя пользователя и пароль подписки Red Hat или идентификатора организации или ключа активации
- Код выхода 4: Идентификатор пула Red Hat неверен, или нет доступных прав
- Код выхода 5: Не удалось подготавливать том тонкого пула DOCKER
