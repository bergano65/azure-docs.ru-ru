...
В следующих примерах в качестве `myResourceGroup`имен параметров замените примеры собственных значений, например, `mystorageaccount`и. `mydisks`
