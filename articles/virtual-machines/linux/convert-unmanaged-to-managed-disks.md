---
title: Преобразование Linux VM с неуправляемых дисков на управляемые диски
description: Как преобразовать Linux VM с неуправляемых дисков на управляемые диски с помощью Azure CLI.
author: roygara
...
В этом разделе описывается, как преобразовать одноэкземплярные виртуальные машины Azure с неуправляемыми дисками, чтобы они могли использовать Управляемые диски. (Если ваши ВМ находятся в наборе доступности, см. следующий раздел.) Этот процесс можно использовать для преобразования ВМ с неуправляемых дисков премиум-класса (SSD) на премиальные управляемые диски или со стандартных (HDD) неуправляемых дисков на стандартные управляемые диски.
...
Для получения дополнительной информации о вариантах хранения данных смотрите [обзор управляемых дисков Azure](../windows/managed-disks-overview.md).
