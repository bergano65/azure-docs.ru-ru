---
title: Настройка программного обеспечения RAID на Linux VM
...
> [!IMPORTANT]
>Не смешивайте диски разных размеров, что приведет к тому, что производительность рейда будет ограничена производительность самого медленного диска. 
