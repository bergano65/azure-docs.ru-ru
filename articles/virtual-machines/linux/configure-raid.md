---
title: Настройка программного RAID-массива на виртуальной машине Linux
...
> [!IMPORTANT]
>Не следует смешивать диски разного размера. это приведет к тому, что производительность RAID-массива будет ограничена самым медленным диском. 
