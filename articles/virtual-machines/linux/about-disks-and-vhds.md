...
> [!NOTE]
> Дополнительные сведения о емкости виртуальных машин см. в статье [Размеры виртуальных машин Linux](./sizes.md).
...
Сведения о размерах в предварительной версии с указанием регионов, в которых они доступны, можно просмотреть в разделе [Вопросы и ответы](faq-for-disks.md#new-disk-sizes-managed-and-unmanaged).
