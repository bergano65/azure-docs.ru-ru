---
title: Переносите Linux-вМ-код в Премиум-хранилище Azure с восстановлением сайта Azure
...
2. Выберите Создать**Management** > **резервное копирование** **ресурсов** > и **восстановление сайта (OMS).** Кроме того, вы можете выбрать**Услуги восстановления** >  **просмотра** > Vault**Add.** 
