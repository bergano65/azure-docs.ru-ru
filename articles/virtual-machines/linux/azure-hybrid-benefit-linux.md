...
Преимущество гибридного использования Azure позволяет более легко перенести локальный Red Hat Enterprise Linux (RHEL) и SUSE Linux Enterprise (SLES) в Azure, используя собственную уже существующую подписку на программное обеспечение Red Hat или SUSE. С этим преимуществом вы платите только за стоимость инфраструктуры виртуальной машины, так как плата за программное обеспечение охватывается подпиской RHEL или SLES. Преимущество распространяется на все образы RHEL и SLES Marketplace с оплатой по мере использования (PAYG).
...
![Преимущество гибридного использования Azure визуализация затрат на виртуальных машинах Linux](./media/ahb-linux/azure-hybrid-benefit-cost.png)
