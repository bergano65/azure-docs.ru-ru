...
*Вопрос. я отправил собственный образ RHEL из локальной среды (с помощью ASR или иным способом) в Azure. Можно ли преобразовать выставление счетов на эти образы из BYOS в PAYG?*
