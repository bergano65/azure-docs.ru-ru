...
description: Узнайте, как использовать построитель образов Azure и Azure CLI, чтобы создать версию образа в общей коллекции образов, а затем распространить образ глобально.
author: cynthn
ms.author: cynthn
ms.date: 05/05/2019
ms.topic: how-to
