...
Вы также можете развернуть виртуальную машину с поддержкой Cloud-init, передав [Параметры в шаблон ARM](https://docs.microsoft.com/azure/azure-resource-manager/templates/deploy-cli#inline-parameters).
