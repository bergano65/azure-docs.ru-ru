...
Azure поддерживает два агента подготовки — [cloud-init](https://cloudinit.readthedocs.io) и [агент Linux для Azure (WALA)](../extensions/agent-linux.md).
...
|RedHat 7.7 |RHEL |7-RAW-CI |7.7.2019081601 | Да (Примечание. это изображение предварительного просмотра, которое больше не **должно** использоваться, оно будет удалено 1 сентября 2020) | Недоступно |
...
| Издатель/версия | ПРЕДЛОЖЕНИЕ | номер SKU | Версия | Образ готов для cloud-init | Поддержка пакетов cloud-init в Azure|
|:--- |:--- |:--- |:--- |:--- |:--- |
|OpenLogic 7.7 |CentOS |7-CI |7.7.20190920 |Да (Примечание. это изображение предварительного просмотра, которое больше не **должно** использоваться, оно будет удалено 1 сентября 2020) | Недоступно |
...
| Издатель/версия | ПРЕДЛОЖЕНИЕ | номер SKU | Версия | Образ готов для cloud-init | Поддержка пакетов cloud-init в Azure|
|:--- |:--- |:--- |:--- |:--- |:--- |
| Debian (GEN1) |Debian-10 | 10 — поддержкой |cloud-init-preview| Да (Примечание. это изображение предварительного просмотра, которое больше не **должно** использоваться, это будет удалено 1 января 2021) | Нет, в предварительной версии. |
| Debian (Gen2) |Debian-10 | 10-поддержкой-Gen2 |cloud-init-preview| Да (Примечание. это изображение предварительного просмотра, которое больше не **должно** использоваться, это будет удалено 1 января 2021) | Нет, в предварительной версии. |
| Debian (GEN1) |Debian-10 | 10 — поддержкой |10:0.20201013.422| Да | Да — поддержка из версии пакета: `20.2-2~deb10u1` |
| Debian (Gen2) |Debian-10 | 10-поддержкой-Gen2 |0.20201013.422| Да | Да — поддержка из версии пакета: `20.2-2~deb10u1` |
...
WALA — это уникальный агент платформы Azure, использующийся для подготовки и настройки виртуальных машин и обработки [расширений Azure](../extensions/features-linux.md). 
...
Вы также можете развернуть виртуальную машину с поддержкой Cloud-init, передав [Параметры в шаблон ARM](../../azure-resource-manager/templates/deploy-cli.md#inline-parameters).
