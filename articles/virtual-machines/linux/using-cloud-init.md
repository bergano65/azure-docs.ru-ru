...
|RedHat 7.7 |RHEL |7-RAW-CI |7.7.2019081601 | да (обратите внимание на то, что это не предварительный просмотр изображения, а поскольку все образы RHEL 7.7 поддерживают cloud-init, он будет удален 1 сентября 2020 года). | да — поддержка из пакета версии: *18.5-6.el7*|
|RedHat 7.7 (Gen1)|RHEL |7.7 | 7.7.2020051912 | нет — обновления образов в полете, завершатся в конце мая | да — поддержка из пакета версии: *18.5-6.el7*|
|RedHat 7.7 (Gen2)|RHEL | 77-gen2 | 7.7.2020051913 | нет — обновления образов в полете, завершатся в конце мая | да — поддержка из пакета версии: *18.5-6.el7*|
|RedHat 7.7 (Gen1)|RHEL |7-LVM | 7.7.2020051921 | нет — обновления образов в полете, завершатся в конце мая | да — поддержка из пакета версии: *18.5-6.el7*|
|RedHat 7.7 (Gen2)|RHEL | 7lvm-gen2 | 7.7.2020051922  | нет — обновления образов в полете, завершатся в конце мая | да — поддержка из пакета версии: *18.5-6.el7*|
|RedHat 7.7 (Gen1) |rhel-byos | rhel-lvm77 | 7.7.20200416 | нет — обновления образов в полете, завершатся в конце мая  | да — поддержка из пакета версии: *18.5-6.el7*|
|RedHat 8.1 (Gen1) |RHEL |8.1-ci |8.1.2020042511 | да (обратите внимание на то, что это не предварительный просмотр изображения, а поскольку все образы RHEL 8.1 поддерживают cloud-init, он будет удален 1 августа 2020 года). | Нет, полная поддержка ожидается в июне 2020 года|
|RedHat 8.1 (Gen2) |RHEL |81-ci-gen2 |8.1.2020042524 | да (обратите внимание на то, что это не предварительный просмотр изображения, а поскольку все образы RHEL 8.1 поддерживают cloud-init, он будет удален 1 августа 2020 года). | Нет, полная поддержка ожидается в июне 2020 года |

Образы RedHat:RHEL 7.8 и 8.2 (Gen1 и Gen2) подготавливаются с использованием cloud-init.

### <a name="centos"></a>CentOS

| Издатель/версия | ПРЕДЛОЖЕНИЕ | номер SKU | Версия | Образ готов для cloud-init | Поддержка пакетов cloud-init в Azure|
|:--- |:--- |:--- |:--- |:--- |:--- |
|OpenLogic 7.7 |CentOS |7-CI |7.7.20190920 |да (обратите внимание на то, что это не предварительный просмотр изображения, а поскольку все образы CentOS 7.7 поддерживают cloud-init, он будет удален 1 сентября 2020 года). | да — поддержка из пакета версии: *18.5-3.el7.centos*|

* Образы CentOS 7.7 с поддержкой cloud-init будут обновлены в июне 2020 года 
* Образы CentOS 7.8 подготавливаются с помощью cloud-init.
...
| Издатель/версия | ПРЕДЛОЖЕНИЕ | номер SKU | Версия | Образ готов для cloud-init | Поддержка пакетов cloud-init в Azure|
|:--- |:--- |:--- |:--- |:--- |:--- |
|Oracle 7.7 |Oracle-Linux |77-ci |7.7.01| изображение предварительного просмотра (обратите внимание на то, что это изображение предварительного просмотра; оно будет удалено, когда все образы Oracle 7.7 будут поддерживать cloud-init, в середине 2020 года после уведомления). | нет, в предварительной версии, пакет: *18.5-3.0.1.el7*

### <a name="suse-sles"></a>SuSE SLES
| Издатель/версия | ПРЕДЛОЖЕНИЕ | номер SKU | Версия | Образ готов для cloud-init | Поддержка пакетов cloud-init в Azure|
|:--- |:--- |:--- |:--- |:--- |:--- |
|SUSE SLES 15 SP1 |suse |sles-15-sp1-basic |cloud-init-preview| Дополнительные сведения см. в блоге [SUSE cloud-init](https://suse.com/c/clout-init-coming-to-suse-images-in-azure/). | Нет, в предварительной версии. |
|SUSE SLES 15 SP1 |suse |sles-15-sp1-basic |gen2-cloud-init-preview| Дополнительные сведения см. в блоге [SUSE cloud-init](https://suse.com/c/clout-init-coming-to-suse-images-in-azure/). | Нет, в предварительной версии. |


### <a name="debian"></a>Debian
Сейчас мы работаем над поддержкой предварительной версии, обновления ожидаются в июне 2020 года.
