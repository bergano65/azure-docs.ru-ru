...
>[!NOTE] 
>Мы используем переменные во всей статье. Замените значения соответствующим образом.
...
df -h
```
![Сведения о смонтированных файловых системах](./media/disk-encryption/lvm-raid-on-crypt/018-lvm-raid-lsblk-after-lvm.png)
...
df -h
```
![Сведения о смонтированных файловых системах](./media/disk-encryption/lvm-raid-on-crypt/021-lvm-raid-lsblk-md-details.png)
