...
![Анимированное изображение, показывающее интерфейс командной строки. Пользователь вводит указанный текст, выбирает указанный параметр и сохраняет параметры.](../media/virtual-machines-serial-console/virtual-machine-linux-serial-console-sles-yast-grub-config.gif)
...
* Основная страница документации по последовательной консоли для Linux находится [здесь](../troubleshooting/serial-console-linux.md).
