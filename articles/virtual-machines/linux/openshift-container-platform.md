...
| `virtualNetworkNewOrExisting` | Выберите, следует ли использовать существующую виртуальную сеть или создать новую виртуальную сеть | Существующие <br> новый | новый |
