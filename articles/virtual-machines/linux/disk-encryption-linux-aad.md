...
## <a name="bkmk_RunningLinux"></a> Включение шифрования на существующей или работающей виртуальной машине IaaS под управлением Linux
...
### <a name="bkmk_RunningLinux"></a> Включение шифрования на существующей или работающей виртуальной машине IaaS под управлением Linux с помощью шаблона
...
### <a name="bkmk_EFACriteria"></a> Критерии енкриптформаталл
...
### <a name="bkmk_EFATemplate"></a> Использование параметра енкриптформаталл с шаблоном
...
### <a name="bkmk_EFAPSH"></a> Использование параметра енкриптформаталл с командлетом PowerShell
...
### <a name="bkmk_EFALVM"></a> Использование параметра Енкриптформаталл с диспетчером логических ТОМОВ (LVM) 
...
## <a name="bkmk_VHDpre"></a> Новые виртуальные машины IaaS, созданные на основе зашифрованных клиентом виртуальных жестких дисков и ключей шифрования
...
### <a name="bkmk_VHDprePSH"></a> Использование Azure PowerShell для шифрования виртуальных машин IaaS с помощью предварительно зашифрованных виртуальных жестких дисков 
