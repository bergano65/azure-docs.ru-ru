...
1. На странице новой виртуальной машины выберите общедоступный IP-адрес и скопируйте его в буфер обмена.
    ...
    ![Копирование общедоступного IP-адреса](./media/quick-create-portal/ip-address.png)
...
![Сайт NGINX по умолчанию](./media/quick-create-portal/nginx.png)
