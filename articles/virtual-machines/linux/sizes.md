...
- Просмотрите [предыдущую страницу поколения](sizes-previous-gen.md) для базовых и стандартных, высокопроизводительных A8-A11, D/DSv1 (D1-4 и D11-14 v1), F/Fsv1, G/GS, Lsv1 и NVv2.
