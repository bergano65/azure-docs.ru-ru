...
- Поддерживаются только [ключи RSA для программного обеспечения и HSM](../../key-vault/keys/about-keys.md) , имеющие размер 2048, а другие ключи и размеры отсутствуют.
