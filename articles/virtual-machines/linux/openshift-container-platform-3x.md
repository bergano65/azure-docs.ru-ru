...
| `routingCertType` | Использовать пользовательский сертификат для домена маршрутизации или самозаверяющий сертификат по умолчанию — следуйте инструкциям в разделе " **настраиваемые сертификаты** ". | селфсигнед <br> настройки | селфсигнед |
| `masterCertType` | Использовать пользовательский сертификат для главного домена или самозаверяющий сертификат по умолчанию — следуйте инструкциям в разделе " **настраиваемые сертификаты** ". | селфсигнед <br> настройки | селфсигнед |
