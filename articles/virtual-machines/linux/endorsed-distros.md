...
| Распространение | Version | Драйверы | Агент |
| --- | --- | --- | --- |
...
| Red Hat Enterprise Linux |RHEL 6.7 +, 7.1 +, 8.0 + |В ядре |Пакет: в репозитории под именем WALinuxAgent <br/>Исходный код: [GitHub](https://github.com/Azure/WALinuxAgent) |
...
### <a name="canonical"></a>Канонический
