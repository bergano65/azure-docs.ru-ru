...
В большинстве случаев эти ядра будут предварительно установлены на образы по умолчанию в Azure Marketplace, поэтому клиенты сразу же получат преимущества этих оптимизированных ядер. Дополнительные сведения об этих ядрах, настроенных Azure, можно найти по следующим ссылкам:
