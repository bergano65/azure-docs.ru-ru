---
title: Варианты доступности Azure для виртуальных машин Linux | Документация Майкрософт
description: Сведения о функциях доступности для запуска виртуальных машин Linux в Azure
