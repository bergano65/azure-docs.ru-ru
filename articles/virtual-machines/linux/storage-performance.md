...
* **Нужно ли изменить "FIO"?**  
   ...
   Также обратите внимание, что оптимальная производительность достигается, когда ввод-вывод выполняется непосредственно на каждом необработанном устройстве NVMe без секционирования, без файловых систем, без конфигурации RAID 0 и т. д. Перед запуском тестового сеанса убедитесь, что конфигурация находится в известном состоянии "новое/чистое", запустив `blkdiscard` на каждом устройстве NVMe.
