...
Шифрование дисков Azure для виртуальных машин Linux (VM) использует функцию DM-Encryption в Linux для обеспечения полного шифрования диска операционной системы и дисков данных. Кроме того, он обеспечивает шифрование временного диска ресурсов при использовании функции Енкриптформаталл.
