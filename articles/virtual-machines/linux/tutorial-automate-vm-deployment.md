...
| Издатель | ПРЕДЛОЖЕНИЕ | номер SKU | Версия | готовность к использованию cloud-init |
|:--- |:--- |:--- |:--- |:--- |
...
|CoreOS |CoreOS |объем стабилен |последняя |да |
|OpenLogic 7.6 |CentOS |7-CI |последняя |предварительный просмотр |
