---
title: Добавление диска данных в Linux VM с помощью Azure CLI
...
Syncing disks.
```
Используйте ниже приведенную команду для обновления ядра:
```
partprobe 
```
...
>
> Серийная консоль Azure VM может использоваться для доступа к VM, если изменение fstab привело к сбою загрузки. Более подробная информация доступна в [документации Serial Console](https://docs.microsoft.com/azure/virtual-machines/troubleshooting/serial-console-linux).
