...
> [!IMPORTANT]
> Чтобы развернуть виртуальную Машину из образа в другом клиенте azure нельзя использовать портал. Чтобы создать виртуальную Машину из образа совместно несколькими клиентами, необходимо использовать [Azure CLI](shared-images.md#create-a-vm) или [Powershell](../windows/shared-images.md#create-vms-from-an-image).
...
1. В разделе **учетной записи администратора**выберите **пароль** или **открытый ключ SSH**, затем введите данные.
1. Если вы хотите разрешить удаленный доступ к виртуальной Машине, в разделе **общедоступных входящих портов**, выберите **разрешить выбранные порты** , а затем выберите **SSH (22)** из раскрывающегося списка. Если вы не хотите разрешить удаленный доступ к виртуальной Машине, оставьте **None** выбранного для **общедоступных входящих портов**.
