...
После перезапуска виртуальной машины выполните следующие действия.
   ...
   1. Используйте следующую команду для установки пакета **gptdisk**, который необходим для увеличения размера диска операционной системы:
   ...
   1. Выполните команду **#lsblk**, чтобы проверить, увеличился ли размер раздела.

      Следующие выходные данные показывают, что размер раздела **/dev/sda4** теперь составляет 98,5 ГБ.
   ...
   1. Укажите тип файловой системы на диске ОС с помощью следующей команды:
