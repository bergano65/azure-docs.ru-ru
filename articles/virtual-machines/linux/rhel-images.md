---
title: Образы Red Hat Enterprise Linux в Azure
...
```
В этом случае `RedHat:RHEL:7.4:7.4.2019041718` будет подключен к репозиториям ЕУС по умолчанию, и `RedHat:RHEL:7-RAW:7.4.2018010506` будет подключен к репозиториям, отличным от ЕУС, по умолчанию.
...
:----|:----|:-------------|:-------------|:-----
RHEL          | 7-RAW    | RAW    | Агент Linux | Семейство образов RHEL 7. x. <br> По умолчанию не подключен к репозиториям ЕУС.
|             | 7-LVM    | Диспетчер логических томов    | Агент Linux | Семейство образов RHEL 7. x. <br> По умолчанию не подключен к репозиториям ЕУС.
|             | 7-RAW-CI | RAW-CI | Cloud-init  | Семейство образов RHEL 7. x. <br> По умолчанию не подключен к репозиториям ЕУС.
|             | 6.7      | RAW    | Агент Linux |
|             | 6,8      | RAW    | Агент Linux |
|             | 6.9      | RAW    | Агент Linux |
