---
title: Контейнерная платформа OpenShift 3.11 в задачах после развертывания Azure
description: Дополнительные задачи для после развертывания кластера OpenShift Container Platform 3.11.
...
- Главная страница: URL консоли OpenShift (например, `https://masterdns343khhde.westus.cloudapp.azure.com/console`)
- Идентификатор URI: URL консоли OpenShift (например, `https://masterdns343khhde.westus.cloudapp.azure.com/console`)
- URL-адрес ответа: Основной общедоступный URL `https://masterdns343khhde.westus.cloudapp.azure.com/oauth2callback/OCPAzureAD`и имя регистрации приложения (например, )
...
1. Выберите**регистрацию приложения** **Azure Active Directory.** > 
...
## <a name="monitor-openshift-with-azure-monitor-logs"></a>Монитор OpenShift с журналами Azure Monitor
...
- Включить расширение Azure Monitor VM на каждом узлу OpenShift
- Установка агента Log Analytics в виде набора daemon OpenShift

Читайте полные [инструкции](https://docs.microsoft.com/azure/log-analytics/log-analytics-containers#configure-a-log-analytics-agent-for-red-hat-openshift) для получения более подробной информации.
...
> [!NOTE]
> Только завершить шаги в разделе OpenShift шаблон проекта, а не весь раздел Установки.
