...
Имя | Имя виртуальной машины. | 2017-04-02
...
Служба метаданных экземпляра доступна через конечную точку HTTP по адресу 169.254.169.254. Один из сценариев работы Службы метаданных экземпляров — предоставление гарантий, что полученные данные действительно поступили из Azure. Мы подписываем часть этой информации, чтобы гарантировать, что в Azure{b> <b}работает надлежащий образ Marketplace.
