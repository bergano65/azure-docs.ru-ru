...
description: Использование интерфейса rESTful для получения сведений о виртуальной Машине Linux вычислений, сети и ближайших мероприятиях обслуживания.
...
AzurePublicCloud
```
Ниже перечислены облака и значения в среде Azure.
