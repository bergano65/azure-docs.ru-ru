...
| `resourceGroupName` | [Группа ресурсов](../../azure-resource-manager/management/overview.md) для виртуальной машины | 2017-08-01
...
| `zone` | [Зона доступности](../../availability-zones/az-overview.md) виртуальной машины | 2017-12-01
...
1. Выведите дамп конфигурации интерфейса и найдите интерфейс, который соответствует ссылке в таблице маршрутизации, указывая MAC-адрес (физический).
    ```console
      > ipconfig /all
      ... (continues) ...
