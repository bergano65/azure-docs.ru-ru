...
description: ИНТЕРФЕЙС RESTful для получения информации о вычислениях, сетевых и предстоящих событиях технического обслуживания Linux VMs.
...
[Лазурный Китай 21Вианет](https://www.azure.cn/)                                            | Общедоступная версия | 2017-04-02, 2017-08-01, 2017-12-01, 2018-02-01, 2018-04-02, 2018-10-01, 2019-02-01, 2019-03-11, 2019-04-30, 2019-06-01, 2019-06-04, 2019-08-01, 2019-08-15
...
[Лазурный Китай 21Вианет](https://azure.microsoft.com/global-infrastructure/china/)         | AzureChinaCloud;
...
[Лазурный Китай 21Вианет](https://azure.microsoft.com/global-infrastructure/china/)         | В.metadata.azure.cn
...
В тех случаях, когда промежуточный сертификат не может быть загружен из-за сетевых ограничений во время проверки, промежуточный сертификат может быть закреплен. Тем не менее, Azure будет пролонгировать сертификаты в стандартной практике PKI. Закрепленные сертификаты должны быть обновлены, когда произойдет переворачивание. Всякий раз, когда планируется изменение обновления промежуточного сертификата, блог Azure будет обновляться и клиенты Azure будут уведомлены. Промежуточные сертификаты можно найти [здесь](https://www.microsoft.com/pki/mscorp/cps/default.htm). Промежуточные сертификаты для каждого из регионов могут быть разными.
