---
title: Использование удаленный рабочий стол для виртуальной машины Linux в Azure
...
В следующем примере выполняется установка облегченной среды рабочего стола [Xfce4](https://www.xfce.org/) на виртуальной машине Ubuntu 18,04 LTS. Команды для других дистрибутивов незначительно отличаются. Например, для установки на виртуальной машине Red Hat Enterprise Linux используйте `yum` и настройте соответствующие правила `selinux`, а для установки на виртуальной машине SUSE используйте `zypper`.
