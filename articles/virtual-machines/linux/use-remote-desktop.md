---
title: Используйте удаленный рабочий стол для Linux VM в Azure
...
Эта статья требует существующего Ubuntu 18.04 LTS VM в Azure. Если требуется создать виртуальную машину, используйте один из следующих методов:

- [Лазурный CLI](quick-create-cli.md)
...
Следующий пример устанавливает легкую среду рабочего стола [xfce4](https://www.xfce.org/) на Ubuntu 18.04 LTS VM. Команды для других дистрибутивов незначительно отличаются. Например, для установки на виртуальной машине Red Hat Enterprise Linux используйте `yum` и настройте соответствующие правила `selinux`, а для установки на виртуальной машине SUSE используйте `zypper`.
