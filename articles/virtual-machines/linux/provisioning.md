...
В качестве агентов подготовки можно использовать [агент Linux для Azure](https://docs.microsoft.com/azure/virtual-machines/extensions/agent-linux) или [cloud-init](https://docs.microsoft.com/azure/virtual-machines/linux/using-cloud-init). Это [обязательные требования](create-upload-generic.md) для создания универсальных образов.

Агенты подготовки обеспечивают поддержку всех предустановленных [дистрибутивов Linux для Azure](https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros), и в большинстве случаев образы этих дистрибутивов уже включают cloud-init и агент Linux. Поэтому вы можете использовать cloud-init для подготовки, а агент Linux — для предоставления поддержки [расширений Azure](https://docs.microsoft.com/azure/virtual-machines/extensions/features-windows). Предоставление поддержки расширений означает, что виртуальная машина сможет поддерживать дополнительные службы Azure, такие как сброс паролей виртуальной машины, мониторинг Azure, Azure Backup, шифрование дисков Azure и т. д.
