...
| Размеры виртуальной машины         | Все размеры виртуальной машины. | [Просмотреть доступные размеры](https://docs.microsoft.com/azure/virtual-machines/linux/generation-2#generation-2-vm-sizes) |
