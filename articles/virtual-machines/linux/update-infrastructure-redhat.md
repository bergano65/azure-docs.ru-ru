...
* Поведение RHUI по умолчанию — обновление виртуальной машины RHEL до последней дополнительной версии при запуске `sudo yum update`.
    ...
    Чтобы избежать такого поведения, можно переключиться на [каналы поддержки расширенных обновлений](#rhel-eus-and-version-locking-rhel-vms) или создать собственный образ, как описано в статье [Создание и передача виртуальной машины на основе Red Hat для Azure](redhat-create-upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) . Если вы создаете собственный образ, необходимо подключить его к другой инфраструктуре обновления ([непосредственно к серверам доставки содержимого Red Hat](https://access.redhat.com/solutions/253273) или к [серверу-спутнику Red Hat](https://access.redhat.com/products/red-hat-satellite)).
