...
Последнее тестирование этой статьи выполнялось 14.02.2019 г. с помощью [Azure Cloud Shell](https://shell.azure.com/bash) и [Azure CLI](/cli/azure/install-azure-cli) версии 2.0.58.
