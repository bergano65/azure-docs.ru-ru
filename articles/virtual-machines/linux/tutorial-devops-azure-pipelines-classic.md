...
В этой статье описывается, как настроить на портале Azure конвейер CI/CD, который использует стратегию последовательного развертывания для нескольких компьютеров. Также портал Azure поддерживает другие стратегии, например [раннего](./tutorial-azure-devops-canary-strategy.md) и [сине-зеленого](./tutorial-azure-devops-blue-green-strategy.md) обновления.
