...
Доступ к порталу возможен через браузер, Azure CLI и Azure PowerShell требуется локальная установка. см. раздел Шифрование диска [Azure для Linux: Чтобы получить дополнительные сведения, установите средства @ no__t-0.
