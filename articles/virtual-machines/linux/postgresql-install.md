---
title: Настройка PostgreS'L на Linux VM
...
5. Если вы хотите построить все, что может быть построено, включая`contrib`документацию (HTML и страницы человека) и дополнительные модули (), запустите следующую команду вместо:
...
Для обновления данных в таблице используйте следующую команду: Для этого, Сэнди подтвердил, что они посещают, поэтому мы будем менять RSVP с "N" на "Y":
