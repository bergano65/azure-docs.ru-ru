...
Для обновления данных в таблице используйте следующую команду: В нашем Sandy подтверждает, что они конференции, поэтому мы изменим RSVP из «N» на «Y»:
