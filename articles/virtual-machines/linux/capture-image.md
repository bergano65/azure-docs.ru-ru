...
Аддитоналли. Используйте метод **Pack** для создания пользовательской конфигурации. Дополнительные сведения см. в статье [Создание образов виртуальных машин Linux в Azure с помощью Packer](build-image-with-packer.md).
