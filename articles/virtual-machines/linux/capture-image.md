...
Сведения о создании, хранении и совместном использовании образов в большом масштабе см. в статье [Общая коллекция образов](shared-images.md).
