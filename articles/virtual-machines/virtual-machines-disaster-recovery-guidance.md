...
---
# <a name="what-if-an-azure-service-disruption-impacts-azure-vms"></a>Что делать, если сбой в работе службы Azure влияет на M Ms Azure
