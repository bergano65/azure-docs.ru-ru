...
Дополнительные сведения о типах и размерах отдельных виртуальных машин в Azure для Windows или Linux, включая размеры, совместимые с хранилищем класса Premium, см. [в статье размеры виртуальных машин в Azure](sizes.md). Дополнительные сведения о типах и размерах отдельных виртуальных машин в Azure для Linux, включая размеры, совместимые с хранилищем класса Premium, см. [в статье размеры виртуальных машин в Azure](sizes.md). В любой из этих статей необходимо проверить каждую отдельную статью о размере виртуальной машины, чтобы определить, совместима ли она с хранилищем класса Premium.
