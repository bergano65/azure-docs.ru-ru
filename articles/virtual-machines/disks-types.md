...
|Сценарий   |Рабочие нагрузки с интенсивным вводом-выводом, такие как [SAP HANA](~/articles/virtual-machines/workloads/sap/hana-vm-operations-storage.md), базы данных верхнего уровня (например, SQL, Oracle) и другие рабочие нагрузки с большим объемом транзакций.   |Рабочая среда с высокими требованиями к уровню производительности   |Веб-серверы, редко используемые корпоративные приложения и сценарии разработки и тестирования   |Резервное копирование, не критически важный и нечастый доступ   |
...
## <a name="premium-ssd"></a>SSD ценовой категории "Премиум"
...
## <a name="standard-ssd"></a>SSD ценовой категории "Стандартный"
...
## <a name="standard-hdd"></a>HDD ценовой категории "Стандартный"
