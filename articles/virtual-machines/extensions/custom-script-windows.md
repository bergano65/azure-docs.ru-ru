...
Сведения о развертывании расширения пользовательских скриптов в масштабируемом наборе см. в [Add-AzVmssExtension](/powershell/module/az.compute/add-azvmssextension)
