---
title: Расширение Linux "Моментальный снимок виртуальной машины" для службы Azure Backup | Документы Майкрософт
...
| языковый стандарт | ru-ru | string |
