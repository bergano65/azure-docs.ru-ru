...
description: Выполните резервное копирование виртуальной машины в соответствии с приложением Azure Backup с помощью расширения Linux моментального снимка виртуальной машины.
