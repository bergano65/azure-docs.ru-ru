---
title: Расширение шеф-повара для Пазуры VMs
...
| name | Значение и пример | Тип данных | Обязательно?
| ---- | ---- | ---- | ----
...
| name | Пример | Тип данных | Обязательно?
| ---- | ---- | ---- | ---- |
...
Шаблон «Менеджер ресурсов», включающий расширение Chef VM, можно найти в [галерее быстрого запуска Azure.](https://github.com/Azure/azure-quickstart-templates/tree/master/chef-json-parameters-linux-vm)
...
> [!NOTE]
> Для чего-либо еще, непосредственно связанных с шеф-поваром, обратитесь [в службу поддержки шеф-повара](https://www.chef.io/support/).
