...
Следующая таблица предоставляет сопоставление версии расширения виртуальной Машины Windows Azure Monitor и пакетов агента Log Analytics для каждого выпуска. 
