---
title: Диагностическое расширение Linux (службы "Вычисления Azure")
...
Дополнительные сведения о создании маркеров SAS для Центров событий и получении сведений о них см. на [этой веб-странице](https://docs.microsoft.com/rest/api/eventhub/generate-sas-token#powershell).
...
**ПРИМЕЧАНИЕ.** Если вместо JSON используется портал Azure, правильным полем условия будет строка "Name='/mnt'".
