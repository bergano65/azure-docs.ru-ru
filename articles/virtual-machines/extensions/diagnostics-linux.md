...
* **Интерфейс командной строки Azure**. [Установите среду Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli) на компьютере.
...
Элемент | Значение
------- | -----
Имя | Строка, используемая для указания этого приемника в других местах конфигурации расширения.
...
запрос | Запрос OMI, который следует выполнить.
