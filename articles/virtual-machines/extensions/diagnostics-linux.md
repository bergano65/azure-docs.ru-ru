...
Элемент | Значение
------- | -----
пространство_имен | Пространство имен OMI, в котором должен выполняться запрос (необязательно). Если этот элемент не задан, значение по умолчанию — "root/scx", реализуемое [кроссплатформенными поставщиками System Center](https://github.com/Microsoft/SCXcore).
