...
> [!IMPORTANT]
> Если в гостевом брандмауэре вы заблокировали доступ к IP-адресу *168.63.129.16*, запуск расширения всегда будет завершаться ошибкой, независимо от описанных выше условий.
