...
* К виртуальной машине можно применить только одну версию расширения. Чтобы запустить второй пользовательский скрипт, необходимо удалить расширение пользовательского скрипта и повторно применить его с обновленным сценарием. 
