...
Вы также можете получить состояние выполнения расширения пользовательского скрипта, `commandToExecute` включая фактические аргументы, передаваемые как с помощью Azure CLI:
