---
title: Регионы Azure
description: Сведения о регионах для запуска виртуальных машин в Azure.
author: cynthn
ms.author: cynthn
...
ms.locfileid: "87284733"
---
# <a name="regions-for-virtual-machines-in-azure"></a>Регионы размещения виртуальных машин в Azure
...
* **Восточный Китай** и **Северный Китай**
  * Эти области доступны благодаря уникальным партнерским отношениям между корпорацией Майкрософт и компанией 21Vianet, по условиям которых Майкрософт не обслуживает центры обработки данных напрямую. См. Дополнительные сведения об [Azure Китая 21vianet](https://www.windowsazure.cn/).
...
| Southeast Asia |Восточная Азия |

Полный [список пар регионов](../best-practices-availability-paired-regions.md#what-are-paired-regions)см. здесь.

## <a name="feature-availability"></a>Доступность функций
Некоторые службы или функции виртуальных машин доступны только в отдельных регионах, например определенные размеры виртуальных машин или типы хранилищ. Также есть глобальные службы Azure, не требующие выбора определенного региона. К ним относятся, например, [Azure Active Directory](../active-directory/fundamentals/active-directory-whatis.md), [диспетчер трафика](../traffic-manager/traffic-manager-overview.md) и [Azure DNS](../dns/dns-overview.md). При разработке среды приложения вам поможет проверка [доступности служб Azure в каждом регионе](https://azure.microsoft.com/regions/#services). Вы также можете [программно запрашивать поддерживаемые размеры и ограничения виртуальной машины в каждом регионе](../azure-resource-manager/templates/error-sku-not-available.md).
...
Дополнительные сведения о параметрах репликации службы хранилища Azure см. [здесь](../storage/common/storage-redundancy.md). Дополнительные сведения об управляемых дисках Azure см. в [этой статье](./windows/managed-disks-overview.md).
...
Дополнительные сведения см. на странице [Регионы Azure](https://azure.microsoft.com/global-infrastructure/regions/).