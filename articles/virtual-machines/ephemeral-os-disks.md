...
| **Поддерживаемые размеры виртуальных машин**          | Все                                                                                          | Размеры виртуальных машин, поддерживающие хранилище класса Premium, например DSv1, DSv2, DSv3, Esv3, FS, серия fsv2, GS, LSv2, M                                               |
