...
|Обработка данных/оповещения системы безопасности|    Оповещения центра безопасности Azure, журналов и оповещений Azure Monitor|    Предоставляет сведения о безопасности и оповещения.|  Интерфейсы REST API, JSON.|
...
* Экспорт журнала действий с профилями журнала в [журналы Azure Monitor](https://docs.microsoft.com/azure/log-analytics/log-analytics-overview).
...
* Анализ журналов с помощью [журналы Azure Monitor](https://docs.microsoft.com/azure/log-analytics/log-analytics-overview).
...
* Направление диагностики Azure в журналах Azure Monitor (**диагностики** в следующей таблице)

* Журналы системы диагностики Azure в службу хранилища Azure в Azure Monitor (**хранения** в следующей таблице)
...
| Тип журнала | Azure Monitor регистрирует вспомогательные JSON (Splunk, ArcSight и IBM QRadar) |
| :------- | :-------------------------------------------------------- |
...
* [Интеграция решений по обеспечению безопасности в Центре безопасности Azure](https://docs.microsoft.com/azure/security-center/security-center-integrating-alerts-with-log-integration). В этой статье рассматривается, как синхронизировать оповещения центра безопасности, события безопасности виртуальных машин, собранные журналы диагностики Azure и журналов аудита Azure с решением SIEM или журналы Azure Monitor.
