...
[Шифрование неактивных данных](https://blogs.microsoft.com/cybertrust/2015/09/10/cloud-security-controls-series-encrypting-data-at-rest/) является обязательным шагом для защиты данных, соответствия стандартам и обеспечения конфиденциальности данных.
...
**Сведения**: используйте [VPN-подключения типа "точка — сеть"](../vpn-gateway/vpn-gateway-point-to-site-create.md).
