...
Центр Microsoft Security Response Center (MSRC) управляется опытными специалистами в сфере обеспечения безопасности. Они круглосуточно и без выходных работают над обнаружением, мониторингом и решением проблем с безопасностью, а также над устранением локальных и облачных уязвимостей.

Помимо своей текущей работы, команда MSRC предоставляет пользователям набор ресурсов для более эффективной защиты ресурсов и развертываний Azure.
...
Майкрософт выплачивает исследователям премии за:

- обнаружение новых способов взлома;
