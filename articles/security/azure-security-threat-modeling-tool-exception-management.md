...
ms.locfileid: "59527427"
---
# <a name="security-frame-exception-management--mitigations"></a>Механизм безопасности. Управление исключениями | Способы устранения рисков 
...
Проверьте ссылки в разделе ссылок на дополнительные сведения об обработке исключений и проверке модели в веб-API ASP.NET 
