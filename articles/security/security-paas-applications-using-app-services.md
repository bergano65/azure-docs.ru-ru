...
Для службы приложений в Windows можно также динамически ограничить IP-адреса, настроив файл Web. config. Дополнительные сведения см. в разделе [Dynamic IP Security](https://docs.microsoft.com/iis/configuration/system.webServer/security/dynamicIpSecurity/).
