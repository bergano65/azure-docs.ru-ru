...
* Установленная служба "Интеграция журналов данных Azure". Чтобы установить службу:
   ...
   2. Скопируйте в систему установщик интеграции журналов Azure. c. Запустите установщик и примите условия лицензионного соглашения на использование программного обеспечения корпорации Майкрософт.
...
* Последняя версия PowerShell.
   ...
   После того как вы по крайней мере PowerShell 5.0, можно перейти к установке последней версии, следуя инструкциям в [установить Azure PowerShell](/powershell/azure/install-az-ps).
...
1. Получите все возможные расположения Azure и добавьте имена в переменную, которая может использоваться в дальнейшем:
    ...
    Если ввести `$locations` на этом этапе вы увидите имена расположений без дополнительных сведений, возвращаемых Get-AzLocation.
