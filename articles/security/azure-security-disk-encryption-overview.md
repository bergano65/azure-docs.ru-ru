...
Microsoft Azure очень серьезно относится к обеспечению конфиденциальности и независимости ваших данных. Вы можете управлять размещенными в Azure данными с помощью ряда передовых технологий, обеспечивающих шифрование, контроль, управление ключами шифрования, а также управление доступом к данным и его аудит. Благодаря этому клиенты Azure получают гибкость в выборе решения, которое лучше всего соответствует потребностям их компании. В этой статье описано технологическое решение: "Шифрование дисков Azure для виртуальных машин IaaS с ОС Windows и Linux". Эта технология помогает защитить данные согласно корпоративным обязательствам по обеспечению безопасности и соответствия. 
...
* виртуальные машины IaaS серий [A, D, DS, G, GS, F и т. д.](https://azure.microsoft.com/pricing/details/virtual-machines/) цен. категории "Стандартный"; ([виртуальные машины Linux](azure-security-disk-encryption-faq.md#bkmk_LinuxOSSupport) этой ценовой категории должны соответствовать минимальным требованиям к объему памяти в 7 ГБ.)
