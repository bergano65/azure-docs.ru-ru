---
title: Включение шифрования дисков Azure с использованием Azure AD App для виртуальных машин IaaS под управлением Windows (предыдущий выпуск) | Документация Майкрософт
