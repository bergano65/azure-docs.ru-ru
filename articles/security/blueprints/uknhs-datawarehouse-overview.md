...
ms.locfileid: "57242672"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-uk-nhs"></a>Схема безопасности и соответствия требованиям Azure. Хранилище данных для Отделения часть соединенного Королевства
...
**Хранилище данных SQL**: [Хранилище данных SQL](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-overview-what-is) является хранилища корпоративных данных, использующего массовую параллельную обработку для быстрого выполнения сложных запросов на несколько петабайт данных, позволяя пользователям для эффективного определения медицинских данных. Пользователи могут применять простые запросы T-SQL PolyBase для импорта больших данных в хранилище данных SQL и задействовать возможности массовой параллельной обработки для выполнения высокопроизводительной аналитики.

**SQL Server Reporting Services**: [SQL Server Reporting Services](https://docs.microsoft.com/sql/reporting-services/report-data/sql-azure-connection-type-ssrs) предоставляет быстрого создания отчетов с помощью таблицы, диаграммы, карты, датчики, матрицы, а также более для хранилища данных SQL Azure.
