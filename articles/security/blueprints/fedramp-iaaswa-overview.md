...
Журналы Azure Monitor предоставляют широкие возможности ведения журнала системных и пользовательских действий, а также работоспособность системы. Решение " [журналы Azure Monitor](https://docs.microsoft.com/azure/security/azure-security-disk-encryption) " собирает и анализирует данные, созданные ресурсами в Azure и локальных средах.
