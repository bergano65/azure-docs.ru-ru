...
- Аутентификация развернутого пользователем веб-приложения может выполняться с помощью Azure Active Directory. Дополнительные сведения см. в статье [Интеграция приложений с Azure Active Directory](../../active-directory/develop/quickstart-v1-integrate-apps-with-azure-ad.md).  
...
- [брандмауэр веб-приложения](../../application-gateway/waf-overview.md) (режим WAF);
...
Журналы Azure Monitor предоставляют широкие возможности ведения журнала системных и пользовательских действий, а также работоспособность системы. Решение " [журналы Azure Monitor](../azure-security-disk-encryption-overview.md) " собирает и анализирует данные, созданные ресурсами в Azure и локальных средах.
...
- **Журналы диагностики**.  [Журналы диагностики.](../../azure-monitor/platform/diagnostic-logs-overview.md) — это все журналы, создаваемые ресурсами. К этим журналам относятся системные журналы событий Windows, журналы службы хранилища Azure, журналы аудита Key Vault, а также журналы брандмауэра и доступа шлюза приложений.
