...
**Хранилище данных SQL**: [Хранилище данных SQL](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-overview-what-is) является корпоративных данных хранилища (EDW), использующее массовую параллельную обработку (MPP) для быстрого выполнения сложных запросов на несколько петабайт данных. Импортируйте большие данные в хранилище данных SQL с помощью простых запросов T-SQL PolyBase и используйте возможности MPP для выполнения высокопроизводительной аналитики.

**SQL Server Reporting Services**: [SQL Server Reporting Services](https://docs.microsoft.com/sql/reporting-services/report-data/sql-azure-connection-type-ssrs) обеспечивает быстрое создание отчетов с помощью таблицы, диаграммы, карты, датчики, матрицы, а также более для хранилища данных SQL Azure.
...
-   [Azure Monitor регистрирует расширение](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-extensions-oms)
