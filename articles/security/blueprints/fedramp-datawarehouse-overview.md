...
ms.locfileid: "68778912"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-fedramp-automation"></a>Схема безопасности и соответствия требованиям Azure. Хранилище данных для службы автоматизации FedRAMP
...
**Хранилище данных SQL**: [Хранилище данных SQL](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-overview-what-is) — это хранилище данных предприятия (EDW), которое использует массовую параллельную обработку (MPP) для быстрого выполнения сложных запросов в петабайтов данных. Импортируйте большие данные в хранилище данных SQL с помощью простых запросов T-SQL PolyBase и используйте возможности MPP для выполнения высокопроизводительной аналитики.

**SQL Server Reporting Services**: [SQL Server Reporting Services](https://docs.microsoft.com/sql/reporting-services/report-data/sql-azure-connection-type-ssrs) позволяет быстро создавать отчеты с таблицами, диаграммами, картами, датчиками, матрицами и др. для хранилища данных SQL Azure.
...
-   [Расширение журналов Azure Monitor](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-extensions-oms)
...
[Журналы Azure Monitor](https://docs.microsoft.com/azure/security/azure-security-disk-encryption) предоставляют широкие возможности ведения журнала системных и пользовательских действий, а также работоспособность системы. Решение " [журналы Azure Monitor](https://azure.microsoft.com/services/log-analytics/) " собирает и анализирует данные, созданные ресурсами в Azure и локальных средах.
