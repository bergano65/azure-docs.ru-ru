...
Кроме того Application Insights предоставляет управления производительностью приложений в режиме реального времени и аналитики с помощью журналов Azure Monitor. **Корпорация Майкрософт рекомендует настроить подключение VPN или ExpressRoute для управления и импорта данных в подсеть эталонной архитектуры.**
