...
![Схема эталонной архитектуры веб-приложения IaaS для GDPR](images/gdpr-iaaswa-architecture.png?raw=true "Схема эталонной архитектуры веб-приложения IaaS для GDPR")
...
Схему потока данных для этой эталонной архитектуры можно [скачать](https://aka.ms/gdprIaaSdfd) или просмотреть ниже. Используя эту модель, клиенты могут выявить зоны потенциального риска в инфраструктуре системы при внесении изменений.

![Модель рисков веб-приложения IaaS для GDPR](images/gdpr-iaaswa-threat-model.png?raw=true "Модель рисков веб-приложения IaaS для GDPR")
