...
**Архивация журналов**. Хранилище данных журнала можно настроить для записи в централизованную учетную запись Azure для архивации и хранения в течение определенного срока. Журналы могут быть обработаны с помощью службы Azure Log Analytics или систем SIEM сторонних производителей.
...
Есть два метода, которые пользователи могут использовать для развертывания этой автоматизации схемы. В первом методе для развертывания эталонной архитектуры используется сценарий PowerShell, а во втором — портал Azure. Подробные инструкции по развертыванию см. в [этой статье](https://aka.ms/ukofficial-iaaswa-repo).
