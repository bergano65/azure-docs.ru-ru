...
**Журналы диагностики**. [Это](../../azure-monitor/platform/diagnostic-logs-overview.md) все журналы, создаваемые ресурсами. Эти журналы могут включать системные журналы событий Windows, журналы больших двоичных объектов, таблиц и очередей.
