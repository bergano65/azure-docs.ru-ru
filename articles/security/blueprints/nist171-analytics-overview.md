...
**Машинное обучение Azure.** [Машинное обучение](https://docs.microsoft.com/azure/machine-learning/preview/) — это метод обработки и анализа данных, который позволяет компьютерам на основе существующих данных прогнозировать будущее поведение, результаты и тенденции.
