...
**Хранилище данных SQL**: [Хранилище данных SQL](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-overview-what-is) — Enterprise данных хранилища (EDW), использующее массовую параллельную обработку (MPP) для быстрого выполнения сложных запросов на несколько петабайт данных, позволяя пользователям для эффективного определения финансовых данных. Пользователи могут применять простые запросы T-SQL PolyBase для импорта больших данных в хранилище данных SQL и задействовать возможности MPP для выполнения высокопроизводительной аналитики.

**SQL Server Reporting Services (SSRS)** : [SQL Server Reporting Services](https://docs.microsoft.com/sql/reporting-services/report-data/sql-azure-connection-type-ssrs) предоставляет быстрого создания отчетов с помощью таблицы, диаграммы, карты, датчики, матрицы, а также более для хранилища данных SQL Azure.
...
- Журналы Azure Monitor подключен к [группы безопасности сети&#39;s журналов диагностики](https://github.com/krnese/AzureDeploy/blob/master/AzureMgmt/AzureMonitor/nsgWithDiagnostics.json)
...
**Защита от вредоносных программ**. [Антивредоносное по Майкрософт](https://docs.microsoft.com/azure/security/azure-security-antimalware) для виртуальных машин обеспечивает возможность защиты в реальном времени, которая помогает обнаруживать и устранять вирусы, программы-шпионы и другие вредоносные программы, можете настроить оповещения вредоносного или нежелательного программного обеспечения пытается установиться или запуститься на защищенных виртуальных машин.
