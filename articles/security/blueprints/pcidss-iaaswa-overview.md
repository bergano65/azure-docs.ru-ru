...
Конфигурацию групп безопасности сети для развертывания с помощью этого решения см. на сайте [GitHub](https://github.com/Azure/fedramp-iaas-webapp/blob/master/nestedtemplates/virtualNetworkNSG.json). Организации могут настроить группы безопасности сети, изменив файл, приведенный выше, с использованием [этой документации](../../virtual-network/virtual-network-vnet-plan-design-arm.md) в качестве руководства.
...
**Шифрование дисков Azure**. Шифрование дисков Azure применяется для шифрования дисков Windows в виртуальных машинах IaaS. [Шифрование дисков Azure](../azure-security-disk-encryption-overview.md) использует возможность BitLocker Windows, чтобы обеспечить шифрование тома для ОС и дисков данных. Решение интегрируется с хранилищем ключей Azure, помогая управлять ключами шифрования дисков.
