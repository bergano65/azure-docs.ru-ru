...
-   [Расширение IaaS](https://github.com/Azure/Health-Data-and-AI-Blueprint/blob/master/README%20IaaS.md). В этом решении будет рассматриваться миграция локального решения на основе SQL в Azure и внедрение рабочей станции c привилегированным доступом для безопасного управления облачными решениями и службами. 
...
- Использование рабочей среды [Студии машинного обучения](/azure/machine-learning/desktop-workbench/experimentation-service-configuration) требует разработки экспериментов, которые предоставляют возможность предсказать набор решений. [Интеграция рабочей среды](/azure/machine-learning/desktop-workbench/using-git-ml-project) может упростить управление экспериментами.
...
[Log Analytics](/azure/operations-management-suite/operations-management-suite-overview) — это коллекция служб управления.
