...
**Azure безопасности и соответствия план — данные о работоспособности HIPAA/HITRUST и искусственного Интеллекта предлагает готовое развертывание решения Azure PaaS и IaaS демонстрируется приема, хранения, анализа, взаимодействия, удостоверений и безопасного развертывания решений с помощью данных о работоспособности при возможность соответствовать отраслевым нормативным требованиям. Проект помогает ускорить внедрение и использование для клиентов с контролируемыми данными облака.**
...
-   **Архитектурная схема.** На схеме показана эталонная архитектура, используемая для проекта и примера сценария использования.
...
*Адрес электронной почты: Алекс\_SiteAdmin*
...
**Специалист по обработке данных — Дебра**

*Адрес электронной почты: Дебра\_DataScientist*
...
*Адрес электронной почты: Дэнни\_DBAnalyst*
...
*Адрес электронной почты: Крис\_CareLineManager*
...
*Адрес электронной почты: Хан\_Аудитор*
...
**1. Функция Azure[ активируется и запрашивает ](/rest/api/)токен носителя из Azure Active Directory.
