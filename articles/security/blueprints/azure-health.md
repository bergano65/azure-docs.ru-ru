...
-   [Расширение IaaS](https://github.com/Azure/Health-Data-and-AI-Blueprint/blob/master/README%20IaaS.md) этого решения будет показано, как перенести решение на основе SQL на предприятии в Azure и реализовать рабочей станции привилегированного доступа для безопасного управления облачных служб и решений. 
