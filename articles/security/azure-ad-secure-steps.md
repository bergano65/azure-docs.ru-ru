...
Причиной большинства нарушений системы безопасности организации является несанкционированный доступ к учетным записям с помощью одного из множества методов, таких как распыление паролей, воспроизведение угрозы или фишинг. Дополнительные сведения об этих атаках приведены в этом видео (1 ч 15 мин):
