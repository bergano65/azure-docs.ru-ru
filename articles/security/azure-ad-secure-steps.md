...
![Оценка безопасности удостоверения](media/azure-ad/azure-ad-sec-steps0.png)
...
![Пользователи, находящиеся в группе риска](media/azure-ad/azure-ad-sec-steps1.png)
...
![Пользователи, находящиеся в группе риска](media/azure-ad/azure-ad-sec-steps3.png)
