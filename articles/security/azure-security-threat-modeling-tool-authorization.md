...
| **Действия** | В некоторых бизнес-сценариях для хранения конфиденциальных данных, предназначенных для различных сторон, может потребоваться хранилище таблиц Azure. Конфиденциальные данные, относящиеся к разных странах и регионах. В таких случаях подписи SAS можно создать, указав диапазоны ключей секций и строк, таким образом, что пользователь может открыть данные, относящиеся к определенной страны или региона.| 
