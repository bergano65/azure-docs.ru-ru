...
- **Azure ExpressRoute.** Устанавливается между вашей сетью и Azure через участник ExpressRoute. Это подключение является закрытым. Трафик не передается через Интернет. Задержку для подключения ExpressRoute можно спрогнозировать, так как трафик не передается через Интернет. Дополнительные сведения о предыдущих способах подключения см. в разделе [Схемы топологий подключения](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpngateways?toc=%2fazure%2fvirtual-network%2ftoc.json).
...
- **Определяемые пользователем маршруты**. Вы можете создать пользовательские таблицы с маршрутами, которые определяют направление передачи трафика для каждой подсети. Дополнительные сведения об определяемых пользователем маршрутах см. в [этой статье](https://docs.microsoft.com/azure/virtual-network/virtual-networks-udr-overview).
...
Периодические и спонтанные события создаваемые сетевыми ресурсами и войти в учетные записи хранения, отправленное в концентратор событий или журналов Azure Monitor. Эти журналы содержат подробные сведения о работоспособности ресурса. Эти журналы можно просмотреть в средства, такие как журналы Power BI и Azure Monitor. Чтобы узнать, как просматривать журналы диагностики, посетите [журналы Azure Monitor](https://docs.microsoft.com/azure/log-analytics/log-analytics-azure-networking-analytics).
...
Журналы Azure Monitor предлагает следующие решения для мониторинга сетей:
...
#### <a name="azure-application-gateway-analytics-in-azure-monitor-logs"></a>Анализ шлюзов приложений Azure в журналах Azure Monitor
...
-   [Журналы Azure Monitor для групп безопасности сети (Nsg)](https://docs.microsoft.com/azure/virtual-network/virtual-network-nsg-manage-log)
