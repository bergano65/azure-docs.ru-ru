...
-   [шифрование транспортного уровня](../../storage/blobs/security-recommendations.md), например протокол HTTPS, при передаче данных в службу хранилища Azure или из нее;

-   [шифрование подключения](../../storage/blobs/security-recommendations.md), например [шифрование SMB 3.0](../../storage/blobs/security-recommendations.md) для [общей папки Azure](../../storage/files/storage-dotnet-how-to-use-files.md);
