...
Для избранных данных также следует использовать шифрование уровня приложения. Проблемы суверенитета данных иногда могут быть смягчены путем шифрования данных ключом, который хранится в правильной стране/регионе. Это предотвращает проблемы даже при ненамеренной передаче данных, так как их невозможно расшифровать без ключа, если, конечно, используется надежный алгоритм (например, AES 256).
