...
В этой статье перечислены [рекомендации по обеспечению безопасности "Интернета вещей"](/azure/iot-fundamentals/iot-security-best-practices). Дополнительные сведения см. в этой статье.
