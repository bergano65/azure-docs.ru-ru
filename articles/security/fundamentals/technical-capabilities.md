...
Решения по управлению удостоверениями и доступом Майкрософт помогают защитить доступ к приложениям и ресурсам в корпоративном центре обработки данных и в облаке, обеспечивая дополнительные уровни проверки, такие как многофакторная проверка подлинности и политики условного доступа. Наблюдение за подозрительной активностью с использованием расширенных отчетов, аудита и предупреждений помогает смягчить потенциальные риски безопасности. [Azure Active Directory Premium](../../active-directory/active-directory-whatis.md) предоставляет возможность единого входа в тысячи облачных приложений и доступ к веб-приложениям, выполняемым локально.
...
[Брандмауэр веб-приложения (WAF)](../../application-gateway/waf-overview.md) — это компонент [шлюза приложений](../../application-gateway/overview.md) , который обеспечивает централизованную защиту веб-приложений от распространенных эксплойтов и уязвимостей.
...
> [!Note]
> Более подробный список правил и их защита см. в следующих [основных наборах правил](../../application-gateway/waf-overview.md):
...
[Сетевая инфраструктура Azure](../../virtual-machines/windows/infrastructure-example.md) позволяет безопасно подключать ресурсы Azure друг к другу с помощью [виртуальных сетей (виртуальных сетей)](../../virtual-network/virtual-networks-overview.md). Виртуальная сеть — это представление вашей собственной сети в облаке. Это логическая изоляция облачной сети Azure, выделенной для вашей подписки. Виртуальные сети можно также подключать к локальным сетям.
