...
[Azure Active Directory (AD) Управление привилегированными пользователями](../../active-directory/privileged-identity-management/pim-configure.md) позволяет управлять и контролировать привилегированные удостоверения и доступ к ресурсам в Azure AD, а также использовать другие веб-службы Майкрософт, такие как Office 365 или Microsoft Intune.
...
Службы, реализующие шифрование неактивных данных, обычно продолжают работать с ключами шифрования или данными, оставленными незашифрованными на основном диске (например, в файле подкачки операционной системы узла). Поэтому службы должны обеспечить шифрование тома узла для своих служб. Для упрощения этой задачи группа специалистов по вычислениям включила развертывание шифрования узла, использующего предохранитель сетевого ключа [BitLocker](https://technet.microsoft.com/library/dn306081.aspx) и расширение службы DCM, а также агент для шифрования тома узла.
