...
- Служба хранилища Azure. Ознакомьтесь со статьей [Шифрование службы хранилища Azure для неактивных данных](../../storage/common/storage-service-encryption.md).
...
- [Включение протокола HTTPS для приложения в службе приложений Azure](../../app-service/app-service-web-tutorial-custom-ssl.md)
