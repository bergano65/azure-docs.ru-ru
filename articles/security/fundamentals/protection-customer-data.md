...
**Шифрование**. Шифрование данных в хранилище и при передаче может развертываться клиентами как лучшая практика для обеспечения конфиденциальности и целостности данных. Клиенты очень просты в настройке облачных служб Azure для использования TLS для защиты обмена данными через Интернет и даже между виртуальными машинами, размещенными в Azure.
