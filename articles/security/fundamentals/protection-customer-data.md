...
**Шифрование**. Шифрование данных в хранилище и при передаче может развертываться клиентами как лучшая практика для обеспечения конфиденциальности и целостности данных. Клиентам просто настроить свои облачные службы Azure для использования TLS для защиты сообщений от Интернета и даже между их VMs- системой, размещенными в Azure.
...
- Хранение в стране/регионе для соблюдения или задержки.
- Хранение за йена/за оторвто вне региона для целей безопасности или аварийного восстановления.
