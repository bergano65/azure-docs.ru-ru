...
|[Azure Key Vault](/azure/key-vault/key-vault-overview);| Защищенное хранилище секретов для паролей, строк подключения и другой информации, необходимой для работы приложения. |
...
|Служба|Описание|
|------|--------|
| [Служба &nbsp; архивации Azure](/azure/backup/backup-introduction-to-azure-backup)| Служба Azure, используемая для резервного копирования и восстановления данных в облаке Azure. |
