...
| [Активный каталог Azure B2C](/azure/active-directory-b2c/active-directory-b2c-overview)|Это служба управления идентификацией, которая позволяет администрировать процессы входа и регистрации пользователей, а также управлять их профилями при использовании приложений на основе Azure.   |
| [Службы активных доменов Azure](/azure/active-directory-domain-services/overview)| Облачная и управляемая версия доменных служб Active Directory. |
