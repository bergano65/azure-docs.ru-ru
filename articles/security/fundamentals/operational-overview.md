...
Центр безопасности использует [Управление доступом на основе ролей Azure (Azure RBAC)](../../role-based-access-control/role-assignments-portal.md). RBAC предоставляет [встроенные роли](../../role-based-access-control/built-in-roles.md), которые могут назначаться пользователям, группам и службам в Azure.
