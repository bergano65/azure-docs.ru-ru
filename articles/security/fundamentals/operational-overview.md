...
Можно консолидировать данные из различных источников таким образом, чтобы вы могли объединять данные из служб Azure с существующей локальной средой. Журналы Azure Monitor также четко отделяют коллекцию данных от действий, выполняемых с этими данными, чтобы все действия были доступны для всех видов данных.
...
### <a name="site-recovery"></a>Восстановление сайтов
