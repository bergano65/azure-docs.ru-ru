...
|[Хранилище BLOB-объектов Azure](https://docs.microsoft.com/azure/storage/blobs/)|*.blob.core.windows.net|
|[Облачные службы Azure](https://docs.microsoft.com/azure/cloud-services/cloud-services-choose-me) и [виртуальные машины Azure](https://docs.microsoft.com/azure/virtual-machines/)|*.cloudapp.net|
|[Oблачныe службы Azure2](https://docs.microsoft.com/azure/cloud-services/cloud-services-choose-me)|*. cloudapp.azure.com|
...
|[Файлы Azure](https://docs.microsoft.com/azure/storage/files/storage-files-introduction)|*.file.core.windows.net|
...
|[служебной шине Azure](https://docs.microsoft.com/azure/service-bus-messaging/service-bus-messaging-overview)|*.servicebus.windows.net|
...
|[хранилище таблиц Azure](https://docs.microsoft.com/azure/storage/tables/table-storage-overview)|*.table.core.windows.net|
|[Диспетчер трафика Azure](https://docs.microsoft.com/azure/traffic-manager/traffic-manager-overview)|*. trafficmanager.net|
