...
description: Сведения о рабочей сети Azure. См. раздел методы безопасного доступа и механизмы защиты для установления подключения к сети.
services: security
