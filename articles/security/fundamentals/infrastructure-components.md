...
- "Узел": Настраиваемая операционная система, которая выполняется на виртуальных машинах узла.
- Собственная. Собственная операционная система, которая выполняется на арендаторах (например, в службе хранилища Azure). В этой операционной системе нет гипервизора.
...
| Role | Внутренний или внешний | Уровень конфиденциальности | Авторизованные привилегии и выполняемые функции | Тип доступа
| --- | --- | --- | --- | --- |
...
|Клиенты Azure | Внешние | Н/Д | Н/Д | Н/Д |
