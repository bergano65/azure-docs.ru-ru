...
С помощью системы [самостоятельного сброса пароля (SSPR)](../../active-directory/authentication/quickstart-sspr.md) Azure ИТ-администраторы могут разрешить пользователям самостоятельно сбрасывать или разблокировывать пароли и учетные записи. Эта система предоставляет подробные отчеты, которые позволяют отслеживать доступ к ней, а также создает уведомления в случае несанкционированного использования или применения не по назначению. 

### <a name="implement-self-service-group-management"></a>Реализация самостоятельного управления группами

Azure AD предоставляет возможность управлять доступом к ресурсам с помощью групп безопасности и групп Office 365. Вместо ИТ-администраторов управлять этими группами могут владельцы групп. Эта функция называется " [Самостоятельное управление группами](../../active-directory/users-groups-roles/groups-self-service-management.md)", которая позволяет владельцам групп, которым не назначена административная роль, создавать группы и управлять ими, не полагаясь на администраторов на обработку своих запросов.

### <a name="implement-azure-ad-access-reviews"></a>Реализация проверок доступа Azure AD

С помощью [проверок доступа Azure AD](../../active-directory/governance/access-reviews-overview.md)вы можете управлять членством в группах, доступом к корпоративным приложениям и назначениями привилегированных ролей, чтобы обеспечить поддержку стандарта безопасности, который не предоставляет пользователям доступ к продолжительным периодам времени, когда они не требуется.
