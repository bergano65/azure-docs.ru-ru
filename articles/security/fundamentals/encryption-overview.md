...
Виртуальные машины Windows и Linux можно защитить с помощью [шифрования дисков Azure](/azure/security/azure-security-disk-encryption), при котором используется технология [Windows BitLocker](https://technet.microsoft.com/library/cc766295(v=ws.10).aspx), и Linux [DM-Crypt](https://en.wikipedia.org/wiki/Dm-crypt) для защиты дисков операционной системы и дисков данных с шифрованием всего тома.
