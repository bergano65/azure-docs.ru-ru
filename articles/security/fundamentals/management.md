...
* Включите многофакторную проверку подлинности (с помощью [многофакторной идентификации Azure AD](../../active-directory/authentication/concept-mfa-howitworks.md)) или проверку подлинности смарт-карт для администраторов, которые входят в систему через шлюз удаленных рабочих столов.
