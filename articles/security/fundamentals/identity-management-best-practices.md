...
**Преимущество**. Это традиционный метод применения двухфакторной проверки подлинности. Он работает в [службе многофакторной идентификации Azure в облаке и на сервере многофакторной идентификации Azure](../../active-directory/authentication/concept-mfa-howitworks.md). Использование этого метода требует, чтобы пользователи выполняли двухфакторную проверку подлинности при каждом входе в учетную запись, и переопределяет политики условного доступа.

Чтобы определить, когда следует включать многофакторную проверку подлинности, см. статью [Какая версия Многофакторной идентификации Microsoft Azure подходит организации?](../../active-directory/authentication/concept-mfa-howitworks.md)
