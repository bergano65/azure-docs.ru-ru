...
Целью написания этой статьи является предоставление общего плана для более надежной системы безопасности после развертывания, посвященного нашим контрольному списку «[5 шагов по защите инфраструктуры идентификации](steps-secure-identity.md)», в котором описываются некоторые основные функции и службы.
...
[Включить синхронизацию хэшей паролей](/azure/active-directory/users-groups-roles/directory-admin-roles-secure#turn-on-password-hash-synchronization)  
...
- Входы с [зараженных устройств](/azure/active-directory/active-directory-reporting-sign-ins-from-possibly-infected-devices).
