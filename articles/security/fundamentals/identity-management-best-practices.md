...
[Управление доступом на основе ролей (RBAC)](../../role-based-access-control/overview.md) можно использовать для назначения пользователям, группам и приложениям разрешений, действующих в рамках определенной области. Областью назначения роли может быть подписка, группа ресурсов или отдельный ресурс.
...
**Сведения**. Предоставьте группам безопасности роль RBAC [Читатель безопасности](../../role-based-access-control/built-in-roles.md#security-reader). Вы можете использовать корневую группу управления или группу управления сегментом в зависимости от области ответственности:
