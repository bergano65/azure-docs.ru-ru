...
Рекомендуется ознакомиться со статьей [Рекомендации по обеспечению безопасности базы данных Azure](https://docs.microsoft.com/azure/security/fundamentals/database-best-practices) до изучения данного контрольного списка. Вы сможете максимально эффективно использовать этот контрольный список, изучив приведенные в статье рекомендации. Затем вы сможете использовать этот контрольный список для устранения важных проблем в системе безопасности Базы данных SQL Azure.
...
|<br>Центр безопасности Azure| <ul><li>[Мониторинг данных](https://docs.microsoft.com/azure/security-center/security-center-enable-auditing-on-sql-databases). Используйте центр безопасности Azure как централизованное решение для мониторинга безопасности для SQL и других служб Azure.</li></ul>|       
