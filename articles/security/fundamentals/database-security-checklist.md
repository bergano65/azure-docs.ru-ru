...
|**Контроль доступа**||  
|<br> Доступ к базе данных | <ul><li>[Аутентификация](../../sql-database/sql-database-manage-logins.md) (Аутентификация Azure Active Directory). Используются удостоверения, управляемые Azure Active Directory.</li><li>[Авторизация](../../sql-database/sql-database-manage-logins.md) позволяет предоставлять пользователям минимальные необходимые привилегии.</li></ul> |
