...
[Защита от атак DDoS Azure уровня "Стандартный"](../../virtual-network/ddos-protection-overview.md) обеспечивает защиту от атак DDoS. Смотрите [Azure DDoS Protection: Рекомендации по практике и справочным архитектурам,](ddos-best-practices.md) чтобы узнать больше.
