...
[Защита от атак DDoS Azure уровня "Стандартный"](../../virtual-network/ddos-protection-overview.md) обеспечивает защиту от атак DDoS. См. [Защита от атак DDoS Azure. Рекомендации и эталонные образцы архитектуры](ddos-best-practices.md)
