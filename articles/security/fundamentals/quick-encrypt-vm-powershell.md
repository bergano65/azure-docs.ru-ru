...
![Сценарий предварительных требований для шифрования дисков Azure, выполняемый в интегрированной среде сценариев PowerShell](./media/quick-encrypt-vm-powershell/ade-prereq-script.PNG)
...
1. После завершения шифрования можно проверить, зашифрован ли диск, с помощью следующего командлета: 
     ...
     ```
    ![выходные данные Get-AzVmDiskEncryptionStatus.](./media/quick-encrypt-vm-powershell/ade-get-encryption-status.PNG)
