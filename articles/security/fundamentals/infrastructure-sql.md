...
{IP-адрес службы обеспечения безопасности (Src), порт Src, целевой IP-адрес, порт назначения, протокол назначения, вход и выход, с отслеживанием состояния и без отслеживания состояния, время ожидания с потоком отслеживания состояния}.
