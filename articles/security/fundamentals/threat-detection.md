...
## <a name="azure-active-directory-identity-protection"></a>Защита удостоверений Azure Active Directory
...
### <a name="threat-intelligence"></a>Исследование угроз
...
| | |
|---|---|
| Обнаружение | Выявите теневые ИТ с помощью Cloud App Security. Получайте информацию, обнаруживая приложения, действия, пользователей, данные и файлы в облачной среде. Выявляйте сторонние приложения, подключенные к вашему облаку.|
