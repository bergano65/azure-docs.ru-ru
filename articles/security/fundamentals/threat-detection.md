...
Ключевым компонентом [журналов Azure Monitor](../../azure-monitor/log-query/log-query-overview.md) является репозиторий, который размещен в Azure.
...
* [Поиск по журналам](../../azure-monitor/log-query/log-query-overview.md), при котором вы формируете запросы для анализа собранных данных.
