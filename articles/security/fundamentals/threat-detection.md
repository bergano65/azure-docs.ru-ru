...
[Защита идентификации Azure AD](../../active-directory/identity-protection/overview.md) — это функция [Azure Active Directory уровня Premium P2](../../active-directory/active-directory-whatis.md), обеспечивающая обзор всех событий риска и возможных уязвимостей, которые могут влиять на удостоверения организации. Защита идентификации предусматривает возможности обнаружения аномалий Azure AD (они доступны в [отчетах Azure AD об аномальных действиях](../../active-directory/active-directory-reporting-azure-portal.md)) и новые типы событий риска, которые позволяют обнаруживать аномалии в реальном времени.
...
[Обнаружение событий риска и учетных записей, подверженных риску](../../active-directory/identity-protection/overview.md)
...
[Исследование событий риска](../../active-directory/identity-protection/overview.md)
...
- [Возможности обнаружения Центра безопасности Azure](../../security-center/security-center-detection-capabilities.md): помогают выявлять активные угрозы для ресурсов Microsoft Azure и оперативно реагировать на них.
