...
| поиск Azure;                     | ДА                | Preview (Предварительный просмотр)            | -                  |
...
| **Базы данных**                    |                    |                    |                    |
| Использование SQL Server на виртуальных машинах   | ДА                | Да, 2048-разрядный RSA  | ДА                |
...
| Восстановление сайтов Azure              | ДА                | Да, 2048-разрядный RSA  | ДА                |
| **Носител**                        |                    |                    |                    |
| Службы носителей                   | ДА                | -                  | ДА                |
| **Хранилище**                      |                    |                    |                    |
