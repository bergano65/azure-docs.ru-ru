...
#### <a name="encryption-model-and-key-management"></a>Модель шифрования и управление ключами

| **На стороне сервера с помощью управляемого службой ключа** |**На стороне сервера с помощью управляемого клиентом ключа**| **На стороне клиента с помощью управляемого клиентом ключа** | **AI и Машинное обучение**   |
|--------------------|-------------------|----------------------|--------------------|
| Поиск Azure                     | Да                | -                  | -                  |
