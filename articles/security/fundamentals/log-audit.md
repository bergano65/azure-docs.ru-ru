...
| ------------ | -------- | ------ | ----------- |
|[Журналы действий](../../azure-monitor/platform/platform-logs-overview.md)|События уровня управления с ресурсами Azure Resource Manager.|  Предоставляет информацию об операциях, которые выполнялись с ресурсами в подписке.|    REST API, [Azure Monitor](../../azure-monitor/platform/platform-logs-overview.md).|
...
|[Обработка данных/оповещения системы безопасности](../../security-center/security-center-intro.md)|  Оповещения центра безопасности Azure, оповещения журналов Azure Monitor|    Предоставляет сведения о безопасности и оповещения.|  Интерфейсы REST API, JSON.|
