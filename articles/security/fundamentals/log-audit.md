---
title: Регистрация и аудит безопасности Azure Документы Майкрософт
description: Узнайте о журналах, доступных в Azure, и сведениях о безопасности, которые вы можете получить.
services: security
...
ms.locfileid: "75750784"
---
# <a name="azure-security-logging-and-auditing"></a>Регистрация и аудит безопасности Azure
...
Облачные приложения являются сложными и содержат множество подвижных частей. Данные о регистрации данных могут дать представление о ваших приложениях и помочь вам:

- Устранение неполадок в прошлом или предотвращение потенциальных проблем
- Улучшение производительности или обслуживания приложений
- Автоматизация действий, которые в противном случае потребовали бы ручного вмешательства

Журналы Azure делятся по следующим категориям:
* **Журналы управления и контроля** содержат информацию об операциях CREATE, UPDATE и DELETE в Azure Resource Manager. Дополнительные сведения см. в разделе [Журналы действий Azure](../../azure-monitor/platform/platform-logs-overview.md).

* **В журналах плоскостей данных** предоставляется информация о событиях, поднятых в рамках использования ресурсов Azure. К этому типу относятся, например, журналы системы событий Windows, журналы безопасности и журналы приложений на виртуальной машине, а также [журналы диагностики](../../azure-monitor/platform/platform-logs-overview.md), настроенные с помощью Azure Monitor.
...
| ------------ | -------- | ------ | ----------- |
|[Журналы активности](../../azure-monitor/platform/platform-logs-overview.md)|События уровня управления с ресурсами Azure Resource Manager.|  Предоставляет информацию об операциях, которые выполнялись с ресурсами в подписке.|    REST API, [Azure Monitor](../../azure-monitor/platform/platform-logs-overview.md).|
|[Журналы ресурсов Azure](../../azure-monitor/platform/platform-logs-overview.md)|Своевременные данные об операциях с ресурсами Azure Resource Manager в подписке.|   Информация об операциях, выполняемых самим ресурсом.| Azure Monitor|
|[Отчеты Azure Active Directory](../../active-directory/reports-monitoring/overview-reports.md)|Журналы и отчеты. | Предоставляет сведения о действиях входа пользователей и системных действиях по управлению пользователями и группами.|[API Graph](../../active-directory/develop/active-directory-graph-api-quickstart.md)|
...
|[Обработка данных/оповещения системы безопасности](../../security-center/security-center-intro.md)|  Оповещения Центра безопасности Azure, журналы журналов Azure Monitor|    Предоставляет сведения о безопасности и оповещения.|  Интерфейсы REST API, JSON.|

## <a name="log-integration-with-on-premises-siem-systems"></a>Интеграция журналов с локальными системами SIEM
[Интеграция предупреждений Центра безопасности](../../security-center/security-center-export-data-to-siem.md) обсуждает, как синхронизировать оповещения Центра безопасности, виртуальные события безопасности машин, собранные журналами диагностики Azure, и журналы аудита Azure с журналами Azure Monitor или решением SIEM.
