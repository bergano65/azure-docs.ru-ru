...
* **Оповещения об атаках.** Вы можете настроить оповещения в начале, конце и на протяжении атаки, используя встроенные метрики атаки. Оповещения интегрируются в операционное программное обеспечение, например Microsoft Azure журналы мониторинга, Splunk, службу хранилища Azure, электронную почту и портал Azure.
