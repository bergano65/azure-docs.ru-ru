...
* [Создание диспетчер ресурсов виртуальной сети с VPN-подключением типа "сеть — сеть" с помощью портал Azure](../../vpn-gateway/tutorial-site-to-site-portal.md)
...
* [Azure DDoS Protection Standard overview](../../ddos-protection/ddos-protection-overview.md) (Обзор защиты от атак DDoS уровня "Стандартный")
...
* [Журналы действий](../../azure-monitor/essentials/platform-logs-overview.md). С помощью этих журналов можно просмотреть все операции, отправленные для ваших подписок Azure. Эти журналы включены по умолчанию и доступны на портале Azure. Ранее они назывались журналами аудита или операционными журналами.
