...
Для получения сведений о работоспособности ресурсов рекомендуется использовать [Azure Monitor](../../azure-monitor/platform/data-platform.md). Возможности Azure Monitor:
...
- [Расширение системы диагностики Azure](../../azure-monitor/platform/diagnostics-extension-overview.md): использование возможностей мониторинга и диагностики на виртуальных машинах под управлением Windows. Чтобы использовать эти возможности, необходимо включить расширение в [шаблон Azure Resource Manager](../../virtual-machines/extensions/diagnostics-template.md).
