...
Для управления ключами и секретами можно использовать [Azure Key Vault](../../key-vault/key-vault-whatis.md). Однако использование секретов в приложении не зависит от конкретной облачной платформы. Можно развертывать приложения в кластере, размещенном в любом месте. Этот поток состоит из четырех основных шагов.
