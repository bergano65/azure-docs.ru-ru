...
Дополнительные сведения о частных конечных точках, а также о службах и регионах Azure, для которых доступны частные конечные точки, см. в разделе [Частная ссылка Azure](https://docs.microsoft.com/azure/private-link/private-link-overview).
