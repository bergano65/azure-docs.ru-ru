...
| Несанкционированное получение привилегий | Авторизация | Используйте [технологию управления привилегированными пользователями](/azure/active-directory/privileged-identity-management/subscription-requirements). |
