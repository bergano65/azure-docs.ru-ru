...
ms.locfileid: "73159870"
---
# <a name="securing-paas-deployments"></a>Защита развертываний PaaS
...
[Разработка безопасных приложений в Azure](abstract-develop-secure-apps.md) — это общее рекомендации по вопросам безопасности и элементам управления, которые следует учитывать на каждом этапе жизненного цикла разработки программного обеспечения при разработке приложений для облака.
...
**Сведения**. Потеря ключей и учетных данных является распространенной проблемой. Можно использовать централизованное решение, где ключи и секреты могут храниться в аппаратных модулях безопасности (HSM). [Azure Key Vault](../../key-vault/key-vault-overview.md) защищает ключи и секреты путем шифрования ключей проверки подлинности, ключей учетной записи хранения, ключей шифрования данных, PFX-файлов и паролей с помощью ключей, защищенных HSM.
...
| Повышение привилегий | Авторизация | Используйте [технологию управления привилегированными пользователями](/azure/active-directory/privileged-identity-management/subscription-requirements). |
...
- [Служба хранилища Azure](paas-applications-using-storage.md)
- Кэш Redis для Azure
- Служебная шина Azure
- Брандмауэры веб-приложения

Контрольные вопросы и элементы управления, которые следует учитывать на каждом этапе жизненного цикла разработки программного обеспечения при разработке приложений для облака, см. в статье [Разработка безопасных приложений в Azure](abstract-develop-secure-apps.md) .
