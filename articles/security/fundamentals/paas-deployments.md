...
Если это возможно, используйте альтернативные подходы, такие как использование виртуальных частных сетей в виртуальной сети Azure. Если альтернативные подходы невозможны, обязательно используйте сложные парольные фразы и двухфакторную аутентификацию (например, [Многофакторную идентификацию Azure](../../active-directory/authentication/concept-mfa-howitworks.md)).
