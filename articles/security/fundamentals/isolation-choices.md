...
Дополнительные сведения о каждом размере изолированной виртуальной машины доступны [здесь](../../virtual-machines/windows/sizes-memory.md).
