...
![Управление доступом на основе ролей в Azure (Azure RBAC)](./media/isolation-choices/azure-isolation-fig3.png)
...
### <a name="sql-database-application-model"></a>Модель приложения базы данных SQL
