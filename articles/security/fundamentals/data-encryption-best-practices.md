...
**Сведения**: используйте [ExpressRoute](/azure/expressroute/expressroute-introduction). Если вы решили использовать ExpressRoute, можно также зашифровать данные на уровне приложения с помощью SSL/TLS или других протоколов для дополнительной защиты.
