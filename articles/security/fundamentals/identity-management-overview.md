...
description: " В статье представлены общие сведения о базовых функциях безопасности Azure, которые помогут в управлении удостоверениями. Решения Microsoft identity и access management помогают ИТ-отделу защитить доступ к приложениям и ресурсам в корпоративном центре обработки данных и в облаке, что позволяет получить дополнительные уровни проверки, такие как многофакторная аутентификация и условный доступ Политики. "
services: security
...
* [Обзор единого ввоза](https://azure.microsoft.com/documentation/videos/overview-of-single-sign-on/)
* [Что такое доступ к приложениям и единый вход в каталог Azure Active?](../../active-directory/manage-apps/what-is-single-sign-on.md)
* [Интеграция единого входа Azure Active Directory с приложениями SaaS](../../active-directory/manage-apps/configure-single-sign-on-non-gallery-applications.md)
...
* [Руководство по речре активных каталогов Azure](/azure/active-directory/active-directory-reporting-guide)
...
* [Активный каталог Azure B2C Предварительный просмотр: Типы приложений](../../active-directory-b2c/application-types.md)
...
При применении вместе с таким решением управления мобильными устройствами, как Intune, в атрибуты устройства в Azure Active Directory добавляются дополнительные данные о нем. Затем можно создать правила условного доступа, которые обеспечивают доступ с устройств в соответствии со стандартами безопасности и соответствия требованиям.
...
Azure AD Identity Protection — это служба безопасности, которая обеспечивает консолидированное представление об обнаружении рисков и потенциальных уязвимостях, влияющих на идентификаторы вашей организации. Защита идентификации использует существующие возможности обнаружения аномалий Azure Active Directory, которые доступны в отчетах об аномальных действиях Azure Active Directory. Identity Protection также вводит новые типы обнаружения рисков, которые могут обнаруживать аномалии в режиме реального времени.

Дополнительные сведения:

* [Защита идентификационных данных AD Azure](/azure/active-directory/identity-protection/overview)
...
* [Обзоры доступа Azure AD](../../active-directory/governance/access-reviews-overview.md)
