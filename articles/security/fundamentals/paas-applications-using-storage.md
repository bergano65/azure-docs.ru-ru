...
- [Руководство по безопасности хранения данных Azure](/azure/storage/common/storage-security-guide) 
...
Шифрование на стороне клиента встроено в библиотеки хранилищ Java и .NET. См [с помощью шифрования на стороне клиента и Хранилища ключей Azure для Microsoft Azure Storage](/azure/storage/common/storage-client-side-encryption) можно ознакомиться с информацией о шифровании данных в клиентских приложениях, а также о создании и управлении собственными ключами шифрования.
