---
title: Рекомендации по обеспечению безопасности баз данных — Microsoft Azure
...
## <a name="secure-databases"></a>Защита баз данных
...
### <a name="sql-server-authentication"></a>*Проверка подлинности SQL Server*
...
[Аудит базы данных SQL Azure](/azure/sql-database/sql-database-auditing) позволяет отслеживать события базы данных и записывать их в журнал аудита в учетной записи хранения Azure.
