...
## <a name="enable-feature-restrictions"></a>Включить ограничения функций

Данные, содержащиеся в базах данных, могут предоставляться злоумышленникам с помощью векторов атак, использующих ошибки базы данных и время выполнения запросов. База данных SQL Azure предоставляет ряд механизмов ограничения функций для защиты базы данных. Дополнительные сведения см. в разделе [ограничения функций базы данных SQL](/azure/sql-database/sql-database-feature-restrictions).
