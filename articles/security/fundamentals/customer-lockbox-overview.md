...
Функция защищенного хранилища теперь является общедоступной и активна при получении доступа к виртуальным машинам через удаленный рабочий стол.

## <a name="supported-services-and-scenarios-in-preview"></a>Поддерживаемые службы и сценарии в предварительной версии

В предварительной версии защищенного хранилища сейчас доступны следующие службы:
...
- Виртуальные машины (теперь также предоставляют доступ к дампам памяти и управляемым дискам)
...
Функция защищенного хранилища теперь активна при запросе доступа к виртуальным машинам через удаленный рабочий стол. Поддерживаются следующие рабочие нагрузки:
...
Для сценариев, использующих доступ к удаленному рабочему столу, можно задействовать журналы событий Windows, чтобы просмотреть действия, предпринятые специалистами Майкрософт. Используйте Центр безопасности Azure, чтобы собрать журналы событий и скопировать данные в рабочую область для анализа. Дополнительные сведения см. в статье [Сбор данных в Центре безопасности Azure](../../security-center/security-center-enable-data-collection.md).
