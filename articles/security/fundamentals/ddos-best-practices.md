---
title: Разработка устойчивых решений с помощью Azure от атак DDoS Protection
...
"Защита от атак DDoS Azure" уровня "Стандартный" определяет и устраняет атаки DDoS без вмешательства пользователя. Чтобы получать уведомления при наличии активного устранения проблем с защищенным общедоступным IP-адресом, можно [настроить оповещение](/azure/virtual-network/ddos-protection-manage-portal) для метрики **в разделе от атак DDoS-атака**. Вы можете создать оповещения для других метрик атак DDoS, чтобы изучить масштабирование атаки, снижающийся трафик и другие сведения.
...
Эталонная архитектура демонстрирует запуск приложения службы приложений Azure в одном регионе. Эта архитектура показывает набор проверенных методик для веб-приложения, использующего [службу приложений Azure](https://azure.microsoft.com/documentation/services/app-service/)   и [базу данных SQL Azure](https://azure.microsoft.com/documentation/services/sql-database/).
