...
Дополнительные сведения см. в статье [Manage Azure DDoS Protection Standard using the Azure portal](../../ddos-protection/manage-ddos-protection.md) (Управление службой "Защита от атак DDoS Azure" уровня "Стандартный" с помощью портала Azure).
...
"Защита от атак DDoS Azure" уровня "Стандартный" определяет и устраняет атаки DDoS без вмешательства пользователя. Чтобы получать уведомления при наличии активного устранения проблем с защищенным общедоступным IP-адресом, можно [настроить оповещение](../../ddos-protection/manage-ddos-protection.md) для метрики **в разделе от атак DDoS-атака**. Вы можете создать оповещения для других метрик атак DDoS, чтобы изучить масштабирование атаки, снижающийся трафик и другие сведения.
...
* [Документация по службе "Защита от атак DDoS Azure"](../../ddos-protection/ddos-protection-overview.md)