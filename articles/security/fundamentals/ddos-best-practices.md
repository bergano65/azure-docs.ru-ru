...
![Обязанности клиента и Azure](./media/ddos-best-practices/image2.png)
...
- Если необходимо список разрешений диапазон IP-адресов или IP-адресов из стандарта Azure от атак DDoS Protection Standard. Распространенный сценарий — список разрешений IP-адрес, если трафик направляется из внешнего облачного WAF в Azure. 
