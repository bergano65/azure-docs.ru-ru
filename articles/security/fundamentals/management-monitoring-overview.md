...
Управление доступом на основе ролей Azure (Azure RBAC) обеспечивает подробное управление доступом для ресурсов Azure. С помощью Azure RBAC можно предоставить пользователям доступ только к тем ресурсам, которые необходимы им для выполнения своих заданий. С помощью Azure RBAC также можно гарантировать, что при выходе пользователей из Организации они теряют доступ к ресурсам в облаке.

Дополнительные сведения:

* [Блог группы Active Directory в Azure RBAC](https://cloudblogs.microsoft.com/enterprisemobility/?product=azure-active-directory)
...
Azure ExpressRoute позволяет переносить локальные сети в Microsoft Cloud по выделенному закрытому подключению, которое обеспечивается поставщиком услуг подключения. С помощью ExpressRoute можно устанавливать подключения к облачным службам Майкрософт, таким как Azure, Microsoft 365 и CRM Online. Возможно исходящее подключение с помощью:
...
Центр безопасности Azure позволяет предотвращать, обнаруживать угрозы и реагировать на них. Центр безопасности предоставляет Вам улучшенную видимость и контроль безопасности ресурсов Azure, а также в гибридной облачной среде. 

Центр безопасности выполняет непрерывную оценку безопасности подключенных ресурсов и сравнивает их конфигурацию и развертывание с [тестовым результатом безопасности Azure](../benchmarks/introduction.md) , чтобы предоставить подробные рекомендации по безопасности для вашей среды.
...
- Вы можете определить политики для ресурсов подписки Azure в соответствии с:
    - Требования к безопасности вашей организации.
    - типом приложений или конфиденциальностью данных в каждой подписке.
    - Любые отраслевые или нормативные стандарты или тесты производительности, применяемые к подпискам. 
