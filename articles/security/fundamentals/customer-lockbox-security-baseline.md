...
* [Журналы аудита для защищенное хранилище](https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview#auditing-logs)
...
* [Журналы аудита в защищенное хранилище](https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview#auditing-logs)
...
**Руководство**. поддержание инвентаризации учетных записей пользователей, имеющих административный доступ к запросам на защищенное хранилище. Вы можете использовать область управления доступом и удостоверениями (IAM) в портал Azure для подписки, чтобы настроить управление доступом на основе ролей (RBAC). Роли применяются к пользователям, группам, субъектам-службам и управляемым удостоверениям в Azure Active Directory.
...
* [Настройка RBAC для книг](https://docs.microsoft.com/azure/sentinel/quickstart-get-visibility)

* [Общие сведения о разрешениях запросов доступа в защищенное хранилище](https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview)
...
* [Создание и настройка экземпляра Azure Active Directory](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-access-create-new-tenant)
...
* [Общие сведения о Azure Active Directory отчетов](https://docs.microsoft.com/azure/active-directory/reports-monitoring/)

* [Использование проверок доступа Azure Active Directory](https://docs.microsoft.com/azure/active-directory/governance/access-reviews-overview)
...
* [Просмотр Azure Active Directory опасного входа в систему](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-risky-sign-ins)
...
* [Общие сведения о рабочем процессе защищенное хранилище](https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview)
...
**Рекомендации**. Неприменимо. Эта рекомендация предназначена для вычислительных ресурсов. Майкрософт управляет базовой инфраструктурой для защищенное хранилище и реализует четкие элементы управления для предотвращения потери или раскрытия данных клиента.
...
* [Включение аудита в защищенное хранилище](https://docs.microsoft.com/azure/security/fundamentals/customer-lockbox-overview)
...
* [Общие сведения об элементах управления доступом на основе ролей в Azure](https://docs.microsoft.com/azure/role-based-access-control/overview)
