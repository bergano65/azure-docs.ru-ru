---
title: Документация по основам безопасности в Azure
description: Сведения о системе безопасности Azure.
services: security
author: arob98
manager: angrobe
layout: LandingPage
...
ms.locfileid: "72792365"
---
# <a name="azure-security-fundamentals-documentation"></a>Документация по основам безопасности в Azure

Сведения о системе безопасности Azure.
        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Разработка и развертывание безопасных приложений</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">Рекомендации по безопасной разработке</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-network-security">Защита сети Azure</a>
                            </li>
                            <li style="list-style: none;">
