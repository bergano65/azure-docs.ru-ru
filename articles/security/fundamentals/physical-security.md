---
title: Физическая безопасность центров обработки данных Azure - Microsoft Azure Документы Майкрософт
description: В статье описывается, что делает корпорация Майкрософт для обеспечения безопасности центров обработки данных Azure, включая физическую инфраструктуру, безопасность и предложения соответствия требованиям.
services: security
...
В этой статье описывается, что делает корпорация Майкрософт для обеспечения безопасности инфраструктуры Azure.
...
Инфраструктура создана для размещения приложений ближе к пользователям в разных уголках мира и хранения данных в локальных расположениях, а также гарантирует максимальную устойчивость и соответствие требованиям. Azure имеет 52 региона по всему миру и доступен в 140 странах/регионах.
