...
**Сведения**. Отслеживайте [пользователей с рисками](/azure/active-directory/reports-monitoring/concept-user-at-risk) и [рискованными входами](../../active-directory/reports-monitoring/concept-risk-events.md) с помощью отчетов безопасности Azure AD.
...
**Сведения**. [Включите ИНТЕГРАЦИЮ ATP в защитнике Майкрософт](../../security-center/security-center-wdatp.md#enable-microsoft-defender-atp-integration) с помощью политики безопасности центра безопасности. Попробуйте использовать метку Azure для обнаружения угроз и реагирования на инциденты.
