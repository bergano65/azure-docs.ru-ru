...
description: Сведения о целостности инфраструктуры Azure и действиях, которые корпорация Майкрософт предпринимает для защиты ИТ, например поиск вирусов в сборках программных компонентов.
services: security
