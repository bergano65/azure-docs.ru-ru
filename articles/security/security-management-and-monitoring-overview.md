---
title: Управление и мониторинг функции безопасности, Microsoft Azure | Документация Майкрософт
...
* [Приступая к работе с управлением привилегированными пользователями Azure AD](../active-directory/privileged-identity-management/pim-getting-started.md)
...
Intelligent Security Graph в реальном времени предоставляет защиту от угроз в продуктах и службах Майкрософт. Используя расширенную аналитику, основанную на больших объемах данных об угрозах и сведениях о безопасности, решение предоставляет ценную аналитическую информацию, которая может помочь повысить уровень безопасности в организации. Майкрософт использует расширенную аналитику. Мы ежемесячно обрабатываем свыше 450 миллиардов операций аутентификации, обновляем миллиард устройств и проверяем 400 миллиардов сообщений электронной почты на предмет вредоносного ПО и фишинга. Все это позволяет нам предоставлять максимально подробные сведения, которые могут помочь вашей организации обнаруживать атаки и быстро на них реагировать.
