...
description: В статье описывается, что корпорация Майкрософт для защиты центров обработки данных Azure, включая физической инфраструктуры, безопасности и соответствия предложения.
services: security
...
ms.locfileid: "64939833"
---
# <a name="azure-facilities-premises-and-physical-security"></a>Объекты, локальная среда и физическая безопасность в Azure
В этой статье описывается, предпринимаемые Майкрософт для защиты инфраструктуры Azure.

## <a name="datacenter-infrastructure"></a>Инфраструктуру центров обработки данных
...
Инфраструктура создана для размещения приложений ближе к пользователям в разных уголках мира и хранения данных в локальных расположениях, а также гарантирует максимальную устойчивость и соответствие требованиям. Azure имеет 52 регионах по всему миру, а также доступна в 140 странах и регионах.
