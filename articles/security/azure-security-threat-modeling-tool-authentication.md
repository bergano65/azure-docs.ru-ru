...
| **Справочные материалы**              | Н/д, [Интернета вещей Azure с помощью .NET](https://azure.microsoft.com/documentation/articles/iot-hub-csharp-csharp-getstarted/), [Приступая к работе с центром Интернета вещей и Node JS](https://azure.microsoft.com/documentation/articles/iot-hub-node-node-getstarted), [защита Интернета вещей с помощью SAS и сертификаты](https://azure.microsoft.com/documentation/articles/iot-hub-sas-tokens/), [репозитория Git](https://github.com/Azure/azure-iot-sdks/tree/master/node) |
