...
* Требования к агенту сквозной проверки подлинности, с помощью двух агентов для обеспечения избыточности:
