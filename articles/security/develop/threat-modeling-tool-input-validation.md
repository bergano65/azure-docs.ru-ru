...
description: Дополнительные сведения о проверке входных данных в Threat Modeling Tool. См. сведения об устранении рисков и просмотр примеров кода.
services: security
...
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Безопасность XSLT](/previous-versions/windows/desktop/ms763800(v=vs.85)), [XsltSettings.EnableScript Property](/dotnet/api/system.xml.xsl.xsltsettings.enablescript) (Свойство XsltSettings.EnableScript) |
| **Шаги** | XSLT поддерживает использование скриптов в таблицах стилей с применением элемента `<msxml:script>`. Таким образом пользовательские функции можно задействовать в преобразовании XSLT. Сценарий выполняется в контексте процесса, выполняющего преобразование. При работе в ненадежной среде скрипт XSLT нужно отключить, чтобы предотвратить выполнение ненадежного кода. *При использовании .NET* скрипты XSLT отключены по умолчанию.Но необходимо убедиться, что они не были явно включены в свойстве `XsltSettings.EnableScript`.|
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [IE8 Security Part V — Comprehensive Protection](/archive/blogs/ie/ie8-security-part-v-comprehensive-protection) (Безопасность IE8, часть 5: комплексная защита)  |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [XML Entity Expansion](https://capec.mitre.org/data/definitions/197.html) (Расширения сущностей XML), [XML Denial of Service Attacks and Defenses](/archive/msdn-magazine/2009/november/xml-denial-of-service-attacks-and-defenses) (XML: атаки типа "отказ в обслуживании" и способы защиты от них), [Общие сведения о безопасности MSXML](/previous-versions/windows/desktop/ms754611(v=vs.85)), [Рекомендации по обеспечению безопасности кода MSXML](/previous-versions/windows/desktop/ms759188(v=vs.85)), [NSXMLParserDelegate Protocol Reference](https://developer.apple.com/library/ios/#documentation/cocoa/reference/NSXMLParserDelegate_Protocol/Reference/Reference.html) (Справочник по протоколу NSXMLParserDelegate), [Разрешение внешних ресурсов](/dotnet/standard/data/xml/resolving-external-resources) |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Unrestricted File Upload](https://owasp.org/www-community/vulnerabilities/Unrestricted_File_Upload) (Неограниченная передача файлов), [File Signature Table](https://www.garykessler.net/library/file_sigs.html) (Таблица подписей файлов) |
...
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Adding Validation](https://www.asp.net/mvc/overview/getting-started/introduction/adding-validation) (Добавление проверки), [Validating Model Data in an MVC Application](/previous-versions/dd410404(v=vs.90)) (Проверка данных модели в приложении MVC), [Основные принципы ваших приложений ASP.NET MVC](/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
| **Шаги** | <p>Перед использованием в приложении все входные параметры нужно проверять, чтобы убедиться, что приложение защищено от вредоносных входных данных. Проверка входных значений с помощью проверки регулярных выражений на стороне сервера с применением стратегии проверки списка разрешенных. Если передать в метод непроверенные входные данные или параметры, приложение подвергается риску атаки путем внедрения кода.</p><p>Точки входа для веб-приложений также включают поля форм, строки запросов, файлы cookie, заголовки HTTP и параметры веб-службы.</p><p>После привязки модели необходимо выполнить следующие проверки входных данных:</p><ul><li>Свойства модели нужно пометить с помощью аннотации RegularExpression, чтобы принимались допустимые знаки, а также применялась максимально допустимая длина.</li><li>Методы контроллера должны выполнить проверку ModelState.</li></ul>|

## <a name="sanitization-should-be-applied-on-form-fields-that-accept-all-characters-eg-rich-text-editor"></a><a id="richtext"></a>Очищайте поля форм, принимающие все знаки, например редактор форматированного текста
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Кодирование небезопасных входных данных](/previous-versions/msp-n-p/ff647397(v=pandp.10)#paght000003_step3), [HTML Sanitizer](https://github.com/mganss/HtmlSanitizer) (Библиотека HtmlSanitizer) |
...
| **Применимые технологии** | Универсальные, MVC 5, MVC 6 |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Validating Model Data in an MVC Application](/previous-versions/dd410404(v=vs.90)) (Проверка данных модели в приложении MVC), [Основные принципы ваших приложений ASP.NET MVC](/archive/msdn-magazine/2009/brownfield/extreme-asp-net-guiding-principles-for-your-asp-net-mvc-applications) |
...
| **Применимые технологии** | Универсальные, веб-формы, MVC 5, MVC 6  |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Свойство DefaultRegexMatchTimeout](/dotnet/api/system.web.configuration.httpruntimesection.defaultregexmatchtimeout) |
...
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [MSDN](/previous-versions/msp-n-p/ff647820(v=pandp.10)) |
...
| **Применимые технологии** | Универсальные, .NET Framework 3 |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [MSDN](/previous-versions/msp-n-p/ff647875(v=pandp.10)) |
