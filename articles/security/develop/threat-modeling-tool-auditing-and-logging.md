...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Н/Д  |
| **Справочные материалы**              | [Настройка аудита входа](https://msdn.microsoft.com/library/ms175850.aspx) |
...
| **Справочные материалы**              | [Приступая к работе с обнаружением угроз базы данных SQL](https://azure.microsoft.com/documentation/articles/sql-database-threat-detection-get-started/)|
