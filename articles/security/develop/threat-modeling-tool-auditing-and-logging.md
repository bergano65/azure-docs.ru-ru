...
| **Ссылки**              | [Приступая к работе с обнаружением угроз базы данных SQL](https://azure.microsoft.com/documentation/articles/sql-database-threat-detection-get-started/)|
