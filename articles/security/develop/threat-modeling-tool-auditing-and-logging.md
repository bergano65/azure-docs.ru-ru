...
| --------------- | ------- |
| **Dynamics CRM**    | <ul><li>[Определение чувствительных сущностей в вашем решении и реализация аудита изменений](#sensitive-entities)</li></ul> |
| **Веб-приложение** | <ul><li>[Обеспечить соблюдение аудиторской проверки и ведения журнала в приложении](#auditing)</li><li>[Убедитесь, что вращение журналов и разделение на месте](#log-rotation)</li><li>[Проверка запрета записи в журнал приложением конфиденциальных сведений о пользователях](#log-sensitive-data)</li><li>[Проверка ограниченного доступа к функциям аудита и ведения журнала](#log-restricted-access)</li><li>[Проверка записи в журнал событий управления пользователями](#user-management)</li><li>[Проверка наличия в системе встроенных защит от несанкционированного использования](#inbuilt-defenses)</li><li>[Включение ведения журнала диагностики для веб-приложений в службе приложений Azure](#diagnostics-logging)</li></ul> |
| **Базы данных** | <ul><li>[Проверка включения на сервере SQL Server аудита входа в систему](#identify-sensitive-entities)</li><li>[Включение обнаружения угроз в Azure SQL](#threat-detection)</li></ul> |
...
| **Веб-API** | <ul><li>[Проверка принудительного применения аудита и ведения журнала в веб-API](#logging-web-api)</li></ul> |
...
| **Облачный шлюз Интернета вещей** | <ul><li>[Обеспечить соблюдение надлежащего аудита и ведения журнала на Cloud Gateway](#logging-cloud-gateway)</li></ul> |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Ссылки**              | [Настройка аудита входа](https://msdn.microsoft.com/library/ms175850.aspx) |
...
| **Ссылки**              | [Начало работы с обнаружением угроз базы данных s'L](https://azure.microsoft.com/documentation/articles/sql-database-threat-detection-get-started/)|
...
| **Атрибуты**              | Недоступно  |
| **Ссылки**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [Fortify Kingdom](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_logging) |
...
| **Применимые технологии** | .NET Framework |
| **Атрибуты**              | Недоступно  |
| **Ссылки**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [Fortify Kingdom](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_audit_failure_handling) |
