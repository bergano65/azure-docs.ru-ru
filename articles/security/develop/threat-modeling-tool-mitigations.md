...
| **[Безопасность связи](threat-modeling-tool-communication-security.md)** | С кем вы общаетесь? Безопасность обмена данными обеспечивает максимально возможную защиту связи. |
