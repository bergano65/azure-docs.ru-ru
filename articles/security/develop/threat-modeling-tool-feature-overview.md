...
![На снимке экрана показан соединитель модели угроз, не подключенный к элементам, с сообщением о том, что эта проблема возникает.](./media/threat-modeling-tool-feature-overview/messages.png)
