...
| **Просмотр** | <ul><li>Переключение между представлениями **Analysis** (Анализ) и **Design** (Конструктор).</li><li>Открытие закрытых окон (например, наборы элементов, свойства элемента и сообщения).</li><li>Восстановление параметров макета по умолчанию.</li></ul> |
...
![Обратная связь](./media/threat-modeling-tool-feature-overview/feedback.png)
...
![Отчет](./media/threat-modeling-tool-feature-overview/report.png)
