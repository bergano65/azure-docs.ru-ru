...
| **Базы данных** | <ul><li>[Настройка брандмауэра Windows для доступа к движке данных](#firewall-db)</li></ul> |
| **Веб-API** | <ul><li>[Настройте доступ к веб-API ASP.NET с включенной технологией CORS только из доверенных источников](#cors-api)</li><li>[Шифруйте разделы файлов конфигурации веб-API, содержащие конфиденциальные данные](#config-sensitive)</li></ul> |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Ссылки**              | [Фильтр защиты от межсайтовых сценариев](https://www.owasp.org/index.php/List_of_useful_HTTP_headers#X-XSS-Protection) |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Ссылки**              | [OWASP кликов jacking обороны Cheat лист](https://www.owasp.org/index.php/Clickjacking_Defense_Cheat_Sheet), [IE Внутренние - Борьба нажмите-джекинг с X-Frame-Опции](https://blogs.msdn.microsoft.com/ieinternals/2010/03/30/combating-clickjacking-with-x-frame-options/) |
