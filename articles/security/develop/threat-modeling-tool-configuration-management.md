...
| **Служба хранилища Azure** | <ul><li>[Обеспечьте безопасное управление ключами доступа к хранилищу Azure](#secure-keys)</li><li>[Настройте доступ к службе хранилища Azure с включенной технологией CORS только из доверенных источников](#cors-storage)</li></ul> |
