...
Если вам нужна дополнительная помощь, поддержка анализа кода безопасности Майкрософт доступна с понедельника по пятницу с 9:00 до 5:00 по тихоокеанскому времени.
  ...
  - Подключение: обратитесь к менеджерам по технической поддержке, чтобы приступить к работе.
  
  - Поддержка. Отправьте нашу команду по электронной почте в [службу Microsoft Security Code Analysis](mailto:mscahelp@microsoft.com?Subject=Microsoft%20Security%20Code%20Analysis%20Support%20Request).
