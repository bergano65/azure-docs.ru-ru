...
Чтобы получить последние версии компилятора C#, перейдите по адресу [Microsoft.NET. compilers](https://www.nuget.org/packages/Microsoft.Net.Compilers). Чтобы получить установленную версию, запустите **файл csc. exe/Version** из командной строки. Убедитесь, что вы ссылаетесь на пакет NuGet Microsoft.Net. compilers версии 2,6 или более поздней.
