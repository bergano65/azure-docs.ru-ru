...
| **концентратору событий Azure** | <ul><li>[Используйте учетные данные проверки подлинности на уровне отдельного устройства с помощью маркеров SaS](#authn-sas-tokens)</li></ul> |
...
| **Ссылки**              | [Подключение к базе данных SQL с использованием аутентификации Azure Active Directory](https://azure.microsoft.com/documentation/articles/sql-database-aad-authentication/) |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Ссылки**              | [SQL Server политики паролей](https://technet.microsoft.com/library/ms161959(v=sql.110).aspx) |
...
| **Ссылки**              | [Рекомендации по обеспечению безопасности автономных баз данных](https://msdn.microsoft.com/library/ff929055.aspx) |
