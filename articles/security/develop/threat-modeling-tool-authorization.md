...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Иерархия разрешений SQL](/sql/relational-databases/security/permissions-hierarchy-database-engine), [защищаемые объекты SQL](/sql/relational-databases/security/securables) |
...
| **Справочные материалы**              | [Безопасность на уровне строк](/sql/relational-databases/security/row-level-security) |
...
Обратите внимание, что RLS как встроенная функция базы данных применима только к SQL Server начиная с 2016, с помощью базы данных SQL Azure и Управляемый экземпляр SQL. Если готовая функция RLS не реализована, необходимо ограничить доступ к данным с помощью представлений и процедур.
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Использование назначений ролей для управления доступом к ресурсам в подписке Azure](../../role-based-access-control/role-assignments-portal.md)  |
...
| **Справочные материалы**              | [Контроль доступа на основе ролей для клиентов Service Fabric](../../service-fabric/service-fabric-cluster-security-roles.md) |
...
| **Справочные материалы**              | [Руководство по безопасности службы хранилища Azure. Делегирование доступа к объектам в учетной записи с помощью подписанных URL-адресов и хранимых политик доступа](../../storage/blobs/security-recommendations.md#identity-and-access-management) |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Защита учетной записи хранения с помощью управления доступом на основе ролей (RBAC)](../../storage/blobs/security-recommendations.md) |
...
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [MSDN](/previous-versions/msp-n-p/ff648500(v=pandp.10)), [Fortify Kingdom](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_weak_class_reference) |
