...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Иерархия разрешений SQL](https://docs.microsoft.com/sql/relational-databases/security/permissions-hierarchy-database-engine), [защищаемые объекты SQL](https://docs.microsoft.com/sql/relational-databases/security/securables) |
...
| **Справочные материалы**              | [Управление доступом к центру Интернета вещей](https://azure.microsoft.com/documentation/articles/iot-hub-devguide/#Security) |
