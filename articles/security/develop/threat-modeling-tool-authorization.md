...
| **Граница доверия Azure** | <ul><li>[Обеспечение детального управления доступом к подписке Azure с помощью Azure RBAC](#grained-rbac)</li></ul> |
| **Граница доверия Service Fabric** | <ul><li>[Ограничение доступа клиента к операциям кластера с помощью Azure RBAC](#cluster-rbac)</li></ul> |
...
| **Хранилище Azure** | <ul><li>[Предоставьте детальное разрешение диапазону сущностей в хранилище таблиц Azure](#permission-entities)</li><li>[Включение управления доступом на основе ролей Azure (Azure RBAC) в учетную запись хранения Azure с помощью Azure Resource Manager](#rbac-azure-manager)</li></ul> |
...
## <a name="enable-azure-role-based-access-control-azure-rbac-to-azure-storage-account-using-azure-resource-manager"></a><a id="rbac-azure-manager"></a>Включение управления доступом на основе ролей Azure (Azure RBAC) в учетную запись хранения Azure с помощью Azure Resource Manager
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Как защитить учетную запись хранения с помощью управления доступом на основе ролей в Azure (Azure RBAC)](../../storage/blobs/security-recommendations.md) |
