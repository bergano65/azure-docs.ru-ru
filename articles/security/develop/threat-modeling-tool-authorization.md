...
| Заголовок                   | Подробнее      |
| ----------------------- | ------------ |
| **Компонент**               | Концентратор событий Azure | 
| **Этап SDL**               | Сборка |  
| **Применимые технологии** | Универсальный |
| **Атрибуты**              | Н/Д  |
...
| **Действия** | В некоторых бизнес-сценариях для хранения конфиденциальных данных, предназначенных для различных сторон, может потребоваться хранилище таблиц Azure. Например конфиденциальные данные, относящиеся к разным странам и регионам. В таких случаях сигнатуры SAS можно создать, указав диапазоны ключей секций и строк, чтобы пользователь мог получить доступ к данным, относящимся к конкретной стране или региону.| 
