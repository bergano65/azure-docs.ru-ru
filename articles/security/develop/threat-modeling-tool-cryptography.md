...
| **Ссылки**              | [Always Encrypted (ядро СУБД)](https://msdn.microsoft.com/library/mt163865) |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Ссылки**              | [Сервер удостоверений — ключи, подписи и шифрование](https://identityserver.github.io/Documentation/docsv2/configuration/crypto.html) |
