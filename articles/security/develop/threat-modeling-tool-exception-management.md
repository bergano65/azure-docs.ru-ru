...
---
# <a name="security-frame-exception-management--mitigations"></a>Механизм безопасности. Управление исключениями | Способы их устранения 
...
| **Веб-приложение** | <ul><li>[Не предоставляйте сведения о безопасности в сообщениях об ошибках](#messages)</li><li>[Реализация страницы обработки ошибок по умолчанию](#default)</li><li>[Настройте метод развертывания retail в IIS](#deployment)</li><li>[Обеспечьте безопасную обработку исключений](#fail)</li></ul> |
