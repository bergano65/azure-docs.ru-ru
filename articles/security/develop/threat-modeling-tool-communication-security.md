...
| **Справочные материалы**              | [Включение зашифрованных соединений для ядра СУБД](https://msdn.microsoft.com/library/ms191192)  |
| **Шаги** | Шифрование SSL повышает безопасность передачи данных по сетям между экземплярами SQL Server и приложениями. |
