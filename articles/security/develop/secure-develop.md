...
Список блокировок может вызывать ошибки, поскольку невозможно составить исчерпывающий список потенциально недопустимых входных данных.
