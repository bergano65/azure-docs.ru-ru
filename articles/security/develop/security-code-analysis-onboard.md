...
>[!NOTE]
>Если у вас нет контракта на поддержку, мы также работаем с программой-партнером по покупке, где вы можете использовать сторонних партнеров для приобретения расширения без необходимости приобретать единый план поддержки. Отправьте отзыв по [электронной почте](mailto:mscahelp@microsoft.com?Subject=Microsoft%20Security%20Code%20Analysis%20Onboarding%20Request). чтобы сообщить нам о том, что вы заинтересованы в этом варианте. Мы относимся к Вашему интересу и вернемся к вам, как только этот вариант станет доступен.
