...
| ---------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Спуфинг               | Аутентификация        | [Требовать подключения по протоколу HTTPS](https://docs.microsoft.com/aspnet/core/security/enforcing-ssl?view=aspnetcore-2.1&tabs=visual-studio). |
...
| Повышение прав | Авторизация         | Используйте Azure Active Directory <span class="underline"></span> [Управление привилегированными пользователями](../../active-directory/privileged-identity-management/pim-configure.md).|
