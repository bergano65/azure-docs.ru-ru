...
Реализуйте JIT *-* доступ для дальнейшего снижения времени предоставления привилегий. Используйте [Azure AD privileged Identity Management](../../active-directory/users-groups-roles/directory-admin-roles-secure.md#stage-3-take-control-of-admin-activity) , чтобы:
