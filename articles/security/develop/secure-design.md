...
| Отказ            | Невозможность отказа       | Включите [мониторинг и диагностику](https://docs.microsoft.com/azure/architecture/best-practices/monitoring) в Azure.|
