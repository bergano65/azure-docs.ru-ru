...
| Повышение привилегий | Авторизация         | Используйте Azure Active Directory <span class="underline"> </span> [Управление привилегированными пользователями](../../active-directory/privileged-identity-management/pim-configure.md).|
