...
Сведения о настройке YAML для этой задачи см. в [статье параметры обнаружения угроз Microsoft Security угроза YAML](yaml-configuration.md#microsoft-security-risk-detection-task)
