...
Доступны следующие варианты:
  ...
  - **Параметры** > управления**выполнением этой задачи**: указывает, когда будет выполняться задача. Выберите **пользовательские условия** , чтобы указать более сложные условия.
