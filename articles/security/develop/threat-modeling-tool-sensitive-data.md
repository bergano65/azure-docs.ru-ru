...
| --------------- | ------- |
| **Отношения доверия между компьютерами** | <ul><li>[Обеспечьте маскировку двоичных файлов, если они содержат конфиденциальную информацию](#binaries-info)</li><li>[Используйте шифрование на уровне файловой системы (EFS) для защиты конфиденциальных данных пользователя](#efs-user)</li><li>[Настройте шифрование конфиденциальных данных, сохраняемых приложением в файловой системе](#filesystem)</li></ul> | 
...
| **Граница доверия виртуальной машины IaaS Azure** | <ul><li>[Использование шифрования дисков Azure для шифрования дисков, используемых виртуальными машинами](#disk-vm)</li></ul> | 
| **Граница доверия Service Fabric** | <ul><li>[Шифрование секретов в Service Fabric приложениях](#fabric-apps)</li></ul> | 
...
| **Мобильный клиент** | <ul><li>[Шифруйте конфиденциальные данные или личные данные, записываемые в локальное хранилище телефонов](#pii-phones)</li><li>[Маскировка созданных двоичных файлов перед распространением конечным пользователям](#binaries-end)</li></ul> | 
| **WCF** | <ul><li>[Присвоить clientCredentialType сертификату или Windows](#cert)</li><li>[Не включен режим безопасности WCF](#security)</li></ul> | 
...
| **Этап SDL**               | Deployment (Развертывание) |  
...
| **Атрибуты**              | Недоступно  |
| **Ссылки**              | Недоступно  |
| **Шаги** | Браузеры могут сохранять информацию для кэширования и ведения истории. Эти кэшированные файлы хранятся в папке, подобной папке временных файлов Интернета в Internet Explorer. При повторном обращении к страницам браузер отображает их из кэша. Если конфиденциальная информация отображается пользователю (например, к адресу, сведениям о кредитной карте, номеру социального страхования или имени пользователя), то эта информация может храниться в кэше браузера и, следовательно, извлекаться путем проверки кэша браузера или путем простого нажатия кнопки "назад" в браузере. Задайте для заголовка ответа Control Cache значение "No-Store" для всех страниц. |
...
| **Ссылки**              | [динамическое маскирование данных](https://msdn.microsoft.com/library/mt130841) |
