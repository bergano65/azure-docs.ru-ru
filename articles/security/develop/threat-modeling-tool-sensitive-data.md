...
description: Сведения об устранении конфиденциальных данных в Threat Modeling Tool. См. сведения об устранении рисков и просмотр примеров кода.
services: security
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Сведения об атрибуте autocomplete на сайте MSDN](https://msdn.microsoft.com/library/ms533486(VS.85).aspx), [использование функции автозаполнение в формах HTML](/previous-versions/windows/internet-explorer/ie-developer/), [Бюллетень по безопасности (Майкрософт) MS10-071 — критическое](/security-updates/SecurityBulletins/2010/ms10-071), [запись блога о функции автозаполнения](https://blog.mindedsecurity.com/2011/10/autocompleteagain.html) |
...
| **Справочные материалы**              | [Маскирование динамических данных](/sql/relational-databases/security/dynamic-data-masking) |
...
| **Справочные материалы**              | [Контрольный список. Шифрование конфиденциальных данных](/previous-versions/sql/sql-server-2008-r2/ff848751(v=sql.105)), [Шифрование столбца данных](/sql/relational-databases/security/encryption/encrypt-a-column-of-data), [ENCRYPTBYCERT (Transact-SQL)](/sql/t-sql/functions/encryptbycert-transact-sql) |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Основные сведения о прозрачном шифровании данных (TDE)](/previous-versions/sql/sql-server-2008-r2/bb934049(v=sql.105)) |
...
| **Справочные материалы**              | [Шифрование резервной копии](/sql/relational-databases/backup-restore/backup-encryption) |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Руководство по безопасности службы хранилища Azure. Применение шифрования дисков Azure для шифрования дисков, используемых виртуальными машинами](../../storage/blobs/security-recommendations.md#data-protection) |
...
| **Справочные материалы**              | [Управление секретами в приложениях Service Fabric](../../service-fabric/service-fabric-application-secret-management.md) |
...
| **Справочные материалы**              | [Шифрование службы хранилища Azure для неактивных данных (предварительная версия)](../../storage/common/storage-service-encryption.md) |
...
| **Применимые технологии** | Универсальный шаблон |
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Шифрование на стороне клиента для службы хранилища Microsoft Azure](../../storage/common/storage-client-side-encryption.md), [Шифрование и расшифровка BLOB-объектов в хранилище Microsoft Azure с помощью хранилища ключей Azure](../../storage/blobs/storage-encrypt-decrypt-blobs-key-vault.md), [запись блога о безопасном хранении данных в хранилище BLOB-объектов Azure с расширениями шифрования Azure](/archive/blogs/partnercatalystteam/storing-data-securely-in-azure-blob-storage-with-azure-encryption-extensions) |
...
| **Атрибуты**              | Недоступно  |
| **Справочные материалы**              | [Создание политики конфигурации](/mem/intune/configuration/), [сведения об обслуживании цепочки ключей](https://components.xamarin.com/view/square.valet) |
...
| **Справочные материалы**              | [MSDN](/previous-versions/msp-n-p/ff648500(v=pandp.10)), [Fortify Kingdom](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_weak_class_reference), [основы безопасности WCF](https://www.codemag.com/article/0611051) |
