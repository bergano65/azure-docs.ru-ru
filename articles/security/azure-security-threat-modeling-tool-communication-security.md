...
| **Фабрика данных Azure** | <ul><li>[Используйте шлюз управления данными при подключении локального сервера SQL с фабрикой данных Azure](#sqlserver-factory)</li></ul> |
...
## <a id="sqlserver-factory"></a>Используйте шлюз управления данными при подключении локального сервера SQL с фабрикой данных Azure
...
| **Применимые технологии** | Универсальный |
| **Атрибуты**              | Типы связанной службы — Azure и локальные |
| **Справочные материалы**              |[Перемещение данных между локальными и фабрики данных Azure](https://azure.microsoft.com/documentation/articles/data-factory-move-data-between-onprem-and-cloud/#create-gateway), [шлюз управления данными](https://azure.microsoft.com/documentation/articles/data-factory-data-management-gateway/) |
