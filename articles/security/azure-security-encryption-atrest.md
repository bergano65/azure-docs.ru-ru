...
| Управляемый экземпляр Базы данных SQL Azure | Yes                | 2048-разрядный RSA (предварительная версия)  | Yes                |
...
| HDInsight (хранилище BLOB-объектов Azure)   | Yes                | -                  | -                  |
| HDInsight (Data Lake Storage)    | Yes                | -                  | -                  |
| Apache Kafka для HDInsight       | Yes                | Предварительная версия, все размеры ключа RSA | -                  |
| Хранилище озера данных Azure            | Yes                | Да, 2048-разрядный RSA  | -                  |
