...
| Виртуальные машины                 | -                  | Да, 2048-разрядный RSA  | -                  |
| Набор масштабирования виртуальной машины        | -                  | Да, 2048-разрядный RSA  | -                  |
| **Базы данных**                    |                    |                    |                    |
| SQL Server на виртуальных машинах   | Да                | Да, 2048-разрядный RSA  | Да                |
| Базы данных SQL Azure               | Да                | Да, 2048-разрядный RSA  | Да                |
