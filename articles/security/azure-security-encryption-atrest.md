...
Все службы хранилища Azure (хранилище BLOB-объектов, хранилище очередей, хранилище таблиц и служба файлов Azure) поддерживают шифрование неактивных данных на стороне сервера, а некоторые службы поддерживают управляемые клиентом ключи и шифрования на стороне клиента.  
...
Поддержка шифрования на стороне сервера в настоящее время предоставляется с помощью функции SQL, которая называется прозрачным шифрованием данных. Как только пользователь базы данных SQL Azure активирует прозрачное шифрование данных, эта функция будет автоматически создавать ключи и управлять ими. Шифрование неактивных данных можно включить на уровне базы данных и на уровне сервера. Начиная с июня 2017 г. [прозрачное шифрование данных (TDE)](https://msdn.microsoft.com/library/bb934049.aspx) включается по умолчанию для всех новых баз данных. База данных SQL Azure поддерживает управляемые клиентом 2048-битные ключи RSA в Azure Key Vault. Дополнительные сведения см. в статье [Прозрачное шифрование данных с поддержкой использования собственных ключей для базы данных и хранилища данных SQL Azure](https://docs.microsoft.com/sql/relational-databases/security/encryption/transparent-data-encryption-byok-azure-sql?view=azuresqldb-current).
...
| SQL Server (IaaS)                | Да                | Да, 2048-разрядный RSA  | Да                |
| SQL Azure (база данных/хранилище данных) | Да                | Да, 2048-разрядный RSA  | Да                |
| Управляемый экземпляр Базы данных SQL Azure | Да                | 2048-разрядный RSA (предварительная версия)  | Да                |
| Хранилище Azure (блочные и страничные BLOB-объекты) | Да                | Да, 2048-разрядный RSA  | Да                |
| Хранилище Azure (файлы)            | Да                | Да, 2048-разрядный RSA  | -                  |
| Хранилище Azure (таблицы, очереди)   | Да                | -                  | Да                |
...
| HDInsight (хранилище BLOB-объектов Azure)   | Да                | -                  | -                  |
| HDInsight (Data Lake Storage)    | Да                | -                  | -                  |
| Apache Kafka для HDInsight       | Да                | Предварительная версия, все размеры ключа RSA | -                  |
