...
- Ключи должны храниться в безопасном месте с политиками управления доступом, ограничивающими доступ для определенных удостоверений и регистрирующими сведения об использовании ключей. Ключи шифрования данных часто шифруются с помощью асимметричного шифрования для дальнейшего ограничения доступа.
...
|----------------------------------|--------------------|--------------------|--------------------|--------------------|
|                                  | **На стороне сервера с помощью управляемого службой ключа**     | **На стороне сервера с помощью управляемого клиентом ключа в Key Vault**             |  **На стороне сервера с помощью управляемого клиентом ключа в локальной среде**                  | **На стороне клиента с помощью управляемого клиентом ключа**      |
