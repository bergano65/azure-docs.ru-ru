...
Чтобы узнать больше о том, как настроить хранилище ключей, ознакомьтесь со статьей об [ Azure Key Vault](https://docs.microsoft.com/azure/key-vault/key-vault-get-started).
...
- [Контрольный список для обеспечения безопасности Azure Service Fabric](azure-service-fabric-security-checklist.md)
