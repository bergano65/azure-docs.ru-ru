---
title: Базы данных рекомендации по обеспечению безопасности — Microsoft Azure
...
## <a name="enable-feature-restrictions"></a>Включение функциональных ограничений

Данные, содержащиеся в базах данных могут предоставляться для злоумышленников, с помощью атак, использующих ошибки базы данных и выполнения запросов. База данных SQL Azure предоставляет несколько механизмов функции ограниченного использования программ для защиты базы данных. Дополнительные сведения см. в разделе [функциональные ограничения базы данных SQL](../sql-database/sql-database-feature-restrictions.md).
