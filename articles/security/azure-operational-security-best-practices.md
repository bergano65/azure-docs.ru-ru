...
**Сведения**. Для службы приложений Azure выберите [план служб приложений](../app-service/overview-hosting-plans.md), где есть несколько экземпляров.
