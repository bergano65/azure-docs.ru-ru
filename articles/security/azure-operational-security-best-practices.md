...
**Сведения**. Выполняйте облачные [нагрузочные тесты](https://www.visualstudio.com/docs/test/performance-testing/getting-started/getting-started-with-performance-testing) с помощью VSTS для:
