...
---
# <a name="overview-of-the-azure-security-benchmark"></a>Обзор производительности системы безопасности Azure
...
- [Управление доступом и удостоверениями](security-control-identity-access-control.md)
...
- [Тесты на проникновение и выупражнения красных команд](security-control-penetration-tests-red-team-exercises.md)
