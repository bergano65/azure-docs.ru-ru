...
- [Как просмотреть доступные псевдонимы Политики Azure](https://docs.microsoft.com/powershell/module/az.resources/get-azpolicyalias?view=azps-3.3.0)
