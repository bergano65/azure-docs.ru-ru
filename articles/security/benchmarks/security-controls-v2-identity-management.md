...
ms.locfileid: "90059415"
---
# <a name="security-control-identity-management"></a>Управление безопасностью: Управление удостоверениями
...
## <a name="id-1-standardize-azure-active-directory-as-the-central-identity-and-authentication-system"></a>ID-1: стандартизация Azure Active Directory в качестве централизованной системы идентификации и проверки подлинности

| Идентификатор Azure | ИДЕНТИФИКАТОРы элементов управления CIS v 7.1 | ИДЕНТИФИКАТОРы для директивы NIST SP800-53 |
|--|--|--|--|
| ИДЕНТИФИКАТОР 1 | 16,1, 16,2, 16,4, 16,5 | IA-2, IA-8, AC-2, AC-3 |
...
## <a name="id-2-manage-application-identities-securely-and-automatically"></a>Идентификатор 2. безопасное и автоматическое управление удостоверениями приложений

| Идентификатор Azure | ИДЕНТИФИКАТОРы элементов управления CIS v 7.1 | ИДЕНТИФИКАТОРы для директивы NIST SP800-53 |
|--|--|--|--|
| ИДЕНТИФИКАТОР 2 | Недоступно | AC-2, AC-3, IA-2, IA-4, IA-9 |
...
## <a name="id-3-use-azure-ad-single-sign-on-sso-for-application-access"></a>Идентификатор 3. Использование единого входа Azure AD (SSO) для доступа к приложениям

| Идентификатор Azure | ИДЕНТИФИКАТОРы элементов управления CIS v 7.1 | ИДЕНТИФИКАТОРы для директивы NIST SP800-53 |
|--|--|--|--|
| ИДЕНТИФИКАТОР 3 | 4.4. | IA-2, IA-4 |
...
## <a name="id-4-use-strong-authentication-controls-for-all-azure-active-directory-based-access"></a>Идентификатор-4. использование строгих средств проверки подлинности для всех Azure Active Directory доступом

| Идентификатор Azure | ИДЕНТИФИКАТОРы элементов управления CIS v 7.1 | ИДЕНТИФИКАТОРы для директивы NIST SP800-53 |
|--|--|--|--|
| ИДЕНТИФИКАТОР — 4 | 4,2, 4,4 4,5, 11,5, 12,11, 16,3 | AC-2, AC-3, IA-2, IA-4 |
...
## <a name="id-5-monitor-and-alert-on-account-anomalies"></a>Идентификатор-5: отслеживание и оповещение об аномалиях учетной записи

| Идентификатор Azure | ИДЕНТИФИКАТОРы элементов управления CIS v 7.1 | ИДЕНТИФИКАТОРы для директивы NIST SP800-53 |
|--|--|--|--|
| ИДЕНТИФИКАТОР – 5 | 4,8, 4,9, 16,12, 16,13 | AC-2, AC-3, AC-7, AU-6 |
...
## <a name="id-6-restrict-azure-resource-access-based-on-conditions"></a>ID-6: ограничение доступа к ресурсам Azure на основе условий

| Идентификатор Azure | ИДЕНТИФИКАТОРы элементов управления CIS v 7.1 | ИДЕНТИФИКАТОРы для директивы NIST SP800-53 |
|--|--|--|--|
| ИДЕНТИФИКАТОР 6 | Недоступно | AC-2, AC-3 |
...
## <a name="id-7-eliminate-unintended-credential-exposure"></a>ID-7: устранение непреднамеренной раскрытия учетных данных

| Идентификатор Azure | ИДЕНТИФИКАТОРы элементов управления CIS v 7.1 | ИДЕНТИФИКАТОРы для директивы NIST SP800-53 |
|--|--|--|--|
| ИДЕНТИФИКАТОР 7 | 18,1, 18,7 | IA-5 |

Реализуйте средство проверки учетных данных для обнаружения учетных данных в коде. Сканер учетных данных также способствует перемещению обнаруженных учетных данных в более безопасные расположения, такие как Azure Key Vault.
...
## <a name="id-8-secure-user-access-to-legacy-applications"></a>ID-8: безопасный доступ пользователей к устаревшим приложениям

| Идентификатор Azure | ИДЕНТИФИКАТОРы элементов управления CIS v 7.1 | ИДЕНТИФИКАТОРы для директивы NIST SP800-53 |
|--|--|--|--|
| ИДЕНТИФИКАТОР — 8 | 14,6 | AC-2, AC-3, SC-11 |
