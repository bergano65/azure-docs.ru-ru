...
description: Управление удостоверениями и доступом в системе безопасности
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
Сведения о том, как отслеживать действия по удостоверениям и доступу пользователей в центре безопасности Azure:
...
Как просмотреть рискованные входы в Azure AD:
