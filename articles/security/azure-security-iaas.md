...
**Сведения**. Используйте [политики Azure](../governance/policy/overview.md) для создания правил для ресурсов в вашей организации и разработайте настраиваемые политики. Примените эти политики к ресурсам, таким как [группы ресурсов](../azure-resource-manager/resource-group-overview.md). Виртуальные машины, которые относятся к группе ресурсов, наследуют ее политики.
