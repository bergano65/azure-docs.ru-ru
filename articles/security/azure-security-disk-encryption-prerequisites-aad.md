...
3. Проверьте версии установленных модулей.
      ...
      ```
4. Войдите в Azure с помощью командлета [Connect-азаккаунт](/powershell/module/az.accounts/connect-azaccount) .
...
1. При необходимости [подключитесь к подписке Azure](azure-security-disk-encryption-appendix.md#bkmk_ConnectPSH).
2. Используйте командлет PowerShell [New-азадаппликатион](/powershell/module/az.resources/new-azadapplication) , чтобы создать приложение Azure AD. Вместо MyApplicationHomePage и MyApplicationUri можно указать любые значения.
