...
[Портал Azure Active Directory](https://aad.portal.azure.com/) доступен в рамках портала Azure. На этой панели мониторинга можно получить общие сведения о состоянии вашей организации и с легкостью углубиться в управление доступом к каталогам, пользователям или приложениям.
