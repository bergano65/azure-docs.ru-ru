...
* **[Читатели каталогов](#directory-readers)** : Это роль, которая должна быть назначена только устаревшим приложениям, которые не поддерживают [инфраструктуру согласия](../develop/quickstart-v1-integrate-apps-with-azure-ad.md). Пользователи с этой ролью могут читать основные сведения о каталоге. Эта роль должна использоваться для: 1) предоставление определенному набору гостевых пользователей доступа на чтение вместо предоставления его всем гостевым пользователям. 2) предоставление определенному набору пользователей, не являющихся администраторами, доступа к порталу Azure, если параметр "ограничить доступ к порталу Azure AD только администраторам" имеет значение "Да". 3) предоставление субъектам-службам доступа к каталогу Вхередиректори. Read. ALL не является параметром.
...
Может считывать сведения базового каталога. Пользователи с этой ролью могут читать основные сведения о каталоге. Эта роль должна использоваться для: 1) предоставление определенному набору гостевых пользователей доступа на чтение вместо предоставления его всем гостевым пользователям. 2) предоставление определенному набору пользователей, не являющихся администраторами, доступа к порталу Azure, если параметр "ограничить доступ к порталу Azure AD только администраторам" имеет значение "Да". 3) предоставление субъектам-службам доступа к каталогу Вхередиректори. Read. ALL не является параметром.
