...
* **[Администратор соответствия требованиям данных](#compliance-data-administrator)** : Пользователи с этой ролью имеют разрешения для защиты и отслеживания данных в центре соответствия требованиям Microsoft 365, Центр администрирования Microsoft 365 и Azure. Пользователи также могут управлять всеми функциями в центре администрирования Exchange, диспетчере соответствия требованиям и центре администрирования Teams и Skype для бизнеса и создавать запросы в службу поддержки для Azure и Microsoft 365.

  In | Может
  ----- | ----------
  [Центр соответствия требованиям Microsoft 365](https://protection.office.com) | Мониторинг политик, связанные с соответствием требованиям в службах Microsoft 365<br>Управление оповещениями по соответствию.
  [Диспетчер соответствия](https://docs.microsoft.com/office365/securitycompliance/meet-data-protection-and-regulatory-reqs-using-microsoft-cloud) | Отслеживание, назначение и проверка деятельности организации на соответствие требованиям.
  [Центр безопасности и соответствия требованиям Office 365](https://support.office.com/article/About-Office-365-admin-roles-da585eea-f576-4f55-a1e0-87090b6aaa9d) | Управление системой управления данными.<br>Выполнение юридического расследование и анализа данных.<br>Управление запросом субъекта данных.
  [Intune](https://docs.microsoft.com/intune/role-based-access-control) | Просмотр всех данных проверки Intune.
  [Cloud App Security](https://docs.microsoft.com/cloud-app-security/manage-admins) | Обладает разрешением только для чтения и может управлять оповещениями.<br>Может создавать и изменять файловые политики и давать разрешение на управление файлом.<br> Позволяет просматривать все встроенные отчеты в разделе "Управление данными".

* **[Администратор условного доступа](#conditional-access-administrator)** : Пользователи с этой ролью могут управлять параметрами Azure Active Directory условного доступа.
  > [!NOTE]
  > Чтобы развернуть политику условного доступа Exchange ActiveSync в Azure, он также должен быть глобальным администратором.
...
* **[Администратор настольных систем аналитики](#desktop-analytics-administrator)** : Пользователи с этой ролью можно управлять анализа рабочего стола, а также настройки Office & политику службы. Для рабочего стола аналитики это включает в себя возможность просмотра данных инвентаризации активов, создавать планы развертывания, просмотр состояния развертывания и работоспособности. Для настройки Office & политики службы эта роль позволяет пользователям управлять политиками Office.
 ...
 * **[Администратор Kaizala](#kaizala-administrator)** : Пользователи с этой ролью имеют глобальные разрешения для управления параметры в Microsoft Kaizala, при наличии службы, а также возможность управлять запросами в службу поддержки и отслеживать работоспособность служб.
Кроме того пользователь может получить доступ к отчеты, относящиеся к внедрению и улучшать Kaizala, сотрудники организации и бизнес-отчеты, созданные с помощью действий, Kaizala. 
...
* **[Модуль чтения центра сообщений о конфиденциальности](#message-center-privacy-reader)** : Пользователи с этой ролью можно отслеживать все уведомления в центре сообщений, включая сообщения о конфиденциальности данных. Центр сообщений о конфиденциальности считывающий код получает уведомления по электронной почте, включая те, которые относятся к конфиденциальности данных и подписку можно отменить с помощью настроек центра сообщения. Только глобальный администратор и чтения конфиденциальности Center сообщения могут считывать сообщения о конфиденциальности данных. Кроме того эта роль включает возможность просмотра групп, доменов и подписок. Эта роль не имеет разрешения на просмотр, создание или управлять запросами на обслуживание.
...
* **[Администратор поиска](#search-administrator)** : Пользователи с этой ролью имеют полный доступ ко всем функциям управления Microsoft Search в центре администрирования Microsoft 365. Поиск администраторов можно делегировать администраторам поиска и редактор поиска ролей пользователям и создания и управления содержимым, такие как закладки, Q & как и расположения. Кроме того этих пользователей можно просмотреть центр сообщений, отслеживать работоспособность служб и создание запросов на обслуживание.

* **[Редактор поиска](#search-editor)** : Пользователи с этой ролью можно создать, управление и удаление содержимого для Microsoft Search в центре администрирования Microsoft 365, включая закладки, Q & и расположения.
...
* **[Оператор безопасности](#security-operator)** : Пользователи с этой ролью могут управлять оповещениями и иметь глобальный доступ только для чтения на функции, связанные с безопасностью, включая всю информацию в центре безопасности Microsoft 365, Azure Active Directory, защиты идентификации, Privileged Identity Management и Office 365 Безопасности и соответствия требованиям. Дополнительные сведения о разрешениях в Office 365 см. в статье [Разрешения в Центре безопасности и соответствия требованиям Office 365](https://docs.microsoft.com/office365/securitycompliance/permissions-in-the-security-and-compliance-center).

  In | Может
  --- | ---
  [Центр безопасности Microsoft 365](https://protection.office.com) | Все разрешения роли читателя сведений о безопасности.<br>Просмотр, исследовать и реагирование на оповещения угрозы безопасности
  Центр защиты идентификации | Все разрешения роли читателя сведений о безопасности.<br>А также возможность выполнять все операции центра защиты идентификации, кроме сброса паролей.
  ...
  [Центр безопасности и соответствия требованиям Office 365](https://support.office.com/article/About-Office-365-admin-roles-da585eea-f576-4f55-a1e0-87090b6aaa9d) | Все разрешения роли читателя сведений о безопасности.<br>Просмотр, исследовать и реагировать на оповещения системы безопасности
  EDR и ATP в Защитнике Windows | Все разрешения роли читателя сведений о безопасности.<br>Просмотр, исследовать и реагировать на оповещения системы безопасности
...
### <a name="compliance-data-administrator"></a>Администратор соответствия требованиям данных
...
Можно контролировать возможности условного доступа.
...
Можно управлять параметрами Microsoft Kaizala.  
...
| microsoft.office365.serviceHealth/allEntities/allTasks | Чтение и настройка работоспособности служб Office 365. |
| microsoft.office365.supportTickets/allEntities/allTasks | Создание запросов в службу поддержки Office 365 и управление ими. |
| microsoft.office365.webPortal/allEntities/basic/read | Центр администрирования Office 365 для чтения. |
...
### <a name="message-center-privacy-reader"></a>Модуль чтения центра сообщений о конфиденциальности
Может считывать центр сообщений сообщения, сообщения о конфиденциальности данных, групп, доменов и подписок.
...
Разрешено для просмотра и сбросить сведения о методе проверки подлинности для любого пользователя (администратора или без прав администратора).
...
| microsoft.aad.directory/servicePrincipals/appRoleAssignedTo/allTasks | Считать и настроить свойства servicePrincipals.appRoleAssignedTo в Azure Active Directory. |
| microsoft.aad.directory/servicePrincipals/oAuth2PermissionGrants/allTasks | Считать и настроить свойства servicePrincipals.oAuth2PermissionGrants в Azure Active Directory. |
| microsoft.aad.directory/administrativeUnits/allProperties/allTasks | Создание и управление ими административные единицы (включая элементы) |
| microsoft.aad.directory/roleAssignments/allProperties/allTasks | Создание и Управление назначениями ролей. |
| microsoft.aad.directory/roleDefinitions/allProperties/allTasks | Создание и управление определениями ролей. |
...
Можно создавать и контролировать все аспекты параметров поиска Майкрософт.
...
| --- | --- |
| microsoft.office365.messageCenter/messages/read | Чтение сообщений в microsoft.office365.messageCenter. |
| Microsoft.Office365.Search/allEntities/allProperties/allTasks | Создание и удаление всех ресурсов и чтение и изменение всех свойств в microsoft.office365.search. |
| microsoft.office365.serviceHealth/allEntities/allTasks | Чтение и настройка работоспособности служб Office 365. |
| microsoft.office365.supportTickets/allEntities/allTasks | Создание запросов в службу поддержки Office 365 и управление ими. |
| microsoft.office365.usageReports/allEntities/read | Чтение отчетов об использовании Office 365. |
| microsoft.office365.webPortal/allEntities/basic/read | Чтение базовых свойств для всех ресурсов в microsoft.office365.webPortal. |
...
Можно создавать и управлять редакторские материалы, такие как закладки, Q и в качестве расположения, план этажа.
...
| --- | --- |
| microsoft.office365.messageCenter/messages/read | Чтение сообщений в microsoft.office365.messageCenter. |
| Microsoft.Office365.Search/Content/allProperties/allTasks | Создание и удаление содержимого и чтение и изменение всех свойств в microsoft.office365.search. |
| microsoft.office365.usageReports/allEntities/read | Чтение отчетов об использовании Office 365. |
...
| microsoft.aad.identityProtection/allEntities/read | Чтение всех ресурсов в microsoft.aad.identityProtection. |
| microsoft.aad.privilegedIdentityManagement/allEntities/read | Чтение всех ресурсов в microsoft.aad.privilegedIdentityManagement. |
| microsoft.azure.advancedThreatProtection/allEntities/read | Чтение и настройка Azure AD Advanced Threat Protection. |
| microsoft.intune/allEntities/allTasks | Управление всеми аспектами Intune. |
| microsoft.office365.securityComplianceCenter/allEntities/allTasks | Чтение и настройка безопасности и соответствия требованиям. |
| microsoft.office365.usageReports/allEntities/read | Чтение отчетов об использовании Office 365. |
| microsoft.windows.defenderAdvancedThreatProtection/allEntities/read | Чтение и настройка Windows Defender Advanced Threat Protection. |
...
Администратор проверки подлинности | Проверка подлинности администратора | c4e39bd9-1100-46d3-8c65-fb160da0071f
...
Поток пользователя B2C администратора | Поток пользователя B2C администратора | 6e591065-9bad-43ed-90f3-e9424366d2f0
...
Администратор соответствия требованиям данных | Администратор соответствия требованиям данных | e6d1a23a-da11-4be4-9570-befc86d067a7
...
Учетные записи синхронизации службы каталогов | Учетная запись синхронизации каталогов | d29b2b05-8046-44ba-8758-1e26182fcf32
...
Администратор поставщика внешних удостоверений | Администратор поставщика внешних удостоверений | be2f45a1-457d-42af-a067-6ec1fa63bc45
...
Модуль чтения центра сообщений о конфиденциальности | Модуль чтения о конфиденциальности центра сообщений | ac16e43d-7b2d-40e0-ac05-243ff356ab5b
...
Администратор привилегированных проверки подлинности | Администратор привилегированных проверки подлинности | 7be44c8a-adaf-4e2a-84d6-ab2649e08a13
