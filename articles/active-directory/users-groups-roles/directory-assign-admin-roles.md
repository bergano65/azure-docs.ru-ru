...
> [!IMPORTANT]
>  Пользователи со встроенными или пользовательскими ролями с разрешениями Microsoft. Directory/Users/Password/Update могут изменять пароли для пользователей, которые могут иметь доступ к конфиденциальной или частной информации или к важной конфигурации внутри и вне Azure Active Directory. Изменение пароля пользователя подразумевает возможность предполагать идентификатор и разрешения пользователя. Пример:
>
