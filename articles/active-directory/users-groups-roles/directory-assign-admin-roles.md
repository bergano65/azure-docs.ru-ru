...
## <a name="limit-the-use-of-global-administrator"></a>Ограничьте использование глобального администратора
...
Пользователи в этой роли могут устанавливать или сбросить учетные данные без пароля, обновлять пароли, требовать перерегистрации в отношении существующих учетных данных без пароля (например, MFA или FIDO) и отозвать **запоминание МИД на устройстве** (что подсказывает МИД при следующем входе) пользователей, не являющихся администраторами или назначенных только следующих ролей:
...
Пользователи с этой ролью имеют разрешения на управление возможностями, связанными с соответствием, в Центре соответствия требованиям Microsoft 365, Центре администрирования Microsoft 365, Azure и Центре безопасности и соответствия требованиям Office 365. Назначаемые средства также могут создавать вспомогательные билеты для Azure и Microsoft 365. Дополнительные сведения см. в статье [Роли администраторов в Office 365](https://support.office.com/article/About-Office-365-admin-roles-da585eea-f576-4f55-a1e0-87090b6aaa9d).
...
[Привилегированое управление идентификацией](https://docs.microsoft.com/azure/active-directory/privileged-identity-management/pim-configure) | Все разрешения роли читателя сведений о безопасности.<br>**Не удается** управлять назначениями или настройками ролей Azure AD
...
Центр защиты идентификации | Все разрешения роли читателя сведений о безопасности.<br>А также возможность выполнять все операции центра защиты идентификации, кроме сброса паролей.
[Привилегированое управление идентификацией](https://docs.microsoft.com/azure/active-directory/privileged-identity-management/pim-configure) | Все разрешения роли читателя сведений о безопасности.
