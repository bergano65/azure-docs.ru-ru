...
Если вам не удается найти необходимую роль в списке многих ролей, Azure AD может предоставить вам более короткие списки на основе категорий ролей. Ознакомьтесь с новым фильтром **типов** для [ролей и администраторов Azure AD](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RolesAndAdministrators) , чтобы отобразить только роли в выбранном типе.
