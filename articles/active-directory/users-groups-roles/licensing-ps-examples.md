---
title: Примеры PowerShell и Graph для группового лицензирования в Azure Active Directory | Документация Майкрософт
...
Graph не выводит результаты напрямую, но их можно просмотреть с помощью этого API:
```
