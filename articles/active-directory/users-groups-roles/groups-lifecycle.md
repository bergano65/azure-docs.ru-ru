...
> [!NOTE]
> Чтобы настроить и использовать политику срока действия для групп Office 365, необходимо обладать Azure AD Premium лицензиями для членов всех групп, к которым применяется политика срока действия.
...
> [!NOTE]
> При первой настройке срока действия для всех групп, которые существуют дольше интервала срока действия, задается срок действия 30 дней. Первое уведомление по электронной почте об обновлении будет отправлено в течение дня. Например, группа A была создана 400 дней назад, а срок действия равен 180 дням. При применении политики срока действия Группа A имеет 30 дней до ее удаления, если только владелец не поменяет ее.
