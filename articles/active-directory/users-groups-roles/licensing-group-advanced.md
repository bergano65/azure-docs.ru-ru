...
Некоторые службы Майкрософт недоступны во всех расположениях. Прежде чем назначать лицензию, администратор должен указать для пользователя свойство **Место использования**. В [портал Azure](https://portal.azure.com)можно указать расположение использования в **параметрах**профиль **пользователя** &gt; &gt;.
