...
Некоторые службы Майкрософт недоступны во всех расположениях. Прежде чем назначать лицензию, администратор должен указать для пользователя свойство **Место использования**. В [портал Azure](https://portal.azure.com)можно указать место использования в **параметрах**профиля **пользователя** &gt; **Profile** &gt;.
...
Когда корпорация Майкрософт добавляет новую службу в план лицензирования продукта, она включается по умолчанию во всех группах, которым назначена лицензия продукта. Пользователи в клиенте, которые подписаны на уведомления об изменениях продукта, заранее получат сообщения электронной почты с уведомлением о предстоящих дополнениях.
