...
> [!NOTE]
> Это же назначение вы можете выполнить из альтернативного расположения: **Пользователи и группы** в Azure Active Directory. Последовательно выберите **Azure Active Directory** > **Пользователи и группы** > **Все группы**. Найдите группу, выберите ее и перейдите к вкладке **Лицензии**. Нажмите кнопку **Назначить** в верхней части области, чтобы открыть область назначения лицензии.
