---
title: Делегирование разрешений на Управление администраторами приложений — Azure AD | Документация Майкрософт
...
1. Войдите в [организацию Azure AD](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/Overview) с учетной записью, которая имеет право администратора приложения или администратора облачного приложения для Организации.
...
- Администратор приложения. пользователи с этой ролью могут создавать и администрировать все аспекты корпоративных приложений, регистрации приложений и параметры прокси приложения. Эта роль также предоставляет возможность согласия на делегированные разрешения и разрешения приложений, исключая Microsoft Graph. Пользователи, назначенные этой роли, не добавляются в качестве владельцев при создании новых регистраций приложений или корпоративных приложений.
- Администратор облачных приложений. пользователи с этой ролью имеют те же разрешения, что и роль администратора приложения, за исключением возможности управлять прокси приложения. Пользователи, назначенные этой роли, не добавляются в качестве владельцев при создании новых регистраций приложений или корпоративных приложений.
