...
description: Настройка политики именования для групп Office 365 в Azure Active Directory
...
ms.locfileid: "84728152"
---
# <a name="enforce-a-naming-policy-on-office-365-groups-in-azure-active-directory"></a>Принудительная политика именования для групп Office 365 в Azure Active Directory
...
> [!IMPORTANT]
> Для использования политики именования Azure AD для групп Office 365 необходимо, чтобы вы обладали, но не обязательно назначили лицензию Azure Active Directory Premium P1 или Azure AD Basic для каждого уникального пользователя, который является членом одной или нескольких групп Office 365.
...
При настройке политики именования групп политика будет применяться к новым группам Office 365, созданным конечными пользователями. Политика именования не применяется к определенным ролям каталога, таким как глобальный администратор или администратор пользователей (ниже приведен полный список ролей, исключенных из политики именования групп). Для существующих групп Office 365 политика не будет немедленно применена во время настройки. Когда владелец группы изменит имя группы для этих групп, будет применена политика именования.
