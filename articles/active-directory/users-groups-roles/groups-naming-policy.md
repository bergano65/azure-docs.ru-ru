---
title: Применение политики именования групп в группах Office 365 Azure Active Directory | Документация Майкрософт
