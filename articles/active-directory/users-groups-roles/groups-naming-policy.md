...
1. Выполните действия, описанные в [Azure Active Directory командлетах для настройки параметров группы](groups-settings-cmdlets.md) , чтобы создать параметры группы для этой Организации.
...
Дополнительные сведения см. в статье [Azure Active Directory командлеты для настройки параметров группы](groups-settings-cmdlets.md).
