...
## <a name="configure-the-group-naming-policy-for-a-tenant-using-azure-portal-preview"></a>Настройте политику именования групп для клиента с помощью портала Azure (Предварительная версия)

1. Войдите в [Центр администрирования Azure AD](https://aad.portal.azure.com) с учетной записью администратора пользователей.
1. Выберите **группы**, а затем выберите **политики именования** чтобы открыть страницу политики именования.

    ![Откройте страницу политики именования в центре администрирования](./media/groups-naming-policy/policy-preview.png)
...
1. На **политики именования** выберите **Групповая политика именования**.
1. Можно просмотреть или изменить текущего префикса или суффикса, именования политики по отдельности, выбрав атрибуты или строк, которые вы хотите применить как часть политики именования.
1. Чтобы удалить префикс или суффикс из списка, выберите префикс или суффикс, а затем выберите **удалить**. В то же время можно удалить несколько элементов.
...
1. На **политики именования** выберите **запрещенные слова**.

    ![редактировать и отправлять список запрещенных слов для политики именования](./media/groups-naming-policy/blockedwords-preview.png)

1. Просмотреть или изменить текущий список настраиваемых запрещенных слов, выбрав **загрузить**.
1. Отправка нового списка настраиваемых запрещенных слов, щелкнув значок файла.
1. Сохранить изменения для новой политики вступить в силу, выбрав **Сохранить**.
...
## <a name="export-or-import-the-list-of-custom-blocked-words-using-azure-ad-powershell"></a>Экспорт или импорт списка настраиваемых запрещенных слов, с помощью Azure AD PowerShell
...
### <a name="remove-the-naming-policy-using-azure-portal-preview"></a>Удалить политику именования, с помощью портала Azure (Предварительная версия)

1. На **политики именования** выберите **удалить политику**.
1. После подтверждения удаления, политика именования удалены, включая все добавления префикса или суффикса именования политики и любые настраиваемые запрещенные слова.
