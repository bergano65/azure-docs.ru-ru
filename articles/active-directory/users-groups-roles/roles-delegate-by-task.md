...
Создание группы | Администратор пользователей | 
...
Чтение скрытых членств | Член группы | Владелец группы, пароль администратора, администратора Exchange, администратор SharePoint, администратор команды, администратор пользователей
Чтение данных о членстве в группах со скрытым членством | Администратор службы технической поддержки | Администратор, администратор команды
