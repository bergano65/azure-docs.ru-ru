---
title: Делегат роли по задаче админ - Активный каталог Azure (ru) Документы Майкрософт
...
Создание, чтение, изменение и удаление политик B2C | Администратор политики B2C IEF | 
Создание, чтение, изменение и удаление поставщиков удостоверений | Администратор внешнего поставщика идентификационных данных | 
Создание, чтение, изменение и удаление маршрутов пользователей для сброса пароля | Администратор потока пользователей B2C | 
Создание, чтение, изменение и удаление маршрутов пользователей для редактирования профиля | Администратор потока пользователей B2C | 
Создание, чтение, изменение и удаление маршрутов пользователей для входа | Администратор потока пользователей B2C | 
Создание, чтение, изменение и удаление маршрутов пользователей для регистрации |Администратор потока пользователей B2C | 
Создание, чтение, изменение и удаление атрибутов пользователей | Администратор атрибута потока пользователей B2C | 
...
> [!NOTE]
> Читатели Azure AD B2C Global не имеют тех же разрешений, что и глобальные администраторы Azure AD. Если у вас есть глобальные привилегии администратора Azure AD B2C, убедитесь, что вы находитесь в каталоге Azure AD B2C, а не в каталоге Azure AD.
...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Сквозная проверка подлинности | Администратор гибридной идентификации | 
Чтение всех конфигураций | Глобальный читатель | Администратор гибридной идентификации |
Простой единый вход | Администратор гибридной идентификации | 
...
Согласие на получение разрешений без учета Microsoft Graph | Администратор облачных приложений | администратор приложений;
Согласие на применение разрешений к Microsoft Graph | Администратор привилегированных ролей | 
...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Добавление ресурсов в каталог | Администратор пользователей | С управлением правами вы можете делегировать эту задачу владельцу каталога[(см. документацию)](../governance/entitlement-management-catalog-create.md#add-additional-catalog-owners)
Добавление сайтов SharePoint в Интернет в каталог | Глобальный администратор.
...
Чтение скрытых членств | Член группы | Владелец группы, администратор паролей, администратор exchange, администратор SharePoint, администратор команд, администратор пользователя
Чтение данных о членстве в группах со скрытым членством | Администратор службы технической поддержки | Администратор пользователя, администратор команд
...
Отклоните все обнаружения рисков | Администратор безопасности | 
...
Ознакомьте все обнаружения рисков | Читатель сведений о безопасности | 
...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Управление поставщиками удостоверений | Администратор внешнего поставщика идентификационных данных | 
...
Отмена маркеров обновления для привилегированных администраторов (см. документацию) | Привилегированный администратор аутентификации | 
Чтение базовой конфигурации | Роль пользователя по умолчанию[(см. документацию](https://docs.microsoft.com/azure/active-directory/fundamentals/users-default-permissions) | 
...
Сброс паролей для привилегированных администраторов | Привилегированный администратор аутентификации | 
Отмена лицензии | Администратор лицензий | Администратор пользователей
...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Отправка запроса в службу поддержки | Администратор служб | Администратор приложений, Администратор защиты информации Azure, Администратор выставления счетов, Администратор облачных приложений, Администратор соответствия, Администратор динамики 365, Администратор аналитики рабочей стола, Администратор Обмена, Администратор паролей, Администратор Интунта, Skype для бизнес-администратора, Администратор Power BI, Привилегированный администратор аутентификации, администратор SharePoint, Администратор коммуникаций команд, Администратор команд, Администратор пользователя, Администратор Аналитики На рабочем месте
