...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Отправка запроса в службу поддержки | Администратор служб | Администратор приложений, Администратор защиты информации Azure, Администратор выставления счетов, Администратор облачных приложений, Администратор соответствия, Администратор динамики 365, Администратор аналитики рабочего стола, Администратор Обмена, Пароль Администратор, Администратор Intune, Skype для бизнес-администратора, Администратор Power BI, Администратор конфиденциальной информации, Администратор SharePoint, Администратор коммуникаций команд, Администратор команд, Администратор пользователей, Администратор пользователя, Администратор аналитики на рабочем месте
