...
Просмотр всех конфигураций | администратор приложений; | 
...
Просмотр всех конфигураций | глобального администратора; | 
...
Просмотр всех конфигураций | Читатели каталога | Роль пользователя по умолчанию ([см. документацию](https://docs.microsoft.com/azure/active-directory/fundamentals/users-default-permissions))
...
Управление параметрами группы | администратор учетных записей; | 
...
Просмотр всех конфигураций | Чтение данных безопасности | 
