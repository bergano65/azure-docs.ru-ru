...
Создание, чтение, изменение и удаление политик B2C | Администратор политики B2C инфраструктура процедур идентификации | 
...
Создание, чтение, изменение и удаление атрибутов пользователей | Администратор атрибута потока пользователя B2C | 
...
Отмена маркеров обновления для привилегированных администраторов (см. документацию) | Администратор привилегированной проверки подлинности | 
Чтение базовой конфигурации | Роль пользователя по умолчанию ([см. документацию](https://docs.microsoft.com/azure/active-directory/fundamentals/users-default-permissions)) | 
...
Сброс паролей для привилегированных администраторов | Администратор привилегированной проверки подлинности | 
Отмена лицензии | Администратор лицензий | Администратор пользователей
