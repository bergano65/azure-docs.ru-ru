...
Чтение всех событий риска | Читатель сведений о безопасности | 
...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Отправка запроса в службу поддержки | Администратор служб | Администратор приложения, администратор Azure Information Protection, выставления счетов, администратор облачных приложений, соответствия требованиям администратора, администратора Dynamics 365 рабочего стола аналитики администратор, администратор Exchange, пароль администратора Администратор, администратор Intune, Скайп для бизнеса администратора, администратор Power BI, администратор привилегированных проверки подлинности, администратор SharePoint, администратор команды Communications, группами администратора, администратора пользователей Администратор Workplace Analytics
