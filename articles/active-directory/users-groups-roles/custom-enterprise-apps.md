...
Дополнительные сведения см. в статьях [Создание и назначение пользовательской роли](roles-create-custom.md) и [Назначение пользовательских ролей с областью действия ресурса с помощью PowerShell](roles-assign-powershell.md).
...
Создайте настраиваемую роль, используя предоставленный пример в API Microsoft Graph. Дополнительные сведения см. в статьях [Создание и назначение пользовательской роли](roles-create-custom.md) и [Назначение пользовательских ролей администратора с помощью API Microsoft Graph](roles-assign-graph.md).
