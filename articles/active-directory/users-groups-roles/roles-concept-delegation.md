...
* Роль **владельца корпоративного приложения** дает возможность управлять корпоративными приложениями, владельцами которых является этот пользователь, в том числе настраивать единый вход, назначать пользователей и группы, добавлять новых владельцев. Он не предоставляет возможность управлять настройками прокси-серверов приложений или условным доступом.
