...
## <a name="what-happens-when-a-group-with-licenses-assigned-is-deleted"></a>Что происходит, когда удаляется группа с назначенными лицензиями?
...
## <a name="how-do-you-force-license-processing-on-a-user-to-resolve-errors"></a>Как настроить принудительную обработку лицензий пользователя, чтобы устранить ошибки?
