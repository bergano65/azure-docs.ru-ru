---
title: Используйте группу для управления доступом к приложениям SaaS - Azure AD Документы Майкрософт
