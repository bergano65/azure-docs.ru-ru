...
- Назначьте облачные группы ролям Azure AD (встроенным или настраиваемым) через административную единицу.
...
- Azure Information Protection не распознает членство в роли с помощью группы. Прямые назначения ролей по-прежнему работают. Портал Azure Information Protection (Классический портал) еще не распознает членство в роли через группу. Прямые назначения ролей по-прежнему работают. Вы можете [выполнить миграцию на платформу единой метки чувствительности](https://docs.microsoft.com/azure/information-protection/configure-policy-migrate-labels) , а затем использовать назначения групп для управления ролями в центре безопасности Office 365 Security &.
...
- [Создание назначаемой роли группы](roles-groups-create-eligible.md)
