---
title: Управление учетными записями администраторов аварийного доступа в Azure AD | Документация Майкрософт
...
Однако хотя бы одна из учетных записей для аварийного доступа должна использовать механизм многофакторной идентификации, отличный от того, который применяют другие обычные учетные записи. Сюда можно отнести сторонние решения многофакторной идентификации. При наличии политики условного доступа, чтобы требовать [многофакторную проверку подлинности для каждого администратора](../authentication/howto-mfa-userstates.md) Azure AD и других подключенных приложений SaaS, следует исключить из этого требования учетные записи аварийного доступа и настроить другой механизм. Кроме того, у учетных записей не должно быть политики многофакторной идентификации для каждого пользователя.
