...
1. Войдите в [центр администрирования Azure AD](https://aad.portal.azure.com) с помощью учетной записи глобального администратора, администратора группы, администратора Intune или роли администратора пользователя в клиенте.
