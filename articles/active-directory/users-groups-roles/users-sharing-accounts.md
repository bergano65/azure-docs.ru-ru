...
* [Групповое назначение](groups-self-service-management.md)
...
* [Прокси-сервер приложения](../manage-apps/application-proxy.md)
