...
Azure AD поддерживает общие учетные записи для любых планов лицензирования Enterprise Mobility Suite (EMS) или Azure AD Premium во всех типах приложений с единым входом на основе пароля. Общие учетные записи можно использовать для любого из тысяч предварительно интегрированных приложений в коллекции приложений, также можно добавить собственное приложение с проверкой подлинности по паролю с помощью [пользовательских приложений единого входа](../manage-apps/what-is-single-sign-on.md).

Ниже перечислены компоненты Azure AD, обеспечивающие совместное использование учетных записей.

* [Единый вход по паролю](../manage-apps/sso-options.md#password-based-sso)
...
* Добавьте приложение из [коллекции приложений](https://azuremarketplace.microsoft.com/marketplace/apps/Microsoft.AzureActiveDirectory) или [пользовательское приложение](https://cloudblogs.microsoft.com/enterprisemobility/2015/06/17/bring-your-own-app-with-azure-ad-self-service-saml-configuration-now-in-preview/).
