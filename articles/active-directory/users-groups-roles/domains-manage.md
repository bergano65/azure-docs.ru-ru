...
5. Выберите команду **Назначить основным**. При появлении запроса подтвердите свой выбор.
   ...
   ![Сделать доменное имя основным](./media/domains-manage/make-primary-domain.png)
...
**В: Я вхожу в систему\@в качестве contoso.com, но я не могу удалить доменное имя "contoso.com"?**<br>
...
**В: Я нажал кнопку домена «Удалить» и просмотреть `In Progress` состояние операции «Удалить». Сколько времени это займет? Что произойдет, если это не удастся?**<br>
...
## <a name="use-powershell-or-the-microsoft-graph-api-to-manage-domain-names"></a>Используйте PowerShell или Microsoft Graph API для управления именами доменов

Большинство задач управления именами доменов в Active Directory Azure также могут быть выполнены с помощью Microsoft PowerShell или программно с помощью API Microsoft Graph.
