...
5. Выберите команду **Назначить основным**. При появлении запроса подтвердите свой выбор.
   ...
   ![Создание основного имени домена](./media/domains-manage/make-primary-domain.png)
...
**Вопрос. я вошел в систему как администратор\@contoso.com, но я не могу удалить доменное имя "contoso.com"?**<br>
...
**Вопрос. я наберу кнопку Удалить домен и вижу `In Progress` состояние для операции удаления. Сколько времени займет? Что произойдет в случае сбоя?**<br>
...
Большинство задач управления для доменных имен в Azure Active Directory также можно выполнить с помощью Microsoft PowerShell или программно с помощью API Microsoft Graph.
