...
Когда вы определите количество гостевых пользователей, которым требуется доступ к вашим платным службам Azure AD, приобретите для них достаточно платных лицензий Azure AD в требуемом соотношении 1:5. Ниже приводится несколько примеров.
