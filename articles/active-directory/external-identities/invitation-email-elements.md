...
### <a name="inviters-information-and-invitation-message"></a>Сведения о приглашении и приглашении приглашаемого

В сообщении электронной почты содержится имя и основной домен, связанный с Организацией, отправляющей приглашение. Эти сведения помогут пригласить принять обоснованное решение о принятии приглашения. Если при [приглашении гостевого пользователя к каталогу, группе или приложению](add-users-administrator.md) или при [использовании API приглашения](customize-invitation-api.md)приглашенный пользователь помещает сообщение в приглашение, он выделяется в основном разделе сообщения. Кроме того, в него входят имя и изображение приглашающего, если они заданы. Само сообщение — это текстовая область, поэтому в целях безопасности он не обрабатывает HTML-теги.

![Изображение сообщения с приглашением в сообщении электронной почты](media/invitation-email-elements/invitation-message-inviters-info.png)
