...
5. В разделе **Управление** выберите **Единый вход** и настройте в приложении единый вход. (Дополнительные сведения об управлении параметрами единого входа для корпоративных приложений см. [здесь](../manage-apps/view-applications-portal.md).)
