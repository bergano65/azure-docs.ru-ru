...
5. В разделе **Управление** выберите **Единый вход** и настройте в приложении единый вход. (Дополнительные сведения об управлении параметрами единого входа для корпоративных приложений см. [здесь](../manage-apps/add-application-portal-setup-sso.md).)
6. В разделе **Управление** выберите **Самообслуживание** и настройте самостоятельный доступ к приложению. (Дополнительные сведения об использовании самостоятельного доступа к приложению см. [здесь](../manage-apps/access-panel-manage-self-service-access.md).) 
