...
9. В окне **изменение правил утверждений** отобразится новое правило. Щелкните **Применить**. 
...
4. В окне **изменение правил утверждений** отобразятся новые правила. Щелкните **Применить**. 
...
Azure AD B2B можно настроить для создания Федерации с поставщиками удостоверений, которые используют протокол WS-подач с указанными ниже требованиями. В настоящее время на совместимость с Azure AD протестированы два поставщика WS-Fed: AD FS и Shibboleth. Здесь мы будем использовать службы федерации Active Directory (AD FS) (AD FS) в качестве примера поставщика удостоверений WS-подач. Дополнительные сведения о установлении отношения доверия между проверяющей стороной между поставщиком WS-подачи и Azure AD см. в статье документация по совместимости поставщика удостоверений Azure AD.
...
1. В окне **изменение правил утверждений** отобразится новое правило. Щелкните **Применить**.  
