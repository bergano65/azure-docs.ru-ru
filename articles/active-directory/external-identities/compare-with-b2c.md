...
| Политика безопасности и соответствие требованиям За управление отвечает основная или приглашающая организация (например, с использованием [политик условного доступа](./conditional-access.md)).           | Политика безопасности и соответствие требованиям За управление отвечает основная или приглашающая организация (например, с использованием [политик условного доступа](./conditional-access.md)). | Политика безопасности и соответствие требованиям Управляется приложением.        |
