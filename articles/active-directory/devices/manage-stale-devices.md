...
description: Узнайте, как удалять устаревшие устройства из базы данных для зарегистрированных устройств в Azure Active Directory.
...
- Политики условного доступа, требуя [управляемые устройства](../conditional-access/require-managed-devices.md) или [утвержденных клиентских приложений](../conditional-access/app-based-conditional-access.md) было запущено.
...
- **Windows 7 и 8** — отключите или удалите устройство Windows 7/8 в Azure AD. Azure AD Connect нельзя использовать для отключения или удаления устройств Windows 7 или 8 в Azure AD.
...
Если имеется большое количество устройств в каталоге, используйте фильтр timestamp сузить число возвращаемых устройств. Чтобы получить и сохранить в CSV-файл список всех устройств, у которых метка времени старше указанной даты, выполните: 
