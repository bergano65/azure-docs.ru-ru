...
Если устройство Azure AD связано с объектом Windows автопилота, то в случае повторного назначения устройства в будущем могут возникать следующие три сценария.
