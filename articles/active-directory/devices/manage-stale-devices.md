...
> [!NOTE]
>* Удаление устройств в локальной службе AD или Azure AD не приводит к регистрации на клиенте. Он будет препятствовать доступу к ресурсам с помощью устройства в качестве удостоверения (например, условный доступ). Ознакомьтесь с дополнительными сведениями о том, как [Удалить регистрацию на клиенте](faq.md#hybrid-azure-ad-join-faq).
