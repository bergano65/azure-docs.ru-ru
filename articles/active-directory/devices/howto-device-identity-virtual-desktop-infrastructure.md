...
Гибридное присоединение к Azure AD для непостоянного VDI не поддерживается в текущих версиях Windows. При развертывании непостоянного VDI для Windows нижнего уровня ИТ-администраторы должны уделять особое внимание управлению устаревшими устройствами в Azure AD. Корпорация Майкрософт рекомендует администраторам отделов ИТ реализовать приведенные ниже рекомендации. Несоблюдение этого действия приведет к тому, что ваш каталог будет иметь множество устаревших гибридных устройств, присоединенных к Azure AD, которые были зарегистрированы на неустойчивой платформе VDI.
