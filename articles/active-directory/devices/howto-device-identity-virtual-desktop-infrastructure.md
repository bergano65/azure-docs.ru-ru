...
\*\* **управляемая** инфраструктура идентификации представляет собой среду с Azure AD в качестве поставщика удостоверений, развернутого с помощью [синхронизации ХЭША паролей (PHS)](../hybrid/whatis-phs.md) или [сквозной проверки подлинности (PTA)](../hybrid/how-to-connect-pta.md) с [простым единым входом](../hybrid/how-to-connect-sso.md).
