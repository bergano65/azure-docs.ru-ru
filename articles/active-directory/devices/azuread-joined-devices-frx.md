...
description: Как пользователи могут настроить Соединение Azure AD во время работы в некоробке.
...
1. Устройство находит подходящего арендатора в Azure AD. Если ваше устройство находится в федеративном домене, то вы будете перенаправлены на локальный сервер службы токенов безопасности, например в службы федерации Active Directory (AD FS).
...
- Для получения дополнительной информации смотрите [введение в управление устройствами в Active Directory Azure.](overview.md)
