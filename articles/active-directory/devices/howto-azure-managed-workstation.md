...
| Профиль | Низкий | Расширенная архитектура | Высокий | Специализированный | Защищены | Isolated |
| :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
1. Введите:
   ...
   * **Directory role** - **Администратор с ограниченным** доступом к роли каталога и выберите роль **администратора Intune** .
...
1. Выберите **Azure Active Directory** > **устройства** > **Параметры устройства**.
...
1. Перейдите на **Microsoft Intune** > **страницу** > **Settings****Device enrollment** > **Windows enrollment** > **Default**регистрации устройств Microsoft Intune регистрация регистрации Windows параметры по умолчанию. > 
...
| Профиль | Папка для загрузки | имя_файла |
| --- | --- | --- |
...
* Здесь можно найти профили конфигурации устройств Intune, созданные с помощью скриптов: **портал Azure** > **Microsoft Intune** >  > **Профили****конфигурации устройств**.
* Здесь можно найти политики соответствия устройств Intune, созданные сценариями: **портал Azure** > **Microsoft Intune** >  > **политик****соответствия устройств**.
...
1. Перейдите в **портал Azure** > **Microsoft Intune** > **Условный доступ — политики Политика** > **.**
...
* Узнайте, как [обнаруживать угрозы с помощью Azure Sentinel](/azure/sentinel/tutorial-detect-threats)
* [Изучение инцидентов с помощью Azure Sentinel](/azure/sentinel/tutorial-investigate-cases)
...
* Обнаружение [Sentinel Azure](/azure/sentinel/)
