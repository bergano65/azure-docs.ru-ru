...
- **Пользователи могут присоединять устройства к Azure AD** -этот параметр позволяет выбрать пользователей, которые могут регистрировать свои устройства как устройства присоединены к Azure AD. Значение этого параметра по умолчанию — **Все**.
