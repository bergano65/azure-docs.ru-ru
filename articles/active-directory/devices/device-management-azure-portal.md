...
:::image type="content" source="./media/device-management-azure-portal/64.png" alt-text="Снимок экрана таблицы в разделе &quot;действие&quot; на странице &quot;устройства&quot; с описанием даты, целевого объекта, субъекта и действия для четырех журналов аудита." border="false":::
...
:::image type="content" source="./media/device-management-azure-portal/65.png" alt-text="Снимок экрана таблицы в разделе &quot;действие&quot; на странице &quot;устройства&quot; с описанием даты, целевого объекта, субъекта и действия для четырех журналов аудита." border="false":::
