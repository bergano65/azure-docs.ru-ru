...
![Представление "все устройства" в портал Azure](./media/device-management-azure-portal/all-devices-azure-portal.png)

## <a name="manage-device-identities"></a>Управление удостоверениями устройств

Портал Azure AD предоставляет централизованное управление удостоверениями устройств. Это место можно получить с помощью [прямой ссылки](https://portal.azure.com/#blade/Microsoft_AAD_IAM/DevicesMenuBlade/Devices) или:
...
На странице Параметры устройства можно настроить параметры, связанные с удостоверениями устройств.
...
## <a name="locate-devices"></a>Найти устройства
...
- Обновление устройств — примеры ежедневных операций, таких как включение и отключение устройств.
- Удаление устройств — при снятии устройства с учета и необходимости удаления в Azure AD
