---
title: Как управлять локальными администраторами на устройствах, связанных с Azure AD
...
- [Просмотр всех членов роли администратора в Azure Active Directory](../users-groups-roles/directory-manage-roles-portal.md)
...
Администраторы устройств назначаются для всех устройств, присоединенных к Azure AD. Администраторов устройств нельзя ограничить определенным набором устройств. Обновление роли администратора устройства не обязательно напрямую влияет на затронутых пользователей. На устройствах, в которые пользователь уже подписан, обновление привилегий происходит, когда происходит *обе* действия ниже:

- Прошло 4 часа для azure AD, чтобы выпустить новый токен Первоначального обновления с соответствующими привилегиями. 
- Пользователь выходит и вскакивает обратно, а не блокирует/блокирует, чтобы обновить свой профиль.
...
Начиная с выпуска **Windows 10 1709,** вы можете выполнить эту задачу из **настроек -> учетных записей - > Другие пользователи**. Выберите **Добавить пользователя организации или учебного заведения**, введите имя участника-пользователя в поле **Учетная запись пользователя** и выберите *Администратор* в разделе **Тип учетной записи**.  
...
- Чтобы узнать больше об условиях [configure Azure Active Directory device-based Conditional Access policies](../conditional-access/require-managed-devices.md)условного доступа на основе устройств, см.
