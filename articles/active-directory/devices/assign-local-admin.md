...
Starting with the **Windows 10 1709** release, you can perform this task from **Settings -> Accounts -> Other users**. Выберите **Добавить пользователя организации или учебного заведения**, введите имя участника-пользователя в поле **Учетная запись пользователя** и выберите *Администратор* в разделе **Тип учетной записи**.  
