...
В таблице ниже приведены сведения о поддержке альтернативных имен для входа для гибридного присоединения к Azure AD в Windows 10.

|Тип альтернативного идентификатора для входа|Тип домена|Версия Windows 10|ОПИСАНИЕ|
|-----|-----|-----|-----|
