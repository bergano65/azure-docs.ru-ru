...
description: Узнайте о устройствах, присоединенных к Azure AD, и о том, как управление удостоверениями устройств может помочь в управлении устройствами, которые обращаются к ресурсам в вашей среде.
...
- Пользователям в основном требуется доступ к Microsoft 365 или другим приложениям SaaS, интегрированным с Azure AD.
