...
1. Откройте журналы событий **регистрации пользователей и устройств** в средстве просмотра событий. Находится в папке **Applications and Services журнал**  >  **Microsoft**  >  **Windows**  >  **регистрации пользователей и устройств** Microsoft Windows
...
:::image type="content" source="./media/troubleshoot-hybrid-join-windows-current/2.png" alt-text="Снимок экрана средства просмотра событий. Выделено событие с I D 304, и отображаются сведения о нем с выделенным кодом ошибки и стадией." border="false":::
...
:::image type="content" source="./media/troubleshoot-hybrid-join-windows-current/5.png" alt-text="Снимок экрана средства просмотра событий. Выделено событие с I D 304, и отображаются сведения о нем с выделенным кодом ошибки и стадией." border="false":::
...
:::image type="content" source="./media/troubleshoot-hybrid-join-windows-current/3.png" alt-text="Снимок экрана средства просмотра событий. Выделено событие с I D 304, и отображаются сведения о нем с выделенным кодом ошибки и стадией." border="false":::
...
:::image type="content" source="./media/troubleshoot-hybrid-join-windows-current/4.png" alt-text="Снимок экрана средства просмотра событий. Выделено событие с I D 304, и отображаются сведения о нем с выделенным кодом ошибки и стадией." border="false":::
