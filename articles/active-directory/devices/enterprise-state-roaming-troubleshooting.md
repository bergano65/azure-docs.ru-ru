...
**Потенциальная ошибка**. Синхронизация может завершиться ошибкой, если администратор настроит службы федерации Active Directory (AD FS) политику условного доступа многофакторной проверки подлинности и срок действия маркера доступа на устройстве истекает. Убедитесь, что вы входите и выйдете с помощью Microsoft Passport for Work ПИН-кода или завершите многофакторную проверку подлинности во время доступа к другим службам Azure, таким как Microsoft 365.
