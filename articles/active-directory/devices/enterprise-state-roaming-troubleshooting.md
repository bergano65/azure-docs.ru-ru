...
Для расширенного поиска проблем можно использовать средство просмотра событий, чтобы находить конкретные ошибки. Они описаны в следующем разделе. События можно найти в разделе Просмотр событий > Applications and Services Logs > **Microsoft** > **Windows** > **журнале settingsync — Azure** и о проблемах, связанных с удостоверениями, с синхронизацией **Microsoft** > **Windows** > **AAD**.
...
**Рекомендованное действие**  
Пользователю будет необходимо отсоединить, а затем заново присоединить устройство к облаку. Для этого войдите в систему как пользователь с правами локального администратора и отсоедините устройство, последовательно выбрав **Параметры** > **система** > **и щелкните** "Управление или отключение от рабочего или учебного заведения". Очистите приведенные ниже файлы, а затем снова присоедините устройство к Azure AD в окне " **Параметры** > **System** > **" и выберите** "подключиться к рабочему или учебному заведению". Продолжайте присоединение устройства к Azure Active Directory и завершите процесс.
