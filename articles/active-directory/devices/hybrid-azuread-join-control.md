...
1. Щелкните правой кнопкой мыши конечный объект **CN = 62a0ff2e-97b9-4513-943f-0d221bd30080** и выберите пункт **свойства** .
...
1. Измените объект групповой политики и откройте следующий путь: параметры **конфигурации компьютера**  >  **Preferences**  >  **Реестр настройки Windows**  >  **Registry**
1. Щелкните Реестр правой кнопкой мыши и выберите пункт **создать**  >  **элемент реестра** .
   1. На вкладке **Общие** настройте следующие параметры.
      ...
      1. Значение данные: идентификатор GUID или **идентификатор каталога** экземпляра Azure AD (это значение можно найти в **портал Azure**  >  **Azure Active Directory**  >  **Свойства**,  >  **идентификатор каталога**).
   1. Нажмите кнопку **ОК**.
1. Щелкните Реестр правой кнопкой мыши и выберите пункт **создать**  >  **элемент реестра** .
   1. На вкладке **Общие** настройте следующие параметры.
      1. Действие: **Обновление**
      ...
      1. Тип значения: **REG_SZ**
      1. Value data (значение). имя проверенного **домена** , если используется Федеративная среда, например AD FS. Имя проверенного **домена** или имя домена onmicrosoft.com, например, `contoso.onmicrosoft.com` Если используется управляемая среда
   1. Нажмите кнопку **ОК**.
