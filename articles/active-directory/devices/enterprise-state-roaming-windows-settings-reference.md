...
| Тип учетной записи и операция | удаленных | Мобильные службы |
| --- | --- | --- |
...
![Настройки](./media/enterprise-state-roaming-windows-settings-reference/active-directory-enterprise-state-roaming-ie.png)
...
| Настройки | удаленных | Мобильные службы | Группа |
| --- | --- | --- | --- |
...
| **Список приложений**: список установленных приложений |X |резервное копирование |Прочее |
...
| **Персонализация рабочего стола**: макет начального экрана |X |резервное копирование | |
...
| **Язык**: QWERTY (CHS) — нечеткий пиньинь |sync |резервное копирование |Язык |
| **Язык**: QWERTY (CHS) — нечеткие пары |sync |резервное копирование |Язык |
...
| **Язык**: язык профиля |sync |резервное копирование |Язык |
| **Язык**: проверка орфографии — автозамена и выделение опечаток |sync |резервное копирование |Язык |
| **Язык**: список клавиатур |sync |резервное копирование |Язык |
...
| **Ввод**: орфографический словарь |sync |резервное копирование |Язык |
| **Ввод**: автозамена слов с ошибками |sync |резервное копирование |Язык |
| **Ввод**: выделение слов с ошибками |sync |резервное копирование |Язык |
| **Ввод**: отображение текстовых предложений при вводе |sync |резервное копирование |Язык |
| **Ввод**: добавление пробела после выбора текстового предложения |sync |резервное копирование |Язык |
| **Ввод**: добавление точки после двойного касания пробела |sync |резервное копирование |Язык |
| **Ввод**: написание каждого предложения с прописной буквы |sync |резервное копирование |Язык |
| **Ввод**: использование прописных букв после двойного нажатия клавиши SHIFT |sync |резервное копирование |Язык |
| **Ввод**: воспроизведение звуков клавиш при вводе |sync |резервное копирование |Язык |
| **Ввод**: данные персонализации для сенсорной клавиатуры |sync |резервное копирование |Язык |
