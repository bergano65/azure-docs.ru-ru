...
| **Расширенное мобильное широкополосное**подключение: сетевое имя общего доступа к подключению к Интернету (включает автоматическое обнаружение точек подключения Wi-Fi мобильных устройств через Bluetooth) |X |X |паролей |
...
| **Список приложений**: список установленных приложений |X |резервная копия |Другой |
