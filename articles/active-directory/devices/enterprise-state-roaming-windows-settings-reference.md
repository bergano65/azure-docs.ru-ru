...
| Тип учетной записи и операция | Рабочий стол | Мобильные службы |
| --- | --- | --- |
...
| Параметры | Рабочий стол | Мобильные службы | Группа |
| --- | --- | --- | --- |
| **Учетные записи**: аватар |sync |X |Тема |
| **Учетные записи**: другие параметры учетных записей |X |X | |
| **Расширенное мобильное широкополосное**подключение: сетевое имя общего доступа к подключению Интернета (включает автоматическое обнаружение точек подключения мобильных Wi-Fi через Bluetooth) |X |X |Пароли |
...
| **Устройства**: общие принтеры, к которым подключен компьютер |X |X |иное |
...
| **Мышь**: изменение размера указателя мыши |sync |X |иное |
| **Мышь**: изменение цвета указателя мыши |sync |X |иное |
