...
| Тип учетной записи и операция | Классические приложения | Мобильный |
| --- | --- | --- |
...
| Параметры | Классические приложения | Мобильный | Группа |
| --- | --- | --- | --- |
...
| **Дата, время и регион**: автоматическая коррекция времени (синхронизация с временем Интернета) |sync |sync |language |
| **Дата, время и регион**: 24-часовой формат |sync |X |language |
| **Дата, время и регион**: дата и время |sync |X |language |
| **Дата, время и регион**: часовой пояс | |X |language |
| **Дата, время и регион**: летнее время |sync |X |language |
| **Дата, время и регион**: страна или регион |sync |X |language |
| **Дата, время и регион**: первый день недели |sync |X |language |
| **Дата, время и регион**: региональные стандарты (языковой стандарт) |sync |X |language |
| **Дата, время и регион**: краткий формат даты |sync |X |language |
| **Дата, время и регион**: полный формат даты |sync |X |language |
| **Дата, время и регион**: краткий формат времени |sync |X |язык |
| **Дата, время и регион**: полный формат времени |sync |X |language |
