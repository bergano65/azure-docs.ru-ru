...
|   |   |
|---|---|
|![службы "Функции Azure"][1]|Изучение сценариев|
|![службы "Функции Azure"][1]|Изучение инфраструктуры удостоверений|
|![службы "Функции Azure"][1]|Оценка управления устройствами|
|![службы "Функции Azure"][1]|Рекомендации для приложений и ресурсов|
|![службы "Функции Azure"][1]|Изучение вариантов подготовки|
|![службы "Функции Azure"][1]|Настройка службы Enterprise State Roaming|
|![службы "Функции Azure"][1]|Настройка условного доступа|
...
> [Присоединяйтесь к новому устройству Windows 10 с помощью Azure AD во время первого запуска](azuread-joined-devices-frx.md)
