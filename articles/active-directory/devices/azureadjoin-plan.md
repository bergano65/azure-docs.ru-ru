...
|   |   |
|---|---|
|![Флажок][1]|Изучение сценариев|
|![Флажок][1]|Изучение инфраструктуры удостоверений|
|![Флажок][1]|Оценка управления устройствами|
|![Флажок][1]|Рекомендации для приложений и ресурсов|
|![Флажок][1]|Изучение вариантов подготовки|
|![Флажок][1]|Настройка службы Enterprise State Roaming|
|![Флажок][1]|Настройка условного доступа|
...
1. Выберите поставщика MDM из списка.
   ...
   ![Добавить приложение](./media/azureadjoin-plan/04.png)
...
![Добавить приложение](./media/azureadjoin-plan/06.png)
...
![Соответствующее устройство](./media/azureadjoin-plan/46.png)
