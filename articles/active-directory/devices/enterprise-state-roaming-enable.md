...
| -------------------- | ------------------------ |
| Страна/регион EMEA, такие как Франция или Замбия | Один или несколько регионов Azure в Европе |
| Североамериканская страна/регион, такие как США или Канада | Один или несколько регионов Azure в США |
| Страна/регион APAC, такие как Австралия или Новая Зеландия | Один или несколько регионов Azure в Азии |
...
* Если пользователь отключил синхронизацию настроек на всех своих устройствах, то ни одна из данных настроек не будет доступна, и все данные настроек для этого пользователя станут устаревшими и могут быть удалены после периода хранения. 
