...
> [!NOTE]
> Сторонние поставщики удостоверений должны поддерживать протокол WS-Trust, чтобы включить выдачу PRT на устройствах Windows 10. Без протокола WS-Trust маркер PRT нельзя выдавать пользователям с гибридным присоединением к Azure AD или устройствам, присоединенным к Azure AD.
