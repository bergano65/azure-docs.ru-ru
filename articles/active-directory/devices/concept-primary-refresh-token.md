...
В этих сценариях подключаемый модуль Azure AD WAM является основным центром для PRT, так как вход в систему Windows не происходит с этой учетной записью Azure AD.
