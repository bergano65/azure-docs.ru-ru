...
ms.locfileid: "54118512"
---
# <a name="tutorial-configure-hybrid-azure-active-directory-joined-devices-manually"></a>Руководство. Настройка устройств с гибридным присоединением к Azure Active Directory 
...
> [!TIP]
> Если вы можете использовать Azure AD Connect, ознакомьтесь с разделом [Select your scenario](hybrid-azuread-join-plan.md#select-your-scenario) (Выбор сценария). С помощью Azure AD Connect можно упростить настройку гибридного присоединения к Azure AD.
...
![Список доменов компании](./media/hybrid-azuread-join-manual-steps/01.png)
...
![Кнопка "Все", которая позволяет пользователям регистрировать устройства](./media/hybrid-azuread-join-manual-steps/23.png)
