...
* *Пароли*, включая пароли в Интернете, профили Wi-Fi и другие.
...
2. После получения идентификатора GUID необходимо добавить раздел реестра **HKEY_LOCAL_MACHINE \софтваре\микрософт\виндовс\сеттингсинк\винмсипк \<tenant ID GUID> **.
