...
**Вопрос. Поддерживает ли регистрация устройства Windows 10 в Azure AD доверенных платформенных модулей в режиме FIPS?**
...
**Вопрос. Что произойдет, если пользователь меняет свой пароль и попытается войти в свои гибридные Windows 10 Azure AD устройства, присоединенные к за пределами корпоративной сети?**
