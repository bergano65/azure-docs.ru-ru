...
У удаленных или отключенных пользователей, которые еще не вошли, не будет доступа к устройству, так как для них нет кэшированных данных для входа в систему. 
