...
**Вопрос. Мной недавно было зарегистрировано устройство. Почему оно отсутствует в моих сведениях о пользователе на портале Azure? Или почему отсутствуют сведения о владельце устройства для гибридных устройств, присоединенных к Azure AD?**
...
**Ответ.** На портале Azure откройте представление "Все устройства" и найдите устройство по его идентификатору. Посмотрите значение в столбце "Тип соединения". Иногда может оказаться, что выполнялся сброс устройства или его восстановление из образа. Таким образом, важно также проверить состояние регистрации устройства на самом устройстве:
...
**Вопрос. Могут ли мои пользователи входить на подключенных к Azure AD устройствах, которые были удалены или отключены в Azure AD?**
...
У пользователей, которые еще не вошли, не будет доступа к устройству, так как для них нет кэшированного входа в систему. 

---

**Вопрос. Могут ли отключенные или удаленные пользователи входить на устройствах, подключенных к Azure AD?**
...
У удаленных или отключенных пользователей, которые еще не вошли, не будет доступа к устройству, так как для них нет кэшированного входа в систему. 
...
**Ответ.** Причина этого в настройке регистрации Azure Active Directory с помощью Intune. Убедитесь в том, что пользователь, который пытается выполнить операцию присоединения к Azure AD, имеет правильно назначенную лицензию Intune. См. дополнительные сведения о [настройке управления устройствами Windows](https://docs.microsoft.com/intune/deploy-use/set-up-windows-device-management-with-microsoft-intune#azure-active-directory-enrollment).  

---

**Вопрос. Почему мне не удается присоединить компьютер к Azure AD, хотя никакие сообщения об ошибке не отображаются?**
...
- [Устранение неполадок автоматической регистрации присоединенных к домену Azure AD компьютеров для Windows 10 и Windows Server 2016](troubleshoot-hybrid-join-windows-current.md)

- [Устранение неполадок автоматической регистрации присоединенных к домену Azure AD компьютеров для клиентов Windows нижнего уровня](troubleshoot-hybrid-join-windows-legacy.md)
