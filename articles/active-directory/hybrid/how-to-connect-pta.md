...
- *Удобство работы для пользователей*
  ...
  - Пользователи могут выполнять задачи [самостоятельного управления паролями](../authentication/concept-sspr-howitworks.md) в облаке.
...
- Эта функция легко работает с функциями [условного доступа](../conditional-access/overview.md) , такими как многофакторная идентификация (MFA) для защиты пользователей.
- Она интегрирована с [самостоятельным управлением паролями](../authentication/concept-sspr-howitworks.md) на основе облака, включая обратную запись паролей в локальный каталог Active Directory и защиту пароля с помощью запрета часто используемых паролей.
