...
### <a name="connect-your-directories"></a>Подключить каталоги
...
### <a name="domain-and-ou-filtering"></a>Фильтрация доменов и подразделений
...
### <a name="optional-features"></a>Дополнительные возможности
...
>
>Дополнительные сведения о службе контроля доступа Azure см в [руководстве по переносу из службы контроля доступа Azure](../develop/active-directory-acs-migration.md).
>
...
![Дополнительные возможности](./media/how-to-connect-install-custom/optional2.png)
...
| Обратная запись устройства |Позволяет выполнять обратную запись объектов устройств в Azure AD в локальную Active Directory для сценариев условного доступа. Дополнительные сведения см. в статье [Azure AD Connect: включение обратной записи устройств](how-to-connect-device-writeback.md). |
...
![Расширения каталога](./media/how-to-connect-install-custom/extension2.png)
...
![Подтвердить домен](./media/how-to-connect-install-custom/ping1.png)
...
![Подтвердить домен](./media/how-to-connect-install-custom/ping2.png)
...
![Готов](./media/how-to-connect-install-custom/completed.png)

![Проверьте](./media/how-to-connect-install-custom/adfs7.png)
