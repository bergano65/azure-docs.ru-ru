...
| Обратная запись устройств |Позволяет выполнять обратную запись объектов устройств в Azure AD в локальной Active Directory для всех сценариев условного доступа. Дополнительные сведения см. в статье [Azure AD Connect: включение обратной записи устройств](how-to-connect-device-writeback.md). |
