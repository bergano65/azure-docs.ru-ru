...
![Снимок экрана: область для выбора федерации с AD FS.](media/tutorial-federation/fed1.png)
...
![Снимок экрана: область выбора созданного файла сертификата.](media/tutorial-federation/fed2.png)
