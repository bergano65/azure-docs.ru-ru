...
Определенные параметры, такие как [усервритебакк в Azure AD Connect](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-preview#user-writeback) , не поддерживаются. Отключите в параметрах. 
