---
title: 'Azure AD Connect выполняет следующие функции: выражения декларативной подготовки | Документация Майкрософт'
...
ms.locfileid: "55489484"
---
# <a name="azure-ad-connect-sync-understanding-declarative-provisioning-expressions"></a>Синхронизация Azure AD Connect: Знакомство с выражениями декларативной подготовки.
...
* Строковые константы заключены в кавычки: например, "Contoso" (обратите внимание, что необходимо использовать прямые (""), а не парные (“”) кавычки).
