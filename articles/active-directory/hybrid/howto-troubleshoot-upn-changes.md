...
> [!NOTE]
> Разработчикам рекомендуется использовать идентификатор objectID пользователя в качестве неизменяемого идентификатора, а не UPN. Если в ваших приложениях используется имя участника-пользователя, рекомендуется задать имя участника-пользователя в соответствии с основным адресом электронной почты пользователя, чтобы улучшить их работу.<br> **В гибридной среде важно, чтобы имя участника-пользователя совпадало в локальном каталоге и в Azure Active Directory**.
...
BSimon@contoso.com дляBJohnson@contoso.com

   * Вы также можете изменить корпоративный стандарт для префиксов:  
Bsimon@contoso.com дляBritta.Simon@contoso.com
...
Изменение имени участника-пользователя при каждом обновлении основного адреса электронной почты пользователя. Независимо от причины изменения электронной почты имя участника-пользователя всегда должно быть обновлено для соответствия.
