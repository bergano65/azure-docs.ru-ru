...
## <a name="apps-known-issues-and-workarounds"></a>Приложения известные проблемы и обходные пути
...
Если вы являетесь разработчиком, подумайте о [добавлении поддержки SCIM в приложение](https://docs.microsoft.com/azure/active-directory/app-provisioning/use-scim-to-provision-users-and-groups) для автоматической подготовки пользователей из Каталога Активных Azure. 
...
Если пользователи входят в Windows до того, как новый UPN был синхронизирован с Azure AD, или продолжают использовать существующую сессию Windows, они могут столкнуться с проблемами одного вступления в систему с приложениями, которые используют Azure AD для проверки подлинности, если условный доступ был настроен для обеспечения использования гибридных устройств для доступа к ресурсам. 
...
* Регистрация устройств (также известная как Workplace Join) в Azure AD, что является требованием для других функций, таких как Intune App Protection и Device Enrolment/Management,
