...
- **Управляемые удостоверения** — это учетные записи пользователей и групп, которые синхронизируются из локального каталога Active Directory. В этом случае аутентификацией пользователей управляет облако Azure.   
...
>
> <sup>3</sup> Федеративный единый вход и AD FS.
>
