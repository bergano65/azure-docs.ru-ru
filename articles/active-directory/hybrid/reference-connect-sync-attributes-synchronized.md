...
| Имя атрибута | Пользователь | Контакт | Группировать | Комментарий |
| --- |:---:|:---:|:---:| --- |
| AccountEnabled |X | | |Определяет, включена ли учетная запись. |
| assistant |X |X | | |
...
| Имя атрибута (локальная служба AD) | Имя атрибута (пользовательский интерфейс Connect) | Пользователь | Контакт | Группировать | Комментарий |
| --- |:---:|:---:|:---:| --- |---|
