...
3. Условный доступ для приложений Office 365 с помощью Microsoft Intune: ИТ-аналитики могут предоставлять политики устройств условного доступа для обеспечения безопасности корпоративных ресурсов, в то же время позволяя информационным работникам на совместимых устройствах получать доступ к службам. 
