...
3. Условный доступ для приложений Office 365 с Microsoft Intune: ИТ администраторы могут подготавливать политики условного доступа для защиты корпоративных ресурсов, в то же время позволяя информационным работникам на соответствующих устройствах получать доступ к службам. 
