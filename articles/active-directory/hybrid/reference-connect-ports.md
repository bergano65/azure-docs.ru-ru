...
| SMB | 445 (TCP/UDP) |Используется функцией простого единого входа для создания учетной записи компьютера в лесу AD. |
...
|WinRM  | 5985 (TCP/UDP) |Используется только при установке AD FS с помощью мастера Azure AD Connect gMSA|
|Веб-службы AD DS | 9389 (TCP/UDP) |Используется только при установке AD FS с помощью мастера Azure AD Connect gMSA |
