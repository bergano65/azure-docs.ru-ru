...
| Run (Запустить) |Используется для одноразового запуска профиля. |
| Стоп |Останавливает соединитель, на котором в настоящее время запущен профиль. |
...
6. Имя леса указывает на соответствующий локальный AD.
