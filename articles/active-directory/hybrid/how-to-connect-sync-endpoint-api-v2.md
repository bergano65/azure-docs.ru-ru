...
</br>Мы планируем создать новый выпуск AADConnect, который будет опубликован для загрузки в январе 2021. В этом выпуске по умолчанию будет использоваться конечная точка v2, а также будут включены группы синхронизации, превышающие 50 000 висуот любую дополнительную конфигурацию. Затем этот выпуск будет опубликован для автоматического обновления на соответствующих серверах.
