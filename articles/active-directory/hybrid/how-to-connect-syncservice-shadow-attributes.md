...
В этом случае **smtp:abbie.spencer\@fabrikam.com** был удален, так как этот домен не был проверен. Но Exchange также добавил **SIP:abbie.spencer\@fabrikamonline.com**. Fabrikam не использовал Lync или Skype локально, но Azure AD и Exchange Online готовы к этому.
