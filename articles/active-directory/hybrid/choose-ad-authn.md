...
> [!NOTE]
> Для изменения метода проверки подлинности требуется планирование, тестирование и потенциальное время простоя. [Промежуточное развертывание](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-staged-rollout) — это отличный способ протестировать переход пользователей из Федерации в облачную аутентификацию.
