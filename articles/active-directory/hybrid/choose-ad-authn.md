...
> [!NOTE]
> Для изменения метода проверки подлинности требуется планирование, тестирование и потенциальное время простоя. [Промежуточное развертывание](https://docs.microsoft.com/azure/active-directory/hybrid/how-to-connect-staged-rollout) — отличный способ тестирования и постепенного перехода с федерации на проверку подлинности в облаке.
