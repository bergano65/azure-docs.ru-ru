...
* В windows Event Viewer журнал событий приложения содержит ошибку с **Event ID 6000** и **сообщением «Агент управления «contoso.com» не удалось запустить, потому что учетные данные были недействительными».**
