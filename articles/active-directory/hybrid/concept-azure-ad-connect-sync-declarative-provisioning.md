...
![Снимок экрана, на котором показан раздел "Добавление преобразований" с открытым раскрывающимся меню "типы слияния".](./media/concept-azure-ad-connect-sync-declarative-provisioning/mergetype.png)  
