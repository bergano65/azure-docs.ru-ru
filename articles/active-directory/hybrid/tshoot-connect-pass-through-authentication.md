---
title: 'Azure AD Connect выполняет следующие функции: Устранение неполадок в работе сквозной аутентификации | Документация Майкрософт'
...
ms.author: billmath
ms.openlocfilehash: ff8dee910f6a89476a53bcaff6b7456da9403160
ms.sourcegitcommit: d3200828266321847643f06c65a0698c4d6234da
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 01/29/2019
ms.locfileid: "55178619"
---
...
| 80005 | Агент проверки подлинности. Произошла ошибка. | Это временная проблема. Повторите попытку позже.
...
Если у вашего клиента включена сквозная аутентификация и вы пытаетесь удалить Azure AD Connect, появится следующее предупреждающее сообщение: "Пользователи не смогут войти в Azure AD, если на других серверах не установлены другие агенты сквозной аутентификации".
...
Описание ошибки (1328 в приведенном выше примере) можно получить, открыв окно командной строки и выполнив следующую команду. Примечание. Необходимо будет заменить число "1328" номером ошибки, которая отображается в ваших журналах).
