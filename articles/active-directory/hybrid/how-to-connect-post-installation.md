...
Если необходимо выполнить задачу синхронизации, это можно сделать следующим образом.

1. Дважды щелкните ярлык рабочего стола Azure AD Connect, чтобы запустить мастер.
2. Щелкните **Настройка**.
3. На экране задачи выберите **Параметры настройки синхронизации** и нажмите кнопку **Далее** .
4. Введите учетные данные Azure AD.
5. Щелкните **Далее**. Щелкните **Далее**.  Щелкните **Далее**.
5.  На экране **все готово для настройки** убедитесь, что установлен флажок **запустить процесс синхронизации при завершении настройки** .
6.  Щелкните **Настройка**.

Дополнительные сведения о планировщике синхронизации Azure AD Connect см. в разделе [планировщик Azure AD Connect](how-to-connect-sync-feature-scheduler.md).
...
|**Изменение входа пользователя**|Изменение метода проверки подлинности, который пользователи используют для входа|
|**Управление интеграцией**|Управление инфраструктурой AD FS, продление сертификатов и добавление серверов AD FS|
|**Устранение неполадок**|Справка по устранению неполадок Azure AD Connect|
