...
ms.locfileid: "69900058"
---
# <a name="azure-ad-connect-staging-server-and-disaster-recovery"></a>Azure AD Connect выполняет следующие функции: Промежуточный сервер и аварийное восстановление
