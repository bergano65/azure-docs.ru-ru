...
* Файл .pfx с одним сертификатом TLS/SSL для вашего предполагаемого имени службы федерации. например fs.contoso.com.
...
| Штат | Описание | Требуется действие |
|:--- |:--- |:--- |
...
| Штат | Влияние на процесс входа пользователей в Azure |
|:---:|:--- |
...
- Узнайте больше о [концепциях дизайна Azure AD Connect.](plan-connect-design-concepts.md)
