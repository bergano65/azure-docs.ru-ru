...
3. Перейдите к **пользовательской конфигурации** > **политика** > **Административные шаблоны** > **компоненты Windows** > **Internet Explorer** > **панель** **управления Интернет > Страница «Безопасность**». Выберите **Список назначений зоны для веб-сайтов**.
...
6. Перейдите к **пользовательской конфигурации** > **политика** > **Административные шаблоны** > **компоненты Windows** > **Internet Explorer** > **панель** **управления Интернет > Страница безопасности** > **зона интрасети**. Выберите **Разрешить обновление строки состояния в сценарии**.
