...
ms.locfileid: "91306282"
---
# <a name="monitor-ad-fs-using-azure-ad-connect-health"></a>Мониторинг AD FS с помощью Azure AD Connect Health
Приведенная ниже информация относится к мониторингу инфраструктуры AD FS с помощью Azure AD Connect Health. Сведения о мониторинге Azure AD Connect (синхронизация) с Azure AD Connect Health см. в разделе [использование Azure AD Connect Health для синхронизации](how-to-connect-health-sync.md). Дополнительные сведения о мониторинге домен Active Directory служб с помощью Azure AD Connect Health см. в разделе [использование Azure AD Connect Health с AD DS](how-to-connect-health-adds.md).
...
![Снимок экрана со страницей Azure AD Connect Health "предупреждения" с выбранным оповещением и отображаемым окном "сведения о предупреждении".](./media/how-to-connect-health-adfs/alert2.png)
...
![Снимок экрана, на котором показана Azure AD Connect Healthная страница "аналитика использования".](./media/how-to-connect-health-adfs/report1.png)
...
|Группирование | Что означает группирование и почему это удобно? |
| --- | --- |
| All | Показывает общее число запросов, обработанных всеми серверами AD FS.|
...
|Группирование | Что означает группирование и почему это удобно? |
| --- | --- |
|All |Эта метрика обеспечивает подсчет среднего числа пользователей, использующих службу федерации в рамках выбранного интервала времени. Пользователи не группируются. <br>Среднее значение зависит от выбранного интервала времени. |
...
![Снимок экрана, на котором показана страница "Мониторинг" Azure AD Connect Health производительности.](./media/how-to-connect-health-adfs/perf1.png)
...
![Снимок экрана, показывающий раздел "Reports" с количеством неудачных попыток ввода пароля за последние 30 дней.](./media/how-to-connect-health-adfs/report1a.png)
...
| --- | --- |
| User ID |Здесь отображается использовавшийся идентификатор пользователя. Это значение, введенное пользователем. В некоторых случаях отображаются сведения об использовании неправильного идентификатора пользователя. |
