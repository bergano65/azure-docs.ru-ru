...
Приведенная ниже информация относится к мониторингу инфраструктуры AD FS с помощью Azure AD Connect Health. Для получения информации о мониторинге Azure AD Connect (Sync) с Azure AD Connect Health [см.](how-to-connect-health-sync.md) Кроме того, для получения информации о мониторинге служб домена Active Directory с azure AD Connect Health [см.](how-to-connect-health-adds.md)
...
* [Рискованный отчет по ИС](how-to-connect-health-adfs-risky-ip.md)
