---
title: 'Синхронизация Azure AD Connect: изменение конфигурации'
...
- До выхода версии 1.5.30.0 в Azure AD службе Azure AD Connect не разрешалось изменять атрибут UserType для существующих пользователей Azure AD. В ранних версиях атрибут задавался во время создания пользователей Azure AD. Изменить его позже [можно было с помощью PowerShell](/powershell/module/azuread/set-azureaduser?view=azureadps-2.0).
