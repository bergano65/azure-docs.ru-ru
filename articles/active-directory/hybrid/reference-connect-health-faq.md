...
**Вопрос. Какое влияние оказывает установка агента Azure AD Connect Health на отдельных серверах?**
...
**Вопрос. Потребуется ли перезагрузка серверов во время установки агентов Azure AD Connect Health?**
...
**Вопрос. Работает ли Azure AD Connect Health с помощью сквозного прокси-сервера HTTP?**
...
**Вопрос. Какие порты брандмауэра следует открыть для работы агента Azure AD Connect Health?**
...
**Вопрос. Как разрешаются оповещения Azure AD Connect Health?**
...
**Вопрос. Я получил сообщение электронной почты, указывающий на моих компьютерах не установлено исправление для недавних атак программ-шантажистов. Почему мне пришло это письмо?**
...
**Вопрос. Почему не создаются журналы аудита ADFS?**
...
**Вопрос. Когда сертификат агента будет автоматического обновленный до окончания срока действия?**
Агент сертификации будет производиться автоматически продлить **6 месяцев** перед истечением срока. Если она не была обновлена, убедитесь, что сетевое подключение агента стабильна. Перезапустите агент службы или обновление до последней версии также может решить проблему.
