...
Дополнительные сведения об управлении назначением групп для приложений см. в статье [способы назначения пользователей и групп для](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups) приложения.
...
3. Задайте необязательные утверждения для конфигурации имени группы.
   ...
   Если требуется, чтобы группы в токене содержали атрибуты on локальной группы AD, укажите, к какому типу токена следует применить обязательное утверждение в разделе дополнительные утверждения.  В списке можно указать несколько типов токенов:
...
[Методы назначения пользователей и групп для приложения](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups)
