...
Они устанавливаются на компьютере, на котором выполняется Azure AD Connectная синхронизация. Соединители предоставляют без агента возможность обратной передачи с помощью системных протоколов, а не полагаться на развертывание специализированных агентов. Это означает снижение риска и сокращение времени развертывания, особенно при работе с критически важными приложениями и системами.
