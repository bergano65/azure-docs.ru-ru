...
Они устанавливаются на компьютер под управлением синхронизации Azure AD Connect. Разъемы обеспечивают бесагентную способность общаться с помощью протоколов удаленной системы вместо того, чтобы полагаться на развертывание специализированных агентов. Это означает снижение риска и сокращение времени развертывания, особенно при работе с критически важными приложениями и системами.
