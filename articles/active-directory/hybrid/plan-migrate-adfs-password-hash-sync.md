---
title: 'Azure AD Connect выполняет следующие функции: Миграция из Федерации в PHS для Azure AD | Документация Майкрософт'
...
4. На странице **входа пользователей** нажмите кнопку **Синхронизация хэша паролей**. Выберите **Включить единый вход** и щелкните **Далее**.
   ...
   После включения синхронизации хэша паролей сделайте следующее: ![Снимок экрана, на котором показаны новые параметры на странице входа пользователя](media/plan-migrate-adfs-password-hash-sync/migrating-adfs-to-phs_image13.png)<br />
