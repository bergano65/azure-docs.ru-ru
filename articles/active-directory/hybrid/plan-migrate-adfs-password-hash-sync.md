...
Чтобы обеспечить работу гибридного соединения для всех устройств, присоединенных к домену после преобразования доменов в синхронизацию хэшей паролей, для клиентов Windows 10 необходимо использовать параметры Azure AD Connect устройства для заполнения SCP и последующей синхронизации. Учетные записи компьютеров каталога в Azure AD. 
...
4. На странице **входа пользователей** нажмите кнопку **Синхронизация хэша паролей**. Выберите **Включить единый вход** и щелкните **Далее**.
   ...
   Перед включением синхронизации хэшей паролей: ![Screenshot, на которой отображается параметр не настраивать на странице входа пользователя ](media/plan-migrate-adfs-password-hash-sync/migrating-adfs-to-phs_image12.png)<br />

   После включения синхронизации хэшей паролей: ![Screenshot, на которой отображаются новые параметры на странице входа пользователя ](media/plan-migrate-adfs-password-hash-sync/migrating-adfs-to-phs_image13.png)<br />
