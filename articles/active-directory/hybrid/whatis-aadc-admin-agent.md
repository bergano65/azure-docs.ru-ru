...
ms.locfileid: "58488407"
---
# <a name="what-is-the-azure-ad-connect-admin-agent"></a>Что такое агент Azure AD Connect администратора? 
...
Если вы не хотите инженер поддержки Майкрософт для доступа к данным для позвонить в службу поддержки, это можно указать при открытии поддержку вызова на портале: 
