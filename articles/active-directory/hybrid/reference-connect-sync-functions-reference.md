...
**Примечания**  
Возможные значения для формата можно найти здесь: [пользовательские форматы даты и времени для функции Format](https://docs.microsoft.com/dax/custom-date-and-time-formats-for-the-format-function).
