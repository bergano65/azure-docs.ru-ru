...
**Примечания:**  
Возможные значения для формата представлены здесь: [Форматы даты и времени, определенные пользователем (функция Format)](https://msdn2.microsoft.com/library/73ctwf33\(VS.90\).aspx).
