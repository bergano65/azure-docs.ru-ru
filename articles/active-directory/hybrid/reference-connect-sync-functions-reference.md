...
* **exp** — выражение, результат вычисления которого должен иметь логический тип;
...
* **ref** — ссылка.
* **str** — строка.
* **var** — вариант практически любого другого типа;
...
| [CRef](#cref) |[CStr](#cstr) |[StringFromGuid](#stringfromguid) |[СтрингФризсид](#stringfromsid) | |
| **Дата и время** | | | | |
...
| [Isnull](#isnull) |[IsNullOrEmpty](#isnullorempty) |[Иснумерика](#isnumeric) |[IsPresent](#ispresent) | |
| [IsString](#isstring) | | | | |
| **Math** | | | | |
| [BitAnd](#bitand) |[BitOr](#bitor) |[RandomNum](#randomnum) | | |
| **Функции с несколькими значениями:** | | | | |
| [Содержит](#contains) |[Рассчитывать](#count) |[Item](#item) |[ItemOrNull](#itemornull) | |
| [Присоединение](#join) |[RemoveDuplicates](#removeduplicates) |[Split](#split) | | |
| **Program Flow** | | | | |
| [Ошибка](#error) |[Iif](#iif) |[Выбрать](#select) |[Переключатель](#switch) | |
| [Где](#where) |[С](#with) | | | |
| **Text** | | | | |
| [Guid](#guid) |[Instr](#instr) |[InStrRev](#instrrev) |[LCase](#lcase) | |
| [Левой](#left) |[Лен](#len) |[Ltrim](#ltrim) |[Mid](#mid) | |
| [PadLeft](#padleft) |[PadRight](#padright) |[PCase](#pcase) |[Replace](#replace) | |
| [ReplaceChars](#replacechars) |[Right](#right) |[Rtrim](#rtrim) |[Обрезать](#trim) | |
...
**Примечания:**  
Возможные значения для формата можно найти здесь: [Пользовательские даты и временные форматы для функции FORMAT.](https://docs.microsoft.com/dax/custom-date-and-time-formats-for-the-format-function)
...
* Цель может содержать несколько знаков, например ö:oe, β:ss.
...
* [Синхронизация Azure AD: Настройка вариантов синхронизации](how-to-connect-sync-whatis.md)
