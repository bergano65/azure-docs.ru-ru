...
**В. Если я отключил Синхронизированное устройство (например: ХААДЖ) в портал Azure, почему она снова включена?**<br>
...
**В. Если я заблокировал вход пользователя на портале Office 365 или Azure AD для синхронизированных пользователей, почему он разблокируется при повторном входе?**<br>
