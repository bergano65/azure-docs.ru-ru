...
Службы синхронизации Azure AD Connect работают под учетной записью службы, созданной мастером установки. Эта учетная запись службы содержит ключи шифрования для базы данных, используемой службой синхронизации. Он создается с длинным паролем в 127 символов, а пароль имеет неограниченный срок действия.
