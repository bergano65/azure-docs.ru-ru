...
Службы синхронизации Azure AD Connect работают под учетной записью службы, созданной мастером установки. Эта учетная запись службы содержит ключи шифрования базы данных, используемые синхронизацией. Он создан с 127 символов длинный пароль и пароль установлен не истекает.
