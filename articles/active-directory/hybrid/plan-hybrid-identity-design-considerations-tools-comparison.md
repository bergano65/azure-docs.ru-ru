...
> [!NOTE]
> Azure AD Connect включает компоненты и функциональность, ранее выпущенные как Dirsync и AAD Sync. Эти инструменты больше не выпускаются по отдельности, и все будущие улучшения будут включены в обновления для Azure AD Connect, так что вы всегда знаете, где получить наиболее актуальную функциональность.
> 
> Компоненты DirSync и Azure AD Sync являются устаревшими. Дополнительные сведения см. [здесь](reference-connect-dirsync-deprecated.md).
> 
> 
...
| Компонент | Подключение Azure Active Directory | Службы синхронизации Azure Active Directory (AAD Sync) больше не поддерживаются | Средство синхронизации Azure Active Directory (DirSync) больше не поддерживается | Forefront Identity Manager 2010 R2 (FIM) | Microsoft Identity Manager 2016 (MIM) |
|:--- |:---:|:---:|:---:|:---:|:---:|
...
| Компонент | Подключение Azure Active Directory | Службы синхронизации Azure Active Directory больше не поддерживаются  | Средство синхронизации Azure Active Directory (DirSync) больше не поддерживается  | Forefront Identity Manager 2010 R2 (FIM) | Microsoft Identity Manager 2016 (MIM) |
|:--- |:---:|:---:|:---:|:---:|:---:|
...
| Компонент | Подключение Azure Active Directory | Службы синхронизации Azure Active Directory больше не поддерживаются  | Средство синхронизации Azure Active Directory (DirSync) больше не поддерживается  | Microsoft Identity Manager 2016 (MIM) |
|:--- |:---:|:---:|:---:|:---:|
