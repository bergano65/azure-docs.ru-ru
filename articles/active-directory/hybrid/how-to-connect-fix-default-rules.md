...
Обратите внимание, что в измененном `msExchMailboxGuid` правиле атрибут изменяется на тип **выражения** , а не на **Direct**. Кроме того, значение изменяется на **null** и параметр **ексекутеонце** . Можно игнорировать идентифицированные и приоритетные различия. 
