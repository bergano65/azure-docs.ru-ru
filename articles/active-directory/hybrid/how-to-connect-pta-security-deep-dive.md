...
Агенты аутентификации устанавливаются и регистрируются в Azure AD, если:
   - [Включение сквозной проверки подлинности с помощью Azure AD Connect](https://docs.microsoft.com/azure/active-directory/connect/active-directory-aadconnect-pass-through-authentication-quick-start#step-2-enable-the-feature)
...
Только глобальные администраторы могут установить агент аутентификации (с использованием Azure AD Connect или в виде изолированного развертывания) на локальном сервере. При установке добавляются две новые записи **Control Panel**в список программ  >  **Programs**  >  **и компонентов** панели управления "программы":
