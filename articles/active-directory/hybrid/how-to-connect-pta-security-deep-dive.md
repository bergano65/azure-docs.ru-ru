...
Только глобальные администраторы могут установить агент аутентификации (с использованием Azure AD Connect или в виде изолированного развертывания) на локальном сервере. При установке добавляются две новые записи в список программ**и компонентов** **панели** > **Programs** > управления "программы":
