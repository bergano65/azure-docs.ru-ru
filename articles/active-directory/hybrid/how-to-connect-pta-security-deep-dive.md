...
- **Агент аутентификации Azure AD Connect**. Локальный компонент, который ожидает передачи запросов на проверку пароля и отвечает на них.
- **База данных SQL Azure**. Содержит сведения об агентах аутентификации клиента, включая их метаданные и ключи шифрования.
