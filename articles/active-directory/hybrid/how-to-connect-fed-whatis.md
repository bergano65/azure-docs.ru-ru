...
В этой статье содержатся сведения о функциях службы Azure AD Connect, относящихся к федерации, и приводятся ссылки на все связанные статьи. Для ссылок на Azure AD Connect [см. Интеграция ваших предпосылок с помощью Active Directory Azure Active.](whatis-hybrid-identity.md)
...
| [Федеративс с Azure AD с помощью альтернативного идентификатора входа](how-to-connect-fed-management.md#alternateid) | Настройка федерации с использованием альтернативного имени пользователя.  |
| **Изменение конфигурации AD FS** | |
| [Ремонт доверия](how-to-connect-fed-management.md#repairthetrust) |Восстановление текущих отношений доверия между локальной службой AD FS и Office 365 или Azure. |
...
| [Обновление сертификата TLS/SSL](how-to-connect-fed-ssl-update.md)| Обновление сертификата TLS/SSL для фермы AD FS. |
...
| [Изменение правил претензии AD FS](how-to-connect-fed-management.md#modclaims) |Изменение или добавление правил утверждений в AD FS в соответствии с настройками синхронизации Azure AD Connect. |
