...
Чтобы включить альтернативное имя пользователя в Azure AD, не нужно дополнительно ничего настраивать, если включен Azure AD Connect. Альтернативное имя пользователя можно настроить непосредственно из мастера. Смотрите конфигурацию регистрации Azure AD для пользователей в разделе Sync. В соответствии с выпадающим **именем основного пользователя,** выберите атрибут для альтернативного идентификатора входа.
