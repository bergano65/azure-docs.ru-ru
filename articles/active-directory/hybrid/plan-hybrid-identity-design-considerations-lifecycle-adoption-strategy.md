...
| Этап управления жизненным циклом | В локальной среде | Облако | Гибридная среда |
| --- | --- | --- | --- |
...
RBAC Azure AD позволяет компании ограничить количество операций, которые может выполнять человек, после того как у них будет доступ к портал Azure. Используя RBAC для управления доступом к порталу, ИТ-администраторы могут применить такие методы управления доступом:
