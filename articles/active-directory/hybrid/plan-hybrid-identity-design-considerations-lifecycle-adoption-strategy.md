...
| Этап управления жизненным циклом | Локально | Облако | Гибридные |
| --- | --- | --- | --- |
...
Azure AD RBAC позволяет ограничить количество операций, которые пользователь может выполнить, когда они имеют доступ к порталу Azure компании. Используя RBAC для управления доступом к порталу, ИТ-администраторы могут применить такие методы управления доступом:
...
* Администраторы могут указать, что условного доступа на основе ресурса приложения, устройства и удостоверение пользователя, сетевого расположения и многофакторной проверки подлинности.
