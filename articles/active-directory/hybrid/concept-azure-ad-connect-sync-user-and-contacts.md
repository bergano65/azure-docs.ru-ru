...
* Azure AD Connect не поддерживает синхронизацию [динамических групп рассылки](/Exchange/recipients/dynamic-distribution-groups/dynamic-distribution-groups) в Azure AD.
