...
* Коллекция версии .NET.
* Улучшение сбора данных счетчиков производительности при отсутствии определенных категорий.
* Исправление ошибки, предотвращению, запускающая нескольких экземпляров Monitoring Agent.

* Агент Azure AD Connect Health для AD FS (версия 3.1.41.0) 
* Интеграция и обновление с помощью ADFSToolBox скриптов тестирования AD FS.
* Коллекция версии .NET.
* Улучшение сбора данных счетчиков производительности при отсутствии определенных категорий.
* Исправление ошибки, предотвращению, запускающая нескольких экземпляров Monitoring Agent.
...
* Реализована поддержка и обязательное использование протокола TLS версии 1.2.
* Снижено количество лишних оповещений о глобальном каталоге.
* Исправлены ошибки с регистрацией агента Health.

* Агент Azure AD Connect Health для AD FS (версия 3.1.24.0).
* Реализована поддержка и обязательное использование протокола TLS версии 1.2.
* Поддержка Test-ADFSRequestToken для локализованной версии операционной системы.
* Решить проблему с блокировкой EventHandler диагностики агента
* Исправлены ошибки с регистрацией агента Health.
