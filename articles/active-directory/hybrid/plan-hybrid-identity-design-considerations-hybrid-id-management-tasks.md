...
description: Azure AD проверяет конкретные условия, которые вы выбираете при проверке подлинности пользователя, и перед предоставлением доступа к приложению с помощью управления условным доступом.
documentationcenter: ''
