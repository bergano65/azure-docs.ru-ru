...
![Синхронизация каталогов ](./media/plan-hybrid-identity-design-considerations/Directory_synchronization.png) . для правильной разработки синхронизации решения для гибридной идентификации необходимо ответить на следующие вопросы:
