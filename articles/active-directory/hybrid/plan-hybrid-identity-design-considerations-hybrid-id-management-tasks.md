...
Распределение задач администрирования в организации повышает точность и эффективность администрирования и улучшает баланс рабочих нагрузок в организации. Ниже приведены основные аспекты, определяющие надежную систему управления идентификацией.
 ...
 ![соображения управления идентичностью](./media/plan-hybrid-identity-design-considerations/Identity_management_considerations.png)
...
![синхронизация](./media/plan-hybrid-identity-design-considerations/Directory_synchronization.png) каталога Для правильной синхронизации синхронизации вашего решения гибридной идентичности гарантирует, что ответы на следующие вопросы:
*    Какие решения синхронизации доступны для решения гибридной идентичности?
*    Каковы единственные знаки на возможности доступны?
*    Каковы варианты федерации идентификации между B2B и B2C?
