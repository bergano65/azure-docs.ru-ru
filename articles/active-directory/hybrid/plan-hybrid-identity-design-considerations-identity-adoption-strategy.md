...
![Поддерживаемая топология с](./media/plan-hybrid-identity-design-considerations/single-forest.png) одним лесом. обычно для больших и даже малых организаций используется несколько лесов, как показано на рис. 5.
...
* Взаимная исключительность применяется также к обратной записи.  В результате эта топология не будет поддерживать некоторые функции обратной записи, так как они предполагают наличие одной локальной конфигурации.  Сюда входят следующие возможности.
