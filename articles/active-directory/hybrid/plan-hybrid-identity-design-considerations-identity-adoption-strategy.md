...
![интеграционные сценарии](./media/plan-hybrid-identity-design-considerations/integration-scenarios.png)
...
![Поддерживаемые топологии](./media/plan-hybrid-identity-design-considerations/single-forest.png) Один лесной сценарий Он является общим для больших и даже малых организаций, чтобы иметь несколько лесов, как показано на рисунке 5.
...
![мульти-лес топология](./media/plan-hybrid-identity-design-considerations/multi-forest.png) 
...
![несколько арендаторов Azure AD](./media/plan-hybrid-identity-design-considerations/multiforest-multipleAzureAD.png) 
...
| Azure AD и локальная служба AD с использованием федерации в AD FS |both |
| Azure AD и локальная служба AD с использованием Azure AD Connect без синхронизации паролей |both |
| Azure AD и локальная служба AD с использованием Azure AD Connect с синхронизацией паролей |both |
