...
![Снимок экрана со страницей Azure AD Connect Health для синхронизации.](./media/how-to-connect-health-sync/syncsnapshot.png)
...
![Снимок экрана с предупреждением о том, что оценка предупреждений ограничена. Обновите параметры, чтобы включить все оповещения.](./media/how-to-connect-health-sync/banner.png)

Чтобы исправить это, в меню "Параметры" разрешите агенту Azure AD Connect Health передавать все журналы ошибок.

![Снимок экрана с вызываемым параметром параметров и разделом параметров с параметром сохранения и параметром ON, который был вызван как out.](./media/how-to-connect-health-sync/banner2.png)
...
![Снимок экрана: задержка профиля запуска за последние 3 дня.](./media/how-to-connect-health-sync/synclatency02.png)
...
![Снимок экрана со графом экспорта статистики в Azure AD за последние 3 дня.](./media/how-to-connect-health-sync/syncobjectchanges02.png)
