...
* Если вы используете путь установки пользовательских настроек, то у вас есть больше вариантов, [см. Учетные записи в Active Directory](reference-connect-accounts-permissions.md#custom-installation-settings)
