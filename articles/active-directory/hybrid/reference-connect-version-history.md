...
- Пользователи больше не могут создавать соединитель для домен Active Directory служб или Windows Azure Active Directory в старом пользовательском интерфейсе.
- Исправлена доступность пользовательских элементов управления пользовательского интерфейса в Service Manager синхронизации
...
- Добавлена ссылка на предупреждение для старого пользовательского интерфейса на странице свойств соединителя. 
...
- Исправлена ошибка PHS на промежуточном сервере, когда учетные данные соединителя обновляются в старом пользовательском интерфейсе. 
