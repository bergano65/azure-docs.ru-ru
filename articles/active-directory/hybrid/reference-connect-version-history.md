...
07.09.2018: выпущено для скачивания, не будет выпущено для автоматического обновления 
...
* Добавлен [промежуточный режим](how-to-connect-sync-operations.md#staging-mode)
