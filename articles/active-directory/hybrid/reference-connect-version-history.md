...
9/28/2019: Выпущено для автоматического обновления и выбора клиентов. Недоступно для скачивания.
...
### <a name="release-status"></a>Состояние выпуска
9/25/2019: Удалено из скачивания вручную до тех пор, пока не будет выполнено исследование инцидентов.
...
>
> Чтобы устранить эту проблему, необходимо импортировать модуль **AdSync** , а затем запустить командлет PowerShell @ no__t-1 на Azure AD Connect сервере.  Можно выполнить следующие действия.
>
