...
### <a name="release-status"></a>Состояние выпуска
9/25/2019: удалено из скачивания вручную, пока не будет завершено исследование инцидентов.
...
введите     | имя                          | Доступ               | Применяется к
---------|-------------------------------|----------------------|--------------|
...
Разрешение    | Administrators                | Полный доступ         | этому объекту  |
...
* Можно [выполнить обновление из DirSync](how-to-dirsync-upgrade-get-started.md)
