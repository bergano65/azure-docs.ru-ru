...
Некоторые компоненты, которые являются частью архитектуры гибридной идентификации ![архитектуры гибридной идентификации](./media/plan-hybrid-identity-design-considerations/hybrid-identity-architechture.png)
