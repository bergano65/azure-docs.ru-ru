...
3. Вызовите метод `AcquireTokenAsync(...)`, который принимает объект `IPlatformParameters` и будет вызывать поток проверки подлинности, необходимый для возврата маркера в приложение.
