---
title: Одноместные и мультитенантные приложения в Azure AD
...
* Проверьте приложение в наемщике, который настроил [политики условного доступа.](../azuread-dev/conditional-access-dev-guide.md)
