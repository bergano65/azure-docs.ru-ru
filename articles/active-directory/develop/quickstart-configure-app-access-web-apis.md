---
title: Краткое руководство. Доступ к веб-API из приложения (платформа удостоверений Майкрософт) | Azure
...
Для URI перенаправления применяются определенные ограничения. См. сведения об [ограничениях для URI перенаправления и URL-адресов ответа](https://docs.microsoft.com/azure/active-directory/develop/reply-url).
...
Чтобы узнать, как предоставить веб-API, перейдите к следующей статье.
...
* [Краткое руководство. Удаление приложения, зарегистрированного с помощью платформы удостоверений Майкрософт](quickstart-remove-app.md)
