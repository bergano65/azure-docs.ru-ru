...
> [!NOTE]
> Настоятельно рекомендуется использовать Microsoft Graph вместо API почты Office 365 и т. д.
