...
* Чтение полных профилей всех пользователей с помощью `User.Read.All`
* Запись данных в каталог организации с помощью `Directory.ReadWrite.All`
* Чтение всех групп в каталоге организации с помощью `Groups.Read.All`
