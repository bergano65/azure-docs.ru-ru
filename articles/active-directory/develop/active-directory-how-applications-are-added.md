...
* Использование API-изнаги Microsoft Graph или PowerShell для создания нового приложения
...
* Программно через Microsoft Graph API или PowerShell
...
![Отображает связь между объектами приложений и принципами обслуживания][apps_service_principals_directory]
...
* В настоящее время не все приведенные выше сведения предоставляются программно. Ниже перечислены только сведения, доступные в пользовательском интерфейсе:
  * утверждает правила преобразования.
  * Сопоставление атрибутов (подготовка пользователей)
* Более подробную информацию об основных объектах службы и объектах приложения можно узнать в справочной документации Microsoft GraphPI:
  * [Приложение](https://docs.microsoft.com/graph/api/resources/application?view=graph-rest-1.0)
  * [Директор службы](https://docs.microsoft.com/graph/api/resources/serviceprincipal?view=graph-rest-beta)
