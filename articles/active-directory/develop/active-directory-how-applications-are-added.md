...
* Когда пользователи входят в веб-службы Майкрософт, например [Microsoft 365](https://products.office.com/)
  * При оформлении подписки на Microsoft 365 или запуске пробной версии один или несколько субъектов-служб создаются в каталоге, представляющем различные службы, которые используются для предоставления всех функций, связанных с Microsoft 365.
  * Некоторые Microsoft 365 службы, такие как SharePoint, создают субъекты-службы на постоянной основе для обеспечения безопасного взаимодействия между компонентами, включая рабочие процессы.
