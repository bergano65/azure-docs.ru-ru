...
Если вы еще этого не сделали, создайте свое первое приложение, следуя краткому руководству по рабочему столу .NET или шаблону UWP.
...
- Вы можете использовать интерактивное получение маркера:
  ...
  - Если классическое приложение поддерживает графические элементы управления, например, если это приложение Windows. Form или приложение WPF.
