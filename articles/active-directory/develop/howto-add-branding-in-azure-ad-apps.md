...
description: Сведения о рекомендациях по фирменной символике приложений для платформы Microsoft Identity.
...
ms.locfileid: "90706206"
---
# <a name="branding-guidelines-for-applications"></a>Рекомендации по фирменной символике для приложений

При разработке приложений на платформе Microsoft Identity необходимо направить клиентов, когда им нужно использовать рабочую или учебную учетную запись (управляемую в Azure AD), или их личную учетную запись для регистрации и входа в приложение.
...
- Узнайте, что нужно сделать для добавления логотипа Майкрософт для использования в приложении.
...
- **Рабочие или учебные учетные записи.**  Управление этими учетными записями осуществляется корпорацией Майкрософт от имени организаций, использующих Azure Active Directory. Эти учетные записи используются для входа в Microsoft 365 и другие бизнес-службы корпорации Майкрософт.

Рабочие учетные записи Майкрософт обычно присваиваются конечным пользователям (сотрудникам, студентам, федеральным служащим) их организациями (компанией, школой, государственным учреждением). Эти учетные записи размещаются непосредственно в облаке (на платформе Azure AD) или синхронизируются с Azure AD из локального каталога, такого как Windows Server Active Directory. Корпорация Майкрософт является *хранителем* учетных записей, размещенных в Azure AD, но право владения и управления принадлежит организации.
...
В более ранней версии данного руководства рекомендуется использование пиктограммы «синего значка». На основании отзывов пользователей и разработчиков теперь вместо него рекомендуется использовать логотип Майкрософт. Логотип Майкрософт поможет пользователям понять, что они могут повторно использовать учетную запись, используемую с Microsoft 365 или другими бизнес-службами Майкрософт для входа в приложение.
...
> *Если вы уже используете Microsoft 365 или другую бизнес-службу корпорации Майкрософт, вы можете предоставить <your_app_name> доступ к данным вашей организации. Это позволит пользователям получать доступ к <your_app_name> с их существующими рабочими учетными записями.*
...
**Не** используйте идентификатор Microsoft 365 или идентификатор Azure. Microsoft 365 является также названием предложения потребителя корпорации Майкрософт, которое не использует Azure AD для проверки подлинности.
