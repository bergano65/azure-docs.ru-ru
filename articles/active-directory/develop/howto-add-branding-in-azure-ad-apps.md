...
- **Рабочие или школьные счета.**  Управление этими учетными записями осуществляется корпорацией Майкрософт от имени организаций, использующих Azure Active Directory. Эти учетные записи используются для входа в Office 365 и другие бизнес-службы, предоставляемые корпорацией Майкрософт.
...
После согласия адм-инов к вашему приложению, они могут добавить его в приложение Office 365 своих пользователей (доступно из вафель и от). [https://portal.office.com/myapps](https://portal.office.com/myapps) Если требуется привлечь внимание к этой возможности, можно использовать описание наподобие "Добавить приложение для моей организации" и отобразить кнопку следующим образом.
...
> *Если вы уже используете Office 365 или другую бизнес-службу корпорации Майкрософт, вы можете предоставить <your_app_name> доступ к данным организации. Это позволит пользователям получить доступ к <your_app_name> с существующими рабочими учетными записями.*
...
**Не** используйте "Office 365 ID" или "Azure ID". Office 365 также является наименованием предложения для клиентов от корпорации Майкрософт, которое не использует Azure AD для аутентификации.
