...
Чтобы зарегистрировать приложение в конечной точке Azure AD версии 1.0, см. статью [Регистрация приложения](quickstart-register-app.md).
