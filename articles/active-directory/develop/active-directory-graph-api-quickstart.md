...
При работе с этим кратким руководством можно использовать веб-отладчик Fiddler, чтобы попрактиковаться в выполнении операций записи в каталоге Azure AD. Например, можно получить и передать фотографию профиля пользователя (что не поддерживается в Azure AD Graph Explorer). Для получения дополнительной информации и [https://www.telerik.com/fiddler](https://www.telerik.com/fiddler)установки Fiddler, см.
