...
* Подготовить приложения с помощью предыдущей версии портала для Azure AD. Дополнительные сведения см. в разделе [Регистрация приложения](quickstart-register-app.md)
...
##### <a name="step-3a-add-a-redirect-uri-in-your-app-and-dev-portal-to-support-certificate-based-authentication"></a>Шаг 3а. Добавление URI перенаправления в приложение и на портал разработчика для поддержки аутентификации на основе сертификатов
