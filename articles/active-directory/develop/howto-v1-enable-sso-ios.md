...
* Подготовить приложения с помощью предыдущей версии портала для Azure AD. Дополнительные сведения см. в статье [Регистрация приложения](quickstart-register-app.md) .
