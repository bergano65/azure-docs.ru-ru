...
| URL-адрес выхода. | http://localhost разрешено <br><br> Максимальная длина 255 символов | http://localhost разрешено <br><br> Максимальная длина 255 символов | <br><br> https://localhost разрешено, http://localhost сбой для MSA <br><br> Максимальная длина 255 символов <br><br> Схема HTTP не разрешена <br><br> Подстановочные знаки не поддерживаются | 
