...
Выполните [эти инструкции, чтобы зарегистрировать новое одностраничное приложение](https://docs.microsoft.com/zure/active-directory/develop/scenario-spa-app-registration).
