...
## <a name="use-the-microsoft-authentication-library-msal-to-sign-in-user"></a>Использование библиотеки проверки подлинности Майкрософт (MSAL) для входа пользователя
