...
С 10 октября 2018 года Azure AD прекратит принимать использованные коды аутентификации для приложений. Это изменение системы безопасности помогает Azure AD соответствовать спецификации OAuth и будет применяться для конечных точек версии 1 и 2.
...
> [!NOTE]
> Стремясь уменьшить случаи взлома, существующие приложения, которые были исключены из этого требования, полагаются на эту функцию.  Любое приложение с более чем 10 входами за день, использующее этот шаблон, считается зависящим от него.  
