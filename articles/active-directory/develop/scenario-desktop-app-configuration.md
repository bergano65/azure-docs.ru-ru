...
- Список доступных на все модификаторы `PublicClientApplicationBuilder`, см. в справочной документации [PublicClientApplicationBuilder](https://docs.microsoft.com/dotnet/api/microsoft.identity.client.appconfig.publicclientapplicationbuilder?view=azure-dotnet-preview#methods)
- Описание всех параметров, отображенных в `PublicClientApplicationOptions` см. в разделе [PublicClientApplicationOptions](https://docs.microsoft.com/dotnet/api/microsoft.identity.client.appconfig.publicclientapplicationoptions?view=azure-dotnet-preview), справочника
