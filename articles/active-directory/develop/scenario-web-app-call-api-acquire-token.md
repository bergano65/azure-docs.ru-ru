---
title: Получение маркера в веб-приложениях, вызывающих веб-API — платформа Microsoft Identity | Службы
...
Он пытается получить маркер из кэша маркеров, а затем вызывает веб-API после установки заголовка авторизации. Если это не так, он повторно подписывает пользователя.
