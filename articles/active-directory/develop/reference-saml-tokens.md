...
* Дополнительные сведения об управлении политикой времени существования маркеров с помощью API Microsoft Graph см. в разделе [ресурс политики](/graph/api/resources/policy?view=graph-rest-beta).
