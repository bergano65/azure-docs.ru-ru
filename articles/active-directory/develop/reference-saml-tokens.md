...
* Используйте [единый Sign-On (SSO) с SAML](single-sign-on-saml-protocol.md).
* Использование [протокола SAML Azure Single Sign-Out](single-sign-out-saml-protocol.md)
