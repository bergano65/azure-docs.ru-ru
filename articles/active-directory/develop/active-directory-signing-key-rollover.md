...
### <a name="vs2015"></a>Веб-приложения и интерфейсы API, защищающие ресурсы и созданные с помощью Visual Studio 2015 или более поздней версии
...
1. Убедившись, что приложение использует приведенный выше код, откройте файл **Web. config** и перейдите к  **\<блоку > IssuerNameRegistry** , в частности, найдите следующие несколько строк:
   ...
   ```
2. В > параметре  **Добавлениеотпечатка=""изменитезначениеотпечатка,заменивлюбойсимволдругим.\<** Сохраните файл **Web.config** .
