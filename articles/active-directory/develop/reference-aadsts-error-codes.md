...
Коды ошибок и сообщения могут изменяться.  Для получения самых актуальных сведений просмотрите страницу [https://login.microsoftonline.com/error](https://login.microsoftonline.com/error) , чтобы найти описания ошибок, исправления и некоторые возможные обходные пути.  

Поиск по числовой части возвращенного кода ошибки.  Например, если получен код ошибки "AADSTS16000", выполните поиск в [https://login.microsoftonline.com/error](https://login.microsoftonline.com/error) для "16000".  Можно также напрямую связать с определенной ошибкой, добавив номер кода ошибки к URL-адресу: [https://login.microsoftonline.com/error?code=16000](https://login.microsoftonline.com/error?code=16000).
