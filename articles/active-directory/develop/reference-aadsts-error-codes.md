...
| AADSTS650052 | Приложению требуется доступ к службе `(\"{name}\")` , на которую не подписана или не включена ваша организация. `\"{organization}\"` Обратитесь к ИТ admin для просмотра конфигурации подписок на службу. |
