...
> [!IMPORTANT]
> После 30 января 2021 клиенты больше не смогут настраивать время существования маркера обновления и сеанса, а Azure Active Directory прекращает учитывать конфигурацию маркера обновления и сеанса в политиках после этой даты.
>
> Если необходимо определить период времени, по истечении которого пользователю будет предложено войти, настройте частоту входа в условный доступ. Дополнительные сведения об условном доступе см. на [странице цен на Azure AD](https://azure.microsoft.com/en-us/pricing/details/active-directory/).
>
> Для клиентов, которые не хотят использовать условный доступ после даты выбытия, они могут рассчитывать на то, что Azure AD будет учитывать конфигурацию по умолчанию, описанную в следующем разделе.
...
## <a name="identify-configuration-in-scope-of-retirement"></a>Определение конфигурации в области выбытия
