...
> [!IMPORTANT]
> После вашим отзывам пользователей на этапе предварительной версии, мы реализовали [возможности управления сеанса проверки подлинности](https://go.microsoft.com/fwlink/?linkid=2083106) в условного доступа Azure AD. Эта новая функция позволяет настроить время жизни маркера обновления, задав входа частотой. После 1 ноября 2019 не можно использовать политики настройки времени жизни маркера для настройки маркеры обновления, но вы по-прежнему можно использовать для настройки маркеры доступа.
