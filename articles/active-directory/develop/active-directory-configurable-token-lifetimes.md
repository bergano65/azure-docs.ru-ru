...
Обратите внимание, что конфигурация времени существования `<SubjectConfirmationData>` маркера не зависит от нотонорафтер подтверждения субъекта, указанного в элементе. 
