...
> [!IMPORTANT]
> После вашим отзывам пользователей на этапе предварительной версии, мы заменили функцию Настройка времени жизни маркеров с [возможности управления сеанса проверки подлинности](https://go.microsoft.com/fwlink/?linkid=2083106) в условного доступа Azure AD. Эта функция будет объявлена устаревшей 1 ноября 2019 г. Если вы используете политику настройки времени жизни маркера, перейдите в новый компонент условного доступа. 
