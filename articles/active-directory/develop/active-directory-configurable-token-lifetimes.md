...
| --- | --- | --- | --- | --- | --- |
| Время жизни маркера доступа |Акцесстокенлифетиме<sup>4</sup> |Маркеры доступа, маркеры безопасности, маркеры SAML2 |1 час |10 минут |1 день |
...
* <sup>4</sup> Чтобы обеспечить работу веб-клиента Microsoft Teams, рекомендуется задать для Microsoft Teams Акцесстокенлифетиме более 15 минут.
