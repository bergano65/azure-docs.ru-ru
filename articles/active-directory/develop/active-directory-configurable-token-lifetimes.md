...
ms.locfileid: "99428155"
---
# <a name="configurable-token-lifetimes-in-the-microsoft-identity-platform-preview"></a>Настраиваемые сроки существования маркеров в платформе Microsoft Identity (Предварительная версия)
...
|Свойство   |Строка свойства политики    |Область применения |Значение по умолчанию |
|----------|-----------|------------|------------|
