...
- Если вы являетесь бизнес-разработчиком (LOB), возможно, вы создадите приложение с одним клиентом, которое будет использоваться только в вашей организации. В этом случае укажите организацию по ИДЕНТИФИКАТОРу клиента (ИДЕНТИФИКАТОРу экземпляра Azure AD) или доменному имени, связанному с экземпляром Azure AD.
...
- Настройте URI перенаправления в [Регистрация приложений](https://aka.ms/appregistrations):
