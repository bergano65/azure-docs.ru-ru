...
description: В этом руководстве показано, как выполнить вход от имени пользователя и вызвать защищенный API из приложения Blazor WebAssembly с помощью платформы удостоверений Майкрософт.
author: knicholasa
ms.author: nichola
...
[Blazor WebAssembly](/aspnet/core/blazor#blazor-webassembly) — это платформа для одностраничных приложений, которая позволяет создавать с помощью .NET интерактивные веб-приложения, выполняемые на стороне клиента. В этом руководстве показано, как создать приложение, которое обрабатывает входы пользователей и извлекает данные из защищенного API в приложении Blazor WebAssembly с помощью [платформы удостоверений Майкрософт](https://docs.microsoft.com/azure/active-directory/develop/).
...
- [Введение в ASP.NET Core Blazor](/aspnet/core/blazor)
