...
* Вы можете определить в контроллерах функции, которые будут вызывать библиотеку adal.js для явной обработки запросов на вход и выход. В `App/Scripts/homeCtrl.js`:
