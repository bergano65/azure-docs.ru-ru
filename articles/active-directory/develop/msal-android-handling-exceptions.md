...
Дополнительные сведения об [ошибках ведения журнала](https://docs.microsoft.com/azure/active-directory/develop/msal-logging?tabs=android) 
