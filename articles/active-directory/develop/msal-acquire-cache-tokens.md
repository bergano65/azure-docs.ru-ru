...
Некоторые платформы, поддерживаемые MSAL, имеют дополнительные сведения о кэше маркеров в документации для библиотеки этой платформы. Вот несколько примеров.
