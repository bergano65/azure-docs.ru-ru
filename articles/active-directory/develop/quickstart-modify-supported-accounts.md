---
title: Краткое руководство. Изменение типов учетных записей, поддерживаемых приложением | Azure
...
Из этого краткого руководства вы узнаете, как настроить конфигурацию приложения, чтобы изменить пользователей или типы учетных записей, которые могут работать с приложением.
...
Дополнительные сведения о настройке проверенного домена издателя см. в разделе [Настройка проверенного домена](quickstart-modify-supported-accounts.md).

## <a name="next-steps"></a>Дальнейшие действия

> [!div class="nextstepaction"]
> [Руководство. Преобразование приложения для поддержки нескольких клиентов](howto-convert-app-to-be-multi-tenant.md)
