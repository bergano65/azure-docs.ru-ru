...
- **clientID**: Обязательный элемент. ClientID приложения, вы должны получить это на портале регистрации приложений.
...
- **unprotectedResources**: Необязательный элемент.  Массив URI, которые являются незащищенных ресурсах. MSAL не присоединит маркер к исходящим запросам, которые имеют эти URI. По умолчанию равен `null`.
