...
- [Краткое руководство. Защита веб-API ASP.NET Core с помощью платформы удостоверений Майкрософт](quickstart-v2-aspnet-core-web-api.md)
...
- [Вход пользователей и вызов Microsoft Graph из приложения iOS или macOS](tutorial-v2-ios.md)
- [Краткое руководство. Вызов веб-API ASP.NET, защищенного с помощью платформы удостоверений Майкрософт](quickstart-v2-dotnet-native-aspnet.md)
- [Краткое руководство. Добавление входа через Майкрософт в веб-приложение ASP.NET Core](quickstart-v2-aspnet-core-webapp.md)
- [Рекомендации по использованию Xamarin iOS с MSAL.NET](msal-net-xamarin-ios-considerations.md)
