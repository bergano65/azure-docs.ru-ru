...
- [Краткое руководство. Веб-приложение ASP.NET Core, выполняющее вход пользователей в систему и вызывающее Microsoft Graph от их имени](quickstart-v2-aspnet-core-webapp-calls-graph.md)
