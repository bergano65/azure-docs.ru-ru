...
| Код |Требуется |Код авторизации ( `authorization_code` ), полученный в предыдущем разделе. |
| redirect_uri |Требуется | Объект `redirect_uri`зарегистрирован в клиентском приложении. |
