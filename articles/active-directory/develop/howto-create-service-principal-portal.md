...
## <a name="upload-a-certificate-or-create-a-secret-for-signing-in"></a>Отправка сертификата или создание секрета для входа
Существуют два типа проверки подлинности, доступные для субъектов-служб: проверка подлинности на основе пароля (секрет приложения) и проверка подлинности на основе сертификатов.  Рекомендуется использовать сертификат, но можно также создать новый секрет приложения.
