...
1. Следуйте указаниям мастера экспорта сертификатов.  Экспортируйте закрытый ключ, укажите пароль для файла сертификата и экспортируйте его в файл.
