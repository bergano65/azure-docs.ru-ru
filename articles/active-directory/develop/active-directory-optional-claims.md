...
| `sid`         | Идентификатор сеанса                      | Сеанс идентификатор GUID, используемый для отслеживания сеанса проверки подлинности с помощью MSA. | MSA.  Не будет включена для учетных записей Azure AD. | 
