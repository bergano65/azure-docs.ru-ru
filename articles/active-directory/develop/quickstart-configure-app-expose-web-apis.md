---
title: Настройка приложения для предоставления интерфейсов веб-API с помощью платформы удостоверений Майкрософт | Azure
...
1. Когда откроется страница **Добавить группу**, введите сведения данной области:
    ...
    | **Кто может давать согласие** | Выберите, могут ли пользователи предоставлять согласие этой области или требуется согласие администратора. Выберите **Только администраторы** для более высокого уровня разрешений. |
