...
| 2 | Title | Заголовок изменяется в зависимости от того, выполняется ли процесс предоставления согласия пользователя или администратора. В случае запроса согласия пользователя заголовок будет "Запрос разрешений", при запросе согласия администратора — "Примите для вашей организации". |
