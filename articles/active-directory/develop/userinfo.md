...
Указанные здесь утверждения, включая `sub` , представляют собой те же утверждения, которые приложение увидит в [маркере идентификации](id-tokens.md) , выданном приложению.  
