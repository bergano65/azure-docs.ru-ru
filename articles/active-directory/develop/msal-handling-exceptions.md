...
| None    | Других подробностей не приводится. Условие может быть решено путем взаимодействия с пользователем во время интерактивного потока проверки подлинности. | Позвоните AcquireTokenИнтерактивно (). |
