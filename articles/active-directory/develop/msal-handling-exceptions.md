...
* **Аусеррор. сообщение:**  То же, что и errorMessage.
* **Аусеррор. Stack:** Трассировка стека для ошибок, вызванных ошибками. Позволяет отследить исходную точку возникновения ошибки.
