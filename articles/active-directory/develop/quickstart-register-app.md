---
title: Регистрация приложения с помощью платформы удостоверений Майкрософт | Azure
...
В этом кратком руководстве показано, как добавить и зарегистрировать приложение с помощью процедуры **регистрации приложений** на портале Azure, чтобы приложение можно было интегрировать с платформой удостоверений Майкрософт. Дополнительные сведения о новых функциях и улучшениях в новом интерфейсе регистрации приложений см. в [этой записи блога](https://developer.microsoft.com/graph/blogs/new-app-registration/).
...
1. После появления страницы **Регистрация приложения** введите сведения о регистрации приложения:
   ...
   - **Поддерживаемые типы учетных записей** — выберите учетные записи, которые должно поддерживать приложение.
       ...
       | **Учетные записи в любом каталоге организации и личные учетные записи Майкрософт** | Выберите этот параметр для охвата максимально широкого круга клиентов.<br><br>Этот параметр сопоставляется с Azure AD с несколькими клиентами и личными учетными записями Майкрософт.<br><br>Если вы зарегистрировали приложение с использованием личных учетных записей Майкрософт и Azure AD с несколькими клиентами, изменить это в пользовательском интерфейсе будет невозможно. Вместо этого для изменения поддерживаемых типов учетных записей необходимо использовать редактор манифестов приложения. |
