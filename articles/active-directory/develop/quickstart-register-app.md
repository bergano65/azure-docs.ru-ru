...
В этом кратком руководстве показано, как добавить и зарегистрировать приложение с помощью функции **регистрации приложений (предварительная версия)** на портале Azure, чтобы приложение можно было интегрировать с платформой удостоверений Майкрософт.
