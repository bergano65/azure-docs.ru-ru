...
MSAL.NET поддерживает три типа учетных данных клиента:

- Секреты приложений <BR>![Конфиденциальный клиент с паролем](media/msal-authentication-flows/confidential-client-password.png)
- Сертификаты <BR>![Конфиденциальный клиент с сертификатом](media/msal-authentication-flows/confidential-client-certificate.png)
- Оптимизированный клиента утверждения<BR>![Конфиденциальный клиент с помощью утверждений](media/msal-authentication-flows/confidential-client-assertions.png)
...
![Встроенная проверка подлинности Windows](media/msal-authentication-flows/integrated-windows-authentication.png)
