...
Предоставление | ADAL.NET | MSAL.NET
----- |----- | -----
Интерактивный | [Интерактивная аутентификация](https://github.com/AzureAD/azure-activedirectory-library-for-dotnet/wiki/Acquiring-tokens-interactively---Public-client-application-flows) | [Получение маркеров в интерактивном режиме через MSAL.NET](https://github.com/AzureAD/microsoft-authentication-library-for-dotnet/wiki/Acquiring-tokens-interactively)
Интегрированная проверка подлинности Windows | [Встроенная аутентификация Windows (Kerberos)](https://github.com/AzureAD/azure-activedirectory-library-for-dotnet/wiki/AcquireTokenSilentAsync-using-Integrated-authentication-on-Windows-(Kerberos)) | [Встроенная аутентификация Windows](msal-authentication-flows.md#integrated-windows-authentication)
...
Тип приложения | Предоставление | ADAL.NET | MSAL.NET
----- | ----- | ----- | -----
...
MSAL.NET не раскрывает маркеры обновления по соображениям безопасности: MSAL обрабатывает маркеры обновления. 
