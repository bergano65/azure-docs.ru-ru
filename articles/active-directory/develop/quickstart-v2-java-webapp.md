...
> 1. Найдите значение **Идентификатор приложения (клиента)** приложения. Скопируйте это значение, оно понадобится позже.
> 1. Найдите значение **Идентификатор каталога (клиента)** приложения. Скопируйте это значение, оно понадобится позже.
...
>    - Скопируйте значение ключа, оно понадобится позже.
>
