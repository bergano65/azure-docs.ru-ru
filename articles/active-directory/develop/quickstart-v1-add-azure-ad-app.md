...
В этом кратком руководстве объясняется, как добавить и зарегистрировать приложение в Azure AD с помощью существующей функции **Регистрация приложений** на портале Azure.
