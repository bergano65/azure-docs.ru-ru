...
1. После появления страницы **Регистрация приложения** введите сведения о регистрации приложения:
   ...
   ![На снимке экрана показана страница Регистрация приложения, на которой можно выбрать пункт зарегистрировать.](media/scenario-webapp/scenario-webapp-app-registration-1.png)
1. Выберите меню **Проверка подлинности** , а затем добавьте следующие сведения:
  ...
  ![На снимке экрана показаны параметры проверки подлинности, в которых можно внести описанные изменения.](media/scenario-webapp/scenario-webapp-app-registration-2.png)
