...
1. В разделе **Дополнительные параметры** задайте для параметра **URL-адрес выхода** значение **http://localhost:8080/msal4jsample/sign_out** . Затем нажмите кнопку **Сохранить**.
...
1. Выберите раздел **Проверка подлинности** . В окне **Дополнительные параметры**задайте для параметра **URL-адрес выхода** значение **http://localhost:5000/logout** . Затем нажмите кнопку **Сохранить**.
