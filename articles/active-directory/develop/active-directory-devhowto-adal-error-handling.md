...
### <a name="error-cases-and-actionable-steps-web-applications-that-call-a-resource-api-net"></a>Сценарии ошибок и практические действия. Веб-приложение, вызывающие API ресурса (.NET).
