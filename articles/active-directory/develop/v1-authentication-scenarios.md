...
В таблице ниже приведено краткое описание каждого типа утверждений, которые создает Azure AD. Дополнительные сведения см. в статье [маркеры доступа](access-tokens.md) и [маркеры идентификации](id-tokens.md) , выданные Azure AD.
