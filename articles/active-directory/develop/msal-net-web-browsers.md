...
- Может возвращать настраиваемое сообщение об ошибке для пользователя. Пример: «Пожалуйста, установите Chrome, чтобы продолжить работу с проверкой подлинности» - OR-
