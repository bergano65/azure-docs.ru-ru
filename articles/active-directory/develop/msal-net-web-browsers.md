---
title: Использование веб-браузеров с MSAL.NET | Службы
...
| FRAMEWORK        | Внедренное | Система | значение по умолчанию |
| ------------- |-------------| -----| ----- |
| Классическая платформа .NET     | ДА | Да ^ | Внедренное |
| .NET Core     | Нет | Да ^ | Система |
| .NET Standard | Нет | Да ^ | Система |
| UWP | ДА | Нет | Внедренное |
| Xamarin.Android | ДА | ДА  | Система |
| Xamarin.iOS | ДА | ДА  | Система |
| Xamarin.Mac| ДА | Нет | Внедренное |
