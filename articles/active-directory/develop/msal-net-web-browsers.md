...
| FRAMEWORK        | Безопасным | системный; | Значение по умолчанию |
| ------------- |-------------| -----| ----- |
| Классическая платформа .NET     | Да | Да ^ | Безопасным |
| .NET Core     | Нет | Да ^ | системный; |
| .NET Standard | Нет | Да ^ | системный; |
| UWP | Да | Нет | Безопасным |
| Xamarin.Android | Да | Да  | системный; |
| Xamarin.iOS | Да | Да  | системный; |
