---
title: Видео по платформе удостоверений Майкрософт | Azure
description: Список видеороликов, посвященных современной проверке подлинности и платформе удостоверений Майкрософт
...
ms.locfileid: "100366013"
---
# <a name="microsoft-identity-platform-videos"></a>Видео по платформе удостоверений Майкрософт

Изучите основы современной проверки подлинности, платформы удостоверений Майкрософт и библиотек проверки подлинности Майкрософт (MSAL).

## <a name="microsoft-identity-platform-for-developers"></a>Платформа удостоверений Майкрософт для разработчиков

Узнайте о ключевых компонентах и возможностях платформы Microsoft Identity.
...
## <a name="developer-training-series"></a>Серия обучающих материалов для разработчиков

В серии видеороликов Удостоверения для разработчиков Маттийс Хоекстра (Matthijs Hoekstra) и Кайл Марш (Kyle Marsh) знакомят зрителей с платформой удостоверений Майкрософт. Узнайте о ключевых компонентах и возможностях платформы, а также о том, как использовать библиотеки проверки подлинности, чтобы приступить к добавлению современной и безопасной проверки подлинности в приложения.

Благодаря содержимому, которое было рассмотрено во многих учебных семинарах, проведенных специалистами, эти видеоматериалы являются отличной отправной точкой для любого, кто решил разобраться с удостоверениями в Azure.
___
...
Если вы не знакомы с такими концепциями, как поставщики удостоверений, маркеры безопасности, утверждения и аудитория, то эта серия видеороликов может помочь ознакомиться с концепциями и компонентами современной проверки подлинности.
___
...
## <a name="microsoft-identity-platform-basics"></a>Основы платформы удостоверений Майкрософт

Узнайте о компонентах платформы удостоверений Майкрософт, библиотеках проверки подлинности Майкрософт (MSAL) и о том, как эти компоненты взаимодействуют с Azure Active Directory. Видеоролики One Dev Question продолжительностью 1–2 минуты.
___
...
Узнайте о переходе на последнюю версию платформы удостоверений Майкрософт, включая переход с библиотеки проверки подлинности Active Directory (ADAL) на MSAL.
___
