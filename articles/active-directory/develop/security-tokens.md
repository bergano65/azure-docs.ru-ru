...
> [!NOTE]
> В этой статье обсуждаются маркеры безопасности для протоколов OAuth2 и OpenID Connect Connect. Многие корпоративные приложения используют SAML для проверки подлинности пользователей. Сведения об утверждениях SAML см. в [справочнике по маркерам SAML в Azure AD](reference-saml-tokens.md) .
