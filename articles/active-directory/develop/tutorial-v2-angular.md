...
В этом руководстве приводятся инструкции по созданию одностраничного приложения (SPA) Angular, реализующего вход пользователей с использованием личных учетных записей Майкрософт и рабочих или учебных учетных записей и вызов API Microsoft Graph от их имени.
