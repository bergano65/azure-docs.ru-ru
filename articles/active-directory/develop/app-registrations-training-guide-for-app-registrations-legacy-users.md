...
Формат URI перенаправления изменился. Они должны быть связаны с типом приложения — Web или public. По соображениям безопасности подстановочные знаки и `http://` схемы не поддерживаются, за исключением *http://localhost* .
