...
В этой статье рассматриваются многие основные понятия проверки подлинности, которые необходимо знать для создания защищенных веб-приложений, веб-API или приложений, вызывающих защищенные веб-API. Если вы видите термин, который вам не знаком, попробуйте наш (глоссарий) [Developer-glossary.md].
