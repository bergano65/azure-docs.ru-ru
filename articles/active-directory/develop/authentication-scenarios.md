...
![Упрощенный процесс подготовки на основе согласия](./media/authentication-scenarios/simplified-provisioning-flow-consent.png)
...
| 4. | Azure AD использует объект приложения в A как схему для создания субъекта-службы в клиенте B. |
