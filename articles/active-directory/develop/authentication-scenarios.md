...
Вместо создания приложений, каждый из которых хранит свои собственные сведения о имени пользователя и пароле, что влечет за собой высокий уровень административной нагрузки при наличии нескольких приложений и необходимости добавлять или удалять пользователей, приложения могут делегировать ответственность за централизованную поставщик удостоверений.
...
**Обрабатывайте согласие пользователя во время запроса маркера и упростите динамическую подготовку приложений для клиентов** . Согласие — это процесс предоставления владельцу ресурса авторизации клиентскому приложению для доступа к защищенным ресурсам в соответствии с конкретными разрешениями от имени владельца ресурса. Платформа Microsoft Identity:
...
## <a name="generalization-to-desktop-and-mobile-apps"></a>Обобщение для настольных и мобильных приложений
