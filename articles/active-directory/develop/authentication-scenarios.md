...
- Сведения о настройке проверки подлинности для приложения службы приложений см. в статье [Интеграция службы приложений с платформой микросфот Identity](/azure/app-service/configure-authentication-provider-aad) .
