...
-   Домен издателя (который отображается пользователям в [запросе согласия приложения\'](application-consent-experience.md)) можно найти на странице фирменной символики. Дополнительные сведения о настройке домена издателя см. в [этом](howto-configure-publisher-domain.md)разделе.
