...
description: Типы приложений и сценариев, поддерживаемых конечной точкой платформы Microsoft Identity.
