...
6. В другом окне откройте [песочницу Azure AD Graph](https://developer.microsoft.com/graph/graph-explorer) и сделайте следующее:
    ...
    4.3. Дайте согласие. Вы повторно войдете в систему.
...
9. В диалоговом окне **Единый вход** в разделе **User Attributes & Claims** (Атрибуты и утверждения пользователя) настройте атрибут токена SAML, как показано на рисунке, и сделайте следующее.
    ...
    б) Выберите **Добавить атрибут**, чтобы открыть область **Управление утверждениями пользователя**.
...
6. Чтобы обновить существующую роль, сделайте следующее:
    ...
    4.3. Обновив все необходимые роли, нажмите кнопку **Выполнить запрос**.
...
6. Чтобы удалить существующую роль, сделайте следующее:
    ...
    4.3. Снова выберите **Выполнение запроса**.
