...
|--------------------------|---------------------------------|-------------|
| Рабочие или учебные учетные записи Майкрософт в клиенте Azure Active Directory (Azure AD) любой организации | 256 | `signInAudience`для поля в манифесте приложения задано значение *азуреадмйорг* или *азуреадмултиплеоргс* |
| Личные учетные записи Майкрософт, рабочие и учебные учетные записи | 100 | `signInAudience`для поля в манифесте приложения задано значение *азуреадандперсоналмикрософтаккаунт* |
...
Сейчас модель приложений Azure AD поддерживает как схемы HTTP, так и HTTPS для приложений, которые входят в рабочие или учебные учетные записи Майкрософт в клиенте Azure Active Directory (Azure AD) любой организации. Это `signInAudience` поле в манифесте приложения имеет значение *азуреадмйорг* или *азуреадмултиплеоргс*. Для приложений, которые входят в личные учетные записи Майкрософт, рабочие и учебные учетные записи (для которых `signInAudience` задано значение *азуреадандперсоналмикрософтаккаунт*), разрешена только схема HTTPS.
...
Если для сценария требуется больше URI перенаправления, чем разрешено, вместо добавления URI перенаправления с подстановочным знаком следует рассмотреть следующий подход.
