...
| URL-адрес для входа      | URL-адрес, по которому пользователи могут войти для использования вашего приложения                                  |
...
| URI-коды перенаправления   | Для собственных приложений пользователь отправляется сюда после успешной авторизации. Azure AD проверяет, совпадает ли предоставленный приложением URI перенаправления в запросе OAuth 2.0 с одним из зарегистрированных значений на портале.                                                            |
