---
title: Публикация приложения в коллекции приложений Azure AD
...
- Приложение может использовать [API Graph](https://docs.microsoft.com/graph/) для доступа к данным, которые применяют производительность пользователей в экосистеме Майкрософт.
...
| Функция| OAuth/OIDC| SAML/WS-подача |
| - |-|-|
...
### <a name="saml-20-or-ws-fed"></a>SAML 2,0 или WS-подача

SAML — это зрелый и широко принятый стандарт единого входа для веб-приложений. Дополнительные сведения о том, как Azure использует SAML, см. в статье Использование [протокола SAML в Azure](active-directory-saml-protocol-reference.md). 
...
### <a name="implement-ws-fed"></a>Реализация WS-подачи
Дополнительные сведения о WS-подачах в ASP.NET Core см. в разделе [Проверка подлинности пользователей с помощью WS-Federation в ASP.NET Core](https://docs.microsoft.com/aspnet/core/security/authentication/ws-federation).
...
## <a name="step-3---create-your-azure-tenant-and-test-your-app"></a>Шаг 3. Создание клиента Azure и тестирование приложения
...
Кроме того, клиент Azure AD поставляется с каждой Microsoft 365ной подпиской. Чтобы настроить бесплатную среду разработки Microsoft 365, см. статью [Присоединение к программе Microsoft 365 Developer](https://docs.microsoft.com/office/developer-program/microsoft-365-developer-program).

После создания клиента необходимо включить и протестировать доступ с одним входом. 
...
## <a name="step-4---create-and-publish-documentation"></a>Шаг 4. Создание и публикация документации
...
## <a name="step-5---submit-your-app"></a>Шаг 5. Отправка приложения
...
Если вы реализуете конечную точку SCIM 2,0 для подготовки пользователей, выберите параметр, как показано ниже. 
...
## <a name="step-6---join-the-microsoft-partner-network"></a>Шаг 6. Присоединяйтесь к партнерской сети Майкрософт
