...
| redirect_uri | рекомендуется |URI перенаправления приложения, на который можно отправлять ответы проверки подлинности для их получения приложением. Он должен в точности соответствовать одному из URI перенаправления, зарегистрированных на портале, но иметь форму закодированного URL-адреса. Если она отсутствует, агент пользователя будут отправляться обратно к одному из перенаправления, зарегистрированных идентификаторы URI для приложения, в произвольном порядке. |
