---
title: Протоколы авторизации, поддерживаемые платформой идентификации Майкрософт | Службы
