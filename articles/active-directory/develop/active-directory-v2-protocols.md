...
> [!TIP]
> Все приложения, зарегистрированного в Azure AD можно использовать конечную точку версии 2.0, даже если они не войти в личные учетные записи.  Таким образом, могут перенести существующие приложения версии 2.0 и [MSAL](reference-v2-libraries.md) без повторного создания приложения.  
