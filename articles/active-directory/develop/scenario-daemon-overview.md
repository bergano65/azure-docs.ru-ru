...
- Во время [регистрации приложения](./scenario-daemon-app-registration.md) **URI ответа** не требуется. Необходимо предоставить общий доступ к секретам или сертификатам или подписанным утверждениям с помощью Azure AD, а также запросить разрешения приложений и предоставить согласие администратора на использование этих разрешений приложения.
