...
- Во время [регистрации приложения](./scenario-daemon-app-registration.md)URI ответа не требуется. Вам необходимо предоставить общий доступ к секретам или сертификатам или подписанным утверждениям с помощью Azure AD. Кроме того, необходимо запросить разрешения приложения и предоставить согласие администратора на использование этих разрешений приложения.
