...
Совет профессионала: Попробуйте вставить следующий запрос в браузере.
...
| Параметр | Описание |
| --- | --- |
| `access_token` | Запрашиваемый маркер доступа. Приложение может использовать этот маркер для проверки подлинности защищенного ресурса, например, для web API. |
