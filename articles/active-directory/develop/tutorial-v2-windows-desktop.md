...
1. В списке страниц приложения выберите **Проверка подлинности**.
   ...
   1. В столбце **Тип** выберите **Общедоступный/собственный клиент (мобильный и классический)** .
   1. В столбец **URI перенаправления** введите `https://login.microsoftonline.com/common/oauth2/nativeclient`.
