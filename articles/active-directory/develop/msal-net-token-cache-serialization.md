...
Важно помнить, что для веб-приложений и веб-API следует создавать отдельный кэш маркеров для каждого пользователя (каждой учетной записи). Сериализацию кэша маркеров также следует выполнять отдельно для каждой учетной записи.
