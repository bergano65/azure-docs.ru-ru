---
title: Руководство. Интеграция Azure Active Directory со StatusPage | Документация Майкрософт
...
1. В поле поиска введите **StatusPage**.

    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/tutorial_statuspage_search.png)

1. На панели результатов выберите **StatusPage** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/tutorial_statuspage_addfromgallery.png)
...
1. **[Создание тестового пользователя StatusPage](#creating-a-statuspage-test-user)** требуется для того, чтобы в StatusPage существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/statuspage-tutorial/tutorial_statuspage_samlbase.png)

1. В разделе **Домены и URL-адреса приложения StatusPage** выполните следующие действия.
...
1. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/statuspage-tutorial/tutorial_statuspage_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/statuspage-tutorial/tutorial_general_400.png)

1. В разделе **Конфигурация StatusPage** щелкните **Настроить StatusPage**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/statuspage-tutorial/tutorial_statuspage_configure.png) 
...
1. На главной панели инструментов щелкните **Manage Account**(Управление учетной записью).
    ...
    ![Настройка единого входа](./media/statuspage-tutorial/tutorial_statuspage_06.png) 

1. Выберите вкладку **Single Sign-on** (Единый вход). 
   
    ![Настройка единого входа](./media/statuspage-tutorial/tutorial_statuspage_07.png) 
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/create_aaduser_04.png) 
...
1. Перейдите на вкладку **Team Members** (Участники команды). 
    ...
    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/tutorial_statuspage_10.png) 

1. Щелкните **ADD TEAM MEMBER** (Добавить участника команды). 
   
    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/tutorial_statuspage_11.png) 

1. Введите в текстовые поля **Email Address** (Электронный адрес), **First Name** (Имя) и **Sur Name** (Фамилия) соответствующие данные действительного пользователя, которого вы хотите подготовить. 
   
    ![Создание тестового пользователя Azure AD](./media/statuspage-tutorial/tutorial_statuspage_12.png) 
...
1. Из списка приложений выберите **StatusPage**.

    ![Настройка единого входа](./media/statuspage-tutorial/tutorial_statuspage_app.png) 
