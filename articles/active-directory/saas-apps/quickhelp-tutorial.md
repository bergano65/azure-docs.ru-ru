...
4. В разделе **Базовая конфигурация SAML** выполните приведенные ниже действия.
    ...
    а. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://quickhelp.com/<ROUTEURL>`.
...
2. В верхнем меню щелкните **Администратор** .
    ...
    ![Снимок экрана, на котором показан пункт меню Admin (Администратор) для Brainstorm.][21]

3. В меню **QuickHelp Admin** (Администратор QuickHelp) щелкните **Settings** (Параметры).
   
    ![Снимок экрана, на котором выбран элемент Settings (Параметры) в меню администрирования QuickHelp.][22]
...
5. На странице **Параметры проверки подлинности** выполните следующие действия.
    ...
    ![Снимок экрана, на котором показана страница Authentication Settings (Параметры проверки подлинности), где можно ввести указанные значения.][23]
