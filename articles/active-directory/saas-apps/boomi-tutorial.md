...
1. Если вам нужно настроить единый вход, инициируемый **поставщиком удостоверений**, и у вас есть **файл метаданных поставщика услуг**, выполните следующие действия в разделе **Базовая конфигурация SAML**:
    ...
    ![Снимок экрана, на котором показан раздел "Базовая конфигурация SAML", где отображены значения идентификатора и URL-адреса ответа](common/idp-intiated.png)
...
1. После входа в систему, перейдите к разделу **User Management** (Управление пользователями) и найдите элемент **Users** (Пользователи).
    ...
    ![Снимок экрана, на котором показана страница "User Management" (Управление пользователями) с выбранным элементом "Users" (Пользователи)](./media/boomi-tutorial/tutorial_boomi_001.png "Пользователи")

1. Щелкните значок **+** . Откроется диалоговое окно **Add/Maintain User Roles** (Добавить или настроить роли пользователей).

    ![Снимок экрана, на котором показан выбранный значок "+"](./media/boomi-tutorial/tutorial_boomi_002.png "Пользователи")

    ![Снимок экрана, на котором показано диалоговое окно "Add/Maintain User Roles" (Добавить или настроить роли пользователей), где можно настроить параметры пользователя](./media/boomi-tutorial/tutorial_boomi_003.png "Пользователи")
