---
title: Руководство. Интеграция Azure Active Directory с Mixpanel | Документация Майкрософт
...
1. В поле поиска введите **Mixpanel**.

    ![Создание тестового пользователя Azure AD](./media/mixpanel-tutorial/tutorial_mixpanel_search.png)

1. На панели результатов выберите **Mixpanel** и щелкните **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/mixpanel-tutorial/tutorial_mixpanel_addfromgallery.png)
...
1. **[Создание тестового пользователя Mixpanel](#creating-a-mixpanel-test-user)** требуется для создания в Mixpanel пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/mixpanel-tutorial/tutorial_mixpanel_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Mixpanel** выполните следующие действия:

    ![Настройка единого входа](./media/mixpanel-tutorial/tutorial_mixpanel_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/mixpanel-tutorial/tutorial_mixpanel_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/mixpanel-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Mixpanel** щелкните **Настроить Mixpanel**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/mixpanel-tutorial/tutorial_mixpanel_configure.png) 

1. В отдельном окне браузера войдите в приложение Mixpanel под учетной записью администратора.

1. Щелкните маленький значок **шестеренки** в левом нижнем углу страницы. 
   
    ![Единый вход в Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_06.png) 

1. Откройте вкладку **Access security** (Безопасность доступа) и щелкните **Change settings** (Изменить параметры).
   
    ![Параметры Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_08.png) 

1. На странице диалогового окна **Change your certificate** (Изменение сертификата) щелкните **Choose file** (Выбрать файл), чтобы передать скачанный сертификат, а затем щелкните **Next** (Далее).
   
    ![Параметры Mixpanel](./media/mixpanel-tutorial/tutorial_mixpanel_09.png) 

1.  В текстовом поле URL-адреса проверки подлинности диалоговой страницы **Change your authentication URL** (Изменение URL-адреса проверки подлинности) вставьте значение **URL-адрес службы единого входа SAML**, которое скопировано с портала Azure, и щелкните **Next** (Далее).
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/mixpanel-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/mixpanel-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/mixpanel-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/mixpanel-tutorial/create_aaduser_04.png) 
...
1. Щелкните маленькую кнопку с шестеренкой в левом нижнем углу страницы, чтобы открыть окно **Параметры** .

1. Откройте вкладку **Команды** .

1. В текстовое поле **член команды** введите электронный адрес пользователя Britta Simon на портале Azure.
...
1. В списке приложений выберите **Mixpanel**.

    ![Настройка единого входа](./media/mixpanel-tutorial/tutorial_mixpanel_app.png) 
