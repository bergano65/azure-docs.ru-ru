...
1. В разделе **Добавление тегов (необязательно)** выполните следующие действия.
    ...
    а. В текстовом поле **Key (ключ** ) введите имя ключа для ex: азуреадтест.
...
1. В диалоговом окне **Review** (Обзор) выполните следующие действия.
    ...
    а. В текстовом поле **Role name (имя роли** ) введите значение в следующем шаблоне `accountname-aws-admin` .
...
1. Откройте [проводник Microsoft Graph](https://developer.microsoft.com/graph/graph-explorer) в другом окне.
    ...
    а. Войдите на сайт Microsoft Graph Explorer, используя учетные данные глобального администратора или соадминистратора для вашего клиента.
