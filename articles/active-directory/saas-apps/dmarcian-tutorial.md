...
4. Во всплывающем меню **Add New User** (Добавление нового пользователя) сделайте следующее:
    ...
    а. В текстовом поле **New User Email** (Электронная почта нового пользователя) введите адрес электронной почты пользователя, например **brittasimon\@contoso.com** .
...
Щелкнув плитку dmarcian на Панели доступа, вы автоматически войдете в приложение dmarcian, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
