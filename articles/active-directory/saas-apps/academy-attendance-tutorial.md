...
## <a name="configure-and-test-azure-ad-sso-for-academy-attendance"></a>Настройка и проверка единого входа Azure AD для Academy Attendance
...
Чтобы настроить и проверить единый вход Azure AD в Academy Attendance, выполните следующие действия:
...
1. На портале Azure на странице интеграции с приложением **Academy Attendance** найдите раздел **Управление** и выберите **Единый вход**.
...
1. На странице **Базовая конфигурация SAML** введите значения следующих полей.
    ...
    1. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://<SUBDOMAIN>.aattendance.com/sso/saml2/login?idp=<IDP_NAME>`.

    1. В текстовом поле **Идентификатор (сущности)** введите URL-адрес в следующем формате: `https://<SUBDOMAIN>.aattendance.com/sso/saml2/metadata?idp=<IDP_NAME>`.
...
* Выберите **Тестировать приложение** на портале Azure. После этого действия открывается URL-адрес для входа в приложение Academy Attendance, где можно инициировать поток входа. 
