...
Щелкните плитку CakeHR на панели доступа, и вы автоматически войдете в приложение CakeHR, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
