...
4. **[Создание тестового пользователя Cherwell](#create-cherwell-test-user)** нужно для того, чтобы в Cherwell также существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
