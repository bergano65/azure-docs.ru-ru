...
1. Если у вас есть **файл метаданных поставщика службы**, выполните следующие действия в разделе **Домены и URL-адреса приложения ForeSee CX Suite**:
...
1. Чтобы настроить единый вход на стороне **ForeSee CX Suite**, отправьте скачанный **XML-файл метаданных** [группе поддержки ForeSee CX Suite](mailto:support@foresee.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
1. Из списка приложений выберите **ForeSee CX Suite**.
