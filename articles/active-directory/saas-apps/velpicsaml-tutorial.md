...
1. В поле поиска введите **Velpic SAML**.

    ![Создание тестового пользователя Azure AD](./media/velpicsaml-tutorial/tutorial_velpicsaml_search.png)

1. На панели результатов выберите **Velpic SAML** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/velpicsaml-tutorial/tutorial_velpicsaml_addfromgallery.png)
...
1. **[Создание тестового пользователя Velpic SAML](#creating-a-velpic-saml-test-user)** требуется для создания в Velpic SAML пользователя Britta Simon, связанного с соответствующим представлением в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/velpicsaml-tutorial/tutorial_velpicsaml_samlbase.png)

1. Введите сведения в разделе **Домены и URL-адреса приложения Velpic SAML**

    ![Настройка единого входа](./media/velpicsaml-tutorial/tutorial_velpicsaml_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **XML метаданных** и сохраните XML-файл на компьютере.
    ...
    ![Настройка единого входа](./media/velpicsaml-tutorial/tutorial_velpicsaml_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/velpicsaml-tutorial/tutorial_general_400.png)

1. В разделе "Настройка Velpic SAML" щелкните "Настроить Velpic SAML", чтобы открыть окно "Настройка единого входа". Скопируйте идентификатор сущности SAML из раздела "Краткий справочник".

1. В другом окне веб-браузера войдите на корпоративный сайт Velpic SAML с правами администратора.

1. Щелкните вкладку **Manage** (Управление), перейдите к разделу **Integration** (Интеграция) и нажмите там кнопку **Plugins** (Подключаемые модули), чтобы создать новый подключаемый модуль для входа.

    ![Подключаемый модуль](./media/velpicsaml-tutorial/velpic_1.png)

1. Нажмите кнопку **Add plugin** (Добавить подключаемый модуль).
    
    ![Подключаемый модуль](./media/velpicsaml-tutorial/velpic_2.png)

1. Щелкните плитку **SAML** на странице добавления подключаемого модуля.
    
    ![Подключаемый модуль](./media/velpicsaml-tutorial/velpic_3.png)

1. Введите имя нового подключаемого модуля SAML и нажмите кнопку **Add** (Добавить).
...
1. Введите следующие сведения:
    ...
    4.3. Также вы можете установить флажок **Auto create new users** (Автоматическое создание новых пользователей), чтобы включить JIT-подготовку SAML. Если этот флаг не установлен, то при попытке входа в Velpic несуществующего пользователя из Azure произойдет ошибка входа. Если флаг установлен, новые пользователи будут автоматически создаваться для Velpic при первом входе. 
...
1. На **портале управления Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/velpicsaml-tutorial/create_aaduser_01.png) 

1. Перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**, чтобы отобразить список пользователей.
    
    ![Создание тестового пользователя Azure AD](./media/velpicsaml-tutorial/create_aaduser_02.png) 

1. В верхней части диалогового окна щелкните **Добавить**, чтобы открыть диалоговое окно **Пользователь**.
 
    ![Создание тестового пользователя Azure AD](./media/velpicsaml-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/velpicsaml-tutorial/create_aaduser_04.png) 
...
1. На странице **Create New User** (Создание пользователя) выполните следующие действия.
    ...
    4.3. В текстовом поле **Электронная почта** введите адрес электронной почты учетной записи Britta Simon.
...
1. Из списка приложений выберите **Velpic SAML**.
    ...
    ![Настройка единого входа](./media/velpicsaml-tutorial/tutorial_velpicsaml_app.png) 
