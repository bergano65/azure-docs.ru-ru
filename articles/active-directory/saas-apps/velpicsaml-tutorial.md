...
4. Щелкните вкладку **Manage** (Управление), перейдите к разделу **Integration** (Интеграция) и нажмите там кнопку **Plugins** (Подключаемые модули), чтобы создать новый подключаемый модуль для входа.
    ...
    ![Снимок экрана: страница Integration (Интеграция), на которой можно выбрать подключаемые модули.](./media/velpicsaml-tutorial/velpic_1.png)

5. Нажмите кнопку **Add plugin** (Добавить подключаемый модуль).
    
    ![Снимок экрана: выбранная кнопка Add Plugin (Добавить подключаемый модуль).](./media/velpicsaml-tutorial/velpic_2.png)

6. Щелкните плитку **SAML** на странице добавления подключаемого модуля.
    
    ![Снимок экрана: выбранный вариант SAML на странице Add Plugin (Добавление подключаемого модуля).](./media/velpicsaml-tutorial/velpic_3.png)

7. Введите имя нового подключаемого модуля SAML и нажмите кнопку **Add** (Добавить).

    ![Снимок экрана: диалоговое окно Add new SAML plugin (Добавить новый подключаемый модуль SAML) с введенной строкой "Azure AD".](./media/velpicsaml-tutorial/velpic_4.png)

8. Введите следующие сведения:

    ![Снимок экрана: страница Azure AD, на которой можно ввести описанные значения.](./media/velpicsaml-tutorial/velpic_5.png)
...
1. Когда вы нажмете плитку Velpic SAML на панели доступа, должна появиться страница входа в приложение Velpic SAML. На этой странице входа вы увидите кнопку **Log In With Azure AD** (Войти с помощью Azure AD).
    ...
    ![Снимок экрана: портал обучения с выбранной кнопкой Log In With Azure AD (Войти с Azure AD).](./media/velpicsaml-tutorial/velpic_6.png)
