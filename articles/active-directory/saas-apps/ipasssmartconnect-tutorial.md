...
Щелкнув плитку iPass SmartConnect на панели доступа, вы автоматически войдете в iPass SmartConnect, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
