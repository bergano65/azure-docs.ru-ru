...
В этом разделе описано, как создать пользователя Britta Simon в приложении zeroheight. Чтобы добавить пользователей на платформу zeroheight, обратитесь в [службу поддержки zeroheight](mailto:support@zeroheight.com). Перед использованием единого входа необходимо создать и активировать пользователей.
...
3. Вы можете использовать Панель доступа (Майкрософт). Щелкнув плитку "zeroheight" на Панели доступа, вы перейдете по URL-адресу для входа в zeroheight. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
