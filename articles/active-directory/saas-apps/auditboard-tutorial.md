...
## <a name="adding-auditboard-from-the-gallery"></a>Добавление AuditBoard из коллекции
...
4. В поле поиска введите **AuditBoard**, выберите **AuditBoard** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
    ...
    ![AuditBoard в списке результатов](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Настройка и проверка единого входа в Azure AD

В этом разделе описана настройка и проверка единого входа Azure AD в AuditBoard с использованием тестового пользователя **Britta Simon**.
Для обеспечения работы единого входа необходимо установить связь между пользователем Azure AD и соответствующим пользователем в AuditBoard.

Чтобы настроить и проверить единый вход Azure AD в AuditBoard, вам потребуется выполнить действия в следующих стандартных блоках.
...
5. **[Создание тестового пользователя AuditBoard](#create-auditboard-test-user)** требуется, чтобы в AuditBoard существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
Чтобы настроить единый вход Azure AD в AuditBoard, выполните следующие действия.

1. На [портале Azure](https://portal.azure.com/) на странице интеграции с приложением **AuditBoard** щелкните **Единый вход**.
...
### <a name="configure-auditboard-single-sign-on"></a>Настройка единого входа AuditBoard

Чтобы настроить единый вход на стороне **AuditBoard**, необходимо отправить **URL-адрес метаданных федерации приложения** в [группу поддержки AuditBoard](mailto:support@auditboard.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
В этом разделе описано, как разрешить пользователю Britta Simon использовать единый вход Azure путем предоставления доступа к AuditBoard.

1. На портале Azure выберите **Корпоративные приложения**, **Все приложения**, а затем **AuditBoard**.

    ![Колонка "Корпоративные приложения"](common/enterprise-applications.png)

2. В списке приложений выберите **AuditBoard**.

    ![Ссылка на AuditBoard в списке приложений](common/all-applications.png)
...
### <a name="create-auditboard-test-user"></a>Создание тестового пользователя AuditBoard

В этом разделе описано, как создать пользователя Britta Simon в AuditBoard. Обратитесь в [службу поддержки AuditBoard](mailto:support@auditboard.com), чтобы добавить пользователей в платформу AuditBoard. Перед использованием единого входа необходимо создать и активировать пользователей.
