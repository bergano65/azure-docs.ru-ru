---
title: Руководство. Интеграция Azure Active Directory с Kudos | Документация Майкрософт
...
1. В поле поиска введите **Kudos**.

    ![Создание тестового пользователя Azure AD](./media/kudos-tutorial/tutorial_kudos_search.png)

1. На панели результатов выберите **Kudos** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/kudos-tutorial/tutorial_kudos_addfromgallery.png)
...
1. **[Создание тестового пользователя Kudos](#creating-a-kudos-test-user)** требуется для создания в Kudos пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/kudos-tutorial/tutorial_kudos_samlbase.png)

1. В разделе **Домены и URL-адреса Kudos** выполните следующие действия:

    ![Настройка единого входа](./media/kudos-tutorial/tutorial_kudos_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/kudos-tutorial/tutorial_kudos_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/kudos-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Kudos** щелкните **Настроить Kudos**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/kudos-tutorial/tutorial_kudos_configure.png) 

1. В другом окне веб-браузера войдите на ваш корпоративный веб-сайт Kudos в качестве администратора.

1. В верхнем меню нажмите пункт **Параметры**.
   
    ![Параметры](./media/kudos-tutorial/ic787806.png "Параметры")

1. Выберите пункты **Integrations \> SSO** (Интеграции > Единый вход).
...
1. В разделе **Единый вход** сделайте следующее:
    ...
    4.3. В текстовом поле **URL-адрес Kudos** введите название своей компании.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/kudos-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/kudos-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/kudos-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/kudos-tutorial/create_aaduser_04.png) 
...
1. В списке приложений выберите **Kudos**.

    ![Настройка единого входа](./media/kudos-tutorial/tutorial_kudos_app.png) 
...
Щелкнув элемент Kudos на панели доступа, вы автоматически войдете в приложение Kudos. См. дополнительные сведения о [панели доступа](../user-help/active-directory-saas-access-panel-introduction.md)
