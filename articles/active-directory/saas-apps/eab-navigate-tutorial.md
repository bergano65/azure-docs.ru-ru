...
Щелкнув плитку EAB Navigate на панели доступа, вы автоматически войдете в EAB Navigate, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
