---
title: Руководство по Интеграция Azure Active Directory с SCC LifeCycle | Документация Майкрософт
...
ms.locfileid: "65902835"
---
# <a name="tutorial-azure-active-directory-integration-with-scc-lifecycle"></a>Руководство по Интеграция Azure Active Directory с SCC LifeCycle
...
Щелкнув элемент "SCC LifeCycle на Панели доступа, вы автоматически войдете в приложение SCC LifeCycle, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
