...
2. Выберите **Preferences** (Параметры) в разделе **Admin Options** (Параметры администрирования).
    ...
    ![Снимок экрана: раздел для настройки параметров администрирования с выбранным элементом Preferences (Параметры).](./media/timelive-tutorial/configure1.png)

3. В разделе **Application Preference** (Параметры приложения) сделайте следующее.
    
    ![Снимок экрана: раздел для настройки параметров приложения, где можно ввести описанные здесь значения.](./media/timelive-tutorial/configure2.png)
...
Щелкнув плитку TimeLive на Панели доступа, вы автоматически войдете в приложение TimeLive, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
