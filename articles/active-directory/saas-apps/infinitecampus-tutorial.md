...
3. **[Создание тестового пользователя бесконечный Campus](#creating-a-infinite-campus-test-user)**  — требуется для создания пользователя Britta Simon в бесконечную Campus, связанного с одноименным пользователем в Azure AD.
