...
1. В поле поиска введите **Help Scout**, выберите **Help Scout** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Help Scout в списке результатов](./media/helpscout-tutorial/tutorial_helpscout_addfromgallery.png)
...
1. **[Создание тестового пользователя Help Scout](#create-a-help-scout-test-user)** требуется для того, чтобы в Help Scout существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/helpscout-tutorial/tutorial_helpscout_samlbase.png)

1. Если вы хотите настроить приложение в режиме, **инициированном поставщиком удостоверений**, в разделе **Домены и URL-адреса приложения Help Scout** выполните следующие действия:

    ![Сведения о домене и URL-адресах единого входа приложения Help Scout](./media/helpscout-tutorial/tutorial_helpscout_url.png)
...
1. Установите флажок **Показать дополнительные параметры URL-адресов**, если хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**.
    ...
    ![Сведения о домене и URL-адресах единого входа приложения Help Scout](./media/helpscout-tutorial/tutorial_helpscout_url1.png)
...
1. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/helpscout-tutorial/tutorial_helpscout_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/helpscout-tutorial/tutorial_general_400.png)


1. В разделе **Настройка Help Scout** щелкните **Настроить Help Scout**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Quick Reference** (Краткий справочник).

    ![Настройка единого входа](./media/helpscout-tutorial/config.png) 

1. В другом окне веб-браузера войдите на свой корпоративный веб-сайт Help Scout в качестве администратора.

1. После того как вы вошли в систему, щелкните **Manage** (Управление) в верхнем меню, а затем выберите **Company** (Компания) в раскрывающемся меню.
...
1. Отобразится раздел SAML settings (Параметры SAML), после чего выполните следующие действия.
    ...
    b. Скопируйте значение **URI аудитории (идентификатор сущности поставщика службы)** и вставьте его в поле **Идентификатор** на портале Azure в разделе **Домены и URL-адреса приложения Help Scout**.
...
1. Переключите параметр **Enable SAML** (Включить SAML) в положение "Вкл." и выполните следующие действия:
    ...
    a. В текстовое поле  **URL-адрес единого входа**  вставьте значение  **URL-адреса службы единого входа**, скопированное на портале Azure.
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/helpscout-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/helpscout-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/helpscout-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/helpscout-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **Help Scout**.

    ![Ссылка на Help Scout в списке "Приложения"](./media/helpscout-tutorial/tutorial_helpscout_app.png)  
