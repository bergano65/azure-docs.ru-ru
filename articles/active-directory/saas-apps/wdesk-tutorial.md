...
1. В нижнем левом углу щелкните **Admin** (Администрирование) и выберите **Account Admin** (Администрирование учетных записей):
    ...
    ![Снимок экрана: в меню администрирования выбран пункт Account Admin (Администрирование учетных записей).](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig1.png)

1. В разделе администрирования Wdesk откройте **Security** (Безопасность), затем **SAML** > **SAML Settings** (Параметры SAML):

    ![Снимок экрана: на вкладке SAML выбран элемент SAML Settings (Параметры SAML).](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig2.png)
...
4. В разделе **General Settings** (Общие параметры) установите флажок **Enable SAML Single Sign On** (Включить единый вход SAML):
    ...
    ![Снимок экрана: раздел Edit SAML Settings (Изменение параметров единого входа), где можно выбрать параметр Enable SAML Single Sign-On (Включить единый вход SAML).](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig3.png)

5. В разделе **Service Provider Details** (Сведения о поставщике SAML) выполните следующие действия:

    ![Снимок экрана: раздел сведений о поставщике услуг, где можно ввести описанные значения.](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig4.png)
...
1. Щелкните **Configure IdP Settings** (Настройка параметров поставщика удостоверений), чтобы открыть диалоговое окно **изменения параметров поставщика удостоверений**. Щелкните **Choose File** (Выбрать файл) и найдите файл **Metadata.xml**, который вы сохранили с портала Azure, а затем отправьте его.
    ...
    ![Снимок экрана: диалоговое окно изменения параметров поставщика удостоверений, откуда можно отправить метаданные.](./media/wdesk-tutorial/tutorial_wdesk_ssoconfig5.png)
  
1. Нажмите кнопку **Сохранить изменения**.

    ![Снимок экрана: кнопка сохранения изменений.](./media/wdesk-tutorial/tutorial_wdesk_ssoconfigsavebutton.png)
...
4. Теперь щелкните **Add Member** (Добавить участника), чтобы открыть диалоговое окно **Add Member** (Добавление участника). 
    ...
    ![Снимок экрана: вкладка "Members" (Участники), где можно выбрать элемент Add Member (Добавить участника).](./media/wdesk-tutorial/createuser1.png)  

5. В текстовом поле **Пользователь** введите имя пользователя, например b.simon@contoso.com, и нажмите кнопку **Продолжить**.

    ![Снимок экрана: диалоговое окно Add Member (Добавление участника), где можно указать пользователя.](./media/wdesk-tutorial/createuser3.png)

6.  Введите необходимые данные, как показано ниже:
  
    ![Снимок экрана: диалоговое окно Add Member (Добавление участника), где можно добавить основные сведения для пользователя.](./media/wdesk-tutorial/createuser4.png)
...
7. Щелкните кнопку **Save Member** (Сохранить участника).  
    ...
    ![Снимок экрана: раздел отправки приветственного сообщения электронной почты с кнопкой Save Member (Сохранить участника).](./media/wdesk-tutorial/createuser5.png)

### <a name="test-sso"></a>Проверка единого входа 

В этом разделе описано, как проверить конфигурацию единого входа Azure AD с помощью панели доступа.

Щелкнув плитку Wdesk на Панели доступа, вы автоматически войдете в приложение Wdesk, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
