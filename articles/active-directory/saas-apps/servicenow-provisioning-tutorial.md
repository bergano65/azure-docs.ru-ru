...
3. Убедитесь, что следующие параметры **отключены** в ServiceNow:
   ...
   > [!IMPORTANT]
   > Если эти параметры *включены*, подсистема подготовки не сможет обмениваться данными с ServiceNow.
