...
1. **Создание тестового пользователя Lessonly.com** требуется для создания соответствующего пользователя Britta Simon в Lessonly.com, связанного с одноименным пользователем в Azure AD.
...
1. В разделе **Домены и URL-адреса приложения Lessonly.com** выполните следующие действия:
    ...
    > [!NOTE] 
    > Эти значения приведены для примера. Замените эти значения фактическим URL-адресом для входа и идентификатором. Чтобы получить их, обратитесь в [службу поддержки клиентов Lessonly.com](mailto:support@lessonly.com). 
