...
4. Выберите **Administration (Администрирование) > Authentication (Проверка подлинности) > Authentication Settings (Параметры проверки подлинности)** и выполните следующие действия:
    ...
    ![Администрирование](./media/zscaler-one-tutorial/ic800206.png "Администрирование")
...
6. На странице **Настройка проверки подлинности пользователей** выполните следующие действия.
    ...
    ![Администрирование](./media/zscaler-one-tutorial/ic800207.png)
...
3. Щелкните вкладку **Подключения** .   
     ...
     ![Подключения](./media/zscaler-one-tutorial/ic769493.png "Подключения")
...
Щелкнув плитку Zscaler One на Панели доступа, вы автоматически войдете в приложение Zscaler One, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
