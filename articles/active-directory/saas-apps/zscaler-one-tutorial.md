...
4. В поле поиска введите **Zscaler One**, выберите **Zscaler One** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
    ...
    ![Zscaler One в списке результатов](./media/zscaler-one-tutorial/tutorial_zscalerone_addfromgallery.png)
...
3. **[Создание тестового пользователя Zscaler One](#creating-a-zscaler-one-test-user)** требуется для того, чтобы в Zscaler One существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
4. В разделе **Базовая конфигурация SAML** выполните приведенные ниже действия.
    ...
    ![Сведения о домене и URL-адресах единого входа приложения Zscaler One](./media/zscaler-one-tutorial/tutorial_zscalerone_url.png)
...
7. На странице **сертификата подписи SAML** в разделе **Сертификат подписи SAML** щелкните **Скачать**, чтобы скачать **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/zscaler-one-tutorial/tutorial_zscalerone_certificate.png) 

8. Требуемый URL-адрес можно скопировать из раздела **Настройка Zscaler One**.
    ...
    ![Конфигурация Zscaler One](common/configuresection.png)

9. В другом окне веб-браузера войдите на свой корпоративный сайт Zscaler One в качестве администратора.
...
Цель этого раздела — создать пользователя с именем Britta Simon в Zscaler One. Приложение Zscaler One поддерживает JIT-подготовку. Эта функция включена по умолчанию. В этом разделе никакие действия с вашей стороны не требуются. Пользователь будет создан при попытке получить доступ к Zscaler One (если он еще не создан).
>[!Note]
>Если вам нужно создать пользователя вручную, обратитесь в  [службу поддержки Zscaler One](https://www.zscaler.com/company/contact).
...
2. Из списка приложений выберите **Zscaler One**.
    ...
    ![Настройка единого входа](./media/zscaler-one-tutorial/tutorial_zscalerone_app.png)
...
5. В диалоговом окне **Пользователи и группы** из списка пользователей выберите **Britta Simon**, а затем в нижней части экрана нажмите кнопку **Выбрать**.
    ...
    ![изображение](./media/zscaler-one-tutorial/tutorial_zscalerone_users.png)
...
6. В диалоговом окне **Выбор роли** выберите соответствующие роли пользователей из списка, а затем нажмите кнопку **Выбрать** в нижней части экрана.
    ...
    ![изображение](./media/zscaler-one-tutorial/tutorial_zscalerone_roles.png)

7. В диалоговом окне **Добавление назначения** нажмите кнопку **Назначить**.

    ![изображение](./media/zscaler-one-tutorial/tutorial_zscalerone_assign.png)
