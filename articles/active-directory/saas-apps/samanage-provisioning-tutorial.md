...
1. Войдите в [портала Azure](https://portal.azure.com) и выберите **корпоративные приложения**выберите **все приложения**, а затем выберите **Samanage**.
...
15. Определите пользователей или группы для подготовки в Samanage, выбрав нужные значения в поле **Область** раздела **Параметры**. При выборе параметра **Синхронизация всех пользователей и групп** необходимо учитывать ограничения, описанные в разделе **Ограничения соединителя** разделе ниже.
...
* Если выбран параметр **Синхронизация всех пользователей и групп** и для атрибута **roles** Samanage указано значение по умолчанию, укажите нужное значение в поле **Значение по умолчанию для NULL (необязательно)** в формате **{"displayName":"role"}**, где role — нужное значение по умолчанию.
