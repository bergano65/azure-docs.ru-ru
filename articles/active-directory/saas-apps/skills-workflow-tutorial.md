...
На этом шаге вы создадите пользователя с именем B.Simon в приложении Skills Workflow. Чтобы добавить пользователей на платформу Skills Workflow обратитесь в [службу технической поддержки Skills Workflow](mailto:support@skillsworkflow.com). Перед использованием единого входа необходимо создать и активировать пользователей.

## <a name="test-sso"></a>Проверка единого входа

В этом разделе описано, как проверить конфигурацию единого входа Azure AD с помощью панели доступа.

Щелкнув плитку Skills Workflow на Панели доступа, вы автоматически войдете в приложение Skills Workflow, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
...
- [Как защитить Skills Workflow с помощью функции управления настройками условного доступа](/cloud-app-security/proxy-intro-aad)