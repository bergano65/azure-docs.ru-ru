---
title: Руководство. Интеграция Azure Active Directory с Zoom | Документация Майкрософт
...
* Вы можете включить автоматический вход пользователей в Zoom (единый вход) с помощью учетной записи Azure AD.
...
* Zoom поддерживает единый вход, инициированный **поставщиком услуг**.
...
Для обеспечения работы единого входа необходимо установить связь между пользователем Azure AD и соответствующим пользователем в Zoom.
...
2. **[Настройка единого входа в Zoom](#configure-zoom-single-sign-on)** необходима, чтобы настроить параметры единого входа на стороне приложения.
3. **[Создание тестового пользователя Azure AD](#create-an-azure-ad-test-user)** требуется для проверки работы единого входа Azure AD от имени пользователя Britta Simon.
4. **[Назначение тестового пользователя Azure AD](#assign-the-azure-ad-test-user)** необходимо, чтобы позволить Britta Simon использовать единый вход Azure AD.
5. **[Создание тестового пользователя приложения Zoom](#create-zoom-test-user)** требуется для того, чтобы в Zoom существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. На [портале Azure](https://portal.azure.com/) на странице интеграции с приложением **Zoom** выберите **Единый вход**.
...
4. В разделе **Базовая конфигурация SAML** выполните приведенные ниже действия.
    ...
    ![Сведения о домене и URL-адресах единого входа для приложения Zoom](common/sp-identifier.png)
...
6. Требуемый URL-адрес можно скопировать из раздела **Настройка Zoom**.
...
1. В другом окне браузера войдите на свой корпоративный сайт Zoom в качестве администратора.
...
1. На портале Azure выберите **Корпоративные приложения**, **Все приложения**, а затем **Zoom**.

    ![Колонка "Корпоративные приложения"](common/enterprise-applications.png)

2. В списке приложений введите и выберите **Zoom**.
...
3. В разделе «Управление пользователями» щелкните **Добавить пользователей**.
    ...
    ![Управление пользователями](./media/zoom-tutorial/IC784703.png "Управление пользователями")

4. На странице **Добавление пользователей** сделайте следующее:
   
    ![Добавление пользователей](./media/zoom-tutorial/IC784704.png "Добавление пользователей")
   
    a. В поле **User Type** (Тип пользователя) задайте значение **Basic** (Базовый).

    b. В текстовом поле **Emails** (Адреса электронной почты) введите адрес действующей учетной записи Azure AD, которую вы хотите подготовить.
...
Щелкнув плитку Zoom на панели доступа, вы автоматически войдете в приложение Zoom, для которого настроили единый вход. Дополнительные сведения о панели доступа см. в статье [Общие сведения о панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
