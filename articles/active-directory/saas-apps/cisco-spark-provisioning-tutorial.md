...
1. Войдите на [портал Azure](https://portal.azure.com) и последовательно выберите **Корпоративные приложения**, **Все приложения**, а затем **Cisco Spark**.
...
6. Чтобы узнать **Идентификатор клиента** и **Секретный токен** учетной записи Cisco Spark, используйте учетную запись администратора для входа на [веб-сайт для разработчиков Cisco Spark](https://developer.webex.com/). Действия, которые необходимо выполнить после входа в систему.
   ...
   * Прокрутите вниз до [раздела аутентификации](https://developer.webex.com/getting-started.html#authentication).
  
    ![Маркер аутентификации Cisco Spark](./media/cisco-spark-provisioning-tutorial/SecretToken.png)
