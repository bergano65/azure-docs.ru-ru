---
title: Руководство по интеграции единого входа Azure Active Directory с приложением Change Process Management | Документация Майкрософт
...
* Управление доступом к Change Process Management с помощью Azure AD.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-change-process-management"></a>Настройка и проверка единого входа Azure AD для Change Process Management
...
Чтобы настроить и проверить единый вход Azure AD в Change Process Management, выполните действия, указанные в следующих стандартных блоках:

1. **[Настройка единого входа Azure AD](#configure-azure-ad-sso)** необходима, чтобы пользователи могли использовать эту функцию.
    1. **[Создание тестового пользователя Azure AD](#create-an-azure-ad-test-user)** требуется для проверки работы единого входа Azure AD с помощью пользователя B.Simon.
    1. **[Назначение тестового пользователя Azure AD](#assign-the-azure-ad-test-user)** необходимо, чтобы позволить пользователю B.Simon использовать единый вход Azure AD.
1. **[Настройка единого входа в Change Process Management](#configure-change-process-management-sso)** необходима, чтобы настроить параметры единого входа на стороне приложения.
    1. **[Создание тестового пользователя Change Process Management](#create-change-process-management-test-user)** требуется для того, чтобы в Change Process Management существовал пользователь B.Simon, связанный с одноименным представлением в Azure AD.
...
1. На странице **Настройка единого входа с помощью SAML** введите значения для следующих полей:
    ...
    а. В текстовом поле **Идентификатор** введите URL-адрес в формате `https://<hostname>:8443/`.

    b. В текстовом поле **URL-адрес ответа** введите URL-адрес в формате `https://<hostname>:8443/changepilot/saml/sso`.
...
Чтобы настроить единый вход на стороне **Change Process Management**, нужно отправить скачанный **сертификат (Base64)** и соответствующие URL-адреса, скопированные на портале Azure, в [службу поддержки Change Process Management](mailto:support@realtech-us.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.

### <a name="create-change-process-management-test-user"></a>Создание тестового пользователя Change Process Management

В этом разделе описано, как создать пользователя B.Simon в приложении Change Process Management. Обратитесь в  [службу поддержки Change Process Management](mailto:support@realtech-us.com), чтобы добавить пользователей на платформу Change Process Management. Перед использованием единого входа необходимо создать и активировать пользователей.

## <a name="test-sso"></a>Проверка единого входа 

В этом разделе описано, как проверить конфигурацию единого входа Azure AD с помощью панели доступа.

Щелкнув плитку Change Process Management на Панели доступа, вы автоматически войдете в приложение Change Process Management, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
