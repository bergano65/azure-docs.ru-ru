---
title: Учебник. подготовка пользователей для ThousandEyes — Azure AD
...
4. Для параметра **Режим подготовки к работе** выберите значение **Automatic** (Автоматически).
    ...
    ![На снимке экрана показана вкладка подготовки для ThousandEyes с автоматически выбранным для режима подготовки.](./media/thousandeyes-provisioning-tutorial/ThousandEyes1.png)
