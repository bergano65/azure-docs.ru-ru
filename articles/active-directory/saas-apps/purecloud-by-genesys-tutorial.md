...
1. Выберите **Администратор** вверху и перейдите к пункту **Единый вход** в разделе **Интеграции** .
    ...
    ![Снимок экрана: окно PureCloud Admin (Администратор PureCloud), где можно выбрать Single Sign-on (Единый вход).](./media/purecloud-by-genesys-tutorial/configure01.png)

1. Перейдите на вкладку **ADFS/Azure AD (Premium)** и выполните приведенные ниже действия.

    ![Снимок экрана: страница Integrations (Интеграции), где можно ввести описанные значения.](./media/purecloud-by-genesys-tutorial/configure02.png)
    ...
    ![Снимок экрана: область Properties (Свойства), где можно найти значение идентификатора приложения.](./media/purecloud-by-genesys-tutorial/configure06.png)
...
1. Нажмите **Администратор** вверху и перейдите к пункту **Пользователи** в разделе **Пользователи и разрешения** .
    ...
    ![Снимок экрана: окно PureCloud Admin (Администратор PureCloud), где можно выбрать People (Пользователи).](./media/purecloud-by-genesys-tutorial/configure03.png)

1. На странице **Пользователи** щелкните **Добавить пользователя** .

    ![Снимок экрана: страница People (Пользователи), где можно добавить пользователя.](./media/purecloud-by-genesys-tutorial/configure04.png)

1. В диалоговом окне **Добавить пользователей в организацию** выполните приведенные ниже действия.

    ![Снимок экрана: страница для ввода описанных значений](./media/purecloud-by-genesys-tutorial/configure05.png)
