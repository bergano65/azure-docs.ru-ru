...
В этом разделе описано, как создать пользователя Britta Simon в приложении CorpTax. Чтобы добавить пользователей на платформу Corptax, обратитесь в [службу поддержки Corptax](https://connect.corptax.com/). Перед использованием единого входа необходимо создать и активировать пользователей.
...
В текстовом поле **Среда** введите соответствующую среду, и вы автоматически войдете в приложение CorpTax, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
