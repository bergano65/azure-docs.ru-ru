...
* Вы можете включить автоматический вход пользователей в CorpTax (единый вход) с помощью учетных записей Azure AD.
...
* CorpTax поддерживает единый вход, инициируемый **поставщиком услуг**.
...
5. **[Создание тестового пользователя приложения CorpTax](#create-corptax-test-user)** требуется, чтобы в CorpTax существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
В этом разделе описано, как позволить пользователю Britta Simon использовать единый вход Azure, предоставив этому пользователю доступ к Corptax.

1. На портале Azure выберите **Корпоративные приложения**, **Все приложения**, а затем **CorpTax**.

    ![Колонка "Корпоративные приложения"](common/enterprise_applications.png)

2. Из списка приложений введите и выберите **CorpTax**.
...
В этом разделе описано, как создать пользователя Britta Simon в приложении CorpTax. Обратитесь к  [группе поддержки CorpTax](https://connect.corptax.com/), чтобы добавить пользователей на платформу CorpTax. Перед использованием единого входа необходимо создать и активировать пользователей.
