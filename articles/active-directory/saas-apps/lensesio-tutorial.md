...
Дополнительные сведения об интеграции приложений SaaS с Azure AD см. в статье о [едином входе в приложения с помощью Azure AD](../manage-apps/what-is-single-sign-on.md).
...
Щелкнув плитку Lenses.io на Панели доступа, вы автоматически войдете на портал Lenses.io. Дополнительные сведения см. в статье [Общие сведения о панели доступа](../user-help/my-apps-portal-end-user-access.md).
...
- [Как защитить Lenses.io с помощью функции управления настройками условного доступа](/cloud-app-security/proxy-intro-aad)