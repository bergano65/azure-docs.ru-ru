...
1. На странице **Single sign-on (SAML)** (Единый вход (SAML)) выполните следующие действия.
    ...
    b. В текстовое поле **SAML SSO URL** (URL-адрес единого входа SAML) вставьте значение **SAML Single Sign-On Service URL** (URL-адрес службы единого входа SAML), скопированное на портале Azure.
