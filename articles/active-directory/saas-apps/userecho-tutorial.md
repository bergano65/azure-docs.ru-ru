...
* С помощью Azure Active Directory вы можете контролировать доступ к приложению UserEcho.
* Вы можете включить автоматический вход для пользователей в UserEcho (единый вход) с помощью учетных записей Azure Active Directory.
...
* Приложение UserEcho поддерживает единый вход, инициированный **поставщиком услуг**.
...
4. В поле поиска введите **UserEcho**, выберите **UserEcho** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

     ![UserEcho в списке результатов](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Настройка и проверка единого входа в Azure AD

В этом разделе описана настройка и проверка единого входа Azure Active Directory в UserEcho с использованием тестового пользователя **Britta Simon**.
Для обеспечения работы единого входа необходимо установить связь между пользователем Azure Active Directory и соответствующим пользователем в UserEcho.
...
2. **[Настройка единого входа в UserEcho](#configure-userecho-single-sign-on)** необходима, чтобы настроить параметры единого входа на стороне приложения.
3. **[Создание тестового пользователя Azure AD](#create-an-azure-ad-test-user)** требуется для проверки работы единого входа Azure AD от имени пользователя Britta Simon.
4. **[Назначение тестового пользователя Azure AD](#assign-the-azure-ad-test-user)** необходимо, чтобы разрешить пользователю Britta Simon использовать единый вход Azure AD.
5. **[Создание тестового пользователя UserEcho](#create-userecho-test-user)** требуется для того, чтобы в приложении UserEcho существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure Active Directory.
...
Чтобы настроить единый вход Azure Active Directory в UserEcho, сделайте следующее.

1. На [портале Azure](https://portal.azure.com/) на странице интеграции с приложением **UserEcho** выберите **Единый вход**.
...
4. В разделе **Базовая конфигурация SAML** выполните приведенные ниже действия.
    ...
    а. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://<companyname>.userecho.com/`.
...
6. Требуемый URL-адрес вы можете скопировать из раздела **Настройка UserEcho**.
...
### <a name="configure-userecho-single-sign-on"></a>Настройка единого входа в UserEcho
...
2. На панели инструментов вверху щелкните имя пользователя, чтобы развернуть меню, а затем щелкните **Setup**(Настройка).
    ...
    ![Настройка единого входа](./media/userecho-tutorial/tutorial_userecho_06.png) 

3. Щелкните **Integrations**(Интеграция).
   
    ![Настройка единого входа](./media/userecho-tutorial/tutorial_userecho_07.png) 

4. Щелкните **Website** (Веб-сайт), а затем — **Single sign-on (SAML2)** (Единый вход (SAML2)).
   
    ![Настройка единого входа](./media/userecho-tutorial/tutorial_userecho_08.png) 

5. На странице **Single sign-on (SAML)** (Единый вход (SAML)) выполните следующие действия.
   
    ![Настройка единого входа](./media/userecho-tutorial/tutorial_userecho_09.png)
...
1. На портале Azure выберите **Корпоративные приложения**, **Все приложения**, а затем — **UserEcho**.

    ![Колонка "Корпоративные приложения"](common/enterprise-applications.png)

2. Из списка приложений выберите **UserEcho**.

    ![Ссылка на UserEcho в списке "Приложения"](common/all-applications.png)
...
### <a name="create-userecho-test-user"></a>Создание тестового пользователя UserEcho
...
3. Щелкните **Users** (Пользователи), чтобы развернуть раздел **Users** (Пользователи).
    ...
    ![Настройка единого входа](./media/userecho-tutorial/tutorial_userecho_10.png)

4. Выберите раздел **Пользователи**.
   
    ![Настройка единого входа](./media/userecho-tutorial/tutorial_userecho_11.png)

5. Щелкните **Invite a new user**(Пригласить нового пользователя).
   
    ![Настройка единого входа](./media/userecho-tutorial/tutorial_userecho_12.png)

6. В диалоговом окне **Invite a new user** (Приглашение нового пользователя) выполните следующие действия.
   
    ![Настройка единого входа](./media/userecho-tutorial/tutorial_userecho_13.png)
...
Щелкнув плитку UserEcho на Панели доступа, вы автоматически войдете в приложение UserEcho, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
