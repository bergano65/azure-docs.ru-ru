...
Щелкнув плитку ProMaster (от Inlogik) на Панели доступа, вы автоматически войдете в приложение ProMaster (от Inlogik), для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
...
- [Как защитить ProMaster (от Inlogik) с помощью функции управления настройками условного доступа](/cloud-app-security/proxy-intro-aad)