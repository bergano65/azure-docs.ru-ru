...
* При назначении пользователю программы необходимо выбрать в диалоговом окне **назначение** любую допустимую роль конкретного приложения (если она доступна). Пользователи с ролью *доступа по умолчанию* исключаются из подготовки.

## <a name="set-up-harness-for-provisioning"></a>Настройка программы для подготовки

1. Войдите в [консоль администратора](https://app.harness.io/#/login)программы и перейдите в раздел **непрерывное** > **Управление доступом к**безопасности.
