...
Щелкнув плитку Kemp LoadMaster Azure AD integration на Панели доступа, вы автоматически войдете в приложение Kemp LoadMaster Azure AD integration, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
...
- [Как защитить Kemp LoadMaster Azure AD integration с помощью расширенных возможностей визуального контроля и элементов управления](/cloud-app-security/proxy-intro-aad)