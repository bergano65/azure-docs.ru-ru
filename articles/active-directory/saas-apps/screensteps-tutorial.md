...
1. Щелкните **Single Sign-on**(Единый вход).
    ...
    ![Снимок экрана: выбран пункт меню Single Sign-on (Единый вход).](./media/screensteps-tutorial/ic778524.png "Удаленная проверка подлинности")
...
Щелкнув плитку ScreenSteps на Панели доступа, вы автоматически войдете в приложение ScreenSteps, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
