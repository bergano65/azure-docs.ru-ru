...
4. В поле поиска введите **&frankly**.
    ...
    ![Создание тестового пользователя Azure AD](./media/andfrankly-tutorial/tutorial_andfrankly_search.png)

5. На панели результатов выберите **&frankly** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/andfrankly-tutorial/tutorial_andfrankly_addfromgallery.png)
...
2. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/andfrankly-tutorial/tutorial_andfrankly_samlbase.png)
...
3. Если вы хотите настроить приложение в **режиме, инициируемом IdP**, то в разделе **Домены и URL-адреса приложения &frankly** выполните следующие действия.
    ...
    ![Настройка единого входа](./media/andfrankly-tutorial/tutorial_andfrankly_url.png)
...
4. Установите флажок **Показать дополнительные параметры URL-адресов**, если хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**.
    ...
    ![Настройка единого входа](./media/andfrankly-tutorial/tutorial_andfrankly_url1.png)
...
5. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/andfrankly-tutorial/tutorial_andfrankly_certificate.png) 

6. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/andfrankly-tutorial/tutorial_general_400.png)
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/andfrankly-tutorial/create_aaduser_01.png) 

2. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/andfrankly-tutorial/create_aaduser_02.png) 

3. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/andfrankly-tutorial/create_aaduser_03.png) 

4. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/andfrankly-tutorial/create_aaduser_04.png) 
...
2. В списке приложений выберите **&frankly**.
    ...
    ![Настройка единого входа](./media/andfrankly-tutorial/tutorial_andfrankly_app.png) 
