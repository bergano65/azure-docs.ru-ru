...
В этом разделе описано, как создать пользователя Britta Simon в приложении Learning Seat LMS. Чтобы добавить пользователей на платформу Learning Seat LMS, обратитесь в [службу технической поддержки Learning Seat LMS](http://help.learningseatlms.com/help). Перед использованием единого входа необходимо создать и активировать пользователей.
