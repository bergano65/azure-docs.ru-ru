...
б) Вы можете включить подготовку пользователей с помощью приложения AWS в Azure AD, после чего наша служба будет получать все роли из этой учетной записи AWS. Не нужно вручную добавлять или обновлять роли AWS для приложения.
