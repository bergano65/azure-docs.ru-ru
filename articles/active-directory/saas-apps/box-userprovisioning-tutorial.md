...
4. Для параметра **Режим подготовки к работе** выберите значение **Automatic** (Автоматически). 
    ...
    ![Снимок экрана: вкладка "подготовка" для Box в портал Azure. Для режима подготовки задано значение автоматически, а авторизация выделена в учетных данных администратора.](./media/box-userprovisioning-tutorial/provisioning.png)
...
6. На странице **Войдите в систему, чтобы предоставить доступ к Box** введите необходимые учетные данные и нажмите кнопку **Авторизовать**. 
    ...
    ![Снимок экрана: вход для предоставления доступа к окну Box, отображение записи для электронной почты и пароля, а также кнопки авторизовать.](./media/box-userprovisioning-tutorial/IC769546.png "Включить автоматическую подготовку пользователей")

7. Нажмите кнопку **Предоставить доступ к Box**, чтобы авторизовать операцию и вернуться на портал Azure. 
   
    ![Снимок экрана: окно авторизации доступа в Box, в котором отображается пояснительное сообщение и кнопка предоставления доступа к Box.](./media/box-userprovisioning-tutorial/IC769549.png "Включить автоматическую подготовку пользователей")
