...
6. На странице **Войдите в систему, чтобы предоставить доступ к Box** введите необходимые учетные данные и нажмите кнопку **Авторизовать**. 
    ...
    ![Включить автоматическую подготовку пользователей](./media/box-userprovisioning-tutorial/IC769546.png "Включить автоматическую подготовку пользователей")

7. Нажмите кнопку **Предоставить доступ к Box**, чтобы авторизовать операцию и вернуться на портал Azure. 
   
    ![Включить автоматическую подготовку пользователей](./media/box-userprovisioning-tutorial/IC769549.png "Включить автоматическую подготовку пользователей")
...
* [Настройка единого ввоза](box-tutorial.md)
