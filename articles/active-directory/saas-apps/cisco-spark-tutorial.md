---
title: Руководство по Интеграция Azure Active Directory с Cisco Spark | Документация Майкрософт
...
ms.locfileid: "56191560"
---
# <a name="tutorial-azure-active-directory-integration-with-cisco-spark"></a>Руководство по Интеграция Azure Active Directory с Cisco Spark
...
4. В разделе **Базовая конфигурация SAML** выполните приведенные ниже действия.
    ...
    б) В текстовом поле **Идентификатор (сущности)** введите URL-адрес в следующем формате: `https://idbroker.webex.com/<companyname>`.

    > [!NOTE]
    > Значение идентификатора не является реальным. Вместо него нужно указать фактический идентификатор. Для получения этого значения обратитесь в [группу поддержки клиентов Cisco Spark](https://support.ciscospark.com/). Можно также посмотреть шаблоны в разделе **Базовая конфигурация SAML** на портале Azure.
...
Щелкнув плитку "Cisco Spark" на панели доступа, вы автоматически войдете в приложение Cisco Spark, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
