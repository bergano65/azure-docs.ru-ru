...
В рамках этого руководства вы настроите и проверите единый вход Azure AD в тестовой среде. Cisco Webex поддерживает единый вход, инициируемый **поставщиком службы**, а также **автоматическую** подготовку пользователей.
