---
title: 'Учебник: Подготовка пользователей для Cerner Central - Azure AD'
...
> [!TIP]
> Вы также можете выбрать включенный SAML-однозначный знак для Cerner Central, следуя инструкциям, предоставленным [на портале Azure.](https://portal.azure.com) Единый вход можно настроить независимо от автоматической подготовки, хотя две эти функции дополняют друг друга. Дополнительные сведения см. в [руководстве по настройке единого входа в Cerner Central](cernercentral-tutorial.md).
...
8. Установите **режим обеспечения** **автоматического.**
...
* [Узнайте, как просматривать журналы и получать отчеты о деятельности по подготовке.](https://docs.microsoft.com/azure/active-directory/active-directory-saas-provisioning-reporting)
