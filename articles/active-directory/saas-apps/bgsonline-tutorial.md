...
1. В поле поиска введите **BGS Online**.

    ![Создание тестового пользователя Azure AD](./media/bgsonline-tutorial/tutorial_bgsonline_search.png)

1. На панели результатов выберите **BGS Online** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/bgsonline-tutorial/tutorial_bgsonline_addfromgallery.png)
...
1. **[Создание тестового пользователя BGS Online](#creating-a-bgs-online-test-user)** нужно для того, чтобы в BGS Online также существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/bgsonline-tutorial/tutorial_bgsonline_samlbase.png)

1. В разделе **Домены и URL-адреса приложения BGS Online** выполните следующие действия.

    ![Настройка единого входа](./media/bgsonline-tutorial/tutorial_bgsonline_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/bgsonline-tutorial/tutorial_bgsonline_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/bgsonline-tutorial/tutorial_general_400.png)

1. В разделе **Настройка BGS Online** щелкните **Настроить BGS Online**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/bgsonline-tutorial/tutorial_bgsonline_configure.png) 

1. Чтобы настроить единый вход на стороне **BGS Online**, нужно отправить скачанный **XML-файл метаданных** и **URL-адрес службы единого входа SAML** [группе поддержки BGS Online](mailto:bgsdashboardteam@millwardbrown.com). 
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/bgsonline-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/bgsonline-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/bgsonline-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/bgsonline-tutorial/create_aaduser_04.png) 
...
1. Из списка приложений выберите **BGS Online**.

    ![Настройка единого входа](./media/bgsonline-tutorial/tutorial_bgsonline_app.png) 
