...
1. В поле поиска введите **Pingboard**, выберите **Pingboard** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
    ...
    ![Pingboard в списке результатов](./media/pingboard-tutorial/tutorial_pingboard_addfromgallery.png)
...
1.  В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/pingboard-tutorial/tutorial_pingboard_samlbase.png)

1. Если вы хотите настроить приложение в режиме, инициированном **поставщиком удостоверений**, то в разделе **Домены и URL-адреса приложения Pingboard** выполните следующие действия:

    ![Сведения о домене и URL-адресах единого входа для приложения Pingboard для IdP](./media/pingboard-tutorial/tutorial_pingboard_url.png)
...
1. Установите флажок **Показать дополнительные параметры URL-адресов**, если вы хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**.
    ...
    ![Сведения о домене и URL-адресах единого входа для приложения Pingboard для поставщика услуг](./media/pingboard-tutorial/tutorial_pingboard_sp_initiated01.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **XML метаданных** и сохраните XML-файл на компьютере.
    ...
    ![XML-файл метаданных Pingboard](./media/pingboard-tutorial/tutorial_pingboard_certificate.png)

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/pingboard-tutorial/tutorial_general_400.png)
...
1. В верхнем меню выберите **Apps > Integrations** ("Приложения" > "Интеграция").

    ![Настройка единого входа](./media/pingboard-tutorial/Pingboard_integration.png)

1. На странице **Integrations** (Интеграция) найдите элемент **Azure Active Directory** и щелкните его.

    ![Интеграция для единого входа в Pingboard](./media/pingboard-tutorial/Pingboard_aad.png)

1. В появившемся модальном окне щелкните **Configure** (Настройка).

    ![Кнопка настройки в Pingboard](./media/pingboard-tutorial/Pingboard_configure.png)

1. На следующей странице вы увидите сообщение "Azure SSO Integration is enabled" (Интеграция для единого входа Azure включена). Откройте скачанный XML-файл метаданных в Блокноте и вставьте его содержимое в поле **IDP Metadata** (Метаданные IdP).

    ![Экран настройки единого входа в Pingboard](./media/pingboard-tutorial/Pingboard_sso_configure.png)

1. Файл будет проверен, и если он пройдет проверку, то единый вход будет включен.
...
1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    ...
    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/pingboard-tutorial/create_aaduser_02.png)

1. В верхней части диалогового окна щелкните **Добавить**, чтобы открыть диалоговое окно **Пользователь**.

    ![Кнопка "Добавить"](./media/pingboard-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.

    ![Диалоговое окно "Пользователь"](./media/pingboard-tutorial/create_aaduser_04.png)
...
1. Нажмите кнопку **Add Employee** (Добавить сотрудника) на странице **Directory** (Каталог).

    ![Добавление сотрудника](./media/pingboard-tutorial/create_testuser_add.png)

1. На диалоговой странице **Add Employee** (Добавление сотрудника) выполните следующие действия.
...
1. Откроется окно подтверждения добавления пользователя.
...
1. В списке приложений выберите **Pingboard**.

    ![Ссылка на Pingboard в списке "Приложения"](./media/pingboard-tutorial/tutorial_pingboard_app.png) 
...
* [Руководство по настройке Google Apps для автоматической подготовки пользователей](pingboard-provisioning-tutorial.md)
