...
При нажатии на плитку "TOPdesk — Secure" на панели доступа вы автоматически войдете в TOPdesk — Secure, для которой настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
