...
1. В диалоговом окне **Пользователи и группы** из списка пользователей выберите **Britta Simon**, а затем в нижней части экрана нажмите кнопку **Выбрать**.
    ...
    ![Снимок экрана: диалоговое окно "Пользователи и группы", где можно выбрать пользователя.](./media/zscaler-three-tutorial/tutorial_zscalerthree_users.png)
...
1. В диалоговом окне **Выбор роли** выберите соответствующие роли пользователей из списка, а затем нажмите кнопку **Выбрать** в нижней части экрана.
    ...
    ![Снимок экрана: диалоговое окно "Выбор роли", где можно выбрать роль пользователя.](./media/zscaler-three-tutorial/tutorial_zscalerthree_roles.png)

1. В диалоговом окне **Добавление назначения** нажмите кнопку **Назначить**.

    ![Снимок экрана: диалоговое окно "Добавление назначения", где можно нажать кнопку "Назначить".](./media/zscaler-three-tutorial/tutorial_zscalerthree_assign.png)
...
4. Выберите **Administration (Администрирование) > Authentication (Проверка подлинности) > Authentication Settings (Параметры проверки подлинности)** и выполните следующие действия:
    ...
    ![Снимок экрана: веб-сайт Zscaler One с элементами, выбранными по описанным ниже инструкциям.](./media/zscaler-three-tutorial/ic800206.png "Администрирование")
...
6. На странице **Настройка проверки подлинности пользователей** выполните следующие действия.
    ...
    ![Снимок экрана: диалоговое окно настройки проверки подлинности пользователя с выделенной кнопкой активации.](./media/zscaler-three-tutorial/ic800207.png)
...
* Вы можете использовать портал "Мои приложения" корпорации Майкрософт. Щелкнув плитку Zscaler Three в разделе "Мои приложения", вы перейдете по URL-адресу для входа в Zscaler Three. Дополнительные сведения о портале "Мои приложения" см. в [этой статье](../user-help/my-apps-portal-end-user-access.md).
