...
1. В диалоговом окне **единого входа** сделайте следующее.
    ...
    а. В текстовом поле **SAML Issuer URL** (URL-адрес издателя SAML) вставьте значение **Идентификатор Azure AD** из окна настройки приложения Azure AD.
...
Щелкнув плитку SpaceIQ на панели доступа, вы автоматически войдете в SpaceIQ, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
