---
title: Руководство по Интеграция Azure Active Directory с Teamwork.com | Документация Майкрософт
...
ms.locfileid: "65888435"
---
# <a name="tutorial-azure-active-directory-integration-with-teamworkcom"></a>Руководство по Интеграция Azure Active Directory с Teamwork.com
...
* Можно включить автоматический вход пользователей в Teamwork.com (единый вход) с помощью учетной записи Azure AD.
...
* Teamwork.com поддерживает единый вход, инициированный **поставщиком службы**.
...
4. В поле поиска введите **Teamwork.com**, выберите **Teamwork.com** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Teamwork.com в списке результатов](common/search-new-app.png)
...
Для обеспечения работы единого входа необходимо установить связь между пользователем Azure AD и соответствующим пользователем в Teamwork.com.
...
2. **[Настройка единого входа в Teamwork.com](#configure-teamworkcom-single-sign-on)** необходима, чтобы настроить параметры единого входа на стороне приложения.
3. **[Создание тестового пользователя Azure AD](#create-an-azure-ad-test-user)** требуется для проверки работы единого входа Azure AD от имени пользователя Britta Simon.
4. **[Назначение тестового пользователя Azure AD](#assign-the-azure-ad-test-user)** необходимо, чтобы разрешить пользователю Britta Simon использовать единый вход Azure AD.
5. **[Создание тестового пользователя Teamwork.com](#create-teamworkcom-test-user)** требуется для того, чтобы в Teamwork.com существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. На [портале Azure](https://portal.azure.com/) на странице интеграции с приложением **Teamwork.com** выберите **Единый вход**.
...
4. В разделе **Базовая конфигурация SAML** выполните приведенные ниже действия.
    ...
    ![Сведения о домене и URL-адресах единого входа для приложения Teamwork.com](common/sp-identifier.png)
...
6. Требуемый URL-адрес можно скопировать из раздела **Настройка Teamwork.com**.
...
### <a name="configure-teamworkcom-single-sign-on"></a>Настройка единого входа в Teamwork.com

Чтобы настроить единый вход на стороне **Teamwork.com**, нужно отправить скачанный файл **XML метаданных федерации** и соответствующие URL-адреса, скопированные на портале Azure, в [службу поддержки Teamwork.com](mailto:support@teamwork.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
1. На портале Azure выберите **Корпоративные приложения**, **Все приложения**, а затем — **Teamwork.com**.

    ![Колонка "Корпоративные приложения"](common/enterprise-applications.png)

2. Из списка приложений выберите **Teamwork.com**.

    ![Ссылка на Teamwork.com в списке приложений](common/all-applications.png)
...
### <a name="create-teamworkcom-test-user"></a>Создание тестового пользователя Teamwork.com
...
Щелкнув плитку Teamwork.com на Панели доступа, вы автоматически войдете в приложение Teamwork.com, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
