...
ms.locfileid: "55196741"
---
# <a name="tutorial-azure-active-directory-integration-with-pega-systems"></a>Руководство. Интеграция Azure Active Directory с Pega Systems
...
1. В поле поиска введите **Pega Systems**, выберите **Pega Systems** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Pega Systems в списке результатов](./media/pegasystems-tutorial/tutorial_pegasystems_addfromgallery.png)
...
1. **[Создание тестового пользователя Pega Systems](#create-a-pega-systems-test-user)** требуется для того, чтобы в приложении Pega Systems существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/pegasystems-tutorial/tutorial_pegasystems_samlbase.png)

1. Если вы хотите настроить приложение в режиме, инициированном **поставщиком удостоверений**, то в разделе **Домены и URL-адреса приложения Pega Systems** сделайте следующее:

    ![Сведения о домене и URL-адресах единого входа для приложения Pega Systems](./media/pegasystems-tutorial/tutorial_pegasystems_url.png)
...
1. Установите флажок **Показать дополнительные параметры URL-адресов**, и выполните следующее действие, если хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**:
    ...
    ![Сведения о домене и URL-адресах единого входа для приложения Pega Systems](./media/pegasystems-tutorial/tutorial_pegasystems_url1.png)
...
1. В разделе **Атрибуты пользователя** диалогового окна **Единый вход** настройте атрибут токена SAML, как показано на рисунке выше, и выполните следующие действия.
    ...
    ![Настройка единого входа](./media/pegasystems-tutorial/tutorial_attribute_04.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/pegasystems-tutorial/tutorial_pegasystems_certificate.png) 
1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/pegasystems-tutorial/tutorial_general_400.png)
...
1. Выберите **Create** -> **SysAdmin** -> **Authentication Service** (Создать > Системный администратор > Служба аутентификации).
...
1. После этого данные поставщика удостоверений будут заполнены, как показано ниже.

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/pegasystems-tutorial/tutorial_pegasystems_admin3.png)
    
1. В разделе **Service Provider (SP) settings** (Параметры поставщика услуг) выполните следующие действия:
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/pegasystems-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/pegasystems-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/pegasystems-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/pegasystems-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **Pega Systems**.
    ...
    ![Ссылка на Pega Systems в списке приложений](./media/pegasystems-tutorial/tutorial_pegasystems_app.png)  
