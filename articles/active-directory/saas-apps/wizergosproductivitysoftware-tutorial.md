...
1. В разделе **Проверка подлинности** выполните следующие действия.
    ...
    4.3. В текстовое поле **Single Sign-Out URL** (URL-адрес единого выхода) вставьте значение **Sign-Out URL** (URL-адрес выхода), скопированное на портале Azure.
