...
> [!NOTE]
> Мы тесно работаем с Рабочей группой Facebook, чтобы убедиться, что приложение Azure AD утверждено и соответствует новым рекомендациям. Крайние сроки на рабочем месте по Facebook находятся в 16 декабря, и мы хотим, чтобы они отвечали. Клиенты в это время не должны работать. По 28 февраля – 2020 клиентам потребуется перейти на новую интеграцию. Мы будем публиковать его, как только будет доступен путь миграции.    
...
* [Настройка единого входа](workplacebyfacebook-tutorial.md)
