...
1. В поле поиска введите **iLMS**.

    ![Создание тестового пользователя Azure AD](./media/ilms-tutorial/tutorial_ilms_search.png)

1. На панели результатов выберите **iLMS** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/ilms-tutorial/tutorial_ilms_addfromgallery.png)
...
1. **[Создание тестового пользователя iLMS](#creating-an-ilms-test-user)** требуется для создания в iLMS пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/ilms-tutorial/tutorial_ilms_samlbase.png)

1. Если вы хотите настроить приложение в режиме, инициированном **поставщиком удостоверений**, то в разделе **Домены и URL-адреса приложения iLMS** выполните следующие действия:

    ![Настройка единого входа](./media/ilms-tutorial/tutorial_ilms_url.png)
...
1. Установите флажок **Показать дополнительные параметры URL-адресов**, если вы хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**.
    ...
    ![Настройка единого входа](./media/ilms-tutorial/tutorial_ilms_url1.png)
...
1. Чтобы выполнить JIT-подготовку, приложение iLMS ожидает утверждения SAML в определенном формате. Настройте следующие утверждения для этого приложения. Управлять значениями этих атрибутов можно в разделе **Атрибуты пользователя** на странице интеграции приложения. На следующем снимке экрана приведен пример.
    
    ![Настройка единого входа](./media/ilms-tutorial/4.png)
...
1. В разделе **Атрибуты пользователя** диалогового окна **Единый вход** настройте атрибут токена SAML, как показано на рисунке выше, и выполните следующие действия:
    ...
    ![Настройка единого входа](./media/ilms-tutorial/tutorial_ilms_04.png)

    ![Настройка единого входа](./media/ilms-tutorial/tutorial_ilms_05.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **XML метаданных** и сохраните XML-файл на компьютере.
    ...
    ![Настройка единого входа](./media/ilms-tutorial/tutorial_ilms_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/ilms-tutorial/tutorial_general_400.png)

1. В другом окне браузера войдите на **портал администрирования iLMS** с правами администратора.

1. На вкладке **Settings** (Параметры) щелкните **SSO:SAML**, чтобы открыть параметры SAML, и выполните следующие действия:
    ...
    4.3. Если вы хотите включить JIT-подготовку, чтобы создать учетные записи iLMS для неопознанных пользователей, выполните следующие действия:
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/ilms-tutorial/create_aaduser_01.png) 

1. Перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**, чтобы отобразить список пользователей.
    
    ![Создание тестового пользователя Azure AD](./media/ilms-tutorial/create_aaduser_02.png) 

1. В верхней части диалогового окна щелкните **Добавить**, чтобы открыть диалоговое окно **Пользователь**.
 
    ![Создание тестового пользователя Azure AD](./media/ilms-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/ilms-tutorial/create_aaduser_04.png) 
...
1. На вкладке **Users** (Пользователи) щелкните **Register User** (Регистрация пользователя), чтобы открыть страницу **регистрации пользователя**. 
   
   ![Добавление сотрудника](./media/ilms-tutorial/3.png)

1. На странице **Register User** (Регистрация пользователя) сделайте следующее:
...
1. В списке приложений выберите **iLMS**.
    ...
    ![Настройка единого входа](./media/ilms-tutorial/tutorial_ilms_app.png) 
