...
* При назначении пользователя в соединитель meta Networks необходимо выбрать в диалоговом окне назначения любую допустимую роль конкретного приложения (если она доступна). Пользователи с ролью **доступа по умолчанию** исключаются из подготовки.
...
8.  В разделе **Настройка scim** выберите имя ключа API, созданное на предыдущих шагах. Щелкните **сохранить**.
