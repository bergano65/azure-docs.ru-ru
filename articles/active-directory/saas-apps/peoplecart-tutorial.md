...
1. В разделе **Домены и URL-адреса приложения Peoplecart** сделайте следующее:
    ...
    > [!NOTE] 
    > Эти значения приведены для примера. Замените эти значения фактическим URL-адресом для входа и идентификатором. Чтобы получить их, обратитесь в [службу поддержки клиентов Peoplecart](https://peoplecart.com/ContactUs.aspx). 
