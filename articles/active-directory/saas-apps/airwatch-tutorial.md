...
5. **[Создание тестового пользователя AirWatch](#create-airwatch-test-user)** требуется, чтобы создать в AirWatch пользователя Britta Simon, связанного с представлением этого пользователя в Azure AD.
