...
2. В верхнем правом углу страницы щелкните значок **Параметры**, затем перейдите к параметру  **Конфигурация**.
...
2. В верхнем правом углу страницы щелкните значок **Параметры**, затем перейдите на экран  **Administration centre** (Центр администрирования).

    ![изображение](./media/appraisd-tutorial/tutorial_appraisd_admin.png)

3. На панели инструментов в верхней части страницы щелкните  **People** (Пользователи), затем выберите  **Добавить нового пользователя**.
