...
* RingCentral поддерживает единый вход, инициируемый **поставщиком служб** .
...
1. **[Настройка единого входа в RingCentral](#configure-ringcentral-sso)** необходима, чтобы настроить параметры единого входа на стороне приложения.
    * **[Создание тестового пользователя RingCentral](#create-ringcentral-test-user)** требуется для того, чтобы в RingCentral существовал пользователь B. Simon, связанный с одноименным пользователем в Azure AD.
...
1. Чтобы автоматизировать настройку в RingCentral, необходимо установить расширение браузера **Безопасный вход в мои приложения** , щелкнув **Установить расширение** .

    ![Расширение "Мои приложения"](common/install-myappssecure-extension.png)

1. Чтобы перейти к приложению RingCentral после добавления расширения в браузер, щелкните **Настройка RingCentral** . После этого укажите учетные данные администратора для входа в RingCentral. Расширение браузера автоматически настроит приложение и автоматизирует шаги 3–7.

    ![Настройка конфигурации](common/setup-sso.png)

1. Если необходимо вручную настроить RingCentral, откройте новое окно веб-браузера, зайдите на сайт компании RingCentral в роли администратора и выполните следующие шаги:

1. Щелкните **Tools** (Средства) вверху.

    ![Снимок экрана: элемент Tools (Средства), выбранный на сайте компании RingCentral.](./media/ringcentral-tutorial/ringcentral1.png)

1. Перейдите к параметру **Single Sign-on** (Единый вход).

    ![Снимок экрана: параметр Single Sign-on (Единый вход), выбранный в меню Tools (Средства).](./media/ringcentral-tutorial/ringcentral2.png)
...
1. На странице **Single Sign-on** (Единый вход) в разделе **SSO Configuration** (Настройка единого входа) в **шаге 1** щелкните **Edit** (Изменить) и выполните следующие шаги:
    ...
    ![Снимок экрана: страница SSO Configuration (Настройка единого входа), где вы можете выбрать параметр Edit (Изменить).](./media/ringcentral-tutorial/ringcentral3.png)

1. На странице **Set up Single Sign-on** (Настройка единого входа) выполните следующие действия:

    ![Снимок экрана: страница SSO Configuration (Настройка единого входа), на которой можно отправить метаданные IDP.](./media/ringcentral-tutorial/ringcentral4.png)

    а. Затем щелкните **Browse** (Обзор), чтобы передать файл метаданных, скачанный с портала Azure.
    ...
    ![Снимок экрана: страница SSO Configuration (Настройка единого входа), где вы можете выбрать элемент Download (Скачать).](./media/ringcentral-tutorial/ringcentral6.png) 

    е) На этой же странице перейдите к разделу **Enable SSO** (Включение единого входа) и выполните следующие действия:

    ![Снимок экрана: раздел Enable SSO (Включение единого входа), в котором можно завершить настройку.](./media/ringcentral-tutorial/ringcentral5.png)
...
Щелкнув элемент "RingCentral" на Панели доступа, вы автоматически войдете в приложение RingCentral, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
...
- [Попробуйте RingCentral с Azure AD](https://aad.portal.azure.com/)