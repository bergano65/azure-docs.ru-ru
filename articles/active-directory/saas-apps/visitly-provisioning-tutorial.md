...
1. Войдите в систему, чтобы [посетить](https://app.visitly.io/login). Выберите **интеграции** > **Синхронизация узла**.
