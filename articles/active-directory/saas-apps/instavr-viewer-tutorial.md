...
4. **[Создание тестового пользователя InstaVR Viewer](#create-instavr-viewer-test-user)** требуется для того, чтобы в InstaVR Viewer существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure Active Directory.
