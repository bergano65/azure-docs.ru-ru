...
Щелкнув плитку "ADP" на панели доступа, вы автоматически войдете в ADP, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
