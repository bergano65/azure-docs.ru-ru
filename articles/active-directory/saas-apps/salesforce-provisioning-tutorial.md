...
* Сопоставление атрибута по умолчанию для подготовки к Salesforce включает выражение Синглеаппролеассигнментс для подготовки ролей пользователей в Salesforce. Убедитесь, что пользователям не назначено несколько ролей в приложении, так как сопоставление атрибутов поддерживает подготовку только одной роли. 
