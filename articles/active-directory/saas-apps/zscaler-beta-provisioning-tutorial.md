---
title: Руководство. Настроить для автоматической подготовки пользователей Azure Active Directory с Zscaler Beta | Документация Майкрософт
...
ms.locfileid: "58109650"
---
# <a name="tutorial-configure-zscaler-beta-for-automatic-user-provisioning"></a>Руководство. Настройка Zscaler Beta для автоматической подготовки пользователей
...
3. Чтобы добавить Zscaler Beta, щелкните **новое приложение** кнопку в верхней части диалогового окна.

    ![Кнопка "Создать приложение"][3]

4. В поле поиска введите **Zscaler Beta**.

    ![Zscaler Beta Подготовка](./media/zscaler-beta-provisioning-tutorial/app-search.png)

5. В области результатов выберите **Zscaler Beta**, а затем нажмите кнопку **добавить** кнопку, чтобы добавить Zscaler Beta в список приложений SaaS.

    ![Zscaler Beta Подготовка](./media/zscaler-beta-provisioning-tutorial/app-search-results.png)

    ![Zscaler Beta Подготовка](./media/zscaler-beta-provisioning-tutorial/app-creation.png)
...
2. В списке приложений SaaS выберите Zscaler Beta.

    ![Zscaler Beta Подготовка](./media/zscaler-beta-provisioning-tutorial/app-instance-search.png)
