...
1. В **диалоге с единым знаком** выберите **режим** в качестве входа на **основе SAML** для включения в систему единого входа.
...
1. В разделе **Домены и URL-адреса приложения Printix** сделайте следующее:
    ...
    В текстовом ящике **Для ввода URL-адреса введите URL-адрес,** используя следующий шаблон:`https://<subdomain>.printix.net`
