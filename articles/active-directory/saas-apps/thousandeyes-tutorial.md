...
* ThousandEyes поддерживает [**автоматическую** подготовку пользователей](./thousandeyes-provisioning-tutorial.md).
...
2. В верхнем меню нажмите пункт **Параметры**.
    ...
    ![Снимок экрана: страница сайта ThousandEyes, на которой выбран элемент Settings (Параметры).](./media/thousandeyes-tutorial/ic790066.png "Настройки")

3. В нижней части страницы нажмите кнопку **Учетная запись**

    ![Снимок экрана: меню Settings (Параметры) с выбранным пунктом Account (Учетная запись).](./media/thousandeyes-tutorial/ic790067.png "Учетная запись")
...
Щелкнув плитку ThousandEyes на Панели доступа, вы автоматически войдете в приложение ThousandEyes, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
