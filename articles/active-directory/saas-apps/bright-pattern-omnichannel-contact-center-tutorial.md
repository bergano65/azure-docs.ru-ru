...
1. Если вы хотите настроить приложение в режиме, инициируемом **поставщиком удостоверений** , в разделе **Базовая конфигурация SAML** введите значения следующих полей.
    ...
    а. В текстовом поле **Идентификатор** введите URL-адрес в формате `<SUBDOMAIN>_sso`.

    b. В текстовом поле **URL-адрес ответа** введите URL-адрес в формате `https://<SUBDOMAIN>.brightpattern.com/agentdesktop/sso/redirect`.
...
При выборе на Панели доступа плитки Bright Pattern Omnichannel Contact Center вы автоматически войдете в Bright Pattern Omnichannel Contact Center, для которого настраивается единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
