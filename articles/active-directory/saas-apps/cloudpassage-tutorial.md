---
title: Руководство. Интеграция Azure Active Directory с CloudPassage | Документация Майкрософт
...
1. В разделе **Параметры единого входа** сделайте следующее: 
    ...
    б) Вставьте **идентификатор Azure AD** в текстовое поле **URL-адрес издателя SAML**.
