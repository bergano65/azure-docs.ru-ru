...
При нажатии на плитку "CloudPassage" на панели доступа вы автоматически войдете в CloudPassage, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
