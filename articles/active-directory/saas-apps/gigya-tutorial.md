...
1. В поле поиска введите **Gigya**.

    ![Создание тестового пользователя Azure AD](./media/gigya-tutorial/tutorial_gigya_search.png)

1. На панели результатов выберите **Gigya** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/gigya-tutorial/tutorial_gigya_addfromgallery.png)
...
1. **[Создание тестового пользователя Gigya](#creating-a-gigya-test-user)** требуется для создания в Gigya пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/gigya-tutorial/tutorial_gigya_samlbase.png)

1. В разделе **Домен и URL-адреса приложения Gigya** выполните следующие действия.

    ![Настройка единого входа](./media/gigya-tutorial/tutorial_gigya_url.png)

    a. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `http://<companyname>.gigya.com`

    b. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://fidm.gigya.com/saml/v2.0/<companyname>`

    > [!NOTE] 
    > Эти значения приведены для примера. Замените эти значения фактическим URL-адресом для входа и идентификатором. Чтобы получить их, обратитесь в [службу поддержки клиентов Gigya](https://www.gigya.com/support-policy/). 
 
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.

    ![Настройка единого входа](./media/gigya-tutorial/tutorial_gigya_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/gigya-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Gigya** щелкните **Настроить Gigya**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Quick Reference** (Краткий справочник).

    ![Настройка единого входа](./media/gigya-tutorial/tutorial_gigya_configure.png) 

1. В другом окне веб-браузера войдите на свой корпоративный веб-сайт Gigya в качестве администратора.

1. Последовательно выберите **Settings \> SAML Login** (Параметры > Вход SAML) и нажмите кнопку **Add** (Добавить).
   
    ![Вход SAML](./media/gigya-tutorial/ic789532.png "Вход SAML")

1. В разделе **Вход SAML** выполните следующие действия.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/gigya-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/gigya-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/gigya-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/gigya-tutorial/create_aaduser_04.png) 
...
1. Последовательно выберите **Admin \> Manage Users** (Администратор > Управление пользователями) и нажмите кнопку **Invite Users** (Пригласить пользователей).
   
    ![Управление пользователями](./media/gigya-tutorial/ic789535.png "Управление пользователями")

1. В диалоговом окне "Пригласить пользователей" выполните следующие действия.
...
1. В списке приложений выберите **Gigya**.

    ![Настройка единого входа](./media/gigya-tutorial/tutorial_gigya_app.png) 
