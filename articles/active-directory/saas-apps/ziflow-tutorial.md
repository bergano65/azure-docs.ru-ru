...
3. Щелкните **Add** (Добавить), а затем — **Add user** (Добавить пользователя).
    ...
    ![Снимок экрана: выделенный пункт Add user (Добавить пользователя).](./media/ziflow-tutorial/tutorial_ziflow_add.png)

4. Во всплывающем меню **Add a user** (Добавление пользователя) сделайте следующее:

    ![Снимок экрана: диалоговое окно Add a User (Добавить пользователя), где можно ввести описанные значения.](./media/ziflow-tutorial/tutorial_ziflow_adduser.png)
...
Щелкнув элемент "Ziflow" на Панели доступа, вы автоматически войдете в приложение Ziflow, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
