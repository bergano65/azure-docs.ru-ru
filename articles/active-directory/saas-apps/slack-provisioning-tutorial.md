...
Примечание. Интеграция подготовки Azure AD основывается на [API scim резервного](https://api.slack.com/scim)времени, который доступен для групп временного резерва в плане "плюс" или выше.
...
13. В нижней части страницы нажмите кнопку **Save**.
