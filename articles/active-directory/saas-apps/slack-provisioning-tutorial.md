---
title: 'Учебник: Подготовка пользователей для Slack - Azure AD'
...
Примечание: Интеграция Azure AD основана на [API Slack SCIM,](https://api.slack.com/scim)который доступен командам Slack в плане Plus или лучше.
...
* Slack позволяет только сопоставлять с атрибутами **userName** и **email**.  
