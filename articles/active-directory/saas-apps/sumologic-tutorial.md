---
title: Руководство. Интеграция Azure Active Directory с SumoLogic | Документация Майкрософт
...
1. В разделе **Домены и URL-адреса приложения SumoLogic** сделайте следующее:
    ...
    > [!NOTE] 
    > Эти значения приведены для примера. Замените эти значения фактическим URL-адресом для входа и идентификатором. Чтобы получить эти значения, обратитесь в [службу поддержки клиентов SumoLogic](https://www.sumologic.com/contact-us/). 
...
1. В диалоговом окне **Настройка SAML 2.0** сделайте следующее:
    ...
    4.3. В текстовое поле **Authn Request URL** (URL-адрес запроса аутентификации) вставьте значение **URL-адрес службы единого входа SAML**, скопированное на портале Azure.
