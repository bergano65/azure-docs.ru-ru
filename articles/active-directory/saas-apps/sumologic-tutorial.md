...
1. В списке **Select a configuration or create a new one** (Выберите настройку или создайте новую) выберите **Azure AD** , а затем щелкните **Configure** (Настройка).
    ...
    ![Снимок экрана: диалоговое окно настройки SAML 2.0, в котором можно выбрать вариант Azure AD.](./media/sumologic-tutorial/ic778558.png "Настройка SAML 2.0")

1. В диалоговом окне **Настройка SAML 2.0** сделайте следующее:

    ![Снимок экрана: диалоговое окно настройки SAML 2.0, где можно ввести описанные значения.](./media/sumologic-tutorial/ic778559.png "Настройка SAML 2.0")
...
1. Выберите **Manage \> Users** (Управление > Пользователи).
    ...
    ![Снимок экрана: в меню управления выбран пункт Users (Пользователи).](./media/sumologic-tutorial/ic778561.png "Пользователи")

1. Нажмите кнопку **Добавить**.

    ![Снимок экрана: кнопка для добавления пользователей, в разделе Users (Пользователи).](./media/sumologic-tutorial/ic778562.png "Пользователи")
...
Щелкнув плитку SumoLogic на Панели доступа, вы автоматически войдете в приложение SumoLogic, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
