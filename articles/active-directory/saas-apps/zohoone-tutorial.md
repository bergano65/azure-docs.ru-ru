---
title: Руководство. Интеграция Azure Active Directory с Zoho One | Документация Майкрософт
...
1. Если вы хотите настроить приложение в режиме, инициированном **поставщиком удостоверений**, в разделе **Домены и URL-адреса приложения Zoho One** сделайте следующее:
    ...
    2. В текстовом поле **URL-адрес ответа** введите URL-адрес в следующем формате: `https://accounts.zoho.com/samlresponse/<saml-identifier>`.
...
1. В открывшемся окне сделайте следующее:
    ...
    2. В текстовое поле **Sign-out URL** (URL-адрес выхода) вставьте **URL-адрес выхода**, скопированный на портале Microsoft Azure.
...
1. На странице **Добавление пользователя** сделайте следующее:
    ...
    2. В **адрес электронной почты** текста введите адрес электронной почты пользователя, например **brittasimon\@contoso.com**.
