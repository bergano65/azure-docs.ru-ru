---
title: Руководство. Интеграция Azure Active Directory с TigerText Secure Messenger | Документация Майкрософт
...
1. В поле поиска введите **TigerText Secure Messenger**, выберите **TigerText Secure Messenger** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Добавление из коллекции](./media/tigertext-tutorial/tutorial_tigertext_addfromgallery.png)
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Параметр "Вход на основе SAML"](./media/tigertext-tutorial/tutorial_tigertext_samlbase.png)

1. В разделе **Домены и URL-адреса приложения TigerText Secure Messenger** сделайте следующее:

    ![Раздел "Домены и URL-адреса приложения TigerText Secure Messenger"](./media/tigertext-tutorial/tutorial_tigertext_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Раздел "Сертификат подписи SAML"](./media/tigertext-tutorial/tutorial_tigertext_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить"](./media/tigertext-tutorial/tutorial_general_400.png)

1. Для настройки единого входа в вашем приложении обратитесь в [службу поддержки TigerText Secure Messenger](mailTo:prosupport@tigertext.com) и предоставьте **скачанный файл метаданных**.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/tigertext-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    !["Пользователи и группы" -> "Все пользователи"](./media/tigertext-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Кнопка "Добавить"](./media/tigertext-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Диалоговое окно пользователя](./media/tigertext-tutorial/create_aaduser_04.png) 
...
1. В списке приложений выберите **TigerText Secure Messenger**.
    ...
    ![TigerText Secure Messenger в списке приложений](./media/tigertext-tutorial/tutorial_tigertext_app.png) 
