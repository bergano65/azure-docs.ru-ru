...
| **Селектуникуевалуе (присоединение (\@"", соединение ("." \[,\]FirstName \[,\]LastName), "contoso.com"), Join (\@"", соединение (".", MID\[(\]FirstName, 1, 1), \[LastName\]), "contoso.com"), Join ("\@", Join (".", MID (\[FirstName\], 1, 2), \[LastName\]), "contoso.com"))**   | userPrincipalName     |     | Записывается только при создании 
