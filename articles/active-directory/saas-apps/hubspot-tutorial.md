...
3. **Создание тестового пользователя HubSpot** требуется для создания соответствующего пользователя Britta Simon в HubSpot, связанного с одноименным пользователем в Azure AD.
