...
1. В поле поиска введите **Intralinks**.

    ![Создание тестового пользователя Azure AD](./media/intralinks-tutorial/tutorial_intralinks_search.png)

1. На панели результатов выберите **Intralinks** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/intralinks-tutorial/tutorial_intralinks_addfromgallery.png)
...
1. **[Создание тестового пользователя Intralinks](#creating-an-intralinks-test-user)** требуется для того, чтобы в Intralinks существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/intralinks-tutorial/tutorial_intralinks_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Intralinks** выполните следующие действия.

    ![Настройка единого входа](./media/intralinks-tutorial/tutorial_intralinks_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/intralinks-tutorial/tutorial_intralinks_certificate.png) 
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/intralinks-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/intralinks-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/intralinks-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/intralinks-tutorial/create_aaduser_04.png) 
...
1. В списке приложений выберите **Intralinks**.

    ![Настройка единого входа](./media/intralinks-tutorial/tutorial_intralinks_app.png) 
...
1. На странице **Intralinks Add app** (Добавление приложения Intralinks) выполните следующие действия.

    ![Добавление приложения Intralinks VIA или Elite](./media/intralinks-tutorial/tutorial_intralinks_addapp.png)

    a. В текстовое поле **Имя** введите соответствующее имя приложения, например **Intralinks Elite**.
...
1. В диалоговом окне **Единый вход** для параметра **Режим** выберите значение **Вход по ссылке**.
...
1. Назначьте приложения пользователям или группам, как показано в разделе **[Назначение тестового пользователя Azure AD](#assigning-the-azure-ad-test-user)**.
