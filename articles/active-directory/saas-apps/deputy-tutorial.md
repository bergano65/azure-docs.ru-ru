---
title: Руководство. Интеграция Azure Active Directory с Deputy | Документация Майкрософт
...
1. В поле поиска введите **Deputy**.

    ![Создание тестового пользователя Azure AD](./media/deputy-tutorial/tutorial_deputy_search.png)

1. На панели результатов выберите **Deputy** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/deputy-tutorial/tutorial_deputy_addfromgallery.png)
...
1. **[Создание тестового пользователя Deputy](#creating-a-deputy-test-user)** требуется для создания в Deputy пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/deputy-tutorial/tutorial_deputy_samlbase.png)

1. Если вы хотите настроить приложение в **режиме, инициированном поставщиком удостоверений**, то в разделе **Домен и URL-адреса приложения Deputy** выполните следующие действия.

    ![Настройка единого входа](./media/deputy-tutorial/tutorial_deputy_url1.png)
...
1. Установите флажок **Показать дополнительные параметры URL-адресов**, если хотите настроить приложение для работы в режиме, инициируемом **поставщиком услуг**.
    ...
    ![Настройка единого входа](./media/deputy-tutorial/tutorial_deputy_url2.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/deputy-tutorial/tutorial_deputy_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/deputy-tutorial/tutorial_general_400.png)
    
1. В разделе **Конфигурация Deputy** щелкните **Настроить Deputy**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/deputy-tutorial/tutorial_deputy_configure.png) 
...
1. На странице **Параметры безопасности** сделайте следующее:
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/deputy-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/deputy-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/deputy-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/deputy-tutorial/create_aaduser_04.png) 
...
1. В верхней части области навигации щелкните **People**(Люди).
   
   ![Люди](./media/deputy-tutorial/tutorial_deputy_001.png "Люди")

1. Нажмите кнопку **Add People** (Добавить людей) и выберите пункт **Add a single person** (Добавить одного человека).
   
   ![Добавить участников](./media/deputy-tutorial/tutorial_deputy_002.png "добавить участников")

1. Выполните следующие действия и нажмите кнопку **Save & Invite** (Сохранить и пригласить).
...
1. Владелец учетной записи AAD получит по электронной почте сообщение со ссылкой для активации учетной записи. Вы можете использовать любые другие средства создания учетной записи пользователя Deputy или API, предоставляемые Deputy для подготовки учетных записей пользователя AAD.
...
1. В списке приложений выберите **Deputy**.

    ![Настройка единого входа](./media/deputy-tutorial/tutorial_deputy_app.png) 
