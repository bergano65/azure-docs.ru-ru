...
Перед настройкой и включением автоматической подготовки пользователей нужно решить, какие пользователи и группы в Azure AD должны иметь доступ к Zscaler ZSCloud. После этого вы сможете назначить этих пользователей и группы в Zscaler ZSCloud, следуя инструкциям из статьи о [назначении пользователей или групп корпоративному приложению](https://docs.microsoft.com/azure/active-directory/active-directory-coreapps-assign-user-azure-portal).
