...
6. Щелкните значок **Изменить** , чтобы изменить параметр **Значение идентификатора имени**.
    ...
    ![Снимок экрана, на котором показана страница "Атрибуты пользователя и утверждения" с выделенным значком "Изменить".](media/sapbusinessbydesign-tutorial/mail-prefix1.png)
...
3. Щелкните **New Identity Provider** (Новый поставщик удостоверений) и выберите XML-файл метаданных, скачанный с портала Azure. Импортируя метаданные, система автоматически отправляет требуемые сертификаты подписи и шифрования.
    ...
    ![Снимок экрана: страница настройки единого входа с выбранной вкладкой поставщика удостоверений и действием добавления поставщика удостоверений.](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_54.png)
...
7. Перейдите на вкладку **My System** (Моя система).
    ...
    ![Снимок экрана, на котором показана страница настройки единого входа с выбранной вкладкой My System (Моя система).](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_52.png)
...
Щелкнув элемент "SAP Business ByDesign" на Панели доступа, вы автоматически войдете в приложение SAP Business ByDesign, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
