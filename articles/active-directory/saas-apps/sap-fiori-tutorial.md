...
> [!NOTE]
> Для проверки подлинности IFRAME, инициированной SAP Fiori, мы рекомендуем использовать параметр **IsPassive** в SAML AuthnRequest для автоматической проверки подлинности. Дополнительные сведения о параметре **IsPassive** см. в статье [Сведения о едином входе Azure AD SAML](../develop/single-sign-on-saml-protocol.md)
...
1. В диалоговом окне **Supported NameID Formats** (Поддерживаемые форматы NameID) выберите **Unspecified** (Не указано). Щелкните **ОК**.
    ...
    **Сценарий 1**. Сопоставление пользователя SAP и пользователя Azure AD
    ...
    1. В SAP в разделе **Details of NameID Format "Unspecified"** (Сведения о формате NameID "На указано") запишите следующие сведения.
        ...
        ![Снимок экрана, на котором показано диалоговое окно Details of NameID Format "Unspecified" (Сведения о формате NameID "Не указано") в SAP.](./media/sapfiori-tutorial/nameiddetails.png)

    1. На портале Azure в разделе **Утверждения и атрибуты пользователя** запишите обязательные утверждения из Azure AD.

        ![Снимок экрана, на котором показано диалоговое окно "Утверждения и атрибуты пользователя".](./media/sapfiori-tutorial/claimsaad1.png)
