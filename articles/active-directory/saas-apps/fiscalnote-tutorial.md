...
1. В разделе **Домены и URL-адреса приложения FiscalNote** сделайте следующее:
    ...
    > [!NOTE]
    > Эти значения приведены для примера. Замените эти значения фактическим URL-адресом для входа и идентификатором. Чтобы получить эти значения, обратитесь к [группе поддержки FiscalNote](mailto:support@fiscalnote.com).
...
1. В разделе **Атрибуты пользователя** диалогового окна **Единый вход** настройте атрибут токена SAML, как показано на рисунке выше, и выполните следующие действия.
    ...
    4.3. Оставьте пространство имен пустым.
