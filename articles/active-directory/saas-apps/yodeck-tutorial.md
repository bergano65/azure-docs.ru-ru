...
5. Чтобы настроить приложение для работы в режиме, инициируемом **поставщиком услуг** , щелкните **Задать дополнительные URL-адреса** и выполните следующие действия.
    ...
    ![Снимок экрана: раздел "Базовая конфигурация SAML" со ссылкой "Отправить файл метаданных".](common/both-preintegrated-signon.png)
...
1. Щелкните форму **Параметры пользователя** в правом верхнем углу страницы и выберите **Параметры учетной записи**.
    ...
    ![Снимок экрана, на котором выбран пункт Account Settings (Параметры учетной записи) для пользователя.](./media/yodeck-tutorial/configure1.png)

1. Выберите **SAML** и выполните следующие действия.

    ![Снимок экрана для вкладки SAML, где выполняются эти действия.](./media/yodeck-tutorial/configure2.png)
...
2. Щелкните **Параметры пользователя** в правом верхнем углу страницы и выберите **Пользователи**.
    ...
    ![Снимок экрана, на котором выбран пункт Users (Пользователи) для пользователя.](./media/yodeck-tutorial/user1.png)

3. Щелкните **+User** (Добавить пользователя), чтобы открыть вкладку **Сведения о пользователе**.

    ![Снимок экрана, на котором показана кнопка в разделе Users (Пользователи).](./media/yodeck-tutorial/user2.png)

4. На диалоговой странице **Сведения о пользователе** выполните указанные ниже действия.

    ![Снимок экрана: вкладка для ввода сведений о пользователе, где выполняются эти действия.](./media/yodeck-tutorial/user3.png)
...
Щелкнув плитку Yodeck на панели доступа, вы автоматически войдете в приложение Yodeck, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
