...
* Google Cloud (G Suite) Connector поддерживает [**автоматическую** подготовку пользователей](./google-apps-provisioning-tutorial.md).
...
Google Cloud (G Suite) Connector также поддерживает автоматическую подготовку пользователей. Чтобы настроить автоматическую подготовку пользователей, сначала необходимо [настроить ее в Google Cloud (G Suite) Connector](./google-apps-provisioning-tutorial.md).
...
- [Руководство по настройке Google Apps для автоматической подготовки пользователей](./google-apps-provisioning-tutorial.md)
