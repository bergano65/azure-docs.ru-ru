...
4. Выполните следующие настройки.
    ...
    б) В поле **Sign-in page URL** (URL-адрес страницы входа) в G Suite вставьте значение поля  **URL-адреса входа** , которое вы скопировали с портала Azure.
    ...
    4.3. В поле **Change password URL** (URL-адрес изменения пароля) в G Suite вставьте значение поля  **Изменить URL-адрес пароля** , которое вы скопировали с портала Azure.
