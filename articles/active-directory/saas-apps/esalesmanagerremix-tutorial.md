...
1. Скопируйте из него значения параметров **Пространство имен** и **Имя**. Создайте значение в * \<пространстве имен шаблона>\</Name>* и сохраните его для дальнейшего использования в этом руководстве.
