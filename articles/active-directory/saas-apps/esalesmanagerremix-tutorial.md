---
title: Руководство. Интеграция Azure Active Directory с E Sales Manager Remix | Документация Майкрософт
...
1. В разделе **SAML authentication setting** (Настройка аутентификации SAML) выполните следующие действия:
    ...
    4.3. В текстовое поле **Issuer (entity ID)** (Издатель или идентификатор сущности) вставьте значение идентификатора, скопированное ранее из раздела **Домены и URL-адреса приложения E Sales Manager Remix** на портале Azure.
