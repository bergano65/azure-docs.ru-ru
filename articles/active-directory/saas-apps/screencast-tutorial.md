...
1. В разделе **Access page** (Страница доступа) нажмите кнопку **Setup** (Настроить).

    ![Снимок экрана: раздел Access page (Страница доступа) с выбранной кнопкой Setup (Настроить).](./media/screencast-tutorial/tutorial_screencast_setup.png)

1. На экране **Страница настройки доступа** выполните следующие действия.

1. В разделе **Access URL** (URL-адрес доступа) в указанном текстовом поле введите имя экземпляра.

    ![Снимок экрана, на котором показан раздел для настройки URL-адреса доступа с выделенным текстовым полем для ввода имени экземпляра.](./media/screencast-tutorial/tutorial_screencast_access.png)
...
Щелкнув плитку Screencast-O-Matic на Панели доступа, вы автоматически войдете в приложение Screencast-O-Matic, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
