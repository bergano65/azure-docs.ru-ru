...
* Вы можете включить автоматический вход пользователей в Netop Portal с помощью учетных записей Azure AD.
...
1. В разделе **Добавление из коллекции** в поле поиска введите **Netop Portal** .
1. Выберите **Netop Portal** в области результатов и добавьте это приложение. Подождите несколько секунд, пока приложение не будет добавлено в ваш клиент.


## <a name="configure-and-test-azure-ad-single-sign-on-for-netop-portal"></a>Настройка и проверка единого входа Azure AD в Netop Portal

Настройте и проверьте единый вход Azure AD в Netop Portal с помощью тестового пользователя **B. Simon** . Для обеспечения работы единого входа необходимо установить связь между пользователем Azure AD и соответствующим пользователем в Netop Portal.

Чтобы настроить и проверить единый вход Azure AD в Netop Portal, выполните действия в следующих стандартных блоках:

1. **[Настройка единого входа Azure AD](#configure-azure-ad-sso)** необходима, чтобы пользователи могли использовать эту функцию.
    1. **[Создание тестового пользователя Azure AD](#create-an-azure-ad-test-user)** требуется для проверки работы единого входа Azure AD с помощью пользователя B.Simon.
    1. **[Назначение тестового пользователя Azure AD](#assign-the-azure-ad-test-user)** необходимо, чтобы позволить пользователю B.Simon использовать единый вход Azure AD.
1. **[Настройка единого входа в Netop Portal](#configure-netop-portal-sso)** требуется, чтобы задать параметры единого входа на стороне приложения.
    1. **[Создание тестового пользователя Netop Portal](#create-netop-portal-test-user)** требуется, чтобы в Netop Portal существовал пользователь B. Simon, связанный с одноименным пользователем в Azure AD.
...
1. На [портале Azure](https://portal.azure.com/) на странице интеграции с приложением **Netop Portal** найдите раздел **Управление** и выберите **Единый вход** .
...
1. Требуемый URL-адрес можно скопировать из раздела **Настройка Netop Portal** .
...
В этом разделе описано, как включить единый вход Azure для пользователя B. Simon, предоставив этому пользователю доступ к приложению Netop Portal.

1. На портале Azure выберите **Корпоративные приложения** , а затем — **Все приложения** .
1. Из списка приложений выберите **Netop Portal** .
...
## <a name="configure-netop-portal-sso"></a>Настройка единого входа для Netop Portal

Чтобы настроить единый вход на стороне **Netop Portal** , вам понадобится скачанный **XML-файл метаданных федерации** и URL-адреса для входа, скопированные на портале Azure. Следуйте инструкциям из шага 3 [этой](https://kb.netop.com/article/netop-remote-control-portal-adfs-and-azure-ad-integration-456.html) документации, чтобы настроить портал NetOp для проверки подлинности в Azure AD.
...
Щелкнув плитку Netop Portal на панели доступа, вы автоматически войдете в приложение Netop Portal, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
...
- [Попробуйте использовать Netop Portal с Azure AD](https://aad.portal.azure.com/)