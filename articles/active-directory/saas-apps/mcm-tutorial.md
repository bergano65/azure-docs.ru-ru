---
title: Руководство. Интеграция Azure Active Directory с MCM | Документация Майкрософт
...
Щелкнув плитку MCM на Панели доступа, вы автоматически войдете в приложение MCM, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
