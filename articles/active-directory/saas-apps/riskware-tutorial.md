...
1. В разделе **Домены и URL-адреса приложения Riskware** выполните следующие действия:
    ...
    2. В текстовом поле **Идентификатор (сущности)** введите такой URL-адрес:
...
1. На странице **Authentication Configuration** (Настройка аутентификации) выполните следующие действия:
    ...
    2. В текстовом поле **Code** (Код) введите код, например AZURE_UAT.
...
1. На вкладке **Details** (Подробные сведения) сделайте следующее:
    ...
    2. В текстовое поле **First Name** (Имя) введите имя, например **Britta**.
...
1. На вкладке **Безопасность** сделайте следующее:
    ...
    2. В разделе **данными для входа** раздела **идентификатор пользователя** текстовом поле введите адрес электронной почты пользователя, например **brittasimon\@contoso.com**.
...
1. На вкладке **Organisation** (Организация) сделайте следующее:
    ...
    2. В разделе **Person's Primary Workplace** (Основное рабочее место) введите описание расположения в текстовое поле **Location** (Расположение).
