...
1. На странице **Authentication Configuration** (Настройка аутентификации) выполните следующие действия:
    ...
    4.3. В текстовое поле **Single Sign On Page** (Страница единого входа) вставьте значение **URL-адреса службы единого входа SAML**, скопированное на портале Azure.
