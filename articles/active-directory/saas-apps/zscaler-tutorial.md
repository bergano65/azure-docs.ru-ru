...
5. В диалоговом окне **Пользователи и группы** из списка пользователей выберите **Britta Simon** , а затем в нижней части экрана нажмите кнопку **Выбрать**.
    ...
    ![Снимок экрана: диалоговое окно "Пользователи и группы", где можно выбрать пользователя.](./media/zscaler-tutorial/tutorial_zscaler_users.png)
...
6. В диалоговом окне **Выбор роли** выберите соответствующие роли пользователей из списка, а затем нажмите кнопку **Выбрать** в нижней части экрана.
    ...
    ![Снимок экрана: диалоговое окно "Выбор роли", где можно выбрать роль пользователя.](./media/zscaler-tutorial/tutorial_zscaler_roles.png)

7. В диалоговом окне **Добавление назначения** нажмите кнопку **Назначить**.

    ![Снимок экрана: диалоговое окно "Добавление назначения", где можно нажать кнопку "Назначить".](./media/zscaler-tutorial/tutorial_zscaler_assign.png)
...
Щелкнув плитку Zscaler на Панели доступа, вы автоматически войдете в приложение Zscaler, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
