---
title: Руководство. Интеграция Azure Active Directory с Recognize | Документация Майкрософт
...
ms.locfileid: "56218182"
---
# <a name="tutorial-azure-active-directory-integration-with-recognize"></a>Руководство. Интеграция Azure Active Directory с Recognize
...
1. В поле поиска введите **Recognize** .

    ![Создание тестового пользователя Azure AD](./media/recognize-tutorial/tutorial_recognize_search.png)

1. На панели результатов выберите **Recognize** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/recognize-tutorial/tutorial_recognize_addfromgallery.png)
...
1. **[Создание тестового пользователя Recognize](#creating-a-recognize-test-user)** требуется для того, чтобы в Recognize существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/recognize-tutorial/tutorial_recognize_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Recognize** выполните следующие действия.

    ![Настройка единого входа](./media/recognize-tutorial/tutorial_recognize_url.png)
...
1. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/recognize-tutorial/tutorial_recognize_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/recognize-tutorial/tutorial_general_400.png)

1. В разделе **Конфигурация Recognize** щелкните **Настроить Recognize**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/recognize-tutorial/tutorial_recognize_configure.png) 

1. В другом окне веб-браузера войдите на корпоративный сайт Recognize с правами администратора.

1. В правом верхнем углу щелкните **Menu** (Меню). Перейдите к пункту **Company Admin** (Администратор компании).
...
1. В разделе **SSO Settings** (Параметры единого входа) выполните следующие действия.
    ...
    4.3. В текстовое поле **Slo target url** (Целевой URL-адрес единого выхода) вставьте значение **URL-адреса выхода**, скопированное на портале Azure. 
...
1. Кроме сведений в разделе **SSO Settings** (Параметры единого входа), сохраните URL-адрес из раздела **Service Provider Metadata url** (URL-адрес метаданных поставщика службы).
   
    ![Настройка единого входа на стороне приложения](./media/recognize-tutorial/tutorial_recognize_003.png)

1. Откройте ссылку с **URL-адресом метаданных** в новом окне браузера, чтобы скачать документ метаданных. Затем скопируйте значение EntityDescriptor (entityID) из файла и вставьте его в текстовое поле  **Идентификатор** в разделе **Домены и URL-адреса приложения Recognize** на портале Azure.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/recognize-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/recognize-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/recognize-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/recognize-tutorial/create_aaduser_04.png) 
...
1. В разделе **User Sync** (Синхронизация пользователей) выполните следующие действия.
...
1. В списке приложений выберите **Recognize**.

    ![Настройка единого входа](./media/recognize-tutorial/tutorial_recognize_app.png) 
...
Щелкнув элемент Recognize на панели доступа, вы автоматически войдете в приложение Recognize. См. дополнительные сведения о [панели доступа](../user-help/active-directory-saas-access-panel-introduction.md)
