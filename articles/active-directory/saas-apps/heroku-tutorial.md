...
1. В поле поиска введите **Heroku**.

    ![Создание тестового пользователя Azure AD](./media/heroku-tutorial/tutorial_heroku_search.png)

1. На панели результатов выберите **Heroku** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/heroku-tutorial/tutorial_heroku_addfromgallery.png)
...
1. **[Создание тестового пользователя Heroku](#creating-a-heroku-test-user)** требуется для создания в Heroku пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/heroku-tutorial/tutorial_heroku_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Heroku** выполните следующие действия:

    ![Настройка единого входа](./media/heroku-tutorial/tutorial_heroku_url.png)

    a. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате:    
    `https://sso.heroku.com/saml/<company-name>/init`

    b. В текстовом поле **Identifier URL** (URL-адрес идентификатора) введите URL-адрес в следующем формате:            
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/heroku-tutorial/tutorial_heroku_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/heroku-tutorial/tutorial_general_400.png)

1. Чтобы включить единый вход в Heroku, выполните следующие действия:
    ...
    Е. Скопируйте **URL-адрес входа Heroku** и **идентификатор сущности Heroku**, а затем вернитесь в раздел **Домены и URL-адреса приложения Heroku** на портале Azure и вставьте эти значения в текстовые поля **URL-адреса входа** и **Идентификатор** соответственно.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/heroku-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/heroku-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/heroku-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/heroku-tutorial/create_aaduser_04.png) 
...
1. В списке приложений выберите **Heroku**.

    ![Настройка единого входа](./media/heroku-tutorial/tutorial_heroku_app.png) 
