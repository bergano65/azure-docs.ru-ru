...
2. На главной панели инструментов щелкните **Settings** (Настройки).
    ...
    ![Снимок экрана: кнопка параметров.](./media/workstars-tutorial/tutorial_workstars_sett.png)
...
3. Откройте элементы **Sign On** (Вход)  > **Settings** (Настройки).
    ...
    ![Снимок экрана: раздел Single Sign On (Единый вход), где можно выбрать элемент Settings (Параметры).](./media/workstars-tutorial/tutorial_workstars_settings.png)
...
Щелкнув плитку Workstars на панели доступа, вы автоматически войдете в приложение Workstars, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
