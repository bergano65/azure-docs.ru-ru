...
Щелкнув элемент "KnowBe4 Security Awareness Training" на панели доступа, вы автоматически войдете в приложение KnowBe4 Security Awareness Training, для которого был настроен единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
