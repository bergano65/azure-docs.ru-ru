...
1. На странице диалогового окна **Единый вход** сделайте следующее:
    ...
    4.3. В текстовое поле **URL-адрес страницы входа** вставьте значение **URL-адреса службы единого входа SAML**, скопированное на портале Azure.
