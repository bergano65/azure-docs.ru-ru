...
ms.locfileid: "57451966"
---
# <a name="tutorial-azure-active-directory-integration-with-syncplicity"></a>Руководство. Интеграция Azure Active Directory с Syncplicity
...
1. В разделе **Домены и URL-адреса приложения Syncplicity** выполните следующие действия:
    ...
    > [!NOTE] 
    > Эти значения приведены для примера. Замените эти значения фактическим URL-адресом для входа и идентификатором. Чтобы получить эти значения, обратитесь в [службу поддержки клиентов Syncplicity](https://www.syncplicity.com/contact-us). 
...
1. Тип **адреса электронной почты** учетной записи AAD, которую вы хотите подготовить, выберите **пользователя** как **роли**, а затем нажмите кнопку **Далее**.
