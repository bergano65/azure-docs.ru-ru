...
В этом разделе описано, как создать пользователя B.Simon в EAB Navigate IMPL. Чтобы добавить пользователей на платформу EAB Navigate IMPL, обратитесь в [службу технической поддержки EAB Navigate IMPL](mailto:EABTechSupport@eab.com). Перед использованием единого входа необходимо создать и активировать пользователей.

## <a name="test-sso"></a>Проверка единого входа

В этом разделе описано, как проверить конфигурацию единого входа Azure AD с помощью панели доступа.

Щелкнув плитку EAB Navigate IMPL на панели доступа, вы автоматически войдете в EAB Navigate IMPL, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
