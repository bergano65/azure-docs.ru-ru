...
## <a name="add-mondaycom-from-the-gallery"></a>Добавление monday.com из коллекции
...
## <a name="configure-and-test-azure-ad-sso-for-mondaycom"></a>Настройка и проверка единого входа Azure AD для monday.com
...
Чтобы настроить и проверить единый вход Azure AD в monday.com, выполните следующие действия:
...
1. На портале Azure на странице интеграции с приложением **monday.com** найдите раздел **Управление** и выберите **Единый вход**.
...
## <a name="configure-mondaycom-sso"></a>Настройка единого входа в monday.com
...
1. В правом верхнем углу страницы выберите **Profile** (Профиль) и щелкните **Admin** (Администратор).
    ...
    ![Снимок экрана демонстрирует выбранный профиль администратора.](./media/mondaycom-tutorial/configuration-1.png)

1. Выберите **Security** (Безопасность) и не забудьте щелкнуть **Open** (открыть) рядом с SAML.

    ![На снимке экрана показана вкладка "Безопасность" и действие открытия рядом с элементом SAML.](./media/mondaycom-tutorial/configuration-2.png)

1. Введите ниже необходимые сведения, предоставленные IDP.

    ![Снимок экрана демонстрирует страницу поставщика SAML, где можно ввести полученные от поставщика удостоверений значения.](./media/mondaycom-tutorial/configuration-3.png)
...
* Выберите **Тестировать приложение** на портале Azure. Вы будете перенаправлены по URL-адресу для входа в monday.com, где можно инициировать поток входа.  

* Перейдите по URL-адресу для входа в monday.com и инициируйте поток входа.

#### <a name="idp-initiated"></a>Вход, инициированный поставщиком удостоверений

* На портале Azure выберите **Тестировать приложение**, и вы автоматически войдете в приложение monday.com, для которого настроили единый вход. 

Вы можете также использовать портал "Мои приложения" корпорации Майкрософт для тестирования приложения в любом режиме. Щелкнув плитку monday.com на портале "Мои приложения", вы будете перенаправлены на страницу входа приложения для инициации потока входа (при настройке в режиме поставщика услуг) или автоматически войдете в приложение monday.com, для которого настроен единый вход (при настройке в режиме поставщика удостоверений). Дополнительные сведения о портале "Мои приложения" см. в [этой статье](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).

## <a name="next-steps"></a>Дальнейшие действия

После настройки monday.com вы можете применить управление сеансами, которое защищает от хищения конфиденциальных данных вашей организации и несанкционированного доступа к ним в реальном времени. Управление сеансом является расширением функции условного доступа. [Узнайте, как применять управление сеансами с помощью Microsoft Cloud App Security](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).
