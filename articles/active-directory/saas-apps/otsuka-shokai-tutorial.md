...
* Otsuka Shokai поддерживает единый вход, инициированный **поставщиком удостоверений**.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-otsuka-shokai"></a>Настройка и проверка единого входа Azure AD для Otsuka Shokai
...
## <a name="configure-otsuka-shokai-sso"></a>Настройка единого входа в Otsuka Shokai
...
- [Попробуйте использовать Otsuka Shokai с Azure AD](https://aad.portal.azure.com/)
