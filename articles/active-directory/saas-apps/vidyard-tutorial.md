...
1. В разделе **SAML Configuration** (Настройка SAML) выполните следующие действия:
    ...
    4.3. Скопируйте значение в поле **Issuer/Metadata URL** (URL-адрес издателя/метаданных) и вставьте его в текстовое поле **Идентификатор** в разделе **Домены и URL-адреса приложения Vidyard** на портале Azure.
