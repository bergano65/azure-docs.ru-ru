...
В рамках этого руководства вы настроите и проверите единый вход Azure AD в тестовой среде. Sansan поддерживает единый вход, инициируемый **поставщиком услуг**.
...
2. **[Настройка Sansan](#configure-sansan)** необходима, чтобы настроить параметры единого входа на стороне приложения.
...
1. На странице **Базовая конфигурация SAML** введите значения для следующих полей.
    ...
    1. В текстовом поле **URL-адрес для входа** введите любой URL-адрес в следующем формате:
    ...
    2. В текстовом поле **Идентификатор (сущности)** можно настроить несколько значений идентификатора и выбирать один из них в соответствии со средой.
...
Щелкнув элемент "Sansan" на Панели доступа, вы автоматически войдете в приложение Sansan, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
