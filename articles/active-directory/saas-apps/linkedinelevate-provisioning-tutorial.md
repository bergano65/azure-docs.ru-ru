---
title: 'Учебник: Подготовка пользователей для LinkedIn Elevate - Azure AD'
...
6. Сохраните маркер доступа к буферу обмена или компьютеру перед выходом со страницы.
...
10. Установите **режим обеспечения** **автоматического.**
