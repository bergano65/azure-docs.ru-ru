...
1. Кроме того, приложение Meraki Dashboard ожидает несколько дополнительных атрибутов в ответе SAML, как показано ниже. Эти атрибуты также заранее заполнены, но вы можете изменить их в соответствии со своими требованиями.
    ...
    > [!NOTE]
    > Чтобы понять, как настроить роли в Azure AD, см. [здесь](../develop/active-directory-enterprise-app-role-management.md).
...
Щелкнув плитку Meraki Dashboard на панели доступа, вы автоматически войдете в приложение Meraki Dashboard, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
