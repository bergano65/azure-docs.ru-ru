...
В этом разделе описано, как создать пользователя Britta Simon в приложении Jostle. Чтобы добавить пользователей на платформу Jostle, обратитесь в [службу поддержки Jostle](mailto:support@jostle.me). Перед использованием единого входа необходимо создать и активировать пользователей.
...
Щелкнув плитку Jostle на Панели доступа, вы автоматически войдете в приложение Jostle, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
