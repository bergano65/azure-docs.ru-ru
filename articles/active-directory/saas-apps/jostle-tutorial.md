...
1. Нажмите **Добавить** в верхней части экрана.

    ![add_01](./media/jostle-tutorial/add_01.png)

1. В поле поиска в разделе **Добавить приложение** введите **Jostle**.

    ![add_02](./media/jostle-tutorial/add_02.png)

1. На панели результатов выберите **Jostle** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/jostle-tutorial/tutorial_jostle_addfromgallery.png)
...
1. **[Создание тестового пользователя Jostle](#creating-a-jostle-test-user)** требуется для создания пользователя Britta Simon в Jostle, связанного с соответствующим представлением в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/jostle-tutorial/tutorial_jostle_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Jostle** выполните следующие действия:
...
1. Щелкните **Сохранить** в верхней части окна.

1. Перейдите к **сертификату подписи SAML** и убедитесь, что для него установлено значение **Активно**. Затем нажмите кнопку **XML метаданных** и загрузите файл метаданных.

    ![url_03](./media/jostle-tutorial/url_03.png)

1. Чтобы настроить единый вход на стороне Jostle, отправьте в [службу поддержки Jostle](mailto:support@jostle.me) скачанный XML-файл метаданных. Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/jostle-tutorial/create_aaduser_01.png)

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Создание тестового пользователя Azure AD](./media/jostle-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.

    ![Создание тестового пользователя Azure AD](./media/jostle-tutorial/create_aaduser_03.png)

1. На странице диалогового окна **Пользователь** выполните следующие действия.

    ![Создание тестового пользователя Azure AD](./media/jostle-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **Jostle**.

    ![Настройка единого входа](./media/jostle-tutorial/tutorial_jostle_app.png)
