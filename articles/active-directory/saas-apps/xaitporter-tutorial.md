...
4. Щелкните **Admin** (Администратор).
    ...
    ![Снимок экрана: на сайте XaitPorter выделен элемент Admin (Администратор).](./media/xaitporter-tutorial/user1.png)

5. Из раскрывающегося списка **System Setup** (Настройка системы) выберите **Manage Single Sign-On** (Управление единым входом).

    ![Снимок экрана: в меню настройки системы выбран пункт для управления единым входом.](./media/xaitporter-tutorial/user2.png)

6. В разделе **MANAGE SINGLE SIGN-ON** (Управление единым входом) выполните следующие действия.

    ![Снимок экрана: раздел управления единым входом, где выполняются описанные здесь действия.](./media/xaitporter-tutorial/user3.png)
...
Щелкнув плитку XaitPorter на панели доступа, вы автоматически войдете в приложение XaitPorter, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
