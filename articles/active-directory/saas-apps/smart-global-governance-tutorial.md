---
title: Руководство по интеграции единого входа Azure Active Directory со Smart Global Governance | Документация Майкрософт
...
* С помощью Azure AD вы можете контролировать доступ к Smart Global Governance.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-smart-global-governance"></a>Настройка и проверка единого входа Azure AD для Smart Global Governance
...
Чтобы настроить и проверить единый вход Azure AD в Smart Global Governance, выполните действия в следующих стандартных блоках.

1. **[Настройка единого входа Azure AD](#configure-azure-ad-sso)** необходима, чтобы пользователи могли использовать эту функцию.
    1. **[Создание тестового пользователя Azure AD](#create-an-azure-ad-test-user)** требуется для проверки работы единого входа Azure AD с помощью пользователя B.Simon.
    1. **[Назначение тестового пользователя Azure AD](#assign-the-azure-ad-test-user)** необходимо, чтобы позволить пользователю B.Simon использовать единый вход Azure AD.
1. **[Настройка единого входа в Smart Global Governance](#configure-smart-global-governance-sso)** необходима, чтобы настроить параметры единого входа на стороне приложения.
    1. **[Создание тестового пользователя Smart Global Governance](#create-smart-global-governance-test-user)** требуется, чтобы в Smart Global Governance существовал пользователь B.Simon, связанный с одноименным пользователем в Azure AD.
...
1. Если вы хотите настроить приложение в режиме, инициируемом **поставщиком удостоверений**, в разделе **Базовая конфигурация SAML** введите значения следующих полей.
    ...
    а. В текстовое поле **Идентификатор** введите один из следующих URL-адресов:
    ...
    b. В текстовое поле **URL-адрес ответа** введите один из следующих URL-адресов:
...
1. Чтобы настроить приложение для работы в режиме, инициируемом **поставщиком услуг**, щелкните **Задать дополнительные URL-адреса** и выполните следующие действия.
    ...
    В текстовое поле **URL-адрес входа** введите один из следующих URL-адресов:
...
Чтобы настроить единый вход на стороне **Smart Global Governance**, отправьте скачанный **сертификат (необработанный)** и URL-адреса с портала Azure [группе поддержки Smart Global Governance](mailto:support.tech@smartglobal.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.

### <a name="create-smart-global-governance-test-user"></a>Создание тестового пользователя Smart Global Governance

Из этого раздела вы узнаете, как создать пользователя B.Simon в Smart Global Governance. Для добавления пользователей на платформу Smart Global Governance, обратитесь к  [группе поддержки Smart Global Governance](mailto:support.tech@smartglobal.com). Перед использованием единого входа необходимо создать и активировать пользователей.

## <a name="test-sso"></a>Проверка единого входа 

В этом разделе описано, как проверить конфигурацию единого входа Azure AD с помощью панели доступа.

Щелкнув плитку Smart Global Governance на Панели доступа, вы автоматически войдете в приложение Smart Global Governance, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
