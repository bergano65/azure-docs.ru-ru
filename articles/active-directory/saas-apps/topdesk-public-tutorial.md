...
1. В поле поиска введите **TOPdesk - Public**, выберите **TOPdesk - Public** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.
    ...
    ![TOPdesk - Public в списке результатов](./media/topdesk-public-tutorial/tutorial_topdesk-public_addfromgallery.png)
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/topdesk-public-tutorial/tutorial_topdesk-public_samlbase.png)

1. В разделе **Домены и URL-адреса приложения TOPdesk - Public** сделайте следующее:

    ![Сведения о домене и URL-адресах единого входа для приложения TOPdesk - Public](./media/topdesk-public-tutorial/tutorial_topdesk-public_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/topdesk-public-tutorial/tutorial_topdesk-public_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/topdesk-public-tutorial/tutorial_general_400.png)
    
1. В разделе **Конфигурация TOPdesk - Public** щелкните **Настройка TOPdesk - Public**, чтобы открыть окно **Настройка входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Конфигурация TOPdesk - Public](./media/topdesk-public-tutorial/tutorial_topdesk-public_configure.png) 

1. Выполните вход на веб-сайт **TOPdesk — Public** компании в качестве администратора.

1. В меню **TOPdesk** выберите пункт **Settings** (Параметры).
   
    ![Параметры](./media/topdesk-public-tutorial/ic790598.png "Параметры")

1. Щелкните **Параметры входа**.
   
    ![Параметры входа](./media/topdesk-public-tutorial/ic790599.png "Параметры входа")

1. Разверните меню **Login Settings** (Параметры входа), а затем выберите **General** (Общие).
   
    ![Общие](./media/topdesk-public-tutorial/ic790600.png "Общие")

1. В разделе **Public** (Общедоступные) для конфигурации **SAML login** (Вход SAML) выполните следующие действия.
    ...
    2. Откройте скачанный файл метаданных и определите местоположение узла **AssertionConsumerService**.
...
1. Чтобы создать файл сертификата, выполните следующие действия:
...
1. На странице диалогового окна **Помощник настройки SAML** сделайте следующее:
...
1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    ...
    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/topdesk-public-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/topdesk-public-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/topdesk-public-tutorial/create_aaduser_04.png)
...
1. В меню в верхней части страницы щелкните **TOPdesk \> New \> Support Files \> Person** ("TOPdesk" > "Создать" > "Файлы поддержки" > "Пользователь").
...
1. В списке приложений выберите **TOPdesk - Public**.

    ![Ссылка на TOPdesk - Public в списке "Приложения"](./media/topdesk-public-tutorial/tutorial_topdesk-public_app.png)  
