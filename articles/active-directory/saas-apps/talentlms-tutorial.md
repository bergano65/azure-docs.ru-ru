...
1. В разделе **Домены и URL-адреса приложения TalentLMS** сделайте следующее.
    ...
    > [!NOTE] 
    > Эти значения приведены для примера. Замените эти значения фактическим URL-адресом для входа и идентификатором. Чтобы получить эти значения, обратитесь к [группе поддержки TalentLMS](https://www.talentlms.com/contact). 
