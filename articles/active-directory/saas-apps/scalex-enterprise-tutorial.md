...
2. **[Настройка единого входа в ScaleX Enterprise](#configure-scalex-enterprise-sso)** необходима, чтобы настроить параметры единого входа на стороне приложения.
...
5. **[Создание тестового пользователя ScaleX Enterprise](#create-scalex-enterprise-test-user)** требуется для того, чтобы в ScaleX Enterprise существовал пользователь B. Simon, связанный с одноименным пользователем в Azure AD.
