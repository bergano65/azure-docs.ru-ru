...
1. В поле поиска введите **Dealpath**, выберите **Dealpath** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Dealpath в списке результатов](./media/dealpath-tutorial/tutorial_dealpath_addfromgallery.png)
...
1. **[Создание тестового пользователя Dealpath](#create-a-dealpath-test-user)** требуется для того, чтобы в Dealpath существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/dealpath-tutorial/tutorial_dealpath_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Dealpath** выполните следующие действия.

    ![Сведения о домене и URL-адресах единого входа приложения Dealpath](./media/dealpath-tutorial/tutorial_dealpath_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Ссылка для скачивания сертификата](./media/dealpath-tutorial/tutorial_dealpath_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Кнопка "Сохранить" в окне настройки единого входа](./media/dealpath-tutorial/tutorial_general_400.png)

1. В разделе **Конфигурация Dealpath** щелкните **Настройка Dealpath**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Конфигурация Dealpath](./media/dealpath-tutorial/tutorial_dealpath_configure.png) 

1. В другом окне веб-браузера войдите в приложение Dealpath с правами администратора.

1. В правом верхнем углу щелкните **Admin Tools** (Средства администрирования) и перейдите на страницу **Integrations** (Интеграции), затем в разделе **SAML 2.0 Authentication** (Аутентификация SAML 2.0) щелкните **Update Settings** (Изменить параметры).

    ![Конфигурация Dealpath](./media/dealpath-tutorial/tutorial_dealpath_admin.png)

1. На странице **Set up SAML 2.0 authentication** (Настройка аутентификации SAML 2.0) выполните указанные ниже действия.
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка "Azure Active Directory"](./media/dealpath-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/dealpath-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/dealpath-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/dealpath-tutorial/create_aaduser_04.png)
...
1. Из списка приложений выберите **Dealpath**.

    ![Ссылка на Dealpath в списке "Приложения"](./media/dealpath-tutorial/tutorial_dealpath_app.png)  
