...
При нажатии на плитку "ArcGIS Online" на панели доступа вы автоматически войдете в ArcGIS Online, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
