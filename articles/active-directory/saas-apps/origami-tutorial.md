---
title: Руководство. Интеграция Azure Active Directory с Origami | Документация Майкрософт
...
1. В поле поиска введите **Origami**.

    ![Создание тестового пользователя Azure AD](./media/origami-tutorial/tutorial_origami_search.png)

1. На панели результатов выберите **Origami** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/origami-tutorial/tutorial_origami_addfromgallery.png)
...
1. **[Создание тестового пользователя Origami](#creating-an-origami-test-user)** требуется для создания в Origami пользователя Britta Simon, связанного с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/origami-tutorial/tutorial_origami_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Origami** сделайте следующее:

    ![Настройка единого входа](./media/origami-tutorial/tutorial_origami_url.png)
...
1. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/origami-tutorial/tutorial_origami_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/origami-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Origami** щелкните **Настроить Origami**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**

    ![Настройка единого входа](./media/origami-tutorial/tutorial_origami_configure.png) 
...
1. На странице диалогового окна "Настройка единого входа" сделайте следующее.
    ...
    4.3. Нажмите кнопку **Browse** (Обзор), чтобы отправить файл метаданных, скачанный с портала Azure.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/origami-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/origami-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/origami-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/origami-tutorial/create_aaduser_04.png) 
...
1. В диалоговом окне **Users and Security** (Пользователи и безопасность) нажмите кнопку **Users** (Пользователи).
...
1. В диалоговом окне добавления нового пользователя выполните следующие действия.
    ...
    4.3. В текстовом поле **First Name** (Имя) введите имя, допустим, **Britta**.
...
1. В списке приложений выберите **Origami**.

    ![Настройка единого входа](./media/origami-tutorial/tutorial_origami_app.png) 
