...
- Если у вас нет пробной среды Azure AD, вы можете получить одномесячную пробную версию здесь: [Пробное предложение](https://azure.microsoft.com/pricing/free-trial/).
...
1. **[Настройка одного знака Azure AD](#configuring-azure-ad-single-sign-on)** для использования этой функцией пользователями.
...
1. **[Тестирование single Sign-On](#testing-single-sign-on)** - для проверки работы конфигурации.
...
1. В разделе **Конфигурация Jobscience** щелкните **Настроить Jobscience**, чтобы открыть окно **Настройка единого входа**. Копируйте **URL-адрес регистрации, идентификатор SAML Entity ID и URL-адрес службы SAML single Sign-On Service** из **раздела «Быстрая ссылка».**
...
1. Чтобы убедиться, что ваш домен был настроен правильно, убедитесь, что он находится в "**Шаг 4 Развернуты для пользователей**" и просмотреть ваши " My Domain**Настройки**".
...
> [!TIP]
> Теперь вы можете прочитать краткую версию этих инструкций на [портале Azure,](https://portal.azure.com)пока вы настраиваете приложение!  После добавления этого приложения из раздела **Active Directory > Корпоративные приложения** просто выберите вкладку **Единый вход** и откройте встроенную документацию через раздел **Настройка** в нижней части страницы. Дополнительные сведения о встроенной документации см. в разделе [Встроенная документация Azure AD]( https://go.microsoft.com/fwlink/?linkid=845985).
> 
...
1. На **портале Azure**на левом навигационном панели нажмите значок **Azure Active Directory.**
...
1. На странице диалогового окна **Пользователь** выполните следующие действия.
    ...
    c. Выберите **Показать пароль** и запишите значение **пароля.**
...
1. На портале Azure откройте представление приложений, а затем перейдите в представление каталога и перейдите в **приложения Enterprise,** а затем нажмите **на все приложения.**
