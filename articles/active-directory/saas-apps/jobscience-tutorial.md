...
1. В поле поиска введите **Jobscience**.
    ...
    ![Снимок экрана показывает окно "Добавить из галереи" с введением jobscience.](./media/jobscience-tutorial/tutorial_jobscience_search.png)
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Снимок экрана, на котором выбран режим "Вход на основе SAML".](./media/jobscience-tutorial/tutorial_jobscience_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Jobscience** выполните следующие действия.

    ![Снимок экрана: "URL-адрес входа".](./media/jobscience-tutorial/tutorial_jobscience_url.png)
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Снимок экрана, на котором показана кнопка сохранения.](./media/jobscience-tutorial/tutorial_general_400.png)
...
1. Чтобы проверить правильность настройки домена, убедитесь, что он находится на этапе **Шаг 4. Развернуть для пользователей**, и просмотрите раздел **Параметры моего домена**.
...
1. На сайте Jobscience для компании нажмите **Управление безопасностью**, а затем нажмите **Параметры единого входа**.
    ...
    ![Снимок экрана: в меню элементов управления безопасностью выбран элемент для настройки параметров единого входа.](./media/jobscience-tutorial/ic784364.png "Средства управления безопасностью")
...
1. На странице **My Domain** (Мой домен) в разделе **Login Page Branding** (Фирменная символика страницы входа) нажмите кнопку **Edit** (Изменить).
    ...
    ![Снимок экрана для раздела фирменной символики страницы входа с кнопкой "Изменить".](./media/jobscience-tutorial/ic767826.png "Фирменная символика страницы входа")
...
1. На странице **Login Page Branding** (Фирменная символика страницы входа) в разделе **Authentication Service** (Служба аутентификации) отображается имя **SAML SSO Settings** (Параметры единого входа SAML). Выберите его, а затем нажмите кнопку **Сохранить**.
    ...
    ![Снимок экрана для раздела фирменной символики страницы входа с PPE и кнопкой "Сохранить".](./media/jobscience-tutorial/ic784366.png "Фирменная символика страницы входа")
...
1. Чтобы поставщик услуг инициировал единый вход по URL-адресу входа, нажмите **Параметры единого входа** в разделе меню **Управление безопасностью**.
    ...
    ![Снимок экрана: Администрирование элементов управления безопасностью с выбранными параметрами единого входа.](./media/jobscience-tutorial/ic784368.png "Средства управления безопасностью")
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Снимок экрана, на котором показан значок Azure AD на портале Azure.](./media/jobscience-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Снимок экрана, на котором в разделе "Управление" выбран пункт "Пользователи и группы", а также выбран пункт "Все пользователи".](./media/jobscience-tutorial/create_aaduser_02.png) 
...
1. На странице диалогового окна **Пользователь** выполните следующие действия.
    ...
    ![Снимок экрана, на котором показано диалоговое окно "Пользователь", где можно ввести значения, описанные в этом шаге.](./media/jobscience-tutorial/create_aaduser_04.png) 
...
1. На портале Azure откройте представление приложений, перейдите к представлению каталога, а затем выберите **Корпоративные приложения** и щелкните **Все приложения**.
    ...
    ![Снимок экрана, на котором показан пункт "Корпоративные приложения", выбранный в меню портала Azure, с выбранным пунктом "Все приложения".][201] 

1. Из списка приложений выберите **Jobscience**.

    ![На снимке экрана показано выбранное значение Jobscience.](./media/jobscience-tutorial/tutorial_jobscience_app.png) 

1. В меню слева выберите **Пользователи и группы**.

    ![Снимок экрана, на котором показано меню портала Azure с выбранным пунктом "Пользователи и группы".][202] 
