...
3. Определите, какие данные должны [сопоставляться между Azure AD и синхронизацией получателей кофенсе](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
9. Изучите пользовательские атрибуты, которые синхронизированы из Azure AD, с помощью синхронизации получателей Кофенсе в разделе " **сопоставление атрибутов** ". Атрибуты, выбранные как свойства **Matching** , используются для сопоставления учетных записей пользователей в Кофенсе получателя синхронизации для операций обновления.  Нажмите кнопку **Сохранить**, чтобы зафиксировать все изменения.
   ...
   |имя. Хонорификсуффикс|Строковый тип|
   |Фоненумберс [Type EQ "Рабочий"]. Value|Строковый тип|
   |Фоненумберс [Type EQ "Home"]. значение|Строковый тип|
   |Фоненумберс [Введите EQ "другое"]. Value|Строковый тип|
   |Фоненумберс [Type EQ "пейджер"]. Value|Строковый тип|
   |Фоненумберс [тип EQ "Мобильный"]. значение|Строковый тип|
   |Фоненумберс [тип EQ "Факс"]. значение|Строковый тип|
   |адреса [Введите EQ "Other"]. форматированный|Строковый тип|
   |адреса [Type EQ "Рабочая"]. форматированный|Строковый тип|
   |адреса [Type EQ "Рабочий"]. streetAddress|Строковый тип|
   |адреса [Введите EQ "Рабочий"]. локальность|Строковый тип|
   |адреса [Type EQ "Рабочий"]. регион|Строковый тип|
   |адреса [Type EQ "Рабочий"]. postalCode|Строковый тип|
   |адреса [Type EQ "Рабочая"]. Country|Строка|
   |title|Строка|
   |emails[type eq "work"].value|Строка|
   |сообщения электронной почты [Type EQ "Home"]. значение|Строковый тип|
