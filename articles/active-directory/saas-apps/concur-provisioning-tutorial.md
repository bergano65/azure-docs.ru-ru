...
* Клиент должен быть единственным, кто нажимает кнопку "*Да*" в диалоговом окне, которое отображается после включения приложения. Нажимая эту кнопку, клиент дает согласие на то, чтобы партнерское приложение осуществляло доступ к его данным, поэтому ни вы, ни партнер не можете нажать эту кнопку.
...
3. В панели **Веб-службы** слева выберите **Включить партнерское приложение**.
   
    ![Включить партнерское приложение](./media/concur-provisioning-tutorial/ic721730.png "Включить партнерское приложение")

4. В списке **включения приложений** выберите **Azure Active Directory** и нажмите **Включить**.
   
    ![Microsoft Azure Active Directory](./media/concur-provisioning-tutorial/ic721731.png "Microsoft Azure Active Directory")

5. Нажмите кнопку **Да**, чтобы закрыть диалоговое окно **подтверждения действия**.
