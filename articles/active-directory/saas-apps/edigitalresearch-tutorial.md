...
В этом разделе описано, как создать пользователя Britta Simon в приложении eDigitalResearch. Чтобы добавить пользователей на платформу eDigitalResearch, обратитесь в [службу поддержки eDigitalResearch](https://www.maruedr.com/contact). Перед использованием единого входа необходимо создать и активировать пользователей.
...
Щелкнув элемент "eDigitalResearch" на Панели доступа, вы автоматически войдете в приложение eDigitalResearch, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
