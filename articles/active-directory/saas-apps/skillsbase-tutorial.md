...
3. На странице **Проверка подлинности** в качестве единого входа выберите **SAML 2** .
    ...
    ![Снимок экрана: страница Authentication (Проверка подлинности), где для единого входа выбран вариант SAML 2.](./media/skillsbase-tutorial/tutorial_skillsbase_single.png)

4. На странице **Проверка подлинности** выполните следующие действия.

    ![Снимок экрана: страница Authentication (Проверка подлинности), где можно ввести указанные значения.](./media/skillsbase-tutorial/tutorial_skillsbase_save.png)

    а. Нажмите кнопку **Update IdP metadata** (Обновить метаданные поставщика удостоверений) рядом с параметром **Состояние** и в указанное поле вставьте содержимое XML-файла метаданных, скачанного с портала Azure.
