...
1. В поле поиска введите **Front**, выберите **Front** на панели результатов и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Front в списке результатов](./media/front-tutorial/tutorial_front_addfromgallery.png)
...
1. **[Создание тестового пользователя Front](#create-a-front-test-user)** требуется для того, чтобы во Front существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Диалоговое окно "Единый вход"](./media/front-tutorial/tutorial_front_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Front** сделайте следующее:

    ![Настройка единого входа](./media/front-tutorial/tutorial_front_url1.png)
    ...
    > [!NOTE] 
    > Эти значения приведены для примера. Вместо этих значений укажите фактические идентификатор и URL-адрес ответа, к которым мы вернемся позже в этом руководстве, или обратитесь в [службу поддержки клиентов Front](mailto:support@frontapp.com), чтобы получить эти значения. 

1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.

    ![Настройка единого входа](./media/front-tutorial/tutorial_front_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/front-tutorial/tutorial_general_400.png)
    
1. В разделе **Конфигурация Front** щелкните **Настроить Front**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/front-tutorial/tutorial_front_configure.png) 

1. Войдите в клиент Front с правами администратора.

1. Последовательно выберите пункты **Settings (Параметры) (значок шестеренки в нижней части левой боковой панели) > Preferences (Предпочтения)**.
   
    ![Настройка единого входа на стороне приложения](./media/front-tutorial/tutorial_front_000.png)

1. Щелкните ссылку **Single Sign On** (Единый вход).
   
    ![Настройка единого входа на стороне приложения](./media/front-tutorial/tutorial_front_001.png)

1. В раскрывающемся списке **Single Sign On** (Единый вход) выберите **SAML**.
   
    ![Настройка единого входа на стороне приложения](./media/front-tutorial/tutorial_front_002.png)

1. В текстовое поле **Entry Point** (Точка входа) введите значение **URL-адрес службы единого входа** из мастера настройки приложения Azure AD.
    
    ![Настройка единого входа на стороне приложения](./media/front-tutorial/tutorial_front_003.png)

1. Откройте скачанный файл **сертификата в кодировке Base64** в Блокноте, скопируйте его содержимое в буфер обмена, а затем вставьте его в текстовое поле **Signing certificate** (Сертификат для подписи).
    
    ![Настройка единого входа на стороне приложения](./media/front-tutorial/tutorial_front_004.png)

1. В разделе **Service provider settings** (Параметры поставщика услуг) сделайте следующее:

    ![Настройка единого входа на стороне приложения](./media/front-tutorial/tutorial_front_005.png)
...
1. На портале Azure в области слева нажмите кнопку **Azure Active Directory**.
    ...
    ![Кнопка Azure Active Directory](./media/front-tutorial/create_aaduser_01.png)

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.

    ![Ссылки "Пользователи и группы" и "Все пользователи"](./media/front-tutorial/create_aaduser_02.png)

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна **Все пользователи** щелкните **Добавить**.

    ![Кнопка "Добавить"](./media/front-tutorial/create_aaduser_03.png)

1. В диалоговом окне **Пользователь** сделайте следующее.

    ![Диалоговое окно "Пользователь"](./media/front-tutorial/create_aaduser_04.png)
...
1. В списке приложений выберите **Front**.

    ![Ссылка на Front в списке "Приложения"](./media/front-tutorial/tutorial_front_app.png)  
