...
1. В поле поиска введите **Marketo**.

    ![Создание тестового пользователя Azure AD](./media/marketo-tutorial/tutorial_marketo_search.png)

1. На панели результатов выберите **Marketo** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/marketo-tutorial/tutorial_marketo_addfromgallery.png)
...
1. **[Создание тестового пользователя Marketo](#creating-a-marketo-test-user)** требуется для создания в Marketo пользователя Britta Simon, связанного с представлением этого пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_samlbase.png)

1. В разделе **Домены и URL-адреса Marketo** выполните следующие действия:

    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_url.png)
...
1. В разделе **Сертификат для подписи токена SAML** щелкните **Certificate (Base64)** (Сертификат (Base64)), а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/marketo-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Marketo** щелкните **Настроить Marketo**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_configure.png) 
...
1. Для настройки единого входа в приложение выполните следующие действия:
    ...
    Е. Вставьте **идентификатор сущности SAML** в текстовое поле **Идентификатор издателя**.
...
1. Чтобы включить единый вход для пользователей, выполните следующие действия.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/marketo-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/marketo-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/marketo-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/marketo-tutorial/create_aaduser_04.png) 
...
1. Нажмите кнопку **Администратор** в области навигации вверху.
   
    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_06.png) 

1. Откройте меню **Безопасность** и выберите **Пользователи и роли**.
   
    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_19.png)  

1. На вкладке "Пользователи" щелкните **Пригласить нового пользователя**.
   
    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_15.png) 

1. Введите следующую информацию в мастере приглашения нового пользователя.
...
1. Нажмите кнопку **Отправить**, чтобы отправить приглашение пользователю.
   
    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_18.png)

1. Пользователь получит уведомление по электронной почте. Ему нужно будет перейти по ссылке, чтобы изменить пароль и активировать учетную запись. 
...
1. В списке приложений выберите **Marketo**.
    ...
    ![Настройка единого входа](./media/marketo-tutorial/tutorial_marketo_app.png) 
