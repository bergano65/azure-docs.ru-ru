...
Чтобы настроить единый вход на стороне **QPrism**, отправьте **группе поддержки QPrism**[URL-адрес метаданных федерации приложения](mailto:qsupport-ce@quatrro.com). Специалисты службы поддержки настроят подключение единого входа SAML на обеих сторонах.
