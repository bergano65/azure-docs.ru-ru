...
В этом разделе описано, как создать пользователя Britta Simon в приложении moconavi. Обратитесь к [группе поддержки moconavi](mailto:support@recomot.co.jp), чтобы добавить пользователей на платформу moconavi. Перед использованием единого входа необходимо создать и активировать пользователей.
