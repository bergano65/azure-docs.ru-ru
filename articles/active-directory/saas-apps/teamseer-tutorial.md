...
1. Перейдите в раздел **Администратор отдела кадров**.
    ...
    ![Администратор отдела кадров](./media/teamseer-tutorial/ic789634.png "Администратор отдела кадров")
...
1. Перейдите в раздел **HR Admin \> Users** (Администратор отдела кадров > Пользователи) и щелкните **Run the New User wizard** (Запустить мастер создания пользователя).
    ...
    ![Администратор отдела кадров](./media/teamseer-tutorial/ic789640.png "Администратор отдела кадров")
...
Щелкнув плитку TeamSeer на Панели доступа, вы автоматически войдете в приложение TeamSeer, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
