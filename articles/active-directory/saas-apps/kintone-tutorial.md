---
title: Руководство. Интеграция Azure Active Directory с Kintone | Документация Майкрософт
...
1. В разделе «Проверка подлинности SAML» выполните следующие действия.
    ...
    b. В текстовое поле **URL-адрес выхода SAML** вставьте значение **URL-адреса выхода**, скопированное на портале Azure.
