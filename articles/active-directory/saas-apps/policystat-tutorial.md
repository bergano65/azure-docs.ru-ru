---
title: Руководство. Интеграция Azure Active Directory с PolicyStat | Документация Майкрософт
...
1. В поле поиска введите **PolicyStat**.

    ![Создание тестового пользователя Azure AD](./media/policystat-tutorial/tutorial_policystat_search.png)

1. На панели результатов выберите **PolicyStat** и нажмите кнопку **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/policystat-tutorial/tutorial_policystat_addfromgallery.png)
...
1. **[Создание тестового пользователя PolicyStat](#creating-a-policystat-test-user)** требуется для того, чтобы в PolicyStat существовал пользователь Britta Simon, связанный с одноименным пользователем в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/policystat-tutorial/tutorial_policystat_samlbase.png)

1. В разделе **Домены и URL-адреса приложения PolicyStat** выполните следующие действия.

    ![Настройка единого входа](./media/policystat-tutorial/tutorial_policystat_url.png)

    a. В текстовом поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://<companyname>.policystat.com`

    b. В текстовом поле **Идентификатор** введите URL-адрес в следующем формате: `https://<companyname>.policystat.com/saml2/metadata/`

    > [!NOTE] 
    > Эти значения приведены для примера. Замените эти значения фактическим URL-адресом для входа и идентификатором. Чтобы получить эти значения, обратитесь к [группе поддержки клиентов PolicyStat](http://www.policystat.com/support/). 
 
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.

    ![Настройка единого входа](./media/policystat-tutorial/tutorial_policystat_certificate.png) 

1. В этом разделе показано, как разрешить пользователям проходить аутентификацию в PolicyStat со своей учетной записью Azure AD, используя федерацию на основе протокола SAML.
    ...
    Приложение PolicyStat ожидает утверждения SAML в определенном формате, который требует добавить настраиваемые сопоставления атрибутов в вашу конфигурацию **атрибутов токена SAML**.  
     ...
     ![Атрибуты](./media/policystat-tutorial/tutorial_policystat_attribute.png "Атрибуты")
...
1. Чтобы добавить обязательные сопоставления атрибутов, выполните следующие действия.
    ...
    ![Настройка единого входа](./media/policystat-tutorial/tutorial_policystat_04.png)
...
1. Нажмите кнопку **Сохранить** .
    ...
    ![Настройка единого входа](./media/policystat-tutorial/tutorial_general_400.png)

1. В другом окне веб-браузера войдите на сайт PolicyStat своей компании в качестве администратора.

1. Щелкните вкладку **Admin** (Администрирование), а затем щелкните **Single Sign-On Configuration** (Конфигурация единого входа) в левой области навигации.
   
    ![Меню администратора](./media/policystat-tutorial/ic808633.png "Меню администратора")

1. В разделе **Setup** (Настройка) установите флажок **Enable Single Sign-on Integration** (Включить интеграцию единого входа).
   
    ![Конфигурация единого входа](./media/policystat-tutorial/ic808634.png "Конфигурация единого входа")

1. Щелкните **Configure Attributes** (Настроить атрибуты), а затем в разделе **Configure Attributes** (Настройка атрибутов) сделайте следующее.
...
1. Щелкните **Your IDP Metadata** (Метаданные вашего поставщика удостоверений), а затем в разделе **Your IDP Metadata** (Метаданные вашего поставщика удостоверений) сделайте следующее.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/policystat-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/policystat-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/policystat-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/policystat-tutorial/create_aaduser_04.png) 
...
1. Из списка приложений выберите **PolicyStat**.

    ![Настройка единого входа](./media/policystat-tutorial/tutorial_policystat_app.png) 
