---
title: Руководство. Интеграция Azure Active Directory с Novatus | Документация Майкрософт
...
1. В поле поиска введите **Novatus**.

    ![Создание тестового пользователя Azure AD](./media/novatus-tutorial/tutorial_novatus_search.png)

1. На панели результатов выберите **Novatus** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/novatus-tutorial/tutorial_novatus_addfromgallery.png)
...
1. **[Создание тестового пользователя Novatus](#creating-a-novatus-test-user)** требуется для того, чтобы в Novatus существовал пользователь Britta Simon, связанный с представлением этого же пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/novatus-tutorial/tutorial_novatus_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Novatus** сделайте следующее:

    ![Настройка единого входа](./media/novatus-tutorial/tutorial_novatus_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.
    ...
    ![Настройка единого входа](./media/novatus-tutorial/tutorial_novatus_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/novatus-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Novatus** щелкните **Настроить Novatus**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/novatus-tutorial/tutorial_novatus_configure.png) 

1. Чтобы настроить единый вход для своего приложения, обратитесь в [службу поддержки Novatus](mailto:jvinci@novatusinc.com). Прикрепите к сообщению **скачанный файл сертификата** и укажите **URL-адреса метаданных** (**URL-адрес выхода, идентификатор сущности SAML и URL-адрес службы единого входа SAML**), чтобы специалисты Novatus смогли настроить единый вход со своей стороны.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/novatus-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/novatus-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/novatus-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/novatus-tutorial/create_aaduser_04.png) 
...
1. Из списка приложений выберите **Novatus**.

    ![Настройка единого входа](./media/novatus-tutorial/tutorial_novatus_app.png) 
