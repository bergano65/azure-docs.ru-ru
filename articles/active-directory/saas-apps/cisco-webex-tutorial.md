...
9. В разделе **Базовая конфигурация SAML** отправьте скачанный **файл метаданных поставщика службы** и настройте приложение, выполнив следующие действия:
    ...
    В текстовом поле **URL-адрес входа** введите URL-адрес в следующем формате: `https://<SUBDOMAIN>.webex.com/`.
...
Щелкнув плитку "Cisco Webex" на панели доступа, вы автоматически войдете в приложение Cisco Webex, для которого настроили единый вход. Дополнительные сведения о панели доступа см. в статье [Общие сведения о панели доступа](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
