...
1. Если вы хотите настроить приложение в **режиме, инициированном поставщиком услуг**, выполните следующие действия.  
    ...
    а. В разделе **Базовая конфигурация SAML** щелкните значок карандаша, чтобы изменить значение.
...
Щелкнув плитку Cisco Webex Meetings на Панели доступа, вы автоматически войдете в приложение Cisco Webex Meetings, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
