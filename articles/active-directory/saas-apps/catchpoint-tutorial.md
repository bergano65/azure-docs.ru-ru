...
Если единый вход настроен, то при выборе плитки Catchpoint на портале "Мои приложения" вы автоматически войдете в приложение Catchpoint. Дополнительные сведения о портале "Мои приложения" см. в статье о [входе на портал "Мои приложения" и запуске приложений на нем](../user-help/my-apps-portal-end-user-access.md).
