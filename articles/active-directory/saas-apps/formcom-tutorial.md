...
В рамках этого раздела вы создадите в Form.com пользователя с именем Britta Simon. Чтобы добавить пользователей на платформу Form.com, обратитесь в [службу поддержки Form.com](https://form.com/about/company/contact-us/). Перед использованием единого входа необходимо создать и активировать пользователей.

### <a name="test-single-sign-on"></a>Проверка единого входа 

В этом разделе описано, как проверить конфигурацию единого входа Azure AD с помощью панели доступа.

Щелкнув плитку Form.com на Панели доступа, вы автоматически войдете в приложение Form.com, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
