...
Дополнительные сведения об интеграции приложения SaaS с Azure AD см. в статье [Что такое доступ к приложениям и единый вход с помощью Azure Active Directory?](../manage-apps/what-is-single-sign-on.md)
...
4. Чтобы настроить приложение **Everbridge** в качестве **портала менеджера Everbridge** в разделе **Базовая конфигурация SAML**, сделайте следующее:
    ...
    а. В поле **Идентификатор** введите URL-адрес в следующем формате: `https://sso.everbridge.net/<API_Name>`
...
Выбрав плитку Everbridge на Панели доступа, вы автоматически войдете в учетную запись Everbridge, для которой настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
