...
ms.locfileid: "67107350"
---
# <a name="tutorial-azure-active-directory-integration-with-adobe-creative-cloud"></a>Руководство по Интеграция Azure Active Directory с Adobe Creative Cloud
...
4. В разделе **Базовая конфигурация SAML** выполните приведенные ниже действия.
    ...
    ![Сведения о домене и URL-адресах единого входа приложения Adobe Creative Cloud](common/sp-identifier.png)

    a. В текстовом поле **URL-адрес входа** введите значение в формате `https://adobe.com`.

    b. В текстовом поле **Идентификатор** введите URL-адрес в формате `https://www.okta.com/saml2/service-provider/<token>`.
...
8. Скопируйте требуемый URL-адрес из раздела **Настройка Adobe Creative Cloud**.
