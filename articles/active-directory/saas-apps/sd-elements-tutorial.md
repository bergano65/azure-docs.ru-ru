...
1. В верхнем меню выберите **System** (Система) и щелкните **Single Sign-on** (Единый вход).
    ...
    ![Снимок экрана, на котором показано раскрывающееся меню System (Система) с выбранными пунктом Single Sign-on (Единый вход).](./media/sd-elements-tutorial/tutorial_sd-elements_09.png)
...
1. На панели инструментов вверху щелкните **User Management** (Управление пользователями), а затем щелкните **Users** (Пользователи).
    ...
    ![Снимок экрана: в раскрывающемся списке User Management (Управление пользователями) выбран элемент Users (Пользователи).](./media/sd-elements-tutorial/tutorial_sd-elements_11.png) 

1. Нажмите кнопку **Add New User** (Добавить нового пользователя).

    ![Снимок экрана: выделенная кнопка Add New User (Добавить нового пользователя)](./media/sd-elements-tutorial/tutorial_sd-elements_12.png)
...
Щелкнув плитку SD Elements на Панели доступа, вы автоматически войдете в приложение SD Elements, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
