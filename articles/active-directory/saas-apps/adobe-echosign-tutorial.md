...
1. В разделе **SAML Settings** (Параметры SAML) выполните следующие действия.
    ...
    ![Снимок экрана, на котором показаны параметры SAML, в том числе "SAML Mandatory" (SAML обязательно)](./media/adobe-echosign-tutorial/ic789521.png "Настройка SAML")
...
Щелкнув плитку Adobe Sign на панели доступа, вы автоматически войдете в приложение Adobe Sign, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
