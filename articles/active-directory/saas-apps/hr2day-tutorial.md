...
1. Настройка и проверка единого входа Azure AD.
...
1. В поле поиска введите **HR2day от Merces**.

    ![Создание тестового пользователя Azure AD](./media/hr2day-tutorial/tutorial_hr2daybymerces_search.png)

1. На панели результатов выберите **HR2day от Merces** и нажмите кнопку **Добавить**, чтобы добавить приложение.

    ![Создание тестового пользователя Azure AD](./media/hr2day-tutorial/tutorial_hr2daybymerces_addfromgallery.png)
...
1. Чтобы включить функцию единого входа, в диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**.
 
    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_hr2daybymerces_samlbase.png)

1. В разделе **Домены и URL-адреса приложения HR2day от Merces** выполните следующие действия:

    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_hr2daybymerces_url.png)

    a. В поле **URL-адрес для входа** введите URL-адрес в следующем формате: `https://<tenantname>.force.com/<instancename>`.

    2. В поле **Идентификатор** введите URL-адрес в следующем формате: `https://hr2day.force.com/<companyname>`.
...
1. В разделе **Сертификат подписи SAML** выберите **Сертификат (Base64)**, а затем сохраните файл сертификата на компьютере.

    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_hr2daybymerces_certificate.png) 

1. В этом разделе описывается, как разрешить пользователям проходить проверку подлинности в HR2day от Merces с помощью их учетной записи в Azure AD. Для этого они используют федерацию, которая основана на протоколе SAML.
    ...
    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_hr2day_00.png)
...
1. В диалоговом окне **Единый вход** в разделе **Атрибуты пользователя** настройте атрибут токена SAML, как показано на следующем рисунке. Затем необходимо сделать следующее.
    ...
    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_attribute_04.png)

    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_attribute_05.png)

    2. В поле **Имя** введите **ATTR_LOGINCLAIM**.
    ...
    Е. В поле **Разделитель** введите **\@**.
    
    ж. Нажмите кнопку **ОК**.

1. Нажмите кнопку **Сохранить**.

    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_general_400.png)

1. В разделе **Настройка HR2day от Merces** выберите **Настроить HR2day от Merces**, чтобы открыть окно **Настройка единого входа**. Скопируйте **URL-адрес выхода**, **идентификатор сущности SAML** и **URL-адрес службы единого входа SAML** из раздела **Краткий справочник**.

    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_hr2daybymerces_configure.png) 

1. Чтобы настроить единый вход для приложения, обратитесь в [службу поддержки клиентов HR2day от Merces](mailTo:servicedesk@merces.nl). Вложите скачанный файл **сертификата (Base64)** в сообщение электронной почты. Также предоставьте **URL-адрес выхода**, **идентификатор сущности SAML** и **URL-адрес службы единого входа SAML**, чтобы настроить их для интеграции единого входа.
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/hr2day-tutorial/create_aaduser_01.png) 

1. Чтобы открыть список пользователей, перейдите в раздел **Пользователи и группы** и выберите **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/hr2day-tutorial/create_aaduser_02.png) 

1. Выберите **Добавить** в верхней части диалогового окна, чтобы открыть диалоговое окно **Пользователь**.
 
    ![Создание тестового пользователя Azure AD](./media/hr2day-tutorial/create_aaduser_03.png) 

1. В диалоговом окне **Пользователь** сделайте следующее:
 
    ![Создание тестового пользователя Azure AD](./media/hr2day-tutorial/create_aaduser_04.png) 

    a. В поле **Имя** введите **BrittaSimon**.

    2. В поле **Имя пользователя** введите **адрес электронной почты** учетной записи BrittaSimon.
...
1. В списке приложений выберите **HR2day от Merces**.

    ![Настройка единого входа](./media/hr2day-tutorial/tutorial_hr2daybymerces_app.png) 
