---
title: Руководство. Интеграция Azure Active Directory с Panopto | Документация Майкрософт
...
1. В поле поиска введите **Panopto**.

    ![Создание тестового пользователя Azure AD](./media/panopto-tutorial/tutorial_panopto_search.png)

1. На панели результатов выберите **Panopto** и щелкните **Добавить**, чтобы добавить это приложение.

    ![Создание тестового пользователя Azure AD](./media/panopto-tutorial/tutorial_panopto_addfromgallery.png)
...
1. **[Создание тестового пользователя Panopto](#creating-a-panopto-test-user)** требуется для создания в Panopto пользователя Britta Simon, связанного с представлением этого пользователя в Azure AD.
...
1. В диалоговом окне **Единый вход** в разделе **Режим** выберите **Вход на основе SAML**, чтобы включить функцию единого входа.
    ...
    ![Настройка единого входа](./media/panopto-tutorial/tutorial_panopto_samlbase.png)

1. В разделе **Домены и URL-адреса приложения Panopto** выполните следующие действия:

    ![Настройка единого входа](./media/panopto-tutorial/tutorial_panopto_url.png)
...
1. В разделе **Сертификат подписи SAML** щелкните **Metadata XML** (Метаданные XML) и сохраните файл метаданных на компьютере.
    ...
    ![Настройка единого входа](./media/panopto-tutorial/tutorial_panopto_certificate.png) 

1. Нажмите кнопку **Сохранить** .

    ![Настройка единого входа](./media/panopto-tutorial/tutorial_general_400.png)

1. В разделе **Настройка Panopto** выберите **Настроить Panopto**, чтобы открыть окно **Настройка единого входа**. Скопируйте **идентификатор сущности SAML и URL-адрес службы единого входа SAML** из раздела **Quick Reference** (Краткий справочник).

    ![Настройка единого входа](./media/panopto-tutorial/tutorial_panopto_configure.png) 

1. В другом окне веб-браузера войдите на сайт Panopto своей компании в качестве администратора.

1. На панели слева щелкните **System** (Система), а затем щелкните **Identity Providers** (Поставщики удостоверений).
   
   ![Система](./media/panopto-tutorial/ic777670.png "Система")
1. Щелкните **Добавить поставщик**.
   
   ![Поставщики удостоверений](./media/panopto-tutorial/ic777671.png "Поставщики удостоверений")
   
1. В разделе сведений поставщика SAML выполните следующие действия:
...
1. На **портале Azure** в области навигации слева щелкните значок **Azure Active Directory**.
    ...
    ![Создание тестового пользователя Azure AD](./media/panopto-tutorial/create_aaduser_01.png) 

1. Чтобы отобразить список пользователей, перейдите в раздел **Пользователи и группы** и щелкните **Все пользователи**.
    
    ![Создание тестового пользователя Azure AD](./media/panopto-tutorial/create_aaduser_02.png) 

1. Чтобы открыть диалоговое окно **Пользователь**, в верхней части диалогового окна щелкните **Добавить**.
 
    ![Создание тестового пользователя Azure AD](./media/panopto-tutorial/create_aaduser_03.png) 

1. На странице диалогового окна **Пользователь** выполните следующие действия.
 
    ![Создание тестового пользователя Azure AD](./media/panopto-tutorial/create_aaduser_04.png) 
...
1. В списке приложений выберите **Panopto**.

    ![Настройка единого входа](./media/panopto-tutorial/tutorial_panopto_app.png) 
