...
4. Прокрутите вниз до раздела **Microsoft Azure AD (Enable single sign on)** (Microsoft Azure AD (Включить единый вход)) и сделайте следующее:
    ...
    б) В текстовое поле **Azure AD Single Sign-On Service URL** (URL-адрес службы единого входа в Azure AD) вставьте значение **URL-адреса входа**, скопированное на портале Azure.
