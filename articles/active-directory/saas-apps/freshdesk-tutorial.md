...
4. В разделе **Базовая конфигурация SAML** выполните приведенные ниже действия.
    ...
    б) В текстовом поле **Идентификатор (сущности)** введите URL-адрес в формате `https://<tenant-name>.freshdesk.com` или любом другом, поддерживаемом Freshdesk.
...
8. Откройте **командную строку** и выполните следующие команды:
    ...
    б) Скопируйте значение **Cert Hash(sha256)** и вставьте его в Блокнот. 
...
2. Щелкните значок **Настройки** и в разделе **Безопасность** выполните следующие действия:
    ...
    4.3. В текстовое поле **Logout URL** (URL-адрес выхода) вставьте значение **URL-адрес выхода**, скопированное на портале Azure.
...
5. В диалоговом окне "Сведения об агенте " выполните следующие действия.
    ...
    б) В текстовое поле **Полное имя** введите имя учетной записи Azure AD, которую желаете подготовить.
