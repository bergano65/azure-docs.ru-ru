...
4. В правом верхнем углу страницы щелкните **профиль** > **Account Settings** > **SSO (Single Sign On)** (Параметры учетной записи > Единый вход).
    ...
    ![Снимок экрана: страница параметров учетной записи, на которой отключен единый вход.](./media/watch-by-colors-tutorial/config01.png)

5. На странице **SSO (Single Sign On)** (Единый вход) сделайте следующее:

    ![Снимок экрана: вкладка настройки SAML, где можно включить SAML.](./media/watch-by-colors-tutorial/config02.png)
...
1. В правом верхнем углу страницы щелкните **профиль** > **Users** > **Add User** (Пользователи > Добавить пользователя).
    ...
    ![Снимок экрана, на котором показана страница Users (Пользователи).](./media/watch-by-colors-tutorial/config03.png)

1. На странице окна **User Details** (Сведения о пользователе) выполните следующие действия.

    ![Снимок экрана для страницы подробных сведений о пользователе, где можно ввести описанные здесь значения.](./media/watch-by-colors-tutorial/config04.png)
...
Щелкнув плитку Watch by Colors на Панели доступа, вы автоматически войдете в приложение Watch by Colors, для которого настроили единый вход. См. дополнительные сведения о [панели доступа](../user-help/my-apps-portal-end-user-access.md)
