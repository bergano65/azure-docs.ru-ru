---
title: Восстановление или навсегдае удаление недавно удаленного пользователя - Azure AD
...
1. Войти на [портал Azure](https://portal.azure.com/) с помощью учетной записи глобального администратора для организации.
...
Когда учетная запись пользователя удалена из организации, учетная запись находится в приостановленном состоянии и вся соответствующая информация организации сохраняется. При восстановлении пользователя информация об этой организации также восстанавливается.

> [!Note]
> После восстановления пользователя лицензии, назначенные пользователю на момент удаления, также восстанавливаются, даже если для этих лицензий нет свободных мест. Если вы потребляете больше лицензий больше, чем приобрели, ваша организация может быть временно не соответствует требованиям для использования лицензии.
...
Вы можете навсегда удалить пользователя из организации, не дожидаясь 30 дней для автоматического удаления. Восстановить окончательно удаленного пользователя не сможете ни вы, ни другой администратор, ни служба поддержки клиентов Майкрософт.
...
Для получения дополнительной информации о других доступных задачах управления пользователями, [документация управления пользователями Azure AD.](../users-groups-roles/index.yml)
