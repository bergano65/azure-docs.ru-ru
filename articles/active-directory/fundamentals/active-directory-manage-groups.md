...
- [Создание группы с помощью Azure Active Directory](active-directory-groups-create-azure-portal.md) или [Создание группы и управление ею с помощью командлетов PowerShell](../enterprise-users/groups-settings-v2-cmdlets.md)
