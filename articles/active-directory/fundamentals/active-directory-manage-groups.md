---
title: Использование групп для управления доступом к приложениям и ресурсам в Azure Active Directory | Документация Майкрософт
...
- **Назначение группы.** Владелец ресурса назначает ресурсу группу Azure AD, которая автоматически предоставляет всем своим членам доступ к этому ресурсу. Членством в группе управляют как владелец группы, так и владелец ресурса, что позволяет каждому из них добавлять и удалять членов группы. Дополнительные сведения о добавлении и удалении членства в группе см. в разделе [Практическое руководство. Добавление или удаление группы из другой группы в Azure Active Directory](active-directory-groups-membership-azure-portal.md). 
