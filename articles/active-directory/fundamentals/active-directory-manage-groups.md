---
title: Управление приложением & доступом к ресурсам с помощью групп - Azure AD
...
> - Другие типы групп, такие как списки рассылки и группы безопасности с поддержкой почты, управляются только в центре админ-адена Exchange или в центре админ-центра Microsoft 365. Для управления этими группами необходимо войти в центр управления управлением такими группами, как центр управления сообщениями.
