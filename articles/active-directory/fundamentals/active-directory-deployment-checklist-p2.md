...
## <a name="phase-1-build-a-foundation-of-security"></a>Фаза 1: Построить основу безопасности
...
| [Создание организации, которая имеет определенный пользовательский список запрещенных паролей](../authentication/howto-password-ban-bad-configure.md) | Запретите пользователям создавать пароли, содержащие слова или фразы, часто используемые в вашей организации или сфере. | |
...
| [Развертывание многофакторной аутентификации Azure AD с использованием политик условного доступа](../authentication/howto-mfa-getstarted.md) | Требовать от пользователей выполнения двухэтапной проверки при доступе к конфиденциальным приложениям с использованием политик и средств условного доступа. | Azure AD Premium P1 |
...
## <a name="phase-2-import-users-enable-synchronization-and-manage-devices"></a>Фаза 2: Импорт пользователей, возможность синхронизации и управление устройствами
