...
- Возможности сопоставления атрибутов на портале Azure
...
Пользователи с ролью [администратора устройств групп](../users-groups-roles/directory-assign-admin-roles.md#teams-devices-administrator) могут управлять [сертифицированными для групп устройствами](https://www.microsoft.com/microsoft-365/microsoft-teams/across-devices/devices) из центра администрирования команд. 
...
Дополнительные сведения см. в разделе [улучшения управления пользователями (Предварительная версия) в Azure Active Directory](../users-groups-roles/users-search-enhanced.md).
...
Дополнительные сведения об этих приложениях см. в статье [Интеграция приложений SaaS с Azure Active Directory](../saas-apps/tutorial-list.md). Дополнительные сведения о том, как добавить приложение в коллекцию приложений Azure AD см. в [этой статье](../azuread-dev/howto-app-gallery-listing.md).
...
Дополнительные сведения см. [в разделе Администрирование единиц управления в Azure Active Directory (Предварительная версия)](../users-groups-roles/directory-administrative-units.md).
