...
Клиенты могут обойти это требование для целей тестирования, используя флаг функции в URL-адресе браузера. [Подробнее.](../app-provisioning/use-scim-to-provision-users-and-groups.md#authorization-for-provisioning-connectors-in-the-application-gallery)
