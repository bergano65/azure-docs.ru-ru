...
### <a name="new-azure-ad-threat-intelligence-detection-is-now-available-in-refreshed-azure-ad-identity-protection"></a>Новое обнаружение аналитики угроз Azure AD теперь доступно в обновленной защита идентификации Azure AD

**Тип:** Новая функция  
**Категория службы:** Azure AD Identity Protection  
**Возможности продукта:** Защита удостоверений

Обнаружение аналитики угроз Azure AD теперь доступно в обновленной защита идентификации Azure AD. Эта новая функциональная возможность позволяет указать активность пользователей, нетипичная для конкретного пользователя или которая согласуется с известными шаблонами атак на основе внутренней и внешней аналитики угроз Майкрософт.
