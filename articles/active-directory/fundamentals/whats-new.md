...
Служба предоставления AD AD Azure предоставляет широкий набор возможностей конфигурации. Клиенты должны быть в состоянии сохранить свою конфигурацию, чтобы они могли обратиться к нему позже или откат к известной хорошей версии. Мы добавили возможность загрузить конфигурацию подготовки в виде файла JSON и загрузить ее, когда это необходимо. Ознакомьтесь с [дополнительными сведениями](https://docs.microsoft.com/azure/active-directory/app-provisioning/export-import-provisioning-configuration).
...
- [Лазурные databricks](https://docs.microsoft.com/azure/active-directory/saas-apps/azure-databricks-scim-connector-provisioning-tutorial)
