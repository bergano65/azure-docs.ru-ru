...
2. Выберите **Azure Active Directory**, затем **Группы** и выберите группу, для которой вы хотите добавить владельца (в этом примере — _Политика управления мобильными устройствами — Запад_).
