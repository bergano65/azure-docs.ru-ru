...
Группы Azure Active Directory (Azure AD) управляются владельцами группы. Владельцы групп могут быть пользователями или директорами служб, и могут управлять группой, включая членство. Только существующие владельцы групп или администраторы группы могут назначать владельцев групп. Владельцы группы не должны быть участниками группы.

Если у группы нет владельца, администраторы группы по-прежнему могут управлять группой. Рекомендуется, чтобы каждая группа иметь по крайней мере одного владельца. После того, как владельцы примкнули к группе, последний владелец группы не может быть удален. Пожалуйста, убедитесь, что выберите другого владельца, прежде чем удалить последнего владельца из группы.

## <a name="add-an-owner-to-a-group"></a>Добавление владельца группы
Ниже приведены инструкции по добавлению пользователя в качестве владельца в группу с помощью портала Azure AD. Чтобы добавить основной сервис в качестве владельца группы, следуйте инструкциям, чтобы сделать это с помощью [PowerShell](https://docs.microsoft.com/powershell/module/Azuread/Add-AzureADGroupOwner?view=azureadps-2.0).
