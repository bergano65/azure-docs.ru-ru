...
**Ответ.** Для получения доступа к порталу Azure каждому пользователю требуются разрешения в рамках подписки Azure. Если вы используете платную версию Office 365 или подписку Azure AD, вам нужно активировать бесплатную [учетную запись Azure](https://azure.microsoft.com/free/
...
**Ответ.** Да, в Azure AD есть [панель доступа к Azure AD](https://myapps.microsoft.com) для самообслуживания пользователей и доступа к приложениям. Если вы являетесь клиентом Office 365, многие из этих возможностей вы найдете на [портале Office 365](https://portal.office.com).
