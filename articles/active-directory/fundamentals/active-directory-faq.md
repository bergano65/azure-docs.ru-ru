...
**Ответ.** Для получения доступа к порталу Azure каждому пользователю требуются разрешения в рамках подписки Azure. Если у вас есть платная подписка Office 365 или Azure AD, перейдите [https://aka.ms/accessAAD](https://aka.ms/accessAAD) на одноразовый этап активации. В противном случае необходимо активировать бесплатную [учетную запись Azure](https://azure.microsoft.com/pricing/free-trial/) или платную подписку.
