...
**Ответ.** Да, в Azure AD есть [панель доступа к Azure AD](https://myapps.microsoft.com) для самообслуживания пользователей и доступа к приложениям. Если вы являетесь клиентом Office 365, многие возможности вы найдете на портале Office 365.
