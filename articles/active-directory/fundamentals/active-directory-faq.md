---
title: 'Azure Active Directory: вопросы и ответы | Документы Майкрософт'
description: Ознакомьтесь с ответами на часто задаваемые вопросы об Azure и Azure Active Directory, управлении паролями и доступе к приложениям.
