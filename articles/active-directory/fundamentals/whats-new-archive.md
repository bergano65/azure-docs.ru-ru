...
[Корестакк](https://cloud.corestack.io/site/login), [Hubspot](https://docs.microsoft.com/azure/active-directory/saas-apps/HubSpot-tutorial), [](https://docs.microsoft.com/azure/active-directory/saas-apps/getthere-tutorial) [гра-PE](https://docs.microsoft.com/azure/active-directory/saas-apps/grape-tutorial), [ехаур](https://getehour.com/try-now), [Consent2Go](https://docs.microsoft.com/azure/active-directory/saas-apps/Consent2Go-tutorial), [аппинукс](https://docs.microsoft.com/azure/active-directory/saas-apps/appinux-tutorial), [дриведоллар](https://azuremarketplace.microsoft.com/marketplace/apps/savitas.drivedollar-azuread?tab=Overview), [усеалл](https://docs.microsoft.com/azure/active-directory/saas-apps/useall-tutorial), [бесконечный Кампус](https://docs.microsoft.com/azure/active-directory/saas-apps/infinitecampus-tutorial), [алайа](https://alayagood.com/en/demo/), [ХЭЙБУДДИ](https://docs.microsoft.com/azure/active-directory/saas-apps/heybuddy-tutorial), [врике SAML](https://docs.microsoft.com/azure/active-directory/saas-apps/wrike-tutorial), отклонение [](https://docs.microsoft.com/azure/active-directory/saas-apps/drift-tutorial), [зенеги для бизнеса Central 365](https://accounting.zenegy.com/), [Everbridge](https://docs.microsoft.com/azure/active-directory/saas-apps/everbridge-tutorial), [, идео,](https://profile.ideo.com/users/sign_up) [иванти Service Manager (ISM)](https://docs.microsoft.com/azure/active-directory/saas-apps/ivanti-service-manager-tutorial), [Peakon](https://docs.microsoft.com/azure/active-directory/saas-apps/peakon-tutorial), [Allbound единый вход](https://docs.microsoft.com/azure/active-directory/saas-apps/allbound-sso-tutorial), [Плекс Apps — классический тест ](https://test.plexonline.com/signon), [Приложения для плексов — классическая](https://www.plexonline.com/signon), [ПЛЕКС Apps — тестирование UX](https://test.cloud.plex.com/sso), [приложения для плексов — UX](https://cloud.plex.com/sso), [приложения для плексов — IAM](https://accounts.plex.com/), [ремесла-чилдкаре, записи, посещаемость & финансовая система отслеживания](https://getcrafts.ca/craftsregistration) 
...
Дополнительные сведения см. в разделе [Что происходит при подготовке](https://docs.microsoft.com/azure/active-directory/manage-apps/how-provisioning-works).
