...
Дополнительные сведения см. в разделе [Изменение динамического членства на статическое (и наоборот)](https://docs.microsoft.com/azure/active-directory/active-directory-groups-dynamic-membership-azure-portal).
