...
**Чтобы включить TLS 1.2, браузером**

- **Microsoft Edge и Internet Explorer (оба являются задается с помощью Internet Explorer)**
...
- **Новый стандарт ролей администраторов Azure AD:**
...
- **Владение (настройке на уровне приложения регистрации и -enterprise приложения похожа на процедуру владельца группы:**
    ...
    - **Владелец приложения Enterprise.** Предоставляет возможность управлять многими аспектами собственных корпоративных приложений, в том числе параметрами единого входа, назначением приложений и согласием (за исключением ресурсов Azure AD).
...
- [Настройка политик управляемого браузера](https://aka.ms/managedbrowser)  
...
- **Регистрация и управление устройствами macOS с помощью Intune.** Подобно другим платформам, таким как iOS и Android, приложение корпоративного портала доступно для единой регистрации устройств macOS. Вы можете использовать новое приложение корпоративного портала для macOS, чтобы зарегистрировать устройство в Intune и Azure AD.
- **Убедитесь, что соблюдение устройствами macOS политик соответствия вашей организации, определенных в Intune.** В Intune на портале Azure вы можете настроить соответствующие политики для устройств macOS. 
- **Ограничьте доступ к приложениям в Azure AD только совместимым устройствам macOS.** При создании политики условного доступа macOS доступен как отдельный вариант платформы устройства. Теперь можно создавать политики условного доступа для macOS для целевого приложения, настроенного в Azure.

Дополнительные сведения можно найти в разделе 

- [Создание политики соответствия устройств для устройств macOS в Intune](https://aka.ms/macoscompliancepolicy)
