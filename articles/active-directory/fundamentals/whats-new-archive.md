...
Дополнительные сведения см. в [справочной документации об API обнаружения рисков](/graph/api/resources/riskdetection?view=graph-rest-beta&preserve-view=true).
...
Дополнительные сведения см. в [справочной документации по API "Пользователи, совершающие рискованные действия"](/graph/api/resources/riskyuser?view=graph-rest-beta&preserve-view=true).
...
Дополнительные сведения о настройке требований к сложности паролей см. в статье [Настройка требований к сложности паролей в Azure Active Directory B2C](../../active-directory-b2c/password-complexity.md).
...
Теперь с помощью пользовательских политик вы можете добавить обычную конечную точку Azure AD в качестве поставщика удостоверений в Azure AD B2C. Так у вас будет единая точка входа для всех пользователей Azure AD, которые входят в ваши приложения. Дополнительные сведения см. в статье [Настройка входа для мультитенантного Azure Active Directory с помощью пользовательских политик в Azure Active Directory B2C](../../active-directory-b2c/identity-provider-azure-ad-multi-tenant.md).
