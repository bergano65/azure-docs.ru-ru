...
| | Почта. чтение |
| API Microsoft Graph | Почта. чтение |
| | Почта. Read. Shared |
| | Mail. ReadWrite |

- Приложения предоставили полное олицетворение пользователя, выполнившего вход. Например:

|Ресурс | Разрешение |
| :- | :- |
| API Microsoft Graph| Directory. Акцессасусер. ALL |
