...
- [Руководство. Планирование реализации гибридного Azure Active Directory Join](../devices/hybrid-azuread-join-plan.md)
...
- Настройте [Условный доступ на основе расположения](https://docs.microsoft.com/azure/active-directory/reports-monitoring/quickstart-configure-named-locations).
