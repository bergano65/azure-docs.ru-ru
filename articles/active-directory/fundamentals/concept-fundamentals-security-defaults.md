...
> [!WARNING]
> Перед включением этого параметра убедитесь, что администраторы не используют старые протоколы проверки подлинности. Дополнительные сведения см. [в разделе как удалить устаревшую проверку подлинности](concept-fundamentals-block-legacy-authentication.md).
