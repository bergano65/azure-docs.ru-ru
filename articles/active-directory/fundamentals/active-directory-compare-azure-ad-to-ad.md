...
| Управление администраторами|Организации будут использовать сочетание доменов, подразделений и групп в AD, чтобы делегировать административные права для управления каталогом и ресурсами, которыми он управляет.| Azure AD предоставляет [встроенные роли](./active-directory-users-assign-role-azure-portal.md) с системой управления доступом на основе РОЛЕЙ Azure AD (Azure AD RBAC) с ограниченной поддержкой [создания пользовательских ролей](../roles/custom-overview.md) для делегирования привилегированного доступа к системе удостоверений, приложениям и ресурсам, которыми он управляет.</br>Управление ролями можно улучшить с помощью [Управление привилегированными пользователями (PIM)](../privileged-identity-management/pim-configure.md) , чтобы обеспечить JIT-доступ к привилегированным ролям на основе времени или рабочих процессов. |
