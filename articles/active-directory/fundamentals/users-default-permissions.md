...
Разрешить пользователям связывать рабочие и учебные учетные записи с LinkedIn | Установка этого параметра значение "Нет" запрещает пользователям подключаться своей рабочей или учебной учетной записью со своей учетной записью LinkedIn.  См. в разделе [совместный доступ к данным подключения и разрешения учетной записи LinkedIn](https://docs.microsoft.com/en-us/azure/active-directory/users-groups-roles/linkedin-user-consent) Дополнительные сведения.
