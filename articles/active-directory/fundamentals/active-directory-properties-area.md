...
В этой статье объясняется, как админ-арендатор может добавлять сведения, связанные с конфиденциальностью, в каталог Active Directory (Azure AD) организации через портал Azure.

Мы настоятельно рекомендуем вам добавить как ваш глобальный контакт конфиденциальности, так и заявление о конфиденциальности вашей организации, чтобы ваши внутренние сотрудники и внешние гости могли ознакомиться с вашей политикой. Так как заявления о конфиденциальности создаются в единственном экземпляре и настраиваются для каждого предприятия отдельно, настоятельно рекомендуем обратиться за помощью к юристу.
...
3.    Добавьте сведения о конфиденциальности для ваших сотрудников.
    ...
    - **URL-адрес заявления о конфиденциальности.** Введите ссылку на документ организации, в которой описывается, как ваша организация обрабатывает конфиденциальность данных как внутренних, так и внешних гостей.

        >[!Important]
        >Если вы не включаете ни свое заявление о конфиденциальности, ни ваш контакт с конфиденциальностью, ваши внешние гости увидят текст в поле **Разрешения на просмотр,** в котором ** <говорится, что _ваше имя организации_> не предоставило ссылки на их условия для рассмотрения.** Например, это сообщение будет отображаться для гостевого пользователя при получении приглашения для получения доступа к организации через службу совместной работы B2B.
