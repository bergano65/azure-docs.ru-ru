...
1. Если вы зарегистрировались с помощью этой подписки Azure Stack, необходимо повторно зарегистрировать. Дополнительные сведения см. в разделе [зарегистрировать Azure Stack с помощью Azure](../../azure-stack/azure-stack-registration.md).
