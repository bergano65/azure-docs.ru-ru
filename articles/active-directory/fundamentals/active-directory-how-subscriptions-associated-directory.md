...
1. Просмотрите следующий список изменений и как вы могут влиять:
    ...
    - Если у вас есть все управляемые удостоверения для ресурсов, таких как виртуальные машины или приложения логики, необходимо будет снова включить или повторно создать их после ассоциации
...
2. Если вы используете назначенное системой удостоверений, управляемых ресурсов, необходимо включить их повторно. Если вы используете назначаемого пользователем управляемого удостоверения, необходимо создать их повторно. После повторного включения или повторном создании удостоверений, управляемых, необходимо повторно установить разрешения, назначенные эти удостоверения. Дополнительные сведения см. в разделе [что такое управляемые удостоверения для ресурсов Azure?](../managed-identities-azure-resources/overview.md).

3. Если вы зарегистрировались с помощью этой подписки Azure Stack, необходимо повторно зарегистрировать. Дополнительные сведения см. в разделе [зарегистрировать Azure Stack с помощью Azure](/azure-stack/operator/azure-stack-registration).
