...
>[!Note]
>Групповое лицензирование — это функция, доступная в рамках любого платного плана лицензирования Azure Active Directory (Azure AD) в режиме общедоступной предварительной версии. См. подробные сведения о [дополнительных условиях использования предварительных выпусков Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).
