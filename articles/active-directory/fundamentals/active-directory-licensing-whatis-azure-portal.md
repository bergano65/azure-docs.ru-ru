...
- Платная или пробная подписка на Azure AD Premium P1 и выше

- Платное или пробное издание Office 365 Enterprise E3 или Office 365 A3 или Office 365 GCC G3 или Office 365 E3 для GCCH или Office 365 E3 для Министерства обороны и выше
...
- Групповое лицензирование в настоящее время доступно только через [портал Azure.](https://portal.azure.com) Если вы в первую очередь используете другие порталы управления для управления пользователями и группами, такие как [центр админ-центра Microsoft 365,](https://admin.microsoft.com)вы можете продолжать это делать. Однако управлять лицензиями на уровне группы нужно с помощью портала Azure.
