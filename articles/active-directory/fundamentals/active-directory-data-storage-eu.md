...
## <a name="microsoft-azure-multi-factor-authentication"></a>Многофакторная идентификация Microsoft Azure

Для облачной многофакторной идентификации Azure проверка подлинности завершается в ближайшем центре обработки данных для пользователя. Центры обработки данных для многофакторной идентификации Azure существуют в Северная Америка, Европе и Азиатско-Тихоокеанский регион.
