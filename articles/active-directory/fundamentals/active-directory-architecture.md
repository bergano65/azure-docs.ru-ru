 ...
 *  Для *операций записи*каталог будет выполнять отработку отказа первичной (главной) реплики в центрах обработки данных по распланированию (новый первичный объект синхронизируется со старыми первичными) или процедурами аварийного перехода. Устойчивость данных достигается за счет репликации любой фиксации по крайней мере в два центра данных.
