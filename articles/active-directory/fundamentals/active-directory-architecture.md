---
title: Что такое архитектура Azure Active Directory? | Документация Майкрософт
...
Благодаря Azure AD вы можете создавать пользователей и группы и управлять ими, разрешая и запрещая доступ к корпоративным ресурсам на основе разрешений. Дополнительные сведения об управлении удостоверениями см. в [этой статье](https://docs.microsoft.com/azure/active-directory/fundamentals-identity).
