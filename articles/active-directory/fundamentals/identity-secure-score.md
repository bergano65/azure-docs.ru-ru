...
Оценка безопасности идентификации доступна во всех выпусках Azure AD. Организации могут получить доступ к удостоверению безопасности идентификации из **портал Azure** > **Azure Active Directory** > безопасность > **удостоверение** **безопасности** .
