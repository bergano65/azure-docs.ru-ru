...
> [!IMPORTANT]
> При лицензировании на основе групп в Azure AD представлена концепция пользователей в состоянии ошибки лицензирования. Если вы заметили ошибки лицензирования, следует немедленно [определить и устранить](../users-groups-roles/licensing-groups-resolve-problems.md) проблемы, связанные с назначением лицензий.
...
- [Подготовка атрибутов каталога для синхронизации с Office 365 с помощью средства Идфикс — Office 365](/office365/enterprise/prepare-directory-attributes-for-synch-with-idfix)
