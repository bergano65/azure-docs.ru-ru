---
title: Общий доступ к данным LinkedIn и согласие-Azure Active Directory | Документация Майкрософт
...
Вы можете разрешить пользователям в вашей организации Active Directory (Azure AD) согласие на подключение рабочей или учебной учетной записи Майкрософт к учетной записи LinkedIn. После того как пользователь подключится к своим учетным записям, информация и основные сведения из LinkedIn будут доступны в некоторых приложениях и службах Майкрософт. Пользователи также могут ожидать, что их возможности сотрудничества в LinkedIn будут улучшены и обогащены благодаря сведениям от Майкрософт.
...
![Включение интеграции с LinkedIn в Организации](./media/linkedin-user-consent/display-example.png)
...
* Данные подписок — включает подписки, предоставляемые вашей организацией в приложения и службы Майкрософт, например Microsoft 365.
