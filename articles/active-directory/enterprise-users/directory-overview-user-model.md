...
С помощью групп в Azure AD можно назначать лицензии большому количеству пользователей или назначать пользователю доступ к развернутому корпоративному приложению. С помощью групп можно назначать роли всем администраторам (кроме глобального администратора) в Azure AD или предоставлять доступ к внешним ресурсам, например к приложениям SaaS или сайтам SharePoint.
...
Новые роли администратора Azure AD добавляются. Чтобы узнать, какие роли сейчас доступны, просмотрите портал Azure или [справочник разрешений для роли администратора](../roles/permissions-reference.md).
