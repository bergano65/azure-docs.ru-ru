...
description: Подробные сведения о функции настраиваемых ролей в Azure Active Directory (Azure AD) с точки зрения управления доступом на основе ролей и областей ресурсов.
