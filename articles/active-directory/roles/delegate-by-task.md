...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Управление доменами | Администратор доменных имен | 
Чтение всех конфигураций | Читатели каталога | Роль пользователя по умолчанию ([см. документацию](../fundamentals/users-default-permissions.md))
...
Отключение MFA | Администратор проверки подлинности (с помощью PowerShell) | Администратор привилегированной проверки подлинности (с помощью PowerShell)
Включение MFA | Администратор проверки подлинности (с помощью PowerShell) | Администратор привилегированной проверки подлинности (с помощью PowerShell) 
