...
Создание, чтение, изменение и удаление маршрутов пользователей для сброса пароля | Администратор потоков пользователей с внешним идентификатором | 
Создание, чтение, изменение и удаление маршрутов пользователей для редактирования профиля | Администратор потоков пользователей с внешним идентификатором | 
Создание, чтение, изменение и удаление маршрутов пользователей для входа | Администратор потоков пользователей с внешним идентификатором | 
Создание, чтение, изменение и удаление маршрутов пользователей для регистрации |Администратор потоков пользователей с внешним идентификатором | 
Создание, чтение, изменение и удаление атрибутов пользователей | Администратор атрибутов потоков пользователей с внешним идентификатором | 
...
Задача | Наименее привилегированная роль | Дополнительные роли
---- | --------------------- | ----------------
Настройка фирменной символики компании | глобальный администратор | 
...
Чтение всех конфигураций | Глобальный читатель | глобальный администратор  |
...
Настройка свойств сброса паролей | администратора пользователей; | глобальный администратор
...
Обновление методов проверки подлинности | Администратор проверки подлинности | Администратор привилегированной проверки подлинности, глобальный администратор
...
* [Как назначить или удалить роли администратора Azure AD](manage-roles-portal.md)
