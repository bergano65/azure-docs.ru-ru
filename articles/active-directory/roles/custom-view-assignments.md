...
В этом разделе описывается Просмотр назначений роли в масштабе всей Организации.  Для просмотра назначений области с одним приложением с помощью API Graph можно использовать операции в [назначении пользовательских ролей с API Graph](../users-groups-roles/roles-assign-graph.md).
