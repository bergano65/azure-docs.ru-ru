...
### <a name="usage-summary-reports-reader"></a>[Средство чтения сводных отчетов об использовании](#usage-summary-reports-reader-permissions)
...
Может создавать и администрировать все аспекты Microsoft Dynamics 365, PowerApps и автоматизации Powering.
...
| microsoft.flow/allEntities/allTasks | Управление всеми аспектами автоматизации Powering. |
...
Может просматривать только агрегаты уровня клиента в аналитике использования M365 и оценке производительности.
...
Автор полезных данных атаки | Автор полезных данных атаки | 9c6df0f2-1e7c-4dc3-b195-66dfbd24aa8f
Администратор имитации атак | Администратор имитации атак | c430b396-e693-46cc-96f3-db01bf8bb62a
