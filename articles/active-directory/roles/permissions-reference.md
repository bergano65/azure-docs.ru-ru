...
### <a name="azure-ad-joined-device-local-administrator"></a>[Локальный администратор присоединенного к Azure AD устройства](#azure-ad-joined-device-local-administrator-permissions)
...
### <a name="intune-administrator"></a>[Администратор Intune](#intune-administrator-permissions)
...
> | Действия | Описание |
> | --- | --- |
> | Microsoft. Directory, организация, Стронгаусентикатион/обновление | Обновите свойства строгой проверки подлинности организации в Azure Active Directory. |
> | Microsoft. Directory/УсеркредентиалполиЦиес/создать | Создание политик учетных данных для пользователей в Azure Active Directory. |
> | Microsoft. Directory/УсеркредентиалполиЦиес/удаление | Удаление политик учетных данных для пользователей в Azure Active Directory. |
> | Microsoft. Directory/УсеркредентиалполиЦиес/Standard/Read | Чтение стандартных свойств политик учетных данных для пользователей в Azure Active Directory. |
> | Microsoft. Directory/УсеркредентиалполиЦиес/Owners/Read | Чтение владельцев политик учетных данных для пользователей в Azure Active Directory. |
> | Microsoft. Directory/УсеркредентиалполиЦиес/policyAppliedTo/Read | Чтение ссылки на навигацию Policy. appliesTo в Azure Active Directory. |
> | Microsoft. Directory/УсеркредентиалполиЦиес/Basic/Update | Обновление основных политик для пользователей в Azure Active Directory. |
> | Microsoft. Directory/УсеркредентиалполиЦиес/Owners/Update | Обновление владельцев политик учетных данных для пользователей в Azure Active Directory. |
> | Microsoft. Directory/УсеркредентиалполиЦиес/Тенантдефаулт/Update | Обновите свойство Policy. isOrganizationDefault в Azure Active Directory. |

### <a name="azure-ad-joined-device-local-administrator-permissions"></a>Разрешения локального администратора устройства, присоединенного к Azure AD
...
### <a name="domain-name-administrator-permissions"></a>Разрешения администратора доменных имен

Может управлять доменными именами в облаке и в локальной среде.
...
### <a name="dynamics-365-administrator-permissions"></a>Разрешения администратора Dynamics 365
...
### <a name="exchange-administrator-permissions"></a>Разрешения администратора Exchange
...
### <a name="global-administrator-permissions"></a>Разрешения глобального администратора
...
### <a name="intune-administrator-permissions"></a>Разрешения администратора Intune
...
### <a name="power-bi-administrator-permissions"></a>Power BI разрешения администратора
...
### <a name="sharepoint-administrator-permissions"></a>Разрешения администратора SharePoint
...
### <a name="skype-for-business-administrator-permissions"></a>Разрешения администратора Skype для бизнеса
...
### <a name="teams-administrator-permissions"></a>Разрешения администратора команды
...
Администратор политики проверки подлинности | Администратор политики проверки подлинности | 0526716b-113d-4c15-b2c8-68e3c22b9f80
...
Администратор доменных имен | Администратор доменных имен | 8329153b-31d0-4727-b945-745eb3bc5f31
...
Администратор Teams | Администратор команды | 69091246-20e8-4a56-aa4d-066075b2a7a8
