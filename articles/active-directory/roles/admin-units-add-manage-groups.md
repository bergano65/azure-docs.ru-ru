...
1. На странице **Azure AD > Группы**
    ...
    ![Назначение группы административной единице по отдельности](./media/admin-units-add-manage-groups/assign-to-group-1.png)
...
1. На странице **Azure AD > Административные единицы > Все группы**
    ...
    ![Выберите административную единицу, затем щелкните "Добавить участника".](./media/admin-units-add-manage-groups/assign-to-admin-unit.png)
...
![Список групп в административной единице](./media/admin-units-add-manage-groups/list-groups-in-admin-units.png)
...
![Список административных единиц для группы](./media/admin-units-add-manage-groups/list-group-au.png)
...
- Удалить из обзора группы
  ...
  1. На панели слева нажмите **Административные единицы**, чтобы получить список всех административных единиц, членом которых является группа. Выберите административную единицу, из которой необходимо удалить группу, а затем нажмите **Удалить из административной единицы**.
    ...
    ![Удаление группы из административной единицы](./media/admin-units-add-manage-groups/group-au-remove.png)
