...
Роли для нескольких служб | глобальный администратор<br>Администратор соответствия требованиям<br>Администратор соответствия данных требованиям<br>Глобальный читатель<br>Администратор безопасности<br>Оператор безопасности<br>Читатель сведений о безопасности<br>Администратор службы поддержки
