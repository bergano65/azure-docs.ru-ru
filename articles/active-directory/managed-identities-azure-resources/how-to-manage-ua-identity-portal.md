---
title: Управление управляемой имитой на портале Azure - Azure AD
...
2. В поле поиска введите *управляемые идентификаторы*и под **службами,** нажмите **Управляемые идентификаторы.**
...
4. Выберите **элемент управления доступом (IAM),** а затем выберите **назначение роли Добавить.**
