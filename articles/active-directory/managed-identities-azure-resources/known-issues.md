...
Примечание. Поддержка управляемых удостоверений для расширения виртуальной машины ресурсов Azure будет отсутствовать в январе 2019. 
