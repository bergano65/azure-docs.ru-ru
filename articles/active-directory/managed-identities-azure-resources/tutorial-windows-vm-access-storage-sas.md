---
title: Управляемый имитатор для`:` доступа к системе хранения Azure с помощью учетных данных SAS - Azure AD
...
3. Нажмите **и добавьте ролевую задания** в верхней части страницы, чтобы добавить новое назначение роли для вашего VM
...
2. Введите **имя пользователя** и **пароль,** для которых вы добавили при создании Windows VM. 
