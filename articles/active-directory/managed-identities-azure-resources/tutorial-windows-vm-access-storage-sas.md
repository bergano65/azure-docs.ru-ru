---
title: Руководство`:` по использованию управляемого удостоверения для доступа к службе хранилища Azure с помощью учетных данных SAS — Azure AD
...
2. Введите **имя пользователя** и **пароль** , которые вы добавили при создании виртуальной машины Windows. 
