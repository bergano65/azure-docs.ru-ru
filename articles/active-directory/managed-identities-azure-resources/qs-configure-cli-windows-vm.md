...
description: Пошаговые инструкции по настройке системных и назначенных пользователем управляемых удостоверений на виртуальной машине Azure с помощью Azure CLI.
