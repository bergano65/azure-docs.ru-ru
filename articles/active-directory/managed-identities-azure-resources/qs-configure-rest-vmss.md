---
title: Настройка управляемых удостоверений в масштабируемом наборе виртуальных машин Azure с помощью службы "остальное — Azure AD"
description: Пошаговые инструкции по настройке системных и назначенных пользователем управляемых удостоверений в масштабируемом наборе виртуальных машин Azure с помощью функции "перелистывание" для выполнения вызовов REST API.
