...
3. Когда все будет готово, в раздел шаблона необходимо добавить следующие разделы, `resource` которые должны выглядеть следующим образом:
...
В следующем примере показано, как удалить назначенное системой управляемое удостоверение из виртуальной машины без назначенных пользователем управляемых удостоверений.
