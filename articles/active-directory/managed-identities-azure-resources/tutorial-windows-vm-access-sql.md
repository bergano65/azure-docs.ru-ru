...
Чтобы [настроить аутентификацию Azure AD для сервера SQL](/azure/sql-database/sql-database-aad-authentication-configure), сделайте следующее:
