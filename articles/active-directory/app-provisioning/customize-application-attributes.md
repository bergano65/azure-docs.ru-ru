...
ms.locfileid: "94441959"
---
# <a name="tutorial---customize-user-provisioning-attribute-mappings-for-saas-applications-in-azure-active-directory"></a>Руководство. Настройка сопоставления атрибутов подготовки пользователей для приложений SaaS в Azure Active Directory
...
- Приложения, поддерживающие [SCIM 2,0](https://tools.ietf.org/html/rfc7643)
...
Настраиваемые атрибуты не могут быть ссылочными атрибутами, многозначными или сложными типизированными атрибутами. Настраиваемые атрибуты расширения с несколькими значениями и сложными типами в настоящее время поддерживаются только для приложений в коллекции.  
