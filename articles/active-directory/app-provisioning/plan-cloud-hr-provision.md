...
| Процесс | Requirements (Требования) |
| - | - |
...
- [Основные сведения о журналах для операций обновления диспетчера](../saas-apps/workday-inbound-tutorial.md#understanding-logs-for-manager-update-operations)
