...
Роль по умолчанию для приложения из коллекции называется ролью "доступ по умолчанию". Исторически пользователи, которым назначена эта роль, не подготавливаются и помечаются как пропущенные в [журналах подготовки](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-provisioning-logs) из-за того, что он не является фактическим. 
