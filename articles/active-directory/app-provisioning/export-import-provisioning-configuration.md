---
title: Экспортируйте конфигурацию подготовки и выполните откат до известного работоспособного состояния для аварийного восстановления. | Документация Майкрософт
...
---
# <a name="export-your-provisioning-configuration-and-roll-back-to-a-known-good-state"></a>Экспорт конфигурации подготовки и откат к известному работоспособному состоянию
...
### <a name="how-can-i-export-my-provisioning-configuration"></a>Как можно экспортировать конфигурацию подготовки?
...
2. В области **Azure Active Directory** выберите **корпоративные приложения** и выберите свое приложение.
3. В области навигации слева выберите **Подготовка**. На странице Настройка подготовки щелкните **сопоставления атрибутов**, затем **Отображение дополнительных параметров**и, наконец, **Проверьте схему**. Откроется редактор схемы. 
5. Щелкните скачать на панели команд в верхней части страницы, чтобы скачать схему.
