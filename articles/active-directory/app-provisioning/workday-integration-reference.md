...
1. Чтобы создать политику проверки подлинности, необходимо получить доступ к задаче **Управление политиками проверки подлинности** . В политике проверки подлинности используйте **проверку подлинности список разрешений** , чтобы указать диапазон IP-адресов Azure AD и группу безопасности, которым будет разрешен доступ из этого диапазона IP-адресов. Сохраните изменения. 
