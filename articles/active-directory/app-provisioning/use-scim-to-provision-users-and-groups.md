...
[!NOTE] Поле маркера в пользовательском интерфейсе настраиваемого приложения конфигурации подготовки Azure AD не рекомендуется оставлять пустым. Создаваемый маркер в основном доступен для целей тестирования.
