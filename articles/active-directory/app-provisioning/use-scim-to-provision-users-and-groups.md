...
* Поддержка фильтра [excludedAttributes=members](https://docs.microsoft.com/azure/active-directory/app-provisioning/use-scim-to-provision-users-and-groups#get-group) при запросе ресурса группы в соответствии с разделом 3.4.2.5 протокола SCIM.
