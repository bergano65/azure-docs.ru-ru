...
В настоящее время служба подготовки Azure AD может использоваться с любым диапазоном IP-адресов Azure. Работа выполняется для консолидации набора диапазонов IP-адресов, с которыми работает служба. Этот документ будет обновлен после консолидации списка диапазонов IP-адресов. 
