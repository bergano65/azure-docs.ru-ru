...
[Приложение](#append) &nbsp; &nbsp; &nbsp; [SelectUniqueValue](#selectuniquevalue) [Count](#count) &nbsp; &nbsp; &nbsp; [BitAnd](#bitand) &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; [Left](#left) [Not](#not) [Guid](#guid) &nbsp; &nbsp; [IsNull](#isnull) &nbsp; [IsPresent](#ispresent) &nbsp; [IIF](#iif) &nbsp; [CStr](#cstr) &nbsp; &nbsp; &nbsp; [Mid](#mid) [Item](#item) &nbsp; [Join](#join) &nbsp; [CBool](#cbool) &nbsp; &nbsp; &nbsp; &nbsp; [DateFromNum](#datefromnum) &nbsp; &nbsp; [Coalesce](#coalesce) &nbsp; &nbsp; &nbsp; [FormatDateTime](#formatdatetime) &nbsp; &nbsp; [InStr](#instr) &nbsp; &nbsp; [IsString](#isstring) &nbsp; [RemoveDuplicates](#removeduplicates) [Replace](#replace) [IsNullOrEmpty](#isnullorempty) &nbsp; [ConvertToBase64](#converttobase64) &nbsp; &nbsp; [ConvertToUTF8Hex](#converttoutf8hex) &nbsp; &nbsp; &nbsp; [NormalizeDiacritics](#normalizediacritics) BitAnd &nbsp; &nbsp; &nbsp; CBool &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Coalesce &nbsp; &nbsp; &nbsp; ConvertToBase64 &nbsp; &nbsp; ConvertToUTF8Hex &nbsp; &nbsp; &nbsp; граф &nbsp; &nbsp; &nbsp; &nbsp; CStr &nbsp; &nbsp; &nbsp; DateFromNum &nbsp; &nbsp; FormatDateTime Guid IIF InStr &nbsp; IsNull &nbsp; IsNullEmpty IsPresent IsString &nbsp; Пункт Присоединиться &nbsp; к &nbsp; левой &nbsp; средней &nbsp; нормализуацииДиакритические не удаляются &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; [Word](#word) [Split](#split)&nbsp; [SingleAppRoleAssignment](#singleapproleassignment) &nbsp; &nbsp; &nbsp; [Switch](#switch) &nbsp; [StripSpaces](#stripspaces) &nbsp; [ToUpper](#toupper) [ToLower](#tolower) SingleAppRoleНазначение &nbsp; &nbsp; Сплит&nbsp;&nbsp; &nbsp; Stripspaces &nbsp; &nbsp; переключиться&nbsp; tolower&nbsp; Toupper&nbsp; Word &nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;
...
| Имя | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **value1** |Обязательно |num |Числовое значение, которое должно быть AND'ed с value2|
| **value2** |Обязательно |num |Числовое значение, которое должно быть AND'ed с value1|
...
| **defaultValue** | Необязательно | Строка | Значение по умолчанию, используемое при всех значениях источника NULL. Может быть пустой строкой ("").
...
| **value2** |Обязательно |Строка |Строка, которая будет найдена |
| **start** |Необязательно |Целое число |Исходное положение для поиска подстроки|
| **сравнитеТип** |Необязательно |Перечисление. |Может быть vbTextCompare или vbBinaryCompare |
...
| Имя | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **expression** |Обязательно |expression |Выражение для оценки |
...
| Имя | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **Атрибут** |Обязательно |attribute |Многоценный атрибут для поиска |
| **Индекс** |Обязательно |Целое число | Индекс к элементу в мультиценированной строке|
...
| Имя | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **String** |Обязательно |attribute | Строка для возврата символов из |
...
| Имя | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **String** |Обязательно |Многоценный атрибут |Строка, чтобы вернуть слово из.|
