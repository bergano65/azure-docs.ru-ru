...
* Функции можно вкладывать одну в другую. Например: <br> *Функтиононе (Функтионтво ( `<<argument1>>` ))*
...
| --- | --- | --- | --- |
| **source** |Обязательное |Строка |Как правило, имя атрибута из исходного объекта. |
| **суффикс** |Обязательное |Строка |Строка, которую необходимо присоединить к концу исходного значения. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **value1** |Обязательное |num |Числовое значение, которое должно быть двух с value2|
| **value2** |Обязательное |num |Числовое значение, которое должно быть двух с значение1|
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **expression** |Обязательное | expression | Любое допустимое выражение |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source1  … sourceN** | Обязательное | Строка |Обязательно, переменное число раз. Как правило, имя атрибута из исходного объекта. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source** |Обязательное |Строка |Строка, которая должна быть преобразована в Base 64|
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source** |Обязательное |Строка |Строка для преобразования в шестнадцатеричное значение UTF8|
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **версию** |Обязательное |Атрибут |Многозначный атрибут, для которого будут учитываться элементы|
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **value** |Обязательное | Числовой, ссылочный или логический | может быть числовым значением, ссылочным атрибутом или логическим значением. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **value** |Обязательное | Дата | Дата объявления для преобразования в тип DateTime |
...
| --- | --- | --- | --- |
| **source** |Обязательное |Строка |Как правило, имя атрибута из исходного объекта. |
| **inputFormat** |Обязательное |Строка |Предполагаемый формат исходного значения. Поддерживаемые форматы см. в разделе [https://msdn.microsoft.com/library/8kb3ddd4%28v=vs.110%29.aspx](https://msdn.microsoft.com/library/8kb3ddd4%28v=vs.110%29.aspx) . |
| **outputFormat** |Обязательное |Строка |Формат вывода даты. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **выполняет** |Обязательное |Переменная или выражение |Любое значение или выражение, результатом которого может быть значение True или False. |
| **valueIfTrue** |Обязательное |Переменная или строка | возвращаемое значение, если условие принимает значение true. |
| **valueIfFalse** |Обязательное |Переменная или строка |возвращаемое значение, если условие принимает значение false.|
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **value1** |Обязательное |Строка |Строка для поиска |
| **value2** |Обязательное |Строка |Строка для поиска |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **expression** |Обязательное |expression |Вычисляемое выражение |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **версию** |Обязательное |attribute |Атрибут с несколькими значениями для поиска |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **separator**язательно, количество |Обязательное |Строка |Строка, используемая для разделения исходных значений, когда они объединяются в одну строку. Если разделитель не требуется, может не иметь значения (""). |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **String** |Обязательное |attribute | Строка, из которой возвращаются символы |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source** |Обязательное |Строка |Как правило, имя атрибута. |
| **start** |Обязательное |целое число |Индекс положения начала подстроки в **исходной** строке. Первый символ в строке будет иметь индекс 1, второй символ — индекс 2 и т. д. |
| **length** |Обязательное |целое число |Длина подстроки. Длина подстроки. Если она превышает размер строки **source**, функция возвращает подстроку от индекса **start** до конца строки **source**. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source** |Обязательное |Строка | Обычно атрибут имени или фамилии. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source** |Обязательное |Логическая строка |Предполагаемые **исходные** значения — "True" или "False". |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **value** |Обязательное | Строка | Строка даты и времени в поддерживаемом формате. Поддерживаемые форматы см. по адресу https://msdn.microsoft.com/library/8kb3ddd4%28v=vs.110%29.aspx. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **версию** |Обязательное |Атрибут с несколькими значениями |Многозначный атрибут, в котором будут удалены дубликаты|
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source** |Обязательное |Строка |Обычно это имя атрибута из **исходного** объекта. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **[appRoleAssignments]** |Обязательное |Строка |Объект **[appRoleAssignments]**. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source** |Обязательное |Строка |**источник** — обновляемое значение. |
| **разделитель** |Обязательное |Строка |Задает символ, который будет использоваться для разделения строки (к примеру, ",") |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **source** |Обязательное |Строка |Значение **source**, которое необходимо обновить |
...
| **key** |Обязательное |Строка |Параметр **key**, с которым сравнивается значение **source** |
| **value** |Обязательное |Строка |Значение, которым заменяется значение **source** , соответствующее ключу. |
...
| name | Обязательно/повторяется | Тип | Примечания |
| --- | --- | --- | --- |
| **String** |Обязательное |Атрибут с несколькими значениями |Строка, из которой возвращается слово.|
| **ворднумбер** |Обязательный | Целое число | Номер, указывающий, какой номер слова должен возвращаться|
| **разделители** |Обязательное |Строка| Строка, представляющая разделители, которые должны использоваться для поиска слов|
