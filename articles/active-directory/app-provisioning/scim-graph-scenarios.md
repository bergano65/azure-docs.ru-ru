---
title: С помощью SCIM, Microsoft Graph и службы подготовки Azure AD, чтобы подготовить пользователей и расширить возможности приложения с помощью необходимых данных | Документация Майкрософт
...
**Целевая аудитория:** Этот документ предназначен для разработчиков, создающих приложения, интегрированные с Azure AD. Чтобы другие пользователи использовали приложения, уже интегрированные с Azure AD, такие как Zoom, ServiceNow и DropBox, вы можете пропустить это и ознакомиться с [руководствами](https://docs.microsoft.com/azure/active-directory/saas-apps/tutorial-list) для приложений, а также узнать, [как работает служба подготовки](https://docs.microsoft.com/azure/active-directory/app-provisioning/how-provisioning-works).
