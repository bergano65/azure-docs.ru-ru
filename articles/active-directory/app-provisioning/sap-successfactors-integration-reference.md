...
| 9  | Менеджер пользователя                         | Емплойментнав/Усернав/Manager/Емпинфо | Всегда  |
| 10 | фокомпани                              | Емплойментнав/Жобинфонав/Компанинав | Только при `company` `companyId` сопоставлении атрибута или |
| 11 | фодепартмент                           | Емплойментнав/Жобинфонав/Департментнав | Только при `department` `departmentId` сопоставлении атрибута или |
| 12 | фобусинессунит                         | Емплойментнав/Жобинфонав/Бусинессунитнав | Только при `businessUnit` `businessUnitId` сопоставлении атрибута или |
| 13 | фокостцентер                           | Емплойментнав/Жобинфонав/Костцентернав | Только при `costCenter` `costCenterId` сопоставлении атрибута или |
| 14 | фодивисион                             | Емплойментнав/Жобинфонав/Дивисионнав  | Только при `division` `divisionId` сопоставлении атрибута или |
| 15 | фожобкоде                              | Емплойментнав/Жобинфонав/Жобкоденав  | Только при `jobCode` `jobCodeId` сопоставлении атрибута или |
| 16 | фопайграде                             | Емплойментнав/Жобинфонав/Пайграденав  | Только при `payGrade` сопоставлении атрибута |
| 17 | фолокатион                             | Емплойментнав/Жобинфонав/Локатионнав  | Только при `location` сопоставлении атрибута |
| 18 | фокорпоратеаддрессдефлт                | Емплойментнав/Жобинфонав/Аддресснавдефлт  | Если параметр Mapping содержит один из следующих атрибутов: `officeLocationAddress,  officeLocationCity, officeLocationZipCode` |
| 19 | фоевентреасон                          | Емплойментнав/Жобинфонав/Евентреасоннав  | Только при `eventReason` сопоставлении атрибута |
| 20 | емпглобалассигнмент                    | Емплойментнав/Емпглобалассигнментнав | Только при `assignmentType` сопоставлении |
| 21 | Поле выбора Емплойменттипе                | Емплойментнав/Жобинфонав/Емплойменттипенав | Только при `employmentType` сопоставлении |
| 22 | Поле выбора Емплойикласс                 | Емплойментнав/Жобинфонав/Емплойикласснав | Только при `employeeClass` сопоставлении |
| 23 | Поле выбора Емплстатус                    | Емплойментнав/Жобинфонав/Емплстатуснав | Только при `emplStatus` сопоставлении |
| 24 | Поле выбора Ассигнменттипе                | Емплойментнав/Емпглобалассигнментнав/Ассигнменттипенав | Только при `assignmentType` сопоставлении |
