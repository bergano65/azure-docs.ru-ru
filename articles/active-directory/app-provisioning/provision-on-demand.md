...
:::image type="content" source="media/provision-on-demand/on-demand-provision-user.jpg" alt-text="По запросу предоставьте пользователя.":::
...
:::image type="content" source="media/provision-on-demand/success-on-demand-provision.jpg" alt-text="Успешная инициализация пользователя.":::
...
* Подготовка по требованию поддерживает отключение пользователей, которые не были назначены в приложении, но не поддерживают отключение или удаление пользователей, которые были отключены или удалены из Azure Active Directory (эти пользователи не будут отображаться при поиске пользователя).
