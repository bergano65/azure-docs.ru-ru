...
| **Проблема соответствия SCIM 2.0** |  **Фиксированной?** | **Дата исправления**  |  
|---|---|---|
...
Изменения применяются ко всем новым [приложениям SCIM не из коллекции](../manage-apps/configure-single-sign-on-non-gallery-applications.md), настроенным на портале Azure, после даты выхода исправления.
...
5. В песочнице Graph выполните следующую команду, чтобы найти идентификатор задания подготовки. Замените [object-id] на идентификатор субъекта-службы (идентификатор объекта), скопированный на третьем шаге.
   ...
   ![Получить вакансии](media/application-provisioning-config-problem-scim-compatibility/get-jobs.PNG "Получить вакансии") 
