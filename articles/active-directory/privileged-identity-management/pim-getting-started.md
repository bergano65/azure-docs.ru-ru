...
1. В списке щелкните **Согласие для PIM**.
    ...
    ![Согласие на использование PIM для включения PIM](./media/pim-getting-started/consent-pim.png)
...
1. В появившемся сообщении щелкните **Да**, чтобы дать согласие на использование службы PIM.
    ...
    ![Согласие на сообщение PIM для завершения процесса разрешения](./media/pim-getting-started/consent-pim-message.png)
...
![Окно навигации в PIM с отображением задач и параметров управления](./media/pim-getting-started/pim-quickstart-tasks.png)
...
1. Установите флажок **Закрепить колонку на панели мониторинга**, чтобы закрепить колонку "Быстрое начало" PIM на панели мониторинга.
    ...
    ![Значок канцелярской кнопки для закрепления колонки PIM на панели мониторинга](./media/pim-getting-started/pim-quickstart-pin-to-dashboard.png)

    На панели мониторинга Azure вы увидите такие плитки:

    ![Плитка краткого руководства PIM на панели мониторинга](./media/pim-getting-started/pim-quickstart-dashboard-tile.png)
