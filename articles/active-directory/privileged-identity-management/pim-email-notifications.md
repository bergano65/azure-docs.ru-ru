...
Эти адреса электронной почты включают префикс **PIM** в строке темы. Пример:
...
| User (Пользователь) | Активация роли ожидает утверждения | Выполнен запрос на активацию роли | Включен PIM |
| --- | --- | --- | --- |
