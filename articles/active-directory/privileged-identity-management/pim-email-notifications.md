...
Когда пользователи активируют свою роль, а параметр роли требует утверждения, утверждающие будут получать по два сообщения электронной почты для каждого утверждения:
...
Кроме того, глобальные администраторы и администраторы привилегированных ролей получают электронное сообщение для каждого утверждения:
