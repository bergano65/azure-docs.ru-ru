...
- если привилегированная роль назначена в качестве разрешенной;
...
| Пользователь | Активация роли ожидает утверждения | Выполнен запрос на активацию роли | Роль назначена как допустимая | Включен PIM |
| --- | --- | --- | --- | --- |
| Администратор привилегированных ролей</br>(активирован или разрешен) | Yes</br>(только если не указаны явные утверждающие) | Да* | Yes | Yes |
| Администратор безопасности</br>(активирован или разрешен) | Нет  | Да* | Yes | Yes |
| глобального администратора;</br>(активирован или разрешен) | Нет  | Да* | Yes | Yes |
