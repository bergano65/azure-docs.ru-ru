...
ms.locfileid: "44303070"
---
# <a name="email-notifications-in-pim"></a>Уведомления по электронной почте в PIM

При возникновении ключевых событий в Azure AD Privileged Identity Management (PIM) отправляются уведомления по электронной почте. Например, PIM отправляет сообщения о следующих событиях:
...
Уведомления по электронной почте отправляются следующим администраторам:

- администратор привилегированных ролей;
- администратор безопасности.

Также эти уведомления отправляются пользователю, которому назначена привилегированная роль для следующих событий:

- если запрос на активацию привилегированной роли выполнен;
- если привилегированная роль назначена;

Начиная с конца июля 2018 г. используются обновленные адрес отправителя и внешний вид уведомлений, отправляемых по электронной почте через PIM. Это обновление повлияет на ресурсы PIM для Azure AD и PIM для Azure. Все события, которые ранее вызвали отправку уведомления по электронной почте, будут продолжать отправлять сообщение. Некоторые электронные сообщения будут содержать обновленные, уточняющие сведения.
