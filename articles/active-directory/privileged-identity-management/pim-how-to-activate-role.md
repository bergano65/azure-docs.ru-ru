...
Если вам нужно предположить роль Azure AD, вы можете запросить активацию с помощью параметра навигации **My Roles (Мои роли** ) в Управление привилегированными пользователями.
...
1. Выберите **Активировать**.
    ...
    ![Завершенная область активации с областью, временем начала, длительностью и причиной](./media/pim-how-to-activate-role/azure-ad-activation-status.png)
