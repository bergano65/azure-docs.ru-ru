...
Эта статья предназначена для администраторов, которым необходимо активировать роль Azure AD в PIM.

## <a name="activate-a-role"></a>Активация роли

Если необходимо выполнить роль Azure AD, вы можете запросить активацию с помощью параметра навигации **Моя роль** в PIM.
...
1. Закройте портал Azure, а затем войдите на него снова.
    ...
    При активации роли Azure AD вы увидите этапы активации. По завершении всех этапов появится ссылка **Выйти**. Вы можете воспользоваться ею, чтобы выйти из системы. В большинстве случаев это поможет устранить задержку активации.
