---
title: Назначение ролей администратора Azure AD - Privileged Identity Management | Документация Майкрософт
description: Дополнительные сведения о назначении ролей администратора Azure Active Directory в Azure AD Privileged Identity Management (PIM).
...
ms.locfileid: "58000628"
---
# <a name="assign-azure-ad-administrator-roles-in-pim"></a>Назначение ролей администратора Azure AD в PIM
