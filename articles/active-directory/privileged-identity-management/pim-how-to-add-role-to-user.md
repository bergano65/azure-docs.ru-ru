...
1. Теперь, когда пользователь имеет право на роль, сообщите ему, что он может активировать его в соответствии с инструкциями в разделе [Активация моих ролей Azure AD в Управление привилегированными пользователями](pim-how-to-activate-role.md).
    ...
    Подходящие администраторы запросят зарегистрироваться для многофакторной идентификации Azure во время активации. Если пользователь не может зарегистрироваться для использования MFA или использует учетная запись Майкрософт (например @outlook.com ,), необходимо сделать их постоянными во всех своих ролях.
