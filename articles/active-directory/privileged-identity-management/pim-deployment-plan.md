---
title: Развертывание Azure AD Privileged Identity Management (PIM) | Документация Майкрософт
...
ms.locfileid: "56166408"
---
# <a name="deploy-azure-ad-privileged-identity-management-pim"></a>Развертывание Azure AD Privileged Identity Management (PIM)

В этом пошаговом руководстве описывается планирование развертывания Azure AD Privileged Identity Management (PIM) в организации.
...
Если вашей целью является развертывание PIM для ресурсов Azure, необходимо следовать [руководству по обнаружению ресурсов Azure для управления в PIM](pim-resource-roles-discover-resources.md). Только владельцы ресурсов, групп ресурсов и подписок будут иметь возможность обнаруживать их в PIM. Если вы являетесь глобальным администратором и развертываете PIM для ресурсов Azure, то вы можете [повысить права доступа для управления всеми подписками Azure ](../../role-based-access-control/elevate-access-global-admin.md?toc=%2fazure%2factive-directory%2fprivileged-identity-management%2ftoc.json). Это позволит вам получить доступ для обнаружения всех ресурсов Azure в каталоге. Тем не менее мы рекомендуем получить утверждение от каждого владельца подписки, прежде чем управлять их ресурсами с помощью PIM.
...
Если вы являетесь ИТ-администратором с ролью глобального администратора и развертываете PIM для ресурсов Azure в своей организации, то вы можете [повысить права доступа для управления всеми подписками Azure ](../../role-based-access-control/elevate-access-global-admin.md?toc=%2fazure%2factive-directory%2fprivileged-identity-management%2ftoc.json), чтобы получить доступ к каждой подписке. Затем можно найти владельца каждой подписки и обратиться к нему, чтобы удалить ненужные назначения и свести к минимуму назначение ролей владельца.
...
1. [Настройте параметры ролей каталога Azure AD](pim-how-to-change-default-settings.md) в зависимости от того, что вы запланировали.
