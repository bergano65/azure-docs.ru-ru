...
**Роли ресурсов Azure**. Это роли, которые связаны с ресурсом, группой ресурсов, подпиской или группой управления Azure. Управление привилегированными пользователями обеспечивает JIT-доступ к обеим встроенным ролям, таким как владелец, администратор доступа пользователей, участник, а также [пользовательские роли](../../role-based-access-control/custom-roles.md). Дополнительные сведения о ролях ресурсов Azure см. в статье [Управление доступом на основе ролей в Azure (Azure RBAC)](../../role-based-access-control/overview.md).
...
В рамках процесса планирования необходимо подготовить управление привилегированными пользователями, выполнив инструкции из статьи [Начало работы с управление привилегированными пользователями](pim-getting-started.md) . Управление привилегированными пользователями предоставляет доступ к некоторым функциям, специально разработанным для помощи в развертывании.
...
1. Составьте список пользователей с привилегированными ролями в организации. Вы можете использовать управление привилегированными пользователяминое [Обнаружение и аналитические сведения (Предварительная версия)](pim-security-wizard.md) , чтобы получить страницу, подобную приведенной ниже.
...
| Администратор Exchange | :heavy_check_mark: | :heavy_check_mark: | :x: | :x: | Отсутствуют | 2 часа | Отсутствуют |
| Администратор службы технической поддержки | :x: | :x: | :heavy_check_mark: | :x: | Отсутствуют | 8 часов | Отсутствуют |
...
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| Владелец критических подписок | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | Другие владельцы подписки | 1 час | Отсутствуют | н/д | 3 месяца |
| Администратор доступа пользователей для менее важных подписок | :heavy_check_mark: | :heavy_check_mark: | :x: | Отсутствуют | 1 час | Отсутствуют | н/д | 3 месяца |
| Участник виртуальной машины | :x: | :heavy_check_mark: | :x: | Отсутствуют | 3 часа | Отсутствуют | н/д | 6 месяцев |
