...
![Расширить кнопки](media/azure-pim-resource-rbac/aadpim_rbac_extend_within_14.png)
...
![Уведомление о том, ошибка](media/azure-pim-resource-rbac/aadpim_rbac_extend_failed_existing_request.png)

Откройте вкладку **Ожидающие запросы** на панели слева, чтобы просмотреть состояние запроса или отменить его.

![Ожидающие запросы](media/azure-pim-resource-rbac/aadpim_rbac_extend_cancel_request.png)
...
![Утвердить запрос на назначение роли](media/azure-pim-resource-rbac/aadpim_rbac_extend_admin_approve_blade.png)
