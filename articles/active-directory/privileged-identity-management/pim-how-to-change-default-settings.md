---
title: Настройка параметров роли Azure AD в PIM-Azure Active Directory | Документация Майкрософт
...
ms.locfileid: "70804435"
---
# <a name="configure-azure-ad-role-settings-in-pim"></a>Настройка параметров роли Azure AD в PIM

Администратор привилегированных ролей может настроить Azure Active Directory (Azure AD) управление привилегированными пользователями (PIM) в своей организации, включая изменение интерфейса пользователя, который активирует назначение подходящей роли.
...
- [Настройка оповещений системы безопасности для ролей Azure AD в PIM](pim-how-to-configure-security-alerts.md)
