...
- Пользователи, у которых есть учетные записи Майкрософт для адресов @outlook.comэлектронной почты (как правило, но не всегда), не могут зарегистрироваться для многофакторной идентификации Azure. Если требуется назначить роли пользователям с учетными записями Майкрософт, следует либо сделать их постоянными администраторами, либо отключить многофакторную проверку подлинности для этой роли.
