...
- Пользователи, у которых есть учетные записи Майкрософт для адресов электронной почты (как правило @outlook.com , но не всегда), не могут зарегистрироваться для многофакторной идентификации Azure. Если требуется назначить роли пользователям с учетными записями Майкрософт, следует либо сделать их постоянными администраторами, либо отключить многофакторную проверку подлинности для этой роли.
- Вы не можете отключить многофакторную идентификацию Azure для ролей с высоким уровнем привилегий для Azure AD и Microsoft 365. Эта функция безопасности помогает защитить следующие роли:  
