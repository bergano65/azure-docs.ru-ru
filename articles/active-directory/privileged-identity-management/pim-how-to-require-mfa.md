...
Вы можете потребовать, чтобы пользователи выполнили запрос многофакторной проверки подлинности при входе. Вы также можете потребовать, чтобы пользователи выполнили запрос многофакторной проверки подлинности при активации роли в Azure Active Directory (Azure AD) управление привилегированными пользователями (PIM). Таким образом, если пользователь не выполнил запрос многофакторной проверки подлинности при входе в системе, ему будет предложено сделать это с управление привилегированными пользователями.
