...
ms.locfileid: "70804393"
---
# <a name="configure-security-alerts-for-azure-ad-roles-in-pim"></a>Настройка оповещений системы безопасности для ролей Azure AD в PIM

Azure Active Directory (Azure AD) управление привилегированными пользователями (PIM) создает оповещения при наличии подозрительных или ненадежных действий в вашей среде. В случае активации оповещения оно отображается на панели мониторинга PIM. Выберите оповещение, чтобы просмотреть список пользователей или ролей, активировавших предупреждение.
