...
1. Щелкните ссылку **ресурсов Azure**, чтобы снова открыть на портале страницу **Все ресурсы**.
    ...
    Если щелкнуть эту ссылку, текущий токен станет недействительным, а портал Azure получит новый с обновленными разрешениями.
...
После активации роли в PIM пройдет не менее десяти минут, прежде чем вы сможете получить доступ к нужному административному порталу или выполнить какие-либо функции в рамках определенной административной рабочей нагрузки. Чтобы принудительно обновить свои разрешения, ознакомьтесь со страницей, содержащей сведения о **доступе к приложению**, как описано ранее в разделе [Использование роли сразу после активации](#use-a-role-immediately-after-activation).
