---
title: Настройка пользовательской роли Azure AD - Привилегированное управление идентификацией (PIM)
...
- **Разрешить постоянное право на назначение**: Администраторы могут назначить постоянное право членства.
- **Срок действия подходящего назначения после**: Администраторы могут требовать, чтобы все подходящие назначения имели указанную дату начала и окончания.

Вы также можете выбрать один из следующих вариантов продолжительности для *активных* назначений.

- **Разрешить постоянное активное назначение**: Администраторы могут назначить постоянное активное членство.
