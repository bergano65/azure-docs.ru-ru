...
1. Щелкните **Настраиваемые роли Azure AD (предварительная версия)** .
    ...
    ![Выбор предварительной версии настраиваемых ролей AAD для просмотра доступных назначений ролей](./media/azure-ad-custom-roles-configure/settings-list.png)
...
- **Разрешить постоянную допустимую роль**. Администраторы могут назначать постоянное допустимое членство.
- **Установить срок действия допустимой роли**. Администраторы могут потребовать, чтобы у всех допустимых назначений были заданы даты начала и окончания действия.

Вы также можете выбрать один из следующих вариантов продолжительности для *активных* назначений.

- **Разрешить постоянную активную роль**. Администраторы могут назначать постоянное активное членство.
- **Установить срок действия активной роли**. Администраторы могут потребовать, чтобы у всех активных назначений были заданы даты начала и окончания действия.
