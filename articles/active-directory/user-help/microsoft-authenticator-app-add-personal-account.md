...
2. В нижней части страницы **Сведения о безопасности** выберите ссылку **дополнительные параметры безопасности**.
    ...
    ![Страница сведений о безопасности с выделенной ссылкой "Дополнительные параметры безопасности"](./media/microsoft-authenticator-app-add-personal-account/more-security-options-link.png)
...
2. Выберите **Добавить учетную запись** из значка**Customize and control** (Настройка и управление) в правом верхнем углу.
    ...
    ![Страница учетных записей с выделенным значком "Customize and control" (Настройка и управление)](./media/microsoft-authenticator-app-add-personal-account/customize-and-control-icon.png)
