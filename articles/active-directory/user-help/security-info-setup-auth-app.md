---
title: Настройка приложения Microsoft Authenticator в качестве способа проверки — Azure AD
description: Сведения о том, как на странице сведений о безопасности (предварительная версия) настроить проверку подлинности с использованием приложения Microsoft Authenticator в качестве способа проверки.
...
## <a name="security-vs-password-reset-verification"></a>Безопасность и проверка для сброса пароля
...
- Выполните вход с помощью приложения Microsoft Authenticator, выполнив действия, приведенные в статье [Вход с помощью двухфакторной проверки подлинности или сведений для защиты](security-info-setup-signin.md).
