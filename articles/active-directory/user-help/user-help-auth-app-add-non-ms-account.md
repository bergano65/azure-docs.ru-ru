...
Мы предоставляем этот процесс для учетных записей Facebook, Google, GitHub и Amazon, но этот процесс одинаков для других приложений, таких как Instagram и Adobe.
