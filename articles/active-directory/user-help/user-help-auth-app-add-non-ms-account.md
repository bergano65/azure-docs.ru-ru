...
11. На странице **почти готово** решите, следует ли сделать компьютер доверенным устройством, а затем выберите **получено. Turn on Two-Step Verification** (Понятно. Включите двухфакторную проверку подлинности).
