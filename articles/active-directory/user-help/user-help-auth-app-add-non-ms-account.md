...
1. На компьютере откройте Facebook, щелкните раскрывающееся меню в правом верхнем углу, а затем выберите **Параметры** > **безопасность и вход**.
...
2. Прокрутите вниз до варианта **Use two-factor authentication** (Использовать двухфакторную проверку подлинности) в разделе **Two-Factor Authentication** (Двухфакторная проверка подлинности), а затем щелкните **Edit** (Изменить).
    ...
    Откроется страница **двухфакторной проверки подлинности** .
...
11. На странице **почти готово** решите, следует ли сделать компьютер доверенным устройством, а затем выберите **получено. Включите двухфакторную проверку подлинности**.
