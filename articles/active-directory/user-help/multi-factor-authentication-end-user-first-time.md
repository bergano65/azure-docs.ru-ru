...
Для этого способа связи требуется установить приложение для проверки подлинности на телефон или планшет. Инструкции в этой статье предназначены для приложения Microsoft Authenticator, которое доступно для платформ [Windows Phone](https://go.microsoft.com/fwlink/?Linkid=825071), [Android](https://go.microsoft.com/fwlink/?Linkid=825072) и [iOS](https://go.microsoft.com/fwlink/?Linkid=825073).
