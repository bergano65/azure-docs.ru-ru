...
9. Рекомендуется указать номер своего мобильного телефона на случай утери доступа к мобильному приложению. Укажите страну или регион в раскрывающемся списке и введите номер мобильного телефона в поле рядом с названием страны или региона. Щелкните **Далее**.
...
2. Введите код и URL-адрес, указанные на той же странице, что и штрихкод. Эти данные необходимо ввести в поля **Код** и **URL-адрес** в мобильном приложении.
    ...
    ![Установка](./media/multi-factor-authentication-end-user-first-time/barcode2.png)
...
1. Из раскрывающегося списка выберите пункт **Телефон для проверки подлинности**.  
    ...
    ![Установка](./media/multi-factor-authentication-end-user-first-time/phone.png)  
2. Выберите страну или регион в раскрывающемся списке и введите номер мобильного телефона.
...
1. Из раскрывающегося списка выберите элемент **Рабочий телефон**.  
    ...
    ![Установка](./media/multi-factor-authentication-end-user-first-time/office.png)  
