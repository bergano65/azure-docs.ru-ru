---
title: Настройка адреса электронной почты в качестве метода проверки (Azure Active Directory)
description: Сведения о том, как на странице сведений о безопасности (предварительная версия) настроить проверку личности с использованием адреса электронной почты в качестве метода проверки.
...
>[!Note]
>Если вы не видите варианта для адреса электронной почты, возможно, ваша организация не позволяет использовать этот вариант для сброса пароля. Если это так, вам нужно выбрать другой метод или обратиться за помощью в службу поддержки вашей организации.

## <a name="security-vs-password-reset-verification"></a>Безопасность и проверка при сбросе пароля
