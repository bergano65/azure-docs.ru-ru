...
description: Как настроить страницу информации о безопасности (предварительно) для проверки личности с помощью адреса электронной почты в качестве метода проверки.
...
>[!Note]
>Если вы не видите опцию электронной почты, возможно, что ваша организация не позволит вам использовать эту опцию для метода сбросить пароль. В этом случае вам необходимо выбрать другой метод или обратиться в службу поддержки вашей организации для получения дополнительной помощи.
