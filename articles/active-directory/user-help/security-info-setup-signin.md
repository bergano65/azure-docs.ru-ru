...
description: Информация о том, как настроить сведения для защиты (предварительная версия) для рабочей или учебной учетной записи после того, как появится запрос со страницы входа в вашу организацию.
...
ms.locfileid: "74278983"
---
# <a name="set-up-your-security-info-preview-from-a-sign-in-prompt"></a>Настройка сведений для защиты (предварительная версия) в запросе на вход
