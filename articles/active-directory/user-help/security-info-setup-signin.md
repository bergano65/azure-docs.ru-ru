...
7. Щелкните **Далее** на странице **Сканирование QR-кода** на своем компьютере.
    ...
    ![Проверка учетной записи с помощью приложения для проверки подлинности](media/security-info/securityinfo-prompt-test-app.png)
