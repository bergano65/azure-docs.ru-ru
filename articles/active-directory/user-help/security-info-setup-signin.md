---
title: Ввод сведений для защиты в запросе на вход в Azure AD
description: Информация о том, как указать сведения для защиты рабочей или учебной учетной записи, когда появится запрос на странице входа вашей организации.
...
>[!Note]
>Если вы не видите этот вариант в мастере, это означает, что ваш администратор не настроил его. В таком случае, чтобы использовать пароли приложений, выполните действия, описанные в статье [Управление паролями приложений на странице сведений для защиты](security-info-app-passwords.md).
