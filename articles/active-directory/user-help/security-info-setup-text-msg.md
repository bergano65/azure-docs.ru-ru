---
title: 'Настройка отправки текстовых сообщений в сведениях для защиты: Azure Active Directory (предварительная версия) | Документация Майкрософт'
