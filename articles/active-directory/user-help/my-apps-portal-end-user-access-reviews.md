...
1. Откройте веб-браузер и перейдите по адресу https://myapps.microsoft.com или воспользуйтесь ссылкой, предоставленной вашей организацией. Вам может быть предоставлена персонализированная корпоративная страница, например https://myapps.microsoft.com/contoso.com.
...
1. Выберите элемент **Проверки доступа**, чтобы просмотреть список проверок доступа, ожидающих утверждения.
...
1. Выберите **Начать проверку**, чтобы начать проверку доступа.
