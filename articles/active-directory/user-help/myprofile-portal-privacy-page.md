---
title: Просмотр конфиденциальной информации из портала "Мой профиль" (предварительная версия) в Azure Active Directory | Документация Майкрософт
description: Общие сведения о странице "Конфиденциальность" на портале "Мой профиль".
