---
title: Управление организациями из портала "Мой профиль" (предварительная версия) в Azure Active Directory | Документация Майкрософт
description: Общий обзор страницы "Организации" на портале "Мой профиль".
...
>[!Important]
>Если вы случайно вышли из организации, нельзя это отменить. Вам нужно будет добавить организацию еще раз.

1. Войдите в вашу учетную запись с области **Other organizations I work with** (Другие организации, с которыми я работаю).

2. Выберите **Покинуть организацию**, а затем — **Да**, чтобы подтвердить выход из организации.
