...
>В вашей организации для входа и доступа к данным и документации может быть необходимо использовать приложение проверки подлинности. Хотя в этом приложении может быть указано ваше имя пользователя, учетную запись нельзя использовать как метод проверки, пока не выполнена процедура регистрации. Дополнительные сведения см. в статье [Добавление рабочей или учебной учетной записи](user-help-auth-app-overview.md).
