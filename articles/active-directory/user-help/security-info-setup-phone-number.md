...
description: Как настроить страницу информации о безопасности (предварительный просмотр) для проверки личности с помощью номера телефона и мобильного устройства в качестве метода проверки.
