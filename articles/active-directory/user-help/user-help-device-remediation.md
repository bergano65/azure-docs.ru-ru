---
title: Исправления для ошибки "Вы не можете получить отсюда" - Azure AD
description: Найдите потенциальные исправления, почему вы получаете сообщение об ошибке "Вы не можете получить там отсюда".
...
---
# <a name="possible-fixes-for-the-you-cant-get-there-from-here-error-message"></a>Возможные исправления для сообщения об ошибке "Вы не можете получить отсюда"
