---
title: Присоединитесь к рабочему устройству в сети организации - AD
...
2. Выберите **работу доступа или школу**и убедитесь, что вы видите текст, который говорит что-то вроде, подключен к ** * \<your_organization>* Azure AD.**
...
- Если ваша организация управляется с помощью Microsoft Intune и у вас возникают вопросы о [Intune user help content](https://docs.microsoft.com/intune-user-help/use-managed-devices-to-get-work-done)регистрации, входе или любой другой проблеме, связанной с Intune, см.