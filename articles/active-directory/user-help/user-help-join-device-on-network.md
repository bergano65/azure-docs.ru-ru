---
title: Присоединения рабочего устройства к сети организации — AD
...
2. Выберите **Доступ к рабочей или учебной учетной записи** и убедитесь, что видите текст, например **Подключено к *\<ваша_организация>* Azure AD**.
...
- Если ваша организация управляется с помощью Microsoft Intune и у вас есть вопросы о регистрации, входе или любых других проблемах, связанных с Intune, см. раздел [Справочные материалы по Intune для пользователей](https://docs.microsoft.com/intune-user-help/use-managed-devices-to-get-work-done).