...
4. На странице **Two-Factor Authentication** (Двухфакторная структура проверки подлинности), которая открыта на вашем компьютере, введите полученный в приложении шестизначный код проверки для своей учетной записи Facebook, а затем щелкните **Проверить**.
...
6. На странице Почти сделано, решить, следует ли сделать ваш компьютер доверенным устройством, а затем выбрать **Got его. Включите двухступенчатую проверку.**
