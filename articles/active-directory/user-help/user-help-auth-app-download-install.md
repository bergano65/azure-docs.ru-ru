...
> [!Important]
> Приложение Microsoft Authenticator работает с любой учетной записи, который использует двухфакторную проверку подлинности и поддерживает стандарты (TOTP) одноразовых паролей на основе времени.
> 
