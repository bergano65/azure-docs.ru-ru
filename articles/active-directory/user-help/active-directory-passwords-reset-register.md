...
Как пользователь, вы можете самостоятельно сбросить свой пароль или разблокировать учетную запись, если используете функцию самостоятельного сброса пароля в Azure AD. Перед использованием этой функции необходимо зарегистрировать методы проверки или подтвердить предопределенные методы проверки, заданные администратором.
...
1. Откройте веб-браузер на устройстве и перейдите на [страницу регистрации для сброса пароля](https://account.activedirectory.windowsazure.com/PasswordReset/Register.aspx?regref=ssprsetup).
...
4. Укажите или подтвердите сведения, которые затребовал ваш администратор. Если вам доступны несколько методов, рекомендуем зарегистрировать их все. Это даст вам возможность выбора, если один из методов будет недоступен. Например, если вы в дороге, у вас нет доступа к офисному телефону.
    ...
    ![Регистрация методов проверки и нажатие кнопки "Готово"][Register]
...
Администраторы могут потребовать подтверждения методов проверки по истечении определенного периода времени, чтобы убедиться в наличии соответствующих методов.
