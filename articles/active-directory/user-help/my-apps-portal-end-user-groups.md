...
3. Щелкните плитку **Группы**, чтобы просмотреть сведения о группах.

    ![Страница "Группы" со списком групп, которыми вы владеете и в которых участвуете](media/my-apps-portal/my-apps-portal-groups-page.png)

4. В зависимости от предоставленных вам разрешений, на странице **Группы** вы можете выполнять что-то из следующего.
