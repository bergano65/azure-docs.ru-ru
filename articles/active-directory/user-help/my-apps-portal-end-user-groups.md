...
2. Введите необходимые сведения:
    ...
    - **Тип группы.**
        ...
        - **Office 365.** Обеспечивает возможности совместной работы, предоставляя участникам доступ к общему почтовому ящику, календарю, файлам, сайту SharePoint и многое другое. Этот параметр также позволяет предоставлять доступ к группе пользователям за пределами организации.
...
Вы можете добавлять или удалять участников для всех групп, которыми вы владеете.
...
Вы можете присоединиться или покинуть уже существующую группу на странице " **группы** ".
