...
> 
> Учетные записи администраторов запрещено использовать секретные вопросы, как метод сброса пароля. При входе в систему качестве учетной записи уровня администратора вы не увидите эти параметры.
