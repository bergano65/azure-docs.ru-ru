...
- **Уведомление.** Приложение отправит уведомление на устройство. Проверьте, что это уведомление по запросу, а затем выберите **Подтвердить**. Если же вы не отправляли запрос на получение уведомления, выберите **Отклонить**. Можно пометить запрос как мошеннический, щелкнув **Запретить**.
