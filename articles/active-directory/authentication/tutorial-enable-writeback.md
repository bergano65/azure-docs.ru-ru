...
description: В этом руководстве описано включение компонента обратной записи паролей, чтобы вернуть инициированные облаком изменения пароля обратно в локальную AD в рамках Azure AD Connect.
...
> [Руководство. Использование событий риска для запуска Многофакторной идентификации и изменений пароля](tutorial-risk-based-sspr-mfa.md)
