...
1. Найдите и выберите *Azure Active Directory*. Выбор > **методов проверки подлинности** **безопасности** > **Политика метода проверки подлинности (Предварительная версия)**
