---
title: Развертывание защиты паролем Azure AD
...
### <a name="install-the-dc-agent-service"></a>Установка службы агента DC
   ...
   Установка программного обеспечения можно автоматизировать с помощью стандартных процедур MSI. Например: 
