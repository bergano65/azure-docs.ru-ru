...
В настоящее время доступна предварительная версия входа без пароля с Microsoft Authenticatorным приложением в Azure AD. Использование приложения Microsoft Authenticator для дополнительной аутентификации для многофакторной идентификации Azure AD, самостоятельного сброса пароля (SSPR) или токенов OATH-программного обеспечения. См. подробные сведения о [дополнительных условиях использования предварительных выпусков Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).
