...
* затронуты все следующие роли администратора:
  ...
  * Администратор привилегированных проверки подлинности
...
В следующей таблице описаны параметры политики паролей, которые применяются к учетным записям пользователей, которые создаются и управляются в Azure AD:
...
| Ограничения для пароля |<ul><li>От 8 до 16 знаков.</li><li>Необходимо выполнить 3 из 4 следующих условий:<ul><li>строчные буквы;</li><li>прописные буквы;</li><li>числа (0–9);</li><li>символы (см. ограничения для пароля выше).</li></ul></li></ul> |
