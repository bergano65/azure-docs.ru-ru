...
Политика паролей не применяется к учетным записям пользователей, синхронизированным из локальной среды AD DS с помощью Azure AD Connect.
