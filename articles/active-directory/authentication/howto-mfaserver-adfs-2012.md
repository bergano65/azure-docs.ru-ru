...
4. Щелкните **Установить AD FS-адаптер**.
   ...
   ![Установка адаптера ADFS из консоли сервера MFA](./media/howto-mfaserver-adfs-2012/server.png)
...
![Изменение глобальной политики проверки подлинности](./media/howto-mfaserver-adfs-2012/global.png)
...
2. В поле **WebServiceSdkUrl** укажите URL-адрес пакета SDK веб-службы многофакторной проверки подлинности. Например: *https:\/\/contoso.com/\<CertificateName>/multifactorauthwebservicesdk/pfwssdk.asmx*, где * \<CertificateName>* — это имя вашего сертификата.  
3. Измените скрипт скрипт Register-multifactorauthenticationadfsadapter. ps1, добавив `-ConfigurationFilePath &lt;path&gt;` в конец `Register-AdfsAuthenticationProvider` команды, где * &lt;Path&gt; * — это полный путь к файлу файлу multifactorauthenticationadfsadapter. config.
...
3. Щелкните правой кнопкой мыши **Microsoft Office 365 Identity Platform** (Платформа удостоверений Microsoft Office 365) и выберите **Изменить правила утверждений...**.
   ...
   ![Изменение правил утверждений в консоли ADFS](./media/howto-mfaserver-adfs-2012/trustedip1.png)

4. На вкладке "Правила преобразования выдачи" выберите **Добавить правило**.

   ![Изменение правил преобразования в консоли ADFS](./media/howto-mfaserver-adfs-2012/trustedip2.png)
...
5. В мастере добавления правила преобразования утверждения выберите **Проход через входящее утверждение или его фильтрация** в раскрывающемся списке и нажмите кнопку **Далее**.
   ...
   ![Мастер добавления правила преобразования утверждений](./media/howto-mfaserver-adfs-2012/trustedip3.png)
