...
>
> Если вы используете службу MFA на основе облака, см. статью [интеграция существующей инфраструктуры NPS с многофакторной идентификацией Azure](howto-mfa-nps-extension.md).
>
...
Узнайте, как [интегрировать проверку подлинности RADIUS](howto-mfa-nps-extension.md) , если у вас есть многофакторная идентификация Azure AD в облаке. 
