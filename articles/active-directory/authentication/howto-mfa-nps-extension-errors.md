...
В этой статье приведены способы быстрого устранения ошибок, связанных с расширением NPS для Многофакторной идентификации Azure. Журналы расширений NPS находятся в Просмотр событий в разделе **пользовательские представления**  >  **роли сервера**  >  **Политика сети и доступ к службам** на сервере, где установлено расширение NPS.
