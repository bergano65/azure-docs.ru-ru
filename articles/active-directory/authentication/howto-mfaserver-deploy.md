...
* Маркер устройства — используется при аутентификации с использованием мобильного приложения.
