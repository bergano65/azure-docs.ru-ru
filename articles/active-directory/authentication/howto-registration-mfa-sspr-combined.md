...
2. Перейдите в раздел **Azure Active Directory** > **Параметры пользователя** > **Управление параметрами просмотра пользовательских функций**.
...
![Создание политики ЦС для управления регистрацией сведений о безопасности](media/howto-registration-mfa-sspr-combined/require-registration-from-trusted-location.png)
