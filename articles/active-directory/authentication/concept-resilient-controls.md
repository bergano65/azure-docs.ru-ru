...
5. Если вы защищаете доступ VPN с помощью расширения NPS Azure MFA, рассмотрите возможность объединения решения VPN в качестве [приложения SAML](../manage-apps/view-applications-portal.md) и определите категорию приложения, как описано ниже. 
...
Если вы защищаете доступ VPN с помощью расширения NPS Azure MFA, рассмотрите возможность объединения решения VPN в качестве [приложения SAML](../manage-apps/view-applications-portal.md) и определите категорию приложения, как описано ниже. 
...
>[!NOTE]
 > Настройка [доверенных IP-адресов](./howto-mfa-mfasettings.md) для MFA Azure доступна только с [лицензиями Azure AD Premium](./concept-mfa-licensing.md).
