---
title: Создание отказоустойчивой стратегии управления доступом — Azure Active Directory
...
* Политика 1: блокировка доступа для пользователей за пределами целевых групп
  ...
  * Условия: (нет)
  * Предоставить управление: Заблокировать
...
Политика условного доступа на непредвиденные случаи — это **отключенная политика** , которая не охватывает Azure MFA, сторонние MFA, основанные на рисках или элементы управления на устройствах. Затем, когда ваша организация решит активировать план на непредвиденные случаи, администраторы могут включить эту политику и отключить обычные политики на основе контроля.
