...
> [!TIP]
> Выберите один из этих методов, чтобы требовать прохождения двухфакторной проверки подлинности, но не оба. Включение пользователя для многофакторной идентификации Azure переопределяет любые политики условного доступа.
