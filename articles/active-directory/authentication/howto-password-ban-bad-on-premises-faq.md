...
Пользовательская смарт-блокировка поддерживается только в Azure. Изменения настраиваемых параметров смарт-блокировки на портале управления Azure не влияют на локальную среду Active Directory, даже если агенты установлены.
