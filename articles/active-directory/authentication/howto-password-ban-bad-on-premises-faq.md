...
ms.locfileid: "54427599"
---
# <a name="preview-azure-ad-password-protection-on-premises---frequently-asked-questions"></a>Предварительная версия. Часто задаваемые вопросы о локальной службе защиты паролем Azure AD
