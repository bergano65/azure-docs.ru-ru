...
[Руководство по миграции репликации SYSVOL: репликация DFS FRS](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/dd640019(v=ws.10))
...
**Вопрос. Почему Azure AD все еще отвергает ненадежные пароли, несмотря на то, что я настроил политику в режиме аудита?**
...
**Вопрос. При отклонении пароля службой защиты паролей Azure AD пользователи видят традиционное сообщение об ошибке Windows. Можно ли настроить это сообщение об ошибке, чтобы пользователи могли узнать, что произошло?**
