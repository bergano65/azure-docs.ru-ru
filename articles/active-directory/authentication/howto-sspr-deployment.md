...
Объединенная регистрация не требует, чтобы организации включили SSPR и многофакторную идентификацию Azure AD. Объединенная регистрация обеспечивает более удобный пользовательский интерфейс. Дополнительные сведения см. в разделе [Объединенная регистрация сведений о безопасности](concept-registration-mfa-sspr-combined.md).
