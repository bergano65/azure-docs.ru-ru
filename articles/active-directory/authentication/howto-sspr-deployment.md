...
## <a name="how-sspr-works"></a>Как работает самостоятельный сброс пароля
...
### <a name="configure-sspr"></a>Настройка самостоятельного сброса пароля
