...
Следуйте указаниям в разделе [Что для меня означает Многофакторная идентификация Azure](../user-help/multi-factor-authentication-end-user-first-time.md), чтобы понять процедуру и правильно настроить устройства для Многофакторной идентификации с помощью своей учетной записи пользователя.
