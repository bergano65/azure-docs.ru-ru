...
> [!NOTE]
> С 1 сентября 2018 года создавать новые поставщики аутентификации невозможно. Существующие поставщики проверки подлинности может продолжать использоваться и обновлены, но миграции больше нельзя. Многофакторная аутентификация по-прежнему будет предоставляться как функция в лицензиях Azure AD ценовой категории "Премиум".
