...
![Страница входа пользовательского портала сервера MFA](./media/howto-mfaserver-deploy-userportal/portal.png)
...
![Управление учетной записью многофакторной проверки Подлинности сервера, с помощью пользовательского портала](./media/howto-mfaserver-deploy-userportal/portalsettings.png)
...
![Проверка пользователя портала, с помощью SMS](./media/howto-mfaserver-deploy-userportal/text.png)
