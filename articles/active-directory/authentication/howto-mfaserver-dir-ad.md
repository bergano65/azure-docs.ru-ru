...
| Компонент | Описание |
| --- | --- |
| Использовать Active Directory |Выберите этот параметр для использования Active Directory для импорта и синхронизации.  Этот параметр используется по умолчанию. <br>Примечание. Для правильной интеграции с Active Directory компьютер должен быть присоединен к домену, а вы должны войти с помощью учетной записи домена. |
