...
|Проход только аудита (не удалось выполнить из-за имени пользователя)| 10016, 30024| 10017, 30023|
...
Варианты в приведенной выше таблице, которые ссылаются на "имя пользователя", указывают на ситуации, когда пароль пользователя содержит либо имя учетной записи пользователя, либо одно из понятных имен пользователя. В любом случае пароль пользователя будет отклонен, если политика настроена на принудительное применение или если политика находится в режиме аудита.
