...
Для защиты пользователей в Azure Active Directory (Azure AD) можно настроить политики на основе рисков, которые автоматически реагируют на события риска. Политики службы "Защита идентификации Azure AD" могут автоматически блокировать попытки входа или требовать дополнительных действий, например изменения пароля или применения Многофакторной идентификации Azure. Эти политики в сочетании с существующими политиками условного доступа Azure AD создают дополнительный слой защиты для организаций. Возможно, пользователи никогда не совершат ничего такого, что приведет к срабатыванию одной из этих политик, но организация будет готова к попыткам взлома систем безопасности.
