---
title: Интеграция VPN с Azure MFA с использованием расширения NPS (Azure Active Directory)
...
Для помощи в настройке службы "Многофакторная идентификация" для пользователей воспользуйтесь статьями [Планирование развертывания Многофакторной идентификации Azure](howto-mfa-getstarted.md#create-conditional-access-policy) и [Что такое страница дополнительной проверки?](../user-help/multi-factor-authentication-end-user-first-time.md).
