...
Чтобы назначить лицензию для рассматриваемой учетной записи администратора, выполните действия по [назначению, проверке и устранению проблем с лицензиями](../enterprise-users/licensing-groups-assign.md#step-1-assign-the-required-licenses).
