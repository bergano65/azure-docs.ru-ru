...
![Применение лицензии для пользователей, включить, уведомлять](./media/multi-factor-authentication-security-best-practices/ems.png)
...
![Поставщик многофакторной проверки подлинности](./media/multi-factor-authentication-security-best-practices/authprovider.png)
...
![По умолчанию компоненты сервера MFA](./media/multi-factor-authentication-security-best-practices/server.png) \*не устанавливаются по умолчанию \** установлен, но не включены по умолчанию
