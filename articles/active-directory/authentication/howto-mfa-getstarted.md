...
| Сценарий | Предварительное требование |
| --- | --- |
...
Для развертывания многофакторной идентификации в Организации используйте настраиваемые плакаты и шаблоны электронной почты в материалах для многофакторной [проверки](https://www.microsoft.com/download/details.aspx?id=57600&WT.mc_id=rss_alldownloads_all) подлинности.
...
6. Выберите, следует ли определять расположение с помощью диапазонов IP-адресов или стран или регионов.
   ...
   2. При использовании стран или регионов
      ...
      2. Решите, следует ли включать неизвестные области. Неизвестные области — это IP-адреса, которые невозможно сопоставить со страной или регионом.
7. Нажмите кнопку **Создать**.

## <a name="plan-authentication-methods"></a>Планирование методов проверки подлинности

Администраторы могут выбирать [методы проверки](../authentication/concept-authentication-methods.md) подлинности, которые они хотят сделать доступными для пользователей. Важно обеспечить более одного метода проверки подлинности, чтобы пользователи имели доступ к методу резервного копирования, если их основной метод недоступен. Для включения в Администраторы доступны следующие методы:
...
1. Настройка выбранных [методов проверки](#choose-verification-options) подлинности
