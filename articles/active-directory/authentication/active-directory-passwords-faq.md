...
* **В: Поддерживаете ли вы разблокировку локальных учетных записей Active Directory при сбросить пароли?**
  ...
  > **A:** Да. Если на момент сброса пароля компонент обратной записи паролей уже развернут с помощью Azure AD Connect, учетная запись пользователя будет автоматически разблокирована.
  >
  >
