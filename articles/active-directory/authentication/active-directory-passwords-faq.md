...
* **Вопрос. Куда именно нужно направлять пользователей для сброса паролей?**
  ...
  > **Ответ.** Ознакомьтесь с предложениями в статье о [развертывании SSPR](howto-sspr-deployment.md#plan-communications).
  >
  >
...
* **Вопрос. Если пользователь зарегистрировал больше вопросов, чем необходимо для сброса, какие именно контрольные вопросы выбираются при сбросе?**
  ...
  > Ответ **.** *n* . Количество контрольных вопросов выбирается случайным образом из общего числа вопросов, зарегистрированных пользователем, где *N* — это объем, заданный для параметра **число вопросов, необходимых для сброса** параметров. Например, если пользователь зарегистрировал пять контрольных вопросов, но для сброса пароля требуется только три, тогда в случайном порядке из пяти вопросов выбираются только три. Если пользователь неправильно отвечает, вопросы выбираются еще раз. Это позволяет предотвратить подбор ответов.
  >
  >
