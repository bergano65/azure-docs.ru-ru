...
1. Пользователю будет возвращен комбинированный опыт регистрации и предложено предоставить значимое имя для ключа, чтобы пользователь мог определить, какой из них, если они имеют несколько. Нажмите кнопку **Далее**.
...
### <a name="upn-changes"></a>Изменения UPN
