...
Устройства, присоединенные к Azure AD, для которых выполняется Пилотная версия, должны работать под управлением Windows 10 версии 1809 или выше. В Windows 10 версии 1903 или более поздней.

Гибридные устройства, присоединенные к Azure AD, должны работать под управлением Windows 10 Insider Build 18945 или более поздней версии.
