...
> [!NOTE]
> SSPR также может завершиться ошибкой, если в локальной AD DS учетной записи на локальном компьютере настроены параметры "пароль не просрочен" или "пользователь не может изменить пароль". 
...
1. На вкладке **Соединители** выберите локальный соединитель **доменных служб Active Directory**, а затем щелкните **Свойства**.  
   ![Synchronization Service Manager покажет, как изменить свойства @ no__t-1  
