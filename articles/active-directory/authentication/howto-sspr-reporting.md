...
> [!NOTE]
> Вы должны иметь права [глобального администратора](../roles/permissions-reference.md) и указать, что эти данные необходимо собирать от имени вашей организации. Чтобы дать согласие, необходимо по крайней мере один раз посетить вкладку **Отчеты** или просмотреть журналы аудита. Пока это не сделано, данные для вашей организации не собираются.
>
