...
* **Причины состояния действия**.   Ознакомьтесь со следующей таблицей, содержащей [все причины допустимых состояний действий сброса пароля](#allowed-values-for-details-column).
