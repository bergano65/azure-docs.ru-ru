...
4. Выберите **Группа репликации**. Введите имя заблокированного пользователя в поле **username@domain.com**. Введите комментарий в поле **Причина**.
...
5. Введите имя пользователя **username@domain.com**. Введите количество секунд, в течение которых будет работать обход проверки, и причину обхода.
