...
|:--- |:--- |
| управляемость. |**Конкретный диапазон IP-адресов**. Администраторы указывают диапазон IP-адресов, которые могут обходить многофакторную проверку подлинности для пользователей, выполняющих вход из интрасети компании. Можно настроить не более 50 диапазонов доверенных IP-адресов.|
