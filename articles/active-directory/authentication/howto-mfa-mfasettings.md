---
title: Наконченная многофакторная аутентификация Azure - Активный каталог Azure
...
Вы можете получить доступ к параметрам, связанным с многофакторной аутентификацией Azure с портала Azure, просматривая доступ к МИД**безопасности** >  **Active Directory.** > **MFA**
...
| [Блокировка и разблокировка пользователей](#block-and-unblock-users) | Используется для блокировки определенных пользователей от возможности получать многофакторные запросы аутентификации. Любые попытки выполнить аутентификацию заблокированных пользователей отклоняются автоматически. Блокировка пользователей действует в течение 90 дней. |
| [Предупреждение о мошенничестве](#fraud-alert) | Настройка параметров, связанных с возможностью пользователей сообщать о мошеннических запросах проверки |
...
2. Просмотр **для Azure Active Directory** > **Security** > **MFA** > **Block/unblock пользователей.**
...
1. Вопиюсь на [портал Azure](https://portal.azure.com) в качестве администратора.
2. Просмотрите**предупреждение Оповещении**о мошенничестве **в Azure Active Directory** > **Security** > **MFA.** > 
...
* **Код для уведомления о мошенничестве во время первоначального приветствия.** Когда пользователям поступает телефонный звонок для прохождения двухфакторной проверки подлинности, они обычно нажимают кнопку **#**, чтобы подтвердить вход. Чтобы сообщить о мошенничестве, пользователь **#** вводит код перед нажатием . По умолчанию используется код **0**, но вы можете его изменить.
...
2. Выберите вхыски **Active Directory** > **Подсылайте**Azure Active. Отчет о мошенничестве теперь является частью стандартного отчета о регистрации Azure AD.

## <a name="notifications"></a>Уведомления

Назначьте адреса электронной почты здесь для пользователей, которые будут получать сообщения о мошенничестве.

![Уведомление о мошенничестве оповещение по электронной почте образец](./media/howto-mfa-mfasettings/multi-factor-authentication-fraud-alert-email.png)
...
В Соединенных Штатах, если вы еще не настроили идентификатор вызова вызова MFA Caller, голосовые вызовы от Microsoft поступают со следующих номеров: No1 (866) 539 4191, No1 (855) 330 8653 и No1 (877) 668 6536. При использовании спам-фильтров, убедитесь, что исключить эти номера.
...
1. Вопиюсь на [портал Azure](https://portal.azure.com) в качестве администратора.
1. Просмотр**настроек**телефонного звонка **Azure Active Directory** > **Security** > **MFA.** > 
...
### <a name="custom-voice-message-defaults"></a>Пользовательские голосовые сообщения по умолчанию

Пример скриптов для создания пользовательских сообщений.

| Имя сообщения | Скрипт |
| --- | --- |
| Успешная аутентификация | Ваш вху был успешно проверен. До свидания. |
| Подсказка расширения | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, нажмите фунт ключ, чтобы продолжить. |
| Подтверждение мошенничества | Было отправлено предупреждение о мошенничестве. Чтобы разблокировать учетную запись, пожалуйста, свяжитесь с Отделом ИТ-службы вашей компании. |
| Мошенничество приветствие (Стандарт) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, нажмите на фунт ключ, чтобы закончить проверку. Если вы не инициировали эту проверку, кто-то может попытаться получить доступ к вашей учетной записи. Пожалуйста, нажмите ноль фунт представить предупреждение о мошенничестве. Это уведомит ИТ-группу вашей компании и заблокирует дальнейшие попытки проверки. |
| Мошенничество сообщил о мошенничестве предупреждение было представлено. | Чтобы разблокировать учетную запись, пожалуйста, свяжитесь с Отделом ИТ-службы вашей компании. |
| Активация | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, нажмите на фунт ключ, чтобы закончить проверку. |
| Аутентификация отказано повторной | Проверка отказано. |
| Повторная попытка (стандарт) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, нажмите на фунт ключ, чтобы закончить проверку. |
| Приветствие (стандарт) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, нажмите на фунт ключ, чтобы закончить проверку. |
| Приветствие (PIN) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, введите свой PIN-код, а затем фунт ключ, чтобы закончить проверку. |
| Мошенничество приветствие (PIN) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт.  Пожалуйста, введите свой PIN-код, а затем фунт ключ, чтобы закончить проверку. Если вы не инициировали эту проверку, кто-то может попытаться получить доступ к вашей учетной записи. Пожалуйста, нажмите ноль фунт представить предупреждение о мошенничестве. Это уведомит ИТ-группу вашей компании и заблокирует дальнейшие попытки проверки. |
| Повторная попытка (PIN) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, введите свой PIN-код, а затем фунт ключ, чтобы закончить проверку. |
| Подсказка расширения после цифр | Если уже на этом продлении, нажмите фунт ключ, чтобы продолжить. |
| Аутентификация отказано | Извините, мы не можем войти в систему в это время. Повторите попытку позже. |
| Активация приветствия (стандарт) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, нажмите на фунт ключ, чтобы закончить проверку. |
| Повторная попытка активации (стандарт) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, нажмите на фунт ключ, чтобы закончить проверку. |
| Активация приветствия (PIN) | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, введите свой PIN-код, а затем фунт ключ, чтобы закончить проверку. |
| Подсказка расширения перед цифрами | Благодарим Вас за использование системы проверки ввне корпорации Майкрософт. Пожалуйста, перенесите этот призыв к расширению ... |
...
1. Вопиюсь на [портал Azure](https://portal.azure.com) в качестве администратора.
2. Просмотрите одноразовый**обход** **Azure Active Directory** > **Security** > **MFA.** > 
3. Нажмите кнопку **Добавить**.
4. При необходимости выберите группу репликации для этого обхода.
5. Введите имя пользователя в качестве **имени\@пользователя domain.com.** Введите количество секунд, в течение которых будет работать обход проверки, и причину обхода.
6. Нажмите кнопку **Добавить**. Ограничение времени вступает в силу немедленно. Пользователь должен выполнить вход до истечения срока действия разового обхода проверки.
...
1. Вопиюсь на [портал Azure](https://portal.azure.com) в качестве администратора.
2. Просмотрите правила **Azure Active Directory** > **Security** > **Mininins.****MFA** > 
3. Нажмите кнопку **Добавить**.
...
Такие настройки, как пароли приложений, надежные IP-адреса, параметры проверки. Кроме того, многие настройки многофакторной проверки подлинности для службы Многофакторной идентификации Azure можно найти в параметрах службы. Настройки службы можно получить с портала Azure, просматривая доступ к **azure Active Directory** > **Security** > **MFA** > **Начало** > **настройки** > **Дополнительные настройки облачного МИД.**
...
Доверенные диапазоны IP-адресов могут быть частными или общедоступными.
...
>[!NOTE]
>Пароли приложений не работают с многофакторной политикой аутентификации Conditional Access и современной аутентификацией.
...
1. Войдите на [портал Azure](https://portal.azure.com).
2. Слева выберите > **пользователей**Active **Directory Azure.**
3. Выберите **многофакторную аутентификацию**.
...
> [!NOTE]
> МИД доверял IP-адресам и условным местам доступа, а названные местами условного доступа работали только с IPV4-адресами.
...
### <a name="enable-named-locations-by-using-conditional-access"></a>Включить названные местоположения с помощью условного доступа

1. Войдите на [портал Azure](https://portal.azure.com).
2. Слева выберите места**условного доступа** >  **Azure Active Directory** > **Security** > Conditional Access**Named.**
3. Выберите **Новое расположение**.
4. Введите имя расположения.
5. Выберите **Отметку в качестве доверенного местоположения.**
6. Введите диапазон IP-адресов в нотации CIDR (например, **192.168.1.1/24**).
7. Выберите **Создать**.

### <a name="enable-the-trusted-ips-feature-by-using-conditional-access"></a>Включить функцию доверенных i-pPs с помощью условного доступа

1. Войдите на [портал Azure](https://portal.azure.com).
2. Слева выберите места**условного доступа** >  **Azure Active Directory** > **Security** >  Conditional Access**Named.**
3. Выберите **Настраивать MFA доверенных IPs**.
4. На странице **Параметры службы** в разделе **Список надежных IP-адресов** выберите один из следующих двух параметров:
   ...
   * **Для запросов от определенного диапазона общедоступных IP-адресов.** Чтобы выбрать этот вариант, введите IP-адреса в соответствующем текстовом поле в нотации CIDR.
      ...
      * Для одного IP-адреса используйте обозначение, **как xxx.xxx.xxx.xxx/32**.
...
>[!IMPORTANT]
>Если учетная запись или устройство скомпрометированы, запоминание данных MFA для доверенных устройств может повлиять на безопасность. Если корпоративная учетная запись становится скомпрометированной или доверенное устройство утеряно или украдено, следует [отозвать сессии МИД.](howto-mfa-userdevicesettings.md)
>
...
Функция сокращает количество проверок подлинности в веб-приложениях, которые обычно запрашиваются каждый раз. Эта функция также увеличивает число аутентификаций в современных клиентах аутентификации (которые обычно запрашиваются каждые 90 дней). Может также увеличить количество аутентификаций в сочетании с политиками условного доступа.
...
>
>Функция **запоминающихся многофакторной аутентификации** не совместима с пользователями B2B и не будет видна пользователям B2B при входе в число приглашенных арендаторов.
>
