...
Вы можете получить доступ к параметрам, связанным с многофакторной идентификацией Azure, из портал Azure, перейдя к **Azure Active Directory** > **Безопасность** > **MFA**.
...
2. Перейдите в **Azure Active Directory** > **безопасность** > **MFA** > **Блокировать/разблокировать пользователей**.
...
1. Войдите на [портал Azure](https://portal.azure.com) с использованием учетной записи администратора.
2. Перейдите к **Azure Active Directory** > **безопасность** > **MFA** > **оповещение о мошенничестве**.
...
1. Войдите на [портал Azure](https://portal.azure.com) с использованием учетной записи администратора.
1. Перейдите в **Azure Active Directory** > **безопасность** > **MFA** > **Параметры телефонного звонка**.
...
1. Войдите на [портал Azure](https://portal.azure.com) с использованием учетной записи администратора.
2. Перейдите в **Azure Active Directory** > безопасность > **MFA** > **одноразовый обход проверки** **подлинности** .
3. Выберите **Добавить**.
...
1. Войдите на [портал Azure](https://portal.azure.com) с использованием учетной записи администратора.
2. Перейдите к **Azure Active Directory** > **безопасность** > **MFA** > **правила кэширования**.
3. Выберите **Добавить**.
...
Такие настройки, как пароли приложений, надежные IP-адреса, параметры проверки. Кроме того, многие настройки многофакторной проверки подлинности для службы Многофакторной идентификации Azure можно найти в параметрах службы. Для доступа к параметрам служб из портал Azure перейдите к **Azure Active Directory** > **безопасность** > **MFA** > **Приступая к работе** > **настроить** > **дополнительных параметров MFA на основе облака**.
