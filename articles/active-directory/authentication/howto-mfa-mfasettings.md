...
| Активация | Благодарим за использование системы проверки входа Майкрософт. Нажмите решетку, чтобы завершить проверку. |
| Проверка подлинности не пройдена — повтор | В проверке отказано. |
| Повтор (стандарт) | Благодарим за использование системы проверки входа Майкрософт. Нажмите решетку, чтобы завершить проверку. |
| Приветствие (стандарт) | Благодарим за использование системы проверки входа Майкрософт. Нажмите решетку, чтобы завершить проверку. |
...
| Приветствие активации (стандартное) | Благодарим за использование системы проверки входа Майкрософт. Нажмите решетку, чтобы завершить проверку. |
| Повтор активации (стандартный) | Благодарим за использование системы проверки входа Майкрософт. Нажмите решетку, чтобы завершить проверку. |
...
## <a name="one-time-bypass"></a>Однократный обход проверки
...
1. Войдите на [портале Azure](https://portal.azure.com).
2. Слева выберите **Azure Active Directory** > **Условный доступ** > **именованные расположения**.
...
## <a name="remember-multi-factor-authentication"></a>Запомнить многофакторную проверку подлинности
