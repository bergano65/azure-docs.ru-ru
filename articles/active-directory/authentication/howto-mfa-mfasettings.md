...
| [OATH-токены](concept-authentication-oath-tokens.md) | Используется в облачных средах Azure MFA для управления OATH-токенами для пользователей. |
