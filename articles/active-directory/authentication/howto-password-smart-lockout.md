...
* Смарт-блокировка отслеживает хэш последних трех попыток неправильного ввода пароля во избежание повторного увеличения счетчика блокировки. Если кто-то введет тот же неверный пароль несколько раз, это не вызовет блокировку учетной записи.
   * Эта функция недоступна для клиентов с включенной сквозной проверкой подлинности.
...
Использование смарт-блокировки не гарантирует, что подлинный пользователь никогда не заблокируется. Если смарт-блокировка блокирует учетную запись пользователя, мы стараемся не блокировать подлинного пользователя. Служба блокировки пытается ограничить доступ злоумышленников к учетной записи настоящих пользователей.  
