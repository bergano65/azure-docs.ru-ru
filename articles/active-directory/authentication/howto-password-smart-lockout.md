---
title: Предотвращение атак методом перебора с помощью Azure AD, смарт-блокировка — Azure Active Directory
...
![Изменение политики блокировки учетных записей в локальной Active Directory](./media/howto-password-smart-lockout/active-directory-on-premises-account-lockout-policy.png)
