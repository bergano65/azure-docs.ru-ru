...
Использование смарт-блокировки не гарантирует, что подлинный пользователь никогда не будет заблокирован. Когда смарт блокировка блокирует учетную запись пользователя, мы стараемся изо всех сил, чтобы не блокировать подлинного пользователя. Служба блокировки пытается ограничить доступ злоумышленников к учетной записи настоящего пользователя.  
