...
1. Войдите в [портал Azure](https://portal.azure.com) и перейдите к **Azure Active Directory** > **методы** > проверки подлинности**пароль защита паролем**.
