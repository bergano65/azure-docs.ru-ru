...
4. Для автоматического обнаружения переменных имени пользователя, пароля и домена введите URL-адрес входа (например `https://sso.contoso.com/adfs/ls`,) в диалоговом окне "Автоматическая настройка веб-сайта на основе форм" и нажмите кнопку " **ОК**".
...
7. В диалоговом окне "Добавление веб-сайта на основе форм" введите URL-адрес страницы AD FS входа в поле URL-адрес `https://sso.contoso.com/adfs/ls`для отправки (например,) и введите имя приложения (необязательно). Имя приложения отображается в отчетах сервера Многофакторной идентификации Azure. Кроме того, оно может отображаться в SMS-сообщениях и сообщениях о проверке подлинности мобильного приложения.
