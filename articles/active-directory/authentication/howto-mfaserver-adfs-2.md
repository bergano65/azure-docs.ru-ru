...
4. Введите IP-адрес, диапазон IP-адресов или подсети, которые должны быть разрешены. Указывая подсеть, выберите соответствующую маску сети и нажмите кнопку **ОК**.
