...
7. В диалоговом окне "Добавление веб-сайта на основе форм" введите URL-адрес страницы AD FS входа в поле URL-адрес для отправки (например, `https://sso.contoso.com/adfs/ls` ) и введите имя приложения (необязательно). Имя приложения отображается в отчетах сервера Многофакторной идентификации Azure. Кроме того, оно может отображаться в SMS-сообщениях и сообщениях о проверке подлинности мобильного приложения.
