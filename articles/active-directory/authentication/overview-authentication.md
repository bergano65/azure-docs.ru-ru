---
title: Проверка подлинности и обеспечение безопасности пользователей в Azure Active Directory
...
Существует множество сценариев, включая вход в приложение, сброс пароля, включение Windows Hello и другие действия, для выполнения которых вашим пользователям нужно пройти дополнительную проверку подлинности.
...
См. дополнительные сведения в [руководстве по самостоятельному сбросу пароля в Azure AD](concept-sspr-howitworks.md).

См. дополнительные сведения в [руководстве по Многофакторной идентификации Azure](concept-mfa-howitworks.md).
