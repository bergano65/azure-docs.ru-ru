...
5. PowerShell запросит ваш идентификатор клиента. Используйте *идентификатор GUID идентификатора клиента* , скопированный из портал Azure в разделе Предварительные требования.
