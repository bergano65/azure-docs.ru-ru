...
Расширение NPS для многофакторной идентификации Azure AD доступно клиентам с [лицензиями на многофакторную идентификацию Azure AD](./concept-mfa-howitworks.md). Лицензии на основе потребления для многофакторной идентификации Azure AD, например для каждого пользователя или лицензии на проверку подлинности, несовместимы с расширением NPS.
