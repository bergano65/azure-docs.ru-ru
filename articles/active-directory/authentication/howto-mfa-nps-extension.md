...
4. Следуйте дальнейшим указаниям мастера, пока не перейдете к странице подтверждения. Нажмите кнопку **Установить**.
...
1. Перейдите к `HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\AzureMfa`. Задайте следующие значения ключей:
