...
1. Настройте новый профиль со следующими параметрами:
   ...
   - Настраиваемые параметры OMA-URI:
      ...
      - Значение: 1
1. Эту политику можно назначить конкретным пользователям, устройствам или группам. Дополнительные сведения см. [в разделе Назначение профилей пользователей и устройств в Microsoft Intune](https://docs.microsoft.com/intune/device-profile-assign).
...
Для **гибридных устройств, присоединенных к Azure AD**, организации могут настроить следующий параметр Групповая политика, чтобы включить вход ключа безопасности Fido. Этот параметр можно найти в разделе **Конфигурация** > **компьютера Административные шаблоны** > **Вход** > в**систему** > **Включение ключа безопасности**.
