...
Для **гибридных устройств, присоединенных к Azure AD**, организации могут настроить следующий параметр Групповая политика, чтобы включить вход ключа безопасности Fido. Параметр можно найти в разделе **Computer Configuration** > **административные шаблоны** > **System** > **logon** > включить вход с помощью **ключа безопасности**:
