...
1. Действия на странице **Способы проверки подлинности**
   ...
   * Выберите **методы, доступные пользователям**  организации, которые необходимо разрешить. В этом руководстве установите флажки, чтобы включить параметры **Электронная почта** и **Код мобильного приложения (предварительная версия)**.
   * Нажмите кнопку **Сохранить**
