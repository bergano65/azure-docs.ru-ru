---
title: Самостоятельный сброс пароля глубокое погружение, Azure Active Directory
...
![Выбор методов проверки подлинности на портале Azure][Authentication]
...
![Проверка обратной записи паролей включена и работает][Writeback]
