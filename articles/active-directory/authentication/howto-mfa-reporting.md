...
| SUCCESS_FALLBACK_SECURITY_QUESTIONS_ANSWERED | Получены ответы на резервные секретные вопросы | Пользователю было отказано в проверке подлинности с помощью основного метода многофакторной проверки подлинности, а затем правильно получены ответы на контрольные вопросы. |
