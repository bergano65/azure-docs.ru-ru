...
**Необходимость многофакторной проверки подлинности.** Требуется ли многофакторная проверка подлинности при входе в систему. ОНА может потребоваться из-за каждого пользователя многофакторной проверки Подлинности, условный доступ или по другим причинам. Возможные значения: **Да** или **нет**.
...
**Условный доступ** найти сведения о политиках условного доступа, которые затронуты попытки входа в том числе:
