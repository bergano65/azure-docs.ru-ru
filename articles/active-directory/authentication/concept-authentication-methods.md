...
После правильного форматирования в виде CSV-файла администратор может войти в портал Azure, перейдите к **Azure Active Directory** > **безопасность** > **MFA** > **OATH**-файлы и отправьте полученный CSV-файл.
