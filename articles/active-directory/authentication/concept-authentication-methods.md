...
description: Методы проверки подлинности, доступных в Azure AD для многофакторной проверки Подлинности и SSPR
...
### <a name="troubleshooting-phone-options"></a>Устранение неполадок Параметры телефона

Распространенные проблемы, связанные с методы проверки подлинности, используя номер телефона:

* Идентификатор заблокированного звонящего на одном устройстве
   * Устранение неполадок устройства
* Неверный номер телефона, код неверные страны, номер домашнего телефона и номер рабочего телефона
   * Устранение неполадок объекта пользователя и настроить методы проверки подлинности. Убедитесь, что зарегистрированы верного телефонного номера.
* Неправильный ПИН-код введен
   * Убедитесь, что пользователь использовал правильный ПИН-код, зарегистрированные на сервере Azure MFA.
* Звонок, переадресованный голосовой почты
   * Убедитесь, у пользователя есть телефона включен и что служба доступна на своей территории или использовать другой метод.
* Пользователь заблокирован
   * Попросите администратора разблокировать пользователя на портале Azure.
* SMS не подписана на устройстве
   * Попросите пользователя изменить методы или активировать SMS на устройстве.
* Поставщики неисправного затратами на телекоммуникации (нет ввода в телефоне найден проблемы сигналы DTMF, заблокированных Звонящего на нескольких устройствах или заблокирован SMS на нескольких устройствах)
   * Корпорация Майкрософт использует несколько поставщиков затратами на телекоммуникации маршрутизировать телефонные звонки и SMS-сообщения для проверки подлинности. Если возникают проблемы, описанные выше имеют при попытке пользователем метод по крайней мере 5 раз в течение пяти минут и быть доступна информация пользователя в том случае, при обращении в службу поддержки Майкрософт.
