...
**Вопрос. что следует сказать пользователям, если они не получили ответ на свой телефон?**
...
Мы не можем гарантировать доставку сообщений и получение ответов в рамках двухстороннего обмена текстовыми сообщениями, так как надежность этой услуги зависит от неконтролируемых факторов. К таким факторам относятся страна или регион назначения, оператор мобильного телефона и сила сигнала.
...
Если вы вынуждены использовать текстовые сообщения, мы рекомендуем по мере возможности использовать односторонний, а не двусторонний обмен текстовыми сообщениями. Односторонний SMS является более надежным и не позволяет пользователям, не связанным с глобальной системой SMS, отвечать на текстовые сообщения, отправленные из другой страны или региона.
...
* В [базе знаний службы технической поддержки Майкрософт](https://www.microsoft.com/en-us/search?form=mssupport&q=phonefactor&rtc=1) можно искать решения распространенных технических проблем.
