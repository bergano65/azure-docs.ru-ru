...
**Вопрос. пользователи говорят, что иногда они не получают текстовое сообщение или время ожидания проверки истекает.**

Доставка SMS-сообщений не гарантируется, так как существуют неконтролируемых факторы, которые могут повлиять на надежность службы. К таким факторам относятся страна или регион назначения, оператор мобильного телефона и сила сигнала.
