...
1. Вам будет предложено **развернуть существующее приложение** или **разработать новое**. Ниже описано, чем эти параметры отличаются и как их использовать.
...
1. Вот и все! Вам больше не нужно знать все о приложении. Теперь вы в любое время можете настроить работу нового приложения, используя меню слева.
...
1. Щелкните **ссылку добавления собственных ресурсов** в коллекции приложений и выберите **разработку существующего приложения**. Отобразится ссылка для быстрого перехода.
...
1. Поддержка этих новых режимов проверки подлинности теперь включает возможность отправки сертификатов из пользовательских доменов для поддержки приложений, работающих на защищенных корпоративных конечных точках.  
...
1. Чтобы отправить новый сертификат для локального приложения, щелкните **Прокси приложения** в меню навигации слева, щелкните средство выбора **сертификатов** и передайте файл сертификата, который можно использовать для шифрования запросов, отправляемых из облачной конечной точки в приложение.
...
1. В этой же колонке установите флажок в разделе **Атрибуты пользователя**, чтобы изменить все атрибуты, включенные в маркер SAML, который передается этому приложению.
...
1. Отобразится набор новых полей для ввода URL-адресов, в которых можно настроить этот параметр и другие параметры URL-адресов SAML.
...
1. Теперь этот URL-адрес будет автоматически использоваться для ввода имени пользователя и пароля и позволит использовать Azure AD для безопасной передачи паролей в приложение с помощью панели доступа в расширении обозревателя.
