...
С помощью отчетов о безопасности в Azure Active Directory (Azure AD) можно получить ценную информацию о наличии скомпрометированных учетных записей пользователей в вашей среде. "Пользователь, находящийся в группе риска" означает, что безопасность учетной записи пользователя, возможно, была нарушена.
...
Дополнительные сведения см. в статье [Описание отчета системы безопасности о пользователях под угрозой на портале Azure Active Directory](concept-user-at-risk.md).
...
1.  [Проверьте](https://aka.ms/MFAValid) правильность сведений для многофакторной проверки подлинности и самостоятельного сброса пароля. 
2.  [Включите](https://aka.ms/MFAuth) многофакторную проверку подлинности для всех пользователей. 
3.  Используя этот [сценарий исправления](https://aka.ms/remediate) для каждой затронутой учетной записи, можно автоматически выполнить действия ниже. 
...
- Ознакомьтесь с этим [руководством](https://aka.ms/fixaccount) по мерам, предпринимаемым в случае обнаружения необычной активности, и выполните описанные в нем шаги. 
- [Включите конвейер аудита](https://aka.ms/improvesecurity) для анализа действий в своем клиенте. После завершения анализа журналы действий в хранилище аудита начнут заполняться соответствующими данными. На этом этапе вы также можете использовать возможность [поиска и исследования в центре безопасности и соответствия требованиям](https://aka.ms/sccsearch). 
- Используйте этот [сценарий](https://aka.ms/mailboxaudit1), чтобы включить аудит почтовых ящиков для всех учетных записей. 
