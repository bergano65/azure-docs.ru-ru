...
Вы можете просмотреть пользователей, находящихся в группе риска, в [соответствующем отчете](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/UsersAtRisk) на портале Azure. Если у вас нет Azure AD, вы можете бесплатно зарегистрироваться на сайте [https://aka.ms/AccessAAD](https://aka.ms/AccessAAD). 
...
1.  [Проверьте правильность сведений](http://aka.ms/MFAValid) для многофакторной проверки подлинности и самостоятельного сброса пароля. 
2.  [Включите многофакторную проверку подлинности](http://aka.ms/MFAuth) для всех пользователей. 
3.  Используйте этот [сценарий исправления](http://aka.ms/remediate) для каждой затронутой учетной записи, чтобы автоматически выполнить действия ниже: 
...
- Ознакомьтесь с этим [руководством по мерам, предпринимаемым в случае обнаружения необычной активности](http://aka.ms/fixaccount), и выполните описанные в нем шаги. 
- [Включите конвейер аудита](http://aka.ms/improvesecurity) для анализа действий в своем клиенте. После завершения анализа журналы действий в хранилище аудита начнут заполняться соответствующими данными. На этом этапе вы также можете использовать [ресурс поиска и исследования в центре безопасности и соответствия требованиям](http://aka.ms/sccsearch). 
- Используйте этот [сценарий для включения аудита почтовых ящиков](http://aka.ms/mailboxaudit1) для всех учетных записей. 
