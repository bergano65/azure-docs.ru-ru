...
В качестве альтернативы использования портала Azure для доступа к данным входа можно также использовать [API отчетов](concept-reporting-api.md).
...
Дополнительные сведения см. в статье [Отчеты о действиях входа на портале Azure Active Directory](concept-sign-ins.md).
