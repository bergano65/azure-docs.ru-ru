...
|50005|Пользователь выполнил попытку входа на устройство с платформу, которая в настоящее время не поддерживается с помощью политики условного доступа.|
...
|53002|Приложение, не утвержденные приложения для условного доступа. Чтобы получить доступ, пользователю нужно использовать одно из приложений из списка утвержденных.|
|53003|Доступ заблокирован из-за политики условного доступа.|
...
|500021|Запрещено, прокси-сервер организации. Запрет доступа к ресурсам.|
