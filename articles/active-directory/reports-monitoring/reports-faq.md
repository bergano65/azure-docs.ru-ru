...
**Вопрос. Какие возможны значения состояния условного доступа?**
...
**Вопрос. Какие возможны значения результата политики условного доступа?**
...
**Ответ.** В настоящее время в отчете о входе в систему могут отображаться неточные данные для сценариев с Exchange ActiveSync при применении условного доступа. Могут возникать ситуации, когда в отчете отображается успешный вход в систему, но фактически вход выполнен не был из-за политики условного доступа. 
