...
Ответ **.** Используйте [API управления office 365](/office/office-365-management-api/office-365-management-apis-overview) для доступа к журналам действий Office 365 через API.
