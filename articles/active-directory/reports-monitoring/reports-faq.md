...
**Ответ.** Если вас уже есть данные действий с бесплатной лицензией, то вы увидите их немедленно. Если данные отсутствуют, то для отображения данных в отчетах потребуется до 3 дней.
...
* **Не применяется**: это означает, что политика условного доступа с пользователем и приложением в области отсутствует. 
* **Успешно**. Это означает, что существовала политика условного доступа с пользователем и приложением в области, а политики условного доступа успешно удовлетворены. 
...
Ответ **.** Имя политики в отчете о входе в систему основано на имени политики условного доступа во время входа. Оно может отличаться от имени политики в службе условного доступа, если вы изменили имя политики после входа в систему.
