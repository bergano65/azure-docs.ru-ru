...
3. Выберите представления, скачанные для выполнения необходимых требований, а затем щелкните **Сохранить**, чтобы сохранить импортированные элементы. Сделайте это для представлений **Azure AD Account Provisioning Events** (События подготовки учетных записей Azure AD), **Sign-ins Events** (События входа в систему) и **Users Performing Consent** (Пользователи, дающие согласие).
