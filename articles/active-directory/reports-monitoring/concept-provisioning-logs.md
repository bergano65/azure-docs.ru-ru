...
|интерналеррор |Произошла внутренняя ошибка службы в службе подготовки Azure AD. Ничего делать не нужно. Эта попытка будет автоматически повторена через 40 минут.|
