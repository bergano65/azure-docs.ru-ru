...
- **Действие** 
    ...
    - **Журналы аудита —** это сведения о системных действиях для пользователей и управления группами, управляемых приложений и действий с каталогами.[Audit logs](concept-audit-logs.md)  - 
