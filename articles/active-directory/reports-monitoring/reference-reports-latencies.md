...
| Report | Задержка 95-го процентиля |Задержка 99-го процентиля|
| :-- | --- | --- |
...
| Report | Минимальные требования | Среднее | Максимальная |
| :-- | --- | --- | --- |
| Пользователи, подверженные риску          | 5 мин   | 15 минут  | 2 часа  |
| Вход, представляющий риск         | 5 мин   | 15 минут  | 2 часа  |
...
| Report | Минимальные требования | Среднее | Максимальная |
| :-- | --- | --- | --- |
| Попытки входа с анонимных IP-адресов |5 мин |15 минут |2 часа |
| Попытки входа из неизвестных расположений |5 мин |15 минут |2 часа |
