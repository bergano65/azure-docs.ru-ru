...
В следующей таблице перечислены отчеты безопасности Azure AD об аномальных действиях и соответствующие типы обнаружения рисков в портал Azure. Дополнительные сведения см. в разделе [Azure Active Directory обнаружения рисков](concept-risk-events.md).  
