...
После [ интеграции журналов действий Azure AD с Log Analytics ](howto-integrate-activity-logs-with-log-analytics.md), вы можете использовать возможности Log Analytics, чтобы получить полезные сведения в своей среде. Вы также можете установить [представления Log Analytics для журналов действий Azure AD ](howto-install-use-log-analytics-views.md), чтобы получить доступ к предварительно созданным отчетам о событиях аудита и входа в вашу среду.
