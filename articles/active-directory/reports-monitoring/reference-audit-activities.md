...
|Administrative Unit Management (Управление административной единицей)|Загрузить все типы обнаружения рисков|
|Administrative Unit Management (Управление административной единицей)|Скачать бесплатное обнаружение рисков пользователей|
...
|Управление группами|Массовые Скачать членов группы - запущен|
|Управление группами|Массовые Скачать членов группы - закончено|
|Управление группами|Массовые члены группы импорта - запущен|
|Управление группами|Массовые члены группы импорта - закончено|
|Управление группами|Массовое удаление членов группы - запущено|
|Управление группами|Массовое удаление членов группы - закончено|
|Управление группами|Массовые группы загрузки - запущен|
|Управление группами|Массовые группы загрузки - закончено|
...
|Управление пользователями|Массовые создавать пользователей - запущен|
|Управление пользователями|Массовые создавать пользователей - закончено|
|Управление пользователями|Массовое удаление пользователей - запущено|
|Управление пользователями|Массовое удаление пользователей - закончено|
|Управление пользователями|Массовые пользователи загрузки - запущен|
|Управление пользователями|Массовые пользователи загрузки - закончено|
|Управление пользователями|Массовое восстановление удаленных пользователей - запущено|
|Управление пользователями|Массовое восстановление удаленных пользователей - закончено|
|Управление пользователями|Массовые приглашают пользователей - запущен|
|Управление пользователями|Массовые приглашают пользователей - закончено|
