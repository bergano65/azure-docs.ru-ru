...
| Обновление может завершиться ошибкой из-за больших наборов данных. | В настоящее время пакет содержимого Azure AD с Power BI может поддерживать только небольшие наборы данных (менее 500 000 строк) из-за ограничений, связанных с временем ожидания в службе Power BI. Если возникли ошибки регулирования или обновление завершилось сбоем из-за проблем с временем ожидания, это может быть вызвано попыткой получить большой набор данных. Сократите период времени в запросе и повторите попытку.|
