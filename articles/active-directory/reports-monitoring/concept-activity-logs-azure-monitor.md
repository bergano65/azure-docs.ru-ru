...
ms.locfileid: "68989888"
---
# <a name="azure-ad-activity-logs-in-azure-monitor"></a>Журналы действий Azure AD в Azure Monitor

Вы можете направить журналы действий Azure Active Directory (Azure AD) в несколько конечных точек для долгосрочного хранения и аналитики данных. Эта функция позволяет:
...
| Входов | 1000 | 34 800 | 4 ГБ | 0,13 долл. США | 1,56 долл. США |
| Входов | 100 000 | 15&nbsp;млн | 1,7 TБ | 35,41 долл. США | 424,92 долл. США |
...
| Входов | 1000 | 178 | 53 400 | 106,8&nbsp;MB | 418 | 3 611 520 | 11,06 долл. США |  
...
| Входов           | 100 000         | 15 000 000     | 450 000 000                |  $847,28                     |
...
**Вопрос. Через какое время после выполнения действия соответствующие журналы отобразятся в Центре событий?**

**Ответ**. Журналы должны появляться в Центре событий в течение 2–5 минут после выполнения действия. Дополнительные сведения о Центрах событий см. в статье [Что такое Центры событий Azure?](../../event-hubs/event-hubs-about.md)
...
**Вопрос. Сколько будет стоить потоковая передача данных в Центры событий?**
