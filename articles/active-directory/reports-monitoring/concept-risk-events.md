...
![Событие риска](./media/concept-risk-events/91.png)
...
### <a name="sign-ins-from-ip-addresses-with-suspicious-activity"></a>Входы с IP-адресов с подозрительными действиями
...
| [Входы в систему с анонимных IP-адресов](#sign-ins-from-anonymous-ip-addresses) | Реальное время |
| [Невозможно переместиться в нетипичные расположения](#impossible-travel-to-atypical-locations) | Не в сети |
| [Входы в систему из необычного расположения](#sign-in-from-unfamiliar-locations) | Реальное время |
