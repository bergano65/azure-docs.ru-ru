...
ms.locfileid: "46364409"
---
# <a name="what-are-azure-active-directory-reports"></a>Что такое отчеты в Azure Active Directory

Отчеты Azure Active Directory предоставляют важные сведения о том, как работает ваша среда.  
...
**Отчет о журналах аудита** предоставляет записи системных операций для соответствия. Эти данные позволяют реализовать наиболее распространенные сценарии, примеры которых перечислены ниже.
