...
Журналы аудита Azure AD содержат записи о действиях системы (необходимые для соответствия требованиям). Чтобы получить доступ к отчету аудита, выберите **Журналы аудита** в разделе **Действие** в **Azure Active Directory**. Обратите внимание, что журналы аудита могут иметь задержку до часа, поэтому для отображения данных о действиях аудита на портале после завершения задачи может потребоваться длительное время.
