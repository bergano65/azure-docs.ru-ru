---
title: Руководство. Интеграция существующего и нового лесов с одним арендатором Azure AD с помощью облачной синхронизации Azure AD Connect.
description: Узнайте о добавлении функции облачной синхронизации в имеющуюся среду гибридной идентификации.
...
![Создание](media/tutorial-existing-forest/existing-forest-new-forest-2.png)
...
В этом сценарии есть существующий лес, синхронизированный с клиентом Azure AD с помощью Azure AD Connect. У вас есть новый лес, который нужно синхронизировать с тем же самым клиентом Azure AD. Вы настроите облачную синхронизацию для нового леса. 
...
3. Слева выберите **Azure Active Directory**, щелкните **Azure AD Connect** и в центре выберите **Manage cloud sync** (Управление облачной синхронизацией).</br>
