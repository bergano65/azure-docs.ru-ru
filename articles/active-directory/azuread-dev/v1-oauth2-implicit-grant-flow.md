...
В спецификации OAuth2 неявное предоставление OAuth2 известно по наибольшему количеству проблем, связанных с безопасностью. Но именно этот подход, реализуемый с использованием библиотеки аутентификации Active Directory для JavaScript, рекомендуется использовать при написании одностраничных приложений. Что это дает? Это все зависит от компромиссов: и, как оказалось, неявное предоставление — это лучший подход, который можно использовать для приложений, использующих веб-API через JavaScript, из браузера.
