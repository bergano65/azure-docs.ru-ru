...
* Azure AD является поставщиком удостоверений. Поставщик удостоверений отвечает за проверку подлинности пользователей и приложений, которые существуют в каталоге Организации, и выдает маркеры безопасности при успешной проверке личности этих пользователей и приложений.
...
* После проверки подлинности пользователя приложение должно проверить маркер безопасности пользователя, чтобы убедиться, что проверка подлинности прошла успешно. Можно найти краткие руководства, учебники и примеры кода на различных языках и платформах, в которых показано, что должно делать приложение.
...
|[Активация маркера обновления](v1-protocols-oauth-code.md#refreshing-the-access-tokens) | маркер обновления | x | x | x| |
...
| Имя субъекта-пользователя | Содержит имя участника-пользователя субъекта. |
