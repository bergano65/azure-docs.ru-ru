...
Предполагается знание приложений с [одним и несколькими клиентами](../develop/howto-convert-app-to-be-multi-tenant.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json) и [распространенными шаблонами проверки подлинности](v1-authentication-scenarios.md) .
