...
| Служба | Руководство |
| ------- | -------- |
| Служебная шина Azure | [Миграция на подписанные URL](../../service-bus-messaging/service-bus-migrate-acs-sas.md) |
...
![На этом рисунке показана проверка связи с логотипом проверки связи с помощью службы ](./media/active-directory-acs-migration/rsz-ping.png)
 [Ping Identity](https://www.pingidentity.com) ACS. Пингоне — это облачная служба идентификации, которая поддерживает многие функции ACS, а PingFederate — аналогичный продукт с локальным удостоверением, обеспечивающий большую гибкость. Дополнительные сведения по их использованию см. в [этом руководстве](https://www.pingidentity.com/en/company/blog/posts/2017/migrating-from-microsoft-acs-to-ping-identity.html).
