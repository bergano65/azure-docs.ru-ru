...
При использовании автоматической подготовки пользователей в приложении Azure AD автоматически подготавливает и обновляет учетные записи пользователей в приложении на основе таких объектов, как [Назначение пользователей и групп](assign-user-or-group-access-portal.md) в регулярно запланированном интервале времени, обычно каждые 40 минут.
