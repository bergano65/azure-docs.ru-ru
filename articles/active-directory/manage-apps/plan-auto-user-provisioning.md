...
| Часто задаваемые вопросы| [Часто задаваемые вопросы](https://docs.microsoft.com/azure/active-directory/manage-apps/user-provisioning) о автоматической подготовке пользователей |
