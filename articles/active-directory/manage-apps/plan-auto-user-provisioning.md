...
* [Система для управления междоменными удостоверениями (scim)](http://www.simplecloud.info/)) — Открытый стандарт, позволяющий автоматизировать подготовку пользователей. SCIM передает данные удостоверений пользователей между поставщиками удостоверений, такими как Майкрософт, а также поставщиками услуг, такими как Salesforce или другие приложения SaaS, для которых требуются сведения об удостоверении пользователя.
