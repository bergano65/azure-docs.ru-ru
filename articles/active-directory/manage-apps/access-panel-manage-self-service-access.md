...
ms.locfileid: "88641795"
---
# <a name="how-to-use-self-service-application-access"></a>Использование самостоятельного доступа к приложениям

Прежде чем пользователи смогут самостоятельно обнаруживать приложения из папки "Мои приложения", необходимо включить **самостоятельный доступ** к приложениям, чтобы пользователи могли самостоятельно обнаруживать и запрашивать доступ к службам.
