...
Кроме того, **Если вы работаете с поставщиком этого приложения,** **отправьте их** по адресу, чтобы мы могли работать с ними, чтобы интегрировать приложение с Azure Active Directory. Для начала можете отправить разработчику приложения ссылку на статью [Добавление приложения в коллекцию приложений Azure Active Directory](../azuread-dev/howto-app-gallery-listing.md).
