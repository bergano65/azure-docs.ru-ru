---
title: Проблемы при настройке единого входа с паролем для приложения из коллекции Azure AD
...
**Если вы работаете с поставщиком приложения**, отправьте ему наши рекомендации, чтобы корпорация Майкрософт смогла интегрировать его приложение в Azure Active Directory. Для начала можете отправить разработчику приложения ссылку на статью [Добавление приложения в коллекцию приложений Azure Active Directory](../azuread-dev/howto-app-gallery-listing.md).
...
Кроме того, **если вы работаете с поставщиком приложения, ** **отправьте ему наши рекомендации**, чтобы мы смогли интегрировать его приложение в Azure Active Directory. Для начала можете отправить разработчику приложения ссылку на статью [Добавление приложения в коллекцию приложений Azure Active Directory](../azuread-dev/howto-app-gallery-listing.md).
...
7.  Войдите на панель доступа и проверьте, можно ли **запустить** приложения единого входа с помощью пароля.
