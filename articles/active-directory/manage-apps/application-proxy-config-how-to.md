...
description: Узнайте, как создать и настроить приложение APplication Proxy в несколько простых шагов
...
Эта статья поможет вам понять, как настроить приложение Application Proxy в Azure AD, чтобы вывести ваши приложения в облаке.
...
Сообщение об ошибке должно отображаться в правом верхнем углу при создании приложения. Для просмотра сообщений об ошибках также можно выбрать значок уведомления.

![Показывает, где найти запрос уведомления на портале Azure](./media/application-proxy-config-how-to/error-message.png)
...
Сообщение об ошибке отображается в правом верхнем углу при попытке загрузить сертификат. Для просмотра сообщений об ошибках также можно выбрать значок уведомления.
