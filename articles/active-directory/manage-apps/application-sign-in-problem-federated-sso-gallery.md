---
title: Проблемы при входе в настроенные приложения единого входа на основе SAML
...
ms.locfileid: "94357918"
---
# <a name="problems-signing-in-to-saml-based-single-sign-on-configured-apps"></a>Проблемы при входе в настроенные приложения единого входа на основе SAML
...
Если вы используете [опыт тестирования](../azuread-dev/howto-v1-debug-saml-sso-issues.md) в портал Azure с расширением "Защищенный браузер" Мои приложения ", вам не нужно вручную выполнять указанные ниже действия, чтобы открыть страницу настройки единого входа на основе SAML.

Чтобы открыть страницу конфигурации единого входа на основе SAML, выполните следующие действия.
...
1. Выберите единый вход на основе SAML.
...
- [Требования к протоколу SAML единого входа в Azure](../develop/active-directory-single-sign-on-protocol-reference.md)
