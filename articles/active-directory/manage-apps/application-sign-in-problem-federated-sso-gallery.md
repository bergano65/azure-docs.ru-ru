...
- Установите [расширение "Мои приложения" для безопасного браузера](./access-panel-deployment-plan.md) , чтобы помочь Azure Active Directory (Azure AD), чтобы обеспечить лучшую диагностику и разрешения при использовании тестирования в портал Azure.
- Воспроизведите ошибку с помощью интерфейса тестирования на странице настройки приложения в портал Azure. Дополнительные сведения об [отладке приложений единого входа на основе SAML](./debug-saml-sso-issues.md)
