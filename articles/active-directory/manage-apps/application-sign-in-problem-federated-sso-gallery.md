...
1.  На панели **Добавление назначения** выберите элемент Выбор **пользователей и групп** .
