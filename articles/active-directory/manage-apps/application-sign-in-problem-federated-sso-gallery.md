...
1.  После загрузки приложения щелкните **Базовая конфигурация SAML**. Проверьте или обновите значение в текстовом поле URL-адрес ответа, чтобы оно совпадало со `AssertionConsumerServiceURL` значением в запросе SAML.    
