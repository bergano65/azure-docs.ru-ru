---
title: Проблемы при настройке федеративного единого входа для приложений из коллекции Azure AD | Документация Майкрософт
...
Если значения не совпадают с шаблонами, предварительно настроенными в Azure AD. Можно выполнить следующие действия:
