---
title: Проблемы настройки федеративного SSO для приложений Azure AD Gallery
...
1. Откройте [**портал Azure**](https://portal.azure.com/) и вопийте в качестве **глобального администратора** или **коадминистратора.** Перейти к шагу 7. Если вы уже находитесь в колонке настройки приложения в Azure AD.
