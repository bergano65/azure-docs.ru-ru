...
При регистрации для клиента Azure AD, регион клиента определяется по странам и регионам, указанную вами. Когда вы включаете прокси приложения, экземпляры службы прокси приложения для вашего клиента выбираются или создаются в том же регионе, где находится клиент Azure AD, или в ближайшем к нему регионе.
...
![Схема, показывающая пользователи, прокси, соединитель и приложение находятся в США.](./media/application-proxy-network-topology/application-proxy-pattern1.png)
...
![Пользователи распределены по всему миру, но все остальное в США.](./media/application-proxy-network-topology/application-proxy-pattern2.png)
...
![Схеме показаны пользователи и прокси-сервера в США, соединитель и приложение — в ЕС](./media/application-proxy-network-topology/application-proxy-pattern5b.png)
...
![Схеме показаны пользователи, прокси-сервер и соединитель в США, а приложение — в ЕС](./media/application-proxy-network-topology/application-proxy-pattern5c.png)
