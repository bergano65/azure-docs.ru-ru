...
Azure AD упрощает процесс управления приложениями, предоставляя единую систему идентификации для облачных и локальных приложений. В Azure AD можно добавить приложения SaaS, локальные приложения и бизнес-приложения. Затем пользователи однократно выполняют вход, чтобы получить безопасный и простой доступ к этим приложениям, а также Microsoft 365 и другим бизнес-приложениям от корпорации Майкрософт. [Автоматизация подготовки пользователей](../app-provisioning/user-provisioning.md) позволяет сократить расходы на администрирование. Вы также можете использовать многофакторную проверку подлинности и политики условного доступа для обеспечения безопасного доступа к приложениям.
