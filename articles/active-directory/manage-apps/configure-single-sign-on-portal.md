...
2. Прокрутите страницу до раздела **Validate single sign-on with (Проверка единого входа с помощью) \<applicationName>** . В этом руководстве этот раздел называется **Настройка GitHub-test**.
