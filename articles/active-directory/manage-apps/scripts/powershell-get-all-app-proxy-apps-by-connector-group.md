...
description: Пример PowerShell, в который перечислены все группы прокси-серверов azure Active Directory (Azure AD) с назначенными приложениями.
...
---
# <a name="get-all-application-proxy-apps-and-list-by-connector-group"></a>Получить все приложения Прокси и список по разъемгруппе группы

В этом примере сценария PowerShell приводится список информации обо всех группах прокси-серверов azure Active Directory (Azure AD) с назначенными приложениями.
