...
---
# <a name="get-all-application-proxy-apps-using-custom-domains-and-certificate-information"></a>Получение всех приложений прокси приложения, использующих личные домены и сведения о сертификате
