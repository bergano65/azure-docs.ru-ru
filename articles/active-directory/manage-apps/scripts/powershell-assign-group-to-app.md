...
| Get-Help | Примечания |
|---|---|
| [New-Азуреадграупаппролеассигнмент](https://docs.microsoft.com/powershell/module/AzureAD/New-azureadgroupapproleassignment?view=azureadps-2.0) | Назначает группу роли приложения. |
