---
title: Образец PowerShell - Список приложений прокси-приложений с использованием подстановочных знаков
description: Пример PowerShell, в который перечислены все прокси-приложения приложения Azure Active Directory (Azure AD), использующие подстановочные карты.
...
---
# <a name="get-all-application-proxy-apps-using-wildcard-publishing"></a>Получите все приложения Application Proxy с помощью публикации подстановочных знаков

В этом примере скрипта PowerShell перечислены все прокси-приложения Azure Active Directory (Azure AD), использующие публикацию подстановочных знаков.
