...
4. Здесь работу можно продолжить несколькими способами:
   ...
   * Проверьте неактивный соединитель. Если соединитель отображается как неактивный, значит ему не удалось подключиться к службе. Обычно эта ошибка возникает, потому что заблокированы некоторые необходимые порты. Для решения проблемы перейдите к пункту с проверкой внесения нужных портов в список разрешений.
