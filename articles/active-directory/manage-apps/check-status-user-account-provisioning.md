...
* Время последнего запуска синхронизации. Синхронизация обычно происходит каждые 20-40 минут после завершения [начального цикла](how-provisioning-works.md#provisioning-cycles-initial-and-incremental) .
* Указывает, завершен ли [начальный цикл](how-provisioning-works.md#provisioning-cycles-initial-and-incremental) .
