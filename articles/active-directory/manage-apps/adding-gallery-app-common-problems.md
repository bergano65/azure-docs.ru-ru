...
6.  Щелкните значок **копирования** **icon** справа от текстового поля **Копировать ошибку** , чтобы скопировать все сведения об уведомлении для совместного использования с инженером отдела поддержки или группы продуктов.
