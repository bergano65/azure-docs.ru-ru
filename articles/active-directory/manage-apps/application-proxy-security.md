...
>[!NOTE]
>Все связи осуществляются по протоколу TLS и всегда создаются в соединителе для службы прокси приложения. В службе используются только исходящие соединения.
