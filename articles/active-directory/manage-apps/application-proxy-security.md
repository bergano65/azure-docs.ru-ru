...
2. Служба прокси приложения оценивает этот маркер. Он проверяет, является ли пользователь глобальным администратором в клиенте.  Если пользователь не является администратором, процесс завершается.
