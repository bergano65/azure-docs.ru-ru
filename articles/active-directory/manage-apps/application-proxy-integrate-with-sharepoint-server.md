...
> [!NOTE]
> Соблюдайте следующие рекомендации для внутренний URL-адрес:
...
1. Выберите сайт, например **SharePoint — 80**. Пока для зоны экстрасети не настроен правильный внутренний URL-адрес:
   ...
   ![Отображает окно сопоставления для альтернативного доступа](./media/application-proxy-integrate-with-sharepoint-server/alternate-access1.png)
