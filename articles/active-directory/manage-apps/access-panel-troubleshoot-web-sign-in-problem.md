...
-   Убедитесь, что пользователь впишется в **правильный URL:**<https://myapps.microsoft.com>
...
7. После загрузки **портала Multi-Factor Authentication Administration Portal** убедитесь, что вы находитесь на вкладке **пользователей.**
