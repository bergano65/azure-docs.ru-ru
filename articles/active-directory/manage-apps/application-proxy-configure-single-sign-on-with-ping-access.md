...
1. Выберите **Azure Active Directory** > **прокси приложения** > **скачать службу соединителя**. Откроется страница **скачивания соединителя прокси приложения** .
...
1. На боковой панели приложения выберите **Пользователи и группы** > **Добавить** пользователей > **пользователей и группы (\<число > выбрано)** . Отобразится список пользователей и групп.
...
1. На боковой панели приложения выберите **единый вход** > **на основе заголовка**.
...
1. Выберите **разрешения приложения** > **приложение** > **приложение. ReadWrite. ALL**.
1. Выберите **Добавить разрешения**.
1. На странице **разрешения API** выберите параметр **предоставить согласие администратора для \<имя каталога >** .
