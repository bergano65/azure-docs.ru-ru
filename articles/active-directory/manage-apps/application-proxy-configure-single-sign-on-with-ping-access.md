...
1. Выберите **делегированные разрешения** > **User** > пользователь**пользователь. чтение**.
...
| --- | --- | --- |
| **Application (client) ID** (Идентификатор приложения (клиент)) | **Идентификатор клиента** | Идентификатор GUID |
| **Идентификатор каталога (клиент)** | **Поставщиков** | Идентификатор GUID |
