---
title: Пароль на основе одного входного (SSO) в панели доступа (ru) Документы Майкрософт
description: Обсуждается проблемные области, которые обеспечивают руководство по устранению неполадок, связанных с ввозами в приложения Azure AD Gallery, настроенные для единого входного знака.
