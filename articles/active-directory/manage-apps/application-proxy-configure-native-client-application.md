...
Опубликуйте приложение прокси, как любое другое приложение, и назначьте пользователей, имеющих доступ к вашему приложению. Дополнительные сведения см. в статье [Публикация приложений с помощью прокси приложения](application-proxy-add-on-premises-application.md).
...
| --- | --- |
| \<Идентификатор клиента> | **Azure Active Directory** > **Properties** > **Идентификатор каталога** свойств Azure Active Directory |
| \<Внешний URL-адрес приложения прокси> | **Корпоративные приложения** >  > . > **внешний URL-адрес** **прокси приложения***прокси*приложений |
...
| \<URI перенаправления собственного приложения> | **Azure Active Directory** > **App registrations**регистрация приложений > **URI перенаправления** *собственного приложения* >  |
| \<URL-адрес API прокси-приложения> | **Azure Active Directory** > **App registrations**регистрация приложений > интерфейс API > **разрешений***собственного приложения* > **или имя разрешения** |
