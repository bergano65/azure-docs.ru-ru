...
Прокси приложения Azure Active Directory (Azure AD) можно использовать для публикации веб-приложений, но его также можно использовать для публикации собственных клиентских приложений, настроенных с помощью Azure AD проверки подлинности Library (ADAL). Собственные клиентские приложения отличаются от веб-приложений, потому что они установлены на устройстве, а веб-приложения осуществляется через браузер.
