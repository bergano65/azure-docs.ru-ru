...
| ВОПРОСЫ И ОТВЕТЫ | [Автоматическая подготовка пользователей](user-provisioning.md#what-applications-and-systems-can-i-use-with-azure-ad-automatic-user-provisioning) |
