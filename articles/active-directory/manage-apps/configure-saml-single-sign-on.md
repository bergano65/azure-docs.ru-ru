...
> [!TIP]
> Многие приложения уже были предварительно настроены для работы с Azure AD. Эти приложения перечислены в коллекции приложений, которые можно просматривать при добавлении приложения в клиент Azure AD. Этот процесс описан в [серии](add-application-portal-setup-sso.md) быстрого запуска. Для приложений в коллекции можно просмотреть подробные сведения, пошаговые инструкции по настройке. Чтобы получить доступ к шагам, щелкните ссылку на странице конфигурации SAML для приложения, как описано в разделе Быстрый запуск, или просмотрите список всех руководств по настройке приложений в руководстве по [настройке приложений SaaS](../saas-apps/tutorial-list.md).
