---
title: Дополнительные параметры подписывания сертификата маркера SAML для предварительно интегрированных приложений Azure AD | Документация Майкрософт
...
1. На странице **Настройка единого входа с помощью SAML-Preview** найдите заголовок **сертификата подписи SAML** и щелкните значок **редактирования** (карандаш). Откроется страница « **сертификат подписи SAML** ».
   ...
   ![Пример Страница сертификата для подписи SAML](./media/certificate-signing-options/saml-signing-page.png)

1. В раскрывающемся списке **параметр подписывания** выберите команду **подписать ответ SAML**, **подписать утверждение SAML**или **подписать ответ SAML и утверждение**. Описания этих параметров приведены ранее в этой статье в разделе [Параметры подписи сертификатов](#certificate-signing-options).
