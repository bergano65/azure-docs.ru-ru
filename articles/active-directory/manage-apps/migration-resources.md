...
| [Планы развертывания](../fundamentals/active-directory-deployment-plans.md) | Дополнительные планы развертывания для других функций, таких как многофакторная проверка подлинности, условный доступ, подготовка пользователей, быстрый единый вход, самостоятельный сброс пароля и других. |
