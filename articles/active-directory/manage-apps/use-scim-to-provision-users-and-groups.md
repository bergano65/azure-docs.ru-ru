...
**Чтобы подключиться к приложению, поддерживающего SCIM:**
...
![][4]
*Рис. 4. Подготовка пользователей и отмену подготовки последовательности*
...
![][5]
*Рис. 5. Группы при подготовке и отзыве последовательности*
...
1. В меню **Режим подготовки к работе** выберите **Автоматический**.
   ...
   ![][2]
   *Рис. 6. Настройка автоматической подготовки пользователей на портале Azure*
