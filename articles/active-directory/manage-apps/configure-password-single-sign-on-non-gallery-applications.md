...
Один из доступных способов единого входа — это [единый вход по паролю](https://docs.microsoft.com/azure/active-directory/active-directory-appssoaccess-whatis). Функция **добавления приложений, не входящих в коллекцию** позволяет интегрировать любое приложение, которое отображает HTML-форму для ввода имени пользователя и пароля, даже если это приложение не входит в набор предварительно интегрированных приложений.
...
-   Разрешите **администратору** назначать пользователям имена для входа и пароли, используя функцию обновления учетных данных при назначении пользователей приложениям.
...
В следующем разделе описывается, как включить [единый вход по паролю](https://docs.microsoft.com/azure/active-directory/active-directory-appssoaccess-whatis) для любого приложения, которое вы ранее добавили с помощью функции **добавления приложения не из коллекции**.
