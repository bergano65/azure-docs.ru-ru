...
8. Нажмите кнопку **Сохранить**. Azure AD пытается проанализировать страницу входа для ввода имени пользователя и ввода пароля. Если эта операция завершается с ошибкой, то все готово. 
