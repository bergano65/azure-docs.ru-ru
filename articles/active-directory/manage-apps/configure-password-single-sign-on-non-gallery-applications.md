...
ms.locfileid: "87459391"
---
# <a name="configure-password-based-single-sign-on"></a>Настройка единого входа на основе пароля

В [серии "быстрый](view-applications-portal.md) запуск" по управлению приложениями вы узнали, как использовать Azure AD в качестве поставщика удостоверений (IDP) для приложения. В кратком руководстве вы настроили единый вход на основе SAML. Другой вариант — единый вход на основе пароля. Эта статья содержит более подробные сведения о параметре единого входа на основе пароля. 
...
- Настройка меток для полей "имя пользователя" и "пароль", которые пользователи видят на [панели доступа к приложениям](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) при вводе учетных данных
