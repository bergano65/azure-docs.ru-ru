---
title: Как настроить федеративный единый знак для приложения, не являемого галереей
...
15. [Назначаем пользователей в приложение.](#assign-users-to-the-application)
