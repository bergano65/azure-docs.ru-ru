---
title: Настройка федеративного единого входа для приложения не из коллекции
...
В этой статье представлен общий обзор действий, необходимых для настройки федеративного единого входа с помощью SAML 2,0 для приложения, не относящегося к коллекции (например, пользовательского).
...
15. [Назначьте пользователей приложению.](#assign-users-to-the-application)
