...
- Сопоставление appRoleAssignment в Azure AD с ролью в приложении требует преобразования атрибута с помощью [выражения](functions-for-customizing-application-data.md). Атрибут appRoleAssignment **не должен сопоставляться напрямую** с атрибутом Role без использования выражения для анализа сведений о роли. 
