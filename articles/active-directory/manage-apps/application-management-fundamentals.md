...
| Требовать назначение пользователей  | По умолчанию пользователи могут получать доступ к корпоративным приложениям без назначения им. Однако если приложение предоставляет роли или вы хотите, чтобы приложение отображалось в моих приложениях пользователя, требуется назначение пользователей. (См. [Руководство разработчика по интеграции приложений](developer-guidance-for-integrating-applications.md).)  | 
