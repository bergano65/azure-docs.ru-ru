...
**Вариант 1. использование Managed Browser или Microsoft ребро** — это решение применимо только в том случае, если вы планируете рекомендовать или требовать, чтобы пользователи обращаются к приложению через Intune Managed Browser или браузер Microsoft ребр. Он будет обрабатывать все опубликованные URL-адреса. 
