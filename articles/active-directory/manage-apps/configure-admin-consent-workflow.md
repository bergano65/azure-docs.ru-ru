...
3. В поле фильтра поиска введите "**Azure Active Directory**" и выберите **Azure Active Directory** элемент.
...
1. Войдите в [портал Azure](https://portal.azure.com) как один из зарегистрированных рецензентов рабочего процесса согласия администратора.
