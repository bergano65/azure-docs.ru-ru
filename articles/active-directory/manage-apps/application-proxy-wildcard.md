---
title: Приложения с подстановочными знаками в AD Application Proxy Azure
...
1. Передать SSL-сертификат в формате PFX на прокси приложения.
...
![Для внешнего URL-адреса используйте формат https://*.\<> пользовательского домена](./media/application-proxy-wildcard/21.png)
...
- Внутренний URL-адрес:
    ...
    ![Пример: подстановочный знак во внутреннем URL-адресе](./media/application-proxy-wildcard/42.png)

- Внешний URL-адрес:

    ![Пример: подстановочный знак во внешнем URL-адресе](./media/application-proxy-wildcard/43.png)

- Внутреннее имя субъекта-службы приложения

    ![Пример: подстановочный знак в конфигурации имени участника-службы](./media/application-proxy-wildcard/44.png)
...
- Во **внутреннем URL-адресе** укажите **finance** вместо подстановочного знака.
    ...
    ![Пример. Указание финансового адреса вместо подстановочного знака во внутреннем URL-адресе](./media/application-proxy-wildcard/52.png)

- Во **внешнем URL-адресе** укажите **finance** вместо подстановочного знака.

    ![Пример. Указание финансового адреса вместо подстановочного знака во внешнем URL-адресе](./media/application-proxy-wildcard/53.png)

- Во внутреннем имени субъекта-службы приложения вместо подстановочного знака укажите **finance**.

    ![Пример. Задание финансового параметра вместо подстановочного знака в конфигурации имени субъекта-службы](./media/application-proxy-wildcard/54.png)

Эта конфигурация реализует следующий сценарий.

![Показывает конфигурацию, реализованную в примере сценария.](./media/application-proxy-wildcard/09.png)
