---
title: Приложения Wildcard в прокси-приложении Azure AD
...
Чтобы начать работу, убедитесь, что вы выполнили эти требования.
...
1. Загрузите сертификат TLS/SSL в формате PFX в прокси-сервер приложения.
...
![Для внутреннего URL-адреса используйте формат http(s)://. \<домена>](./media/application-proxy-wildcard/22.png)

При настройке **внешнего URL-адреса** необходимо использовать следующий формат: `https://*.<custom domain>`.

![Для внешнего URL-адреса используйте формат https://». \<пользовательские> домена](./media/application-proxy-wildcard/21.png)
...
![Найти идентификатор приложения на странице свойств приложения](./media/application-proxy-wildcard/01.png)
...
1. На странице свойств приложения для параметра **Show Application** (Показать приложение) задайте значение **true**.
...
- Внутренний URL-адрес:
    ...
    ![Пример: Wildcard во внутреннем URL-адресе](./media/application-proxy-wildcard/42.png)

- Внешний URL-адрес:

    ![Пример: Wildcard во внешнем URL](./media/application-proxy-wildcard/43.png)

- Внутреннее имя субъекта-службы приложения

    ![Пример: Wildcard в конфигурации SPN](./media/application-proxy-wildcard/44.png)
...
![Отображает структуру, реализованную конфигурацией примера](./media/application-proxy-wildcard/05.png)

| Color | Описание |
| ---   | ---         |
| Синий  | Приложения, явно опубликованные и видимые на портале Azure. |
...
- Во **внутреннем URL-адресе** укажите **finance** вместо подстановочного знака.
    ...
    ![Пример: Установите финансирование вместо подстановочного знака во внутреннем URL-адресе](./media/application-proxy-wildcard/52.png)

- Во **внешнем URL-адресе** укажите **finance** вместо подстановочного знака.

    ![Пример: Установите финансирование вместо подстановочного знака во внешнем URL](./media/application-proxy-wildcard/53.png)

- Во внутреннем имени субъекта-службы приложения вместо подстановочного знака укажите **finance**.

    ![Пример: Установите финансирование вместо подстановочного знака в конфигурации SPN](./media/application-proxy-wildcard/54.png)

Эта конфигурация реализует следующий сценарий.

![Отображает конфигурацию, реализованную по примеру сценария](./media/application-proxy-wildcard/09.png)
