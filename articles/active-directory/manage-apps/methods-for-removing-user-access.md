...
4. Нажмите **на корпоративные приложения** из меню слева от навигации Azure Active Directory.

5. Нажмите **на все приложения,** чтобы просмотреть список всех ваших приложений.
