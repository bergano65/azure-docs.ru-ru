...
Вы можете определить, могут ли пользователи, назначенные корпоративному приложению, просматривать их в разделе "Мои приложения" и в Microsoft 365 средства запуска приложений.
...
* [Самостоятельное управление группами/SSAA](../enterprise-users/groups-self-service-management.md)
