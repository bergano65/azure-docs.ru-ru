...
- Эта функция включена в Microsoft 365 подписки, но если вы хотите использовать ограничения клиентов для управления доступом к другим приложениям SaaS, необходимо Azure AD Premium 1 лицензий.
