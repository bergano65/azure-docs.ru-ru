...
\* на этом компьютере использовался пользовательский параметр для создания некоторых ограничений по умолчанию для соединений за пределами рекомендуемых параметров .NET. Рекомендуем запустить тест с параметрами по умолчанию, прежде чем обратиться в службу поддержки, чтобы изменить это ограничение для своего клиента.
