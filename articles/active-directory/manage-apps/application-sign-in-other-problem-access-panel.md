...
2.  Нажмите **на приложение password-SSO** в панели доступа.
...
7.  Вопийте в панель доступа и посмотрите, можете ли вы **запустить** приложения sSO с паролем
...
-   [Расширение "Панель доступа" для Microsoft Edge](https://www.microsoft.com/p/my-apps-secure-sign-in-extension/9pc9sckkzk84)
...
1. <span id="_Hlk477187909" class="anchor"><span id="_Hlk477001983" class="anchor"></span></span>Откройте [**портал Azure**](https://portal.azure.com/) и вопийте в качестве **глобального администратора** или **коадминистратора.**
...
14. Нажмите **Сохранить,** чтобы сохранить конфигурацию.
...
6.  **Введите текстовый** ящик имени из **раздела Добавить из раздела галереи,** введите имя приложения
