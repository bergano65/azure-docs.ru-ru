...
![Приложениям, подключенным непосредственно на предприятии](media/migrate-adfs-apps-to-azure/migrate1.png)
