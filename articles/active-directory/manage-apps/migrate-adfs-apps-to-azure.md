...
description: Эта статья поможет организациям понять, как перемещать приложения в Azure Active Directory, и сосредоточиться на федеративных приложениях SaaS.
...
> [!TIP]
> Эта статья написана для аудитории разработчика. Руководителям проектов и администраторам, которые планируют Перемещение приложения в Azure AD, следует ознакомиться со статьей [Миграция проверки подлинности приложения в Azure AD](migrate-application-authentication-to-azure-active-directory.md) .
