...
![Приложения, подключенные непосредственно в локальной среде](media/migrate-adfs-apps-to-azure/migrate1.png)
...
- **Более безопасный доступ**
  ...
  - Настройте подробные элементы управления доступом на уровне приложения, включая многофакторную идентификацию Azure, с помощью [условного доступа Azure AD](../active-directory-conditional-access-azure-portal.md). Политики можно применить к приложениям SaaS и пользовательским приложениям таким же образом, который известен на сегодня для Office 365.
...
|Элемент конфигурации приложения|Description|Расположение в рамках конфигурации AD FS|Соответствующее расположение в конфигурации Azure AD|Элемент токена SAML|
|-----|-----|-----|-----|-----|
...
|Элемент конфигурации|Description|AD FS|Azure AD|
|---|---|---|---|
...
![Отображает список атрибутов, которые можно отправить в качестве утверждений.](media/migrate-adfs-apps-to-azure/migrate4.png)

Щелкните определенную строку атрибута, чтобы изменить ее, или выберите **Добавить атрибут** для добавления нового атрибута.

![Показывает панель "изменение атрибута"](media/migrate-adfs-apps-to-azure/migrate5.png)
...
![Отображение области "Добавление назначения"](media/migrate-adfs-apps-to-azure/migrate7.png)
