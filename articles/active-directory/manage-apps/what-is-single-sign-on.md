...
Если вы являетесь администратором или ИТ-специалистом, ознакомьтесь со сведениями о реализации единого входа в Azure.

## <a name="single-sign-on-basics"></a>Основные сведения о едином входе
Единый вход — это существенный этап в развитии процесса входа пользователей в приложения и работы с ними. Системы проверки подлинности на основе единого входа часто называются "современной проверкой подлинности". Чтобы понять, что делает единый вход возможным, посмотрите предоставленное ниже видео.
> [!VIDEO https://www.youtube.com/embed/fbSVgC8nGz4]

## <a name="understanding-where-an-app-is-hosted"></a>Основные сведения о размещении приложения
Реализация единого входа для приложения во многом связана с местом размещения приложения. Размещение приложения играет очень важную роль из-за способа маршрутизации сетевого трафика для доступа к приложению. Если приложение размещено в вашей локальной сети (локальное приложение) и доступно через нее, то пользователям не нужно иметь доступ к Интернету для использования приложения. Если приложение размещено в другом расположении (в облаке приложения), для использования приложения пользователям потребуется доступ к Интернету.

> [!TIP]
> Облачные приложения также называются приложениями SaaS (Программное обеспечение как услуга). 
