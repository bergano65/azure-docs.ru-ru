...
>[!NOTE]
>Вы не можете применить политики условного доступа или многофакторную проверку подлинности для единого входа на основе пароля.
...
>[!NOTE]
>К связанному приложению нельзя применить политики условного доступа или многофакторную проверку подлинности. Это связано с тем, что связанное приложение не предоставляет возможности единого входа через Azure AD. При настройке связанного приложения вы просто добавляете ссылку, которая будет отображаться на портале запуска приложений или портала MyApps. 
