...
![Выбор способа единого входа](./media/what-is-single-sign-on/choose-single-sign-on-method-040419.png)
...
5. Соединитель использует ограниченное делегирование Kerberos (KCD) согласования с локальном каталоге AD, олицетворяя пользователя, чтобы получить маркер Kerberos для приложения.
