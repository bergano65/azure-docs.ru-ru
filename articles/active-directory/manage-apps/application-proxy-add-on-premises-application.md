...
5. Выберите **Скачать службу соединителя**.
    ...
    ![Скачивание службы соединителя](./media/application-proxy-add-on-premises-application/application-proxy-download-connector-service.png)
...
2. Выполните вход от имени пользователя, созданного в предыдущем разделе.
