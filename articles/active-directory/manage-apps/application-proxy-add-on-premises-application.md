...
ms.locfileid: "78967851"
---
# <a name="tutorial-add-an-on-premises-application-for-remote-access-through-application-proxy-in-azure-active-directory"></a>Руководство. Добавление локального приложения для удаленного доступа через прокси приложения в Azure Active Directory
...
Если вы ранее установили соединитель, переустановите его, чтобы получить последнюю версию. Сведения о ранее выпущенных версиях и изменениях, которые они включают, см. в разделе [Журнал выпусков приложений: версия](application-proxy-release-version-history.md).
...
5. В разделе **Добавление локального приложения** укажите следующие сведения о приложении.
    ...
    | Поле | Description |
    | :---- | :---------- |
    | **Название** | Имя приложения, которое будет отображаться на панели доступа и на портале Azure. |
