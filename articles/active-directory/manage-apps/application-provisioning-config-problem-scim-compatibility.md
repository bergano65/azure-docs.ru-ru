...
| **Проблемы с соответствием SCIM 2.0** |  **Исправлена?** | **Исправьте дату**  |  
|---|---|---|
...
[Дополнительные сведения о подготовке и отзыве к приложениям SaaS](user-provisioning.md)
