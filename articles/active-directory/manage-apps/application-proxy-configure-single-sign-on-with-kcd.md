...
При настройке компьютера соединителя для SPNEGO убедитесь, что все другие соединители в этой группе настроены с SPNEGO. Приложения, ожидающие Стандартный маркер Kerberos, должны маршрутизироваться через другие соединители, для которых не настроена SPNEGO.
