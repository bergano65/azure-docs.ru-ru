...
| Доступ к этому корпоративному приложению невозможно получить прямо сейчас. Повторите попытку позже. Истекло время ожидания для соединителя. | Ваши пользователи могут получить эту ошибку при попытке доступа к опубликованному вами приложению, если они не определены должным образом для этого приложения на стороне в локальной среде. Убедитесь, что у пользователей есть соответствующие разрешения, определенные для этого приложения внутреннего сервера на компьютере в локальной среде. |
