...
1. Нажмите **Сохранить**. Теперь новый сертификат отображается со статусом **неактивна**, выбранная дата истечения срока действия и отпечаток.
