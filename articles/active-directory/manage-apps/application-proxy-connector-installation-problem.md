...
**Цель:** убедитесь, что пользователь, пытающийся установить соединитель, является администратором с подходящими учетными данными. В настоящее время он должен быть администратором приложения или глобального администратора для установки для успешного выполнения.
...
Выберите свою учетную запись пользователя и затем "Роль каталога" в появившемся меню. Убедитесь, что выбрана роль "Глобальный администратор" или "Администратор приложений". Если вам не удается открыть какие-либо страницы при выполнении описанных действий, у вас нет нужной роли.
