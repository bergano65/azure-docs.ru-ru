...
Проверьте отпечаток текущего сертификата клиента. Хранилище сертификатов можно найти в Коннектор\конфиг\трустсеттингс.ксмл прокси приложения%Програмдата%\микрософт\микрософт AAD.
...
1. Скачать файл [PsTools. zip](https://docs.microsoft.com/sysinternals/downloads/pstools)
2. Извлеките [PsExec](https://docs.microsoft.com/sysinternals/downloads/psexec) из пакета и выполните команду **PsExec-i-u "NT Authority\Network Service" cmd. exe** из командной строки с повышенными привилегиями.
