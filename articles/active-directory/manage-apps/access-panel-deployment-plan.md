...
Когда пользователи входят в приложения единого входа на основе пароля, им необходимо установить и использовать расширение безопасного входа в мои приложения. Расширение выполняет сценарий, передающий пароль в форму входа приложения. Пользователям предлагается установить расширение при первом запуске приложения единого входа на основе пароля. Дополнительные сведения о расширении можно найти в этой документации по [установке расширения браузера "Мои приложения](access-panel-extension-problem-installing.md)".
...
Чтобы спланировать членство в группе самообслуживания, определите, разрешено ли всем пользователям в организации создавать группы или только подмножество пользователей. Если вы разрешаете подмножество пользователей, необходимо настроить группу, в которую добавляются эти пользователи. Дополнительные сведения о включении этих сценариев см. [в разделе Настройка самостоятельного управления группами в Azure Active Directory](../users-groups-roles/groups-self-service-management.md) .
...
Используйте роль с наименьшим уровнем привилегий для выполнения необходимой задачи в Azure Active Directory. [Ознакомьтесь с различными доступными ролями](../users-groups-roles/directory-assign-admin-roles.md) и выберите нужную, чтобы удовлетворить потребности каждого персонажа для этого приложения. Некоторые роли, возможно, потребуется временно применить и удалить после завершения развертывания.
...
### <a name="troubleshoot-my-apps-issues"></a>Устранение неполадок, связанных с моими приложениями
...
[Приложения не отображаются](access-panel-troubleshoot-application-not-appearing.md)

[Отображаются непредвиденные приложения](access-panel-troubleshoot-unexpected-application.md)

[Пользователь не может войти в мои приложения](access-panel-troubleshoot-web-sign-in-problem.md)

[Проблемы при использовании самостоятельного доступа к приложениям](access-panel-troubleshoot-self-service-access.md)

[Проблемы с расширением браузера](manage-access-panel-browser-extension.md)
