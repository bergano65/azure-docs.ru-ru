...
|Access | Портал панели доступа доступен с корпоративных устройств за пределами корпоративной сети. |
...
| Проверьте взаимодействие с пользователем.| Пользователи знают о возможностях панели доступа и способах их использования.|
| Проверьте взаимодействие с пользователем.| Пользователи могут управлять доступом к приложениям и группам.|
| Проверьте взаимодействие с пользователем.| Пользователи могут управлять своими учетными записями. |
| Проверьте взаимодействие с пользователем.| Пользователи знают о совместимости с браузерами. |
