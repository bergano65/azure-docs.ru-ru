...
ms.locfileid: "88930542"
---
# <a name="plan-an-azure-active-directory-my-apps-deployment"></a>Планирование Azure Active Directory развертывания приложений

Azure Active Directory (Azure AD) "Мои приложения" — это веб-портал, который помогает снизить затраты на поддержку, повысить производительность и безопасность, а также сократить число недовольство пользователей. Система включает подробные отчеты, которые отслеживаются при доступе к системе и уведомляют администраторов о неправильном использовании или нарушении прав.
...
Основой моих приложений является портал запуска приложений, к которому пользователи обращаются по адресу [https://myapps.microsoft.com](https://myapps.microsoft.com/) . Страница «Мои приложения» дает пользователям единое место для начала работы и получения необходимых приложений. Здесь пользователи находят список всех приложений, к которым у них есть доступ с помощью единого входа. 
...
### <a name="deploy-microsoft-microsoft-365-applications-to-my-apps"></a>Развертывание приложений Microsoft 365 Майкрософт в "Мои приложения"
...
Для выполнения необходимой задачи в Azure Active Directory необходимо использовать роль с минимальными полномочиями. [Ознакомьтесь с различными доступными ролями](../users-groups-roles/directory-assign-admin-roles.md) и выберите нужную, чтобы удовлетворить потребности каждого персонажа для этого приложения. Некоторые роли, возможно, потребуется временно применить и удалить после завершения развертывания.
