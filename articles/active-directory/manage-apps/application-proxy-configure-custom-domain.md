...
Нельзя использовать сертификат, выданный собственную инфраструктуру открытых ключей (PKI) из-за вопросы безопасности.
...
* [Включить условный доступ](application-proxy-integrate-with-sharepoint-server.md) к опубликованным приложениям.
