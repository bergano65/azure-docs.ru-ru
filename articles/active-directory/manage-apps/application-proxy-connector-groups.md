---
title: Публикация приложений в отдельных сетях через группы разъемов - Azure AD
...
1. Выберите**прокси-сервер****приложений** >  **Azure Active Directory** > Enterprise.
1. Выберите **Новая группа соединителей**. Появится колонка "New Connector Group" (Новая группа соединителей).

   ![Показывает экран, чтобы выбрать новую группу разъема](./media/application-proxy-connector-groups/new-group.png)
...
1. Из панели мониторинга управления для каталога выберите **приложения** > Enterprise**Все приложения,** > приложение, которое вы хотите назначить группе разъема > **прокси-сервера приложения.**
...
![Диаграмма, иллюстрирующая сеть Azure AD IaaS](./media/application-proxy-connector-groups/application-proxy-iaas-network.png)
...
![Azure AD IaaS Несколько поставщиков облачных технологий](./media/application-proxy-connector-groups/application-proxy-multiple-cloud-vendors.png)
...
![Пример Azure AD без групп разъемов](./media/application-proxy-connector-groups/application-proxy-sample-config-1.png)
...
![Пример Azure AD Без групп разъема и изолированной сети](./media/application-proxy-connector-groups/application-proxy-sample-config-2.png)
...
![Пример компании с 2 центрами обработки данных и 2 разъемами](./media/application-proxy-connector-groups/application-proxy-sample-config-3.png)
