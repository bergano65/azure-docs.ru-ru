...
В некоторых случаях может потребоваться 1–2 минуты (или даже больше), чтобы отобразилось приложение, добавленное в каталог. Хотя это и не является нормальной ожидаемой производительностью, вы можете увидеть, как выполняется добавление приложения, щелкнув значок **уведомления** (колокольчик) в правом верхнем углу [портал Azure](https://portal.azure.com/) и просматривая уведомление о **выполнении** или **завершении** с меткой **Создание приложения**.
...
В некоторых случаях из-за временных проблем, неполадок сети или сбоев в программе добавление приложения может завершиться ошибкой. Вы можете сообщить, что это происходит, щелкнув значок **уведомления** (колокольчик) в правом верхнем углу портал Azure и увидите красный значок (!) рядом с уведомлением о **создании приложения** . значит при создании приложения произошла ошибка.
