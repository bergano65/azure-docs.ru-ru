---
title: Удаленный доступ к приложениям для непредпосмяно - Azure AD Application Proxy
...
- **Безопасный**. Локальные приложения могут использовать элементы управления авторизацией и аналитику безопасности Azure. Например, в приложениях для помещений можно использовать Условный доступ и двухэтапную проверку. Application Proxy не требует открывать входящие подключения через брандмауэр.
...
Приложение Прокси рекомендуется для предоставления удаленным пользователям доступа к внутренним ресурсам. Прокси-сервер приложения заменяет потребность в VPN или обратном прокси- Он не предназначен для внутренних пользователей корпоративной сети.  Эти пользователи, которые неоправданно используют Application Proxy, могут ввести неожиданные и нежелательные проблемы с производительностью.
