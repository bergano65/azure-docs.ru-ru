...
-   [Выберите идентификатор пользователя и добавьте атрибуты пользователя, которые будут отправлены в приложение.](#select-user-identifier-and-add-user-attributes-to-be-sent-to-the-application)
...
12. **Необязательно.** Щелкните **Просмотреть и изменить все другие атрибуты пользователей**, чтобы изменить атрибуты, которые будут отправлены приложению в токене SAML при входе пользователей в систему.
    ...
    2. нажмите **Сохранить.** Новый атрибут появится в таблице.
...
6. нажмите **негалерей приложение** в **разделе Добавить свой собственный раздел приложения.**
...
10. Выберите **регистрацию на основе SAML** в режиме отбрасываемого **режима.**
...
9. [Назначаем пользователей в приложение.](#how-to-assign-a-user-to-an-application-directly)
...
#### <a name="configure-the-application-for-password-single-sign-on"></a><a name="configure-the-application-for-password-single-sign-on-1"></a>Настройка приложения для единого ввоза пароля
...
5.  Щелкните **Все приложения**, чтобы открыть полный список приложений.
    ...
    1.  Если вы не видите приложение, которое вы хотите отображить здесь, используйте элемент управления **фильтром** в верхней части **списка всех приложений** и установите опцию **Show** для **всех приложений.**
...
10. [Назначаем пользователей в приложение.](#how-to-assign-a-user-to-an-application-directly)
...
7. нажмите **пользователи и группы**.
...
11. Нависте над **пользователем** в списке, чтобы показать **флажок.** Чтобы добавить пользователя в список **Выбрано**, установите флажок рядом с фотографией или логотипом профиля этого пользователя.
...
[Добавление новых пользователей в active-каталог Azure](./../fundamentals/add-users-azure-active-directory.md)
