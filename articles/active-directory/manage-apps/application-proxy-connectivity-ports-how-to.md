---
title: Как открыть порты брандмауэра, необходимые для приложения Application Proxy
...
-   Убедитесь, что все прокси-серверы или брандмауэры, которые применяются к соединителю, также применяются к этой странице. Это можно сделать в Internet Explorer, перейдя в **Настройки**  - &gt; **Интернет Параметры**  - &gt; **Подключения**  - &gt; **LAN Настройки.** На этой странице появится флажок "Использовать прокси-сервер для локальной сети". Установите этот флажок и укажите адрес прокси-сервера в поле "Адрес".
