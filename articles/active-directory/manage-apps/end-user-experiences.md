...
Эти ссылки представляют собой специально созданные URL-адреса, которые передают пользователя в рамках процесса входа в Azure AD для конкретного приложения, не требуя от пользователя запуска их из приложения Azure AD My или Microsoft 365. Эти **URL-адреса пользователей** доступны в свойствах доступных корпоративных приложений. На портале Azure выберите **Azure Active Directory** > **Корпоративные приложения**. Выберите приложение и щелкните **Свойства**.
