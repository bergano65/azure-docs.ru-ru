...
2.  Создание приложения прокси приложения Azure AD

3.  Скачивание и настройка PingAccess

4.  Настройка приложений в PingAccess

Сведения о каждом из этих шагов см. в нашей [документации по единому входу с использованием заголовков](application-proxy-configure-single-sign-on-with-ping-access.md).
