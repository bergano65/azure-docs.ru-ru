...
1. Перейдите к каналу Teams, в который необходимо добавить это приложение, и нажмите **+** , чтобы добавить вкладку.
   ...
   ![Выберите +, чтобы добавить вкладку в группах](./media/application-proxy-integrate-with-teams/add-tab.png)

1. Выберите **Веб-сайт** на вкладке параметров.

   ![Выберите веб-сайт из добавить вкладку экрана](./media/application-proxy-integrate-with-teams/website.png)

1. Присвойте вкладке имя и задайте внешний URL-адрес прокси приложения в качестве URL-адреса.

   ![Имя вкладки и добавьте внешний URL-адрес](./media/application-proxy-integrate-with-teams/tab-name-url.png)
