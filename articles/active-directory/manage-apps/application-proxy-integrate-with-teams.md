...
1. Выберите **Веб-сайт** на вкладке параметров.
   ...
   ![Выбор веб-сайта на экране "Добавление вкладки"](./media/application-proxy-integrate-with-teams/website.png)

1. Присвойте вкладке имя и задайте внешний URL-адрес прокси приложения в качестве URL-адреса.

   ![Присвойте вкладке Имя и добавьте внешний URL-адрес.](./media/application-proxy-integrate-with-teams/tab-name-url.png)
