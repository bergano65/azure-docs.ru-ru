...
6. Чтобы добавить приложение, найдите его в коллекции или введите его имя в поле поиска. Затем выберите приложение в результатах поиска. В форме можно изменить имя приложения в соответствии с потребностями организации. В этом примере мы выбрали GitHub и изменили имя на **GitHub-test**.
    ...
    >[!TIP]
    >Если нужное приложение отсутствует в коллекции, щелкните ссылку **Создать собственное приложение**. Корпорация Майкрософт уже обеспечила предварительную настройку множества приложений для работы с Azure AD при участии их разработчиков. Эти приложения можно найти в коллекции. Но если нужное вам приложение не указано, создайте новое стандартное приложение и настройте его самостоятельно или под руководством разработчика приложения.
