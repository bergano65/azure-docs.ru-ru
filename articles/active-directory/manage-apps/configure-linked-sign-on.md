...
**Связанный** параметр позволяет настроить целевое расположение, когда пользователь выбирает приложение в приложении " [Мои приложения](https://myapplications.microsoft.com/) " или на портале Office 365.
...
**Связанный** параметр не предоставляет функции входа через Azure AD. Параметр просто задает расположение, в которое будут отправляться пользователи при выборе приложения в [моих приложениях](https://myapplications.microsoft.com/) или средстве запуска приложений Microsoft 365.
...
После настройки приложения назначьте ему пользователей и группы. При назначении пользователей можно контролировать, когда приложение отображается в окне " [Мои приложения](https://myapplications.microsoft.com/) " или в средстве запуска приложений Microsoft 365.
