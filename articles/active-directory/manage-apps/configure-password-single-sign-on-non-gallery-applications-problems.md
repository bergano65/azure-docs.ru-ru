...
-   Если процесс определения полей вручную перестает отвечать на запросы, или страницы входа не выполняется никаких действий (случай 3 выше), попробуйте вручную снова. Но на этот раз после завершения процесса нажмите кнопку **F12**, чтобы открыть консоль разработчика браузера. Откройте **консоль**, введите **window.location="&lt;URL-адрес входа, указанный при настройке приложения&gt;"** и нажмите клавишу **ВВОД**. Это вызовет принудительный переход на указанную страницу, при этом процесс определения завершится и найденные поля будут сохранены.
