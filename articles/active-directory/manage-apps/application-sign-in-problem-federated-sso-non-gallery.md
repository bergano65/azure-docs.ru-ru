...
Убедитесь, что атрибут `Issuer` в запросе SAML соответствует значению идентификатора, настроенному в Azure AD. Если вы используете [опыт тестирования](../azuread-dev/howto-v1-debug-saml-sso-issues.md) в портал Azure с расширением "Защищенный браузер" Мои приложения ", вам не нужно вручную выполнять эти действия.
...
Убедитесь, что атрибут `Issuer` в запросе SAML соответствует значению идентификатора, настроенному в Azure AD. Если вы используете [опыт тестирования](../azuread-dev/howto-v1-debug-saml-sso-issues.md) в портал Azure с расширением "Защищенный браузер" Мои приложения ", вам не нужно вручную выполнять следующие действия:
