---
title: Проблемы при входе в приложение федеративного единого входа не из коллекции | Документация Майкрософт
...
*Ошибка AADSTS50011: Адрес `https://contoso.com` отклика не соответствует адресам ответа, настроенным для приложения* 
...
8. После загрузки приложения щелкните **Базовая конфигурация SAML**. Проверьте или обновите значение в текстовом поле URL-адрес ответа, `AssertionConsumerServiceURL` чтобы оно совпадало со значением в запросе SAML.    
...
*Ошибка AADSTS50105: Пользователь `brian\@contoso.com` , выполнивший вход, не назначен роли для приложения*
