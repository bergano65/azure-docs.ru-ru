...
Для большинства сценариев мы рекомендуем Azure AD Application Proxy в качестве современного решения. Прокси-служба веб-приложений предпочтительна только в ситуациях, когда требуется прокси-сервер для AD FS, а задействовать пользовательские домены в Azure Active Directory нет возможности. 
...
- Расширение Azure AD для использования с локальными ресурсами
   ...
   - Такие функции, как условный доступ и многофакторная аутентификация, просты в возможности
