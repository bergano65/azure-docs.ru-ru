...
На [портале Azure](https://portal.azure.com) можно просматривать все приложения, которые настроены для использования единого входа в каталог, а также управлять ими. Приложения можно найти в разделе портала **Все службы** &gt; **Корпоративные приложения**. Корпоративные приложения — это приложения, развертываемые и используемые в вашей организации.
