---
title: Единый вход SAML для локальных приложений с Azure Active Directory Application Proxy (Предварительная версия) | Документация Майкрософт
...
ms.locfileid: "67853770"
---
# <a name="saml-single-sign-on-for-on-premises-applications-with-application-proxy-preview"></a>Единый вход SAML для локальных приложений с помощью прокси приложения (Предварительная версия)
...
2. В разделе **Добавление собственного приложения**выберите **приложение не из коллекции**.
...
3. Измените **URL-адрес ответа** , настроенный ранее, чтобы его домен был доступен прокси приложения. Например, если **внешний URL-адрес** имеет `https://contosotravel-f128.msappproxy.net` значение, а **Исходный URL-адрес ответа** был `https://contosotravel.com/acs`, необходимо обновить исходный **URL-адрес ответа** на. `https://contosotravel-f128.msappproxy.net/acs` 
