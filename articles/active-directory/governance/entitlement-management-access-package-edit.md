...
**Готовности к установке роли:** Администратор пользователей, владельца каталога или доступа диспетчера пакетов
...
1. На странице "Обзор", скопируйте **ссылка портале мой доступ**.
    ...
    ![Обзор пакета доступа — ссылка на портале мой доступ](./media/entitlement-management-shared/my-access-portal-link.png)
