...
[Azure AD privileged Identity Management (PIM)](../privileged-identity-management/pim-configure.md) предоставляет дополнительные элементы управления, предназначенные для защиты прав доступа для ресурсов, в Azure AD, Azure и других службах Microsoft Online Services.  В дополнение к многофакторной проверке подлинности и условному доступу предоставляется полный набор элементов управления для обеспечения безопасности ресурсов компании (каталога, Office 365 и ролей ресурсов Azure), а также возможности оповещений о JIT-доступе и изменения ролей, предоставляемые Azure AD PIM. Как и для других видов доступа, с помощью проверок доступа можно настроить регулярные сертификации прав доступа для всех пользователей с ролями администратора.
...
- [Что такое проверки доступа Azure AD?](access-reviews-overview.md)
