...
Использование PIM позволяет ограничить административные разрешения пользователя для обеспечения дополнительной безопасности. Ниже приведены минимальные роли каталога с минимальными правами для настройки функций управления удостоверениями в Azure AD. 
