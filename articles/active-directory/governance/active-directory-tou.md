...
1. Чтобы пользователи принимали условия использования на каждом устройстве, с помощью которого они осуществляют доступ, для параметра **Требовать согласие пользователей для каждого устройства** выберите значение **Вкл**.

    Если вы не видите параметра **Требовать согласие пользователей для каждого устройства**, значит, эта функция еще не развернута для вашего региона. Полное развертывание этой функции ожидается в начале января 2019 г. Дополнительные сведения см. в статье [Функция "Условия использования Azure Active Directory"](#per-device-terms-of-use).
...
> [!NOTE]
> Если вы не видите параметра **Требовать согласие пользователей для каждого устройства** при создании новых условий использования, значит, эта функция еще не развернута для вашего региона. Полное развертывание этой функции ожидается в начале января 2019 г.
