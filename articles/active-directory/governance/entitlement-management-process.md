...
| 9 | Запрос отклонен на *[access_package]* | Это сообщение будет отправлено запрашивающему, когда запрос будет отклонен. | Запрашивающая сторона |
| 10 | Срок действия вашего запроса истек для *[access_package]* | Это сообщение будет отправлено инициатору запроса в конце одного или 2-этапного запроса. Сообщение электронной почты уведомляет запрашивающий, что срок действия запроса истек. | Запрашивающая сторона |
...
| 18 | Теперь у вас есть доступ к *[access_package]* | Это электронное письмо будет отправлено конечным пользователям для начала использования доступа. | Запрашивающая сторона |
| 19 | Расширение доступа для *[access_package]* по *[DATE]* | Это сообщение будет отправлено конечным пользователям до истечения срока действия доступа. | Запрашивающая сторона |
| 20 | Доступ к *[access_package]* завершен. | Это сообщение электронной почты будет отправлено конечным пользователям после истечения срока действия доступа. | Запрашивающая сторона |
