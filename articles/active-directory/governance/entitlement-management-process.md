...
| 9 | Запрос отклонен на *[access_package]* | Это сообщение будет отправлено запрашивающему, когда запрос будет отклонен. | Requestor |
| 10 | Срок действия вашего запроса истек для *[access_package]* | Это сообщение будет отправлено инициатору запроса в конце одного или 2-этапного запроса. Сообщение электронной почты уведомляет запрашивающий, что срок действия запроса истек. | Requestor |
