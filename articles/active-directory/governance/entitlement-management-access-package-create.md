...
1. В раскрывающемся списке **Каталог** выберите каталог, в котором нужно создать пакет доступа. Например, у вас может быть владелец каталога, который управляет всеми ресурсами маркетинга, которые могут быть запрошены. В этом случае можно выбрать каталог Marketing.
    ...
    Вы увидите только каталоги, у которых есть разрешение на создание пакетов доступа в. Чтобы создать пакет Access в существующем каталоге, необходимо быть по крайней мере глобальным администратором, администратором пользователя, владельцем каталога в этом каталоге или доступом к диспетчеру пакетов в этом каталоге.

    ![Доступ к пакету — основные сведения](./media/entitlement-management-access-package-create/basics.png)

    Если вы являетесь глобальным администратором или администратором пользователей и хотите создать пакет Access в новом каталоге, который не указан в списке, щелкните **создать**. Введите имя и описание каталога, а затем нажмите кнопку **создать**.
...
1. В открывшейся области Выбор выберите один или несколько ресурсов из списка.
    ...
    Если вы создаете пакет Access в каталоге "общий" или в новом каталоге, вы сможете выбрать любой ресурс из каталога, которому вы владеете. Необходимо быть по крайней мере глобальным администратором, администратором пользователя или автором каталога.
    ...
    Если вы являетесь глобальным администратором, администратором или владельцем каталога, у вас есть дополнительный вариант выбора ресурсов, которые еще не находятся в каталоге. Если выбрать ресурсы, не находящиеся в выбранном каталоге, эти ресурсы будут также добавлены в каталог для других администраторов каталога для сборки пакетов доступа с помощью. Если вы хотите выбрать только те ресурсы, которые в данный момент находятся в выбранном каталоге, установите флажок **только см** . в верхней части окна Выбор панорамы.
