...
| --- | --- | --- |
| Администратор создает проверку доступа группы A с 500 пользователями.<br/>Назначение трех владельцев групп в качестве рецензентов. | 1 администратор + 3 владельца группы | 4 |
| Администратор создает проверку доступа группы A с 500 пользователями.<br/>Делает его самостоятельным обзором. | 1 администратора + 500 пользователей как самостоятельных рецензентов | 501 |
| Администратор создает проверку доступа группы A с 5 пользователями и 25 гостевых пользователей.<br/>Делает его самостоятельным обзором. | 1 администратора и 5 пользователей как самостоятельных рецензентов<br/>(гостевые пользователи попадают в требуемое соотношение 1:5). | 6 |
| Администратор создает проверку доступа группы A с 5 пользователями и 28 гостевых пользователей.<br/>Делает его самостоятельным обзором. | 1 Администратор + 5 пользователей как самопроверяющих + 1 пользователь для покрытия гостевых пользователей в соответствии с требуемым соотношением 1:5 | 7 |
