...
| присвоение | Назначение пакета доступа пользователю гарантирует, что у пользователя все роли ресурсов этого пакета доступа.  Доступ к назначениям пакетов обычно ограничен по времени до истечения срока их действия. |
