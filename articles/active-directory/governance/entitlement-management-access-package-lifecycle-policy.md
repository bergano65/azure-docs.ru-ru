...
description: Узнайте, как изменить сведения о запрашивающей стороны & параметры жизненного цикла для пакета Access в Azure Active Directory управлении назначением.
...
## <a name="open-requestor-information"></a>Открыть сведения о запрашивающем
Чтобы обеспечить доступ пользователей к пакету Access, можно настроить запрашивать у пользователей запрос на доступ к определенным пакетам доступа. Доступны следующие параметры конфигурации: локализация, обязательный или необязательный параметр, а для форматов ответов "текст/несколько вариантов выбора". Запрашивающие стороны будут видеть вопросы, когда они запрашивают пакет, и утверждающие увидят ответы на вопросы, чтобы помочь им принять решение. Чтобы настроить вопросы в пакете Access, выполните следующие действия.
