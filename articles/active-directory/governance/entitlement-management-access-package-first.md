...
![Общая схема сценария](./media/entitlement-management-access-package-first/elm-scenario-overview.png)
...
9. На панели "Выбор групп" найдите и выберите группу **Маркетинговые ресурсы**, созданную ранее.
    ...
    ![Снимок экрана: вкладка "New access package — Resource roles" (Создание пакета для доступа — роли ресурсов) и окно выбора групп](./media/entitlement-management-access-package-first/resource-roles-select-groups.png)
