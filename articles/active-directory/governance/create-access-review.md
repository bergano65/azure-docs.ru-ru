...
1. Щелкните **Создать проверку доступа**, чтобы создать проверку доступа.
    ...
    ![Область проверки доступа в функции управления удостоверениями](./media/create-access-review/access-reviews.png)
...
1. Чтобы указать, что происходит после завершения проверки, разверните раздел **Настройки после завершения**.
    ...
    ![Создание проверки доступа - после заполнения параметров](./media/create-access-review/upon-completion-settings.png)
