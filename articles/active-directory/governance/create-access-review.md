...
- Образца Владельцы ресурсов групп Microsoft 365 могут создавать рецензии на группы Microsoft 365, которыми они владеют.
- Образца Владельцы ресурсов групп безопасности Azure AD могут создавать рецензии на группы безопасности Azure AD, которыми они владеют.
