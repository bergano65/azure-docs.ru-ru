...
1. При необходимости введите причину.
    ...
    ![На снимке экрана показана страница, на которой вы принимаете или отклоняете запрос.](./media/entitlement-management-request-approve/my-access-approve-request.png)
