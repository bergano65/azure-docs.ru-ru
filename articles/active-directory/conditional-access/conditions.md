...
**Действия пользователя** задачи, которые могут быть выполнены пользователем. Поддерживаемые в настоящее время единственным действием будет **зарегистрировать сведения о безопасности (Предварительная версия)**, что позволяет политики условного доступа для принудительного применения, когда пользователь регистрирует свои сведения о безопасности.
