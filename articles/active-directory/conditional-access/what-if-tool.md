...
- Если вы готовы к настройке политик условного доступа для своей среды, ознакомьтесь с рекомендациями [по условному доступу в Azure Active Directory](best-practices.md). 
