...
В **средстве What If условного доступа**необходимо сначала настроить параметры сценария входа, который требуется имитировать. Эти параметры включают:
