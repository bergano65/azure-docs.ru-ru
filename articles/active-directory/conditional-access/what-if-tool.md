...
:::image type="content" source="./media/what-if-tool/01.png" alt-text="Снимок экрана со страницей условного доступа — политики в портал Azure. На панели инструментов выделяется элемент что если." border="false":::
...
:::image type="content" source="./media/what-if-tool/02.png" alt-text="Снимок экрана со страницей условного доступа — политики в портал Azure. На панели инструментов выделяется элемент что если." border="false":::
...
:::image type="content" source="./media/what-if-tool/03.png" alt-text="Снимок экрана со страницей условного доступа — политики в портал Azure. На панели инструментов выделяется элемент что если." border="false":::
