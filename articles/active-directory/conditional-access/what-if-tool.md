---
title: Что такое, что если средство в Azure Active Directory условного доступа?
description: Узнайте, как можно понять влияние политики условного доступа на рабочую среду.
...
ms.locfileid: "67506741"
---
# <a name="what-is-the-what-if-tool-in-azure-active-directory-conditional-access"></a>Что такое, что если средство в Azure Active Directory условного доступа?

[Условный доступ](../active-directory-conditional-access-azure-portal.md) является Azure Active Directory (Azure AD), можно контролировать как доступ авторизованных пользователей к облачным приложениям. Как узнать, чего следует ожидать от политик условного доступа в вашей среде? Чтобы ответить на этот вопрос, можно использовать **средство условного доступа гипотетических**.
...
**Средство политики условного доступа гипотетических** позволяет понять влияние политики условного доступа на рабочую среду. Вместо того, чтобы тестировать политики, выполняя несколько входов вручную, можно воспользоваться данным инструментом, чтобы имитировать вход пользователя. При имитации оценивается влияние входа на политики и создается отчет об имитации. Отчет не включает только примененные политики условного доступа, но также [классических политик](policy-migration.md#classic-policies) если они существуют.    

**Что делать, если** средство позволяет быстро определить политики, которые применяются к конкретному пользователю. Эти сведения можно использовать, например, если необходимо устранить проблему.    

## <a name="how-it-works"></a>Принцип работы

В **средство условного доступа гипотетических**, сначала необходимо настроить параметры сценария входа в систему требуется имитировать. К числу этих параметров относятся следующие:
...
Можно найти **что делать, если** средство **[условный доступ — политики](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ConditionalAccessBlade/Policies)** страницы на портале Azure.

Чтобы запустить средство, на панели инструментов на основе списка политик, нажмите кнопку **что делать, если**.
...
Запустите оценку, нажав кнопку **что делать, если**. После оценки предоставляется отчет, содержащий: 
