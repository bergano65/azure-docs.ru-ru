...
Этот процесс включает ситуацию, когда пользователи теряют доступ к файлам, электронной почте, календарю или задачам Организации, а также командам из клиентских приложений Office 365 в минутах после одного из этих критических событий. 
...
Этот процесс включает ситуацию, когда пользователи теряют доступ к файлам Организации, электронной почте, календарю или задачам из клиентских приложений Office 365 или SharePoint Online сразу после изменения сетевого расположения.
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| SharePoint Online | Поддерживается | Поддерживается | Не поддерживается | Поддерживается | Поддерживается |
| Exchange Online | Поддерживается | Поддерживается | Не поддерживается | Поддерживается | Поддерживается |
...
### <a name="user-condition-change-flow-public-preview"></a>Поток изменения условия пользователя (общедоступная Предварительная версия):
...
> [!IMPORTANT]
> При настройке расположений для оценки непрерывного доступа используйте только [условие расположения условного доступа на основе IP-адреса](../conditional-access/location-condition.md). Не используйте условия расположения страны или функции надежных IP-адресов, доступные на странице параметров службы многофакторной идентификации Azure.
...
Описание каналов обновления Office см. в [статье Обзор каналов обновления для Microsoft 365 приложений](https://docs.microsoft.com/deployoffice/overview-update-channels). Не рекомендуется, чтобы организации не отключили Диспетчер учетных записей Web (WAM).
