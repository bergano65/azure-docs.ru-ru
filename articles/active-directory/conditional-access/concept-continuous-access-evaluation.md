...
| Current Channel <br> или диспетчер конфигурации служб <br> Monthly Channel (корпоративный) | АВТОМАТИЗИРОВАННОГО конструирования поддерживается независимо от параметра | АВТОМАТИЗИРОВАННОГО конструирования поддерживается независимо от параметра |
