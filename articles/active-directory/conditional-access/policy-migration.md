...
- [Рекомендации по работе с условным доступом в Azure Active Directory](best-practices.md): изучите рекомендации по развертыванию условного доступа в организации.

- [Краткое руководство. Требование многофакторной идентификации (MFA) для конкретных приложений с помощью условного доступа Azure Active Directory](app-based-mfa.md): ознакомьтесь с пользовательским интерфейсом на портале Azure.
