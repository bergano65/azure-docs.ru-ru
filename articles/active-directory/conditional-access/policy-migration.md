...
С помощью условного доступа на портале Azure можно управлять всеми политиками в одном централизованном месте. Так как реализации условного доступа значительно изменилась, следует ознакомиться с основными понятиями перед переносом классических политик.
