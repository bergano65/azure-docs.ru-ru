...
- **Диапазоны IP-адресов** — один или не сколько диапазонов IPv4-адресов в формате CIDR. Указание диапазон IPv6-адресов не поддерживается.
   ...
   > [!NOTE]
   > Rangess адрес IPv6 в настоящее время не может использоваться в именованный обеспеченияТакже measn IPv6, диапазонами нельзя исключить из политики условного доступа.
