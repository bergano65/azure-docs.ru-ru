...
Количество именованных расположений, которые можно настроить, ограничено размером соответствующего объекта в Azure AD. Организации могут настроить до 90 lamed расположений, настроенных с до 12000 диапазоны IP-адресов.
