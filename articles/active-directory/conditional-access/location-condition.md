---
title: Что такое условие расположения в Azure Active Directory условного доступа? | Документация Майкрософт
...
ms.locfileid: "67112295"
---
# <a name="what-is-the-location-condition-in-azure-active-directory-conditional-access"></a>Что такое условие расположения в Azure Active Directory условного доступа? 

С помощью [условного доступа Azure Active Directory (Azure AD)](../active-directory-conditional-access-azure-portal.md), вы можете управлять как авторизованные пользователи могут получить доступ к вашим облачным приложениям. Условие расположения политики условного доступа позволяет привязать параметры управления доступом в сеть пользователей.
...
Расположение — метки для в сетевую папку, которая представляет собой именованное расположение или многофакторной проверки подлинности надежных IP-адресов.
...
Можно получить доступ к вашей именованных расположений в **управление** раздел на странице условного доступа.
...
- **Отметить как надежное расположение** — флажок, который можно установить для именованного расположения, чтобы указать надежное расположение. Как правило, надежные расположения являются областями сети, которые контролируются ИТ-отделом. Помимо условного доступа, надежные именованные расположения также используются отчеты о безопасности для защиты идентификации Azure и Azure AD для уменьшения [ложных срабатываний](../reports-monitoring/concept-risk-events.md#impossible-travel-to-atypical-locations-1).
...
- **Включить неизвестные области** -некоторые IP-адреса не сопоставляются с определенной страны или региона. Этот параметр позволяет указать, нужно ли включать эти IP-адреса в именованное расположение. Используйте данный параметр, когда политика, использующая именованное расположение, должна применяться к неизвестным расположениям.

Количество именованных расположений, которые можно настроить, ограничено размером соответствующего объекта в Azure AD. Организации могут настроить до 90 именованных расположений, настроенных с до 1200 диапазоны IP-адресов.

Политики условного доступа применяется для трафика IPv4 и IPv6. В настоящее время именованные расположения не разрешать диапазоны IPv6-адресов к конфигурированию. Это ограничение приводит к следующих ситуациях:

- Невозможно применить политику условного доступа для определенных диапазонов IPv6
...
При наличии надежных IP-адресов настроены, они отображаются как **многофакторной проверки Подлинности надежных IP-адресов** в список расположений для условия расположения.
...
API и PowerShell не еще поддерживается для именованных расположений, или для политик условного доступа.
