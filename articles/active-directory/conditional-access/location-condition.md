...
Количество именованных расположений, которые можно настроить, ограничено размером соответствующего объекта в Azure AD. Вы можете настроить расположения на основе следующие ограничения:
