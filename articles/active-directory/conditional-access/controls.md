...
![Управление](./media/controls/10.png)
...
![Управление](./media/controls/61.png)
...
![Управление](./media/controls/18.png)
...
С помощью политики защиты приложений можно ограничить доступ к клиентским приложениям, отправленным в Azure AD, и получить [политики защиты приложений Intune](https://docs.microsoft.com/intune/app-protection-policy). Например, можно ограничить доступ к Exchange Online для приложения Outlook, в котором есть политика защиты приложений Intune. Политика условного доступа, требующая политики защиты приложений, также называется [политикой условного доступа на основе защиты приложений](concept-conditional-access-session.md#application-enforced-restrictions). 

Устройство должно быть зарегистрировано в Azure AD, прежде чем можно будет пометить приложение как защищенное политикой.

Список поддерживаемых клиентских приложений, защищенных с помощью политики, см. в разделе [требование политики защиты приложений](concept-conditional-access-session.md#application-enforced-restrictions).
...
![Управление](./media/controls/31.png)
