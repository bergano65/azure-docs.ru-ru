...
![Блокировка доступа](./media/block-legacy-authentication/02.png)
...
Блокировка доступа с помощью **других клиентов** также блокирует Exchange Online PowerShell с использованием обычной проверки подлинности.
