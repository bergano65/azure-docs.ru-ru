...
Действия пользователя являются задачами, которые могут быть выполнены пользователем. Единственным поддерживаемым в настоящее время действием является информация о **безопасности регистра,** которая позволяет политике условного доступа обеспечивать соблюдение, когда пользователи, включенные для комбинированной регистрации, пытаются зарегистрировать свою информацию о безопасности. Более подробную информацию можно найти в [статье,Свмейковые регистрации безопасности информации](../authentication/concept-registration-mfa-sspr-combined.md).
