...
- Microsoft Forms
- Microsoft Intune
- [Регистрация Microsoft Intune](/intune/enrollment/multi-factor-authentication)
...
Помимо приложений Майкрософт, администраторы могут добавить любое зарегистрированное приложение Azure AD в политики условного доступа. Эти приложения могут включать: 
