...
Да, вы можете использовать Exchange ActiveSync в политике условного доступа с некоторыми [ограничения](https://docs.microsoft.com/azure/active-directory/conditional-access/conditional-access-for-exo-and-spo). 
