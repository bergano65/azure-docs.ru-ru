...
- На **втором** этапе вам будет предложено удовлетворить невыполненные требования. Если любая из политик блокирует доступ, вы блокируете и не предлагаете удовлетворить другие элементы управления политикой. Если политики блокируют вас, вам будет предложено удовлетворить другие элементы управления политиками в следующем порядке:
