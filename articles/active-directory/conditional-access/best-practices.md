...
- На **втором** этапе вам будет предложено удовлетворить невыполненные требования. Если любая из политик блокирует доступ, вы блокируете и не предлагаете удовлетворить другие элементы управления политикой. Если ни одна из политик не блокирует вас, вам будет предложено удовлетворить другие элементы управления политиками в следующем порядке:

   ![Заказ](./media/best-practices/06.png)
    
   Внешние поставщики MFA и условия использования приступит далее.
