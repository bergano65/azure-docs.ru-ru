...
![Предупреждающее сообщение отключить параметры безопасности по умолчанию включение условного доступа](./media/concept-conditional-access-security-defaults/security-defaults-disable-before-conditional-access.png)
