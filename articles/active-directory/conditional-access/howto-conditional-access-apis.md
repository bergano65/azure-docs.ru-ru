...
Несколько администраторов могут создавать политики условного доступа и могут забыть добавить [учетные записи аварийного доступа](https://docs.microsoft.com/azure/active-directory/users-groups-roles/directory-emergency-access) в качестве исключения для этих политик. Этот пример гарантирует, что все политики будут обновлены для включения назначенных учетных записей аварийного доступа.
