...
:::image type="content" source="./media/require-managed-devices/47.png" alt-text="Снимок экрана панели устройств в Azure A D. элементы включения и отключения выделены." border="false":::
...
:::image type="content" source="./media/require-managed-devices/10.png" alt-text="Снимок экрана панели устройств в Azure A D. элементы включения и отключения выделены." border="false":::
...
:::image type="content" source="./media/require-managed-devices/45.png" alt-text="Снимок экрана панели устройств в Azure A D. элементы включения и отключения выделены." border="false":::
...
:::image type="content" source="./media/require-managed-devices/11.png" alt-text="Снимок экрана панели устройств в Azure A D. элементы включения и отключения выделены." border="false":::
...
:::image type="content" source="./media/require-managed-devices/46.png" alt-text="Снимок экрана панели устройств в Azure A D. элементы включения и отключения выделены." border="false":::
...
В этом сценарии компания Contoso решила, что все мобильные подключения к ресурсам Microsoft 365 должны использовать зарегистрированное устройство. Все пользователи уже выполнили вход с учетными данными Azure AD и имеют назначенные лицензии, в том числе Azure AD Premium P1, P2 и Microsoft Intune.
