...
Так как базовые политики находятся в предварительной версии, они не включены по умолчанию. Чтобы включить политику, необходимо активировать ее вручную. Если явным образом включить базовую политику на этапе предварительной версии, она будет действовать и после выхода общедоступной версии соответствующей функции. Из-за изменения запланированного поведения наряду с включением и отключением политики существует третий способ установить состояние политики — параметр **Автоматически включать политику в будущем**. Если он выбран, на этапе предварительной версии политики можно не включать: корпорация Майкрософт автоматически включит их при выходе общедоступной версии. Если вы явно не включите базовые политики сейчас и не выберете параметр **Автоматически включать политику в будущем**, политики останутся отключенными после выхода общедоступной версии.
