...
- Будет предложено установить **приложение Microsoft Authenticator** или **корпоративного портала Intune** для продолжения.
...
1. В разделе **назначения**в **пользователей и групп**, выбрать по крайней мере одного пользователя или группу, для каждой политики условного доступа.
1. В **облачные приложения**выберите **Office 365 Exchange Online**.

   ![условный доступ;](./media/app-protection-based-conditional-access/07.png)

1. В **условия**, Настройка **платформ устройств** и **клиентских приложений (Предварительная версия)** :
   1. В **платформ устройств**выберите **Android** и **iOS**.

      ![условный доступ;](./media/app-protection-based-conditional-access/03.png)

   1. В **клиентских приложений (Предварительная версия)** выберите **мобильные приложения и настольные клиенты** и **современных клиентах аутентификации**.

      ![условный доступ;](./media/app-protection-based-conditional-access/91.png)

1. В разделе **элементы управления доступом**выберите **требуется политика защиты приложений (Предварительная версия)** .
...
1. В **условия**, Настройка **клиентских приложений (Предварительная версия)** . 

   1. В **клиентских приложений (Предварительная версия)** выберите **мобильные приложения и настольные клиенты** и **клиентов Exchange ActiveSync**.
