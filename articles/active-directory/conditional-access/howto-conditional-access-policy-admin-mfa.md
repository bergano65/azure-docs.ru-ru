...
1. В разделе **условия**  >  **клиентские приложения**установите переключатель в положение **Да** и в **Configure** разделе **выберите клиентские приложения, к которым будет применена эта политика** оставьте все значения по умолчанию и нажмите кнопку **Готово**.
