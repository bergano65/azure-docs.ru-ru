...
1. В разделе **условия**  >  **риска при входе в систему**задайте для параметра **Настройка** значение **Да**. В разделе **выберите уровень риска при входе, к которому будет применяться эта политика** . 
