...
1. В разделе **облачные приложения или действия** > выберите пункт **выбрать приложения**, выберите **Microsoft Azure управление**и нажмите **кнопку Выбрать** , а затем **Готово**.
