...
Вы можете просмотреть пользователей-гостей, которые проходят проверку подлинности с помощью одноразовых секретных кодов, в портал Azure, перейдя в **Azure Active Directory**  >  **пользователей**.
