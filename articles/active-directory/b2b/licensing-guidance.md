...
Когда вы определите количество гостевых пользователей, которым требуется доступ к вашим платным службам Azure AD, приобретите для них достаточно платных лицензий Azure AD в требуемом соотношении 1:5. Далее приводятся некоторые примеры.

- Вы хотите пригласить 100 гостевых пользователей в ваши приложения или службы Azure AD и присвоить права управления доступом и подготовки для всех гостевых пользователей. Также требуется многофакторная проверка Подлинности и условного доступа для 50 из этих гостевых пользователей. Для этой комбинации вам потребуется 10 лицензий Azure AD Basic и 10 лицензий Azure AD Premium P1. Если вы планируете использовать для гостевых пользователей функции защиты идентификации, вам потребуются лицензии Azure AD Premium P2 в соотношении 1:5 для охвата гостевых пользователей.
