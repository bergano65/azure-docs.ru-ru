...
Убедитесь, что параметры внешнего взаимодействия вашей организации настроены таким образом, что может приглашать гостей. По умолчанию все пользователи и Администраторы могут приглашать гостей. Но можно настроить политики организации внешнего взаимодействия и для предотвращения таких пользователей или администраторов приглашать гостей. Чтобы узнать, как просматривать и задавать эти политики, см. в разделе [включить внешние службы совместной работы B2B и управлять ими, могут приглашать гостей](delegate-invitations.md).
...
1. Войдите в [портала Azure](https://portal.azure.com) от имени пользователя, которому назначена роль администратора с ограниченными правами каталога или в роль Guest Inviter.
...
5. В колонке **Имя пользователя** введите адрес электронной почты внешнего пользователя. При желании допишите приветственное сообщение. Пример:
...
Если вам нужно вручную добавить пользователей службы совместной работы B2B в группу, выполните следующие действия:
