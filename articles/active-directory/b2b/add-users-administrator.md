...
1. Войдите в [портала Azure](https://portal.azure.com) как пользователь, являющийся назначен любой из администратор с ограниченными правами роли каталога.
