...
5. На странице **Новый пользователь** выберите **пригласить пользователя** и добавьте сведения о гостевом пользователе. 
   ...
   - **Name** (Имя). Имя и фамилия гостевого пользователя.
   - **Адрес электронной почты (обязательно)** . Адрес электронной почты гостевого пользователя.
   - **Личное сообщение (необязательно)** Включите в гостевой пользователь личное приветственное сообщение.
