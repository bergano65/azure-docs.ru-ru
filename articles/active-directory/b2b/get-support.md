---
title: Получение поддержки для совместной работы B2B - Активный каталог Azure
...
1. На [портале Azure](https://portal.azure.com) перейдите в колонку "Справка и поддержка" и щелкните "Новый запрос на поддержку".
   ...
   ![Скриншот, показывающий новый запрос на поддержку](media/get-support/new-support-request.png)
...
2. Опишите свою проблему.
   ...
   ![Скриншот, показывающий описание проблемы с билетом поддержки](media/get-support/problem-description.png)
