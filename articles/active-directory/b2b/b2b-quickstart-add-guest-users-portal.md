...
5. На странице **Новый пользователь** выберите **Пригласить пользователя**, а затем добавьте сведения о пользователе-госте. 
   ...
   - **Роль в каталоге**. Если требуется предоставить пользователю права администратора Azure AD, ему можно присвоить роль Azure AD. 
...
3.  В тексте сообщения электронной почты выберите **Приступить к работе**. В браузере откроется страница **Проверить разрешения**. 
