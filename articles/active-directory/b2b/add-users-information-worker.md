---
title: Добавление пользователей совместной работы B2B в качестве информационного работника - Azure AD
...
2. Укажите приложение, щелкните многоточие (**...**), а затем выберите **Управление приложением**.
   ...
   ![Скриншот, показывающий подменю приложения «Управление» для приложения Salesforce](media/add-users-iw/access-panel-manage-app.png)
 
3. В верхней части списка **+** пользователей выберите .
   
   ![Скриншот, показывающий символ плюс для добавления членов в приложение](media/add-users-iw/access-panel-manage-app-add-user.png)
...
4. В поле поиска **Добавление участников** введите адрес электронной почты гостевого пользователя. При желании допишите приветственное сообщение.
   ...
   ![Скриншот, показывающий окно участников Добавления для добавления гостя](media/add-users-iw/access-panel-invitation.png)
...
3. Выберите приложение **Группы**.
   ...
   ![Скриншот, показывающий приложение Группы в панели доступа](media/add-users-iw/access-panel-groups.png)
...
4. В разделе **Группы в моем владении** выберите группу, у которой есть доступ к приложению, которое вы хотите использовать совместно.
   ...
   ![Скриншот, показывающий, где выбрать группу под группами, которые я владею](media/add-users-iw/access-panel-groups-i-own.png)
   
5. В верхней части списка членов **+** группы выберите .
   
   ![Скриншот, показывающий символ плюс для добавления членов в группу](media/add-users-iw/access-panel-groups-add-member.png)
...
5. В разделе **Управление** выберите **Единый вход** и настройте в приложении единый вход. (Дополнительные сведения об управлении параметрами единого входа для корпоративных приложений см. [здесь](https://docs.microsoft.com/azure/active-directory/manage-apps/configure-single-sign-on-non-gallery-applications).)
...
8. Чтобы добавить приложение в панель доступа владельца группы, выберите **Добавить** > **пользователей и групп.** Чтобы добавить пользователя в приложение, найдите владельца группы и выберите пользователя, щелкните **Выбрать**, а затем **Назначить**.
