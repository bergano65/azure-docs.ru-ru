...
При необходимости в любое время на протяжении 30-дневного периода администратор клиента может удалить учетную запись без возможности восстановления. Выполните указанные ниже действия.
