...
### <a name="can-i-set-up-direct-federation-with-a-domain-for-which-an-unmanaged-email-verified-tenant-exists"></a>Можно настроить прямую федерацию с доменом, для которого существует неуправляемый клиент (проверкой по электронной почте)? 
