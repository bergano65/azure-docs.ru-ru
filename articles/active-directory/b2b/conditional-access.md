...
### <a name="device-based-location-based-and-risk-based-conditional-access-for-b2b-users"></a>На основе устройств, на основе расположения и рисков условного доступа для пользователей B2B

Если компания Contoso применяет политики условного доступа на основе устройств к корпоративным данным, блокируется доступ с устройств, которые не управляются компанией Contoso и не соответствуют политикам устройства Contoso.

Если компания Contoso не управляет устройствами пользователей B2B, то доступ пользователей из организаций-партнеров будет заблокирован во всех контекстах, в которых применяются такие политики. Тем не менее Contoso может создать списки исключений, включающие пользователей конкретного партнера, чтобы исключить их из политики условного доступа на основе устройств.

#### <a name="location-based-conditional-access-for-b2b"></a>На основе расположения условный доступ для B2B

Политики условного доступа на основе расположения может применяться для пользователей B2B, если приглашающая организация сможет создать доверенных диапазон IP-адресов, определяющий партнерские организации.

#### <a name="risk-based-conditional-access-for-b2b"></a>На основе рисков условного доступа для пользователей B2B
