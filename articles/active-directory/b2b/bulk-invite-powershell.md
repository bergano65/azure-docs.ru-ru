...
description: Из этого руководства вы узнаете, как с помощью PowerShell и CSV-файла отправлять массовые приглашения для внешних гостевых пользователей службы совместной работы Azure AD B2B.
