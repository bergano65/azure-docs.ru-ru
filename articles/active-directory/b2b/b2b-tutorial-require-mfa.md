---
title: 'Руководство: применение Многофакторной идентификации для гостевых пользователей B2B Azure Active Directory'
...
2.  В области слева выберите **Azure Active Directory**.
3.  В разделе **Управление** выберите **Пользователи**.
4.  Выберите тестового пользователя, а затем — **Удалить пользователя**.
