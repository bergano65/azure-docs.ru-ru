...
Выполняя данное руководство, вы:
...
1.  На странице **Проверка политики условного доступа** выберите **Параметр What If** . 

    ![Снимок экрана с подсказкой, где выбрать параметр What if](media/tutorial-mfa/tutorial-mfa-whatif-1.png)
