...
ms.locfileid: "74420589"
---
# <a name="tutorial-enforce-multi-factor-authentication-for-b2b-guest-users"></a>Руководство по применению многофакторной проверки подлинности для гостевых пользователей B2B
...
> [!div class="checklist"]
> * Перед настройкой MFA проверите работу входа в систему.
> * Создадите политику условного доступа, которая требует прохождения MFA для доступа к облачному приложению в вашей среде. В этом руководстве мы используем приложение управления Microsoft Azure для демонстрации процесса.
> * Используете инструмент What If для имитации входа через MFA.
...
4.  Затем выберите **Новый гостевой пользователь**.
    ...
    ![Снимок экрана с подсказкой, где выбрать команду "Новый гостевой пользователь"](media/tutorial-mfa/tutorial-mfa-user-3.png)
...
7.  На странице **Пользователи и группы** щелкните **Выбрать пользователей и группы**, а затем — **Все гостевые пользователи (предварительная версия)** .
    ...
    ![Снимок экрана с подсказкой, как выбрать всех гостевых пользователей](media/tutorial-mfa/tutorial-mfa-policy-6.png)
...
11. На странице **Облачные приложения** щелкните **Выбрать приложения**, а затем нажмите кнопку **Выбрать**.
      ...
      ![Снимок экрана с изображением страницы облачных приложений и возможностью выбора](media/tutorial-mfa/tutorial-mfa-policy-10.png)
      
12. На странице **выбора** выберите **управление Microsoft Azure**, а затем нажмите кнопку **Выбрать**.

      ![Снимок экрана с выбранным приложением «Управление Microsoft Azure»](media/tutorial-mfa/tutorial-mfa-policy-11.png)
...
1. На странице **Условный доступ — политики** выберите **What If**.
      ...
      ![Снимок экрана с подсказкой, где выбрать What if](media/tutorial-mfa/tutorial-mfa-whatif-1.png)
