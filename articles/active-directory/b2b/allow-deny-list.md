...
- Сведения о службе совместной работы условного доступа и B2B, см. в разделе [условный доступ для пользователей службы совместной работы B2B](conditional-access.md).
