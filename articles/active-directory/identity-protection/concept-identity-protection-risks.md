...
| Распыление пароля | Чтобы получить несанкционированный доступ, в качестве средства взлома паролей можно использовать несколько имен пользователей, использующих обычные пароли. Это обнаружение риска активируется при выполнении атаки типа "распыление пароля". |
