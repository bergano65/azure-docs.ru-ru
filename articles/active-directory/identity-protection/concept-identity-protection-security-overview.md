...
:::image type="content" source="./media/concept-identity-protection-security-overview/01.png" alt-text="Снимок экрана портал Azure общие сведения о безопасности. Линейчатые диаграммы показывают количество рисков с течением времени. Плитки обобщаются сведения о пользователях и входах." border="false":::
...
:::image type="content" source="./media/concept-identity-protection-security-overview/02.png" alt-text="Снимок экрана портал Azure общие сведения о безопасности. Линейчатые диаграммы показывают количество рисков с течением времени. Плитки обобщаются сведения о пользователях и входах." border="false":::
