---
title: Обзор безопасности безопасности активных идентификационных данных Azure Active Directory
description: Узнайте, как обзор безопасности дает представление о безопасности вашей организации.
...
[Обзор безопасности](https://aka.ms/IdentityProtectionRefresh) на портале Azure дает представление о безопасности вашей организации. Это помогает определить потенциальные атаки и понять эффективность ваших политик.
...
Служба оценки безопасности удостоверений измеряет и сравнивает систему безопасности со стандартами отрасли. Если вы нажмете на плитку 'Identity Secure Score (Preview)', она перенаправит на лезвие "Identity Secure Score", где вы сможете узнать больше об улучшении вашей безопасности.
