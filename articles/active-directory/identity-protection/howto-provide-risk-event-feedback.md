---
title: Предоставьте отзыв об обнаружении рисков в защита идентификации Azure AD-Azure Active Directory
