...
**Тип обнаружения**. В режиме реального времени **старое имя:** Попытки входа из неизвестных расположений
...
**Тип обнаружения**. Автономно <br>
**Старое имя**. Это обнаружение будет отображаться в старых отчетов защиты идентификации Azure AD (пользователи, находящиеся в группе риска, событий риска) как «Пользователи с украденными учетными данными»

События риска этого типа указывает действия пользователей, необычен для определенного пользователя или соответствуют известным шаблонам атак на основе источников аналитики внутренних и внешних угроз корпорации Майкрософт.
