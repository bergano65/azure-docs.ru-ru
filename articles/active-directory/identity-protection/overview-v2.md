...
1. Сотрудник пытается войти в Exchange Online с помощью Tor Browser. Во время входа Azure AD обнаруживает события риска в режиме реального времени. 
...
5. Неудачное прохождение MFA активировало событие риска, которое должно быть записано, повышая риск пользователя сотрудника для будущих входов в систему. 
...
1. Сотрудник пытается войти в Exchange Online с помощью Outlook. Во время входа Azure AD обнаруживает события риска в режиме реального времени, а также все предыдущие риски пользователя. 
...
6. Предыдущие события риска сотрудника устранены, и его уровень риска пользователя автоматически сбрасывается в ответ на устранение компрометации учетных данных. 
