...
3. Сотрудник сверхмощного запрос на многофакторную Идентификацию, так как ИТ-администратор Contoso настройки политики условного доступа риска входа защиты идентификации. Политика требует MFA при риске при входе среднего уровня или выше. 
