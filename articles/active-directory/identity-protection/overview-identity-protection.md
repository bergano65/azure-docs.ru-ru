...
| Отчеты о безопасности | Пользователи, выполняющие рискованные действия  | Ограниченные сведения | Ограниченные сведения | Полный доступ|
| Отчеты о безопасности | Вход, представляющий риск  | Ограниченные сведения | Ограниченные сведения | Полный доступ|
| Отчеты о безопасности | Обнаружение рисков   | Нет | Ограниченные сведения| Полный доступ|
