...
| Функция | Сведения | Azure AD Premium P2 | Azure AD Premium P1 | Azure AD Free и приложения Office 365 |
| --- | --- | --- | --- | --- |
| Политики рисков | Политика рисков пользователей (реализуется через Защиту идентификации) | Да | Нет | Нет |
| Политики рисков | Политика рисков входа (реализуется через Защиту идентификации или условный доступ) | Да | Нет | Нет |
| Отчеты о безопасности | Обзор | Да | Нет | Нет |
...
| Уведомления | Предупреждения об обнаружении пользователей под угрозой | Да | Нет | Нет |
| Уведомления | Еженедельный дайджест | Да | Нет | Нет |
| | Политика регистрации MFA | Да | Нет | Нет |
