...
1. Войдите на [портал Azure](https://ms.portal.azure.com/) с правами глобального администратора. 

2. На портале Azure щелкните **Marketplace**.
   
    ![Создание](./media/enable/01.png "Создание")

3. В списке приложений выберите **Удостоверение**.
   
    ![Создание](./media/enable/05.png "Создание")

4. Щелкните **Azure AD Identity Protection**(Защита идентификации Azure AD).
   
    ![Создание](./media/enable/06.png "Создание")

5. В колонке **Azure AD Identity Protection** (Защита идентификации Azure AD) щелкните **Создать**.
   
    ![Создание](./media/enable/04.png "Создание")
