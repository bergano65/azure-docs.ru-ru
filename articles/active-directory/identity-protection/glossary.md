...
Политика условного доступа, которая оценивает риск для конкретного события входа и применяет способы устранения рисков на основе предварительно определенных условий и правил.
...
Политика условного доступа, который учитывает входа и применяет способы устранения рисков на основе предварительно определенных условий и правил.
