...
2. **Отклонить все обнаружения рисков** . Политика риска пользователя блокирует пользователя, если был достигнут заданный уровень риска для блокировки доступа. Можно уменьшить уровень риска пользователя, вручную закрыв обнаруженные определения рисков. 
