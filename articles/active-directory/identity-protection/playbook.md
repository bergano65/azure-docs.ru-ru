...
* Настройка политики условного доступа на основе рисков и проверить воздействие этих политик.
...
9. Теперь можно проверить пользователя на основе рисков условного доступа, необходимо выполнить вход, используя данные пользователя с уровнем риска.
...
8. Теперь, можно проверить вход на основе рисков условного доступа необходимо выполнить вход с помощью сеанса, представляющего риск (например, с помощью Tor browser). 
