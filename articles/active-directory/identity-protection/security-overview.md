...
![Общие сведения о безопасности](./media/security-overview/01.png)
...
![Общие сведения о безопасности](./media/security-overview/02.png)
...
### <a name="legacy-authentication"></a>Устаревший механизм проверки подлинности
...
### <a name="identity-secure-score"></a>Оценка безопасности удостоверения
