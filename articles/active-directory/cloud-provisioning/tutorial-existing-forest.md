...
В этом сценарии есть существующий лес, синхронизированный с клиентом Azure AD с помощью Azure AD Connect. У вас есть новый лес, который нужно синхронизировать с одним и тем же клиентом Azure AD. Вы настроите облачную подготовку для нового леса. 
...
4. На экране **Локальных агентов подготовки** вы увидите установленные агенты.  Убедитесь, что нужный агент присутствует в этом списке с пометкой **Активный**.
