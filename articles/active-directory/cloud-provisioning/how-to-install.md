...
Для установки подключаемого модуля сделайте следующее.
 ...
 10. Введите учетные данные администратора домена, чтобы создать групповую управляемую учетную запись службы, которая будет использоваться для запуска службы агента. Нажмите кнопку **Далее**.  
