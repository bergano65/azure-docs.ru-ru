...
![Схема: подготовка облака с использованием Azure Active Directory.](media/what-is-provisioning/cloud1.png)
...
![Схема: подготовка с использованием облачной и локальной систем управления персоналом, а также Azure Active Directory.](media/what-is-provisioning/cloud2.png)
...
![Схема: подготовка приложений с помощью локальных приложений, облачных приложений сторонних производителей (не Майкрософт) и Azure Active Directory.](media/what-is-provisioning/cloud3.png)
