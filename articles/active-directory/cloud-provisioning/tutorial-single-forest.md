...
1. Войдите на сервер, который будет использоваться с разрешениями администратора предприятия.  Если вы используете учебник по [основным службам Active Directory и среде Azure](tutorial-basic-ad-azure.md) , это будет DC1.
2. Скачайте [Azure AD Connect агент подготовки](https://go.microsoft.com/fwlink/?linkid=2109037).
3. Запуск агента подготовки Azure AD Connect (Аадконнектпровисионин
4. Гажент. Installer)
...
7. После завершения этой операции вы увидите уведомление: **Конфигурация агента успешно проверена.**  Можно нажать кнопку **выход**.</br>
