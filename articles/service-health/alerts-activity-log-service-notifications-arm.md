...
Уведомления о работоспособности службы сохраняются в [журнале действий Azure](../azure-monitor/platform/platform-logs-overview.md). При наличии большого объема информации, хранящегося в журнале действий, вы можете воспользоваться отдельным пользовательским интерфейсом, который упрощает просмотр и настройку оповещений о работоспособности службы.
