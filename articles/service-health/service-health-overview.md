...
description: Узнайте, как служба работоспособности служб предоставляет настраиваемую панель мониторинга, которая отслеживает работоспособность служб Azure в регионах, где они используются.
ms.topic: conceptual
ms.date: 05/10/2019
