...
## <a name="does-resource-health-differentiate-between-unavailability-caused-by-platform-problems-versus-something-i-did"></a>Ли ресурс здравоохранения различать недоступность, вызванную проблемы платформы по сравнению с тем, что я сделал?
...
Здоровье ресурсов имеет [поддержку предварительного просмотра](resource-health-alert-arm-template-guide.md) предупреждений на основе журнала активности. Оповещения о деятельности журнала использовать [группы действий,](https://docs.microsoft.com/azure/azure-monitor/platform/action-groups) чтобы уведомить пользователей, что оповещение было срабатывает. Группы действий поддерживают различные каналы уведомлений, такие как электронная почта, SMS, webhook и itsM.ru.
...
- Перейдите в раздел "Работоспособность служб Azure".  В левой навигации выберите **здоровье ресурсов.**
...
Здоровье ресурсов доступно во всех геосах Azure.
