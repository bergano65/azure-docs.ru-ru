...
|Выполняемые проверки|
|---|
|<ul><li>Учетная запись пакета запущена и запущена?</li><li>Превышена ли квота пула для этой пакетной учетной записи?</li></ul>|
...
## <a name="microsoftdatafactoryfactories"></a>Microsoft.datafactory/фабрики
|Выполняемые проверки|
|---|
|<ul><li>Были ли сбои в работе трубопровода?</li><li>Является ли кластер, принимающий Фабрику данных, здоровым?</li></ul>|

## <a name="microsoftdatalakeanalyticsaccounts"></a>Microsoft.datalakeanalytics/accounts
|Выполняемые проверки|
|---|
|<ul><li>У пользователей возникали проблемы с отправкой или размещением заданий Data Lake Analytics?</li><li>Не могут ли задания Data Lake Analytics быть завершены из-за системных ошибок?</li></ul>|
...
|Выполняемые проверки|
|---|
|<ul><li>Не удалось ли обеспечить миграционную службу базы данных?</li><li>Остановлена ли миграционная служба базы данных из-за бездействия или запроса пользователя?</li></ul>|

## <a name="microsoftdatashareaccounts"></a>Microsoft.DataShare/учетные записи
|Выполняемые проверки|
|---|
|<ul><li>Является ли учетная запись «Общий доступ» и запущена?</li><li>Доступен ли кластер, принимающий «Общий доступ» ?</li></ul>|

## <a name="microsoftdbformariadbservers"></a>Microsoft.DBforMariaDB/servers
|Выполняемые проверки|
|---|
|<ul><li>Сервер недоступен из-за технического обслуживания?</li><li>Сервер недоступен из-за перенастройки?</li></ul>|
...
|Выполняемые проверки|
|---|
|<ul><li>Является ли пространство имен Event Hubs ошибками, генерируемыми пользователями?</li><li>Обновляется ли в настоящее время пространство имен event Hubs?</li></ul>|

## <a name="microsofthdinsightclusters"></a>Microsoft.hdinsight/кластеры
|Выполняемые проверки|
|---|
|<ul><li>Доступны ли основные службы в кластере HDInsight?</li><li>Может ли кластер HDInsight получить доступ к ключу шифрования BYOK в состоянии покоя?</li></ul>|
...
|Выполняемые проверки|
|---|
|<ul><li>Веб-сервис запущен?</li></ul>|

## <a name="microsoftmediamediaservices"></a>Microsoft.Media/mediaservices
|Выполняемые проверки|
|---|
|<ul><li>Является ли служба массовой информации запущена и работает?</li></ul>|

## <a name="microsoftnetworkapplicationgateways"></a>Microsoft.network/applicationgateways
|Выполняемые проверки|
|---|
|<ul><li>Ухудшается ли производительность шлюза приложения?</li><li>Доступен ли шлюз приложения?</li></ul>|
...
|Выполняемые проверки|
|---|
|<ul><li>Является ли схема ExpressRoute здоровой?</li></ul>|

## <a name="microsoftnetworkfrontdoors"></a>Microsoft.network/frontdoors
|Выполняемые проверки|
|---|
|<ul><li>Отвечают ли бэкэнды Front Door с ошибками на зонды здоровья?</li><li>Затягиваются ли изменения конфигурации?</li></ul>|
...
|Выполняемые проверки|
|---|
|<ul><li>Существуют ли задержки с индексацией рабочей области?</li></ul>|
...
|Выполняемые проверки|
|---|
|<ul><li>Работает ли операционная система узла?</li><li>Доступна ли коллекция workspaceCollection из-за пределов центра обработки данных?</li><li>Доступен ли поставщик ресурсов Power BI?</li><li>Доступна ли услуга Power BI в соответствующем регионе?</li></ul>|
...
|Выполняемые проверки|
|---|
|<ul><li>Является ли кластер Service Fabric запущен и запущен?</li><li>Можно ли управлять кластером Service Fabric через менеджер ресурсов Azure?</li></ul>|

## <a name="microsoftsqlmanagedinstancesdatabases"></a>Microsoft.S'L/управляемыеInstances/базы данных
|Выполняемые проверки|
|---|
|<ul><li>База данных запущена и работает?</li></ul>|

## <a name="microsoftsqlserverdatabases"></a>Microsoft.S'L/Server/базы данных
|Выполняемые проверки|
|---|
