...
Уведомления о работоспособности ресурсов хранятся в [журнале действий Azure](../azure-monitor/platform/platform-logs-overview.md) , учитывая потенциально большой объем данных, хранящихся в журнале действий. существует отдельный пользовательский интерфейс, облегчающий Просмотр и настройку оповещений о работоспособности ресурсов.
...
7. В разделе **Группа действий** в раскрывающемся меню укажите группу действий, которую нужно назначить новому правилу генерации оповещений. Или [создайте группу действий](../azure-monitor/platform/action-groups.md) и назначьте ее новому правилу. Чтобы создать новую группу, выберите + **Новая группа**.
...
Вы можете включить, отключить, изменить или удалить правило. Дополнительные сведения об [управлении правилами журнала действий](../azure-monitor/platform/alerts-activity-log.md#view-and-manage-in-the-azure-portal).
