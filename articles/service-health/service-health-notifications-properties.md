...
Properties.stage | Возможные значения для **инцидента**и **безопасности** — **активные,** **Разрешенные** или **RCA**. У параметров **ActionRequired** и **Informational** может быть только одно значение — **Active**. Значения параметра **Maintenance**: **Active**, **Planned**, **InProgress**, **Canceled**, **Rescheduled**, **Resolved** или **Complete**.
