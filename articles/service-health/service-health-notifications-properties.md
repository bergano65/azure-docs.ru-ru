...
-------- | -----------
каналы | Одно из следующих значений: **Администрирование** или **Операция**.
...
состояние | Строка, описывающая состояние операции. Обычные значения: **Запущено**, **Выполняется**, **Выполнено**, **Не выполнено**, **Активно** и **Решено**.
