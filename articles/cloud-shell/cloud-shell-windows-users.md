...
Дополнительные сведения о новинках в PowerShell Core 6 можно получить в [документах PowerShell](/powershell/scripting/whats-new/what-s-new-in-powershell-70?view=powershell-7.1) и в записи блога [Getting Started with PowerShell Core on Windows, Mac, and Linux](https://blogs.msdn.microsoft.com/powershell/2017/06/09/getting-started-with-powershell-core-on-windows-mac-and-linux/) (приступая к работе с PowerShell Core в Windows, Mac и Linux).