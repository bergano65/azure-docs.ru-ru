...
## <a name="upload-and-download-files"></a>Отправка и скачивание файлов
...
* Чтобы скачать файл, введите полный путь к файлу во всплывающем окне (т. е. по сути это путь в каталоге, `/home/user` который отображается по умолчанию) и нажмите кнопку "Скачать".  
> [!NOTE] 
...
## <a name="web-preview"></a>Предварительный просмотр в Интернете
...
[Быстрый запуск PowerShell в Cloud Shell](quickstart-powershell.md)
