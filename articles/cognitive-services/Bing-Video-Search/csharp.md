...
## <a name="bing-video-search"></a>API Bing для поиска видео

[API Bing для поиска видео](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference) возвращает результаты видео из поисковой системы Bing.
...
## <a name="see-also"></a>См. также 
 ...
 [Поиск видео в сети](search-the-web.md)  
 [Пробная версия](https://azure.microsoft.com/services/cognitive-services/bing-video-search-api/)