---
title: Отправка поисковых запросов в API Поиска видео Bing
...
Если Bing может расширить запрос, чтобы сузить исходный поисковый запрос, объект [Videos](https://docs.microsoft.com/rest/api/cognitiveservices/bing-video-api-v7-reference#videos) будет содержать поле `queryExpansions`. Например, если запрос был *Cleaning Gutters*, расширенные запросы могут иметь вид: Gutter Cleaning **Tools**, Cleaning Gutters **From the Ground**, Gutter Cleaning **Machine**, and **Easy** Gutter Cleaning.
