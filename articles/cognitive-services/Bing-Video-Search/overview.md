...
| [Обрезка, изменения размера и отображение эскизов](../bing-web-search/resize-and-crop-thumbnails.md)                                                | Изменяйте и отображайте предварительные версии видео, возвращаемые API Bing для поиска видео.                                                                                      |
