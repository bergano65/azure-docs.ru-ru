...
* использование существующего ресурса Служб мультимедиа Azure с указанием [идентификатора ресурса](https://docs.microsoft.com/azure/media-services/latest/assets-concept) (поддерживается только в платных учетных записях).
