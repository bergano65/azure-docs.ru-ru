...
- **Идентификация лиц на основе учетных записей** — Индексатор видео обучает модель для определенной учетной записи. Затем, используя обученную модель, он распознает лица только на тех видео, которые хранятся в соответствующей учетной записи.
