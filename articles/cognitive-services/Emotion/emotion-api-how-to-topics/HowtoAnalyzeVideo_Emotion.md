---
title: 'Пример: Анализ видео в режиме реального времени — API распознавания эмоций'
titlesuffix: Azure Cognitive Services
description: Выполняйте анализ практически в реальном времени по кадрам, взятым из видеотрансляции, с помощью API распознавания эмоций.
...
Как и для всех служб Cognitive Services, разработчики, работающие с нашими API-интерфейсами и примерами, должны следовать [правилам поведения разработчиков служб Azure Cognitive Services](https://azure.microsoft.com/support/legal/developer-code-of-conduct/).
