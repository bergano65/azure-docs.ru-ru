...
| SYM | символ | % & |
| В | "to" как метка предлога или инфинитива | до |
...
Как и для выделения лексем, мы полагаемся на детализацию из [Penn Treebank](https://catalog.ldc.upenn.edu/LDC99T42).
