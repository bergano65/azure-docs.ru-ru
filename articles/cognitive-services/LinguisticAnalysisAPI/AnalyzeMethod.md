...
-----|-------|----------|------------
**language**    | string | Yes | Двухбуквенный ISO-код языка, который будет использоваться для анализа. Например "en" для английского языка.
...
**text**        | string | Yes | Необработанные входные данные для анализа. Это может быть короткая строка, такая как слово или фраза, полное предложение, целый абзац или часть текста.
