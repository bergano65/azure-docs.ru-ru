...
1. Создайте [учетную запись Cognitive Services](../cognitive-services-apis-create-account.md), чтобы получить доступ к API Поиска Bing. Если у вас нет подписки Azure, [создайте бесплатную учетную запись](https://azure.microsoft.com/free/cognitive-services/).
...
* В справочнике по [Визуальному поиску изображений](/rest/api/cognitiveservices/bingvisualsearch/images/visualsearch) даны определения и сведения о конечных точках, заголовках запросов, ответах и параметрах запросов, которые можно использовать для поиска изображений.
