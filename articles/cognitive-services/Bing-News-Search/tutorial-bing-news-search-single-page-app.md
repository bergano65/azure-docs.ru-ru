...
Чтобы выполнить задания, описанные в этом руководстве, требуются ключи подписок для API "Поиск Bing". Если у вас нет таких ключей, можете использовать [ключ пробной версии](https://azure.microsoft.com/try/cognitive-services/?api=bing-web-search-api) и [базовый ключ Карт Bing](https://www.microsoft.com/maps/create-a-bing-maps-key).
