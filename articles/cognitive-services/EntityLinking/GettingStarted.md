---
title: Руководство по Создание приложения для связывания сущностей с помощью C#
...
ms.locfileid: "56594038"
---
# <a name="tutorial-build-an-entity-linking-app-with-c"></a>Руководство по Создание приложения для связывания сущностей с помощью C#
