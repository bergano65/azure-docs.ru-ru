...
Чтобы войти в локальную установку интерфейса Command-Line (CLI), используйте команду [AZ login](https://docs.microsoft.com/cli/azure/reference-index?view=azure-cli-latest#az-login) .
