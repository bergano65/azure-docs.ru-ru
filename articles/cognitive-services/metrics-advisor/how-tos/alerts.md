...
:::image type="content" source="../media/alerts/alert-setting.png" alt-text="окно создания веб-перехватчика.":::

Нажмите кнопку **Добавить** или **изменить** , чтобы открыть окно для добавления или изменения параметров оповещений.

:::image type="content" source="../media/alerts/edit-alert.png" alt-text="окно создания веб-перехватчика.":::
...
:::image type="content" source="../media/alerts/alert-setting-operator.png" alt-text="окно создания веб-перехватчика.":::
