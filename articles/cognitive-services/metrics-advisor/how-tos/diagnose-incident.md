...
Последняя часть вкладки детализация — это график необработанных значений. Если эта диаграмма предоставлена, не нужно переходить к странице метрика для просмотра сведений.
...
Выберите ряд из своего веб-канала данных. Можно выбрать одну и ту же гранулярность или другую. Выберите целевые измерения и загрузите тренд ряда, а затем нажмите кнопку **ОК** , чтобы сравнить его с предыдущим рядом. Ряды будут объединены в одну визуализацию. Вы можете продолжить добавление серии для сравнения и получения дополнительных сведений. Щелкните раскрывающееся меню в верхней части вкладки **средства сравнения** , чтобы сравнить данные временных рядов за определенный период времени, сдвинуты.  

> [!Warning]
> Чтобы включить посмещенное сравнение, необходимо, чтобы он поддерживал детализацию данных. Например, если данные еженедельны и вы используете сравнение " **день за день** ", вы не получите результатов. В этом примере вместо этого используется сравнение " **месячный за месяц** ".

После выбора переопределяющего сравнения можно выбрать, следует ли сравнивать значения данных, разностные значения или процентные разницы.
