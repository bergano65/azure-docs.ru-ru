...
2. Перейдите на демонстрационный сайт, чтобы изучить экземпляр Помощника по метрикам с предварительно настроенными примерами данных. 
3. Создайте свой первый монитор с помощью веб-портала.
...
1. Используйте REST API для настройки своего экземпляра.

## <a name="next-steps"></a>Следующие шаги

* Перейдите к [демоверсии сайта](quickstarts/explore-demo.md).
