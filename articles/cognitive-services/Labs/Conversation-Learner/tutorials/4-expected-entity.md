...
[![Предварительная версия руководства 4](https://aka.ms/cl-tutorial-04-preview)](https://aka.ms/blis-tutorial-04)
...
2. Чтобы исправить это, щелкните выделенную фразу, а затем щелкните красный значок корзины. 
