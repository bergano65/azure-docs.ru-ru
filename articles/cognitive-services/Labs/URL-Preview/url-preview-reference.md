...
Предварительная версия URL-адреса поддерживает краткие описания веб-ресурсов для публикаций в блогах, форумов, страниц предварительного просмотра и т. д. URL-адрес может представлять собой любой тип Интернет-ресурса: Web Page, News, Image или Video. Запрос должен содержать абсолютный URL-адрес со схемой http или https. Относительные URL-адреса и другие схемы (например, ftp://) не поддерживаются.
...
|----------|-----------|----------|--------------|
|<a name="mkt" />mkt|Рынок, по которому возвращаются результаты. <br /><br />Список возможных значений рынка приведен в разделе "Коды рынка".<br /><br /> **ПРИМЕЧАНИЕ.** Сейчас API предварительного просмотра URL-адресов поддерживает только рынок США и английский язык.<br /><br />|String|Да|
