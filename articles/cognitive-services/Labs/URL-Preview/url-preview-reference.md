...
|----------|-----------|----------|--------------|
|<a name="mkt" />mkt|Рынок, по которому возвращаются результаты. <br /><br />Список возможных значений рынка приведен в разделе "Коды рынка".<br /><br /> **Примечание**. Сейчас API предварительного просмотра URL-адресов поддерживает только регион США и английский язык.<br /><br />|String|Да|
