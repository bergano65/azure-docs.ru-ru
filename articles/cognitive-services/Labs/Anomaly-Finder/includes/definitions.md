...
|**WarningText**  <br>*необязательный параметр*|Если указанные входные точки данных не следуют правилу, которого требует API, а данные по-прежнему могут быть обнаружены API, то API проанализирует данные и добавит предупредительную информацию в этом поле.|string|
