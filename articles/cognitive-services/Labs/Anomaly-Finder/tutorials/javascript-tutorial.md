---
title: Руководство. Обнаружение аномалий с использованием JavaScript
...
ms.locfileid: "55227837"
---
# <a name="tutorial-anomaly-detection-with-javascript-application"></a>Руководство. Обнаружение аномалий с помощью приложения JavaScript
