...
|Объект|Description|  
|------------|-----------------|  
|[WebPage]|Объект верхнего уровня JSON, содержащий атрибуты предварительного просмотра.|  
...
|Имя|Значение|Тип|  
|-------------|-----------------|----------|
|идентификатор|Идентификатор ресурса|String|
