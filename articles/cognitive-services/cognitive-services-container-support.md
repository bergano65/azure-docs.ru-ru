...
## <a name="view-webinar"></a>Просмотреть веб-семинар 

Присоединяйтесь к [веб-семинар](https://info.microsoft.com/AP-AZUREPLAT-WBNR-FY19-03Mar-20-Seamlesslyintegrateapplicationsdataandprocesses-MCW0012283_02OnDemandRegistration-ForminBody.html) Дополнительные сведения о:

* Развертывание Cognitive Services на любом компьютере, с помощью Docker
* Способ развертывания Cognitive Services в AKS
...
* [Контейнеры personalizer](https://go.microsoft.com/fwlink/?linkid=2083928&clcid=0x409)
