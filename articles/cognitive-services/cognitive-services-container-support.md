...
|--|--|--|--|
| [Детектор аномалий][ad-containers] | F0, S0 | **Аномалия — детектор** ( [изображение](https://hub.docker.com/_/microsoft-azure-cognitive-services-decision-anomaly-detector))  | API Детектор аномалий позволяет отслеживать и обнаруживать отклонения в данных временных рядов с помощью машинного обучения.<br>[Запрос доступа][request-access] |
