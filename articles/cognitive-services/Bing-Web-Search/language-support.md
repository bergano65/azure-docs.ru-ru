...
* [Image Search API v7 reference (Справочник по API Bing для поиска изображений)](//docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference)
