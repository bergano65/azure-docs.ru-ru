...
Полный список вариантов и параметров см. в разделе [API Поиска в Интернете Bing версии 7](/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-reference).
