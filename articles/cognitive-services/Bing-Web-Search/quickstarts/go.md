---
title: Краткое руководство. Поиск с помощью Go и API Bing для поиска в Интернете
titleSuffix: Azure Cognitive Services
description: Из этого краткого руководства вы узнаете, как вызвать API Bing для поиска в Интернете и получить ответ в формате JSON, используя Go.
...
ms.locfileid: "46128967"
---
# <a name="quickstart-use-go-to-call-the-bing-web-search-api"></a>Краткое руководство. Вызов API Bing для поиска в Интернете с использованием Go  
...
Этот код объявляет функцию main и задает необходимые переменные. Убедитесь, что конечная точка указана верно, и замените значение `token` действительным ключом подписки из своей учетной записи Azure. Вы можете настроить поисковый запрос, заменив значение параметра `searchTerm`.
...
Помните структуру, которую мы создали ранее? Мы используем ее, чтобы форматировать ответ и вывести на экран результаты поиска.
