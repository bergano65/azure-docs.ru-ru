...
По умолчанию Bing не включает маркеры выделения в отображаемых строках. Чтобы включить маркеры, включите в запрос `textDecorations` параметр запроса и задайте для `true`него значение.
