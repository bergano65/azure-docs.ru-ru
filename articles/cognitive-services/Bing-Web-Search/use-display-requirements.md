...
|API поиска    | К ним относятся API пользовательского поиска Bing, API Bing для поиска сущностей, API Bing для поиска изображений, API Bing для поиска новостей, API Bing для поиска видео, API Bing для визуального поиска, API локального бизнес-поиска Bing и API Bing для поиска в Интернете. |
