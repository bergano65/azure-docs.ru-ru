...
| Компьютерное зрение | Распознаватель документов | Средство маркировки данных | [Краткое руководство](./form-recognizer/quickstarts/label-tool.md?tabs=v2-0) |
