...
![Кривая окклюзии проекта](media/wwise-occlusion-curve.png)
...
![Кривая препятствий проекта](media/wwise-obstruction-curve.png)
...
![Параметры подключаемого модуля микшера Project Acoustics](media/mixer-plugin-global-settings.png)
...
![Параметры микшера для каждого звука](media/per-sound-mixer-settings.png)
...
![Рекомендации по проектированию голоса](media/voice-design-guidelines.png)
...
![Кривые затухания](media/atten-curve.png)
...
![Элементы управления акустического пространства](media/acoustics-space-controls.png)
...
* **Draw Stats** (Отрисовка статистики). Хотя в UE `stat Acoustics` может предоставить вам информацию о ЦП, это отображение состояния покажет загруженную карту, потребление ОЗУ и другие сведения о состоянии в верхней левой части экрана.
...
![Элементы управления компонента аудио](media/audio-component-controls.png)
...
![Схема потоковой передачи](media/blueprint-streaming.png)
...
![Настройка потоковой передачи](media/streaming-setup.png)
...
![Запрос расстояния](media/distance-query.png)
