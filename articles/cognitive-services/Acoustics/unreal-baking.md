...
![Открытие режима Acoustics](media/acoustics-mode.png)
...
![Сведения о вкладке объектов в Unreal](media/unreal-objects-tab-details.png)
...
![Сведения о вкладке объектов в Unreal](media/unreal-materials-tab-details.png)
...
![Подробные сведения о вкладке Probes (Зонды)](media/unreal-probes-tab-details.png)

1. Кнопка перехода на вкладку **Probes** (Зонды) позволяет открыть эту страницу.
2. Краткое описание действий, выполняемых с помощью этой страницы.
3. Здесь можно выбрать низкое (Coarse) или высокое (Fine) разрешение для грубого или точного моделирования соответственно. Грубое выполняется быстрее, но допускает некоторые неточности. Подробнее это описано в разделе [Низкое и высокое разрешение](#Coarse-vs-Fine-Resolution) ниже.
...
![Отрисовщик отладочной акустической информации](media/acoustics-debug-renderer.png)
...
![Включение отрисовки в реальном времени](media/unreal-real-time-rendering.png)
...
![Предварительный просмотр объемных пикселей](media/unreal-voxel-preview.png)
...
![Предварительный просмотр зондов](media/unreal-probes-preview.png)
...
![Дверной проем в низком разрешении](media/unreal-coarse-bake.png)

![Дверной проем в высоком разрешении](media/unreal-fine-bake.png)
...
![Подробные сведения о вкладке Bake (Наложение)](media/unreal-bake-tab-details.png)
