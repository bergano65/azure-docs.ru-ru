---
title: Часто задаваемые вопросы о службе "Project Acoustics"
...
№ Акустические параметры предварительно вычисляются на основе статического состояния уровня в игре. Мы предлагаем оставить дверь без акустики, а затем применить дополнительный эффект окклюзии на основе состояния разрушаемых и подвижных игровых объектов с использованием установленных методов.
...
Система учитывает потенциальные расположения игрока для создания набора равномерно расположенных позиций пробы. Процесс моделирования для уровня состоит из независимых задач для каждой пробы. Система рассматривает кубический регион моделирования, центрированный в пробе, и делает детальное моделирование волн в этой области с разрешением до 25 см.
