...
* **Outdoorness** (Открытое пространство). Аддитивная настройка того, как акустическая система должна обрабатывать источник звука, имитируя наружную среду. Значение 1 приведет к тому, что источник всегда будет звучать полностью как на открытом воздухе, а при значении –1 он будет звучать как в помещении.
...
* **Perceptual Distance Warp** (Ощущаемое искажение расстояния). Позволяет применить экспоненциальное искажение к расстоянию, используемое для вычисления коэффициента "сухого" и "влажного" звука. Акустическая система вычисляет уровни влажности во всем пространстве, которые плавно изменяются с расстоянием и обеспечивают признаки удаленности расстояния. Значения искажения, превышающие 1, преувеличивают этот эффект за счет увеличения уровней реверберации, связанных с расстоянием, делая звук "отдаленным", в то время как значение менее 1 делает изменение реверберации на основе расстояния более слабым, увеличивая эффект присутствия.
