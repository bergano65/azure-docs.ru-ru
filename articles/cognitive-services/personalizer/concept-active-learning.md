...
Узнайте, [как](how-to-learning-policy.md) импортировать и экспортировать политику обучения.
...
[Загрузите собственные политики обучения](how-to-learning-policy.md) , чтобы сравнить их с текущей политикой обучения.
