...
1. В портал Azure для ресурса персонализации на странице **модель и политика** выберите **Очистить данные**.
1. Чтобы очистить все данные и сбросить цикл обучения до исходного состояния, установите флажок все 3 флажка.
    ...
    |Сбросьте модель персонализации.|Эта модель изменяется при каждом повторном обучении. Эта частота обучения указана в поле **Частота модели отправки** на странице **Параметры** . |
