...
description: Эти рекомендации помогут вам реализовать персонализацию так, чтобы это способствовало доверительным отношениям внутри компании. Не забудьте сделать паузу, чтобы исследования, узнать и обдумать влияние персонализации на жизнь людей. При любых сомнениях обращайтесь за помощью.
...
Чтобы пользователи и общество могли воспользоваться потенциалом искусственного интеллекта, специалисты, которые добавляют искусственный интеллект в приложения, и пользователи, которые используют эти приложения, должны доверять качеству реализации. Эти рекомендации помогут вам реализовать Персонализатор так, чтобы это способствовало формированию доверительных отношений как внутри вашей компании, так и к используемой службе. Не забудьте сделать паузу, чтобы исследования, узнать и обдумать влияние персонализации на жизнь людей. При любых сомнениях обращайтесь за помощью.
...
Вы можете использовать этот материал в качестве исходного контрольного списка, адаптировав его под свой сценарий. Этот документ состоит из двух основных разделов: первый посвящен выделению ответственных соображений использования при выборе сценариев, функций и вознаграждений для Personalizer. Во втором указаны важные аспекты, которые корпорация Майкрософт считает важными при разработке систем искусственного интеллекта, а также предоставлены практические рекомендации и описаны риски, связанные с использованием Персонализатора в этом контексте.
...
* создание [функций вознаграждения](concept-rewards.md);
* выбор [признаков](concepts-features.md) для контекста и возможных действий, которые вы будете использовать для персонализации.
...
Примеры подобного применения Персонализатора включают сценарии, когда вознаграждение зависит от большого количества долгосрочных и сложных факторов, упрощенная обработка которых для получения немедленного вознаграждения приводит к неблагоприятным результатам для пользователей. Они, как правило, рассматриваются как "последовательный" выбор, или выбор, который связан с риском нанесения ущерба. Пример:


* **Финансы**: Персонализация предложений по кредитным, финансовым и страховым продуктам, где факторы риска основаны на данных, о которых люди не знают, не могут получить или не могут оспорить.
* **Образование**: Персонализация ряды для школьных курсов и учебных заведений, где рекомендации могут распространяться предубеждений и уменьшить осведомленность пользователей о других вариантах.
* **Демократия и гражданское участие:** Персонализация контента для пользователей с целью влияния на мнения является последовательным и манипулятивным.
* **Оценка вознаграждения сторонних сторон:** Персонализация элементов, где вознаграждение основано на последней оценке пользователя третьей стороной, вместо того, чтобы иметь вознаграждение, генерируемое собственным поведением пользователя.
* **Нетерпимость к разведке**: Любая ситуация, когда поведение разведки Personalizer может причинить вред.
...
* Подумайте, является ли ваш случай использования автоматизированной обработкой, которая существенно влияет на субъекты данных, которые регулируются [gdpR](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32016R0679) статьей 22 или другими законами.
* Оцените возможность отрицательной обратной связи (самоисполняющиеся пророчества). Это ситуации, когда вознаграждение персонализации обучает модель так, что она последовательно блокирует для демографических групп релевантное содержимое. Например, большинство людей в районе с низким уровнем дохода не получают премии страховое предложение, и медленно никто в районе, как правило, видят предложение на всех, если не хватает разведки.
...
* **Демографические данные пользователей**: Особенности, касающиеся пола, пола, возраста, расы, религии: Эти функции могут быть запрещены в некоторых приложениях по нормативным причинам, и это не может быть этичным, чтобы персонализировать вокруг них, потому что персонализация будет распространять обобщения и предвзятости. Например, распространением предрассудков можно считать отсутствие отображаемых инженерных вакансий людям пожилого возраста или определенного пола.
* **Информация**о локальном регионе : Во многих местах мира информация о местоположении (например, почтовый индекс, почтовый индекс или название района) может быть сильно коррелирована с доходами, расой и религией.
* **Восприятие пользователями справедливости:** Даже в тех случаях, когда ваше приложение принимает обоснованные решения, учитывайте влияние пользователей, воспринимающих, что содержимое отображается в приложении изменения таким образом, что, как представляется, коррелирует с функциями, которые будут дискриминационными.
* **Непреднамеренные предубеждения в особенностях**: Есть типы предубеждений, которые могут быть введены с помощью функций, которые влияют только на подмножество населения. Подобные ситуации требуют особого внимания, если признаки создаются алгоритмически, например при использовании анализа изображений для извлечения элементов или анализа текста для обнаружения сущностей. Учитывайте характеристики служб, которые вы используете для создания таких признаков.
...
* Спросите себя: Будут ли мои пользователи заботиться и быть счастливыми, если я использовал эту информацию для персонализации содержания для них? Можно ли будет спокойно сообщить пользователям о том, как принимались решения об отображении или сокрытии определенных элементов?
...
Рассмотрите задачи, связанные с ответственным использованием, как и другие задачи перекрестного использования в жизненном цикле приложения, такие как задачи, связанные с пользовательским опытом, безопасностью или DevOps. Недопустимо откладывать обсуждение таких задач и требований. Реализацию ответственного использования необходимо регулярно обсуждать и проверять на протяжении всего жизненного цикла приложения.
...
* Ознакомьтесь с шестью принципами microsoft по ответственному развитию ИИ, опубликованным в книге [«Будущее вычислений»](https://news.microsoft.com/futurecomputed/) за январь 2018 года
...
[Особенности: действие и контекст](concepts-features.md).
