...
• Предоставьте пользователям сведения о том, как персонализируется содержимое. Например, можно отобразить кнопку с надписью "Почему я вижу эти предложения?", с помощью которой пользователь сможет узнать о признаках и действиях, на основе которых Персонализатор получает результаты.
...
* *Предоставьте пользователям сведения о том, как персонализируется содержимое.* Например, можно отобразить кнопку с надписью `Why These Suggestions?`, с помощью пользователь сможет узнать о признаках и действиях, на основе которых Персонализатор получает результаты.
* Убедитесь, что в условиях использования упоминается, что вы намерены использовать сведения о пользователях для персонализации взаимодействия.

### <a name="fairness"></a>Справедливость
* Системы искусственного интеллекта должны работать с соблюдением беспристрастность по отношению ко всем людям.
...
Относитесь к задачам по ответственному использованию так же, как к другим задачам, которые затрагивают все смежные области (взаимодействие с пользователями, безопасность, DevOps и т. д.). Недопустимо откладывать обсуждение таких задач и требований. Реализацию ответственного использования необходимо регулярно обсуждать и проверять на протяжении всего жизненного цикла приложения.
