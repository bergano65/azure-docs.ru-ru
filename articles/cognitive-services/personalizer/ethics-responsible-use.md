...
description: Эти рекомендации помогут вам реализовать персонализацию так, чтобы это способствовало доверительным отношениям внутри компании. Не забудьте приостанавливаться в исследованиях, изучать и намеренно повлиять на воздействие персонализации на пользователей. При любых сомнениях обращайтесь за помощью.
...
Чтобы пользователи и общество могли воспользоваться потенциалом искусственного интеллекта, специалисты, которые добавляют искусственный интеллект в приложения, и пользователи, которые используют эти приложения, должны доверять качеству реализации. Эти рекомендации помогут вам реализовать Персонализатор так, чтобы это способствовало формированию доверительных отношений как внутри вашей компании, так и к используемой службе. Не забудьте приостанавливаться в исследованиях, изучать и намеренно повлиять на воздействие персонализации на пользователей. При любых сомнениях обращайтесь за помощью.
...
Вы можете использовать этот материал в качестве исходного контрольного списка, адаптировав его под свой сценарий. Этот документ состоит из двух основных разделов: Первый предназначен для выделения ответственных за использование при выборе сценариев, функций и вознаграждений для персонализации. Во втором указаны важные аспекты, которые корпорация Майкрософт считает важными при разработке систем искусственного интеллекта, а также предоставлены практические рекомендации и описаны риски, связанные с использованием Персонализатора в этом контексте.
...
Примеры подобного применения Персонализатора включают сценарии, когда вознаграждение зависит от большого количества долгосрочных и сложных факторов, упрощенная обработка которых для получения немедленного вознаграждения приводит к неблагоприятным результатам для пользователей. Они, как правило, считаются «косвенными» вариантами или вариантами, которые связаны с риском ущерба. Пример:


* **Финансы**. Персонализация предложений по ссудам, финансовым и страховым продуктам, в которых факторы риска основаны на данных, о которых не известны сотрудникам, не могут получить или невозможность спора.
* **Образование**: персонализированные рейтинги для учебных курсов и учебных учреждений, где рекомендации могут распространять смещения и сокращать осведомленность пользователей о других вариантах.
* **Демократия и гражданское участие**: Персонализация содержимого для пользователей с целью влияния на мнения, является существенным и манипуляцией.
* **Оценка**поощрений сторонних поставщиков. Персонализация элементов, в которых вознаграждение основано на последних сторонних оценках пользователя, а не о награде, создаваемой собственным поведением пользователя.
* **Недопустимый способ исследования**: любая ситуация, когда поведение при исследовании персонализации может привести к вреду.
...
* **Демографические сведения о пользователях**: функции, касающиеся секса, пола, возраста, состязания, системам. Эти функции могут быть недопустимы в некоторых приложениях по соображениям нормативных требований, и, возможно, не будет безупречно персонализировать их, так как Персонализация будет распространяться на обобщения и сдвиг. Например, распространением предрассудков можно считать отсутствие отображаемых инженерных вакансий людям пожилого возраста или определенного пола.
* **Сведения о языковых стандартах**. во многих местах мира сведения о расположении (например, почтовый индекс, почтовый индекс или имя окружения) могут быть очень тесно связаны с доходностью, состязанием и системам.
* **Восприятие пользователем равноправия**. даже в тех случаях, когда ваше приложение принимает решение о звуке, следует рассмотреть воздействие пользователей на то, что содержимое, отображаемое в приложении, меняется таким образом, чтобы оно сопоставлено с функциями, которые были бы перцеивинг.
* **Непреднамеренное смещение в функциях**: существуют типы смещений, которые могут быть введены с помощью функций, которые влияют только на подмножество Генеральной совокупности. Подобные ситуации требуют особого внимания, если признаки создаются алгоритмически, например при использовании анализа изображений для извлечения элементов или анализа текста для обнаружения сущностей. Учитывайте характеристики служб, которые вы используете для создания таких признаков.
...
* Задайте себе вопрос: будут ли мои пользователи осторожно и с радостью использовать эти сведения для настройки содержимого? Можно ли будет спокойно сообщить пользователям о том, как принимались решения об отображении или сокрытии определенных элементов?
...
### <a name="accountability"></a>Ответственность
...
*Системы AI должны быть понятны*. При использовании Персонализатора:
...
В *искусственных системах все люди должны работать довольно*.
...
*Системы AI должны работать надежно и безопасно*. При использовании Персонализатора:
...
*Системы AI должны быть безопасными и соблюдаться в конфиденциальности*. При использовании Персонализатора:
...
* Ознакомьтесь с разделом шести принципов разработки искусственного интеллекта корпорации Майкрософт, опубликованного в 2018 января, [в будущем, вычисленном](https://news.microsoft.com/futurecomputed/)
...
[Функции: действие и контекст](concepts-features.md).
