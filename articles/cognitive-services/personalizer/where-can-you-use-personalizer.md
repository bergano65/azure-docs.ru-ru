...
Персонализация использует машинное обучение для выбора действия (содержимого), которое будет отображаться для пользователя. Показываемые варианты значительно зависят от количества, качества и распределения данных, отправленных в службу.
