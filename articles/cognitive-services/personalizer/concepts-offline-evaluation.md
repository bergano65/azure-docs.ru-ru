---
title: Автономная оценка. Персонализатор
...
После автономной оценки вы увидите эффективность службы "Персонализатор" с этой новой политикой по сравнению с текущей онлайн-политикой. Затем вы можете применить эту политику обучения, чтобы она немедленно вступила в силу в службе "Персонализатор", или скачать ее для дальнейшего анализа или использования.
...
[Настройка Персонализатора](how-to-settings.md)
