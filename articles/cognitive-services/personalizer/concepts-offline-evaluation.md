...
[Настройка](how-to-settings.md)
[выполнения автономных вычислений](how-to-offline-evaluation.md) в программе персонализации Узнайте, [как работает Персонализация](how-personalizer-works.md)
