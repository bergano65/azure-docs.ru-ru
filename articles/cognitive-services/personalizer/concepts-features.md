...
Персонализатор не задает, не определяет и не ограничивает признаки, которые вы можете отправлять для действий и контекста:
