...
Вы настраиваете процент трафика для исследования на странице **конфигурации** портала Azure для Personalizer. Этот параметр определяет процент анализируемых вызовов ранжирования. 
