...
- Учетная запись Microsoft Azure. [Создайте бесплатную учетную запись](https://azure.microsoft.com/free/cognitive-services/) или [Войдите в нее](https://portal.azure.com/).
...
|---------|---------|---|---|
| Инициализация переменной | var_person | Строковый | Модель Person |
| Инициализация переменной 2 | var_phone | Строковый | Phone_Number |
| Инициализация переменной 3 | var_plumbing | Строковый | коммуникаций |
| Инициализация переменной 4 | var_other | Строковый | др. | 
...
| Поле           | Значение                                                                                                             |
|-----------------|-------------------------------------------------------------------------------------------------------------------|
| Имя подключения | Имя для подключения к ресурсу Анализ текста. Пример: `TAforPowerAutomate`. |
