...
|---------|---------|---|---|
| Инициализация переменной | var_person | String | Человек |
| Инициализация переменной 2 | var_phone | String | Phone_Number |
| Инициализация переменной 3 | var_plumbing | String | коммуникаций |
| Инициализация переменной 4 | var_other | String | иное | 
...
| Поле           | Значение                                                                                                             |
|-----------------|-------------------------------------------------------------------------------------------------------------------|
| Имя соединения | Имя для подключения к ресурсу Анализ текста. Например, `TAforPowerAutomate`. |
