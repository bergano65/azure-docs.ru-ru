...
ms.locfileid: "73750143"
---
# <a name="quickstart-use-the-text-analytics-client-library-for-detecting-language"></a>Краткое руководство. Определение языка с помощью клиентской библиотеки Анализа текста
