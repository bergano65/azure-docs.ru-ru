...
1. Выберите пакет NuGet и установите его. Сейчас (по состоянию на 18 марта 2019 г.) может потребоваться временный возврат к версии 2.8.0, пока не будет обновлен пример кода для версии 3.0.0.
