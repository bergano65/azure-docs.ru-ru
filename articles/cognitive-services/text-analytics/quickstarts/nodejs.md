...
2. Добавьте в новый файл `.js` указанный ниже код.
3. Замените значение `accessKey` ключом подписки из ресурса службы "Анализ текста" в Azure.
4. Замените расположение в `uri` (в настоящее время `westus`) на свой регион регистрации.
5. Запустите программу из IDE или командной строки, например `npm start` или `node detect.js`.
...
3. Замените значение `accessKey` ключом подписки из ресурса службы "Анализ текста" в Azure.
4. Замените расположение в `uri` (в настоящее время `westus`) на свой регион регистрации.
5. Запустите программу из IDE или командной строки, например `npm start` или `node sentiment.js`.
...
3. Замените значение `accessKey` ключом подписки из ресурса службы "Анализ текста" в Azure.
4. Замените расположение в `uri` (в настоящее время `westus`) на свой регион регистрации.
5. Запустите программу из IDE или командной строки, например `npm start` или `node key-phrases.js`.
...
3. Замените значение `accessKey` ключом подписки из ресурса службы "Анализ текста" в Azure.
4. Замените расположение в `uri` (в настоящее время `westus`) на свой регион регистрации.
5. Запустите программу из IDE или командной строки, например `npm start` или `node entities.js`.
