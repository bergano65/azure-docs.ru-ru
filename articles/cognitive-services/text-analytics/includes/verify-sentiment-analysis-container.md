...
Теперь можно сопоставить документ `id` JSON полезных данных ответа с исходным документом полезных данных запроса `id` . Оценка больше `0.98` указывает на очень положительный тональности.