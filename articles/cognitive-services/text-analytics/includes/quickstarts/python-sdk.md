...
Кроме того, вы можете использовать операцию анализа для обнаружения персональных данных и извлечения ключевых фраз. [Пример анализа](https://github.com/Azure/azure-sdk-for-python/blob/master/sdk/textanalytics/azure-ai-textanalytics/samples/async_samples/sample_analyze_async.py) см. на сайте GitHub.
