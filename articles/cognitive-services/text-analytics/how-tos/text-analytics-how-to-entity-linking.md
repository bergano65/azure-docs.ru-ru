...
## <a name="sending-a-rest-api-request"></a>Отправка запроса REST API

### <a name="preparation"></a>Подготовка

Необходимо иметь документы JSON в следующем формате: ID, Text, Language.

Каждый документ должен содержать не более 5 120 символов, и в каждой коллекции может быть до 1 000 элементов (идентификаторов). Коллекция передается в тексте запроса.
...
#### <a name="version-3tabversion-3"></a>[Версия 3](#tab/version-3)
...
Задайте заголовок запроса для включения ключа API анализа текста. В тексте запроса укажите подготовленные документы JSON.
...
API анализа текста не имеет состояния. В вашей учетной записи данные не хранятся, и результаты немедленно возвращаются в ответе.
...
* [Использование клиентской библиотеки Анализ текста](../quickstarts/text-analytics-sdk.md)
