...
Анализ тональности поддерживает широкий спектр языков, и еще несколько сейчас находятся в режиме предварительной версии. Дополнительные сведения см. в [списке поддерживаемых языков](../language-support.md).
