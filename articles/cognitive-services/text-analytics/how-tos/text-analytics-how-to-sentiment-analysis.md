...
Метки: `positive`, `negative` и `neutral`. На уровне документа может также возвращаться метка тональности `mixed`. Тональность документа определяется следующим образом.
...
Оценки достоверности колеблются в диапазоне от 1 до 0. Оценки, близкие к 1, указывают на более высокую достоверность в классификации метки, а более низкие оценки указывают на более низкую достоверность. Оценки достоверности в каждом документе или предложении в сумме составляют 1.
