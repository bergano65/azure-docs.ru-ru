...
> * Для доступа к Анализ текста контейнеру работоспособности требуется [Форма запроса](https://aka.ms/cognitivegate). В настоящее время плата за использование не взимается.
...
# <a name="text-analytics-for-health-preview"></a>[Анализ текста для работоспособности (Предварительная версия)](#tab/healthcare)
...
* Анализ текста предоставляет три контейнера Linux для DOCKER, включая различные возможности:
   ...
   * *Анализ текста для работоспособности (Предварительная версия)*
