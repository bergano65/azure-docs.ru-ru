...
## <a name="classify-and-redact-documents-that-have-sensitive-information"></a>Классификация и отредактивание документов, которые имеют конфиденциальную информацию

Используйте распознавание именованных сущностей для идентификации личной и конфиденциальной информации в документах. Используйте данные для классификации документов или их отделать, чтобы их можно было безопасно обмениваться ими.

![Изображение, описывающее, как использовать NER для обнаружения личной информации и классификации и отсечения документов](media/use-cases/sensitive-docs.jpg)
