...
* [Quickstart: Use the Text Analytics client library for detecting language](quickstarts/client-libraries-rest-api.md) (Краткое руководство. Вызов клиентской библиотеки "Анализ текста" для определения языка)
