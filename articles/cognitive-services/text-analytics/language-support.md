...
Для других языков `Location` возвращаются только именованные сущности и `Organization` `Person`
...
\** Также доступно в [Анализ тональности v3](https://docs.microsoft.com/azure/cognitive-services/text-analytics/how-tos/text-analytics-how-to-sentiment-analysis#sentiment-analysis-versions-and-features) и (или) [с именем "распознавание открытых сущностей v3](how-tos/text-analytics-how-to-entity-linking.md#named-entity-recognition-versions-and-features) ".

## <a name="see-also"></a>См. также

[Страница документации Cognitive Services](https://docs.microsoft.com/azure/cognitive-services/)   
