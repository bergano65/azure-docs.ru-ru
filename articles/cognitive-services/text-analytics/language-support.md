...
| Язык    | Код языка | Мнение | Ключевые фразы | Распознавание именованных сущностей |   Заметки  |
|:----------- |:-------------:|:---------:|:-----------:|:-----------:|:-----------:
| Арабский      | `ar`          |           |             | ✔ \*                     | |
| Чешский       | `cs`          |           |             | ✔ \*                     | |
...
для этого языка доступны \*\* [распознаванию](how-tos/text-analytics-how-to-entity-linking.md#named-entity-recognition-ner) сущностей и [связывание сущностей](how-tos/text-analytics-how-to-entity-linking.md#entity-linking) .  
