...
ms.locfileid: "84142169"
---
# <a name="text-analytics-api-v3-language-support"></a>Поддержка языков API анализа текста v3 

> [!IMPORTANT]
> Версия 3. x API анализа текста сейчас недоступна в следующих регионах: Центральная Индия, Fairfax, Северная Народно-Африканская Республика, Южная Африка, сев., Северный Китай 2 Восточный Китай.
