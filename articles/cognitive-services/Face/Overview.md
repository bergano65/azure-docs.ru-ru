...
-->
![Юридическая информация ](./media/overview/banner.png)
...
Служба "Распознавание лиц" предоставляет несколько разных функций, каждая из которых описана в следующих разделах.
