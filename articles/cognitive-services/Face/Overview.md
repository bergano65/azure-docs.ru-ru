...
> [!NOTE]
> Функция определения лиц также доступна через [службу "Компьютерное зрение"](../computer-vision/overview.md). Однако, если вы хотите выполнить последующие операции с данными распознавания лиц, следует использовать эту службу.
