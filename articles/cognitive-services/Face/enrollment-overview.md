...
|Безопасность | Cognitive Services работает согласно [рекомендациям](../cognitive-services-virtual-networks.md?tabs=portal) для шифрования неактивных и передаваемых данных пользователя. Ниже приведены дополнительные рекомендации, которые помогут вам реализовать гарантии безопасности, которые предоставляются пользователям при регистрации. </br></br>Примите меры безопасности, чтобы ни у кого не было доступа к идентификатору пользователя ни на каком этапе регистрации. Примечание. Идентификатор пользователя в системе регистрации следует рассматривать как секрет. </br></br>Использование [управления доступом на основе ролей](../../role-based-access-control/overview.md) с Cognitive Services. </br></br>Для доступа к таким ресурсам, как базы данных, отдавайте предпочтение проверке подлинности на основе маркеров и (или) подписанным URL-адресам (SAS) перед ключами и секретами. С помощью маркеров запросов или SAS можно предоставить ограниченный доступ к данным без риска компрометации ключей учетной записи. Кроме того, для маркера можно задать время окончания срока действия. </br></br>Ни в коем случае не храните секреты, ключи или пароли в приложении. |
