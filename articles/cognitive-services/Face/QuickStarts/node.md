...
ms.locfileid: "49954104"
---
# <a name="quickstart-detect-faces-in-an-image-using-the-rest-api-and-nodejs"></a>Краткое руководство. Обнаружение лиц на изображении с помощью REST API и Node.js
