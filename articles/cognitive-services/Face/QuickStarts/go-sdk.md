---
title: Краткое руководство. Клиентская библиотека Распознавания лиц для Go | Документация Майкрософт
...
ms.locfileid: "76961230"
---
# <a name="quickstart-face-client-library-for-go"></a>Краткое руководство. Клиентская библиотека Распознавания лиц для Go
...
Следующие классы и интерфейсы воплощают некоторые основные функции пакета SDK для службы "Распознавание лиц" для Go.
