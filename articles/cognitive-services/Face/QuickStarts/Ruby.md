...
Вам нужно будет обновить значение `request['Ocp-Apim-Subscription-Key']`, указав значение вашего ключа подписки, и изменить строку `uri`, добавив в нее требуемую конечную точку.
