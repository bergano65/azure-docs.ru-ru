...
6. Введите путь к изображению в командной строке.
...
> [Руководство по началу работы с API распознавания лиц на C#](../Tutorials/FaceAPIinCSharpTutorial.md)
