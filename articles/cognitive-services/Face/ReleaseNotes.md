...
* Добавлена функция моментального снимка для поддержки миграции данных между подписками. [Моментальный снимок](https://docs.microsoft.com/rest/api/cognitiveservices/face/snapshot).
