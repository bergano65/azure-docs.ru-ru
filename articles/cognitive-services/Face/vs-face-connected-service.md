---
title: Руководство. Подключенная служба "Распознавание лиц"
titleSuffix: Azure Cognitive Services
description: Создание приложения Windows, которое использует службу "Распознавание лиц" Cognitive Services для обнаружения особенностей лиц на изображении.
...
ms.locfileid: "76170239"
---
# <a name="connect-to-the-face-service-by-using-connected-services-in-visual-studio"></a>Подключение к службе "Распознавание лиц" с помощью компонента "Подключенные службы" в Visual Studio

С помощью службы "Распознавание лиц" Azure можно обнаруживать, анализировать, систематизировать и помечать лица на фотографиях.

В этой статье и других статьях этого цикла приводятся сведения об использовании компонента "Подключенная служба" Visual Studio для службы "Распознавание лиц". Эта возможность доступна как в Visual Studio 2017 15.7, так и в более поздней версии с установленным расширением Cognitive Services.
...
- Visual Studio 2017 версии 15.7 или более поздней с установленной рабочей нагрузкой **Веб-разработка**. [Скачайте это приложение](https://www.visualstudio.com/downloads/).

[!INCLUDE [vs-install-cognitive-services-vsix](../../../includes/vs-install-cognitive-services-vsix.md)]

## <a name="create-a-project-and-add-support-for-face"></a>Создание проекта и добавление поддержки службы "Распознавание лиц"
...
1. Выберите подписку, которую необходимо использовать, придумайте имя для службы "Распознавание лиц" или выберите ссылку "Изменить", чтобы изменить автоматически созданное имя, а затем выберите группу ресурсов и ценовую категорию.
...
1. Щелкните "Добавить", чтобы добавить поддержку для подключенной службы.
   Visual Studio модифицирует проект, чтобы добавить пакеты NuGet, записи файла конфигурации и другие изменения для поддержки подключения службы "Распознавание лиц".

## <a name="use-the-face-service-to-detect-attributes-of-faces-in-an-image"></a>Использование службы "Распознавание лиц" для обнаружения атрибутов лиц на изображении
...
1. Замените метод Configure следующим кодом, чтобы получить доступ к службе "Распознавание лиц" и протестировать изображение. Замените строку imagePath на правильный путь и имя файла для изображения лица.
...
1. Запустите веб-приложение и посмотрите, что будет найдено на изображении с помощью службы "Распознавание лиц".
 
   ![Изображение и отформатированные результаты службы "Распознавание лиц"](media/vs-face-connected-service/Cog-Face-Connected-Service-4.PNG)
...
Дополнительные сведения о службе "Распознавание лиц" см. [Документация по службе "Распознавание лиц"](Overview.md).
