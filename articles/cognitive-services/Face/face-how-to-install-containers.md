...
| Параметр | ОПИСАНИЕ |
|--------|-------------|
| `ApiKey` | Ключ API ресурса _API распознавания лиц_, используемый для отслеживания информации о выставлении счетов. |
| `Billing` | Конечная точка ресурса _API распознавания лиц_, используемого для отслеживания сведений о выставлении счетов.|
