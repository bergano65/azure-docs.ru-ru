...
В глоссарии Распознавание речи (LUIS) рассказывается о терминах, которые могут возникнуть при работе со службой LUIS.
...
Пакетное тестирование — это возможность проверить модели текущего приложения LUIS с помощью единообразного и известного тестового набора пользователей фразы продолжительностью. Пакетный тест определяется в [отформатированном файле JSON](./luis-how-to-batch-test.md#batch-test-file).


См. также
* [Основные понятия](./luis-how-to-batch-test.md)
* [Как](luis-how-to-batch-test.md) выполнить пакетный тест
* [Руководство](./luis-how-to-batch-test.md) . Создание и запуск пакетного теста
...
## <a name="overfitting"></a>Переобучение
...
### <a name="prediction-resource"></a>Ресурс для прогнозирования
...
## <a name="utterance"></a>Речевой фрагмент
