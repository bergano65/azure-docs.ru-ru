...
Вложенная сущность является дочерней сущностью, занятой компьютером.

### <a name="non-machine-learned-entity"></a>Сущность, которая не является машиной
...
Этот термин также называется **[компонентом, предназначенным для компьютера](luis-concept-feature.md)**.
...
[Ключ прогнозирования](luis-concept-keys.md) (ранее известный как ключ подписки) — это ключ, связанный со службой Luis, созданной в Azure, которая разрешает использование конечной точки прогнозирования.
...
|Фразу|Число маркеров|Объяснение|
|--|--|--|
