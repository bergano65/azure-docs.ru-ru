...
Этот тип тестирования аналогичен [пакетному тестированию](./luis-concept-batch-test.md) , которое можно выполнять в интерактивном режиме на портале Luis.
...
Используйте [синтаксис пакетного файла](./luis-concept-batch-test.md#batch-syntax-template-for-intents-with-entities) Luis для определения группы тестов в файле в формате JSON. Пример:
...
Наборы пакетных тестов должны содержать большое количество тестовых случаев, предназначенных для тестирования всех целей и всех сущностей в приложении LUIS. Сведения об определении набора пакетных тестов см. [в разделе пакетное тестирование на портале Luis](./luis-concept-batch-test.md) .
