...
ms.locfileid: "73487733"
---
# <a name="batch-testing-with-1000-utterances-in-luis-portal"></a>Пакетное тестирование 1000 высказываний на портале LUIS

Пакетное тестирование проверяет активную обученную версию для измерения точности прогнозов. Пакетный тест позволяет просматривать точность каждой цели и сущности в активной версии, отображая результаты с диаграммой. Изучите результаты пакетного теста, чтобы предпринять соответствующие действия для повышения точности, например добавить дополнительный пример фразы продолжительностью к намерениям, если приложение часто не может найти правильные намерения или метки в utterance.
