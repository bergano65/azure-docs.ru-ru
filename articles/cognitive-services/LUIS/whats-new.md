...
* Новые, расширенные [ограничения](luis-limits.md) — более высокие значения для списков фраз и итоговых фраз, Новая модель — ограничения функций
