...
При фильтрации _kind_ресурсов в `LUIS.Authoring`портал Azure используйте тип. LUIS ограничивает число приложений 500 на ресурс, созданный Azure.
...
При фильтрации _kind_ресурсов в `LUIS`портал Azure используйте тип. Ресурс конечной точки прогнозирования запросов LUIS, используемый в среде выполнения, допустим только для запросов к конечной точке.
