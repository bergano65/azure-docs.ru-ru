...
|Компоненты сущности ML|Все компоненты сущности, полученные от компьютера (дочерние сущности), должны быть уникальными в пределах этой сущности для компонентов на одном уровне.|
