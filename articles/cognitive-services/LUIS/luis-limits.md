...
| [Фраза][utterances] | 500 символов<br><br>Если текст длиннее, чем это ограничение, необходимо сегментировать utterance до ввода в LUIS и объединить ответы соответствующим образом. Есть очевидные перерывы, с которыми можно работать, например знаки пунктуации и длинные паузы в речи.|
