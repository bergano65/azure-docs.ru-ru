...
* Измените схему приложения LUIS. Сюда входит выполнение следующих задач.
...
|Объект|Чтобы завершить намерение, необходимо **извлечь** данные из utterance. К примерам относятся Дата и время поездки и расположение.|
