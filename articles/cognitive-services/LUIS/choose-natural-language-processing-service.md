---
title: Использование когнитивных служб NLP для обогащения разговоров
titleSuffix: Azure Cognitive Services
description: 'Cognitive Services предоставляет две услуги по обработке естественного языка: Language Understanding и snA Maker, каждая из которых имеет различную цель. Поймите, когда использовать каждую услугу и как они дополняют друг друга.'
author: diberry
ms.author: diberry
manager: nitinme
ms.topic: conceptual
...
---
# <a name="use-cognitive-services-with-natural-language-processing-nlp-to-enrich-bot-conversations"></a>Используйте cognitive Services с обработкой естественного языка (NLP), чтобы обогатить разговоры ботов

Cognitive Services предоставляет две услуги по обработке естественного языка, [Language Understanding](what-is-luis.md) и [SnA Maker,](../qnamaker/overview/overview.md)каждая с другой целью. Поймите, когда использовать каждую услугу и как они дополняют друг друга. 
