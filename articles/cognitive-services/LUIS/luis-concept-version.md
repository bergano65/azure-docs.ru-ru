...
Экспортированный файл не содержит сведения, прошедшие машинное обучение, так как после импорта приложение обучается повторно. Экспортированный файл не содержит сведений об участнике.
...
## <a name="contributions-from-collaborators"></a>Вклады участников совместной работы
