---
title: Устаревшие предварительно созданные сущности — LUIS
...
#### <a name="3-geography-subtypes"></a>3 подтипа сущности geography

Предварительно созданная сущность   |   Пример фразы   |   JSON
------|------|------|
...
## <a name="encyclopedia-culture"></a>Язык и региональные параметры для сущности encyclopedia
...
Предварительно созданная сущность   |   Предварительно созданная сущность (подтипы)   |   Пример фразы
------|------|------|
