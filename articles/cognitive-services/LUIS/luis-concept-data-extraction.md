...
|--|--|--|--|
|Блокировка с намерением|Строковый тип|topScoringIntent.intent|"GetStoreInfo"|
...
|--|--|--|--|:--|
|Блокировка с намерением|Строковый тип|intents[0].intent|"GetStoreInfo"|0,984749258|
|Блокировка с намерением|Строковый тип|intents[1].intent|"None"|0,0168218873|
...
|--|--|--|--|--|
|Служебные программы|Блокировка с намерением|Строковый тип|intents[0].intent|"<b>Utilities</b>.ShowNext"|
|Связь|Блокировка с намерением|Строковый тип|intents[1].intent|<b>Communication</b>.StartOver"|
||Блокировка с намерением|Строковый тип|intents[2].intent|"None"|
...
Если во время [публикации](luis-how-to-publish-app.md#sentiment-analysis)настраивается анализ тональности, ответ JSON Luis включает в себя анализ тональности. Дополнительные сведения об анализе тональности см. в документации по [анализу текста](https://docs.microsoft.com/azure/cognitive-services/text-analytics/).

## <a name="key-phrase-extraction-entity-data"></a>Данные сущности извлечения ключевой фразы
[Сущность извлечения ключевых фраз](luis-reference-prebuilt-keyphrase.md) возвращает ключевые фразы в utterance, предоставляемые [анализ текста](https://docs.microsoft.com/azure/cognitive-services/text-analytics/).
