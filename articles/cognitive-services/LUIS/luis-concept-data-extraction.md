...
description: Извлечение данных из текста utterance с намерения и сущности. Узнайте, какие данные можно извлечь из Language Understanding (LUIS).
...
В зависимости от языка и региональных параметров формат имен людей может незначительно отличаться. Воспользоваться либо заранее **[personName](luis-reference-prebuilt-person.md)** сущности или **[простого объекта](luis-concept-entity-types.md#simple-entity)** с [ролей](luis-concept-roles.md) первого и Фамилия. 

При использовании простого объекта, убедитесь, что для примеров, использующих имя и Фамилия в различных частях utterance, фразы разной длины и фразы для всех целей, включая None намерений. Регулярно [просматривайте](luis-how-to-review-endoint-utt.md) высказывания конечной точки, чтобы помечать имена, которые были неправильно спрогнозированы.
...
Некоторые приложения должны иметь возможность поиска новых имен, например имен продуктов и компаний. Эти типы имен — это самая сложная тип извлечения данных. Начинаются с **[простого объекта](luis-concept-entity-types.md#simple-entity)** и добавьте [списка фраз](luis-concept-feature.md). Регулярно [просматривайте](luis-how-to-review-endoint-utt.md) высказывания конечной точки, чтобы помечать имена, которые были неправильно спрогнозированы.
