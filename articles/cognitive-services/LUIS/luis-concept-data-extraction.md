...
|--|--|--|--|
|Блокировка с намерением|String|topScoringIntent.intent|"GetStoreInfo"|
...
|--|--|--|--|:--|
|Блокировка с намерением|String|intents[0].intent|"GetStoreInfo"|0,984749258|
|Блокировка с намерением|String|intents[1].intent|"None"|0,0168218873|
