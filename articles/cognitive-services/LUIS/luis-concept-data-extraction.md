...
|Объект данных|Тип данных|Расположение данных|Применение|
|--|--|--|--|
...
|Объект данных|Тип данных|Расположение данных|Применение|Оценка|
|--|--|--|--|:--|
...
|Домен|Объект данных|Тип данных|Расположение данных|Применение|
|--|--|--|--|--|
...
Без `verbose=true` параметра QueryString.
...
С `verbose=true` помощью в качестве параметра QueryString.
...
С `verbose=true` помощью в строке запроса:
