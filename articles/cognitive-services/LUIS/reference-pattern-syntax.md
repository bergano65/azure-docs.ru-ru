...
> [!CAUTION]
> Шаблоны включают только те элементы, которые изучены компьютером, а не подсущности.
...
|or| \|— Вертикальная черта (вертикальная черта)<br><br>На вертикальных панелях (или) в одной группе имеется ограничение 2 |-|Где имеет форму ({Form-Name-Short} &#x7c; {форма-Name-Long} &#x7c; {форма-номер})|
