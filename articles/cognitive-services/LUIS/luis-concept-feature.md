...
[Создайте список фраз](luis-how-to-add-features.md) , если приложение содержит слова или фразы, важные для приложения, такие как:
...
Список взаимозаменяемых фраз — это сигнал, который повышает уровень обнаружения в LUIS. Список фраз указывает на слова или фразы, которые более важны, чем другие слова. Это помогает как в определении намерения, так и в определении сущности. Например, предположим, у вас есть предметная область, например путешествия, которая носит глобальный характер (то есть разные культуры, но на одном языке). Есть слова и фразы, которые важны для приложения, но не являются синонимами. 
...
## <a name="phrase-lists-help-identify-simple-interchangeable-entities"></a>Списки фраз помогают определить простые взаимозаменяемые сущности
...
Хотя как список фраз, так и [сущности со списком](reference-entity-list.md) могут повлиять на фразы продолжительностью по всем методам, каждое делает это по-разному. Список фраз влияет на оценку прогнозирования намерения. Сущность списка влияет на извлечение сущности для точного текстового совпадения. 
...
Если вы хотите иметь возможность распознать новые экземпляры сущности, например, планировщик собрания, который должен распознать имена новых контактов, или приложение инвентаризации, которое должно распознать новые продукты, используйте другой тип сущности, предназначенной для компьютера, такой как простая сущность. Затем создайте список фраз, состоящий из слов и фраз, который поможет LUIS найти другие слова, аналогичные сущности. Этот список поможет LUIS распознавать примеры сущности путем добавления дополнительных смыслов к значению этих слов. 
