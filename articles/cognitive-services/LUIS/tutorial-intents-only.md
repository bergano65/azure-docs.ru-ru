---
title: Руководство. Прогнозирование намерений — LUIS
...
ms.locfileid: "76262761"
---
# <a name="tutorial-build-a-luis-app-to-determine-user-intentions"></a>Руководство. созданию приложения LUIS для определения намерений пользователя
