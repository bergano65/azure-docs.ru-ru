...
|`options.datetimeReference`|string|Только версия 3|по умолчанию|Используется для определения [datetimeV2 смещение](luis-concept-data-alteration.md#change-time-zone-of-prebuilt-datetimev2-entity).|
...
|`query`|string|Только версия 3|Обязательный элемент.|**В версии 2**, utterance в качестве прогнозируемых находится в `q` параметра. <br><br>**В версии 3**, переданный функции `query` параметра.|
