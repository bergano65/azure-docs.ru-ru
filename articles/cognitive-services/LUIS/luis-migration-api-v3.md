...
## <a name="prebuilt-domains-with-new-models-and-language-coverage"></a>Предварительно созданных доменов с помощью новых моделей и языков

Просмотрите [V3 API список предварительно созданных доменов](luis-reference-prebuilt-domains.md). Эти домены являются более полный, как в модели, а также язык покрытия. 
