...
1. Добавьте некоторые примеры речевых фрагментов. Текст, который необходимо спрогнозировать как Pattern.any, имеет **жирный шрифт**. Имя формы сложно определить по другим словам в речевом фрагменте. Pattern.any позволяет помечать границы сущности.
    ...
    |--|--|
    |Где находится форма **Действия при возгорании в лаборатории** и кто должен подписать ее после прочтения?|Действия при возгорании в лаборатории
    |Где находится форма **Запрос на перевод от нового сотрудника компании** на сервере?|Запрос на перевод от нового сотрудника компании|
    |Кто создал форму **Запросы, связанные со здоровьем и благополучием сотрудников в главном корпусе** и какая ее текущая версия?|Запросы, связанные со здоровьем и благополучием сотрудников в главном корпусе|
    |Я ищу форму с названием **Запрос на перемещение офиса (включая физические ресурсы)**. |Запрос на перемещение офиса (включая физические ресурсы)|
