...
## <a name="creating-an-entity-is-different-from-labeling-an-entity"></a>Создание сущности отличается от пометки сущности

Прежде чем можно будет пометить сущность в примере utterance, необходимо создать сущность. 
...
|--|--|
|Сущность, занятая компьютером|Сущности или сведения о намерениях|
