...
## <a name="add-regular-expression-entities-for-highly-structured-concepts"></a>Добавление сущностей регулярное выражение для структурированы основные понятия
