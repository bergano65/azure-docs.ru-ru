...
> [!Note]
> Когда красная линия находится под слово или фразу в примере utterance, [ошибка прогноза сущности](luis-how-to-add-example-utterances.md#entity-status-predictions) произошла. Необходимо исправить. 
