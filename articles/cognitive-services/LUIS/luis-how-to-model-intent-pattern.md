...
1. Выберите **шаблоны** на левой панели в разделе **улучшение производительности приложения**.
...
1. В диалоговом окне **Выбор типа сущности** введите имя сущности в поле **имя** и выберите **шаблон. Any** в качестве **типа** , а затем выберите **создать**.
    ...
    После [создания шаблона utterance](luis-how-to-model-intent-pattern.md) с помощью этой сущности сущность извлекается с помощью комбинированного алгоритма машинного обучения и сопоставления текста.
...
1. На странице сведения о намерениях выберите строку для примера utterance, которую нужно использовать в качестве шаблона utterance, а затем выберите **+ Добавить как шаблон** на панели инструментов контекста.
    ...
    Utterance должен включать сущность, чтобы создать шаблон из utterance.

1. Во всплывающем окне выберите **Готово** на странице **Подтверждение шаблонов** . Не нужно определять вложенные сущности или функции сущностей. Вам нужно только получить список сущностей машинного обучения.
