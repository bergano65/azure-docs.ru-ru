...
1. Во всплывающем окне выберите **Готово** на странице **Подтверждение шаблонов** . Не нужно определять вложенные сущности или функции сущностей. Вам нужно только получить список известных для компьютера сущностей.
