...
|401|Создание и настройка|Используется ключ подписки для конечной точки вместо ключа разработки|
...
|401|Создание и настройка|Вы не являетесь владельцем или участником совместной работы|
|401|Создание и настройка|Недопустимый порядок вызовов API|
