---
title: Создание бота на Node.js с помощью Bot Framework версии 3
titleSuffix: Azure Cognitive Services
description: Создайте бота, интегрированного с приложением LUIS, на основе платформы Bot Framework 3.x и с помощью бота веб-приложения.
...
1. На [портале Azure](https://portal.azure.com) в колонке меню выберите **Создать ресурс**, а затем выберите **Показать все**.
    ...
    ![Отображение всех ресурсов на портале Azure](./media/luis-tutorial-node-bot/bot-service-creation.png)
