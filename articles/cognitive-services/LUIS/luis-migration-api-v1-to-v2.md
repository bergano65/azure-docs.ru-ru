...
description: Версия 1 конечная точка и авторство язык понимая AIS являются deprecated. Используйте это руководство, чтобы перейти на API конечных точек и разработки версии 2.
...
Конечная [точка](https://aka.ms/v1-endpoint-api-docs) версии 1 и [авторство](https://aka.ms/v1-authoring-api-docs) AIS унижаются. Используйте это руководство, чтобы понять, как перейти на конечную [точку](https://go.microsoft.com/fwlink/?linkid=2092356) версии 2 и [нарастать](https://go.microsoft.com/fwlink/?linkid=2092087) AA. 
...
API конечных точек имеет новые параметры строки запроса, а также другой ответ. Если флаг verbose установлен, то наряду с максимальной оценкой topScoringIntent возвращаются все намерения независимо от оценок (в массиве intents).
