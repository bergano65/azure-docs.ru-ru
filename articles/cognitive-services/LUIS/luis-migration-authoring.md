...
* При миграции не выполняется автоматическое собираются участников совместной работы и их перемещение или добавление в ресурс создания Azure. Владелец приложения должен выполнить этот шаг после миграции. Для этого шага требуются [разрешения на доступ к ресурсу разработки Azure](./luis-how-to-collaborate.md).
...
* Вероятно, ресурс был создан в расположении, отличном от портала, в котором вы вошли. Проверьте [области разработки и порталы Luis](./luis-reference-regions.md#luis-authoring-regions).
