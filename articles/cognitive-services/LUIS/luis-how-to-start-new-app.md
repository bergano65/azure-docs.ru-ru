...
* Приложение с таким именем уже существует. Чтобы устранить эту проблему, повторно импортировать приложение и задайте **необязательное имя** на новое имя. 
