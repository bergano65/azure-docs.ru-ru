...
Следуя инструкциям в этом кратком руководстве для языков C#, Python и JavaScript, вы сможете создать приложение ИИ Azure LUIS и отправить в него запрос с помощью клиентских библиотек пакета SDK LUIS.
