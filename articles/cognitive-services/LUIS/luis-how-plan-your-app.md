...
> [!TIP]
> Для многих сценариев LUIS предлагает [готовые предметные области](./howto-add-prebuilt-models.md). Проверьте, можете ли вы использовать готовую предметную область в качестве отправной точки для своего приложения.
...
> [!TIP]
> LUIS предлагает [Готовые сущности](./howto-add-prebuilt-models.md) для распространенных пользовательских сценариев. Рассмотрите возможность использования готовых сущностей в качестве отправной точки для разработки приложений.
