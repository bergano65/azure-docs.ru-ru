...
Если бот не работает, скачайте проект на локальный компьютер и продолжите [отладку](https://docs.microsoft.com/bot-framework/bot-service-debug-bot). 
