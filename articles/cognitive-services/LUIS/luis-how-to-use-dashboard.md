...
![Снимок экрана показывает прогнозы по намерениям с несколькими нечеткими или неправильными прогнозируемыми результатами.](./media/luis-how-to-use-dashboard/utterance-per-intent-shows-data-imbalance.png)

Наведите указатель мыши на отрезок каждой цели, чтобы получить сведения о намерении.

![Снимок экрана показывает прогнозы по каждому намерению с подробными сведениями о непонятных или неверно прогнозируемых результатах.](./media/luis-how-to-use-dashboard/utterances-per-intent-with-details-of-errors.png)
