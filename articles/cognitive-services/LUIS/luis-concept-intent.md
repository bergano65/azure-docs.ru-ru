...
Намерение представляет задачу или действие, которое хочет выполнить пользователь. Это цель или цель, выраженная в [utteranceе](luis-concept-utterance.md)пользователя.
...
Ознакомьтесь с [ограничениями](luis-limits.md#model-boundaries), чтобы понять, какое количество намерений можно добавить в модель.
