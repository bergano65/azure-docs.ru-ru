...
Список версий показывает, какие версии публикуются, где они публикуются, и какая версия в настоящее время активна. 
...
Выберите версию из списка, а затем выберите **Активировать** из панели инструментов. 

> [!div class="mx-imgBorder"]
> [![Управление разделом, страницей версий, сделать действие версии](./media/luis-how-to-manage-versions/versions-other.png "Управление разделом, страницей версий, сделать действие версии")](./media/luis-how-to-manage-versions/versions-other.png#lightbox)

## <a name="import-version"></a>Импорт версии

Можно импортировать `.json` или `.lu` версию приложения.

1. Выберите **Импорт** из панели инструментов, а затем выберите формат. 

2. В всплывающем окне **Импорт новой версии** введите имя новой версии, которое должно состоять из 10 символов. Вам нужно установить идентификатор версии, если версия в файле уже существует в приложении.
...
* Ошибки токенизатора: Если при импорте вы получаете **ошибку маркеризатора,** вы пытаетесь импортировать версию, используюую другой [токенизатор,](luis-language-support.md#custom-tokenizer-versions) чем приложение в настоящее время. Чтобы исправить это, [см. Мигрировать между версиями токенизаторов.](luis-language-support.md#migrating-between-tokenizer-versions)

<a name = "export-version"></a>

## <a name="other-actions"></a>Другие действия

* Чтобы **удалить** версию выберите ее из списка, а затем на панели инструментов нажмите **Удалить**. Выберите **Ok**. 
...
* Чтобы **экспортировать** версию выберите ее из списка, а затем на панели инструментов нажмите **Экспортировать приложение**. Выберите JSON для экспорта для резервного копирования, выберите **Экспорт для контейнера для** использования этого приложения в [контейнере LUIS.](luis-container-howto.md)  
