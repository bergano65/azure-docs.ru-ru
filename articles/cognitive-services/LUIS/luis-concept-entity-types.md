...
|--|--|--|
|Купить 3 билета в Нью-Йорк|Предварительно созданная сущность number<br>Destination|3<br>Нью-Йорк|
...
## <a name="entity-prediction-status-and-errors"></a>Состояние прогнозирования сущностей и ошибки
