...
В первую очередь необходимо удалить utterance пример и повторное обучение приложения. Добавьте обратно только слово или фразу, сущности как пример utterance, а затем пометить сущности, а также проводить обучение. Теперь снова добавьте исходный пример utterance и предварительно созданные сущности. Настраиваемой сущности должны продолжать отмечаться вместо готовых сущностей. 

#### <a name="remove-prebuilt-entity-to-fix-tagging"></a>Удалить сущность, готовых для исправления тегов

Второй вариант заключается в удалении предварительно созданные сущности из приложения, пометка настраиваемой сущности в примере utterance, а затем добавить предварительно созданных сущностей обратно к приложению. Это исправление предполагается, что предварительно созданные сущности не является частью составного сущности. 
