...
Ключи, управляемые клиентом, доступны во всех [регионах разработки](luis-reference-regions.md). 
