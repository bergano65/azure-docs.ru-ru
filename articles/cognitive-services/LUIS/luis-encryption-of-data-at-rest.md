...
* Миграция на ресурс E0 будет заблокирована. Пользователи смогут перенести свои приложения только в ресурсы F0. После переноса существующего ресурса в F0 можно создать новый ресурс на уровне E0. Дополнительные сведения о [миграции](./luis-migration-authoring.md)см. здесь.  
