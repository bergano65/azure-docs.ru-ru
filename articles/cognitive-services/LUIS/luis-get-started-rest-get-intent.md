...
description: Из этого краткого руководства по REST API вы узнаете, как с помощью cURL и REST определить намерение пользователя в разговоре.
