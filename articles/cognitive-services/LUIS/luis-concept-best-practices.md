...
Лучше всего не использовать эти методы, пока ваше приложение не будет протестировано. Вы должны понимать, как работает программа, прежде чем добавлять списки и шаблоны фраз. Узнав, как ваша программа работает без них, поочередно добавьте каждую из этих функций, применимых к вашей программе. Не нужно добавлять каждую из этих функций для каждой [итерации](luis-concept-app-iteration.md) или изменять их с каждой версией. 
