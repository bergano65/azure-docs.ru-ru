...
Лучше всего не использовать эти методы, пока ваше приложение не будет протестировано. Прежде чем добавлять списки фраз и шаблоны, необходимо понять, как приложение ведет себя, так как эти функции имеют взвешенное значение более интенсивно, чем пример фразы продолжительностью и будут распознавать достоверность. 
