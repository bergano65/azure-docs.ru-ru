...
Если в клиентском приложении не имеет особого значения, рассмотрите возможность [игнорирования знаков препинания](#utterance-normalization) путем нормализации знаков препинания. 
