...
* [Пунктуация](luis-reference-application-settings.md#punctuation-normalization) - хорошее разнообразие, используя правильный, неправильный, и нет грамматики
...
Нормализация высказывания – это процесс игнорирования последствий знаков препинания и диакритических эффектов во время обучения и прогнозирования. Используйте [настройки приложений](luis-reference-application-settings.md) для контроля влияния нормализации высказываний на прогнозы высказываний.
