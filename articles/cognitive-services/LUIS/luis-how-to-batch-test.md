...
> ![Снимок экрана: список пакетных тестов с параметрами](./media/luis-how-to-batch-test/batch-testing-options.png)

## <a name="run-a-batch-test-on-your-trained-app"></a>Запуск пакетного теста в обученном приложении

Чтобы выполнить тест, выберите имя набора данных, а затем выберите **выполнить** на контекстной панели инструментов. После завершения теста в этой строке отображается результат теста набора данных.
