...
Пакетная диаграмма отображает четыре квадранта результатов. В правой части диаграммы находится фильтр. Фильтр содержит намерения и сущности. При выборе [раздела диаграммы](#review-batch-results-for-intents) или точки внутри диаграммы соответствующие высказывания отображаются под диаграммой.
...
LUIS позволяет выполнять пакетный тест с помощью портала LUIS и REST API. Ниже перечислены конечные точки для REST API. Сведения о пакетном тестировании с помощью портала LUIS см. в разделе [учебник. наборы данных пакетного теста](). Используйте полные URL-адреса, приведенные ниже, заменив значения заполнителей собственным ключом и конечной точкой LUIS прогнозирования. 
