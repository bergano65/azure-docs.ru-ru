...
|Неподдерживаемые сущности для языка и региональных`en-US`параметров "Английский ()"|Предварительно созданные сущности [GeographyV2](luis-reference-prebuilt-geographyV2.md)|
