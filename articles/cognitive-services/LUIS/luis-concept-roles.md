...
В utterance может существовать несколько сущностей, которые можно извлечь без использования ролей. Если контекст предложения указывает, что версия сущности имеет значение, то следует использовать роль. 
