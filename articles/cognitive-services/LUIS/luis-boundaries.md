...
| [Список фраз][phrase-list]|500 списков фраз. Несменный фразалист имеет максимум 5000 фраз. Взаимозаменяемый фразалист имеет максимум 50 000 фраз. Максимальное количество фраз за приложение из 500 000 фраз.|
