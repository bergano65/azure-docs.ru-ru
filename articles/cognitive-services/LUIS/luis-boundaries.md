...
| [Сущности машинного обучения](./luis-concept-entity-types.md).<br> Составная,<br>  Иерархическая сущность<br> Простая|Ограничение в 100 родительских сущностей (не включая иерархические дочерние элементы) или 330 сущностей (в том числе иерархические дочерние элементы) в зависимости от того, какое ограничение пользователь достигнет сначала.<br><br>Примером с иерархией будет 30 иерархий, каждая с 10 дочерними элементами.  Дочерние элементы будут использовать всего 300, а элементы иерархии — оставшиеся 30. |
