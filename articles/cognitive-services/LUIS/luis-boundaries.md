...
| [Сущности машинного обучения](./luis-concept-entity-types.md).<br> Составная,<br>  Иерархическая сущность<br> Простая|100 <br>Общее количество сущностей машинного обучения (простых, иерархических и составных) не может превышать 100. Составные и иерархические сущности не могут иметь более 10 дочерних элементов.  |
