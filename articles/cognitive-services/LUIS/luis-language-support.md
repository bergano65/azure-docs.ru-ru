...
|Язык|  каждый пробел и специальный символ | уровень символа|составные слова|[токенизированная сущность возвращается](luis-concept-data-extraction.md#tokenized-entity-returned)
|--|:--:|:--:|:--:|:--:|
|Арабский|||||
|Китайский||✔||✔|
|Нидерландский|||✔|✔|
