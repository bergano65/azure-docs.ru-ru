...
Список поддерживаемых языков и состояний см. в разделе [Поддерживаемые языки](../bing-spell-check/language-support.md) проверки орфографии Bing.
