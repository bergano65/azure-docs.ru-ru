...
Общие сведения о формировании этой иерархии вызовов из Bot Builder v4 см. в [этом](/azure/bot-service/bot-builder-tutorial-dispatch?branch=master&tabs=cs&view=azure-bot-service-4.0) руководстве.  
...
* [Учебник по модели диспетчеризации](/azure/bot-service/bot-builder-tutorial-dispatch?branch=master&tabs=cs&view=azure-bot-service-4.0)
