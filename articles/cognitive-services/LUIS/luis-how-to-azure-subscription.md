...
|Клавиши|Назначение|Служба для переприятия`kind`|Служба для переприятия`type`|
|--|--|--|--|
...
Чтобы передавать владение ресурсом, OU может быть:
