---
title: Правильные неправильно написанные слова - LUIS
...
Если вы не хотите использовать службу проверки орфографии Bing, необходимо добавить правильное и неправильное написание. 

Два решения:

* Этикетка пример высказывания, которые имеют все различные орфографии, так что LUIS может узнать надлежащее правописание, а также опечатки. Этот способ требует больше усилий, чем применение проверки орфографии.
* Создайте список фраз со всеми вариациями слова. С помощью этого решения не нужно маркировать вариации слов в примере высказываний. 
