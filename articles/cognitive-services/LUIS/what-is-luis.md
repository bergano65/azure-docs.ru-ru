...
Создайте приложение LUIS с [предварительно созданным](luis-get-started-create-app.md) или [пользовательским](luis-quickstart-intents-only.md) доменом. [Отправьте запрос к конечной точке прогнозирования](luis-get-started-get-intent-from-browser.md) общедоступного приложения Интернета вещей.
