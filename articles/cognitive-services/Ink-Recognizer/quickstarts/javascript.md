...
description: В этом кратком руководстве показано, как распознать рукописный текст с помощью API "Распознаватель рукописного текста" и JavaScript.
