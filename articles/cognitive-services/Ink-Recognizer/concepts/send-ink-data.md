...
## <a name="the-ink-recognizer-api-vs-ocr-services"></a>API распознавания чернил против услуг OCR
...
[Windows Ink](https://docs.microsoft.com/windows/uwp/design/input/pen-and-stylus-interactions) предоставляет инструменты и технологии, предоставляющие широкие возможности рукописного ввода с диапазона различных устройств. Платформу Windows Ink можно объединить с API Ink Recognizer для создания приложений, которые отображают и интерпретируют цифровые штрихи.
