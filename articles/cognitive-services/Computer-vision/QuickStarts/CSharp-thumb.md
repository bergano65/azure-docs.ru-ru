...
ms.locfileid: "59995121"
---
# <a name="quickstart-generate-a-thumbnail-using-the-rest-api-and-c-in-computer-vision"></a>Краткое руководство. Создание эскиза с помощью REST API компьютерного зрения и C#
