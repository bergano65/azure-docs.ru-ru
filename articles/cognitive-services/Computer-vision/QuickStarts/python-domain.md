---
title: Краткое руководство. Использование модели предметной области (REST, Python). Компьютерное зрение
...
ms.locfileid: "45632455"
---
# <a name="quickstart-use-a-domain-model-using-the-rest-api-and-python-in-computer-vision"></a>Краткое руководство по использованию моделей предметной области с помощью REST API и Python в Компьютерном зрении
