---
title: Краткое руководство по извлечению печатного текста (OCR) — REST, JavaScript в службе "Компьютерное зрение"
...
ms.locfileid: "51851999"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-rest-api-and-javascript-in-computer-vision"></a>Краткое руководство по извлечению печатного текста (OCR) с помощью REST API и JavaScript в службе "Компьютерное зрение"
