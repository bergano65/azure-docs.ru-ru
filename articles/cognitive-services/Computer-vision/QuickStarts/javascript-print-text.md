...
> [!NOTE]
> При извлечении текста на английском языке попробуйте применить новую [операцию чтения](../concept-recognizing-text.md). Доступно [краткое руководство для JavaScript](./javascript-hand-text.md).
