...
ms.locfileid: "68881253"
---
# <a name="use-computer-vision-features-with-the-rest-api-and-java"></a>Использование возможностей Компьютерного зрения с помощью REST API и Java
...
Перед созданием примера необходимо получить подписку на интерфейс API "Компьютерное зрение", который является частью Azure Cognitive Services. Сведения о подписках и управлении ключами см. в разделе [Подписки](https://azure.microsoft.com/try/cognitive-services/). В этом руководстве можно использовать как первичный, так и вторичный ключ.
...
В этом руководстве вы научились использовать REST API "Компьютерное зрение" с помощью Java для тестирования многих доступных функций анализа изображений. Далее ознакомьтесь со справочной документацией, чтобы получить дополнительные сведения об используемых API.
