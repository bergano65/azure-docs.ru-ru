...
Приложение форм Java Swing уже написано, но в нем нет функциональных возможностей. В этом руководстве вы добавите код для API компьютерного зрения, чтобы дополнить функциональные возможности приложения.
...
Функция создания эскизов API компьютерного зрения создает эскиз изображения. С помощью функции **Интеллектуальная обрезка**, компонент создания эскизов определит интересующую область в изображении и отцентрирует эскиз по данной области, чтобы сделать его более эстетичным.
