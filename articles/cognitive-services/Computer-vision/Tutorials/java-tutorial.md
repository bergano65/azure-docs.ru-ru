...
ms.locfileid: "68565679"
---
# <a name="use-computer-vision-features-with-the-rest-api-and-java"></a>Использование Компьютерное зрение функций с REST API и Java
...
Приложение повернутой формы Java уже было написано, но не имеет функциональности. В этом руководстве вы добавите код для API компьютерного зрения, чтобы дополнить функциональные возможности приложения.
...
Перед созданием примера необходимо подписываться на API компьютерного зрения, который является частью Cognitive Services Azure. Сведения о подписках и управлении ключами см. в разделе [Подписки](https://azure.microsoft.com/try/cognitive-services/). В этом руководстве можно использовать как первичный, так и вторичный ключ.
...
В этом руководством вы использовали Компьютерное зрение REST API с Java для тестирования многих доступных функций анализа изображений. Затем ознакомьтесь с справочной документацией, чтобы узнать больше об используемых API.
