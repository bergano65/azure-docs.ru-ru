---
title: Руководство по Выполнение операций с изображениями — JavaScript
...
## <a name="acquire-the-incomplete-tutorial-project"></a>Получение неполного учебного проекта
...
## <a name="add-the-tutorial-code-to-the-project"></a>Добавление учебного кода в проект
