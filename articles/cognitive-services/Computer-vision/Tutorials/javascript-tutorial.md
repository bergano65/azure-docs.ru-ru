...
ms.locfileid: "68564572"
---
# <a name="use-computer-vision-features-with-the-rest-api-and-javascript"></a>Использование Компьютерное зрение функций с REST API и JavaScript

В этом пошаговом окне показаны функции REST API Компьютерное зрение Azure Cognitive Services.
...
Приложение форм JavaScript уже написано, но в нем нет функциональных возможностей API компьютерного зрения. В этом разделе вы добавите код, относящийся к Компьютерное зрение REST API, чтобы завершить работу приложения.
...
Перед созданием примера необходимо получить подписку API компьютерного зрения, который является частью Azure Cognitive Services. Сведения о подписках и управлении ключами см. в разделе [Подписки](https://azure.microsoft.com/try/cognitive-services/). Первичный и вторичный ключи допустимы для использования в этом руководством.

## <a name="acquire-incomplete-tutorial-project"></a>Получить неполный проект учебника
...
Если вы предпочитаете использовать готовый проект с добавленным кодом учебника, можно использовать файлы из папки **Completed** .

## <a name="add-tutorial-code-to-the-project"></a>Добавление кода учебника в проект

В приложении JavaScript заданы шесть HTML-файлов, по одному для каждого компонента. Каждый файл демонстрирует различные функции Компьютерное зрение (анализ, распознавание текста и т. д.). Шесть разделов не имеют взаимозависимостей, поэтому можно добавить код учебника в один файл, все шесть файлов или только несколько файлов. Коме того, учебный код можно добавлять в файлы в любом порядке.

### <a name="analyze-an-image"></a>Анализ изображения

Функция анализа Компьютерное зрение сканирует изображение для тысяч распознаваемых объектов, живых вещей, пейзажей и действий. После завершения анализа эта функция возвращает объект JSON, описывающий изображение с помощью описательных тегов, анализа цвета, подписей и многого другого.

Чтобы завершить анализ функции приложения, выполните следующие действия.

#### <a name="add-the-event-handler-code-for-the-analyze-button"></a>Добавление кода обработчика событий для кнопки "анализ"
...
#### <a name="run-the-analyze-function"></a>Выполнение функции Analyze
...
Чтобы завершить функцию ориентира приложения, выполните следующие действия.
...
#### <a name="run-the-landmark-function"></a>Выполнение функции ориентира
...
Чтобы завершить функцию знаменитостей приложения, выполните следующие действия.

#### <a name="add-the-event-handler-code-for-the-celebrities-button"></a>Добавление кода обработчика событий для кнопки знаменитостей
...
#### <a name="run-the-celebrities-function"></a>Выполнение функции знаменитостей
...
Чтобы завершить функцию эскиза приложения, выполните следующие действия.
...
Чтобы завершить распознавание текста приложения, выполните следующие действия.
...
#### <a name="run-the-handwriting-function"></a>Запуск функции рукописного ввода

Сохраните файл **handwriting.html** и откройте его в веб-браузере. Поместите ключ подписки в поле **Subscription Key** (Ключ подписки) и убедитесь, что вы используете правильный регион в поле **Subscription Region** (Регион подписки). Введите URL-адрес изображения, которое нужно проанализировать, а затем нажмите кнопку **Read Image** (Распознать изображение), чтобы проанализировать изображение и просмотреть результат.

## <a name="next-steps"></a>Следующие шаги

В этом разделе вы использовали Компьютерное зрение REST API с JavaScript для тестирования многих доступных функций анализа изображений. Затем ознакомьтесь с справочной документацией, чтобы узнать больше об используемых API.

- [Компьютерное зрение REST API](https://westus.dev.cognitive.microsoft.com/docs/services/5adf991815e1060e6355ad44/operations/56f91f2e778daf14a499e1fa)
