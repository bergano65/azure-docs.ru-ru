...
Вы можете создавать приложения Компьютерного зрения с помощью пакета SDK для клиентской библиотеки или посредством прямого вызова REST API. Эта страница содержит подробные сведения о действиях, которые можно совершить с помощью API компьютерного зрения.
