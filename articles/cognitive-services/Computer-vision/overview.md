...
ms.locfileid: "99575946"
---
# <a name="what-is-computer-vision"></a>Что собой представляет Компьютерное зрение

[!INCLUDE [TLS 1.2 enforcement](../../../includes/cognitive-services-tls-announcement.md)]

Компьютерное зрение Azure обеспечивает доступ к расширенным алгоритмам обработки изображений и возврата данных на основе интересующих вас визуальных функций. Например, Компьютерное зрение может определить, есть ли на изображении содержимое для взрослых, конкретные торговые марки или объекты, или найти человеческие лица.

Вы можете создавать приложения Компьютерного зрения с помощью [пакета SDK для клиентской библиотеки](./quickstarts-sdk/client-library.md) или посредством прямого вызова [REST API](https://westcentralus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-ga/operations/5d986960601faab4bf452005). Эта страница содержит подробные сведения о действиях, которые можно совершить с помощью API компьютерного зрения.

## <a name="optical-character-recognition-ocr"></a>Оптическое распознавание текста (OCR)

Компьютерное зрение включает возможности [оптического распознавания символов (OCR)](concept-recognizing-text.md). Вы также можете использовать API чтения для извлечения печатного и рукописного текста из изображений и документов. Это средство использует модели на основе глубокого обучения и работает с текстом на самых разных поверхностях и фонах, таких как бизнес-документация, счета, квитанции, плакаты, визитные карточки, письма и доски. API OCR поддерживают извлечение печатного текста на [нескольких языках](./language-support.md). Чтобы приступить к работе, ознакомьтесь с [этим руководством](./quickstarts-sdk/client-library.md).
...
Для развертывания функций API в локальной среде используйте контейнеры API "Компьютерное зрение". Эти контейнеры Docker позволяют разместить службу ближе к данным для обеспечения безопасности, соответствия требованиям и других эксплуатационных преимуществ. Для API "Компьютерное зрение" предлагаются такие контейнеры:

* [Контейнер OCR (чтение) для API "Компьютерное зрение" (предварительная версия)](computer-vision-how-to-install-containers.md) позволяет распознавать печатный и рукописный текст на изображениях.
* [Контейнер пространственного анализа для API "Компьютерное зрение" (предварительная версия)](spatial-analysis-container.md) позволяет анализировать потоковую передачу видео в реальном времени для распознавания пространственных связей между людьми и их движением в физических средах.
...
Начните работу с Компьютерным зрением, изучив краткое руководство по предпочтительному языку разработки:

- [Краткое руководство. REST API или клиентские библиотеки Компьютерного зрения](./quickstarts-sdk/client-library.md)
