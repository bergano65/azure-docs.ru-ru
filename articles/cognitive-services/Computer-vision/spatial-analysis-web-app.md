...
* Основные сведения о конфигурациях развертывания Azure IoT Edge и [центре Интернета вещей Azure](https://docs.microsoft.com/azure/iot-hub/)
...
* Имя развертывания: выберите имя для этого развертывания.
* Имя центра Интернета вещей: имя центра Интернета вещей Azure
* Deployment.js: имя файла развертывания
