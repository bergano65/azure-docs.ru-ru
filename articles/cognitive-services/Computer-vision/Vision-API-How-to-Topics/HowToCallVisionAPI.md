...
Чтобы использовать REST API, см. [Справочник по API компьютерного зрения компьютера](https://westus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-ga/operations/56f91f2e778daf14a499f21b).
