...
1. При использовании клиентской библиотеки ключ подписки передается через конструктор ComputerVisionClient, а регион указывается в свойстве клиента:
