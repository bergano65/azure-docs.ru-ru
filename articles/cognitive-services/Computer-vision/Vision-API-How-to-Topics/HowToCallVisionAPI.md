---
title: Пример. Вызов API компьютерного зрения
...
ms.locfileid: "45981751"
---
# <a name="example-how-to-call-the-computer-vision-api"></a>Пример. Методы вызова API компьютерного зрения
...
URL-адрес или путь к локально сохраненному изображению.
  ...
  * Размер изображения: больше чем 50x50 пикселей.
...
Функции разбиваются на:
  ...
  * **Параметр 1**. Статистический анализ — анализирует только данную модель
  * **Параметр 2**. Расширенный анализ — анализ для предоставления дополнительных сведений с [86 категориями таксономии](../Category-Taxonomy.md)
...
### <a name="Step2">Шаг 2. Передача образа в службу API компьютерного зрения и возврат тегов, описания и знаменитостей</a>
...
**Параметр 1**. Получить список "тегов" и одного "описания".
```
...
**Параметр 2.** Расширенный анализ — анализ для предоставления дополнительных сведений с 86 категориями таксономии
