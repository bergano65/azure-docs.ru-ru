...
|-------|------|-----------|-------------|
|Не разрешено| `Input` | Тип String | Контейнеры API компьютерного зрения не используют этот элемент.|
...
# <a name="version-31"></a>[Версия 3.1](#tab/version-3-1)
