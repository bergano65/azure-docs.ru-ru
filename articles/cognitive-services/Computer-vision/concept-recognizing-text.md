...
[API Read 3,2](https://westcentralus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-ga/operations/5d986960601faab4bf452005) поддерживает извлечение печатного текста на английском, испанском, немецком, французском, итальянском, португальском и нидерландском языках.
...
- Используйте [краткие руководства по чтению 3,1 REST API](./QuickStarts/CSharp-hand-text.md) в C#, Java, JavaScript или Python, чтобы узнать, как использовать интерфейсы API.
...
- Дополнительные сведения о [REST API общедоступной предварительной версии 3,2](https://westus2.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-preview-2/operations/5d986960601faab4bf452005) с поддержкой упрощенного китайского и японского языков.
