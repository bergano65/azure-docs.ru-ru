...
* повышенную точность;
* новый формат вывода;
* оценку достоверности для каждого извлеченного слова;
* поддержку испанского и английского языков с дополнительным языковым параметром.
