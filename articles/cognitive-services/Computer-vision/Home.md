...
Компьютерное зрение можно использовать для [обнаружения непристойного и оскорбительного содержимого](concept-detecting-adult-content.md) в изображение и оценки достоверности такого содержимого. Вы можете установить фильтр, определяющий содержимое для взрослых и носящее непристойный характер в соответствии с предпочтением пользователя по степени принятия материалов данного характера.
