...
Компьютерное зрение можно использовать для [извлечения текста с помощью функции распознавания текста](concept-extracting-text-ocr.md) и его последующей вставки в машиночитаемый поток символов. При необходимости функция OCR выравнивает распознанный текст и предоставляет координаты кадра каждого слова. Функция OCR поддерживает 25 языков и автоматически определяет язык распознанного текста.

Вы также можете [распознавать печатный и рукописный текст](concept-recognizing-text.md) на изображении. API компьютерного зрения может обнаруживать и извлекать печатный и рукописный текст из изображений различных объектов с различными поверхностями и фонами, например из квитанций, плакатов, визитных карточек, писем и настенных досок. Функция распознавание печатного и рукописного текста сейчас доступна в предварительной версии, а единственным поддерживаемым языком является английский. 
