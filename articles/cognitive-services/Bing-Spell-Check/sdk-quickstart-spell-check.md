...
- [Справочник по пакету SDK C# для API Проверки орфографии Bing](/dotnet/api/overview/azure/cognitiveservices/bing-spell-check-readme?view=azure-dotnet)