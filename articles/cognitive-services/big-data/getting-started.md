...
Если приложение или рабочая нагрузка использует чрезвычайно большие наборы данных, требует использовать частную сеть или не может получить доступ к облаку, обмен данными с облачными службами может оказаться невозможным. В этом случае контейнерные Cognitive Services имеют следующие преимущества:
...
1. Установка Cognitive Services для больших данных
    ...
    * Введите следующие координаты Maven:  `com.microsoft.ml.spark:mmlspark_2.11:1.0.0-rc1`. Репозиторий: `https://mmlspark.azureedge.net/maven`.  
      <img src="media/library-coordinates.png" alt="Library Coordinates" width="50%"/>
    * Установите библиотеку в кластере.  
      <img src="media/install-library.png" alt="Install Library on Cluster" width="50%"/>

### <a name="synapse-analytics-optional"></a>Synapse Analytics (необязательно)
...
1. [Создайте пул Apache Spark (предварительная версия) с помощью портала Azure.](https://docs.microsoft.com/azure/synapse-analytics/quickstart-create-apache-spark-pool-portal)
...
1. Вставьте приведенный ниже фрагмент кода в новую записную книжку.
