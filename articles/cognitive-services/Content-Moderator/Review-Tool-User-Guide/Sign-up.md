---
title: Регистрация в Content Moderator | Документация Майкрософт
description: На странице регистрации в службе Content Moderator можно зарегистрироваться с помощью учетной записи Майкрософт или создать учетную запись на веб-сайте Content Moderator.
