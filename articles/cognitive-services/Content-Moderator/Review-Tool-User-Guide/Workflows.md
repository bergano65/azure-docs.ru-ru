...
Затем выберите соединитель. В этом примере используется **Content Moderator**. В зависимости от выбранного соединителя вы получите различные параметры вывода данных. Сведения о настройке других [соединителей](./configure.md#connectors) см. в разделе Соединители руководства по параметрам средства проверки.
...
В этом руководство вы узнали, как настроить и использовать рабочие процессы для контроля использования в средстве Content Moderatorной [проверки](https://contentmoderator.cognitive.microsoft.com). Далее ознакомьтесь с [руководством REST API](../try-review-api-workflow.md) , чтобы узнать, как создавать рабочие процессы программным способом.
