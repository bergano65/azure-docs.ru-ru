...
В этом разделе вы узнали, как настроить и использовать [проверки](https://contentmoderator.cognitive.microsoft.com)в средстве Content Moderatorных проверок. См. Руководство по [REST API](../try-review-api-review.md) или [пакет SDK для .NET](../moderation-reviews-quickstart-dotnet.md) , чтобы узнать, как программным способом создать рецензию.