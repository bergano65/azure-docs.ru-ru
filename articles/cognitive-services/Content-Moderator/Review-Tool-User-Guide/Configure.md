...
На **вкладке Теги** можно определить пользовательские теги для добавления в дополнение&mdash;к двум тегам по умолчанию —**взрослым** (**a**) и **исраци** (**r**). При создании пользовательского тега он будет доступен в проверках рядом с тегами по умолчанию. Вы можете изменить теги, отображаемые в рецензиях, переключив их параметры видимости.
