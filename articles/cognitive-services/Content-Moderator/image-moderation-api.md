...
> - Логические параметры принимают значения True или False в зависимости от внутренних пороговых значений оценки. Клиенты могут выбрать, будут ли они использовать значения по умолчанию или настраивать собственные пороги в соответствии с действующими политиками содержимого.
...
## <a name="human-review-tool"></a>Средство пользовательской проверки
