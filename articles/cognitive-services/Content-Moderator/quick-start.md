...
Просмотрите примененные теги модерации. Вы увидите, какие теги были применены к содержимому, а также оценку в каждой категории.
...
- Реализация модерации видео. Изучите [краткое руководство по C#](video-moderation-api.md), чтобы проверить видео на наличие материалов для взрослых и (или) содержимого непристойного характера. 
