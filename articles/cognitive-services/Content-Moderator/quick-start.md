...
Теперь создайте команду проверки. В рабочем сценарии это группа людей, которые будут вручную проверять решения модерации службы. Чтобы создать команду, необходимо выбрать **Регион** и указать **Имя команды** и **Идентификатор группы**. Если вы хотите пригласить коллег в команду, введите здесь их адреса электронной почты.
