...
- Реализация модерации изображений. Используйте [консоль API](try-image-api.md) или [краткое руководство](client-libraries.md), чтобы проверить изображения на наличие материалов для взрослых и (или) непристойного характера с использованием тегов, оценки достоверности и других сведений, извлекаемых из содержимого.
- Реализация модерации текста. Используйте [консоль API](try-text-api.md) или [краткое руководство](client-libraries.md), чтобы проверить содержимое текста на наличие ненормативной лексики, персональных данных и другого нежелательного содержимого.
