...
- Реализация модерации изображений. Используйте [консоль API](try-image-api.md) или [краткое руководство по клиентской библиотеке или REST API](client-libraries.md), чтобы проверить изображения на наличие материалов для взрослых или непристойного характера с помощью тегов, оценки достоверности и других сведений, извлекаемых из содержимого.
- Реализация модерации текста. Используйте [консоль API](try-text-api.md) или [краткое руководство по клиентской библиотеке или REST API](client-libraries.md), чтобы проверить текстовое содержимое на наличие ненормативной лексики, персональных данных и выполнить машинную классификацию нежелательных текстов (предварительная версия).
