...
Выберите регистрацию приложения и нажмите кнопку **Управление приложением** под ней. Обратите внимание на значение в поле **Идентификатор приложения**. Оно потребуется позже. Выберите**ключи** **настройки** > и введите описание для нового ключа (например, "VideoModKey"). Щелкните **Сохранить**, а затем обратите внимание на новое значение ключа. Скопируйте эту строку и сохраните ее в надежном месте.
