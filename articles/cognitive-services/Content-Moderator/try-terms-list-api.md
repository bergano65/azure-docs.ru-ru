...
Используйте [API управления списками](https://westus.dev.cognitive.microsoft.com/docs/services/57cf755e3f9b070c105bd2c2/operations/57cf755e3f9b070868a1f67f), чтобы создать настраиваемые списки терминов, используемые в API модерации текста. **Текст -** операция экрана сканирует текст на ненормативную лексику, а также сравнивает текст с пользовательскими и общими блокировщиками.
