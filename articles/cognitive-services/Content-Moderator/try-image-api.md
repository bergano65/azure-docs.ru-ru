...
Используйте REST API в коде или следуйте [быстрому запуску .NET SDK,](dotnet-sdk-quickstart.md) чтобы добавить модерацию изображения в приложение.
