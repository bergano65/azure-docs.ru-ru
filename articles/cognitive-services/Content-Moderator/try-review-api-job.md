...
Выберите **Отправить**. Если операция выполнена, **состояние ответа** равно `200 OK`, а в поле **ответное содержимое** отображается идентификатор задания. Скопируйте этот идентификатор, чтобы использовать на следующих шагах.
...
Введите параметры вызова RESTFUL, как показано в приведенном выше разделе. Для этого шага **JOBID** — это уникальная строка идентификатора, полученная при создании задания. Выберите **Отправить**. Если операция выполнена, **состояние отклика** — `200 OK`, а в поле **ответное содержимое** отображается задание в формате JSON, как показано ниже:
