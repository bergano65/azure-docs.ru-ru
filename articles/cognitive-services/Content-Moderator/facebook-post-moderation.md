...
1. Создайте приложение-функцию Azure, как показано на странице [Создание приложения-функции на портале Azure](../../azure-functions/functions-create-function-app-portal.md).
...
1. В приложении перейдите на вкладку **Функции платформы** и выберите **Конфигурация**. В разделе **Параметры приложения** на следующей странице выберите **Новый параметр приложения** и добавьте приведенные ниже пары "ключ-значение".
    ...
    | `cm:SubscriptionKey` | Ключ подписки Content Moderator (см. раздел [Учетные данные](./review-tool-user-guide/configure.md#credentials)). |
...
1. Создайте приложение Facebook.
    ...
    1. Перейдите в раздел **My Apps** (Мои приложения).
...
1. Создайте страницу Facebook.
    ...
    1. Разрешите приложению Facebook доступ к этой странице, выполнив следующие действия.
        ...
        1. Выберите **Page ID** (Идентификатор страницы) в ответе.
