...
ms.locfileid: "55219300"
---
# <a name="quickstart-check-text-against-a-custom-term-list-in-c"></a>Краткое руководство. Проверка текста с помощью списка пользовательских терминов на C#
