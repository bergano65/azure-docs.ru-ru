...
description: Объединение машинной модерации и человеческого контроля с использованием API проверки Azure Content Moderator для получения наилучших результатов для вашего бизнеса.
...
ms.locfileid: "55862706"
---
# <a name="content-moderation-jobs-and-reviews"></a>Задания модерации и проверки содержимого
