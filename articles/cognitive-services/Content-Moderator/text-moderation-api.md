...
ms.locfileid: "81274016"
---
# <a name="learn-text-moderation-concepts"></a>Изучение концепций модерации текста

Использование программного контроля за текстом в машинном обContent Moderator и возможностей [человеческого анализа](Review-Tool-User-Guide/human-in-the-loop.md) в среднем текстовом содержимом.
...
Проверьте в работе [консоль API для списков терминов](try-text-api.md) и примеры кода для REST API. Ознакомьтесь также с разделом "текстовое руководство" в [кратком руководстве по пакету SDK для .NET](dotnet-sdk-quickstart.md) , если вы знакомы с Visual Studio и C#.
