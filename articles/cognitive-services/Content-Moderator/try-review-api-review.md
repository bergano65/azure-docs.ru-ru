...
Выберите **Отправить**. Если операция выполнена, **состояние ответа** равно `200 OK`, а в поле **ответное содержимое** отображается идентификатор проверки. Скопируйте этот идентификатор, чтобы использовать на следующих шагах.
...
Выберите **Отправить**. Если операция выполнена, **состояние отклика** — `200 OK`, а в поле **ответное содержимое** отображаются подробные сведения о проверке в формате JSON, как показано ниже:
