...
- извлечение и обновление метаданных списка;
- обновление индекса поиска списка;
...
Прежде чем использовать службы Content Moderator с помощью REST API или пакета SDK, необходимо получить ключ подписки для API. Подпишитесь на службу Content Moderator на [портале Azure](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesContentModerator), чтобы получить его.
...
Добавьте следующий фрагмент кода, чтобы создать клиент Content Moderator для своей подписки. Обновите `AzureEndpoint` поля и, `CMSubscriptionKey` указав значения URL-адреса конечной точки и ключа подписки. Их можно найти на вкладке **Быстрый запуск** ресурса в портал Azure.
...
Добавьте следующие классы и статические поля в класс **Program** в файле Program.cs.
...
## <a name="create-a-method-to-create-the-custom-list"></a>Создание метода для создания настраиваемого списка
...
## <a name="create-a-method-to-remove-images-from-the-list"></a>Создание метода для удаления изображений из списка
...
## <a name="create-a-method-to-get-all-of-the-content-ids-for-images-in-the-list"></a>Создание метода для получения всех идентификаторов содержимого для изображений в списке
...
## <a name="create-a-method-to-update-the-details-of-the-list"></a>Создание метода для обновлений сведений о списке
...
## <a name="create-a-method-to-retrieve-the-details-of-the-list"></a>Создание метода для извлечения сведений о списке
...
## <a name="create-a-method-to-refresh-the-search-index-of-the-list"></a>Создание метода для обновления индекса поиска списка

Добавьте следующий метод в класс **Program**. При каждом изменении списка необходимо обновить его индекс поиска, прежде чем использовать этот список для проверки изображений.
...
## <a name="create-a-method-to-match-images-against-the-list"></a>Создание метода для сопоставления изображений со списком
...
## <a name="create-a-method-to-delete-all-images-from-the-list"></a>Создание метода для удаления всех изображений из списка
...
## <a name="create-a-method-to-delete-the-list"></a>Создание метода для удаления списка
...
## <a name="create-a-method-to-retrieve-ids-for-all-image-lists"></a>Создание метода для извлечения идентификаторов всех списков изображений
...
Идентификатор списка и идентификаторы содержимого изображений будет отличаться при каждом запуске приложения.
Файл журнала, записанный программой, содержит следующие выходные данные.
