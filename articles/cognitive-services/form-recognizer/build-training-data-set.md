...
Если вы хотите использовать обучающие данные вручную, необходимо начать с как минимум пять заполненных форм того же типа. Вы по-прежнему можете использовать непомеченные формы в дополнение к требуемому набору данных.
