...
> [!IMPORTANT]
> При работе с этим кратким руководством используется API "Распознаватель документов" версии 1.0. Если ваша подписка находится в регионе `West US 2` или `West Europe`, перейдите к [краткому руководству по API версии 2.0](./python-train-extract.md).
