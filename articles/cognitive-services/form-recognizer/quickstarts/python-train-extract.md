...
- Минимум пять документов одного типа. Для работы с этим руководством вы можете использовать [пример набора данных](https://go.microsoft.com/fwlink/?linkid=2090451).
...
Чтобы создать и выполнить пример, во фрагменте кода ниже внесите следующие изменения:
