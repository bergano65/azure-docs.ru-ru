...
- **Обновление клиентской библиотеки** . Последняя версия [клиентских библиотек](quickstarts/client-library.md) для .NET, Python, Java и JavaScript поддерживает API распознавателя форм 2,1.
