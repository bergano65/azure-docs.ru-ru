...
Чтобы приступить к написанию приложения для обработки форм с помощью распознавателя форм на любом языке разработки, выполните инструкции из [краткого руководства](quickstarts/client-library.md) .
