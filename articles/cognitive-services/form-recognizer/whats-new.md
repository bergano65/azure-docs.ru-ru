...
- **Цикл обратной связи** . при анализе файлов с помощью образца средства создания меток можно также добавить его в обучающий набор и адужст метки при необходимости и обучить, чтобы улучшить модель.
- **Автоматическая метка докуметс** -аутомиткалли помечает дополнительные документы на основе предыдущих помеченных документов в проекте. 
