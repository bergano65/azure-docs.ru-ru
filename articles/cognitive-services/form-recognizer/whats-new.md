...
- **Обновление клиентской библиотеки** . в [клиентских библиотеках](quickstarts/client-library.md) для .NET, Python, Java и JavaScript введена общедоступная доступность.
