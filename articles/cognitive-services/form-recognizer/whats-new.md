...
Ознакомьтесь с [кратким](quickstarts/client-library.md) руководством, чтобы приступить к созданию приложения для обработки форм с помощью распознавателя форм на любом языке.
