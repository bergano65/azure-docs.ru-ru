...
API визитной карточки также возвращает весь распознанный текст из визитной карточки. Эти выходные данные OCR включаются в ответ JSON.  
...
Если в поле **состояние** указано значение **успешно** , в ответе JSON будут содержаться сведения о результатах работы с визитной картой и распознавании текста. Результат «основные сведения о бизнес-карте» организован как словарь значений именованных полей, где каждое значение содержит извлеченный текст, нормализованное значение, ограничивающий прямоугольник, достоверность и соответствующие элементы слова. Результат распознавания текста организован в виде иерархии строк и слов с текстом, ограничивающим прямоугольником и сведениями о достоверности.

![Результаты Contoso смампле](./media/business-card-results.png)
