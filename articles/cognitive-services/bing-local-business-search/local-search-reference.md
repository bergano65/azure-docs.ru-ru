---
title: Bing Местный бизнес Поиск API v7 Ссылка
titleSuffix: Azure Cognitive Services
description: В этой статье приводится техническая информация об объектах ответа, а также параметрах запроса и заголовках, влияющих на результаты поиска.
...
|----------|-----------|----------|--------------|
|<a name="count" />count|Количество результатов для возврата, начиная с `offset` индекса, указанного параметром.|Строка|нет|   
...
|<a name="mkt" />mkt|Рынок, по которому возвращаются результаты. <br /><br />Список возможных значений рынка приведен в разделе "Коды рынка".<br /><br /> **ПРИМЕЧАНИЕ.** API Local Business Search в настоящее время поддерживает только рынок и язык en-us.<br /><br />|Строка|Да|
...
|Объект|Описание|  
|------------|-----------------|  
|[Место](#place)|Определяет сведения о местных бизнесах, например, ресторан или гостиница.|  
...
|<a name="errors" />errors|Список ошибок, описывающих причины сбоя запроса.|[Ошибка (ошибка)](#error)|  
