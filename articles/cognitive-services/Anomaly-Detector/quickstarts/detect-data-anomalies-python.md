---
title: Краткое руководство. Обнаружение аномалий в пакетном режиме с помощью REST API Детектора аномалий и Python | Документация Майкрософт
