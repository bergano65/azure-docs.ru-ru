...
|-------------|-------|---|
| **{API_KEY}** | Ключ конечной точки `Anomaly Detector` ресурса на странице ключей Azure `Anomaly Detector` . | `xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx` |
