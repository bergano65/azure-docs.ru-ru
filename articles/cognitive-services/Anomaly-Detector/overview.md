...
description: Узнайте, как использовать алгоритмы API "Детектор аномалий" для обнаружения аномалий в данных временных рядов.
...
ms.locfileid: "91319322"
---
# <a name="what-is-the-anomaly-detector-api"></a>Общие сведения об API Детектора аномалий

[!INCLUDE [TLS 1.2 enforcement](../../../includes/cognitive-services-tls-announcement.md)]

API "Детектор аномалий" позволяет отслеживать и обнаруживать отклонения в данных временных рядов без специальных знаний в сфере машинного обучения. Алгоритмы API "Детектор аномалий" адаптируются путем автоматического определения и применения наиболее подходящих моделей к вашим данным, независимо от отрасли, сценария или объема данных. Используя данные временных рядов, API определяет границы для обнаружения аномалий, ожидаемые значения и точки данных, которые являются аномалиями.
...
|Обнаружьте точки изменения во всем наборе данных как пакет. | Используйте временные ряды для обнаружения любых точек изменения тенденций, существующих в данных. Эта операция приводит к созданию модели использующей все данные временных рядов, и каждая точка анализируется с помощью одной и той же модели.    |
...
Чтобы узнать, как вызвать API Детектора аномалий, используйте эту [записную книжку](https://aka.ms/adNotebook). Это приложение Jupyter Notebook поможет вам отправить запрос API и визуализировать результат.
