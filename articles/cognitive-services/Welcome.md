...
|[Служба "Пользовательское визуальное распознавание"](https://docs.microsoft.com/azure/cognitive-services/Custom-Vision-Service/home "Служба \"Пользовательское визуальное распознавание\"")|Пользовательская служба визуального распознавания позволяет создавать пользовательские классификаторы изображений.|
...
|Имя службы|Описание службы|
|:-----------|:------------------|
|[Службы распознавания речи](https://docs.microsoft.com/azure/cognitive-services/speech-service/ "Службы распознавания речи")|Служба "Речь" позволяет добавлять в приложения функции с поддержкой речи.|
...
|[Распознавание речи Bing](https://docs.microsoft.com/azure/cognitive-services/speech/home "Распознавание речи Bing") (прекращение использования)|API распознавания речи Bing позволяет без усилий добавлять в приложения функции с поддержкой речи.|
|[Перевод речи](https://docs.microsoft.com/azure/cognitive-services/translator-speech/ "Перевод речи") (прекращение использования)|Перевод речи — это служба машинного перевода.|
...
|[Персонализатор](https://docs.microsoft.com/azure/cognitive-services/personalizer/ "Персонализатор") (предварительная версия)|Персонализатор позволяет выбирать максимально удобный режим работы для своих пользователей, изучая их поведение в реальном времени.|
