...
ms.locfileid: "65020183"
---
# <a name="what-are-azure-cognitive-services"></a>Общие сведения об Azure Cognitive Services

Azure Cognitive Services — это API-интерфейсы, пакеты SDK и службы, которые помогают создавать интеллектуальные приложения разработчикам без опыта работы со средствами искусственного интеллекта и обработки и анализа данных. Azure Cognitive Services позволяют разработчикам легко добавить когнитивные функции в свои приложения. Задача Azure Cognitive Services — помочь разработчикам создавать приложения, которые умеют видеть, слышать, разговаривать и даже в некоторой степени размышлять. Каталог служб в Azure Cognitive Services можно разделить на пять основных аспектов - компьютерного зрения, речи, языка, поиск в Интернете и принятия решений.
...
|[Пользовательская служба визуального распознавания](https://docs.microsoft.com/azure/cognitive-services/Custom-Vision-Service/home "пользовательская служба визуального распознавания")|Пользовательская служба визуального распознавания позволяет создавать пользовательские классификаторы изображений.|
...
|[Форме распознаватель](https://docs.microsoft.com/azure/cognitive-services/form-recognizer/ "форме распознаватель") (Предварительная версия)|Распознаватель формы определяет и извлекает пары "ключ значение" и табличных данных из документов формы; затем выводит структурированных данных, включая связи в исходном файле.|
|[Рукописного ввода в распознаватель](https://docs.microsoft.com/azure/cognitive-services/ink-recognizer/ "рукописного ввода в распознаватель") (Предварительная версия)|Распознаватель рукописного ввода позволяет распознавать и анализ данных рукописного ввода рукописный ввод, фигур и рукописные содержимое вывода структуры документа, на всех распознанных сущностей.|
...
|Имя службы|Описание службы|
|:-----------|:------------------|
|[Службы речи](https://docs.microsoft.com/azure/cognitive-services/speech-service/ "службы распознавания речи")|Служба "Речь" позволяет добавлять в приложения функции с поддержкой речи.|
...
|[API распознавания речи Bing](https://docs.microsoft.com/azure/cognitive-services/speech/home "распознавания речи Bing") (прекращение использования)|API распознавания речи Bing позволяет без усилий добавлять в приложения функции с поддержкой речи.|
|[Перевод речи](https://docs.microsoft.com/azure/cognitive-services/translator-speech/ "перевода речи") (прекращение использования)|Перевод речи — это служба машинного перевода.|
...
|Имя службы|Описание службы|
|:-----------|:------------------|
|[Средства обнаружения аномалий](https://docs.microsoft.com/azure/cognitive-services/anomaly-detector/ "обнаружения аномалий") (Предварительная версия)|Средства обнаружения аномалий позволяет отслеживать и выявлять аномалии в данных временных рядов.|
...
|[Personalizer](https://docs.microsoft.com/azure/cognitive-services/personalizer/ "Personalizer") (Предварительная версия)|Personalizer позволяет выбрать получения наилучших результатов для отображения для пользователей, обучение от их поведения в режиме реального времени.|
...
После входа в учетную запись Майкрософт в разделе [Мои подписки](https://www.microsoft.com/cognitive-services/subscriptions "Мои подписки") можно просмотреть используемые продукты, оставшуюся квоту и возможность добавления других продуктов в подписку.

## <a name="upgrade-to-unlock-limits"></a>Обновление для снятия ограничений

Все API-интерфейсы имеют бесплатную пробную версию плана использования и пропускной способности ограничения.  Эти ограничения можно увеличить это платное предложение, выбрав соответствующий параметр уровня цен при развертывании службы на портале Azure. [Дополнительные сведения о предложениях и ценах](https://azure.microsoft.com/pricing/details/cognitive-services/ "предложения и цены"). Для этого потребуется настроить учетную запись подписчика Azure, указав данные кредитной карты и номер телефона. Если у вас есть особые пожелания или вы хотите пообщаться с торговым представителем, щелкните "Свяжитесь с отделом продаж" в верхней части страницы "Цены Azure".
