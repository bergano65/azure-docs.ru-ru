...
* Создайте свою учетную запись службы в [портал Azure](cognitive-services-apis-create-account.md) или с помощью [Azure CLI](./cognitive-services-apis-create-account-cli.md).
