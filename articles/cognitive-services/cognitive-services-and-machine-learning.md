...
|--|--|
|[Решение](https://azure.microsoft.com/services/cognitive-services/directory/decision/)|Создавайте приложения, которые удовлетворяют рекомендациям для информированного и эффективного принятия решения.|
...
|[Пользовательское визуальное распознавание](./Custom-Vision-Service/home.md)||x||
|[Распознавание лиц](./Face/Overview.md)|x|x||
|[Распознаватель форм](./form-recognizer/overview.md)||x||
|[Иммерсивное средство чтения](./immersive-reader/overview.md)|x|||
|[Распознаватель рукописного ввода](./Ink-recognizer/overview.md)|x|x||
