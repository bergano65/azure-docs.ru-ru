...
|[Язык](https://azure.microsoft.com/services/cognitive-services/directory/lang/)|Возможность реализовать в приложениях обработку естественного языка с использованием готовых скриптов, анализа тональности и обучения распознаванию пользовательских запросов.|
