...
|--|--|
|[Принятие](https://azure.microsoft.com/services/cognitive-services/directory/decision/)|Создавайте приложения, которые предоставят рекомендации для информированного и эффективного принятия решения.|
...
|[Персонализация](./personalizer/what-is-personalizer.md)|x*|x*|x|
