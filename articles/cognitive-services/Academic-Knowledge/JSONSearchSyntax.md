---
title: Синтаксис поиска JSON — Academic Knowledge API
titlesuffix: Azure Cognitive Services
description: Дополнительные сведения о синтаксисе поиска JSON, который можно использовать в Academic Knowledge API.
