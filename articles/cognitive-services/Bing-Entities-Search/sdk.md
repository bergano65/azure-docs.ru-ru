...
3.  Поиск локальной сущности, например ресторана, и получение подробных сведений о ней.
4.  Поиск местных предприятий, например ресторанов, и получение подробных сведений о них.
5.  Отправка недопустимого запроса и обработка ошибок.

> [!NOTE] 
> Некоторые пакеты SDK теперь общедоступны. В ближайшее время будут внесены изменения в документацию. 
