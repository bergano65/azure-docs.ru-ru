...
> [!NOTE]
> Доступны дополнительные параметры конфигурации. Дополнительные сведения см. в статье [Получение и использование данных журнала из ресурсов Azure](../azure-monitor/platform/platform-logs-overview.md).
...
> [!NOTE]
> Чтобы включить эту функцию с помощью PowerShell или Azure CLI, следуйте инструкциям, приведенным в статье [Получение и использование данных журнала из ресурсов Azure](../azure-monitor/platform/platform-logs-overview.md).
...
* Чтобы понять, как включить ведение журнала, а также метрики и категории журналов, которые поддерживаются различными службами Azure, прочитайте [Обзор метрик](../azure-monitor/platform/data-platform.md) в Microsoft Azure и обзор статей о [журналах диагностики Azure](../azure-monitor/platform/platform-logs-overview.md) .
...
* Прочитайте [сведения о поиске по журналам в Azure Monitor журналах](../azure-monitor/log-query/log-query-overview.md).