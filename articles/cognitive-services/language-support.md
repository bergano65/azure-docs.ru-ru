...
> [!NOTE]
> ¹ LUIS, индексатор видео, Анализ текста и преобразование речи в текст не поддерживаются.
...
* [Персонализация](https://docs.microsoft.com/azure/cognitive-services/personalizer/)
