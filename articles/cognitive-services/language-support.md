...
* [Пользовательское распознавание речи](https://docs.microsoft.com/azure/cognitive-services/custom-speech-service/customspeech-how-to-topics/cognitive-services-custom-speech-change-locale)
* [Служба "Речь": преобразование речи в текст](https://docs.microsoft.com/azure/cognitive-services/speech-service/supported-languages#speech-to-text)
* [Служба "Речь": преобразование текста в речь](https://docs.microsoft.com/azure/cognitive-services/speech-service/supported-languages#text-to-speech)
* [Служба "Речь": перевод речи](https://docs.microsoft.com/azure/cognitive-services/speech-service/supported-languages#speech-translation)
