...
| Поле | Описание |
|----|----|
| Кодирование сообщений WebSocket | Text |
...
|-|-|-|
| os.platform | Платформа ОС, на которой размещено приложение, например Windows, Android, iOS или Linux |Обязательно для заполнения |
| os.name | Название операционной системы, например Debian или Windows 10 | Обязательно для заполнения |
| os.version | Версия операционной системы в виде *major.minor.build.branch* | Обязательно для заполнения |

##### <a name="device-element"></a>Элемент устройства

| Поле | Описание | Использование |
|-|-|-|
| device.manufacturer | Изготовитель оборудования устройства | Обязательно для заполнения |
| device.model | Модель устройства | Обязательно для заполнения |
| device.version | Версия программного обеспечения устройства, предоставленная производителем устройства. В этом значении указывается версия устройства, которую может отслеживать производитель. | Обязательно для заполнения |
...
| Поле | Описание | Использование |
| ----- | ----------- | ----- |
| ИМЯ | `Connection` | Обязательно для заполнения |
| Идентификатор | Значение идентификатора соединения, использованное в заголовке *X-ConnectionId* для этого запроса на подключение. | Обязательно для заполнения |
| Начало | Время, когда клиент отправил запрос на соединение. | Обязательно для заполнения |
| End | Время, когда клиент получил уведомление о том, что соединение было успешно установлено или, в случае ошибок, отклонено, отказано или не выполнено | Обязательно для заполнения |
...
| Поле | Описание | Использование |
| ----- | ----------- | ----- |
| Name | Микрофон | Обязательно для заполнения |
| Начало | Время, когда клиент начал использовать аудиоданные с микрофона или другой аудиопоток или получил триггер от корректировщика ключевых слов | Обязательно для заполнения |
| End | Время, когда клиент прекратил использование микрофона или аудиопотока | Обязательно для заполнения |
...
| Начало | Время запуска триггера прослушивателя | Обязательно для заполнения |
| End | Время окончания работы триггера прослушивателя | Обязательно для заполнения |
