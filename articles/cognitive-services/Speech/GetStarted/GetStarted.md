...
Чтобы использовать службу преобразования текста в речь Microsoft, см. [документацию по API преобразования текста в речь](../api-reference-rest/bingvoiceoutput.md).
