...
description: С помощью этого руководства вы узнаете, как настроить экземпляр Пользовательского поиска Bing и интегрировать его в веб-страницу.
...
- Чтобы выполнить задания, описанные в этом руководстве, требуется ключ подписки для API пользовательского поиска Bing.  Чтобы получить ключ, [создайте ресурс Пользовательского поиска Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingCustomSearch) на портале Azure. Можно также использовать [ключ пробной версии](https://azure.microsoft.com/try/cognitive-services).
