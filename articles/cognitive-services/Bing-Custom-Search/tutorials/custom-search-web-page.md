...
- Чтобы выполнить задания, описанные в этом руководстве, требуется ключ подписки для API пользовательского поиска Bing.  Чтобы получить ключ, [создайте ресурс Пользовательского поиска Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingCustomSearch) на портале Azure.
