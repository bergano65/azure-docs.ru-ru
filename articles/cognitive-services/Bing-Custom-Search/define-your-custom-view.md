...
|            |                                                                                                                                                                      |
|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Заблокировать      | Перемещает домен, подстраницу или веб-страницу в список заблокированных. Bing исключит содержимое с выбранного сайта из отображаемых результатов поиска.                    |
...
## <a name="view-statistics"></a>Просмотреть статистику
