...
| Имя среза | Описание                                                                                                                                                                                                                                                                                                |
|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Домен     | Доменный срез включает в себя все содержимое, найденное в Интернет-домене. Пример: `www.microsoft.com`. Если опустить `www.`, Bing будет также выполнять поиск по поддоменам домена. Например, если указать `microsoft.com` , Bing также возвращает результаты из `support.microsoft.com` или `technet.microsoft.com` . |
