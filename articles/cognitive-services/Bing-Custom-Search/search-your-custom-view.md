...
|Параметр  |Описание  |
|---------|---------|
|query     | Условие, по которому выполняется поиск. Оно доступно только для конечных точек веб-поиска, изображений, видео и автозаполнения |
...
|Параметр  |Описание  |
|---------|---------|
|Безопасный поиск     | Фильтр, который позволяет убрать из результатов веб-страницы для взрослых. Доступно только для конечных точек веб-поиска, изображений, видео и размещаемых интерфейсов. Обратите внимание, что пользовательский Поиск видео Bing поддерживает только `moderate` два `strict`значения: и.        |
