---
title: Краткое руководство. Использование клиентской библиотеки Пользовательского поиска Bing
titleSuffix: Azure Cognitive Services
description: API "Пользовательский поиск" предоставляет клиентские библиотеки, которые упрощают интеграцию возможностей поиска в приложения. В этом кратком руководстве описано, как отправлять поисковые запросы и получать результаты.
