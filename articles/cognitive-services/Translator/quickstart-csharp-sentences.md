...
В этом кратком руководстве описано, как определить длину предложения с помощью.NET Core C# версии 7.1 или более поздней и API Перевода текстов.
