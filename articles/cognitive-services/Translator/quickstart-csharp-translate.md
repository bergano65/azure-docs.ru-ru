...
ms.locfileid: "49648468"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-c"></a>Краткое руководство. Перевод текста с помощью REST API перевода текстов (C#)
