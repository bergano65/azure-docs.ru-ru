...
|Авторизация|*Используйте с подпиской на Cognitive Services, при передаче маркер проверки подлинности.*<br/>Значением является токен носителя: `Bearer <token>`.|
