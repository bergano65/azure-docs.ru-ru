---
title: Краткое руководство. Перевод текста с помощью Перевода текстов и Python
titleSuffix: Azure Cognitive Services
description: В этом кратком руководстве вы узнаете, как перевести текст с одного языка на другой, используя API перевода текстов и Python.
