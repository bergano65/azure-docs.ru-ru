...
Из этого краткого руководства вы узнаете, как с помощью REST API Перевода текстов и .NET Core, C# версии 7.1 или более поздней определить язык заданного текста.
