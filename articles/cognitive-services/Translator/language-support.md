...
> [!NOTE]
> Код языка `pt` будет по умолчанию `pt-br`, португальский (Бразилия).
...
| Китайский (упрощенный) | `zh-Hans` | Китайский (упрощенное письмо) `Hans`| <--> | Латиница `Latn` |
| Китайский (упрощенный) | `zh-Hans` | Китайский (упрощенное письмо) `Hans`| <--> | Китайский (традиционное письмо) `Hant`|
| Китайский (традиционный) | `zh-Hant` | Китайский (традиционное письмо) `Hant`| <--> | Латиница `Latn` |
| Китайский (традиционный) | `zh-Hant` | Китайский (традиционное письмо) `Hant`| <--> | Китайский (упрощенное письмо) `Hans` |
