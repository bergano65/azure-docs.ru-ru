---
title: Краткое руководство. Определение языка текста с помощью Перевода текстов и Go
...
ms.locfileid: "46129715"
---
# <a name="quickstart-identify-language-from-text-with-go"></a>Краткое руководство по определению языка текста с помощью Go
