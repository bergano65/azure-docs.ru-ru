...
ms.locfileid: "49647210"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-go"></a>Краткое руководство. Определение языка текста с помощью REST API перевода текстов (Go)
...
6. Скомпилируйте файл, например go build quickstart-detect.go.
7. Запустите файл, например quickstart-detect.
