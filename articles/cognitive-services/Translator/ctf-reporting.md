...
| to | **Необязательный**. Строка, представляющая код языка для перевода текста.|
...
| пропустить| **Необязательный**. Количество результатов, которые вы хотите пропустить на странице. Например, если вы хотите пропустить первые 20 строк результатов и начать просмотр с 21-й записи результатов, укажите 20 для этого параметра. Значение параметра по умолчанию — 0.|
