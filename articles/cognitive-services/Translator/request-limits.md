...
Почасовая Квота должны будут потребляться равномерно на протяжении этого часа. Например достигло предельного уровня F0 символов 2 млн в час, символов следует использовать не быстрее, чем приблизительно 33,300 символов в одной минуты скользящее окно (2 млн символов, деленное на 60 минут).

Если вы или обойти эти ограничения либо отправьте слишком большой части квоты за короткий период времени, скорее всего появится готовую квоты ответа. Отсутствуют ограничения на параллельные запросы.
