...
Используйте ранее переведенные документы (листовки, веб-страницы, документацию и т.д.) для создания системы перевода, которая отражает вашу терминологию и стиль, основанную на домене, лучше, чем стандартная система перевода. Пользователи могут отправлять документы TMX, XLIFF, TXT, DOCX и XLSX.  
...
> [!NOTE]
> Наследие Microsoft Translator Hub будет отозвано 17 мая 2019 года. [Просмотр важной информации о миграции и датах](https://www.microsoft.com/translator/business/hub/).  
