...
2.  В диалоговом окне введите сведения о проекте в указанные ниже поля:
    ...
    б.  "Описание". Краткие сведения о проекте. Это описание не влияет на поведение Custom Translator или конечной пользовательской системы, но может помочь отличать этот проект от других.
