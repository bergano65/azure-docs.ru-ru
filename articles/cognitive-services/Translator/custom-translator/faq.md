...
Custom Translator пропускает выравнивание и разбивку предложений для файлов TMX и текстовых файлов с помощью расширения `.align`. Файлы с расширением `.align` предоставляют пользователям параметр для разбивки и выравнивания предложений в Custom Translator для тех файлов, которые полностью выровнены и не требуют дальнейшей обработки. Мы рекомендуем использовать расширение `.align` только для тех файлов, которые идеально выровнены.
