---
title: Часто задаваемые вопросы — настраиваемый переводчик
...
Доступ к развернутым системам можно получить через API перевода текстов Майкрософт версии 3, указав идентификатор категории. Дополнительные сведения об API перевода текстов можно найти на [этой веб-странице](../reference/v3-0-reference.md).
...
## <a name="i-tried-uploading-my-tmx-but-it-says-document-processing-failed"></a>Я попытался отправить ТМКС, но сообщает о сбое обработки документов.
