...
К развернутым системам можно получить доступ через переводчик, указав CategoryID. Дополнительные сведения о переводчике можно найти на веб-странице [Справочник по API](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-reference) .
