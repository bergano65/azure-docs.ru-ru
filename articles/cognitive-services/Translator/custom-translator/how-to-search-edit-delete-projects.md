...
Пользовательский переводчик дает вам возможность отсеивать название и описание проекта. Другие метаданные проекта, такие как категория, исходный язык и целевой язык, недоступны для его отработки. На приведенных ниже шагах описывается, как отсеивать проект.
