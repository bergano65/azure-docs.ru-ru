...
1.  **Результаты системных испытаний:** Результат тестового процесса в тренингах. В результате тестирования создается оценка BLEU.
...
1.  **custom.mt.txt:** Этот файл содержит машинные переводы исходных языковых предложений на целевом языке, выполненном моделью, обученной данными пользователя.

2.  **ref.txt:** Этот файл содержит предоставленные пользователем переводы исходных выражений на целевом языке.

3.  **источник.txt:** Этот файл содержит предложения на языке исходного кода.
