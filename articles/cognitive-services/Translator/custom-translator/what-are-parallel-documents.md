...
Неважно, какой язык помечен как "источник" и какой язык помечен как "целевой" — параллельный документ можно использовать для обучения системы перевода в любом направлении.
...
Корпорация Майкрософт требует, чтобы документы, отправленные в настраиваемый транслятор, не нарушают авторские права или интеллектуальной собственности третьей стороны. Дополнительные сведения см. в статье [об условиях использования](https://azure.microsoft.com/support/legal/cognitive-services-terms/).
