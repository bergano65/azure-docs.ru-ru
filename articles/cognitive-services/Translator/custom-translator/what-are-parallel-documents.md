...
Вам потребуется не менее 10 000 параллельных предложений для обучения системы. Рекомендуется постоянно добавлять больше параллельного содержимого и переобучать систему, чтобы улучшить качество системы перевода.
