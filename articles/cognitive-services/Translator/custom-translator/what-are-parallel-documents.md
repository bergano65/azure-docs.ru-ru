...
Вам понадобится как минимум 10 000 уникальных параллельных предложений для обучения системы. Это ограничение является защитной сеткой для обеспечения того, чтобы ваши параллельные предложения содержали достаточно уникального словаря для успешной подготовки модели перевода. В качестве наилучшей практики, постоянно добавляйте больше параллельного контента и перетренируйтесь для улучшения качества вашей системы перевода. Пожалуйста, обратитесь к [предложению выравнивания](https://docs.microsoft.com/azure/cognitive-services/translator/custom-translator/sentence-alignment).
