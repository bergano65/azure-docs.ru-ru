...
Словари хорошо работают только для проектов, языковые пары в которых полностью поддерживаются системой нейронного машинного перевода (NMT) корпорации Майкрософт. Полный список языков представлен на странице http://www.aka.ms/translatorlanguages.
