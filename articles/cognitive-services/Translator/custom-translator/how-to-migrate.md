...
description: В этой статье объясняется, как перенести рабочее пространство концентратора и проекты в пользовательский переводчик Azure Cognitive Services.
author: swmachan
manager: nitinme
...
> [!Note] 
> Для успешного обучения Custom Translator требует как минимум 10 000 уникальных извлеченных предложений. Пользовательский переводчик не может проводить обучение с меньшим, чем [предлагаемый минимум.](https://docs.microsoft.com/azure/cognitive-services/translator/custom-translator/sentence-alignment#suggested-minimum-number-of-sentences)
...
* Системы с языковыми парами, которые пока не доступны в Custom Translator, будут доступны только для доступа к данным или для развертывания через Пользовательский переводчик. Эти проекты будут помечены как "Недоступные" на странице Проектов. По мере того, как мы включаем новые языковые пары с Custom Translator, проекты станут активными для обучения и развертывания. 
...
Если вы являетесь сообществом или организацией, работающими над [custommt@microsoft.com](mailto:custommt@microsoft.com) созданием новой языковой системы для Microsoft Translator, опросите дополнительную информацию.
