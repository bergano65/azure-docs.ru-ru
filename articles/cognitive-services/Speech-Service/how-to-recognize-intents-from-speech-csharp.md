...
После выполнения этих изменений можно создать (**Control+Shift+B**) и запустить (**F5**) программу, приведенную в руководстве. При появлении запроса в микрофон компьютера следует произнести фразу "выключить свет". Приложение отображает результат в окне консоли.
...
Приложение "Учебник" не анализирует результат JSON. Оно только отображает текст JSON в окне консоли.
