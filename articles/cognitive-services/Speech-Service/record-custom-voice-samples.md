---
title: Запись пользовательских образцов голоса - Служба речи
...
Другой частью уравнения является вклад актера озвучивания. Они должны быть в состоянии говорить с последовательной скоростью, уровнем громкости, шагом и тоном. Четкая дикция является обязательной. Талант также должен быть в состоянии строго контролировать их шаг изменения, эмоциональное воздействие, и речи mannerisms.
...
|Работы&nbsp;правительственных учреждений|Произведения, созданные правительством Соединенных Штатов, не защищены авторским правом в Соединенных Штатах, хотя правительство может претендовать на авторское право в других странах/регионах.|
...
Обсудите свой проект с звукозаписывающим инженером студии и прислушайтесь к их советам. Запись должна иметь небольшое сжатие динамического диапазона или же оно должно отсутствовать (максимум 4:1). Очень важно, чтобы у записи была согласованная громкость и высокое отношение сигнала к шуму, при этом должны отсутствовать лишние звуки.
...
Чтобы не тратить время в студии, вместе с актером озвучивания быстро просмотрите сценарий перед записью. В то время как голос талант знакомится с текстом, они могут прояснить произношение любых незнакомых слов.
...
Актер озвучивания может спросить, на каком слове в высказывании стоит сделать логическое ударение ("ключевое слово"). Скажите им, что вы хотите естественное чтение без особого акцента. Логические ударения можно добавить при синтезе речи, но они не должны быть частью исходной записи.
...
> [!TIP]
> Если используется большое количество высказываний, одно высказывание может не оказывать заметного влияния на результирующую пользовательскую голосовую модель. Возможно, целесообразнее просто отметить любые высказывания с проблемами, исключить их из набора данных и посмотреть, как получается пользовательский голос. Вы всегда можете вернуться в студию и записать пропущенные образцы позже.
...
Возьмите регулярные перерывы и обеспечить напиток, чтобы помочь вашему голосу талант держать свой голос в хорошей форме.
