...
|-----------|-----------------|----------|-------------------|----------|
| [Аудиосигнал](#audio-data-for-testing) | Да<br>Используется для визуальной проверки | более 5 звуковых файлов | Нет | Н/Д |
...
Не все базовые модели поддерживают обучение с помощью звуковых данных. Если базовая модель не поддерживает ее, служба пропустит звук и просто обучить текст транскрипций. В этом случае обучение будет таким же, как и при обучении со связанным текстом.
...
Обучение со связанным текстом обычно завершается в течение нескольких минут.
