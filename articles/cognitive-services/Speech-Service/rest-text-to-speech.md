...
| Восток США | `https://eastus.tts.speech.microsoft.com/cognitiveservices/voices/list` |
...
| Заголовок | Description (Описание) | Обязательный или необязательный |
|--------|-------------|---------------------|
...
| HTTP status code (Код состояния HTTP) | Description (Описание) | Возможная причина |
|------------------|-------------|-----------------|
