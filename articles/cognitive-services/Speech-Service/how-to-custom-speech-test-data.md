...
> [!NOTE]
> При отправке обучающих и проверочных данных Размер ZIP-файла не может превышать 2 ГБ. Уау можно протестировать только из *одного* набора данных, обязательно хранить его в соответствующем размере.
