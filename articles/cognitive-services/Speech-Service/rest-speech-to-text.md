...
| Параметр | Description | Обязательный или необязательный |
|-----------|-------------|---------------------|
...
|Заголовок| Description | Обязательный или необязательный |
|------|-------------|---------------------|
...
|------------------|-------------|-----------------|
| `100` | Продолжение | Первоначальный запрос принят. Перейдите к отправке данных, которые остались. (Используется с фрагментированным перемещением) |
