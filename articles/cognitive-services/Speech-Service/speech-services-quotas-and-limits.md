...
|--|--|--|
| **Ограничение параллельных запросов на запись в Интернете (базовые и пользовательские модели)** |  |  |
| Значение по умолчанию | 1 | 20 |
...
| **Максимальный размер входного большого двоичного объекта для записи пакетов** | Недоступно | 2,5 ГБ |
| **Максимальный размер контейнера больших двоичных объектов для записи пакетов** | Недоступно | 5 ГБ |
| **Максимальное количество больших двоичных объектов на контейнер для записи пакетов** | Недоступно | 10000 |
| **Максимальное число файлов на запрос транскрипции для записи пакетов (при использовании нескольких URL-адресов содержимого в качестве входных данных)** | Недоступно | 1000  |
| **Максимальное количество одновременно выполняющихся заданий для записи пакетов** | Недоступно | 2000  |
...
| **Лимит запросов REST API** | 20 запросов в минуту | 25 запросов в течение 5 секунд |
