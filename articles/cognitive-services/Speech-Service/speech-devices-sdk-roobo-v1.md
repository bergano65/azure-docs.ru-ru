...
1. Если требуется подключить динамик к комплекту разработки, это можно сделать с помощью звукового линейного выхода. Следует выбрать высококачественный динамик с аналоговым разъемом 3,5 мм.
