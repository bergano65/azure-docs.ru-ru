...
Roobo предоставляет средство, позволяющее перехватывать все аудио для устройства флэш-памяти. Это может помочь в устранении проблем с аудио. Для каждой конфигурации набора разработки предусмотрена отдельная версия инструмента. На [сайта Roobo](http://ddk.roobo.com/), выберите устройство, а затем выберите **Roobo средства** ссылку в нижней части страницы.
