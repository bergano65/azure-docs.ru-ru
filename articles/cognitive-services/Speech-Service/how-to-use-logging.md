...
> [!NOTE]
> Ведение журнала доступно, так как Speech SDK версии 1.4.0 во всех поддерживаемых языках программирования, за исключением JavaScript Speech SDK.
