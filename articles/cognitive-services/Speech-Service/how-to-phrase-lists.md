...
Предоставляя службе речи список фраз, вы можете повысить точность распознавания речи. Списки фраз используются для идентификации известных фраз в аудиоданных, таких как имя человека или определенное место.
...
Отдельные слова или полные фразы могут быть добавлены в список фраз. Во время распознавания используется запись в списке фраз, если точная совпадение для всей фразы включено в аудио в качестве отдельной фразы. Если точное соответствие фразе не найдено, распознавание не помогается.
