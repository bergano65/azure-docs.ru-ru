...
1. Создайте новый параметр, чтобы указать, будет ли пользователь включать или выключать устройство
   ...
   | Является глобальным          | не включен           | Флажок, указывающий, будет ли значение этого параметра глобально применено ко всем командам в проекте |
   | Обязательно для заполнения           | включен             | Флажок, указывающий, требуется ли значение этого параметра перед выполнением команды          |
