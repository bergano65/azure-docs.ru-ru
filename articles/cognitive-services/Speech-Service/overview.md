...
> [!IMPORTANT]
> Службы речи заменили API распознавания речи Bing, Перевод речи и Пользовательское распознавание речи. Указания по миграции см. в разделе _Практические руководства > Миграция_.
