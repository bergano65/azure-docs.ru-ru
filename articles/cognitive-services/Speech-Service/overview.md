...
|[Преобразование текста в речь](text-to-speech.md)| <li>Преобразует текст в естественно звучащую речь. <li>Предлагает голоса обеих полов и диалекты для множества поддерживаемых языков. <li>Поддерживает ввод простого текста или на языке разметки синтеза речи (Speech Synthesis Markup Language, SSML). |
