...
* Получить [комплект разработки можно на сайте ROOBO](https://ddk.roobo.com/). Доступны комплекты с конфигурациями линейной или кольцевой микрофонной решетки. Выберите подходящую конфигурацию.
...
ROOBO предоставляет инструмент, который собирает все аудио во флэш-память. Это может помочь в устранении проблем с аудио. Для каждой конфигурации набора разработки предусмотрена отдельная версия инструмента. На [сайте ROOBO](https://ddk.roobo.com/) выберите свое устройство и затем откройте ссылку **ROOBO Tools** (Средства ROOBO) в нижней части страницы.
