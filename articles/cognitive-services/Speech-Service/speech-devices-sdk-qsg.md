---
title: Начало работы с пакетом SDK для речевых устройств
...
1. С помощью кабеля mini-USB подключите комплект разработки к компьютеру или адаптеру питания. Когда комплект подключен, под верхней панелью загорается зеленый индикатор питания.

1. С помощью второго кабеля mini-USB подключите комплект разработки к компьютеру.
...
1. Установите сертификаты и табличный файл со словами для пробуждения (ключевое слово) и задайте разрешения для звукового устройства. Введите следующие команды в окне командной строки:
