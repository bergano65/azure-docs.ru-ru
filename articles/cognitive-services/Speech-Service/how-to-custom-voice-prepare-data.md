...
| Тип данных | Description (Описание) | Сценарии использования | Требуется дополнительная служба | Количество для обучения модели | Языковой стандарт (s) |
| --------- | ----------- | ----------- | --------------------------- | ----------------------------- | --------- |
