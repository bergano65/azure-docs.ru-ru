...
|--|--|--|
| **Речь к тексту** | один декодер требует как минимум 1150 милликоров. Если `optimizedForAudioFile` включено, то требуется 1,950 милликоров. (по умолчанию: два декодера) | Требуется: 2 ГБ<br>Ограничено: 4 ГБ |
