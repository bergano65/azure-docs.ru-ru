---
title: Краткое руководство. Пользовательский виртуальный помощник по обработке голоса (предварительная версия), Java (Android). Службы распознавания речи
titleSuffix: Azure Cognitive Services
description: Узнайте, как создать приложение виртуального помощника по обработке голоса в Java на Android с помощью пакета SDK службы "Речь"
...
1. В том же файле замените строки конфигурации в соответствии с ресурсами:
    ...
    * Замените `YourServiceRegion` [регионом](regions.md), связанным с вашей подпиской. Служба "Речь Direct Line" сейчас поддерживается только в ряде регионов служб распознавания речи. Дополнительные сведения см. в разделе [Регионы](regions.md#voice-first-virtual-assistants).
