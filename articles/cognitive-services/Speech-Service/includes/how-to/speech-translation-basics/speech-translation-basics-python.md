...
Если вы хотите перейти непосредственно к образцу кода, см. [примеры](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/python) быстрого запуска Python на сайте GitHub.
