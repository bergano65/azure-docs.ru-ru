...
ms.locfileid: "81399588"
---
## <a name="additional-language-and-platform-support"></a>Поддержка дополнительных языков и платформ

Если вы щелкнули эту вкладку, вы, вероятно, не увидели базовую статью для предпочитаемого языка программирования. Не беспокойтесь. У нас есть дополнительные примеры кода, доступные на сайте GitHub. Используйте таблицу, чтобы найти правильный пример для своего сочетания языка программирования, платформы и ОС.

| Язык    | Примеры кода                                                                                                                            |
|-------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| C#          | [.NET Framework][csharp-netframework], [.NET Core][csharp-netcore], [UWP][csharp-uwp], [Unity][csharp-unity], [Xamarin][csharp-xamarin] |
| C++         | [Краткие руководства][cpp-quickstarts], [примеры][cpp-samples]                                                                                  |
| Java        | [Android][java-android], [JRE][java-jre]                                                                                                |
| JavaScript  | [Браузер][js-browser]                                                                                                                   |
