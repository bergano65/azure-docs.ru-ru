...
| `speechToText.verification.enabled` | `helm test` Включена ли поддержка **распознавания речи в текст** . | `true` |
...
| `textToSpeech.verification.enabled` | `helm test` Включена ли поддержка **распознавания речи в текст** . | `true` |
