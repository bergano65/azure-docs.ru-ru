...
ms.locfileid: "81399882"
---
:::row:::
    :::column span="3":::
        При разработке для Android доступно два пакета SDK для распознавания речи. Пакет SDK для распознавания речи Java доступен в виде пакета Android, или пакет SDK для .NET для распознавания речи можно использовать с **Xamarin. Android** , так как он реализует .NET Standard 2,0.
    :::column-end:::
    :::column:::
        <br>
...
:::row:::
    :::column span="3":::
        Xamarin.Android предоставляет полный пакет SDK для Android для разработчиков .NET. Создавайте собственные приложения Android с помощью C# и F# в Visual Studio. Дополнительные сведения см. в статье о <a href="https://docs.microsoft.com/xamarin/android/" target="_blank">Xamarin <span class="docon docon-navigate-external x-hidden-focus"></span> . Android.</a>
    :::column-end:::
    :::column:::
        <br>
        <div class="icon is-large">
