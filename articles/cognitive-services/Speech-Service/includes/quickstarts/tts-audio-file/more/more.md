...
ms.date: 03/30/2020
ms.author: dapine
ms.openlocfilehash: cdfde5d1538d597bd1efce11d1a248a5048859b9
ms.sourcegitcommit: 6397c1774a1358c79138976071989287f4a81a83
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 04/07/2020
ms.locfileid: "80813701"
---
## <a name="additional-language-and-platform-support"></a>Поддержка дополнительных языков и платформ

Если вы щелкнули эту вкладку, вы, вероятно, не увидели краткого руководства для предпочитаемого языка программирования. Не беспокойтесь. У нас есть дополнительные материалы по быстрому запуску и примеры кода, доступные на сайте GitHub. Используйте таблицу, чтобы найти правильный пример для своего сочетания языка программирования, платформы и ОС.

| Язык | Дополнительные краткие руководства | Примеры кода |
|--|--|--|
| C# | [Вывод на динамик][1-speaker] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [Вывод на динамик][2-speaker] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [Вывод на динамик][3-speaker] | [Android][java-android], [JRE][java-jre] |
| JavaScript | [В звуковой файл (Node.js)][js-node] | [Windows, Linux, macOS][js-code] |
| Objective-C | [Вывод на динамик (iOS)][obj-iOS-qck], [Вывод на динамик (macOS)][obj-macOS-qck] | [iOS][obj-iOS], [macOS][obj-macOS] |
| Python | [Вывод на динамик][4-speaker] | [Windows, Linux, macOS][python] |
| Swift | [Вывод на динамик (iOS)][swift-iOS-qck], [Вывод на динамик (macOS)][swift-macOS-qck] | [iOS][swift-iOS], [macOS][swift-macOS] |
