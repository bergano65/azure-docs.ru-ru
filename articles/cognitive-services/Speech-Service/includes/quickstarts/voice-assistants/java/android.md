...
> * [Настройка среды разработки и создание пустого проекта](~/articles/cognitive-services/speech-service/quickstarts/setup-platform.md?tabs=android)
