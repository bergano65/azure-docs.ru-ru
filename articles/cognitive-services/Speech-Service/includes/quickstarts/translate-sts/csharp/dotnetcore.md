---
title: Краткое руководство. Перевод речи в речь в службе "Речь" с помощью C# (.NET Core в Windows)
...
> * [Настройте среду разработки и создайте пустой проект](../../../../quickstarts/setup-platform.md?tabs=dotnetcore).
