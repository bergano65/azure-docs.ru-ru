...
ms.locfileid: "75660564"
---
## <a name="prerequisites"></a>предварительные требования

Необходимые условия:

* Если это ваш первый проект C++, воспользуйтесь этим руководством, чтобы <a href="../quickstarts/create-project.md?tabs=windows" target="_blank">создать пустой пример проекта</a>.
* <a href="../quickstarts/setup-platform.md?tabs=windows" target="_blank">Установите пакет SDK для службы "Речь" для среды разработки</a>.
