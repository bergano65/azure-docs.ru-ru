...
ms.locfileid: "75660550"
---
## <a name="prerequisites"></a>предварительные требования

Необходимые условия:

* Если это ваш первый проект Java (JRE), воспользуйтесь этим руководством, чтобы <a href="../quickstarts/create-project.md?tabs=jre" target="_blank">создать пустой пример проекта</a>.
* <a href="../quickstarts/setup-platform.md?tabs=jre" target="_blank">Установите пакет SDK для службы "Речь" для среды разработки</a>.
...
Вставьте приведенный ниже код под вызовом `recognizeOnceAsync()`: [!code-java[](~/samples-cognitive-services-speech-sdk/quickstart/java/jre/intent-recognition/src/speechsdk/quickstart/Main.java?range=44-65)]
