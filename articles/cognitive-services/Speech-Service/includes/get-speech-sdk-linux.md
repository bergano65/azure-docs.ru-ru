...
ms.locfileid: "80668749"
---
:::row:::
    :::column span="3":::
        Речь SDK поддерживает только **Ubuntu 16.04/18.04**, **Debian 9**, **Red Hat Enterprise Linux (RHEL) 7/8**, и **CentOS 7/8** на следующих целевых архитектур при использовании с Linux:
        - X64
    :::column-end:::
    :::column:::
        <br>
