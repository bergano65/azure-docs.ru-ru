...
На приведенной ниже схеме показаны действия по созданию настраиваемой модели речи с помощью пользовательского Voice. Воспользуйтесь ссылками для получения дополнительных сведений.
...
- [Подготовка настраиваемых голосов данных](how-to-custom-voice.md)
