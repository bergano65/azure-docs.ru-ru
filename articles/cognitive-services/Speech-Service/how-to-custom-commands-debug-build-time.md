...
[Luis ограничивает число приложений 500 на каждый ресурс разработки](https://docs.microsoft.com/azure/cognitive-services/luis/luis-limits). Создание приложения LUIS может завершиться ошибкой, если вы используете ресурс создания, который уже содержит 500 приложений. 
