---
title: Краткое руководство. Распознавание речи с помощью Objective-C в службе "Речь" (macOS)
titleSuffix: Azure Cognitive Services
description: Узнайте, как создать приложение для распознавания речи на Objective-C для компьютера macOS с помощью пакета SDK службы "Речь" в Cognitive Services.
