...
description: В этом кратком руководстве показано, как использовать пакет SDK службы "Речь" для интерактивного перевода речи на одном языке в текст на другом.
