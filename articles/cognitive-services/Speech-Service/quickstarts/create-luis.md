...
description: В этом учебнике вы узнаете, как быстро создать приложение LUIS.
...
|Начало работы|Позволяет тестировать приложение LUIS только с помощью текста|
