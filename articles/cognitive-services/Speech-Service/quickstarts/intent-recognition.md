---
title: Краткое руководство по распознаванию намерений — служба Речи
titleSuffix: Azure Cognitive Services
description: В этом кратком руководстве показано, как использовать интерактивное распознавание намерений из аудиоданных, полученных с микрофона.
