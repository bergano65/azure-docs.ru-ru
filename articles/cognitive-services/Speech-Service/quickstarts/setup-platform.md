---
title: Краткое руководство. Настройка среды разработки
...
# <a name="java-runtime"></a>[Среда выполнения Java](#tab/jre)
...
#### <a name="browser-based"></a>[На основе браузера](#tab/browser)
