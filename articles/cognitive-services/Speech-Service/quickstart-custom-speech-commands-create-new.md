...
Теперь можно создать команду. Давайте рассмотрим пример, который будет принимать одно utterance, `turn on the tv`и реагировать на сообщение. `Ok, turning on the TV`
...
1. Создайте новое правило завершения, щелкнув `+` значок рядом с полем правила завершения.
1. Введите имя правила
1. Добавление действия
   1. Создайте новое действие речевого ответа, щелкнув `+` значок рядом с пунктом действия и выбрав`SpeechResponse`
   1. Введите ответ
