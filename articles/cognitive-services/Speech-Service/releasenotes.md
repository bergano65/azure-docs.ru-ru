...
* **Нейронный TTS, 15 новых нейронных голосов**. новые голоса, добавленные в портфель НЕЙРОНного TTS, Салма на арабском языке (Египет), Зарийах на арабском языке (Саудовская Аравия), Алба в каталанского (Испания), Чристел в датском (Дания), Ниржа на английском языке (Индия), свара в хинди (Индия), Колетте в нидерландском (Нидерланды), Зофиа в польском (Польша), Фернанда на португальском языке (Португалия), Дарийа в России (Россия), Хиллеви в шведском (Швеции), Ачара в Швеции (Таиланд), иселин Норвежский (букмол) в (Норвегия), HiuGaai в китайском (Гонконг) и HsiaoYu (Тайвань). Проверьте все [Поддерживаемые языки](https://docs.microsoft.com/azure/cognitive-services/speech-service/language-support#neural-voices).  
...
* Улучшена функция TTS вокодер для повышения точности и снижения задержки.
    ...
    * Обновленная Елса на итальянском языке до новой вокодер, которая достигает + 0,464 CMOS (сравнительная оценка очков), обеспечивает качество голоса, 40% быстрее в синтезе и 30% снижения задержки в первых байтах. 
    * Обновлен Ксиаоксиао на китайском языке до нового вокодер с усилением CMOS + 0148 для общего домена, + 0,348 для стиля невскаст и + 0,195 для стиля лирикал. 

* Обновленные `de-DE` и `ja-JP` голоса модели, чтобы сделать вывод в формате TTS более естественным.
    
    * Обновленный Катжа на немецком языке с последним методом моделирования Prosody, МОС (среднее мнение) получает значение + 0,13. 
    * Обновленная Нанами на японском языке с новой моделью Prosody, МОС (оценка мнения) имеет значение + 0,19;  
