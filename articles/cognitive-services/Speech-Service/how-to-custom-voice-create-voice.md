...
| Состояние | Значение |
| ----- | ------- |
| Идет обработка | Набор данных получен и обрабатывается. |
| Succeeded | Набор данных проверен и теперь может использоваться для создания модели голоса. |
...
| Состояние | Значение |
| ----- | ------- |
| Идет обработка | Создается модель речи. |
| Succeeded | Ваша модель голоса создана и может быть развернута. |
