...
Каждое обучение будет автоматически создавать образцы звуковых файлов 100, которые помогут вам протестировать модель. После успешной сборки голоса модель можно проверить перед развертыванием для использования.

1.  Переход к **тексту в речь > пользовательского голоса > [имя проекта] > модель**.

2.  Щелкните имя модели, которую нужно протестировать.

3.  На странице сведения о модели можно найти образцы звуковых файлов на вкладке **тестирование** . 
