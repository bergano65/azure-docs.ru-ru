...
После успешной отправки данных щелкните имя каждого элемента, чтобы просмотреть подробные сведения о них. На странице подробностей перечислены все файлы в наборе данных, и можно щелкнуть нужный utterance. Для каждого utterance можно воспроизвести звук и проанализировать записи, а также изменить транскрипции в случае обнаружения ошибок вставки, удаления или подстановки. Дополнительные сведения о типах ошибок см. в статье [анализ данных](how-to-custom-speech-evaluate-data.md) .

![Страница редактора](media/custom-speech/custom-speech-editor.png)

Если звуковой файл имеет большую длину, он автоматически делится на небольшие части. Их можно изменить по одному, используя **предыдущий** и **Далее** для перемещения между страницами. После внесения изменений нажмите кнопку **сохранить** .
