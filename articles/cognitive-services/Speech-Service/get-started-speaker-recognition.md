---
title: Краткое руководство по Распознаванию говорящего — служба Речи
titleSuffix: Azure Cognitive Services
description: Узнайте, как использовать Распознавание говорящего из пакета SDK службы Речи. В этом кратком руководстве описаны стандартные шаблоны проектирования для работы с проверкой и идентификацией говорящего на основе голосовой биометрии для определения уникальных голосов.
...
ms.locfileid: "89410549"
---
# <a name="get-started-with-speaker-recognition"></a>Начало работы с Распознаванием говорящего
