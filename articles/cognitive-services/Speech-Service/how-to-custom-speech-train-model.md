...
6. На странице **выбор обучающих данных** выберите один или несколько связанных текстовых наборов данных, а также наборы данных для транскрипции или звуковых и пользовательских меток, которые вы хотите использовать для обучения.

> [!NOTE]
> При обучении новой модели Начните с связанного текста. обучение с помощью звука и транскрипции может занять много времени **(до [нескольких дней](how-to-custom-speech-evaluate-data.md#add-audio-with-human-labeled-transcripts)**).
