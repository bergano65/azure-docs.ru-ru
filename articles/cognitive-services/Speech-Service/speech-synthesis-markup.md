...
| duration  | Период времени, который должен пройти во время речи синтеза (TTS) служба считывает текст, в секунды или миллисекунды. Например *2s* или *1800ms*. | Необязательно |
