---
title: Разработка приложений с помощью речевого SDK - Речевой сервис
titleSuffix: Azure Cognitive Services
description: Узнайте, как развернуть приложение, используюеееееело Speech SDK на поддерживаемых платформах.
...
Когнитивные услуги речи SDK требует [Microsoft Visual C е Redistributable для Visual Studio 2019](https://support.microsoft.com/help/2977003/the-latest-supported-visual-c-downloads) на системе. Установщики для последней версии `Microsoft Visual C++ Redistributable for Visual Studio 2019` можно скачать здесь:
...
Речь SDK в настоящее время поддерживает Ubuntu 16.04, Ubuntu 18.04, Debian 9, RHEL 8, CentOS 8 дистрибутивов.
...
На Debian 9 установите эти пакеты:
