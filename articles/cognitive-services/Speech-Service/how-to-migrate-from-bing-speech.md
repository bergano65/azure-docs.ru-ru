...
[Интерфейсы API-интерфейсов](./overview.md#reference-docs) службы распознавания речи совместимы с интерфейсами API распознавание речи Bing. Если вы используете Распознавание речи Bing интерфейсы API-интерфейсов, необходимо изменить только конечную точку и переключиться на ключ подписки на службу речи.
...
1. Поработайте с [краткими руководствами](./get-started-speech-to-text.md?pivots=programming-language-csharp&tabs=dotnet) и [учебниками](how-to-recognize-intents-from-speech-csharp.md)по речевым службам. Также ознакомьтесь с [примерами кода](./speech-sdk.md#sample-source-code), чтобы получить опыт работы с новыми интерфейсами API.
