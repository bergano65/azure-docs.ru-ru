...
1. Нажмите **Создать**. Создание группы ресурсов может занять несколько минут.
...
6. Нажмите **Создать**. Создание группы ресурсов может занять несколько минут.
...
1. Нажмите **Создать**. На последнем экране мастера нажмите кнопку **Готово**.
