...
5. Браузер должен запуститься, и появится экран, похожий на этот.
    ...
    > ![ечобот — работает на локальном компьютере](media/tutorial-voice-enable-your-bot-speech-sdk/echobot-running-on-localhost.png "Ечобот, выполняемый на localhost")
...
5. В этом случае обмен данными с экземпляром Echo Bot может выглядеть так: ![Bot-Framework-Emulator](media/tutorial-voice-enable-your-bot-speech-sdk/bot-framework-emulator.png "Эмулятор Bot Framework") .
...
1. Выберите **служба приложений** в области навигации **служб Azure** , выберите **создать**и нажмите кнопку **опубликовать**.
...
1. В области навигации **служб Azure** щелкните **Параметры**.
