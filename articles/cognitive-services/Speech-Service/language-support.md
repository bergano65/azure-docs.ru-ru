...
| Болгарская (Булгари) | `bg-BG` | Жен. | `bg-BG-KalinaNeural` <sup>Оператор new</sup> | Общее |
...
| Хорватский (Хорватия) | `hr-HR` | Жен. | `hr-HR-GabrijelaNeural` <sup>Оператор new</sup> | Общее |
| Чешский (чешский) | `cs-CZ` | Жен. | `cs-CZ-VlastaNeural` <sup>Оператор new</sup>    | Общее |
...
| Английский (Австралия) | `en-AU` | Муж.   | `en-AU-WilliamNeural` <sup>Оператор new</sup>  | Общие сведения |
| Английский (Канада) | `en-CA` | Жен. | `en-CA-ClaraNeural` | Общее |
| Английский (Индия) | `en-IN` | Жен. | `en-IN-NeerjaNeural` | Общее |
| Английский (Ирландия) | `en-IE` | Жен. | `en-IE-EmilyNeural` <sup>Оператор new</sup> | Общее |
| Английский (Великобритания) | `en-GB` | Жен. | `en-GB-LibbyNeural` | Общее |
| Английский (Великобритания) | `en-GB` | Жен. | `en-GB-MiaNeural` | Общее |
| Английский (Великобритания) | `en-GB` | Муж. | `en-GB-RyanNeural` <sup>Оператор new</sup> | Общее |
...
| Английский (США) | `en-US` | Жен. | `en-US-JennyNeural` <sup>Оператор new</sup> | Общие, несколько стилей голоса, доступных [с помощью SSML](speech-synthesis-markup.md#adjust-speaking-styles) |
...
| Французский (Канада) | `fr-CA` | Муж. | `fr-CA-JeanNeural` <sup>Оператор new</sup> | Общие сведения |
| Французский (Франция) | `fr-FR` | Жен. | `fr-FR-DeniseNeural` | Общие сведения |
| Французский (Франция) | `fr-FR` | Муж. | `fr-FR-HenriNeural` <sup>Оператор new</sup> | Общее |
| Французский (Швейцария) | `fr-CH` | Жен. | `fr-CH-ArianeNeural` <sup>Оператор new</sup> | Общее |
| Немецкий (Австрия) | `de-AT` | Жен. | `de-AT-IngridNeural` <sup>Оператор new</sup> | Общее |
| Немецкий (Германия) | `de-DE` | Жен. | `de-DE-KatjaNeural` | Общее |
| Немецкий (Германия) | `de-DE` | Муж. | `de-DE-ConradNeural` <sup>Оператор new</sup> | Общее |
| Немецкий (Швейцария) | `de-CH` | Жен. | `de-CH-LeniNeural` <sup>Оператор new</sup> | Общее |
| Греческий (Греция) | `el-GR` | Жен. | `el-GR-AthinaNeural` <sup>Оператор new</sup> | Общее |
| Иврит (Израиль) | `he-IL` | Жен. | `he-IL-HilaNeural` <sup>Оператор new</sup> | Общее |
| Хинди (Индия) | `hi-IN` | Жен. | `hi-IN-SwaraNeural` | Общее |
| Венгерский (Венгрия) | `hu-HU` | Жен. | `hu-HU-NoemiNeural` <sup>Оператор new</sup> | Общее |
| Индонезийский (Индонезия) | `id-ID` | Муж. | `id-ID-ArdiNeural` <sup>Оператор new</sup> | Общие сведения |
| Итальянский (Италия) | `it-IT` | Жен. | `it-IT-ElsaNeural` | Общие сведения |
| Итальянский (Италия) | `it-IT` | Жен. | `it-IT-IsabellaNeural` <sup>Оператор new</sup> | Общие сведения |
| Итальянский (Италия) | `it-IT` | Муж. | `it-IT-DiegoNeural` <sup>Оператор new</sup> | Общее |
| Японский (Япония) | `ja-JP` | Жен. | `ja-JP-NanamiNeural` | Общее |
| Японский (Япония) | `ja-JP` | Муж. | `ja-JP-KeitaNeural` <sup>Оператор new</sup> | Общее |
| корейский (Корея) | `ko-KR` | Жен. | `ko-KR-SunHiNeural` | Общее |
| корейский (Корея) | `ko-KR` | Муж. | `ko-KR-InJoonNeural` <sup>Оператор new</sup> | Общее |
| Малайский (Малайзия) | `ms-MY` | Жен. | `ms-MY-YasminNeural` <sup>Оператор new</sup> | Общее |
...
| Португальский (Бразилия) | `pt-BR` | Муж. | `pt-BR-AntonioNeural` <sup>Оператор new</sup> | Общее |
| Португальский (Португалия) | `pt-PT` | Жен. | `pt-PT-FernandaNeural` | Общее |
| Румынский (Румыния) | `ro-RO` | Жен. | `ro-RO-AlinaNeural` <sup>Оператор new</sup> | Общее |
| Русский (Россия) | `ru-RU` | Жен. | `ru-RU-DariyaNeural` | Общее |
| Словацкий (Словакия) | `sk-SK` | Жен. | `sk-SK-ViktoriaNeural` <sup>Оператор new</sup> | Общее |
| Словенский (Словения) | `sl-SI` | Жен. | `sl-SI-PetraNeural` <sup>Оператор new</sup> | Общие сведения |
| Испанский (Мексика) | `es-MX` | Жен. | `es-MX-DaliaNeural` | Общие сведения |
| Испанский (Мексика) | `es-MX` | Муж. | `es-MX-JorgeNeural` <sup>Оператор new</sup> | Общие сведения |
| испанский (Испания) | `es-ES` | Жен. | `es-ES-ElviraNeural` | Общие сведения |
| испанский (Испания) | `es-ES` | Муж. | `es-ES-AlvaroNeural` <sup>Оператор new</sup> | Общее |
| Шведский (Швеция) | `sv-SE` | Жен. | `sv-SE-HilleviNeural` | Общее |
| Тамильский (Индия) | `ta-IN` | Жен. | `ta-IN-PallaviNeural` <sup>Оператор new</sup> | Общее |
| Телугу (Индия) | `te-IN` | Жен. | `te-IN-ShrutiNeural` <sup>Оператор new</sup> | Общее |
| Тайский (Таиланд) | `th-TH` | Жен. | `th-TH-AcharaNeural` | Общее |
| Тайский (Таиланд) | `th-TH` | Жен. | `th-TH-PremwadeeNeural` <sup>Оператор new</sup> | Общее |
| Турецкий (Турция) | `tr-TR` | Жен. | `tr-TR-EmelNeural` | Общее |
| Вьетнамский (Вьетнам) | `vi-VN` <sup>Оператор new</sup> | Жен. | `vi-VN-HoaiMyNeural` | Общее|
...
| Язык                         | Языковой стандарт  | пол; | Название голоса                             | Поддержка стиля |
|----------------------------------|---------|--------|----------------------------------------|---------------|
| Китайский (мандаринский диалект, упрощенный) | `zh-CN` | Муж.   | `zh-CN-YunxiNeural` <sup>Оператор new</sup> | Общие, несколько стилей, доступных [с помощью SSML](speech-synthesis-markup.md#adjust-speaking-styles) |
| Китайский (мандаринский диалект, упрощенный) | `zh-CN` | Жен. | `zh-CN-XiaohanNeural` <sup>Оператор new</sup> | Общие, несколько стилей, доступных [с помощью SSML](speech-synthesis-markup.md#adjust-speaking-styles) |
| Китайский (мандаринский диалект, упрощенный) | `zh-CN` | Жен. | `zh-CN-XiaoxuanNeural` <sup>Оператор new</sup> | Общие, несколько воспроизводимых ролей и [стилей, доступных с помощью SSML](speech-synthesis-markup.md#adjust-speaking-styles) |
| Китайский (мандаринский диалект, упрощенный) | `zh-CN` | Жен. | `zh-CN-XiaomoNeural` <sup>Оператор new</sup> | Общие, несколько воспроизводимых ролей и [стилей, доступных с помощью SSML](speech-synthesis-markup.md#adjust-speaking-styles) |
| Китайский (мандаринский диалект, упрощенный) | `zh-CN` | Жен. | `zh-CN-XiaoruiNeural` <sup>Оператор new</sup> | Старшие голоса, несколько стилей, доступных [с помощью SSML](speech-synthesis-markup.md#adjust-speaking-styles) |
| Эстонский (Эстония) | `et-EE` | Жен. | `et-EE-AnuNeural` <sup>Оператор new</sup> | Общее |
| Гэльский (Ирландия) | `ga-IE` | Жен. | `ga-IE-OrlaNeural` <sup>Оператор new</sup> | Общее |
| Литовский (Литва) | `lt-LT` | Жен. | `lt-LT-OnaNeural` <sup>Оператор new</sup> | Общее |
| Латышский (Латвия) | `lv-LV` | Жен. | `lv-LV-EveritaNeural` <sup>Оператор new</sup> | Общее |
| Мальтийский (Мальта) | `mt-MT` | Жен. | `mt-MT-GraceNeural` <sup>Оператор new</sup> | Общее |
