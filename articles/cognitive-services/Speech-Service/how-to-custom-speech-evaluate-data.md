...
> [!NOTE]
> Не все базовые модели поддерживают обучение с помощью аудио. Если базовая модель не поддерживает ее, служба распознавания речи будет использовать только текст из записей и игнорировать звук.
