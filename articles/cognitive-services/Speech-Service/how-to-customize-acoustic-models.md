...
description: Узнайте, как создать акустическую модель с помощью служб "Речь" в Azure.
...
ms.locfileid: "57844030"
---
# <a name="tutorial-create-a-custom-acoustic-model"></a>Руководство. Создание пользовательской акустической модели
...
Вы можете подключиться к подписке службы "Речь", созданной на портале Azure, выбрав **Connect existing subscription** (Подключиться к имеющейся подписке).

Дополнительные сведения о создании подписок служб "Речь" на портале Azure см. на странице [Бесплатная пробная подписка на службу "Речь"](get-started.md).
...
Акустический набор данных для настройки акустической модели состоит из двух частей: набора звуковых файлов с данными речи и файла с расшифровкой всех звуковых файлов.
...
Выполните действия в следующих разделах с помощью [портала служб "Речь"](https://cris.ai).
