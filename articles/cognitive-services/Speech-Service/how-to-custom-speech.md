...
На этой схеме показаны элементы, составляющие [портал пользовательское распознавание речи](https://speech.microsoft.com/customspeech). Используйте приведенные ниже ссылки для получения дополнительных сведений о каждом шаге.
...
Перед использованием [портала пользовательское распознавание речи](https://speech.microsoft.com/customspeech) для создания настраиваемой модели требуется подписка на службы речи. Выполните следующие инструкции, чтобы создать стандартную подписку на речевые службы: [Создайте речевую подписку](https://docs.microsoft.com/azure/cognitive-services/speech-service/get-started#new-azure-account).
