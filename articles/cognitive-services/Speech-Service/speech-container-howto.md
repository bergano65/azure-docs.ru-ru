...
|-|-|--|
|Преобразование речи в текст| <li>Расшифровывает непрерывной в режиме реального времени речи или пакета, аудиозаписи в текст с промежуточными результатами.|1.1.3|
...
В следующей таблице перечислены поддерживаемые языковые стандарты для **речи в текст** в 1.1.3 версии контейнера:
