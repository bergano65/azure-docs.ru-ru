...
Кроме того, доступны краткие руководства по [синтезу речи](quickstart-text-to-speech-python.md).

[!INCLUDE [Selector](../../../includes/cognitive-services-speech-service-quickstart-selector.md)]

В этой статье показано, как использовать службы речи с помощью Speech SDK для Python а также как распознавать речь с использованием микрофона.
