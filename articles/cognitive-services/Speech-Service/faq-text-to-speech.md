...
description: Получите ответы на часто задаваемые вопросы о службе «Текст к речи».
...
На данный момент мы не обеспечиваем поддержку записи в сети и не можем предоставить рекомендации по звукозаписывающим студиям. Для требования формата, посмотрите, [как подготовить записи и стенограммы](https://docs.microsoft.com/azure/cognitive-services/speech-service/how-to-custom-voice-create-voice).
