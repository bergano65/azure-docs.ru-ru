---
title: Настройка произношения с помощью службы распознавания речи
titlesuffix: Azure Cognitive Services
description: Узнайте, как настроить произношение с помощью службы распознавания речи.
