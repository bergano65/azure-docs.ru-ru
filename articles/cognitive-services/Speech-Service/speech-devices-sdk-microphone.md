---
title: Рекомендации по использованию микрофона пакета SDK для речевых устройств — служба речи
titleSuffix: Azure Cognitive Services
description: Рекомендации по использованию микрофона пакета SDK для речевых устройств. Следующие геометрические массивы рекомендуется использовать с Microsoft Audio Stack. Улучшено расположение звуковых источников и отклонение окружающих шума с большим числом микрофонов с зависимостями от конкретных приложений, пользовательских сценариев и конструктивных форм устройств.
...
*\*Для приложений высококачественного обмена данными (VoIP) может потребоваться более высокая частота дискретизации или более широкие диапазоны частот.*
...
*\*\*Для измерения СД требуется докладчик с низким искажением (например, Неймана KH120).*

*\*\*Для приложений высококачественного обмена данными (VoIP) могут потребоваться "более широкие" диапазоны частот.*
