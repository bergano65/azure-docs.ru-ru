...
|-----------------------------------|-----------------------------------|
| ВЫСШЕЕ                               | \>= dB 65 (dBSPL сигнала 94 1КГц, со смещением A шума)   |
...
Производительность массива микрофона, встроенного в устройство будет отличаться от спецификации компонентов. Важно, чтобы убедиться, что после интеграции также сопоставляются микрофонов. Таким образом производительность устройства измеряется после любой фиксированной получить или EQ должен отвечать следующим требованиям:

|  Параметр        |    Рекомендуется |
|--------------------|----------------------------------------------------|
|  ВЫСШЕЕ                 | \> 63 dB (dBSPL сигнала 94 1КГц, со смещением A шума) |
...
*\*\* Динамика низкой искажение необходим для измерения Нелинейных (например Неймана KH120)*
