...
Если вы адаптировали и развернули модель с базовым планом версии 1.0, такое развертывание не будет изменяться. Клиент может вывести развернутую модель из эксплуатации, повторно адаптировать ее в более новой версии базового плана и снова развернуть.
...
Если вам нужно больше, свяжитесь с нами.
