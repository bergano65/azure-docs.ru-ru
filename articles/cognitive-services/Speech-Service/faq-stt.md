...
**Вопрос. увеличивается ли ограничение на параллелизм?**

Ответ **. нет**, стоимость основана на использовании. Увеличение параллелизма не приводит к увеличению затрат. Дополнительные сведения о стоимости см. на [странице с ценами](https://azure.microsoft.com/pricing/details/cognitive-services/speech-services/) . 
