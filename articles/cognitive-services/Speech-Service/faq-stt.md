...
Ответ **.** Если модель клиента включена, создана и опубликована, она используется для улучшения распознавания любых корпоративных приложений, созданных с помощью речевых служб. Это также передает маркер AAD пользователя, который указывает на принадлежность к Организации.
