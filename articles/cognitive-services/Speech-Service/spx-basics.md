...
Теперь мы воспользуемся интерфейсом командной строки службы "Речь" для распознавания речи с помощью стандартного микрофона системы. 

>[!WARNING]
> Если вы используете контейнер Docker, эта команда не будет работать.
...
С помощью интерфейса командной строки службы "Речь" можно также распознать речь из аудиофайла.
