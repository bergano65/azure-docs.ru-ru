...
Кроме того, обратите внимание на **рекомендуемые** разделы справки, указанные справа от параметров команды. Вы также можете выполнить поиск по ключевому слову. Например, введите следующую команду, чтобы просмотреть список разделов справки о примерах CLI для службы "Речь":
