...
**Ответ**. Сейчас единственное, что вам нужно, — это состояния модели или набора данных, которое отображается в таблице.
...
**Вопрос**. Можно ли создать больше одной модели за один раз?
...
**Вопрос**. Я понял, что допустил ошибку. Как мне теперь отменить импорт данных или создание модели? 
...
**Вопрос**. В отчете о данных сказано, что при обработке высказываний произошла ошибка. Это указывает на проблему?
...
**Ответ**. Вы можете создать автономное приложение для сбора данных или использовать некоторые доступные программы для записи аудио.
...
**Ответ**. Данные необходимо транскрибировать. Их можно транскрибировать самостоятельно или с помощью специальной службы для транскрибирования. Такие службы привлекают профессиональных расшифровщиков или коллективные ресурсы. Можно также рекомендовать службу транскрибирования по запросу.
