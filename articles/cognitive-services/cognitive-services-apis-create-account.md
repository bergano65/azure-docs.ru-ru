...
3. На странице _ *CREATE* * укажите следующие сведения.
...
1. После успешного развертывания ресурса щелкните _ *Go (ресурс* ) * в разделе **дальнейшие действия**.
