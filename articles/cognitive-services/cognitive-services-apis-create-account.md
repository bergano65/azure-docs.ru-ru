...
Cognitive Services Azure — это облачные службы с интерфейсами API, а также пакеты SDK для клиентской библиотеки, которые помогают разработчикам создавать средства для работы с данными без прямого искусственного интеллекта (ии) или опыта обработки и анализа данных. С помощью Azure Cognitive Services разработчики могут без усилий добавлять в свои приложения когнитивные функции, создавая когнитивные решения, которые могут видеть, слышать, говорить, понимать и даже в некоторой степени размышлять.
