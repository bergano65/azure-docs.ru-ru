...
1. Создайте URI для поискового запроса. Обратите внимание, что условие поиска `SearchTerm` нужно отформатировать перед добавлением к строке.
