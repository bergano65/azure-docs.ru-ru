...
* Платформа [Express.js](https://expressjs.com/) для Node.js. Инструкции по установке для исходного кода доступны в примере файла сведений на GitHub.
