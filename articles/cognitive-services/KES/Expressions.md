---
title: Структурированные выражения запросов — API службы поиска и распознавания данных
titlesuffix: Azure Cognitive Services
description: Узнайте, как использовать структурированные выражения запросов в API службы поиска и распознавания данных (KES).
