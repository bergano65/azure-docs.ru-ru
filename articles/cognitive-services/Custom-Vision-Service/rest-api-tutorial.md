---
title: Руководство по созданию, обучению и экспорту модели с помощью REST API Пользовательского визуального распознавания
...
ms.locfileid: "58351105"
---
# <a name="tutorial-create-train-and-export-a-model-with-rest"></a>Руководство по созданию, обучению и экспорту модели с помощью REST
...
Дополнительные сведения об этом запросе см. в разделе [CreateProject](https://go.microsoft.com/fwlink/?linkid=865446).
