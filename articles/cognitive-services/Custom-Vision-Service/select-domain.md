...
|Домен|Назначение|
|---|---|
|__Общие сведения__| Рассчитан на самые разные задачи классификации изображений. Если ни один из других доменов не подходит или вы не знаете, какой домен выбрать, выберите общий домен. Идентификатор: `ee85a74c-405e-4adc-bb47-ffa8ca0c9f31`|
...
|__Розничная версия__|Рассчитан на изображения из каталогов товаров и торговых веб-сайтов. Если требуется высокая точность при распознавании таких объектов, как платья, брюки и рубашки, следует использовать этот домен. Идентификатор: `b30a91ae-e3c1-4f73-a81e-c270bff27c39`|
...
|---|---|---|---|---|---|
|Классификация|General (compact) (Общий (компактный))|`0732100f-1a38-4e49-a514-c9b44c697ab5`|5 МБ|13 мс|5 мс|
