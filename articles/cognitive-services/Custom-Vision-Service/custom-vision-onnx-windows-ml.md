...
1. Создайте и обучите классификатор с помощью Пользовательской службы визуального распознавания. Инструкции по выполнению этой задачи см. в разделе [Создание и обучение классификатора](https://docs.microsoft.com/azure/cognitive-services/custom-vision-service/getting-started-build-a-classifier). Используйте один из **компактных** доменов, например **General (Compact)**. 
