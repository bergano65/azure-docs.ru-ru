...
1. Чтобы добавить изображения, последовательно выберите элементы __Add images__ (Добавить изображения) и __Browse local files__ (Обзор локальных файлов). Выберите __Открыть__, чтобы загрузить изображение.
