---
title: Перенос проекта в API 3,0
titleSuffix: Azure Cognitive Services
description: Узнайте, как перенести Пользовательское визуальное распознавание проекты из предыдущей версии API в API 3,0.
...
ms.locfileid: "68560894"
---
# <a name="migrate-to-the-30-api"></a>Переход на API 3,0
...
В этом руководство показано, как обновить проекты, чтобы они работали с новой версией API. Полный список изменений см. в заметках [о](release-notes.md) выпуске.
...
С помощью API 3,0 мы предоставляем два дополнительных целевого объекта экспорта: Комплект разработчика и видения для искусственного интеллекта ARM.

* Чтобы использовать ARM, нужно просто выбрать компактный домен, а затем выбрать DockerFile, а затем — Параметры экспорта.
* Для подготовки к выпуску Application Insight Kit проект необходимо создать с помощью __общего (компактного)__ домена, а также указать ваидк в аргументе Target Export Platforms.
