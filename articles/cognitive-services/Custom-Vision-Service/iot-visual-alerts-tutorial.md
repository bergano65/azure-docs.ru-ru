...
## <a name="examine-the-code-structure"></a>Изучение структуры кода
...
После того как приложение закончит запись изображений, оно передаст их, а затем переключится в состояние **Waiting For Trained Model** (Ожидание обученной модели). На этом этапе перейдите на веб-сайт [Пользовательского визуального распознавания](https://www.customvision.ai/) и создайте модель на основе новых изображений для обучения. На анимации ниже показан пример такого процесса.
...
1. Войдите на веб-сайт службы [Пользовательское визуальное распознавание](http://customvision.ai).
