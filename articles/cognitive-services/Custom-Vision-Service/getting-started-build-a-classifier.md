---
title: Краткое руководство. Создание классификатора с помощью веб-сайта Пользовательского визуального распознавания
titleSuffix: Azure Cognitive Services
description: Из этого краткого руководства вы узнаете, как создать, обучить и протестировать модель классификации изображений на веб-сайте Пользовательского визуального распознавания.
...
ms.locfileid: "99221250"
---
# <a name="quickstart-build-a-classifier-with-the-custom-vision-website"></a>Краткое руководство. Создание классификатора с помощью веб-сайта Пользовательского визуального распознавания

Из этого краткого руководства вы узнаете, как создать модель классификации изображений на веб-сайте Пользовательского визуального распознавания. Созданную модель можно протестировать с использованием новых изображений, а затем интегрировать в собственное приложение для распознавания изображений.
...
В этом разделе описано, как отправить изображения и вручную добавить к ним теги для обучения классификатора. 

1. Чтобы добавить изображения, последовательно выберите элементы __Add images__ (Добавить изображения) и __Browse local files__ (Обзор локальных файлов). Выберите __Открыть__, чтобы переместить теги. Выбранные теги будут применены ко всей группе изображений, выбранных для отправки. Это означает, что лучше всего разделить изображения на группы по примененным тегам. Вы также можете изменить теги для отдельных изображений уже после отправки.
