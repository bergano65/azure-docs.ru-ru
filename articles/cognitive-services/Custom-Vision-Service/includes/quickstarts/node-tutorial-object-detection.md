...
Чтобы установить клиентскую библиотеку Пользовательского визуального распознавания для Node.js, выполните следующие команды:
