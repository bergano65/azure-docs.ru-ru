...
Чтобы установить клиентскую библиотеку Пользовательского визуального распознавания для Go, выполните следующую команду в PowerShell:
