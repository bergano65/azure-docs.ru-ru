...
- Появились API 3,0. Объявлено о прекращении использования предварительных версий API, предшествующих 3,0, на 1 октября 2019. Ознакомьтесь с краткими руководствами по [.NET](./quickstarts/image-classification.md), [Python](./quickstarts/image-classification.md), [node](./quickstarts/image-classification.md), [Java](./quickstarts/image-classification.md)или [Go](./quickstarts/image-classification.md) для получения примеров по началу работы.
