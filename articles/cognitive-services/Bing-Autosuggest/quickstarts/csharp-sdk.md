---
title: Краткое руководство. Клиентская библиотека Автозаполнения Bing для .NET | Документация Майкрософт
description: Начните использовать клиентскую библиотеку Автозаполнения Bing для .NET, чтобы получать предложения поиска на основе частей строк запросов.
...
ms.locfileid: "75450980"
---
# <a name="quickstart-bing-autosuggest-client-library-for-net"></a>Краткое руководство. Клиентская библиотека Автозаполнения Bing для .NET
