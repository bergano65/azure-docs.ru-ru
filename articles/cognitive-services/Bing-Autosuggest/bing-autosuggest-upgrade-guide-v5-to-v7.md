...
В этом руководстве по обновлению определены изменения между версиями 5 и 7 API автозаполнения Bing. Используйте это руководство, чтобы помочь обновить приложение для использования версии 7.
