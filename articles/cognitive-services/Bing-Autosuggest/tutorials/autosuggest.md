...
Создайте HTML-форму с текстовым полем. Обработайте событие `oninput` и вызовите функцию `bingAutosuggest()`, передав содержимое текстового поля и ключ API "Автозаполнение Bing".
