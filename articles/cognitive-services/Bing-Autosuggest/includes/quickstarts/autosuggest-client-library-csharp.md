...
- [Справочник по dotnet для Автозаполнения Bing](/dotnet/api/overview/azure/cognitiveservices/client/bingautosuggest?view=azure-dotnet)