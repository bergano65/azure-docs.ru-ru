---
title: Руководство по использованию API перевода речи с C#
...
ms.locfileid: "49340432"
---
# <a name="tutorial-translator-speech-application-in-c"></a>Руководство по использованию приложения API перевода речи с C#

[!INCLUDE [Deprecation note](../../../includes/cognitive-services-translator-speech-deprecation-note.md)]

Это руководство содержит обзор средства интерактивного перевода речи, которое использует API перевода речи, часть служб Azure Cognitive Services. Вы научитесь:
...
Открыв в Visual Studio решение "Перевод речи" (`SpeechTranslator.sln`), нажмите клавишу F5 для создания и запуска приложения.  Откроется главное окно программы.
...
В этом окне вставьте ключ подписки службы "Перевод речи", а затем нажмите кнопку **Сохранить**. Ключ сохраняется при последующих запусках.
...
На момент написания этой статьи служба "Перевод речи" поддерживает более пяти десятков языков. Для перевода речи поддерживается меньше языков. Такие языки требуют поддержки как для транскрибирования (распознавания речи), так и для вывода при преобразовании текста в речь, синтеза.
