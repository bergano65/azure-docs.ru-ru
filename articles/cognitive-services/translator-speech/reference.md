...
|Авторизация|(пусто)  |Указывает значение маркера носителя клиента. Используйте префикс `Bearer` со значением `access_token`, возвращаемым службой токенов проверки подлинности.|Верхний колонтитул   |string|
