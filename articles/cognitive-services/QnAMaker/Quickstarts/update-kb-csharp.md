...
description: В этом кратком руководстве описывается обновление примера базы знаний QnA Maker программным способом. Определение JSON, которое используется для обновления базы знаний, позволяет добавлять, изменять или удалять пары вопросов и ответов.
...
ms.locfileid: "48801699"
---
# <a name="quickstart-update-a-qna-maker-knowledge-base-in-c"></a>Краткое руководство: обновление базы знаний с использованием C#
