---
title: 'Быстрый запуск: Создать, обучать и публиковать базы знаний - NA Maker'
...
---
# <a name="quickstart-create-train-and-publish-your-qna-maker-knowledge-base"></a>Быстрый запуск: Создайте, обучайте и публикуйте свою базу знаний nA Maker
...
1. Под **bot Управления**, выберите тест в **веб-чате**.
...
Вы создали новую базу знаний, добавили общедоступный URL-адрес в базу знаний, добавили свою собственную пару, обучили, протестировали и опубликовали базу знаний.
