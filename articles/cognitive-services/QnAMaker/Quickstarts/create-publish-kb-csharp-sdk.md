...
Вместо переменной **конечной точки** `<your-custom-domain>` введите имя своего личного домена. Это расположение находится на странице **Обзор** для ресурса QnA Maker на портале Azure.
