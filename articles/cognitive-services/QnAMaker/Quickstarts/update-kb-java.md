---
title: 'Краткое руководство: обновление базы знаний с использованием Java — QnA Maker'
titleSuffix: Azure Cognitive Services
description: Обновление базы знаний QnA Maker с использованием Java.
...
ms.locfileid: "49388251"
---
# <a name="update-a-knowledge-base-in-java"></a>Обновление базы знаний на Java
...
Если у вас еще нет базы знаний, создайте пример для этого краткого руководства по инструкциям из [этой статьи](create-new-kb-java.md).
...
1. Вам потребуется библиотека [apache httpclient](https://hc.apache.org/downloads.cgi). Вы можете скачать двоичный файл 4.x.x.tar.gz HttpClient, который содержит все необходимые JAR-файлы для импорта в проект.
1. Также нужна библиотека [GSON](https://github.com/google/gson). Вы можете вручную [создать](https://stackoverflow.com/questions/5258159/how-to-make-an-executable-jar-file) и импортировать файл .jar либо добавить зависимость от любого инструмента управления проектами, например Maven.
...
Обновленную базу знаний вы можете просмотреть на странице [My knowledge bases](https://www.qnamaker.ai/Home/MyServices) (Мои базы знаний) на портале QnA Maker. Здесь вы можете убедиться, что в базу знаний внесены изменения, указанные в настроенных вами запросах.

Чтобы изменить другие элементы базы знаний, изучите [схему JSON](https://westus.dev.cognitive.microsoft.com/docs/services/5a93fcf85b4ccd136866eb37/operations/5ac266295b4ccd1554da7600) QnA Maker и измените объект `req` в методе `getRequest()`.
