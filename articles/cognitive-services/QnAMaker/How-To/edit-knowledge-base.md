...
1. Выберите элемент **Параметры**. Здесь вы можете изменить значение в обязательном поле имени службы.
    ...
    |Update|Обновление базы знаний зависит от **ценовой категории управления**, используемой при создании службы QnA Maker, которая связана с базой знаний. При необходимости можно также обновить ценовую категорию управления на портале Azure.
