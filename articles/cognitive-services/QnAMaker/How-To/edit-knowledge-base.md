...
На **параметры** выберите **QnA, добавьте пары** для добавления новой строки в таблице баз знаний.
...
Добавление пары "метаданные", сначала выбрав **просмотреть параметры**, выбрав **показывают метаданные**. Отобразится столбец метаданных. Затем выберите **+** войдите добавить пару метаданных. Эта пара состоит из одного ключа и одно значение.
