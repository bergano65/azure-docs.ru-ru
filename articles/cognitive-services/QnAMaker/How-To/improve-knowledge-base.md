...
1. Чтобы включить active в обучение в облаке, щелкните ваш **имя**, перейдите в меню [ **параметры службы** ](https://www.qnamaker.ai/UserSettings) на портал QnA Maker, в правом верхнем углу.  
...
|`userQuestion`|string|Точный текст вопроса. Обязательный.|
