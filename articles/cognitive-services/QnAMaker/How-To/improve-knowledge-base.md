...
ms.locfileid: "73721175"
---
# <a name="use-active-learning-to-improve-your-knowledge-base"></a>Использование активного обучения для улучшения базы знаний
...
|`userQuestion`|строка|Точный текст запроса пользователя. обязательный параметр.|
...
* [ИНТЕРФЕЙС REST API](https://westus.dev.cognitive.microsoft.com/docs/services/5a93fcf85b4ccd136866eb37/operations/5ac266295b4ccd1554da75fc)
