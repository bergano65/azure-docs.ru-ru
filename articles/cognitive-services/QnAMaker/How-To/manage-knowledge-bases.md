...
1.  Выберите **Параметры**. В следующем списке содержатся поля, которые можно изменить.
    ...
    |Обновление:|Обновление базы знаний зависит от **ценовой категории управления**, используемой при создании службы QnA Maker, которая связана с базой знаний. При необходимости можно также обновить уровень управления с портал Azure.
