...
2. Просмотр или сброс ключей:
    ...
    > ](../media/qnamaker-how-to-key-management/Endpoint-keys1.png) диспетчера ключей ![Endpoint
...
1. Перейдите к службе QnAMaker (Группа ресурсов) в [портал Azure](https://portal.azure.com).
    ...
    > [!div class="mx-imgBorder"]
    > ](../media/qnamaker-how-to-troubleshoot/qnamaker-azure-resourcegroup.png) ![группы ресурсов Azure QnAMaker

1. Выберите экземпляр службы приложений и откройте раздел **Обзор** .

    > [!div class="mx-imgBorder"]
    > ![экземпляра службы приложений QnAMaker](../media/qnamaker-how-to-troubleshoot/qnamaker-azure-appservice.png)
