...
1. Войдите на портал Azure и [создать QnA Maker](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesQnAMaker) ресурсов.
...
1. В **QnA Maker** выберите соответствующие уровни и регионы.
    ...
    * Выберите **Ценовая** для служб управления QnA Maker (портал и API-интерфейсов управления). На [этой странице](https://aka.ms/qnamaker-pricing) вы найдете сведения о ценах для существующих номеров SKU.
