...
|`top`|необязательный|integer|Количество ранжированных результатов в выходных данных. Значение по умолчанию — 1.|
...
|`scoreThreshold`|необязательный|integer|Будут возвращены только ответы с оценкой степени достоверности превышает данное пороговое значение. Значение по умолчанию — 0.|
