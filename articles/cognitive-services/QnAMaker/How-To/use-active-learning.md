...
[Активное обучение](../Concepts/active-learning-suggestions.md) позволяет повысить качество базы знаний, предлагая альтернативные вопросы. Отправку пользователей учитываются и отображаются как предложения в списке альтернативных вопросов. Вы можете либо добавить эти предложения в качестве альтернативных вопросов, либо отклонить их.
