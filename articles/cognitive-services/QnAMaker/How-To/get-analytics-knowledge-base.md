...
1. [Включите ведение журнала диагностики](https://docs.microsoft.com/azure/cognitive-services/diagnostic-logging) для службы QnA Maker Managed (Предварительная версия).
