...
|**Уровень Когнитивный поиск Azure** | **Бесплатный** | **Basic** (обычная) |**S1** | **S2**| **S3** |**S3 HD**|
|---|---|---|---|---|---|----|
...
* Длина текста ключа метаданных: 100
* Длина значения метаданных: 500
