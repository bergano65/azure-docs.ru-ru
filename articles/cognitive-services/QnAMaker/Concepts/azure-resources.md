...
| **Среда разработки и тестирования**   | SKU "Стандартный"         | Общий      | Базовый        | Публикация до 14 баз знаний размером 2 ГБ    |
...
|Name (Имя)|Расположение|Назначение|
|--|--|--|
