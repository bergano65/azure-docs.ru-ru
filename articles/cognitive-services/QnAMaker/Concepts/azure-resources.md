...
| **Среда разработки и тестирования**   |Основные        | Публикация до 14 баз знаний размером 2 ГБ    |
...
* Защитите ресурс службы для переприятия из общего доступа, [настроив виртуальную сеть](../../cognitive-services-virtual-networks.md?tabs=portal).
* Защита службы приложений (среда выполнения QnA) от общего доступа:
    ...
    * Ознакомьтесь с [дополнительными сведениями о тегах служб.](../../../virtual-network/service-tags-overview.md)
