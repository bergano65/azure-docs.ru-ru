...
|Обновление|Причина|
|--|--|
|[Обновление](../How-to/set-up-qnamaker-service-azure.md#upgrade-qna-maker-sku) ЗНА Maker управления SKU|Вы хотите иметь больше наборов или источников документов в вашей базе знаний.|
...
* Храните наборы QnA
* Обеспечить первоначальный рейтинг (ranker #1) наборов ВСА во время выполнения
...
Ресурс «NA Maker» предоставляет доступ к авторским и публикационным AIS, а также к обработке естественного языка (НЛП), основанному на втором уровне (ranker #2) наборов в момент выполнения.
