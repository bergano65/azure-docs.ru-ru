...
[Расположение источника данных SharePoint](../How-to/add-sharepoint-datasources.md) предоставлять файлы прошедшего проверку подлинности. Материалы по SharePoint должны быть файлами, не веб-страниц. 
