...
QnA Maker определяет разделы и подразделы и связи в файле на основе визуальных подсчетов, таких как размер шрифта, начертание шрифта, нумерация, цвета и т. д. Частично структурированные файлы PDF или DOC могут содержать руководства, часто задаваемые вопросы, рекомендации, политики, буклеты, объявления и многие другие типы файлов. Ниже приведены несколько примеров типов этих файлов.
