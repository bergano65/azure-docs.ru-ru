...
Создание базы знаний поддерживает несколько [разрешений на доступ на основе ролей](../index.yml) , которые применяются в портал Azure для ограничения области возможностей участника совместной работы.
...
### <a name="dispatch-between-qna-maker-and-language-understanding-luis"></a>Отправка между QnA Maker и Language Understanding (LUIS)
