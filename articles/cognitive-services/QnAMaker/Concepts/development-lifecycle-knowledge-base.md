...
Для больших баз знаний, используйте автоматическое тестирование с помощью [generateAnswer API](../how-to/metadata-generateanswer-usage.md#get-answer-predictions-with-the-generateanswer-api) и `isTest=true` параметр строки запроса, какие запросы `test` базы знаний, а не опубликованные базы знаний. 
