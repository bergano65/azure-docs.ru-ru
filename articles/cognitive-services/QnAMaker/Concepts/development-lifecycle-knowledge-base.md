...
Конечная точка базы знаний QnA Maker предоставляет наиболее точный ответ на запрос пользователя на основании содержимого базы знаний. Создание базы знаний — это одноразовое действие по настройке репозитория содержимого вопросов, ответов и связанных метаданных. Базу знаний можно создать путем сканирования уже существующего содержимого, например страниц часто задаваемых вопросов, руководств по продукции или структурированных пар "вопрос-ответ". Узнайте, как [создать базу знаний](../quickstarts/create-publish-knowledge-base.md).
