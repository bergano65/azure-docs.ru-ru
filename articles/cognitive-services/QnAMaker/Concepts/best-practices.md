...
Лучшие ответы — это простые ответы, но не слишком простые, такие как "да" или "нет". Если ваш ответ должен содержать ссылки на другие источники или предоставить широкие возможности мультимедиа и ссылок, используйте [теги](../how-to/metadata-generateanswer-usage.md), чтобы определить, какой тип ответа вы ожидаете, а затем отправьте этот тег вместе с запросом, чтобы получить правильную версию ответа.
...
Хотя определенная поддержка синонимов реализована для английского языка, используйте [альтернативные слов](https://docs.microsoft.com/rest/api/cognitiveservices/qnamaker/alterations/replace) без учета регистра, чтобы добавить синонимы к ключевым словам, принимающим разную форму. Синонимы следует добавить на уровне службы QnA Maker и совместно использовать во всех базах знаний в службе.
