...
|---------|-----|
|Профессиональная версия |[qna_chitchat_professional. TSV](https://qnamakerstore.blob.core.windows.net/qnamakerdata/editorial/qna_chitchat_professional.tsv) |
...
|Исходный запрос|Альтернативные запросы|Изменить|
|--|--|--|
|Есть ли парковка?|У вас есть автостоянка?|структуры предложения|
 |Привет!|Большое<br>Всем привет!|стиль речи или сленговое выражение|
...
Хотя на английском языке имеется какая-либо поддержка синонимов, для добавления синонимов в ключевые слова, которые принимают другую форму [, можно использовать](https://docs.microsoft.com/rest/api/cognitiveservices/qnamaker/alterations/replace) изменения в словах, не учитывающие регистр. Синонимы добавляются на QnA Maker уровне службы и совместно используются всеми базами знаний в службе.
