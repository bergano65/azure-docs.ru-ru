...
|--|--|--|--|
|Владелец|All|Ключ проверки подлинности|All|
...
|QnA Maker чтение<br>Просмотр|Экспорт и скачивание<br>Тест|Маркер носителя|1. Скачайте API базы знаний<br>2. Перечисление KBs для пользовательского API<br>3. Получение сведений о базе знаний<br>4. Загрузка изменений<br>Создать ответ |
|Редактор QnA Maker<br>(чтение и запись)|Экспорт и скачивание<br>Тест<br>Обновление базы знаний<br>Экспорт базы знаний<br>Импорт базы знаний<br>Заменить КБ<br>Создание базы знаний|Маркер носителя|1. Создание API базы знаний<br>2. обновление API базы знаний<br>3. Замените API базы знаний<br>4. Замена изменений<br>5. "обучение API" [в новой службе Service Model v5]|
|Пользователь службы автообновления<br>(чтение, запись и публикация)|All|Маркер носителя|All|