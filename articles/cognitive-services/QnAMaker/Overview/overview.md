...
* **Если у вас есть статическая информация**. Используйте QnA Maker, если в вашей базе знаний с ответами содержится статическая информация. Такую базу знаний, сформированную из [документов PDF и URL-адресов](../Concepts/data-sources-and-content.md), можно настроить под свои требования.
...
QnA Maker [импортирует содержимое](../Concepts/plan.md) в базу знаний, содержащую пары вопросов и ответов. При импорте извлекаются сведения о связях между отдельными частями структурированного и частично структурированного содержимого, чтобы установить связи между парами вопросов и ответов. Эти пары вопросов и ответов можно изменять или дополнять новыми.
