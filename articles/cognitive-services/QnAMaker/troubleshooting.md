...
**Ответ**. проблемы с производительностью пропускной способности указывают на необходимость масштабирования когнитивный Поиск. Рассмотрите возможность добавления реплики в Когнитивный поиск для повышения производительности.
...
<details>
<summary><b>Можно ли предоставить общий доступ к базе знаний участнику, который не находится в том же Azure Active Directory клиенте, чтобы изменить базу знаний?</b></summary>
...
<details>
<summary><b>Можно ли предоставить 5 разным пользователям права на чтение и запись так, чтобы каждый из них мог использовать только 1 базу знаний QnA Maker?</b></summary>
