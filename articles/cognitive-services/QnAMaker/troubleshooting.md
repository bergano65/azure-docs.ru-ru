...
После того, как пары qnA находятся в базе знаний, вы можете отсечь текст разметки ответа, чтобы включить ссылки на средства массовой информации, доступные из публичных URL-адресов.
