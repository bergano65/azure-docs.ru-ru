...
Обновите службу приложений, когда значок предупреждения отображается рядом со значением версии базы знаний в таблице **Endpoint keys** (Ключи конечной точки) на **странице** [Параметры пользователя](https://www.qnamaker.ai/UserSettings).
...
### <a name="i-deleted-my-testkb-index-in-my-search-service-how-can-i-fix-this"></a>Я удалил индекс `testkb` в службе поиска. Как это исправить? 
