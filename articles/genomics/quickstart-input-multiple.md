---
title: Отправка рабочего процесса с использованием нескольких наборов входных данных — Microsoft Genomics
titleSuffix: Azure
description: В этой статье показано, как отправить рабочий процесс в службу Microsoft Genomics, если входной файл является несколько FASTQ или BAM-файлов, поступающих из одного примера. Вы уже установлен клиент msgen и успешно запустили примеры данных через службу.
services: genomics
ms.service: genomics
author: grhuynh
manager: cgronlund
