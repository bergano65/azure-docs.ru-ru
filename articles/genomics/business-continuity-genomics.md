---
title: Обзор непрерывности бизнеса
...
При возникновении сбоя в работе регионального центра обработки данных можно отправить рабочие процессы Microsoft Genomics во вторичном регионе на основе индивидуальных требований к суверенитету данных и непрерывности бизнеса. Чтобы перенаправить рабочие процессы Microsoft Genomics в другой регион вручную, необходимо использовать учетную запись Genomics конкретного региона и отправить задание с соответствующими учетными данными этой учетной записи и учетной записи хранения.
