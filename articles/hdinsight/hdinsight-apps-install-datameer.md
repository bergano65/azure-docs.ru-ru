...
description: Установка и использование стороннего приложения Datameer на базе приложения Apache Hadoop.
services: hdinsight
author: ashishthaps
ms.reviewer: jasonh
