...
| Компонент | HDInsight 4.0 | HDInsight 3.6 (по умолчанию) | HDInsight 3.5 | HDInsight 3.4 | HDInsight 3.3 | HDInsight 3.2 | HDInsight 3.1 | HDInsight 3.0 |
| --- | --- | --- | --- | --- | --- | --- | --- |--- |
...
| Apache Spark |2.3.2 |2.3.0, 2.2.0, 2.1.0 |1.6.2, 2.0 |1.6.0 |1.5.2 |1.3.1 (только для Windows) |-|-|
| Apache Livy |0,5 |0,4 |0,3 |0,3 |0,2 |-|-|-|
| Apache Kafka | 1.1.1 |1.1, 1.0* (см. примечание внизу) | 0.10.0 | 0.9.0 |-|-|-|-|
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| HDInsight 4.0 |HDP 3.0 |Ubuntu 16.0.4 LTS |24 сентября 2018 г. | | |Yes |Yes |
