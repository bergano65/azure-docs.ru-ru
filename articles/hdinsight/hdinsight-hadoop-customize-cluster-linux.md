...
* **AMBARI. ВЫПОЛНИТЕ \_ пользовательскую \_ команду**. Это разрешение по умолчанию назначено для роли администратора Ambari.
* **Кластер. ВЫПОЛНИТЕ \_ пользовательскую \_ команду**. Это разрешение по умолчанию назначено для администратора кластера HDInsight и администратора Ambari.
