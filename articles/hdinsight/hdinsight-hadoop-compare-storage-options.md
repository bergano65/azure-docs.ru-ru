...
|---|---|---|---|---|---|---|---|
|Azure Data Lake Storage 2-го поколения| Общего назначения версии 2 | Иерархическая (файловая система) | Blob | Стандарт | Горячий, холодное, архивная | 3.6+ | Все |
|Служба хранилища Azure| Общего назначения версии 2 | Object | Blob | Стандарт | Горячий, холодное, архивная | 3.6+ | Все |
|Служба хранилища Azure| Общего назначения версии 1 | Object | Blob | Стандарт | Н/Д | Все | Все |
...
| 4,0 | Data Lake Storage 1-го поколения | Any | Нет |
...
| Контроль доступа |Data Lake Storage 1-го поколения обеспечивает контроль доступа за счет поддержки разрешений POSIX, предоставляемых протоколом WebHDFS. Списки управления доступом можно включить в корневой папке, вложенных папках, а также в отдельных файлах. Дополнительные сведения о принципе работы списков управления доступом в контексте Data Lake Storage 1-го поколения см. в статье [Контроль доступа в Azure Data Lake Storage 1-го поколения](../data-lake-store/data-lake-store-access-control.md). |
