...
|---|---|---|---|---|---|---|---|
|Azure Data Lake Storage 2-го поколения| Общего назначения версии 2 | Иерархическая (файловая система) | BLOB-объект | Standard | Горячий, холодное, архивная | 3.6+ | Все, кроме Spark 2,1 |
...
> [!Note] 
> Data Lake Storage 2-го поколения первичное хранилище не поддерживается для кластеров Spark 2,1. 
