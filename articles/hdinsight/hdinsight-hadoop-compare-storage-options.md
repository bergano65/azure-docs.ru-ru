...
|Хранилище Azure| Общего назначения версии 1 | Объект | BLOB-объект | Standard | Недоступно | Все | Все |
|Хранилище Azure| Хранилище BLOB-объектов * * | Объект | Блочный BLOB-объект | Стандартный | Горячий, холодный или архивный | Все | Все |
