...
Пользователям Microsoft Azure HDInsight доступны несколько различных вариантов хранения при создании кластеров HDInsight:
...
## <a name="azure-data-lake-storage-gen2-with-apache-hadoop-in-azure-hdinsight"></a>Azure Data Lake Storage 2-го поколения с Apache Hadoop в Azure HDInsight
...
При создании учетной записи хранения Azure можно выбирать из нескольких типов такой учетной записи. Следующая таблица содержит сведения о параметрах, поддерживаемых для HDInsight.

| **Тип учетной записи хранения** | **Поставщики Resource Manager, регионы, версии API и схемы** | **Поддерживаемые уровни производительности** | **Поддерживаемые уровни доступа** |
|----------------------|--------------------|-----------------------------|------------------------|
...
* Архивный уровень доступа — это автономный уровень с задержкой извлечения в несколько часов. Не используйте этот уровень с HDInsight. Дополнительные сведения см. в разделе [Архивный уровень доступа](../storage/blobs/storage-blob-storage-tiers.md#archive-access-tier).

> [!WARNING]  
> Мы не рекомендуем применять контейнер больших двоичных объектов по умолчанию для хранения бизнес-данных. Контейнер по умолчанию содержит журналы приложений и системный журнал. Обязательно извлеките эти журналы перед удалением контейнера больших двоичных объектов по умолчанию. Удаляйте контейнер больших двоичных объектов после каждого использования для сокращения затрат на хранение. Помните также, что один контейнер больших двоичных объектов нельзя использовать в качестве файловой системы по умолчанию для нескольких кластеров.
