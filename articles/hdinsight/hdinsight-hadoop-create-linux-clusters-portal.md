...
1. В разделе **3, "Хранилище",** укажите нужное хранилище по умолчанию: служба хранилища Azure или Data Lake Storage. Дополнительные сведения приведены в таблице ниже.
     ...
     | Хранилище                                      | Description (Описание) |
     |----------------------------------------------|-------------|
