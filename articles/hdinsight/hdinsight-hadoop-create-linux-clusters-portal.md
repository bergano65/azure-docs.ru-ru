...
4. В разделе **2, "Безопасность и сети",** можно подключить кластер к виртуальной сети с помощью раскрывающегося меню. Выберите виртуальную сеть Azure и подсеть для размещения кластера в виртуальной сети. Дополнительные сведения об использовании HDInsight в виртуальной сети см. в статье [Расширение возможностей HDInsight с помощью виртуальной сети Azure](hdinsight-extend-hadoop-virtual-network.md). Статья содержит конкретные требования к конфигурации виртуальной сети. 
