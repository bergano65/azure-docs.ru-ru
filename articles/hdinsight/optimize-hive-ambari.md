...
Чтобы включить статистические, перейдите к разделу **Hive**  >  **Параметры конфигурации**Hive  >  и найдите**параметр** **включить Оптимизатор на основе затрат**, а затем установите переключатель в положение **вкл**.
