...
|Все остальные кластеры (Spark, Interactive, Hadoop, HBase без ускоренной записи)|Layer1: [Шифрование SSE](../virtual-machines/managed-disks-overview.md#encryption) по умолчанию|Н/Д|Layer1: Необязательное шифрование на узле с помощью PMK, Layer2: Необязательное шифрование неактивных с помощью CMK|
