---
title: Разработка действий скриптов с помощью HDInsight в Azure
...
* Предоставьте стабильные ссылки на ресурсы сценария.
...
* Обеспечьте идемпотентность сценария настройки кластера.
...
* Установите пользовательские компоненты в оптимальное расположение.
...
* Обеспечьте высокий уровень доступности кластера.
...
* Настройте пользовательские компоненты для использования хранилища BLOB-объектов Azure.
