...
* `adl:///`: доступ к Data Lake Store, используемому по умолчанию для кластера.
...
* [blobxfer.py](https://github.com/Azure/azure-batch-samples/tree/master/Python/Storage): сценарий Python для работы с большими двоичными объектами в службе хранилища Azure.
