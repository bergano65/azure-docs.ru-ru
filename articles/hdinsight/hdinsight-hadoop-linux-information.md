...
* **2.6.5.3006-29**: Имя каталога — это версия платформы Hadoop, используемая HDInsight. Это число для вашего кластера может отличаться от указанного здесь.
