...
Чтобы использовать Data Lake Storage 1-го поколения в качестве дополнительного хранилища, предоставьте субъекту-службе доступ к путям, в которых хранятся файлы.  Например:
