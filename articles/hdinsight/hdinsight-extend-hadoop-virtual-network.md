...
1. Всегда должен быть разрешен трафик для следующих IP-адресов.
    ...
    | Исходный IP-адрес | Конечный порт | Направление |
    | ---- | ----- | ----- |
...
2. Если ваш кластер HDInsight находится в одном из следующих регионов, необходимо разрешить трафик для IP-адресов, указанных для этого региона.
    ...
    | Страна | Регион | Разрешенные исходные IP-адреса | Разрешенный порт назначения | Направление |
    | ---- | ---- | ---- | ---- | ----- |
...
Разрешите трафик для правил исходящего трафика NSG из любого источника в виртуальной сети для достижения "Конечных IP-адресов", как указано выше.
