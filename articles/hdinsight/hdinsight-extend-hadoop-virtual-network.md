...
3. Разрешите трафик с IP-адресов для служб Azure работоспособности и управления в определенном регионе, где находятся ресурсы:
    ...
    | Country | Регион | Разрешенные исходные IP-адреса | Допустимые назначения | Направление |
    | ---- | ---- | ---- | ---- | ----- |
    ...
    | Австралия | Центральная Австралия | 20.36.36.33</br>20.36.36.196 | \*:443 | Входящий трафик |
    | &nbsp; | Восточная часть Австралии | 104.210.84.115</br>13.75.152.195 | \*:443 | Входящий трафик |
