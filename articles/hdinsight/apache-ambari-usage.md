...
Чтобы проверить, какая головного узла активна, одним из способов является подключение SSH к одному из узлов в кластере, а затем выполнение `ping headnodehost` и сравнение IP-адреса с этими двумя головных узлах.
