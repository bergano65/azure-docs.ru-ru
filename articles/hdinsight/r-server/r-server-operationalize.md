...
* Выберите **Actions** > **Selected Hosts**выбранные > действия размещение**узлов** > щелкните **списание**.
* Выберите **действия** > **Выбранные узлы** > **NodeManagers** > щелкните **списать**.
* Выберите **Actions** > **Selected Hosts**выбранные > действия размещение**узлов** > нажмите кнопку " **Закрыть**".
