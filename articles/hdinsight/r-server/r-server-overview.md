...
Модели или прогнозы, полученные в результате анализа, можно загрузить для локального использования. Их также можно использовать в любой службе Azure, в частности в [веб-службе](https://studio.azureml.net) [Студия машинного обучения Azure (классическая)](../../machine-learning/studio/deploy-a-machine-learning-web-service.md).
...
| Категория компонента | Description |
|------------------|-------------|
