...
|--------------------------|-------------------|------------------------------------------------------------------------------------------------------------------------------------|
| [Начального уровня](../virtual-machines/linux/sizes-general.md)          | A, Av2  | Производительность ЦП и конфигурации памяти лучше всего подходят для рабочих нагрузок начального уровня, таких как разработка и тестирование. Они являются экономичными и предоставляют недорогой вариант, чтобы начать работу с Azure. |
