...
* Дополнительные сведения о Apache Hadoop MapReduce — способе написания программ, которые обрабатывают данные в Hadoop, — см. в статье [Использование MapReduce в Apache Hadoop в HDInsight](../hdinsight-use-mapreduce.md).
