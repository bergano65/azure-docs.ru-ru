...
По умолчанию `yarn.scheduler.capacity.maximum-applications` определяет максимальное число выполняющихся или ожидающих приложений и по умолчанию имеет значение `10000`.
