...
Чтобы получить имена узлов для различных типов узлов в кластере, используйте [REST API Ambari](hdinsight-hadoop-manage-ambari-rest-api.md#get-the-fqdn-of-cluster-nodes).
...
| `ResourceManager`Веб-интерфейс                   | Это оповещение уровня узла активируется, если `ResourceManager` веб-интерфейс недоступен.                                                                                                             |
...
* Замените **имя_кластера** именем кластера.
