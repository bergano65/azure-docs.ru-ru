...
Существует ряд значков, которые могут отображаться рядом со службой и указывать ее состояние. Все оповещения, связанные с той или иной службой, можно просмотреть, щелкнув ссылку **Оповещения** в верхней части страницы.  Ambari предоставляет несколько предварительно установленные предупреждения.

Следующие оповещения помогут отслеживать доступность кластера:

| Имя оповещения                               | ОПИСАНИЕ                                                                                                                                                                                  |
|------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Состояние монитора метрик                    | Это предупреждение означает состояние процесса монитор метрики, как определено с помощью монитора состояния сценария.                                                                                   |
| Периодический сигнал агента Ambari                   | Это предупреждение активируется в том случае, если сервер потеряло связь с агентом.                                                                                                                        |
| Процесс сервера zooKeeper                 | Это предупреждение уровня узла активируется в том случае, если ZooKeeper серверный процесс не может быть определено было запущено и ожидает передачи данных, в сети.                                                               |
| Состояние сервера IOCache метаданных           | Это предупреждение уровня узла активируется в том случае, если сервере IOCache метаданных не может быть определено было запущено и отвечает на запросы клиентов                                                            |
| JournalNode веб-Интерфейс                       | Это предупреждение уровня узла активируется в том случае, если в веб-Интерфейс JournalNode недоступен.                                                                                                                 |
| Сервер Thrift Spark2                     | Это предупреждение уровня узла активируется в том случае, если сервер Thrift Spark2 удается определить, было запущено.                                                                                                |
| Процессу журнала сервера                   | Это предупреждение уровня узла активируется в том случае, если журнал серверный процесс не может быть прослушивания сети, но было запущено.                                                                |
| Журнал сервера в веб-Интерфейс                    | Это предупреждение уровня узла активируется в том случае, если веб-Интерфейс сервера журнала недоступен.                                                                                                              |
| ResourceManager Web UI                   | Это предупреждение уровня узла активируется в том случае, если веб-интерфейса ResourceManager недоступен.                                                                                                             |
| Сводка по работоспособности NodeManager               | Это предупреждение уровня службы активируется в том случае, если неработоспособное NodeManagers                                                                                                                    |
| Веб-временная шкала приложения пользовательского интерфейса                      | Это предупреждение уровня узла активируется в том случае, если в веб-Интерфейс сервера временной шкалы приложения недоступен.                                                                                                         |
...
| NameNode веб-Интерфейс                          | Это предупреждение уровня узла активируется в том случае, если недоступен в веб-Интерфейс NameNode.                                                                                                                    |
| Процесс отработки отказа контроллера zooKeeper    | Это предупреждение уровня узла активируется в том случае, если процесс отработки отказа контроллера ZooKeeper не может быть подтверждена было запущено и ожидает передачи данных, в сети.                                                   |
| Сервер Oozie веб-Интерфейс                      | Это предупреждение уровня узла активируется в том случае, если веб-Интерфейс Oozie сервер недоступен.                                                                                                                |
| Состояние сервера Oozie                      | Это предупреждение уровня узла активируется в том случае, если сервер Oozie не может быть определено было запущено и отвечает на запросы клиента.                                                                      |
| Процесс хранилища метаданных Hive                   | Это предупреждение уровня узла активируется в том случае, если процесс хранилища метаданных Hive не может быть определено было запущено и ожидает передачи данных, в сети.                                                                 |
| HiveServer2 Process                      | Это предупреждение уровня узла активируется в том случае, если HiveServer не может быть определено было запущено и отвечает на запросы клиента.                                                                        |
| Состояние сервера WebHCat                    | Это предупреждение уровня узла активируется в том случае, если состояние сервера templeton находится в неработоспособном состоянии.                                                                                                            |
| Доступные серверы процент ZooKeeper      | Это предупреждение активируется в том случае, если количество работы серверов ZooKeeper в кластере больше, чем заданное Критическое пороговое значение. Он объединяет результаты процесса проверки ZooKeeper.     |
| Сервер Livy Spark2                       | Это предупреждение уровня узла активируется в том случае, если сервер Livy2 удается определить, было запущено.                                                                                                        |
| Сервер журнала Spark2                    | Это предупреждение уровня узла активируется в том случае, если сервер журнала Spark2 удается определить, было запущено.                                                                                               |
| Процесс сборщика метрик                | Это предупреждение активируется, если сборщик метрик не может быть подтверждена было запущено и ожидает передачи данных на настроенном порте количество секунд, равное пороговое значение.                                 |
| Сборщик метрик - процесс Master HBase | Это предупреждение активируется, если сборщик метрик HBase master процессов не может быть подтверждена было запущено и ожидает передачи данных, в сети для настроенного критического порогового значения, заданного в секундах. |
| Мониторы метрики процента доступных       | Это предупреждение активируется в том случае, если процент монитор метрики, процессы не вверх и прослушивает сеть для настроенных предупреждения и критическим пороговыми значениями.                             |
| Процент NodeManagers доступных           | Это предупреждение активируется в том случае, если число вниз NodeManagers в кластере больше, чем заданное Критическое пороговое значение. Он объединяет результаты из NodeManager процесса проверки.        |
| NodeManager Health                       | Это предупреждение уровня узла проверяет свойство работоспособности узла, доступные из NodeManager компонента.                                                                                              |
| NodeManager Web UI                       | Это предупреждение уровня узла активируется в том случае, если в веб-Интерфейс NodeManager недоступен.                                                                                                                 |
...
| Процесс DataNode                         | Это предупреждение уровня узла активируется в том случае, если отдельные процессы DataNode не может быть прослушивания сети, но было запущено.                                                         |
| DataNode веб-Интерфейс                          | Это предупреждение уровня узла активируется в том случае, если веб-интерфейса DataNode недоступен.                                                                                                                    |
...
| Состояние сервера Zeppelin                   | Это предупреждение уровня узла активируется в том случае, если сервер Zeppelin не может быть определено было запущено и отвечает на запросы клиента.                                                                   |
| HiveServer2 Interactive Process          | Это предупреждение уровня узла активируется в том случае, если HiveServerInteractive не может быть определено было запущено и отвечает на запросы клиента.                                                             |
| Приложение LLAP                         | Это предупреждение активируется в том случае, если приложение LLAP не может быть определено было запущено и отвечает на запросы.                                                                                    |
...
При создании кластера можно указать размер узлов. Ниже приведены рекомендации, о том, как указать размер с помощью [портала Azure][preview-portal], [модуля Azure PowerShell Az][azure-powershell], и [Azure CLI][azure-cli]:
...
* **Azure CLI.** При использовании [создания az hdinsight](https://docs.microsoft.com/cli/azure/hdinsight?view=azure-cli-latest#az-hdinsight-create) команды можно задать размер головного, рабочего и узлов ZooKeeper с помощью `--headnode-size`, `--workernode-size`, и `--zookeepernode-size` параметров.

* **Azure PowerShell** При использовании [New AzHDInsightCluster](https://docs.microsoft.com/powershell/module/az.hdinsight/new-azhdinsightcluster) командлета, можно задать размер головного, рабочего и узлов ZooKeeper с помощью `-HeadNodeSize`, `-WorkerNodeSize`, и `-ZookeeperNodeSize` параметров.
...
* [Установка и настройка Azure PowerShell модуль Az](/powershell/azure/overview)
