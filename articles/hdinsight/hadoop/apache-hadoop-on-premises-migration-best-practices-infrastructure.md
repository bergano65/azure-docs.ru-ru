...
## <a name="plan-well-for-the-capacity-needed-for-hdinsight-clusters"></a>Планирование производительности, необходимой для кластеров HDInsight
...
## <a name="use-the-recommended-virtual-machine-types-for-cluster-nodes"></a>Использование рекомендуемых типов виртуальных машин для узлов кластера
...
## <a name="check-the-availability-of-hadoop-components-in-hdinsight"></a>Проверка доступности компонентов Hadoop в HDInsight
...
Вы также можете использовать пользовательский интерфейс Ambari или Ambari REST API для проверки компонентов Hadoop и версий в HDInsight.
...
Дополнительные сведения см. в статье [Компоненты Hadoop, доступные в разных версиях HDInsight](../hdinsight-component-versioning.md#hadoop-components-available-with-different-hdinsight-versions)
...
- [Установка сторонних приложений Hadoop в Azure HDInsight](../hdinsight-apps-install-applications.md)
...
## <a name="use-edge-nodes-on-hadoop-clusters-in-hdinsight-to-access-the-client-tools"></a>Использование граничных узлов в кластерах Hadoop в HDInsight для доступа к клиентским средствам
...
Дополнительные сведения см. в статье [Использование пустых граничных узлов в кластерах Hadoop в HDInsight](../hdinsight-apps-use-edge-node.md)

## <a name="use-the-scale-up-and-scale-down-feature-of-clusters"></a>Использование функции увеличения и уменьшения масштаба кластеров
...
## <a name="use-azure-virtual-network-service-endpoints-to-securely-connect-to-other-azure-services"></a>Использование конечных точек службы виртуальной сети для безопасного подключения к другим службам Azure
...
- [How to enhance HDInsight security with service endpoints](https://azure.microsoft.com/blog/enhance-hdinsight-security-with-service-endpoints/.md) (Как повысить безопасность HDInsight с помощью конечных точек службы)
