...
description: Когда и как запускать пользовательские программы Apache MapReduce в кластерах Azure HDInsight.
author: ashishthaps
ms.author: ashishth
ms.reviewer: jasonh
