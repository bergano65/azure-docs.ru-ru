...
* Команды `ssh` и `scp` или [Azure PowerShell](https://docs.microsoft.com/powershell/azure/overview)
...
* **Входные данные** компоненты сопоставления и сжатия должны считывать входные данные из STDIN.
* **Выходные данные**: компоненты сопоставления и сжатия должны записывать выходные данные в STDOUT.
* **Формат данных**: полученные и созданные данные должны быть парой "ключ-значение", разделенной знаком табуляции.
