...
Используйте допустимые параметры для `Get-AzVirtualNetwork` , как описано в [пакете SDK для AZ PowerShell](/powershell/module/az.network/get-azvirtualnetwork) .
