...
* `set hive.execution.engine=tez;`: задает механизм выполнения с использованием Apache Tez. Использование Tez повышает производительность запросов. Дополнительные сведения о Tez см. в разделе [Использование Apache Tez для повышения производительности](#usetez).
