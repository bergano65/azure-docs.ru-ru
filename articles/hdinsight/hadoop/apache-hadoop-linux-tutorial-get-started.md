---
title: Краткое руководство. Apache Hadoop & диспетчер ресурсов — Azure HDInsight
...
ms.locfileid: "78361357"
---
# <a name="quickstart-create-apache-hadoop-cluster-in-azure-hdinsight-using-resource-manager-template"></a>Краткое руководство. Создание кластера Apache Hadoop в Azure HDInsight с помощью шаблона диспетчер ресурсов
