...
![Процесс](./media/apache-hadoop-deep-dive-advanced-analytics/hdinsight-analytic-process.png)
...
![Варианты использования машинного обучения](./media/apache-hadoop-deep-dive-advanced-analytics/machine-learning-use-cases.png)
...
![Изображений](./media/apache-hadoop-deep-dive-advanced-analytics/machine-learning-images.png)
...
![Результаты](./media/apache-hadoop-deep-dive-advanced-analytics/machine-learning-results.png)
