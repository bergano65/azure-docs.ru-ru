...
![Расширенный аналитический процесс](./media/apache-hadoop-deep-dive-advanced-analytics/hdinsight-analytic-process.png)
...
![Резюме категории машинного обучения](./media/apache-hadoop-deep-dive-advanced-analytics/machine-learning-use-cases.png)
...
* Полуконтролируемый - алгоритм может быть дополнен дополнительными целями через интерактивный запрос тренера, который не был доступен на начальном этапе обучения
* Неконтролируемый - алгоритм не требует обучающие данные
...
![Пример ы машинного обучения](./media/apache-hadoop-deep-dive-advanced-analytics/machine-learning-images.png)

Для получения дополнительной информации о наборе данных, см. [Learning Multiple Layers of Features from Tiny Images](https://www.cs.toronto.edu/~kriz/learning-features-2009-TR.pdf)
...
![Диаграмма результатов машинного обучения](./media/apache-hadoop-deep-dive-advanced-analytics/machine-learning-results.png)

### <a name="try-it-out"></a>Просто попробуйте!

Следуйте [этому учебнику,](../spark/apache-spark-microsoft-cognitive-toolkit.md) чтобы реализовать это решение сквозной: настроить кластер HDInsight Spark, установить когнитивный инструмент и запустить ноутбук Jupyter, который оценивает 10 000 изображений CIFAR.
...
* [Использование кластера Azure HDInsight Hadoop на 1-Tb наборе данных](../../machine-learning/team-data-science-process/hive-criteo-walkthrough.md)
...
* [Apache Spark с машинным обучением: Используйте Apache Spark в HDInsight для анализа температуры здания с использованием данных HVAC](../spark/apache-spark-ipython-notebook-machine-learning.md)
* [Apache Spark с машинным обучением: Используйте Apache Spark в HDInsight для прогнозирования результатов проверки пищевых продуктов](../spark/apache-spark-machine-learning-mllib-ipython.md)
