...
description: Используйте PowerShell для запуска запросов Apache Hive в Apache Hadoop в Azure HDInsight
...
ms.locfileid: "75552599"
---
# <a name="run-apache-hive-queries-using-powershell"></a>Выполнение запросов Apache Hive с помощью PowerShell

[!INCLUDE [hive-selector](../../../includes/hdinsight-selector-use-hive.md)]

В этом документе приводится пример использования Azure PowerShell для запуска запросов Apache Hive в кластере Apache Hadoop в кластере HDInsight.
...
2. Откройте новую командную строку **Azure PowerShell** . Перейдите к расположению файла `hivejob.ps1`, а затем используйте следующую команду для запуска скрипта:
    ...
    При запуске скрипта предлагается ввести имя кластера и учетные данные учетной записи HTTPS/Cluster Admin. Вам также может быть предложено войти в подписку На Azure.
