...
- **Пакет SDK для .NET**:
  ...
  - [Выполнение заданий Apache Pig с помощью пакета SDK для .NET для Apache Hadoop в HDInsight](apache-hadoop-use-pig-dotnet-sdk.md)
...
- **curl**:
  ...
  - [Выполнение заданий Apache Pig в Apache Hadoop в HDInsight с использованием curl](apache-hadoop-use-pig-curl.md)
...
- **PowerShell**:
  ...
  - [Выполнение заданий Apache Pig с помощью PowerShell](apache-hadoop-use-pig-powershell.md)
  - [Использование Apache Sqoop с Apache Hadoop в HDInsight](apache-hadoop-use-sqoop-powershell.md)
  - [Выполнение заданий MapReduce с помощью Apache Hadoop в HDInsight и PowerShell](apache-hadoop-use-mapreduce-powershell.md)
