...
* Кластер, Azure SQL Server и базы данных, как определено из HDInsight [создания кластера и базы данных SQL](./hdinsight-use-sqoop.md#create-cluster-and-sql-database).
