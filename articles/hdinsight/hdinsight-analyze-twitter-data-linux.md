...
1. Измените приведенный ниже код, `Your consumer secret`заменив, `Your consumer key` `Your access token`, `Your access token secret` и соответствующими данными из приложения Twitter. Затем вставьте измененный код в качестве содержимого файла **gettweets.py** .
