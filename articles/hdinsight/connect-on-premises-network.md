...
3. На вкладке __Основные сведения__ задайте следующие параметры.  
    ...
    |Район | Выберите тот же регион, что и для созданной ранее виртуальной сети.  Не во всех регионах доступны виртуальные машины всех размеров.  |
...
5. На вкладке **Проверить и создать** выберите **Создать** для создания виртуальной машины.
