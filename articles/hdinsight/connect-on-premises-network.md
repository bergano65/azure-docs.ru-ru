...
3. Чтобы настроить привязку для перенаправления запросов на разрешение имен на локальный DNS-сервер, используйте следующий текст в качестве содержимого файла `/etc/bind/named.conf.options`:
