...
1. Выберите **Ubuntu Server 18.04 LTS**.<br />  
...
1. На вкладке **Сеть** введите следующие сведения. 
...
1. На вкладке **Просмотр и создание** выберите **Создать** для создания виртуальной машины.
...
1. Запишите значения **ОБЩЕДОСТУПНЫЙ IP-АДРЕС/ИМЯ DNS** и **ЧАСТНЫЙ IP-АДРЕС**. Они вам еще пригодятся.
...
1. В разделе **Сеть** выберите **Виртуальные сети**.  

1. Выберите свою виртуальную сеть из списка, чтобы открыть представление по умолчанию для виртуальной сети.  

1. В представлении по умолчанию в разделе **Параметры** выберите **DNS-серверы**.  

1. Выберите __Пользовательский__ и введите **ЧАСТНЫЙ IP-АДРЕС** пользовательского DNS-сервера.   

1. Щелкните __Сохранить__.  <br />  
