...
* **Нагрузка**: Прочитайте данные, которыми можно манипулировать из файловой системы.

* **Преобразование**: Манипулировать данными.

* **Dump или хранить**: Выходные данные на экран или хранить их для обработки.
