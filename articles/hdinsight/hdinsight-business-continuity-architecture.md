...
Дополнительные сведения о репликации Hive и примерах кода см. [в статье Apache Hive репликация в кластерах Azure HDInsight](https://docs.microsoft.com/azure/hdinsight/interactive-query/apache-hive-replication) .
