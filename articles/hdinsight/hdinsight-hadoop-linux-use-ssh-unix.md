...
| Azure CLI | Используйте `--ssh-password` параметр [az hdinsight создать](https://docs.microsoft.com/cli/azure/hdinsight?view=azure-cli-latest#az-hdinsight-create) команду и обеспечить значение пароля. |
