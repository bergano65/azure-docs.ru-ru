...
* Для рабочих нагрузок рекомендуется переходить на внешний хранилище метаданных. Дополнительные сведения см. в разделе ниже.
...
Частные конечные точки для хранилищ SQL не поддерживаются.
...
* В HDInsight 4,0 если вы хотите совместно использовать хранилище метаданных между Hive и Spark, это можно сделать, изменив свойство хранилище метаданных. catalog. default на Hive в кластере Spark. Это свойство можно найти в Ambari Advanced spark2-Hive-site-override. Важно понимать, что совместное использование хранилище метаданных работает только для внешних таблиц Hive. это не будет работать при наличии внутренних или управляемых таблиц Hive или таблиц с ACID.  
