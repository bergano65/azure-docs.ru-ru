...
Частные конечные точки для хранилищ SQL поддерживаются только в кластерах, созданных с помощью `outbound` ресаурцепровидерконнектион. Дополнительные сведения см. в этой [документации](https://docs.microsoft.com/azure/hdinsight/hdinsight-private-link).
