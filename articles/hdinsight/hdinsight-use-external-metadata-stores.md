...
* В хранилище метаданных по умолчанию используется базовая база данных SQL Azure, которая имеет ограничение в пять DTU (единиц транзакций базы данных).
