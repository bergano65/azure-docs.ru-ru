...
* [Выполнить Apache Hive запросы с помощью PowerShell](hadoop/apache-hadoop-use-hive-powershell.md).
...
* **[Azure Cloud Shell](https://docs.microsoft.com/azure/cloud-shell/overview)** — это интерактивная оболочка командной строки, которая работает в браузере и на портале Azure.
...
* [Azure HDInsight SDK для .NET](https://docs.microsoft.com/dotnet/api/overview/azure/hdinsight?view=azure-dotnet).
* [Выполнить Apache Hive запросы с помощью .NET SDK](hadoop/apache-hadoop-use-hive-dotnet-sdk.md).
* [Используйте функции, определяемые пользователем, с потоковым потоком Apache Hive и Apache Pig на Apache Hadoop.](hadoop/apache-hadoop-hive-pig-udf-dotnet-csharp.md)
...
* Intellij IDEA: [Создавайте приложения Apache Spark с помощью azure Toolkit для плагина Intellij и SCala SDK.](spark/apache-spark-intellij-tool-plugin.md)
* Eclipse IDE или Scala IDE для Eclipse: [Создание приложений Apache Spark и инструментарий Azure для Eclipse](spark/apache-spark-eclipse-tool-plugin.md)
...
## <a name="cross-platform-tools"></a>Кросс-платформенные инструменты

Azure CLI — это кроссплатформенный интерфейс командной строки от Майкрософт для управления ресурсами Azure.  Для получения дополнительной [Azure Command-Line Interface (CLI)](https://docs.microsoft.com/cli/azure/?view=azure-cli-latest)информации см.
