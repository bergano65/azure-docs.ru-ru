...
| Тип кластера HDInsight | Использование Data Lake Storage 1-го поколения как хранилища по умолчанию | Использование Data Lake Storage 1-го поколения как дополнительного хранилища| Notes |
|------------------------|------------------------------------|---------------------------------------|------|
...
* [С помощью PowerShell (с Gen1 хранилища Озера данных как хранилище по умолчанию)](../data-lake-store/data-lake-store-hdinsight-hadoop-use-powershell-for-default-storage.md)
* [С помощью PowerShell (с Gen1 хранилища Озера данных как дополнительное хранилище)](../data-lake-store/data-lake-store-hdinsight-hadoop-use-powershell.md)
* [С помощью шаблонов Azure](../data-lake-store/data-lake-store-hdinsight-hadoop-use-resource-manager-template.md)
...
* [Краткое руководство. настройке кластеров в HDInsight](../storage/data-lake-storage/quickstart-create-connect-hdi-cluster.md)
* [Создание кластера HDInsight для использования Gen1 хранилища Озера данных с помощью Azure PowerShell](../data-lake-store/data-lake-store-hdinsight-hadoop-use-powershell.md)
