...
![Снимок экрана: кластер HDInsight с удаляемой группой ресурсов](./media/quickstart-resource-manager-template/azure-portal-delete-hbase.png)
