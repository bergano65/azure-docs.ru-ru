...
| --- | --- | --- | --- |
| Совместимость клиента и сервера на уровне передачи данных | в | Y | Y |
| Совместимость серверов | в | Y | Y |
| Совместимость форматов файлов | в | Y | Y |
| Совместимость API клиента | в | Y | Y |
| Совместимость клиента на уровне двоичного кода | в | в | Y |
| **Ограниченная совместимость API на стороне сервера** |  |  |  |
| Stable | в | Y | Y |
| Развитие | в | в | Y |
| Работает неустойчиво | в | Нет | в |
| Совместимость зависимостей | в | Y | Y |
| Совместимость операций | в | в | Y |
...
8. **Если вы не используете кластеры HBase с функцией расширенной записи, пропустите этот шаг. Он нужен только для кластеров HBase с функцией расширенной записи.**
   ...
   `hbase.rootdir` Измените путь, чтобы он указывал на контейнер исходного кластера.
