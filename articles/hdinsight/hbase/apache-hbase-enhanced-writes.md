...
* Чтобы обновить кластер HDInsight Apache HBase для использования расширенного записывает, см. в разделе [перенос данных кластера Apache HBase в новую версию](apache-hbase-migrate-new-version.md).
