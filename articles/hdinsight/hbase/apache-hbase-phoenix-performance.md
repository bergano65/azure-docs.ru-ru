...
|rowkey|       адрес|   телефон| firstName| lastName|
|------|--------------------|--------------|-------------|--------------|
...
|rowkey|       адрес|   телефон| firstName| lastName| socialSecurityNum |
|------|--------------------|--------------|-------------|--------------| ---|
...
|rowkey|       key|   value| 
|------|--------------------|---|
|  Kuznetsov-Artem-111|адрес |Владимирская, 34|  
|  Kuznetsov-Artem-111|телефон |1-425-000-0002|  
...
* [Сведения о вторичном индексировании](https://phoenix.apache.org/secondary_indexing.html)
