---
title: Создание клиента HBase на Java с помощью Apache Maven — Azure HDInsight
...
* [Пакет JDK для платформы Java](https://aka.ms/azure-jdks) версии 8 или более поздней.
