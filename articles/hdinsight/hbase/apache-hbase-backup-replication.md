...
Если целевой кластер является кластером ADLS поколения 2, измените предыдущую команду, чтобы она была настроена для конфигураций, используемых ADLS Gen 2:
