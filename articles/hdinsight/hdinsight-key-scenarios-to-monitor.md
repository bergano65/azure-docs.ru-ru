...
![Вкладка "Hosts" (Узлы)](./media/hdinsight-key-scenarios-to-monitor/apache-ambari-hosts-tab.png)
...
![Сведения об узле](./media/hdinsight-key-scenarios-to-monitor/apache-ambari-host-details.png)
...
![Диспетчер очередей YARN](./media/hdinsight-key-scenarios-to-monitor/apache-yarn-queue-manager.png)
...
![Ссылка в меню "Resource Manager UI" (Пользовательский интерфейс Resource Manager)](./media/hdinsight-key-scenarios-to-monitor/resource-manager-ui-menu-link.png)
...
![диспетчер ресурсов меню пользовательского интерфейса](./media/hdinsight-key-scenarios-to-monitor/resource-manager-ui-menu.png)
