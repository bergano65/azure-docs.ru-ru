...
Нет поддерживаемого пути обновления от предыдущих версий HDInsight до HDInsight 4.0. Поскольку форматы данных Metastore и blob изменились, HDInsight 4.0 не совместим с предыдущими версиями. Важно, чтобы вы держали новую среду HDInsight 4.0 отдельно от текущей производственной среды. Если вы развернете HDInsight 4.0 в текущей среде, ваш Metastore будет обновлен и не может быть отменен.  
