...
Сведения о том, как добавить пустой граничный узел в кластер HDInsight. Пустой узло края представляет собой виртуальную машину Linux с теми же клиентскими инструментами, установленными и настроенными как в headnodes, но без служб [Apache Hadoop](https://hadoop.apache.org/) работает. Граничный узел можно использовать для доступа к кластеру, а также тестирования и размещения клиентских приложений.
