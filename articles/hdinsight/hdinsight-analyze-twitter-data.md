---
title: Анализ данных Twitter с помощью Apache Hadoop в HDInsight в Azure
description: Узнайте, как использовать Hive для анализа данных Twitter с помощью Apache Hadoop в HDInsight, чтобы определить частоту употребления конкретного слова.
services: hdinsight
...
ms.locfileid: "53635584"
---
# <a name="analyze-twitter-data-using-apache-hive-in-hdinsight"></a>Анализ данных Twitter с помощью Apache Hive в HDInsight
...
В рамках этого руководства вы будете получать твиты с помощью API потоковой передачи Twitter, а затем с помощью [Apache Hive](https://hive.apache.org/) в Azure HDInsight будете получать список пользователей Twitter, отправивших большинство твитов, которые содержат определенное слово.

> [!IMPORTANT]  
> Действия, описанные в этом документе, требуют наличия кластера HDInsight на основе Windows. Linux — это единственная операционная система, используемая для работы с HDInsight 3.4 или более поздних версий. Дополнительные сведения см. в разделе [Приближается дата прекращения сопровождения HDI версии 3.3](hdinsight-component-versioning.md#hdinsight-windows-retirement). Инструкции по работе с кластером под управлением Linux см. в статье [Анализ данных Twitter с помощью Apache Hive в HDInsight (Linux)](hdinsight-analyze-twitter-data-linux.md).
...
Данные твитов хранятся в формате JSON в виде сложных вложенных структур. Вместо того чтобы писать много строк кода с использованием обычного языка программирования, эту вложенную структуру можно преобразовать в таблицу Hive, чтобы к ней можно было отправлять запросы на SQL-подобном языке — HiveQL.

Twitter использует протокол OAuth для обеспечения авторизованного доступа к API. OAuth — это протокол проверки подлинности, с помощью которого пользователи разрешают приложению действовать от их имени без предоставления их паролей. Дополнительные сведения можно найти на веб-сайте [oauth.net](https://oauth.net/) или в превосходном [руководстве по OAuth для начинающих](https://hueniverse.com/oauth/) от Hueniverse.
...
После размещения результатов анализа в хранилище больших двоичных объектов Azure можно экспортировать данные в базу данных SQL Azure или на сервер SQL Server, экспортировать данные в Excel с помощью Power Query или подключить приложение к данным с помощью драйвера Hive ODBC. Дополнительные сведения см. в статьях об [использовании Apache Sqoop с HDInsight][hdinsight-use-sqoop], [анализе данных о задержке рейсов с помощью HDInsight][hdinsight-analyze-flight-delay-data], [подключении Excel к HDInsight с помощью Power Query][hdinsight-power-query] и [подключении Excel к HDInsight с помощью Microsoft Hive ODBC Driver][hdinsight-hive-odbc].

## <a name="next-steps"></a>Дополнительная информация
В этом учебнике мы рассмотрели, как преобразовать неструктурированный набор данных JSON в структурированную таблицу Apache Hive для запроса, исследования и анализа данных из Twitter с помощью HDInsight в Azure. Дополнительные сведения см. на следующих ресурсах:
