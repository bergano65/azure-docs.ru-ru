...
## <a name="utilities"></a>Энергогенерация.
...
|Azure Data Lake Storage Gen1|[Копирование данных в Azure Data Lake Storage Gen1 и из него с помощью фабрики данных Azure](../data-factory/connector-azure-data-lake-store.md)|
|Azure Data Lake Storage Gen2 |[Загрузка данных в Azure Data Lake Storage 2-го поколения с помощью Фабрики данных Azure](../data-factory/load-azure-data-lake-storage-gen2.md)|
...
**Причина**: HBase в кластерах HDInsight по умолчанию имеет размер блока 256 КБ при записи в службу хранилища Azure. Несмотря на то что это подходит при использовании API HBase или REST API, применение служебных программ командной строки `hadoop` или `hdfs dfs` вызовет ошибку.
...
1. В браузере перейдите к веб-интерфейсу Ambari для кластера Это `https://CLUSTERNAME.azurehdinsight.net`, где `CLUSTERNAME` — имя кластера.
