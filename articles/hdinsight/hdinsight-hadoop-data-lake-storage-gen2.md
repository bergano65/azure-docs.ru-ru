...
Дополнительные сведения см. в [The Azure Blob Filesystem driver (ABFS): выделенный драйвер службы хранилища Azure для Apache Hadoop](../storage/data-lake-storage/abfs-driver.md).
