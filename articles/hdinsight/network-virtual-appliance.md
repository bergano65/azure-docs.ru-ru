...
> [!Important]
> Следующие сведения требуются **только** в том случае, если требуется настроить сетевой виртуальный модуль (NVA), отличный от [брандмауэра Azure](https://docs.microsoft.com/azure/hdinsight/hdinsight-restrict-outbound-traffic).
