...
**Меню слева:**  
  ...
  - **Меню параметров**  
    ...
    |SSH + вход в кластер|Отображение сведений о подключении к кластеру по протоколу SSH. Дополнительные сведения см. [в статье Использование SSH с HDInsight](hdinsight-hadoop-linux-use-ssh-unix.md).|
