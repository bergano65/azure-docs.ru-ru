...
|Состояние|Одно из следующих: Aborted, Accepted, Клустерсторажепровисионед, Азуревмконфигуратион, Хдинсигхтконфигуратион, Operation, Operation, Error, Deleted, TimedOut, Делетекуеуед, DeleteTimedout, DeleteError, PatchQueued, CertRolloverQueued, Ресизекуеуед или ClusterCustomization.|
