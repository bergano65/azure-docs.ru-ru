...
**Меню слева:**  
  ...
  - **Меню параметров**  
    ...
    |Azure Data Lake Storage 1-го поколения|Настройка доступа к Data Lake Storage 1-го поколения.  Дополнительные сведения см. в статье [Краткое руководство по установке кластеров в HDInsight](../storage/data-lake-storage/quickstart-create-connect-hdi-cluster.md).|
