...
| Элемент| ОПИСАНИЕ |
|---|---|
|Move (Переместить)|Перемещает кластер в другую группу ресурсов или подписку.|
...
**Меню слева:**  
  ...
  - **Меню параметров**  
    ...
    |Data Lake Storage Gen1|Настройка доступа к Data Lake Storage 1-го поколения.  См. [Краткое руководство. по настройке кластеров в HDInsight](../storage/data-lake-storage/quickstart-create-connect-hdi-cluster.md).|
...
|Version (версия)|См. статью о [поддерживаемых версиях HDInsight](hdinsight-component-versioning.md).|
