...
Как развернуть Azure HDInsight в виртуальной сети и безопасно с группой сетевой безопасности:
...
Конфигурации пакета корпоративной безопасности с помощью служб домена Active Directory в HDInsight:https://docs.microsoft.com/azure/hdinsight/domain-joined/apache-domain-joined-configure-using-azure-adds
