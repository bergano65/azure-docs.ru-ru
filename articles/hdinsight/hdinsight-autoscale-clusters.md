...
Чтобы включить функцию автомасштабирования, выполните следующие действия как часть обычного процесса создания кластера.
...
3. Введите необходимые электронные адреса для:  
...
Мы вычислим, что определенное количество новых рабочих узлов требуется для соответствия текущим требованиям к ЦП и памяти, а затем инициируем запрос на увеличение масштаба, запросив соответствующее количество новых рабочих узлов.
...
Исходя из числа основных контейнеров приложений на каждом узле, а также текущих требований к ЦП и памяти, функция автомасштабирования будет выдавать запрос на удаление определенного количества узлов, указав, какие узлы являются потенциальными кандидатами для удаления. По умолчанию два узла будут удалены в рамках одного цикла.
