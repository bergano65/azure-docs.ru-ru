...
4. В поле **Пароль** введите пароль, настроенный для учетной записи `root`. Оставьте в остальных полях значения по умолчанию.
    ...
    ![Снимок экрана диалогового окна с выделенным текстовым полем корневого пароля](./media/hdinsight-hadoop-emulator-visual-studio/enter-root-password.png)
...
2. В новом окне создания запроса введите следующую команду:
    ...
    ![Снимок экрана: диалоговое окно "Отправка скрипта" Hive](./media/hdinsight-hadoop-emulator-visual-studio/advanced-hive.png)
...
2. Введите в качестве содержимого файла **script.pig**, созданного с помощью этого проекта, следующий текст.
    ...
    ![Снимок экрана: диалоговое окно "Отправка скрипта" Pig](./media/hdinsight-hadoop-emulator-visual-studio/advanced-pig.png)
