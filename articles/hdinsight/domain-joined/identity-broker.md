...
## <a name="clinets-using-oauth-to-connect-to-hdinsight-gateway-with-id-broker-setup"></a>Clinets с помощью OAuth для подключения к шлюзу HDInsight с установкой ID Broker
