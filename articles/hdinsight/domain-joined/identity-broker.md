...
Если вы добавите `idbrokernode` новую роль, вызванную со следующими атрибутами, в вычислительный профиль шаблона, кластер будет создан с включенным узлами брокера ID:
