...
1. Измените `log4j.rootLogger` на уровень `DEBUG` (после изменения он должен выглядеть как `log4j.rootLogger = DEBUG,logFile,FilterLog`).
...
* [Синхронизация пользователей Azure AD с кластером HDInsight](../hdinsight-sync-aad-users-to-cluster.md)
