...
1. На **основы** экрана выполните следующие действия:
    1. В разделе **имя каталога** выберите Azure Active Directory, созданный в этом учебнике **HDIFabrikam**.
...
1. На **группы администраторов** экрана, вы увидите уведомление, в котором создается группа с именем **Администраторы контроллера домена AAD** уже создан для этой группы управления. При необходимости можно изменить членство данной группы, но он не является обязательным для инструкциям из этого руководства. Последовательно выберите **ОК**.
