...
1. Вот как можно добавить пользовательский параметр.
    ...
    а. Перейдите на вкладку **Configs** (Конфигурации) Hive и выберите вкладку **Advanced** (Дополнительно).

    b. На вкладке **Advanced** (Дополнительно) найдите и разверните область **Custom hive-site** (Настраиваемый сайт Hive).

    c. Щелкните ссылку **Add Property** (Добавить свойство) в нижней части области "Custom hive-site" (Настраиваемый сайт Hive).

    г) В окне "Add Property" (Добавление свойства) введите ключ `mapred.map.output.compression.codec` и значение `org.apache.hadoop.io.compress.SnappyCodec`.
