...
1. Вот как можно добавить пользовательский параметр.
    ...
    a. Перейдите в раздел > **конфигурации** **Hive** > **Дополнительно** > **Пользовательский Hive — сайт**.
...
| Настройка | Рекомендуется | Значение по умолчанию HDInsight |
| -- | -- | -- |
| `hive.mapjoin.hybridgrace.hashtable` | True — более безопасное и медленное выполнение, false — более быстрое выполнение. | нет |
