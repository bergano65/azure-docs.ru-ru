...
| `tez.am.resource.memory.mb` | Верхняя граница 4 ГБ для большинства | Автоматическая настройка. |
...
1. Выберите **Сохранить** на верхней правой части окна, чтобы сохранить новое значение. Изменение некоторых свойств может потребовать перезапуска службы.
