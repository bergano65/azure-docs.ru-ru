...
1. Размер кучи NameNode Java изменен на 2 ГБ вместо 1 ГБ.
...
1.  Чтобы ограничить количество заданий, выполняемых параллельно, измените свойство `hive.exec.parallel.thread.number`. Значение по умолчанию — 8.
...
1. Щелкните **Save** (Сохранить) в верхней правой части окна, чтобы сохранить новое значение. Изменение некоторых свойств может потребовать перезапуска службы.
