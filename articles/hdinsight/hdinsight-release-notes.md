...
Для этого выпуска изменение версии компонента отсутствует. Текущие версии компонентов для HDInsight 4,0 и HDInsight 3,6 можно найти [здесь](https://docs.microsoft.com/azure/hdinsight/hdinsight-component-versioning).
