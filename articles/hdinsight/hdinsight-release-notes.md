...
Начиная с этого выпуска, клиенты могут использовать URL-адреса ключей шифрования без версии Azure Кэйвалут для шифрования неактивных ключей клиентов. HDInsight автоматически поворачивает ключи по мере их истечения или заменяет их новыми версиями. Дополнительные сведения см. [здесь](https://docs.microsoft.com/azure/hdinsight/disk-encryption).
