...
### <a name="deprecate-spark-21-and-22-for-hdinsight-36-spark-cluster"></a>Не рекомендуется использовать Spark 2,1 и 2,2 для кластера HDInsight 3,6 Spark
Начиная с июля 1 2020 клиенты не смогут создавать новые кластеры Spark с Spark 2,1 и 2,2 в HDInsight 3,6. Существующие кластеры будут работать как без поддержки корпорации Майкрософт. Рекомендуется перейти в Spark 2,3 с Хдинигхт 3,6 по Июнь 30 2020, чтобы избежать потенциальных прерываний системы и поддержки.

### <a name="deprecate-spark-23-for-hdinsight-40-spark-cluster"></a>Нерекомендуемый параметр Spark 2,3 для кластера HDInsight 4,0 Spark
Начиная с июля 1 2020 клиенты не смогут создавать новые кластеры Spark с помощью Spark 2,3 в HDInsight 4,0. Существующие кластеры будут работать как без поддержки корпорации Майкрософт. Рекомендуется перейти в Spark 2,4 с Хдинигхт 4,0 по Июнь 30 2020, чтобы избежать потенциальных прерываний системы и поддержки.

### <a name="deprecate-kafka-11-for-hdinsight-40-kafka-cluster"></a>Нерекомендуемый Kafka 1,1 для кластера HDInsight 4,0 Kafka
Начиная с июля 1 2020 клиенты не смогут создавать новые кластеры Kafka с Kafka 1,1 в HDInsight 4,0. Существующие кластеры будут работать как без поддержки корпорации Майкрософт. Рассмотрите возможность перехода на Kafka 2,1 с Хдинигхт 4,0 по Июнь 30 2020, чтобы избежать потенциальных прерываний системы и поддержки.
