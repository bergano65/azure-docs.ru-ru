...
- Федеративные пользователи входят в систему без синхронизации хэшей паролей в AAD-DS. Дополнительные сведения см. в [документации по ХИБ](https://docs.microsoft.com/azure/hdinsight/domain-joined/identity-broker).
...
Исправлена проблема перезапуска виртуальных машин в кластере. можно использовать [PowerShell или REST API для повторной перезагрузки узлов в кластере](https://docs.microsoft.com/azure/hdinsight/cluster-reboot-vm) .
