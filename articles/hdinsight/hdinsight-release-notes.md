...
Дополнительные сведения о важных изменениях, с помощью HDInsight 4.0., см. в разделе [новые возможности в HDI 4.0?](../hdinsight/hdinsight-version-release.md#whats-new-in-hdi-40).
