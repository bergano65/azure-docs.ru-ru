...
HDInsight обновляет версию ОС с 16,04 до 18,04. Обновление будет выполнено до 2021 апреля.
...
Начиная с середины ноября 2020, вы могли заметить, что виртуальные машины кластера HDInsight будут регулярно перезагружены. Это может быть вызвано следующими причинами.
