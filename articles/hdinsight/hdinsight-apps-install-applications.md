...
* **[Trifacta](https://www.trifacta.com/)** повышает эффективность исследования и подготовки разнообразнейших современных данных для инженеров и аналитиков за счет машинного обучения. Это позволяет разрабатывать передовые пользовательские интерфейсы, рабочие процессы и архитектуру.
