...
![Управление Ambari](./media/hdinsight-authorize-users-to-ambari/manage-apache-ambari.png)
...
1. На странице управления щелкните ссылку **Views** (Представления) под заголовком меню **Views** (Представления) в левой части экрана.
    ...
    ![Ссылка "Views" (Представления)](./media/hdinsight-authorize-users-to-ambari/apache-ambari-views-link.png)
...
2. На странице "Views" (Представления) разверните строку **HIVE**. При добавлении службы Hive в кластер создается представление по умолчанию Hive. При необходимости можно также создать дополнительные экземпляры представлений Hive. Выберите представление Hive.
    ...
    ![Представление Hive на странице "Views" (Представления)](./media/hdinsight-authorize-users-to-ambari/views-apache-hive-view.png)
...
1. Чтобы добавить пользователя, нажмите кнопку **Add User** (Добавить пользователя).
   ...
   * Начните вводить имя пользователя, и вы увидите раскрывающийся список ранее определенных имен.
     ...
     ![Автозаполнение имени пользователя](./media/hdinsight-authorize-users-to-ambari/ambari-user-autocomplete.png)
   ...
   * Чтобы сохранить изменения, щелкните **синий флажок**.
     ...
     ![Пользователь введен](./media/hdinsight-authorize-users-to-ambari/user-entered-permissions.png)
...
1. Чтобы добавить группу, нажмите кнопку **Add Group** (Добавить группу).
   ...
   * Чтобы сохранить изменения, щелкните **синий флажок**.
     ...
     ![Группа введена](./media/hdinsight-authorize-users-to-ambari/ambari-group-entered.png)
...
![Представление Tez на странице "Views" (Представления)](./media/hdinsight-authorize-users-to-ambari/views-apache-tez-view.png)
...
![Ссылка "Roles" (Роли) в меню](./media/hdinsight-authorize-users-to-ambari/cluster-roles-menu-link.png)
...
![Меню "роли" ссылки на разрешения](./media/hdinsight-authorize-users-to-ambari/roles-menu-permissions.png "Меню \"роли\" ссылки на разрешения")
...
![Представление "Block" (Блок) ролей](./media/hdinsight-authorize-users-to-ambari/ambari-roles-block-view.png)
...
![Пользователь с доступом только к представлениям](./media/hdinsight-authorize-users-to-ambari/ambari-user-views-only.png)
