...
Выполните [эти инструкции](./domain-joined/apache-domain-joined-configure-using-azure-adds.md), чтобы подготовить новый кластер ESP, если у вас его еще нет.
