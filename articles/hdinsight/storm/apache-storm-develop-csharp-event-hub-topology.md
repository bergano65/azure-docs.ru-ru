...
Узнайте, как работать с Центрами событий Azure из [Apache Storm](http://storm.apache.org/) в HDInsight. В этом документе для чтения данных из Центров событий и записи в него используется топология Storm на C#.
