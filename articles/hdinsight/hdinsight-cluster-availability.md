---
title: Как отслеживать доступность кластера с помощью журналов Ambari и Azure Monitor
...
![Панель мониторинга Ambari](media/hdinsight-cluster-availability/apache-ambari-dashboard.png)
...
![Представление узлов Ambari](media/hdinsight-cluster-availability/apache-ambari-hosts1.png)
...
![Ambari размещает одноузловое представление](media/hdinsight-cluster-availability/apache-ambari-hosts-node.png)
...
![Число оповещений Ambari](media/hdinsight-cluster-availability/apache-ambari-alerts.png)
...
Откроется диалоговое окно для управления уведомлениями об оповещениях. **+** Щелкните в нижней части диалогового окна и заполните обязательные поля, чтобы указать Ambari с данными о почтовом сервере, с которых следует отправлять сообщения электронной почты.
...
В качестве необходимого компонента для хранения собранных данных потребуется Log Analytics рабочей области. Если вы еще не создали его, выполните инструкции здесь: [Создайте рабочую область log Analytics](https://docs.microsoft.com/azure/azure-monitor/learn/quick-create-workspace).
...
Вы можете закрепить эту таблицу на общей информационной панели, щелкнув **закрепить** в правом верхнем углу. Если у вас нет доступных для записи общих панелей мониторинга, можно увидеть, как ее создать. [Создавайте и делитесь панелями мониторинга в портал Azure](https://docs.microsoft.com/azure/azure-portal/azure-portal-dashboards#publish-and-share-a-dashboard).
...
![Образец запроса "недоступные компьютеры" в колонке Log Analytics рабочей области](media/hdinsight-cluster-availability/portal-unavailable-computers.png)
...
![Условие для правила генерации оповещений](media/hdinsight-cluster-availability/portal-condition-title.png)

Откроется колонка **Настройка логики сигнала** .

Задайте раздел **логики оповещения** следующим образом:

*На основе: Число результатов, условие: Больше, пороговое значение: 0,0.*
...
![Добавление группы действий для правила генерации оповещений](media/hdinsight-cluster-availability/portal-add-action-group.png)
...
![Создание правила генерации оповещений завершено](media/hdinsight-cluster-availability/portal-create-alert-rule-finish.png)
...
![Azure Monitor оповещение по электронной почте](media/hdinsight-cluster-availability/portal-oms-alert-email.png)
