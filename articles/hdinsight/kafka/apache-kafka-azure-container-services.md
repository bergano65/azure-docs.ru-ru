...
1. Выберите __+ Добавить__ и заполните форму, используя следующие значения:
    ...
    |Свойство |Значение |
    |---|---|
    |Имя пиринга между \<этой виртуальной сетью> и удаленной виртуальной сетью.|Введите уникальное имя этой конфигурации пиринга.|
    |Виртуальная сеть|Выберите виртуальную сеть **кластера AKS**.|
    |Имя пиринга между \<виртуальной сетью AKS> и \<этой виртуальной сетью>|Укажите уникальное имя.|
