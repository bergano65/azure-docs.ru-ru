...
1. На вкладке **Хранилище** укажите следующие значения:
    ...
    ![Начало работы с HDInsight в Linux. Предоставление значений хранилища кластера](./media/apache-kafka-get-started/azure-portal-cluster-storage-blank.png "Предоставление значений хранилища для создания кластера HDInsight")
