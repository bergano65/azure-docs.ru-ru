...
3. В колонке **Основные сведения** введите или выберите следующие значения параметров.
   ...
   ![Базовая конфигурация кластера Apache Kafka в HDInsight](./media/apache-kafka-get-started/custom-basics-kafka1.png)
...
4. В области __Конфигурация кластера__ выберите следующие значения.
    ...
    ![Указание типа кластера Apache Kafka в HDInsight](./media/apache-kafka-get-started/apache-kafka-cluster-type.png)
...
5. В колонке __Основные сведения__ введите или выберите следующие значения параметров.
   ...
   ![Основные сведения при создании кластера на портале Azure](./media/apache-kafka-get-started/hdinsight-basic-configuration-2.png)
...
9. Чтобы продолжить, оставив значения параметров по умолчанию, в колонке __Размер кластера__ щелкните __Далее__.
   ...
   ![Определение размера кластера Apache Kafka](./media/apache-kafka-get-started/apace-kafka-cluster-size.png)
...
11. В колонке **Сводка** проверьте конфигурацию для кластера. Используйте ссылки __Изменить__, чтобы изменить неправильные параметры. Наконец, выберите **Создать**, чтобы создать кластер.
    ...
    ![Сводка по конфигурации кластера Kafka](./media/apache-kafka-get-started/kafka-configuration-summary.png)
