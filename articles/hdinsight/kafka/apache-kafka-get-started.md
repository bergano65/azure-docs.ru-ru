...
2. В меню слева последовательно выберите **+ Создать ресурс** > **Аналитика** > **HDInsight**.
    ...
    ![Создание кластера HDInsight](./media/apache-kafka-get-started/create-hdinsight-cluster.png)
...
4. В области __Конфигурация кластера__ выберите следующие значения.
    ...
    ![Выбор типа кластера](./media/apache-kafka-get-started/apache-kafka-cluster-type.png)
