...
Для получения дополнительной информации об использовании HDInsight в виртуальной [сети,](../hdinsight-plan-virtual-network-deployment.md)см.
...
2. Откройте запрос PowerShell и используйте следующий код для вхуши в подписку Azure:
...
1. Откройте веб-браузер и перейдите по адресу `https://CLUSTERNAME.azurehdinsight.net`. Замените `CLUSTERNAME` название Kafka в кластере HDInsight.
...
3. Чтобы просмотреть конфигурацию Kafka, выберите пункт __Configs__ (Конфигурации) в верхней части окна.
    ...
    ![Конфигурация служб Apache Ambari](./media/apache-kafka-connect-vpn-gateway/select-kafka-config1.png)
...
8. Нажмите кнопку __Save__ (Сохранить), чтобы сохранить изменения в конфигурации. Введите текст, описывающий изменения. После сохранения изменений нажмите кнопку __ОК__.
    ...
    ![Apache Ambari сохранить конфигурацию](./media/apache-kafka-connect-vpn-gateway/save-configuration-button.png)
...
Для получения дополнительной информации об использовании HDInsight с виртуальной сетью смотрите [план виртуального развертывания сети для документа кластеров Azure HDInsight.](../hdinsight-plan-virtual-network-deployment.md)
