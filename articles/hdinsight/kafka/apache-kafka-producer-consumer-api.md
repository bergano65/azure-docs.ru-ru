...
1. Установите [jq](https://stedolan.github.io/jq/) — обработчик командной строки JSON. В открытом сеансе SSH-подключения введите следующую команду для установки `jq`:
...
1. Чтобы получить узлы брокера Kafka, используйте следующую команду:
