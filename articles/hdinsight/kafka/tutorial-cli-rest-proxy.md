...
* Azure CLI. Убедитесь, что у вас установлена версия 2.0.79 или более поздняя. Подробнее см. статью [Установка Azure CLI](/cli/azure/install-azure-cli).
