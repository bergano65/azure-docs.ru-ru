...
2. В разделе **цены на конфигурацию &** используйте поле __число узлов__ , чтобы настроить количество дисков.
    ...
    ![раздел "размер кластера" с выделенным узлом "диски на рабочий узел"](./media/apache-kafka-scalability/azure-portal-cluster-configuration-pricing-kafka.png)
