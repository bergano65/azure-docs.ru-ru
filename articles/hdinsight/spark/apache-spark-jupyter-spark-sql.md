---
title: Краткое руководство. Создание кластера Spark с помощью шаблона в Azure HDInsight
...
![Как удалить кластер HDInsight на портале Azure](./media/apache-spark-jupyter-spark-sql/hdinsight-azure-portal-delete-cluster.png "Удаление кластера HDInsight")
