...
7. Откройте пространство имен концентратора событий, выполнив следующие инструкции:

    1. На портале щелкните **Все службы**.
    2. В текстовом поле "Фильтр" введите **Центры событий**.
    3. Выберите созданное пространство имен.
...
10. Выберите **Политики общего доступа** для пространства имен (обратите внимание на то, что это не политики общего доступа концентратора событий), а затем выберите **RootManageSharedAccessKey**.
...
11. Сохраните значения **Первичный ключ** и **Строка подключения — первичный ключ**. Они понадобятся позже для работы с этим руководством.
