---
title: 'Руководство. Обработка данных из Центров событий Azure с помощью Apache Spark в Azure HDInsight '
...
5. Для пространства имен нового Центра событий введите следующие значения.
    ...
    - **Включить автоматическое расширение**. (Необязательно.) Автоматическое расширение автоматически масштабирует число единиц пропускной способности, назначенное для пространства имен Центров событий, если трафик превышает объем единиц пропускной способности, назначенных ему.  

    - **Автоматически увеличивать максимум единиц пропускной способности**. (Необязательно.) Этот ползунок будет отображаться только в том случае, если вы установили флажок **Включить автоматическое расширение**.  
