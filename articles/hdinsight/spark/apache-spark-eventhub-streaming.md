...
5. Для пространства имен нового Центра событий введите следующие значения.
    ...
    |Resource group|Выберите имеющуюся группу ресурсов из раскрывающегося списка или щелкните вариант **Создать**, чтобы создать новую группу ресурсов.|
