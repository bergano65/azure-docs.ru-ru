...
1. На странице **Хранилище** укажите следующие значения.
    ...
    ![Создание основных конфигураций кластера Spark в HDInsight](./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-cluster-storage.png "Создание кластера Spark в основных конфигурациях HDInsight")
