...
1. В разделе **Основные сведения** укажите следующие значения.
    ...
    ![Создание основных конфигураций кластера Spark в HDInsight](./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-cluster-basics-spark.png "Создание кластера Spark в основных конфигурациях HDInsight")
...
1. На странице **Хранилище** укажите следующие значения.
    ...
    ![Создание основных конфигураций кластера Spark в HDInsight](./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-cluster-storage-spark.png "Создание кластера Spark в основных конфигурациях HDInsight")
