...
Данные в таблицах результатов могут содержать только новые данные с момента последнего обработки запроса *(режим приложения),* или таблица может обновляться каждый раз, когда есть новые данные, поэтому таблица включает в себя все выходные данные с момента начала потокового запроса *(полный режим).*
...
Этот запрос дает результаты, аналогичные следующим:
...
* [Создание кластера Apache Spark в HDInsight](../hdinsight-hadoop-create-linux-clusters-portal.md)
