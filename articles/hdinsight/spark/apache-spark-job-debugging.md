...
3. Щелкните вкладку **Этапы** , чтобы просмотреть этапы, связанные с приложением.
    ...
    ![Подробные сведения о стадиях сервера журнала Spark](./media/apache-spark-job-debugging/view-spark-stages-details.png "Просмотр сведений о стадиях Spark")
...
6. Другие вкладки в пользовательском интерфейсе Spark содержат полезные сведения о самом экземпляре Spark.
   ...
   * Вкладка "среда". на этой вкладке содержится много полезной информации об экземпляре Spark, например:
     * версия Scala;
...
1. Чтобы открыть сервер журнала Spark, в колонке "Обзор" в разделе **Панели мониторинга кластера** щелкните **Сервер журнала Spark**.
    ...
    ![Портал Azure запустить сервер журнала Spark](./media/apache-spark-job-debugging/launch-spark-history-server.png "Запуск журнала Spark — Server1")
...
2. Отобразится список всех завершенных приложений. Выберите идентификатор приложения, чтобы открыть подробные сведения о приложении.
    ...
    ![Сервер журнала Spark завершено приложения](./media/apache-spark-job-debugging/view-completed-applications.png "Запуск журнала Spark Server2")
