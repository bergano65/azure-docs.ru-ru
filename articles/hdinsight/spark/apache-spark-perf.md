...
* Кэширование на уровне хранилища (рекомендуется)
    * Можно реализовать с помощью [Alluxio](https://www.alluxio.org/).
...
Если вы используете сегментированные таблицы, то у вас есть третий тип присоединение — `Merge`. В соединении `SortMerge` правильно предварительно секционированный и отсортированный набор данных пропустит дорогостоящий этап сортировки.
