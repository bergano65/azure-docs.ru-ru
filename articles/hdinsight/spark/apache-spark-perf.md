...
| Azure Data Lake Storage Gen 2| **абфс [s]:** //УРЛ/ | **Более быстрая** | Да | Промежуточный кластер |
...
* Факторы, которые стоит учесть, чтобы выбрать исполнитель большего размера:
    ...
    4. Дополнительно уменьшите лимит переполнения памяти каждого исполнителя.
    5. Дополнительно увеличьте использование и параллелизм, увеличив число назначенных ЦП.
