...
| --- | --- | --- | --- | --- |
| Хранилище больших двоичных объектов Azure | **wasb [s]:**//url/ | **Стандартная** | Yes | Промежуточный кластер |
| Общего хранилища Озера данных Azure 2| **abfs [s]:**//url/ | **Быстрее** | Yes | Промежуточный кластер |
| Хранилище Azure Data Lake поколения 1| **adl:**//url/ | **Быстрее** | Yes | Промежуточный кластер |
