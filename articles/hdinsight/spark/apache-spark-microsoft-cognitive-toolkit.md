...
* **Подписка Azure**. Перед началом работы в этой статье, необходимо иметь подписку Azure. Ознакомьтесь со страницей [Создайте бесплатную учетную запись Azure уже сегодня](https://azure.microsoft.com/free).
...
Этого решения используются Данная статья и записной книжки Jupyter, загруженный в рамках этой статьи. Ниже перечислены действия, которые вы выполните в этой статье.
...
5. После передачи, щелкните имя записной книжки и следуйте инструкциям в notebook указаниям о том, как загрузить набор данных и выполнять статьи.
