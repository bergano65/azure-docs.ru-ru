---
title: Устранение неполадок в работе кластера HDInsight в Azure HDInsight или в случае сбоя.
...
* Шаг 1. Соберите данные о неполадке.
* Шаг 2. Проверьте среду кластера HDInsight.
* Шаг 3. Просмотр работоспособности кластера.
* Шаг 4. Изучите стек и версии среды.
* Шаг 5. Изучите файлы журналов кластера.
...
![Пользовательский интерфейс Ambari](./media/hdinsight-troubleshoot-failed-cluster/apache-ambari-overview.png)
...
![Перезапуск сервера WebHCat](./media/hdinsight-troubleshoot-failed-cluster/restart-webhcat-server.png)
...
1. Отправка задания YARN может занять достаточно времени, чтобы вызвать истечение времени ожидания.
    ...
    ![Очередь joblauncher](./media/hdinsight-troubleshoot-failed-cluster/hdi-job-launcher-queue.png)
...
![Стек и версии](./media/hdinsight-troubleshoot-failed-cluster/ambari-stack-versions.png)
