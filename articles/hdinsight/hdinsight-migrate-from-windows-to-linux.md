...
| `hive` из удаленного рабочего стола. |Используйте [Beeline](hadoop/apache-hadoop-use-hive-beeline.md) или [Apache Hive из сеанса SSH](hdinsight-hadoop-use-hive-ssh.md) |
