...
description: Узнайте, как для чтения и понимания, использования и оплаты за подписку Azure.
author: bandersmsft
manager: jureid
tags: billing
ms.service: billing
...
ms.locfileid: "67490322"
---
# <a name="understand-your-microsoft-azure-bill"></a>Расшифровка счета за Microsoft Azure
Чтобы расшифровать счет Azure, сравните счет с подробный файл ежедневного использования и отчетах по управлению затратами на портале Azure.
...
Эта статья не относится к клиентам Azure [соглашении клиента Microsoft](#check-access-to-a-microsoft-customer-agreement). Если у вас есть соглашение Microsoft клиента, см. в разделе [расходах Azure, в счете клиента соглашение](billing-mca-understand-your-bill.md).
...
CSV-файл с подробными данными об использовании отображает сведения о расходах за расчетный период и о ежедневном использовании. Чтобы загрузить или просмотреть файл, см. в разделе [получение счета Azure счета и данных о ежедневном](billing-download-azure-invoice-daily-usage-date.md).
...
**Плата за использование** разделе счета отображает общее значение для каждого средству измерения за определенный расчетный период. Например на следующем рисунке плата за службу планировщика Azure использование.
...
Чтобы просмотреть распределение ежедневных расходов, перейдите к **о ежедневном использовании** разделе CSV-файла. Фильтрация для *планировщика* под *Категория счетчика*. Вы увидите, в какие дни использовался этот счетчик и какой потребления он зафиксировал. *Ресурсов* и *группы ресурсов* также отображаются сведения для сравнения. *Потреблено* значения следует добавить не больше и соответствовать отображаемому в счете.
...
1. Выберите строку, которая показывает плата для ежедневных затратах см. в разделе.
