...
### <a name="option-2-compare-the-usage-and-costs-with-the-azure-portal"></a>Вариант 2. Сравните данных о потреблении и затратах с порталом Azure
