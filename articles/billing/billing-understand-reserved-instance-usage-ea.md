...
## <a name="reservation-purchases-and-amortization-in-cost-analysis"></a>Резервирование покупок и списания в анализа затрат

Стоимость резервирования доступны в [анализ затрат](https://aka.ms/costanalysis). По умолчанию затрат показывает analysis **фактическая стоимость**, который является как цены будут показаны в вашем счете. Чтобы просмотреть резервирование покупок разбить и связанных с ресурсами, которые используются преимущества, перейдите к **амортизации затрат**:
...
Группировать по типу оплаты увидеть разрыв внизу использования, покупки и возмещения; или резервирования разбор затраты на резервирование и по запросу. Помните, что затраты на резервирование только вы увидите при просмотре фактическая стоимость приобретаются, но затраты, выделяемое для отдельных ресурсов, которые используются benfit при просмотре амортизированная стоимость. Вы также увидите новый **UnusedReservation** тип взимается плата в случае, если по амортизации затрат.
