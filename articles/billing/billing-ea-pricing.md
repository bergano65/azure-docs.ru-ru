---
title: Просмотр цен Azure для вашей организации | Документация Майкрософт
description: Узнайте, как просмотреть и скачать сведения о ценах или оценить затраты по Соглашению Enterprise.
services: ''
documentationcenter: ''
author: adpick
manager: dougeby
...
ms.locfileid: "54904239"
---
# <a name="view-your-organizations-azure-enterprise-agreement-pricing"></a>Просмотр цен на Соглашение Enterprise Azure вашей организации 

Клиенты с Соглашением Enterprise (EA) Azure могут просматривать и скачивать сведения о ценах на свое соглашение EA на портале Azure. Вы можете также воспользоваться сведениями о ценах EA вашей организации для оценки затрат с помощью калькулятора цен Azure.

В зависимости от политик, которые администратор задал для вашей организации, только некоторые административные роли предоставляют доступ к сведениям о ценах EA вашей организации. Дополнительные сведения см. в статье [Understand Azure Enterprise Agreement administrative roles in Azure](billing-understand-ea-roles.md) (Сведения об административных ролях в Azure для Соглашения Azure Enterprise).
...
## <a name="estimate-costs-with-ea-pricing"></a>Оценка затрат с помощью сведений о ценах EA
...
- [Understand your bill for Azure customers with an Enterprise Agreement](billing-understand-your-bill-ea.md) (Расшифровка счета для клиентов Azure с Соглашением Enterprise)
