...
|Role| Ограничение пользователей|
|---|---|
...
|---|---|---|---|
|Владелец учетной записи или администратор отдела|✔ Включено|Ответственный|Цены по Соглашению Enterprise для организации|
|Владелец учетной записи или администратор отдела|✘ Отключено|Ответственный|Розничная цена|
...
|Отсутствуют|Неприменимо |Ответственный|Розничная цена|
