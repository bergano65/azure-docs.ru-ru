...
Скидка на резервирование применяется только для ресурсов в подписках, приобретенных по Соглашению Enterprise, договору CSP (поставщик облачных решений) или для индивидуальных планов с оплатой по мере использования.
...
Вы также можете получить сведения об использовании резервирования через [интерфейсы API](billing-reservation-apis.md#see-reservation-usage) или через [данные об использовании](billing-understand-reserved-instance-usage-ea.md#common-cost-and-usage-tasks), если вы являетесь клиентом с Соглашением Enterprise.
...
Скидка на резервирование применяется только к ресурсам в подписках, связанных с Соглашением Enterprise, CSP или оплатой по мере использования. Ресурсы, работающие в подписке с любым другим типом, не могут воспользоваться скидкой резервирования.
