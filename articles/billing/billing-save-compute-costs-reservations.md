...
- тип предложения подписки Enterprise Agreement (MS-AZR-0017P или MS-AZR-0148P);
- тип предложения подписки с оплатой по мере использования (MS-AZR-003P или MS-AZR-0023P).
...
Скидка на резервирование применяется только для ресурсов в подписках с Соглашением Enterprise, с оплатой по мере использования или CSP.
 ...
 Чтобы приобрести план нужно сделать следующее.
...
Когда вы покупаете резервирование, скидку можно применить к другим экземплярам с атрибутами, которые находятся в группе того же размера. Гибкость покрытия скидки зависит от типа резервирования и атрибутов, которые вы выбираете при покупке резервирования.
...
- План программного обеспечения SUSE Linux Enterprise Server. Покрытие скидки зависит от количества виртуальных ЦП виртуальных машин, где запускается программное обеспечение SUSE. Дополнительные сведения см. в статье [Сведения о применении скидки на программное обеспечение SUSE Linux Enterprise](billing-understand-suse-reservation-charges.md).
