---
title: Расшифровка счета Azure enterprise
...
1. Для входа на [корпоративного портала](https://ea.azure.com).
1. Выберите **Reports** (Отчеты).
1. В правом верхнем углу вкладки, переключите представление **M** для **C** и соответствуют периоду в счете.  
