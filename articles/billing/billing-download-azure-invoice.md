...
Для большинства подписок счет можно скачать с портала Azure. Если у вас есть соглашение Microsoft клиента, см. в разделе [скачивать счета клиента соглашения Microsoft](#download-invoices-for-a-microsoft-customer-agreement).

### <a name="download-invoices-for-an-individual-subscription"></a>Скачивать счета для отдельной подписки

1. Выберите свою подписку на [страницу "подписки"](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade) на портале Azure как [пользователя с доступом к счетам](billing-manage-access.md).
...
Вы можете согласиться и настроить дополнительных получателей Azure для получения счета по электронной почте. Эта функция может быть недоступна для определенных подписок, например для предложений о планах поддержки, соглашений Enterprise или Azure с открытой лицензией. Если у вас есть соглашения с Майкрософт, см. в разделе ниже, [получение счетах профиль выставления счетов по электронной почте](#get-your-subscriptions-invoices-in-email).

### <a name="get-your-subscriptions-invoices-in-email"></a>Получение счетов вашей подписки по электронной почте

1. Выберите свою подписку на [страницу "подписки"](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade). Выберите все свои подписки. Щелкните **Invoices** (Счета), а затем — **Email my invoice** (Отправить счет по электронной почте).

    ![Снимок экрана, показывающий opt в потоке](./media/billing-download-azure-invoice-daily-usage-date/InvoicesDeepLink.PNG)

2. Щелкните **Согласиться** и примите условия.

    ![Снимок экрана, показывающий opt на шаге 2, поток](./media/billing-download-azure-invoice-daily-usage-date/InvoiceArticleStep2.PNG)

3. Если вы приняли условия соглашения, можно настроить дополнительных получателей. При удалении получателей адреса их электронной почты больше не сохраняются. Если вы передумаете, их необходимо добавить повторно.

    ![Снимок экрана, показывающий opt в последовательность шаг 3](./media/billing-download-azure-invoice-daily-usage-date/InvoiceArticleStep3.PNG)
...
Чтобы отказаться от получения счета по электронной почте, выполните описанные выше шаги и нажмите кнопку **отказаться от счета по электронной почте**. После этого удаляются все адреса электронной почты, на которые могли отправляться счета. Если вы выбрали в можно перенастроить получателей.

 ![Снимок экрана, показывающий отказ от использования потока](./media/billing-download-azure-invoice-daily-usage-date/InvoiceArticleStep4.PNG)
...
Чтобы отказаться от получения счета по электронной почте, выполните описанные выше шаги и нажмите кнопку **отказаться**. Все владельцы, участники, читатели и счета диспетчеры отказались от получения счета по электронной почте, слишком. Если средство чтения, нельзя изменить приоритет счета по электронной почте.
