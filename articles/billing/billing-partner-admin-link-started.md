...
**Можно ли изменить идентификатор партнера, после его связывания?**

Да. Связанный идентификатор партнера можно изменить, добавить или удалить.

**Что делать, если пользователь имеет учетную запись в более чем одного клиента?**
...
**Можно другие партнеры или покупатели изменить или удалить ссылку на идентификатор партнера?**
