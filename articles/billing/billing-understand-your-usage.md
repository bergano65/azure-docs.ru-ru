...
Аккаунтовнерид<sup>1</sup> | EA, PAYG | Уникальный идентификатор для учетной записи регистрации EA или учетной записи выставления счетов PAYG.
Дополнительные сведения | Все | Метаданные определенных служб. Например, тип образа для виртуальной машины.
Биллингаккаунтид<sup>1</sup> | Все | Уникальный идентификатор корневой учетной записи выставления счетов.
...
Биллингпрофилеид<sup>1</sup> | Все | Уникальный идентификатор подписки EA, подписке PAYG, профиля выставления счетов MCA или консолидированной учетной записи AWS.
...
CostCenter<sup>1</sup> | EA, MCA | Центр затрат, определенный для подписки на отслеживание затрат (доступен только в открытых периодах выставления счетов для учетных записей MCA).
...
Дата<sup>1</sup> | Все | Дата использования или покупки платежа.
...
Инвоицесектионид<sup>1</sup> | EA, MCA | Уникальный идентификатор для раздела "Отдел EA" или "счет MCA".
...
MeterId<sup>1</sup> | Все | Уникальный идентификатор для счетчика.
...
Партнумбер<sup>1</sup> | EA, PAYG | Идентификатор, используемый для получения конкретных цен на измерения.
