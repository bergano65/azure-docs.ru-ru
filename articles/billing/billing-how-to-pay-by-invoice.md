...
ms.locfileid: "68774664"
---
# <a name="pay-for-your-azure-subscription-by-invoice"></a>Оплата подписки Azure по счету

Если переключиться на оплату по счету, это означает, что счет будет оплачиваться в течение 30 дней с даты выставления счета на проверку/проводное перемещение. Чтобы получить право платить за подписку Azure по счету, отправьте запрос в службу поддержки Azure. После утверждения запроса можно переключиться на оплату счета (проверка/проводка передачи) в [портал Azure](https://portal.azure.com).

> [!IMPORTANT]
> * Оплата по счету (проверка/проводка передачи) доступна только для бизнес-учетных записей.
> * Перед переходом на оплату счета необходимо оплатить все неоплаченные расходы.
...
5. Укажите следующие сведения в поле **Сведения** и нажмите кнопку **Далее**.
    ...
    - Необходимо добавить контактные данные для выставления счетов в портал Azure, прежде чем можно будет утвердить кредитный лимит. Контактные данные должны быть связаны с кредиторской задолженностью компании или финансовым отделом. Чтобы обновить контактные данные для выставления счетов, перейдите по адресу [центр управления учетной записью Azure](https://account.azure.com/Profile).
...
Если у вас есть учетная запись программы Microsoft Online Services, вы можете переключить подписку Azure на проверку или перенос проводок. Если у вас есть соглашение с клиентами корпорации Майкрософт, вы можете переключить профиль выставления счетов на проверку или перенос проводки. [Узнайте, как проверить тип учетной записи](#check-access-to-a-microsoft-customer-agreement).

### <a name="switch-azure-subscription-to-checkwire-transfer"></a>Переключение подписки Azure на проверку и перенос проводок

Выполните следующие действия, чтобы переключить подписку Azure на счет оплаты (проверка/проводка передачи). **После переключения на оплату по счету (проверка/передача проводки) вы не сможете вернуться на кредитную карту**.
...
1. Выберите подписку, которую вы хотите переключить на оплату счета.
...
Выполните следующие действия, чтобы переключить профиль выставления счетов на проверку или перенос проводки. Обратите внимание, что только пользователь, выполнивший вход в Azure, может изменить метод оплаты по умолчанию для профиля выставления счетов.
