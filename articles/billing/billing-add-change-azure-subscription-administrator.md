...
[Гостевые пользователи](../active-directory/b2b/b2b-quickstart-add-guest-users-portal.md), которым была назначена роль соадминистратора, могут видеть некоторые различия, в отличие от пользователей-участников с той же ролью. Рассмотрим следующие сценарии.
