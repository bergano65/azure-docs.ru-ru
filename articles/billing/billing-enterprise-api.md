...
* **Зарезервированные подробные сведения об экземпляре** - [API использования зарезервированного экземпляра](/rest/api/billing/enterprise/billing-enterprise-api-reserved-instance-usage) возвращает приобретает использования зарезервированного экземпляра. [Зарезервированного экземпляра плата за API](/rest/api/billing/enterprise/billing-enterprise-api-reserved-instance-usage) показано выставления счетов транзакций, совершаемых. 
...
|Код состояния отклика|`Message`|Описание|
|-|-|-|
|200| OК|Без ошибок|
