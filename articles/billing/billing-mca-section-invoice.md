---
title: Создать разделы в счете, чтобы упорядочить затраты — Azure | Документация Майкрософт
...
Создать разделы на счета для организации затрат по отделу, среды разработки или исходя из потребностей вашей организации. Затем предоставьте другим пользователям разрешение на создание подписок Azure для раздела. Плата за использование любых покупки для подписок отображены в разделе счета. Просмотреть общие платежи для раздела в ваш счет, на портале Azure, или просмотрите их в анализ затрат Azure. Дополнительные сведения см. в разделе [просматривать транзакции по разделы счетов](billing-mca-understand-your-bill.md#view-transactions-by-invoice-sections).
...
3. Выберите **выставляется счет разделах** в левой области. В зависимости от вашего доступа необходимо выбрать профиль выставления счетов или учетную запись выставления счетов, а затем выберите **выставляется счет разделах**.
   ...
   ![Снимок экрана, показывающий поиск на портале Azure](./media/billing-mca-section-invoice/billing-mca-list-invoice-sections.png)

4. В верхней части страницы выберите **добавить**.

5. Введите имя в разделе счета.
...
6. Выберите профиль выставления счетов. Плата за использование любых покупки для раздела счета будут отображены в профиль выставления счетов.
...
- [Предоставить другим пользователям разрешение на создание подписки Azure](billing-mca-create-subscription.md#give-others-permission-to-create-azure-subscriptions)
