...
description: Сведения о физических и технических характеристиках для Microsoft Azure ФКСТ пограничных фильтр оборудования.
author: ekpgh
...
| Номера жестких дисков    |  Использование   |  Характеристики |
|------------------|--------|-----------------|
| 0, 1             | OS     | 480 ГБ SATA SSD |
| 2, 3, 4, 5, 6, 7, 8, 9 | Данные   | ФКСТ 6600:3,2 ТБ SSD NVMe <br> ФКСТ 6400:1,6 ТБ SSD NVMe |
...
> [!NOTE] 
> **Деоценка температуры высотой:** Максимальная температура уменьшается на 1 °C/300 м (1 ° F/547 футов) выше 950 м (3 117 футов).

### <a name="airflow-shock-and-vibration"></a>Воздушный поток, ударопрочность и вибрация 

| attribute         | Спецификация |
|-------------------|---------------|
...
| Чувствительность к вибрация в выключенном состоянии | 1,88 G<sub>RMS</sub> от 10 гц до 500 Гц в течение 15 минут (все шесть сторон протестированы)  |
