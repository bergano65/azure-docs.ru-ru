...
1. В рамках метода **CreateTable** получите объект **CloudStorageAccount**, который представляет сведения об учетной записи хранения. Используйте следующий код, чтобы получить строку подключения к хранилищу и сведения об учетной записи хранения из конфигурации службы Azure: (измените * &lt;имя учетной записи хранения>* на имя учетной записи хранения Azure, к которой осуществляется доступ.)
...
1. Запустите приложение и выберите **создать таблицу** , чтобы увидеть результаты, как на снимке экрана ниже.
...
1. Запустите приложение и выберите **добавить сущность** , чтобы увидеть результаты, как на снимке экрана ниже.
...
1. Запустите приложение и выберите **добавить сущности** , чтобы увидеть результаты, как на снимке экрана ниже.
...
1. Запустите приложение и выберите **получить один** , чтобы увидеть результаты, как на снимке экрана ниже.
...
1. Запустите приложение и выберите **получить секцию** , чтобы увидеть результаты, как на снимке экрана ниже.
...
1. Запустите приложение и выберите **Удалить сущность** , чтобы увидеть результаты, как на снимке экрана ниже.
...
Просмотрите дополнительные руководства, чтобы изучить дополнительные возможности хранения данных в Azure.
  ...
  * [Приступая к работе с хранилищем BLOB-объектов Azure и Visual Studio Подключенные службы (ASP.NET)](../storage/vs-storage-aspnet-getting-started-blobs.md)
