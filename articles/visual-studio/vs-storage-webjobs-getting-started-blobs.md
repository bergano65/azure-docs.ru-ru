...
* FunctionId (в формате *{имя веб-задания}* . Функции. *{Function Name}* , например: WebJob1.Functions.CopyBlob)
...
* Функция, которая была вызвана для большого двоичного объекта (" *{имя веб-задания}* ". Функции. *{Function Name}* ", например: "WebJob1. functions. CopyBlob")
* имя контейнера;
