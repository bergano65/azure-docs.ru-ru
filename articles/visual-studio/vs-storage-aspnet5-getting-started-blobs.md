---
title: Начало работы с хранилищем BLOB-объектов с помощью Visual Studio (ASP.NET Core)
...
См. [Краткое руководство. Отправьте, скачайте и перечислите большие двоичные объекты с помощью. NET @ no__t-0 — другие способы перечисления содержимого контейнера больших двоичных объектов.
...
См. [Краткое руководство. Отправьте, скачайте и перечислите большие двоичные объекты с помощью. NET @ no__t-0 — другие способы сохранения больших двоичных объектов в виде файлов.
