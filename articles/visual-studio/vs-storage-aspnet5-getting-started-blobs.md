...
См. [Краткое руководство. Отправка, скачивание и перечисление больших двоичных объектов с помощью .NET](../storage/blobs/storage-quickstart-blobs-dotnet.md#list-the-blobs-in-a-container) . другие способы перечисления содержимого контейнера больших двоичных объектов.
...
См. [Краткое руководство. Передача, скачивание и перечисление больших двоичных объектов с помощью .NET](../storage/blobs/storage-quickstart-blobs-dotnet.md#download-blobs) для других способов сохранения больших двоичных объектов в виде файлов.
