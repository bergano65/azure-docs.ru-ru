...
1. Выполнить приложение и выбрать **очередь «Создать»** для просмотра результатов, аналогичных следующему скриншоту:
...
1. Выполнить приложение и выберите **сообщение Добавить,** чтобы увидеть результаты, аналогичные следующему скриншоту:
...
1. Выполнить приложение и выбрать **сообщение Peek,** чтобы увидеть результаты, аналогичные следующему скриншоту:
...
1. Выполнить приложение и выбрать **сообщение Read/Delete,** чтобы увидеть результаты, аналогичные следующему скриншоту:
...
1. Выполнить приложение и выбрать **Длину очереди,** чтобы увидеть результаты, аналогичные следующему скриншоту:
