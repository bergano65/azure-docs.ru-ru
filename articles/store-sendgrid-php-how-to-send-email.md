...
Дополнительные сведения см. на странице [https://sendgrid.com][https://sendgrid.com].
...
## <a name="how-to-send-an-email"></a>Практическое руководство: отправка сообщения электронной почты
...
Используйте функцию [curl][curl function] в PHP для отправки электронной почты с помощью веб-API SendGrid.
...
## <a name="how-to-use-filters-to-enable-footers-tracking-and-analytics"></a>Практическое руководство: использование фильтров для включения нижних колонтитулов, отслеживания и аналитик
