...
В этом разделе необходимо заменить следующие параметры в шагах приведенными ниже сведениями.

| Параметр                   | Значение                |
|-----------------------------|----------------------|
| **\<имя группы ресурсов >**  | myResourceGroup |
| **\<имя виртуальной сети >** | myVirtualNetwork          |
| **\<имя региона >**          | центрально-западная часть США      |
