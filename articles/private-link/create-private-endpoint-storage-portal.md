...
1. В верхней левой части экрана портал Azure выберите **создать ресурс** > **Вычисление** > **виртуальной машины**.
...
2. Введите @ no__t-0. Вы получите примерно следующее сообщение:
    ```azurepowershell
    Server:  UnKnown
...
1. В верхней части портала введите *myResourceGroup*@no__t- **1in, а** затем выберите *myResourceGroup* from результаты поиска. 
2. Выберите **Удалить группу ресурсов**. 
3. Введите *myResourceGroup* For **, введите имя группы ресурсов** и выберите **Удалить**. 
