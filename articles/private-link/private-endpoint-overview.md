...
- **Автоматически** утверждается, когда вы владеете или имеете разрешение на конкретный ресурс частной связи. Требуемое разрешение основано на типе ресурса частной ссылки в следующем формате: NNTP. \<Поставщик > < resource_type >/приватиндпоинтконнектионаппровал/Актион
