...
|**Веб-приложения Azure** | Microsoft.Web/sites    | site |
...
- **Автоматически** получить утверждение можно, если вы владеете конкретным ресурсом Приватного канала или имеете разрешение на доступ к нему. Требуемое разрешение основано на типе ресурса Приватного канала в следующем формате. Microsoft.\<Provider>/<resource_type>/privateEndpointConnectionApproval/action
