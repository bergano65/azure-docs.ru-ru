...
|Приватный канал для служб PaaS Azure   | Хранилище Azure        |  Все общедоступные регионы      | Предварительный просмотр <br/> [Узнайте больше](/azure/storage/common/storage-private-endpoints).  |
|  | Azure Data Lake Storage 2-го поколения        |  Все общедоступные регионы      | Предварительный просмотр <br/> [Узнайте больше](/azure/storage/common/storage-private-endpoints).  |
