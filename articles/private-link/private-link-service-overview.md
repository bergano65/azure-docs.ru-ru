...
|Свойство |Объяснение  |
|---------|---------|
|Состояние подготовки (provisioningState)  |Свойство только для чтения, которое содержит текущее состояние подготовки для службы закрытых ссылок. Применимые состояния подготовки: Саму Ошибок Успешно Идет обновление ". Если состояние подготовки — "успешно", вы успешно подготовили службу частной связи.        |
...
Псевдоним состоит из трех частей: *Префикс*. *Идентификатор GUID*. *Суффикс*
...
Полный псевдоним:  *Префикс*. {GUID}. *регион*. Azure. привателинксервице  
