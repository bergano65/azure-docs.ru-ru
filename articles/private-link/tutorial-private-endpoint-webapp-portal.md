...
2. На странице **Создание веб-приложения** на вкладке **Основные сведения** укажите следующее.
    ...
    | План Windows (Восточная часть США) | Выберите **Создать** . </br> Введите **myServicePlan** в поле **Имя** . |
...
10. Убедитесь, что вы получили страницу  **403** . Эта страница указывает, что веб-приложение недоступно извне.
    ...
    :::image type="content" source="./media/tutorial-private-endpoint-webapp-portal/web-app-ext-403.png" alt-text="Вкладка &quot;Основные сведения&quot; для создания веб-приложения на портале Azure." border="true":::
...
13. Убедитесь, что вы получили страницу веб-приложения по умолчанию.
    ...
    :::image type="content" source="./media/tutorial-private-endpoint-webapp-portal/web-app-default-page.png" alt-text="Вкладка &quot;Основные сведения&quot; для создания веб-приложения на портале Azure." border="true":::
