...
ms.locfileid: "91849016"
---
# <a name="connect-privately-to-an-azure-cosmos-account-using-azure-private-link"></a>Частное подключение к учетной записи Azure Cosmos с помощью Приватного канала Azure
...
Из этой статьи вы узнаете, как создать виртуальную машину в виртуальной сети Azure и учетную запись Azure Cosmos с частной конечной точкой Azure, используя портал Azure. Затем вы сможете безопасно обращаться к этой учетной записи Azure Cosmos с этой виртуальной машины.
...
1. Чтобы включить IP-адрес и сопоставление DNS, войдите в виртуальную машину *myVM*, откройте `c:\Windows\System32\Drivers\etc\hosts` файл и добавьте данные DNS из предыдущего шага в следующем формате:
