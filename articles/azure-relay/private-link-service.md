...
ms.locfileid: "98134387"
---
# <a name="integrate-azure-relay-with-azure-private-link"></a>Интеграция Azure Relay с помощью частной ссылки Azure 
...
Чтобы интегрировать пространство имен Azure Relay с частной ссылкой Azure, вам потребуются следующие сущности или разрешения:
...
13. Вернитесь на страницу **сети** **пространства имен** и перейдите на вкладку **подключения к частной конечной точке** . Вы должны увидеть созданную закрытую конечную точку. 
...
- Сведения о ценах см. на [странице цен на частную связь Azure](https://azure.microsoft.com/pricing/details/private-link/).
