...
Стандарт защиты от атак DDoS предназначен для [служб, развернутых в виртуальной сети](https://docs.microsoft.com/azure/virtual-network/virtual-network-for-azure-services). Для остальных служб применяется "Защита от атак DDoS" уровня "Базовый". Дополнительные сведения о поддерживаемых архитектурах см. в разделе [эталонные архитектуры защиты от атак DDoS](https://docs.microsoft.com/azure/ddos-protection/ddos-protection-reference-architectures). 
