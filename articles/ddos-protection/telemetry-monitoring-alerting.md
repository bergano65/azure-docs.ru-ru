---
title: Просмотр и настройка телеметрии защиты от атак DDoS
...
ms.locfileid: "92905688"
---
# <a name="view-and-configure-ddos-protection-telemetry"></a>Просмотр и настройка телеметрии защиты от атак DDoS
...
Чтобы имитировать атаки DDoS для проверки телеметрии, ознакомьтесь с разделом [Проверка обнаружения атак DDoS](test-through-simulations.md).
...
> [Настройка отчетов по предотвращению атак от атак DDoS и журналов потоков](reports-and-flow-logs.md)