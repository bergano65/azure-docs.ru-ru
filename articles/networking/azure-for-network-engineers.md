...
Вы можете фильтровать сетевой трафик между ресурсами в виртуальной сети с помощью групп безопасности сети. Вы карамели также использовать виртуальные сетевые устройства (NVA), такие как брандмауэр Azure или брандмауэры от других поставщиков. Кроме того, можно контролировать, как Azure маршрутизирует трафик из подсетей. Вы также можете ограничить количество сотрудников организации, которые могут работать с ресурсами в виртуальных сетях.
