...
- **DNS A Record** — Записи — это указатели, которые указывают домен на адрес IPv4. 
...
В пределах этой зоны создайте три записи (например, www\.contoso.com, prod.contoso.com и dr.consoto.com), как показано ниже.
...
В течение 30 минут, в течение которых большинство решателей обновят файл кэшированной зоны, любой запрос на www contoso.com\.будет перенаправлен на dr.contoso.com.
...
*Рисунок - Создание профиля менеджера трафика*
...
- Узнайте больше о [Azure DNS](../dns/dns-overview.md).
