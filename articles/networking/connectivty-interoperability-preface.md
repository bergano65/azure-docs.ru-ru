...
-   **Azure ExpressRoute**. Частный пиринг Azure ExpressRoute позволяет напрямую подключать пространство частных IP-адресов локальной сети к развертываниям виртуальной сети Azure. С помощью ExpressRoute вы можете повысить пропускную способность и сделать подключение частным. Многие партнеры, работающие в экосистеме ExpressRoute, предоставляют подключения ExpressRoute с поддержкой соглашений об уровне обслуживания. Дополнительные сведения о ExpressRoute и о настройке ExpressRoute см. в статье [Введение в expressroute][ExpressRoute].
-   **VPN типа "сеть — сеть"** . С помощью VPN-шлюза Azure типа "сеть — сеть" вы можете безопасно подключить локальную сеть к Azure через Интернет или с помощью ExpressRoute. Чтобы узнать, как настроить VPN-подключение типа "сеть — сеть" для подключения к Azure, см. раздел [Настройка VPN-шлюза][VPN].
-   **Пиринг виртуальных сетей**. С помощью пиринга виртуальной сети можно установить подключение между виртуальными сетями в Azure. Дополнительные сведения об пиринга виртуальных сетей см. в [руководстве по пирингу][VNet]виртуальных сетей.
...
Сведения о [конфигурации][Configuration] для топологии тестирования.
