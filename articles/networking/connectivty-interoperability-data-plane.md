...
В этой статье описывается анализ плоскости данных для [настройки теста][Setup]. Вы также можете ознакомиться с [конфигурацией настройки тестирования][Configuration] и [анализом плоскости управления][Control-Analysis] для настройки теста.
...
Как мы поговорим в разделе [анализ плоскости управления][Control-Analysis], локальное расположение 1 не имеет представления о локальном расположении 2 в конфигурации сети. Результаты следующей команды проверки связи подтверждают это: 
...
Как мы поговорим в разделе [анализ плоскости управления][Control-Analysis], локальное расположение 1 не имеет представления о виртуальной сети филиала, локальном расположении 1 или удаленной виртуальной сети в конфигурации сети. 
...
Как мы поговорим в разделе [анализ плоскости управления][Control-Analysis], удаленная виртуальная сеть не имеет возможности видеть виртуальную сеть филиала или локальное расположение 2 в конфигурации сети. 
