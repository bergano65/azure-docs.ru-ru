...
description: Узнайте о сетевых службах в Azure, включая службы подключения, службы защиты приложений, службы доставки приложений и мониторинг сети.
services: networking
...
Azure DNS представляет собой службу размещения доменов DNS, которая обеспечивает разрешение имен с помощью инфраструктуры Microsoft Azure. Размещая домены в Azure, вы можете управлять своими записями DNS с помощью тех же учетных данных, API и инструментов и оплачивать использование, как и другие службы Azure. Дополнительные сведения см. в разделе [что такое Azure DNS?](../dns/dns-overview.md).
...
[Приватный канал](#privatelink)|Обеспечивает доступ к службам Azure PaaS (например, службе хранилища Azure и базе данных SQL), а также службам, принадлежащим клиентам, и партнерам, размещенным в частной конечной точке в виртуальной сети.|<p>[Создание частной конечной точки](../private-link/create-private-endpoint-portal.md)</p><p>[Создание службы частной связи](../private-link/create-private-link-service-portal.md)</p>|
|||
