...
- **Azure PowerShell**. Программы командной строки для управления Azure на компьютерах Windows. Дополнительные сведения об Azure PowerShell см. в [этой статье](/powershell/azure/overview?toc=%2fazure%2fnetworking%2ftoc.json).
