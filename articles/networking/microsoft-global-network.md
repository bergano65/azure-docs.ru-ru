...
ms.locfileid: "91398395"
---
# <a name="microsoft-global-network"></a>Глобальная сеть Майкрософт

Корпорация Майкрософт владеет одной из самых крупных магистральных сетей в мире. Эта глобальная и сложная архитектура, охватывающая более 160 000 километров, соединяет наши центры обработки данных и клиентов. 
