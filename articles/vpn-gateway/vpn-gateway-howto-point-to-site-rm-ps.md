...
## <a name="declare"></a>1. вход и задание переменных
...
## <a name="Certificates"></a>5. Создание сертификатов
...
### <a name="cer"></a>1. получите CER файл для корневого сертификата.
...
## <a name="upload"></a>6. Отправка сведений о открытом ключе корневого сертификата
