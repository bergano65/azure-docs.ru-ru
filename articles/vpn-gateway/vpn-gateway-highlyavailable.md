...
![На схеме показан локальный сайт с частными подсетями I P и локальная версия P N, подключенная к активному шлюзу Azure V P N для подключения к подсетям, размещенным в Azure, с доступным резервным шлюзом.](./media/vpn-gateway-highlyavailable/active-standby.png)
...
![На схеме показан локальный сайт с частными подсетями I P и локальная версия P N, подключенная к двум активным шлюзам Azure V P N для подключения к подсетям, размещенным в Azure.](./media/vpn-gateway-highlyavailable/active-active.png)
...
![На схеме показаны два региона Azure, в которых размещаются частные подсети I P и два шлюза Azure V P N, с помощью которых соединяются два виртуальных сайта.](./media/vpn-gateway-highlyavailable/vnet-to-vnet.png)
