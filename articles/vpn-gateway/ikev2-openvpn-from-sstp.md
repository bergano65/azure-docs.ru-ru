...
После настройки шлюза существующие клиенты не смогут подключиться, пока не будут [развернуты и настроены клиенты опенвпн](./vpn-gateway-howto-openvpn-clients.md).

Если вы используете Windows 10, вы также можете использовать [VPN-клиент Azure для Windows](./openvpn-azure-ad-client.md#to-download-the-azure-vpn-client) .
