...
## <a name="1-set-the-variables"></a><a name="signin"></a>1. Установите переменные
...
## <a name="2-create-the-resource-group-vnet-and-public-ip-address"></a>2. <a name="vnet"> </a>Создание группы ресурсов, VNet и общественного IP-адреса
...
* VPN шлюз может занять до 45 минут, в зависимости от [шлюза SKU](vpn-gateway-about-vpn-gateway-settings.md#gwsku) вы выбираете.
...
## <a name="5-add-the-radius-server-and-client-address-pool"></a>5. <a name="addradius"> </a>Добавьте сервер RADIUS и пул адресов клиентов
...
## <a name="6-download-the-vpn-client-configuration-package-and-set-up-the-vpn-client"></a>6. <a name="vpnclient"> </a>Скачать пакет конфигурации VPN клиента и настроить VPN-клиент
