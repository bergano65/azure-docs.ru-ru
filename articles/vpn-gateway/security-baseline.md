...
- [Создание VPN-шлюза на основе маршрутов с помощью портала Azure](./tutorial-create-gateway-portal.md)
...
- [Azure CLI VPN-шлюза](/cli/azure/network/vnet-gateway?view=azure-cli-latest)
...
- [Пример политики Azure. встроенные надстройки для виртуальной сети](../virtual-network/policy-reference.md)
