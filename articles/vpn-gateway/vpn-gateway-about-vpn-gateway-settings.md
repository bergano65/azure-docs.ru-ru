...
description: Сведения о конфигурации подключения VPN-шлюза в Azure, который зависит от нескольких ресурсов, каждый из которых содержит настраиваемые параметры.
