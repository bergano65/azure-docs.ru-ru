---
title: Установка подключения "точка — сеть" между компьютером и виртуальной сетью Azure с использованием собственной аутентификации Azure на основе сертификата и Портал Azure | Документация Майкрософт
