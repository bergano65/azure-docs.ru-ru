---
title: Подключитесь к виртуальной сети Azure с компьютера, используя VPN типа "точка — сеть" и собственную аутентификацию Azure Certificate. портал Azure | Документация Майкрософт
...
ms.locfileid: "71266579"
---
# <a name="configure-a-point-to-site-vpn-connection-to-a-vnet-using-native-azure-certificate-authentication-azure-portal"></a>Настройка VPN-подключения типа "точка — сеть" к виртуальной сети с помощью собственной проверки подлинности на основе сертификата Azure. портала Azure
...
## <a name="generatecert"></a>3. Создайте сертификаты.
