---
title: 'Подключение к виртуальной сети Azure с компьютера с помощью VPN типа "точка — сеть" и встроенной аутентификации Azure Certificate: портал Azure | Документация Майкрософт'
