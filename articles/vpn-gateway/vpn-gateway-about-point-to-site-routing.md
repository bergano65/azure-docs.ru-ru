---
title: 'Azure VPN Gateway: О p2S-разгроме'
...
![изолированная routing VNet](./media/vpn-gateway-about-point-to-site-routing/1.jpg "изолированная routing VNet")
...
В этом примере подключение VPN-шлюза типа "точка — сеть" предназначено для VNet1. VNet1 участвует в пиринге с VNet2. VNet2 участвует в пиринге с VNet3. VNet1 участвует в пиринге с VNet4. Прямой пиринг между VNet1 и VNet3 отсутствует. VNet1 имеет "Разрешить шлюз транзита" и VNet2 и VNet4 имеют "Использовать удаленные шлюзы" включен.
...
![несколько заглянул VNets](./media/vpn-gateway-about-point-to-site-routing/2.jpg "несколько заглянул VNets")
...
![несколько VNets и S2S](./media/vpn-gateway-about-point-to-site-routing/3.jpg "несколько VNets и S2S")
...
![несколько VNets и S2S (BGP)](./media/vpn-gateway-about-point-to-site-routing/4.jpg "несколько VNets и S2S BGP")
...
![разгром с помощью VNet и филиала](./media/vpn-gateway-about-point-to-site-routing/5.jpg "разгром с помощью VNet и филиала")
...
![один VNet и филиал (BGP)](./media/vpn-gateway-about-point-to-site-routing/6.jpg "один VNet и филиал")
...
![multi-VNet S2S и филиал](./media/vpn-gateway-about-point-to-site-routing/7.jpg "multi-VNet S2S и филиал")
...
![multi-VNet S2S и филиал](./media/vpn-gateway-about-point-to-site-routing/8.jpg "multi-VNet S2S и филиал")
