...
Например, политики IKEv2 в основном режиме для VPN-шлюзов Azure используют только Diffie-Hellman группу 2 (1024 бит), в то время как может потребоваться указать более надежные группы для использования в IKE, такие как группа 14 (2048-бит), Группа 24 (2048-bit MODP (бит Group) или ECP (группы на эллиптических кривых) 256 или 384 bit (Группа 19 и Группа 20 соответственно). Аналогичные требования также применяются к политикам быстрого режима IPsec.
