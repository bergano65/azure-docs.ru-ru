...
На этом шаге вы создадите две классические виртуальные сети. Если вы используете эту статью в качестве упражнения, можно воспользоваться следующими примерами значений.
