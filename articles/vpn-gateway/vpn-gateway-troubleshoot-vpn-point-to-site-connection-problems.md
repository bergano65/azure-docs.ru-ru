...
## <a name="the-network-connection-between-your-computer-and-the-vpn-server-could-not-be-established-because-the-remote-server-is-not-responding"></a>Не удалось установить сетевое подключение между компьютером и VPN-сервером, так как удаленный сервер не отвечает
...
## <a name="vpn-package-installer-doesnt-complete"></a>Установщик пакета VPN не завершен
