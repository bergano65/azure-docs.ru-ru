...
## <a name="tenant"></a>1. Проверка клиента Azure AD
...
9. Включите проверку подлинности Azure AD на VPN-шлюзе, выполнив следующие команды, и вы обязательно измените команду, чтобы она отражала собственную среду:
   ...
   > [!NOTE]
   > Убедитесь, что в конце значения `AadIssuerUri` указана завершающая косая черта. В противном случае команда завершится ошибкой.
