...
> * [Microsoft Azure](vpn-gateway-connect-different-deployment-models-portal.md)
...
2. Щелкните **шлюз** в разделе **Параметры** меню, а затем щелкните баннер, чтобы создать шлюз.
  ![Настройка VPN-шлюза](./media/vpn-gateway-connect-different-deployment-models-portal/gatewaygraphic.png "Cподключение VPN-шлюза)
...
### <a name="ip"></a>4. Скопируйте общедоступный IP-адрес шлюза виртуальной сети.
...
### <a name="createlng"></a>3. Создание шлюза локальной сети
