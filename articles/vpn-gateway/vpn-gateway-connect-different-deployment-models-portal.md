---
title: Подключение классических виртуальных сетей к виртуальным сетям Azure Resource Manager с помощью портала | Документация Майкрософт
...
При создании виртуальной сети на портале Azure полное имя, которое используется Azure, не отображается на портале. Например, если виртуальная сеть отображается на портале Azure с именем ClassicVNet, то в файле конфигурации сети она может иметь гораздо более длинное имя. Это имя будет иметь следующий вид: Group ClassicRG ClassicVNet. На этих шагах вы скачаете файл конфигурации сети и просмотрите значения в нем.
