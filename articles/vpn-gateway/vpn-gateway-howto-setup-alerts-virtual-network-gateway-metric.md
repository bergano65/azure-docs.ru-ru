...
|---       | ---        | ---       | ---            | ---       |
|**AverageBandwidth**| байтов/с  | 5 минут| Среднее использование пропускной способности объединенных всех подключений сайт сайт, на шлюзе.     |
...
|**TunnelAverageBandwidth** | байтов/с    | 5 минут  | Среднее использование пропускной способности туннелей, созданы на шлюзе. |
|**TunnelEgressBytes** | Байт | 5 минут | Передачу исходящего трафика через туннели, созданы на шлюзе.   |
|**TunnelEgressPackets** | Количество | 5 минут | Количество исходящих пакетов в туннелях, созданы на шлюзе.   |
|**TunnelEgressPacketDropTSMismatch** | Количество | 5 минут | Количество исходящих пакетов удален туннелей, из-за несоответствия селектора трафика. |
|**TunnelIngressBytes** | Байт | 5 минут | Трафик, поступающий на туннелей, созданы на шлюзе.   |
|**TunnelIngressPackets** | Количество | 5 минут | Число входящих пакетов в туннелях, созданы на шлюзе.   |
|**TunnelIngressPacketDropTSMismatch** | Количество | 5 минут | Число входящих пакетов, отброшенных в туннелях, из-за несоответствия селектора трафика. |
...
- **Окно:** 5 минут
- **Действие оповещения:** Адрес эл. почты
