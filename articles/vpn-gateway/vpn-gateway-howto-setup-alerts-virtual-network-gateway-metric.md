...
|**TunnelEgressPackets** | Счетчик | 5 минут | Число исходящих пакетов в туннелях, созданных на шлюзе.   |
|**TunnelEgressPacketDropTSMismatch** | Счетчик | 5 минут | Число исходящих пакетов, отбрасываемых в туннелях, вызванных несоответствием селектора трафика. |
|**TunnelIngressBytes** | Байты | 5 минут | Входящий трафик по туннелям, созданным на шлюзе.   |
|**TunnelIngressPackets** | Счетчик | 5 минут | Число входящих пакетов на туннели, созданных на шлюзе.   |
|**TunnelIngressPacketDropTSMismatch** | Счетчик | 5 минут | Число входящих пакетов, отбрасываемых в туннелях, вызванных несоответствием селектора трафика. |
...
4. Настройте логику сигнала. Существует три компонента:
    ...
    Б. **Условие**: это операция для вычисления значения метрики.
