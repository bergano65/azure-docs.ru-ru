...
1. Удалите шлюз:
1. [портале Azure](vpn-gateway-delete-vnet-gateway-portal.md)
1. [Azure PowerShell](vpn-gateway-delete-vnet-gateway-powershell.md)
1. [Azure Powershell — Классическая модель](vpn-gateway-delete-vnet-gateway-classic-powershell.md)
1. [Создать новый шлюз нужного типа и завершить настройку VPN](vpn-gateway-howto-site-to-site-resource-manager-portal.md#VNetGateway)
