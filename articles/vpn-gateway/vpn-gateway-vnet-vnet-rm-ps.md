---
title: Настройка подключения "виртуальная сеть — виртуальная сеть" между виртуальными сетями Azure с помощью PowerShell | Документация Майкрософт
