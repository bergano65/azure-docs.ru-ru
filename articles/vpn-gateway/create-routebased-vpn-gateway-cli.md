...
description: Узнайте, как создать VPN-шлюз Azure на основе маршрутов с помощью Azure CLI. Используйте VPN-шлюз для подключения к локальной сети.
