...
1. Войдите на портал [Azure](http://portal.azure.com) и выберите **Создать ресурс**. Откроется страница **Новый**. 

2. В поле **Поиск в Marketplace** введите *виртуальная сеть* и выберите **Виртуальная сеть** в полученном списке. Откроется страница **Виртуальная сеть**.
...
В Azure можно добавить до 20 CER-файлов доверенных корневых сертификатов. Инструкции см. в разделе [Отправка CER-файла корневого сертификата](#upload-the-root-certificate-.cer-file).
