...
1. В меню [портала Microsoft Azure](https://portal.azure.com) или на **домашней** странице выберите **Создать ресурс**. Откроется страница **создания**.
