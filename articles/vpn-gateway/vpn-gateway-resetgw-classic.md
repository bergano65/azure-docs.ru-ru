---
title: Сброс VPN-шлюза Azure для повторного создания туннеля IPsec
description: Сбросьте свой VPN-шлюз Azure для повторного создания туннелей IPsec для VPN-шлюзов в классической модели развертывания и диспетчер ресурсов.
...
Сбросить настройки VPN-шлюза Resource Manager можно на портале Azure. Если вы хотите сбросить классический шлюз, см. шаги PowerShell для [классической модели развертывания](#resetclassic).
...
## <a name="azure-cli"></a><a name="cli"></a>Интерфейс командной строки Azure
