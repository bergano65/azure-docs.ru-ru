---
title: 'Подключение к виртуальной сети: Сайт-к-сайт VPN: CLI'
...
## <a name="2-create-a-resource-group"></a><a name="rg"></a>2. Создание ресурсной группы
...
## <a name="5-create-the-local-network-gateway"></a><a name="localnet"></a>5. Создание локального сетевого шлюза
...
* *--шлюз-IP-адрес* является IP-адресом вашего собственного VPN-устройства.
...
## <a name="6-request-a-public-ip-address"></a><a name="PublicIP"></a>6. Запросить публичный IP-адрес
...
* *Тип шлюза* для конфигурации Сайта к сайту *—* vpn. Тип шлюза всегда зависит от реализуемой конфигурации. Для получения дополнительной информации [см.](vpn-gateway-about-vpn-gateway-settings.md#gwtype)
...
* Выберите SKU шлюза, который нужно использовать. К определенным номерам SKU применяются ограничения настройки. Для получения дополнительной информации [см.](vpn-gateway-about-vpn-gateway-settings.md#gwsku)
...
## <a name="9-create-the-vpn-connection"></a><a name="CreateConnection"></a>9. Создание VPN-соединения
...
## <a name="10-verify-the-vpn-connection"></a><a name="toverify"></a>10. Проверить подключение VPN
...
* Для получения информации о принудительном туннеле, [см.](vpn-gateway-forced-tunneling-rm.md)
