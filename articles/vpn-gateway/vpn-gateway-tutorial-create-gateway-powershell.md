...
description: Из этого учебника вы узнаете, как создать, развернуть VPN-шлюз Azure и обеспечить управление им с помощью PowerShell.
...
:::image type="content" source="./media/vpn-gateway-tutorial-create-gateway-powershell/diagram.png" alt-text="Схема виртуальной сети и VPN-шлюза":::
...
> * [Создание подключения "сеть — сеть"](vpn-gateway-create-site-to-site-rm-powershell.md)