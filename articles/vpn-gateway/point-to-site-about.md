...
* **OpenVPN® протокол**, протокол VPN на основе SSL/TLS. Решение TLS VPN может проникать в брандмауэры, так как большинство брандмауэров открывают порт TCP 443, который использует TLS. OpenVPN можно использовать для подключения с Android, iOS (версии 11.0 и выше), Windows, Linux и Mac (версии OSX 10.13 и выше).

* Secure Socket Tunneling Protocol (SSTP), собственный VPN-протокол на основе TLS. Решение TLS VPN может проникать в брандмауэры, так как большинство брандмауэров открывают порт TCP 443, который использует TLS. Протокол SSTP поддерживается только на устройствах Windows. Azure поддерживает все версии Windows с протоколом SSTP (Windows 7 и более поздние версии).
