...
### <a name="deployment-model"></a><a name="models"></a>Модель развертывания
...
## <a name="connection-topology-diagrams"></a><a name="diagrams"></a>Схемы топологий подключения
...
## <a name="site-to-site-and-multi-site-ipsecike-vpn-tunnel"></a><a name="s2smulti"></a>Подключение типа "сеть — сеть" и многосайтовое подключение (через VPN-туннель IPsec/IKE)

### <a name="site-to-site"></a><a name="S2S"></a>Подключение типа "сеть — сеть"
...
### <a name="multi-site"></a><a name="Multi"></a>Многосайтовые подключения
