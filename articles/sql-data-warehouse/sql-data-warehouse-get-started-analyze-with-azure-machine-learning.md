...
* Пул SQL, предварительно загруженный с образцом данных AdventureWorksDW. Чтобы выполнить эту команду, см. статью [Создание пула SQL](create-data-warehouse-portal.md) и загрузка демонстрационных данных. Если хранилище данных уже существует, но не содержит демонстрационные данные, вы можете [загрузить их вручную](sql-data-warehouse-load-sample-databases.md).
