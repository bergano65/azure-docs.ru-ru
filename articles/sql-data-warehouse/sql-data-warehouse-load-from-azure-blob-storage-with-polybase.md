---
title: Загрузка данных Contoso Retail в хранилище данных аналитики SQL
...
Теперь, когда вы указали источник данных и формат файла, можно приступать к созданию внешних таблиц. 
