...
> [!NOTE]
> Перенос данных из хранилища 1-го поколения в хранилище 2-го поколения на портале Azure необратим. Возвращение к использованию хранилища 1-го поколения не предусмотрено.  
