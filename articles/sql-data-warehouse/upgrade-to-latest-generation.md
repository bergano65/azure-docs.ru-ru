...
2. Выберите **Обновить до Gen2 на** вкладке задачи: ![Upgrade_1](./media/sql-data-warehouse-upgrade-to-latest-generation/Upgrade_to_Gen2_1.png)
