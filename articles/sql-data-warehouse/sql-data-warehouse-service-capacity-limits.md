...
| Категория | Description | Максимальная |
|:--- |:--- |:--- |
...
| Таблица |Количество байт в столбце |Зависит от [типа данных](sql-data-warehouse-tables-data-types.md) столбца. Для символьных типов данных максимальное ограничение может хранить до 2 ГБ в хранилище на странице (переполнение строки).  Символы не в Юникоде, такие как ограничение char или varchar, — 8000 на странице данных, символы Юникода, такие как ограничение типа nchar или nvarchar, — это 4000 на странице данных.  Используйте размеры хранилища страниц данных для повышения производительности. |
