...
| Таблица |Максимальный размер | Для таблиц columnstore ограничение упппер отсутствует. <br/><br/>Для таблиц хранилища строк, сжатых на диске 60 ТБ |
