---
title: Ограничения емкости — Azure синапсе Analytics (ранее — хранилище данных SQL) | Документация Майкрософт
