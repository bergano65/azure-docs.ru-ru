...
- Если хранилище данных только создается, начните с небольшого количества единиц использования хранилища данных.  Хорошей отправной точкой является DW400c или DW200c.
