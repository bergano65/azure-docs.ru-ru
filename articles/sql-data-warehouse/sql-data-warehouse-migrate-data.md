...
Дополнительные сведения о том, как использовать ADF для загрузки данных в хранилище данных, см. в [этом руководстве]( /articles/data-factory/load-azure-sql-data-warehouse.md).
