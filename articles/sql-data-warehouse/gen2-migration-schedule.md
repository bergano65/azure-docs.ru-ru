...
| **Регион** | **Доступные нижней Gen2** | **Начать автоматическое обновление** |
|:--- |:--- |:--- |
| Восточная часть Австралии |Доступна |1 июня 2019 г. |
| Юго-Восточная часть Австралии |2 апреля 2019 г. |1 мая 2019 г. |
| Южная часть Бразилии |15 мая 2019 г. |\* |
...
| Восток США 2 |Доступна |1 июня. 2019 |
| Центральная Франция |\* |\* |
...
| Южная Индия |2 апреля 2019 г. |1 июня 2019 г. |
| Восточная часть Японии |Доступна |1 июня 2019 г. |
| Западная часть Японии |Доступна |1 мая 2019 г. |
| Центральная Корея |2 апреля 2019 г. |1 июня 2019 г. |
| Южная Корея |2 апреля 2019 г. |1 мая 2019 г. |
| Центрально-северная часть США |2 апреля 2019 г. |1 мая 2019 г. |
...
| Южная часть Великобритании |2 апреля 2019 г. |1 июня 2019 г. |
...
| Запад США |2 апреля 2019 г. |1 июня 2019 г. |
...
**Вопрос. 2-го поколения стоит так же, как Gen1?**
...
**Вопрос. Сколько самостоятельно обновить обычно времени занимает?**
...
**Вопрос. Сколько времени потребуется автоматическое обновление?**
...
**Вопрос. При этом автоматическое обновление будет иметь место?**
...
**Вопрос. Что делать, если мой фоновый процесс обновления "зависнуть"?**
...
**Вопрос. Что делать, если поколения 2 не поддерживает уровень обслуживания у меня есть в поколение 1?**
...
**Вопрос. Могу ли я отключить геоархивации**
...
**Вопрос. Есть ли отличия в синтаксисе T-SQL между Gen1 и Gen2?**

- Ответ. Различия в синтаксисе языка T-SQL между поколением 1 и 2 отсутствуют.

**Вопрос. 2-го поколения поддерживает обслуживание Windows?**

- Ответ. Да.

**Вопрос. Я смогу создать новый экземпляр Gen1, после обновления моем регионе?**
...
- [Монитор работоспособности ресурсов](https://docs.microsoft.com/azure/service-health/resource-health-overview)
- [Изучите перед началом миграции](upgrade-to-latest-generation.md#before-you-begin)
- [Обновление на месте и обновления из точки восстановления](upgrade-to-latest-generation.md)
- [Создание определенной пользователем точки восстановления](sql-data-warehouse-restore.md#restore-through-the-azure-portal)
- [Сведения о восстановлении на уровень Gen2](sql-data-warehouse-restore.md#restore-an-active-or-paused-database-using-the-azure-portal)
- [Откройте запрос в службу поддержки хранилища данных SQL](https://go.microsoft.com/fwlink/?linkid=857950)
