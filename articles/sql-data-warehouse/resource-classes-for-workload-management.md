...
Выделение памяти для каждого класса ресурсов осуществляется следующим образом независимо от **уровня обслуживания**.  Также приводится список минимальных запросов параллелизма.  Для некоторых уровней обслуживания может быть достигнуто больше минимального параллелизма.
...
1. @DWU: либо предоставьте параметр NULL для извлечения текущего DWU из базы данных DW, либо укажите любой поддерживаемый DWU в форме "DW100c".
