...
description: Уменьшите требования к памяти или увеличьте объем доступной памяти, чтобы максимально увеличить количество строк в каждой группы строк.
...
- 72 МБ +
- \#строк \* \#столбцы \* 8 байт +
- \#строк \* \#коротких столбцов \* 32 байт +
...
Подробные сведения о требованиях к памяти columnstore см. в видеоролике [масштабирование SQL Analytics: Конфигурация и рекомендации](https://channel9.msdn.com/Events/Ignite/2016/BRK3291).
...
Дополнительные способы повышения производительности SQL Analytics см. в статье [Обзор производительности](sql-data-warehouse-overview-manage-user-queries.md).
