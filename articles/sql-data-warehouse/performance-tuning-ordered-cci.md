---
title: Настройка производительности с упорядоченным кластеризованным индексом columnstore
...
OPTION (MAXDOP 1);
```
- Предварительно сортировать данные по ключам сортировки перед их загрузкой в таблицы SQL Analytics.
