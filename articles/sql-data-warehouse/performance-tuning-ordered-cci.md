...
4.  Выполните инструкцию ALTER INDEX < Ordered_CCI_Index > Rebuild PARTITION = < Partition_ID > в таблице B, чтобы перестроить включенный в нее раздел.  
