...
- Хранилище данных масштабируется достаточно часто. Масштабирование хранилища данных изменяет число узлов вычислений, что влечет за собой перестроение реплицированной таблицы.
