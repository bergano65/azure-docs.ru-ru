...
description: Списки партнеров по бизнес-аналитике сторонних производителей с решениями, поддерживающими хранилище данных SQL Azure.
...
| ![IBM Когнос][3] |**IBM Когнос Analytics**<br>Когнос Analytics включает в себя интеллектуальные возможности самообслуживания, которые делают ее простым, понятным и простым в использовании, будь то опыт бизнес-аналитика, изучающий Кинкс в обширной цепочке поставок или вырынке оптимизации одной кампании. Когнос Analytics использует AI и другие интеллектуальные возможности для выполнения задач по исследованию данных и упрощения работы пользователей с целью получения необходимых им ответов.|[Страница продукта][cognosanalytics_website]<br>|
| ![Построители информации][13] |**Построители информации (фокусировка)**<br>Бизнес-аналитика помогает компаниям использовать данные более стратегически в рамках предприятия и за его пределами. Это позволяет пользователям и администраторам быстро создавать панели мониторинга, объединяющие содержимое из нескольких источников и форматов, обеспечивая надежную защиту и комплексное управление, которое обеспечивает бесперебойную и надежную работу с диверли и совместной работой любых бизнес-аналитики и аналитики. содержани|[Страница продукта][informationbuilders_website]<br> |
![Jinfonet][5] |**Жинфонет JReport**<br>JReport — встраиваемое решение бизнес-аналитики для предприятий. Решение позволяет пользователям создавать отчеты, панели мониторинга и выполнять анализ данных в облаке, работать с большими объемами данных и источниками транзакционных данных. Визуализируя данные, вы можете создавать собственные отчеты и исследовать данные для принятия решений на ходу. |[Страница продукта][jinfonet_website]<br> |
...
| ![микростратеги][14] |**микростратеги**<br>Платформа Микростратеги предлагает полный набор возможностей бизнес-аналитики и аналитики, позволяющий организациям получать ценность своих бизнес-данных. Мощная аналитическая система Микростратеги, комплексные наборы инструментов, разнообразные соединители данных и масштабируемая открытая архитектура обеспечивают все необходимое для расширения доступа к аналитикам в каждой команде и бизнес-функции. |[Страница продукта][microstrategy_website]<br> [Azure Marketplace][microstrategy_marketplace]<br> |
...
| ![Targit][11] |**Таргит (набор решений)**<br>Targit Decision Suite — это платформа бизнес-аналитики, которая объединяет актуальные панели мониторинга, аналитику, понятные отчеты, превосходные мобильные возможности и простые технологии работы с данными в одном, связанном решении. Targit дает компаниям мужество для действия. |[Страница продукта][targit_website]<br> [Azure Marketplace][targit_marketplace]<br> |
| ![Yellowfin][12] |**Yellowfin**<br>Yellowfin — это высший рейтинг поставщика облачных бизнес-аналитики для автоматизированной отчетности и панелей мониторинга с помощью BARC; Опрос бизнес-аналитики. Подключитесь к хранилищу данных SQL Azure, создавайте и публикуйте красивые отчеты и панели мониторинга с помощью ведущей бизнес-аналитики и функций анализа. |[Страница продукта][yellowfin_website]<br> [Azure Marketplace][yellowfin_marketplace] |
