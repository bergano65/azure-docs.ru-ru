...
Дополнительные сведения о ценах на хранилище данных SQL см. в разделе [цены на хранилище данных SQL]. При восстановлении между регионами не производится плата за исходящие данные.
