...
5. Если создается моментальный снимок, то пул SQL приостанавливается в течение более 7 дней, после чего возобновляется, что точка восстановления может сохраняться до тех пор, пока не будет 42 общих точек восстановления (включая как пользовательские, так и автоматические).
