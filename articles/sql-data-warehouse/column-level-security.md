...
Так как это видео было опубликовано, значит [безопасность на уровне строк](/sql/relational-databases/security/row-level-security?toc=%2Fazure%2Fsql-data-warehouse%2Ftoc&view=sql-server-2017) стала доступной для Azure синапсе. 
