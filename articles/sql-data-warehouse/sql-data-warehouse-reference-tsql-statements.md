...
* [Создать материализованный вид как SELECT](/sql/t-sql/statements/create-materialized-view-as-select-transact-sql?view=azure-sqldw-latest) (Предварительная версия) 
...
* [DBCC дропресултсеткаче](/sql/t-sql/database-console-commands/dbcc-dropresultsetcache-transact-sql?view=azure-sqldw-latest) (Предварительная версия)
...
* [DBCC шовресулткачеспацеусед](/sql/t-sql/database-console-commands/dbcc-showresultcachespaceused-transact-sql) (Предварительная версия)
