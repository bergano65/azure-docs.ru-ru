...
* [Создание рабочей НАГРУЗКИ КЛАССИФИКАТОРА](/sql/t-sql/statements/create-workload-classifier-transact-sql) (Предварительная версия)
...
* [КЛАССИФИКАТОР рабочей НАГРУЗКИ DROP](/sql/t-sql/statements/drop-workload-classifier-transact-sql) (Предварительная версия)
