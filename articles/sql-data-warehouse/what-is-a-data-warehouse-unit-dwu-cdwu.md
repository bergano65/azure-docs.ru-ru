...
По мере увеличения единиц использования хранилища данных вы линейно увеличивайте количество вычислительных ресурсов. 2-го поколения обеспечивает наилучшую производительность запросов и максимальном масштабе. Кэш максимально используется системами на основе этого уровня.
