...
description: Основные рекомендации по использованию временных таблиц в хранилище данных SQL Azure, в которых выделяются принципы временных таблиц уровня сеанса.
