...
Хранилище данных SQL реализует транзакции ACID. Уровень изоляции транзакционной поддержки по умолчанию равен READ UNCOMMITTED.  Его можно изменить на режим изоляции МОМЕНТАЛЬного СНИМКа COMMITTED, включив параметр READ_COMMITTED_SNAPSHOT Database для пользовательской базы данных при подключении к базе данных master.  После включения все транзакции в этой базе данных выполняются в режиме изоляции МОМЕНТАЛЬных снимков READ COMMITTED и настройка незафиксированного чтения на уровне сеанса не будет учитываться. Дополнительные сведения см. в [параметрах ALTER DATABASE SET (Transact-SQL)](https://docs.microsoft.com/sql/t-sql/statements/alter-database-transact-sql-set-options?view=azure-sqldw-latest) .
