---
title: 'Краткое руководство. Приостановка и возобновление вычислений с помощью портала Azure '
...
ms.locfileid: "78200654"
---
# <a name="quickstart-pause-and-resume-compute-in-azure-synapse-analytics-sql-pool-in-the-azure-portal"></a>Краткое руководство. Приостановка и возобновление вычислений в пуле SQL Azure Synapse Analytics на портале Azure

Используйте портал Azure, чтобы приостановить вычисления для пула SQL и сэкономить. [Возобновите работу вычислительных ресурсов](sql-data-warehouse-manage-compute-overview.md), когда будете готовы к использованию хранилища данных.
...
3. Чтобы удалить созданный вами сервер SQL Server, щелкните **sqlpoolservername.database.windows.net**, а затем нажмите кнопку **Удалить**.  Будьте внимательны, так как удаление сервера приведет к удалению всех баз данных, назначенных этому серверу.
...
Вы приостановили и возобновили вычисления для пула SQL. Дальнейшие шаги приведены в учебнике по загрузке данных.
