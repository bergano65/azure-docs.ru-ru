---
title: Непрерывная интеграция и развертывание | Документация Майкрософт
...
2. Выберите репозиторий исходного кода (Azure Repos Git) и шаблон классического приложения .NET.
      ...
      ![Настройка конвейера](media/sql-data-warehouse-continuous-integration-and-deployment/2-pipeline-setup.png "Настройка конвейера") 
