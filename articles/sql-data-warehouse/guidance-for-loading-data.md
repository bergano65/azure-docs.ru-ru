...
Чтобы запускать загрузки в соответствующих вычислительных ресурсах, создайте пользователей, назначенных для выполнения загрузок. Назначьте каждому пользователю, выполняющему загрузку, конкретный ресурс класса. Чтобы выполнить загрузку, войдите как один из таких пользователей и запустите загрузку. Загрузка выполняется с помощью класса ресурсов пользователя.  Использовать этот метод проще, чем пытаться изменить класс ресурсов пользователя в соответствии с текущими потребностями.
...
Чтобы выполнить загрузку с ресурсами для классов ресурсов staticRC20, войдите в систему как пользователь LoaderRC20 и запустите загрузку.
