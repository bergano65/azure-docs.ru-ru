---
title: Поддержка матрицы-Hyper-V аварийного восстановления на вторичном сайте VMM с Azure восстановление сайта
...
В этой статье кратко излагается то, что поддерживается при использовании службы [восстановления сайта Azure](site-recovery-overview.md) для воспроизведения Hyper-V VMs, управляемых в облаках виртуального машинного управления (VMM) System Center на второстепенный сайт. Если нужно реплицировать виртуальные машины Hyper-V в Azure, ознакомьтесь с [этой таблицей поддержки](hyper-v-azure-support-matrix.md).
