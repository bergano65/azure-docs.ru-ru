...
> [!NOTE]
> Если вы уже выполнили отработку отказа виртуальной Машины, и он выполняется в Azure, обратите внимание, что отключение защиты не удаление / влияют на отработке отказа виртуальной Машины.
