---
title: Настройка аварийного восстановления в Azure для физических локальных серверов с Azure Site Recovery
...
5. Скачайте ключ регистрации в хранилище. Он потребуется при запуске единой установки. Ключ действителен в течение пяти дней после создания.
...
3. Site Recovery проверяет наличие одной или нескольких совместимых учетных записей хранения и сетей Azure.
   ...
   ![Целевая платформа](./media/physical-azure-disaster-recovery/network-storage.png)
