...
В этом руководстве показано, как выполнять настройку аварийного восстановления локальных физических серверов Windows и Linux в Azure. В этом руководстве вы узнаете, как:
...
После завершения регистрации сервер конфигурации отображается на **Settings**  >  странице**серверы** параметров в хранилище.
...
3. Site Recovery проверяет наличие одной или нескольких совместимых учетных записей хранения и сетей Azure.
   ...
   ![целевого объекта](./media/physical-azure-disaster-recovery/network-storage.png)
...
8. Выберите **настроить сейчас для выбранных компьютеров**, чтобы применить параметр сети ко всем компьютерам, выбранным для защиты. Выберите **Отложить настройку**, чтобы выбрать сеть Azure для каждого компьютера. 
...
12. Щелкните **включить репликацию**. Ход выполнения задания **включения защиты** можно отслеживать, выбрав **Параметры** > **Задания** > **Задания Site Recovery**. После выполнения задания **завершить подготовку защиты** компьютер будет готов к отработке отказа.
