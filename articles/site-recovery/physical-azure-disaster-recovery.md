...
- Ознакомьтесь с [требованиями поддержки ](vmware-physical-secondary-support-matrix.md) для всех компонентов.
...
- Вы можете начать с [бесплатной пробной версии](https://azure.microsoft.com/pricing/free-trial/).
