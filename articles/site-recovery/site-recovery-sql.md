...
1. Создание балансировщика нагрузки. Для каждого прослушивателя группы доступности создайте один IP-адрес из внешнего пула IP-адресов. Также добавьте SQL Server виртуальную машину в пул серверной части.
