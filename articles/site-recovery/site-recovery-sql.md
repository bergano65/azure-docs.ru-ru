...
## <a name="protect-a-sql-server-cluster-standard-editionsql-server-2008-r2"></a>Защита кластера SQL Server (standard edition или SQL Server 2008 R2)
