---
title: Отработка отказа виртуальных машин VMware в Azure с помощью Site Recovery
description: Сведения о настройке отработки отказа виртуальных машин VMware в Azure Site Recovery.
...
2. Подготовьте локальную среду [VMware](vmware-azure-tutorial-prepare-on-premises.md) для аварийного восстановления. 
3. Настройте аварийное восстановление для локальных [виртуальных машин VMware](vmware-azure-tutorial.md).
...
1. Если после отработки отказа вы хотите подключиться к виртуальным машинам Azure по протоколу удаленного рабочего стола (RDP) и Secure Shell (SSH), [убедитесь, что выполнены требования]((ailover-failback-overview.md#connect-to-azure-after-failover).
