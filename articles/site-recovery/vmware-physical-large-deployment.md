...
**Task** | **Дополнительные сведения** | **Действие**
--- | --- | ---
...
- Для компьютеров под Windows можно заранее проверить соответствие требованиям и при необходимости сделать их совместимыми. [Дополнительные сведения](site-recovery-failover-to-azure-troubleshoot.md#failover-failed-with-error-id-170010)
