...
4.  Активируйте отработку отказа с помощью командлета PowerShell [Start-азрековерисервицесасрпланнедфаиловержоб](/powershell/module/az.recoveryservices/start-azrecoveryservicesasrplannedfailoverjob?view=azps-2.0.0&viewFallbackFrom=azps-1.1.0) вместе с планом восстановления.
