...
1. В хранилище щелкните **Реплицированные элементы**, а затем выберите виртуальную машину, которая повторно защищена.
    ...
    ![Снимок экрана с восстановлением размещения на основном ресурсе на портале Azure.](./media/site-recovery-azure-to-azure-failback/azure-to-azure-failback.png)
...
8. Для виртуальной машины должно отобразиться состояние отработки отказа и восстановления размещения.
    ...
    ![Снимок экрана с виртуальной машиной в основном и дополнительном регионах.](./media/site-recovery-azure-to-azure-failback/azure-to-azure-failback-vm-view.png)
