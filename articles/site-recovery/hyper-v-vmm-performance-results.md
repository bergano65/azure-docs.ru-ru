---
title: Тест Hyper-V VM репликации на вторичный сайт с VMM с помощью Azure восстановление сайта
...
| SQL Server (том 1)<br />Сервер S'L (том 2) |8<br />64 |100 %<br />100 % |70 %<br />0% |8<br />8 |100 % случайные<br />100% последовательных |
...
| Операции чтения (IOPS) виртуальной машины в секунду |«Гипер-V Виртуальное\<устройство хранения данных (VHD>)))))-Прочитайте операции/Sec |
| Операции записи (IOPS) виртуальной машины в секунду |«Гипер-V Виртуальное\<устройство хранения данных (VHD>))»Запись операций / S |
| Пропускная способность операций чтения виртуальной машины |«Гипер-V Виртуальное\<устройство хранения данных ( VHD>)) Читать байты/сек |
| Пропускная способность операций записи виртуальной машины |«Гипер-V Виртуальное\<устройство хранения данных ( VHD>)»Напишите байты/сек |
