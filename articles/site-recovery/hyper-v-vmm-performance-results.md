...
* На диаграмме ниже показаны временные затраты на выполнение операций ввода-вывода в секунду для репликации. Мы видим, что временные затраты на выполнение операций ввода-вывода в секунду для репликации составляют приблизительно 5%, что довольно мало.
  ...
  ![Граф, отображающий устойчивое состояние операций ввода-вывода в секунду для репликации.](./media/hyper-v-vmm-performance-results/IC744913.png)
...
![График, отображающий нагрузку на репликацию, находится в диапазоне 2-3%.](./media/hyper-v-vmm-performance-results/IC744915.png)
...
![Граф, который суммирует сведения об использовании памяти на сервере восстановления.](./media/hyper-v-vmm-performance-results/IC744916.png)
...
![Граф, показывающий сравнение операций ввода-вывода на первичном и вторичном сайтах.](./media/hyper-v-vmm-performance-results/IC744917.png)
...
| Сервер | ОЗУ | Моделирование | Процессор | Количество процессоров | Сетевая карта | Программное обеспечение |
| --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- | --- |
| Файловый сервер |4<br />8<br />16<br />32<br />64 |60 %<br />20 %<br />5 %<br />5 %<br />10 % |80 %<br />80 %<br />80 %<br />80 %<br />80 % |8<br />8<br />8<br />8<br />8 |Все 100 % случайные |
| SQL Server (том 1)<br />SQL Server (том 2) |8<br />64 |100 %<br />100 % |70 %<br />0 % |8<br />8 |100 % случайные<br />100% последовательных |
...
| Количество операций ввода-вывода в секунду |\Диск\Физический диск(_общий объем ресурсов) в секунду |
...
[Настройка репликации](hyper-v-vmm-disaster-recovery.md)
