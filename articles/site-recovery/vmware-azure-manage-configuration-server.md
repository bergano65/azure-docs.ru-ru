...
6. При необходимости укажите данные прокси-сервера. Затем щелкните **Регистрация**.
...
3. Скачайте файл установщика обновлений на сервер конфигурации.
    ...
    ![Обновить](./media/vmware-azure-manage-configuration-server/update1.png)
...
6. После завершения обновления будет выполнена проверка сервера конфигурации.
    ...
    ![Обновить](./media/vmware-azure-manage-configuration-server/update3.png)
