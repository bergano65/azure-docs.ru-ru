...
7. Откройте командную строку PowerShell с правами администратора и выполните следующую команду:
   ...
   ```
    ...
    >[!NOTE]
    >Для того, чтобы **вытащить последние сертификаты** с сервера конфигурации на сервер масштабирования, выполните команду *\<" Установка Drive (Установка Drive)Microsoft Azure Site Recovery-agent-cdpcli.exe>" --registermt*
...
1. В хранилище, открыть **настройку инфраструктуры** > сайта**Настройка сервера**. Выберите нужный сервер конфигурации.
