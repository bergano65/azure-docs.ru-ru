...
3. Для виртуальных машин VMware: в качестве источника выберите сервер обработки VMware, в качестве целевого объекта — Microsoft Azure, а в качестве модели развертывания — Resource Manager и щелкните "Выбор элементов".
4. Для виртуальных машин Hyper-V: в качестве источника выберите сервер VMM, в качестве целевого объекта — Microsoft Azure, а в качестве модели развертывания — Resource Manager. Щелкните "Выбор элементов" и выберите развертывание виртуальных машин компонента XenApp.
...
1. Группа отработки отказа 1: DNS-сервер AD.
2. Группа отработки отказа 2: виртуальные машины SQL Server.
2. Группа отработки отказа 3: виртуальная машина с главным образом VDA.
3. Группа отработки отказа 4: контроллер доставки и виртуальные машины сервера StoreFront.
...
1. Группа отработки отказа 1: DNS-сервер AD.
2. Группа отработки отказа 2: виртуальные машины SQL Server.
3. Группа отработки отказа 3: виртуальная машина с главным образом VDA.
...
4. Группа 3. Действие, выполняемое вручную, или действие сценария: Завершение работы виртуальной машины с главным образом VDA.
...
5. Группа отработки отказа 4: контроллер доставки и виртуальные машины сервера StoreFront.
