...
1. У пользователя должна быть роль "разработчик приложения" для создания приложения.
   1. Чтобы проверить, войдите в портал Azure</br>
   1. Перейдите к Azure Active Directory > ролей и администраторов</br>
...
1. Если роль "разработчик приложений" не может быть назначена, убедитесь, что флаг "пользователь может зарегистрировать приложение" имеет значение true, чтобы пользователь мог создать удостоверение. Чтобы включить указанные выше разрешения,
   1. Вход на портал Azure
   1. Перейдите к Azure Active Directory > Параметры пользователя
   1. В разделе * * Регистрация приложений "пользователи могут регистрировать приложения" должны быть выбраны как "Да".
