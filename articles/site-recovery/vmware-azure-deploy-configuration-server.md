...
Чтобы обновить сервер конфигурации до последней версии, выполните эти [инструкции](vmware-azure-manage-configuration-server.md#upgrade-the-configuration-server). Подробные инструкции по обновлению всех компонентов Site Recovery см. [здесь](https://docs.microsoft.com/en-us/azure/site-recovery/service%20updates-how-to).
...
7. Могу ли я изменить парольную фразу?
...
8. Где можно загрузить ключи регистрации хранилища?
...
9. Можно ли клонировать имеющийся сервер конфигурации и использовать его для оркестрации репликации?

    **Нет.** Использование клонированного компонента сервера конфигурации не поддерживается.

10. Можно ли изменить IP-адрес сервера конфигурации?
...
11. Можно ли настроить сервер конфигурации в Azure?
