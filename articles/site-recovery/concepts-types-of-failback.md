...
> [!NOTE]
> Вы можете восстановить работоспособность только на исходном сервере vCenter Server и на сервер конфигурации. Невозможно развернуть новый сервер конфигурации и восстановить размещение с его помощью. Кроме того, невозможно добавить новый сервер vCenter на имеющийся сервер конфигурации и восстановить размещение на этот сервер vCenter.
