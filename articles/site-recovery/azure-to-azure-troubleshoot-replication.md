...
:::image type="content" source="./media/site-recovery-azure-to-azure-troubleshoot/data_change_event2.png" alt-text="Azure Site Recovery страница, на которой показана слишком высокая частота изменения данных.":::
...
:::image type="content" source="./media/site-recovery-azure-to-azure-troubleshoot/churn.png" alt-text="Azure Site Recovery страница, на которой показана слишком высокая частота изменения данных.":::
