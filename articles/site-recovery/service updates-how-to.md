...
description: Обзор обновлений службы и процедуры обновления компонентов, используемых в Azure Site Recovery.
...
1. Сначала установите обновление на локальном сервере управления. Это тот сервер, на котором выполняются роли сервера конфигурации и сервера обработки. 
2. Если вы используете серверы обработки масштабирования, обновите их следующими.
3. Перейдите на портал Azure и откройте страницу **Защищенные элементы** > **Реплицированные элементы**.
Выберите на этой странице виртуальную машину. Для каждой виртуальной машины нажмите кнопку **Обновление агента**, которая отображается в нижней части страницы. Это действие обновляет агент службы Mobility Service на всех защищенных виртуальных машинах.
...
|---------|---------|---------|---------|--------|
|[Накопительный пакет обновления 32](https://support.microsoft.com/help/4478871/update-rollup-31-for-azure-site-recovery)     |   5.1.3800.0  |  9.21.5091.1   |  5.1.3800.0  |2.0.9144.0
