...
--- | --- | --- 
Allow HTTPS outbound: port 443 | Разрешает диапазоны, соответствующие учетным записям хранения в исходном регионе. | Хранилище. \<имя региона >.
...
**Правило** |  **Дополнительные сведения** | **Тег службы**
--- | --- | --- 
Allow HTTPS outbound: port 443 | Разрешает диапазоны, соответствующие учетным записям хранения в целевом регионе. | Хранилище. \<имя региона >.
