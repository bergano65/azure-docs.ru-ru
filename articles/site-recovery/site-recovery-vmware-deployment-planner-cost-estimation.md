---
title: Просмотр оценок затрат в планировщике развертывания развертывания сайта Azure
description: В этой статье описывается, как просмотреть оценки затрат в планировщике развертывания развертывания сайта Azure для аварийного восстановления VMware.
...
---
# <a name="review-cost-estimations-in-the-vmware-deployment-planner"></a>Обзор оценок затрат в планировщике развертывания VMware 
...
>[!Note]
>Текущая версия инструмента планировщика развертывания v2.5 обеспечивает оценку затрат для VMs,реплицируя управляемые диски.
...
* Общий размер хранилища (ГБ) исходной машины
...
**Общий размер хранилища VM (GB)**: Общий объем хранилища источника VM.
