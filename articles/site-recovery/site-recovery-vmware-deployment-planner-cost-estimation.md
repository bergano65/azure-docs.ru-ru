...
>[!Note]
>Текущая версия средства планировщика развертывания версии 2.5 обеспечивает оценку затрат для виртуальных машин, реплицируемых на управляемые диски.
...
* Общий размер хранилища виртуальной машины (в ГБ) исходного компьютера
* число операций тестирования DR в год; 
* длительность каждой операции тестирования DR (в днях); 
* Тип ОС
* Избыточность данных 
* Преимущество гибридного развертывания Azure
...
**VM total storage size (GB)** (Общий размер хранилища виртуальной машины (ГБ)). Общий объем хранилища исходной виртуальной машины.

**Number of DR-Drills in a year** (Число операций тестирования аварийного восстановления в год). Сколько раз в год выполняется тестирование аварийного восстановления. Значение по умолчанию — 4 раза в год. Можно изменить число для отдельных виртуальных машин или применить новое значение ко всем виртуальным машинам. Для этого введите новое значение в верхней строке и нажмите кнопку Apply to all (Применить ко всем). На основе годового количества операций тестирования DR и длительности каждой такой операции рассчитываются общие затраты на тестирование аварийного восстановления.  
...
|Валюта|Название||Валюта|Имя||Валюта|Название|
|---|---|---|---|---|---|---|---|
...
|EUR|Евро (€)||GBP|Фунт стерлингов (£)||HKD|Гонконгский доллар (HK$)|
|IDR|Индонезийская рупия (Rp)||INR|Индийская рупия (₹)||JPY|Японская йена (¥)|
|KRW|Южнокорейская вона (₩)||MXN|Мексиканское песо (MX$)||MYR|Малайзийский ринггит (RM$)|
|NOK|Норвежская крона (kr)||NZD|Новозеландский доллар ($)||RUB|Российский рубль (руб)|
|SAR|Саудовский риял (SR)||SEK|Шведская крона (kr)||Новый тайваньский доллар (TWD)|Новый тайваньский доллар (NT$)|
|TRY|Турецкая лира (TL)||USD| Доллар США ($)||ZAR|Ранд Южно-африканской республики (R)|
