...
3. В\< \<**группе** >  > защита **защищенных элементов**протектионграупнаме>-> VirtualMachineName> выберите виртуальную машину, для которой необходимо выполнить откат, а затем выберите **плановая отработка отказа**.
...
8. После завершения начальной синхронизации и готовности к завершению работы виртуальной машины Azure щелкните **задания** > \<плановая отработка отказа> > **завершить отработку отказа**. Это позволит завершить работу компьютера с Azure, перенести последние изменения на локальную виртуальную машину и запустить ее.
