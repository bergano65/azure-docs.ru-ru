...
1. Если вы можете установить Telnet-подключение из исходного компьютера, но сервер обработки недоступен из источника, проверьте сквозное подключение с помощью cxprocessserver из исходной виртуальной машины, запустив средство cxpsclient на исходной виртуальной машине:
...
2. Проверьте следующие журналы на СО в случае, если из СО не поступает пакет пульса:
