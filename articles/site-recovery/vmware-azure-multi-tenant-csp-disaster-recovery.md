...
[Программа CSP](https://partner.microsoft.com/cloud-solution-provider) обеспечивает более эффективные статьи для облачных служб Майкрософт, в том числе Microsoft 365, Enterprise Mobility Suite и Microsoft Azure. С ее помощью партнеры могут управлять отношениями с клиентами, став основным контактным лицом. Также партнеры могут развертывать подписки Azure для клиентов и объединять их с собственными настраиваемыми предложениями.
...
1. Укажите клиент с [созданной учетной записью](#create-a-tenant-account).
1. На портале CSP можно добавить нового пользователя к подписке клиента следующим образом:
    ...
    1. Теперь создайте нового пользователя, введя соответствующие сведения и выбрав разрешения, или открыв список пользователей в CSV-файле.

    1. После создания нового пользователя вернитесь к портал Azure. На странице **Подписки** выберите соответствующую подписку.

    1. Выберите **Управление доступом (IAM)**, а затем щелкните **назначения ролей**.
