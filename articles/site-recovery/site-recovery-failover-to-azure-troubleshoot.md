...
1. Перейдите к разделу**сеть** **виртуальных машин** > и щелкните имя нужного сетевого интерфейса.  ![сетевой интерфейс](media/site-recovery-failover-to-azure-troubleshoot/network-interface.PNG)
...
4. Щелкните **настроить обязательные параметры** > **создать**. ![Создать](media/site-recovery-failover-to-azure-troubleshoot/Create-New-Public-IP.png)
...
Дополнительные сведения о повторном включении защиты виртуальной машины см. в статье [Повторная защита и отработка отказа виртуальных машин на локальный сайт после перехода на другой ресурс в Azure](vmware-azure-reprotect.md).
