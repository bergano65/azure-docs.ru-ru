...
RegisterHostStaticInfo обнаружил исключение config/talwrapper.cpp(107) [post] CurlWrapper Post не удалось: server: 10.38.229.221, порт: 443, phpUrl: request_handler.php, безопасное: true, ignoreCurlPartialError: false с ошибкой: [at curlwrapperlib/curlwrapper.cpp:processCurlResponse:231] не удалось передать запрос: (35) - Ошибка соединения SSL. 
