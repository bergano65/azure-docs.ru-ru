...
3. Отформатируйте диск, а затем создайте файловую систему на новом диске: **mkfs. ext4/дев/маппер/\<многопутевой идентификатор диска хранения >** .
...
5. Создайте запись **fstab**, чтобы диск хранения автоматически подключался при каждом запуске системы.
    ...
    **/Дев/маппер/\<>/МНТ/ретентион ext4 RW 0 0**
