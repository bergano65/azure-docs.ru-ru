...
**Из Azure в Azure** | **Из VMware в Azure** | **Hyper-V в Azure** 
--- | --- | ---
Да | Да | Да 

## <a name="exclude-limitations"></a>Исключить ограничения

**Чего** | **Виртуальные машины Azure** | **Виртуальные машины VMware** | **Виртуальные машины Hyper-V**
--- | --- | ---
