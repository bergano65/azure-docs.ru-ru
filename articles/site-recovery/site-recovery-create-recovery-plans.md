...
1. В плане восстановления щелкните шаг, к которому следует добавить действие и указать, когда действие должно происходить:
...
3. Если вы хотите добавить выполняемое вручную действие, сделайте следующее:
...
4. Если вы хотите добавить скрипт, сделайте следующее:
    1. При добавлении сценария VMM выберите **отработку отказа для сценария VMM** и в поле **пути сценария** введите относительный путь к общей папке. Например, если общий ресурс находится в \\ \<VMMServerName > \MSSCVMMLibrary\RPScripts, укажите путь: \RPScripts\RPScript.PS1.
