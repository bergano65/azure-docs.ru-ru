...
ms.locfileid: "57729037"
---
# <a name="fail-over-and-reprotect-azure-vms-between-azure-regions"></a>Отработка отказа и повторная защита виртуальных машин Azure между регионами Azure
...
- Узнайте, [как выполнить восстановление размещения](azure-to-azure-tutorial-failback.md).
