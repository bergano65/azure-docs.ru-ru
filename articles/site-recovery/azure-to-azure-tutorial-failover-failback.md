...
После повторной защиты виртуальной машины вы можете по мере необходимости восстановить размещение в основном регионе. Для этого настройте отработку отказа из дополнительного региона в основной регион, как описано в этой статье.
