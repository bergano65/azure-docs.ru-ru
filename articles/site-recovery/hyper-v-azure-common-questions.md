...
При репликации в Azure трафик репликации достигает общедоступных конечных точек учетной записи хранения Azure. Поэтому вы можете выполнять репликацию только через общедоступный Интернет с ExpressRoute (общедоступный пиринг), и VPN не работает. 
