...
### <a name="can-azure-site-recovery-and-hyper-v-replica-be-configured-together-on-a-hyper-v-machine"></a>Можно ли настроить Azure Site Recovery и реплику Hyper-V на компьютере Hyper-V?

Да, как Azure Site Recovery, так и реплику Hyper-V можно настроить совместно для компьютера. Но компьютер должен быть защищен как физический компьютер и реплицирован в Azure с помощью сервера конфигурации или процесса. Дополнительные сведения о защите физических компьютеров см. [здесь](./physical-azure-architecture.md).
