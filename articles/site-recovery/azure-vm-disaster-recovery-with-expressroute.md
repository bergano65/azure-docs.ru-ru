---
title: Интеграция аварийного восстановления VM Azure ExpressRoute Azure с восстановлением сайта Azure
...
---
# <a name="integrate-expressroute-with-disaster-recovery-for-azure-vms"></a>Интеграция ExpressRoute с аварийным восстановлением для Пазуры VMs
...
- [Схемы](../expressroute/expressroute-circuit-peerings.md) ExpressRoute
- [Домены маршрутной маршрутной трассы](../expressroute/expressroute-circuit-peerings.md#routingdomains)
...
- **Центральная виртуальная сеть**. **Исходная центральная виртуальная сеть**: 10.10.10.0/24.
  ...
  - Весь обмен данными между подсетями происходит через нее.
    - **Подсети hub vNet**. Центральная виртуальная сеть содержит две подсети:
