...
2. Создайте учетную запись, с помощью которой сервер обработки сможет получить доступ к компьютеру. Учетная запись должна быть **привилегированным** пользователем на исходном сервере Linux. Используйте эту учетную запись только для принудительной установки и обновлений.
