...
>
> Имя учетной записи появится на портале через 15 (или больше) минут. Чтобы немедленно выполнить обновление, выберите **серверы конфигурации**  >  **_имя сервера_*_ > _* обновить сервер**.
