...
Когда первичный сайт восстановится и заработает, можно восстановить размещение из Azure в Azure Stack. Для этого выполните действия, описанные [здесь](/azure-stack/operator/site-recovery-failback?view=azs-2005).
