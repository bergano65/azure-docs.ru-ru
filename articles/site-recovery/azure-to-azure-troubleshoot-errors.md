...
Отключение репликации виртуальной машины не приводит к удалению сетевого сопоставления. Сопоставление должно быть удалено из хранилища служб восстановления, в котором была защищена виртуальная машина. Перейдите > к *хранилищу служб восстановления***Site Recovery** > **Сетевое сопоставление**инфраструктуры.
