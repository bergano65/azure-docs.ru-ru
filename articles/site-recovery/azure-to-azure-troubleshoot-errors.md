...
1. Перейдите к разделу **реплицированные элементы** >  > **диски**_имен виртуальных машин_.
...
1. Запустите сценарий _клеануп-стале-АСР-конфиг-Азуре-ВМ. ps1_. Укажите **идентификатор подписки**, **группу ресурсов виртуальной машины**и **имя виртуальной машины** в качестве параметров.
...
В каждом примере GRUB должен обнаруживать два LVM устройства с именами `root` и `swap` из группы `rootvg`томов.
