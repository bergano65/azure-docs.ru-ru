 ...
 **Причина 1.  Группа ресурсов и исходной виртуальной машины находятся в разных расположениях** <br>
...
**Причина 2. Группа ресурсов не является частью выбранной подписки** <br>
...
**Причина 1. Если ваша виртуальная машина присоединяется к сети, которая уже сопоставлен с «целевая сеть».**
...
**Причина 2. Если вы ранее защищенных виртуальных Машин, с помощью Azure Site Recovery и отключить репликацию.**
...
- Следующая строка из файла GRUB **/boot/grub2/grub.cfg**. <br>
  *Linux /boot/vmlinuz-3.12.49-11-default **корневой = / dev/sda2** ${extra_cmdline} **возобновить = / dev/sda1** заставка = автоматической quiet showopts*
