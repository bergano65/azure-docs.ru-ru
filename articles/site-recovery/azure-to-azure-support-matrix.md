...
Исключение диска | [Выполняется с помощью PowerShell](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-powershell#replicate-azure-virtual-machine) |   Временный диск исключается по умолчанию.
