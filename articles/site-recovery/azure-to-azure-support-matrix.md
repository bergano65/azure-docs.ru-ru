...
**Репликация виртуальных машин Azure из одной подписки в другую для обеспечения аварийного восстановления** | Поддерживается в том же клиенте Azure Active Directory. Не поддерживается для классических виртуальных машин.
**Миграция виртуальных машин между регионами в рамках поддерживаемых географических кластеров (в пределах подписок и между ними)** | Поддерживается в одном и том же клиенте Azure Active Directory для виртуальных машин модели развертывания с помощью Resource Manager. Не поддерживается для виртуальных машин классической модели развертывания.
...
- Oracle Enterprise Linux 6.4, 6.5, 6.6, 6.7 с ядром, совместимым с Red Hat, или с ядром Unbreakable Enterprise Kernel Release 3 (UEK3)
...
Зоны доступности | Не поддерживается | Виртуальные машины, развернутые в зонах доступности, сейчас не поддерживаются.
