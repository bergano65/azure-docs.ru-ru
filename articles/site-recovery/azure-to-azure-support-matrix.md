...
Исключение диска | [Выполняется с помощью PowerShell](https://review.docs.microsoft.com/azure/site-recovery/azure-to-azure-powershell?branch=pr-en-us-66458#replicate-azure-virtual-machine) |  Временный диск исключается по умолчанию.
