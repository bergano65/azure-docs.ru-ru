...
>[!NOTE]
>Если вы не видите регион в географическом кластере во время включения репликации, убедитесь, что вашей подписке предоставляет права для создания виртуальной машины в этом регионе. В противном случае отправьте запрос в службу поддержки, указав подписку в категории "Тип проблемы".
>
...
>[!NOTE]
>
> Для региона "Южная Бразилия" вы можете реплицировать и выполнить отработку отказа в один из следующих регионов: центрально-южная часть США, центрально-западная часть США, восточная часть США, восточная часть США 2, западная часть США, западная часть США 2 и центрально-северная часть США.
>
> Следует отметить, что в Site Recovery только Южная Бразилия может использоваться в качестве исходного региона, из которого можно обеспечить защиту виртуальных машин. Он не может использоваться в качестве целевого региона аварийного восстановления для каких-либо регионов Azure, например центрально-южной части США. Рекомендуется выбрать любой другой регион Америки, отличный от Южной Бразилии, из-за задержки, связанной с географическим расстоянием.
