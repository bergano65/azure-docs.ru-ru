...
**Узел Hyper-V**: Если указано имя узла Hyper-V, программа сначала проверяет, входит ли он в кластер. Если это так, извлекается список узлов в кластере. Затем для каждого узла Hyper-V извлекается список виртуальных машин. 
