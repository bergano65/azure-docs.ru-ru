...
1.  Для каждого узла Hyper-V, который необходимо профилировать, необходимо:
    ...
    1\. Указать виртуальную машину, на которой будет выполняться программа, в списке TrustedHosts. Выполните следующую команду в сеансе PowerShell с повышенными привилегиями в узле Hyper-V:
...
Последняя версия средства Планировщик развертывания Azure Site Recovery — 2,5.
