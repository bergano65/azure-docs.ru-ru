---
title: Планировщик развертывания для восстановления аварийности Hyper-V с восстановлением сайта Azure
...
Последняя версия инструмента планировщика развертывания azure Site Recovery Planner составляет 2,5.
Обратитесь на страницу [планировщика развертывания azure,](https://social.technet.microsoft.com/wiki/contents/articles/51049.asr-deployment-planner-version-history.aspx) чтобы исправить эти консики, которые добавляются в каждом обновлении.


## <a name="next-steps"></a>Дальнейшие действия
* [Выполнить планировщик развертывания.](site-recovery-hyper-v-deployment-planner-run.md)
