...
>[!NOTE]
>
>- Site Recovery в настоящее время не поддерживает планы восстановления зоны для аварийного восстановления зоны через портал. Используйте PowerShell или REST API, чтобы использовать планы восстановления зоны для аварийного восстановления зоны. 
