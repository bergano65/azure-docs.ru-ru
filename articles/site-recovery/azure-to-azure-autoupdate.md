...
2. В разделе для**параметров обновления расширения** **виртуальных машин** > Azure включите параметр **Разрешить Site Recovery управлять** . Для управления вручную отключите его. 
...
1. Если на виртуальных машинах установлены новые обновления для службы Mobility Service, вы увидите следующее уведомление: "Новое обновление агента репликации для восстановления сайта доступно. Щелкните, чтобы установить
