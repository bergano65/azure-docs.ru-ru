...
> [!NOTE]
> Начиная с накопительного пакета обновления 35, можно выбрать существующую учетную запись службы автоматизации для использования при обновлениях. До этого обновления Site Recovery создать эту учетную запись по умолчанию. Обратите внимание, что этот параметр можно выбрать только при включении репликации для виртуальной машины. Она недоступна для реплицируемой виртуальной машины. Выбранный параметр будет применяться ко всем виртуальным машинам Azure, защищенным в одном хранилище.
...
1. Если на виртуальных машинах установлены новые обновления для службы Mobility Service, вы увидите следующее уведомление: Доступна новая Site Recovery обновление агента репликации. Щелкните, чтобы установить
