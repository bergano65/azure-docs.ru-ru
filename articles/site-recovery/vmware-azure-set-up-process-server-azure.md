---
title: Настройка сервера обработки VMware/физического сбоя в восстановлении сайта Azure
...
1. В**Manage** > хранилище > **серверов управления конфигурацией инфраструктуры**> восстановления сайта выберите сервер конфигурации.**Configuration Servers**
...
6. Нажмите кнопку **ОК**, чтобы начать развертывание виртуальной машины сервера обработки. Сервер процесса будет развернут на Standard_A8_v2 SKU. Убедитесь, что этот VM SKU доступен для вашей подписки.
