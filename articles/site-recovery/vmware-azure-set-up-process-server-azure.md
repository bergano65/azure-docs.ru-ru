...
6. Нажмите кнопку **ОК**, чтобы начать развертывание виртуальной машины сервера обработки. Сервер обработки будет развернут на SKU Standard_A8_v2. Убедитесь, что этот номер SKU виртуальной машины доступен для вашей подписки.
