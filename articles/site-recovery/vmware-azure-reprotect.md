---
title: Повторное включение защиты виртуальных машин или физических серверов VMware на локальном сайте с помощью Azure Site Recovery
...
- Восстановить размещение не удается в следующих случаях:
    - Машины перенесены в Azure. [Дополнительные сведения](migrate-overview.md#what-do-we-mean-by-migration)
