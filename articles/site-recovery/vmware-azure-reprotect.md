...
>[!NOTE]
>Объем данных, отправленных из Azure в собралный источник во время повторного включения защиты, может быть любым от 0 до суммарного размера диска для всех защищенных компьютеров и не может быть рассчитан.
