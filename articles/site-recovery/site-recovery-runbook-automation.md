...
В следующем примере мы применим другую методику, создав в ресурсах учетной записи службы автоматизации Azure [сложную переменную](https://docs.microsoft.com/powershell/module/servicemanagement/azure/set-azureautomationvariable) с несколькими значениями. Для выполнения следующих действий потребуется Azure PowerShell.
