...
**C:\Program Files (x86) \Microsoft Azure site Рековери\ажент > "C:\Program Files (x86) \Microsoft Azure site Recovery\agent\InMageVSSProvider_Install.cmd**
...
В журнале, расположенном на сервере конфигурации в\<к:\програмдата\асрсетуплогс\уплоадедлогс Дата-время > UA_InstallLogFile. log, вы обнаружите следующее исключение:
