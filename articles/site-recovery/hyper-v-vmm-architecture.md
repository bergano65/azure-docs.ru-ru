---
title: Архитектура аварийного восстановления Hyper-V на дополнительный локальный сайт с Azure Site Recovery
...
--- | --- | ---
**Azure** | Подписка на Azure | Создайте хранилище служб восстановления в подписке Azure для координации процесса репликации между расположениями VMM и управления им.
