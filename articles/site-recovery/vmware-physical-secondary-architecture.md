...
**Сервер VMware ESX/ESXi и vCenter** |  Виртуальные машины размещаются на узлах ESX/ESXi. Управление узлами осуществляется с помощью сервера vCenter | Для репликации виртуальных машин VMware требуется инфраструктура VMware.
**Виртуальные машины и физические серверы** |  Единый агент устанавливается на виртуальных машинах VMware и физических серверах, репликацию которых необходимо выполнить. | Агент обеспечивает обмен данными между всеми компонентами.
...
**Рисунок 6. Репликация VMware в VMware**
