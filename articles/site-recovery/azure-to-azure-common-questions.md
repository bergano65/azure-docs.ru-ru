...
- При выполнении отработки отказа виртуальной Машины, к которому добавить диск и включить для нее репликацию, точки репликации покажет диски, которые доступны для восстановления. Например, если виртуальная машины имеет один диск и вы добавляете новый, точки репликации, созданные перед добавлением диска, покажут, что точка репликации состоит из "1 из 2 дисков".
