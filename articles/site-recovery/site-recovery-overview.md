...
- **Служба Backup**. [Служба архивации Azure](../backup/index.yml) обеспечивает защиту и восстановление данных.
...
**Регионы** | Ознакомьтесь с [поддерживаемыми регионами](https://azure.microsoft.com/global-infrastructure/services/?products=site-recovery) для Site Recovery. |
