...
### <a name="canl-i-use-the-configuration-server-vm-for-anything-else"></a>Можно ли использовать сервера конфигурации виртуальной машины для чего-либо еще?
