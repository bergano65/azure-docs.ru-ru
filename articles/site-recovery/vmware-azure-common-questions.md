...
Да, клиенты Microsoft Software Assurance могут использовать программу [Преимущество гибридного использования Azure](https://azure.microsoft.com/en-in/pricing/hybrid-benefit/), чтобы сэкономить на стоимости лицензирования **компьютеров под управлением Windows Server**, которые переносятся в Azure, или использовать Azure для аварийного восстановления.
...
Вы можете использовать [Калькулятор цен](https://aka.ms/asr_pricing_calculator) для оценки затрат при использовании Azure Site Recovery. Для получения подробной оценки затрат запустите средство планировщика развертывания (https://aka.ms/siterecovery_deployment_planner) и проанализируйте [отчет об оценке стоимости](https://aka.ms/asr_DP_costreport).
...
Учетную запись хранения можно обновить только до уровня "Премиум". Если вы хотите использовать другую учетную запись хранения, вам необходимо отключить репликацию вашего исходного компьютера и повторно включить защиту с помощью новой учетной записи хранения. Кроме этого, нет другого способа изменить учетную запись хранения после включения защиты.
