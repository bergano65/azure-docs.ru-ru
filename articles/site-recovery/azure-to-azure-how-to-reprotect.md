...
1. Просмотрите сведения о группе ресурсов, сети, хранилище и группах доступности. Затем нажмите кнопку **ОК**. Если какие – либо ресурсы помечены как новые, они будут созданы как часть процесса повторного включения защиты.
