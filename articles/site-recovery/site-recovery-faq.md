...
Да, Site Recovery поддерживает аварийное восстановление виртуальных машин Azure между регионами Azure. Ознакомьтесь с [часто задаваемыми вопросами об аварийном восстановлении виртуальных машин Azure в Azure](azure-to-azure-common-questions.md).
