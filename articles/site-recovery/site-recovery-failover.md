...
2. Щелкните **Отработка отказа**.
    ...
    ![На снимке экрана показана панель АДРП с отработкой отказа, выбранной в меню "Дополнительно".](./media/site-recovery-failover/Failover.png)
