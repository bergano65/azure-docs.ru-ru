...
3. В случае **отработки отказа** > **направление отработки отказа**оставьте значение по умолчанию, если выполняется репликация в Azure.
