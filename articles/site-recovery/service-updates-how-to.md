...
|---------|---------|---------|---------|--------|
|36 накопительный пакет обновления *     |   5.1.4150.0  |  9.24.5211.1   |  5.1.4150.0  | 2.0.9160.0
...
* Заметки о выпуске уже выполняется. Обратитесь к соответствующей обновления документов, для обновления компонентов Site Recovery.
