...
2. В окне **Подготовка источника**выберите **+ VMM** , чтобы добавить сервер VMM. В колонке **Добавление сервера** в поле **Тип сервера** должно быть указано **System Center VMM server** (Сервер System Center VMM).
3. Скачайте программу установки поставщика Microsoft Azure Site Recovery.
4. Скачайте ключ регистрации в хранилище. Этот ключ потребуется при запуске программы установки поставщика. Ключ действителен в течение пяти дней после создания.
...
1. В **Site Recovery** > **Сетевое** > **сопоставление**сетевые сопоставления выберите значок **+ Сетевое сопоставление** .
