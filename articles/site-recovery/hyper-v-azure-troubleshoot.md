---
title: Устранение последствий аварии Hyper-V с восстановлением сайта Azure
...
4. Проверьте журнал Hyper-V-VMMS\Admin на наличие проблем при выполнении входа в виртуальную машину. Этот журнал находится в **приложениях и службах Журналы** > **Microsoft** > **Windows**.
5. Включите на гостевой виртуальной машине инструментарий управления Windows (WMI) и проверьте, что он доступен.
   ...
   - [Проблемы устранения неполадок](https://technet.microsoft.com/library/ff406382.aspx#H22) с помощью скриптов и служб WMI.
...
2. Проверьте, приостановлена ли репликация.
   ...
   - Если это важно, нажмите на vM > **Воспроизведение** > **Просмотр воспроизведения здоровье**.
...
2. Чтобы просмотреть подробные сведения, выберите пункт **View Replication Health** (Просмотреть состояние работоспособности репликации).
    ...
    - Если репликация приостановлена, нажмите на VM >**репликации репликации** **репликации.** > 
...
5. Проверьте, включена ли служба резервного копирования. Убедитесь, что он включен в **настройках Hyper-V Службы** > **интеграции.**
...
1. Проверьте журналы событий на наличие ошибок VSS и просмотрите рекомендации.
    - На сервере Hyper-V, откройте журнал событий Hyper-V Admin в**приложениях и службах** >  **событий** > **Microsoft** > **Windows** > **Hyper-V** > **Admin.**
...
2. Чтобы создавать моментальные снимки VSS для виртуальной машины, установите на виртуальной машине службы Integration Services Hyper-V и включите службу интеграции резервного копирования (VSS).
    ...
    - Вы можете проверить это с повышенной сессии PowerShell на Хосте Hyper-V с командой **Get-VMIntegrationService-VMName\<VMName>-Name VSS** Вы также можете получить эту информацию, войдя в гостевой VM. Ознакомьтесь с [дополнительными сведениями](https://docs.microsoft.com/windows-server/virtualization/hyper-v/manage/manage-hyper-v-integration-services).
...
1. Сначала убедитесь, что аналитический журнал и журнал отладки видны в средстве просмотра событий. Чтобы сделать журналы доступными, в Viewer событий нажмите **View** > **Show Analytic и Debug журналы.**. Аналитический журнал отображается в группе **Hyper-V-VMMS**.
