...
Установите соответствующие конфигурации Site Recovery в зависимости от того, развертываются ли виртуальные машины на узле [Hyper-V](./hyper-v-azure-tutorial.md) или [VMware](./vmware-azure-tutorial.md).
...
**Настройка параметров вычислений и сети виртуальной машины**
