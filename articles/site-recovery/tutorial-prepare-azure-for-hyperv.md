---
title: Подготовка Azure для аварийного восстановления локальных виртуальных машин Hyper-V с помощью Azure Site Recovery | Документация Майкрософт
...
Эта статья является первой в серии руководств, в которой показано, как настроить аварийное восстановление для локальных виртуальных машин. В ней рассматриваются вопросы защиты виртуальные машины Hyper-V.
...
В статье описана подготовка компонентов Azure для репликации локальных виртуальных машин (Hyper-V) в Azure. Из этого руководства вы узнаете, как выполнять следующие задачи:
...
> [Подготовка локальных серверов VMware для аварийного восстановления в Azure](hyper-v-prepare-on-premises-tutorial.md)
