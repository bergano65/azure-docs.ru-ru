...
1. Мониторинг хода выполнения развертывания в консоли Configuration Manager. Перейдите к разделу **мониторинг** > **развертывания** > _\<имя\>пакета_.
