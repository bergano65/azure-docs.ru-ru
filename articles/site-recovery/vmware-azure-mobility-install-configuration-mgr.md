...
1. Выберите точки распространения, в которых должны копироваться пакеты. [Подробнее](/sccm/core/servers/deploy/configure/install-and-configure-distribution-points).
