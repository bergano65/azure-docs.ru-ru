---
title: Восстановление аварийности для многоуровневого приложения SharePoint с использованием восстановления сайта Azure
...
В этой статье подробно описывается, как защитить приложение SharePoint с помощью [Azure Site Recovery.](site-recovery-overview.md)
...
Вы можете посмотреть видео ниже о восстановлении многоуровневого приложения в Azure.
...
Восстановление сайта является агностиком приложений и должно работать с любой версией SharePoint, работая на поддерживаемой машине. Для написания этой статьи использовались виртуальные машины VMware под управлением Windows Server 2012 R2 Enterprise. Кроме того, использовались выпуски SharePoint 2013 Enterprise и SQL Server 2014 Enterprise.
...
Для получения рекомендаций по проведению сбоя теста для групп доступности S'L Always ON, обратитесь к [производительности Исцвырения приложений с восстановлением сайта Azure и с документом о сбое в тестировании.](site-recovery-sql.md#disaster-recovery-of-an-application)
