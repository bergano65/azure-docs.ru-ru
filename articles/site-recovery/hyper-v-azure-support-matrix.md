...
> [!NOTE]
> При репликации Hyper-VMs из локальной среды в Azure можно выполнять репликацию только в один клиент AD из одного конкретного окружения — Hyper-V или Hyper-V с помощью VMM.
