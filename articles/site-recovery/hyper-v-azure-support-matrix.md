...
--- | --- | ---
Сеть узла: объединение сетевых адаптеров | Yes | Yes
...
Сеть гостевых виртуальных машин: IPv4 | Yes | Yes
Сеть гостевых виртуальных машин: IPv6 | Нет  | Yes
Сеть гостевых виртуальных машин: Статический IP-адрес (Windows) | Yes | Yes
Сеть гостевых виртуальных машин: Статический IP-адрес (Linux) | Нет  | Нет 
Сеть гостевых виртуальных машин: Несколько сетевых адаптеров | Yes | Yes
