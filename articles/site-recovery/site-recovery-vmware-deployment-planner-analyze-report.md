...
**Учетная запись хранения**. Имя учетной записи хранения с добавлением рекомендуемого префикса.
...
**Сетевые адаптеры**. Количество сетевых адаптеров на виртуальной машине.
