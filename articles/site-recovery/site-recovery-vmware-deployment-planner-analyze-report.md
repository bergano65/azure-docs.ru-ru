...
**Тип учетной записи хранения журнала**: Все журналы репликации хранятся в учетной записи хранилища класса Standard.
...
**Suggested Log Account Name** (Рекомендуемое имя учетной записи журналов). Имя учетной записи хранения с добавлением рекомендуемого префикса. Замените имя в угловых скобках (< и >) именем своей учетной записи.

**Placement Summary** (Сводка по размещению). Сводка по дискам, необходимым для защиты виртуальных машин по типу хранилища. Он включает общее число виртуальных машин, общий размер для всех дисков и общее количество дисков.
