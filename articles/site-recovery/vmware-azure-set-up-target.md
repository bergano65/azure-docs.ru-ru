---
title: Подготовьте цель репликации VMware VM в восстановлении сайта Azure
...
- Для защиты исходных машин создан портал Служб восстановления на [портале](https://portal.azure.com "Портал Azure")
...
На основе выбранной модели развертывания проводится проверка, чтобы убедиться, что у вас есть по крайней мере одна виртуальная сеть в целевой подписке для воспроизведения и отказа от виртуальной машины или физического сервера.

После успешного завершения проверки нажмите кнопку "OK", чтобы перейти к следующему шагу.

Если у вас нет виртуальной сети, вы можете создать ее, нажав кнопку **«Сеть»** в верхней части страницы.
