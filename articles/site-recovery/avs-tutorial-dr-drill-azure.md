---
title: Выполнение аварийного восстановления из Решения Azure VMware в Azure с помощью Azure Site Recovery
description: Сведения о том, как выполнить отработку аварийного восстановления из частного облака Решения Azure VMware в Azure с помощью службы Azure Site Recovery.
author: Harsha-CS
manager: rochakm
...
ms.locfileid: "91814293"
---
# <a name="run-a-disaster-recovery-drill-from-azure-vmware-solution-to-azure"></a>Выполнение аварийного восстановления из Решения Azure VMware в Azure

В этой статье описано, как выполнять аварийное восстановление виртуальной машины Решения Azure VMware в Azure, используя службу [Azure Site Recovery](site-recovery-overview.md). Выполнение проверяет стратегию репликации без потери данных.


Это четвертое руководство в серии, в котором показано, как настроить аварийное восстановление виртуальных машин Решения Azure VMware в Azure.
...
3. [Настройте](avs-tutorial-replication.md) аварийное восстановление виртуальных машин Решения Azure VMware.
 

## <a name="verify-vm-properties"></a>Проверка свойств виртуальной машины

Перед запуском тестовой отработки отказа проверьте свойства виртуальной машины и убедитесь, что [виртуальная машина VMware](vmware-physical-azure-support-matrix.md#replicated-machines) соответствует требованиям Azure.
...
- Тестовая сеть должна использовать тот же диапазон классов IP-адресов и подсетей.
...
> [Запуск отработки отказа](avs-tutorial-failover.md)
