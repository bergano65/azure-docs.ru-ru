---
title: Запуск отработки аварийного восстановления в Azure с помощью Azure Site Recovery
description: Сведения о том, как выполнить отработку аварийного восстановления из локальной среды в Azure с помощью службы Azure Site Recovery.
