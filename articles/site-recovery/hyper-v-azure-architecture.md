---
title: Архитектура аварийного восстановления Hyper-V в восстановлении сайта Azure
...
4. Вы можете контролировать работу во вкладке **«Вакансии».**      ![Список](media/hyper-v-azure-architecture/image1.png) ![заданий Включить защиту сверлить вниз](media/hyper-v-azure-architecture/image2.png)
