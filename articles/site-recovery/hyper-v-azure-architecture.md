---
title: Архитектура аварийного восстановления Hyper-V в Azure Site Recovery
...
4. Вы можете отслеживать задание на вкладке **задания** .      ![список заданий](media/hyper-v-azure-architecture/image1.png) ![включить детализацию защиты](media/hyper-v-azure-architecture/image2.png)
