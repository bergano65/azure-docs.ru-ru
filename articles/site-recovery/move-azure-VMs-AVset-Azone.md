...
3. В разделе **Настройка аварийного восстановления** > **Целевой регион** выберите целевой регион, в который будет выполняться репликация. Убедитесь, что этот регион [поддерживает](https://docs.microsoft.com/azure/availability-zones/az-region) Зоны доступности.
