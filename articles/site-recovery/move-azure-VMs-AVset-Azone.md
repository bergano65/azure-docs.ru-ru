...
> [!NOTE]
> Если параметры выбора группы доступности или зоны доступности не отображаются, удостоверьтесь, что [предварительные требования](#prepare-the-source-vms) выполнены, а [подготовка](#prepare-the-source-vms) исходных виртуальных машин завершена.
