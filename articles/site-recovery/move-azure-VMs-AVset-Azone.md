...
> [!IMPORTANT]
> Сейчас Azure Site Recovery поддерживает перемещение виртуальных машин из одного региона в другой. Но перемещение между зонами в пределах одного региона поддерживается только в некоторых регионах. [Подробнее](./azure-to-azure-how-to-enable-zone-to-zone-disaster-recovery.md).
