...
### <a name="2-prepare-source"></a>2. Подготовка источника
...
### <a name="3-prepare-target"></a>3. Подготовка цели
...
### <a name="5-select-deployment-planning"></a>5. Выбор параметров планирования развертывания
