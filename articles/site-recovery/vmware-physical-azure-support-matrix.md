...
**Поддерживаемый выпуск** | **Версия службы Mobility Service** | **Версия ядра** |
--- | --- | --- |
Debian 7 | [9,31][9.31 UR], [9,32][9.32 UR], [9,33](https://support.microsoft.com/help/4564347/), [9,34](https://support.microsoft.com/help/4570609)| С 3.2.0-4-amd64 по 3.2.0-6-amd64, 3.16.0-0.bpo.4-amd64 |
|||
...
--- | --- | --- |
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4, SP5) | [9,34](https://support.microsoft.com/help/4570609) | Поддерживаются все стандартные ядра SUSE 12 SP1, SP2, SP3, SP4.</br></br> с 4.4.138-4.7-azure по 4.4.180-4.31-azure,</br>4.12.14-6.3-Azure в 4.12.14-6.43-Azure </br> 4.12.14-16,7-Azure в 4.12.14-16.13-Azure  |
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4) | 9,32, [9,33](https://support.microsoft.com/help/4564347/) | Поддерживаются все стандартные ядра SUSE 12 SP1, SP2, SP3, SP4.</br></br> с 4.4.138-4.7-azure по 4.4.180-4.31-azure,</br>с 4.12.14-6.3-azure по 4.12.14-6.34-azure  |
...
Загрузка из виртуальной машины/сервера EFI/UEFI | — Поддерживается для Windows Server 2012 или более поздней версии, SLES 12 SP4 и RHEL 8,0 с агентом Mobility Service версии 9,30 и выше<br/> -Безопасный тип загрузки UEFI не поддерживается. [Подробнее.](../virtual-machines/windows/generation-2.md#on-premises-vs-azure-generation-2-vms)
