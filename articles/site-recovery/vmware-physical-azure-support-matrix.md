...
**Поддерживаемый выпуск** | **Версия службы Mobility Service** | **Версия ядра** |
--- | --- | --- |
Debian 7 | [9,36](https://support.microsoft.com/help/4578241/), [9,37](https://support.microsoft.com/help/4582666/), [9,38](https://support.microsoft.com/help/4590304/), [9,39](https://support.microsoft.com/help/4597409/), [9,40](https://support.microsoft.com/en-us/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a) | С 3.2.0-4-amd64 по 3.2.0-6-amd64, 3.16.0-0.bpo.4-amd64 |
|||
Debian 8 | [9,36](https://support.microsoft.com/help/4578241/), [9,37](https://support.microsoft.com/help/4582666/), [9,38](https://support.microsoft.com/help/4590304/), [9,39](https://support.microsoft.com/help/4597409/), [9,40](https://support.microsoft.com/en-us/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a)  | 3.16.0-4-AMD64 – 3.16.0-11-AMD64, 4.9.0 -0. BPO. 4-AMD64 до 4.9.0 -0. BPO. 11 — AMD64 |
|||
...
**Выпуск** | **Версия службы Mobility Service** | **Версия ядра** |
--- | --- | --- |
SUSE Linux Enterprise Server 15, SP1, SP2 | [9,40](https://support.microsoft.com/en-us/topic/update-rollup-53-for-azure-site-recovery-060268ef-5835-bb49-7cbc-e8c1e6c6e12a)  | По умолчанию поддерживаются все [стандартные ядра SUSE 15 и 15](https://www.suse.com/support/kb/doc/?id=000019587).</br></br> 4.12.14-5.5 — Azure — 4.12.14 — 5.47 — Azure </br></br> 4.12.14-8.5 — Azure — 4.12.14 — 8.55 — Azure </br> 5.3.18-16 — Azure </br> 5.3.18-18.5 — Azure — 5.3.18 — 18.29 — Azure
...
Диск размером более 1 ТБ для клиента или сервера | Да, диск должен быть больше 1024 МБ<br/><br/>До 32 ТБ при репликации на управляемые диски (9,40 версии)<br></br> До 4 095 ГБ при репликации в учетные записи хранения
...
Размер диска данных | До 32 ТБ при репликации на управляемый диск (9,40 версии)<br></br>До 4 095 ГБ при репликации в учетную запись хранения| Если не поддерживается, проверка завершается ошибкой.
