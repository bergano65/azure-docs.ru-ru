...
18.04 LTS | [9,34](https://support.microsoft.com/help/4570609) | 4.15.0-20-Generic для 4.15.0-101-Generic </br> с 4.18.0-13-generic по 4.18.0-25-generic </br> 5.0.0-15-Generic – 5.0.0-48-Generic </br> 5.3.0-19-Generic для 5.3.0-53-Generic </br> 4.15.0-1009-Azure в 4.15.0-1083-Azure </br> с 4.18.0-1006-azure по 4.18.0-1025-azure </br> 5.0.0-1012 — Azure — 5.0.0-1036 — Azure </br> 5.3.0-1007 — Azure — 5.3.0 — 1022 — Azure|
...
**Поддерживаемый выпуск** | **Версия службы Mobility Service** | **Версия ядра** |
--- | --- | --- |
Debian 7 | [9,32][9.32 UR], [9,33](https://support.microsoft.com/help/4564347/), [9,34](https://support.microsoft.com/help/4570609), [9,35](https://support.microsoft.com/help/4573888/), [9,36](https://support.microsoft.com/help/4578241/)| С 3.2.0-4-amd64 по 3.2.0-6-amd64, 3.16.0-0.bpo.4-amd64 |
|||
Debian 8 | [9,35](https://support.microsoft.com/help/4573888/), [9,36](https://support.microsoft.com/help/4578241/) | 3.16.0-4-AMD64 – 3.16.0-11-AMD64, 4.9.0 -0. BPO. 4-AMD64 до 4.9.0 -0. BPO. 11 — AMD64 |
Debian 8 | [9,32][9.32 UR], [9,33](https://support.microsoft.com/help/4564347/), [9,34](https://support.microsoft.com/help/4570609) | с 3.16.0-4-amd64 по 3.16.0-10-amd64, с 4.9.0-0.bpo.4-amd64 по 4.9.0-0.bpo.11-amd64 |
...
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4, SP5) | [9,34](https://support.microsoft.com/help/4570609) | Поддерживаются все [ядра версии SUSE 12 SP1, SP2, SP3, SP4](https://www.suse.com/support/kb/doc/?id=000019587) .</br></br> с 4.4.138-4.7-azure по 4.4.180-4.31-azure,</br>4.12.14-6.3-Azure в 4.12.14-6.43-Azure </br> 4.12.14-16,7-Azure в 4.12.14-16.13-Azure  |
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4) | 9,32, [9,33](https://support.microsoft.com/help/4564347/) | Поддерживаются все [ядра версии SUSE 12 SP1, SP2, SP3, SP4](https://www.suse.com/support/kb/doc/?id=000019587) .</br></br> с 4.4.138-4.7-azure по 4.4.180-4.31-azure,</br>с 4.12.14-6.3-azure по 4.12.14-6.34-azure  |
...
**Выпуск** | **Версия службы Mobility Service** | **Версия ядра** |
--- | --- | --- |
SUSE Linux Enterprise Server 15 и 15 SP1 | [9,36](https://support.microsoft.com/help/4578241/)  | По умолчанию поддерживаются все [стандартные ядра SUSE 15 и 15](https://www.suse.com/support/kb/doc/?id=000019587).</br></br> 4.12.14-5.5 — Azure — 4.12.14 — 5.47 — Azure </br></br> 4.12.14-8.5 — Azure — 4.12.14 — 8.38 — Azure
...
SUSE Linux Enterprise Server 15 и 15 SP1 | [9,34](https://support.microsoft.com/help/4570609)  | По умолчанию поддерживаются все [стандартные ядра SUSE 15 и 15](https://www.suse.com/support/kb/doc/?id=000019587).</br></br> 4.12.14-5.5 — Azure — 4.12.14 — 5.47 — Azure </br></br> 4.12.14-8.5 — Azure — 4.12.14 — 8.30 — Azure 
...
SUSE Linux Enterprise Server 15 и 15 SP1 | [9.32](https://support.microsoft.com/help/4550047/) | По умолчанию поддерживаются все [стандартные ядра SUSE 15 и 15](https://www.suse.com/support/kb/doc/?id=000019587). </br></br> с 4.12.14-5.5-azure по 4.12.14-8.22-azure
...
Загрузка из виртуальной машины/сервера EFI/UEFI | — Поддерживается для всех [операционных систем UEFI Azure Marketplace](../virtual-machines/windows/generation-2.md#generation-2-vm-images-in-azure-marketplace) с Site Recovery агента мобильности версии 9,30. <br/> -Безопасный тип загрузки UEFI не поддерживается. [Подробнее.](../virtual-machines/windows/generation-2.md#on-premises-vs-azure-generation-2-vms)
