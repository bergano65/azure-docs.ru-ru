...
Диспетчер томов | LVM2 LVM поддерживается только для дисков данных. Виртуальные машины Azure содержат только один диск с ОС.
