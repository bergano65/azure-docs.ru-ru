...
Загрузка из виртуальной машины/сервера EFI/UEFI | — Поддерживается для Windows Server 2012 или более поздней версии, SLES SP4 и RHEL 8,0 <br/> -Безопасный тип загрузки UEFI не поддерживается. 
