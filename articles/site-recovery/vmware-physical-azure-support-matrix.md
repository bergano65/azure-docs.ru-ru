...
Операционная система Linux | Red Hat Enterprise Linux: 5.2–5.11<b>\*\*</b>, 6.1–6.10<b>\*\*</b>, 7.0–7.5 <br/><br/>CentOS: 5.2–5.11<b>\*\*</b>, 6.1–6.10<b>\*\*</b>, 7.0–7.5 <br/><br/>Сервер Ubuntu версии 14.04 LTS [(поддерживаемые версии ядра)](#ubuntu-kernel-versions)<br/><br/>Сервер Ubuntu версии 16.04 LTS [(поддерживаемые версии ядра)](#ubuntu-kernel-versions)<br/><br/>Debian 7 и Debian 8[ (поддерживаемые версии ядра)](#debian-kernel-versions)<br/><br/>SUSE Linux Enterprise Server 12 SP1,SP2,SP3 [ (поддерживаемые версии ядра)](#suse-linux-enterprise-server-12-supported-kernel-versions)<br/><br/>SUSE Linux Enterprise Server 11 с пакетом обновления 3 (SP3)<b>\*\*</b> или SUSE Linux Enterprise Server 11 с пакетом обновления 4 (SP4)* </br></br>Oracle Enterprise Linux 6.4, 6.5, 6.6, 6.7 с ядром, совместимым с Red Hat, или с ядром Unbreakable Enterprise Kernel Release 3 (UEK3) <br/><br/></br>* *Обновление реплицированных виртуальных машин с SUSE Linux Enterprise Server 11 SP3 до SP4 не поддерживается. Для обновления отключите репликацию и включите ее снова после обновления.*</br></br><b>\*\*</b> *Подробные сведения о поддержке Linux и технологий с открытым кодом в Azure см. в руководстве по [поддержке виртуальных машин Linux в Azure](https://support.microsoft.com/help/2941892/support-for-linux-and-open-source-technology-in-azure). Azure Site Recovery позволяет выполнять отработку отказа и запускать серверы Linux в Azure, но поставщики Linux могут ограничить поддержку только теми версиями их дистрибутивов, жизненный цикл которых еще не завершен.*
...
>
> - Для загрузки виртуальных машин в Azure на серверах под управлением Red Hat Enterprise Linux 5.2–5.11 или CentOS 5.2–5.11 должны быть установлены [компоненты служб интеграции Linux (LIS)](https://www.microsoft.com/en-us/download/details.aspx?id=55106).
...
Служба Mobility Service | Координирует репликацию между локальными серверами VMware или физическими серверами и Azure или вторичным сайтом.<br/><br/> Устанавливается на виртуальной машине VMware или физических серверах, репликацию которых необходимо выполнить. | Для новой установки щелкните [здесь](vmware-azure-install-mobility-service.md). Для обновления существующего компонента до последней версии щелкните [здесь](vmware-azure-install-mobility-service.md#update-mobility-service).
