...
**Поддерживаемый выпуск** | **Версия службы Mobility Service** | **Версия ядра** |
--- | --- | --- |
Debian 7 | [9,28][9.28 UR], [9,29][9.29 UR], [9,30][9.30 UR], [9,31][9.31 UR]| С 3.2.0-4-amd64 по 3.2.0-6-amd64, 3.16.0-0.bpo.4-amd64 |
|||
Debian 8 | [9,30][9.30 UR], [9,31][9.31 UR] | 3.16.0-4-AMD64 – 3.16.0-10-AMD64, 4.9.0 -0. BPO. 4-AMD64 до 4.9.0 -0. BPO. 11 — AMD64 |
Debian 8 | [9,28][9.28 UR], [9,29][9.29 UR] | 3.16.0-4-AMD64 – 3.16.0-10-AMD64, 4.9.0 -0. BPO. 4-AMD64 до 4.9.0 -0. BPO. 9 — AMD64 |
...
--- | --- | --- |
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4) | [9,31][9.31 UR] | Поддерживаются все [ядра версии SUSE 12 SP1, SP2, SP3, SP4](https://wiki.microfocus.com/index.php/SUSE/SLES/Kernel_versions#SUSE_Linux_Enterprise_Server_12) .</br></br> 4.4.138-4.7-Azure в 4.4.180-4.31-Azure,</br>4.12.14-6.3-Azure в 4.12.14-6.29-Azure  |
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4) | [9,30][9.30 UR] | Поддерживаются все [ядра версии SUSE 12 SP1, SP2, SP3, SP4](https://wiki.microfocus.com/index.php/SUSE/SLES/Kernel_versions#SUSE_Linux_Enterprise_Server_12) .</br></br> 4.4.138-4.7-Azure в 4.4.180-4.31-Azure,</br>4.12.14-6.3-Azure в 4.12.14-6.26-Azure  |
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4) | [9,29][9.29 UR] | Поддерживаются все [ядра версии SUSE 12 SP1, SP2, SP3, SP4](https://wiki.microfocus.com/index.php/SUSE/SLES/Kernel_versions#SUSE_Linux_Enterprise_Server_12) .</br></br> 4.4.138-4.7-Azure в 4.4.180-4.31-Azure,</br>4.12.14-6.3-Azure в 4.12.14-6.23-Azure  |
...
Сведения о количестве виртуальных машин, которые можно защитить в одной группе ресурсов, см. в статье [ограничения подписки и квоты](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits#resource-group-limits) .
