---
title: Настройка сбоя/неудачи на вторичном сайте Hyper-V с восстановлением сайта Azure
...
> [!WARNING]
> **Не отменяйте сбой в процессе:** Перед началом сбоя репликация VM остановлена. Если отменить выполняющуюся отработку отказа, она остановится, но виртуальная машина не будет реплицирована повторно.  
