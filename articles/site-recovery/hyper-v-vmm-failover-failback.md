---
title: Настройка отработки отказа и восстановления размещения на дополнительном сайте Hyper-V с Azure Site Recovery
...
1. В окне **Параметры** > **реплицированные элементы** щелкните виртуальную машину > **отработку отказа**.
...
> [!WARNING]
> **Не отменяйте отработку отказа**. перед запуском отработки отказа РЕПЛИКАЦИЯ виртуальной машины будет остановлена. Если отменить выполняющуюся отработку отказа, она остановится, но виртуальная машина не будет реплицирована повторно.  
