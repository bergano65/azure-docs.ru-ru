...
- Узнайте больше об [обновлении и требованиях SHA-2](https://aka.ms/SHA-2KB).
...
**Компонент** | **Дополнительные сведения**
--- | ---
Новые предупреждения сервера обработки | Мы добавили новые оповещения сервера обработки. [Дополнительные сведения](vmware-physical-azure-monitor-process-server.md) 
...
**Компонент** | **Дополнительные сведения**
--- | ---
**Репликация добавленных дисков** | Включите репликацию для дисков данных, добавленных на виртуальную машину Azure, которая уже включена для аварийного восстановления. [Дополнительные сведения](azure-to-azure-enable-replication-added-disk.md)
**Автоматические обновления** | При настройке автоматического обновления для расширения службы Mobility Service, работающего на виртуальных машинах Azure, для которых разрешено аварийное восстановление, теперь можно выбрать имеющуюся учетную запись службы автоматизации, а не использовать учетную запись по умолчанию, созданную Site Recovery. [Дополнительные сведения](azure-to-azure-autoupdate.md)
...
**Компонент** | **Дополнительные сведения**
--- | ---
**Мониторинг сервера обработки** | Для аварийного восстановления локальных виртуальных машин VMware и физических серверов, мониторинга и устранения неполадок, связанных с сервером обработки, с улучшенными отчетами о работоспособности сервера и оповещениями. [Дополнительные сведения](vmware-physical-azure-monitor-process-server.md) 
...
[Дополнительные сведения](azure-vm-disaster-recovery-with-accelerated-networking.md)
...
Обновления не требуют перезагрузки виртуальной машины и не влияют на репликацию. [Дополнительные сведения](azure-to-azure-autoupdate.md)
...
**Поддержка шифрования дисков** | Добавлена поддержка аварийного восстановления виртуальных машин Azure, зашифрованных с помощью шифрования дисков Azure (ADE), с помощью приложения Azure AD. [Дополнительные сведения](azure-to-azure-how-to-enable-replication-ade-vms.md)
...
**Аварийное восстановление между подписками** | Поддержка репликации виртуальных машин Azure в одном регионе в другой регион в другой подписке в том же клиенте Azure Active Directory. [Дополнительные сведения](https://aka.ms/cross-sub-blog)
