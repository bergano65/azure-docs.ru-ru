...
## <a name="update-september-2020"></a>Обновление (Сентябрь 2020)
...
**SSD ценовой категории "Стандартный"** | Теперь можно настроить аварийное восстановление для виртуальных машин Azure с помощью [SSD (цен. Категория "Стандартный") дисков](../virtual-machines/disks-types.md#standard-ssd).
...
**Каталогов** | Добавлена поддержка для этих каталогов, настроенных как отдельные разделы или файловые системы, которые не находятся на одном системном диске:<br/><br/> /(root),/Boot,/usr,/usr/local,/var,/etc.
