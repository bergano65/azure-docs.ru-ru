...
**SSD (цен. категория "Стандартный")** | Теперь можно настроить аварийное восстановление для виртуальных машин Azure с помощью [SSD (цен. Категория "Стандартный") дисков](../virtual-machines/disks-types.md#standard-ssd).
