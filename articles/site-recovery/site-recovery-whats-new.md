...
- Начиная с версии 9.30. x. x расширения службы Mobility Service (для виртуальных машин Azure) и агента службы Mobility Service (для VMware или физических компьютеров), в некоторых операционных системах должны быть установлены обновления стека обслуживания и SHA-2. Подробные сведения приведены в таблице ниже.
- Установите обновление и SHA-2 в соответствии со связанной базы знаний.
