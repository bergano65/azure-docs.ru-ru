...
Виртуальные машины Azure теперь поддерживают виртуальные машины для шифрования неактивных компьютеров с ключами, управляемыми клиентом. [Дополнительные сведения](azure-to-azure-how-to-enable-replication-cmk-disks.md)
