...
**Возможность** | **Сведения**
--- | ---
Учетная запись хранения | Site Recovery теперь поддерживает использование учетной записи хранения с включенным управлением доступом на основе ролей (RBAC). Дополнительные [сведения](../storage/common/storage-account-manage.md#access-control) об управлении доступом для учетных записей хранения. 
