...
**Операционная система** | **Виртуальная машина Azure** | **ВИРТУАЛЬная машина VMware или физический компьютер**
--- | --- | ---
...
**Отработка отказа** | Улучшено время отработки отказа для виртуальных машин VMware, где storvsc и всбус не являются драйверами загрузки.
