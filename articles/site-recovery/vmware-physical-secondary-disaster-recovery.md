...
**Реплицированный** |Диск (Windows и Linux) |Том в Windows<br> Диск в Linux
...
- InMage_UA_8.0.7.0_SLES11-SP4-64_GA_03Dec2018_release.tar.gz
  ...
  5. **vContinuum Server**: Скопируйте **InMage_Scout_vContinuum_MT_8.0,7.0_Windows_GA_27Dec2018_release. exe** на сервер.  Убедитесь, что вы закрыли мастер vContinuum. Дважды щелкните файл, чтобы запустить его.
  ...
  7. **Исходный сервер Windows**. чтобы обновить единый агент, скопируйте **файл InMage_UA_8.0,7.0_Windows_GA_27Dec2018_release. exe** на исходный сервер. Дважды щелкните файл, чтобы запустить его. 
...
2. Дополнительные сведения об установке, защите и восстановлении см. в следующих документах:
   ...
   * [Руководством пользователя](https://aka.ms/asr-scout-user-guide)
...
- UA обновления 4 BITS for RHEL5, OL5, OL6, SUSE 10, SUSE 11: UA_\<Linux OS>_8.0,4.0_GA_Update_4_9035261_26Sep16. tar. gz
  1. Извлеките ZIP-файлы.
