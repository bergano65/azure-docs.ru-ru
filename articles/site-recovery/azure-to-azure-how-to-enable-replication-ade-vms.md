...
>[!NOTE]
>В настоящее время Azure Site Recovery поддерживает только виртуальные машины с поддержкой шифрования дисков Azure, работающие под управлением ОС Windows.
