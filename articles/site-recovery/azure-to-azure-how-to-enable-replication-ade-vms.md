...
Можно использовать [Скрипт](#copy-disk-encryption-keys-to-the-dr-region-by-using-the-powershell-script) , чтобы скопировать ключи шифрования в целевой регион, а затем обновить целевые параметры шифрования в **хранилище служб восстановления**  >  *Свойства реплицированного элемента*  >  **Properties**  >  **, вычисление и сеть**.
