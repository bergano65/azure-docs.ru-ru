...
ms.locfileid: "87097893"
---
# <a name="replicate-machines-with-private-endpoints"></a>Репликация компьютеров с частными конечными точками

Azure Site Recovery позволяет использовать частные конечные точки [частной связи Azure](../private-link/private-endpoint-overview.md) для репликации компьютеров из изолированной виртуальной сети. Поддержка закрытой конечной точки для доступа к хранилищу восстановления поддерживается в следующих регионах:
