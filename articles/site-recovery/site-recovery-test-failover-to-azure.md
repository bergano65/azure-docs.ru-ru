...
![Тестовая отработка отказа](./media/site-recovery-test-failover-to-azure/TestFailover.png)
...
![Тестовая отработка отказа](./media/site-recovery-test-failover-to-azure/TestFailoverJob.png)
...
**Тип отработки отказа** | **Location** | **Действия**
--- | --- | ---
