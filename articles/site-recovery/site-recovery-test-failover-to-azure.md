...
6. Чтобы инициировать подключение по протоколу RDP к виртуальной машине Azure, необходимо [добавить общедоступный IP-адрес](/archive/blogs/srinathv/how-to-add-a-public-ip-address-to-azure-vm-for-vm-failed-over-using-asr) в сетевом интерфейсе виртуальной машины, для которой выполнена отработка отказа.
