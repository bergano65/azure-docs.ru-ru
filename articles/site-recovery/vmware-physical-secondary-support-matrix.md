---
title: Поддержка VMware/восстановления физического аварийного происшествия на вторичном сайте с восстановлением сайта Azure
...
Сценарий восстановления сайта для репликации между нахождения vMware или физическими центрами обработки данных подходит к концу поддержки.

- С августа 2018 года сценарий не может быть настроен в хранилище служб восстановления, а программное обеспечение InMage Scout не может быть загружено из хранилища. Это не повлияет на работоспособность имеющихся развертываний.
...
|Обновления компонентов | В пакет обновлений Scout входят обновления для всех компонентов, включая сервер RX, сервер конфигурации, главный целевой сервер и целевой сервер обработки, серверы vContinuum и исходные серверы, которые нужно защитить.<br/><br/> Ознакомьтесь с [дополнительными сведениями](vmware-physical-secondary-disaster-recovery.md#download-and-install-component-updates).|
