---
title: Какие рабочие нагрузки можно защитить с помощью службы Azure Site Recovery? | Документы Майкрософт
...
* Интеграция с SQL Server AlwaysOn и партнерство с другими технологиями репликации на уровне приложений, включая репликацию AD, SQL AlwaysOn, группы доступности базы данных Exchange (DAG).
...
Служба Site Recovery может реплицировать любое приложение, работающее на поддерживаемой машине. Кроме того, мы сотрудничаем с командами разработчиков продуктов для выполнения дополнительного тестирования приложений, указанных в таблице.
...
| Веб-приложения (IIS, SQL) |Y |Y |Y |Y |Y|
...
| Exchange (не DAG) |Y |Y |Y |Y |Y|
| Удаленный рабочий стол/VDI |Y |Y |Y |Y |Y|
...
| Файловый сервер Windows |Y |Y |Y |Y |Y|
| Citrix XenApp и XenDesktop |Y|Н/Д |Y |Н/Д |Y |
