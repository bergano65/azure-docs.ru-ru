...
* Интеграция с SQL Server AlwaysOn и партнерство с другими технологиями репликации на уровне приложения, включая группы доступности базы данных Exchange репликации SQL AlwaysOn, AD (DAG).
