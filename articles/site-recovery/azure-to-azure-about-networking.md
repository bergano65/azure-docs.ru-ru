...
- IP-адреса конечной точки службы Site Recovery доступны в [XML-файле](https://aka.ms/site-recovery-public-ips) и зависят от вашего целевого расположения. Рекомендуется разрешить доступ к тегу **"азуреситерековери"** для Site Recovery доступа к службе.
...
> [!NOTE]
> Рекомендуется использовать **тег азуреситерековери** вместо IP-адресов, чтобы разрешить доступ к **службе Site Recovery**.
