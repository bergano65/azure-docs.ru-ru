...
Если вы используете прокси-сервер брандмауэра на основе IP-адресов или NSG для управления исходящими подключениями, эти диапазоны IP-адресов должны быть разрешены.
...
Если вы предпочитаете использовать диапазоны IP-адресов Site Recovery (не рекомендуется), ознакомьтесь с таблицей ниже.
   ...
   **Цель** | **IP-адрес Site Recovery** |  **IP-адрес мониторинга Site Recovery**
   ...
   Республика Корея, центральный регион | 52.231.28.253 | 52.231.32.85
   ...
   Восточный регион US DoD | 52.181.164.103 | 52.181.162.129
   Центральный регион US DoD | 52.182.95.237 | 52.182.90.133
