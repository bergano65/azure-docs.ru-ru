---
title: Запустите упражнение по восстановлению аварийного восстановления NHyper-V на второстепенном объекте с восстановлением сайта Azure
...
В этой процедуре описывается, как запустить тестовую отработку отказа для плана восстановления. Кроме того, вы можете запустить failover для одной виртуальной машины на вкладке **Виртуальные машины.**

1. Выберите **планы** > восстановления*recoveryplan_name*. Нажмите **Failover** > **Тест Failover**.
...
5. Когда все будет готово, щелкните **Cleanup test failover** (Очистить тестовую отработку отказа) в плане восстановления. В **Notes**, запись и сохранить любые наблюдения, связанные с тестом неудачи. На этом шаге удаляются виртуальные машины и сети, созданные Site Recovery при тестовой отработке отказа. 
