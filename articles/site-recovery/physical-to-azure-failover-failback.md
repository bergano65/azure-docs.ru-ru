...
1. В **параметрах** > хранилища > **реплицированных элементов**щелкните правой кнопкой мыши компьютер, для которого была выполнена отработка отказа > **повторно защитить**.
...
1. В **параметрах** > хранилища, >**реплицированные элементы**, выберите восстановленные виртуальные машины со сбоями и щелкните **повторно защитить**.
