...
- Если ваша виртуальная машина была развернута как одноэкземплярная или как часть группы доступности и вы хотите расширить Соглашения об уровне обслуживания относительно доступности, вы можете **переместить виртуальные машины в группу доступности**. 
...
> [!NOTE]
> Подробные указания по этим шагам приведены в документации по каждому из сценариев, как описано здесь.
