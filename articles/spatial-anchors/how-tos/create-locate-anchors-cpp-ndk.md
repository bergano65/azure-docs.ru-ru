...
Дополнительные сведения см. в статье о структуре [CloudSpatialAnchorSession](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession).
...
Дополнительные сведения см. в статье о структуре [SessionConfiguration](/cpp/api/spatial-anchors/ndk/sessionconfiguration).
...
Дополнительные сведения см. в статье о делегате [TokenRequiredDelegate](/cpp/api/spatial-anchors/ndk/tokenrequireddelegate).
...
Дополнительные сведения см. в статье о методе [Start](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#start).
...
Дополнительные сведения см. в статье о методе [ProcessFrame](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#processframe).
...
Дополнительные сведения см. в статье о делегате [SessionUpdatedDelegate](/cpp/api/spatial-anchors/ndk/sessionupdateddelegate).
...
Дополнительные сведения см. в статье о структуре [CloudSpatialAnchor](/cpp/api/spatial-anchors/ndk/cloudspatialanchor).
...
Дополнительные сведения см. в статье о методе [GetSessionStatusAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#getsessionstatusasync).
...
Дополнительные сведения см. в статье о методе [AppProperties](/cpp/api/spatial-anchors/ndk/cloudspatialanchor#appproperties).
...
Дополнительные сведения см. в статье о методе [UpdateAnchorPropertiesAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#updateanchorpropertiesasync).
...
Дополнительные сведения см. в статье о методе [GetAnchorPropertiesAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#getanchorpropertiesasync).
...
Дополнительные сведения см. в статье о методе [Expiration](/cpp/api/spatial-anchors/ndk/cloudspatialanchor#expiration).
...
Дополнительные сведения см. в статье о методе [CreateWatcher](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#createwatcher).
...
Дополнительные сведения см. в статье о делегате [AnchorLocated](/cpp/api/spatial-anchors/ndk/anchorlocateddelegate).
...
Дополнительные сведения см. в статье о методе [DeleteAnchorAsync](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#deleteanchorasync).
...
Дополнительные сведения см. в статье о методе [Stop](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#stop).
...
Дополнительные сведения см. в статье о методе [Reset](/cpp/api/spatial-anchors/ndk/cloudspatialanchorsession#reset).
