---
title: Создание и найдите привязки, использующие Azure пространственных привязки Objective-c | Документация Майкрософт
...
ms.locfileid: "57850740"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-objective-c"></a>Создание и найдите привязки, использующие Azure пространственных привязки Objective-c
...
Пространственные привязки Azure позволяют вам совместно использовать привязки на различных устройствах. Он поддерживает несколько сред разработки. В этой статье мы подробно рассмотрим как это делать в Objective-C.
