---
title: Создание и найдите привязки, использующие Azure пространственных привязки в C + +/ NDK | Документация Майкрософт
...
ms.locfileid: "57857391"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-cndk"></a>Создание и найдите привязки, использующие Azure пространственных привязки в C + +/ NDK
...
Пространственные привязки Azure позволяют вам совместно использовать привязки на различных устройствах. Он поддерживает несколько сред разработки. В этой статье мы подробно рассмотрим как это сделать в C + +/ NDK.
