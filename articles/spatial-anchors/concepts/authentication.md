...
Маркер доступа Azure AD извлекается с использованием библиотеки ADAL, как описано в следующей документации: https://docs.microsoft.com/azure/active-directory/develop/v1-overview; необходимо выполнить шаги, перечисленные в разделе «Краткие руководства», которые включают:
