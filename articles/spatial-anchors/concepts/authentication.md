...
1.  Настройка на портале Microsoft Azure.
    1.  Зарегистрируйте приложение в AAD.
        ...
        4.  На странице этого приложения нажмите **Параметры**, а затем откройте вкладку **Ключи**. Введите имя ключа, выберите длительность и нажмите **Сохранить**. Не забудьте сохранить значение ключа, которое отображается в это время, так как его необходимо включить в код веб-службы.
