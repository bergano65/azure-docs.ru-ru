...
В этой статье вы узнаете о различных способах проверки подлинности в пространственных привязках Azure из приложения или веб-службы. Кроме того, вы узнаете о способах использования управления доступом на основе ролей в Azure Active Directory (Azure AD) для управления доступом к учетным записям пространственных привязок.
