...
1.    Зарегистрируйте приложение в AAD.
        ...
        3.    Введите имя приложения, выберите для него тип **Веб-приложение или API** и введите URL-адрес аутентификации для своей службы. Нажмите кнопку **создания** .
