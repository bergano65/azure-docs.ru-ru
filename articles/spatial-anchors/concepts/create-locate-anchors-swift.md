---
title: Создание и найдите привязки, использующие Azure пространственных привязки в Swift | Документация Майкрософт
...
ms.locfileid: "57863616"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-swift"></a>Создание и найдите привязки, использующие Azure пространственных привязки в Swift
...
Пространственные привязки Azure позволяют вам совместно использовать привязки на различных устройствах. Он поддерживает несколько сред разработки. В этой статье мы подробно рассмотрим как это сделать в Swift.
