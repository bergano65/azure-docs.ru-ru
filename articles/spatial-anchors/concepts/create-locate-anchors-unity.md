---
title: Создание и найдите привязки, использующие привязки пространственных Azure в Unity | Документация Майкрософт
...
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-unity"></a>Создание и найдите привязки, использующие привязки пространственных Azure в Unity
...
Пространственные привязки Azure позволяют вам совместно использовать привязки на различных устройствах. Он поддерживает несколько сред разработки. В этой статье мы подробно рассмотрим как это сделать в Unity.
