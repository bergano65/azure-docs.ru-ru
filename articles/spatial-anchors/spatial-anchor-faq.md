...
**Ответ.** Все данные хранятся в зашифрованном виде с использованием ключа шифрования данных, управляемого Майкрософт.
...
**Ответ.** Как и для всех служб Azure, мы стремимся обеспечить доступность выше 99,9%. 
