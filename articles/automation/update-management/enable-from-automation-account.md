...
* [Виртуальная машина Azure](../../virtual-machines/windows/quick-create-portal.md)или виртуальная машина или сервер, зарегистрированные на серверах с поддержкой ARC (Предварительная версия). На виртуальных машинах или серверах, не относящихся к Azure, необходимо установить [агент log Analytics](../../azure-monitor/platform/log-analytics-agent.md) для Windows или Linux и создавать отчеты для рабочей области, связанной с учетной записью службы автоматизации Управление обновлениями включен в. Мы рекомендуем установить агент Log Analytics для Windows или Linux, сначала подключив компьютер к [серверам с поддержкой дуги Azure](../../azure-arc/servers/overview.md), а затем используя политику Azure, чтобы назначить встроенную политику [развертывания log Analytics Agent для *Linux* или *Windows* Azure Arc](../../governance/policy/samples/built-in-policies.md#monitoring) . Если вы планируете также отслеживать компьютеры с Azure Monitor для виртуальных машин, используйте инициативу [Enable Azure Monitor для виртуальных машин](../../governance/policy/samples/built-in-initiatives.md#monitoring) .
