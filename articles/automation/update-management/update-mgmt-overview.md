...
* Из [учетной записи службы автоматизации Azure](update-mgmt-enable-automation-account.md) для одного или нескольких компьютеров Azure.
...
* [на одной виртуальной машине](update-mgmt-enable-vm.md);
* [на нескольких виртуальных машинах](update-mgmt-enable-portal.md);
