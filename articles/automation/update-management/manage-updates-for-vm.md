...
На компьютере с Windows проверка на соответствие по умолчанию выполняется каждые 12 часов. В дополнение к запланированному сканированию проверка соответствия обновлений инициируется в течение 15 минут после перезапуска агента Log Analytics для Windows, до установки обновления и после установки обновления. Также важно ознакомиться с нашими рекомендациями по [настройке центр обновления Windows клиента](configure-wuagent.md) с Управление обновлениями во избежание проблем, которые не позволяют правильно управлять.
