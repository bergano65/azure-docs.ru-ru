...
ms.locfileid: "92222864"
---
# <a name="enable-update-management-from-an-azure-vm"></a>Включение Управления обновлениями на виртуальных машинах Azure

Эта статья содержит сведения о том, как из виртуальной машины Azure включить функцию [Управление обновлениями](overview.md) для других виртуальных машин. Чтобы включить большое количество виртуальных машин Azure, сначала нужно включить существующую виртуальную машину через функцию "Управление обновлениями".
