...
[![Представление оценки Управление обновлениями для виртуальной машины Azure](./media/view-update-assessments/update-assessment-azure-vm.png)](./media/view-update-assessments/update-assessment-azure-vm-expanded.png#lightbox)
...
[![Представление оценки Управление обновлениями для серверов с поддержкой Arc](./media/view-update-assessments/update-assessment-arc-server.png)](./media/view-update-assessments/update-assessment-arc-server-expanded.png#lightbox)
...
[![Представление Управление обновлениями по умолчанию](./media/overview/update-management-view.png)](./media/overview/update-management-view-expanded.png#lightbox)
...
[![Просмотр состояния обновления](./media/view-update-assessments/missing-updates.png)](./media/view-update-assessments/missing-updates-expanded.png#lightbox)
...
[![Просмотр результатов запроса журнала](./media/view-update-assessments/logsearch-results.png)](./media/view-update-assessments/logsearch-results-expanded.png#lightbox)
...
![Отсутствующие обновления](./media/view-update-assessments/automation-view-update-assessments-missing-updates.png)
...
Следующим этапом процесса является [развертывание обновлений](deploy-updates.md) на компьютерах, не соответствующих требованиям, и проверка результатов развертывания.
