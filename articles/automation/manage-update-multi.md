...
Вы можете использовать Управление обновлениями службы автоматизации Azure для управления обновлениями и исправлениями для виртуальных машин Windows и Linux. В учетной записи [службы автоматизации Azure](automation-offering-get-started.md) вы можете сделать следующее:

- подключить виртуальные машины;
- оценить состояние доступных обновлений;
- запланировать установку необходимых обновлений;
- Проверьте результаты развертывания, чтобы убедиться, что обновления были успешно применены ко всем виртуальным машинам, для которых включен Управление обновлениями.

Дополнительные сведения о требованиях к системе для Управление обновлениями см. в статье [Управление обновлениями требования клиента](automation-update-management.md#client-requirements).

## <a name="prerequisites"></a>Предварительные условия

* Виртуальная машина или компьютер, где установлена одна из поддерживаемых операционных систем.
* Доступ к репозиторию обновлений для виртуальных машин Linux, подключенных к Управление обновлениями.
...
Если управление обновлениями недавно включено для компьютеров, возможно, они еще не оценивались. Состояние соответствия для этих компьютеров — `Not assessed`. Вот список возможных значений состояния соответствия:

- `Compliant`: Компьютеры, на которых не пропущены критические или обновленные обновления для системы безопасности.
- `Non-compliant`: Компьютеры, на которых отсутствует по крайней мере одно критическое или обновление для системы безопасности.
- `Not assessed`: Данные оценки обновления не были получены с компьютера в течение ожидаемого времени. Для компьютеров Linux ожидаемым периодом является последний час. Для компьютеров Windows ожидаемый период — это последние 12 часов.

Чтобы просмотреть состояние агента, выберите ссылку в столбце **готовность агента обновления** . Откроется область гибридной рабочей роли со сведениями о состоянии этой роли. Ниже приведен пример агента, который долгое время не был подключен к решению "Управление обновлениями".
...
После включения Управление обновлениями открывается область Управление обновлениями. На вкладке **Отсутствующие обновления** можно просмотреть список отсутствующих обновлений.
...
- **Компьютеры, на которые нужно установить обновления**. Выберите "Сохраненные поисковые запросы", группу "Импортировано" или выберите "Компьютеры", чтобы выбрать компьютеры, которые требуется обновить.
   ...
   Если выбраны **Компьютеры**, готовность компьютера отображается в столбце **готовность агента обновления** . Вы можете просмотреть состояние работоспособности компьютера перед планированием развертывания обновлений. Дополнительные сведения о различных способах создания групп компьютеров в журналах Azure Monitor см. в разделе [группы компьютеров в журналах Azure Monitor](../azure-monitor/platform/computer-groups.md) .

  ![Область "Новое развертывание обновления"](./media/manage-update-multi/update-select-computers.png)

- **Классификации обновлений**. Выберите типы программного обеспечения, которые будут включены в развертывание обновления. Описание типов классификации см. в разделе [классификации обновлений](automation-view-update-assessments.md#update-classifications). Ниже приведены типы классификации:
...
- `Not attempted`: Обновление не установлено, так как было доступно недостаточное время на основе определенного периода обслуживания.
- `Succeeded`: Обновление прошло.
- `Failed`: Сбой обновления.
...
Дополнительные сведения о Управление обновлениями журналах, выходных данных и ошибках см. в разделе [записи об обновлениях запросов для управление обновлениями](automation-update-management-query-logs.md).
