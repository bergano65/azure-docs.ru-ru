...
Сведения о том, как включить Управление обновлениями для виртуальных машин и компьютеров Windows, отличных от Azure, см. в статье [Подключение компьютеров Windows к службе Azure Monitor в Azure](../log-analytics/log-analytics-windows-agent.md).

Сведения о том, как включить Управление обновлениями для виртуальных машин и компьютеров Linux, отличных от Azure, см. в статье [Подключение компьютеров Linux к Azure Monitorным журналам](../log-analytics/log-analytics-agent-linux.md).
