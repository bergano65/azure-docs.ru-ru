...
- **Скрипты предварительного и последующего выполнения**: выберите скрипты, которые будут выполняться до и после развертывания. Дополнительные сведения см. в разделе [Управление скриптами предварительного и последующего выполнения](pre-post-scripts.md).
