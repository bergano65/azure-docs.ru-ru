...
>[!NOTE]
>При планировании развертывания обновлений создается ресурс [расписания](shared-resources/schedules.md) , связанный с модулем **установки Patch-микрософтомскомпутерс** , который обрабатывает развертывание обновлений на целевых компьютерах. Если вы удаляете ресурс расписания из портал Azure или с помощью PowerShell после создания развертывания, он прерывает запланированное развертывание обновлений и выдает ошибку при попытке перенастроить ее на портале. Ресурс расписания можно удалить только путем удаления соответствующего расписания развертывания.
>
