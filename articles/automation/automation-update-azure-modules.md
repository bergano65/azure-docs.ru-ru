...
> [!NOTE]
> Новый [модуль Azure PowerShell Az](/powershell/azure/new-azureps-module-az?view=azurermps-6.13.0) не поддерживается в службе автоматизации Azure.
