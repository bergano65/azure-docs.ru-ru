...
description: В этой статье описывается, как использовать механизм контроля доступа на основе ролей (RBAC), который обеспечивает управление доступом к ресурсам Azure.
