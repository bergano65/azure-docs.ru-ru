...
> [!NOTE]
> Гибридные рабочие роли Runbook не поддерживаются в китайской версии Azure.
...
| Восточная часть Австралии |ae-jobruntimedata-prod-su1.azure-automation.net</br>ae-agentservice-prod-1.azure-automation.net |
