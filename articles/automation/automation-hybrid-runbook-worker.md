...
В дополнение к стандартным адресам и портам, необходимым для гибридной рабочей роли Runbook, Управление обновлениями предъявляют дополнительные требования к конфигурации сети, описанные в разделе « [планирование сети](update-management/update-mgmt-overview.md#ports) ».
...
Максимальное число групп гибридных рабочих ролей на учетную запись службы автоматизации — 4000. оно применимо как для системных & пользователей, так и для гибридных рабочих ролей. При наличии более 4 000 компьютеров для управления рекомендуется создать дополнительные учетные записи службы автоматизации.
