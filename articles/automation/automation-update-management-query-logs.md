...
| Type | *Обновление* | 
| UpdateClassification | Указывает тип обновлений, которые могут быть применены. Для Windows:<br> *Критические обновления*<br> *Обновление системы безопасности*<br> *накопительные пакеты обновления;*<br> *пакеты дополнительных компонентов;*<br> *Сервисные пакеты*<br> *обновления определений;*<br> *Инструменты*<br> *Обновления*. Для Linux:<br> *критические обновления и обновления для системы безопасности;*<br> *Прочее* |
...
| УстановкаСтатус | Возможные состояния установки обновления на клиентском компьютере,<br> *Не запущен* - работа еще не сработала.<br> *FailedToStart* - не в состоянии запустить задание на машине.<br> *Неудачно* - работа началась, но не сработала за исключением.<br> *InProgress* - работа в процессе.<br> *ОбслуживаниеWindowExceeded* - если выполнение осталось, но интервал обслуживания окна достигнута.<br> *Успешно* - работа удалась.<br> *InstallFailed* - обновление не удалось установить успешно.<br> *Невключено*<br> *Исключена.* |
| KBID | Идентификатор базы знаний для обновления Windows. | 
| ManagementGroupName | Название группы управления менеджером операций или рабочего пространства Log Analytics. |
