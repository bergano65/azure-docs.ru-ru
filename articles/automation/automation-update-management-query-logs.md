...
| упдатесеверити | Оценка серьезности уязвимости. Возможны следующие значения.<br> *Критическая*<br> *Важно*<br> *Средний*<br> *Низкая* |
...
| MSRCSeverity | Оценка серьезности уязвимости. Возможны следующие значения.<br> *Критическая*<br> *Важно*<br> *Средний*<br> *Низкая* |  
| KBID | Идентификатор статьи базы знаний для центра обновления Windows. |
| ManagementGroupName | Имя Operations Manager группы управления или Log Analytics рабочей области. |
