...
1. На странице сведений **Виртуальная машина** выберите **+ Подключить**.
   ...
   > [!IMPORTANT]
   > Это должна быть Azure Resource Manager виртуальная машина под управлением [поддерживаемой операционной системы](automation-dsc-overview.md#operating-system-requirements).
