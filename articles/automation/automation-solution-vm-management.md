...
> [!NOTE]
> Ограничения на имя ВМ и группу ресурсов в значительной степени являются результатом переменного размера. Смотрите [переменные активы в Azure Automation](https://docs.microsoft.com/azure/automation/shared-resources/variables).
