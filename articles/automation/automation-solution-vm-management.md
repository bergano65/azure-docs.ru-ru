...
1. Добавьте теги **sequencestart** и **sequencestop**, значением которых является положительное целое число, для виртуальных машин, которые вы планируете добавить в переменную **VMList**. 
