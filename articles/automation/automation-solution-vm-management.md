...
Существуют определенные разрешения, которые пользователь должен обладать для развертывания виртуальных машин запуска и остановки во время отключить решение часов. Эти разрешения различаются, при использовании предварительно созданной рабочей области учетной записи службы автоматизации и Log Analytics или создать новые во время развертывания. Если вы являетесь участником подписки и глобального администратора в клиенте Azure Active Directory, вы не обязательно должны настроить следующие разрешения. Если нужно настроить пользовательскую роль, см. в разделе разрешения, необходимые ниже или не соответствующие права.
...
- Соадминистратор для подписки - это требуется только для создания классической учетной записи запуска
- Быть частью [Azure Active Directory](../active-directory/users-groups-roles/directory-assign-admin-roles.md) **разработчик приложения** роли. Дополнительные сведения о настройке записей см. в разделе [разрешения для настройки учетных записей запуска от имени](manage-runas-account.md#permissions).
- Участник для подписки или следующие разрешения.
...
1. Из учетной записи службы автоматизации в разделе **ресурсы, связанные с**выберите **рабочей области связанные**.
1. Выберите **перейдите к рабочей области**.
