...
|Модуль Runbook | Параметры | Description (Описание)|
| --- | --- | ---|
...
|Переменная | Description (Описание)|
|---------|------------|
...
|SourceSystem | Указывает исходную систему для отправленных данных. Для службы автоматизации значением является OpsManager.|
|StreamType | Тип потока задания. Возможные значения:<br>- Progress<br>— Output;<br>Предупреждение<br>error<br>debug<br>- Verbose.|
|Время | Дата и время выполнения задания Runbook.|
