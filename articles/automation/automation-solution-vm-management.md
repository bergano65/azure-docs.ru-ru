...
Эта функция использует командлет [Start-AzVm](https://docs.microsoft.com/powershell/module/az.compute/start-azvm) для запуска виртуальных машин. Для остановки виртуальных машин используется [остановить-AzVM](https://docs.microsoft.com/powershell/module/az.compute/stop-azvm) .
