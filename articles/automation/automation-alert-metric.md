...
ms.locfileid: "100593956"
---
# <a name="monitor-runbooks-with-metric-alerts"></a>Мониторинг модулей runbook с помощью оповещений метрик

В этой статье вы узнаете, как создать [оповещение метрики](../azure-monitor/alerts/alerts-metric-overview.md) на основе состояния завершения Runbook.
