...
Когда компиляция успешно завершена, новая конфигурация отображается во вкладке **Компиляция конфигураций.** Как только он будет виден в этой вкладке, он может быть назначен управляемому узлам, используя шаги в [переназначении узла другой конфигурации узла.](automation-dsc-getting-started.md#reassigning-a-node-to-a-different-node-configuration)
