...
* Возможно, потребуется [импортировать](shared-resources/modules.md)/[обновить модули Azure](automation-update-azure-modules.md) на основе используемых командлетов.
