...
> [!NOTE]
> Использование веб-перехватчика для запуска модуля runbook Python не поддерживается.
...
## <a name="create-a-new-runbook"></a>Создать новый Runbook
...
1. Прокрутите экран вправо до области **MyFirstRunbook-Python**.
   Параметры в верхней части позволяют запустить модуль runbook, просматривать модуль runbook или запланировать его запуск в определенное время в будущем.
