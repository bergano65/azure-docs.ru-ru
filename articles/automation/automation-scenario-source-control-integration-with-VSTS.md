...
![Коллекция PowerShell](media/automation-scenario-source-control-integration-with-VSTS/VSTSPowerShellGallery.png)
...
![Публикация модуля Runbook](media/automation-scenario-source-control-integration-with-VSTS/VSTSPublishRunbook.png)
...
![Веб-перехватчик GIT](media/automation-scenario-source-control-integration-with-VSTS/VSTSGitWebhook.png)
...
![Перехватчик события](media/automation-scenario-source-control-integration-with-VSTS/VSTSServiceHook.png)
...
![Синхронизация выходных данных Runbook](media/automation-scenario-source-control-integration-with-VSTS/VSTSSyncRunbookOutput.png)
