...
> [!NOTE]
> Включение полного Отслеживание измененийного решения может привести к дополнительным расходам. Дополнительные сведения см. в разделе [цены](https://azure.microsoft.com/en-us/pricing/details/automation/)на автоматизацию.
...
| Службы Windows | от 10 секунд до 30 минут</br> По умолчанию: 30 минут |
