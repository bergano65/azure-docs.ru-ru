...
При создании нового сертификата в службу автоматизации Azure передается CER- или PFX-файл. Если пометить сертификат как экспортируемый, его можно будет переместить из хранилища сертификатов службы автоматизации Azure. Если он не экспортируемый, то он будет использоваться только для подписи в модуле Runbook или конфигурации DSC. Для службы автоматизации Azure необходимо, чтобы у сертификата был поставщик: **поставщик служб шифрования Enhanced RSA и AES корпорации Майкрософт**.
