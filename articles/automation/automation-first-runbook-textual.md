...
1. После завершения задания Runbook на панели "тест" отображаются выходные данные. В этом случае вы увидите текст **Hello World**.
...
1. Как только состояние модуля Runbook изменится на **Выполнено**, щелкните **Выходные данные**. Откроется страница выходных данных, на которой можно просмотреть сообщение **Hello World** .
