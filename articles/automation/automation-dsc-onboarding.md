...
Повторная регистрация может быть выполнена так же, как изначально вы зарегистрировали узел, используя любой из методов адаптации, описанных в этом документе. Отменить регистрацию узла в конфигурации состояния службы автоматизации Azure перед повторной регистрацией не требуется.
