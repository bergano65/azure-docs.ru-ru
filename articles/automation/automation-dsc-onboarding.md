...
## <a name="onboarding-physicalvirtual-windows-machines"></a>На борту физических / виртуальных windows-машин

Вы можете находиться на борту серверов Windows, работающих на месте или в других облачных средах (включая экземпляры AWS EC2) в azure Automation State Configuration. Серверы должны иметь [исходящий доступ к Azure](automation-dsc-overview.md#network-planning).
...
1. Используя портал Azure или cmdlets, убедитесь, что машины, которые будут на борту, отображаться как узлы конфигурации состояния, зарегистрированные в учетной записи Azure Automation.

## <a name="onboarding-physicalvirtual-linux-machines"></a>На борту физических / виртуальных Linux-машин
