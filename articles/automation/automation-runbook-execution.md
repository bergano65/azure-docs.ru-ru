...
|Сценарии, требующие доступа к инструментарию WMI|гибридный компонент Runbook Worker|Заданий, выполняемых в "песочницах" в облаке [не имеют доступа к инструментарию WMI](#device-and-application-characteristics)|
