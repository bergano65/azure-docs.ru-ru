...
Служба автоматизации Azure использует [Azure Monitor](../azure-monitor/overview.md) для наблюдения за операциями компьютера. Для выполнения операций требуются рабочая область Log Analytics и [агенты Log Analytics](../azure-monitor/platform/log-analytics-agent.md).
