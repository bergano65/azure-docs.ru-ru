...
Runbooks в Azure Automation может работать либо на песочнице Azure, либо на [гибридном Runbook Worker.](automation-hybrid-runbook-worker.md) Вы можете легко запустить большинство runbooks в песочнице Azure, которая является общей средой, которую могут использовать несколько заданий. Для заданий, использующих одну и ту же песочницу, применяются ее ограничения ресурсов.
...
|Взаимодействие с местными службами|Гибридная рабочая роль Runbook|Может иметь прямой доступ к принимающей машине.|
...
|Используйте runbooks или модули, требующие версии .NET Framework, отличающиеся от 4.7.2|Гибридная рабочая роль Runbook|Автоматизация песочницы имеют .NET Framework 4.7.2, и нет никакого способа обновить версию.|
...
|Запуск скриптов, требующих доступа к инструменту управления Windows (WMI)|Гибридная рабочая роль Runbook|Вакансии, работающие в песочницах в облаке, не могут получить доступ к WMI. |
