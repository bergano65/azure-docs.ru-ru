---
title: Диагностика Linux Гибридный Runbook работника - Управление обновлениями Azure
description: Узнайте, как устранить неполадки и решить проблемы с гибридным Runbook Работника Azure Automation на Linux, который поддерживает управление обновлением.
services: automation
author: mgoedtel
ms.author: magoedte
ms.date: 12/03/2019
...
ms.locfileid: "79278302"
---
# <a name="understand-and-resolve-linux-hybrid-runbook-worker-health-for-update-management"></a>Понять и решить Linux Гибридный Runbook работы работника для управления обновлениями
