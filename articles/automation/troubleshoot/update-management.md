...
Старые обновления отображаются в Управление обновлениями учетной записи Azure, хотя они отсутствуют, несмотря на то, что они были заменены. Заменяемое обновление является ненужной установкой, так как доступно более позднее обновление, устраняющее ту же уязвимость. Управление обновлениями игнорирует заменяемое обновление и делает его неприменимым в пользу замены заменяемого обновления. Сведения о связанных проблемах см. в разделе [обновление заменено](https://docs.microsoft.com/windows/deployment/update/windows-update-troubleshooting#the-update-is-not-applicable-to-your-computer).

### <a name="cause"></a>Причина

Замененные обновления не отмечены как отклоненные, чтобы их можно было считать неприменимыми.

### <a name="resolution"></a>Решение

Если заменяемое обновление преобразуется в 100% неприменимо, следует изменить состояние утверждения этого обновления на **отклоненное**. Чтобы сделать это для всех обновлений, выполните следующие действия.
...
2. Проверьте заменяемое обновление, чтобы убедиться в том, что 100 процентов неприменимо. 
...
7. Для служб WSUS вручную очистите все заменяемые обновления, чтобы обновить инфраструктуру.
