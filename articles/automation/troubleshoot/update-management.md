...
3. Раздел [Планирование сети](../update-management/update-mgmt-overview.md#ports) содержит информацию о том, как создать список портов и адресов, необходимых для Управления обновлениями, а затем убедиться, что компьютер соответствует этим требованиям.
