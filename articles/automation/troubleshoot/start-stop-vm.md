...
* Проверьте [потоки заданий](../automation-runbook-execution.md#viewing-job-status-from-the-azure-portal) на наличие ошибок. На портале перейдите к учетной записи службы автоматизации и в разделе **Автоматизация процессов** выберите **Задания**. На странице **Задания** найдите задания одного из следующих модулей runbook:
...
Чтобы устранить многие ошибки, рекомендуется удалить старую версию и обновить решение. Чтобы узнать, как обновить решение, ознакомьтесь с разделом [Обновление решения](../automation-solution-vm-management.md#update-the-solution). Кроме того, вы можете проверить [потоки заданий](../automation-runbook-execution.md#viewing-job-status-from-the-azure-portal) на наличие ошибок. На портале перейдите к учетной записи службы автоматизации и в разделе **Автоматизация процессов** выберите **Задания**.
