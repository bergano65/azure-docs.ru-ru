...
## <a name="all-vms-fail-to-startstop"></a>Сценарий: не удается запустить или завершить все виртуальные машины
...
## <a name="other"></a>Сценарий: Моя проблема не указана выше
