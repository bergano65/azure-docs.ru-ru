...
* Предельный объем памяти. Ограничения на объем памяти, выделяемый на Sandbox, описаны в разделе [Ограничения автоматизации](../../azure-resource-manager/management/azure-subscription-service-limits.md#automation-limits). Задание может завершиться ошибкой, если оно использует более 400 МБ памяти.

* Сетевые сокеты. В песочницах Azure разрешено одновременно использовать не более 1000 сетевых сокетов, как описано в разделе об [ограничениях службы автоматизации](../../azure-resource-manager/management/azure-subscription-service-limits.md#automation-limits).
