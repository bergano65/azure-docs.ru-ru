...
2. **Изучение модуля Runbook** [Потоки ошибок](https://docs.microsoft.com/azure/automation/automation-runbook-output-and-messages#runbook-output) для конкретных сообщений и их сравнение с указанными ниже ошибками.
...
При работе с `Add-AzureAccount` командлетами или `Connect-AzureRmAccount` вы получаете одну из следующих ошибок:
