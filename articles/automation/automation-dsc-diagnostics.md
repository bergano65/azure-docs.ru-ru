...
ms.locfileid: "82996047"
---
# <a name="forward-state-configuration-reporting-data-to-azure-monitor-logs"></a>Пересылка данных отчетов State Configuration в журналы Azure Monitor
