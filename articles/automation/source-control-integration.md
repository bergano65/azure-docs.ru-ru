...
* [Последние модули Azure](automation-update-azure-modules.md) в учетной записи службы автоматизации, включая модуль **AZ. Accounts** (AZ Module равнозначен AzureRM. Profile).
...
Выполните следующие действия, чтобы выполнить синхронизацию с системой управления версиями. 
