...
|Ветвь     | Ветвь, из которой следует извлечь исходные файлы. Нацеливание на ветви недоступно для типа системы управления версиями TFVC.          |
...
## <a name="syncing"></a>Синхронизируется
...
* Через [API-интерфейс RESTful](https://docs.microsoft.com/en-us/rest/api/automation/sourcecontrol/update).
