...
|Auto синхронизации<sup>1</sup>     | Включает или выключает автоматическую синхронизацию при выполнении фиксации в репозитории системы управления версиями         |
...
<sup>1</sup> Чтобы включить автоматическую синхронизацию при настройке интеграции системы управления версиями с репозиториями Azure, необходимо быть администратором проекта.

![Сводка по системе управления версиями](./media/source-control-integration/source-control-summary.png)

> [!NOTE]
> Имя входа для репозиторий системы управления версиями может отличаться от вашего имени входа для портала Azure. Убедитесь, что вы выполняете вход с использованием правильную учетную запись для репозиторий системы управления версиями при настройке системы управления версиями. Если есть сомнения, откройте новую вкладку в браузере, выйдите из visualstudio.com или github.com и повторите попытку подключения системы управления версиями.
