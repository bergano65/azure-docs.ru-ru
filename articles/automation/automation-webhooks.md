...
| Включено |При создании веб-перехватчика он по умолчанию включается. Если его отключить, клиенты не смогут его использовать. Свойство **Включен** можно задать при создании веб-перехватчика или в любое время после его создания. |
