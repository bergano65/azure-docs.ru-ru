...
* **Учетная запись запуска от имени Azure** . Эта учетная запись используется для управления ресурсами [модели развертывания Диспетчер ресурсов](../azure-resource-manager/management/deployment-models.md) .
...
* **Классическая учетная запись запуска от имени Azure** . Эта учетная запись используется для управления ресурсами [классической модели развертывания](../azure-resource-manager/management/deployment-models.md) .
...
2. В портал Azure найдите и выберите **учетные записи службы автоматизации**.
...
1. В портал Azure найдите и выберите **учетные записи службы автоматизации**.
...
Чтобы управлять нацеливанием на ресурсы автоматизации для ресурсов в Azure, можно выполнить скрипт [упдате-аутоматионрунасаккаунтролеассигнментс. ps1](https://aka.ms/AA5hug8) в коллекции PowerShell, чтобы изменить существующий субъект-службу учетной записи запуска от имени для создания и использования определения пользовательской роли. Эта роль будет иметь разрешения для всех ресурсов, кроме [Key Vault](https://docs.microsoft.com/azure/key-vault/).
