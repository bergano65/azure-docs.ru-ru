...
| Значение по умолчанию | Необязательный параметр. Значение, используемое для параметра, если оно не передается при запуске модуля Runbook. Чтобы установить значение по умолчанию, выберите **Пользовательское**. Выберите **нет** , если не нужно указывать значение по умолчанию. |
