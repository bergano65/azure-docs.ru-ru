...
| Свойство | Описание |
|:--- |:--- |
| name | Обязательный элемент. Имя параметра. Название должно быть уникальным в runbook. Она должна начинаться с буквы и может содержать только буквы, цифры и подчеркнутые. Имя не может содержать пробел. |
