...
ms.locfileid: "72243604"
---
# <a name="usage-example-continuous-deployment-to-virtual-machines-using-automation-state-configuration-and-chocolatey"></a>Пример использования. Непрерывное развертывание на виртуальных машинах с помощью службы "Настройки состояния службы автоматизации Azure" и Chocolatey
...
## <a name="step-2-vm-extension-tweaks-to-the-resource-manager-template"></a>Шаг 2. Оптимизация расширения виртуальной машины в шаблоне Resource Manager
...
## <a name="step-3-adding-required-dsc-resources-to-the-pull-server"></a>Шаг 3. Добавление требуемых ресурсов DSC на опрашиваемый сервер
...
## <a name="step-4-adding-the-node-configuration-to-the-pull-server"></a>Шаг 4. Добавление конфигурации узла к опрашиваемому серверу
