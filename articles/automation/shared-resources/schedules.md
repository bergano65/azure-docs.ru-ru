...
1. В учетной записи службы автоматизации выберите элемент **Расписания** в области **Общие ресурсы**.
