...
Вы также можете использовать тот же командлет для импорта модуля из коллекция PowerShell напрямую. Убедитесь, что вы захватите **ModuleName** **и** намерены от [коллекция PowerShell](https://www.powershellgallery.com).
