...
## <a name="enable-the-full-change-tracking-and-inventory-solution"></a>Включение полного решения Отслеживание изменений и инвентаризации

Если вы включили [мониторинг целостности файлов центра безопасности Azure (FIM)](https://docs.microsoft.com/azure/security-center/security-center-file-integrity-monitoring), можно использовать полное решение отслеживание изменений и инвентаризации, как описано ниже. Эти параметры не удаляются этим процессом.

> [!NOTE]
> Включение полного Отслеживание изменений и решения инвентаризации может привести к дополнительным расходам. См. раздел [цены на автоматизацию](https://azure.microsoft.com/pricing/details/automation/).
...
3. Чтобы повторно включить решение, перейдите к учетной записи службы автоматизации и выберите **Отслеживание изменений** в разделе **Управление конфигурацией**.
