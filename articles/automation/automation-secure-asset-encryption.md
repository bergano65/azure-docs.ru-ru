...
> [!NOTE] 
> Чтобы включить управляемые клиентом ключи, в настоящее время вам потребуется сделать API-интерфейсы службы автоматизации Azure с помощью API версии 2020-01-13-Preview.
...
> [!NOTE] 
> Поля tenantId и objectId должны быть предоставлены со значениями Identity. tenantId и Identity. principalId из ответа управляемого удостоверения для учетной записи службы автоматизации.
