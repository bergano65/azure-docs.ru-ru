...
Наконец, можно переключить учетную запись службы автоматизации с ключей, управляемых корпорацией Майкрософт, на управляемые клиентом ключи, используя следующий вызов REST API:
