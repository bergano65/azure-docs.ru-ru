...
В службе автоматизации Azure доступно три типа встроенных подключений:
...
В большинстве случаев не нужно создавать ресурс подключения, так как он создается вместе с [учетной записью запуска от имени](manage-runas-account.md).
