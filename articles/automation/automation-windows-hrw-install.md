...
| *Учетные данные* | Необязательно | Учетные данные, используемые для входа в среду Azure. |
...
| *Подписки* | Обязательный | Идентификатор подписки Azure, связанной с учетной записью службы автоматизации. |
...
* При необходимости задайте параметр *verbose* для получения сведений об установке.
