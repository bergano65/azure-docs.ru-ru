...
ms.locfileid: "61076820"
---
# <a name="create-a-standalone-azure-automation-account"></a>Создание автономной учетной записи службы автоматизации Azure

В этой статье объясняется, как создать учетную запись службы автоматизации на портале Azure. Портала учетной записи службы автоматизации можно использовать для оценки и изучить службу автоматизации, не прибегая к дополнительным решениям по управлению или интеграции с журналами Azure Monitor. Можно добавить эти решения по управлению или интеграции с журналами Azure Monitor для расширенного мониторинга заданий runbook в любой момент в будущем.
