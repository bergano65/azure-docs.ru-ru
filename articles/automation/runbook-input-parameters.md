...
При выполнении модуля Runbook с помощью веб-перехватчика отправляется предопределенный входной параметр *[WebhookData](automation-webhooks.md)* вместе с определяемыми входными параметрами. 
