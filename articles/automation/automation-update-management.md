...
> [!NOTE]
> Управление обновлениями решение требует связывания рабочей области Log Analytics с учетной записью службы автоматизации. Полный список поддерживаемых регионов см. в разделе [https://docs.microsoft.com/en-us/azure/automation/how-to/region-mappings ]. Сопоставления регионов не влияют на возможность управления виртуальными машинами в отдельном регионе, чем ваша учетная запись службы автоматизации.
