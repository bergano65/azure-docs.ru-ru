...
* [Просмотр нескольких машин](automation-onboard-solutions-from-browse.md)
* [Из учетной записи службы автоматизации](automation-onboard-solutions-from-automation-account.md)
* [С помощью модуль runbook службы автоматизации Azure](automation-onboard-solutions.md)
