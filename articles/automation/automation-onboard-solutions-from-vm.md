...
Служба автоматизации Azure предоставляет решения для управления обновлениями безопасности операционной системы, отслеживания изменений и инвентаризации компонентов, установленных на компьютерах. Подключить решения на виртуальных машинах можно несколькими способами. Вы можете подключить решение на одной виртуальной машине, [на нескольких виртуальных машинах](automation-onboard-solutions-from-automation-account.md), в [учетной записи службы автоматизации](automation-onboard-solutions-from-browse.md) или с помощью [модуля runbook](automation-onboard-solutions.md). В этой статье описано, как подключать такие решения на виртуальной машине Azure.
