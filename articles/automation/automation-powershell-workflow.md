...
Первый шаг к преобразованию сценария PowerShell в рабочий процесс PowerShell — это добавление ключевого слова **Workflow** .  Рабочий процесс начинается с ключевого слова **Workflow** , за которым следует текст сценария, заключенный в фигурные скобки. Название рабочего процесса следует ключевому слову **Рабочего процесса,** указанному в следующем синтаксисе:
