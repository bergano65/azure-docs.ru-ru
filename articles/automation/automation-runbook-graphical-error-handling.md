...
Улучшены графические модули Runbook службы автоматизации Azure с возможностью включения обработки ошибок. Теперь можно преобразовывать исключения в устранимые ошибки и создавать ссылки ошибок между действиями. Улучшенный процесс позволяет модулю Runbook перехватывать ошибки и управлять реализованными или непредвиденными условиями. 
...
* Дополнительные сведения о ссылках и типах ссылок в графических модулях Runbook см. в разделе [графическая разработка в службе автоматизации Azure](automation-graphical-authoring-intro.md#links-and-workflow).
