---
title: Решение "Настройка запуска и остановки виртуальных машин в нерабочее время" в службе автоматизации Azure
...
---
# <a name="how-to-configure-startstop-vms-during-off-hours-solution"></a>Настройка решения "Запуск и завершение виртуальных машин в нерабочее время"

В решении " **Запуск и завершение виртуальных машин в нерабочее время** " можно:
...
1. Создайте новое [Расписание](shared-resources/schedules.md#creating-a-schedule) и свяжите его с **AutoStop_CreateAlert_Parent** модулем Runbook, добавив разделенный запятыми список имен виртуальных машин `VMList` в параметр.
