...
[Служба настройки состояния](automation-dsc-overview.md) в службе автоматизации Azure — это облачное решение для PowerShell DSC, которое предоставляет службы для корпоративных сред. С помощью этой функции вы можете управлять ресурсами DSC в службе автоматизации Azure и применять конфигурации к виртуальным машинам или физическим компьютерам с опрашивающего сервера DSC в облаке Azure. Вы также можете выполнять мониторинг и автоматическое обновление конфигурации на физических компьютерах и виртуальных машинах Windows или Linux, работающих в облаке или локальной среде. Поддержка инвентаризации позволяет просматривать ресурсы в гостевой системе, чтобы контролировать установленные приложения и другие элементы конфигурации.
 
Служба настройки состояния в службе автоматизации Azure предоставляет широкие возможности для создания отчетов и поиска. Вы можете использовать эти возможности для нахождения подробных сведений о том, что настроено в операционной системе. Служба поддерживает отслеживание изменений в службах, управляющих программах, программном обеспечении, реестре и файлах в вашей среде, помогая определять причины нежелательных изменений и создавать оповещения. Важной связанной возможностью является создание отчетов по основным событиям, например событиям, регистрируемым при обнаружении несоответствия узлов назначенным конфигурациям. 

## <a name="update-management"></a>Управление обновлениями

Служба автоматизации Azure включает решение по [управлению обновлениями](automation-update-management.md) для систем Windows и Linux в гибридных средах. С помощью этого решения вы сможете контролировать соблюдение требований к обновлению в Azure и других облаках, а также в локальной среде. Решение по управлению обновлениями позволяет создавать расписания развертываний, чтобы оркестрировать установку обновлений в течение определенного периода обслуживания. Если обновление не нужно устанавливать на определенном компьютере, с помощью управления обновлениями его можно исключить из развертывания.
