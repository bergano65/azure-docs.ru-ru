...
* **Классификация обновлений**. Выберите поддерживаемые классификации обновлений для каждого продукта, которые можно добавить в развертывание обновлений. Для целей этого руководства сохраните выбор всех типов.

  Ниже приведены типы классификации:

   |OS  |Тип  |
   |---------|---------|
   |Windows     | критические обновления;</br>Обновления для системы безопасности</br>накопительные пакеты обновления;</br>пакеты дополнительных компонентов;</br>пакеты обновления;</br>обновления определений;</br>Инструменты</br>Обновления        |
