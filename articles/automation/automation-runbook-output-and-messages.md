...
### <a name="write-output-to-debug-stream"></a>Запись выходных данных в поток отладки
...
### <a name="write-output-to-verbose-stream"></a>Записывать выходные данные в подробный поток
