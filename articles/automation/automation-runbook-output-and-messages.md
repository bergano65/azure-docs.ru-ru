...
|:--- |:--- |:--- |:--- |
| Выход |Объекты, предназначенные для использования другими Runbook. |Записывается в журнал заданий. |Отображается в области вывода теста. |
...
|:--- |:--- |:--- |
| WarningPreference |Continue |Остановить<br>Продолжить<br>SilentlyContinue |
