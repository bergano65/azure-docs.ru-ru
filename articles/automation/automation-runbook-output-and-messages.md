...
| Поток | Description | Опубликовано | Тестирование |
|:--- |:--- |:--- |:--- |
...
| Подробный |Сообщения, содержащие общую или отладочную информацию. |Записывается в журнал заданий только в том случае, если для Runbook включено подробное ведение журнала. |Отображается в области вывода теста только в том случае, если в Runbook для $VerbosePreference задано значение Continue. |
