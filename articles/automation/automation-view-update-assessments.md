---
title: Просмотр оценок обновления управления обновлениями Azure
...
ms.locfileid: "79278419"
---
# <a name="view-azure-update-management-update-assessments"></a>Просмотр оценок обновления управления обновлениями Azure
...
Для выполнения поиска журналов, возвращающем информацию о машине, обновлении или развертывании, выберите соответствующий элемент в списке. При этом откроется страница **поиска по журналам** с запросом на выбранный элемент:
