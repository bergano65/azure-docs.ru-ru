...
Инвентаризация позволяет создавать и просматривать группы компьютеров в Log Analytics. Группы компьютеров — это коллекция компьютеров, определенных запросом в Log Analytics.
...
Чтобы создать группу, нажмите кнопку **+ Создать группу компьютеров**. Откроется **страница создания группы компьютеров**, на которой вы сможете определить новую группу. Щелкните **Создать**, чтобы создать группу.
