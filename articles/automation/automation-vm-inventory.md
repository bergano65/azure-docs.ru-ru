...
|Использовать sudo     | Значение true, если используется sudo при проверке наличия элемента, или false, если нет.         |
...
2. На странице Log Analytics откройте меню **Ресурсы**.
