...
Если вы хотите создать новую группу машин, выберите **группу машин.** Откроется **страница создания группы компьютеров**, на которой вы сможете определить новую группу. Щелкните **Создать**, чтобы создать группу.
