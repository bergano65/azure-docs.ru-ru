...
![Диаграмма, отображающая изменение файла hosts](./media/automation-change-tracking/changes.png)
...
![Рисунок, демонстрирующий запрос на изменение для отслеживания изменений в файле hosts](./media/automation-change-tracking/change-query.png)

После установки логики условий назначьте группы действий для выполнения действий в ответ на срабатывание оповещения. В этом случае настроены сообщения электронной почты, и необходимо создать билет ITSM.  Также можно выполнить множество других полезных действий, таких как запуск Функции Azure, автоматизации runbook, веб-перехватчика или приложения логики.

![Изображение с настройкой группы действий для оповещения об изменении](./media/automation-change-tracking/action-groups.png)
