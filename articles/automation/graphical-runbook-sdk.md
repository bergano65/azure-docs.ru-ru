...
> [!NOTE]
> Не получайте действия от предоставленных классов. Служба автоматизации Azure не сможет использовать модули runbook с помощью типов настраиваемых действий.
...
> [!NOTE]
> Не получайте значения дескрипторов от предоставленных классов. Служба автоматизации Azure не сможет использовать модули runbook с типами дескрипторов пользовательского значения.
