---
title: Используйте управление обновлением автоматизации Azure с клиентами Configuration Manager
...
Вы можете сообщать и обновлять управляемые серверы Windows, создавая и предварительно заменяя развертывание обновления программного обеспечения в Configuration Manager, и получить подробный статус завершенных развертываний обновлений с помощью [управления обновлением.](automation-update-management.md) Если вы используете Configuration Manager для отчетности об обновлении, но не для управления развертыванием обновлений с серверами Windows, вы можете продолжать отчитываться перед менеджером конфигурации, пока обновления безопасности управляются с помощью решения Update Management.
...
1. В службе автоматизации Azure выберите **Управление обновлениями**. Создайте новое развертывание после шагов, описанных в [создании развертывания обновления,](automation-tutorial-update-management.md#schedule-an-update-deployment) и выберите **импортированные группы** в отбрасывании **типа,** чтобы выбрать соответствующую коллекцию диспетчеров конфигурации. Помните следующие важные моменты: А. Если период обслуживания выбранной коллекции устройств Configuration Manager задан, участники коллекции учитывают его вместо параметра **Длительность**, задаваемого в плане развертывания.
