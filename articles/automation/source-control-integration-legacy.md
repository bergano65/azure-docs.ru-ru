...
1. Со счета автоматизации, где вы настраиваете элемент управления исходом, откройте страницу **интеграции/репозитория** и нажмите **Синхронизация.**  Вам предлагается с подтверждением сообщения, нажмите **Да,** чтобы продолжить.  
