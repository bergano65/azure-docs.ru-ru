...
- Поддерживается семейство IPv4-адресов.  NAT не взаимодействует с семейством IPv6-адресов.
- Группа безопасности сети (NSG) подсети или сетевого адаптера не учитывается в NAT для исходящих потоков в общедоступные конечные точки.
