...
Да. Вы можете использовать интерфейсы REST API для виртуальных сетей, развернутых по модели развертывания [с помощью Azure Resource Manager](/rest/api/virtual-network) или [классической модели развертывания (управление службами)](https://go.microsoft.com/fwlink/?LinkId=296833).
...
- Масштабируемых наборов виртуальных Машин с помощью подсистемы балансировки нагрузки, базовый 
- кэш Redis; 
...
Это [руководство устранения неполадок] (https://support.microsoft.com/en-us/help/4486956/troubleshooter-for-virtual-network-peering-issues) можно попробовать.
