...
- x. x. x. 0, а последний адрес подсети зарезервирован для соответствия протоколу.
- x. x. x. 1-x. x. x. 3 зарезервировано в каждой подсети для служб Azure.
...
Если две виртуальные сети находятся в другом регионе (пиринг глобальной виртуальной сети), вы не сможете подключиться к ресурсам, использующим базовый Load Balancer. Вы можете подключиться к ресурсам, использующим Load Balancer (цен. категория "Стандартный").
