...
Да. Вы можете развернуть веб-приложения в виртуальной сети с помощью ASE (Среда службы приложений), подключить серверную часть приложений к виртуальных сетей с помощью интеграции с виртуальной сетью и заблокировать входящий трафик в приложении с конечными точками службы. См. сведения в следующих статьях:
