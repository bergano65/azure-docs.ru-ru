...
Да. Azure резервирует 5 IP-адресов в каждой подсети. Зарезервированы первый и последний IP-адреса каждой подсети (для соответствия требованиям протокола), а также адреса x.x.x.1-x.x.x.3, используемые для служб Azure.
