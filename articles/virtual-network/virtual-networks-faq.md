...
Да. Вы можете в любое время изменить список DNS-серверов для виртуальной сети. При изменении списка DNS-серверов необходимо выполнить продление аренды DHCP на всех затронутых виртуальных машинах в виртуальной сети, чтобы новые параметры DNS вступили в силу. Для виртуальных машин под управлением ОС Windows это можно сделать, `ipconfig /renew` введя непосредственно на виртуальной машине. Сведения о других типах ОС см. в документации по продлению аренды DHCP для конкретного типа ОС. 
