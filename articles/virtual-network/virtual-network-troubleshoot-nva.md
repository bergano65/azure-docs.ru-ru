...
- При использовании уровня "стандартный" и общедоступные IP-адреса, должно существовать созданную группу безопасности сети и явное правило, разрешающее трафик направляться на виртуальное сетевое устройство.
...
2. Выполните следующую команду (замените значения в скобках своими значениями):
   ...
   Get-AzNetworkInterface - ResourceGroupName <ResourceGroupName> -имя <NicName>  
