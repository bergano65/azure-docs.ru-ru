...
**Проверка наличия NSG при использовании номера SKU ценовой категории "Стандартный" и общедоступного IP-адреса**. Если используется номер SKU ценовой категории "Стандартный" и общедоступный IP-адрес, нужно создать группу безопасности сети и явное правило, разрешающее передачу трафика в NVA.
