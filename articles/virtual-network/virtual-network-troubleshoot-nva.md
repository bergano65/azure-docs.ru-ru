...
> [!NOTE]
> Если у вас есть проблема с подключением или маршрутизацией, которая связана с NVA, вы должны [напрямую обратиться к поставщику NVA](https://mskb.pkisolutions.com/kb/2984655).
...
Для каждого модуля NVA предусмотрены базовые требования к конфигурации для правильной работы в Azure. В следующем разделе приведены шаги для проверки этих основных конфигураций. Для получения дополнительных сведений [свяжитесь с поставщиком NVA](https://mskb.pkisolutions.com/kb/2984655).
...
Если входящие пакеты отображаются, но не отвечают, возможно, проблема в приложении виртуальной машины или брандмауэре. При возникновении любой из этих проблем [при необходимости свяжитесь с поставщиком NVA](https://mskb.pkisolutions.com/kb/2984655).