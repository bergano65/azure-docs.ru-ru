...
3. В области **Виртуальные машины** выберите виртуальную машину, которой вы хотите назначить IP-адреса. Перейдите к **сетевой** tab. Нажмите **интерфейс сети** на странице. Как показано на рисунке ниже: 
...
4. В панели **интерфейса сети** щелкните **конфигурации IP.**

5. Откроется область для выбранного сетевого адаптера. В ней щелкните **Конфигурации IP**. Нажмите **Добавить,** завершить шаги в одном из разделов, которые следуют, в зависимости от типа IP-адреса вы хотите добавить, а затем нажмите **OK**. 
...
1. Перейдите на портал Azure по адресу https://portal.azure.com и при необходимости выполните вход.
3. На портале нажмите **Создать ресурс** > **Networking** > **Public IP-адрес**.
