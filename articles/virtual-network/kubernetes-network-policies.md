...
При реализации безопасности для кластера используйте группы сетевой безопасности (НСГ) для фильтрации трафика "Север-юг", т.е. ввода и выхода из вашей кластерной подсети, и используйте сетевые политики Kubernetes для трафика Восток-Запад, т.е. трафик между стручками в кластера.
...
- [Развертывание плагина](deploy-container-networking.md) для кластеров Kubernetes или контейнеров Docker.
