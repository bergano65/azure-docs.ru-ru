...
| Ресурс | Динамические | Статические | Несколько IP-адресов |
| --- | --- | --- | --- |
...
Ознакомьтесь с полным списком [сетевых ограничений](../azure-resource-manager/management/azure-subscription-service-limits.md#networking-limits) в Azure.
