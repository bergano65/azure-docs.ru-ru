---
title: Типы IP-адресов в Azure (классическая модель)
...
| --- | --- | --- |
| Общедоступные IP-адреса (динамические) |5 |служба технической поддержки поможет найти ответы на них |
| Зарезервированные общедоступные IP-адреса |20 |обратиться в службу поддержки |
| Общедоступный виртуальный IP-адрес на развертывание (облачная служба) |5 |служба технической поддержки поможет найти ответы на них |
...
|  | Resource | Классический | Resource Manager |
| --- | --- | --- | --- |
