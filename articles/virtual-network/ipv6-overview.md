...
- Защита ресурсов с помощью правил IPv6 для групп безопасности сети
...
- Поддержка стандартных общедоступных Load Balancer IPv6 для создания устойчивых масштабируемых приложений, в том числе:
