---
title: Обзор IPv6 для виртуальной сети Azure (Предварительный просмотр)
...
- IPv6 для виртуальной сети Azure (Preview) доступен во всех глобальных регионах Azure, но только в Global Azure, еще не в правительственных облаках.
