...
> [!IMPORTANT]
> В настоящее время TAP для виртуальной сети доступна предварительная версия во всех регионах Azure. Чтобы использовать КАСАНИе виртуальной сети, необходимо зарегистрироваться в предварительной версии, отправив сообщение электронной почты  <azurevnettap@microsoft.com> с идентификатором подписки. После активации подписки на электронную почту будет отправлено письмо. Вы не сможете использовать функцию, пока не получите подтверждение по электронной почте. Эта предварительная версия предоставляется без соглашения об уровне обслуживания и не должна использоваться для рабочих нагрузок. Некоторые функции могут не поддерживаться, иметь ограничения и быть доступными не во всех расположениях Azure. Подробные сведения см. на странице  [Дополнительные условия использования Предварительных версий Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/) .
