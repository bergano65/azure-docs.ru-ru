...
В сценарии между виртуальными сетями происходит при проверке работоспособности из частного IP-адреса и 168.63.129.16 не используется.
