...
Интеграция виртуальной сети для службы Azure позволяет заблокировать доступ к службе только для инфраструктуры виртуальной сети. Инфраструктура виртуальной сети также включает в себя одноранговые виртуальные сети и локальные сети.

Службы Azure достигают сетевой изоляции одним или несколькими из следующих методов.
