...
description: Используйте пример скрипта Azure CLI, чтобы настроить конечные точки IPv6 и развернуть приложение с двойным стеком (IPv4 + IPv6) в Azure.
