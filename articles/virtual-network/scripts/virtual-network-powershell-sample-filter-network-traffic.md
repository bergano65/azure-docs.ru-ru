---
title: Пример скрипта Azure PowerShell. Фильтрация сетевого трафика виртуальной машины
description: Фильтрация входящего и исходящего сетевого трафика виртуальной машины — пример скрипта Azure PowerShell.
