...
1. В левом верхнем углу экрана выберите элементы **Создать ресурс** > **Сеть** > **Виртуальная сеть** или найдите раздел **Виртуальная сеть** с помощью функции поиска на Marketplace.
...
2. В подменю **Создать виртуальную сеть** введите или выберите следующую информацию:
    ...
    | ------- | ----- |
    | Имя | Введите **myVNet**. |
    | Пространство адресов | Введите **192.168.0.0/16**. |
    | Подписка | Выберите свою подписку.|
    | Группа ресурсов | Выберите создание группы и назовите ее **myResourceGroupNAT**. |
    | Расположение | Выберите регион **Восточная часть США 2**.|
    | Имя подсети | Введите **mySubnet**. |
    | Диапазон адреса подсети | Введите **192.168.0.0/24**. |
