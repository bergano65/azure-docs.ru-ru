...
- Может использоваться в качестве IP-адресов рассылки до первого [уровня для подсистем балансировки нагрузки между регионами](https://docs.microsoft.com/azure/load-balancer/cross-region-overview) (Предварительная версия функциональности).
