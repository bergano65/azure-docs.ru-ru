...
- PowerShell: [Add-азвиртуалнетворксубнетконфиг](/powershell/module/az.network/add-azvirtualnetworksubnetconfig)
...
5. Выберите **Delete** (Удалить), а затем щелкните **Yes** (Да).

**Команды**

- Azure CLI: [AZ Network vnet подсети Delete](/cli/azure/network/vnet/subnet#az-network-vnet-subnet-delete)
