...
5. На странице подсеть измените любые из следующих параметров.
    ...
    | **Пользователи** | Вы можете управлять доступом к подсети, используя встроенные роли или собственные настраиваемые роли. Дополнительные сведения о назначении ролей и пользователей для доступа к подсети см. в статье [назначение ролей Azure](../role-based-access-control/role-assignments-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json). |
