...
1. Выберите **и создайте ресурсНую** > **сетевую** > **виртуальную сеть.**
2. Введите или выберите значения для следующих параметров, а затем выберите **Создать:**
   ...
   - **Адресное пространство**. Адресное пространство виртуальной сети состоит из одного или нескольких неперекрывающихся диапазонов адресов, указанных в нотации CIDR. Определяемый диапазон адресов может быть общедоступным или частным (RFC 1918). Независимо от того, какой диапазон адресов вы укажете (общедоступный или частный), он будет доступен только внутри виртуальной сети, из взаимосвязанных виртуальных сетей и из всех локальных сетей, подключенных к виртуальной сети. Невозможно добавить следующий диапазон адресов:
     ...
     Хотя при создании виртуальной сети на портале можно определить только один диапазон адресов, после создания виртуальной сети можно добавить больше диапазонов адресов в адресное пространство. Чтобы узнать, как добавить или удалить диапазон адресов в имеющейся виртуальной сети, см. [этот раздел](#add-or-remove-an-address-range).
...
- PowerShell: [Новая АзВиртуальнаяСеть](/powershell/module/az.network/new-azvirtualnetwork)
...
Вы можете уменьшить диапазон адресов для виртуальной сети до тех пор, пока она по-прежнему включает в себя диапазоны любых связанных подсетей. Кроме того, можно расширить диапазон адресов, например, изменяя /16 на /8. 
...
- PowerShell: [Удалить-AzVirtualNetwork](/powershell/module/az.network/remove-azvirtualnetwork)
