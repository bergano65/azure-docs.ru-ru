...
![Сетевой график](./media/virtual-networks-udr-overview/routing-example.png)
...
|ИДЕНТИФИКАТОР  |Источник |Состояние  |Префиксы адресов    |Тип следующего прыжка          |IP-адрес следующего прыжка|Название определяемого пользователем маршрута| 
|----|-------|-------|------              |-------                |--------           |--------      |
...
|6   |Пользователь   |Активно |10.1.0.0/16         |Нет                   |                   |К виртуальной сети 2 — 1 —прервать|
|7   |Пользователь   |Активно |10.2.0.0/16         |Нет                   |                   |К виртуальной сети 2 — 2 —прервать|
