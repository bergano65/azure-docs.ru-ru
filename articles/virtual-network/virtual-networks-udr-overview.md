...
|Пиринговая связь между виртуальными сетями         |Пиринговая связь между виртуальными сетями                                    |Не применяется|
...
|7   |Пользователь   |Активна |10.2.0.0/16         |Нет                   |                   |К виртуальной сети 2 — 2 —прервать|
