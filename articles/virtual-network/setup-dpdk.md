...
| SLES 15 SP1  | 4.12.14-8.27-лазурный          | 
| RHEL 7.5     | 3.10.0-862.11.6.el7.x86_64  | 
| CentOS 7.5   | 3.10.0-862.11.6.el7.x86_64  | 

**Поддержка настраиваемого ядра**

Любую версию ядра Linux, не указанную в списке, можно найти в [репозитории GitHub](https://github.com/microsoft/azure-linux-kernel). Для получения дополнительной информации, вы также можете связаться [azuredpdk@microsoft.com](mailto:azuredpdk@microsoft.com). 
...
1. [Скачайте последнюю версию DPDK](https://core.dpdk.org/download). Версия 18.11 LTS или 19.11 LTS требуется для Azure.
...
1. Hugepages.
   ...
   * Нанастройка огромной страницы, запустив следующую команду, один раз для каждого numa узла:
...
Приложения DPDK должны работать через отказоустойчивый драйвер PMD, доступный в Azure. Если приложение работает непосредственно над *VF* PMD, оно не получает **все** пакеты, предназначенные для VM, так как некоторые пакеты отображаются над синтетическим интерфейсом. 
