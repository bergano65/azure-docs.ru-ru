...
2. В разделе **Создание виртуальной машины** на вкладке **Основные сведения** укажите следующее.
    ...
    | Группа ресурсов | Выберите **Создать**. </br> В окне **имя** введите **myResourceGroup**. </br> Нажмите кнопку **ОК**. |
...
4. На вкладке "Сеть" укажите следующее.
    ...
    | Общедоступный IP-адрес | Выберите **Создать**. </br> В окне **Создание общедоступного IP-адреса** в имени введите **myPublicIP**. </br> Для **номера SKU** выберите **стандартный**. </br> **Назначение**, выберите **статический**. </br> Нажмите кнопку **ОК**.  |
    ...
    > [!WARNING]
    > Порт 3389 выбран для обеспечения удаленного доступа к виртуальной машине Windows Server из Интернета. Открытие порта 3389 в Интернете не рекомендуется для управления рабочими нагрузками. </br> Сведения о безопасном доступе к виртуальным машинам Azure см. в статье **[что такое Azure бастиона?](../bastion/bastion-overview.md)**
...
- Подробнее о [статических общедоступных IP-адресах](./public-ip-addresses.md#allocation-method).
