...
```
Объедините определения конфигурации, чтобы создать виртуальную машину с именем **myVMsource** с помощью командлета [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) в группе **myResourceGroupNAT**.
...
```
Объедините определения конфигурации, чтобы создать виртуальную машину с именем **myVMdestination** с помощью командлета [New-AzVM]((https://docs.microsoft.com/powershell/module/az.compute/new-azvm?view=azps-2.8.0)) в группе **myResourceGroupNAT**.
