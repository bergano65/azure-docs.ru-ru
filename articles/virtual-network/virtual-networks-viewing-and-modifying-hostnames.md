...
1. Убедитесь, что у вас есть сертификат клиента для подключения к порталу Azure. Чтобы получить сертификат клиента, выполните действия, приведенные в [разделе как Скачайте и импортируйте параметры публикации и сведения](https://msdn.microsoft.com/library/dn385850.aspx)о подписке. 
