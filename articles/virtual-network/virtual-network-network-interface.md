...
3. Для выбранного сетевого интерфейса отображаются следующие элементы:
   ...
   - **Общие параметры диспетчера ресурсов Azure**. Дополнительные сведения об общих параметрах диспетчера ресурсов Azure см. в документах о [журнале действий](../azure-monitor/platform/platform-logs-overview.md), [контроле доступа (IAM)](../role-based-access-control/overview.md), [тегах](../azure-resource-manager/management/tag-resources.md?toc=%2fazure%2fvirtual-network%2ftoc.json), [блокировках](../azure-resource-manager/management/lock-resources.md?toc=%2fazure%2fvirtual-network%2ftoc.json) и [скрипте службы автоматизации](../azure-resource-manager/templates/export-template-portal.md).
