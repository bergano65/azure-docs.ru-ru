---
title: Перенос виртуальной сети Azure (классическая модель) из территориальной группы в регион
...
2. Измените файл конфигурации сети, заменив параметр **AffinityGroup** на **Location**. В качестве значения параметра [Location](https://azure.microsoft.com/regions) следует указать **регион** Azure.
