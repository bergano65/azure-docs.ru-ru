...
Поддержка настройки маршрутизации для учетной записи хранения доступна в следующих регионах Azure: северо-центральная часть США, Западная Центральная часть США, Южная Европа, Восточная часть US, Западная часть территории США, Северная Восточная Азия Западная Швейцария Центрально-Западная Германия Европ
