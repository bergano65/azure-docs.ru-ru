...
Поддержка предпочтений маршрутизации для учетной записи хранения доступна в следующих регионах Azure: Юго-Восточная часть США, Северный регион, Центральная часть США, Западная Япония, Запад Японии, Центрально-Западная Германия и Западная Швейцария.
