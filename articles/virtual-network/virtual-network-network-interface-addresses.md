...
Вы можете добавить требуемое [частных](#private) и [общедоступных количество ](#public) [IPv4](#ipv4)-адресов для сетевого интерфейса в пределах, приведенных в статье [Подписка Azure, границы, квоты и ограничения службы](../azure-resource-manager/management/azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits). Для существующего сетевого интерфейса можно добавить личный адрес IPv6 в одну [вторичную конфигурацию IP](#secondary) (пока нет существующих вторичных конфигураций IP. Каждый сетевой интерфейс может иметь не более одного частного адреса IPv6. Можно дополнительно добавить общедоступный адрес IPv6 в конфигурацию сетевого интерфейса IPv6. Ознакомьтесь с протоколом [IPv6](#ipv6), чтобы узнать больше об использовании IPv6-адресов.
...
|PowerShell|[Ад-AzNetworkInterfaceIpConfig](/powershell/module/az.network/add-aznetworkinterfaceipconfig)|
...
|PowerShell|[Удалить-AzNetworkInterfaceIpConfig](/powershell/module/az.network/remove-aznetworkinterfaceipconfig)|
...
- Ей также может быть назначен [общедоступный](#public) IPv4-адрес. Вы не можете присвоить общедоступный адрес IPv6 основной (IPv4) КОНФИГУРАЦИи IP. 
...
- Может также иметь публичный адрес IPv4 или IPv6, назначенный ему. Назначение нескольких адресов IPv4 сетевому интерфейсу полезно в таких сценариях, как:
  - Хостинг нескольких веб-сайтов или служб с различными IP-адресами и сертификатами TLS/SSL на одном сервере.
...
Частные адреса [IPv4](#ipv4) или IPv6 позволяют виртуальной машине общаться с другими ресурсами в виртуальной сети или других подключенных сетях. 
...
Можно (по желанию) назначить общедоступный или частный статичный адрес IPv4 или IPv6 конфигурации IP. Чтобы узнать больше о том, как Azure назначает статические общедоступные IPv4-адреса, прочитайте статью [Создание, изменение и удаление общедоступного IP-адреса](virtual-network-public-ip-address.md).
