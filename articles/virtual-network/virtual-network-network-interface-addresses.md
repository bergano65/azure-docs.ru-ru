...
Вы можете добавить в сетевой интерфейс столько [частных](#private) и [общедоступных](#public) [IPv4](#ipv4) -адресов, сколько требуется для сетевого интерфейса, в пределах ограничений, перечисленных в статье [ограничения Azure](../azure-resource-manager/management/azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits) . Вы можете добавить частный IPv6-адрес в одну [дополнительную конфигурацию IP](#secondary) (при условии, что нет существующих ВТОРИЧНЫХ IP-конфигураций) для существующего сетевого интерфейса. Каждый сетевой интерфейс может иметь не более одного частного адреса IPv6. При необходимости можно добавить общедоступный IPv6-адрес в конфигурацию сетевого интерфейса IPv6. Ознакомьтесь с протоколом [IPv6](#ipv6), чтобы узнать больше об использовании IPv6-адресов.
...
|PowerShell|[Add-Азнетворкинтерфацеипконфиг](/powershell/module/az.network/add-aznetworkinterfaceipconfig)|
...
|PowerShell|[Remove-Азнетворкинтерфацеипконфиг](/powershell/module/az.network/remove-aznetworkinterfaceipconfig)|
...
- Имеет назначенный ему [частный](#private) [IPv4](#ipv4) -адрес. Ей невозможно назначить частный [IPv6](#ipv6)-адрес.
- Ей также может быть назначен [общедоступный](#public) IPv4-адрес. Общедоступный IPv6-адрес не может быть назначен основной конфигурации IP (IPv4). 
...
Частные адреса [IPv4](#ipv4) и IPv6 позволяют виртуальной машине взаимодействовать с другими ресурсами в виртуальной сети или в других подключенных сетях. 
...
Число общедоступных и частных IP-адресов, которые можно назначить сетевому интерфейсу, ограничено. Дополнительные сведения см. в статье об [ограничениях в Azure](../azure-resource-manager/management/azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits).
...
Можно (необязательно) назначить IP-конфигурации открытый или частный статический адрес IPv4 или IPv6. Чтобы узнать больше о том, как Azure назначает статические общедоступные IPv4-адреса, прочитайте статью [Создание, изменение и удаление общедоступного IP-адреса](virtual-network-public-ip-address.md).
...
Каждый сетевой интерфейс должен иметь одну [основную](#primary) IP-конфигурацию с назначенным [частным](#private) адресом [IPv4](#ipv4) . Можно добавить одну или несколько [дополнительных](#secondary) IP-конфигураций с частным IPv4-адресом и (необязательно) [общедоступным](#public) IPv4-адресом.

### <a name="ipv6"></a>IPv6

Можно не назначать вовсе или назначить один частный [IPv6](#ipv6)-адрес одной дополнительной IP-конфигурации сетевого интерфейса. Для этого у сетевого интерфейса не должно быть каких-либо дополнительных IP-конфигураций. Каждый сетевой интерфейс может иметь не более одного частного адреса IPv6. При необходимости можно добавить общедоступный IPv6-адрес в конфигурацию сетевого интерфейса IPv6.
