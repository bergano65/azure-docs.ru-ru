...
Количество групп безопасности сети, которые можно создать в одном расположении и одной подписке Azure, ограничено. Дополнительные сведения см. в разделе [Ограничения сети](../azure-resource-manager/management/azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits).
...
- PowerShell: [New-азнетворксекуритиграуп](/powershell/module/az.network/new-aznetworksecuritygroup)
...
- PowerShell: [Get-азнетворксекуритиграуп](/powershell/module/az.network/get-aznetworksecuritygroup)
...
- PowerShell: [Set-азнетворксекуритиграуп](/powershell/module/az.network/set-aznetworksecuritygroup)
...
Количество правил на группу безопасности сети, которые можно создать в одном расположении и одной подписке Azure, ограничено. Дополнительные сведения см. в разделе [Ограничения сети](../azure-resource-manager/management/azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits).
...
4. <a name = "security-rule-settings"></a>Выберите **+ Добавить**.  Выберите или добавьте значения перечисленных ниже параметров, а затем щелкните **ОК**.
    ...
    |Протокол     | Выберите **ANY**, **TCP**, **UDP** или **ICMP**.        |         |
    |Действия     | Выберите **Разрешить** или **Запретить**.        |         |
...
- PowerShell: [New-азнетворксекуритирулеконфиг](/powershell/module/az.network/new-aznetworksecurityruleconfig)
...
- PowerShell: [Set-азнетворксекуритирулеконфиг](/powershell/module/az.network/set-aznetworksecurityruleconfig)
