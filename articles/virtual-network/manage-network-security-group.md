...
4. <a name = "security-rule-settings"></a>Выберите **+ Добавить**.  Выберите или добавьте значения перечисленных ниже параметров, а затем щелкните **ОК**.
    ...
    |Name     | Уникальное имя правила в пределах группы безопасности сети.        |  Оно может содержать до 80 знаков. Это имя должно начинаться с буквы или цифры, оканчиваться буквой, цифрой или символом подчеркивания и может содержать только буквы, цифры, символы подчеркивания, точки и дефисы.       |
...
3. Выберите или введите следующие сведения, а затем щелкните **Создать**.
    ...
    | Параметр        | Значение                                                   |
    | ---            | ---                                                     |
    | Name           | Имя должно быть уникальным в пределах группы ресурсов.        |
