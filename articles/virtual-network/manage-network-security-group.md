...
3. Выберите **Delete** (Удалить), а затем щелкните **Yes** (Да).
...
4. <a name = "security-rule-settings"></a>Выберите **+ Добавить**.  Выберите или добавьте значения перечисленных ниже параметров, а затем щелкните **ОК**.
    ...
    |Настройка  |Значение  |Подробная информация  |
    |---------|---------|---------|
...
1. Выполните инструкции из раздела [Просмотр сведений о правиле безопасности](#view-details-of-a-security-rule).
2. Выберите **Delete** (Удалить), а затем щелкните **Yes** (Да).
...
3. Выберите или введите следующие сведения, а затем щелкните **Создать**.
    ...
    | Место проведения       | Выберите расположение                                       |
