...
8. Чтобы изменить параметр имени общедоступного IP-адреса, измените свойство в разделе **параметры** > **значение** из ОБЩЕдоступного IP-адреса источника на имя целевого общедоступного IP-адреса и убедитесь, что имя указано в кавычках:
...
12. Кроме того, можно изменить другие параметры в шаблоне, если вы выбираете и являются необязательными в зависимости от ваших требований:
    ...
    * **SKU** . Вы можете изменить номер SKU общедоступного IP-адреса в конфигурации с Standard на Basic или Basic на Standard, изменив свойство **SKU** > **Name** в файле **template. JSON** :
...
14. Щелкните **основные** > **Подписка** , чтобы выбрать подписку, в которой будет развернут целевой общедоступный IP-адрес.
...
16. Убедитесь, что **Основные сведения** о > **расположении** установлены в целевое расположение, где требуется развернуть общедоступный IP-адрес.
