---
title: Проверка сетевой задержки виртуальных машин Azure в виртуальной сети Azure | Документация Майкрософт
