...
- Виртуальные машины, принадлежащие к виртуальной сети, могут работать с 500 тыс **_активными подключениями_* _ для всех размеров виртуальных машин с 500 тыс _*_активными потоками в каждом направлении_*_.  
- Виртуальные машины с сетевыми виртуальными модулями (NVA), такими как шлюз, прокси-сервер, брандмауэр, могут обслуживать _*_активные подключения_*_ 250 000 с 500 тыс _ *_Active Flow в каждом направлении_** из-за пересылки и дополнительного создания потока при новой настройке подключения к следующему прыжку, как показано на схеме выше. 
