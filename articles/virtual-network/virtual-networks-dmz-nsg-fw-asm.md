...
1. Настройте правила брандмауэра. Сведения о том, как это сделать, см. в приведенном ниже разделе "Правила брандмауэра".
...
Инструкции по скачиванию клиента и подключению к брандмауэру Barracuda, который используется в этом примере, см. в статье об [администрировании Barracuda NG](https://techlib.barracuda.com/NG61/NGAdmin).

В брандмауэре необходимо создать правила пересылки. Поскольку в этом примере входящий трафик только пересылается на брандмауэр, а затем на веб-сервер, потребуется только одно правило перенаправления NAT. В брандмауэре Barracuda NextGen Firewall, используемом в этом примере, это будет правило назначения NAT (Dst NAT) для передачи этого трафика.
