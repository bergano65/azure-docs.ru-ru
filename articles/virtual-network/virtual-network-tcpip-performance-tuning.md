...
В примере Нью-Йорка до Сан-Франциско это расстояние Бразилию 4,148 км. Минимальное время приема-Передачи = 2 * (4,148 / 200). Выходные данные формула будет в миллисекундах.
...
Теперь, когда мы обсуждали, TCP/IP, Настройка производительности для виртуальных машин Azure, шаги могут включать [планирования другой виртуальной сети](https://docs.microsoft.com/en-us/azure/virtual-network/virtual-network-vnet-plan-design-arm) вопросы или [Дополнительные сведения о подключении и настройке виртуальных сетей](https://docs.microsoft.com/en-us/azure/virtual-network/).