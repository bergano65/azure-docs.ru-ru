...
| | | | |
|-|-|-|-|
|**Route**|**Distance**|**Одностороннее время**|**RTT**|
...
Вы можете задать начальный размер окна TCP и коэффициент масштабирования TCP в Windows с помощью команды `Set-NetTCPSetting` PowerShell. Дополнительные сведения см. в разделе [Set-нетткпсеттинг](https://docs.microsoft.com/powershell/module/nettcpip/set-nettcpsetting?view=win10-ps).
