...
description: Узнайте, как назначить несколько IP-адресов виртуальной машине с помощью PowerShell. | Менеджер ресурсов
...
6. Определите основную конфигурацию IP для сетевого адаптера. Замените 10.0.0.4 действительным адресом в созданной подсети, если вы не использовали значение, определенное ранее. Прежде чем назначать статический IP-адрес, рекомендуем сначала убедиться, что он не используется. Введите команду `Test-AzPrivateIPAddressAvailability -IPAddress 10.0.0.4 -VirtualNetwork $VNet`. Если адрес доступен, в выходных данных возвращается значение *True*, Если он недоступен, вывод возвращает *false* и список доступных адресов. 
    ...
    При присвоении NIC нескольких конфигураций IP-нагрузок одна конфигурация должна быть назначена в качестве *-Primary*.
...
8. Создайте сетевой адаптер и свяжите с ним три конфигурации IP:
   ...
   >[!NOTE]
   >Хотя в этой статье все конфигурации назначены одному сетевому адаптеру, каждому сетевому адаптеру, подключенному к виртуальной машине, можно назначить несколько конфигураций IP. Чтобы узнать, как создать VM с несколькими NICs, прочитайте [Создать VM с несколькими](../virtual-machines/windows/multiple-nics.md) статьями NICs.
...
5. Выполните действия, описанные в одном из следующих разделов, с учетом задач.
   ...
   **Связывание ресурса общедоступного IP-адреса с новой IP-конфигурацией**
   ...
   Чтобы создать новую конфигурацию IP со статичным частным IP-адресом и связанным с ним общедоступным IP-адресом *myPublicIp3,* введите следующую команду:
   ...
   **Связывание ресурса общедоступного IP-адреса с имеющейся IP-конфигурацией**
   ...
   Введите следующую команду, чтобы связать ресурс общедоступного IP-адреса с существующей конфигурацией IP под названием *IpConfig-3:*
