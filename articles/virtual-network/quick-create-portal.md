...
3. В окне **Создание виртуальной машины — Основы** введите или выберите следующую информацию:
    ...
    | Изображение | Оставьте значение по умолчанию **Microsoft Windows Server 2019 Datacenter**. |
...
5. В окне **Создание виртуальной машины — диски**оставьте значения по умолчанию и нажмите кнопку **Далее: Сетевые подключения**.
