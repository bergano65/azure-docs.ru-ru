...
> [!IMPORTANT]
> Префикс общедоступного IP-адреса находится в общедоступной предварительной версии в ограниченном числе регионов. Вы можете [узнать, что означает предварительная версия](https://azure.microsoft.com/support/legal/preview-supplemental-terms/). Префикс общедоступного IP-адреса сейчас доступен в следующих регионах: центрально-западная часть США, западная часть США, западная часть США 2, центральная часть США, Северная Европа, Западная Европа и Юго-Восточная Азия. Обновленный список регионов, см. в разделе [обновления Azure](https://azure.microsoft.com/updates/?product=virtual-network).
