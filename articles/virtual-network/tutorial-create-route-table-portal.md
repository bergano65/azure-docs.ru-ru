...
1. В подменю **Создание таблицы маршрутов** введите или выберите следующую информацию:
    ...
    | Location | Оставьте значение по умолчанию **Восточная часть США**.
    | Распространение маршрутов шлюза виртуальной сети | Оставьте значение по умолчанию **Включено**. |
