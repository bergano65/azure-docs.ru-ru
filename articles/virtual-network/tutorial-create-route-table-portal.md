...
1. В окне **Create a virtual machine — Basics** (Создание виртуальной машины — основы) введите или выберите такую информацию:
...
1. В окне **Create a virtual machine — Management** (Создание виртуальной машины — управление) в поле **Учетная запись хранения диагностики** выберите **Создать**.
