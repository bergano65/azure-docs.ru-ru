...
7. Выберите **статистической обработки** ввести в качестве **Max**
...
## <a name="view-ddos-protection-alerts-in-azure-security-center"></a>Просмотр оповещений системы защиты от атак DDoS в центре безопасности Azure

Центр безопасности Azure предоставляет список [оповещения системы безопасности](/azure/security-center/security-center-managing-and-responding-alerts), с информацией, чтобы определить причину и устранять проблемы. С помощью этой функции вы получите единое представление оповещений, включая предупреждения, связанные с атаки DDoS и действия, предпринятые для устранения атаки в практически времени.
Существуют два определенных типов оповещений, что вы увидите для любой DDoS атаки, обнаружение и устранение рисков:

- **Обнаружена атака DDoS для общедоступного IP-адреса**: Это предупреждение создается в том случае, когда службу защиты от атак DDoS обнаруживает, что один из общедоступных IP-адреса является целевым объектом атаки DDoS.
- **Устранить атаки DDoS для общедоступного IP-адреса**: Это предупреждение создается в том случае, когда сдерживается атаку на общедоступный IP-адрес.
Чтобы просмотреть предупреждения, откройте **центр безопасности** на портале Azure. В разделе **защиты от угроз**выберите **оповещения системы безопасности**. На следующем рисунке показан пример оповещения атаки DDoS.

![Предупреждение от атак DDoS в центре безопасности Azure](./media/manage-ddos-protection/ddos-alert-asc.png)

Предупреждения содержат общие сведения о общедоступный IP-адрес, который атаки, географической и сведения об анализе угроз, а также действия исправления.
