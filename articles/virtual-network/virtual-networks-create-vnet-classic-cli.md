...
ms.locfileid: "71056650"
---
# <a name="create-a-virtual-network-classic-by-using-the-azure-cli"></a>Создание (классической) виртуальной сети с помощью интерфейса командной строки Azure
...
В этом документе описывается создание виртуальной сети с помощью классической модели развертывания. Вы также можете [создать виртуальную сеть на основе модели развертывания менеджера ресурсов, используя интерфейс командной строки Azure](quick-create-cli.md).
