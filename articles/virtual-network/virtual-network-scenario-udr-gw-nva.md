...
|  | Плюсы | Минусы |
| --- | --- | --- |
| **NSG** |Бесплатное использование. <br/>Интегрирована в управление доступом на основе ролей (RBAC). <br/>Правила можно создавать в шаблонах Azure Resource Manager. |В больших средах сложность может меняться. |
