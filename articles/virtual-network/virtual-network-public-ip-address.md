 ...
 * [Создание общедоступного IP-адреса — портал](./create-public-ip-portal.md?tabs=option-create-public-ip-standard-zones)
 * [Создание общедоступного IP-адреса — PowerShell](./create-public-ip-powershell.md?tabs=option-create-public-ip-standard-zones)
 * [Создание общедоступного IP-адреса — Azure CLI](./create-public-ip-cli.md?tabs=option-create-public-ip-standard-zones)
...
## <a name="view-modify-settings-for-or-delete-a-public-ip-address"></a>Просмотр, изменение параметров или удаление общедоступного IP-адреса
   ...
   - **Изменение**. чтобы изменить параметры с помощью сведений на шаге 4, [Создайте общедоступный IP-адрес](#create-a-public-ip-address), например время ожидания ПРОСТОЯ, метку DNS-имени или метод назначения.  (Полный процесс обновления номера SKU общедоступного IP-адреса с базового до Standard см. в разделе [обновление общедоступных IP-адресов Azure](./virtual-network-public-ip-address-upgrade.md).)
   >[!WARNING]
...
Чтобы получить список общедоступных IP-адресов в масштабируемом наборе виртуальных машин, можно использовать PowerShell ([Get-азпублиЦипаддресс-виртуалмачинескалесетнаме](/powershell/module/az.network/get-azpublicipaddress)) или CLI ([AZ vmss List-instance-public-IP](/cli/azure/vmss#az_vmss_list_instance_public_ips)).

Дополнительные сведения см. в статье [Сеть для масштабируемых наборов виртуальных машин Azure](../virtual-machine-scale-sets/virtual-machine-scale-sets-networking.md#public-ipv4-per-virtual-machine).
...
- [Общедоступные Load Balancer](../load-balancer/quickstart-load-balancer-standard-public-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
- [Шлюз приложений](../application-gateway/quick-create-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
- [Подключение типа "сеть — сеть" с помощью VPN-шлюза](../vpn-gateway/tutorial-site-to-site-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
- [Масштабируемый набор виртуальных машин](../virtual-machine-scale-sets/quick-create-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
...
- Создание и назначение [определений политик Azure](./policy-reference.md) для общедоступных IP-адресов
