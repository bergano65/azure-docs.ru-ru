...
|PowerShell|[Get-AzPublicIpAddress](/powershell/module/az.network/get-azpublicipaddress) чтобы извлечь объект общедоступного IP-адреса и просмотреть его параметры, [AzPublicIpAddress набора](/powershell/module/az.network/set-azpublicipaddress) для обновления параметров; [Remove-AzPublicIpAddress](/powershell/module/az.network/remove-azpublicipaddress) для удаления|
