...
4. Введите или выберите значения для перечисленных ниже параметров в разделе **Создать общедоступный IP-адрес**, а затем щелкните **Создать**.
   ...
   |Subscription|ДА|Должен существовать в той же [подписке](../azure-glossary-cloud-terminology.md?toc=%2fazure%2fvirtual-network%2ftoc.json#subscription) , что и ресурс, к которому вы свяжете общедоступный IP-адрес.|
   ...
   |Location|ДА|Должно находиться в том же [расположении](https://azure.microsoft.com/regions), которое также называется регионом, как ресурс, к которому вы свяжете общедоступный IP-адрес.|
