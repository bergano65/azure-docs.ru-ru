...
|Priority|Источник|Исходные порты|Назначение|Конечные порты|Протокол|доступ|
|---|---|---|---|---|---|---|
|65500|0.0.0.0/0|0-65535|0.0.0.0/0|0-65535|Любой|Запрещено|
