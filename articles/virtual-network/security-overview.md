...
|Direction (направление)| Определяет тип трафика (входящий или исходящий), к которому применяется правило.|
...
|Приоритет|Источник|Исходные порты|Destination|Конечные порты|Протокол|Access|
|---|---|---|---|---|---|---|
