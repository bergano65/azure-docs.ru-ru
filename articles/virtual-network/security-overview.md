...
ms.locfileid: "81269879"
---
# <a name="network-security-groups"></a>Группы безопасности сети
<a name="network-security-groups"></a>

Группу сетевой безопасности Azure можно использовать для фильтрации сетевого трафика в и из ресурсов Azure в виртуальной сети Azure. Группа сетевой безопасности содержит [правила безопасности,](#security-rules) которые позволяют или отказывают ввходящим сетевому трафику или исходящим сетевым трафиком из нескольких типов ресурсов Azure. Для каждого правила можно указать источник и назначение, порт и протокол.
В этой статье описаны свойства правила группы безопасности сети, применяемые [правила безопасности по умолчанию](#default-security-rules) и свойства правил, которые можно изменить для создания [расширенного правила безопасности.](#augmented-security-rules)
...
* Чтобы узнать, какие ресурсы Azure могут быть развернуты в виртуальной сети и иметь группы сетевой безопасности, связанные с ними, [см. Виртуальную сетевую интеграцию для служб Azure](virtual-network-for-azure-services.md)
...
* Узнайте, как включить [журналы потоков группы сетевой безопасности](../network-watcher/network-watcher-nsg-flow-logging-portal.md?toc=%2fazure%2fvirtual-network%2ftoc.json) для анализа сетевого трафика на ресурсы, которые имеют связанную группу сетевой безопасности.
