...
### <a name="inbound"></a>Вход.

#### <a name="allowvnetinbound"></a>AllowVNetInBound

|Приоритет|Источник|Исходные порты|Место назначения|Конечные порты|Протокол|Доступ|
|---|---|---|---|---|---|---|
|65000|Виртуальная сеть|0-65535|Виртуальная сеть|0-65535|Все|Allow|

#### <a name="allowazureloadbalancerinbound"></a>AllowAzureLoadBalancerInBound

|Приоритет|Источник|Исходные порты|Место назначения|Конечные порты|Протокол|Доступ|
|---|---|---|---|---|---|---|
|65001|AzureLoadBalancer|0-65535|0.0.0.0/0|0-65535|Все|Allow|

#### <a name="denyallinbound"></a>DenyAllInbound

|Приоритет|Источник|Исходные порты|Место назначения|Конечные порты|Протокол|Доступ|
|---|---|---|---|---|---|---|
|65500|0.0.0.0/0|0-65535|0.0.0.0/0|0-65535|Все|Deny|
...
|Приоритет|Источник|Исходные порты| Место назначения | Конечные порты | Протокол | Доступ |
|---|---|---|---|---|---|---|
| 65001 | 0.0.0.0/0 | 0-65535 | Интернет | 0-65535 | Все | Allow |
