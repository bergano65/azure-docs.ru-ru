...
Этот базовый уровень безопасности применяет рекомендации из [тестового показателя безопасности Azure версии 1,0](../security/benchmarks/overview.md) к общедоступному IP-адресу Azure. Тест производительности системы безопасности Azure содержит рекомендации по обеспечению безопасности облачных решений в Azure. Содержимое группируются по **элементам управления безопасностью** , определенным в ходе тестирования системы безопасности Azure, и связанным рекомендациям, применимым к общедоступному IP-адресу Azure. **Элементы управления** , неприменимые к общедоступному IP-адресу Azure, были исключены.  Обратите внимание, что общедоступные IP-адреса Azure не хранят данные клиентов.
