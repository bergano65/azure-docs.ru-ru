...
Политики применяются согласно следующей иерархии: подписка, группа управления и группа ресурсов. Узнайте больше о [политике Azure](../azure-policy/azure-policy-introduction.md?toc=%2fazure%2fvirtual-network%2ftoc.json) или разверните некоторые примеры [шаблона политики](policy-samples.md).
