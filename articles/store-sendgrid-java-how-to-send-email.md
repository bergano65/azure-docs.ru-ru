...
Дополнительные сведения см. в разделе <https://sendgrid.com>.
...
3. Создайте сообщение и назначьте значения полей **Кому**, **От**, **Тема** и содержимое. Это показано в [следующих руководствах: Создание раздела электронной](#how-to-create-an-email) почты.
4. Отправьте сообщение через объект *javax.mail.Transport*. Это показано в [практические руководства. Отправка сообщения электронной почты] [#how-to-send-a-Email].
...
## <a name="how-to-send-an-email"></a>Практическое руководство. Отправка электронного сообщения
...
## <a name="how-to-update-email-properties"></a>Практическое руководство. Обновить свойства электронной почты
...
SendGrid поддерживает различные веб-интерфейсы API, с помощью которых вы можете использовать дополнительные функции SendGrid, доступные в приложении Azure. Полные сведения см. в [документации по API SendGrid][SendGrid API documentation].
...
* Пример, демонстрирующий использование SendGrid в развертывании Azure: [Как отправлять электронную почту с помощью SendGrid из Java в развертывании Azure](store-sendgrid-java-how-to-send-email-example.md)
