...
3. Создайте сообщение и назначьте значения полей **Кому**, **От**, **Тема** и содержимое. Это показано в [How To: Создайте сообщение электронной почты](#how-to-create-an-email) раздел.
4. Отправьте сообщение через объект *javax.mail.Transport*. Это показано в [How To: Отправка сообщения электронной почты] разделе [# практическом руководстве-send--email].

## <a name="how-to-create-an-email"></a>Практическое руководство: Создайте сообщение электронной почты
