...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Руководство по началу работы для разработчиков Azure</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="visually-hidden">Документация по Microsoft Azure</h1>
        <ul class="pivots">
            <li>
                            ...
                            <li>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Защита ресурсов и управление ими</h3>
                                                <ul class="noBullet">
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">База данных SQL для пограничной зоны</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">SQL Server на виртуальной машине Azure</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics (ранее — Хранилище данных SQL)</a></li>
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/azure/azure-portal/">
                                                            <img src="https://docs.microsoft.com/media/logos/logo_azure.svg" alt=""> Портал Azure </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="https://docs.microsoft.com/media/common/i_mobile-app-developement.svg" alt=""> Мобильное приложение Azure </a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>Развитие навыков с помощью Microsoft Learn</h3>
                                                <ul class="noBullet">
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/principles-cloud-computing/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/principles-cloud-computing.svg" alt=""> Принципы облачных вычислений </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/control-azure-services-with-cli/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/control-azure-services-with-cli.svg" alt=""> Управление службами Azure с помощью CLI </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/automate-azure-tasks-with-powershell/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/automate-azure-tasks-with-powershell.svg" alt=""> Автоматизация задач Azure с помощью скриптов в PowerShell </a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/browse/?products=azure">Другие интерактивные руководства</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
            ...
            <li>
                ...
                <ul id="products">
                    <li>
                        <a data-default="true" href="#all">Все</a>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics (ранее — Хранилище данных SQL)</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/blockchain/tokens/">
                                                ...
                                                <p>Служба блокчейн-токенов Azure</p>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/virtual-machines/linux/">
                                                ...
                                                <p>Виртуальные машины Linux</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-machines/windows/">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>Виртуальные машины Windows</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/aks/">
                                                ...
                                                <p>Служба Azure Kubernetes (AKS)</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>SQL Server на виртуальных машинах</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/vmware-cloudsimple/">
                                                ...
                                                <p>Решение VMware в Azure от CloudSimple</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Контейнеры</h3>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/container-registry/">
                                                ...
                                                <p>Реестр контейнеров</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/container-instances/">
                                                <img src="media/index/ContainerInstances.svg" alt="" />
                                                <p>Экземпляры контейнеров</p>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="/azure/app-service/containers/">
                                                <img src="media/index/AppService.svg" alt="" />
                                                <p>Веб-приложение для контейнеров</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/sql-database-edge/">
                                                ...
                                                <p>База данных SQL Azure для пограничных вычислений</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/integrations">
                                                ...
                                                <p>Интеграция средств для разработчиков</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/cli">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                ...
                                                <p>Мобильное приложение Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/media-services/media-services-manage-channels-overview">
                                                ...
                                                <p>Потоковая трансляция в прямом эфире и по запросу</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/media-services/media-services-playback-content-with-existing-players">
                                                ...
                                                <p>Проигрыватель мультимедиа Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/spatial-anchors/">
                                                ...
                                                <p>Пространственные привязки Azure</p>
                                            </a>
                                        </li>
                                         <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/app-service-mobile/">
                                                ...
                                                <p>Служба приложений — мобильные приложения</p>
                                            </a>
                                        </li>
                                    </ul>
                                    <h3>Сеть</h3>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/dedicated-hsm">
                                                ...
                                                <p>Выделенное устройство HSM Azure</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/virtual-network/ddos-protection-overview">
                                        ...
                                        <li>
                                            <a href="/azure/asc-for-iot/">
                                                ...
                                                <p>Центр безопасности Azure для Интернета вещей</p>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/azure-government/">
                                                ...
                                                <p>Azure для US Gov организаций</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/app-service-web/">
                                                ...
                                                <p>Служба приложений — веб-приложения</p>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="/azure/api-management/">
                    ...
                    <li>
                        <a href="#ai">Средства ИИ и машинного обучения</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Создание рабочей области Azure Databricks с кластерами Spark</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics (ранее — Хранилище данных SQL)</h3>
                                                    <p>Служба аналитики без ограничений и с беспрецедентной скоростью получения полезных сведений</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>HDInsight</h3>
                                                    <p>Подготовка облачных кластеров Hadoop, Spark, R Server, HBase и Storm</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Аналитика в реальном времени для быстрого движущихся потоков данных из приложений и с устройств</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Распределенная служба аналитики, которая упрощает работу с большими данными</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Службы Azure Analysis Services</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Spark для Azure HDInsight</h3>
                                                    <p>Apache Spark в облаке для критически важных развертываний</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Apache Storm для Azure HDInsight</h3>
                                                    <p>Упрощение потоковой обработки в режиме реального времени для больших данных</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>R Server для Azure HDInsight</h3>
                                                    <p>Прогнозная аналитика, машинное обучение и статистическое моделирование для больших данных</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Получение дополнительных возможностей на основе существующих корпоративных ресурсов данных</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Служба файлов NFS корпоративного уровня на платформе NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Простая и надежная служба для предоставления сторонним организациям доступа к большим данным</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Служба "Блокчейн Azure"</h3>
                                                    <p>Создавайте, администрируйте и расширяйте блокчейн-сети консорциумов</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Служба блокчейн-токенов Azure</h3>
                                                    <p>Простое определение и создание токенов на основе реестра, а также управление ими</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#Compute">Службы вычислений</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Виртуальные машины Linux</h3>
                                                    <p>Подготовка виртуальных машин Ubuntu, Red Hat и др.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Служба Azure Kubernetes (AKS)</h3>
                                                    <p>Оптимизация развертывания, администрирования и использования Kubernetes</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Создание облачных приложений и API с высокой доступностью и бесконечной масштабируемостью</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Server на виртуальных машинах</h3>
                                                    <p>Размещение корпоративных приложений SQL Server в облаке</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Выполняйте самые крупные рабочие нагрузки SAP HANA любого поставщика гипермасштабируемых облачных решений</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Решение VMware в Azure от CloudSimple</h3>
                                                    <p>Запуск платформы VMware в Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Полностью управляемая служба OpenShift для совместной работы с Red Hat</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cognitive Services</h3>
                                                    <p>Использование контейнеров Azure Cognitive Services с Docker, Kubernetes, AKS и Экземплярами контейнеров</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>База данных SQL Azure для пограничных вычислений</h3>
                                                    <p>Ядро реляционной СУБД, оптимизированное для развертываний Интернета вещей и пограничных развертываний.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>База данных Azure для PostgreSQL</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>База данных Azure для MySQL</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>База данных Azure для MariaDB</h3>
                                                    <p>Управляемая служба баз данных MariaDB для разработчиков приложений</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Упрощение миграции в облако</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>Полнофункциональная интегрированная среда разработки (IDE) для Android, iOS, Windows, Интернета и облачной среды</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DevOps</h3>
                                                    <p>Службы для рабочих групп, обеспечивающие совместное использование кода, отслеживание хода работ и доставку программного обеспечения</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Пакеты SDK</h3>
                                                    <p>Создавайте облачные приложения с помощью уже знакомых языков программирования</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Интеграция средств для разработчиков</h3>
                                                    <p>Возможность использовать сторонние средства при разработке в Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Быстродействующее масштабируемое хранилище параметров конфигурации приложений</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Службы лабораторий Azure</h3>
                                                    <p>Создание лабораторий в облаке для аудитории, разработки и тестирования, а также других сценариев (прежнее название — DevTest Labs)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Интеграция средств для разработчиков</h3>
                                                    <p>Популярные расширения для Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#identity">Удостоверение</a>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Синхронизация локальных каталогов и поддержка единого входа</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Многофакторная идентификация</h3>
                                                    <p>Усиленная защита данных и приложений без дополнительных трудностей для пользователей</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Управление удостоверениями клиентов и доступом в облаке</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT Edge</h3>
                                                    <p>Расширение интеллектуальных возможностей облака на пограничные устройства</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Подключение устройств к решению Интернета вещей без написания кода устройства</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Акселераторы решений для Интернета вещей</h3>
                                                    <p>Сбор и анализ необработанных данных для улучшения бизнес-показателей</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Студия машинного обучения</h3>
                                                    <p>Простая разработка, развертывание и администрирование решений прогнозной аналитики</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Отправка push-уведомлений из любой серверной части на любую платформу</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Site Recovery</h3>
                                                    <p>Управление защитой и восстановлением частных облаков</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Планировщик</h3>
                                                    <p>Запуск заданий по простому или сложному повторяющемуся расписанию</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Monitor</h3>
                                                    <p>Подробные данные мониторинга в реальном времени по всем ресурсам Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Широкие возможности обеспечения облачной безопасности для обнаружения и предотвращения угроз</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Портал Azure</h3>
                                                    <p>Создание, контроль и мониторинг всех продуктов Azure с помощью одной унифицированной консоли</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Упрощение управления ресурсами вашего приложения</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cloud Shell</h3>
                                                    <p>Упрощенное администрирование Azure с помощью оболочки на основе браузера</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Мобильное приложение Azure</h3>
                                                    <p>Подключение к ресурсам Azure в любое время из любой точки мира</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Политика Azure</h3>
                                                    <p>Реализация корпоративного управления и стандартов в требуемом масштабе для ресурсов Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Изучение ресурсов по мере необходимости с помощью полнофункционального языка запросов</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Управляемые приложения Azure</h3>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Служба "Миграция Azure"</h3>
                                                    <p>Простое обнаружение, оценка, подбор размера и миграция локальных виртуальных машин в Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Получение и интерпретация сведений, указанных в счете за использование подписки Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Управление ресурсами клиента в масштабе</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Кодировка, хранение и потоковая передача аудио и видео с учетом масштаба</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Кодирование</h3>
                                                    <p>Кодирование студийного уровня в масштабах облака</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Потоковая трансляция в прямом эфире и по запросу</h3>
                                                    <p>Передача содержимого на любые устройства с требуемой степенью масштабирования</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Проигрыватель мультимедиа Azure</h3>
                                                    <p>Единый проигрыватель для всех необходимых возможностей воспроизведения</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Повышенная доступность и более простой поиск мультимедийных материалов</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#mixed">Смешанная реальность</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Digital Twins</h3>
                                                    <p>Создавайте решения пространственной аналитики нового поколения для Интернета вещей</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Сеть доставки содержимого</h3>
                                                    <p>Безопасная и надежная доставка содержимого благодаря глобальному охвату аудитории</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>ExpressRoute</h3>
                                                    <p>Выделенные оптоволоконные подключения частных сетей к Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure DNS</h3>
                                                    <p>Разместите свой домен DNS в Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Шлюз приложений</h3>
                                                    <p>Создание безопасных, масштабируемых и высокодоступных веб-интерфейсов в Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Брандмауэр Azure</h3>
                                                    <p>Высокодоступная масштабируемая облачная служба безопасности сети</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Масштабируемая и безопасная точка входа для доставки глобальных веб-приложений</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Бастион Azure</h3>
                                                    <p>Безопасное и бесперебойное SSL-подключение к виртуальным машинам с помощью портала Azure без общедоступного IP-адреса</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Брандмауэр веб-приложения</h3>
                                                    <p>Централизованная защита веб-приложений от распространенных эксплойтов и уязвимостей</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Приватный канал Azure</h3>
                                                    <p>Частный доступ к службам, размещенным на платформе Azure, с сохранением данных в сети Майкрософт</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Унифицированное управление безопасностью и расширенная защита от угроз для гибридных облачных рабочих нагрузок</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Выделенное устройство HSM</h3>
                                                    <p>Использование хранилища криптографических ключей в Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Центр безопасности Azure для Интернета вещей</h3>
                                                    <p>Узнайте, как унифицировать управление безопасностью и расширить защиту от угроз для решений Интернета вещей.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft Azure для US Gov организаций</h3>
                                                    <p>Создание и размещение приложений для целей US Gov  в выделенном экземпляре Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Создавайте и размещайте приложения в соответствии с политиками и правилами обработки данных, установленными правительством Китая.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>StorSimple</h3>
                                                    <p>Сокращение затрат за счет гибридного облачного решения корпоративного класса для хранения данных</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Хранилище BLOB-объектов</h3>
                                                    <p>Хранилище объектов на основе REST для неструктурированных данных</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Постоянные защищенные хранилища дисков с поддержкой виртуальных машин</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Управляемые диски</h3>
                                                    <p>Постоянное безопасное хранилище дисков для виртуальных машин Azure</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Хранилище очередей</h3>
                                                    <p>Эффективное масштабирование приложений в зависимости от трафика</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Файловые ресурсы, использующие стандартный протокол SMB 3.0</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Решение для оптимизации гибридного хранилища в средах HPC</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Недорогое безопасное облачное хранилище для редко запрашиваемых данных</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp Files</h3>
                                                    <p>Сетевые службы файлов корпоративного уровня на платформе NetApp</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Служба приложений — веб-приложения</h3>
                    ...
                    <li>
                        <a href="#windowsvirtualdesktop">Виртуальный рабочий стол Windows</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Виртуальный рабочий стол Windows</h3>
                                                    <p>Интерфейс виртуального рабочего стола на любом устройстве в масштабах облака</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure для разработчиков .NET </h3>
                                                <p>
                                                    <a href="/dotnet/azure">Начало работы</a>
                                                </p>
                                                <p>
                                                    <a href="/dotnet/api/overview/azure/?view=azure-dotnet">Справочник по API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure для разработчиков Python </h3>
                                                <p>
                                                    <a href="/azure/python">Начало работы</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">Справочник по API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure для разработчиков Node.js </h3>
                                                <p>
                                                    <a href="/azure/javascript/">Начало работы</a>
                                                </p>
                                                <p>
                                                    <a href="/javascript/api/overview/azure/">Справочник по API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure для разработчиков Java </h3>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Azure для разработчиков Go </h3>
                                                <p>
                                                    <a href="/azure/go/">Начало работы</a>
                                                </p>
                                                <p>
                                                    <a href="https://godoc.org/github.com/Azure/azure-sdk-for-go">Справочник по API</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="/powershell/azure/get-started-azureps">Начало работы</a>
                                                </p>
                                                <p>
                                                    <a href="/powershell/azure/overview">Справочные материалы</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Портал Azure</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">Начало работы</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Мобильное приложение Azure</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">Начало работы</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-azureappservice">Служба приложений</a>
                                                </p>
                                                 <p>
...
Средства Java </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/java/api/overview/azure/maven/readme">Подключаемые модули Maven</a>
                                                </p>
                                                <p>
...
Azure Resource Manager </h3>
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/templates/">Справочные материалы</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
...
Средства SQL </h3>
                                                ...
                                                <p>
                                                    <a href="/sql/tools/overview-sql-tools">Просмотреть все средства SQL</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Набор рекомендуемых архитектур для облака. Каждая архитектура включает рекомендации, предписания и развертываемое решение.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
