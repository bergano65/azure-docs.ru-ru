...
1. Перейдите в службу [Записные книжки Azure](https://notebooks.azure.com) и выполните вход. (Дополнительные сведения см. в [кратком руководстве по входу в службу "Записные книжки Azure"](quickstart-sign-in-azure-notebooks.md).)

1. Вверху на странице общедоступного профиля выберите **My Projects** (Мои проекты).

    ![Ссылка My Projects (Мои проекты) в верхней части окна браузера](media/quickstarts/my-projects-link.png)

1. На странице **My Projects** (Мои проекты) выберите **+ New Project** (+ Новый проект) (сочетание клавиш: n). Эта кнопка может отображаться просто как знак **+**, если окно браузера уменьшено:

    ![Команда New Project (Новый проект) на странице My Projects (Мои проекты)](media/quickstarts/new-project-command.png)

1. В появившемся всплывающем окне **Create New Project** (Создание проекта) введите или укажите приведенные ниже сведения, а затем выберите **Create** (Создать).
...
| Вид | Команды для управления видимостью различных частей пользовательского интерфейса Jupyter. |
| Вставка | Команды для вставки новой ячейки выше или ниже текущей. Эти команды часто используются при создании записной книжки. |
...
Если ячейки кода в записной книжке не работают ожидаемым образом, возможно, в коде есть ошибки или другие проблемы. Однако за исключением инструкций `print` для отображения значений переменных, в записной книжке Jupyter нет других средств отладки.

К счастью, расширение Python для Visual Studio Code позволяет непосредственно импортировать записную книжку Jupyter как единый файл кода с ячейками Markdown в комментариях. Затем можно запустить отладчик Visual Studio Code для пошагового выполнения кода, задания точек останова, проверки состояния и так далее. 

После внесения исправлений в код сохраните файл с расширением *.ipynb*, а затем отправьте его в службу "Записные книжки Azure".

Дополнительные сведения см. в следующих статьях документации по Visual Studio Code:

- [Общие сведения о записных книжках Jupyter в VS Code](https://code.visualstudio.com/docs/languages/python#_jupyter-notebooks)
- [Руководство по Python. Настройка и запуск отладчика](https://code.visualstudio.com/docs/python/python-tutorial#_configure-and-run-the-debugger)
- [Редактирование. Ячейки кода Jupyter](https://code.visualstudio.com/docs/python/editing#_jupyter-code-cells)
