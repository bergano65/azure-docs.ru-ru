---
title: Руководство по созданию и запуску Jupyter Notebook в предварительной версии службы "Записные книжки Azure"
description: Узнайте, как создать и запустить записную книжку Jupyter Notebook в предварительной версии службы "Записные книжки Azure", которая демонстрирует процесс линейной регрессии при обработке и анализе данных.
ms.topic: tutorial
ms.date: 01/11/2019
...
ms.locfileid: "94844477"
---
# <a name="tutorial-create-and-run-a-jupyter-notebook-with-python"></a>Руководство. Создание и запуск записной книжки Jupyter Notebook с помощью Python

[!INCLUDE [notebooks-status](../../includes/notebooks-status.md)]

В этом руководстве приводятся пошаговые инструкции по созданию записной книжки Jupyter Notebook с помощью службы "Записные книжки Azure", демонстрирующей пример простой линейной регрессии. При работе с этим руководством вы познакомитесь с пользовательским интерфейсом Jupyter Notebook, в частности с функциями создания ячеек различных типов, выполнения ячеек и представления записной книжки в виде слайд-шоу.
...
> [!div class="checklist"]
> * Создание записной книжки проекта с примером данных.
> * Использование интерфейса записной книжки для создания различных типов ячеек.
> * Запустите записную книжку
> * Сохранение записной книжки.
> * Отладка записной книжки в Visual Studio Code.
...
1. В появившемся всплывающем окне **Создание проекта** введите или укажите приведенные ниже сведения, а затем нажмите кнопку **Создать**:
   ...
   - **Имя проекта**: Linear Regression Example - Cricket Chirps (Пример линейной регрессии — стрекотание сверчка).
...
1. Через несколько секунд Записные книжки Azure перенаправят вас в окно нового проекта.
...
| Изменить | Типовые команды вырезания, копирования и вставки ячеек, поиска и замены значений, управления вложениями в ячейках и вставки изображений.  |
| Представление | Команды для управления видимостью различных частей пользовательского интерфейса Jupyter. |
...
| Ядро | Команды для управления способом выполнения кода в ядре, а также команда **Change kernel** (Изменить ядро) для изменения языка или версии Python, используемой для запуска записной книжки. |
...
Дополнительные сведения см. в [документации Visual Studio Code по отладке записных книжек Jupyter Notebook](https://code.visualstudio.com/docs/python/jupyter-support#debug-a-jupyter-notebook).

Чтобы узнать больше о дополнительных функциях Visual Studio Code для записных книжек Jupyter Notebook, см. [эту статью](https://code.visualstudio.com/docs/python/jupyter-support).
