---
title: Данные об импорте и экспорте с проектами с предварительной версией ноутбуков Azure
description: Узнайте, как внести данные в проект Azure Notebooks Preview из внешних источников и как экспортировать данные из проекта.
ms.topic: how-to
ms.date: 12/04/2018
...
---
# <a name="work-with-data-files-in-azure-notebooks-preview-projects"></a>Работа с файлами данных в проектах Azure Notebooks Preview
...
1. Выберите команду **Отправить**, а затем либо **С URL-адреса** или **С компьютера** и спроектируйте необходимую информацию для импорта данных.
   ...
   - **С URL:** Введите исходный адрес в поле **URL-файла** и имя файла для присвоения блокноту в вашем проекте в поле **имя файла.** Затем выберите **+ Добавить файл**, чтобы добавить в список передачи URL-адрес. Повторите эту процедуру для всех других URL-адресов, а затем выберите **Готово**.

     ![Всплывающее окно отправки из URL-адреса](media/quickstarts/upload-from-url-popup.png)

   - **С компьютера:** Перетащите и перебросьте файлы во всплывающее окно или выберите **Выберите файлы,** затем просмотрите и выберите файлы данных, которые вы хотите импортировать. Можно удалять или выбирать любое количество файлов любого типа и формата, поскольку именно код в записной книжке открывает файл и анализирует его данные.
...
1. В запущенном блокноте выберите команду**загрузки** **файлов:** > 
...
1. В появившемся всплывающем окне **Состояние отправки** из раскрывающегося списка выберите **Папка назначения**.
    ...
    - Папка сеанса (*~/* ): Загружает файлы в текущую сессию ноутбука, но не создает файлы в проекте. Папка сеанса является одноранговой в папке проекта, но не сохраняется после завершения сеанса. Чтобы получить доступ к файлам сеанса в код, добавьте префикс имени файла с относительным путем *../*.
...
1. Выберите команду меню**загрузки** **файлов:** > 
