...
Идентификатор пользователя является частью URL-адресов, используемых для совместного использования проектов и записных книжек. Ниже перечислены различные шаблоны URL-адресов:
...
| Social Profiles (Профили в социальных сетях) | Идентификаторы GitHub, Twitter и Facebook, если вы хотите поделиться ими. |
