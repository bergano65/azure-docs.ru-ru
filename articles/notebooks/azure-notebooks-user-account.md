...
> [!Note]
> При попытке создать учетную запись с адресом электронной почты, который уже имеет учетной записи, связанной с ним, может появиться сообщение «невозможно войдите в систему с помощью рабочей или адрес электронной почты. Использование личной электронной почты, например Gmail или Yahoo!, или получить новую почту Outlook». В этом случае попробуйте войти рабочий адрес электронной почты, не создавая новую учетную запись.
