...
- [Введение в обработку и анализ данных](https://github.com/jakevdp/PythonDataScienceHandbook/tree/master/code_listings) от Джейка Вандерпласа (Jake Vanderplas).
...
- [Примеры для начала работы со службой "Машинное обучение Azure"](https://notebooks.azure.com/azureml/projects/0f41b597b1ea)
