...
По умолчанию проекты выполняются **бесплатный вычислений** уровня, который ограничен 4 ГБ памяти и 1 ГБ данных, чтобы избежать злонамеренного использования. Можно обойти эти ограничения и увеличить вычислительную мощность, используя другую виртуальную машину, подготовленное в подписке Azure. Дополнительные сведения см. в разделе [как использовать виртуальные машины для обработки и анализа данных](use-data-science-virtual-machine.md).
