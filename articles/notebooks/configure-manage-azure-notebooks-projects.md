...
| Get-Help | Сочетание клавиш | Действие |
| --- | --- | --- |
...
| Скачать | d | Загружает ZIP-файл, содержащий файл или содержимое папки. |
| Переименовать | а | Запрашивает новое имя для файла или папки. |
...
| Скачать | d | Скачивает копию записной книжки. |
...
- **Environment. yml**. во втором раскрывающемся списке выберите файл *среды. yml* для проектов Python с помощью среды conda.
   ...
   > [!WARNING]
   > Так как это предварительная версия службы в разработке, в настоящее время существует известная проблема `Environment.yml` , при которой параметр не применяется к проекту должным образом. Проект и записные книжки Jupyter в настоящее время не загружают указанный файл среды.
