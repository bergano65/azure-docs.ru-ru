...
- Настройка среды проекта осуществляется либо путем запуска скриптов, либо напрямую с помощью терминала.
- Через терминал можно получить доступ к журналам.

> [!Note]
> Вы не можете управлять проектом, которым не владеете, если только владелец проекта не назначил вам права участника совместной работы. В противном случае описанные здесь функции управления и настройки будут для вас недоступны.
