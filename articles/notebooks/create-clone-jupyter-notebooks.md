...
| Идентификатор проекта | Пользовательский идентификатор, который включается в URL-адрес для общего доступа к проекту. Этот идентификатор может содержать только буквы, цифры и дефисы. |
| Общедоступные | Если задано, доступ разрешается любому пользователю, имеющему ссылку. Очистите этот флажок, если нужно создать частный проект. |
