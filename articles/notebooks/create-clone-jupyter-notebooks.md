...
| Get-Help | Кому доступно | Описание |
| --- | --- | --- |
| **Запуска** | Владелец | Запускает сервер проекта и открывает папку проекта в Jupyter. (Чаще вы сначала открываете папку проекта, а уже потом запускаете из нее записную книжку.) |
...
| Открытый | Если задан этот параметр, доступ к проекту разрешается любому пользователю, у которого есть ссылка. В случае создания закрытого проекта снимите этот флажок. |
...
| Содержимое | "Веб-транзакции" | обзор | Вопросы и ответы | справка | html |
...
| Поле | Описание |
| --- | --- |
| GitHub repository (Репозиторий GitHub) | Имя исходного репозитория на сайте github.com. Например, чтобы клонировать записные книжки Jupyter для Azure Cognitive Services [https://github.com/Microsoft/cognitive-services-notebooks](https://github.com/Microsoft/cognitive-services-notebooks)в, введите Microsoft/-Services-Notebooks.  |
