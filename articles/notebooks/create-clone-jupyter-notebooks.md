...
| Команда | Кому доступно | Description (Описание) |
| --- | --- | --- |
...
| --- | --- |
| Имя проекта | Понятное имя проекта, которое Записные книжки Azure будут отображать в соответствующих представлениях. Например, "Мой проект записной книжки". |
...
| Компьютеры | файлов | предварительный просмотр | цены | Профиль | поиск |
| status | support | test | | | |
