...
[![Mпанель мониторинга проектов y в записных книжках Azure](media/my-projects-dashboard.png)](media/my-projects-dashboard.png#lightbox)
...
| --- | --- | --- |
| **Run (Запустить)** | Владелец. | Запускает сервер проекта и открывает папку проекта в Jupyter. (Чаще вы сначала открываете папку проекта, а уже потом запускаете из нее записную книжку.) |
...
| **+ Новый проект** | Владелец. | Создает проект. См. инструкции по [созданию проекта](#create-a-new-project). |
| **Отправьте репозиторий GitHub** | Владелец. | Импортирует проект из GitHub. См. инструкции по [импорту проекта из GitHub](#import-a-project-from-github). |
