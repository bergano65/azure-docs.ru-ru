...
DevOps Projects позволяет создать конвейер CI/CD в Azure Pipelines. Вы можете создать новую организацию Azure DevOps или использовать существующую. Служба DevOps Projects также создает ресурсы Azure, например виртуальные машины, в выбранной подписке Azure.
