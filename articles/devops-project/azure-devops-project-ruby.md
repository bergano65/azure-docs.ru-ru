...
1. **Веб-приложение в Linux** является целью развертывания по умолчанию.  
    Дополнительно можно выбрать **Веб-приложение для контейнеров**. Исполняющая среда, которую вы выбрали ранее, определяет доступный тип объекта развертывания в службе Azure. 
