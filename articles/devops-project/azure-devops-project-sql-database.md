...
> * фиксировать изменения в Azure Repos и автоматически развертывать их в Azure;
...
1. Выберите **Добавление базы данных** и нажмите кнопку **Далее**.  
    Платформа приложений, выбранная на предыдущем шаге, определяет доступный тип для целевого объекта развертывания в службе Azure. 
