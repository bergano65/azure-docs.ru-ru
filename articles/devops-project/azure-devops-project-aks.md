...
DevOps Projects позволяет создать конвейер CI/CD в Azure Pipelines. Вы можете создать новую организацию Azure DevOps или использовать существующую. Azure DevOps Projects также создает ресурсы Azure, такие как кластер AKS, в нужной подписке Azure.
