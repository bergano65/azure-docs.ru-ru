...
2. На следующих нескольких шагах вы можете с помощью веб-браузера создавать и фиксировать изменения кода непосредственно в **главной** ветви. Репозиторий Git можно клонировать в предпочитаемой интегрированной среде разработки, выбрав **Клонировать** в верхнем правом углу страницы репозитория. 
