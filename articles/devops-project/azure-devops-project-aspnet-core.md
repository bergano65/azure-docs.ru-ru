...
4. Выберите **Изменить** и внесите изменения в заголовок h2. Например, введите **Начало работы с проектом Azure DevOps** или внесите другие изменения.
