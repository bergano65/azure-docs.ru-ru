...
Проект Azure DevOps представляет собой упрощенный интерфейс, который создает ресурсы Azure и устанавливает конвейер непрерывной интеграции (CI) и непрерывной доставки (CD) для вашего приложения PHP в Azure DevOps Services.  
