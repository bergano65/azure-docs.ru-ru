...
1. В браузере откройте панель мониторинга DevOps Starter. Теперь вы должны увидеть, что сборка выполняется. Внесенные изменения автоматически создаются и развертываются с помощью конвейера CI/CD.
...
1. Измените имя конвейера сборки на более описательное, выберите, **сохраните & очередь**, а затем нажмите кнопку **сохранить**.
