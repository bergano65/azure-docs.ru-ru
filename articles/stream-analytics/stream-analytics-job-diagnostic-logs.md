...
2.  Укажите **имя** в поле " **имя параметров диагностики** " и установите флажки для **выполнения** и **разработки** в разделе " **Журнал**" и **аллметрикс** в разделе " **Метрика**". Затем выберите **Отправить, чтобы log Analytics** и выбрать рабочую область. Нажмите **Сохранить**.
