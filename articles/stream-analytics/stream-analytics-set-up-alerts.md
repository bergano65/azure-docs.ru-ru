...
### <a name="get-alerted-when-a-job-stops-unexpectedly"></a>Оповещения при неожиданной остановке задания
...
5. В разделе **Настроить логику сигналов** задайте для параметра **Уровень события** значение **Все**, а для параметра **Состояние** — значение **Сбой**. Оставьте поле **Кем инициировано событие** пустым и выберите **Готово**.
