...
7. В полях **Ресурс** , **Условие** и **Группы действий** должны быть записи. Обратите внимание, что для работы оповещений должны быть соблюдены определенные условия. Например, вы можете каждые 5 минут измерять среднее значение по метрике за последние 15 минут.
   ...
   ![На снимке экрана показано диалоговое окно Создание правила с РЕСУРСом, УСЛОВИЕм и группой действий.](./media/stream-analytics-set-up-alerts/stream-analytics-create-alert-rule-2.png)
   ...
   ![На снимке экрана показано диалоговое окно Создание правила с подробными сведениями о предупреждении.](./media/stream-analytics-set-up-alerts/stream-analytics-create-alert-rule.png)
