...
3. В колонке **Метрика** выберите команду **Добавить оповещение**.
      ...
      ![Настройка оповещений Stream Analytics на портале Azure](./media/stream-analytics-set-up-alerts/06-stream-analytics-set-up-alerts.png)  
