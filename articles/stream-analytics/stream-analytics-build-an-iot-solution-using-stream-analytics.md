...
4. Просмотрите выходные данные примера задания TollApp.
   - **Cosmos DB** выходные данные — это контейнер базы данных Cosmos, который получает события приемника выходных данных. Обратите внимание, что эти выходные данные используются в предложении INTO запроса потоковой передачи.
