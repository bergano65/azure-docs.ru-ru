...
| ИД пункта сбора | Время въезда | LicensePlate | Состояние | Производитель | Моделирование | Тип транспортного средства | Вес транспортного средства | Плата | Тег |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
4. Разверните документы **толлаппдатабасе**  >  **толлаппколлектион**  >  **Documents**.
