...
| ИД пункта сбора | Время въезда | LicensePlate | Состояние | Добавляйте | Модель | Тип транспортного средства | Вес транспортного средства | Плата | Тег |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Добавляйте |Изготовитель транспортного средства |
...
## <a name="scale-out-the-job"></a>Горизонтальное увеличение масштаба задания
