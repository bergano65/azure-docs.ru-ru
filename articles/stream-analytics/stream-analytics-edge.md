...
- Образ: `mcr.microsoft.com/azure-stream-analytics/azureiotedge:1.0.5-linux-amd64`
   - базовый образ: microsoft/dotnet:2.1.6-runtime-alpine3.7
   - платформа:
      - архитектура: amd64
      - ОС: Linux
  
- Образ: `mcr.microsoft.com/azure-stream-analytics/azureiotedge:1.0.5-linux-arm32v7`
   - базовый образ: microsoft/dotnet:2.1.6-runtime-bionic-arm32v7
   - платформа:
      - архитектура: arm
      - ОС: Linux
  
- Образ: `mcr.microsoft.com/azure-stream-analytics/azureiotedge:1.0.5-windows-amd64`
...
Для получения дополнительной помощи воспользуйтесь [страницей вопросов и ответов об Azure Stream Analytics](https://docs.microsoft.com/answers/topics/azure-stream-analytics.html).
