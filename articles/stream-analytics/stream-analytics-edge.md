...
2. На экране создания выберите **Edge** в качестве **среды размещения** (см. следующий рисунок).
   ...
   ![Создание задания](media/stream-analytics-edge/ASAEdge_create.png)
...
4. Задайте путь к файлу. Для устройства с Windows используйте абсолютный путь. Для устройства с Linux используйте путь на томе.

![Новые входные эталонные данные для задания Azure Stream Analytics в IoT Edge](./media/stream-analytics-edge/ReferenceDataNewInput.png)
