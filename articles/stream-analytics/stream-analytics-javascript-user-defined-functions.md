...
* [Определяемая пользователем функция в машинном обучении](https://docs.microsoft.com/azure/stream-analytics/machine-learning-udf)
* [Определяемая пользователем функция C#](https://docs.microsoft.com/azure/stream-analytics/stream-analytics-edge-csharp-udf-methods)
