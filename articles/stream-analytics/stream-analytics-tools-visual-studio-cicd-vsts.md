...
> [!NOTE]
> NuGet CI/CD не рекомендуется к использованию. Сведения о том, как перейти к последней версии npm, см. в статье [Общие сведения о непрерывной интеграции и развертывании](cicd-overview.md)
...
Дополнительная информация о том как использовать инструменты Azure Stream Analytics для Visual Studio для настройки процесса непрерывной интеграции и развертывания см. в статье о настройке конвейера CI/CD:
