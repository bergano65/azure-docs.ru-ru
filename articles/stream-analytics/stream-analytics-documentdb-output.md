...
Размер хранилища для документов, принадлежащих одному ключу секции, ограничен 20 ГБ. Идеальный ключ секции — тот, который часто отображается в качестве фильтра в запросах и имеет достаточное количество элементов, чтобы гарантировать масштабируемость решения.
