...
| Базы данных SQL Azure | Yes | Основано на предложении PARTITION BY в запросе | Соответствует секционированию входных данных для [полностью распараллеливаемых запросов](stream-analytics-scale-jobs.md). | 
