...
| Кодирование | Если вы используете формат CSV или JSON, необходимо указать кодировку. В настоящее время единственным поддерживаемым форматом кодирования является UTF-8.|
...
| Хранилище больших двоичных объектов Azure | См. раздел [ограничения хранилища Azure](../azure-subscription-service-limits.md#storage-limits). | Максимальный размер блока BLOB-объектов составляет 4 МБ.<br />Максимальное число Bock больших двоичных объектов — 50 000. |
