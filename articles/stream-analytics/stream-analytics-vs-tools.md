...
description: Узнайте, как просматривать, запускать и останавливать, тестировать соединения, проверять результаты и экспортировать задания Azure Stream Analytics с помощью Visual Studio.
author: su-jie
ms.author: sujie
