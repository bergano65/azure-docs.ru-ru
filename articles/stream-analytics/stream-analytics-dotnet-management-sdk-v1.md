...
ms.locfileid: "58075208"
---
# <a name="set-up-and-run-analytics-jobs-using-azure-stream-analytics-api-for-net"></a>Настройка и запуск заданий аналитики с помощью API Azure Stream Analytics для .NET
...
1. Добавьте следующий раздел **appSettings** в файл App.config:
...
1. Добавьте следующую ссылку в CSPROJ-файле:
...
1. Добавьте вспомогательный метод проверки подлинности:
