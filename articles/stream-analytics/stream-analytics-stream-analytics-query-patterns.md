...
**DATEDIFF** — это функция для работы с датами, которая сравнивает метки времени и возвращает разницу во времени между двумя полями даты и времени. Дополнительные сведения см. в статье о [функциях для работы с датами](/stream-analytics-query/date-and-time-functions-azure-stream-analytics).
...
Дополнительные сведения см. в инструкциях по [JavaScript](./stream-analytics-javascript-user-defined-functions.md) и [C#](./stream-analytics-edge-csharp-udf.md).
