---
title: Создание задания Azure Stream Analytics с помощью Visual Studio
...
2. Заполните область **Stream Analytics Input Configuration** следующими значениями.
   ...
   |Subscription  |  \<Ваша подписка\>   | Выберите подписку Azure, в которой размещен созданный Центр Интернета вещей.   |
