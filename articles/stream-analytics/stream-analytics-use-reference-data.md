...
> 
> Например, после того, как задание найдет `sample/2015-04-16/17-30/products.csv` большой двоичный объект, он будет игнорировать все файлы с кодированной датой, предшествующими 5:30 апреля, 2015, поэтому `sample/2015-04-16/17-25/products.csv` , если в том же контейнере создается большой двоичный объект с поздним поступлением, задание не будет использовать его.
> 
