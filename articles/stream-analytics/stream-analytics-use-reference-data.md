...
В одном шаге запроса можно объединить только один потоковый вход с одним входным ссылочным данными. Однако можно объединить несколько эталонных наборов данных, разбивая запрос на несколько шагов. Ниже приведен соответствующий пример.
