...
Эталонные данные Базы данных SQL Azure извлекаются заданием Stream Analytics и хранятся в памяти в виде моментального снимка для обработки. Моментальный снимок эталонных данных также хранится в контейнере в учетной записи хранения, указанной в параметрах конфигурации. Контейнер создается автоматически при запуске задания и автоматически удаляется при остановке задания.
