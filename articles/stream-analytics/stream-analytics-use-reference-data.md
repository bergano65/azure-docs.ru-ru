...
|Сервис кодирования   | В настоящее время единственным поддерживаемым форматом кодировки является UTF-8.  |
...
> 
> Например, после того, как задание найдет большой двоичный объект `sample/2015-04-16/17-30/products.csv` он будет игнорировать все файлы с закодированной датой, предшествующими 5:30 апреля, 2015, поэтому, если в том же контейнере создается `sample/2015-04-16/17-25/products.csv` большой двоичный объект, задание не будет использовать его.
> 
