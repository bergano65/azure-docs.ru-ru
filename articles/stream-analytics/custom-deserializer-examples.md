...
Все входные данные Stream Analytics имеют **формат сериализации**. Дополнительные сведения о параметрах ввода см. в документации по [REST API ввода](/rest/api/streamanalytics/2016-03-01/inputs).
