---
title: Краткое руководство. Создание облачного задания Azure Stream Analytics в Visual Studio Code
...
2. Добавьте следующий запрос:
   ...
   ```
## <a name="test-with-sample-data"></a>Тестирование с демонстрационными данными
Перед выполнением в облаке запрос можно протестировать с помощью локальных демонстрационных данных, чтобы проверить его логику.

Чтобы получить дополнительные сведения, следуйте инструкциям в статье [Test Stream Analytics queries locally with Visual Studio Code](vscode-local-run.md) (Локальное тестирование запросов Stream Analytics с помощью Visual Studio Code). 

 ![Тестирование с помощью демонстрационных данных в VS Code](./media/quick-create-vs-code/vscode-localrun.gif)
...
4. Введите **IotHub** как имя входного файла.
...
5. Измените файл **BlobStorage**, указав значения из приведенной ниже таблицы. Сохраните значения по умолчанию для всех полей, которые не упомянуты ниже. CodeLens поможет вводить строки и выбирать значения из раскрывающегося списка. 
...
![Список заданий в обозревателе Stream Analytics](./media/quick-create-vs-code/list-job.png)
