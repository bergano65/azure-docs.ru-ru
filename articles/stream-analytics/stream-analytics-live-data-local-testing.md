...
|**Входные данные**  |**Вывод**  |**Тип задания**  |
|---------|---------|---------|
...
* [Создайте задание Stream Analytics, используя инструменты Azure Stream Analytics для Visual Studio](stream-analytics-quick-create-vs.md)
