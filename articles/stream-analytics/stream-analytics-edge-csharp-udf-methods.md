---
title: Разработка .NET Standardных функций для Azure Stream Analyticsных заданий пограничных устройств
description: Узнайте, как разрабатывать определяемые пользователем функции .NET для Azure Stream Analyticsных заданий с помощью кода поддержки, существующего пакета или локального проекта.
