...
* Создание INSTEAD OF [триггера](https://docs.microsoft.com/en-us/sql/t-sql/statements/create-trigger-transact-sql) использование простой инструкции insert для каждой строки.
