...
ms.locfileid: "78392548"
---
# <a name="tutorial-analyze-phone-call-data-with-stream-analytics-and-visualize-results-in-power-bi-dashboard"></a>Учебник. анализ данных телефонных вызовов с помощью Stream Analytics и визуализация результатов на панели мониторинга Power BI
