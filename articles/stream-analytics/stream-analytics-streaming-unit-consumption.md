...
Чтобы устранить проблемы, вызванные большим количеством элементов в предыдущем запросе, можно отправить события в концентратор событий, секционированный по `clusterid`, и выполнить масштабирование запроса, разрешив системе обрабатывать каждую входную секцию отдельно, используя **секционирование,** как показано в следующем примере:
