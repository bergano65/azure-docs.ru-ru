...
## <a name="scenario-alerting-based-on-adjustable-rule-thresholds"></a>Сценарий: Оповещения на основе настраиваемого правила пороговых значений
...
## <a name="reference-data"></a>Справочные данные
