...
## <a name="examples"></a>Примеры
Используйте точечную нотацию (.) для доступа к вложенным полям. Например этот запрос выбирает координаты широты и долготы в свойстве расположение в предыдущем данные JSON:
...
[Типы данных в Azure Stream Analytics](https://docs.microsoft.com/en-us/stream-analytics-query/data-types-azure-stream-analytics)
