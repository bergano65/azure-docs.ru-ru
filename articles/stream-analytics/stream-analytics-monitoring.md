...
| Входные события           | Число записей, десериализованных из входных событий. |
| Полученные входные источники       | Число событий, получаемых заданием. Эти данные можно использовать, чтобы проверить, отправляются ли события в источник входных данных. |
