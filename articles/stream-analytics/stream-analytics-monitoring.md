...
| Ошибки времени выполнения         | Общее количество ошибок, связанных с обработкой запросов (за исключением ошибки, обнаруженные во время приема событий или выводе результатов) |
| Использование SU (%)       | Использование единиц потоковой передачи, назначенных заданию на вкладке «Масштаб» соответствующего задания. Как только этот индикатор достигнет 80 % и более существует высокая вероятность приостановки или отсрочки обработки события. |
