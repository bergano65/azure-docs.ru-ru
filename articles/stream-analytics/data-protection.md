...
## <a name="in-region-data-residency"></a>Местонахождение данных в регионе
...
В настоящее время существует известное ограничение, при котором при использовании управляемого удостоверения для проверки подлинности во всех входных и выходных данных задание, использующее управляемый пользователем ключ, выполняет сбои.
