...
Существует известная проблема, при которой при использовании управляемого удостоверения для проверки подлинности во всех входных и выходных данных задание, использующее управляемый пользователем ключ, выполняет сбои. Исправление для этой проблемы обработано и станет доступным в ближайшем будущем. 
