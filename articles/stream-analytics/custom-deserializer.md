...
* [Установите инструменты Stream Analytics для Visual Studio](stream-analytics-tools-for-visual-studio-install.md) или обновите до последней версии. 
