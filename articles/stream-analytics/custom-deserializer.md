...
ms.locfileid: "75443694"
---
# <a name="tutorial-custom-net-deserializers-for-azure-stream-analytics"></a>Руководство. Пользовательские десериализаторы .NET для Azure Stream Analytics
