...
> [!NOTE]
> Время ожидания для запросов HTTP от Stream Analytics к Функциям Azure устанавливается на 100 секунд. Если обработка пакета приложением Функции Azure занимает более 100 секунд, Stream Analytics выдает сообщение об ошибке.
