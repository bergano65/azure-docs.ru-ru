...
Ключ раздела, или имя столбца, используемое для разделения входных данных, может содержать буквенно-цифровые символы, дефисы, знаки подчеркивания и пробелы. Использование вложенных полей в качестве ключа раздела не поддерживается, если не используется в сочетании с псевдонимами.
