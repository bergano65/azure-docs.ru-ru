...
ms.locfileid: "58116187"
---
# <a name="tutorial-stream-analytics-and-power-bi-a-real-time-analytics-dashboard-for-streaming-data"></a>Руководство по Stream Analytics и Power BI: панель мониторинга аналитики для потоковой передачи данных в режиме реального времени
...
4. В поле **Приемник** выберите **Power BI**.
   ...
   ![Создание выхода для Power BI](./media/stream-analytics-power-bi-dashboard/create-power-bi-ouptut.png)

5. Щелкните **Авторизовать**.

    Откроется окно, где можно ввести учетные данные Azure (рабочей или учебной учетной записи). 

    ![Ввод учетных данных для доступа к Power BI](./media/stream-analytics-power-bi-dashboard/power-bi-authorization-credentials.png)
...
7. Вернувшись в колонку **Новые выходные данные**, введите следующие сведения:
   ...
   * **Имя набора данных**.  Укажите `sa-dataset`. Вы можете использовать другое имя. Если вы используете другое имя, запишите его.
   * **Имя таблицы.** Укажите `fraudulent-calls`. Сейчас для вывода выходных данных из заданий Stream Analytics в Power BI можно использовать только одну таблицу в наборе данных.

     ![Набор данных рабочей области Power BI и таблица](./media/stream-analytics-power-bi-dashboard/create-pbi-ouptut-with-dataset-table.png)
...
* **defaultRetentionPolicy: BasicFIFO**: данные обслуживаются в порядке ФИФО, максимум 200 000 строк.
