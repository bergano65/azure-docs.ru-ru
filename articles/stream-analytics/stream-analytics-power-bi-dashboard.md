...
* Учетная запись для Power BI Pro. Вы можете использовать рабочую или учебную учетную запись.
...
2. В меню слева выберите **выходные данные** в разделе **топология задания**. Затем выберите **+ Добавить** и в раскрывающемся меню выберите **Power BI** .
...
3. Выберите **+ Добавить** > **Power BI**. Затем заполните форму следующими сведениями и нажмите кнопку **Авторизовать**:
   ...
   |Имя набора данных  |   SA — набор данных  |
...
* **defaultRetentionPolicy: BasicFIFO** — Data — FIFO, не более 200 000 строк.
...
2. На странице **запрос** для задания Stream Analytics щелкните точки рядом с `CallStream` входными данными, а затем выберите **образец данных из раскладки**.

3. Укажите, что необходим трехминутный образец данных, и щелкните **ОК**. Дождитесь уведомления о выборке данных.

4. Нажмите кнопку **проверить** и проверьте результаты.

## <a name="run-the-job"></a>Запуск задания

1. Убедитесь, что приложение TelcoStreaming работает.

2. Перейдите на страницу **обзора** для задания Stream Analytics и нажмите кнопку **запустить**.
