...
> [!IMPORTANT] 
> Создание приложения Twitter больше не доступен через [apps.twitter.com](https://apps.twitter.com/). Это руководство представляет собой работаем над обновлением для включения нового API Twitter.
