---
title: Создание пользовательских функций на C# для заданий Azure Stream Analytics с помощью Visual Studio (предварительная версия)
description: Сведения о написании пользовательских функций на C# для заданий Stream Analytics с помощью Visual Studio.
