...
### <a name="add-local-input"></a>Добавить локальный ввод
...
![Добавить локальный ввод](./media/stream-analytics-vs-tools-local-run/stream-analytics-tools-for-vs-add-local-input-01.png)
   
Во всплывающем окне выберите демонстрационные данные из локальной папки и нажмите кнопку **Сохранить**
   
![Добавить локальный ввод](./media/stream-analytics-vs-tools-local-run/stream-analytics-tools-for-vs-add-local-input-02.png)
...
![Запустить локально](./media/stream-analytics-vs-tools-local-run/stream-analytics-tools-for-vs-local-run-01.png)
...
![Образцы данных](./media/stream-analytics-vs-tools-local-run/stream-analytics-tools-for-vs-sample-data-01.png)
...
* [Учебник. Развертывание задания Azure Stream Analytics с помощью CI/CD с использованием Azure DevOps](stream-analytics-tools-visual-studio-cicd-vsts.md)
