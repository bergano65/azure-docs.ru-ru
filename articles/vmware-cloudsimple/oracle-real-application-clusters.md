...
6. В разделе **vSAN** > **доступность** vSAN выберите **нет** для обеспечения отказоустойчивости сайта. Чтобы ошибки не допускать, выберите параметр **RAID-зеркальное отображение** для нужных ФТТ.
