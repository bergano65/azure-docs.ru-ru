...
2. Создайте пользователя в частном облаке для репликации vSphere и установки СРМ. Описание ниже в [пользовательском интерфейсе vCenter: создание пользователя в частном облаке для вра &AMP; СРМ установки](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation).
