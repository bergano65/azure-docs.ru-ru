...
Настройте набор преобразований (TS), который должен содержать ключевое ```ikev1```слово. Атрибуты шифрования и хеширования, указанные в службах терминалов, должны соответствовать параметрам, перечисленным в [конфигурации по умолчанию для VPN-шлюзов клаудсимпле](cloudsimple-vpn-gateways.md).
...
* "Включено". Не устанавливайте флажок.
