...
2. Выберите **Сетевые подключения** > **Переключение** > **коммутаторы** > * * < \логикал Switch @ no__t-5 * * **Обзор**>.
...
4. Войдите в НСКС Manager и выберите **сеть** > **Маршрутизация** > **маршрутизаторы** > **provider-LR** > **Маршрутизация** > **соседей** **BGP**1. Выберите первый сосед. Щелкните **изменить** **семейства адресов** > . В семействе IPv4 измените столбец **исходящий фильтр** и выберите созданный список IP-префиксов. В нижней части страницы нажмите кнопку **Save**. Повторите этот шаг для второго соседа.
    ...
    ![Attach IP prefix List 1 @ no__t-1 @no__t — 2Attach IP prefix List 2 @ no__t-3

5. Повторно распространите статический маршрут NULL в BGP. Чтобы объявить маршрут интерфейса замыкания на ундерлай, необходимо повторно распространить статический маршрут NULL в BGP. Войдите в НСКС Manager и выберите **Сетевые подключения** > **Маршрутизация** > **маршрутизаторы** > **provider-LR** > **Маршрутизация** >  с**перераспределением маршрутов**@no__t **-11.** Выберите **поставщик-LR-Route_Redistribution** и нажмите кнопку **изменить**. Установите флажок **статический** и нажмите кнопку **сохранить**.
...
2. Перейдите в папку со всеми извлеченными файлами. Выберите все VMDK (НСКС-L2T-Client-Large. MF и NSX-l2t-client-large. ovf для большого размера устройства или НСКС-L2T-Client-Ксларже. MF и NSX-l2t-client-Xlarge. ovf для очень большого размера устройства). Щелкните **Далее**.
    ...
    шаблон ![Select @ no__t-1 ![Select Template @ no__t-3
...
6. Введите следующие сведения на экране **Настройка шаблона** и нажмите кнопку **Далее**.
    ...
    * **Администратор CLI, включение и ввод пароля пользователя root**. Задайте пароль для учетной записи администратора/Enable/root.
      ...
      шаблон ![Customize @ no__t-1 @ no__t-2Customize-more @ no__t-3
