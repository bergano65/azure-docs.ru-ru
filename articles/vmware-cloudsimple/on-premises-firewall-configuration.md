...
| Port       | Источник                           | Место назначения                      | Цель                                                                                                                |
|------------|----------------------------------|----------------------------------|------------------------------------------------------------------------------------------------------------------------|
| 53 (UDP)   | Локальные DNS-серверы          | DNS-серверы частного облака AVS        | Требуется для перенаправления поиска DNS *AZ. AVS.io* на DNS-серверы частного облака AVS из локальной сети.     |
| 53 (UDP)   | DNS-серверы частного облака AVS        | Локальные DNS-серверы          | Требуется для перенаправления DNS-имен локальных доменов из версии AVS частного облака vCenter на локальные DNS-серверы. |
...
| Port         | Источник                           | Место назначения                                         | Цель                                                                                                                                          |
|--------------|----------------------------------|-----------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
| 53 (UDP)      | DNS-серверы частного облака AVS        | Локальные DNS-серверы                             | Требуется для перенаправления DNS-имен локальных доменов Active Directory из версии AVS частного облака vCenter на локальные DNS-серверы.        |
