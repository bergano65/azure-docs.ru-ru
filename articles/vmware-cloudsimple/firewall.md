---
title: Решения Azure VMware (AVS) — Настройка таблиц и правил брандмауэра
description: Описывает, как настроить таблицы и правила брандмауэра для частного облака AVS, чтобы ограничить трафик в подсетях и виртуальных ЛС.
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/15/2019
ms.topic: article
...
ms.locfileid: "77025288"
---
# <a name="set-up-firewall-tables-and-rules-for-avs-private-clouds"></a>Настройка таблиц и правил брандмауэра для частных облаков AVS
...
2. Настройте правило следующим образом.
    ...
    * **Тип трафика**. Выберите правило для частного облака AVS, Интернета или VPN-трафика (без отслеживания состояния) или для общедоступного IP-адреса (с отслеживанием состояния).
...
4. Выберите частное облако AVS и виртуальную ЛС. Отобразятся связанные имя подсети и блок CIDR.
