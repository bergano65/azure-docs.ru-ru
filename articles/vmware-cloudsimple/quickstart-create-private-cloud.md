...
2. Выберите предпочтительный клиент vSphere для доступа к vCenter и выполните вход с помощью имени пользователя и пароля.  По умолчанию используются следующие значения:
