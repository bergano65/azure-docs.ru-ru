...
| Начало | Запустите указанную виртуальную машину.  |
...
| Сбор | Запишите образ указанной виртуальной машины, чтобы его можно было использовать в качестве образа для создания других виртуальных машин. См. статью [Создание управляемого образа универсальной виртуальной машины в Azure](../virtual-machines/windows/classic/capture-image.md).   |
| Переместить | Перейдите на указанную виртуальную машину.  |
| Удалить | Удалите указанную виртуальную машину.  |
| Обновление | Обновите данные на экране.  |
