---
title: Решения Azure VMware (AVS) — Управление виртуальными машинами частного облака AVS в Azure
description: Описывает, как управлять виртуальными машинами частного облака AVS в портал Azure, включая добавление дисков, изменение емкости виртуальной машины и Добавление сетевых интерфейсов.
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/16/2019
ms.topic: article
...
---
# <a name="manage-your-avs-private-cloud-virtual-machines-in-azure"></a>Управление виртуальными машинами в частном облаке AVS в Azure

Чтобы управлять виртуальными машинами, [созданными для частного облака AVS](azure-create-vm.md), войдите в [портал Azure](https://portal.azure.com). Найдите и выберите виртуальную машину (выполните поиск во **всех службах** или **виртуальных машинах** в боковом меню).
...
| Control | Description |
| ------------ | ------------- |
| Подключиться | Подключитесь к указанной виртуальной машине.  |
...
| Запись | Запишите образ указанной виртуальной машины, чтобы его можно было использовать в качестве образа для создания других виртуальных машин. См. статью [Создание управляемого образа универсальной виртуальной машины в Azure](../virtual-machines/windows/classic/capture-image.md).   |
...
Чтобы добавить интерфейс, нажмите кнопку **Добавить сетевой интерфейс**. Настройте каждый из следующих параметров, введя или выбрав встроенный параметр. Выберите команду **Сохранить**.
   ...
   | Сеть | Выберите из списка настроенные сети в vSphere частном облаке AVS.  |
