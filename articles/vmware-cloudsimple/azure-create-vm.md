...
4. Введите Основные сведения нажмите кнопку **Далее: размер**.
    ...
    | Поле | Description |
    | ------------ | ------------- |
    | Subscription | Подписка Azure, связанная с частным облаком.  |
    ...
    | Location | Регион Azure, в котором размещена эта виртуальная машина.  |
...
6. Настройте сетевые интерфейсы и диски, как описано в следующих таблицах, и щелкните **проверить и создать**.
    ...
    | SCSI-контроллер | Выберите контроллер SCSI для диска.  |
