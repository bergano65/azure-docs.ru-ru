...
description: Узнайте о Клаудсимпле VPN-шлюзах типа "сеть — сеть" и "точка — сеть", которые используются для отправки зашифрованного трафика между Клаудсимпле регионами и другими ресурсами.
author: sharaths-cs
ms.author: dikamath
ms.date: 08/20/2019
ms.topic: article
...
| Шифрование | AES 128 | AES 256 | AES 256 |
| Хэш-алгоритм| SHA 256 | SHA 256 | SHA 1 |
| Безопасная группа безопасной пересылки (Группа PFS) | None | None | None |
| Время существования | 1 800 секунд | 1 800 секунд | 1 800 секунд |
| Размер данных | 4 Гб | 4 Гб | 4 Гб |
