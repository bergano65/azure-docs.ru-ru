...
* Запись : Записывает голос вызываемого абонента и возвращает URL файла, содержащего запись. ** &lt;&gt;**
...
* Скачать библиотеку Twilio для Python[https://github.com/twilio/twilio-python][twilio_python]от GitHub ( ) и установить его так:
