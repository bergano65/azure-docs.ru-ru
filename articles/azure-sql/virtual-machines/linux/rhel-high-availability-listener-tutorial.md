...
> [Настройка подсистемы балансировки нагрузки для группы доступности на виртуальных машинах Azure SQL Server](../windows/availability-group-load-balancer-portal-configure.md).
