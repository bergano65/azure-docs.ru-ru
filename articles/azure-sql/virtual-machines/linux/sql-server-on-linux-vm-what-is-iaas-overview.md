...
> [!NOTE]
> Сведения о доступных образах виртуальных машин SQL Server на базе Windows см. в статье [Приступая к работе с SQL Server в виртуальных машинах Azure](../windows/sql-server-on-azure-vm-iaas-what-is-overview.md).
...
|---|---|---|---|---|---|---|
| RHEL | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![нет](./media/sql-server-on-linux-vm-what-is-iaas-overview/no.png) |
| SLES | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![да](./media/sql-server-on-linux-vm-what-is-iaas-overview/yes.png) | ![нет](./media/sql-server-on-linux-vm-what-is-iaas-overview/no.png) | ![нет](./media/sql-server-on-linux-vm-what-is-iaas-overview/no.png) |
...
* [Обзор виртуальных машин](../../../virtual-machines/linux/overview.md).
...
* [Часто задаваемые вопросы об SQL Server на виртуальных машинах Azure с Linux](frequently-asked-questions-faq.md)
