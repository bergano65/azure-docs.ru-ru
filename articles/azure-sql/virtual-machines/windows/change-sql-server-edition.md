...
description: Узнайте, как изменить выпуск виртуальной машины SQL Server в Azure на более раннюю версию, чтобы снизить затраты или обновить, чтобы включить дополнительные функции.
...
- [SQL Server виртуальную машину в Windows](./create-sql-vm-portal.md) , зарегистрированную с [расширением агента IaaS SQL](sql-agent-extension-manually-register-single-vm.md).
...
После изменения выпуска SQL Server с помощью установочного носителя и регистрации виртуальной машины SQL Server с [расширением агента IaaS SQL](sql-agent-extension-manually-register-single-vm.md)можно использовать портал Azure, чтобы изменить свойство Edition SQL Server виртуальной машины для выставления счетов. Для этого выполните следующие действия. 
...
- Возможность изменения выпуска является компонентом расширения агента IaaS SQL. Развертывание образа Azure Marketplace с помощью портал Azure автоматически регистрирует SQL Server виртуальную машину с расширением агента IaaS SQL. Тем не менее клиентам, которые самостоятельно устанавливают SQL Server, нужно будет вручную [зарегистрировать виртуальные машины SQL Server](sql-agent-extension-manually-register-single-vm.md).
