...
Вам понадобится учетная запись Azure. Вы можете [создать бесплатную учетную запись Azure](https://signup.azure.com/signup?offer=ms-azr-0044p&appId=102&ref=azureplat-generic) или [активировать преимущества для подписчиков Visual Studio](https://docs.microsoft.com/visualstudio/subscriptions/subscriber-benefits).
...
4. В **центре управления сетями и общим доступом**выберите сетевой интерфейс.
   ...
   ![сетевому интерфейсу](./media/availability-group-manually-configure-prerequisites-tutorial-/26-networkinterface.png)
...
22. Нажмите кнопку **Далее** , пока диалоговое окно не достигнет проверки **готовности** к установке. Затем нажмите кнопку **установить**.
