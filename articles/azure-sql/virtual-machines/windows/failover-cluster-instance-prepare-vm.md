...
Если вы используете [подсистему балансировки нагрузки](hadr-vnn-azure-load-balancer-configure.md), необходимо также открыть порт, используемый зондом работоспособности. По умолчанию это порт 59999. Но это может быть любой TCP-порт, указанный при создании балансировщика нагрузки. 
