...
ms.locfileid: "84030035"
---
# <a name="configure-an-availability-group-on-azure-sql-server-virtual-machines-in-different-regions"></a>Настройка групп доступности на виртуальных машинах Azure SQL Server в разных регионах
...
1. Добавьте ресурс IP-адреса в кластер.
   ...
   В диалоговом окне **Свойства** нажмите кнопку **Добавить** внизу поля **IP-адрес**, а затем добавьте IP-адрес имени кластера из удаленного региона сети. Нажмите **ОК** в диалоговом окне **IP-адрес**, а затем снова нажмите **ОК** в диалоговом окне **Свойства кластера**, чтобы сохранить новый IP-адрес. 
...
1. Добавьте ресурс IP-адреса в роль группы доступности в кластере. 
   ...
   Щелкните правой кнопкой мыши роль группы доступности в диспетчере отказоустойчивости кластеров выберите **Добавить ресурс**, **Дополнительные ресурсы** и укажите **IP-адрес**.
