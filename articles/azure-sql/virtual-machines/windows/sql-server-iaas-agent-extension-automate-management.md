...
Версию этой статьи для классической модели развертывания см. в статье о [расширении агента IaaS для SQL Server виртуальных машин SQL Server (классическая)](/previous-versions/azure/virtual-machines/windows/sqlclassic/virtual-machines-windows-classic-sql-server-agent-extension).
