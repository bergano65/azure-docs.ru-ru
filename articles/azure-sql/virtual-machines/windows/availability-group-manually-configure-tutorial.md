...
1. Настройте следующие параметры для балансировщика нагрузки:
   ...
   | Параметр | Поле |
   | --- | --- |
   | **Name** |Используйте для подсистемы балансировки нагрузки текстовое имя, например **sqlLB**. |
   | **Тип** |Внутренние |
...
1. В поле **Порт** укажите номер порта для прослушивателя группы доступности. значение по умолчанию — 1433. Нажмите кнопку **ОК**.
