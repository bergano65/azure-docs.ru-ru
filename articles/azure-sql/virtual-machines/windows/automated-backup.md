...
> [!IMPORTANT]
> Автоматическое резервное копирование (версия 2) работает с SQL Server 2016 или более поздних версий. Если используется SQL Server 2014, то для архивации баз данных можно применять автоматическую архивацию версии 1. Дополнительные сведения см. в статье [Автоматическое резервное копирование для виртуальных машин SQL Server 2014 (Resource Manager)](automated-backup-sql-2014.md).
...
- Для системных баз данных нет необходимости использовать модель полного восстановления. Тем не менее, если требуется создавать резервные копии журналов для шаблона базы данных или MSDB, то необходимо использовать модель полного восстановления.
- Целевые базы данных должны находиться на экземпляре SQL Server по умолчанию или на [правильно установленном](frequently-asked-questions-faq.md#administration) именованном экземпляре. 
