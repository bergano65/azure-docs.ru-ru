...
5. В диалоговом окне **Создание подсистемы балансировки нагрузки** настройте подсистему балансировки нагрузки, задав следующие параметры:
   ...
   | **Номер SKU** |**Стандартный**: требуется, если экземпляры SQL находятся в другой группе доступности, отличной от подсистемы балансировки нагрузки. </br> **Базовый**: параметр по умолчанию. |
