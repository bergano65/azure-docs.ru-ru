...
1. Выберите **Да** , чтобы **включить совместимость с Ultra Disk**. 
   ...
   :::image type="content" source="../../../virtual-machines/media/virtual-machines-disks-getting-started-ultra-ssd/ultra-options-yes-enable.png" alt-text="Снимок экрана, на котором показан параметр &quot;Да&quot;.":::
