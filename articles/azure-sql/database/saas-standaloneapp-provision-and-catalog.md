---
title: Руководство по созданию SaaS с несколькими клиентами
...
В этой задаче вы узнаете, как создать каталог, используемый для регистрации всех баз данных клиента. Вы узнаете:
...
1. В интегрированной среде сценариев PowerShell откройте *. ..\Learning модулес\усерконфиг.ПСМ* и измените **\<user\>** значение на значение, которое использовалось при развертывании трех примеров приложений.  **Сохраните файл**.
...
1. Войдите на [портал Azure](https://portal.azure.com/) и перейдите к группам ресурсов.  Откройте группу ресурсов **Wingtip-SA-Catalog \<user\> -** Resource и запишите сервер каталога и базу данных.
1. Откройте базу данных на портале и выберите *обозреватель данных* в левом меню.  Щелкните команду Login, а затем введите password = **P \@ ssword1**.
...
В этой задаче вы узнаете, как подготовить однотенантное приложение. Вы узнаете:
