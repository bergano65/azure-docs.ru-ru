...
| 40501 |20 |Служба занята. Повторите запрос через 10 секунд. Идентификатор инцидента: %ls. Код: %d. Дополнительные сведения можно найти в разделе <br/>&bull;&nbsp; [Ограничения на логические ресурсы SQL Server](resource-limits-logical-server.md)<br/>&bull;&nbsp; [Ограничения на основе DTU для отдельных баз данных](service-tiers-dtu.md)<br/>&bull;&nbsp; [Ограничения на основе DTU для эластичных пулов](resource-limits-dtu-elastic-pools.md)<br/>&bull;&nbsp; [ограничения на основе виртуальное ядро для отдельных баз данных](resource-limits-vcore-single-databases.md)<br/>&bull;&nbsp; [ограничения для эластичных пулов на основе виртуальное ядро](resource-limits-vcore-elastic-pools.md)<br/>&bull;&nbsp; [Ограничения ресурсов управляемый экземпляр Azure SQL](../managed-instance/resource-limits.md).|
...
| 49918 |16 |Не удается обработать запрос. Недостаточно ресурсов для обработки запроса.<br/><br/>Служба занята. Повторите запрос позже. Дополнительные сведения можно найти в разделе <br/>&bull;&nbsp; [Ограничения на логические ресурсы SQL Server](resource-limits-logical-server.md)<br/>&bull;&nbsp; [Ограничения на основе DTU для отдельных баз данных](service-tiers-dtu.md)<br/>&bull;&nbsp; [Ограничения на основе DTU для эластичных пулов](resource-limits-dtu-elastic-pools.md)<br/>&bull;&nbsp; [ограничения на основе виртуальное ядро для отдельных баз данных](resource-limits-vcore-single-databases.md)<br/>&bull;&nbsp; [ограничения для эластичных пулов на основе виртуальное ядро](resource-limits-vcore-elastic-pools.md)<br/>&bull;&nbsp; [Ограничения ресурсов управляемый экземпляр Azure SQL](../managed-instance/resource-limits.md). |
| 49919 |16 |Невозможно обработать запрос на создание или обновление. Для подписки "%ld" выполняется слишком много операций создания или обновления.<br/><br/>Служба занята обработкой нескольких запросов на создание или обновление для вашей подписки или сервера. В данный момент запросы блокируются для оптимизации ресурсов. Выполните запрос [sys.dm_operation_status](/sql/relational-databases/system-dynamic-management-views/sys-dm-operation-status-azure-sql-database) для ожидающих операций. Подождите, пока выполнятся ожидающие запросы на создание или обновление, либо удалите один из ожидающих запросов и повторите свой запрос позже. Дополнительные сведения можно найти в разделе <br/>&bull;&nbsp; [Ограничения на логические ресурсы SQL Server](resource-limits-logical-server.md)<br/>&bull;&nbsp; [Ограничения на основе DTU для отдельных баз данных](service-tiers-dtu.md)<br/>&bull;&nbsp; [Ограничения на основе DTU для эластичных пулов](resource-limits-dtu-elastic-pools.md)<br/>&bull;&nbsp; [ограничения на основе виртуальное ядро для отдельных баз данных](resource-limits-vcore-single-databases.md)<br/>&bull;&nbsp; [ограничения для эластичных пулов на основе виртуальное ядро](resource-limits-vcore-elastic-pools.md)<br/>&bull;&nbsp; [Ограничения ресурсов управляемый экземпляр Azure SQL](../managed-instance/resource-limits.md). |
...
8. Щелкните правой кнопкой мыши элемент **Пользователи** и выберите пункт **Новый пользователь** .
...
Дополнительные сведения о динамических административных представлениях см. в разделе [системные динамические административные представления](/sql/relational-databases/system-dynamic-management-views/system-dynamic-management-views).
...
| 10929 |20 |Идентификатор ресурса: %d. Минимальная гарантия %s составляет %d, максимальное значение равно %d, а текущее использование для базы данных — %d. Тем не менее, в настоящее время сервер слишком занят, чтобы обработать более чем %d запросов для этой базы данных. Идентификатор ресурса указывает на ресурс, предел которого был достигнут. Для рабочих потоков идентификатор ресурса = 1. Для сеансов идентификатор ресурса — 2. Дополнительные сведения можно найти в разделе <br/>&bull;&nbsp; [Ограничения на логические ресурсы SQL Server](resource-limits-logical-server.md)<br/>&bull;&nbsp; [Ограничения на основе DTU для отдельных баз данных](service-tiers-dtu.md)<br/>&bull;&nbsp; [Ограничения на основе DTU для эластичных пулов](resource-limits-dtu-elastic-pools.md)<br/>&bull;&nbsp; [ограничения на основе виртуальное ядро для отдельных баз данных](resource-limits-vcore-single-databases.md)<br/>&bull;&nbsp; [ограничения для эластичных пулов на основе виртуальное ядро](resource-limits-vcore-elastic-pools.md)<br/>&bull;&nbsp; [Ограничения ресурсов управляемый экземпляр Azure SQL](../managed-instance/resource-limits.md). <br/>В противном случае повторите попытку позже. |
...
- [Архитектура подключения к базе данных SQL Azure](./connectivity-architecture.md)
