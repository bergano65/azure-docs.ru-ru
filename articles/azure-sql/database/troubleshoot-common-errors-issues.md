...
- Проверьте наличие долго выполняющихся запросов.
  ...
  > [!NOTE]
  > Это минимальный подход, который может не решить проблему. Подробные сведения об устранении неполадок блокировки запросов см. в статье [сведения о проблемах с БЛОКИРОВКОЙ SQL Azure](understand-resolve-blocking.md).
