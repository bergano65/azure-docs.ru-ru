...
В этой статье описаны основы защиты уровня данных приложения с помощью [базы данных SQL Azure](sql-database-paas-overview.md) и [управляемый экземпляр Azure SQL](../managed-instance/sql-managed-instance-paas-overview.md). Эта стратегия безопасности использует многоуровневый подход (эшелонированная защита), который представлен на следующем рисунке (уровни рассматриваются, начиная с наружного):

![layer.png безопасности SQL](./media/security-overview/sql-security-layer.png)

## <a name="network-security"></a>Безопасность сети

База данных SQL Microsoft Azure и SQL Управляемый экземпляр предоставляют службу реляционных баз данных для облачных и корпоративных приложений. Для защиты данных клиентов брандмауэры предотвращают сетевой доступ к серверу, пока доступ не будет явно предоставлен на основе IP-адреса или источника трафика виртуальной сети Azure.
...
![rls.png базы данных Azure](./media/security-overview/azure-database-rls.png)
...
![td.jpg базы данных Azure](./media/security-overview/azure-database-td.jpg)
...
База данных SQL и SQL Управляемый экземпляр безопасность данных клиента путем шифрования данных в движении с помощью [протокола TLS](https://support.microsoft.com/help/3135244/tls-1-2-support-for-microsoft-sql-server).

База данных SQL и SQL Управляемый экземпляр принудительно применяют шифрование (SSL/TLS) для всех подключений. Это гарантирует, что все данные шифруются "при передаче" между клиентом и сервером независимо от значения параметра **Encrypt** или **TrustServerCertificate** в строке подключения.
...
![ae.png базы данных Azure](./media/security-overview/azure-database-ae.png)
...
![ddm.png базы данных Azure](./media/security-overview/azure-database-ddm.png)
