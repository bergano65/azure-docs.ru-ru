...
![Схема, показывающая, что безопасность на уровне строк изолирует отдельные строки базы данных SQL от доступа пользователей через клиентское приложение.](./media/security-overview/azure-database-rls.png)
