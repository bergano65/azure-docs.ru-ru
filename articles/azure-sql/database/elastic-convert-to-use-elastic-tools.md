...
Получите скрипты PowerShell из [базы данных SQL Azure — скрипты инструментов эластичной базы данных](https://gallery.technet.microsoft.com/scriptcenter/Azure-SQL-DB-Elastic-731883db).
