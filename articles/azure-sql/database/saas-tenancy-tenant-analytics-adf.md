...
Azure Synapse используется в качестве хранилища аналитики для выполнения агрегирования данных арендаторов. В этом примере PolyBase используется для загрузки данных в хранилище данных. Необработанные данные загружаются в промежуточные таблицы, в которых есть столбец идентификаторов, используемый для отслеживания строк, преобразованных в таблицы схемы типа "звезда". На следующем рисунке показан шаблон загрузки: ![Схема с шаблоном загрузки для таблиц базы данных.](./media/saas-tenancy-tenant-analytics-adf/loadingpattern.JPG)
