...
1. **Извлечение данных** из каждой базы данных клиентов в хранилище аналитики, например в пул SQL.
...
Есть также три параметризованные связанные службы, которые связывают фабрику данных с исходными базами данных SQL, целевым пулом SQL и промежуточным хранилищем BLOB-объектов. На вкладке **Author** (Создание) щелкните **Подключения** , чтобы изучить связанные службы, как показано на следующем рисунке:
