...
![Обученная модель с дополнительными выходными данными](./media/r-train-score-model-create-quickstart/r-train-model-with-additional-output.png)
...
2. Спрогнозируйте тормозной путь на основе этих новых значений.
   ...
   **Результаты**
   ...
   ![Результирующий набор для прогнозирования расстояния торможения](./media/r-train-score-model-create-quickstart/r-predict-stopping-distance-resultset.png)
