...
База данных SQL Azure предоставляет несколько методов создания транзакционно согласованной копии существующей [базы данных](single-database-overview.md) на том же или на другом сервере. Базу данных можно скопировать с помощью портал Azure, PowerShell или T-SQL.
...
> [!NOTE]
> [Автоматические резервные копии базы данных](automated-backups-overview.md) используются при создании копии базы данных.
