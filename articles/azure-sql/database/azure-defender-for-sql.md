...
## <a name="1-enable-azure-defender"></a>1. Включение защитника Azure
...
## <a name="2-start-tracking-vulnerabilities-and-investigating-threat-alerts"></a>2. Запуск отслеживания уязвимостей и изучения оповещений об угрозах
...
## <a name="3-manage-azure-defender-settings"></a>3. Управление параметрами защитника Azure
...
## <a name="4-manage-azure-defender-settings-for-a-database"></a>4. Управление параметрами защитника Azure для базы данных
