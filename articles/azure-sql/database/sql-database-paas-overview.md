...
База данных SQL Azure основана на последней стабильной версии [ядра СУБД Microsoft SQL Server](/sql/sql-server/sql-server-technical-documentation?toc=%2fazure%2fsql-database%2ftoc.json). Вы можете использовать расширенные функции обработки запросов, например [технологии высокопроизводительных вычислений в памяти](../in-memory-oltp-overview.md) и [интеллектуальную обработку запросов](/sql/relational-databases/performance/intelligent-query-processing?toc=%2fazure%2fsql-database%2ftoc.json). На самом деле, новые возможности SQL Server выпускаются сначала для базы данных SQL и только потом для SQL Server. Вы получаете новейшие возможности SQL Server без дополнительных издержек на исправление или обновление, после тестирования на миллионах баз данных. 
