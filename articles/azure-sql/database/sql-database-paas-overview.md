...
В базах данных на уровнях служб "Премиум" и "Критически важный для бизнеса" [уже реализован механизм](high-availability-sla.md#premium-and-business-critical-service-tier-availability), сходный с синхронизацией группы доступности. Базы данных на более низких уровнях служб обеспечивают избыточность через хранилище, используя [несколько иной, но по сути эквивалентный механизм](high-availability-sla.md#basic-standard-and-general-purpose-service-tier-availability). Защититься от сбоев одного компьютера помогает встроенная логика. Функция активной георепликации дает возможность защититься от аварии, при которой уничтожается весь регион.
