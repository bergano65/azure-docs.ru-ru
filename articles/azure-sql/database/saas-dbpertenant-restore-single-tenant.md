...
description: Узнайте, как восстановить базу данных SQL Azure из одного клиента после случайного удаления данных
...
* Разверните приложение SaaS Wingtip. Сведения о развертывании менее чем за пять минут см. в статье [развертывание и изучение приложения SaaS Wingtip](../../sql-database/saas-dbpertenant-get-started-deploy.md).
...
1. Откройте концентратор событий ( http://events.wtp.&lt user &gt; . trafficmanager.NET) и выберите **contoso концерт зал**.
