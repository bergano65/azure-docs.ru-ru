...
Это никак не сказывается на клиенте, так как эти шлюзы (работающие на старом оборудовании) не направляют трафик клиентов. IP-адреса для этих шлюзов должны быть деактивированы 15 марта 2021.
