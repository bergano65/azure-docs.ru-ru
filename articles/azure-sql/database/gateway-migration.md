...
Существующие шлюзы SQL начнут принимать трафик в следующих регионах:
- Восточная Япония: 40.79.184.8, 40.79.192.5

Эти шлюзы SQL начинают принимать клиентский трафик по 1 сентября 2020. 
