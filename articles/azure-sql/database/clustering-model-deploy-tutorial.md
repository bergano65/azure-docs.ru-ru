...
* В третьей части этой серии учебников предполагается, что вы ознакомились с [**первой**](clustering-model-prepare-data-tutorial.md) и [**второй частью**](clustering-model-build-tutorial.md).
...
Если вы не собираетесь продолжать работу с этим руководством, можете удалить базу данных tpcxbb_1gb со своего сервера.
