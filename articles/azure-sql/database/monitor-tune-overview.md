...
Потоковые метрики и журналы ресурсов в [службе хранилища Azure](../../azure-monitor/platform/resource-logs.md#send-to-azure-storage). Используйте службу хранилища Azure для архивации огромных объемов диагностических данных диагностики за долю стоимости предыдущих двух вариантов потоковой передачи.
