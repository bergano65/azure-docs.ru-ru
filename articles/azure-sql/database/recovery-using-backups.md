...
По умолчанию резервные копии базы данных SQL Azure и Azure SQL Управляемый экземпляр хранятся в геореплицированном хранилище BLOB-объектов (тип хранилища RA-GRS). Для восстановления базы данных доступны следующие параметры с помощью автоматически создаваемых [резервных копий базы данных](automated-backups-overview.md). Вы можете:
...
- [Длительное хранение](long-term-retention-overview.md)
