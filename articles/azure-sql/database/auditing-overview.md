...
> [!WARNING]
> Включение аудита на сервере, на котором есть пул баз данных SQL, **приводит к возобновлению работы пула баз данных SQL и повторной приостановке** , что может привести к оплате счетов.
> Включение аудита в приостановленном пуле баз данных SQL невозможно. Чтобы включить его, отмените приостановку пула баз данных SQL.
