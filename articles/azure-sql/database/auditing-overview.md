...
В следующем разделе описывается настройка аудита на портале Azure.
  ...
  > [!NOTE]
  > Включение аудита в приостановленном пуле SQL синапсе невозможно. Чтобы включить аудит, отмените приостановку пула SQL синапсе. Дополнительные сведения о [пуле SQL синапсе](../../synapse-analytics/sql/best-practices-sql-pool.md).
