...
description: Узнайте, как использовать георепликацию базы данных SQL Azure для поддержки последовательных обновлений облачного приложения.
...
![На схеме показана конфигурация георепликации базы данных SQL для аварийного восстановления облака.](./media/manage-application-rolling-upgrade/option1-1.png)
...
![На схеме показана конфигурация георепликации базы данных SQL для аварийного восстановления облака, запускающего скрипт обновления.](./media/manage-application-rolling-upgrade/option1-2.png)
...
![Настройка георепликации базы данных SQL для облачного аварийного восстановления.](./media/manage-application-rolling-upgrade/option1-3.png)
...
![На схеме показана конфигурация георепликации базы данных SQL для аварийного восстановления облака с выработкой промежуточной среды.](./media/manage-application-rolling-upgrade/option1-4.png)
...
![На схеме показана конфигурация георепликации базы данных SQL для аварийного восстановления облака с полностью синхронизированной копией приложения.](./media/manage-application-rolling-upgrade/option2-1.png)
...
![На схеме показана конфигурация георепликации базы данных SQL для аварийного восстановления облака с изменениями базы данных, реплицированными в промежуточное хранение.](./media/manage-application-rolling-upgrade/option2-2.png)
...
![На схеме показана конфигурация георепликации базы данных SQL для аварийного восстановления облака с необязательным списанием промежуточной среды.](./media/manage-application-rolling-upgrade/option2-3.png)
...
![На схеме показана конфигурация георепликации базы данных SQL для аварийного восстановления облака с откатом процесса обновления.](./media/manage-application-rolling-upgrade/option2-4.png)
...
* Сведения о группах автоматической отработки отказа Базы данных SQL Azure см. в статье [Использование групп автоматической отработки отказа для включения прозрачной и согласованной отработки отказа в нескольких базах данных](auto-failover-group-overview.md).
