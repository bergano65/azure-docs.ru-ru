...
1. Оцените количество единиц eDTU или виртуальных ядер, необходимых для пула, следующим образом:
   - Для модели приобретения на основе DTU:
     - Max (<*Общее число баз данных* &times; *среднего потребления DTU на> базы данных* , <*число параллельных пиковых нагрузок баз данных* &times; *пикового использования DTU на базу данных*>)
   - Для модели приобретения на основе виртуальное ядро:
     - Max (<*Общее число баз данных* &times; *среднего уровня использования Виртуальное ядро на базу данных*>, <*число параллельно пиковых нагрузок баз данных* &times; *пиковое использование Виртуальное ядро на DB*>)
