...
|---|---|---|---|
|Standard|Общего назначения|Горизонтальный|Может выполнять миграцию в любом порядке, но необходимо обеспечить соответствующее виртуальное ядрое определение, как описано выше.|
...
|Standard|Критически важный для бизнеса уровень|Обновление|Сначала необходимо перенести базу данных-получатель|
|Критически важный для бизнеса уровень|Standard|Понижение уровня|Сначала необходимо перенести базу данных-источник|
