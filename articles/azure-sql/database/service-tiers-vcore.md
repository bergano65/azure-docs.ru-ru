...
|Серия M     |Процессоры Intel Xeon E7-8890 v3 2,5 ГГц и Intel Xeon Platinum 8280M 2,7 ГГц (Cascade Lake)<br>— Инициализация 128 виртуальных ядер (1 Виртуальное ядро = 1 Hyper-Thread)|– 29 ГБ на виртуальное ядро<br>— Инициализация 3,7 ТБ|
