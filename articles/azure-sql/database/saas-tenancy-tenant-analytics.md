...
description: Выполнение межклиентских запросов аналитики с помощью данных, извлеченных из нескольких баз данных SQL Azure в однотенантном приложении.
...
![Схема, на которой показана архитектура, используемая при работе с этой статьей.](./media/saas-tenancy-tenant-analytics/architectureOverview.png)
...
![Снимок экрана: элементы базы данных, отображаемые в обозревателе объектов SSMS.](./media/saas-tenancy-tenant-analytics/tenantAnalytics.png)
...
![Снимок экрана: база данных ExtractTickets с выбранным объектом базы данных TicketsRawData в обозревателе объектов.](./media/saas-tenancy-tenant-analytics/ticketExtracts.png)
...
5. В области слева выберите элемент **База данных** , а затем введите имя пользователя *developer* и пароль *P\@ssword1* . Нажмите кнопку **Соединить** .  
    ...
    ![Снимок экрана: диалоговое окно базы данных SQL Server, в котором можно ввести имя пользователя и пароль.](./media/saas-tenancy-tenant-analytics/databaseSignIn.PNG)
...
![Снимок экрана: визуализация и элементы управления для визуализации данных в правой части окна Power BI.](./media/saas-tenancy-tenant-analytics/TotalTicketsByVenues.PNG)
...
![Снимок экрана: визуализация Power BI с именем Ticket Sale Distribution (Распределение продаж билетов) и данными о продажах за каждый день.](./media/saas-tenancy-tenant-analytics/SaleVersusDate.PNG)
...
![Снимок экрана: визуализация среднего количества билетов, проданных каждым объектом, в Power BI.](./media/saas-tenancy-tenant-analytics/AvgTicketsByVenues.PNG)
