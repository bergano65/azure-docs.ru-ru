...
Обсуждение периода блокировки для клиентов, использующих ADO.NET, см. в разделе [Организация пулов соединений (ADO.NET)](https://msdn.microsoft.com/library/8xx3tyca.aspx).
...
Enterprise Library 6 (EntLib60) — это платформа классов .NET, которая помогает реализовать надежные клиенты облачных служб, одна из которых является базой данных SQL. Дополнительные сведения обо всех полезных возможностях EntLib60 вы найдете в [этой](https://msdn.microsoft.com/library/dn169621%28v=pandp.60%29.aspx) статье.
