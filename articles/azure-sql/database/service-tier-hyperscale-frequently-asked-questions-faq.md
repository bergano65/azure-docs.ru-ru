...
| **Объем вычислительных ресурсов**|Управляемый экземпляр SQL | 8, 16, 24, 32, 40, 64, 80 виртуальных ядер | Н/Д | 8, 16, 24, 32, 40, 64, 80 виртуальных ядер |
...
| **Объем памяти** | Управляемый экземпляр SQL  | От 32 ГБ до 8 ТБ | Н/Д | От 32 ГБ до 4 ТБ |
...
| **ОПЕРАЦИЙ ВВОДА-ВЫВОДА** | Управляемый экземпляр SQL | Зависит от размера файла | Н/Д | 1375 операций ввода-вывода в секунду/Виртуальное ядро |
