...
| **Объем вычислительных ресурсов**|Одиночная база данных или пул эластичных БД * | От 1 до 80 виртуальных ядер | От 1 до 80 виртуальных ядер* | От 1 до 80 виртуальных ядер |
| |Управляемый экземпляр SQL | 8, 16, 24, 32, 40, 64, 80 виртуальных ядер | Н/Д | 8, 16, 24, 32, 40, 64, 80 виртуальных ядер |
...
| **Объем памяти** | Отдельная база данных / эластичный пул*| От 5 ГБ до 4 ТБ | До 100 ТБ | От 5 ГБ до 4 ТБ |
...
| | Управляемый экземпляр SQL | Зависит от размера файла | Н/Д | 1375 операций ввода-вывода в секунду/Виртуальное ядро |
