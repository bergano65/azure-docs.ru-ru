...
Если вы используете аналитику данных в крупном масштабе с помощью сложных запросов и постоянно возрастающих приемов, превышающих 100 МБ/с, или с помощью хранилища данных Parallel Data Warehouse (PDW), Teradata или других хранилищ Data Parallel Processing (MPP), то лучше выбрать Azure синапсе Analytics (ранее — хранилище данных SQL).
