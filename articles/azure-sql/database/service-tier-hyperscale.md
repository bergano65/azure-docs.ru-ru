...
| Миграция баз данных с постоянными объектами OLTP в памяти | Масштабирование поддерживает только несохраняемые объекты OLTP в памяти (типы таблиц, собственные SPs и функции).  Постоянные таблицы OLTP в памяти и другие объекты должны быть удалены и воссозданы как объекты на диске перед переносом базы данных на уровень служб с поддержкой масштабирования.|
