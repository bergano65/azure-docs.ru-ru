...
[ ** \@ refresh_credential_name =** ] ' refresh_credential_name '  
Имени сервера. Типом refresh_credential_name является nvarchar(128), значение по умолчанию отсутствует.
...
|**job_id**| UNIQUEIDENTIFIER |Уникальный идентификатор задания.|
|**job_version** |INT |Версия задания (автоматически обновляется каждый раз при изменении задания).|
|**nописание** |nvarchar(512)| Описание задания. Бит включено: указывает, включено ли задание или отключено. Значение 1 указывает включенные задания, а значение 0 — отключенные задания.|
