---
title: Ограничения ресурсов виртуального ядра для эластичного пула
...
Ограничения для модели приобретения DTU см. в разделе [ограничения ресурсов DTU базы данных SQL — эластичные пулы](resource-limits-dtu-elastic-pools.md).
...
Вы можете задать уровень служб, размер вычислений (цель службы) и объем хранилища с помощью [портал Azure](elastic-pool-manage.md#azure-portal), [PowerShell](elastic-pool-manage.md#powershell), [Azure CLI](elastic-pool-manage.md#azure-cli)или [REST API](elastic-pool-manage.md#rest-api).
...
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup> |400|800|1200|1600|2000|2400|
|Максимальное количество журналов на пул (Мбит/с)|6|12|18|24|30|36|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup> |210|420|630|840|1050|1260|
|Максимальное число одновременных входов на пул <sup>3</sup> |210|420|630|840|1050|1260|
...
<sup>2</sup> максимальное значение для размеров операций ввода-вывода в диапазоне от 8 кб до 64 КБ. Фактические число операций ввода-вывода зависит от рабочей нагрузки. Дополнительные сведения см. в разделе [Управление вводом и выводом данных](resource-limits-logical-server.md#resource-governance).
...
|Максимальное число баз данных на пул <sup>1</sup>|500|500|500|500|500|500|
|Поддержка columnstore|Да|Да|Да|Да|Да|Да|
|Хранилище выполняющейся в памяти OLTP (ГБ)|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|
...
|Тип хранилища|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|
|Задержка ввода-вывода (приблизительно)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|2800|3200|3600|4000|6400|9600|
|Максимальное количество журналов на пул (Мбит/с)|42|48|48|48|48|48|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|1470|1680|1890|2100|3360|5040|
|Максимальное число одновременных входов в пул (запросов) <sup>3</sup>|1470|1680|1890|2100|3360|5040|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|30 000|
...
|Максимальное число баз данных на пул <sup>1</sup>|100|200|500|500|500|500|500|
...
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|800|1600|2400|3200|4000|4800|5600|
|Максимальное количество журналов на пул (Мбит/с)|12|24|36|48|48|48|48|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|210|420|630|840|1050|1260|1470|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|210|420|630|840|1050|1260|1470|
...
|Максимальное число баз данных на пул <sup>1</sup>|500|500|500|500|500|500|500|
|Поддержка columnstore|Да|Да|Да|Да|Да|Да|Да|
|Хранилище выполняющейся в памяти OLTP (ГБ)|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|
...
|Тип хранилища|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|
|Задержка ввода-вывода (приблизительно)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup> |6400|7200|8000|9600|12 800|16 000|16 000|
|Максимальное количество журналов на пул (Мбит/с)|48|48|48|48|48|48|48|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|1680|1890|2100|2520|3360|4200|8400|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|1680|1890|2100|2520|3360|4200|8400|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|30 000|30 000|
...
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|2560|3200|3840|4480|5120|
|Максимальное количество журналов на пул (Мбит/с)|48|48|48|48|48|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|400|500|600|700|800|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|800|1000|1200|1400|1600|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|
|Максимальное/минимальное количество виртуальных ядер в эластичном пуле на базу данных|0-8|0-10|0-12|0-14|0-16|
...
|Задержка ввода-вывода (приблизительно)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|5–7 мс (запись)<br>5–10 мс (чтение)|
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|5760|6400|7680|10240|11520|23040|
|Максимальное количество журналов на пул (Мбит/с)|48|48|48|48|48|48|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|900|1000|1200|1600|1800|3600|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|1800|2000|2400|3200|3600|7200|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|30 000|
|Максимальное/минимальное количество виртуальных ядер в эластичном пуле на базу данных|0-18|0-20|0–24|0-32|0-36|0-72|
|Количество реплик|1|1|1|1|1|1|
|Возможность развертывания Multi-AZ|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|
|Горизонтальное масштабирование для чтения|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|Недоступно|
|Включенное хранилище резервных копий|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|1 x размер базы данных|
...
|:--- | --: |--: |--: |--: |
|Поколение вычислительных ресурсов|DC|DC|DC|DC|
|Виртуальные ядра|2|4|6|8|
|Память (ГБ)|9|18|27|36|
|Максимальное число баз данных на пул <sup>1</sup>|100|400|400|400|
|Поддержка columnstore|Да|Да|Да|Да|
|Хранилище выполняющейся в памяти OLTP (ГБ)|Недоступно|Недоступно|Недоступно|Недоступно|
|Максимальный размер данных (ГБ)|756|1536|2048|2048|
|Максимальный размер журнала (ГБ)|227|461|614|614|
|Максимальный размер данных TempDB (ГБ)|64|128|192|256|
|Тип хранилища|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|Хранилище уровня "Премиум" (удаленное)|
...
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|800|1600|2400|3200|
|Максимальное количество журналов на пул (Мбит/с)|9,4|18,8|28,1|32,8|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|168|336|504|672|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|168|336|504|672|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|
|Максимальное/минимальное количество виртуальных ядер в эластичном пуле на базу данных|2|2... 4|2... 6|2... 8|
...
|Объем вычислительных ресурсов (цель обслуживания)|BC_Gen4_2|BC_Gen4_3|BC_Gen4_4|BC_Gen4_5|BC_Gen4_6|
|:--- | --: |--: |--: |--: |--: |--: |
...
|Максимальный размер данных TempDB (ГБ)|64|96|128|160|192|
...
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|9000|13 500|18 000|22 500|27 000|
|Максимальное количество журналов на пул (Мбит/с)|20|30|40|50|60|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|420|630|840|1050|1260|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|420|630|840|1050|1260|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|
...
|Виртуальные ядра|7|8|9|10|16|24|
|Память (ГБ)|49|56|63|70|112|159,5|
|Максимальное число баз данных на пул <sup>1</sup>|100|100|100|100|100|100|
...
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|31 500|36 000|40 500|45 000|72 000|96 000|
|Максимальное количество журналов на пул (Мбит/с)|70|80|80|80|80|80|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|1470|1680|1890|2100|3360|5040|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|1470|1680|1890|2100|3360|5040|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|30 000|
|Максимальное/минимальное количество виртуальных ядер в эластичном пуле на базу данных|0, 0.25, 0.5, 1...7|0, 0.25, 0.5, 1...8|0, 0.25, 0.5, 1...9|0, 0.25, 0.5, 1...10|0, 0.25, 0.5, 1...10, 16|0, 0.25, 0.5, 1...10, 16, 24|
...
|Объем вычислительных ресурсов (цель обслуживания)|BC_Gen5_4|BC_Gen5_6|BC_Gen5_8|BC_Gen5_10|BC_Gen5_12|BC_Gen5_14|
|:--- | --: |--: |--: |--: |---: | --: |--: |
...
|Максимальное число баз данных на пул <sup>1</sup>|50|100|100|100|100|100|
|Поддержка columnstore|Да|Да|Да|Да|Да|Да|
...
|Максимальный размер данных TempDB (ГБ)|128|192|256|320|384|448|
|Тип хранилища|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|
|Задержка ввода-вывода (приблизительно)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|18 000|27 000|36 000|45 000|54 000|63 000|
|Максимальное количество журналов на пул (Мбит/с)|60|90|120|120|120|120|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|420|630|840|1050|1260|1470|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|420|630|840|1050|1260|1470|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|30 000|
...
|Виртуальные ядра|16|18|20|24|32|40|80|
|Память (ГБ)|83|93,4|103,8|124,6|166,1|207,6|415,2|
|Максимальное число баз данных на пул <sup>1</sup>|100|100|100|100|100|100|100|
|Поддержка columnstore|Да|Да|Да|Да|Да|Да|Да|
...
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|72 000|81 000|90 000|108 000|144 000|180,000|256 000|
|Максимальное количество журналов на пул (Мбит/с)|120|120|120|120|120|120|120|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|1680|1890|2100|2520|3360|4200|8400|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|1680|1890|2100|2520|3360|4200|8400|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|30 000|30 000|
...
|Тип хранилища|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|
|Задержка ввода-вывода (приблизительно)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|12 499|15 624|18 748|21 873|24 998|28 123|
|Максимальное количество журналов на пул (Мбит/с)|48|60|72|84|96|108|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|800|1000|1200|1400|1 600|1800|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|800|1000|1200|1400|1 600|1800|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|30 000|
|Максимальное/минимальное количество виртуальных ядер в эластичном пуле на базу данных|0-8|0-10|0-12|0-14|0-16|0-18|
|Количество реплик|4|4|4|4|4|4|
...
Если все виртуальные ядра эластичного пула заняты, то каждая база данных в пуле получает равное количество вычислительных ресурсов для обработки запросов. База данных SQL Azure предоставляет равномерное распределение ресурсов между базами данных, обеспечивая равные срезы времени вычислений. Если задано минимальное значение виртуальных ядер на базу данных, отличное от нуля, то такое равное разделение ресурсов в эластичном пуле также позволяет гарантировать любое дополнительное количество ресурсов каждой базе данных.
...
|Тип хранилища|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|Локальный SSD|
|Задержка ввода-вывода (приблизительно)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|1–2 мс (запись)<br>1–2 мс (чтение)|
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|31 248|37 497|49 996|99 993|160 000|
|Максимальное количество журналов на пул (Мбит/с)|120|144|192|264|264|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|2 000|2400|3200|6400|12 800|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|2 000|2400|3200|6400|12 800|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|30 000|
|Количество реплик|4|4|4|4|4|
...
|Виртуальные ядра|2|4|6|8|
|Память (ГБ)|9|18|27|36|
|Максимальное число баз данных на пул <sup>1</sup>|50|100|100|100|
|Поддержка columnstore|Да|Да|Да|Да|
...
|Максимальное число операций ввода-вывода в секунду на пул <sup>2</sup>|15750|31500|47250|56000|
|Максимальное количество журналов на пул (Мбит/с)|20|60|90|120|
|Максимальное число одновременных рабочих ролей на пул (запросов) <sup>3</sup>|168|336|504|672|
|Максимальное число одновременных входов на пул (запросов) <sup>3</sup>|168|336|504|672|
|Максимальное количество параллельных сеансов|30 000|30 000|30 000|30 000|
|Максимальное/минимальное количество виртуальных ядер в эластичном пуле на базу данных|2|2... 4|2... 6|2... 8|
...
- [Общие сведения об ограничениях ресурсов Управляемого экземпляра Базы данных SQL Azure](../managed-instance/resource-limits.md).
