...
- Агент задания и его база данных созданы. Соответствующие шаги см. в [**этом разделе**](../../sql-database/saas-multitenantdb-schema-management.md#create-a-job-agent-database-and-new-job-agent).
...
2. Задайте в сценарии для переменной $DemoScenario значение в зависимости от выбранного хранилища аналитики. В целях обучения рекомендуется использовать базу данных без columnstore.
...
1. В среде SSMS подключитесь к базе данных **базе jobaccount** в каталоге-MT- \<User\> .
...
1. В среде SSMS подключитесь к базе данных **базе jobaccount** в каталоге-MT- \<User\> Server.
