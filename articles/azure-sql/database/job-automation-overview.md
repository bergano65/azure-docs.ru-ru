...
Стоит отметить пару различий между агентом SQL (доступным как локально, так и как часть Управляемого экземпляра SQL) и агентом заданий обработки эластичных баз данных (доступным для отдельных баз данных в Базе данных SQL Azure и для баз данных в Хранилище данных SQL).
