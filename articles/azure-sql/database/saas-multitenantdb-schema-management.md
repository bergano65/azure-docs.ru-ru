...
После этого ознакомьтесь с [руководством по автоматизированной системе отчетности](../../sql-database/saas-multitenantdb-adhoc-reporting.md), чтобы узнать о выполнении распределенных запросов в клиентских базах данных.
