---
title: Управление схемой в приложении с несколькими клиентами
...
ms.locfileid: "84027015"
---
# <a name="manage-schema-in-a-saas-application-that-uses-sharded-multi-tenant-databases"></a>Управление схемой в приложении SaaS, использующем сегментированные многоклиентские базы данных
...
> [!NOTE]
> В этом руководстве используются функции службы Базы данных SQL Azure в ограниченной предварительной версии ([Задания обработки эластичных баз данных](elastic-database-client-library.md)). Если вы хотите выполнить инструкции из этого руководства, укажите идентификатор подписки *саасфидбакк \@ Microsoft.com* с параметром subject = эластичные задания предварительной версии. Получив подтверждение о включении подписки, [скачайте и установите предварительную версию командлетов заданий](https://github.com/jaredmoo/azure-powershell/releases). Эта предварительная версия ограничена, поэтому обратитесь в *саасфидбакк \@ Microsoft.com* для получения связанных вопросов или поддержки.
...
В этом руководстве требуется создать базу данных агента заданий и агент заданий с помощью PowerShell. Как и база данных MSDB, используемая агентом SQL, агент заданий использует базу данных в базе данных SQL Azure для хранения определений задания, состояния задания и журнала. Создав агент заданий, вы можете сразу создавать и отслеживать задания.

1. В **интегрированной среде сценариев PowerShell**откройте *... \\ Учебные модули \\ \\Demo-SchemaManagement.ps1управления схемой *.
...
6. В SSMS откройте файл *... \\ Learning modules \\ Schema Management \\ DeployReferenceData. SQL*.
...
- **при \_ добавлении \_ задания SP** создается задание, именуемое *развертыванием эталонных данных*.
...
2. В SSMS откройте *... \\ Learning modules \\ Schema Management \\ OnlineReindex. SQL*.
...
* При создании ** \_ \_ задания SP Add** создается новое задание с именем *Online reindex PK \_ \_ VenueTyp \_ \_ 265E44FD7FD4C885*.

* **SP \_ Add \_ JobStep** создает шаг задания, содержащий текст команды T-SQL для обновления индекса.
...
Затем ознакомьтесь с [руководством по автоматизированной системе отчетности](../../sql-database/saas-multitenantdb-adhoc-reporting.md) , чтобы исследовать выполнение распределенных запросов между базами данных клиентов.
