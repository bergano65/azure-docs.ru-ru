...
**_Вариант 1. Обновление метаданных с помощью PowerShell_* _
...
_*_Вариант 2. Обновление метаданных с помощью языка C #_*_
