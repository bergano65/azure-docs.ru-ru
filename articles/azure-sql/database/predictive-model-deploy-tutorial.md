...
В третьей части этого руководства показано, как развернуть прогнозную модель, разработанную на R, в базе данных в Базе данных SQL с помощью Служб машинного обучения Базы данных SQL Azure (предварительная версия).

[!INCLUDE[ml-preview-note](../../../includes/sql-database-ml-preview-note.md)]

Вы создадите хранимую процедуру с внедренным сценарием R, который создает прогнозы с использованием модели. Так как модель выполняется в базе данных, ее можно легко обучать на данных, хранящихся в базе данных.
...
Из [второй части](predictive-model-build-compare-tutorial.md) вы узнали, как создавать и обучать несколько моделей машинного обучения на языке R, а затем выбирать наиболее точную.

## <a name="prerequisites"></a>Предварительные требования

* В третьей части этой серии учебников предполагается, что вы ознакомились с [**первой**](predictive-model-prepare-data-tutorial.md) и [**второй частью**](predictive-model-build-compare-tutorial.md).
...
Вы успешно создали, обучили и развернули модель в базе данных в Базе данных SQL Azure. Затем вы использовали ее в хранимой процедуре для прогнозирования значений на основе новых данных.
