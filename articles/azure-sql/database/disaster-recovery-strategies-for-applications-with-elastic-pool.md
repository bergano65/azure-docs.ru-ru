...
![На схеме показан основной регион и регион D R, которые используют георепликацию между базой данных управления и платным основным пулом клиентов и вторичным пулом без репликации для пула пробных клиентов.](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-4.png)
...
![На схеме показан сбой основного региона с отработкой отказа в базу данных управления, платным вторичным пулом клиентов, а также созданием и восстановлением для пробных клиентов.](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-5.png)
...
![На схеме показаны шаги восстановления размещения, реализуемые после восстановления основного региона.](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-6.png)
...
![На схеме показан основной регион с именем регион а и дополнительный регион с именем регион B, которые используют георепликацию между базой данных управления и платным основным пулом клиентов и вторичным пулом без репликации для пула пробных клиентов.](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-7.png)
...
![На схеме показан сбой основного региона с отработкой отказа в базу данных управления, платным вторичным пулом клиентов, а также созданием и восстановлением пробных версий клиентов в регионе B.](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-8.png)
...
![На схеме показаны шаги восстановления размещения, реализуемые после восстановления региона а.](./media/disaster-recovery-strategies-for-applications-with-elastic-pool/diagram-9.png)
