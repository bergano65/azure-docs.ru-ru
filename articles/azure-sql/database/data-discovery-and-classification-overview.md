...
- Чтобы просмотреть все классификации в базе данных, выполните следующие действия. [sys.sensitivity_classifications](https://docs.microsoft.com/sql/relational-databases/system-catalog-views/sys-sensitivity-classifications-transact-sql)
