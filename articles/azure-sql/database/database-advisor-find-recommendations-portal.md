...
![Рекомендации](./media/database-advisor-find-recommendations-portal/recommendations.png)
...
| Состояние | Описание |
|:--- |:--- |
| Не завершен |Команда на применение рекомендации получена и запланирована для выполнения. |
