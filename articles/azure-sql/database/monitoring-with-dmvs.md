...
Подробные сведения о динамических административных представлениях см. в разделе [динамические административные представления и функции (Transact-SQL)](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/system-dynamic-management-views).
...
Представление [sys. resource_stats](https://msdn.microsoft.com/library/dn269979.aspx) в базе данных **master** содержит дополнительные сведения, которые могут помочь в мониторинге производительности базы данных на уровне служб и вычислений. Данные собираются каждые 5 минут и хранятся приблизительно 14 дней. Это представление полезно для долгосрочного анализа использования ресурсов в базе данных.
...
Историю статистики по сеансам можно получить, выполнив запрос к представлению [sys. resource_stats](/sql/relational-databases/system-catalog-views/sys-resource-stats-azure-sql-database) и просмотрев столбец **active_session_count** .
