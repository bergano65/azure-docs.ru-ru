...
Чтобы скачать агент синхронизации данных, перейдите на [Синхронизация данных SQL агент](https://www.microsoft.com/download/details.aspx?id=27693). Чтобы обновить агент синхронизации данных, установите агент в том же расположении, что и старый агент, и переопределит исходный.
