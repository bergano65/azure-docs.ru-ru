...
|У вас есть службы среднего уровня, которые должны подключаться к базе данных SQL или Azure синапсе Analytics.|Используйте [встроенную проверку подлинности Azure AD](authentication-aad-configure.md).|
|||
