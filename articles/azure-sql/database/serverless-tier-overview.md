...
## <a name="auto-pause-and-auto-resume"></a>Автоматическое Приостановка и автоматическое возобновление

### <a name="auto-pause"></a>Автоматическая приостановка

Автоматическая приостановка активируется, если выполняются все перечисленные ниже условия в течение задержки автоматической паузы.
...
|Объект|Метрика|Описание|единиц(ы)|
|---|---|---|---|
