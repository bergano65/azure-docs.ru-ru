...
Следующие функции не поддерживают автоматическую приостановку, но поддерживают автоматическое масштабирование.  Если используются следующие компоненты, то функция приостановки должна быть отключена, а база данных останется в сети независимо от длительности бездействия базы данных.
...
|Признак|Триггер автоматического возобновления|
|---|---|
