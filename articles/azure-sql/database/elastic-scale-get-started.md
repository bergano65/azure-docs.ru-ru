...
3. В решении для примера проекта откройте файл *app.config*. Затем следуйте инструкциям в файле, чтобы добавить имя сервера и сведения о входе (имя пользователя и пароль).
...
* Форум обсуждений: [Microsoft Q&страница вопросов для базы данных SQL Azure](https://docs.microsoft.com/answers/topics/azure-sql-database.html)
