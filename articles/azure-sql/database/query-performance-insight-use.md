...
5. Откройте   >  **рекомендации** по интеллектуальной производительности и проверьте, доступны ли какие либо рекомендации по производительности. Дополнительные сведения о встроенных рекомендациях по производительности см. в разделе [Помощник по базам данных SQL Azure](database-advisor-implement-performance-recommendations.md).
...
1. С помощью флажков выделите отдельные запросы или отмените их выделение, чтобы включить их в диаграмму или исключить из нее.
   ...
   >
   > 1. В портал Azure выберите Мониторинг **базы данных SQL Azure**  >  .
   > 2. Выберите **Метрики**.
...
Длительные запросы с большой вероятностью могут блокировать ресурсы на долгий период, блокировать работу других пользователей и ограничивать масштабируемость. Они также являются лучшими кандидатами для оптимизации. Дополнительные сведения см. в статье [изучение и устранение проблем с БЛОКИРОВКОЙ SQL Azure](understand-resolve-blocking.md).
...
5. Чтобы просмотреть настраиваемое представление, нажмите кнопку **Перейти >**.
   ...
   >
   > 1. Выберите **мониторинг базы данных SQL Azure**  >  .
   > 2. Выберите **Метрики**.
   > 3. Выберите **+ Добавить диаграмму**.
   > 4. Выберите процент DTU на диаграмме.
   > 5. Дополнительно выберите **За последние 24 часа** в меню в верхнем левом углу и укажите интервал, равный одной минуте.
