...
Анализ производительности запросов обеспечивает интеллектуальный анализ запросов для отдельных баз данных и в составе пула. Он помогает выявление наиболее ресурсоемких и долго выполняющихся запросов в рабочей нагрузке. Это помогает найти запросы, оптимизированные для повышения общей производительности рабочей нагрузки и эффективного использования ресурсов, за которые вы оплачиваете. Анализ производительности запросов помогает тратить меньше времени на устранение неполадок базы данных, предоставляя:
...
Для анализа производительности запросов в базе данных должно быть активно [хранилище запросов](https://msdn.microsoft.com/library/dn817826.aspx) . По умолчанию он автоматически включается для всех баз данных SQL Azure. Если хранилище запросов неактивно, на портале Azure появится запрос на его включение.
