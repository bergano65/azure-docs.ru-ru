...
* Ограничения ресурсов модели приобретения DTU для базы данных SQL Azure см. в статье [ограничения ресурсов DTU — база данных SQL Azure](resource-limits-vcore-elastic-pools.md).
