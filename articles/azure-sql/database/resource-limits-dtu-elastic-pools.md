...
Ресурсы, предоставляемые эластичному пулу, могут превысить ресурсы, предоставленные отдельной базе данных за пределами эластичного пула, для того же числа DTU. Это означает, что использование eDTU эластичного пула может быть меньше, чем сумма использования DTU в базах данных в пуле, в зависимости от шаблонов рабочей нагрузки. Например, в крайнем случае с одной базой данных в эластичном пуле, где использование DTU базы данных составляет 100%, для определенных шаблонов рабочей нагрузки можно использовать eDTU пула в 50%. Это может произойти, даже если не задано явное максимальное значение DTU на базу данных. В этом случае использование DTU в составе базы данных ограничено таким же образом, как потребление DTU одной базы данных с соответствующей целью службы.
