...
Кроме того, для Управляемый экземпляр распределенных транзакций доступны в [Transact-SQL](https://docs.microsoft.com/sql/t-sql/language-elements/begin-distributed-transaction-transact-sql).
...
* **sys.dm\_tran\_active\_transactions** — позволяет просматривать список активных транзакций и их состояние. В столбце UOW (единица работы) можно просмотреть различные дочерние транзакции, которые относятся к одной распределенной транзакции. У всех транзакций в рамках одной распределенной транзакции одинаковое значение UOW. Дополнительные сведения см. в [документации по DMV](https://msdn.microsoft.com/library/ms174302.aspx).
* **sys.dm\_tran\_database\_transactions** — здесь можно просматривать дополнительные сведения о транзакциях, включая расположение транзакции в журнале. Дополнительные сведения см. в [документации по DMV](https://msdn.microsoft.com/library/ms186957.aspx).
* **sys.dm\_tran\_locks** — в этом представлении указываются сведения о текущих блокировках транзакций. Дополнительные сведения см. в [документации по DMV](https://msdn.microsoft.com/library/ms190345.aspx).
...
* Для получения вопросов свяжитесь с нами на [странице Microsoft Q&A вопрос для базы данных SQL](https://docs.microsoft.com/answers/topics/azure-sql-database.html).
