---
title: Мониторинг производительности сегментированной мультитенантной базы данных
...
1. _Чтобы создать нормальную нагрузку с высокой нагрузкой на отдельный клиент (около 90 DTU), задайте для параметра **$DemoScenario** значение 5._
