...
> - тестовая отработка отказа.
  ...
  > - Для управляемых экземпляров, которые включены в группу отработки отказа, требуется [Azure ExpressRoute](../../expressroute/expressroute-howto-circuit-portal-resource-manager.md) или два подключенных VPN-шлюза. Пиринг глобальной виртуальной сети не поддерживается. В этом учебнике содержатся инструкции по созданию и подключению VPN-шлюзов. Если вы уже настроили ExpressRoute, пропустите эти шаги. 
