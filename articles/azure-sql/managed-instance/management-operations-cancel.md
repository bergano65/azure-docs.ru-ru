...
|---------|---------|---------|---------|
|Развертывание |Создание экземпляра |Да |90 % операций завершается в течение 5 минут. |
...
|DELETE |Удаление виртуального кластера (выполняется в качестве операции, инициированной пользователем) |Нет |  |
...
1. Выберите **отменить операцию** в нижней части страницы. 
   ...
   :::image type="content" source="media/management-operations-cancel/cancel-operation.png" alt-text="Выберите поле текущая операция, чтобы открыть страницу текущей операции.":::
