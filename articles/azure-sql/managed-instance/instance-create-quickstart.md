...
> [!IMPORTANT]
> - Создание Управляемого экземпляра SQL — это длительный процесс, на завершение которого может потребоваться несколько часов в зависимости от условий. Сведения о стандартном времени создания см. в разделе [Длительность операций управления](management-operations-overview.md#management-operations-duration).
