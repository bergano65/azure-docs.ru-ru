...
- Реализуйте рекомендации по [использованию хранилища для общего назначения](https://techcommunity.microsoft.com/t5/DataCAT/Storage-performance-best-practices-and-considerations-for-Azure/ba-p/305525), например предварительное выделение размера файлов, чтобы повысить производительность.
