...
|------------|----------------------------|--------|-----------------|-----------|------|
|управление  |9000, 9003, 1438, 1440, 1452|TCP     |SqlManagement    |MI SUBNET  |Разрешить |
|            |9000, 9003                  |TCP     |корпнетсав       |MI SUBNET  |Разрешить |
|            |9000, 9003                  |TCP     |корпнетпублик    |MI SUBNET  |Разрешить |
...
| Имя       |Порт          |Протокол|Источник           |Назначение|Действие|
|------------|--------------|--------|-----------------|-----------|------|
|управление  |443, 12000    |TCP     |MI SUBNET        |AzureCloud; |Разрешить |
|mi_subnet   |Любой           |Любой     |MI SUBNET        |MI SUBNET  |Разрешить |
