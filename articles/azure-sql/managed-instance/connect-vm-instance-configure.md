...
1. После завершения развертывания перейдите в ресурс виртуальной машины.
    ...
    ![На снимке экрана показан портал Azure со страницей обзора для выбранной виртуальной машины и выделенной подсоединении.](./media/connect-vm-instance-configure/vm.png)  
