...
Если вы не знакомы с Управляемый экземпляр Azure SQL, ознакомьтесь с видеороликом *Azure sql управляемый экземпляр* из нашего подробного видеосборника [Azure SQL](https://channel9.msdn.com/Series/Azure-SQL-for-Beginners?WT.mc_id=azuresql4beg_azuresql-ch9-niner):
...
- Логические ЦП **го поколения** основаны на процессорах Intel® с частотой 3 – 2673 v3 (Haswell) 2,4 ГГц, подключенный SSD, физические ядра, 7 ГБ ОЗУ на ядро и вычисление размеров от 8 до 24 виртуальных ядер.
- Логические процессоры **го поколения** основаны на процессорах Intel® версии 3 – 2673 V4 (Broadwell) 2,3 ГГц, Intel® SP-8160 (Skylake) и Intel® 8272CL (Cascade Lake) с частотой 2,5 ГГц, быстрый SSD NVMe, логическое ядро с технологией Hyper-Threading и размер вычислений от 4 до 80 ядер.
...
![совместимость контактной зоны](./media/sql-managed-instance-paas-overview/migration.png)
