...
![Миграция](./media/transact-sql-tsql-differences-sql-server/migration.png)
...
- Включение и отключение агент SQL Server в настоящее время не поддерживается в SQL Управляемый экземпляр. Агент SQL работает всегда.
