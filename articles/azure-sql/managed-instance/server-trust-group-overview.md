...
[Группа доверия серверов](https://aka.ms/mi-server-trust-group-arm) — это объект Azure Resource Manager, помеченный как **Группа доверия SQL** в портал Azure.
