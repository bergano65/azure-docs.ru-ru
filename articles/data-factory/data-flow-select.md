...
![Пропустить повторения](media/data-flow/select-skip-dup.png "пропустить повторения")
...
![Выберите правила преобразования](media/data-flow/rule2.png "сопоставление на основе правил")
