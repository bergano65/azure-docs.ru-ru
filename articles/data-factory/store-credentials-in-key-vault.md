...
1. **Получите удостоверение управляемый фабрики данных** , скопировав значение «Управляемые Identity Application ID» созданного вместе с фабрикой. Если вы используете ADF разработки пользовательского интерфейса, управляемого удостоверения приложения, идентификатор будет отображаться в окне создания связанной службы Azure Key Vault; его также можно получить с портала Azure, см. [фабрики данных для получения управляемого удостоверения](data-factory-service-identity.md#retrieve-managed-identity).
