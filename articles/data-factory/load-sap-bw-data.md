...
3. Этот шаблон создает конвейер со следующими тремя действиями и делает их цепочкой в случае успеха: *Lookup*, *копирование данных*и *Web*.
   ...
   - **Хигхватермаркблобнаме**: укажите имя большого двоичного объекта для хранения значения верхнего предела, `requestIdCache.txt`например. В хранилище BLOB-объектов перейдите к соответствующему пути Хигхватермаркблобконтаинер + Хигхватермаркблобдиректори + Хигхватермаркблобнаме, например *Container/Path/рекуестидкаче. txt*. Создайте большой двоичный объект с содержимым 0.
