...
4. После ввода параметров конвейера фабрики данных выберите **отладка** > **Готово** , чтобы вызвать запуск для проверки конфигурации. Или выберите **опубликовать** , чтобы опубликовать все изменения, а затем выберите **добавить триггер** для выполнения выполнения.
