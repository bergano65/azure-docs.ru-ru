...
![The Mapping tab](media/data-flow/sink2.png "Приемники")
...
* Partition Key: This is a required field. Enter a string that represents the partition key for your collection. Пример: ```/movies/title```
