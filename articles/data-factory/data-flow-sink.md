...
> [!NOTE]
> При использовании [кэшированных поисков](https://docs.microsoft.com/azure/data-factory/concepts-data-flow-expression-builder#cached-lookup)убедитесь, что в упорядочении приемников задано значение 0 для кэшированных приемников.
