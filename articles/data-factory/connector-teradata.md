...
|:--- |:--- |:--- |
| тдмстпортнумбер | Номер порта, используемого для доступа к базе данных Teradata.<br>Не изменяйте это значение, если оно не указано в технической поддержке. | 1025 |
