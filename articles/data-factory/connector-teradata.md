...
| connectVia | [Среда выполнения интеграции](concepts-integration-runtime.md), используемая для подключения к хранилищу данных. Требуется локальная среда выполнения интеграции, как упоминалось в статье [Предварительные требования](#prerequisites). |Да |
...
| — база данных | Имя базы данных Teradata. | Нет (если свойство query указано в источнике действия) |
...
### <a name="teradata-as-a-source-type"></a>Teradata в качестве типа источника
