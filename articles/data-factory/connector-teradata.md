...
|:--- |:--- |:--- |
| уседатаенкриптион | Указывает, следует ли шифровать все связи с базой данных Teradata. Допустимые значения: 0 или 1.<br><br/>- **0 (отключено, по умолчанию)**: шифрует только сведения о проверке подлинности.<br/>- **1 (включено)**: шифрует все данные, передаваемые между драйвером и базой данных. | Нет |
