...
6. Укажите поведение копирования, установив параметры **Copy files recursively** (Копировать файлы рекурсивно) и **Binary copy** (Двоичное копирование). Выберите **Далее:**
...
9. На странице **«Выбрать выводной файл» или страницу папки** введите **copyfroms3** в качестве имени папки вывода и выберите **«Следующий».** ADF создаст соответствующую файловую систему ADLS Gen2 и подпапки во время копирования, если она не существует.
