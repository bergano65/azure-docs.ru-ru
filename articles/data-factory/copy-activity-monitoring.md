...
| redirectRowPath | Путь к журналу пропущенных несовместимых строк в хранилище BLOB-объектов, настраиваемом в `redirectIncompatibleRowSettings` свойстве. См. раздел [отказоустойчивость](copy-activity-overview.md#fault-tolerance). | Текст (string) |
