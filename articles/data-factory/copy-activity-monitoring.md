...
| датаконсистенциверификатион | Сведения о проверке согласованности данных, где можно узнать, были ли скопированные данные согласованы между исходным и целевым хранилищами. Дополнительные сведения см. в [этой статье](copy-activity-data-consistency.md#monitoring). | Array |
