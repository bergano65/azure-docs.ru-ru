...
| sqlDwPolyBase | Используется ли Polybase при копировании данных в Azure синапсе Analytics (ранее — хранилище данных SQL). | Логическое значение |
