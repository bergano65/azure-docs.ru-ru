...
1. В окне **Новый набор данных** введите SQL в окне поиска, чтобы отфильтровать соединители, а затем выберите **База данных SQL Azure** и нажмите **Готово**. В этом руководстве вы будете копировать данные в базу данных SQL. 
