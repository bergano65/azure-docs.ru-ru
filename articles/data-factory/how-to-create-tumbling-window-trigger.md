...
| Элемент JSON | Описание | Type | Допустимые значения | Обязательный |
|:--- |:--- |:--- |:--- |:--- |
...
| **Завершения**| Последнее возникновение, которое может быть в прошлом. | DateTime | Значение даты и времени. | Да |
