---
title: Копирование данных в базу данных Azure для MySQL и из нее с помощью фабрики данных Azure
...
| Свойство | Description (Описание) | Параметры | Обязательно |
|:--- |:--- |:--- |:--- |
