---
title: Копирование данных в базу данных Azure для MySQL и из нее
...
|:--- |:--- |:--- |:--- |
| SSLMode | Этот параметр указывает, использует ли драйвер шифрование и проверку TLS при подключении к MySQL. Пример: `SSLMode=<0/1/2/3/4>`| DISABLED (0) / PREFERRED (1) **(по умолчанию)** / REQUIRED (2) / VERIFY_CA (3) / VERIFY_IDENTITY (4) | Нет |
