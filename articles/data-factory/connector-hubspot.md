...
Этот соединитель HubSpot поддерживается для следующих действий:
...
Чтобы копировать данные из HubSpot, задайте для типа источника в действии копирования значение **HubspotSource**. В разделе **источник** действия копирования поддерживаются следующие свойства.
