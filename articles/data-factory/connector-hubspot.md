---
title: Копирование данных из HubSpot с помощью фабрики данных Azure (предварительная версия)
...
В этой статье описывается, как с помощью действия копирования в фабрике данных Azure копировать данные из HubSpot. Это продолжение [статьи об обзоре действия копирования](copy-activity-overview.md), в которой представлены общие сведения о действии копирования.
...
Этот разъем HubSpot поддерживается для следующих действий:
...
Данные из HubSpot можно скопировать в любое поддерживаемое хранилище данных, которое используется в качестве приемника. Список хранилищ данных, которые поддерживаются в качестве источников и приемников для действия копирования, приведен в таблице [Поддерживаемые хранилища данных и форматы](copy-activity-overview.md#supported-data-stores-and-formats).
...
| clientid | Идентификатор клиента, связанный с вашим приложением HubSpot. Узнайте, как создать приложение в HubSpot [здесь](https://developers.hubspot.com/docs/faq/how-do-i-create-an-app-in-hubspot). | Да |
| clientSecret | Секрет клиента, связанный с вашим приложением HubSpot. Пометьте это поле как SecureString, чтобы безопасно хранить его в фабрике данных, или [добавьте ссылку на секрет, хранящийся в Azure Key Vault](store-credentials-in-key-vault.md). | Да |
| accessToken | Маркер доступа, полученный на этапе первоначальной аутентификации при интеграции с OAuth. Узнайте, как получить токен доступа с вашим идентификатором клиента и секрет [омсвянина здесь](https://developers.hubspot.com/docs/methods/oauth2/get-access-and-refresh-tokens). Пометьте это поле как SecureString, чтобы безопасно хранить его в фабрике данных, или [добавьте ссылку на секрет, хранящийся в Azure Key Vault](store-credentials-in-key-vault.md). | Да |
...
Полный список разделов и свойств, доступных [datasets](concepts-datasets-linked-services.md) для определения наборов данных, см. Этот раздел содержит список свойств, поддерживаемых набором данных HubSpot.
...
| Свойство | Описание | Обязательно |
|:--- |:--- |:--- |
| type | Свойство типа набора данных должно быть установлено: **HubspotObject** | Да |
...
### <a name="hubspotsource-as-source"></a>HubSpot в качестве источника

Чтобы копировать данные из HubSpot, задайте для типа источника в действии копирования значение **HubspotSource**. Следующие свойства поддерживаются в разделе **источника активности** копирования:
