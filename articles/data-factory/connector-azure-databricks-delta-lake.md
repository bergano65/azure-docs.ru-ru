...
| type | Тип команды экспорта, установленный в значение _ * Азуредатабрикксделталакикспорткомманд * *. | Да |
...
| type | Тип команды импорта, установленный в значение _ * Азуредатабрикксделталакеимпорткомманд * *. | Да |
