...
Вычисляет арксинус обратное значение* ``acos(1) -> 0.0``
---
### <code>add</code>
...
Слева дополняет строку прилагаемым отступом определенной длины. Если строка больше или равна длине, то она * ``lpad('great', 10, '-') -> '-----great'`` считается неop 
* ``lpad('great', 4, '-') -> 'great'`` 
...
Дополняет строку прилагаемым отступом справа до достижения определенной длины. Если строка больше * ``rpad('great', 10, '-') -> 'great-----'``или равна длине, то она считается неop 
* ``rpad('great', 8, '<>') -> 'great<><'`` 
