...
Возвращает значение часа метки времени. Вы можете передать дополнительный часовой пояс в формате GMT, PST, UTC, "Острова Кайман". По умолчанию используется местный часовой пояс. Доступные форматы можно найти в SimpleDateFormat Java. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
...
Возвращает значение миллисекунды даты. Вы можете передать дополнительный часовой пояс в формате GMT, PST, UTC, "Острова Кайман". По умолчанию используется местный часовой пояс. Доступные форматы можно найти в SimpleDateFormat Java. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
...
Вычитает числа. Вычитает количество дней из даты. Вычитает длительность из метки времени. Вычитает две метки времени, чтобы получить разницу в миллисекундах. То же, что и оператор-.  
* ``minus(20, 10) -> 10``  
* ``20 - 10 -> 10``  
...
Возвращает значение минуты метки времени. Вы можете передать дополнительный часовой пояс в формате GMT, PST, UTC, "Острова Кайман". По умолчанию используется местный часовой пояс. Доступные форматы можно найти в SimpleDateFormat Java. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
...
Возвращает второе значение даты. Вы можете передать дополнительный часовой пояс в формате GMT, PST, UTC, "Острова Кайман". По умолчанию используется местный часовой пояс. Доступные форматы можно найти в SimpleDateFormat Java. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
...
Находит размер массива или типа схемы * ``size(['element1', 'element2']) -> 2``
* ``size([1,2,3]) -> 3``
___
### <code>slice</code>
...
Сортирует массив, используя предоставленную функцию предиката. Функция Sort принимает ссылку на два последовательных элемента в функции выражения как #item1 и #item2.  
...
Вычитает месяцы из даты или метки времени. То же, что и оператор-для Date.  
...
Преобразует строку даты ввода в дату, используя необязательный формат даты ввода. Доступные форматы можно найти в SimpleDateFormat Java. Если формат даты ввода не указан, формат по умолчанию — гггг-[М]М-[д]д. Допустимые форматы: [гггг, гггг-[M] M, гггг-[M] M-[d] d, гггг-[M] M-[d] dT *].  
...
Преобразует метку времени в формат UTC. Вы можете передать дополнительный часовой пояс в формате GMT, PST, UTC, "Острова Кайман". По умолчанию используется текущий timezoneRefer Java SimpleDateFormat для доступных форматов. https://docs.oracle.com/javase/8/docs/api/java/text/SimpleDateFormat.html.  
...
Всегда возвращает истинное значение. Используйте синтаксис функции (true ()), если имеется столбец с именем "true".  
* ``(10 + 20 == 30) -> true``  
* ``(10 + 20 == 30) -> true()``  
___
### <code>typeMatch</code>
...
## Агрегатные функции. следующие функции доступны только в преобразованиях «Статистическая обработка», «сведение», «отмена свертывания» и «окно».
___
### <code>avg</code>
...
## Функции окон следующие функции доступны только в преобразованиях окна.
___
### <code>cumeDist</code>
