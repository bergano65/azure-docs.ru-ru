...
Проверяет, имеет ли первый параметр значение null. Если значение не равно null, возвращается первый параметр. Если значение равно null, возвращается второй параметр. Если заданы три параметра, поведение будет таким же, как IIf (isNull (значение1), value2, значение3), а третий параметр возвращается, если первое значение не равно null.  
* ``iifNull(10, 20) -> 10``  
