...
1. В меню слева выберите **создать ресурс** > **Analytics** > **data Factory**.
...
13. Обратите внимание, что слева автоматически выбирается вкладка **Мониторинг**. Столбец **действия** содержит ссылки для просмотра сведений о выполнении действия и для повторного запуска конвейера:
