...
* **Высокая производительность**: До скорости загрузки данных 1 ГБ/с в поколение 1 хранилища Озера данных. Дополнительные сведения см. в руководстве [по настройке производительности действия копирования](copy-activity-performance.md).
...
* Учетная запись Gen1 хранилища Озера данных: Если у вас нет учетной записи Gen1 хранилища Озера данных, см. инструкции в [создать учетную запись Gen1 хранилища Озера данных](../data-lake-store/data-lake-store-get-started-portal.md#create-a-data-lake-storage-gen1-account).
