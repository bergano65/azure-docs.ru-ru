...
Чтобы скопировать данные из Concur, задайте тип источника **ConcurSource** в действии копирования. В разделе **источник** действия копирования поддерживаются следующие свойства.
