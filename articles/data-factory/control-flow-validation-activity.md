...
type | Должно быть присвоено **проверки**. | String | Да |
...
timeout | Указывает время ожидания для выполнения действия. Если значение не указано, значение по умолчанию — 7 дней («7.00:00:00»). Формат: д.чч:мм:сс | String | Нет |
