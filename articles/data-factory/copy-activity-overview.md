...
На вкладке Источник действия копирования можно найти следующую конфигурацию. Можно также сопоставить эти дополнительные столбцы в [сопоставлении схемы](copy-activity-schema-and-type-mapping.md#schema-mapping) действия копирования как обычно с помощью определенных имен столбцов. 
...
## <a name="auto-create-sink-tables"></a>Автоматическое создание таблиц приемников

При копировании данных в базу данных SQL или Azure синапсе Analytics, если Целевая таблица не существует, действие копирования поддерживает автоматическое создание на основе исходных данных. Она призвана помочь вам быстро начать загрузку данных и оценить базу данных SQL или Azure синапсе Analytics. После приема данных можно просматривать и корректировать схему таблицы приемника в соответствии с вашими потребностями.

Эта функция поддерживается при копировании данных из любого источника в следующие хранилища данных приемника. Этот параметр можно найти в *пользовательском интерфейсе создания ADF* — *> приемника действий копирования* — > *параметр таблицы* — > *Автоматическое создание таблицы* или через `tableOption` свойство в полезных данных приемника действия копирования.

- [База данных SQL Azure](connector-azure-sql-database.md)
- [Управляемый экземпляр Базы данных SQL Azure](connector-azure-sql-managed-instance.md)
- [Azure Synapse Analytics (прежнее название — хранилище данных SQL)](connector-azure-sql-data-warehouse.md)
- [SQL Server](connector-sql-server.md)

![Создание таблиц приемников](media/copy-activity-overview/create-sink-table.png)
