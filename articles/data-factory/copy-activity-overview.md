...
1. **Создайте связанные службы для источника данных и приемник данных.** Дополнительные сведения о настройке и поддерживаемых свойствах см. в разделе "Свойства связанных служб" статьи о соединителях. Список поддерживаемых соединителей приведен в разделе [Поддерживаемые хранилища данных и форматы](#supported-data-stores-and-formats).
2. **Создание наборов данных для источника и приемника.** Дополнительные сведения о настройке и поддерживаемых свойствах см. в разделе "Свойства наборов данных" статьи о соединителях источника и приемника.
...
|:--- |:--- |:--- |
| тип | Свойство type действия копирования должно иметь значение **Copy**. | Да |
...
**Пример: копирование из базы данных SQL Azure в хранилище данных SQL Azure с помощью промежуточного копирования**
...
**Пример: копирование в базу данных SQL Azure с советы по настройке производительности**
...
- [Копирование данных из одного расположения в другое расположение в том же хранилище BLOB-объектов Azure](quickstart-create-data-factory-dot-net.md)
- [Копирование данных из хранилища BLOB-объектов Azure в базу данных SQL Azure](tutorial-copy-data-dot-net.md)
- [Копирование данных из локального SQL Server в Azure](tutorial-hybrid-copy-powershell.md)
