...
| Свойство | Description (Описание) | Обязательный? |
|:--- |:--- |:--- |
| type | Для действия копирования задайте значение `Copy` | Да |
| inputs | Укажите созданный набор данных, указывающий на исходные данные. Действие копирования поддерживает только один вход. | Да |
...
| sink | Укажите тип приемника копирования и соответствующие свойства для записи данных.<br/><br/>Дополнительные сведения см. в разделе "свойства действия копирования" статьи о соединителе, приведенном в статье [Поддерживаемые хранилища данных и форматы](#supported-data-stores-and-formats). | Да |
...
| Имя свойства  | Description (Описание) | Единица измерения |
|:--- |:--- |:--- |
