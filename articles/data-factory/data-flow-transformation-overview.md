...
| [Поиска](data-flow-lookup.md) | Несколько входов/выходов | Справочные данные из другого источника. |
...
| [Сортировки](data-flow-sort.md) | Модификатор строки | Сортировать входящие строки в текущем потоке данных |
