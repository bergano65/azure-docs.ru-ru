...
|:--- |:--- |:--- |
| type | Свойству type необходимо задать значение **Phoenix** | Да |
| host | IP-адрес или имя узла сервера Phoenix (это 192.168.222.160).  | Да |
| port | TCP-порт, используемый сервером Phoenix для прослушивания клиентских подключений. Значение по умолчанию — 8765. При подключении к Azure HDInsights укажите порт 443. | Нет |
...
| Свойство | Описание | Обязательно для заполнения |
|:--- |:--- |:--- |
| type | Свойству type набора данных необходимо задать значение **PhoenixObject**. | Да |
...
| Свойство | Описание | Обязательно для заполнения |
|:--- |:--- |:--- |
| type | Свойству type источника действия копирования необходимо задать значение **PhoenixSource**. | Да |
