...
- SAP Business Warehouse **версии 7,01 или более поздней (в последнем стеке пакетов поддержки SAP, выпущенном после года 2015)**. SAP BW4/HANA не поддерживается этим соединителем.
...
|:--- |:--- |
| C (строка) | Строковый тип |
| I (целое число) | Int32 |
| F (с плавающей запятой) | Double |
| D (дата) | Строковый тип |
| T (время) | Строковый тип |
| P (пакеты данных конфигурации загрузки, валюта, десятичное число, количество) | Десятичный тип |
| N (числовой символ) | Строковый тип |
| X (двоичные и необработанные данные) | Строковый тип |
