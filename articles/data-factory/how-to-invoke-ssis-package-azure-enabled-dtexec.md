...
После того, как уникальные конвейеры с активностью пакета Execute SSIS в них генерируются и запускаются после того, как вы вызываете AzureDTExec, они могут контролироваться на портале Data Factory. Для получения дополнительной [информации см. Выполнить пакеты SSIS как деятельность фабрики данных.](https://docs.microsoft.com/azure/data-factory/how-to-invoke-ssis-package-ssis-activity)
