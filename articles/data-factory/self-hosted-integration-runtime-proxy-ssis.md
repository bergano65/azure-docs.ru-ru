...
- В настоящее время поддерживаются только пользовательские или сторонние компоненты потока данных, написанные в управляемом коде (платформа .NET Framework). в настоящее время они не поддерживаются в машинном коде (C++).
