...
Эта функция разделяет любую задачу потока данных служб SSIS, имеющую локальный источник данных, на две промежуточные задачи: 
...
- В настоящее время поддерживаются только задачи потока данных с/Оледб/флатными источниками файлов и назначение OLEDB. 
