...
Потоки данных структурирование в фабрике данных Azure позволяют итеративно выполнять подготовку данных без кода в масштабе облака. Потоки данных структурирование интегрируются с [Power Query Online](/power-query/) и делают функции Power Query M доступными для структурирование данных в облачном масштабировании с помощью выполнения Spark. Дополнительные сведения см. в разделе [структурирование Data](wrangling-data-flow-overview.md)Flows.
