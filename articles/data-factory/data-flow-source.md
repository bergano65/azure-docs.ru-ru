...
Это полезно в таких наборах данных, как Avro и CosmosDB, которые поддерживают сложные структуры, а определения схем не должны существовать в наборе данных.
