...
В этом случае все подкаталоги в/Дата/Салес, для которых были созданы исходные данные, перемещаются относительно/Баккуп/приорсалес.
...
Щелкнув внутри полей на панели параметров, вы увидите гиперссылку "добавить динамическое содержимое". Щелкнув здесь, вы запустите построитель выражений. Здесь можно задать значения для параметров динамически с помощью выражений, статических литеральных значений или параметров.
