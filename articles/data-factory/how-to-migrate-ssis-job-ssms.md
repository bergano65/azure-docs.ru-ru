...
- генерировать шаблоны Azure Resource Manager (ARM) в локальной папке вывода и развертывать на фабрике данных непосредственно или позже вручную. Для получения дополнительной информации о шаблонах ADF Resource Manager [см.](https://docs.microsoft.com/azure/templates/microsoft.datafactory/allversions)
