...
1. Создайте файл python по имени **WordCount_Spark.py** со следующим содержанием: 
    ...
    if __name__ == "__main__":
        main()
    ```
2. Замените ** &lt;хранилищеAccountName&gt; ** на имя вашей учетной записи хранения Azure. Затем сохраните файл. 
