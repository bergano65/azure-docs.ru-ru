...
6.  Запуск триггера в Azure PowerShell с помощью cmdlet **Get-AzDataFactoryV2TriggerRun.** Для этого следующую команду нужно выполнять периодически. Обновите значения **TriggerRunStartedAfter** и **TriggerRunStartedBefore** в соответствии со значениями в определении триггера:
...
| **Интервал** | Number | нет | 1 | 1–1000 | `"interval":10` |
