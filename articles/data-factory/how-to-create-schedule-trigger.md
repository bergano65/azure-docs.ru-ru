...
| **interval** | Положительное целое число, определяющее интервал для значения **frequency**, которое определяет, как часто выполняется триггер. Например, если **interval** имеет значение 3, а для элемента **frequency** выбран вариант week (неделя), триггер выполняется один раз каждые 3 недели. |
...
|:--- |:--- |:--- |:--- |:--- |:--- |
| **startTime** | string | Да | None | Дата и время по спецификации ISO-8601 | `"startTime" : "2013-01-09T09:30:00-08:00"` |
...
| **endTime** | string | Да | None | Значение даты и времени, представляющее время в будущем. | `"endTime" : "2013-02-09T09:30:00-08:00"` |
