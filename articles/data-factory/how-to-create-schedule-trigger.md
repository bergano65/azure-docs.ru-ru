...
|:--- |:--- |:--- |
| **тезис** | Минуты часа, в которые будет выполняться триггер. | <ul><li>Целочисленный тип</li><li>массив целых чисел</li></ul>
| **суток** | Часы дня, в которые будет выполняться триггер. | <ul><li>Целочисленный тип</li><li>массив целых чисел</li></ul> |
