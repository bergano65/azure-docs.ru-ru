...
1. На странице **Исходное хранилище данных** сделайте следующее.
    ...
    а. Щелкните **+Создать подключение**:
    ...
    c. На странице **New Linked Service** выберите имя сервера и имя DB из списка выпадающих данных и укажите имя пользователя и пароль. Щелкните **Проверить подключение**, чтобы проверить настройки, а затем нажмите кнопку **Готово**.
...
1. На странице **Целевое хранилище данных** сделайте следующее.
    ...
    b. В коллекции выберите элемент **Хранилище данных SQL Azure** и нажмите кнопку **Далее**.
...
1. На странице **Параметры** сделайте следующее.
    ...
    b. На странице **New Linked Service** (Новая связанная служба) выберите учетную запись хранения и нажмите кнопку **Готово**.
...
1. Просмотрите параметры на странице **Summary** (Сводка), а затем нажмите кнопку **Далее**.
...
1. Обратите внимание, что слева автоматически выбирается вкладка **Мониторинг**. Столбец **«Действия»** содержит ссылки для просмотра сведений о запуске активности и повторного запуска конвейера:
