...
1. На странице **Исходное хранилище данных** сделайте следующее.
    ...
    в) На странице **Новая связанная служба** выберите имя сервера и имя базы данных из раскрывающегося списка и укажите имя пользователя и пароль. Щелкните **Проверить подключение**, чтобы проверить настройки, а затем нажмите кнопку **Готово**.
...
1. На странице **Параметры** сделайте следующее.
    ...
    в) В разделе **Дополнительные параметры** снимите флажок **Use type default** (Тип по умолчанию) и нажмите кнопку **Далее**.
