...
| клиент | Укажите информацию о клиенте, такие как доменное имя или идентификатор, на котором размещается приложение клиента. Эти сведения можно получить, наведя указатель мыши на правый верхний угол страницы портала Azure. | Yes |
