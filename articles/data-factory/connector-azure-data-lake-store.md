...
>[!NOTE]
>При использовании **Средства копирования данных** для создания конвейера копирования или **пользовательского интерфейса ADF** для тестирования подключения и навигации по папкам во время создания, чтобы просматривать папки, начиная с корневой, необходимо предоставить субъекту-службе разрешение на **уровне корневой папки с правом на выполнение**. Выполнение действия копирования может работать до тех пор, пока копируемым данным предоставляется разрешение. Вы можете пропустить авторизованные операции, если необходимо ограничить разрешение.
...
>[!NOTE]
>При использовании **Средства копирования данных** для создания конвейера копирования или **пользовательского интерфейса ADF** для тестирования подключения и навигации по папкам во время создания, чтобы просматривать папки, начиная с корневой, необходимо предоставить разрешение **на уровне корневой папки с правом на выполнение**. Выполнение действия копирования может работать до тех пор, пока копируемым данным предоставляется разрешение. Вы можете пропустить авторизованные операции, если необходимо ограничить разрешение.
...
| folderPath | Путь к папке в Data Lake Store. Фильтр подстановочных знаков не поддерживается. Если это свойство не указано, будет использоваться корневая папка. Пример: rootfolder/subfolder/ |Нет  |
