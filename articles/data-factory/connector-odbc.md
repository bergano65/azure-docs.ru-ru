...
Этот разъем ODBC поддерживается для следующих действий:
...
- Установите 64-разрядный драйвер ODBC для хранилища данных на машине Integration Runtime.
...
Полный список разделов и свойств, доступных [datasets](concepts-datasets-linked-services.md) для определения наборов данных, см. В этом разделе содержится список свойств, поддерживаемых набором данных ODBC.

Для копирования данных из/в хранилище данных, совместимых с ODBC, поддерживаются следующие свойства:

| Свойство | Описание | Обязательно |
|:--- |:--- |:--- |
| type | Свойство типа набора данных должно быть установлено на: **OdbcTable** | Да |
...
Для копирования данных из хранилища данных, совместимых с ODBC, в разделе **источника активности** копирования поддерживаются следующие свойства:

| Свойство | Описание | Обязательно |
|:--- |:--- |:--- |
| type | Свойство типа источника активности копирования должно быть установлено на: **OdbcSource** | Да |
...
Чтобы скопировать данные в хранилище данных, совместимое с ODBC, установите тип приемника в действии копирования **OdbcSink**. Следующие свойства поддерживаются в разделе **раковины активности** копирования:
