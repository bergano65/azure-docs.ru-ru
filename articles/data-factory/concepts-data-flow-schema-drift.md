...
ms.locfileid: "56212822"
---
# <a name="azure-data-factory-mapping-data-flow-schema-drift"></a>Смещение схемы сопоставления потоков данных в Фабрике данных Azure
...
* Убедитесь, что вы используете функцию "Автоматическое сопоставление" для сопоставления всех новых полей в преобразовании приемника, чтобы все новые поля были выбраны и помещены в целевое расположение.
