...
Это видео дает представление о некоторых сложных решениях, которые можно легко построить в ADF с функцией дрейфа схемы потока данных. В этом примере мы создаем многоразовые шаблоны на основе гибких схем баз данных:
