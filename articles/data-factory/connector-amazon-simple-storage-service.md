...
Чтобы скопировать данные из Amazon S3 в **Parquet, текст, JSON, Avro и двоичный формат с разделителями**, см. статью [Формат Parquet](format-parquet.md), [текстовый формат с разделителями](format-delimited-text.md), [Формат Avro](format-avro.md) и [двоичный формат](format-binary.md) в наборе данных на основе формата и поддерживаются. Параметры. Для Amazon S3 в параметрах `location` в наборе данных на основе формата поддерживаются следующие свойства:
...
Чтобы скопировать данные из Amazon S3 в **формате ORC**, поддерживаются следующие свойства:
...
Чтобы скопировать данные из Amazon S3 в **Parquet, текст, JSON, Avro и двоичный формат**, см. статью [Формат Parquet](format-parquet.md), [текстовый формат с разделителями](format-delimited-text.md), [Формат Avro](format-avro.md) и [двоичный формат](format-binary.md) в источнике действия копирования на основе формата и Поддерживаемые параметры. Следующие свойства поддерживаются для Amazon S3 в параметрах `storeSettings` в источнике копирования на основе формата:
...
Чтобы скопировать данные из Amazon S3 в **формате ORC**, в разделе **источник** действия копирования поддерживаются следующие свойства.
