...
В режиме DistCp фабрики данных можно использовать параметр `-update`командной строки DistCp, чтобы записывать данные, когда исходный файл и файл назначения различаются по размеру, для разностной миграции данных.
