...
| Рекомендации недоступны          | Этот узел не готов к развертыванию и выполнению пакетов служб SSIS и содержит ошибки и проблемы, которые можно устранить. |
