...
| Description (Описание) | Описание среды выполнения интеграции.  |
...
| Свойство или состояние | Description (Описание) |
| --------------- | ----------- |
...
| Description (Описание) | Описание среды выполнения интеграции SSIS Azure. |
...
| Общее состояние | Description (Описание) | 
| -------------- | ----------- | 
