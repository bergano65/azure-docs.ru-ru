...
-  **Именование ресурсов** Сделать ограничением шаблона. Если ресурсы содержат пробелы в имени, может возникнуть проблема развертывания. Группа фабрики данных Azure рекомендует использовать символы "_" или "-" вместо пробелов для ресурсов. Например, "Pipeline_1" будет предпочтительным именем для "конвейер 1".
