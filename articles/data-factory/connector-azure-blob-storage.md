...
- Чтобы скопировать данные из **Parquet, разделенного текста, Avro и двоичного формата**, см. раздел [Parquet, исходный текст и двоичный формат с разделителями](#format-based-source) .
...
Чтобы скопировать данные из хранилища BLOB-объектов в **формате ORC или JSON**, задайте для типа источника в действии копирования значение **BlobSource**. В разделе **source** действия копирования поддерживаются следующие свойства.
...
Чтобы скопировать данные в хранилище BLOB-объектов в **формате ORC/JSON**, задайте для типа приемника в действии копирования значение **BlobSink**. Следующие свойства поддерживаются в разделе **sink**.
