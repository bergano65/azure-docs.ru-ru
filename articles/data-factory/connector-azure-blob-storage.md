...
Сведения о копировании данных в хранилище BLOB-объектов и из него в Parquet, разделенном на текст или двоичном формате, см. в статье [Формат Parquet](format-parquet.md), [текстовый формат с разделителями](format-delimited-text.md) и [двоичный формат](format-binary.md) в наборе данных на основе формата и поддерживаемых параметрах. Следующие свойства поддерживаются для большого двоичного объекта `location` Azure в параметрах набора данных на основе формата:
...
Чтобы скопировать данные в хранилище BLOB-объектов и из него в формате ORC/Avro/JSON, задайте для свойства Type набора данных значение **AzureBlob**. Поддерживаются следующие свойства.
...
Сведения о копировании данных в хранилище BLOB-объектов и из него в **Parquet, разделенном на текст или двоичном формате**, см. в статье [Формат Parquet](format-parquet.md), [текстовый формат с разделителями](format-delimited-text.md) и [двоичный формат](format-binary.md) в наборе данных на основе формата и поддерживаемых параметрах. Следующие свойства поддерживаются для большого двоичного объекта `storeSettings` Azure в параметрах в источнике копирования на основе формата:
...
Чтобы скопировать данные из хранилища BLOB-объектов в **формате ORC, Avro или JSON**, задайте для параметра Тип источника в действии копирования значение **BlobSource**. В разделе **source** действия копирования поддерживаются следующие свойства.
...
Чтобы скопировать данные в хранилище BLOB-объектов в **формате ORC/Avro/JSON**, задайте для типа приемника в действии копирования значение **BlobSink**. Следующие свойства поддерживаются в разделе **sink**.
