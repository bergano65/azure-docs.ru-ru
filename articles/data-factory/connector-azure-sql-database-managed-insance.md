...
>[!NOTE]
>Если хранимая процедура записывает данные в тип данных **Money или Smallmoney**, значения могут округляться. Чтобы избежать этой проблемы, укажите для возвращающих табличное значение параметров тип **Decimal** вместо **Money или Smallmoney**. 
