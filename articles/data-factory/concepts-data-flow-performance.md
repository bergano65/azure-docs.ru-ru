...
Монитор потока данных ![монитора потока]данных(media/data-flow/mon002.png "2")
...
(media/data-flow/mon003.png "Монитор потока данных") ![мониторинга потока данных]3
...
![Создать]IR(media/data-flow/ir-new.png "Новый IR")
...
(media/data-flow/sourcepart3.png "Часть источника") исходного ![фрагмента]
...
![](media/data-flow/source4.png "Источник") источника
...
(media/data-flow/sink4.png "Приемник") ![приемника]
...
* Отладочные кластеры по умолчанию — это небольшие кластеры с одним узлом. для отладки рекомендуется использовать примеры небольших файлов. Перейдите в раздел Параметры отладки и укажите небольшое подмножество данных с помощью временного файла.
    ...
    Параметры ![отладки отладочных](media/data-flow/debugsettings3.png "") параметров
