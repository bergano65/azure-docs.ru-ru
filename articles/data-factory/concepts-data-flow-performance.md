---
title: Сопоставление руководств по производительности потока данных и настройке в фабрике данных Azure
...
* Сраугпут: задайте более высокую пропускную способность, чтобы документы можно было быстрее писать в CosmosDB. Обратите внимание на более высокие затраты на ЕДИНИЦу, основанные на настройке высокой пропускной способности.
*   Пропускная способность записи: используйте значение, которое меньше общего числа получателей в минуту. Если у вас есть поток данных с большим количеством партитионгс Spark, Настройка пропускной способности бюджета позволит повысить баланс между этими секциями.
