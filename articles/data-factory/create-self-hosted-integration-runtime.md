...
| **Запуск**                                                       | Запустите службу узла локальной среды выполнения интеграции.     | нет       |
...
Например, чтобы скопировать данные из локального хранилища данных в приемник базы данных SQL или Azure синапсе Analytics (ранее — хранилище данных SQL), выполните следующие действия.
