...
- На компьютере может быть установлен только один экземпляр локальной среды выполнения интеграции. Если у вас есть две фабрики данных, которым требуется доступ к локальным источникам данных, необходимо установить локальную среду выполнения интеграции на двух локальных компьютерах каждого из обеих фабриках данных или использовать [локальной IR, совместного использования](#sharing-the-self-hosted-integration-runtime-with-multiple-data-factories)для совместного использования среды выполнения интеграции с другой фабрикой данных.  
