...
1. На следующей странице выберите **Self-Hosted** для создания Самостоятельного ИК, а затем выберите **Продолжить**.
   ![Создание самоуправляемого ИК](media/create-self-hosted-integration-runtime/new-selfhosted-ir.png)

1. Введите имя для ИК и выберите **Создать.**

1. На странице **настройки времени выполнения интеграции** выберите ссылку в соответствии с **вариантом 1,** чтобы открыть экспресс-установку на вашем компьютере. Или выполните шаги в соответствии с **вариантом 2,** чтобы настроить вручную. Следующие инструкции основаны на ручной настройке:
...
1. Выберите **Далее**. Затем вы видите предупреждение, которое запрашивает ваше разрешение на сохранение настройки прокси и перезагрузку службы хоста времени выполнения.
