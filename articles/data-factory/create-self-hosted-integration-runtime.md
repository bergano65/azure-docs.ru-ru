...
1. Нажмите кнопку **Далее**. Вы увидите предупреждение о том, что у вас есть разрешение на сохранение параметра прокси-сервера, и перезапустите службу узла среды выполнения интеграции.
