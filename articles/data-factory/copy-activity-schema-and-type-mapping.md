...
| Порядковый номер  | Индекс столбца. Начинается с 1. <br>Применить и требуется, если с помощью с разделителями текста без строки заголовка. | Нет        |
...
| Тип     | Тип промежуточных данных фабрики данных столбца источника или приемника. | Нет        |
