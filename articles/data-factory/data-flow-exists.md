---
title: Преобразование "EXISTS" в потоке данных сопоставления фабрики данных Azure | Документация Майкрософт
...
Выберите поток данных для проверки существования в правильном раскрывающемся списке **потока** .

Укажите, нужно ли, чтобы данные были уже существуют или не существовали в параметре **типа EXISTS** .

Выберите ключевые столбцы, которые необходимо сравнить как условия существования. По умолчанию поток данных ищет равенство между двумя столбцами в каждом потоке. Для сравнения с помощью значения вычислений наведите указатель мыши на раскрывающийся список столбцов и выберите **вычисляемый столбец**.
