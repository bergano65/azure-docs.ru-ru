...
| [Лазурные databricks](#azure-databricks-linked-service)         | [Notebook](transform-data-databricks-notebook.md), [Jar](transform-data-databricks-jar.md), [Python](transform-data-databricks-python.md) |
...
Можно создать **службу связанного с Azure Databricks службы** регистрации рабочего пространства Databricks, которое будет использоваться для выполнения рабочих нагрузок Databricks (ноутбук, банк, питон). 
> [!IMPORTANT]
