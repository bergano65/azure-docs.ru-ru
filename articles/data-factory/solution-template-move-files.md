---
title: Перемещение файлов между файловым хранилищем с помощью фабрики данных Azure | Документация Майкрософт
...
3. Выберите **использовать этот шаблон**.
    ...
    ![Использовать этот шаблон](media/solution-template-move-files/move-files3.png)
