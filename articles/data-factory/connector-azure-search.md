...
Чтобы скопировать данные в Когнитивный поиск Azure, задайте тип источника **AzureSearchIndexSink**в действии копирования. В разделе **приемника** действия копирования поддерживаются следующие свойства:
