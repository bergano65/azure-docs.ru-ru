---
title: Копирование данных в базу данных Azure для PostgreSQL и из нее с помощью фабрики данных Azure
...
| запрос | Используйте пользовательский SQL-запрос для чтения данных. Например: `"SELECT * FROM MyTable"` | Нет (если указано свойство tableName в наборе данных) |
