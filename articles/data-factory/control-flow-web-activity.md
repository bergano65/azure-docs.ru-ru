---
title: Веб-активность на фабрике данных Azure
...
> [!NOTE]
> Веб-активность может вызывать только публично открытые URL-адреса. Он не поддерживается для URL-адресов, которые размещаются в частной виртуальной сети.
...
Ниже приведены поддерживаемые типы аутентификации в веб-активности.
...
> [!NOTE]
> Если фабрика данных настроена с репозиторием git, необходимо хранить учетные данные в Azure Key Vault, чтобы использовать базовую проверку подлинности сертификата клиента. Azure Data Factory не хранит пароли в git.
