...
* **Учетная запись хранения Azure.** В качестве _исходного_ хранилища используйте хранилище BLOB-объектов. Если у вас нет учетной записи хранения Azure, см. инструкции по [ее созданию](../storage/common/storage-account-create.md).
