...
- **Причина**. Основная причина проблемы в основном инициируется узким местом на стороне базы данных SQL Azure. Ниже приведены некоторые возможные причины.
    ...
    - Использование DTU базы данных SQL Azure близко к 100%. Вы можете [отслеживать производительность](../azure-sql/database/monitor-tune-overview.md) и обновлять уровень базы данных SQL Azure.
