...
&#42;Свойства `resourceLinkedService` и `folderPath` должен быть указаны либо не указаны одновременно.
