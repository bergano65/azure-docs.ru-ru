...
* Учетная запись хранения Azure с поддержкой Data Lake Storage 2-го поколения. Если у вас нет учетной записи хранения, щелкните [здесь](https://ms.portal.azure.com/#create/Microsoft.StorageAccount-ARM), чтобы создать ее.
