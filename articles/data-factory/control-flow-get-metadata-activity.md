...
description: Узнайте, как действие GetMetadata можно использовать в конвейере фабрики данных.
...
|:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |
| Amazon S3 | √/√ | √/√ | √ | x/x | √/√* | √ | п | √ | √ | √/√* |
| Google Cloud Storage; | √/√ | √/√ | √ | x/x | √/√* | √ | п | √ | √ | √/√* |
| BLOB-объект Azure | √/√ | √/√ | √ | x/x | √/√* | √ | √ | √ | √ | √/√ |
| Azure Data Lake Storage Gen1 | √/√ | √/√ | √ | x/x | √/√ | √ | п | √ | √ | √/√ |
| Azure Data Lake Storage Gen2 | √/√ | √/√ | √ | x/x | √/√ | √ | п | √ | √ | √/√ |
| Хранилище файлов Azure | √/√ | √/√ | √ | √/√ | √/√ | √ | п | √ | √ | √/√ |
| Файловая система | √/√ | √/√ | √ | √/√ | √/√ | √ | п | √ | √ | √/√ |
| SFTP | √/√ | √/√ | √ | x/x | √/√ | √ | п | √ | √ | √/√ |
| FTP | √/√ | √/√ | √ | x/x | √/√ | √ | п | √ | √ | √/√ |

- Для Amazon S3 и Google Sloud Storage `lastModified` применяется для контейнера и ключ, но не виртуальную папку; и `exists` применяется для контейнеров и ключ, но не префикс или виртуальной папки.
