...
| Соединитель и метаданные | itemName<br>(файл или папка) | itemType<br>(файл или папка) | размер;<br>(файл) | created<br>(файл или папка) | lastModified<br>(файл или папка) |childItems<br>(папка) |contentMD5<br>(файл) | structure<br/>(файл) | columnCount<br>(файл) | exists (существует)<br>(файл или папка) |
|:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |:--- |
...
| размер; | Размер файла в байтах. Применимо только к файлам. |
...
| exists (существует)| Существует ли файл, папка или таблица. Обратите внимание, что если `exists` в списке полей получить метаданные указано значение, действие не будет выполняться, даже если файл, папка или таблица не существуют. Вместо этого `exists: false` в выходных данных возвращается. |
