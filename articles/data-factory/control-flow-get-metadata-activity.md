...
- В Amazon S3 `lastModified` используется с контейнерами и ключами, но не с виртуальными папками, а `exists` — с контейнерами и ключами, но не с префиксами или виртуальными папками.
