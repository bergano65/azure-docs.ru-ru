...
- Копирование данных из таблицы SAP в **SAP Business Suite с 7.01 или более поздней версии** (в последних SAP поддержки пакета стопка выпущено после 2015 г.) или **S/4HANA**.
...
| rfcTableOptions                  | Параметры для фильтрации строк таблицы SAP. Например, `COLUMN0 EQ 'SOMEVALUE'`. | Нет       |
