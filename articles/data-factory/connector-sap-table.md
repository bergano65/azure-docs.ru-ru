---
title: Копирование данных из таблицы SAP с помощью фабрики данных Azure
...
|:--- |:--- |:--- |
| `type` | Для свойства `type` необходимо задать значение `SapTable`. | Да |
...
| Свойство | Description (Описание) | Обязательно |
|:--- |:--- |:--- |
| `type` | Для свойства `type` необходимо задать значение `SapTableResource`. | Да |
...
| Свойство                         | Description (Описание)                                                  | Обязательно |
| :------------------------------- | :----------------------------------------------------------- | :------- |
| `type`                             | Для свойства `type` необходимо задать значение `SapTableSource`.         | Да      |
