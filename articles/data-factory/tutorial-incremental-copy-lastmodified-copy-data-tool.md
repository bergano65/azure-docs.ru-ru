...
1. В области слева выберите **Создать ресурс**. Выберите **Integration**  >  **фабрику данных** интеграции:
...
5. На странице **целевое хранилище данных** выберите созданную службу **AzureBlobStorage** . Это та же учетная запись хранения, что и исходное хранилище данных. Затем нажмите кнопку **Далее**.
