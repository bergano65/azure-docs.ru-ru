---
title: Добавочное копирование новых и измененных файлов на основе LastModifiedDate с помощью средства Копирование данных | Документация Майкрософт
...
2. На странице **Свойства** выполните следующие действия.
    ...
    Г. Вразделе повторение введите **15 минут**. 
...
3. На странице **Исходное хранилище данных** сделайте следующее:
    ...
    1\. Выберите **+ создать новое соединение**, чтобы добавить подключение.
...
4. На странице **Choose the input file or folder** (Выбор входного файла или папки) выполните следующие действия:
    ...
    1\. Найдите и выберите **исходную** папку, а затем щелкните **выбрать**.
    ...
    2\. В разделе **поведение при загрузке файлов**выберите **добавочная загрузка: LastModifiedDate**.
...
6. На странице **Choose the output file or folder** (Выбор целевого файла или папки) выполните следующие действия:
    ...
    1\. Найдите и выберите папку **назначения** , а затем щелкните **выбрать**.
