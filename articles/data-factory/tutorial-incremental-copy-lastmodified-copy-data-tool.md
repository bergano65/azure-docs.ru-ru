...
3. На странице **Исходное хранилище данных** сделайте следующее:
    ...
    d. Выберите только что созданную связанную службу и нажмите кнопку **Далее**.
...
5. На странице **целевое хранилище данных** выберите **AzureBlobStorage**. Это та же учетная запись хранения, что и исходное хранилище данных. Выберите **Далее**.
