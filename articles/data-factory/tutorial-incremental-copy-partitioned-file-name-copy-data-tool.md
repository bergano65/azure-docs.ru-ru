---
title: Использование фабрики данных Azure для добавочного копирования новых файлов только в соответствии с временным секционированным именем файла | Документация Майкрософт
...
2. На странице **Свойства** выполните следующие действия.
    ...
    1\. В разделе **имя задачи**введите **делтакопифромблобпипелине**.

    2\. В разделе " **ритмичность задач" или "Расписание задач**" выберите **регулярное выполнение по расписанию**.

    В. В разделе **тип триггера**выберите **окно "переворачивающегося"** .
    
    Г. Вразделе повторение введите **1 час**. 
...
3. На странице **Исходное хранилище данных** сделайте следующее:
    ...
    1\. Щелкните **+ создать новое соединение**, чтобы добавить подключение.
    ...
    2\. Выберите **хранилище BLOB-объектов Azure** из коллекции и нажмите кнопку **продолжить**.
    ...
    Г. Выберите только что созданную связанную службу, а затем нажмите кнопку **Далее**. 
...
4. На странице **Choose the output file or folder** (Выбор файла или папки входных данных) выполните следующие действия.
    ...
    1\. Найдите и выберите **Исходный** контейнер, а затем нажмите **кнопку Выбрать**.
    ...
    2\. В разделе **поведение при загрузке файлов**выберите **добавочная загрузка: временная секционированная папка или имена файлов**.
    ...
    В. Запишите путь динамической папки в формате " **источник/{год}/{месяц}/{день}/{час}/** " и измените формат следующим образом:
    ...
    Г. Проверьте **двоичное копирование** и нажмите кнопку **Далее**.
...
6. На странице **Выбор выходного файла или папки** выполните следующие действия.
    ...
    1\. Найдите и выберите папку **назначения** , а затем нажмите кнопку **выбрать**.
    ...
    2\. Запишите путь динамической папки в формате " **источник/{год}/{месяц}/{день}/{час}/** " и измените формат следующим образом:
...
9. На **странице развертывания** выберите **Мониторинг**, чтобы отслеживать созданный конвейер (задачу).
    ![Страница "развертывание"](./media/tutorial-incremental-copy-partitioned-file-name-copy-data-tool/deployment-page.png)
