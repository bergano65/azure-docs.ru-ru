...
| Корневое расположение: контейнер | Имя контейнера папки CDM | да | Строковый тип | fileSystem |
| Корневое расположение: путь к папке | Расположение корневой папки папки CDM | да | Строковый тип | folderPath |
| Файл манифеста: путь сущности | Путь к папке сущности в корневой папке | нет | Строковый тип | entityPath |
...
| Контейнер ссылки на сущность | Контейнер совокупности находится в | Да, если использовать манифест и совокупности в ADLS 2-го поколения | Строковый тип | adlsgen2_fileSystem |
| Репозиторий ссылок на сущности | Имя репозитория GitHub | Да, если использовать манифест и совокупности в GitHub | Строковый тип | github_repository |
| Ветвь ссылки на сущность | Ветвь репозитория GitHub | Да, если использовать манифест и совокупности в GitHub | Строковый тип |  github_branch |
| Папка совокупности | корневое расположение совокупности | Да, при использовании манифеста | Строковый тип | корпуспас |
| Сущность совокупности | Путь к ссылке на сущность | да | Строковый тип | сущность |
...
| Контейнер ссылки на сущность | Контейнер совокупности находится в | Да, если совокупности в ADLS 2-го поколения | Строковый тип | adlsgen2_fileSystem |
| Репозиторий ссылок на сущности | Имя репозитория GitHub | Да, если совокупности в GitHub | Строковый тип | github_repository |
| Ветвь ссылки на сущность | Ветвь репозитория GitHub | Да, если совокупности в GitHub | Строковый тип |  github_branch |
| Папка совокупности | корневое расположение совокупности | да | Строковый тип | корпуспас |
| Сущность совокупности | Путь к ссылке на сущность | да | Строковый тип | сущность |
| Путь к секции | Расположение, в котором будет записана Секция | нет | Строковый тип | партитионпас |
...
| Разделитель столбцов | При записи в DelimitedText, как разделить столбцы | Да, при записи в DelimitedText | Строковый тип | columnDelimiter |
