...
- XML-атрибуты:
    ...
    - Атрибуты элемента анализируются как вложенные поля элемента в иерархии.
