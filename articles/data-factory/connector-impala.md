...
| enableSsl | Уточняется, шифруются ли соединения на сервер с помощью TLS. Значение по умолчанию — **false**.  | нет |
...
| allowHostNameCNMismatch | Уточняется, следует ли требовать, чтобы при подключении к TLS-TLS/SSL было названо сертификат TLS/SSL, выданное CA. Значение по умолчанию — **false**.  | нет |
