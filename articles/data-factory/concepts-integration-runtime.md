...
- Расположение Azure-SSIS IR не обязательно должно совпадать с расположением фабрики данных, но оно должно совпадать с расположением собственной базы данных SQL Azure или сервера Управляемый экземпляр, где будет размещен SSISDB. Это позволит среде выполнения интеграции Azure SSIS легко обращаться к базе данных SSIS, не генерируя лишний трафик между расположениями.
