...
- **Диспетчеризация действий**.  Назначение и мониторинг действий по преобразованию в разных службах вычислений, например Azure HDInsight, Машинное обучение Azure, База данных SQL Azure, SQL Server и др.
