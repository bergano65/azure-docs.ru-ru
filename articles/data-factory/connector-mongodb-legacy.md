---
title: Копирование данных из MongoDB с использованием устаревшего
...
Служба Azure Data Factory выведет схему из коллекции MongoDB, используя **последние 100 документов** в коллекции. Если эти 100 документов не содержат полной схемы, во время копирования некоторые столбцы могут игнорироваться.
