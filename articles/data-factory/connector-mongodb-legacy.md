...
Служба фабрики данных Azure выводит схему из коллекции MongoDB, используя **последние документы 100** в коллекции. Если эти 100 документов не содержат полной схемы, во время копирования некоторые столбцы могут игнорироваться.
...
| _№ | Имя клиента | Счета | Уровень обслуживания | Рейтинги |
| --- | --- | --- | --- | --- |
