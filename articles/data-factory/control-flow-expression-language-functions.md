...
|indexof|Поиск индекса значения в строке без учета регистра. Индекс отсчитывается от нуля. Например, следующее выражение возвращает `7`: `indexof('hello, world.', 'world')`.<br /><br /> **Номер параметра:** 1.<br /><br /> **Имя:** строка.<br /><br /> **Описание:** обязательно. Строка, которая может содержать значение.<br /><br /> **Номер параметра:** 2.<br /><br /> **Имя:** строка.<br /><br /> **Описание:** обязательно. Значение, для которого будет выполняться поиск индекса.|  
|lastindexof|Поиск последнего индекса значения в строке без учета регистра. Индекс отсчитывается от нуля. Например, следующее выражение возвращает `3`: `lastindexof('foofoo', 'foo')`.<br /><br /> **Номер параметра:** 1.<br /><br /> **Имя:** строка.<br /><br /> **Описание:** обязательно. Строка, которая может содержать значение.<br /><br /> **Номер параметра:** 2.<br /><br /> **Имя:** строка.<br /><br /> **Описание:** обязательно. Значение, для которого будет выполняться поиск индекса.|  
