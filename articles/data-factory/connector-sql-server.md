...
**Пример 2: использование проверки подлинности SQL с паролем в хранилище ключей Azure**
...
**Пример: использование SQL-запрос**
...
**Пример: с помощью хранимой процедуры**
...
Для копирования данных в базу данных SQL Server можно настроить и вызвать указанную пользователем хранимую процедуру с дополнительными параметрами.
