...
3. По умолчанию у вас есть конфигурация VS для выполнения пакетов в локальной среде с именем **Разработка** . Создание новой конфигурации VS для выполнения пакетов в облачной среде с именем **Azure** . Если вы еще не сделали этого, см. раздел [Создание новой конфигурации VS](/visualstudio/ide/how-to-create-and-edit-configurations?view=vs-2019).
