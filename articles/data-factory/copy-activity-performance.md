...
>[!NOTE]
> При использовании промежуточного копирования с включенным сжатием субъект-служба или проверка подлинности MSI для связанной с промежуточным большим двоичным объектом службы не поддерживается.
...
* **Скопируйте поведение и производительность неявно**: Существуют разные способы записи данных в приемник SQL, ознакомьтесь с дополнительными [рекомендация по загрузке данных в базе данных SQL Azure](connector-azure-sql-database.md#best-practice-for-loading-data-into-azure-sql-database).
