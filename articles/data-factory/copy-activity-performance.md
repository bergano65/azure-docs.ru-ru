...
> [!NOTE]
> В настоящее время количество единиц интеграции данных **свыше 4** поддерживается только при **копировании нескольких файлов из хранилища BLOB-объектов, Data Lake Storage, Amazon S3, облака FTP или облака SFTP в любые другие облачные хранилища данных**.
>
