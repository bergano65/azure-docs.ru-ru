...
* [Создание Azure-SSIS IR](./create-azure-ssis-integration-runtime.md)

* [Создание и Настройка локальной среды IR](./create-self-hosted-integration-runtime.md)
...
* [Присоединение Azure-SSIS Integration Runtime к виртуальной сети](./join-azure-ssis-integration-runtime-virtual-network.md)
...
* [Общие сведения о тегах служб, связанных с фабрикой данных Azure](./join-azure-ssis-integration-runtime-virtual-network.md)
...
* [Система управления версиями в фабрике данных Azure](./source-control.md)
...
* [Сведения о REST API для фабрики данных Azure](/rest/api/datafactory/)
...
* [Копирование и преобразование данных в базе данных SQL Azure с помощью фабрики данных Azure](./connector-azure-sql-database.md)

* [Настройка проверки подлинности Azure Active Directory и управление ею с помощью базы данных SQL Azure](../azure-sql/database/authentication-aad-configure.md)
...
* [Авторизация доступа к ресурсам концентраторов событий с помощью Azure Active Directory](../event-hubs/authorize-access-azure-active-directory.md)
...
* [Настройка и администрирование аутентификации Azure Active Directory с помощью SQL](../azure-sql/database/authentication-aad-configure.md?tabs=azure-powershell)

* [Включение аутентификации Azure Active Directory для среды выполнения интеграции Azure-SSIS](./enable-aad-authentication-azure-ssis-ir.md)
...
* [Общие сведения о частной ссылке](../private-link/private-endpoint-overview.md)
...
Для всех подключений к базе данных SQL Azure и Azure синапсе Analytics требуется шифрование (SSL/TLS), во время передачи данных в базу данных и из нее. Разрабатывая конвейер с помощью JSON, добавьте свойство "encryption" и в строке подключения задайте для него значение true. Для службы хранилища Azure вы можете использовать в строке подключения протокол HTTPS.

* [Общие сведения о шифровании при передаче в фабрике данных Azure](./data-movement-security-considerations.md)
...
* [Общие сведения о шифровании при хранении в фабрике данных Azure](./data-movement-security-considerations.md)
...
* [Использование секретов Azure Key Vault в действиях конвейера](./how-to-use-azure-key-vault-secrets-pipeline-activities.md)

* [Как Azure Key Vault учетные данные](./store-credentials-in-key-vault.md)
...
* [Как запустить оценку уязвимостей в базе данных SQL Azure](../azure-sql/database/sql-vulnerability-assessment.md)
...
* [Управление обновлениями и исправлениями для виртуальных машин Azure](../automation/update-management/manage-updates-for-vm.md)
...
* [Общие сведения об интегрированном сканере уязвимостей для виртуальных машин](../security-center/deploy-vulnerability-assessment-vm.md)
...
* [Встроенный сканер уязвимостей для виртуальных машин](../security-center/deploy-vulnerability-assessment-vm.md)
...
* [Что такое Брандмауэр Azure?](../firewall/overview.md)

* [Что такое брандмауэр веб-приложения Azure?](../web-application-firewall/overview.md)
...
* [Обратимое удаление в Azure Key Vault](../key-vault/general/soft-delete-overview.md)
...
* [Управляемое удостоверение для фабрики данных Azure](./data-factory-service-identity.md)
...
* [Обратимое удаление для виртуальных машин](../backup/backup-azure-security-feature-cloud.md)
