...
Если каталог служб SSIS размещен в базе данных SQL Azure с конечными точками службы виртуальной сети или Управляемый экземпляр в виртуальной сети, вы можете присоединить среду выполнения интеграции Azure SSIS к: 
