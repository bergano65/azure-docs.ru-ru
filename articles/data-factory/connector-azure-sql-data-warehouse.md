---
title: Копирование и преобразование данных в хранилище данных SQL Azure
description: Узнайте, как копировать данные в хранилище данных SQL Azure и из него, а затем преобразовывать данные в хранилище данных SQL Azure с помощью фабрики данных.
...
ms.locfileid: "74929635"
---
# <a name="copy-and-transform-data-in-azure-sql-data-warehouse-by-using-azure-data-factory"></a>Копирование и преобразование данных в хранилище данных SQL Azure с помощью фабрики данных Azure 
...
В этой статье описывается, как с помощью действия копирования в фабрике данных Azure копировать данные в хранилище данных SQL Azure и в него, а затем использовать поток данных для преобразования данных в Azure Data Lake Storage 2-го поколения. Дополнительные сведения о Фабрике данных Azure см. во [вводной статье](introduction.md).
...
Для действия копирования этот соединитель хранилища данных SQL Azure поддерживает следующие функции:
...
Для набора данных хранилища данных SQL Azure поддерживаются следующие свойства:
