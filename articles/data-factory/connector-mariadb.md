...
Этот соединитель MariaDB поддерживается для следующих действий:
...
Чтобы копировать данные из MariaDB, задайте для типа источника в действии копирования значение **MariaDBSource**. В разделе **источник** действия копирования поддерживаются следующие свойства.
