...
--------- | ----------- | -------------- | --------
timeout | Указывает время ожидания для выполнения действия. | Временной диапазон | № Время ожидания по умолчанию — 7 дней.
retry | Максимальное количество повторных попыток | Integer | № Значение по умолчанию — 0.
retryIntervalInSeconds | Задержка между повторными попытками (в секундах) | Integer | № Значение по умолчанию — 30 секунд
...
- [Создание конвейера с помощью действия преобразования данных](tutorial-transform-data-spark-powershell.md)
