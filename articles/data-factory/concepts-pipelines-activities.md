...
Тег | Description | Тип | Обязательно
--- | ----------- | ---- | --------
...
параллелизм | Максимальное количество параллельных запусков конвейера. По умолчанию максимальное значение отсутствует. Если достигнут предел параллелизма, дополнительные запуски конвейера будут поставлены в очередь до завершения предыдущих версий. | Number | нет 
...
Имя JSON | Description | Допустимые значения | Обязательно
--------- | ----------- | -------------- | --------
