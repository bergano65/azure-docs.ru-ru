...
Действие управления | Description (Описание)
---------------- | -----------
...
Тег | Description (Описание) | Тип | Обязательно
--- | ----------- | ---- | --------
...
Имя JSON | Description (Описание) | Допустимые значения | Обязательно
--------- | ----------- | -------------- | --------
