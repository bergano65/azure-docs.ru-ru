...
Тег | Описание | Type | Обязательный
--- | ----------- | ---- | --------
...
secureOutput | Если задано значение true, выходные данные действия считаются безопасными и не регистрируются для мониторинга. | логический | Нет. Значение по умолчанию — false.
