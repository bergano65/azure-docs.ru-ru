---
title: Преобразование данных с помощью действия Сохраненной Процедуры
...
| type                      | Для сохраненной процедуры тип действия **SqlServerStoredProcedure** | Да      |
| linkedServiceName         | Ссылка на **базу данных Azure S'L** или **хранилище данных Azure S'L** или **сервер S'L,** зарегистрированную в качестве связанной службы на фабрике данных. Дополнительные сведения об этой связанной службе см. в статье [Вычислительные среды, поддерживаемые фабрикой данных Azure](compute-linked-services.md). | Да      |
...
## <a name="parameter-data-type-mapping"></a>Отображение типа параметра
Тип данных, указанный для параметра, — это тип Фабрики данных Azure, который отображает тип данных в используемом источнике данных. Отображение типов данных для источника данных в области разъемов. Некоторые примеры
...
* [Деятельность U-S'L](transform-data-using-data-lake-analytics.md)
* [Активность улья](transform-data-using-hadoop-hive.md)
* [Действие Pig](transform-data-using-hadoop-pig.md)
* [КартаУменьшить активность](transform-data-using-hadoop-map-reduce.md)
* [Активность потоковой передачи Hadoop](transform-data-using-hadoop-streaming.md)
