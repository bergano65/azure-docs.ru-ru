...
Преобразование раковины требует либо одного ключа, либо серии ключей для уникальной идентификации строкви в вашей целевой базе данных. Для поглотителей S'L установите клавиши во вкладке настроек раковины. Для CosmosDB установите ключ перегородки в настройках, а также установите поле системы CosmosDB "id" в отображении раковины. Для CosmosDB обязательно включать в системную колонку "id" для обновлений, upserts и удаляет.
