...
-   **Отображение изменений**. В режиме Git вы получаете удобную комбинацию полезных данных, которые будут опубликованы в фабрике. Будут показаны все ресурсы или сущности, которые были изменены, добавлены или удалены с момента последней публикации в фабрике. Исходя из данных о различиях, можно либо продолжить процесс публикации, либо вернуться и проверить изменения и продолжить публикацию позже.
