...
Для файловой системы поддерживаются следующие свойства в разделе Параметры `storeSettings` в источнике копирования на основе формата:
...
Следующие свойства поддерживаются для файловой системы в параметрах `storeSettings` в приемнике копирования на основе формата:
