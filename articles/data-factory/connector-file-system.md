...
|:--- |:--- |:--- |
| Тип | Для свойства типа необходимо задать значение **FileServer**. | ДА |
...
Для файловой системы поддерживаются следующие свойства в параметрах `location` в наборе данных на основе формата:
...
Для файловой системы поддерживаются следующие свойства в параметрах `storeSettings` в источнике копирования на основе формата:
...
Следующие свойства поддерживаются для файловой системы в параметре `storeSettings` в приемнике копирования на основе формата:
