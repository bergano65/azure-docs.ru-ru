...
В этой статье описано, как копировать данные в файловую систему и из нее. Дополнительные сведения о Фабрике данных Azure см. во [вводной статье](introduction.md).

## <a name="supported-capabilities"></a>Поддерживаемые возможности

Этот соединитель файловой системы поддерживается для следующих действий:
...
Чтобы скопировать данные в файловую систему и из нее в **формате ORC**, поддерживаются следующие свойства:
...
Чтобы скопировать данные из файловой системы в **формате ORC**, в разделе **источник** действия копирования поддерживаются следующие свойства.
...
Чтобы скопировать данные в **Parquet, текст, JSON, Avro и двоичный формат**, см. статью [Формат Parquet](format-parquet.md), [текстовый формат с разделителями](format-delimited-text.md), [Формат Avro](format-avro.md) и [двоичный формат](format-binary.md) в приемнике действий копирования на основе формата и поддерживаемых Параметры. Следующие свойства поддерживаются для файловой системы в разделе `storeSettings` параметры в приемнике копирования на основе формата:
