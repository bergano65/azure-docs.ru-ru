...
- **Несовместимость между типом исходных данных и типом раковины native.** 
...
- **Несоответствие в количестве столбцов между источником и раковиной**.

    Пример. Выполняется копирование данных из CSV-файла в хранилище BLOB-объектов в базу данных SQL с использованием определения схемы, которое содержит шесть столбцов. Строки CSV-файла, которые содержат шесть столбцов, успешно копируются в хранилище приемника. Строки файлов CSV, содержащие более шести столбцов, обнаруживаются как несовместимые и пропущены.

- **Основное ключевое нарушение при записи в базу данных S'L Server/Azure S'L/Azure Cosmos DB.**
