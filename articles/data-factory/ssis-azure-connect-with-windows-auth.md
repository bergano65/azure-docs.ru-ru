---
title: Доступ к хранилищам данных и файлам с проверкой подлинности Windows
...
> [!WARNING]
> Если вы не используете ни один из вышеуказанных методов для доступа к хранилищам данных с аутентификацией Windows, ваши пакеты, зависят от проверки подлинности Windows, не смогут получить к ним доступ и выйти из строя во время выполнения. 
...
4. Запустите пакеты служб SSIS. Пакеты используют предоставленные учетные данные для доступа к хранилищам данных в помещениях с аутентификацией Windows.
...
3. Присоединитесь к ИК Azure-SSIS в виртуальной сети Microsoft Azure, которая подключена к серверу S'L В помещении.  Для получения дополнительной информации [см.](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network)
...
2. Присоединитесь к ИК Azure-SSIS в виртуальной сети Microsoft Azure, которая подключена к совместной файле в помещениях.  Для получения дополнительной информации [см.](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network)
