...
6. В новом окне службы Linked, введите "AzureStorageLinkedService" в качестве имени, выберите "Основной службы" из списка выпадающих методов проверки подлинности, заполните конечную точку службы, арендатора, основного идентификатора службы и основной ключ службы, а затем выберите Сохранить развернуть связанную службу.  Дополнительные сведения о настройке проверки подлинности субъекта-службы для хранилища BLOB-объектов Azure см. [здесь](connector-azure-blob-storage.md#service-principal-authentication).
