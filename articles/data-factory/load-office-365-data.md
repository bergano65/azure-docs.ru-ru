...
8. Теперь вернитесь на вкладку Источник **конвейера**,  >  **Source tab** чтобы продолжить настройку дополнительных свойств для извлечения данных Office 365.  Область пользователя и фильтр области пользователя — это необязательные предикаты, которые можно определить, чтобы ограничить данные, которые необходимо извлечь из Office 365. Сведения о настройке этих параметров см. в разделе [Свойства набора данных Office 365](https://docs.microsoft.com/azure/data-factory/connector-office-365#dataset-properties) .
