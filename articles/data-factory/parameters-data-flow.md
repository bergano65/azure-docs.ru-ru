...
Выражение параметра потока данных ![выражение]параметра(media/data-flow/parameter-expression.png "поток данных")
...
![Установка параметра потока данных](media/data-flow/parameter-assign.png "для параметра потока данных")
...
![](media/data-flow/parameter-example.png "Пример параметров") потока данных параметры потока
