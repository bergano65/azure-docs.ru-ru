...
>[!NOTE]
>Для копирования данных из базы данных Azure для службы [MyS'L](../mysql/overview.md) используйте специализированную [базу данных Azure для разъема MyS'L.](connector-azure-database-for-mysql.md)

## <a name="supported-capabilities"></a>Поддерживаемые возможности

Этот разъем MyS'L поддерживается для следующих действий:
...
|:--- |:--- |:--- |:--- |
| SSLMode | В этом варианте указывается, использует ли драйвер шифрование и проверку TLS при подключении к MyS'L. Например.`SSLMode=<0/1/2/3/4>`| DISABLED (0) / PREFERRED (1) **(по умолчанию)** / REQUIRED (2) / VERIFY_CA (3) / VERIFY_IDENTITY (4) | нет |
...
Полный список разделов и свойств, доступных [datasets](concepts-datasets-linked-services.md) для определения наборов данных, см. В этом разделе содержится список свойств, поддерживаемых набором данных MySQL.

Для копирования данных из MyS'L поддерживаются следующие свойства:

| Свойство | Описание | Обязательно |
|:--- |:--- |:--- |
| type | Свойство типа набора данных должно быть установлено: **MySqlTable** | Да |
...
Для копирования данных из MyS'L в разделе **источника активности** копирования поддерживаются следующие свойства:

| Свойство | Описание | Обязательно |
|:--- |:--- |:--- |
| type | Свойство типа источника активности копирования должно быть установлено: **MySqlSource** | Да |
