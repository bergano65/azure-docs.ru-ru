...
* **Azure Synapse Analytics.** Если у вас нет Azure Synapse Analytics, ознакомьтесь со сведениями о [создании экземпляра этой службы](../synapse-analytics/sql-data-warehouse/create-data-warehouse-portal.md).
...
1. Чтобы следить за выполнением отладки, перейдите на вкладку **Выходные данные** холста конвейера. Экран мониторинга будет автоматически обновляться каждые 20 секунд или после ручного нажатия кнопки обновления. У действия копирования есть специальное представление мониторинга. Чтобы получить к нему доступ, щелкните значок очков в колонке **Действия**.
...
1. В разделе **Описание** введите предложение, в котором описано содержимое общего ресурса данных. Общий ресурс данных будет содержать данные о поездках в международном масштабе, которые хранятся в ряде хранилищ, включая Azure Synapse Analytics и Azure Data Lake Store. 
...
1. Щелкните **Azure Synapse Analytics**, чтобы выбрать таблицу из Azure Synapse Analytics, в которую попали ваши преобразования из ADF.
