...
This error occurs when package execution can't find a file in the local disk in the SSIS integration runtime. Попробуйте выполнить следующие действия:
