...
1. Повторите эти шаги, чтобы создать выходной набор данных:  
   ...
   d. На вкладке **Подключение** выберите **AzureStorageLinkedService** в качестве связанной службы и введите для папки значение **adftutorial/output** в поле каталога. Если папка **output** отсутствует, действие копирования создаст ее во время выполнения.
