...
В этой статье описывается, что связано с службами, как они определяются в формате JSON и как они используются в конвейерах Azure Data Factory.
...
type | Тип связанной службы. Например: Хранилище данных Azure (хранилище данных) или AzureBatch (вычислить). См. описание typeProperties. | Да |
...
Ниже показана связанная служба хранилища Azure. Обратите внимание, что тип настроен на хранилище Azure. Свойства типов связанной службы хранилища Azure включают строку подключения. Фабрика данных использует эту строку подключения для соединения с хранилищем данных в среде выполнения.
