...
type | Тип связанной службы. Пример: служба хранилища Azure (хранилище данных) или AzureBatch (служба вычислений). См. описание typeProperties. | Да |
...
Ниже показана связанная служба хранилища Azure. Обратите внимание, что параметру type присвоено значение "Служба хранилища Azure". Свойства типов связанной службы хранилища Azure включают строку подключения. Фабрика данных использует эту строку подключения для соединения с хранилищем данных в среде выполнения.
