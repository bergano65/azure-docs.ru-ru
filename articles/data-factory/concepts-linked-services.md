...
type | Тип связанной службы. Например: служба хранилища Azure (хранилище данных) или AzureBatch (COMPUTE). См. описание typeProperties. | Да |
...
Ниже показана связанная служба хранилища Azure. Обратите внимание, что для типа задано значение хранилище Azure. Свойства типов связанной службы хранилища Azure включают строку подключения. Фабрика данных использует эту строку подключения для соединения с хранилищем данных в среде выполнения.
