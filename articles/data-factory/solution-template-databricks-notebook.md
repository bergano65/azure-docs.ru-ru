...
- **Записная книжка** активирует Блокнот, который преобразует набор данных. Он также добавляет набор данных в обработанную папку или хранилище данных SQL Azure.
