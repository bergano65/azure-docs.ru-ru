...
* **Потоковая передача журналов в Центры событий** для обработки в сторонней службе или пользовательском аналитическом решении, например в PowerBI.
...
* Куда будут отправляться журналы диагностики (учетная запись хранения, служба "Центры событий" и (или) Log Analytics).
