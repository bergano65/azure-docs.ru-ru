...
| Свойство | Тип | Description (Описание) |
| --- | --- | --- |
...
| Свойство | Тип | Description (Описание) | Пример |
| --- | --- | --- | --- |
...
|**category**| string | Категория журналов диагностики. Присвойте свойству значение `ActivityRuns`. | `ActivityRuns` |
|**уровню**| string | Уровень журналов диагностики. Присвойте свойству значение `Informational`. | `Informational` |
...
|**конце**| string | Время окончания действия выполняется в формате времени в формате UTC. Если в журнале диагностики указано, что действие началось, но еще не завершено, значение свойства равно `1601-01-01T00:00:00Z`. | `2017-06-26T20:55:29.5007959Z` |
...
|**resourceId**| string | Идентификатор, связанный с ресурсом фабрики данных. | `/SUBSCRIPTIONS/<subID>/RESOURCEGROUPS/<resourceGroupName>/PROVIDERS/MICROSOFT.DATAFACTORY/FACTORIES/<dataFactoryName>` |
|**category**| string | Категория журналов диагностики. Присвойте свойству значение `PipelineRuns`. | `PipelineRuns` |
|**уровню**| string | Уровень журналов диагностики. Присвойте свойству значение `Informational`. | `Informational` |
...
|**start**| string | Время начала действия выполняется в формате времени в формате UTC. | `2017-06-26T20:55:29.5007959Z`. |
|**конце**| string | Время окончания действия выполняется в формате времени в формате UTC. Если в журнале диагностики указано, что действие началось, но еще не завершено, значение свойства равно `1601-01-01T00:00:00Z`.  | `2017-06-26T20:55:29.5007959Z` |
|**состояние**| string | Конечное состояние выполнения конвейера. Возможные значения свойств — `Succeeded` и `Failed`. | `Succeeded`|
...
|**состояние**| string | Конечное состояние, показывающее, успешно ли вызван триггер. Возможные значения свойств — `Succeeded` и `Failed`. | `Succeeded`|
