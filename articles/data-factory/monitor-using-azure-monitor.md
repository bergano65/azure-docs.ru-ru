...
| **contextType**            | Строка | Тип объекта пакета в качестве источника контекста сообщения о событии      | `60`(см. [Дополнительные типы контекста](/sql/integration-services/system-views/catalog-event-message-context?view=sql-server-ver15#remarks)) |
...
| **messageType**            | Строка | Тип сообщения о событии                                     | `70`(см. [Дополнительные типы сообщений](/sql/integration-services/system-views/catalog-operation-messages-ssisdb-database?view=sql-server-ver15#remarks)) |
| **messageSourceType**      | Строка | Тип источника сообщения о событии                              | `20`(см. [Дополнительные типы источников сообщений](/sql/integration-services/system-views/catalog-operation-messages-ssisdb-database?view=sql-server-ver15#remarks)) |
