...
| --- | --- | --- | --- |
| **Level** |Строка | Уровень диагностических журналов. Для журналов, управляемых деятельностью, установите значение свойства до 4. | `4` |
| **Correlationid** |Строка | Уникальный идентификатор для отслеживания конкретного запроса. | `319dc6b4-f348-405e-b8d7-aafc77b73e77` |
| **time** | Строка | Время события в формате `YYYY-MM-DDTHH:MM:SS.00000Z`TIMEspan UTC . | `2017-06-28T21:00:27.3534352Z` |
...
| **Метрика**           | **Имя метрического дисплея**         | **Единица измерения** | **Тип агрегации** | **Описание**                                       |
|----------------------|---------------------------------|----------|----------------------|-------------------------------------------------------|
