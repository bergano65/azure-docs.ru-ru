...
Используйте [шаблоны столбцов](concepts-data-flow-column-pattern.md) для применения одной и той же статистической обработки к набору столбцов. Это полезно, если нужно сохранить много столбцов из входной схемы, так как они удаляются по умолчанию. Используйте эвристический подход, например, `first()` для сохранения входных столбцов с помощью статистической обработки.
