...
3.  Выберите алгоритм шифрования, используемый в Kerberos.
    ...
    Б. На панели **редактор "Управление групповыми политиками"** выберите **Конфигурация компьютера**  >  **политики**параметры  >  **Windows настройки**  >  **безопасности**  >  **Локальные политики**  >  **Параметры безопасности**, а затем настройте **безопасность сети: Настройка типов шифрования, разрешенных для Kerberos**.
...
4.  Создайте сопоставление между учетной записью домена и участником Kerberos, чтобы можно было использовать субъект Kerberos в домене Windows.
    ...
    Б. Настройте дополнительные функции, выбрав **Вид** > **Дополнительные параметры**.
