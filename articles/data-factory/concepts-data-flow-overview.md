...
ms.locfileid: "72030132"
---
# <a name="what-are-mapping-data-flows"></a>Что такое сопоставление потоков данных
...
![Оптимизировать](media/data-flow/optimize1.png "оптимизацию")
...
![Проверить](media/data-flow/inspect1.png "проверку")
