...
![Холст](media/data-flow/canvas1.png "Canvas")
...
![Холст](media/data-flow/canvas2.png "Canvas")
...
Если действия потока данных выполняются параллельно внутри конвейеров, рекомендуется не использовать TTL. Это связано с тем, что параллельное выполнение потоков данных, одновременно использующих один Azure Integration Runtime, приведет к созданию нескольких экземпляров горячего пула для фабрики данных.
...
#### <a name="inspect"></a>Инспектировать
...
![Обследован](media/data-flow/inspect1.png "Инспектировать")
