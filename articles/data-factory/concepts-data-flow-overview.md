...
![Новый поток данных](media/data-flow/new-data-flow.png "новый поток данных")
...
![На снимке экрана показан холст потока данных с верхней полосой, диаграммой и панелью конфигурации с меткой.](media/data-flow/canvas1.png "Холст")
...
![На снимке экрана показана часть графа холста с текстовым полем поиска.](media/data-flow/canvas2.png "Холст")
...
Сопоставление потоков данных доступно в следующих регионах:

| Регион Azure | Потоки данных в ADF | Потоки данных в синапсе Studio |
| ------------ | ----------------- | ---------------------------- |
