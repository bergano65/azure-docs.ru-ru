...
Создайте связанную службу **Машинного обучения Azure**, чтобы связывать веб-службы Машинного обучения Azure с фабрикой данных Azure. Связанная служба используется Машинное обучение Azure действием выполнения пакета и [действиями обновления ресурса](update-machine-learning-models.md).
