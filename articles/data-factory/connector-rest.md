...
| enableServerCertificateValidation | Следует ли проверять серверное сертификат TLS/SSL при подключении к конечной точке. | нет<br /> (по умолчанию **это правда)** |
