...
| enableServerCertificateValidation | Следует ли проверять серверное сертификат TLS/SSL при подключении к конечной точке. | нет<br /> (значение по умолчанию **true**) |
