...
| requestInterval | Интервал времени между различными запросами в милисеконд. Значение интервала запроса должно быть числом в диапазоне от [10 до 60000]. |  нет |
...
>[!NOTE]
>Соединитель RESTFUL в качестве приемника работает с конечными точками RESTFUL, принимающими JSON. Данные будут отправлены только в JSON.
