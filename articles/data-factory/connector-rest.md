...
* абсолютный URL-адрес следующего запроса = значение свойства в текущем тексте ответа;
* абсолютный URL-адрес следующего запроса = значение заголовка в текущих заголовках ответа;
...
| Ключ | ОПИСАНИЕ |
|:--- |:--- |
| AbsoluteUrl | Указывает URL-адрес для выполнения следующего запроса. |
