---
title: Копирование данных от salesforce и в Salesforce
...
Этот разъем Salesforce поддерживается для следующих действий:
