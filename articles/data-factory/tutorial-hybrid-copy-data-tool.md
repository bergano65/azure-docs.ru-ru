...
1. В диалоговом окне **Integration Runtime Setup** (Настройка среды выполнения интеграции) выберите **Self-Hosted** (Локальная). Затем нажмите кнопку **Далее**. 
...
1. В диалоговом окне **Целевое хранилище данных** выберите вариант **Хранилище BLOB-объектов Azure**. Затем нажмите кнопку **Далее**. 
