...
| Activity Type | Тип действия, например **Copy**, **HDInsightSpark**или **HDInsightHive** |
...
| Output | Массив JSON, описывающий выходные данные действия |
| Ошибка | Ошибка выполнения действия (при наличии) |
...
| **Имя столбца** | **Описание** |
| --- | --- |
| Pipeline Name | Имя конвейера. К параметрам относятся быстрые фильтры за **последние 24 часа**, за **последнюю неделю**и за **последние 30 дней**. Или выберите настраиваемую дату и время. |
...
Вы можете создавать оповещения на основе поддерживаемых метрик фабрики данных. Выберите **мониторинг** > **оповещения & метрик** на странице мониторинга фабрики данных, чтобы приступить к работе.
