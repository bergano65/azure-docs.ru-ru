...
| Сообщение о состоянии | Сбой (Failed), Успешно (Succeeded), Выполняется (In Progress) |
| Параметры | Параметры запуска конвейера (пары "имя — значение") |
| Error | Ошибки выполнения конвейера (если есть) |
...
| Error | Ошибки выполнения действия (если есть) |
...
![Диаграмма Ганта](media/monitor-visually/gantt1.png)

![Заметки диаграммы Ганта](media/monitor-visually/gantt2.png)

Длина строки информирует время конвейера. Можно также щелкнуть строку, чтобы просмотреть дополнительные сведения.
