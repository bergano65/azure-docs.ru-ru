---
title: Визуальный мониторинг фабрик данных Azure
...
| Состояние | **Не выполнено**, **успешно**или **выполняется** |
...
| Run Status | Выполнение фильтра по состоянию: **выполнено**, **не выполнено**или **выполняется**. |
