...
1. Чтобы просмотреть сведения о выполнении действий, связанных с выполнением конвейера, выберите ссылку в столбце **Имя конвейера**. Чтобы просмотреть сведения о выполнениях действий, щелкните ссылку **Сведения** (значок очков) в столбце **Имя действия**. 
