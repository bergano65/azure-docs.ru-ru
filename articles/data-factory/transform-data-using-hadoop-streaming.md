...
| модуль сопоставления            | Указывает имя исполняемого файла средства сопоставления. | Да      |
...
| ввод             | Указывает путь WASB к входному файлу для средства сопоставления. | Да      |
| вывод            | Указывает путь WASB к выходному файлу для средства приведения. | Да      |
