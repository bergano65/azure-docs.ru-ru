...
Наиболее эффективный способ обнаружения новых или измененных файлов из AWS S3 заключается в использовании соглашения об именовании с разделением по времени. когда данные в AWS S3 были секционированы с данными временных срезов в имени файла или папки (например,/ИИИИ/мм/дд/филе.КСВ), конвейер может легко найти файлы и папки для копирования. 
