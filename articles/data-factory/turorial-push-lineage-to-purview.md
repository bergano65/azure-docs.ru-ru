---
title: Отправка данных журнала преобразований в фабрике данных в Azure зрения
...
* **Учетная запись Azure зрения**. Учетная запись зрения фиксирует все данные журнала обращений и преобразований, созданные фабрикой данных. Если у вас нет учетной записи Azure зрения, см. статью [Создание зрения Azure](https://docs.microsoft.com/azure/purview/create-catalog-portal).
