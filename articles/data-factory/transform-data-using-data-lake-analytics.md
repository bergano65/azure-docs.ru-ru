...
| **Подписки**       | Идентификатор подписки Azure.                    | Нет                                       |
...
В приведенном выше примере сценария входные и выходные данные скрипта определяются в параметрах ** \@in** и ** \@out** . Значения параметров ** \@in** и ** \@out** в скрипте U-SQL динамически передаются фабрикой данных с помощью раздела Parameters. 
