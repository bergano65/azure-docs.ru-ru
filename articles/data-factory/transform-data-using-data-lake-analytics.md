...
В приведенном выше примере входные и выходные данные в скрипт определяется в  **\@в** и  **\@out** параметров. Значения для  **\@в** и  **\@out** параметры в скрипте U-SQL передаются динамически с помощью фабрики данных с помощью раздела «параметры». 
