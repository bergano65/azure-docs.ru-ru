---
title: Преобразование данных с помощью сценария U-S'L
...
| **ресурсGroupName**    | Имя группы ресурсов Azure                | нет                                       |
...
В приведенном выше примере сценария вход и выход скрипта определяются ** \@в** параметрах в параметрах и ** \@из-за** нее. Значения ** \@параметров в** и ** \@из** них в скрипте U-S'L динамически передаются Data Factory с помощью раздела «параметры». 
