...
| ---------------- | --------------- | -------- | ------------------ | ------------ |
| **область** | Идентификатор ресурса Azure Resource Manager учетной записи хранения. | String | Идентификатор Azure Resource Manager | Да |
...
| **игноримптиблобс** | Указывает, будут ли большие двоичные объекты с нулевым байтами инициировать запуск конвейера. По умолчанию задано значение true. | Логическое | true или false | Нет |
