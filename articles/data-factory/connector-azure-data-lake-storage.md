...
>[!IMPORTANT]
>При использовании PolyBase для загрузки данных из ADLS Gen2 в хранилище данных SQL, при использовании ADLS Gen2 управляемых удостоверений проверки подлинности, убедитесь, что можно также настроить хранилище данных SQL, соответствующим образом, чтобы использовать MSI для хранения ADLS Gen2, выполните шаги с #1 для #3.b в [в этом руководстве](../sql-database/sql-database-vnet-service-endpoint-rule-overview.md#impact-of-using-vnet-service-endpoints-with-azure-storage). Если ваш Gen2 ADLS настроен с конечной точкой службы виртуальной сети, использовать PolyBase для загрузки данных из нее, необходимо использовать управляемое удостоверение проверки подлинности.
