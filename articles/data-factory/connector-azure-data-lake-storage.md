...
>[!NOTE]
>При использовании Polybase для загрузки данных в Azure синапсе Analytics (ранее — хранилище данных SQL), если в исходной Data Lake Storage 2-го поколения настроена конечная точка виртуальной сети, необходимо использовать управляемую идентификацию аутентификации в соответствии с требованиями Polybase. Дополнительные предварительные требования к конфигурации см. в разделе [Проверка подлинности с использованием управляемого удостоверения](#managed-identity).
