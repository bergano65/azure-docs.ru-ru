...
>[!NOTE]
>Список папок, начиная с уровня учетной записи, необходимо задать разрешения для субъекта-службы, которое предоставляется **учетной записи хранения с разрешением «Execute»** либо иметь разрешение на IAM. Это работает, если вы используете:
...
>[!NOTE]
>Список папок, начиная с уровня учетной записи, необходимо задать разрешения управляемое удостоверение, которое предоставляется **учетной записи хранения с разрешением «Execute»** либо иметь разрешение на IAM. Это работает, если вы используете:
>- **средство копирования данных** для разработки конвейера копирования;
>- **пользовательский интерфейс фабрики данных** для проверки подключения и перемещения по папкам во время разработки. 
