...
Чтобы скопировать данные в Data Lake Storage 2-го поколения и из них в **формате ORC/Avro/JSON**, поддерживаются следующие свойства:
...
Чтобы скопировать данные из Data Lake Storage 2-го поколения в **формате ORC/Avro/JSON**, в разделе **источник** действия копирования поддерживаются следующие свойства.
...
Чтобы скопировать данные в Data Lake Storage 2-го поколения в **формате ORC/Avro/JSON**, в разделе приемника поддерживаются следующие свойства:
