...
> [!NOTE]
> Используется в этих примерах ниже цены являются гипотетическими и не предназначены для подразумевают фактических цен.
...
## <a name="using-mapping-data-flow-debug-for-a-normal-workday-preview-pricing"></a>С помощью сопоставления данных потока отладки для обычного рабочего дня (цены на предварительную версию)
...
## <a name="transform-data-in-blob-store-with-mapping-data-flows-preview-pricing"></a>Преобразование данных в хранилище больших двоичных объектов с помощью сопоставления потоков данных (цены на предварительную версию)
