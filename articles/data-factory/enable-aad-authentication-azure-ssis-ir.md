...
10.  Если база данных SSISDB была создана с использованием аутентификации SQL и вы хотите переключиться на использование аутентификации Azure AD для доступа к этой базе данных из Azure-SSIS IR, щелкните базу данных **SSISDB** правой кнопкой мыши и выберите  **Новый запрос**.

11.  В окне запроса введите следующую команду T-SQL и щелкните  **Выполнить**  на панели инструментов:
...
8.  Если база данных SSISDB была создана с использованием аутентификации SQL и вы хотите переключиться на использование аутентификации Azure AD для доступа к этой базе данных из Azure-SSIS IR, щелкните базу данных **SSISDB** правой кнопкой мыши и выберите  **Новый запрос**.

9.  В окне запроса введите следующую команду T-SQL и щелкните  **Выполнить**  на панели инструментов:
