...
* При использовании постановки во время гибридной копии, которая копирует данные из собственного хранилища данных в хранилище облачных данных, на одном этапе, уполномоченном самоходной интеграционной периодом выполнения, с вас взимается плата за «гибридную продолжительность копирования» x «гибридная цена копий» х «цена единицы облачной копии».
