...
Чтобы использовать эту функцию, [Скачайте](https://docs.microsoft.com/sql/ssms/download-sql-server-management-studio-ssms?view=sql-server-2017) и установите последнюю версию SQL Server Management Studio (SSMS). Сведения о поддержке версий приведены ниже:
