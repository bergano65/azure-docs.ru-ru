---
title: Преобразование окна потока данных сопоставления фабрики данных Azure
...
![Параметры окна](media/data-flow/windows1.png "Windows 1")
...
![Параметры окна](media/data-flow/windows4.png "Windows 4")
...
![Параметры окна](media/data-flow/windows5.png "Windows 5")
...
![Параметры окна](media/data-flow/windows6.png "Windows 6")
...
![Параметры окна](media/data-flow/windows7.png "Windows 7")
