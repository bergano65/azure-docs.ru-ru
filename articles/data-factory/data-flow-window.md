---
title: Картирование преобразования потока данных в окно
description: Преобразование потока данных Azure Data Factory отображение
author: kromerm
ms.author: makromer
...
ms.locfileid: "81416489"
---
# <a name="azure-data-factory-window-transformation"></a>Преобразование оконной фабрики лазурных данных
...
![Параметры окна](media/data-flow/windows1.png "окна 1")
...
![Параметры окна](media/data-flow/windows4.png "окна 4")
...
![Параметры окна](media/data-flow/windows5.png "окна 5")
...
![Параметры окна](media/data-flow/windows6.png "окна 6")

## <a name="window-columns"></a>Оконные столбцы
...
![Параметры окна](media/data-flow/windows7.png "окна 7")
...
Если вы ищете простую групповую агрегацию, используйте [преобразование Агрегированных](data-flow-aggregate.md)
