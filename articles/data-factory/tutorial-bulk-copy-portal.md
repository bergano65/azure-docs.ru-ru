...
1. Перейдите на вкладку **Подключение**. 
    ...
    а. Для **таблицы** выберите параметр **Изменить**, щелкните поле ввода имени таблицы, а затем щелкните ссылку **Добавить динамическое содержимое** ниже. 
