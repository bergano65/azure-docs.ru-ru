...
1. Если у вас нет рабочей области Azure Synapse Analytics (ранее — Хранилище данных SQL), создайте ее по инструкциям из статьи [Начало работы с Azure Synapse Analytics](..\synapse-analytics\get-started.md).
