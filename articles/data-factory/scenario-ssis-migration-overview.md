...
Это также практичный способ использования [средств DevOps служб SSIS](https://docs.microsoft.com/sql/integration-services/devops/ssis-devops-overview)для повторного развертывания пакетного пакета в назначении миграции.  
...
- [Помощник по переносу баз данных](https://docs.microsoft.com/sql/dma/dma-overview)
- [Перемещение рабочих нагрузок служб SSIS в облако](https://docs.microsoft.com/sql/integration-services/lift-shift/ssis-azure-lift-shift-ssis-packages-overview)
- [Инструменты DevOps Integration Services](https://docs.microsoft.com/sql/integration-services/devops/ssis-devops-overview)
...
- [Использовать аутентификацию управляемого удостоверения](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-storage-connection-manager#managed-identities-for-azure-resources-authentication)
