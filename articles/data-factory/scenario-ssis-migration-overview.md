...
|-|-|-|
|SSISDB|[Перенос **SSISDB**](scenario-ssis-migration-ssisdb-mi.md)|[Миграция заданий служб SSIS в агент Azure SQL Управляемый экземпляр](scenario-ssis-migration-ssisdb-mi.md#ssis-jobs-to-sql-managed-instance-agent)|
