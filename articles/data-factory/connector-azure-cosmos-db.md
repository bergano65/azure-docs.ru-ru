...
|:--- |:--- |:--- |
| Тип | Для свойства **type** необходимо задать значение: **CosmosDb**. | ДА |
...
| Свойство | Описание | Обязательно для заполнения |
|:--- |:--- |:--- |
| Тип | Свойство **Type** набора данных должно иметь значение **космосдбсклапиколлектион**. |ДА |
...
| Свойство | Описание | Обязательно для заполнения |
|:--- |:--- |:--- |
| Тип | Свойство **Type** источника действия копирования должно иметь значение **космосдбсклаписаурце**. |ДА |
...
| Свойство | Описание | Обязательно для заполнения |
|:--- |:--- |:--- |
| Тип | Свойство **Type** приемника действия копирования должно иметь значение **космосдбсклаписинк**. |ДА |
