...
> [!NOTE]
> При копировании данных из SQL Server или базы данных SQL Azure в Azure синапсе Analytics (ранее — хранилище данных SQL), если таблица не существует в целевом хранилище, Копирование данных средство поддерживает автоматическое создание таблицы с помощью исходной схемы. 
