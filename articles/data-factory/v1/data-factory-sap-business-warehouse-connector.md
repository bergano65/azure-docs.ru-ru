...
- Проще всего создать конвейер с помощью **мастера копирования**. Пошаговые инструкции см. в [руководстве по созданию конвейера с помощью мастера копирования данных](data-factory-copy-data-wizard-tutorial.md). 
