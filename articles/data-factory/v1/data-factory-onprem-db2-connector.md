...
| **имен** |Имя для учетной записи пользователя, если используемая аутентификация имеет тип "Обычная" или "Windows". |Нет |
...
Раздел **typeProperties** отличается для каждого типа набора данных и предоставляет сведения о расположении данных в хранилище данных. Раздел **typeProperties** набора данных с типом **RelationalTable**, который включает набор данных DB2, имеет следующее свойство:
...
Сначала установите и настройте шлюз данных. Инструкции приведены в статье [Перемещение данных между локальными расположениями и облаком](data-factory-move-data-between-onprem-and-cloud.md) .
...
| Тип базы данных DB2 | Тип платформы .NET Framework |
| --- | --- |
| SmallInt |Int16 |
| Целое число |Int32 |
| BigInt |Int64 |
