...
**Пример. использование обычной, дайджест-или проверки подлинности Windows**
...
Данные записываются в новый большой двоичный объект каждый час (**Частота**: **час**, **интервал**: **1**).
