...
| пароль | Пароль, связанный с сертификатом. | Нет |
...
| requestMethod | HTTP-метод. Допустимые значения: **GET** и **POST**. | Нет <br />(значение по умолчанию — **GET**) |
