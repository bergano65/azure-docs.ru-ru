...
1. Вставьте следующий фрагмент в окно Draft-1. В редакторе JSON выполните следующие действия.
    ...
    В. Укажите пароль для пользователя.
...
1. Замените скрипт в окне Draft-1 следующим скриптом:
    ...
    1\. Свойству **type** присваивается значение **HDInsightSpark**.
    ...
    В. Свойству **entryFilePath** присваивается значение **test.py**, которое является файлом Python.
...
| Path | Описание | Обязательное значение | Type |
| ---- | ----------- | -------- | ---- |
