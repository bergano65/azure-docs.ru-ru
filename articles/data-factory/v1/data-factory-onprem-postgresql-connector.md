---
title: Перемещение данных с PostgreS'L с помощью фабрики данных Azure
...
- Для создания конвейера можно использовать указанные ниже средства.
  ...
  - REST API
    ...
    См, обучаемый [по деятельности Copy,](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md) для пошаговых инструкций по созданию конвейера с копированием.
...
Как уже упоминалось в статье [о движении данных,](data-factory-data-movement-activities.md) деятельность Copy выполняет автоматические преобразования типов из типов источников в типы раковин со следующим 2-ступенчатым подходом:
