...
* **Простота настройки**: 5-шаговый интуитивно понятный мастер без необходимости создавать сценарии.
...
В этом разделе описываются действия по настройке источника — BLOB-объекта Azure, содержащего файлы с элементами строк TPC-H размером 1 ТБ.
