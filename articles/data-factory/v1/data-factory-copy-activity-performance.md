...
| Свойство | Description | Значение по умолчанию | Обязательно для заполнения |
| --- | --- | --- | --- |
| **enableStaging** |Укажите, следует ли копировать данные в промежуточное хранилище. |Нет |Нет |
