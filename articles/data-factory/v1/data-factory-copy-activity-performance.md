...
* Загрузка данных в **Azure синапсе Analytics** с частотой **1,2 Гбит/** с. Пошаговое руководство с вариантом использования см. в статье [Загрузка 1 ТБ в Azure синапсе Analytics (ранее — хранилище данных SQL) в течение 15 минут с фабрикой данных Azure](data-factory-load-sql-data-warehouse.md).
