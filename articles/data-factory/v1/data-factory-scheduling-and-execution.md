...
| anchorDateTime |Определяет момент времени, на основе которого планировщик вычисляет границы среза набора данных. <br/><br/><b>Примечание</b>. Если параметр AnchorDateTime содержит элементы с большей степенью детализации, чем значение параметра frequency, эти элементы игнорируются. <br/><br/>Например, если <b>интервал</b> — <b>каждый час</b> (frequency: Hour, interval: 1), а <b>AnchorDateTime</b> содержит <b>минуты и секунды</b>, то элементы <b>минуты и секунды</b> параметра AnchorDateTime не учитываются. |Нет |01/01/0001 |
...
Каждый день в папке создается один выходной файл за целый день. Для выходных данных устанавливается **ежедневная** доступность (frequency: Day и interval: 1).
...
**Входные данные 1: большой двоичный объект Azure**
...
**Входные данные 2: большой двоичный объект Azure**
...
**Выходные данные: большой двоичный объект Azure**
