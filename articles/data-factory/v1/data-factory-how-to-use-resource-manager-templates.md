...
Рассмотрим ситуацию, когда организация имеет 10 производственных фабрик по всему миру. Журналы каждой фабрики хранятся в отдельной локальной базе данных SQL Server. Компания хочет создать одно хранилище данных в облаке для ad-hoc-аналитики. Требуется также использовать одну логику и разные конфигурации для сред разработки, тестирования и рабочих сред.
