...
Мастер изначально предполагает работу с большими данными. С помощью мастера копирования данных можно быстро и просто создавать конвейеры фабрики данных для перемещения сотен папок, файлов или таблиц. Мастер поддерживает три функции: автоматический предварительный просмотр данных, сбор и сопоставление схем, а также фильтрацию данных. 
