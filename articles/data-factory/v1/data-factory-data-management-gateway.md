...
2. Запустите исполняемый файл **ConfigManager.exe** в папке: **C:\Program Files\Microsoft Data Management Gateway\2.0\Shared**
...
Статус | Состояние логического шлюза и узлов шлюза, Пример: "В сети", "Автономно", "Ограничено" и т. д. Сведения об этих состояниях см. в разделе [Состояние шлюза](#gateway-status).
