...
description: В этой статье объясняется, как горизонтально увеличить масштаб шлюза управления данными, добавив дополнительные узлы, и вертикально увеличить масштаб шлюза, увеличив число одновременных заданий, которые могут выполняться на одном узле.
