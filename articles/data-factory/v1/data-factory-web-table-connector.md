---
title: Перемещение данных из веб-таблицы с помощью фабрики данных Azure
...
Раздел **typeProperties** отличается для каждого типа набора данных и предоставляет информацию о местоположении данных в хранилище данных. Раздел typeProperties набора данных типа **WebTable** содержит следующие свойства.
...
| индекс |Индекс таблицы в ресурсе. Смотрите [Получить индекс таблицы в](#get-index-of-a-table-in-an-html-page) разделе страницы HTML для шагов к получению индекса таблицы на странице HTML. |Да |
...
> [!NOTE]
> Смотрите [Получить индекс таблицы в](#get-index-of-a-table-in-an-html-page) разделе страницы HTML для шагов к получению индекса таблицы на странице HTML.  
>
>
...
Список свойств, поддерживаемых WebSource, см. в разделе "Свойства типа WebSource".
