---
title: Преобразование данных с помощью сценария U-S'L - Azure
...
| **ресурсGroupName** |Имя группы ресурсов Azure |Нет (если не указано, используется группа ресурсов фабрики данных). |
...
Значения ** \@параметров в** и ** \@из** них в скрипте U-S'L передаются динамически ADF с помощью раздела «параметры». См. раздел parameters в определении конвейера.
