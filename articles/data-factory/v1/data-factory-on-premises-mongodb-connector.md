...
| --- | --- | --- |
| тип |Для свойства type необходимо задать значение **OnPremisesMongoDb** |Да |
...
| Дата |Дата и время |
| NumberDouble |С двойной точностью |
| NumberInt |Int32 |
| NumberLong |Int64 |
| ObjectID |String |
| String |String |
...
| _id | Имя клиента | Счета | Уровень обслуживания | Оценки |
| --- | --- | --- | --- | --- |
...
| _id | Имя клиента | Уровень обслуживания |
| --- | --- | --- |
| 1111 |ABC |Серебряная |
| 2222 |XYZ |Золотой |
...
| _id | ExampleTable_Invoices_dim1_idx | счет_№ | item | цена | Скидка |
| --- | --- | --- | --- | --- | --- |
