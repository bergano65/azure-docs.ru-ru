...
- Можно добавить записи DNS, чтобы разрешить служебную шину, а не разрешить все IP-адреса Azure в брандмауэре (при необходимости). Соответствующую запись DNS можно найти на портал Azure (фабрика данных-> "Создание и развертывание"-> "шлюзы"-> "Сервицеурлс" (в JSON)
...
*  Возможность "Обновить сейчас" от клиента
