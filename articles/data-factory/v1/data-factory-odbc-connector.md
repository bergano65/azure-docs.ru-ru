...
| --- | --- | --- |
| Тип |Для свойства type необходимо задать значение **OnPremisesOdbc** |ДА |
...
| пароль |Укажите пароль для учетной записи пользователя, указанной для имени пользователя. |Нет |
...
Учетные данные можно зашифровать с помощью командлета [New-аздатафакторенкриптвалуе](https://docs.microsoft.com/powershell/module/az.datafactory/new-azdatafactoryencryptvalue) (1,0 версии Azure PowerShell) или [New-азуредатафакторенкриптвалуе](https://msdn.microsoft.com/library/dn834940.aspx) (0,9 или более ранней версии Azure PowerShell).
