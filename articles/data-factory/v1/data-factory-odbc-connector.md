...
| --- | --- | --- |
| Тип |Свойству type необходимо задать значение **OnPremisesOdbc** |Yes |
...
| authenticationType |Тип проверки подлинности, используемый для подключения к хранилищу данных ODBC. Возможные значения: Anonymous (анонимная) и Basic (обычная). |Yes |
