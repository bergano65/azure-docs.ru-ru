...
С помощью действия "Хранимая процедура SQL Server" в конвейере Фабрики данных можно вызвать хранимую процедуру в одном из таких хранилищ данных: База данных Azure SQL, Хранилище данных SQL Azure, база данных SQL Server в вашей организации или на виртуальной машине Azure. Дополнительные сведения см. в разделе [Действие хранимой процедуры](data-factory-stored-proc-activity.md).  
