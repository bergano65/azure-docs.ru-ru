...
| [Вызов заданий Spark в кластере HDInsight Hadoop](../tutorial-transform-data-spark-portal.md) |В этом примере показано, как использовать действие MapReduce для запуска программы Spark. Программа Spark просто копирует данные из одного контейнера BLOB-объектов Azure в другой. |
...
4. Задайте параметры конфигурации для этого примера. Например, имя учетной записи хранения Azure и ключ учетной записи, имя логического сервера SQL Server, база данных, идентификатор пользователя и т. д.
