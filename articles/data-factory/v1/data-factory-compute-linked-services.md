...
| [Аналитика озер данных Azure](#azure-data-lake-analytics-linked-service) | [Аналитика озера данных U-SQL](data-factory-usql-activity.md) |
...
Корпорация Майкрософт обновляет список поддерживаемых версий HDInsight, предоставляя новейшие компоненты и исправления для экосистемы Hadoop. Для получения подробной информации [см.](../../hdinsight/hdinsight-component-versioning.md#supported-hdinsight-versions)
