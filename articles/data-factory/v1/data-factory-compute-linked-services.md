...
Для свойства **AccountName** добавьте **. \<region name\> ** в имя учетной записи пакетной службы. Вот несколько примеров:

```json
"accountName": "mybatchaccount.eastus"
```

Кроме того, можно указать конечную точку **batchUri**. Вот несколько примеров:
