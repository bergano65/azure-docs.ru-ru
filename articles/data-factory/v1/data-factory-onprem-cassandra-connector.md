...
Соединитель Cassandra поддерживает следующие версии Cassandra 2.х и 3.х. Если действие выполняется в локальной среде IR, поддержка Cassandra начинается с версии 3.7.
...
| --- | --- | --- |
| Тип |Для свойства type необходимо задать значение **OnPremisesCassandra** |ДА |
...
| pk_int | Value | Получение списков | Сопоставление | StringSet |
| --- | --- | --- | --- | --- |
