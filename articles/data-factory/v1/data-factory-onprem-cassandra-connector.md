...
Первая виртуальная таблица — это базовая таблица с именем «ExampleTable», приведенная в следующей таблице. В этой таблице содержатся те же данные, что и в исходной, но без коллекций. Они развернуты в других виртуальных таблицах.
