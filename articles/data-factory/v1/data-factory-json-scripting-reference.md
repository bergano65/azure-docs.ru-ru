...
| [База данных Azure SQL](#azure-sql-database), [хранилище данных Azure SQL](#azure-sql-data-warehouse), [SQL Server](#sql-server-stored-procedure) |[Хранимая процедура](#stored-procedure-activity) |
...
| Свойство. | Описание | Обязательное значение |
| --- | --- | --- |
| storedProcedureName |Укажите имя хранимой процедуры в базе данных SQL Azure или хранилище данных SQL Azure, представленное связанной службой, которую использует выходная таблица. |Да |
