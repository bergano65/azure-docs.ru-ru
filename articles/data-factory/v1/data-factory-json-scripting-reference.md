...
| encryptedCredential |[New-аздатафакторенкриптвалуе](https://docs.microsoft.com/powershell/module/az.datafactory/new-azdatafactoryencryptvalue) выходные данные учетных данных доступа. |Нет |
...
Учетные данные можно зашифровать с помощью командлета [New-аздатафакторенкриптвалуе](https://docs.microsoft.com/powershell/module/az.datafactory/new-azdatafactoryencryptvalue) .
...
[Действие выполнения пакета Машинное обучение Azure Studio (классическая модель)](#azure-machine-learning-studio-classic-batch-execution-activity) | Фабрика данных Azure позволяет легко создавать конвейеры, в которых для прогнозной аналитики используется опубликованная веб-служба Studio (классическая модель). С помощью действия выполнения пакета в конвейере фабрики данных Azure можно вызвать веб-службу Studio (классическая) для выполнения прогнозов по данным в пакетной службе.
[Действие "обновить ресурс" Машинное обучение Azure Studio (классическая модель)](#azure-machine-learning-studio-classic-update-resource-activity) | Со временем прогнозные модели в экспериментах оценки Машинное обучение Azure Studio (классическая модель) необходимо переучить с помощью новых входных наборов данных. После завершения повторного обучения необходимо обновить веб-службу оценки с помощью переученной модели машинного обучения. Чтобы обновить веб-службу с помощью заново обученной модели, можно использовать действие обновления ресурса Машинного обучения Azure.
