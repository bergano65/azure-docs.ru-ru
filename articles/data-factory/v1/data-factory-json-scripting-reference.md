...
| Тег | Description (Описание) | Обязательно |
| --- | --- | --- |
...
| Свойство | Допустимые значения | По умолчанию | Description (Описание) |
| --- | --- | --- | --- |
...
| Доступность | Определяет окно обработки или модель среза для создания набора данных. Дополнительные сведения о модели срезов набора данных см. в статье [Планирование и исполнение с использованием фабрики данных](data-factory-scheduling-and-execution.md). |Да |Нет данных |
...
| Имя политики | Description (Описание) | Применяется к | Обязательно | значение по умолчанию |
| --- | --- | --- | --- | --- |
...
| Имя | Description (Описание) | Обязательно | По умолчанию |
| --- | --- | --- | --- |
...
| клиенте | Укажите сведения о клиенте (доменное имя или идентификатор клиента), в котором находится приложение. Его можно получить, наведя указатель мыши на правый верхний угол страницы портала Azure. | Да (для проверки подлинности на основе субъекта-службы) |
