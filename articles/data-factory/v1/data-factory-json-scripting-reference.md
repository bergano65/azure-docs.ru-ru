...
| Тег | Description | Обязательно для заполнения |
| --- | --- | --- |
...
| Свойство | Допустимые значения | Значение по умолчанию | Description |
| --- | --- | --- | --- |
...
| Свойство | Description | Обязательно для заполнения | По умолчанию |
| --- | --- | --- | --- |
...
| Имя политики | Description | Применяется к | Обязательно для заполнения | По умолчанию |
| --- | --- | --- | --- | --- |
...
| Имя | Description | Обязательно для заполнения | Значение по умолчанию |
| --- | --- | --- | --- |
...
| --- | --- | --- | --- |
| sqlWriterCleanupScript |Укажите запрос на выполнение действия копирования, позволяющий убедиться в том, что данные конкретного среза очищены. |Инструкция запроса. |Нет |
| allowPolyBase |Указывает, следует ли использовать PolyBase (если применимо) вместо механизма BULKINSERT. <br/><br/> **Использование PolyBase — рекомендуемый способ загрузки данных в хранилище данных SQL.** |Да <br/>False (по умолчанию) |Нет |
...
| Свойство | Description | Пример | Обязательно для заполнения |
| --- | --- | --- | --- |
...
## <a name="hdinsight-hive-activity"></a>Действие Hive в HDInsight
...
## <a name="hdinsight-pig-activity"></a>Действие Pig в HDInsight
...
## <a name="hdinsight-mapreduce-activity"></a>Действие MapReduce в HDInsight
...
## <a name="hdinsight-streaming-activity"></a>Действие потоковой передачи в HDInsight
