...
Редактор Data Factory в Visual Studio или Azure PowerShell можно создать определение JSON для конвейера (с помощью copy Activity). Затем его можно развернуть с целью создания конвейера в фабрике данных. Пошаговые инструкции см. в руководстве [Копирование данных из хранилища BLOB-объектов Azure в базу данных SQL с помощью фабрики данных](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md).    
