---
title: Перемещение данных с помощью действия копирования
...
* Копирование данных в базу данных SQL Server и запись в Azure Data Lake Store в формате ORC.
...
## <a name="globally-available-data-movement"></a><a name="global"></a>Глобально доступное перемещение данных
...
| Бразилия | Южная Бразилия | Brazil South |
...
| Азиатско-Тихоокеанский регион | Southeast Asia | Southeast Asia |
| &nbsp; | Восточная Азия | Юго-Восточная Азия |
| Австралия | Восточная Австралия | Восточная Австралия |
| &nbsp; | Юго-Восточная часть Австралии | Australia Southeast |
...
Вы можете использовать редактор фабрики данных в Visual Studio или Azure PowerShell, чтобы создать определение JSON для конвейера (с помощью действия копирования). Затем его можно развернуть с целью создания конвейера в фабрике данных. Пошаговые инструкции см. в руководстве [Копирование данных из хранилища BLOB-объектов Azure в базу данных SQL с помощью фабрики данных](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md).    
