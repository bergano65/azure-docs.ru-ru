...
> [!NOTE]
> Статья относится к версии 1 фабрики данных Azure, которая является общедоступной версией. Если вы используете текущую версию Фабрики данных, см. статью о [пользовательских действиях в службе "Фабрика данных Azure"](../transform-data-using-dotnet-custom-activity.md).
...
1. Создайте проект библиотеки классов .NET в Visual Studio.
   ...
   g. Нажмите кнопку **ОК**, чтобы создать проект.
