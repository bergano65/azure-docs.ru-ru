...
При необходимости, чтобы узнать больше о пакетной службе, см. в разделе [документация по пакетной службе](https://docs.microsoft.com/azure/batch/).
...
Создайте учетную запись пакетной службы с помощью [портала Azure](https://portal.azure.com/). Дополнительные сведения см. в [этой статье](../../batch/batch-account-create-portal.md). Запишите ключ и имя учетной записи пакетной службы. Вы также можете использовать [New AzBatchAccount](https://docs.microsoft.com/powershell/module/az.batch/new-azbatchaccount) командлет, чтобы создать учетную запись пакетной службы. Инструкции по использованию этого командлета см. в статье [Управление ресурсами пакетной службы с помощью командлетов PowerShell](../../batch/batch-powershell-cmdlets-get-started.md).
