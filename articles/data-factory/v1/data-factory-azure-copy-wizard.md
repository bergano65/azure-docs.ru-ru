...
> [!TIP]
> При копировании данных из SQL Server или базы данных SQL Azure в Azure синапсе Analytics (ранее в хранилище данных SQL) фабрика данных поддерживает автоматическое создание таблиц с использованием схемы источника. Дополнительные сведения см. [в статье перемещение данных в Azure синапсе Analytics и обратно с помощью фабрики данных Azure](./data-factory-azure-sql-data-warehouse-connector.md).
>
