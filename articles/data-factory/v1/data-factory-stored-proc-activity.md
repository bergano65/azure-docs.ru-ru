...
3. Внесите следующие изменения в сценарий JSON:
   ...
   1. Замените `<servername>` именем своего сервера.
