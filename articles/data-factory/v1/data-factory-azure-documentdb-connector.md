...
| --- | --- | --- |
| тип |Для свойства надо указать тип **DocumentDb** |Да |
...
| writeBatchTimeout |Время ожидания до выполнения операции, пока не завершится срок ее действия. |timespan<br/><br/> Пример: 00:30:00 (30 минут). |Нет |
