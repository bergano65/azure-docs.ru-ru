...
> [!NOTE]
> При копировании данных из хранилища данных в помещениях в хранилище данных Azure S'L с использованием PolyBase и постановке, если версия шлюза управления данными ниже 2,4, JRE (Java Runtime Environment) требуется на вашем шлюзе, который используется для преобразования вашего источника данные в надлежащем формате. Чтобы избежать такой зависимости, мы рекомендуем обновить шлюз до последней версии.
>
