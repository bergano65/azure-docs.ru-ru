...
Самый простой способ создать конвейер, копирующий данные в Azure синапсе Analytics или из него, — использовать мастер копирования данных. Краткое пошаговое руководство по созданию конвейера с помощью мастера копирования данных см. в разделе [учебник. Загрузка данных в синапсе Analytics с помощью фабрики данных](../load-azure-sql-data-warehouse.md) .
