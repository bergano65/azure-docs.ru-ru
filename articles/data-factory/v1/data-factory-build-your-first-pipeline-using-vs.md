---
title: Создание первой фабрики данных (Visual Studio)
...
> [!NOTE]
> Копирование данных с помощью фабрики данных Azure в этом руководстве не рассматривается. Инструкции по копированию данных с помощью Фабрики данных Azure см. в [руководстве по копированию данных из хранилища BLOB-объектов Azure в Базу данных SQL](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md).
> 
...
2. Затем создайте два набора данных: **InputDataset** и **OutputDataset** для входных и выходных данных, сохраненных в хранилище BLOB-объектов Azure. 
...
1. Войдите на [портал Azure](https://portal.azure.com/) и сделайте следующее:
   ...
   2. Выберите имя своей фабрики данных в соответствующем списке (например, **DataFactoryUsingVS09152016**).
