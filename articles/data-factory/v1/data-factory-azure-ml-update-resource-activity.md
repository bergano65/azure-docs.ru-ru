...
В следующей таблице описаны веб-службы, используемые в данном примере.  Дополнительные сведения см. в разделе [программное переобучение моделей машинное обучение Studio (классическая модель)](../../machine-learning/studio/retrain-machine-learning-model.md) .
