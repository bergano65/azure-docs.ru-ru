...
| Имя переменной | Description (Описание) | Область объекта | Область JSON и примеры использования |
| --- | --- | --- | --- |
...
1. Указание запросов выбора данных (см. статьи о соединителях, на которые ссылается статья [Действия перемещения данных](data-factory-data-movement-activities.md)).
   ...
   Для вызова функции фабрики данных используется следующий синтаксис: **$$\<функции >** для запросов выбора данных и других свойств в действиях и наборах DataSet.  
...
| Категория | Функция | Параметры | Description (Описание) |
| --- | --- | --- | --- |
