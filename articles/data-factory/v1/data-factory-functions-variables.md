...
1. Указание запросов выбора данных (см. статьи о соединителях, на которые ссылается статья [Действия перемещения данных](data-factory-data-movement-activities.md)).
   ...
   Для вызова функции фабрики данных используется следующий синтаксис: ** $$ \<Функция>** для запросов выбора данных и других свойств в наборе действий и данных.  
...
| --- | --- | --- | --- |
| Время |AddHours(X,Y) |X: DateTime  <br/><br/>Y: int |Добавляет Y часов к заданному времени X. <br/><br/>Например, `9/5/2013 12:00:00 PM + 2 hours = 9/5/2013 2:00:00 PM`. |
