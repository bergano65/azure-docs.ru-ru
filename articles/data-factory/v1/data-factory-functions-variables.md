...
| Category | Функция | Параметры | ОПИСАНИЕ |
| --- | --- | --- | --- |
...
| Text |Format(X) |X: Строковая переменная |Форматирует текст (используйте комбинацию `\\'` для экранирования символа `'`).|
