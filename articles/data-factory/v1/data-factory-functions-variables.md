...
1. Указание запросов выбора данных (см. статьи о соединителях, на которые ссылается статья [Действия перемещения данных](data-factory-data-movement-activities.md)).
   ...
   Для вызова функции фабрики данных используется следующий синтаксис:  **$$ \<функция >** для запросов выбора данных и других свойств действий и наборов данных.  
...
| DateTime |From(X) |X: Строка |Разбор строки X в значение даты и времени. |
