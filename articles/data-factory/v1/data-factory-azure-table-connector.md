---
title: Перемещение данных в/из таблицы Azure
...
1. Связанная служба типа [AzureStorage](data-factory-azure-blob-connector.md#linked-service-properties) (используется как для таблицы & капли).
...
**Служба, связанная с хранением Azure:**
