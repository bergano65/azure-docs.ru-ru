...
## <a name="json-example-copy-data-from-sql-server-to-azure-cognitive-search-index"></a>Пример JSON. копирование данных из SQL Server в индекс Когнитивный поиск Azure
...
В примере данные временных рядов копируются из базы данных SQL Server для поиска в индексе по часам. Используемые в этом примере свойства JSON описаны в разделах, следующих за примерами.
