...
-   Для использования **TLS**:
    ...
    1.  Получите информацию о сертификате TLS/SSL. Получите закодированную информацию о сертификате TLS/SSL (DER) и сохраните результат (----- Сертификат начала... End Certificate -----) как текстовый файл.
