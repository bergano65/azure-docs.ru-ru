...
>[!TIP]
>При использовании пользовательского интерфейса ADF для разработки можно найти определенную запись "хранилище файлов Azure" для создания связанной службы, которая создает объект типа `FileServer`.
