...
description: Узнайте больше о платформе Azure Databricks и интеграции решений Spark и Databricks с Azure. Azure Databricks — это платформа аналитики на основе Apache Spark, оптимизированная для платформы облачных служб Microsoft Azure.
...
![Конвейер Databricks](./media/what-is-azure-databricks/databricks-pipeline.png)
...
Azure Databricks тесно интегрируется с такими базами данных и хранилищами Azure: хранилище данных SQL, Cosmos DB, Azure Data Lake Storage и хранилище BLOB-объектов. 
