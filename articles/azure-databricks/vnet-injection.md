...
|Direction|Протокол|Источник|Исходный порт|Место назначения|Порт назначения|
|---------|--------|------|-----------|-----------|----------------|
|Вход.|\*|Виртуальная сеть|\*|\*|\*|
|Вход.|\*|IP-адресов NAT плоскости управления|\*|\*|22|
|Вход.|\*|IP-адресов NAT плоскости управления|\*|\*|5557|
...
|Запад Индии|Плоскость управления NAT </br></br>Веб-приложения|104.211.89.81/32 </br></br>104.211.101.14/32|
