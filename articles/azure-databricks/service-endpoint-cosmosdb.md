...
1. Откройте портал Azure. Вверху в левой части экрана выберите **Создать ресурс > Базы данных > Azure Cosmos DB**.
...
2. Заполните параметры в разделе **Сведения об экземпляре** на вкладке **Основы** следующим образом.
   ...
   |Геоизбыточность|Отключить|
   |Выполнение операций записи в нескольких регионах|Включить|
