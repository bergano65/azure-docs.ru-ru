...
2. В разделе **Создание виртуальной сети**, применяются следующие параметры: 
    ...
    |Пространство адресов|10.1.0.0/16|Диапазон адресов виртуальной сети в нотации CIDR.|
    ...
    |Расположение|\<Выберите ближайший к пользователям регион\>|Выберите географическое расположение, где можно разместить виртуальной сети. Используйте ближайшее к пользователям расположение.|
...
2. В разделе **службы Azure Databricks**, применяются следующие параметры:
    ...
    |Расположение|\<Выберите ближайший к пользователям регион\>|Выберите то же расположение вашей виртуальной сети.|
    ...
    |Развертывание рабочей области Azure Databricks в виртуальной сети|Yes|Этот параметр позволяет развернуть рабочую область Azure Databricks в виртуальной сети.|
