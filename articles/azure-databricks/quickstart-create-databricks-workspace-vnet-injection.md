...
2. В разделе **Создание виртуальной сети**примените следующие параметры. 
    ...
    |Расположение|\<Выберите ближайший к пользователям регион\>|Выберите географическое расположение, в котором можно разместить виртуальную сеть. Используйте ближайшее к пользователям расположение.|
