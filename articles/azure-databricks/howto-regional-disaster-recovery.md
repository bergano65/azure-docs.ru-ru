...
8. **Мигрировать хранилище капли Azure и крепления Azure Data Lake**

   Вручную воссоединить все точки [хранения Azure Blob](/azure/databricks/data/data-sources/azure/azure-storage) и [Azure Data Lake Storage (Gen 2)](/azure/databricks/data/data-sources/azure/azure-datalake-gen2) с помощью решения на основе ноутбука. Ресурсы хранилища были бы подключены в основной рабочей области, и это следует повторить в дополнительной рабочей области. Внешних API для подключений не существует.
...
## <a name="disaster-recovery-for-your-azure-ecosystem"></a>Восстановление аварийности для экосистемы Azure

Если вы используете другие службы Azure, не забудьте реализовать рекомендации по восстановлению нештатных средств для этих служб. Например, если вы решили использовать внешний экземпляр метамагазина Hive, следует рассмотреть возможность восстановления аварийного наблюдения для [сервера Azure S'L Server,](../sql-database/sql-database-disaster-recovery.md) [Azure HDInsight](../hdinsight/hdinsight-high-availability-linux.md)и/или [базы данных Azure для MyS'L.](../mysql/concepts-business-continuity.md) Для получения общей информации [Disaster recovery for Azure applications](https://docs.microsoft.com/azure/architecture/resiliency/disaster-recovery-azure-applications)о аварийном восстановлении см.
