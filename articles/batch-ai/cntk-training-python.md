---
title: Обучение модели CNTK в Azure Batch AI с помощью Python | Документация Майкрософт
description: Обучение нейронной сети Microsoft Cognitive Toolkit (CNTK) с помощью Azure Batch AI и пакета SDK для Python
services: batch-ai
...
В этой статье показано, как использовать пакет Azure SDK для Python для обучения простой модели Microsoft Cognitive Toolkit (CNTK) с помощью службы Batch AI.
...
Дополнительные сведения об использовании Batch AI с разными платформами см. в [инструкциях по обучению](https://github.com/Azure/BatchAI).