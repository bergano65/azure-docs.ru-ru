...
>
> **Приступая к работе**. Служба приложений позволяет легко создать и развернуть свое первое [веб-приложение](../../app-service/quickstart-dotnetcore.md), [мобильное приложение](../../app-service-mobile/app-service-mobile-ios-get-started.md) или [приложение API](../../app-service/app-service-web-tutorial-rest-api.md).
>
...
- **Служба хранилища Azure**. Обеспечивает надежное высокодоступное хранилище для больших двоичных объектов, очередей, файлов и других типов нереляционных данных. Служба хранилища является платформой хранения данных для виртуальных машин.
  ...
  >
  > **Начало работы**. Выберите один из следующих типов хранилища: [большие двоичные объекты](../../storage/blobs/storage-dotnet-how-to-use-blobs.md), [таблицы](../../cosmos-db/table-storage-how-to-use-dotnet.md), [очереди](../../storage/queues/storage-dotnet-how-to-use-queues.md)или [файлы](../../storage/files/storage-dotnet-how-to-use-files.md).
...
- **База данных SQL Azure**. Версия ядра Microsoft SQL Server на основе Azure для хранения реляционных табличных данных в облаке. База данных SQL обеспечивает прогнозируемую производительность, масштабируемость без простоев, непрерывность бизнес-процессов и защиту данных.
  ...
  >
  > Приступая к **работе**. [Создайте базу данных в базе данных SQL Azure за считаные минуты с помощью портал Azure](../../sql-database/sql-database-get-started.md).
