...
1. Выберите тип репликации хранилища и нажмите кнопку **сохранить**.
   ...
   ![Задайте конфигурацию хранилища для нового хранилища.](../backup/media/backup-try-azure-backup-in-10-mins/recovery-services-vault-backup-configuration.png)
