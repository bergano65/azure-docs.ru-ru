...
>[!NOTE]
>Полный обзор этого шага см. в видео [Azure VMware Solution: Deployment](https://www.youtube.com/embed/1JLB3L2WDWI) (Решение Azure VMware: развертывание). 
...
Для виртуальных машин вы назначите сегменты, созданные на шаге [Проверка объявленного сегмента NSX-T](#verify-advertised-nsx-t-segment).  
