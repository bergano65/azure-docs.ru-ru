...
CSP должны использовать [Центр партнеров Майкрософт](https://partner.microsoft.com) , чтобы включить решение Azure VMware для своих клиентов. В этой статье для демонстрации процедуры приобретения партнеров используется [план Azure CSP](/partner-center/azure-plan-lp.md) в качестве примера.
...
1. Проверьте и завершите общие настройки подписки на план Azure для клиента. Дополнительные сведения см. в [документации центра партнеров Майкрософт](/partner-center/azure-plan-manage.md).

После настройки плана Azure и необходимых для подписки [разрешений Azure RBAC](/partner-center/azure-plan-manage.md) вы заметите Майкрософт, чтобы включить квоту для подписки на план Azure. Получите доступ к портал Azure из [центра партнеров Майкрософт](https://partner.microsoft.com) с помощью процедуры **администратора от имени** (Аобо).
