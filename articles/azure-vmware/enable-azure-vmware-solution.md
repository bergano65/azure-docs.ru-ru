...
После настройки плана Azure и необходимых разрешений RBAC в качестве CSP вы заметите Майкрософт, чтобы включить квоту для подписки на план Azure. Доступ к портал Azure из центра партнеров с помощью процедуры **"Администратор от имени"** (Аобо).
