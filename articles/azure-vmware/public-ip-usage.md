---
title: Как использовать функции общедоступного IP-адреса в виртуальной глобальной сети
...
ms.locfileid: "91744928"
---
# <a name="how-to-use-the-public-ip-functionality-in-azure-virtual-wan"></a>Как использовать функции общедоступного IP-адреса в виртуальной глобальной сети Azure

Общедоступный IP-адрес — это новая функция в связи с решением VMware для Azure, а клиенты могут обеспечить доступ к общедоступному Интернету двумя способами. 
...
В рамках развертывания частного облака решения Azure VMware при включении функций общедоступного IP-адреса необходимые компоненты с автоматизацией создаются и включаются автоматически.
...
В этой статье подробно описано, как использовать функции общедоступного IP-адреса в виртуальной глобальной сети для создания ресурсов, таких как веб-серверы, виртуальные машины и узлы, доступ к которым можно получить через общедоступную сеть.
...
2.  Примите значения по умолчанию или измените их, а затем нажмите кнопку **создать**.

   -  Группа ресурсов виртуальной глобальной сети

   -  Имя виртуальной глобальной сети

   -  Блок адресов виртуального концентратора
