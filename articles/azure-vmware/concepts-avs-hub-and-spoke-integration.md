...
Дополнительные сведения и требования см. в статье о решении Azure VMware на [шлюзе приложений](./protect-avs-web-apps-with-app-gateway.md) .
