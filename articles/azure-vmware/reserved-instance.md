...
CSP, которые хотят приобрести зарезервированные экземпляры для своих клиентов, должны использовать процедуру **"Администратор от имени** " (Аобо) в [документации центра партнеров](https://docs.microsoft.com/partner-center/azure-plan-manage). Дополнительные сведения см. в видео ["Администратор от имени" (Аобо)](https://channel9.msdn.com/Series/cspdev/Module-11-Admin-On-Behalf-Of-AOBO) .
...
Дополнительные сведения о резервировании, управляемом CSP, см. в разделе [продажа Microsoft Azure резервирования клиентам с помощью центра партнеров, портал Azure или интерфейсов API](https://docs.microsoft.com/partner-center/azure-reservations).
