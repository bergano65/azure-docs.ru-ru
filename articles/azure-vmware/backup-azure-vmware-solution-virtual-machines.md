...
В этой статье мы рассмотрим процедуры резервного копирования виртуальных машин VMware, работающих в решении VMware для Azure, с помощью Azure Backup Server. Перед началом убедитесь, что вы тщательно [Настроили Microsoft Azure Backup Server для решения VMware для Azure](set-up-backup-server-for-azure-vmware-solution.md).
