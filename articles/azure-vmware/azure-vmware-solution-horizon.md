...
Подключение из виртуальной сети Azure к частным облакам Azure или Сддкс должно быть настроено с помощью пути Експресспас FAST. На следующей схеме показано развертывание модуля Pod с базовым горизонтом.
...
### <a name="single-horizon-pd-on-azure-vmware-solution"></a>Один горизонт PD в решении VMware для Azure
