...
Собственные средства безопасности Azure обеспечивают защиту гибридной среды Azure, решения VMware Azure и локальных виртуальных машин (ВМ). В этой статье показано, как настроить средства Azure для обеспечения безопасности гибридной среды. Эти средства используются для выявления и устранения различных угроз.

## <a name="azure-native-services"></a>Собственные службы Azure

Ниже приведен краткий обзор собственных служб Azure.
...
- **Центр безопасности Azure:** Центр безопасности Azure — это единая система управления безопасностью инфраструктуры. Это повышает безопасность центров обработки данных и обеспечивает расширенную защиту от угроз для гибридных рабочих нагрузок в облаке или локальной среде.
- **Sentinel Azure:** Azure Sentinel — это собственное решение для управления событиями с информацией о безопасности (SIEM). Она предоставляет средства анализа безопасности, обнаружения предупреждений и автоматизированного реагирования на угрозы в среде.
...
Рабочую область Log Analytics можно настроить с помощью метки Azure для определения предупреждений, видимости угроз, поиска и реагирования на угрозы. На предыдущей схеме центр безопасности Azure подключен к Sentinel Azure с помощью соединителя центра безопасности Azure. Центр безопасности Azure пересылает уязвимость среды в метку Azure для создания инцидента и его сопоставлении с другими угрозами. Можно также создать запрос по запланированным правилам для обнаружения нежелательных действий и их преобразования в инциденты.
...
- Центр безопасности Azure предлагает множество функций, в том числе:
...
Защитник Azure расширяет возможности расширенной защиты от угроз в центре безопасности Azure по гибридным рабочим нагрузкам как локально, так и в облаке. Чтобы защитить виртуальные машины Azure VMware, необходимо включить защитник Azure. 
...
После подключения источников данных к Sentinel Azure можно создать правила для создания оповещений об обнаруженных угрозах. В следующем примере мы создадим правило для попытки входа в Windows Server с неверным паролем.
