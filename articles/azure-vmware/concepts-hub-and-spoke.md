...
* Автоматическая регистрация должна быть включена Azure DNS для автоматического управления жизненным циклом записей DNS для виртуальных машин, развернутых в периферийных виртуальных сетях.
