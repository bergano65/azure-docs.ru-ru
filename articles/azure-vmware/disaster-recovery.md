...
- **Целевое хранилище:** Выберите удаленное хранилище данных для защищенных виртуальных машин. В частном облаке решения Azure VMware этот вариант должен быть хранилищем данных vSAN.
...
Войдите в **vSphere Client** на удаленном сайте, который является частным облаком решения Azure VMware. В **подключаемом модуле хккс**в области аварийного восстановления выберите вертикальные многоточия на любой виртуальной машине, чтобы отобразить меню операции. Выберите **тест восстановить виртуальную машину**.
...
После завершения операции тестового восстановления новую виртуальную машину можно будет проверить в частном облаке Azure VMware Cloud Center.
...
Войдите в **vSphere Client** на удаленном сайте, который является частным облаком решения Azure VMware, и получите доступ к **подключаемому модулю хккс**.
...
Войдите в **клиент vSphere** в частном облаке решения Azure VMware и получите доступ к **подключаемому модулю хккс**.
