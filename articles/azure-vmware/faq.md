...
**Где находится решение Azure VMware, доступное сегодня?**
...
**Могут ли рабочие нагрузки, работающие в экземпляре решения Azure VMware, использовать или интегрировать со службами Azure?**
...
**Разделы справки подключиться из локальных сред к частному облаку решения Azure VMware?**
...
**Какие учетные записи и привилегии получит мое новое частное облако решения Azure VMware?**
...
**Как будет взиматься плата за использование предварительной версии решения VMware для Azure**
...
**Как будут структурированы цены во время предварительной версии решения VMware для Azure?**
...
**Какие учетные записи нужно создать в частном облаке решения Azure VMware?**
