...
Нет. Используйте [инструкции, предоставленные VMware](https://docs.vmware.com/en/VMware-vSphere/6.7/com.vmware.vsphere.vm_admin.doc/GUID-89E7E8F0-DB2B-437F-8F70-BA34C505053F.html) , чтобы удовлетворить предварительные требования к виртуальным машинам, указанным в этих инструкциях. 
...
#### <a name="you-document-that-commvault-veritas-and-veeam-have-extended-their-backup-solutions-to-work-with-azure-vmware-solution-what-about-other-independent-software-vendors-isvs-backup-solutions"></a>Вы можете документировать, что Commvault, Veritas и Veeam расширили свои решения резервного копирования для работы с решением VMware для Azure. Как насчет других независимых поставщиков программного обеспечения (ISV) для резервного копирования?
...
В частных облаках используется vSphere 6,7 U3, vSAN 6,7 U3, VMware ХККС и НСКС-T 2,5.  Дополнительные сведения см. [в статье требования к версии программного обеспечения VMware](https://docs.vmware.com/en/VMware-HCX/services/user-guide/GUID-54E5293B-8707-4D29-BFE8-EE63539CC49B.html).
...
Нет. Сетевой трафик, входящий из Интернета напрямую в частные облака, по умолчанию запрещен.  Тем не менее вы можете предоставить виртуальные машины Azure VMware в Интернете с помощью параметра [общедоступного IP-адреса](public-ip-usage.md) в портал Azure для частного облака решения Azure VMware.
...
Да. CSP может приобрести зарезервированные экземпляры для своих клиентов. Дополнительные сведения см. в статье [Сохранение затрат с помощью зарезервированных экземпляров](reserved-instance.md) . 
