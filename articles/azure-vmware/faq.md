...
Для подписок, управляемых CSP, первый уровень поддержки предоставляется поставщиком решений таким же образом, как и CSP для других служб Azure.
...
Перед созданием ресурса решения Azure VMware отправьте запрос в службу поддержки, чтобы узлы были распределены. Подтверждение запроса и выделение узлов занимает до пяти рабочих дней. Если у вас уже есть частное облако Решения Azure VMware и вы хотите выделить для него больше узлов, выполните те же действия.
