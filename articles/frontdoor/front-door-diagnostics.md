...
| Правило маршрутизации с включенным кэшированием. Попадание в кэш в точке подключения на границе | 1 | Код POP пограничных точек | Empty | Да | ПРОИЗВОДИТСЯ |
