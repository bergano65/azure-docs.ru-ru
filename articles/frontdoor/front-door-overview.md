...
Front Door обеспечивает высокую доступность для критически важных приложений, выполняя интеллектуальные пробы работоспособности, отслеживая задержки и состояние доступности серверных частей, а также поддерживая мгновенный автоматический переход на другой ресурс при выходе серверной части из строя. Таким образом, вы можете выполнять операции запланированного обслуживания приложений, не вызывая простоев всей системы. Во время обслуживания служба Front Door направляет трафик к альтернативным серверам.
