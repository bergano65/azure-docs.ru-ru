...
| ------------- | ------------- |
| Via |  *С помощью: 1.1 azure* </br> Входной двери добавляет версию клиента HTTP, следуют «Azure» как значение с помощью заголовка. Это будет добавлен для указания версии HTTP клиента и двери, Azure была получателю промежуточных для запроса между клиентом и серверной части.  |
