...
1. **Очистка одного пути**. Очистите отдельные активы, указав полный путь к ресурсу (без протокола и домена) с расширением файла, например/pictures/strasbourg.png;
