...
ms.locfileid: "91449211"
---
# <a name="how-requests-are-matched-to-a-routing-rule"></a>Способ сопоставления запросов с правилом маршрутизации

После установления соединения и завершения подтверждения TLS, когда запрос направляется в среду передней дверцы, одна из первых подвижок — определить, какое правило маршрутизации будет соответствовать запросу, а затем выполнить определенное действие в конфигурации. В следующем документе объясняется, как служба Front Door определяет, какую конфигурацию маршрута использовать для обработки HTTP-запроса.
