---
title: Настройка обработчика правил для Azure Front Door
description: В этой статье описывается, как настроить обработчики правил для Azure Front Door.
services: frontdoor
documentationcenter: ''
author: megan-beatty
editor: ''
