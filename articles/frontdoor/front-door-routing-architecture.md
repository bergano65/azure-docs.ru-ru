---
title: Передняя дверь Azure - архитектура разгрома Документы Майкрософт
...
Передняя дверь Azure, когда она получает запросы клиента, либо отвечает на них (если кэширование включено), либо направляет их в соответствующее бэкэнд приложения (в качестве обратного прокси).
