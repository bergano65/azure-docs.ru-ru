...
Для создания [передней двери](front-door-overview.md) с сертификатом для прекращения SSL можно использовать портал Azure. Правило routout используется для перенаправления трафика HTTP на HTTPS.

Вы узнаете, как выполнять следующие задачи:

> [!div class="checklist"]
> * Создание передней двери с существующим ресурсом Web App
> * Добавление пользовательского домена с сертификатом SSL 
