...
> [!NOTE]
> Если не указать версию сертификата, произойдет следующее:
> - будет выбрана последняя версия сертификата;
> - текущие версии сертификатов будут автоматически заменены последними версиями, если в Key Vault доступна более новая версия сертификата.
