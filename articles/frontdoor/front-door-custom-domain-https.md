...
Прежде чем перейти к выполнению шагов в этом руководстве, создайте службу Front Door и разверните в ней как минимум один личный домен. Дополнительные сведения см. в статье [Руководство. Добавление личного домена в службу Front Door](front-door-custom-domain.md).
...
> [!NOTE]
> Это действие необходимо выполнить только **один** раз для каждого клиента.
...
5. Нажмите кнопку **ОК**. 
    ...
    Теперь у Azure Front Door Service есть доступ к этому хранилищу ключей и сертификатам, которые хранятся в нем.
