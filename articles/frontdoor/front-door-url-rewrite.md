---
title: Передняя дверь Azure - URL переписать (ru) Документы Майкрософт
description: Эта статья поможет вам понять, как Azure Front Door делает URL-адрес перезаписи для ваших маршрутов, если настроен.
services: front-door
documentationcenter: ''
author: sharad4u
...
| www\.contoso.com/**подлодка**     | /\*                      | /**Sub**   | /fwd/**sub**   | /foo/**sub**   | /foo/bar/**sub**   |
| www\.contoso.com/**a/b/c**   | /\*                      | /**a/b/c** | /fwd/**a/b/c** | /foo/**a/b/c** | /foo/bar/**a/b/c** |
| www\.contoso.com/foo         | /foo                     | /          | /fwd/          | /foo/          | /foo/bar/          |
| www\.contoso.com/foo/        | /foo/\*                  | /          | /fwd/          | /foo/          | /foo/bar/          |
| www\.contoso.com/foo/**бар** | /foo/\*                  | /**Бар**   | /fwd/**bar**   | /foo/**бар**   | /foo/bar/**bar**   |
