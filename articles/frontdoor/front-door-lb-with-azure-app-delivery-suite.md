...
End-to-end надежным, эффективный и безопасный способ маршрутизации трафика для и от пользователей комбинирования глобального и регионального служб в приложении предоставляет IaaS, PaaS или локальным службам. В следующем разделе описывается каждая из этих служб.
...
| Диспетчер трафика | Служба Azure Front Door |
| --------------- | ------------------------ |
