...
Вы можете использовать портал Azure, чтобы на борт домена вершины на передней двери и включить HTTPS на нем, связав его с сертификатом для прекращения TLS. Домены Apex также называются корневыми или голыми доменами.
...
> [!WARNING]
> Тип управления сертификатами Front Door в настоящее время не поддерживается для доменов вершины или корней. Единственный вариант, доступный для включения HTTPS на вершине или корневом домене для Front Door, это использование собственного пользовательского сертификата TLS/SSL, размещенного на Azure Key Vault.
