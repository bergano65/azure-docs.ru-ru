...
* **Сходство сеансов:** Можно настроить сходство сеансов для интерфейсных узлов или доменов, если необходимо, чтобы последующие запросы от пользователя отправлялись на тот же сервер, если сеанс пользователя все еще активен, а внутренний экземпляр по-прежнему сообщает о работоспособности на основе проб работоспособности. 
