---
title: Геофильтрация на домене для передней двери Azure Документы Майкрософт
description: В этой статье вы узнаете о политике геофильтрации для Передней двери Azure
services: frontdoor
documentationcenter: ''
author: KumudD
editor: ''
...
По умолчанию Azure Front Door отвечает на запросы пользователей независимо от местонахождения пользователя, делающих запрос. Но в некоторых случаях может потребоваться ограничить доступ к веб-приложениям для определенной страны или региона. Служба брандмауэра веб-приложения в Azure Front Door позволяет определить политику, используя настраиваемые правила доступа для определенного пути в конечной точке, чтобы разрешить или заблокировать доступ из указанных стран и регионов. 
