...
**Руководство**. Передняя дверца Azure не предназначена для развертывания в виртуальных сетях; из-за этого клиенты не могут включить ведение журнала потоков для групп безопасности сети, направить трафик через брандмауэр или выполнить захват пакетов.
