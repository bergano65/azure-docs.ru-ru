---
title: Приступая к работе с Центром образования Azure
description: Сведения о том, как быстро приступить к работе с Центром образования Azure, начав со страницы "Начало работы".
author: tfosmark
ms.author: rymend
ms.topic: quickstart
...
- [Управление грантами на обучение с помощью страницы обзора](hub-overview-page.md)
