...
| --- | --- | --- | --- |
| Роль не назначена |Отсутствуют |Управление с помощью ACL |Пользователь не может использовать портал Azure или командлеты PowerShell Azure для просмотра Data Lake Storage 1-го поколения. Он может использовать только средства командной строки. |
