---
title: Рекомендации по настройке производительности Azure Data Lake Storage 1-го поколения | Документы Майкрософт
description: Рекомендации по настройке производительности Azure Data Lake Storage 1-го поколения
...
При передаче данных из исходной системы в Data Lake Storage 1-го поколения необходимо учесть, что исходное оборудование, сетевое оборудование и сетевое подключение к Data Lake Storage 1-го поколения могут быть узким местом.  
...
При хранении данных в Data Lake Storage 1-го поколения размер файла, число файлов и структура папок влияют на производительность.  В следующем разделе описаны рекомендации в этих областях.  
