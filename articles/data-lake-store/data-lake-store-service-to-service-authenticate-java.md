---
title: Проверка подлинности между службами в Azure Data Lake Storage 1-го поколения с помощью Azure Active Directory и Java | Документы Майкрософт
