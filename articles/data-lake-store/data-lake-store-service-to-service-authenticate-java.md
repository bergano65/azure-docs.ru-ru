---
title: Аутентификация обслуживания в обслуживании - Data Lake Storage Gen1 - Java SDK
...
* [Maven](https://maven.apache.org/install.html). В этом руководстве это средство используется для создания зависимостей проекта. Хотя можно создавать без использования системы сборки, такой как Maven или Gradle, эти системы значительно упрощают управление зависимостями.
