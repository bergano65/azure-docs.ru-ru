...
* **Учетная запись Хранения озера данных Gen1**. Следуйте инструкциям в [Get started с Azure Data Lake Storage 1 с помощью портала Azure.](data-lake-store-get-started-portal.md) В целях этого руководства создадим учетную запись Data Lake Storage 1-го поколения и назовем ее **datacatalogstore**.
...
1. На странице Добро пожаловать нажмите **войти в систему**и введите свои учетные данные.
