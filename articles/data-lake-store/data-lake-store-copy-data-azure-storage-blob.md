---
title: Копирование данных из капли хранения данных в Data Lake Storage Gen1
...
Data Lake Storage Gen1 предоставляет инструмент командной строки [AdlCopy](https://www.microsoft.com/download/details.aspx?id=50358)для копирования данных из следующих источников:

* От капли хранения данных в Data Lake Storage Gen1. Вы не можете использовать AdlCopy для копирования данных из data Lake Storage Gen1 в Azure Storage blobs.
* Между двумя учетными записями Data Lake Storage Gen1.
...
* **Контейнер Azure Storage с** некоторыми данными.
* **Учетная запись Хранения озера данных Gen1**. Для получения инструкций о том, как его создать, [см.](data-lake-store-get-started-portal.md)
* **Учетная запись Data Lake Analytics (необязательно)** - [См. Начало работы с Azure Data Lake Analytics](../data-lake-analytics/data-lake-analytics-get-started-portal.md) для получения инструкций о том, как создать учетную запись Data Lake Analytics.
* **Средство AdlCopy**. Установите [инструмент AdlCopy.](https://www.microsoft.com/download/details.aspx?id=50358)
...
* AdlCopy (для версии 1.0.5) поддерживает копирование данных из источников, которые совокупно содержат тысячи файлов и папок. Однако, если вы столкнулись с проблемами, копирующих большой набор данных, можно распределить файлы/папки на различные субфолители и использовать путь к этим субфайрам в качестве источника.

## <a name="performance-considerations-for-using-adlcopy"></a>Рекомендации по производительности при использовании AdlCopy

AdlCopy поддерживает копирование данных, содержащих тысячи файлов и папок. Однако, если вы столкнулись с проблемами, копирующих большой набор данных, можно распределить файлы/папки на более мелкие субфоли. Инструмент AdlCopy был создан для выполнения задач копирования при необходимости. Если требуется копировать данные на регулярной основе, то лучше воспользоваться [фабрикой данных Azure](../data-factory/connector-azure-data-lake-store.md), которая предоставляет возможности полного управления операциями копирования.
