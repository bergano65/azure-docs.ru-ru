...
* **Запущенный кластер Storm в Data Lake Storage 1-го поколения**. Для получения дополнительной информации, [см.](https://docs.microsoft.com/azure/hdinsight/hdinsight-storm-overview)
...
1. В **Ambari** > **Storm** > **Config** > **Расширенный шторм-рабочий-log4j**, изменить ** &lt;уровень корня "инфо"&gt; ** на ** &lt;корневой уровень "отладка"&gt;**. Перезапустите все узлы и службы, чтобы изменения конфигурации вступили в силу.
...
Дополнительная настройка производительности для Storm может быть ссылкой в [этом блоге](https://blogs.msdn.microsoft.com/shanyu/2015/05/14/performance-tuning-for-hdinsight-storm-and-microsoft-azure-eventhubs/).
