---
title: 'Аутентификация между службами: Python с Azure Data Lake Storage 1-го поколения помощью Azure Active Directory | Документация Майкрософт'
