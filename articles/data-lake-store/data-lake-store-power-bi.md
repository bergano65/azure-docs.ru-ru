...
15. Давайте создадим круговую диаграмму, чтобы представлено количество водителей в каждом городе данной страны или региона. Для этого выполним указанные ниже действия.
    ...
    2. Столбцы, которые мы собираемся использовать **4 столбца** (имени города) и **столбец 7** (имя страны или региона). Перетащите их с вкладки **Поля** на вкладку **Визуализации**, как показано ниже.
...
16. Если выбрать конкретную страну или регион из фильтров уровня страницы, вы увидите количество водителей в каждом городе выбранной страны или региона. Например, на вкладке **Визуализации** в списке **Фильтры** уровня страницы выберите **Бразилия**.
    
    ![Выберите страну](./media/data-lake-store-power-bi/select-country.png "выберите страну или регион")
17. Круговая диаграмма автоматически обновится, и вы увидите количество водителей в городах Бразилии.
    
    ![Драйверы в стране](./media/data-lake-store-power-bi/driver-per-country.png "количество водителей в каждой страны или региона")
