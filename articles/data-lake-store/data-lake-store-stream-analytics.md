...
description: Узнайте, как использовать Azure Data Lake Storage 1-го поколения в качестве выходных данных для задания Azure Stream Analytics, с помощью простого сценария, считывающего данные из большого двоичного объекта службы хранилища Azure.
author: twooley
...
1. Откройте страницу задания Stream Analytics, на панели слева перейдите на вкладку **Входные данные** и выберите команду **Добавить**.
    ...
    ![Снимок экрана: колонка "Stream Analytics" с параметром "входные данные" и параметром "добавить поток входных данных".](./media/data-lake-store-stream-analytics/create.input.1.png "Добавление входных данных в задание")

2. В колонке **Создание входных данных** введите следующие значения.

    ![Снимок экрана хранилища BLOB-объектов — Новая колонка ввода.](./media/data-lake-store-stream-analytics/create.input.2.png "Добавление входных данных в задание")
...
1. Откройте страницу задания Stream Analytics, перейдите на вкладку **Выходные данные**, щелкните **Добавить** и выберите **Data Lake Storage 1-го поколения**.
    ...
    ![Снимок экрана: колонка задания Stream Analytics с параметром выходные данные, параметром "Добавить" и параметром Data Lake Storage Gen 1 "вызываемый".](./media/data-lake-store-stream-analytics/create.output.1.png "Добавление выходных данных в задание")
...
3. В колонке **Новые выходные данные** продолжайте ввод значений.
    ...
    ![Снимок экрана: колонка "Data Lake Storage поколения 1 — новая".](./media/data-lake-store-stream-analytics/create.output.3.png "Добавление выходных данных в задание")
