...
5. Выберите команду **Сохранить**. Вы увидите группы безопасности, как показано ниже.
    ...
    ![Группа безопасности добавлена](./media/data-lake-store-secure-data/adl.add.user.3.png "Добавлена группа безопасности.")
...
3. В колонке **Доступ** перечислены владельцы и назначенные им права доступа, которые уже назначены администратору. Нажмите кнопку **Добавить**, чтобы добавить дополнительные списки ACL для доступа.
    ...
    ![Список стандартных и настраиваемых прав доступа](./media/data-lake-store-secure-data/adl.acl.2.png "Перечисление стандартных и пользовательских сценариев доступа")
...
5. Нажмите кнопку **Выберите разрешения**, выберите разрешения, а также любой из вариантов назначения разрешений — рекурсивно или в виде ACL для доступа, ACL по умолчанию или обоих одновременно. Нажмите кнопку **ОК**.
    ...
    ![Назначить разрешения группе](./media/data-lake-store-secure-data/adl.acl.4.png "Назначение разрешений для группы")
...
6. После нажатия кнопки **ОК** в колонке **Назначьте разрешения** добавленная группа и связанные с ней разрешения будут перечислены в колонке **Доступ**.
    ...
    ![Назначить разрешения группе](./media/data-lake-store-secure-data/adl.acl.5.png "Назначение разрешений для группы")
...
![Параметры брандмауэра и доступ по протоколу IP](./media/data-lake-store-secure-data/firewall-ip-access.png "Параметры и IP-адрес брандмауэра")
...
2. В колонке **Управление доступом (IAM)** выберите группы безопасности, которые требуется удалить. Щелкните **Удалить**.
    ...
    ![Группа безопасности удалена](./media/data-lake-store-secure-data/adl.remove.group.png "Удалена группа безопасности.")
...
3. В колонке **Доступ** выберите группу безопасности, которую необходимо удалить. В колонке **Сведения о доступе** щелкните **Удалить**.
    ...
    ![Назначить разрешения группе](./media/data-lake-store-secure-data/adl.remove.acl.png "Назначение разрешений для группы")
