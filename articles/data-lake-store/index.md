...
<ul class="panelContent cardsW">
    ...
                        <p><a href="https://docs.microsoft.com/python/api/azure-datalake-store/azure.datalake.store.core">Python (управление файловой системой)</a></p>
                    </div>
                </div>
            </div>
        </div>
