...
| управление доступом; |Data Lake Storage 1-го поколения обеспечивает контроль доступа за счет поддержки разрешений POSIX, предоставляемых протоколом WebHDFS. Можно включить списки управления доступом в корневой папке, вложенных папок и отдельных файлов. Дополнительные сведения о работе списки управления доступом в контексте Gen1 хранилища Озера данных см. в разделе [управление доступом в поколение 1 хранилища Озера данных](data-lake-store-access-control.md). |
