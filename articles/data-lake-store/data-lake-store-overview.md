...
### <a name="enterprise-ready-highly-available-and-secure"></a>Готовность к использованию на предприятии: Высокой доступности и безопасности
...
* [Начало работы с Gen1 хранилища Озера данных Azure с помощью пакета SDK для .NET](data-lake-store-get-started-net-sdk.md)
