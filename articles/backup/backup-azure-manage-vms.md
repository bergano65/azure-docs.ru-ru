...
6. В области **архивные элементы** можно просмотреть список защищенных виртуальных машин. В этом примере хранилище защищает одну виртуальную машину: демобаккуп.  
...
3.  Щелкните Изменить и измените параметры.
