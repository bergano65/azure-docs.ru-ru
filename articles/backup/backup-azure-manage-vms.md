...
Точки восстановления сохраняются неограниченно долго, пока элемент резервного копирования не будет повторно защищен с помощью политики хранения либо по защита не будет остановлена, а данные — удалены. В случае повторного включения защиты новая политика определяет срок хранения точек восстановления. Точно так же, если удалить источник данных, не выполняя остановку резервного копирования, будут происходить сбои новых резервных копий и срок действия старых точек восстановления истечет в соответствии с политикой хранения, но последняя точка восстановления всегда будет храниться, пока вы не выполните остановку резервного копирования с удалением данных.
