---
title: Рекомендации и рекомендации
...
* Управление доступом на основе ролей (RBAC) в Azure обеспечивает точное управление доступом, разделение обязанностей внутри команды и предоставление только доступа пользователям, необходимым для выполнения их заданий. [Дополнительные сведения](backup-rbac-rs-vault.md)см. здесь.
