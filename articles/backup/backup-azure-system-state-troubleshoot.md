...
4. Выберите **Cистема архивации данных Windows Server** на вкладке " **компоненты** " и нажмите кнопку **Далее**.
    ...
    ![эластичной базы данных](./media/backup-azure-system-state-troubleshoot/features.png)
...
Теневое копирование томов (VSS) | Manual
Поставщик теневого копирования программного обеспечения Майкрософт (СВПРВ) | Manual
