...
Перед устранением неполадок с резервным копированием состояния системы с Azure Backup выполните следующие проверки предварительных требований.  
