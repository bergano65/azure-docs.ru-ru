...
Установить непосредственно на компьютере | Агент MARS можно установить непосредственно на локальном сервере Windows Server или на виртуальной машине Windows, работающей под управлением любой из [поддерживаемых операционных систем](https://docs.microsoft.com/azure/backup/backup-support-matrix-mabs-dpm#supported-mabs-and-dpm-operating-systems).
