...
* Сокращение времени резервного копирования и восстановления за счет локального сохранения моментальных снимков в течение двух дней по умолчанию. Это хранилище по умолчанию настраивается на любое значение от 1 до 5 дней.
