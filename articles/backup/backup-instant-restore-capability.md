...
>  
>1. Вы можете создавать резервные копии критически важных данных только на одном диске, и вы не хотите создавать резервные копии остальных дисков, подключенных к виртуальной машине. Это позволяет сократить затраты на хранение резервных копий.  
>2. У вас есть другие решения резервного копирования для части данных виртуальной машины. Например, вы создаете резервные копии баз данных или данных с помощью другого решения резервного копирования рабочей нагрузки и хотите использовать резервное копирование на уровне виртуальной машины Azure для остальных дисков и данных, чтобы создать эффективную и надежную систему с использованием лучших возможностей.
>
