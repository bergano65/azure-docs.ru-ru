...
### <a name="which-versions-of-dpm-support-sql-server-2014-and-sql-2012-sp2"></a>Какие версии DPM поддерживаются в SQL Server 2014 и SQL Server 2012 (SP2)?
DPM 2012 R2 с накопительным пакетом обновления 4 поддерживает обе версии.
