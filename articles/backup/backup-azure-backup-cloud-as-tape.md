---
title: Как заменить инфраструктуру ленты
description: Узнайте, как Резервное копирование Azure предоставляет семантику, похожую на ленту, которая позволяет создать резервную связь и восстановить данные в Azure
ms.topic: conceptual
ms.date: 04/30/2017
...
* Сохраняйте данные резервного копирования в течение более длительных периодов времени.
...
2. **Еженедельная политика удержания:** Резервные копирования, сделанные в полночь и 6 вечера субботы сохраняются в течение четырех недель.
3. **Ежемесячная политика удержания**: Резервные копирования, сделанные в полночь и 6 вечера в последнюю субботу каждого месяца сохраняются в течение 12 месяцев.
4. **Ежегодная политика удержания:** Резервные копирования, сделанные в полночь в последнюю субботу каждого марта, сохраняются в течение 10 лет.
...
> [!NOTE]
> С помощью резервного копирования Azure можно создать до 9999 точек восстановления на защищенный экземпляр. Защищенный экземпляр — это компьютер, сервер (физический или виртуальный) или рабочая нагрузка, для которых настроено резервное копирование данных в Azure.
>
