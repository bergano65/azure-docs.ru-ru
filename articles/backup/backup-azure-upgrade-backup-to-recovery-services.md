...
- **Минимальная версия агента.** Для обновления хранилища нужно использовать агент Служб восстановления Microsoft Azure (MARS) не ниже версии 2.0.9083.0. Если используется агент MARS версии, предшествующей версии 2.0.9083.0, обновите агент, прежде чем начать процесс обновления.
...
- **Отсутствие текущих операций по настройке резервного копирования.** Во время обновления доступ к плоскости управления ограничен. Завершите все действия плоскости управления, а затем начните обновление.
...
### <a name="does-the-upgrade-plan-affect-my-ongoing-backups"></a>Затронет ли план обновления мои текущие операции архивации?
№ Текущие операции архивации будут выполняться без прерывания как во время, так и после обновления.

### <a name="if-i-dont-plan-on-upgrading-soon-what-happens-to-my-vaults"></a>Что будет с моими хранилищами, если я не планирую обновление в ближайшем будущем?
...
### <a name="what-does-this-upgrade-mean-for-my-existing-tooling"></a>Как это обновление отразится на моих имеющихся инструментах?
...
### <a name="during-the-upgrade-is-there-much-downtime"></a>Долго ли длится простой во время обновления?
...
### <a name="can-i-roll-back-after-upgrading"></a>Возможен ли откат после обновления?
№ Откат после успешного обновления ресурсов не поддерживается.

### <a name="can-i-validate-my-subscription-or-resources-to-see-if-theyre-capable-of-upgrade"></a>Можно ли проверить подписку или ресурсы, чтобы узнать, подходят ли они для обновления?
...
### <a name="can-i-upgrade-my-csp-based-backup-vault"></a>Можно ли обновить резервное хранилище на основе CSP?
№ Сейчас обновить резервные хранилища на основе CSP невозможно. Мы добавим поддержку для обновления резервных хранилищ на основе CSP в следующих выпусках.

### <a name="can-i-view-my-classic-vault-post-upgrade"></a>Смогу ли я просматривать свое классическое хранилище после обновления?
№ После обновления невозможно будет просмотреть классическое хранилище или управлять им. Для всех операций управления хранилищем можно будет использовать только новый портал Azure.

### <a name="my-upgrade-failed-but-the-machine-that-held-the-agent-requiring-updating-doesnt-exist-anymore-what-do-i-do-in-such-a-case"></a>Мне не удалось обновить хранилище, однако компьютер, на котором был установлен агент, требующий обновления, больше не существует. Что делать в таком случае?
...
### <a name="why-cant-i-see-the-jobs-information-for-my-resources-after-upgrade"></a>Почему после обновления не отображаются сведения о заданиях для моих ресурсов?
