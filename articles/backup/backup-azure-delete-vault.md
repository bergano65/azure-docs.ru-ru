...
- Нельзя удалить хранилище, которое содержит защищенные источники данных (например, виртуальные машины IaaS, базы данных SQL, общие файловые ресурсы Azure и т. д.).  
