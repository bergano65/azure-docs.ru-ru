...
|Предварительные требования для Linux|— Вы можете выполнять резервное копирование виртуальных машин Linux с помощью MABS. Поддерживаются только моментальные снимки с постоянными файлами.|
