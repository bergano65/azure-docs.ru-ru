...
Обратимое удаление в настоящее время поддерживается в регионе "Западная Центральная часть США".
...
* Дополнительные сведения об [атрибутах безопасности для Azure Backup](https://docs.microsoft.com/en-us/azure/backup/backup-security-attributes).
