...
| Операция | Сведения об ошибке | Обходной путь |
| --- | --- | --- |
| Восстановить | **Код ошибки** CBPServerRegisteredVaultDontMatchWithCurrent/Vault Ошибка учетных данных: 100110 <br/> <br/>**Сообщение об ошибке** Исходный и внешний серверы DPM должны быть зарегистрированы в одном хранилище. | **Причина**. Эта проблема возникает при попытке восстановить файлы на альтернативном сервере с исходного сервера с помощью параметра внешнего восстановления DPM, а также в случае, если восстанавливаемый сервер и исходный сервер, с которого выполняется резервное копирование данных, не связаны с одним хранилищем служб восстановления.<br/> <br/>**Возможное решение**. Чтобы устранить эту проблему, убедитесь, что и исходный, и альтернативный серверы зарегистрированы в одном хранилище.|
