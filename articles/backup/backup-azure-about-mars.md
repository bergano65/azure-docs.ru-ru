...
3. Подготовка инфраструктуры:
    ...
    а. Запустите установщик, чтобы [установить агент](https://docs.microsoft.com/azure/backup/install-mars-agent#install-and-register-the-agent).

    б. Используйте Скачанные учетные данные хранилища для регистрации компьютера в хранилище служб восстановления.
4. В консоли агента на клиенте [Настройте резервное копирование](https://docs.microsoft.com/azure/backup/backup-windows-with-mars-agent#create-a-backup-policy). Укажите политику хранения данных резервных копий, чтобы приступить к защите.
