...
1. В **Select group members** (Выбор элементов группы) > выберите виртуальные машины (или папки виртуальных машин), для которых вы хотите создать резервную копию. Нажмите кнопку **Далее**.
