...
Определив неактивный ресурс, вы можете изучить проблему еще раз, перейдя на панель мониторинга элементов резервного копирования или в колонку ресурсов Azure для этого ресурса (когда это возможно). В зависимости от вашего сценария можно либо прерывать резервное копирование компьютера (если он больше не существует), либо удалять ненужные резервные копии, тем самым экономя расходы, а также устранять проблемы на компьютере, чтобы гарантировать надежность резервного копирования.
