...
> [!NOTE]
> Для рабочих нагрузок DPM пользователи могут увидеть небольшое различие (в порядке 20 МБ на сервер DPM) между значениями использования, показанными в отчетах, по сравнению со статистическим значением использования, как показано на вкладке **Обзор** хранилища служб восстановления. Это различие учитывается тем, что каждый сервер DPM, регистрируемый для резервного копирования, имеет связанный источник данных метаданных, который не отображается в качестве артефакта для создания отчетов.
