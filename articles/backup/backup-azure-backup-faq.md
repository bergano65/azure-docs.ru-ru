...
№ Хранилище создается на уровне подписки, и его нельзя перенести в другую подписку.
...
Нет, восстановление IRL не поддерживается.
