...
Azure | 16 дисков данных<br/> Чтобы зарегистрироваться для использования ограниченной предварительной версии виртуальных машин с 16 дисками (до 32 дисков), напишите нам по адресуAskAzureBackupTeam@microsoft.com <br><br> Диск с данными размером до 32 ТБ
