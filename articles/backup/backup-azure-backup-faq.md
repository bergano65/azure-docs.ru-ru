...
Вы можете защитить до 2000 источников данных и элементов во всех рабочих нагрузках (виртуальная машина IaaS, SQL, AFS и т. д.) в хранилище.
...
Виртуальная машина Azure | 16 дисков данных<br/><br/> Диск данных размером до 4095 ГБ
...
Обмен |Сумма размеров всех баз данных Exchange на сервере Exchange, для которого выполняется резервное копирование.
