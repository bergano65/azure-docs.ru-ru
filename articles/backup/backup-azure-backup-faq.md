...
**Операционная система** | **номер SKU** | **Сведения**
--- | --- | ---
Рабочая станция | |
...
Виртуальная машина Azure | 16 дисков данных<br/> Чтобы зарегистрироваться для использования закрытой предварительной версии виртуальных машин, поддерживающих более 16 дисков (до 32 дисков), напишите нам на адрес AskAzureBackupTeam@microsoft.com. <br><br> Диск с данными размером до 32 ТБ
