...
Вы можете зарегистрировать не более 1000 виртуальных машин Azure в одном хранилище. Если вы используете агент резервного копирования Microsoft Azure, вы можете зарегистрировать до 50 агентов MARS на хранилище. И вы можете зарегистрировать 50 серверов MABS/DPM в хранилище.
...
В хранилище можно защитить до 2000 источников данных и элементов для всех рабочих нагрузок (виртуальная машина IaaS, SQL, AFS и т. д.).
Например, если в хранилище вы уже обеспечили защиту для 500 виртуальных машин и 400 общих папок службы "Файлы Azure", то сможете защитить не более 1100 баз данных SQL.

### <a name="how-many-policies-can-i-create-per-vault"></a>Сколько политик можно создать для каждого хранилища?
...
Общий объем данных, которые можно создать резервную часть, не ограничен с помощью хранилища служб восстановления. Индивидуальные источники данных (кроме VMs Azure) могут быть не более 54 400 ГБ в размерах. Для получения дополнительной информации [vault limits section in the support matrix](https://docs.microsoft.com/azure/backup/backup-support-matrix#vault-support)об ограничениях см.
