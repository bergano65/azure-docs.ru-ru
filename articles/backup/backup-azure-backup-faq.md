...
Вы можете защитить до 2000 источников данных и элементов во всех рабочих нагрузках (виртуальная машина IaaS, SQL, AFS и т. д.) в хранилище.<br>  
...
Можно использовать до 200 политик на хранилище.
...
Да. Сведения о перемещении хранилища служб восстановления см. в этой [статье](backup-azure-move-recovery-services-vault.md) .
...
- Сведения [об](backup-azure-file-folder-backup-faq.md)агенте, используемом для резервного копирования папок файлов Azure, см. в этой статье.
...
Azure VM | 16 дисков данных<br/><br/> Диск данных размером до 4095 ГБ
...
- Следующее задание выполнит добавочное резервное копирование относительно уже переданных данных. Добавочное резервное копирование переносит только новые или измененные данные, что соответствует более эффективному использованию пропускной способности.
...
Нет. Политики хранения можно применять только в точках резервного копирования. Например, на этом рисунке показана политика хранения резервных копий, создаваемых на 12am и 18:00.
