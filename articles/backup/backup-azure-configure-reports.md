---
title: Настройка отчетов Power BI
...
5. Укажите метод проверки подлинности "Ключ" и введите ключ для этой учетной записи хранения. Ключи доступа к учетной записи хранения можно найти в портал Azure. Дополнительные сведения см. в статье [Управление ключами доступа учетной записи хранения](../storage/common/storage-account-keys-manage.md).
