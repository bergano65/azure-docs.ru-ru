...
Зашифрованные диски | Поддерживается.<br/><br/> Для виртуальных машин Azure, поддерживающих шифрование дисков Azure, можно создавать резервные копии (с помощью приложения Azure AD или без него).<br/><br/> Зашифрованные виртуальные машины нельзя восстановить на уровне файлов и папок. Необходимо восстановить всю виртуальную машину.<br/><br/> Вы можете включить шифрование на виртуальных машинах, которые уже защищены службой Azure Backup.
