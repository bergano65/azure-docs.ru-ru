...
Диски с включенным ускорителем записи | По состоянию на 23 ноября 2020, поддерживаемое в регионах "Центральная Корея (Крк)" и "Южная Африка" (SAN).<br/><br/> Azure Backup создаст резервную копию виртуальных машин с дисками, на которые записаны записи Акцелартед (WA) во время резервного копирования.  
