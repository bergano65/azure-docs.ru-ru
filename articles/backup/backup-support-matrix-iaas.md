...
**Компонент** | **Поддержка**
--- | ---
Диски данных виртуальной машины Azure | Поддержка резервного копирования виртуальных машин Azure с 32 дисков доступна в общедоступной предварительной версии во всех регионах, кроме национальных облаков (Azure для государственных организаций, Azure для Китая и Azure для Германии).<br><br> Поддержка резервного копирования виртуальных машин Azure с неуправляемыми дисками или классических виртуальных машин возможна только при количестве дисков до 16.
