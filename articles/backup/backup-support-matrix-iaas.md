...
**Компонент** | **Поддержка**
--- | ---
Диски данных виртуальной машины Azure | Резервное копирование виртуальной машины с 16 или меньшим количеством дисков данных. <br/><br/> Поддерживает резервное копирование виртуальных машин с каждым размером диска до 30TB и не более 256TB, Объединенных для всех дисков в виртуальной машине.
Размер диска данных | Отдельный диск может быть не 30TB.
