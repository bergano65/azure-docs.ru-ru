...
**Сценарий** | **Azure Backup** | **Агент** |**Restore**
--- | --- | --- | ---
...
Зашифрованные диски | Поддерживается (до 4 ТБ).<br/><br/> Для виртуальных машин Azure, поддерживающих шифрование дисков Azure, можно создавать резервные копии (с помощью приложения Azure AD или без него).<br/><br/> Зашифрованные виртуальные машины нельзя восстановить на уровне файла или папки. Необходимо восстановить всю виртуальную машину.<br/><br/> Вы можете включить шифрование на виртуальных машинах, которые уже защищены службой Azure Backup.
