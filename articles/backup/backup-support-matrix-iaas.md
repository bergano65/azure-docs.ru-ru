...
Восстановление виртуальной машины контроллера домена (DC), входящей в состав конфигурации с несколькими КОНТРОЛЛЕРами домена, с помощью портала | Поддерживается, если восстановить диск и создать виртуальную машину с помощью PowerShell.
