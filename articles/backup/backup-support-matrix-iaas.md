...
**Компонент** | **Поддержка**
--- | ---
Диски данных виртуальной машины Azure | Поддержка резервного копирования виртуальных машин Azure, имеющих до 32 дисков, находится в общедоступной предварительной версии в [этих регионах](#backup-of-azure-virtual-machines-with-up-to-32-disks).<br><br> Поддержка резервного копирования виртуальных машин Azure с неуправляемыми дисками или классическими виртуальными машинами может быть только до 16 дисков.
...
Azure Backup теперь поддерживает резервное копирование виртуальных машин Azure с подключенными дисками до 32.  Эта функция доступна в общедоступной предварительной версии в западной центральной части США.  Если вы заинтересованы в других регионах, зарегистрируйтесь для ознакомления с ограниченным предварительным просмотром по адресу AskAzureBackupTeam@microsoft.com .  

>[!NOTE]
>Azure Backup поддерживает до 16 дисков для виртуальных машин Azure с неуправляемыми дисками или классическими виртуальными машинами.
...
Резервное копирование поддерживает сжатие трафика резервных копий, как показано в следующей таблице. Следует отметить следующее.
