...
Виртуальные машины Azure в [масштабируемых наборах виртуальных машин](../virtual-machine-scale-sets/overview.md) |Группы доступности не поддерживаются.
...
Резервное копирование виртуальных машин, развернутых в [масштабируемом наборе](../virtual-machine-scale-sets/overview.md) |Поддерживается. Группа доступности не поддерживается.
