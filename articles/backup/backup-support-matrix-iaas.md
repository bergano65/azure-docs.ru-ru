...
**Компонент** | **Поддержка**
--- | ---
Диски данных виртуальной машины Azure | Создайте резервную копию виртуальной машины с 16 или меньшей емкостью дисков данных.<BR> Чтобы зарегистрироваться для использования ограниченной предварительной версии виртуальных машин с 16 дисками (до 32 дисков), напишите нам по адресуAskAzureBackupTeam@microsoft.com
