...
1. Отсортируйте столбец версии агента Azure Backup, выбрав столбец **версия агента** для установки агента MARS или столбец **версия агента Azure Backup** для установок Azure Backup Server.
