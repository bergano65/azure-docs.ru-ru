...
- Чтобы узнать, как переместить виртуальную машину с управляемыми дисками, обратитесь к [этой статье](https://docs.microsoft.com/azure/azure-resource-manager/management/move-resource-group-and-subscription).
