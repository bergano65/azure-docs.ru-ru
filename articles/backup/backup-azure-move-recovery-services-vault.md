...
- Перемещение хранилищ с помощью файлов Azure, Синхронизация файлов Azure или SQL в виртуальных машинах IaaS между подписками и группами ресурсов не поддерживается.
