...
## <a name="register-the-subscription-to-move-your-recovery-services-vault"></a>Регистрация подписки для перемещения хранилища Служб восстановления

Чтобы зарегистрировать подписку для **перемещения** хранилища Служб восстановления, выполните следующие командлеты из терминала PowerShell.
