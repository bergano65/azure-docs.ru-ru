...
> [!NOTE]
> В UX вы по-прежнему можете запланировать столько резервных копий в любой момент времени, однако они будут обрабатываться в скользящем окне, скажем, 5, в соответствии с приведенным выше примером.
...
Переименованная база данных рассматривается как новая база данных. Таким образом, служба будет рассматривать эту ситуацию так, как если бы база данных не была найдена и не завершила создание резервных копий.
