...
Если вы **останавливаете резервное копирование с сохранением данных**, дальнейшие резервные копии не будут выполняться, а существующие точки восстановления останутся без изменений. База данных по-прежнему будет рассматриваться как защищенная и должнаотображаться в архивных элементах.
