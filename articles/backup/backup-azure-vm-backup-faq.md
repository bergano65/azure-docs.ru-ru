...
Если происходит [изменение клиента](https://docs.microsoft.com/azure/devops/organizations/accounts/change-azure-ad-connection) , необходимо отключить и повторно включить [управляемые удостоверения](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/overview) , чтобы сделать резервные копии еще раз.
...
Одним из способов просмотра параметров хранения резервных копий является переход на [панель мониторинга](https://docs.microsoft.com/azure/backup/backup-azure-manage-vms#view-vms-on-the-dashboard) элементов резервного копирования для виртуальной машины в портал Azure. Щелкнув ссылку на политику резервного копирования, можно просмотреть продолжительность хранения всех ежедневных, еженедельных, ежемесячных и ежегодных точек хранения, связанных с виртуальной машиной.

Кроме того, с помощью [обозревателя резервного копирования](https://docs.microsoft.com/azure/backup/monitor-azure-backup-with-backup-explorer) можно просматривать параметры хранения для всех виртуальных машин в одной области. Перейдите к обозревателю архивации из любого хранилища служб восстановления, перейдите на вкладку **элементы резервного копирования** и выберите Расширенное представление, чтобы просмотреть подробные сведения о хранении для каждой виртуальной машины.
