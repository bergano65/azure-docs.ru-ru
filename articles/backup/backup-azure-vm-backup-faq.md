...
Моментальные снимки можно создавать только на дисках данных, включенных в WA, а не на дисках ОС. Поэтому можно защищать только диски данных с включенным WA.
