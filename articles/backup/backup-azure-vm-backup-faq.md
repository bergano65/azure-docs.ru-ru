...
### <a name="maximum-of-how-many-data-disks-can-i-attach-to-a-vm-to-be-backed-up-by-azure-backup"></a>Какое максимальное количество дисков данных можно присоединить к виртуальной машине для резервного копирования Azure Backup?
Azure Backup теперь поддерживает резервное копирование виртуальных машин с количеством дисков до 32. Чтобы получить поддержку 32 дисков, [обновите стек резервного копирования виртуальных машин Azure до версии 2](backup-upgrade-to-vm-backup-stack-v2.md). Включение защиты всех виртуальных машин будет поддерживаться с 24 сентября 2018 г.

### <a name="does-azure-backup-support-standard-ssd-managed-disk"></a>Поддерживает резервная копия Azure Управляемые диски SSD ценовой категории "Стандартный"?
Служба Azure Backup поддерживает [Управляемые диски SSD ценовой категории "Стандартный"](https://azure.microsoft.com/blog/announcing-general-availability-of-standard-ssd-disks-for-azure-virtual-machine-workloads/) — надежное хранилище нового типа для виртуальных машин Microsoft Azure. Он поддерживается для управляемых дисков в [стеке резервного копирования виртуальных машин Azure V2](backup-upgrade-to-vm-backup-stack-v2.md).
