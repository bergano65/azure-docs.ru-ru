...
### <a name="can-i-backup-or-restore-selective-disks-attached-to-a-vm"></a>Можно ли выполнять резервное копирование или восстановление выборочных дисков, подключенных к виртуальной машине?
