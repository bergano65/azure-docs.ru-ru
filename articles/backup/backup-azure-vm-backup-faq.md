...
Azure Backup теперь поддерживает резервное копирование виртуальных машин с количеством дисков до 16. Чтобы получить поддержку 16 дисков, [обновите стек резервного копирования виртуальных машин Azure до версии 2](backup-upgrade-to-vm-backup-stack-v2.md). Включение защиты всех виртуальных машин будет поддерживаться с 24 сентября 2018 г.
