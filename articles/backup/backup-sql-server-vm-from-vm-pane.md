...
8. Для дальнейшей работы или мониторинга, которые необходимо выполнить на резервном SQL Server виртуальной машине, перейдите в соответствующее хранилище службы восстановления. Перейдите к **элементу архивации** , чтобы просмотреть все базы данных, которые были архивированы в этом хранилище, и активируйте такие операции, как резервное копирование и восстановление по запросу. Аналогичным образом перейдите к **заданиям резервного копирования** , чтобы [отслеживать](manage-monitor-sql-database-backup.md) задания, соответствующие операциям, таким как настройка защиты, резервное копирование и восстановление.
