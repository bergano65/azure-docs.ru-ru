...
description: Из этой статьи вы узнаете, как использовать Azure Backup Server для защиты и резервного копирования рабочих нагрузок в Azure Stack.
ms.topic: conceptual
ms.date: 01/31/2019
...
| SQL Server 2012 с пакетом обновления 1 (SP1) | Database |
...
Защита рабочих нагрузок с помощью Azure Backup Server имеет свои особенности. Эти особенности рассматриваются в статье [Установка DPM в виде виртуальной машины Azure](https://docs.microsoft.com/previous-versions/system-center/system-center-2012-R2/jj852163(v=sc.12)). Прежде чем развертывать виртуальную машину, полностью ознакомьтесь с этой статьей.
...
9. Установщик Azure Backup Server состоит из восьми файлов — собственно установщика и семи BIN-файлов. В списке **Имя файла** выберите все необходимые файлы и нажмите кнопку **Далее**. Скачайте все файлы в одну папку.
    ...
    Размер загружаемого файла для всех файлов установки превышает 3 ГБ. При скачивании установочных файлов по ссылке со скоростью 10 Мбит/с процесс может занять до 60 минут. Файлы скачиваются в указанное расположение.
...
При этом подписка Azure должна быть активна. Чтобы узнать состояние подписки и управлять ею, войдите на [портал подписки](https://ms.portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade).
...
| --- | --- | --- | --- | --- | --- |
| Подключен |Активно |Разрешено |Разрешено |Разрешено |Разрешено |
...
| Подключение потеряно на 15 и более дней |Активно |Остановлена |Остановлена |Разрешено |Разрешено |
...
Если брандмауэр или прокси-сервер запрещает доступ к Azure, добавьте следующие адреса домена в список разрешений профиля брандмауэра или прокси-сервера:
