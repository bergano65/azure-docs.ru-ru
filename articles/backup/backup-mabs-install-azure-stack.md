...
Защита рабочих нагрузок с помощью Azure Backup Server имеет свои особенности. [Матрица защиты для MABS](https://docs.microsoft.com/azure/backup/backup-mabs-protection-matrix) помогает объяснить эти особенности. Прежде чем развертывать виртуальную машину, полностью ознакомьтесь с этой статьей.
