...
description: В этой статье узнайте, как использовать сервер резервного копирования Azure для защиты или резервного копирования рабочих нагрузок в Azure Stack.
ms.topic: conceptual
ms.date: 01/31/2019
...
9. Установщик Azure Backup Server состоит из восьми файлов — собственно установщика и семи BIN-файлов. В списке **Имя файла** выберите все необходимые файлы и нажмите кнопку **Далее**. Скачайте все файлы в одну папку.
    ...
    Размер загрузки всех файлов установки больше, чем 3 ГБ. При скачивании установочных файлов по ссылке со скоростью 10 Мбит/с процесс может занять до 60 минут. Файлы скачиваются в указанное расположение.
...
При этом подписка Azure должна быть активна. Чтобы узнать состояние вашей подписки и управлять ею, войдите на [портал подписки.](https://ms.portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade)
...
Если брандмауэр или прокси-сервер препятствуют доступу к Azure, добавьте следующие доменные адреса в профиль брандмауэра/прокси-профиля, позволяющие составить список:
