...
Служба архивации Azure может не подключить том восстановления даже через несколько минут. Во время процесса вы также можете получить сообщения об ошибках. Чтобы приступить к восстановлению в обычном порядке, выполните следующие действия: 
