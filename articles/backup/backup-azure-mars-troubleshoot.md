...
- [Убедитесь, что на сервере установлен платформа .NET Framework 4.5.2 или более поздней версии](https://www.microsoft.com/download/details.aspx?id=30653).
...
Если в журнале заданий **консоли Mars** появляется предупреждение о  >  том, что не удалось запустить задание, так как выполняется другое задание, это может быть вызвано повторным экземпляром задания, запущенного планировщик задач.
...
3. Перейдите в **Диспетчер устройств**  >  **контроллеры хранилища** и найдите **инициатор iSCSI (Майкрософт**). Если вы обнаружите его, перейдите непосредственно к шагу 7.

4. Если не удается найти службу инициатора iSCSI (Майкрософт), попробуйте найти запись в разделе **Диспетчер устройств**  >  **контроллеры хранилища** с именем **неизвестное устройство** с идентификатором оборудования **рут\исксипрт**.
