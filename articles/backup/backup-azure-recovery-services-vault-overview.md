...
Если у вас все еще есть хранилища резервного копирования, они автоматически обновляются до хранилищ служб восстановления. Все резервные хранилища будут обновлены до хранилищ служб восстановления до ноября 2017 г.
...
## <a name="storage-settings-in-the-recovery-services-vault"></a>Настройки хранения в хранилище служб восстановления
...
Резервное копирование Azure автоматически обрабатывает хранилище для хранилища. Узнайте, как [можно изменить настройки хранилища.](https://docs.microsoft.com/azure/backup/backup-create-rs-vault#set-storage-redundancy)

Чтобы узнать больше об избыточности хранилища, [local](https://docs.microsoft.com/azure/storage/common/storage-redundancy-lrs) см. [geo](https://docs.microsoft.com/azure/storage/common/storage-redundancy-grs)
...
![Восстановление Услуги хранилище детали VM](./media/backup-azure-recovery-services-vault-overview/rs-vault-in-context-vm.png)
