...
- **Восстановление между регионами**. восстановление между регионами (КРР) позволяет восстановить виртуальные машины Azure в дополнительном регионе, который является парным регионом Azure. Включив эту функцию на [уровне хранилища](backup-create-rs-vault.md#set-cross-region-restore), можно в любое время восстановить реплицированные данные в дополнительном регионе при выборе. Это позволяет восстановить данные дополнительного региона для обеспечения соответствия аудита и во время сбоя, не дожидаясь объявления аварии в Azure (в отличие от параметров GRS хранилища). [Подробнее.](backup-azure-arm-restore-vms.md#cross-region-restore)
