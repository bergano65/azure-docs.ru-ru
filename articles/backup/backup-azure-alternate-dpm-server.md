...
5. Щелкните правой кнопкой мыши соответствующий элемент и выберите команду **восстановить**.
...
8. Выберите один из вариантов: **Создать копию**, **Пропустить** или **Перезаписать**.
   ...
   * **Пропустить** — если возникает конфликт имен, не восстанавливает файл, что оставляет исходный файл.
