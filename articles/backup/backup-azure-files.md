...
3. В списке файловых ресурсов Azure выберите необходимый ресурс. Отобразятся сведения об **архивируемом элементе**. В меню **Backup Item** (Архивируемый элемент) выберите **Моментальная архивация**. Так как это задание резервного копирования по запросу, политика хранения не связана с точкой восстановления.
...
4. Откроется диалоговое окно **Моментальная архивация**. Укажите срок хранения точки восстановления (последний день).
...
5. Щелкните **ОК**, чтобы подтвердить задание резервного копирования по запросу.
