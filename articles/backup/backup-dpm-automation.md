...
> [!IMPORTANT]
> После создания парольной фразы надежно сохраните ее и никому не сообщайте о ней. Вы не сможете восстановить данные из Azure без этой парольной фразы.
>
>
