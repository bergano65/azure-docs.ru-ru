---
title: Управление базами данных SQL Server и их мониторинг на виртуальной машине Azure с помощью Azure Backup
...
Хотя необходимо указать продолжительность хранения для полной резервной копии только для копирования, диапазон хранения для нерегламентированной полной резервной копии будет автоматически установлен в 45 дней с текущего времени. <br/>
