...
Azure Backup отображаются все задания, активированные вручную на портале **задания резервного копирования** . Задания, отображаемые на этом портале, включают в себя операции обнаружения и регистрации базы данных, а также резервного копирования и восстановления.
