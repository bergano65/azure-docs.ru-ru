---
title: Управление базами данных SQL Server и их мониторинг на виртуальной машине Azure, для которой создана резервная копия Azure Backup | Документация Майкрософт
...
6. Выберитепункт прерывать архивацию.


> [!NOTE]
>
Дополнительные сведения о параметре Delete Data см. в разделе часто задаваемых вопросов.
...
Хотя необходимо указать продолжительность хранения для полной резервной копии только для копирования, диапазон хранения для других типов резервных копий автоматически задается в течение 30 дней с текущего времени. <br/>
