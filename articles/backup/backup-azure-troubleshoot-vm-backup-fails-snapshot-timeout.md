...
Операция резервного копирования может завершиться ошибкой при резервном копировании виртуальной машины с размером диска более 30 ТБ. Кроме того, в настоящее время не поддерживается резервное копирование зашифрованных дисков размером больше 4 ТБ. Убедитесь, что размер дисков меньше или равен поддерживаемому ограничению, путем разбиения дисков.
