...
## <a name="ExtentionOperationFailed-vmsnapshot-extension-operation-failed"></a>ExtentionOperationFailed — сбой в ходе работы расширения VMSnapshot

**Код ошибки**: ExtentionOperationFailed. <br>
...
* [Очистка коллекции точек восстановления на портале, созданном службой Backup](#clean-up-restore-point-collection-from-portal-created-by-backup-service)<br>
...
#### <a name="clean-up-restore-point-collection-from-portal-created-by-backup-service"></a>Очистка коллекции точек восстановления на портале, созданном службой Backup<br>

Чтобы вручную очистить коллекцию точек восстановления, которая не очищается из-за блокировки группы ресурсов, сделайте следующее:
1. Войдите на [портале Azure](http://portal.azure.com/).
