...
3. В диалоговом окне **Все службы** введите **Хранилища Служб**. Элементы списка фильтруются автоматически по мере ввода символов. Когда появится строка **Хранилища Служб восстановления**, щелкните ее, чтобы отобразился список хранилищ Служб восстановления в вашей подписке.
