...
| ----------- | ----------- |
| Критический | Критические оповещения создаются в следующих ситуациях: сбой задания резервного копирования, сбой задания восстановления, прекращение защиты сервера с сохранением данных.|
| Предупреждение | Предупреждение появляется, когда: задания резервного копирования выполнены с предупреждениями, например, когда менее 100 файлов не архивируются из-за проблем с повреждением или при успешном резервном копировании файлов больше 1 000 000. |
