...
В представленном выше меню оповещений резервного копирования используются следующие фильтры: состояние "Активно", уровень серьезности "Критический" и период, составляющий последние 24 часа.
...
| ----------- | ----------- |
| критические ошибки. | Критические оповещения создаются в следующих ситуациях: сбой задания резервного копирования, сбой задания восстановления, отмена защиты сервера с сохранением данных.|
| Предупреждение | Критические оповещения создаются в следующих ситуациях: завершение заданий резервного копирования с предупреждениями (например, если не удалось скопировать менее 100 файлов из-за повреждения данных или успешно скопировано более 1 000 000 файлов). |
...
В хранилище Служб восстановления хранятся данные резервного копирования нескольких типов. [Дополнительные сведения](backup-overview.md#what-can-i-back-up) о резервного копирования. Чтобы перейти к управлению серверами, компьютерами, базами данных и рабочими нагрузками, выберите плитку **элементов резервного копирования** и просмотрите содержимое хранилища.
...
**Действия по устранению неполадок**. Процесс ```OBRecoveryServicesManagementAgent``` отправляет данные задания и оповещение в службу Azure Backup. Иногда этот процесс может зависнуть или завершить работу.
...
* Посетите [форум о службе архивации Azure](https://go.microsoft.com/fwlink/p/?LinkId=290933)
