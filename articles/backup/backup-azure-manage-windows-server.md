...
1. Войдите в [портал Azure](https://portal.azure.com/) с помощью подписки Azure.
...
| ----------- | ----------- |
| Критически важно | Критические оповещения создаются в следующих ситуациях: сбой задания резервного копирования, сбой задания восстановления, прекращение защиты сервера с сохранением данных.|
...
| Информационное | Сейчас информационные оповещения не используются. |
...
В хранилище Служб восстановления хранятся данные резервного копирования нескольких типов. Дополнительные [сведения](backup-overview.md#what-can-i-back-up) о возможностях резервного копирования. Чтобы перейти к управлению серверами, компьютерами, базами данных и рабочими нагрузками, выберите плитку **элементов резервного копирования** и просмотрите содержимое хранилища.
