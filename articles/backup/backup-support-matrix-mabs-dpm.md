...
--- | --- | ---
Подключен | Активно | Создайте резервную копию на диске DPM/MABS.<br/><br/> Резервное копирование в Azure.<br/><br/> Восстановление с диска.<br/><br/> Восстановление из Azure.
