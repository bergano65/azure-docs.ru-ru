...
**.NET Framework в MABS** | Для виртуальной машины MABS требуется платформа .NET Framework 3,3 с пакетом обновления 1 (SP1) или более поздней версии.
...
Серверу DPM/MABS требуется доступ к этим URL-адресам и IP-адреса:
