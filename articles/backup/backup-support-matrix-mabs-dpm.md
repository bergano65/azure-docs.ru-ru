...
**Windows 2008 R2 (Standard и Enterprise)**<br/><br/> 32/64-разрядная | Для MABS v3, v2 в ОС должен быть установлен пакет обновления 1 (SP1). | Локальный компьютер или виртуальная машина Azure. | **Локальная защита**. Том, общая папка, папка, файл; состояние системы, исходное состояние системы.<br/><br/> **Защита виртуальных машин Azure**. Том, общая папка, папка, файл.<br/><br/> Поддерживаются дедуплицированные тома. |
