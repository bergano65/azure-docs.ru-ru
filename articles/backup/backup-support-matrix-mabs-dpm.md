...
Сведения о различных серверах и рабочих нагрузках, которые можно защитить с помощью Data Protection Manager, см. в статье [что может сделать резервное копирование DPM?](/system-center/dpm/dpm-protection-matrix?view=sc-dpm-2019).
