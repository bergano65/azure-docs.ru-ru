...
MABS основан на System Center DPM и предоставляет аналогичные функции с несколькими отличиями:
...
**Резервное копирование виртуальных машин и рабочих нагрузок Azure** | DPM/MABS Protection Agent на защищенном компьютере.<br/><br/> Агент MARS на сервере DPM/MABS. | Сервер DPM или MABS должен быть запущен на виртуальной машине Azure
...
**Windows 2008 R2 с пакетом обновления 1 (Standard и Enterprise)**<br/><br/> 32/64-разрядная | Поддерживается в MABS v3, v2.<br/><br/> Необходимо установить [Windows Management Framework 4.0](https://www.microsoft.com/download/details.aspx?id=40855). | Локальный компьютер или виртуальная машина Azure. |   **Локальная защита**. Том, общая папка, папка, файл; состояние системы, исходное состояние системы.<br/><br/> **Защита виртуальных машин Azure**. Том, общая папка, папка, файл.<br/><br/> Поддерживаются дедуплицированные тома. |
...
**Windows Server 2008 с пакетом обновления 2**<br/><br/> 32/64-разрядная | MABS v2, v3 | MABS версии 2, v3 поддерживается, когда MABS развертывается как виртуальная машина VMware.<br/><br/> Не поддерживается для MABS, запущенной на виртуальной машине Azure. | Том, общая папка, папка, файл; состояние системы, исходное состояние системы. |
**Windows Storage Server 2008** | MABS v2, v3 | MABS как локальный физический сервер или виртуальная машина Hyper-V. <br/><br/> Не поддерживается для MABS, запущенной на виртуальной машине Azure. | Том, общая папка, папка, файл; состояние системы, исходное состояние системы.
...
**Windows Server 2012 R2 (Datacenter и Standard)**<br/><br/> 32/64-разрядная | Локальный компьютер или виртуальная машина Azure. | **Локальная защита**. Том, общая папка, папка, файл; состояние системы, исходное состояние системы.<br/><br/> **Защита виртуальных машин Azure**. Том, общая папка, папка, файл.<br/><br/> Нечередующиеся тома поддерживаются с помощью DPM 2012 R2 и более поздних версий.
**Windows Server 2012 с пакетом обновления 1 (Datacenter и Standard)**<br/><br/> 32/64-разрядная | Локальный компьютер или виртуальная машина Azure. | **Локальная защита**. Том, общая папка, папка, файл; состояние системы, исходное состояние системы.<br/><br/> **Защита виртуальных машин Azure**. Том, общая папка, папка, файл.<br/><br/> Нечередующиеся тома поддерживаются с помощью DPM 2012 R2 и более поздних версий.
