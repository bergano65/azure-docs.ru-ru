...
--- | --- | --- | --- |
**Windows 10 @ no__t-1Windows 8.1 @ no__t-2Windows 8 @ no__t-3Windows 7**<br/><br/>(32/64-разрядная) | MABS версий 2, 3 | Локальная система. | Том, общая папка, папка, файл.<br/><br/> Поддерживаются дедуплицированные тома.<br/><br/> Тома должны быть размером не менее 1 ГБ и быть типа NTFS. |
