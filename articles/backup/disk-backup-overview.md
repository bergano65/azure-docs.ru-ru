...
- Первым шагом при настройке резервного копирования для управляемых дисков Azure является создание [резервного хранилища](backup-vault-overview.md). Хранилище предоставляет объединенное представление резервных копий, настроенных для разных рабочих нагрузок.
