...
> [!Note]
> 
> * Имя скачанного файла скрипта будет содержать **географическое имя** , которое будет заполнено URL-адресом. Пример: Имя скачанного скрипта начинается \'с\'VMname\_\'\'геоимени\'_GUID\', например ContosoVM_wcus_12345678....<br><br>
