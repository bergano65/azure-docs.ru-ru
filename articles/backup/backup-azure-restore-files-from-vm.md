...
Так как процесс восстановления файлов присоединяет все диски из резервной копии (в случае большого количества дисков (> 16) или больших дисков (> 4 ТБ каждый), рекомендуется использовать следующие точки действий.
