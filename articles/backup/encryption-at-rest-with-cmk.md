...
- Эта функция не связана с [шифрованием дисков Azure](../security/fundamentals/azure-disk-encryption-vms-vmss.md), которое использует шифрование дисков виртуальной машины на виртуальной машине с помощью BitLocker (для Windows) и DM-encryption (для Linux).
