---
title: Azure Backup Server и DPM (Data Protection Manager) вопросы и ответы
description: В этой статье вы найдете ответы на часто задаваемые вопросы о Microsoft Azure Backup сервере (MABS) и DPM.
