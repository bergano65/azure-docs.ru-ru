...
5. В раскрывающемся списке **Настроена ли Многофакторная идентификация Azure?** укажите, включена ли у вас [Многофакторная идентификация Azure](../active-directory/authentication/concept-mfa-howitworks.md). Если она включена, при входе на портал Azure вам будет предложено подтвердить аутентификацию со второго устройства (например, с мобильного телефона).
