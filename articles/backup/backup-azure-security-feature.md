...
> [!NOTE]
> Если вы используете резервную копию виртуальной машины в виде службы (IaaS), не следует включать функции безопасности. Эти функции пока не доступны для резервного копирования виртуальных машин IaaS, поэтому их включение не окажет никакого влияния. Функции безопасности следует включать, только если вы используете следующие компоненты. <br/>
>
