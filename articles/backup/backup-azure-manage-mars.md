...
1. В меню **приостановить архивацию по расписанию** проверьте сведения и нажмите кнопку **Готово** , ![изменить или остановить архивацию по расписанию.](./media/backup-azure-manage-mars/pause-schedule-backup.png)
...
1. Выберите **повторно включить расписание архивации. Можно также изменить элементы резервного копирования или время** и нажать кнопку **Далее**.
