...
- Чтобы восстановить компьютер, выполните следующие действия.
  - [Восстановление виртуальной машины на другой целевой компьютер](backup-azure-restore-windows-server.md#use-instant-restore-to-restore-data-to-an-alternate-machine)
  - Повторное создание целевого компьютера с тем же именем узла, что и у исходного компьютера
  - Установка агента и повторная регистрация в том же хранилище и с той же парольной фразой
  - Запустите клиент MARS, чтобы продлить срок хранения в соответствии с вашими требованиями.
