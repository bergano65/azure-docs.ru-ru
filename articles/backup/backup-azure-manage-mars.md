...
1. В окне **изменение процесса резервного копирования**Проверьте состояние "приостановлено" для расписания резервного копирования и нажмите кнопку **Закрыть** для завершения.
...
1. Введите новую парольную фразу или нажмите кнопку " **создать парольную фразу**".
