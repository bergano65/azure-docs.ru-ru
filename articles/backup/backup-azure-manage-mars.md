...
1. В окне " **изменение хода архивации**" Проверьте состояние "приостановлено резервное копирование" и нажмите кнопку " **Закрыть** " для завершения.
