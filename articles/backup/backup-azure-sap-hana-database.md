...
**Поддерживаемые версии HANA** | SSDC на HANA 1.x, MDC в HANA 2.x < = SPS03
...
2.  На виртуальной Машине установить и включить пакеты драйверов ODBC с официальной SLES пакета/носителя с помощью zypper, следующим образом:
    ...
    ```
4.  Разрешить подключение из виртуальной Машины к Интернету, таким образом, чтобы он достигнет Azure, как описано в следующей процедуре.
