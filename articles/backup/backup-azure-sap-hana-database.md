...
7. В поле **Политика добавочного резервного копирования** выберите **включить** , чтобы открыть элементы управления периодичностью и удержанием.
