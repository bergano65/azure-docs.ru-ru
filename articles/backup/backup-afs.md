...
Функция резервного копирования файловых ресурсов Azure находится в стадии предварительной версии. Файловые ресурсы Azure поддерживаются в учетных записях хранения общего назначения версий 1 и 2. Ниже приведены ограничения резервного копирования файловых ресурсов Azure.

* Поддержка резервного копирования файловых ресурсов Azure в учетных записях хранения с репликацией [хранилища, избыточной](https://docs.microsoft.com/azure/storage/common/storage-redundancy-zrs) в пределах зоны (ZRS), в настоящее время ограничена [этими регионами](https://docs.microsoft.com/azure/backup/backup-azure-files-faq#in-which-geos-can-i-back-up-azure-file-shares).
...
* Не удаляйте моментальные снимки, созданные Azure Backup. Удаление моментальных снимков может привести к утрате точек восстановления или ошибок восстановления.
* Не удаляйте файловые ресурсы, защищенные Azure Backup. Текущее решение удаляет все моментальные снимки, созданные Azure Backup после удаления общей папки, поэтому все точки восстановления будут потеряны.
...
1. Отслеживайте уведомления на портале, чтобы следить за завершением выполнения задания резервного копирования. Ход выполнения задания можно отслеживать на панели мониторинга хранилища. Выберите **задания резервного копирования** > **выполняется**.
