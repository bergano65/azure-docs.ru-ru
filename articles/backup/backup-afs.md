...
ms.locfileid: "87077139"
---
# <a name="back-up-azure-file-shares"></a>Резервное копирование файловых ресурсов Azure

В этой статье объясняется, как использовать портал Azure для резервного копирования [файловых ресурсов Azure](../storage/files/storage-files-introduction.md).
