...
>[!NOTE]
> Некоторые элементы портал Azure интерфейса могут быть недоступны в данный момент. Ознакомьтесь с альтернативными возможностями в таких сценариях, пока не будет выполнена полная доступность в вашем регионе.
...
1. В области **Создание частной зоны DNS** введите необходимые сведения. Подписка должна совпадать с той, где будет создана частная конечная точка.
    ...
    | **Зону**                           | **Служеб** | **Сведения о подписке и группе ресурсов (RG)**                  |
    | ---------------------------------- | ----------- | ------------------------------------------------------------ |
...
| **Зону**                                                     | **Служеб** | **Сведения о подписке и группе ресурсов**                  |
| ------------------------------------------------------------ | ----------- | ------------------------------------------------------------ |
...
Для соглашений об именовании URL-адресов в Национальный геообъектов:
...
Приватиндпоинтконтрибуторроледеф. JSON
...
Нетворкинтерфацереадерроледеф. JSON
...
Приватиндпоинтсубнетконтрибуторроледеф. JSON
