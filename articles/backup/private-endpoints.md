...
>[!NOTE]
> Этот шаг не требуется, если вы используете интегрированную зону DNS. Тем не менее, если вы создали собственную зону Azure Частная зона DNS или используете собственную закрытую зону DNS, убедитесь, что записи созданы, как описано в этом разделе.
