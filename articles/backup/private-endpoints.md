...
Вы можете интегрировать частные конечные точки с частными зонами DNS для Azure Backup (рассматривается в разделе [Создание и использование частных конечных точек для резервного копирования](#creating-and-using-private-endpoints-for-backup)) для обмена данными между службами. Если вы не хотите интегрироваться с частной зоной DNS, вы можете использовать собственный DNS-сервер или отдельно создать частную зону DNS. Это дополнение к двум обязательным частным зонам DNS, обсуждаемым в предыдущем разделе.
...
>[!NOTE]
> Этот шаг не требуется, если вы используете интегрированную зону DNS. Однако, если вы создали собственную зону Azure Частная зона DNS или используете собственную закрытую зону DNS, убедитесь, что записи созданы, как описано в этом разделе.
