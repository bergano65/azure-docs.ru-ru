...
| Серверы (64-разрядные)          | Windows Server 2019, 2016, 2012 R2, 2012                    | Виртуальная машина Azure (если Рабочая нагрузка работает как виртуальная машина Azure)  <br><br>    Физический сервер  <br><br>    Виртуальные машины Hyper-V <br><br>     Виртуальная машина VMware  <br><br>    Azure Stack | V3 UR1                            | Том, общий ресурс, папка, файл <br><br>    Тома с дедупликацией (только NTFS)  <br><br>   Состояние системы и система исходного состояния (не поддерживается, если Рабочая нагрузка работает как виртуальная машина Azure) |
| Серверы (64-разрядные)          | Windows Server 2008 R2 с пакетом обновления 1 (SP1), Windows Server 2008 SP2 (необходимо установить [Windows Management Framework](https://www.microsoft.com/download/details.aspx?id=54616)) | Физический сервер  <br><br>    Виртуальные машины Hyper-V  <br><br>      Виртуальная машина VMware  <br><br>   Azure Stack | V3 UR1                            | Тома, общие ресурсы, папки, файлы, состояние системы или восстановление исходного состояния        |
