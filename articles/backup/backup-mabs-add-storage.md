...
>
> Для обеспечения расширенного резервного копирования производительность рекомендуется развернуть MABS v3 с многоуровневым хранилищем на Windows Server 2019. Инструкции по настройке многоуровневого хранилища см. в статье DPM "[Настройка MBS с многоуровневым хранилищем](/system-center/dpm/add-storage#set-up-mbs-with-tiered-storage)".
