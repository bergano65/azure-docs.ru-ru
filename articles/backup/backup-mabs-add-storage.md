...
Хранилище с учетом рабочих нагрузок можно настроить с помощью командлета PowerShell Update-DPMDiskStorage, обновляющего свойства тома в пуле носителей в Azure Backup Server. 
