...
> [!NOTE]
>
> - Добавьте в пул только один диск, чтобы число столбцов оставалось равным 1. После этого можно добавить диски, как нужно позже.
> - При добавлении нескольких дисков в пул носителей в Go количество дисков хранится в виде числа столбцов. При добавлении дополнительных дисков они могут быть только кратными количеству столбцов.
