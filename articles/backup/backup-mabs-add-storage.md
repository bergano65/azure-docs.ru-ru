...
>
> Для достижения улучшенных показателей резервного копирования мы рекомендуем развернуть MABS v3 с многоуровневым хранилищем на Windows Server 2019. Пожалуйста, обратитесь к статье DPM "[Настройка MBS с tiered Storage](https://docs.microsoft.com/system-center/dpm/add-storage?view=sc-dpm-2019#set-up-mbs-with-tiered-storage)" для шагов по настройке многоуровневого хранилища.
...
1. В серверном менеджере выберите пулы хранения **файлов и служб** > хранения**данных.** > **Storage Pools** В разделе **ФИЗИЧЕСКИЕ ДИСКИ** выберите **Новый пул носителей**.
...
6. В диалоговом окне **Выбор сервера или диска** выберите сервер и новый диск. Затем выберите **Следующий**.
...
Вы можете настроить хранилище данных, осведомленное о рабочей нагрузке, с помощью обновления PowerShell cmdlet Update-DPMDiskStorage, который обновляет свойства тома в пуле хранения на сервере резервного копирования Azure.
...
1. В консоли администратора выберите **Управление** > **диском Хранения** > **Добавить**.
