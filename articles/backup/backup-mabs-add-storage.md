...
>
> Для обеспечения расширенного резервного копирования производительность рекомендуется развернуть MABS v3 с многоуровневым хранилищем на Windows Server 2019. Инструкции по настройке многоуровневого хранилища см. в статье DPM "[Настройка MBS с многоуровневым хранилищем](/system-center/dpm/add-storage?view=sc-dpm-2019#set-up-mbs-with-tiered-storage)".
...
4. Настройте хранилище с поддержкой рабочей нагрузки.
...
1. В Диспетчер сервера выберите **файл и службы хранилища**  >  **тома**  >  **Пулы носителей**. В разделе **ФИЗИЧЕСКИЕ ДИСКИ** выберите **Новый пул носителей**.

    ![Создание пула носителей](./media/backup-mabs-add-storage/mabs-add-storage-1.png)
...
> [!NOTE]
>
> - Добавьте только один диск в пул, чтобы число столбцов было равно 1. Тогда вы можете добавлять диски в любом количестве по мере необходимости.
> - Если добавить в пул сразу несколько дисков, их число сохраняется в параметре количества столбцов. Таким образом, число добавляемых впоследствии дисков должно быть кратным числу столбцов.
...
1. В консоли администратора выберите функцию **Защита**. В списке **Член группы защиты** щелкните элемент правой кнопкой мыши и выберите пункт **Остановить защиту элемента**.
   ...
   ![Остановка защиты элемента](/system-center/dpm/media/upgrade-to-dpm-2016/dpm-2016-stop-protection1.png)

2. В диалоговом окне **Удалить из группы** проверьте используемый объем дискового пространства и объем доступного свободного пространства для пула носителей. По умолчанию точки восстановления остаются на диске, а их срок хранения истекает согласно связанной политике хранения. Щелкните **ОК**.
   ...
   ![Диалоговое окно "Удалить из группы"](/system-center/dpm/media/upgrade-to-dpm-2016/dpm-2016-retain-data.png)
...
1. В консоль администратора выберите **Управление**  >  **хранилище дисков**  >  **Добавить**.

    ![Диалоговое окно "Добавить дисковый накопитель"](/system-center/dpm/media/upgrade-to-dpm-2016/dpm-2016-add-disk-storage.png)
