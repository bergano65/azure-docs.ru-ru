...
* Операционная система (64 бит): Windows Server 2019, 2016, 2012 R2, 2012.
* SQL Server: SQL Server 2019, SQL Server 2017, 2016.
* Обмен: Exchange 2019, 2016.
* SharePoint: SharePoint 2019, 2016 с последним пакетом обновления.
...
С помощью MABS v3 UR1 теперь можно защитить виртуальные машины, развернутые в [решении VMware для Azure](https://docs.microsoft.com/azure/azure-vmware/).
...
### <a name="support-for-additional-layer-of-authentication-to-delete-online-backup"></a>Поддержка дополнительного уровня проверки подлинности для удаления оперативного резервного копирования
...
MABS v3 UR1 улучшает работу автономного резервного копирования с помощью службы импорта и экспорта Azure. Дополнительные сведения см. [здесь](https://docs.microsoft.com/azure/backup/backup-azure-backup-server-import-export).
...
>[!NOTE]
>Ознакомьтесь с [обновленной матрицей защиты](https://docs.microsoft.com/azure/backup/backup-mabs-protection-matrix) , чтобы узнать о поддерживаемых рабочих нагрузках для защиты с помощью MABS UR 1.
