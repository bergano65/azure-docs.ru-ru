...
Компоненты | На сервере DPM должен быть Windows PowerShell и платформа .NET Framework 4.5.
...
Azure ExpressRoute | Если Azure ExpressRoute настроен пиринг Майкрософт или частный, он не может использоваться для резервного копирования данных в Azure.<br/><br/> Если Azure ExpressRoute настроен с общедоступным Пирингом, его можно использоваться для резервного копирования данных в Azure.<br/><br/> **Примечание.** Общедоступный Пиринг является устаревшим для новых каналов.
