...
1. Убедитесь, что у вас есть одна или несколько виртуальных машин [Windows](../security/azure-security-disk-encryption-windows.md) или [Linux](../virtual-machines/linux/disk-encryption-overview.md) с включенными файлами ADE.
...
3. В > **цели резервного копирования** **, где выполняется ваша рабочая нагрузка?** выберите **Azure**.
...
5. В > **политика резервного копирования** **выберите Политика архивации**, выберите политику, которую нужно связать с хранилищем. Нажмите кнопку **ОК**.
...
5. В поле **создать резервную копию**используйте элемент управления Calendar, чтобы выбрать последний день, в который должна храниться точка восстановления. Нажмите кнопку **ОК**.
...
6. В окне **Добавление политики доступа** > **настроить из шаблона (необязательно)** выберите **Azure Backup**.
...
2. Затем выполните одно из следующих действий.
    - Используйте шаблон, созданный во время операции восстановления, чтобы настроить параметры виртуальной машины и активировать развертывание виртуальной машины. [Дополнительные сведения](backup-azure-arm-restore-vms.md#use-templates-to-customize-a-restored-vm)
    - Создайте новую виртуальную машину на основе восстановленных дисков с помощью PowerShell. [Дополнительные сведения](backup-azure-vms-automation.md#create-a-vm-from-restored-disks)
