...
5. В **политика архивации** > **Выбор политики архивации**, выберите политику, в которой вы хотите связать с хранилищем. Нажмите кнопку **ОК**.
...
6. Последовательно выберите **ОК**. **Резервное копирование службы управления** добавляется **политики доступа**.
