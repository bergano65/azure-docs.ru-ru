...
5. В > **политика резервного копирования** **выберите Политика архивации**, выберите политику, которую нужно связать с хранилищем. Затем нажмите кнопку **ОК**.
