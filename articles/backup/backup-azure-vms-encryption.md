...
- Дополнительные сведения о [ADE](../security/azure-security-disk-encryption-overview.md), [Key Vault](../key-vault/key-vault-overview.md)и [ключи обмена ключами](https://docs.microsoft.com/azure/virtual-machine-scale-sets/disk-encryption-key-vault#set-up-a-key-encryption-key-kek/).
...
2. Повторно создайте экземпляр виртуальной машины, выполнив одно из следующих действий.
    1. Используйте шаблон, созданный во время операции восстановления, чтобы настроить параметры виртуальной машины и активировать развертывание виртуальной машины. [Дополнительные сведения](backup-azure-arm-restore-vms.md#use-templates-to-customize-a-restored-vm)
    2. Создайте новую виртуальную машину на основе восстановленных дисков с помощью PowerShell. [Дополнительные сведения](backup-azure-vms-automation.md#create-a-vm-from-restored-disks)
