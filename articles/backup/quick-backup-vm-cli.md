...
ms.locfileid: "98805462"
---
# <a name="back-up-a-virtual-machine-in-azure-with-the-azure-cli"></a>Резервное копирование виртуальной машины в Azure с помощью Azure CLI
...
Чтобы отслеживать состояние заданий резервного копирования, используйте команду [az backup job list](/cli/azure/backup/job#az-backup-job-list):
