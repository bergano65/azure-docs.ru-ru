...
5. Настройте файл **VMSnapshotScriptPluginConfig.json**, как описано далее.
    ...
    - **timeoutInSeconds**: укажите разное время ожидания для скриптов предварительного и последующего выполнения (максимальное допустимое значение — 1800).
