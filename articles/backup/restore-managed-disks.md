...
- Если восстановленный диск является диском данных для виртуальных машин Windows, следуйте инструкциям по [отсоединению исходного диска данных](../virtual-machines/windows/detach-disk.md#detach-a-data-disk-using-the-portal) от виртуальной машины. Затем [Подключите восстановленный диск](../virtual-machines/windows/attach-managed-disk-portal.md) к виртуальной машине. Следуйте инструкциям по [переключению диска ОС](../virtual-machines/windows/os-disk-swap.md) виртуальной машины на восстановленный диск.

- Если восстановленный диск является диском данных для виртуальных машин Linux, следуйте инструкциям по [отсоединению исходного диска данных](../virtual-machines/linux/detach-disk.md#detach-a-data-disk-using-the-portal) от виртуальной машины. Затем [Подключите восстановленный диск](../virtual-machines/linux/attach-disk-portal.md#attach-an-existing-disk) к виртуальной машине. Следуйте инструкциям по [переключению диска ОС](../virtual-machines/linux/os-disk-swap.md) виртуальной машины на восстановленный диск.
