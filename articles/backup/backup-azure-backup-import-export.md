...
Вы можете отслеживать состояние задания импорта из портал Azure. Перейдите на страницу **Импорт и экспорт заданий** и выберите задание. Дополнительные сведения о состоянии заданий импорта см. в статье [что такое служба импорта и экспорта Azure?](../import-export/storage-import-export-service.md).
