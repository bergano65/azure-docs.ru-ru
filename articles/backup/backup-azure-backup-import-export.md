...
1. Когда вы создаете расписание для резервного копирования на агенте MARS, отображается следующий экран.
    ...
    * **Учетная запись хранения Azure Resource Manager** — Имя диспетчера ресурсов тип учетной записи хранения (общего назначения версии 1 или 2) в любой подписке Azure.
