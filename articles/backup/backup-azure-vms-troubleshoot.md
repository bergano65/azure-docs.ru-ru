...
* Проверьте, соответствует ли компьютер, на котором выполняется сценарий, требованиям операционной системы. [Подробнее.](./backup-azure-restore-files-from-vm.md#system-requirements)  
* Убедитесь, что вы не восстанавливаете тот же источник, дополнительные [сведения](./backup-azure-restore-files-from-vm.md#original-backed-up-machine-versus-another-machine).
