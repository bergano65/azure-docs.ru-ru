...
* **Журнал событий** может показывать ошибки резервного копирования, которые относятся к другим продуктам резервного копирования, например системе архивации данных Windows Server, и не связаны с архивацией Azure. Чтобы определить, связан ли сбой с Azure Backup, выполните следующие действия.
