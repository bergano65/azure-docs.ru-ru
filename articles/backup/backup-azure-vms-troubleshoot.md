...
Чтобы проверить, перейдите в раздел ***системы и Просмотр событий Журналы приложений** _ и проверьте следующее сообщение об ошибке:<br>
Истекло время ожидания поставщика теневого копирования _The при удержании записи на копируемый том. Возможно, это произошло из-за чрезмерной активности тома приложением или системной службой. Повторите попытку позже, когда будет уменьшено действие на томе. *<br>
