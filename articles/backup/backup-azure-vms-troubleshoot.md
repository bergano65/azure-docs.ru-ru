...
Сбой операции резервного копирования из-за проблемы с **системным приложением COM+** службы Windows.  Для устранения этой проблемы выполните следующие действия.
...
Сбой операции резервного копирования из-за несоответствия состояния расширения резервного копирования. Для устранения этой проблемы выполните следующие действия.
