...
- Для резервного копирования виртуальных машин, использующих хранилище класса Premium, рекомендуется запустить последнюю версию Azure Backup ([мгновенное восстановление](backup-instant-restore-capability.md)). Если вы не используете последнюю версию, резервное копирование выделяет около 50 процентов от общего объема хранилища. Службе архивации требуется это пространство для копирования моментального снимка в ту же учетную запись хранения и ее передачи в хранилище.
