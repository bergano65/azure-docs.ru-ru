...
Длительное выполнение резервного копирования может быть связано с несколькими причинами:
  1. **Первое резервное копирование диска, уже добавленного к уже защищенной виртуальной машине** <br>
    Если для виртуальной машины завершено начальное резервное копирование и выполняется добавочное резервное копирование. Добавление новых дисков может прервать действие Соглашения об уровне обслуживания на один день в зависимости от размера нового диска.
  2. **Фрагментация** <br>
    Если для рабочей нагрузки (приложения), запущенной на виртуальной машине, выполняются операции записи небольших объемов фрагментированным данных, это может отрицательно повлиять на производительность резервного копирования. <br>
  3. **Перегруженные учетные записи хранения** <br>
      a. Если резервное копирование запланировано во время пикового использования приложений.  
      b. Если из одной и той же учетной записи хранения размещаются более 5–10 дисков.<br>
  4. **Проверка согласованности** <br>
      Если для дисков размером более 1 ТБ резервное копирование выполняется в режиме проверки согласованности из-за следующих причин:<br>
        a. Управляемый диск перемещается в рамках перезапуска виртуальной машины.<br>
        b. Преобразование моментального снимка в базовый большой двоичный объект.<br>
