...
- Для резервного копирования виртуальных машин, использующих хранилище класса Premium, при мгновенном восстановлении рекомендуется выделить *50%* свободного пространства для общего выделенного пространства, которое требуется **только** для первой резервной копии. 50 % свободного пространства не является обязательным требованием для создания резервных копий после завершения первой операции архивации.
