...
**Закрепленные виртуальные машины зоны** | При создании резервной копии виртуальной машины Azure, прикрепленной к зоне (с Azure Backup), ее можно восстановить в той же зоне, в которой она была закреплена. [Подробнее](../availability-zones/az-overview.md)
