...
В процессе восстановления вы увидите параметр **Зона доступности.** Сначала вы увидите свою зону по умолчанию. Чтобы выбрать другую зону, выберите нужный вариант. Если закрепленная зона недоступна, вы не сможете восстановить данные в другую зону, так как резервные копии данных не зоналли реплицированы.
...
Существует множество распространенных сценариев, в которых может потребоваться восстановить виртуальные машины.
...
После восстановления виртуальной машины необходимо отметить несколько моментов.
