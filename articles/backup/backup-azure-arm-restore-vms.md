...
**Закрепленные виртуальные машины зоны** | При резервном копировании виртуальной машины Azure, прикрепленной к зоне (с Azure Backup), ее можно восстановить в той же зоне, в которой она была закреплена. [Дополнительные сведения](https://docs.microsoft.com/azure/availability-zones/az-overview)
