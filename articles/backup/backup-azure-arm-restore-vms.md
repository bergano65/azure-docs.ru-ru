...
> [!NOTE]
> Вы также можете восстановить определенные файлы и папки на виртуальной машине Azure. [Дополнительные сведения](backup-azure-restore-files-from-vm.md).
...
1. В поле **промежуточное расположение** укажите учетную запись хранения для виртуальной машины. [Дополнительные сведения](#storage-accounts).
...
1. В поле **промежуточное расположение** укажите учетную запись хранения, в которую копируются виртуальные жесткие диски. [Дополнительные сведения](#storage-accounts).
...
1. В поле **промежуточное расположение** укажите, где должны сохраняться моментальные снимки текущих управляемых дисков в процессе восстановления. [Дополнительные сведения](#storage-accounts).
...
[Закрепленные виртуальные машины зоны Azure](https://docs.microsoft.com/azure/virtual-machines/windows/create-portal-availability-zone) можно восстановить в любой [зоне доступности](https://docs.microsoft.com/azure/availability-zones/az-overview) одного региона.

В процессе восстановления вы увидите параметр **Зона доступности.** Сначала вы увидите свою зону по умолчанию. Чтобы выбрать другую зону, выберите нужный вариант. Если закрепленная зона недоступна, вы не сможете восстановить данные в другую зону, так как резервные копии данных не зоналли.
