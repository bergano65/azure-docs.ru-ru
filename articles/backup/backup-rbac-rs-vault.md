...
Служба архивации Azure предоставляет три встроенные роли для контроля операций управления резервным копированием. Дополнительные сведения см. в статье о [встроенных ролях RBAC в Azure](../role-based-access-control/built-in-roles.md).

* [Участник резервного копирования](../role-based-access-control/built-in-roles.md#backup-contributor) — эта роль имеет все разрешения на создание и управление резервным копированием, за исключением удаление хранилища служб восстановления и предоставлять доступ другим пользователям. Эта роль представляет собой администратора управления архивацией, который может выполнять любую операцию управления архивацией.
...
## <a name="minimum-role-requirements-for-the-azure-file-share-backup"></a>Требования к минимальным ролей для резервным копированием файлов Azure
В следующей таблице указаны управления архивацией и соответствующая роль, необходимые для выполнения операции общую папку файлов Azure.

| Операция управления | Требуемая роль | Ресурсы |
| --- | --- | --- |
| Включить резервное копирование файловых ресурсов Azure | Участник резервного копирования | Хранилище служб восстановления |
...
| | Участник учетной записи хранения | Ресурсам учетной записи хранения, где присутствуют источник для восстановления и целевой общих папок |
| Восстановление отдельных файлов | Оператор резервного копирования | Хранилище служб восстановления |
| | Участник учетной записи хранения |   Ресурсам учетной записи хранения, где присутствуют источник для восстановления и целевой общих папок |
| остановка защиты; | Участник резервного копирования | Хранилище служб восстановления |      
| Отмена регистрации учетной записи хранения из хранилища |   Участник резервного копирования | Хранилище служб восстановления |
