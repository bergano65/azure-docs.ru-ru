...
9. Когда все будет готово, на странице **Обзор и восстановление файлов** выберите **Отключить**. Нажмите кнопку **Да**, чтобы подтвердить отключение тома.
    ...
    ![Снимок экрана: страница "Обзор и восстановление файлов" мастера восстановления данных (восстановление на тот же компьютер)](./media/backup-azure-restore-windows-server/samemachine_unmount_instantrestore.png)
