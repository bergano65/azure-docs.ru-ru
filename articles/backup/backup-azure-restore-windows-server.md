...
4. В области **Выбор режима восстановления** выберите **Отдельные файлы и папки** > **Далее**.
   ...
   > [!TIP]
   > Параметр **Отдельные файлы и папки** позволяет быстро получить доступ к данным точек восстановления. Он подходит для восстановления отдельных файлов с размерами, не превышающими 80 ГБ, и обеспечивает скорость передачи или копирования до 6 Мбит/с во время восстановления. Параметр **Том** позволяет восстановить все резервные копии на определенном томе. Этот параметр обеспечивает более быструю скорость передачи (до 40 Мбит/с), которая идеально подходит для восстановления данных большого размера или целых томов.
