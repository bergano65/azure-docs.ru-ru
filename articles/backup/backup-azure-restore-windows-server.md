...
> [!TIP]
> Параметр *Отдельные файлы и папки* позволяет быстро получить доступ к данным точек восстановления. Параметр подходит для восстановления отдельных файлов с общим размером не более 80 ГБ, а также обеспечивает скорость передачи и копирования до 6 Мбит/с во время восстановления. Параметр *Том* позволяет восстановить все резервные копии в определенном томе. Этот параметр обеспечивает более высокую скорость передачи (до 60 Мбит/с), что идеально подходит для восстановления большого объема данных или целых томов.
