...
Состояние задания импорта можно отслеживать из портала Azure, перейдя на страницу **Задания импорта и экспорта** и выбрав задание. Дополнительные сведения о состоянии заданий импорта см. в статье [What is Azure Import/Export service?](https://docs.microsoft.com/azure/storage/common/storage-import-export-service) (Что такое служба "Импорт и экспорт Azure"?).
