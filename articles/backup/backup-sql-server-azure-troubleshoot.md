...
| Уровень серьезности | Описание | Возможные причины | Рекомендованное действие |
|---|---|---|---|
...
| Сообщение об ошибке | Возможные причины | Рекомендованное действие |
|---|---|---|
Виртуальной машине не удается связаться со службой Azure Backup из-за проблем с подключением к Интернету. | Виртуальной машине требуется исходящее подключение к службам Azure Backup, службе хранилища Azure или службам Azure Active Directory.| — Если вы используете NSG для ограничения возможностей подключения, то следует использовать тег службы AzureBackup, чтобы разрешить исходящий доступ к Azure Backup Azure Backup службе хранилища Azure или службам Azure Active Directory. Чтобы предоставить доступ, выполните следующие [действия](./backup-sql-server-database-azure-vms.md#nsg-tags) .<br>— Убедитесь, что DNS разрешает конечные точки Azure.<br>— Убедитесь, что виртуальная машина находится за подсистемой балансировки нагрузки, блокирующей доступ к Интернету. При назначении общедоступного IP-адреса виртуальным машинам обнаружение будет работать.<br>— Убедитесь в отсутствии брандмауэра, антивирусной программы или прокси-сервера, который блокирует вызовы указанных выше трех целевых служб.
