...
| **Версии ОС**            | SLES 12 с пакетом обновления 2 (SP2), SP3 и SP4; SLES 15 с SP0 и SP1 <br><br>   **Preview** -RHEL 7,4, 7,6, 7,7 и 8,1  <br>     Приступая к [работе](https://docs.microsoft.com/azure/backup/tutorial-backup-sap-hana-db) с предварительной версией SAP HANA Backup для RHEL (7,4, 7,6, 7,7 и 8,1). С вопросами пишите на адрес [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com).                |                                             |
