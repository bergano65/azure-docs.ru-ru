...
| **Версии ОС**            | SLES 12 с пакетом обновления 2 (SP2), SP3, SP4 и SP5; SLES 15 с SP0, SP1, SP2 <br><br>  Резервное копирование SAP HANA для RHEL (7.4, 7.6, 7.7 и 8.1) стало общедоступно 1 августа 2020 г.                |                                             |
...
| **Типы резервного копирования**           | Полные, разностные, добавочные (предварительные) и резервные копии журналов                          |  Моментальные снимки                                       |
...
| **Ограничения резервного копирования**          | До 2 ТБ полного размера резервной копии на экземпляр SAP HANA (мягкое ограничение)         |                                                              |
