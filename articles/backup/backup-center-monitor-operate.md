...
ms.locfileid: "98893784"
---
# <a name="monitor-and-operate-backups-using-backup-center-preview"></a>Мониторинг и работа с резервными копиями с помощью центра архивации (Предварительная версия)
