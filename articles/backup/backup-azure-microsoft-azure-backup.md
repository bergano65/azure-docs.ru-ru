...
> Область применения: MABS версии 3. (MABS версии 2 больше не поддерживается. Если вы используете более раннюю версию, чем MABS версии 3, обновите ее до последней версии.)
