...
> Область применения: MABS v3. (MABS версии 2 больше не поддерживается. Если вы используете более раннюю версию, чем MABS v3, обновите ее до последней версии.)
...
| Windows Server 2016 и последние пакеты обновления |64-разрядная версия |Standard, Datacenter, Essentials  |
