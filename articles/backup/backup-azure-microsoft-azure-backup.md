...
С помощью дедупликации Windows Server можно выполнить дедупликацию хранилища DPM. См. дополнительные сведения об использовании [DPM и дедупликации](/system-center/dpm/deduplicate-dpm-storage?view=sc-dpm-2019) при развертывании на виртуальных машинах Hyper-V.
...
4. Укажите расположение для установки файлов Microsoft Azure Backup Server и нажмите кнопку **Далее**.
    ...
    Папка для временных файлов обязательна для резервного копирования в Azure. Убедитесь, что размер папки для временных файлов составляет по крайней мере 5 % объема данных, для которых планируется создать резервную копию в облаке. После завершения установки необходимо настроить защиту отдельных дисков. Дополнительные сведения о пулах носителей см. в разделе [Подготовка хранилища данных](/system-center/dpm/plan-long-and-short-term-data-storage?view=sc-dpm-2019).
...
См. дополнительные сведения о [подготовке среды к работе с DPM](/system-center/dpm/prepare-environment-for-dpm?view=sc-dpm-2019). На этом сайте также содержатся сведения о поддерживаемых конфигурациях, при которых можно развернуть и использовать Azure Backup Server. Для выполнения различных операций можно использовать ряд [командлетов PowerShell](/powershell/module/dataprotectionmanager/) .
