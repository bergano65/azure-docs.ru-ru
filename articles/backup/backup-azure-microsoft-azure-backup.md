...
|:--- | --- |:--- |
| Windows Server 2019 |64-разрядное программирование [C++] |Standard, Datacenter, Essentials |
| Windows Server 2016 и последние пакеты обновления |64-разрядное программирование [C++] |Standard, Datacenter, Essentials  |
...
## <a name="software-package"></a>Пакет программного обеспечения
