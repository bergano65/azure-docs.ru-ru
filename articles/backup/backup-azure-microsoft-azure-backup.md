...
> [!WARNING]
> Для извлечения файлов установки требуется по крайней мере 4 ГБ свободного места.
>
>
...
6. Установите Azure Backup Server версии 2 или более поздней (переместите диски пула хранилища DPM со старого сервера и выполните импорт).
...
11. Службе архивации Azure, выполните команду DPMSYNC-SYNC

    Если вы добавили новые диски в пул носителей DPM вместо перемещения старых, выполните команду DPMSYNC - Reallocatereplica
...
При этом подписка Azure должна быть активна. Чтобы определить состояние подписки и управлять им, войдите [портал подписки](https://account.windowsazure.com/Subscriptions).
...
Если у вас есть брандмауэр или прокси-сервера, который препятствует доступу в Azure, необходимо разрешить следующие адреса доменов в профиле брандмауэра или прокси-сервер:
