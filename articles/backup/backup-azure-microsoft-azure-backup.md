...
4. Укажите расположение для установки файлов Microsoft Azure Backup Server и нажмите кнопку **Далее**.
    ...
    Требования к емкости для дискового хранилища зависят главным образом от размера защищенных данных, размера ежедневно создаваемой точки восстановления, ожидаемого темпа роста объема данных тома и целей диапазона хранения. Рекомендуем сделать дисковый накопитель вдвое размером защищенных данных. Предполагается, что размер ежедневный точки восстановления составляет 10 % от размера защищаемых данных, а диапазон хранения составляет 10 дней. Чтобы получить хорошую оценку размера, ознакомьтесь с [планировщик ресурсов DPM](https://www.microsoft.com/download/details.aspx?id=54301). 
