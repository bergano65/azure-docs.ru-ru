...
--- | --- | ---
**Резервное копирование данных и период удержания** | Резервные копии данных можно хранить в течение дней, месяцев или даже лет, если это необходимо для обеспечения соответствия. | Решения резервного копирования, такие как Azure Backup, позволяют вам точно выбирать данные для резервного копирования и тонко настраивать политики резервного копирования и хранения.<br/><br/> Служба Site Recovery не допускает такой же тонкой настройки.
...
- Вы можете в одной консоли управлять резервными копиями нескольких компьютеров, входящими в группы защиты. Это полезно в тех случаях, когда приложения распределены между несколькими компьютерами и вы хотите создать их резервные копии вместе.
