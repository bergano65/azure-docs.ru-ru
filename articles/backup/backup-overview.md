...
**Машина** | **Сценарий резервного копирования**
--- | ---
...
**Машина** | **Метод резервного копирования** | **Резервное копирование**
--- | --- | ---
...
**Azure Backup** | **Решение** | **Ограничение**
--- | --- | ---
...
**Я хочу выполнить прямое резервное копирование локальных компьютеров Linux** | Для резервного копирования в Azure необходимо развернуть DPM или MABS. | Резервное копирование узла Linux не поддерживается. Можно выполнить резервное копирование только гостевого компьютера Linux на Hyper-V или VMWare.
