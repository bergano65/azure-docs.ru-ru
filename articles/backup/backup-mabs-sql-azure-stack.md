...
description: В этой статье узнайте, как настроить сервер резервного копирования Microsoft Azure (MABS) для защиты баз данных сервера S'L в Azure Stack.
ms.topic: conceptual
ms.date: 06/08/2018
...
4. На экране **Выбор элементов группы** в списке "Доступные элементы" показаны различные источники данных. Нажмите, **+** чтобы расширить папку и выявить subfolders. Установите флажок, чтобы выбрать нужный элемент.
