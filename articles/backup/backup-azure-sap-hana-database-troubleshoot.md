...
- Повторно зарегистрируйте расширение для того же компьютера на портале Azure ("резервное копирование > Просмотр подробностей", > выберите соответствующую виртуальную машину Azure — > повторной регистрации).
