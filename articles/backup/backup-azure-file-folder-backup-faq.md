...
* Если необходимо восстановить данные, резервные в хранилище со старым именем сервера, используйте опцию для восстановления в альтернативном местоположении в мастере данных восстановления. Ознакомьтесь с [дополнительными сведениями](backup-azure-restore-windows-server.md#use-instant-restore-to-restore-data-to-an-alternate-machine).
...
Да, вы можете использовать опцию **Change Properties** в агенте MARS для настройки пропускной способности и времени. Ознакомьтесь с [дополнительными сведениями](backup-windows-with-mars-agent.md#enable-network-throttling).
