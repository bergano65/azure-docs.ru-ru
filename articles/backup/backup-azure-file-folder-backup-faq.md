...
### <a name="why-does-the-mars-agent-need-net-framework-452-or-higher"></a>Почему агент MARS требуются .NET framework 4.5.2 или более поздней версии?

Новые функциональные возможности, доступные в [мгновенное восстановление](backup-azure-restore-windows-server.md#use-instant-restore-to-recover-data-to-the-same-machine) требуется .NET Framework 4.5.2 или более поздней версии.
...
Да. Установите агент служб восстановления Microsoft AZURE, а резервное копирование файлов и папок в операционной системе Windows во временном хранилище. -Резервное копирование задания завершаются сбоем о временного хранилища, стирание данных.
...
Да, вы можете использовать **изменить свойства** параметр в агент MARS для регулировки пропускной способности и времени. [Дополнительные сведения](backup-configure-vault.md#enable-network-throttling)**.
