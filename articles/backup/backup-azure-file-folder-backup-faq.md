---
title: Резервное копирование файлов и папок — часто задаваемые вопросы
...
* При резервном копировании состояния системы Windows вам потребуется дополнительно 30-35 ГБ свободного места в томе, содержащем папку кэша.
...
6. выполнение резервного копирования по требованию. После успешного завершения резервного копирования в новом расположении можно удалить исходную папку кэша.
...
**Можно ли выполнить восстановление, если забыли парольную фразу?**
...
| --- | --- | --- |
| Доступно |Lost |Если исходный компьютер (где были созданы резервные копии) доступен и по-прежнему зарегистрирован в том же хранилище служб восстановления, вы можете повторно создать парольную фразу, выполнив следующие [действия](https://docs.microsoft.com/azure/backup/backup-azure-manage-mars#re-generate-passphrase).  |
...
* При удалении и повторной регистрации агента на том же исходном компьютере с
  * *Той же парольной фразы*, вы сможете восстановить резервные копии данных.
  * *Другая парольная фраза*, вы не сможете восстановить резервные копии данных.
* Если агент устанавливается на *другой компьютер* с
  * *Та же парольная фраза* (используемая на исходном компьютере), после чего вы сможете восстановить резервные копии данных.
  * *Другая парольная фраза*, вы не сможете восстановить резервные копии данных.
...
**Разделы справки восстановить в случае утери исходного компьютера (где были созданы резервные копии)?**
...
| --- | --- | --- |
| Lost |Доступно |Агент MARS можно установить и зарегистрировать на другом компьютере с той же парольной фразой, которую вы указали во время регистрации исходного компьютера. Выберите **вариант восстановления** > **другое расположение** для выполнения восстановления. Дополнительные сведения см. в этой [статье](https://docs.microsoft.com/azure/backup/backup-azure-restore-windows-server#use-instant-restore-to-restore-data-to-an-alternate-machine).
| Lost |Lost |Невозможно восстановить данные, или данные недоступны |
