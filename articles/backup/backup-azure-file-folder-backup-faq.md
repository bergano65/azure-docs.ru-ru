...
4. Скопируйте всю папку `\Scratch` на другой диск, где достаточно места. Убедитесь, что содержимое скопировано, а не перемещено.
...
| --- | --- | --- |
| Терять |Доступно |Агент MARS можно установить и зарегистрировать на другом компьютере с той же парольной фразой, которую вы указали во время регистрации исходного компьютера. Выберите **вариант восстановления** > **другое расположение** для выполнения восстановления. Дополнительные сведения см. в этой [статье](https://docs.microsoft.com/azure/backup/backup-azure-restore-windows-server#use-instant-restore-to-restore-data-to-an-alternate-machine).
| Терять |Терять |Невозможно восстановить данные, или данные недоступны |
