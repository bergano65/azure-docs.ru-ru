...
| --- | --- | --- |
| Lost |Доступно |Агент MARS можно установить и зарегистрировать на другом компьютере с той же парольной фразой, которую вы указали во время регистрации исходного компьютера. Выберите **вариант** > восстановления**другое расположение** , чтобы выполнить восстановление. Дополнительные сведения см. в этой [статье](https://docs.microsoft.com/azure/backup/backup-azure-restore-windows-server#use-instant-restore-to-restore-data-to-an-alternate-machine).
| Lost |Lost |Невозможно восстановить данные, или данные недоступны |
