...
ms.locfileid: "58118907"
---
# <a name="back-up-sql-server-databases-in-azure-vms"></a>Резервное копирование баз данных SQL Server на виртуальных машинах Azure
...
1. Определение или [создание](backup-azure-sql-database.md#create-a-recovery-services-vault) в хранилище служб восстановления, в том же регионе или языковой стандарт в качестве виртуальной Машины, где размещен экземпляр SQL Server.
...
Если вам нужно отключить автоматическую защиту, щелкните имя экземпляра в разделе **Настройка резервного копирования**и выберите **отключить автоматическая защита** для экземпляра. Резервное копирование всех баз данных продолжится. Однако будущие базы данных не будут автоматически защищены.
