...
- **Разрешить доступ с помощью тегов Azure брандмауэра**. Если вы используете брандмауэр Azure, создайте правила приложения с помощью AzureBackup [полное доменное имя тега](https://docs.microsoft.com/en-us/azure/firewall/fqdn-tags). Это разрешает исходящий доступ к службе архивации Azure.
