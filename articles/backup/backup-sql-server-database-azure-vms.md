...
3. Убедитесь, что базы данных SQL Server соответствуют [рекомендациями по именованию баз данных для Azure Backup](#database-naming-guidelines-for-azure-backup).
4. Проверьте, что у вас отсутствуют любые другие включенные средства резервного копирования базы данных. Перед выполнением резервного копирования базы данных отключите все другие службы резервного копирования SQL Server.
