...
s ![ Настройка конфигурации хранилища для нового хранилища](./media/backup-azure-arm-vms-prepare/full-blade.png)
...
1. Откроется панель **Выбор виртуальных машин** . Выберите виртуальные машины, для которых необходимо создать резервную копию с помощью политики. Нажмите кнопку **ОК**.
...
Completed | Пропущено | Завершено
Завершено | Завершено | Завершено
Завершено | Сбой | Выполнено с предупреждениями
Сбой | Ошибка | Ошибка
...
Добавочная точка восстановления, созданная в хранилище, будет содержать все изменения после последней точки восстановления, созданной в хранилище. На пользователя не влияет никаких затрат.
