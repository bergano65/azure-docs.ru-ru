...
4. В **выбор виртуальных машин**, выберите виртуальные машины, необходимо создать резервную копию с помощью политики. Затем нажмите кнопку **ОК**.
...
--- | --- | --- 
**Настройка правил группы безопасности сети** | Разрешите [диапазоны IP-адресов центра обработки данных Azure](https://www.microsoft.com/download/details.aspx?id=41653).<br/><br/> Вместо разрешения и управление каждый диапазон адресов, можно добавить правило, которое разрешает доступ к службе архивации Azure с помощью [тег службы](backup-azure-arm-vms-prepare.md#set-up-an-nsg-rule-to-allow-outbound-access-to-azure). | [Дополнительные сведения](../virtual-network/security-overview.md#service-tags) о тегах служб.<br/><br/> Теги служб упрощают управление доступом, а не повлечь дополнительные затраты.
