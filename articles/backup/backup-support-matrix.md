...
--- | ---
**Диски данных виртуальной машины Azure** | См. [таблицу поддержки для резервного копирования виртуальных машин Azure](https://docs.microsoft.com/azure/backup/backup-support-matrix-iaas#vm-storage-support).
