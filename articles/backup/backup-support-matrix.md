...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| Azure               | Поддерживается для виртуальных машин Azure с управляемыми и неуправляемыми дисками. Не поддерживается для классических виртуальных машин. | Все общедоступные регионы Azure.  |
| SQL или SAP HANA | Да                                                          | Все общедоступные регионы, кроме Франции |
