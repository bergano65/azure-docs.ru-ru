...
| аддоназуребаккупалертс | Предупреждение | Представляет запись, содержащую все сведения об определенном предупреждении. Например, время создания предупреждения, серьезность, состояние и т. д.  |
