...
1. В консоли Azure Backup Server на панели навигации выберите **Восстановление** и найдите данные, которые требуется восстановить. В области результатов выберите нужные данные.
...
6. Укажите настройки восстановления.
    ...
    * **Уведомление об** Выберите **отправить по электронной почте по завершении восстановления**и укажите получателей, которые получат уведомление. Несколько адресов электронной почты разделяйте запятыми.
