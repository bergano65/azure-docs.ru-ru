---
title: Резервное копирование файлов в M Ms Azure Stack
...
7. Просмотрите параметры восстановления и нажмите кнопку **Восстановить**.
...
Чтобы просмотреть объекты сервера резервного копирования Azure на портале Azure, вы можете выполнить следующие действия:
