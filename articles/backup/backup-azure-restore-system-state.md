...
2. Выполните [следующие действия](https://docs.microsoft.com/windows-server/identity/ad-ds/manage/ad-forest-recovery-nonauthoritative-restore), чтобы восстановить доменные службы Active Directory с помощью командлетов системы архивации данных Windows Server.
