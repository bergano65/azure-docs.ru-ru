...
- Чтобы понять, сколько баз данных можно защитить на одном сервере, необходимо учитывать такие факторы, как пропускная способность, размер виртуальной машины, частота резервного копирования, размер базы данных и т. д. Мы работаем над планировщиком, который поможет вам рассчитать эти числа самостоятельно. Мы опубликуем его в ближайшее время.
