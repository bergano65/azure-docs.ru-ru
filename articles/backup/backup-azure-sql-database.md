...
Если остановить резервное копирование с сохранением данных, срок точек восстановления истечет в соответствии с политикой хранения, но Azure Backup всегда будет сохранять одну последнюю точку восстановления, пока вы явно не удалите данные о резервном копировании. Точно так же, если удалить источник данных, не выполняя остановку резервного копирования, новые резервные копии будут завершаться сбоем, и срок старых точек восстановления истечет в соответствии с политикой хранения. Но одна последняя точка восстановления всегда будет храниться, пока вы не выполните остановку резервного копирования с удалением данных.
