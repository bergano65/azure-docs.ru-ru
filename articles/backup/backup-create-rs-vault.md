...
>
>- Если вы еще не настроили резервное копирование, [выполните следующие действия](https://docs.microsoft.com/azure/backup/backup-create-rs-vault#set-storage-redundancy) для просмотра и изменения параметров.
...
1. В разделе **Свойства** найдите элемент **Конфигурация архивации** и щелкните **Обновить**.

1. Выберите тип репликации хранилища и щелкните **Сохранить**.
...
>[!WARNING]
>Следующая операция является необратимой и не может быть отменена. Все резервные копии данных и элементы резервного копирования, связанные с защищенным сервером, будут удалены без возможности восстановления. Используйте эти возможности осторожно.
