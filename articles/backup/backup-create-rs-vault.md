...
1. Выберите тип репликации хранилища и нажмите кнопку **сохранить**.
   ...
   - Если вам требуется доступность данных без простоев в регионе, убедитесь, что местонахождение данные, а затем выберите [хранилище, избыточное](https://docs.microsoft.com/azure/storage/common/storage-redundancy#zone-redundant-storage)в пределах зоны.
...
>- Теперь функция кросс-региона восстановления (КРР) доступна для просмотра во всех общедоступных регионах Azure и облаках независимых.
