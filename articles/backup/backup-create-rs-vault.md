...
>- Функция межрегиона восстановления (КРР) в настоящее время доступна только в следующих регионах: Западная Центральная часть США, Западная часть США 2, Восточная Австралия и Юго-Восточная Австралия. 
