...
>- Функция кросс-региона Restore (КРР) в настоящее время доступна только в регионе вкус.
>- КРР — это функция согласия на уровне хранилища для любого хранилища GRS (по умолчанию отключена).
>- Используйте *"featureName": "кроссрегионресторе"* , чтобы подключить подписку к этой функции.
