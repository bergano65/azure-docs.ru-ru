...
**Руководство**. Используйте рабочую станцию привилегированного доступа (привилегированным доступом) с настроенной службой многофакторной идентификации Azure AD (MFA) для входа и настройки ресурсов с поддержкой Azure Backup.
