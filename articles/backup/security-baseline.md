...
**Руководство**. Azure Backup предоставляет встроенные возможности мониторинга и оповещения в хранилище служб восстановления. Они доступны без какой бы то ни было дополнительной инфраструктуры управления. Кроме того, вы также можете увеличить масштаб мониторинга и создания отчетов, используя Azure Monitor.
