...
* При защите баз данных, использующих функцию AlwaysOn, MABS имеет следующие ограничения.
  * MABS будет учитывать политику резервного копирования для групп доступности, которая задается в SQL Server на основе настроек резервного копирования следующим образом.
...
* SQL Server 2014 или выше проблемы резервного копирования:
  * В SQL Server 2014 добавлена новая функция для создания [базы данных для локальных SQL Server в хранилище больших двоичных объектов Windows Azure](/sql/relational-databases/databases/sql-server-data-files-in-microsoft-azure?view=sql-server-ver15). MABS нельзя использовать для защиты этой конфигурации.
