...
Azure Backup теперь поддерживает настройку резервного копирования для существующих файловых ресурсов Azure с помощью шаблона Azure Resource Manager (ARM). Шаблон настраивает защиту для имеющегося файлового ресурса Azure, указывая соответствующие сведения для хранилища служб восстановления и политики резервного копирования. При необходимости она создает новое хранилище служб восстановления и политику резервного копирования, а также регистрирует учетную запись хранения, содержащую общую папку, в хранилище служб восстановления.
