...
- Январь 2021 г.
  - [Резервное копирование дисков Azure (Предварительная версия)](disk-backup-overview.md)
  - [Шифрование неактивных с использованием ключей, управляемых клиентом, теперь общедоступно](encryption-at-rest-with-cmk.md)
- Ноябрь 2020 г.
