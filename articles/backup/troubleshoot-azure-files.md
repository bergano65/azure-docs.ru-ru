...
В портал Azure откройте > **инфраструктуру** > резервного **Vault**копирования хранилища**учетные записи хранения** и нажмите кнопку **отменить регистрацию** , чтобы удалить учетные записи хранения из хранилища служб восстановления.
