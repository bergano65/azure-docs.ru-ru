...
3. Появится начальный экран DPM с рекомендациями по созданию **группы защиты**. Щелкните **Далее**.
4. Выберите **Серверы**.
...
14. Щелкните **Далее** и выберите нужный параметр для передачи начальной резервной копии в Azure. Доступны параметры **Автоматически по сети** или **Автономная архивация**.
    ...
    * Принцип работы **автономного резервного копирования** описан в статье [Обзор автономной резервной копии](offline-backup-overview.md).
