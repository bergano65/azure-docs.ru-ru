...
1. Выберите **создать** , чтобы создать группу защиты.
    ...
    ![Создать группу защиты](./media/backup-azure-backup-sql/protection-group.png)
