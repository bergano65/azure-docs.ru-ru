...
7. Выберите параметр **Запустить программу Eseutil для проверки целостности данных** , чтобы проверить целостность баз данных Exchange Server.
    ...
    После выбора этой опции проверка согласованности резервного копирования будет проводиться на сервере DPM, чтобы избежать трафика ввоза/от ввоза, генерируемого при запуске команды **eseutil** на сервере Exchange.
