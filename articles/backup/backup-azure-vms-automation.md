...
Этот шаблон недоступен напрямую, так как он находится под учетной записью хранения клиента и заданным контейнером. Для доступа к этому шаблону требуется полный URL-адрес (вместе с временным маркером SAS).
