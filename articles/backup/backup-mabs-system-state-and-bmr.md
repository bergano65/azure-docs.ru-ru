...
|Backup|Проблемы|Восстановление из резервной копии Azure Backup Server|Восстановление из резервной копии состояния системы|Восстановление исходного состояния системы|
|----------|---------|---------------------------|------------------------------------|-------|
...
1. **Разверните Azure Backup Server**. Убедитесь, что развертывание Backup Server выполнено правильно. Дополнительные сведения можно найти в разделе
