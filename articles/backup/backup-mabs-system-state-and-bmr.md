---
title: Защита состояния системы & восстановить исходное состояние компьютера — Azure Backup Server
...
|**Данные файлов**<br /><br />Резервное копирование данных файлов с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря или повреждение операционной системы|N|Да|Да|
...
|**Данные SharePoint**<br /><br />Резервное копирование данных фермы с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря или повреждение операционной системы|N|Да|Да|
...
|Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы узла|Потеря или повреждение операционной системы|N|Да|Да|
...
|SQL Server и Exchange<br /><br />Резервное копирование приложения с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря или повреждение операционной системы|N|y|Да|
...
1. **Разверните Azure Backup Server**. Убедитесь, что развертывание Backup Server выполнено правильно. Дополнительные сведения см. здесь:
...
5. На странице **Выбор способа восстановления резервной копии** выберите **Формат и перераспределение дисков**. На следующей странице проверьте параметры.
...
3. На странице **Выбор типа восстановления** выберите **Копировать в сетевую папку**.
