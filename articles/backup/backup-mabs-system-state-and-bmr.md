...
* **Резервное копирование состояния системы**: создает резервные копии файлов операционной системы. Эта резервная копия позволяет восстанавливать при запуске компьютера, но системные файлы и реестр теряются. Резервная копия состояния системы включает следующие элементы:
  * Член домена: файлы загрузки, база данных регистрации классов COM+, реестр
...
|Резервное копирование|Проблема|Восстановление из резервной копии Azure Backup Server|Восстановление из резервной копии состояния системы|BMR|
|----------|---------|---------------------------|------------------------------------|-------|
|**Файловые данные**<br /><br />Обычное резервное копирование данных<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потеря файловых данных|Да|N|N|
|**Файловые данные**<br /><br />Резервное копирование данных файлов с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потеря или повреждение операционной системы|N|Да|Да|
|**Файловые данные**<br /><br />Резервное копирование данных файлов с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потеря сервера (тома данных без изменений)|N|N|Да|
|**Файловые данные**<br /><br />Резервное копирование данных файлов с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потерянный сервер (тома с данными потеряны)|Да|N|Да<br /><br />BMR, а затем регулярное восстановление резервных копий данных файлов|
|**Данные SharePoint**<br /><br />Резервное копирование данных фермы с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потеря веб-сайта, списков, элементов списков, документов|Да|N|N|
|**Данные SharePoint**<br /><br />Резервное копирование данных фермы с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потеря или повреждение операционной системы|N|Да|Да|
|**Данные SharePoint**<br /><br />Резервное копирование данных фермы с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Аварийное восстановление|N|N|N|
|Windows Server 2012 R2 Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR) для узла|Потерянная виртуальная машина|Да|N|N|
|Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR) для узла|Потеря или повреждение операционной системы|N|Да|Да|
|Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR) для узла|Потерянный узел Hyper-V (виртуальные машины сохранены)|N|N|Да|
|Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR) для узла|Потерянный узел Hyper-V (виртуальные машины потеряны)|N|N|Да<br /><br />Восстановление исходного состояния системы, затем обычное восстановление Azure Backup Server|
|SQL Server и Exchange<br /><br />Резервное копирование приложения с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потерянные данные приложений|Да|N|N|
|SQL Server и Exchange<br /><br />Резервное копирование приложения с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потеря или повреждение операционной системы|N|Да|Да|
|SQL Server и Exchange<br /><br />Резервное копирование приложения с помощью Azure Backup Server<br /><br />Резервное копирование состояния системы или восстановление исходного состояния системы (BMR)|Потерянный сервер (база данных и журналы транзакций сохранены)|N|N|Да|
...
## <a name="recover-system-state-or-bmr"></a>Восстановление состояния системы или BMR
