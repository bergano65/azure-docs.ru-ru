...
* **Резервное копирование исходного состояния системы.** Создается резервная копия файлов операционной системы и всех данных на критически важных томах (кроме данных пользователя). По определению резервная копия исходного состояния системы включает резервную копию состояния системы. Она обеспечивает защиту на случай, если компьютер не запускается и вам нужно все восстановить.
...
|Архивация|Проблемы|Восстановление из резервной копии Azure Backup Server|Восстановление из резервной копии состояния системы|Восстановление исходного состояния системы|
|----------|---------|---------------------------|------------------------------------|-------|
|**Данные файлов**<br /><br />Обычное резервное копирование данных<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря данных файлов|Y|в|в|
|**Данные файлов**<br /><br />Резервное копирование данных файлов с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря или повреждение операционной системы|в|Y|Y|
|**Данные файлов**<br /><br />Резервное копирование данных файлов с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря сервера (тома данных без изменений)|в|в|Y|
...
|**Данные SharePoint**<br /><br />Резервное копирование данных фермы с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря веб-сайта, списков, элементов списков, документов|Y|в|в|
|**Данные SharePoint**<br /><br />Резервное копирование данных фермы с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря или повреждение операционной системы|в|Y|Y|
|**Данные SharePoint**<br /><br />Резервное копирование данных фермы с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Аварийное восстановление|в|Нет|в|
|Windows Server 2012 R2 Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы узла|Потеря виртуальной машины|Y|в|в|
|Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы узла|Потеря или повреждение операционной системы|в|Y|Y|
|Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы узла|Потеря узла Hyper-V (виртуальные машины без изменений)|в|в|Y|
|Hyper-V<br /><br />Резервное копирование узла Hyper-V или гостя с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы узла|Потеря узла Hyper-V (виртуальные машины потеряны)|в|в|Y<br /><br />Восстановление исходного состояния системы, затем обычное восстановление Azure Backup Server|
|SQL Server и Exchange<br /><br />Резервное копирование приложения с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря данных приложения|Y|в|в|
|SQL Server и Exchange<br /><br />Резервное копирование приложения с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря или повреждение операционной системы|в|y|Y|
|SQL Server и Exchange<br /><br />Резервное копирование приложения с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря сервера (журналы транзакций и базы данных без изменений)|в|в|Y|
|SQL Server и Exchange<br /><br />Резервное копирование приложения с помощью Azure Backup Server<br /><br />Восстановление исходного состояния системы и резервное копирование состояния системы|Потеря сервера (журналы транзакций и базы данных потеряны)|в|в|Y<br /><br />Восстановление исходного состояния системы, затем обычное восстановление с помощью Azure Backup Server|
