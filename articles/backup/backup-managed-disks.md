...
1. На вкладке **Основные сведения** укажите подписку, группу ресурсов, имя хранилища службы архивации, регион и избыточность хранилища резервных копий. Продолжайте, выбрав " **Проверка + создать**". Дополнительные сведения о [создании хранилища службы архивации](./backup-vault-overview.md#create-a-backup-vault).
