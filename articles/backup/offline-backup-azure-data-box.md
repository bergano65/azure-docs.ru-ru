...
1. Запустите *MARSAgentInstaller.exe*и выполните *только* шаги по [установке и регистрации агента](https://docs.microsoft.com/azure/backup/install-mars-agent#install-and-register-the-agent) в хранилище служб восстановления, в котором необходимо хранить резервные копии.
