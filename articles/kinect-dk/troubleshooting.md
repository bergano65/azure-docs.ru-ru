...
На этой странице содержатся известные проблемы и советы по устранению неполадок при использовании пакета SDK для датчика с Azure Kinect DK. Дополнительные сведения о проблемах, связанных с оборудованием продукта, см. на [странице поддержки продукта](https://aka.ms/kinectsupport) .
