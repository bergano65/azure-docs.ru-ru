...
description: Сведения о том, как с помощью примера скрипта Azure PowerShell обеспечить защиту серверной системы с использованием взаимной аутентификации на основе сертификатов.
