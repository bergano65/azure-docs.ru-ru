...
description: Сведения о том, как масштабировать и добавлять регионы в экземпляр службы "Управление API". Ознакомьтесь с примером скрипта и дополнительными ресурсами.
