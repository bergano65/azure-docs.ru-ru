...
* Секреты, обновленные в хранилище ключей, автоматически поворачиваются в управлении API. После обновления в хранилище ключей именованное значение в управлении API обновляется в течение 4 часов. 
...
Если [Key Vault брандмауэр](../key-vault/general/network-security.md) включен в хранилище ключей, ниже приведены дополнительные требования к использованию секретов хранилища ключей.
...
* Включите Azure Key Vault [конечной точки службы](../key-vault/general/overview-vnet-service-endpoints.md) в подсети управления API.
* Настройте правило группы безопасности сети (NSG), разрешающее исходящий трафик для [тегов службы](../virtual-network/service-tags-overview.md)AzureKeyVault и AzureActiveDirectory. 

Дополнительные сведения см. в разделе сведения о конфигурации сети в статье [Подключение к виртуальной сети](api-management-using-with-vnet.md#-common-network-configuration-issues).
