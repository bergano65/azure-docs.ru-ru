...
description: Сведения об использования именованных значений в политиках Управления API Azure. Именованные значения могут содержать строковые литералы и выражения политики.
