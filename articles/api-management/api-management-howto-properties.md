...
| --- | --- | --- |
| Отображаемое имя |string |Буквенно-цифровая строка, используемая для ссылки на свойство в политиках. |
| Value |string |Значение свойства. Не может быть пустым или состоять только из пробелов. |
