...
+ [Создание экземпляра управления API API Azure](get-started-create-service-instance.md)
...
> [!NOTE]
> **Использование настройки** определяет, какое региональное развертывание API Management будет связываться с настроенным кэшем в случае многорегиональной конфигурации управления API. Кэши, заданные как **Default** (По умолчанию), будут переопределены кэшами с региональным значением.
>
...
5. Выберите **по умолчанию** или укажите желаемый узло в **поле использования из** поля выпадения.
6. Нажмите **Сохранить**.
