...
![Снимок экрана, показывающий, как добавить внешний кэш Azure для Redis в службе управления API Azure.](media/api-management-howto-cache-external/add-external-cache.png)
