...
* **Слушатель:** Слушатель имеет передний порт, протокол (http или Https, эти значения чувствительны к случаям) и имя сертификата SSL (при настройке Разгрузки SSL).
