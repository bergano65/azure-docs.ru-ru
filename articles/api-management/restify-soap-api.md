...
description: Узнайте, как импортировать API SOAP, преобразовать его в REST с помощью службы "Управление API", а затем протестировать API на портале Azure и портале разработчика.
