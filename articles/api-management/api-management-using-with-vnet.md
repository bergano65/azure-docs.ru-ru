...
* **Дополнительные обновления**: При внесении изменений в сеть обратитесь к [NetworkStatus API,](https://docs.microsoft.com/rest/api/apimanagement/2019-01-01/networkstatus)чтобы убедиться, что служба управления API не потеряла доступ ни к одному из критических ресурсов, от которых она зависит. Состояние подключения должно обновляться каждые 15 минут.
...
* [Сервисные теги](../virtual-network/security-overview.md#service-tags)
