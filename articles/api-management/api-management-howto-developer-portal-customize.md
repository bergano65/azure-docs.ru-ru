...
После публикации портала к нему можно получить доступ с того же URL-адреса, что и панель администрирования, например `https://contoso-api.portal.azure-api.net`. Откройте его на новой вкладке браузера, чтобы просмотреть его как внешнего посетителя.

## <a name="next-steps"></a>Дальнейшие действия

Дополнительные сведения о портале разработчика:

- [Обзор портала разработчика управления API Azure](api-management-howto-developer-portal.md)