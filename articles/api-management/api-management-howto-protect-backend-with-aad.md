...
1. Оставьте пустым раздел **URI перенаправления** для Now.
...
2. В разделе **Добавление секрета клиента**введите **Описание**. Выберите время истечения срока действия ключа и нажмите кнопку **Добавить**.
...
2. Выберите `client-app`и в списке страниц для приложения перейдите к разрешениям **API**.

3. Выберите **Добавить разрешение**.

4. В разделе **Выбор API**найдите и выберите `backend-app`.

5. В разделе **делегированные разрешения**выберите соответствующие разрешения `backend-app`.
