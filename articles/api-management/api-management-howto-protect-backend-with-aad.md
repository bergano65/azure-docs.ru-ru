...
1. Перейдите в клиент Azure AD, а затем перейдите к **регистрация приложений (для прежних версий)**.
...
1. При работе в **регистрация приложений (для прежних версий)** выберите **Регистрация нового приложения**. 
...
1. Перейдите к **регистрации приложения (для прежних версий)**. 
