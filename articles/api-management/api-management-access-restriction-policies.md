...
> [!CAUTION]
> Из-за регулирования архитектура распределенного характера ограничение скорости никогда не вполне точной. Разница между настроен, и реальное число разрешено, запросы не соответствовать зависимости от объема и скорости, задержку серверной части и других факторов.
