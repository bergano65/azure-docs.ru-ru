...
| имя-заголовка                | Имя заголовка HTTP для проверки.                                                                                                                                  | Да      | Н/Д     |
...
| вызовы          | Максимальное общее число вызовов, разрешенное в течение периода времени, указанного в `renewal-period`.     | Необходимо указать атрибут `calls`, `bandwidth` или оба вместе. | Н/Д     |
| renewal-period | Период времени (в секундах), по окончании которого сбрасывается квота.                                                  | Да                                                              | Н/Д     |
...
| имя-заголовка                     | Имя заголовка НТТР, содержащего маркер.                                                                                                                                                                                                                                                                                                                                                                                                         | Необходимо указать один из `header-name`, `query-parameter-name` или `token-value`. | Н/Д                                                                               |
...
| require-expiration-time         | Boolean. Указывает, требуется ли утверждение истечения срока действия для маркера.                                                                                                                                                                                                                                                                                                                                                                               | Нет                                                                               | true                                                                              |
...
| require-signed-tokens           | Boolean. Указывает, должен ли быть подписан маркер.                                                                                                                                                                                                                                                                                                                                                                                           | Нет                                                                               | true                                                                              |
