...
1. На панели справа в разделе **Политики преобразования** дважды щелкните **Установка HTTP-заголовка** (чтобы вставить два фрагмента политики).
...
1.  Выберите **Demo Conference API** > **Все операции** > **Конструктор**.
1.  В разделе **Обработка исходящих запросов** выберите значок редактора кода ( **</>** ).
1.  Поместите курсор на **&lt;входящий&gt;** элемент.
