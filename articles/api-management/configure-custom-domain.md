...
1. Выберите **Личные домены**.
    ...
    - **Невпортал** (значение по умолчанию: `<apim-service-name>.developer.azure-api.net`).
