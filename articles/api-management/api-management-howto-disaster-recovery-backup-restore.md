...
-   **Разрешите** доступ из плоскости управления к учетной записи хранения Azure, если [брандмауэр][azure-storage-ip-firewall] включен. Клиент должен открыть набор [IP-адресов плоскости управления Azure API Management][control-plane-ip-address] в учетной записи хранения для резервного копирования или восстановления из. Это связано с тем, что запросы к службе хранилища Azure не Снатедся на общедоступный IP-адрес из > вычислений (плоскость управления Azure API Management). Запрос на хранение в разных регионах будет Снатед.
...
-   [Управление API Azure: резервное копирование и восстановление конфигурации](https://docs.microsoft.com/archive/blogs/stuartleeks/azure-api-management-backing-up-and-restoring-configuration) 
