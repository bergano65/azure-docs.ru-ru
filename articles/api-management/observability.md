...
| Инструмент        | Сферы использования    | Запаздывание данных | Сохранение | Выборка | Тип данных | Включен|
|:------------- |:-------------|:---- |:----|:---- |:--- |:---- 
| **[Инспектор API](api-management-howto-api-inspector.md)** | Тестирование и отладка | Мгновенное | Последние 100 трассировок | Включено на запрос | Трассировка запросов | Всегда
