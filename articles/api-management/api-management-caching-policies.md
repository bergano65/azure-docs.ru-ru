...
| vary-by-developer              | Установите значение `true`, если нужно кэшировать ответы в зависимости от [ключа подписки](https://docs.microsoft.com/azure/api-management/api-management-subscriptions).                                                                                                                                                                                                                                                                                                         | Да      |         Ложь          |
| vary-by-developer-groups       | Установите значение `true`, если нужно кэшировать ответы в зависимости от [группы пользователя](https://docs.microsoft.com/azure/api-management/api-management-howto-create-groups).                                                                                                                                                                                                                                                                                                             | Да      |       Ложь            |
