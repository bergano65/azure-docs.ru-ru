...
| vary-by-developer              | Задайте значение `true` , чтобы кэшировать ответы на учетную запись разработчика, которой принадлежит [ключ подписки](./api-management-subscriptions.md) , входящий в запрос.                                                                                                                                                                                                                                                                                                  | Да      |         False          |
| vary-by-developer-groups       | Установите значение `true`, если нужно кэшировать ответы в зависимости от [группы пользователя](./api-management-howto-create-groups.md).                                                                                                                                                                                                                                                                                                             | Да      |       False            |
