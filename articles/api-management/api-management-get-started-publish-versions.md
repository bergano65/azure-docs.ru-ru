...
2. Добавьте **v1** как **имя** и **идентификатор версии**.
...
3. Щелкните **Создать**, чтобы создать версию.
4. Теперь под пунктом **Demo Conference API** в списке API указаны два разных API, **Original** и **v1**.
...
5. Теперь можно изменить и настроить **v1** в качестве API, не связанного с версией **Original**. Изменение одной версии не влияет на другую.
...
1. На странице модели классического развертывания выберите **Продукты**.
    ...
    ![Продукты управления API](media/api-management-getstarted-publish-versions/Products.png)
