...
> [!NOTE]
> `rate-limit-by-key` Политики `quota-by-key` и политики не доступны, когда в уровне потребления API Управления API. 
...
Пожалуйста, дайте нам свои отзывы в качестве вопроса GitHub по этой теме. Мы будем рады узнать о других возможных значениях ключей, подходящих для вашего случая.
