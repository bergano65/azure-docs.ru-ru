...
description: Сведения о том, как импортировать программный интерфейс спецификации OpenAPI в Управление API Azure и проверить свой API на портале Azure.
