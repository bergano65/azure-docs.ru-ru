...
- [Планирование и управление затратами на управление API](plan-manage-costs.md)
- [Ограничения управления API](../azure-resource-manager/management/azure-subscription-service-limits.md#api-management-limits)