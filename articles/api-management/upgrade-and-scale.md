...
> [!NOTE]
> Процесс обновления или масштабирования может занять от 15 до 45 минут. Вы получите уведомление, когда это будет сделано.

> [!NOTE]
> Служба управления API в шкале уровня **потребления** автоматически зависит от трафика.
...
## <a name="downtime-during-scaling-up-and-down"></a>Время простоя во время масштабирования вверх и вниз
Если вы масштабируете от или до уровня разработчика, будет время простоя. В противном случае, нет простоя. 
