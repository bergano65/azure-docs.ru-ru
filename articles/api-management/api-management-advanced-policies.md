...
| Атрибут | Описание                                                                                        | Обязательно | По умолчанию |
| --------- | -------------------------------------------------------------------------------------------------- | -------- | ------- |
| key       | Строка. Допустимое выражение. Задает область параллелизма. Используется несколькими политиками. | Да      | Н/Д     |
...
| count (счетчик)            | Положительное число, определяющее максимальное число повторных попыток.                                                                                | Да      | Н/Д     |
