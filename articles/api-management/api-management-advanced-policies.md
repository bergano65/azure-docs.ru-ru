...
-   [Трассировка](#Trace) . Добавляет пользовательские трассировки в выходные данные [инспектора API](https://azure.microsoft.com/documentation/articles/api-management-howto-api-inspector/) , Application Insights телеметрии и журналы ресурсов.
...
-   Политика добавляет пользовательскую трассировку в выходные данные [инспектора API](https://azure.microsoft.com/documentation/articles/api-management-howto-api-inspector/) при активации трассировки, т. е. `Ocp-Apim-Trace` заголовок запроса представлен и имеет значение true, а `Ocp-Apim-Subscription-Key` заголовок запроса имеется и содержит допустимый ключ, позволяющий отслеживать.
-   Политика создает данные телеметрии [трассировки](https://docs.microsoft.com/azure/azure-monitor/app/data-model-trace-telemetry) в Application Insights, когда [Application Insights интеграция](https://docs.microsoft.com/azure/api-management/api-management-howto-app-insights) включена и `severity` уровень, указанный в политике, находится в состоянии или выше уровня, `verbosity` указанного в параметре диагностики.
-   Политика добавляет свойство в запись журнала при включении [журналов ресурсов](https://docs.microsoft.com/azure/api-management/api-management-howto-use-azure-monitor#diagnostic-logs) , а уровень серьезности, указанный в политике, равен уровню детализации, указанному в параметре диагностики, или выше него.
...
| метаданные | Добавляет пользовательское свойство в данные телеметрии [трассировки](https://docs.microsoft.com/azure/azure-monitor/app/data-model-trace-telemetry) Application Insights. | Нет       |
