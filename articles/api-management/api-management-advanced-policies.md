...
| --------------------------------------- | ---------------------------------------------------------------------------------------------------------------- | -------- | ----------- |
| timeout="целое число"                       | Интервал времени ожидания в секундах до того, как вызов, адресованный внутренней службе, завершится сбоем. Минимальное значение — 0 секунд. Максимальные значения — 240 секунд.| Нет        | 240 секунд |
