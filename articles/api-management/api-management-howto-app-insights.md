...
1. Откройте **портал Azure** и перейдите к **Application Insights** .  
    ![Снимок экрана, на котором показано, как переходить к Application Insights.](media/api-management-howto-app-insights/apim-app-insights-instance-1.png)  
2. Выберите **+ Добавить** .  
...
3. Выберите **+ Добавить** .  
    ![Снимок экрана, на котором показано, куда добавить новое соединение.](media/api-management-howto-app-insights/apim-app-insights-logger-1.png)  
...
6. Только что вы создали средство ведения журнала Azure Application Insights с ключом инструментирования. Оно должно появиться в списке.  
    ![Снимок экрана, на котором показано, где можно просмотреть созданное средство ведения журнала Application Insights Azure с помощью ключа инструментирования.](media/api-management-howto-app-insights/apim-app-insights-logger-2.png)  
...
| Дополнительные параметры: уровень детализации         |                                   | Задает уровень детализации. В журнал будут занесены только пользовательские трассировки с более высоким уровнем серьезности. По умолчанию: Information.                                                                                                                                                                                                                               |
