---
title: Интеграция управления API Azure с Azure Application Insights
...
1. Перейдите на **экземпляр службы управления API Azure** на **портале Azure.**
...
| Расширенные варианты: Verbosity         |                                   | Определяет уровень многословности. Будут зарегистрированы только пользовательские следы с более высоким уровнем тяжести. По умолчанию: Информация.                                                                                                                                                                                                                               |
