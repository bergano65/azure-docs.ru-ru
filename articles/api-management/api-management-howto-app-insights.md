...
| Основные параметры: Первый байт в теле  | целочисленный                           | Задает количество первых байт текста для запросов и ответов, которые будут записываться в журналы Azure Application Insights.  По умолчанию: текст не записывается в журналы.                                                                                                                                                                                              |
