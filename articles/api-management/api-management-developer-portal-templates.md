---
title: Настройка портала разработчика API Management с использованием шаблонов
...
Чтобы изменить шаблоны, войдите на **портал разработчика** в качестве администратора. Чтобы получить там первый открыть портал Azure и нажмите **на портал разработчика** из панели инструментов службы вашего экземпляра Управления API.
...
Щелкнув шаблон, можно перейти на страницу портала разработчика, которая настраивается с помощью этого шаблона. В этом примере отображается шаблон **списка продуктов.** Шаблон **Список продуктов** управляет областью экрана, обозначенной красным прямоугольником.
...
В предыдущем примере на портале разработчиков отображаются два продукта, которые были извлечены из данных, отображаемых в панели **данных шаблона,** как показано в следующем примере:
