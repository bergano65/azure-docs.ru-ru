...
|`Title`|string|Название продукта. Не может быть пустым. Максимальная длина составляет 100 символов.|  
...
|`ProductTitle`|string|Название продукта. Не может быть пустым. Максимальная длина составляет 100 символов.|  
...
|`primaryKey`|string|Первичный ключ подписки. Максимальная длина — 256 символов.|  
|`secondaryKey`|string|Вторичный ключ подписки. Максимальная длина — 256 символов.|  
