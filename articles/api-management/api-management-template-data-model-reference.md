...
|`State`|number|Текущее состояние приложения.<br /><br /> — 0: зарегистрировано.<br /><br /> — 1: отправлено.<br /><br /> — 2: опубликовано.<br /><br /> — 3: отклонено.<br /><br /> — 4: не опубликовано.|  
...
|`ApiID`|string|Идентификатор API, для которого была отправлена эта проблема.|  
