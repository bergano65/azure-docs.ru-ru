...
Существует несколько способов защитить такое подключение. Можно сделать следующее.
...
* Используйте IP-фильтрацию для серверной службы. На всех уровнях управления API за исключением уровня потребления IP-адрес шлюза остается постоянным, с помощью нескольких предостережений, описанных в [статье о документации по IP](api-management-howto-ip-addresses.md).
...
Существует несколько способов сделать это. Можно сделать следующее.
...
Чтобы настроить несколько сред, например тестовую и рабочую, в одном API, используйте один из двух способов. Можно сделать следующее.
