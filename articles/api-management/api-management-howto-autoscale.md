...
> [!NOTE]
> Служба управления API в шкале уровня **потребления** автоматически зависит от трафика - без необходимости дополнительной конфигурации.
...
7. Определите новое правило развертывания единиц.
   ...
   Например, правило развертывания единиц может запустить добавление единицы управления API Azure, когда средний показатель емкости за последние 30 минут превышает 80 %. В следующей таблице представлена конфигурация для такого правила.
    ...
    | Статистика интервала времени  | Среднее           |                                                                                                                                                                                                                                                                                 |
    | Оператор              | Больше      |                                                                                                                                                                                                                                                                                 |
    | Порог             | 80 %               | Пороговое значение для среднего показателя емкости.                                                                                                                                                                                                                                 |
    ...
    | Охлаждение (в минутах)   | 60                | Масштабирование службы Управления API API Azure занимает не менее 20 минут. В большинстве случаев, период охлаждения 60 минут предотвращает запуск многих масштабов из.                                                                                                  |

8. Нажмите кнопку **Добавить**, чтобы сохранить правило.
...
10. Определите новое правило свертывания единиц.
    ...
    | Статистика интервала времени  | Среднее           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
    | Оператор              | Меньше чем         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
    | Порог             | 35 %               | Как и для правила развертывания единиц, это значение во многом зависит от шаблонов использования управления API Azure. |
...
11. Нажмите кнопку **Добавить**, чтобы сохранить правило.
...
13. Нажмите **Сохранить**. Автомасштабирование настроено.
