...
![Снимок экрана, на котором показано, где можно проверить состояние политики CORS.](media/api-management-howto-developer-portal/cors-azure-portal.png)
