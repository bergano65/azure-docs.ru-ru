...
## <a name="apis-and-operations"></a><a name="apis"> </a>API и операции
...
## <a name="products"></a><a name="products"> </a> Продукты
...
## <a name="groups"></a><a name="groups"> </a> Группы
...
## <a name="developers"></a><a name="developers"> </a> Разработчики
...
## <a name="developer-portal"></a><a name="developer-portal"> </a> Портал разработчика
