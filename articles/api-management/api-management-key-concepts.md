...
Выражения политики можно использовать в качестве значений атрибутов или текстовых значений в любой политике управления API, если в ней не указано иное. Некоторые политики (включая [управление потоками](https://msdn.microsoft.com/library/azure/dn894085.aspx#choose) и [настройку переменной](https://msdn.microsoft.com/library/azure/dn894085.aspx#set-variable)) основаны на выражениях политики. Дополнительную информацию см. в документации по [расширенным политикам](https://msdn.microsoft.com/library/azure/dn894085.aspx#AdvancedPolicies) и [выражениям политики](https://msdn.microsoft.com/library/azure/dn910913.aspx).
