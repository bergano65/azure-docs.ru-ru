...
Использование одного и того же захвата в предыдущем сценарии нажмите**Иерархия протокола** **статистики** > 
...
Используя тот же захват в предыдущем сценарии нажмите **Статистика** > **IPv4 Статистика** > **Направления и порты**
