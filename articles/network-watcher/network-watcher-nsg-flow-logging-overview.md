...
1. **Несколько NSG на сетевом адаптере**. Если несколько группы безопасности сети подключены к сетевой карте, ведение журнала потоков должно быть включено для всех
