...
- Журналы потоков имеют функцию хранения, которая позволяет автоматически удалять журналы до года после их создания. **Примечание**. хранение доступно только при использовании [учетных записей хранения общего назначения версии 2 (GPv2)](https://docs.microsoft.com/azure/storage/common/storage-account-overview#types-of-storage-accounts). 
