...
> - [Microsoft Azure](diagnose-communication-problem-between-networks.md)
> - [PowerShell](network-watcher-troubleshoot-manage-powershell.md)
> - [Инфраструктура CLI Azure](network-watcher-troubleshoot-manage-cli.md)
