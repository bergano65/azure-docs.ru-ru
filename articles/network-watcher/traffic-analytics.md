...
3. Выберите учетную запись хранения из имеющихся, в которой будут храниться журналы потоков. Убедитесь, что в вашем хранилище не имеется "Хранилища данных озера Gen2 Иерархическое Namespace Enabled" установлен на истину.
