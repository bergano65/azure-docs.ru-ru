...
![На снимке экрана показана диагностика "наблюдатель за сетями" версии P N.][2]
...
* В каждый момент времени на подписку может выполняться только одна операция устранения неполадок. Чтобы выполнить другую операцию устранения неполадок, дождитесь завершения предыдущей. Активация дополнительных операций, когда предыдущая из них не завершена, приведет к сбою последующих операций. 
