---
title: Визуализация шаблонов сетевого трафика с помощью средств с открытым кодом
...
1. Географическая карта
    ...
    Эта панель предоставляет представление с картой о сетевом трафике, а цвета масштабируются к объему трафика из каждой страны или региона. Можно выбрать выделенные страны или регионы для просмотра дополнительной статистики потока, например пропорции данных, отправленных и полученных от IP-адресов в этой стране или регионе.
...
1. Фильтры
    ...
    Посетите страницу [https://www.capanalysis.net/ca/#about](https://www.capanalysis.net/ca/#about) , чтобы узнать больше о всех возможностях CapAnalysis.
