---
title: Визуализация шаблонов сетевого трафика с помощью инструментов с открытым исходным кодом
...
1. Географическая карта
    ...
    Эта панель предоставляет вам представление карты вашего сетевого трафика, с цветами масштабирования объема трафика из каждой страны / региона. Можно выбрать выделенные страны/регионы для просмотра дополнительных статистических данных о потоках, таких как доля данных, отправляемых и полученных от ИС в этой стране/регионе.
