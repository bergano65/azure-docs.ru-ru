---
title: Диагностика подключения On-Premises через VPN шлюз
...
| **Свойство** | **ПолитикаНа основе** | **Стандартный или высокопроизводительный VPN-шлюз с маршрутизацией на основе маршрутов** |
| --- | --- | --- |
