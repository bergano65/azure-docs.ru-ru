...
| FASchemaVersion_s |   1   | Версия схемы. Не отражает версию журнала потока NSG |
...
1. Некоторые имена полей добавляются с помощью _s или _d. Они не обозначают источник и назначение.
