...
4. — Это одну запись внутренних (подробности в разделе ниже) и попадающих в Log Analytics, аналитика трафика.
...
| SubType_s | FlowLog | Подтип для журналов потоков |
