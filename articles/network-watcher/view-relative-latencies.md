...
## <a name="view-available"></a>Просмотр доступных стран, состояний, городов и поставщиков

Данные будут доступны для определенных поставщиков услуг Интернета, страны и регионы, штатов и городов. Чтобы просмотреть список всех доступных Интернет поставщиков услуг, странах и регионах, штатов и городов, для которых можно просмотреть данные, введите следующую команду:

```powershell
Get-AzNetworkWatcherReachabilityProvidersList -NetworkWatcherName NetworkWatcher_eastus -ResourceGroupName NetworkWatcherRG
```

Данных доступна только для стран, штатов и городов, возвращенных предыдущей команды. Для предыдущей команды необходимо указать имеющийся Наблюдатель за сетями. В примере указывается Наблюдатель за сетями *NetworkWatcher_eastus* в группе ресурсов с именем *NetworkWatcherRG*, но вы можете указать любой имеющийся Наблюдатель за сетями. Если у вас его нет, создайте его, выполнив задачи, описанные в разделе о [создании наблюдателя за сетями](#create-a-network-watcher). 
