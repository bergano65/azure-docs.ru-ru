---
title: Перемещение ресурсов наблюдателя за сетями Azure | Документация Майкрософт
description: Перемещение ресурсов наблюдателя за сетями Azure в разных регионах
...
## <a name="moving-the-network-watcher-resource"></a>Перемещение ресурса наблюдателя за сетями
Ресурс наблюдателя за сетями представляет серверную службу для наблюдателя за сетями и полностью управляемая Azure. Клиентам не требуется управлять им. Операция перемещения не поддерживается для этого ресурса.
