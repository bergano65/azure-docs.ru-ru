...
1. Оповещения по GeoIP — карта распределения оповещений по страны или регионы их происхождения, на основе географического расположения (определяется по IP-Адресу)
