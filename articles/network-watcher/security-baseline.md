...
* [Общие сведения о разрешениях RBAC в службе "наблюдатель за сетями"](https://docs.microsoft.com/azure/network-watcher/required-rbac-permissions)
