...
>  * Добавляет расширение виртуальной машины *азуренетворкватчерекстенсион* [Linux](../virtual-machines/linux/extensions-nwa.md) или [Windows](../virtual-machines/windows/extensions-nwa.md) в виртуальную машину, если оно еще не установлено.
