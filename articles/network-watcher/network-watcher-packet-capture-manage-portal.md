---
title: Управление захватами пакетов - портал Azure
...
2. Вам будет предложено подтвердить удаление записи пакетов. Нажмите кнопку **Да**.
