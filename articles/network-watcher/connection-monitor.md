...
> [!IMPORTANT]
> С 1 июля 2021 г. вы не сможете добавлять новые мониторы подключений в Монитор подключений (классический), но вы сможете продолжить использование тех мониторов подключений, которые были созданы до 1 июля 2021 г. Чтобы прерывание ваших текущих рабочих нагрузок было минимальным, [перейдите с Монитора подключения (классический) на новый Монитор подключений](migrate-to-connection-monitor-from-connection-monitor-classic.md) в Наблюдателе за сетями Azure до 29 февраля 2024 г.
