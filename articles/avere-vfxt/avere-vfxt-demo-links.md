...
* [Рендеринг с помощью пакетной службы Azure и Avere vFXT](https://github.com/Azure/Avere/blob/master/docs/maya_azure_batch_avere_vfxt_demo.md) —60-минутная демонстрация использования Autodesk Maya с пакетной службой Azure и кластером Avere vFXT для создания анимированного фильма.

* [Преимущества использования Avere vFXT для рендеринга](https://github.com/Azure/Avere/blob/master/docs/why_avere_for_rendering.md) — демонстрация,которая сравнивает время рендеринга из NAS с и без кластера Avere vFXT. 


## <a name="high-performance-computing"></a>Высокопроизводительные вычисления

* [Рекомендации по повышению времени загрузки виртуальной машины Azure](https://github.com/Azure/Avere/blob/master/docs/azure_vm_provision_best_practices.md) — воспроизводимый тест использования Avere vFXT для Azure для повышения времени загрузки при работе с тысячей вычислительных клиентов.
