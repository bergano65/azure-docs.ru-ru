...
1. Определите [IP-адрес и путь соединения](#identify-ip-addresses-and-paths-to-mount) для подключения.
...
* путь vFXT (комбинация IP-адреса и пути соединения по пространству имен, описанная [ниже](#junction-and-ip-address));
