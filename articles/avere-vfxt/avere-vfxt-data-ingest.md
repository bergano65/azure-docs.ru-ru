...
1. Определите общее число копируемых файлов и каталогов.
   ...
   Например, используйте служебную программу Avere ``prime.py`` с аргументами ```prime.py --directory /path/to/some/directory``` (можно загрузить по URL-адресу https://raw.githubusercontent.com/Azure/Avere/master/src/dataingestor/prime.py).
