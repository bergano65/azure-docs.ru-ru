...
Данные распределяются по дискам, но не шифруются. Тем не менее сами диски можно зашифровать. Дополнительные сведения см. в разделе [Шифрование](../virtual-machines/security-policy.md#encryption).
...
[Уровни доступа](../storage/blobs/storage-blob-storage-tiers.md#cool-access-tier) предоставляют дополнительные сведения о том, когда может быть целесообразно использовать хранилище "холодного уровня" в качестве вфкст Core фильтр.
