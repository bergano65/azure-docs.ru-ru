...
## <a name="technical-compute"></a>Технические требования. Вычисление
...
## <a name="technical-networking"></a>Технические требования. Сети
...
* [Подготовка к созданию кластера vFXT Avere](avere-vfxt-prereqs.md)
* [Развертывание кластера vFXT Avere](avere-vfxt-deploy.md)
