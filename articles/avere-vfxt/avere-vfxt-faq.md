...
## <a name="technical-compute"></a>Технические требования. Среда выполнения приложений
...
Например ограничение исходящего доступа к Интернету из виртуальной сети вызывает проблемы для кластера нужно также добавить правило, которое явно разрешает доступ к AzureCloud. Описывается в этой ситуации [дополнительная документация на сайте GitHub](https://github.com/Azure/Avere/tree/master/src/vfxt/internet_access.md).
