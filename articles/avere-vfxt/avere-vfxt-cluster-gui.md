...
Прежде чем устанавливать подключение, убедитесь, что пара общедоступного и закрытого ключей SSH, которую вы использовали при создании контроллера кластера, установлена на вашем локальном компьютере. При необходимости ознакомьтесь с документацией о ключах SSH для [Linux](../virtual-machines/linux/ssh-from-windows.md) и [Windows](../virtual-machines/linux/mac-create-ssh-keys.md). Если вместо открытого ключа использовался пароль, вам будет предложено ввести его при подключении.
