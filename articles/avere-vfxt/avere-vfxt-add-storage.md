...
> [!TIP] 
> Если во время создания кластера Avere vFXT было выбрано создание контейнера BLOB-объектов, шаблон или сценарий развертывания создадут контейнер хранилища и определят его в качестве центрального систематизатора, а также создадут связывающее пространство имен как составную кластера vFXT. 
