...
Полное руководство по использованию vfxt.py, служебной программы для создания и администрирования облачного кластера, приведено на странице <https://github.com/AvereSystems/vFXT.py/blob/master/docs/README.md>.  
