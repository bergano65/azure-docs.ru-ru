...
> [!NOTE]
> Если при попытке удаления сетевого профиля появляется сообщение об ошибке, подождите 2-3 дней, чтобы платформа автоматически воспринимала ошибку, и повторите попытку удаления. Если у вас по-прежнему возникают проблемы с удалением сетевого профиля, отправьте [запрос в службу поддержки](https://azure.microsoft.com/support/create-ticket/).
