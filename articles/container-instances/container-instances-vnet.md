...
* **Пиринг виртуальной сети** — невозможно выполнить одноранговую виртуальную сеть, содержащую подсеть, делегированную в службу "экземпляры контейнеров Azure", в другую виртуальную сеть
* **Таблицы маршрутов** — определяемые пользователем маршруты не могут быть настроены в подсети, делегированной в службу "экземпляры контейнеров Azure"
