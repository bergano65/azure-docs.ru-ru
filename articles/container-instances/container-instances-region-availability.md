...
> [!IMPORTANT]
> В настоящее время развертывания с ресурсами GPU не поддерживаются в развертывании виртуальной сети Azure и доступны только в группах контейнеров Linux.
...
| Southeast Asia | Н/Д | Н/Д | 2 | 3.5 | 20 |
