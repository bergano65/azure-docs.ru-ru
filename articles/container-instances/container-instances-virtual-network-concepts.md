...
* **NAT виртуальной сети** . группы контейнеров, развернутые в виртуальной сети, сейчас не поддерживают использование ресурса шлюза NAT для исходящего подключения к Интернету.
