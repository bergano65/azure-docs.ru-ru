...
В этом сценарии можно задать ограничение ресурсов, равное 2 процессорам, для экземпляра контейнера. Эта конфигурация позволяет экземпляру контейнера использовать до 2 ЦП, если он доступен.
