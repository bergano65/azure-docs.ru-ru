...
* **Имя учетной записи хранения** . Если вы использовали предыдущий скрипт, имя учетной записи хранения было сохранено в переменной `$ACI_PERS_STORAGE_ACCOUNT_NAME`. Для отображения имени учетной записи введите:

  ```console
  echo $ACI_PERS_STORAGE_ACCOUNT_NAME
  ```

* **Имя общего ресурса** — это значение уже известно (определяется как `acishare` в предыдущем сценарии).
