...
В целях этого краткого руководства оставьте значение по умолчанию **Общедоступный**, чтобы развернуть образ Microsoft `aci-helloworld`. Этот образ содержит небольшое веб-приложение, написанное на Node.js, которое обслуживает статические HTML-страницы.
