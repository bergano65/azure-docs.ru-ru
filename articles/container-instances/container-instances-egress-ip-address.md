...
При необходимости сначала создайте группу ресурсов Azure с помощью команды [AZ Group Create][az-group-create] . Вот несколько примеров:
