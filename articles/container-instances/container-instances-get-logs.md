...
При наличии контейнера с неправильным поведением Начните с просмотра его журналов с помощью команды [AZ Container Logs][az-container-logs], and streaming its standard out and standard error with [az container attach][az-container-attach].
