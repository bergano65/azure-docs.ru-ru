...
* Группа контейнеров, развернутая [в виртуальной сети (Предварительная версия), в](container-instances-vnet.md) которой размещено небольшое веб-приложение.
...
Выходные данные — это общедоступный IP-адрес `52.142.18.133`, аналогичный:.
