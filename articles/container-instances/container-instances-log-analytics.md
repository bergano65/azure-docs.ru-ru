...
Чтобы отправить журнал и данные событий группы контейнеров в Azure Monitor журналы, укажите существующий идентификатор рабочей области Log Analytics и ключ рабочей области при создании группы контейнеров. В следующих разделах описано, как создать группу контейнеров с поддержкой ведения журналов и как запрашивать журналы.
