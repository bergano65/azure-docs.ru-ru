...
| --- | --- | --- | --- | --- | --- |
| Имя контейнера<sup>1</sup> | 1–63 |Нижний регистр | Буквы, цифры, дефис в любом месте, за исключением первого знака |`<name>-<role>-container<number>` |`web-batch-container1` |
...
| Имя тома | 5–63 |Нижний регистр |Буквенно-цифровые символы и дефисы в любом месте, кроме первого или последнего символа. Не может содержать два дефиса подряд. |`<name>` |`batch-output-volume` |
