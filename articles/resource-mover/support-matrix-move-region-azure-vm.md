...
**Релиз** | **Версия ядра** 
--- |  --- 
SUSE Linux Enterprise Server 12 (SP1, SP2, SP3, SP4) |  Поддерживаются все [ядра версии SUSE 12 SP1, SP2, SP3, SP4](https://wiki.microfocus.com/index.php/SUSE/SLES/Kernel_versions#SUSE_Linux_Enterprise_Server_12) .</br></br> с 4.4.138-4.7-azure по 4.4.180-4.31-azure,</br>с 4.12.14-6.3-azure по 4.12.14-6.34-azure  
...
--- | --- | ---
Размер | Любой размер виртуальной машины Azure с по крайней мере двумя ядрами ЦП и 1 ГБ ОЗУ | Проверьте [размеры виртуальных машин Azure](https://docs.microsoft.com/azure/virtual-machines/sizes-general).
...
В этой таблице приведены сведения о поддержке диска Azure VM OS, диска данных и временного диска. Нужно следить за лимитом диска виртуальной машины и целевыми объектами виртуальных машин [Linux](https://docs.microsoft.com/azure/virtual-machines/linux/disk-scalability-targets) и [Windows](https://docs.microsoft.com/azure/virtual-machines/windows/disk-scalability-targets), чтобы избежать проблем с производительностью.

**Компонент** | **Поддержка** | **Сведения**
--- | --- | ---
Максимальный размер диска ОС | 2048 ГБ | [Узнайте больше](https://docs.microsoft.com/azure/virtual-machines/windows/managed-disks-overview) о дисках, используемых виртуальными машинами.
Временный диск | Не поддерживается | Временный диск всегда исключается из процесса подготовки.<br/><br/> Не сохраняйте долговременные данные на временном диске. [Подробнее](https://docs.microsoft.com/azure/virtual-machines/windows/managed-disks-overview#temporary-disk).
...
Максимальное число дисков данных | До 64, зависимо от поддержки определенного размера виртуальной машины Azure. | [Узнайте больше](https://docs.microsoft.com/azure/virtual-machines/windows/sizesd) о размерах виртуальных машин.
