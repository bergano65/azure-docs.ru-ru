...
- Для доступа к подписке, в которой находится служба перемещения ресурсов Azure, объекту Мовеколлектион требуется [управляемое системой удостоверение](../active-directory/managed-identities-azure-resources/overview.md#managed-identity-types) (прежнее название — управляемое удостоверение службы (MSI)), которое является доверенным для подписки.
...
![Вывод текста после инициации перемещения исходной группы ресурсов](./media/move-region-powershell/initiate-move-resource-group.png)
