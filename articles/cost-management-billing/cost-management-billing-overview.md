---
title: Общие сведения о службе "Управление затратами и выставление счетов Azure" | Документация Майкрософт
description: Функции "Управления затратами" и "Выставление счетов" Azure используются, чтобы выполнять административные задачи выставления счетов и управлять доступом к затратам. Кроме того, вы можете отслеживать расходы на Azure и управлять ими, а также оптимизировать использование ресурсов Azure.
keywords: ''
author: bandersmsft
ms.author: banders
ms.date: 01/24/2020
...
С помощью продуктов и служб Azure вы платите только за используемые продукты. Вы платите только по мере создания и использования ресурсов Azure. Функции "Управления затратами" и "Выставление счетов" Azure используются, чтобы выполнять административные задачи выставления счетов и управлять доступом к затратам. Кроме того, вы можете отслеживать расходы на Azure и управлять ими, а также оптимизировать использование ресурсов Azure.
