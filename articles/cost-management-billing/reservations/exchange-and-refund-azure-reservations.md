...
> [!NOTE]
> Корпорация Майкрософт в настоящее время не взимает плату за досрочную отмену при возмещениях за резервирования. Но мы можем установить такую плату за возмещения в будущем. В настоящее время нет определенной даты начала для применения такой платы.
...
- В настоящее время мы не взимаем плату за досрочную отмену, но в будущем возможен ввод штрафа за отмену в размере 12 %.
