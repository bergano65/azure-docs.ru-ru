...
Azure Reserved Virtual Machine Instances обеспечивают гибкость, позволяющую удовлетворить ваши требования. Зарезервированный экземпляр можно обменять на другой зарезервированный экземпляр того же типа. Также можно вернуть средства за резервирование (до 50 000 долл. США в год), если вы больше не используете его. Максимальный лимит возмещения применяется ко всем резервированиям в области действия соглашения с корпорацией Майкрософт.
