...
Для обмена или возмещения у пользователя должен быть доступ к заказу на резервирование. Рекомендуем предоставлять пользователю разрешения для заказа на резервирование, а не для резервирования.
...
4. Изучите тенденцию использования резервирования с течением времени.  
  ![Изображение, показывающее данные об использовании резервирования ](./media/manage-reserved-vm-instance/reservation-utilization-trend.png)
