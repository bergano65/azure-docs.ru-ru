...
Сведения о том, как разрешить другим пользователям управлять резервированиями, см. в статье [Управление резервированиями для ресурсов Azure](manage-reserved-vm-instance.md).
