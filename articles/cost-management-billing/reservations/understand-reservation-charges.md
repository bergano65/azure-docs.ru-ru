...
Когда вы купите зарезервированную емкость Базы данных SQL Azure, скидка на резервирование будет автоматически применена к базам данных SQL, которые соответствуют атрибутам и количеству резервирования. Резервирование применяется к затратам на вычислительные ресурсы Базы данных SQL, включая первичную реплику и все оплачиваемые вторичные реплики. С вас взимается плата за программное обеспечение, хранение и сеть по обычным тарифам. Вы можете покрыть расходы на лицензирование для Базы данных SQL с помощью программы [Преимущество гибридного использования Azure](https://azure.microsoft.com/pricing/hybrid-benefit/).
...
- Сценарий 5. Вы запускаете одну основную Базу данных SQL (Гипермасштабирование) с 4 ядрами и 3 вторичными репликами, у каждой из которых есть 4 ядра. Резервирование применяется к использованию вычислительных ресурсов для первичной и всех вторичных реплик.
