...
- Вы должны быть владельцем подписки.
...
:::image type="content" source="./media/troubleshoot-no-eligible-subscriptions/subscription-not-eligible.png" alt-text="Пример, в котором показано, почему не удается купить резервирование" :::

### <a name="cause-2"></a>Причина 2

Вы должны быть владельцем подписки. Вы не являетесь владельцем подписки. При выборе подписки, владельцем которой вы не являетесь, отображается следующая ошибка.
...
:::image type="content" source="./media/troubleshoot-no-eligible-subscriptions/no-owner-access.png" alt-text="Пример, в котором показано, почему не удается купить резервирование" :::
