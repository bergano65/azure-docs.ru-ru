...
Данные делятся на два отдельных набора данных: _фактические и экономичные_ . Ниже перечислены отличия этих наборов данных:
...
Обратите внимание, что эти данные недоступны в [API-интерфейсах отчетов для корпоративных клиентов. сведения об использовании](/rest/api/billing/enterprise/billing-enterprise-api-usage-detail).

Ниже приведен пример вызова API сведений об использовании.
...
Если вы являетесь администратором EA, вы можете скачать CSV-файл с новыми данными об использовании на портале Azure. Эти данные недоступны на портале EA (ea.azure.com). для просмотра новых данных необходимо скачать файл использования из портал Azure (portal.azure.com).
...
Сгруппируйте расходы по типам, чтобы получить подробные сведения об использовании, покупках и возвратах платежей. Группировка по резервированиям дает разбивку по расходам на резервирования и расходам по запросу. Помните только те затраты на резервирование, которые вы увидите при просмотре фактической стоимости покупки, но затраты будут выделяться для отдельных ресурсов, которые использовали преимущества при просмотре платных затрат. Также в представлении амортизированной стоимости вы увидите новый тип расходов **UnusedReservation**.
