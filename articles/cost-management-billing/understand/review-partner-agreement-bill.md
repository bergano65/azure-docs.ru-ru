---
title: Ознакомьтесь с накладной по соглашению партнера Майкрософт — Azure
description: Узнайте, как проанализировать счет и использование ресурсов, а затем проверите расходы на счет по соглашению с партнерами Майкрософт.
author: jureid
manager: jureid
tags: billing
...
---
# <a name="tutorial-review-your-microsoft-partner-agreement-invoice"></a>Учебник. Ознакомьтесь с накладной по партнерским соглашениям Майкрософт

 В учетной записи выставления счетов Соглашения с партнером Майкрософт в каждом профиле выставления счетов ежемесячно создается счет. В счет входят все расходы клиента за предыдущий месяц. Вы можете интерпретировать расходы, включенные в счет, проанализировав отдельные транзакции на портале Azure. Вы также можете просмотреть счета в портал Azure и сравнить расходы в файле сведений об использовании.

Дополнительные сведения см. в статье [Просмотр и скачивание счета Microsoft Azure](download-azure-invoice.md).

Это руководство относится только к партнерам Azure с соглашением с партнерами Майкрософт.

В этом руководстве описано следующее.

> [!div class="checklist"]
> * Проверка выставленных счетов транзакций в портал Azure
> * Просмотр ожидаемых расходов для прогнозирования следующего счета
> * Анализ расходов на использование Azure

## <a name="prerequisites"></a>Технические условия

Необходимо иметь доступ к учетной записи выставления счетов для соглашения партнера Майкрософт.

Срок его службы должен составлять более 30 дней с момента подписки на Azure. Azure выставляет счет в конце периода выставления счетов.
...
В портал Azure введите " *Управление затратами + выставление счетов* " в поле поиска, а затем выберите **Управление затратами + выставление счетов**.
...
![Снимок экрана, на котором показано соглашение партнера Майкрософт на странице свойств](./media/review-partner-agreement-bill/billing-account-properties-partner-agreement.png)
...
![Снимок экрана, на котором показано соглашение партнера Майкрософт на странице списка учетных записей выставления счетов](./media/review-partner-agreement-bill/mpa-in-the-list.png)

## <a name="review-invoiced-transactions-in-the-azure-portal"></a>Проверка выставленных счетов транзакций в портал Azure

В области Управление затратами и выставление счетов выберите **все транзакции** в левой части страницы. В зависимости от уровня доступа вам, возможно, потребуется выбрать учетную запись выставления счетов, профиль выставления счетов или клиента, а затем **Все транзакции**.
...
|СДКУ продукта     | Уникальный код, определяющий экземпляр продукта |
|Объем     |  Сумма транзакции      |
|Профиль выставления счетов     | Эта транзакция отображается в этом профиле выставления счетов |

Найдите идентификатор счета, чтобы отфильтровать проводки по счету.
...
В окне Управление затратами + выставление счетов выберите профиль выставления счетов. В зависимости от уровня вашего доступа вам, возможно, потребуется выбрать учетную запись выставления счетов. В учетной записи выставления счетов щелкните **Профили выставления счетов** и выберите профиль выставления счетов.
