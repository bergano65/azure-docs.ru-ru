...
1. Выполните поиск по фразе *Управление затратами + выставление счетов*.
    ...
    ![Снимок экрана, показывающий поиск на портале Azure](./media/download-azure-daily-usage/portal-cm-billing-search.png)
...
1. Выберите **значок скачивания** или многоточие (`...`) справа.
1. Справа откроется область загрузки. Выберите **скачать** в разделе **сведения об использовании** .
...
5. Щелкните **Использование и расходы Azure**.
    ...
    ![Снимок экрана, показывающий загрузку из "Обзора"](./media/download-azure-daily-usage/open-usage01.png)
...
- [Просмотр и скачивание сведений о ценах для вашей организации](../manage/ea-pricing.md)

Если у вас есть Клиентское соглашение Майкрософт см. следующие сведения.

- [Сведения об подробном использовании Azure в клиентском соглашении Майкрософт](mca-understand-your-usage.md)
- [Общие сведения об оплате счета в соответствии с клиентским соглашением Майкрософт](review-customer-agreement-bill.md)
- [Просмотр и скачивание счета Microsoft Azure](download-azure-invoice.md)
- [Просмотр и скачивание налоговых документов по клиентскому соглашению Майкрософт](mca-download-tax-document.md)
- [Просмотр и скачивание сведений о ценах для вашей организации](../manage/ea-pricing.md)
