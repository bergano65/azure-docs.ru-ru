...
Плата за использование — это общая сумма за использование подписки **за месяц**. В ней не учитываются какие-либо поступления на счет или скидки.
...
PayGPrice | Розничная цена на ресурс.
PricingModel | Идентификатор, указывающий, как образуется цена за единицу измерения (значения: On Demand, Reservation, Spot)
