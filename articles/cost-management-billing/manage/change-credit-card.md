...
1. Щелкните значок многоточия (`...`) в конце строки.  
    :::image type="content" source="./media/change-credit-card/edit-delete-credit-card-mca.png" alt-text="Снимок экрана, отображающий параметр замены" :::
