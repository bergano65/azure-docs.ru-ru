...
PAL позволяет корпорации Майкрософт выявлять и идентифицировать партнеров, которые наиболее успешно работают с клиентами, использующими Azure. Корпорация Майкрософт может определить влияние и доход от потребления ресурсов Azure в вашей организации на основе разрешений учетной записи (роль Azure) и области (подписка, группа ресурсов, ресурс).
