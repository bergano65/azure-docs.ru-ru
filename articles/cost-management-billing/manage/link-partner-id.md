...
- **Гостевой пользователь**. Клиент может добавить вас в качестве гостевого пользователя и назначить роли Azure. Дополнительные сведения см. в статье [Что такое служба совместной работы Azure AD B2B](../../active-directory/external-identities/what-is-b2b.md).
...
2. Войдите в клиент пользователя с помощью учетной записи пользователя или субъекта-службы. Дополнительные сведения см. в разделе [Вход с помощью PowerShell](/powershell/azure/authenticate-azureps).
...
2. Войдите в клиент пользователя с помощью учетной записи пользователя или субъекта-службы. Дополнительные сведения см. в разделе [Вход с помощью Azure CLI](/cli/azure/authenticate-azure-cli).
...
1. Для связанной учетной записи пользователя не настроено [управление доступом на основе ролей (Azure RBAC)](../../role-based-access-control/overview.md) ни в одном клиентском ресурсе или подписке Azure.

2. Отсутствуют сведения об использовании подписки Azure, в которой пользователь имеет доступ на основе [Azure RBAC](../../role-based-access-control/overview.md).
