...
После регистрации в вашей учетной записи кредитной карты может быть выставлен небольшой счет для проверки. Это значение удаляется в течение трех–пяти дней. Если вы беспокоитесь об управлении расходами, узнайте больше о [предотвращении непредвиденных затрат](getting-started.md).
