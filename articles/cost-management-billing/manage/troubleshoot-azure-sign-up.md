...
Вы можете столкнуться с проблемой при регистрации для создания учетной записи на портале Microsoft Azure или в Центре управления учетной записью Azure. Прежде чем устранять эту неполадку, проверьте следующие рекомендации:
...
4. При регистрации подписки Azure убедитесь, что адрес выставления счетов для регистрации кредитной карты соответствует банковским записям.
...
![Проверка личности с помощью карты](./media/troubleshoot-azure-sign-up/identify-verification-by-card.png)
...
Адрес для выставления счетов должен находиться в той же стране или том регионе, которые выбраны в разделе **О вас**. Убедитесь, что вы правильно выбрали страну или регион.
...
- Проверьте введенный номер телефона, включая код страны или региона, выбранный в раскрывающемся меню.
...
После регистрации в вашей учетной записи кредитной карты могут быть удержаны небольшие средства для проверки. Это значение удаляется в течение трех–пяти дней. Если вы беспокоитесь об управлении расходами, узнайте больше о [предотвращении непредвиденных затрат](getting-started.md).
