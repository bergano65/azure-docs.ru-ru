...
3. Нажмите кнопку скачивания, чтобы скачать копию счета в формате PDF, а затем выберите **Скачать счет**. Если отображается сообщение **Недоступно**, см. раздел [Почему не отображается счет за последний расчетный период?](#noinvoice)
    ...
    ![Снимок экрана, на котором показаны расчетные периоды, параметр для скачивания, данные о ежедневном использовании и общие выплаты за каждый расчетный период](./media/download-azure-invoice-daily-usage-date/downloadinvoice.png)
...
4. Вы также можете скачать файл с данными об израсходованных объемах с разбивкой по дням и ориентировочной величиной расходов, щелкнув **Скачать CSV-файл**.
    ...
    ![Снимок экрана кнопкой "Скачать счет" и разделом использования](./media/download-azure-invoice-daily-usage-date/usageandinvoice.png)
...
Вы можете отказаться от получения счета по электронной почте, выполнив приведенные выше действия и выбрав пункт **отказаться**. Все владельцы, участники, читатели и менеджеры по накладным будут отключаться от получения счета по электронной почте. Если вы являетесь читателем, изменить отправку счета по электронной почте нельзя.
