...
Администраторы предприятия имеют наибольшие права для управления Соглашением о регистрации Azure EA. Первоначальный администратор Azure EA создается при настройке Соглашения Enterprise. Но вы в любое время можете добавить новых администраторов или удалить их. Только существующие администраторы могут добавлять новых администраторов. Дополнительные сведения о добавлении дополнительных администраторов предприятия см. в статье [Создание другого администратора предприятия](ea-portal-get-started.md#create-another-enterprise-admin). Дополнительные сведения о ролях и задачах профиля выставления счетов см. в разделе [роли и задачи профиля выставления счетов](understand-mca-roles.md#billing-profile-roles-and-tasks).
...
Дополнительные сведения см. в разделе о [добавлении администратора подразделений Azure EA](ea-portal-get-started.md#add-a-department-admin).
...
Квота на расходы в отделе теперь будет отображаться в представлении списка отделов на вкладке отдел. По завершении текущего обязательства на портале Azure EA будут поддерживаться квоты на затраты для следующего условия обязательства.
...
При передаче учетной записи владелец учетной записи перемещается из одной регистрации в другую. Все связанные подписки с владельцем учетной записи будут перемещены в целевую регистрацию. Это выполняется при наличии нескольких активных регистраций и необходимости перемещения только выбранных владельцев учетных записей.
...
Можно выполнить обратную передачу учетной записи до даты начала целевой регистрации или даты начала учетной записи, в зависимости от того, какая из них более поздней даты начала. После передачи учетной записи все сведения о потреблении для учетной записи до фактической даты переноса сохраняются в том Соглашении о регистрации, из которого выполнялся перенос. Сведения об использовании после даты передачи будут перемещены в целевую регистрацию.

### <a name="prerequisites"></a>Технические условия

В запросе на перенос учетной записи предоставьте следующую информацию:

- Номер целевой учетной записи для регистрации, имени учетной записи и владельца учетной записи для перемещения
- Регистрационный номер исходного Соглашения о регистрации и идентификатор переносимой учетной записи.
- Для даты вступления в силу учетной записи она может быть возвращена назад в качестве даты начала целевой регистрации или датой начала учетной записи, в зависимости от того, какая из этих дат была позже.
...
- После завершения передачи переданная учетная запись будет неактивна под исходной регистрацией и будет отображаться активной под целевой регистрацией.
...
Перенос регистрации рассматривается в следующих случаях:

- Срок текущего обязательства по регистрации был завершен.
- Срок действия регистрации истек, Расширенное состояние и согласование нового соглашения.
- Если у вас есть несколько регистраций и вы хотите консолидировать все счета и выставление счетов в рамках одной регистрации.
...
- Все службы Azure, подписки, учетные записи, отделы и вся структура регистрации, включая администраторов отделов EA, передаются в новую целевую регистрацию.
...
Действующий день перемещения может быть не позже даты начала целевой регистрации.
...
Передача с возвратом по времени поддерживается до даты начала целевой регистрации. Указание выбранной даты передачи не влияет на использование уже выпущенного счета.

### <a name="prerequisites"></a>Технические условия

При запросе на перенос Соглашения о регистрации предоставьте следующую информацию:

- Для исходной регистрации — номер регистрации.
...
- Требуется утверждение как от целевого, так и от исходного администратора с регистрацией EA.
- Если перенос Соглашения о регистрации не соответствует вашим требованиям, рассмотрите вариант переноса учетной записи.
- Состояние регистрации источника будет изменено на передано и будет доступно только для целей составления отчетов об использовании.
...
### <a name="no-services-affected-for-account-and-enrollment-transfers"></a>Нет затронутых служб для передачи учетных записей и регистрации

При переносе учетной записи или регистрации время простоя отсутствует. Перенос можно выполнить в день подачи запроса, если были предоставлены все необходимые сведения.
