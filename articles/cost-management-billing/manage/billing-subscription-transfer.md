...
Если вы хотите сохранить права владения на выставление счетов, изменив только тип подписки, перейдите к статье [о переключении подписки Azure на другое предложение](switch-azure-offer.md). Чтобы изменить права на управление ресурсами в подписке, см. статью [Built-in roles for Azure resources](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles) (Встроенные роли для ресурсов Azure).
...
Если права владения на выставление счетов для подписки вы передаете учетной записи в другом клиенте Azure AD, можете одновременно перенести эту подписку в клиент новой учетной записи. Но при этом все пользователи, группы и субъекты-службы с [доступом на основе ролей (RBAC)](../../role-based-access-control/role-assignments-portal.md) для управления подпиской и ее ресурсами потеряют этот доступ. Доступ к управлению этими ресурсами будет только у того пользователя в новой учетной записи, который подтвердит запрос на передачу. Чтобы снова предоставить доступ пользователям, которые утратили его, новый владелец должен [вручную добавить этих пользователей в подписку](https://docs.microsoft.com/azure/role-based-access-control/role-assignments-portal).
...
1. Просмотрите и обновите роли администратора служб, соадминистраторов и другие роли RBAC. Дополнительные сведения см. в статьях [Добавление или изменение администраторов подписки Azure](add-change-subscription-administrator.md) и [Управление доступом с помощью RBAC и портала Azure](../../role-based-access-control/role-assignments-portal.md).
...
Передача подписки на портале Azure доступна только для перечисленных ниже типов подписок. В настоящее время перенос подписки [бесплатной пробной версии](https://azure.microsoft.com/offers/ms-azr-0044p/) или [Azure с открытой лицензией (AIO)](https://azure.microsoft.com/offers/ms-azr-0111p/) не поддерживается. Сведения об обходном решении см. в статье [Перемещение ресурсов в новую группу ресурсов или подписку](../../azure-resource-manager/management/move-resource-group-and-subscription.md). Чтобы перенести другие подписки (например, [спонсорское предложение](https://azure.microsoft.com/offers/ms-azr-0036p/) или планы поддержки), [обратитесь в службу поддержки Azure](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade).
...
Да. Но назначения [ролей администратора](add-change-subscription-administrator.md) и [управления доступом на основе ролей (RBAC)](../../role-based-access-control/role-assignments-portal.md) могут быть удалены. Потеря доступа происходит в том случае, если учетная запись находится в клиенте Azure AD, отличном от клиента этой подписки, и отправивший запрос пользователь переместит подписку в клиент вашей учетной записи. Чтобы узнать, какие пользователи имеют [доступ на основе ролей](../../role-based-access-control/overview.md) для управления ресурсами в подписке, выполните следующие действия.
