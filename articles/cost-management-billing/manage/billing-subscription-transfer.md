...
Если вы являетесь клиентом по Соглашению Enterprise (EA), администратор предприятия может передавать между учетными записями права на выставление счетов для подписок. Дополнительные сведения см. в статье [Изменение владельца учетной записи](ea-portal-administration.md#change-account-owner).
