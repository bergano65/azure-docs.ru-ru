...
**Учетная запись Майкрософт:** Учетные записи, которые были связаны с Live ID на [https://signup.live.com](https://signup.live.com).

**Рабочая или учебная учетная запись:** Доступно только компаниям, которые настроили Active Directory с помощью Федерации в облаке, а все учетные записи находятся в одном клиенте. Пользователей можно добавить с помощью типа авторизации рабочей или учебной учетной записи, если внутренний экземпляр Active Directory организации является федеративным в облаке.
