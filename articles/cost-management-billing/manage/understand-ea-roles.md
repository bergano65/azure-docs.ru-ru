...
|---|---|
|Администратор предприятия|Неограниченная|
|Администратор предприятия (только для чтения)|Неограниченная|
|Администратор отдела|Неограниченная|
|Администратор отдела (только для чтения)|Неограниченная|
