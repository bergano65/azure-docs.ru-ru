...
|Владелец учетной записи|1 на одну учетную запись<sup>2</sup>|

<sup>2</sup> Каждая учетная запись должна иметь уникальную учетную запись Майкрософт (рабочую или учебную учетную запись).
...
|Просмотр данных о контактных лицах<sup>3</sup> |✔|✔|✘|✘|✘|
|Добавление и удаление контактных лиц<sup>3</sup> |✔|✘|✘|✘|✘|
|Создание отделов и управление ими |✔|✘|✘|✘|✘|
|Просмотр администраторов отдела|✔|✔|✔|✔|✘|
|Добавление и удаление администраторам отдела|✔|✘|✔|✘|✘|
|Просмотр учетных записей в регистрации |✔|✔|✔<sup>4</sup>|✔<sup>4</sup>|✘|
|Добавление учетных записей в регистрацию, изменение владельца учетной записи|✔|✘|✔<sup>4</sup>|✘|✘|
|Создание подписок и разрешений для подписок, управление ими|✘|✘|✘|✘|✔|

- <sup>3</sup> Контактным лицам рассылаются информационные письма о Соглашении Enterprise Azure.
- <sup>4</sup> Задача ограничивается учетными записями конкретного отдела.
...
|Просмотр сведений о потреблении и затратах|✔|✔|✔<sup>5</sup>|✔<sup>5</sup>|✔<sup>6</sup>|
|Управление ресурсами на портале Azure|✘|✘|✘|✘|✔|

- <sup>5</sup> Требуется, чтобы администратор предприятия включил политику **DA view charges** (Возможность просмотра затрат для администратора отдела) на Enterprise Portal. После этого администратор отдела сможет просматривать сведения о затратах для отдела.
- <sup>6</sup> Требуется, чтобы администратор предприятия включил политику **AO view charges** (Возможность просмотра затрат для владельца учетной записи) на Enterprise Portal. После этого владелец учетной записи сможет просматривать сведения о затратах для учетной записи.
