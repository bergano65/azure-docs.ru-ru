...
description: Сведения о настройке учетных записей выставления счетов для Клиентского соглашения Майкрософт. Ознакомьтесь с предварительными требованиями для настройки и просмотрите дополнительные ресурсы.
...
Если уже истек или скоро истекает срок действия прямого Соглашения о регистрации для вашего Соглашения Enterprise, вы можете подписать Клиентское соглашение Майкрософт для продления этого Соглашения о регистрации. В этой статье описываются изменения, которые будут применены к выставлению счетов в этой ситуации, и пошаговый процесс настройки новой учетной записи выставления счетов. Сейчас непрямые Соглашения Enterprise, срок действия которых истекает, нельзя продлить с помощью Клиентского соглашения Майкрософт.

Процесс продления соглашения включает следующие шаги:
...
Доступ к ресурсам Azure, который был настроен с помощью механизма управления доступом на основе ролей (Azure RBAC), не затрагивается этим переходом.
...
4. В области слева выберите **Управление доступом (IAM)** .
   ...
   ![Снимок экрана: доступ администраторов предприятия, которые указаны как владельцы учетных записей выставления счетов, после перехода.](./media/mca-setup-account/mca-ea-admins-ba-access-post-transition.png)
...
4. В области слева выберите **Управление доступом (IAM)** .
   ...
   ![Снимок экрана: доступ администраторов предприятия, которые указаны как владельцы профиля выставления счетов, после перехода.](./media/mca-setup-account/mca-ea-admins-bp-access-post-transition.png)
...
- [Get started with your new billing account](../understand/mca-overview.md) (Начало работы с новой учетной записью выставления счетов)
