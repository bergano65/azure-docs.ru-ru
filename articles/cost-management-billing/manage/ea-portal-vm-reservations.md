...
Мы будем частично возмещать средства при возврате резервирований клиентами в рамках EA, приобретенных за счет избытка, а не за счет денежных обязательств.
