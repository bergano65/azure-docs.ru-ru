...
С помощью API-интерфейсов Azure вы можете программным способом получить сведения о резервированиях службы или программного обеспечения Azure для своей организации. Дополнительные сведения см. в статье [API-интерфейсы для автоматизации резервирования Azure](../reservations/reservation-apis.md).
...
Вы можете просмотреть сведения о приобретении зарезервированного экземпляра в меню _Резервирования_ в левой части [портала Azure](https://aka.ms/reservations) или на [портале Azure EA Portal](https://ea.azure.com/). Выберите **отчеты** в меню слева и прокрутите вниз до раздела _Оплата по службам_ на вкладке _Сводка по использованию_ . Прокрутите раздел вниз, и зарезервированный экземпляр покупки и использование будут перечислены в конце, как указано в параметре "1 год" или "3 года" рядом с именем службы, например: Standard_DS1_v2 eastus 1 год или Standard_D2s_v3 eastus2 3 года.
