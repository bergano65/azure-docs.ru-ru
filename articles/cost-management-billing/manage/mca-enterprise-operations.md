...
- Для соглашения о регистрации создается профиль выставления счетов. Профиль выставления счетов позволяет вам управлять выставлением счетов для организации, аналогично соглашению о регистрации для Соглашения Enterprise. Дополнительные сведения о профилях выставления счетов см. в [этой статье](../understand/mca-overview.md#billing-profiles).
