...
1. Войдите на [портал Azure](https://portal.azure.com/) с тем адресом электронной почты, который имеет разрешения администратора для этой учетной записи.
...
1. На [портале Azure](https://portal.azure.com/#blade/HubsExtension/ContactInfoBlade) выберите значок со своими инициалами или изображением. Затем выберите контекстное меню ( **...** ). Далее в меню выберите **Мои контактные данные** и введите новый адрес электронной почты.
