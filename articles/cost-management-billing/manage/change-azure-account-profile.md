...
*Адрес электронной почты для сообщений электронной почты по службам и маркетингу* — вы можете указать адрес электронной почты, отличный от того, с которым вы входите в систему, для получения важных уведомлений о выставлении счетов, службах и рекомендациях по этой учетной записи Azure.  
