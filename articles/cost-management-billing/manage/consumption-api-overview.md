...
-   **Управление доступом на основе ролей Azure (Azure RBAC).** Настройте политики доступа с помощью [портала Azure](https://portal.azure.com), [Azure CLI](../../role-based-access-control/role-assignments-cli.md) или [командлетов Azure PowerShell](/powershell/azure/), чтобы указать, какие пользователи или приложения могут получить доступ к данным о потреблении в рамках подписки. Вызывающие объекты должны использовать стандартные маркеры Azure Active Directory для проверки подлинности. Добавьте вызывающий объект в роль читателя счетов, читателя, владельца или участника, чтобы получить доступ к данным об использовании для конкретной подписки Azure.
...
Дополнительные сведения вы найдете в технической спецификации [API сведений о потреблении](/rest/api/consumption/usagedetails).
...
Дополнительные сведения вы найдете в технической спецификации [API расходов для Marketplace](/rest/api/consumption/marketplaces).
...
Дополнительные сведения вы найдете в технической спецификации [API балансов](/rest/api/consumption/balances).
...
Дополнительные сведения вы найдете в технической спецификации [API бюджетов](/rest/api/consumption/budgets).
...
Дополнительные сведения вы найдете в технической спецификации [API рекомендаций по резервированию](/rest/api/consumption/reservationrecommendations).
...
Дополнительные сведения вы найдете в технической спецификации [API сведений о резервировании](/rest/api/consumption/reservationsdetails).
...
Дополнительные сведения вы найдете в технической спецификации [API сводок по резервированию](/rest/api/consumption/reservationssummaries).
...
Дополнительные сведения вы найдете в технической спецификации [API прейскурантов](/rest/api/consumption/pricesheet).
...
- См. [общие сведения о программном использовании API-интерфейсов выставления счетов Azure](usage-rate-card-overview.md) для анализа информации о потреблении ресурсов Azure.