...
2. Выполните поиск по фразе **Управление затратами + выставление счетов**.
    ...
    ![Снимок экрана с изображением поиска на портале Azure по фразе "Управление затратами + выставление счетов"](./media/mca-request-billing-ownership/billing-search-cost-management-billing.png)

3. На странице области выставления счетов выберите счет выставления счетов, который будет использоваться для оплаты использования подписок. Счет выставления счетов должен иметь тип " **Соглашение клиента Майкрософт**".
    ...
    > [!NOTE]
    >
    > Портал Azure запоминает последнюю доступную область выставления счетов и отображает область при следующем обращении к странице Управление затратами и выставление счетов. Если вы посещали управление затратами и выставление счетов ранее, вы не увидите страницу области выставления счетов. Если это так, убедитесь, что вы находится в [правильной области](#check-for-access). В противном случае [переключите область](view-all-accounts.md#switch-billing-scope-in-the-azure-portal) , чтобы выбрать счет выставления счетов для соглашения клиента Майкрософт.

4. Выберите **Профили выставления счетов** с левой стороны.

    ![Снимок экрана, показывающий выбор профилей выставления счетов](./media/mca-request-billing-ownership/mca-select-profiles.png)     

    > [!Note]
    >
    > Если профили выставления счетов не отображаются, вы не найдете нужную область выставления счетов. Необходимо выбрать счет выставления счетов для соглашения клиента Майкрософт, а затем выбрать профили выставления счетов. Сведения об изменении областей см. [в разделе переключение областей выставления счетов в портал Azure](view-all-accounts.md#switch-billing-scope-in-the-azure-portal).

5. Выберите **профиль выставления счетов** из списка. После того как вы перейдете за владение подпиской, счет за использование будет взиматься по этому профилю выставления счетов.
...
7. Выберите раздел счета из списка. После того как вы перейдете за владение подписками, их использование будет назначено этому разделу счета профиля выставления счетов.
...
3. На странице области выставления счетов выберите счет выставления счетов, для которого был отправлен запрос на перемещение.
...
7. Выберите в списке раздел счет, для которого был отправлен запрос на перемещение.
...
8. Выберите **Запросы на перемещение** в нижней левой части. На странице "Запросы на перемещение" отображаются следующие сведения:
   ...
   |Идет обработка|Пользователь утвердил запрос на перемещение Выставление счетов для выбранных пользователем подписок перемещается в раздел счета|
