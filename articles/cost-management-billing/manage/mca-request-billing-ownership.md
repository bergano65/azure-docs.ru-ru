...
Пользователь, у которого вы запрашиваете права на выставление счетов, должен иметь одну из следующих ролей:

- В случае с Клиентским соглашением Майкрософт у пользователя должна быть роль владельца выставления счетов.
- В случае с Соглашением Enterprise у пользователя должна быть роль владельца учетной записи.
- В случае с учетной записью выставления счетов в рамках программы Microsoft Online Service у пользователя должна быть роль администратора учетной записи.

Дополнительные сведения о том, как просматривать свои учетные записи выставления счетов на портале Azure, см. [здесь](view-all-accounts.md).
...
1. Введите адрес электронной почты пользователя, от которого запрашивается владение на выставление счетов. Щелкните **Отправить запрос на передачу прав**.  
