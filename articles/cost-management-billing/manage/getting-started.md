...
5. Также вы можете щелкнуть любую метку на диаграмме, чтобы увидеть историю ежедневных затрат по этой метке. Пример. на следующем снимке экрана, щелкнув виртуальные машины, вы увидите Ежедневные затраты на выполнение виртуальных машин.
...
Счет становится доступен по окончании периода выставления счетов. Вы можете [скачать счета и файлы с подробными сведениями об использовании](download-azure-invoice-daily-usage-date.md), чтобы сравнить их и убедиться в правильности выставленных счетов. Дополнительные сведения о том, как сравнить данные о ежедневном использовании со счетом, см. в статье [Расшифровка счета за использование Microsoft Azure](../understand/review-individual-bill.md).

Если вы используете Azure на условиях клиентского соглашения Майкрософт, вы можете также [сравнить счет с данными о транзакциях](../understand/review-customer-agreement-bill.md#review-invoiced-transactions-in-the-azure-portal) для анализа затрат, включенных в счет.
...
| Azure — спонсорство | [Портал спонсорского предложения Azure](https://www.microsoftazuresponsorships.com/) |
