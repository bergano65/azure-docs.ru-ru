...
1. Выберите **Методы оплаты**.
    ...
    ![Снимок экрана: выбранная колонка "Методы оплаты".](./media/account-admin-tasks/subscription-payment-methods-blade.png)
...
1. На панели команд выберите **Оплата по счету**.
    ...
    ![Снимок экрана: выбранная колонка "Методы оплаты".](./media/account-admin-tasks/subscription-payment-methods-pay-by-invoice.png)
...
- [Предотвращение непредвиденных расходов с помощью функции выставления счетов и управления затратами в Azure](getting-started.md)
