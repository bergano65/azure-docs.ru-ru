...
1. Вверху страницы щелкните **Управление**. Вы будете перенаправлены на сайт https://account.azure.com/. В правой части страницы выберите **Удалить предельную сумму расходов**.  
  ![Пример, в котором показано удаление предельной суммы расходов](./media/spending-limit/account-azure-com-spending-limit.png)
1. Вы будете перенаправлены обратно на портал Azure. Выберите подходящий параметр, а затем выберите метод оплаты. Нажмите кнопку **Готово**.  
  ![Выбор параметра для удаления предельной суммы расходов](./media/spending-limit/remove-spending-limit.png)
...
1. Выберите желтый баннер, чтобы изменить параметр для предельной суммы расходов.
