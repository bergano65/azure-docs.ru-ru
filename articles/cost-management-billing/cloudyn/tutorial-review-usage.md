---
title: Руководство. Просмотр сведений о потреблении и затратах с помощью службы Cloudyn в Azure
...
ms.locfileid: "79474566"
---
<!-- Intent: As a cloud-consuming user, I need to view usage and costs for my cloud resources and services.
-->

# <a name="tutorial-review-usage-and-costs"></a>Руководство по Просмотр сведений об использовании и затратах
...
В меню в верхней части окна портала щелкните **Optimizer (Оптимизатор)**  > **Pricing Optimization (Оптимизация цены)**  > **Cost Effective Sizing Recommendations (Рекомендации по подбору эффективных размеров)** . Если этот параметр полезен, примените фильтр для сокращения результатов. Вот изображение с примером.
...
Управление затратами Azure также предоставляет рекомендации по снижению затрат на службы Azure. Дополнительные сведения см. в статье [Учебник. Рекомендации по оптимизации затрат](../costs/tutorial-acm-opt-recommendations.md).
...
> [Прогнозирование будущих затрат](../../cost-management/tutorial-forecast-spending.md)
