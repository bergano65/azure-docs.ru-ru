...
5. Приведенная ниже политика позволяет сохранить отчет в контейнер S3. Скопируйте и вставьте следующий пример политики на вкладку **JSON** . Замените &lt;bucketname&gt; именем своего сегмента.
