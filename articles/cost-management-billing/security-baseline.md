...
- Многофакторная проверка подлинности. Включите многофакторную проверку подлинности в Azure AD и следуйте рекомендациям по управлению идентификацией и доступом в Центре безопасности Azure для оптимальной настройки MFA. MFA можно применять для всех или выбранных пользователей, либо на уровне отдельных пользователей, учитывая условия входа и факторы риска.
...
- [Включение ATP службы хранилища Azure](../storage/common/azure-defender-storage-configure.md?tabs=azure-security-center)
