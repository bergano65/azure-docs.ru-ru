...
Просмотрите видео [How to assign access with Azure Cost Management](https://www.youtube.com/watch?v=J997ckmwTa8) (Как назначить доступ с помощью службы "Управление затратами Azure"), чтобы получить сведения о назначении доступа для просмотра затрат и расходов с помощью управления доступом на основе ролей Azure.
