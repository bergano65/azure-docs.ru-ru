...
| Subscription | [https://portal.azure.com](https://portal.azure.com/) | Читатель службы "Управление затратами" (или просто читатель) | **Возможность просмотра затрат для владельца учетной записи** включена | Все ресурсы и группы ресурсов в подписке |
