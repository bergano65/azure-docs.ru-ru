...
Анализ затрат включает много параметров для группирования и фильтрации. Чтобы узнать о параметрах группирования и фильтрации, просмотрите видео о [создании отчетов Управления затрат по измерениям и тегам](https://www.youtube.com/watch?v=2Vx7V17zbmk). Чтобы просмотреть другие видео, посетите канал YouTube, посвященный [Управлению затратами](https://www.youtube.com/c/AzureCostManagement).
