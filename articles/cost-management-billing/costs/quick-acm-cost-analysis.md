...
| **Cloud** | Разделение затрат на расходы на Amazon Web Services и Azure. Затраты на AWS доступны только в группах управления, внешних учетных записях выставления счетов и внешних подписках. |
...
| **Тег** | Разделение затрат по значениям тегов для конкретного ключа тега. |
