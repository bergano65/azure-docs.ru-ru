...
| Старое свойство API прейскурантов Azure Resource Manager  | Новое свойство API прейскурантов для Клиентского соглашения Майкрософт   | Описание |
| --- | --- | --- |
