...
Войдите в арендатор партнера на портале Azure и выберите **Cost Management + Billing** (Управление затратами и выставление счетов). Выберите соответствующую область выставления счетов в области "Область выставления счетов", а затем выберите **Клиенты**. Список клиентов связан с учетной записью выставления счетов.
