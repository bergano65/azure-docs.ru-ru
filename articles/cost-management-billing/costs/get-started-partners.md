...
Торговые посредники и клиенты могут получить доступ к Управлению затратами в арендаторе клиента и просматривать затраты для подписок, в которых затраты рассчитываются и отображаются в розничных тарифах. Но у таких торговых посредников и клиентов должен быть доступ RBAC к подписке в арендаторе клиента для просмотра затрат. Поставщику следует включить политику видимости затрат для арендатора клиента.
