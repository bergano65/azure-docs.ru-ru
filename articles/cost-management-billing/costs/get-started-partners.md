...
### <a name="view-customer-costs"></a>Просмотр затрат пользователей

Чтобы просмотреть затраты в пользовательском клиенте, откройте раздел **Управление затратами + выставление счетов**. Выберите **Анализ затрат** и укажите в качестве области клиентскую подписку, чтобы начать просмотр затрат.
