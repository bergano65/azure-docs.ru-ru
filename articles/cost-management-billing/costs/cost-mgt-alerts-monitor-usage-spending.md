...
Оповещения о кредите уведомляют вас о расходе предоплаты Azure (прежнее название — денежное обязательство). Предоплату Azure могут использовать организации, подписавшие Соглашение Enterprise. Оповещения о кредите создаются автоматически, если израсходовано 90 % или 100 % остатка на счете для предоплаты Azure. Каждый раз, когда создается оповещение, оно отражается в оповещениях о затратах и в сообщении электронной почты, отправляемом владельцам учетных записей.
