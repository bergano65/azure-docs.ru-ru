...
Администраторы учетных записей индивидуальной подписки Azure могут просматривать данные о выставлении счетов, такие как счета и платежи, и управлять ими ([портал Azure](https://portal.azure.com) > **Подписки** > выберите подписку).
...
В управлении затратами Azure поддерживаются клиенты партнеров поставщиков облачных решений, только если у них есть Клиентское соглашение Майкрософт. Сведения о поддерживаемых клиентах поставщиков облачных решений, у которых еще нет Клиентского соглашения Майкрософт, см. [здесь](/azure/cloud-solution-provider/overview/partner-center-overview).
