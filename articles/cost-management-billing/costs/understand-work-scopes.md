...
- [**Учетная запись выставления счетов**](../manage/view-all-accounts.md) — представляет собой соглашение о регистрации EA. В этой области создаются счета. Покупки, не основанные на использовании, например на Marketplace и резервирования, доступны только в этой области. Они не представлены в подразделениях или учетных записях регистрации.
