...
- **Создание отчетов об использовании ресурсов**. Управление затратами Azure показывает стоимость на портале Azure, а также включает использование в контексте стоимости полного использования, API расходов и скачивания. Но вы также можете детально изучить метрики использования в Azure Monitor, чтобы получить более полное представление. Попробуйте предоставить роль [читателя данных мониторинга](../../role-based-access-control/built-in-roles.md#monitoring-reader) в любой области, где вам нужно включить в отчет подробные метрики использования.
