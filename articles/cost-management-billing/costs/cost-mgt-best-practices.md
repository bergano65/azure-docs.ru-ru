...
- Доступ к популярным бесплатным службам в течение 12 месяцев
...
Дополнительные сведения см. на странице [Сведения о службе "Миграция Azure"](../../site-recovery/migrate-overview.md).
