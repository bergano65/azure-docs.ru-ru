...
Для заголовков HTTP нужно использовать следующее соглашение об именовании: X-MS-AZUREFHIR-AUDIT-AUDIT-\<имя>.
...
Если вы используете клиентскую библиотеку API C# для Firely, код выглядит примерно так:
