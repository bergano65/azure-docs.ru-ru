...
| API                            | Поддерживается — PaaS | Поддерживаемые — OSS (SQL) | Поддерживаемые — OSS (Cosmos DB) | Добавление примечаний                                             |
|--------------------------------|-----------|-----------|-----------|-----------------------------------------------------|
| read                           | Да       | Да       | Да       |                                                     |
| вреад                          | Да       | Да       | Да       |                                                     |
| обновить                         | Да       | Да       | Да       |                                                     |
...
| Тип параметра поиска | Поддерживается — PaaS | Поддерживаемые — OSS (SQL) | Поддерживаемые — OSS (Cosmos DB) | Добавление примечаний |
|-----------------------|-----------|-----------|-----------|---------|
| Number                | Да       | Да       | Да       |         |
...
| Операции поиска       | Поддерживается — PaaS | Поддерживаемые — OSS (SQL) | Поддерживаемые — OSS (Cosmos DB) | Добавление примечаний |
|-------------------------|-----------|-----------|-----------|---------|
| `_filter`               | Нет        | Нет        | Нет        |         |
| `_sort`                 | Нет        | Нет        | Нет        |         |
| `_score`                | Нет        | Нет        | Нет        |         |
