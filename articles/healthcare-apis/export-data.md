...
| _\_анонимизатионконфижетаг_|"0x8D8494A069489EC"|Необязательно для отмены определения экспорта|Это ETag файла конфигурации. Тег eTag можно получить с помощью Обозреватель службы хранилища Azure из свойства BLOB-объекта.|
...
В этой статье вы узнали, как экспортировать ресурсы FHIR с помощью команды $export, включая деидентифицированные данные. Затем можно настроить данные экспорта:
 
>[!div class="nextstepaction"]
>[Настройка экспорта данных](configure-export-data.md)
