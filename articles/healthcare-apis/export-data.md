...
ms.locfileid: "91531672"
---
# <a name="how-to-export-fhir-data"></a>Экспорт данных FHIR

Функция полного экспорта позволяет экспортировать данные с сервера FHIR в соответствии с FHIR спецификацией] ( https://hl7.org/fhir/uv/bulkdata/export/index.html) . 
