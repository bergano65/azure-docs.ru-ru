...
|---------------|-----------|
|Установка|Операция, относящаяся к настройке экземпляра соединителя IoT|
...
|Critical|Существует ошибка на уровне системы в соединителе IoT, и ожидающие обработки сообщения отсутствуют|
...
|TemplateNotFoundException|Шаблон сопоставления устройства или FHIR не настроен с помощью экземпляра соединителя IoT.|Девицетемплатиррор, Фхиртемплатиррор|Critical|Нормализация, Фхирконверсион|
