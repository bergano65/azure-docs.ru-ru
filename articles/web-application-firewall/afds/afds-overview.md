...
### <a name="bot-protection-rule-preview"></a>Правило защиты от ботов (предварительная версия)
...
Если включена защита от ботов, входящие запросы с известных IP-адресов вредоносных ботов регистрируются в журнале FrontdoorWebApplicationFirewallLog. Доступ к журналам WAF можно получить через учетную запись хранения, концентратор событий или Log Analytics. 
