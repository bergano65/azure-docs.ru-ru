...
description: В этой статье содержатся ответы на часто задаваемые вопросы о брандмауэре веб-приложения в службе "Передняя дверь" Azure.
...
## <a name="what-is-waf-on-azure-front-door-service"></a>Что такое WAF в службе "Передняя дверца Azure"? 
