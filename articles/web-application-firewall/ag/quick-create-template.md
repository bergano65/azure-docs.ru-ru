...
description: Узнайте, как с помощью шаблона Azure Resource Manager (шаблона ARM) создать брандмауэр веб-приложения версии 2 в Шлюзе приложений Azure.
