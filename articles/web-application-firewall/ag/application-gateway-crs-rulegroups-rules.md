...
> ![управляет правилами](../media/application-gateway-crs-rulegroups-rules/managed-rules-01.png)
...
- Программы-роботы, обходчикы и Сканеры
...
|Группа правил|Description (Описание)|
|---|---|
...
## <a name="owasp31"></a>Наборы правил

### <a name="general-31"></a> <p x-ms-format-detection="none">Общие сведения</p>

|Идентификатор правила|Description (Описание)|
|---|---|
...
|942280|Обнаруживает postgres pg_sleep Injection, атаки WAITFOR DELAY и попытки завершения работы базы данных|
...
### <a name="crs944-31"></a> <p x-ms-format-detection="none">ЗАПРОС-944-APPLICATION-АТАКОВАТЬ-SESSION-JAVA</p>
...
### <a name="general-30"></a> <p x-ms-format-detection="none">Общие сведения</p>
