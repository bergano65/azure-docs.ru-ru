...
|933151|Атака путем внедрения PHP: обнаружено имя функции PHP с умеренным риском|
|933160|Атака путем внедрения кода PHP = обнаружен вызов функции PHP с высоким уровнем риска|
|933161|Атака путем внедрения PHP: обнаружен вызов функции PHP с низким значением|
