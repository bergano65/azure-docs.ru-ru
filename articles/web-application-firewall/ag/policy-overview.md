...
С помощью политик WAF на уровне сайта можно защитить несколько сайтов с разными требованиями к безопасности за один WAF, используя политики для каждого сайта. Например, если имеется пять сайтов за WAF, можно иметь пять отдельных политик WAF (по одному для каждого прослушивателя), чтобы настроить исключения, настраиваемые правила, наборы управляемых правил и все остальные параметры WAF для каждого сайта.

Допустим, к шлюзу приложений применена Глобальная политика. Затем к прослушивателю этого шлюза приложений применяется другая политика. Политика прослушивателя теперь вступает в силу только для этого прослушивателя. Глобальная политика шлюза приложений по-прежнему применяется ко всем другим прослушивателям и правилам на основе путей, которым не назначена определенная политика.
