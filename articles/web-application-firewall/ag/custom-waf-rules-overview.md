...
Настраиваемые правила позволяют создавать специализированные правила в соответствии с потребностями приложений и политиками безопасности. Теперь вы можете ограничить доступ к веб-приложениям по странам или регионам, доступным в общедоступной предварительной версии. Как и в случае с любыми пользовательскими правилами, эту логику можно составить с помощью других правил в соответствии с потребностями вашего приложения. 

   > [!NOTE]
   > Пользовательские правила геосоответствия доступны в юго-центральной части США и Северной Европе. Чтобы получить доступ к ним на портале, используйте [эту ссылку](https://aka.ms/AppGWWAFGeoMatch) , пока она не станет активной для всех. 
