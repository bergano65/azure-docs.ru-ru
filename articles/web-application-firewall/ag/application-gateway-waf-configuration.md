...
$exclusion2 = New-AzApplicationGatewayFirewallExclusionConfig `
   ...
   -Selector "user"
```
Таким образом, если URL-адрес `http://www.contoso.com/?user%281%29=fdafdasfda` передается WAF, он не вычисляет строку **фдафдасфда**, но по-прежнему будет оценивать имя параметра **User %281 %29**. 
