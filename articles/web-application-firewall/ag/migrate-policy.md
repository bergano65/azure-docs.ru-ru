---
title: Миграция политик WAF для шлюза приложений Azure
description: Узнайте, как перенести политики брандмауэра веб-приложения Azure с помощью Azure PowerShell.
...
## <a name="to-migrate-to-waf-policy-using-the-migration-script"></a>Миграция в политику WAF с помощью скрипта миграции

Чтобы запустить скрипт миграции, выполните следующие действия. 

1. Откройте следующее окно Cloud Shell или откройте его на портале.
...
4. Свяжите новую политику WAF с вашим шлюзом приложений. Перейдите к политике WAF на портале и перейдите на вкладку **связанные шлюзы приложений** . Выберите **связать шлюз приложений** , а затем выберите шлюз приложений, к которому нужно связать политику WAF.
