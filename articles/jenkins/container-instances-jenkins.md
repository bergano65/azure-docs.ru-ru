---
title: Дженкинс построить на контейнере экземпляр
description: Узнайте, как настроить сервер Jenkins для выполнения заданий по требованию в экземплярах контейнеров Azure
ms.topic: article
ms.date: 08/31/2018
...
См. дополнительные сведения об [экземплярах контейнеров Azure](../container-instances/container-instances-overview.md).
