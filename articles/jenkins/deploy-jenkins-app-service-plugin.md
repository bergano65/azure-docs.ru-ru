...
* Для приложений Java EE используется [развертывание WAR](/azure/app-service/app-service-deploy-zip#deploy-war-file).
* Для приложений Java SE используется [развертывание ZIP](/azure/app-service/app-service-deploy-zip#deploy-zip-file).
* Для других языков используется [развертывание Git](/azure/app-service/app-service-deploy-local-git).
