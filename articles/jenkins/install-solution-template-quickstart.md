...
description: В этом кратком руководстве вы установите Jenkins на виртуальной машине Azure под управлением Linux, используя шаблон решения Jenkins, и создадите пример приложения на Java.
