...
- Имя и идентификатор корневой группы управления присваиваются по умолчанию. Отображаемое имя можно обновить в любое время для отображения другого имени на портале Azure. Чтобы [изменить имя](manage.md#change-the-name-of-a-management-group), учетной записи необходимо назначить роль владельца или участника в корневой группе управления.
