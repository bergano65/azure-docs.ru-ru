---
title: Краткое руководство. Создание группы управления с помощью портала
...
1. Установите флажок **Создать новую** и заполните поле идентификатора группы управления.
   ...
   :::image type="content" source="./media/create_context_menu.png" alt-text="Область параметров для создания новой группы управления":::
