...
1. Установите флажок **Создать новую** и заполните поле идентификатора группы управления.
   ...
   :::image type="content" source="./media/create_context_menu.png" alt-text="Снимок экрана: окно &quot;Добавить группу управления&quot;, в котором показаны параметры для создания группы управления.":::
