...
>[!IMPORTANT]
>Токены пользователей и кэш группы управления Azure Resource Manager длятся 30 минут, прежде чем они будут вынуждены обновиться.  После выполнения любых действий, таких как перемещение группы управления или подписки, это может занять до 30 минут, чтобы показать.  
>Чтобы увидеть обновления раньше, вам нужно обновить маркер, освежая браузер, ввод и выход, или запрашивая новый маркер.  
...
1. Выберите параметр **Переименовать группу** в верхней части страницы.
   ...
   ![Вариант переименования группы на странице группы управления](./media/detail_action_small.png)

1. Когда откроется меню, введите новое имя.

   ![Переименовать панель группы для переименования группы управления](./media/rename_context.png)
...
## <a name="move-subscriptions"></a>Перемещение подписки 
...
1. Выберите многоточие в конце строки подписки в списке, которую требуется переместить.
   ...
   ![Перемещение опциона на группу управления](./media/move_small.png)

1. Выберите **Переместить**.

1. В открывшемся меню выберите **родительскую группу управления**.

   ![Перемещение панели для изменения родительской группы](./media/move_small_context.png)
...
![Логи активности с группами управления](media/al-mg.png)
...
>"/провайдеры/Microsoft.Management/ManagementGroups/yourMgID"
