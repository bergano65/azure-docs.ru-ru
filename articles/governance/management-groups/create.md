...
Группу управления можно создать с помощью портала, [шаблона диспетчер ресурсов](../../azure-resource-manager/templates/deploy-to-tenant.md#create-management-group), PowerShell или Azure CLI.
