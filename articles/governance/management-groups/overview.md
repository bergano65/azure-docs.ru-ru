...
:::image type="complex" source="./media/subtree.png" alt-text="Схема примера иерархии группы управления." border="false":::
...
Существуют некоторые ограничения на использование настраиваемых ролей в группах управления. 
 ...
 - Действия в плоскости данных поставщика ресурсов невозможно определить в пользовательских ролях для группы управления. Это ограничение связано с тем, что существует задержка при обновлении поставщиков ресурсов в плоскости данных.
...
:::image type="content" source="./media/al-mg.png" alt-text="Схема примера иерархии группы управления." border="false":::
