---
title: Учебник. Создание определения настраиваемой политики
...
ms.locfileid: "78386792"
---
# <a name="tutorial-create-a-custom-policy-definition"></a>Учебник. Создание определения настраиваемой политики
...
Azure Resource Graph можно использовать в [Cloud Shell](https://shell.azure.com), чтобы быстро и удобно просматривать свойства ресурсов.
...
Так как оба критерия должны удовлетворяться, воспользуемся **логическим оператором** [allOf](../concepts/definition-structure.md#logical-operators). Параметр **effectType** мы передадим эффекту, чтобы не делать статичное объявление. Готовое правило имеет следующий вид:
