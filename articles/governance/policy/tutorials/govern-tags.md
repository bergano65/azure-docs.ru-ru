...
Что касается непосредственно среды Azure, управляемой с помощью Политики Azure, требования к тегу _CostCenter_ следующие:
...
Что касается непосредственно среды Azure, управляемой с помощью Политики Azure, требования к тегу _Env_ следующие:
