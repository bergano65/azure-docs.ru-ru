---
title: Руководство. Создание политик для обеспечения соответствия
...
ms.locfileid: "78384534"
---
# <a name="tutorial-create-and-manage-policies-to-enforce-compliance"></a>Руководство. Создание политик для обеспечения соответствия требованиям и управление ими
...
Развертывание, препятствующее назначенной политике или инициативе, можно просмотреть в группе ресурсов, на которую ссылается развертывание: выберите **развертывания** в левой части страницы, а затем выберите **имя развертывания** для неудачного развертывания. Исключенный ресурс отображается с состоянием _Запрещено_. Чтобы определить политику, инициативу и назначение, которые отклонили ресурс, выберите **сбой. Щелкните здесь для получения сведений — >** на странице Обзор развертывания. В правой части страницы откроется окно со сведениями об ошибке. В разделе **Сведения об ошибке** будут идентификаторы GUID связанных объектов политики.

![Развертывание отклонено назначением политики](../media/create-and-manage/rg-deployment-denied.png)

На странице Политика Azure: выберите **соответствие** в левой части страницы и выберите инициативу **Получение политики безопасности** . На этой странице вы увидите, что значение **Отклонено** для заблокированных ресурсов увеличилось. На вкладке **События** содержатся сведения о том, кто пытался создать или развернуть ресурс, отклоненный определением политики.
