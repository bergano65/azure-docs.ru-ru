---
title: 'Пример: использование виртуальной сети, прошедшей проверку, для сетевых интерфейсов виртуальной машины'
description: В этом примере определения политики требуется, чтобы сетевые интерфейсы использовали утвержденную виртуальную сеть, указанную в параметре.
ms.date: 01/23/2019
ms.topic: sample
