...
description: В этом примере определения политики необходимо, чтобы служба ExpressRoute использовала указанные в параметре расположения пиринга.
ms.date: 01/23/2019
ms.topic: sample
