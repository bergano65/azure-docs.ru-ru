...
description: В этом примере определения политики необходимо, чтобы служба ExpressRoute использовала указанный в параметре набор значений для пропускной способности.
ms.date: 01/23/2019
ms.topic: sample
