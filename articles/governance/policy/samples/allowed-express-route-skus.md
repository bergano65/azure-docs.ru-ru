...
description: Этот пример политики требует, чтобы служба ExpressRoute использовала только одобренный номер SKU.
...
ms.date: 09/18/2018
ms.author: dacoulte
ms.openlocfilehash: c36336d0c8168ba9e60950b285be124401bff149
ms.sourcegitcommit: eb9dd01614b8e95ebc06139c72fa563b25dc6d13
ms.translationtype: HT
ms.contentlocale: ru-RU
ms.lasthandoff: 12/12/2018
ms.locfileid: "53318896"
---
# <a name="allowed-expressroute-skus"></a>Допустимые номера SKU ExpressRoute

Эта политика требует, чтобы служба ExpressRoute использовала только одобренный номер SKU. Вы можете указать массив допустимых номеров SKU.
