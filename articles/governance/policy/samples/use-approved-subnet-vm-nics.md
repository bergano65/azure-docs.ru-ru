---
title: 'Пример: использование утвержденной подсети для сетевых адаптеров виртуальной машины'
description: В этом примере определения политики требуется, чтобы сетевые интерфейсы использовали утвержденную подсеть, указанную в параметре.
ms.date: 01/23/2019
ms.topic: sample
