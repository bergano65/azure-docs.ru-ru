...
description: В этом примере определения политики налагается запрет на развертывание определенных типов ресурсов, указанных в параметре.
ms.date: 01/23/2019
ms.topic: sample
