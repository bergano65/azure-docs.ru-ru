...
description: Этот пример политики запрещает использовать программу преимуществ гибридного использования Azure.
...
ms.locfileid: "54853907"
---
# <a name="deny-hybrid-use-benefit"></a>Запрет на использование программы преимуществ гибридного использования
