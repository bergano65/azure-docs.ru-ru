...
description: Индекс примеров для Политики Azure. Категории включают именования, теги, Key Vault, сети, хранилища и многое другое.
author: DCtheGeek
manager: carmonm
...
ms.locfileid: "59796907"
---
# <a name="azure-policy-samples"></a>Примеры для Политики Azure

В таблице ниже указаны ссылки на примеры для Политики Azure. Эти примеры можно также найти в [репозитории примеров для Политики Azure](https://github.com/Azure/azure-policy).
