...
description: В этом примере определения политики требуется, чтобы для баз данных SQL использовались утвержденные номера SKU. Несоответствующие требованиям новые ресурсы отклоняются.
author: DCtheGeek
