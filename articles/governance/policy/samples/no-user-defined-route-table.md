...
description: В этом примере определения политики налагается запрет на развертывание виртуальных сетей с использованием определяемой пользователем таблицы маршрутов.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74069931"
---
# <a name="sample---no-user-defined-route-table"></a>Пример: запрет определяемой пользователем таблицы маршрутов
