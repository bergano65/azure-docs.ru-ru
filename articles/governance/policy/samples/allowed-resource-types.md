...
description: В этом примере определения политики обеспечивается развертывание только утвержденных типов ресурсов, указанных в параметре.
ms.date: 01/23/2019
ms.topic: sample
