---
title: 'Пример: разрешение применения пользовательского образа виртуальной машины из группы ресурсов'
description: В этом примере определения политики необходимо, чтобы пользовательские образы поступали из утвержденной группы ресурсов, указанной в параметре.
ms.date: 01/23/2019
ms.topic: sample
