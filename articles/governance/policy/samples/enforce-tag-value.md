...
description: В этом примере определения политики необходимо, чтобы имя и значение тега были указаны в параметре для каждого ресурса Azure.
ms.date: 01/23/2019
ms.topic: sample
...
ms.locfileid: "74463339"
---
# <a name="sample---enforce-tag-and-its-value"></a>Пример: принудительное применение тега и его значения
