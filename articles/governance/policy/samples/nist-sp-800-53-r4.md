...
В следующей статье подробно описано, как в определении встроенной инициативы Политики Azure по соответствию нормативным требованиям **области соответствия нормативным требованиям** и **элементы управления** сопоставляются со стандартом NIST SP 800-53 R4.
...
Найдите и выберите определение встроенной инициативы по соответствию нормативным требованиям под названием **[Предварительная версия]: Аудит элементов управления NIST SP 800-53 R4 и развертывание определенных расширений виртуальной машины для обеспечения требований аудита**.
...
|Имя<br /><sub>(портал Azure)</sup> |Описание |Действие |Версия<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
...
|Имя<br /><sub>(портал Azure)</sup> |Описание |Действие |Версия<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[Необходимо включить Расширенную защиту данных на управляемых экземплярах SQL](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fabfb7388-5bf4-4ad7-ba99-2cd2f41cebb9) |Аудит управляемых экземпляров SQL без Расширенной защиты данных |AuditIfNotExists, Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurity_Audit.json) |
...
|[Отображение результатов аудита виртуальных машин с Linux без разрешений 0644 для файла passwd](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb18175dd-c599-4c64-83ba-bb018a06d35b) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет Политике Azure обрабатывать результаты аудита виртуальных машин с Linux без разрешений 0644 для файла passwd. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Audit.json) |
|[Отображение результатов аудита виртуальных машин с Linux с учетными записями без паролей](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc40c9087-1981-4e73-9f53-39743eda9d05) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет Политике Azure обрабатывать результаты аудита виртуальных машин с Linux с учетными записями без паролей. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.1.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Audit.json) |
|[Отображение результатов аудита виртуальных машин с Windows без хранения паролей с использованием обратимого шифрования](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет с помощью Политики Azure обрабатывать результаты аудита виртуальных машин с Windows без хранения паролей с использованием обратимого шифрования. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|[Отображение результатов аудита виртуальных машин с Windows с возможностью повторного использования предыдущих 24 паролей](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fcdbf72d9-ac9c-4026-8a3a-491a5ac59293) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет с помощью Политики Azure обрабатывать результаты аудита виртуальных машин с Windows с возможностью повторного использования предыдущих 24 паролей. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Audit.json) |
|[Отображение результатов аудита виртуальных машин с Windows, максимальный срок действия пароля которых не составляет 70 дней](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F24dde96d-f0b1-425e-884f-4a1421e2dcdc) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет с помощью Политики Azure обрабатывать результаты аудита виртуальных машин с Windows, максимальный срок действия пароля которых не составляет 70 дней. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Audit.json) |
|[Отображение результатов аудита виртуальных машин Windows, минимальный срок действия пароля которых не составляет один день](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aa11bbc-5c76-4302-80e5-aba46a4282e7) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет с помощью Политики Azure обрабатывать результаты аудита виртуальных машин с Windows, минимальный срок действия пароля которых не составляет один день. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Audit.json) |
|[Отображение результатов аудита виртуальных машин с Windows без включенного параметра сложности пароля](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff48b2913-1dc5-4834-8c72-ccc1dfd819bb) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет с помощью Политики Azure обрабатывать результаты аудита виртуальных машин с Windows без включенного параметра сложности пароля. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Audit.json) |
|[Отображение результатов аудита виртуальных машин с Windows, минимальная длина пароля которых не ограничена 14 символами](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aebc8d1-020d-4037-89a0-02043a7524ec) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет с помощью Политики Azure обрабатывать результаты аудита виртуальных машин с Windows, минимальная длина пароля которых не ограничена 14 символами. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Audit.json) |
|[Отображение результатов аудита виртуальных машин с Windows без хранения паролей с использованием обратимого шифрования](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |Эта политика должна использоваться только вместе с соответствующей политикой развертывания в инициативе. Это определение позволяет с помощью Политики Azure обрабатывать результаты аудита виртуальных машин с Windows без хранения паролей с использованием обратимого шифрования. Дополнительные сведения о политиках гостевой конфигурации: [https://aka.ms/gcpol](https://aka.ms/gcpol) |auditIfNotExists |[1.0.0 (предварительная версия)](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
