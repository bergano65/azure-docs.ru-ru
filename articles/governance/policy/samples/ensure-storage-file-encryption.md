...
description: Этот пример политики требует, чтобы для учетных записей хранения было включено шифрование файлов.
...
ms.locfileid: "53317792"
---
# <a name="ensure-storage-file-encryption"></a>Обеспечение шифрования файлов хранилища

Эта политика требует, чтобы для учетных записей хранения было включено шифрование файлов.
