...
description: В этом примере определения политики проверяется, отключена ли служба "Наблюдатель за сетью" для указанного в параметре региона.
ms.date: 01/23/2019
ms.topic: sample
