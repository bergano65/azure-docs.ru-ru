...
**Идентификатор**. 1149.01c2System.9 — 01.c **Ответственность**: Неприменимо
...
**Идентификатор**. 1150.01c2System.10 — 01.c **Ответственность**: Неприменимо
...
### <a name="passwords-are-not-displayed-when-entered"></a>Пароли не отображаются при вводе.

**Идентификатор**. 1002.01d1System.1 — 01.d **Ответственность**: Customer
...
**Идентификатор**. 1117.01j1Organizational.23 — 01.j **Ответственность**: Неприменимо
...
**Идентификатор**. 1119.01j2Organizational.3 — 01.j **Ответственность**: Неприменимо
...
**Идентификатор**. 1173.01j1Organizational.6 — 01.j **Ответственность**: Неприменимо
...
**Идентификатор**. 1174.01j1Organizational.7 — 01.j **Ответственность**: Неприменимо
...
**Идентификатор**. 1176.01j2Organizational.5 — 01.j **Ответственность**: Неприменимо
...
**Идентификатор**. 0894.01m2Organizational.7 — 01.m **Ответственность**: Неприменимо
...
**Идентификатор**. 11110.01q1Organizational.6 — 01.q **Ответственность**: Неприменимо
...
**Идентификатор**. 11208.01q1Organizational.8 — 01.q **Ответственность**: Неприменимо

|Имя<br /><sub>(портал Azure)</sub> |Описание |Действие |Версия<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Подписке должно быть назначено более одного владельца](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F09024ccc-0c5f-475e-9457-b7c0d9ed487b) |Мы рекомендуем назначить более одного владельца подписки, чтобы обеспечить избыточность для административного доступа. |AuditIfNotExists, Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Security%20Center/ASC_DesignateMoreThanOneOwner_Audit.json) |

### <a name="electronic-signatures-based-upon-biometrics-are-designed-to-ensure-that-they-cannot-be-used-by-any-individual-other-than-their-genuine-owners"></a>Электронные подписи, основанные на биометрии, служат гарантией того, что их не сможет использовать никто, кроме подлинного пользователя.

**Идентификатор**. 11209.01q2Organizational.9 — 01.q **Ответственность**: Неприменимо
...
**Идентификатор**. 11210.01q2Organizational.10 — 01.q **Ответственность**: Неприменимо
...
**Идентификатор**. 11211.01q2Organizational.11 — 01.q **Ответственность**: Неприменимо
...
### <a name="sharedgroup-and-generic-user-ids-are-only-used-in-exceptional-circumstances-where-there-is-a-clear-business-benefit-when-user-functions-do-not-need-to-be-traced-additional-accountability-controls-are-implemented-and-after-approval-by-management"></a>Общие/групповые и универсальные идентификаторы пользователей используются только в исключительных обстоятельствах, когда существует явное преимущество для бизнеса, когда пользовательские функции не нужно отслеживать, когда реализуются дополнительные средства контроля отчетности, а также после утверждения ответственными за управление.

**Идентификатор**. 1124.01q1System.34 — 01.q **Ответственность**: Customer
...
### <a name="help-desk-support-requires-user-identification-for-any-transaction-that-has-information-security-implications"></a>Для использования службы технической поддержки требуется идентификация пользователя при любой транзакции, которая имеет отношение к безопасности информации.

**Идентификатор**. 1128.01q2System.5 — 01.q **Ответственность**: Customer
...
**Идентификатор**. 1402.05i1Organizational.45 — 05.i **Ответственность**: Неприменимо
...
**Идентификатор**. 1202.09aa1System.1 — 09.aa **Ответственность**: Неприменимо
...
**Идентификатор**. 1210.09aa3System.3 — 09.aa **Ответственность**: Неприменимо
...
**Идентификатор**. 1211.09aa3System.4 — 09.aa **Ответственность**: Неприменимо
...
### <a name="information-collected-from-multiple-sources-shall-be-aggregated-for-review"></a>Данные, собранные из нескольких источников, должны быть агрегированы для проверки.

**Идентификатор**. 12103.09ab1Organizational.5 — 09.ab **Ответственность**: Customer
...
### <a name="automated-systems-support-near-real-time-analysis-and-alerting-of-events-eg-malicious-code-potential-intrusions-and-integrate-intrusion-detection-into-access-and-flow-control-mechanisms"></a>Автоматизированные системы поддерживают анализ и оповещения о событиях (например, вредоносном коде, потенциальных вторжениях) почти в реальном времени, а также интегрируют обнаружения вторжений в механизмы управления доступом и потоком.

**Идентификатор**. 1218.09ab3System.47 — 09.ab **Ответственность**: Customer
...
|Имя<br /><sub>(портал Azure)</sub> |Описание |Действие |Версия<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[База данных Azure для MySQL должна использовать геоизбыточное резервное копирование](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F82339799-d096-41ae-8538-b108becf0970) |Эта политика выполняет аудит Баз данных Azure для MySQL, для которых не включено геоизбыточное резервное копирование. |Audit, Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/GeoRedundant_DBForMySQL_Audit.json) |
...
|Имя<br /><sub>(портал Azure)</sub> |Описание |Действие |Версия<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[База данных Azure для PostgreSQL должна использовать геоизбыточное резервное копирование](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F48af4db5-9b8b-401c-8e74-076be876a430) |Эта политика выполняет аудит Баз данных Azure для PostgreSQL, для которых не включено геоизбыточное резервное копирование. |Audit, Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/GeoRedundant_DBForPostgreSQL_Audit.json) |
...
**Идентификатор**. 1620.09l1Organizational.8 — 09.l **Ответственность**: Неприменимо
...
**Идентификатор**. 1623.09l2Organizational.4 — 09.l **Ответственность**: Неприменимо
...
**Идентификатор**. 1626.09l3Organizational.5 — 09.l **Ответственность**: Неприменимо
...
**Идентификатор**. 1699.09l1Organizational.10 — 09.l **Ответственность**: Неприменимо
...
**Идентификатор**. 0863.09m2Organizational.910 — 09.m **Ответственность**: Неприменимо
...
**Идентификатор**. 0864.09m2Organizational.12 — 09.m **Ответственность**: Неприменимо
...
**Идентификатор**. 0865.09m2Organizational.13 — 09.m **Ответственность**: Неприменимо
...
**Идентификатор**. 0867.09m3Organizational.17 — 09.m **Ответственность**: Неприменимо
...
**Идентификатор**. 0868.09m3Organizational.18 — 09.m **Ответственность**: Неприменимо
...
**Идентификатор**. 0885.09n2Organizational.3 — 09.n **Ответственность**: Неприменимо
...
**Идентификатор**. 0888.09n2Organizational.6 — 09.n **Ответственность**: Неприменимо
...
**Идентификатор**. 0301.09o1Organizational.123 — 09.o **Ответственность**: Неприменимо
...
**Идентификатор**. 0302.09o2Organizational.1 — 09.o **Ответственность**: Неприменимо
...
**Идентификатор**. 0303.09o2Organizational.2 — 09.o **Ответственность**: Неприменимо
...
**Идентификатор**. 0304.09o3Organizational.1 — 09.o **Ответственность**: Неприменимо
...
**Идентификатор**. 0915.09s2Organizational.2 — 09.s **Ответственность**: Неприменимо
...
**Идентификатор**. 0916.09s2Organizational.4 — 09.s **Ответственность**: Неприменимо
...
**Идентификатор**. 0943.09y1Organizational.1 — 09.y **Ответственность**: Неприменимо

|Имя<br /><sub>(портал Azure)</sub> |Описание |Действие |Версия<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Должно выполняться безопасное перемещение в учетные записи хранения](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F404c3081-a854-4457-ae30-26a93ef643f9) |Настройка требования выполнять аудит для безопасного переноса в учетную запись хранения. Безопасная передача данных — это параметр, при включении которого ваша учетная запись хранения принимает запросы только с безопасных подключений (HTTPS). Протокол HTTPS обеспечивает проверку подлинности между сервером и службой, а также защищает перемещаемые данные от атак сетевого уровня, таких как "злоумышленник в середине", прослушивание трафика и перехват сеанса. |Audit, Deny, Disabled |[2.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Storage/Storage_AuditForHTTPSEnabled_Audit.json) |

### <a name="security-is-maintained-through-all-aspects-of-the-transaction"></a>Безопасность обеспечивается в отношении всех аспектов транзакции.

**Идентификатор**. 0944.09y1Organizational.2 — 09.y **Ответственность**: Неприменимо
...
**Идентификатор**. 0945.09y1Organizational.3 — 09.y **Ответственность**: Неприменимо
...
**Идентификатор**. 0946.09y2Organizational.14 — 09.y **Ответственность**: Неприменимо
...
**Идентификатор**. 0947.09y2Organizational.2 — 09.y **Ответственность**: Неприменимо
...
**Идентификатор**. 0948.09y2Organizational.3 — 09.y **Ответственность**: Неприменимо
...
**Идентификатор**. 0949.09y2Organizational.5 — 09.y **Ответственность**: Неприменимо
...
**Идентификатор**. 0640.10k2Organizational.1012 — 10.k **Ответственность**: Неприменимо
...
### <a name="internal-and-external-vulnerability-assessments-of-covered-information-systems-virtualized-environments-and-networked-environments-including-both-network--and-application-layer-tests-are-performed-by-a-qualified-individual-on-a-quarterly-basis-or-after-significant-changes"></a>Оценка внутренних и внешних уязвимостей в соответствующих информационных системах, виртуальных окружениях и сетевых средах, включая тесты на уровне сети и приложения, выполняется квалифицированным лицом ежеквартально или после значительных изменений.

**Идентификатор**. 0712.10m2Organizational.4 — 10.m **Ответственность**: Customer
