---
title: 'Пример: проверка назначения роли администратора Azure AD'
description: В этом примере определения политики проверяется, назначена ли роль администратора Azure Active Directory в настройках SQL Server.
...
ms.locfileid: "56339657"
---
# <a name="sample---audit-no-azure-active-directory-administrator"></a>Пример проверки назначения роли администратора Azure Active Directory
