...
Ресурс, для которого требуется действовать политика Azure, не обрабатывается, и в [журнале действий Azure](../../../azure-monitor/essentials/platform-logs-overview.md)нет записи.
