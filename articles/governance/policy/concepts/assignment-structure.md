...
|Режим |Значение JSON |Тип |Исправить вручную |Запись журнала действий |Description |
|-|-|-|-|-|-|
|Активировано |По умолчанию |string |Да |Да |Этот результат политики применяется во время создания или обновления ресурса. |
|Выключено |донотенфорце |string |Да |Нет | Этот результат политики не применяется во время создания или обновления ресурса. |
