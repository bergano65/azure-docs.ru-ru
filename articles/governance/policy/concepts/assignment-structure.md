...
|-|-|-|-|-|-|
|Включено |Значение по умолчанию |string |Да |Да |Этот результат политики применяется во время создания или обновления ресурса. |
|Отключен |донотенфорце |string |Да |Нет | Этот результат политики не применяется во время создания или обновления ресурса. |
