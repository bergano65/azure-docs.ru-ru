...
Прежде чем начать управление новыми или обновленными ресурсами с помощью нового определения политики, лучше понять, как она оценивает ограниченное подмножество существующих ресурсов, например тестовую группу ресурсов. Используйте [режим](./assignment-structure.md#enforcement-mode)
применения_отключено_ (донотенфорце) для назначения [политики, чтобы](./effects.md) предотвратить создание триггера или запись журнала действий.
