...
:::image type="content" source="../media/policy-as-code/policy-as-code-workflow.png" alt-text="Обзор политики в качестве рабочего процесса кода" border="false":::
