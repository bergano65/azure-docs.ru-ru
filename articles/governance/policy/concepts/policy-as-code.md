...
- Инфраструктура как код. Практика рассмотрения как кода всего содержимого, определяющего вашу среду, от шаблонов Resource Manager до определения политик Azure.
...
Этап проверки также должен быть компонентом других рабочих процессов непрерывной интеграции или непрерывного развертывания. Примеры включают развертывание среды приложения или виртуальной инфраструктуры. Осуществляя проверку политики Azure на ранних этапах процесса сборки и развертывания, группы приложений и операций смогут понять, соответствуют ли их изменения всем стандартам и требованиям, задолго до того, как станет слишком поздно и они пытаются развернуть их в рабочей среде.

## <a name="workflow-overview"></a>Обзор рабочего процесса

Рекомендуемый общий рабочий процесс политики как кода представлен на следующей диаграмме.

:::image type="content" source="../media/policy-as-code/policy-as-code-workflow.png" alt-text="Обзор рабочего процесса политики как кода" border="false":::
...
Общий рабочий процесс для политики как кода предназначен для разработки и развертывания политик и инициатив в масштабе среды. Однако оценка политики должна быть частью процесса развертывания любых рабочих процессов, которые развертывают или создают ресурсы в Azure для создания инфраструктуры, таких как развертывание приложений или запуск шаблонов Resource Manager.
...
В этой статье рассматривается общий рабочий процесс для политики как кода, а также место, которое должна занимать оценка политики в других рабочих процессах развертывания. Этот рабочий процесс можно использовать в любой среде, которая поддерживает действия сценариев и автоматизацию на основе триггеров.
