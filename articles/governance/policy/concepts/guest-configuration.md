...
> [!NOTE]
> **DeployIfNotExists** политики является обязательным для **аудита** политики для возврата результатов.
> Без **DeployIfNotExists**, **аудита** демонстрируется использование политики «0 0» ресурсы с кодом состояния.
