...
1. Зарегистрируйте поставщики ресурсов и предварительные версии функций.
   ...
   - Портал Azure:
     ...
     1. Запустите службу политики Azure в портал Azure, выбрав **все службы**, а затем выполнив поиск и выбрав пункт **Политика**.
        ...
        :::image type="content" source="../media/policy-for-kubernetes/search-policy.png" alt-text="Снимок экрана: Поиск политики во всех службах." border="false":::
