...
В правиле политики можно использовать все [функции шаблона Resource Manager](../../../azure-resource-manager/resource-group-template-functions.md), кроме следующих функций развертываний и ресурсов:
