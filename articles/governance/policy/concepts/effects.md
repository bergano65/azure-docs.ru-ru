...
Этот результат используется с `Microsoft.ContainerService.Data`режимом определения политики . Он используется для передачи правил управления допуском, определенных с помощью [Рего](https://www.openpolicyagent.org/docs/how-do-i-write-policies.html#what-is-rego) , для [открытия агента политики](https://www.openpolicyagent.org/) (Непрозра) в [службе Kubernetes Azure](../../../aks/intro-kubernetes.md).
