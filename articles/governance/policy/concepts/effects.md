---
title: Сведения о действии политик Azure
...
Это действие применяется при тестировании, а также когда определение политики имеет параметризованное действие. Появляется возможность отключить единое назначение этой политики. Для этого можно изменить параметр назначения действия, а не отключать все назначения политики.
