...
Пример 3 Одна пара **поле/значение** с использованием [псевдонима](definition-structure.md#aliases) с массивом **value** для установки правил IP-адресов для учетной записи хранения.
