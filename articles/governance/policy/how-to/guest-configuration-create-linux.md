...
> Чтобы развернуть расширение в масштабе на всех машинах Linux, назначайте следующее определение политики:
...
Сохраните этот `inspec.yml` файл с именем в папке, названной `linux-path` в каталоге проекта.
...
Сохраните этот `linux-path.rb` файл с именем `controls` в `linux-path` новой папке, названной в каталоге.

Наконец, создайте конфигурацию, импортируйте модуль ресурсов **PSDesiredStateConfiguration** и компилируйте конфигурацию.
