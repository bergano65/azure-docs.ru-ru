...
> [!NOTE]
> Для командлета Test-Гуестконфигуратионпаккаже требуется OpenSSL версии 1,0 из-за зависимости от OMI.
> Это приводит к ошибке в любой среде с OpenSSL 1,1 или более поздней версии.
...
Опубликуйте определения политики с помощью командлета `Publish-GuestConfigurationPolicy`.
