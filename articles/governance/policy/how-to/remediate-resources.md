...
Ресурсы, которые не соответствуют политике **deployIfNotExists** или **Modify** , могут быть переведены в соответствующее состояние путем **исправления**. Исправление достигается путем указания политики Azure на выполнение действия **deployIfNotExists** **или тегов** назначенной политики для существующих ресурсов, будь это назначение группе управления, подписке, группе ресурсов или отдельному ресурсу. В этой статье описаны шаги, необходимые для понимания и выполнения исправления с помощью политики Azure.
...
Политика Azure создает управляемое удостоверение для каждого назначения, но должно иметь подробные сведения о том, какие роли должны предоставлять управляемое удостоверение. Если в управляемом удостоверении отсутствуют роли, эта ошибка отображается во время назначения политики или в инициативе. При использовании портала политика Azure автоматически предоставляет управляемому удостоверению указанные роли после начала назначения. _Расположение_ управляемого удостоверения не влияет на его работу с политикой Azure.

:::image type="content" source="../media/remediate-resources/missing-role.png" alt-text="Управляемое удостоверение — отсутствует роль" border="false":::
...
1. Выберите **Исправление** на странице службы "Политика Azure" слева.
   ...
   :::image type="content" source="../media/remediate-resources/select-remediation.png" alt-text="Выбор исправления на странице политики" border="false":::
...
1. Запустите задачу по исправлению после того, как ресурсы были отфильтрованы, щелкнув **Исправить**. Страница соответствие политике открывается на вкладке **задачи исправления** для отображения состояния хода выполнения задач. Развертывания, созданные задачей исправления, начинают сразу же.
