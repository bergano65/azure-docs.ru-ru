...
|Текущее значение должно быть меньше, чем целевое значение. |меньше или **не** greaterOrEquals |
|Текущее значение должно быть больше или равно целевому. |greaterOrEquals или **не** меньше |
|Текущее значение должно быть больше, чем целевое значение. |больше или **не** lessOrEquals |
|Текущее значение должно быть меньше или равно целевому. |lessOrEquals или **не** больше |
|Текущее значение должен существовать. |exists (существует) |
|Текущее значение должно находиться в целевое значение. |в или **не** notIn |
|Текущее значение должно находиться как целевое значение. |как и или **не** notLike |
|Текущее значение должно совпадать с с учетом регистра, целевое значение. |соответствует или **не** notMatch |
|Текущее значение должно совпадать с без учета регистра, целевое значение. |matchInsensitively или **не** notMatchInsensitively |
...
|Текущее значение должно совпадать с без учета регистра, целевое значение. |notMatch или **не** соответствует |
|Текущее значение должно совпадать с не без учета регистра, целевое значение. |notMatchInsensitively или **не** matchInsensitively |
|Нет связанных ресурсов соответствуют эффекта в определении политики. |Ресурс типа, определенного в **then.details.type** и связанный ресурс, определенный в **Если** часть правила политики не существует. |
...
1. На **соответствие ресурсов** вкладке приводятся следующие сведения:
   ...
   ![Просмотр сведений о совместимости](../media/determine-non-compliance/guestconfig-assignment-view.png)
...
![Просмотр сведений о совместимости](../media/determine-non-compliance/guestconfig-compliance-details.png)
