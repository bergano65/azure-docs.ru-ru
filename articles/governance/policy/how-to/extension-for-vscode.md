...
> [!NOTE]
> Если выбранное определение политики имеет значение [помощью параметров auditifnotexists](../concepts/effects.md#auditifnotexists) или [DeployIfNotExists](../concepts/effects.md#deployifnotexists), в области **Оценка** используйте значок плюс, чтобы выбрать _связанный_ ресурс для проверки существования.
