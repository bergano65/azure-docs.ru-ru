...
При аудите Windows Гостевая конфигурация использует модуль ресурсов [настройки требуемого состояния](/powershell/scripting/dsc/overview/overview) (DSC) и файл конфигурации. Конфигурация DSC определяет условие, в котором должен находиться компьютер.
