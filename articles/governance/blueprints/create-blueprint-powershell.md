...
1. Создайте исходный объект _схемы_. Параметр **BlueprintFile** принимает JSON-файл, который содержит свойства схемы, групп ресурсов, которые необходимо создать, и все параметры уровня схемы. Эти параметры задаются при назначении и используются артефактами, которые будут добавлены в дальнейшем.
