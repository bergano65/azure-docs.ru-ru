...
|:---|:---|:---|
|`[artifacts("myTemplateArtifact").outputs.myArray]` | Массив | \["первый", "второй"\] |
|`[artifacts("myTemplateArtifact").outputs.myArray[0]]` | Строка | началь |
|`[artifacts("myTemplateArtifact").outputs.myString]` | Строка | "мое строковое значение" |
|`[artifacts("myTemplateArtifact").outputs.myObject]` | Объект | {"MyProperty": "мое значение", "Аносерпроперти": true} |
