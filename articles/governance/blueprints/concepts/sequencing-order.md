...
> [!NOTE]
> Использование [artifacts()](../reference/blueprint-functions.md#artifacts) создает неявную зависимость на артефакт, на которую выполняется ссылка.
