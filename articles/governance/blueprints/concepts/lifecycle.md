...
Схема в режиме **черновика**, которая никогда не публиковалась, будет отображаться на странице **Определения схем** со значком, отличным от значка для ранее **опубликованной** схемы. **Последней версии** отображается в виде **черновик** они никогда не опубликованного чертежей.
...
1. Выберите **схема определения** на странице слева, а также использования параметров фильтра для поиска в проекте, который вы хотите удалить версию. Щелкните нужную схему, чтобы открыть страницу изменения.

1. Выберите вкладку **Опубликованные версии** и найдите версию, которую требуется удалить.

1. Щелкните правой кнопкой мыши на версию, которую необходимо удалить и щелкните **удалить эту версию**.
