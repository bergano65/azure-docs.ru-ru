...
|Режим|Тип ресурса артефакта|State|Описание|
|-|-|-|-|
...
|-|-|-|-|-|-|
|Только для чтения |**\*** |**\*/чтение** |Системдефинед (все) |Назначение схемы и определяемые пользователем данные в **ексклудедпринЦипалс** |Группа ресурсов — _true_; Ресурс — _false_ |
|Не удалять |**\*/удалить** | |Системдефинед (все) |Назначение схемы и определяемые пользователем данные в **ексклудедпринЦипалс** |Группа ресурсов — _true_; Ресурс — _false_ |
