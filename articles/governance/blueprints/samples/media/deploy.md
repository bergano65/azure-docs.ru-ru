---
title: Развертывание примера схемы мультимедийных данных
description: Шаги развертывания для примера схемы мультимедийных данных и сведения о параметрах артефактов схемы.
ms.date: 02/25/2020
ms.topic: sample
...
ms.locfileid: "78201731"
---
# <a name="deploy-the-media-blueprint-sample"></a>Развертывание примера схемы мультимедийных данных

Чтобы развернуть пример схемы мультимедийных данных, необходимо выполнить следующие действия:
...
1. Найдите пример схемы **мультимедийных данных** в разделе _Другие примеры_ и выберите **Использовать этот пример**.
...
1. В верхней части страницы выберите **Опубликовать схему**. В правой части новой страницы укажите **версию** для копии примера схемы. Это свойство позволяет вносить изменения позднее. Укажите **сведения об изменениях**, например First version published from the Media blueprint sample (Первая версия, опубликованная из примера схемы мультимедийных данных). Затем щелкните **Опубликовать** в нижней части страницы.
...
|\[Предварительная версия.\] Аудит элементов управления мультимедийных данных и развертывание конкретных расширений виртуальной машины для поддержки требований аудита |Назначение политики |Группа администраторов |Группа. Например, `Administrator; myUser1; myUser2`. |
...
Теперь, когда вы ознакомились с процедурой развертывания примера мультимедийных данных, перейдите к статье с обзором схемы и статье о сопоставлении элементов управления:

> [!div class="nextstepaction"]
> [Краткое описание примера схемы мультимедийных данных](./index.md)
> [Сопоставление элементов управления примера схемы мультимедийных данных](./control-mapping.md)
