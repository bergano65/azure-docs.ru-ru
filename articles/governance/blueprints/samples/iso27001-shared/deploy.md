...
|Допустимые номера SKU учетных записей хранения|Назначение политики|Допустимые номера SKU для хранилища|Список разрешенных номеров SKU для учетной записи хранения диагностических журналов. Значение по умолчанию — _["Standard_LRS"]_ .|
...
|Группа ресурсов Log Analytics|Resource group|ИМЯ|**Заблокировано**. Чтобы группа ресурсов была уникальной, объединяются значения **названия организации** и `-sharedsvsc-log-rg`.|
|Группа ресурсов Log Analytics|Resource group|Location|**Заблокировано**. Используется параметр схемы.|
...
|Группа сетевых ресурсов|Resource group|ИМЯ|**Заблокировано**. Чтобы группа ресурсов была уникальной, объединяются значения **названия организации** и `-sharedsvcs-net-rg`.|
|Группа сетевых ресурсов|Resource group|Location|**Заблокировано**. Используется параметр схемы.|
...
|группа ресурсов хранилища ключей;|Resource group|ИМЯ|**Заблокировано**. Чтобы группа ресурсов была уникальной, объединяются значения **названия организации** и `-sharedsvcs-kv-rg`.|
|группа ресурсов хранилища ключей;|Resource group|Location|**Заблокировано**. Используется параметр схемы.|
...
|Группа ресурсов Jumpbox|Resource group|ИМЯ|**Заблокировано**. Чтобы группа ресурсов была уникальной, объединяются значения **названия организации** и `-sharedsvcs-jb-rg`.|
|Группа ресурсов Jumpbox|Resource group|Location|**Заблокировано**. Используется параметр схемы.|
...
|Группа ресурсов для доменных служб Active Directory|Resource group|ИМЯ|**Заблокировано**. Чтобы группа ресурсов была уникальной, объединяются значения **названия организации** и `-sharedsvcs-adds-rg`.|
|Группа ресурсов для доменных служб Active Directory|Resource group|Location|**Заблокировано**. Используется параметр схемы.|
