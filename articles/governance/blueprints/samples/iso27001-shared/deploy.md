...
|Группа ресурсов Jumpbox|группа ресурсов.|Location|**Заблокировано**. Используется параметр схемы.|
...
|Группа ресурсов для доменных служб Active Directory|группа ресурсов.|Location|**Заблокировано**. Используется параметр схемы.|
