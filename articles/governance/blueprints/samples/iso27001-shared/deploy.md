...
|группа ресурсов хранилища ключей;|Группа ресурсов|ИМЯ|**Заблокировано**. Чтобы группа ресурсов была уникальной, объединяются значения **имени организации** и `-sharedsvcs-kv-rg`.|
