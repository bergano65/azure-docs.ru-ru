...
description: 'Сопоставление элементов управления на примере схемы "ISO 27001: общие службы". Каждый элемент управления сопоставляется с определениями одной или нескольких Политик Azure, которые помогают выполнять оценку.'
ms.date: 02/05/2021
ms.topic: sample
...
[Управление доступом на основе ролей Azure (Azure RBAC)](../../../../role-based-access-control/overview.md) упрощает управление доступом к ресурсам Azure. Эта схема помогает управлять доступом к ресурсам Azure, назначая семь определений [Политики Azure](../../../policy/overview.md) для аудита использования типов и конфигураций ресурсов, которые предоставляют повышенные права доступа к ресурсам.
...
[Управление доступом на основе ролей Azure (Azure RBAC)](../../../../role-based-access-control/overview.md) упрощает управление доступом к ресурсам в Azure. С помощью [Azure Active Directory](../../../../active-directory/fundamentals/active-directory-whatis.md) и Azure RBAC вы можете обновлять роли пользователей в соответствии с изменениями в организации. При необходимости можно запретить вход для учетных записей (или удалить их), что немедленно отменит все права доступа к ресурсам Azure. Эта схема назначает два определения [Политики Azure](../../../policy/overview.md) для аудита устаревших учетных записей, которые, возможно, требуется удалить.
