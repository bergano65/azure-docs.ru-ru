...
- [Роли Azure](../../../../role-based-access-control/overview.md), которые используются для разделения обязанностей в контексте уровня управления. Перед развертыванием какой-либо инфраструктуры нужно определить три роли:
  ...
  - роль SecOps с правами, необходимыми для развертывания и администрирования [Центра безопасности Azure](../../../../security-center/security-center-intro.md), описания определений [Политики Azure](../../../policy/overview.md) и другими правами, связанными с безопасностью;
