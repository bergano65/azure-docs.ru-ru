---
title: Элементы управления примера схемы для уровня влияния DoD 4
...
В этой схеме содержатся определения политик, помогающие обеспечить правильную работу уведомлений о безопасности данных. Кроме того, эта схема гарантирует, что аудит и расширенная защита данных будут настроены в SQL Server.
...
- \[Предварительная версия.\] Службы Kubernetes должны быть обновлены до версии с устраненными уязвимостями
...
Теперь, когда вы ознакомились с сопоставлением элементов управления схемы для уровня влияния DoD 4, узнайте о схеме и развертывании этого образца из следующих статей:

> [!div class="nextstepaction"]
> [Краткое описание примера схемы для уровня влияния DoD 4](./index.md)
> [Deploy the DoD Impact Level 4 blueprint sample](./deploy.md) (Развертывание примера схемы для уровня влияния DoD 4)
