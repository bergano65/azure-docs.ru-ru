...
description: Сопоставление элементов управления примера схемы для уровня влияния DoD 4. Каждый элемент управления сопоставляется с определениями одной или нескольких Политик Azure, которые помогают выполнять оценку.
ms.date: 10/26/2020
ms.topic: sample
