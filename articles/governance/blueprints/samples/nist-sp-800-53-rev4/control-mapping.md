...
- \[Предварительная версия.\] Аудит внешних учетных записей с разрешениями на чтение для подписки
...
- \[Предварительная версия.\] Мониторинг возможного JIT-доступа к сети в Центре безопасности Azure
...
- \[Предварительная версия.\] Аудит ограничений доступа к ресурсам CORS в веб-приложении
...
- \[Предварительная версия.\] Аудит состояния удаленной отладки в приложении-функции
- \[Предварительная версия.\] Аудит состояния удаленной отладки в веб-приложении
- \[Предварительная версия.\] Аудит состояния удаленной отладки в приложении API
- \[Предварительная версия.\] Аудит виртуальных машин Linux без разрешенного удаленного подключения учетных записей без паролей
- \[Предварительная версия.\] Развертывание расширения ВМ для аудита виртуальных машин Linux без разрешенного удаленного подключения учетных записей без паролей
...
- \[Предварительная версия.\] Мониторинг серверов SQL без аудита в Центре безопасности Azure
...
- \[Предварительная версия.\] Аудит виртуальных машин Linux без учетных записей без паролей
- \[Предварительная версия.\] Развертывание расширения виртуальных машин для аудита виртуальных машин Linux без учетных записей без паролей
- \[Предварительная версия.\] Аудит виртуальных машин Linux с разрешениями 0644 для файла passwd
- \[Предварительная версия.\] Аудит виртуальных машин Windows с хранением паролей с обратимым шифрованием
- \[Предварительная версия.\] Развертывание расширения виртуальных машин для аудита виртуальных машин Linux с разрешениями 0644 для файла passwd
...
- \[Предварительная версия.\] Аудит виртуальных машин Windows без права повторного использования предыдущих 24 паролей
- \[Предварительная версия.\] Аудит виртуальных машин Windows с максимальным сроком действия пароля 70 дней
- \[Предварительная версия.\] Аудит виртуальных машин Windows с минимальным сроком действия пароля 1 день
- \[Предварительная версия.\] Аудит виртуальных машин Windows с параметром сложности пароля
- \[Предварительная версия.\] Аудит виртуальных машин Windows с ограничением минимальной длины пароля до 14 символов
- \[Предварительная версия.\] Аудит виртуальных машин Windows с хранением паролей с обратимым шифрованием
- \[Предварительная версия.\] Развертывание расширения виртуальных машин для аудита виртуальных машин Windows без права повторного использования предыдущих 24 паролей
- \[Предварительная версия.\] Развертывание расширения виртуальных машин для аудита виртуальных машин Windows с максимальным сроком действия пароля 70 дней
- \[Предварительная версия.\] Развертывание расширения виртуальных машин для аудита виртуальных машин Windows с минимальным сроком действия пароля 1 день
- \[Предварительная версия.\] Развертывание расширения виртуальных машин для аудита виртуальных машин Windows с параметром сложности пароля
- \[Предварительная версия.\] Развертывание расширения виртуальных машин для аудита виртуальных машин Windows с ограничением минимальной длины пароля до 14 символов
- \[Предварительная версия.\] Развертывание расширения виртуальных машин для аудита виртуальных машин Windows с хранением паролей с обратимым шифрованием
...
- Аудит серверов SQL без Расширенной защиты данных
- Развертывание Расширенной защиты данных на серверах SQL
- \[Предварительная версия.\] Аудит уязвимостей ОС в масштабируемых наборах виртуальных машин в Центре безопасности Azure
...
- \[Предварительная версия.\] Аудит включения стандартного уровня защиты от DDoS-атак в виртуальной сети
...
- \[Предварительная версия.\] Мониторинг виртуальных машин, доступных в Интернете, для предоставления рекомендаций по повышению безопасности трафика для группы безопасности сети
...
- \[Предварительная версия.\] Мониторинг баз данных SQL без шифрования в Центре безопасности Azure
...
- \[Предварительная версия.\] Аудит отсутствия обновлений системы в масштабируемых наборах виртуальных машин в Центре безопасности Azure
- \[Предварительная версия.\] Аудит уязвимостей ОС в масштабируемых наборах виртуальных машин в Центре безопасности Azure
...
- \[Предварительная версия.\] Аудит решения защиты конечных точек в масштабируемых наборах виртуальных машин в Центре безопасности Azure
...
Теперь, когда вы ознакомились с сопоставлением элементов управления схемы "NIST SP 800-53 R4", узнайте о схеме и развертывании этого образца из следующих статей:

> [!div class="nextstepaction"]
> [NIST SP 800-53 R4 blueprint – Overview](./index.md)
> [NIST SP 800-53 R4 blueprint - Deploy steps](./deploy.md) (Обзор образца схемы NIST SP 800-53 R4 > Развертывание образца схемы NIST SP 800-53 R4)
