...
## <a name="ac-16-security-attributes"></a>AC-16 Атрибуты безопасности
...
> [!NOTE]
> Доступность конкретных определений Политики Azure может отличаться в Azure для государственных организаций и других национальных облаках.
