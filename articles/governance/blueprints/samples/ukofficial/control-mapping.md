...
- Развертывание стандартного расширения IaaS Anti-malware корпорации Майкрософт для Windows Server.

## <a name="9-secure-user-management--10-identity-and-authentication"></a>Безопасное управление пользователями (9 ) / удостоверение и проверка подлинности (10)
