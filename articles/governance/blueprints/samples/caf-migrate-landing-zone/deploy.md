---
title: Пример. Схема зоны размещения для миграции CAF. Шаги по развертыванию
description: Шаги по развертыванию примера схемы зоны размещения для миграции CAF.
author: DCtheGeek
ms.author: dacoulte
ms.date: 08/20/2019
ms.topic: sample
...
Чтобы развернуть пример схемы зоны размещения для миграции CAF Azure Blueprints, необходимо выполнить следующие действия.
...
1. В разделе _Другие примеры_ найдите пример схемы **зоны размещения для миграции CAF**, а затем выберите **Использовать этот пример**.
...
> [Общие сведения об использовании Microsoft Cloud Adoption Framework с примером схемы зоны размещения для миграции в соответствии с CAF](./index.md)
