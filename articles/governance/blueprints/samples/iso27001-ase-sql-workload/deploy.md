...
1. Введите _основные данные_ образца схемы.
   ...
   - **Расположение определения**. Используйте кнопку с многоточием и выберите группу управления, в которой вы решили сохранить копию примера.
