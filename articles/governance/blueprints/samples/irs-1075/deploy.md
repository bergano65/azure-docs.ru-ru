...
ms.locfileid: "74546802"
---
# <a name="deploy-the-irs-1075-blueprint-sample"></a>Развертывание примера схемы IRS 1075

Чтобы развернуть пример схемы IRS 1075 (ред. от 11.2016) Azure Blueprints, необходимо выполнить следующие действия:
...
1. Найдите пример схемы **IRS 1075 (Rev.11-2016)** (IRS 1075 (ред. от 11.2016)) в разделе _Другие примеры_ и выберите **Использовать этот пример**.

1. Введите _основные данные_ образца схемы.

   - **Имя схемы**. Укажите имя для копии примера схемы IRS 1075 (ред. от 11.2016).
...
|Развертывание агента Log Analytics для Масштабируемых наборов виртуальных машин Linux (VMSS)|Назначение политики|Рабочая область Log Analytics для Масштабируемых наборов виртуальных машин Linux (VMSS)|Если эта рабочая область находится за пределами области назначения, необходимо вручную предоставить разрешения участника Log Analytics (или аналогичные) для идентификатора участника назначения политики.|
|Развертывание агента Log Analytics для Масштабируемых наборов виртуальных машин Linux (VMSS)|Назначение политики|Необязательно: список образов виртуальных машин с поддерживаемой версией ОС Linux для добавления в область|Пустой массив может использоваться для указания отсутствия необязательных параметров: \[\]|
|Развертывание агента Log Analytics для виртуальных машин Linux|Назначение политики|Рабочая область Log Analytics для виртуальных машин Linux|Если эта рабочая область находится за пределами области назначения, необходимо вручную предоставить разрешения участника Log Analytics (или аналогичные) для идентификатора участника назначения политики.|
|Развертывание агента Log Analytics для виртуальных машин Linux|Назначение политики|Необязательно: список образов виртуальных машин с поддерживаемой версией ОС Linux для добавления в область|Пустой массив может использоваться для указания отсутствия необязательных параметров: \[\]|
|Развертывание агента Log Analytics для Масштабируемых наборов виртуальных машин Windows (VMSS)|Назначение политики|Рабочая область Log Analytics для Масштабируемых наборов виртуальных машин Windows (VMSS)|Если эта рабочая область находится за пределами области назначения, необходимо вручную предоставить разрешения участника Log Analytics (или аналогичные) для идентификатора участника назначения политики.|
|Развертывание агента Log Analytics для Масштабируемых наборов виртуальных машин Windows (VMSS)|Назначение политики|Необязательно: список образов виртуальных машин с поддерживаемой версией ОС Windows для добавления в область|Пустой массив может использоваться для указания отсутствия необязательных параметров: \[\]|
|Развертывание агента Log Analytics для виртуальных машин Windows|Назначение политики|Рабочая область Log Analytics для виртуальных машин Windows|Если эта рабочая область находится за пределами области назначения, необходимо вручную предоставить разрешения участника Log Analytics (или аналогичные) для идентификатора участника назначения политики.|
|Развертывание агента Log Analytics для виртуальных машин Windows|Назначение политики|Необязательно: список образов виртуальных машин с поддерживаемой версией ОС Windows для добавления в область|Пустой массив может использоваться для указания отсутствия необязательных параметров: \[\]|
...
Теперь, когда вы ознакомились с процедурой развертывания примера схемы IRS 1075 (ред. от 11.2016), узнайте о схеме и сопоставлении элементов управления по следующим ссылкам:

> [!div class="nextstepaction"]
> [Общие сведения о схеме IRS 1075](./index.md)
> [Сопоставление элементов управления для примера схемы IRS 1075](./control-mapping.md)
