---
title: Элементы управления примера схемы ISO 27001
description: Сопоставление элементов управления на примере схемы ISO 27001 Каждый элемент управления сопоставляется с определениями одной или нескольких Политик Azure, которые помогают выполнять оценку.
ms.date: 07/13/2020
ms.topic: sample
