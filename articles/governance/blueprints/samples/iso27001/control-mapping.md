---
title: Пример схемы ISO 27001. Сопоставление элементов управления
description: Сопоставление элементов управления на примере схемы ISO 27001 Каждый элемент управления сопоставляется с одной или несколькими политиками Azure, которые помогают выполнять оценку.
author: DCtheGeek
ms.author: dacoulte
ms.date: 07/22/2019
ms.topic: sample
...
В следующей статье подробно описано, как с помощью примера схемы Azure Blueprints ISO 27001 выполнять сопоставление с элементами управления ISO 27001. См. подробнее об [элементах управления ISO 27001](https://www.iso.org/isoiec-27001-information-security.html).
...
Теперь, когда вы ознакомились с сопоставлением элементов управления с помощью схемы ISO 27001, см. об архитектуре и развертывании этого примера:

> [!div class="nextstepaction"]
> [Схема ISO 27001.Общие сведения](./index.md)
