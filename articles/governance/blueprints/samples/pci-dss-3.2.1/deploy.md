...
|Допустимые расположения|Назначение политики|Список допустимых расположений|Список расположений центров обработки данных, разрешенных для развертывания любого ресурса в. Этот список можно настроить глобально для нужных расположений Azure. Выберите расположения, которые вы хотите разрешить.| 
