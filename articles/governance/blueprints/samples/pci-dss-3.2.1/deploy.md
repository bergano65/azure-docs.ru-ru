...
|-|-|-|-|
|PCI v3.2.1:2018|Назначение политики|Список типов ресурсов | Аудит параметров диагностики для выбранных типов ресурсов. По умолчанию выбраны все ресурсы.| 
