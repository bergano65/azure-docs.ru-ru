...
|Развертывание аудита на серверах SQL Server|Назначение политики|Дни хранения|Срок хранения данных в днях. Значение по умолчанию — 180, но для PCI требуется 365.| 
