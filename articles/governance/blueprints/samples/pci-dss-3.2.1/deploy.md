...
|-|-|-|-|
|\[Preview @ no__t-1 Audit PCI v 3.2.1:2018 управляет и развертывает определенные расширения виртуальной машины для поддержки требований аудита.|Назначение политики|Список типов ресурсов | Аудит параметров диагностики для выбранных типов ресурсов. Значение по умолчанию — все ресурсы выбраны| 
...
> [PCI-DSS v: сопоставление элементов управления](./control-mapping.md)
