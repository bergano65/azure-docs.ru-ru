...
1. Укажите значения параметра для назначения схемы.
   ...
   - Параметры артефакта
     ...
     |-|-|-|-|-|
     |Группа ресурсов ProdRG|Resource group|ИМЯ|ProductionRG|Определяет имя первой группы ресурсов.|
     |Группа ресурсов ProdRG|Resource group|Location|Западный регион США 2|Задает расположение первой группы ресурсов.|
     ...
     |Группа ресурсов PreProdRG|Resource group|ИМЯ|PreProductionRG|Определяет имя второй группы ресурсов.|
     |Группа ресурсов PreProdRG|Resource group|Location|Запад США|Задает расположение второй группы ресурсов.|
