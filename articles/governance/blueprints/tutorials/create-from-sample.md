...
1. Укажите значения параметра для назначения схемы.
   ...
   - Параметры артефакта
     ...
     |Группа ресурсов ProdRG|группа ресурсов.|Location|Западный регион США 2|Задает расположение первой группы ресурсов.|
     ...
     |Группа ресурсов PreProdRG|группа ресурсов.|Location|Запад США|Задает расположение второй группы ресурсов.|
