...
1. Добавьте шаблон в группу ресурсов:
   ...
   1. На вкладке **Шаблон** вставьте приведенный ниже шаблон Resource Manager в поле редактора.
      Вставив шаблон, щелкните **Добавить**, чтобы добавить этот артефакт к схеме.
