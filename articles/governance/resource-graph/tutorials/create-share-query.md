...
В отличие от закрытого, общий запрос является ресурсом Resource Manager. Это означает, что запрос сохраняется в группу ресурсов, им можно управлять с помощью Azure RBAC, и его можно защитить с помощью блокировок ресурсов. Как и любой другой ресурс, он доступен для просмотра и использования любому пользователю, который имеет соответствующие разрешения.
