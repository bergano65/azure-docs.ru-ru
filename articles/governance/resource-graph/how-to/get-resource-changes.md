...
В этой статье показано, как собирать эти сведения через пакет SDK для Resource Graph. Чтобы просмотреть эти сведения на портале Azure, воспользуйтесь [журналом изменений Политики Azure](../../policy/how-to/determine-non-compliance.md#change-history-preview) или [журналом изменений для журнала действий Azure](../../../azure-monitor/platform/activity-log-view.md#azure-portal).
Дополнительные сведения об изменениях в приложениях на уровне инфраструктуры вплоть до развертывания см. в статье [Использование анализа изменений в приложениях (предварительная версия) в Azure Monitor](../../../azure-monitor/app/change-analysis.md).
