---
title: Поддерживаемые типы ресурсов Resource Manager
description: Список типов ресурсов Resource Manager, поддерживаемых в Azure Resource Graph и журнале изменений.
ms.date: 05/21/2020
ms.topic: reference
