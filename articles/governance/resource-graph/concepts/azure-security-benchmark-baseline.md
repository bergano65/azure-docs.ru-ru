...
**Руководство**. граф ресурсов Azure предоставляет доступ к типам ресурсов и свойствам на основе управления доступом на основе РОЛЕЙ (RBAC). Регулярно проверяйте и просматривайте доступ, предоставленный субъектам безопасности (пользователям, группам и учетным записям служб), чтобы убедиться, что запросы возвращают результаты для соответствующих ресурсов.
