 ...
 **куериреспонсе** предоставляет значения, указывающие на то, что набор результатов был разбит: **ресулттрункатед** и **$skipToken**. **ресулттрункатед** — это логическое значение, которое информирует потребителя о наличии большего числа записей, не возвращаемых в ответе. Это условие также можно определить, когда свойство **count** меньше, чем свойство **totalRecords**. **totalRecords** определяет, сколько записей соответствует запросу.
