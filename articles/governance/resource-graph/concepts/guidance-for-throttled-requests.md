...
Хотя мы рекомендуем чаще применять группирование, чем распараллеливание, в некоторых случаях группирование выполнить сложно. В таких случаях вы можете отправлять несколько запросов к Azure Resource Graph параллельно. Ниже приведен пример _откладывания_ запросов с учетом заголовков регулирования для такого сценария:
