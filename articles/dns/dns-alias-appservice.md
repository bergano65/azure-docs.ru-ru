...
Инструкции для размещения вашего домена в Azure DNS см. в разделе [руководства: размещению домена в Azure DNS](dns-delegate-domain-azure-dns.md).
