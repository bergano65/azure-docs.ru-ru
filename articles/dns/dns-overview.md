...
* [Управление доступом Azure на основе ролей (Azure RBAC).](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-overview) Позволяет управлять доступом к определенным действиям для организации.
