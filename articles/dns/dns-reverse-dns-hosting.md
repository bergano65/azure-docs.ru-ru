...
Эта статья поможет вам создать свою первую зону обратного просмотра и обратную запись DNS с помощью Azure CLI, портала Azure, Azure PowerShell или классического Azure CLI.
