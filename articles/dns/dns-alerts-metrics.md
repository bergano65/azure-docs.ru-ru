...
Вы также можете просмотреть [определения этих метрик](../azure-monitor/essentials/metrics-supported.md#microsoftnetworkdnszones) на странице документации Azure Monitor.
>[!NOTE]
...
![Снимок экрана, вховс пример просмотра метрик.](./media/dns-alerts-metrics/dns-metrics-record-set-capacity-uitlization.png)
