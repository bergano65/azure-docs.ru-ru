...
description: В этой статье узнайте о часто задаваемых вопросах о Azure DNS
services: dns
author: rohinkoul
ms.service: dns
ms.topic: article
...
- [Узнайте больше о Azure DNS](dns-overview.md).

- [Использование Azure DNS для частных доменов](private-dns-overview.md).

- [Узнайте больше о зонах и записях DNS.](dns-zones-records.md)
