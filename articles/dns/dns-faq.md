...
Нет. Частные зоны работают вместе с виртуальными сетями. Клиенты используют их для управления доменами виртуальных машин или других ресурсов внутри и между виртуальными сетями. Для разрешения имен не нужно подключение к Интернету. 
...
Нет. В данный момент записи DNS виртуальных машин, которые автоматически регистрируются в частной зоне, недоступны клиентам для просмотра и редактирования. Однако вы можете перезаписать их записями DNS, созданными в зоне вручную. Чтобы узнать об этом больше, ознакомьтесь со следующими вопросом и ответом.
...
* Виртуальная сеть не может иметь все виртуальные машины с сетевым адаптером, связанным с частной зоной в качестве виртуальной сети регистрации или разрешения. Другими словами, виртуальная сеть должна быть пуста. Виртуальная сеть не обязательно должна быть пустой при последующем связывании с другими частными зонами в качестве виртуальной сети регистрации или разрешения. 
