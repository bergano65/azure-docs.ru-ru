...
> [!NOTE]
> Рекомендуется не использовать домен .local для частной зоны DNS. Не все операционные системы поддерживают такую возможность.
