...
* Обратный DNS для частного IP для связанной виртуальной сети возвращает "internal.cloudapp.net" в качестве суффикса по умолчанию для виртуальной машины. Для виртуальных сетей, связанных с частной зоной с включенной автоматической регистрацией, обратный DNS для частного IP-адреса возвращает два полных доменных имени: одно с суффиксом *internal.cloudapp.net* по умолчанию, а другое с суффиксом частной зоны.
* Условная пересылка в настоящее время не поддерживается. См. о включении разрешения имен между Azure и локальными сетями в руководстве по [разрешению имен для виртуальных машин и экземплярами ролей](../virtual-network/virtual-networks-name-resolution-for-vms-and-role-instances.md).
