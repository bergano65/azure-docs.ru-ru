---
title: Общие сведения о обратных DNS в Azure — Azure DNS
description: В этом учебном материале вы узнаете, как работает обратная DNS и как ее можно использовать в Azure.
services: dns
