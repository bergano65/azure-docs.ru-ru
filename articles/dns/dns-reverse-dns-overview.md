---
title: Обзор обратного DNS в Azure - Azure DNS
description: На этом пути обучения начинайте изучать, как работает обратный DNS и как его можно использовать в Azure
services: dns
...
Например, DNS-запись www.contoso.com получена на основе DNS-записи А с именем www в зоне contoso.com.  Эта запись А указывает на соответствующий IP-адрес. В этом случае — 64.4.6.100.  Обратный поиск осуществляется отдельно, используя запись 'PTR' под названием '100' в зоне '6.4.64.in-addr.arpa' (обратите внимание, что IP-адреса меняются в зонах ARPA).  Эта запись PTR, если она была настроена правильно, указывает на имя "www.contoso.com".
