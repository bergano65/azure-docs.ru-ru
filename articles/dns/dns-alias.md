...
Например, если статический веб-сайт называется `www.contoso.com` , пользователи могут получить доступ к сайту с помощью `contoso.com` без необходимости добавлять имя DNS в начало веб-сайта.
