...
![Снимок экрана, на котором выделяется кнопка + добавить имя узла.](./media/dns-custom-domain/figure1.png)
...
![Снимок экрана, на котором показана страница "личный домен".](./media/dns-custom-domain/indirectvalidate.png)
