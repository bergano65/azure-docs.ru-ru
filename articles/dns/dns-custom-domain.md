...
Перейдите назад к учетной записи хранилища, нажав**на учетные записи** **хранения,** > выберите учетную запись хранения и нажмите **пользовательский домен.** Введите псевдоним, созданный без приставки asverify в текстовом поле, проверьте **непрямую проверку CNAME**и нажмите **Сохранить.** После завершения этого шага вернитесь в зону DNS и создайте запись CNAME без префикса asverify.  После этого можно безопасно удалить запись CNAME с префиксом cdnverify.
