...
Перейдите в раздел**учетные записи**хранения **хранилища** > , выберите свою учетную запись хранения и щелкните **личный домен**. Запишите полное доменное имя из шага 2. Это значение используется для создания первой записи CNAME.
