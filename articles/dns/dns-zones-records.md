...
* **Флаги**: Это должно быть целым числом от 0 до 255, которое представляет критический флаг с особым значением для каждого [RFC](https://tools.ietf.org/html/rfc6844#section-3)
