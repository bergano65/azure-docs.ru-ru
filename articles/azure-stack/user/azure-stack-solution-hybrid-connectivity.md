...
1. В браузере перейдите на [портал Azure](http://portal.azure.com/)  и войдите, используя учетную запись Azure.
...
4. На странице **Создание шлюза виртуальной сети** укажите для шлюза сети значения, которые предложены в **примере значений для руководства** и следующие дополнительные значения:
    ...
    - **Первая IP-конфигурация**.  Это общедоступный IP-адрес вашего шлюза.
        ...
        - Выберите **+ Создать новый** , чтобы открыть страницу **Создание общедоступного IP-адреса**.
        - Введите  **Имя**  общедоступного IP-адреса. Примените для номера SKU значение  **Базовый**, а затем нажмите кнопку  **ОК**, чтобы сохранить изменения.
