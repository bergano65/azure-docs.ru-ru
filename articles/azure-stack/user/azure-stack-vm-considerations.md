...
| Хранилище для виртуальных машин | Поддерживаются [управляемые диски.](../../virtual-machines/windows/managed-disks-overview.md) | Управляемые диски поддерживаются в Azure Stack версии 1808 и выше. |
| Производительность дисков виртуальной машины | Зависит от типа и размера диска. | Зависит от размера виртуальной машины, к которой подключены диски, см. статью [Размеры виртуальной машины, поддерживаемые в Azure Stack](azure-stack-vm-sizes.md).
