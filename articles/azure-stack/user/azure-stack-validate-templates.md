...
- [Использование шаблонов диспетчера ресурсов Azure в Azure Stack](azure-stack-arm-templates.md)
- [Рекомендации по использованию шаблона Azure Resource Manager](azure-stack-develop-templates.md)
