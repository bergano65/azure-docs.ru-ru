...
3. При необходимости создайте подписку и сохраните ее идентификатор для дальнейшего использования. Сведения о создании подписки см. в статье [Создание подписок для предложений в Azure Stack](../azure-stack-subscribe-plan-provision-vm.md).
...
6. Создайте [субъект-службу](../azure-stack-create-service-principals.md) для работы с Azure Stack. Убедитесь, что субъект-служба имеет [роль участника или владельца](../azure-stack-create-service-principals.md#assign-a-role) в вашей подписке.
