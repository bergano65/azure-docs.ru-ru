...
1.  На портале выберите **Все службы** > **Виртуальные машины**.    
...
3.  Для виртуальной машины последовательно выберите **Диски** > **Add data disk** (Добавить диск с данными).       
...
5.  В колонке создания управляемого диска:
    -  Введите **имя** диска.
    ...
    -  Выберите **тип источника**.
        ...
        **Моментальный снимок**  
        Выберите моментальный снимок, если он доступен. Моментальный снимок должен быть доступен в подписке и расположении виртуальной машины.
...
5.  После того как Azure Stack создаст диск и подключит его к виртуальной машине, он появится в параметрах дисков виртуальной машины в разделе **Диски данных**.   
...
Дополнительные сведения о работе с учетными записями хранения в Azure Stack см. в статье [Общие сведения о хранилище Azure Stack](azure-stack-storage-overview.md).
