---
title: Настройка VPN-подключений Azure Stack типа "сеть — сеть" | Документация Майкрософт
description: Сведения о политике IPsec/IKE для подключений VPN типа "сеть — сеть" или "виртуальная сеть — виртуальная сеть" в Azure Stack
...
См. дополнительные сведения о  [создании виртуальной сети с VPN-подключением типа "сеть — сеть"](../../vpn-gateway/vpn-gateway-create-site-to-site-rm-powershell.md).
...
- Командлеты PowerShell для Azure Resource Manager. См. дополнительные сведения об  [установке командлетов PowerShell](../azure-stack-powershell-install.md) .
...
Создайте подключение VPN типа "сеть — сеть" и примените политику IPsec/IKE, созданную на предыдущем шаге.
