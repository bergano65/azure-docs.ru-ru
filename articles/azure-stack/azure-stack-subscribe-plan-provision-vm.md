...
1. На пользовательском портале выберите **Все службы**. После этого в категории **ОБЩИЕ** выберите **Подписки**, а затем выберите подписку, которую необходимо изменить. Если есть доступные планы надстройки, будет активно действие **+ Добавить план** и появится дополнительная плитка **Планы надстройки**.
