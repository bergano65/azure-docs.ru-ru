...
1. [Войдите](azure-stack-connect-azure-stack.md) на [портал пользователя Azure Stack](https://portal.local.azurestack.external) и выберите **Получить подписку**.
