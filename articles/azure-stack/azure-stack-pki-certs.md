...
- Для шифрования PFX нужно использовать 3DES (это вариант по умолчанию при экспорте из клиента Windows 10 или хранилища сертификатов Windows Server 2016).
...
- Пароль для PFX-файла сертификата должен быть сложным. Создайте пароль, отвечающий следующим требованиям сложности пароля. Минимальная длина — 8 знаков. Пароль содержит по крайней мере три знака из перечисленных групп: прописные буквы, строчные буквы, цифры от 0 до 9, специальные символы, алфавитный символ, не являющийся прописным или строчным. Запишите этот пароль. Вы будете использовать его в качестве параметра развертывания.
