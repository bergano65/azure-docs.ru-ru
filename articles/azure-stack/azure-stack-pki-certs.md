...
- Невозможно использовать алгоритм подписи SHA1, так как требуется более строгий алгоритм. 
...
- Пароль для PFX-файла сертификата должен быть сложным.
