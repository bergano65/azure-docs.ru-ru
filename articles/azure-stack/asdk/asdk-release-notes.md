...
<!--3463840 - IS, ASDK --> 
- Устранена проблема со сбоем резервного копирования инфраструктуры из-за недоступности файлового сервера из открытой сети VPN. Это исправление переносит службу резервного копирования инфраструктуры обратно в общедоступную сеть инфраструктуры. Если вы применили последнее [исправление Azure Stack для версии 1809](#azure-stack-hotfixes), которое устраняет эту проблему, обновление 1811 не будет вносить никаких дальнейших изменений. 
