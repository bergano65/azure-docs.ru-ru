...
- Улучшения надежности увеличения объема во время операции добавления узла при переключении состояния единицы масштабирования с "Расширение хранилища" на "Выполняется".
