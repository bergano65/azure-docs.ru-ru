...
> [!Important]  
> Подготовьтесь к развертыванию Azure Stack для хост-процесса для расширений. Подготовьте систему, следуя инструкциям из статьи [Подготовка хост-процесса для расширений для Azure Stack](azure-stack-extension-host-prepare.md).
...
- [KB 4468920 — исправление для Azure Stack версии Azure Stack 1.1808.7.113](https://support.microsoft.com/help/4471992/)
...
- Возможно многократное отображение и исчезновение следующих оповещений в системе Azure Stack:
  ...
  Эта проблема исправлена в последнем [выпуске исправления 1808](https://support.microsoft.com/help/4471992/), поэтому не забудьте установить это исправление, если у вас возникли проблемы.
