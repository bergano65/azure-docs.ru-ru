...
> [!Note]  
> В версии 1809 служба резервного копирования обменивается данными с внешним файловым сервером из общедоступной сети виртуальных IP-адресов. До версии 1809 служба обменивалась данными через общедоступную сеть инфраструктуры. Если в вашей среде запрещен доступ к ресурсам инфраструктуры из открытой сети виртуальных IP-адресов, примените последнее [исправление 1809](azure-stack-update-1809.md#post-update-steps) для Azure Stack. Это исправление настроит службу резервного копирования инфраструктуры для использования общедоступной сети инфраструктуры. Если применить исправление 1809 в версии 1811, служба резервного копирования инфраструктуры будет использовать общедоступную сеть инфраструктуры. Если применить исправление 1809 в версии 1811, служба резервного копирования инфраструктуры будет использовать общедоступную сеть инфраструктуры.
