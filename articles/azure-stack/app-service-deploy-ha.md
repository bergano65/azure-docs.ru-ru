...
> [!TIP]
> Не все шаги, описанные в статье по подготовке, являются обязательными, потому что при развертывании шаблона виртуальные машины инфраструктуры настраиваются с учетом ваших требований. 
