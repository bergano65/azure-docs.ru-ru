...
2. Войдите в Azure Stack как оператор. В меню выберите **Все службы**. Затем в категории **Администрирование** выберите **Вычисления** > **Образы виртуальных машин** > **Добавить**.
