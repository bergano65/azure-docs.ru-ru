...
1. [Войдите](azure-stack-connect-azure-stack.md) на портал с правами администратора облака и последовательно выберите **+ Create a resource** (+ Создать ресурс)  > **Предложения и планы** > **Предложение**.
