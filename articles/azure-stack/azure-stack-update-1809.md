...
- Установите последнее исправление для Azure Stack версии 1808 перед применением версии 1809. Дополнительные сведения см. в статье базы знаний 4468920 [Azure Stack Hotfix 1.1808.5.110](https://support.microsoft.com/en-us/help/4468920) (Исправление для Azure Stack версии 1.1808.5.110).
