...
- [База знаний: 4471993. Исправление для Azure Stack версии Azure Stack 1.1809.3.96](https://support.microsoft.com/help/4471993/)  
...
- Возможно многократное отображение и исчезновение следующих оповещений в системе Azure Stack:
  ...
  Эта проблема исправлена в последнем [выпуске исправления 1809](https://support.microsoft.com/help/4471993/), поэтому не забудьте установить это исправление, если у вас возникли проблемы. 
