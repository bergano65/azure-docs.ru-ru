...
Как упоминалось ранее, корпорация Майкрософт поддерживает удаление данных по запросу клиента. Клиенты в любой момент могут потребовать от нашего сотрудника службы поддержки удалить все свои журналы для заданного обращения, прежде чем данные будут безвозвратно удалены.  
...
[Служба выставления счетов Azure Stack](azure-stack-usage-reporting.md) использует глобальный конвейер выставления счетов Azure, поэтому она следует рекомендациям Майкрософт по соблюдению соответствия требованиям.
