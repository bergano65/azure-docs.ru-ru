...
* Два сервера и другое требуемое оборудование для Пакета средств разработки Azure Stack, как описано в статье[ Как скачать Пакет средств разработки Azure Stack (ASDK)](azure-stack-deploy-overview.md). 
