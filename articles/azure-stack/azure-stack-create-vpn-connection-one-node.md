...
* Два сервера и другое требуемое оборудование для ASDK, как описано в статье [ Как скачать Пакет средств разработки Azure Stack (ASDK)](azure-stack-deploy-overview.md).
...
> [!NOTE]
> Выполните [инструкции по развертыванию](azure-stack-run-powershell-script.md) для каждой среды ASDK. В этой статье среды ASDK называются **POC1** и **POC2**.
