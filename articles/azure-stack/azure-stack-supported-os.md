...
> [!NOTE]
> Пользовательские образы должны содержать последнюю общедоступную версию WALA или версию 2.2.20. Версии, предшествующие 2.2.20, и версии с 2.2.20 по 2.2.35.1 (не включительно) могут неправильно работать в Azure Stack. 
>
