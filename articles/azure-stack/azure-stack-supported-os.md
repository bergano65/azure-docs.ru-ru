...
> [!NOTE]
> Пользовательские образы должны содержать последнюю общедоступную версию WALA или версию 2.2.20. Версии ниже 2.2.20 и от 2.2.20 до 2.2.35 (не включая) могут неправильно работать в Azure Stack. 
>
