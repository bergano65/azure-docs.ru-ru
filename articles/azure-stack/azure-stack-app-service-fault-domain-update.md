---
title: 'Служба приложений в Azure Stack: обновление домена сбоя | Документация Майкрософт'
...
2. В категории **Вычислительные ресурсы** выберите **Масштабируемые наборы виртуальных машин**. Здесь указаны все существующие масштабируемые наборы, развернутые одновременно со службой приложений, а также число экземпляров в них. На следующем снимке экрана показан пример масштабируемых наборов.
