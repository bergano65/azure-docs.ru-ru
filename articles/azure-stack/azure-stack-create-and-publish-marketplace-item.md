...
1. [Скачайте](https://www.aka.ms/azurestackmarketplaceitem) средство упаковщика коллекции Azure и пример элемента Azure Stack Marketplace.
