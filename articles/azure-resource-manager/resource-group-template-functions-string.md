...
| Параметр | Обязательно для заполнения | type | ОПИСАНИЕ |
|:--- |:--- |:--- |:--- |
| itemToTest |Yes |массив, объект или строка |Значение для проверки, если он пуст. |
...
| arg1 | Yes | Строка, целое число или логическое значение | Значение, добавляемое в форматируемую строку. |
...
| numberToSkip |Yes |int |Число элементов или знаков, которые необходимо пропустить. Если это значение меньше или равно 0, то возвращаются все элементы или знаки в значении. Если это больше, чем длина массива или строки, возвращается пустой массив или строка. |
...
| numberToTake |Yes |int |Число элементов или знаков, которые необходимо взять. Если это значение меньше или равно 0, то возвращается пустой массив или строка. Если его размер превышает длину заданного массива или строки, возвращаются все элементы в массиве или строке. |
