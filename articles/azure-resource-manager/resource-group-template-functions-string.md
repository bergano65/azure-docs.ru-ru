...
| objectTrue | Логический | Да |
| objectFalse | Логический | False |
| arrayTrue | Логический | Да |
...
| Название | Тип | Значение |
| ---- | ---- | ----- |
| arrayEmpty | Логический | Да |
| objectEmpty | Логический | Да |
| stringEmpty | Логический | Да |
...
| Название | Тип | Значение |
| ---- | ---- | ----- |
| startsTrue | Логический | Да |
| startsCapTrue | Логический | Да |
| startsFalse | Логический | False |
| endsTrue | Логический | Да |
| endsCapTrue | Логический | Да |
...
| Название | Тип | Значение |
| ---- | ---- | ----- |
| formatTest | Строка | Привет, пользователь. Форматированного числа: 8,175,133 |
...
| numberToSkip |Да |ssNoversion |Число элементов или знаков, которые необходимо пропустить. Если это значение меньше или равно 0, то возвращаются все элементы или знаки в значении. Если это больше, чем длина массива или строки, возвращается пустой массив или строка. |
...
| Параметр | Обязательно | Тип | Описание |
|:--- |:--- |:--- |:--- |
| valueToConvert |Да | Любые |Значение, которое необходимо преобразовать в строку. Можно преобразовать любой тип значения, включая объекты и массивы. |
...
| длина |Нет |ssNoversion |Число символов в подстроке. Этот параметр должен ссылаться на позицию в строке. Значение этого параметра должно быть равным нулю или больше него. |
...
| numberToTake |Да |ssNoversion |Число элементов или знаков, которые необходимо взять. Если это значение меньше или равно 0, то возвращается пустой массив или строка. Если его размер превышает длину заданного массива или строки, возвращаются все элементы в массиве или строке. |
