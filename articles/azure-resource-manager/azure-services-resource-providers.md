...
description: Представлены все пространства имен поставщика ресурсов для Azure Resource Manager и служба Azure для этого пространства имен.
author: tfitzmac
...
В этой статье представлены пространства имен поставщика ресурсов для служб Azure.

## <a name="match-resource-provider-to-service"></a>Поставщик ресурсов соответствия для службы
...
| Microsoft.ApiManagement | [Служба управления API](../api-management/index.yml) |
| Microsoft.AppConfiguration | core |
| Microsoft.Authorization | [Azure Resource Manager](index.yml) |
| Microsoft.Automation | [Автоматизация](../automation/index.yml) |
...
| Microsoft.Blockchain | [Служба Azure Blockchain](/azure/blockchain/workbench/) |
| Microsoft.Blueprint | [Azure чертежей](/azure/governance/blueprints/) |
...
| Microsoft.ClassicCompute | Классической модели развертывания модели виртуальной машины |
| Microsoft.ClassicInfrastructureMigrate | Миграция классической модели развертывания моделей |
| Microsoft.ClassicNetwork | Виртуальной сети в классической модели развертывания модели |
| Microsoft.ClassicStorage | Модель хранения классической модели развертывания |
| Microsoft.ClassicSubscription | Классическая модель развертывания |
...
| Microsoft.CustomerLockbox | Защищенное хранилище клиента для Microsoft Azure |
...
| Microsoft.DeploymentManager | [Менеджер по развертыванию Azure](deployment-manager-overview.md) |
| Microsoft.Devices | [Центр Интернета вещей](/azure/iot-hub/) |
| Microsoft.DevSpaces | [Пробелы разработки Azure](/azure/dev-spaces/) |
| Microsoft.DevTestLab | [Службы лабораторий Azure](../lab-services/index.yml) |
| Microsoft.DocumentDB | [Azure Cosmos DB](../cosmos-db/index.yml) |
| Microsoft.DomainRegistration | [Службы приложений](/azure/app-service/) |
| Microsoft.EnterpriseKnowledgeGraph | Графа знаний организации |
...
| Microsoft.HealthcareApis | [API Azure на FHIR](../healthcare-apis/index.yml) |
| Microsoft.ImportExport | [Импорта и экспорта Azure](../storage/common/storage-import-export-service.md) |
| microsoft.insights | [Azure Monitor](../azure-monitor/index.yml) |
| Microsoft.Intune | [Intune](/intune/) |
| Microsoft.IoTCentral | [IoT Central](/azure/iot-central/) |
| Microsoft.IoTSpaces | [Azure цифровой Двойников](../digital-twins/index.yml) |
...
| Microsoft.MachineLearningCompute | [Служба машинного обучения](../machine-learning/service/index.yml) |
| Microsoft.MachineLearningModelManagement | [Служба машинного обучения](../machine-learning/service/index.yml) |
| Microsoft.MachineLearningServices | [Служба машинного обучения](../machine-learning/service/index.yml) |
...
| Microsoft.ManagedLab | [Службы лабораторий Azure](../lab-services/index.yml) |
...
| Microsoft.MixedReality | [Пространственные привязки Azure.](/azure/spatial-anchors/) |
...
| Microsoft.Relay | [Ретранслятор Azure](../service-bus-relay/relay-what-is-it.md) |
...
| Microsoft.WindowsIoT | [Службы Windows 10 IoT базовая](https://docs.microsoft.com/windows-hardware/manufacture/iot/iotcoreservicesoverview) |
| Microsoft.WorkloadMonitor | [Azure Monitor](../azure-monitor/index.yml) |

## <a name="next-steps"></a>Дальнейшие действия

Дополнительные сведения о поставщиках ресурсов см. в разделе [поставщики и типы ресурсов Azure](resource-manager-supported-services.md)
