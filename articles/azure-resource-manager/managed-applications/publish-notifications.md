...
PUT | Успешно | Полная подготовка управляемого приложения прошла удачно после размещения.
PUT | Failed | Сбой помещения подготовки экземпляра приложения в любой момент.
