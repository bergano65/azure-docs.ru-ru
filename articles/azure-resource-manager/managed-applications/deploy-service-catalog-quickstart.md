...
1. Укажите значения для вкладки " **основы** ". Выберите подписку Azure для развертывания приложения каталога услуг. Создайте новую группу ресурсов с именем **applicationGroup**. Выберите расположение для вашего приложения. По завершении выберите **ОК**.
