...
Кроме того, требуется учетная запись Marketplace. См. статью о том, [как создать коммерческую учетную запись Marketplace в Центре партнеров](../../marketplace/partner-center-portal/create-account.md).
