...
* При использовании полного режима Resource Manager **удаляет** ресурсы, которые существуют в группе ресурсов, но не указаны в шаблоне. Но ресурсы, которые указываются, но не развертываются из-за невыполнения условий, не удаляются.
