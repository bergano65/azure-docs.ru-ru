---
title: Безопасное развертывание в разных регионах - Менеджер развертывания Azure
...
ms.locfileid: "76152533"
---
# <a name="enable-safe-deployment-practices-with-azure-deployment-manager-public-preview"></a>Включить безопасные методы развертывания с менеджером развертывания Azure (публичный предварительный просмотр)
...
Менеджер развертывания Azure находится в предварительном просмотре. Помогите нам улучшить функцию, предоставляя [обратную связь](https://aka.ms/admfeedback).
...
- [Учебник: Используйте менеджер развертывания Azure с шаблонами «Менеджер ресурсов».](./deployment-manager-tutorial.md)
- [Учебник: Используйте проверку работоспособности в Azure Менеджер развертывания](./deployment-manager-tutorial-health-check.md).
...
Идентификация должна находиться в том же месте, что и развертывание.
...
Вы можете определить шаг, выполняемый до или после операции развертывания. В настоящее `wait` время доступны только шаг и шаг 'healthCheck'.
...
Для получения дополнительной информации о этапе проверки работоспособности см. [Ввести развертывание интеграции работоспособности в azure Deployment Manager](./deployment-manager-health-check.md) и [Tutorial: Используйте проверку работоспособности в Azure Deployment Manager.](./deployment-manager-tutorial-health-check.md)
...
>
> [Быстрый запуск: Попробуйте менеджер развертывания Azure всего за несколько минут](https://github.com/Azure-Samples/adm-quickstart)
