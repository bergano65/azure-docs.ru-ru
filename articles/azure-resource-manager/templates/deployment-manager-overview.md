...
Вы можете определить шаг, выполняемый до или после операции развертывания. В настоящее время `wait` доступны только шаг и шаг "healthCheck".
