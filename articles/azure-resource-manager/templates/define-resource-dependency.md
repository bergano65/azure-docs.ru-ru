...
В шаблоне элемент dependsOn позволяет определить один ресурс как зависимый от одного или нескольких ресурсов. Его значение представляет собой список имен ресурсов, разделенных запятой. Список может включать ресурсы, которые [условно развернуты.](conditional-resource-deployment.md) Когда условный ресурс не развернут, менеджер ресурсов Azure автоматически удаляет его из требуемых зависимостей.
