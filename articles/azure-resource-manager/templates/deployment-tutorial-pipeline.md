...
1. Введите URL-адрес. Для URL-адреса репозитория используется такой формат: **https://github.com/ [имя_учетной_записи]/[имя_репозитория]** .
...
1. Перейдите из браузера в свой репозиторий GitHub.  URL-адрес: **https://github.com/ [YourAccountName]/[YourGitHubRepository]** . Вы увидите папку **CreateWebApp** с тремя файлами в ней.
