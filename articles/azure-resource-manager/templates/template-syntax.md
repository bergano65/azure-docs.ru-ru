...
| Имя элемента | Обязательное значение | Описание |
|:--- |:--- |:--- |
| пространство имен |Да |Пространство имен для пользовательских функций. Используйте, чтобы избежать конфликтов имен с функциями шаблонов. |
