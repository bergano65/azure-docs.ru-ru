...
Эта статья предназначена для пользователей, знакомых с шаблонами ARM. Он предоставляет подробные сведения о структуре шаблона. Пошаговые инструкции по созданию шаблона см. в статье [Учебник. Создание и развертывание первого шаблона ARM](template-tutorial-create-first-template.md). Дополнительные сведения о шаблонах ARM в интерактивном наборе модулей на Microsoft Learn см. в статье [развертывание ресурсов и управление ими в Azure с помощью шаблонов ARM](/learn/paths/deploy-manage-resource-manager-templates/).
