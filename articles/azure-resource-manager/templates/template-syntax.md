...
> [!NOTE]
> Для развертывания шаблонов с комментариями с помощью `--handle-extended-json-format` Azure CLI необходимо использовать переключатель.
...
Для развертывания шаблонов с многолинейными строками с помощью `--handle-extended-json-format` Azure CLI необходимо использовать переключатель.
