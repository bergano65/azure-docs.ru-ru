...
Сведения об использовании `copy` для создания нескольких значений для переменной см. в разделе [Переменная iteration](create-multiple-instances.md#variable-iteration).
