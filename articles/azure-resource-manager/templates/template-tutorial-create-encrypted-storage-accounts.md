...
![Справочник по шаблонам Resource Manager: развернуть зашифрованную учетную запись хранения](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-tutorial-deploy-encrypted-storage-account.png)
...
1. Из VS Code сверните шаблон до корневого уровня. Имеется простейшая структура со следующими элементами.
    ...
    ![Простейшая структура шаблона Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-simplest-structure.png)
...
2. Разверните раздел **resources**. Вы увидите определенный ресурс `Microsoft.Storage/storageAccounts`. Этот шаблон создает незашифрованную учетную запись хранения.
    ...
    ![Определение учетной записи хранения в шаблоне Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resource.png)
...
3. Последовательно выберите **"Справочник", "Справочник по шаблонам", "Хранилище", &lt;"Версия">"Учетные записи хранения"** , как показано на приведенном ниже снимке экрана.
    ...
    ![Учетная запись хранения ссылки на шаблон Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts.png)
...
4. Найдите информацию о шифровании в определениях.
    ...
    ![Ссылка на шаблон Resource Manager: шифрование учетной записи хранения](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption.png)
    ...
    ![Ссылка на шаблон Resource Manager: объект шифрования учетной записи хранения](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption-object.png)
...
![Зашифрованные ресурсы учетной записи хранения шаблона Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resources.png)
...
![Зашифрованная учетная запись хранения Azure Resource Manager](./media/template-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-account.png)
