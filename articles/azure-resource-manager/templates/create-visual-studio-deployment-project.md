...
1. Можно добавить новый ресурс, нажав кнопку **Добавить ресурс** в верхней части окна структуры JSON. Или же можно щелкнуть правой кнопкой мыши элемент **Ресурсы** и выбрать команду **Добавить новый ресурс**.
   ...
   ![Добавление ресурса](./media/create-visual-studio-deployment-project/add-resource.png)
...
1. В меню быстрого размещения узла проекта развертывания выберите **Развертывание** > **Нового**.
...
1. Добавьте проект в свое решение Visual Studio. Нажмите правой кнопкой мыши и выберите **Добавить** > **новый проект.**
...
1. Теперь нужно убедиться, что проект группы ресурсов уведомлен о новом проекте. Вернитесь к проекту группы ресурсов (ExampleAppDeploy). Щелкните правой кнопкой мыши **Ссылки** и выберите **Добавить ссылку**.
    ...
    ![Ссылка, которую нужно добавить](./media/create-visual-studio-deployment-project/add-new-reference.png)

1. Выберите созданный проект веб-приложения.

   ![Ссылка, которую нужно добавить](./media/create-visual-studio-deployment-project/add-reference.png)
...
1. После завершения развертывания просмотрите панель мониторинга на портале. Щелкните **Панель мониторинга** и выберите ту, которую вы развернули.
   ...
   ![Настраиваемая панель мониторинга](./media/create-visual-studio-deployment-project/view-custom-dashboards.png)
