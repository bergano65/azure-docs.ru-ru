...
[Спецификации шаблонов](./template-specs.md) (в настоящее время в закрытой предварительной версии) позволяют совместно использовать шаблоны ARM с другими пользователями в Организации. Спецификации шаблонов можно также использовать для упаковки основного шаблона и связанных с ним шаблонов. Дополнительные сведения можно найти в разделе
