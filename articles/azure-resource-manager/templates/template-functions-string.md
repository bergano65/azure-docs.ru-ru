...
|:--- |:--- |:--- |:--- |
| inputString |Да |string |Значение, которое нужно вернуть в кодировке base64. |
...
| toJsonOutput | Объекты | {"one": "a", "two": "b"} |
...
| Параметр | Обязательно для заполнения | Тип | Description |
|:--- |:--- |:--- |:--- |
| inputString |Да |string |Строка для разделения. |
