...
Если вам нужно создавать новое уникальное имя каждый раз, когда вы развертываете шаблон, и не намерены обновлять ресурс, вы можете использовать функцию [utcNow](#utcnow) с uniqueString. Этот подход можно использовать в тестовой среде. Например, [см.](#utcnow)
