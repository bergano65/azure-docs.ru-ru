...
Решая, какие [зависимости](define-resource-dependency.md) следует установить, следуйте следующим рекомендациям.
