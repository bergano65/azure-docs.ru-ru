...
Чтобы установить свойство в значение null, можно использовать **значение NULL** или **[JSON (' null ')]**. [Функция JSON](template-functions-object.md#json) возвращает пустой объект, если в качестве параметра `null` указано значение. В обоих случаях диспетчер ресурсов шаблоны обрабатывают его так, как если бы свойство не присутствовало.
