...
* [if](template-functions-logical.md#if) (если);
...
* Указания по выполнению заданного количества циклов итерации при создании типа см. в разделе [Создание нескольких экземпляров ресурсов в Azure Resource Manager](create-multiple-instances.md).
* Сведения о развертывании созданного шаблона см. в разделе [развертывание приложения с помощью Azure Resource Manager шаблона](deploy-powershell.md) .
