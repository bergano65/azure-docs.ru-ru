...
- `primaryScriptUri`: Укажите общедоступный URL-адрес основного скрипта развертывания с поддерживаемыми расширениями файлов.
- `supportingScriptUris`: Укажите массив общедоступных URL-адресов для поддержки файлов, которые вызываются в либо `scriptContent` `primaryScriptUri` .
