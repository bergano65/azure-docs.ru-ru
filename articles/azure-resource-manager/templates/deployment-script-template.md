...
- Измените название ресурса развертыванийScripts. Например, используйте функцию шаблона [utcNow](./template-functions-string.md#utcnow) как имя ресурса или как часть имени ресурса. Изменение имени ресурса создает новый ресурс развертыванияScripts. Это хорошо для хранения истории выполнения сценария.
