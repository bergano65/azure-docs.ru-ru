...
Чтобы хранить экземпляр контейнера и учетную запись хранения для устранения неполадок, можно добавить в скрипт команду Sleep.  Например, используйте [Start-Sleep](https://docs.microsoft.com/powershell/module/microsoft.powershell.utility/start-sleep).
