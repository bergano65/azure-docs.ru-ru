...
| TooManyTargetResourceGroups | Уменьшите количество групп ресурсов для одного развертывания. | [Развертывание между областями](cross-scope-deployment.md) |
