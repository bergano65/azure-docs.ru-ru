...
ms.locfileid: "92744763"
---
# <a name="develop-arm-templates-for-cloud-consistency"></a>Разработка шаблонов ARM для согласованности в облаке

[!INCLUDE [requires-azurerm](../../../includes/requires-azurerm.md)]

Основным преимуществом Azure является согласованность. Вложения в разработку для одного расположения можно повторно использовать для другого. Шаблон Azure Resource Manager (ARM) делает развертывания согласованными и повторяемыми в разных средах, включая глобальные Azure, облака Azure независимых и Azure Stack. Для повторного использования шаблонов в разных облачных средах, тем не менее, необходимо учитывать зависимости, присущие конкретным средам, о которых рассказывается в этом руководстве.
