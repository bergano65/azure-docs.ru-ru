...
description: Описывается, как запустить набор средств тестирования шаблона Azure Resource Manager (шаблон ARM) в шаблоне. Набор средств позволяет увидеть, реализованы ли рекомендации.
ms.topic: conceptual
ms.date: 09/02/2020
ms.author: tomfitz
author: tfitzmac
