---
title: Конфигурация после развертывания с помощью расширений
...
- [Учебник: Развертывание виртуальных машинных расширений с помощью шаблонов Azure Resource Manager.](template-tutorial-deploy-vm-extensions.md)
