...
## <a name="install-visual-studio-code"></a>Установить код Visual Studio
...
## <a name="install-resource-manager-tools-extension"></a>Установка расширения средств диспетчер ресурсов
...
Можно перейти к определению с помощью **сочетания клавиш CTRL + щелчок**или контекстного меню, как показано на снимке экрана: ![Visual Studio Code расширения средств диспетчер ресурсов Tools к определению](./media/resource-manager-tools-vs-code/resource-manager-tools-extension-context-menu.png)
...
- Дополнительные сведения о шаблонах диспетчер ресурсов и диспетчер ресурсов см. в разделе [Azure Resource Manager обзор](./resource-group-overview.md).
- Чтобы выполнить краткое руководство по использованию Visual Studio Code, см. [раздел Краткое руководство. Создание шаблонов Azure Resource Manager с помощью Visual Studio Code](./resource-manager-quickstart-create-templates-use-visual-studio-code.md)
