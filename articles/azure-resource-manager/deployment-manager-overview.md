...
Дополнительные сведения о на этапе проверки работоспособности, см. в разделе [ ]() и [ ]() Дополнительные сведения см. в разделе [действия Справочник по шаблонам](/azure/templates/Microsoft.DeploymentManager/steps).
