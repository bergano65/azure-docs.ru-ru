...
Azure Resource Manager шаблонах требуется, чтобы, `id` `name` и `type` были правильно возвращены из подчиненной конечной точки. Возвращенный ответ ресурса должен иметь вид:
