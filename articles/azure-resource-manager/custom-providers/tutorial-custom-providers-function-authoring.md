---
title: Создание конечной точки RESTful
...
**идентификатор** | /subscriptions/{subscriptionId}/resourceGroups/{имя_группы_ресурсов}/<br>providers/Microsoft.CustomProviders/resourceProviders/{имя поставщика ресурсов}/<br>{имя_типа_ресурса}/{имя_настраиваемого_ресурса} | Идентификатор ресурса
