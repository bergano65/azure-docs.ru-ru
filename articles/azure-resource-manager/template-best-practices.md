...
При развертывании ресурсов в группу ресурсов, она хранит метаданные ресурсов. Метаданные хранятся в расположении группы ресурсов.

Если область группы ресурсов, временно недоступна, невозможно обновить ресурсы в группе ресурсов, поскольку метаданные недоступна. Ресурсы в других регионах по-прежнему будет работать должным образом, но не обновлять их. Чтобы свести к минимуму риск, найдите группу ресурсов и ресурсы в одном регионе.
...
* Ресурсы, в которых установлено значение [элемента условия](resource-group-authoring-templates.md#condition) false, автоматически удаляются из порядка зависимостей. Назначайте зависимости так, как и при развернутом ресурсе.
