...
Подробно рассмотрим пример, см. в разделе [руководства: Use health check in Azure Deployment Manager](./deployment-manager-health-check.md) (Учебник по использованию проверки работоспособности в диспетчере развертывания Azure).
