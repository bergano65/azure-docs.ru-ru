---
title: Учебник. Добавление параметров в шаблон Resource Manager
...
## <a name="make-your-template-reusable"></a>Изменение шаблона для повторного использования
...
## <a name="redeploy-the-template"></a>Повторное развертывание шаблона
