...
* **azureResourcelocation**. Чтобы упростить работу с руководством, все ресурсы совместно используют это расположение, если не указано иное.
