...
* Виртуальные машины в существующей виртуальной сети, где пользователь не требуется переместить все ресурсы в виртуальной сети.
...
### <a name="recovery-services-limitations"></a>Ограничения служб восстановления
 ...
 Чтобы переместить в хранилище служб восстановления, выполните следующие действия: [Перемещение ресурсов в новую группу ресурсов или подписку](../backup/backup-azure-move-recovery-services-vault.md).
