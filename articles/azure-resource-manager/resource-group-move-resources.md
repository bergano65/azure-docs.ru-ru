...
* Хранилище Служб восстановления — вы должны быть зарегистрированы в [ограниченной общедоступной предварительной версии](https://docs.microsoft.com/azure/backup/backup-azure-move-recovery-services-vault).
...
Для перемещения хранилища Служб восстановления вы должны быть зарегистрированы в [ограниченной общедоступной предварительной версии](https://docs.microsoft.com/azure/backup/backup-azure-move-recovery-services-vault).
