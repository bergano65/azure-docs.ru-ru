...
* Cognitive Services
* Реестр контейнеров — реестр контейнеров нельзя переместить, если включена географическая репликация.
* Content Moderator
...
* Хранилище Служб восстановления — вы должны быть зарегистрированы для использования закрытой предварительной версии. Ознакомьтесь с разделом [Ограничения служб восстановления](#recovery-services-limitations).
...
Ниже приведены ограничения, которые еще не поддерживаются.
...
* Если виртуальная машина настроена для резервного копирования, ознакомьтесь со сведениями, описанными в разделе [Ограничения Служб восстановления](#recovery-services-limitations).
...
Чтобы переместить виртуальную машину в новую подписку без перемещения хранилища Служб восстановления, сделайте следующее:
 ...
 2. Переместите виртуальную машину в новую подписку.
 3. Повторно защитите ее в новом хранилище в этой подписке.
