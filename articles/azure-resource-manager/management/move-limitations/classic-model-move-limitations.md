---
title: Перемещение ресурсов развертывания Azure Classic
description: Используйте менеджер ресурсов Azure для перемещения ресурсов Classic развертывания в новую группу ресурсов или подписку.
ms.topic: conceptual
ms.date: 07/09/2019
...
---
# <a name="move-guidance-for-classic-deployment-model-resources"></a>Перемещение руководства для ресурсов модели классического развертывания

Шаги по перемещению ресурсов, развернутых по классической модели, различаются в зависимости от того, перемещаете ли ресурсы в рамках подписки или в новую подписку.

## <a name="move-in-the-same-subscription"></a>Перемещение в той же подписке
...
Чтобы переместить классические ресурсы в новую группу ресурсов в рамках той же подписки, используйте [стандартные операции перемещения](../move-resource-group-and-subscription.md) через портал, Azure PowerShell, Azure CLI или REST API. При этом используются те же операции, что и для перемещения ресурсов Resource Manager.
...
Для перемещения классических ресурсов в новую подписку используйте операции REST, предназначенные для классических ресурсов. Чтобы использовать REST, сделайте следующие шаги:
