...
Вы можете сделать эти шаги через портал Azure, Azure PowerShell или Azure CLI.

Для списка, который отображает ресурсы для служб Azure, можно узнать о [поставщиках ресурсов для служб Azure.](azure-services-resource-providers.md)
...
6. Регистрация поставщика ресурсов настраивает подписку для работы с поставщиком ресурсов. Областью регистрации всегда является подписка. По умолчанию многие поставщики ресурсов регистрируются автоматически. Тем не менее, некоторые поставщики ресурсов может потребоваться зарегистрировать вручную. Чтобы зарегистрировать поставщика ресурсов, необходимо иметь `/register/action` разрешение на проведение операции для поставщика ресурсов. Эта операция включается в роли участника и владельца. Чтобы зарегистрировать поставщика ресурсов, выберите **Регистрация**. На предыдущем снимке экрана ссылка **Регистрация** выделена в поле **Microsoft.Blueprint**.

    Вы не можете отменить регистрацию поставщика ресурсов, когда в подписке все еще есть типы ресурсов от этого поставщика ресурсов.
...
Регистрация поставщика ресурсов настраивает подписку для работы с поставщиком ресурсов. Областью регистрации всегда является подписка. По умолчанию многие поставщики ресурсов регистрируются автоматически. Тем не менее, некоторые поставщики ресурсов может потребоваться зарегистрировать вручную. Чтобы зарегистрировать поставщика ресурсов, необходимо иметь `/register/action` разрешение на проведение операции для поставщика ресурсов. Эта операция включается в роли участника и владельца.
...
* Чтобы узнать о создании шаблонов «Менеджер ресурсов», [см.](../templates/template-syntax.md) 
