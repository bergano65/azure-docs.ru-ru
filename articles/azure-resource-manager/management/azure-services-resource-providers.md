---
title: Поставщики ресурсов службами Azure
description: Перечисляет все области имен поставщика ресурсов для менеджера ресурсов Azure и отображает службу Azure для этого пространства имен.
ms.topic: conceptual
ms.date: 03/17/2020
...
ms.locfileid: "81382515"
---
# <a name="resource-providers-for-azure-services"></a>Поставщики ресурсов для служб Azure

В этой статье показано, как ресурсоснабжающей организации отображает карты для служб Azure.

## <a name="match-resource-provider-to-service"></a>Соответствие поставщику ресурсов для обслуживания
...
| Microsoft.AnalysisServices | [Службы Azure Analysis Services](/azure/analysis-services/) |
...
| Microsoft.AzureData | Реестр серверов S'L |
| Microsoft.AzureStack | core |
| Microsoft.Batch | [Пакетная служба Azure](../../batch/index.yml) |
...
| Microsoft.CertificateRegistration | [Сертификаты обслуживания приложений](../../app-service/configure-ssl-certificate.md#import-an-app-service-certificate) |
| Microsoft.ChangeАнализ | [Azure Monitor](../../azure-monitor/index.yml) |
| Microsoft.ClassicCompute | Классическая модель развертывания виртуальной машины |
| Microsoft.ClassicInfrastructureMigrate | Классическая миграция модели развертывания |
| Microsoft.ClassicNetwork | Классическая модель развертывания виртуальной сети |
| Microsoft.ClassicStorage | Классическая модель развертывания |
| Microsoft.ClassicПодписка | Классическая модель развертывания |
| Microsoft.CognitiveServices | [Cognitive Services](/azure/cognitive-services/) |
| Microsoft.Commerce | core |
| Microsoft.Compute; | [Виртуальные машины](/azure/virtual-machines/)<br />[Масштабируемые наборы виртуальных машин Microsoft Azure](/azure/virtual-machine-scale-sets/) |
...
| Microsoft.CustomerLockbox | Блокировка клиентов для Microsoft Azure |
...
| Share Microsoft.DataShare | [Azure Data Share](/azure/data-share/) |
...
| Microsoft.DesktopVirtualization | [Виртуальный рабочий стол Windows](/azure/virtual-desktop/) |
| Microsoft.DeploymentManager | [Менеджер развертывания Azure](../templates/deployment-manager-overview.md) |
| Microsoft.Devices | [Центр Интернета вещей Azure](/azure/iot-hub/)<br />[Служба подготовки устройств к добавлению в Центр Интернета вещей Azure](/azure/iot-dps/) |
...
| Microsoft.EnterpriseKnowledgeGraph | График знаний предприятия |
| Microsoft.EventGrid | [Сетка событий Azure](/azure/event-grid/) |
...
| Microsoft.Kubernetes | [Служба Azure Kubernetes (AKS)](/azure/aks/) |
...
| Microsoft.Maintenance | [Обслуживание лазури](../../virtual-machines/maintenance-control-cli.md) |
...
| Microsoft.Network. | [Шлюз приложений](../../application-gateway/index.yml)<br />[Бастион Azure](/azure/bastion/)<br />[Защита от атак DDoS Azure](../../virtual-network/ddos-protection-overview.md)<br />[Azure DNS](../../dns/index.yml)<br />[Azure ExpressRoute](../../expressroute/index.yml)<br />[Брандмауэр Azure](../../firewall/index.yml)<br />[Azure Front Door Service](../../frontdoor/index.yml)<br />[Приватный канал Azure](../../private-link/index.yml)<br />[Load Balancer](../../load-balancer/index.yml)<br />[Наблюдатель за сетями](../../network-watcher/index.yml)<br />[Диспетчер трафика](../../traffic-manager/index.yml)<br />[Виртуальная сеть](../../virtual-network/index.yml)<br />[Виртуальная глобальная сеть](../../virtual-wan/index.yml)<br />[VPN-шлюз](../../vpn-gateway/index.yml)<br /> |
...
| Microsoft.SerialConsole | [Серийная консоль Azure для Windows](../../virtual-machines/troubleshooting/serial-console-windows.md) |
...
| Microsoft.Sql | [База данных SQL Azure](../../sql-database/index.yml)<br />[Azure Synapse Analytics](/azure/sql-data-warehouse/) |
...
| Microsoft.WindowsIoT | [Основные службы Windows 10 IoT](https://docs.microsoft.com/windows-hardware/manufacture/iot/iotcoreservicesoverview) |
| Microsoft.WorkloadMonitor | [Azure Monitor](../../azure-monitor/index.yml) |

## <a name="next-steps"></a>Следующие шаги

Для получения дополнительной информации [Azure resource providers and types](resource-providers-and-types.md) о поставщиках ресурсов см.
