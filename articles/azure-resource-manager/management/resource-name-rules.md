...
> | Сущность | Область | Длина | Допустимые символы |
> | --- | --- | --- | --- |
> | служба | глобальная | 1–50 | Буквенно-цифровые.<br><br>Начинается с буквы. |
...
> | virtualMachines | resource group | 1–15 (Windows)<br>1–64 (Linux)<br><br>См. примечание ниже. | Нельзя использовать:<br> `\/""[]:|<>+=;,?*@&`<br><br>Не может начинаться с символа подчеркивания. Не может заканчиваться точкой или дефисом. |
> | virtualMachineScaleSets | resource group | 1–15 (Windows)<br>1–64 (Linux)<br><br>См. примечание ниже. | Нельзя использовать:<br> `\/""[]:|<>+=;,?*@&`<br><br>Не может начинаться с символа подчеркивания. Не может заканчиваться точкой или дефисом. |
...
> | Сущность | Область | Длина | Допустимые символы |
> | --- | --- | --- | --- |
> | пространства имен | глобальная | 6–50 | Буквенно-цифровые символы и дефисы.<br><br>Начинается и закачивается буквенно-цифровым символом. |
