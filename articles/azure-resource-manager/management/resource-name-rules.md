...
> | virtualMachines | resource group | 1–15 (Windows)<br>1–64 (Linux)<br><br>См. примечание ниже. | Не может использовать пробелы или следующие символы:<br> `\/"'[]:|<>+=;,?*@&`<br><br>Не может начинаться с символа подчеркивания. Не может заканчиваться точкой или дефисом. |
