...
3. Выберите ресурс, который необходимо открыть.
    ...
    ![Снимок экрана, который выделяет выбранный ресурс.](./media/manage-resources-portal/manage-azure-resources-portal-open-resource.png)

    Учетная запись хранения выглядит следующим образом:

    ![Снимок экрана, показывающий, как выглядит учетная запись хранения.](./media/manage-resources-portal/manage-azure-resources-portal-open-resource-storage.png)
