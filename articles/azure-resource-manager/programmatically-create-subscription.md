...
Выполните следующий запрос, заменив `<customerId>` на `id`, скопированный на первом шаге (```/providers/Microsoft.Billing/billingAccounts/99a13315-xxxx-xxxx-xxxx-xxxxxxxxxxxx:xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx_xxxx-xx-xx/customers/2281f543-xxxx-xxxx-xxxx-xxxxxxxxxxxx```). Передайте необязательный *реселлерид* , скопированный на втором шаге, в параметрах запроса API. 
