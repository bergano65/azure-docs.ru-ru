...
- Существует ограничение в 200 подписок на учетную запись регистрации. После этого дополнительные подписки для учетной записи можно создать только в центре управления учетной записью. Если вы хотите создать больше подписок через API, создайте другую учетную запись регистрации.
