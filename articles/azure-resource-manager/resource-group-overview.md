...
- Быстрое начало работы
    ...
    |[Краткое руководство. Создание шаблона Azure Resource Manager c помощью Visual Studio Code](./resource-manager-quickstart-create-templates-use-visual-studio-code.md)|Используйте Visual Studio Code, чтобы создавать и редактировать шаблоны, а также узнайте, как развернуть шаблон с помощью Azure Cloud Shell.|
...
- Учебники
    ...
    |[Руководство. Использование диспетчера развертывания Azure с шаблонами Resource Manager (закрытая предварительная версия)](./deployment-manager-tutorial.md)|Используйте диспетчер развертывания Azure. |
