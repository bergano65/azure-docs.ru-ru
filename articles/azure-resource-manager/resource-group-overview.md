...
В Azure предоставляются четыре уровня области управления: [группы управления](../governance/management-groups/index.md), подписки, [группы ресурсов](#resource-groups) и ресурсы. Пример этих уровней приведен на следующем изображении.
