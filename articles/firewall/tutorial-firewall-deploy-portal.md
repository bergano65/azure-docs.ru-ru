...
ms.locfileid: "57994256"
---
# <a name="tutorial-deploy-and-configure-azure-firewall-using-the-azure-portal"></a>Руководство. Развертывание и настройка службы "Брандмауэр Azure" с помощью портала Azure
...
> * настройка приложения для предоставления доступа к msn.com;
...
11. Примите остальные значения по умолчанию и щелкните кнопку **Далее: Управление**.
12. Щелкните **Отключить**, чтобы выключить диагностику загрузки. Примите другие параметры по умолчанию и щелкните кнопку **Просмотр и создание**.
...
4. Используйте сведения в следующей таблице, чтобы настроить брандмауэр на странице **Создание брандмауэра**:
   ...
   |Группа ресурсов     |**Использовать существующую**. Test-FW-RG |
...
7. По завершении развертывания перейдите в группу ресурсов **Test-FW-RG** и щелкните брандмауэр **Test-FW01**.
...
12. В поле **Подсеть** щелкните **Workload-SN**. Убедитесь, что для этого маршрута выбрана только подсеть **Workload-SN**. В противном случае брандмауэр не будет работать правильно.
...
Это правило приложения, разрешающее исходящий доступ к msn.com.
...
11. В поле **Целевые полные доменные имена** введите **msn.com**.
...
3. Откройте браузер Internet Explorer и перейдите на сайт https://msn.com.
4. В оповещениях безопасности щелкните **ОК** > **Закрыть**.

   Откроется домашняя страница MSN.

5. Перейдите по адресу https://www.msn.com.
