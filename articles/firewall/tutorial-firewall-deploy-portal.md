...
В Брандмауэре Azure используется правила преобразования сетевых адресов, правила сети и правила приложений. Дополнительные сведения о логике обработки правил Брандмауэра Azure см. в [соответствующей статье](rule-processing.md).
...
12. В поле **Подсеть** щелкните **Workload-SN**.
    ...
    > [!IMPORTANT]
    > Убедитесь, что для этого маршрута выбрана только подсеть **рабочей нагрузки SN**. В противном случае брандмауэр не будет работать правильно.
