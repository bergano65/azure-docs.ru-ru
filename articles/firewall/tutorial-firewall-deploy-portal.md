...
Дополнительные сведения о логике обработки правил Брандмауэра Azure см. в [соответствующей статье](rule-processing.md).
...
7. В разделе **Группа ресурсов** выберите **Use existing** (Использовать имеющуюся), а затем — **Test-FW-RG**.
