...
ms.locfileid: "57531170"
---
# <a name="tutorial-filter-inbound-traffic-with-azure-firewall-dnat-using-the-azure-portal"></a>Руководство. Фильтрация входящего трафика с помощью DNAT службы "Брандмауэр Azure" с использованием портала Azure
