...
2. По завершении выберите **Next: IP-адреса** .
3. В поле **Диапазон IPv4-адресов** введите **10.5.0.0/16** .
6. В разделе **Имя подсети** выберите **по умолчанию** .
7. В разделе **Имя** введите **AzureFirewallSubnet** . Брандмауэр будет размещен в этой подсети. Для подсети **необходимо** указать имя AzureFirewallSubnet.
8. В поле **Диапазон адресов** введите **10.5.0.0/26** . 
...
4. В поле **Диапазон IPv4-адресов** введите **10.6.0.0/16** .
6. В разделе **Имя подсети** выберите **по умолчанию** .
7. В поле **Имя** введите **SN-Workload** .
8. В поле **Диапазон адресов** введите **10.6.0.0/24** . 
9. Щелкните **Сохранить** .
10. Выберите **Проверить и создать** .
11. Нажмите кнопку **создания** .
...
4. В поле **Диапазон IPv4-адресов** введите **192.168.0.0/16** .
5. В разделе **Имя подсети** выберите **по умолчанию** .
7. В поле **Имя** введите **SN-Corp** .
8. В поле **Диапазон адресов** введите **192.168.1.0/24** . 
9. Щелкните **Сохранить** .
10. Выберите **Проверить и создать** .
11. Нажмите кнопку **создания** .
