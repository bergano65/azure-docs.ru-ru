...
description: Сведения об использовании шаблона Azure Resource Manager (шаблона ARM) для создания Брандмауэра Azure с несколькими общедоступными IP-адресами.
services: firewall
author: vhorne
ms.service: firewall
ms.topic: quickstart
