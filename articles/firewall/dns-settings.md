...
Существует два типа функций кэширования, которые выполняются, если брандмауэр Azure является DNS-прокси:

- Положительный кэш — разрешение DNS успешно. Брандмауэр использует TTL (срок жизни) пакета или объекта. 
...
Вы можете использовать Azure CLI, чтобы настроить параметры прокси-сервера DNS в брандмауэре Azure и обновить виртуальные сети, чтобы использовать брандмауэр Azure в качестве DNS-сервера.
...
Вы можете использовать Azure PowerShell, чтобы настроить параметры прокси-сервера DNS в брандмауэре Azure и обновить виртуальные сети, чтобы использовать брандмауэр Azure в качестве DNS-сервера.
