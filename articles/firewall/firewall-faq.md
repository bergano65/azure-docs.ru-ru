...
Начальная пропускная способность брандмауэра Azure составляет 2,5 – 3 Гбит/с и масштабируется до 30 Гбит/с. Масштабирование выполняется на основе загрузки ЦП и пропускной способности. Обратитесь в службу поддержки, чтобы увеличить пропускную способность брандмауэра, если ваш брандмауэр не масштабируется в соответствии с вашими потребностями и вам требуется более высокая пропускная способность.

## <a name="how-long-does-it-take-for-azure-firewall-to-scale-out"></a>Сколько времени займет развертывание брандмауэра Azure?

Для горизонтального масштабирования брандмауэра Azure потребуется от пяти до семи минут. Обратитесь в службу поддержки, чтобы увеличить начальную пропускную способность брандмауэра, если у вас есть пакеты, требующие более быстрого автоматического масштабирования.
