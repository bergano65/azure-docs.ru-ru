...
## <a name="does-azure-firewall-outbound-snat-between-private-networks"></a>Работает брандмауэр Azure исходящих SNAT-подключений между частными сетями?

Брандмауэр Azure не SNAT при диапазон частных IP-адрес в IP-адрес назначения [IANA RFC 1918](https://tools.ietf.org/html/rfc1918). Если ваша организация использует общедоступный диапазон IP-адресов для частных сетей, SNATs брандмауэра Azure трафик на одно брандмауэра частных IP-адресов AzureFirewallSubnet.
