...
Управление доступом исходящих сетевых подключений является важной частью общего плана безопасности сети. Например можно ограничить доступ к веб-сайтов. Или, может потребоваться ограничить исходящий IP-адреса и порты, которые доступны.
...
> * Настройка правила приложения для доступа к www.google.com
...
Теперь проверьте брандмауэр так, чтобы убедиться, что он работает должным образом.
...
1. Подключение удаленного рабочего стола к **перехода Srv** виртуальную машину и войдите в. Откройте удаленный рабочий стол для **Srv рабочих** частных IP-адрес и входа.
...
* [Руководство. Журналы брандмауэра Azure](./tutorial-diagnostics.md)
