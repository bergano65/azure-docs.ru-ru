...
Если вы хотите использовать портал Azure для работы с этим руководством, см. [раздел учебник. Развертывание и настройка брандмауэра Azure в гибридной сети с помощью портал Azure](tutorial-hybrid-portal.md).
