...
## <a name="availability-zones-public-preview"></a>Зоны доступности (общедоступная предварительная версия)
...
## <a name="multiple-public-ips-public-preview"></a>Несколько общедоступных IP-адресов (общедоступная предварительная версия)
...
> [!NOTE]
> Если на этапе общедоступной предварительной версии был добавлен или удален общедоступный IP-адрес работающего брандмауэра, то существующее входящее подключение для которого используются правила DNAT может не работать в течение 40–120 секунд. Запрещается удалять первый общедоступный IP-адрес, который был назначен брандмауэру, если только брандмауэр не освобождается или удаляется.
...
|Не удается удалить первый общедоступный IP-адрес|Запрещается удалять первый общедоступный IP-адрес, который был назначен брандмауэру, если только брандмауэр не освобождается или удаляется.|Это сделано специально.|
|Если общедоступный IP-адрес будет добавлен или удален, правила DNAT могут временно не работать.| Если общедоступный IP-адрес работающего брандмауэра был добавлен или удален, то существующее входящее подключение для которого используются правила DNAT может не работать в течение 40–120 секунд.|Данное ограничение касается общедоступной предварительной версия этой функции.|
