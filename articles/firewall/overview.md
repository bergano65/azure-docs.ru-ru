...
|Поддержка фильтрации SQL FQDN только в режиме прокси-сервера (порт 1433)|Для Базы данных SQL Azure, Хранилища данных SQL Azure и Управляемого экземпляра Базы данных SQL Azure:<br><br>в предварительной версии фильтрация SQL FQDN поддерживается только в режиме прокси-сервера (порт 1433).<br><br>Для Azure SQL IaaS:<br><br>если вы используете нестандартные порты, их можно указать в правилах приложения.|Для SQL в режиме перенаправления (по умолчанию используется для подключения из Azure) можно фильтровать доступ с помощью тега службы SQL в правилах сети Брандмауэра Azure.
