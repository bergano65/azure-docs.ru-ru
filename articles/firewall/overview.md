...
## <a name="pci-soc-and-iso-compliant"></a>Соответствие требованиям PCI, SOC и ISO

Брандмауэр Azure соответствует требованиям стандартов Payment Card Industry Data Security Standard (PCI DSS) и Международной организация по стандартизации (ISO), а также требованиям к отчетам System and Organization Controls (SOC). В настоящее время выполняются требования к отчетам SOC 1, тип 2, SOC 2, тип 2, SOC 3, а также требования стандартов PCI DSS, ISO 27001, 27018, 20000-1, 22301, 9001, 27017.

Дополнительные сведения см. в [этом документе](https://servicetrust.microsoft.com/ViewPage/MSComplianceGuide).
