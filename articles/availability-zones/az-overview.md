...
- **Избыточные между зонами службы**. Платформа выполняет автоматическую репликацию между зонами (например, хранилище, избыточное в пределах зоны, база данных SQL).
