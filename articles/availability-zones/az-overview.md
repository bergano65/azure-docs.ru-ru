---
title: Что такое Зоны доступности Azure?
...
- **Зональные службы** — вы прикрепляете ресурс к определенной зоне (например, виртуальные машины, управляемые диски, стандартные IP-адреса) или
...
> [!IMPORTANT]
> Идентификаторы зоны доступности (цифры 1, 2 и 3 на рисунке выше) логически отображаются к фактическим физическим зонам для каждой подписки самостоятельно. Это означает, что зона доступности 1 в данной подписке может относиться к другой физической зоне, чем зона доступности 1 в другой подписке. Как следствие, рекомендуется не полагаться на идолты зоны доступности в различных подписках для размещения виртуальных машин.

## <a name="services-support-by-region"></a>Поддержка услуг по регионам

Комбинации служб Azure и регионов, поддерживающих зоны доступности:
...
| **Хранилище**   |            |              |           |           |                |              |          |             |            |                |
| Управляемые диски                   | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003;   | &#10003;       |
| Зона-избыточное хранение          | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003;   | &#10003;       |
| **Сеть**                     |            |              |           |           |                |              |          |             |            |                |
| Стандартный IP-адрес        | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003;   | &#10003;       |
| Load Balancer (цен. категория "Стандартный")     | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003;   | &#10003;       |
| VPN-шлюз            | &#10003;   |  &#10003;    | &#10003;  | &#10003;  | &#10003;       | &#10003;     |  &#10003;  | &#10003;    |  &#10003;   | &#10003;       |
| Шлюз ExpressRoute   | &#10003;   |  &#10003;    | &#10003;  | &#10003;  | &#10003;       | &#10003;     |  &#10003;  | &#10003;    |  &#10003;   | &#10003;       |
| Портал приложений (V2)    | &#10003;   |  &#10003;    | &#10003;  | &#10003;  | &#10003;       | &#10003;     |  &#10003;  | &#10003;    |  &#10003;   | &#10003;       |
| Брандмауэр Azure           | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    |  &#10003;       | &#10003;       |
| **Баз данных**                     |            |              |           |           |                |              |          |             |            |                |
| Azure Data Explorer                   | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003;        | &#10003;       |
| База данных SQL                    | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    | &#10003; (Предварительный просмотр)      | &#10003;       |
| Кэш Redis для Azure           | &#10003;   | &#10003;     | &#10003;  | &#10003;  | &#10003;       | &#10003;     | &#10003; | &#10003;    |  &#10003;       | &#10003;       |
| Azure Cosmos DB                    | &#10003;   |  &#10003;  |  &#10003; | &#10003; |       |     | &#10003; |  &#10003;   |            | &#10003;       |
| **Аналитики**                       |            |              |           |           |                |              |          |             |            |                |
| Центры событий                      | &#10003;   |   &#10003; | &#10003;  | &#10003;  | &#10003; | &#10003; | &#10003; | &#10003; | &#10003; | &#10003;       |
...
## <a name="services-resiliency"></a>Устойчивость услуг
Все службы управления Azure учреждаются как устойчивые к сбоям на уровне регионов. В спектре сбоев один или несколько сбоев зоны доступности в регионе имеют меньший радиус сбоя по сравнению с полной сбой в регионе. Azure может оправиться от сбоя служб управления на уровне зоны в регионе или в другом регионе Azure. Azure выполняет критические функции обслуживания по одной зоне в пределах региона, чтобы предотвратить любые сбои, влияющие на ресурсы клиентов, развернутые в зонах доступности в пределах региона.
...
- [База данных S'L](../sql-database/sql-database-high-availability.md#zone-redundant-configuration)
...
- [Добавление избыточной зоны для Azure Cosmos DB](../cosmos-db/high-availability.md#availability-zone-support)
- [Начало работы кэша Azure для зон доступности Redis](https://aka.ms/redis/az/getstarted)
- [Создание экземпляра доменных служб Azure Active Directory](../active-directory-domain-services/tutorial-create-instance.md)
- [Создание кластера службы Azure Kubernetes (AKS), использующем зоны доступности](../aks/availability-zones.md)
