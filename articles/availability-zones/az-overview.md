...
- [Добавить область избыточности зоны для Azure Cosmos DB](../cosmos-db/high-availability.md#availability-zone-support)
- [Приступая к работе кэша Azure Redis зонах доступности](https://aka.ms/redis/az/getstarted)
