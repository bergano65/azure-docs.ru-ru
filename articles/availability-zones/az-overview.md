...
> | Azure Cosmos DB | Служба автоматизации | База данных Azure для MariaDB |
...
> | Служебная шина | Брандмауэр Azure | Data Box Heavy |
> | Service Fabric | Функции Azure | Каталог данных |
> | Масштабируемые наборы виртуальных машин Microsoft Azure | Azure HPC Cache | Фабрика данных: фабрика данных v1 |
...
> | Виртуальные машины: IP-адреса уровня экземпляра | Пакетная служба Azure | Виртуальные машины: серия EASv4 |
> | Виртуальные машины: зарезервированный IP-адрес | Облачные службы: серия M | Виртуальные машины: серия EAv4 |
> | Виртуальная сеть | Cognitive Services | Виртуальные машины: серия G |
