...
>[!IMPORTANT]
> Если личность, назначенная экземпляру Конфигурации Приложения, больше не уполномочена разворачивать ключ шифрования экземпляра, или если управляемый ключ удален навсегда, то расшифровка конфиденциальной информации, хранящейся в приложении Конфигурация экземпляра. Использование функции [мягкого удаления](../key-vault/key-vault-ovw-soft-delete.md) Azure Key Vault снижает вероятность случайного удаления ключа шифрования.
