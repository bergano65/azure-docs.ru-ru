...
> [!NOTE]
> Ключи, управляемые клиентом, теперь общедоступны во всех регионах, *Кроме* центрального Индии. В **центральном регионе Индии** конфигурация приложений Azure позволяет использовать управляемые клиентом ключи в качестве общедоступной предварительной версии. Предложения общедоступной предварительной версии позволяют клиентам экспериментировать с новыми функциями до официального выпуска.  Общедоступные предварительные версии функций и служб не предназначены для использования в рабочей среде.
