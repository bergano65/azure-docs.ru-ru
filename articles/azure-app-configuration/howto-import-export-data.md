...
1. На вкладке **Импорт** выберите файл конфигурации **исходной службы**  >  **Configuration File**.
...
1. На вкладке **Экспорт** выберите файл конфигурации **целевой службы**  >  **Configuration File**.

1. При необходимости введите **префикс** и выберите **метку** и точку во времени для экспортируемых ключей.

1. Выберите разделитель **типов файлов**  >  **Separator**.
