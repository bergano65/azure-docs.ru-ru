...
1. Создайте назначенное пользователем удостоверение с именем `myUserAssignedIdentity` с помощью интерфейса командной строки.
...
1. Выполните команду [AZ appconfig Identity Assign] , чтобы назначить новое назначенное пользователем удостоверение этому хранилищу конфигураций. Используйте значение свойства `id`, записанное на предыдущем шаге.
