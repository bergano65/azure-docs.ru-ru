...
- Чтение всех параметров из основного хранилища. Обновление только этих параметров в дополнительном хранилище, имеющих соответствующее событие в очереди хранилища. Удалите все параметры из вторичного хранилища, которые присутствовали в очереди хранилища, но не в основном хранилище. Вы можете использовать [пакет SDK для настройки приложений](https://github.com/Azure/AppConfiguration#sdks) для программного доступа к хранилищам конфигурации.
...
Используйте следующую команду или [портал Azure](/azure/storage/common/storage-auth-aad-rbac-portal#assign-rbac-roles-using-the-azure-portal) , чтобы предоставить управляемому удостоверению Azure приложение-функция доступ к вашей очереди хранилища. 
