...
| Команда | Примечания |
|---|---|
| [az appconfig import](/cli/azure/ext/appconfig/appconfig/kv#ext-appconfig-az-appconfig-kv-import) | Импортирует данные в ресурс хранилища конфигураций приложения. |
