...
Чтобы начать работу с этим действием GitHub, перейдите в репозиторий и перейдите на вкладку " **действия** ". Щелкните "создать рабочий процесс", а затем "настроить рабочий процесс самостоятельно". Оттуда выполните поиск по запросу "Синхронизация конфигурации приложений Azure" в Marketplace.
