...
1. После обновления пользовательского интерфейса вы сможете выбрать, какие данные конфигурации следует экспортировать в дополнительное хранилище. Можно оставить значение времени по умолчанию как есть и задать оба значения в поле **Метка** , а **для метки** — одно и то же. Нажмите кнопку **Применить**.
