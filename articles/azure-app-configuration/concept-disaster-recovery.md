---
title: Устойчивость конфигурации приложений Azure и аварийное восстановление
description: Наклоните, как реализовать устойчивость и аварийное восстановление с помощью конфигурации приложений Azure.
author: lisaguthrie
ms.author: lcozzens
...
1. В новом лезвии, открываемом, укажите подписку, группу ресурсов и название ресурса вторичного магазина, затем выберите **Apply.**

1. После обновления пользовательского интерфейса вы сможете выбрать, какие данные конфигурации следует экспортировать в дополнительное хранилище. Вы можете оставить значение времени по умолчанию как есть, и установить как **от метки** и **для обозначения** на то же значение. Нажмите кнопку **Применить**.
