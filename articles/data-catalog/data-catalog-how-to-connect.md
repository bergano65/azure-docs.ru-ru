...
При использовании представления списка меню доступно на панели поиска в верхней части окна портала.
 ...
 ![Открытие отчета об услугах отчетности серверов S'L в отчете Manager](./media/data-catalog-how-to-connect/data-catalog-how-to-connect2.png)
