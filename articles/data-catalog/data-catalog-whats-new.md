...
*   Поддержка более точного управления разрешенными операциями с метаданными, включая следующие:
...
* Поддержка регистрации и обнаружения объектов SQL Server Analysis Services через протокол HTTP или HTTPS. Пользователи теперь могут подключаться к серверам SSAS, используя URL-адрес (например, https:\//servername/olap/msmdpump.dll) вместо сервера имя и можно использовать обычную проверку подлинности и анонимные подключения в дополнение к проверке подлинности Windows. Дополнительные сведения о подключениях к SSAS по протоколу HTTP или HTTPS см. в статье [Настройка HTTP-доступа к службам Analysis Services](https://msdn.microsoft.com/library/gg492140.aspx).
