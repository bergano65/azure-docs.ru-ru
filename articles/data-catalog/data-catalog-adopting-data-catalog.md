...
**Каталог данных Azure** расширяет возможности финансового отдела Adventure Works для совместной работы с основными источниками данных, каждый член группы можно легко находить и использовать данные, они должны и можно поделиться своими знаниями с разработчиками в целом.
