...
* Разработчики данных и бизнес-аналитики и специалисты по аналитике: Пользователи, ответственные за создание содержимого данных и аналитики для использования другими пользователями.
* Администраторы данных: Пользователи, имеющие знания о данных, то, что они означают и как они предназначены для использования.
* Потребители данных: Пользователи, которым необходимо иметь возможность легко находить, понимать и подключаться к данным, необходимым для выполнения их работы, используя любое удобное средство.
* Центральная ИТ: Пользователи, которым необходимо сделать сотни источников данных доступными для бизнес-пользователей, и которым необходимо поддерживать избыточную аналитику использования данных и их сотрудников.
...
Учетные записи пользователей, которым назначена лицензия Power BI Pro, автоматически получают доступ к каталогу данных из-за лицензионного соглашения, когда они подписались на Office 365 с лицензией Power BI Pro. Этот тип пользователя имеет полный доступ к ресурсам каталога данных без прав администратора. Этот тип пользователя *не* является частью роли **пользователя каталога** в каталоге данных Azure.
