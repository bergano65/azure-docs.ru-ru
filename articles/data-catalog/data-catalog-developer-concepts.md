...
<table><tr><td><b>Имя свойства</b></td><td><b>Тип данных</b></td><td><b>Комментарии</b></td></tr><tr><td> timestamp</td><td>DateTime</td><td>Время последнего изменения элемента. Это поле создается сервером при вставке и каждом изменении элемента. Значение этого свойства игнорируется во входных данных операции публикации.</td></tr><tr><td>id</td><td>URI</td><td>Абсолютный URL-адрес элемента (только для чтения). Это уникальный адресуемый URI для элемента.  Значение этого свойства игнорируется во входных данных операции публикации.</td></tr><tr><td>Тип</td><td>Строка</td><td>Тип ресурса (только для чтения).</td></tr><tr><td>etag</td><td>Строка</td><td>Строка, соответствующая версии элемента, которую можно использовать для оптимистического управления параллелизмом при выполнении операций, изменяющих элементы в каталоге. Можно указать "*" для соответствия любому значению.</td></tr></table>
...
<tr><td></td><td>sourceType</td><td>string</td><td>Описывает тип источника данных.  Например:  SQL Server, базы данных Oracle, и т.д.  </td></tr>
...
<tr><td></td><td>authentication</td><td>string</td><td>Необязательный элемент. Схема проверки подлинности, используемая для связи с источником данных. Например, Windows, OAuth и т. д.</td></tr>
