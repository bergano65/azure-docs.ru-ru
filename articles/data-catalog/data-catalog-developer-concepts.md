...
<tr><td>fromSourceSystem</td><td>Логический</td><td>Указывает, являются ли данные элемента производными от исходной системы (например, SQL Server базы данных, Oracle Database) или созданы пользователем.</td></tr>
</table>
...
<tr><td></td><td>address</td><td>&lt;Строка словаря, объект&gt;</td><td>Обязательный. Адрес — это набор данных, относящийся к протоколу. Он используется для определения источника данных, указанного в ссылке. Так как данные адреса относятся к определенному протоколу, это значит, что знать их нет смысла, не зная протокол.</td></tr>
...
<tr><td></td><td>objectId</td><td>Guid</td><td>Удостоверение пользователя или группы безопасности Azure Active Directory. Необязательный элемент. Должен быть указан, если не задан upn, в противном случае необязателен.</td></tr>
...
<tr><td></td><td>макс. </td><td>строка</td><td>Максимальное значение в наборе данных</td></tr>
