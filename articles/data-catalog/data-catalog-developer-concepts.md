...
<table><tr><td><b>Тип ресурса (имя представления)</b></td><td><b>Дополнительные свойства</b></td><td><b>Тип данных</b></td><td><b>Разрешенные заметки</b></td><td><b>Комментарии</b></td></tr><tr><td>Таблица ("tables")</td><td></td><td></td><td>Описание<p>FriendlyName<p>Тег<p>Схема<p>ColumnDescription<p>ColumnTag<p> Эксперт<p>Предварительный просмотр<p>AccessInstruction<p>TableDataProfile<p>ColumnDataProfile<p>ColumnDataClassification<p>Документация<p></td><td>Таблица представляет любые табличные данные.  Пример: Таблица SQL, представление SQL, Analysis Services табличная таблица, Analysis Services Многомерное измерение, таблица Oracle и т. д.   </td></tr><tr><td>Мера ("measures")</td><td></td><td></td><td>Описание<p>FriendlyName<p>Тег<p>Эксперт<p>AccessInstruction<p>Документация<p></td><td>Этот тип представляет измерение Analysis Services.</td></tr><tr><td></td><td>measure</td><td>Столбец</td><td></td><td>Метаданные, описывающие измерение</td></tr><tr><td></td><td>isCalculated </td><td>логический</td><td></td><td>Указывает, вычисляется измерение или нет.</td></tr><tr><td></td><td>measureGroup</td><td>Строковое</td><td></td><td>Физический контейнер для измерения</td></tr><td>Ключевой показатель эффективности ("kpis")</td><td></td><td></td><td>Описание<p>FriendlyName<p>Тег<p>Эксперт<p>AccessInstruction<p>Документация</td><td></td></tr><tr><td></td><td>measureGroup</td><td>Строковое</td><td></td><td>Физический контейнер для измерения</td></tr><tr><td></td><td>goalExpression</td><td>Строковое</td><td></td><td>Числовое выражение MDX или вычисление, которое возвращает целевое значение ключевого показателя эффективности.</td></tr><tr><td></td><td>valueExpression</td><td>Строковое</td><td></td><td>Числовое выражение MDX, которое возвращает фактическое значение ключевого показателя эффективности.</td></tr><tr><td></td><td>statusExpression</td><td>Строковое</td><td></td><td>Выражение MDX, которое отражает состояние ключевого показателя эффективности в заданный момент времени.</td></tr><tr><td></td><td>trendExpression</td><td>Строковое</td><td></td><td>Выражение MDX, которое оценивает значение ключевого индикатора производительности во времени. В качестве тренда может использоваться любой временной критерий, который удобно использовать в заданном бизнес-контексте.</td>
<tr><td>Отчет ("reports")</td><td></td><td></td><td>Описание<p>FriendlyName<p>Тег<p>Эксперт<p>AccessInstruction<p>Документация<p></td><td>Этот тип представляет отчет для служб отчетов SQL Server </td></tr><tr><td></td><td>assetCreatedDate</td><td>Строковое</td><td></td><td></td></tr><tr><td></td><td>assetCreatedBy</td><td>Строковое</td><td></td><td></td></tr><tr><td></td><td>assetModifiedDate</td><td>Строковое</td><td></td><td></td></tr><tr><td></td><td>assetModifiedBy</td><td>Строковое</td><td></td><td></td></tr><tr><td>Контейнер ("containers")</td><td></td><td></td><td>Описание<p>FriendlyName<p>Тег<p>Эксперт<p>AccessInstruction<p>Документация<p></td><td>Этот тип представляет контейнер других ресурсов, таких как база данных SQL, контейнер больших двоичных объектов Azure или модель служб Analysis Services.</td></tr></table>
...
<tr><td></td><td>numberOfRows</td></td><td>ssNoversion</td><td>Количество строк в наборе данных</td></tr>
...
<tr><td></td><td>objectId</td><td>Guid</td><td>Удостоверение AAD для пользователя или группы безопасности. Необязательный. Должен быть указан, если не задан upn, в противном случае необязателен.</td></tr>
<tr><td></td><td>firstName</td><td>строка</td><td>Имя пользователя (для отображения). Необязательный. Допустим только в контексте свойства "lastRegisteredBy". Не может быть указан при предоставлении субъекта безопасности для "roles", "permissions" и "experts".</td></tr>
...
<tr><td></td><td>maxLength</td><td>ssNoversion</td><td>Максимальная длина столбца или атрибута. Определяется по информации из источника данных. Применимо только к некоторым типам источников данных.</td></tr>
...
<tr><td></td><td>nullCount </td><td>ssNoversion</td><td>Число значений null в наборе данных</td></tr>
<tr><td></td><td>distinctCount  </td><td>ssNoversion</td><td>Число различающихся значений в наборе данных</td></tr>
