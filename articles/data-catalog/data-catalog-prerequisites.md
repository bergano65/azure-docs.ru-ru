...
> [!NOTE]
> Пользователи могут входить на [портал Azure](https://portal.azure.com/) с помощью личной учетной записи Майкрософт, а также рабочей или учебной учетной записи Azure Active Directory. Чтобы настроить каталог данных с помощью портала Azure или [портала каталога данных](https://www.azuredatacatalog.com), необходимо войти с помощью учетной записью Azure Active Directory, а не личной учетной записи.
>
>
