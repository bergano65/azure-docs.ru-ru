...
* Документация только по контейнеру: Все содержимое находится в одном месте, но могут отсутствовать необходимые сведения для пользователей принять обоснованное решение.
* Документация только по таблицам: Содержимое относится к этому объекту, но пользователи находятся в нескольких расположениях для документов.
* Документация по контейнерам и таблицам: Комплексный подход, но исключает необходимость дополнительной документов.
