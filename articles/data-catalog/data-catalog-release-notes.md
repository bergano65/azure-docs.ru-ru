...
На дату выпуска этого соединителя Active Directory самый последний [драйвер ODBC Teradata для Windows (вер. 15.10)](https://downloads.teradata.com/download/connectivity/odbc-driver/windows) совместим с Office 2013, но не с Office 2016.
...
**Причина 1. Конфигурация Active Directory Federation Services** средство регистрации источника данных использует проверку подлинности форм для проверки входа пользователя в Active Directory. Для успешного входа в систему администратор Active Directory должен включить проверку подлинности форм в глобальную политику проверки подлинности.
...
**Причина 2. Конфигурация прокси-сервера сети** Если в корпоративной сети используется прокси-сервер, с помощью инструмента регистрации не может быть возможность подключиться к Azure Active Directory через прокси-сервер. Пользователи могут проверить средство регистрации, изменив файл конфигурации средства и добавив в файл этот раздел.
