...
| Теги (теги глоссария) |Теги могут присваиваться на уровне ресурса данных, а также атрибута или столбца. Теги глоссария — это централизованно определенные термины глоссария, которые можно использовать для категоризации атрибутов или ресурсов данных с помощью бизнес-таксономии. Для получения дополнительной информации [см. Как настроить бизнес-глоссарий для управляемых метки](data-catalog-how-to-business-glossary.md) |
