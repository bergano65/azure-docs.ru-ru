...
ms.locfileid: "78379317"
---
::: zone target="docs" 

# <a name="tutorial-copy-data-to-azure-data-box-via-smb"></a>Руководство. копирование данных в Azure Data Box через SMB
...
Пошаговые инструкции см. в разделе [руководство. копирование данных в Azure Data Box через SMB](data-box-deploy-copy-data.md).
...
Пошаговые инструкции см. в [руководстве по копированию данных в Azure Data Box через NFS](data-box-deploy-copy-data-via-nfs.md).
...
Пошаговые инструкции см. в [руководстве копирование данных в Azure Data Box хранилище BLOB-объектов с помощью интерфейсов API](data-box-deploy-copy-data-via-nfs.md).
...
Пошаговые инструкции см. в [разделе Учебник. копирование данных в Azure Data Box с помощью службы копирования данных](data-box-deploy-copy-data-via-copy-service.md).
...
Пошаговые инструкции см. в разделе [учебник. использование Data Box для импорта данных в качестве управляемых дисков в Azure](data-box-deploy-copy-data-from-vhds.md).
