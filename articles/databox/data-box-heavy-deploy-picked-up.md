...
description: Из этого руководства вы узнаете, как вернуть Azure Data Box Heavy, а также о подготовке к отправке, доставке Data Box Heavy, проверке передачи данных и удалении данных с этого устройства.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy
