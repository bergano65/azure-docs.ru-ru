...
2. Если устройство пересылается в США или Европе, воспользуйтесь услугами службы доставки FedEx.

    1. Обратитесь в местное отделение перевозчика, чтобы запланировать отправку.
    2. Свяжитесь со [службой эксплуатации Data Box](mailto:DataBoxOps@microsoft.com), чтобы сообщить об отправке и получить этикетку отгрузки для возврата.
    3. Поместите этикетку отгрузки на передней части устройства и убедитесь, что она хорошо читаема.
