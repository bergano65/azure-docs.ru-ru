...
3. В диалоговом окне **Настроить и запустить** предоставьте следующие данные.
    ...
    |Оптимизация файлов              |Если этот параметр включен, файлы размером до 1 МБ будут упакованы при приеме. Его применение ускоряет копирование данных для небольших файлов. Ощутимая экономия времени наблюдается, если количество файлов значительно превышает количество каталогов.        |
