...
|    Максимальный размер блока большого двоичного объекта                              |    4,75 ТБ (100 МБ х 50 000 блоков)                   |    4,75 ТБ (100 МБ х 50 000 блоков) для Azure Data Box версии 1.7 и более поздних.|
...
Общедоступная предварительная версия (Azure Data Box 1.7 и более поздняя)
...
Для хранилища BLOB-объектов службы Data Box существуют определенные клиентские библиотеки и определенные требования к суффиксу конечной точки.

Поддерживаемые версии REST API для хранилища BLOB-объектов службы Data Box являются 2017-04-17, 2016-05-31, 2015-12-11, 2015-07-08 и 2015-04-05 для Azure Data Box версии 1.7 и более поздние. Конечные точки хранилища BLOB-объектов Data Box не имеют полного соответствия с последней версией REST API службы хранилища BLOB-объектов Azure. Для клиентских библиотек хранилища вам необходимо знать версию, совместимую с REST API.

### <a name="azure-data-box-17-onwards"></a>Azure Data Box версии 1.7 и более поздние
