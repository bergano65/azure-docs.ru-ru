...
2. Вы получили Data Box; состояние заказа на портале **Доставлено**. На устройстве под текущей этикеткой будет транспортная этикетка в прозрачном пакетике. Храните эту этикетку, так как она нужна для возврата устройства.
