...
description: Из этого руководства вы узнаете, как присоединить кабели и подключиться к Azure Data Box Heavy, а также как включить это устройство.
services: databox
author: alkohli
ms.service: databox
ms.subservice: heavy
...
5. В локальном пользовательском веб-интерфейсе отобразится страница **Sign in** (Вход).
    ...
    - Введите пароль администратора устройства, полученный на предыдущем шаге, чтобы войти в устройство. Нажмите кнопку **Войти**.
