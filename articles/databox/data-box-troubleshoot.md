...
В этой статье подробно сведения о том, как устранять неполадки, может появиться при использовании Azure Data Box или Azure Data Box большой. Статья содержит список возможных ошибок при копировании данных в Data Box или при отправке данных из поля данных.

## <a name="error-classes"></a>Классов ошибок

Ошибки в Data Box и интенсивной поле данных можно обобщить следующим образом:

| Ошибка категории *        | Описание        | Рекомендуемое действие    |
|----------------------------------------------|---------|--------------------------------------|
| Имена контейнеров или общей папки | Имена контейнеров или общей папки не выполняйте Azure правила именования.  |Загрузите списки ошибки. <br> Переименование контейнеров или общие папки. [Узнайте больше](#container-or-share-name-errors).  |
| Максимальный размер контейнера или общей папки | Общий объем данных в контейнеры или общих ресурсов превышает ограничение в Azure.   |Загрузите списки ошибки. <br> Уменьшите общую данные в контейнер или общий ресурс. [Узнайте больше](#container-or-share-size-limit-errors).|
| Максимальный размер объекта или файла | Объект или файлы в контейнеры или общих ресурсов превышает ограничение в Azure.|Загрузите списки ошибки. <br> Уменьшите размер файла в контейнер или общий ресурс. [Узнайте больше](#object-or-file-size-limit-errors). |    
| Тип данных или файл | Формат данных или тип файла не поддерживается. |Загрузите списки ошибки. <br> Для страничных BLOB-объектов или управляемые диски убедитесь, что данные — 512 байт выравнивается и скопированы в предварительно созданной папки. [Узнайте больше](#data-or-file-type-errors). |
| Некритические ошибки большого двоичного объекта или файла  | Имена больших двоичных объектов или файл не выполняйте Azure правила именования или тип файла не поддерживается. | Эти BLOB-объектов или файлов не могут быть скопированы или имена могут быть изменены. [Узнайте, как исправить эти ошибки](#non-critical-blob-or-file-errors). |

\* Первый категорий четыре ошибки становятся критическими ошибками и должны быть исправлены, прежде чем перейти к подготовке к отправке.


## <a name="container-or-share-name-errors"></a>Ошибки имен контейнера или общей папки

Это ошибки, связанные с контейнером и сетевые имена.
...
## <a name="container-or-share-size-limit-errors"></a>Контейнер или общий ресурс ошибок ограничение размера

Это ошибки, связанные с данными, превышение объема данных, допустимых в контейнер или общий ресурс.
...
## <a name="object-or-file-size-limit-errors"></a>Объект или файл ошибок ограничение размера

Это ошибки, связанные с данными, превышающие максимальный размер объекта или файла, которые разрешены в Azure. 
...
## <a name="data-or-file-type-errors"></a>Ошибки типа данных или файла

Это ошибки, связанные с типом данных, в контейнер или общий ресурс или неподдерживаемый тип файла. 
...
**Предлагаемое решение.** Переход по символическим ссылкам обычно ссылки, каналы и других таких файлов. Удалить связи, или разрешить ссылки и копирования данных.


## <a name="non-critical-blob-or-file-errors"></a>Некритические ошибки большого двоичного объекта или файла
