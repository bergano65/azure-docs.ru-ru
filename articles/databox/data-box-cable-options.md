...
1. Используйте кабель RJ45 для подключения порта MGMT к серверу с данными.
    ...
    ![Настройка для одного порта](media/data-box-cable-options/cabling-mgmt-only.png)
...
3. На сервере задайте следующие значения:
   ...
   - **Подсеть** : 255.255.255.0.
     ...
     ![Установка с двумя портами](media/data-box-cable-options/cabling-2-port-setup.png)
...
3. Настройте адаптер Ethernet на ноутбуке, который используется для подключения к устройству, указав следующие значения:
   ...
   ![Установка с двумя портами с переключателем](media/data-box-cable-options/cabling-with-static-ip.png)
...
3. Настройте адаптер Ethernet на ноутбуке, который используется для подключения к устройству, указав следующие значения:
   ...
   - **Подсеть** : 255.255.255.0.
     ...
     ![Установка с двумя портами с коммутатором 2](media/data-box-cable-options/cabling-with-switch-static-ip.png)
