...
1. Если вы хотите включить двойное шифрование на основе программного обеспечения, на вкладке **Безопасность** выберите **Enable double encryption for the order** (Включить двойное шифрование для заказа). 
   ...
   ![Экран безопасности для импорта Data Box, двойное шифрование](media/data-box-deploy-export-ordered/azure-data-box-export-05b.png)
...
1. Для **типа экспорта**выберите **использовать XML-файл**. Это ваш XML-файл, указывающий определенные большие двоичные объекты и файлы Azure, которые вы хотите экспортировать. Чтобы добавить XML-файл, выберите **пункт Щелкните здесь, чтобы выбрать XML-файл**.
     ![Снимок экрана с параметром "Выбор экспорта" и щелкните здесь, чтобы выбрать параметр "вызываемый файл" X M L.](media/data-box-deploy-export-ordered/azure-data-box-export-sms-use-xml-file-01.png)

2. Выберите **+ контейнер** , чтобы создать контейнер.
    ![Снимок экрана раздела "контейнеры".](media/data-box-deploy-export-ordered/azure-data-box-export-sms-use-xml-file-02.png)
...
4. Нажмите кнопку **создания**.
   ...
   ![Снимок экрана с сообщением "контейнер хранилища успешно создан".](media/data-box-deploy-export-ordered/azure-data-box-export-sms-use-xml-file-09.png)

5. Выберите созданный контейнер и дважды щелкните его.

   ![Снимок экрана раздела Containers с вызываемым контейнером закрытого контейнера тестов.](media/data-box-deploy-export-ordered/azure-data-box-export-sms-use-xml-file-08.png)
...
6. Если дважды щелкнуть контейнер, откроется представление свойств контейнера. Теперь нужно присоединить (или перейти к) XML-файл, содержащий список больших двоичных объектов и (или) файлов Azure, которые вы хотите экспортировать. Щелкните **Отправить**.
   ...
   ![Снимок экрана диалогового окна "передача большого двоичного объекта" с вызываемым параметром отправки.](media/data-box-deploy-export-ordered/azure-data-box-export-sms-use-xml-file-10c.png)
...
7. Вы успешно добавили XML-файл в контейнер. Будут экспортированы только большие двоичные объекты и файлы Azure, указанные в этом XML.
   ...
   ![Снимок экрана мастера заказов со следующим параметром безопасности "вызываемый".](media/data-box-deploy-export-ordered/azure-data-box-export-sms-use-xml-file-12.png)
