...
6. На странице **Заказ** перейдите на вкладку **Основы** . Введите или выберите следующие сведения и нажмите кнопку **Next: Data destination>** (Далее: назначение данных>).
    ...
    ![Снимок экрана мастера заказов с шагом "Основы", который правильно заполнен.](media/data-box-deploy-ordered/select-data-box-import-06.png)
...
7. На вкладке **Назначение данных** выберите пункт **Назначение данных** .
    ...
    ![Снимок экрана мастера заказов, отображающий шаг назначения данных с правильными сведениями.](media/data-box-deploy-ordered/select-data-box-import-07b.png)
...
11. После возвращения на вкладку **Контактные сведения** добавьте один или несколько адресов электронной почты. Служба отправляет уведомления по электронной почте об обновлениях состояния заказа на указанные адреса электронной почты.
    ...
    ![Снимок экрана раздела электронной почты шага "Контактные сведения" мастера заказов с текстовым полем для электронной почты и вызванным параметром Next: Review and Order (Далее: просмотр и заказ).](media/data-box-deploy-ordered/select-data-box-import-08c.png)
