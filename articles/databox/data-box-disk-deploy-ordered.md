...
6.  В разделе **Заказ** укажите **Сведения о заказе**. Введите или выберите следующие сведения.
    ...
    |Целевое хранилище     | Выберите из учетной записи хранения и/или управляемых дисков. <br> Исходя из заданного региона Azure, выберите учетную запись хранения в отфильтрованном списке существующей учетной записи хранения. Data Box можно связать с 10 учетными записями хранения. <br> Вы также можете создать новую **Учетную запись общего назначения версии 1**, **Учетную запись общего назначения версии 2** или **Учетную запись хранения BLOB-объекта**. <br>Нельзя использовать учетные записи хранения с настроенными правилами. Хранилищу учетных записей должен быть **разрешен доступ из всех сетей** в разделе "Брандмауэры и виртуальные сети".|
