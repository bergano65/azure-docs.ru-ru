...
> - На этапе предварительной версии Диск Data Box может быть доставлен клиентам в США, Западной и Северной Европе, Канаде и Австралии. Дополнительные сведения см. в разделе [Регионы доступности](data-box-disk-overview.md#region-availability).
