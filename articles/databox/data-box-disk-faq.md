...
### <a name="q-will-my-data-box-disk-cross-country-borders-during-shipping"></a>У. Будет ли мой Диск Data Box пересекать границы страны во время доставки?
...
### <a name="q-can-i-specify-the-number-of-data-box-disks-in-the-order"></a>У. Можно ли указать количество дисков Data Box в заказе?
...
### <a name="q-how-do-i-return-the-disks"></a>У. Как вернуть диски? 
...
### <a name="q-what-is-the-data-transfer-speed-for-data-box-disks"></a>У. Какова скорость передачи данных на диски Data Box?
...
### <a name="q-what-is-the-toolset-available-for-my-data-with-data-box-disks"></a>У. Какой набор инструментов доступен при работе с данными с помощью Дисков Data Box?
...
### <a name="q-i-copied-data-to-manageddisk-folder-i-dont-see-any-managed-disks-with-the-resource-group-specified-for-managed-disks-was-my-data-uploaded-to-azure-and-how-can-i-locate-it"></a>У. Данные скопированы в папку ManagedDisk. Но я не вижу управляемых дисков с группой ресурсов, определенной для таких дисков. Отправлены ли мои данные в Azure и как их можно найти?
