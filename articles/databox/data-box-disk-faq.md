...
О.  Сейчас режим предварительной версии Дисков Data Box поддерживается в США, Канаде, Австралии и всех странах ЕС.  
...
О. Набор инструментов, который доступен для работы с Диском Data Box, состоит из трех элементов.
 ...
 - **Средство Split Copy Диска Data Box**. Применяйте этот инструмент при использовании нескольких дисков и при наличии большого набора данных, который нужно разделить и скопировать на все диски. Сейчас это средство доступно для ОС семейства Windows.
