...
Если это было не так, [скачайте журналы диагностики](#download-diagnostic-logs) из системы и [свяжитесь со службой поддержки Майкрософт](data-box-disk-contact-microsoft-support.md).
