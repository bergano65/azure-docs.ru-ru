...
![Безопасность при импорте Data Box](media/data-box-security/data-box-security-2.png)

На следующей схеме показан порядок экспорта Data Box.

![Data Box экспорт безопасности](media/data-box-security/data-box-security-3.png)
