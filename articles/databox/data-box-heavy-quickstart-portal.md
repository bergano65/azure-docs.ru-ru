...
1. Чтобы получить пароль устройства, последовательно выберите **Общие > Сведения об устройстве** на [портале Azure](http://portal.azure.com). Этот же пароль используется для обоих узлов устройства.
