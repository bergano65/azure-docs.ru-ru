...
4. После того как устройство будет подготовлено, можно запланировать его вывоз.
...
6. После того как вы запланировали вывоз устройства, вы можете посмотреть код авторизации устройства на панели **Планирование вывоза для Azure**.
   ...
   Запишите этот **код авторизации**. Согласно требованиям безопасности при планировании вывоза или сдачи устройства необходимо указать имя человека, который будет вывозить или сдавать это устройство.
