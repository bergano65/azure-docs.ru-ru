...
### <a name="verify-connection-and-configure-partner-software"></a>Проверка подключения и настройка партнерского программного обеспечения
...
Выполните шаги для [настройки партнерского программного обеспечения, которые вы выполняли при подключении по протоколу *HTTP*](#verify-connection-and-configure-partner-software). Единственное отличие — не устанавливайте флажок для *использования HTTP*.
