...
| ![Значок предупреждения ](./media/data-box-safety/warning_icon.png) **предупреждение!** |Указывает на опасную ситуацию, которая может привести к смерти или серьезной травме. |
...
![Значок предупреждения ](./media/data-box-safety/warning_icon.png) **предупреждение!**
...
![Значок предупреждения предупреждение ](./media/data-box-safety/warning_icon.png) **:**
