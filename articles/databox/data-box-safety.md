...
| ![Предупреждение](./media/data-box-safety/warning_icon.png) значок **ВНИМАНИЕ!** |Указывает на опасную ситуацию, которая может привести к смерти или серьезной травме. |
...
* Устройство оснащено винтами, защищающими от несанкционированного доступа. Если вы подозреваете, что устройство не работает, [обратитесь в службу поддержки майкрософт,](data-box-disk-contact-microsoft-support.md) чтобы получить замену. Не пытайтесь проводить техническое обслуживание самостоятельно. 
...
![Предупреждение](./media/data-box-safety/warning_icon.png) значок **ВНИМАНИЕ!**
...
![Предупреждение](./media/data-box-safety/warning_icon.png) значок **ПРЕДОСТЕРИЯ:**
...
[Запросить копию Декларации соответствия ЕС](mailto:CSI_Compliance@microsoft.com).
