...
| ![Значок](./media/data-box-safety/warning_icon.png) предупреждения **предупреждение!** |Указывает на опасную ситуацию, которая может привести к смерти или серьезной травме. |
...
![Значок](./media/data-box-safety/warning_icon.png) предупреждения **предупреждение!**
