...
4. После подготовки устройства вы сможете запланировать его вывоз. В заказе на Диск Azure Data Box перейдите в раздел **Обзор** и выберите **Запланировать вывоз**.

   ![Заказ Диска Data Box для вывоза](media\data-box-disk-portal-customer-managed-shipping\data-box-disk-user-pickup-01b.png)

5. Следуйте инструкциям в разделе **Планирование вывоза для Azure**. Прежде чем получить код авторизации, отправьте сообщение на адрес [adbops@microsoft.com](mailto:adbops@microsoft.com), чтобы запланировать вывоз устройств из регионального центра обработки данных.
...
6. Если вы уже запланировали вызов устройств, вы сможете посмотреть код авторизации на панели **Планирование вывоза для Azure**.
   ...
   Согласно требованиям безопасности, при планировании вывоза или сдачи устройства необходимо указать имя лица, которое будет вывозить или сдавать это устройство.

   Также необходимо предоставить сведения о лице, которое прибудет в центр обработки данных за устройством. Вам или вашему контактному лицу необходимо будет предъявить государственное удостоверение личности с фотографией, которое будет проверено в центре обработки данных.

   Кроме того, у лица, забирающего устройство, должен быть **код авторизации**. Код авторизации проверяется в центре обработки данных во время выдачи устройства.
...
11. После сдачи устройства копирование данных будет продолжено. После завершения копирования заказ считается выполненным.
