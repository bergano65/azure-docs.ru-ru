...
Эта статья относится к Azure Data Box, Azure Data Box Heavy и Диск Azure Data Box, которые управляются службой Azure Data Box. Если у вас возникли проблемы со службой Azure Data Box, можно обратиться за помощью в службу технической поддержки. В этой статье описаны следующие операции.
...
4. В колонке **Новый запрос в службу поддержки** щелкните шаг 3 **Контактные данные**. В колонке **Контактные данные** сделайте следующее:
   ...
   2. В **контактной информации**укажите свое имя, адрес электронной почты, необязательный контакт, страну или регион. Выберите **Сохранить изменения контактных данных для будущих запросов на поддержку**.
...
Узнайте, как [устранять проблемы, связанные с Data Box](data-box-troubleshoot.md).
Узнайте, как [устранять проблемы, связанные с хранилищем BLOB-объектов Data Box](data-box-troubleshoot-rest.md).
