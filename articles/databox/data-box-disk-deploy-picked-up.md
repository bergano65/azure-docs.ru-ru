...
Перед началом убедитесь, что выполнены действия, описанные в статье [Учебник. Копирование данных на диск Microsoft Azure Data Box и проверка](data-box-disk-deploy-copy-data.md).
...
2. Чтобы организовать отправку при наличии квитанции, сделайте следующее:
    ...
    2. Если не удается дозвониться на горячую линию, отправку можно организовать по электронной почте, отправив сообщение на адрес [microsoft@rocketparcel.com](mailto:microsoft@rocketparcel.com) и указав *Microsoft Azure Pickup* в теме сообщения и номер запроса на обслуживание в самом сообщении.
...
2. Чтобы запросить отправку, отправьте сообщение в службу поддержки SingPost по электронной почте, используя следующий шаблон с номером отслеживания (номер отслеживания можно найти на этикетке возврата, входящей в комплект поставки).
   ...
   Если возникнут проблемы, обратитесь к Data Box Operations Asia по адресу [adbo@microsoft.com](mailto:adbo@microsoft.com). Укажите имя задания в заголовке субъекта и обнаруженной ошибке.
...
4. Если возникнут проблемы, отправьте на адрес [DL-DC-SHA@oe.21vianet.com](mailto:DL-DC-SHA@oe.21vianet.com) сообщение электронной почты с их описанием, указав имя заказа в строке "Тема:".
...
Если вы используете Диск Data Box в государственной организации США, Японии, Сингапуре, Корее, Соединенном Королевстве, Западной Европе, Австралии, ЮАР или Индии и выбрали параметр самостоятельного управления отгрузкой во время создания заказа, следуйте этим инструкциям.
