...
|Возведение в степень                                                    | 4 встроенных блока питания, которые совместно используются двумя узлами устройства.|
...
| Сетевые интерфейсы на каждом узле                             | 4 сетевых интерфейса на каждом узле <br> MGMT, DATA3 <ul><li> 2 интерфейса 1-GbE </li><li> MGMT используется для управления и первоначальной настройки, не поддерживает настройку пользователем </li><li> DATA3 — это интерфейс данных, поддерживающий настройку пользователем. По умолчанию использует протокол DHCP.</li><li>Интерфейсы 1-GbE можно также настроить в качестве интерфейсов 10-GbE.</li></ul>Интерфейсы данных DATA1, DATA2 <ul><li>2 интерфейса 40-GbE </li><li> Интерфейсы данных DHCP (по умолчанию) или настраиваемые пользователем статические интерфейсы</li>|
