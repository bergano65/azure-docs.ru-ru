...
**Перемещение данных из виртуальной Машины в BLOB-объектов Azure: AzCopy**
...
**Перемещение данных из виртуальной Машины в BLOB-объектов Azure: обозреватель хранилищ Azure**

Отправить данные из локального файла в виртуальной машине можно также с помощью обозревателя хранилищ Azure.

* Чтобы передать данные в контейнер, выберите целевой контейнер и нажмите кнопку **отправить** кнопки.![ Снимок экрана: кнопка отправки в обозревателе хранилищ Azure](./media/vm-do-ten-things/storage-accounts.png)
* Щелкните **...**  справа от **файлы** выберите один или несколько файлов для передачи из файловой системы и нажмите кнопку **отправить** чтобы начать их передачу.![ Снимок экрана: диалоговое окно отправки файлов](./media/vm-do-ten-things/upload-files-to-blob.png)

**Считывание данных из BLOB-объектов Azure: Модуль чтения машинного обучения**
...
**Считывание данных из BLOB-объектов Azure: Python ODBC**
...
**Перемещение данных из виртуальной Машины в озеро данных: Обозреватель Azure Data Lake**
...
**Чтение данных из большого двоичного объекта Azure в озеро данных: U-SQL**
...
**Запросы к данным в Data Lake: U-SQL**
...
**Чтение данных из HDI с помощью машинного обучения: модуль чтения**
