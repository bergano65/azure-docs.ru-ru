...
После запуска Jupyter перейдите в `/notebooks` каталог, например записные книжки, которые предварительно упакованы в DSVM. Теперь вы можете:
