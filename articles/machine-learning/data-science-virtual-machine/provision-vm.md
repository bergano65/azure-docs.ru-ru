...
1. Заполните во вкладке **Основные сведения** следующие сведения:
      ...
      * **Размер**. Этот параметр должен автоматически заполняться размером, подходящим для общих рабочих нагрузок. Дополнительные сведения см. в разделе [Размеры виртуальных машин Windows в Azure](../../virtual-machines/windows/sizes.md).
      * **Имя пользователя**. Введите имя администратора. Это имя пользователя, которое будет использоваться для входа в виртуальную машину. Оно не должно совпадать с именем пользователя Azure.
