---
title: 'Справочник: CentOS Data научные виртуальные машины'
...
В DSVM включены некоторые инструменты и алгоритмы машинного обучения, которые были предварительно скомпилированы и установлены локально. К ним относятся следующие объекты.
...
Rattle (*R* *A*налитикал *t*ул *t*o *L*заработать *E*асили) использует просмотр и моделирование данных на основе графического пользовательского интерфейса. Задачи Rattle:
