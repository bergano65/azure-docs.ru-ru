...
* [**Linux Data Science Виртуальная машина**](https://azure.microsoft.com/marketplace/partners/microsoft-ads/linux-data-science-vm). Для получения информации о подготовке виртуальной машины, [см.](linux-dsvm-intro.md)
...
* Для более плавного прокрутки, в веб-браузере Firefox DSVM, переключать `gfx.xrender.enabled` флаг в `about:config`. Ознакомьтесь с [дополнительными сведениями](https://www.reddit.com/r/firefox/comments/4nfmvp/ff_47_unbearable_slow_over_remote_x11/). Также рассмотреть `False`вопрос об установке `mousewheel.enable_pixel_scrolling` . Ознакомьтесь с [дополнительными сведениями](https://support.mozilla.org/questions/981140).
