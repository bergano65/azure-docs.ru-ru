...
description: Узнайте о средствах приема данных и служебных программах, предустановленных на Виртуальной машине для обработки и анализа данных.
...
Один из первых технических шагов в проекте обработки и анализа данных или AI — это определение наборов данных, которые будут использоваться, и их добавление в среду аналитики. Виртуальная машина для обработки и анализа данных (DSVM) предоставляет средства и библиотеки для переноса данных из разных источников в локальное хранилище аналитических данных на DSVM или в платформе данных в облаке или локальной среде. 
