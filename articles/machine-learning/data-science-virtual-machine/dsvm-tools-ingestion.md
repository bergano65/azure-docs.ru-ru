...
Один из первых технических шагов в проекте обработки и анализа данных или AI — это определение наборов данных, которые будут использоваться, и их добавление в среду аналитики. Виртуальная машина обработки и анализа данных (DSVM) предоставляет средства и библиотеки для добавления данных из различных источников в хранилище аналитических данных в DSVM или на платформе данных в облаке или локально. 
