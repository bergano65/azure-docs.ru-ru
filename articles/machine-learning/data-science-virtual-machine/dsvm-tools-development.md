...
description: Узнайте о средствах и интегрированных средах разработки, предустановленных на Виртуальной машине для обработки и анализа данных.
...
| Дополнительные средства на виртуальной машине для обработки и анализа данных      |     Visual Studio 2019, RStudio, Juno  |
...
| Распространенные способы применения      |  Разработка на языке R     |
| Запуск и использование      | Включите службу с помощью _systemctl enable rstudio-server_, а затем запустите службу с помощью _systemctl start rstudio-server_. Затем можно войти на сервер RStudio по адресу http:\//йоур-ВМ-ИП: 8787.       |
| Дополнительные средства на виртуальной машине для обработки и анализа данных      |   Visual Studio 2019, Visual Studio Code, RStudio Desktop      |
...
| Дополнительные средства на виртуальной машине для обработки и анализа данных      |   Visual Studio 2019, Visual Studio Code, RStudio      |
