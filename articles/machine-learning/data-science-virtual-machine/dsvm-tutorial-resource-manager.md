...
1. Тип проверки подлинности, который вы хотите использовать (введите строку `password` или `sshPublicKey`)
...
1. Вход 
1. Используйте группу ресурсов, созданную ранее
...
В этом кратком руководстве вы создали виртуальную машину для обработки и анализа данных из шаблона Azure Resource Manager. 
