...
В этой статье рассматриваются возможности Виртуальной машины для обработки и анализа данных. В ней описывается несколько основных сценариев использования этой виртуальной машины и перечисляются ключевые функции, доступные в версиях для Windows и Linux. Статья также содержит инструкции о том, как начать их использовать.
