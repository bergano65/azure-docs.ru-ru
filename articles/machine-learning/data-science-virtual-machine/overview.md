...
Виртуальная машина для анализа и обработки данных разработана и настроена для работы в широком ряде сценариев использования. Среду можно масштабировать по мере измерения требований проекта. Кроме того, вы можете использовать любой предпочитаемый язык программирования задач обработки и анализа данных и устанавливать другие средства, чтобы настроить систему в соответствии со своими требованиями.
