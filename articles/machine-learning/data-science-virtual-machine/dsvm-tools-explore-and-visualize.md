...
Ключевым шагом в обработке и анализе данных является их понимание. Средства визуализации и исследования данных позволяют ускорить этот процесс. Ниже описаны некоторые средства, предоставляемые на виртуальной машине для обработки и анализа данных, которые упрощают выполнение этого шага. 
