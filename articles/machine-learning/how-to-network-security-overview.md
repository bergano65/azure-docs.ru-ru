...
- Частная ссылка на рабочую область доступна только в следующих регионах: eastus, westus2, southcentralus
...
- Некоторые функции Studio, такие как конструктор, Аутомл, метки и профилирование данных, нельзя использовать с учетными записями хранения, настроенными для использования частной конечной точки. Если вам необходимо использовать эти функции Studio, используйте вместо них конечные точки службы.
