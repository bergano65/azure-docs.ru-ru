...
description: Используйте модуль перекрестной проверки модели в конструкторе Машинное обучение Azure для перекрестной проверки оценок параметров для моделей классификации или регрессии.
