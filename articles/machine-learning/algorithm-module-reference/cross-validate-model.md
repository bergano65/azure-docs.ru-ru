...
7. Описание отчетов см. в разделе [результатов](#results) .
    ...
    Чтобы получить копию модели для повторного использования, перейдите на вкладку **выходные данные** в правой панели модуля, в котором содержится алгоритм (например, на **компьютере с двумя классами Байеса**). Затем щелкните значок **зарегистрировать набор данных** , чтобы сохранить копию обученной модели в дереве модулей.
