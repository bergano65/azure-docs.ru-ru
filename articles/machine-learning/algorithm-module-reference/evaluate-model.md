...
При оценке моделей классификации предоставляются следующие метрики.
...
-   Оценки в столбце **Максимальное расстояние до центра кластера** представляет сумму расстояний между каждой точкой и центроидом кластера этого пункта.  
...
Ознакомьтесь с [набором модулей, доступных](module-reference.md) службе Машинного обучения Azure. 
