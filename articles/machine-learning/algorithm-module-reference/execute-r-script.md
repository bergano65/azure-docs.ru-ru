...
После успешной отправки конвейера можно просмотреть изображение на правой панели модуля ![отправленного образа](media/module/upload-image-in-r-script.png)
...
![Модуль R-Module](media/module/upload-image-in-r-script.png)
