...
С помощью R можно выполнять задачи, которые в настоящее время не поддерживаются существующими модулями, например: 
...
Модуль выполнения R Script modules может возвращать несколько выходов, но они должны быть представлены в виде кадров данных R. Данные автоматически преобразуются в наборы данных в конструкторе для совместимости с другими модулями.
...
1. Убедитесь, что сжатый файл доступен в списке **Мои наборы данных** в категории **наборы данных** в левом дереве модулей.
