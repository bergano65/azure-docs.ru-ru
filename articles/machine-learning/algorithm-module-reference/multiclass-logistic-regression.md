...
description: Узнайте, как использовать модуль логистической регрессии с несколькими классами в конструкторе Машинное обучение Azure для прогнозирования нескольких значений.
