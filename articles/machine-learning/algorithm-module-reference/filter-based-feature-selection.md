...
> [!IMPORTANT]
> Если вы собираетесь использовать **Выбор компонентов на основе фильтров** в выводе, необходимо использовать [Преобразование выбор столбцов](./select-columns-transform.md) для хранения выбранного результата компонента и [Применить преобразование](./apply-transformation.md) , чтобы применить выбранное преобразование к набору данных оценки.
>
> Чтобы выполнить построение конвейера, ознакомьтесь со следующим снимком экрана и убедитесь, что для процесса оценки выбраны одинаковые столбцы.
