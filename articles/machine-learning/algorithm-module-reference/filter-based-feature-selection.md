...
-   **Корреляция Пирсона**  
    ...
    Статистика корреляции Пирсона или коэффициент корреляции Пирсона также известны в статистических моделях как значение `r`. Для двух любых переменных он возвращает значение, показывающее степень корреляции.
