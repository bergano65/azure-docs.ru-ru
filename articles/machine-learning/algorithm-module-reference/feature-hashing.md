...
description: Узнайте, как использовать модуль хэширования функций в службе Машинное обучение Azure для создание признаков текстовых данных.
...
1.  Добавьте модуль хэширования компонентов к эксперименту в визуальном интерфейсе.
...
Оптимальный набор методов предварительной обработки, применяемых в любом решении, зависит от домена, словаря и потребности бизнеса. Поэкспериментируйте с данными, чтобы узнать, какие методы обработки текста наиболее эффективны.
