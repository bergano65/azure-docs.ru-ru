...
---
# <a name="pca-based-anomaly-detection-module"></a>Модуль обнаружения аномалий на основе PCA

В этой статье описывается использование модуля обнаружения аномалий на основе PCA в Машинное обучение Azure Designer для создания модели обнаружения аномалий на основе анализа основных компонентов (PCA).
...
## <a name="how-to-configure-pca-based-anomaly-detection"></a>Настройка обнаружения аномалий на основе PCA
