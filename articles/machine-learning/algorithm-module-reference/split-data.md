...
Первый результирующий набор данных содержит все строки, в которых столбец индекса начинается с одного из следующих `a`символов `b`: `c`, `d`, `e`, `f`,,. Все остальные строки направляются на второй выход.
