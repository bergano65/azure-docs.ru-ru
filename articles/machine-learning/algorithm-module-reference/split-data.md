...
В этом примере выполняется поиск указанной строки в любой из позиций во втором столбце набора данных. Позиция обозначается значением индекса, равного 1. Соответствие учитывает регистр символов.
