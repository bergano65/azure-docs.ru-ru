---
title: 'Разделение данных: Справочник по модулям'
titleSuffix: Azure Machine Learning service
description: Узнайте, как использовать модуль Split Data (разделение данных) в службе Машинное обучение Azure, чтобы разделить набор данных на два разных набора.
...
1. Добавьте модуль **Split Data (разделение данных** ) к эксперименту в интерфейсе. Этот модуль можно найти в разделе " **Преобразование данных**" в категории " **пример и разделение** ".

2. **Режим разделения**: Выберите один из следующих режимов в зависимости от типа данных и способа его разделения. Каждый режим разделения имеет различные параметры. Подробные инструкции и примеры см. в следующих разделах. 
...
5.  **Случайное начальное значение**: Введите неотрицательное целочисленное значение, чтобы инициализировать псевдослучайное последовательность экземпляров для использования. Это начальное значение по умолчанию используется во всех модулях, создающих случайные числа. 
...
6. **Разделение стратифицированной**: Установите для этого параметра **значение true** , чтобы два выходных набора данных содержали репрезентативную выборку значений в *столбце Strata* или *соотношением Key*. 
...
1.  Добавьте модуль [Split Data (разделение данных](./split-data.md) ) в эксперимент и подключите его как входные данные для набора данных, который необходимо разделить.  
