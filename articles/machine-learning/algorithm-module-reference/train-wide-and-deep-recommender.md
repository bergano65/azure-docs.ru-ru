...
|мовиеид|Заголовок|Исходный язык|Жанров|Год|
|-------------|-------------|-------------------|-----------|---------------|
...
7.  **Измерение перекрестной функции**: введите измерение перекрестных идентификаторов пользователей и идентификаторов элементов. 
