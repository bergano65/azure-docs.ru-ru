---
title: 'Нормализовать данные: Справочник по модулям'
titleSuffix: Azure Machine Learning service
description: Узнайте, как использовать модуль нормализации данных в службе Машинное обучение Azure для преобразования набора данных с помощью *нормализации*.
...
Используйте этот модуль для преобразования набора данных спомощью нормализации.
...
- Если необходимо повторить эксперимент или применить те же шаги нормализации к другим данным, можно сохранить эти шаги как преобразование нормализации и применить их к другим наборам данных, имеющим одну и ту же схему.
...
1. Добавьте модуль **нормализация данных** в эксперимент. Модуль можно найти в Машинное обучение Azure, в разделе **Преобразование данных**в категории **масштаб и уменьшить** .
...
5. В раскрывающемся списке **метод преобразования** выберите одну математическую функцию, применяемую ко всем выбранным столбцам. 
    ...
    - **Логистика**: Значения в столбце преобразуются с использованием следующей формулы:
    ...
    - **Логарифмическое**: Этот параметр преобразует все значения в логарифмическое нормальное масштабирование.
...
6. Запустите эксперимент или дважды щелкните модуль **нормализация данных** и выберите пункт **Выполнить выбранное**. 
