---
title: 'Объединение данных: Справочник по модулям'
...
1. Добавьте наборы данных, которые необходимо объединить, а затем перетащите модуль **присоединить данные** в свой эксперимент. 
...
1. Раскрывающийся список **тип объединения** используется для указания способа объединения наборов данных.  
    ...
    * **Левая половина объединения**: *Левое соединение* возвращает только значения из левой таблицы, если значения ключевых столбцов совпадают.  
...
1. Запустите эксперимент или выберите модуль присоединить данные и выбранный **Запуск** , чтобы выполнить соединение.

1. Чтобы просмотреть результаты, щелкните правой кнопкой мыши**набор данных** > результаты **объединения данных** > .
