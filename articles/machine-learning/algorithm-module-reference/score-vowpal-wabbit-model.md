...
ms.locfileid: "85857761"
---
# <a name="score-vowpal-wabbit-model"></a>Оценка модели Vowpal Wabbit
В этой статье описывается использование модуля **Vowpal Wabbit Model** в машинное обучение Azure Designer (Предварительная версия) для создания оценки набора входных данных с использованием существующей обученной модели Vowpal Wabbit.  
