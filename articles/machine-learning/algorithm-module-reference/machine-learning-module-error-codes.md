...
## <a name="error-0100"></a>Ошибка 0100  
 ...
 Эта ошибка в машинном обучении Azure возникает при создании пользовательского модуля и свойство имени **языка** элемент в XML-файла определения пользовательского модуля имеет недопустимое значение. В настоящее время является единственным допустимым значением для этого свойства `R`. Например:   
