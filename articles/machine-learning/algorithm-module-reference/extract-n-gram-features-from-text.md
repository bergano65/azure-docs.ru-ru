...
В этой статье описывается модуль в Машинное обучение Azure Designer (Предварительная версия). Используйте функции извлечь N-граммы из текстового модуля, чтобы *Создание признаков* неструктурированные текстовые данные. 
...
Этот набор данных можно обновить вручную, но могут возникнуть ошибки. Например:
