...
4.  В поле **столбец метки**щелкните **изменить столбец** в правой панели окна модуль и выберите один столбец, содержащий результаты, которые модель может использовать для обучения.
