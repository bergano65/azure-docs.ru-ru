...
-  [https://research.microsoft.com/apps/pubs/default.aspx?id=132652](https://research.microsoft.com/apps/pubs/default.aspx?id=132652)  
    ...
    Обзор Microsoft Research: от Ранкнет до Ламбдаранк до Ламбдамарт: Общие сведения. По J.C. Буржес.
...
+ Чтобы сохранить моментальный снимок обученной модели, щелкните правой кнопкой мыши выходные данные **обученной модели** модуля "обучение" и выберите **Сохранить как**. Копия обученной модели, которую вы сохраняете, не обновляется при последующих выполнениях конвейера.
