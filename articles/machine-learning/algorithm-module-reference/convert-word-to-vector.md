...
В следующем примере показано, как работает модуль преобразование слова в вектор Vector. Он применяет этот модуль с параметрами по умолчанию к предварительно обработанному набору данных Википедии SP 500, предоставленному в Машинное обучение Azure.
