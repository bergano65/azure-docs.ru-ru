...
description: Узнайте, как использовать модуль нейронной сети с несколькими классами в Машинное обучение Azure конструкторе для прогнозирования целевого объекта с многоклассными значениями.
