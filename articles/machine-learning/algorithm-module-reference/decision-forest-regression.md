...
1. Добавьте модуль **регрессии леса решений** в конвейер. Модуль можно найти в интерфейсе в разделе **машинное обучение**, **Инициализация модели**и **регрессия**.
...
+ Чтобы сохранить моментальный снимок обученной модели, щелкните правой кнопкой мыши выходные данные модуля обучения и выберите команду **Сохранить как обученную модель**. Эта копия модели не обновляется при последующих выполнениях конвейера. 
