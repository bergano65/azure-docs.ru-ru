...
В этой статье описывается, как использовать модуль "Оценка рекомендаций" в конструкторе Машинное обучение Azure. Целью является измерение точности прогнозов, выполненных моделью рекомендаций. С помощью этого модуля можно оценивать различные виды рекомендаций:  
