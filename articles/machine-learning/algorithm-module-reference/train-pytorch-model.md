...
| ------------- | ---------------- | ------- | ------- | ---------------------------------------- |
| Эпох        | > 0               | Тип Integer | 5       | Выберите столбец, который содержит столбец метки или столбец результата |
| Размер пакета    | > 0               | Тип Integer | 16      | Количество экземпляров для обучения в пакете   |
...
| Терпение      | > 0               | Тип Integer | 3       | Количество эпох для раннего завершения обучения   |
