...
4.  Нажмите клавишу ВВОД после каждой строки, чтобы начать новую строку.      
     ...
     Если нажать клавишу ВВОД несколько раз, чтобы добавить несколько пустых конечных строк, пустые строки будут удалены.  
  
     Если вы создаете строки с отсутствующими значениями, их всегда можно отфильтровать позже.  
  
5.  Подключите выходной порт к другим модулям и запустите конвейер.  
