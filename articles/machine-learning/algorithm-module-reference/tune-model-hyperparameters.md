...
+ Чтобы просмотреть результаты очистки, щелкните модуль правой кнопкой мыши и выберите команду **визуализировать**.

    Выходные данные включают все метрики степени и точности параметров, применяемые к типу модели, но метрика, выбранная для ранжирования, определяет, какая модель считается наилучшей.
