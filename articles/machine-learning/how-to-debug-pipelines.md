...
description: Отладка конвейеров Машинное обучение Azure в Python. Ознакомьтесь с распространенными ошибками и советами по отладке сценариев до и во время удаленного выполнения.
