...
1. Рядом с пунктом **Отправить**выберите новый раскрывающийся список **создать конвейер вывода**.
...
1. Нажмите кнопку **Отправить** , чтобы создать ручной запуск конвейера.
...
1. Нажмите кнопку **Отправить** , чтобы запустить конвейер.
...
Следуйте указаниям в [учебнике](tutorial-designer-automobile-price-train-score.md) по конструктору, чтобы обучить и развернуть модель регрессии.
''