---
title: Руководство. первой модели машинного обучения с R
...
ms.locfileid: "75532457"
---
# <a name="tutorial-train-and-deploy-your-first-model-in-r-with-azure-machine-learning"></a>Руководство. Обучение и развертывание первой модели в R с помощью службы машинного обучения Azure
...
1. Откройте папку **vignettes**.

1. Выберите папку **"..."** справа от папки **train-and-deploy-to-aci**, а затем выберите **Клонировать**.

    ![Клонирование папки](media/tutorial-1st-r-experiment/clone-folder.png)

1. В списке папок отображается каждый пользователь, обращающийся к рабочей области.  Выберите свою папку для клонирования папки **train-and-deploy-to-aci**.
...
1. В RStudio папка **train-and-deploy-to-aci** располагается на несколько уровней ниже, чем папка **Users** в разделе **Файлы** в правом нижнем углу.  Выберите папку **train-and-deploy-to-aci**, чтобы найти файлы, необходимые для работы с этим учебником.
