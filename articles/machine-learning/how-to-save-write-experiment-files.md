...
Машинное обучение Azure запускает скрипты обучения, копируя всю папку скрипта в целевой контекст вычислений, а затем создает моментальный снимок. Максимальный размер хранилища для моментальных снимков экспериментов составляет 300 МБ или 2000 файлов.
