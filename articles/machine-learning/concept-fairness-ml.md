---
title: Оценка и устранение проблем с равноправием в моделях машинного обучения
...
ms.locfileid: "85611787"
---
# <a name="build-fairer-machine-learning-models"></a>Создание моделей машинного обучения для налево
