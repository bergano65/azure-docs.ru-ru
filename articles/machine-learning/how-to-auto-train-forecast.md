...
## <a name="time-series-and-deep-learning-models"></a>Временные ряды и модели глубокого обучения
...
+ Пророк (Предварительный просмотр)
+ Авто-АРИМА (Предварительный просмотр)
+ ForecastTCN (Предварительный просмотр)
...
Учитывая более крупные данные, модели глубокого обучения, такие как Microsoft ForecastTCN, могут улучшить оценки полученной модели. Узнайте, как [настроить эксперимент для глубокого обучения.](#configure-a-dnn-enable-forecasting-experiment)
...
Кроме того, вы `Enable deep learning` можете выбрать опцию в студии.
