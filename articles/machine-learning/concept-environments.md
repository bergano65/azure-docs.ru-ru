...
`Environment` Объект можно использовать в локальном вычислении для выполнения следующих действий.
...
>[!IMPORTANT]
> Например ```numpy```, при создании среды с незакрепленной зависимостью пакета эта среда будет использовать версию пакета, установленную _во время создания среды_. Кроме того, любая будущая среда с соответствующим определением будет использовать старую версию. 
