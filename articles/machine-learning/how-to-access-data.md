...
**Для неподдерживаемых решений для хранения**данных и для сохранения затрат на исходящие данные во время экспериментов в машинном [коде перенесите данные](#move) в поддерживаемое решение службы хранилища Azure.  Хранилища данных можно создавать на основе [этих решений службы хранилища Azure](#matrix). 
...
> [!IMPORTANT]
> Если вы планируете создать хранилище данных для учетных записей хранения, которые находятся в виртуальной сети, см. раздел [доступ к данным в виртуальной сети](#access-data-in-a-virtual-network) .
