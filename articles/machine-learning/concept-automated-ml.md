...
## <a name="the-studio-vs-sdk"></a>Пакет SDK для Visual Studio

Сведения о четности и различиях между высокоуровневая автоматизированными возможностями ML, доступными в пакете SDK для Python и в студии в Машинное обучение Azure. 
