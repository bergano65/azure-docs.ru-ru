...
- [Интеграция со службой "Сетка событий Azure](concept-event-grid-integration.md) " позволяет работать с событиями в жизненном ЦИКЛе машинного обучения. Например, события регистрации модели, развертывания, смещения данных и обучения (запуск).
