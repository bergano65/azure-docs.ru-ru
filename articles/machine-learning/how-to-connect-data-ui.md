...
Сведения о первом интерфейсе кода см. в следующих статьях, посвященных использованию [пакета SDK для машинное обучение Azure Python](https://docs.microsoft.com/python/api/overview/azure/ml/?view=azure-ml-py) для:
