...
Машинное обучение Azure отслеживает ход выполнения и поддерживает очередь незавершенных задач с метками.

Вы можете запускать и прекращать работу проекта, а также отслеживать ход выполнения меток. Вы можете экспортировать помеченные данные в формате COCO или набора данных Машинного обучения Azure.
...
Проекты добавления меток администрируются в Машинном обучении Azure. Используйте страницу **проекты с метками** для управления проектами.
