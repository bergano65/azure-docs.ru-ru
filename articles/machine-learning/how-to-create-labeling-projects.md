...
Машинное обучение Azure отслеживает ход выполнения задач маркировки и обрабатывает очереди незавершенных задач.

Вы можете запускать и останавливать проект, а также отслеживать ход выполнения маркировки. Вы можете экспортировать помеченные данные в формате COCO или набора данных Машинного обучения Azure.
...
Вы можете напрямую пометить данные на странице **Сведения о проекте**, выбрав действие **Пометить данные**.
...
1. В меню слева выберите пункт **Классы меток**.
1. В верхней части списка выберите **+ Добавление метки** ![Добавить метку](media/how-to-create-labeling-projects/add-label.png).
...
* [Руководство по созданию проекта маркировки классификации изображений](tutorial-labeling.md).
