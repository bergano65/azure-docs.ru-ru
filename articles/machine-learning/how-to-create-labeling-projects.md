...
> [!Important]
> Образы данных должны быть доступны в хранилище данных BLOB-объектов Azure. (Если у вас нет хранилища данных, вы можете отправлять образы при создании проекта.)
...
* Выберите тип **Сегментация экземпляра (многоугольник) (предварительная версия)** для проекта, если вам нужно присвоить метку и нарисовать многоугольник вокруг каждого объекта на изображении.

> [!IMPORTANT]
> Тип "Сегментация экземпляра (многоугольник)" предоставляется в общедоступной предварительной версии.
