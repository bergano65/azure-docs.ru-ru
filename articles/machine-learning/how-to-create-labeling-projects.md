...
:::image type="content" source="media/how-to-create-labeling-projects/labeling-dashboard.png" alt-text="Мастер создания проекта маркировки" приводятся ссылки на каждый из этапов машинного обучения.
