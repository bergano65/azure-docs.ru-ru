...
|Возможность полной настройки|Широкая поддержка типов виртуальных машин Azure, включая GPU и устойчивую настройку низкого уровня, например установку пакетов и драйверов, делает более сложными сценарии. |
