...
Для обучения модели производственного уровня используйте [машинное обучение Azure COMPUTE кластер](how-to-create-attach-compute-sdk.md#amlcompute) с возможностями масштабирования с несколькими узлами. Для развертывания модели производственного класса используйте [кластер службы Azure Kubernetes](how-to-deploy-azure-kubernetes-service.md).
...
Экземпляры вычислений можно использовать в качестве [целевого объекта вычислений для обучения](concept-compute-target.md#train) , аналогичного машинное обучение Azureных кластерных кластерах. 
