...
| Компонент | Состояние общедоступного облака  | US-Виргиния | US-то| 
|----------------------------------------------------------------------------|:----------------------:|:--------------------:|:-------------:|
...
| Создание, запуск, Визуализация и публикация конвейеров в конструкторе машинного обучения Azure          | Общедоступная предварительная версия   | YES       | Недоступно        |
| Интеграция Azure Databricks с конвейером машинного обучения                             | GA               | NO        | Недоступно        |
| Создание конечных точек конвейера в конструкторе машинного обучения Azure                             | Общедоступная предварительная версия   | YES       | Недоступно        |
| **Интегрированные записные книжки** |   | | |
