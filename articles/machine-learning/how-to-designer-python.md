...
1. Запишите используемый порт ввода. Конструктор назначает для переменной левый входной порт `dataset1` а также средний входной порт для `dataset2`. 
