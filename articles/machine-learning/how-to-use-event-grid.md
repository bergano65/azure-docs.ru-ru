...
Служба " [Сетка событий Azure](https://docs.microsoft.com/azure/event-grid/) " поддерживает события машинное обучение Azure. Например, можно использовать события завершения выполнения, регистрации модели, развертывания модели и обнаружения отклонения данных в рабочей области.
