...
Чтобы отразить эту функцию затрат, создайте новый набор данных. В этом новом наборе данных каждый пример высокого риска реплицируется пять раз. При этом число примеров низкого риска не изменяется. Перед репликацией разбейте данные на наборы данных для обучения и тестирования, чтобы предотвратить дублирование строк в двух наборах.
