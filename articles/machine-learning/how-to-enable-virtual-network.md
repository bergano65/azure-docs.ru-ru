...
> * Если учетные записи хранения Azure для рабочей области также защищены в виртуальной сети, они должны находиться в той же виртуальной сети, что и Машинное обучение Azure вычислительного экземпляра или кластера. При создании вычислительного экземпляра в той же виртуальной сети необходимо отключить учетные записи хранения из виртуальной сети, создать вычислительный экземпляр в виртуальной сети, а затем присоединить учетные записи хранения к виртуальной сети.
