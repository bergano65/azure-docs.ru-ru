...
1. Чтобы подключить рабочую область к виртуальной сети, [включите функцию "Частная связь Azure](how-to-configure-private-link.md)". Сейчас эта возможность доступна в предварительной версии. он доступен в регионах Восточная часть США и Западная часть США 2.
