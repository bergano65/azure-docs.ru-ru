...
Чтобы использовать RBAC, добавьте управляемое удостоверение рабочей области в роль [читателя данных BLOB](../role-based-access-control/built-in-roles.md#storage-blob-data-reader) . Дополнительные сведения см. в статье [Управление доступом на основе ролей в Azure (Azure RBAC)](../storage/blobs/data-lake-storage-access-control.md#role-based-access-control).
...
#### <a name="enable-private-ip"></a>Включить частный IP-адрес
