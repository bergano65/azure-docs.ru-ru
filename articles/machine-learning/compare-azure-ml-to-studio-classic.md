...
|---| --- | --- |
| Интерфейс перетаскивания | Поддерживается | Поддерживается: [конструктор службы "Машинное обучение Azure" (предварительная версия)](concept-designer.md) | 
