...
Дополнительные сведения об управляемых удостоверениях для ресурсов Azure см. [в этой статье](../active-directory/managed-identities-azure-resources/overview.md).
