...
|---|---|---|---|
|Клавиши|Ключи являются статическими и не нуждаются в обновлении. Ключи можно создать повторно вручную.|По умолчанию отключено| По умолчанию включено|
