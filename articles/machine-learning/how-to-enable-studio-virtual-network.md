...
Использование управляемого удостоверения для доступа к службам хранилища влияет на некоторые аспекты безопасности. В этом разделе описаны изменения для каждого типа учетной записи хранения.
