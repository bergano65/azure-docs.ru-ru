...
Каждая Машинное обучение Azure Рабочая область поставляется с двумя учетными записями хранения по умолчанию, которые определяются при создании рабочей области. Studio использует учетные записи хранения по умолчанию для хранения экспериментов и артефактов модели, которые важны для определенных функций в студии.
