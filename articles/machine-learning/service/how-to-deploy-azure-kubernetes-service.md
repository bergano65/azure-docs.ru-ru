...
>
> Если задано `cluster_purpose = AksCompute.ClusterPurpose.DEV_TEST`значение, кластеру не требуется 12 виртуальных ЦП. Однако кластер, настроенный для разработки и тестирования, не подходит для трафика уровня рабочей среды и может увеличить время вывода.
