...
[![проверки подлинности в Машинное обучение Azure](./media/enterprise-readiness/authentication.png)](./media/enterprise-readiness/authentication-expanded.png)
...
|Метод проверки подлинности|Экземпляры контейнеров Azure|AKS|
|---|---|---|
...
Чтобы включить проверку подлинности ключей, используйте параметр `auth_enabled` при создании или обновлении развертывания.
...
[Рабочий процесс создания рабочей области ![](./media/enterprise-readiness/create-workspace.png)](./media/enterprise-readiness/create-workspace-expanded.png)
...
[Рабочий процесс создания моментального снимка кода ![](./media/enterprise-readiness/code-snapshot.png)](./media/enterprise-readiness/code-snapshot-expanded.png)
