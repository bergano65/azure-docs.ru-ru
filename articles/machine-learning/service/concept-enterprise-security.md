...
Служба машинное обучение Azure создает дополнительное приложение (имя начинается с `aml-`) с доступом на уровне участника в подписке для каждого региона рабочей области. Например, если у вас есть одна рабочая область в восточной части США и другая рабочая область в Северной Европе в той же подписке, вы увидите два из этих приложений. Эти приложения позволяют службе Машинное обучение Azure, помогающей управлять ресурсами вычислений.
