...
|Целевой объект вычислений для обучения| Ускорение GPU | Автоматическая регистрация.<br/> Настройка гиперпараметров | Автоматическая регистрация.</br> машинное обучение; | Конвейеры Машинного обучение Azure |
|----|:----:|:----:|:----:|:----:|
