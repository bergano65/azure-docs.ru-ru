...
Вы можете создать целевой объект вычислений и управлять им с помощью Машинное обучение Azure пакета SDK, портал Azure, целевой страницы рабочей области (Предварительная версия), Azure CLI или Машинное обучение Azure VS Code. Если у вас есть целевые объекты вычислений, созданные другой службой (например, кластером HDInsight), вы можете подключить их к своей рабочей области Службы машинного обучения Azure.
