...
|Обучение &nbsp;целевых объектов| Поддержка GPU |Автоматическое Машинное обучение | Конвейеры Машинного обучения | Графический интерфейс
|----|:----:|:----:|:----:|:----:|
|[Локальный компьютер](#local)| Возможно | Да | &nbsp; | &nbsp; |
|[Вычислительная среда Машинного обучения Azure](#amlcompute)| Да | Да & <br/>гиперпараметров&nbsp;помощник по настройке | Да | Да |
|[Удаленная виртуальная машина](#vm) |Да | Да & <br/>Настройка гиперпараметров | Да | &nbsp; |
|[Azure&nbsp;Databricks](how-to-create-your-first-pipeline.md#databricks)| &nbsp; | Да | Да | &nbsp; |
|[Аналитика озера данных Azure](how-to-create-your-first-pipeline.md#adla)| &nbsp; | &nbsp; | Да | &nbsp; |
|[Azure HDInsight](#hdinsight)| &nbsp; | &nbsp; | Да | &nbsp; |
|[Пакетная служба Azure](#azbatch)| &nbsp; | &nbsp; | Да | &nbsp; |
