...
|Целевой объект вычислений для обучения| Ускорение GPU | Автоматически<br/> Настройка гиперпараметров | Автоматически</br> машинное обучение; | Конвейеры Машинного обучение Azure |
|----|:----:|:----:|:----:|:----:|
