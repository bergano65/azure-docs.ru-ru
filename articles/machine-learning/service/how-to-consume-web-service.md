...
Если ваша модель принимает двоичные данные, например изображения, необходимо изменить файл `score.py`, используемый для развертывания, чтобы обеспечить прием необработанных HTTP-запросов. Ниже приведен пример `score.py` , принимающий двоичных данных:
...
## <a name="consume-the-service-from-power-bi"></a>Использовать службу с Power BI
