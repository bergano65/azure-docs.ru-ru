...
description: Узнайте, как объяснить, почему ваша модель делает прогнозы с использованием пакета SDK для Azure Machine Learning. Данное свойство можно использовать во время обучения и выводов, чтобы понять, как модели прогнозов.
...
+ Interpretability на наборы реальных данных в масштабе, во время обучения и выводов. 
...
На этапе выводов по обработке и анализу данных можно использовать interpretability для объяснения прогнозы, чтобы пользователи, применяющие модель. Например, почему модели запрета ссуды ипотеки или предсказать, что портфелем капиталовложений выполняет подвергается риску?
...
## <a name="interpretability-in-inferencing"></a>Interpretability в выводов
