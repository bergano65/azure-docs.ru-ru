...
ms.locfileid: "68358645"
---
# <a name="model-interpretability-with-azure-machine-learning-service"></a>Интерпретируемость модели с помощью службы Машинное обучение Azure
...
Хотя вы можете обучить различные целевые объекты вычислений, поддерживаемые Машинное обучение Azureной службой, в примере в этом разделе показано, как это сделать с помощью целевого объекта Машинное обучение Azure вычислений.
...
1. Разверните образ в целевом объекте вычислений:
   ...
   1. Создайте файл оценки (перед выполнением этого шага выполните действия, описанные в разделе [Развертывание моделей со службой машинное обучение Azure](https://docs.microsoft.com/azure/machine-learning/service/how-to-deploy-and-where) , чтобы зарегистрировать исходную модель прогнозирования).
