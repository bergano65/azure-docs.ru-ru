...
> [!Important]
> Некоторые классы наборов данных (Предварительная версия) имеют зависимости в пакет SDK для подготовки данных (GA). Хотя функции преобразования можно сделать непосредственно с GA'ed [функции пакета SDK для подготовки данных](how-to-transform-data.md), мы рекомендуем оболочки пакета набора данных, описанные в этой статье, при создании нового решения. Azure наборы данных обучения машины (Предварительная версия) позволяют не только преобразовывать данные, но также [данных моментального снимка](how-to-create-dataset-snapshots.md) и сохранить [определения наборов данных с версиями](how-to-manage-dataset-definitions.md). Наборы данных — следующая версия пакета SDK для подготовки данных, предлагая расширенными функциональными возможностями для управления наборами данных в решения искусственного Интеллекта.
...
||ИД|Серийный номер|Дата|Заблокировать|IUCR|Основной тип|...|
-|--|-----------|----|-----|----|------------|---
...
||ИД|Серийный номер|Дата|Заблокировать|...|
-|---------|-----|---------|----|---
