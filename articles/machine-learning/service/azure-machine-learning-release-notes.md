 ...
 * **В следующем выпуске**  *Workspace.compute_targets, datastores, experiments, images, models* и *webservices* станут свойствами вместо методов. Например, *Workspace.compute_targets()* заменится на *Workspace.compute_targets*.

#### <a name="bugs-fixed"></a>Исправления ошибок
