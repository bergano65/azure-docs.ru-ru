...
Этот интерфейс командной строки машинного обучения является расширением [Azure CLI](https://docs.microsoft.com/cli/azure/?view=azure-cli-latest) и был построен с <a href="https://aka.ms/aml-sdk" target="_blank">SDK</a> на основе Python для службы Машинное обучение Azure.
...
+ Создайте рабочую область службы Машинного обучения Azure, ресурс верхнего уровня для машинного обучения.
   ```AzureCLI
