...
Из двух частей этого руководства вы узнаете, как с помощью графического интерфейса Машинного обучения Azure разработать и развернуть решение прогнозной аналитики для прогнозирования цен на автомобили. 
...
Чтобы создать эксперимент с визуальным интерфейсом, сначала нужно создать рабочую область Машинного обучения Azure. В этом разделе показано, как создать оба этих ресурса.

### <a name="create-a-new-workspace"></a>Создание рабочей области

Если у вас есть рабочая область Машинного обучения Azure, перейдите к следующему разделу.
