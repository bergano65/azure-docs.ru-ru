---
title: 'Пример конструктора #3: классификация для прогнозирования кредитного риска'
...
Набор данных содержит 14 функций и один столбец меток. Существует несколько типов функций, включая числовые и по категориям. На следующей диаграмме показан фрагмент из набора данных: ![данных](media/how-to-ui-sample-classification-predict-income/data.png)
...
![«применение-преобразование»](media/how-to-ui-sample-classification-predict-income/transformation.png)
...
![анализ результатов;](media/how-to-ui-sample-classification-predict-income/evaluate-result.png)
