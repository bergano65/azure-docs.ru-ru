...
* Собственные [сервер записных книжек на основе облака](#workstation): Используйте вычислительных ресурсов в рабочей станции для запуска записные книжки Jupyter. Это самый простой способ начать работу, так как пакет SDK для Машинного обучения Azure уже установлен.
...
Рабочая область — все что нужно приступить к работе с собственным [сервер записных книжек на основе облака](#workstation), [DSVM](#dsvm), [Azure Databricks](#aml-databricks), или [записных книжек Azure](#aznotebooks).
...
## <a id="workstation"></a>Сервер записной книжки на основе облака
...
* Среда рабочей станции автоматически настроена для работы с рабочей областью.
* Ресурс доступен и могут управляться в рабочей области

Чтобы приступить к разработке с помощью сервера записной книжки на основе облака, см. в разделе [приступить к работе со службой машинного обучения Azure](quickstart-run-cloud-notebook.md).
