...
| [Записные книжки Azure](#aznotebooks) | Бесплатное и легкое начало работы с предварительно установленным Python и пакетом SDK. | Доступ к менее мощным виртуальным машинам по сравнению с облачной виртуальной машиной записной книжки. Изолировано от рабочей области и других ресурсов. |
