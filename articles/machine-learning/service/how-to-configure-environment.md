...
Чтобы начать разработку с помощью Записных книжек Azure, обратитесь к статье [Краткое руководство. Начало работы со Службой машинного обучения Azure с помощью портала Azure](quickstart-run-cloud-notebook.md).
