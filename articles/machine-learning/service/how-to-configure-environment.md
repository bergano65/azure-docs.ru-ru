...
+ **Простая установка**: Создайте в любое время с в рабочей области машинного обучения Azure. Укажите только имя и укажите тип виртуальной Машины Azure. Попробуйте прямо сейчас с этим [краткое руководство: Используйте на сервере записной книжки на основе облака, чтобы начать работу с машинным обучением Azure](quickstart-run-cloud-notebook.md).
...
* **Загрузите файл**: На портале Azure выберите **Скачать config.json** в разделе **Обзор** рабочей области.
