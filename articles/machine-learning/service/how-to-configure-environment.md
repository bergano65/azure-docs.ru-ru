...
description: Узнайте, как настроить среду разработки при работе со Службой машинного обучения Azure. В этой статье вы узнаете, как использовать среды Conda, создания файлов конфигурации и настроить собственный сервер записной книжки на основе облака, записные книжки Jupyter, Azure Databricks, записных книжек Azure, интегрированных сред разработки, редакторы кода и виртуальная машина для обработки и анализа данных.
...
* Собственные [сервер записных книжек на основе облака](#notebookvm): Используйте вычислительных ресурсов в рабочей станции для запуска записные книжки Jupyter. Это самый простой способ начать работу, так как пакет SDK для Машинного обучения Azure уже установлен.
...
Рабочая область — все что нужно приступить к работе с собственным [сервер записных книжек на основе облака](#notebookvm), [DSVM](#dsvm), [Azure Databricks](#aml-databricks), или [записных книжек Azure](#aznotebooks).
...
## <a id="notebookvm"></a>Сервер записной книжки на основе облака

Создайте на сервере записной книжки в рабочей области машинного обучения Azure для самый простой способ начать работу с разработки машинного обучения Azure.

* Пакет SDK для Машинного обучения Azure уже установлен.
* Среда записной книжки виртуальной Машины автоматически настраивается для работы с рабочей областью.
* Ресурс создается в рабочей области и могут управляться существует

Чтобы приступить к разработке с помощью сервера записной книжки на основе облака, см. в разделе [краткое руководство: Используйте на сервере записной книжки на основе облака, чтобы начать работу с машинным обучением Azure](quickstart-run-cloud-notebook.md).
