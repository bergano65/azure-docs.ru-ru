...
ms.locfileid: "71002691"
---
# <a name="manage-and-request-quotas-for-azure-resources"></a>Управление квотами для ресурсов Azure и их запрашивание

Как и в случае с другими службами Azure, существуют ограничения на определенные ресурсы, связанные с Машинное обучение Azure. Эти ограничения находятся в диапазоне от ограничения на количество рабочих областей, которые можно создать для ограничения реальных базовых вычислений, используемых для обучения модели или вывода или оценки. 
