...
Доступные ресурсы:
+ Количество выделенных ядер для каждого региона по умолчанию ограничено до 10–24 ядер.  Количество выделенных ядер для каждой подписки можно увеличить. Чтобы обсудить варианты увеличения, обратитесь в службу поддержки Azure.

+ Количество ядер с низким приоритетом для каждого региона по умолчанию ограничено до 10–24 ядер.  Количество ядер с низким приоритетом для каждой подписки можно увеличить. Чтобы обсудить варианты увеличения, обратитесь в службу поддержки Azure.
...
1. На левой панели выберите  **Служба машинного обучения** и в появившемся списке выберите любую рабочую область.
