...
ms.locfileid: "71035471"
---
# <a name="mlops-manage-deploy-and-monitor-models-with-azure-machine-learning"></a>Млопс: Администрирование, развертывание и мониторинг моделей с помощью службы "Машинное обучение Azure"
...
Узнайте больше о [том, как и где можно развертывать модели](how-to-deploy-and-where.md) с помощью машинное обучение Azure. Пример развертывания см. в разделе [учебник. Развертывание модели классификации изображений в службе "экземпляры](tutorial-deploy-models-with-aml.md)контейнеров Azure".
