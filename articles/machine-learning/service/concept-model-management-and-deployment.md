---
title: 'Млопс: управление, развертывание, & мониторинг моделей машинного обучения'
titleSuffix: Azure Machine Learning
description: 'Узнайте, как использовать Машинное обучение Azure для Млопс: развертывание, управление и мониторинг моделей для их непрерывного улучшения. Модели, обученные с помощью службы "Машинное обучение Azure", можно развертывать на локальном компьютере или из других источников.'
...
ms.locfileid: "73497440"
---
# <a name="mlops-manage-deploy-and-monitor-models-with-azure-machine-learning"></a>Млопс: управление, развертывание и мониторинг моделей с помощью Машинное обучение Azure
...
Узнайте больше о [том, как и где можно развертывать модели](how-to-deploy-and-where.md) с помощью машинное обучение Azure. Пример развертывания см. [в разделе Учебник. Развертывание модели классификации изображений в службе "экземпляры контейнеров Azure"](tutorial-deploy-models-with-aml.md).
