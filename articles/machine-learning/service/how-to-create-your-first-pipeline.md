...
* Подключает хранилище данных, если `DataReference` объект указан на шаге. Если подключение не поддерживается, то данные копируются на целевой объект вычислений.
