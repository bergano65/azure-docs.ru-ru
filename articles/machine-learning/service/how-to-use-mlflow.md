...
Отслеживание Млфлов с помощью службы Машинное обучение Azure позволяет хранить зарегистрированные метрики и артефакты из модулях данных в рабочей области Машинное обучение Azure.
