...
> * создадите облачную виртуальную машину для записных книжек с предварительно установленным и настроенным пакетом SDK службы "Машинное обучение Azure" для Python.
