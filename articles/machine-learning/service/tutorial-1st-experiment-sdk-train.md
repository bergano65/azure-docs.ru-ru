...
> [!TIP]
> Если вы не знакомы с записными книжками Jupyter, выполните код, щелкнув ячейку кода и нажав клавиши **SHIFT+ВВОД**, чтобы выполнить ячейки по одной. Вы также можете выполнить всю записную книжку, нажав кнопку **Ячейка** в верхней строке меню и выбрав **Выполнить все**.
