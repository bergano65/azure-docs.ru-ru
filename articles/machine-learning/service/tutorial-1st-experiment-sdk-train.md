...
1. Выберите **Jupyter** в столбце **URI** для виртуальной машины, созданной с помощью первой части этого руководства.
...
1. На веб-странице записной книжки Jupyter выберите верхнее имя папки, которое представляет ваше имя пользователя.  

   Эта папка находится в рабочей области [учетной записи хранения](concept-workspace.md#resources), а не на самой виртуальной машине записной книжки.  При удалении виртуальной машины записной книжки ваша работа будет сохранена.  Если вы создадите виртуальную машину записной книжки, она будет загружена в эту же папку. При совместном использовании рабочей области с другими пользователями, они увидит вашу папку и вы увидите их.

1. Откройте подкаталог `samples-*` и выберите записную книжку Jupyter `tutorials/tutorial-1st-experiment-sdk-train.ipynb`, а **не** файл `.yml` с тем же именем. 
...
> Чтобы выполнить одну ячейку кода в записной книжке, щелкните эту ячейку и нажмите клавиши **SHIFT+ВВОД**. Или запустите всю записную книжку, выбрав в меню вверху **Ячейка > Запустить все**.
