...
description: В этой статье показано, как создавать сложные эксперимента машинного обучения с помощью визуального интерфейса. Вы узнаете, как реализовать пользовательские скрипты Python и сравнить несколько моделей, чтобы выбрать оптимальный вариант.
...
В этой статье показано, как создавать сложные эксперимента машинного обучения с помощью визуального интерфейса. Вы узнаете, как реализовать пользовательскую логику, с помощью сценариев Python и сравнить несколько моделей, чтобы выбрать оптимальный вариант.

В этом примере обучает классификатор для прогнозирования кредитного риска, с помощью кредитной сведений о приложении, такие как кредитная История, возраст и номера кредитных карт. Тем не менее можно применить понятия, описанные в этой статье, чтобы справиться с собственным машинным обучением проблем.

Если вы кто только знакомится с помощью машинного обучения, можно взглянуть на [классификатора базовый пример](ui-sample-classification-predict-credit-risk-basic.md) первого.
...
1. Используйте **Score Model** для создания оценок с помощью тестовых примеров.
