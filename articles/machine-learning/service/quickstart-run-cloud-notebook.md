...
1. На веб-странице записной книжки Jupyter верхнее имя папки представляет ваше имя пользователя.  Выберите эту папку.
    ...
    > [!TIP]
    > Эта папка находится в рабочей области [контейнера хранилища](concept-workspace.md#resources), а не на самой виртуальной машине записной книжки.  Вы можете удалить виртуальную машину записной книжки, сохранив свою работу.  Если вы создадите виртуальную машину записной книжки, она будет загружена в эту же папку.
...
На веб-странице Jupyter Notebook в папке для **быстрого запуска** откройте и запустите записную книжку **02.deploy-web-service.ipynb**, чтобы просмотреть сведения о развертывании веб-службы.

На той же странице просмотрите другие записные книжки в папке с примерами, чтобы узнать больше о Службе машинного обучения Azure.
