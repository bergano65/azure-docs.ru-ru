...
* Рабочая область службы машинного обучения Azure. Сведения о создании рабочей области см. в статье [Создание рабочей области службы машинное обучение Azure](setup-create-workspace.md).
...
* Ознакомьтесь с справочной документацией по [пакету SDK машинное обучение Azure для Python](https://aka.ms/aml-sdk) .
