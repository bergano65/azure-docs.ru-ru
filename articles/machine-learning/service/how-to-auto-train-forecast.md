...
* Настройка отдельных параметров временных рядов в объекте [`AutoMLConfig`](/python/api/azureml-train-automl/azureml.train.automl.automlconfig)
...
Модели глубокого обучения имеют три встроенных капбаилитиес:
...
При наличии больших данных модели глубокого обучения, такие как Microsoft Форекастткн, могут улучшить оценки результирующей модели. 
...
| Параметр | Description (Описание) | Обязательно |
|-------|-------|-------|
...
Чтобы использовать DNN, в качестве целевого объекта вычислений рекомендуется использовать для вычислений с графическим процессором AML и по крайней мере 2 узла. Дополнительные сведения см. в [документации по вычислений AML](https://docs.microsoft.com/en-us/azure/machine-learning/service/how-to-set-up-training-targets#amlcompute) . Дополнительные сведения о размерах виртуальных машин, которые включают GPU, см. в статье [размеры виртуальной машины, оптимизированные для GPU](https://docs.microsoft.com/en-us/azure/virtual-machines/linux/sizes-gpu) .
