...
|`target_lags`|Число строк для запаздывания целевых значений на основе частоты данных. Представляется в виде списка или одного целого числа.||
