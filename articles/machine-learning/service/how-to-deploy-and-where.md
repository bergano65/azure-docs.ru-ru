...
| [Вычислений для машинного Обучения Azure](#azuremlcompute) | Определение пакета | Запустите пакетный прогноз на бессерверных вычислений. Поддерживает нормальные и низкоприоритетные виртуальные машины. |
