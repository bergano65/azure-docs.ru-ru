...
Конфигурация вывода может использовать Машинное обучение Azure среды для определения зависимостей программного обеспечения, необходимых для развертывания. Среды позволяют создавать, администрировать и повторно использовать зависимости программного обеспечения, необходимые для обучения и развертывания. При использовании среды файлы модели и предоставленный исходный каталог подключаются непосредственно к выполняющемуся контейнеру. они не копируются в образ контейнера или в реестр контейнеров.
