...
Завершение плохо выполняющихся запусков автоматически с помощью [политики раннего завершения. Прекращение запусков позволяет снизить потери ресурсов и перераспределить их для изучения других конфигураций параметров.
