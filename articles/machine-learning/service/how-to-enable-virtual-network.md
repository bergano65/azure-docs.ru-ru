...
> [!IMPORTANT]
> _Учетную запись хранения по умолчанию_ для службы машинное обучение Azure можно разместить в виртуальной сети _только для экспериментов_. Учетная запись хранения по умолчанию автоматически подготавливается при создании рабочей области.
>
> _Учетные записи хранения, отличные от используемых по умолчанию_ , можно разместить в виртуальной сети _только для экспериментов_. Параметр в функции позволяет указать настраиваемую учетную запись хранения по идентификатору ресурса Azure. [ `Workspace.create()` ](https://docs.microsoft.com/python/api/azureml-core/azureml.core.workspace(class)?view=azure-ml-py#create-name--auth-none--subscription-id-none--resource-group-none--location-none--create-resource-group-true--friendly-name-none--storage-account-none--key-vault-none--app-insights-none--container-registry-none--default-cpu-compute-target-none--default-gpu-compute-target-none--exist-ok-false--show-output-true-) `storage_account`
>
