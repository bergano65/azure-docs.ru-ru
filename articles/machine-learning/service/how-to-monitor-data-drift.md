...
Конфигурация средства обнаружения смещения данных может отображаться на странице сведения о модели в портал Azure или на целевой странице рабочей области (Предварительная версия).
...
Результаты также доступны в сведениях о модели на [целевой странице рабочей области (Предварительная версия)](https://ml.azure.com).
