...
4. Нажмите кнопку **Открыть** для конвейера образца 1:

    ![Открытие конвейера](media/how-to-ui-sample-regression-predict-automobile-price-basic/open-sample1.png)
