...
* После запуска панели мониторинга записной книжки Jupyter откройте записную книжку **tutorials/regression-part1-data-prep.ipynb**.

Это руководство также доступно на сайте [GitHub](https://github.com/Azure/MachineLearningNotebooks/tree/master/tutorials), если вы хотите использовать его в собственной [локальной среде](how-to-configure-environment.md#local).  Убедитесь, что у вас установлен пакет `azureml-dataprep` из пакета SDK Машинного обучения Azure.
