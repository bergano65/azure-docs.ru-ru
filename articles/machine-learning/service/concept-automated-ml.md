...
ms.locfileid: "68358854"
---
# <a name="what-is-automated-machine-learning"></a>Что такое автоматическое машинное обучение?

Автоматизированное машинное обучение, также называемое Аутомл, — это процесс автоматизации ресурсоемких задач разработки моделей машинного обучения. Благодаря этому специалисты по обработке и анализу данных могут создавать модели машинного обучения с высокой масштабируемостью, эффективностью и производительностью, сохраняя при этом качество модели.
...
## <a name="preprocessing"></a>Предварительной обработки
...
## <a name="ensemble-models"></a>Модели ансамблей

Вы можете обучить модели ансамблей, используя автоматизированное машинное обучение, с помощью [алгоритма выбора Каруана ансамблей с упорядоченной инициализацией ансамблей](http://www.niculescu-mizil.org/papers/shotgun.icml04.revised.rev2.pdf). Ансамблейное обучение улучшает результаты машинного обучения и прогнозную производительность, объединяя многие модели в отличие от использования отдельных моделей. Итерация ансамблей отображается как Последняя итерация выполнения.
...
+ Настройте параметры для автоматического обучения.
  + В интерфейсе портал Azure [выполните следующие действия](how-to-create-portal-experiments.md).
