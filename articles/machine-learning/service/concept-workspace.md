...
| Создание вычислительного экземпляра | **&check;**  | **&check;** | **&check;** |     |
...
+ [Учетная запись хранения Azure](https://azure.microsoft.com/services/storage/). используется в качестве хранилища данных по умолчанию для рабочей области.  Записные книжки Jupyter, используемые для экземпляра Машинное обучение Azure вычислительных ресурсов, также хранятся здесь.
