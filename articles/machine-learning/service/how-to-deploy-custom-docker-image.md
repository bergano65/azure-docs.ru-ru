...
* Вы будете использовать реестр контейнеров Azure, созданные для рабочей области службы машинного обучения Azure, либо отдельный реестр контейнеров Azure?
    ...
    > [!TIP]
    > Реестр контейнеров для рабочей области создается в первый раз обучения или развертывание модели с помощью рабочей области. Если был создан рабочую область, но не обучена или создания модели, не реестр контейнеров Azure будет существовать для рабочей области.
    ...
    Сведения о создании частного реестра контейнеров Azure, см. в разделе [создать частный реестр контейнеров](/azure/container-registry/container-registery-get-started-azure-cli).
...
Дополнительные сведения о создании образов в реестре контейнеров Azure, см. в разделе [собрать и запустить образ контейнера с помощью задачи реестра контейнеров Azure](/docs.microsoft.com/azure/container-registry/container-registry-quickstart-task-cli.md)

Дополнительные сведения о загрузке существующих образов в реестр контейнеров Azure, см. в разделе [отправка первого образа в частный реестр контейнеров Docker](/azure/container-registry/container-registry-get-started-docker-cli.md).
