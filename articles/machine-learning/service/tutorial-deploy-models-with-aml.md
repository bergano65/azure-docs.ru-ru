...
Можно также ознакомиться с руководством по [автоматическому выбору алгоритма](tutorial-auto-train-models.md), чтобы узнать, как служба "Машинное обучение Azure" может автоматически выбирать и настраивать подходящий для вашей модели алгоритм, а также создавать эту модель.
