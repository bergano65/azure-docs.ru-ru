---
title: Руководство. Развертывание модели классификации изображений в экземпляре контейнера Azure (ACI) с помощью службы "Машинное обучение Azure"
...
Для удобства это руководство доступно в виде [записной книжки Jupyter](https://github.com/Azure/MachineLearningNotebooks/blob/master/tutorials/02.deploy-models.ipynb). Запустите записную книжку `02.deploy-models.ipynb` в службе "Записные книжки Azure" или на своем сервере Jupyter Notebook.
...
Можно также ознакомиться с руководством по [автоматическому выбору алгоритма](), чтобы узнать, как служба "Машинное обучение Azure" может автоматически выбирать и настраивать подходящий для вашей модели алгоритм, а также создавать эту модель.
