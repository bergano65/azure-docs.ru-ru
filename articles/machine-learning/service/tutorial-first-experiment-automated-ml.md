...
1. На панели слева выберите **Automated ML** (Автоматизированное ML) в разделе **Разработка**.
...
По мере выполнения эксперимента на экране обновляется **схема итерации** и **список итераций**, где отображаются сведения о создаваемых итерациях (моделях) с сортировкой по оценке метрики. По умолчанию в начале списка отображается модель, имеющая наибольшее значение по выбранной метрике **AUC_weighted**.
