...
description: Машинное обучение в облаке и зачем оно. Общие сведения о Службе машинного обучения Azure — полнофункциональном интегрированном решении для специалистов по обработке и анализу данных, которое позволяет разрабатывать, проверять и развертывать приложения расширенной аналитики в масштабах облака.
...
Поддержка расширенных средств, например, расширения [записных книжек Jupyter](http://jupyter.org) или [средств Visual Studio Code для Машинного обучения](https://visualstudio.microsoft.com/downloads/ai-tools-vscode/), позволяют легко выполнять интерактивное исследование данных, преобразовывать их, а затем разрабатывать и тестировать модели.
...
При наличии модели ее используют для создания контейнера (например, Docker), который можно развернуть локально для тестирования. После завершения тестирования модель можно развернуть в качестве производственной веб-службы в [Экземплярах контейнеров Azure](how-to-deploy-to-aci.md) или в [Службе Azure Kubernetes](how-to-deploy-to-aks.md).
