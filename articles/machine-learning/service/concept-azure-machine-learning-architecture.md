...
Дополнительные сведения см. в разделе [Создание и регистрация машинное обучение Azure наборов данных](how-to-create-register-datasets.md).  Дополнительные примеры использования наборов данных см. в [примере записных книжек](https://aka.ms/dataset-tutorial).
...
* [Создание рабочей области службы Машинное обучение Azure](setup-create-workspace.md)
