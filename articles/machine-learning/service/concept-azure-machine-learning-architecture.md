...
ms.locfileid: "71035598"
---
# <a name="how-azure-machine-learning-works-architecture-and-concepts"></a>Как работает Машинное обучение Azure: архитектура и основные понятия
...
+ Используйте [визуальный интерфейс (Предварительная версия) для машинное обучение Azure](ui-concept-visual-interface.md) выполнения действий рабочего процесса без написания кода.
...
Пример см. в статье [Руководство. Обучение модели классификации изображений с Машинное обучение Azure](tutorial-train-models-with-aml.md).
...
Машинное обучение Azure предоставляет базовый образ, используемый по умолчанию. Вы также можете предоставить собственные пользовательские образы.
