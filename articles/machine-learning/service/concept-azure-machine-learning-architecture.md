...
1. **Отправьте скрипты** в настроенный целевой объект вычислений для запуска в этой среде. Во время обучения целевой объект вычислений сохраняет записи о выполнении в **хранилище данных**. Там эти записи сохраняются в **эксперимент**.
