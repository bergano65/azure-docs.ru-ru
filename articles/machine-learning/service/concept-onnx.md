...
+ Обучение новой модели ONNX в службе Машинное обучение Azure (см. примеры в нижней части этой статьи)
