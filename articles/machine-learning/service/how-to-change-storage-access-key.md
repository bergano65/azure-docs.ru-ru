...
description: Узнайте, как изменить ключи доступа для учетной записи хранения Azure, используемой рабочей областью. Машинное обучение Azure использует учетную запись хранения Azure для хранения данных и моделей. При повторном создании ключа доступа для учетной записи хранения необходимо обновить Машинное обучение Azure, чтобы использовать новые ключи.
