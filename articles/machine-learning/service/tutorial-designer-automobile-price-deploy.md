...
В открывшемся диалоговом окне можно выбрать любой кластер Службы Azure Kubernetes (AKS), чтобы развернуть в нем модель. Если у вас нет кластера AKS, создайте его, сделав следующее.
