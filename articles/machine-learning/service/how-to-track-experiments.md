...
description: Отслеживайте эксперименты машинного обучения Azure и отслеживайте показатели запуска для улучшения процесса создания модели. Добавьте ведение журнала в сценарий обучения и просмотрите записанные результаты выполнения.  Используйте Run. log, запустите. start_logging или Скриптрунконфиг.
...
## <a name="view-the-experiment-in-the-azure-portal-or-your-workspace-landing-page-previewhttpsmlazurecom"></a>Просмотр эксперимента на целевой странице портал Azure или [рабочей области (Предварительная версия)](https://ml.azure.com)
