---
title: Отслеживание экспериментов и метрик обучения
...
Если вы знаете имя эксперимента и идентификатор выполнения, после запуска выполнения вы можете отменить его, даже если потеряли ссылку на объект. 
