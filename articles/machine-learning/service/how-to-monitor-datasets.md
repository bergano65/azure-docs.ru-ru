...
| Настройка | Description (Описание) | Советы | Изменяемый | 
| ------- | ----------- | ---- | ------- | 
...
| Настройка | Description (Описание) | Советы | Изменяемый | 
| ------- | ----------- | ---- | ------- |
| Включить | Включение или отключение расписания в конвейере монитора набора данных | Отключите этот параметр, чтобы анализировать исторические данные с помощью параметра "Обратная засыпку". Его можно включить после создания монитора набора данных. | Да | 
| Latency | Время в часах, затраченное на получение данных в наборе данных. Например, если в моем наборе данных SQL DB поступают данные в виде трех дней, установите задержку 72. | Невозможно изменить после создания монитора набора данных | Нет | 
...
| Настройка | Description (Описание) | Советы |
| ------- | ----------- | ---- |
...
| Метрика | Description (Описание) | Советы | 
| ------ | ----------- | ---- | 
