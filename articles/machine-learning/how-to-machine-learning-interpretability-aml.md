...
После скачивания объяснений в локальную Jupyter Notebook можно использовать панель мониторинга визуализации для понимания и интерпретации модели.
