---
title: Реализация разностной конфиденциальности с помощью пакета Смартноисе (Предварительная версия)
titleSuffix: Azure Machine Learning
description: Узнайте, что такое разностное конфиденциальность и как пакет Смартноисе может помочь в реализации разностных частных систем с сохранением конфиденциальности данных.
...
ms.locfileid: "97723496"
---
# <a name="preserve-data-privacy-by-using-differential-privacy-and-the-smartnoise-package-preview"></a>Сохранение конфиденциальности данных с помощью разностной конфиденциальности и пакета Смартноисе (Предварительная версия)

Узнайте, что такое разностное конфиденциальность и как пакет Смартноисе может помочь в реализации разностных в частном порядке систем.
...
Реализация систем с дифференциальной конфиденциальностью — это сложный процесс. Смартноисе — это проект с открытым исходным кодом, который содержит различные компоненты для создания глобальных разностных систем. Смартноисе состоит из следующих компонентов верхнего уровня:
