...
```
Новую версию набора данных также можно зарегистрировать в 
...
Можно также найти `input_datasets` из экспериментов с помощью https://ml.azure.com/. 
