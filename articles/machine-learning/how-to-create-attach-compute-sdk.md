---
title: Создание ресурсов вычислений с помощью пакета SDK для Python
...
Теперь, когда вы присоединяете вычисление, следующим шагом является [Отправка обучающего запуска](how-to-set-up-training-targets.md).
...
Теперь, когда вы присоединяете вычисление и настроили выполнение, следующим шагом является [Отправка обучающего запуска](how-to-set-up-training-targets.md) .
