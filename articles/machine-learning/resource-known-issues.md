...
* Если вы [создали монитор смещения](how-to-monitor-datasets.md) данных, но не видите данные на странице **мониторы набора данных** в машинное обучение Azure Studio, попробуйте выполнить следующие.
...
Дополнительные сведения см. в разделе [Manage Users and Roles](how-to-assign-roles.md).
...
* [Интерактивная Отладка вычислительного экземпляра машинного обучения с VS Code](how-to-set-up-vs-code-remote.md)
