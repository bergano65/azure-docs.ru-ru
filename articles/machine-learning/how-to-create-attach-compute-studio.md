...
|Дополнительные настройки     |  Необязательный элемент. Настройте виртуальную сеть. Укажите **группу ресурсов**, **виртуальную сеть** и **подсеть** , чтобы создать вычислительный экземпляр в виртуальной сети Azure. Дополнительные сведения см. в описании этих [сетевых требований](./how-to-secure-training-vnet.md) для виртуальной сети.  |
...
|Дополнительные настройки     |  Необязательный элемент. Настройте виртуальную сеть. Укажите **группу ресурсов**, **виртуальную сеть** и **подсеть** , чтобы создать вычислительный экземпляр в виртуальной сети Azure. Дополнительные сведения см. в описании этих [сетевых требований](./how-to-secure-training-vnet.md) для виртуальной сети.   Также присоедините [управляемые удостоверения](#managed-identity) для предоставления доступа к ресурсам.     |
