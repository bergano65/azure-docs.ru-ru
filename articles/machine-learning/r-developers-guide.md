...
Студия машинного обучения Azure поддерживает R и Python.  R можно использовать двумя способами в Студии машинного обучения Azure.
...
Чтобы воспользоваться этой возможностью, перетащите модуль "Выполнить сценарий R" в свой эксперимент.  Затем с помощью редактора кода в области "Свойства" напишите новый R-сценарий или вставьте имеющийся.  В сценарии можно ссылаться на внешние пакеты R.  С помощью сценария можно управлять данными или обучать сложные модели машинного обучения, которые не являются частью стандартной библиотеки моделей Студии машинного обучения Azure.

Подробное представление использования R в экспериментах в Студии машинного обучения см. в статье [Краткое руководство по языку программирования R для Студии машинного обучения Azure](https://docs.microsoft.com/azure/machine-learning/studio/r-quickstart).
...
Другой способ работы с R в Студии машинного обучения Azure — это использование
пакета <code>[AzureML](https://cran.r-project.org/web/packages/AzureML/vignettes/getting_started.html)</code> для отслеживания и контроля процесса экспериментирования с помощью среды программирования R.  Этот пакет, который обслуживает корпорация Майкрософт, позволяет отправлять и загружать наборы данных в Студию машинного обучения Azure и из нее, чтобы запрашивать эксперименты, публиковать функции R в качестве веб-служб, выполнять данные R с помощью имеющейся веб-службы и получать выходные данные.

С помощью этого пакета гораздо проще использовать Студию машинного обучение Azure в качестве масштабируемой платформы развертывания для кода R.  Вместо того чтобы щелкать и перетаскивать элементы в пользовательском интерфейсе, весь процесс развертывания можно автоматизировать с помощью уже знакомых инструментов.
