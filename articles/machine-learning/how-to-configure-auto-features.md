...
1. **Предварительная обработка и разметка всех текстовых столбцов**. Например, преобразователь "Стрингкаст" можно найти в сводке Добавление признаков финальной модели. Пример создания сводки Добавление признаков для модели можно найти в [этой записной книжке](https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/automated-machine-learning/classification-text-dnn/auto-ml-classification-text-dnn.ipynb).
