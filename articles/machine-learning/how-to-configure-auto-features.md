...
Сведения о параметрах Добавление признаков данных в Машинное обучение Azure и о настройке этих функций для [автоматизированных экспериментов ML](concept-automated-ml.md).
