...
| --- | --- |
| **Читатель** | Действия только для чтения в рабочей области. Читатели могут перечислять и просматривать ресурсы (включая учетные данные [хранилища](how-to-access-data.md) данных) в рабочей области, но не могут создавать или обновлять эти ресурсы. |
...
Дополнительные сведения о пользовательских ролях см. в статье [пользовательские роли Azure](/azure/role-based-access-control/custom-roles).
