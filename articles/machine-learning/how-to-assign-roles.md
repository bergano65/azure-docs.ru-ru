...
| --- | --- |
| **Читатель** | действия с доступом только для чтения в рабочей области. Читатели могут выводить список ресурсов в рабочей области и просматривать их, но не могут создавать или изменять эти ресурсы. |
