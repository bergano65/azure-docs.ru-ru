...
Рабочая область машинного обучения Azure. Сведения о создании рабочей области см. в статье [создание машинное обучение Azure рабочей области](how-to-manage-workspace.md). Рабочая область — это все, что нужно для начала работы с вашим собственным [облачным сервером записных книжек](#compute-instance), [DSVM](#dsvm)или [Azure Databricks](#aml-databricks).
...
## <a id="compute-instance"></a>Собственный облачный вычислительный экземпляр
