...
- Просмотрите статью [What is the Azure Machine Learning SDK for Python?](/python/api/overview/azure/ml/intro?preserve-view=true&view=azure-ml-py) (Что такое пакет SDK для Машинного обучения Azure для Python?)