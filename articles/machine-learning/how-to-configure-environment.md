...
+ Импортируйте эти примеры непосредственно из рабочей области. См. ниже ![: выберите](./media/how-to-configure-environment/azure-db-screenshot.png)
![импорт панели импорта](./media/how-to-configure-environment/azure-db-import.png)
