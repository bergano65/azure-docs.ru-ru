...
+ **Пользовательский интерфейс автоматизированного машинного обучения (предварительная версия)**
...
|---| --- | --- |
| Интерфейс перетаскивания | Классический интерфейс | Обновленный интерфейс — [конструктор Машинного обучения Azure (предварительная версия)](concept-designer.md) <br/>(требуется корпоративная рабочая область) | 
...
Посетите [студию](https://ml.azure.com) или изучите различные варианты разработки по следующим учебникам:  
  + [Использование записных книжек Python для обучения и развертывания моделей](tutorial-1st-experiment-sdk-setup.md)
