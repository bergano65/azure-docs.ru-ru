...
В этом разделе вы настроите обучающий эксперимент, инициализируя рабочую область, создавая эксперимент и загружая обучающие данные и обучающие сценарии.
...
### <a name="create-or-attach-an-amlcompute-resource"></a>Создание или присоединение ресурса Амлкомпуте
...
Создание `AmlCompute` займет около пяти минут. Если `AmlCompute` ресурс уже находится в рабочей области, этот код пропускает процесс создания.
...
### <a name="create-a-scriptrunconfig-resource"></a>Создание ресурса Скриптрунконфиг
