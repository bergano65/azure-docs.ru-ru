...
1. Войдите в Машинное обучение Azure на https://ml.azure.com. 
...
|Этапы предварительной обработки&nbsp;| Description |
| ------------- | ------------- |
...
Снятие данных применяются автоматически для выявления потенциальных проблем с данными (например, отсутствующие значения, несбалансированность класса) и выполнения корректирующих действий для улучшения результатов. Существует множество рекомендаций, которые можно применять для достижения надежных результатов. 

В следующей таблице описаны поддерживаемые в настоящее время снятие данных, а также связанные состояния, которые пользователи могут поступать при отправке эксперимента.

гуардраил|Состояние|Условие&nbsp;для триггера&nbsp;
---|---|---
Отсутствующие значения&nbsp;&nbsp;добавления отсутствующих |**Данного** <br> <br> **Префикс**|    Отсутствуют отсутствующие значения во входных&nbsp;столбцах <br> <br> В некоторых столбцах отсутствуют значения
Перекрестная проверка|**Договорились**|Если явный набор проверки не указан
Высокое&nbsp;количество элементов&nbsp;обнаружение&nbsp;компонентов|    **Данного** <br> <br>**Договорились**|    Не обнаружено компонентов с высоким количеством элементов <br><br> Обнаружены входные столбцы с большим количеством элементов
Определение баланса класса    |**Данного** <br><br><br>**Оповещения** |Классы сбалансированы в обучающих данных; Набор данных считается сбалансированным, если каждый класс имеет хорошее представление в наборе данных, как измеряется числом и отношением выборок. <br> <br> Несбалансированные классы в обучающих данных
Согласованность данных временных рядов|**Данного** <br><br><br><br> **Префикс** |<br> Были проанализированы выбранные значения {горизонта, запаздывания, чередующегося окна} и не обнаружены потенциальные проблемы нехватки памяти. <br> <br>Выбранные значения {горизонта, запаздывания, чередующегося окна} были проанализированы и потенциально могут привести к нехватке памяти для эксперимента. Запаздывание или пошаговое окно отключено.
