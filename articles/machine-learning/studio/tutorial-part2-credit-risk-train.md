...
В этом руководстве подробно описывается процесс разработки решения прогнозной аналитики. Сначала нужно разработать простую модель в Студии машинного обучения.  Затем следует развернуть модель в качестве веб-службы машинного обучения Azure.  Развернутая модель позволяет создавать прогнозы на основе новых данных. Это руководство представляет собой **вторую часть серии, состоящей из трех частей**.
...
Оценка кредитных рисков — это сложная задача. Мы немного упростим ее для этого руководства. На примере этой задачи вы создадите решение прогнозной аналитики с помощью Машинного обучения Microsoft Azure. Для этого используем Студию машинного обучения Azure и веб-службу машинного обучения.  
