...
Ознакомьтесь с графическим интерфейсом (предварительной версией) с помощью [краткого руководства: Подготовка и визуализация данных без написания кода](../service/ui-quickstart-run-experiment.md).
