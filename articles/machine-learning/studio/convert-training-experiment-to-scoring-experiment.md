...
Для этого используйте классическую версию Studio, чтобы создать эксперимент, который называется *обучающим экспериментом* , где вы научитесь обучать, оценивать и редактировать модель. Когда модель будет полностью вас устраивать, вы подготовите ее к развертыванию, преобразовав обучающий эксперимент в *прогнозный*, который предназначен для обработки пользовательских данных.
