...
К счастью, для решения этой задачи вы можете применить [API переобучения Студии машинного обучения Azure](retrain-models-programmatically.md) и автоматизацию с помощью [PowerShell для Студии машинного обучения Azure](powershell-module.md).
