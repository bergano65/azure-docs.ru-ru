...
description: Управление новыми и классическими веб-сервисами машинного обучения с помощью веб-сервисов Microsoft Azure Machine Learning. Так как классические и новые веб-службы основаны на различных базовых технологиях, возможности управления для них слегка различаются.
...
ms.locfileid: "79217977"
---
# <a name="manage-a-web-service-using-the-azure-machine-learning-studio-classic-web-services-portal"></a>Управление веб-службой с помощью портала Web-сервисов Azure Machine Learning Studio (классический)
...
>[!NOTE]
>Вы также можете управлять классическими веб-сервисами в [студии машинного обучения (классический)](https://studio.azureml.net) на вкладке **Web-сервисов.**
...
*Развертывание веб-службы не удавится. Эта учетная запись не имеет достаточного доступа к подписке Azure, содержащей рабочее пространство. Для развертывания Web-службы в Azure необходимо пригласить ту же учетную запись в рабочее пространство и получить доступ к подписке Azure, содержащей рабочее пространство.*

Для получения дополнительной информации о создании рабочего пространства [см.](create-workspace.md)
...
* **Название** позволяет ввести заголовок для веб-службы
...
* **Enable Sample data** (Включить образцы данных): позволяет добавлять образцы данных, которые можно использовать для тестирования службы "запрос — ответ". Если вы создали веб-сервис в машинной студии обучения (классический), образец данных берется из данных, используемых для обучения модели. Если служба создана программным путем, то данные берутся из данных примеров, которые вы предоставили в составе пакета JSON.
...
* **Веб-службы** отображают количество веб-служб, использующих этот план.
...
> [!NOTE]
> Процедуры, описанные в этом разделе, относятся к управлению классическими веб-службами на портале веб-служб машинного обучения Azure. Для получения информации об управлении классическими веб-сервисами через студию машинного обучения (классический) и портал Azure можно получить информацию о работе ВНедряйтесь в формат [Azure Machine Learning Studio (классическое).](manage-workspace.md)
> 
> 
