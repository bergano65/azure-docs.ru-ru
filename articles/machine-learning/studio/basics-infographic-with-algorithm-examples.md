...
[Студия машинного обучения Azure](https://studio.azureml.net/) включает большую библиотеку алгоритмов для прогнозной аналитики. Этот Инфографика определяет четыре популярных семейства алгоритмов: регрессия, обнаружения аномалий, кластеризации и классификации, а также ссылки на рабочие примеры в [Коллекция решений ии Azure](https://gallery.azure.ai/). Коллекция содержит примеры экспериментов и руководства, в которых показано, как можно применять эти алгоритмы во многих реальных решениях.
