...
## <a name="transcript-the-5-questions-data-science-answers"></a>Расшифровка. 5 вопросов, на которые дают ответ обработка и анализ данных
...
* Если ваш автомобиль оснащен манометром, возможно, вы хотите знать: "Корректно ли манометр считывает данные о давлении?"
* Если вы ведете наблюдение за интернет-трафиком, возможно, вы хотите знать: "Типично ли это сообщение для Интернета?"
...
* Для системы управления температурой в доме: "Изменить температуру или нет?"  
