...
description: Подробное руководство по созданию решения для прогнозной аналитики в Студии машинного обучения Azure для оценки кредитных рисков. Это руководство представляет собой третью, заключительную часть серии руководств. В нем описывается развертывание модели в качестве веб-службы.
...
Оценка кредитных рисков — это сложная задача. Мы немного упростим ее для этого руководства. На примере этой задачи вы создадите решение прогнозной аналитики с помощью Машинного обучения Microsoft Azure. Для этого мы используем Студию машинного обучения Azure и веб-службу машинного обучения. 
