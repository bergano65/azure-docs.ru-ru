...
Мы также поняли, что в будущем для более быстрого получения результатов по проектам прогнозирования целесообразно использовать модуль [Filter-Based Feature Selection][filter-based-feature-selection] (Выбор признаков на основе фильтра). Применяя выбор компонентов к данным, можно создать улучшенную модель в Studio (классической) с более высокой общей производительностью. 
