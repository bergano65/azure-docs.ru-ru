...
> Тем не менее для построения аналогичной модели в примере эксперимента [Telco Customer Churn](https://gallery.azure.ai/Experiment/31c19425ee874f628c847f7e2d93e383) из [Коллекции решений ИИ Azure](https://gallery.azure.ai/) используются общедоступные данные.
> 
...
[2] Статья из Википедии. [Точность и презиционность](https://en.wikipedia.org/wiki/Accuracy_and_precision).

[3] [CRISP-DM 1.0. Пошаговое руководство по интеллектуальному анализу данных](https://www.the-modeling-agency.com/crisp-dm.pdf)   

[4] [Маркетинг больших данных. Эффективное привлечение клиентов и стимулирование развития бизнеса](https://www.amazon.com/Big-Data-Marketing-Customers-Effectively/dp/1118733894/ref=sr_1_12?ie=UTF8&qid=1387541531&sr=8-12&keywords=customer+churn)
