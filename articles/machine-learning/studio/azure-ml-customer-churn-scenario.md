...
Этот эксперимент был разработан и протестирован Сержем Бергером (Serge Berger), старшим научным сотрудником корпорации Майкрософт по обработке данных, и Роджером Барга (Roger Barga), ранее являвшимся руководителем проекта Студии машинного обучения Microsoft Azure. Группа составителей документации Azure с благодарностью подтверждает их квалификацию и выражает признательность за предоставление этого технического документа.
...
Как лучше всего можно реализовать интегрированный подход моделирования и оценки, принимая во внимание описанную проблему? В этом разделе демонстрируется выполнение данной задачи с помощью Студии машинного обучения Azure.  
...
![Снимок экрана со сложным рабочим пространством Студии со многими взаимосвязанными модулями](./media/azure-ml-customer-churn-scenario/churn-3.png)
...
*Рис. 7. Признаки, извлеченные из источника данных*
 

> Обратите внимание, что эти данные являются частными, поэтому общий доступ к модели и данным должен быть ограничен.
> Тем не менее для построения аналогичной модели в примере эксперимента [Telco Customer Churn](http://gallery.azure.ai/Experiment/31c19425ee874f628c847f7e2d93e383) из [Коллекции решений ИИ Azure](http://gallery.azure.ai/) используются общедоступные данные.
> 
...
*Рис. 8. Создание моделей в Студии Машинного обучения*  
...
Как правило, точность реализации в Студии машинного обучении Azure отстает от аналогичного показателя в SAS примерно на 10–15 % (площадь под кривой или AUC).  
...
*Рис. 9. Прототип Пассау: площадь под кривой*
...
*Рис. 11. Характеристики модели увеличивающегося дерева решений*
...
Еще одним интересным преимуществом студии машинного обучения Azure является возможность добавления настраиваемого модуля в репозиторий уже имеющихся предопределенных модулей. Она, по сути, позволяет выбрать библиотеки и создавать шаблоны для вертикальных рынков. Благодаря ей Студия машинного обучения Azure занимает выгодную позицию на рынке.  
...
В этой статье описывается разумный подход к решению распространенной проблемы, связанной с оттоком клиентов, на основе единой схемы. Мы рассмотрели прототип для моделей оценки и реализовали его с помощью Студии машинного обучения Azure. Наконец, мы оценили точность и производительность решения прототипа на уровне сопоставимых алгоритмов в SAS.  
...
[2] Статья из Википедии. [Точность и презиционность](http://en.wikipedia.org/wiki/Accuracy_and_precision).

[3] [CRISP-DM 1.0. Пошаговое руководство по интеллектуальному анализу данных](http://www.the-modeling-agency.com/crisp-dm.pdf)   

[4] [Маркетинг больших данных. Эффективное привлечение клиентов и стимулирование развития бизнеса](http://www.amazon.com/Big-Data-Marketing-Customers-Effectively/dp/1118733894/ref=sr_1_12?ie=UTF8&qid=1387541531&sr=8-12&keywords=customer+churn)

[5] [Шаблон модели оттока Telco](http://gallery.azure.ai/Experiment/Telco-Customer-Churn-5) в [коллекции решений ИИ Azure](http://gallery.azure.ai/) 
 
