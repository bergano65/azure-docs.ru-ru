---
title: Пример использования анализа настроений
titleSuffix: ML Studio (classic) - Azure
description: Как создать модели анализа текста в Azure Machine Learning Studio (классический) с помощью модулей для предварительной обработки текста, N-грамм или хэширования функций
...
ms.locfileid: "79217882"
---
# <a name="create-a-sentiment-analysis-model-in-azure-machine-learning-studio-classic"></a>Создание модели анализа настроений в студии машинного обучения Azure (классический)

[!INCLUDE [Notebook deprecation notice](../../../includes/aml-studio-notebook-notice.md)]

Для создания и эксплуатации моделей анализа текста можно использовать программу Azure Machine Learning Studio (классическая). Эти модели могут быть полезными, например, при решении проблем с классификацией документов или анализом мнений.
...
В этом учебнике, вы узнаете эти шаги, как мы идем через модель анализа настроений с помощью Amazon Book Reviews набор данных (см. эту исследовательскую работу "Биографии, Болливуд, Boom-boxes и Blenders: Домен Адаптация для классификации настроений" Джон Блитцер, Марк Дредзе и Фернандо Перейра; Ассоциация вычислительной лингвистики (ACL), 2007 г.) Этот набор данных состоит из обзорных баллов (1-2 или 4-5) и текста свободной формы. Целью является прогнозирование оценки в обзоре: низкая (1-2) или высокая (4-5).
