...
5.    В поле запросы к URL `https://catalog.cortanaanalytics.com/entities`-адресу найдите запрос GET и выберите вкладку *заголовки* . Прокрутите вниз до раздела *заголовков запросов* .
