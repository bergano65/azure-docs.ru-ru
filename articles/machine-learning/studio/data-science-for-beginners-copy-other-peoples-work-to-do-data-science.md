...
В эту службу также входит **[коллекция средств ИИ Azure](https://gallery.azure.ai/)**. Она содержит ресурсы, например коллекцию экспериментов Студии машинного обучения Azure, и модели, которые создали и предоставили другие пользователи. Эти эксперименты — отличный способ начать создание собственных решений, используя разработки других пользователей. Давайте внимательно его рассмотрим.
