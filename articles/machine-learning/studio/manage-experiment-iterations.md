...
description: Как управлять итерациями экспериментов в Студии машинного обучения Azure (классика). В любой момент вы можете просмотреть данные предыдущих выполнений эксперимента, чтобы поставить под вопрос, пересмотреть и, в конечном счете, подтвердить или уточнить предыдущие предположения.
...
---
# <a name="manage-experiment-iterations-in-azure-machine-learning-studio-classic"></a>Управление итерациями экспериментов в студии машинного обучения Azure (классический)
