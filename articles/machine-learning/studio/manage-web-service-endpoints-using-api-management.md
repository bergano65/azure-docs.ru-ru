...
* Рабочая область, служба и ключ API для эксперимента AzureML, развернутого в качестве веб-службы. Дополнительные сведения о создании эксперимента AzureML см. в [кратком руководстве](create-experiment.md)по работе с Studio. Сведения о развертывании эксперимента (классическая модель) в качестве веб-службы см. в разделе [руководство по развертыванию Studio](publish-a-machine-learning-web-service.md) для получения дополнительных сведений о развертывании эксперимента AzureML в качестве веб-службы. Инструкции по созданию и тестированию простого эксперимента AzureML и его развертывания в качестве веб-службы содержатся также в дополнении А.
...
![Выбор столбцов с помощью имен столбцов](./media/manage-web-service-endpoints-using-api-management/select-columns.png)
