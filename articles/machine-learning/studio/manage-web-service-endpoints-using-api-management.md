...
![Подключите модуль книги проверки набора данных к модулю столбцы проекта](./media/manage-web-service-endpoints-using-api-management/project-columns.png)
...
![Выберите столбцы, используя имена столбцов](./media/manage-web-service-endpoints-using-api-management/select-columns.png)
