...
description: Как отладить ошибки, созданные модулями Train Model и Score Model в Azure Machine Learning Studio (классический).
...
---
# <a name="debug-your-model-in-azure-machine-learning-studio-classic"></a>Отогладить модель в студии машинного обучения Azure (классический)
...
1. Тип модели машинного обучения из коллекции моделей, предоставленных Azure Machine Learning Studio (классика).
