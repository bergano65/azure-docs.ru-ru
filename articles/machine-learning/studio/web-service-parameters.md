---
title: Параметры web-сервиса - Студия машинного обучения Azure (классика) Документы Майкрософт
...
---
# <a name="use-azure-machine-learning-studio-classic-web-service-parameters"></a>Используйте параметры веб-сервиса Azure Machine Learning Studio (классические)
...
> [!NOTE]
> Документация API для классического веб-сервиса предоставляется через ссылку на **страницу справки API** в веб-сервисе **DASHBOARD** в машинной студии обучения (классический). Документация по API для новой веб-службы предоставляется на портале [веб-служб Машинного обучения Azure](https://services.azureml.net/Quickstart) на страницах **Consume** (Использование) и **Swagger API** этой веб-службы.
> 
> 
...
1. В студии машинного обучения (классический) щелкните модуль [экспортных данных,][writer] чтобы выбрать его. Его свойства отображаются на панели "Свойства" справа от холста эксперимента.
