...
ms.locfileid: "73838434"
---
# <a name="choose-parameters-to-optimize-your-algorithms-in-azure-machine-learning-studio-classic"></a>Выбор параметров для оптимизации алгоритмов в Машинное обучение Azure Studio (классическая модель)
...
Выбор модели осуществляется разными способами. В машинном обучении перекрестная проверка является одним из самых широко используемых методов выбора модели, и он является механизмом выбора модели по умолчанию в классической версии Машинное обучение Azure Studio. Поскольку классическая версия Машинное обучение Azure Studio поддерживает как R, так и Python, всегда можно реализовать собственные механизмы выбора модели с помощью R или Python.
...
На следующем рисунке показано, как это можно сделать в классической версии Машинное обучение Azure Studio.
...
Тот же модуль [параметров модели настройки][tune-model-hyperparameters] , который выполняет обучение всех моделей, соответствующих набору параметров, оценивает различные метрики, а затем создает оптимальную модель на основе выбранной метрики. Для этого модуля необходимо обязательно предоставить следующие входные данные:
