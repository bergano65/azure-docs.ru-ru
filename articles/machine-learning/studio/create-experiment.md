---
title: Простой эксперимент в Студии машинного обучения Azure | Документация Майкрософт
...
- [Студия машинного обучения. Справка по алгоритмам и модулям](https://msdn.microsoft.com/library/azure/dn905974.aspx). Это подробное руководство по всем модулям студии машинного обучения, включая алгоритмы машинного обучения.
