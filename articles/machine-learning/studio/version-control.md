...
В модели выполнения классической версии эксперимента Машинное обучение Azure Studio неизменяемый моментальный снимок будет отправляться планировщику заданий при каждом нажатии кнопки **выполнить** в редакторе экспериментов. Чтобы просмотреть этот список моментальных снимков, нажмите кнопку **Журнал выполнения** на панели команд в представлении редактора экспериментов.
...
Важным аспектом управления жизненным циклом приложений является возможность автоматического выполнения и развертывания приложения. В классической версии Машинное обучение Azure Studio это можно сделать с помощью [модуля PowerShell](https://aka.ms/amlps). Ниже приведен пример комплексных действий, которые относятся к стандартному автоматизированному процессу выполнения и развертывания ALM с помощью [модуля PowerShell машинное обучение Azure Studio (классическая модель)](https://aka.ms/amlps). Для выполнения каждого шага используется один или несколько командлетов PowerShell.
