...
* [**локальный файл**](import-data-from-local-file.md) на жестком диске, чтобы создать модуль набора данных в рабочей области;
* [**источники данных в Интернете**](import-data-from-online-sources.md), чтобы получать данные в ходе эксперимента с помощью модуля [Импорт данных][import-data];
* [**эксперимент Студии машинного обучения**](import-data-from-an-experiment.md), чтобы использовать данные, сохраненные в виде набора данных в Студии машинного обучения;
