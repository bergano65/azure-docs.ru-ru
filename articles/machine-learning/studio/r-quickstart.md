---
title: Краткое руководство по языку R
...
Данные, использующиеся в этой статье, а также сценарии на языке R можно [скачать здесь](https://github.com/Azure-Samples/MachineLearningSamples-Notebooks/blob/master/studio-samples/cadairydata.csv). Эти данные основаны на информации, собранной университетом Висконсина: https://dairymarkets.com.
...
Если вам пока не понятна последняя строка кода, не останавливайтесь. Далее в этом документе мы подробно рассмотрим использование языка R в среде Студии машинного обучения.

### <a name="introduction-to-rstudio"></a>Основные сведения об RStudio
RStudio — широко распространенная среда IDE для языка R. Я буду использовать RStudio для изменения, тестирования и отладки фрагментов кода на R, используемых в этом кратком руководстве. Когда код на R будет готов и проверен, его можно будет просто вырезать из редактора RStudio и вставить в модуль [выполнения скрипта R][execute-r-script] в Студии машинного обучения.  
...
* Книга Нормана Мэтлофа (Norman Matloff) "The Art of R Programming: A Tour of Statistical Software Design" (Искусство программирования: обзор проектирования ПО для статистической обработки) — хороший пример введения в программирование на R.  
...
* DataCamp. На сайте DataCamp обучение R происходит в вашем браузере с помощью видеоуроков и упражнений по программированию. Здесь представлены интерактивные учебники по последним методам кодирования на R и пакетам R. Изучите бесплатное интерактивное руководство по языку R: https://www.datacamp.com/courses/introduction-to-r
