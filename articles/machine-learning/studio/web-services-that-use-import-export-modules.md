---
title: Импорт и экспорт данных в веб-службах
...
ms.locfileid: "82209372"
---
# <a name="deploy-azure-machine-learning-studio-classic-web-services-that-use-data-import-and-data-export-modules"></a>Развертывание веб-служб Машинное обучение Azure Studio (классическая модель), использующих модули импорта и экспорта данных
...
7. В поле запросов базы данных введите следующий запрос:
     ...
     select [age],
        ...
        [income]
     from dbo.censusdata;
8. В нижней части холста эксперимента нажмите кнопку **выполнить**.
...
При написании приложения, которое вызывает окончательную веб-службу, может потребоваться указать другой входной запрос или целевую таблицу во время выполнения. Чтобы настроить эти входные и выходные данные, воспользуйтесь функцией "Web Service Parameters" (Параметры веб-службы). С ее помощью можно задать свойство *Data source* (Источник данных) модуля *Import Data* (Импорт данных) и свойство "Data destination" (Назначение данных) модуля *Export Data* (Экспорт данных).  Дополнительные сведения о параметрах веб-службы см. в [записи машинное обучение Azure Studio Web Service Parameters](https://blogs.technet.microsoft.com/machinelearning/2014/11/25/azureml-web-service-parameters/) в Cortana Intelligence и машинное обучение блоге.
...
5. В Visual Studio создайте консольное приложение c#: **New** > **Project** > **Visual C#** > **Классическая Desktop** > **консольное приложение (.NET Framework)**.
...
1. В нижней части холста эксперимента нажмите кнопку **выполнить**.
...
6. В Visual Studio создайте консольное приложение c#: **New** > **Project** > **Visual C#** > **Классическая Desktop** > **консольное приложение (.NET Framework)**.
