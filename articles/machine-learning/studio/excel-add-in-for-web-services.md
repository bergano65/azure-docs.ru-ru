...
---
# <a name="excel-add-in-for-azure-machine-learning-studio-classic-web-services"></a>Excel Add-in для сервисов Azure Machine Learning Studio (классические) веб-сервисы
...
Разверните новую веб-службу или используйте уже существующую. Для получения дополнительной информации о [Tutorial 3: Deploy credit risk model](tutorial-part3-credit-risk-deploy.md)развертывании веб-сервиса см.
...
**Использование классического веб-сервиса** 

1. В студии машинного обучения (классический) щелкните раздел **WEB SERVICES** в левом стеле, а затем выберите веб-сервис.
...
> [!NOTE]
> Теперь можно войти в [веб-сервис Azure Machine Learning Web Services,](https://services.azureml.net) чтобы получить ключ API для веб-сервиса Classic Machine Learning.
> 
> 

**Использование нового веб-сервиса**

1. На портале [веб-сервисов машинного обучения Azure](https://services.azureml.net) нажмите **на веб-сервис,** а затем выберите веб-сервис. 
...
1. Разверните новую веб-службу или используйте уже существующую. Для получения дополнительной информации о [Tutorial 3: Deploy credit risk model](tutorial-part3-credit-risk-deploy.md)развертывании веб-сервиса см.
2. Щелкните **Consume**(Использование).
3. Найдите раздел **Basic consumption info** (Основные сведения об использовании). Скопируйте и сохраните **первичный ключ** и URL-адрес **запроса-ответа**.
4. В Excel перейдите в раздел **Web Services** (если вы находитесь в разделе **«Прогноз»,** щелкните заднюю стрелку, чтобы перейти к списку веб-сервисов).
