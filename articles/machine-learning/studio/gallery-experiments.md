---
title: Эксперименты в Коллекции решений ИИ Azure — Студия машинного обучения Azure | Документация Майкрософт
description: Поиск и публикация экспериментов в коллекции решений ИИ Azure. Эксперимент — это холст в Студии машинного обучения, на котором можно создать модель прогнозной аналитики.
...
ms.locfileid: "53269307"
---
# <a name="discover-azure-machine-learning-studio-experiments-in-azure-ai-gallery"></a>Обнаружение экспериментов Студии машинного обучения Azure в Коллекции решений ИИ Azure
...
4. На странице **Experiment Description** (Описание эксперимента) введите название и теги. Используйте для них описательные выражения. Укажите конкретные методы, которые вы использовали, или проблему, которую вы решаете. Пример описательного названия эксперимента: "Двоичная классификация: анализ тональности в Twitter".
