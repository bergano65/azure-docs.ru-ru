---
title: Переподготовка классического веб-сервиса
titleSuffix: ML Studio (classic) - Azure
description: Узнайте, как переучивать модель и обновлять классический веб-сервис, чтобы использовать недавно обученную модель в Azure Machine Learning Studio (классический).
...
ms.locfileid: "79204245"
---
# <a name="retrain-and-deploy-a-classic-studio-classic-web-service"></a>Переподготовка и развертывание классического студийного (классического) веб-сервиса

[!INCLUDE [Notebook deprecation notice](../../../includes/aml-studio-notebook-notice.md)]

Повторное обучение моделей машинного обучения является одним из способов обеспечения точности и основывается на самых актуальных доступных данных. Эта статья покажет вам, как переквалифицировать классический студии (классический) веб-сервис. Для руководства о том, как переквалифицировать новый studio (классический) [веб-сервис, просмотрите эту статью.](retrain-machine-learning-model.md)
...
1. В нижней части панели мониторинга веб-службы нажмите **«Управление конечными точками предварительного просмотра».**
1. Нажмите кнопку **Добавить**.
1. Введите имя и описание новой конечной точки. Выберите уровень ведения журнала и укажите, включать ли образцы данных. Для получения дополнительной информации о регистрации [см.](web-services-logging.md)
...
> [!NOTE]
> Если вы добавили конечную точку в обучающий веб-сервис вместо службы Predictive Web Service, при нажатии на ссылку **Update Resource** вы получите следующую ошибку: «Извините, но эта функция не поддерживается или доступна в этом контексте. Эта веб-служба не содержит обновляемых ресурсов. We apologize for the inconvenience and are working on improving this workflow" (К сожалению, эта функция не поддерживается или недоступна в данном контексте. Приносим извинения за неудобства. Мы работаем над исправлением этой ошибки).
>
...
Значение параметра *«Имя»* в *Ресурсах* должно соответствовать названию ресурса сохраненной обученной модели в прогностическом эксперименте. Чтобы получить имя ресурса:

1. Войдите на [портал Azure](https://portal.azure.com).
1. В левом меню нажмите **Машинное обучение**.
1. В поле "Имя" выберите рабочую область, а затем щелкните **Веб-службы**.
1. Под именем, нажмите **Модель переписи (прогнозный exp.)**.
