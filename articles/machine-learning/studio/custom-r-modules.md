...
description: В этой статье описывается процедура создания и развертывания пользовательского R-модуля в Машинном обучении Azure. Здесь поясняется, что такое пользовательский R-модуль, и какие файлы используются для его создания. В этом разделе также описывается, как создать файлы, определяющие модуль, и зарегистрировать модуль для его развертывания в рабочей области Студии машинного обучения.
