...
description: Создание конечных точек веб-службы в Студии машинного обучения Azure. Каждая конечная точка в веб-службе адресуется, регулируется и управляется независимо.
...
ms.locfileid: "60751184"
---
# <a name="create-endpoints-for-deployed-azure-machine-learning-studio-web-services"></a>Создание конечных точек для развернутых веб-служб Студии машинного обучения Azure
