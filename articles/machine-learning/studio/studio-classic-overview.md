...
Разобраться в огромной библиотеке доступных алгоритмов машинного обучения вам поможет статья [Выбор алгоритмов Студии машинного обучения (классической)](algorithm-choice.md).
