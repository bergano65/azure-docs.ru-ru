---
заголовок: Создание пользовательских нейронных сетей с использованием Net# titleSuffix Студия машинного обучения Azure description: Руководство по синтаксису для языка спецификации нейтральных сетей Net#. Узнайте, как создать настраиваемые модели нейронной сети в Студии машинного обучения Azure.
