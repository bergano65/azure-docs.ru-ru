---
title: 'ML Studio (классическая модель): NET # Custom нейронные сети — Azure'
...
+ **Пакеты свертки**. Вы можете задать небольшие окрестности узлов в слое источника. Каждый узел в слое назначения подключается к одной окрестности узлов в слое источника.
...
Архитектура моделей нейронной сети, создаваемых в Машинное обучение Azure Studio (классическая модель), может быть расширена с помощью net #. Можно сделать следующее.
...
+ Арность свертки составляет три: длина кортежей `InputShape` ,, `KernelShape` `Stride` и `Sharing` .
