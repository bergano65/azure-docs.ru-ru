...
Архитектура моделей нейронной сети, создаваемых в классической версии Машинное обучение Azure Studio, может быть настроена с помощью net #. Вы можете:
