---
title: Пользовательские нейронные сети Net
titleSuffix: ML Studio (classic) - Azure
description: Руководство по синтаксису для языка спецификации нейтральных сетей Net#. Узнайте, как создавать пользовательские модели нейронных сетей в Azure Machine Learning Studio (классический).
...
ms.locfileid: "79218253"
---
# <a name="guide-to-net-neural-network-specification-language-for-azure-machine-learning-studio-classic"></a>Руководство по языку спецификации нейронных сетей сети Net» для студии машинного обучения Azure (классический)
...
+ **Конволюционные пучки**. Вы можете задать небольшие окрестности узлов в слое источника. Каждый узел в слое назначения подключается к одной окрестности узлов в слое источника.
...
Архитектура моделей нейронных сетей, создаваемых в Azure Machine Learning Studio (классическая), может быть тщательно настроена с помощью Сети. Вы можете:
...
+ Арность свертка три: длина `InputShape`корпозы, `KernelShape`, `Stride`и `Sharing`.
