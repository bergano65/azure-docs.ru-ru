---
title: Создание пользовательских нейронных сетей с использованием Net#
titleSuffix: Azure Machine Learning Studio
description: Руководство по синтаксису для языка спецификации нейтральных сетей Net#. Узнайте, как создать настраиваемые модели нейронной сети в Студии машинного обучения Azure.
...
Архитектуру моделей нейронных сетей, создаваемых в Студии машинного обучения Azure, можно настраивать в широком диапазоне с помощью Net#. Вы можете:
