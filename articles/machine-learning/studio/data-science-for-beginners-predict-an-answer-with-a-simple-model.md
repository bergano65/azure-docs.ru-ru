...
## <a name="transcript-predict-an-answer-with-a-simple-model"></a>Расшифровка. Прогнозирование ответа с помощью простой модели
...
Теперь мы зададим вопрос "в лоб": "How much will it cost to buy a 1.35 carat diamond?" (Во сколько обойдется алмаз весом в 1,35 карата?)
...
Теперь у нас есть модель и мы можем задать ей вопрос: "How much will a 1.35 carat diamond cost?" (Сколько будет стоить алмаз в 1,35 карата?)

Для ответа на вопрос мы проводим вертикальную линию от отметки 1,35 карата. От точки ее пересечения с линией модели проводим горизонтальную линию к оси цен. Она приводит нас к отметке 10 000. Вот так! Вот и ответ: "A 1.35 carat diamond costs about $10,000" (Алмаз массой 1,35 карата стоит около 10 000 долларов США).
