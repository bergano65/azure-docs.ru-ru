...
description: Описания наборов данных, используемых в примерах моделей, которые входят в состав Машинное обучение Studio (классическая модель). Эти наборы данных можно использовать для собственных экспериментов.
...
---
# <a name="use-the-sample-datasets-in-azure-machine-learning-studio-classic"></a>Использование образцов наборов данных в Машинное обучение Azure Studio (классическая модель)

[!INCLUDE [Notebook deprecation notice](../../../includes/aml-studio-notebook-notice.md)]

[top]: #machine-learning-sample-datasets

При создании рабочей области в Машинное обучение Azure Studio (классическая модель) по умолчанию включается ряд образцов наборов данных и экспериментов. Многие из этих примеров наборов данных используются в примерах моделей в [коллекции решений ИИ Azure](https://gallery.azure.ai/). Остальные примеры включают примеры различных типов данных, обычно используемых в машинном обучении.
...
Остальная часть тестовых наборов данных размещена в разделе **сохраненных наборов данных** в вашей рабочей области. Его можно найти в палитре модулей слева от холста эксперимента в Машинное обучение Studio (классическая модель).
...
<p></p>
<b>Использование:</b> Классификация людей, использующих демографические данные, для прогнозирования того, зарабатывает ли человек более 50 000 в год.
<p></p>
<b>Связанные исследования:</b> Kohavi, R., Becker, B., (1996). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук </td>
</tr>
...
<p></p>
<b>Использование:</b> Прогнозирование оценки рисков по функциям с помощью регрессии или многофакторная классификации. 
<p></p>
<b>Связанные исследования:</b> Schlimmer, J.C. (1987). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук </td>
</tr>
...
<p></p>
<b>Связанное исследование:</b> Yeh, I.C. (2008 г.). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук
<p></p>
В соответствии с шаблонами, Cheng, Иванов, короля-Jang и Ting, Tao-Ming, "обнаружение знаний в модели режима ограниченной функциональности с использованием последовательности Бернулли", "экспертные системы с приложениями", 2008,<a href="https://dx.doi.org/10.1016/j.eswa.2008.07.018">https://dx.doi.org/10.1016/j.eswa.2008.07.018</a>
  </td>
</tr>
...
<p></p>
<b>Связанное исследование:</b> Wohlberg, W.H., Street, W.N., & Mangasarian, O.L. (1995). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук </td>
</tr>
...
<tr>
  ...
  <td>
Метки из запроса на прогнозирование связи клиента KDD чашки 2009 (<a href="http://www.sigkdd.org/site/2009/files/orange_large_train_upselling.labels">orange_large_train_upselling. Метки</a>).
  </td>
</tr>
...
<p></p>
<b>Использование:</b> Используйте регрессию или классификацию для прогнозирования оценки эффективности энергопотребления на основе одного из двух реальных ценных ответов. Для многоклассовой классификации переменная ответа округляется до ближайшего целого числа. 
<p></p>
<b>Связанные исследования:</b> Xifara, A. & Tsanas,. (2012). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук </td>
</tr>

<tr>
  <td>Данные о задержках рейсов</td>
  <td>
Данные о соблюдении графиков пассажирских рейсов взяты из массива данных TranStats Министерство транспорта США (<a href="https://www.transtats.bts.gov/DL_SelectFields.asp?Table_ID=236&DB_Short_Name=On-Time">данные о соблюдении графиков</a>).
<p></p>
Набор данных охватывает период времени с апреля по октябрь 2013 г. Перед отправкой в Машинное обучение Azure Studio (классическая модель) набор данных был обработан следующим образом:
<ul>
...
<p></p>
<b>Связанные исследования:</b> Cortez, P., & Morais, A. (2008). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук
<p></p>
...
<p></p>
<b>Связанное исследование:</b> Fisher, R. A. (1988). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук </td>
</tr>
...
<p></p>
<b>Связанные исследования:</b> StatLib, Карнеги Меллон университета, (1993). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук </td>
</tr>
...
<p></p>
<b>Связанные исследования:</b> Sigillito, V. (1990). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml"> https://archive.ics.uci.edu/ml"</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук </td>
</tr>
...
<p></p>
<b>Использование:</b> Используйте этот набор данных в сочетании с другими двумя наборами данных ресторана, чтобы обучить и протестировать систему рекомендаций. 
<p></p>
<b>Связанные исследования:</b> Bache, K. и Lichman, M. (2013). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвайн, Калифорния: Калифорнийский университет, Школа информационных технологий и компьютерных наук.
  </td>
</tr>
...
<p></p>
<b>Связанные исследования:</b> Стерлингов, D. & Buntine, W. (НД). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин, Калифорния: Калифорнийский Университет, школа информационных и компьютерных наук
<p></p>
Полезное руководство по стальным оценкам можно найти здесь:<a href="https://otk-sitecore-prod-v2-cdn.azureedge.net/-/media/from-sharepoint/documents/product/outokumpu-steel-grades-properties-global-standards.pdf">https://otk-sitecore-prod-v2-cdn.azureedge.net/-/media/from-sharepoint/documents/product/outokumpu-steel-grades-properties-global-standards.pdf</a>
  </td>
</tr>
...
<p></p>
<b>Связанное исследование:</b> Bock, R. K. (1995). UCI Машинное обучение репозиторий <a href="https://archive.ics.uci.edu/ml">https://archive.ics.uci.edu/ml</a>. Ирвин: Калифорнийский университет, школа информационных наук </td>
</tr>
...
<p></p>
Данные представляют собой наблюдения за погодой, осуществленные с метеорологических станций аэропортов, которые охватывают период времени с апреля по октябрь 2013 г. Перед отправкой в Машинное обучение Azure Studio (классическая модель) набор данных был обработан следующим образом:
<ul>
...
<tr>
  ...
  <td>
Данные извлекаются из Википедии<a href="https://www.wikipedia.org/">https://www.wikipedia.org/</a>() на основе статей каждой&компании P 500, хранящейся в виде XML-данных.
<p></p>
Перед отправкой в Машинное обучение Azure Studio (классическая модель) набор данных был обработан следующим образом:
<ul>
...
<tr>
  ...
  <td>
Назначения разделов для новостных статей в наборе данных новостей RCV1-V2 Reuters. Новостная статья может быть назначена нескольким разделам. Каждая строка имеет формат&lt;"имя&gt; &lt;раздела идентификатор&gt; документа 1". Набор данных содержит 2,6 млн назначений разделов. Набор данных предоставлен Дэвидом Д. Г. Lewis).
  </td>
</tr>
...
> [Kickstart эксперименты с примерами](sample-experiments.md)
