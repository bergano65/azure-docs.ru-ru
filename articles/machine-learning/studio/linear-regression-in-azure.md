...
* При использовании модуля [Линейная регрессия][linear-regression] в Студии доступно два метода:
...
Параллельное выполнение экспериментов Студии и регрессии Excel позволило узнать много нового. Создание базовой модели в Excel и ее сравнение с моделями с использованием [линейной регрессии][linear-regression] Машинного обучения помогло нам изучить Студию. Кроме того, мы обнаружили возможности усовершенствования выбора данных и повышения производительности модели. 

Мы также поняли, что в будущем для более быстрого получения результатов по проектам прогнозирования целесообразно использовать модуль [Filter-Based Feature Selection][filter-based-feature-selection] (Выбор признаков на основе фильтра). Применив выборку признаков к данным, можно создать улучшенную модель Студии с более высокой общей производительностью. 
