...
* **R Inferno** по (Patrick Burns) является юмористическом адский Патрика Бернса, которыми можно столкнуться при программировании на R. Книга доступна по адресу [R Inferno](http://www.burns-stat.com/documents/books/the-r-inferno/).
