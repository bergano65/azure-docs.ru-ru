...
description: Узнайте, как Машинное обучение Azure позволяет масштабировать задание обучения TensorFlow с помощью эластичных облачных ресурсов.
