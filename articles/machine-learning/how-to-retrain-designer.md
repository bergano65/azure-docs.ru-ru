...
* Набор данных, доступный конструктору. Может иметь одно из следующих значений.
   * Машинное обучение Azure зарегистрированный набор данных
    
     **ни**
   * Файл данных, хранящийся в хранилище Машинное обучение Azure.
   
Сведения о доступе к данным с помощью конструктора см. в статье [Импорт данных в конструктор](how-to-designer-import-data.md).
