...
| Свойство | Описание |
|:--- |:---|
| Время создания | Время создания записи журнала |
...
| ----- | ----- | ----- |
| Сбой развертывания модели | Число | Число неудачных развертываний моделей. |
| Развертывание модели начато | Число | Число запущенных развертываний моделей. |
| Развертывание модели прошло | Число | Число удачных развертываний модели. |
| Не удалось зарегистрировать модель | Число | Число неудачных регистраций модели. |
| Регистрация модели прошла | Число | Число удачных регистраций в модели. |
...
| Метрика | Единицы | Описание |
| ----- | ----- | ----- |
| Активные ядра | Число | Количество активных ядер вычислений. |
| Активные узлы | Число | Количество активных узлов. |
| Бездействующие ядра | Число | Число бездействующих ядер вычислений. |
| Бездействующие узлы | Число | Число бездействующих узлов вычислений. |
| Освобождение ядер | Число | Число покидает ядер. |
| Покинуть узлы | Число | Количество покидает узлов. |
| Вытесненные ядра | Число | Число ядер с вытеснением. |
| Прерванные узлы | Число | Количество вытесненных узлов. |
| Процент использования квоты | Процент | Процент используемой квоты. |
| Всего ядер | Число | Общее число ядер. |
| Всего узлов | Число | Общее число узлов. |
| Непригодные для использования ядра | Число | Число неиспользуемых ядер. |
| Неиспользуемые узлы | Число | Число неиспользуемых узлов. |
...
| Метрика | Единицы | Описание |
| ----- | ----- | ----- |
| Завершенные запуски | Число | Число завершенных запусков. |
| Неудачные запуски | Число | Число неудачных выполнений. |
| Запущенные запуски | Число | Число запущенных запусков. |
