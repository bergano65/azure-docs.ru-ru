---
title: 'ML Studio (классическая модель): обработка и анализ данных для начинающих — Azure'
...
* Если вы наблюдаете в Интернете, то можете ли вы сказать: это сообщение от обычного Интернета?

Функция обнаружения аномалий регистрирует неожиданные или необычные события или особенности поведения. А также подсказывает, где могут быть проблемы.
...
Иногда требуется понять структуру набора данных, то есть задать вопрос "Как это организовано?" Для этого вопроса у вас нет примеров, для которых вы уже узнали результаты.
...
Ответом на вопрос всегда является то, какое действие необходимо выполнить. Обычно это относится к машине или роботу. Ниже приведены некоторые примеры.
