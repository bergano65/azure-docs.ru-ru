...
К счастью, это можно сделать с помощью [API-интерфейса переобучения машинное обучение Azure Studio (классическая модель)](/azure/machine-learning/studio/retrain-machine-learning-model) и автоматизации задачи с помощью среды [PowerShell для машинное обучение Azure Studio (классическая модель)](powershell-module.md).
