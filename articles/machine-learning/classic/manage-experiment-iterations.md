...
## <a name="view-the-prior-run"></a>Просмотр предыдущих выполнений
...
## <a name="view-the-run-history"></a>Просмотр журнала выполнения
...
## <a name="run-a-previous-experiment"></a>Выполнение предыдущего эксперимента
