---
title: 'Учебник 3 по Студии машинного обучения (классической): развертывание моделей кредитных рисков в Azure'
description: Подробный учебник по созданию решения прогнозной аналитики для оценки кредитных рисков в Студии машинного обучения Azure (классической). Это руководство представляет собой третью, заключительную часть серии руководств. В нем описывается развертывание модели в качестве веб-службы.
...
> [!TIP]
> Процесс преобразования обучающего эксперимента в прогнозный эксперимент см. в статье [How to prepare your model for deployment in Azure Machine Learning Studio (classic)](deploy-a-machine-learning-web-service.md) (Подготовка модели к развертыванию в Студии машинного обучения Azure (классической)).
