...
* Дополнительные сведения о готовности модели к развертыванию см. в статье [Подготовка модели к развертыванию в машинное обучение Azure Studio (классическая модель)](deploy-a-machine-learning-web-service.md).
