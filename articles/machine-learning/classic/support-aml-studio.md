...
+ [Учебники и статьи с инструкциями](./index.yml) 
+ [Задайте вопрос, на который можно ответить с помощью данных](./data-science-for-beginners-ask-a-question-you-can-answer-with-data.md) 
