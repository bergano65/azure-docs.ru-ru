...
ms.locfileid: "82891515"
---
# <a name="manage--increase-quotas-for-resources-with-azure-machine-learning"></a>Управление & увеличение квот для ресурсов с Машинное обучение Azure
[!INCLUDE [applies-to-skus](../../includes/aml-applies-to-basic-enterprise-sku.md)]

Эта статья содержит [машинное обучение Azure](overview-what-is-azure-ml.md) пользователей с подробными сведениями о предварительно настроенных ограничениях для ресурсов Azure для вашей подписки. Также включены инструкции по запросу улучшений квот для каждого типа ресурсов. Эти ограничения применяются во избежание перерасхода бюджета из-за мошенничества, а также для соблюдения ограничений по объемам ресурсов Azure.

Как и в случае с другими службами Azure, существуют ограничения на определенные ресурсы, связанные с Машинное обучение Azure. Эти ограничения находятся в диапазоне от ограничения количества [рабочих областей](concept-workspace.md) до ограничений на фактическое базовое вычисление, которое используется для обучения модели или вывода или оценки. 
...
Более подробный и актуальный список ограничений квоты см. в [статье квота на уровне Azure](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits).

### <a name="azure-machine-learning-compute"></a>Вычислительная среда Машинного обучения Azure;
Для [машинное обучение Azure вычислений](concept-compute-target.md#azure-machine-learning-compute-managed)существует квота по умолчанию как на количество ядер, так и на количество уникальных ресурсов вычислений, разрешенных для каждого региона в подписке. Эта квота отделена от квоты ядра ВМ выше, и ограничения ядра не являются общими для двух типов ресурсов, так как Амлкомпуте — это управляемая служба, которая развертывает ресурсы в модели с размещением от имени пользователя.
...
Для [машинное обучение Azure конвейеров](concept-ml-pipelines.md)существует квота на количество шагов в конвейере и количество выполненных на основе расписания планов опубликованных конвейеров на регион в подписке.
...
+ [Планирование & управления затратами для Машинное обучение Azure](concept-plan-manage-cost.md)

+ [Как увеличить квоту](https://docs.microsoft.com/azure/azure-resource-manager/resource-manager-quota-errors).
