...
description: Сведения о квотах на ресурсы для Машинное обучение Azure и о том, как запросить увеличение квоты.
...
> [!IMPORTANT]
> Границы могут измениться. Последние сведения см. в статье [Подписка Azure, ограничения службы, квоты и ограничения](https://docs.microsoft.com/azure/azure-resource-manager/management/azure-subscription-service-limits/) для всех Azure.
