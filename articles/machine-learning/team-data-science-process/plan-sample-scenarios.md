...
1. Предварительно обработайте и очистите данные (необязательно).
   ...
   2\.  Очистите данные и при необходимости преобразуйте их в табличную форму.
...
1. Загрузите данные в базу данных SQL Server на виртуальной машине Azure.
   ...
   2\.  Если данные еще не сохранены, скачайте файлы данных из Azure.
...
## <a name="largedbtodb"></a>Сценарий \#№6. Большой набор данных в базе данных SQL Server в локальной среде, предназначенные для SQL Server в виртуальных машинах Azure
...
1. Экспортируйте данные из SQL Server в файлы дампа, используя один из методов экспорта данных.
   ...
   > [!NOTE]
   > Если вы решите перенести все данные из локальную базу данных, альтернативным методом (быстрее), чтобы переместить базу данных полный экземпляр SQL Server в Azure. Пропустите шаги для экспорта данных, создайте базу данных, загрузите или импортируйте данные в целевую базу данных и воспользуйтесь альтернативным методом.
   > 
   > 
...
1. Загрузите данные в базу данных Hive в кластере Azure HDInsight Hadoop.
   ...
   2\.  Откройте командную строку Hadoop.
