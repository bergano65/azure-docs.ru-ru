...
* Чтобы создать собственную учетную запись хранения Azure, выполните действия, описанные в статье [об учетных записях хранения Azure](../../storage/common/storage-create-storage-account.md). Убедитесь, что вы записали значения данных учетной записи хранения, так как они потребуются позже в этом пошаговом руководстве.
