...
2. Получение данных в Студии машинного обучения Azure.
...
В этом упражнении мы уже изучили и спроектировали данные в Хранилище данных SQL и определились с размером выборки для приема в Студии машинного обучения Azure. Вот процедура, позволяющая создать одну или несколько моделей прогнозирования:
