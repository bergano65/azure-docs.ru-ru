...
Чтобы начать упражнение по моделированию, войдите в рабочую область **машинное обучение Azure (классическая)** . Если вы еще не создали рабочую область машинного обучения, см. статью [Создание рабочей области машинное обучение Azure Studio (классическая модель)](../studio/create-workspace.md).

1. Чтобы приступить к работе с Машинное обучение Azure, см [. раздел что такое машинное обучение Azure Studio (классическая модель)?](../studio/what-is-ml-studio.md)
