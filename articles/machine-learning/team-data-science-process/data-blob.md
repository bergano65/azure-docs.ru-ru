...
## <a name="blob-dataexploration"></a>Исследование данных
...
После изучения данных и создания необходимых функций можно передать данные (Samples или признаками) в большой двоичный объект Azure и использовать их в Машинное обучение Azure выполните следующие действия. Обратите внимание, что на компьютере Azure можно создать дополнительные функции. Также учебные студии (классическая модель). 
