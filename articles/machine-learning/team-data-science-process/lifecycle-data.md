...
Наряду с исходным процессом приема и очистки данных, как правило, требуется настроить еще и процесс оценки новых данных или их регулярного обновления в ходе обучения. Для этого настройте конвейер данных или рабочий процесс. В статье [Перенос данных из локального SQL Server в базу данных SQL Azure с Фабрикой данных Azure](move-sql-azure-adf.md) приведен пример настройки конвейера с помощью [Фабрики данных Azure](https://azure.microsoft.com/services/data-factory/). 
