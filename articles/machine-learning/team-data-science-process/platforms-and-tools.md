...
- SQL Server 2019 служб R и Python
- Azure Databricks
...
Он также включает **средства машинного обучения и AI** , такие как xgboost, Mxnet и Vowpal Wabbit.
...
Дополнительные сведения о выпуске Windows DSVM см. в [статье виртуальная машина Майкрософт](https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-dsvm.dsvm-windows) для обработки и анализа данных в Azure Marketplace. Выпуск виртуальной машины для обработки и анализа данных для Linux [описан здесь](https://azure.microsoft.com/marketplace/partners/microsoft-ads/linux-data-science-vm/).

Чтобы узнать, как эффективно выполнять некоторые общие задачи обработки и анализа данных в DSVM, см. статью [10 вещей, которые можно выполнить на виртуальной машине для обработки и анализа данных](../data-science-virtual-machine/vm-do-ten-things.md) .
...
## <a name="sql-server-2019-r-and-python-services"></a>SQL Server 2019 служб R и Python

Службы R Services (в базе данных) предоставляют платформу для разработки и развертывания интеллектуальных приложений, которые могут выкрывать новые ценные сведения. Вы можете использовать полнофункциональный мощный язык R и множество пакетов, созданных сообществом R, чтобы разрабатывать модели и формировать прогнозы на основе данных, хранящихся в SQL Server. Поскольку службы R (в базе данных) интегрируют язык R в SQL Server, аналитика остается близкой к данным, что устраняет расходы и риски безопасности, связанные с перемещением данных.

Службы r (в базе данных) поддерживают язык R с открытым исходным кодом с полным набором средств и технологий SQL Server. Они обеспечивают высокую производительность, безопасность, надежность и управляемость. Для развертывания решений R вам доступны удобные и знакомые средства. Ваши рабочие приложения могут вызывать среду выполнения R, получать прогнозы и визуальные элементы с использованием Transact-SQL. Кроме того, вы можете использовать библиотеки ScaleR для увеличения масштаба и производительности решений R. Дополнительные сведения см. в разделе [SQL Server R Services](https://docs.microsoft.com/sql/advanced-analytics/r/sql-server-r-services).
...
1. Щелкните **< свое имя\>** в правом верхнем углу страницы и щелкните **Безопасность**. 
...
Примеры, в которых показано, как выполнить шаги в процессе обработки и анализа данных группы с помощью Машинное обучение Azure Studio (классическая модель), см. в статье Руководство по обучению [машинного обучения Azure](https://docs.microsoft.com/azure/machine-learning/team-data-science-process/) .
