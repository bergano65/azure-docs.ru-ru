...
Дополнительные сведения о выпуске Windows DSVM см. в [статье виртуальная машина Майкрософт](https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-dsvm.dsvm-win-2019) для обработки и анализа данных в Azure Marketplace. Выпуск виртуальной машины для обработки и анализа данных для Linux [описан здесь](https://azure.microsoft.com/marketplace/apps/microsoft-dsvm.ubuntu-1804).
...
1. Щелкните **<свое имя\> ** в правом верхнем углу страницы и выберите **Безопасность**. 
