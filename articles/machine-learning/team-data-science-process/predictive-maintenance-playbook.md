...
Потоковые данные с датчиков (или из других источников) используемого оборудования являются важным источником данных. Ключевое допущение в PdM заключается в том, что состояние работоспособности компьютера снижается со временем во время выполнения своей процедуры. Ожидается, что данные содержат изменяющиеся со временем признаки, которые отражают эту временную закономерность, и любые аномалии, которые ведут к ухудшению работоспособности. Временной аспект данных необходим для того, чтобы алгоритм мог изучать шаблоны наличия и отсутствия сбоев с течением времени. Основываясь на этих точках данных, алгоритм учится прогнозировать, сколько еще единиц времени оборудование сможет продолжать работать, до того как выйдет из строя.
...
Двоичная классификация используется для _прогнозирования вероятности сбоя элемента оборудования в течение следующего периода времени_ , называемого _периодом X в будущем_. X определяется бизнес-проблемой и данными в ходе консультации с экспертом по предметной области. Ниже приведены некоторые примеры.
