---
title: Просмотр данных в хранилище BLOB-объектов Azure с помощью Pandas | Документы Майкрософт
description: Описание просмотра данных, которые хранятся в контейнере BLOB-объектов Azure, с помощью Pandas.
