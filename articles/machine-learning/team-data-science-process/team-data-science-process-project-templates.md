...
[Гибкая разработка проектов в области науки о данных](agile-development.md) В этом документе описывается проект по науке о данных систематическим, контролируемым версиями и совместным способом с помощью процесса team Data Science Process.
