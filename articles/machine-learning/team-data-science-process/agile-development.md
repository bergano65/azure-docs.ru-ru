...
При планировании спринта на платформе TDSP выделяют четыре распространенных типа **рабочих элементов**: **возможность**, **пользовательская история**, **задача** и **ошибка**. Для каждого проекта поддерживается один список невыполненных работ для всех рабочих элементов. На уровне репозитория Git список невыполненных работ для проекта не предусмотрен. Ниже приведены определения рабочих элементов:
