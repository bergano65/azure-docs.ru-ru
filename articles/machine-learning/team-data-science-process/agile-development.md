...
1. На странице **проекта в области** навигации слева выберите **доски** > невыполненные работы. 
...
1. На вкладке **Невыполненная работа** выберите **+** слева от компонента. 
...
1. В созданном проекте выберите **доски** ** > ** невыполненные работы в левой области навигации.
...
1. Чтобы добавить рабочий элемент в проект TDSP, выберите **+** рядом с проектом, а затем выберите тип создаваемого рабочего элемента. 
