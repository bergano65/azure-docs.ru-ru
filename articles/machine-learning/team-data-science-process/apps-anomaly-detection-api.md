...
| Категория средства обнаружения | Средство обнаружения | Description (Описание) | Входные параметры | outputs |
| --- | --- | --- | --- | --- |
...
| Входные параметры | Description (Описание) | Значение по умолчанию | Тип | Допустимый диапазон значений | Рекомендуемый диапазон значений |
| --- | --- | --- | --- | --- | --- |
