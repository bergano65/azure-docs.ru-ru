...
* Цифра единиц (один десятичный градус) дает положение с точностью до 111 километров (60 морских миль, или около 69 миль). Она приблизительно указывает, какие крупном региону или стране мы находимся.
