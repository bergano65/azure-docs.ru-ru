...
* [Отсчет на основе поколения функций](#sql-countfeature)
...
В этом документе показаны два способа создания количественных характеристик. В первом способе используется условная сумма, а во втором — предложение "where". Эти новые функции могут быть соединены с исходной таблицей (с использованием основных ключевых столбцов), чтобы иметь функции подсчета наряду с исходными данными.
...
* Цифра единиц (один десятичный градус) дает положение с точностью до 111 километров (60 морских миль, или около 69 миль). Это, грубо говоря, указывает на то, в каком крупном государстве или стране/регионе мы находимся.
...
* Шестое десятичное место стоит до 0,11 м: этот уровень можно использовать для детального прокладки конструкций, для проектирования ландшафтов, строительства дорог. Этого уровня более чем достаточно для отслеживания движения ледников и рек. Эта цель может быть достигнута путем принятия кропотливых мер с GPS, таких как дифференциально исправлены GPS.

Сведения о расположении можно включить в признаки, выделяя информацию о регионе, расположении и городе. После того, как можно также вызвать REST конечную точку, например Bing Maps API (см., `https://msdn.microsoft.com/library/ff701710.aspx` чтобы получить информацию о регионе /районе).
