...
* [Создание характеристик на основе количества](#sql-countfeature)
...
Сведения о расположении можно включить в признаки, выделяя информацию о регионе, расположении и городе. Один раз также может вызывать конечную точку RESTFUL, например API Карт Bing (см. `https://msdn.microsoft.com/library/ff701710.aspx` для получения сведений о регионе или районе).
