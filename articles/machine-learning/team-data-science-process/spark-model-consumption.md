...
Файлы с данными о поездках в такси по Нью-Йорку и тарифах были объединены с помощью процедуры, описанной в статье [Процесс обработки и анализа данных группы на практике: использование кластеров Azure HDInsight Hadoop](hive-walkthrough.md).
...
Время выполнения кода выше: 46,37 с
...
Время выполнения кода выше: 5,37 с
...
Время выполнения кода выше: 11,72 с
...
Время выполнения кода выше: 19,22 с
...
Время выполнения кода выше: 16,63 с
...
Время выполнения кода выше: 31,07 с
...
Время выполнения кода выше: 14,6 с
