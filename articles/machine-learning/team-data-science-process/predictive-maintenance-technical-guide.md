...
Запрос во втором задании Stream Analytics _ *maintenancesa02asablob* * просто выводит все события [концентратора событий](https://azure.microsoft.com/services/event-hubs/) в службу [хранилища Azure](https://azure.microsoft.com/services/storage/) и поэтому не требует изменения вне зависимости от формата данных, так как все данные о событиях передаются в хранилище.
...
2. Войдите в [Power BI Online](https://www.powerbi.com)
   ...
   * Убедитесь, что панель * **визуализации** _ открыта и отображается в правой части экрана.
