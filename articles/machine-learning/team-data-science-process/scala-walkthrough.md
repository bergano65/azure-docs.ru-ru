...
* Двоичная классификация: прогнозирование суммы чаевых (в долларах) за поездку в такси.
...
* Для выполнения дальнейших действия требуется кластер Azure HDInsight 3.4 Spark 1.6. Создайте его, выполнив инструкции из руководства по [ созданию кластера Apache Spark в Azure HDInsight](../../hdinsight/spark/apache-spark-jupyter-spark-sql.md). Укажите тип и версию кластера с помощью меню **Выберите тип кластера** .
...
Время, затраченное на выполнение кода: 8 с.
...
Время, затраченное на выполнение кода: 4 с.
...
Время, затраченное на выполнение кода: 2 с.
...
Время, затраченное на выполнение кода: 13 с.
...
Время, затраченное на выполнение кода: 33 с.
...
Время, затраченное на выполнение кода: 61 с.
