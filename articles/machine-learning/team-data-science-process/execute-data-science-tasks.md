...
## <a name="1--exploration"></a>1. <a name='DataQualityReportUtility-1'></a> Разведка 
...
Такие продукты, как Azure Machine Learning, также обеспечивают [расширенную подготовку данных к](../how-to-create-register-datasets.md) обработке данных и исследованию данных, включая создание функций. Пользователь должен выбрать инструменты, библиотеки и пакеты, которые лучше всего подходят для выполнения его задач. 
