...
Это вводная статья, которая содержит ссылки на руководства с инструкциями по настройке среды TDSP для всей группы обработки и анализа данных, для отдельных команд и проектов.
В ней приведены подробные инструкции по использованию Azure DevOps в руководствах. Azure DevOps обеспечивает платформу для размещения кода и гибкий инструмент планирования, помогающие управлять задачами команды, контролировать доступ и управлять репозиториями.

Вы можете использовать эту информацию для внедрения процесса TDSP на основе собственных инструментов для размещения кода и гибкого планирования.
...
Эта структура подразумевает наличие руководителей групп и команд. Как правило, проект обработки и анализа данных выполняется одной командой обработки и анализа данных, в которую входят руководители проектов (они выполняют задачи по управлению проектом и руководству), а также инженеры и (или) специалисты по обработке и анализу данных (отдельные участники, технический персонал), которые непосредственно выполняют технические действия по обработке и анализу данных в рамках проекта. Перед выполнением проекта руководители групп, команд и (или) проектов выполняют подготовку и распределение задач.

## <a name="definition-of-four-tdsp-roles"></a>Определение четырех ролей в рамках TDSP
На основе изложенных выше предположений выделяются четыре основные роли для персонала команд.
...
> [!NOTE]
> В зависимости от структуры на предприятии один человек может выполнять несколько ролей или одна роль может быть распределена между несколькими сотрудниками. Такое часто практикуется на предприятиях небольшого размера или с небольшим количеством сотрудников в подразделении обработки и анализа данных.
...
> [!NOTE]
> В приведенных ниже инструкциях перечислены процедуры настройки среды TDSP и выполнения других задач обработки и анализа данных в Azure DevOps. Мы объясняем, как выполнить эти задачи с помощью Azure DevOps, так как на базе именно этой платформы мы реализуем TDSP в Майкрософт. Azure DevOps облегчает совместную работу, интегрируя управление рабочими элементами для отслеживания задач. Служба размещения кода предоставляет возможности совместного использования программ, контроля версий и управления безопасностью на основе ролей. При желании вы можете выбрать для реализации задач, описанных в TDSP, другие удобные для вас платформы. Но в зависимости от выбора платформы могут оказаться недоступными некоторые функции, для которых мы используем Azure DevOps.
>
>Кроме того, в приведенных инструкциях в качестве компьютера аналитики используется [Виртуальная машина для обработки и анализа данных](https://aka.ms/dsvm) в облаке Azure, которая укомплектована популярными средствами обработки и анализа данных и интегрирована с программным обеспечением Майкрософт и службами Azure. Для реализации TDSP вы можете использовать виртуальную машину для обработки и анализа данных или любую другую среду разработки.
...
- Создание **групповой учетной записи** на платформе размещения кода (GitHub, Git, Azure DevOps или любой другой).
- Создание **репозитория шаблонов проектов** в групповой учетной записи, а также заполнение его данными из репозитория шаблонов проектов, который поддерживается командой TDSP корпорации Майкрософт. Репозиторий шаблонов проектов TDSP от корпорации Майкрософт:
    - предоставляет **стандартизованную структуру каталогов**, включая каталоги для данных, кода и документов;
    - предоставляет набор **стандартизованных шаблонов документов** для эффективного анализа и обработки данных.
- Создание **репозитория служебных программ** и заполнение его данными из репозитория служебных команд, который поддерживается командой TDSP корпорации Майкрософт. Репозиторий служебных программ TDSP от корпорации Майкрософт:
    - набор полезных служебных программ для повышения эффективности работы специалистов по обработке и анализу данных. Сюда входят служебные программы для интерактивного исследования данных, анализа и подготовки отчетов, а также для создания базовых моделей и отчетов по ним.
...
- Создание **командного проекта** на сервере Azure DevOps группы, если служба Azure DevOps выбрана в качестве платформы для размещения кода, контроля версий и совместной работы. В противном случае эту задачу можно пропустить.
- Создание **репозитория шаблонов проектов** в проекте и заполнение его данными из группового репозитория шаблонов проектов, который создается менеджером группы или его заместителем.
...
- Создание **репозитория** в проекте и заполнение его данными из репозитория шаблонов проектов.
...
Инструкции по выполнению проекта разрабатывались на основе предположения, что рабочие элементы и репозитории Git для проекта размещаются в Azure DevOps. Использование Azure DevOps для обеих целей позволяет связывать рабочие элементы с ветвями Git в репозитории проекта. Так вы сможете легко отслеживать все операции с рабочими элементами.
