...
Это вводная статья, которая содержит ссылки на руководства с инструкциями по настройке среды TDSP для всей группы обработки и анализа данных, для отдельных команд и проектов. В ней приведены подробные инструкции по использованию Azure DevOps в руководствах. Azure DevOps обеспечивает платформу для размещения кода и гибкий инструмент планирования, помогающие управлять задачами команды, контролировать доступ и управлять репозиториями. 
