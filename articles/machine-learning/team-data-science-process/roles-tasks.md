...
>
>Кроме того, в приведенных инструкциях в качестве компьютера аналитики используется [Виртуальная машина для обработки и анализа данных](http://aka.ms/dsvm) в облаке Azure, которая укомплектована популярными средствами обработки и анализа данных и интегрирована с программным обеспечением Майкрософт и службами Azure. Для реализации TDSP вы можете использовать виртуальную машину для обработки и анализа данных или любую другую среду разработки. 
