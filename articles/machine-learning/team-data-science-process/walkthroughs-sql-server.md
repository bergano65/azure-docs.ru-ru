...
В пошаговом руководстве по [использованию SQL Server R Services](/sql/machine-learning/tutorials/walkthrough-data-science-end-to-end-walkthrough) показано, как создать и развернуть модель R для SQL Server. Пошаговое руководство предназначено для ознакомления разработчиков R со службами R Services (в базе данных).
...
В пошаговом руководстве [In-Database Python Analytics for SQL Developers](/sql/advanced-analytics/tutorials/sqldev-in-database-python-for-sql-developers) (Аналитика на Python в базе данных для разработчиков SQL), предназначенном для программистов SQL, описан практический опыт создания решения машинного обучения в SQL Server. Демонстрируется, как внедрить Python в приложение, добавив код Python в хранимые процедуры.
