...
Процесс обучения модели включает следующие шаги: 
   ...
   * **Разделение входных данных** случайным образом для моделирования в набор обучающих данных и набор тестовых данных.
...
На этом этапе создаются следующие артефакты.
   ...
   * [Наборы функций](https://github.com/Azure/Azure-TDSP-ProjectTemplate/blob/master/Docs/Data_Report/Data%20Defintion.md): Функции, разработанные для моделирования, описаны в разделе **наборов функций** отчета **об определении данных.** Здесь есть указатели на код, создающий эти признаки, и описание самого процесса создания.
   ...
   * **Решение контрольно-пропускного пункта**: Оцените, работает ли модель достаточно для производства. Здесь нужно ответить на такие вопросы.
