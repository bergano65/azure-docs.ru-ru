...
На этом этапе создаются следующие артефакты.
   ...
   * [Наборы признаков](https://github.com/Azure/Azure-TDSP-ProjectTemplate/blob/master/Docs/Data_Report/Data%20Defintion.md). Признаки, разработанные для моделирования, описываются в разделе **Набор признаков** отчета по **определению данных**. Здесь есть указатели на код, создающий эти признаки, и описание самого процесса создания.
