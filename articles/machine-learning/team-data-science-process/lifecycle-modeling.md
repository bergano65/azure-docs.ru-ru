...
На этом этапе создаются следующие артефакты.
   ...
   * [Отчет по моделированию](https://github.com/Azure/Azure-TDSP-ProjectTemplate/blob/master/Docs/Model/Model%201/Model%20Report.md). Для каждой проверенной модели создается стандартный отчет по указанному шаблону, в котором указаны подробные данные о каждом эксперименте.
