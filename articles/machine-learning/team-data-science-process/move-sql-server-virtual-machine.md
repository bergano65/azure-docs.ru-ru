...
2. Непосредственное создание виртуальных машин SQL Server в Azure с использованием скопированной базы данных или копирование в существующую базу данных SQL Azure. Дополнительные сведения см. в статье [Use the Copy Database Wizard](https://msdn.microsoft.com/library/ms188664.aspx).
