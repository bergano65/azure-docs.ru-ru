...
1. В диалоговом окне Регистрация укажите имя Организации Azure DevOps и примите назначение региона узла или расположите и выберите другой регион. Затем нажмите **Продолжить**. 
...
1. Повторите импорт, чтобы импортировать содержимое репозитория **служебных программ** Microsoft TDSP Team, *\/HTTPS:/GitHub.com/Azure/Azure-TDSP-Utilities.git*, в репозиторий **GroupUtilities** . 
