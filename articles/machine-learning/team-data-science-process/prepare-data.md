...
В этой статье описываются различные основные понятия и задачи обработки данных, которые можно выполнить до или после приема данных в Azure ML Studio (классическая модель).

Пример просмотра данных и предварительной обработки в студии машинного обучения Azure (классическая модель) см. в видео о [предварительной обработке данных](https://azure.microsoft.com/documentation/videos/preprocessing-data-in-azure-ml-studio/) .
