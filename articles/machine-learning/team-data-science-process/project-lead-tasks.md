...
На этом этапе нужно заполнить репозиторий (R5) проекта **DSProject1** из репозитория (R3) с шаблоном проекта. Процедура заполнения использует каталоги D3 и D5 на локальной DSVM в качестве промежуточных расположений для хранения и обработки. Таким образом путь заполнения: R3 -> D3 -> D5 -> R5.
