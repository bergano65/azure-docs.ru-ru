...
## <a name="secure-azure-storage-accounts"></a>Защита учетных записей хранения Azure

В этом разделе вы узнаете, как защитить учетную запись хранения Azure с помощью конечных точек службы. Однако для защиты хранилища Azure также можно использовать частные конечные точки. Дополнительные сведения см. в статье [использование частных конечных точек для службы хранилища Azure](../storage/common/storage-private-endpoints.md).
...
В этом разделе вы узнаете, как использовать хранилище данных и данные для взаимодействия с пакетом SDK в виртуальной сети. Дополнительные сведения о работе с Studio см. [в статье использование машинное обучение Azure Studio в виртуальной сети](how-to-enable-studio-virtual-network.md).
