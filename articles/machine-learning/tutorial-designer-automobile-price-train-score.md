...
1. В области свойств справа от холста щелкните **All columns** (Все столбцы).
...
1. На панели свойства щелкните текстовое поле **Comment** (Комментарий) и введите *Exclude normalized losses* (Исключение нормализованных потерь).
...
1. Введите **split data** в поле поиска, чтобы найти модуль **Split Data** (Разделение данных). Присоедините левый порт модуля **Clean Missing Data** (Очистка недостающих данных) к модулю **Split Data** (Разделение данных).
...
## <a name="score-a-machine-learning-model"></a>Оценка модели машинного обучения
...
1. На панели свойств выберите **Outputs** (Выходные данные) > значок графа > ![значок визуализации](./media/tutorial-designer-automobile-price-train-score/visualize-icon.png) и просмотрите результаты.
...
1. На панели свойств выберите **Output** (Выходные данные) > значок графа > ![значок визуализации](./media/tutorial-designer-automobile-price-train-score/visualize-icon.png) и просмотрите результаты.
