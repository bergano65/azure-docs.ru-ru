...
1. В области сведений о модуле справа от холста выберите **Выходные данные и журнал** > значок диаграммы ![Значок визуализации](./media/tutorial-designer-automobile-price-train-score/visualize-icon.png) для просмотра результатов.
