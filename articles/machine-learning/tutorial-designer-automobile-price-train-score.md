---
title: Руководство по прогнозированию цен на автомобили с помощью конструктора (предварительная версия)
...
1. Щелкните правой кнопкой мыши **Automobile price data (Raw)** (Данные о ценах на автомобили (необработанные)) и выберите пункт **Визуализировать**.
...
1. В диалоговом окне **Set up pipeline run** (Настройка выполнения конвейера) выберите **Создать новый**.
    ...
    1. Введите описательное имя в поле **Имя нового эксперимента**.
...
1. Щелкните правой кнопкой мыши модуль **Score Model** (Оценка модели) и выберите **Визуализировать**, чтобы просмотреть его выходные данные.
...
1. Щелкните правой кнопкой мыши модуль **Evaluate Model** (Анализ модели) и выберите **Визуализировать**, чтобы просмотреть его выходные данные.
