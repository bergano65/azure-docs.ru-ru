...
## <a name="transfer-learning"></a>Перенос обучения
...
Узнайте, как применить обучение для классификации изображений с помощью платформы с открытым кодом в Машинное обучение Azure. [классификация образов с помощью модели Pytorch](./how-to-train-pytorch.md?WT.mc_id=docs-article-lazzeri).
