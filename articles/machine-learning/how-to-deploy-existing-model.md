...
* Рабочая область машинного обучения Azure. Дополнительные сведения см. [в разделе Создание рабочей области](how-to-manage-workspace.md).
    ...
    > [!TIP]
    > В примерах Python в этой статье предполагается, что `ws` для переменной задана рабочая область машинное обучение Azure.
    >
...
* Обученная модель. Модель должна быть сохранена в одном или нескольких файлах в среде разработки.
    ...
    > [!NOTE]
    > Чтобы продемонстрировать регистрацию модели, обученной за пределами Машинное обучение Azure, в примерах фрагментов кода в этой статье используются модели, созданные проектом Паулу Рипамонти в Twitter тональности [https://www.kaggle.com/paoloripamonti/twitter-sentiment-analysis](https://www.kaggle.com/paoloripamonti/twitter-sentiment-analysis) Analysis.
...
* Скрипт входа. Этот файл (с именем `score.py` ) загружает модель при запуске развернутой службы. Он также отвечает за получение данных, передачу их в модель и возврат ответа.
