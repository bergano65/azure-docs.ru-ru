...
1. Появится запрос, предлагающий открыть URL-адрес эксперимента в Машинное обучение Azure Studio. Выберите **Open** (Открыть).
...
1. Появится запрос на открытие URL-адреса запуска в Машинное обучение Azure Studio. Выберите **Open** (Открыть).
