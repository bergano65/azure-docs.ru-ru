...
Поскольку мы ищем ответ на вопрос "Который из?", такая проблема называется задачей классификации. Но вы можете выполнять базовые действия, описанные в этом примере, для решения любых задач машинного обучения, будь то регрессия, классификация, кластеризация и т. д.
