...
> [!IMPORTANT]
> Учетные данные, регистред с хранилищами данных, сохраняются в Azure Key Vault, связанном с рабочей областью. Если для Key Vault включено [обратимое удаление](../key-vault/general/soft-delete-overview.md) , то для обновления учетных данных обязательно выполните действия, описанные в этой статье. Отмена регистрации хранилища данных и повторная его регистрация с тем же именем завершится ошибкой.
