...
Количество реплик pod, присвоенных кластеру, можно масштабировать с помощью командной строки службы "Машинное обучение Azure" или [панели мониторинга Kubernetes](https://kubernetes.io/docs/tasks/access-application-cluster/web-ui-dashboard/).
