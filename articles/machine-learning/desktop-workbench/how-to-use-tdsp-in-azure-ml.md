...
* Сведения о том, как обрабатывать большие файлы и выходные данные в службе машинного обучения, см. в статье [Сохранение изменений и работа с большими файлами](https://aka.ms/aml-largefiles).
