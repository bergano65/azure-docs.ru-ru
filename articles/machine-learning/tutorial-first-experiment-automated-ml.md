...
1. Нажмите кнопку **Готово**, чтобы запустить эксперимент. Откроется экран **Сведения о выполнении**, содержащий значение **Состояние выполнения** после начала подготовки эксперимента.
