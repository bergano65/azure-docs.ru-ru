...
> [!NOTE]
> Функция ParallelRunStep предназначена для рабочих нагрузок с усложненным параллелизмом. Она также может использоваться для одновременного обучения множества моделей или обработки больших массивов данных.
