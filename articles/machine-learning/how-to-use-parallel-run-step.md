...
Узнайте, как в асинхронном и параллельном режиме выполнять пакетный вывод больших объемов данных с помощью Машинного обучения Azure. Функция ParallelRunStep предоставляет готовые возможности параллельной обработки данных.

Она позволяет очень легко масштабировать вывод с локальных компьютеров в крупные кластеры, которые позволяют обрабатывать терабайты структурированных или неструктурированных данных, повышая производительность и оптимизируя затраты.

В этой статье описаны следующие задачи:

> * Настройка ресурсов машинного обучения
> * Настройка входных и выходных данных пакетного вывода
> * Подготовка предварительно обученной модели классификации изображений на основе набора данных [MNIST](https://publicdataset.azurewebsites.net/dataDetail/mnist/) 
