...
В этом примере показано, как использовать модули текстовой аналитики для создания конвейера классификации текста в конструкторе Машинное обучение Azure.
...
Для **извлечения N-граммного компонента из текстового** модуля мы будем подключать **выходные данные результирующего словаря** из обучающего потока данных к **входному словарю** в потоке вычислений и присвоить параметру " **режим словаря** " значение " **только для чтения**".
[![график с показателями n-грамм](./media/how-to-designer-sample-text-classification/n-gram.png)](./media/how-to-designer-sample-text-classification/n-gram.png)
