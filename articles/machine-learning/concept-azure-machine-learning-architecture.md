...
* [Рабочая область](#workspaces)
    ...
    * [Модели](#models)
        * [Возможным](#environments)
        * [Сценарий обучения](#training-scripts)
...
### <a name="compute-instance"></a>Вычислительный экземпляр (Предварительная версия)
