...
> [!NOTE]
> Вычислительные операции (предварительная версия) сейчас доступны только для рабочих областей, расположенных в регионе **центрально-северная часть США**, **восточная часть США 2**, **Северная Европа** или **южная часть Соединенного Королевства**. Поддержка для других регионов ожидается в ближайшее время.
