...
+ [Пакет SDK службы "Машинное обучение Azure" для Python](#r-sdk). SDK использует сетчатый пакет для привязки к пакету SDK для Python службы "Машинное обучение Azure". Это позволяет получить доступ к основным объектам и методам, реализованным в пакете SDK для Python из любой среды R.
...
* [Руководство. Настройка и использование целевых объектов вычислений для обучения моделей](how-to-set-up-training-targets.md)
...
Пакет SDK для R позволяет использовать язык R в Машинном обучении Azure. SDK использует сетчатый пакет для привязки к пакету SDK для Python службы "Машинное обучение Azure". Это позволяет получить доступ к основным объектам и методам, реализованным в пакете SDK для Python из любой среды R.
...
+ [Учебник по прогнозированию цен на автомобили с помощью конструктора (предварительная версия)](tutorial-designer-automobile-price-train-score.md)
...
Сведения о [настройке сред обучения](how-to-set-up-training-targets.md).
