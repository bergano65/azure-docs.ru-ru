---
title: Руководство. Создание прогнозной модели с помощью записной книжки (часть 1 из 2)
titleSuffix: Azure Machine Learning
description: Узнайте, как создать и развернуть модель машинного обучения с помощью кода в записной книжке Jupyter Notebook. Вы можете использовать модель для прогнозирования результатов в Microsoft Power BI.
...
ms.locfileid: "97814777"
---
# <a name="tutorial-power-bi-integration---create-the-predictive-model-by-using-a-jupyter-notebook-part-1-of-2"></a>Руководство по Интеграция Power BI. Создание прогнозной модели с помощью записной книжки Jupyter Notebook (часть 1 из 2)

В первой части этого руководства показано, как обучить и развернуть прогнозную модель машинного обучения с помощью кода в записной книжке Jupyter Notebook. Во второй части показано, как использовать модель для прогнозирования результатов в Microsoft Power BI.
...
>[!NOTE]
> В этой статье для определения схемы входных и выходных данных используются декораторы Python. Эта настройка важна для интеграции с Power BI.
