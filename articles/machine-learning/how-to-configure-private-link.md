---
title: Настройка частной связи Azure
...
В этом документе вы узнаете, как использовать частную связь Azure с рабочей областью Машинное обучение Azure. Сейчас эта возможность доступна в предварительной версии. он доступен в восточной части США, Западная часть США 2, в регионах Юго-центрального региона США. 

Частная ссылка Azure позволяет подключаться к рабочей области с помощью частной конечной точки. Частная конечная точка — это набор частных IP-адресов в виртуальной сети. Затем можно ограничить доступ к рабочей области, чтобы она выполнялась только по частным IP-адресам. Частная ссылка помогает снизить риск утечка данных. Дополнительные сведения о частных конечных точках см. в статье о [частной ссылке Azure](/azure/private-link/private-link-overview) .
...
Сейчас мы поддерживаем только включение частной конечной точки при создании новой рабочей области Машинное обучение Azure. Для нескольких популярных конфигураций предоставляются следующие шаблоны:

> [!TIP]
> Автоматическое утверждение управляет автоматическим доступом к ресурсу с поддержкой частной ссылки. Дополнительные сведения см. в статье [что такое служба частной связи Azure](../private-link/private-link-service-overview.md).

* [Рабочая область с ключами, управляемыми клиентом, и автоматическое утверждение для закрытой ссылки](#cmkaapl)
* [Рабочая область с ключами, управляемыми клиентом, и утверждением вручную для частной связи](#cmkmapl)
* [Рабочая область с ключами, управляемыми Майкрософт, и автоматическое утверждение для частной связи](#mmkaapl)
* [Рабочая область с ключами, управляемыми корпорацией Майкрософт, и утверждением вручную для частного канала](#mmkmapl)

При развертывании шаблона необходимо предоставить следующие сведения.

* имя рабочей области.
* Регион Azure для создания ресурсов
* Выпуск рабочей области (Basic или Enterprise)
* Если необходимо включить параметры высокой конфиденциальности для рабочей области
* Если необходимо включить шифрование для рабочей области с ключом, управляемым клиентом, и соответствующими значениями ключа
* Имя виртуальной сети и подсети, шаблон создаст новую виртуальную сеть и подсеть

После отправки и подготовки шаблона группа ресурсов, содержащая рабочую область, будет содержать три новых типа артефактов, связанных с частной ссылкой:

* Частная конечная точка
* сетевому интерфейсу
* Частная зона DNS

Рабочая область также содержит виртуальную сеть Azure, которая может взаимодействовать с рабочей областью через закрытую конечную точку.

### <a name="deploy-the-template-using-the-azure-portal"></a>Разверните шаблон с помощью портал Azure

1. Выполните инструкции из раздела [Развертывание ресурсов с помощью настраиваемого шаблона](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-template-deploy-portal#deploy-resources-from-custom-template). Когда вы поступите на экран __изменение шаблона__ , вставьте один из шаблонов в конец этого документа.
...
В этом примере предполагается, что вы сохранили один из шаблонов из конца этого документа в файл, указанный `azuredeploy.json` в текущем каталоге:
...
### <a name="deploy-the-template-using-the-azure-cli"></a>Разверните шаблон с помощью Azure CLI
...
Так как взаимодействие с рабочей областью разрешено только из виртуальной сети, все среды разработки, использующие эту рабочую область, должны быть членами виртуальной сети. Например, виртуальная машина в виртуальной сети или компьютер, подключенный к виртуальной сети с помощью VPN-шлюза.
...
Сведения о VPN-шлюзах см. в статье [что такое VPN-шлюз](/azure/vpn-gateway/vpn-gateway-about-vpngateways).
...
<a id="cmkaapl"></a>
### <a name="workspace-with-customer-managed-keys-and-auto-approval-for-private-link"></a>Рабочая область с ключами, управляемыми клиентом, и автоматическое утверждение для закрытой ссылки
...
<a id="cmkmapl"></a>
### <a name="workspace-with-customer-managed-keys-and-manual-approval-for-private-link"></a>Рабочая область с ключами, управляемыми клиентом, и утверждением вручную для частной связи
...
<a id="mmkaapl"></a>
### <a name="workspace-with-microsoft-managed-keys-and-auto-approval-for-private-link"></a>Рабочая область с ключами, управляемыми Майкрософт, и автоматическое утверждение для частной связи
...
<a id="mmkmapl"></a>
### <a name="workspace-with-microsoft-managed-keys-and-manual-approval-for-private-link"></a>Рабочая область с ключами, управляемыми корпорацией Майкрософт, и утверждением вручную для частного канала
