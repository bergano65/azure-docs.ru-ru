...
1. Укажите следующие сведения для настройки новой рабочей области:
   ...
   Выпуск рабочей области | Выберите **базовый** или **Корпоративный**.  Этот выпуск рабочей области определяет функции, к которым у вас есть доступ и цены. Дополнительные сведения о [машинное обучение Azure](overview-what-is-azure-ml.md). 
