...
1. Укажите следующие сведения для настройки новой рабочей области:
   ...
   Группа ресурсов | Используйте группу ресурсов, которая уже есть в подписке, или введите имя, чтобы создать группу ресурсов. Группа ресурсов содержит связанные ресурсы для решения Azure. 
   ...
   :::image type="content" source="media/how-to-manage-workspace/select-edition.png" alt-text="Настройка рабочей области":::

1. Завершив настройку рабочей области, можно выбрать пункт проверить и **создать**или перейти к дополнительной конфигурации __сети__ .

### <a name="optional-networking"></a>Используемых Сети
...
### <a name="optional-advanced"></a>Используемых Продвинут
...
Завершив настройку сети, выберите __проверить и создать__.

### <a name="review--create"></a>Проверка и создание
