...
3. Нажмите __Добавить__. На странице __Добавление ссылки на виртуальную сеть__ укажите уникальное __имя ссылки__ , а затем выберите добавляемую __виртуальную сеть__ . Нажмите кнопку __ОК__ , чтобы добавить сетевое соединение.
...
Вы можете указать собственный ключ для шифрования данных. При этом создается экземпляр Azure Cosmos DB, в котором хранятся метрики и метаданные в подписке Azure.
