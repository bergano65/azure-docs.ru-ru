...
* Для моделей идентификации объектов вы можете увидеть, что ограничивающие прямоугольники и метки уже существуют.  Исправьте любые неточности, прежде чем отправлять страницу.

* Для моделей сегментации объектов вы можете увидеть, что многоугольники и метки уже существуют.  Исправьте любые неточности, прежде чем отправлять страницу. 

    > [!IMPORTANT]
    > Функции с пометкой "(предварительная версия)" предоставляются в общедоступной предварительной версии.   
