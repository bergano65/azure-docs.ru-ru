...
Машинное обучение Azure наборы данных — это ссылки, указывающие на данные в службе хранилища. Они не копируют данные, поэтому дополнительные затраты на хранение не взимается. Чтобы взаимодействовать с данными в хранилище, [Создайте набор данных](how-to-create-register-datasets.md) для упаковки данных в объект, который можно использовать для задач машинного обучения. Зарегистрируйте набор данных в рабочей области, чтобы поделиться им и повторно использовать его в разных экспериментах без сложностей приема данных.
