...
description: Узнайте, как безопасно подключаться к данным из Машинное обучение Azure и как использовать наборы данных и хранилища для задач машинного обучения. Хранилища данных могут хранить данные из большого двоичного объекта Azure, Azure Data Lake Gen 1 & 2, SQL DB и Azure Databricks.
