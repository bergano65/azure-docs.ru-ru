...
ms.locfileid: "86025732"
---
# <a name="create-and-explore-azure-machine-learning-dataset-with-labels-preview"></a>Создание и изучение набора данных Машинное обучение Azure с помощью меток (Предварительная версия)
