...
Затем можно использовать настраиваемую конфигурацию ACI в развертывании с помощью родительского класса `WebService`.
