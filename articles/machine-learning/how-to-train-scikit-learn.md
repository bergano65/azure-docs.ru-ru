...
description: Узнайте, как Машинное обучение Azure позволяет масштабировать задание обучения scikit-учиться с помощью эластичных облачных ресурсов.
