...
| Pipeline | Что будет сделано | Канонический канал |
| ---- | ---- | ---- |
...
+ Обучение и проверка эффективно и многократно, включая указание конкретных поднаборов данных, различные вычислительные ресурсы оборудования, распределенную обработку и мониторинг хода выполнения
