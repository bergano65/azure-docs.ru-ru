...
+ **Новые функции**
   + Собственный терминал. Теперь пользователи получат доступ к интегрированному терминалу, а также к операции Git через [встроенный терминал.](./how-to-run-jupyter-notebooks.md#terminal)
  + Повторяющаяся папка 
