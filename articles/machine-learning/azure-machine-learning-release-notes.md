...
+ **Исправления ошибок и улучшения**
  ...
  + **azureml-core**
    ...
    + Исправление ошибки в наборе данных. обновление, которое вызвало обновление самой новой версии набора данных, но не является версией набора данных, для которого было вызвано обновление. 
    + Исправление ошибки в наборе данных. get_by_name, где будут отображаться теги для новейшей версии набора данных, даже если на самом деле была получена определенная старая версия.
  + **azureml-interpret**
