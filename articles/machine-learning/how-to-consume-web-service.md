...
* `auth_enabled`— Если включена проверка подлинности `True`ключа,; в противном случае — `False`.
* `token_auth_enabled`— Если включена проверка подлинности `True`маркеров; в противном случае — `False`.
...
Дополнительные сведения см. [в статье Использование TLS для защиты веб-службы с помощью машинное обучение Azure](how-to-secure-web-service.md).
