...
Машинное обучение Azure имеет большую библиотеку алгоритмов из семейств ***Classification** _, _*_рекомендовать системы_*_, _*_кластеризации_*_, _*_обнаружения аномалий_*_, _*_регрессии_*_ и _ *_Text Analytics_**. Каждое семейство предназначено для решения определенного типа проблем, связанных с машинным обучением.
