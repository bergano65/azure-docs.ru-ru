...
description: Узнайте, как применять DevOpsные методики для создания конвейера приема данных для подготовки данных с помощью фабрики данных Azure и Azure Databricks.
