...
Метрика|Description|Вычисление|Дополнительные параметры
--|--|--|--
...
точность|Точность — это процент прогнозируемых меток, которые точно соответствуют истинным меткам. |[Вычисление](https://scikit-learn.org/stable/modules/generated/sklearn.metrics.accuracy_score.html) |None|
