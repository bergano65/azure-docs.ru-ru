...
description: Отладка и устранение неполадок ParallelRunStep в конвейерах машинного обучения в пакете SDK решения "Машинное обучение Azure" для Python.
