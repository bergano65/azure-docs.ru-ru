...
> [!NOTE]
> Экземпляры вычислений (Предварительная версия) доступны только для рабочих областей с **северо-центральным**регионом США, * * восток США 2 * *, **северная Европа** или **Южная часть Соединенного Королевства**.
