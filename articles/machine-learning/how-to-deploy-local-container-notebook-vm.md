...
> [!NOTE]
> Экземпляры вычислений (Предварительная версия) доступны только для рабочих областей с регионом **северо-центральная часть США** или **Южная часть Соединенного Королевства**.
