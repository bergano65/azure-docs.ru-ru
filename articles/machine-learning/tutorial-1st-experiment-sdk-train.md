...
![Главная страница эксперимента на портале](./media/tutorial-1st-experiment-sdk-train/experiment-main.png)
...
![Страница сведений на портале](./media/tutorial-1st-experiment-sdk-train/model-download.png)
