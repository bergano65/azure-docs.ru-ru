...
3. На странице **Разделы сетки событий** на панели инструментов выберите **+ Добавить**. 
    ...
    :::image type="content" source="./media/custom-event-quickstart-portal/add-event-grid-topic-button.png" alt-text="Поиск и выбор разделов Сетки событий":::
4. На странице **Создать раздел** выполните следующие действия:
    ...
    5. В нижней части страницы выберите **Review + create** (Проверить и создать). 
        ...
        :::image type="content" source="./media/custom-event-quickstart-portal/create-custom-topic.png" alt-text="Поиск и выбор разделов Сетки событий":::
    6. На вкладке **Просмотр и создание** на странице **Создание раздела** выберите **Создать**. 
    
        :::image type="content" source="./media/custom-event-quickstart-portal/review-create-page.png" alt-text="Поиск и выбор разделов Сетки событий":::
...
6. Выберите в списке созданный вами раздел. 
    ...
    :::image type="content" source="./media/custom-event-quickstart-portal/select-event-grid-topic.png" alt-text="Поиск и выбор разделов Сетки событий":::
...
7. Отобразится страница **Раздел Сетки событий** для соответствующего раздела. Оставьте эту страницу открытой. Она понадобится позже при работе с кратким руководством. 
    ...
    :::image type="content" source="./media/custom-event-quickstart-portal/event-grid-topic-home-page.png" alt-text="Поиск и выбор разделов Сетки событий":::
...
1. Теперь на странице **Раздел сетки событий** выберите для пользовательского раздела **+ Подписка на события** на панели инструментов.
    ...
    :::image type="content" source="./media/custom-event-quickstart-portal/new-event-subscription.png" alt-text="Поиск и выбор разделов Сетки событий":::
2. На странице **Создать подписку на событие** выполните следующие действия:
    ...
    4. Выберите **Выбрать конечную точку**. 
        ...
        :::image type="content" source="./media/custom-event-quickstart-portal/provide-subscription-values.png" alt-text="Поиск и выбор разделов Сетки событий":::
    5. Для конечной точки веб-перехватчика укажите URL-адрес веб-приложения и добавьте `api/updates` к URL-адресу домашней страницы. Выберите **Подтвердить выбор**.
        ...
        :::image type="content" source="./media/custom-event-quickstart-portal/provide-endpoint.png" alt-text="Поиск и выбор разделов Сетки событий":::
...
1. На портале Azure выберите **Cloud Shell**. Cloud Shell откроется в нижней области веб-браузера. 
    ...
    :::image type="content" source="./media/custom-event-quickstart-portal/select-cloud-shell.png" alt-text="Поиск и выбор разделов Сетки событий":::
...
:::image type="content" source="./media/custom-event-quickstart-portal/event-grid-viewer-end.png" alt-text="Поиск и выбор разделов Сетки событий":::
