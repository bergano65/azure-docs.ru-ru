...
| Свойство | Type | Описание: |
| -------- | ---- | ----------- |
| ключ | string | Ключ измененного или удаленного ключевого значения. |
| label | string | Метка, если таковая имеется, для измененного или удаленного ключевого значения. |
| etag | string | Для `KeyValueModified` ETag нового ключевого значения. Для `KeyValueDeleted` ETag удаленного ключевого значения. |
