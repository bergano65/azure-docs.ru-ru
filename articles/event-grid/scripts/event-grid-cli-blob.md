...
description: В этой статье приведен пример скрипта Azure CLI, в котором показано, как подписаться на события для учетной записи хранилища BLOB-объектов Azure.
services: event-grid
