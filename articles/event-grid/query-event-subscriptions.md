...
description: В этой статье описывается, как перечислить подписку Event Grid в подписку Azure. Вы предоставляете различные параметры в зависимости от типа подписки.
services: event-grid
author: spelluru
