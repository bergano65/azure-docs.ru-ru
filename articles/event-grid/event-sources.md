...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-subscriptions.md) | Содержит сведения о полях в событиях подписки Azure. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-container-registry.md) | Содержит сведения о полях событий Реестра контейнеров. |
...
| [Перенаправление пользовательских событий в хранилище очередей Azure с помощью Azure CLI и службы "Сетка событий"](custom-event-to-queue-storage.md) | Содержит сведения об отправке пользовательских событий в хранилище очередей. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema.md) | Содержит сведения о полях в пользовательских событиях. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-event-hubs.md) | Содержит сведения о полях в событиях в Центрах событий. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-iot-hub.md) | Содержит сведения о полях событий в Центре Интернета вещей. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-key-vault.md) | Показывает поля в Key Vault событиях. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](../media-services/latest/media-services-event-schemas.md?toc=%2fazure%2fevent-grid%2ftoc.json) | Содержит сведения о полях в событиях Служб мультимедиа. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-service-bus.md) | Содержит сведения о полях в событиях служебной шины. |
...
| [Учебник. Настройка геозоны](../azure-maps/tutorial-geofence.md?toc=%2fazure%2fevent-grid%2ftoc.json) | Этот руководство поможет выполнить основные действия по настройке геозоны с помощью Azure Maps. Используйте Сетку событий Azure для выполнения потоковой передачи результатов геозоны и на их основе создавайте уведомления. |
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-azure-maps.md) | Отображает поля в событиях службы Azure Maps. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-app-configuration.md) | Показывает поля в событиях конфигурации приложения Azure. |
...
| [Схема событий службы "Сетка событий Azure" для хранилища BLOB-объектов](event-schema-azure-signalr.md) | Показывает поля в событиях службы Azure SignalR. |
