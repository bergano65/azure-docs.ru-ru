...
* Дополнительные сведения об интеграции Key Vault с таблицей событий см. в статье [мониторинг Key Vault с помощью службы "Сетка событий Azure](../key-vault/general/event-grid-overview.md)".
* Руководство по интеграции Key Vault с сеткой событий см. в статье [Получение уведомлений хранилища ключей и реагирование на них с помощью службы "Сетка событий Azure](../key-vault/general/event-grid-tutorial.md)".
* Дополнительные рекомендации по Key Vault и службе автоматизации Azure см. в следующих статьях:
    ...
    - [мониторингу Key Vault с помощью службы "Сетка событий Azure"](../key-vault/general/event-grid-overview.md)
    - [Получение уведомлений хранилища ключей и реагирование на них с помощью Сетки событий Azure](../key-vault/general/event-grid-tutorial.md)
