...
Максимально допустимый размер события — 1 МБ. За событиями свыше 64 КБ начислено приращения в 64 КБ. Свойства, отправляемые в событии, см. в статье [о схеме событий службы "Сетка событий Azure"](event-schema.md).
