...
[Расширение "Сетка событий"](/cli/azure/azure-cli-extensions-list) для Azure CLI позволяет задать срок действия даты при создании подписки на событие. Если вы используете REST API, используйте `api-version=2018-09-15-preview`
