...
Эта статья содержит свойства и схему для событий рабочей области машинного обучения. Введение в схемы событий см. в статье [Схема событий службы "Сетка событий Azure"](event-schema.md).
...
| моделидс | строка | Общий разделенный список идентификаторов моделей. Идентификаторы моделей, развернутых в службе. |
...
* Пример использования службы "Сетка событий Azure" с Машинное обучение Azure см. в статье [создание рабочих процессов машинного обучения на основе событий](/azure/machine-learning/service/event-schema-machine-learning) .