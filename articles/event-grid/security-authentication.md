...
* Контролируется ли код приложения, выполняющийся в целевой конечной точке? Например, когда вы пишете функцию Azure на основе триггера HTTP, есть ли у вас доступ к коду приложения для внесения в него изменений?
