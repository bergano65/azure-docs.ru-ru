...
* **Microsoft.Storage/storageAccounts**: создание учетной записи хранения.
* **"Microsoft.Storage/storageAccounts/providers/eventSubscriptions**: создание подписки на службу "Сетка событий Azure" для учетной записи хранения. 

1. Выберите следующую ссылку, чтобы войти на портал Azure и открыть шаблон. Шаблон создает хранилище ключей и секрет.

    [Развертывание в Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-event-grid-subscription-and-storage%2Fazuredeploy.json)
