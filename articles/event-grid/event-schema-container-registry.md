...
Схема для нажатого события диаграммы аналогична схеме для отображаемого события, но не включает объект запроса:
...
Схема для удаленного события диаграммы аналогична схеме для удаленного события, но не включает объект запроса:
