...
| данные | object | Географическое зонирование данных события. |
...
| Свойство | type | Описание |
| -------- | ---- | ----------- |
| ошибка | ErrorDetails |Этот объект возвращается, если в API Maps произошла ошибка.  |

Объект ErrorDetails возвращается, если в API Maps произошла ошибка. Этот объект имеет следующие свойства.

| Свойство | type | Описание |
| -------- | ---- | ----------- |
| Код | string | Код состояния HTTP. |
...
| Свойство | type | Описание |
| -------- | ---- | ----------- |
| Код | string | Сообщение об ошибке. |
