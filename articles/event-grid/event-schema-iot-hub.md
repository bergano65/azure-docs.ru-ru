...
| cloudToDeviceMessageCount | целочисленный | Число сообщений, отправленных из облака на это устройство. | 
...
| version | целочисленный | Целое число, которое увеличивается на единицу при каждом обновлении двойника устройства. |
