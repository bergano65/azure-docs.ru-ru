...
Если эти ограничения вам не подходят, с просьбой команде разработчиков, открыв запрос в службу поддержки или путем отправки сообщения электронной почты для [ askgrid@microsoft.com ](mailto:askgrid.microsoft.com). 

## <a name="pricing"></a>Цены
Домены событий используйте тот же [цены на операции](https://azure.microsoft.com/pricing/details/event-grid/) , использовать другие функции в "Сетка событий".
