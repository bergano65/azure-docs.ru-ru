...
Например, при публикации следующего массива событий в раздел `"id": "1111"` будет отправлено событие с `foo`, в то время как событие с `"id": "2222"` будет отправлено в раздел `bar`:
...
Если эти ограничения не соответствуют вам, обратитесь к группе разработчиков, отправив запрос в службу поддержки или отправьте электронное письмо по адресу [askgrid@microsoft.com](mailto:askgrid@microsoft.com). 
