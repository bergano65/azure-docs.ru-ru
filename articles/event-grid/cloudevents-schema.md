...
| source             | URI      | "/mycontext"                     | Описание источника событий                                       | topic#subject
| eventID            | String   | "1234-1234-1234"                 | Идентификатор события                                                    | id
...
| сontentType        | String   | "application/json"               | Описание формата кодирования данных (необязательно)                       | *не используется*
| extensions         | Сопоставление      | { "extA": "vA", "extB", "vB" }  | Любые дополнительные метаданные (необязательно)                                 | *не используется*
| data               | Object   | { "objA": "vA", "objB", "vB" }  | Полезные данные события (необязательно)                                       | data
