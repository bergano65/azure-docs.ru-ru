---
title: Мертвые буквы и политики повтора - Azure Event Grid
...
> [!NOTE]
> - Создайте учетную запись хранения и контейнер с каплями в хранилище перед запуском команд в этой статье.
> - Служба Event Grid создает капли в этом контейнере. Названия капли будут иметь название подписки Event Grid со всеми буквами в верхнем корпусе. Например, если название подписки My-Blob-Subscription, имена мертвых букв будут иметь MY-BLOB-SUBSCRIPTION (myblobcontainer/MY-BLOB-SUBSCRIPTION/2019/8/8/5/111111111-1111-111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111 Такое поведение защищает от различий в обработке случаев между службами Azure.
