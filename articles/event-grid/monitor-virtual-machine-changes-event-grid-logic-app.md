...
6. В поле поиска введите "event grid" в качестве фильтра. Выберите триггер **Azure Event Grid - On a resource event** (Сетка событий Azure — при событии ресурса)

   ![Выберите триггер Azure Event Grid - On a resource event (Сетка событий Azure — при событии ресурса)](./media/monitor-virtual-machine-changes-event-grid-logic-app/logic-app-event-grid-trigger.png)
