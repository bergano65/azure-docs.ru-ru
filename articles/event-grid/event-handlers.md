...
В портал Azure при создании подписки на события выберите "очередь служебной шины" в качестве типа конечной точки, а затем щелкните "выбрать и конечную точку", чтобы выбрать очередь служебной шины.
