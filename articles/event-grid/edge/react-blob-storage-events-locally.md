...
В этой статье показано, как локально реагировать на создание больших двоичных объектов и события удаления больших двоичных объектов на IoT Edge с помощью сетки событий.
