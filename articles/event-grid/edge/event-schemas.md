...
ms.locfileid: "72992383"
---
# <a name="event-schemas"></a>Схемы событий

Модуль "Сетка событий" принимает и доставляет события в формате JSON. В настоящее время существует две схемы, поддерживаемые службой "Сетка событий":-
