...
| Возможные значения | Описание: |
| ----------------  | ------------ |
| true | По умолчанию. Требует, чтобы все запросы в модуль "Сетка событий" представим сертификат клиента. Кроме того, необходимо будет настроить **inbound__clientAuth__clientCert__source**.
...
| Возможные значения | Описание:  |
| ----------------  | ------------ |
| true | Разрешает проверку подлинности на основе ключей SAS. Требуется **inbound__clientAuth__sasKeys__key1** или **inbound__clientAuth__sasKeys__key2**
...
| Возможные значения | Описание: |
| ----------------  | ------------ |
| true | По умолчанию. Требует, чтобы все исходящие запросы из модуля сетки событий присутствовали сертификат. Необходимо настроить **outbound__clientAuth__clientCert__source**.
