...
Теперь необходимо настроить приложение функцию для подключения к учетной записи хранения, созданной в ходе выполнения инструкций из предыдущего [руководства][previous-tutorial].
