...
Если ошибка, возвращенная конечной точкой подписки, связана с ошибкой конфигурации, которую невозможно исправить с повторными попытками (например, если конечная точка удалена), EventGrid ее либо выполняет событие недоставленной буквы, либо удаляет событие, если недоставленная буква не настроена.
