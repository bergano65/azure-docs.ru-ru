...
Для доставки событий сетка событий использует политику экспоненциального увеличения задержки повтора. Если конечной точки не отвечает или возвращает код ошибки, сетка событий предпринимает повторные попытки доставки, по следующему расписанию на наилучшим возможным образом:
...
1. 30 минут
1. 1 час
1. Каждый час в течение 24 часов
