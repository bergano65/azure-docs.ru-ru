...
1. Выберите соответствующую частоту экспорта:
    - **Потоковая передача** — оценки будут отправляться в режиме реального времени при обновлении состояния работоспособности ресурса (если обновления не выполняются, данные не будут отправлены).
    - **Моментальные снимки** — моментальный снимок текущего состояния всех оценок соответствия нормативным требованиям будет отправляться каждую неделю (это предварительная версия функции для еженедельного моментального снимка безопасных оценок и данных соответствия нормативным требованиям).
