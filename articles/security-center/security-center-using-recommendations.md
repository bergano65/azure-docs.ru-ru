...
Чтобы пользователи не могли создавать ресурсы, которые отрицательно влияют на оценку Джеффа, они настраивают параметры принудительного применения и запрета для наиболее важных рекомендаций. См. сведения о [предотвращении ошибок конфигурации с помощью рекомендаций о применении и отклонении](prevent-misconfigurations.md).
