...
## <a name="configure-jit-in-security-center"></a>Настройка JIT в центре безопасности

В центре безопасности можно настроить политику JIT и запросить доступ к виртуальной машине с помощью политики JIT.


### Настройка JIT-доступа на виртуальной машине в центре безопасности<a name="jit-asc"></a>
...
6. Можно также настроить пользовательские порты.
      ...
      1. Щелкните **Добавить**. Откроется окно **Добавление конфигурации порта** .
...
## Настройка JIT-доступа на странице виртуальной машины Azure<a name="jit-vm"></a>
...
4. В разделе **JIT-доступ**выберите **включить JIT-политику**. 
