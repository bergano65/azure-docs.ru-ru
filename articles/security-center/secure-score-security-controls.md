...
ms.locfileid: "86044317"
---
# <a name="enhanced-secure-score-in-azure-security-center"></a>Улучшенная оценка безопасности в центре безопасности Azure
...
## <a name="accessing-your-secure-score"></a>Доступ к оценке безопасности
...
### <a name="getting-your-secure-score-from-the-portal"></a>Получение оценки безопасности с портала
...
### <a name="getting-your-secure-score-from-the-rest-api"></a>Получение оценки безопасности из REST API
...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-lboi"; width=55%>- В службах Kubernetes должны быть определены политики безопасности контейнеров pod.<br>- Необходимо устранить уязвимости в конфигурациях безопасности контейнера.<br>- Уязвимости конфигурации безопасности на ваших компьютерах должны быть устранены.<br>- Уязвимости в конфигурации безопасности в масштабируемом наборе виртуальных машин должны быть устранены.<br>- Агент наблюдения должен быть установлен на виртуальных машинах.<br>- Необходимо установить агент наблюдения на ваших компьютерах.<br>-Агент Log Analytics должен быть установлен на компьютерах Arc Azure на базе Windows (Предварительная версия).<br>-Агент Log Analytics должен быть установлен на компьютерах Arc Azure на базе Linux (Предварительная версия).<br>- Необходимо установить агент наблюдения в масштабируемых наборах виртуальных машин.<br>- Необходимо устранить проблемы работоспособности агента наблюдения на ваших компьютерах.</td>
  </tr>
  <tr>
...
Центр безопасности переключился на расширенный показатель безопасности, который включает изменения в способе вычисления оценки. Теперь необходимо выполнить все рекомендации для ресурса, чтобы получить баллы. Кроме того, теперь используется шкала оценок от 0 до 10.
...
Нет. В то время как они работали параллельно, чтобы упростить переход. Предыдущая модель теперь устарела. 
