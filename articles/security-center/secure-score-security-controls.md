...
Кроме того, рекомендации, помеченные как **Предварительная версия** , не включаются в вычисления оценки безопасности. Их по-прежнему следует устранять, когда это возможно, поэтому по окончании периода предварительной версии они будут участвовать в оценке.
