...
|Необходимые роли и разрешения:|**Читатель безопасности** и [роль читателя реестра контейнеров Azure](https://docs.microsoft.com/azure/container-registry/container-registry-roles)|
...
## <a name="identify-vulnerabilities-in-images-in-azure-container-registries"></a>Выявление уязвимостей в образах в реестре контейнеров Azure 
