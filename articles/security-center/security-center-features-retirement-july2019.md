...
При нажатии кнопки **Перейти к карте событий безопасности** открывается панель мониторинга "аналитика угроз". Мы вышли из эксплуатации панель мониторинга аналитики угроз.

![Панель мониторинга для анализа угроз][11]

При выборе рабочей области для просмотра ее панели мониторинга для анализа угроз необходимо открыть экран "схема оповещений системы безопасности" (Предварительная версия) в Log Analytics. Мы вышли из этого экрана.
