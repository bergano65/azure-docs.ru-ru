...
## <a name="search-menu-entry"></a>Запись меню "Поиск"<a name="menu_search"></a>
...
## <a name="classic-identity--access-preview"></a>Классическая идентификация & доступом (Предварительная версия)<a name="menu_classicidentity"></a>
...
## <a name="security-events-map"></a>Схема событий безопасности<a name="menu_securityeventsmap"></a>

Центр безопасности предоставляет карту предупреждений системы безопасности для выявления угроз безопасности. Кнопка **Перейти к сопоставлению событий безопасности** на этой карте открывает панель мониторинга, которая позволяет просматривать необработанные события безопасности в выбранной рабочей области.
...
## <a name="custom-alert-rules-preview"></a>Настраиваемые правила генерации оповещений (Предварительная версия)<a name="menu_customalerts"></a>
...
## <a name="subset-of-security-solutions"></a>Подмножество решений по обеспечению безопасности<a name="menu_solutions"></a>
...
## <a name="edit-security-configurations-for-security-policies"></a>Изменение конфигураций безопасности для политик безопасности<a name="menu_securityconfigurations"></a>
...
Мы вышли из этой предварительной версии функции. Чтобы восстановить параметры безопасности по умолчанию после даты выбытия, сделайте это через API или PowerShell, выполнив [следующие инструкции](https://github.com/Azure/Azure-Security-Center/tree/master/Powershell%20scripts/Reset%20security%20configurations%20customization).
...
## <a name="security-and-audit-dashboard-for-log-analytics-workspaces"></a>Панель мониторинга "безопасность и аудит" для рабочих областей Log Analytics<a name="menu_securityomsdashboard"></a>
