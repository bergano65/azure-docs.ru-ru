---
title: Подключение компьютеров Windows к Центру безопасности Azure
description: В этом кратком руководстве показано, как подготовить агент Log Analytics на компьютере Windows.
...
В этом кратком руководстве показано, как установить агент Log Analytics на компьютере Windows.
...
7. Если компьютер должен передавать данные в рабочую область Log Analytics в облаке Azure для государственных организаций, выберите **Azure для US Gov организаций** в раскрывающемся списке **Облако Azure**. Если компьютер должен обмениваться данными со службой Log Analytics через прокси-сервер, выберите **Дополнительно** и укажите URL-адрес и номер порта прокси-сервера.
...
Дополнительные сведения об установке и настройке агента см. в разделе [Подключение компьютеров Windows](../azure-monitor/platform/agent-windows.md#install-agent-using-setup-wizard).
...
3. В окне **Программы и компоненты** выберите **агент Log Analytics** и нажмите кнопку **Удалить**.

## <a name="next-steps"></a>Дальнейшие действия
Из этого краткого руководства вы узнали, как подготовить агент Log Analytics на компьютере Windows. Дополнительные сведения об использовании центра безопасности см. в руководстве по настройке политики безопасности и оценке безопасности ресурсов.
