...
- **Защитник Azure отключен** — центр безопасности включает решение "SecurityCenterFree" в рабочей области по умолчанию. Плата за использование защитника Azure не взимается.

- **Защитник Azure в** — центр безопасности включает решение "безопасность" в рабочей области по умолчанию.
...
## <a name="what-security-events-are-collected-by-the-log-analytics-agent"></a>Какие события безопасности собираются агентом Log Analytics?

Полный список событий безопасности, собираемых агентом, см. в разделе [какие типы событий хранятся для параметров событий безопасности "Common" и "минимальный"?](security-center-enable-data-collection.md#what-event-types-are-stored-for-common-and-minimal)
...
1. Для Log Analytics агента выберите **изменить конфигурацию**. 
    ...
    :::image type="content" source="./media/security-center-enable-data-collection/edit-configuration-auto-deploy-agent.png" alt-text="Конфигурация агента Log Analytics для использования при автоматическом развертывании" lightbox="./media/security-center-enable-data-collection/edit-configuration-auto-deploy-agent.png":::

1. Выберите **Подключить виртуальные машины Azure к другой рабочей области** и выберите имеющуюся рабочую область.

    :::image type="content" source="./media/security-center-enable-data-collection/choose-workspace.png" alt-text="Выбор рабочей области, отличной от используемой по умолчанию, для передачи отчетов агенту Log Analytics" lightbox="./media/security-center-enable-data-collection/choose-workspace.png":::
...
1. На странице " **Автоматическая подготовка** " выберите перо и отключите автоподготовку на странице "  **Политика безопасности — сбор данных** ".
...
1. В [портал Azure](https://portal.azure.com)откройте **Центр безопасности** и выберите пункт **цены и настройки**.

1. Выберите подписку, для которой необходимо отключить автоматическую подготовку.

1. В разделе **Автоматическая подготовка** отключите переключатель для агента log Analytics.
