...
Дополнительные данные безопасности для серверов SQL Server на виртуальных машинах Azure — это единый пакет, для обеспечения дополнительных возможностей безопасности SQL. В настоящее время, он содержит функции, отображая и Устранение потенциальных уязвимостей базы данных и обнаружение аномальных действий, которые могут указывать угрозу для базы данных. 
...
Следующие шаги приступить к работе с повышенной безопасности данных для SQL на виртуальных машинах Azure.
