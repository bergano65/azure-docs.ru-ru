...
| Агент виртуальной машины Azure отсутствует или недопустим | Microsoft Monitoring Agent еще не установлен.  Чтобы центр безопасности мог установить расширение, требуется допустимый агент виртуальной машины Azure. | Установите, переустановите или обновите агент виртуальной машины Azure на виртуальной машине. |
