...
description: Этот документ помогает устранять неполадки в центре безопасности Azure.
...
* **Агент вручную установлен на виртуальной машине, расположенной в Azure**. в этом сценарии, если вы используете агенты, скачанные и установленные вручную до февраля 2017, вы можете просматривать оповещения на портале Центра безопасности, только если отфильтровать подписку в рабочей области. принадлежит. Если выполнить фильтрацию по подписке, к которой принадлежит ресурс, вы не увидите никаких оповещений. Вы получите уведомления по электронной почте по адресу электронной почты, который был настроен в политике безопасности для подписки, к которой принадлежит Рабочая область.
