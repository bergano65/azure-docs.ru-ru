...
ms.locfileid: "88042506"
---
# <a name="suppress-alerts-from-azure-security-centers-threat-protection"></a>Отключение оповещений от защиты от угроз в центре безопасности Azure
...
|Цены|Уровень служб "Бесплатный"<br>(Большинство предупреждений системы безопасности предназначены только для уровня "Стандартный".)|
...
![Создать правило подавления предупреждений](media\alerts-suppression-rules\create-suppression-rule.gif)
