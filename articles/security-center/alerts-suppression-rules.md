...
description: В этой статье объясняется, как использовать правила подавления в Центре безопасности Azure для скрытия нежелательных оповещений системы безопасности.
author: memildin
manager: rkarlin
...
ms.locfileid: "83871700"
---
# <a name="suppressing-alerts-from-azure-security-centers-threat-protection"></a>Подавление оповещений Защиты от угроз в Центре безопасности Azure

На этой странице объясняется, как можно использовать правила подавления оповещений для подавления ложных срабатываний и других нежелательных оповещений системы безопасности в Центре безопасности Azure.

## <a name="availability"></a>Доступность

- Состояние выпуска: **Предварительный просмотр**
- Требуемые роли: **Администратор безопасности** и **Владелец** могут создавать и удалять правила. **Читатель сведений о безопасности** и **Читатель** могут просматривать правила.
- Облако. 
    - ✔ коммерческие облака;
    - ✔ национальные (US Gov, China Gov, другие правительственные облака).


## <a name="introduction-to-suppression-rules"></a>Общие сведения о правилах подавления

Компоненты Защиты от угроз в Центре безопасности Azure обнаруживают угрозы в любой части среды и создают оповещения системы безопасности.
...
> [!CAUTION]
> Подавление оповещений системы безопасности снижает эффективность Защиты от угроз Центра безопасности. Внимательно оценивайте возможное влияние любого правила подавления и время от времени выполняйте мониторинг.

[![Страница оповещений системы безопасности в Центре безопасности Azure с параметрами подавления оповещений](media/alerts-suppression-rules/alerts-screen-with-options.png)](media/alerts-suppression-rules/alerts-screen-with-options.png#lightbox)
...
Чтобы изменить созданные правила, используйте страницу правил подавления.
...
1. Откроется страница правил подавления, в которой перечислены все доступные для выбранных подписок правила. 
...
## <a name="viewing-alerts-that-have-been-suppressed"></a>Просмотр подавленных оповещений
...
Дополнительные сведения об оповещениях системы безопасности в Центре безопасности Azure см. в следующих статьях:

- [Оповещения системы безопасности и намерения кибератак](alerts-reference.md) — справочное руководство по оповещениям системы безопасности, которые могут отображаться в модуле Защиты от угроз Центра безопасности Azure.
- [Защита от угроз в Центре безопасности Azure](threat-protection.md) — описание аспектов среды, отслеживаемых модулем Защиты от угроз Центра безопасности Azure.