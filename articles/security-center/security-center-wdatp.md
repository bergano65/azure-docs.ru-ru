...
| Поддерживаемые платформы:            | ![Да](./media/icons/yes-icon.png) Компьютеры Azure под Windows<br>![Да](./media/icons/yes-icon.png) Компьютеры ARC в Azure под Windows|
| Поддерживаемые версии Windows:  | Защитник для конечной точки встроен в Windows 10 1703 (и более поздние версии) и Windows Server 2019.<br>Центр безопасности поддерживает обнаружение в Windows Server 2016, 2012 R2 и 2008 R2 с пакетом обновления 1 (SP1).<br>Мониторинг конечных точек сервера с помощью этой интеграции отключен для клиентов Office 365 GCC. |
...
| Облако.                         | ![Да](./media/icons/yes-icon.png) Коммерческие облака.<br>![Нет](./media/icons/no-icon.png) GCC клиенты, выполняющие рабочие нагрузки в глобальных облаках Azure<br>![Да](./media/icons/yes-icon.png) US Gov<br>![Нет](./media/icons/no-icon.png) China Gov и другие правительственные облака                                                        |
|                                 |                                                                                                                                                                                                                                                                                                               |
