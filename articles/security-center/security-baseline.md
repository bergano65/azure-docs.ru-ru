...
- [Требования к брандмауэру для использования агента Log Analytics](../azure-monitor/agents/log-analytics-agent.md#firewall-requirements)
...
- [Отправка журналов действий в рабочую область Log Analytics](../azure-monitor/essentials/activity-log.md#send-to-log-analytics-workspace)
...
- [Оповещения журнала в Azure Monitor](../azure-monitor/alerts/alerts-unified-log.md)
...
- [Безопасная отправка данных в Log Analytics](../azure-monitor/logs/data-security.md#sending-data-securely-using-tls-12)
...
- [Ключ Azure Monitor, управляемый клиентом](../azure-monitor/logs/customer-managed-keys.md)
...
- [Управление рабочей областью Log Analytics с помощью шаблонов Azure Resource Manager](../azure-monitor/logs/resource-manager-workspace.md)
