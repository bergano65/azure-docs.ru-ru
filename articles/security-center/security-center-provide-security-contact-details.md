...
- [Автоматизируйте реагирование на триггеры Центра безопасности.](workflow-automation.md) Используйте функцию автоматизации для реагирования на триггеры Центра безопасности с помощью настраиваемой логики уведомлений.