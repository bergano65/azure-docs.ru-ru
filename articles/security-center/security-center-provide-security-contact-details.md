...
## Настройка уведомлений по электронной почте для оповещений<a name="email"></a>

1. На портале выберите **параметры ценообразования &** .
1. Щелкните подписку.
...
> Если вы реализуете рекомендацию, в разделе **рекомендации**выберите **сведения о контактах безопасности**, а затем выберите подписку Azure для предоставления контактных сведений. Откроются **Уведомления по электронной почте**.
   ...
   * Вы можете отправлять уведомления по электронной почте владельцам подписки (классических администраторов служб и соадминистраторов, а также роль владельца RBAC в области действия подписки).
