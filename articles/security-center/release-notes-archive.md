...
Добавлены две новые рекомендации, которые помогают развернуть [агент Log Analytics](../azure-monitor/agents/log-analytics-agent.md) на компьютерах Azure Arc и обеспечить их защиту с помощью Центра безопасности Azure:
