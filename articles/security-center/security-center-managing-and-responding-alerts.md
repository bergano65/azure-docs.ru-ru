...
1. Шаги по исправлению, предлагаемые Центром безопасности, зависят от оповещения безопасности. Следуйте указаниям по каждому оповещению. В некоторых случаях, чтобы уменьшить оповещение об обнаружении угроз, для реализации рекомендуемого исправления может потребоваться использовать другие элементы управления или службы Azure. 
