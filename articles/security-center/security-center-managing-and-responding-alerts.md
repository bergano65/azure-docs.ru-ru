...
* **Уровень серьезности**. Уровень серьезности. Может быть высоким, средним или низким.
...
-   **Средний (низкий в REST API)**. Это скорее всего подозрительные действия, которые могут указывать на то, что ресурс скомпрометирован.
...
-   **Низкий (информационный в REST API)**. Это может быть неопасная положительная или заблокированная атака. 
