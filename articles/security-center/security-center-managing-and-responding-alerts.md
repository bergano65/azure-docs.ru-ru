...
1. После просмотра сведений щелкните ресурс, который был атакован.
    ...
    Кроме того, в правой панели находится вкладка **предпринять действие** . Используйте эту вкладку для выполнения дальнейших действий, касающихся оповещения системы безопасности. Такие действия, как:
...
- [Автоматизация ответов на предупреждения и рекомендации с помощью автоматизации рабочих процессов](workflow-automation.md)
