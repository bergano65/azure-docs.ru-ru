...
**Сети** колонка содержит общие сведения о разделах, можно углубиться в, чтобы получить дополнительные сведения о работоспособности сетевых ресурсов:
...
**Эти данные основана на анализе групп безопасности сети, а также дополнительные алгоритмы машинного обучения, которые анализируют несколько правил, чтобы понять их crossovers и взаимодействия.** 
...
* [Защита службы Azure SQL в центре безопасности Azure](security-center-sql-service-recommendations.md)
