...
В представлении топологии на первом уровне находятся виртуальные сети. На втором экране отображаются подсети, а на третьем — виртуальные машины, принадлежащие к этим подсетям. В правом столбце отображается текущее состояние рекомендаций по группам безопасности сети для этих ресурсов.
