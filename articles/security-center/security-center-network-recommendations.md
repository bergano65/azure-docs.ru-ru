...
|----|----|----|----|
|Машина|40|Включить группы безопасности сети на виртуальных машинах|Включение групп безопасности сети для управления доступом виртуальных машин к сети.|
...
|Машина|30|Применить JIT-управление доступом к сети|Применение управления JIT-доступом к виртуальным машинам для окончательной блокировки доступа к выбранным портам и предоставления авторизованным пользователям возможности открыть их через тот же механизм за ограниченное время.|
|Машина|20|Ограничить доступ через конечную веб-точку|Усиление групп безопасности сети подключенных к Интернету виртуальных машин путем ограничения доступа существующих разрешающих правил.|
