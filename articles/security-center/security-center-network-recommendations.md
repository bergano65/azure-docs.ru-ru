...
|----|----|----|----|
|Мachine|40|Включить группы безопасности сети на виртуальных машинах|Включение групп безопасности сети для управления доступом виртуальных машин к сети.|
...
|Мachine|30|Применить JIT-управление доступом к сети|Применение управления JIT-доступом к виртуальным машинам для окончательной блокировки доступа к выбранным портам и предоставления авторизованным пользователям возможности открыть их через тот же механизм за ограниченное время.|
|Мachine|20|Ограничить доступ через конечную веб-точку|Усиление групп безопасности сети подключенных к Интернету виртуальных машин путем ограничения доступа существующих разрешающих правил.|
|Мachine|10|Добавление брандмауэра следующего поколения|Добавление решения брандмауэра следующего поколения (NGFW) для улучшения защиты подключенных к Интернету виртуальных машин.|
|Мachine|5|Маршрутизация трафика только через брандмауэр сетевого шлюза|Чтобы выполнить развертывание решения брандмауэра следующего поколения, трафик для защищенных виртуальных машин, подключенных к Интернету, должен маршрутизироваться только через решение брандмауэра следующего поколения.|
|Вирт. сеть|5|Включение защиты от атак DDoS уровня "Стандартный"|Приложения с общедоступными IP-адресами в этих виртуальных сетях не защищены с помощью службы защиты от атак DDoS уровня "Стандартный". Рекомендуется включить ее, чтобы устранять риски объемных атак и атак протоколов сети.|
|Мachine|10|Добавление брандмауэра следующего поколения|Добавление решения брандмауэра следующего поколения (NGFW) для улучшения защиты подключенных к Интернету виртуальных машин.|
|Мachine|5|Маршрутизация трафика только через брандмауэр сетевого шлюза|Чтобы выполнить развертывание решения брандмауэра следующего поколения, трафик для защищенных виртуальных машин, подключенных к Интернету, должен маршрутизироваться только через решение брандмауэра следующего поколения.|
