...
|----|----|----|----|
|Мachine|40|Группы безопасности сети для виртуальных машин должна быть включена|Включение групп безопасности сети для управления доступом виртуальных машин к сети.|
|Подсеть|35|Группы безопасности сети на уровне подсети должен быть включен|Включение групп безопасности сети для управления доступом ресурсов, развернутых в подсетях, к сети.|
|Мachine|30|Управление доступом к сети Just-In-Time должны быть выполнены с виртуальных машин|Применение управления JIT-доступом к виртуальным машинам для окончательной блокировки доступа к выбранным портам и предоставления авторизованным пользователям возможности открыть их через тот же механизм за ограниченное время.|
|Мachine|20|Ограничение доступа через подключенную к Интернету конечную точку|Усиление групп безопасности сети подключенных к Интернету виртуальных машин путем ограничения доступа существующих разрешающих правил.|
