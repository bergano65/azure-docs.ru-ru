...
В этой статье описывается страница « **сеть** » раздела «безопасность ресурсов» центра безопасности Azure и некоторые рекомендации, которые вы увидите.

Полный список рекомендаций по работе с сетью см. в разделе [рекомендации](recommendations-network.md)по работе с сетью.
