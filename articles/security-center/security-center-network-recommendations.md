...
В этой статье описывается страница " **Сетевые подключения** " в разделе "безопасность ресурсов" центра безопасности.
...
- Сетевая схема (только для центра безопасности Azure уровня "Стандартный")
...
Если у вас нет центра безопасности "Стандартный", в этом разделе объясняется, как просмотреть рекомендации по бесплатным сетям.
