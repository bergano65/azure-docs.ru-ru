...
* Оповещения системы безопасности от функций защиты от угроз
...
* Сведения о поддерживаемых операционных системах см. в статье [Центр безопасности Azure: часто](faq-vms.md)задаваемые вопросы. 
