...
* Предупреждения о безопасности с функций защиты от угроз
...
* Для получения информации о поддерживаемых операционных системах см. [Центр безопасности Azure часто задаваемые вопросы (Часто задаваемые вопросы).](faq-vms.md) 
...
| --- | --- |
| Включение сбора данных для подписок |Рекомендует включить в политике безопасности сбор данных для каждой вашей подписки и всех виртуальных машин (ВМ) в ваших подписках. |
...
| Установка Endpoint Protection |Рекомендует подготовить антивредоносные программы на виртуальных машинах (только для виртуальных машин Windows). |
...
* [Часто задаваемые вопросы - Виртуальные машины](faq-vms.md) - Найти часто задаваемые вопросы об использовании службы.