...
| Страница "Исправление уязвимостей" |Позволяет просматривать уязвимости системы и приложений, обнаруженные решением для оценки уязвимостей, установленным на виртуальной машине. |
