...
FIM использует решение "Отслеживание изменений" Azure, чтобы отслеживать и обнаруживать изменения в среде. При включении мониторинга целостности файлов у вас есть ресурс **отслеживания изменений** втисениях. **Solution** Подробная информация о [Change Tracking data collection details](https://docs.microsoft.com/azure/automation/automation-change-tracking#change-tracking-data-collection-details) частоте сбора данных см.

> [!NOTE]
> При удалении ресурса **отслеживания изменений** вы также отстраните функцию мониторинга целостности файлов в Центре безопасности.
...
Панель мониторинга FIM для рабочего пространства отображает следующие детали:
...
**Поиск журнала** открывается при вводе имени машины в поле поиска или выборе машины, указанной в вкладке «Компьютеры.Поиск журнала» отображает все изменения, внесенные в выбранный период времени для машины. Вы можете развернуть любое изменение, чтобы получить дополнительную информацию.
...
3. Нажмите кнопку **Добавить**. Открывается окно **Добавление файла Linux для отслеживания изменений**.
...
В этой статье вы научились использовать мониторинг целостности файлов (FIM) в Центре безопасности. Чтобы узнать больше о Центре безопасности, смотрите следующие страницы:
...
* [Мониторинг партнерских решений](security-center-partner-solutions.md) — Узнайте, как контролировать состояние здоровья ваших партнерских решений.
