...
|Облако.|![Да ](./media/icons/yes-icon.png) коммерческие облака<br>![Да ](./media/icons/yes-icon.png) US gov<br>![Без ](./media/icons/no-icon.png) Китая gov, другие gov<br>Поддерживается только в регионах, где доступно решение для отслеживания изменений в службе автоматизации Azure.<br>См. раздел [Supported regions for linked log Analytics Workspace](../automation/how-to/region-mappings.md).<br>Дополнительные [сведения об отслеживании изменений](../automation/change-tracking/overview.md).|
|||
