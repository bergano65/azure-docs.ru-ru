...
- [Интегрированное решение для оценки уязвимостей центра безопасности для образов реестра контейнеров Azure](monitor-container-security.md)
...
|----|:----|
|**На виртуальных машинах должно быть включено решение для оценки уязвимостей.**|Заменяет следующие две рекомендации:<br> **•** Включите встроенное решение для оценки уязвимостей на виртуальных машинах (на платформе Qualys (теперь не рекомендуется использовать) (входит в состав уровня "Стандартный").<br> **•** Решение для оценки уязвимостей должно быть установлено на виртуальных машинах (сейчас не рекомендуется) (уровень "Стандартный" и "бесплатный").|
...
|Рекомендация|Область|
|----|:----|
|**На виртуальных машинах должно быть включено решение для оценки уязвимостей.**<br>Ключ: ffff0522-1e88-47fc-8382-2a80ba848f5d|Встроенные + BYOL|
