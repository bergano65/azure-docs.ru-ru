...
1. В главном меню Центра безопасности выберите **Just-in-Time VM access** (JIT-доступ к виртуальным машинам) в области **Расширенная защита облака**.

  ![JIT-доступ к виртуальным машинам][1]

  На плитке **Just-in-Time VM access** (JIT-доступ к виртуальной машине) содержатся сведения о состоянии виртуальных машин.
...
Эта функция доступна только для машин под управлением Windows.
