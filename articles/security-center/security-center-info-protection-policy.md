---
title: Настройка защиты информации s-L - Центр безопасности Azure
...
Вы можете определить и настроить политику защиты информации для всего клиента Azure в Центре безопасности Azure.

Информационная защита — это передовая возможность обеспечения безопасности для обнаружения, классификации, маркировки и отчетности конфиденциальных данных в ресурсах данных Azure. Обнаружение и классификация наиболее конфиденциальных данных (бизнес, финансы, здравоохранение, персональные данные и т.д.) может сыграть ключевую роль в вашей организационной защите информации. На основе этих процессов может формироваться инфраструктура для решения следующих задач:
- Соблюдение стандартов в сфере конфиденциальности данных и нормативных требований.
- Сценарии безопасности, такие как мониторинг (аудит) и оповещение об аномальном доступе к конфиденциальным данным
- Управление доступом к базам данных, содержащим конфиденциальные данные, и усиление их защиты
 
Политика [SQL Information Protection](../sql-database/sql-database-data-discovery-and-classification.md) реализует эту парадигму для хранилищ данных SQL и в настоящее время поддерживается для баз данных SQL Azure. Политика SQL Information Protection автоматически обнаруживает и классифицирует потенциально конфиденциальные данные, предоставляет механизм работы с метками для постоянного маркирования конфиденциальных данных атрибутами классификации и предоставляет подробную панель мониторинга, на которой отображается состояние классификации базы данных. Кроме того, эта служба вычисляет результирующий набор конфиденциальности запросов SQL, чтобы запросы, которые извлекают конфиденциальные данные, можно было проверить явным образом и обеспечить защиту данных. Для получения более подробной информации о защите информации, [см.](../sql-database/sql-database-data-discovery-and-classification.md)
...
Information Protection поставляется со встроенным набором меток и типов сведений, которые используются по умолчанию. Чтобы настроить эти метки и типы, можно настроить политику защиты информации в Центре безопасности.
...
1. В главном меню Центра безопасности под **руководством RESOURCE SECURITY HYGIENE** перейдите на **& хранения данных** и нажмите на кнопку **защиты информации.**

   ![Настройка политики защиты информации](./media/security-center-info-protection-policy/security-policy.png) 
 
2. На странице **защиты информации s'L** можно просмотреть текущий набор меток. Это основные атрибуты классификации, которые используются для категоризации уровня конфиденциальности данных. На этой странице можно настроить **метки защиты информации** и **типы сведений** для клиента. 
...
- [Безопасность данных Центра безопасности Azure](security-center-data-security.md): Узнайте, как Центр безопасности управляет и защищает данные
