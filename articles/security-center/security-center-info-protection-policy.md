...
1. В системе безопасности центра главного меню в разделе **ГИГИЕНА безопасности РЕСУРСОВ** перейдите **данные и хранилище** и щелкнуть **SQL Information Protection** кнопки.

   ![Настройка политики защиты информации](./media/security-center-info-protection-policy/security-policy.png) 
 
2. В **SQL Information Protection** странице можно просмотреть текущий набор меток. Это основные атрибуты классификации, которые используются для категоризации уровня конфиденциальности данных. На этой странице можно настроить **метки защиты информации** и **типы сведений** для клиента. 
