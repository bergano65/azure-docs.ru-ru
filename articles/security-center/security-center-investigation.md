...
> * Исследование поддерживается только для оповещения на основе данных, собираемых с серверов Windows.
...
Вы можете начать свое изучение с инцидента или с оповещения. Выбранный вами вариант будет отличаться в зависимости от ваших потребностей. Следующие шаги, используемые для расследования из оповещения.
