...
Центр безопасности также предлагает анализ уязвимостей для:

* Базы данных SQL. см. статью [Обзор отчетов об оценке уязвимостей на панели мониторинга "Оценка уязвимостей](security-center-iaas-advanced-data.md#explore-vulnerability-assessment-reports) ".
