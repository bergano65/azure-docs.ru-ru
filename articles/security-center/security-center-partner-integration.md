...
Дополнительные сведения об интеграции средств проверки уязвимостей от Qualys, включая встроенный сканер, доступный для клиентов уровня "Стандартный", см. в следующих статьях: 

- [Встроенный сканер уязвимостей для виртуальных машин](built-in-vulnerability-assessment.md).
- [Развертывание решения для поиска уязвимостей партнеров](partner-vulnerability-assessment.md).

Центр безопасности также позволяет выполнить анализ уязвимостей для:

* Баз данных SQL — см. раздел [Просмотр отчетов об оценке уязвимостей](security-center-iaas-advanced-data.md#explore-vulnerability-assessment-reports).
...
> [!NOTE]
> Уровень "Стандартный" центра безопасности необходим на уровне подписки для функции обнаруженных решений. Дополнительные сведения о ценовых категориях см. в разделе [цены](security-center-pricing.md) .
>
...
* [Экспорт оповещений и рекомендаций системы безопасности](continuous-export.md). Узнайте, как настроить интеграцию с Azure Sentinel или любым другим SIEM.
