...
|Адаптивные элементы управления приложениями|✔ (только в Azure)|X|X|X|
|FIM;|✔|✔|✔|✔|
...
|Кэш Redis|✔| X|
|Service Fabric|✔| X|
|Служба автоматизации Azure|✔| X|
|Data Lake |✔| X|
|Хранилище ключей|✔| X|
|Служебная шина|✔| X|
|Stream Analytics|✔| X|
|Пакетная служба Azure|✔| X|
