...
- [Ценовая категория](https://docs.microsoft.com/azure/security-center/security-center-pricing): с защитником Azure или без него, который определяет доступные функции центра безопасности для ресурсов в области (может быть указана для подписок, групп ресурсов и рабочих областей).
