---
title: Руководство по планированию и операциям Центра безопасности
...
Хотя эта статья не имеет намерения помочь вам в создании собственного плана реагирования на инциденты, мы собираемся использовать Microsoft Azure Security Response в жизненном цикле облака в качестве основы для этапов реагирования на инциденты. Эти этапы показаны на схеме ниже.
