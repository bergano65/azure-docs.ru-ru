...
Центр безопасности Azure использует агент мониторинга Майкрософт — это тот же агент, который используется службой Azure Monitor – для сбора данных о безопасности с ваших виртуальных компьютеров. [Данные](https://docs.microsoft.com/azure/security-center/security-center-enable-data-collection), собранные этим агентом, будут храниться в рабочих областях Log Analytics.
