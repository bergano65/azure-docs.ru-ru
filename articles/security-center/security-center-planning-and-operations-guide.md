...
- [Ценовая категория](security-center-pricing.md) со службой Azure Defender или без нее. От этого зависит, какие функции Центра безопасности доступны для ресурсов в области действия (это может быть подписка, группа ресурсов или рабочая область).
...
Центр безопасности может отслеживать состояние безопасности компьютеров, не относящихся к Azure. Однако сначала необходимо подключить эти ресурсы. Дополнительные сведения о подключении ресурсов, не относящихся к Azure, см. в статье [Подключение компьютеров, не относящихся к Azure](quickstart-onboard-machines.md).
