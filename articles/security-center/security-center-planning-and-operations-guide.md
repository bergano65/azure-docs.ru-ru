...
* Группа ресурсов: *DefaultResourceGroup-[географическое_расположение]*
...
Центр безопасности обнаруживает угрозы и оповещает о них по мере возникновения. Организациям необходимо отслеживать появление оповещений системы безопасности и принимать меры, необходимые для изучения атаки и устранения ее последствий. Дополнительные сведения о том, как работает обнаружение угроз центра безопасности, см. в статье Обнаружение [угроз в центре безопасности Azure и реагирование на них](security-center-alerts-overview.md#detect-threats).
