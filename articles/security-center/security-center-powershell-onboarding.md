...
В этом примере мы включению центра безопасности в подписке с идентификатором: d07c0080-170c-4c24-861d-9c817742786c и примените Рекомендуемые параметры, обеспечивающие высокий уровень защиты, путем реализации уровня "Стандартный" центра безопасности, который обеспечивает расширенные возможности защиты от угроз и обнаружения.
...
1. (Необязательно.) Установите уровень покрытия (ценовую категорию) подписок (если не определена, используется ценовая категория "Бесплатный"):
