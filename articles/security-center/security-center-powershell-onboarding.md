---
title: На борту в Центр безопасности Azure с PowerShell
...
1. Установите [стандартный уровень защиты Центра безопасности.](https://azure.microsoft.com/pricing/details/security-center/) 
 
2. Установите рабочее пространство Log Analytics, в которое агент Log Analytics будет отправлять данные, которые он собирает на вс-чатах, связанных с подпиской , - в этом примере существующее рабочее пространство определено пользователем (myWorkspace).

3. Активировать автоматическое представление агента Центра безопасности, который [развертывает агент Log Analytics.](security-center-enable-data-collection.md#auto-provision-mma)

5. Установите CISO организации [в качестве контакта безопасности для предупреждений Центра безопасности и заметных событий.](security-center-provide-security-contact-details.md)
...
4.  Автоматическая установка агента Log Analytics на врезные ввои:
