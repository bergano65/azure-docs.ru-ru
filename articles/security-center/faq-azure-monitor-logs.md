---
title: Вопросы и ответы по центру безопасности Azure — вопросы о существующих моделями
description: Это часто задаваемые вопросы о клиентах, которые уже используют Microsoft Monitoring Agent и рассмотрены центр безопасности Azure, продукт, который помогает предотвращать, обнаруживать угрозы и реагировать на них.
...
---
# Вопросы и ответы для клиентов, уже использующих журналы Azure Monitor<a name="existingloganalyticscust"></a>
...
> [!TIP]
> Если Microsoft Monitoring Agent устанавливается непосредственно на виртуальной машине (а не в виде расширения Azure), центр безопасности не устанавливает Microsoft Monitoring Agent, а мониторинг безопасности ограничен.
