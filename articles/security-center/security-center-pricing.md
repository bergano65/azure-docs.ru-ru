...
- Уровень **Стандартный** расширяет возможности уровня "Бесплатный". Он предоставляет рабочие нагрузки, выполняющиеся в частных и других общедоступных облаках, а также гарантирует унифицированное управление безопасностью и защиту от угроз в гибридных облачных рабочих нагрузках. В рамках уровня "Стандартный" добавлены функции обнаружения угроз, использующие встроенный анализ поведения и машинное обучение, чтобы определять атаки и уязвимости нулевого дня, элементы управления доступом и приложениями для снижения риска сетевых атак и внедрения вредоносных программ и т. д. Уровень "Стандартный" доступен бесплатно. Центр безопасности ценовой категории "Стандартный" поддерживает такие ресурсы Azure, как виртуальные машины, Служба приложений Azure и серверы SQL. Центр безопасности ценовой категории "Стандартный" позволяет отказаться от поддержки на основе типа ресурса. 
