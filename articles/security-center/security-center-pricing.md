...
- Уровень " **бесплатный** " включен во всех подписках Azure, когда вы впервые посещаете панель мониторинга центра безопасности Azure на портале Azure или включили ПРОГРЕММАТИКАЛИ через API. Если добавить другие подписки афтевардс, то в новой подписке центр безопасности не будет включен по умолчанию, однако вам нужно просто запустить портал центра безопасности, и новая подписка будет зарегистрирована и применена бесплатная Категория. Уровень Free обеспечивает политику безопасности, непрерывную оценку безопасности и рекомендации по обеспечению безопасности, которые помогут защитить ресурсы Azure.
...
(Цены на изображении предназначены только для примера.)  Цены на ![Security Center ](./media/security-center-pricing/get-standard.png)
