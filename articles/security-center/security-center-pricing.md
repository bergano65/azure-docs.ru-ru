...
- Уровень **Стандартный** расширяет возможности уровня "Бесплатный". Он предоставляет рабочие нагрузки, выполняющиеся в частных и других общедоступных облаках, а также гарантирует унифицированное управление безопасностью и защиту от угроз в гибридных облачных рабочих нагрузках. В рамках уровня "Стандартный" добавлены функции обнаружения угроз, использующие встроенный анализ поведения и машинное обучение, чтобы определять атаки и уязвимости нулевого дня, элементы управления доступом и приложениями для снижения риска сетевых атак и внедрения вредоносных программ и т. д. Вы можете бесплатно попробовать уровня "стандартный". Стандарт центр безопасности поддерживает Azure ресурсы, включая виртуальные машины, масштабируемые наборы виртуальных машин, службы приложений, серверов SQL Server и учетные записи хранения. Центр безопасности ценовой категории "Стандартный" позволяет отказаться от поддержки на основе типа ресурса. 
...
1. Выберите **цен & Параметры** на **центр безопасности** главного меню.
