...
Центр безопасности использует Microsoft Monitoring Agent для накопления и хранения данных. Подробные сведения см. в статье [сбор данных в центре безопасности Azure](security-center-enable-data-collection.md).
...
## Почему изменились значения оценки безопасности? <a name="secure-score-faq"></a>
