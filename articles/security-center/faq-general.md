...
По состоянию на февраль 2019 центр безопасности настроил оценку нескольких рекомендаций, чтобы лучше соответствовать их серьезности. В результате этой корректировки могут возникать изменения в общих значениях показателей безопасности.  Дополнительные сведения об оценке безопасности см. [в статье повышенная безопасность оценки в центре безопасности Azure](secure-score-security-controls.md).
