...
Чтобы настроить расширенное обнаружение, обновите центр безопасности Azure до уровня "Стандартный". Бесплатный пробный период составляет 60 дней. Чтобы выполнить обновление, выберите в [политике безопасности](security-center-azure-policy.md) соответствующую **ценовую категорию**. Дополнительные сведения см. на [странице с ценами](https://azure.microsoft.com/pricing/details/security-center/).
