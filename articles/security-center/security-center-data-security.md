...
|-------------------------------------|---------------|
| Соединенные Штаты Америки, Бразилия, южная Африка | США |
| Canada                              | Canada        |
...
* **Активность Azure:** все оповещения безопасности, утвержденные запросы Центра безопасности [и](https://docs.microsoft.com/azure/security-center/security-center-just-in-time) все оповещения, генерируемые [адаптивными элементами управления приложениями.](https://docs.microsoft.com/azure/security-center/security-center-adaptive-application)
* **Журналы Azure Monitor:** все оповещения безопасности.
