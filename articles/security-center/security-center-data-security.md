...
- Виртуальные машины и серверы. С виртуальных машин собираются сведения о конфигурации и событиях безопасности, например события Windows, данные журналов аудита и журналов IIS, а также сообщения системного журнала и файлы аварийного дампа. Кроме того, при появлении оповещения центр безопасности Azure для аналитических целей может создать моментальный снимок поврежденного диска виртуальной машины и извлечь из диска артефакты, связанные с оповещением, например файл реестра.
...
**Рабочие области**. Рабочая область задается для указанных ниже геообъектов, а данные, собранные с виртуальных машин Azure, включая аварийные дампы и некоторые типы данных оповещений, хранятся в ближайшей рабочей области.

| Геообъект виртуальной машины                              | Геообъект рабочей области |
|-------------------------------------|---------------|
| США, Бразилия, Южно-Африканская Республика | Соединенные Штаты Америки |
| Канада                              | Канада        |
| Европа (за исключением Соединенное Королевство)   | Европа        |
| Соединенное королевство                      | Соединенное королевство |
| Азия (кроме Индии, Японии, Кореи, Китай)   | Азиатско-Тихоокеанский регион  |
| Корея, Республика                              | Азиатско-Тихоокеанский регион  |
| Индия                               | Индия         |
| Япония                               | Япония         |
| Китай                               | Китай         |
| Австралия                           | Австралия     |
