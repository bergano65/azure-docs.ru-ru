...
Если вы не используете защитник Azure, вы также можете отключить сбор данных из виртуальных машин в политике безопасности. Для подписок, защищенных защитником Azure, требуется сбор данных. Функция создания моментальных снимков диска виртуальной машины и сбора артефактов работает даже в том случае, если сбор данных был отключен.
