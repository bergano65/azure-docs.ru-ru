...
## <a name="manage-data-collection-from-virtual-machines"></a>Управление сбором данных с виртуальных машин
...
* **Действие Azure.** Все оповещения системы безопасности, утвержденные [JIT](security-center-just-in-time.md)-запросы к Центру безопасности и все оповещения, созданные [адаптивными элементами управления приложения](security-center-adaptive-application.md).
