...
|STREAM  |Типы данных  |
|---------|---------|
|[Журнал действий Azure](../azure-monitor/platform/activity-log.md)| Все оповещения системы безопасности, утвержденные [JIT](security-center-just-in-time.md)-запросы на доступ к Центру безопасности и все оповещения, созданные [адаптивными элементами управления приложениями](security-center-adaptive-application.md). |
...
Дополнительные сведения о центре безопасности Azure см. в следующих статьях:

- [Что такое Центр безопасности Azure?](security-center-introduction.md)
