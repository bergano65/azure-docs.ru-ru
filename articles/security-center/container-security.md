...
Центр безопасности сканирует образы на основе ОС Linux. 

Сканер Qualys не поддерживает образы "дистролесс", которые содержат только приложение и его зависимости времени выполнения.
