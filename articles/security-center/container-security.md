...
Установите **Надстройку Политики Azure для Kubernetes**, чтобы получить пакет рекомендаций по защите рабочих нагрузок в контейнерах Kubernetes.
...
Когда вы установите надстройку для кластера AKS, каждый запрос к серверу API Kubernetes будет отслеживаться и сопоставляться с заранее установленным набором рекомендаций, прежде чем попадет в кластер. Вы сможете настроить **принудительное применение** таких рекомендаций и управлять ими для всех будущих рабочих нагрузок. 
