...
- Windows или Linux [агента виртуальной машины Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/extensions/agent-windows) установлен.
...
Агент, установленный продолжит занесения в его уже настроенных рабочих областях, а также будут отправлять отчеты в рабочей области, настроенной в центре безопасности (Множественная адресация поддерживается).
