...
description: В этой статье содержатся ответы на вопросы о центре безопасности Azure, а также о продукте, который помогает предотвращать, обнаруживать угрозы и реагировать на них.
...
ms.locfileid: "74558659"
---
# <a name="azure-security-center-frequently-asked-questions-faq"></a>Часто задаваемые вопросы о центре безопасности Azure
...
Кроме того, в центре безопасности Azure также можно [отслеживать компьютеры,](./quick-onboard-windows-computer.md) не относящиеся к Azure (включая локальные). [](./quick-onboard-linux-computer.md)
