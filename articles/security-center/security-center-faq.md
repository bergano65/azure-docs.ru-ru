...
### Что делать, если у меня есть агент Microsoft Monitoring Agent непосредственно на компьютере, но не как расширение (Direct Agent)?<a name="directagentinstalled"></a>
...
Если настроенной рабочей области — это рабочее пространство пользователя (не рабочую центра безопасности по умолчанию), необходимо установить «безопасности / отчетов «securityFree» решения на его для центра безопасности для запуска обработки событий из виртуальных машин и компьютеров к этой рабочей области.
...
### Что произойдет, если агент SCOM уже установлен на моей виртуальной Машине?<a name="scomomsinstalled"></a>
