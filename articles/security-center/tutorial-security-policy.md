...
- **Читатель безопасности**: иметь права на просмотр центра безопасности, который включает рекомендации, оповещения, политику и работоспособность, но не может вносить изменения.
- **Администратор безопасности**: имеет те же права просмотра, что и *читатель безопасности*, а также может обновлять политику безопасности и отклонять рекомендации и оповещения.
