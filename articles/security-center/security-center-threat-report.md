...
Эти сведения полезны в процессе [реагирования на инцидент](security-center-incident-response.md), когда ведется исследование, чтобы понять источник атаки, мотивацию злоумышленника и то, как избежать этой проблемы в дальнейшем.
