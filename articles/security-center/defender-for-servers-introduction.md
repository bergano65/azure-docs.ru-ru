...
- **Интеграция с Advanced Threat Protection (ATP) в Microsoft Defender (только для Windows).** Azure Defender интегрируется с платформой Advanced Threat Protection (ATP) в Microsoft Defender. Вместе они обеспечивают широкие возможности обнаружения конечных точек и реагирования. [Дополнительные сведения](security-center-wdatp.md).

    > [!IMPORTANT]
    > Датчик ATP в Microsoft Defender автоматически включается для серверов Windows, которые используют Центр безопасности.

    Когда средство ATP в Microsoft Defender обнаруживает угрозу, оно инициирует оповещение. Оповещение отображается в Центре безопасности. Из Центра безопасности вы можете перейти к консоли ATP в Microsoft Defender, отобразить сводные данные и тщательно их изучить для определения области атаки. Дополнительные сведения об ATP в Microsoft Defender см. в статье [Подключение серверов к службе ATP в Microsoft Defender](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/configure-server-endpoints).
