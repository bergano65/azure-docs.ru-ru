...
1. В меню центра безопасности выберите пункт **адаптивные элементы управления приложениями**.
    ...
    - **Нет рекомендаций** — компьютеры без определенного списка разрешенных приложений, которые не поддерживают эту функцию. Компьютер может находиться на этой вкладке по следующим причинам:
      ...
      - Это компьютер Windows с предварительно существующей политикой [AppLocker](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-application-control/applocker) , включенной либо объектом групповой политики, либо локальной политикой безопасности.
...
## <a name="editing-a-groups-adaptive-application-controls-rule"></a>Изменение правила управления адаптивным приложением для группы
...
## <a name="responding-to-the-allowlist-rules-in-your-adaptive-application-control-policy-should-be-updated-recommendation"></a>В ответ на запрос "правила разрешенных в политике адаптивного управления приложениями должны быть обновлены"
...
## <a name="auditing-alerts-and-violations"></a>Аудит предупреждений и нарушений
...
## <a name="managing-application-controls-via-the-rest-api"></a>Управление элементами управления приложениями с помощью REST API 
