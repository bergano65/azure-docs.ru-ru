...
Пользователи уровня "Стандартный" центра безопасности Azure получают оповещения системы безопасности, когда центр безопасности обнаруживает угрозы для их ресурсов.
