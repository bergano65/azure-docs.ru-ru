...
| Роль | Изменение политики безопасности | Применение рекомендаций по безопасности к ресурсу</br> (в том числе с "Быстрый Fix!") | Отклонение оповещений и рекомендаций | Просмотр оповещений и рекомендаций |
|:--- |:---:|:---:|:---:|:---:|
| Владелец подписки | ✔ | ✔ | ✔ | ✔ |
| Участник подписки | -- | ✔ | ✔ | ✔ |
...
- [Управление и реагирование на оповещения безопасности в Центре безопасности](security-center-managing-and-responding-alerts.md)
