...
| Role | Изменение политики безопасности | Применение рекомендаций по безопасности к ресурсу</br> (в том числе с помощью "быстрого исправления!") | Отклонение оповещений и рекомендаций | Просмотр оповещений и рекомендаций |
|:--- |:---:|:---:|:---:|:---:|
| Владелец подписки | ✔ | ✔ | ✔ | ✔ |
| Участник подписки | -- | ✔ | ✔ | ✔ |
