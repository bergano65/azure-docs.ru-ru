---
title: Защитите свои компьютеры и приложения в центре безопасности Azure
...
Центр безопасности Azure анализирует состояние безопасности ресурсов Azure, серверов, не относящихся к Azure, и виртуальных машин. Когда центр безопасности выявляет потенциальные уязвимости в системе безопасности, он создает рекомендации по настройке необходимых элементов управления. Рекомендации относятся к следующим типам ресурсов Azure: виртуальные машины (ВМ) и компьютеры, приложения, сети, служба SQL, удостоверения и доступ.
...
Полный список рекомендаций для служб приложений и ресурсов вычислений см. в разделе [Рекомендации](security-center-virtual-machine-protection.md#compute-and-app-recs).
...
- **Контейнеры**: список контейнеров и оценка безопасности их конфигураций.
...
- **Нет. Виртуальных машин & компьютеров**: общее количество виртуальных машин и компьютеров, на которых отсутствует это обновление.
...
> [!NOTE]
> Приведенные здесь рекомендации по безопасности совпадают с указанными в разделе **Рекомендации**. Дополнительные сведения об устранении рекомендаций см. в статье [Реализация рекомендаций по безопасности в центре безопасности Azure](security-center-recommendations.md).
>
>
...
Чтобы просмотреть сведения о службе приложений, необходимо включить службу приложений в подписке. Инструкции по включению этой функции см. в статье [Защита службы приложений с помощью центра безопасности Azure](security-center-app-services.md).
[!NOTE]
...
2. Выполните поиск политики **развертывание log Analytics агент для масштабируемых наборов виртуальных машин Windows** и щелкните его.
...
|Тип ресурса|Оценка безопасности|Рекомендации|Description (Описание)|
|----|----|----|----|
...
|Вычислительные ресурсы (учетная запись службы автоматизации)|5|Переменные учетной записи службы автоматизации должны быть зашифрованы|Включите шифрование ресурсов переменных в учетной записи службы автоматизации при хранении конфиденциальных данных.|
