...
### <a name="protect-iot-and-hybrid-cloud-workloads-preview"></a>Защита рабочих нагрузок Интернета вещей и гибридных облачных рабочих нагрузок (предварительная версия)

Центр безопасности Azure для Интернета вещей упрощает обеспечение защиты гибридной рабочей нагрузки, предоставляя унифицированное представление и контроль, адаптивное предотвращение угроз и интеллектуальную систему обнаружения угроз и реагирования на них в рабочих нагрузках, выполняющиеся на периферии, в локальной среде, в Azure и в других облаках. Дополнительные сведения см. в статье [Azure Security Center for IoT Preview Documentation](https://docs.microsoft.com/azure/asc-for-iot/) (Документация по Центру безопасности Azure для Интернета вещей (предварительная версия)).
