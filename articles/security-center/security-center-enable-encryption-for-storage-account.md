---
title: Шифрование для учетной записи хранения Azure в центре безопасности Azure | Документация Майкрософт
...
ms.locfileid: "60703934"
---
# <a name="encryption-for-azure-storage-account-in-azure-security-center"></a>Шифрование для учетной записи хранения Azure в центре безопасности Azure

Шифрование хранилища Azure для неактивных данных включена по умолчанию для всех учетных записей хранилища Azure. Служба хранилища Azure шифрует данные при их записи в хранилище и расшифровывает их до извлечения. Дополнительные сведения см. в разделе [шифрованием службы хранилища Azure для неактивных данных](../storage/common/storage-service-encryption.md).
