---
title: Повышенная безопасность уровня "Стандартный" — Центр безопасности Azure
...
Центр безопасности уровня "Стандартный" включает:
...
Вы можете обновить всю подписку Azure до уровня "Стандартный", который наследуется всеми поддерживаемыми ресурсами в подписке. Применение уровня "Стандартный" к рабочей области применяется ко всем ресурсам, которые отменяют отчеты в рабочей области.
...
Чтобы обновить подписку или рабочую область до уровня "Стандартный", выполните следующие действия.
...
3.  Нажмите кнопку **Запустить пробную версию**, чтобы начать пробное использование выбранных подписок.
  ![Выбор подписки](./media/security-center-onboarding/select-subscription.png)
   ...
   > [!NOTE]
   > Бесплатные возможности центра безопасности применяются только к виртуальным машинам Azure и VMSS. Возможности уровня "Бесплатный" не применяются к компьютерам, не относящимся к Azure. Если выбрано значение Standard, то стандартные возможности применяются ко всем виртуальным машинам Azure, масштабируемым наборам виртуальных машин и отчетам, не являющимся компьютерами Azure, в рабочую область. Мы рекомендуем применять уровень "Стандартный", чтобы обеспечить расширенную безопасность для ресурсов Azure и сторонних ресурсов.
   >
...
2. В разделе **безопасность и аудит**выберите **рабочую область OMS** , чтобы создать новую рабочую область.
   > [!NOTE]
