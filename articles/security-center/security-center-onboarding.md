---
title: Повышенная безопасность стандартного уровня - Центр безопасности Azure
...
Можно обновить всю подписку Azure до уровня Стандарта, которая передается по всем поддерживаемым ресурсам в рамках подписки. Применение стандартного уровня к рабочему пространству применяется ко всем ресурсам, подотчетным рабочей области.
...
Чтобы обновить подписку или рабочее пространство до стандарта:
1. В главном меню центра безопасности выберите **Приступая к работе**.
  ![Начало работы](./media/security-center-onboarding/get-started.png)
...
3.  Нажмите кнопку **Запустить пробную версию**, чтобы начать пробное использование выбранных подписок.
  ![Выбор подписки](./media/security-center-onboarding/select-subscription.png)
   ...
   > [!NOTE]
   > Бесплатные возможности Центра безопасности применяются только к вашим VMs-ми и VMSS. Возможности уровня "Бесплатный" не применяются к компьютерам, не относящимся к Azure. При выборе стандарта возможности Стандарта применяются ко всем m M Ms Azure, наборам свай-масштабов VM и компьютерам, не отчитанным в рабочее пространство. Мы рекомендуем применять уровень "Стандартный", чтобы обеспечить расширенную безопасность для ресурсов Azure и сторонних ресурсов.
   >
...
2. Под **системой безопасности и аудита**выберите **рабочее пространство OMS** для создания нового рабочего пространства.
   > [!NOTE]
...
- [JIT-доступ к виртуальной машине](security-center-just-in-time.md)
