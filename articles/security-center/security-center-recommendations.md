...
| [Применение управления JIT-доступом к сети](security-center-just-in-time.md) | Рекомендуется применять JIT-доступ для виртуальных машин. Функция JIT доступна в центре безопасности Azure уровня "Стандартный". Дополнительные сведения о ценовых категориях центра безопасности см. на странице [Цены](security-center-pricing.md). |
...
| [Включение адаптивного управления приложениями](security-center-adaptive-application.md) | Рекомендуется применять адаптивное управление приложениями на виртуальных машинах Windows. Эта функция доступна в центре безопасности Azure (цен. категория "Стандартный"). Дополнительные сведения о ценовых категориях центра безопасности см. на странице [Цены](security-center-pricing.md). |
