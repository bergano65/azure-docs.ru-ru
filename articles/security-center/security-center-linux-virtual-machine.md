...
> [!NOTE]
> Дополнительные сведения о каждой доступной **политике предотвращения** см. в статье [Настройка политик безопасности в центре безопасности Azure](security-center-azure-policy.md).
> 
