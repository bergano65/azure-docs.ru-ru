...
В этом кратком руководстве описано, как включить Azure Defender для обеспечения дополнительной безопасности и установить агент Log Analytics на виртуальных машинах, чтобы отслеживать угрозы и уязвимости системы безопасности.

Вам необходимо сделать следующее:

> [!div class="checklist"]
> * Включение Центра безопасности Azure в подписке
> * включить Azure Defender в своей подписке;
> * Включение автоматического сбора данных
...
1. На боковой панели Центра безопасности выберите **Начало работы**.
    ...
    :::image type="content" source="./media/security-center-get-started/get-started-upgrade-tab.png" alt-text="Вкладка &quot;Обновление&quot; на странице начала работы"::: 
