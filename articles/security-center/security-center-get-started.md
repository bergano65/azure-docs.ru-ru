...
1. В главном меню центра безопасности выберите **Начало работы**.
 
  ![Начало работы][4]

2. В разделе **Обновление** центра безопасности появится список подписок и рабочих областей, доступных для подключения. 
   - Вы можете щелкнуть расширяемый список **Применить пробную версию** для отображения всех подписок и рабочих областей, для которых доступна пробная версия.
   -    Вы можете обновить подписки и рабочие области, пробная версия для которых недоступна.
   -    Можно выбрать подходящие рабочие области и подписки для использования в режиме пробной версии.
