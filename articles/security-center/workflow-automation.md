...
ms.locfileid: "92344038"
---
# <a name="create-automatic-responses-to-alerts-and-recommendations-with-workflow-automation"></a>Создание автоматических ответов на оповещения и рекомендаций с помощью автоматизации рабочих процессов
