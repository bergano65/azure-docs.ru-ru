...
|Оповещения обнаружения угроз для аналитики поведения виртуальной машины|✔|✔|✔|✔ (в поддерживаемых версиях)|✔ (в поддерживаемых версиях)|✔|Обнаружение угроз (бесплатное) (Standard)|
|Оповещения об обнаружении угроз на основе сети|✔|✔|X|✔|✔|X|Стандарт|
|Интеграция ATP в защитнике Майкрософт|✔ (в поддерживаемых версиях)|✔ (в поддерживаемых версиях)|✔|X|X|X|Стандарт|
...
|Мониторинг целостности файлов|✔|✔|✔|✔|✔|✔|Стандарт|
...
|Адаптивная защита сети|✔|X|X|✔|X|X|Стандарт|
