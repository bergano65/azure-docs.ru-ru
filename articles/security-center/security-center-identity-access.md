...
|----|----|----|----|
|Subscription|50|Необходимо включить MFA для учетных записей с разрешениями владельца в подписке.|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с правами администратора, чтобы предотвратить брешь в системе безопасности учетных записей или ресурсов.|
|Subscription|40|Для учетных записей подписки необходимо включить MFA с разрешениями на запись|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с привилегиями записи, чтобы предотвратить нарушение безопасности учетных записей или ресурсов.|
|Subscription|30|Внешние учетные записи с разрешениями владельца должны быть удалены из подписки.|Удаляет внешние учетные записи с разрешениями владельца из подписки, чтобы предотвратить неотслеживаемый доступ.|
|Subscription|30|MFA необходимо включить в учетных записях подписки с разрешениями на чтение|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с привилегиями чтения, чтобы предотвратить нарушение безопасности учетных записей или ресурсов.|
|Subscription|25|External accounts with write permissions should be removed from your subscription (Внешние учетные записи с разрешениями на запись следует удалять из подписки)|Удаляет внешние учетные записи с разрешениями записи из подписки, чтобы предотвратить неотслеживаемый доступ. |
|Subscription|20|Устаревшие учетные записи с разрешениями владельца должны быть удалены из подписки.|Удаляет нерекомендуемые учетные записи с разрешениями владельца из подписок.|
|Subscription|5|Устаревшие учетные записи следует удалить из подписки.|Удаляет устаревшие учетные записи из ваших подписок, чтобы разрешить доступ к только текущим пользователям. |
|Subscription|5|К подписке должен быть назначен более одного владельца.|Назначает несколько владельцев подписки, чтобы обеспечить избыточный доступ для администраторов.|
|Subscription|5|Для подписки должно быть назначено не более 3 владельцев.|Назначает до 3 владельцев подписки, чтобы снизить вероятность бреши в системе безопасности скомпрометированной владельцем.|
...
|Subscription|15|Внешние учетные записи с разрешениями на чтение должны быть удалены из подписки.|Удаляет внешние учетные записи с разрешениями на чтение из подписки, чтобы предотвратить неотслеживаемый доступ.| 
