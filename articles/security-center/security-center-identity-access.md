...
> [!NOTE]
> «Представление *классической* удостоверения и доступ» ссылка будет прекращена 31 июля 2019 г. Нажмите кнопку [здесь](security-center-features-retirement-july2019.md#menu_classicidentity) дополнительные альтернативные службы.
...
|----|----|----|----|
|Подписка|50|Включите MFA для учетных записей с разрешениями владельца в вашей подписке.|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с правами администратора, чтобы предотвратить брешь в системе безопасности учетных записей или ресурсов.|
|Подписка|50|Включите Центр безопасности в своих подписках |Включает Центр безопасности на всех ваших подписках для расширенного обнаружения угроз, JIT, списка разрешений приложения и расширенных рекомендаций. |
|Подписка|50|Включите Центр безопасности уровня "Стандартный" в своих подписках. |Включает Центр безопасности уровня "Стандартный" на всех ваших подписках для расширенного обнаружения угроз, JIT, списка разрешений приложения и расширенных рекомендаций.|
|Подписка|40|Включите MFA для учетных записей приложения управления Azure с разрешениями записи в вашей подписке.|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с привилегиями записи, чтобы предотвратить нарушение безопасности учетных записей или ресурсов.|
|Подписка|30|Удалите внешние учетные записи с разрешениями владельца из подписки|Удаляет внешние учетные записи с разрешениями владельца из подписки, чтобы предотвратить неотслеживаемый доступ. |
|Подписка|30|Включите MFA для учетных записей приложения управления Azure с разрешениями считывания в вашей подписке.|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с привилегиями чтения, чтобы предотвратить нарушение безопасности учетных записей или ресурсов.|
|Подписка|25|Удалите внешние учетные записи с разрешениями на запись из подписки|Удаляет внешние учетные записи с разрешениями записи из подписки, чтобы предотвратить неотслеживаемый доступ. |
|Подписка|20|Удалите нерекомендуемые учетные записи с разрешениями владельца из подписки.|Удаляет нерекомендуемые учетные записи с разрешениями владельца из подписок. Устаревшие учетные записи — это учетные записи, для которых вход был заблокирован в Azure AD.|
|Подписка|5|Удалите нерекомендуемые учетные записи из подписки.|Удаляет устаревшие учетные записи из ваших подписок, чтобы разрешить доступ к только текущим пользователям. Устаревшие учетные записи — это учетные записи, для которых вход был заблокирован в Azure AD.|
|Подписка|5|Назначьте несколько владельцев в подписке|Назначает несколько владельцев подписки, чтобы обеспечить избыточный доступ для администраторов.|
|Подписка|5|Назначьте до 3 владельцев в подписке|Назначает до 3 владельцев подписки, чтобы снизить вероятность бреши в системе безопасности скомпрометированной владельцем.|
|Хранилище ключей|5|Включите журналы диагностики в Key Vault.|Включает журналы и сохраняет их на год. Это позволит воссоздать следы действий для анализа инцидентов безопасности или при компрометации сети. |
|Подписка|15|Удалите внешние учетные записи с разрешениями на чтение из подписки|Удаляет внешние учетные записи с разрешениями на чтение из подписки, чтобы предотвратить неотслеживаемый доступ.|
|Подписка|1|Предоставление сведений о контактном лице по вопросам безопасности|Предоставляет сведения о контактном лице по вопросам безопасности для каждой подписки. Контактные сведения включают адрес электронной почты и номер телефона. Эти сведения используются для связи с вами, если наша группа безопасности обнаружит, что ваши ресурсы были скомпрометированы.|

> ![ПРИМЕЧАНИЕ] Если вы создали политику условного доступа, которой требуется открытая многофакторная проверка подлинности, но имеете набор исключений, то оценка рекомендаций MFA центра безопасности будет считать политику несоответствующей, поскольку позволяет некоторым пользователям входить в Azure без MFA.
>
