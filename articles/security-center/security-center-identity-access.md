...
|----|----|----|----|
|Подписка|50|Многофакторной проверки Подлинности должен быть включен на учетные записи с правами владельца в подписке|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с правами администратора, чтобы предотвратить брешь в системе безопасности учетных записей или ресурсов.|
|Подписка|40|Должна быть включена для учетных записей подписки с разрешениями на запись|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с привилегиями записи, чтобы предотвратить нарушение безопасности учетных записей или ресурсов.|
|Подписка|30|Внешние учетные записи с правами владельца, которые должны быть удалены из подписки|Удаляет внешние учетные записи с разрешениями владельца из подписки, чтобы предотвратить неотслеживаемый доступ.|
|Подписка|30|Должна быть включена для учетных записей подписки с разрешениями на чтение|Включает Многофакторную идентификацию (MFA) для всех учетных записей подписки с привилегиями чтения, чтобы предотвратить нарушение безопасности учетных записей или ресурсов.|
|Подписка|25|Внешние учетные записи с записи, что разрешения должны быть удалены из подписки|Удаляет внешние учетные записи с разрешениями записи из подписки, чтобы предотвратить неотслеживаемый доступ. |
|Подписка|20|Устаревшие учетные записи с правами владельца, которые должны быть удалены из подписки|Удаляет нерекомендуемые учетные записи с разрешениями владельца из подписок.|
|Подписка|5|Устаревшие учетные записи должны быть удалены из подписки|Удаляет устаревшие учетные записи из ваших подписок, чтобы разрешить доступ к только текущим пользователям. |
|Подписка|5|Должно быть больше одного владельца, назначенные вашей подписке|Назначает несколько владельцев подписки, чтобы обеспечить избыточный доступ для администраторов.|
|Подписка|5|Более 3 владельцы должны быть обозначены для вашей подписки|Назначает до 3 владельцев подписки, чтобы снизить вероятность бреши в системе безопасности скомпрометированной владельцем.|
|Хранилище ключей|5|Журналы диагностики в хранилище ключей должен быть включен|Включите журналы и сохраняйте их на год. Это позволит воссоздать следы действий для анализа инцидентов безопасности или при компрометации сети. |
|Подписка|15|Внешние учетные записи с разрешениями на чтение должен быть удален из подписки|Удаляет внешние учетные записи с разрешениями на чтение из подписки, чтобы предотвратить неотслеживаемый доступ.| 

> [!NOTE]
> Если вы создали политику условного доступа, который требуется открытое многофакторной проверки Подлинности, но имеет набор исключений, оценка рекомендаций многофакторной проверки Подлинности центра безопасности считает, что политика несоответствия, так как он позволяет некоторые пользователи должны входить Azure без многофакторной проверки Подлинности.
