...
Оповещения отображаются на странице **Безопасность** в Key Vault, на панели мониторинга Azure Defender и на странице оповещений центра обеспечения безопасности.
