...
7. У вас есть три варианта **параметров диагностики**. Вы можете выбрать один, два или все три и настроить каждый из них в соответствие с вашими требованиями:
   ...
   * **Archive to a storage account** (Архивировать в учетной записи хранения). Для этого процесса потребуется учетная запись хранения, созданная ранее. Сведения о создании учетной записи хранения см. [здесь](../storage/common/storage-account-create.md?tabs=azure-portal).
...
* [Проверка доступных метрик для балансировщика нагрузки](https://docs.microsoft.com/azure/load-balancer/load-balancer-standard-diagnostics)
