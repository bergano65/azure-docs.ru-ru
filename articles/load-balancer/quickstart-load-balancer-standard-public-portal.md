...
2. На вкладке **Основные сведения** страницы **Создание подсистемы балансировки нагрузки** введите или выберите следующие сведения, примите значения по умолчанию для остальных параметров и нажмите кнопку **Review + create** (Проверить и создать).
    ...
    | Имя общедоступного IP-адреса              | Введите *myPublicIP* в текстовом поле.   Для создания базового общедоступного IP-адреса используйте ```-SKU Basic```. Общедоступные IP-адреса ценовой категории "Базовый" несовместимы с подсистемой балансировки нагрузки ценовой категории **Стандартный**. Для производственных рабочих нагрузок компания Майкрософт рекомендует использовать ценовую категорию **Стандартный**.|
