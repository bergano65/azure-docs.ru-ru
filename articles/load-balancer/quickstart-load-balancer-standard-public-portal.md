...
3. Для настройки правила для исходящего трафика используйте следующие значения:
    ...
    | Интерфейсный IP-адрес | Выберите **Создать**. </br> В разделе **Имя** введите **LoadBalancerFrontEndOutbound**. </br> Выберите **IP-адрес** или **IP-префикс**. </br> Выберите **Создать** в разделе **Общедоступный IP-адрес** или **Общедоступный IP-префикс**. </br> В качестве имени введите **myPublicIPOutbound** или **myPublicIPPrefixOutbound**. </br> Щелкните **ОК**. </br> Выберите **Добавить**.|
