...
Ресурс Load Balancer сам по себе является региональным и никогда не бывает зональным. Степень детализации, которую можно настроить, ограничивается каждой конфигурацией внешнего интерфейса, правила и определения внутреннего пула.
...
#### <a name="zone-redundant"></a>Избыточная зона 
