---
title: Конфигурация подсистемы балансировки нагрузки только для исходящих подключений
...
---
# <a name="outbound-only-load-balancer-configuration"></a>Конфигурация подсистемы балансировки нагрузки только для исходящих подключений
...
2. В верхней левой части экрана выберите **создать ресурс > сети > виртуальная сеть** или найдите **виртуальную сеть** в поле поиска.

2. В окне **Создание виртуальной сети**введите или выберите эти сведения на вкладке " **основы** ":

    | **Параметр**          | **Значение**                                                           |
    |------------------|-----------------------------------------------------------------|
    | **Сведения о проекте**  |                                                                 |
    | Подписка     | Выбор подписки Azure                                  |
    | Группа ресурсов   | Выберите **Создать**. </br> Введите **myResourceGroupLB**. </br> Нажмите кнопку **OK**. |
    | **Сведения об экземпляре** |                                                                 |
    | Имя             | Введите **myVNet**                                    |
    | Регион           | Выберите **Восточная часть США 2** |

3. Перейдите на вкладку **IP-адреса** или нажмите кнопку **Далее: IP-адреса** в нижней части страницы.

4. На вкладке **IP-адреса** введите следующие сведения:

    | Параметр            | Значение                      |
    |--------------------|----------------------------|
    | Диапазон IPv4-адресов | Введите **10.1.0.0/16** |

5. В разделе **имя подсети**выберите слово **по умолчанию**.
...
9. В разделе **бастионхост**выберите **включить**. Введите следующие сведения:

    | Параметр            | Значение                      |
    |--------------------|----------------------------|
    | Имя бастиона | Введите **мибастионхост** |
    | Адресное пространство Азуребастионсубнет | Введите **10.1.1.0/24** |
    | Общедоступный IP-адрес | Выберите **Создать**. </br> В качестве **имени**введите **мибастионип**. </br> Нажмите кнопку **OK**. |


8. Перейдите на вкладку " **Проверка и создание** " или нажмите кнопку " **Проверка и создание** ".
...
4. На вкладке "Сеть" укажите следующее.
    ...
    | Сетевая группа безопасности сетевого адаптера | Выбрать **нет**|
...
2. На странице **Создание подсистемы балансировки нагрузки** на вкладке **Основные сведения** укажите следующее. 
    ...
    | Группа ресурсов         | Выберите **myResourceGroupLB** , созданный на предыдущем шаге.|
    ...
    | Виртуальная сеть | Выберите **myVNet** , созданный на предыдущем шаге. |
    | Подсеть  | Выберите **myBackendSubnet** , созданный на предыдущем шаге. |
...
2. На странице **Создание подсистемы балансировки нагрузки** на вкладке **Основные сведения** укажите следующее. 
    ...
    | Зона доступности | Выбор **избыточности в зоне** |
...
2. На странице **Обзор** выберите **подключить**, а затем **бастиона**.

4. Введите имя пользователя и пароль, введенные во время создания виртуальной машины.
