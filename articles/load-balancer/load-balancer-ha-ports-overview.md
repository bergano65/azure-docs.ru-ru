...
- Не поддерживается объединение правил балансировки нагрузки портов с высоким уровнем доступности и правила балансировки нагрузки портов без высокой доступности, указывающих на тот же серверный ipconfigurations.
...
- [Настройка портов высокой доступности во внутренней Load Balancer (цен. категория "Стандартный")](load-balancer-configure-ha-ports.md)
