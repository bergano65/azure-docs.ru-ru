---
title: Краткое руководство. Создание общедоступного базового Load Balancer — портал Azure
...
ms.locfileid: "74048701"
---
# <a name="quickstart-create-a-basic-load-balancer-by-using-the-azure-portal"></a>Краткое руководство. Создание базовой Load Balancer с помощью портал Azure
...
2. На вкладке **Основные сведения** страницы **Создание подсистемы балансировки нагрузки** введите или выберите следующие сведения, примите значения по умолчанию для остальных параметров и нажмите кнопку **Review + create** (Проверить и создать).
    ...
    | введите          | Щелкните **Общедоступный**.                                        |
