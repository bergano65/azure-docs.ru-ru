---
title: Обзор IPv6 - Балансер загрузки Azure
description: С помощью этого пути обучения начинайте с поддержки IPv6 для Azure Load Balancer и сбалансированных с нагрузкой VM.
...
>[!NOTE] 
>Это содержание было заменено [IPv6 для обзора Azure VNet.](https://docs.microsoft.com/azure/virtual-network/ipv6-overview) Azure рекомендует новым развертываниям IPv6 использовать новый IPv6 для функций виртуальных сетей Azure.
...
Основные балансирумы нагрузки SKU для интернета могут быть развернуты с адресом IPv6. Помимо подключения по протоколу IPv4 это дает следующие возможности:
