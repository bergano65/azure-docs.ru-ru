...
description: С помощью этого пути обучения начинайте создавать общественный баланс с IPv6 с помощью Azure CLI.
