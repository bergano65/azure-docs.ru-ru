...
* **Правила балансировки нагрузки**. Содержит правила, которые сопоставляют общедоступный порт в подсистеме балансировки нагрузки и порт во внутреннем пуле адресов.
