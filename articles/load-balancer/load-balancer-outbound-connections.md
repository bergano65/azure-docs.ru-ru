...
>[!NOTE]
> Если имеется внутренний пул с максимальным размером 6, то каждый экземпляр может иметь 64000/10 = 6 400 портов, если определено явное правило исходящего трафика. В соответствии с приведенной выше таблицей в каждой из них будет 1 024, если выбрано автоматическое выделение.
