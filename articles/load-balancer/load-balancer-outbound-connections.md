...
[Эфемерные порты,](#preallocatedports) используемые для [PAT,](#pat) являются исчерпывающим ресурсом, как описано в [Standalone VM без публичного IP-адреса](#defaultsnat) и [сбалансированного VM без публичного IP-адреса.](#lb)
