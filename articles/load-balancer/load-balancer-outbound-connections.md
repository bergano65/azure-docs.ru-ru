...
Если [несколько общедоступных IP-адресов связаны с Load Balancer категории "Базовый"](load-balancer-multivip-overview.md), то любой из них, [но только один случайно выбранный, можно использовать для исходящих потоков](#multivipsnat).  
