...
3. Используйте эти значения, чтобы настроить интерфейсную IP-конфигурацию для исходящего трафика:
    ...
    | Тип IP-адреса | Выберите **IP-адрес** или **префикс IP-** адреса.|
    | Общедоступный IP-адрес | Выберите **Создать**. </br> В поле **добавить общедоступный IP-адрес**введите **мипублиЦипаутбаунд**. </br> При использовании префикса IP-адреса в **добавьте префикс общедоступного IP-адреса**и введите **мипублиЦиппрефиксаутбаунд**. Выберите **Размер префикса** для префикса общедоступного IP-адреса </br> Щелкните **ОК**.  |
...
3. Используйте эти значения для настройки правил исходящего трафика:
    ...
    | Время ожидания простоя (в минутах) | Переместите ползунок в значение **15 минут**.|
    | Сброс TCP | Выберите значение **Включено**.|
