...
- Плавающий IP-адрес в настоящее время не поддерживается во вторичных IP-конфигурациях для сценариев с использованием внутренней или общедоступной балансировки нагрузки.
