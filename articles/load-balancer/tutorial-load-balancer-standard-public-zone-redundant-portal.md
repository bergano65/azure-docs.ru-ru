...
2. На странице **Create a load balancer** (Создание подсистемы балансировки нагрузки) введите следующие значения для подсистемы балансировки нагрузки.
    ...
    - **Public** — для типа подсистемы балансировки нагрузки.
     - *myPublicIP* — для нового общедоступного IP-адреса. Для этого щелкните **Выберите общедоступный IP-адрес**, а затем нажмите кнопку **Создать**. Для имени введите *myPublicIP*, номер SKU — "Стандартный" по умолчанию и выберите **Избыточное между зонами** для параметра **Зона доступности**.
