...
ms.locfileid: "87501725"
---
# <a name="azure-cli-script-example-load-balance-vms-across-availability-zones"></a>Пример скрипта Azure CLI. Балансировка нагрузки виртуальных машин в пределах зон доступности
