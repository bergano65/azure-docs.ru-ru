...
* Создает Load Balancer SKU "Стандартный" с расположением, указанным в той же группе ресурсов базового Load Balancer (цен. категория "Стандартный").
...
Скачайте скрипт миграции из  [коллекция PowerShell](https://www.powershellgallery.com/packages/AzurePublicLBUpgrade/4.0).
