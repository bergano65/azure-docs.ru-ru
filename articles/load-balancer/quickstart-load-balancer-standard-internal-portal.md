...
Начните работу с Azure Load Balancer, создав с помощью портала Azure внутреннюю подсистему балансировки нагрузки и три виртуальные машины.
...
7. Выполните шаги 1–8, чтобы создать еще две виртуальные машины со следующими значениями (все остальные параметры совпадают с параметрами виртуальной машины **myVM1**).
