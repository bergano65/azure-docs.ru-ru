...
9. Повторите шаги 1–6, чтобы установить IIS и разместить обновленный файл iisstart.htm на **myVM2**.
...
* Дополнительные сведения о [Бастионе Azure](https://docs.microsoft.com/azure/bastion/bastion-overview).
