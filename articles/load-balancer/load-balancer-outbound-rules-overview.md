...
**frontend** + **parameters** + **серверный пул** параметров внешнего интерфейса
...
### <a name="enable-tcp-reset-on-idle-timeout"></a><a name="tcprst"></a><a name="tcpreset"></a> Включить сброс TCP при превышении времени ожидания простоя
