...
Вы можете вернуться к [автоматическому распределению SNAT-портов на основе размера серверного пула](load-balancer-outbound-connections.md#preallocatedports), указав значение 0 для количества портов. В этом случае первые 50 экземпляров виртуальных машин получат порты 1024, 51-100 экземпляры виртуальных машин будут получать 512 и т. д. в соответствии с таблицей. Наличие более чем одного внешнего интерфейса с общедоступным IP-адресом, связанным с правилом исходящего трафика, не увеличивает число портов, выделенных для каждого экземпляра виртуальной машины.
