---
title: Руководство. Виртуальные машины подсистемы балансировки нагрузки в пределах зоны — портал Azure | Документация Майкрософт
...
ms.locfileid: "68273390"
---
# <a name="tutorial-load-balance-vms-within-an-availability-zone-with-standard-load-balancer-by-using-the-azure-portal"></a>Руководство. Распределение нагрузки на виртуальные машины в пределах зоны доступности с помощью Load Balancer ценовой категории "Стандартный" и портала Azure
...
2. На вкладке **Основные сведения** страницы **Создание подсистемы балансировки нагрузки** введите или выберите следующие сведения, примите значения по умолчанию для остальных параметров и нажмите кнопку **Review + create** (Проверить и создать).
    ...
    | Resource group         | Выберите **Создать** и введите *MyResourceGroupZLB* в текстовом поле.|
    | ИМЯ                   | *myLoadBalancer*                                   |
...
2. Щелкните **Создать**, чтобы создать виртуальную сеть.
    ...
    ![Создание виртуальной сети](./media/tutorial-load-balancer-standard-zonal-portal/create-virtual-network.png)
