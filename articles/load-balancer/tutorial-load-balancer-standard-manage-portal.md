...
1. Выполните действия, чтобы создать еще две виртуальные машины *myVM2* и *myVM3* с общедоступным IP-адресом ценовой категории "Стандартный" в **зонах доступности** **2** и **3**, соответственно, и с теми же параметрами, как и *myVM1*.  
