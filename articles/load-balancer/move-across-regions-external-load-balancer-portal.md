...
13. Выберите **основные** > **Подписка** , чтобы выбрать подписку, в которой будет развернута Целевая внешняя подсистема балансировки нагрузки.
...
16. Убедитесь, что в поле **основные** > **Расположение** установлено целевое расположение, в котором должна быть развернута внешняя подсистема балансировки нагрузки.
