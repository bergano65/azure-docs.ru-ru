...
> [!IMPORTANT]
> Подсистема балансировки нагрузки в разных регионах сейчас доступна в предварительной версии и может быть развернута на портале. Войдите в, чтобы **https://portal.azure.com** Просмотреть и развернуть компонент.. </br> </br>
