...
> [!IMPORTANT]
> Подсистема балансировки нагрузки между регионами сейчас доступна в предварительной версии и скрыта на портале предварительной версии. Войдите в, чтобы **https://preview.portal.azure.com/?feature.globallb=true** Просмотреть и развернуть компонент.. </br> </br>
