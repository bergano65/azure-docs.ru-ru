...
> [!NOTE]
> Внутренний порт для загрузки правила балансировки нагрузки в подсистеме балансировки нагрузок между регионами должен соответствовать интерфейсному порту правила балансировки нагрузки правило NAT для входящего трафика в подсистеме балансировки нагрузки "Региональный стандарт". 
...
:::image type="content" source="./media/cross-region-overview/global-region-view.png" alt-text="Схема балансировщика нагрузки в разных регионах." border="true":::
...
- См. статью [Создание общедоступного стандартного балансировщика нагрузки](quickstart-load-balancer-standard-public-portal.md) для начала работы с подсистемой балансировки нагрузки.
