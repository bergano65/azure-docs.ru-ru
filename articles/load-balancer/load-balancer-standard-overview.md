...
За Load Balancer (цен. категория "Стандартный") плата взимается, исходя из количества настроенных правил балансировки нагрузки и всех обработанных входящих и исходящих данных. Сведения о ценах на Load Balancer уровня "Стандартный" см. на [странице цен](https://aka.ms/lbpricing).
