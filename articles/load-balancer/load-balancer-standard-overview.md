...
- [Операции перемещения подписки](../azure-resource-manager/management/move-resource-group-and-subscription.md) не поддерживаются для ресурсов LB и PIP номера SKU "Стандартный".
