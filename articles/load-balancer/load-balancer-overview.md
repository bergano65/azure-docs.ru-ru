...
* **Проверки работоспособности**
    ...
    Кроме того, при использовании классических облачных служб допускается еще один тип:  [гостевой агент](load-balancer-custom-probe-overview.md#guestagent).  Его следует рассматривать как проверку работоспособности на крайний случай и не рекомендуется использовать, если другие варианты также являются приемлемыми.
...
- Обычно переадресация IP-фрагментов или выполнение фрагментации IP-адресов для UDP- и TCP-пакетов не поддерживается в правилах балансировки нагрузки.  [Правила балансировки нагрузки для портов с высоким уровнем доступности](load-balancer-ha-ports-overview.md) являются исключением для этого общего случая и могут использоваться для переадресации существующих IP-фрагментов.
