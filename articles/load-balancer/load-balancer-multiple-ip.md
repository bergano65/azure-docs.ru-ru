...
description: Из этой статьи вы узнаете о балансировке нагрузки для первичной и вторичной IP-конфигурации с помощью портал Azure.
...
2. В верхнем левом углу экрана выберите **создать ресурс**  >  **Сетевые подключения**  >  **Load Balancer**. Далее выберите **Создать**.
...
3. В разделе **Параметры**выберите **серверные пулы**. Введите имя внутреннего пула (например, **contosopool** или **fabrikampool**). В верхней части следующей колонки выберите **Добавить**. 
...
4. Введите имя проверки работоспособности (например, **HTTP**). Щелкните **ОК**.
...
1. <a name="step6-1"></a>В разделе **Параметры**выберите **правила балансировки нагрузки**. В верхней части следующей колонки выберите **Добавить**. 
...
6. <a name="step6-6"></a>Нажмите кнопку **ОК**.
