...
description: В этой статье узнайте о балансировке нагрузки в первичных и вторичных конфигурациях IP с помощью портала Azure.
...
1. Войдите на портал Azure по адресу https://portal.azure.com. Войдите в систему с использованием учетной записи Azure.
...
2. В верхнем левом углу экрана выберите **«Создайте** > **балансослер****сетевой** > нагрузки». Далее выберите **Создать**.
...
3. Под **настройками**выберите **backend бассейны.** Введите имя внутреннего пула (например, **contosopool** или **fabrikampool**). В верхней части следующей колонки выберите **Добавить**. 
...
3. В разделе **Параметры** выберите **Health probe** (Проверка работоспособности). В верхней части следующей колонки выберите **Добавить**. 
...
1. <a name="step6-1"></a>В настройках выберите **правила балансировки** **нагрузки.** В верхней части следующей колонки выберите **Добавить**. 
...
6. <a name="step6-6"></a>Выберите **OK**.
...
- Узнайте, как можно использовать различные типы журналов для управления и устранения неполадок в [журналах Azure Monitor для Azure Load Balancer.](../load-balancer/load-balancer-monitor-log.md)
