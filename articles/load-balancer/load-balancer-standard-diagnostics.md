...
| Рекомендации недоступны | Ресурс "Стандартный балансировщик нагрузки" неисправен. Для диагностики работоспособности выберите **Azure Monitor**  >  **метрики**Azure Monitor.<br>(Состояние "*недоступно* " может также означать, что ресурс не подключен к вашей стандартной подсистеме балансировки нагрузки.) |
