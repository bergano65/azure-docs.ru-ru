...
2. Группировка по **состоянию соединения** для успешных и неудачных подключений SNAT может представляться различными линиями. 
...
Используйте **Sum** в качестве агрегата для большинства сценариев.
...
1. Выберите **число байтов** и/или тип метрики **числа пакетов** с **суммой** в качестве агрегата. 
