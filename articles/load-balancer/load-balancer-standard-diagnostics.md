...
| --- | --- |
| Доступна | Ресурс "Стандартный балансировщик нагрузки" исправен и доступен. |
...
| Unknown | Состояние работоспособности ресурсов для ресурса подсистемы балансировки нагрузки "Стандартный" еще не обновлено.<br>(*Неизвестное* состояние может также означать, что ресурс не подключен к вашей стандартной подсистеме балансировки нагрузки.)  |
