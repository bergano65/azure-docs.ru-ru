...
1. Если приложение начинает производить тайм-аут ответа зонда непосредственно перед прибытием первого зонда, обнаружение этих событий займет 10 секунд (2 х 5 секунд интервалов) плюс продолжительность приложения, начинающего сигнализировать тайм-аут, когда первый зонд прибывает.  Можно предположить, что это обнаружение займет чуть более 10 секунд.
...
>[!NOTE]
>Зонд работы будет зондировать все случаи выполнения в пуле бэкэнда. Если экземпляр остановлен, он не будет исследован до тех пор, пока он не будет запущен снова.
