...
| [Реакция на сбой пробы работоспособности](#probedown) | При сбое всех проб работоспособности потоки TCP продолжаются. | Все датчики вниз, срок действия всех потоков TCP. | 
...
В дополнение к проверке работоспособности подсистемы балансировки нагрузки [следующие операции используют этот IP-адрес](../virtual-network/what-is-ip-address-168-63-129-16.md):
