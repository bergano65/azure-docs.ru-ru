...
ms.locfileid: "79096127"
---
# <a name="tutorial-balance-internal-traffic-load-with-a-basic-load-balancer-in-the-azure-portal"></a>Руководство по Балансировка нагрузки внутреннего трафика с помощью подсистемы балансировки нагрузки уровня "Базовый" на портале Azure
...
1. На странице **Добавление серверного пула** введите или выберите приведенные ниже значения.
   ...
   - **Сопоставлено с**. Раскройте список **Виртуальная машина** и выберите нужно значение.
   
   
1. Установите флажок **Виртуальная машина**. 
