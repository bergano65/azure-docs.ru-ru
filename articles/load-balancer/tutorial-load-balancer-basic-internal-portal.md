...
**Чтобы создать серверный пул адресов, включающий VM1 и VM2:**
...
**Чтобы создать пробу работоспособности для отслеживания работоспособности виртуальных машин:**
...
**Чтобы создать правило подсистемы балансировки нагрузки:**
...
**Чтобы подключиться к виртуальной машине с помощью RDP:**
...
**Чтобы установить IIS и обновить веб-страницу по умолчанию с помощью PowerShell:**
