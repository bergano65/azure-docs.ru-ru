---
title: Руководство по созданию внутренней подсистемы балансировки нагрузки уровня "Базовый" с помощью портала Azure | Документация Майкрософт
...
1. На панели **Создание подсистемы балансировки нагрузки** введите или выберите следующие значения:
   ...
   - **Виртуальная сеть**. Щелкните **Выбор виртуальной сети**, а затем выберите **MyVNet**.
   - **Подсеть**. Щелкните **Выбор подсети**, а затем выберите **MyBackendSubnet**.
...
1. На странице **Добавить правило балансировки нагрузки** введите или выберите следующие значения, если они отсутствуют:
   ...
   - **Интерфейсный IP-адрес**. Введите *LoadBalancerFrontEnd*, если оно отсутствует.
