...
В этой статье приведены пошаговые инструкции по созданию общедоступного [Load Balancer категории "Стандартный"](https://aka.ms/azureloadbalancerstandard) с избыточным между зонами внешним интерфейсом, чтобы достичь избыточности между зонами без зависимости от нескольких записей DNS. Один интерфейсный IP-адрес по умолчанию является избыточным между зонами.  Используйте избыточный в пределах зоны внешний интерфейс для распределения нагрузки, с помощью одного IP-адреса можно связаться с любой виртуальной машиной в рамках региона во всех зонах доступности. Зоны доступности позволяют защитить приложения и данные от маловероятных сбоев и потери всего центра обработки данных.
