---
title: Azure Service Bus - приостановка деятельности мессенджеров
description: В этой статье объясняется, как временно приостанавливать и повторно активировать объекты сообщений Azure Service Bus (очереди, темы и подписки).
...
На портале раздел **«Свойства»** для соответствующей организации позволяет изменить состояние; следующий скриншот показывает переключатель для очереди:
