...
* [Владелец данных шины службы (Предварительная версия)](../role-based-access-control/built-in-roles.md#service-bus-data-owner): Обеспечивает доступ к данным к пространству имен служебной шины и его сущностей (очереди, разделы, подписки и фильтры)
