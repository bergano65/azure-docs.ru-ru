---
title: Как использовать AMQP 1,0 с API-интерфейсом служебной шины Java JMS | Документация Майкрософт
...
## <a name="jms-topics-vs-service-bus-topics"></a>Статьи о JMS и Разделы шины обслуживания
