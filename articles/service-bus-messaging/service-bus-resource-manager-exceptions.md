...
| Код ошибки | Код ошибки | Сообщение об ошибке | Description | Рекомендация |
| ---------- | ------------- | ------------- | ----------- | -------------- |
...
| Не найдено | none | Не найден. Операция не существует. | Операция, которую вы пытаетесь выполнить, не существует. | Проверьте операцию и повторите попытку. |
