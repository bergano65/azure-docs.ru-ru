...
ms.locfileid: "54002677"
---
# <a name="quickstart-send-and-receive-messages-using-the-azure-portal-and-net"></a>Краткое руководство. Отправка и получение сообщений с помощью портала Azure и .NET
