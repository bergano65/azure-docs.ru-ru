---
title: Передача, блокировки и сопоставление сообщений служебной шины Azure
...
> [!IMPORTANT]
> Важно отметить, что блокировка, PeekLock в сообщении, является временной и может быть потеряна в следующих условиях.
>   * Обновление службы
>   * Обновление ОС
