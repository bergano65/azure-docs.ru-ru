---
title: Обзор Am-P 1.0 в сервисном автобусе Azure
description: Узнайте, как Azure Service Bus поддерживает Расширенный протокол очередей сообщений (АМЗП), открытый стандартный протокол.
