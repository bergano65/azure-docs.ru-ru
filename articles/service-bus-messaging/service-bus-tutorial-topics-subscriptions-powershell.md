...
В рамках этого руководства вы подготовили ресурсы с помощью Azure PowerShell, а затем отправили и получили сообщения через раздел служебной шины и подписок на него. Вы ознакомились с выполнением следующих задач:
