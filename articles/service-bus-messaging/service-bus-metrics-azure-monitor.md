...
description: Использование Azure Monitor для мониторинга сущностей служебной шины
...
Можно также открыть метрики непосредственно с помощью пространства имен. Чтобы сделать это, выберите нужное пространство имен и нажмите кнопку **метрики**. Чтобы отобразить метрики, отфильтрованные по сущности, выберите сущность и нажмите кнопку **метрики**.
...
Метрики и оповещения в Azure Monitor взимается по принципу каждое оповещение. Эти расходы должны быть доступны на портале, при настройке оповещения и до его сохранения. 

Дополнительные решения для приема данных метрик, выставляются непосредственно с этих решений. Например, при архивации данных метрик в учетную запись хранения Azure плата будет взиматься службой хранилища Azure, а при потоковой передаче данных метрик в Log Analytics для расширенного анализа плата будет взиматься за использование Log Analytics.
...
| ------------------- | ----------------- |
| Входящих запросов| Число запросов к службе служебной шины за указанный период. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Итого <br/> Измерение: EntityName|
|Выполненные запросы|Число успешных запросов к службе служебной шины за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Итого <br/> Измерение: EntityName|
|Server Errors|Число запросов, которые не были обработаны из-за ошибки в службе служебной шины, за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Итого <br/> Измерение: EntityName|
|Ошибки пользователей (см. следующий подраздел)|Количество запросов, не обработанных из-за ошибки пользователя, за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Итого <br/> Измерение: EntityName|
|Регулируемые запросы|Число запросов, которые были отрегулированы из-за превышения квоты использования.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Итого <br/> Измерение: EntityName|
...
| Имя метрики | Описание |
| ------------------- | ----------------- |
|Входящие сообщения|Количество событий или сообщений, отправленных в служебную шину, за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Итого <br/> Измерение: EntityName|
|Исходящие сообщения|Количество событий или сообщений, полученных из служебной шины, за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Итого <br/> Измерение: EntityName|
| Сообщения| Количество сообщений в очереди или разделе. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средние <br/> Измерение: EntityName |
| ActiveMessages| Количество активных сообщений в очереди или разделе. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средние <br/> Измерение: EntityName |
| Недоставленных сообщений| Количество недоставленных сообщений в очереди или раздела. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средние <br/>Измерение: EntityName |
| Запланированные сообщения| Число запланированных сообщений в очереди или раздела. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средние  <br/> Измерение: EntityName |

## <a name="connection-metrics"></a>Метрики подключения

| Имя метрики | Описание |
| ------------------- | ----------------- |
|ActiveConnections|Число активных подключений для пространства имен, а также для сущности.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Итого <br/> Измерение: EntityName|
...
2. Выберите **Выбор целевого объекта** параметр и выполните следующие действия на **выберите ресурс** страницы: 
...
1. Выберите **Добавить критерий** и выполните следующие действия на странице **Настройка логики сигнала**:
    ...
    2. Выберите сигнал. Пример: **Службы ошибки**. 
...
См. в разделе [Обзор Azure Monitor](../monitoring-and-diagnostics/monitoring-overview.md).
