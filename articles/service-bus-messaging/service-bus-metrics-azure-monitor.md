...
| Недоставленных сообщений (Предварительная версия) | Количество недоставленных сообщений в очереди или раздела. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средняя <br/>Измерение: EntityName |
| Запланированные сообщения (Предварительная версия) | Число запланированных сообщений в очереди или раздела. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средняя  <br/> Измерение: EntityName |
