...
| ------------------- | ----------------- |
| Incoming Requests (preview) | Число запросов к службе служебной шины за указанный период. <br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Successful Requests (preview)|Число успешных запросов к службе служебной шины за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Server Errors (preview)|Число запросов, которые не были обработаны из-за ошибки в службе служебной шины, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Ошибки пользователей (ознакомьтесь с предварительной версией в следующем подразделе)|Количество запросов, не обработанных из-за ошибки пользователя, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Throttled Requests (preview)|Число запросов, которые были отрегулированы из-за превышения квоты использования.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
...
| Имя метрики | ОПИСАНИЕ |
| ------------------- | ----------------- |
|Incoming Messages (preview)|Количество событий или сообщений, отправленных в служебную шину, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Outgoing Messages (preview)|Количество событий или сообщений, полученных из служебной шины, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
| Messages (preview) | Количество сообщений в очереди или разделе. <br/><br/> Единица измерения: Count <br/> Тип агрегирования. Средняя <br/> Измерение: EntityName |
| ActiveMessages (preview) | Количество активных сообщений в очереди или разделе. <br/><br/> Единица измерения: Count <br/> Тип агрегирования. Средняя <br/> Измерение: EntityName |

## <a name="connection-metrics"></a>Метрики подключения

| Имя метрики | ОПИСАНИЕ |
| ------------------- | ----------------- |
|ActiveConnections (preview)|Число активных подключений для пространства имен, а также для сущности.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Connections Opened (preview)|Число открытых подключений.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Connections Closed (preview)|Число закрытых подключений.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName |
