...
| ------------------- | ----------------- |
| Входящих запросов| Число запросов к службе служебной шины за указанный период. <br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Выполненные запросы|Число успешных запросов к службе служебной шины за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Ошибки на сервере|Число запросов, которые не были обработаны из-за ошибки в службе служебной шины, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Ошибки пользователей (см. следующий подраздел)|Количество запросов, не обработанных из-за ошибки пользователя, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Регулируемые запросы|Число запросов, которые были отрегулированы из-за превышения квоты использования.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
...
| Имя метрики | Описание |
| ------------------- | ----------------- |
|Входящие сообщения|Количество событий или сообщений, отправленных в служебную шину, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Исходящие сообщения|Количество событий или сообщений, полученных из служебной шины, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
| Сообщения| Количество сообщений в очереди или разделе. <br/><br/> Единица измерения: Count <br/> Тип агрегирования. Average <br/> Измерение: EntityName |
| ActiveMessages| Количество активных сообщений в очереди или разделе. <br/><br/> Единица измерения: Count <br/> Тип агрегирования. Average <br/> Измерение: EntityName |
| Недоставленные сообщения| Количество недоставленных сообщений в очереди или разделе. <br/><br/> Единица измерения: Count <br/> Тип агрегирования. Average <br/>Измерение: EntityName |
| Запланированные сообщения| Число запланированных сообщений в очереди или разделе. <br/><br/> Единица измерения: Count <br/> Тип агрегирования. Average  <br/> Измерение: EntityName |
...
| Имя метрики | Описание |
| ------------------- | ----------------- |
|Загрузка ЦП на пространство имен|Процент использования ЦП для пространства имен.<br/><br/> Единица измерения: Percent <br/> Тип агрегирования: Максимум <br/> Измерение: EntityName|
|Объем используемой памяти на пространство имен|Процент использования памяти для пространства имен.<br/><br/> Единица измерения: Percent <br/> Тип агрегирования: Максимум <br/> Измерение: EntityName|
...
1. Выберите **Добавить критерий** и выполните следующие действия на странице **Настройка логики сигнала**:
    ...
    2. Выберите сигнал. Пример: **Ошибки службы**. 
