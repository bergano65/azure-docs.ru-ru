...
|Server Errors|Число запросов, которые не были обработаны из-за ошибки в службе служебной шины, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Итог <br/> Измерение: имя сущности|
|Ошибки пользователей (см. следующий подраздел)|Количество запросов, не обработанных из-за ошибки пользователя, за указанный период.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Итог <br/> Измерение: имя сущности|
...
| Size | Размер сущности (очереди или раздела) в байтах. <br/><br/>Единица измерения: Count <br/>Тип агрегирования: Среднее <br/>Измерение: имя сущности | 
...
| Имя метрики | Описание |
| ------------------- | ----------------- |
|Активные подключения|Число активных подключений для пространства имен, а также для сущности.<br/><br/> Единица измерения: Count <br/> Тип агрегирования: Итог <br/> Измерение: имя сущности|
