...
| ------------------- | ----------------- |
| Incoming Requests (preview) | Число запросов к службе служебной шины за указанный период. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Successful Requests (preview)|Число успешных запросов к службе служебной шины за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Server Errors (preview)|Число запросов, которые не были обработаны из-за ошибки в службе служебной шины, за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Ошибки пользователей (ознакомьтесь с предварительной версией в следующем подразделе)|Количество запросов, не обработанных из-за ошибки пользователя, за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Throttled Requests (preview)|Число запросов, которые были отрегулированы из-за превышения квоты использования.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
...
| Имя метрики | Описание |
| ------------------- | ----------------- |
|Incoming Messages (preview)|Количество событий или сообщений, отправленных в служебную шину, за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
|Outgoing Messages (preview)|Количество событий или сообщений, полученных из служебной шины, за указанный период.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
| Messages (preview) | Количество сообщений в очереди или разделе. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средние <br/> Измерение: EntityName |
| ActiveMessages (preview) | Количество активных сообщений в очереди или разделе. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средние <br/> Измерение: EntityName |
| Недоставленных сообщений (Предварительная версия) | Количество недоставленных сообщений в очереди или раздела. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средние <br/>Измерение: EntityName |
| Запланированные сообщения (Предварительная версия) | Число запланированных сообщений в очереди или раздела. <br/><br/> Единица измерения: Количество <br/> Тип агрегирования. Средние  <br/> Измерение: EntityName |

## <a name="connection-metrics"></a>Метрики подключения

| Имя метрики | Описание |
| ------------------- | ----------------- |
|ActiveConnections (preview)|Число активных подключений для пространства имен, а также для сущности.<br/><br/> Единица измерения: Количество <br/> Тип агрегирования: Всего <br/> Измерение: EntityName|
...
| Имя метрики | Описание |
| ------------------- | ----------------- |
|CPU usage per namespace (preview)|Процент использования ЦП для пространства имен.<br/><br/> Единица измерения: Percent <br/> Тип агрегирования: Максимум <br/> Измерение: EntityName|
|Memory size usage per namespace (preview)|Процент использования памяти для пространства имен.<br/><br/> Единица измерения: Percent <br/> Тип агрегирования: Максимум <br/> Измерение: EntityName|
...
1. На странице **Создание правила** разверните **Определение сведений об оповещении** и выполните следующие действия:
    ...
    3. Выберите **уровень серьезности** для оповещения. 
        ...
        ![Подробности об оповещении](./media/service-bus-metrics-azure-monitor/alert-details.png)
1. На странице **Создание правила** разверните **Определение группы действий**, выберите **Новая группа действий** и выполните следующие действия на странице **Добавление группы действий**. 
    ...
    8. На странице **Email/SMS/Push/Voice** выполните следующие действия:
        ...
        3. Нажмите кнопку **ОК**.
            ...
            ![Подробности об оповещении](./media/service-bus-metrics-azure-monitor/add-action-group.png)
