...
2. В меню слева выберите **Сеть**. По умолчанию выбран параметр **Все сети**. Пространство имен Служебной шины принимает подключения с любого IP-адреса. То есть, такое значение параметра по умолчанию равноценно правилу, которое принимает диапазон IP-адресов 0.0.0.0/0. 

    ![Брандмауэр — выбран вариант "Все сети"](./media/service-bus-ip-filtering/firewall-all-networks-selected.png)
1. Установите переключатель рядом с пунктом **Выбранные сети** в верхней части страницы. В разделе **Брандмауэр** выполните следующие шаги:
...
3. На панели инструментов нажмите **Сохранить**, чтобы сохранить параметры. Подождите несколько минут, чтобы в уведомлениях портала появилось подтверждение.
