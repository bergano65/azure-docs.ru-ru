...
> [!IMPORTANT]
> Брандмауэры и виртуальные сети поддерживаются только в **премиальном** уровне Сервисного автобуса. Если обновление до **уровня premier** не является опцией, мы рекомендуем вам обеспечить безопасность маркера общей подписи доступа (SAS) и поделиться им только с авторизованными пользователями. Для получения информации о проверке подлинности SAS [см.](service-bus-authentication-and-authorization.md#shared-access-signature)
