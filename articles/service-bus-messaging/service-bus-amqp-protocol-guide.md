...
| Клиент | Служебная шина Azure |
| --- | --- |
| --> attach(<br/>name={имя ссылки},<br/>handle={числовой дескриптор},<br/>role=**sender**,<br/>source={идентификатор связи клиента},<br/>target={имя сущности}<br/>) |Без действия |
...
| Клиент | Служебная шина Azure |
| --- | --- |
| --> detach(<br/>handle={числовой дескриптор},<br/>closed=**true**<br/>) |Без действия |
| Без действия |<-- detach(<br/>handle={числовой дескриптор},<br/>closed=**true**<br/>) |

#### <a name="send-success"></a>Отправка (успешно)

| Клиент | Служебная шина Azure |
| --- | --- |
| --> transfer(<br/>delivery-id={числовой дескриптор},<br/>delivery-tag={двоичный дескриптор},<br/>settled=**false**,,more=**false**,<br/>state=**null**,<br/>resume=**false**<br/>) |Без действия |
| Без действия |<-- disposition(<br/>role=receiver,<br/>first={идентификатор доставки},<br/>last={идентификатор доставки},<br/>settled=**true**,<br/>state=**accepted**<br/>) |
...
| --- | --- |
| --> transfer(<br/>delivery-id={числовой дескриптор},<br/>delivery-tag={двоичный дескриптор},<br/>settled=**false**,,more=**false**,<br/>state=**null**,<br/>resume=**false**<br/>) |Без действия |
| Без действия |<-- disposition(<br/>role=receiver,<br/>first={идентификатор доставки},<br/>last={идентификатор доставки},<br/>settled=**true**,<br/>state=**rejected**(<br/>error={сведения об ошибке}<br/>)<br/>) |

#### <a name="receive"></a>Получение

| Клиент | Служебная шина Azure |
| --- | --- |
| --> flow(<br/>link-credit=1<br/>) |Без действия |
| Без действия |< transfer(<br/>delivery-id={числовой дескриптор},<br/>delivery-tag={двоичный дескриптор},<br/>settled=**false**,<br/>more=**false**,<br/>state=**null**,<br/>resume=**false**<br/>) |
| --> disposition(<br/>role=**receiver**,<br/>first={идентификатор доставки},<br/>last={идентификатор доставки},<br/>settled=**true**,<br/>state=**accepted**<br/>) |Без действия |

#### <a name="multi-message-receive"></a>Получение нескольких сообщений

| Клиент | Служебная шина Azure |
| --- | --- |
| --> flow(<br/>link-credit=3<br/>) |Без действия |
| Без действия |< transfer(<br/>delivery-id={числовой дескриптор},<br/>delivery-tag={двоичный дескриптор},<br/>settled=**false**,<br/>more=**false**,<br/>state=**null**,<br/>resume=**false**<br/>) |
| Без действия |< transfer(<br/>delivery-id={числовой дескриптор+1},<br/>delivery-tag={двоичный дескриптор},<br/>settled=**false**,<br/>more=**false**,<br/>state=**null**,<br/>resume=**false**<br/>) |
| Без действия |< transfer(<br/>delivery-id={числовой дескриптор+2},<br/>delivery-tag={двоичный дескриптор},<br/>settled=**false**,<br/>more=**false**,<br/>state=**null**,<br/>resume=**false**<br/>) |
| --> disposition(<br/>role=receiver,<br/>first={идентификатор доставки},<br/>last={идентификатор доставки + 2},<br/>settled=**true**,<br/>state=**accepted**<br/>) |Без действия |
...
| Имя поля | Использование | API-имя |
| --- | --- | --- |
| durable |- |- |
| priority |- |- |
...
| до |Определяемый приложением идентификатор назначения, который не интерпретируется служебной шиной. |[To](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage) |
| тема |Определяемый приложением идентификатор назначения сообщения, который не интерпретируется служебной шиной. |[Label](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage) |
...
| Ключ сопоставления заметки | Использование | API-имя |
| --- | --- | --- |
...
| --- | --- | --- |
| Создание пути "запрос-ответ" |--> attach(<br/>name={*имя связи*},<br/>handle={*числовой дескриптор*},<br/>role=**sender**,<br/>source=**null**,<br/>target=”myentity/$management”<br/>) |Без действия |
| Создание пути "запрос-ответ" |Без действия |\<-- attach(<br/>name={*имя связи*},<br/>handle={*числовой дескриптор*},<br/>role=**receiver**,<br/>source=null,<br/>target=”myentity”<br/>) |
...
| Создание пути "запрос-ответ" |Без действия |\<-- attach(<br/>name={*имя связи*},<br/>handle={*числовой дескриптор*},<br/>role=**sender**,<br/>source=”myentity”,<br/>target=”myclient$id”<br/>) |
...
| тип |Нет |string |Тип размещаемого маркера. |
...
> Примечание. Перед установлением этого канала необходимо выполнить проверку подлинности как для сущности *via-entity*, так и для *destination-entity*.
