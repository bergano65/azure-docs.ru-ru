...
![Снимок экрана журнала, в котором показаны источник, назначение, порт источника, порт назначения и имя протокола. В первой строке порт назначения 10401 (0x28 A 1) выдается черным цветом.][4]
