...
| в |Определяемый приложением идентификатор назначения, который не интерпретируется служебной шиной. |[Чтобы](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage) |
