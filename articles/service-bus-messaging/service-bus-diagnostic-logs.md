...
| Область | Операция|
|-------| -------- |
| Пространство имен | <ul> <li> Создание пространства имен</li> <li> Обновление именного пространства </li> <li> Удалить пространство имен </li>  </ul> | 
| Очередь | <ul> <li> Создать очередь</li> <li> Обновление очереди</li> <li> Удаление очереди. </li> </ul> | 
