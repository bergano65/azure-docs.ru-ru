...
В этой статье рассматриваются сходства и различия между двумя типами очередей, предлагаемых Microsoft Azure: очередями службы хранилища и очередями служебной шины. Используя эту информацию, вы можете сравнивать и сопоставлять соответствующие технологии и принимать максимально информированные решения о том, какие из них наиболее соответствуют вашим потребностям.
