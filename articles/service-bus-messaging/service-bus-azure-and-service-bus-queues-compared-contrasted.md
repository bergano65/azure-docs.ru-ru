...
В данной статье анализируются сходства и различия двух типов очередей, которые предлагает Microsoft Azure: очереди службы хранилища и очереди служебной шины. Используя эту информацию, вы можете сравнивать и сопоставлять соответствующие технологии и принимать максимально информированные решения о том, какие из них наиболее соответствуют вашим потребностям.
...
* Очереди служебной шины поддерживают гарантию доставки *как минимум один раз*. 
* Несогласованности с точки зрения обработки сообщения в контексте сеансов служебной шины можно избежать путем использования состояния сеанса для сохранения состояния приложения относительно ход выполнения обработки последовательности сообщений для сеанса и с помощью транзакций вокруг согласование полученных сообщений и обновлении состояния сеанса. Такого рода согласованности функция иногда называется *точно-одну обработку* в продуктах других поставщиков, но транзакции сбоев очевидно, что приведет к повторно доставлено сообщений, и поэтому термин не совсем подходит.
