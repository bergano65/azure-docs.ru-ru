...
8. На странице **ресурсов** выполните следующие действия.
    ...
    2. Если вы выбрали **подключиться к ресурсу Azure по идентификатору или псевдониму ресурса**, выполните следующие действия.
        1. Введите идентификатор или **псевдоним** **ресурса** . Это может быть идентификатор ресурса или псевдоним, к которому вам предоставили доступ кто-то. Самый простой способ получить идентификатор ресурса — перейти к пространству имен служебной шины в портал Azure и скопировать часть URI, начиная с `/subscriptions/`. Пример см. на следующем рисунке. 
