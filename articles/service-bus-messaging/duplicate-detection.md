...
> [!NOTE]
> Если включен поиск повторяющихся и ключ сеанса идентификатор или секции не заданы, идентификатор сообщения используется в качестве ключа секции. Если идентификатор сообщения не задано, библиотеки .NET и AMQP автоматически создавать идентификатор сообщения для сообщения. Дополнительные сведения см. в разделе [использование ключей секционирования](service-bus-partitioning.md#use-of-partition-keys).
