...
Взаимодействие с разделом служебной шины начинается с создания экземпляра класса [ServiceBusClient](/javascript/api/@azure/service-bus/servicebusclient) и его применения для создания экземпляра класса [TopicClient](/javascript/api/@azure/service-bus/topicclient). Получив клиент раздела, вы сможете создать отправителя и использовать его методы [send](/javascript/api/@azure/service-bus/sender#send-sendablemessageinfo-) и [sendBatch](/javascript/api/@azure/service-bus/sender#sendbatch-sendablemessageinfo---) для отправки сообщений.
