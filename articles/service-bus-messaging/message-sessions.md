...
> [!NOTE]
> Если сеансы включены для очереди или подписки, клиентские приложения ***больше не смогут*** отправлять и получать обычные сообщения. Все сообщения должны быть отправлены в рамках сеанса (путем установки идентификатора сеанса) и получены путем получения сеанса.
