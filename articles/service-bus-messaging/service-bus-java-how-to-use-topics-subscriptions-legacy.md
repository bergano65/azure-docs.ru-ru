...
В этом кратком руководстве описано, как создать код Java для отправки сообщений в раздел Служебной шины Azure и их последующего получения из подписок в этот раздел. 

> [!WARNING]
>  Для работы с этим кратким руководством используются пакеты azure-servicebus прежних версий. Сведения об использовании последнего пакета см. в кратком руководстве по [отправке и получению сообщений с помощью azure-messaging-servicebus](service-bus-java-how-to-use-topics-subscriptions.md).
...
2. Выполните шаги из [краткого руководства по Создание раздела служебной шины и подписок на него с помощью портала Azure](service-bus-quickstart-topics-subscriptions-portal.md). Так вы сделаете следующее:
    ...
    4. Создайте **три подписки** в разделе пространства имен.
...
![Добавление библиотек Microsoft Azure для Java в проект Eclipse](media/service-bus-java-how-to-use-topics-subscriptions-legacy/eclipse-azure-libraries-java.png)
...
> [!NOTE] 
> - Замените `<NameOfServiceBusNamespace>` именем пространства имен используемой служебной шины. 
