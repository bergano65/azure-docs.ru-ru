...
Служебная шина Azure недавно обновила компоненты выставления счетов. Из-за этого при наличии стандартного пространства имен служебной шины могут отображаться элементы строк для ресурса "/Subscriptions/< azure_subscription_id >/resourceGroups/$system/Провидерс/Микрософт.сервицебус/намеспацес/$system" в группе ресурсов "$system".
