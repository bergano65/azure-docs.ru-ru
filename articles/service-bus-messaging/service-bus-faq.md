...
Подписи общего доступа представляют собой механизм проверки подлинности на основе безопасных хэшей SHA-256 или URI. Сведения о создании собственных подписей в Node. js, PHP, Java, Python и C# см. в статье [подписанные][Shared Access Signatures] URL.
