...
См. в разделе [рекомендации по повышению производительности с помощью служебной шины][Best practices for performance improvements using Service Bus] — в этой статье описывается, как для оптимизации производительности при обмене сообщениями.
...
Список ограничений и квот шину службы, см. в разделе [обзоре квот служебной шины][Quotas overview].
...
Как и в случае с другими службами в Azure, служебная шина использует набор особых квот для обеспечения справедливого использования ресурсов. Дополнительные сведения об этих квотах в [обзоре квот служебной шины][Quotas overview].
...
Подписи общего доступа представляют собой механизм проверки подлинности на основе безопасных хэшей SHA-256 или URI. Сведения о том, как создавать собственные подписи в Node.js, PHP, Java и C\#, см. в разделе [подписанных][Shared Access Signatures] статьи.
