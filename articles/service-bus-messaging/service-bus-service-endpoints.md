...
2. В меню слева выберите **Сеть**. По умолчанию выбран параметр **Все сети**. Пространство имен принимает подключения с любого IP-адреса. То есть, такое значение параметра по умолчанию равноценно правилу, которое принимает диапазон IP-адресов 0.0.0.0/0. 

    ![Брандмауэр — выбран вариант "Все сети"](./media/service-endpoints/firewall-all-networks-selected.png)
