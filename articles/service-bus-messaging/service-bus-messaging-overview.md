...
Служебная шина поддерживает такие протоколы безопасности, как [подписанный URL-адрес](service-bus-sas.md) (SAS), [управление доступом на основе ролей](authenticate-application.md) (Azure RBAC) и [управляемые удостоверения для ресурсов Azure](service-bus-managed-service-identity.md).
