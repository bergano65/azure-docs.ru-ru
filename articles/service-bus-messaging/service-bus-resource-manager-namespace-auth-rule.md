---
title: Создание правила авторизации автобуса службы с помощью шаблона Azure
...
> 
> Чтобы проверить последние шаблоны, посетите галерею [шаблонов Azure и][Azure Quickstart Templates] поиск **сервисного автобуса.**
