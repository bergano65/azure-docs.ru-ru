...
* Если у вас установлена среда [Visual Studio 2012 с обновлением 3](https://docs.microsoft.com/visualstudio/releasenotes/vs2012-update3-vs) , вы можете сделать следующее:
  
  * перезапустить Visual Studio;
  * или перезапустить решение, а затем выполнить построение решения.  
* Если у вас нет среды [Visual Studio 2012 с обновлением 3](https://docs.microsoft.com/visualstudio/releasenotes/vs2012-update3-vs) , откройте диспетчер задач, перейдите на вкладку процессов, выберите процесс MSBuild.exe и нажмите кнопку «Завершить процесс».  
...
### <a name="upgrade-token-provider-error-after-upgrading-from-biztalk-services-preview-to-general-availability-ga"></a>ОБНОВЛЕНИЕ. Ошибка поставщика маркеров после обновления службы BizTalk с предварительной версии до общедоступной версии
...
* Ошибка: Поставщику маркеров не удалось предоставить маркер безопасности. Поставщик маркеров вернул сообщение. удаленное имя не удалось разрешить".
...
### <a name="upgrade-toolbox-shows-the-old-bridge-icons-after-upgrading-the-biztalk-services-sdk"></a>ОБНОВЛЕНИЕ. После обновления пакета SDK для службы BizTalk на панели элементов отображаются старые значки мостов
...
### <a name="upgrade-new-tracking-data-does-not-show-up-after-biztalk-services-is-upgraded-to-ga"></a>ОБНОВЛЕНИЕ. Новые данные отслеживания не отображаются после обновления версии службы BizTalk до общедоступной версии
