...
1. Получите JAR-файл Twilio и добавьте его к пути построения Java и к WAR-сборке. На сайте [https://github.com/twilio/twilio-java][twilio_java] можно скачать исходные файлы GitHub и создать собственный JAR-файл или загрузить готовый (с зависимостями или без них).
