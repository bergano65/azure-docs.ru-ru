---
title: Примеры сертификата Аттестации Azure пользователя, подписавшего политику
description: Пример содержимого сертификата Аттестации Azure пользователя, подписавшего политику.
...
## <a name="policy-signer-certificate-content"></a>Сертификат пользователя, подписавшего политику
...
## <a name="policy-signer-certificates-file-content"></a>Содержимое файла сертификата пользователя, подписавшего политику
