...
## <a name="default-policy-for-an-sgx-enclave-with-policyformattext"></a>Политика для анклава SGX по умолчанию с PolicyFormat=Text
...
## <a name="default-policy-for-vbs-enclave"></a>Политика по умолчанию для анклава VBS

Отсутствие политики по умолчанию для анклава VBS
