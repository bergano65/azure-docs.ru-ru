...
**service_context** (BASE64URL (октеты)): непрозрачный, зашифрованный контекст, созданный службой, который, в свою случаях, является проблемой, а также временем истечения срока действия этой задачи. 
