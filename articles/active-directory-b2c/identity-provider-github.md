---
title: Настройка регистрации и вхоложестива с учетной записью GitHub
...
Чтобы использовать учетную запись GitHub в качестве [поставщика идентификационных данных](authorization-code-flow.md) в Azure Active Directory B2C (Azure AD B2C), необходимо создать приложение в интересующий его клиента. Если у вас еще нет учетной записи GitHub, вы можете зарегистрироваться в [https://www.github.com/](https://www.github.com/).
...
1. Копируйте значения **идентификатора клиента** и **секрет клиента.** Оба этих значения потребуются при добавлении поставщика удостоверений для вашего клиента.
...
1. Выберите **поставщиков идентификационных данных,** затем выберите **GitHub (Предварительный просмотр).**
1. Введите **имя**. Например, *GitHub*.
1. Для **идентификатора клиента**введите идентификатор клиента приложения GitHub, созданного ранее.
