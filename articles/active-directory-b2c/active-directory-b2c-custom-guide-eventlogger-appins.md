...
При использовании Azure Active Directory B2C (Azure AD B2C) вместе с Azure Application Insights можно получить подробные и настраиваемые журналы событий для пути взаимодействия пользователя. В этой статье раскрываются следующие темы:
