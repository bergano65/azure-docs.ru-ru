...
- **Технические политики для создания и использования сведений о цифровых удостоверениях, а также для определения уровня гарантии и защиты. Эти письменные политики обычно разделяются на следующие категории:**
    - Политики доказательства идентичности, например: *насколько строго проверяются сведения об удостоверении пользователя?*
    - Политики безопасности, например: *каков уровень защиты целостности и конфиденциальности данных?*
    - Политики конфиденциальности, например: *может ли пользователь управлять персональными данными, позволяющими установить личность?*
    - Политики устойчивости, например: *если поставщик прекращает работу, как работает функция непрерывной защиты персональных данных, позволяющих установить личность?*
