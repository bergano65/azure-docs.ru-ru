...
2. Выберите политику и щелкните **Изменить**.
3. Откройте **Password complexity** (Сложность пароля).
4. Смените сложность пароля для этой политики на **простую**, **надежную** или **настраиваемую**.
