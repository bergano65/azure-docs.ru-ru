...
1. Выберите **Обновить**, а затем проверить, что "Предоставлено для ..." отображается в соответствии с **статусом** для обеих областей. Распространение разрешений может занять несколько минут.
