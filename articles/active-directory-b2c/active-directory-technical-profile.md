...
- [Добавление утверждений и настройка вводимых пользователем данных с помощью пользовательских политик в Azure Active Directory B2C](custom-policy-configure-user-input.md)
