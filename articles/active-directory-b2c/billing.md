...
1. В верхнем меню выберите фильтр **каталог и подписка** , а затем выберите каталог Azure AD B2C, который требуется обновить до MAU.<br/>
    ![фильтра каталогов и подписок в портал Azure](./media/billing/portal-mau-01-select-b2c-directory.png)
...
1. На странице **Обзор** клиента Azure AD B2C выберите ссылку в поле **имя ресурса**. Вы направляетесь к ресурсу Azure AD B2C в клиенте Azure AD.<br/>
    ![ссылка на Azure AD B2C ресурс, выделенная в портал Azure](./media/billing/portal-mau-02-b2c-resource-link.png)
1. На странице **Обзор** ресурса Azure AD B2C в разделе **оплачиваемые единицы**выберите ссылку на **проверку подлинности (изменение на MAU)** .<br/>
    ![изменить ссылку на MAU, выделенную в портал Azure](./media/billing/portal-mau-03-change-to-mau-link.png)
...
1. Нажмите кнопку **создания**.
    ![страницу создания ресурсов Azure AD B2C в портал Azure](./media/billing/portal-01-create-b2c-resource-page.png)
...
В дополнение к просмотру сведений об использовании и выставлении счетов в выбранной подписке Azure можно просмотреть подробные отчеты по дням использования с помощью [API отчетов об использовании](view-usage-reports.md).
