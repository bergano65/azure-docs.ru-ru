...
2. В разделе параметров B2C щелкните **Приложения**, а затем — **Добавить**. 
    ...
    | **Пользовательский URI перенаправления** | `com.onmicrosoft.contoso.appname://redirect/path` | Введите `com.onmicrosoft.<your tenant name>.<any app name>://redirect/path` Потоки пользователей отправляют маркеры к этому URI. |
