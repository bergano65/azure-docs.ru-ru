...
Важным моментом является то, что вы размещаете содержимое на общедоступной конечной точке HTTPS с [включенным CORS.](https://enable-cors.org/server.html) При ее указании в содержимом необходимо использовать абсолютный URL-адрес.

> [!NOTE]
> Подробную информацию о создании HTML-контента, загрузке содержимого в хранилище Azure Blob и настройке CORS можно узнайте в разделе ["Пошаговая версия" пользовательского содержимого страницы](custom-policy-ui-customization.md#custom-page-content-walkthrough) в статье настройки пользовательского использования.
