...
|тип действия; |Description (Описание)  |
|---------|---------|
...
|Раздел|Поле|Description (Описание)|
|-------|-----|-----------|
...
Вы можете попробовать этот скрипт в [Azure Cloud Shell](../cloud-shell/overview.md). Обязательно обновите его с помощью идентификатора приложения, секрета клиента и имени клиента Azure AD B2C.
