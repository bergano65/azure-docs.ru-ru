...
* Выберите [Макет страницы](contentdefinitions.md#select-a-page-layout) для элементов пользовательского интерфейса приложения.
    ...
    Если предполагается использовать JavaScript, необходимо [определить версию макета страницы](contentdefinitions.md#migrating-to-page-layout) с `contract` версией страницы для *всех* определений содержимого в пользовательской политике. Сведения о [переходе на макет страницы](contentdefinitions.md#migrating-to-page-layout) с использованием версии страницы. 
