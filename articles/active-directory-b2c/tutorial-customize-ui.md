---
title: Руководство по Настройка пользовательского интерфейса
titleSuffix: Azure AD B2C
description: Сведения о том, как настроить пользовательский интерфейс своих приложений в Azure Active Directory B2C с помощью портала Azure.
services: B2C
author: msmimart
manager: celestedg
...
2. Убедитесь, что вы используете каталог, содержащий подписку Azure. Щелкните фильтр **Каталог и подписка** в верхнем меню и выберите каталог, который содержит вашу подписку. Этот каталог отличается от каталога, который содержит ваш клиент Azure B2C.
...
3. В качестве **допустимых методов** выберите `GET`,`PUT` и `OPTIONS`.
...
6. В поле **Максимальный возраст** введите 200.
    ...
    ![Страница конфигурации CORS в Хранилище BLOB-объектов Azure на портале Azure](./media/tutorial-customize-ui/enable-cors.png)
...
3. Выберите **Отправить**, найдите и выберите файл *custom-ui.html*, затем нажмите кнопку **Отправить**.
    ...
    ![Страница отправки BLOB-объекта на портале с выделенной кнопкой "Отправить" и файлами](./media/tutorial-customize-ui/upload-blob.png)
...
2. Выберите **Потоки пользователей** и щелкните поток пользователя *B2C_1_signupsignin1*.
...
3. Нажмите кнопку **Выполнить поток пользователя**.
    ...
    ![Страница запуска потока пользователя для потока регистрации или входа пользователя](./media/tutorial-customize-ui/run-user-flow.png)
    ...
    ![Веб-браузер со странице регистрации или входа с настраиваемыми элементами пользовательского интерфейса](./media/tutorial-customize-ui/run-now.png)
