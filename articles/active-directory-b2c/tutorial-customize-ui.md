---
title: 'Учебник: Настроить пользовательский интерфейс'
titleSuffix: Azure AD B2C
description: Узнайте, как настроить пользовательский интерфейс (Пользовательское интерфейс) приложений в Azure Active Directory B2C с помощью портала Azure.
services: B2C
author: msmimart
manager: celestedg
...
---
# <a name="tutorial-customize-the-interface-of-user-experiences-in-azure-active-directory-b2c"></a>Учебник: Настроить интерфейс пользовательских интерфейсов в Azure Active Directory B2C

Для более распространенных пользовательских интерфейсов, таких как регистрация, регистрация и редактирование профиля, можно использовать [потоки пользователей](user-flow-overview.md) в Azure Active Directory B2C (Azure AD B2C). Сведения в этом руководстве помогут вам узнать, как [настроить пользовательский интерфейс](customize-ui-overview.md) этих функций, используя собственные HTML- и CSS-файлы.
...
2. Убедитесь, что вы используете каталог, содержащий подписку Azure. Выберите фильтр **подписки каталога** в верхнем меню и выберите каталог, содержащий подписку. Этот каталог отличается от каталога, который содержит ваш клиент Azure B2C.
...
6. В поле **Максимальный возраст** введите 200.
    ...
    ![Страница конфигурации CORS в хранилище Azure Blob на портале Azure](./media/tutorial-customize-ui/enable-cors.png)
...
1. Выберите **все службы** в верхнем левом углу портала Azure, ищите и выберите **учетные записи хранилища.**
...
3. Выберите **Отправить**, найдите и выберите файл *custom-ui.html*, затем нажмите кнопку **Отправить**.
    ...
    ![Загрузите страницу blob на портале с кнопкой загрузки и выделенными файлами](./media/tutorial-customize-ui/upload-blob.png)
...
3. Нажмите кнопку **Выполнить поток пользователя**.
    ...
    ![Запустите страницу потока пользователя для регистрации или входе в поток пользователя](./media/tutorial-customize-ui/run-user-flow.png)
    ...
    ![Веб-браузер, показывающий регистрацию или записаться на страницу с пользовательскими элементами пользовательского интерфейса](./media/tutorial-customize-ui/run-now.png)
