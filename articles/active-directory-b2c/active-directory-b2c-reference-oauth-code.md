...
| p |Обязательно |Выполняемый поток пользователя. Это имя потока, созданное в вашем каталоге Azure AD B2C. Оно должно начинаться с **b2c\_1\_**. Дополнительные сведения о потоках пользователей см. [здесь](active-directory-b2c-reference-policies.md). |
