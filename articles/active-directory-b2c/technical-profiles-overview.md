...
![Процесс работы с техническим профилем](./media/technical-profiles-overview/technical-profile-idp-saml-flow.png)
 
...
3. **Выполнение технического профиля**: технический профиль обменивается утверждениями с настроенной службой. Пример:
