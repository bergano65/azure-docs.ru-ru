...
| DataType | 1:1 | Тип утверждения. Можно использовать типы данных Boolean, Date, dateTime, int, Long, String, stringCollection и phoneNumber. Тип данных-примитив представляет эквивалент типа C# данных переменной. stringCollection представляет коллекцию строк. Дополнительные сведения см. в разделе [ C# типы и переменные](https://docs.microsoft.com/dotnet/csharp/tour-of-csharp/types-and-variables). Дата соответствует соглашению ISO 8601. |
