...
| Элемент | Вхождения | ОПИСАНИЕ |
| ------- | ----------- | ----------- |
| Protocol | 0:n | Список протоколов с указанием имени стандартного типа утверждения партнера. |
...
| Атрибут | Обязательно для заполнения | ОПИСАНИЕ |
| --------- | -------- | ----------- |
| Text | Yes | Отображаемая строка, показываемая в пользовательском интерфейсе для этого параметра. |
|Value | Yes | Значение утверждения, связанное с этим вариантом. |
