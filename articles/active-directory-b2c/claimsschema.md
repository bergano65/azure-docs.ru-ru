...
|string| Представляет текст как последовательность единиц кода UTF-16.|
...
|Абзац | `boolean`, `date`, `dateTime`, `duration`, `int`, `long`, `string`|Поле, которое показывает текст только в теге абзаца. |
