...
| Value | Да | Значение, которое передается в преобразование дословно. Некоторые значения являются произвольными, а некоторые из них выбираются из метода преобразования утверждений. |
