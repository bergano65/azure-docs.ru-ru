...
* Убедитесь, что произошла определенная стойкость проверки подлинности, например, с помощью многофакторной идентификации Azure AD.
