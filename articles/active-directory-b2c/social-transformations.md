...
| ---- | ----------------------- | --------- | ----- |
| InputClaim | key | строка | Тип ClaimType, который указывает уникальный идентификатор пользователя, используемый поставщиком удостоверений социальных сетей. |
