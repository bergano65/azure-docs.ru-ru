---
title: Использование фильтрации по возрасту в Azure Active Directory B2C | Документация Майкрософт
...
ms.locfileid: "49318866"
---
# <a name="using-age-gating-in-azure-ad-b2c"></a>Использование фильтрации по возрасту в Azure AD B2C

>[!IMPORTANT]
>Эта функция находится в режиме закрытой предварительной версии.  Просматривайте информацию в нашем [служебном блоге](https://blogs.msdn.microsoft.com/azureadb2c/) по мере ее доступности или обратитесь по адресу AADB2CPreview@microsoft.com.  НЕ используйте эту функцию в рабочих каталогах. Использование новых функций такого рода может привести к потере данных и непредвиденным изменениям функциональности, пока мы не переведем их в общедоступный режим.  
>
