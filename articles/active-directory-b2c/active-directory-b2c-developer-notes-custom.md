...
* Создавать и отправлять пользовательские процедуры проверки подлинности с помощью настраиваемых политик. 
   ...
   * Определять условные ветвления путей взаимодействия пользователей. * Интегрировать службы с поддержкой REST API в пользовательские процедуры проверки подлинности.  
...
* Мы рекомендуем использовать новые возможности только для ознакомления.<br>
* Новые возможности не предназначены для использования в рабочей среде.<br>
* К новым возможностям не применяются соглашения об уровнях обслуживания. <br>
