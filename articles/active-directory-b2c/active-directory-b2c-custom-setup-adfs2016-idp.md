...
> [!NOTE]
> Visual Studio code расширение B2C использует «socialIdpUserId.» Политику социальных сетей, также является обязательным для служб федерации Active Directory.
>
