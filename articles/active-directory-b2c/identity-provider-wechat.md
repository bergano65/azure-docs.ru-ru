---
title: Настройка регистрации и входиный займ с учетной записью WeChat
...
Чтобы использовать учетную запись WeChat в качестве поставщика идентификационных данных в Azure Active Directory B2C (Azure AD B2C), необходимо создать приложение в интересующий его клиента. Если у вас еще нет учетной записи WeChat, вы можете получить информацию по адресу [https://kf.qq.com/faq/161220Brem2Q161220uUjERB.html](https://kf.qq.com/faq/161220Brem2Q161220uUjERB.html).

### <a name="register-a-wechat-application"></a>Регистрация приложения WeChat

1. Вопийте [https://open.weixin.qq.com/](https://open.weixin.qq.com/) с вашими учетными данными WeChat.
...
1. Выберите **поставщиков идентификационных данных,** затем выберите **WeChat (Предварительный просмотр).**
1. Введите **имя**. Например, *WeChat*.
1. Для **идентификатора клиента**введите идентификатор APP приложения WeChat, созданного ранее.
