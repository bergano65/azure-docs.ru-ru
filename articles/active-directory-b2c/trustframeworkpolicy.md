...
Файл политики **SocialAndLocalAccounts** в [начальном пакете](https://docs.microsoft.com/azure/active-directory-b2c/active-directory-b2c-get-started-custom#download-starter-pack-and-modify-policies) содержит пути взаимодействия пользователя SignUpOrSignIn, ProfileEdit и PasswordReset. Вы можете добавить дополнительные пути взаимодействия пользователя для других сценариев, таких как изменение адреса электронной почты или привязка и отсоединение учетной записи социальной сети. 
