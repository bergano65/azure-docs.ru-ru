...
![Схема, демонстрирующая модель наследования политики инфраструктуры доверия](./media/trustframeworkpolicy/custom-policy-Inheritance-model.png)
...
Файл политики **SocialAndLocalAccounts** в [начальном пакете](custom-policy-get-started.md#custom-policy-starter-pack) содержит пути взаимодействия пользователя SignUpOrSignIn, ProfileEdit и PasswordReset. Можно добавить дополнительные пути взаимодействия пользователя для других сценариев, таких как изменение адреса электронной почты или связывание и отмена связи с учетной записью социальных сетей.
...
![Схема, показывающая поток выполнения политики](./media/trustframeworkpolicy/custom-policy-execution.png)
