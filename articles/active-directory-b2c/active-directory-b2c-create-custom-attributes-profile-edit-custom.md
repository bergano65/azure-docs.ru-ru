...
Выполните действия, описанные в статье [Начало работы с настраиваемыми политиками в Azure Active Directory B2C](active-directory-b2c-get-started-custom.md).
...
9. В разделе "Разрешения приложений" установите флажок: **Чтение и запись данных каталога**. Затем нажмите кнопку **Save** (Сохранить).
