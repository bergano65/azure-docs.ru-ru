...
### <a name="step-12-grant-administrative-permission-to-your-application"></a>Шаг 1.2. Предоставление административных разрешений для приложения
...
Пример кода перед переносом можно найти в репозитории `azure-ad-b2c/user-migration` репозитория GitHub, поддерживаемом сообществом:
...
1. Выберите приложение в раскрывающемся списке **выберите приложение** .
    ...
    > [!NOTE]
    > Для **запуска теперь** требуется, чтобы в клиенте было зарегистрировано хотя бы одно приложение. Сведения о регистрации приложений см. в разделе [Tutorial: Зарегистрируйте приложение в Azure Active Directory B2C @ no__t-0.
