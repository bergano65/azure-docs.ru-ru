...
| p |Обязательно |Политика, которую необходимо выполнить. Это имя политики (потока пользователя), созданной в клиенте Azure AD B2C. Оно должно начинаться с **b2c\_1\_**. Дополнительные сведения см. [здесь](active-directory-b2c-reference-policies.md). |
