...
Средство миграции можно создать с помощью API Graph Azure AD. Дополнительные сведения см. в [руководстве по переносу пользователей](user-migration.md).
...
Нет служба Azure AD Connect не предназначена для работы с Azure AD B2C. Вы можете использовать [API Graph Azure AD](manage-user-accounts-graph-api.md) для перемещения пользователя. Дополнительные сведения см. в [руководстве по переносу пользователей](user-migration.md).
...
Прочитайте статью [Сравнение службы совместной работы B2B и B2C в Azure AD](../active-directory/b2b/compare-with-b2c.md) , чтобы узнать больше о применении соответствующих функций к внешним сценариям идентификации.
...
Вы можете использовать текущие возможности **приложений** или новый единый интерфейс **Регистрация приложений (Предварительная версия)** . [См. дополнительные сведения о новом интерфейсе](https://aka.ms/b2cappregintro).
