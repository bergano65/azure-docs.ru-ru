...
Вы можете использовать наш новый единый интерфейс **Регистрация приложений** или устаревшие **приложения** . [См. дополнительные сведения о новом интерфейсе](https://aka.ms/b2cappregtraining).
