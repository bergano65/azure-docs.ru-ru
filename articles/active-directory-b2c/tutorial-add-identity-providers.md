...
3. Выберите **все службы** в левом верхнем углу портала Azure, а затем найдите и выберите **регистрация приложений (для прежних версий)** .
