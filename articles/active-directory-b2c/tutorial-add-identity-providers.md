...
1. Выберите **тип поставщика удостоверений**, выберите **OpenID Connect Connect (Предварительная версия)** и нажмите кнопку **ОК**.
1. Щелкните **Настроить этот поставщик удостоверений**.
1. В поле **URL-адрес метаданных**введите следующий URL- `your-AD-tenant-domain` адрес, заменив именем домена клиента Azure AD.
...
1. В поле **идентификатор клиента**введите *идентификатор приложения (клиента)* , который вы записали ранее.
1. В поле **секрет клиента**введите значение *секрета клиента* , записанное ранее.
...
1. Нажмите кнопку **ОК**, а затем выберите **создать** , чтобы сохранить конфигурацию.
...
1. Выберите **тип поставщика удостоверений**, выберите **Facebook**, а затем нажмите кнопку **ОК**.
1. Выберите **настроить этот поставщик удостоверений** и введите *идентификатор приложения* , записанный ранее в качестве **идентификатора клиента**.
1. Введите *секрет приложения* , записанный в качестве **секрета клиента**.
1. Нажмите кнопку **ОК** , а затем выберите **создать** , чтобы сохранить конфигурацию Facebook.
