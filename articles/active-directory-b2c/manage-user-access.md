...
Если приложение надежно собирал DOB или страны или региона данных другими способами, приложение может использовать Graph API для обновления записи пользователя с помощью этой информации. Пример:
