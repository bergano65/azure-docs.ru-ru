...
---
# <a name="define-an-oauth2-technical-profile-in-an-azure-active-directory-b2c-custom-policy"></a>Определение технического профиля OAuth2 в пользовательской политике Azure Active Directory B2C

[!INCLUDE [active-directory-b2c-advanced-audience-warning](../../includes/active-directory-b2c-advanced-audience-warning.md)]

Активный каталог Azure B2C (Azure AD B2C) предоставляет поддержку поставщику идентификационных данных протокола OAuth2. OAuth2 является основным протоколом для авторизации и делегированной аутентификации. Дополнительные сведения см. в документе [RFC 6749 о системе авторизации OAuth 2.0](https://tools.ietf.org/html/rfc6749). С помощью технического профиля OAuth2 вы можете подавать на федерацию с помощью поставщика идентификационных данных oAuth2, например Facebook. Федерирование с поставщиком идентификационных данных позволяет пользователям войти в систему с их существующими социальными или корпоративными удостоверениями.
...
| область | нет | Сфера действия запроса, определяемого в соответствии со спецификацией поставщика идентификационных данных OAuth2. Возможные значения: `openid`, `profile` и `email`. |
