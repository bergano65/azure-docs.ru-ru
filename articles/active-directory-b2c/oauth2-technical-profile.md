...
Атрибуту **Name** элемента **Protocol** необходимо присвоить значение `OAuth2`. Например, **— это протокол для технического профиля**Facebook-OAUTH`OAuth2`.
