...
Дополнительные сведения можно найти в разделе  [Создание пользователя (локальной учетной записи)](/previous-versions/azure/ad/graph/api/users-operations#CreateLocalAccountUser).
