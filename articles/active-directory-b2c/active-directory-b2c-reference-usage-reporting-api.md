...
* **AlternateIdUserCount**. Число пользователей Azure AD B2C, зарегистрированных с помощью внешних поставщиков удостоверений (например Facebook, учетной записи Майкрософт или другого клиента Azure Active Directory, которого также называют `OrgId`).
...
* **b2cMfaRequestCountSummary**. Сводка по количеству ежедневных операций Многофакторной проверки подлинности по дням и типу (с помощью SMS или голосовой связи).
