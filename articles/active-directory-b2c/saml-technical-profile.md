---
title: Определение технического профиля SAML в пользовательской политике Azure Active Directory B2C
...
| Атрибут | Обязательно | Description (Описание) |
| --------- | -------- | ----------- |
