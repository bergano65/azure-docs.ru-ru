...
> [!IMPORTANT]
> Если вы работали с потоками пользователей в Azure AD B2C, то обратите внимание, что мы изменили способ ссылки на версии потока пользователей. Ранее мы предложили версии v1 (готовые к производству) и версии 1.1 и v2 (Предварительная версия). Теперь мы объединили потоки пользователей в две версии:
>
