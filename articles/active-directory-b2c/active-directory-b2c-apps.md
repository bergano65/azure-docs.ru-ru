---
title: Типы приложений, которые можно использовать в Azure Active Directory B2C
...
Каждый запрос, отправленный в Azure AD B2C, указывает **пользовательский поток** (встроенная политика) или **настраиваемую политику** , которая управляет поведением Azure AD B2C. Оба типа политик позволяют создать настраиваемый набор пользовательских интерфейсов.
...
### <a name="unsupported-application-types"></a>Неподдерживаемые типы приложений
