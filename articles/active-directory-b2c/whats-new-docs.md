...
### <a name="new-articles"></a>Новые статьи
- [Добавление соединителя API в пользовательский поток регистрации (Предварительная версия)](add-api-connector.md)
- [Руководство по Регистрация одностраничного приложения в Azure Active Directory B2C](tutorial-register-spa.md)
- [Использование соединителей API для настройки и расширения потоков пользователей при регистрации](api-connectors-overview.md)
- [SubJourneys](subjourneys.md)

### <a name="updated-articles"></a>Обновленные статьи
- [Определение технического профиля поставщика удостоверений SAML в настраиваемой политике Azure Active Directory B2C](saml-identity-provider-technical-profile.md)
- [Добавление соединителя API в пользовательский поток регистрации (Предварительная версия)](add-api-connector.md)
- [Примеры кода Azure Active Directory B2C](code-samples.md)
- [Типы приложений, которые можно использовать в Active Directory B2C](application-types.md)
- [Поток кода авторизации OAuth 2.0 в Azure Active Directory B2C](authorization-code-flow.md)
- [Руководство по регистрации веб-приложения в Azure Active Directory B2C](tutorial-register-applications.md)

## <a name="september-2020"></a>Сентябрь 2020 г.

### <a name="new-articles"></a>Новые статьи
- [Общие сведения о ключах политики в Azure Active Directory B2C](policy-keys-overview.md)


### <a name="updated-articles"></a>Обновленные статьи
- [Установка b2clogin.com в качестве URL-адреса перенаправления для Azure Active Directory B2C](b2clogin.md)
- [Определение технического профиля OpenID Connect Connect в Azure Active Directory B2C настраиваемой политике](openid-connect-technical-profile.md)
- [Настройка регистрации телефона и входа в систему с помощью пользовательских политик в Azure AD B2C](phone-authentication.md)
...
### <a name="updated-articles"></a>Обновленные статьи
- [Версии макета страницы](page-layout.md)
- [Модель выставления счетов для Azure Active Directory B2C](billing.md)
