...
Azure AD B2C пользовательские политики используют инфраструктуру процедур идентификации, чтобы вы ответили на следующие вопросы:
...
- **Технические политики для производства и использования информации о цифровом удостоверении, а значит, для измерения определения гарантии и защиты. Эти письменные политики обычно включают следующие категории политик:**
...
- **Технические профили для производства и использования информации о цифровом удостоверении. К этим профилям относятся:**
