...
* **Перенаправление URI** или **идентификатор аксора,** который может быть использован для прямых ответов обратно в ваше приложение.
...
![Диаграмма, показывающая четыре роли OAuth 2.0](./media/protocols-overview/protocols_roles.png)
...
* **Владелец ресурса** обычно является конечным пользователем. Это сторона, владеющая данными, которая может предоставлять третьим сторонам доступ к этим данным или к ресурсу.
