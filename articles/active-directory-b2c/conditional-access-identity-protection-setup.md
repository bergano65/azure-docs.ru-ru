...
- Для использования условного доступа на основе входа и рисков пользователей требуется Azure AD B2C ценовой категории Premium P2. При необходимости [повысьте ценовую категорию Azure AD B2C до уровня Premium P2](https://aka.ms/exid-pricing-tier). 
...
|Анонимный IP-адрес     | Вход с анонимного IP-адреса (например, браузер Tor, VPN с функцией анонимайзера).        |
