...
- [Дисплайконтролс](display-controls.md) — определяет элементы управления, отображаемые на странице. Элементы управления "Отображение" имеют специальные функции и взаимодействуют с техническими профилями проверки серверной части. Элементы управления отображением в настоящее время доступны в **предварительной версии**.
