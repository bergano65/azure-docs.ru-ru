...
ms.locfileid: "85384895"
---
# <a name="tutorial-register-a-web-application-in-azure-active-directory-b2c"></a>Руководство. Регистрация веб-приложения в Azure Active Directory B2C
...
Если вместо этого используется собственное приложение (например, iOS, Android, Mobile & Desktop), Узнайте, [как зарегистрировать собственное клиентское приложение](add-native-application.md).
...
1. В разделе **Поддерживаемые типы учетных записей**выберите **учетные записи в любом организационном каталоге или любом поставщике удостоверений. Для проверки подлинности пользователей с помощью Azure AD B2C**.
...
1. На странице **Azure AD B2C-регистрация приложений** выберите созданное приложение, например, веб- *APP1*.
