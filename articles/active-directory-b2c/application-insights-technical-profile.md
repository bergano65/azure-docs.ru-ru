...
В следующем примере показан стандартный технический профиль Application Insights. Другие Application Insights технические профили включают в себя Азуреинсигхтс-Common, чтобы использовать его конфигурацию.  
