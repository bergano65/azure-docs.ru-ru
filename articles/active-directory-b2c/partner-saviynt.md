...
- [Савийнт](https://saviynt.com/) — платформа управления удостоверениями, обеспечивающая детальное администрирование, которое обеспечивает управление жизненным циклом и доступом пользователей Azure AD B2C пользователей.  
...
### <a name="creating-an-azure-ad-application-for-saviynt"></a>Создание приложения Azure AD для Савийнт
...
### <a name="enabling-saviynt-to-delete-users"></a>Включение Савийнт для удаления пользователей
