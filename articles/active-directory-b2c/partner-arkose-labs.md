...
3. Откройте только что переименованный файл верифи-токен. php и выполните следующие действия.
   ...
   а. Замените содержимое содержимым из файла верифи-токен. php, найденного в [репозитории GitHub](https://github.com/ArkoseLabs/Azure-AD-B2C).
...
6. Перейдите к   >    >  **отправке** контейнера хранилища.
...
2. Включение JavaScript в [потоке пользователя](javascript-and-page-layout.md).

3. На одной и той же странице потока пользователей включите URL-адрес настраиваемой страницы: переход к  >  **макету страницы** потока пользователей  >  **Использование настраиваемого содержимого страницы**  =  **Да**  >  **Вставка URL-адреса настраиваемой страницы**.
