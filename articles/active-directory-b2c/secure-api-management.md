...
Для получения идентификатора приложения можно использовать текущие возможности **приложений** или новый единый интерфейс **Регистрация приложений (Предварительная версия)** . Дополнительные [сведения о предварительной версии](http://aka.ms/b2cappregintro).
