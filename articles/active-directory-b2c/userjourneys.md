...
| attribute | Обязательно | Описание |
| --------- | -------- | ----------- |
| субжаурнэйреференцеид | Да | Идентификатор вспомогательного пути, который должен быть выполнен. |
