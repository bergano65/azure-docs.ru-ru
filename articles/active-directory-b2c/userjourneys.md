...
Шаги оркестрации можно условно выполняться, на основе предварительных условий, определенных в элементе шага оркестрации. Например можно проверить для выполнения шага оркестрации только в том случае, если существует конкретные утверждения, или если утверждение равен или не соответствующие заданному значению. 
...
| Атрибут | Обязательно для заполнения | ОПИСАНИЕ |
| --------- | -------- | ----------- |
| `Order` | Yes | Порядок шагов оркестрации. | 
