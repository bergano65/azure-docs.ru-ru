...
| --------- | -------- | ----------- |
| ReferenceId | Yes | Идентификатор пути взаимодействия пользователя в политике. Дополнительные сведения см. в статье [UserJourneys](userjourneys.md). |
...
| Protocol | 1:1 | Протокол, используемый для федерации. |
