...
- Проверка того, что произошла определенная стойкость проверки подлинности, например многофакторная идентификация Azure AD.
