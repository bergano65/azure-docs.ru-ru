...
* **Логотип баннера**: отображается в правом нижнем углу;
...
1. Затем войдите в [портал Azure](https://portal.azure.com/) как администратор подписки. Используйте ту же рабочую или учебную учетную запись или ту же учетная запись Майкрософт, которая использовалась для регистрации в Azure.
...
1. Затем выберите всех пользователей (кроме пользователя, от имени которого вы вошли, — администратора подписки). Выберите **Удалить** в нижней части страницы и нажмите **кнопку Да** при появлении соответствующего запроса.
