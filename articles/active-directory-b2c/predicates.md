...
| Минимальные требования | Да | Минимальное число символов, которое необходимо указать. |
...
| Минимальные требования | Да | Минимальная возможная дата, которую можно указать. Формат даты соответствует `yyyy-mm-dd` соглашению или `Today` .|
...
- **Symbol** С помощью `IncludesCharacters` метода проверяет, содержит один из нескольких символов символа.
