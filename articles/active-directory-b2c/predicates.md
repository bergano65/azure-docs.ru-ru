...
![Схема, показывающая связь предикаты и предиката проверок](./media/predicates/predicates.png)
...
![Схема предиката и PredicateGroup пример сложность пароля](./media/predicates/predicates-pass.png)
