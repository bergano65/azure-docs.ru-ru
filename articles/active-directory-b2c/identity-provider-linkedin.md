---
title: Настройка регистрации и входиный учет LinkedIn
...
Чтобы использовать учетную запись LinkedIn в качестве [поставщика идентификационных данных](authorization-code-flow.md) в Azure Active Directory B2C (Azure AD B2C), необходимо создать приложение в интересующий его клиента. Если у вас еще нет учетной записи LinkedIn, вы можете зарегистрироваться в [https://www.linkedin.com/](https://www.linkedin.com/).
...
1. Копируйте значения **идентификатора клиента** и **секрет клиента.** Вы можете найти их под **ключей проверки подлинности**. Оба значения необходимы для настройки LinkedIn в качестве поставщика удостоверений для вашего клиента. **Секрет клиента**— важный элемент обеспечения безопасности.
...
1. Выберите **поставщиков идентификационных данных,** затем выберите **LinkedIn**.
1. Введите **имя**. Например, *LinkedIn*.
1. Для **идентификатора клиента**введите идентификатор клиента приложения LinkedIn, созданного ранее.
...
LinkedIn недавно [обновил свои AA с v1.0 до v2.0](https://engineering.linkedin.com/blog/2018/12/developer-program-updates). В рамках миграции Azure AD B2C может получить полное имя пользователя LinkedIn только во время регистрации. Если адрес электронной почты является одним из атрибутов, которые собираются во время регистрации, пользователь должен вручную ввести адрес электронной почты и проверить его.
