...
Вы можете увидеть не все разрешения Microsoft Graph, так как многие из этих разрешений не применяются к пользователям потребителя Azure B2C. [Узнайте больше об управлении пользователями с помощью Microsoft Graph](microsoft-graph-operations.md).
