...
При проверке по схеме XML определяются ошибки перед отправкой XML-файла. В корневой папке [начального пакета](https://github.com/Azure-Samples/active-directory-b2c-custom-policy-starterpack)получите файл определения схемы XML *TrustFrameworkPolicy_0.3.0.0. xsd*. Чтобы узнать, как использовать файл схемы XSD для проверки в редакторе, найдите *средства XML* и *проверку XML* или аналогичную документацию редактора.
