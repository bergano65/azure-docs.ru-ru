...
## <a name="prerequisites"></a>Технические условия
 ...
 В разделе [Metadata (метаданные](self-asserted-technical-profile.md#metadata) ) [самоподтвержденного технического профиля](self-asserted-technical-profile.md) [контентдефинитион](contentdefinitions.md) должен иметь `DataUri` установлен в значение контракта страницы Version 2.0.0 или выше. Пример.
...
Чтобы вывести на экран выходные данные заявки на следующий этап оркестрации, используйте **OutputClaims** фактического, самостоятельно утвержденного технического профиля, который ссылается на этот элемент управления.
