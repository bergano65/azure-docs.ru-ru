---
title: Настройка поведения сеанса - Активный каталог Azure B2C Документы Майкрософт
description: Настройка поведения сеансов в Active Directory B2C.
...
ms.locfileid: "78186817"
---
# <a name="configure-session-behavior-in-azure-active-directory-b2c"></a>Настройка поведения сеанса в Active Directory B2C

Эта возможность обеспечивает более точный контроль [для каждого потока пользователя](user-flow-overview.md) над следующими параметрами.
...
Azure AD B2C поддерживает [протокол проверки подлинности OpenID Connect](openid-connect.md) для включения безопасного входа в веб-приложения. Следующие свойства можно использовать для управления сеансами веб-приложения.
...
- **Одноразовая конфигурация** Если у вас есть несколько приложений и потоки пользователей в вашем арендаторе B2C, вы можете управлять взаимодействиями пользователей через них с помощью свойства **конфигурации Единого знака.** Этому свойству можно задать одно из указанных далее значений.
...
2. Убедитесь, что вы используете каталог, содержащий ваш клиент Azure AD B2C, выбрав фильтр **подписки каталога** в верхнем меню и выбрав каталог, содержащий ваш клиент Azure AD B2C.
3. Выберите **Все службы** в левом верхнем углу окна портала Azure, а затем найдите и выберите **Azure AD B2C**.
4. Выберите **потоки пользователей (политики)**.
5. Откройте пользовательский поток, созданный ранее.
6. Выберите **Свойства**.
7. Назначайте **срок службы сеанса Web-приложения (минуты),** **тайм-аут сеанса сеанса веб-приложений,** **конфигурацию единого входа**и **требуемый токен ID в запросах на выход из системы.**

    ![Настройки свойств поведения сеансов на портале Azure](./media/session-behavior/session-behavior.png)
