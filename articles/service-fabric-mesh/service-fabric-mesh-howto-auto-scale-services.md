---
title: Автомасштабирование приложения, работаемого в сетке Azure Service Fabric
...
Одним из основных преимуществ развертывания приложений для Service Fabric Mesh является возможность для вас легко масштабировать свои услуги в или из. Это должно использоваться для обработки различных объемов нагрузки на ваши службы или повышения доступности. Вы можете вручную выполнять масштабирование своих служб или же настроить автомасштабирование.
