---
title: Терминология для лазурной службы Ткань сетки
description: В этой статье подробно описана терминология, используемая Azure Service Fabric Mesh, чтобы помочь вам лучше понять термины, используемые в документации.
author: dkkapur
ms.author: dekapur
ms.date: 11/28/2018
ms.topic: conceptual
