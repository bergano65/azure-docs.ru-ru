...
7. **Файл параметров** и **параметры**, Разрешить пользовательские параметры, передаваемые в среду. Чтобы задать значения параметров можно использовать одно или оба. В этом примере будет использоваться раздел параметров. Используйте имена переменных, которые были определены в среде, например: `-administratorLogin “$(administratorLogin)” -administratorLoginPassword “$(administratorLoginPassword)” -databaseName “$(databaseName)” -cacheSKUCapacity 1`
