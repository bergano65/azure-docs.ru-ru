---
title: Устранение ошибок виртуальной машины и среды Azure DevTest Labs
...
3. В элементах журнала действий выберите операцию, которая завершилась ошибкой. Как правило, операция, вызвавшая сбой, называется `Write Virtualmachines`.
...
5. Просмотрите журнал JSON, пока не найдете свойство `statusMessage`. Он предоставляет основное сообщение об ошибке и более подробную информацию, если это применимо. Следующий код JSON является примером ошибки, о которой появлялось в кавычках выше в этой статье.
