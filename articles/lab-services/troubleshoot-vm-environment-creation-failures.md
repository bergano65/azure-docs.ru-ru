...
Если ваш среды или виртуальная машина была создана с помощью службы автоматизации, есть одно последнее место для поиска сведений об ошибке. Это журнал развертывания шаблона Azure Resource Manager. При создании ресурсов лаборатории за счет автоматизации часто осуществляется посредством развертывания шаблона Azure Resource Manager. См. в разделе[ https://github.com/Azure/azure-devtestlab/tree/master/Samples ](https://github.com/Azure/azure-devtestlab/tree/master/Samples) примеры шаблонов Azure Resource Manager, которые создают ресурсы DevTest Labs. 
