---
title: Создание и управление притязаниями на выв. В. в Лабораториях Azure DevTest Labs (ru) Документы Майкрософт
...
После того, как пользователь закажет VM, DevTest Labs запустит машину и перенесет ее в список пользователей лаборатории "Мои виртуальные машины". Это означает, что пользователь лаборатории теперь будет иметь привилегии владельца на этой машине. Время, необходимое для этого шага может варьироваться в зависимости от времени запуска, а также любых других пользовательских действий, выполняемых во время события претензии. После заявления, машина больше не доступна в claimable бассейне.  
...
Когда пользователь не имеет vM, у него больше нет разрешений владельца для этой конкретной лаборатории VM, и он доступен для утверждения любым другим пользователем лаборатории в состоянии, что он был retured в пул. 
