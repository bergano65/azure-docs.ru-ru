...
> [!NOTE]
> Прежде чем мы начнем, вот как графики влияют на лабораторные виртуальные машины: 
>- Виртуальная машина Template не включена в расписания. 
>- Запускаются только назначенные виртуальные машины. Это означает, что если машина не заявлена конечным пользователем (студентом), машина не запустится в запланированные часы. 
>- Все виртуальные машины (будь то заявленные пользователем или нет) останавливаются в зависимости от лабораторного расписания. 
...
При выборе выделенного расписания в календаре вы видите кнопки для **отсеивательь** или **удаление** расписания. 

![Изменение страницы расписания](../media/how-to-create-schedules/schedule-edit-button.png)

На странице **запланированного события «Отменить»** можно обновить расписание и выбрать **«Сохранить».** 

## <a name="delete-a-schedule"></a>Удаление расписания

1. Чтобы удалить расписание, выберите выделенное расписание в календаре и выберите кнопку значка мусора :

    ![Кнопка "Удалить" на панели инструментов](../media/how-to-create-schedules/schedule-delete-button.png)
2. В поле диалога **о событии «Удалить»** выберите **«Да»** для подтверждения удаления. 
