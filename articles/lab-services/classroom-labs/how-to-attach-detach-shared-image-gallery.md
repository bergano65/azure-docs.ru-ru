...
> [!NOTE]
> Сейчас службы лаборатории Azure поддерживают создание шаблонов виртуальных машин на основе только **обобщенных** образов виртуальных машин (не специализированных образов) в общей коллекции образов. 
