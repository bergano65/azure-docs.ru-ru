...
description: В этой статье описывается, как подключить коллекцию общих образов к лабораторной лаборатории в службах лаборатории Azure.
