...
Ruby — это динамический язык с открытым исходным кодом, который можно сочетать с скриптами bash. В этом разделе показано, как `apt-get` использовать для установки последней версии [Ruby](https://www.ruby-lang.org/).
