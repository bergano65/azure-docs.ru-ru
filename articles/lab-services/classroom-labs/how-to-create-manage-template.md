...
2. Состояние можно проверить на плитке лаборатории в разделе **Шаблон**.

    ![Состояние запуска шаблона](../media/how-to-create-manage-template/template-start-status.png)
1. Запустив его, чтобы подключиться к виртуальной машине, нажмите кнопку **Подключиться** и следуйте инструкциям. 

    ![Подключение к шаблону виртуальной машины или его остановка](../media/how-to-create-manage-template/connect-stop-vm.png)
