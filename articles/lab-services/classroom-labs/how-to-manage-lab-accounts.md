...
4. На странице **Учетная запись лаборатории** сделайте следующее: 
    ...
    5. Выберите существующую **общего образа коллекции** или создайте новый. Шаблон виртуальной Машины можно сохранить в коллекции образов, общие для его для повторного использования другими пользователями. Подробные сведения о коллекции общего образа, см. в разделе [с помощью общего образа коллекции в службы лабораторий Azure](how-to-use-shared-image-gallery.md).
    ...
    7. Укажите **диапазон адресов** для виртуальных машин в лаборатории. Диапазон адресов должен быть в нотации бесклассовой междоменной маршрутизации (CIDR) (пример: 10.20.0.0/23). В этот диапазон адресов будут создаваться виртуальные машины в лаборатории. Дополнительные сведения см. в разделе [укажите диапазон адресов для виртуальных машин в лаборатории](how-to-configure-lab-accounts.md#specify-an-address-range-for-vms-in-the-lab).    
