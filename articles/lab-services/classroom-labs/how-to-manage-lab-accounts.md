...
6. Нажмите кнопку **Далее: Теги** в нижней части страницы, чтобы перейти на вкладку **теги** . Добавьте теги, которые необходимо связать с учетной записью лаборатории. Теги — это пары "имя-значение", которые позволяют классифицировать ресурсы и просматривать консолидированный счет за счет применения одного и того же тега к нескольким ресурсам и группам ресурсов. Дополнительные сведения см. [в статье Использование тегов для Организации ресурсов Azure](../../azure-resource-manager/management/tag-resources.md).
