...
В этом разделе показано, как учащийся может подключиться к виртуальной машине с компьютера Mac с помощью RDP.

### <a name="step-1-install-microsoft-remote-desktop-on-a-mac"></a>Шаг 1. Установка удаленного рабочего стола (Майкрософт) на компьютере Mac
...
### <a name="step-2-access-the-vm-from-your-mac-using-rdp"></a>Шаг 2. Доступ к виртуальной машине с компьютера Mac с помощью RDP
