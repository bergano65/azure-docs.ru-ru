...
1. Перейдите по адресу [https://labs.azure.com](https://labs.azure.com). Обратите внимание на то, что Internet Explorer 11 еще не поддерживается. 
