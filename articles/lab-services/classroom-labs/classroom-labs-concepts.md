...
Квота — это ограничение времени (в часах), которое можно задать преподаватель учащегося для использования виртуальной Машины лаборатории. Его можно установить равным 0 или определенное количество часов. Если квота имеет значение 0, учащийся можно использовать только виртуальную машину при запуске расписания или преподаватель вручную на виртуальной машине для учащегося.
