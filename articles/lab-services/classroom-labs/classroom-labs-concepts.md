...
Время квоты учитывается, когда учащийся запускает виртуальную машину лаборатории.  Если преподаватель вручную запускает виртуальную машину лаборатории для учащихся, для этого учащегося часы квоты не используются.

## <a name="schedules"></a>Расписания

Расписания — это временные интервалы (однократное или повторяющееся), которые могут создаваться преподавателями для класса. Все виртуальные машины в лаборатории автоматически запускаются в начале по расписанию и останавливаются по окончании этого расписания. Время квоты не используется при запуске расписания.
