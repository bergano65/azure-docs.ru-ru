...
Чтобы настроить лабораторию для аудитории в учетной записи лаборатории, вы должны быть членом роли **Создатель лаборатории** роли в учетной записи лаборатории. Учетная запись, которую вы использовали для создания учетной записи лаборатории, автоматически добавляется в эту роль. См. дополнительные сведения о том, как [назначить владельцу лаборатории роль, позволяющую добавлять других пользователей в роль создателя лаборатории](tutorial-setup-lab-account.md#add-a-user-to-the-lab-creator-role).
