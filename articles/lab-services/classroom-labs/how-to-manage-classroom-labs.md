...
4. На странице **выбора характеристик виртуальных машин** выполните следующие действия:
    1. Выберите **размер** для виртуальных машин, созданных в лаборатории. В настоящее время **небольшой**, **Средний**, **больших**, и **GPU** размеры допускаются.
    2. Выберите **регион**, в котором требуется создать виртуальные машины. 
    3. Выберите **образ виртуальной машины**, который будет использоваться для создания виртуальных машин в лаборатории. Если выбрать образ Linux, вы увидите параметр, чтобы включить удаленный рабочий стол для него. Дополнительные сведения см. в разделе [включить удаленный рабочий стол для Linux](how-to-enable-remote-desktop-linux.md).
    4. Щелкните **Далее**.
...
8. В рамках этого руководства можно выполнить следующие необязательные действия: 
    ...
    2. Подключитесь к шаблону виртуальной машины. Для этого выберите **Подключиться**. Если это шаблона виртуальной Машины Linux, вы можете выбрать, хотите ли вы подключиться с помощью SSH или RDP (Если RDP включен).
