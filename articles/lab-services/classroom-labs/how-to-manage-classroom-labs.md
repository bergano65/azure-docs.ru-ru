...
> [!NOTE]
> Службы лаборатории Azure автоматически устанавливают и настраивают необходимые драйверы GPU при создании лаборатории с образами GPU.  
