...
1. Перейдите по **URL-адресу регистрации**, который вам предоставил преподаватель или методист. Не нужно использовать URL-адрес регистрации после завершения регистрации. Вместо этого используйте такой URL-адрес: [https://labs.azure.com](https://labs.azure.com). Обратите внимание на то, что Internet Explorer 11 еще не поддерживается. 
