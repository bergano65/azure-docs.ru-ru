...
3. В разделе **Повторение** выберите текущее расписание. 

    ![Добавление кнопки расписания на страницу "Расписания"](../media/how-to-create-schedules/select-current-schedule.png)
4. При выборе расписания откроется диалоговое окно **Повторить**. В нем выполните следующие действия.
...
5. Теперь на странице **Add scheduled event** (Добавление запланированного события) для параметра **Notes (optional)** (Примечания (необязательно)) введите любое описание или примечания для расписания. 
6. На странице **Add scheduled event** (Добавление запланированного события) нажмите кнопку **Сохранить**. 
