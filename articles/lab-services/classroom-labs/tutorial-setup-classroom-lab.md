...
На этом шаге вы опубликуете шаблон виртуальной машины. Процесс публикации создает виртуальные машины лаборатории, которые по сути копируют шаблон виртуальной машины. 
