...
8. На странице **Configure template** (Настройка шаблона) выполните следующие действия: Эти действия **необязательно** выполнять для этого руководства.
    1. Подключитесь к шаблону виртуальной машины. Для этого выберите **Подключиться**. 
...
2. Выберите конкретного пользователя или всех пользователей в списке. Чтобы выбрать конкретных пользователей, установите флажки в первом столбце списка. Чтобы выбрать всех пользователей, установите флажок перед заголовком первого столбца (**Имя**) или установите все флажки для всех пользователей в списке.
3. Выберите **Отправить приглашение** на панели инструментов. Вы также можете навести указатель мыши на имя учащегося в списке и отправить значок электронной почты. 
...
4. На странице **Отправка ссылки для регистрации по электронной почте** выполните следующие действия. 
    ...
    2. На странице **Отправка ссылки для регистрации по электронной почте** выберите **Отправить**. 
