...
Следующий шаг по внедрению фабрики образа для вашей команды — понять, что доступно. Изображение фабрики скрипты и шаблоны доступны публично в [репозиторий GitHub DevTest Labs](https://github.com/Azure/azure-devtestlab/tree/master/Scripts/ImageFactory). Ниже приводится объяснение из частей:
