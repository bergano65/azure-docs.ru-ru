...
description: В этой статье описывается, как настроить и использовать общедоступные среды (шаблоны менеджера ресурсов Azure в репо Git) в Лабораториях Azure DevTest Labs.
