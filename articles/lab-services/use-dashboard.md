...
![На экране капатуре показано представление панели мониторинга лаборатории в службах лаборатории Azure.](./media/use-dashboard/dashboard.png)
