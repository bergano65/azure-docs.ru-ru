---
title: PowerShell - Создание пользовательского изображения из файла VHD в лабораторных службах Azure
...
| [Новая АзРесурсГруппразвертывание](/powershell/module/az.resources/new-azresourcegroupdeployment) | Добавляет развертывание Azure в группу ресурсов. |
