...
14. На странице **тип установки** выберите **стандартный**. Нажмите кнопку **Далее**.
15. На странице **Выбор темы пользовательского интерфейса** выберите нужную тему. Нажмите кнопку **Далее**.
