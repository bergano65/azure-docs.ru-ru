...
Объявите секреты как защищенные строки. Ниже приведен синтаксис объявления безопасного строкового параметра в `parameters` разделе файла **artifactfile. JSON** :
...
Полный пример artifactfile. JSON и артефакта. ps1 (сценарий PowerShell) см. [в этом примере на сайте GitHub](https://github.com/Azure/azure-devtestlab/tree/master/Artifacts/windows-test-paramtypes).
