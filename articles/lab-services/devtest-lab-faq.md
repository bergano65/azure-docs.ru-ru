...
### <a name="where-can-i-track-feature-updates-going-forward"></a>Где можно отслеживать обновления компонентов, в дальнейшем?
В дальнейшем будет исправлена обновления компонентов и/или информативные сообщения в блогах в блоге Azure и Azure обновляет. Эти сообщения в блогах также будет связан в нашей документации, где это необходимо.
...
После создания виртуальной машины в DevTest Labs вам будет предоставлено разрешение на доступ к ней. Можно просмотреть виртуальной Машины на странице labs, а также на **виртуальных машин** страницы. Пользователи, которым назначена роль пользователя лаборатории DevTest Labs можно см. в разделе все виртуальные машины, которые были созданы в лаборатории в лаборатории **все виртуальные машины** страницы. Однако пользователи лаборатории с ролью DevTest Labs автоматически не получают доступ на чтение ресурсов виртуальной машины, созданных другими пользователями. Таким образом, эти виртуальные машины не отображаются на **виртуальных машин** страницы.
...
Ошибки при развертывании виртуальной машины записываются в журналы действий. Лаборатории можно найти журналы действий виртуальных Машин в группе **журналы аудита** или **диагностических данных виртуальной машины** в меню ресурсов на странице виртуальной Машины лаборатории (страница отображается после выбора виртуальной Машины из **моей виртуальной машины** списка).
