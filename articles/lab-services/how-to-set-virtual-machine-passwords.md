...
description: Узнайте, как устанавливать и сбрасывать пароли для виртуальных машин (ВМ) в лабораториях служб лаборатории Azure.
ms.topic: article
ms.date: 06/26/2020
...
3. Затем нажмите кнопку **Сохранить**. 
    ...
    ![Снимок экрана, показывающий окно "емкость лаборатории" с выбранной кнопкой "максимальное число компьютеров в лаборатории" и "Сохранить".](./media/how-to-set-virtual-machine-passwords/number-of-vms-in-lab.png)
...
Дополнительные сведения о том, как студенты могут сбрасывать пароли для виртуальных машин, см. [в статье Установка или сброс пароля для виртуальной машины в лабораториях (учащихся)](how-to-set-virtual-machine-passwords-student.md).