...
С помощью [управления доступом на основе ролей Azure (Azure RBAC)](https://docs.microsoft.com/azure/role-based-access-control/overview)можно назначить следующие роли для предоставления доступа учетным записям лаборатории и учебным лабораториям:
