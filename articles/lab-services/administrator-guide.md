...
Расположение лаборатории для аудитории зависит от следующих факторов:
  ...
  - **Нет одноранговой связи с виртуальной сетью ***и*** авторы лаборатории не могут выбрать расположение лаборатории**.
  ...
  - **Нет одноранговой связи с виртуальной сетью, ***но*** авторы лаборатории могут выбрать расположение лаборатории**.
...
| Большой (вложенная виртуализация) | <ul><li>8 ядер</li><li>ОЗУ 16 ГБ</li></ul>  | [Standard_A8_v2](https://docs.microsoft.com/azure/virtual-machines/av2-series) | Этот размер лучше всего подходит для приложений, которым требуются ЦП с более высокой тактовой частотой, более высокая производительность локального диска, крупные базы данных и крупные кэши памяти. |
