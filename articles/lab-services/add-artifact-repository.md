...
7. На вкладке **маркеров безопасности > личный доступ** выберите **новый токен**.
8. На **странице создания нового маркера личного доступа:**
   1. Введите **имя** токена.
   2. В списке **Организации** выберите **все доступные организации.**
   3. В списке **expiration (UTC)** выберите **90 дней**или установленный по заказу срок действия.
   4. Выберите опцию **полного доступа** для Скоупов.
