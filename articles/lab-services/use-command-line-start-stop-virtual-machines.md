...
Следующий сценарий PowerShell запускает виртуальную Машину в лаборатории. [Invoke-AzureRmResourceAction](/powershell/module/azurerm.resources/invoke-azurermresourceaction?view=azurermps-6.13.0) является основной целью для этого скрипта. **ResourceId** параметр — это полный идентификатор ресурса для виртуальной Машины в лаборатории. **Действие** параметр именно **запустить** или **остановить** параметры задаются в зависимости от необходимых.
