...
В этой статье описаны действия по тестированию приложения в Azure с помощью DevTest Labs. Сначала необходимо настроить общую папку в лаборатории и подключить ее как диск на локальном компьютере разработки и на виртуальной машине в лаборатории. Затем вы используете Visual Studio 2019 для развертывания приложения в файле, чтобы можно было запустить приложение на VM в лаборатории.  
...
3. [Установка Azure PowerShell](/powershell/azure/install-az-ps).
...
1. Создайте настольное/веб-приложение с помощью Visual Studio 2019.
