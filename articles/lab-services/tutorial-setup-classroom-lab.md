...
Вы можете создать группу Azure AD в каталоге Azure Active Directory организации, чтобы управлять доступом к ресурсам организации и облачным приложениям. Дополнительные сведения см. в статье [о группах Azure AD](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-manage-groups). Если в вашей организации используется Microsoft Office 365 или службы Azure, скорее всего в ней уже есть администраторы, управляющие Azure Active Directory. 
