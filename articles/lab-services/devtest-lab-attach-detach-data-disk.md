...
- Размер виртуальной машины определяет число дисков данных, которые можно к ней подключить. Дополнительные сведения см. в статье [размеры виртуальных машин](https://docs.microsoft.com/azure/virtual-machines/windows/sizes).
