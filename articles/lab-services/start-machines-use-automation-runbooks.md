...
Чтобы этот сценарий выполнялся ежедневно, [Создайте расписание](../automation/shared-resources/schedules.md#creating-a-schedule) в учетной записи службы автоматизации. После создания расписания [свяжите его с модулем Runbook](../automation/shared-resources/schedules.md#linking-a-schedule-to-a-runbook). 
