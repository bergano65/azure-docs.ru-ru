...
1. Настройте задачу следующим образом.
   ...
   |**Source Lab VM** > **Идентификатор виртуальной машины** исходного лабораторного испытания исходной виртуальной машины|Если вы изменили имя переменной Лабвмид по умолчанию, введите его здесь. По умолчанию установлено значение **$(labVMId)**.|
   |**Output Variables** > **Идентификатор пользовательского образа** переменных вывода|При необходимости можно изменить имя переменной по умолчанию.|
