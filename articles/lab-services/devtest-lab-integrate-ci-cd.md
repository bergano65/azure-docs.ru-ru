...
1. На странице проекта Azure DevOps выберите **конвейеры** > **выпуски** в левой области навигации.
...
1. На вкладке **конвейер** конвейера выпуска выберите текст с гиперссылкой в **шаге 1** , чтобы **просмотреть задачи этапа**, а затем щелкните знак "плюс" **+** рядом с **заданием агента**. 
...
1. Настройте задачу следующим образом.
   ...
   |**Идентификатор виртуальной машины** исходной лаборатории > исходной **лаборатории**|Если вы изменили имя переменной Лабвмид по умолчанию, введите его здесь. По умолчанию установлено значение **$(labVMId)** .|
