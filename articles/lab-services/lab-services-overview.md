...
> [!NOTE]
> Сейчас Службы лабораторий Azure поддерживают только виртуальные машины, созданные на основе образов Azure Marketplace. Если нужно применять пользовательские образы или создавать другие ресурсы PaaS в лабораторной среде, используйте DevTest Labs. См. подробнее о [создании пользовательского образа в DevTest Labs](devtest-lab-create-custom-image-from-vm-using-portal.md) и [создании лабораторных сред с помощью шаблонов Resource Manager](devtest-lab-create-environment-from-arm.md).
