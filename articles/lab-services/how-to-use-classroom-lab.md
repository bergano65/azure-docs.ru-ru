...
## <a name="view-all-the-labs"></a>Просмотреть все лабораторные занятия
После регистрации в лабораториях можно просмотреть все лаборатории, выполнив следующие действия. 
