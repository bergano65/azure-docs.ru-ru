---
title: Управление инфраструктурой Azure DevTest Labs - Ресурс
description: В этой статье рассматриваются вопросы выравнивания и управления ресурсами для лабораторий Azure DevTest в вашей организации.
