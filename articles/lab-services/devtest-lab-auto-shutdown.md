...
3. В **уведомления**выберите **перейти к ресурсу** уведомление. 
    ...
    ![Перейти к ресурсу](./media/devtest-lab-auto-shutdown/go-to-resource.png)
...
7. Выберите **+ новый шаг** в конструкторе и выполните следующие действия:
    ...
    5. Выберите **СУБЪЕКТА**и введите тему уведомления по электронной почте. Например: «Завершение работы компьютера vmName для лаборатории: labName.»
