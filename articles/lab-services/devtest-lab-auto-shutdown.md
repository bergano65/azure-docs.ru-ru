...
### <a name="set-auto-shutdown-policy-for-a-lab"></a>Установка политики автоматического выключения для лаборатории
...
1. На странице **Виртуальной машины** выберите **автоматическое выключение** в левом меню в разделе **Операции.** 
...
### <a name="view-activity-logs-for-auto-shutdown-updates"></a>Просмотр журналов активности для обновления автоматического выключения
При обновлении настройки автоматической остановки вы увидите действие, зарегистрированное в журнале активности для VM. 

1. На [портале Azure](https://portal.azure.com)перейдите на главную страницу для вашего VM.
2. Выберите **журнал активности** из левого меню. 
3. Удалить **ресурс: mycomputevm** из фильтров.
3. Подтвердите, что вы видите операцию **Добавить или изменяют графики** в журнале активности. Если вы не видите его, подождите когда-нибудь и обновите журнал активности.

    ![Запись журнала активности](./media/devtest-lab-auto-shutdown/activity-log-entry.png)
4. Выберите **операцию добавления или изменения расписаний,** чтобы увидеть следующую информацию на странице **Резюме:**

    - Имя операции (Добавить или изменить расписание)
    - Дата и время, в течение которого настройка автоматического выключения была обновлена.
    - Адрес электронной почты пользователя, который обновил настройку. 

        ![Резюме входа в журнал активности](./media/devtest-lab-auto-shutdown/activity-log-entry-summary.png)
5. Переключитесь на вкладку **истории изменений** на странице **Добавления или измените расписание,** и вы увидите историю изменений для настройки. В следующем примере время отключения было изменено с 19:00 до 18:00 10 апреля 2020 года в 15:18:47 EST. И, установка была отключена в 15:25:09 EST. 

    ![Журнал активности - изменить историю](./media/devtest-lab-auto-shutdown/activity-log-entry-change-history.png)
6. Чтобы узнать больше о операции, переключитесь на вкладку **JSON** на странице **Добавления или измените расписание.**
