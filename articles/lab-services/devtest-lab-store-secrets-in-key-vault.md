...
Обратите внимание, что пользователю лаборатории необходимо сначала создать лабораторную виртуальную машину, прежде чем они смогут создать секрет в хранилище ключей. Это связано с тем, что служба DevTest Lab должна связать пользователя лаборатории с действительным пользовательским документом, прежде чем ему будет разрешено создавать и хранить секреты в хранилище ключей. 
...
2. Введите **имя** для секрета. Это имя отображается в раскрывающемся списке при создании виртуальной машины, формулы или среды. 
