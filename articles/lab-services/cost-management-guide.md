...
* Автоматическое завершение работы виртуальных машин, которые запущены, но не подключаются пользователями.
    ...
    Внутри лаборатории пользователь может запустить виртуальную машину, но не подключаться к ней. Пример:
...
* [Настройка автоматического завершения работы виртуальных машин в при отключении учетной записи лаборатории](how-to-configure-lab-accounts.md)
* [Включение автоматического завершения работы виртуальных машин при отключении](how-to-enable-shutdown-disconnect.md)
