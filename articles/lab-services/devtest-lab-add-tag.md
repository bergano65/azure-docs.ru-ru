...
1. Чтобы создать новый тег для этой лабораторной работы, введите пару " **имя**/-**значение** " и нажмите кнопку **сохранить**. Вы также можете выбрать имеющийся тег из списка для просмотра связанных с ним ресурсов и управления ими.
