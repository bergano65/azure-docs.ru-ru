...
Каждый тег состоит из пары**значений** **имени.**/ Например, можно создать тег с именем *costcenter* и значением *34543*. Такой тег может помочь определить платные лабораторные ресурсы в этой определенной области организации. Нужно выбирать имена и значения в соответствии со способом упорядочивания подписки.
...
1. При необходимости щелкните **Все службы**, а затем выберите в списке **DevTest Labs**. Ваша лаборатория может быть уже показана на панели мониторинга под **всеми ресурсами.**
...
1. Чтобы создать новый тег для этой лаборатории, введите пару**значения** **имен**/и выберите **Сохранить.** Вы также можете выбрать имеющийся тег из списка для просмотра связанных с ним ресурсов и управления ими.

    ![Управление тегами](./media/devtest-lab-add-tag/devtestlab-manage-tags.png)

> [!NOTE]
> Теги, созданные на уровне лаборатории, протекают через все ресурсы, которые лаборатория закручивает в вашей подписке. Например, теги уровня лаборатории перетекают в базовые вычислительные ВМ лаборатории VMs.You можете использовать теги в контексте управления затратами. Теги уровня лаборатории отображаются в фильтре тегов для управления затратами.
