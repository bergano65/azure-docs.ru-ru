...
1. Преобразуйте извлеченный VMDK-файл в VHDX-файл, чтобы можно было использовать его вместе с Hyper-V. Существует несколько средств для преобразования образов VMware в образы Hyper-V и наоборот.  Мы будем использовать [преобразователь STARWIND V2V](https://www.starwindsoftware.com/starwind-v2v-converter).  Для загрузки см. [страницу загрузки преобразователя STARWIND V2V](https://www.starwindsoftware.com/starwind-v2v-converter#download).
    ...
    1. На странице **Преобразование** дождитесь преобразования изображения.  Это может занять несколько минут.  По завершении преобразования нажмите кнопку **Готово** .
