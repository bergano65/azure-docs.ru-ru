...
> [!NOTE]
> Чтобы узнать о расходах, связанных [Pricing for Azure Virtual Network](../virtual-network/virtual-networks-overview.md#pricing)с сервисом Виртуальной сети Azure, см.
...
1. После выбора виртуальной сети вы вернетесь в область **Виртуальная сеть**. Выберите подсеть из списка внизу.
   ...
   - Чтобы позволить использовать подсеть в создании vM лаборатории, выберите **Использование в создании виртуальной машины.**
   ...
   - В **максимальных виртуальных машинах на** поле пользователя укажите максимум виртуальных на одного пользователя для каждой подсети. Чтобы разрешить использовать неограниченное число виртуальных машин, оставьте это поле пустым.
