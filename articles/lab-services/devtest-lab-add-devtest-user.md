...
| **Действия, которые могут выполнять пользователи с этой ролью** | **DevTest Labs Пользователь** | **Владелец** | **Участник** |
| --- | --- | --- | --- |
| **Задачи лаборатории** | | | |
...
5. На лезвии **пользователей** выберите **Добавить**.
