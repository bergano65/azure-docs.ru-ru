---
title: Политика и соответствие требованиям компании в Лабораториях Azure DevTest
description: В этой статье описано, как обеспечить соответствие политикам, которые установлены в компании для инфраструктуры Azure DevTest Labs.
