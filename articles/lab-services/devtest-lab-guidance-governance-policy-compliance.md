...
- Свяжите службу Visual Studio Team Services с тем же клиентом Azure Active Directory, который используется для проверки подлинности и авторизации в подписке Azure.
