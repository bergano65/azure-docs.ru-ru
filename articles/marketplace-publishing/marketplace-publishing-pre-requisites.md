...
## <a name="steps-to-add-a-coadmin-in-the-publishing-portal"></a>Добавление соадминистратора на портале публикации
Администраторы портала публикации могут добавлять других сотрудников компании, работающих с приложением, в качестве соадминистраторов портала публикации. **Если вы являетесь администратором**, выполните приведенные ниже шаги для добавления соадминистратора.
...
7. При регистрации в центре разработки избегайте использования учетной записи, связанной только с одним человеком. Так вы сможете избежать зависимости от отдельного лица.
...
## <a name="steps-to-delete-a-coadmin-in-the-publishing-portal"></a>Удаление соадминистратора на портале публикации
**Если вы являетесь администратором**, выполните приведенные ниже шаги для удаления соадминистратора.
...
Это подписка, которая будет использоваться для создания образов виртуальных машин и передачи образов в [Azure Marketplace](https://azure.microsoft.com/marketplace/). Если у вас нет подписки, зарегистрируйтесь здесь: https://account.windowsazure.com/signup?offer=ms-azr-0003p.
