...
## <a name="step-1-provide-marketplace-marketing-content"></a>Шаг 1. Предоставление маркетингового содержимого Marketplace
*Единственным языком по умолчанию, а также поддерживаемым языком является английский.*  Проверьте, что все сведения, предоставляемые в полях, указываются на английском языке. Все сведения можно отредактировать в любое время до момента перехода в промежуточную стадию.
...
* Как только предложение вносится в список, в имиджевый логотип программно вставляется отображаемое имя издателя, название плана, развернутая сводка предложения и кнопка "Создать", поэтому вводить какой либо текст при разработке имиджевого логотипа не нужно. Оставьте справа пустое пространство, так как мы добавляем текст (отображаемое имя издателя, заголовок плана, длинная сводка предложения) программно. Для текста необходимо пространство в правой части размером 415 x 100 пикселей (с отступом слева 370 пикселей).
...
## <a name="step-2-set-your-prices"></a>Шаг 2. Установка собственных цен
...
### <a name="211-how-to-set-up-hourly-pricing-model-for-a-sku"></a>2.1.1 Настройка почасовой модели выставления счетов для номеров SKU
Чтобы настроить почасовую модель выставления счетов для номеров SKU, выполните указанные ниже действия.
...
3. В боковом меню слева щелкните вкладку **Номера SKU**.
...
8. Задайте цены для всех ядер. *Укажите цены для всех ядер SKU, даже если ваш номер SKU не поддерживает какие-то из них.*
...
### <a name="212-how-to-set-up-byol-pricing-model-for-a-sku"></a>2.1.2 Настройка модели выставления счетов BYOL для номеров SKU
Чтобы настроить модель выставления счетов BYOL для номеров SKU, выполните указанные ниже действия.
...
## <a name="step-4-choose-azure-marketplace-categories"></a>Шаг 4. Выбор категории Azure Marketplace
На вкладке **Категории** представлены доступные для выбора категории. Можно выбрать до пяти категорий.
