...
Можно использовать REST API [получить работоспособности конечных точек](https://docs.microsoft.com/de-de/rest/api/iothub/iothubresource/getendpointhealth#iothubresource_getendpointhealth) получить состояние работоспособности конечных точек. Мы рекомендуем использовать [метрики центра Интернета вещей](iot-hub-metrics.md) относящиеся к маршрутизации задержка сообщений для диагностики и устранения ошибок при неработающей или неработоспособное работоспособности конечных точек.

|Состояние работоспособности|Описание|
|---|---|
|Работоспособен|Конечная точка принимает сообщения должным образом.|
