...
| Размер | До 256 КБ сообщений. | Максимальный размер свойств составляет 32 кБ. | Максимальный размер файла, поддерживаемый хранилищем BLOB-объектов Azure. |
