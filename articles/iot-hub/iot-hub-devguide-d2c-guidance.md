...
| Размер | До 256 КБ сообщений. | Максимальный размер сообщаемых свойств — 32 КБ. | Максимальный размер файла, поддерживаемый хранилищем BLOB-объектов Azure. |
