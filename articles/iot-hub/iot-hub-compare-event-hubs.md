...
| Protocols: HTTPS, AMQP, AMQP через WebSocket | ![Проверка][checkmark] | ![Проверка][checkmark] | ![Проверка][checkmark] |
| Protocols: MQTT, MQTT через WebSocket | ![Проверка][checkmark] | ![Проверка][checkmark] |  |
...
| Потоки устройств (предварительная версия) | ![Проверка][checkmark] |  |  |
