...
ms.locfileid: "60002907"
---
# <a name="tutorial-perform-manual-failover-for-an-iot-hub-public-preview"></a>Руководство по Выполнение ручной отработки отказа центра Интернета вещей Azure (предварительная версия)
