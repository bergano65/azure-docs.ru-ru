...
ms.locfileid: "77110666"
---
# <a name="tutorial-perform-manual-failover-for-an-iot-hub"></a>Руководство. выполнению отработки отказа вручную для Центра Интернета вещей
