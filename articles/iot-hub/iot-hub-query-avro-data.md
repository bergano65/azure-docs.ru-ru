...
Дополнительные сведения см. в статье [Использование службы хранилища Azure в качестве конечной точки маршрутизации](iot-hub-devguide-messages-d2c.md#azure-storage).
