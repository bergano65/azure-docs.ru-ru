...
* [Инструменты Azure IoT для VS Code](https://marketplace.visualstudio.com/items?itemName=vsciot-vscode.azure-iot-tools) или копирования и вставки этого URL в окно браузера:`vscode:extension/vsciot-vscode.azure-iot-tools`
