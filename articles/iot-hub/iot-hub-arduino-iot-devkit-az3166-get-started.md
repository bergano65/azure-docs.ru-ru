...
Можно найти исходный код для работы с учебниками по DevKit [IoTDevEnvExamples](https://github.com/IoTDevEnvExamples) репозитория.
...
1. Чтобы проверить данные телеметрии, отправленные в Azure, выполните следующую команду в Azure Cloud Shell:
    ```bash
...
1. Разверните **устройства ЦЕНТРА Интернета ВЕЩЕЙ AZURE** панели справа щелкните правой кнопкой мыши имя устройства, вы создали и выберите **начать мониторинг встроенную событий конечную точку**.
