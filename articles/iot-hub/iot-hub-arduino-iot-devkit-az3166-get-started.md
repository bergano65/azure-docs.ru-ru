...
1. Выполните приведенные ниже команды в Azure Cloud Shell, чтобы создать удостоверение устройства.
   ...
   **MyNodeDevice**. Имя регистрируемого устройства. Используйте **MyNodeDevice**, как показано ниже. Если вы выбрали другое имя для устройства, используйте его при работе с этим руководством и обновите имя устройства в примерах приложений перед их запуском.
   ...
   > [!NOTE]
   > Если возникает ошибка `device-identity`, установите [расширение Azure IOT для Azure CLI](https://github.com/Azure/azure-iot-cli-extension/blob/dev/README.md) для получения дополнительных сведений.
...
1. Затем выберите или создайте новую [группу ресурсов](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-overview#terminology).
    ...
    ![Выбрать группу ресурсов](media/iot-hub-arduino-devkit-az3166-get-started/getting-started/select-resource-group.png)
