...
> [!NOTE]
> С 11 марта 2019 г. функция мониторинга операций удаляется из интерфейса портал Azure центра Интернета вещей. Приведенные ниже действия больше не применяются. Чтобы выполнить миграцию, убедитесь, что в Azure Monitor параметров диагностики выше включены правильные категории.
