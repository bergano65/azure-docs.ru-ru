---
title: Отправка сообщений на сервер МТТ с помощью клиентской библиотеки Azure M'TT
description: Узнайте, как использовать библиотеку клиента МЗТТ для отправки сообщений брокеру МЗТТ. Кроме того, узнайте, как настроить свой mXChip IoT DevKit, чтобы быть клиентом МЗТТ.
author: liydu
manager: jeffya
ms.service: iot-hub
services: iot-hub
