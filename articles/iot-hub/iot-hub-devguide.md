...
* Статья [Отправка сообщений с устройства в облако и из облака на устройство с помощью Центра Интернета вещей](iot-hub-devguide-messaging.md) содержит сведения о функциях обмена сообщениями (между устройством и облаком в обоих направлениях), которые предоставляет Центр Интернета вещей.
  ...
  * [Прочитайте сообщения от устройства к облаку со встроенной точки.](iot-hub-devguide-messages-read-builtin.md)

  * [Используйте пользовательские конечные точки и правила реуктора для сообщений от устройства к облаку.](iot-hub-devguide-messages-read-custom.md)

  * [Отправка сообщений от облака к устройству от Концентратора IoT.](iot-hub-devguide-messages-c2d.md)

  * [Создавайте и читайте сообщения IoT Hub.](iot-hub-devguide-messages-construct.md)
...
* [Общие сведения о двойниках устройств и их использование в Центре Интернета вещей](iot-hub-devguide-device-twins.md): сведения о концепции *двойника устройства*. В статье также описывается функциональность устройства близнецов разоблачить, такие как синхронизация устройства с устройством близнецы. Эта статья также содержит сведения о данных, хранящихся в двойнике устройства.
