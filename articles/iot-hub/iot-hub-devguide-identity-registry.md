...
Идентификаторы устройств также могут быть экспортированы и импортированы из концентратора IoT через Service API через [REST API](/rest/api/iothub/service/jobclient/createimportexportjob) или один из [SDK службы](/azure/iot-hub/iot-hub-devguide-sdks#azure-iot-hub-service-sdks)концентратора IoT.
...
| etag |Обязательно, только для чтения |Строка, представляющая слабый ETag для идентификации устройства, в соответствии с [RFC7232.](https://tools.ietf.org/html/rfc7232) |
...
* [Начало работы с концентратором Azure IoT](quickstart-send-telemetry-dotnet.md)
