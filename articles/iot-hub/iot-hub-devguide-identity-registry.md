...
Текст: Этот раздел имеет формат JSON и предоставляет двойник созданного удостоверения устройства. Например,
...
Текст: В этом разделе в формате JSON и представляет двойник созданного модуля удостоверения. Например,
