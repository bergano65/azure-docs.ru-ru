...
Удостоверения устройств также можно экспортировать и импортировать из центра Интернета вещей через API службы с помощью [REST API](/rest/api/iothub/service/createimportexportjob) или одного из [пакетов SDK службы](/azure/iot-hub/iot-hub-devguide-sdks#azure-iot-hub-service-sdks)центра Интернета вещей.
