...
Используйте метод **ExportDevicesAsync** для экспорта всего реестра удостоверений Центра Интернета вещей в контейнер больших двоичных объектов [службы хранилища Azure](../storage/index.yml) с помощью [подписанного URL-адреса](../storage/common/storage-security-guide.md#authorization).
...
| importMode | Description (Описание) |
| --- | --- |
