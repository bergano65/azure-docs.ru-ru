...
| **создание** |Если устройство не существует с указанным **идентификатор**, оно регистрируется заново. <br/>Если устройство уже существует, в файл журнала записывается ошибка. <br> Вместе с данными устройства пользователь может дополнительно указать данные двойника устройства. Значение Etag двойника, если указано, обрабатывается отдельно от значения Etag устройства. При несоответствии между имеющимися значениями Etag двойника в файл журнала записывается ошибка. |
...
| **delete** |Если устройство уже существует с указанным **идентификатор**, оно удаляется вне зависимости от **ETag** значение. <br/>Если устройство не существует, в файл журнала записывается ошибка. |
