...
| importMode | ОПИСАНИЕ |
| --- | --- |
| **createOrUpdate** |Если устройство не существует с указанным **идентификатор**, оно регистрируется заново. <br/>Если устройство уже существует, имеющиеся данные заменяются предоставленными входными данными вне зависимости от значения **ETag** . <br> Вместе с данными устройства пользователь может дополнительно указать данные двойника устройства. Значение Etag двойника, если указано, обрабатывается отдельно от значения Etag устройства. При несоответствии между имеющимися значениями Etag двойника в файл журнала записывается ошибка. |
| **create** |Если устройство не существует с указанным **идентификатор**, оно регистрируется заново. <br/>Если устройство уже существует, в файл журнала записывается ошибка. <br> Вместе с данными устройства пользователь может дополнительно указать данные двойника устройства. Значение Etag двойника, если указано, обрабатывается отдельно от значения Etag устройства. При несоответствии между имеющимися значениями Etag двойника в файл журнала записывается ошибка. |
| **обновить** |Если устройство уже существует с указанным **идентификатор**, имеющиеся данные заменяются предоставленными входными данными вне зависимости от **ETag** значение. <br/>Если устройство не существует, в файл журнала записывается ошибка. |
| **updateIfMatchETag** |Если устройство уже существует с указанным **идентификатор**, имеющиеся данные заменяются предоставленными входными данными только в том случае, если имеется **ETag** совпадают. <br/>Если устройство не существует, в файл журнала записывается ошибка. <br/>Если имеется несовпадение **ETag** , в файл журнала записывается ошибка. |
| **createOrUpdateIfMatchETag** |Если устройство не существует с указанным **идентификатор**, оно регистрируется заново. <br/>Если устройство уже существует, имеющиеся данные заменяются предоставленными входными данными только при совпадении **ETag** . <br/>Если имеется несовпадение **ETag** , в файл журнала записывается ошибка. <br> Вместе с данными устройства пользователь может дополнительно указать данные двойника устройства. Значение Etag двойника, если указано, обрабатывается отдельно от значения Etag устройства. При несоответствии между имеющимися значениями Etag двойника в файл журнала записывается ошибка. |
| **удалить** |Если устройство уже существует с указанным **идентификатор**, оно удаляется вне зависимости от **ETag** значение. <br/>Если устройство не существует, в файл журнала записывается ошибка. |
| **deleteIfMatchETag** |Если устройство уже существует с указанным **идентификатор**, оно удаляется только в том случае, если имеется **ETag** совпадают. Если устройство не существует, в файл журнала записывается ошибка. <br/>Если имеется несовпадение ETag, в файл журнала записывается ошибка. |
