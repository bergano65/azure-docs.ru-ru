...
| --------- | ----- |
| Устройств | Максимальное число устройств, которые можно подключить к одному центру Интернета вещей, — 1 000 000. Единственный способ увеличить это ограничение — обратиться в [Служба поддержки Майкрософт](https://azure.microsoft.com/support/options/).|
