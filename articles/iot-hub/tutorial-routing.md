...
Данные записываются в хранилище BLOB-объектов формате Avro.
...
4. В разделе **Топология задания** щелкните **Входные данные**.

5. В панели **входов**, нажмите кнопку **Добавить потоковый вход** и выберите Центр IoT. На появившемся экране заполните следующие поля:
