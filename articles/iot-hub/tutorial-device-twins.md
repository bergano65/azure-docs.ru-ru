---
title: Руководство. Синхронизация состояния устройств из Центра Интернета вещей Azure | Документация Майкрософт
description: Руководство. Узнайте, как с помощью двойников устройств настраивать устройства из облака и получать данные о состоянии и соответствии требованиям со своих устройств.
services: iot-hub
author: wesmc7777
ms.author: wesmc
ms.service: iot-hub
