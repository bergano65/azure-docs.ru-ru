...
description: Узнайте, как с помощью двойников устройств настроить устройства в облаке и получать данные о состоянии и соответствии требованиям со своих устройств.
services: iot-hub
author: wesmc7777
ms.author: wesmc
ms.service: iot-hub
