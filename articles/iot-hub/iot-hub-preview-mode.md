...
- Некоторые существующие функции центра Интернета вещей, такие как частная связь, управляемое удостоверение, потоки устройств и отработку отказа, могут работать неожиданно или вообще.
