...
* **Планирование.** На этом этапе операторы создают схему метаданных устройства, позволяющую им легко и точно выполнить запрос, а также выбрать группу устройств для массового управления операциями. Для хранения метаданных устройства в форме тегов и свойств можно использовать его двойник.
    ...
    *Дальнейшее чтение*: 
    * [Начало работы с устройством близнецов](iot-hub-node-node-twin-getstarted.md)
    * [Основные сведения о двойниках устройств](iot-hub-devguide-device-twins.md)
    * [Как использовать двойные свойства устройства](tutorial-device-twins.md)
...
* **Выход на пенсию**: Заменить или вывести из эксплуатации устройства после сбоя, цикла обновления или в конце срока службы.  При замене, архивации или прекращении использования физического устройства сведения об устройстве сохраняются с помощью двойника устройства. Безопасный отзыв удостоверений и учетных данных устройств выполняется с помощью реестра удостоверений Центра Интернета вещей.
