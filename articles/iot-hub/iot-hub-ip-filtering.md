...
![После выбора Правила IP-фильтра](./media/iot-hub-ip-filtering/ip-filter-after-selecting-add.png)
...
IP-фильтры IoT Hub можно получить и установить через [Azure PowerShell.](/powershell/azure/overview)
