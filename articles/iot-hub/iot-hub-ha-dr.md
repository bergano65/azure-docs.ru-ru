...
| --- | --- | --- | --- | --- | --- |
| Корпорация Майкрософт инициирует отработку отказа |2–26 часов|См. сведения в таблице RPO выше|нет|None|Отсутствуют|
| Переход на другой ресурс вручную |От 10 мин до 2 ч|См. сведения в таблице RPO выше|Да|Очень низкая. Необходимо просто запустить эту операцию на портале.|Отсутствуют|
