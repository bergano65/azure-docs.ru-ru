...
| ------- | --------------- | ---------- |
| **Сообщения и события устройства** | Да, маршрутизацию сообщений можно использовать для данных телеметрии, изменений двойникаов устройств, событий жизненного цикла устройства и событий изменения цифровых двойника. | Да, сетка событий может использоваться для данных телеметрии и событий устройств, таких как устройство создано, удалено, подключено или отключено. Но сетка событий не может использоваться для событий изменения двойникаа устройства и событий изменения цифровых двойника. |
