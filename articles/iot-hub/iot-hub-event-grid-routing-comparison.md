...
| ------- | --------------- | ---------- |
| **Сообщения и события устройства** | Да, маршрутизацию сообщений можно использовать для данных телеметрии, отчетов об изменениях двойникаов устройств, событий жизненного цикла устройства (например, когда устройства создаются, удаляются, подключаются и отключаются из центра Интернета вещей, а также события изменения цифровых двойника (в составе [общедоступной предварительной версии IoT Plug and Play](../iot-pnp/overview-iot-plug-and-play.md)). | Да, сетка событий может использоваться для данных телеметрии и событий жизненного цикла устройства. Но сетка событий не может использоваться для событий изменения двойникаа устройства и событий изменения цифровых двойника. |
