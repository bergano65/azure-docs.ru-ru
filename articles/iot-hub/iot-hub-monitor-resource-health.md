...
Обратите `correlationId` внимание, что соответствует предложению [контекста трассировки W3C](https://github.com/w3c/trace-context) , где оно содержит, `trace-id` а также `span-id`.
