...
| Свойство | Тип | Описание |
|--------------------|-----------------------------------------------|------------------------------------------------------------------------------------------------|
| **isRoutingEnabled** | Строковый тип | Значение true или false показывает, включена ли маршрутизация сообщений в Центре Интернета вещей |
| **parentSpanId** | Строковый тип | [Span-id](https://w3c.github.io/trace-context/#parent-id) родительского сообщения, которое в этом случае является трассировкой сообщения, передаваемого из устройства в облако (D2C) |
...
| Свойство | Тип | Описание |
|--------------------|-----------------------------------------------|------------------------------------------------------------------------------------------------|
| **endpointName** | Строковый тип | Имя конечной точки маршрутизации |
| **endpointType** | Строковый тип | Тип конечной точки маршрутизации |
| **parentSpanId** | Строковый тип | [Span-id](https://w3c.github.io/trace-context/#parent-id) родительского сообщения, которое в этом случае является трассировкой сообщения входящего трафика Центра Интернета вещей |
