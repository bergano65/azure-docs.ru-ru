...
| положительное | Если сообщение, переданное из облака на устройство, достигает состояния *завершено* , центр Интернета вещей создает сообщение с отзывом. |
...
| Код состояния         | Обязательная строка, используемая в сообщениях отзыва, созданных центром Интернета вещей: <br/> *Успешно* <br/> *Истек* <br/> *DeliveryCountExceeded* <br/> *Вергать* <br/> *Очистке* |
