...
| StatusCode         | Необходимая строка, используемая в сообщениях обратной связи, генерируемых концентратором IoT: <br/> *Success* <br/> *Истек* <br/> *ДоставкаCountПревысила* <br/> *Отклонено* <br/> *Очищены* |
