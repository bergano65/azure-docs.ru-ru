...
| ------------------------- | ----------- | ----------------- |
| defaultTtlAsIso8601       | TTL для сообщений, отправляемых из облака на устройство, по умолчанию | ISO_8601 интервал до 2 дней (минимум 1 минута); параметры 1 ч. |
| maxDeliveryCount          | Максимальное число доставок для очередей устройств из облака на устройство | от 1 до 100; параметры 10 |
| feedback.ttlAsIso8601     | Хранение сообщений об отзыве, привязанных к службе | ISO_8601 интервал до 2 дней (минимум 1 минута); параметры 1 ч. |
