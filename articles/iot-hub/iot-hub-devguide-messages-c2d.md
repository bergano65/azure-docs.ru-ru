...
| StatusCode         | Обязательная строка, используемая в сообщениях отзыва, созданных центром Интернета вещей: <br/> *Успешно* <br/> *Истек* <br/> *DeliveryCountExceeded* <br/> *Вергать* <br/> *Очистке* |
