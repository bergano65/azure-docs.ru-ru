...
> [!NOTE]
> Для просмотра информации об устройствах IoT Plug и Play, подключенных к концентратору IoT, можно использовать метрики IoT Hub. Устройства IoT Plug and Play являются частью [публичного предварительного просмотра IoT Plug and Play.](../iot-pnp/overview-iot-plug-and-play.md)
