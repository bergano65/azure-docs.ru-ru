...
|c2d<br>.twin<br>.read<br>.success|Успешные операции чтения с двойников, инициированные из серверной части.|Count|Всего|Число всех успешных операций чтения с двойников, инициированных из серверной части. Это число не включает операции чтения двойника, инициированные из запросов двойника.|Нет измерений|
