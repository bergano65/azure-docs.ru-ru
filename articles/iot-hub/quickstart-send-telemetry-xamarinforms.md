---
title: Краткое руководство по отправке данных телеметрии в Центр Интернета вещей Azure (Xamarin.Forms)
description: Вы узнаете, как запустить пример приложения Xamarin.Forms для отправки имитированных данных телеметрии в центр Интернета вещей и считывания данных телеметрии из центра Интернета вещей для обработки в облаке.
author: cmaneu
manager: philmea
ms.author: chmaneu
ms.service: iot-hub
