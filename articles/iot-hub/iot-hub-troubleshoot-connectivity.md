...
1. Выберите **добавить условие**, затем выберите «Подключенных устройств (Предварительная версия)».
1. Завершите настройку вашей требуемые пороги и параметры предупреждений, следующие запросы.
