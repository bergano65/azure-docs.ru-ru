...
**Пример\_HTTP\_-\_приложения iothub Client** , который входит в состав пакета SDK, демонстрирует интерфейсы API нижнего уровня. В этом примере мы отправляем события в Центр Интернета вещей с помощью кода, аналогичного приведенному ниже.
