...
Вы отправляете сериализованный объект JSON с двумя свойствами: **Имя** имя действия (сообщения) и **параметры** содержит параметры этого действия.
