...
* Node.js 4.0.x или более поздней версии. [Подготовка среды разработки](https://github.com/Azure/azure-iot-sdk-node/tree/master/doc/node-devbox-setup.md) описывается установка Node.js в этом руководстве в ОС Windows или Linux.
