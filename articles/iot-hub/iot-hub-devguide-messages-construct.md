...
| iothub-enqueuedtime |Дата и время [Device-to-Cloud](iot-hub-devguide-d2c-guidance.md) центра Интернета вещей получил сообщение. | Для сообщений D2C — нет, в противном случае — да. |
