...
Вы можете настроить эти свойства на концентраторЕ IoT с помощью портала Azure, Azure CLI или PowerShell. Чтобы узнать, как, увидеть темы под [настройкой файлзагрузить](iot-hub-configure-file-upload.md).
