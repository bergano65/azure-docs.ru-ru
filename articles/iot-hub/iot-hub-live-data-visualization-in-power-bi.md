...
* Создать и опубликовать отчет Power BI, чтобы визуализировать данные.
...
3. В области **Входные данные** щелкните **Добавить**, а затем введите сведения, приведенные ниже.
...
2. В области **Выходные данные** щелкните **Добавить**, а затем введите сведения, приведенные ниже.
...
4. После входа в систему введите сведения, приведенные ниже.
...
3. Перейдите в рабочую область группы, заданную при создании выходных данных для задания Stream Analytics.

4. Щелкните **Потоковая передача наборов данных**.

   Вы должны увидеть набор данных, указанный при создании выходных данных для задания Stream Analytics.

5. В разделе **Действия** щелкните первый значок для создания отчета.
...
9. Щелкните **Файл** > **Опубликовать в Интернете**.

10. Щелкните **Создать код внедрения**, а затем выберите **Опубликовать**.
