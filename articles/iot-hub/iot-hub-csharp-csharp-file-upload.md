...
Этот учебник основан на коде в [отправки сообщений из облака на устройство с центром Интернета вещей](iot-hub-csharp-csharp-c2d.md) руководству, чтобы показать, как использовать возможности передачи файлов центра Интернета вещей. В нем показано следующее:
...
* **SimulatedDevice**, измененную версию приложения, созданного в [отправки сообщений из облака на устройство с центром Интернета вещей](iot-hub-csharp-csharp-c2d.md) руководства. Это приложение передает файл в хранилище с помощью универсального кода ресурса (URI) SAS, предоставленного вашим Центром Интернета вещей.
...
В этом разделе вы измените приложение устройства, созданный в [отправки сообщений из облака на устройство с центром Интернета вещей](iot-hub-csharp-csharp-c2d.md) для получения сообщений из облака на устройство из центра Интернета вещей.
