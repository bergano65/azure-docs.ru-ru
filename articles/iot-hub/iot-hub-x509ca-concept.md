...
![Поток для генерации сертификатов X509CA](./media/iot-hub-x509ca-concept/csr-flow.png)
...
![Цепочка доверия от сертификатов одной компании до сертификатов другой компании](./media/iot-hub-x509ca-concept/cert-mfr-chain.png)
...
![Поток от одного сертификата к другому, поп вызов от концентратора](./media/iot-hub-x509ca-concept/device-pop-flow.png)
