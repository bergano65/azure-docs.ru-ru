...
![Поток для создания сертификатов X509CA](./media/iot-hub-x509ca-concept/csr-flow.png)
...
![Иерархии цепочки сертификатов](./media/iot-hub-x509ca-concept/cert-chain-hierarchy.png)
...
![Цепочку сертификатов от сертификатов одна компания сертификаты из другой компании](./media/iot-hub-x509ca-concept/cert-mfr-chain.png)
...
![Поток из одного сертификата, запрос другой, всплывающих сообщений из концентратора](./media/iot-hub-x509ca-concept/device-pop-flow.png)
