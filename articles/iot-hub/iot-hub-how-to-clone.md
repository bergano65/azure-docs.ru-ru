...
1. Выберите **Развертывание шаблона (развертывание с помощью пользовательских шаблонов)**. Откроется экран для Шаблоны развертывания. Нажмите кнопку **создания**. Появляется следующий экран:
...
## <a name="using-import-export-to-move-the-devices-to-the-new-hub"></a>Использование Import-Export для перемещения устройств в новый центр
