...
* [Перенос пакета SDK для C для других платформ](https://github.com/Azure/azure-c-shared-utility/blob/master/devdoc/porting_guide.md)
...
* [Образцы](https://github.com/Azure-Samples/azure-iot-samples-ios)
* Справочник по API: см. [Справочная документация по API для C](https://docs.microsoft.com/azure/iot-hub/iot-c-sdk-ref/).
...
* [Поддержка платформы Azure SDK Интернета вещей](iot-hub-device-sdk-platform-support.md)
...
* [Справочник по API REST для центра Интернета вещей](/rest/api/iothub/)
