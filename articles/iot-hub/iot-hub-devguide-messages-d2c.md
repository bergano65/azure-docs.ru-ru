...
> [!NOTE]
> Если в учетной записи хранения есть конфигурации брандмауэра, ограничивающие возможности подключения центра Интернета вещей, рассмотрите возможность использования [исключения Microsoft Trusted First сторона](./virtual-network-support.md#egress-connectivity-to-storage-account-endpoints-for-routing) (доступно в выбранных регионах для центров Интернета вещей с управляемым удостоверением службы).
...
> [!NOTE]
> Если ресурс служебной шины имеет конфигурации брандмауэра, которые ограничивают возможности подключения центра Интернета вещей, рассмотрите возможность использования [исключения Microsoft Trusted First сторона](./virtual-network-support.md#egress-connectivity-to-service-bus-endpoints-for-routing) (доступно в выбранных регионах для центров Интернета вещей с управляемым удостоверением службы).
...
> [!NOTE]
> Если в ресурсе концентраторов событий имеются конфигурации брандмауэра, ограничивающие подключение центра Интернета вещей, рассмотрите возможность использования [исключения Microsoft Trusted First сторона](./virtual-network-support.md#egress-connectivity-to-event-hubs-endpoints-for-routing) (доступно в области выбора для центров Интернета вещей с управляемым удостоверением службы).
