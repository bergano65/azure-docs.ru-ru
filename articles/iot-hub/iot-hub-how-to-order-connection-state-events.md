---
title: Заказ событий подключения устройства fr центр Интернета вещей Azure w/Azure Cosmos DB
...
* Активная учетная запись Azure. Если у вас ее нет, можно [создать бесплатную учетную запись](https://azure.microsoft.com/pricing/free-trial/).
...
1. В Cosmos DB API SQL выберите **Обозреватель данных** > **элементы** > **создать хранимую процедуру**.
...
4. Заполните **сведения о подписке на события**: введите описательное имя и выберите **Схема сетки событий**.
