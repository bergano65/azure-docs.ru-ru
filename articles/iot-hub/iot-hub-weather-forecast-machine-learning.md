...
1. В области **Выходные данные** щелкните **Добавить**, а затем введите сведения, приведенные ниже.
   ...
   **Учетная запись хранения**. Учетная запись хранения для хранилища BLOB-объектов. Можно использовать существующую учетную запись хранения или создать новую.

   **Контейнер.** Контейнер, в котором сохранен большой двоичный объект. Вы можете создать новый контейнер или использовать уже существующий.
...
1. Введите следующие сведения:
   ...
   **Псевдоним функции**: Укажите `machinelearning`.

   **Тип функции**: Выберите **машинное Обучение Azure**.

   **Вариант импорта.** Выберите **импорта из другой подписки**.
