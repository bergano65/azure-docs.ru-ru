...
1. В левой части окна Машинное обучение Azure Studio щелкните стрелку, чтобы развернуть панель Инструменты. Введите строку Execute в поле поиска. Выберите модуль **Execute R Script** (Выполнение скрипта R).
