...
Центр Интернета вещей масштабируется до нескольких миллионов одновременно подключенных устройств и нескольких миллионов событий в секунду для поддерживания рабочих нагрузок Интернета вещей. Центр Интернета вещей предлагает несколько уровней обслуживания, что позволяет выбрать тот, который лучше всего подходит для ваших потребностей масштабируемости. Дополнительные сведения см. на [странице с ценами](https://azure.microsoft.com/pricing/details/iot-hub/).
