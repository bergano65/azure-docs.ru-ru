...
|-----------------|----------|---------|-----------------------------------------------------|
| `sampling_mode` | Yes | Целое число  | Для включения и отключения выборки в настоящее время поддерживается два режима. `1` включен и `2` отключен. |
...
> [!div class="button"]
> <a href="https://github.com/Azure-Samples/e2e-diagnostic-provision-cli" target="_blank">Получить пример на Github</a>
