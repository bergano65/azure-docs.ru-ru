...
Центр Интернета вещей отклоняется с ошибкой все операции, которые увеличивают размер документов `tags`, `properties/desired`или `properties/reported` выше ограничения.
