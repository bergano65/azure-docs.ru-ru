...
- [Настройка журналов Интернета вещей Azure](monitor-iot-hub-reference.md#resource-logs)
...
- [Настройка журналов ресурсов для центра Интернета вещей](monitor-iot-hub.md#collection-and-routing)
