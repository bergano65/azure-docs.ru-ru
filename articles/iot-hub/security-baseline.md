...
- [рекомендации по многим сетям](https://docs.microsoft.com/azure/iot-fundamentals/security-recommendations?context=azure/iot-hub/rc/rc#networking)
...
- [ Как просмотреть рискованные входы в Azure AD](/azure/active-directory/reports-monitoring/concept-risky-sign-ins)
...
- [Создание хранилища ключей](/azure/key-vault/quick-create-portal)
...
- [ Использование тегов для Организации ресурсов Azure](/azure/azure-resource-manager/resource-group-using-tags)
