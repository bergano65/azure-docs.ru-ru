...
1. В Visual Studio выберите **Создать проект**. В окне **Создание нового проекта**выберите **консольное приложение (.NET Framework)** , а затем нажмите кнопку **Далее**.
...
1. Нажмите кнопку **Обзор** и найдите и выберите **Microsoft. Azure. Devices**. Выберите пункт **Установить**.
...
1. Добавьте следующие поля в класс **Program** . Замените `{iot hub connection string}` строкой подключения центра Интернета вещей, скопированной в [поле получение строки подключения центра Интернета вещей](#get-the-iot-hub-connection-string).
...
1. Нажмите кнопку **Обзор** и найдите и выберите **Microsoft. Azure. Devices. Client**. Выберите пункт **Установить**.
...
1. В окне **Общие свойства** > **запускаемый проект**выберите **Несколько запускаемых проектов**. Для **ReportConnectivity**выберите **Запуск** в качестве **действия**. Нажмите кнопку **ОК** , чтобы сохранить изменения.  
