...
Конфигурации устройств для автоматического запуска в первый раз вскоре после создания конфигурации, а затем с интервалом в пять минут. Запросы метрик выполняться при каждом запуске конфигурации автоматического устройства.
