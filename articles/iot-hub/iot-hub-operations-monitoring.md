---
title: Операции центра Интернета вещей Azure monitoring (устаревшая версия) | Документация Майкрософт
...
ms.locfileid: "60345742"
---
# <a name="iot-hub-operations-monitoring-deprecated"></a>Операций центра Интернета вещей мониторинга (устаревшая версия)
...
1. Создайте Центр Интернета вещей. Вы найдете инструкции о том, как создать центр Интернета вещей в [приступить к работе](quickstart-send-telemetry-dotnet.md) руководства.
