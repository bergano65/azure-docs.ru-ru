...
> [!NOTE]
> При отправке задания, имена и значения свойств могут содержать только печатаемые US-ASCII буквы, цифры, за исключением тех, в следующем наборе: `$ ( ) < > @ , ; : \ " / [ ] ? = { } SP HT`
