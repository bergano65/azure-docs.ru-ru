...
Следующий фрагмент показывает запрос и ответ на задание, запланированное для вызова прямого метода под названием TestMethod на всех устройствах на contoso-hub-1:
...
> [!NOTE]
> Свойство *updateTwin* требует действительного соответствия etag; например, `etag="*"`.

Следующий фрагмент показывает запрос и ответ на задание, запланированное для обновления двойных свойств устройства для тест-устройства на contoso-hub-1:
...
| **тип** |Типы заданий: |
| | **scheduleUpdateTwin:** Задание, используемое для обновления набора желаемых свойств или тегов. |
| | **scheduleDeviceMethod**: Задание, используемое для выдвижения метода устройства на наборе близнецов устройств. |
...
| | **Свойства устройстваРаботаСтатистика:** |
...
* [Расписание и трансляция заданий](iot-hub-node-node-schedule-jobs.md)