...
ms.locfileid: "72809696"
---
# <a name="tutorial-using-azure-iot-hub-message-enrichments-preview"></a>Учебник. Использование дополнений сообщений центра Интернета вещей Azure (Предварительная версия)
...
2. Добавьте эти значения в список для конечной точки Контососторажеендпоинтенричед.
   ...
   | Name | Value | Конечная точка (раскрывающийся список) |
   | ---- | ----- | -------------------------|
