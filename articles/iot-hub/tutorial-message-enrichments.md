...
1. Выберите **Сохранить**. Откроется область **Настраиваемое развертывание** , в которой отображаются все параметры, используемые шаблоном. Единственное поле, которое необходимо задать, — **Группа ресурсов**. Создайте новый или выберите его из раскрывающегося списка.
