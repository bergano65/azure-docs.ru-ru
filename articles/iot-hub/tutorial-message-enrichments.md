...
1. Щелкните **Сохранить**. Панель **пользовательского развертывания** отображается и отображает все параметры, используемые шаблоном. Единственное поле, необходимое для установки, это **группа ресурсов.** Либо создайте новый, либо выберите один из списка выпадающих.
