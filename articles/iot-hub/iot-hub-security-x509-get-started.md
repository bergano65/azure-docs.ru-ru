...
1. Откройте Visual Studio, выберите **создать новый проект**, а затем выберите шаблон проекта **консольное приложение (.NET Framework)** . Нажмите **Далее**.
