...
1. Получив уведомление о том, что сертификат успешно отправлен, нажмите кнопку **сохранить**.
    ...
    ![Отправка сертификата](./media/iot-hub-security-x509-get-started/iot-hub-add-cert.png)  
