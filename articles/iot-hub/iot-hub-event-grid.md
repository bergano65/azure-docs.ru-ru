...
Если соединение с устройством вытекает, что означает, что устройство подключается и отключается часто, мы не будем отсылать каждое состояние одного подключения, но публикуют *Последнее* состояние соединения, которое в конечном итоге будет согласовываться. Например, если устройство изначально находится в состоянии подключено, то в течение нескольких секунд вы сможете установить соединение с помощью многофункционального соединения, а затем вернуться в состояние Connected (подключено). Новые события состояния подключения устройства не будут опубликованы после первоначального состояния соединения. 

В случае сбоя Центра Интернета вещей мы опубликуем состояние подключения устройства сразу же после того, как сбой будет устранен. Если устройство отключается во время этого сбоя, событие отключения устройства будет опубликовано в течение 10 минут.
