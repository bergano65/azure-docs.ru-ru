...
description: Сведения о проверенных наборах данных "Открытые наборы данных Azure" из общедоступного домена, например о погоде, переписи, праздниках и расположении, которые позволяют расширить возможности прогнозных решений.
...
[Открытые наборы данных Azure](https://azure.microsoft.com/services/open-datasets/) — это проверенные общедоступные наборы данных, которые можно использовать для добавления функций конкретных сценариев в решения машинного обучения для создания более точных моделей. Открытые наборы данных находятся в облаке Microsoft Azure, интегрированы в Машинное обучение Azure и доступны для Azure Databricks и Студии машинного обучения (классической). Кроме того, вы можете получать доступ к наборам данных с помощью интерфейсов API, а также использовать их в других продуктах, например в Power BI и Фабрике данных Azure.
...
Открытые наборы данных доступны в пользовательском интерфейсе Машинного обучения Azure и пакете SDK. Открытые наборы данных поддерживают службу "Записные книжки Azure" и записные книжки Azure Databricks, с помощью которых вы можете связывать данные с Машинным обучением Azure и Azure Databricks. Доступ к наборам данных также можно осуществлять с помощью пакета SDK для Python. 
...
* [Руководство. по моделированию регрессии с данными о такси Нью-Йорка](../machine-learning/tutorial-auto-train-models.md?context=azure%252fopen-datasets%252fcontext%252fopen-datasets-context)
* [Пакет SDK для Python для открытых наборов данных](/python/api/azureml-opendatasets/)
