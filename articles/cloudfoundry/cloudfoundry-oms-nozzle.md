...
В случае необходимости можно [создавать оповещения](../azure-monitor/platform/alerts-overview.md), настраивать запросы и пороговые значения. Ниже приведены рекомендуемые оповещения.
