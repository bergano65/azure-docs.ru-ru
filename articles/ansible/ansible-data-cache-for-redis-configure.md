---
title: Руководство. Настройка кэшей в Кэше Azure для Redis с помощью Ansible | Документация Майкрософт
description: Дополнительные сведения о том, как использовать Ansible для создания, масштабирования и перезапуска Кэша Azure для Redis
...
- [Загрузите сборник схем](https://github.com/Azure-Samples/ansible-playbooks/blob/master/rediscache.yml) и сохраните его в `rediscache.yml`.
- Создайте файл с именем `rediscache.yml` и скопируйте в него следующее:
