...
На [портале Azure](https://portol.azure.com) проверьте группу ресурсов, которую вы указали в `vars.yml`, чтобы просмотреть созданную виртуальную машину и различные ресурсы.
