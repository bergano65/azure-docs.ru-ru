---
title: Руководство. Настройка таблиц маршрутов Azure с помощью Ansible | Документация Майкрософт
description: Сведения о том, как создавать, изменять и удалять таблицы маршрутов Azure с помощью Ansible
