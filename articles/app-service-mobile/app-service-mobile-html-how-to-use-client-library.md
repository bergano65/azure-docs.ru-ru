...
Поддерживаются только текущие и последние версии основных браузеров:  Google Chrome, Microsoft Edge, Microsoft Internet Explorer и Mozilla Firefox.  Ожидается, что пакет SDK будет работать с любым относительно современным браузером.
...
## <a name="auth"></a>Практическое руководство. Аутентификация пользователей
