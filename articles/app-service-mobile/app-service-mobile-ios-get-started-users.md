---
title: Добавление аутентификации на iOS
description: Узнайте, как использовать мобильные приложения Azure для проверки подлинности пользователей вашего приложения iOS через поставщиков идентификационных данных, таких как AAD, Google, Facebook, Twitter и Microsoft.
...
## <a name="add-authentication-to-app"></a><a name="add-authentication"></a>Добавление проверки подлинности в приложение
**Цель-C**:
...
4. Откройте файл `QSAppDelegate.m` и добавьте в него следующий код.
   ...
   Добавьте этот код непосредственно перед строкой `#pragma mark - Core Data stack`.  Замените _имя приложения значением_ urlScheme, которое вы использовали в шаге 1.
...
3. Откройте файл `AppDelegate.swift` и добавьте следующую строку в класс `AppDelegate`.
    ...
    Замените _имя приложения значением_ urlScheme, которое вы использовали в шаге 1.
