---
title: Добавление аутентификации в приложение UWP
description: Узнайте, как использовать мобильные приложения Azure App Service для проверки подлинности пользователей приложения Universal Windows Platform (UWP) с помощью поставщиков идентификационных данных, таких как AAD, Google, Facebook, Twitter и Microsoft.
...
## <a name="register-your-app-for-authentication-and-configure-the-app-service"></a><a name="register"></a>Регистрация приложения для проверки подлинности и настройка службы приложений
...
1. На [портале Azure](https://ms.portal.azure.com) выберите свою службу приложений.
...
## <a name="add-authentication-to-the-app"></a><a name="add-authentication"></a>Добавление аутентификации в приложение
...
## <a name="store-the-authentication-token-on-the-client"></a><a name="tokens"></a>Сохранение токена проверки подлинности в клиенте
