...
## <a name="be-in-the-know"></a>Будьте в курсе
...
## <a name="keep-your-assets-safe"></a>Сохранение активов в безопасности
...
## <a name="ready-stage-go"></a>На старт! Внимание! Марш!
С помощью *службы приложений Azure* вы теперь можете создать несколько тестовых и промежуточных сред для своих мобильных приложений. Используйте их для тестирования перед развертыванием. В производственную стадию вы можете переходить без простоя. Веб-приложения загружаются автоматически, что позволяет обеспечить самые лучшие условия работы клиентов.
