---
title: Включить автономную синхронизацию (Xamarin. Forms) | Документация Майкрософт
...
Дополнительные сведения о функции автономной синхронизации см. в статье [Автономная синхронизация данных в мобильных приложениях Azure][2].
...
3. Используемых Просмотрите обновленные данные с помощью обозреватель объектов SQL Server или средства RESTFUL, например Fiddler или [POST][6]. Обратите внимание, что данные синхронизированы между базой данных в серверной части и локальным хранилищем.
...
* [Автономная Синхронизация данных в мобильных приложениях Azure][2]
