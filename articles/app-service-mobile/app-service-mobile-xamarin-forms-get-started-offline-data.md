---
title: Включить синхронизацию в автономном режиме (Xamarin.Forms) Документы Майкрософт
description: Узнайте, как использовать мобильное приложение App Service для кэша и синхронизации автономных данных в приложении Xamarin.Forms.
...
4. (Необязательно) В каждом проекте приложения Windows **ссылки** > справа на кнопку**добавляют ссылки...**, расширьте папку **Windows** > **расширения.**
