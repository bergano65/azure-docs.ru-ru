...
1. Запустите диспетчер конфигурации SQL Server 2014.
   ...
   и. Щелкните правой кнопкой мыши **SQL Server (SQLEXPRESS)** и выберите **Перезапустить**.
...
1. Войдите на [портал Azure].
1. В левом верхнем углу окна нажмите кнопку **+ создать** , > **Интернет и мобильные устройства** > **мобильное приложение**, а затем укажите имя серверной части мобильных приложений.
