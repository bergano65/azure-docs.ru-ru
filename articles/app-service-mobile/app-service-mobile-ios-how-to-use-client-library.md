...
В файле [`<WindowsAzureMobileServices/MSError.h>`][6] определены константы `MSErrorResponseKey`, `MSErrorRequestKey`и `MSErrorServerItemKey`. Вот как можно получить дополнительные данные об ошибке.
