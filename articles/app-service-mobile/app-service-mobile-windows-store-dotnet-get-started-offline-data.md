...
3. В обозреватель решений щелкните правой кнопкой мыши **ссылки** > **Добавить ссылку...** > **универсальные** **расширения**Windows >, а затем включите **SQLite для универсальная платформа Windows** и **Visual C++ 2015. Среда выполнения для приложений универсальная платформа Windows**.
