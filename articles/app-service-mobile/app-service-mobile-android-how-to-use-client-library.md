...
Сведения о создании дополнительных таблиц в серверной части мобильных приложений см. в разделе [Практическое руководство. Определите контроллер][15] таблиц (серверную часть .NET) или [Определите таблицы с помощью динамической схемы][16] (серверная часть Node. js).
...
* `String id`. глобальный уникальный идентификатор для записи.  Рекомендуется сделать идентификатор строковым представлением объекта [UUID][17] .
