---
title: Как использовать SDK для Android
...
ms.locfileid: "79249390"
---
# <a name="how-to-use-the-azure-mobile-apps-sdk-for-android"></a>Сведения об использовании пакета SDK для мобильных приложений Azure в клиенте Android.
...
* [Включить разрешение на использование Интернета](#enable-internet).

### <a name="update-the-gradle-build-file"></a><a name="gradle-build"></a>Обновление файла сборки Gradle

Измените оба файла **build.gradle** :

1. Добавьте этот код в файл уровня *Project* **build.gradle:**
...
### <a name="enable-internet-permission"></a><a name="enable-internet"></a>Включение разрешения INTERNET
...
## <a name="query-a-backend-table"></a><a name="query"></a>Запрос таблицы серверной части
...
### <a name="filtering-results"></a><a name="filter"></a> Фильтрация результатов
...
### <a name="sort-returned-data"></a><a name="sorting"></a>Сортировка возвращаемых данных
...
### <a name="select-specific-columns"></a><a name="selection"></a>Выбор определенных столбцов
...
### <a name="return-data-in-pages"></a><a name="paging"></a>Возврат данных на страницах
...
### <a name="how-to-concatenate-query-methods"></a><a name="chaining"></a>Практическое руководство. Объединение методов запросов
...
## <a name="bind-data-to-the-user-interface"></a><a name="binding"></a>Привязка данных к пользовательскому интерфейсу
...
#### <a name="define-the-layout"></a><a name="layout"></a>Определение макета
...
#### <a name="define-the-adapter"></a><a name="adapter"></a>Определение адаптера
...
#### <a name="use-the-adapter-to-bind-to-the-ui"></a><a name="use-adapter"></a>Привязка данных к пользовательскому интерфейсу с помощью адаптера
...
## <a name="insert-data-into-the-backend"></a><a name="inserting"></a>Вставка данных в серверную часть
...
## <a name="update-data-in-a-mobile-app"></a><a name="updating"></a>Обновление данных в мобильном приложении
...
## <a name="delete-data-in-a-mobile-app"></a><a name="deleting"></a>Удаление данных в мобильном приложении
...
## <a name="look-up-a-specific-item-by-id"></a><a name="lookup"></a>Поиск определенного элемента по идентификатору
...
## <a name="how-to-work-with-untyped-data"></a><a name="untyped"></a>Практическое руководство. Работа с нетипизированными данными
...
### <a name="create-an-instance-of-an-untyped-table"></a><a name="json_instance"></a>Создание экземпляра нетипизированной таблицы
...
### <a name="insert-into-an-untyped-table"></a><a name="json_insert"></a>Вставка данных в нетипизированную таблицу
...
```
### <a name="delete-from-an-untyped-table"></a><a name="json_delete"></a>Удаление данных из нетипизированной таблицы
...
### <a name="return-all-rows-from-an-untyped-table"></a><a name="json_get"></a>Получение всех строк из нетипизированной таблицы
...
## <a name="implement-offline-sync"></a><a name="offline-sync"></a>Реализация синхронизации в автономном режиме
...
## <a name="call-a-custom-api"></a><a name="custom-api"></a>Вызов настраиваемого интерфейса API
...
## <a name="add-authentication-to-your-app"></a><a name="authentication"></a>Добавление проверки подлинности в приложение
...
### <a name="authentication-server-flow"></a><a name="caching"></a>Серверный поток проверки подлинности
...
### <a name="cache-authentication-tokens"></a><a name="caching"></a>Кэширование маркеров аутентификации
...
### <a name="use-refresh-tokens"></a><a name="refresh"></a>Использование токенов обновления
...
### <a name="authenticate-users-with-the-active-directory-authentication-library-adal"></a><a name="adal"></a>Проверка подлинности пользователей с помощью библиотеки проверки подлинности Active Directory (ADAL)
...
1. Настройте серверную часть мобильного приложения для входа с помощью AAD, следуя указаниям в учебнике [Настройка приложения службы приложений для использования службы входа Azure Active Directory][22] . Обязательно выполните дополнительный этап регистрации собственного клиентского приложения.
...
## <a name="adjust-the-client-server-communication"></a><a name="filters"></a>Настройка связи между клиентом и сервером
...
### <a name="configure-automatic-serialization"></a><a name="conversions"></a>Настройка автоматической сериализации
