...
description: Концептуальная ссылка и обзор функции аутентификации /авторизации для службы приложений Azure, специально для мобильных приложений.
ms.topic: article
ms.date: 10/01/2016
...
* [Добавление аутентификации в ваше приложение для Android][Android]
...
* [Добавление аутентификации в приложение Cordova][Cordova]
