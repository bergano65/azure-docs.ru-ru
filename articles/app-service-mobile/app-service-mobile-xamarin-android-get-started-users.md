---
title: Начало работы с проверкой подлинности в Xamarin Android
description: Узнайте, как использовать мобильные приложения для проверки подлинности пользователей приложения Xamarin Android с помощью поставщиков удостоверений, таких как AAD, Google, Facebook, Twitter и Майкрософт.
