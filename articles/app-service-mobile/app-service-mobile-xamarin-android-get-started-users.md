---
title: Начало работы с аутентификацией в Xamarin Android
description: Узнайте, как использовать мобильные приложения для проверки подлинности пользователей вашего приложения Xamarin Android с помощью поставщиков идентификационных данных, таких как AAD, Google, Facebook, Twitter и Microsoft.
...
## <a name="register-your-app-for-authentication-and-configure-app-services"></a><a name="register"></a>Регистрация приложения для проверки подлинности и настройка служб приложений
