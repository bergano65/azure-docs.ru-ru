...
Если ваше приложение использует решение для настраиваемой проверки подлинности, необходимо убедиться, что обновленный сайт имеет доступ к системе. Инструкции по интеграции решения см. в статье [Обзор пакета SDK для сервера .NET]. Обратите внимание, что компоненты настраиваемой проверки подлинности все еще находятся на стадии предварительной версии.
