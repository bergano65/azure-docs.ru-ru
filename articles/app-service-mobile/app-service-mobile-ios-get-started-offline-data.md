...
| дата создания | Date | (необязательно) Сопоставляется с системным свойством **createdAt** |
| дата обновления | Date | (необязательно) Сопоставляется с системным свойством **updatedAt** |
