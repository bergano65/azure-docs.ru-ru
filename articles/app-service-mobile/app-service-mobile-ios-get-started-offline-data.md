...
| текст |String |Поле элемента списка дел |
...
| version | String | (необязательно) Используется для обнаружения конфликтов, сопоставляется со свойством version |
...
* [Облачное покрытие: автономная синхронизация в мобильных службах Azure] \(видео о мобильных службах, но автономная синхронизация мобильных приложений работает аналогичным образом.\)
