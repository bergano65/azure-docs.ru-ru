---
title: Добавление push-уведомлений в приложение Xamarin.Forms
...
2. Добавьте учетную запись Google на устройство Android, нажав на**учетную запись** **Apps** > **Settings** > Add. Затем следуйте указаниям в отображаемых запросах, чтобы добавить на устройство имеющуюся учетную запись Google или создать новую.
...
5. В приложении введите задачу, а**+** затем нажмите на значок plus () .
...
3. В приложении введите задачу, а**+** затем нажмите на значок plus () .
...
2. Нажмите кнопку **Run,** чтобы построить проект и запустить приложение.
3. В приложении введите имя для нового тодоита,**+** а затем нажмите на значок plus () для его добавления.
