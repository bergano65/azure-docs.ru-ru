---
title: Версия SDK клиента и сервера
description: Список клиентских SDK и совместимость с серверными версиями SDK для мобильных сервисов и мобильных приложений Azure.
...
## <a name="azure-mobile-apps-client-and-server"></a><a name="2.0.0"></a>Клиент и сервер мобильных приложений Azure
### <a name="mobile-apps-client-sdks"></a><a name="MobileAppsClients"></a>Мобильные *приложения* клиент SDKs
