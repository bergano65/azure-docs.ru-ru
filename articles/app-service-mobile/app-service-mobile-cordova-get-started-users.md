---
title: Добавление аутентификации на Apache Cordova
description: Узнайте, как использовать мобильные приложения в службе приложений Azure для проверки подлинности пользователей приложения Apache Cordova с помощью поставщиков идентификационных данных, таких как Google, Facebook, Twitter и Microsoft.
...
[Нажмите Уведомления]: app-service-mobile-cordova-get-started-push.md
[Об аутентификации]: app-service-mobile-auth.md
[Использование клиентской библиотеки Apache Cordova для мобильных приложений Azure]: app-service-mobile-cordova-how-to-use-client-library.md
