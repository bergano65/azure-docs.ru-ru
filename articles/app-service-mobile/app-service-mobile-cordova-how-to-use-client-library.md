---
title: Как использовать Apache Cordova Plugin
...
## <a name="setting-up-an-ionic-v2-app"></a><a name="ionic"></a>Настройка приложения Ionic v2
...
7. Найдите элемент "allowedExternalRedirectUrls".  Ему может быть присвоено значение NULL или массив значений.  Измените его значение на следующее:
    ...
    Замените URL-адреса на URL-адреса службы.  Примеры `http://localhost:3000` включают (для службы образца `http://localhost:4400` Node.js), или (для службы Ripple).  Это только примеры URL-адресов. Ваша ситуация, включая упомянутые в приведенных примерах службы, может быть совершенно другой.
...
## <a name="how-to-register-for-push-notifications"></a><a name="register-for-push"></a>Практическое руководство. Регистрация для получения push-уведомлений
