---
title: Добавить push-уведомления в приложение Xamarin.iOS
description: Узнайте, как использовать службу приложений Azure для отправки push-уведомлений в приложение Xamarin.iOS.
...
2. В приложении введите задачу, а**+** затем нажмите на значок plus () .
3. Убедитесь, что уведомление получено, а затем нажмите **OK,** чтобы отклонить уведомление.
