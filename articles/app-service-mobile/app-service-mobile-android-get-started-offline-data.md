---
title: Включить синхронизацию в автономном режиме (Android)
description: Узнайте, как использовать мобильные приложения Службы App для кэша и синхронизации автономных данных в приложении Android.
...
3. Просмотрите содержимое таблицы Azure *TodoItem* с помощью инструмента SQL, например *SQL Server Management Studio* или с помощью клиента REST, например *Fiddler* или *Postman*. Проверить, что новые элементы *не* были синхронизированы с сервером
...
[Создание приложения для Android]: app-service-mobile-android-get-started.md
