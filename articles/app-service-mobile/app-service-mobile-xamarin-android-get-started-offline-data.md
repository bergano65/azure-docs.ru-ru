---
title: Включить синхронизацию в автономном режиме (Xamarin Android)
description: Узнайте, как использовать мобильное приложение App Service для кэша и синхронизации автономных данных в приложении Xamarin Android.
...
3. В Visual Studio нажмите клавишу **F5** , чтобы выполнить сборку и запустить клиентское приложение. Приложение работает так же, как и до включения синхронизации в автономном режиме. Однако локальная база данных теперь заполнена данными, которые могут быть использованы в автономном сценарии.
