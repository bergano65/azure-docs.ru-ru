...
> [!IMPORTANT]
> Пожалуйста, используйте [разъем SFTP-SSH,](../connectors/connectors-sftp-ssh.md) как разъем SFTP утихает. Вы больше не можете выбрать триггеры sFTP и действия в Logic App Designer.
...
Разъем SFTP обрабатывает только файлы, которые *50 МБ или меньше,* и не поддерживает [сообщение chunking.](../logic-apps/logic-apps-handle-large-messages.md) Для больших файлов используйте [разъем SFTP-SSH.](../connectors/connectors-sftp-ssh.md) Для различия между разъемом SFTP и разъемом SFTP-SSH, просмотрите [Сравните SFTP-SSH по сравнению с SFTP](../connectors/connectors-sftp-ssh.md#comparison) в статье SFTP-SSH.
