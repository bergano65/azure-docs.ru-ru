...
> [!NOTE]
> Для файлов размером от 50 МБ и до 1 ГБ используйте [соединитель SFTP-SSH](../connectors/connectors-sftp-ssh.md). Соединитель SFTP поддерживает только файлы размером 50 МБ или меньше, если вы не используете [Блокирование обработки больших сообщений](../logic-apps/logic-apps-handle-large-messages.md). 
