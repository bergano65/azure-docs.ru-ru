---
title: Подключиться к учетной записи SFTP - Azure Logic Apps
...
Соединитель SFTP обрабатывает только файлы, которые являются *50 МБ или меньше* и не поддерживает [фрагментацию сообщения](../logic-apps/logic-apps-handle-large-messages.md). Файлы большего размера, используйте [соединитель SFTP-SSH](../connectors/connectors-sftp-ssh.md). Различия между соединитель SFTP и соединитель SFTP-SSH, просмотрите [сравнения SFTP-SSH и SFTP](../connectors/connectors-sftp-ssh.md#comparison) в статье SFTP-SSH.
