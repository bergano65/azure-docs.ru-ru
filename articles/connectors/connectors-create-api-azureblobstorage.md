...
1. В рабочем процессе приложения логики добавьте и настройте действие HTTP или триггер для доступа к учетной записи хранения или сущности.
   ...
   > [!IMPORTANT]
   > Для исходящих вызовов HTTP-действий или триггеров в учетные записи хранения Azure убедитесь, что заголовок `x-ms-version` запроса содержит свойство и версию API для операции, которую требуется выполнить в учетной записи хранения. Дополнительные сведения см. в статье [Аутентификация доступа с помощью управляемого удостоверения](../logic-apps/create-managed-service-identity.md#authenticate-access-with-managed-identity) и [управления версиями для служб хранилища Azure](https://docs.microsoft.com/rest/api/storageservices/versioning-for-the-azure-storage-services#specifying-service-versions-in-requests).
