...
> [!NOTE]
> Соединитель FTP поддерживает только файлы размером 50 МБ или меньше, если вы не используете [фрагментацию сообщений в действиях](../logic-apps/logic-apps-handle-large-messages.md). В настоящее время нельзя использовать фрагментацию для триггеров.
>
