...
1. Для пустых приложений логики в поле поиска введите `ftp` в качестве фильтра. В списке **триггеры** выберите нужный триггер.
...
1. Для пустых приложений логики в поле поиска введите `ftp` в качестве фильтра. В списке триггеры выберите этот триггер: **при добавлении или изменении архивирования (только свойства)** .
...
1. В поле **Папка** выберите значок папки, чтобы появился список. Чтобы найти эту папку, чтобы отслеживать для новых или измененных файлов, щелкните кнопку со стрелкой вправо ( **>** ), перейдите к этой папке и выберите ее.
