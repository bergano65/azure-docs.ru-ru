...
| Действие | Описание |
|--------|-------------|
| **Получение оповещений** | Получение предупреждений, отфильтрованных на основе одного или нескольких [свойств предупреждения](https://docs.microsoft.com/graph/api/resources/alert), например `Provider eq 'Azure Security Center' or 'Palo Alto Networks'` . | 
