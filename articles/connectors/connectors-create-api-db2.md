...
| **Server** | Да | Адрес или псевдоним, двоеточие и номер порта для сервера DB2, например myDB2server.cloudapp.net:50000 <p><p>**Примечание**. Это значение является строкой, которая представляет адрес TCP/IP или псевдоним, либо в формате IPv4 или IPv6, а затем двоеточие и номер порта TCP/IP. |
| **База данных** | Да | Имя базы данных <p><p>**Примечание**. Это значение является строка, представляющая реляционной базы данных имя DRDA (RDBNAM): <p>– DB2 для z/OS принимает 16-байтовую строку, если база данных известна как расположение "IBM DB2 для z/OS". <br>– DB2 для i принимает 18-байтовую строку, если база данных известна как реляционная база данных "IBM DB2 для i". <br>– DB2 для LUW принимает в качестве значения 8-байтовую строку. |
| **Имя пользователя** | Да | Имя пользователя для базы данных <p><p>**Примечание**. Это значение является строкой, длина которого зависит от конкретной базы данных: <p><p>– DB2 для z/OS принимает 8-байтовую строку. <br>– DB2 для i принимает 10-байтовую строку. <br>– DB2 для Linux или UNIX принимает 8-байтовую строку. <br>– DB2 для Windows принимает 30-байтовую строку. |
...
| **Имя подключения** | Да | Имя подключения, например MyLogicApp-DB2-connection | 
| **Server** | Да | Адрес или псевдоним, двоеточие и номер порта для сервера DB2, например myDB2server:50000 <p><p>**Примечание**. Это значение является строкой, которая представляет адрес TCP/IP или псевдоним, либо в формате IPv4 или IPv6, а затем двоеточие и номер порта TCP/IP. |
| **База данных** | Да | Имя базы данных <p><p>**Примечание**. Это значение является строка, представляющая реляционной базы данных имя DRDA (RDBNAM): <p>– DB2 для z/OS принимает 16-байтовую строку, если база данных известна как расположение "IBM DB2 для z/OS". <br>– DB2 для i принимает 18-байтовую строку, если база данных известна как реляционная база данных "IBM DB2 для i". <br>– DB2 для LUW принимает в качестве значения 8-байтовую строку. |
| **Проверка подлинности** | Да | Тип проверки подлинности для подключения, например "Обычная" <p><p>**Примечание**. Выберите это значение из списка, которая включает в себя Basic или Windows (Kerberos). |
| **Имя пользователя** | Да | Имя пользователя для базы данных <p><p>**Примечание**. Это значение является строкой, длина которого зависит от конкретной базы данных: <p><p>– DB2 для z/OS принимает 8-байтовую строку. <br>– DB2 для i принимает 10-байтовую строку. <br>– DB2 для Linux или UNIX принимает 8-байтовую строку. <br>– DB2 для Windows принимает 30-байтовую строку. |
| **Пароль** | Да | Пароль для базы данных |
| **Шлюз** | Да | Имя установленного локального шлюза данных <p><p>**Примечание**. Выберите это значение из списка, который включает все шлюзы данных, установленных в подписку Azure и группы ресурсов. |
||||
