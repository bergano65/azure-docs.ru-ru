---
title: Подключение к IBM DB2 — Azure Logic Apps
...
|--------------------|------------------|
| создание списка таблиц базы данных; | Получить таблицы |
| чтение одной строки с помощью инструкции SELECT; | Получить строку |
| чтение всех строк с помощью инструкции SELECT; | Получить строки |
| добавление одной строки с помощью инструкции INSERT; | Вставить строку |
...
1. В поле поиска введите слово db2 в качестве фильтра. Для этого примера в списке действия выберите это действие: **Получить таблицы (Предварительная версия)**
...
| **Server** | Да | Адрес или псевдоним, двоеточие и номер порта для сервера DB2, например myDB2server.cloudapp.net:50000 <p><p>**Примечание**. Это значение представляет собой строку, представляющую TCP/IP-адрес или псевдоним в формате IPv4 или IPv6, за которым следует двоеточие и номер порта TCP/IP. |
| **База данных** | Да | Имя базы данных <p><p>**Примечание**. Это значение представляет собой строку, представляющую имя реляционной базы данных DRDA (RDBNAM): <p>– DB2 для z/OS принимает 16-байтовую строку, если база данных известна как расположение "IBM DB2 для z/OS". <br>– DB2 для i принимает 18-байтовую строку, если база данных известна как реляционная база данных "IBM DB2 для i". <br>– DB2 для LUW принимает в качестве значения 8-байтовую строку. |
| **Имя пользователя** | Да | Имя пользователя для базы данных <p><p>**Примечание**. Это значение представляет собой строку, длина которой зависит от конкретной базы данных: <p><p>– DB2 для z/OS принимает 8-байтовую строку. <br>– DB2 для i принимает 10-байтовую строку. <br>– DB2 для Linux или UNIX принимает 8-байтовую строку. <br>– DB2 для Windows принимает 30-байтовую строку. |
...
| **Имя подключения** | Да | Имя подключения, например MyLogicApp-DB2-connection | 
| **Server** | Да | Адрес или псевдоним, двоеточие и номер порта для сервера DB2, например myDB2server:50000 <p><p>**Примечание**. Это значение представляет собой строку, представляющую TCP/IP-адрес или псевдоним в формате IPv4 или IPv6, за которым следует двоеточие и номер порта TCP/IP. |
| **База данных** | Да | Имя базы данных <p><p>**Примечание**. Это значение представляет собой строку, представляющую имя реляционной базы данных DRDA (RDBNAM): <p>– DB2 для z/OS принимает 16-байтовую строку, если база данных известна как расположение "IBM DB2 для z/OS". <br>– DB2 для i принимает 18-байтовую строку, если база данных известна как реляционная база данных "IBM DB2 для i". <br>– DB2 для LUW принимает в качестве значения 8-байтовую строку. |
| **Authentication** | Да | Тип проверки подлинности для подключения, например "Обычная" <p><p>**Примечание**. Выберите это значение из списка, включающего Basic или Windows (Kerberos). |
| **Имя пользователя** | Да | Имя пользователя для базы данных <p><p>**Примечание**. Это значение представляет собой строку, длина которой зависит от конкретной базы данных: <p><p>– DB2 для z/OS принимает 8-байтовую строку. <br>– DB2 для i принимает 10-байтовую строку. <br>– DB2 для Linux или UNIX принимает 8-байтовую строку. <br>– DB2 для Windows принимает 30-байтовую строку. |
| **Пароль** | Да | Пароль для базы данных |
| **Шлюз** | Да | Имя установленного локального шлюза данных <p><p>**Примечание**. Выберите это значение из списка, включая все установленные шлюзы данных в подписке Azure и группе ресурсов. |
||||
...
## <a name="get-row"></a>Получить строку
...
1. Укажите значения для всех обязательных свойств (*). После выбора таблицы это действие показывает соответствующие свойства записей из этой таблицы.
   ...
   ![Выберите таблицу.](./media/connectors-create-api-db2/db2-get-row-action-select-table.png)
...
## <a name="get-rows"></a>Получить строки
...
1. Откройте список **Имя таблицы** и выберите нужную таблицу (в этом примере — "AREA"):
   ...
   ![Выберите таблицу.](./media/connectors-create-api-db2/db2-get-rows-action-select-table.png)
...
## <a name="insert-row"></a>Вставить строку
...
1. Укажите значения для всех обязательных свойств (*). После выбора таблицы это действие показывает соответствующие свойства записей из этой таблицы.
   ...
   ![Выберите таблицу.](./media/connectors-create-api-db2/db2-insert-row-action-select-table.png)
...
## <a name="update-row"></a>Изменить строку
...
1. Укажите значения для всех обязательных свойств (*). После выбора таблицы это действие показывает соответствующие свойства записей из этой таблицы.
   ...
   ![Выберите таблицу.](./media/connectors-create-api-db2/db2-update-row-action-select-table.png)
...
## <a name="delete-row"></a>Удалить строку
...
1. Укажите значения для всех обязательных свойств (*). После выбора таблицы это действие показывает соответствующие свойства записей из этой таблицы.
   ...
   ![Выберите таблицу.](./media/connectors-create-api-db2/db2-delete-row-action-select-table.png)
...
Для получения технических сведений, таких как триггеры, действия и ограничения, как описано в файле OpenAPI (ранее Swagger) соединителя, см. [страницу справочника](/connectors/db2/)по соединителю.
