---
title: Подключение к Twitter из Azure Logic Apps
...
**Пример Enterprise**. Этот триггер можно использовать для мониторинга твитов о вашей компании и передачи содержимого твитов в базу данных SQL.
