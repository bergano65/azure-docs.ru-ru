---
title: Подключение к SMTP из приложений логики Azure
...
1. При появлении запроса введите эти сведения о подключении:
   ...
   | **Включить SSL?** | нет | Включите или выключите шифрование TLS/SSL. | 
   |||| 
...
Для получения более подробной информации об этом разъеме, таких как триггеры, действия и ограничения, описанные в файле Swagger разъема, смотрите [страницу ссылки разъема.](https://docs.microsoft.com/connectors/smtpconnector/)
