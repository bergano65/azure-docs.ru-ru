...
1. Для пустых приложений логики в поле поиска введите `sftp ssh` в качестве фильтра. В списке триггеров выберите нужный триггер.
...
1. В разделе **Перемещение содержимого**в свойстве **Размер фрагмента** введите целое значение от `5` к `50`, например: 
