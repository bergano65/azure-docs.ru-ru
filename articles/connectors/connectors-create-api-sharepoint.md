---
title: Подключение к SharePoint из Azure Logic Apps
...
## <a name="connect-to-sharepoint"></a>Подключение к сайту SharePoint
...
1. Когда вам будет предложено войти в систему, укажите необходимые сведения о подключении. Если вы используете SharePoint Server, убедитесь, что выбрано **подключение через локальный шлюз данных**. Когда все будет готово, выберите **Создать**.
