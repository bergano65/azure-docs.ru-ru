---
title: Подключение к SharePoint из приложений логики Azure
...
1. Когда вам будет предложено войти в систему, укажите необходимые сведения о подключении. Если вы используете SharePoint Server, убедитесь, что вы выбираете **Connect через шлюз данных.** Когда все будет готово, выберите **Создать**.
