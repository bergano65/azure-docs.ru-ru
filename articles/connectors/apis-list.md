...
* [Создайте свое первое приложение логики](../logic-apps/quickstart-create-first-logic-app-workflow.md)
* [Создание настраиваемых соединителей для приложений логики](https://docs.microsoft.com/connectors/custom-connectors/)
