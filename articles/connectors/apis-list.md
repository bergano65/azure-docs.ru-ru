...
:::row:::
    :::column:::
        [![Значок API ][biztalk-server-icon]<br> **BizTalk** <br> **Server**][biztalk-server-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][file-system-icon]<br> **Файловая <br> система**][file-system-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][ibm-db2-icon]<br> **IBM DB2**][ibm-db2-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][ibm-informix-icon]<br> **IBM** <br> **Informix**][ibm-informix-doc]
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
        [![Значок API ][mysql-icon]<br> **MySQL**][mysql-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][oracle-db-icon]<br> **Oracle DB**][oracle-db-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][postgre-sql-icon]<br> **PostgreSQL**][postgre-sql-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][sharepoint-server-icon]<br> **SharePoint <br> Server**][sharepoint-server-doc]
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
        [![Значок API ][sql-server-icon]<br> **SQL <br> Server**][sql-server-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][teradata-icon]<br> **Teradata**][teradata-doc]
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        [![Значок API ][as2-icon]<br> ** <br> декодирование AS2**][as2-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][as2-icon]<br> ** <br> кодирование AS2**][as2-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][edifact-icon]<br> ** <br> декодирование EDIFACT**][edifact-decode-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][edifact-icon]<br> **EDIFACT <br> Encoding**][edifact-encode-doc]
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
        [![Значок API ][flat-file-decode-icon]<br> ** <br> декодирование неструктурированного файла**][flat-file-decode-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][flat-file-encode-icon]<br> ** <br> Кодировка неструктурированного файла**][flat-file-encode-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][integration-account-icon]<br> ** <br> учетная запись интеграции**][integration-account-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][liquid-icon]<br> **преобразования жидкостей** <br> **transforms**][json-liquid-transform-doc]
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
        [![Значок API ][x12-icon]<br> ** <br> декодирование X12**][x12-decode-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][x12-icon]<br> **X12 <br> Encoding**][x12-encode-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][xml-transform-icon]<br> **преобразования XML-кода** <br> **transforms**][xml-transform-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][xml-validate-icon]<br> ** <br> Проверка XML**][xml-validate-doc]
    :::column-end:::
:::row-end:::
...
:::row:::
    :::column:::
        [![Значок API ][ibm-3270-icon]<br> **IBM 3270**][ibm-3270-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][ibm-mq-icon]<br> **IBM MQ**][ibm-mq-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][sap-icon]<br> **SAP**][sap-connector-doc]
    :::column-end:::
    :::column:::
...
:::row:::
    :::column:::
        [![Значок API ][as2-icon]<br> **AS2**][as2-doc]
    :::column-end:::
    :::column:::
        [![Значок API Служба ][azure-automation-icon]<br> ** <br> автоматизации Azure**][azure-automation-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][azure-blob-storage-icon]<br> ** <br> хранилище BLOB-объектов Azure**][azure-blob-storage-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][azure-cosmos-db-icon]<br> **Azure Cosmos <br> DB**][azure-cosmos-db-doc]
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
        [![Значок API ][azure-event-hubs-icon]<br> ** <br> концентраторы событий Azure**][azure-event-hubs-doc]
    :::column-end:::
    :::column:::
        [![Значок API служба " ][azure-event-grid-icon]<br> ** <br> Сетка событий Azure** "][azure-event-grid-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][azure-file-storage-icon]<br> ** <br> хранилище файлов Azure**][azure-file-storage-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][azure-key-vault-icon]<br> ** <br> хранилище ключей Azure**][azure-key-vault-doc]
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
        [![Значок API ][azure-monitor-logs-icon]<br> **Azure Monitor <br> журналы**][azure-monitor-logs-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][azure-service-bus-icon]<br> **служебная <br> шина Azure**][azure-service-bus-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][azure-sql-data-warehouse-icon]<br> ** <br> хранилище данных SQL Azure**][azure-sql-data-warehouse-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][azure-table-storage-icon]<br> ** <br> хранилище таблиц Azure**][azure-table-storage-doc]
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
        [![Значок API ][azure-queues-icon]<br> ** <br> очереди Azure**][azure-queues-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][edifact-icon]<br> **EDIFACT**][edifact-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][file-system-icon]<br> **Файловая <br> система**][file-system-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][ftp-icon]<br> **FTP**][ftp-doc]
    :::column-end:::
:::row-end:::
:::row:::
    :::column:::
...
:::row:::
    :::column:::
        [![Значок API ][sftp-ssh-icon]<br> **SFTP-SSH**][sftp-ssh-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][smtp-icon]<br> **SMTP**][smtp-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][sql-server-icon]<br> **SQL <br> Server**][sql-server-doc]
    :::column-end:::
    :::column:::
        [![Значок API ][x12-icon]<br> **X12**][x12-doc]
    :::column-end:::
:::row-end:::
