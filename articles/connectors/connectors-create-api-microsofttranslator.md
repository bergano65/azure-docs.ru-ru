---
title: Подключение к Microsoft Translator с помощью Azure Logic Apps | Документация Майкрософт
description: Переводите тексты и выполняйте другие лингвистические задачи с помощью интерфейсов REST API Microsoft Translator и Azure Logic Apps.
author: ecfan
manager: jeconnoc
ms.author: estfan
ms.date: 11/07/2016
...
Информацию о существующих ограничениях, а также о триггерах и действиях, определенных в Swagger, см. в статье со [сведениями о соединителях](/connectors/microsofttranslator/).
