...
1. В триггере предоставляют сведения о концентратора событий, который вы хотите отслеживать. Дополнительные свойства, откройте **добавьте параметр** списка. Выбор параметра добавляет это свойство на карточке триггера.
   ...
   |----------|----------|-------------|
   | **Имя концентратора событий** | Да | Имя для концентратора событий, который вы хотите отслеживать |
   ...
   | **Интервал** | Да | Положительное целое число, которое описывает, как часто выполняется рабочий процесс на основе частоты |
...
1. В действии предоставляют сведения о событиях, которые вы хотите отправить. Дополнительные свойства, откройте **добавьте параметр** списка. Выбор параметра добавляет свойства карточка действия.
   ...
   | Свойство | Обязательно для заполнения | Описание |
   |----------|----------|-------------|
   | **Имя концентратора событий** | Да | Концентратор событий, где вы хотите отправить событие |
