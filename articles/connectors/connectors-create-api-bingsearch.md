...
Или, если подключение уже существует, введите необходимые сведения для триггера.
   ...
   | Смещение | Нет | <*skip-value*> | Количество пропускаемых результатов перед возвращением результатов |
   |||||
...
2. В разделе триггер или действие выберите **новый шаг** > **Добавить действие**.
   ...
   **Поиск Bing в новой статье новостей**
   ...
   ![Добавить действие](./media/connectors-create-api-bing-search/add-action.png)
...
Для получения технических сведений, таких как триггеры, действия и ограничения, как описано в файле OpenAPI (ранее Swagger) соединителя, см. [страницу справочника](/connectors/bingsearch/)по соединителю.
