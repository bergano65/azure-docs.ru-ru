...
1. В разделе триггер или действие, в которое необходимо добавить действие SQL, выберите **новый шаг**.
   ...
   ![Выберите "новый шаг".](./media/connectors-create-api-sqlazure/select-new-step-logic-app.png)
...
1. В разделе **выберите действие**в поле поиска введите "SQL Server" в качестве фильтра. В списке действия выберите нужное действие SQL.
   ...
   ![Поиск и выбор действия "получить строку" SQL](./media/connectors-create-api-sqlazure/select-sql-get-row.png)
...
Технические сведения о триггерах, действиях и ограничениях этого соединителя см. на [странице справочника по соединителю](/connectors/sql/).
