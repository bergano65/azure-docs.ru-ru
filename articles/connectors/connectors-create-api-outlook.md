...
С помощью [Azure Logic Apps](../logic-apps/logic-apps-overview.md) и [соединителя Outlook.com](/connectors/outlook/)можно создавать автоматизированные задачи и рабочие процессы, которые управляют учетной записью @outlook.com или @hotmail.com путем создания приложений логики. Например, вы Автоматизируйте следующие задачи:
...
> [!NOTE]
> Чтобы автоматизировать задачи для рабочей учетной записи Майкрософт, например @fabrikam.onmicrosoft.com, используйте [соединитель Office 365 Outlook](../connectors/connectors-create-api-office365-outlook.md).
