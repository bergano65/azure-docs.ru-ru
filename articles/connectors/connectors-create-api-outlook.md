...
С помощью [Azure Logic Apps](../logic-apps/logic-apps-overview.md) и [соединителя Outlook.com](/connectors/outlook/)можно создавать автоматизированные задачи и рабочие процессы, управляющие @outlook.com учетной записью или @hotmail.com с помощью создания приложений логики. Например, вы Автоматизируйте следующие задачи:
