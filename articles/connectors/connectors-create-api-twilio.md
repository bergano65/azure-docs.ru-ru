---
title: Подключение к Twilio из приложений логики Azure
...
1. Предоставьте необходимые сведения для подключения, а затем выберите **Создать:**
