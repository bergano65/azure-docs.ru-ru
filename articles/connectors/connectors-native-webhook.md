...
> [!NOTE]
> Logic Apps обеспечивает безопасность транспортного уровня (TLS) 1,2 при получении вызова к триггеру или действию веб-перехватчика HTTP. Если вы видите ошибки подтверждения TLS, убедитесь, что используется TLS 1,2. Для входящих вызовов поддерживаются следующие наборы шифров:
>
