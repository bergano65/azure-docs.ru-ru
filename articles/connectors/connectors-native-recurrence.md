...
1. После появления конструктора приложений логики в поле поиска введите `recurrence` в качестве фильтра. В списке триггеры выберите этот триггер в качестве первого шага в рабочем процессе приложения логики: **повторение**
...
1. Задайте интервал повторения и единицу времени. В этом примере задайте запуск рабочего процесса каждый день.
   ...
   | Свойство | Имя JSON | Обязательно для заполнения | Тип | Description |
   |----------|-----------|----------|------|-------------|
