...
| ИМЯ | Обязательно для заполнения | Имя свойства | type | ОПИСАНИЕ | 
|----- | -------- | ------------- | ---- | ----------- | 
| **Frequency** | Yes | frequency | Строка | Единица измерения времени, используемая для повторения: **Second** (секунда), **Minute** (минута), **Hour** (час), **Day** (день), **Week** (неделя) или **Month** (месяц). | 
