...
Этот встроенный триггер создает конечную точку HTTPS, вызываемую вручную, которая может принимать *только* Входящие HTTPS-запросы. Когда происходит это событие, триггер срабатывает и запускает приложение логики.
