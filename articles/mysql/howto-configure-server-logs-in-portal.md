---
title: Настройка и доступ к журналам запросов для базы данных Azure для MySQL в портал Azure
...
ms.locfileid: "71703443"
---
# <a name="configure-and-access-slow-query-logs-in-the-azure-portal"></a>Настройка и доступ к журналам запросов с высокой производительностью в портал Azure
