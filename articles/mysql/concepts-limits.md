...
- Системные базы данных. в базе данных Azure для MySQL [системная база данных MySQL](https://dev.mysql.com/doc/refman/8.0/en/system-schema.html) доступна только для чтения, так как она используется для поддержки различных функций службы PaaS. Обратите внимание, что в `mysql` системной базе данных нельзя изменить ничего.
