...
- Кроме того, можно перейти на хранилище общего назначения, которое поддерживает хранилище объемом до 16 ТБ, если базовая инфраструктура хранилища доступна в предпочтительных [регионах Azure](./concepts-pricing-tiers.md#storage). Дополнительные затраты на хранилище общего назначения, поддерживающее хранилище объемом до 16 ТБ, не взимается. Чтобы получить помощь при миграции на хранилище размером 16 ТБ, отправьте запрос в службу поддержки портал Azure.
