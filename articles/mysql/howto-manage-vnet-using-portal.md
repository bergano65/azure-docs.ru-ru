---
title: Управление конечными точками VNet - Портал Azure - База данных Azure для MyS'L
...
> [!Important]
> Если вы оставите набор управления В ON, ваш сервер базы данных Azure MyS'L принимает сообщение из любой подсети. что сделает доступ слишком незащищенным. Функция конечной точки службы Microsoft Azure Virtual Network в координации с функцией виртуального сетевого правила базы данных Azure database для MyS'L вместе может уменьшить область вашей поверхности безопасности.
