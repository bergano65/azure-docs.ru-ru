...
> [!Important]
> Если оставить для элемента управления, в значение ON, серверу базы данных MySQL Azure принимает подключения из любой подсети. что сделает доступ слишком незащищенным. Функция конечной точки службы виртуальной сети Microsoft Azure, в соответствии с функция правила виртуальной сети базы данных Azure для MySQL, можно уменьшить контактную зону системы безопасности.
