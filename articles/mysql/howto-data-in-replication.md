...
Просмотрите [ограничения и требования](concepts-data-in-replication.md#limitations-and-considerations) репликации data-in до выполнения шагов в этой статье.
...
1. Просмотрите [требования к главному серверу](concepts-data-in-replication.md#requirements) перед началом работы. 
   ...
   Тест подключение к главному серверу, пытаясь подключиться к такому инструменту, как командная линия MyS'L, размещенная на другой машине или из [облачной оболочки Azure,](https://docs.microsoft.com/azure/cloud-shell/overview) доступную на портале Azure 
