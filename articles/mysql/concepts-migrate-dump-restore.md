...
- Служебная программа командной строки [mysqldump](https://dev.mysql.com/doc/refman/5.7/en/mysqldump.html) , установленная на компьютере.
...
-   Используйте `skip-definer` параметр в mysqlpump для пропуска предложений "деточное" и "безопасность SQL" из инструкций CREATE для представлений и хранимых процедур.  При перезагрузке файла дампа он создает объекты, использующие значения по умолчанию и безопасность SQL.
...
5. Используйте кнопку **Обзор** , чтобы найти файл базы данных. 
