...
- **Администратор базы данных:** &nbsp; обновить список управления доступом (ACL), чтобы добавить данную подсеть к серверу базы данных Azure для MySQL.
