...
### <a name="c-cannot-yet-have-azure-database-for-mysql-on-a-subnet-without-defining-a-service-endpoint"></a>C. Базу данных Azure для MySQL невозможно создать в подсети без определения конечной точки службы
...
- Включение конечных точек службы виртуальной сети для Базы данных Azure для MySQL с помощью тега службы **Microsoft.Sql** также включает конечные точки для всех служб базы данных Azure: "База данных Azure для MySQL", "База данных Azure для PostgreSQL", "База данных SQL Azure" и "Хранилище данных SQL Azure".
