...
|seconds_behind_master|Задержка репликации в секундах|Счетчик|Количество секунд, на которое сервер-реплика отстает от главного сервера.|
