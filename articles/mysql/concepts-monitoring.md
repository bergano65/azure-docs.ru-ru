...
|seconds_behind_master|Задержка репликации в секундах|Count|Количество секунд, на которое сервер-реплика отстает от главного сервера. (Неприменимо для серверов уровня Basic)|
