...
| В | Соединитель MySQL/C (либмисклклиент) | https://dev.mysql.com/doc/refman/5.7/en/c-api-implementations.html | 6.0.2 + | | |
| В | Соединитель MySQL/ODBC (мйодбк) | https://github.com/mysql/mysql-connector-odbc | 3.51.29 + | | |
