...
2. В журнале действий щелкните **Добавить фильтр** , как показано, и установите следующие фильтры для 
 ...
 4. Перейдите на [страницу создание REST API сервера](https://docs.microsoft.com/rest/api/mysql/servers/create) и щелкните вкладку "попробовать", выделенную зеленым цветом, и войдите в нее с помощью учетной записи Azure.
