...
+   `sku/family`. Укажите значение Gen4 или Gen5, чтобы выбрать поколение оборудования для развертывания сервера.
+   `sku/name`. Укажите значение TierPrefix_family_capacity. Например, B_Gen4_1, GP_Gen5_16, MO_Gen5_32. Сведения о допустимых значениях для разных регионов и уровней можно найти в [документации по ценовым уровням](./concepts-pricing-tiers.md).
