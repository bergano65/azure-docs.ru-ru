---
title: Резервное копирование и восстановление - Портал Azure - База данных Azure для MyS'L
...
- [База данных Azure для сервера и базы данных MyS'L](quickstart-create-mysql-server-database-using-azure-portal.md)
...
1. Выберите **кнопку «Создание ресурса»** в верхнем левом углу портала. Выберите **базу данных Лазурных** > баз**данных для MyS'L**.
