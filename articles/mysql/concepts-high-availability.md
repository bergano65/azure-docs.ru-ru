...
- Основные сведения о службе см. в статье  [Что такое база данных Azure для MySQL?](overview.md)
- Общие сведения о логике повтора см. в статье [Обработка временных ошибок подключения к Базе данных Azure для MySQL](concepts-connectivity.md).
