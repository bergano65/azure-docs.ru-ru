...
![представление эластичного масштабирования в Azure MySQL](./media/concepts-high-availability/elastic-scaling-mysql-server.png)
...
![Просмотр высокого уровня доступности в Azure MySQL](./media/concepts-high-availability/availability-for-mysql-server.png)
