...
| Атрибут   | **Основной** | **общего назначения** | **Оптимизированная для памяти** |
|:---|:----------|:--------------------|:---------------------|
...
| Атрибут хранилища   | Основные | Общего назначения | Оптимизированные для операций в памяти |
|:---|:----------|:--------------------|:---------------------|
