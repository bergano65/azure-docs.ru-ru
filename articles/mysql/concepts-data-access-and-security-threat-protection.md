---
title: Расширенная защита от угроз - База данных Azure для MyS'L
description: Изучите концепции расширенной защиты от угроз, которые обнаруживают аномальные действия базы данных, указывающие на потенциальные угрозы безопасности базы данных.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
Расширенная защита от угроз входит в состав предложения "Расширенная защита данных", которое представляет собой унифицированный пакет расширенных возможностей безопасности. Расширенная защита от угроз может быть доступна и управляется через [портал Azure](https://portal.azure.com) или с помощью [REST API.](/rest/api/mysql/serversecurityalertpolicies) Функция доступна для серверов общего назначения и оптимизации памяти.
