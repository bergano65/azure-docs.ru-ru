...
Только администратор Azure AD может создавать или включать пользователей для аутентификации на основе Azure AD. Чтобы создать администратора Azure AD, выполните приведенные ниже действия.
