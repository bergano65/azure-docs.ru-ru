...
Настройте [подключение VPN-шлюза](../vpn-gateway/vpn-gateway-howto-vnet-vnet-resource-manager-portal.md) между виртуальными сетями, чтобы установить подключение к базе данных Azure для MySQL с виртуальной машины Azure в другом регионе или в подписке.
...
* Сведения о настройке брандмауэра для базы данных Azure для MySQL см. в разделе [Поддержка брандмауэра](./concepts-firewall-rules.md).

* Сведения о настройке конечной точки службы виртуальной сети для базы данных Azure для MySQL см. в статье [Настройка доступа из виртуальных сетей](./concepts-data-access-and-security-vnet.md).

* Общие сведения о подключении к базе данных Azure для MySQL см. в статье [Архитектура подключения базы данных Azure для MySQL](./concepts-connectivity-architecture.md) .
