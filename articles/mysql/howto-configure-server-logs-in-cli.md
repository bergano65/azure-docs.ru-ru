...
Если **log_output** настроена на "Файл", вы можете получить доступ к журналам непосредственно из локального хранилища сервера. Чтобы перечислить доступные файлы медленного журнала запроса для вашего сервера, запустите команду [списка серверов az mysql.](/cli/azure/mysql/server-logs#az-mysql-server-logs-list)
...
Если **log_output** настроена на "Файл", вы можете скачать отдельные файлы журнала с вашего сервера с командой [загрузки сервера az mysql.](/cli/azure/mysql/server-logs#az-mysql-server-logs-download)
