---
title: Управление правилами брандмауэра - Портал Azure - База данных Azure для MyS'L
...
Правила брандмауэра уровня сервера могут использоваться для управления доступом к базе данных Azure для MyS'L Server с указанного IP-адреса или ряда IP-адресов. 
