...
> [!Important]
> - Сценарий 2 и 4 существенно влияют на производительность сервера базы данных Azure для MySQL из-за дополнительного уровня шифрования инфраструктуры.
