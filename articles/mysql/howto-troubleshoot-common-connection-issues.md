---
title: Узнайте, как устранить проблемы с подключением к Базе данных Azure для MySQL
...
* Ошибка пользователя. Возможно, имеются недопустимые параметры подключения, такие как имя сервера в строке подключения или отсутствующий суффикс *\@servername* в имени пользователя.
