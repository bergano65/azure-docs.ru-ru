...
![Снимок экрана портал Azure для принудительного применения SSL-подключений в базе данных Azure для MySQL](./media/howto-configure-ssl/enable-ssl.png)
