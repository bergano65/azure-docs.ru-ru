...
4. Откроется страница **Add rule** (Добавление правила), как показано ниже.  Заполните необходимые сведения:
   ...
   | Подписка | В этом поле предварительно указывается подписка, в которой размещена база данных Azure для MySQL. |
   | Группа ресурсов | В этом поле предварительно указывается группа ресурсов базы данных Azure для MySQL. |
   | Ресурс | В этом поле предварительно указывается имя базы данных Azure для MySQL. |
