...
* Ключ должен иметь [обратимое удаление](../key-vault/general/soft-delete-overview.md) с периодом хранения, равным **90 дням**.
* Для Кэй должна быть [включена защита от очистки](../key-vault/general/soft-delete-overview.md#purge-protection).
