---
title: Резервное копирование и восстановление - Azure CLI - База данных Azure для MyS'L
...
- [База данных Azure для сервера и базы данных MyS'L](quickstart-create-mysql-server-database-using-azure-cli.md)
