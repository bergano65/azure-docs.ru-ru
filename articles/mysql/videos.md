...
ms.locfileid: "87513865"
---
# <a name="azure-database-for-mysql-videos"></a>Видеоролики, посвященные базе данных Azure для MySQL

На этой странице содержится видеоматериал для изучения базы данных Azure для MySQL.
...
## <a name="how-to-get-started-with-the-new-azure-database-for-mysql-service"></a>Как начать работу с новой службой "База данных Azure для MySQL"

>[!VIDEO https://channel9.msdn.com/Events/Build/2017/B8045/player]
[Открыть на канале 9](https://channel9.msdn.com/events/Build/2017/B8045)
