...
1. Разверните узел Operations Management Suite и выберите **Подключения**.
1. Щелкните ссылку **Повторная настройка Operation Management Suite** в середине панели.
1. Выполните инструкции **мастера переноса Operations Management Suite** и введите адрес электронной почты или номер телефона и пароль учетной записи администратора, связанной с новой рабочей областью Log Analytics.
