...
Чтобы отображать предупреждения и управлять ими, вместо [решения по управлению оповещениями](../azure-monitor/platform/alert-management-solution.md) вы можете использовать [объединенный интерфейс Azure Monitor для оповещений](../monitoring-and-diagnostics/monitoring-overview-alerts.md). Эти новые интерфейсы собирают оповещения от нескольких источников Azure, включая оповещения журналов из Log Analytics. Вы можете просматривать распределение оповещений, применять автоматическое группирование связанных оповещений через смарт-группы или отображать оповещения для нескольких подписок с помощью расширенных возможностей фильтрации. Все эти функции доступны в предварительной версии начиная с 4 июня 2018 г. Решение по управлению оповещениями не будет реализовано на портале Azure. 
