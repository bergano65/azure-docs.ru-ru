...
О. Выполните действия, описанные в разделе о [создании оповещений журналов](../monitoring-and-diagnostics/alert-metric.md), чтобы получать уведомления при прекращении сбора данных.
...
При развертывании службы фактические IP-адреса службы Log Analytics изменяются. DNS-имена, обеспечивающие передачу данных через брандмауэр, описаны в [требованиях к сети](log-analytics-agent-overview.md#network-firewall-requirements).
