...
Такое может произойти, если канал и пиринговые подключения распределены по нескольким подпискам. Решение "Монитор производительности сети" обнаруживает частные пиринговые подключения ExpressRoute только в виртуальных сетях, которые находятся в той же подписке, что и рабочая область решения "Монитор производительности сети". Кроме того, решение "Монитор производительности сети" обнаруживает пиринговые подключения Майкрософт, у которых подключенный канал ExpressRoute находится в той же подписке, что и рабочая область решения "Монитор производительности сети". Это можно проиллюстрировать приведенным ниже примером.

 Предположим, у вас есть 2 виртуальные сети: сеть A в подписке A и сеть B в подписке B. Обе подключены к ExpressRoute в подписке C. Кроме того, в подписке C есть еще одна виртуальная сеть C, для которой настроен пиринг Майкрософт с каналом ExpressRoute. 

В этой конфигурации будет справедливо следующее:

* Если рабочая область решения "Монитор производительности сети" связана с подпиской A, вы сможете отслеживать подключения через ExpressRoute только к виртуальной сети A.
* Если рабочая область решения "Монитор производительности сети" связана с подпиской B, вы сможете отслеживать подключения через ExpressRoute только к виртуальной сети B.
* Если рабочая область решения "Монитор производительности сети" связана с подпиской C, вы сможете отслеживать подключения через ExpressRoute к виртуальной сети C и настроенный пиринг Майкрософт.

Скоро будет реализована поддержка мониторинга между подписками. После этого вы сможете настроить мониторинг из одной рабочей области для всех частных подключений ExpressRoute и пирингов Майкрософт в разных подписках.
