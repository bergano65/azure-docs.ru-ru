...
Источники данных могут отличаться от [решений по управлению](../monitoring/monitoring-solutions.md), которые также собирают данные с подключенных источников и создают записи в Log Analytics.  Кроме сбора данных, решения обычно поддерживают возможности поиска и просмотра журналов, что позволяет анализировать работу определенного приложения или службы.
