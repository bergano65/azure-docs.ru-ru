...
description: Узнайте, как отправить электронную почту в службе электронной почты SendGrid в Azure. Примеры написаны на языке C# и используют API .NET.
services: ''
...
Для получения дополнительной [https://sendgrid.com](https://sendgrid.com) информации посетите или [библиотеку S' S'][sendgrid-csharp] GitHub репо.
...
> [!NOTE]
> Чтобы установить NuGet, если вы работаете версия Visual Studio раньше, чем Visual Studio 2015, посетите [https://www.nuget.org](https://www.nuget.org)кнопку Install **NuGet.**
>
>
...
* **SendGrid** для общения с API SendGrid.
...
Вы можете хранить эти учетные данные через портал Azure, нажав на настройки приложения и добавив пары ключей/значений в настройках приложения.
