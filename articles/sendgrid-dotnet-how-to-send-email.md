...
Дополнительные сведения см [https://sendgrid.com](https://sendgrid.com) . в репозитории SendGrid [ C# библиотеки][sendgrid-csharp] GitHub.
...
## <a name="how-to-send-email-from-asp-net-core-api-using-mailhelper-class"></a>Практическое руководство. отправка сообщения электронной почты из API .NET Core ASP с помощью класса MailHelper
...
* Репозиторий\# библиотеки SendGrid C: [SendGrid-CSharp][sendgrid-csharp]
