...
> [!NOTE]
> Чтобы установить NuGet, если вы используете версию Visual Studio, более раннюю по сравнению с Visual Studio [https://www.nuget.org](https://www.nuget.org)2015, откройте и нажмите кнопку **установить NuGet** .
>
>
