...
Некоторые свойства электронной почты можно переписать с помощью функции **SetProperty** или добавить с помощью **AddProperty**. Например, вы можете добавить дополнительных получателей с помощью
