...
Как поставщик услуг Интернета или поставщик услуг обмена интернет-трафиком вы можете создать новый ресурс PeerAsn для сопоставления номера автономной системы (ASN) с подпиской Azure. Вы можете связать с подпиской несколько ASN, открыв страницу [Привязка PeerASN](https://go.microsoft.com/fwlink/?linkid=2129592) для каждого ASN, который требуется связать.
