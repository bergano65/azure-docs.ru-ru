---
title: Руководство по службам Azure Analysis Services. Дополнительный урок. Динамическая безопасность | Документация Майкрософт
...
1.  В обозревателе табличных моделей выберите **Источники данных**, щелкните правой кнопкой мыши подключение и выберите элемент **Импортировать новые таблицы**.  
    ...
    Если появляется диалоговое окно "Учетные данные олицетворения", введите учетные данные олицетворения, использованные в уроке 2 "Добавление данных".
