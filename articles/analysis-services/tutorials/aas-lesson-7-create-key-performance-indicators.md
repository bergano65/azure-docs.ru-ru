---
title: Руководство по службам Azure Analysis Services. Урок 7. Создание ключевых показателей эффективности | Документация Майкрософт
...
Этот раздел входит в учебник по табличному моделированию, который следует изучать в предложенном порядке. Прежде чем выполнять задачи в этом уроке, вам нужно завершить предыдущий урок: [Урок 6. Создание мер](../tutorials/aas-lesson-6-create-measures.md).   
...
[Урок 8. Создание перспектив](../tutorials/aas-lesson-8-create-perspectives.md).
