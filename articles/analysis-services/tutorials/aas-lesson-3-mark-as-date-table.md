---
title: Руководство по службам Azure Analysis Services. Урок 3. Обозначение таблиц дат | Документация Майкрософт
...
ms.locfileid: "54189003"
---
# <a name="mark-as-date-table"></a>Обозначение таблицы дат

В уроке 2 "Получение данных" вы импортировали таблицу измерения DimDate. Хотя в вашей модели эта таблица имеет имя DimDate, она также может называться *таблицей дат*, так как содержит данные о датах и времени.  
...
Предполагаемое время выполнения этого урока: **три минуты**.  
  
## <a name="prerequisites"></a>Предварительные требования  
Этот раздел входит в учебник по табличному моделированию, который следует изучать в предложенном порядке. Прежде чем выполнять задачи в этом уроке, вам нужно завершить предыдущий урок: [2. Получение данных](../tutorials/aas-lesson-2-get-data.md). 
...
[Урок 4. Создание связей](../tutorials/aas-lesson-4-create-relationships.md).
