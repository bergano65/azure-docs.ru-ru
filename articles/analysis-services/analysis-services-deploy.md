...
> [!TIP]
> Перед развертыванием убедитесь, что можете обрабатывать данные в таблицах. В Visual Studio щелкните **модель** > **обработать** > **процесс все**. Если обработка завершается сбоем, вы не сможете выполнить развертывание.
> 
> 
...
1. В **Обозреватель решений**Visual Studio > щелкните правой кнопкой мыши проект > **свойства**. Затем на **Deployment** > **сервере** развертывания вставьте имя сервера.   
