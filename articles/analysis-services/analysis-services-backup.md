...
> [!NOTE]
> Если учетная запись хранения находится в другом регионе, параметры брандмауэра должны быть настроены для разрешения доступа из **всех сетей**. Параметры брандмауэра, настроенные для выбранных сетей с список разрешений IP-адресами и разрешающими исключения доверенных служб Майкрософт, не поддерживаются.
