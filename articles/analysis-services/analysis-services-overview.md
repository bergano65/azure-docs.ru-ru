...
<a name="depr">1</a> Доступно не во всех регионах.   
<a name="rec">2</a> Это нерекомендуемый план. Рекомендуется v2.
...
|восточная часть США 2     |     S8<sup>[2](#rec)</sup>, S9<sup>[2](#rec)</sup>, S8v2, S9v2   |    1    |
...
|западная часть США     |    S8<sup>[2](#rec)</sup>, S9<sup>[2](#rec)</sup>, S8v2, S9v2   |    2  |
|Западная часть США 2    |    B1, B2, S0, S1, S2, S4, D1    |    3   |
|Западная часть США 2    |    S8<sup>[2](#rec)</sup>, S9<sup>[2](#rec)</sup>, S8v2, S9v2  |    1     |
...
|Западная Европа    |   S8<sup>[2](#rec)</sup>, S9<sup>[2](#rec)</sup>, S8v2, S9v2  |  1  |
...
|Восточная Австралия     |    S8<sup>[2](#rec)</sup>, S9<sup>[2](#rec)</sup>, S8v2, S9v2    |    1     |
|Юго-Восточная часть Австралии     | B1, B2, S0, S1, S2, S4, D1       |    1     |
|Восточная Япония     |   B1, B2, S0, S1, S2, S4, D1       |    1     |
|Юго-Восточная Азия     |     B1, B2, S0, S1, S2, S4, S8<sup>[2](#rec)</sup>, S9<sup>[2](#rec)</sup>, S8v2, S9v2, D1     |   1      |
...
В документах по службам Analysis Services, таких как эта статья, используется открытый код. См. [руководство для участников разработки документации](https://docs.microsoft.com/contribute/). 
