...
Так как табличные модели в Azure Analysis Services имеют много общего с табличными моделями в SQL Server Analysis Services и наборами данных Power BI Premium, в [документации по службам Analysis Services](/analysis-services/?view=azure-analysis-services-current) представлена обширная библиотека руководств по моделированию данных, а также справочных статей. В документации по службам Analysis Services под заголовками статей есть баннер "Область применения", в котором указано, применима ли статья к Azure Analysis Services. Над оглавлением также можно выбрать номер версии, чтобы отфильтровать статьи для нужной платформы.
