...
4.  Выберите одно из следующих разрешений:  
    ...
    |Разрешение|Описание|  
    |----------------|-----------------|  
    |**Нет**|Члены не могут читать или изменять схему модели и не могут запрашивать данные.|  
    ...
    |**Процесс**|Члены могут выполнять операции «Обработать» и «Обработать все». Не может считывать или изменять схему модели и не может запрашивать данные.|  
    |**Административ**|Участники могут изменять схему шаблона и выполнять запрос всех данных.|   
