...
* Выполнять синхронизацию *перед выполнением операции горизонтального масштабирования* во избежание избыточного расконсервации добавлена реплик.
