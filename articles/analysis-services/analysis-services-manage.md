...
![Снимок экрана, на котором показано портал Azure, где можно создавать и удалять серверы, отслеживать ресурсы сервера, изменять размер и управлять доступом к серверам.](./media/analysis-services-manage/aas-manage-portal.png)
