...
ms.locfileid: "96487343"
---
# <a name="create-an-office-data-connection-file"></a>Создание файла подключения к данным Office

В этой статье описывается создание файла подключения к данным Office для подключения к серверу Azure Analysis Services из Excel 2016 (с номером версии 16.0.7369.2117 или ниже) либо Excel 2013. Обновленный [поставщик MSOLAP.7](/analysis-services/client-libraries?view=azure-analysis-services-current&preserve-view=true) также является обязательным.
