...
1. На экране **Выбор целевого объекта** укажите сведения о подключении для целевой Базы данных SQL Azure, которая является предварительной подготовленной Базой данных SQL Azure со схемой **Adventureworks2016**, развернутой с помощью Помощника по миграции данных.
    ...
    > [!NOTE]
    > Azure Database Migration Service поддерживает подключения частной конечной точки к целевой Базе данных SQL Azure кроме случаев, когда используется пользовательское DNS-имя. 
