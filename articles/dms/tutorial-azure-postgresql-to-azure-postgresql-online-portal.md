...
* [Включите логическую репликацию](https://docs.microsoft.com/azure/postgresql/concepts-logical) в исходном экземпляре Базы данных Azure для PostgreSQL. 
