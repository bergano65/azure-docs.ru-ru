...
Сейчас служба поддерживает множество сценариев миграции. Полный список состояний всех доступных сценариев миграции см. в статье [Состояние сценариев миграции, поддерживаемых службой Azure Database Migration Service](https://docs.microsoft.com/azure/dms/resource-scenario-status). Другие сценарии миграции доступны в ограниченной предварительной версии. Чтобы воспользоваться ими, необходимо отправить заявку через сайт предварительной версии DMS. Полный список сценариев в ограниченной предварительной версии и инструкции по регистрации для получения одного из этих предложений см. на [сайте предварительной версии DMS](https://aka.ms/dms-preview/).
