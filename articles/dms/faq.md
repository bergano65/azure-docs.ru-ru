...
Служба сейчас поддерживает перенос из SQL Server в Базу данных SQL Azure. Теперь вы можете перейти на портал Azure, чтобы начать использовать службу Azure Database Migration Service для этого сценария. Другие пары исходного и целевого объектов, такие как Oracle и База данных SQL Azure, доступны в ограниченной закрытой предварительной версии. Чтобы принять участие в ограниченной закрытой предварительной версии этих сценариев, зарегистрируйтесь [здесь](https://aka.ms/dms-preview/).
