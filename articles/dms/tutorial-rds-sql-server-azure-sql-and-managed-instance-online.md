---
title: "Учебник: Переносите сервер RDS S'L в онлайн в базу данных S'L"
titleSuffix: Azure Database Migration Service
description: Научитесь выполнять онлайн-миграцию с сервера RDS S'L в единую базу данных базы данных Azure S'L или управляемый экземпляр с помощью службы миграции базы данных Azure.
services: dms
author: pochiraju
ms.author: rajpo
manager: craigg
...
ms.locfileid: "80298869"
---
# <a name="tutorial-migrate-rds-sql-server-to-azure-sql-database-or-an-azure-sql-database-managed-instance-online-using-dms"></a>Учебник: Перенос RDS S'L Server в базу данных Azure S'L или управляемый экземпляр базы данных Azure S'L в режиме онлайн с помощью DMS
...
* Создайте виртуальную сеть Microsoft Azure для службы миграции баз данных Azure, используя модель развертывания ресурсов Azure Manager. Если вы перебрались в управляемый экземпляр базы данных Azure S'L, убедитесь, что создайте экземпляр DMS в той же виртуальной сети, которая используется для управляемого экземпляра базы данных Azure S'L, но в другой подсети.  Кроме того, если вы используете другую виртуальную сеть для DMS, вам нужно создать виртуальную сеть, вглядывающуюся между двумя виртуальными сетями. Для получения дополнительной информации о создании виртуальной сети, см [Виртуальная сеть Документация](https://docs.microsoft.com/azure/virtual-network/), и особенно быстро начать статьи с пошаговой детали.
