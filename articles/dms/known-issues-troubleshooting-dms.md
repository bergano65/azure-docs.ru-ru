...
При выполнении оперативной миграции с SQL Server на Управляемый экземпляр SQL Azure прямую миграцию завершается со следующей ошибкой:
