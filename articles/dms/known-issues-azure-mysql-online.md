...
- База данных Azure для MySQL поддерживает:
  ...
  - подсистему InnoDB.
- Миграция между одинаковыми версиями. Миграция с MySQL 5.6 в Базу данных Azure для MySQL 5.7 не поддерживается. Миграция в MySQL 8,0 или из нее не поддерживаются.
