...
![Снимок экрана: функция повторных попыток на стороне сервера в MongoDB.](media/tutorial-mongodb-to-cosmosdb-online/mongo-server-side-retry-feature.png)

Если функция *отключена*, рекомендуется включить ее, как показано ниже.

![Снимок экрана: включение функции повторных попыток на стороне сервера в MongoDB.](media/tutorial-mongodb-to-cosmosdb-online/mongo-server-side-retry-enable.png)
