...
- Сбор данных о зависимостях можно настроить параллельно для серверов 400. Вы можете проанализировать большее количество серверов путем виртуализации в пакетах 400.
