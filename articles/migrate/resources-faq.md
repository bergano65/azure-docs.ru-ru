...
- **Виртуальные машины VMware**. Ознакомьтесь с [поддерживаемыми географами](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-vmware) Azure для виртуальных машин VMware.
- **Виртуальные машины Hyper-v**. Ознакомьтесь со сведениями о [поддержке](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-hyper-v) миграции в Azure для виртуальных машин Hyper-v.
