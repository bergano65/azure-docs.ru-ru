...
1. Проверьте, правильно ли загружен файл OVA устройства для миграции Azure, проверив его хэш-значение. [Дополнительные сведения](./tutorial-discover-vmware.md). Если хэш-значение не совпадает, скачайте файл OVA еще раз и повторите попытку развертывания.
...
## <a name="clicking-on-login-button-opens-a-new-tab-with-no-device-code"></a>При нажатии кнопки "Login" открывается новая вкладка без кода устройства

Если после нажатия кнопки "Login" в диспетчере конфигурации устройства, откроется новая вкладка без кода, вернитесь на вкладку "Диспетчер конфигурации устройства" и вы сможете найти код устройства полужирным шрифтом под кнопкой "Login", как показано на снимке экрана ниже. Скопируйте код и вставьте его на вкладке Имя входа для аутентификации в Azure.

![Код устройства](./media/troubleshoot-appliance-discovery/code.png)
