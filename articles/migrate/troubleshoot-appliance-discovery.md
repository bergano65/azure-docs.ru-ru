...
Если обнаруженные виртуальные машины не отображаются на портале, подождите несколько минут. Для отображения данных на портале требуется до 30 минут. Если после 30 минут нет данных, попробуйте обновить, как показано ниже.
