...
5. В окне **Выбор средства оценки**добавьте средство оценки. Если средство оценки не требуется, выберите пункт **пропустить Добавление средства оценки для** > **Далее**. 
2. В окне **Выбор средства миграции**добавьте средство миграции при необходимости. Если вам сейчас не требуется средство миграции, выберите **пропустить Добавление средства миграции для** > **Далее**.
