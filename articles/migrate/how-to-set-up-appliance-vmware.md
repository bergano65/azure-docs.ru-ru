...
2. В разделе **Обнаружение компьютеров**  >  **виртуальные машины виртуализованные?** нажмите кнопку **Да, используя VMware vSphere гипервизор**.
...
Настройте устройство в первый раз. При развертывании устройства с помощью скрипта вместо шаблона OVA первые два шага в процедуре не применяются.
...
4. В веб-приложении выберите **Настройка необходимых компонентов** и выполните приведенные ниже действия.
    ...
    - **Установка вддк**. Служба "миграция Azure" проверяет, установлен ли пакет средств разработки VMware vSphere виртуального диска (вддк).
...
Для обнаружения приложений, ролей и функций, а также для визуализации зависимостей виртуальных машин можно предоставить учетные данные виртуальной машины, которые обеспечивают доступ к виртуальным машинам VMware. Вы можете добавить одни учетные данные для виртуальных машин Windows, а другие учетные данные — для виртуальных машин Linux. [Узнайте больше](./migrate-support-matrix-vmware.md) о необходимых привилегиях доступа.
