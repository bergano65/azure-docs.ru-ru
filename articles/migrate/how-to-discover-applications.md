...
1. В компоненте " **Миграция Azure" — серверы** > **службе "миграция Azure": Оценка сервера**выберите отображаемое число, чтобы открыть страницу **обнаруженные серверы** .
    ...
    > [!NOTE]
    > На этом этапе можно также настроить сопоставление зависимостей для обнаруженных компьютеров, чтобы можно было визуализировать зависимости между компьютерами, которые необходимо оценить. [Подробнее](how-to-create-group-machine-dependencies.md).
