...
Чтобы перенести рабочие нагрузки, работающие в Amazon Linux, можно запустить виртуальную машину CentOS/RHEL в Azure и перенести рабочую нагрузку, работающую на компьютере AWS Linux, с помощью соответствующего подхода к миграции рабочей нагрузки. Например, в зависимости от рабочей нагрузки могут быть специфичные для рабочей нагрузки средства для упрощения миграции, например для баз данных или средств развертывания в случае веб-серверов.
...
Нет. Для переноса этих виртуальных машин на виртуальные машины Azure поколения 2 можно использовать параметры миграции [на основе агента VMware](https://docs.microsoft.com/azure/migrate/tutorial-migrate-vmware-agent), миграцию [Hyper-V](https://docs.microsoft.com/azure/migrate/tutorial-migrate-physical-virtual-machines)или [физические серверы](https://docs.microsoft.com/azure/migrate/tutorial-migrate-physical-virtual-machines) .

***Примечание.*** Убедитесь, что выбран соответствующий размер виртуальной машины, который поддерживает UEFI поколения 2 в Azure.
