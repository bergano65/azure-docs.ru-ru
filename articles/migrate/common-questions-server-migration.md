...
Аппнамепрефикс для использования в NetQosPolicy — "Гатевайвиндовссервице. exe". Вы можете создать политику на устройстве "миграция Azure", чтобы регулировать трафик репликации с устройства, создав такую политику:
 
New-NetQosPolicy-Name "Сроттлерепликатион"-Апппаснамематчкондитион "Гатевайвиндовссервице. exe"-Сроттлератеактионбитсперсеконд 1 МБ
