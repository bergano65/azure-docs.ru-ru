...
Сейчас можно одновременно перенести 300 виртуальных машин на экземпляр vCenter Server. Выполните миграцию в пакетах по 10 виртуальным машинам.
...
Если настроено несколько устройств, они должны быть перекрываться между виртуальными машинами в предоставленных учетных записях vCenter. Обнаружение с таким перекрытием является неподдерживаемым сценарием.
