...
1.  Назначьте [разрешения](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-vmware#agentless-migration-vcenter-server-permissions) для новой роли.
1.  Нажмите кнопку **ОК**.
