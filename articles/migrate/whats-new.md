...
- Она также позволяет переносить виртуальные машины на основе UEFI и физические серверы на виртуальные машины Azure поколения 2. 
...
- Улучшены возможности поиска, сортировки и фильтрации для добавленных учетных данных и источников обнаружения.
- Включена поддержка ввода одного и нескольких элементов, а также импорт параметров CSV для пользователя, чтобы добавить источники обнаружения для узлов или кластеров Hyper-V и физических серверах.
- Улучшен интерфейс обработки ошибок и обновлены состояния для операций проверки и обнаружения по каждому добавленному источнику в таблице. 
