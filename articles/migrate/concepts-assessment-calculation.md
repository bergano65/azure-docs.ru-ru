...
**Серия виртуальной машины** | Серия виртуальных машин Azure, которую вы хотите рассмотреть для оптимизации дается задание. Например, если у вас нет рабочей среды, которая требует виртуальных машин Azure серии А, эту серию можно исключить из списка серий.
...
**ПРЕДЛОЖЕНИЕ** | [Предложение Azure](https://azure.microsoft.com/support/legal/offer-details/) , в котором вы зарегистрированы. Средство оценки серверов оценит стоимость этого предложения.
...
- Узнайте о выполнении оценок для [виртуальных машин VMware](./tutorial-discover-vmware.md), [виртуальных машин Hyper-V](./tutorial-discover-hyper-v.md)и [физических серверов](./tutorial-discover-physical.md).
