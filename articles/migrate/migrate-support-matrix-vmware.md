...
**Поддержка** | **Сведения**
--- | ---
**Обнаружение** | Обнаружение без агента, использование гостевых учетных данных компьютера и удаленный доступ к компьютерам с помощью WMI и вызовов SSH.
...
Сейчас этот вариант доступен в предварительной версии. [Узнайте больше](how-to-create-group-machine-dependencies-agentless.md). Требования приведены в следующей таблице.
