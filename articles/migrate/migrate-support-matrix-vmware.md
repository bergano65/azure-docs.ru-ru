...
**Поддержка** | **Сведения**
--- | ---
**vCenter Server** | Вам потребуется достаточно ресурсов на vCenter Server, чтобы выделить виртуальную машину с 32 ГБ ОЗУ, 8 виртуальных ЦП и внешним виртуальным коммутатором.<br/><br/> Устройству требуется доступ к Интернету либо напрямую, либо через прокси-сервер.
