...
**География** | [Ознакомьтесь](migrate-support-matrix.md#supported-geographies) с поддерживаемыми географами.
...
Для репликации можно выбрать до 10 виртуальных машин. Если вы хотите перенести другие компьютеры, выполните репликацию в группы из 10. Для миграции без агента VMware можно одновременно запустить до 100 репликаций.
