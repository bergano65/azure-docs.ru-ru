...
**VMware** | **Сведения**
--- | ---
**vCenter Server** | Компьютеры, которые требуется обнаружить и оценить, должны управляться с помощью vCenter Server версии 5,5, 6,0, 6,5 или 6,7.
