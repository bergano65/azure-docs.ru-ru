...
**Операционные системы** | Обнаружение приложений поддерживается для виртуальных машин, работающих под управлением всех версий Windows и Linux.
