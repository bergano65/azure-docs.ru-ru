...
**Discovery** | Устройство для переноса Azure может обнаружить до 5000 виртуальных машин Hyper-V.<br/><br/> Устройство может подключаться к узлам Hyper-V до 300.
...
[Подготовка к оценке виртуальных машин Hyper-V](./tutorial-discover-hyper-v.md)