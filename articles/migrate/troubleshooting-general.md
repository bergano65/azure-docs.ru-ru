...
## <a name="cant-add-enterprise-agreement-ea-in-an-assessment"></a>Не удается добавить Соглашение Enterprise (EA) в ходе оценки

В настоящее время Оценка сервера "миграция Azure" не поддерживает цены Соглашение Enterprise (EA). Чтобы обойти это ограничение, используйте предложение Azure с **оплатой по мере** использования и используйте свойство **Скидка** , чтобы указать любую полученную вами скидку. [Узнайте](https://aka.ms/migrate/selfhelp/eapricing) , как настроить оценку.
