...
Служба "Миграция Azure" Профили постоянно в локальной среде для сбора данных производительности на локальных виртуальных машин. Если вы запустили обнаружение вашей среды, необходимо Подождите по крайней мере один день для сбора данных производительности, которые необходимо выполнить. Если оценка создается без ожидания за один день, метрики производительности отображаются как нули. После ожидания в течение дня, можно создать новую оценку или обновить существующий оценку с помощью параметра «Обновить» в отчет об оценке.
