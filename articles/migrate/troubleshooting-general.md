...
1. Проверьте, правильно ли загружен файл OVA устройства для миграции Azure, проверив его хэш-значение. [Подробнее](https://docs.microsoft.com/azure/migrate/tutorial-assessment-vmware). Если хэш-значение не совпадает, скачайте файл OVA еще раз и повторите попытку развертывания.
...
В настоящее время Обнаружение приложений поддерживается только для виртуальных машин VMware. Поддержка виртуальных машин Hyper-V и физических серверов будет включена в будущем.

Обнаружение приложений требует предоставления учетных данных виртуальной машины в устройстве, если учетные данные виртуальной машины не указаны в устройстве, обнаружение приложений работать не будет. Дополнительные [сведения](https://docs.microsoft.com/azure/migrate/migrate-support-matrix-vmware#assessment-vcenter-server-permissions) о привилегиях доступа, необходимых для vCenter Server и для виртуальных машин VMware. Если вы указали учетные данные виртуальной машины на устройстве и не завершили обнаружение приложения, ознакомьтесь со следующей таблицей, чтобы выяснить причину сбоя и действия по исправлению:
