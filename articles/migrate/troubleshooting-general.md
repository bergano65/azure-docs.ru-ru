...
[Ниже приведен список [операционных систем Windows и Linux, которые Azure Monitor для виртуальных машин поддерживаются](../azure-monitor/insights/vminsights-enable-overview.md#supported-operating-systems).
