...
Условно поддерживаемая операционная система Windows | Операционная система прошла дату окончания поддержки, и для [поддержки в Azure](/troubleshoot/azure/virtual-machines/server-software-support)требуется специальное соглашение о поддержке (CSA). Перед миграцией в Azure рассмотрите возможность обновления.
Неподдерживаемая операционная система Windows | Azure поддерживает только [Выбранные версии ОС Windows](/troubleshoot/azure/virtual-machines/server-software-support). Рекомендуется обновить компьютер перед миграцией в Azure.
Условно поддерживаемая ОС Linux | Azure подтверждает только [Выбранные версии ОС Linux](../virtual-machines/linux/endorsed-distros.md). Рекомендуется обновить компьютер перед миграцией в Azure. Дополнительные сведения см. [здесь](#linux-vms-are-conditionally-ready-in-an-azure-vm-assessment) .
