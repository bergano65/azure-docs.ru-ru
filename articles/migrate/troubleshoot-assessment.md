...
Для компьютеров, импортированных с помощью CSV-файла, средство миграции по умолчанию в и оценка AVS неизвестны. Однако для компьютеров VMware рекомендуется использовать решение гибридного облака VMWare (ХККС). [Подробнее](https://docs.microsoft.com/azure/azure-vmware/hybrid-cloud-extension-installation)
