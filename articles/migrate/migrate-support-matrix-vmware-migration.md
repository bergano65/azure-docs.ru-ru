...
**Размер диска** | 2 ТБ диск ОС (Загрузка BIOS); диск ОС объемом 4 ТБ (Загрузка UEFI); 32 ТБ для дисков данных.
