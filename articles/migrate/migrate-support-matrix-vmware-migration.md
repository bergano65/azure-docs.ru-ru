...
**Автоматическая установка агента виртуальной машины Azure (агент Windows)** | Поддерживается для Windows Server 2008 R2, начиная с версии.
