...
**Размер диска** | 2 ТБ ОС диск; 4 ТБ для дисков данных.
...
**Мобильный сервис** | Агент службы мобильности должен быть установлен на каждом VM, который вы хотите перенести.
