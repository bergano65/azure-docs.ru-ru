...
ms.locfileid: "80336898"
---
# <a name="support-matrix-for-physical-server-assessment"></a>Матрица поддержки для оценки физического сервера 

В этой статье кратко излагаются предпосылки и требования к поддержке для оценки физических серверов в рамках подготовки к миграции в Azure. Если требуется перенести физические серверы в Azure, просмотрите [матрицу поддержки миграции.](migrate-support-matrix-physical-migration.md)
...
| **Операционная система** | Все операционные системы [Windows](https://support.microsoft.com/help/2721672/microsoft-server-software-support-for-microsoft-azure-virtual-machines) и [Linux](https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros) поддерживаются, за исключением Windows Server 2003 и SUSE Linux.|


## <a name="azure-migrate-appliance-requirements"></a>Требования к устройству Миграции Azure

Azure Migrate использует [прибор Azure Migrate](migrate-appliance.md) для обнаружения и оценки. Прибор для физических серверов может работать на VM или физической машине. Вы настроили его с помощью скрипта PowerShell, который вы загружаете с портала Azure.
