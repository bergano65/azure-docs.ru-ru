...
| **Разрешения**           | **Windows:** Вам потребуется локальная учетная запись или пользователь домена на всех серверах Windows, которые вы хотите обнаружить. Учетная запись пользователя должна быть добавлена в следующие группы: удаленный рабочий стол пользователей, пользователей системного монитора и пользователей журнала производительности. <br/><br/> **Linux:** Вам потребуются права суперпользователя на серверах Linux, которые вы хотите обнаружить. |
| **Операционная система** | Все операционные системы [Windows](https://support.microsoft.com/help/2721672/microsoft-server-software-support-for-microsoft-azure-virtual-machines) и [Linux](https://docs.microsoft.com/azure/virtual-machines/linux/endorsed-distros) , поддерживаемые Azure, за исключением Windows Server 2003 и SuSE Linux.|


## <a name="azure-migrate-appliance-requirements"></a>Требования к устройству Миграции Azure

Служба "миграция Azure" использует [устройство "миграция Azure](migrate-appliance.md) " для обнаружения и оценки. Устройство для физических серверов может работать на виртуальной машине или на физическом компьютере. Настроить устройство можно с помощью сценария PowerShell, скачиваемого из портал Azure.
