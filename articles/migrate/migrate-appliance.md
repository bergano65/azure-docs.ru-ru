...
--- | --- 
Виртуальная машина VMware | Служба "миграция Azure": Оценка серверов; Миграция Azure: миграция сервера | Обнаружение виртуальных машин VMware<br/><br/> Обнаружение приложений и зависимостей<br/><br/> Собирайте метаданные компьютера и метаданные производительности для оценки.<br/><br/> Репликация виртуальных машин VMware с миграцией без агента.
...
Физический компьютер |  Инструмент "миграция Azure": средство оценки |  Обнаружение физических серверов<br/><br/> Собирайте метаданные компьютера и метаданные производительности для оценки.
...
**Оборудование** | Компьютеру, на котором работает устройство, требуется 16 ГБ ОЗУ, 8 виртуальных ЦП, около 80 ГБ дискового пространства.
