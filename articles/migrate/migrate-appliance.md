...
**Требование** | **VMware** 
--- | ---
**Разрешения** | Для локального или удаленного доступа к веб-приложению устройства необходимо иметь локальную или доменную учетную запись с правами администратора на сервере устройства.
