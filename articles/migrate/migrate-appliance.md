...
**Поддержка проектов** |  Устройство может быть связано с одним проектом. <br/> С одним проектом можно связать любое количество устройств.<br/> 
**Ограничения обнаружения** | Устройство может обнаружить до 250 физических серверов.
**Сценарий PowerShell** | Скачайте сжатую папку со сценарием (AzureMigrateInstaller.ps1) с портала. [Подробнее](tutorial-assess-physical.md#set-up-the-appliance). Кроме того, его можно [скачать напрямую](https://go.microsoft.com/fwlink/?linkid=2105112).<br/><br/> Размер скачиваемого файла составляет 59,7 ГБ.
...
#### <a name="connection-data"></a>Данные подключений
...
#### <a name="linux-vm-data"></a>Данные виртуальных машин Linux
