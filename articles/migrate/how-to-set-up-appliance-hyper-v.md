...
Настройте устройство в первый раз. При развертывании устройства с помощью сценария вместо виртуального жесткого диска первые два шага процедуры не применяются.
