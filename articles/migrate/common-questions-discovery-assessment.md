...
- Оценка сервера не может выполнить накопление данных о производительности для некоторых или всех виртуальных машин в периоде оценки. Для оценки высокой достоверности убедитесь, что: 
