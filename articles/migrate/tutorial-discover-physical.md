...
**Требование** | **Сведения**
--- | ---
**Устройство** | Вам потребуется компьютер, на котором можно будет запустить устройство службы "Миграции Azure". На компьютере должны быть следующие компоненты:<br/><br/> — Установлен Windows Server 2016. Запуск устройства на компьютере с Windows Server 2019 не поддерживается.<br/><br/> — 16 ГБ ОЗУ, 8 виртуальных ЦП, около 80 ГБ дискового пространства и внешний виртуальный коммутатор.<br/><br/> — Статический или динамический IP-адрес, а также доступ к Интернету напрямую или через прокси-сервер.
