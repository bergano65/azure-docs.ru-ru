...
> [!NOTE]
> У нас есть доступные предварительной версии, которая позволяет обнаруживать до 10 000 виртуальных машин VMware в одном проекте с помощью одного устройства, если вы заинтересованы в ознакомлении с его, войдите в систему [здесь.](https://aka.ms/migratefuture)
...
4.  В сборщике службы "Миграция Azure" откройте раздел **Set Up Prerequisites** (Настройка предварительных требований), а затем:
    ...
    В. Скачайте и установите VMware PowerCLI.
