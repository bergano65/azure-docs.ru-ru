...
[Статья 5. Перемещение приложения на виртуальные машины Azure](contoso-migration-rehost-vm.md) | В этой статье рассказывается, как компания Contoso переносит виртуальные машины приложения SmartHotel, используя только Site Recovery. | Доступна
...
## <a name="step-5-configure-connection-strings"></a>Шаг 5. Настройте строки подключения
