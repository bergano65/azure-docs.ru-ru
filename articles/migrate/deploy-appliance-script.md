...
2. Выполните следующую команду, чтобы создать хэш ZIP-файла.
    ...
    - Например, ```C:\>CertUtil -HashFile C:\Users\administrator\Desktop\AzureMigrateInstaller-Server-Public.zip SHA256```.
3. Проверьте последнюю версию и скрипт устройства для общедоступного облака Azure:

    **Алгоритм** | **Загрузить** | **SHA256**
    --- | --- | ---
    VMware (85 ГБ) | [Последняя версия](https://go.microsoft.com/fwlink/?linkid=2116601) | 72fef66b8efd93106e626ea87354af0fb800893f9cb77edb5490490106c6a193
...
3. Проверьте последнюю версию и скрипт устройства для общедоступного облака Azure:
    ...
    **Сценарий** | **Загрузить** | **SHA256**
    --- | --- | ---
    Hyper-V (85 МБ) | [Последняя версия](https://go.microsoft.com/fwlink/?linkid=2116657) |  bea013eab690ae3a476422c55becd87c369c14834e52f8cafe6ad0ed7f416b4f
