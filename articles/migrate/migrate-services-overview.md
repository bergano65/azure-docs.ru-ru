...
**Azure Database Migration Service** | Миграция локальных баз данных на SQL Server на виртуальных машинах Azure, в Базу данных SQL Azure и на Управляемые экземпляры SQL. | Дополнительные сведения о службе Database Migration Service см. [здесь](https://docs.microsoft.com/azure/dms/dms-overview).
