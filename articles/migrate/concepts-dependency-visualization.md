...
- Чтобы подключить рабочую область Log Analytics к проекту, выполните следующие действия.
    1. На вкладке **Серверы** на плитке **Azure Migrate: На плитке Оценка сервера @ no__t-0 щелкните **Обзор**.
...
- Во время связывания вы можете создать рабочую область или присоединить имеющуюся.
  ...
  > [!NOTE]
  > Сейчас служба "миграция Azure" поддерживает создание или сопоставление рабочих областей Log Analytics, находящихся в восточной части США, Юго-Восточной Азии и Западной Европе. Если Рабочая область создана за пределами службы "миграция Azure" в неподдерживаемом регионе, она сейчас не может быть связана с проектом "миграция Azure". 
