...
3. На странице **Оценка серверов**выберите тип оценки "виртуальная машина Azure", выберите источник обнаружения и укажите имя оценки.

    ![Основы оценки](./media/how-to-create-assessment/assess-servers-azurevm.png)

4. Щелкните **Просмотреть все**, чтобы просмотреть свойства оценки.

    ![Свойства оценки](./media/how-to-create-assessment//view-all.png)

5. Нажмите кнопку **Далее** , чтобы **выбрать компьютеры для оценки**. В разделе **Создание или выбор группы** выберите **Создать** и укажите имя группы. Группа собирает одну или несколько виртуальных машин для оценки.
6. В разделе **Добавление компьютеров в группу** выберите виртуальные машины, которые необходимо добавить в группу.
7. Нажмите кнопку **Далее** , чтобы **проверить и создать оценку** , чтобы ознакомиться с данными оценки.
...
## <a name="review-an-azure-vm-assessment"></a>Проверка оценки виртуальной машины Azure

Оценка виртуальных машин Azure описывает:
