...
2. Войдите с использованием имени пользователя и пароля. Вход с помощью ключа не поддерживается. Кроме того, пользователь должен быть привилегированным или должен входить в группу локальных администраторов.
3. Укажите **операционную систему**, понятное имя для учетных данных, имя пользователя и пароль. Нажмите кнопку **Добавить**.
Вы можете добавить несколько учетных данных для серверов Windows и Linux.
...
5. Нажмите кнопку **Проверить**. После проверки будет показан список серверов, доступных для обнаружения.
...
6. После проверки щелкните **Сохранить и начать обнаружение**, чтобы начать процесс обнаружения.
