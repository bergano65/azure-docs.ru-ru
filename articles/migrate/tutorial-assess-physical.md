...
ms.locfileid: "96753201"
---
# <a name="tutorial-assess-physical-servers-for-migration-to-azure"></a>Руководство по Оценка готовности физических серверов к переносу в Azure
...
В этой статье описывается, как оценивать готовность локальных физических серверов к миграции в Azure с помощью службы "Миграция Azure". службы "Миграция Azure".
...
- Прежде чем приступить к работе с этим учебником по оценке компьютеров для миграции на виртуальные машины Azure, убедитесь, что обнаружили компьютеры, которые хотите оценить:
    - Чтобы обнаруживать компьютеры с помощью устройства службы "Миграция Azure", [следуйте инструкциям в этом учебнике](tutorial-discover-physical.md). 
...
- Убедитесь, что физические компьютеры, которые вы хотите оценить, не работают под управлением Windows Server 2003 или SUSE Linux. Эти компьютеры не поддерживают выполнение оценки.
...
1. На странице **Серверы** > **Серверы Windows и Linux** щелкните **Оценка и миграция серверов**.
   ...
   ![Расположение кнопки "Оценка и миграция серверов"](./media/tutorial-assess-physical/assess.png)

2. В **Azure Migrate: Server Assessment** (Миграция Azure: оценка сервера) щелкните **Оценка**.

    ![Расположение кнопки оценки](./media/tutorial-assess-physical/assess-servers.png)
...
6. Щелкните **Просмотреть все**, чтобы просмотреть свойства оценки.
    ...
    ![Расположение кнопки "Просмотреть все" для просмотра свойств оценки](./media/tutorial-assess-physical/assessment-name.png)
...
10. При внесении изменений нажмите кнопку **Сохранить**.
    ...
    ![Свойства оценки](./media/tutorial-assess-physical/assessment-properties.png)
