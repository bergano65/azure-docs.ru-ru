...
**Настройка служб интеграции Hyper-V** | Проверяется, включены ли службы Integration Services Hyper-V на всех виртуальных машинах, управляемых узлом. |  [Включите службы интеграции Hyper-V](https://docs.microsoft.com/windows-server/virtualization/hyper-v/manage/manage-hyper-v-integration-services) на каждой виртуальной машине.<br/><br/> Если вы используете Windows Server 2003, [выполните эти инструкции](prepare-windows-server-2003-migration.md).
