...
Во время регистрации устройства вы можете назначить разрешения Миграции Azure для создания приложений Azure AD одним из следующих способов:
