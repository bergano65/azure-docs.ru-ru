...
- Учетная запись Azure должна иметь разрешения на регистрацию устройства Миграции Azure. Устройство используется для обнаружения и оценки переносимых виртуальных машин Hyper-V. Во время регистрации устройства служба Миграции Azure создает два приложения Azure Active Directory (Azure AD), которые однозначно идентифицируют устройство.
