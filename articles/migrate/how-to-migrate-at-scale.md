...
- Убедитесь, что вы добавили учетную запись администратора виртуальной машины на сервер конфигурации (который будет использоваться для репликации локальных виртуальных машин).
- Убедитесь, что в Azure созданы такие целевые артефакты:
