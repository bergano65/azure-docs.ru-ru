...
- **Миграция Azure**. Чтобы оценить затраты, необходимо проверить и учесть все ресурсы, необходимые для запуска ваших рабочих нагрузок в Azure. Чтобы получить эти данные, необходимо провести инвентаризацию ресурсов, включая серверы, виртуальные машины, базы данных и хранилище. Для сбора этой информации можно использовать службу "Миграция Azure".
 ...
 - Оценка службы "Миграция Azure" содержит предполагаемые расходы.
    ...
    ![Служба "Миграция Azure"](./media/migrate-best-practices-costs/assess.png) *Оценка службы "Миграция Azure"*
...
- **Создать бюджет**. Создайте бюджет для финансовой отчетности.
    ...
    ![Бюджет в службе "Управление затратами"](./media/migrate-best-practices-costs/budget.png) *Бюджет в службе "Управление затратами Azure"*
...
- **Выполнение анализа затрат**. Получите анализ затрат, чтобы изучить и проанализировать затраты организации. Это поможет понять, как накапливаются затраты, а также определить тенденции расходов.
    ...
    ![Анализ в службе "Управление затратами"](./media/migrate-best-practices-costs/analysis.png) *Анализ в службе "Управление затратами Azure"*
...
- [Дополнительные сведения о пакетной службе Azure ](https://azure.microsoft.com/en-us/services/batch/).
