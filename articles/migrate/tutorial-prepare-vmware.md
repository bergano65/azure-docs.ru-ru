...
- **Настройка учетной записи оценки**. Службе "Миграция Azure" требуется доступ к vCenter Server для обнаружения виртуальных машин для оценки. Для доступа к службе "Миграция Azure" требуется учетная запись только для чтения.
...
Службе "миграция Azure" требуется доступ к vCenter Server для обнаружения виртуальных машин для оценки и миграции без агентов. Настройте учетную запись только для чтения для vCenter Server только для выполнения оценки.
