...
ms.locfileid: "84770192"
---
# <a name="azure-migrate-support-matrix"></a>Таблица поддержки службы "Миграция Azure"

[Службу "Миграция Azure"](migrate-overview.md) можно использоваться для оценки и миграции компьютеров в облако Microsoft Azure. В этой статье описаны общие параметры и ограничения поддержки для сценариев и развертываний службы "Миграция Azure".
...
**Deployment** | **Сведения** 
--- | --- 
**Обнаружение для конкретного приложения** | Вы можете обнаруживать приложения, роли и компоненты, работающие на виртуальных машинах VMware. В настоящее время эта возможность ограничена только обнаружением. Оценка сейчас производится только на уровне компьютера. Мы пока что не предлагаем оценку конкретного приложения, роли или компонента. 
**Оценка в локальной среде** | Оценивайте локальные рабочие нагрузки и данные виртуальных машин VMware и Hyper-V, а также физических серверов. Используйте средство оценки сервера службы "Миграция Azure" и Помощник по миграции данных (Майкрософт), а также другие инструменты и предложения независимых поставщиков программного обеспечения.
**Локальная миграция в Azure** | Выполняйте миграцию в Azure рабочих нагрузок и данных на физических серверах, виртуальных машинах VMware, виртуальных машинах Hyper-V и облачных виртуальных машинах. Используйте для миграции средство оценки сервера в службе "Миграция Azure" и Azure Database Migration Service (DMS), а также другие инструменты и предложения независимых поставщиков программного обеспечения.
...
[DMA](https://docs.microsoft.com/sql/dma/dma-overview?view=sql-server-2017) | Оценка SQL Server баз данных. | Н/Д
...
[Movere](https://www.movere.io/) | Оценка виртуальных машин VMware, Hyper-V и Xen, физических компьютеров, рабочих станций (включая VDI), рабочих нагрузок в общедоступных облаках. | Н/Д
...
Вы можете создать проект службы "Миграция Azure" в ряде географических регионов в общедоступном облаке. Проекты можно создавать только в этих географических регионах, но вы можете оценивать или мигрировать компьютеры для других целевых расположений. Географический регион проекта используется только для хранения обнаруженных метаданных.
