...
> [!NOTE]
> В настоящее время инструменты ISV не могут отправлять данные в Azure Migrate в правительстве Azure. Вы можете использовать интегрированные инструменты Майкрософт или использовать партнерские инструменты самостоятельно.
