...
--- | --- | ---
Оценка сервера службы "Миграция Azure" | Оценка [виртуальных машин VMware](./tutorial-discover-vmware.md), [виртуальных машин Hyper-V](./tutorial-discover-hyper-v.md) и [физических серверов](./tutorial-discover-physical.md). |  Недоступна (Н/Д)
