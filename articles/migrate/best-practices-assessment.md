...
Если после создания оценки вы добавите или удалите компьютеры из группы, то созданная вами оценка будет помечена какНесинхронизированная. Запустите оценку еще раз (**пересчитать**), чтобы отразить изменения группы.
