...
https:\//dev.mysql.com/get/Downloads/MySQLInstaller/mysql-installer-community-5.7.20.0.msi | Для завершения загрузки MySQL. В нескольких регионах загрузка может быть перенаправлена на URL-адрес CDN. При необходимости убедитесь, что URL-адрес CDN также разрешен.
