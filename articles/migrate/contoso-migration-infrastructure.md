...
2. Они щелкают **Добавить разрешения** > **Роль** > **Участник**, а затем выбирают из списка группу AD под названием **ContosoCobRG**. После этого группа появляется в списке **Выбранные элементы**. 
