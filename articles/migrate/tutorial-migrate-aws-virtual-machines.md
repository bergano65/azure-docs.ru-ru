...
1. Оценку можно выполнить, обрабатывая виртуальные машины AWS как физические компьютеры с целью проведения оценки с помощью средства оценки сервера службы "Миграция Azure". Выполните инструкции из этого [учебника](./tutorial-prepare-physical.md), чтобы настроить Azure и подготовить виртуальные машины AWS к оценке.
