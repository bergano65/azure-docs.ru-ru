...
1. В проекте "Миграция Azure" щелкните **Серверы**, в разделе ***Azure Migrate: Server Migration** (Миграция Azure: Миграция сервера), выберите **Обнаружить**.
