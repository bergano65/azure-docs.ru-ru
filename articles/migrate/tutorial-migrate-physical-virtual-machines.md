...
[Просмотрите](migrate-architecture.md) архитектуру миграции.
...
- Вам нужно подготовить компьютер для размещения модуля репликации. [Просмотрите требования](migrate-replication-appliance.md#appliance-requirements) к компьютеру. Модуль не следует устанавливать на исходном компьютере, который вы намерены реплицировать.
