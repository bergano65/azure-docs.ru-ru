...
- Ознакомьтесь с разделом [предварительных требований](#prerequisites), чтобы определить, нужны ли какие-либо изменения для операционной системы.
