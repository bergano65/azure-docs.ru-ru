---
title: Оценка виртуальных машин Hyper-V для миграции на виртуальные машины Azure с помощью средства оценки серверов в службе "Миграция Azure"
description: Узнайте, как оценивать виртуальные машины Hyper-V для миграции на виртуальные машины Azure с помощью средства оценки серверов.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
ms.locfileid: "98567081"
---
# <a name="tutorial-assess-hyper-v-vms-for-migration-to-azure"></a>Руководство по оценке виртуальных машин Hyper-V для миграции в Azure
...
В этой статье содержатся сведения о том, как оценивать обнаруженные виртуальные машины Hyper-V для миграции в Azure с помощью средства оценки серверов: службы "Миграция Azure".
...
- Прежде чем приступить к работе с этим руководством по оценке компьютеров для миграции на виртуальные машины Azure, убедитесь, что обнаружили компьютеры, которые хотите оценить:
    - Чтобы обнаруживать компьютеры с помощью устройства службы "Миграция Azure", [следуйте инструкциям в этом учебнике](tutorial-discover-hyper-v.md). 
...
1. В разделе **Создание или выбор группы** выберите **Создать** и укажите имя группы. 
    ...
    :::image type="content" source="./media/tutorial-assess-hyper-v/assess-machines.png" alt-text="Создание новой группы и добавление компьютеров":::
