...
3.  Для версии устройства 1.19.06.27 созданный хэш должен соответствовать этим параметрам.
...
Если вы запускаете виртуальные жесткие диски в SMB, необходимо включить делегирование учетных данных с устройства на узлы Hyper-V. Если вы не сделали этого на каждом узле в [предыдущем руководстве](tutorial-prepare-hyper-v.md#enable-credssp-on-hosts), сделайте это сейчас с устройства:
