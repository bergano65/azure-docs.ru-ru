...
- В первом руководстве вы должны были выполнить следующие действия.
    ...
    - [Подготовка кластеров](tutorial-prepare-hyper-v.md#prepare-hyper-v-for-assessment), узлов и виртуальных машин Hyper-V для оценки.
    - [Подготовка к развертыванию](tutorial-prepare-hyper-v.md#prepare-for-appliance-deployment) устройства Миграции Azure, которое используется для обнаружения и оценки виртуальных машин Hyper-V.
