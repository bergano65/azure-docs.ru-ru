---
title: Оценка виртуальных машин VMware для миграции на виртуальные машины Azure с помощью средства оценки серверов в службе "Миграция Azure"
description: Узнайте, как оценивать виртуальные машины VMware для миграции на виртуальные машины Azure с помощью средства оценки серверов.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
ms.locfileid: "96753150"
---
# <a name="tutorial-assess-vmware-vms-for-migration-to-azure-vms"></a>Руководство по Оценка готовности виртуальных машин VMware к переносу на виртуальные машины Azure
...
В этой статье содержатся сведения о том, как оценивать обнаруженные виртуальные машины VMware при подготовке к миграции в виртуальные машины Azure с помощью службы "Миграция Azure": службы "Миграция Azure".
...
Прежде чем приступить к работе с этим руководством по оценке компьютеров для миграции на виртуальные машины Azure, убедитесь, что обнаружили компьютеры, которые хотите оценить:
...
1. В разделе **Свойства оценки** > **Свойства целевого объекта**:
 ...
 7. В поле **Размер виртуальной машины**:
...
9. При внесении изменений нажмите кнопку **Сохранить**.

    ![Свойства оценки](./media/tutorial-assess-vmware-azure-vm/assessment-properties.png)

10. В поле **Оценка серверов** щелкните **Далее**.
11. В разделе **Выбор компьютеров для оценки** выберите **Создать** и укажите имя группы. 
12. Выберите устройство, а также виртуальные машины, которые необходимо добавить в группу. Затем нажмите кнопку **Далее**.

     ![Добавление виртуальных машин в группу](./media/tutorial-assess-vmware-azure-vm/assess-group.png)

13. На странице **Review + create assessment (Проверка и создание оценки) проверьте сведения об оценке и щелкните **Создать оценку**, чтобы создать группу и запустить оценку.
...
2. В разделе **Оценки** щелкните оценку, чтобы открыть сведения о ней. В качестве примера (оценки и затраты только для примера): 
    ...
    ![Сводка оценки](./media/tutorial-assess-vmware-azure-vm/assessment-summary.png)
...
![Оценка достоверности](./media/tutorial-assess-vmware-azure-vm/confidence-rating.png)
