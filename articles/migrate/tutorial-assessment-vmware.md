...
- Сведения о проблеме. Пользователь назначается на уровне центра обработки данных и поэтому имеет доступ ко всем объектам в центре обработки данных.
...
--- | ---
США | Центрально-западная часть США, восточная часть США
