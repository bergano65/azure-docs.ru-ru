...
Настроить устройство репликации можно несколькими способами.

- Настройка скачанного шаблона Open Virtualization Application (OVA). Импортируйте шаблон в VMware и создайте виртуальную машину устройства репликации. Это метод, используемый в этом руководстве.
