...
description: В этой статье описывается, как оценить готовность экземпляров AWS к миграции в Azure с помощью средства оценки серверов в службе "Миграция Azure".
ms.topic: tutorial
ms.date: 09/14/2020
ms.custom: MVC
...
1. На странице **Серверы** > **Серверы Windows и Linux** щелкните **Оценка и миграция серверов**.
   ...
   ![Расположение кнопки "Оценка и миграция серверов"](./media/tutorial-assess-aws/assess.png)

2. В **средстве оценки серверов службы "Миграция Azure" щелкните **Оценка**.

    ![Расположение кнопки оценки](./media/tutorial-assess-aws/assess-servers.png)
...
6. Щелкните **Просмотреть все**, чтобы просмотреть свойства оценки.
    ...
    ![Расположение кнопки "Просмотреть все" для просмотра свойств оценки](./media/tutorial-assess-aws/assessment-name.png)
...
10. При внесении изменений нажмите кнопку **Сохранить**.
    ...
    ![Свойства оценки](./media/tutorial-assess-aws/assessment-properties.png)
