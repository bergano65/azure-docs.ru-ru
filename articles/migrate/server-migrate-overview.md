...
**Использование средства оценки серверов** | Оценка компьютеров с помощью средства "миграция Azure" для оценки серверов. | Вы можете оценивать компьютеры перед их миграцией, но вам не нужно. | Оценка является необязательной.
