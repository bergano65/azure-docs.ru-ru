...
Устройство может подключаться через Интернет или с помощью Azure ExpressRoute. Убедитесь, что эти [URL-адреса](./migrate-appliance.md#url-access) утверждены для подключения устройства к Azure.
