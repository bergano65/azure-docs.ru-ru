...
Устройство может подключаться через Интернет или с помощью Azure ExpressRoute. Убедитесь, что эти [URL-адреса](https://docs.microsoft.com/azure/migrate/migrate-appliance#url-access) список разрешений для подключения устройства к Azure.
