...
Когда устройство отправляет [вызов "Регистрация устройства](https://docs.microsoft.com/rest/api/iot-dps/runtimeregistration/registerdevice) " в службу DPS. Вызов Register можно улучшить, чтобы взять другие поля в тексте. Текст выглядит следующим образом: 
   ```
   { 
