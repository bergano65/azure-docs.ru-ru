---
title: Roll X.509 сертификаты в Azure IoT Концентратор Устройства Обеспечение устройств
description: Как свернуть сертификаты X.509 в экземпляре Службы обеспечения устройств (DPS)
author: wesmc7777
ms.author: wesmc
ms.date: 08/06/2018
ms.topic: conceptual
...
2. Щелкните **Вторичный сертификат**, а затем щелкните значок папки, чтобы выбрать новый сертификат, который будет загружен для записи регистрации. Нажмите **Сохранить**.
...
2. Выберите скомпрометированный сертификат в списке и нажмите кнопку **Удалить**. Подтвердите удаление, введя имя сертификата и нажмите **OK**. Повторите этот процесс для всех скомпрометированных сертификатов.
...
5. Щелкните **Сертификат ЦС** и выберите новый корневой сертификат ЦС. Затем нажмите **Сохранить**. 
...
3. Щелкните **Сертификат ЦС** и выберите новый корневой сертификат ЦС в разделе конфигурации **вторичного сертификата**. Затем нажмите **Сохранить**. 
