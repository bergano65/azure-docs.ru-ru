...
description: Краткое руководство Azure. Регистрация устройств TPM в службе "Подготовка устройств к добавлению в Центр Интернета вещей" с помощью пакета SDK для служб C#. В этом кратком руководстве используется индивидуальная регистрация.
author: wesmc7777
ms.author: wesmc
ms.date: 01/16/2018
ms.topic: quickstart
...
1. Присвойте проекту имя *CreateTpmEnrollment* и выберите команду **Создать**.
...
1. В **обозревателе решений** щелкните правой кнопкой мыши проект **CreateTpmEnrollment** и выберите **Управление пакетами NuGet**.
...
После успешного создания в окне командной строки отобразятся свойства новой отдельной регистрации.
...
1. Перейдите к службе подготовки устройств на портале Azure, откройте раздел **Управление регистрациями** и выберите вкладку **Индивидуальные регистрации**. Выберите *Идентификатор регистрации* для записи о регистрации, которую вы создали с помощью этого руководства, и нажмите кнопку **Удалить**.
...
1. Если вы следовали инструкциям по [созданию и подготовке имитированного устройства доверенного платформенного модуля с помощью пакета SDK устройства для C#](quick-create-simulated-device-tpm-csharp.md), чтобы создать устройство TPM, следуйте инструкциям, приведенным ниже.
    ...
    1. На портале Azure перейдите в Центр Интернета вещей, в котором подготовлено устройство. В меню под **Explorers** выберите **Устройства IOT**, установите флажок рядом с устройством и нажмите кнопку **Удалить**.
