---
title: Проверка сертификатов X.509 CA с помощью службы обеспечения устройств Концентратора Azure IoT
description: Как сделать подтверждение владения сертификатами X.509 CA с помощью службы обеспечения устройств Azure IoT (DPS)
author: wesmc7777
ms.author: wesmc
ms.date: 02/26/2018
ms.topic: conceptual
...
3. Введите понятное отображаемое имя для сертификата. Перейдите к CER- или PEM-файлу, который соответствует открытой части сертификата X.509. Нажмите кнопку **Отправка**.
