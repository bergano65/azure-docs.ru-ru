...
---
# <a name="use-azure-iot-dps-ip-connection-filters"></a>Использование фильтров IP-подключений Azure IoT DP
...
| attribute                | Описание |
| ------------------------ | ----------- |
| **FilterName**           | Укажите имя для правила IP-фильтра. Оно должно быть уникальной строкой буквенно-цифровых символов длиной не более 128 символов без учета регистра. Только 7-разрядные буквы и цифры в формате ASCII, плюс {'-', ': ', '/', ' \' , '. ', ' + ', '% ', ' _ ', ' # ', ' * ', '? ', "!", "(", ")", ",", "=", "@", ";", "" "} принимаются. |
