...
description: Описание концепций обеспечения безопасности, относящихся к устройствам с помощью службы подготовки устройств (DPS) и центра Интернета вещей.
author: nberdy
ms.author: nberdy
ms.date: 04/04/2019
ms.topic: conceptual
