---
title: Служба подготовки устройств для центра Интернета вещей Azure — основные понятия безопасности
