...
Конечные сертификаты, используемые с [индивидуальной регистрации](./concepts-service.md#individual-enrollment) запись существует требование, **имя субъекта** должно быть присвоено идентификатор регистрации записи индивидуальной регистрации. Конечные сертификаты, используемые с [группы регистраций](./concepts-service.md#enrollment-group) запись должна иметь **имя субъекта** присвоено устройство идентификатор, который будет отображаться в **регистрационных записей** для аутентифицированное устройство в группе регистраций.
