...
> [!WARNING]
> Код устройства должен включать только ключ производного устройства для отдельного устройства. Не добавляйте главный ключ группы в код устройства. Скомпрометированный главный ключ может нарушить безопасность всех устройств, прошедших проверку подлинности.
