...
description: Использование симметричных ключей для инициализации устаревших устройств с помощью экземпляра службы подготовки устройств (DPS)
author: wesmc7777
ms.author: wesmc
ms.date: 04/10/2019
ms.topic: conceptual
