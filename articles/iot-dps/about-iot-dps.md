...
* **Поддержка нескольких центров** позволяет DPS выполнить позднюю привязку устройств с центром Интернета вещей во время выполнения. DPS может взаимодействовать с центрами в нескольких подписках Azure.
...
DPS автоматизирует подготовку устройств с помощью Центра Интернета вещей. См. дополнительные сведения о [Центре Интернета вещей](https://docs.microsoft.com/azure/iot-hub/).
