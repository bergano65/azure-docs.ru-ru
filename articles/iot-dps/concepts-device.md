...
description: Описывает концепции подготовки устройств, характерные для устройств с службой обеспечения устройств (DPS) и IoT Hub
author: nberdy
ms.author: nberdy
ms.date: 11/06/2019
ms.topic: conceptual
...
Идентификатор устройства совпадает с идентификатором, отображаемым в Центре Интернета вещей. Необходимый идентификатор устройства можно задать в записи регистрации, но это необязательно. Установка идентификатора желаемого устройства поддерживается только в отдельных регистрациях. Если в списке регистрации нет необходимого идентификатора устройства, при регистрации устройства в качестве идентификатора устройства используется идентификатор регистрации. Узнайте больше об [идентификаторах устройств в Центре Интернета вещей](../iot-hub/iot-hub-devguide-identity-registry.md).
