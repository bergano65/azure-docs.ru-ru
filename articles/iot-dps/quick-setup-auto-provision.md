...
description: Краткое руководство. Настройка службы "Подготовка устройств к добавлению в Центр Интернета вещей Azure" на портале Azure
author: wesmc7777
ms.author: wesmc
ms.date: 11/08/2019
ms.topic: quickstart
