...
5. В левой области страницы **Обзор** приложения-функции нажмите кнопку **+** далее рядом с функцией **, чтобы добавить** новую функцию.
...
В этом разделе вы обновите пример подготовки с именем " **Prov\_\_dev Client\_Sample** ", расположенный в ранее настроенном пакете SDK для Azure IOT C.
