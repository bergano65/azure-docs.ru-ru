...
description: Руководством для разработчиков. Поддержка устройств, подключающихся к конечной точке службы подготовки устройств Интернета вещей Azure с помощью протокола MQTT.
author: rajeevmv
ms.service: iot-dps
services: iot-dps
ms.topic: conceptual
