...
В этом руководстве показано, как настроить облако для автоматической подготовки устройств с помощью службы подготовки устройств для Центра Интернета вещей. В этом руководстве описано следующее:
