...
| Оператор | Настройка автоматической подготовки | Эта операция соответствует первому этапу автоматической подготовки.<br><br>**Краткие руководства.** Выполните роль оператора, настроив экземпляры Службы подготовки устройств (DPS) и Центра Интернета вещей в своей подписке Azure. | Настройка автоматической подготовки |
|  | Регистрация удостоверения устройства | Эта операция соответствует второму этапу автоматической подготовки.<br><br>**Краткие руководства.** Выполните роль оператора, зарегистрировав имитированное устройство в своем экземпляре Службы подготовки устройств. Удостоверение устройства определяется с помощью метода аттестации, имитируемого в кратком руководстве (доверенный платформенный модуль или X.509). Чтобы узнать больше об аттестации, ознакомьтесь с ролью разработчика. | 
