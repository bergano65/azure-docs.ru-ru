...
| Оператор | Настройка автоматической подготовки | Эта операция соответствует первому этапу автоматической подготовки.<br><br>**Краткие руководства.** Выполните роль оператора, настроив экземпляры Службы подготовки устройств (DPS) и Центра Интернета вещей в своей подписке Azure. |
