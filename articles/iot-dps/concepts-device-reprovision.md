---
title: Служба обеспечения устройств Azure IoT - Концепции устройств
description: Описывает концепции переподготовки устройств для службы обеспечения устройств Azure IoT (DPS)
author: wesmc7777
ms.author: wesmc
ms.date: 04/04/2019
ms.topic: conceptual
...
Данные состояния устройства состоят из двух [и устройствовых](../iot-hub/iot-hub-devguide-device-twins.md) возможностей устройства. Эти данные хранятся в экземпляре службы подготовки устройств и в центре Интернета вещей, которому назначено устройство.
...
* [Как перезаставить устройства](how-to-reprovision.md)
