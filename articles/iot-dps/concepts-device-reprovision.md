...
* **Географическое расположение и географическая задержка**: Устройство после перемещения между расположениями задержки в сети повышается благодаря наличию устройства перенесены в ближе центра Интернета вещей.

* **Мультитенантность**: Устройство может использоваться в одном решении Интернета вещей и переназначить на нового клиента, или на сайте клиента. Обслуживание этого нового клиента может выполняться с помощью другого Центра Интернета вещей.
...
* **Никогда не выполняется повторно Подготовка**: Устройство никогда не назначается другой концентратора. Эта политика предоставляется для управления обратной совместимостью.
...
| -------- | ----- | ---------- | --------- | -------- | -------- |
| [2018-04-01 и более ранних версий](/rest/api/iot-dps/createorupdateindividualenrollment/createorupdateindividualenrollment#uri-parameters) | [1.2.8 и более ранних версий](https://github.com/Azure/azure-iot-sdk-c/blob/master/version.txt) | [1.4.2 и более ранних версий](https://github.com/Azure/azure-iot-sdk-python/blob/0a549f21f7f4fc24bc036c1d2d5614e9544a9667/device/iothub_client_python/src/iothub_client_python.cpp#L53) | [1.7.3 или более ранней версии](https://github.com/Azure/azure-iot-sdk-node/blob/074c1ac135aebb520d401b942acfad2d58fdc07f/common/core/package.json#L3) | [1.13.0 или более ранней версии](https://github.com/Azure/azure-iot-sdk-java/blob/794c128000358b8ed1c4cecfbf21734dd6824de9/device/iot-device-client/pom.xml#L7) | [1.1.0 или более ранней версии](https://github.com/Azure/azure-iot-sdk-csharp/blob/9f7269f4f61cff3536708cf3dc412a7316ed6236/provisioning/device/src/Microsoft.Azure.Devices.Provisioning.Client.csproj#L20)
