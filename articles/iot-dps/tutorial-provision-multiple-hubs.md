...
2. **Равномерно взвешенное распределение** (по умолчанию). В связанных центрах Интернета вещей можно обеспечить равномерную подготовку устройств. Это параметр по умолчанию. При подготовке устройств только в одном Центре Интернета вещей можно оставить это значение. 
