...
**Клиентский сертификат** — это корневой сертификат на устройстве.  **Клиентский сертификат** и связанный **закрытый ключ** необходимы в клиенте устройства. Механизм его размещения в клиентском приложении может отличаться в зависимости от выбора языка.  Дополнительные сведения см. в [кратком руководстве](./quick-create-simulated-device-x509.md) по созданию имитированного устройства с использованием сертификата X.509.

Корневой или промежуточный сертификат можно использовать для создания группы регистраций или индивидуальной регистрации [программным образом](./how-to-manage-enrollments-sdks.md) или с помощью [портала](./how-to-manage-enrollments.md).
