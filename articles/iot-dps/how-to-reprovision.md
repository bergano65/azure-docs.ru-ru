...
ms.locfileid: "98791902"
---
# <a name="how-to-reprovision-devices"></a>Повторная подготовка устройств

Во время жизненного цикла решения Интернета вещей часто приходится перемещать устройства между Центрами Интернета вещей. Эта статья написана для помощи в решении операторов, которые настраивают политики повторной инициализации.

Более подробные сведения о сценариях повторной инициализации см. в разделе [Основные понятия повторной инициализации устройств центра Интернета вещей](concepts-device-reprovision.md).
...
3. В разделе **Выберите способ назначения устройств для Центров** выберите одну из следующих политик распределения:
    ...
    * **Статическая конфигурация**. Эта политика требует, чтобы центр Интернета вещей был указан в записи регистрации для устройства, которое должно быть подготовлено. Эта политика позволяет вам указать один конкретный Центр Интернета вещей, которому вы хотите назначить устройства.
...
4. Щелкните **Сохранить**, чтобы включить повторную подготовку устройства на основе изменений.
    ...
    ![Снимок экрана, на котором показаны внесенные изменения и кнопка "Сохранить".](./media/how-to-reprovision/reprovisioning-policy.png)
