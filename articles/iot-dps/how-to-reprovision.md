---
title: Устройства переобеспечения в службе обеспечения устройств Концентратора Концентратора Azure
description: Узнайте, как перезаставить устройства в экземпляре Службы обеспечения устройств (DPS) и почему это может потребоваться.
author: wesmc7777
ms.author: wesmc
ms.date: 04/04/2019
ms.topic: conceptual
...
Более подробный обзор переподготовки можно ознакомиться с [концепциями переподготовки устройств IoT Hub](concepts-device-reprovision.md)Device.
