...
Индивидуальные регистрации относятся к конкретным устройствам и могут использовать в качестве механизмов аттестации сертификаты X.509 или токены SAS (в реальном или виртуальном доверенном платформенном модуле). (Устройства, использующие маркеры SAS в качестве механизма аттестации, можно подготовить только через индивидуальную регистрацию.) Чтобы запретить устройству, имеющему отдельную регистрацию, можно либо отключить, либо удалить запись регистрации. 
