---
title: Отрезка устройства от службы обеспечения устройств Концентратора Azure IoT
description: Как отписать устройство для предотвращения подготовки через службу обеспечения устройств Azure IoT (DPS)
author: wesmc7777
ms.author: wesmc
ms.date: 04/05/2018
ms.topic: conceptual
...
Индивидуальные регистрации относятся к конкретным устройствам и могут использовать в качестве механизмов аттестации сертификаты X.509 или токены SAS (в реальном или виртуальном доверенном платформенном модуле). (Устройства, которые используют токены SAS в качестве механизма аттестации, могут быть подготовлены только через индивидуальную регистрацию.) Чтобы внести устройство в черный список, в результате которого имеется индивидуальная регистрация, можно отключить или удалить его запись. 
...
6. Прокрутите страницу **Добавить регистрацию** до конца и выберите **Отключить** в переключателе **Включить запись**, а затем **Сохранить**. 
    ...
    [![Используйте отключенную индивидуальную запись регистрации для отключения устройства от регистрации группы на портале](./media/how-to-revoke-device-access-portal/disable-individual-enrollment-in-enrollment-group.png)](./media/how-to-revoke-device-access-portal/disable-individual-enrollment-in-enrollment-group.png#lightbox)
