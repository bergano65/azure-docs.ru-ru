...
Следует заметить, что на владельца доверенного платформенного модуля Владельца доверенного платформенного МОДУЛЯ зависит от многих вещей, включая изготовителя доверенного платформенного МОДУЛЯ, набор средств TPM используется и ОС устройства. Чтобы получить право владения, следуйте инструкциям для своей системы.
