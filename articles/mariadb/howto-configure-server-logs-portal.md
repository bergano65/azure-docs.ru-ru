...
5. Измените параметры, которые необходимо настроить, включая включение **slow_query_log** в значение **вкл**. Все изменения, вносимые в этом сеансе, выделены фиолетовым цветом. 
...
![снимок экрана параметров конфигурации параметров диагностики с выделенным параметром "Сохранить"](./media/howto-configure-server-logs-portal/save-diagnostic-setting.png)
