...
3. В разделе **мониторинг** на боковой панели выберите **журналы сервера**. 
   параметры журналов сервера ![Screenshot @ no__t-1

4. Чтобы просмотреть параметры сервера, выберите **щелкните здесь, чтобы включить журналы и настроить параметры журнала**.

5. Измените параметры, которые необходимо настроить, **включая включение** **slow_query_log** . Все изменения, вносимые в этом сеансе, выделены фиолетовым цветом. 

   После изменения параметров нажмите кнопку **сохранить**. Вы также можете отменить изменения.

   ![Снимок экрана параметров параметров сервера](./media/howto-configure-server-logs-portal/3-save-discard.png)
...
@no__t 0Screenshot параметры конфигурации параметров диагностики @ no__t-1

1. После настройки приемников данных для передачи журналов запросов с задержкой нажмите кнопку **сохранить**.
![Screenshot параметров конфигурации диагностики с выделенным параметром Save @ no__t-1
