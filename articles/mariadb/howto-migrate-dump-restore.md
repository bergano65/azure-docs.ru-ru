---
title: Миграция с свалкой и восстановлением - База данных Azure для MariaDB
...
- утилита командной линии [mysqldump](https://mariadb.com/kb/en/library/mysqldump/) установлена на машине.
