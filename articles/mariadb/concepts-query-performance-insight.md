...
> [!NOTE]
> Статистика ожидания предназначена для устранения проблем с производительностью запросов. Рекомендуется включать только в целях устранения неполадок. <br>Если вы получаете сообщение об ошибке в портал Azure "*Microsoft. дбформариадб". не удается выполнить запрос. Если эта проблема будет возникать или неожиданно, обратитесь в службу поддержки, используя эту информацию.* " При просмотре статистики ожидания используйте меньший период времени.
