...
Правила брандмауэра уровня сервера могут использоваться для управления доступом к базе данных Azure для MariaDB Server с указанного IP-адреса или ряда IP-адресов.

Для обеспечения доступа к серверу также можно использовать правила виртуальной сети (VNet). Подробнее о [создании и управлении конечными точками и правилами службы виртуальной сети с помощью портала Azure.](howto-manage-vnet-portal.md)
...
## <a name="next-steps"></a>Дальнейшие действия
 - Аналогичным образом можно сделать сценарий для [создания и управления базой данных Azure для правил брандмауэра MariaDB с помощью Azure CLI.](howto-manage-firewall-cli.md)
 - Дальнейший безопасный доступ к серверу путем [создания и управления конечными точками и правилами службы Virtual Network с помощью портала Azure.](howto-manage-vnet-portal.md)