...
1. В верхней левой части экрана портал Azure выберите **создать ресурс** > **базы данных** > **базе данных Azure для MariaDB**.
...
1. В верхней левой части экрана портал Azure выберите **создать ресурс** > **сети** > **Частная ссылка**.
