...
- Чтобы получить ответы на любые вопросы и предложения по работе с базой данных Azure для MariaDB, отправьте сообщение электронной почты для команды MariaDB базы данных Azure по адресу *AskAzureDBforMySQL@service.microsoft.com* .
