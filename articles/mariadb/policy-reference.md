...
ms.locfileid: "98703753"
---
# <a name="azure-policy-built-in-definitions-for-azure-database-for-mariadb"></a>Встроенные определения в Политике Azure для Базы данных Azure для MariaDB
