---
title: Предоплата за базу данных Azure для MariaDB. Вычисление ресурсов с зарезервированной емкостью
