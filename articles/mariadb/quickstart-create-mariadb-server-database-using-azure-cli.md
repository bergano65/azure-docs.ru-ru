...
backup-retention | **7** | Срок хранения резервной копии. Указывается в днях. Диапазон: от 7 до 35. 
...
admin-password | *ваш пароль* | Пароль администратора. Ваш пароль должен состоять из 8–128 символов. Он должен содержать знаки трех из следующих категорий: прописные латинские буквы, строчные латинские буквы, цифры и другие знаки.
