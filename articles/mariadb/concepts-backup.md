...
Эти файлы резервных копий не предоставлены пользователю и не могут быть экспортированы. Эти резервные копии можно использовать только для операций восстановления в базе данных Azure для MariaDB. [Mysqldump](howto-migrate-dump-restore.md) можно использовать для копирования базы данных.
...
#### <a name="long-term-retention-of-backups"></a>Долгосрочного хранение резервных копий
...
В базе данных Azure для MariaDB при восстановлении создается новый сервер из резервных копий исходного сервера и восстанавливаются все базы данных, содержащиеся на сервере.
