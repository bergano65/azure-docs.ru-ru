---
title: Резервное копирование и восстановление - Azure CLI - База данных Azure для MariaDB
...
При восстановлении сервера в более ранней точке времени создается новый сервер. Исходный сервер и его базы данных, начиная с указанного момента во времени, копируются на новый сервер.
...
Новый сервер, созданный во время восстановления, не имеет конечных точек службы VNet, существовавших на исходном сервере. Эти правила должны быть настроены отдельно для этого нового сервера. Правила брандмауэра с исходного сервера восстанавливаются.
