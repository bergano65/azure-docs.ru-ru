...
Если вы не обновите корневой сертификат до 26 октября 2020, то приложения, подключающиеся по протоколу SSL/TLS и выполняющие проверку корневого сертификата, не смогут взаимодействовать с сервером базы данных MariaDB, и приложение будет испытывать проблемы с подключением к серверу базы данных MariaDB.
...
### <a name="8--what-if-i-cannot-get-a-scheduled-downtime-for-this-change-before-october-26-2020-10262020"></a>8. что делать, если я не могу получить запланированное время простоя для этого изменения до 26 октября 2020 (10/26/2020)?
...
### <a name="9-if-i-create-a-new-server-after-october-26-2020-will-i-be-impacted"></a>9. Если я создам новый сервер после 26 октября 2020 г., будет ли это затронуто?
