---
title: Хранилище запросов в базе данных Azure для MariaDB
...
Область **применения:**  Azure база данных для MariaDB 10,2
