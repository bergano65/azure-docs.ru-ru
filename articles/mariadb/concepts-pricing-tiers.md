...
> [!IMPORTANT]
> В настоящее время большая память находится в общедоступной предварительной версии в следующих регионах: Восточная часть США, восток США 2, Центральная часть США, Запад США, Северо-центральный регион США, Юго-Центральная часть США, Северная Европа, Западная Европа, южная часть Соединенного Королевства, западная часть Соединенного Королевства, Юго-Восточная Азия, Восточная Азия, Восточная Япония, Западная Япония, Центральная Корея, Южная Корея, Восточная Австралия, Юго-Восточная Австралия, Западная часть США, Юго-Центральноевропейская, Восточная Канада и Центральная Канада.
>
