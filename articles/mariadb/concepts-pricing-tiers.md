...
| Атрибуты хранилища   | Basic | Общего назначения | С оптимизацией для операций в памяти |
|:---|:----------|:--------------------|:---------------------|
...
| Атрибуты хранилища | Общего назначения | С оптимизацией для операций в памяти |
|:-------------|:--------------------|:---------------------|
