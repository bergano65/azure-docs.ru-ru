...
2. Включите двоичную регистрацию.
...
4. Создайте новую роль репликации и наверсните разрешения.
...
5. Установите мастер-сервер в режим чтения только.
...
6. Получите текущее имя файла двоичного журнала и смещение.
...
7. Получите позицию GTID (необязательно, необходимую для репликации с помощью GTID).
