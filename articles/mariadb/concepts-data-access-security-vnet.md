...
- Включение конечных точек службы виртуальной сети для Базы данных Azure для MariaDB с помощью тега службы **Microsoft.Sql** также включает конечные точки для всех служб базы данных Azure: "База данных Azure для MariaDB", "База данных Azure для MySQL", "База данных Azure для PostgreSQL", "База данных SQL Azure" и "Хранилище данных SQL Azure".
