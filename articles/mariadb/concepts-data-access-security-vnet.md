...
Можно также использовать [частную ссылку](concepts-data-access-security-private-link.md) для подключений. Частная ссылка предоставляет частный IP-адрес в виртуальной сети для сервера базы данных Azure для MariaDB.
...
> - Убедитесь, что у обеих подписок есть зарегистрированный поставщик ресурсов **Microsoft. SQL** и **Microsoft. дбформариадб** . Дополнительные сведения см. в разделе [resource-manager-registration][resource-manager-portal]
