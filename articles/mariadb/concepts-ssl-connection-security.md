...
>
> Сейчас версии TLS, поддерживаемые базой данных Azure для MariaDB, — это TLS 1,0, 1,1 и 1,2. После принудительного применения к определенной минимальной версии TLS ее нельзя изменить на отключенную.
