---
title: Преемственность бизнеса - База данных Azure для MariaDB
description: Узнайте о непрерывности бизнеса (восстановление точек времени, сбой в работе центра обработки данных, геовосстановление) при использовании базы данных Azure для службы MariaDB.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
