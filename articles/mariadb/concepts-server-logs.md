...
Существует два варианта доступа к журналам запросов в базе данных Azure для MariaDB: хранилище локального сервера или журналы диагностики Azure Monitor. Это задается с `log_output` помощью параметра.
