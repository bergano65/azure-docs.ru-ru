---
title: Управление конечными точками VNet - Портал Azure - База данных Azure для MariaDB
...
> [!Important]
> Если вы установите его в ON, ваш сервер базы данных Azure MariaDB принимает сообщение из любой подсети. что сделает доступ слишком незащищенным. Функция конечной точки службы Microsoft Azure Virtual Network в координации с функцией виртуального сетевого правила базы данных Azure для MariaDB может вместе уменьшить область безопасности.
