...
> [!Important]
> Если вы установите значение Вкл., сервер базы данных Azure MariaDB будет принимать данные из любой подсети. что сделает доступ слишком незащищенным. Функция конечной точки службы виртуальная сеть Microsoft Azure, согласованная с функцией правила виртуальной сети в базе данных Azure для MariaDB, позволяет сократить контактную зону безопасности.
