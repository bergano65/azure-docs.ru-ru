...
Вы можете создать управляемый домен, используя параметры конфигурации по умолчанию для сетевых подключений и синхронизации, или [вручную определить эти параметры][tutorial-create-instance-advanced]. В этом руководстве описано, как с помощью параметров по умолчанию создать и настроить экземпляр Azure AD DS на портале Azure.
