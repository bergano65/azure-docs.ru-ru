...
> [!TIP]
> Вы можете присоединить виртуальную машину к домену с помощью PowerShell, используя командлет [Add-Computer][add-computer]. Следующий пример присоединяет виртуальную машину к домену *AADDSCONTOSO* и перезапускает ее. Укажите учетные данные пользователя, который входит в группу *Администраторы Azure AD DC*, когда появится соответствующий запрос.
>
