...
В следующем примере сценария развертывания управляемый домен Contoso включен в клиенте Contoso Azure AD. Управляемый домен развертывается в виртуальной сети, которая принадлежит подписке Azure, принадлежащей клиенту Contoso Azure AD. Управляемый домен и виртуальная сеть принадлежат одному клиенту Azure AD. Этот пример конфигурации является допустимым и полностью поддерживаемым.
