...
Домен и выполняемые в нем действия (включая исправление, мониторинг и создание резервных копий) управляются корпорацией Майкрософт. Домен заблокирован, и у вас нет прав на выполнение определенных административных задач в домене. Некоторые примеры задач, которые нельзя выполнять, приведены ниже.
...
3. Чтобы подключиться к виртуальной машине, откройте скачанный RDP-файл. При появлении запроса нажмите кнопку **Подключиться**. Укажите учетные данные пользователя, принадлежащего к группе "Администраторы контроллера домена AAD". Например, bob@domainservicespreview.onmicrosoft.com. При входе в систему может появиться предупреждение о сертификате. Чтобы продолжить процесс подключения, нажмите кнопку "Да" или "Продолжить".
...
Теперь вы можете использовать средства администрирования Windows Server AD для просмотра и администрирования управляемого домена.
