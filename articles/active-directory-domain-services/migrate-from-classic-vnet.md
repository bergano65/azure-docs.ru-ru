...
1. Теперь запустите `Migrate-Aadds` командлет, используя параметр *-Prepare* . Укажите параметр *-манажеддомаинфкдн* для собственного управляемого домена Azure AD DS, например *aaddscontoso.com*:
...
Запустите `Migrate-Aadds` командлет с параметром *-commit* . Укажите параметр *-манажеддомаинфкдн* для собственного управляемого домена Azure AD DS, подготовленного в предыдущем разделе, например *aaddscontoso.com*:
...
Запустите `Migrate-Aadds` командлет с параметром *-Abort* . Укажите параметр *-манажеддомаинфкдн* для собственного управляемого домена Azure AD DS, подготовленного в предыдущем разделе, например *aaddscontoso.com*, и имя классической виртуальной сети, например *миклассиквнет*:
