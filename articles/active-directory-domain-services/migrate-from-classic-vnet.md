...
В этой статье описываются преимущества и рекомендации по миграции, а также необходимые действия для успешного переноса существующего экземпляра AD DS Azure. Эта функция миграции сейчас доступна в предварительной версии.
