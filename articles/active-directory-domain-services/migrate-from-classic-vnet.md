...
Выполните командлет `Migrate-Aadds`, используя параметр *-Abort* . Укажите параметр *-манажеддомаинфкдн* для собственного управляемого домена Azure AD DS, подготовленного в предыдущем разделе, например *contoso.com*:
