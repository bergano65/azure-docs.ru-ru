...
3. Во время установки вам будет предложено зарегистрировать соединитель прокси приложения каталога Azure AD.
   * Укажите **учетные данные администратора приложения Azure AD**. Ваш клиент администратора приложения может отличаться от учетных данных Microsoft Azure.
...
Используйте основанное на ресурсах ограниченное делегирование Kerberos, как описано в этой [статье](deploy-kcd.md).
