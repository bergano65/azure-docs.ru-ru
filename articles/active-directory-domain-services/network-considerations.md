...
### <a name="virtual-network-peering"></a>Пиринг виртуальных сетей
...
| Номер порта | Протокол | Источник                             | Место назначения | Действия | Обязательно для заполнения | Цель |
|:-----------:|:--------:|:----------------------------------:|:-----------:|:------:|:--------:|:--------|
| 443         | TCP      | азуреактиведиректоридомаинсервицес | Любой         | Allow  | ДА      | Синхронизация с клиентом Azure AD. |
| 3389        | TCP      | корпнетсав                         | Любой         | Allow  | ДА      | Управление доменом. |
| 5986        | TCP      | азуреактиведиректоридомаинсервицес | Любой         | Allow  | ДА      | Управление доменом. |
| 636         | TCP      | Любой                                | Любой         | Allow  | Нет       | Включается только при настройке защищенного протокола LDAP (LDAPs). |
