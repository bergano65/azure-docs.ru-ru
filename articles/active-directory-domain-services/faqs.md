...
Да, вы можете создать управляемый домен доменных служб Azure AD с помощью шаблона диспетчер ресурсов. Субъект-службу и группу Azure AD для администрирования необходимо создать с помощью портал Azure или Azure PowerShell перед развертыванием шаблона. При создании управляемого домена доменных служб Azure AD в портал Azure можно экспортировать шаблон для использования с дополнительными развертываниями. Также существует [Пример шаблона в репозитории примеров шаблонов GitHub](https://github.com/Azure/azure-quickstart-templates/tree/master/101-AAD-DomainServices).
