...
В этой статье приведены решения распространенных проблем при [настройке защищенного протокола LDAP](tutorial-configure-ldaps.md) для доменных служб Azure AD.
...
Создайте сертификат защищенного протокола LDAP, выполнив инструкции в статье о [настройке защищенного протокола LDAP](tutorial-configure-ldaps.md).
