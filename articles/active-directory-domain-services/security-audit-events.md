...
| Имя категории аудита | Description (Описание) |
|:---|:---|
...
1. В верхней части портал Azure найдите и выберите **доменные службы Azure AD**. Выберите нужный управляемый домен, например *contoso.com.*
