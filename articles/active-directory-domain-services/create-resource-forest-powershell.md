...
Создание субъекта-службы Azure AD для AD DS Azure для взаимодействия и проверки подлинности. Идентификатор конкретного приложения используется с именем *службы контроллера домена* и идентификатором *6ba9a5d4-8456-4118-B521-9c5ca10cdf84* . Не изменяйте этот идентификатор приложения.
