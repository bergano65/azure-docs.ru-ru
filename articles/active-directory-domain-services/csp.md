...
* **Поставщики облачных решений могут написать сценарий создания управляемых доменов для своих клиентов с помощью PowerShell.** Дополнительные сведения о том, как включить доменные службы Azure AD с помощью PowerShell, см. в [этой статье](powershell-create-instance.md).
