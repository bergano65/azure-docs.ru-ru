...
ms.locfileid: "78668407"
---
# <a name="tutorial-enable-password-synchronization-in-azure-active-directory-domain-services-for-hybrid-environments"></a>Учебник. Включение синхронизации паролей в доменных службах Azure Active Directory для гибридных сред
...
1. Перейдите на вкладку **соединители** . Перечисляются сведения о подключении, используемые для синхронизации между локальной средой AD DS и Azure AD.
