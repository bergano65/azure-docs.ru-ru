...
* Длительность блокировки учетных записей: 30 дней.
* Разрешенное число неудачных попыток входа в систему: 5.
* Время, по истечении которого сбрасываются неудачные попытки входа в систему: 30 мин.
...
* [Дополнительные сведения о детальных политиках паролей для Active Directory](https://docs.microsoft.com/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc770394)
