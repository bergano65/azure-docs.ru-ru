...
В этом сценарии предположим, что у вас есть веб-приложение, которое выполняется на компьютере с именем *contoso-webapp.aaddscontoso.com*. Веб-приложению необходимо получить доступ к веб-API, который выполняется на компьютере с именем *contoso-API.aaddscontoso.com* в контексте пользователей домена. Чтобы настроить этот сценарий, выполните следующие действия.
