...
В этом сценарии предположим, что у вас есть веб-приложение, которое выполняется на компьютере с именем *contoso-webapp.aadds.contoso.com*. Веб-приложению необходимо получить доступ к веб-API, который выполняется на компьютере с именем *contoso-API.aadds.contoso.com* в контексте пользователей домена. Чтобы настроить этот сценарий, выполните следующие действия.
