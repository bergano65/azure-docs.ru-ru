...
Обоим контроллерам домена может понадобиться час или два для подготовки управляемого домена. Если развертывание закончилось ошибкой или в течение нескольких часов находится в состоянии "Ожидание", [обратитесь за помощью к команде разработчиков](contact-us.md).
