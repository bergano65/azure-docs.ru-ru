...
| --- |:--- |
| *Имя contoso100.com уже используется в этой сети. Укажите имя, которое не используется.* |[Конфликт доменных имен в виртуальной сети](active-directory-ds-troubleshooting.md#domain-name-conflict) |
| *Не удалось включить доменные службы в этом клиенте Azure AD. У службы нет необходимых разрешений на доступ к приложению с именем Azure AD Domain Services Sync. Удалите приложение с именем «Azure AD Domain Services Sync» и затем попробуйте снова включить доменные службы для вашего клиента Azure AD.* |[Доменные службы не имеет достаточно разрешений для приложения Azure AD Domain Services Sync](active-directory-ds-troubleshooting.md#inadequate-permissions) |
| *Не удалось включить доменные службы в этом клиенте Azure AD. У приложения доменных служб в клиенте Azure AD нет разрешений, необходимых для включения доменных служб. Удалите приложение с идентификатором приложения d87dcbc6-a371-462e-88e3-28ad15ec4e64 и затем попробуйте снова включить доменные службы для вашего клиента Azure AD.* |[У приложения доменных служб не настроен в клиенте](active-directory-ds-troubleshooting.md#invalid-configuration) |
...
*Имя contoso100.com уже используется в этой сети. Укажите имя, которое не используется.*
...
*Не удалось включить доменные службы в этом клиенте Azure AD. У службы нет необходимых разрешений на доступ к приложению с именем Azure AD Domain Services Sync. Удалите приложение с именем «Azure AD Domain Services Sync» и затем попробуйте снова включить доменные службы для вашего клиента Azure AD.*
...
*Не удалось включить доменные службы в этом клиенте Azure AD. У приложения доменных служб в клиенте Azure AD нет разрешений, необходимых для включения доменных служб. Удалите приложение с идентификатором приложения d87dcbc6-a371-462e-88e3-28ad15ec4e64 и затем попробуйте снова включить доменные службы для вашего клиента Azure AD.*
