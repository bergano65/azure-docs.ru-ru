...
| **Пример сообщения об ошибке** | **Разрешение** |
| --- |:--- |
...
* **Формат учетных данных** — попробуйте использовать формат имени участника-пользователя, чтобы `dee@aaddscontoso.onmicrosoft.com`указать учетные данные, например. Формат UPN — это рекомендуемый способ указания учетных данных в AD DS Azure. Убедитесь, что имя участника-пользователя правильно настроено в Azure AD.
