...
3. Сохраните [скрипт в следующем разделе](scoped-synchronization.md#script-to-select-groups-to-synchronize-to-the-managed-domain-select-groupstosyncps1) в файл с именем ```Select-GroupsToSync.ps1```. Выполните скрипт, как показано ниже:
