...
* [Включите синхронизацию паролей с доменными службами Azure AD](tutorial-create-instance-advanced.md#enable-user-accounts-for-azure-ad-ds) , чтобы конечные пользователи могли входить в управляемый домен с использованием своих корпоративных учетных данных.
...
1. В портал Azure найдите и выберите **доменные службы Azure AD**. Выберите свой экземпляр, например *contoso.com*.
