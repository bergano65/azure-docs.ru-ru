...
1. Чтобы исследовать управляемый домен Azure AD DS, выберите на панели слева имя управляемого домена, например *aaddscontoso.com*. Первыми в списке указаны два контейнера с именами *Компьютеры AADDC* и *Пользователи AADDC*.
