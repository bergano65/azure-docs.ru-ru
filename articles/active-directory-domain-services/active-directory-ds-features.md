...
* **Использование корпоративных учетных данных и паролей**. Пароли для пользователей клиента Azure AD подходят для доменных служб Azure AD. Пользователей можно использовать свои корпоративные учетные данные для присоединения к домену компьютеров, войдите в интерактивном режиме или через удаленный рабочий стол и проверку подлинности в управляемом домене.
