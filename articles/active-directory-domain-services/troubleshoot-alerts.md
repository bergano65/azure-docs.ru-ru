...
1. Узнайте о [контроле доступа на основе ролей и о том, как предоставить доступ к приложениям в портал Azure](../role-based-access-control/role-assignments-portal.md).
