...
Эта ошибка является неисправимой. Чтобы устранить это предупреждение, [удалите существующий управляемый домен AD DS Azure](delete-aadds.md) и создайте его заново в новом каталоге. Если у вас возникли проблемы при удалении управляемого домена, [откройте запрос в службу поддержки Azure][azure-support] для получения дополнительных сведений об устранении неполадок.
...
Следующие распространенные причины приводят к прекращению синхронизации в управляемых доменах.
