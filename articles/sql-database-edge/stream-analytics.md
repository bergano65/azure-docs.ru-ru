...
| асажобинфо | Универсальный код ресурса (URI) хранилища BLOB-объектов Azure для задания ASA ребра. Дополнительные сведения о публикации задания ASA ребра см. в статье [Публикация задания с ребром ASA для базы данных SQL]().
