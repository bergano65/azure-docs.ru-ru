...
Одно из наиболее распространенных требований — возможность отправки push-уведомлений пользователям с помощью мобильных приложений при определенных событиях в серверной системе. например клиент банка, у кого есть банковское приложение на устройстве iPhone хочет получать уведомления при списании со, превышающих определенную сумму из учетной записи или интрасети, где требуется сотрудник из финансового отдела, у кого есть приложение для утверждения бюджета на Windows Phone  Чтобы получать уведомления при получении запроса на утверждение.
...
2. Запустите **EnterprisePushMobileApp**, которая запускает приложение Windows Store.
