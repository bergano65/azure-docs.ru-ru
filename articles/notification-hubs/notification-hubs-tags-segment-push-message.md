...
На рисунке показано, что сообщение помечается `user_Alice` на все устройства `user_Alice`, помеченные как.
...
Выражения тегов поддерживают общие логические операторы, такие `AND` как`&&`() `OR` ,`||`() и `NOT` (`!`); Они также могут содержать круглые скобки. Выражения тегов, использующие `OR` только операторы, могут ссылаться на 20 тегов. выражение с `AND` операторами, `OR` но ни один оператор не может ссылаться на 10 тегов; в противном случае выражения тегов ограничены 6 тегами.
