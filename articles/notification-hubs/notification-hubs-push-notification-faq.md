...
> [!NOTE]
> Общая стоимость использования может увеличиваться в зависимости от числа отправленных push-уведомлений. Ознакомьтесь с ограничениями для категорий на странице [Цены на центры уведомлений].
