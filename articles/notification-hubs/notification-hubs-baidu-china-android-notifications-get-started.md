...
* Пакет SDK для Android (предполагается, что вы используете Android Studio), который можно скачать с <a href="https://go.microsoft.com/fwlink/?LinkId=389797">сайта Android</a>.
