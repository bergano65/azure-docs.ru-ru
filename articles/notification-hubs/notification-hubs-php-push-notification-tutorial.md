...
* Следуйте инструкциям по [отправке push-уведомлений в приложения iOS с помощью центров уведомлений Azure](ios-sdk-get-started.md) для вашей мобильной платформы и реализации серверной части на PHP.
