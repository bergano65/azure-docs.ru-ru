...
1. На портале Azure в разделе **Концентратор уведомлений** выберите **Apple (APNS)**.
...
Дополнительные сведения см. в статье [Руководство. Отправка push-уведомлений в приложения iOS с помощью Центров уведомлений Azure](notification-hubs-ios-apple-push-notification-apns-get-started.md).
...
1. На портале Azure в разделе **Концентратор уведомлений** выберите **Google (GCM/FCM)**. 
...
1. На портале Azure в разделе **Концентратор уведомлений** выберите **Windows (WNS)**.
...
1. На портале Azure в разделе **Концентратор уведомлений** выберите **Windows Phone (MPNS)**.
...
1. На портале Azure в разделе **Концентратор уведомлений** выберите **Amazon (ADM)**.
...
1. На портале Azure в разделе **Концентратор уведомлений** выберите **Baidu (Android China)**. 
