---
title: Отправка push-уведомлений на определенные устройства iOS с помощью концентраторов уведомлений Azure Документы Майкрософт
...
---
# <a name="tutorial-send-push-notifications-to-specific-ios-devices-using-azure-notification-hubs"></a>Учебник: Отправка push-уведомлений на определенные устройства iOS с помощью концентраторов уведомлений Azure
