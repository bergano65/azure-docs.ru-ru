...
1. В вашей `Notification.h`, добавьте `retrieveLocale` метод и изменение хранилища и подписываться методы, как показано в следующем коде:
