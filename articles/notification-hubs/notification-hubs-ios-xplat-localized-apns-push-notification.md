...
ms.locfileid: "71211894"
---
# <a name="tutorial-push-localized-notifications-to-ios-devices-using-azure-notification-hubs"></a>Учебник. Отправка локализованных уведомлений на устройства iOS с помощью службы "Центры уведомлений Azure"
...
1. `Notification.h` В`retrieveLocale` добавьте метод и измените методы Store и Subscribe, как показано в следующем коде:
