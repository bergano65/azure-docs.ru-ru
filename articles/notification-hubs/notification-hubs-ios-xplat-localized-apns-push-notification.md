...
В `MainStoryboard_iPhone.storyboard`добавьте сегментированный элемент управления на три языка: Английский, французский и мандаринский диалект.
...
## <a name="build-the-ios-app"></a>сборка приложения iOS;

1. В `Notification.h`добавьте метод `retrieveLocale` и измените методы Store и Subscribe, как показано в следующем коде:
...
>[Отправка push-уведомлений конкретным адресатам](notification-hubs-aspnet-backend-ios-apple-apns-notification.md)
