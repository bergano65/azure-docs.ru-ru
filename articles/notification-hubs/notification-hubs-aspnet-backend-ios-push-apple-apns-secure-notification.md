---
title: Концентраторы уведомлений Azure Secure Push для iOS
...
Теперь, когда вы изменили приложение бэк-энд, чтобы отправить только *идентификатор* уведомления, вы должны изменить приложение iOS для обработки этого уведомления и перезвонить обратно обратно конца для получения безопасного сообщения, которое будет отображаться.
