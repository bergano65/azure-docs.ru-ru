...
В Центрах уведомлений Azure центр является наименьшим ресурсом или сущностью. Обычно он сопоставляется с одним приложением и может содержать один сертификат для каждого система отправки уведомлений платформы (PNS), поддерживаемого приложением. Приложение может быть гибридным или машинным, а также кросс-платформенным приложением.
...
Вы можете связать пространство имен с ценовыми категориями " **бесплатный**", " **базовый**" или " **стандартный** ". Для пространства имен можно использовать уровень, соответствующий вашим требованиям. В следующих разделах показано, как изменить ценовую категорию пространства имен Центров уведомлений.
...
3. Щелкните **Пространства имен концентратора уведомлений** в разделе **Интернет вещей**. Если нажать звездочку ( `*` ) рядом с текстом, он будет добавлен в левую панель навигации в разделе **Избранное**. Это помогает быстро перейти на страницу пространства имен. После добавления в Избранное выберите **пространства имен концентратора уведомлений**.
...
В следующей процедуре показано, как изменить ценовую категорию для пространства имен на странице центра. Несмотря на то что эти действия начинаются на странице центра, фактически ценовая категория изменяется для пространства имен и всех входящих в нее центров.
