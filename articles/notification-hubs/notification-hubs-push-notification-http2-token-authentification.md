...
После создания токена приложения можно скачать токен проверки подлинности. Дополнительные сведения о создании этого токена см. в [документации для разработчиков Apple](https://help.apple.com/xcode/mac/current/#/devdfd3d04a1).
