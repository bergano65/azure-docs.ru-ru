...
Дополнительные сведения см. в [документации по обнаружению и классификации данных SQL](/sql/relational-databases/security/sql-data-discovery-and-classification).
