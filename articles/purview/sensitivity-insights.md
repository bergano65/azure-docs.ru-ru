---
title: Метка конфиденциальности, сообщающая о данных в Azure зрения с помощью зрения Insights
description: В этом пошаговом руководство описано, как просмотреть и использовать отчет о метке чувствительности зрения для ваших данных.
author: batamig
ms.author: bagol
ms.service: purview
...
> [!NOTE]
> Метки конфиденциальности, обнаруженные в [Power BIных ресурсах](register-scan-power-bi-tenant.md) , которые просматриваются зрения, в настоящее время не отображаются в отчете о метке "Конфиденциальность". 
>
...
Зрения использует те же классификации, которые также известны как [типы конфиденциальных данных](/microsoft-365/compliance/sensitive-information-type-entity-definitions), как Microsoft 365. Это позволяет расширить существующие метки чувствительности в ресурсах Azure зрения.
