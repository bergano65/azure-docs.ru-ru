...
1. Щелкните **Подключить существующий**, чтобы подключить существующий диск данных к виртуальной машине.
    ...
    ![Снимок экрана, на котором показан выбранный параметр "диски" и выбран вариант "Присоединить существующий".](./media/devtest-lab-attach-detach-data-disk/devtest-lab-attach-existing-button.png)
...
1. В области сведений о диске вверху щелкните **Отключить**.
    ...
    ![На снимке экрана показана панель сведений о диске с выделенным действием "отсоединить".](./media/devtest-lab-attach-detach-data-disk/devtest-lab-detach-data-disk2.png)
