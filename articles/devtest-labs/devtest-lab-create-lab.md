...
1. В главном меню слева выберите **Все службы** (в верхней части списка). Выберите * (звездочку) рядом с полем **DevTest Labs** в разделе **DEVOPS**. После этого пункт **DevTest Labs** будет добавлен в левое меню навигации, чтобы вы в следующий раз могли легко открыть его. 

    ![Окно "Все службы". Выбор DevTest Labs](./media/devtest-lab-create-lab/all-services-select.png)
2. Теперь выберите **DevTest Labs** в левом меню навигации. На панели инструментов выберите **Добавить**. 
   
    ![Добавление лаборатории](./media/devtest-lab-create-lab/add-lab-button.png)
1. В окне **Создание DevTest Lab** сделайте следующее: 
    1. Введите **имя** лаборатории.
    2. Выберите **подписку** , которую необходимо связать с лабораторией.
    3. Введите **имя для группы ресурсов** лаборатории. 
    4. Выберите **расположение**, в котором будет храниться лаборатория.
    ...
    7. Нажмите кнопку **создания**. Вы можете отслеживать состояние создания лаборатории в области **Уведомления**. 
    
        ![Раздел "Создание лаборатории" в DevTest Labs](./media/devtest-lab-create-lab/create-devtestlab-blade.png)
    8. После завершения выберите **Перейти к ресурсу** в уведомлении. Можно также обновить страницу **DevTest Labs**, чтобы увидеть только что созданную лабораторию в списке лабораторий.  Выберите лабораторию в списке. После этого откроется домашняя страница лаборатории. 

        ![Домашняя страница лаборатории](./media/devtest-lab-create-lab/lab-home-page.png)
