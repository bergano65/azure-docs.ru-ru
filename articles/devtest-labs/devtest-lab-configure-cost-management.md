...
4. Выберите пункт **тенденция затрат** в разделе **Отслеживание затрат** в меню слева. На следующем снимке экрана показан пример диаграммы затрат. 
   ...
   * подписки CSP и Dreamspark в настоящее время не поддерживаются, так как для расчета затрат лаборатории Azure DevTest Labs использует интерфейсы API Azure для выставления счетов , а они не поддерживают указанные подписки;
