...
Сведения о развертывании узла бастиона в виртуальной сети см. в статье  [Создание узла бастиона для Azure](../bastion/tutorial-create-host-portal.md). При создании узла бастиона выберите виртуальную сеть лаборатории. 
