...
Дополнительные сведения см. в следующей статье: [как задать параметры хранения журнала](../azure-monitor/logs/manage-cost-storage.md#change-the-data-retention-period) .
...
Дополнительные сведения см. в следующей статье: [как предупредить о данных журнала Log Analytics](../azure-monitor/alerts/tutorial-response.md)
