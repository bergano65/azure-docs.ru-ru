...
**Руководство.** Используйте Azure Active Directory (Azure AD) Управление доступом на основе ролей (RBAC) для управления доступом к лабораториям в Azure DevTest Labs.
