...
1. После выбора виртуальной сети вы вернетесь в область **Виртуальная сеть**. Выберите подсеть из списка внизу.
   ...
   - Чтобы разрешить использование подсети в процессе создания виртуальной машины лаборатории, выберите **использовать при создании виртуальной машины**.
   ...
   - В поле **Максимальное число виртуальных машин на пользователя** укажите максимальное число виртуальных машин на пользователя для каждой подсети. Чтобы разрешить использовать неограниченное число виртуальных машин, оставьте это поле пустым.
...
[Документация по виртуальной сети](../virtual-network/index.yml) Azure содержит дополнительные сведения об использовании виртуальных сетей, включая инструкции по настройке виртуальной сети, управлению ею и ее подключению к вашей локальной сети.
