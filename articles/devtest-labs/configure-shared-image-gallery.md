...
ms.locfileid: "98788427"
---
# <a name="configure-a-shared-image-gallery-in-azure-devtest-labs"></a>Настройка коллекции общих образов в Azure DevTest Labs
DevTest Labs теперь поддерживает функцию [коллекции общих образов](../virtual-machines/shared-image-galleries.md) . Он позволяет пользователям лаборатории получать доступ к изображениям из общего расположения при создании лабораторных ресурсов. Кроме того, он позволяет создавать структуру и организацию для пользовательских управляемых образов виртуальных машин. Коллекция общих образов поддерживает следующие возможности.
...
Дополнительные сведения см. в [документации по общей коллекции образов](../virtual-machines/shared-image-galleries.md). 
...
> [!NOTE]
> Дополнительные сведения о затратах, связанных со службой коллекции общих образов, см. в разделе [выставление счетов для общей коллекции образов](../virtual-machines/shared-image-galleries.md#billing).
