...
## <a name="define-role-based-access-across-your-organization"></a>Определение доступа на основе ролей в Организации
### <a name="question"></a>Вопрос
Разделы справки определить управление доступом на основе ролей Azure для сред DevTest Labs, чтобы убедиться, что он может управлять, пока разработчики и тесты могут выполнять свою работу? 
