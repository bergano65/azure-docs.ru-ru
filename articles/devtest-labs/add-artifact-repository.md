...
В этом разделе приведен пример скрипта PowerShell, который можно использовать для добавления репозитория артефактов в лабораторию. Если у вас нет Azure PowerShell, см. Дополнительные инструкции по установке [и настройке Azure PowerShell](/powershell/azure/overview?view=azps-1.2.0) .
