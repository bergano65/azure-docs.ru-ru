...
- [Операции с сертификатами с помощью RESTFUL](/rest/api/keyvault/#certificate-operations)
...
- Назначение политики доступа (портал[CLI](assign-access-policy-cli.md)  |  [PowerShell](assign-access-policy-powershell.md)  |  [Portal](assign-access-policy-portal.md)). Key Vault поддерживает до 1024 записей политики доступа. Чтобы оставить это ограничение для пользователей, создайте Azure Active Directory группы безопасности, добавьте в эту группу всех связанных субъектов-служб, а затем предоставьте группе доступ к Key Vault.
