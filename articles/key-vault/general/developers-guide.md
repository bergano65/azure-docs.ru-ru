...
- Управление сертификатами Key Vault. Для получения дополнительной [информации см.](../certificates/about-certificates.md)

Для получения более подробной информации о Убежище ключей Azure, [см.](overview.md)
...
Дополнительные сведения об управляемых удостоверениях для ресурсов Azure см. в [обзоре управляемых удостоверений](../../active-directory/managed-identities-azure-resources/overview.md). Для получения дополнительной информации о работе [Integrating applications with Azure Active Directory](../../active-directory/develop/active-directory-integrating-applications.md)с Azure AD см.
...
- [Создание хранилищ ключей и управление ими с помощью CLI](../secrets/quick-create-cli.md).
- [Создание хранилищ ключей и управление ими с помощью PowerShell](../secrets/quick-create-powershell.md).
- [Создавайте и управляйте ключами Vaults с помощью порта Azure](../secrets/quick-create-portal.md)
- [Создавайте и управляйте ключами Vaults с помощью Python](../secrets/quick-create-python.md)
- [Создавайте и управляйте ключами Vaults с помощью Java](../secrets/quick-create-java.md)
- [Создавайте и управляйте ключами Vaults с помощью Node.js](../secrets/quick-create-node.md)
- [Создавайте и управляйте ключами Vaults с помощью .NET (v4 SDK)](../secrets/quick-create-net.md)
...
Дополнительные сведения о версии 2.x пакета SDK для .NET см. в [заметках о выпуске](dotnet2api-release-notes.md).
...
- [Использование Azure Key Vault из Web-приложений](../secrets/quick-create-net.md) — руководство по использованию Azure Key Vault из веб-приложений Azure. 
...
- [Настройка полной смены ключей и аудита в Key Vault](../secrets/key-rotation-log-monitoring.md) — руководство по настройке смены ключей и аудита журналов с помощью Azure Key Vault.
...
- [Key Vault мягкого удаления поведения](overview-soft-delete.md)) описывает функцию, которая позволяет восстановить удаленные объекты, было ли удаление случайным или преднамеренным.
...
- [Обзор ключей учетной записи хранилища Key Vault)](../secrets/overview-storage-keys.md) описывает ключи интеграции учетных записей системы хранения azure Key Vault.
