...
- [Создание хранилищ ключей и управление ими с помощью портал Azure](../secrets/quick-create-portal.md)
- [Создание хранилищ ключей и управление ими с помощью Python](../secrets/quick-create-python.md)
- [Создание хранилищ ключей и управление ими с помощью Java](../secrets/quick-create-java.md)
- [Создание хранилищ ключей и управление ими с помощью Node.js](../secrets/quick-create-node.md)
- [Создание хранилищ ключей и управление ими с помощью .NET (пакет SDK для версии 4)](../secrets/quick-create-net.md)
...
- [Key Vault режим обратимого удаления](overview-soft-delete.md)) Описывает функцию, позволяющую восстанавливать удаленные объекты, независимо от того, было ли удаление случайным или умышленно.
...
- [Общие сведения о ключах учетной записи хранения Key Vault](../secrets/overview-storage-keys.md)) Описание ключей Key Vault интеграции учетных записей хранения Azure.
