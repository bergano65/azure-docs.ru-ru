...
ms.locfileid: "91604353"
---
# <a name="azure-key-vault-recovery-overview"></a>Общие сведения о восстановлении Azure Key Vault
...
> [!IMPORTANT]
> Для всех хранилищ ключей необходимо включить защиту обратимого удаления. Возможность отключения защиты обратимого удаления будет прекращена до декабря 2020. Ознакомьтесь с подробными сведениями [ **здесь**.](soft-delete-change.md)
...
:::image type="content" source="../media/key-vault-recovery-1.png" alt-text="<снимок экрана портал Azure>":::
...
:::image type="content" source="../media/key-vault-recovery-2.png" alt-text="<снимок экрана портал Azure>":::
...
:::image type="content" source="../media/key-vault-recovery-3.png" alt-text="<снимок экрана портал Azure>":::

:::image type="content" source="../media/key-vault-recovery-4.png" alt-text="<снимок экрана портал Azure>":::
...
:::image type="content" source="../media/key-vault-recovery-5.png" alt-text="<снимок экрана портал Azure>":::
