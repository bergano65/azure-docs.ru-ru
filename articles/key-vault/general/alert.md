...
Когда вы начнете использовать хранилище ключей для хранения рабочих секретов, важно отслеживать работоспособность хранилища ключей, чтобы убедиться, что служба работает должным образом. После начала масштабирования службы количество запросов, отправленных в хранилище ключей, будет возрастать. Это может увеличить задержку запросов и в крайних случаях приводит к регулированию запросов, которые влияют на производительность службы. Кроме того, необходимо получать оповещения, если хранилище ключей отправляет необычное количество кодов ошибок, что позволяет быстро получать уведомления о любых проблемах, связанных с настройкой политики доступа или брандмауэра. В этом документе рассматриваются следующие темы:
...
> ![Снимок экрана портал Azure](../media/alert-1.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-2.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-3.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-4.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-5.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-6.png)

4. Выберите **+ Добавить группу действий**

> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-7.png)

5. Выберите **тип действия** для группы действий. В этом примере мы создадим оповещение по электронной почте.

> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-8.png)

> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-9.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-10.png)

2. Выберите **новое правило генерации оповещений**

> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-11.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-12.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-13.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-14.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-15.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-16.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-18.png)

6. Включение оповещения и назначение серьезности

> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-19.png)
...
> [!div class="mx-imgBorder"]
> ![Снимок экрана портал Azure](../media/alert-20.png)
