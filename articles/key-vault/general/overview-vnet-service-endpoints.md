...
|Служба хранилища Azure|[Шифрование службы хранилища использование ключей, управляемых клиентом, в Azure Key Vault](../../storage/common/storage-service-encryption-customer-managed-keys.md).|
