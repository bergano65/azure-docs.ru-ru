...
Защиту от очистки можно включить, только если включена функция удаления с возможностью восстановления. Отключение защиты от очистки в настоящее время не поддерживается. 
