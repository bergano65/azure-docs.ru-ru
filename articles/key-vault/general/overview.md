...
- **Хранение секретов, защищенных аппаратными модулями безопасности** — секреты, ключи и сертификаты в магазине шифруются с помощью программного ключа (уровень "Стандартный") или проверенного ключа HSM FIPS 140-2 уровня 2 (уровень "Премиум"). 
