...
Неполномочный ответ: адрес: 52.168.109.101 псевдонимы: fabrikam.vault.azure.net fabrikam.privatelink.vaultcore.azure.net data-prod-eus.vaultcore.azure.net data-prod-eus-region.vaultcore.azure.net
```
Linux:
