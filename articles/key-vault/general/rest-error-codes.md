...
Указанные пользователем сведения должны быть правильными:
...
- IP-адрес запрашивающего ресурса не утверждается в параметрах брандмауэра в хранилище ключей.
