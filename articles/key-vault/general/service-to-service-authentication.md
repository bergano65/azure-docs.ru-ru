...
> [!NOTE]
> Методы проверки подлинности, описанные в этой статье, больше не считаются рекомендациями. Мы рекомендуем применять обновленные методы проверки подлинности в [Azure Key Vault](authentication.md).
