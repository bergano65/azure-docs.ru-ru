...
|--|--|--|
| **Хранилища**|<ul><li>Ключи, защищенные программным обеспечением</li><li>Ключи с защитой HSM (с SKU Premium)</li><li>Сертификаты</li><li>Ключи учетной записи хранения</li></ul> | HTTPS://{имя хранилища}. Vault. Azure. NET
|**Управляемый HSM** |<ul><li>Ключи, защищенные модулем HSM</li></ul> | HTTPS://{HSM-Name}. манажедхсм. Azure. NET

Ниже приведены суффиксы URL-адресов, используемые для доступа к каждому типу объектов.

|Тип объекта|Суффикс URL-адреса|
|--|--|
|Ключи, защищенные программным обеспечением| /кэйс |
|Ключи, защищенные модулем HSM| /кэйс |
|Секреты|/секретс|
