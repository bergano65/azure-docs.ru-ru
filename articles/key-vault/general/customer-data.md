...
Soft-delete позволяет восстановить удаленные данные в течение 90 дней после удаления. При использовании "мягкого удаления" данные могут быть удалены навсегда до истечения 90-дневного срока хранения, выполняя операцию по удалению. Если в хранилище или подписке настроена блокировка операций очистки, невозможно окончательно удалить данные до тех пор, пока не пройдет запланированный период хранения.
...
- [Лазурный ключ Vault Logging](logging.md))
