...
- 4xx - Ошибка клиента: Используется для плохих запросов, отсутствующих ключей, ошибок синтаксиса, недействительных параметров, ошибок аутентификации и т.д. Тело ответа будет содержать подробное объяснение ошибки.  
