...
1. Добавьте Key Vault управляемую учетную запись хранения в хранилище. Установите `key1` в качестве активного ключа с периодом повторного создания в 180 дней.
