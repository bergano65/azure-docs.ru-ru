...
- Задает учетную запись с именем определения SAS `<YourSASDefinitionName>` на учетную запись хранения, управляемая KeyVault `<YourStorageAccountName>` в вашем хранилище `<VaultName>`. 
