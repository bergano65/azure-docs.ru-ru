...
Очистка ключа, секрета или сертификата приведет к окончательному удалению, то есть восстановить их будет невозможно. Однако содержащее его хранилище ключей останется без изменений, как и другие объекты, хранящиеся в нем. 
