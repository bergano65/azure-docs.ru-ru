...
3. **С помощью субъекта-службы и секрета:** 3-й вариант (который не рекомендуется использовать) — использовать субъект-службу и секретный ключ для проверки подлинности в Key Vault.
