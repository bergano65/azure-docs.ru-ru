...
Измените файл класса, чтобы он содержал код, приведенный в следующем трехэтапном процессе.
...
3. Добавление имени хранилища и имени секрета в запрос.
