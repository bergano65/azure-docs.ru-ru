...
При создании нового хранилища ключей обратимое удаление включено по умолчанию. Вы можете создать хранилище ключей без обратимого удаления с помощью [Azure CLI](key-vault-soft-delete-cli.md) или [Azure PowerShell](key-vault-soft-delete-powershell.md). После включения обратимого удаления в хранилище ключей его нельзя отключить.
