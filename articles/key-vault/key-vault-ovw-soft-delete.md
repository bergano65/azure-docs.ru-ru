...
[!NOTE] Обязательное предварительное условие для включения защиты от удаления — включенный параметр обратимого удаления. В Azure CLI 2 его можно включить с помощью команды:
