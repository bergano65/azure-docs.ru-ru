...
- Как отслеживать CSR или управлять им?
     ...
     См. статью [Мониторинг и администрирование процесса создания сертификатов](https://docs.microsoft.com/azure/key-vault/certificates/create-certificate-scenarios).
