...
1. На приведенной выше схеме приложение создает сертификат, который начинает создание ключа в хранилище ключей.
2. Key Vault отправляет запрос на сертификат TLS/SSL в ЦС.
...
4. CA отвечает на tLS/SSL-запрос Key Vault с сертификатом TLS/SSL.
5. Ваше новое создание сертификата завершается слиянием сертификата TLS/SSL X.509 для CA.
