...
| `RunAs=App` | [Управляемые идентификаторы для ресурсов Azure](../active-directory/managed-identities-azure-resources/index.yml) | `AzureServiceTokenProvider`использует управляемый итог для получения токена. |
