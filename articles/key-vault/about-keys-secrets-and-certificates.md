...
|`object-version`|`object-version` Представляет собой сформированный системой, 32 идентификатор символьной строки, который дополнительно используется * o адрес уникальной версии объекта.|  
