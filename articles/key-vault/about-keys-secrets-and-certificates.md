...
|`object-version`|`object-version` — это сформированный системой, 32 идентификатор символьной строки, который при необходимости можно использовать * o адрес уникальная версия объекта.|  
