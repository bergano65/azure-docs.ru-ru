...
| Аудиторы | None | Ключи: перечисление<br>Секреты: перечисление<br><br> **Примечание**. это разрешение позволяет аудиторам проверять атрибуты (Теги, даты активации, сроки действия) для ключей и секретов, не выдаваемых в журналах. |
