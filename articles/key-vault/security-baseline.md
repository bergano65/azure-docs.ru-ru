...
Общие сведения о тегах служб Azure:
...
Развертывание Azure AD Privileged Identity Management (PIM):
...
Azure Active Directory отчеты и документация по мониторингу: https://docs.microsoft.com/azure/active-directory/reports-monitoring/
...
**Руководство**. Если вы используете пользовательские определения политики Azure для ресурсов с поддержкой Azure Key Vault, используйте Azure DevOps/репозиториев для безопасного хранения кода и управления им.
