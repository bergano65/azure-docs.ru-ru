...
## <a name="key-types-protection-methods-and-algorithms"></a>Типы ключей, методы и алгоритмы защиты
...
- **AES-GCM** — шифрование AES в режиме счетчика с аутентификацией Галуа ([NIST SP800-38d](https://csrc.nist.gov/publications/sp800)).
- **AES-CBC** — шифрование AES в режиме сцепления блоков шифра ([NIST SP800-38A](https://csrc.nist.gov/publications/sp800)).
