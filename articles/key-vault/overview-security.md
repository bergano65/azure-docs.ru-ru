...
Для получения дополнительной информации о сетевом адресе Azure Key Vault просмотрите [конечные точки виртуального сетевого обслуживания для Azure Key Vault](key-vault-overview-vnet-service-endpoints.md)
...
- [Конечные точки служб для виртуальной сети для Azure Key Vault](key-vault-overview-vnet-service-endpoints.md)
- [RBAC: встроенные роли](../role-based-access-control/built-in-roles.md)
- [виртуальные конечные точки сетевого обслуживания для Azure Key Vault](key-vault-overview-vnet-service-endpoints.md)
