...
Во-первых, включите лесозаготовки. Для получения инструкций о том, как это сделать, смотрите [журнал Azure Key Vault.](key-vault-logging.md)
...
Как правило, запросы в Key Vault ограничены 2000 запросами/10 секундами. Исключениями являются ключевые операции, как это описано в [лимитах службы Key Vault](key-vault-service-limits.md)
...
- При задушии Key Vault адаптируйте запрашивающий код для использования экспоненциального отката для повторной попытки. Алгоритм объясняется здесь: [Как задушить ваше приложение](key-vault-ovw-throttling.md#how-to-throttle-your-app-in-response-to-service-limits)
...
Подробное руководство, включая запрос на увеличение лимитов, можно найти здесь: [Key Vault регулирования руководства](key-vault-ovw-throttling.md)
