...
> [!TIP]
> Azure AD предоставляет каждому зарегистрированному приложению **[субъект-службу](/azure/active-directory/develop/developer-glossary#service-principal-object)**, который используется в качестве удостоверения приложения. Субъект-служба может затем получить авторизацию для доступа к другим ресурсам Azure, например Key Vault, посредством управления доступом на основе ролей (RBAC). Key Vault — это приложение корпорации Майкрософт. Поэтому оно предварительно зарегистрировано во всех арендаторах Azure AD с идентификатором "cfa8b339-82a2-471a-a3c9-0fc0be7a4093".
...
- [Ссылка на PowerShell для Key Vault](/powershell/module/azurerm.keyvault/)
