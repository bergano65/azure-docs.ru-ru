...
Теперь можно воспользоваться командлетом [Get-AzKeyVaultSecret](/powershell/module/az.keyvault/get-azkeyvaultsecret) и свойством `Name` секрета для просмотра содержимого этого секрета.
