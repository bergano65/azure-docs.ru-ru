...
Дополнительные сведения об атрибутах секретов см. в статье [Сведения о секретах Azure Key Vault](https://docs.microsoft.com/azure/key-vault/secrets/about-secrets).
