...
Дополнительные сведения о секретах см. здесь: (about-secrets.md).
...
Вы можете создать Key Vault с помощью Azure CLI или PowerShell: [Создание Key Vault с помощью PowerShell](../general/quick-create-powershell.md)
