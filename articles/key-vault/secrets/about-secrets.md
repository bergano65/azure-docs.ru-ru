...
Key Vault может управлять ключами [учетных записей хранения Azure](../../storage/common/storage-account-overview.md):
...
- [Ключи доступа к учетной записи хранения](../../storage/common/storage-account-keys-manage.md)
