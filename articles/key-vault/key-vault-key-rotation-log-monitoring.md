...
Сначала нужно включить ведение журнала в хранилище ключей. Используйте следующие команды PowerShell. (Вы можете увидеть полную информацию в [этой статье о ключе-vault-logging](key-vault-logging.md).)
