...
> [!NOTE]
> Для получения дополнительной информации о [What is Azure Key Vault?](key-vault-overview.md) Убежище ключей Azure см.  
...
Следуйте [рекомендациям Key Vault,](key-vault-best-practices.md) чтобы обеспечить безопасность, долговечность и мониторинг ключей.
