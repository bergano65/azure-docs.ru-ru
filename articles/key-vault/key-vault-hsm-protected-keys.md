...
nCipher безопасность, Entrust Datacardная компания, — лидер на рынке HSM общего назначения, позволяющий ведущим организациям, обеспечивая доверие, целостность и контроль над важной бизнес-информацией и приложениями. криптографические решения nCipher защищают новые технологии — облако, IoT, блокчейн, цифровые платежи и помогают удовлетворить требования соответствия новым требованиям, используя те же проверенные технологии, которые глобальные организации зависят от угроз для защиты конфиденциальные данные, сетевые подключения и инфраструктура предприятия. nCipher обеспечивает доверие для критически важных для бизнеса приложений, обеспечивая целостность данных и помещая клиентов в полный контроль — сегодня, завтра, в любое время.
...
> 
> Мир безопасности, созданный с помощью Нев-Ворлд. exe, который поставляется с nCipher Software версии 12,50, несовместим с этой процедурой BYOK. Доступны два варианта:
> 1) Понизить версию программного обеспечения nCipher до 12.40.2, чтобы создать новый мир безопасности.
> 2) Обратитесь в службу поддержки nCipher и попросите их предоставить исправление для версии программного обеспечения 12,50, которое позволяет использовать 12.40.2 версию Нев-Ворлд. exe, совместимую с этой процедурой BYOK.
