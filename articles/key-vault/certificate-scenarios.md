...
-   Подключение ИТ-администратора, администратора PKI или любого управляющего учетными записями в центрах сертификации для данной компании (например, Contoso) является необходимым условием для использования сертификатов Key Vault.  
    ...
    -   Глобалсигн-Key Vault предлагает OV SSL-сертификаты с Глобалсигн.  
...
При слиянии сертификатов мы поддерживаем два формата на основе PEM. Можно либо объединить один сертификат в кодировке PKCS # 8, либо файл P7B в кодировке Base64. -----НАЧАТЬ СЕРТИФИКАТ----------КОНЕЧНЫЙ СЕРТИФИКАТ-----
