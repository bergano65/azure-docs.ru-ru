...
[Операция получения сертификата](/rest/api/keyvault/getcertificateoperation/getcertificateoperation)  
...
### <a name="formats-of-import-we-support"></a>Форматы импорта, мы поддерживаем
Мы поддерживаем следующий тип импорта PEM-формате. Один сертификат в кодировке PEM вместе с PKCS 8 закодированы в незашифрованный ключ, который содержит следующие

---BEGIN CERTIFICATE------END CERTIFICATE---

---BEGIN PRIVATE KEY------КОНЕЦ ЛИЧНОГО КЛЮЧА---

По объединению сертификат мы поддерживаем 2 форматов на основе PEM. Либо можно объединить в один сертификат PKCS 8 кодировке или файла p7b – в кодировке base64. ---BEGIN CERTIFICATE------END CERTIFICATE---

Ключи EC сейчас не поддерживается в PEM-формате.
