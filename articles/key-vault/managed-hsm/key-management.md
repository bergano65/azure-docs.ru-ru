...
В следующем примере показано, как создать 3070-битный ключ **RSA**, который будет использоваться только для операций **wrapKey и unwrapKey** (задаются параметром --ops). 
...
В следующем примере показано, как создать 3070-битный **симметричный** ключ, который будет использоваться только для операций **encrypt и decrypt** (задаются параметром --ops).
