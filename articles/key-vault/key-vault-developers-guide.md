...
- [Создание хранилищ ключей и управление ими с помощью PowerShell](key-vault-overview.md).
...
[Справочник по API .NET для Key Vault](/dotnet/api/microsoft.azure.keyvault).
...
[Модули Azure Key Vault для Node.js](/nodejs/api/overview/azure/key-vault)

#### <a name="python"></a>Python

[Библиотеки Azure Key Vault для Python](/python/api/overview/azure/key-vault)

#### <a name="azure-cli-2"></a>Azure CLI 2

[Azure CLI для Key Vault](/cli/azure/keyvault)

#### <a name="azure-powershell"></a>Azure PowerShell 

[Azure PowerShell для Key Vault](/powershell/module/az.keyvault/?view=azps-1.2.0#key_vault)

### <a name="quickstart-guides"></a>Краткие руководства

- [Создание хранилища ключей](https://github.com/Azure/azure-quickstart-templates/tree/master/101-key-vault-create)
- [Приступая к работе с Key Vault в Node.js](https://github.com/Azure-Samples/key-vault-node-getting-started)
...
## <a name="social"></a>Социальное взаимодействие
