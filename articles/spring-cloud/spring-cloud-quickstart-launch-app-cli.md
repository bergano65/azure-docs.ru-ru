...
Azure Spring Cloud позволяет легко запустить приложение для микрослужб на основу Spring Boot в Azure.  Перед выполнением этого примера вы можете ознакомиться с [базовым кратким руководством](spring-cloud-quickstart.md).
...
3. Перейдите по URL-адресу, полученному с помощью предыдущей команды, чтобы запустить приложение PiggyMetrics.
    ![Запущенное приложения PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. Выберите **шлюз**.
    ...
    ![Выбор шлюза для приложения PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. Найдите URL-адрес на странице **общих сведений о шлюзе**. ![Дальнейшие действия по выбору шлюза для приложения PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
