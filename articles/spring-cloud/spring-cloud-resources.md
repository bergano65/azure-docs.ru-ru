...
* [Страница "Часто задаваемые вопросы" на сайте Майкрософт](https://docs.microsoft.com/answers/topics/azure-spring-cloud.html)
* [Веб-сайт Java Spring Cloud](https://spring.io/)
* [Платформа Spring](https://cloud.spring.io/spring-cloud-azure/)
* [Spring в Azure](https://docs.microsoft.com/azure/developer/java/spring-framework/)
