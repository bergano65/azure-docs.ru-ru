...
> [!TIP]
> Если вы используете частный репозиторий для сервера конфигурации, см. наш [учебник по настройке аутентификации](./spring-cloud-tutorial-config-server.md).
