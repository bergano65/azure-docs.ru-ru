...
* `server.port`не допускается в файле конфигурации из репозитория Git. Его добавление в файл конфигурации, скорее всего, сделает приложение недоступным из других приложений или Интернета.
