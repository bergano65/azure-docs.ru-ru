...
### <a name="how-often-will-os-security-patches-be-applied"></a>Как часто будут применяться исправления безопасности ОС?

Исправления безопасности, применимые к облаку Azure для весны, будут выдаваться в эксплуатацию ежемесячно.
Критические исправления безопасности (CVE Score >= 9), применимые к облаку Azure с пружинным облаком, будут как можно быстрее.
...
## <a name="trouble-shooting"></a>Устранение проблем
