...
| Ошибка | Не удалось достичь цели, которая *завершилась успешно* . |
...
| Ошибка | Экземпляру приложения не удалось запустить двоичный файл пользователя после нескольких попыток. |
