...
>|----|----|----|------------|
>| Глобальная ошибка Tomcat | Tomcat. Global. Error | Count | Число ошибок, возникших при обработке запросов |
...
>| Счетчик приостановки GC | виртуальной машины Java. GC. Pause (Итого — число) | Count | Общее число GC после запуска этого ЖМВ, включая Титов и Old GC. |
...
>| Общее число запросов Tomcat | Tomcat. Global. Request (всего — Count) | Count | Общее число обработанных запросов веб-сервера Tomcat |
...
>| Имя | Имя метрики пружинного выключателя | Единицы | Сведения |
>|----|----|----|------------|
>| Максимальное число активных сеансов Tomcat | Tomcat. Sessions. Active. Max | Count | Максимальное количество сеансов, которые были активными одновременно |
...
>| Число созданных сеансов Tomcat | Tomcat. Sessions. Created | Count | Число созданных сеансов |
>| Счетчик с истекшим сроком действия сеанса Tomcat | Tomcat. Sessions. Expires | Count | Число просроченных сеансов |
>| Число отклоненных сеансов Tomcat | Tomcat. Sessions. отклонено | Count | Число сеансов, которые не были созданы, так как достигнуто максимальное число активных сеансов. |
