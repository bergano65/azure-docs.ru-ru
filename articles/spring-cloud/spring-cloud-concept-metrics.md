...
>|----|----|----|------------|
>| Глобальная ошибка Tomcat | Tomcat. Global. Error | Число | Число ошибок, возникших при обработке запросов |
...
>| Счетчик приостановки GC | виртуальной машины Java. GC. Pause (Итого — число) | Число | Общее число GC после запуска этого ЖМВ, включая Титов и Old GC. |
>| Общее время приостановки сборки мусора | виртуальной машины Java. GC. Pause (всего-время) | Миллисекунд | Общее время, затраченное на сборку мусора после запуска ЖМВ, включая Титов и Old GC. |
...
>| Общее время запроса Tomcat | Tomcat. Global. Request (всего-Time) | Миллисекунд | Общее время Tomcat веб-сервера для обработки запросов |
>| Общее число запросов Tomcat | Tomcat. Global. Request (всего — Count) | Число | Общее число обработанных запросов веб-сервера Tomcat |
>| Максимальное время запроса Tomcat | Tomcat. Global. Request. Max | Миллисекунд | Максимальное время, в течение которого веб-сервер Tomcat обработать запрос |

### <a name="session"></a>Сеанс
>[!div class="mx-tdCol2BreakAll"]
>| Имя | Имя метрики пружинного выключателя | Единицы | Сведения |
>|----|----|----|------------|
>| Максимальное число активных сеансов Tomcat | Tomcat. Sessions. Active. Max | Число | Максимальное количество сеансов, которые были активными одновременно |
>| Максимальное время активности сеанса Tomcat | Tomcat. Sessions. Alive. Max | Миллисекунд | Наибольшее время (в секундах), в течение которого истек срок действия сеанса |
>| Число созданных сеансов Tomcat | Tomcat. Sessions. Created | Число | Число созданных сеансов |
>| Счетчик с истекшим сроком действия сеанса Tomcat | Tomcat. Sessions. Expires | Число | Число просроченных сеансов |
>| Число отклоненных сеансов Tomcat | Tomcat. Sessions. отклонено | Число | Число сеансов, которые не были созданы, так как достигнуто максимальное число активных сеансов. |
