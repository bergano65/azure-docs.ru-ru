...
Необходимо зарегистрировать поставщиков ресурсов Azure Spring Cloud *Microsoft.AppPlatform* и *Microsoft.ContainerService* в соответствии с инструкциями по [регистрации поставщика ресурсов на портале Azure](../azure-resource-manager/management/resource-providers-and-types.md#azure-portal) или с помощью следующей команды az CLI:
...
1. Снова выберите **Добавление подсети**, а затем введите имя (например, *apps-subnet*) поле **Имя подсети** и диапазон адресов (например, 10.1.1.0/24) в поле **Диапазон адресов подсети**.  Нажмите кнопку **Добавить**.
