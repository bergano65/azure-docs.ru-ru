...
Внесение дополнений в проекты с открытым исходным кодом заключается не только в публикации обновлений. Это также подразумевает информирование нас о существующих проблемах. Дополнительные сведения см. в нашем [руководстве участника](CONTRIBUTING.md).
...
* Расширение [Docs Authoring Pack](https://marketplace.visualstudio.com/items?itemName=docsmsft.docs-authoring-pack) для Visual Studio Code
...
Сведения о лицензировании см. здесь: [LICENSE](LICENSE), [LICENSE-CODE](LICENSE-CODE) и [ThirdPartyNotices](ThirdPartyNotices.md).
