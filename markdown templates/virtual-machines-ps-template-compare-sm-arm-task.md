...
В этой статье показано, как решается [задача] с помощью команд в модулях Azure и Azure Resource Manager. Это поможет вам изучить новые команды, а также перенести имеющиеся сценарии в новые команды.
