...
ms.locfileid: "67185784"
---
1. В обозревателе решений Visual Studio щелкните правой кнопкой мыши проект приложения для Магазина Windows. Затем выберите **Приложение Store** > **Associate с Магазином**.
...
5. Перейдите в [Центр разработки для Windows](https://dev.windows.com/en-us/overview) и войдите в систему, используя учетную запись Майкрософт. В разделе **Мои приложения** выберите регистрацию нового приложения. Затем расширьте уведомления **Служб** > **push.**
