...
Во время подготовки диска для хранилища класса Premium количество поддерживаемых им операций ввода-вывода в секунду и пропускная способность (полоса пропускания) зависят от его размера. Azure предлагает восемь типов общедоступных дисков для хранилища (цен. категория "Премиум"): P4, P6, P10 и P15 (только для службы "Управляемые диски"), а также P20, P30, P40 и P50. Кроме того, доступны три типа дисков в предварительной версии: P60, P70 и P80. Каждый из них отличается определенными ограничениями относительно количества операций ввода-вывода в секунду и пропускной способности, которые указаны в следующей таблице.
