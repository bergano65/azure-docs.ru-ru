...
ms.locfileid: "75384730"
---
## <a name="create-an-azure-resource"></a>Создание ресурса Azure

Начните использовать API "Автозаполнение Bing", создав один из следующих ресурсов Azure.
...
* [Создайте ресурс Автозаполнения Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingAutosuggest-v7):
    ...
    * API "Автозаполнение Bing" также предлагается на платных уровнях [ресурса поиска Bing версии 7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7).
