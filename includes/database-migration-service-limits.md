...
| --- | --- | --- |
| Максимальное количество служб на одну подписку для одного региона |2 | Чтобы запросить увеличение предела, обратитесь в службу поддержки. |
