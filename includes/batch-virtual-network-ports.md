...
| Исходные IP-адреса | Тег службы источника | Исходные порты | Место назначения | Конечные порты | Протокол | Действия |
| --- | --- | --- | --- | --- | --- | --- |
| Н/Д | [тег службы](../articles/virtual-network/security-overview.md#service-tags) `BatchNodeManagement` | * | Любой | 29876–29877 | TCP | Allow |
...
| Источник | Исходные порты | Место назначения | Тег целевой службы | Конечные порты | Протокол | Действия |
| --- | --- | --- | --- | --- | --- | --- |
| Любой | * | [Тег службы](../articles/virtual-network/security-overview.md#service-tags) | `Storage` (в том же регионе, что и учетная запись пакетной службы и виртуальная сеть) | 443 | TCP | Allow |
...
| Исходные IP-адреса | Исходные порты | Место назначения | Конечные порты | Протокол | Действия |
| --- | --- | --- | --- | --- | --- |
...
| Источник | Исходные порты | Место назначения | Конечные порты | Протокол | Действия |
| --- | --- | --- | --- | --- | --- |
