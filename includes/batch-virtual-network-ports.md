...
| Исходные IP-адреса | Тег службы источника | Исходные порты | Destination | Конечные порты | Протокол | Действие |
| --- | --- | --- | --- | --- | --- | --- |
| Н/Д | `BatchNodeManagement`[Тег службы](../articles/virtual-network/security-overview.md#service-tags) (если используется региональный вариант в том же регионе, что и учетная запись пакетной функции) | * | Любой | 29876–29877 | TCP | Allow |
| Исходные IP-адреса пользователей для удаленного доступа к вычислительным узлам и (или) подсети вычислительных узлов для задач с несколькими экземплярами Linux, если это необходимо. | Н/Д | * | Любой | 3389 (Windows), 22 (Linux) | TCP | Allow |
...
| Источник | Исходные порты | Destination | Тег целевой службы | Конечные порты | Протокол | Действие |
| --- | --- | --- | --- | --- | --- | --- |
...
| Исходные IP-адреса | Исходные порты | Destination | Конечные порты | Протокол | Действие |
| --- | --- | --- | --- | --- | --- |
...
| Источник | Исходные порты | Destination | Конечные порты | Протокол | Действие |
| --- | --- | --- | --- | --- | --- |
