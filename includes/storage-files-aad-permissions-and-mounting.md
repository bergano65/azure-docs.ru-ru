...
Следующий процесс проверяет, что ваша доля файла и разрешения доступа были настроены правильно и что вы можете получить доступ к совместной акции Azure File из домена, объединенного VM:
