...
1. Выберите **Compute** > **приложение-функция**вычислений.
...
1. Введите следующие параметры размещения.
    ...
    | **[План](../articles/azure-functions/functions-scale.md)** | Premium | В поле Тип плана выберите **Premium (Предварительная версия)** и выберите значения по умолчанию для параметров *план Windows* и *SKU и размер* . |
