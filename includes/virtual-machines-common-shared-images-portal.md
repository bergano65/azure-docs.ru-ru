...
> [!NOTE]
> Если вы зарегистрировались для использования общих коллекций образов в режиме предварительной версии, может потребоваться повторная регистрация `Microsoft.Compute` поставщика. Откройте [Cloud Shell](https://shell.azure.com/bash) и введите:`az provider register -n Microsoft.Compute`
