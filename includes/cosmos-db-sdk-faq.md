...
**2. Могут ли клиенты авторприложений использовать «быть» ушедшим в отставку Azure Cosmos DB SDK в течение 12 месяцев?** 
...
**3. Могут ли клиенты авторить и модифицировать приложения с помощью ушедшего в отставку Azure Cosmos DB SDK после 12-месячного периода уведомления?**
...
**4. Что происходит с запущенными приложениями клиента, использующими неподдерживаемую версию Azure Cosmos DB SDK?**
...
**5. Будут ли новые функции и функциональные возможности применяться ко всем неотставным SDK?**
