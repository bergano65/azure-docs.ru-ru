...
Дополнительные сведения о гибкости размера экземпляров см. [в статье гибкость размера виртуальной машины с](../articles/virtual-machines/windows/reserved-vm-instance-size-flexibility.md)зарезервированными экземплярами виртуальных машин.
...
Зарезервированный экземпляр виртуальной машины можно купить в [портал Azure](https://portal.azure.com/#blade/Microsoft_Azure_Reservations/CreateBlade/referrer/documentation/filters/%7B%22reservedResourceType%22%3A%22VirtualMachines%22%7D).
...
Если необходимо отменить резервирование, возможно, с вас будет взиматься плата за досрочное аннулирование (12 %). Сумма возмещенных средств основывается на наименьшей стоимости, например на стоимости покупки или текущей стоимости резервирования. Максимальная сумма возмещенных средств — 50 000 долл. США в год. Полученные возмещенные средства включают оставшийся пропорциональный баланс за вычетом 12 % за досрочное аннулирование. Чтобы отменить операцию, перейдите к зарезервированию в портал Azure и выберите **Возврат**.

Если необходимо изменить зарезервированное резервирование экземпляров виртуальных машин на другой регион, группу размера виртуальной машины или термин, вы можете обмениваться данными. Exchange должен быть для другого резервирования с равным или большим значением. При обмене дата начала использования для нового резервирования не переносится из текущего резервирования. Первый или третий год начинается с момента создания нового резервирования. Чтобы выполнить обмен, перейдите к зарезервированию в портал Azure и выберите **Exchange**.

Дополнительные сведения об обмене и возмещении резервирования см. в статье [Обмен резервированиями и](../articles/billing/billing-azure-reservations-self-service-exchange-and-refund.md)возврат денег.
