...
В полях "Подкатегория измерения" и "Продукт" в данных об использовании не различаются размеры виртуальных машин, которые используют Службу хранилища (цен. категория "Премиум"), и виртуальных машин, которые не используют эту службу. Если вы используете эти поля для определения размера виртуальной машины для резервирования, вы можете купить неправильный размер и не получить ожидаемую скидку на резервирование. Чтобы определить правильный размер виртуальной машины при покупке резервирования, используйте один из следующих методов.

- Чтобы правильно определить размер виртуальной машины, см. поле AdditionalInfo в файле использования или API использования. Не используйте значения из полей "Подкатегория измерения" или "Продукт". Эти поля не видят различий между версией S и другими версиями виртуальных машин.
- Получите точную информацию о размере виртуальной машины из сведений о виртуальной машине на портале Azure или с помощью Powershell или Azure Resource Manager.

Reserved VM Instances доступны почти для всех размеров виртуальных машин за некоторыми исключениями.

- Скидка на резервирование не распространяется на следующие виртуальные машины:
  - виртуальные машины серии A, Av2 или G;
  - предварительные версии виртуальных машин (любой серии и любого размера).
- Облако. Резервирования недоступны для приобретения в Германии и Китае.
- Недостаточная квота. Если резервирование привязано к одной конкретной подписке, эта подписка должна иметь свободную квоту виртуальных ЦП для размещения нового зарезервированного экземпляра. Например, если целевая подписка имеет квоту на 10 виртуальных ЦП для серии D, вы не сможете приобрести резервирование для 11 экземпляров Standard_D1. При проверке квоты для резервирования учитываются все виртуальные машины, уже размещенные в подписке. Например, если подписка имеет квоту на 10 виртуальных ЦП для серии D и два развернутых экземпляра Standard_D1, в этой подписке можно приобрести резервирование для 10 экземпляров Standard_D1.
...
4. Заполните обязательные поля. Работающие экземпляры виртуальной машины, соответствующие выбранным атрибутам, подходят для получения скидки на резервирование. Фактическое число экземпляров виртуальной машины, получающих скидку, зависит от области и выбранного количества.
    ...
    |Подписка|Подписка, используемая для оплаты резервирования. Резервирование оплачивается предварительно с помощью метода оплаты, указанного для подписки. Нужно выбрать подписку с соглашением Enterprise (номера предложения: MS-AZR-0017P или MS-AZR-0148P) или подписку с оплатой по мере использования (номера предложения: MS-AZR-0003P или MS-AZR 0023P). Для подписки с соглашением Enterprise плата вычитается из баланса денежных обязательств или относится к избыточным расходам. Для подписки с оплатой по мере использования плата взимается с помощью метода оплаты (кредитной карты или счета), указанного для подписки.|    
