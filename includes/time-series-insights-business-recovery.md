...
* Используйте вашей второй регион для резервного копирования и восстановления любых данных телеметрии и запроса TSI.
