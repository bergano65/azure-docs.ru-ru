...
1. По завершении выберите **Next: Size and scale** (Далее: размер и масштаб), чтобы продолжить создание концентратора.
   ...
   На панели **Размер и масштабирование** вы можете принять настройки по умолчанию и щелкнуть **Просмотр и создание** внизу страницы. Следуйте приведенным ниже рекомендациям.
