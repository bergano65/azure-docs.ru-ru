...
Чтобы продолжить работу с IoT Hub и шаблонами управления устройствами, такими как удаленное обновление прошивки, см. [Как сделать обновление прошивки.](../articles/iot-hub/tutorial-firmware-update.md)

Чтобы узнать, как расширить решение IoT и запланировать вызовы метода на нескольких устройствах, см [Расписание и трансляция заданий.](../articles/iot-hub/iot-hub-node-node-schedule-jobs.md)