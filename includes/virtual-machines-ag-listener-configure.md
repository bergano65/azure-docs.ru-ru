...
1. <a name="getnet"></a>Получите название ресурса кластерной сети.
...
1. <a name="addcap"></a>Добавьте точку доступа клиента.  
    ...
    b. В панели **ролей,** право нажмите имя группы доступности, а затем выберите **Добавить ресурс** > **клиента точка доступа.**
...
1. <a name="congroup"></a>Нанастройка ресурса IP для группы доступности.
...
1. <a name = "dependencyGroup"></a>Сделайте ресурс группы доступности сервера s'L зависимым от точки доступа клиента.
...
1. <a name="listname"></a>Сделайте ресурс точки доступа клиента зависимым от IP-адреса.
   ...
   ![Ресурс IP-адреса](./media/virtual-machines-ag-listener-configure/98-dependencies.png) 
    ...
    c. Нажмите на вкладку **"Зависимости."** Убедитесь, что IP-адрес является зависимостью. В противном случае укажите IP-адрес в качестве зависимости. Если в списке несколько ресурсов, убедитесь, что IP-адреса имеют зависимости OR, а не AND. Нажмите кнопку **ОК**. 
...
1. Получите имя IP-адреса для кластера WSFC. В **Failover кластерный менеджер** под **кластерными основными ресурсами**найдите **имя сервера.**
