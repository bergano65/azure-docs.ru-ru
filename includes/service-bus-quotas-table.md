...
| Максимальное число пространств имен уровня "премиум" в подписке Azure |Пространство имен |Последующие запросы на дополнительные пространства имен уровня "премиум" отклоняются порталом. |50 |
