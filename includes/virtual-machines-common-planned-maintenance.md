...
- Если для обслуживания требуется перезагрузка, вы получите уведомление во время планирования обслуживания. Azure предоставит вам возможность начать обслуживание самостоятельно в удобное для вас время. В Azure большое внимание уделяется технологиям, позволяющим сократить число случаев, когда для планового обслуживания платформы требуется перезагрузка виртуальных машин. 
...
Цель большинства обслуживания, который не требует перезагрузки — менее 10 секунд, приостановку для виртуальной Машины. В некоторых случаях используются механизмы обслуживания с сохранением памяти, которые приостанавливают виртуальную машину максимум на 30 секунд, сохраняя память в ОЗУ. Затем работа виртуальной машины возобновляется, а ее часы автоматически синхронизируются. В Azure все чаще используются технологии динамической миграции и вносятся улучшения в механизм обслуживания с сохранением памяти, необходимые для уменьшения длительности паузы.
...
**Период самообслуживания** позволяет вам начинать обслуживание на виртуальных машинах. В течение этого времени вы можете отправить запрос на каждую виртуальную машину, чтобы оценить ее состояние и проверить результат последнего запроса на обслуживание.
