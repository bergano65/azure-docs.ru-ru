...
Ниже приведены доступные размеры для управляемых дисков ценовой категории "Премиум". Размеры, помеченные звездочкой, сейчас доступны в предварительной версии.

| **Тип управляемого диска SSD <br>(цен. категории "Премиум")** | **P4** | **P6** | **P10** | **P15** | **P20** | **P30** | **P40** | **P50** | **P60*** | **P70*** | **P80*** |
|------------------|---------|---------|--------|--------|--------|----------------|----------------|----------------|----------------|----------------|----------------|
...
Ниже приведены доступные размеры для управляемых дисков SSD ценовой категории "Стандартный". Размеры, помеченные звездочкой, сейчас доступны в предварительной версии.

| **Тип управляемого диска SSD <br>уровня "Стандартный"** | **E4** | **E6** | **E10** | **E15** | **E20** | **E30** | **E40** | **E50** | **E60*** | **E70*** | **E80*** |
|------------------|---------|---------|--------|--------|--------|----------------|----------------|----------------|----------------|----------------|----------------|
| Размер диска        | 32 Гиб | 64 Гиб | 128 ГБ | 256 Гиб | 512 ГБ | 1024 Гиб (1 ТиБ) | 2048 Гиб (2 ТиБ) | 4095 Гиб (4 ТиБ) | 8192 Гиб (8 ТиБ) | 16 384 ГиБ (16 ТиБ) | 32 767 Гиб (32 Тиб) |

Ниже приведены доступные размеры для управляемых дисков HDD ценовой категории "Стандартный". Размеры, помеченные звездочкой, сейчас доступны в предварительной версии.

| **Тип управляемых дисков HDD <br>уровня "Стандартный"** | **S4** | **S6** | **S10** | **S15** | **S20** | **S30** | **S40** | **S50** | **S60*** | **S70*** | **S80*** |
|------------------|---------|---------|--------|--------|--------|----------------|----------------|----------------|----------------|----------------|----------------|
| Размер диска        | 32 Гиб  | 64 Гиб  | 128 ГБ | 256 Гиб | 512 ГБ | 1024 Гиб (1 ТиБ) | 2048 Гиб (2 ТиБ) | 4095 Гиб (4 ТиБ) | 8192 Гиб (8 ТиБ) | 16 384 ГиБ (16 ТиБ) | 32 767 Гиб (32 Тиб) |

**Количество транзакций.** Счет выставляется за количество транзакций, выполняемых на управляемом диске ценовой категории "Стандартный".
