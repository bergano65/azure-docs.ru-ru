...
Отчеты также можно просматривать с помощью меню отчетов в верхней части портала. Давайте посмотрим, сколько средств потратила компания Contoso на ресурсы Azure за последние 30 дней. Выберите **Costs** > **Cost Analysis** > **Actual Cost Analysis** (Затраты > Анализ затрат > Анализ фактических затрат). Удалите все значения, заданные для тегов, групп или фильтров в отчете.

![Анализ фактических затрат](./media/cost-management-create-account-view-data/actual-cost-01.png)

В этом примере сумма общих затрат составляет 122 273 $, а бюджет — 290 000 $.
...
В этом примере общая сумма затрат на ресурсы Azure за последние 30 дней составляет 3309 $.
...
На следующем рисунке показаны затраты компании Contoso на ресурсы Azure. Общая сумма составляет 3309 $. В этом примере приблизительно половина затрат приходится на виртуальные машины Standard_A1, а другая половина — на различные сервисы Azure и экземпляры виртуальных машин.

![Типы ресурсов](./media/cost-management-create-account-view-data/actual-cost-04.png)

Щелкните тип ресурса правой кнопкой мыши и выберите **Cost Entities** (Сущности затрат), чтобы просмотреть сущности затрат и службы, которые потребляют ресурс. В следующем примере в качестве типа ресурса указано локально избыточное хранилище образов. Contoso | Потреблено ресурсов Azure/хранилища на 15,65 $. Проектирование | Потреблено ресурсов хранилища Azure на 164,25 $. Общая инфраструктура | Потреблено ресурсов Azure/хранилища на 116,58 $. Общая стоимость служб — 296 $.
