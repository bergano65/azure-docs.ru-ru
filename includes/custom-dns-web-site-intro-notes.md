...
> 
> **Использование имен личных доменов недоступно для уровня "Бесплатный".** Необходимо [выбрать более высокую ценовую категорию](../articles/app-service/web-sites-scale.md), что может повлиять на сумму в выставляемых за подписку счетах. 
