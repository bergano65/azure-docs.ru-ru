...
Кэширование хранилища класса Premium:  Поддерживаются
...
| Size | vCPU | Графический процессор | Память | Сетевые адаптеры (макс.) | Хранилище Temp (SSD) гиб | Макс. количество дисков данных | Максимальная пропускная способность дисков без кэширования: операций ввода-вывода в секунду / МБит/с | Максимальная пропускная способность сети | 
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_ND40s_v2 | 40 | 8 V100 (Нвлинк) | 672 Гиб | 8 | 2948 | 32 | 80000/800 | 24000 Мбит/с |
