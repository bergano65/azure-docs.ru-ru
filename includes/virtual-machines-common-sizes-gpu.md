...
| Размер              | Виртуальный процессор | Графический процессор              | Память  | Сетевые адаптеры (макс.) | Макс. размер диска           | Макс. количество дисков данных (по 1023 ГБ) | Максимальная пропускная способность сети | 
|-------------------|-------------|-------------------|--------|------------------|---------|------------|--------------------------|--------------------|--------------------------------|-----------------------------------------|-----------------------|------------|
| Standard_ND40s_v2 | 40     | 8 V100 (NVlilnk) | 672 Гиб | 8          | Временный, 1344 / 2948XIO | 32    | 24 000 Мбит/с             | 
