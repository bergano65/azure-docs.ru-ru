...
> [!IMPORTANT]
> Для этого семейства размеров квота на виртуальные процессоры (ядра) в вашей подписке изначально имеет значение 0 в каждом регионе. [Запросите увеличение квоты на виртуальные процессоры](../articles/azure-portal/supportability/resource-manager-core-quotas-request.md) для этого семейства в [доступном регионе](https://azure.microsoft.com/regions/services/).
>
...
> [!IMPORTANT]
> Для этого семейства размеров квота на виртуальные процессоры (ядра) на регион в вашей подписке изначально имеет значение 0. [Запросите увеличение квоты на виртуальные процессоры](../articles/azure-portal/supportability/resource-manager-core-quotas-request.md) для этого семейства в [доступном регионе](https://azure.microsoft.com/regions/services/).
>
