...
3. Разверните имя кластера и нажмите кнопку **Роли**.
...
6. Перейдите на вкладку **Ресурсы** и разверните созданную точку доступа клиента. 
    Отобразится ресурс IP-адреса для каждой сети в кластере. Если это решение только для Azure, вы увидите только один ресурс IP-адреса.

7. Выполните одно из приведенных ниже действий.

   * Для настройки гибридного решения:

        a. Щелкните правой кнопкой мыши ресурс IP-адреса, соответствующий локальной подсети, и выберите **Свойства**. Запишите имя IP-адреса и имя сети.

        2. Выберите **Статический IP-адрес**, присвойте неиспользуемый IP-адрес и нажмите кнопку **ОК**.

   * Для настройки решения только для Azure:

        a. Щелкните правой кнопкой мыши ресурс IP-адреса, соответствующий подсети Azure, и выберите **Свойства**.
       ...
       2. В этом же окне свойств **IP-адрес** измените **имя IP-адреса**.  
