...
4. В панели **ролей,** право нажмите имя группы доступности, а затем выберите **Добавить ресурс** > **клиента точка доступа.**
...
7. Выполните одно из приведенных ниже действий.
   ...
   * Для настройки решения только для Azure:
        ...
        а. Нажмите правой кнопкой мыши на ресурсе IP-адреса, который соответствует вашей подсети Azure, а затем выберите **Свойства.**
