...
Следующие виртуальные машины поддерживаются для создания на Azure Stack пограничном устройстве.
...
Дополнительные сведения см. на странице [Dv2 Series on общего назначения sizes VM](../articles/virtual-machines/dv2-dsv2-series.md#dv2-series).
...
Дополнительные сведения см. в [подNCasT4_v3 серии по размерам виртуальных машин, оптимизированных для GPU](../articles/virtual-machines/nct4-v3-series.md).
...
Дополнительные сведения см. на странице [серия fsv2-Series на виртуальных машинах, оптимизированных для вычислений](../articles/virtual-machines/fsv2-series.md).
