...
1. В разделе **Создать новый проект** введите в поле поиска текст *функции*, а затем выберите шаблон **Функции Azure**.
