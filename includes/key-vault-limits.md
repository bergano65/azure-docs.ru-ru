...
>
> В течение заданного 10-секундного интервала Azure Key Vault клиент может выполнить *только одну* из следующих операций, прежде чем будет обнаружен код `429` состояния HTTP регулирования:
...
| Хранилища ключей с частными конечными точками на подписку | 64 |
