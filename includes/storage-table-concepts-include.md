...
* **Учетные записи.** Весь доступ к хранилищу Azure осуществляется с помощью учетной записи хранения. См. сведения об [учетных записях хранения](../articles/storage/common/storage-account-overview.md).
