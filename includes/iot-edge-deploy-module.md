...
4. На этапе **Укажите маршруты** мастера вы определите способ передачи сообщений между модулями и в Центр Интернета вещей. Для руководства необходимо, чтобы все сообщения со всех модулей отправлялись в Центр Интернета вещей (`$upstream`). Добавьте приведенный ниже код, если он не заполняется автоматически:
