...
1. В ходе создания образа построитель изображений распространяет изображение в соответствии с шаблоном, а затем удаляет дополнительные ресурсы в группе ресурсов IT_\<Дестинатионресаурцеграуп > _\<TemplateName >, созданной для процесса.
