...
1. В процессе создания образа, Image builder распространяет этот образ в соответствии с шаблоном, затем удаляется дополнительные ресурсы в IT_<DestinationResourceGroup>_<TemplateName> группы ресурсов, которая была создана для процесса.
...
Azure Image Builder будет распространить образ к выбранным областям, которому может взиматься плата за исходящий трафик сети.
