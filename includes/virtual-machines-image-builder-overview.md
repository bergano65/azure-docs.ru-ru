...
- SLES 12 SP4
- SLES 15, SLES 15 SP1
- Windows 10 RS5 Предприятие/Предприятие многосессионно/профессиональное
- Windows 2016
- Windows 2019
...
Чтобы разрешить Azure VM Image Builder распространять изображения либо на управляемые изображения, либо в общую галерею изображений, необходимо предоставить разрешения 'Contributor' для службы "Azure Virtual Machine Image Builder" (идентификатор приложения: cf32a0cc-373c-47c9-9156-0db11f6a6dfc) в ресурсных группах. 
