...
1. После создания шаблона образа можно создать образ. В построителе фоновых изображений использует шаблон и исходные файлы для создания виртуальной машины (D1v2), сети, общедоступного IP-адреса\<и хранилища в\<группе ресурсов IT_ дестинатионресаурцеграуп > _ TemplateName >.
