...
## <a name="hyper-v-generation"></a>Создание Hyper V
В настоящее время построитель образов поддерживает образы и виртуальные машины Hyper V Generation 1.
