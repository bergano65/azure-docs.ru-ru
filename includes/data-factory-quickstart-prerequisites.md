...
2. На панели инструментов *\<Имя учетной записи* - **Контейнеры** выберите **контейнер**.
3. В диалоговом окне **Создание контейнера** введите **adftutorial** в качестве имени и щелкните **ОК**. Страница *\<Имя учетной записи* - **Контейнеры** будет обновлена и контейнер **adftutorial** появится в списке.
...
1. На странице *\<Имя учетной записи* - **Контейнеры**, где вы остановились, выберите **adftutorial** в обновленном списке контейнеров.
