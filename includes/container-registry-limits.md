...
<sup>1</sup> Хранилище, плата за которое включена в ежедневную плату для каждого уровня. Может использоваться дополнительное хранилище, за которое взимается ежедневная плата за ГиБ до достижения ограничения хранилища для реестра. Дополнительные сведения см. в статье [Цены на Реестр контейнеров Azure][pricing].
