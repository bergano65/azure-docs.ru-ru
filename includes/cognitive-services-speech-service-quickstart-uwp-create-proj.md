...
> [!NOTE]
> Пакет SDK для распознавания речи поддерживает все процессоры, совместимые с Intel, но **только x64** -версии процессоров ARM.
...
1. В строке меню выберите **файл**  >  **сохранить пакет. appxmanifest** , чтобы сохранить изменения.
...
1. В **Обозреватель решений**щелкните решение правой кнопкой мыши и выберите пункт **Управление пакетами NuGet** , чтобы выбрать решение для перехода в окно **NuGet — решение** .
