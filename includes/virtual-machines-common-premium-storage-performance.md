...
В качестве примера рассмотрим приложение, требующее выполнения 16 000 операций ввода-вывода в секунду. Для достижения этой производительности потребуется Стандартная виртуальная машина Azure IaaS no__t-0D14, которая может предоставлять максимум операций ввода-вывода в секунду 16 000 с использованием дисков стандартного хранилища объемом 1 ТБ 32. Каждый диск стандартного хранилища объемом 1 ТБ может достигать 500 операций ввода-вывода в секунду. Оценочная стоимость этой виртуальной машины в месяц составляет 1570 долл. США. Ежемесячная стоимость 32 дисков хранилища класса «Стандартный» составляет 1638 долл. США. Оценочная общая ежемесячная стоимость составляет 3208 долл. США.
...
| --- | --- | --- | --- |
| Ubuntu | 12,04 или более поздней версии| 3.2.0-75.110 или более поздней версии | Ubuntu-12_04_5-LTS-amd64-server-20150119-en-us-30GB |
| Ubuntu | 14,04 или более поздней версии| 3.13.0-44.73 или более поздней версии  | Ubuntu-14_04_1-LTS-amd64-server-20150123-en-us-30GB |
| Debian | 7. x, 8. x или более поздней версии| 3.16.7-ckt4-1 или более поздней версии | &nbsp; |
| SUSE | SLES 12 или более поздней версии| 3.12.36-38.1 или более поздней версии | suse-sles-12-priority-v20150213 <br> suse-sles-12-v20150213 |
| SUSE | SLES 11 SP4 или более поздней версии| 3.0.101-0.63.1 или более поздней версии | &nbsp; |
| CoreOS | 584.0.0 + или более поздняя версия| 3.18.4 или более поздней версии | CoreOS 584.0.0 |
| CentOS | 6,5, 6,6, 6,7, 7,0 или более поздней версии| &nbsp; | [Требуется LIS4](https://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409) <br> *См. примечание ниже* |
| CentOS | 7.1 + или более поздняя версия| 3.10.0-229.1.2.el7 или более поздней версии | [Рекомендуется LIS4](https://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409) <br> *См. примечание ниже* |
| Red Hat Enterprise Linux (RHEL) | 6.8 +, 7,2 + или более поздней версии | &nbsp; | &nbsp; |
| Oracle | 6.0 +, 7,2 + или более поздняя версия | &nbsp; | UEK4 или RHCK |
| Oracle | 7.0 — 7.1 или более поздняя версия | &nbsp; | UEK4 или RHCK с [LIS 4.1 или более поздней версии](https://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409) |
| Oracle | 6.4 — 6.7 или более поздняя версия | &nbsp; | UEK4 или RHCK с [LIS 4.1 или более поздней версии](https://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409) |
