...
| --- | --- | --- | --- |
| Макс. Число транзакций в секунду | | | |
| Операции чтения, % | | | |
| Операции записи, % | | | |
| Случайные операции, % | | | |
...
| Требование к приложению | Объем ввода-вывода | IOPS | Пропускная способность |
| --- | --- | --- | --- |
...
| Размер ВМ | Ядра ЦП | Память | Размеры диска виртуальной машины | Макс. количество дисков данных | Объем кэша | IOPS | Ограничения количества операций ввода-вывода в секунду и пропускной способности кэша |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
В качестве примера рассмотрим приложение, требующее выполнения 16 000 операций ввода-вывода в секунду. Для достижения этой производительности потребуется стандартная\_D14 виртуальная машина Azure IaaS, которая может предоставлять максимум операций ввода-вывода в секунду 16 000 с использованием дисков стандартного хранилища объемом 1 ТБ 32. Каждый диск стандартного хранилища объемом 1 ТБ может достигать 500 операций ввода-вывода в секунду. Оценочная стоимость этой виртуальной машины в месяц составляет 1570 долл. США. Ежемесячная стоимость 32 дисков хранилища класса «Стандартный» составляет 1638 долл. США. Оценочная общая ежемесячная стоимость составляет 3208 долл. США.
...
| Дистрибуция | Версия | Поддерживаемое ядро | Сведения |
| --- | --- | --- | --- |
