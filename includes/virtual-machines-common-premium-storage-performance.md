...
В таблице ниже приведена сводка факторов, влияющих на производительность, и шагов по оптимизации операций ввода-вывода, пропускной способности и задержки. В следующих разделах более подробно описан каждый из показателей.
...
| Требование к приложению | Объем ввода-вывода | Количество операций ввода-вывода в секунду | Пропускная способность |
| --- | --- | --- | --- |
...
Для SSD дисков ценовой категории "Премиум" можно использовать следующие дистрибутивы Linux. Для повышения производительности и стабильности при использовании дисков SSD ценовой категории "Премиум" рекомендуем обновить виртуальные машины до одной из указанных или более новых версий. 
...
| CentOS | 7.1+ или более поздней версии| 3.10.0-229.1.2.el7 или более поздней версии | [Рекомендуется LIS4](https://www.microsoft.com/download/details.aspx?id=55106) <br> *См. примечание ниже* |
| Red Hat Enterprise Linux (RHEL) | 6.8+, 7.2+ или более поздней версии | &nbsp; | &nbsp; |
| Oracle | 6.0+, 7.2+ или более поздней версии | &nbsp; | UEK4 или RHCK |
| Oracle | 7.0–7.1 или более поздней версии | &nbsp; | UEK4 или RHCK с поддержкой [LIS4](https://www.microsoft.com/download/details.aspx?id=55106) |
| Oracle; | 6.4–6.7 или более поздней версии | &nbsp; | UEK4 или RHCK с поддержкой [LIS4](https://www.microsoft.com/download/details.aspx?id=55106) |
...
В некоторых случаях приведенная выше команда обновит ядро. Если необходимо обновить ядро, то после перезагрузки может потребоваться выполнить приведенные выше команды для полной установки пакета microsoft-hyper-v.
