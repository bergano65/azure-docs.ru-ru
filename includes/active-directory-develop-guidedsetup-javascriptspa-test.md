...
После загрузки файла index.html в браузер щелкните **Войти**. Вам будет предложено войти с помощью конечной точки платформы удостоверений Майкрософт.
