...
* Установите соответствующие **разрешения** на чтение и запись для объектов в зависимости от того, как связанная служба (чтение, запись, чтение и запись) используется в фабрике данных.
