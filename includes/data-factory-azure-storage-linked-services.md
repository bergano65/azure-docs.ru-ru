...
* Установите соответствующие **разрешения** на чтение/запись на объектах на основе того, как связанная служба (читай, пишет, пишет/записывает) используется на фабрике данных.
