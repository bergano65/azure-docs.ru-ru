...
ms.locfileid: "85603283"
---
## <a name="create-an-azure-resource"></a>Создание ресурса Azure

Начните использовать API Поиска изображений Bing, создав один из следующих ресурсов Azure.

### <a name="bing-search-v7-resource"></a>[Ресурс Поиска Bing версии 7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7)
