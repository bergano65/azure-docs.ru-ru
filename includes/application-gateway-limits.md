...
ms.locfileid: "78305080"
---
| Ресурс | Ограничение по умолчанию или максимальное ограничение | Примечание |
| --- | --- | --- |
...
<sup>1</sup> При использовании номера SKU с поддержкой WAF рекомендуем ограничить количество ресурсов до 40, чтобы обеспечить оптимальную производительность.
