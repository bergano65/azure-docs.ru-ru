...
---
* [Аутентификация службы приложений / Обзор авторизации](../articles/app-service/overview-authentication-authorization.md).
...
* Добавьте аутентификацию в мобильное приложение: [iOS,][ios-get-started-users] [Android,][android-get-started-users] [Windows Universal,][windows-get-started-users] [Xamarin.Android,][xamarin-android-get-started-users] [Xamarin.iOS,][xamarin-ios-get-started-users] [Xamarin.Forms,][xamarin-forms-get-started-users] [Cordova][cordova-get-started-users].  
