...
ms.locfileid: "66755607"
---
* [Проверка подлинности службы приложений / Обзор авторизации](../articles/app-service/overview-authentication-authorization.md).
* Добавление проверки подлинности в мобильное приложение: [iOS][ios-get-started-users], [Android][android-get-started-users], [универсальной Windows] [ windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms] [ xamarin-forms-get-started-users], [Cordova][cordova-get-started-users].  
