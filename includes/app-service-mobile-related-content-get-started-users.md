...
ms.locfileid: "83860530"
---
* [Проверка подлинности и авторизация в службе приложений Azure](../articles/app-service/overview-authentication-authorization.md).
* [Дополнительные возможности использования проверки подлинности и авторизации в Службе приложений Azure](../articles/app-service/app-service-authentication-how-to.md)
* [Руководство. Сквозная проверка подлинности и авторизация в Службе приложений Azure](../articles/app-service/app-service-web-tutorial-auth-aad.md)
* Вы можете добавить функции аутентификации для мобильного приложения [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows Universal][windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms][xamarin-forms-get-started-users], [Cordova][cordova-get-started-users].  
