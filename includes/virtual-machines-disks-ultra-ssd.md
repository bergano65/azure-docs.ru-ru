...
**Виртуальные машины.** Диски SSD (цен. категория "Ультра") предназначены для работы со всеми номерами SKU виртуальных машины Azure с дисками SSD (цен. категория "Премиум"), но, так как сейчас они доступны в предварительной версии, размеры виртуальных машин соответствуют версии 3 ES/DS.
...
- Емкость диска. Диски SSD (цен. категория "Ультра") доступны в разных размерах от 4 ГиБ до 64 ТиБ.
...
- Пропускная способность диска. предельная пропускная способность одного диска SSD (цен. категория "Ультра") — 256 КиБ/с для каждой подготовленной операции ввода-вывода в секунду, но не более 2000 Мбит/с на диск (где Мбит/с = 10 ^ 6 байт в секунду). Минимальная пропускная способность диска — 1 MиБ.
