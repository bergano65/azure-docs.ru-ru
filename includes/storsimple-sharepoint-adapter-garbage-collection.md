...
5. В расшифрованном файле web.config в узле `connectionStrings` добавьте строку подключения для вашего экземпляра SQL Server и имя базы данных содержимого. См. следующий пример.
