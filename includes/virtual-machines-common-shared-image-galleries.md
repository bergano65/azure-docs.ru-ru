...
- Высокой доступности образов с учетными записями хранения избыточных зоны (ZRS), в регионах с поддержкой зон доступности. ZRS предлагает повышенной устойчивости к сбоям зоны.
