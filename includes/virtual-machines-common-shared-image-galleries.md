...
Да, может создать виртуальную машину из специализированного образа с помощью интерфейса [командной строки](../articles/virtual-machines/vm-specialized-image-version-cli.md), [PowerShell](../articles/virtual-machines/vm-specialized-image-version-powershell.md)или API. 
