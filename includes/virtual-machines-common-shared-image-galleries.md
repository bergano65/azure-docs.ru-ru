...
| Юго-Восточная Австралия   | Северный Китай 2     | Западная Япония         | Центральный регион US DoD     |
...
| Доступ предоставлен пользователю     | Общедоступная коллекция образов | Определение образа | Версия образа |
|----------------------|----------------------|--------------|----------------------|
...
За использование коллекции общих образов дополнительная плата не взимается. Плата взимается за следующие ресурсы.
...
Да. Существует 3 сценария, в зависимости от типов образов, которые у вас могут быть.
 ...
 Сценарий 1. Если вы используете управляемый образ в той же подписке, что и подпись, то можете создать из него определение образа и версию образа.

 Сценарий 2. Если вы используете неуправляемый образ в той же подписке, что и подпись, вы можете создать управляемый образ из него, а затем создать определение образа и его версию на основе образа. 
