...
| Доступ предоставлен пользователю     | Общедоступная коллекция образов | Общий образ | Версия общего образа |
|----------------------|----------------------|--------------|----------------------|
| Общедоступная коллекция образов | Да                  | Да          | Да                  |
| Общий образ         | Нет                   | Да          | Да                  |
| Версия общего образа | Нет                   | Нет           | Да                  |
