...
**Новый рекомендуемый размер**: [Серии NVv3 (Предварительная версия)](https://docs.microsoft.com/azure/virtual-machines/linux/sizes-gpu#nvv3-series--1)
