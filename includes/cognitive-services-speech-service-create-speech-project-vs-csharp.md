...
1. Из меню visual Studio бар, выберите **Инструменты** > **Получить инструменты и особенности**, который открывает Visual Studio Установщик и отображает **изменение** диалогового окна.
...
1. Из панели меню выберите**менеджер конфигурации** **сборки.** >  Откроется диалоговое окно**ConfigurationManager** (Диспетчер конфигураций).
