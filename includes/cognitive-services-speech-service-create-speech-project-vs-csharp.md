...
1. В строке меню Visual Studio выберите **Сервис**  >  **получить средства и компоненты**, открывающий Visual Studio Installer и отображающий диалоговое окно **изменение** .
