...
2. На правительственном портале нажмите кнопку, **+** а затем на рынке, нажмите Смотрите **все**. Найдите _физическое устройство StorSimple_. Выберите **Серия физического устройства StorSimple** и щелкните **Создать**. Кроме того, на правительственном **+** портале, нажмите, а затем под **хранение**, нажмите **StorSimple физических устройств серии**.
