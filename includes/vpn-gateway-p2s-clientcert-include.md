...
- **Корпоративный сертификат:**
  ...
  - Если вы используете корпоративное решение для создания сертификатов, создайте сертификат клиента с именем формата значения * \@ yourdomain.com*. Используйте этот формат вместо формата *доменное_имя\имя_пользователя*.
