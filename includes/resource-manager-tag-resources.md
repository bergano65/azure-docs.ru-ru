...
---
Если пользователь не имеет необходимого доступа для применения тегов, вы можете назначить роль **тега Вкладчика** пользователю. Для получения дополнительной информации [см.](../articles/role-based-access-control/quickstart-assign-role-user-portal.md)
...
1. В любом списке ресурсов установите флажки для ресурсов, которым требуется назначить тег. Затем выберите **теги Назначать.**
...
1. В меню портала Azure ищите **теги.** Выберите его из доступных опций.
