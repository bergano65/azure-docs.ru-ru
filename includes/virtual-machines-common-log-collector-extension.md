...
> [!NOTE]
> Описания большинства из записанных в журнал сведений можно найти по адресу https://blogs.msdn.microsoft.com/kwill/2013/08/09/windows-azure-paas-compute-diagnostics-data/
> 
> 
...
* **Все журналы (Full).** В этом режиме собираются те же файлы, что и в режиме GA, а также:
...
* Azure PowerShell. Инструкции по установке см. в разделе [install Azure PowerShell](/powershell/azure/install-az-ps)].
