...
> [!NOTE]
> Описания для большей части зарегистрированной информации можно найти по адресуhttps://blogs.msdn.microsoft.com/kwill/2013/08/09/windows-azure-paas-compute-diagnostics-data/
> 
> 

Существует два режима сбора данных для файлов разных типов.

* **Только журналы агента гостей Azure (GA).** В этом режиме собираются все журналы, связанные с гостевыми агентами и другими компонентами Azure.
* **Все журналы (Полный)**. В этом режиме собираются те же файлы, что и в режиме GA, а также:
...
* Установите Azure PowerShell. Инструкции по [установке Инструкций по установке на лазурном](/powershell/azure/install-az-ps)берегу.
...
* **ServiceName**: Ваше имя облачного сервиса.
...
* **AdditionalDataLocationList**: Список из следующих структур:
