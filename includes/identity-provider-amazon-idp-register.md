...
1. Введите **имя профиля безопасности**, **Описание профиля безопасности**и **URL-адрес уведомления о конфиденциальности согласия**, `https://www.contoso.com/privacy` например URL-адрес уведомления о конфиденциальности — это страница, которую вы управляете, предоставляющей пользователям сведения о конфиденциальности. Затем нажмите кнопку **Сохранить**.
