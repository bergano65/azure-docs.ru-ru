...
| Служба | Конфигурация |
| --- | --- |
| Доменные службы Azure AD | [Виртуальные сети, содержащие доменные службы Azure AD.](../articles/active-directory-domain-services/migrate-from-classic-vnet.md) |
