...
---
| Язык программирования | платформа | Справочник по API |
| -------------------- | -------- | ------------- |
...
| Java\* | [Пакет SDK для речевых устройств](../articles/cognitive-services/speech-service/speech-devices-sdk.md) | [Обзор](https://aka.ms/csspeech/javaref) |
