...
**Процессора** | **Память** | **Диск кэша** | **Скорость изменения данных** | **Реплицируемые компьютеры**
--- | --- | --- | --- | ---
