...
1. На портале слева щелкните **+Создать ресурс** и выполните поиск по запросу "Шлюз виртуальной сети". Найдите **шлюз виртуальной сети** в списке результатов и щелкните соответствующую запись. На странице **шлюз виртуальной сети** нажмите кнопку **создать**. Откроется страница **Создание шлюза виртуальной сети**.
   ...
   ![Создание полей страницы шлюза виртуальной сети](./media/vpn-gateway-add-gw-p2s-rm-portal-include/p2sgw.png "Создание полей страницы шлюза виртуальной сети")

   ![Создание полей страницы шлюза виртуальной сети](./media/vpn-gateway-add-gw-p2s-rm-portal-include/p2sgw2.png "Создание полей страницы шлюза виртуальной сети")
