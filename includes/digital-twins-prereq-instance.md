...
После настройки экземпляра Azure Digital Twins вам понадобится **_имя узла_** экземпляра ( [можно найти на портале Azure](../articles/digital-twins/how-to-set-up-instance-portal.md#verify-success-and-collect-important-values)). Запишите это значение, чтобы его можно было использовать позже для подключения к экземпляру.