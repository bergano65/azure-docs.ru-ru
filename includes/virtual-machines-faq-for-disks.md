...
Управляемые диски — это функция автоматического управления учетными записями хранения, которая упрощает управление дисками виртуальных машин Azure IaaS. Дополнительные сведения см. в разделе [Обзор управляемых дисков Azure](../articles/virtual-machines/managed-disks-overview.md).
...
Сведения о региональных параметрах см. в нашей [концептуальной статье](../articles/virtual-machines/linux/disks-shared.md).
...
Поддерживаемые размеры см. в нашей [концептуальной статье](../articles/virtual-machines/linux/disks-shared.md).
...
Помимо регулирования диска, выполняется регулирование операций ввода-вывода, которое действует на уровне виртуальной машины. Убедитесь, что размер виртуальной машины, который вы используете, может поддерживать уровни, настроенные на дисках. Дополнительные сведения об ограничениях операций ввода-вывода, наложенных виртуальной машиной, см. в статье [Размеры виртуальных машин Windows в Azure](../articles/virtual-machines/windows/sizes.md).
...
Можно, если эта виртуальная машина находится в регионе и зоне доступности, поддерживающих диски (цен. категория "Ультра"). См. статью [Начало работы с дисками (цен. категория "Ультра")](../articles/virtual-machines/disks-enable-ultra-ssd.md).
