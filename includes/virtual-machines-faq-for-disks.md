...
Все управляемые диски, созданные с помощью API версии 2019-07-01 или более поздней, могут включать общие диски. Для этого необходимо отключить диск от всех виртуальных машин, к которым он подключен. Затем измените свойство `maxShares` на диске.
