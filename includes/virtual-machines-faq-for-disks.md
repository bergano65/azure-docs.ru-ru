...
SSD (цен. категория "Премиум"), Стандартный SSD и стандартный HDD поддерживают моментальные снимки. Для этих трех типов дисков моментальные снимки поддерживаются для всех размеров дисков (включая диски размером до 32 Тиб). Ultra SSDs не поддерживает моментальные снимки.
