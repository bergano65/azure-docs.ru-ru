...
Максимальный размер дисков, поддерживаемых службами Azure Backup и Azure Site Recovery, составляет 4 ТиБ. Поддержка дисков большего размера до 32 ТБ еще не доступна.
