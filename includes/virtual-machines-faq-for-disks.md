...
## <a name="uploading-to-a-managed-disk"></a>Отправка в управляемый диск

**Можно загрузить данные для существующего управляемого диска?**

Нет, отправка может использоваться только во время создания нового пустого диска с **ReadyToUpload** состояние.

**Можно ли подключить диск к виртуальной Машине, когда оно находится в состоянии отправки?**

№

**Можно сделать снимок управляемый диск в состоянии отправки?**
...
8 ТБ 16 ТБ, SKU и 32 Тиб диск поддерживаются во всех регионах в разделе глобальных 21Vianet в Azure, Microsoft Azure для государственных организаций и Azure для Китая.
