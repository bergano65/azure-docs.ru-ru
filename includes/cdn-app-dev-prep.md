...
>
> Когда вы доберетесь до шага, названного Приложением для мультиарендаторов, выберите **Нет.**
>
...
4. Вместо того, чтобы назначить роль **Участник роли CDN** субъекту-службе, мы назначим ее отдельным пользователям или группам.  В этом примере вы можете видеть, что я назначил *пользователя CDN Demo* роли **вкладчика CDN.**  
