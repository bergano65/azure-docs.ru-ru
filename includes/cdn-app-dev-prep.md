...
>
> При переходе к шагу Настройка приложения с несколькими клиентами выберите **нет**.
>
...
4. Вместо того, чтобы назначить роль **Участник роли CDN** субъекту-службе, мы назначим ее отдельным пользователям или группам.  В этом примере вы видите, что *пользователь с демонстрацией CDN* назначен роли **участника профиля CDN** .  
