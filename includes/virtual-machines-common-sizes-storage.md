...
Серия Lsv2 включает напрямую сопоставляемое локальное хранилище NVMe с высокой пропускной способностью и низкой задержкой на базе процессора [AMD EPYC &trade; 7551](https://www.amd.com/en/products/epyc-7000-series) с ускоренной частотой всех ядер 2,55 ГГц и максимальным ускорением в 3,0 ГГц. Виртуальные машины серии Lsv2 могут иметь от 8 до 80 виртуальных ЦП в одновременных многопоточных конфигурациях.  Отводится 8 ГиБ памяти на виртуальный ЦП, одно устройство NVMe SSD M.2 объемом 1,92 ТБ на 8 виртуальных ЦП, а на виртуальной машине L80s v2 доступно до 19,2 ТБ (10 x 1,92 ТБ).
...
>
> Высокая пропускная способность и операции ввода-вывода на локальном диске делают виртуальные машины серии Lsv2 и Ls идеальными для хранилищ NoSQL, таких как Apache Cassandra и MongoDB, которые реплицируют данные между несколькими виртуальными машинами для обеспечения сохранности в случае сбоя одной виртуальной машины.
>
> Дополнительные сведения см. в статье [Оптимизация производительности на виртуальных машинах серии Lsv2](../articles/virtual-machines/linux/storage-performance.md).  
