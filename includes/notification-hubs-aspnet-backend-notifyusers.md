...
![Снимок экрана: диалоговое окно "расширения и обновления" с выделенным пакетом NuGet управление для пакета Visual Studios.][B4]

> [!NOTE]
> Убедитесь, что вы установили [пакет SDK Azure](https://azure.microsoft.com/downloads/) для Visual Studio для развертывания веб-сайта.
...
2. Выберите **Microsoft Azure служба приложений** в качестве цели публикации, а затем щелкните * * Опубликовать. Откроется окно создания службы приложений. В этом окне можно создать все необходимые ресурсы Azure для запуска веб-приложения ASP.NET в Azure.
