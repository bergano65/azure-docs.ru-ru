...
2.  Задайте тип планировщика низкоуровневой оболочки, выполнив приведенные `Core` [здесь](https://docs.microsoft.com/windows-server/virtualization/hyper-v/manage/manage-hyper-v-scheduler-types)инструкции.
