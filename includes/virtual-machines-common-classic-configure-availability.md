...
* [Вариант 1. Создание виртуальной машины и группы в то же время доступности][Option 1: Create a virtual machine and an availability set at the same time]. Затем добавляйте создаваемые виртуальные машины в эту группу.
...
## <a id="createset"> </a>Вариант 1. Создание виртуальной машины и группы в то же время доступности
