...
| **Учетные записи хранения и поддерживаемые типы хранилищ** | **Блочный BLOB-объект** |**Страница капля*** |**Файлы Azure** |**Примечания**|
| --- | --- | -- | -- | -- |
...
\**- Данные, загруженные на страницы капли должны быть 512 байт выровнены, такие как VHDs.*
