...
После `AuthenticationResult` того как MSAL возвращается в `result`, добавьте его в заголовок авторизации HTTP, прежде чем выполнять вызов к защищенному веб-API.
