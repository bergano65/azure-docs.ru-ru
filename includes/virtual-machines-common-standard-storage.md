...
**Транзакция.** Для хранилища ценовой категории "Стандартный" в Azure взимается 0,0036 долл. США за каждые 100 000 транзакций. К транзакциям относятся операции чтения и записи в хранилище.
