...
15. Вернитесь на портал Azure для государственных организаций и выполните следующие действия.
    ...
    2. Щелкните **Устройства**. Из списка устройств определите развертываемое устройство. Проверьте, чтобы устройство было успешно подключено к службе. Для этого просмотрите его состояние. Состояние устройства должно быть **В сети**.
