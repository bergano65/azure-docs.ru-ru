...
---
**Требования к настройке и обработке сервера**
...
Язык операционной системы | Английский (ан-з)
...
FIPS (Федеральные стандарты обработки информации) | Не включайте режим FIPS
|
...
Тип сетевой карты | VMXNET3 (если сервер конфигурации является VMware VM)
 |
**Доступ в Интернет** (сервер нуждается в доступе к следующим URL-адресам, непосредственно или через прокси):|
...
*.services.visualstudio.com | Используется для телеметрии (по желанию)
...
| <ul> <li> https:\//login.microsoftonline.com </li><li> https:\//secure.aadcdn.microsoftonline-p.com </li><li> https:\//login.live.com </li><li> https:\//graph.windows.net </li><li> https:\//login.windows.net </li><li> https:\//www.live.com </li><li> https:\//www.microsoft.com </li></ul> | Настройка OVF нуждается в доступе к этим URL-адресам. Они используются для управления доступом и управления идентификацией в каталоге Azure Active.
https:\//dev.mysql.com/get/Downloads/MySQLInstaller/mysql-installer-community-5.7.20.0.msi  | Для завершения загрузки MyS'L. </br> В некоторых регионах загрузка может быть перенаправлена на URL CDN. Убедитесь, что URL CDN также включен в белый список, если это необходимо.
|
...
В следующей таблице приведены требования к емкости для сервера конфигурации. Если вы реплицируете несколько VMwre VMs, просмотрите [соображения планирования емкости](../articles/site-recovery/site-recovery-plan-capacity-vmware.md) и запустите [инструмент планировщика развертывания azure Site.](../articles/site-recovery/site-recovery-deployment-planner.md)
