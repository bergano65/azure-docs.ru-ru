...
3. В колонке **Создать облачный программно-аппаратный комплекс** укажите следующее:
   ...
   7. Установите флажок, чтобы указать, что вы понимаете, что данные, сохраненные на облачном устройстве, размещены в центре обработки данных Майкрософт.
       ...
       * При использовании облачного устройства ключ шифрования и ключ расшифровки хранятся в Microsoft Azure. Дополнительные сведения см. в [рекомендациях по обеспечению безопасности при использовании облачного устройства](../articles/storsimple/storsimple-security.md).
