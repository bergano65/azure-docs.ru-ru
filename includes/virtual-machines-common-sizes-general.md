...
- Серии Dav4 и Dasv4 — это новые размеры, использующие процессор AMD с частотой 2.35 ГГц ЕПИК<sup>TM</sup> 7452 в многопоточной конфигурации с кэшем третьего уровня размером до 256 МБ, который ВЫДЕЛЯЕТ 8 МБ для этого кэша L3 на каждые 8 ядер, увеличивая возможности клиента для выполнения рабочих нагрузок общего назначения. Серии Dav4 и Dasv4 имеют те же конфигурации памяти и диска, что и серия D & Dsv3-Series.
