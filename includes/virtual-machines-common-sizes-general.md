...
- Серии Dav4 и Dasv4 — это новые размеры, использующие процессор AMD 2.35 ГГц ЕПИК<sup>TM</sup> 7452 в многопоточной конфигурации с кэшем третьего уровня размером до 256 ГБ, который ВЫДЕЛЯЕТ 8 ГБ для этого кэша L3 до каждых 8 ядер для выполнения рабочих нагрузок общего назначения. Серии Dav4 и Dasv4 имеют те же конфигурации памяти и диска, что и серия D & Dsv3-Series.
