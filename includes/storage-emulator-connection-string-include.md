...
Самый простой способ подключиться к эмулятору хранения из приложения — настроить строку подключения в файле конфигурации приложения, на которое ссылается ярлык: `UseDevelopmentStorage=true`. Вот пример строки подключения к эмулятору хранилища в файле *app.config:* 
