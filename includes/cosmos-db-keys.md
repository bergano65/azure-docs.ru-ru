...
![Снимок экрана: портал Azure с выделенной кнопкой "Ключи" на странице учетной записи Azure Cosmos DB](./media/cosmos-db-keys/copy-keys.png)
