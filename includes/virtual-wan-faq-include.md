...
IPv6 не поддерживается в концентраторе Виртуальной глобальной сети и его шлюзах. Если у вас есть виртуальная сеть с поддержкой IPv6 и вы хотите подключить виртуальную сеть к Виртуальной глобальной сети, этот сценарий в настоящее время не поддерживается.

### <a name="what-is-the-recommended-api-version-to-be-used-by-scripts-automating-various-virtual-wan-functionality-"></a>Какая рекомендуемая версия API будет использоваться в скриптах, автоматизирующих различные функции Виртуальной глобальной сети?
