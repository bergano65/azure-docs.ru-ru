...
3. В диалоговом окне **Создание пространства имен** выполните следующие действия: 
    1. Введите **имя для пространства имен**. Система немедленно проверяет, доступно ли оно. Список правил для именования пространств имен, см. в разделе [API REST для создания пространства имен](/rest/api/servicebus/create-namespace).
