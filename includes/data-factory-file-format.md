...
* [Формат текста](#specifying-textformat)
* [Формат JSON](#specifying-jsonformat)
* [Формат Авро](#specifying-avroformat)
...
| encodingName |задает имя кодировки. |Допустимое имя кодировки. Ознакомьтесь с описанием свойства [Encoding.EncodingName](/dotnet/api/system.text.encoding). Пример: windows-1250 или shift_jis. Значение **по умолчанию** **UTF-8**. |нет |
