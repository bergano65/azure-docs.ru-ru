...
| **Сообщение об ошибке образца** | **Рекомендуемое действие** |
|--------------------------|------------------------|
...
Сбои регистрации можно отладить, просмотрев журналы в папке **%ProgramData%-ASRLogs.**
...
|06:28:45: не удалось создать сертификат.<br>06:28:45: не удается продолжить настройку. Не удалось создать сертификат, необходимый для проверки подлинности Site Recovery. Перезапустите программу установки. | Убедитесь, что вы работаете установки в качестве локального администратора. |
