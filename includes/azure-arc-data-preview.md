...
>
>Чтобы узнать о текущих ограничениях, см. раздел [Известные проблемы](../articles/azure-arc/data/release-notes.md#known-limitations-and-issues) в заметках о выпуске.