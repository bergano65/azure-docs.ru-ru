...
---
Клиенты Azure могут разблокировать 25 000 бесплатных сообщений электронной почты каждый месяц. Эти 25 000 бесплатных ежемесячных электронных писем помогут вам получить доступ к расширенным отчетам и аналитикам, а также [ко всем API][all APIs] (Интернет, SMTP, событие, анализ и многое другое). Дополнительные сведения о дополнительных службах, предоставляемых SendGrid, см. на странице [решений SendGrid][SendGrid Solutions] .
...
Дополнительные сведения об отправке электронной почты через SendGrid см. в [обзоре API электронной почты][Email API Overview].
