...
9. В разделе **Ценовая категория** выберите план SendGrid для регистрации.
    ...
    ![Снимок экрана: диалоговое окно создания учетной записи SendGrid с выбранным разделом Выбор ценовой категории и выбранной ценовой категорией "бесплатный".][sendgrid-pricing]
...
1. Щелкните значок ключа, чтобы найти свое **имя пользователя**.
    ...
    ! Снимок экрана со страницей учетной записи Контососендгрид с выделенным значком ключа.] [ключ]
