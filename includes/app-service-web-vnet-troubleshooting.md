...
Средства **ping**, **nslookup**и **tracert** не будут работать через консоль из-за ограничений безопасности. Чтобы заполнить void, добавляются два отдельных средства. Чтобы проверить функциональность DNS, мы добавили средство с именем **nameresolver.exe**. Синтаксис:
