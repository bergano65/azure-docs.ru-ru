...
[host.js](../articles/azure-functions/functions-host-json.md) файла содержит конфигурации среды выполнения и находится в корневой папке приложения-функции. Папка *bin* содержит пакеты и другие файлы библиотеки, необходимые приложению-функции. См. требования конкретного языка для проекта приложения-функции:
