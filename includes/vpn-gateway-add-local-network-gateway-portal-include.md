...
3. На странице **Создание шлюза локальной сети** укажите значения для своего шлюза.
   ...
   :::image type="content" source="./media/vpn-gateway-add-local-network-gateway-portal-include/create-local-gateway-fqdn.png" alt-text="Создание полного доменного имени локального сетевого шлюза":::
