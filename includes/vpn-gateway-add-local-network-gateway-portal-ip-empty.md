...
---
1. В [портал Azure](https://portal.azure.com)в поле **Поиск ресурсов, служб и документов (G +/)** введите **локальный сетевой шлюз**. В результатах поиска найдите **шлюз локальной сети** в **Marketplace** и выберите его. Откроется страница **Создание шлюза локальной сети** .
1. На странице **Создание шлюза локальной сети** укажите значения для своего шлюза.

   :::image type="content" source="./media/vpn-gateway-add-local-network-gateway-portal-ip-empty/create-ip.png" alt-text="Создание шлюза локальной сети с IP-адресом&quot;:::
