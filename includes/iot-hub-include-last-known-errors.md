...
|-----|-----|-----|
|Временный|Произошла временная ошибка, и центр Интернета вещей повторит операцию.|Просмотрите [журналы ресурсов для маршрутов](https://docs.microsoft.com/azure/iot-hub/monitor-iot-hub-reference#routes).|
|InternalError|Произошла ошибка при доставке сообщения в конечную точку.|Это внутреннее исключение, но также обратите внимание на [журналы ресурсов маршрутов](https://docs.microsoft.com/azure/iot-hub/monitor-iot-hub-reference#routes).|
