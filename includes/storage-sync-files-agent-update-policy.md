...
4. **Загрузка последней версии установщика агента службы синхронизации файлов Azure из [Центра загрузки Майкрософт](https://go.microsoft.com/fwlink/?linkid=858257). Загружаемый установщик — это пакет установщика Майкрософт или исполняемый MSI-файл.**  
