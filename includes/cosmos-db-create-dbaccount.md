...
ms.locfileid: "81422339"
---
1. Создайте учетную запись для базы данных Azure Cosmos DB, [перейдя на портал Azure](https://portal.azure.com/). На домашней странице выберите **Создать ресурс** на панели **Службы Azure**.

   ![Создание ресурса](./media/cosmos-db-create-dbaccount/azure-cosmos-db-create-resource-1.png)

1. Найдите в поиске и выберите **Azure Cosmos DB**

   ![Раскрывающийся список ресурсов на портале Azure](./media/cosmos-db-create-dbaccount/create-nosql-db-databases-json-tutorial-updated-1.png)

1. Нажмите кнопку **создания**.

   ![Создание ресурса Azure Cosmos DB](./media/cosmos-db-create-dbaccount/azure-cosmos-db-create-account-1.png)
