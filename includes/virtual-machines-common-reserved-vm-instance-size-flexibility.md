...
Но скидки на резервирование не применяются к размерам виртуальных машин, перечисленным в разных группах гибкости размера экземпляров, таких как номера SKU в DSv2 с большим объемом памяти. Standard_DS11_v2, Standard_DS12_v2 и т. д.
