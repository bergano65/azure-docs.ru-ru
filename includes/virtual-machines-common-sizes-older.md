...
| Размер | vCPU | Память: ГиБ | Временное хранилище (HDD): ГиБ | Максимальное число дисков данных | Максимальная пропускная способность дисков данных: ОПЕРАЦИЙ ВВОДА-ВЫВОДА | Максимальное количество сетевых адаптеров / ожидаемая пропускная способность сети (Мбит/с)  |
| --- | --- | --- | --- | --- | --- | --- |
...
| Размер | vCPU | Память: ГиБ | Временное хранилище (HDD): ГиБ | Максимальное число дисков данных | Максимальная пропускная способность дисков данных: ОПЕРАЦИЙ ВВОДА-ВЫВОДА | Максимальное число сетевых адаптеров|
| --- | --- | --- | --- | --- | --- | --- |
