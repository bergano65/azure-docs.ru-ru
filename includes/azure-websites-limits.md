...
ms.locfileid: "73476892"
---
| Ресурс | Free | Совмещаемая блокировка | базовая; | Standard | Премиум (версия 2) | Isolated </th> |
| --- | --- | --- | --- | --- | --- | --- |
...
<sup>11</sup> Запускайте пользовательские исполняемые файлы и (или) скрипты по запросу, по расписанию или непрерывно в качестве фоновой задачи в экземпляре службы приложений. Для обеспечения непрерывной работы веб-заданий требуется установка опции "Всегда включено". Для обеспечения работы веб-заданий по расписанию на уровнях Free или Standard требуется использование планировщика Azure. На число веб-заданий, которые могут выполняться в экземпляре службы приложений, нет предопределенных ограничений. Существуют практические ограничения, зависящие от того, что пытается выполнить код приложения.  