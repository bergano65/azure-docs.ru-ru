...
Размеры серии Eav3 основаны на процессоре AMD ЕПИК<sup>TM</sup> 7452 с тактовой частотой 2.35 ГГц, который может обеспечить повышенный FMAX с частотой 3.35 ГГц и использовать хранилище класса Premium. Размеры серии Eav3 идеально подходят для корпоративных приложений с большим объемом памяти. Хранилище данных диска оплачивается отдельно от виртуальных машин. Чтобы использовать диски хранилища класса Premium, используйте размеры серии Easv3. Показатели ценообразования и выставления счетов для размеров Easv3 совпадают с серией Eav3.
...
Размеры серии DSv2 основаны на процессорах Intel (R) Xeon (R) с частотой 3 – 2673 v3 @ 2,40 ГГц.
