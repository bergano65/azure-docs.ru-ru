...
<sup>1</sup> этих больших виртуальных ЦП требуется одна из этих поддерживаемых операционных систем: Windows Server 2016, Windows Server 2019 г., SLES 12 SP4, SLES 15 и RHEL 7.6
