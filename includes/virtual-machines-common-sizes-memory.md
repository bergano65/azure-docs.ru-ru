...
* Серии Eav3 и Easv3 используют процессор AMD с частотой 2.35 ГГц ЕПИК<sup>TM</sup> 7452V в многопоточной конфигурации с кэшем третьего уровня объемом до 256 МБ, увеличивая возможности выполнения большинства оптимизированных для памяти рабочих нагрузок.  Серии Eav3 и Easv3 имеют те же конфигурации памяти и дисков, что и Ev3 & Esv3 Series.
...
<sup>2</sup> виртуальные машины серии Mv2 имеют только [поколение 2](/azure/virtual-machines/linux/generation-2) . Если вы используете Linux, ознакомьтесь со следующим разделом, чтобы найти и выбрать образ SUSE Linux.
