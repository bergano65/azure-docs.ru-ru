...
ms.locfileid: "66117400"
---
В этом разделе описывается создание центра Интернета вещей с помощью [портала Azure](https://portal.azure.com).

1. Войдите на [портал Azure](https://portal.azure.com). 

2. Выберите **+Создать ресурс** и в поле *Поиск в Marketplace* введите **Центр Интернета вещей**.

3. Выберите **Центр Интернета вещей** и нажмите кнопку **Создать**. Появится первый экран для создания Центра Интернета вещей.
