...
|----|----|----|
| Модель конфигурации виртуальной машины| Нет. VirtualMachineProfile не определен в модели масштабируемого набора. | Обязательный элемент. VirtualMachineProfile заполняется в модели масштабируемого набора. |
