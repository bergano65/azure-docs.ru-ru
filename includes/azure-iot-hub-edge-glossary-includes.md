...
В развертывании IoT Edge условие Целевой — это любое условие Boolean на тегах близнецов устройства для выбора целевых устройств развертывания, например **tag.environment и prod.** Целевое состояние постоянно оценивается для включения любых новых устройств, которые отвечают требованиям или удаляют устройства, которые больше не делают. Дополнительные сведения см. в разделе [Условие назначения](https://docs.microsoft.com/azure/iot-edge/module-deployment-monitoring#target-condition)