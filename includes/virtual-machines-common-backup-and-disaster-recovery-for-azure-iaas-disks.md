...
[Azure Backup](https://azure.microsoft.com/services/backup/) используется для резервного копирования и аварийного восстановления и работает с [управляемыми дисками](../articles/virtual-machines/windows/managed-disks-overview.md) , а также с неуправляемыми дисками. Вы можете создавать задания архивации с учетом времени, легко восстанавливать виртуальные машины и использовать политики хранения архивов.
