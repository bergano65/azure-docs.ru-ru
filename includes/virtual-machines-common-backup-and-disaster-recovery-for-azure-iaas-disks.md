...
Для решения этой проблемы Microsoft Azure Backup обеспечивает целостность на уровне приложений во время архивации рабочих нагрузок Майкрософт. Она использует службу теневого копирования томов, чтобы обеспечить правильную запись данных в хранилище. Для виртуальных машин Linux режим согласованности резервных копий по умолчанию поддерживает резервное копирование файлов, так как Linux не имеет функций, эквивалентных службе теневого копирования томов, как в случае с Windows. Сведения для компьютеров Linux см. в статье [резервное копирование виртуальных машин Linux в Azure с подсистемой совместимости приложений](https://docs.microsoft.com/azure/backup/backup-azure-linux-app-consistent).
