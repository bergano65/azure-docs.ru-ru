...
| --- | --- | --- |
| Диски SSD категории "Премиум" | Локальная ([локально избыточное хранилище](../articles/storage/common/storage-redundancy-lrs.md)) | [Служба архивации Azure](https://azure.microsoft.com/services/backup/) |
...
| уровень |   высокой доступности   | Резервное копирование или аварийное восстановление |
| --- | --- | --- |
