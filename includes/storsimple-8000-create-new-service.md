...
2. На портале Azure щелкните **Создать ресурс**, а затем в Marketplace выберите **See all** (Просмотреть все).
    ...
    Найдите _физическое устройство StorSimple_. Выберите **Серия физического устройства StorSimple** и щелкните **Создать**. Кроме того, на портале **+** Azure нажмите кнопку, а затем под **хранением,** нажмите **StorSimple Физические устройства серии**.
