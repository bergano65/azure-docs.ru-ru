...
ms.locfileid: "58500854"
---
> [!IMPORTANT]
> Служба "Брандмауэр Azure" сейчас предоставляется в управляемой общедоступной предварительной версии. Она включается явным образом помощью команды PowerShell `Register-AzProviderFeature`.
>
