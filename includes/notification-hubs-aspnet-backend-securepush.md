...
2. Выберите в качестве цели публикации веб-сайт Azure. Вопийте с учетной записью Azure и выберите существующий или новый веб-сайт, и сделать заметку о свойстве **URL назначения** во вкладке **Connection.** Мы будем ссылаться на этот URL в качестве *бэкэнда конечная точка* позже в этом учебнике. Нажмите кнопку **Опубликовать**.
