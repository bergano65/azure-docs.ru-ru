...
2. Выберите в качестве цели публикации веб-сайт Azure. Войдите с помощью учетной записи Azure, выберите имеющийся или новый веб-сайт и запишите свойство **URL-адрес назначения** на вкладке **Подключение**. Далее в учебнике этот URL-адрес будет называться *конечная точка сервера* . Нажмите кнопку **Опубликовать**.
