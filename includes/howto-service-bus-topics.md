...
2. На портале в области навигации слева щелкните **Создать ресурс**, **Интеграция Enterprise** и **Служебная шина**.
...
6. Выберите имеющуюся **группу ресурсов**, в которую будет включено это пространство имен, или создайте новую.      
...
2. В области **Пространство имен служебной шины** щелкните **Политики общего доступа**.
3. В области **Политики общего доступа** щелкните **RootManageSharedAccessKey**.
   
    ![Сведения о подключении][connection-info]
4. В области **Политика: RootManageSharedAccessKey** нажмите кнопку копирования рядом с полем **Строка подключения — первичный ключ**, чтобы скопировать строку подключения в буфер обмена для последующего использования.
