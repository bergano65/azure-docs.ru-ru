...
Давайте проверим, как использовать эти новые метрики использования операций ввода-вывода хранилища для отладки, когда в системе есть узкое место. Настройка системы — это именно то, что было в предыдущем примере, за исключением того, что подключенный диск ОС **не** кэшируется.
