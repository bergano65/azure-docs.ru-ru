...
* *Закрытый ключ* в локальной системе используется клиентом SSH для идентификации пользователя при подключении к виртуальной машине Linux. Его нужно защищать и нельзя никому предоставлять.
