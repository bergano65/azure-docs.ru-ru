...
VPN-шлюз Azure выделит один IP-адрес из диапазона GatewaySubnet для VPN-шлюзов "активный — резервный" или два IP-адреса для VPN-шлюзов "активный — активный". Вы можете получить фактические IP-адреса BGP, выделенные с помощью PowerShell (Get-Азвиртуалнетворкгатевай, найдите свойство bgpPeeringAddress) или в портал Azure (в разделе "Настройка BGP ASN" на странице Конфигурация шлюза).
