...
> [!IMPORTANT]
> * Перед переходом в режим обслуживания убедитесь, что оба контроллера устройства находятся в работоспособном состоянии на портале Azure. Если контроллер неисправен, [обратитесь к служба поддержки Майкрософту](../articles/storsimple/storsimple-8000-contact-microsoft-support.md) за дальнейшими действиями.
> * В режиме обслуживания необходимо сначала обновить один контроллер, а затем другой.

1. Подключите последовательную консоль с помощью PuTTY. Подробные инструкции см. в разделе [Подключение к последовательной консоли устройства с помощью PuTTY](../articles/storsimple/storsimple-8000-deployment-walkthrough-u2.md#use-putty-to-connect-to-the-device-serial-console). В командной строке нажмите клавишу **ВВОД**. Выберите вариант 1, **Войдите в систему с полным доступом**.
