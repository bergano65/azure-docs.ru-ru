...
* **Для схемы источников чтения данных (в частности, Azure blob)** можно хранить данные без хранения какой-либо схемы или ввода информации с данными. Для таких типов источников данных раздел structure нужно добавлять в следующих двух случаях:
