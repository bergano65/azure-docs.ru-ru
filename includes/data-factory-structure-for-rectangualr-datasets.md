...
* **Для схемы на чтение источников данных (в частности, большого двоичного объекта Azure)** можно выбрать хранение данных без сохранения каких-либо схем или сведений о типах с данными. Для таких типов источников данных раздел structure нужно добавлять в следующих двух случаях:
