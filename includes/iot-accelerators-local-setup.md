...
В этом документе предполагается, что вы используете микрослужбы .NET. Есть также доступные реализации Java. Чтобы загрузить последнюю версию реализаций микрослужбы Java, выполните:
