...
Эта функция полностью поддерживается для веб-приложений Windows и Linux. Все эти поведения действуют одинаково в приложениях Windows и приложениях Linux.
