...
| Размер серверного пула                          | 1 000 экземпляров, одна виртуальная сеть |
| Внутренних ресурсов на подсистему балансировки нагрузки<sup>1<sup>   | 150                 |
...
| Размер серверного пула                           | 100 экземпляров, одна группа доступности |
