...
| Общедоступные IP-адреса (динамические) |5 |Связаться со службой поддержки |
| Зарезервированные общедоступные IP-адреса |20 |Связаться со службой поддержки |
...
Следующие ограничения применяются только для сетевых ресурсов, управляемых с помощью **Azure Resource Manager** на регион на подписку. Узнайте, как [просмотреть текущие данные об использовании ресурсов в соответствии с ограничениями подписки](../articles/networking/check-usage-against-limits.md).
...
| Размер префикса общедоступный IP-адрес (Предварительная версия) | /28 | Обратитесь в службу поддержки. |
