...
| Ресурс | Ограничение по умолчанию | Максимальное ограничение |
| --- | --- | --- |
| Общедоступные IP-адреса (динамические) |("Базовый") 1000 |обратиться в службу поддержки |
...
| Размер префикса общедоступного IP-адреса (предварительная версия) | /28 | /28 |
...
| Конфигурации IP интерфейса, уровень "Базовый" | 200 |
| Конфигурации IP интерфейса, уровень "Стандартный" | 600 |
| Серверный пул, уровень "Базовый" | 100, одна группа доступности |
| Серверный пул, уровень "Стандартный" | 1000, одна виртуальная сеть |
| Количество внутренних ресурсов на экземпляр Load Balancer (цен. категория "Стандартный")* | 150 |
| Порты HA, уровень "Стандартный" | 1 на внутренний интерфейс |

** До 150 ресурсов, допускаются любые сочетания ресурсов изолированных виртуальных машин, наборов доступности и масштабируемых наборов виртуальных машин.
