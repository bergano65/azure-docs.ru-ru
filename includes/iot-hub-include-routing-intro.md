...
В первой и второй частях этого руководства описано, как выполнять следующие задачи:

**Часть 1. Создание ресурсов, настройка маршрутизации сообщений**
> [!div class="checklist"]
> * Создание ресурсов: Центра Интернета вещей, учетной записи хранения, очереди служебной шины и имитированного устройства. Это можно сделать с помощью портал Azure, шаблона Azure Resource Manager, Azure CLI или Azure PowerShell.
...
* Для работы со второй частью этого руководства необходимо следующее:
  ...
  - Доступ к учетной записи Power BI для анализа потока аналитики конечных точек по умолчанию. (Доступна [бесплатная пробная версия Power BI](https://app.powerbi.com/signupredirect?pbi_source=web).)
  - Рабочая или учебная учетная запись для отправки уведомлений по электронной почте.
  - Убедитесь, что в брандмауэре открыт порт 8883. Пример в этом руководстве использует протокол MQTT, который передает данные через порт 8883. В некоторых корпоративных и академических сетях этот порт может быть заблокирован. Дополнительные сведения и способы устранения этой проблемы см. в разделе о [подключении к Центру Интернета вещей по протоколу MQTT](../articles/iot-hub/iot-hub-mqtt-support.md#connecting-to-iot-hub).
