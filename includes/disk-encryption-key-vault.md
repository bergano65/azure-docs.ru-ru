...
Вместо этого вы можете импортировать KEK из вашего собственного ключевого управления HSM. Дополнительные сведения см. в документации по [Key Vault](/azure/key-vault/key-vault-hsm-protected-keys).
