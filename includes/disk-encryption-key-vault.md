...
Вместо этого можно импортировать KEK из локального АППАРАТного модуля управления ключами. Дополнительные сведения см. в документации по [Key Vault](/key-vault/key-vault-hsm-protected-keys). 
