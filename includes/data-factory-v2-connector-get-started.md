...
Чтобы выполнить действие копирования с помощью конвейера, можно использовать одно из следующих средств или пакетов SDK:

- [Средство Копирование данных](../articles/data-factory/quickstart-create-data-factory-copy-data-tool.md)
...
- [Вызов REST API](../articles/data-factory/quickstart-create-data-factory-rest-api.md)
