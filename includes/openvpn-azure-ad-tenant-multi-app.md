...
## <a name="users"></a>2. Создание пользователей клиента
...
## <a name="register-client"></a>3. Регистрация VPN-клиента
...
## <a name="register-apps"></a>4. регистрация дополнительных приложений
...
## <a name="assign-users"></a>5. Назначение пользователей для приложений
