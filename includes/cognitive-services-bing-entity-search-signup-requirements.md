...
* [Создайте пробный ресурс](https://azure.microsoft.com/try/cognitive-services/?api=bing-web-search-api):
...
* [Создайте ресурс для Поиска сущностей Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingEntitySearch):
    ...
    * Поиск сущностей Bing также предлагается на платных уровнях [ресурса поиска Bing версии 7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7).
