...
|  | **Политический базовый VPN шлюз** | **RouteBased Базовый VPN шлюз** | **RouteBased Стандартный VPN шлюз** | **Высокопроизводительный VPN-шлюз с маршрутизацией на основе маршрутов** |
| --- | --- | --- | --- | --- |
