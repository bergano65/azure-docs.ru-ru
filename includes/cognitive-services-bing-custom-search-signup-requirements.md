...
* [Создайте пробный ресурс](https://azure.microsoft.com/try/cognitive-services/?api=bing-custom-search-api):
...
* [Создайте ресурс для Пользовательского поиска Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingCustomSearch):
