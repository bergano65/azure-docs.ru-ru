...
3. В **Подключение к удаленному рабочему столу** введите частный IP-адрес виртуальной машины. При необходимости выберите **Показать параметры**, чтобы настроить дополнительные параметры, а затем подключитесь.
...
Дополнительные сведения об устранении неполадок см. в статье [Устранение неполадок с подключением к виртуальной машине Azure через удаленный рабочий стол](../articles/virtual-machines/troubleshooting/troubleshoot-rdp-connection.md).