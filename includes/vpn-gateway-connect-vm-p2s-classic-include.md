...
3. В **удаленном подключении к рабочему столу**введите личный IP-адрес VM. При необходимости выберите **Показать параметры**, чтобы настроить дополнительные параметры, а затем подключитесь.
