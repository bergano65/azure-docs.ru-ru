...
В следующей таблице показаны допустимые максимальные значения `maxShares` для размеров дисков уровня "Премиум".
...
`maxShares` Значение не влияет на количество операций ввода-вывода и ограничения пропускной способности для диска. Например, максимальное число операций ввода-вывода для диска p15 — 1100, если Максшарес = 1 или Максшарес > 1.
