...
1. На портале слева щелкните **+Создать ресурс** и выполните поиск по запросу "Шлюз виртуальной сети". Найдите **шлюз виртуальной сети** в списке результатов и щелкните соответствующую запись. На странице **шлюз виртуальной сети** нажмите кнопку **создать**. Откроется страница **Создание шлюза виртуальной сети**.
   ...
   ![Поля страницы Create virtual network gateway (Создание шлюза виртуальной сети)](./media/vpn-gateway-add-gw-rm-portal-include/p2sgw.png "Поля страницы Create virtual network gateway (Создание шлюза виртуальной сети)")

   ![Поля страницы Create virtual network gateway (Создание шлюза виртуальной сети)](./media/vpn-gateway-add-gw-rm-portal-include/p2sgw2.png "Поля страницы Create virtual network gateway (Создание шлюза виртуальной сети)")
