...
> [!NOTE]
> Эта идемпотентная операция. Если не удалось выполнить операцию, повторите ее. Если он продолжает потерпеть неудачу, создайте билет поддержки или создайте форум на [Microsoft и&A](https://docs.microsoft.com/answers/index.html)
>
>
