...
4. Выберите и добавьте следующие столбцы:
   ...
   **Обслуживание.** Отображает состояние обслуживания виртуальной машины. Ниже приведены возможные значения.
      ...
      | Value | Описание |
      |-------|-------------|
      | Начать | Виртуальная машина находится в периоде самообслуживания, в течение которого вы можете инициировать обслуживание самостоятельно. Ниже приведены сведения о том, как запустить обслуживание виртуальной машины. | 
      ...
      | Повторите попытку позже | Вы инициировали обслуживание, но его не удалось выполнить. Вы сможете попытаться запустить самостоятельное обслуживание позже. | 
