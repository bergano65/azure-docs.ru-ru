...
[Microsoft Cloud](https://azure.microsoft.com) инфраструктура поддерживает более миллиарда клиентов в 127 странах и регионах. Опираясь на богатый опыт Майкрософт в сфере разработки, создания корпоративного программного обеспечения и управления крупнейшими веб-службами, Microsoft Cloud обеспечивает более высокий уровень безопасности, конфиденциальности, соответствия требованиям и методов устранения угроз, чем большинство пользователей может обеспечить самостоятельно.
...
![Акселераторы решений Интернета вещей Azure](media/iot-security-ground-up/securing-iot-ground-up-fig3.png)
