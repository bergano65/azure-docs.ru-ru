...
Все ключи, используемые в инфраструктуре Интернета вещей, хранятся в защищенном облачном хранилище с возможностью продления, в случае если ключи должны быть повторно подготовлены. Данные могут храниться в [Azure Cosmos DB](../articles/cosmos-db/introduction.md) или в [базе данных SQL](../articles/sql-database/sql-database-faq.md), что позволяет определить требуемый уровень безопасности. Кроме того, в Azure предусмотрены функции мониторинга и аудита всех операций доступа к данным, которые оповещают о попытках вторжения и несанкционированного доступа.
