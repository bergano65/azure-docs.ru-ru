...
---
>[!NOTE]
>При работе с политиками по умолчанию Azure может выступать как в качестве инициатора, так и ответчика во время установки туннеля IPsec. Поддержка Azure только в качестве ответчика отсутствует.
>
