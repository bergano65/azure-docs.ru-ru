...
ms.locfileid: "67185969"
---
1. Войдите на [портал Azure].
2. Выберите **«NEW** > **Web» — мобильное** > **мобильное приложение,** а затем предоставьте название для задней части мобильных приложений.
3. В поле **Группа ресурсов** выберите существующую группу ресурсов или создайте новую (с тем же именем, что и у приложения). 
4. В качестве **плана службы приложений** используется план по умолчанию (для [уровня "Стандартный"](https://azure.microsoft.com/pricing/details/app-service/)). Вы также можете выбрать другой план или [создать новый.](../articles/app-service/app-service-plan-manage.md#create-an-app-service-plan) 
...
5. Выберите **Создать**. На этом шаге создается серверная часть мобильных приложений. 
