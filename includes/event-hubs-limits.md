...
| Максимальное число единиц пропускной способности |Превышение этого ограничения приводит к регулированию данных и созданию [исключения занятости сервера](/dotnet/api/microsoft.servicebus.messaging.serverbusyexception). Чтобы запросить большее число единиц пропускной способности для уровня "Стандартный", отправьте запрос в [службу поддержки](../articles/azure-portal/supportability/how-to-create-azure-support-request.md). [Дополнительные единицы пропускной способности](../articles/event-hubs/event-hubs-auto-inflate.md) доступны в блоках по 20 единиц на основе подтвержденной покупки. |20 | 20 | 
...
Сведения о создании выделенного кластера Центров событий с помощью портала Azure см. в этом [документе](../articles/event-hubs/event-hubs-dedicated-cluster-create-portal.md).
