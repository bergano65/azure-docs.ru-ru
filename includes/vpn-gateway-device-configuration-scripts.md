...
---
| **Поставщика** | **Семейство устройств** | **Версия встроенного ПО** |
| --- | --- | --- |
...
> [!NOTE]
> ( * ) Требуется: УзкиеАзуреТрафикСекторы (включите опцию UsePolicyBasedTrafficSelectors) и CustomAzurePolicies (IKE/IPsec)
>
